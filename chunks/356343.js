...
function s(C) {
    let { icon: e, onChange: r } = C,
        { handleClick: s, reenable: M } = (function () {
            let { setFocusLockDisabled: C } = n.useContext(l.M),
                e = n.useRef(!1),
                r = n.useRef(null),
                L = n.useRef(C);
            n.useEffect(() => {
            ...
            let t = n.useCallback(() => {
                    e.current &&
                        ((e.current = !1),
                        L.current?.(!1),
                        null != r.current && (window.removeEventListener("focus", r.current), (r.current = null)));
                }, []),
                u = n.useCallback(
                    (C) => {
                        null != L.current &&
                            ((e.current = !0), L.current(!0), (r.current = t), window.addEventListener("focus", t));
                    },
                    [t],
                );
            return (
                n.useEffect(
                    () => () => {
                        e.current && ((e.current = !1), L.current?.(!1)),
                            null != r.current && (window.removeEventListener("focus", r.current), (r.current = null));
                    },
                    [],
                ),
                { handleClick: u, reenable: t }
            );
        })(),
        Z = n.useCallback(
            (C, e) => {
    ...
    return (0, L.jsx)(t.vN, {
        ...
        children: (0, L.jsxs)("div", {
            ...
            children: [
                null != e
                    ? (0, L.jsx)("img", { alt: "Your icon", className: i.k, src: e })
                    : (0, L.jsxs)("svg", {
                          width: "80",
                          height: "80",
                          viewBox: "0 0 80 80",
                          ...
                          children: [
                              ...
                              (0, L.jsx)("circle", { cx: "68", cy: "12", r: "12", fill: "#5865f2" }),
                              (0, L.jsx)("path", {
                ...
                (0, L.jsx)(u.Ay, {
                    ...
                    multiple: !1,
                    tabIndex: 0,
                    "aria-label": c.intl.string(c.t.DWB2YZ),
                }),
            ],
        }),
    });
