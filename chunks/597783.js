...
function k(t, e) {
    let r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "product",
        k = (0, a.uM)(),
        p = (0, n.bG)([u.A], () => u.A.getProduct(t)),
        m = (0, o.i)(),
        x = l.Ay.canUseShopDiscounts(m),
        C = i.useRef(null),
        I = i.useCallback(() => {
            let i = null != p ? (0, c.Br)(p, x, !1) : null,
                n = null != p ? (0, c.c7)(p, x, !1) : void 0;
        ...
        }, [k?.sessionId, k?.categoryPosition, k?.pageCategory, k?.pageSection, k?.tilePosition, x, e, p, t, r]),
        _ = i.useCallback(
            (t) => {
                t
                    ? null === C.current &&
