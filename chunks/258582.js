...
function f(e, t, n, i, r) {
    let s = d.A.getChannel(c.A.getVoiceChannelId()),
        a = s?.getGuildId(),
        o = u.A.getMediaSessionId(),
        l = u.A.getRTCConnectionId(),
        f = _.Ay.getCurrentGameForAnalytics()?.name,
        g = a !== n.guildId && "0" !== n.guildId,
        A = "0" === n.guildId ? "default" : g ? "custom-external" : "custom";
...
let T = new p(A.h, {
    VOICE_CHANNEL_EFFECT_TOGGLE_ANIMATION_TYPE: () => {
        i = i === I.B.BASIC ? I.B.PREMIUM : I.B.BASIC;
    },
});
var S = n(104142);
function N(e) {
...
function O(e, t, n) {
    let { abortController: i, onRequestProgress: r } = N(e),
        o = T.getState().animationType ?? I.B.BASIC,
        _ = { animation_type: o, animation_id: (0, S.oS)(o, S.m4) };
    s.Bo.post({
...
function R(e, t, n, i, r) {
    let a = null != t.emojiId ? o.Ay.getCustomEmojiById(t.emojiId) : null,
        { abortController: _, onRequestProgress: d } = N(e),
