...
function m(e) {
    let { src: t, size: n, 'aria-hidden': l = !1, 'aria-label': a, imageClassName: d, cornerIconUrl: m, cornerIconOffsetX: b = 0, cornerIconOffsetY: v = 0 } = e,
        _ = (0, u.UC)(n),
        C = _.size,
        j = (0, i.useId)();
    return (0, r.jsx)(
        ...
        f(p({}, e), {
            ...
            children: (0, r.jsxs)('svg', {
                width: C + b,
                height: C + v,
                viewBox: '0 0 '.concat(C + b, ' ').concat(C + v),
