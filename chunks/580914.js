...
let S = {
    ...
    B = (e) => {
        var t, n, i, a, g;
        let { isLoading: b, handleTransition: B, category: I, heroBlock: y, tab: Z } = e,
            N = (0, o.e7)([u.Z], () => u.Z.useReducedMotion),
            F = (0, o.e7)([p.Z], () => p.Z.isFocused()),
            w = (0, o.e7)([h.default], () => h.default.getCurrentUser()),
            P = (0, j.u)(),
            O = r.useMemo(() => (null != y ? y : T(I)), [y, I]),
                                ...
                                !b &&
                                    (0, l.jsx)('div', {
                                        ...
                                        children: (0, l.jsx)(d.zxk, {
                                            ...
                                            color: d.Ttl.WHITE,
                                            onClick: () => {
                                                Z === k.AW.ORBS ? (0, c.Z)('https://support.discord.com/') : B('shop latest category hero', O.categorySkuId);
                                            },
                                            children: H
                                        })
                                    })
