...
let D = (e) => {
    ...
    B = (e) => {
        ...
        return (0, r.jsx)(s.ua7, {
            ...
            children: (e) =>
                (0, r.jsxs)(
                    M,
                    L(w(L(w({ className: null != v.entryPointClassName ? (0, O.l)(x, v.entryPointClassName) : void 0 }, C), { icon: v.entryPointIcon }), e), {
    ...
    W = (e) => {
        ...
        if (o) return (0, r.jsx)(H, L(w({}, d), { listScrollerRef: a }));
        if (null != s)
            switch (s.type) {
                case T.k2.TOOLTIP:
                ...
                case T.k2.COACHMARK:
                    return (0, r.jsx)(F, L(w({ dismissContent: c }, d), { displayOptions: s }));
            }
        return (0, r.jsxs)(r.Fragment, {
