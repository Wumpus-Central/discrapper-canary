...
t.Z = {
    [d.Etm.SHARE_LINK]: (0, i.S)(d.Etm.SHARE_LINK, {
        ...
        handler(e) {
            ...
            if (!(0, l.yE)(null !== (t = n.application.flags) && void 0 !== t ? t : 0, d.udG.EMBEDDED)) throw new a.Z({ errorCode: d.lTL.INVALID_COMMAND }, 'This application cannot access this API');
