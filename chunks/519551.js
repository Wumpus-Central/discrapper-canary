...
class l {
    ...
    transaction(e, t) {
        return this.database.transaction((t) => e(new _(this.prefix, this.tableId, t)), t);
    }
...
class I {
    ...
    withoutLogging() {
        return new I(this.originalPrefix, this.table.tableId, this.table.database, !1);
    }
    get(e, t, n) {
