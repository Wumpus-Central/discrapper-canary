                      ...
                      new Promise((e, t) => {
                          ...
                          (n.crossOrigin = "anonymous"),
                              (n.onload = () => {
                                  ...
                                  (t.width = p.Im.width), (t.height = p.Im.height);
...
async function A(e, t) {
    ...
    await g(s.Tr.CAMERA_BACKGROUND_LIVE, { type: s.Qo.INPUT_DEVICE }, e), n && (0, d.Uz)(e, r, "Enabled");
}
...
function T() {
    ...
    if (null == e) return;
    let t = (0, l.i)(e);
    (0, f.A)() && !c.A.hasBeenApplied && null != t && A(t, { track: !1 }).catch(h.tEg);
}
