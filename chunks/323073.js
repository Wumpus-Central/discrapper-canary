...
function D(e) {
    ...
    return t
        ? {
              ...
              verifyGateDescription: c?.teen ?? (s ? g.intl.format(g.t["8tk6bB"], {}) : g.intl.format(g.t.XQZvwn, {})),
              verifyTitle: s ? g.intl.string(g.t.xi46lg) : g.intl.string(g.t.ZmwvDc),
          ...
          : d && s && !n
            ...
            : {
                  ...
                  verifyGateDescription:
                      c?.unverified ?? (s ? g.intl.string(g.t.V6Gmu9) : g.intl.string(g.t["5rygLk"])),
                  verifyTitle: s ? g.intl.string(g.t.xi46lg) : g.intl.string(g.t.ZmwvDc),
                  verifyDisagreementButtonText: g.intl.string(null != c ? g.t["/g10LC"] : g.t.f3Pet9),
              };
}
