...
function O(e) {
    let { locked: t, pinned: n, anchorLeft: l } = e,
        O = (0, o.e7)([h.Z], () => h.Z.getSocket()),
        E = (0, o.e7)([m.Z], () => m.Z.isGPUBoosted());
    (0, d.nU)();
    let v = (0, o.e7)([p.Z], () => p.Z.getWindow(g.$J)),
        [S, b] = (0, d.m8)(O),
        {
            currentFPS: x,
            averageFrameTime: j,
    ...
    return t && !n
        ? null
        : (0, i.jsxs)("div", {
              className: a()(y.panelGroup, !l && y.rightAligned),
              children: [
                  (V || !t) &&
                      (0, i.jsxs)("div", {
                              ...
                              (0, i.jsxs)(u.Text, {
                                  ...
                                  children: [
                                      ...
                                      (0, i.jsx)(u.Text, {
                                          ...
                                          variant: "code",
                                          color:
                                              I < 2 ? "text-danger" : I < 5 ? "text-feedback-warning" : "text-primary",
                                          children: Z.current,
                                      }),
                                      (0, i.jsxs)(u.Text, {
                                          tag: "span",
