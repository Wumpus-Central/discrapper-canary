...
function g(e) {
    ...
    return (
        (n = { id: (t = (0, s.cR)(i)), isBlockedEdit: (0, s.Qn)(i), messageData: i, errorMessage: (0, u.PD)(i, r) }),
        (E[t] = n),
        A++,
        !0
    );
