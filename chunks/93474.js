...
class I extends i.Ay.PersistedStore {
    ...
    initialize(e) {
        this.waitFor(o.A, l.A), null != e && ((h = e.automodFailedMessages), (p = e.mentionRaidDetectionByGuild));
    }
    getState() {
        return { automodFailedMessages: h, mentionRaidDetectionByGuild: p, lastIncidentAlertMessage: E };
    }
    getMessage(e) {
