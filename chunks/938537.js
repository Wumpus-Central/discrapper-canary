    ...
    if (l)
        return (
            ...
            S(a)
                ...
                : null != a && (P(a) && (a = C(a, n + (null == a.key || (e && e.key === a.key) ? '' : ('' + a.key).replace(w, '$&/') + '/') + l)), t.push(a)),
            1
        );
    l = 0;
    var c = '' === r ? '.' : r + ':';
    if (S(e)) for (var u = 0; u < e.length; u++) (s = c + D((r = e[u]), u)), (l += k(r, t, n, s, a));
    else if ('function' == typeof (u = m(e))) for (e = u.call(e), u = 0; !(r = e.next()).done; ) (s = c + D((r = r.value), u++)), (l += k(r, t, n, s, a));
    else if ('object' === s) {
