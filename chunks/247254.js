...
class P extends p.A {
    ...
    handleClipsInitFailure(e) {
        ...
        N.default.track(b.HAw.CLIPS_INIT_FAILURE, {
            application_name: t,
            error_message: n,
    ...
    handleRTCConnectionVideo(e) {
        ...
        if (n !== f.x.STREAM || !(0, y.A)(h.Ay)) return;
    ...
    async classifyHardwareAndTrack() {
        try {
            ...
            return (
                N.default.track(b.HAw.CLIPS_HARDWARE_CLASSIFICATION, {
                    classification: t,
                    version: v.V0,
                    gpu_models: e,
    ...
    constructor() {
        super(),
            Object.assign(this.actions, {
                ...
                RPC_SERVER_READY: () => {
                    (0, _.se)(O.Ay.getEnableAutoclipping());
                },
            });
    }
    handlePostConnectionOpen() {
        super.handlePostConnectionOpen(), (0, _.se)(O.Ay.getEnableAutoclipping());
    }
