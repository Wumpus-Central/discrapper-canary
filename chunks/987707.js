...
var r,
    ...
    m = n(430824),
    I = n(981631);
let g = o.$e(I.Plq.KICK_MEMBERS, I.Plq.BAN_MEMBERS, I.Plq.ADMINISTRATOR, I.Plq.MANAGE_CHANNELS, I.Plq.MANAGE_GUILD, I.Plq.MANAGE_MESSAGES, I.Plq.MANAGE_NICKNAMES, I.Plq.MANAGE_ROLES, I.Plq.MANAGE_WEBHOOKS, I.Plq.MANAGE_GUILD_EXPRESSIONS, I.Plq.MOVE_MEMBERS, I.Plq.MUTE_MEMBERS, I.Plq.DEAFEN_MEMBERS),
    f = null,
    N = [],
    h = [],
    O = [],
...
function G(e) {
    ...
    return (
        e.reverse().forEach((e) => {
            ...
            (e.action_type === I.rsA.AUTO_MODERATION_BLOCK_MESSAGE && (null == (l = e.options) ? void 0 : l.auto_moderation_rule_name) != null && i.push(new E.ms(I.zUn.AUTO_MODERATION_TRIGGERED_RULE_NAME, null, e.options.auto_moderation_rule_name)), e.action_type === I.rsA.VOICE_CHANNEL_STATUS_CREATE && (null == (r = e.options) ? void 0 : r.status) != null && i.push(new E.ms(I.zUn.STATUS, null, e.options.status)));
            let _ = new E.ZP({
                    id: e.id,
            ...
            if (_.actionType === I.vB8.DELETE && (null != o || null != u)) {
                ...
                ((_.targetType === I.KFR.CHANNEL || _.targetType === I.KFR.CHANNEL_OVERWRITE) && null !== c && (0, d.r8)(c.oldValue) && (e = '#'.concat(e)), null == y[_.targetType] ? (y[_.targetType] = { [_.targetId]: e }) : (y[_.targetType][_.targetId] = e));
            }
            ((n = 0), t.unshift(_));
        }),
        t
...
let z = new F(c.Z, {
    ...
    AUDIT_LOG_FETCH_SUCCESS: function (e) {
        var t;
        ((w = 0), (D = !1), (b = !1), (x = !0), (U = !1), (N = G(e.logs)), (h = e.integrations), (p = e.webhooks), (R = e.guildScheduledEvents), (S = null != (t = e.automodRules) ? t : []), (C = e.threads), (v = e.applicationCommands), e.logs.length < I.Rg9 && (x = !1));
    },
    ...
    AUDIT_LOG_FETCH_NEXT_PAGE_SUCCESS: function (e) {
        ...
        if (((L = !1), (h = n), (p = r), (R = l), (S = s), (C = i), (v = a), (0 === t.length || t.length < I.Rg9) && (x = !1), t.length > 0)) {
            let e = G(t);
            N = [...N, ...e];
        }
    },
    ...
    GUILD_SETTINGS_CLOSE: function () {
        ((N = []), (O = []), (P = I.rsA.ALL), (M = null), (j = null), (y = {}), (w = 0), (D = !0), (h = []), (p = []), (R = []), (S = []), (C = []));
    }
});
