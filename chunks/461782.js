...
function l(e) {
    ...
    let _ = i.useCallback(
        ...
        m = i.useMemo(() => ({ onAllowIdle: f, onPreventIdle: _, onActive: p, onForceIdle: h }), [f, _, p, h]);
    return (0, r.jsx)(o.Provider, {
        value: l,
        children: (0, r.jsx)(s.Provider, { value: m, children: t({ idle: l, ...m }) }),
    });
}
