function n(e) {
    let n = e.regex,
        ...
        a = {
            variants: [
                ...
                {
                    relevance: 0,
                    match: n.concat(/\b(?!for|if|while)/, i, n.lookahead(/\s*\(/)),
    ...
    return {
        ...
        keywords: {
            ...
            title: 'setup draw',
            variable: 'super this',
            built_in: [...r, 'BufferedReader', 'PVector', 'PFont', 'PImage', 'PGraphics', 'HashMap', 'String', 'Array', 'FloatDict', 'ArrayList', 'FloatList', 'IntDict', 'IntList', 'JSONArray', 'JSONObject', 'Object', 'StringDict', 'StringList', 'Table', 'TableRow', 'XML'],
