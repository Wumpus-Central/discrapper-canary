...
var i = n(788409),
    ...
    f = {},
    p = function e(t, n, s, a, o, u, d, _, p, E, m, g, A, I, T, S, y, N) {
        for (var v, C, R = t, O = N, b = 0, D = !1; void 0 !== (O = O.get(f)) && !D; ) {
            var L = O.get(t);
            if (((b += 1), void 0 !== L))
        ...
        if ("comma" === s && l(R))
            S && p && (R = r.maybeMap(R, p)), (C = [{ value: R.length > 0 ? R.join(",") || null : void 0 }]);
        else if (l(E)) C = E;
        else {
            var M = Object.keys(R);
            C = m ? M.sort(m) : M;
