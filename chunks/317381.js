...
function en(e) {
    ...
    let k = !C;
    null != R && c.id === R.location.id && u === R.applicationId && ((!A && Array.from(R.userIds).some((e) => e === T)) || k)
        ? ei(R)
        : A &&
...
function ec(e) {
    var t, n;
    let { applicationId: i, launchId: a, compositeInstanceId: l, location: c, participants: u, isFirstActivityInChannel: m, isStart: g, referrerId: O, customId: I, inviterUserId: T } = e,
        C = (0, y.ZP)(i),
...
function e_(e) {
    let { applicationId: t, config: n } = e,
        r = M.get(t);
    null != r && M.set(r.applicationId, w(P({}, r), { config: n }));
}
function ep(e) {
    let { guildId: t } = e,
        n = et(t),
...
C(eR, 'displayName', 'EmbeddedActivitiesStore'),
    ...
    C(eR, 'migrations', [
        ...
        (e) => w(P({}, e), { lastCheckedForBadgeableActivities: null })
    ]);
let ew = new eR(s.Z, {
