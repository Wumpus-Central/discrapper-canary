...
function Y(e) {
    ...
    let eR = "refresh_sm",
        ...
        ew = (0, r.jsx)(c.yRy, {
            ...
            onRequestOpen: () => {
                em && (0, E.Q3)(l.z.ACTIVITIES_CHAT_BUTTON_NUX_V2, { dismissAction: U.L.TAKE_ACTION }),
                    ec("attachMenu");
            },
            onRequestClose: () => {
                (0, c.$sL)() ||
                    (em && (0, E.Q3)(l.z.ACTIVITIES_CHAT_MENU_NEW_BADGE, { dismissAction: U.L.TAKE_ACTION }), ec(null));
            },
            renderPopout: (e) => {
                switch (el) {
                    case "recentClips":
