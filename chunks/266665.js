...
function R(e) {
    var t, i;
    let s,
        { guild: d, role: p, highestRole: g, selectedItem: h, onClick: x, currentPosition: j, onDragStart: N, onDragReset: v, onDragComplete: O, roleStyle: y } = e,
        C = (0, _.T)(d, g, p),
        E = (0, f.pM)(d.id, p.id),
        R = null == C && !E,
...
function D(e) {
    let { guild: t, currentRoleId: n, setCurrentRoleId: s, setSelectedSection: l } = e,
        ...
        { scrolledToTop: _, handleScroll: I } = (0, y.V)(),
        ...
        k = i.useCallback(
            (e) => {
                ...
                null === (n = A.current) || void 0 === n || null === (t = n.getScrollerNode()) || void 0 === t || t.scrollTo({ top: Math.max((r - 2) * 34, 0) });
            },
            [o]
        );
    (0, g.ZP)(() => {
    ...
    return (0, r.jsx)(x.ZP.Sidebar, {
        ...
        children: (0, r.jsxs)('div', {
            ...
            children: [
                (0, r.jsxs)('div', {
                    className: a()(S.titleContainer, { [S.titleElevated]: !_ }),
                    children: [
                        (0, r.jsxs)(u.P3F, {
                            className: S.title,
                            onClick: () => s(null),
