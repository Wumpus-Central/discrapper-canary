...
let x = function (e) {
    let { className: t, style: n, channel: x, draftType: v } = e,
        ...
        P = null != (0, l.e7)([a.Z], () => a.Z.getActiveCommand(x.id)),
        S = x.getGuildId(),
        ...
        w = Z ? (y.TPd.GUILD_THREADS_ONLY.has(x.type) ? C.intl.string(C.t.RBBLhI) : C.intl.string(C.t.gUx4en)) : j ? C.intl.format(C.t.dYP2FR, { destination: (0, o.F6)(x, f.default, h.Z, !0) }) : C.intl.string(C.t.h76ulJ);
    return P || !A
        ? null
        : (0, r.jsx)(b.Z, {
              className: t,
