...
let v = function (e) {
    let { className: t, style: n, channel: v, draftType: O } = e,
        ...
        R = N ? (C.TPd.GUILD_THREADS_ONLY.has(v.type) ? x.intl.string(x.t.RBBLhI) : x.intl.string(x.t.gUx4en)) : j ? x.intl.format(x.t.dYP2FR, { destination: (0, s.F6)(v, m.default, f.Z, !0) }) : x.intl.string(x.t.h76ulJ);
    return I || !w
        ? null
        : (0, r.jsx)(_.Z, {
              className: t,
