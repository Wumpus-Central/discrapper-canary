...
function h(e) {
    return {
        focusNext(t = {}) {
            ...
            let p = f.nextNode();
            return !p && l && ((f.currentNode = d), (p = f.nextNode())), p && T(p, !0), p;
        },
        focusPrevious(t = {}) {
            var n;
            let r = e.current,
            ...
            return !p && l && ((f.currentNode = d), (p = f.previousNode())), p && T(p, !0), p;
        },
        focusFirst(t = {}) {
            let n = e.current,
...
function y(e, t) {
    ...
    (0, r.b)(() => {
        ...
        let l = (0, a.r3)(r ? r[0] : void 0),
            ...
            d = (t) => {
                (!_ || I(_, e)) && v((0, i.NI)(t), e.current)
                    ? ((_ = e), (n.current = (0, i.NI)(t)))
                    : E(e) && !S((0, i.NI)(t), e)
                      ? n.current
                          ? n.current.focus()
        ...
        (0, r.b)(() => {
            ...
            let i = (t) => {
                ...
                if (
                    ...
                    while (S(s, e));
                    t.preventDefault(), t.stopPropagation(), s ? T(s, !0) : O(a) ? T(a, !0) : n.blur();
                }
            };
            return (
                                ...
                                if (r.activeElement === r.body) {
                                    ...
                                    for (n = t.getTreeNode(e); n; ) {
                                        if (n.scopeRef && n.scopeRef.current && U.getTreeNode(n.scopeRef))
                                            return void D(C(n.scopeRef.current, !0));
                                        n = n.parent;
                                    }
                                }
                            });
...
function L(e, t = {}) {
    return {
        focusNext(n = {}) {
            ...
            let f = d.nextNode();
            return !f && l && ((d.currentNode = r), (f = d.nextNode())), f && T(f, !0), f;
        },
        focusPrevious(n = t) {
            let r = e.current;
            if (!r) return null;
