...
let E = {
    ...
    [g.NV.USER_CALLED]: (0, r.jsx)(c._, { size: "custom", color: "currentColor", width: 22, height: 22 }),
    [g.NV.USER_ADD]: (0, r.jsx)(h.$, { size: "custom", color: "currentColor", width: 22, height: 22 }),
    ...
    [g.NV.GIFTS]: (0, r.jsx)(u.o, { size: "custom", color: "currentColor", width: 22, height: 22 }),
};
function I(t) {
    ...
    return (0, r.jsxs)(l.B, {
        ...
        fullWidth: !1,
        children: [
            (0, r.jsx)("div", { className: f.zc, children: o }),
            (0, r.jsxs)("div", {
                className: f.u4,
                children: [
                    (0, r.jsx)(C.E, { variant: "text-sm/bold", children: i }),
                    (0, r.jsx)(C.E, { variant: "text-xs/medium", children: e }),
                ],
            }),
        ],
    });
    ...
    return (0, r.jsx)(n.Modal, {
        ...
        children: (0, r.jsx)(l.B, {
            ...
            children: c.map((t) => {
                ...
                return (0, r.jsx)(
                    I,
                    { icon: E[i], header: e.tooltipHeader(), description: e.tooltipDescription(s ?? void 0) },
                    i,
                );
            }),
        }),
