    ...
    f = {
        [g.Et.GET_PROVIDER_ACCESS_TOKEN]: {
            ...
            handler: (e) => {
                ...
                if (n === m.ABu.AMAZON_MUSIC) {
                    if (!_.has(h)) throw new c.Z({ errorCode: g.lT.UNAUTHORIZED_FOR_APPLICATION }, 'Command not available for this application');
                ...
                return new Promise(async (e, t) => {
                    ...
                    if (null == r) {
                        ...
                        function h() {
                            t(new c.Z({ errorCode: g.lT.OAUTH2_ERROR }, 'OAuth2 setup for "'.concat(n, '" failed'))), _();
                        }
                        function _() {
        ...
        [g.Et.MAYBE_GET_PROVIDER_ACCESS_TOKEN]: {
            ...
            handler: async (e) => {
                ...
                if (n === m.ABu.AMAZON_MUSIC) {
                    if (!_.has(i)) throw new c.Z({ errorCode: g.lT.UNAUTHORIZED_FOR_APPLICATION }, 'Command not available for this application');
                } else throw new c.Z({ errorCode: g.lT.UNAUTHORIZED_FOR_APPLICATION }, 'Command not available for this application');
