...
function j(e) {
    let t,
        ...
        (j = l.useMemo(() => S.filter((e) => !_.some((t) => t.id === e.id)), [S, _])),
        (R = (0, r.yK)([b.Ay], () => {
        ...
        V = (0, i.jsx)(T, { icon: h.k, users: D }),
        { isMuted: B, muteConfig: H } = (0, r.cf)(
            [I.Ay],
            () => ({ isMuted: I.Ay.isChannelMuted(null, M), muteConfig: I.Ay.getChannelMuteConfig(null, M) }),
            [M],
        );
...
function L(e) {
    let { channel: t, children: n } = e,
        s = (0, g.Ay)(t),
        a = l.useMemo(() => (0, i.jsx)("div", { className: v.A_, children: (0, i.jsx)(R, { channel: t }) }), [t]);
    return (0, i.jsx)(o.m, {
