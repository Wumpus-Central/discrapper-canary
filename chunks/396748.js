...
function S(e) {
    ...
    let r = l.default.getCurrentUser()?.isStaff() ?? !1;
    return (0, s.aP)({
...
function C() {
    ...
    return (0, s.aP)({
        url: I.Rsh.STOREFRONT_COLLECTION_WITH_PRODUCTS(g.q4),
        query: { locale: i.default.locale, include_unpublished_products: e, include_unpublished_collection: e },
        oldFormErrors: !0,
        rejectWithError: !1,
        retries: 2,
    }).then((e) => {
