...
let to = (e) => {
    let { channel: n, guild: l } = e,
        {
            ...
            let e = nP.A.getCurrentCategoryId(n.id),
                t = nP.A.getDirectoryEntries(n.id, e === n5.mU.ALL ? null : e),
    ...
    let u = s.useMemo(
            () =>
                null != r
                    ? (function (e, n) {
                          if (n !== n5.mU.ALL) return [{ entries: (0, tt._t)(e), appendEndCard: !0 }];
                          let t = [],
                              l = (0, tt.A3)(e),
    ...
    return I
        ...
        : null == u && null == a
          ...
          : u?.length === 0 && null == a
            ? (0, i.jsx)("div", { className: n6.$$, children: (0, i.jsx)(nU, { guild: l, onAddGuild: y }) })
            : (0, i.jsx)(tn, {
                  channel: n,
                  searchQuery: f,
                  setSearchQuery: j,
...
function lY(e) {
    let { channel: n } = e,
        t = (0, lB.S4)(n),
        l = (0, A.bG)([lw.A], () => lw.A.hasHidden(n.id)),
        s = (0, lV.l)(n.id),
    ...
    handleVoiceClick = (e) => {
        ...
        if (
            (l.includes(g.M.ACTIVITY_GDM_CALL_TOOLTIP) &&
                (0, tc.Dr)(g.M.ACTIVITY_GDM_CALL_TOOLTIP, { dismissAction: l6.i.AUTO }),
            n)
        );
...
function it(e) {
    let { channel: n } = e,
        ...
        o = n.getRecipientId(),
        { notFriend: c, isBlocked: u } = (0, A.cf)([l4.A], () => ({
            notFriend: n.type === er.rbe.DM && null != o && !l4.A.isFriend(o),
            isBlocked: n.type === er.rbe.DM && null != o && l4.A.isBlocked(o),
        })),
...
function iC(e) {
    ...
    return (0, i.jsx)(tg.In, {
        ...
        icon: ip.n,
        onClick: () => {
            (0, ij.am)({ displayProfile: s, isProfileOpen: !r }), lC.A.toggleUserProfileSidebarSection();
        },
        selected: r && !t,
    });
}
...
function iP(e) {
    let { user: n, channel: l, status: a, activities: r } = e,
        ...
        u = (0, A.bG)([l4.A], () => l4.A.getNickname(n.id)),
        h = (0, iL.A)(n.id),
        g = s.useRef(null),
        m = (e) => {
            (0, I.L3)(e, async () => {
        ...
        { listItems: r } = (0, A.bG)(
            ...
            () => {
                ...
                let l =
                    ...
                    i = {};
                for (let e of l)
                    l4.A.isFriend(e.id) || e.id === J.default.getCurrentUser()?.id
                        ? (i[e.id] = {
    ...
    let { parentChannelId: n } = e,
        t = s.useCallback(() => {
            let e = t5.A.getThreadSettings(n),
                ...
                l = sl.A.getUploads(n, t5.C.FirstThreadMessage);
            ...
            return (
                s.useEffect(() => {
                    function t(t) {
                        ...
                        (0 === i.length || !0 === t) && l((0, i3.ur)(i)), n(t5.A.getThreadSettings(e.id) ?? {});
                    }
                    return (
                        t(!0),
...
function sy(e) {
    let { parentChannel: n, textAreaState: t, setTextAreaState: l, submit: a, error: d } = e,
        ...
        m = s.useCallback(
            (e, t, i) => {
                i0.A.saveDraft(n.id, t, t5.C.FirstThreadMessage),
                    l(
                        (e) => (
...
function sG(e) {
    ...
    if (
        ...
        return null;
    let m = (0, i.jsx)(t4, { channel: o, baseChannelId: r });
    return (0, i.jsxs)(i.Fragment, {
        children: [
...
function ae(e) {
    let { context: n, analyticsLocations: t, profileFrame: l, handleOpenProfile: s } = e,
        ...
        r = a
            ...
            : null;
    return null != l
        ? (0, i.jsxs)("div", { className: s6.xQ, children: [(0, i.jsx)(s4.A, { frame: l, filterLayer: s8 }), r] })
        : r;
}
var an = t(996988),
    at = t(556818),
...
function ac(e) {
    let { user: n, channel: t, onHide: l } = e,
        a = (0, iI.Ay)(n.id),
        r = (0, sY.Ay)(),
        d = (0, A.bG)([l4.A], () => l4.A.isBlocked(n.id)),
...
function aF(e) {
    let { user: n, currentUser: t, displayProfile: l, channel: s, isHoveringOrFocusing: a, onOpenProfile: r } = e,
        { relationshipType: d, originApplicationId: o } = (0, A.cf)([l4.A], () => ({
            relationshipType: l4.A.getRelationshipType(n.id),
            originApplicationId: l4.A.getOriginApplicationId(n.id),
        })),
        c = (0, aT.fi)(n.id),
    ...
    return (0, i.jsxs)("div", {
        ...
        children: [
            (0, i.jsxs)(lz.A, {
                ...
                children: [
                    (0, i.jsx)(lz.A.Icon, { icon: rR.N, "aria-hidden": !0 }),
        ...
        switch (e.type) {
            ...
            case er.rbe.PUBLIC_THREAD:
                e.isModeratorReportChannel() && d.push((0, i.jsx)(tX, { channel: e })),
                    ...
                    e.isVocalThread() &&
                        (d.push((0, i.jsx)(ix, { channel: e }, "thread-call")),
                    ...
                    null != n && (0, ef.pk)(e) && d.push((0, i.jsx)(lk, { channel: e }, "summaries")),
            ...
            case er.rbe.GUILD_TEXT:
                d.push((0, i.jsx)(sR, { channel: e }, "browser")),
                    ...
                    d.push((0, i.jsx)(lL, { channel: e }, "pins")),
                    (0, ni.fw)("channel_header") && d.push((0, i.jsx)(lv, { channelId: e.id }, "conversations")),
                    d.push((0, i.jsx)(l_, { channelId: e.id }, "members")),
                    (0, ef.pk)(e) && d.push((0, i.jsx)(lk, { channel: e }, "summaries"));
                break;
            case er.rbe.GUILD_FORUM:
            case er.rbe.GUILD_MEDIA:
                t ||
...
let rQ = (0, ep.A)(rX),
    r$ = s.memo(function (e) {
        ...
        let O = (0, A.bG)([eI.Ay], () => eI.Ay.getCurrentEmbeddedActivity()),
            ...
            V =
                ((n = E?.id),
                (l = (0, A.bG)([nJ.A, iv, J.default, X.Ay], () => {
            ...
            K = E?.id,
            q = (0, A.bG)([lE.Ay], () => lE.Ay.getGuildSidebarState(K), [K]),
            $ = (0, iT.lI)(),
            Z = (0, th.Ay)(f),
            ee = (0, th.Ay)(f, !0),
        ...
        !(function (e) {
            ...
            s.useEffect(() => {
                async function e(e) {
                    ...
                    eG.A.getVoiceChannelId() !== l && (await (0, e4.A)({ channelId: l }));
        ...
        s.useEffect(() => {
            let e = eA && !eh,
                n = eA && eh && f?.id !== eg;
            (e || n) && (0, tc.Dr)(g.M.ACTIVITY_GDM_CALL_TOOLTIP, { dismissAction: l6.i.AUTO });
        }, [f?.id, eg, eh, eA]);
