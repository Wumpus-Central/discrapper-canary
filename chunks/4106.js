...
let d = {
    ...
    fetchForStatusNotification(e) {
        (0, l.Lg)("fetchInitialStatus") && a.h.dispatch({ type: "LOAD_ICYMI_FROM_NOTIFICATION", customStatusItem: e });
    },
    async fetchHydrated(e, t, n) {
        if (!(0, l.Lg)("fetchHydrated")) return;
        let { messageItems: r, activityItems: d } = n;
        if (0 === r.length && 0 === d.length)
        ...
        try {
            let n = await i.Bo.post({
                url: o.Rsh.GRAVITY_ITEMS_HYDRATE,
                body: { message_items: r, activity_items: d },
                rejectWithError: !1,
            });
            a.h.dispatch({
                type: "LOAD_ICYMI_HYDRATED",
