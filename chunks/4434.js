...
function er(e) {
    ...
    let el = [
        ...
        ea =
            null == P
                ? void 0
                : P.items.find((e) => e.planId === z.Xh.PREMIUM_MONTH_TIER_2 || e.planId === z.Xh.PREMIUM_YEAR_TIER_2);
    null != ea && el.push(ea);
    let es =
            null == P
                ? void 0
                : P.items.find((e) => e.planId === z.Xh.PREMIUM_MONTH_GUILD || e.planId === z.Xh.PREMIUM_YEAR_GUILD),
    ...
    let ep = !eo && null == ed && null == em,
        ...
        eP = null == ed ? void 0 : ed.findInvoiceItemByPlanId(M.id),
        ef =
            null != eP
                ? {
                      amount: eP.amount,
                                ...
                                : eg
                                  ...
                                  : (function (e) {
                                        let { amount: n, currency: t, intervalType: i, intervalCount: r = 1 } = e,
                                            l = (0, H.T4)(n, t);
                                        return i === z.rV.YEAR
                                            ? $.intl.formatToPlainString($.t["8M04YG"], { price: l })
                                            : i === z.rV.MONTH && 1 === r
                                              ? $.intl.formatToPlainString($.t.VStWCQ, { price: l })
                                              : i === z.rV.MONTH && r > 1
                                                ? $.intl.formatToPlainString($.t.xJvAFR, { price: l })
                                                : null;
                                    })({
                                        intervalType: D,
                                        intervalCount: w,
                ...
                (0, i.jsx)(D.Z, {
                    ...
                    children:
                        ...
                        (0, i.jsx)(P.Z, {
                            ...
                            showPricingLink:
                                (null != (n = null == L ? void 0 : L.currency) ? n : Q.pK.USD) !== Q.pK.USD,
            ...
            children: [
                ...
                (0, i.jsx)(R.ZP, {
                    ...
                    type: Q.X7.has(null != o ? o : Q.He.UNKNOWN)
                        ? R.ZP.Types.PREMIUM_PAYMENT_STARTED
                        : R.ZP.Types.GUILD_BOOST_APPLIED,
                }),
                (0, i.jsx)("div", {
