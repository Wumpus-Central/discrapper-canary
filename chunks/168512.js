...
let nj = {
    ...
    n_ = a.forwardRef(function (e, t) {
                                          ...
                                          let c = (function (e) {
                                              ...
                                              return (0, tM.kd)(t) && !u
                                                  ...
                                                  : null != i && null != i.enrolledAt && null == i.claimedAt
                                                    ...
                                                    : n.has(t.id)
                                                      ? s$.DISCOVERED
                                                      : null != s && (0, e7.I0)(s, t.id) && ng(s$.FEATURED, l)
                                                        ? s$.FEATURED
        ...
        let M = a.useMemo(() => ({ targetQuestId: g, highlightCount: j, highlightAnimationProgress: b }), [g, j, b]),
            L = a.useMemo(
                () =>
                    d.findIndex((e) => {
                        let { identifier: t } = e;
...
let nL = a.forwardRef(function (e, t) {
    let { adContentId: s, topContent: n, title: l, subtitle: i, buttons: u, background: c, className: d } = e,
        ...
        g = a.useCallback(() => nM(s, eO.HAw.QUEST_HOVER), [s]),
        f = a.useCallback(() => nM(s, eO.HAw.QUEST_HOVER_OFF), [s]);
    return (0, r.jsx)(tx.N, {
