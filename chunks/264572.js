...
(o.isBuffer = function (e) {
    ...
    (o.prototype.toString = function () {
        var e = this.length;
        return 0 === e ? "" : 0 == arguments.length ? g(this, 0, e) : p.apply(this, arguments);
    }),
    ...
    (o.prototype.compare = function (e, t, n, r, i) {
        ...
        for (var s = i - r, a = n - t, l = Math.min(s, a), u = this.slice(r, i), c = e.slice(t, n), d = 0; d < l; ++d)
            if (u[d] !== c[d]) {
                (s = u[d]), (a = c[d]);
                break;
            }
...
function g(e, t, n) {
    ...
    for (var p = "", h = 0; h < f; ) p += String.fromCharCode.apply(String, _.slice(h, (h += 4096)));
    return p;
}
function A(e, t, n) {
...
(o.prototype.write = function (e, t, n, r) {
    ...
    for (var f = !1; ; )
        switch (r) {
            ...
            case "utf8":
            case "utf-8":
                return (i = t), (s = n), R(v(e, this.length - i), this, i, s);
            case "ascii":
                return (a = t), (o = n), R(C(e), this, a, o);
            case "latin1":
            case "binary":
                return (function (e, t, n, r) {
                    return R(C(t), e, n, r);
