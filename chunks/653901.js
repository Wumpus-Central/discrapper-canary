...
function l2(e) {
    ...
    return (0, t.jsxs)("div", {
        ...
        "aria-hidden": !0,
        children: [
            (0, t.jsx)("img", { src: r, alt: "", className: l7.AH }),
            l?.skuId != null &&
                (0, t.jsx)(b.A, {
                    skuId: l.skuId,
                    autoPlay: !1,
...
function l8(e) {
    let { user: l, guildId: n, disabled: r } = e,
        { analyticsLocations: a } = (0, j.Ay)(),
        o = null != n,
        d = (0, s.bG)([l3.A], () => (null != n ? l3.A.getGuild(n) : null)),
        u = (0, Z.N2)({ user: l }),
...
function ny(e) {
    let {
        ...
        O = i.useRef(!1),
        _ = i.useRef(!1),
        G = i.useMemo(() => l.filter((e) => (0, nh.fI)(e.value, [n])), [n, l]),
        L = i.useCallback(() => {
            u || h(!x);
        }, [u, h, x]),
        M = i.useCallback(
        ...
        : (0, t.jsxs)("aside", {
              ...
              children: [
                  ...
                  (0, t.jsxs)("div", {
                      className: nS.wx,
                      children: [
                          (0, t.jsx)(nG, { innerRef: c, onClick: d }),
                          (0, t.jsx)(nR, {
...
let n6 = {
    ...
    te = (e) => {
        let { className: l } = e,
            ...
            [c, g] = i.useState(null);
        i.useEffect(() => {
            null !== n ? (u(!0), g(n6[n]), n7.O.announce(n6[n].message)) : u(!1);
        }, [n]);
        let m = (0, d.p)(
            o,
            {
...
var tR = n(97808),
    ...
    tL = n(106106),
    tM = n(338165);
let tw = tG.Ay.getEnableHardwareAcceleration() ? tR.Js : tR.eu;
function tU(e) {
...
function tV(e) {
    ...
    return 0 === m.length
        ...
        : (0, t.jsxs)("div", {
              ...o,
              className: a()(tL.my, tL.vk, tM.kL, { [tM.MO]: d }),
              onMouseDown: (e) => {
                  c.current?.contains(e.target) || u(!0);
              },
              children: [
                  (0, t.jsx)(tw, { ...r, imageClassName: a()(tL.Lw, tM.HU) }),
                  (0, t.jsx)(lS.Y, {
                      targetElementRef: c,
                      shouldShow: d,
...
function t2(e) {
    ...
    return (0, t.jsxs)("main", {
        ...
        children: [
            ...
            (0, t.jsx)(t7, { displayProfile: g, profileEffectOverride: b, isHovering: G }),
                                        ...
                                        (0, t.jsxs)(f.F, {
                                            children: [
                                                ...
                                                (0, t.jsxs)(eC.A, {
                                                    ...
                                                    children: [
                                                        (0, t.jsx)(t3, { displayProfile: eT, pendingBanner: eg }),
