...
let E = a.memo(function (e) {
    let {
        ...
        b = a.useMemo(() => {
            if (j) return (0, i.jsx)(x.A, { item: t, wishlistOwner: l, wishlistId: c, isDragging: u, dragHandle: E });
            let e = (0, i.jsx)(I.A, {
                    item: t,
                    profileOwner: l,
                    wishlistId: c,
    ...
    return s
        ? (0, i.jsx)("li", { children: (0, i.jsx)(T, { item: t, index: n, wishlistId: c, onReorder: f, children: b }) })
    ...
    let { items: t, profileOwner: n, isOwner: r } = e,
        ...
        _ = a.useCallback(
            (e, n) => {
                ...
                c.A.reorderWishlistItem(g, a.skuId, { previousSkuId: s, nextSkuId: r, newWishlistData: l });
            },
            [g, t],
        );
