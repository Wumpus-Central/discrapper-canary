...
class d {
    ...
    announceDrag(e, t) {
        ...
        this.announce(o.intl.formatToPlainString(o.t["vHD/Je"], { itemName: n }));
    }
    announceHover(e, t) {
        null != e && this.announce(this.getName(e, t));
    }
    announceDrop() {
        this.announce(o.intl.string(o.t.lMkmz7));
    }
    announceCancel() {
        this.announce(o.intl.string(o.t["u4d/eC"]));
    }
    clear() {
...
class E {
    ...
    restoreRoleOfHoveredNode() {
        ...
        let e = this.currentHoveredNode.dataset[_];
        null != e &&
            ("" === e
                ? this.currentHoveredNode.removeAttribute("role")
                : this.currentHoveredNode.setAttribute("role", e),
            delete this.currentHoveredNode.dataset[_]);
    }
    overrideRoleToApplicationForHoveredNode() {
        null != this.currentHoveredNode &&
            ((this.currentHoveredNode.dataset[_] = this.currentHoveredNode.getAttribute("role") ?? ""),
...
class T {
    ...
    constructor(e, t, n) {
        (this.manager = e),
            ...
            (this._previewer = new c(t.document)),
            (this._announcer = new d(n?.announcer));
    }
    setup() {
        if (T.isSetUp) throw Error("Cannot have two Keyboard backends at the same time.");
        (T.isSetUp = !0),
    ...
    handleGlobalKeyDown = (e) => {
        this.monitor.isDragging() && f(e, h) && (this.endDrag(e), this._announcer.announceCancel());
    };
    setDndMode(e) {
    ...
    handleDrop = (e) => {
        f(e, A) && (this.actions.drop(), this.endDrag(e), this._announcer.announceDrop());
    };
    endDrag(e) {
        null != e && I(e),
...
let m = (0, a.eV)("keydown", (e) => !!p(e) && (e.preventDefault(), !0)),
    g = (0, a.eV)(
        "mousedown",
    ...
    S = {
        backends: [
            { id: "html5", backend: r.t, transition: g },
            {
                id: "keyboard",
                backend: (e, t, n) => new T(e, t, n),
                context: { window, document },
                options: { onDndModeChanged: l.ef, announcer: s.O },
                preview: !0,
                transition: m,
            },
        ],
...
function N(e) {
    let { children: t } = e;
    return (0, i.jsx)(a.QP, { options: S, children: t });
}
