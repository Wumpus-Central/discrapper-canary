...
class I {
    ...
    constructor(e, t, n) {
        (this.manager = e),
            ...
            (this._announcer = new _(n?.announcer));
    }
    setup() {
        if (I.isSetUp) throw Error("Cannot have two Keyboard backends at the same time.");
        (I.isSetUp = !0),
    ...
    handleDragStart = (e, t) => {
        if (!A(t, this._handlingFirstEvent) || ((this._handlingFirstEvent = !1), !this.monitor.canDragSource(e)))
            return;
...
let p = (0, s.eV)("keydown", (e) => !!A(e) && (e.preventDefault(), !0)),
    T = (0, s.eV)(
        "mousedown",
