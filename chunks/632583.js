...
function N(e) {
    var t,
        { width: n = 31, height: s = 22, referralsRemaining: c, isResending: f, hovered: _, isLightTheme: h } = e,
        m = d(e, ['width', 'height', 'referralsRemaining', 'isResending', 'hovered', 'isLightTheme']);
    let [g, E] = i.useState(p),
        v = null !== (t = y.get(g)) && void 0 !== t ? t : null;
    return (
        i.useEffect(() => {
                        ...
                        (0, r.jsxs)('defs', {
                            children: [
                                (0, r.jsxs)('linearGradient', {
                                    ...
                                    children: [
                                        (0, r.jsx)('stop', { stopColor: o.Z.unsafe_rawColors.PREMIUM_TIER_2_PURPLE.css }),
                                        (0, r.jsx)('stop', {
                                            offset: '1',
