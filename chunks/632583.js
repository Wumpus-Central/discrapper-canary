...
let o = 'currentColor',
    l = 'url(#nitro_hover)',
    u = 'url(#birthday_gradient_1_light)',
    c = 'url(#birthday_gradient_2_light)',
    d = 'url(#birthday_gradient_3_light)',
    f = 'url(#birthday_secondary_gradient_1_light)',
    _ = 'url(#birthday_secondary_gradient_2_light)',
    p = 'url(#birthday_secondary_gradient_3_light)',
    h = new Map([
    ...
    v = (e, t, n, i) => {
        if (n) return e ? l : o;
        let r = t ? [...m.keys()].filter((e) => e !== i) : [...h.keys()].filter((e) => e !== i),
            a = Math.floor(Math.random() * r.length);
        return r[a];
    };
function y(e) {
    var t;
    let { width: n = 31, height: l = 22, referralsRemaining: u, isResending: c, hovered: d, isLightTheme: f, ..._ } = e,
        [p, m] = r.useState(o),
        y = null !== (t = h.get(p)) && void 0 !== t ? t : null;
    return (
        r.useEffect(() => {
            d ? m((e) => v(d, f, c, e)) : c && m(o);
        }, [d, f, c]),
        (0, i.jsxs)('svg', {
            width: n,
            height: l,
            ...
            children: [
                c
                    ? (0, i.jsx)(E, { fillColor: p })
                    : (0, i.jsx)(g, {
                          referralsRemaining: u,
                          fillColor: d ? p : o,
                          secondaryFillColor: d ? y : null
                      }),
                (0, i.jsxs)('defs', {
                    children: [
                        (0, i.jsxs)('linearGradient', {
                            ...
                            children: [
                                (0, i.jsx)('stop', { stopColor: a.Z.unsafe_rawColors.PREMIUM_TIER_2_PURPLE.css }),
                                (0, i.jsx)('stop', {
                                    offset: '1',
