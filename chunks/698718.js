...
let e5 = l.forwardRef((e, t) => (0, i.jsx)(e8, { ...e, ref: t }));
...
class e8 extends l.PureComponent {
    ...
    handleKeyDown = (e) => {
        ...
        switch (e.key) {
            ...
            case e2.dh.ESCAPE:
                ...
                if ((e.preventDefault(), t)) return void (0, v.Bm)();
    ...
    handleSendMessage = async (e) => {
        ...
        if (null != l) {
            ...
            if (null == e || e === P.iw.CHAT) {
                ...
                let { location: t, sectionName: n } = (0, eJ.bV)(l) ?? {},
        ...
        return (0, eV.i)({
            ...
            if (null != n && n.length > 0) {
                let e = (0, ez.LJ)(n);
                if ((0, ez.fJ)(e, d?.id)) return (0, eW.V)(h, e), { shouldClear: !1, shouldRefocus: !1 };
                (I.eagerDispatch = !1),
    ...
    handleSetValue = (e) => {
        ...
        null != t && (W.b.select(t, []), t.insertText(e), this.editorRef?.focus());
    };
    ...
    render() {
        let {
            ...
            E =
                e.type === e0.rbe.GUILD_ANNOUNCEMENT && p
                    ? (0, i.jsx)(F.A, {
...
class te extends l.PureComponent {
    ...
    handleOpenExpressionPicker = (e) => {
        let { activeView: t } = e;
        (0, K.bf)(t, this.props.chatInputType, this.props.channel.id);
    };
...
let tt = l.memo(function (e) {
    let { channel: t, guild: n, chatInputType: l, filterAfterTimestamp: a } = e,
        { placeholder: s, accessibilityLabel: r } = (0, eq.A)({ channel: t }),
        ...
        _ = (0, Q.A)(t.id),
        f = (0, eC.D)(t.id),
        E = (0, h.bG)([ev.A], () => ev.A.getAlsoSendToChannel(t.id)),
        C = (0, h.bG)([eh.Ay, ey.default], () => eh.Ay.getUserCombo(ey.default.getId(), t.id)),
        x = (0, S.rj)(t),
        I = (0, S.aW)(t),
        v = x.length > 0 || t.rateLimitPerUser > 0 || null != C || null != I,
        { showLinkedLobbyApplicationLoadingIndicator: T } = (0, eK.A)(t.linkedLobby),
        y = (0, z.A)("ChannelChat"),
    ...
    return (
        ...
        (0, i.jsx)(te, {
            ...
            guild: n,
            keyboardModeEnabled: (0, h.bG)([N.A], () => N.A.keyboardModeEnabled),
            pendingReply: (0, h.bG)([ep.A], () => ep.A.getPendingReply(t.id)),
