...
class f extends a.Z {
    ...
    handleIdleUpdate() {
        ...
        let n = d.Z.getGuild(u.Z.getGuildId());
        ...
        null != i &&
            (i.isGuildStageVoice() ||
                g.start(e + n.afkTimeout * h.Z.Millis.SECOND - Date.now(), () => {
                    null != (n = d.Z.getGuild(u.Z.getGuildId())) && null != n.afkChannelId && r.default.selectVoiceChannel(n.afkChannelId);
                }));
    }
}
let E = new f();
