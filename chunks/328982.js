...
function eP() {
    ...
    return (0, i.jsx)("div", {
        ...
        className: eI.x,
        children: t
            ? (0, i.jsx)(ev.H, { children: (0, i.jsx)(ek.o, { ref: e, text: c, variant: eS, delay: null }) })
    ...
    let t,
        ...
        k =
            ...
            (s = l.useCallback(() => {
                n.current ||
                    ((n.current = !0),
                    (0, b.P0)((0, w.o)(Y.intl.formatToPlainString(H.default.u9TapG, { name: a }), x.Ck.MESSAGE)),
                    ez(t, a)
                        .catch((e) => {
                            let a;
...
function tH(e) {
    ...
    let eZ = l.useCallback((e) => {
        ...
        eJ =
            null != s && (0, el.jf)(s)
                ? (0, i.jsx)(k.$, { size: "sm", variant: "primary", loading: p, disabled: eg, onClick: eQ, text: ey })
                : null,
        e0 = (0, i.jsx)(tn, {
            ...
            actions:
                null == s
                    ...
                    : (0, i.jsxs)("div", {
                          className: tz.FO,
                          children: [
                              eu.showModeSwitch ? (0, i.jsx)(eW, { modes: eu.modes, mode: ec, onChange: ep }) : null,
                              (0, i.jsx)(G.A.Icon, {
                                  icon: e_ ? tB : tL,
                                  tooltip: eT,
                                  "aria-label": eT,
                              ...
                              "frame" === ec ? (0, i.jsx)(ex.A, { frame: eM, controlProjectId: s.id }) : null,
                              ...
                              eb
                                  ? null
                                  : (0, i.jsx)(G.A.Icon, { icon: tV, tooltip: ew, "aria-label": ew, onClick: ek }),
                          ],
                      }),
        });
    return (0, i.jsxs)("div", {
...
function tY(e) {
    ...
    let J = l.useMemo(
        ...
        em = t_(X) ?? s,
        ef = (0, u.bG)([el.Ay], () => el.Ay.getGuildProjectsFetchState(em), [em]),
...
function tq(e) {
    ...
    let E = l.useCallback(
        ...
        z = l.useCallback(
            async (e, t) => {
                let n = eD(e);
                if (null != n) return void (0, b.P0)((0, w.o)(n, x.Ck.FAILURE));
                G(!0);
                let i = null;
                try {
    ...
    return null != p
        ? (0, i.jsx)(tH, { project: $, projectsLoaded: Q, onBack: X, guildId: a }, p)
        : (0, i.jsx)(tY, {
              projects: s,
              modelSettings: I,
