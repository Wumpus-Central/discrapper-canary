...
class h {
    ...
    getForwardInfo() {
        ...
        if (null != E && E.guild_id === A.messageReference?.guild_id) {
            var C;
            let l = e.getChannel(A.messageReference?.channel_id);
            if (null == l) {
                let e = h.getGuild(E.guild_id);
            ...
            return c.can(l.accessPermissions, l)
                ? {
                      snapshotIndex: g,
                      footerInfo: {
                          originLabel: (C = (0, i.m1)(l, t, n, !0)),
                          timestampLabel: x,
                          accessibilityLabel: m.intl.formatToPlainString(m.t["+l04BN"], { origin: C, timestamp: x }),
                      },
                  }
                : { snapshotIndex: g };
        }
        ...
        let T = h.getGuild(I) ?? p.getGuild(I);
        return null == T ? { snapshotIndex: g } : { snapshotIndex: g, footerInfo: _(T, x) };
    }
}
