...
i.A.registerLanguage("ansi", function () {
    let e = [
        ...c("foreground", o, ["38", "39"], !0),
        ...c("background", l, ["48", "49"], !0),
        ...c("style", a, [], !1),
        { className: "ansi-control-sequence", begin: u, starts: { end: d, endsParent: !0 } },
    ];
    return (
        (function (e) {
            for (let t = 0; t < e.length; t++) e[t].contains = e.slice(t + 1);
        })(e),
        { contains: [{ begin: d, contains: e }] }
    );
});
let _ = /(<script\/?\\?>)|(html\\?`)/g,
...
for (let [e, t] of p) if (null == e.match(f)) throw Error(`Language name does not match regex: ${e}`);
function m(e) {
    return p.get(e.toLowerCase());
}
let g = {
        highlight(e, t, n) {
            if (
        ...
        isKnownLanguage: (e) => p.has(e.toLowerCase()),
