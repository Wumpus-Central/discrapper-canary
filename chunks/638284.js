...
let rX = {
    ...
    GuildRaidLockdownFeedbackModal: async () => {
        let { default: e } = await Promise.all([a.e("93412"), a.e("46313")]).then(a.bind(a, 336496));
        return (t) =>
            (0, r.jsx)(e, {
                ...t,
                guildId: "123456789",
...
function d7(e) {
    let { title: t, can: a } = e,
        n = a ? r0.A : z.P,
        l = (0, r.jsx)("div", {
            className: w()(d9.v_, a ? d9.uU : d9.Ss),
            children: (0, r.jsx)(n, { className: d9.Kk }),
        });
    return (0, r.jsxs)("div", {
        className: d9.z8,
        children: [
...
let c3 = () => {
    ...
    c9 = ["intro", "idle", "reduced_motion", "static", "thumbnail"],
    c7 = { max: 5e6, warn: 2e6 },
    ue = { max: 3e6, warn: 1e6 },
    ut = { max: 2e6, warn: 1e6 },
    ua = { max: 1e6, warn: 5e5 },
                                    ...
                                    ((e) => {
                                        ...
                                        ui({ names: Object.keys(t.profileEffectFilesMap), addError: a }),
                                            Object.entries(t.profileEffectFilesMap).forEach((e) => {
                                                ...
                                                let r = s
                                                    .filter(
                                                        (e) => !c9.some((t) => e.startsWith(t)) && !e.endsWith(".txt"),
                                                    )
                                                    .map((e) => `${t}/${e}`);
...
let h9 = (0, hB.D)(() => ({ isRecording: !1, isUploading: !1, isSuccess: !1, errorMessage: null }));
function h7() {
    ...
    let { userState: t } = e,
        ...
        i = o.useCallback((e) => {
            ...
            return t
                ...
                : (0, r.jsx)(m4.E, { size: "sm", color: eL.A.colors.ICON_FEEDBACK_CRITICAL });
        }, []);
    return (0, r.jsxs)("div", {
        className: h2.N6,
        children: [
