...
function g(e) {
    ...
    "string" == typeof e ||
        "number" == typeof e ||
        e instanceof Date ||
        (E.error("Invalid date given to startOfDay", { d: e }), (n = new Date()));
    let r = new Date(n),
        i = r.getTime();
...
function y(e, t, n) {
    let r = R(e).locale(),
        ...
        s = h[i];
    return null == s && (s = h[i] = (0, o.A)(t)), s(v(e));
}
function N(e) {
    let t,
    ...
    return y(e, s.calendar(t, R(e), a), r);
}
function O(e, t) {
    let n = i().localeData(),
        r = i()(),
    ...
    return 0 === s
        ? y(e, "LT", t)
        : -1 === s
          ? y(e, n.calendar("lastDay", R(e), r), t)
          : s > -7
            ? y(e, "dddd", t)
            : y(e, "L", t);
}
