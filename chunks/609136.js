...
function g(e, t, n, r, i) {
    if ((null != t.minValue && e < t.minValue) || (null != t.maxValue && e > t.maxValue)) {
        if (null != t.maxValue && null != t.minValue)
            return {
                success: !1,
                error: d.intl.formatToPlainString(n, { minimum: h(t.minValue), maximum: h(t.maxValue) }),
            };
        else if (null != t.minValue)
            return { success: !1, error: d.intl.formatToPlainString(r, { minimum: h(t.minValue) }) };
        else if (null != t.maxValue)
            return { success: !1, error: d.intl.formatToPlainString(i, { maximum: h(t.maxValue) }) };
    }
    return { success: !0 };
}
function h(e) {
