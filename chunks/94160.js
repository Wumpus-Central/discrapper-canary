...
function Z(e) {
    let { onClose: t } = e,
        i = s.useCallback(() => {
            t?.(), (0, D.openUserSettings)(P.X.CONNECTIONS_PANEL);
        }, [t]),
        l = s.useCallback(() => {
            t?.(), (0, D.openUserSettings)(P.X.CONTENT_AND_SOCIAL_CONNECTED_GAMES_TAB);
        }, [t]);
    return (0, n.jsxs)(z, {
...
function tt(e) {
    var t;
    let { items: i, profileOwner: l, guildId: r, showEditingControls: a, isSortingNitroToFront: o } = e,
        d = eH.default.getCurrentUser(),
        { defaultWishlistId: c } = (0, f.cf)([eB.A], () => ({ defaultWishlistId: eB.A.getFirstWishlistId(l.id) })),
        u = (0, eQ.rV)("UserProfileModalV2WishlistGrid"),
        g = s.useMemo(
            ...
            return (
                h &&
                    (e = (0, e$.hE)(e, (e) => {
                        var t;
                        return (
                            (t = eZ.A.hasSentGift(e.skuId, l.id)),
                            e.skuProductLine !== x.EZt.PREMIUM && (!0 === e.isOwned || t)
                        );
                    })),
                e
            );
        }, [g, o, h, l.id]),
        { isDragging: p } = (0, eK.V)((e) => ({ isDragging: e.isDragging() })),
        A = s.useCallback(
            (e, t) => {
                if (e === t || null == c || 0 === I.length || e < 0 || e >= I.length || t < 0 || t >= I.length) return;
                let i = eJ.A.getWishlist(c);
                if (null == i) return;
                let n = I[e],
                    { newWishlistData: s, previousSkuId: l, nextSkuId: r } = (0, e$.Ap)(i, I, e, t);
                eD.A.reorderWishlistItem(c, n.skuId, { previousSkuId: l, nextSkuId: r, newWishlistData: s });
            },
            [c, I],
        );
    ...
    return a ? (0, n.jsx)(e3.B, { emptyListFallbackRef: null, children: j }) : j;
}
function ti(e) {
...
function tn(e) {
    let t = eH.default.getCurrentUser()?.id,
        ...
        s = e.items.some((e) => e7.Ay.isPremiumSku(e.skuId));
    return (0, n.jsx)(e0.h, {
        isGifting: i,
        location: "UserProfileModalV2WishlistGrid",
        children: i && s ? (0, n.jsx)(ti, { ...e }) : (0, n.jsx)(tt, { ...e, isSortingNitroToFront: !1 }),
    });
}
var ts = i(815021),
    tl = i(299679),
    ...
    let {
        ...
        } = e,
        {
            ...
            let { userId: t, wishlist: i, hasFetchedWishlist: n } = e,
                { minItemsToDismiss: l } = tf.useConfig({ location: "user_profile_wishlist_suggestions_grid" }),
                  ...
                  (0, n.jsxs)("div", {
                      ...
                      children: [
                          ...
                          d &&
                              (0, n.jsx)("div", {
                                  className: tx.b,
                                  children: (0, n.jsx)(ts.J, { size: "xs", onClick: c }),
                              }),
                      ],
                  }),
                  (0, n.jsx)(tl.dB, {
            ...
            return s.useMemo(
                () =>
                    t.filter(e_.Vq).map((e) => {
                        let t = tv.Ay.getApplicationIconURL({ id: e.id, icon: e.icon, size: 20 });
                        return {
                            id: `browse-social-layer-storefront-${e.id}`,
                            label: F.intl.formatToPlainString(F.t["HDT/rg"], { applicationName: e.name }),
                            iconLeft: null != t ? () => (0, n.jsx)("img", { className: tN.I, src: t, alt: "" }) : ep.U,
...
var tC = i(509434),
    tw = i(365199);
let tk = E.A.getArticleURL(x.MVz.CUSTOM_PROFILES_WISHLIST);
function tR(e) {
                    ...
                    ? (0, n.jsxs)(tp.rX, {
                          children: [
                              ...
                              (0, n.jsx)(tp.Dr, {
                                  ...
                                  icon: tC.I,
                                  trailingIndicator: { type: "icon", icon: tC.I },
...
function tG(e) {
    ...
    return (0, n.jsxs)("div", {
        ...
        children: [
            ...
            (0, n.jsx)(tR, { isOwner: !0, isWishlistPublic: s, onToggleVisibility: o }),
        ],
    });
}
function tL(e) {
    ...
    let {
        ...
        c = s.useMemo(() => {
            ...
            if (1 === i.length) {
                ...
                return null == t
                    ? null
                    : (0, n.jsx)(tL, { application: t, handleOpenGameShop: r, handleOpenGameShopMouseDown: a });
            }
            return (0, n.jsx)(tb, {
                ...
                : (0, n.jsxs)(n.Fragment, {
                      children: [
                          ...
                          (0, n.jsx)(tD, {
                              ...
                              handleOpenShop: j,
                              handleOpenGameShop: S,
                              handleAddNitroToWishlist: p && !(0, eW.C3)(u, tO.pe.TIER_2) ? T : void 0,
                          }),
...
function tF(e) {
    ...
    return (0, n.jsx)(a.Ip, { ref: s, className: r()(tU.gN, i), fade: !0, ...l, children: t });
}
function tW(e) {
