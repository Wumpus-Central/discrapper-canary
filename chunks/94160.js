    ...
    let { items: i, profileOwner: s, guildId: r, showEditingControls: a } = e,
        ...
        h = l.useCallback(
            (e, t) => {
                ...
                if (null == i) return;
                let n = g[e],
                    { newWishlistData: l, previousSkuId: s, nextSkuId: r } = (0, eZ.Ap)(i, g, e, t);
            ...
            let { wishlist: t, profileOwner: i, currentUser: n } = e,
                ...
                o = l.useMemo(() => {
                    ...
                    for (let i of t?.items ?? [])
                        (0, eL.$)(i) && null != a[i.sku.applicationId] && e.push(i.sku.applicationId);
                    return e;
                }, [t, a]),
                d = (0, eP.w)({ userIds: r }),
                c = (0, eP.mn)({ userIds: r }),
                ...
                : (0, n.jsxs)(n.Fragment, {
                      children: [
                          ...
                          (0, n.jsx)(tL, {
                              ...
                              handleOpenShop: A,
                              handleOpenGameShop: E,
                              handleAddNitroToWishlist: I && !(0, eF.C3)(u, tT.pe.TIER_2) ? S : void 0,
                          }),
        ...
        : l === $.RP.MUTUAL_FRIENDS
          ...
          : l === $.RP.MUTUAL_GUILDS
            ...
            : l === $.RP.WIDGETS
              ...
              : l === $.RP.WISHLIST
                ? (0, n.jsx)(tO, { profileOwner: t, guildId: r })
                : null;
}
function tG(e) {
    let {
