...
var a = r(442837),
    ...
    h = r(388032);
function _(e) {
    let { user: n, activity: r, onAction: _, onClose: m } = e,
    ...
    return (null == r ? void 0 : r.type) !== p.IIU.HANG_STATUS || null == E
        ? null
        : (0, i.jsx)(f.tG, {
              ...
              onClick: (e) => {
                  e.stopPropagation(),
                      null == _ || _({ action: 'PRESS_HANG_STATUS_BUTTON' }),
                      o.default.selectVoiceChannel(E.id),
                      d.default.track(p.rMx.HANG_STATUS_CTA_CLICKED, {
                          channel_id: E.id,
                          guild_id: E.guild_id,
                          source: g
                      }),
