...
let T = l.memo(function (e) {
                    ...
                    children: [
                        ...
                        (0, i.jsx)("div", {
                            ...
                            children: (0, i.jsx)(u.E, {
                                ...
                                children: (0, _.Tz)(n, void 0, t.channel_id),
                            }),
                        }),
                    ],
                }),
    ...
    y = l.memo(function (e) {
        let { className: t, compact: n, message: a, children: r, content: d, onUpdate: u } = e,
            ...
            _ = l.useRef(!1),
            p = (0, c.bG)([A.A], () => A.A.getMessage(a.id), [a.id]),
            x = l.useCallback(() => {
                p?.isBlockedEdit ? (0, m.j)(a.id) : h.A.deleteMessage(a.channel_id, a.id, !0);
            }, [a, p]);
        return (
            l.useLayoutEffect(() => {
                _.current ? null != u && u() : (_.current = !0);
            }, [u, a.content, d, g, r]),
            (0, i.jsxs)("div", {
                id: (0, f.CJ)(a),
                className: s()(t, N.PT, {
                    [v.BK]: !0,
                    [v.nB]: "rtl" === o()(a.content),
                    [I.Dy]: p?.isBlockedEdit,
                    [I.bv]: !p?.isBlockedEdit,
                }),
                children: [
                    r ?? (0, E._A)(a, d),
                    p?.isBlockedEdit &&
                    ...
                    (0, i.jsx)(T, {
                        notice: p?.errorMessage ?? S.intl.string(S.t.zQ69pv),
                        message: a,
                        compact: n,
                        onDismiss: x,
                    }),
