            ...
            switch (t) {
                case r.M.NAGBAR_NOTICE_DOWNLOAD:
                    return (0, i.jsxs)(l.$T, {
                        color: l.Hv.DEFAULT,
                        children: [
                            (0, i.jsx)(l.PM, { onClick: () => R(h.i.UNKNOWN), noticeType: P }),
                    ...
                    return (0, i.jsxs)(l.$T, {
                        ...
                        children: [
                            ...
                            (0, i.jsx)(l.Z_, {
                                noticeType: P,
                                onClick: () => {
                                    (0, _.A)(S.AMi.META_QUEST), R(h.i.TAKE_ACTION);
                                },
                                children: M.intl.string(M.t["1WjMbC"]),
                            }),
                        ],
                ...
                case r.M.NAGBAR_NOTICE_CONNECT_PLAYSTATION:
                    return (0, i.jsxs)(l.$T, {
                        ...
                        children: [
                            (0, i.jsx)(l.PM, { noticeType: P, onClick: () => R(h.i.UNKNOWN) }),
                            (0, i.jsx)("img", {
                                alt: "",
                                className: D.tV,
                ...
                case r.M.NAGBAR_NOTICE_PASSKEY_BACKUP:
                    return (0, i.jsxs)(l.$T, {
                        color: l.Hv.DEFAULT,
                        children: [
                            (0, i.jsx)(l.PM, { onClick: () => R(h.i.USER_DISMISS), noticeType: P }),
                ...
                case r.M.NAGBAR_NOTICE_PREMIUM_PROMO:
                    return (0, i.jsxs)(l.$T, {
                        ...
                        children: [
                            ...
                            (0, i.jsx)(l.PM, {
                                onClick: () => {
                                    R(h.i.UNKNOWN), (0, u.lA)(S.nhx.PREMIUM_PROMO_DISMISSED, !0);
                                },
                                noticeType: P,
                            }),
                        ],
                ...
                case r.M.NAGBAR_NOTICE_PREMIUM_TIER_TWO_TRIAL_ENDING:
                    return (0, i.jsx)(I.A, {
                        dismissCurrentNotice: () => R(h.i.UNKNOWN),
                    ...
                    return (0, i.jsxs)(l.$T, {
                        ...
                        children: [
                            ...
                            (0, i.jsx)(l.Z_, {
                                noticeType: P,
                                onClick: () => {
                                    R(h.i.UNKNOWN), (0, p.openUserSettings)(N.X.NITRO_PANEL);
                                },
