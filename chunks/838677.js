...
let r = (function () {
    var e = {
            ...
            size: "72x72",
            className: "emoji",
            convert: { fromCodePoint: E, toCodePoint: y },
            onerror: function () {
    ...
    function _(e) {
        return y(0 > e.indexOf(i) ? e.replace(r, "") : e);
    }
    function f(e, t) {
        for (var r, i, a, s, o, u, c, f, p, h, m, g, E, A = d(e, []), I = A.length; I--; ) {
            for (a = !1, s = document.createDocumentFragment(), u = (o = A[I]).nodeValue, f = 0; (c = n.exec(u)); ) {
                if (
                    ((p = c.index) !== f && s.appendChild(l(u.slice(f, p), !0)),
                    (g = _((m = c[0]))),
                    (f = p + m.length),
                    (E = t.callback(g, t)),
                    g && E)
            ...
            a && (f < u.length && s.appendChild(l(u.slice(f), !0)), o.parentNode.replaceChild(s, o));
        }
        return e;
    }
    function p(e, t) {
