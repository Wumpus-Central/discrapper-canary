...
let r = (function () {
                        ...
                        : function (e, t) {
                              for (
                                  var r,
                                      ...
                                      g,
                                      A = (function e(t, n) {
                                          for (var r, i, s = t.childNodes, o = s.length; o--; )
                                              3 === (i = (r = s[o]).nodeType)
                                                  ? n.push(r)
                                                  : 1 !== i ||
                                                    "ownerSVGElement" in r ||
                                                    a.test(r.nodeName.toLowerCase()) ||
                                                    e(r, n);
                                          return n;
                                      })(e, []),
                                      I = A.length;
                                  ...
                                  for (
                                      s = !1, o = document.createDocumentFragment(), c = (u = A[I]).nodeValue, f = 0;
                                      (_ = n.exec(c));
                                  ) {
                                      if (
                                          ((E = _.index) !== f && o.appendChild(l(c.slice(f, E), !0)),
                                          (m = d((p = _[0]))),
                                          (f = E + p.length),
                                          (g = t.callback(m, t)),
                                          m && g)
                                  ...
                                  s &&
                                      (f < c.length && o.appendChild(l(c.slice(f), !0)),
    ...
    function d(e) {
        return E(0 > e.indexOf(i) ? e.replace(r, "") : e);
    }
    function c(e) {
        return t[e];
    }
    ...
    function E(e, t) {
        for (var n = [], r = 0, i = 0, s = 0; s < e.length; )
            (r = e.charCodeAt(s++)),
                i
