...
let d = 1209600000,
    ...
    p = () => {
        let { enabled: e, forceNotice: t } = c.l.useExperiment({ location: "useShouldShowPriceDecreaseNotice" }),
        ...
        return r > f
            ? ((0, o.Dr)(s.M.PREMIUM_SETTINGS_SUBSCRIPTION_INFO_NOTICE, { dismissAction: u.i.AUTO_DISMISS }), !1)
            : !!p && e;
    };
