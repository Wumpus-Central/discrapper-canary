...
var n = r(636537),
    ...
    h = r(38405),
    _ = r(652215);
let d = new i.A("VirtualCurrencyActionCreators");
async function u() {
    a.h.wait(() => {
        a.h.dispatch({ type: "VIRTUAL_CURRENCY_BALANCE_FETCH" });
    });
    try {
        let e = await n.Bo.get({ url: _.Rsh.VIRTUAL_CURRENCY_USER_BALANCE, rejectWithError: !1 }),
            t = e.body.balance;
...
async function R(e) {
    ...
    try {
        ...
        i && (E.test_mode = !0);
        let o = (await n.Bo.post({ url: _.Rsh.VIRTUAL_CURRENCY_SKU_REDEEM(t), body: E, rejectWithError: !1 })).body;
        if (null == o || !Array.isArray(o)) {
            let e = "Could not read entitlements from Virtual Currency redemption response. Response: ",
                t = Error(e, o);
            throw (d.error(e, o), h.A.captureException(t, { tags: { app_context: "virtual_currency" } }), t);
        }
        return (
            a.h.dispatch({ type: "VIRTUAL_CURRENCY_REDEEM_SUCCESS", skuId: t, entitlements: o }), C && u(), R?.(o), o
        );
    } catch (r) {
        let e = r instanceof l.Ey ? r : new l.Ey(r);
        a.h.dispatch({ type: "VIRTUAL_CURRENCY_REDEEM_FAIL", skuId: t, error: e }), C && u(), E?.(e);
    }
}
