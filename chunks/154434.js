...
function g(e) {
    ...
    return a.useState(() => (null != t ? { hours: t.hours, minutes: t.minutes } : l));
}
var y = l(602339),
    p = l(985018),
    v = l(166670);
...
function B(e) {
    let { transitionState: t, onClose: l, teenId: r, rule: b } = e,
        B = null != b,
        $ = (0, x.F7)(r),
        [A, I] = g({ initial: b?.startTime, defaultValue: { hours: 22, minutes: 0 } }),
        [R, U] = a.useState(""),
        [z, H] = g({ initial: b?.endTime, defaultValue: { hours: 7, minutes: 0 } }),
        [V, O] = a.useState(""),
        ...
        q = a.useMemo(() => {
            ...
            for (let t of (M(e, A, w), k(R))) M(e, t, w);
            return e.sort(_);
        }, [A, R]),
        J = a.useMemo(() => {
            let e,
        ...
        P = a.useMemo(() => {
            let e = $?.restrictedSchedule?.rules ?? [];
            return B && null != b ? e.filter((e) => e.ruleId !== b.ruleId) : e;
        }, [B, b, $?.restrictedSchedule?.rules]),
        X = a.useMemo(() => (0, h.d)(D, P, Y), [Y, P, D]),
        ee = (0, h.yN)(A) > (0, h.yN)(z),
        et = (0, h.yN)(A) !== (0, h.yN)(z),
        el = async () => {
            F(!0);
            try {
                let e = {
                ...
                B ? await (0, f.Um)(r, b.ruleId, e) : await (0, f.qP)(r, e), l();
            } finally {
                F(!1);
            }
        },
            ...
            children: [
                ...
                (0, n.jsxs)(i.B, {
                    ...
                    children: [
                        ...
                        (0, n.jsx)(T, { conflictingEntries: X.conflictingEntries }),
                    ],
                }),
            ],
        }),
