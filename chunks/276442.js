...
function m(e) {
    let { analyticsData: t, initialPlanId: n, breadcrumbSteps: i, handleStepChange: m, referralTrialOfferId: g, onReturn: E, continueSessionToInitialStep: v } = e,
        { contextMetadata: y, step: I, paymentSources: T, paymentSourceId: b, setPaymentSourceId: S, purchaseError: A, setPurchaseError: N, purchaseErrorBlockRef: C, paymentAuthenticationState: R, selectedSkuId: O, activeSubscription: D, previousStepRef: x, setPurchaseState: L } = (0, c.JL)(),
        { isGift: P } = (0, u.wD)(),
        w = {
            ...(0, o.fL)(),
            paymentSources: T,
