...
let f = a.memo(function (e) {
    ...
    return (0, i.jsx)(s.W, {
        ...
        onSelect: () => {},
        className: _.VS,
        children: Object.entries(g.Pb).map((e) => {
            let s,
                [r, o] = e,
                c =
                    ((s = []),
...
function x(e) {
        ...
        A = (0, a.useCallback)(
            function (e) {
                let t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                    i = new Set(I);
                if (t) {
                    let t = Object.values(g.Pb).find((t) => t.tags.includes(e));
                    null != t &&
                        (t.tags.forEach((e) => {
                            i.delete(e);
                        }),
    ...
    return (0, i.jsx)(r.Y, {
        ...
        renderPopout: (e) => {
            let { closePopout: t } = e;
            return (0, i.jsx)(f, { currentTags: I, onTagSelect: A, onNoneSelect: h, onClose: t });
        },
        children: (e) =>
            (0, i.jsx)("div", {
                ref: (e) => (
