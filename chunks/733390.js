...
let S = [
    ...
    { id: "NON_NITRO", label: "Non Nitro", premiumType: 0, premiumSource: I.NONE, premiumSubscriptionType: y.NONE },
    {
        id: "FRACTIONAL_WITHOUT_SUB",
        label: "Nitro Credit w/o sub",
        premiumType: 2,
        premiumSource: I.FRACTIONAL_NITRO,
        premiumSubscriptionType: y.NONE,
    },
    {
        ...
        premiumType: 2,
        premiumSource: I.FRACTIONAL_NITRO,
        premiumSubscriptionType: y.TIER_2,
    },
    {
        ...
        premiumType: 2,
        premiumSource: I.FRACTIONAL_NITRO,
        premiumSubscriptionType: y.TIER_1,
    },
    {
        ...
        premiumType: 2,
        premiumSource: I.FRACTIONAL_NITRO,
        premiumSubscriptionType: y.TIER_0,
    },
    {
        id: "NITRO_BASIC",
        label: "Nitro Basic",
...
let eN = "playground-gift-plan-selection-card-banner",
    ...
    ey = Q.VALENTINES_GIFTING_2026_FULL_HEARTS_SKU_ID;
var eE = n(823901);
function eS() {}
...
let e$ = i.forwardRef(function (e, t) {
    ...
    return (0, p.jsxs)("button", {
        ref: s,
        type: "button",
        className: ek()(eW.pc, { [eW.EV]: l }),
        onClick: ez,
        children: [
            r && (0, p.jsx)(eH.ls, { eventTargetRef: d, isNitro: !0, contentWidth: i }),
            (0, p.jsxs)("span", {
                className: eW.Hq,
                children: [
                    ...
                    null != a && (0, p.jsx)("div", { className: eW.UT, children: a }),
                ],
            }),
        ],
    });
...
function eZ(e) {
    let {
        ...
        i = (0, p.jsx)(e$, { ref: a, icon: eV.t, label: t, selected: n, decoration: o, showHoverGradient: l });
    return (0, p.jsxs)("nav", {
        className: eW.C$,
        children: [
            (0, p.jsx)(e$, { icon: ej.$, label: "Friends" }),
            null != r ? r(i) : i,
            (0, p.jsx)(e$, { icon: eK.U, label: "Shop" }),
            (0, p.jsx)(e$, { icon: ew.r, label: "Quests" }),
        ],
    });
}
var eq = n(52416);
    ...
    eX = {
        ...
        component: function (e) {
            ...
            eu(
                ...
                F(eQ, u.C.PREMIUM_TAB_POPOVER, "playground-premium-tab-popover-promotion", o)),
            );
            let A = i.useRef(null);
            return (0, p.jsx)(eZ, {
                selected: !0,
                nitroRowRef: A,
                wrapNitroRow: (e) => (0, p.jsx)(eq.A, { targetElementRef: A, dismissPopover: eJ, children: e }),
            });
        },
...
let tl = {
                    ...
                    component: function (e) {
                        ...
                        eu(
                            (function (e, t) {
                                ...
                                return F(eM, u.C.PAYMENT_MODAL_BANNER, "playground-payment-modal-banner-promotion", a);
                            })(
                                { body: t, assetUrl: n },
                ...
                eX,
                {
                    ...
                    component: function (e) {
                        ...
                        return (
                            ...
                            (0, p.jsx)(eZ, { selected: !0, wrapNitroRow: (e) => (0, p.jsx)(e0.A, { children: e }) })
                        );
                    },
                ...
                },
                {
                    ...
                    component: function (e) {
                        ...
                        eu(
                            ...
                            F(tn, u.C.SHOP_NAGBAR, "playground-shop-nagbar-promotion", o)),
                        );
                        let s = (0, te.c)(u.C.SHOP_NAGBAR),
                            c =
                                ...
                                onClick: () => {
                                    ...
                                    (r = {
                                        ...
                                        (i = {
                                            ...
                                            partner_id: null,
                                            marketing_components: [r],
                                            metadata: { gift_promotion: { reward_sku_ids: [ey] } },
                                        }),
                                        ee.h.dispatch({
                                            type: "ACTIVE_PROMOTIONS_FETCH_SUCCESS",
                                            promotions: [i],
                ...
                },
                {
                    ...
                    component: function (e) {
                        ...
                        return (
                            ...
                            (0, p.jsx)("div", {
                                className: j.MT,
                                children: (0, p.jsx)(eE.y, { markAsDismissed: eS, className: j.gO }),
                            })
                        );
                    },
        ...
        HeaderControl: function () {
            ...
            let l = i.useMemo(() => e5(t), [t]),
                a = i.useCallback((e, n) => e5((0, e1.Ht)(t, n, { keys: ["name"] })), [t]);
            return 0 === t.length
                ? null
                : (0, p.jsx)("div", {
                      className: j.$K,
