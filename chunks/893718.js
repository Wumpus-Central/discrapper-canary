            ...
            (i, u, d, f, _) => {
                ...
                e({
                    ...
                    let { shouldClear: i, shouldRefocus: s } = e,
                        c = eO(i, t),
                        u = null != a.current;
                    c && (ev(o) ? h.Z.saveDraft(o, '', t.drafts.type) : u && (null == (r = a.current) || r.clearValue())), u && (l(!1), (0, R._Q)(), s && (null == (n = a.current) || n.focus()));
                });
            },
            [a, e, s, t, o]
        );
...
function ex(e, t, n) {
    let [r, a] = (0, R.Iu)((e) => [e.activeView, e.activeViewType], u.X),
        o = (0, _.e7)([v.Z], () => v.Z.shouldShowPopup() && v.Z.activeViewType() === e),
...
function ej(e, t) {
    ...
    let { activeCommand: tu, activeCommandSection: td } = (0, _.cj)([O.Z], () => {
            var e, t;
            return {
                activeCommand: (null == (e = ep.commands) ? void 0 : e.enabled) ? O.Z.getActiveCommand(ea.id) : null,
                activeCommandSection: (null == (t = ep.commands) ? void 0 : t.enabled) ? O.Z.getActiveCommandSection(ea.id) : null
            };
        }),
    ...
    eC(ep, tp);
    let { eventEmitter: tA, handleEditorSelectionChanged: tC } = eR(tr, F, V),
                                    ...
                                    children: [
                                        ...
                                        e9
                                            ? (0, r.jsxs)('div', {
                                                  ...
                                                  children: [
                                                      t4 ? (0, r.jsx)(N.Z, { channel: ea }) : null,
