            ...
            (i, u, d, f, _) => {
                ...
                e({
                    ...
                    let { shouldClear: i, shouldRefocus: s } = e,
                        c = ev(i, t),
                        u = null != o.current;
                    c && (eO(a) ? h.Z.saveDraft(a, '', t.drafts.type) : u && (null == (r = o.current) || r.clearValue())), u && (l(!1), (0, R._Q)(), s && (null == (n = o.current) || n.focus()));
                });
            },
            [o, e, s, t, a]
        );
