...
function R(e, t, n) {
    ...
    t &&
        I(e) &&
        ((r = (e.offsetWidth > 0 && C(i.width) / e.offsetWidth) || 1),
    ...
    return n && ("html" === b(n) || ("body" === b(n) && "static" === w(n).position))
        ...
        : n ||
              (function (e) {
                  ...
                  if (/Trident/i.test(N()) && I(e) && "fixed" === w(e).position) return null;
                  var n = x(e);
...
var F = "bottom",
    ...
    z = [].concat(H, [j]).reduce(function (e, t) {
...
function er(e) {
    ...
    (I = y.x), (S = y.y);
    var N = _.hasOwnProperty("x"),
        v = _.hasOwnProperty("y"),
        R = B,
        O = "top",
        b = window;
    if (p) {
        ...
        k =
            !0 === E
                ? ((t = { x: I, y: S }),
                  ...
                  (i = t.x),
                  (r = t.y),
                  { x: C(i * (s = n.devicePixelRatio || 1)) / s || 0, y: C(r * s) / s || 0 })
                : { x: I, y: S };
    return ((I = k.x), (S = k.y), f)
        ...
        : Object.assign({}, x, (((a = {})[O] = v ? S + "px" : ""), (a[R] = N ? I + "px" : ""), (a.transform = ""), a));
}
...
function ep(e, t) {
    ...
    var n,
        ...
        j = g === K ? B : P,
        Y = {
            top: M.top - j.top + v.top,
            bottom: j.bottom - M.bottom + v.bottom,
            left: M.left - j.left + v.left,
            right: j.right - M.right + v.right,
        },
...
var eA =
        ((s =
            ...
            (r = (i = {
                            ...
                            if (I) {
                                if (void 0 === r || r) {
                                    var b,
                                        ...
                                        q = $[L],
                                        Z = eE(0, T[w], K[w]),
                                        X = m ? T[w] / 2 - U - Z - z - v.mainAxis : j - Z - z - v.mainAxis,
                                        Q = m ? -T[w] / 2 + U + Z + q + v.mainAxis : H + Z + q + v.mainAxis,
                                        en = t.elements.arrow && G(t.elements.arrow),
                                        ei = en ? ("y" === g ? en.clientTop || 0 : en.clientLeft || 0) : 0,
                                        er = null != (b = null == R ? void 0 : R[g]) ? b : 0,
                                        es = eE(d ? y(x, M + X - er - ei) : x, M, d ? S(k, M + Q - er) : k);
                                    (I[g] = es), (O[g] = es - M);
                                }
                                if (void 0 !== s && s) {
                                    var ea,
                                        ...
                                        eA = em ? eh : ec - T[ed] - C[ed] - eg + v.altAxis,
                                        eI = em ? ec + T[ed] + C[ed] - eg - v.altAxis : ef,
                                        eT =
                                            d && em
                                                ? (ea = eE(eA, ec, eI)) > eI
                                                    ? eI
                ...
                ? []
                : r),
        (o = void 0 === (a = i.defaultOptions) ? Z : a),
        function (e, t, n) {
            void 0 === n && (n = o);
            var i,
                r,
                            ...
                            if (X(t, n)) {
                                (a.rects = {
                                    reference:
                                        ...
                                        (_ =
                                            I(i) &&
                                            ((l = C((o = i.getBoundingClientRect()).width) / i.offsetWidth || 1),
                                            (d = C(o.height) / i.offsetHeight || 1),
                                            1 !== l || 1 !== d)),
                                        (h = D(i)),
                                        (f = R(t, _, r)),
                                ...
                                for (var i, r, s, o, l, d, _, h, f, p, E, m = 0; m < a.orderedModifiers.length; m++) {
                                    ...
                                    var A = a.orderedModifiers[m],
                                        ...
                                        N = A.name;
                                    "function" == typeof T &&
                                        (a = T({ state: a, options: y, name: N, instance: c }) || a);
                                }
                            }
                        }
                    },
        ...
        R = l.useMemo(
            function () {
                return {
                    ...
                    arrowProps: { style: C.arrow, ref: T },
                    forceUpdate: N || eC,
                    update: v || eN,
                };
            },
