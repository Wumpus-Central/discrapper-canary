...
function w(e) {
    ...
    g.some(N.$r) && (L.log("Found expired attachment link, clearing messages"), c.A.clear(n), (g = c.A.getOrCreate(n))),
        null != g.jumpTargetId &&
            null == s &&
        ...
        if ((c.A.commit(g.mutate({ loadingMore: !0 })), null != s))
            ...
            if (
                ...
                return (
                    ...
                    o.A.fetchMessages({
                        channelId: n,
                        limit: (0, v.h)("MessageManager.threadStart"),
            ...
            if (!(m?.isThread() && T.Ay.hasTrackedUnread(m.id)) || g.ready)
                return o.A.fetchMessages({
                    channelId: n,
                    limit: (0, v.h)("MessageManager.initialFetch"),
                    isPreload: u,
                    skipLocalFetch: f,
            ...
            return (
                ...
                o.A.fetchMessages({
                    channelId: n,
                    limit: (0, v.h)("MessageManager.threadUnread"),
...
function K(e) {
    ...
    i &&
        h.A.isConnected() &&
        u &&
        o.A.fetchMessages({ channelId: t, limit: (0, v.h)("MessageManager.staleFetch"), jump: n });
}
function $(e) {
