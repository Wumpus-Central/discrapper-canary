...
function F(e) {
    let t,
        ...
        v = (0, b.A)(n, T);
    T && d
        ? (t = w.intl.format(w.t.pkxVx6, { endDate: v, onClickDetails: p }))
        : T && !d
          ? (t = w.intl.format(w.t["4sFeob"], { endDate: v, onClickDetails: p }))
          : !T && d
            ? (t = w.intl.format(w.t["RBnE+l"], { endDate: v, onClickDetails: p }))
            : T || d || (t = w.intl.format(w.t["57+7Qn"], { endDate: v, onClickDetails: p }));
    let I = T ? w.intl.string(w.t["2cHUti"]) : w.intl.string(w.t.O13yhz),
        y = s.useCallback(() => h(!1), []),
...
let z = function () {
    let e = (0, d.yK)([R.A], () => R.A.getGiftable()),
        ...
        l = (0, d.bG)([O.default], () => D.Ay.isPremiumExactly(O.default.getCurrentUser(), V.PremiumTypes.TIER_2)),
    ...
    return m && f
        ? (0, i.jsxs)(i.Fragment, {
              children: [
                  (function () {
                      let e = n.find((e) => e.giftCodeBatchId === V.FB && !e.consumed),
                          t = n.filter((e) => e.giftCodeBatchId === V.Bu && !e.consumed) ?? [],
                          [s, r] = o().partition(t, (e) => {
                              let { subscriptionPlanId: t } = e;
                              return t === V.gD.PREMIUM_YEAR_TIER_2;
                          }),
                          d = (0, i.jsx)(u.D, {
                              variant: "heading-md/semibold",
                              children: H ? w.intl.string(w.t.wFsj3B) : void 0,
                          }),
                          g = Y
                              ? (0, i.jsxs)("div", {
                                    className: B.uo,
                                    children: [
                                        ...
                                        (0, i.jsx)(c.E, {
                                            ...
                                            className: B.Qw,
                                            children: w.intl.format(w.t.G4fwxK, {
                                                onClick: () => {
                                        ...
                                        (0, i.jsx)(I.A, {
                                            ...
                                            textOptions: { textOverride: w.intl.string(w.t.mr4K7D) },
                                        }),
                                    ],
                                })
                              : null;
                  ...
                  (0, i.jsx)("div", {
                      ...
                      children: (0, i.jsxs)(p.F, {
                          component: (0, i.jsx)(u.D, {
                              variant: "heading-md/semibold",
                              children: w.intl.string(w.t["9KeUbY"]),
                          }),
                          children: [
                              ...
                              0 === Object.keys(g).length
                                  ? (0, i.jsxs)("div", {
                                        ...
                                        children: [
                                            ...
                                            (0, i.jsx)(p.H, { className: B.ks, children: w.intl.string(w.t.B1qgZn) }),
                                            (0, i.jsx)("p", {
                                                className: B.WO,
                                                children: w.intl.format(w.t.HezvJ8, {
                                                    onClick: function () {
