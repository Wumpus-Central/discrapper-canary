...
let p = {
    ...
    g = (e) => {
        ...
        return (
            ...
            (0, r.jsx)('div', {
                style: i,
                className: a()(f.jumbleWrapper, {
                    [f.peaking]: t,
                    [f.transitioned]: g
                }),
                children: b.map((e, t) => {
                    var l, i;
                    let { top: a, left: c, rotation: b, size: g, skuId: h } = e,
                        _ = null == (l = m[t]) ? void 0 : l.items[0],
                        C = null == (i = m[t]) ? void 0 : i.type,
                    ...
                    return (0, r.jsxs)(
                        'div',
                        {
                            ...
                            children: [
                                null != _ && C === o.Z.AVATAR_DECORATION && (0, r.jsx)(u.R, { item: _ }),
                                null != _ &&
                                    C === o.Z.PROFILE_EFFECT &&
                                    (0, r.jsx)(s.Z, {
