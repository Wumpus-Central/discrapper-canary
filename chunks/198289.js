...
function w(e) {
    let { selectedColors: a, setSelectedColors: s, defaultColor: i, selectedEffectId: n, className: r } = e,
        ...
        o = (0, t.useCallback)(
            (e) => {
                s([e]), p.default.track(L.HAw.DISPLAY_NAME_STYLES_COLOR_SELECTED, { default: e === i, colors: [e] });
            },
            [s, i],
        ),
        c = (0, t.useCallback)(
            (e) => {
                s(e), p.default.track(L.HAw.DISPLAY_NAME_STYLES_COLOR_SELECTED, { default: !1, colors: e });
            },
            [s],
        );
    return (0, l.jsxs)("div", {
            ...
            (0, l.jsx)(z.B, {
                ...
                children: k.rA.map((e) => {
                    ...
                    return (0, l.jsx)(
                        Q.m,
                        {
                            text: M.intl.string(t.name),
                            asContainer: !0,
                            children: (0, l.jsx)(F.D, {
                                className: Y()($.SO, { [$.wH]: i }),
                                onClick: () => s(e),
                                "aria-label": M.intl.string(t.name),
                                children: (0, l.jsx)(V.E, {
                                    variant: "text-lg/semibold",
                                    color: i ? "text-strong" : "text-default",
                                    className: Y()($.FH, t.className),
                                    children: "Gg",
                                }),
                            }),
                        },
                    ...
                    children: [
                        ...
                        (0, l.jsx)(V.E, {
                            ...
                            children: M.intl.format(P.default.PWf0xS, {
                                onClickNitro: () => {
                                    p.default.track(L.HAw.DISPLAY_NAME_STYLES_NITRO_CLICKED), (0, ea.x)(t);
                                },
                            }),
                        }),
                    ],
                    ...
                    children: [
                        ...
                        (0, l.jsx)(es.A, {
                            premiumModalAnalyticsLocation: {
                                section: L.JJy.DISPLAY_NAME_STYLES_MODAL_FOOTER,
                                object: L.ZSU.PREMIUM_UPSELL_BUTTON,
                            },
...
function eT(e) {
    let {
        ...
        S = (0, d.cf)([I.A], () => I.A.getPendingChanges(s?.id)),
        E = (0, eS.V7)({ userId: a.id, image: S.pendingAvatar }),
        { userNameplate: C, guildNameplate: j, pendingNameplate: _ } = (0, f.rv)(a, s?.id),
        T = (0, eN.WK)(j);
    x && !N ? (u = L.NJ8.DARK) : !x && N && (u = L.NJ8.LIGHT);
    let v = (0, t.useCallback)(() => {
            p.default.track(L.HAw.DISPLAY_NAME_STYLES_CLOSED), m();
        }, [m]),
        D = (0, t.useCallback)((e) => {
            A(e === L.NJ8.DARK), p.default.track(L.HAw.DISPLAY_NAME_STYLES_THEME_TOGGLE, { dark: e === L.NJ8.DARK });
        }, []),
        y = (0, t.useMemo)(
    ...
    return (0, l.jsxs)("div", {
        ...
        children: [
            (0, l.jsx)(c.rQ, {
                ...
                separator: !1,
                className: eI.bV,
                children: (0, l.jsx)(c.s_, { "data-migration-pending": !0, onClick: v, innerClassName: eI.b }),
            }),
            null != h &&
                (0, l.jsx)(ej.A, {
                    user: a,
                    ...
                    className: eI.LX,
                    forceUserTheme: !0,
                    children: (0, l.jsx)("div", { className: eI.b8, style: { backgroundImage: `url(${h})` } }),
                }),
            (0, l.jsx)(ed.N, {
                theme: u,
                children: (e) =>
                    (0, l.jsxs)("div", {
                        ...
                        children: [
                            ...
                            (0, l.jsx)(ep.A, {
                                author: y,
                                message: (0, ef.rh)({
                                    ...(0, eA.Ay)({ channelId: "1337", content: M.intl.string(P.default.h5Cuej) }),
                                    state: L.cmJ.SENT,
                                    id: "0",
                                }),
                                isGroupStart: !0,
                            ...
                            (0, l.jsx)(ex.A, {
                                ...
                                guildId: s?.id,
                                nameplate: _,
                                nameplateData: null == _ ? (T ?? C) : void 0,
                                pendingGlobalName: i,
                                pendingDisplayNameStyles: y.displayNameStyles,
                                isHighlighted: !0,
                                className: eI.qF,
            ...
            (0, l.jsxs)("div", {
                ...
                children: [
                    (0, l.jsx)(V.E, {
                        ...
                        color: "text-muted",
                        children: M.intl.format(P.default.prQba8, {
                            helpArticleLink: e_.A.getArticleURL(L.MVz.DISPLAY_NAME_STYLES),
                        }),
                    }),
                    (0, l.jsx)(ev, { darkPreview: x, onToggleTheme: D }),
                ],
            }),
        ],
    });
        ...
        options: [
            {
                ...
                value: L.NJ8.DARK,
                icon: ec.Z,
                className: t === L.NJ8.DARK ? eI.iB : void 0,
            },
            {
                name: "",
                ...
                value: L.NJ8.LIGHT,
                icon: em.F,
                className: t === L.NJ8.LIGHT ? eI.iB : void 0,
            },
        ],
        value: t,
        onChange: (e) => {
...
function ey(e) {
    let a,
        ...
        G =
            ((a = v.Ay.useName(O)),
            (0, d.bG)([I.A, T.Ay], () => {
                let e = I.A.getPendingChanges(y);
                return null != y ? (e.pendingNickname ?? T.Ay.getNick(y, O?.id)) : e.pendingGlobalName;
            }, [y, O]) ??
                a ??
                ""),
        R = (0, d.bG)([A.A], () => A.A.getGuild(y)),
        { userDisplayNameStyles: Y, guildDisplayNameStyles: z, pendingDisplayNameStyles: F } = (0, f.B0)(O, y),
        U = void 0 !== F ? F : (z ?? Y),
        [H, J] = t.useState(U?.fontId ?? r.x.DEFAULT),
        [K, V] = t.useState(U?.effectId ?? n.z.SOLID),
        X = (0, S.as)(K) > 1,
        Q = (0, C._)(K),
        W = (0, C._)(n.z.GRADIENT),
        $ = U?.colors ?? [],
        [Z, ee] = t.useState($.length > 0 && !X ? $[0] : Q.defaultColors[0]),
        [ea, es] = t.useState($.length > 0 && X ? $ : W.defaultColors);
    (0, x.A)(
        { type: i.ImpressionTypes.POPOUT, name: i.ImpressionNames.DISPLAY_NAME_STYLES_MODAL },
        { trackOnInitialLoad: !0 },
    );
    let { analyticsLocations: el } = (0, N.Ay)(D, u.A.EDIT_DISPLAY_NAME_STYLES_MODAL),
        et = t.useMemo(() => (X ? ea : [Z]), [X, ea, Z]),
        ei = t.useMemo(() => H !== U?.fontId || K !== U?.effectId || !(0, o.v)(et, U?.colors ?? []), [U, H, K, et]),
        { enabled: er } = E.useConfig({ location: "DisplayNameStylesModal" }),
        ed = (function (e) {
            let {
                hasChanges: a,
                selectedFontId: s,
            ...
            return t.useCallback(() => {
                if (a) {
                    ...
                    c ? (0, j.EW)(a) : (0, _.p)({ guildId: o, displayNameStyles: a }),
                        p.default.track(L.HAw.DISPLAY_NAME_STYLES_APPLIED, {
                            font_name: r.x[s],
                            effect_name: n.z[l],
                            colors: i,
                        }),
        ...
        eo = t.useCallback(() => {
            let { fontId: e, effectId: a, colors: s } = (0, S.gN)(er);
            J(e), V(a), (0, S.as)(a) > 1 ? es(s) : ee(s[0]), p.default.track(L.HAw.DISPLAY_NAME_STYLES_SURPRISE_ME);
        }, [er, es, ee]),
        ec = t.useCallback(
            (e) => {
                V(e);
                          ...
                          (0, l.jsxs)(c.$m, {
                              ...
                              children: [
                                      ...
                                      children: [
                                          (0, l.jsx)(c.rQ, {
                                              ...
                                              children: (0, l.jsx)(m.D, {
                                                  ...
                                                  children: M.intl.string(P.default.ZPMAlX),
                                              }),
                                          }),
                                          (0, l.jsx)(q, {
                                              selectedFontId: H,
                                  ...
                                  (0, l.jsx)(eT, {
                                      ...
                                      selectedFontId: H,
                                      selectedEffectId: K,
                                      selectedColors: K === n.z.SOLID && (0, o.v)(et, Q.defaultColors) ? [] : et,
                                      onClose: b,
                                  }),
                              ],
                          }),
