n.d(e, { H1: () => B, Lk: () => K, TQ: () => G, Xf: () => F, _c: () => W, c9: () => H, dN: () => V, ix: () => N });
var i = n(627968),
    r = n(64700),
    s = n(925747),
    l = n(17928),
...
var A = n(87719),
    ...
    I = n(985018);
function N(t) {
    let { quest: e, questContent: n, questContentPosition: i, questContentRowIndex: s, sourceQuestContent: u } = t,
...
let F = (t) => {
        let { useReducedMotion: e, className: n } = t,
            ...
            C = (0, s.animated)(o.f);
        return {
            render: () => (0, i.jsx)(C, { className: n, style: e ? void 0 : l, color: "currentColor", size: "xs" }),
            startAnimation: (t) => {
                (c.current = !0),
                    a({
                        from: { rotate: "0deg" },
...
function w(t) {
    return (0, q.vl)(t)
        ? t.config.features.includes(D.Li.CLOUD_GAMING_ACTIVITY)
            ? { text: I.intl.string(I.t["+qoymD"]), questContentCTA: p.Cy.START_QUEST }
            : { text: I.intl.string(I.t.E4kW5O), questContentCTA: p.Cy.START_QUEST }
        : (0, q.Ov)(t)
          ? { text: I.intl.string(I.t.CkUzLd), questContentCTA: p.Cy.START_QUEST }
          : { text: I.intl.string(I.t.l7E81v), questContentCTA: p.Cy.ACCEPT_QUEST };
}
function W(t) {
    let {
            quest: e,
        ...
        C = N({ quest: e, questContent: i, questContentPosition: s, questContentRowIndex: l, sourceQuestContent: c }),
        T = (0, x.RR)({ quest: e }),
        A = (0, x.fc)(e),
        f = (0, y.vU)()?.getId(),
    ...
    return r.useMemo(() => {
        switch (n) {
            ...
            case x.F3.IN_PROGRESS:
                ...
                return { text: I.intl.string(I.t.cfY4PE), tooltipText: I.intl.string(I.t.hsbwjv), onClick: null };
            case x.F3.COMPLETED:
                return { text: I.intl.string(I.t.cfY4PE), tooltipText: null, onClick: C };
            case x.F3.CLAIMED:
                return {
                    tooltipText: null,
                    onClick: C,
                    text: (0, k.r7)(e.config) ? I.intl.string(I.t.bAGFz3) : I.intl.string(I.t.vTgCWx),
                };
        }
    }, [n, o, T, u, C, e, i, s, l, f, A, a, d, c, E]);
}
function V() {
    let { enableNewRequestBehavior: t } = v.A.useConfig({ location: "useQuestBarQuest" }),
        e = (0, Q.A)(g.yW.DESKTOP_ACCOUNT_PANEL_AREA),
        n = (0, l.bG)(
            [E.A],
            () =>
                E.A.questDeliveryOverride ??
                (0, O.t6)(E.A.quests, E.A.questToDeliverForPlacement, g.yW.DESKTOP_ACCOUNT_PANEL_AREA) ??
                null,
        );
    return t ? e : n;
}
function G(t) {
    let { quest: e } = t,
        n = (0, S.s)(),
        i = (0, x.LS)(e),
        { premiumSubscription: r } = (0, l.cf)([d.A], () => ({ premiumSubscription: d.A.getPremiumSubscription() })),
    ...
    let u = e.userStatus?.claimedAt != null,
        o = !s && null != e.userStatus && (0, O.gO)(e.userStatus, g.uF.QUEST_BAR);
    return u
...
function K(t) {
    ...
    return (0, T.I)(
        r.useCallback(() => {
            e && ((0, b.Xm)(n, i), (0, a.P0)((0, c.o)(I.intl.string(I.t["+5kSoW"]), C.Ck.SUCCESS)));
        }, [e, n, i]),
        3e3,
        [],
        M,
