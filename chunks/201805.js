...
function G(e) {
    ...
    return s.useCallback(() => {
        null != t &&
            ((0, h.E5)(h.kI.STEP_2_CLICKED_INTERNAL, "quest_claim_reward")
                ? (0, A.r)({
...
let W = (e, t, n) => {
    ...
    return (0, r.jsx)("span", {
        onClick: function (r) {
            ...
            let o = s.getAttribute("href") === i ? R.Cy.HOW_TO_HELP_ARTICLE_XBOX : R.Cy.HOW_TO_HELP_ARTICLE_PLAYSTATION;
            (0, h.E5)(h.kI.STEP_2_CLICKED_INTERNAL, "quest_how_to_help_article")
                ? (0, A.r)({
                      type: E.F.CLICK_INTERNAL,
                      adCreativeType: l.p.QUEST,
                      adCreativeId: e,
...
function X(e) {
    let {
        ...
        d = G({ quest: t, questContent: r, questContentPosition: i, questContentRowIndex: l, sourceQuestContent: c }),
        C = (0, Q.RR)({ quest: t }),
        f = (0, Q.fc)(t),
        A = (0, U.vU)()?.getId(),
        ...
        switch (n) {
            case Q.F3.UNACCEPTED:
                let e = j.intl.string(j.t.kUQLMJ),
                    s = R.Cy.ACCEPT_QUEST;
                return (
                    a && ((e = j.intl.string(j.t.umdNin)), (s = R.Cy.START_QUEST)),
                    (o || (0, F.vl)(t)) && ({ text: e, questContentCTA: s } = z(t)),
                    {
                        text: e,
                        tooltipText: null,
                        onClick: async () => {
            ...
            case Q.F3.CLAIMED:
                return {
                    tooltipText: null,
                    onClick: d,
                    text: (0, q.r7)(t.config) ? j.intl.string(j.t.bAGFz3) : j.intl.string(j.t.vTgCWx),
                };
        }
    }, [n, a, C, u, d, t, r, i, l, A, f, o, E, c, _]);
}
function Y() {
    let e = (0, L.Ay)(I.p9.DESKTOP_ACCOUNT_PANEL_AREA);
    return (0, u.bG)([y.A], () => y.A.getQuestPreviewOverride(I.uF.QUEST_BAR_V2), []) ?? e;
}
function $(e) {
    let { quest: t } = e,
        n = (0, x.s)(),
        ...
        i = (0, u.bG)([y.A], () => null != y.A.getQuestPreviewOverride(I.uF.QUEST_BAR_V2), []);
    ...
    if ((0, q.K9)(t.config) && s?.isPurchasedExternally)
        return { isQuestBarVisible: !1, reason: "premium_subscription_is_purchased_externally" };
    let a = null != t.userStatus && (0, O.gO)(t.userStatus, I.uF.QUEST_BAR);
    return l
