...
function A(e) {
    ...
    F || t === U || W(!0);
    let H = [];
    _ && H.push(w), G && "compact" !== g && H.push(L);
    ...
    let z = (0, i.jsxs)("div", {
        ref: R,
        className: r()(h.LL, { [h.JD]: O, [h.xe]: P, [h.r9]: T }),
        onMouseDown: T
            ? void 0
            : function (e) {
                  e.preventDefault();
    ...
    return (0, i.jsx)("div", {
        ...
        className: r()(
            h.kL,
            { [h.oE]: "compact" === g, [h.c1]: "multiline" === g, [h.CP]: y, [h.WK]: N, [h.Dy]: t },
            E,
        ),
        onBlur: C,
        onKeyDown: S,
                ...
                children: t
                    ...
                    : (0, i.jsxs)(i.Fragment, {
                          children: [
                              ...
                              G && "compact" !== g && (0, i.jsx)(j, { id: L, message: M, type: D }),
                          ],
                      }),
            },
            t ? "editing" : "preview",
