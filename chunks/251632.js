...
function Y(e) {
    let { transitionState: n, onClose: l, guildId: R, action: G, onSave: Y, onDelete: z } = e,
        Q = i.useRef(null),
        X = i.useRef(null),
        K = null == G || null == I.A.getChannel(G.channelId) ? null : G.channelId,
        [Z, q] = i.useState(K),
        ...
        [eo, er] = i.useState(null == G ? null : (en.find((e) => e.value === G.actionType)?.value ?? null)),
        [ec, ed] = i.useState(G?.emoji ?? null),
        eu = (0, s.bG)([H.A], () => H.A.getNewMemberAction(G?.channelId)?.icon),
        em = G?.channelId,
        ...
        eb = i.useCallback(() => {
            ...
            let e = void 0 !== em && Z !== em,
                n = void 0 !== eh,
                t = null != ec || void 0 !== eg,
                i = { icon: eg ?? null, emoji: ec };
            (e || (n && t)) && (n && (0, L.Rp)(em), (0, L.J4)(Z, i));
            let a = ec !== ej,
                s = eg !== ep;
            Y(
                {
                ...
                l();
        }, [Y, l, ei, eo, Z, ec, eu, eg, ej, ep, em, eh]),
        eC = i.useCallback(() => {
            z?.(), l();
        }, [z, l]),
        eN = i.useCallback(
                ...
                M.Ay.getSelectableChannels(R)
                    ...
                    .map((e) => {
                        ...
                        return {
                            id: e.channel.id,
                            value: e.channel.id,
                            label: (0, S.m1)(e.channel, w.default, D.A),
                            leading: l ?? void 0,
                        };
                    }),
            [R, es],
        ...
        null != ef
            ? (0, t.jsxs)(t.Fragment, {
                  children: [
                      ...
                      (0, t.jsx)("div", {
                          className: U.gu,
                          children: (0, t.jsx)(g.R, { size: "md", color: "currentColor" }),
                      }),
                  ],
              })
            : null != ec
              ...
              : (0, t.jsx)(x.X, { size: "md", color: "currentColor" });
    let ek = i.useMemo(
        () => [
    ...
    return (0, t.jsxs)(a.Modal, {
        ...
        actions: ek,
        actionBarInput:
            null != G ? (0, t.jsx)(j.Q, { text: O.intl.string(O.t.N86XcP), onClick: eC, variant: "critical" }) : void 0,
        children: [
            (0, t.jsxs)("div", {
                className: U.eH,
                children: [
