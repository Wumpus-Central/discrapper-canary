...
function W(e) {
    ...
    function s(e) {
        (v.default.track(w.rMx.EXPRESSION_PICKER_SOUNDBOARD_SOUND_PREVIEWED, {
            sound_id: t.soundId,
            sound_name: t.name,
            ...
            (e) => {
                (e.stopPropagation(),
                    ...
                    s
                        ...
                        : ((0, A.lF)({
                              sound: t,
                              location: M(k({}, a), { object: w.qAy.SOUNDBOARD_SOUND })
                          }),
                          (0, I.TB)(t.soundId)));
            },
            [s, t, a]
...
let q = i.forwardRef(function (e, t) {
    var n,
        ...
        y,
        v,
        { sound: I, channel: T, containerClassName: w, className: x, focused: j, forceSecondaryActions: G = !1, interactive: Y = !0, enableSecondaryActions: q = !1, suppressPlaySound: $, onMouseEnter: X, onSelectItem: Q, analyticsLocations: J, buttonOverlay: ee = S.Pb.PLAY, showLockForDisabledSound: et = !0, inNitroLockedSection: en = !1, isAnimated: er = !0, isPlayingSoundOverride: ei, isSoundmoji: ea, soundmojiVisualEffectRef: eo, tooltipOverride: es, tooltipClassName: el, tooltipContentClassName: ec } = e,
    ...
    let { name: ed, emojiId: ef, emojiName: e_ } = I,
        ...
        { playSoundboardSound: em, previewSound: eg, isPlayingSound: eE } = (0, N.Z)(I, null != (u = null == T ? void 0 : T.id) ? u : null, null != (p = ea ? b.AY.getSetting() : null == (n = b.kU.getSetting()) ? void 0 : n.volume) ? p : 100, !ea && (null == T ? void 0 : T.isVocal()) ? P.w.VOICE : P.w.DEFAULT),
        ...
        ew = !(0, A.Nq)(ep, I, T) && !ea,
        eR = G || (q && !ew),
        eP = null != (y = m.Wq.useStore().bottomPosition) ? y : 0,
        eD = (null != (v = null == (a = ey.current) ? void 0 : a.getBoundingClientRect().bottom) ? v : 0) + 50 > eP ? 'top' : 'bottom',
        [eL, ex] = i.useState(!1),
        ek = ew && et;
    function ej() {
        $ || em(J);
    ...
    function eM(e) {
        if ((eS && !ev && ((eI.current = Math.min(eI.current + V, F)), Math.random() < eI.current && eb(eO.x, eO.y, void 0, void 0, { sprite: R.vv })), null != Q)) return void Q(e);
        ej();
    }
    let eU = W({
            sound: I,
        ...
        eZ = () =>
            ek && !en
                ...
                : (0, r.jsxs)('div', {
                      className: L.buttonOverlay,
                      children: [
                          (0, r.jsx)('div', { className: o()({ [L.buttonOverlayBackground]: !$ }) }),
                          (0, r.jsx)('div', {
                              className: L.buttonOverlayActions,
                              children:
                                  ee === S.Pb.SOUNDMOJI
        ...
        children: [
            ...
            !I.available &&
                (0, r.jsx)(d.ua7, {
                    ...
                    children: (e) => (0, r.jsx)('div', k({ className: L.unavailableTooltip }, e))
                }),
            !0 === ea &&
                (0, r.jsx)(E.Z, {
                    sound: I,
