                                                    ...
                                                    (e.exports = function (e) {
                                                        ...
                                                        var T = r.float_array(E),
                                                            ...
                                                            G = {
                                                                ...
                                                                flush: function (e) {
                                                                    (N = 0), (w = [0, 0]), (M = 0), (j = 0), (I = 0);
                                                                    for (var t = 0; t < 2; t++)
                                                                        for (var n = 0; n < v; n++) V[t][n] = 0;
                                                        ...
                                                        var W = function (e, t, n) {
                                                            ...
                                                            H = function () {
                                                                ...
                                                                r.blit(d, 2 * f, d, 0, u - f),
                                                                    ...
                                                                    s.inplace(!0);
                                                                var n = c.length;
                                                                for (r.blit(c, M, c, 0, n - M), t = n - M; t < n; t++)
                                                                    c[t] = 0;
                                                                var i = 0,
                                                                    a = R;
                                                                for (t = 0; t < h; t++)
                        ...
                        return (
                            (a.drawFrame = function (u) {
                                ...
                                if (
                                    ...
                                    b(p, 0, u.y.stride), b(v, 0, (u.u.stride * y.width) / y.chromaWidth);
                                }
                                E("uTextureY", D, u.y.stride, y.height, u.y.bytes),
                                    E("uTextureCb", D, u.u.stride, y.chromaHeight, u.u.bytes),
                                    E("uTextureCr", D, u.v.stride, y.chromaHeight, u.v.bytes),
                                    i.stripe &&
                                        (w("uTextureY", D, u.y.stride, y.height),
                                        w("uTextureCb", D, u.u.stride, y.chromaHeight),
                                        w("uTextureCr", D, u.v.stride, y.chromaHeight)),
                                    o.useProgram(t),
                        ...
                        convertYCbCr: function (e, n) {
                            ...
                            if (1 == a && 1 == o)
                                for (D = 0, b = h, x = 0, T = 0; T < i; T += 2) {
                                    for (
                                        v = ((m = (T * d) | 0) + d) | 0, _ = (x * c) | 0, g = (x * f) | 0, V = 0;
                                        V < r;
                                        V += 2
                                    )
                                        (C = 0 | s[_++]),
                                ...
                                for (y = 0, T = 0; T < i; T++)
                                    for (
                                        k = 0, p = (T * d) | 0, _ = ((x = T >> o) * c) | 0, g = (x * f) | 0, V = 0;
                                        V < r;
                                        V++
                                    )
                                        (C = 0 | s[_ + (k = V >> a)]),
