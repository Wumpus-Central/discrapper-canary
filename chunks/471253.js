...
function N(e, t) {
    ...
    return (
        ...
        t && (0, s.yw)(T.rMx.REQUEST_TO_SPEAK_INITIATED, S({}, (0, O.s$)(e))),
        o.tn.patch({
...
function m(e, t) {
    ...
    return (
        (0, p.gf)(l) !== p.xO.REQUESTED_TO_SPEAK_AND_AWAITING_USER_ACK || t || (0, s.yw)(T.rMx.PROMOTED_TO_SPEAKER, S({}, (0, O.s$)(e))),
        o.tn.patch({
