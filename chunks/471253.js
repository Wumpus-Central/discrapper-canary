...
function T(e, t) {
    ...
    return (
        ...
        t && (0, c.yw)(C.rMx.REQUEST_TO_SPEAK_INITIATED, g({}, (0, E.s$)(e))),
        o.tn.patch({
...
function S(e, t) {
    ...
    return (
        (0, p.gf)(l) !== p.xO.REQUESTED_TO_SPEAK_AND_AWAITING_USER_ACK || t || (0, c.yw)(C.rMx.PROMOTED_TO_SPEAKER, g({}, (0, E.s$)(e))),
        o.tn.patch({
