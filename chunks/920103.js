...
class o {
    ...
    start() {
        ...
        (this.animating = !0),
            ...
            (this.nextTick =
                null != (t = null == (e = this.nodeWindow) ? void 0 : e.requestAnimationFrame(this.update)) ? t : -1);
    }
    getUpdates(e, t) {
    ...
    stop(e) {
        var t;
        null == (t = this.nodeWindow) || t.cancelAnimationFrame(this.nextTick),
            (this.animating = !1),
            (this.accumulator = 0),
        ...
        r(this, "tension", void 0),
            ...
            r(this, "update", (e) => {
                ...
                if (null == this.last) {
                    (this.last = e),
                        (this.nextTick =
                            null != (n = null == (t = this.nodeWindow) ? void 0 : t.requestAnimationFrame(this.update))
                                ? n
                                : -1);
                    return;
                }
