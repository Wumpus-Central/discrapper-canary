...
function I(e, t) {
    let { subscriptionTrial: n, subscriptionPlan: i, overrideAmount: a, isPrepaidPaymentSource: c, currency: d } = t,
...
function y(e, t) {
    var n;
    let { subscriptionPlanInvoiceItem: i, coalescedInvoiceItems: r } = T(e, t);
    if (null == i)
        throw new a.v({
    ...
    let o = r.find((e) => !(0, l.z4)(e.subscriptionPlanId) && e.amount < 0),
        ...
        g = r.filter(
            (e) =>
                e.subscriptionPlanId === d.gD.PREMIUM_MONTH_GUILD || e.subscriptionPlanId === d.gD.PREMIUM_YEAR_GUILD,
        ),
    ...
    return (
        0 === m ||
            ...
            I.push({
                ...
                label: f.intl.formatToPlainString(f.t.ZSVged, { planName: (0, l.ys)(t.id) ? (0, l.RH)(t.id) : t.name }),
