...
let g = (e) => {
    ...
    S = (e) => {
        let t = (0, c.Z)(e.invoiceItems),
            ...
            i = t.find((e) => (0, l.z4)(e.subscriptionPlanId) && e.amount >= 0);
    ...
    N = (e, t) => {
        let { isPrepaidPaymentSource: n = !1 } = t,
            { guildSubscriptionInvoiceItem: i, ...r } = S(e),
            a = (0, s.bG)([o.A], () => (null != i ? o.A.get(i.subscriptionPlanId) : null)),
            l = y(a, i, { currency: e.currency, isPrepaidPaymentSource: n });
        return { ...r, guildSubscriptionInvoiceItem: i, guildSubscriptionPlan: a, ...l };
    },
    v = (e, t) => {
        let { isPrepaidPaymentSource: n = !1 } = t,
            { guildSubscriptionInvoiceItem: i, ...r } = S(e),
            s = null != i ? o.A.get(i.subscriptionPlanId) : null,
            a = y(s, i, { currency: e.currency, isPrepaidPaymentSource: n });
        return { ...r, guildSubscriptionInvoiceItem: i, guildSubscriptionPlan: s, ...a };
    },
    C = (e, t) => {
        let n,
            { subscriptionPlanInvoiceItem: i, coalescedInvoiceItems: s } = T(e, t);
