...
class N extends (r = a.Component) {
    ...
    renderLayer() {
        ...
        let { position: e, align: t, nudgeAlignIntoViewport: n, useRawTargetDimensions: r, spacing: a, autoInvert: o, fixed: s, positionKey: l, disablePointerEvents: c, layerContext: u, clickTrap: f = !1 } = this.props,
