...
let Z = (0, a.Qx)(u.X.ACTIVITY_PRIVACY_PER_GUILD_DEFAULT_SETTING, {
    ...
    setValue: function (e) {
        ...
        (0, K.openModalLazy)(async () => {
            let { default: e } = await Promise.all([i.e("46662"), i.e("81849"), i.e("62041"), i.e("41996")]).then(
                i.bind(i, 32167),
            );
            return (t) =>
        ...
        children: (0, E.jsxs)("div", {
            ...
            children: [
                (0, E.jsx)(g, {
                    ...
                    size: a8.$n.Sizes.SMALL,
                    onClick: () =>
                        (0, Tj.XD)({ uploadType: TY.HL.BANNER, analyticsSource: c, guildId: s, isTryItOut: o }),
...
function px(e) {
    ...
    return (0, E.jsx)("div", {
        ...
        children: (0, E.jsx)(J.d, {
            ...
            checked: !s,
            onChange: (e) => {
                !e === n ? (0, Tu._e)() : (0, TB.p)({ legacyUsernameDisabled: !e });
            },
        }),
    });
}
                        ...
                        children: [
                            (0, E.jsxs)(Th.V, {
                                ...
                                onItemSelect: function (e) {
                                    if (s !== e) {
                                        if (i) {
                                            (0, l6.fO)({ duration: 300, intensity: 1.4 }),
        ...
        : ec.A.getGuildsArray().filter((e) => e.ownerId === t.id).length > 0
          ...
          : t.isClaimed()
            ? (0, K.openModal)((t) =>
                  (0, E.jsx)(Nf.default, {
                      ...t,
                      handleSubmit: (t) => (0, Tu.U_)(t, e).then(U.tEg, NN),
...
let _a = (0, a.zD)(u.X.CLIPS_ENABLE_DECOUPLED_CLIPPING, {
    ...
    _h = (0, a.zZ)(u.X.CONNECTIONS_ADD_CONNECTIONS_CATEGORY, { buildLayout: () => [Te], useInlineNotice: Tn }),
    _E = (0, a.zZ)(u.X.CONNECTIONS_CONNECTED_ACCOUNTS_CATEGORY, { buildLayout: () => [Tt] }),
...
function _G() {
    let e = (0, pX.aX)(_O.t.REACTIVE_CHECK),
        t = (0, pY.b8)();
    return S.useMemo(() => {
...
let Ii = (0, a.Qx)(u.X.CONTENT_AND_SOCIAL_DM_SPAM_SETTING, {
    ...
    In = (0, a.zZ)(u.X.CONTENT_CATEGORY, {
        ...
        buildLayout: () => ((0, o.Bv)("ContentCategory") ? [_2, _8, _F, _z, _X] : [_2, Ii, _8, _F, _z]),
    });
var Is = i(189883);
    ...
    if (t === IC.YG) {
        ...
        (i = !e),
            (0, Iw.O)({
                ...
                onCancel: function () {
                    L.n6.updateSetting(i), L.$s.updateSetting(i ? ec.A.getGuildIds() : []), IX(i, !0);
                },
            });
    } else {
        let i = (0, l6.Tb)();
...
let CI = (0, a.zD)(u.X.PERSISTENT_VERIFICATION_CODES_SETTING, {
    ...
    useSubtitle: () => j.intl.format(j.t["/T+ZlP"], { helpArticle: (0, C_.Lu)() }),
    useValue: function () {
...
function CO(e) {
    ...
    return (
        ...
        (0, E.jsxs)("div", {
            className: Cj.uW,
            children: [
                null != s && (0, E.jsx)(Cy.A, { className: Cj.my, user: s, size: i7._3.SIZE_40 }),
                (0, E.jsxs)("div", {
                    className: Cj.Qq,
                    children: [
                        (0, E.jsx)(en.D, {
                ...
                (0, E.jsx)(en.D, { onClick: r, className: Cj.Qz, children: (0, E.jsx)(rz.u, { size: "xs" }) }),
            ],
        })
    );
}
function CR(e) {
    let { className: t, userId: i, verification: n, index: s } = e,
        l = (0, C_.tC)(n.timestamp),
        r = S.useCallback(() => {
            (0, C_.W0)(i, n.verifiedKey);
        }, [n.verifiedKey, i]);
    return (0, E.jsxs)("div", {
        className: t,
        children: [
            ...
            return (0, E.jsxs)(_$.h, {
                children: [
                    (0, E.jsx)(_$._, {
                        ...
                        description: j.intl.format(j.t.jrTSWU, { helpArticle: (0, C_.dc)() }),
                    }),
                    e.map((e) => (0, E.jsx)("div", { className: CD.A, children: (0, E.jsx)(CL, { userId: e }) }, e)),
                ],
            });
        },
    }),
...
i(839272);
let CY = (0, a.zZ)(u.X.SPAM_FILTERS_CATEGORY, { useTitle: () => j.intl.string(j.t.Qwuoic), buildLayout: () => [Ii] }),
...
let bc = (0, a.zD)(u.X.FRIEND_ANNIVERSARY_NOTIFICATIONS, {
    ...
    bA = (0, a.zD)(u.X.GO_LIVE_NOTIFICATIONS, {
    ...
    bE = (0, a.zD)(u.X.PROFILE_UPDATES_NOTIFICATIONS, {
        ...
        usePredicate: () => bh.useConfig({ location: "user_settings.ProfileUpdatesNotifications" }).showSettingsToggle,
    });
var bS = i(815807);
let bT = (0, a.Hn)(u.X.REACTION_NOTIFICATIONS, {
        ...
        setValue: (e) => (0, bS.n4)(e, L.Zp.getSetting()),
    }),
    bx = (0, a.zD)(u.X.SERVER_TRENDING_NOTIFICATIONS, {
    ...
    bf = (0, a.zD)(u.X.UPCOMING_SERVER_EVENT_NOTIFICATIONS, {
        ...
        usePredicate: () => bp.useConfig({ location: "UpcomingServerEventNotifications" }).showSettingsToggle,
    }),
    bN = (0, a.FW)(u.X.NOTIFICATION_SELECTION_FIELD_SET, {
        variant: "compact",
        useTitle: () => j.intl.string(j.t.FEVRDV),
        buildLayout: () => [bA, bc, bm, bx, bf, bE, bT],
    }),
    b_ = (0, a.zD)(u.X.TASK_BAR_FLASHING, {
    ...
    bI = (0, a.zZ)(u.X.NOTIFICATIONS_OVERVIEW_CATEGORY, {
        useTitle: () => j.intl.string(j.t["/dp6yY"]),
        buildLayout: () => [bi, b_, bN, br, bu, bo],
    });
var bC = i(965957),
    bb = i(312671),
    bv = i(235079);
let by = (0, a.zD)(u.X.NOTIFICATION_HOLIDAY_SOUNDPACK, {
    ...
    setValue: function (e) {
        ...
        tX()(null != t, "predicate should fail if no soundpack is available"), (0, bC.p)(e ? t : bv.i.CLASSIC);
    },
...
let bO = {
    ...
    bP = (0, a.D1)(u.X.NOTIFICATION_SOUNDS_LIST, {
        initialize: function () {
            return () => {
                uV();
            };
        },
        buildLayout: () => [uw(bO), bL, uw(bR), bD],
    }),
    ...
    bU = (0, a.zZ)(u.X.NOTIFICATIONS_SOUNDS_CATEGORY, {
        useTitle: () => j.intl.string(j.t.LweOYy),
        buildLayout: () => [by, bP, bM],
    }),
    bV = (0, a.t_)(u.X.NOTIFICATIONS_PANEL, {
        ...
        buildLayout: () => [bI, bU, C4, bt, C3],
    }),
    bk = (0, a.i4)(u.X.NOTIFICATIONS_SIDEBAR_ITEM, {
        useTitle: () => j.intl.string(j.t.HcoRu0),
        icon: CW.X,
        buildLayout: () => [bV],
    }),
    bw = (0, a.WI)(u.X.USER_SECTION, {
        useTitle: () => j.intl.string(j.t.ShSTDe),
        hideTitle: !0,
        buildLayout: () => {
            let e = (0, o.Bv)("UserSection");
            return [Ny, ...(e ? [] : [I5]), CU, ...(e ? [CK] : []), ...(e ? [] : [NL]), ...(e ? [] : [_T]), bk, _A];
        },
    });
var bB = i(387758),
    bF = i(271866),
...
let bX = (0, a.zD)(u.X.APPLICATION_TEST_MODE, {
        ...
        useValue: () => (0, g.bG)([bz.A], () => null != bz.A.testModeApplicationId),
        setValue: (e) => {
            e ? (0, K.openModal)((e) => (0, E.jsx)(bY.A, { ...e })) : bF.cL();
        },
    }),
    bH = (0, a.zD)(u.X.DEVELOPER_MODE, {
    ...
    bK = (0, a.zZ)(u.X.DEVELOPER_CATEGORY, { buildLayout: () => [bH, bX] }),
    bW = (0, a.t_)(u.X.DEVELOPER_PANEL, { useTitle: () => j.intl.string(j.t["0BRxRp"]), buildLayout: () => [bK] }),
    bZ = (0, a.i4)(u.X.DEVELOPER_SIDEBAR_ITEM, {
        icon: bB.G,
...
let bJ = (0, a.i4)(u.X.LOGOUT_SIDEBAR_ITEM, {
    ...
    b0 = (0, a.Hr)({
        buildLayout: function () {
            return [pk, bw, h4, dr, (0, o.Bv)("UserSettingsRoot_buildLayout") ? To : i3, Sh, b$];
        },
