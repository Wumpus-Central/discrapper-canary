...
class D {
    ...
    addChannelMessages(e) {
        ...
        (this._messages = [
            ...this._messages,
            ...n
                .filter((e) => e.author.id !== i && N.default.age(e.id) < b.V$)
                .map((e) => ({
                    id: e.id,
        ...
        this._isSorted ||
            ((this._messages = O().sortedUniqBy(
                this._messages.toSorted((e, t) => {
                    let n = N.default.compare(e.id, t.id);
                    return 0 !== n
                        ? n
    ...
    maybeTruncate() {
        ...
        Object.values(t).forEach((e) => {
            let t = [...e.mentions, ...e.messages].sort((e, t) => N.default.compare(e.id, t.id)).slice(-b.EM),
                i = new Set(),
                r = [];
...
function z() {
    ...
    for (let e of x.toSorted((e, t) => N.default.compare(g.Ay.lastMessageId(t), g.Ay.lastMessageId(e)))) {
        let t = P[e];
        if (t.loadState === b.Ve.UNLOADED && null != t.mostRecentMessageId) {
            H = t.mostRecentMessageId;
            return;
        }
    }
    H = "0";
            ...
            .sort((e, t) => {
                ...
                return n !== g.Ay.hasUnread(t)
                    ? n
                        ? -1
                        : 1
                    : N.default.compare(g.Ay.lastMessageId(t), g.Ay.lastMessageId(e));
            })
            .reduce(
                (e, t) => (
...
class et extends s.Ay.Store {
    ...
    canLoadMore(e) {
        ...
        return (function (e) {
            let { preload: t } = e;
            return (
                null != (0, v.GE)({ location: "NotificationsInboxStore.canLoadMore" })?.notificationCenterVariant &&
                null != x &&
                !G &&
                !F &&
                (!t || !B) &&
...
let en = new et(a.h, {
    ...
    THREAD_MEMBERS_UPDATE: function (e) {
        ...
        if (n?.some((e) => e.userId === r)) {
            let e = p.A.getBasicChannel(t);
            return !(null == e || d.A.isMuted(t)) && (0, _.l)(e) !== M.CP.NO_MESSAGES && void Z();
        }
        return !!i?.includes(r) && void Z();
    },
    ...
    NOTIFICATIONS_INBOX_LOAD_MORE_INBOX_SUCCESS: function (e) {
        ...
        (G = !1), t && (B = !0), null != n && (j = n), t || (V = !0), z(), (W = i ?? null);
    },
    ...
    NOTIFICATIONS_INBOX_ITEM_CLICK: function (e) {
        let { messageId: t, channelId: n, isUnread: i } = e,
            r = (0, v.GE)({ location: "handleInboxItemClick" }).notificationCenterVariant;
        Y = i && r === v.U5.SIDEBAR ? { channelId: n, messageId: t } : null;
    },
    NOTIFICATIONS_INBOX_ITEM_ACK: function (e) {
        let { channelId: t, messageId: n } = e;
        (0, C.zo)({ channelId: t, id: n }, Y) && (Y = null);
    },
