...
function s(e, t) {
    for (var n, i = [], s = 0, a = 0, o = "", u = (t && t.delimiter) || "/"; null != (n = r.exec(e)); ) {
        var c = n[0],
            d = n[1],
            _ = n.index;
        if (((o += e.slice(a, _)), (a = _ + c.length), d)) {
            o += d[1];
            continue;
        }
        var h = e[a],
...
function o(e) {
    ...
    return function (n, r) {
        for (var s = "", o = n || {}, l = (r || {}).pretty ? a : encodeURIComponent, u = 0; u < e.length; u++) {
            var c,
                d = e[u];
            if ("string" == typeof d) {
                s += d;
