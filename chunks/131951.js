...
function ni(e) {
    ...
    let t = tL();
    if (
        (tq() && (tX() ? ra(ev.iA.AUTOMATIC) : t.automaticAudioSubsystem && ro()),
...
function rr(e) {
    ...
    t$({ bypassSystemInputProcessing: t }), eY.setAudioInputBypassSystemProcessing(t), nw(e.location);
}
function ri(e) {
    ra(e.subsystem);
}
function ra(e) {
    e === ev.iA.AUTOMATIC
        ? (t$({ automaticAudioSubsystem: !0 }), ro())
