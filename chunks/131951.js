...
function tB() {
    eW.on(b.aB.Connection, (e) => {
        ...
        let o = ep.Z.getGuildId(),
            {
                ...
                eA({ location: "setupMediaEngine" }, null != o && { guildId: o }),
                { autoTrackExposure: !0 },
            );
        ...
        for (let t of ((i = tP(e.context)), e.setPostponeDecodeLevel(eV), Object.keys(i.localMutes)))
...
function nP() {
    let e = tP(),
        ...
        o = tj(ef.Z.hasAutomaticGainControl(n) || e.automaticGainControl),
...
function n$() {
    !nJ() || __OVERLAY__ || tl || tc
        ? (0, ea.isWeb)() && eW.supports(eI.AN.NOISE_CANCELLATION)
            ? ((tc = !0), r.emitChange())
            : (0, ea.isWeb)() && tz({ noiseCancellation: !1 })
        : ((tl = !0), nQ());
}
function n0(e) {
    let { enabled: t } = e;
...
function ri(e) {
    ...
    null != o &&
        o.desktopSource.id !== d.desktopSource.id &&
