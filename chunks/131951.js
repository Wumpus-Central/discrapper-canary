...
let eZ = new w.Z("MediaEngineStore"),
    eF = "MediaEngineStore",
    eB = 4,
    eV = 1,
    eH = 1,
    ...
    ez = 500,
    eq = 5 * eh.Z.Millis.SECOND,
    eQ = -60,
    eX = 100,
    eJ = 2 * eh.Z.Millis.SECOND,
    e$ = 30 * eh.Z.Millis.SECOND,
    e0 = !0,
...
let e8 = {},
    ...
    tk = !1,
    tU = !1;
ei.Z.hasPermission(eR.Eu.AUDIO, { showAuthorizationError: !1 }),
    ei.Z.hasPermission(eR.Eu.CAMERA, { showAuthorizationError: !1 });
let tG = !1,
    tZ = new Set(),
    tF = tG,
    tB = new Set(),
...
function t2(e) {
    let t = t0(e.context),
        n = !e7 || t.mute || t.deaf;
    e.context === eL.Yn.DEFAULT
        ? (n = n || to || ts || tl || !ei.Z.didHavePermission(eR.Eu.AUDIO))
...
function t9(e, t) {
    let n = (0, eo.Z)(t, r.getSystemMicrophoneMode(), { location: "setNoiseCancellation" });
    ...
    let { noiseCancellationAfterProcessing: a, vadAfterWebrtc: o } = (0, q.$)({ location: "setNoiseCancellation" });
...
function nt() {
    ta.start(e$, () => {
        ...
        e5.on(y.aB.Connection, (e) => {
                ...
                n === z.$.NoSoftwareDecode || n === z.$.NoSoftwareDecodeWithFallback
                    ? (e.setExperimentFlag(eL.V8.H265_HARDWARE_ONLY, !0),
                      (0, em.isWindows)()
                          ...
                          : (0, em.isMac)() && e.setExperimentFlag(eL.V8.H265_HARDWARE_DECODE_AVAILABLE, !0))
                    : n === z.$.Disabled &&
                      (e.setExperimentFlag(eL.V8.H265_HARDWARE_ONLY, !0),
                      e.setExperimentFlag(eL.V8.H265_HARDWARE_DECODE_AVAILABLE, !1)),
                (0, em.isWindows)() &&
                    (0, K.t)({ location: "setupMediaEngine" }).enabled &&
                    e.setExperimentFlag(eL.V8.USE_H264_MF_DECODER, !0);
            ...
            if (
                ((0, em.isWindows)()
                    ...
                    : ((0, em.isMac)() || (0, em.isLinux)()) && e.setExperimentFlag(eL.V8.SIGNAL_AV1_DECODE, !0),
                (0, em.isWindows)() && e.setExperimentFlag(eL.V8.SIGNAL_AV1_HARDWARE_DECODE, !0),
                (0, em.isWeb)())
            ) {
            ...
            if (
                ...
                (0, em.isWindows)() &&
                    ...
                    (0, en.C)("MediaEngineStore").enabled &&
                    e.setExperimentFlag(eL.V8.WMF_GPU_ENCODE, !0),
                e5.setHasFullbandPerformance((0, R.Z)()),
            ...
            e.on(y.Sh.Speaking, (t, n, r, i) => {
                ...
                e5.supports(eL.AN.ASYNC_VIDEO_INPUT_DEVICE_INIT) &&
                    e5.setAsyncVideoInputDeviceInit((0, Z.p)("setupMediaEngine").enabled);
        }),
        ...
        e5.on(y.aB.VideoInputInitialized, (e) => {
            ep.default.track(eP.rMx.VIDEO_INPUT_INITIALIZED, {
                ...
                time_to_first_frame_ms: e.initializationTimerExpired
                    ? null
                    : Math.round(e.timeToFirstFrame * eh.Z.Millis.SECOND),
        ...
        e5.supports(eL.AN.ASYNC_CLIPS_SOURCE_DEINIT) &&
            e5.setAsyncClipsSourceDeinit((0, F.C)("setupMediaEngine").enabled),
        ns.reset(),
        (0, eC.q)().then((e) => {
...
function nn() {
    return (0, em.isWindows)() && g().satisfies(null === I.Z || void 0 === I.Z ? void 0 : I.Z.os.release, ew.c5);
}
function nr() {
    return (0, em.isWindows)() && g().satisfies(null === I.Z || void 0 === I.Z ? void 0 : I.Z.os.release, ew.sN);
}
function ni() {
    return (
        (0, em.isMac)() &&
        e5.supports(eL.AN.SCREEN_CAPTURE_KIT) &&
        g().satisfies(null === I.Z || void 0 === I.Z ? void 0 : I.Z.os.release, ew.C7)
    );
}
function na() {
    return (
...
function nP(e) {
    ...
    return t.reduce((e, t) => {
        if (i === t.sessionId) {
            ...
            return t5(!e && !n && tu), (tR = t.channelId), !0;
        }
...
function nR(e) {
    let { context: t, playSoundEffect: n } = e,
        { mute: r, deaf: i } = t0(t);
    if (t === eL.Yn.DEFAULT && (ei.Z.requestPermission(eR.Eu.AUDIO), tl)) return !1;
    (r = !i && !r) || (i = !1),
        n || (tp = !0),
        nc(
            {
...
function nD(e) {
    ...
    nc({ mute: n }, t), r || (tp = !0), e5.eachConnection(t2);
}
function nx(e) {
    let {
        settings: { type: t },
...
function nL(e) {
    let { context: t } = e;
    nc({ deaf: !t0(t).deaf }, t), e5.eachConnection(t2);
}
function nj(e) {
...
function nB(e) {
    let { volume: t } = e;
    nc({ inputVolume: t3(t) }), e5.setInputVolume(t);
}
function nV(e) {
    let { volume: t } = e;
...
function nY(e) {
    let { id: t } = e;
    nc({ outputDeviceId: (t = nh(tr, t)) }), e5.setAudioOutputDevice(t);
}
function nW(e) {
    let { id: t } = e;
    nc({ videoDeviceId: (t = nh(ti, t)) }), t5();
}
function nK(e) {
...
function nX(e) {
    ...
    let n = t0(),
        ...
        l = (0, eo.Z)(n.noiseCancellation, r.getSystemMicrophoneMode(), { location: "trackVoiceProcessing" });
...
function rm() {
    !rh() || __OVERLAY__ || tS || tI
        ? (0, em.isWeb)() && e5.supports(eL.AN.NOISE_CANCELLATION)
            ? ((tI = !0), r.emitChange())
...
class rz extends (d = b.ZP.Store) {
    ...
    goLiveSimulcastEnabled() {
        var e;
        return (
            (null == (e = eI.Z.getChannel(tR)) ? void 0 : e.type) !== eP.d4z.GUILD_STAGE_VOICE &&
            e0 &&
    ...
    isSelfMute() {
        ...
        return (
            !this.isEnabled() ||
            t0(e).mute ||
            !ei.Z.didHavePermission(eR.Eu.AUDIO) ||
            this.isSelfDeaf(e) ||
            (e === eL.Yn.DEFAULT && tl)
        );
    }
    ...
    supportsExperimentalSoundshare() {
        return (
            ...
            g().satisfies(null === I.Z || void 0 === I.Z ? void 0 : I.Z.os.release, ew.T6)
        );
    }
    supportsHookSoundshare() {
        return (
            ...
            g().satisfies(null === I.Z || void 0 === I.Z ? void 0 : I.Z.os.release, ew.sA)
        );
    }
    ...
    supportsScreenSoundshare() {
        return (0, em.isMac)()
            ? e5.supports(eL.AN.SOUNDSHARE) &&
                  g().satisfies(null === I.Z || void 0 === I.Z ? void 0 : I.Z.os.release, ew.yG) &&
                  ni()
            : (0, em.isWindows)()
              ? e5.supports(eL.AN.SCREEN_SOUNDSHARE) && this.getExperimentalSoundshare()
              : !!(0, em.isLinux)() && e5.supports(eL.AN.SCREEN_SOUNDSHARE);
    }
