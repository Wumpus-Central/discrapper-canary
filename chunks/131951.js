let r, i, o, a;
n.d(t, { Z: () => n9 }), n(47120), n(301563), n(571269), n(298267), n(266796), n(773603), n(653041), n(337869);
var s,
    l = n(512722),
    c = n.n(l),
    u = n(392711),
...
function tN() {
    ej.on(m.aB.Connection, (e) => {
        ...
        let l = es.Z.getGuildId(),
            { muteBeforeProcessing: c, pttBeforeProcessing: u, skipEncode: d } = (null != l ? M.Z : x.Z).getCurrentConfig(eE({ location: 'setupMediaEngine' }, null != l && { guildId: l }), { autoTrackExposure: !0 });
...
function tA() {
    return (0, X.isWindows)() && _().satisfies(null === b.Z || void 0 === b.Z ? void 0 : b.Z.os.release, ef.nz);
}
function tC() {
    return (0, X.isMac)() && ej.supports(eh.AN.SCREEN_CAPTURE_KIT) && _().satisfies(null === b.Z || void 0 === b.Z ? void 0 : b.Z.os.release, ef.C7);
}
function tR() {
...
function tY(e) {
    ...
    (eU = t.settingsByContext), (eZ = t.inputDevices), (eH = t.outputDevices), (tf = t.appSupported), (e9 = t.krispModuleLoaded), (eF = t.goLiveContext);
}
function tK() {
    i = null;
}
...
function t2(e) {
    ...
    if ((I[u] === ed.ZUi.AUTO_PROBING && d === ed.ZUi.AUTO_ENABLED && (0, F.Z)(u, p ? eh.fC.AUTO_DISABLE : eh.fC.AUTO_ENABLE, E), (I[u] = d), tD({ videoToggleStateMap: I }, l, f), d === ed.ZUi.AUTO_PROBING ? null === (n = es.Z.getRTCConnection()) || void 0 === n || n.pauseStatsCollectionForUser(u, !0) : null === (r = es.Z.getRTCConnection()) || void 0 === r || r.pauseStatsCollectionForUser(u, !1), tu || (ey.info('isAutoDisableAllowed='.concat(tu, ' - disabling VideoHealthManager')), null === (o = es.Z.getRTCConnection()) || void 0 === o || null === (i = o.getVideoHealthManager()) || void 0 === i || i.disable()), y)) {
        if ((!p && !g) || (p && !tu)) return;
        (0, F.Z)(u, p ? eh.fC.AUTO_DISABLE : eh.fC.AUTO_ENABLE, E), p ? tc.add(u) : tc.delete(u);
    } else O && (g && !p ? (ey.info('disallowing auto-disable for this session because of manual override by user'), (tu = !1), null === (s = es.Z.getRTCConnection()) || void 0 === s || null === (a = s.getVideoHealthManager()) || void 0 === a || a.disable(), (0, F.Z)(u, eh.fC.MANUAL_REENABLE, E)) : (0, F.Z)(u, p ? eh.fC.MANUAL_DISABLE : eh.fC.MANUAL_ENABLE, E));
    b && !p && tc.delete(u),
        p ? (h[u] = !0) : delete h[u],
...
function nr(e) {
    return eV !== e.required && ((eV = e.required), e.required || ej.interact(), !0);
}
function ni(e) {
...
function nw() {
    return (0, X.isWindows)() || (0, X.isLinux)() || ((0, X.isMac)() && _().satisfies(null === b.Z || void 0 === b.Z ? void 0 : b.Z.os.release, ex));
}
function nD() {
...
class n8 extends (s = h.ZP.Store) {
    ...
    supportsExperimentalSoundshare() {
        return ej.supports(eh.AN.EXPERIMENTAL_SOUNDSHARE) && _().satisfies(null === b.Z || void 0 === b.Z ? void 0 : b.Z.os.release, ef.I9);
    }
    ...
    supportsScreenSoundshare() {
        return (0, X.isMac)() ? ej.supports(eh.AN.SOUNDSHARE) && _().satisfies(null === b.Z || void 0 === b.Z ? void 0 : b.Z.os.release, ef.yG) && tC() : (0, X.isWindows)() ? ej.supports(eh.AN.SCREEN_SOUNDSHARE) && this.getExperimentalSoundshare() : !!(0, X.isLinux)() && ej.supports(eh.AN.SCREEN_SOUNDSHARE);
    }
...
let n9 = (r = new n8(v.Z, {
    ...
    AUDIO_SET_NOISE_SUPPRESSION: n_,
