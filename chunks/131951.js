    ...
    if (((null == s ? void 0 : s.desktopSource) != null && s.desktopSource.id !== (null == a || null == (e = a.desktopSource) ? void 0 : e.id) && (null != s.desktopSource.soundshareId && (0, X.isWindows)() && v.pn(s.desktopSource.soundshareId), eU.setGoLiveSource(null, eZ)), (null == s ? void 0 : s.cameraSource) != null && (s.cameraSource.videoDeviceGuid !== (null == a || null == (t = a.cameraSource) ? void 0 : t.videoDeviceGuid) || s.cameraSource.audioDeviceGuid !== (null == a || null == (n = a.cameraSource) ? void 0 : n.audioDeviceGuid)) && eU.setGoLiveSource(null, eZ), (eJ || i) && ((e$ = (eJ = i) ? tZ(eK, tv().videoDeviceId) : eh.Av), eU.setVideoInputDevice(e$)), (o = a), null != a)) {
        ...
        if (null != a.desktopSource) {
            let t = ty(),
                n = tv().videoHook,
                i = tw(),
                o = i ? (tD() && (0, F.R)('MediaEngineStore_updateVideo').enabled ? ef.zj : ef.ZM) : 0;
            eU.setGoLiveSource(
                {
                    desktopDescription: {
    ...
    (i = e.sessionId),
        ...
        (0, X.isWeb)() ||
            (U.Z.subscribe({ location: 'handleConnectionOpen' }, (e) => {
                let t = tv();
                !e.sidechainAvailable && t.sidechainCompression ? (tj({ sidechainCompressionSettingVersion: 0 }), nh(!1)) : e.sidechainAvailable && t.sidechainCompressionSettingVersion < eA && (tj({ sidechainCompressionSettingVersion: eA }), nh(e.sidechainEnabled));
            }),
            ng());
    let t = tv();
    tx() && (t.automaticAudioSubsystem && nW(), t.audioSubsystemSettingVersion < eC && (tj({ audioSubsystemSettingVersion: eC }), t.automaticAudioSubsystem || eU.getAudioSubsystem() === eh.iA.LEGACY || nH(eh.iA.AUTOMATIC))),
        (0, K.wt)({
...
function t8(e) {
    ...
    } else O && (g && !p ? (ev.info('disallowing auto-disable for this session because of manual override by user'), (tf = !1), null == (s = es.Z.getRTCConnection()) || null == (a = s.getVideoHealthManager()) || a.disable(), (0, V.Z)(u, eh.fC.MANUAL_REENABLE, E)) : (0, V.Z)(u, p ? eh.fC.MANUAL_DISABLE : eh.fC.MANUAL_ENABLE, E));
    y && !p && td.delete(u),
        p ? (h[u] = !0) : delete h[u],
...
function no(e) {
    let { id: t } = e;
    (t = tZ(eW, t)), (eH = performance.now()), tj({ inputDeviceId: t }), eU.setAudioInputDevice(t);
}
function na(e) {
    let { id: t } = e;
    tj({ outputDeviceId: (t = tZ(eY, t)) }), eU.setAudioOutputDevice(t);
}
function ns(e) {
    let { id: t } = e;
    tj({ videoDeviceId: (t = tZ(eK, t)) }), tN();
}
function nl(e) {
...
function nH(e) {
    e === eh.iA.AUTOMATIC ? (tj({ automaticAudioSubsystem: !0 }), nW()) : (tj({ automaticAudioSubsystem: !1 }), eU.setAudioSubsystem(e));
}
function nW() {
...
function nJ(e) {
    ...
    null != a && a.desktopSource.id !== d.desktopSource.id && (eU.setClipsSource(null), (0, X.isWindows)() && null != a.desktopSource.soundshareId && v.pn(a.desktopSource.soundshareId)), null != l && tq(l, c), (a = d);
    let f = ty(),
        _ = tv().videoHook;
    eU.setClipsSource({
        desktopDescription: {
...
class ri extends (s = h.ZP.Store) {
    ...
    getInputDeviceId() {
        return tZ(eW, tv().inputDeviceId);
    }
    getOutputDeviceId() {
        return tZ(eY, tv().outputDeviceId);
    }
    getVideoDeviceId() {
...
let ra = (r = new ri(b.Z, {
    ...
    MEDIA_ENGINE_SET_VIDEO_HOOK: nN,
