...
let e$ = {},
    ...
    tA = !1,
    tC = !1;
$.Z.hasPermission(eS.Eu.AUDIO, { showAuthorizationError: !1 }),
    $.Z.hasPermission(eS.Eu.CAMERA, { showAuthorizationError: !1 });
let tN = !1,
    tR = new Set(),
    tP = tN,
    tD = new Set(),
...
function tB() {
    ...
    return ex(eD({}, i, a), { modeOptions: o });
}
function tZ(e) {
    var t, n;
    let r = tB(e.context),
...
function tV(e) {
    let t = tB(e.context),
        n = !e1 || t.mute || t.deaf;
    e.context === eN.Yn.DEFAULT
        ? (n = n || e7 || e9 || te || !$.Z.didHavePermission(eS.Eu.AUDIO))
    ...
    eJ.on(b.aB.Connection, (e) => {
        ...
        i && e.setExperimentFlag(eN.V8.MUTE_BEFORE_PROCESSING, !0),
            ...
            (0, W.J)({ location: "setupMediaEngine" }).enabled &&
                e.setExperimentFlag(eN.V8.LOW_LATENCY_RATE_CONTROL, !0);
        let l = !1,
            c = !0;
        if (
            ...
            e.on(b.Sh.VoiceActivityDetectorError, (e) => {
                eL.warn("voiceactivitydetectorerror event: ".concat(e)),
                    ...
                    v.Z.dispatch({
                        ...
                        mode: eI.pM4.VOICE_ACTIVITY,
                        options: ex(eD({}, tB(eN.Yn.DEFAULT).modeOptions), { vadUseKrisp: !1 }),
                    }),
                    v.Z.dispatch({
        ...
        eJ.on(b.aB.VideoCodecError, (e) => {
            ...
            (0, P.kr)(
                t === P.u.VIDEO_ENCODE_ERROR
                    ? ex(eD({ type: t }, n), { videoEncoder: e.implName })
                    : ex(eD({ type: t }, n), { videoDecoder: e.implName }),
            );
        }),
...
function np() {
    if ((0, eu.isWeb)()) {
        let e = z.NJ.getCurrentConfig({ location: "MediaEngineStore handlePostConnectionOpen" });
...
function nE(e) {
    let { context: t, playSoundEffect: n } = e,
        { mute: r, deaf: i } = tB(t);
    if (t === eN.Yn.DEFAULT && ($.Z.requestPermission(eS.Eu.AUDIO), te)) return !1;
    (r = !i && !r) || (i = !1),
        n || (ta = !0),
        t5(
            {
...
function nI(e) {
    ...
    if (
        (I[c] === eI.ZUi.AUTO_PROBING &&
            ...
            (0, J.Z)(c, p ? eN.fC.AUTO_DISABLE : eN.fC.AUTO_ENABLE, E),
        (I[c] = u),
        ...
        v &&
            (g && !p
                ? (eL.info("disallowing auto-disable for this session because of manual override by user"),
                  ...
                  (0, J.Z)(c, eN.fC.MANUAL_REENABLE, E))
                : (0, J.Z)(c, p ? eN.fC.MANUAL_DISABLE : eN.fC.MANUAL_ENABLE, E));
    y && !p && tR.delete(c),
        p ? (h[c] = !0) : delete h[c],
...
async function nW() {
    ...
    (null == (t = window.DiscordNative) || null == (e = t.processUtils) ? void 0 : e.getSystemInfo) != null &&
        ...
        ((tj = !0), (tk = eJ.supports(eN.AN.GAMESCOPE_CAPTURE)));
}
function nK(e) {
...
class rk extends (u = E.ZP.Store) {
    initialize() {
        tJ(),
            ...
            this.waitFor(eh.default, em.Z, eg.Z, eE.Z, A.Z, D.Z, eb.Z, x.ZP, et.Z, ei.Z, eO.default, ev.Z, eo.Z);
    }
    supports(e) {
    ...
    isSelfMute() {
        ...
        return (
            !this.isEnabled() ||
            tB(e).mute ||
            !$.Z.didHavePermission(eS.Eu.AUDIO) ||
            this.isSelfDeaf(e) ||
            (e === eN.Yn.DEFAULT && te)
        );
    }
    ...
    fetchAsyncResources() {
        ...
        return (
            (0, eu.isWeb)() &&
                (e.fetchDave = z.NJ.getCurrentConfig({
    ...
    getSupportedSecureFramesProtocolVersion() {
        if ((0, eu.isWeb)()) {
            let { useWasmModule: e } = z.NJ.getCurrentConfig({
        ...
        114 === e && (e = 1);
        let t = z.m8.getCurrentConfig({ location: "MediaEngineStore" }),
            n = z.Th.getConfig({ location: "MediaEngineStore" });
        return (t.canSupportDaveProtocol || (n.allowOptIn && et.Z.getPersistentCodesEnabled())) &&
