        ...
        let s = eo.Z.getGuildId(),
            {
                ...
                skipEncode: u
            } = (null != s ? P.Z : w.Z).getCurrentConfig(
                {
