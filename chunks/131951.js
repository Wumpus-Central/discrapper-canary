...
function tM() {
    ...
    if (
        ...
        e5 && e === eI.w5 && e6 !== eI.Av && (e = e6), (e6 = (e5 = i) ? t3(e1, e) : eI.Av), eW.setVideoInputDevice(e6);
    }
    if (((a = o), null != o)) {
        let e = {
...
function na(e) {
    ...
    return t.reduce((e, t) => {
        if (i === t.sessionId) {
            ...
            return tM(!e && !n && e5), (tm = t.channelId), !0;
        }
...
function rh(e) {
    let { state: t } = e,
        n = D.Z.isEnabled();
    if (t === eE.$7l.BACKGROUND && e5 && !n) (tn = !0), tM(!1);
    else {
