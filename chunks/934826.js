...
var r = n(73800),
    ...
    u = n(981631);
function d(e) {
    let t = (0, i.e7)([o.ZP], () => o.ZP.getSubscriptions()),
        n = r.useMemo(() => {
            if (null == t) return {};
            let e = {};
        ...
        { activeSubscription: d, activeSubscriptionListing: m } = (0, i.cj)([s.Z], () => {
            var t;
            let r,
                i = null,
        ...
        b = null == m ? void 0 : m.soft_deleted;
    return (
        r.useEffect(() => {
            null != g || null == h || a.Z.isFetchingForSKU(h) || (0, l.GZ)(h, void 0, void 0, b);
        }, [g, h, b]),
        {
