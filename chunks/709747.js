...
function w(e) {
    let { dragStart: t, dragging: n } = e,
        [w, _] = (0, l.bG)([p.A], () => p.A.getSessionEntries()),
        O = (0, l.bG)([p.A], () => p.A.getSelectedChannelId()),
        N = (0, l.bG)([p.A], () => p.A.getVoiceChatMinimized()),
        b = (0, l.bG)([o.A], () => (null != O ? (o.A.getChannel(O) ?? null) : null), [O]);
    s.useEffect(() => {
        null == O || (null == b && (0, T.b)(O));
    }, [b, O]);
    let R = (0, l.bG)([d.A], () => (0, f.P)(b, d.A), [b]),
        M = (0, l.bG)([u.A], () => u.A.getChannelId(), []),
        L = s.useMemo(() => (null == M || 0 === _ ? w : w.filter((e) => e.channelId !== M)), [w, _, M]),
        z = (0, m.Dk)(() => {
            let e = new Set();
    ...
    let V = (0, l.bG)([h.default], () => (0, f.j)(b, h.default)),
        U = (0, l.bG)(
            [h.default, c.A],
              ...
              children: [
                  ...
                  Y
                      ? (0, i.jsxs)("div", {
                            className: y.oM,
                            children: [
                                (0, i.jsx)(E.A, { channel: b, user: V, guild: R, title: U, dragStart: t, dragging: n }),
                                (0, i.jsx)(I.A, { selectedChannelId: O }),
                            ],
                        })
                      : null,
              ],
