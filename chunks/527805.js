...
function p(e) {
    var t, n, r;
    let { userId: i, activity: a, application: o, channelId: s, currentUser: l, isActivitiesEnabledForCurrentPlatform: u, ChannelStore: f, VoiceStateStore: p, PermissionStore: h, GuildStore: m } = e;
    if (null == i) return 8;
    ...
    let g = null != s ? s : null == (r = p.getVoiceStateForSession(i, null == a ? void 0 : a.session_id)) ? void 0 : r.channelId;
    if (null == g) return 4;
    let E = f.getChannel(s);
    if (null == E) return 4;
    if (!E.isPrivate()) {
        let e = E.getGuildId();
        if (null == e) return 10;
        ...
        let n = p.getCurrentClientVoiceChannelId(E.getGuildId()) === g,
            r = (0, c.rY)(E, p, m),
            i = h.can(_.Plq.CONNECT, E);
        if (!h.can(_.Plq.USE_EMBEDDED_ACTIVITIES, E)) return 1;
        if (E.isVocal() && !n) {
            if (r) return 3;
            if (!i) return 2;
        }
