...
function p(e) {
    var t, n, r;
    let { userId: i, activity: a, application: o, channelId: s, currentUser: l, isActivitiesEnabledForCurrentPlatform: u, ChannelStore: _, VoiceStateStore: p, PermissionStore: h, GuildStore: m } = e;
    if (null == i) return 8;
