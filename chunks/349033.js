...
class l {
    ...
    addRule(e) {
        let t,
            ...
            { regex: o } = e;
        if (
            ("^" !== o.source.charAt(0) && (o = new RegExp("^".concat(o.source), o.flags)),
            null != i && (t = new Map()),
            null == r)
        )
    ...
    tokenize(e) {
        ...
        for (; n.length > 0; ) {
            ...
            null != e
                ? (null != r && "" !== r && a.push(new c(s(r.match(i), o), this._nonTokenType)),
                  (t = e),
                  a.push(e),
                  (o += t.length + r.length),
    ...
    _getMatch(e, t, n) {
        ...
        return (
            (null == t ? void 0 : t.end) === n && (r = a(e, this._followers[String(i)], n)),
            null == r && (r = a(e, this._rules, n)),
            r
        );
    }
    constructor(e = []) {
