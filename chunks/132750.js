...
function x(e) {
    let { hovered: t, activities: s, user: l, applicationStream: f, voiceChannel: x, status: E, userTag: j, customStatusHoverOnlyRTCEntrypointEnabled: O } = e,
        { analyticsLocations: C } = (0, m.ZP)(u.Z.RTC_PANEL),
        S = (0, h.a)(),
        v = r.useCallback(() => {
            (0, a.ZDy)(async () => {
                let e = (0, p.Z)(),
