...
function D(e) {
    ...
    let V = (H && !k) || (H && T);
    return (H && T && (l = Z.intl.string(Z.t.wJNK8P)), k || (l = Z.intl.string(Z.t.hHGrW1)), null == a.code || '' === a.code || null == x)
        ? null
        : (0, r.jsx)(f.Gt, {
              value: D,
              children: (0, r.jsx)(M, {
...
function M(e) {
    var t, n;
    let { app: l, activityUsers: a, isMember: o, channel: s, guild: c, members: u, membersOnline: d, isActivityActive: p, submitting: m, isDisabled: f, tooltip: y, handleAcceptInvite: C, onView: x } = e,
        { bot: v, icon: O } = l,
