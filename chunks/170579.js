...
let I = (e) => {
        let { isTier0: t, discountAmount: n } = e,
            i = (0, g.N)(),
            o = null != i && i.trial_id === b.a7,
            l = y.intl.string(y.t.IBYG5e);
        return (
            void 0 !== n ? (l = y.intl.formatToPlainString(y.t.iiLbvr, { percent: n })) : o && (l = y.intl.string(y.t.gtNqJS)),
            (0, r.jsx)('div', {
                className: O.trialBadgeContainer,
                children: (0, r.jsx)(s.Text, {
                    variant: 'text-xs/bold',
                    className: a()(O.trialOfferText, { [O.tier0TrialOffer]: t }),
                    children: l
                })
            })
        );
    ...
    S = function (e) {
        var t;
        let n,
            { hideCloseButton: i = !1, hideCloseOnFullScreen: p, shouldShowPrice: h, plan: g, renderAnimation: y, onClose: S, isGift: T, upgradeToPremiumType: A, headerTheme: N = b.nL.DEFAULT, className: C, showTrialBadge: P = !1, showDiscountBadge: R = !1 } = e,
            w = A === b.p9.TIER_2;
        ...
        return (0, r.jsxs)('div', {
            ...
            children: [
                ...
                (P || R) && (0, r.jsx)(_.Z, { className: O.trialBadgeSparkles }),
                y(),
                (0, r.jsxs)(c.Z, {
