...
let x = (e) => {
    ...
    let { className: n } = e,
        ...
        v = null !== (t = (0, a.e7)([d.Z], () => (null != N ? d.Z.getForSkuAndInterval((0, p.Wz)(h.Si.GUILD), N.interval, N.intervalCount) : void 0))) && void 0 !== t ? t : h.GP[h.Xh.PREMIUM_MONTH_GUILD];
    return (0, r.jsxs)('div', {
            ...
            (0, r.jsx)(l.Text, {
                ...
                children: (function (e) {
                    let { currentUser: t, locale: n, guildBoostingPlanId: i, interval: s, intervalCount: a } = e,
                        l = p.ZP.getDefaultPrice(i, p.ZP.isPremium(t)),
                        o = p.ZP.getDefaultPrice(i, !1),
                        c = (0, g.og)((0, g.T4)(l.amount, l.currency), s, a),
                        d = (0, g.og)((0, g.T4)(o.amount, o.currency), s, a);
                    return p.ZP.isPremium(t, h.p9.TIER_2)
