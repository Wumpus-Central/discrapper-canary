...
function A(e, t, n) {
    for (var r in (n && (N((n = a({}, n)), t), (t = a(a({}, n), t))), N(e, t), Object.assign(e, t), S)) null == e[r] && (e[r] = S[r]);
    var i = e.mass,
        s = e.frequency,
        l = e.damping;
                                                        ...
                                                        case 0:
                                                            return (
                                                                ...
                                                                o.is.arr(t)
                                                                    ...
                                                                    : o.is.fun(t) && (I = Promise.resolve(t(O, i.stop.bind(i)))),
                                                                (e.next = 11),
        ...
        return (
                            ...
                            if (!f) {
                                ...
                                if (o.is.und(a.duration))
                                    if (a.decay) {
                                        ...
                                        for (var b = null == c.lastVelocity ? m : c.lastVelocity, y = a.precision || (h == d ? 0.005 : Math.min(1, 0.001 * Math.abs(d - h))), O = a.restVelocity || y / 10, v = a.clamp ? 0 : a.bounce, I = !o.is.und(v), S = h == d ? c.v0 > 0 : h < d, T = !1, A = 1, N = Math.ceil(e / 1), C = 0; C < N && !(!(Math.abs(b) > O) && (f = Math.abs(d - _) <= y)); ++C) {
                                            I && (T = _ == d || _ > d == S) && ((b = -b * v), (_ = d));
                                            var P = (-(0.000001 * a.tension) * (_ - d) + -(0.001 * a.friction) * b) / a.mass;
                                            (b += P * A), (_ += b * A);
                                        }
                                else {
                                    var R = a.progress || 0;
                                    a.duration <= 0 ? (R = 1) : (R += (1 - R) * Math.min(1, p / a.duration)), (b = ((_ = h + a.easing(R) * (d - h)) - c.lastPosition) / e), (f = 1 == R);
                                }
            ...
            (n._merge = function (e, t, n) {
                ...
                var S = o.is.arr(t.to) || o.is.fun(t.to),
                    ...
                    N = T.decay,
                    C = T.velocity;
                t.config && !S && A(T, x(t.config, r), t.config !== a.config ? x(a.config, r) : void 0);
                var P = f.getAnimated(this);
                if (!P || o.is.und(m)) return n(q(this, !0));
                var R = o.is.und(t.reset) ? l && !t.default : !o.is.und(E) && k(t.reset, r),
                    w = R ? E : this.get(),
                    D = Y(m),
                    L = o.is.num(D) || o.is.arr(D) || o.isAnimatedString(D),
                    M = !S && (!L || k(a.immediate || t.immediate, r));
                if (O)
                    if (M) P = this._updateNode(D);
                    else {
                        var j = this._getNodeType(m);
                        if (j !== P.constructor) throw Error('Cannot animate between ' + P.constructor.name + ' and ' + j.name + ', as the "to" prop suggests');
                    }
                var U = P.constructor,
                    G = !!v,
                    F = !1;
                if (!G) {
                    var V = R || (this.is(es) && y);
                    (O || V) && (G = !(F = o.isEqual(Y(w), D))), (o.isEqual(T.decay, N) && o.isEqual(T.velocity, C)) || (G = !0);
                }
                if ((F && this.is(ec) && (i.changed && !R ? (G = !0) : G || this._stop()), !S)) {
                    (G || o.getFluidConfig(d)) && ((i.values = P.getPayload()), (i.toValues = v ? null : U == f.AnimatedString ? [1] : o.toArray(D))), (i.immediate = M), (i.onStart = ep(c('onStart'), r)), (i.onChange = ep(c('onChange'), r));
                    var Z = i.onRest,
                        H = R && !t.onRest ? Z[0] || o.noop : eh(ep(c('onRest'), r), this);
                    if (G) {
                ...
                if ((K && K(t, this), R && P.setValue(w), S)) n(ee(t.to, t, this._state, this));
    ...
    ev = (function () {
        ...
        return (
            ...
            (t.start = function (e) {
                ...
                return (e || (this.queue = []), this._flush) ? this._flush(this, t) : (eP(this, t), eI(this, t));
            }),
            (t.stop = function (e) {
                if (o.is.und(e))
            ...
            function () {
                o.each(S, function (e, t) {
                    var n = e.phase,
                        i = e.springs,
                        o = e.payload;
                    eA(t.ctrl, i), T.cancel || ((t.phase = n), n == eU && t.ctrl.start({ default: T }), t.ctrl[r ? 'update' : 'start'](o));
                });
            },
            l ? void 0 : n
        );
