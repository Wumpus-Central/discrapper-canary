...
function A(e, t, n) {
    for (var r in (n && (N((n = o({}, n)), t), (t = o(o({}, n), t))), N(e, t), Object.assign(e, t), S)) null == e[r] && (e[r] = S[r]);
    var i = e.mass,
        s = e.frequency,
        l = e.damping;
        ...
        return (
                            ...
                            if (!f) {
                                ...
                                if (a.is.und(o.duration))
                                    if (o.decay) {
                                        ...
                                        for (var b = null == c.lastVelocity ? m : c.lastVelocity, y = o.precision || (h == d ? 0.005 : Math.min(1, 0.001 * Math.abs(d - h))), O = o.restVelocity || y / 10, v = o.clamp ? 0 : o.bounce, I = !a.is.und(v), S = h == d ? c.v0 > 0 : h < d, T = !1, A = 1, N = Math.ceil(e / 1), C = 0; C < N && !(!(Math.abs(b) > O) && (f = Math.abs(d - _) <= y)); ++C) {
                                            I && (T = _ == d || _ > d == S) && ((b = -b * v), (_ = d));
                                            var P = (-(0.000001 * o.tension) * (_ - d) + -(0.001 * o.friction) * b) / o.mass;
                                            (b += P * A), (_ += b * A);
                                        }
                                else {
                                    var R = o.progress || 0;
            ...
            (n._merge = function (e, t, n) {
                ...
                var S = a.is.arr(t.to) || a.is.fun(t.to),
                    ...
                    N = T.decay,
                    C = T.velocity;
                t.config && !S && A(T, x(t.config, r), t.config !== o.config ? x(o.config, r) : void 0);
                var P = f.getAnimated(this);
                if (!P || a.is.und(m)) return n(q(this, !0));
                var R = a.is.und(t.reset) ? l && !t.default : !a.is.und(E) && k(t.reset, r),
                    w = R ? E : this.get(),
                    D = Y(m),
                    L = a.is.num(D) || a.is.arr(D) || a.isAnimatedString(D),
                    M = !S && (!L || k(o.immediate || t.immediate, r));
                if (O)
                ...
                if (!G) {
                    ...
                    (O || V) && (G = !(F = a.isEqual(Y(w), D))), (a.isEqual(T.decay, N) && a.isEqual(T.velocity, C)) || (G = !0);
                }
                if ((F && this.is(ec) && (i.changed && !R ? (G = !0) : G || this._stop()), !S)) {
                    (G || a.getFluidConfig(d)) && ((i.values = P.getPayload()), (i.toValues = v ? null : U == f.AnimatedString ? [1] : a.toArray(D))), (i.immediate = M), (i.onStart = ep(c('onStart'), r)), (i.onChange = ep(c('onChange'), r));
                    var Z = i.onRest,
                        H = R && !t.onRest ? Z[0] || a.noop : eh(ep(c('onRest'), r), this);
                    if (G) {
            ...
            function () {
                a.each(S, function (e, t) {
                    var n = e.phase,
                        i = e.springs,
                        a = e.payload;
                    eA(t.ctrl, i), T.cancel || ((t.phase = n), n == eU && t.ctrl.start({ default: T }), t.ctrl[r ? 'update' : 'start'](a));
                });
            },
            l ? void 0 : n
        );
