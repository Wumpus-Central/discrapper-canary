...
function W(e, t) {
    ...
    return new Promise(function (t, l) {
        ...
        _ ? h() : ((c = x(r.delay || 0, n)), (d = k(r.pause, n)) ? (i.resumeQueue.add(p), s.pause()) : (s.resume(), p()));
    });
}
var K = function (e, t) {
        return 1 == t.length
        ...
        return (
            ...
            (n._merge = function (e, t, n) {
                ...
                if ((V && this.is(ec) && (i.changed && !P ? (G = !0) : G || this._stop()), !T)) {
                    ((G || a.getFluidConfig(d)) && ((i.values = R.getPayload()), (i.toValues = v ? null : U == _.AnimatedString ? [1] : a.toArray(D))), (i.immediate = M), (i.onStart = ep(c('onStart'), r)), (i.onChange = ep(c('onChange'), r)));
                    var Z = i.onRest,
