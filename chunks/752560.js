...
class g {
    ...
    initialize() {
        ...
        (this._initialized = !0),
            (this._search = new u.j(this.guildId)),
            (this._members = new l.cm(this.guildId)),
            (this._pagination = new c.Rt(this.guildId, this._members.values(this.getSearchIndex())));
    }
    get isInitialized() {
    ...
    reset() {
        ...
        this._initialized &&
            (null == (e = this._members) || e.reset(),
            null == (t = this._pagination) || t.reset(),
            null == (n = this._search) || n.reset(),
            r && this.initialize());
    }
    get searchChunkSize() {
    ...
    getMember(e) {
        var t;
        return null != this._members && this._initialized && null != (t = this._members.getMemberByUserId(e))
            ? t
            : null;
    }
    getMembersByIndex(e) {
    ...
    updateMembersSort(e) {
        return new Promise((t) => {
            [
                ...(0, r.cloneDeep)(this.getMembersByIndex(l.R_.CURRENT_GUILD_MEMBER)[0]),
    ...
    updateSearchState(e) {
        ...
        for (let e of i) {
            ...
            t !== e.isIncludedInSearchResults &&
                ((o = !0), (n = !0), this._members.updateMember(e, { isIncludedInSearchResults: t }));
        }
    ...
    constructor(e) {
        f(this, "guildId", void 0),
            f(this, "lastRefreshTimestamp", 0),
            f(this, "lastCursorTimestamp", Date.now()),
            f(this, "_initialized", void 0),
            f(this, "_pagination", void 0),
            f(this, "_search", void 0),
            f(this, "_members", void 0),
            f(this, "_lastRefreshTimer", null),
            f(this, "_defaultSearchTotalResultsCount", void 0),
            (this.guildId = e),
            (this._initialized = !1),
            (this._members = null),
