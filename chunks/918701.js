...
function Y(e, t) {
    return Array.from(e.values()).filter((e) => H(t, e) && !K(e) && eC({ quest: e }));
}
function K(e) {
...
function eh(e) {
    let t = ep(e);
    return null != t && 'expiresAtPremium' in t && null != t.expiresAtPremium ? e8(t.expiresAtPremium) : null;
}
function em(e) {
    let t = ep(e);
...
let ek = (e, t) => {
    ...
    eU = (e) => e1(e) || S.Z.isProgressingOnDesktop(e.id),
    eG = (e, t) => {
        var n, r, o, a;
    ...
    eY = (e, t) =>
        e.config.taskConfig.type !== u.L.FIRST_PARTY
            ...
            : eX(e)
              ? eW({
                    quest: e,
                    includeTaskTypes: null != t ? t : e1(e) ? a.T.CONSOLE : a.T.ALL
                })
              : eJ(e)
                ? eZ({
                      quest: e,
...
let ez = (e) => (t) => e.some((e) => null != t.config.taskConfig.tasks[e]);
function eq(e) {
...
let eX = ez([a.X.PLAY_ON_XBOX, a.X.PLAY_ON_PLAYSTATION]),
    eJ = ez([a.X.WATCH_VIDEO]);
function e$(e) {
    return eX(e);
}
let e0 = (e, t) => {
...
function e1(e) {
    return null != e.userStatus && (e0(e.userStatus, a.X.PLAY_ON_XBOX) || e0(e.userStatus, a.X.PLAY_ON_PLAYSTATION));
}
function e2(e) {
    return !!eJ(e) && (0, n(952265).nf)(ts(e.id));
}
function e3() {
...
function te(e) {
    return e9(e) === P.ABu.XBOX ? D.t.mytEv7 : D.t.iDiwb2;
}
function tt(e) {
    var t, n, r, i;
...
function to(e) {
    var t;
    return ti(e) && (null === (t = ep(e)) || void 0 === t ? void 0 : t.expirationMode) === l.n.PREMIUM_PERMANENT;
}
function ta(e) {
...
function tc(e, t) {
    var n, r;
    !K(e) && (null === (n = e.userStatus) || void 0 === n ? void 0 : n.enrolledAt) != null && (null === (r = e.userStatus) || void 0 === r ? void 0 : r.completedAt) == null && (0, I.cT)(e.id, t);
}
function tu(e) {
    return {
