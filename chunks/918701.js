...
var I = r(572004),
    ...
    B = r(388032);
let G = 2592000000,
    Z = new Set([_.n.PREMIUM_EXTENSION, _.n.PREMIUM_PERMANENT]);
function F(e) {
    try {
        ...
        case m.w.REWARD_CODE:
            return {
                questRewards: {
                    reward: {
                        tag: n.reward.tag,
                        rewardCode: eo(n.reward.reward_code)
                    }
                }
            };
    }
...
function el(e) {
    return {
        skuId: e.sku_id,
        tenantMetadata: es(e.tenant_metadata),
        consumed: e.consumed
    };
}
function eu(e) {
...
function e_(e) {
    var n, r;
    let { quest: i, taskDetails: a, thirdPartyTaskDetails: o } = e;
...
function ev(e) {
    ...
    let r = new Date(e.expiresAt),
        ...
        a = (0, c.Z)(i, r),
        o = Math.floor(a / 30) + (a % 30 >= 25 ? 1 : 0);
    if (o >= 12) {
        let e = Math.floor(o / 12);
        return B.intl.formatToPlainString(B.t.PClsr6, { years: e });
    }
    if (o > 0) return B.intl.formatToPlainString(B.t.kridzM, { months: o });
    {
        let e = (0, c.Z)(i, r);
...
function eR(e) {
    return e.taskConfig.type === g.L.FIRST_PARTY && null != e.taskConfig.tasks[p.X.PLAY_ON_DESKTOP];
}
function eO(e) {
    let { quest: n } = e;
    return eR(n.config);
...
let eB = (e, n) => {
    ...
    eF = (e, n) => {
        var r, i, a, o;
        let s = null === (o = e.userStatus) || void 0 === o ? void 0 : null === (a = o.progress) || void 0 === a ? void 0 : null === (i = a[n.eventName]) || void 0 === i ? void 0 : null === (r = i.heartbeat) || void 0 === r ? void 0 : r.lastBeatAt;
        if (null == s || !eZ(e)) return 0;
        let l = Date.now() - new Date(s).valueOf();
        return (0, d.floor)(l / T.Z.Millis.SECOND, 2);
    },
    eV = (e, n) => {
        var r, i, a, o, s;
        let l = null === (i = e.userStatus) || void 0 === i ? void 0 : null === (r = i.progress) || void 0 === r ? void 0 : r[n.eventName],
            u = null !== (s = null !== (o = null == l ? void 0 : l.value) && void 0 !== o ? o : null === (a = e.userStatus) || void 0 === a ? void 0 : a.streamProgressSeconds) && void 0 !== s ? s : 0;
        if (e$(e)) {
    ...
    eY = (e) => {
        var n, r;
        let { quest: i, taskType: a, includeTaskTypes: o = p.T.ALL } = e,
            s = i.config.taskConfig;
        if (s.type !== g.L.FIRST_PARTY) throw Error('Cannot retrieve task details for task config with type '.concat(s.type, '!'));
        let l = null != a ? a : null === (n = Object.values(s.tasks).filter((e) => o.has(e.eventName))[0]) || void 0 === n ? void 0 : n.eventName,
            u = null !== (r = s.tasks[l]) && void 0 !== r ? r : s.tasks[p.X.STREAM_ON_DESKTOP];
        ...
        return {
            progressSeconds: d,
            targetSeconds: c,
            targetMinutes: Math.round(c / T.Z.Seconds.MINUTE),
            percentComplete: eG(c, d),
            taskType: l
        };
    },
    eW = (e) => (p.T.ALL.has(e) ? e : null),
    eK = (e) => {
        var n, r;
        let { quest: i, includeTaskTypes: a = p.T.ALL } = e;
        for (let e of Object.values(null !== (r = null === (n = i.userStatus) || void 0 === n ? void 0 : n.progress) && void 0 !== r ? r : {})
            .sort((e, n) => {
                ...
                let a = null == e ? void 0 : null === (r = e.heartbeat) || void 0 === r ? void 0 : r.lastBeatAt,
                    o = null == n ? void 0 : null === (i = n.heartbeat) || void 0 === i ? void 0 : i.lastBeatAt;
                if (null != a && null != o) return new Date(a).valueOf() > new Date(o).valueOf() ? -1 : 1;
                if (null == a && null == o && (null == e ? void 0 : e.updatedAt) != null && (null == n ? void 0 : n.updatedAt) != null) return new Date(e.updatedAt).valueOf() > new Date(n.updatedAt).valueOf() ? -1 : 1;
    ...
    ez = (e, n) => {
        if (e.config.taskConfig.type !== g.L.FIRST_PARTY)
            return {
                ...
                targetMinutes: 1,
                percentComplete: 0,
                taskType: p.X.STREAM_ON_DESKTOP
            };
        if (eJ(e))
            return eK({
                quest: e,
                includeTaskTypes: null != n ? n : e2(e) ? p.T.CONSOLE : p.T.ALL
            });
        if (e$(e))
            return eY({
                quest: e,
...
let eJ = eQ([p.X.PLAY_ON_XBOX, p.X.PLAY_ON_PLAYSTATION]),
    e$ = eQ([p.X.WATCH_VIDEO]);
function e0(e) {
    return eJ(e);
}
let e1 = (e, n) => {
    ...
    if (null == a) return !1;
    let o = new Date(a).valueOf();
    return !isNaN(o) && o > Date.now();
};
function e2(e) {
    return null != e.userStatus && (e1(e.userStatus, p.X.PLAY_ON_XBOX) || e1(e.userStatus, p.X.PLAY_ON_PLAYSTATION));
}
function e3(e) {
    return !!e$(e) && (0, r(952265).nf)(to(e.id));
}
function e4() {
...
function e5(e, n) {
    ...
    let i = ta(r);
    if (1 === i.length) return (0, b.Z)({ platformType: i.at(0) });
    E.Z.dispatch({
        type: 'CONNECTIONS_GRID_MODAL_SHOW',
        onComplete: (e) => (0, b.Z)({ platformType: e }),
...
function tt(e) {
    var n, r, i, a;
    let { quest: o, rewardCode: s, selectedPlatformType: l, sharedQuestFields: u } = e,
        c = eN({ quest: o }),
        d = null != l ? l : null == s ? void 0 : s.platform,
        f = c
            ? ek({
                  quest: o,
                  idx: null !== (i = null == s ? void 0 : s.tier) && void 0 !== i ? i : null === (n = o.userStatus) || void 0 === n ? void 0 : n.claimedTier
              })
            : null,
        p = null !== (a = null == f ? void 0 : null === (r = f.messages) || void 0 === r ? void 0 : r.redemptionInstructionsByPlatform) && void 0 !== a ? a : u.defaultRewardRedemptionInstructionsByPlatform;
    return null != d ? p[d] : void 0;
}
function tn(e) {
...
function ta(e) {
    ...
    for (let e of n)
        switch (e) {
            case p.X.PLAY_ON_XBOX:
                r.push(k.ABu.XBOX);
                break;
            case p.X.PLAY_ON_PLAYSTATION:
