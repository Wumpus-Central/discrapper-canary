...
function F(e, t) {
    ...
    if (null != n) return n;
    for (let [t, n] of e) if (!j(n) && eN(n)) return n;
}
function V(e, t) {
    return Array.from(e.values()).filter((e) => B(t, e) && !j(e) && eI({ quest: e }));
}
function j(e) {
...
function e7(e) {
    var t;
    return e5(e) && (null === (t = ec(e)) || void 0 === t ? void 0 : t.expirationMode) === l.n.PREMIUM_PERMANENT;
}
function e8(e) {
