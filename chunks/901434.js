...
let v = (e, t) => b.ZP.getName(e.getGuildId(), e.id, t.user),
    j = function (e) {
        let { participants: t, channel: n, hasConnectPermission: l } = e,
            ...
            I = 4 === E.length ? 2 : 3,
            P = (0, o.Wu)([u.Z], () => E.map((e) => u.Z.getParticipant(n.id, e.id)).filter(g.lm), [n.id, E]);
        return (0, r.jsxs)('div', {
            ...
            children: [
                    ...
                    children: (0, r.jsx)(s.Text, {
                        ...
                        children:
                            0 === E.length
                                ...
                                : 1 === E.length
                                  ? y.intl.formatToPlainString(y.t.EQwZlJ, { a: v(n, E[0]) })
                                  : 2 === E.length
                ...
                (0, r.jsxs)('div', {
                    ...
                    children: [
                        (0, r.jsx)(s.zxk, {
                            disabled: !l,
                            className: a()(C.joinButton, { [C.roundButton]: !b }),
