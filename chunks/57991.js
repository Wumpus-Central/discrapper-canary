        ...
        children: [
            ...
            (0, e.jsx)("div", {
                ...
                children: (0, e.jsx)(A.E, {
                    variant: "text-xs/semibold",
                    color: "always-white",
                    children: L.intl.format(L.t["dR/SVH"], { count: r.premiumSubscriberCount }),
                }),
            }),
        ],
    });
...
function v(o) {
    let { badgeType: r, guildTraits: s } = o,
        { tooltipTitle: a, tooltipSubtitle: l, tooltipDescription: n } = (0, T.V)(r, s.visibility);
    return (0, e.jsxs)(e.Fragment, {
        children: [
            (0, e.jsxs)("div", {
                className: M.Rf,
                children: [
                    (0, e.jsx)(A.E, { color: "interactive-text-active", variant: "text-xs/bold", children: a }),
                    null != l ? (0, e.jsx)(A.E, { color: "text-muted", variant: "text-xs/medium", children: l }) : null,
                    null != n ? (0, e.jsx)(A.E, { color: "text-muted", variant: "text-xs/medium", children: n }) : null,
                ],
            }),
