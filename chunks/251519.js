...
async function O(e) {
    ...
    i()(null == t, "Syncing to remote while in voice!"),
        e.selfMute !== c.Ay.isSelfMute() && (await o.A.toggleSelfMute({ syncRemote: !1 })),
        e.selfDeaf !== c.Ay.isSelfDeaf() && o.A.toggleSelfDeaf({ syncRemote: !1 });
}
class R extends l.A {
            ...
            n =
                ...
                e.find((e) => {
                    let n = T.hv.has(e.clientInfo.os),
                        r = null != E.A.getVoiceStateForSession(d.default.getId(), e.sessionId),
                        i = null == t || (0, A.X)(t.type) === e.clientInfo.os;
                    return n && i && r;
                }));
        if (null == n) return null;
        this.awaitRemoteTimeout.stop(), (0, p.m9)(n.sessionId);
        let r = E.A.getVoiceStateForSession(d.default.getId(), n.sessionId);
        null != r && O(r);
    };
    handleAudioStateToggle = (e) => {
        let { syncRemote: t, context: n } = e;
        if (!t || n !== S.x.DEFAULT) return;
        let r = c.Ay.isSelfDeaf(),
            i = c.Ay.isSelfMute(),
            s = d.default.getId(),
            a = g.default.getRemoteSessionId();
        if (null == a) return;
        let o = E.A.getVoiceStateForSession(s, a);
        null == o ||
            ((o.selfDeaf !== r || o.selfMute !== i) &&
                ((0, p.JS)(a, { selfDeaf: r, selfMute: i }),
    ...
    handleSessionsChanged = () => {
        ...
        null != e && null == f.A.getSessionById(e) && (0, p.ZG)(),
            null == e && this.maybeConnect(Object.values(f.A.getSessions()));
    };
    handleWaitForRemoteSession = () => {
        this.awaitRemoteTimeout.start(6e4, () => {
            (0, p.ZG)(), a.A.show({ title: y.intl.string(y.t.wGMxr3), body: y.intl.string(y.t.i5k8b5) });
        });
    };
    handleConsoleCommandUpdate = (e) => {
        ...
        null != a &&
            ...
            T.v_.has(r.code) && this.awaitRemoteTimeout.isStarted()
                ? this.awaitRemoteTimeout.start(18e4, () => (0, p.ZG)(), !0)
                : "failed" === n && (0, p.ZG)();
    };
