...
let ed = N.sC,
    ec = {
        ...
        [w.$.GUILD_BOOSTER]: {
            ...
            ctaAction: () => (0, G.openUserSettings)(z.X.PREMIUM_GUILD_SUBSCRIPTIONS_PANEL),
        },
        [w.$.ORB_PROFILE]: {
...
function ej(e) {
    let {
        ...
        p = em(a, r, 48),
        y = (0, Y.d)({ location: "BadgeDirectoryPanel" }),
        f = null != d ? e_(d) : null,
        A = null != d && f !== d,
        I =
            null != f && A && null != p
                ...
                children: t.tiers.map((e) => {
                    let l = e.owned,
                        ...
                        c = (function (e) {
                            ...
                            return n || !l || i ? (t.milestone_text ?? "") : er.intl.string(er.t.VPu695);
...
function eS(e) {
    ...
    let p = n ?? t,
        ...
        P = S?.complex_icon_static_url ?? S?.simple_icon_url,
        z = !(0, V.uJ)(C?.progress_helper_text),
        G = null != R ? { "aria-labelledby": h } : { "aria-label": er.intl.string(er.t.Uwhb1l) };
    return (0, i.jsxs)(i.Fragment, {
        children: [
            null != U && (0, i.jsx)(u.E, { variant: "text-xs/medium", color: "text-subtle", children: U }),
            O &&
                !A &&
                (0, i.jsxs)("div", {
                    className: ew.ES,
                    children: [
                        ...
                        (0, i.jsxs)("div", {
                            ...
                            children: [
                                ...
                                null != B
                                    ...
                                    : null != C &&
                                      (0, i.jsx)(eN.z, { isIndeterminate: !0, size: "md", className: ew.hr, ...G }),
                                z &&
                                    (0, i.jsx)(u.E, {
                                        variant: "text-xs/medium",
                                        color: "text-subtle",
                        ...
                        null != P &&
                            (0, i.jsx)("img", { className: ew.Tw, src: P, alt: "", "aria-hidden": !0, draggable: !1 }),
                    ],
                }),
            O && !A
                ? (0, i.jsxs)("div", {
...
function ez() {
    return (0, i.jsx)(P.A, { height: 3, width: 3, "aria-hidden": "true", className: ex.zN });
}
function eG(e) {
    let { segments: t } = e;
    return 0 === t.length
        ...
        : (0, i.jsx)("div", {
              ...
              children: t.map((e, t) => {
                  let { key: n, node: l } = e;
                  return (0, i.jsxs)("span", { className: ex.Hq, children: [t > 0 && (0, i.jsx)(ez, {}), l] }, n);
              }),
          });
}
function e$(e) {
    let {
        ...
        _ = [];
    (g && _.push({ key: "beta", node: (0, i.jsx)(eP, {}) }),
        null != x &&
            _.push({
                key: "status",
                node: (0, i.jsxs)("span", {
    ...
    return 0 === j.length && null == v
        ...
        : (0, i.jsxs)("div", {
              className: ex.rI,
              children: [(0, i.jsx)(eG, { segments: j }), b && null != v && (0, i.jsx)(eG, { segments: [v] })],
          });
}
function eV(e) {
    let t,
        ...
        q = H?.simple_icon_url ?? h.simple_icon_url,
        Y = Z ?? J ?? q,
    ...
    let ev = l.useCallback(() => {
        ...
        ej =
            !A || h.is_earnable || C || h.badge_id === w.$.STAFF
                ? null
                : (0, i.jsx)(U.w, { type: "info", children: er.intl.format(er.t.vFekBs, { onViewBadges: O }) }),
        ...
        children: (0, i.jsx)("div", {
            ...
            children: (0, i.jsxs)(k.d_, {
                ...
                children: [
                    ...
                    null != Y &&
                        (0, i.jsx)("img", {
                            className: E()(ex.y2, null != Z && Y === Z && ex.hu),
                            src: Y,
                            alt: "",
                            "aria-hidden": !0,
                            draggable: !1,
                                    ...
                                    ep &&
                                        (0, i.jsx)(U.w, {
                                            ...
                                            children: er.intl.format(er.t.Zh44ni, {
                                                onGoToSettings: () =>
                                                    (0, G.openUserSettings)(z.X.DATA_USAGE_PERSONALIZATION_SETTING),
                                            }),
                                        }),
                                    eg,
                                    !(0, V.uJ)(x) &&
    ...
    return (0, i.jsxs)("div", {
        ...
        children: [
            ...
            (0, i.jsxs)("div", {
                ...
                children: [
                    null != m &&
                        (0, i.jsx)("img", { className: eH.Tw, src: m, alt: "", "aria-hidden": !0, draggable: !1 }),
                    (0, i.jsxs)("div", {
                        className: eH.Bd,
                        children: [
                            null != x && (0, i.jsx)(u.E, { id: a, variant: "text-sm/medium", children: x }),
                            null != o
                                ? (0, i.jsx)(eN.z, {
                                      value: c?.current ?? 0,
                                      minValue: c?.floor ?? 0,
                                ...
                                : null != c &&
                                  (0, i.jsx)(eN.z, { isIndeterminate: !0, size: "md", className: eH.hr, ...h }),
                        ],
                    }),
                    null != g &&
                        (0, i.jsx)("img", { className: eH.Tw, src: g, alt: "", "aria-hidden": !0, draggable: !1 }),
                ],
            }),
        ],
    });
...
var eK = n(148204);
let eW = [er.t["6zFA/T"], er.t.wzZHKl, er.t["+ED/nf"]];
function eQ() {
    let e = Math.floor(Math.random() * eW.length);
    return er.intl.string(eW[e]);
}
function eX() {
    return (0, i.jsx)(P.A, { height: 3, width: 3, "aria-hidden": "true", className: eK.zN });
}
function e0(e) {
    let { segments: t } = e;
    return 0 === t.length
        ...
        : (0, i.jsx)("div", {
              ...
              children: t.map((e, t) => {
                  let { key: n, node: l } = e;
                  return (0, i.jsxs)("span", { className: eK.Hq, children: [t > 0 && (0, i.jsx)(eX, {}), l] }, n);
              }),
          });
}
function e1(e) {
    let t,
        ...
        Z = eR(H) ?? void 0,
        J = ec[c.badge_id],
        q = c.badge_id === w.$.PREMIUM_TENURE,
        Y = q ? (I?.name ?? I?.key) : I?.name,
        K = q ? er.intl.string(er.t.Ipxkog) : c.name;
    q ? (n = null != Y ? `${K} ${Y}` : K) : null != Y && c.owned ? ((t = K), (n = Y)) : (n = K);
    let W = (0, M.ie)(c.badge_id) && !c.is_earnable && c.badge_id !== w.$.STAFF,
        Q = (c.tiers?.length ?? 0) > 0,
        X = (0, v.H5)(c),
        ee = (function (e) {
            let [t, n] = l.useState(eQ),
                [i, a] = l.useState(e);
            return (e !== i && (a(e), n(eQ())), t);
        })(c.badge_id);
    a = c.owned
    ...
    let et = (0, V.uJ)(c.info_label) ? void 0 : c.info_label,
        en = c.owned && H !== eT.x.COMMON && null != Z,
        ei = [];
    (null != et &&
        ei.push({
            key: "info",
        ...
        en && ei.push({ key: "rarity", node: (0, i.jsx)(S.E, { ...Z }) }));
    let el = _.default.getCurrentUser()?.premiumType,
        ea = q && (el === es.PremiumTypes.TIER_0 || el === es.PremiumTypes.TIER_1);
    r =
    ...
    let ed = l.useCallback(() => {
        ...
        eu =
            !h || c.is_earnable || p || c.badge_id === w.$.STAFF
                ? null
                : (0, i.jsx)(U.w, { type: "info", children: er.intl.format(er.t.vFekBs, { onViewBadges: A }) }),
                ...
                children: [
                    (0, i.jsxs)("div", {
                        ...
                        children: [
                            ...
                            (0, i.jsx)("div", {
                                className: eK.Gw,
                                children: (0, i.jsx)(d.J, { onClick: x, size: "sm" }),
                            }),
                        ],
                    }),
                    null != P &&
                        (0, i.jsx)("img", {
                            className: E()(eK.y2, null != C && P === C && eK.hu),
                            src: P,
                            alt: "",
                            "aria-hidden": !0,
                            draggable: !1,
                                    ...
                                    eb &&
                                        (0, i.jsxs)("div", {
                                            ...
                                            children: [
                                                ...
                                                null != eu && (0, i.jsx)("div", { className: eK.Z6, children: eu }),
                                            ],
                                        }),
                                    !eb && eu,
                                ],
...
function e8(e) {
    ...
    let L = l.useMemo(() => {
        ...
        P = null != U && null != B ? v.Ay.getBadgeById(U, B) : void 0,
        z = null != L && null != B ? v.Ay.getBadgeById(L, B) : void 0,
        G = P ?? z,
        $ = !F && !D,
        V = !F && D,
        M = !C;
    ...
    let H = (0, s.bG)([v.Ay], () => null != y && null != G && (v.Ay.getBadgeById(G.badge_id, y)?.owned ?? !1), [G, y]),
        Z = (0, s.bG)([v.Ay], () => (null != w && null != G ? v.Ay.getBadgeById(G.badge_id, w) : void 0), [G, w]),
        J = Z?.owned ?? !1,
        q = l.useCallback(
            function () {
        ...
        K = l.useCallback(() => {
            null != w &&
                null != y &&
                (f({ actionName: "view_your_badges_pressed", badge: G, displayedUserId: B, isSociallyNavigated: C }),
        ...
        Q = l.useCallback(() => {
            (f({ actionName: "badge_directory_closed", badge: G, displayedUserId: B, isSociallyNavigated: C }), n());
        }, [B, C, n, G]),
        X = l.useCallback(() => {
            null != w &&
                (f({
    ...
    return (
        ...
        l.useEffect(() => {
            null != G && f({ actionName: "badge_detail_viewed", badge: G, displayedUserId: B, isSociallyNavigated: C });
        }, [ee, B, C]),
        (0, i.jsx)(r.EO, {
