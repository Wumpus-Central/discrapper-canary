...
(d.prototype.push = function (e, t) {
    ...
    (s = t === ~~t ? t : !0 === t ? o.Z_FINISH : o.Z_NO_FLUSH), 'string' == typeof e ? (_.input = a.binstring2buf(e)) : '[object ArrayBuffer]' === u.call(e) ? (_.input = new Uint8Array(e)) : (_.input = e), (_.next_in = 0), (_.avail_in = _.input.length);
    do {
        if ((0 === _.avail_out && ((_.output = new i.Buf8(p)), (_.next_out = 0), (_.avail_out = p)), (n = r.inflate(_, o.Z_NO_FLUSH)) === o.Z_NEED_DICT && h && ((f = 'string' == typeof h ? a.string2buf(h) : '[object ArrayBuffer]' === u.call(h) ? new Uint8Array(h) : h), (n = r.inflateSetDictionary(this.strm, f))), n === o.Z_BUF_ERROR && !0 === m && ((n = o.Z_OK), (m = !1)), n !== o.Z_STREAM_END && n !== o.Z_OK)) return this.onEnd(n), (this.ended = !0), !1;
        _.next_out && (0 === _.avail_out || n === o.Z_STREAM_END || (0 === _.avail_in && (s === o.Z_FINISH || s === o.Z_SYNC_FLUSH))) && ('string' === this.options.to ? ((l = a.utf8border(_.output, _.next_out)), (c = _.next_out - l), (d = a.buf2string(_.output, l)), (_.next_out = c), (_.avail_out = p - c), c && i.arraySet(_.output, _.output, l, c, 0), this.onData(d)) : this.onData(i.shrinkBuf(_.output, _.next_out))), 0 === _.avail_in && 0 === _.avail_out && (m = !0);
    } while ((_.avail_in > 0 || 0 === _.avail_out) && n !== o.Z_STREAM_END);
    return (n === o.Z_STREAM_END && (s = o.Z_FINISH), s === o.Z_FINISH) ? ((n = r.inflateEnd(this.strm)), this.onEnd(n), (this.ended = !0), n === o.Z_OK) : (s === o.Z_SYNC_FLUSH && (this.onEnd(o.Z_OK), (_.avail_out = 0)), !0);
}),
