...
(d.prototype.push = function (e, t) {
    ...
    do {
        if (
            ...
            (n = r.inflate(_, a.Z_NO_FLUSH)) === a.Z_NEED_DICT &&
                h &&
                ((f =
                    "string" == typeof h
                        ? o.string2buf(h)
            ...
            n === a.Z_BUF_ERROR && !0 === m && ((n = a.Z_OK), (m = !1)),
        ...
        _.next_out &&
            ...
            ("string" === this.options.to
                ? ((l = o.utf8border(_.output, _.next_out)),
                  (c = _.next_out - l),
                  (d = o.buf2string(_.output, l)),
                  (_.next_out = c),
                  (_.avail_out = p - c),
    ...
    return (n === a.Z_STREAM_END && (s = a.Z_FINISH), s === a.Z_FINISH)
        ? ((n = r.inflateEnd(this.strm)), this.onEnd(n), (this.ended = !0), n === a.Z_OK)
        : (s === a.Z_SYNC_FLUSH && (this.onEnd(a.Z_OK), (_.avail_out = 0)), !0);
}),
