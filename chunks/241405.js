...
(d.prototype.push = function (e, t) {
    ...
    (s = t === ~~t ? t : !0 === t ? o.Z_FINISH : o.Z_NO_FLUSH), 'string' == typeof e ? (f.input = a.binstring2buf(e)) : '[object ArrayBuffer]' === u.call(e) ? (f.input = new Uint8Array(e)) : (f.input = e), (f.next_in = 0), (f.avail_in = f.input.length);
    do {
        if ((0 === f.avail_out && ((f.output = new i.Buf8(p)), (f.next_out = 0), (f.avail_out = p)), (n = r.inflate(f, o.Z_NO_FLUSH)) === o.Z_NEED_DICT && h && ((_ = 'string' == typeof h ? a.string2buf(h) : '[object ArrayBuffer]' === u.call(h) ? new Uint8Array(h) : h), (n = r.inflateSetDictionary(this.strm, _))), n === o.Z_BUF_ERROR && !0 === m && ((n = o.Z_OK), (m = !1)), n !== o.Z_STREAM_END && n !== o.Z_OK)) return this.onEnd(n), (this.ended = !0), !1;
        f.next_out && (0 === f.avail_out || n === o.Z_STREAM_END || (0 === f.avail_in && (s === o.Z_FINISH || s === o.Z_SYNC_FLUSH))) && ('string' === this.options.to ? ((l = a.utf8border(f.output, f.next_out)), (c = f.next_out - l), (d = a.buf2string(f.output, l)), (f.next_out = c), (f.avail_out = p - c), c && i.arraySet(f.output, f.output, l, c, 0), this.onData(d)) : this.onData(i.shrinkBuf(f.output, f.next_out))), 0 === f.avail_in && 0 === f.avail_out && (m = !0);
