...
function x(e, t, n) {
    ...
    if (l && (0, d.Km)(n.type)) {
        if ((e.attachments.length > 0 || e.messageSnapshots.some((e) => e.message.attachments.length > 0)) && !f.Z.can(b.Plq.ATTACH_FILES, n)) return { label: y.intl.string(y.t.P7yvbm) };
        if ((e.embeds.length > 0 || e.messageSnapshots.some((e) => e.message.embeds.length > 0)) && !(0, _.eC)(n, f.Z) && !(0, _.En)(e)) return { label: y.intl.string(y.t.Wr4RIS) };
        let t = [
            ...(0, u.cv)(e),
        ...
        if ((e.hasFlag(b.iLy.IS_VOICE_MESSAGE) || e.messageSnapshots.some((e) => e.message.hasFlag(b.iLy.IS_VOICE_MESSAGE))) && !f.Z.can(b.Plq.SEND_VOICE_MESSAGES, n)) return { label: y.intl.string(y.t.quj4DQ) };
    }
}
function E(e, t) {
