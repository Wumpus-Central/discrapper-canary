...
function _(e) {
    let { subscriptionTier: t, subscriptionPlanId: n, buttonTextOverride: _, defaultTextOverride: f } = e,
        p = (0, r.bG)([s.default], () => s.default.getCurrentUser()),
        h = (0, r.bG)([a.A], () => a.A.getPremiumTypeSubscription()),
        E = (0, r.bG)([l.A], () => l.A.getPremiumTypeOverride()),
        m = f ?? d.intl.string(d.t["2pG5Ga"]),
        g = null != h ? (0, o.EL)(h) : null,
        A = void 0 !== E ? E : null != g ? (0, o.m6)(g.planId) : p?.premiumType,
    ...
    if (!((null != h && h.status !== c.Dmq.ACCOUNT_HOLD && !(0, i.m1)(h.planId) && !I && !T && void 0 === E) || S))
