        ...
        children: [
            (0, n.jsxs)("div", {
                ...
                children: [
                    ...
                    (0, n.jsx)(Z.A, { userId: l.id, onClose: f, className: eI.interactionToast }),
                    (0, n.jsx)(V.A, {
                        user: l,
                        displayProfile: m,
                        guildId: s,
            ...
            (0, n.jsxs)(d.HOs, {
                ...
                children: [
                    ...
                    h && (0, n.jsx)(K.A, { isPremiumUser: (0, b.ki)(t), onInteraction: f }),
                    ...
                    !D && (0, n.jsx)(W.E, { userBio: m?.bio, setLineClamp: !1 }),
                    F.length > 0 &&
                        (0, n.jsx)(eu.A, {
                            heading: ej.intl.string(ej.t["Uv/eTx"]),
                            children: (0, n.jsx)($.A, { applicationIds: F }),
                        }),
                    (0, n.jsx)(eu.A, {
...
function eE(e) {
    let { user: l, displayProfile: t, children: i } = e,
        ...
        { profileThemeStyle: o, profileThemeClassName: d } = (0, k.A)({
            theme: s,
            themeType: null,
            primaryColor: a,
            secondaryColor: r,
...
function eC(e) {
    let {
        ...
        M = l.id === t.id,
        { guildId: k, pendingGuildId: V, selectUserProfile: B } = (0, D.A)({ userId: l.id, initialGuildId: s }),
        z = i.useMemo(() => (null != k ? { [k]: [l.id] } : {}), [k, l.id]);
    (0, m.Eq)(z, "UserProfileModalV2");
    let W = (0, S.Ay)(l.id, k),
        K = (0, g.A)(W?.profileFrame?.skuId, "UserProfileModalV2"),
        H = (0, R.X)("UserProfileModalV2"),
        $ = M && H,
        {
            isExpanded: X,
            isAnimating: Z,
    ...
    let ec = (0, w.fC)(),
        ...
        e_ = (0, h.GV)(),
        eb = ej.intl.format(ej.t.KRe1Fk, { name: eT });
    return (0, n.jsx)(p.f5, {
        value: eN,
                ...
                children: (0, n.jsx)(F.N, {
                    ...
                    children: (0, n.jsxs)(d.EOs, {
                        ...
                        children: [
                                        ...
                                        (0, n.jsxs)(eE, {
                                            ...
                                            children: [
                                                (0, n.jsxs)("div", {
                                                    ...
                                                    children: [
                                                        (0, n.jsx)(ea.A, { isCurrentUser: M, onClose: b }),
                                                        (0, n.jsx)(d.AC4, {
                                                            children: (0, n.jsx)(d.H, { id: e_, children: eb }),
                                                        }),
                                                        $ &&
                                                            (!X || Z) &&
                                                            (0, n.jsx)(eo._T, {
                                            ...
                                            children: [
                                                ...
                                                (0, n.jsxs)(ee.A, {
                                                    ...
                                                    children: [
                                                        ...
                                                        (0, n.jsx)(ep.A, { className: eI.toast }),
                                                        (0, n.jsx)(ey, {
                                                            user: l,
                                                            currentUser: t,
                                                            guildId: k,
                            ...
                            (0, n.jsx)(ed.A, { userId: l.id, guildId: k, className: eI.pendingChangesToolbar }),
                        ],
                    }),
                }),
            }),
