...
var a = r(503698),
    ...
    C = r(756974);
function y() {
    let { claimableRewards: e } = (0, R.Pv)(),
        t = (0, o.bG)([E.A], () => {
            let e = E.A.getMarketingComponentByType(A.C.GIFT_PLAN_SELECTION_CARD_BANNER);
        ...
        r = (0, _.T)(t?.bannerAsset),
        i = (0, _.T)(t?.avatarAsset);
...
let Z = function (e) {
    let { isGift: t = !1, priceOptions: r } = e,
        i = (0, o.bG)([H.A], () => H.A.get(k.gD.PREMIUM_GROUP_MONTH)),
        a = (0, d.q)((0, x.Ay)());
    if (null == i) return (0, n.jsx)(D.y, { type: D.y.Type.PULSING_ELLIPSIS, className: V.xB });
    let s = (0, F.sS)(i, r, !1, t),
        l = k.WT.MONTH;
    return (0, n.jsxs)("div", {
        children: [
            (0, n.jsx)(v.E, {
...
function Q(e) {
    let {
        ...
        R = null != v,
        _ = (0, d.q)((0, x.Ay)()),
        E = g ? N.intl.string(N.t.tUbSDK) : N.intl.string(N.t["t9uG/o"]),
        P = (0, n.jsxs)(n.Fragment, {
            children: [
                R && (0, n.jsx)(B.R, { text: v, className: K.pill }),
                (0, n.jsx)(l.D, {
                    variant: "display-md",
                ...
                (0, n.jsx)(G.nH, { enablePremiumBrandRefresh: !0, isApplicationHome: m }),
                t,
            ],
        });
    return (0, n.jsx)(u.h, {
        color: "nitro-green",
        className: s()(K.card, K.tier0, i, { [K.pillMargin]: !m && R }),
        children: P,
    });
}
var $ =
...
function X(e) {
    let {
        ...
        R = (0, o.bG)([f.A], () => f.A.getPremiumTypeSubscription()),
        _ = (0, o.bG)([I.default], () => I.default.getCurrentUser()),
        E = (0, b.V)(),
        P = E?.subscription_trial?.sku_id,
        C = R?.hasActiveTrial ? _?.premiumType : null,
        w = (0, M.O)(),
        S = (0, j.k5)(),
        U = null != P || null != C ? k.Vk.PREMIUM_TRIAL : null != w || S ? k.Vk.PREMIUM_DISCOUNT : null,
        D = (0, d.q)((0, x.Ay)()),
        H = (0, O.rm)(S, C, w, E, P);
    return (0, n.jsxs)(u.h, {
        color: "nitro-pink",
        ...
        children: [
            ...
            v && (0, n.jsx)(B.R, { text: H ?? N.intl.string(N.t["6bEcYr"]), className: K.pill }),
            (0, n.jsx)(l.D, {
                variant: "display-md",
            ...
            (0, n.jsx)(W.A, {
                ...
                offerType: U,
                offerTierMatchesCard: P === k.pe.TIER_2 || (0, L.U9)(w, k.pe.TIER_2),
                showYearlyPrice: r,
                priceOptions: g,
                enablePremiumBrandRefresh: !0,
                headingVariant: "text-md/medium",
...
let et = (e) => {
        let { subscriptionTier: t, isReducedMotion: r, tierCardProps: i, className: a, narrowLayout: l } = e,
            o = t === k.pe.TIER_2,
            { subscribeButtonProps: d, subscriptionTier: u } = (0, U.$)({
                subscriptionTier: t,
