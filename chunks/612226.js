...
let Y = {
    ...
    [V.EkH.JUMP_TO_GUILD]: g.u,
    [V.EkH.SUBMIT]: v.z,
    [V.EkH.TEXTAREA_FOCUS]: j.U,
    [V.EkH.MARK_CHANNEL_READ]: h.f,
    [V.EkH.MARK_SERVER_READ]: x.l,
    ...
    [V.EkH.SEARCH_STICKERS]: I.U,
    [V.EkH.TOGGLE_HOTKEYS]: y._,
    [V.EkH.JUMP_TO_FIRST_UNREAD]: _.O,
