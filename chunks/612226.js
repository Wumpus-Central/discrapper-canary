...
let H = {
    [U.EkH.SERVER_NEXT]: I.nq,
    [U.EkH.SERVER_PREV]: I.X3,
    ...
    [U.EkH.SUBMIT]: T.z,
    [U.EkH.TEXTAREA_FOCUS]: S.U,
    [U.EkH.MARK_CHANNEL_READ]: f.f,
    [U.EkH.MARK_SERVER_READ]: _.l,
    ...
    [U.EkH.ZOOM_IN]: j.UF,
    [U.EkH.ZOOM_OUT]: j.RC,
    [U.EkH.ZOOM_RESET]: j.MY,
    [U.EkH.OPEN_APP_DIRECTORY]: h.T,
...
function Y() {
    let e = [
            ...
            {
                description: G.intl.string(G.t.Lns0FR),
                binds: ["mod+d"],
                group: "DND",
            },
            {
                description: G.intl.string(G.t.dmMqa2),
                binds: ["up", "down"],
                group: "DND",
            },
            {
                description: G.intl.string(G.t["cs/HVF"]),
                binds: ["spacebar", "enter"],
                group: "DND",
            },
            {
                description: G.intl.string(G.t["1ioMJS"]),
                binds: ["esc"],
                group: "DND",
                groupEnd: !0,
            },
            ...
            {
                description: G.intl.string(G.t.HnNtEB),
                binds: ["h+h+right+n+k"],
                group: "MISCELLANEOUS",
                groupEnd: !0,
            },
            {
                description: G.intl.string(G.t.fsBWmZ),
                binds: ["e"],
                group: "MESSAGE",
            },
            {
                description: G.intl.string(G.t.xwMqDw),
                binds: ["backspace"],
                group: "MESSAGE",
            },
            {
                description: G.intl.string(G.t["CvQ18/"]),
                binds: ["p"],
                group: "MESSAGE",
            },
            {
                description: G.intl.string(G.t.lfIHs7),
                binds: ["plus"],
                group: "MESSAGE",
            },
            {
            ...
            {
                description: G.intl.string(G.t.zSyDdH),
                binds: ["f"],
                group: "MESSAGE",
            },
            {
                description: G.intl.string(G.t.JrGD7O),
                binds: ["mod+c"],
                group: "MESSAGE",
            },
            {
                description: G.intl.string(G.t.RpE9k5),
                binds: ["alt+enter"],
                group: "MESSAGE",
            },
            {
