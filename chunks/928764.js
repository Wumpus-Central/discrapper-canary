...
function q(e) {
    ...
    return s
        ? (0, i.jsx)(u.$, {
              size: "sm",
              variant: "secondary",
              text: a ? V.intl.string(W.default["2Y4vkk"]) : V.intl.string(W.default.YIbR4r),
              onClick: () => {
                  !0 === o.w.get(L.f)
                      ? m()
...
function J(e) {
    let { postId: t, isFirstMessage: n, isLastItem: a = !1, parentChannelId: o } = e,
        ...
        { disableReactionUpdates: et, disableReactionCreates: en, isLurking: ei, isPendingMember: el } = (0, v.A)(X),
        ea = (0, M.W1)(X),
        ...
        ec = l.useCallback(
            (e) => {
                ...
                if (null != t && n) {
                    ...
                    J((e.bottom - e.top) / (n.bottom - n.top) < 1);
                }
            },
            [n],
        );
    ...
    return (0, i.jsxs)(i.Fragment, {
        children: [
            (0, i.jsxs)("div", {
                className: s()(z.kL, { [z.wx]: W }),
                ref: d,
                children: [
                    ea
                        ? (0, i.jsx)("div", { className: z.kX, children: (0, i.jsx)(D.A, { message: Q, channel: X }) })
                        : (0, i.jsxs)("div", {
                              className: s()(z.hY, { [z.Lq]: ed }),
                              children: [
                                  !eh &&
                                      !en &&
                                      null != er &&
                                  ...
                                  !en &&
                                      (0, i.jsx)(N.t, {
                                          ...
                                          channel: X,
                                          useChatFontScaling: !1,
                                          className: s()(Y.secondary, z.vU, { [z.w$]: !eh }),
                                          isForumToolbar: !0,
