...
let E = {
    init() {
        c.Z.addChangeListener(this.handleAccessibilityStoreChanged),
            ...
            m.addListener(this.handlePrefersMoreContrastChanged),
            this.handlePrefersMoreContrastChanged(m),
            h.addListener(this.handlePrefersForcedColorsChanged),
            this.handlePrefersForcedColorsChanged(h),
    ...
    handleAccessibilityStoreChanged() {
        g(u.E.REDUCED_MOTION, c.Z.useReducedMotion),
            g(u.E.REDUCED_MOTION_FROM_USER_SETTINGS, "auto" !== c.Z.rawPrefersReducedMotion),
            g(u.E.FORCED_COLORS_FROM_USER_SETTINGS, c.Z.syncForcedColors),
            g(u.E.CHAT_FONT_SCALE_DECREASED, c.Z.isFontScaledDown),
            g(u.E.CHAT_FONT_SCALE_INCREASED, c.Z.isFontScaledUp),
            g(u.E.ZOOM_LEVEL_DECREASED, c.Z.isZoomedOut),
            g(u.E.ZOOM_LEVEL_INCREASED, c.Z.isZoomedIn),
            g(u.E.MESSAGE_GROUP_SPACING_DECREASED, c.Z.isMessageGroupSpacingDecreased),
            g(u.E.MESSAGE_GROUP_SPACING_INCREASED, c.Z.isMessageGroupSpacingIncreased),
