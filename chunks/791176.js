...
function C(e) {
    ...
    let { permission: i, roleIds: l, guild: p, specMap: h } = e,
        m = g.Plq[i],
        C = null !== (n = null === (t = h[m.toString()]) || void 0 === t ? void 0 : t.title) && void 0 !== n ? n : (0, u.wt)(m),
        v = f._o.has(m),
        y = (0, a.e7)([d.Z], () => d.Z.getRoles(p.id));
    return (0, r.jsx)(s.ua7, {
        ...
        children: (e) => {
            ...
            return (0, r.jsxs)(s.P3F, {
                className: o()(_.permissionChiplet, { [_.elevatedPermission]: v }),
                onMouseEnter: t,
                onMouseLeave: n,
                children: [
                    v &&
...
let v = i.memo(function (e) {
    let { member: t, onNavigate: n } = e,
        ...
        x = i.useMemo(() => (null != l ? p.Z.getGuildPermissionSpecMap(l) : null), [l]),
                      ...
                      (0, r.jsxs)(s.P3F, {
                          ...
                          children: [
                              (0, r.jsx)(s.Text, {
                                  variant: 'eyebrow',
                                  color: 'interactive-normal',
                                  children: b.NW.format(b.t['0x6aTk'], { count: y })
                              }),
                              (0, r.jsx)(s.Fbu, {
                                  size: 'custom',
                                  width: 16,
