...
var v = n(151781);
let C = new d.A("MemberSafetySearchManager");
function R(e) {
    return `guild_${e}`;
}
function O(e) {
...
async function k(e) {
    ...
    let n,
        i,
        r = v.A.getSearchStateByGuildId(e),
        o = v.A.getPaginationStateByGuildId(e),
        l = R(e),
        u = w(l),
        [c, d] = (function (e, t, n) {
            let i = (function (e, t) {
                    let n,
                        ...
                        c = t.currentPage,
                        d = u?.currentPage ?? 0,
                        _ = v.A.getElasticSearchPaginationByGuildId(e);
                    switch (!0) {
                        case null == _:
                        case a === l && 0 === a:
                            return 0;
                ...
                r = v.A.getElasticSearchPaginationByGuildId(e),
                s = (0, f.n4)(n);
            switch (i) {
                case 0:
                    return [null, { limit: s }];
    ...
    try {
        if ((C.info("Making member search request", { query: A.query, guildId: e }), null == A.query))
            throw Error("Query is null");
        await N(e, A.query, { signal: A.abortController?.signal ?? void 0 });
    } catch (e) {
        if (-1 === e.code) return;
