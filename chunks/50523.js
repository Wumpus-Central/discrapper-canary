...
function O(e) {
    var t, n;
    let { application: O, customId: v, customLink: y, embedUrl: x, referrerId: j } = e,
        I = null == O || null == (t = O.bot) ? void 0 : t.id,
        S = (0, c.ms)({
    ...
    L &&
        k.push({
            ...
            disabledReason:
                null != Z && (null == R ? void 0 : R.compositeInstanceId) === Z ? C.intl.string(C.t.wJNK8P) : void 0,
        }),
        P &&
            !L &&
            k.push({
