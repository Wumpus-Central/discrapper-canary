...
function F(e) {
    ...
    let { channel: p, showingBanner: h } = e,
        ...
        { systemDMRedesignEnabled: F } = g.Z.useExperiment({ location: 'bf1a4f_1' }, { autoTrackExposure: null !== (t = p.isSystemDM()) && void 0 !== t && t }),
    ...
    if (
        (i.useEffect(() => {
            y === L.d4z.DM && null == k && null != I && a.Z.wait(() => (0, _.Z)(p.getRecipientId(), I.getAvatarURL(null, 80), { withMutualGuilds: !0 }));
        }, [k, y, p, I]),
        i.useEffect(() => {
