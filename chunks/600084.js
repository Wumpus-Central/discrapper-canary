...
function F(e) {
    let { canManageRoles: t, channel: n } = e,
        i = t && (0, p.Yk)(n),
        o = (0, l.e7)([C.ZP], () => null != n.guild_id && n === C.ZP.getDefaultChannel(n.guild_id), [n]);
    if ((0, h.Z)(n.id)) return null;
    if (n.isForumPost()) return (0, r.jsx)(S.Z, { channel: n });
    if (x.Ec.has(n.type)) return (0, r.jsx)(k.Z, { channel: n });
...
function H(e) {
    ...
    let { channel: p, showingBanner: h } = e,
        ...
        { authorizedAppToken: z, authorizedAppsFetchState: W } = (0, l.cj)([y.Z], () => {
            var e;
            return {
    ...
    if (
        (i.useEffect(() => {
            C === L.d4z.DM && null == M && null != S && a.Z.wait(() => (0, _.Z)(p.getRecipientId(), S.getAvatarURL(null, 80), { withMutualGuilds: !0 }));
        }, [M, C, p, S]),
        i.useEffect(() => {
            (null == S ? void 0 : S.bot) && W === y.M.NOT_FETCHED && s.Z.fetch();
    ...
    if (p.isMultiUserDM())
        if (p.isManaged())
            return (0, r.jsxs)(I.ZP, {
                channelId: p.id,
                children: [(0, r.jsx)(I.Ot, { children: U.intl.format(U.t.I3R7Vl, { channelName: x }) }), (0, r.jsx)(I.jz, { children: U.intl.string(U.t.M8Ao6O) })]
            });
    ...
    return k
        ...
        : (0, r.jsx)(I.ZP, {
              channelId: p.id,
              children: (0, r.jsx)(I.jz, { children: U.intl.format(U.t.hPVEQE, { channelName: x }) })
          });
}
