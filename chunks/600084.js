...
function H(e) {
    ...
    let { channel: p, showingBanner: h } = e,
        ...
        k = (0, l.e7)([b.Z], () => (C === L.d4z.DM ? b.Z.getMutualGuilds(p.getRecipientId()) : null), [p, C]),
    ...
    if (
        (i.useEffect(() => {
            C === L.d4z.DM && null == k && null != P && o.Z.wait(() => (0, _.Z)(p.getRecipientId(), P.getAvatarURL(null, 80), { withMutualGuilds: !0 }));
        }, [k, C, p, P]),
        i.useEffect(() => {
