...
eV(
    ...
    (e) => {
        er.A.initialGuild.measure(() => {
            s.Ay.Emitter.batched(() => {
                var t;
                let n,
                    i = ((t = B.identifyStartTime), (n = eb(e)), (eN = { guild: e, identifyTime: t }), n);
                      ...
                      s.Ay.Emitter.batched(() => {
                          let t = (e = er.A.hydrateReady.measure(() =>
                                  (function (e, t, n) {
                                      ...
                                      let u =
                                              o?.map((e, t) =>
                                                  !0 === e.unavailable ? e : ((e.members = eR(ev, a?.[t])), eO(e)),
                                              ) ?? [],
                                          c = eC(t, o, (e) => eO(e));
                                      return (
                                          null != c && u.push(c),
    ...
    eV(
        ...
        (e) => p.D.loadGuildIds([e.guild_id]),
        (e) => {
            eY(e), eH({ type: "MESSAGE_UPDATE", guildId: e.guild_id, message: e });
        },
    ),
    eV(
        ["MESSAGE_DELETE"],
    ...
    eF(["SESSIONS_REPLACE"], (e) => {
        eH({ type: "SESSIONS_REPLACE", sessions: eW(e) });
    }),
...
let eZ = new u.A("ConnectionStore"),
    eQ = 0,
    eJ = null,
    e0 = !0,
    e1 = null,
...
let e9 = new e8(o.h, {
    ...
    VOICE_STATE_UPDATES: function (e) {
        ...
        return t.reduce((e, t) => {
            ...
            if (t.sessionId === eJ) {
                if (null != e2)
                    return eZ.verbose("Ignoring voice state for own session due to VSU lock on channel:", e2), e;
