...
function j(e) {
    var t, n, r, a, x, j, P;
    let { isGift: E, premiumTier: b, offerTierMatchesCard: _, offerType: S, showYearlyPrice: N, priceOptions: R, textVariant: Z, className: y, isApplicationHome: w, enablePremiumRebrandDesign: L, headerClassName: M, headingVariant: O = 'heading-md/normal', headingColor: H } = e,
        A = (0, o.e7)([d.ZP], () => d.ZP.getPremiumTypeSubscription()),
        U = (0, o.e7)([u.default], () => u.default.getCurrentUser()),
        k = (0, C.t7)(),
        D = (0, C.lr)(),
        G = b === h.p9.TIER_0 ? h.Si.TIER_0 : h.Si.TIER_2,
        V = (null == A ? void 0 : A.hasActiveTrial) ? (null == U ? void 0 : U.premiumType) : k ? h.p9.TIER_2 : null,
        F = (0, g.N)(),
        B = (0, p.Ng)(),
