...
class w extends i.Ay.Store {
    ...
    getNewChannelIds(e) {
        return null != e && null == f[e] && v(e), null != e ? (f[e] ?? A) : A;
    }
    shouldIndicateNewChannel(e, t) {
        ...
        return (
            ...
            (null != e && null == f[e] && v(e), f[e]?.has(t) && null == g.Ay.getTrackedAckMessageId(t))
        );
    }
}
let m = new w(s.h, {
    ...
    CHANNEL_SELECT: function (e) {
        ...
        return (
            null != t && (null == f[t] || S[t] < Date.now() - p.A.Millis.HOUR ? (v(t), !0) : (null != n && E(t, n), !1))
        );
    },
