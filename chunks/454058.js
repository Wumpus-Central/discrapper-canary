...
class m extends i.Ay.Store {
    ...
    initialize() {
        this.waitFor(o.default, d.A, h.Ay, u.Ay, c.A, g.Ay, C.Ay, a.A), this.syncWith([C.Ay], E);
    }
    getNewChannelIds(e) {
    ...
    shouldIndicateNewChannel(e, t) {
        ...
        return (
            ...
            (null != e && null == f[e] && _(e), f[e]?.has(t) && null == g.Ay.getTrackedAckMessageId(t))
        );
    }
}
let w = new m(s.h, {
    ...
    CHANNEL_SELECT: function (e) {
        ...
        return (
            null != t && (null == f[t] || S[t] < Date.now() - p.A.Millis.HOUR ? (_(t), !0) : (null != n && v(t, n), !1))
        );
    },
