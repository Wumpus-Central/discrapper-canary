...
class c extends r.Z {
    createUser(e) {
        this.recognizedUserIds.add(e),
            this.setupKeyRatchetForUser(e, this.latestPreparedTransitionVersion, a.Bp.DECRYPT);
    }
    destroyUser(e) {
    ...
    executeSecureFramesTransition(e) {
        ...
        this.secureFramesTransitions.delete(e),
            ...
            this.setupKeyRatchetForUser(this.userId, t, a.Bp.ENCRYPT),
            this.onSecureFramesStateChanged();
    }
    getMLSKeyPackage(e) {
    ...
    setupEncryptionWorker() {
        ...
        return (
            (e.onmessage = (e) => {
                let { data: t } = e;
                t.type === a.r7.PROTOCOL_VERSION_CHANGED
            ...
            e.postMessage({ type: a.u.INITIALIZE }),
            e
        );
    }
    ...
    prepareSecureFramesRatchets(e, t) {
        ...
        e === this.dave.kInitTransitionId
            ? (this.setupKeyRatchetForUser(this.userId, t, a.Bp.ENCRYPT), this.onSecureFramesStateChanged())
    ...
    onSecureFramesStateChanged() {
        ...
        (null == this.lastSecureFramesStateUpdate ||
            ...
            this.emit(o.Sh.SecureFramesUpdate, t),
