l.r(t), l.d(t, { slayerStorefrontPlaygroundConfig: () => q, storefrontCollection: () => X });
var a = l(34188),
    o = l(627968),
    n = l(64700),
    i = l(50777),
...
function v(e, t, l) {
    let {
        ...
        I = {
            ...
            access_type: null,
            legal_notice: "",
            price: { amount: o, currency: y.Yr.USD, sale_amount: n ?? void 0, sale_percentage: i ?? void 0 },
            price_tier: 0,
            premium: !1,
            show_age_gate: !1,
            restricted: !1,
    ...
    if ((p.h.dispatch({ type: "SKU_FETCH_SUCCESS", sku: I }), null != n && null != i)) {
        let t = {
            skuPriceMap: { [e]: { pricingResultId: b, rewardResultIds: [h] } },
            pricingResultIdMap: {
                [b]: {
                    [m.QK.SELF_PURCHASE]: {
                        userPrice: [
                            { currency: y.Yr.USD, amount: n },
                            { currency: y.Yr.DISCORD_ORB, amount: n },
                        ],
                        prices: {
                            [f.FBC.BASE]: {
                                [m.v8.NORMAL]: [
                                    { currency: y.Yr.USD, amount: o },
                                    { currency: y.Yr.DISCORD_ORB, amount: o },
                                ],
                                [m.v8.DISCOUNTED]: [{ currency: y.Yr.USD, amount: n }],
                            },
                        },
                    },
                    [m.QK.GIFT]: {
                        userPrice: [{ currency: y.Yr.USD, amount: n }],
                        prices: {
                            [f.FBC.BASE]: {
                                [m.v8.NORMAL]: [{ currency: y.Yr.USD, amount: o }],
                                [m.v8.DISCOUNTED]: [{ currency: y.Yr.USD, amount: n }],
                            },
                        },
                    },
            ...
            data: {
                ...
                pricingResultIdMap: {
                    [b]: {
                        ...
                        [m.QK.GIFT]: {
                            userPrice: [{ currency: y.Yr.USD, amount: o }],
                            prices: {
                                [f.FBC.BASE]: {
                                    [m.v8.NORMAL]: [{ currency: y.Yr.USD, amount: o }],
                                    [m.v8.DISCOUNTED]: [],
...
let D = {
    ...
    component: function (e) {
        ...
        return t === r.s.EMBEDDED
            ? (0, o.jsx)("div", {
                  style: { padding: 16 },
                  children: (0, o.jsx)(i.A, { applicationId: S, guildId: E, skuId: h, channel: A }),
              })
            : (0, o.jsx)("div", {
                  style: { maxWidth: t === r.s.SMALL ? 220 : 300, padding: 16 },
                  children: (0, o.jsx)(r.A, { skuId: h, variant: t, onClick: I }),
              });
    },
    controls: {
        variant: {
...
let X = {
                                ...
                                p.h.dispatch({
                                    ...
                                    p.h.dispatch({
                                        ...
                                        storefront: {
                                            ...
                                            pages: [{ title: "Shop", skuIds: [h], sections: [], leaderboard: null }],
                                            assets: {},
                                            promotions: {},
                                        },
                                    });
                ...
                stories: [
                        ...
                        component: function (e) {
                            let t,
                                ...
                                f =
                                    ...
                                    n.useEffect(() => {
                                        for (let { id: e, params: l } of C.slice(0, m)) v(e, l, t);
                                        p.h.dispatch({
                                            type: "SOCIAL_LAYER_STOREFRONT_CONFIG_FETCH_SUCCESS",
                                            config: {
                                                promotionalSkuIds: l,
                    ...
                    },
                    {
                        ...
                        component: function (e) {
                            ...
                            _();
                            let r = (0, K.i)((e) => e.setOverrideNitroEligibilityForSocialLayerStorefront),
                                s = (0, K.i)((e) => e.setIsNitroEligibleForSocialLayerStorefront);
                            return (
                                ...
                                (0, o.jsx)(Q.M, { applicationId: S, analyticsLocations: [] })
                            );
                        },
                        controls: {
                            flavor: {
                    ...
                    },
                    {
                        ...
                        component: function (e) {
                            let { flavor: t, text: l, isNitroEligible: a, daysUntilEnd: i } = e,
                                r = (0, K.i)((e) => e.setOverrideNitroEligibilityForSocialLayerStorefront),
                                s = (0, K.i)((e) => e.setIsNitroEligibleForSocialLayerStorefront);
                            n.useEffect(() => (r(!0), s(a), () => r(!1)), [r, s, a]);
                            let u = {
                                Icon: void 0,
                    ...
                    },
                    {
                        ...
                        component: function (e) {
                                    ...
                                    p.h.dispatch({
                                        ...
                                        p.h.dispatch({
                                            ...
                                            storefront: {
                                                ...
                                                lightThemeLogoAssetId: null,
                                                pages: [
                                                    { title: "Shop", skuIds: [h], sections: [], leaderboard: null },
                                                ],
                                                assets: {},
                                                promotions: {
                                                    [H]: {
                            ...
                            return (0, o.jsx)("div", {
                                ...
                                children: (0, o.jsx)(r.A, { skuId: h, variant: r.s.MEDIUM, onClick: i }),
                            });
                        },
                        controls: {
    ...
    q = { playgroundBaseUrl: "slayer-storefront", collections: [X] };
