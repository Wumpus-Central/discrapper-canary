...
class j extends i.Ay.PersistedStore {
                        ...
                        for (let e of n) {
                            let t =
                                null == e || "string" != typeof e.targetId
                                    ? null
                                    : { targetId: e.targetId, addedTimestampMs: R(e.addedTimestampMs) };
    ...
    getState() {
        return {
            friendsFavoriteTargetIds: D(h.x.FRIENDS),
            messagesFavoriteTargetIds: D(h.x.MESSAGES),
            voiceFavoriteTargetIds: D(h.x.VOICE),
        };
    }
    ...
    __OVERLAY__
        ...
        : {
              OVERLAY_FRIENDS_WIDGET_SET_FAVORITE: W(function (e) {
                  ...
                  let n = R(e.addedTimestampMs ?? y(e.tab).get(e.targetId)?.addedTimestampMs ?? Date.now()),
                      i = y(e.tab);
              ...
              RELATIONSHIP_ADD: W(function (e) {
                  ...
                  if (null == t || !y(h.x.FRIENDS).has(t)) return !1;
                  let n = v();
