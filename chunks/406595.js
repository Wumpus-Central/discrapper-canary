...
function N(e) {
    return Number.isFinite(e) ? Math.floor(y(e, 0, g)) : Date.now();
}
function v(e) {
    return e ? "0" : "1";
}
...
function M(e) {
    ...
    return (
        (c.sortKey = [
            (t = c).tab,
            v(t.isOnline),
            C(Math.round((1 - y(t.affinityScore, 0, 1)) * 1e6), 7),
            v(t.hasMention),
            v(t.hasUnread),
            ((n = y(t.addedTimestampMs, 0, g)), C(g - n, 16)),
            t.rowId,
        ].join("\0")),
        c
    );
...
function P(e) {
    ...
    if (t === p.x.FRIENDS) {
        ...
        let e = (function (e, t, n) {
            var i;
            if (e !== p.x.FRIENDS || null == f.default.getUser(t) || !h.A.isFriend(t)) return null;
    ...
    let c = (function (e, t, n, i) {
        ...
        let s = r.getGuildId() ?? null,
            a = y((null != s ? (u.A.getGuildAffinity(s)?.score ?? 0) : 0) / i, 0, 1),
                        ...
                        for (let e of n) {
                            let t =
                                null == e || "string" != typeof e.targetId
                                    ? null
                                    : { targetId: e.targetId, addedTimestampMs: N(e.addedTimestampMs) };
    ...
    __OVERLAY__
        ...
        : {
              OVERLAY_FRIENDS_WIDGET_SET_FAVORITE: Y(function (e) {
                  ...
                  if (!e.isFavorite) {
                      let n = O(e.tab).delete(e.targetId),
                          i = A.delete(t);
                      return n || i;
                  }
                  let n = N(e.addedTimestampMs ?? O(e.tab).get(e.targetId)?.addedTimestampMs ?? Date.now()),
                      i = O(e.tab);
              ...
              POST_CONNECTION_OPEN: Y(j),
              OVERLAY_INITIALIZE: Y(j),
              CACHE_LOADED: Y(j),
              CACHE_LOADED_LAZY: Y(j),
              FRIENDS_LIST_POPOUT_MOUNTED: Y(j),
              PRESENCE_UPDATES: Y(function (e) {
                  ...
                  for (let r of e.updates) {
                      ...
                      null != e &&
                          t.has(e) &&
                          (i =
                              G({ tab: p.x.FRIENDS, targetId: e, pruneInvalid: S, guildAffinityNormalizationMax: n }) ||
                              i);
                  }
                  return i;
              }),
