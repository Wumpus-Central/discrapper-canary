...
function F(e, t) {
    ...
    let l = R(),
        ...
        r = new Set();
    for (let t of i.keys())
        r.add(y(e, t)), (s = j({ tab: e, targetId: t, pruneInvalid: n, guildAffinityNormalizationMax: l }) || s);
...
function V(e, t) {
    ...
    for (let t of i.keys())
        o.A.getDMFromUserId(t) === e &&
            (s = j({ tab: A.x.FRIENDS, targetId: t, pruneInvalid: n, guildAffinityNormalizationMax: l }) || s);
    return s;
}
function k(e) {
    let t = _,
    ...
    return (
        D(A.x.MESSAGES).has(e) &&
            (i = j({ tab: A.x.MESSAGES, targetId: e, pruneInvalid: t, guildAffinityNormalizationMax: n }) || i),
...
class B extends i.Ay.PersistedStore {
    ...
    getState() {
        return {
            friendsFavoriteTargetIds: x(A.x.FRIENDS),
            messagesFavoriteTargetIds: x(A.x.MESSAGES),
            voiceFavoriteTargetIds: x(A.x.VOICE),
        };
    }
        ...
        __OVERLAY__
            ...
            : {
                  ...
                  LOAD_USER_AFFINITIES_V2_SUCCESS: Y(function () {
                      return F(A.x.FRIENDS, { pruneInvalid: _ });
                  }),
                  LOAD_GUILD_AFFINITIES_SUCCESS: Y(function () {
                      let e = _;
                      return F(A.x.MESSAGES, { pruneInvalid: e }) || F(A.x.VOICE, { pruneInvalid: e });
                  }),
                  ...
                  RELATIONSHIP_ADD: Y(function (e) {
                      ...
                      let n = R();
                      return j({ tab: A.x.FRIENDS, targetId: t, pruneInvalid: _, guildAffinityNormalizationMax: n });
                  }),
                  ...
                  LOGOUT: Y(function () {
                      let e = S.size() > 0 || C.size > 0;
                      return S.clear(), (C = new Map()), (_ = !1), e;
                  }),
              },
    );
