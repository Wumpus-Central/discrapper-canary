    ...
    if ((C()(null != a && null != L, "Missing startingPlan or newPlan"), x.Y1.indexOf(l) < x.Y1.indexOf(n)))
        switch (n) {
            case x.Xh.PREMIUM_MONTH_TIER_1:
                (e = f.intl.string(f.t.knvOV1)),
                    T.X7u.has(null != s ? s : T.HeQ.UNKNOWN) && (e = f.intl.format(f.t.o6hBiY, {}));
                break;
            case x.Xh.PREMIUM_MONTH_TIER_2:
                (e = f.intl.string(f.t.f8Dqur)),
                    T.X7u.has(null != s ? s : T.HeQ.UNKNOWN) && (e = f.intl.format(f.t.A4THYm, {}));
                break;
            case x.Xh.PREMIUM_YEAR_TIER_1:
                (e = f.intl.string(f.t.YZd5r6)),
                    T.X7u.has(null != s ? s : T.HeQ.UNKNOWN) && (e = f.intl.format(f.t.MHAxpK, {}));
                break;
            case x.Xh.PREMIUM_YEAR_TIER_2:
                (e = f.intl.formatToPlainString(f.t["M/Lknp"], { numFreeGuildSubscriptions: x.cb })),
                    T.X7u.has(null != s ? s : T.HeQ.UNKNOWN) &&
                        (e = f.intl.format(f.t.mULxLS, { numFreeGuildSubscriptions: x.cb }));
                break;
...
function p(t) {
    ...
    let A = (t) =>
        t.skuId === x.Si.TIER_0
            ? T.X7u.has(null != j ? j : T.HeQ.UNKNOWN)
                ? f.intl.format(f.t.o6hBiY, {})
                : f.intl.string(f.t["AGf/yc"])
            : t.skuId === x.Si.TIER_1
              ? T.X7u.has(null != j ? j : T.HeQ.UNKNOWN)
                  ? f.intl.format(f.t.o6hBiY, {})
                  : f.intl.string(f.t.knvOV1)
              : T.X7u.has(null != j ? j : T.HeQ.UNKNOWN)
                ? f.intl.format(f.t.A4THYm, {})
                : H
                  ? f.intl.string(f.t["g52y/v"])
                  : f.intl.string(f.t.aTUr3d);
    if (null != w)
        e = (0, i.jsx)("div", {
            className: I.text,
        ...
        C()(null != t, "Missing plan"),
            t.skuId === x.Si.TIER_0
                ? (e = (0, i.jsxs)("div", {
                      className: I.text,
                      children: [
                          (0, i.jsx)("p", { children: f.intl.string(f.t.L9lcGx) }),
                          (0, i.jsx)("p", {
                              children: f.intl.format(f.t.EoDFuL, {
                                  helpCenterLink: h.Z.getArticleURL(T.BhN.FRACTIONAL_PREMIUM_ABOUT),
                              }),
                          }),
                      ],
                  }))
                : (t.skuId === x.Si.TIER_1 || t.skuId === x.Si.TIER_2) &&
                  (e = (0, i.jsxs)("div", {
                      className: I.text,
                      children: [
                          (0, i.jsx)("p", { children: f.intl.string(f.t.UPpbPz) }),
                          (0, i.jsx)("p", {
                              children: f.intl.format(f.t.EoDFuL, {
                                  helpCenterLink: h.Z.getArticleURL(T.BhN.FRACTIONAL_PREMIUM_ABOUT),
                              }),
    ...
    C()(null != O, "premium type should not be null in purchase confirmation"),
        (n =
            null != w
                ? f.intl.formatToPlainString(f.t["1qGgm5"], { skuName: w.name })
                : _
                  ? f.intl.string(f.t.QJ9EyM)
                  : null != v
                    ? f.intl.string(f.t.ta3cXV)
                    : f.intl.string(f.t.TkTvBw));
    let S = () =>
        T.X7u.has(null != j ? j : T.HeQ.UNKNOWN)
