...
function F(e) {
        ...
        Y = i.useMemo(
            () =>
                null == C
                    ? null
                    : [...C].sort((e, t) =>
                          (null == V ? void 0 : V.source.id) === e.id
                              ? -1
                              : (null == V ? void 0 : V.source.id) === t.id
                                ? 1
                                : W(t) - W(e),
                      ),
            [V, C],
    ...
    i.useEffect(() => {
        g.Z.hasPermission(k.Eu.SCREEN_RECORDING, { showAuthorizationError: !1 }).then(K);
    }, []);
    let q = (function (e) {
        switch (e) {
            case c.vA.WINDOW:
...
function Y(e) {
    ...
    return (
        i.useEffect(() => {
            (0, y.isLinux)() ||
            ((0, y.isMac)() && a().satisfies(null === m.Z || void 0 === m.Z ? void 0 : m.Z.os.release, M.jR))
                ? (0, Z.T)(l)
                : (0, Z.t)();
        }, [l]),
        s === w.Uc.Error
