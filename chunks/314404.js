    ...
    switch (t) {
        ...
        case V.Si.TIER_2:
            switch (o) {
                ...
                case V.Si.TIER_2:
                    return e.interval === V.rV.MONTH ? Y.intl.formatToPlainString(Y.t['RqUv8/'], { numFreeGuildSubscriptions: V.cb }) : i;
                default:
                    return i;
            }
        default:
...
function et(e) {
    ...
    let { premiumSubscription: g, skuId: b, selectedPlanId: U, setSelectedPlanId: G, planGroup: z, priceOptions: Q, planOptions: $, eligibleForMultiMonthPlans: et, referralTrialOfferId: en, subscriptionPeriodEnd: er, showTotal: ei = !0, discountInvoiceItems: eo, useCompactGiftComponents: ea, handleClose: es } = e,
        ...
        eI = ep && (0, y.pO)(eh),
        eS = (0, N.cF)(ed, eI, ey),
        eT = (0, C.Z)({ location: 'PremiumPlanSelectStep' });
    ...
    let [eA, eN] = (0, c.Wu)([E.Z], () => [null != g ? E.Z.get(g.planId) : null, null != U ? E.Z.get(U) : null]),
        eC = (0, w.N)(en),
        eP = null == eC ? void 0 : eC.subscription_trial,
        eR = (0, R.Ng)(),
    ...
    let ek = (0, _.Z)({
        ...
        eM = null != eC && V.nG[eC.trial_id].skus.includes(b),
        ej = null != eR && $.some((e) => (null == ew ? void 0 : ew.includes(e))) && null != eR.discount,
        eU = (0, v.aS)(V.Xh.PREMIUM_MONTH_TIER_2, !1, ep, ex);
    i.useEffect(() => {
    ...
    i.useEffect(() => {
        ...
        i.useEffect(() => {
            eS && null != ey && ey.length > 0 && eO(ey[0]);
        }, [ey, eO, eS]);
    let eB = !eI && (ep || (!eM && !ej)) && eG && ei,
        ...
        { ipCountryCode: eY } = (0, P.Z)(),
        eW = 'HR' === eY && null != eH && eH.currency === H.pK.EUR,
        eK = (0, v.Ap)(ex.paymentSourceId),
        ez = i.useMemo(() => ((null == eP ? void 0 : eP.interval) === V.rV.DAY ? ((null == eP ? void 0 : eP.interval_count) > 7 ? Y.intl.string(Y.t.Z1V2cn) : Y.intl.string(Y.t.MI1rHh)) : Y.intl.string(Y.t['+S5lra'])), [eP]),
        eq = !ep && (ej || (null != eP && eM && null != er)),
        eQ = null == eo || null == (s = eo.find((e) => e.subscriptionPlanId === V.Xh.PREMIUM_MONTH_TIER_2)) || null == (o = s.discounts) || null == (n = o.find((e) => e.type === f.eW.SUBSCRIPTION_PLAN)) ? void 0 : n.amount,
        eX = (e, t, n) => {
            if (eI)
            ...
            if (n && null != eQ && null != eU && U === V.Xh.PREMIUM_MONTH_TIER_2)
                return (0, r.jsxs)('div', {
                    children: [
                        (0, r.jsx)(u.Text, {
                            variant: 'text-sm/normal',
                            ...
                            children: Y.intl.format(Y.t['nG7g/P'], {
                                ...
                                discountedPrice: (0, I.T4)(eU.amount - eQ, eU.currency),
        ...
        e6 = null != g && null != U && (0, S.R4)(g, U, z),
        e8 = ek.isFractionalPremiumActive && (null == g || e6) && !ep && null != U && V.dJ.has(U);
    return (0, r.jsxs)('div', {
        className: a()(eI ? K.stepBodyCustomGift : K.stepBody, { [K.paddingForHalloweenBanner]: eT }),
        children: [
            e8 &&
                (0, r.jsx)(k.n, {
