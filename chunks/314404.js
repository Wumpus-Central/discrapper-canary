...
function J(e) {
    var t, n, o, s;
    let { premiumSubscription: g, skuId: v, selectedPlanId: j, setSelectedPlanId: U, priceOptions: K, planOptions: q, eligibleForMultiMonthPlans: J, referralTrialOfferId: $, subscriptionPeriodEnd: ee, showTotal: et = !0, discountInvoiceItems: en, useCompactGiftComponents: er, handleClose: ei } = e,
        ...
        ev = eu && (0, b.pO)(ed),
        eb = (0, N.cF)(el, ev, em),
        ey = (0, A.Z)({ location: 'PremiumPlanSelectStep' });
    (v = null != v ? v : es), (g = null != g ? g : eo), l()(void 0 !== g, 'should not be undefined');
    let [eO, eI] = (0, c.Wu)([E.Z], () => [null != g ? E.Z.get(g.planId) : null, null != j ? E.Z.get(j) : null]),
        eS = (0, P.N)($),
        eT = null == eS ? void 0 : eS.subscription_trial,
        eN = (0, R.Ng)(),
        eA = null == eN ? void 0 : null === (t = eN.discount) || void 0 === t ? void 0 : t.plan_ids,
        eC = null != eI ? eI : el,
        eR = i.useCallback(
            (e) => {
                null != U ? U(e) : ea(e);
    ...
    let ew = (0, _.Z)(),
        eD = ew.fractionalState !== V.a$.NONE,
        eL = null != eS && V.nG[eS.trial_id].skus.includes(v);
    ...
    let ex = null != eN && q.some((e) => (null == eA ? void 0 : eA.includes(e))) && null != eN.discount,
        eM = (0, O.aS)(V.Xh.PREMIUM_MONTH_TIER_2, !1, eu, eP);
    i.useEffect(() => {
    ...
    i.useEffect(() => {
        ...
        i.useEffect(() => {
            eb && null != em && em.length > 0 && eg(em[0]);
        }, [em, eg, eb]);
    let ej = !ev && (eu || (!eL && !ex)) && ek && et && !eD,
        eU = (0, u.arW)(),
        eG = (null == eC ? void 0 : eC.id) != null ? (0, O.aS)(eC.id, !1, eu, eP) : void 0,
        { ipCountryCode: eB } = (0, C.Z)(),
        eV = 'HR' === eB && null != eG && eG.currency === Z.pK.EUR,
        eF = (0, O.Ap)(eP.paymentSourceId),
        eZ = i.useMemo(() => ((null == eT ? void 0 : eT.interval) === V.rV.DAY ? ((null == eT ? void 0 : eT.interval_count) > 7 ? H.NW.string(H.t.Z1V2cn) : H.NW.string(H.t.MI1rHh)) : H.NW.string(H.t['+S5lra'])), [eT]),
        eH = !eu && (ex || (null != eT && eL && null != ee) || eD),
        eW = null == en ? void 0 : null === (s = en.find((e) => e.subscriptionPlanId === V.Xh.PREMIUM_MONTH_TIER_2)) || void 0 === s ? void 0 : null === (o = s.discounts) || void 0 === o ? void 0 : null === (n = o.find((e) => e.type === f.eW.SUBSCRIPTION_PLAN)) || void 0 === n ? void 0 : n.amount,
        eY = (e, t, n) => {
            if (ev)
            ...
            if (n && null != eW && null != eM && j === V.Xh.PREMIUM_MONTH_TIER_2)
                return (0, r.jsxs)('div', {
                    children: [
                        (0, r.jsx)(u.Text, {
                            variant: 'text-sm/normal',
        ...
        eK = () => {
            if (eE === b.xr.CUSTOM_MESSAGE_EMOJI_SOUNDBOARD && null != ep)
                return (0, r.jsx)(M.Z, {
        ...
        e$ = () => eY(eS, eL, ex),
        e0 = () => (eV ? (0, r.jsx)(d.Z, { message: H.NW.formatToPlainString(H.t['9hnZoK'], { kunaPriceWithCurrency: (0, I.T4)(7.5345 * eG.amount, Z.pK.HRK) }) }) : null);
    return (0, r.jsxs)('div', {
        className: a()(ev ? Y.stepBodyCustomGift : Y.stepBody, { [Y.paddingForHalloweenBanner]: ey }),
        children: [
            ew.fractionalState !== V.a$.NONE && (0, r.jsx)(x.n, { fractionalPremiumInfo: ew }),
            (0, r.jsxs)('div', {
                className: ev ? eQ : void 0,
                children: [
                    (0, r.jsx)(w.Z, {
            ...
            (0, r.jsxs)('div', {
                className: ev ? Y.bodyColumnRight : void 0,
                children: [
                    (0, r.jsx)(B.s, {
                    ...
                    !eq && e0(),
                    !eu && !eH && et && (0, r.jsx)(d.Z, { message: H.NW.format(H.t.Om31w8, { documentationLink: y.Z.getArticleURL(F.BhN.LOCALIZED_PRICING) }) }),
...
function ee(e) {
    ...
    return (
        h && (b = g.h8.REVIEW),
        (0, N.id)(_, i, o) && f !== g.h8.SELECT_FREE_SKU && (b = g.h8.SELECT_FREE_SKU),
        (0, r.jsx)(u.zxk, {
            onClick: () => t(b),
            children: E
        })
