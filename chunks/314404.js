...
function V(e) {
    var n, t, r, a;
    let { premiumSubscription: f, skuId: g, selectedPlanId: M, setSelectedPlanId: L, priceOptions: V, planOptions: K, eligibleForMultiMonthPlans: z, referralTrialOfferId: Y, subscriptionPeriodEnd: X, showTotal: q = !0, discountInvoiceItems: J, useCompactGiftComponents: Q, handleClose: $ } = e,
            ...
            children: [
                ...
                (0, i.jsxs)('div', {
                    ...
                    children: [
                        ...
                        eG && eH(),
                        (() => {
                            if (ep === E.xr.CUSTOM_MESSAGE_EMOJI_SOUNDBOARD && null != eo)
                                return (0, i.jsx)(R.Z, {
                        ...
                        !eG && eK(),
                        !er && !ek && q && (0, i.jsx)(d.Z, { message: B.intl.format(B.t.Om31w8, { documentationLink: S.Z.getArticleURL(U.BhN.LOCALIZED_PRICING) }) }),
