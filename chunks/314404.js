...
let $ = (e) => {
    ...
    er = (e) => {
        let {
            ...
            p = d && (0, O.pO)(f),
            { enabled: m } = N.Z.getCurrentConfig(
    ...
    return (
        ...
        (0, r.jsxs)(r.Fragment, {
            children: [
                ...
                o
                    ? (0, r.jsx)(k.Z, {
                          className: h && b ? Y.equalDistantBackButton : void 0,
                          onClick: a,
                      })
                    : null,
            ],
...
function es(e) {
    ...
    return (
        E && (O = h.h8.REVIEW),
        (0, P.id)(_, i, a) && p !== h.h8.SELECT_FREE_SKU && (O = h.h8.SELECT_FREE_SKU),
        (0, r.jsx)(c.Button, {
            variant: "primary",
            text: b,
            onClick: () => t(O),
