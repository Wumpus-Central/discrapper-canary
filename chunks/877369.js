(t.byteLength = function (e) {
    ...
    (t.toByteArray = function (e) {
        ...
        for (n = 0; n < s; n += 4)
            (t =
                ...
                (c[d++] = 255 & t);
        return (
            2 === u && ((t = (r[e.charCodeAt(n)] << 2) | (r[e.charCodeAt(n + 1)] >> 4)), (c[d++] = 255 & t)),
            1 === u &&
    ...
    (t.fromByteArray = function (e) {
        for (var t, r = e.length, i = r % 3, l = [], o = 0, u = r - i; o < u; o += 16383)
            l.push(
                (function (e, t, r) {
                    for (var i, l = [], o = t; o < r; o += 3)
