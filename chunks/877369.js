(t.byteLength = function (e) {
    ...
    (t.toByteArray = function (e) {
        ...
        for (n = 0; n < d; n += 4)
            (t =
                ...
                (c[u++] = 255 & t);
        return (
            2 === o && ((t = (l[e.charCodeAt(n)] << 2) | (l[e.charCodeAt(n + 1)] >> 4)), (c[u++] = 255 & t)),
            1 === o &&
    ...
    (t.fromByteArray = function (e) {
        for (var t, l = e.length, i = l % 3, r = [], a = 0, o = l - i; a < o; a += 16383)
            r.push(
                (function (e, t, l) {
                    for (var i, r = [], a = t; a < l; a += 3)
                        (i = ((e[a] << 16) & 16711680) + ((e[a + 1] << 8) & 65280) + (255 & e[a + 2])),
                            r.push(n[(i >> 18) & 63] + n[(i >> 12) & 63] + n[(i >> 6) & 63] + n[63 & i]);
                    return r.join("");
                })(e, a, a + 16383 > o ? o : a + 16383),
            );
        return (
            1 === i
                ? r.push(n[(t = e[l - 1]) >> 2] + n[(t << 4) & 63] + "==")
                : 2 === i &&
                  r.push(n[(t = (e[l - 2] << 8) + e[l - 1]) >> 10] + n[(t >> 4) & 63] + n[(t << 2) & 63] + "="),
            r.join("")
        );
    });
for (
