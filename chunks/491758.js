...
function A() {
    let e = (0, l.e7)([g.Z], () => g.Z.getHardwareEncoding()),
        ...
        D = (0, l.e7)([h.ZP], () => h.ZP.getKeybindForAction(E.kg4.SAVE_CLIP, !0)),
                ...
                children: [
                    !e &&
                        (0, i.jsx)(p.Z, {
                            ...
                            children: T.intl.format(T.t.kiaF4e, { onClick: () => d.Z.open(E.oAB.VOICE, S.gP, { scrollPosition: S.KQ.VoiceAndVideoScrollPositions.HARDWARE_ACCELERATION }) })
                        }),
                    R === x.x.BELOW_MINIMUM
                        ? (0, i.jsx)(p.Z, {
                              look: p.z.WARNING,
