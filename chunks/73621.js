...
var h = n(953727);
function p(e) {
    let { width: t = 18, height: n = 22, color: l = "currentColor", ...r } = e;
    return (0, i.jsx)("svg", {
        ...(0, h.A)(r),
        width: t,
        height: n,
...
let A = (e) => {
    ...
    return (0, i.jsxs)("div", {
        className: g._Z,
        children: [
            (0, i.jsx)(h, { className: g.Yg, color: r.A.unsafe_rawColors.PRIMARY_300.css }),
            (0, i.jsxs)("div", {
                className: g.XE,
                children: [
                    (0, i.jsx)(d.E, { variant: "text-md/normal", className: g.Md, children: l }),
                    (0, i.jsx)(d.E, { variant: "text-sm/normal", color: "text-subtle", children: E }),
                ],
            }),
            (0, i.jsx)(s.m, {
                asContainer: !0,
