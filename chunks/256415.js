                            ...
                            if (
                                ("OVERLAY_INITIALIZE" === e.type &&
                                    ((null == e.version && 1 === g.OVERLAY_VERSION) ||
                                        ...
                                        (a.h.dispatch({ type: "OVERLAY_INCOMPATIBLE_APP" }), (0, s.Zf)(), 0)) &&
                                    (L = !0),
                                L)
                            )
                                switch (e.type) {
...
class k extends i.Ay.PersistedStore {
    ...
    static migrations = [
        () => {
            let { pinnedWidgets: e, positions: t, sizes: n, v: i, ...a } = { ...l.w.get("OverlayStore") };
            return { ...T, ...(5 === i ? a : null) };
        },
        (e) => {
    ...
    initialize(e) {
        if (
            ...
            let t = h.default.getId();
            null != t &&
                (null == (P = U(t)).textChatNotifications && (P.textChatNotifications = T.textChatNotifications),
                null == P.textWidgetOpacity && (P.textWidgetOpacity = T.textWidgetOpacity),
                null == P.disableClickableRegions && (P.disableClickableRegions = T.disableClickableRegions));
        }
    }
    getState() {
        return C;
    ...
    get showInviteNotification() {
        return null == P.showGameInviteNotification || P.showGameInviteNotification;
    }
...
let H = new k(a.h, {
    ...
    OVERLAY_START_SESSION: function () {
        a.h.addInterceptor((e) => {
            ...
            (0, s.Ng)(),
            (0, s.tN)({ type: I.kGV.CONNECT, pid: (0, g.getPID)(), token: (0, g.getRPCAuthToken)() });
    },
    ...
    OVERLAY_READY: function () {
        ...
        if (
            (null == e ||
                (A.Ay.hasChannels(e) && (null == t || A.Ay.hasSelectableChannel(e, t))) ||
                ((e = null), (t = null)),
