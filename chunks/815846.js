...
var l,
    ...
    ed = s(953727);
let eu = (e) => {
        let { className: t, backgroundColor: s, backgroundCircleSize: l, ...n } = e;
        return (0, i.jsxs)("svg", {
            width: "100%",
            height: "100%",
            viewBox: "0 0 100 100",
...
function ef(e) {
    let { avatarDecorationLegacyAssetId: t, avatarDecorationSkuId: s, avatarDecoAssetDescription: l } = e,
        r = n.useMemo(() => (0, ec.A)({ legacyAssetId: t, skuId: s, size: X._3.SIZE_120, canAnimate: !1 }), [t, s]);
    return (0, i.jsx)("div", {
        className: eh.Q7,
        children: (0, i.jsx)("div", {
            className: eh.Nk,
            children: null != r && (0, i.jsx)("img", { className: eh.CH, alt: l, src: r }),
        }),
    });
}
let eg = function (e) {
                ...
                switch (u) {
                    case 0:
                        return (0, i.jsx)(eu, {
                            ...
                            backgroundColor: a()(eh.vH, n),
                            backgroundCircleSize: o,
                        });
                    case 1:
                        return (0, i.jsx)(ex, { circleColor: f, ellipseOpacity: h });
                    case 2:
                        if (null != p)
                            return (0, i.jsx)(ef, {
                                avatarDecorationLegacyAssetId: m,
...
function eR(e) {
    let { userRecord: t, placement: s } = e,
        { avatarSrc: l, eventHandlers: n } = (0, el.A)({ userId: t?.id, size: X._3.SIZE_32, animateOnHover: !0 }),
        r = null != t,
        a = r
            ? (0, i.jsx)(ee.eu, { src: l, "aria-label": t.username, size: X._3.SIZE_32, ...n })
            : (0, i.jsx)(g.D, { variant: "heading-md/semibold", className: eA.n5, children: s });
    return (0, i.jsx)(Q.m, {
...
function eI(e) {
    ...
    return (0, i.jsxs)("div", {
        ...
        children: [
            ...
            (0, i.jsx)(eR, { userRecord: n, placement: 2 }),
            (0, i.jsx)(eT, { numSentReferrals: s, placement: 2 }),
            (0, i.jsx)(eR, { userRecord: r, placement: 3 }),
        ],
    });
}
let eN = function () {
    let e = (0, x.bG)([er.A], () => er.A.getRecipientStatus()),
        { referralSentUsers: t } = (0, ea.J)(),
        l = n.useMemo(() => t.map((e) => new ei.A(e)), [t]),
        r = { redeemed: 0, converted: 0, sent: e.size };
    e.forEach((e) => {
        e === en.aK.REDEEMED && r.redeemed++, e === en.aK.CONVERTED && (r.redeemed++, r.converted++);
    });
    let o = r.sent === ea.Z,
        ...
        p = (0, i.jsxs)("div", {
            className: eA.hE,
            children: [
                (0, i.jsx)(eg, { percentage: m, progressCircleVariation: e_.NITRO_LOGO, iconClassName: eA.ER }),
                (0, i.jsxs)("div", {
                    className: eA.Ns,
                    children: [
                        (0, i.jsx)(g.D, {
                        ...
                        (0, i.jsx)(E.E, {
                            ...
                            children: (function (e) {
                                ...
                                })({ hasSentAll: s.sent >= ea.Z, hasSentAtLeastOne: s.sent >= 1, helpdeskArticle: t });
...
let eG = "to_premium_home_button",
    ...
    eB = "payment modal";
function ek(e) {
    let { premiumSubscription: t, isDiscountApplied: s, activeDiscountInfo: l, theme: n } = e,
        r = t.hasActiveTrial,
    ...
    if (s || r) {
        let e = (0, _.M)(n) ? eb.at.PREMIUM_TIER_2_WHITE_FILL : eb.at.PREMIUM_TIER_2_OLD_GRADIENT_FILL;
...
function eH() {
    let e = (0, W.k5)(),
        ...
        n = (0, x.bG)([G.default], () => G.default.getCurrentUser()),
        r = n?.isPremiumWithPremiumGroup(),
        o = (0, M.A)(),
        c = (0, z.ds)(),
        ...
        children: (0, i.jsxs)(i.Fragment, {
            children: [
                ...
                (0, i.jsx)(m.L, {
                    ...
                    children: (0, i.jsx)("div", { ref: f, className: eD._Z }),
                }),
            ],
        }),
    });
