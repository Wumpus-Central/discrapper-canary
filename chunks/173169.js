...
let S =
    ...
    o.forwardRef(function (e, t) {
        ...
        return (
            ...
            (0, r.jsx)("div", {
                ref: N,
                className: d()(a, { [E.Rv]: g, [E.D8]: S, [s]: !0, [E.fs]: !0, [E.qw]: y && g }),
                style: _,
                dir: m,
                onScroll: R,
                ...I,
                children: (0, r.jsx)(p.xp, {
                    ...
                    children: (0, r.jsxs)("div", {
                        ref: v,
                        className: d()(u, E.Qs),
                        children: [n, y && (0, r.jsx)("div", { className: E.X3 })],
                    }),
                }),
            })
        );
                      ...
                      children: [
                          ...
                          j
                              ? (0, r.jsx)(
                                    nr.qv,
                                    {
                                        label: v ? ek.intl.string(ek.t.LHUP9D) : ek.intl.string(ek.t["9p3D9p"]),
                                        icon: v ? tB.c : tV.c,
...
function nx(e) {
    ...
    return (0, r.jsxs)(r.Fragment, {
        children: [
            ...
            (0, r.jsx)(
                nr.qv,
                { label: ek.intl.string(ek.t.oyYWHE), icon: tY.u, onClick: (e) => (0, tA.RC)(t, n, e) },
                "delete-usent",
            ),
        ],
    });
...
let n$ = o.memo(function (e) {
    ...
    let x = w.sl8.has(i.type) ? i.messageReference : void 0,
        ...
        { popouts: v, selected: T, setPopout: N } = (0, tC.A)(i.id, nz.Fd),
        b = (0, e9.VL)(i, a, N),
        M = (0, e9.ri)(i, a),
        {
            handleMouseEnter: R,
...
function n6(e) {
    ...
    let [{ height: c, opacity: d }, h] = (0, Y.z)(
...
function lC(e) {
    let { style: t, channel: n, conversation: l, scrollerRef: i, requestDismiss: s } = e,
        ...
        v = (0, m.bG)([P.A], () => (l?.id != null ? P.A.getHydratedMessages(n.id, l.id) : null), [n.id, l]),
        y = o.useMemo(
            () =>
                null != l
                    ? (function (e, t, n, l) {
...
let lT = o.memo(function (e) {
    let t,
        ...
        v = (0, Y.z)({ y: c.y, opacity: +!c.hidden, config: la }, "respect-motion-settings"),
        y = (0, Y.z)(
            {
                ...((t = h && x),
                (n = 0),
        ...
        children: [
            ...
            (0, r.jsx)(lv, {
                ...
                style: {
                    ...
                    transform: (0, u.to)([y.textScale, y.textX], (e, t) => `scale(${e}) translateX(${t}px)`),
                },
                children: I,
            }),
            (0, r.jsx)("span", {
                ...
                children: (0, r.jsx)(u.animated.span, {
                    ...
                    style: {
                        width: y.lineWidth,
                        opacity: y.lineOpacity,
                        transform: y.lineScaleX.to((e) => `scaleX(${e})`),
                    },
                }),
            }),
            (0, r.jsx)(u.animated.span, {
                ...
                style: {
                    ...
                    transform: (0, u.to)([y.arrowX, y.arrowScale], (e, t) => `translateX(${e}px) scale(${t})`),
                },
                children:
                    "down" === _
...
function lw(e) {
    let { channel: t, scrollManager: n, conversations: l } = e,
        ...
        { isFocused: a } = (0, B.D7)(),
        c = lp(),
        h = (0, Y.z)({ insetInlineEnd: a ? 48 : 16, config: c }, "respect-motion-settings"),
        g = (function (e) {
        ...
        { showTopFade: v, showBottomFade: y } = o.useMemo(
                  ...
                  children: [
                      ...
                      (0, r.jsx)(e_.Y, {
                          ...
                          children: () =>
                              (0, r.jsx)("div", {
                                  ref: T,
                                  className: d()(lU.nd, { [lU.mc]: E, [lU._z]: !E, [lU.OP]: E && v, [lU.yc]: E && y }),
                                  style: { height: 188 },
                                  children: (0, r.jsx)(lN, {
                                      items: I,
                                      isExpanded: E,
...
class ii {
    ...
    setScrollToBottom() {
        ...
        if (t.hasMoreAfter)
            I.A.jumpToPresent(n.id, (0, l0.h)("scrollManager.jumpToPresent")), (0, eZ.uh)(n.getGuildId() ?? w.ME, n.id);
        else
...
function iy(e) {
    let { channel: t, scrollManager: n } = e,
        ...
        [{ x: s }, a] = (0, Y.z)(() => ({ x: 0, config: lc }), "respect-motion-settings", []),
...
function i$(e) {
    let { joinRequest: t, guild: n } = e,
        l = (0, m.bG)([lY.default], () => lY.default.getUser(t.userId));
    return (0, r.jsxs)("div", {
        className: iq.I8,
        children: [
            (0, r.jsxs)("div", {
...
function sf(e) {
    let { channel: t } = e,
        ...
        c = (0, m.bG)([lY.default, nl.A], () => lY.default.getUser(nl.A.getGuild(s)?.ownerId)),
...
function sT(e) {
    let { userId: t, channel: l } = e,
        ...
        a = (0, m.bG)([lY.default], () => lY.default.getUser(t)),
        c = (0, m.bG)([sv.Ay], () => (null != t ? sv.Ay.getMember(l.guild_id, t) : null)),
    ...
    let g = c?.nick ?? iD.Ay.getName(a) ?? "???",
        p = c?.colorString;
    return null == a
        ? (0, r.jsx)("span", { className: d()(sy.eM, sy.sL), children: g })
        : (0, r.jsx)(s_.f5, {
              value: s,
...
function sb(e) {
    ...
    return (0, r.jsxs)(iL.Ay, {
        channelId: t.id,
        children: [
            (0, r.jsx)("div", { className: sy.P0, children: (0, r.jsx)(n, { className: sy.Kk }) }),
...
function sq(e) {
    ...
    l.bot && null != i && null != s)
        ...
        : (0, r.jsx)(iZ.e, { size: "sm", children: (0, r.jsx)(sK, { channel: n, user: l }) });
}
var s$ = n(573435),
    sJ = n(903209),
    sZ = n(975732),
...
function s0(e) {
    ...
    let a = o.useMemo(() => {
        ...
        return e
            .map((e, n) => {
                let { guild: l } = e,
                    i = sY.Ay.getGuildIconURL({ id: l.id, icon: l.icon, size: 24 });
...
function ai(e) {
    let { channel: t, user: n } = e,
        ...
        } = (0, at.t)({ user: lY.default.getUser(n.id), onError: l, onAcceptSuccess: s, onRejectSuccess: i }),
        g = d || u || h || m;
    return (0, r.jsxs)(iZ.e, {
        size: "sm",
        children: [
...
function ad(e) {
    let { channel: t, showingBanner: n } = e,
        l = (0, k.Ay)(t),
        { type: i } = t,
        s = (0, m.bG)([lY.default], () => (t.isPrivate() ? lY.default.getUser(t.getRecipientId()) : null)),
        ...
        return (0, r.jsxs)(i9, {
            ...
            children: [
                null == s || s.isProvisional
                    ? null
                    : (0, r.jsx)(ev.D, { variant: "heading-xl/medium", className: ao.SX, children: a }),
...
function aQ(e) {
    let { channel: t, message: l, snapshot: i } = e,
        ...
        c = (0, m.bG)([lY.default], () => (null != a ? lY.default.getUser(a) : null)),
    ...
    let u = (function (e) {
        ...
        h = (function (e) {
            let { channel: t, user: l, guild: i } = e,
                ...
                a = (0, m.bG)([sv.Ay], () => null == l || null == sv.Ay.getMember(t.guild_id, l.id));
            if (!s) return null;
            ...
            return (0, r.jsx)(
                az,
                {
                    ...
                    onClick: () => {
                        null != l &&
                            (0, io.openModalLazy)(async () => {
                                let { default: e } = await Promise.all([n.e("50671"), n.e("40243")]).then(
                                    n.bind(n, 547166),
                                );
                                return (n) => (0, r.jsx)(e, { ...n, guildId: t.guild_id, user: l, modReportId: t.id });
                            });
        ...
        g = [
            ...
            (function (e) {
                let { channel: t, user: n, guild: l } = e,
                    i = (0, m.bG)(
                        [lY.default, nl.A, td.A],
                        () => null != n && null != l && (0, aY.b)(l.id, n.id, [lY.default, nl.A, td.A]),
                    ),
                    [s, a] = (0, aX.Ay)(n?.id, t.guild_id),
                    o = (0, m.bG)([sv.Ay], () => null != l && null != n && null != sv.Ay.getMember(l.id, n.id));
                if (!i || !o) return null;
                ...
                return (0, r.jsx)(
                    az,
                    {
                        ...
                        icon: aJ.O,
                        onClick: () => {
                            null != n && (0, aZ.R)({ guildId: t.guild_id, userId: n.id, modReportId: t.id });
                        },
                        disabled: a,
                    },
                    c,
...
function rr(e) {
    let { channelId: t, warningId: l, senderId: i } = e,
        ...
        d = o.useCallback(
            (e) => () => {
                s1.A.blockUser(i, { location: rl.Rx }).then(() => {
                    a();
                }),
                      ...
                      children: (0, r.jsxs)(u.animated.div, {
                          ...
                          children: [
                              ...
                              (0, r.jsx)(eM.D, {
                                  ...
                                  children: (0, r.jsx)(rd.A, { className: rm.O1, width: 12, height: 12 }),
                              }),
                              (0, r.jsx)(eM.D, {
                                  onClick: (e) => i(e, rh.P0.BAD),
                                  children: (0, r.jsx)(rc.A, { className: rm.O1, width: 12, height: 12 }),
                              }),
                          ],
                      }),
                  })
...
function rp(e) {
    ...
    return (
        (t = o
            ? (0, r.jsxs)(r.Fragment, {
                  children: [(0, r.jsx)(ro.K, { size: "xs", color: "currentColor", className: rm.cR }), n.content],
              })
            : (0, r.jsxs)(r.Fragment, {
                  children: [
                      (0, r.jsx)(rg, { summary: s, channel: l }),
                      (0, r.jsx)(ro.K, { size: "xs", color: "currentColor", className: rm.Jq }),
                  ],
              })),
        (0, r.jsx)(
            nQ.A,
            {
                className: d()(rm.aK, o ? rm.Ke : rm.hO),
                contentClassName: o ? rm.Ew : rm.rD,
                isUnread: a,
                id: a ? nz.q4 : void 0,
                children: t,
            },
...
function rM(e) {
    let { channel: t, className: n } = e,
        l = (0, ts._M)(t),
        i = (0, m.bG)([rT.A], () => rT.A.isInChannel(t.id)),
        s = (0, m.bG)([rN.Ay], () => rN.Ay.getVoiceStatesForChannel(t), [t]),
        { needSubscriptionToAccess: a } = (0, rv.A)(t.id),
        c = o.useCallback(() => {
            rj.A.handleVoiceConnect({ channel: t, connected: i, needSubscriptionToAccess: a, locked: !1 });
        }, [t, i, a]),
        u = null != s && s.length > 0;
    return l || u
        ? (0, r.jsxs)("div", {
                  ...
                  (0, r.jsxs)(eM.D, {
                      ...
                      children: [
                          ...
                          (0, r.jsx)(ej.E, {
                              ...
                              color: "text-strong",
                              className: rb.Gp,
                              children: ek.intl.string(ek.t.LFHDVw),
                          }),
                      ],
                  }),
                  u
...
function rD(e) {
    ...
    return (0, r.jsxs)("div", {
        ...
        children: [
            ...
            (0, r.jsx)("div", { className: rR.b1 }),
            (0, r.jsx)(rM, { className: rR.Lz, channel: l }),
            (0, r.jsx)("div", { className: rR.ld }),
        ],
    });
}
var rL = n(34337),
    ...
    rG = n(148355),
    rU = n(310876);
let rw = "749054660769218631";
function rF(e) {
    let { channel: t } = e,
        [n, l] = o.useState("");
    o.useEffect(() => {
        (0, rO.zk)("847199849233514549", !0);
    }, []);
    let i = (0, m.bG)(
            [ep.A, ec.default],
            () =>
        ...
        s = (0, m.bG)([lY.default], () => lY.default.getUser(t.isPrivate() ? t.getRecipientId() : null)),
        a = iD.Ay.useName(s) ?? ek.intl.string(ek.t.y1Wu2f),
        c = (0, m.bG)([rP.A], () => rP.A.getStickerById(rw)),
        d = o.useCallback(async () => {
            if (null == n || "" === n)
                try {
                    (0, rk.W)({ channelId: t.id, source: "In-channel greet" }), await I.A.sendGreetMessage(t.id, rw);
                } catch (e) {
    ...
    return i
        ? (0, r.jsxs)("div", {
              ...
              children: [
                  (0, r.jsxs)(eM.D, {
                      className: null != n && "" !== n ? rU.AO : rU.Iq,
                      "aria-label": ek.intl.string(ek.t.pJObYI),
                      onClick: d,
                      children: [
                          (0, r.jsx)(rG.A, { sticker: c, size: 24 }),
                          (0, r.jsx)(ej.E, { className: rU.Qq, variant: "text-md/medium", children: u }),
                      ],
                  }),
                  h,
              ],
        ...
        : (0, r.jsxs)("div", {
              className: rU.nj,
              children: [
                  (0, r.jsx)(rG.A, { sticker: c, size: 160, className: rU.Xr }),
                  (0, r.jsx)(eD.$, {
                      fullWidth: !0,
                      variant: "primary",
                      size: "md",
...
let rW = (0, u.animated)(S),
            ...
            let n,
                ...
                ),
                {
                    ...
                    let t,
                        ...
                        _ = lY.default.getCurrentUser(),
                        v = () => p.isInitialized() || a.ready,
                        N = (0, rE.r)(s),
                        b = a.length > 0 && a.first()?.isFirstMessageInForumPost(s),
                        M = (0, j.cI)(s),
                        R = (0, m.bG)([lW.A], () => lW.A.shouldShowTopicsBar() && !x),
                        D = (0, rs.l)(s.id),
                        L = (0, rn.j)(s.id, rl.Rx),
                        k = (0, ia.E)(s.id),
                        O = (0, rx.A)(),
                        ...
                        F =
                            null != U
                                ? (0, r.jsx)(
                                      rD,
                                      { compact: u, channel: s, message: U, id: (0, e2.j)(s.id, U.id) },
                                      U.id,
                                  )
                                : null,
                        H = (0, iN.A)(s.id),
                        B = (0, aG.W1)(s);
                    (t = eY.Sf.useSetting()),
                        (n = (0, aC.bG)([y.A], () => y.A.useReducedMotion)),
                        o.useEffect(() => {
                            function e(e) {
                                ...
                                a ||
                                    ...
                                    !t ||
                                    n ||
                                    (0, t6.on)({ channelId: i, messageId: l, emoji: s, key: rH.W.EXTERNAL });
                            }
                            return (
                    ...
                    let V = null,
                        ...
                        z = h.map((e, t) => {
                                    ...
                                    : e.isConversationChannelHeader
                                      ...
                                      : e.isSummaryDivider
                                        ? (0, r.jsx)(rp, {
                                              ...
                                              item: e,
                                              channel: s,
                                              isBeforeGroup: null == e.content && rV(h[t + 1]),
                                          })
                                        : (0, r.jsx)(
                                              nQ.A,
                                              {
                            ...
                            if (null != f && f > e.content.timestamp.getTime() * rC.A.Millis.SECOND) return;
                            e.type === w.TZK.MESSAGE && null == V && (V = e);
                    ...
                    if (
                        (null != _ &&
                            g.forEach((e, t) => {
                                let n = 0 === t && (0, ei.l)(s, W, new rA.Ay({ type: w.lAJ.DEFAULT, author: _ }));
                                K.push(
                                    (0, r.jsx)(
                                        rK,
                        ...
                        ((e && v()) || !e) && K.unshift((0, r.jsx)(l2, { compact: u, ...A }, "has-more"));
                    }
                    if (
                        ((a.hasMoreBefore && null == f) ||
                            S ||
                            K.unshift((0, r.jsx)(ad, { channel: s, showingBanner: C }, "empty-message")),
                        a.hasMoreAfter && K.push((0, r.jsx)(l2, { compact: u, ...A }, "has-more-after")),
                        !C && N && v() && K.push((0, r.jsx)(rF, { channel: s })),
                        c > 0 && d && v())
                    ) {
                        let e,
                            t,
                        ...
                        if (
                            ...
                            M && (0, j.Kc)(s) && O.includes(rB.i.SUMMARIES))
                        ) {
                            ...
                            if (
                                ...
                                if (R) {
                                    ...
                                    l = (0, r.jsx)(rL.OZ, { scrollManager: p, content: e, channel: s });
                                } else {
                                    let e = (0, r.jsx)("div", {
                                    ...
                                    l = (0, r.jsx)(rL.GN, { content: e, channelId: s.id });
                                }
                            }
                        } else
                            O.includes(rB.i.NEW_MESSAGES) &&
                                (l = (0, r.jsx)(rL.GN, {
                    ...
                    if (
                        (null == l &&
                            (0, j.pk)(s) &&
                            R &&
                            O.includes(rB.i.SUMMARIES) &&
                            (l = (0, r.jsx)(rL.UK, { channel: s, scrollManager: p })),
                        a.error)
                    )
                        i = (0, r.jsx)(rL.Ez, {
    ...
    r$ = o.memo(function (e) {
        let {
            ...
            })(),
            {
                ...
                let n,
                    ...
                    a = lY.default.getUser(ec.default.getId())?.hasFlag(w.nhx.SPAMMER) ?? !1,
                    r = (0, j.cI)(e),
                                    ...
                                    s.forEach((e) => {
                                        ...
                                        (null !== y &&
                                            ([j, I] =
                                                ((E = f = I),
                                                null == f || f.type !== y
                                                    ? ((x = { type: y, content: [], key: e.id }), m.push(x))
        ...
        return (
            o.useEffect(() => {
                null != v && O.W$.trackExposure({ guildId: v, location: "guild_entry" });
            }, [v]),
