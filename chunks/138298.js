...
let c = {
    ...
    openChannelAsSidebar(e) {
        ...
        null != d
            ? i.A.jumpToMessage({ channelId: n, messageId: d, flash: u, jumpType: s.US.INSTANT })
    ...
    openModReportAsSidebar(e) {
        ...
        r.h.dispatch({
            ...
            c?.initialMessageId != null
                ? i.A.jumpToMessage({ channelId: a, messageId: c.initialMessageId, flash: u, jumpType: s.US.INSTANT })
    ...
    openGuildSidebar(e) {
        let { guildId: t, baseChannelId: n, sidebarType: i, details: s } = e;
        return r.h.dispatch({ type: "SIDEBAR_VIEW_GUILD", sidebarType: i, baseChannelId: n, guildId: t, details: s });
    },
    closeGuildSidebar(e) {
