...
function m(e) {
    ...
    let U = (0, s.Ro)({
        ...
        G = p.intl.format(p.t.Y2Rkqc, { primaryText: U, paidURL: _.X7G.PAID_TERMS }),
        F = p.intl.format(p.t.H2uH5b, { primaryText: U, paidURL: _.X7G.PAID_TERMS }),
        V = "",
        B = "";
    if (T) {
        V = p.intl.format(p.t.xlJyOM, { virtualGoodsURL: _.X7G.PAID_TERMS_VIRTUAL_GOODS, paidURL: _.X7G.PAID_TERMS });
        let e = "";
        (e =
            L === h.Dp.ORB_PROFILE_BADGE
                ? p.intl.string(p.t.APcKRo)
                : L === h.Dp.FRACTIONAL_PREMIUM
                  ? p.intl.string(p.t.FhJ74j)
                  : p.intl.string(p.t["Sxed/G"])),
            Array.isArray(V) ? (V = [...V, ` ${e}`]) : (V += ` ${e}`);
    } else if (S)
        if (null != E && y?.subscriptionPeriodEnd != null) V = p.intl.format(p.t["2VPTay"], { subtotalRate: m });
        else
            switch (t) {
                case f.WT.MONTH:
                    V = 1 === n ? p.intl.format(p.t["+ywPmZ"], {}) : p.intl.format(p.t.oBwZfh, { intervalCount: n });
                    break;
                case f.WT.YEAR:
                    V = p.intl.format(p.t.y9gsX5, {});
                    break;
                case void 0:
                    V = p.intl.format(p.t.UxGFH4, {});
                    break;
                default:
                    throw Error(`Unexpected interval: ${t}`);
            }
    else if (v === _.VVm.ONE_TIME)
        switch (R) {
            case _.EZt.COLLECTIBLES:
                (B = G),
                    (V = A
                        ? p.intl.format(p.t.Amdf8X, { paidURL: _.X7G.PAID_TERMS })
                        : p.intl.format(p.t["40vM4o"], { paidURL: _.X7G.PAID_TERMS }));
                break;
            case _.EZt.GUILD_PRODUCT:
                (B = G), (V = p.intl.format(p.t["GEAQ+u"], { paidURL: _.X7G.PAID_TERMS }));
                break;
            case _.EZt.SOCIAL_LAYER_GAME_ITEM:
                (B = G),
                    (V = (0, a._z)(null != M ? { id: M, name: w ?? "game's" } : void 0, {
                        shouldAppendDisclaimer: !0 === A || !1 === P,
                    }));
                break;
            default:
                (B = F), (V = "");
        ...
        switch ((A && (B = G), t)) {
            case f.WT.MONTH:
                (V = A ? p.intl.string(p.t.IjNapk) : p.intl.string(p.t["/sGXPr"])),
                    (V = A
                ...
                break;
            case f.WT.YEAR:
                V = A ? p.intl.string(p.t.vAfbG8) : p.intl.string(p.t.IGzFc5);
                break;
            case void 0:
                V = "";
                break;
        ...
        I ||
            ...
            (V = D?.isPausedAllowsResumeButNotUpdates
    ...
    return (0, i.jsxs)(i.Fragment, {
        children: [
            ...
            C === _.hes.PAYSAFE_CARD && (0, i.jsx)("div", { children: p.intl.string(p.t.kj9VLI) }),
            C === _.hes.SOFORT && (0, i.jsx)("div", { children: p.intl.string(p.t["UYy1/h"]) }),
        ],
    });
}
let g = function (e) {
    return (0, i.jsx)("div", { className: E.F, children: (0, i.jsx)(m, { ...e }) });
};
