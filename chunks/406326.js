...
function S(e) {
    let {
        ...
        z = i.useMemo(() => (A > 0 ? v.intl.format(v.t.uaR4sI, { filterCount: A }) : v.intl.string(v.t.UdhTtk)), [A]),
    ...
    return (0, r.jsxs)("header", {
        className: a()(j.searchHeader, { [j.searchHeaderWithSubtitle]: null != D }),
        children: [
            (0, r.jsx)("div", {
