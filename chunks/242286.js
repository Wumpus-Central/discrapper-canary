    ...
    flush = () => {
        ...
        W())
            ? (this.actionsToFlush.size > 0 &&
                  (E.tN({ type: V.kGV.DISPATCH, pid: null, token: null, payloads: Array.from(this.actionsToFlush) }),
                  this.actionsToFlush.clear()),
    ...
    eo = (0, s.n)({
        ...
        onTimeout: (e, t) => {
            ...
            es((0, G.getPID)(), { ...r, error_description: n, success: !1 }),
                P.default.track(V.HAw.OVERLAY_HOOK_RESULT, ei((0, G.getPID)()));
        },
        timeoutMs: 18e4,
    });
function el(e, t) {
...
function eu(e, t) {
    ...
    (null === n || r === n) &&
        ...
        (null == t || "CRASHED" === t) &&
            ...
            (function () {
                try {
                    let e = p.A?.fileManager?.uploadDiscordHookCrashes;
                    if (null == e) return;
                    e().then((e) => {
        ...
        Q.delete(e),
        en.info(`pid=${e} status transition ${r ?? "DISCONNECTED"} -> ${t ?? "DISCONNECTED"}`, Y));
}
async function ec(e) {
    try {
        ...
        if ((en.verbose("updateIntendedOverlayPIDs: newGame", r), r.legacyEnabled))
            switch (
                ...
                case y.Ue.Hook:
                    ...
                    es(r.pid, { mounting_started_at: i, fullscreen_type: await (0, C.E1)(r.pid, 0) }),
                        Y.has(r.pid) || (await ed(r.pid)),
                        (H[r.pid] = {
...
let ep = el("updateIntendedOverlayPIDs", (e) => (en.info("updateIntendedOverlayPIDs", e), ef(e))),
    eh = el("clearPID", (e) => {
        if (null == e) return (0, G.setPID)(G.UNSET_PID);
        O.A.isOverlayV3EnabledForPID(e) || (0, G.setPID)(G.UNSET_PID);
    });
function eE() {
...
function eA(e, t, n) {
    ...
    es(e, {
        ...
        (0, d.Vz)(G.OVERLAY_LAYOUT_ID, M.A.getDefaultLayout(G.OVERLAY_LAYOUT_ID), 0, {
            width: n.graphics_width,
            height: n.graphics_height,
        });
    let s = ei(e);
    P.default.track(V.HAw.OVERLAY_HOOK_RESULT, s),
        ...
        case V.kGV.CONNECT:
            ...
            (0, d.Vz)(G.OVERLAY_LAYOUT_ID, M.A.getDefaultLayout(G.OVERLAY_LAYOUT_ID), 0),
                Promise.all([(0, N.A)(t, e.pid), a.Ay.PersistedStore.getAllStates()]).then((t) => {
                    let [n, r] = t,
                        { pid: i, token: s } = e;
                    E.tN({ type: V.kGV.STORAGE_SYNC, pid: i, token: s, states: r }),
                        E.tN({ type: V.kGV.DISPATCH, pid: i, token: s, payloads: [n] }),
                        eu(i, "READY"),
                        (0, G.setPID)(i),
                        _.A.overlayReady(i);
                    let a = ei(i);
...
let ev = null;
function eC() {
    g.A.hasLoadedExperiments && !j && ((j = !0), em(S.x.legacyEnabled));
}
class eO extends a.Ay.Store {
    ...
    initialize() {
        !(0, G.supportsLegacy)() ||
            __OVERLAY__ ||
            (this.waitFor(L.default, g.A, w.A, M.A, v.default, R.A, b.A, O.A, A.Ay),
    ...
    isInputLocked(e) {
        return v.default.isOverlayOOPEnabledForPid(e) ? R.A.isInputLocked(e) : !Q.has(e);
    }
    ...
    get enabled() {
        ...
        return null != e ? (O.A.isOverlayV3EnabledForPID(e) ? b.A.isOverlayEnabled : K) : b.A.isOverlayEnabled || K;
    }
    ...
    getFocusedPID() {
        let e = O.A.getFocusedPID();
        return null != e && O.A.isOverlayV3EnabledForPID(e) ? e : z;
    }
    ...
    isReady(e) {
        return O.A.isOverlayV3EnabledForPID(e) ? O.A.isReady(e) : "READY" === Y.get(e);
    }
    isCrashed(e) {
        return !O.A.isOverlayV3EnabledForPID(e) && "CRASHED" === Y.get(e);
    }
            ...
            : {
                  ...
                  OVERLAY_SET_INPUT_LOCKED: function (e) {
                      let { locked: t, pid: n } = e,
                          r = Y.get(n);
                      if (
                          (q.has(n) && ep(void 0), null != r && null != H[n]) &&
                          (t || "READY" === r || "CRASHED" === r)
                      ) {
                          if (
                              (t ? Q.delete(n) : Q.add(n), et.clear(), null != ev && (clearTimeout(ev), (ev = null), t))
                          )
                              return;
                          t
                              ? eN(t, n)
                  ...
                  RPC_SERVER_READY: function (e) {
                      ...
                      n.append("build_id", "c1ea4d003c39d60d1cfe1080be064091929ac58f"),
                  ...
                  OVERLAY_JOIN_GAME: function (e) {
                      ...
                      setImmediate(() => {
                          c.Ay.join({ userId: t, sessionId: n, applicationId: r, channelId: i, messageId: s }),
                  ...
                  OVERLAY_UPDATE_OVERLAY_METHOD: function (e) {
                      en.verbose("Updating OverlayMethod", {
                          ...
                          e.overlayMethod === y.Ue.Hook
                              ? ep({ added: [e.pid], removed: [] })
                              : ep({ added: [], removed: [e.pid] });
                  },
              },
    ),
    eb = eR;
