...
function b(e) {
    ...
    r.useEffect(
        ...
        [i, a, w, D, j, S, A, O, v, p, h, l, N, C, R, n],
    ),
        r.useEffect(
            function () {
                I({
...
function A(e, t) {
        ...
        function () {
            if (s && e) {
                ...
                if (null == f) {
                    ...
                    (t = new i.Rive(o(o({ useOffscreenRenderer: r }, e), { canvas: s }))).on(
                        i.EventType.Load,
                        function () {
                            (n = !0), s ? _(t) : t.cleanup();
                        },
    ...
    var C = null == e ? void 0 : e.animations;
    r.useEffect(
        function () {
            f &&
                C &&
                (f.isPlaying
                    ? (f.stop(f.animationNames), f.play(C))
                    : f.isPaused && (f.stop(f.animationNames), f.pause(C)));
        },
        [C, f],
    );
    var N = r.useCallback(
