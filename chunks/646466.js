...
let x = l.createContext({
    ...
    E = () => {
        let { validateShopAssetPackage: e, reset: t, validationComplete: n, warnings: r, errors: s } = (0, m.g)(),
            o = Object.entries(s),
            c = Object.entries(r),
            d = o.length > 0,
            u = c.length > 0,
            { setDropHandler: h } = l.useContext(x),
            f = l.useCallback(
                (n) => {
                    t(), e(n);
                },
    ...
    T = (e) => {
        let { children: t } = e,
            [n, r] = l.useState(() => () => {}),
            i = l.useMemo(() => ({ setDropHandler: (e) => r(() => e) }), []);
