...
var s = n(120356),
    ...
    p = n(155352);
function E(e) {
    let { user: t, pendingAvatar: n, pendingColors: s, onThemeColorsChange: r, preventDisabled: E, guildId: C, className: f, showPremiumIcon: N = !0, showResetThemeButton: I = !1, forcedDivider: T } = e,
        S = (0, u.ZP)(t.id, C),
    ...
    return (0, i.jsx)(x.Z, {
        ...
        disabled: !b && !E,
        className: l()(p.__invalid_profileThemesSection, f),
        showPremiumIcon: N,
        forcedDivider: T,
