...
function i(e) {
    ...
    if (t)
        if (i)
            ...
            else if (a) return r.NW.string(r.t.TJQcNj);
            else if (l) return r.NW.string(r.t.mJyBio);
            else return r.NW.string(r.t.lxTgPz);
        else if (o) return r.NW.string(r.t.Mnvc3N);
        else if (a) return r.NW.string(r.t.FdPNr6);
        else if (l) return r.NW.string(r.t.f4gmra);
