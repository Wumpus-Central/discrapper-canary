...
function c(e) {
    let { alt: t, ariaLabel: n, ariaHidden: i, role: r, width: s = 288, height: c = 192 } = e;
    return (0, a.jsx)("img", {
...
let Z = (e) => {
        let { user: t } = e,
            { avatarSrc: n, eventHandlers: i } = (0, F.A)({ userId: t.id, size: k._3.SIZE_24 });
        return (0, a.jsx)(
            U.eu,
            { className: q.bj, src: n, "aria-label": (0, H.mG)(t), size: k._3.SIZE_24, ...i },
            t.id,
        );
    },
    Q = (e) => {
    ...
    J = (e) => {
        ...
        return (0, a.jsx)("div", {
            ...
            children: (() => {
                ...
                for (let n = 0; n < X.Z; n++)
                    if (t?.[n] !== void 0) {
                        let i = (0, a.jsx)(Z, { user: t[n] }, t[n].id);
                        e.push(i);
                    } else {
...
let eo = (e) => {
    let { expiresAt: t, className: n } = e,
        i = (0, el.A)(es()(t).toDate(), 1e3);
    if (null == i) return null;
    let { days: s, hours: l, minutes: c, seconds: o } = i,
        d = [
...
var eA = n(103733),
    ...
    ex = n(584151);
let eb = () => {
    let e = (0, eg.bG)([A.A], () => A.A.useReducedMotion);
    return (0, a.jsx)(eh.A, {
        isMotionReduced: e,
        blurScale: 0.4,
...
let eR = (e) => {
    let { containerVisibilityPercentage: t } = e,
        n = (0, eg.bG)([A.A], () => A.A.useReducedMotion);
    return (0, a.jsxs)(a.Fragment, {
        children: [
            (0, a.jsx)("div", {
                className: eN.BI,
...
let ev = (e) => {
    ...
    return (0, a.jsx)(B.D, { className: r()(eI.w, t, i && eI.n), variant: "display-md", color: n, children: s });
};
var eT = n(788868),
    eS = n(97584);
let ej = (e) => {
    ...
    ey = (e) => {
        let { className: t, isEligibleForBogoPromotion: i, isInReverseTrial: l, shouldShowReferralProgressBar: c } = e,
            {
                headingText: d,
                headingTop: _,
                showPill: x,
        ...
        let j = (0, o.bG)([E.A], () => E.A.getPremiumTypeSubscription()),
            ...
            k = (0, O.V)(),
            U = (0, y.O)(),
            w = (0, ei.U9)(U, eT.pe.TIER_2) ? eT.pe.TIER_2 : void 0,
            G = null != j && j.status !== Y.Dmq.ACCOUNT_HOLD && j.hasAnyPremiumNitro,
            B = (0, b.A)(),
            F = B.isFractionalPremiumActive && !G && null == S && !D,
            V = (0, o.bG)([A.A], () => A.A.useReducedMotion),
            { visibilityPercentageRef: H, visibilityPercentage: z } = (0, eA.U)(!V);
        return l
    ...
    eM = (e) => {
        let { className: t, buttonVisibilityRef: n, userDiscountOffer: i, discountedPrice: r } = e,
            ...
            A = (0, x.Ay)(f, x.yE.CREDITS_ENDS_IN),
            C = null;
            ...
            C = (0, a.jsx)(d.A, {
                ...
                children: (e) =>
                    (0, a.jsx)("div", {
                        ...e,
                        className: eS.V_,
                        children: (0, a.jsx)("div", { className: eS.eL, children: (0, a.jsx)(eu.A, { text: A }) }),
                    }),
            });
        }
        return (0, a.jsx)(h.f5, {
