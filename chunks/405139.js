...
class T extends i.Component {
    ...
    initPaymentRequest = async (e) => {
        ...
        t.on("paymentmethod", (e) => {
            ...
            n(r, i), this.trackAnalyticsEvent(E.HAw.PAYMENT_REQUEST_COMPLETED), t("success");
        }),
            t.on("cancel", () => {
                n(null);
            });
    ...
    attemptPaymentRequest = () => {
        if ((0, f.isDesktop)()) return void this.props.onChooseType(E.hes.PAYMENT_REQUEST, this.paymentRequestWallet);
    ...
    renderConnectorView() {
        return (0, r.jsxs)("div", {
            ...
            children: [
                ...
                (0, r.jsx)(l.E, { variant: "text-md/medium", className: g.yW, children: m.intl.string(m.t.f19PPV) }),
            ],
        });
    }
    renderMain() {
    ...
    renderConnectorView() {
        return (0, r.jsxs)("div", {
            ...
            children: [
                ...
                (0, r.jsx)(l.E, { variant: "text-md/medium", className: g.yW, children: m.intl.string(m.t.ueoGef) }),
            ],
        });
    }
    renderMain() {
    ...
    renderConnectorView() {
        return (0, r.jsxs)("div", {
            ...
            children: [
                ...
                (0, r.jsx)(l.E, { variant: "text-md/medium", className: g.yW, children: m.intl.string(m.t.iv8pQV) }),
            ],
        });
    }
    renderMain() {
