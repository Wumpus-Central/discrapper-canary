"use strict";
n.d(t, { Ay: () => eI, Pq: () => eA, he: () => eE, rq: () => eg }), n(938796);
var r = n(481613),
    i = n.n(r),
    a = n(110259),
    s = n(821418),
...
function ed(e, t, n) {
    ...
    if (n?.targetType == null && !(0, G.QE)(t.type) && (0, N.K)(e)) return er.VV.GUILD_HOME;
...
function e_(e, t) {
    let { type: n } = e,
        ...
        s = n === et.rbe.GUILD_STAGE_VOICE,
        o = { source: M.A.INVITE_ACCEPT, navigationReplace: !0 };
    return (
        null != i && (o.welcomeModalChannelId = i),
        s && (o.state = { stageInviteKey: es.J2 }),
...
function ef(e) {
    let { guildId: t, channel: r, options: i, analyticsLocations: a = [] } = e,
        s = H.A.getGuild(t),
        o = s?.features.has(et.GuildFeatures.MEMBER_VERIFICATION_MANUAL_APPROVAL),
        {
            targetUserId: l,
            targetType: u,
        ...
        ? (0, v.B)(() => {
              Promise.resolve()
                  ...
                  .then((e) => {
                      ...
                      !d && (0, b.V)(t, [H.A, z.default, j.Ay]) ? (0, C.Ze)(t, s) : s();
                  });
          })
        : (0, g.AX)(h) &&
          u === ea.yV.EMBEDDED_APPLICATION &&
...
let eI = {
            ...
            : (p.h.dispatch({ type: "INVITE_ACCEPT", code: o }),
              d.Bo.post({
                  ...
                  async (e) => {
                      ...
                      let t = O.Ay.getGuildScheduledEvent(s.guildScheduledEventId),
    ...
    transitionToInvite(e, t, n) {
        ...
        if (null != i && !a && e.new_member && (0, D.h)(i)) return void (0, D.W)(i.id);
        if (null == r) return;
        let l = eu(e);
    ...
    openNativeAppModal(e) {
        let t = { experiments: [y.R.definition.id] };
    ...
    openApp(e, t, n, r, a) {
        ...
        } else "#" === (s = null != t ? et.BVt.INVITE_PROXY(t) : "")[0] && (s = s.slice(1)), (s = `discord://${s}`);
        Q.A.launch(s, (t) => {
