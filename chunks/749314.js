...
let u = r.forwardRef(function (e, t) {
    let { className: n, contentClassName: r, isUnread: s, children: o, ...u } = e;
    return (0, i.jsxs)("div", {
        ...u,
        className: a()(n, { [_.yF]: !0, [_.KJ]: s, [_.ov]: null != o }),
        ref: t,
        children: [
            null != o ? (0, i.jsx)("span", { className: a()(_.Qs, r), children: o }) : null,
            s
                ? (0, i.jsxs)("span", {
                      className: _.dM,
                      children: [(0, i.jsx)(l, { foreground: _.BH, className: _.fE }), d.intl.string(d.t.y2b7CA)],
                  })
                : null,
        ],
    });
