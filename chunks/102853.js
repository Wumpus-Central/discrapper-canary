...
function U(e) {
    let t,
        ...
        Y = null != U || (0, A.A)(n),
        q = (0, i.bG)([M.default], () => M.default.getCurrentUser()),
        J = G.id === q?.id,
        $ = (function (e) {
        ...
        et = (0, i.bG)(
            [O.A],
            () => null != n && null != n.application_id && O.A.getState(n.application_id, k.xL.JOIN) === k.eAD.LOADING,
        ),
        en = (0, I.h)(Z),
        el = (0, v.x)(en),
        ei = (0, g.vG)({ userId: G.id, activity: n, channelId: $, application: en }),
        es = (0, i.bG)([m.A, N.A, S.A, j.A, b.Ay, f.A, T.A, _.A, R.A, u.Ay], () =>
            null != U
                ? ei === g.Gy.CAN_JOIN
                    ? p.o.CAN_JOIN
                    : p.o.CANNOT_JOIN
