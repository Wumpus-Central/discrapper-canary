...
var r = n(412703),
    ...
    C = n(814793),
    O = n(654487);
let R = +p.A.Millis.MINUTE,
    b = +p.A.Millis.SECOND,
    D = (0, S.L)({ location: O.rE.QUESTS_MANAGER });
function L(e) {
...
class P extends s.A {
        ...
        let s = () => {
            ...
            if (a.has(e)) {
                let o = a.get(e),
                    ...
                    { enabled: c } = I.ev.getConfig({ location: O.rE.QUESTS_MANAGER }),
                ...
                if (t === r.n.STREAM_ON_DESKTOP) {
                    ...
                    D.log(`~ initiateHeartbeat -> Sending heartbeat for questId: ${e}`),
                        (0, E.R2)({ questId: e, streamKey: r, applicationId: u, executableFingerprint: _ });
                } else
                    D.log(`~ initiateHeartbeat -> Sending heartbeat for questId: ${e}`),
                        (0, E.R2)({ questId: e, applicationId: u, executableFingerprint: _ });
    ...
    getActivelyProgressingActivityQuests() {
        ...
        for (let t of r.values()) L(t) && (0, C._e)(t) && e.set(t.id, { applicationId: O.ej });
        return (
