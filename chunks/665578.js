            ...
            () =>
                (0, c.ZDy)(async () => {
                    ...
                    return (
                        ...
                        (n) => (0, i.jsx)(e, Z(w({}, n), { defaultMemberPermissions: t }))
                    );
                }),
            [D],
        ),
    ...
    return (0, i.jsxs)(r.Fragment, {
        children: [
            ...
            X.map((e, t) => {
                ...
                return (
                    M
                        ? Y && (r = S.intl.string(S.t.XTwtW1))
                        : (r = null != l ? S.intl.string(S.t.tybdam) : S.intl.string(S.t.z2hjk5)),
                    (0, i.jsx)(
                        _.Z,
                        {
                            bar: (0, i.jsx)(c.ua7, {
...
function T(e) {
    ...
    return Z(w({}, t), {
        results: t.results.roles
            .map((e) => Z(w({}, e), { type: d.Kw.ROLE }))
            .concat(t.results.members.map((e) => Z(w({}, e), { type: d.Kw.USER }))),
    });
}
