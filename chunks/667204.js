...
async function V(e) {
    ...
    let { command: N, optionValues: w, context: k, commandTargetId: j, maxSizeCallback: U, commandOrigin: G = L.bB.CHAT, sectionName: B, interactionLifecycleOptionsFactory: F = K, source: V } = e;
        ...
        null != k.autocomplete
            ...
            : (s.Z.clearAll(k.channel.id, Q),
              Y({
                  ...
                  sectionName: B,
                  source: H,
                  interactionLifecycleOptions: await F(N, k, J)
              }));
}
let Z = (e) => {
