...
async function F(e) {
    ...
    let H = null != (r = w.Z.getSource(j.channel.id)) ? r : F,
        W = null != (o = w.Z.getCommandOrigin(j.channel.id)) ? o : G;
    null == j.autocomplete &&
        a.Z.dispatch({
                ...
                case c.jw.ROLE:
                    if ("roleMention" === a.type) t = a.roleId;
                        ...
                        if ((0, x.BH)(a.text)) t = a.text.trim();
                            ...
                            let e = (0, _.K)(a.text, null == (m = j.guild) ? void 0 : m.id, j.channel.id, {
                                allowUsers: !1,
                            });
                ...
                case c.jw.USER:
                    if ("userMention" === a.type) t = a.userId;
                        ...
                        if ((0, x.BH)(a.text)) t = a.text.trim();
                            ...
                            let e = (0, _.K)(a.text, null == (E = j.guild) ? void 0 : E.id, j.channel.id, {
                                allowRoles: !1,
                            });
        ...
        null != j.autocomplete
            ...
            : (s.Z.clearAll(j.channel.id, Q),
              Y({
                  ...
                  sectionName: B,
                  source: H,
                  interactionLifecycleOptions: await Z(C, j, J),
              }));
}
let V = (e) => {
...
async function X(e, t, n, r) {
    let i = (0, S.dg)(n),
        a = (e) => {
            null == r || r(i, e),
                m.yr(t, M.evJ.ENTITY_TOO_LARGE, k.intl.formatToPlainString(k.t.fxEKdS, { maxSize: (0, S.Ng)(i) }));
        },
        { totalSize: o, largestUploadedFileSize: s } = await q(e, !1);
    if (s > Math.max(i, j.Y1) || o > C.zz) return a(s), !1;
    try {
        await (0, d.Z)(e);
    } catch (n) {
        m.yr(t, void 0, k.intl.formatToPlainString(k.t["9h1/1p"], { count: e.length }));
    }
    return (
