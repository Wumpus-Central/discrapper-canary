...
async function Q(e, t, n, r) {
    let i = e,
        o = (0, T.dg)(n),
        a = (e) => {
            null == r || r(o, e), m.yr(t, M.evJ.ENTITY_TOO_LARGE, j.intl.formatToPlainString(j.t.fxEKdX, { maxSize: (0, T.Ng)(o) }));
        },
        { totalSize: s, largestUploadedFileSize: l } = await q(i, !1);
    if (l > Math.max(o, k.Y1) || s > N.zz) return a(l), !1;
    try {
        await (0, d.$)(i);
    } catch (e) {
        m.yr(t, void 0, j.intl.formatToPlainString(j.t['9h1/1t'], { count: i.length }));
    }
    return ({ totalSize: s, largestUploadedFileSize: l } = await q(i, !0)), (!i.some((e) => e.error === M.evJ.ENTITY_TOO_LARGE) && !(s > N.zz)) || (a(l), !1);
}
