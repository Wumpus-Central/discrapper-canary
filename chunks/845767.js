...
class a extends i.Z {
    _initialize() {
        r.Z.subscribe("POST_CONNECTION_OPEN", this._maybeStartDevSession),
            r.Z.subscribe("LOGOUT", this._maybeStopDevSession);
    }
    _terminate() {
        r.Z.unsubscribe("POST_CONNECTION_OPEN", this._maybeStartDevSession),
            r.Z.unsubscribe("LOGOUT", this._maybeStopDevSession);
    }
    _maybeStartDevSession() {
        ...
        if (!((null == t ? void 0 : t.email) == null || (e && t.isStaff())))
