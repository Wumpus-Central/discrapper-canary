...
let m = [
    ...
    N = 0;
function v() {
    if (null == S || !O(S)) return !1;
    let e = R(S);
    if (e.lastActionTime > Date.now() - d.A.Millis.DAY && e.viewDuration > g) return !1;
    let t = Date.now();
    return (e.lastActionTime = t), (e.viewDuration += t - y), (y = t), !0;
}
function C() {
    return (
...
class D extends r.Ay.PersistedStore {
    ...
    initialize(e) {
        null != e && (I.channels = e.channels), this.syncWith([c.Ay], C), this.waitFor(a.default, o.A, l.A, u.A, c.Ay);
    }
    getState() {
        return I;
    }
    ...
    maybeAutoUpgradeChannel(e) {
        ...
        return (
            ...
            (delete I.channels[e], T.add(e), (0, h.mA)(t.guild_id, t.id, p.e.ALL_MESSAGES), !0)
        );
    }
}
let L = new D(s.h, {
        CHANNEL_SELECT: function () {
            let e = v();
            return (S = u.A.getChannelId()), (y = Date.now()), e;
        },
        CONNECTION_OPEN: function () {
            (S = u.A.getChannelId()), (y = Date.now()), C();
            let e = Date.now() - A;
        ...
        MESSAGE_CREATE: function (e) {
            if (e.optimistic || e.isPushNotification || e.message.author?.id !== a.default.getId() || !O(e.channelId))
                return !1;
            let t = R(e.channelId);
