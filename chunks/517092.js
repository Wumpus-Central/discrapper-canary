...
function D(e) {
    if (!c.Ay.useNewNotifications || C.has(e)) return !1;
    ...
    return c.Ay.getChannelUnreadSetting(t.guild_id, t.id) === A.e.UNSET && n !== A.e.ALL_MESSAGES;
}
function M(e, t) {
    if (null == t) return !1;
...
class R extends a.Ay.PersistedStore {
    ...
    initialize(e) {
        null != e && (p.channels = e.channels), this.syncWith([c.Ay], L), this.waitFor(l.default, s.A, o.A, d.A, c.Ay);
    }
    getState() {
        return p;
    }
...
let O = new R(r.h, {
        CHANNEL_SELECT: function () {
            let e = I();
            return (N = d.A.getChannelId()), (T = Date.now()), e;
        },
        CONNECTION_OPEN: function () {
            (N = d.A.getChannelId()), (T = Date.now()), L();
            let e = Date.now() - h;
