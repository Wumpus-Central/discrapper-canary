...
function N() {
    ...
    let t = Date.now();
    (e.lastActionTime = t), (e.viewDuration += t - T), (T = t);
}
function v() {
    return (
...
function R(e, t) {
    ...
    return (
        ...
        !!(
            ...
            (null != n.flags && (0, i.br)(n.flags, g.vv.UNREADS_ALL_MESSAGES | g.vv.UNREADS_ONLY_MENTIONS))
        )
    );
}
class j extends l.Ay.PersistedStore {
    ...
    initialize(e) {
        null != e && (C.channels = e.channels), this.syncWith([d.Ay], v), this.waitFor(s.default, r.A, o.A, c.A, d.Ay);
    }
    getState() {
        return C;
    }
    ...
    maybeAutoUpgradeChannel(e) {
        ...
        return (
            ...
            (delete C.channels[e], x.add(e), (0, m.mA)(t.guild_id, t.id, p.e.ALL_MESSAGES), !0)
        );
    }
}
let M = new j(a.h, {
