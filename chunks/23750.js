...
class E extends m {
                ...
                if ((0, l.ir)(a.emoji, e)) {
                    if (((i = c), r === s.O.BURST)) {
                        ...
                        a = h(p({}, a), {
                            ...
                            burst_count: e,
                            count_details: h(p({}, a.count_details), { burst: e }),
                            burst_colors: r,
                        ...
                        let e = null !== (f = null === (d = a.count_details) || void 0 === d ? void 0 : d.vote) && void 0 !== f ? f : 0,
                            n = t && a.me_vote ? e : e + 1;
                        a = h(p({}, a), {
                            count_details: h(p({}, a.count_details), { vote: n }),
                            me_vote: !!t || a.me_vote
                        });
                    } else {
                        ...
                        a = h(p({}, a), {
                            count: e,
                            count_details: h(p({}, a.count_details), { normal: e }),
                            me: !!t || a.me
                        });
                    }
                }
    ...
    removeReaction(e) {
        ...
        let o = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                ...
                if ((0, l.ir)(t.emoji, e)) {
                    if (a === s.O.BURST) {
                        ...
                        t = h(p({}, t), {
                            ...
                            count_details: h(p({}, t.count_details), { burst: e })
                        });
                    } else if (a === s.O.VOTE) {
                        var r, i;
                        let e = null !== (i = null === (r = t.count_details) || void 0 === r ? void 0 : r.vote) && void 0 !== i ? i : 0,
                            n = o && !t.me_vote ? e : e - 1;
                        t = h(p({}, t), {
                            count_details: h(p({}, t.count_details), { vote: n }),
                            me_vote: !o && t.me_vote
                        });
                    } else {
                        ...
                        t = h(p({}, t), {
                            count: e,
                            me: !o && t.me,
                            count_details: h(p({}, t.count_details), { normal: e })
                        });
                    }
                    c = n;
                }
            ...
            m = null !== (n = null == _ ? void 0 : _.normal) && void 0 !== n ? n : 0,
