...
let C = new _.Z('GuildMemberStore'),
    R = {},
    P = {},
    w = {},
    D = {},
...
function B(e, t) {
    if (null == t.communicationDisabledUntil || !(0, f.b)(t)) return V(e, t.userId);
    let n = H(e, t.userId);
    L[n] !== t.communicationDisabledUntil && (0, f.b)(t) && ((L[n] = t.communicationDisabledUntil), F(n));
}
function V(e, t) {
    if (null != t) {
        let n = H(e, t);
...
function z(e) {
    var t, n;
    let { userId: r, nick: i, guildId: a, avatar: o, avatarDecoration: s, guildRoles: l, roles: c, premiumSince: u, isPending: d, joinedAt: _, communicationDisabledUntil: f, unusualDMActivityUntil: p, fullProfileLoadedTimestamp: m, flags: E } = e,
    ...
    if (r === y.default.getId())
        if (h.Z.isViewingRoles(a) || h.Z.isFullServerPreview(a)) {
            ...
            w[a] = N(S({}, D, h.Z.getMemberOptions(a)), { roles: null != e ? b.default.keys(e) : [] });
...
function er(e) {
    var t;
    let { guildId: n, user: r, nick: i, avatar: a, avatarDecoration: o, roles: s, premiumSince: l, isPending: c, joinedAt: u, communicationDisabledUntil: _, unusualDMActivityUntil: f, flags: p } = e,
        h = R[n];
    if (null == h) return !1;
...
function ei(e) {
    ...
    o.roles = [...o.roles, r];
    let s = K(v.Z.getRoles(a.id), o.roles);
    return (i[n] = S({}, o, s)), !0;
}
function ea(e) {
    let { guildId: t, userId: n, roleId: r } = e,
...
function ec(e) {
    ...
    return ef(t, n.map((e) => e.member).filter(E.lm));
}
function eu(e) {
...
function e_(e) {
    ...
    return null != n && ef(t, n.map((e) => e.member).filter(E.lm));
}
function ef(e, t) {
    let n = R[e];
    if (null == n) return !1;
