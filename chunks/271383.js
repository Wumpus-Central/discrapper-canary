...
function z(e, t) {
    ...
    for (let n of t) {
        ...
        null != t &&
            ...
            t.hoist && (null == a || (0, E.C$)(t, a)) && (a = t),
            (null != t.icon || null != t.unicodeEmoji) && (null == o || (0, E.C$)(t, o)) && (o = t));
    }
    return {
...
function q(e) {
    ...
    let {
        ...
        { colorString: v, colorStrings: I, colorRoleId: S, iconRoleId: C, hoistRoleId: R, highestRoleId: w } = z(l, c),
        x = {
            userId: r,
            nick: i,
            guildId: a,
    ...
    if (
        ((0, m.yE)(null != (t = x.flags) ? t : 0, T.q.IS_GUEST) &&
            (x.flags = (0, m.pj)(null != (n = x.flags) ? n : 0, T.q.BYPASSES_VERIFICATION)),
        null == P[a])
    )
        return x;
    if (r === y.default.getId())
        if (h.Z.isViewingRoles(a) || h.Z.isFullServerPreview(a)) {
            ...
            D[a] = N(A({}, x, h.Z.getMemberOptions(a)), { roles: null != e ? b.default.keys(e) : [] });
...
function en(e) {
    for (let t of e)
        if (
            null != t.member &&
            (null == x[t.id] ? (x[t.id] = t.member) : (x[t.id] = N(A({}, t.member), { roles: t.member.roles })),
            null != P[t.id])
        ) {
            let e = P[t.id];
            null != e[t.member.userId] &&
                (e[t.member.userId] = N(A({}, e[t.member.userId]), { roles: t.member.roles }));
        }
}
function er(e) {
    var t, n;
    ...
    let r = !1;
    for (let t of ((j = !0), (P[e.guildId] = null != (n = P[e.guildId]) ? n : {}), e.members))
