...
function x(e) {
    let { user: t, guildId: n, onClose: l } = e,
        i = t.id,
        o = (0, a.e7)([p.Z, N.Z, T.default], () => (i === T.default.getId() ? p.Z.getStatus() : N.Z.getStatus(i, n)), [
            i,
            n,
        ]);
    return (0, r.jsxs)("div", {
...
function j(e) {
    let { user: t, member: l, guildId: i } = e,
        ...
        j = (0, a.e7)([T.default], () => T.default.getId() === (null == t ? void 0 : t.id)),
        y = (0, a.e7)([O.Z, I.Z], () => {
