...
let g = new m(a.h, {
    ...
    COLLECTIBLES_SHOP_HOME_FETCH_FAILURE: (e) => {
        p.set(e.tab, u), E.set(e.tab, !1), f.set(e.tab, e.error), c.set(e.tab, Date.now()), h.set(e.tab, !0);
    },
    ...
    LOGOUT: () => {
        p.clear(), _.clear(), f.clear(), E.clear(), d.clear(), c.clear(), h.clear(), (r = void 0), (i = void 0);
    },
});
