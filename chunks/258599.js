...
function G(e) {
    let { windowKey: t, themeOverride: n, children: i } = e,
        ...
        [d] = a.useState(() => v.Ay.getEnableHardwareAcceleration()),
        {
            ...
            highContrastMode: z,
        } = (0, c.cf)([L.default, f.Ay, y.A, O.A, D.A], () => ({
            locale: L.default.locale,
            theme: n ?? y.A.theme,
            focused: l ? O.A.getWindowFocused(t) : D.A.isFocused(),
            mainWindowVisible: D.A.isVisible(),
            currentWindow: l ? (O.A.getWindow(t) ?? window) : window,
                ...
                _ = a.useCallback(
                    () => ({
                        i18n: {
                            ...
                            SEARCH: U.intl.string(U.t["5h0QOP"]),
                            AUTOCOMPLETE_NO_RESULTS_HEADER: U.intl.string(U.t["4o4z3e"]),
                            AUTOCOMPLETE_NO_RESULTS_BODY: U.intl.string(U.t.QwSXv8),
                            ...
                            CHARACTER_COUNT_A11Y_LABEL: (e) =>
                                U.intl.formatToPlainString(U.t.fR1cof, { remainingCharacters: e }),
                            MINIMUM_LENGTH_ERROR: (e) => U.intl.formatToPlainString(U.t["62rk1K"], { minLength: e }),
                            MAXIMUM_LENGTH_ERROR: (e) => U.intl.formatToPlainString(U.t.ICT5S6, { maxLength: e }),
                            MINIMUM_VALUE_ERROR: (e) => U.intl.formatToPlainString(U.t.ykmNSo, { min: e }),
                            MAXIMUM_VALUE_ERROR: (e) => U.intl.formatToPlainString(U.t.KiDDCk, { max: e }),
                        },
                        locale: o,
                        theme: t,
                        saturation: n,
