...
function U(e) {
    let { windowKey: t, themeOverride: n, children: i } = e,
        ...
        [u] = s.useState(() => L.Ay.getEnableHardwareAcceleration()),
        {
            ...
            highContrastMode: z,
        } = (0, c.cf)([O.default, m.A, b.A, R.A, D.A], () => ({
            locale: O.default.locale,
            theme: n ?? b.A.theme,
            focused: o ? R.A.getWindowFocused(t) : D.A.isFocused(),
            currentWindow: o ? (R.A.getWindow(t) ?? window) : window,
            fontScale: m.A.fontScale,
            fontScaleClass: m.A.fontScaleClass,
            keyboardModeEnabled: m.A.keyboardModeEnabled,
            saturation: m.A.saturation,
            desaturateUserColors: m.A.desaturateUserColors,
            useForcedColors: m.A.useForcedColors,
            systemForcedColors: m.A.systemForcedColors,
            useReducedMotion: m.A.useReducedMotion,
            alwaysShowLinkDecorations: m.A.alwaysShowLinkDecorations,
            highContrastMode: m.A.isHighContrastModeEnabled,
        })),
        q = (function (e, t) {
        ...
        X = 0;
    1 !== H && (X |= _.REDUCE_SATURATION_ENABLED);
    let Z = (0, w.C)(),
        Q = (0, y.qK)("RootThemeContextProvider"),
        J = (0, y.k5)("RootThemeContextProvider"),
        ee = (0, y.lV)("RootThemeContextProvider"),
        et = (0, N.y)("RootThemeContextProvider"),
        en = v.useConfig({ location: "RootThemeContextProvider" }).enabled,
