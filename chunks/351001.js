n.d(t, { EZ: () => h, HU: () => A, KX: () => f, Kd: () => b, L7: () => g, fJ: () => M }), n(938796);
var l = n(665260),
    u = n(17928),
    i = n(696451),
    r = n(71393),
...
let A = (e, t) => {
    var n;
    let o = (0, u.bG)([i.Ay], () => (0, l.Lt)(i.Ay.getMember(e, t)?.flags ?? 0, d.D.DID_REJOIN)),
        c = (0, u.bG)([r.A], () => {
        ...
        A = (0, u.bG)([a.default], () => a.default.getUser(t)?.bot);
    return (
        (n = { maxDaysOld: 7 }),
        (0, u.bG)(
            [],
            () =>
                (function (e, t, n) {
                    let { maxDaysOld: l, minDaysOld: u = 0 } = t,
                        o = r.A.getGuild(e),
                        a = o?.joinedAt;
                    if (null != n) {
                        let t = i.Ay.getMember(e, n);
                        a = t?.joinedAt == null ? null : new Date(t.joinedAt);
                    }
                    if (null == a) return !1;
...
function h(e, t) {
    let [n] = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : [o.A];
    return null != t && M(e, t, [n]) && !e.isProvisional;
}
function M(e, t) {
    let [n] = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : [o.A];
