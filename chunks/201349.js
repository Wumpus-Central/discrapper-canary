...
function na(e) {
    ...
    return i.useCallback(
        (e, i) => {
            n ||
                (a === eX.oU.CREATE_ANNOUNCEMENT_POST || (0, eO.YS)(i, l, s, a.drafts.type)
                    ? ((0, td.fh)({
                          sticker: e,
...
let nf = (e, t) => ({
    ...
    ng = i.memo(
        i.forwardRef(function (e, t) {
            ...
            let { activeCommand: eS, activeCommandSection: eN } = (0, m.cf)([M.A], () => ({
                    activeCommand: j.commands?.enabled ? M.A.getActiveCommand(N.id) : null,
                    activeCommandSection: j.commands?.enabled ? M.A.getActiveCommandSection(N.id) : null,
                })),
                {
                    isLurking: ej,
                    isPendingMember: eT,
            ...
            let tb = null != P,
                tS = (ew && !((ej || eT) && eM)) || (e1 && j.submit?.useDisabledStylesOnSubmit),
                tR = null;
            null != eS ? (tR = L?.(eS, eN, tj.g$)) : (!ew || ek) && (tR = R?.(tb, tj.g$));
            let tL = eP && null != r && !ew && j.showCharacterCount && null == eS,
                tk = eP && !__OVERLAY__ && null != r && null == eS && j.toolbarType !== eX.O1.NONE && !ew,
                tM = (function (e) {
                    let {
                            channel: t,
                            type: n,
                ...
                tD = j.layout === eX.wt.INLINE,
                tU = j.layout === eX.wt.FLUSH,
                                        ...
                                        children: [
                                            ...
                                            (0, l.jsxs)("div", {
                                                className: a()(tj.vW, {
                                                    [tj.BF]: tS,
                                                    [tj.RL]:
                                                        j !== eX.oU.EDIT && (null != tR || (tS && null == tR) || ej),
                                                    [tj.fk]: j === eX.oU.THREAD_CREATION,
                                                    [tj.TZ]:
                                                        j === eX.oU.CREATE_FORUM_POST ||
                                                        j === eX.oU.FORWARD_MESSAGE_INPUT,
                                                    [tj.$i]: j === eX.oU.USER_PROFILE_REPLY,
                                                }),
                                                onMouseDown: tm,
                                                children: [
                                                    tG,
                                                    ...
                                                    (0, l.jsx)(f.vN, {
                                                        ...
                                                        children: (0, l.jsx)(e$.A, {
                                                            ...
                                                            className: a()(
                                                                {
                                                                    [tj.QI]: j === eX.oU.THREAD_CREATION,
                                                                    [tj.AV]: j === eX.oU.PROFILE_BIO_INPUT,
                                                                    [tj.GR]: j === eX.oU.OVERLAY_INLINE_REPLY,
                                                                },
                                                                h,
                                                            ),
                                                            "aria-labelledby": $,
