...
let X = 2,
    Q = 'billing';
function J(e) {
    let { analyticsDataOverride: t, analyticsLocations: n, analyticsLocation: o, analyticsObject: l, analyticsSourceLocation: d, analyticsSubscriptionType: p = F.NYc.PREMIUM, onComplete: m, transitionState: N, initialPlanId: k, subscriptionTier: j, onClose: B, trialId: W, trialFooterMessageOverride: z, reviewWarningMessage: Q, planGroup: $ = V.Y1, openInvoiceId: ee, onSubscriptionConfirmation: et, renderPurchaseConfirmation: en, postSuccessGuild: er, followupSKUInfo: ei, renderHeader: eo, applicationId: ea, guildId: es, referralTrialOfferId: el, skuId: ec, onStepChange: eu, shakeWhilePurchasing: ed = !1, isLargeModal: ef = !1, isDynamicModal: e_ = !1, hideShadow: ep = !1, returnRef: eh, skipConfirm: em = !1, continueSessionToInitialStep: eg } = e,
        ...
        eB = (0, M.Z)(),
        { isGift: eZ, giftRecipient: eF, customGiftMessage: eV, emojiConfetti: eH, soundEffect: eY } = (0, w.wD)(),
        eW = c.CgR.SMALL;
    ...
    return (0, r.jsx)(c.UkV, {
        ...
        children: (0, r.jsx)(c.Y0X, {
            ...
            className: a()(Y.root, eG, { [Y.withHeader]: null != e3 }),
            transitionState: N,
            hideShadow: ep,
            returnRef: eh,
            size: eW,
