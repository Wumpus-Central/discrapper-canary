    ...
    o.useEffect(() => {
        ...
        o.useEffect(() => {
            if ((null != eP && null != ep ? ey(eP) : ey(E), null != eo)) eE(eo);
                ...
                var e;
                eE(null === (e = x.Z.get(E)) || void 0 === e ? void 0 : e.skuId);
            }
        }, [ey, eE, E, eo, eP, ep]);
...
function $(e) {
    let { subscriptionTier: n, initialPlanId: r, handleStepChange: i, referralTrialOfferId: s, handleClose: l, continueSessionToInitialStep: u } = e,
        ...
        [x, w] = o.useState(!0),
        P = (0, c.e7)([L.Z], () => L.Z.applicationIdsFetched.has(K.CL));
    return (o.useEffect(() => {
        w(!h || !_ || g);
    }, [g, _, h]),
    (0, m.Z)(
            ...
            : null != r
              ...
              : e
                ...
                : null != n
                  ? i(B.h8.PLAN_SELECT)
                  : i(B.h8.SKU_SELECT);
    }, [u, d, f, P, r, x, i, n, v, y, O, R, b, C, N, A, D]),
    x)
        ? (0, a.jsx)(H.Z, {})
        : f
