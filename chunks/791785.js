...
function ee(e) {
    ...
    let { isGift: eV, giftRecipient: eZ, customGiftMessage: eH, emojiConfetti: eW, soundEffect: eY } = (0, L.wD)(),
...
function et(e) {
    ...
    i.useEffect(() => {
        ...
        null != c
            ...
            : null != n
              ? a(I && A ? M.h8.PLAN_SELECT : M.h8.REVIEW)
              : e
                ? (b((0, U.nA)(E, u, v)), a(M.h8.REVIEW))
                : null != t
                  ? a(M.h8.PLAN_SELECT)
                  : a(M.h8.SKU_SELECT);
    }, [c, u, f, w, n, C, a, t, E, b, N, v, S, T, I, A]),
    C)
        ? (0, r.jsx)(V.Z, {})
        : f
