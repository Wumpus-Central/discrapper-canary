...
function E(e) {
    ...
    if (null != e && null != e.channel) {
        let n = e.channel;
        t = e.target_type === _.Iq.STREAM ? f.dAT.STREAM : e.target_type === _.Iq.EMBEDDED_APPLICATION ? f.dAT.APPLICATION : (0, o.bc)(n.type) ? f.dAT.GDM_INVITE : null == n || (0, o.hv)(n.type) ? f.dAT.FRIEND_INVITE : f.dAT.SERVER_INVITE;
    }
    return t;
}
let b = new Map();
function y(e, t, n) {
    if ((c.default.track(f.rMx.INVITE_OPENED, { invite_code: e }), b.has(e))) return b.get(e);
    let o = (0, d.fU)(e),
        _ = g(h({}, n), {
            with_counts: !0,
            with_expiration: !0,
                    ...
                    if (null != t) {
                        ...
                        c.default.track(
                            f.rMx.INVITE_RESOLVED,
                            {
                                ...
                                invite_type: E(i),
                                user_is_member: null != l.Z.getGuild(null == i || null == (a = i.guild) ? void 0 : a.id)
                            },
                            { flush: !0 }
                        );
                    }
