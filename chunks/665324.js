...
function z(e) {
    ...
    let O = L
        ? (0, r.jsx)(u.zxk, {
              onClick: function () {
                  (0, u.ZDy)(async () => {
                      let { default: e } = await Promise.all([n.e('56035'), n.e('71222')]).then(n.bind(n, 758961));
...
function H(e) {
    let { sound: t, isPlaying: s, onPlaySound: a, guild: o } = e,
        { soundId: d, name: p, user: h, userId: b, emojiId: j, emojiName: N } = t,
        O = (0, c.e7)([C.default], () => (null != h ? h : C.default.getUser(b)), [b, h]),
