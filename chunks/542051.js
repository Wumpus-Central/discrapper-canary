...
class g extends (r = a.PureComponent) {
    renderQuery(e) {
        let { query: t, navId: n, focusedIndex: r, onSelectQuery: a, onSelectSearchEverywhere: o, onHighlightQuery: u, hideQuery: f, searchFavorites: g } = this.props;
        if (e || f) return null;
        let _ = -1 === r;
        return (0, i.jsxs)(i.Fragment, {
            children: [
                (0, i.jsxs)(
                    s.P3F,
                    m(p({ className: l()(d.queryContainer, { [d.focused]: _ }) }, h(n, -1, _)), {
                        onMouseEnter: u,
                        onClick: a,
                        children: [
                            (0, i.jsx)('div', {
