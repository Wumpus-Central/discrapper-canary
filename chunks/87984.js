    ...
    return (0, s.jsxs)(el.Ip, {
        ...
        children: [
            ...
            (0, s.jsx)(ej.Ay, {
                ...
                displayName: c,
                onClickName: a,
                displayNameTrailing: I ? null : (0, s.jsx)(eO.A, { userId: i.id, isVisible: o, onOpenProfile: a }),
                pronouns: n?.pronouns,
                onClose: u,
                usernameIcon: i.hasAvatarForGuild(d?.id) && (0, s.jsx)(em.A, { user: i, nickname: c }),
            ...
            (0, s.jsx)(eI.A, { user: i }),
            !h && (0, s.jsx)(eA.A, { user: i, onOpenProfile: (e) => a?.({ tabSection: e }) }),
            n?.private && (0, s.jsx)(L.A.Overlay, { children: (0, s.jsx)(ef.A, { username: c }) }),
            ...
            i.isProvisional
                ...
                : (0, s.jsx)(eg.A, { userId: i.id, userBio: n?.bio, hidePersonalInformation: I, onClose: u }),
            P && (0, s.jsx)(ex.A, { user: i, widgets: n?.widgets, onOpenUserProfileModal: a }),
            (0, s.jsx)(eP.A, { user: i, currentUser: l, guildId: d?.id, onOpenUserProfileModal: a, onClose: u }),
