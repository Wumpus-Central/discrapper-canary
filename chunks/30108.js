...
var r = n(311907),
    ...
    E = n(39938);
let h = !1,
    p = (0, s.Qh)("stage_waiting", "stage_waiting", o.Ay.getOutputVolume() / 400);
function m() {
    ...
    if (E.A.shouldPlay()) {
        (p.volume = o.Ay.getOutputVolume() / 400), p.loop(), (h = !0);
        return;
    }
    if (f.A.isLive(e)) {
        p.stop(), (h = !1);
    ...
    n || h ? n && (p.pause(), (h = !1)) : ((p.volume = o.Ay.getOutputVolume() / 400), p.loop(), (h = !0));
}
function g(e) {
    let t = (0, r.bG)([l.A], () => l.A.getVoiceChannelId() === e),
        n = null != (0, c.E5)(e, _.ip.SPEAKER).find((e) => !e.voiceState.isVoiceMuted()),
        i = (0, r.bG)([f.A], () => f.A.getStageInstanceByChannel(e));
    return t && null == i && !n;
}
function A(e) {
    let t = l.A.getVoiceChannelId() === e,
        n = null != d.A.getMutableParticipants(e, _.ip.SPEAKER).find((e) => !e.voiceState.isVoiceMuted()),
...
class I extends i.A {
    ...
    handleVoiceChannelSelect(e) {
        ...
        if (null != t) {
            ...
            e?.isGuildStageVoice() ? m() : (p.stop(), (h = !1));
        } else p.stop(), (h = !1);
    }
    handleLogout() {
        p.stop(), (h = !1);
