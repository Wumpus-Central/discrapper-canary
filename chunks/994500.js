...
let O = new R(r.h, {
    ...
    OVERLAY_INITIALIZE: function (e) {
        for (let [t, n] of (l.clear(), y.clear(), e.relationships)) C(t, n);
        v();
    },
    RELATIONSHIP_ADD: function (e) {
        let t = l.get(e.relationship.id);
        C(e.relationship.id, e.relationship.type),
    ...
    RELATIONSHIP_PENDING_INCOMING_REMOVED: function (e) {
        for (let e of l.keys()) l.get(e) === o.eA$.PENDING_INCOMING && (N(e), _.delete(e), f.delete(e), delete m[e]);
        v();
    },
