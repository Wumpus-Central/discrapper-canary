    ...
    constructor(...e) {
        super(...e),
            ...
            b(this, "handleGuildMemberUpdate", (e) => {
                ...
                if (
                    o.id === s.default.getId() &&
                    !this.onboardingCompleteGuilds.has(a) &&
            ...
            b(this, "handleMessageSend", (e) => {
                ...
                (null == o ? void 0 : o.isForumPost()) &&
                    (null == o ? void 0 : o.parent_id) != null &&
                    this._completeChatAction(n, o.parent_id),
