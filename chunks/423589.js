...
function p(e) {
    ...
    return o.default.keys(e).filter((n) => {
        ...
        let o = e[n].message_notifications !== c.bL.NULL,
            s = i.yE(null != (a = e[n].flags) ? a : 0, u.ic.UNREADS_ALL_MESSAGES) || i.yE(null != (l = e[n].flags) ? l : 0, u.ic.UNREADS_ONLY_MENTIONS);
        return (!t.ignoreUnreadSetting && s) || (!t.ignoreNotificationSetting && o) || (!t.ignoreMute && (0, r.m$)(e[n]));
    });
}
function b(e) {
