...
function T(e) {
    let { expanded: t, setExpanded: n, isWholeFile: i, numLines: o } = e,
        a = p.intl.formatToPlainString(i ? p.t.Go5Vvr : p.t.yJcYam, { lines: o });
        ...
        children: (e) =>
            (0, r.jsxs)(
                ...
                y(E({}, e), {
                    ...
                    children: [
                        (0, r.jsx)(f.Z, { direction: t ? f.Z.Directions.UP : f.Z.Directions.DOWN }),
...
function C(e) {
    ...
    v && c && y > O ? (C = "\n...") : v || (C = "..."),
        "" !== C &&
            (v
                ? (C += " " + p.intl.formatToPlainString(p.t.DQnFp6, { lines: y - O }))
                : (C += " " + p.intl.formatToPlainString(p.t["1+gGcH"], { formattedBytes: (0, _.IC)(g) })));
