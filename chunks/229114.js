...
function m(e, t = !0) {
    ...
    i.currentNode = n;
    let a = i.nextNode();
    return t && !a && (((i = y((r = c(e)), { tabbable: !1 }, e)).currentNode = n), (a = i.nextNode())), a;
}
function g(e, t = !0) {
    h(m(e, t));
}
...
function y(e, t, n) {
    let s = (null == t ? void 0 : t.tabbable) ? i.W : i.E,
        l = (null == e ? void 0 : e.nodeType) === Node.ELEMENT_NODE ? e : null,
        c = (0, a.r3)(l),
        u = (0, o.A)(c, e || c, NodeFilter.SHOW_ELEMENT, {
            acceptNode(e) {
                ...
                return (null == t || null == (i = t.from) ? void 0 : i.contains(e))
                    ...
                    : s(e) && (0, r.J)(e) && (!n || f(e, n)) && (!(null == t ? void 0 : t.accept) || t.accept(e))
