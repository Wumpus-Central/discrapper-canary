...
var a = (function (e) {
    return (
        ...
        (e[(e.ORDER_BY_GUILD_JOINED_AT_ASC = 2)] = "ORDER_BY_GUILD_JOINED_AT_ASC"),
        (e[(e.ORDER_BY_USER_ID_DESC = 3)] = "ORDER_BY_USER_ID_DESC"),
        (e[(e.ORDER_BY_USER_ID_ASC = 4)] = "ORDER_BY_USER_ID_ASC"),
        e
    );
})({});
