...
async function G(e) {
    let {
        ...
        sectionName: d,
        interactionLifecycleOptionsFactory: f = j,
        source: p,
    } = e;
        ...
        null != i.autocomplete
            ...
            : (o.A.clearAll(i.channel.id, S),
              B({
                  ...
                  sectionName: d,
                  source: E,
                  interactionLifecycleOptions: await f(t, i, N),
              }));
}
let F = (e) => {
...
async function K(e, t, n, i) {
    let r = (0, v.o2)(n),
        s = (e) => {
            i?.(r, e),
                E.C1(t, x.t02.ENTITY_TOO_LARGE, U.intl.formatToPlainString(U.t.fxEKdS, { maxSize: (0, v.Hb)(r) }));
        },
