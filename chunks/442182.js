...
function D(e) {
    ...
    return (
        (0, f.$)(b, "GuildSettingsRolesEditMembers"),
        (0, r.jsx)("div", {
...
function L(e) {
    let {
        ...
        { analyticsLocations: g } = (0, b.ZP)(m.Z.MEMBER_LIST),
...
function G(e) {
    let { guild: t, role: l, locked: s, setSelectedSection: c } = e,
        [u, g] = i.useState(""),
        { headerHeight: f, headerRef: m } = (0, y.Z)(0),
        { scrolledToTop: b, handleScroll: p } = (0, N.V)(),
        h = l.managed || s,
        v = (0, C.e)(t.id, l.id),
        O =
            (0, o.e7)([j.Z], () => {
        ...
        children: [
            (0, r.jsx)("div", {
                ...
                children: (0, r.jsx)("div", {
                    className: P.contentWidth,
                    children: (0, r.jsxs)("div", {
                        className: a()(P.header, { [P.stickyHeaderElevated]: !b }),
                        children: [
                            (0, r.jsx)(N.Z, {
                                guild: t,
                                role: l,
