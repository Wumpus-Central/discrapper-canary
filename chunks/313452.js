                ...
                (0, i.jsxs)(h.B, {
                    ...
                    children: [
                        ...
                        (0, i.jsx)(p.E, {
                            ...
                            children: U.intl.string(D.default["O+racd"]),
                        }),
                    ],
                }),
                (0, i.jsx)(f.$, {
                    variant: "secondary",
                    onClick: () => (0, R.tZ)(e),
                    text: U.intl.string(D.default.klSpfs),
                }),
            ],
        }),
    });
...
function H(e) {
    let t,
        ...
        f = l.useRef(null),
        I = (0, x.A)(m, f),
        { entrypoint: C, notificationCenterVariant: D } = (0, v.X8)({ location: "NotificationsInboxSidebarList" }),
        {
            isLoading: U,
            isLoadingComplete: H,
            hasLoadedEver: F,
    ...
    l.useEffect(() => {
        ...
        return (
            N._.subscribe(M.jej.SCROLL_PAGE_DOWN, t),
            N._.subscribe(M.jej.SCROLL_PAGE_UP, e),
            () => {
                N._.unsubscribe(M.jej.SCROLL_PAGE_DOWN, t), N._.unsubscribe(M.jej.SCROLL_PAGE_UP, e);
            }
        );
    }, []);
    let q = l.useCallback(() => {
    ...
    l.useEffect(() => {
        Z || U || 0 >= ei() || ((!ee || z) && r?.(G.VA.FILL_SCROLLER));
    }, [ei, r, Z, U, ee, z]);
    let el = l.useMemo(() => {
