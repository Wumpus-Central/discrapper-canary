...
function k(e) {
    let { isRainbow: t, pathData: n, width: s, height: o, gradientWidthScale: i, className: a } = e,
        c = (0, p.Dt)(),
        l = (0, p.Dt)(),
        u = (0, r.jsx)('path', {
            d: n,
...
function M(e) {
    let t = (0, u.e7)([b.Z], () => b.Z.getPurchasedUpgradesForItem(j.yN.CLICKER_BUTTON)),
        ...
        U = (0, x.eR)(Z);
    (0, s.useEffect)(() => {
        M && !L.hasPlayedRainbowSound && (D(), F({ hasPlayedRainbowSound: !0 }));
    }, [M, L, D, F]);
        ...
        (0, r.jsxs)(r.Fragment, {
            children: [
                (0, r.jsxs)(h.Z, {
                    ...
                    innerRef: n,
                    onClick: W,
                    className: i()(P.logo, { [P.logoGreen]: !M }),
                    children: [
                        (0, r.jsx)(k, {
                            className: P.logoLeft,
                            isRainbow: M,
                        ...
                        (0, r.jsxs)(v.Z, {
                            ...
                            children: [
                                _.intl.format(N.default['u5OO/f'], {}),
                                (0, r.jsx)(O.Z, {
                                    renderedPoints: B,
                                    onRemovePoint: G
                                })
