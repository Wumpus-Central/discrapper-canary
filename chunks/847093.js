...
let Z = n(874332),
    ...
    S = () => [P.intl.string(N.default.TXLQ3d), P.intl.string(N.default.TC42mZ), P.intl.string(N.default.h3tura), P.intl.string(N.default['sAbI/v']), P.intl.string(N.default.NJ4o2t), P.intl.string(N.default.sUsj8f), P.intl.string(N.default.jMKjJC), P.intl.string(N.default.J6uWam)];
function I(e) {
