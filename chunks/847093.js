...
function k(e) {
    let t = (0, u.e7)([b.Z], () => b.Z.getPurchasedUpgradesForItem(j.yN.CLICKER_BUTTON)),
        { ref: n } = (0, f.ZP)(),
        o = null != t[j.uv.CLICKER_BUTTON_AFFIRMATIONS],
        [c, d] = (0, s.useState)([]),
        p = (0, s.useRef)([]),
        k = null != t[j.uv.CLICKER_BUTTON_RAINBOW],
        M = g.Mq[j.yN.CLICKER_BUTTON],
        R = (0, s.useMemo)(() => M.getPoints(t), [t, M]),
        [A, T] = (0, s.useState)({}),
        [L, B] = (0, y.Z)(j.yN.CLICKER_BUTTON),
        D = (0, x.eR)(Z),
        F = (0, x.eR)(w);
    (0, s.useEffect)(() => {
        k && !L.hasPlayedRainbowSound && (D(), B({ hasPlayedRainbowSound: !0 }));
    }, [k, L, D, B]);
            ...
            o &&
                (c.push({
                    text:
                        null !=
                        (e = (0, i.sample)([
                            P.intl.string(N.default.TXLQ3d),
                            P.intl.string(N.default.TC42mZ),
                            P.intl.string(N.default.h3tura),
                            P.intl.string(N.default["sAbI/v"]),
                            P.intl.string(N.default.NJ4o2t),
                            P.intl.string(N.default.sUsj8f),
                            P.intl.string(N.default.jMKjJC),
                            P.intl.string(N.default.J6uWam),
                        ]))
                            ? e
                            : "",
                ...
                (0, r.jsxs)(h.Z, {
                    ...
                    children: [
                        ...
                        (0, r.jsxs)(v.Z, {
                            ...
                            children: [
                                P.intl.format(N.default["u5OO/f"], {}),
                                (0, r.jsx)(O.Z, {
                                    renderedPoints: A,
                                    onRemovePoint: G,
                                }),
                    ...
                    return (0, r.jsx)(
                        S,
                        {
                            ...
                            position: C(
                                ...
                                E(
                                    e.variation,
                                    null == (s = n.current) ? void 0 : s.offsetTop,
                                    null == (o = n.current) ? void 0 : o.offsetLeft,
                                    null == (a = n.current) ? void 0 : a.offsetWidth,
                                    null == (i = n.current) ? void 0 : i.offsetHeight,
                                )[t % Object.keys(E(0)).length],
                            ),
                        },
                        t,
                    );
