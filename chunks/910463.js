...
function _(e) {
    let t,
        ...
        p = (0, i.pc)(),
        h = (0, i.Ld)();
    if (!f?.is_campaign_ias_enabled || !_ || void 0 === p || void 0 === h) return null;
    let E = l.A.getGuildId(),
        m = null != E ? a.A.getGuild(E) : null,
        g = {
            guilds:
                ((t = p()),
                (n = a.A.getGuilds()),
                t
                    .map((e) => {
                        ...
                        let i =
                            null !== t.icon
                                ? (c.Ay.getGuildIconURL({ id: t.id, icon: t.icon, size: 44, canAnimate: !0 }) ?? null)
                                : null;
