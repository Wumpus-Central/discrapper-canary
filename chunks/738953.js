...
function G(e) {
    let { user: t, currentUser: n, guildId: M, channelId: j, messageId: G, roleId: B, openedAt: V, closePopout: F, setPopoutRef: Z, disableUserProfileLink: H = __OVERLAY__, newAnalyticsLocations: Y = [], appContext: W, disableAutoFocus: K = !1 } = e,
    ...
    let er = (0, _.p)({ location: 'UserProfilePopout' }),
        ei = i.useMemo(() => (0, f.Z)(), []),
        ea = (e) => {
            null == F || F(),
