...
function G(e) {
    let { user: t, currentUser: n, guildId: k, channelId: j, messageId: G, roleId: B, openedAt: V, closePopout: F, setPopoutRef: Z, disableUserProfileLink: H = __OVERLAY__, newAnalyticsLocations: Y = [], appContext: W, disableAutoFocus: K = !1 } = e,
