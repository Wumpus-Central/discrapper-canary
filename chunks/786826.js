...
var t = l(627968),
    ...
    O = l(898525),
    _ = l(457845);
let z = (0, V.createChannelRecord)({ id: "1", type: L.rbe.DM });
function B(e) {
...
function H(e) {
        ...
        P = (function (e) {
            let n = a.useContext(R.Ay),
                ...
                [t] = a.useState(() => {
                    ...
                    return (
                        (t.children = (0, b.x7)(e)),
                        (t.selection = { anchor: M.K, focus: M.K }),
                        (0, E.a)({
                            editor: t,
    ...
    let W = a.useCallback(
        (e) => {
            ...
            n !== U.current && (L(n), K(!0), A?.(n)), d && _(e.length);
        },
        [d, A, K],
    );
    a.useEffect(() => {
        n !== U.current &&
            ((P.children = (0, b.x7)(n)),
            (P.selection = { anchor: M.K, focus: M.K }),
            P.onChange(),
            L(n),
