...
let k = () => {
    ...
    U = (e) => {
        let { children: t } = e;
        return (0, a.jsx)("div", { className: M.oP, children: (0, a.jsx)("div", { className: M.t0, children: t }) });
    },
    F = (e) => {
        let { recurrence: t } = e,
            s = (0, a.jsx)(n.r, { color: C.A.colors.CONTROL_CONNECTED_BACKGROUND_DEFAULT }),
            i = (0, a.jsx)("span", {
                className: M.nP,
                                        ...
                                        (0, a.jsx)(h.D, {
                                            ...
                                            children: R
                                                ? S.intl.format(S.t.i2EuFO, {
                                                      helpdeskArticle: v.A.getArticleURL(O.MVz.RECURRING_PROMOTION),
                                                  })
                                                : N
                                                  ? n.body
                                                  : null != n.bodyWithExpiration
                                                    ? S.intl.format(n.bodyWithExpiration, { date: n.endDate })
                                                    : n.body,
                                        }),
                                    ],
                                }),
