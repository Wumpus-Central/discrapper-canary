            ...
            children: [
                (0, r.jsxs)("g", {
                    ...
                    children: [
                        (0, r.jsx)("mask", {
                            ...
                            width: "20",
                            height: "20",
                            children: (0, r.jsx)("path", { d: "M0 0H20V20H0V0Z", fill: "white" }),
                        }),
                        (0, r.jsxs)("g", {
                ...
                (0, r.jsx)("defs", {
                    children: (0, r.jsx)("clipPath", {
                        id: "clip0_5398_22750",
                        children: (0, r.jsx)("rect", { width: "20", height: "20", fill: "white" }),
                    }),
                }),
            ],
        }),
...
function B() {
    ...
    return {
        [v.XY]: {
            title: e ? O.default.PF1aT5 : O.default.LsJ9hj,
            titleParams: e ? { discountPercentage: S.aW } : { discountPercent: S.aW },
            body: e ? O.default.KoKwMn : O.default.Yl5ww1,
            bodyWithExpiration: O.default["6KjkUa"],
            redemptionURL: "https://www.logitech.com/",
            logos: {
                dark: (0, r.jsx)(i.Fragment, {}, "logitech-logo-dark"),
                light: (0, r.jsx)(i.Fragment, {}, "logitech-logo-light"),
            },
            asset: M.A,
        },
        [v.KS]: {
            title: e ? L.t.p7BkHh : L.t.sfGgOG,
            titleParams: e ? { discountPercentage: I.H7 } : void 0,
            body: e ? L.t.nmvvaN : L.t.igiSKe,
            bodyWithExpiration: L.t.w8CXUl,
            redemptionURL: "https://steelseries.com/",
            logos: { dark: (0, r.jsx)(P, {}), light: (0, r.jsx)(D, {}) },
            asset: "https://cdn.discordapp.com/assets/content/c23a186569a2e8606d206cd4b5cc7f4ee8f880c844bc0debd5fd3400400ff7bc.png",
        },
        [v.Cs]: {
            title: e ? L.t.QEJnti : L.t["9N8obd"],
            titleParams: e ? { discountPercentage: I.F0 } : void 0,
            body: e ? L.t.eT5vm0 : L.t["34g+Z3"],
            bodyWithExpiration: L.t.rqmpXc,
            redemptionURL: "https://www.kontrolfreek.com/",
            logos: { dark: (0, r.jsx)(T, {}), light: (0, r.jsx)(y, {}) },
...
let U = () => {
        ...
        return (0, r.jsxs)("div", {
            ...
            children: [
                (0, r.jsx)(a.E, {
                    ...
                    color: "text-muted",
                    className: w.kT,
                    children: L.intl.format(O.default["65EEvD"], { days: t }),
                }),
                (0, r.jsx)(E.Ay, {
                    progress: e,
                    variant: E.qP.UNSET,
    ...
    k = (e) => {
        let { children: t } = e;
        return (0, r.jsx)("div", { className: w.oP, children: (0, r.jsx)("div", { className: w.t0, children: t }) });
    },
    F = (e) => {
        let { recurrence: t, analyticsLocations: l = [] } = e,
            s = (0, r.jsx)(n.r, { color: p.A.colors.CONTROL_CONNECTED_BACKGROUND_DEFAULT }),
            u = (0, r.jsx)("span", {
                className: w.nP,
                children: (0, r.jsx)(o.K, {
                    ...
                    onClick: () => {
                        navigator.clipboard.writeText(t.code),
                            h(s),
                            f.default.track(b.HAw.THIRD_PARTY_PARTNER_CTA_CLICKED, {
                                partner: t.partnerId,
                                cta_type: "copy code",
                ...
                children: (0, r.jsxs)("div", {
                    ...
                    children: [
                        ...
                        (0, r.jsx)(c.$, {
                            variant: "secondary",
                            size: "sm",
                            text: L.intl.formatToPlainString(L.t.DF68t7, { redemptionURL: t.redemptionURL }),
                            onClick: () => {
                                window.open(t.redemptionURL, "_blank"),
                                    f.default.track(b.HAw.RECURRING_PROMOTION_CLAIMED),
                                    f.default.track(b.HAw.THIRD_PARTY_PARTNER_CTA_CLICKED, {
                                        partner: t.partnerId,
    ...
    H = (e) => {
        ...
        let l,
            ...
            [g, E] = i.useState(n.code),
            [f, A] = i.useState(!1),
            N =
                ((t = n.partnerId),
                (l = (0, C.bG)([x.A], () => (0, s.M)(x.A.theme))),
                null == (a = B()[t]) ? null : l ? a.logos.dark : a.logos.light),
            I = null == g;
        return (0, r.jsxs)("div", {
            className: w.lA,
            children: [
                                ...
                                (0, r.jsxs)("div", {
                                    ...
                                    children: [
                                        ...
                                        (0, r.jsx)(h.D, {
                                            ...
                                            color: "text-subtle",
                                            children: f
                                                ? L.intl.format(L.t.i2EuFO, {
                                                      helpdeskArticle: R.A.getArticleURL(b.MVz.RECURRING_PROMOTION),
                                                  })
                                                : I
                                                  ? n.body
                                                  : null != n.bodyWithExpiration
                                                    ? L.intl.format(n.bodyWithExpiration, { date: n.endDate })
                                                    : n.body,
                                        }),
                                    ],
                                }),
                        ...
                        c &&
                            (0, r.jsx)("div", {
                                ...
                                children: (0, r.jsx)(_._, {
                                    src: n.asset ?? "",
                                    className: w.Ys,
                                    imageClassName: n.partnerId === v.XY ? w.Cy : void 0,
                                    width: 100,
                                    height: 100,
                                    zoomable: !1,
                                }),
                ...
                m && (0, r.jsx)(U, {}),
                null != g && (0, r.jsx)(F, { recurrence: { ...n, code: g }, analyticsLocations: p }),
                m &&
                    null == g &&
                    (0, r.jsx)(k, {
                        children: (0, r.jsx)(G, {
