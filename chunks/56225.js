...
var L = i(652215),
    ...
    k = i(208556);
function U() {
    let e = (0, f.Q)("getRecurringPromotionPartnerAttributes");
    return {
        [D.XY]: {
        ...
        [D.KS]: {
            ...
            logos: { dark: (0, r.jsx)(b, {}), light: (0, r.jsx)(T, {}) },
        ...
        [D.Cs]: {
            ...
            logos: { dark: (0, r.jsx)(O, {}), light: (0, r.jsx)(y, {}) },
...
let F = () => {
    ...
    G = (e) => {
        let { children: t } = e;
        return (0, r.jsx)("div", { className: B.oP, children: (0, r.jsx)("div", { className: B.t0, children: t }) });
    },
    H = (e) => {
        let { recurrence: t, analyticsLocations: i = [] } = e,
            n = (0, r.jsx)(s.r, { color: p.A.colors.CONTROL_CONNECTED_BACKGROUND_DEFAULT }),
            u = (0, r.jsx)("span", {
                className: B.nP,
    ...
    W = (e) => {
        ...
        let i,
            ...
            [f, E] = l.useState(s.code),
            [R, A] = l.useState(!1),
            I =
                ((t = s.partnerId),
                (i = (0, _.bG)([x.A], () => (0, n.M)(x.A.theme))),
                null == (a = U()[t]) ? null : i ? a.logos.dark : a.logos.light),
            S = null == f;
        return (0, r.jsxs)("div", {
            className: B.lA,
            children: [
                                            ...
                                            children: [
                                                (0, r.jsx)(h.D, {
                                                    ...
                                                    children: R
                                                        ...
                                                        : S
                                                          ? s.body
                                                          : null != s.bodyWithExpiration
                                                            ? M.intl.format(s.bodyWithExpiration, { date: s.endDate })
                                                            : s.body,
                                                }),
                                                null != s.bodyNote &&
                                                    (0, r.jsx)(h.D, {
                                                        variant: "heading-sm/medium",
                                                        color: "text-subtle",
                                                        children: M.intl.format(s.bodyNote, {
                                                            partnerName: D.CD[s.partnerId].label,
                                                            helpdeskArticle: N.A.getArticleURL(
                                                                L.MVz.RECURRING_PROMOTION,
                                                            ),
                                                        }),
                        ...
                        c &&
                            (0, r.jsx)("div", {
                                ...
                                children: (0, r.jsx)(g._, {
                                    src: s.asset ?? "",
                                    className: B.Ys,
                                    imageClassName: s.partnerId === D.XY ? B.Cy : void 0,
                                    width: 100,
                                    height: 100,
                                    zoomable: !1,
                                }),
                ...
                m && (0, r.jsx)(F, {}),
                null != f && (0, r.jsx)(H, { recurrence: { ...s, code: f }, analyticsLocations: p }),
                m &&
                    null == f &&
                    (0, r.jsx)(G, {
                        children: (0, r.jsx)(V, {
