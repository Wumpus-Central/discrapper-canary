...
function x(e) {
    let { color: t, id: l, role: s, guild: d, children: x, isDragging: j, selectedItem: b, onItemSelect: N, itemType: v, locked: y, lockTooltip: C, showContextMenu: S, theme: Z, roleStyle: w, 'aria-label': O } = e,
        E = i.useCallback(
            (e) => {
                (0, c.jW)(e, async () => {
