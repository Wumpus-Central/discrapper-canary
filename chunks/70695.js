...
let f = 20 * o.A.Millis.SECOND,
    p = {
        getActiveErrors: () => {
            ...
            if (null == e || e.state === _.XYD.PAUSED || 0 === a.A.getViewerIds(e).length) return null;
            let t = (0, i._z)(e),
            ...
            let m = (0, d.xA)(o, e.ownerId);
            if (null == m) return null;
            let g = (0, l.wz)(h);
            return null == g
                ? null
                : m.short.frameRate < (0, d.s1)(g.maxFrameRate) || m.long.frameRate < (0, d.s1)(g.maxFrameRate)
