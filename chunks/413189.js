...
function O(e) {
    ...
    null == w)
        ? null
        : ((I = H
              ? x.intl.format(x.t.z847Tk, { wallpaper_name: null != (n = null == M ? void 0 : M.label) ? n : x.intl.string(x.t['UQMV/P']) })
              : x.intl.format(x.t['+lKndX'], {
                    username: null == L ? void 0 : L.nick,
                    wallpaper_name: null != (O = null == M ? void 0 : M.label) ? O : x.intl.string(x.t['UQMV/P'])
                })),
          Z
              ? D || R
                  ? z && B
                      ? (S = x.intl.formatToPlainString(x.t.PzTpVV, { wallpaperName: null != (j = null == M ? void 0 : M.label) ? j : x.intl.string(x.t['UQMV/P']) }))
                      : H ||
                        V ||
                        !B ||
                        (S = x.intl.format(x.t.JwUhHh, {
                            onClickNitro: () => {
                                (0, d.uL)(y.Z5c.NITRO_HOME);
                            }
                        }))
                  : (S = x.intl.format(x.t.dBxFsL, { learnMoreLink: m.Z.getArticleURL(y.BhN.DM_WALLPAPERS) }))
              : (S = x.intl.string(x.t['6JSOu7'])),
              ...
              (T = (0, r.jsx)(a.zx, {
                  ...
                  onClick: () => {
                      h.X(P, w, {
                          shouldClear: !z,
                          onError: () => {
                              (0, o.showToast)((0, o.createToast)(x.intl.string(x.t.F8FvU1), o.ToastType.FAILURE));
                          }
                      });
                  },
                  submitting: k,
                  children: x.intl.string(z ? x.t.o6850d : x.t['/ubFp6'])
              })),
          (0, r.jsx)(E.Z, {
              channel: P,
              content: I,
