"use strict";
n.d(t, { $u: () => S, IA: () => A, ID: () => y, Tk: () => g, Z$: () => C, rf: () => I });
var i = n(228366),
    r = n(95561),
    s = n(976860),
    a = n(734057),
    ...
    m = n(746080);
function g(e, t) {
    h.default.track(E.HAw.VIEW_AS_ROLES_SELECTED, {
        num_roles: Object.keys(t.roles).length,
        ...(0, r.H$)(e),
        is_viewing_as_member: t.type === p._.NEW_MEMBER,
    }),
...
function A(e, t) {
    ...
    null != n &&
        ...
        (h.default.track(E.HAw.VIEW_AS_ROLES_SELECTED, {
            ...
            ...(0, r.H$)(e),
            is_viewing_as_member: n.type === p._.NEW_MEMBER,
        }),
...
function T(e) {
    let t = d.A.getChannelId(e),
        n = a.A.getChannel(t);
    if (!(null != t && (0, m.jq)(t)) && !c.A.can(E.xBc.VIEW_CHANNEL, n)) {
        let t = o.Ay.getDefaultChannel(e);
        null != t && (0, s.pX)(E.BVt.CHANNEL(e, t.id));
    }
}
function S(e, t, n) {
    let i = new Set(_.Ay.getOptedInChannels(e));
    t.forEach((e) => i.add(e)), n.forEach((e) => i.delete(e)), A(e, { type: p._.NEW_MEMBER, optInChannels: i });
}
function y(e, t) {
    let n, i;
    ...
    let r = {};
    for (let n of u.A.getManyRoles(e, t)) r[n.id] = n;
    A(e, { type: p._.NEW_MEMBER, roles: r });
}
function C(e, t) {
    A(e, { type: p._.NEW_MEMBER, ...t });
}
