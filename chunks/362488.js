...
let r = (0, n(600975).C)({
    ...
    defaultConfig: { logSkipped: !1, logPostSkipped: !1 },
    treatments: [
        { id: 1, label: "Fully Enabled", config: { logSkipped: !0, logPostSkipped: !0 } },
        { id: 2, label: "Don't log post-skipped", config: { logSkipped: !0, logPostSkipped: !1 } },
    ],
});
function i() {
