...
function eO() {
    let e = c.useMemo(
        () => [
            ...
            { Icon: eA.ShieldIcon, label: el.intl.string(es.default.s0N1nM) },
            { Icon: eN.Q, label: el.intl.string(es.default.NzrGEi) },
        ],
        [],
    );
    return (0, o.jsxs)("section", {
    ...
    eV = c.forwardRef(function (e, t) {
        ...
        return (0, o.jsx)(eF.m, {
            ...
            children: (0, o.jsx)(eH.D, {
                ...
                "aria-label": s,
                "aria-disabled": d,
                className: u()(n, eG.x6, l, a, { [eG.r9]: d }),
                onMouseDown: r,
                onClick: (e) => {
                    c(e);
                },
    ...
    let { server: t, onOpenSettings: n } = e,
        ...
        l = (0, M.bG)(
            ...
            () =>
                (0, e2.Yg)({
                    subscriptionId: s,
                    hasFetchedSubscriptions: V.A.hasFetchedSubscriptions(),
                    getSubscriptionById: (e) => V.A.getSubscriptionById(e),
                }),
            [s],
        ),
...
var e3 = n(652215),
    ...
    e8 = n(49999),
    e9 = n(684644);
let e7 = [eD.M.STARTUP_FAILED, eD.M.MISSING_STOCK, eD.M.PROVIDER_ERRORED, eD.M.DELETED];
function te(e) {
...
let ts = c.memo(function (e) {
    let { server: t, onJoin: s, onViewPanel: l, onOpenSettings: a, isHighlighted: i = !1 } = e,
        ...
        _ = (0, eQ.A)(t.instance.providerType, t.instance.gameServerPanelUrl) ?? e6.qb[E],
        A = null != t.instance.gameServerPanelUrl,
        N = null != t.instance.status && e7.includes(t.instance.status),
        I = c.useCallback(() => {
            (0, K.h)({ href: _ });
        }, [_]),
        L = c.useMemo(() => {
        ...
        O = t.isOnline ? "text-feedback-positive" : N ? "text-feedback-critical" : "text-muted",
        T = c.useMemo(
            () =>
                (0, o.jsx)(eH.D, {
        ...
        R = c.useMemo(
            () =>
                (0, o.jsxs)(eH.D, {
                    className: u()(e9.wC, e9.y2, { [e9.Gz]: !A }),
                    onClick: A ? S : void 0,
                    "aria-disabled": !A,
        ...
        k = c.useMemo(() => {
            switch (t.instance.status) {
                case eD.M.SLEEPING:
                    return (0, o.jsxs)(o.Fragment, { children: [(0, o.jsx)(tt, { gameServerId: t.id }), R] });
                case eD.M.STARTUP_FAILED:
                case eD.M.MISSING_STOCK:
                    return (0, o.jsx)("div", {
                        className: e9.y7,
        ...
        }, [t.instance.status, t.id, A, T, R, S, I]);
    return (0, o.jsxs)("div", {
        id: te(t.id),
...
function tg(e) {
    ...
    return (0, o.jsx)(w.A, { children: (0, o.jsx)(th, { isGameServerHostingInShopEnabled: t }) });
}
function th(e) {
    let { isGameServerHostingInShopEnabled: t } = e,
        n = (0, k.zy)(),
    ...
    let E = c.useCallback(() => {
        ...
        S = (0, to.O)((e) => e.highlightFirstCardNonce),
        b = c.useRef(S);
    c.useEffect(() => {
    ...
    c.useEffect(() => {
        if (!t || null == N || g || 0 === d.length) return;
        let e = d.find((e) => e.gameId === N);
        if (null == e) return;
        A(e, ti.cl.ACTIVITY_PANEL_DEEP_LINK);
        let l = new URLSearchParams(n.search);
        l.delete(tu.tD), s.replace(`${n.pathname}?${l.toString()}`);
    }, [t, N, d, g, A, s, n.pathname, n.search]);
    let I = c.useCallback(() => {
            F.A.setState({ scrollToGameServers: !0 }), (0, U.openUserSettings)(G.X.SUBSCRIPTIONS_PANEL);
        }, []),
        L = c.useCallback((e) => {
                ...
                (0, o.jsxs)("div", {
                    ...
                    children: [
                        ...
                        u || m
                            ...
                            : (0, o.jsx)(eS, { games: d, title: R, onSelectGame: A, loading: g }),
                    ],
                }),
            ],
        }),
...
function tk() {
    let { itemTypeFilters: e, searchQuery: t, thirdPartyOnly: n, offerEligible: s } = (0, R.v)((e) => e),
        { totalCount: l, isFetchingResults: a } = (0, tv.S)(),
        ...
        r = c.useCallback(() => {
            ...
            if (!n && !s && 1 === e.size) {
                if (e.has(tR.q.AVATAR_DECORATION)) return el.intl.format(el.t.s1UzGQ, { count: l });
                if (e.has(tR.q.NAMEPLATE)) return el.intl.format(el.t.ZWGN9T, { count: l });
                if (e.has(tR.q.PROFILE_EFFECT)) return el.intl.format(el.t["v/7apu"], { count: l });
                if (e.has(tR.q.PROFILE_FRAME)) return el.intl.format(el.t.eu4eRy, { count: l });
                if (e.has(tR.q.BUNDLE)) return el.intl.format(el.t.fZ1rdk, { count: l });
            }
            return 0 === e.size && n && !s
        ...
        children: Array.from({ length: 3 }).map((e, t) =>
            (0, o.jsxs)(
                "div",
                {
                    className: tG.vY,
                    children: [
                        (0, o.jsx)("div", { className: u()(tF.sW, tU.s) }),
                        Array.from({ length: 12 }, (e, t) => (0, o.jsx)(tw.A, {}, t)),
                    ],
                },
                t,
            ),
    ...
    return null == n || 0 === l.length
        ...
        : (0, o.jsx)("div", {
              ...
              children: l.map((e, t) =>
                  (0, o.jsx)(
                      A.R9,
                      { newValue: { tilePosition: t }, children: (0, o.jsx)(tV.A, { skuId: e.skuId }, e.skuId) },
                      e.skuId,
                  ),
              ),
          });
...
function tq(e) {
    let { category: t } = e,
        ...
        a = (0, k.W6)(),
        i = (0, tp.a)("CollectiblesCatalogContent"),
        r = (0, A.uM)(),
        d = c.useCallback(() => {
    ...
    return (0, o.jsxs)("div", {
        className: tG.EF,
        ref: l,
        children: [(0, o.jsx)(tH.A, { category: t, onSelect: i ? d : void 0 }), (0, o.jsx)(t$, { category: t })],
    });
}
function tZ(e) {
    ...
    c.useEffect(() => {
        ...
        if (-1 === e) return;
        let t = Math.floor(e / tu.l5) + 1;
        t !== s && l(t), (h.current = a);
    }, [a, g, l, s]);
    let x = c.useMemo(() => {
        let e = (s - 1) * tu.l5;
        return g.slice(e, e + tu.l5);
    }, [g, s]);
    return (c.useEffect(() => {
        (0, tB.z)({
            sessionId: d,
...
let t2 = function () {
    let { sort: e, onSetSort: t, hasRelevanceFilters: n } = (0, R.v)(),
        ...
        a = n(),
        i = c.useMemo(() => tu.QB.filter((e) => e.sortType !== tJ.$.RELEVANCE || a), [a]),
        r = c.useCallback((e) => {
...
function nE() {
    let {
        ...
        x = c.useRef(null),
        E = (0, tT.A)(),
        f = c.useMemo(() => tu._6.filter((e) => g || e !== tR.q.PROFILE_FRAME), [g]),
        p = c.useCallback(
            (e) => {
                tb.default.track(e3.HAw.COLLECTIBLES_SHOP_ELEMENT_CLICKED, {
        ...
        children: [
            (0, o.jsxs)("div", {
                ...
                children: [
                    ...
                    f.map((e) => (0, o.jsx)(nf, { filter: e, trackFilterAction: p }, e)),
                    (0, o.jsx)(t6.S, {
                        checked: t,
                        onChange: () => {
                    ...
                    d && (0, o.jsx)(t6.S, { checked: s, onChange: v, label: el.intl.string(el.t["+W8gb+"]) }),
                ],
            }),
            (0, o.jsx)(np, { trackFilterAction: p }),
            (0, o.jsx)(nj, { trackFilterAction: p }),
            m &&
                (0, o.jsx)(Q.$, {
                    variant: "secondary",
                    onClick: () => {
...
function nf(e) {
    let { filter: t, trackFilterAction: n } = e,
        s = {
            [tR.q.AVATAR_DECORATION]: el.intl.string(el.t.dRZYNE),
            [tR.q.PROFILE_EFFECT]: el.intl.string(el.t["1cNjtx"]),
            [tR.q.NAMEPLATE]: el.intl.string(el.t.V68Fqz),
            [tR.q.PROFILE_FRAME]: el.intl.string(el.t.ecTJkR),
            [tR.q.BUNDLE]: el.intl.string(el.t.FYFpps),
        },
    ...
    return t === tR.q.PROFILE_FRAME
        ? (0, o.jsxs)("div", { className: nx.Ym, children: [i, (0, o.jsx)(t8.E, { type: "new" })] })
        : i;
}
function np(e) {
    ...
    return (0, o.jsxs)("div", {
        className: nx.KZ,
        children: [
            (0, o.jsx)(X.E, { variant: "text-md/semibold", className: nx.hr, children: el.intl.string(el.t.K1xGoG) }),
...
function nj(e) {
    ...
    return (0, o.jsxs)("div", {
        className: nx.KZ,
        children: [
            (0, o.jsx)(X.E, { variant: "text-md/semibold", className: nx.hr, children: el.intl.string(el.t.t1Ztrp) }),
            (0, o.jsx)("div", {
                className: nx.Ot,
                children: r.map((e) => {
...
function nI(e) {
    let { isFetchingCategories: t, scrollerRef: n, tab: s } = e,
        ...
        { skus: m, currentPage: h, totalCount: x, isFetchingResults: E } = (0, tv.S)(),
        f = (0, g.yK)([N.A], () => N.A.getProductsBySkus(m)),
        p = c.useCallback(() => {
    ...
    return (0, o.jsxs)(nS.v3.Provider, {
        value: nN,
        children: [
            (0, o.jsxs)("div", {
                className: u()({ [nA.oE]: y }),
                children: [
                    y && (0, o.jsx)(n_, {}),
                    (0, o.jsxs)("div", {
                        className: u()(nA.ZE, { [nA.Kp]: O }),
                        ref: S,
                        children: [
                            k && [...Array(L)].map((e, t) => (0, o.jsx)(tw.A, {}, t)),
                            !k &&
                                j.map((e, t) =>
...
function nO(e) {
    ...
    !(function () {
        let e = (0, M.bG)([tO.A], () => "success" === tO.A.getFetchState(e3.FYj)),
            t = null != (0, tT.A)(),
        ...
        (0, R.S)(i);
    let r = c.useRef(null),
        { handleScroll: d } = tA(r, t),
        u = (0, tx.U)("Shop Browse"),
        ...
        (0, o.jsx)("div", {
            ...
            children: (0, o.jsxs)("main", {
                ...
                children: [
                    (0, o.jsx)(B.Gt, {
                        ...
                        children: u
                            ? (0, o.jsx)("div", {
                                  ...
                                  children: (0, o.jsx)("div", {
                                      className: nL.pf,
                                      children: (0, o.jsx)(tI.Z_, { tenantId: e3.FYj, templateId: tL.b.BACK_CATALOG }),
                                  }),
                              })
                            : (0, o.jsx)(nT, {
                                  isSmallScreen: E,
                    ...
                    h && !E && (0, o.jsx)("div", { className: nL.yF }),
                    h && !E && (0, o.jsx)(tC.Ip, { className: nL.kT, children: (0, o.jsx)(nE, {}) }),
                ],
            }),
        })
    );
            ...
            children: (0, o.jsxs)("div", {
                ...
                children: [
                    (0, o.jsxs)("div", {
                        className: nL.ne,
                        children: [
                            (0, o.jsx)("div", { className: nL.lQ, children: (0, o.jsx)(tk, {}) }),
                            (0, o.jsxs)("div", {
                            ...
                            n &&
                                ...
                                (0, o.jsx)("div", {
                                    className: nL.Dh,
                                    ref: m,
                                    children: (0, o.jsx)(B.Ch, { className: nL.Qo, children: (0, o.jsx)(nE, {}) }),
                                }),
                        ],
                    }),
                    g
                      ...
                      A.R9,
                      {
                          ...
                          children: (0, o.jsx)(
                              nq.S,
                              {
                                  subblock: e,
                                  enablePreview: 0 === n,
                                  badgeText: (0, n$.HF)(e.unpublishedAt) ? el.intl.string(el.t["h/uBCR"]) : void 0,
                                  handleTransition: t,
                              },
            ...
            children: [
                null != s &&
                    (0, o.jsx)(nq.S, {
                        category: s,
                        enablePreview: !0,
                        badgeText: (0, n$.HF)(s.unpublishedAt) ? el.intl.string(el.t["h/uBCR"]) : void 0,
                        handleTransition: t,
                    }),
                null != l &&
                    (0, o.jsx)(nq.S, {
                        category: l,
                        badgeText: (0, n$.HF)(l.unpublishedAt) ? el.intl.string(el.t["h/uBCR"]) : void 0,
                        handleTransition: t,
                    }),
            ],
        }),
                ...
                t &&
                    (0, o.jsx)(eF.m, {
                        ...
                        children: (0, o.jsx)(eH.D, {
                            ...
                            className: sn.s,
                            children: (0, o.jsx)(n7.CircleInformationIcon, { size: "sm" }),
                        }),
                    }),
            ],
        });
        ...
        let {
            ...
            h = (0, t1.yB)("FeedBlock"),
            {
                ...
                let { sortedSkuIds: t, hasShopDiscount: n, orbsSupportedOnly: s } = e,
                    l = (0, M.bG)([n6.A], () => n6.A.hasConsented(e3.YAq.PERSONALIZATION)),
                    a = c.useMemo(() => t?.[n3.RECOMMENDED] ?? [], [t]),
                    i = c.useMemo(() => t?.[n3.POPULAR] ?? [], [t]),
                    r = a.length > 0 && l,
                    [o, d] = c.useState(r ? n3.RECOMMENDED : n3.POPULAR),
                    u = (0, M.bG)([N.A], () => N.A.productsWithVariantsAsGroup),
                    m = c.useMemo(() => (0, n$.CE)(u), [u]),
                    g = (0, n8.A)(),
                    h = (0, tP.p)(),
                    [x, E] = c.useState([]),
                    f = c.useCallback(() => {
                        d(n3.RANDOM), E(n5().shuffle(m));
                    }, [m]);
                c.useEffect(() => {
                    E(n5().shuffle(m));
                }, [m]);
                  ...
                  children: (0, o.jsxs)("div", {
                      ...
                      children: [
                          (0, o.jsxs)("div", {
                              className: nZ.$6,
                              children: [
                                  (0, o.jsx)(ss, { label: n, personalizedResults: j }),
                                  (0, o.jsxs)("div", {
                                  ...
                                  (0, o.jsx)(nG.A, {
                                      "aria-live": "polite",
                                      role: "status",
                                      children: B && L === n4.FINISHED ? el.intl.string(el.t["3Pml0e"]) : "",
                                  }),
                              ],
                          }),
                          (0, o.jsx)("div", {
                              ...
                              children: t
                                  ? (0, o.jsx)(o.Fragment, {
                                        children: [...Array(12)].map((e, t) => (0, o.jsx)(tw.A, {}, t + 1)),
                                    })
                                  : f.slice(0, l).map((e, t) => {
                                        let n,
                                        ...
                                        if (I)
                                            if (L === n4.SHUFFLE_OUT)
                                                return (0, o.jsx)(
                                                    ...
                                                    {
                                                        className: nZ.Z2,
                                                        children: (0, o.jsx)(tw.A, { skipPulseAnimation: !0 }),
                                                    },
                                                    `${e.skuId}-${t}`,
                                                );
                                            else
        ...
        g = c.useCallback(
            (e) => {
                e?.stopPropagation(),
                    ...
                    (0, sr.pX)(e3.BVt.COLLECTIBLES_SHOP_WITH_TAB(tu.G2.GAME_SERVERS));
            },
            [m],
        ),
        h = c.useCallback(
            (e) => {
                e?.stopPropagation(),
                    ...
                    d(!0),
                    !0 === t.isDismissible &&
                        (0, ny.d6)(eB.M.COLLECTIBLES_SHOP_GAME_SERVER_HOSTING_BANNER, {
                            dismissAction: e8.i.USER_DISMISS,
                        });
            },
            [m, t.isDismissible],
        ),
...
function sN(e, t) {
    let n = c.useMemo(() => e?.products.filter((e) => e.skuId !== t).map((e) => e.skuId) ?? [], [e?.products, t]),
        s = (0, M.bG)([tf.A], () => tf.A.getPurchases(n));
    return {
...
let sO = c.memo(function (e) {
        let { category: t, rewardSkuId: n } = e,
            ...
            m = (0, M.bG)([tf.A], () => tf.A.isClaiming === n);
        return (0, o.jsx)(sa.L, {
            onChange: s,
            threshold: 0,
            innerRef: l,
                                            ...
                                            children: [
                                                ...
                                                (0, o.jsx)(eF.m, {
                                                    ...
                                                    children: (0, o.jsx)("span", {
                                                        className: sL.ZB,
                                                        children: (0, o.jsx)(sp.CircleQuestionIcon, { size: "xs" }),
                                                    }),
                                                }),
                                            ],
                                        }),
    ...
    sT = function (e) {
        let t,
            ...
            r = (0, nS.Mk)(i),
            d = c.useMemo(() => N.A.getCategoryForProduct(a.rewardSkuId), [a.rewardSkuId]),
            u = (0, M.bG)([tf.A], () => tf.A.getPurchase(a.rewardSkuId)),
            { products: m } =
                ((t = (0, n8.A)()),
                (n = c.useMemo(
            ...
            g = c.useMemo(
                () =>
                    ...
                    !(m.length > 0) &&
                    a.rankedSkuIds.every((e) => N.A.getProduct(e)?.variantGroupStoreListingId != null),
        ...
        return (0, o.jsx)(sE.A, {
            ...
            children: h
                ? (0, o.jsx)(o.Fragment, {
                      children: [void 0, void 0, void 0, void 0, void 0].map((e, t) => (0, o.jsx)(tw.A, {}, t)),
                  })
                : (0, o.jsxs)(o.Fragment, {
                      children: [
                          E &&
                              ...
                              return null == e || null == n
                                  ...
                                  : (0, o.jsx)(
                                        A.R9,
                                        {
                                            ...
                                            children: (0, o.jsx)(tV.A, { skuId: e.skuId, prioritizedCurrency: r }),
                                        },
                                        e.skuId,
                                    );
                          }),
                      ...
                      children: [
                          ...
                          (0, o.jsxs)("div", {
                              ...
                              children: [
                                  ...
                                  (0, o.jsx)(sT, { isBlockLoading: t, heroBlock: n, tab: s }),
                              ],
                          }),
                      ],
                  }),
...
let sM = function (e) {
    let { shelf: t, handleTransition: n, tab: s } = e,
        ...
        a = (0, nS.Mk)(s),
        i = (0, M.bG)([N.A], () => (null != t.categorySkuId ? N.A.getCategory(t.categorySkuId) : void 0)),
        r = (0, n8.A)(),
        ...
        h = c.useCallback(() => {
            n({
                ...
                isOrbsExclusive: i?.isOrbsExclusive === !0 && s !== tu.G2.ORBS,
            });
    ...
    return (0, o.jsx)(p.f5, {
        ...
        children: (0, o.jsxs)("div", {
            ...
            children: [
                v && (0, o.jsx)("img", { className: sy.iL, src: f, alt: "", "aria-hidden": !0 }),
                (0, o.jsxs)("div", {
                    className: sy.Qs,
                    children: [
                        (0, o.jsxs)("div", {
                                ...
                                null == N.A.getCategoryForProduct(e.skuId)
                                    ...
                                    : (0, o.jsx)(
                                          A.R9,
                                          {
                                              ...
                                              children: (0, o.jsx)(tV.A, { skuId: e.skuId, prioritizedCurrency: a }),
                                          },
                                          e.skuId,
                                      ),
                            ),
            ...
            [d] = c.useState(() =>
                [...sK]
                    ...
                    .map((e) => ({
                        ...
                        transitionDuration: `${tu.H1 - 200 * Math.random()}ms`,
                    })),
            );
        return (
            c.useEffect(() => {
            ...
            c.useEffect(() => {
                n && setTimeout(() => a(!0), tu.H1);
            }, [n]),
            (0, o.jsx)("div", {
                className: u()(sV.rA, { [sV.Kb]: t, [sV.pp]: l }),
                children: i.map((e, t) => {
                    let { config: s, baseLeft: l } = e;
                    return (0, o.jsx)(sY, { config: s, baseLeft: l, transitioning: n }, s.skuId + t);
                }),
            })
        );
    },
    s$ = function (e) {
        ...
        return (
            ...
            (0, o.jsx)("div", {
                ref: s,
                className: sV.eL,
                children: (0, o.jsx)(sW, { peaking: t, transitioning: n, parentWidth: l }),
            })
        );
    };
var sq = n(815021);
let sZ = function (e) {
        ...
        let g = s?.skuId ?? "",
            ...
            j = c.useCallback(() => {
                if ((m(!0), t.isDismissible)) {
                    ...
                    (0, ny.$l)(eB.M.COLLECTIBLES_SHOP_WIDE_BANNER, e, { dismissAction: e8.i.USER_DISMISS });
                }
        ...
        let _ = u()(nZ.nM, nZ.Tq, nZ.TS, nZ.YB, { [nZ._1]: f, [nZ.vb]: p }),
            I = (0, o.jsxs)(o.Fragment, {
                children: [
                    ...
                    (0, o.jsx)("div", {
                        className: u()(nZ.zK, { [nZ._1]: f }),
                        style: null != i ? { height: `${i}px` } : void 0,
                        children: (0, o.jsx)("img", {
                            ref: a,
                            src: E,
                            alt: t.title,
                            className: u()(nZ.LN, { [nZ.d5]: f }),
                        }),
                    }),
                    (0, o.jsx)("div", {
                                ...
                                v &&
                                    (0, o.jsxs)("div", {
                                        ...
                                        children: [
                                            ...
                                            C && (0, o.jsx)("img", { src: t.logoURL, alt: "", className: nZ.bU }),
                                        ],
                                    }),
                            ],
                        }),
    ...
    sX = (e) => {
        ...
        null != E)
            ? (0, o.jsx)(nR.h, { onRetry: v, errorOrigin: nR.A.SHOP_PAGE, errorMessage: E.message })
            : x || 0 === f.length
              ? (0, o.jsxs)("div", {
                    ...
                    children: [
                        ...
                        (0, o.jsx)(sl, {
                            isLoading: x,
                            title: l === tu.G2.ORBS ? el.intl.string(el.t.dFgeuZ) : el.intl.string(el.t.NSv5KV),
                            numVisibleItems: n,
                            tab: l,
                        }),
                    ],
                        ...
                        (function (e, a, i) {
                            ...
                            switch (e.type) {
                                ...
                                case nk.g.FEED:
                                    ...
                                    c = (0, o.jsx)(
                                        sl,
                                        {
                                            ...
                                            tab: l,
                                            orbsSupportedOnly: l === tu.G2.ORBS,
                                        },
                                        i,
                                    );
                                    break;
                                case nk.g.WIDE_BANNER:
                                    if (e.isDismissible) {
                                        let t = e.dismissibleContentVersion ?? 0,
                                            { isDismissed: n } = (0, ny.En)(eB.M.COLLECTIBLES_SHOP_WIDE_BANNER, t);
                                        if (n) return null;
                                    }
                                ...
                                case nk.g.COUNTDOWN_TIMER:
                                    (c = (0, o.jsx)(nY, { countdownTimerBlock: e, isVisible: r }, i)), (m = !0);
                                    break;
                                ...
                                case nk.g.GAME_SERVER_HOSTING_BANNER:
                                    if (
                                        !h ||
                                        (!0 === e.isDismissible &&
                                            (0, ny.En)(eB.M.COLLECTIBLES_SHOP_GAME_SERVER_HOSTING_BANNER).isDismissed)
                                    )
                                        return null;
                                    return (0, o.jsx)(
                                        nP,
    ...
    sQ = function (e) {
        let { handleTransition: t, tab: n, transitionState: s } = e,
            l = c.useRef(null),
            { handleScroll: a } = tA(l, n),
            i = (0, tK.U)(),
            r = (0, A.uM)(),
            [d, u] = c.useState(tu.md),
            [m, g] = c.useState(!1);
        return (
            c.useEffect(() => {
                if (null != l.current) {
            ...
            (0, o.jsx)(B.Ch, {
                ...
                children: (0, o.jsxs)("div", {
                    ...
                    children: [
                                                ...
                                                onClick: () => {
                                                    t({ sourceButton: "shop all button", shouldAnimate: !0 }),
                                                        tb.default.track(e3.HAw.COLLECTIBLES_SHOP_ELEMENT_CLICKED, {
                                                            collectibles_shop_session_id: r?.sessionId,
                                                            page_type: n,
                                                            page_category: n === tu.G2.HOME ? void 0 : r?.pageCategory,
                        ...
                        (0, o.jsx)(s$, { peaking: m, transitioning: s === tu.Pf.OUT }),
                    ],
                }),
            })
        );
...
function s8(e) {
    let { tab: t } = e,
        [n, s, l] = (0, M.yK)([s1.A], () => [s1.A.getLayout(t), s1.A.isFetchingLayout(t), s1.A.getLayoutFetchError(t)]),
        a = (0, M.bG)([sJ.A], () => sJ.A.get("shop_include_unpublished")),
        i = (0, M.bG)([N.A], () => N.A.skipNumCategories),
        r = c.useMemo(() => {
            let e = {};
    ...
    if (
        ...
        return t !== y.HOME || d || s
            ...
            : (0, o.jsx)(tI.Z_, {
                  tenantId: e3.FYj,
                  templateId: tL.b.SHOP_HOME,
                  requestParams: r,
                  overrides: s2[tL.b.SHOP_HOME],
              });
    let u = (0, o.jsx)(tI.Qs, { tenantId: e3.FYj, layoutId: n, overrides: s5[n] });
    return (0, o.jsxs)(o.Fragment, {
        children: [
            t === y.ORBS && (0, o.jsx)(s3, {}),
            t === y.ORBS ? (0, o.jsx)(nS.v3.Provider, { value: s6, children: u }) : u,
        ],
    });
}
function s9(e) {
    ...
    null == n)
        ? null
        : (0, o.jsx)(tI.Ay, { layout: n });
}
let s7 = function (e) {
    let { handleTransition: t, tab: n, transitionState: s } = e,
        l = (0, A.uM)(),
        a = (0, M.bG)([s0.A], () => s0.A.getShopLayoutUrlOverride()),
        i = c.useRef(null),
        { handleScroll: r } = tA(i, n),
        [d, m] = c.useState(tu.md),
        [g, h] = c.useState(!1);
    return (
        c.useEffect(() => {
            if (null != i.current) {
            ...
            children: (0, o.jsxs)("div", {
                ...
                children: [
                    (0, o.jsxs)("div", {
                        ...
                        children: [
                            null != a && "" !== a ? (0, o.jsx)(s9, { url: a }) : (0, o.jsx)(s8, { tab: n }),
                            n !== y.CATALOG &&
                                d >= 36 &&
                                (0, o.jsxs)("div", {
                                    className: nZ.R$,
                    ...
                    (0, o.jsx)(s$, { peaking: g, transitioning: s === tu.Pf.OUT }),
                ],
            }),
        })
    );
...
function ls(e) {
    ...
    let d = (0, D.H)({ location: "collectibles_content" }),
        ...
        j = (0, tx.U)("CollectiblesContent"),
        S = (0, tp.a)("CollectiblesContent"),
        b = c.useCallback(
            (e) => {
                let {
                    sourceButton: t,
                ...
                let o = l && !u,
                    c = r ? tu.G2.ORBS : tu.G2.CATALOG;
                E(n), p(!i), s(c, o);
            },
            [u, s, a, S, m],
        ),
        { searchError: A } = (0, tv.S)();
    return null != A
        ? (0, o.jsx)(lt, {})
        : null != r
          ? (0, o.jsx)(nR.h, { onRetry: i, errorMessage: r, errorOrigin: nR.A.SHOP_PAGE })
          : t === tu.G2.HOME && j
            ? (0, o.jsx)(s7, { tab: y.HOME, transitionState: l, handleTransition: b })
            : t === tu.G2.ORBS && j
              ? (0, o.jsx)(s7, { tab: y.ORBS, transitionState: l, handleTransition: b })
              : ln.includes(t)
                ? (0, o.jsx)(sQ, { handleTransition: b, tab: t, transitionState: l })
                : t === tu.G2.GAME_SERVERS
                  ? d
                      ? (0, o.jsx)(tg, { isGameServerHostingInShopEnabled: d })
                      : (0, o.jsx)(k.rd, { to: e3.BVt.COLLECTIBLES_SHOP_WITH_TAB(tu.G2.HOME) })
                  : (0, o.jsx)(nO, {
                        tab: t,
                        categories: C,
...
let lc = function (e) {
    ...
    let l = (0, t1.yB)("CollectiblesShop"),
        ...
        d = c.useMemo(() => (t === tu.G2.HOME && null != i && r() ? i : t), [t, i, r]);
    (0, S.A)(e3.FYj);
    let { categories: y, refreshCategories: M } = (0, O.Ay)({ logPerf: !0 }, { sessionId: n, tab: d }),
        P = c.useMemo(() => [...y.values()], [y]),
        [D, B] = c.useState(),
        H = (0, g.bG)([N.A], () => N.A.getCategory(D)?.name),
        [w, F] = c.useState();
    (0, tX.XU)(n);
    let G = c.useCallback((e, t) => {
            F(e), B(t);
        }, []),
    ...
    let { dismissShopButtonDC: Y } = (0, li.A)();
    c.useEffect(() => {
        Y();
    }, [Y]),
        c.useEffect(() => {
        ...
        children: (0, o.jsx)(A.R9, {
            ...
            children: (0, o.jsx)(I.iM, {
                ...
                children: (0, o.jsx)(lo, {
                    ...
                    children: (0, o.jsxs)("div", {
                        className: u()(tG.bx, { [t1.jP]: l }),
                        ref: $,
                        inert: q,
                        tabIndex: -1,
                        children: [
                            (0, o.jsx)(ll.G, { handleTransition: K, selectedTab: z }),
                            (0, o.jsx)(la.A, { tab: z, handleTransition: K }),
                            (0, o.jsx)("div", {
                                className: u()(tG.td, {
                                    [tG.RK]: V === tu.Pf.VISIBLE,
                                    [tG.in]: V === tu.Pf.IN,
                                    [tG.FD]: V === tu.Pf.OUT,
                                }),
                                children: (0, o.jsx)(ls, {
