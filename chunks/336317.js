...
let i = (function () {
    ...
    function d(e, t) {
        for (var n, i, r = e.childNodes, a = r.length; a--; ) 3 === (i = (n = r[a]).nodeType) ? t.push(n) : 1 !== i || 'ownerSVGElement' in n || s.test(n.nodeName.toLowerCase()) || d(n, t);
        return t;
    }
    function f(e) {
    ...
    function _(e, t) {
        for (var i, r, a, s, o, u, c, _, p, h, m, g, E, v = d(e, []), y = v.length; y--; ) {
            for (a = !1, s = document.createDocumentFragment(), u = (o = v[y]).nodeValue, _ = 0; (c = n.exec(u)); ) {
                if (((p = c.index) !== _ && s.appendChild(l(u.slice(_, p), !0)), (g = f((m = c[0]))), (_ = p + m.length), (E = t.callback(g, t)), g && E)) {
                    for (r in (((h = new Image()).onerror = t.onerror), h.setAttribute('draggable', 'false'), (i = t.attributes(m, g)))) i.hasOwnProperty(r) && 0 !== r.indexOf('on') && !h.hasAttribute(r) && h.setAttribute(r, i[r]);
                    (h.className = t.className), (h.alt = m), (h.src = E), (a = !0), s.appendChild(h);
                }
                h || s.appendChild(l(m, !1)), (h = null);
            }
            a && (_ < u.length && s.appendChild(l(u.slice(_), !0)), o.parentNode.replaceChild(s, o));
        }
        return e;
    }
    function p(e, t) {
        return y(e, function (e) {
            var n,
                ...
                s = t.callback(a, t);
            if (a && s) {
                for (i in ((r = '<img '.concat('class="', t.className, '" ', 'draggable="false" ', 'alt="', e, '"', ' src="', s, '"')), (n = t.attributes(e, a)))) n.hasOwnProperty(i) && 0 !== i.indexOf('on') && -1 === r.indexOf(' ' + i + '=') && (r = r.concat(' ', i, '="', u(n[i]), '"'));
                r = r.concat('/>');
            }
            return r;
        });
