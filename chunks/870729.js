    ...
    let {
        ...
        q = i.useCallback(
            function (e) {
                ...
                return ((S.current = ea.pk.ARROW), s.scrollTo({ left: l[i], behavior: y }), !0);
            },
            [y, M, H, g, f],
        ),
        P = (function (e) {
...
function tN(e) {
    ...
    i.useEffect(() => {
        let e = l.current;
        (0, e7.vq)(e, HTMLVideoElement) && (a ? ((e.currentTime = 0), e.play().catch(tC.tE)) : e.pause());
    }, [a]);
    let { hoverSpring: c } = (0, e5.z)({ hoverSpring: +!!a, config: e8.config.gentle }),
        d = i.useCallback(() => {
            (0, eo._Q)(
...
function tp(e) {
    ...
    i.useEffect(() => {
        let e = u.current;
        (0, e7.vq)(e, HTMLVideoElement) && (c ? ((e.currentTime = 0), e.play().catch(tC.tE)) : e.pause());
    }, [c]);
    let E = i.useCallback(() => {
            (0, eo._Q)(
                { adContentId: t.id, adCreativeType: m.p.QUEST_HOME_HERO, cta: t.cta },
    ...
    let { topFade: j, bottomFade: C } = (0, e5.z)({
            topFade: +!!f.top,
            bottomFade: +!!f.bottom,
...
function tA(e) {
    let { heroId: t, quest: s, onQuestCtaClick: n, contentPosition: l } = e,
        ...
        { hoverSpring: R } = (0, e5.z)({ hoverSpring: +!!O, config: e8.config.gentle }),
        b = i.useCallback(() => {
            (n(s.id),
...
function sX(e) {
    let { quest: t, questContent: s, sourceQuestContent: n, isHovering: l } = e,
        ...
        S = (0, r.jsx)("div", { className: h === sf.UA.UNENROLLED ? sY.fm : sY.n5, children: C }),
            ...
            (0, r.jsx)(em.N, {
                ...
                children: (e) =>
                    (0, r.jsx)("div", {
                        ...
                        children: h === sf.UA.UNENROLLED ? S : N,
                    }),
            }),
            (0, r.jsxs)("div", {
...
function s6(e) {
    let {
        ...
        H = M === ef.NJ8.LIGHT,
        Q = i.useContext(eP.X),
        { visibilityElementRef: y, almostVisibleInViewport: U } = (0, s7.I)(
        ...
        V = (0, r.jsx)(s2.A, {
            ...
            children: (0, r.jsx)(eu.N, {
                imageAsset:
                    null != g
                        ? { asset: g, assetId: "QuestTileV2", alt: ew.intl.string(ew.t.jnijWz), className: s5.Tv }
                        : void 0,
                videoAsset:
                    null != v
                        ? {
                              ...
                              className: o()(s5.Tv, s5.gJ, { [s5.C7]: p }),
                          }
                        : void 0,
        ...
        G = A
            ...
            : (0, r.jsxs)(r.Fragment, {
                  children: [
                      V,
                      (0, r.jsx)("div", { className: o()(s5.sL, { [s5.Mq]: I }) }),
                      H
                          ? (0, r.jsx)(em.N, {
                                theme: ef.NJ8.ONYX,
                                disableAdaptiveTheme: !0,
                                children: (e) => (0, r.jsx)("div", { className: o()(e, s5.f5) }),
                            })
                          : (0, r.jsx)("div", { className: o()(s5.f5, { [s5.kg]: L }) }),
                      (0, r.jsxs)("div", {
                          className: s5.qy,
                          children: [
                              (0, r.jsxs)("div", {
...
let nQ = i.forwardRef(function (e, t) {
    let {
        ...
        [{ highlightAnimationProgress: C }, S] = (0, e5.z)(() => ({
                        ...
                        children: [
                            ...
                            (0, r.jsxs)("div", {
                                ...
                                children: [
                                    ...
                                    (0, r.jsx)(nS, { onChange: f, selectedFilters: E }),
                                ],
                            }),
                        ],
                    }),
...
let lE = {
    ...
    lf = i.forwardRef(function (e, t) {
        ...
        let [{ highlightAnimationProgress: T }, O] = (0, e5.z)(() => ({
                highlightAnimationProgress: 1,
                config: { duration: lh },
            })),
            I = i.useCallback(
...
let lj = (0, lx.v)((e, t) => ({
    ...
    registerAssetLoad: () => {
        ...
        if (s.info === tC.tE || t().elapsed >= 6e4) return;
