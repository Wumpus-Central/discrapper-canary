...
let h = new Set(['awaiting_browser_checkout', 'awaiting_browser_checkout_google_pay', 'awaiting_browser_checkout_apple_pay']),
    p = new Set(['credit_card_information', 'payment_request_information', 'paypal_information', 'venmo_information', 'cash_app_information', 'address', 'claim_free_sku', 'sku_preview', 'premium_upsell', 'przelewy24_information']);
function m(e) {
    switch (e) {
        case 'plan_select':
