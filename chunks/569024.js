...
async function U(e, t, n) {
        ...
        );
    {
        ...
        let l = { guildId: t, channelId: n, users: r.users, members: r.members, messages: r.messages };
...
async function G(e, t, n) {
    ...
    let s = v.A.getGuildId() ?? null,
        ...
        [[T, S], y, b, O, L, P, j] = await Promise.all([c, u, A, p, E, I, C]),
        M = performance.now() - d;
    if ((D.verbose(`cache loaded in ${M}ms (channel_history ${T}ms)`), null == S))
        return (
    ...
    return (
        ...
        N.A.setEarlyCacheInfo({ guilds: y.length }),
...
async function B(e, t) {
    ...
    let i = n;
    return { channels: await (0, s.kk)(() => g.A.getAsync(e, i)), guildId: n };
}
async function H(e, t, n, r) {
    D.verbose("loading late lazy cache");
    let [l, u, A] = await N.A.fetchLazyCache.measureAsync(() =>
            Promise.all([
                (0, s.kk)(() =>
                    null != e
    ...
    C.iQ.getCachedEnabled()
        ...
        : (D.verbose("loadLateLazyCache: yielding to react"), await (0, E.i)((0, b.isIOS)() ? 0 : void 0)),
    ...
    F(() => {
        ...
        N.A.deserializeCache.measure(() => {
            ...
            N.A.dispatchLazyCache.measure(() => a.h.dispatch(s)),
...
class Y extends r.Ay.Store {
    ...
    async loadCacheAsync(e, t) {
        ...
        try {
            ...
            r
                ? (n(), await H(i, t, l, s))
                : (n(), await (F(() => a.h.dispatch({ type: "CACHE_LOADED_LAZY_NO_CACHE" })), Promise.resolve()));
        } catch (e) {
