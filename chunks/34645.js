...
function ep(e) {
    let n,
        ...
        { hasAcceptedTerms: eK, setHasAcceptedTerms: eJ } = (0, L.P5)(),
        eQ = (0, o.bG)([F.A], () => F.A.popupCallbackCalled),
        e$ = (0, I.Y)(),
        eX = i.useMemo(
            () => (null != eg && eN && e$ ? (0, O.v)(eg, ez) : [{ planId: et.gD.PREMIUM_MONTH_GUILD, quantity: ez }]),
            [eg, eN, ez, e$],
        ),
        eZ = i.useMemo(() => (0, k.A)(), []),
        [e0, e8] = (0, _.A)(() => [eZ ?? (0, a.A)(), Date.now()]),
        { analyticsLocations: e5 } = (0, A.Ay)(ep, E.A.GUILD_BOOST_PURCHASE_MODAL),
        e9 = i.useMemo(
            () =>
                eX.find((e) => {
                    let { planId: n } = e;
    ...
    }, [e4, e2, nc, eG, eg, eh, nt]),
        (0, v.b)(e4, eG, e2, nr),
        (0, R.zT)(e4, ni, nr);
    let nu = i.useRef(null),
        [np, nd] = (0, S.A)(!1, 500),
        n_ = (0, x.D7)({ location: "GuildBoostPurchaseModal" }),
    ...
    i.useEffect(() => {
        ...
        e$ &&
            ...
            null == ev && null != eg && null != eg.paymentSourceId ? nS(eg.currency) : null != e && nS(e[0]));
    }, [ev, eg, e$, nb]);
    let ng = (0, G.Y)({
        paymentModalArgs: ek,
            ...
            switch (e4) {
                case R.pn.PLAN_SELECT:
                    s()(null != em, "Missing guildId"),
                        ...
                        nc && null != eg && null != eg.paymentGateway
                            ? (e = (0, l.jsxs)("div", {
                                  className: er.xK,
                                  children: [
                                      (0, l.jsx)(u.wx6, {
                ...
                case R.pn.AWAITING_AUTHENTICATION:
                    e = (0, l.jsx)(d.N, { className: er.__invalid_body });
                    break;
                case R.pn.REVIEW:
                    s()(null != eL, "Missing nextPremiumSubscriptionPlan"),
                        s()(null != em, "Missing guildId"),
                    ...
                    let m = async () => {
                        ...
                        try {
                            ...
                            if (null == eg || null == eC) {
                                ...
                                let i = { items: (0, K.aE)(eg, eX) };
                                (i.currency = eg.currency ?? t),
                            ...
                            null == eb && e2(R.pn.CONFIRM),
                                nr(j.h.COMPLETED),
                                null != em && (await ec(em, null != eb)),
                                null != eb && no(),
                                eS?.();
                        } catch (n) {
                            nr(j.h.FAIL),
...
function ed(e) {
    let n = (0, o.bG)([H.A], () => H.A.getPremiumTypeSubscription()),
        { analyticsLocations: t } = (0, A.Ay)(E.A.GUILD_BOOST_PURCHASE_MODAL);
    return (0, l.jsx)(A.f5, {
        value: t,
