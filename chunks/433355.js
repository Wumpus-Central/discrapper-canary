...
function L() {
    N && u.S.dispatch(g.CkL.SEARCH_RESULTS_CLOSE), A && (A = x(A)), (S = x(S));
}
function j() {
    S && (S = x(S)), (A = x(A));
}
function M() {
    C || u.S.dispatch(g.CkL.SEARCH_RESULTS_CLOSE), (C = x(C));
}
function k(e) {
...
class z extends (r = a.ZP.PersistedStore) {
    initialize(e) {
        if (null != e) {
            var t, n, r, i, a;
            (S = null != (t = e.isMembersOpen) && t),
                (A = null != (n = e.isSummariesOpen) && n),
                (C = null == (r = e.isProfileOpen) || r),
