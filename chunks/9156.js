...
let N = {},
    ...
    L = {
        [E.bL.ALL_MESSAGES]: T(S({}, x), { message_notifications: E.bL.ALL_MESSAGES }),
        [E.bL.ONLY_MENTIONS]: T(S({}, x), { message_notifications: E.bL.ONLY_MENTIONS })
    },
    M = {},
    k = {},
    j = 'null',
...
function F(e, t) {
    ...
    let r = N[e],
        ...
        s = T(S({}, Q(e), r, t), { channel_overrides: a });
    w.clearTimer(e),
        o().forEach(i, (e) => {
...
function W(e, t) {
    var n;
    let r = N[e];
    F(e, S({ channel_overrides: null !== (n = null == r ? void 0 : r.channel_overrides) && void 0 !== n ? n : {} }, t));
}
function Y(e, t, n) {
    let r = q(e, t, n);
    z(e, { [t]: r });
...
function K(e, t) {
    ...
    _.default.keys(t).forEach((n) => {
        var o;
        let a = q(e, n, t[n]);
        (r[n] = a), (i[n] = { flags: null !== (o = a.flags) && void 0 !== o ? o : 0 });
    }),
        null != e && (B[e] = S({}, B[e], i)),
        z(e, r);
}
function z(e, t) {
    ...
    let r = N[e],
        i = null !== (n = null == r ? void 0 : r.channel_overrides) && void 0 !== n ? n : {};
    F(e, { channel_overrides: null == r ? t : S({}, i, t) });
}
function q(e, t, n) {
    var r;
    let i = N[e];
    return S(
        ...
        (null !== (r = null == i ? void 0 : i.channel_overrides) && void 0 !== r ? r : {})[t],
        n
    );
}
function Q(e) {
...
function ei(e) {
    ...
    t.forEach((e) => {
        F(e.guild_id, S({ channel_overrides: {} }, e));
    });
}
function eo(e) {
...
function es(e) {
    ...
    null != t && null != r.flags && (B[t] = T(S({}, B[t]), { [n]: { flags: r.flags } })), Y(t, n, r);
}
function el(e) {
    let { guildId: t } = e;
    if (null == t) return !1;
        ...
        if ((this.waitFor(g.default, m.Z, c.Z, d.Z), null != e)) {
            ...
            (C = null !== (t = e.useNewNotifications) && void 0 !== t && t),
                'userGuildSettings' in e &&
                    ...
                    (k = o().mapValues(null !== (n = e.optedInChannelsByGuild) && void 0 !== n ? n : {}, (e) => new Set(e))),
                    o().forEach(N, (e, t) => {
                        M[t] = ef(e);
                    }));
        }
