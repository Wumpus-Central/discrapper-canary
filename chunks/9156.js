...
function q(e) {
    var t;
    return null !== (t = T[e]) && void 0 !== t ? t : K(e);
}
function Q(e) {
...
function X(e) {
    ee(e.notificationSettings), R.reset(), O.reset(), e.userGuildSettings.partial || ((T = {}), (L = {}), (P = {}));
    let t = new Set();
...
b(ef, 'displayName', 'UserGuildSettingsStore'), b(ef, 'persistKey', 'collapsedGuilds');
let e_ = new ef(o.Z, {
