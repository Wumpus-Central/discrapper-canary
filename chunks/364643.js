...
function m(e) {
    ...
    let L = n.isLink(m) && "override" === R,
        w = N && "action" === e.UNSTABLE_itemBehavior,
        M = n.isLink(m) && "selection" !== R && "none" !== R,
        P = !C && n.canSelectItem(m) && !L && !w,
        x = (N || M) && !C,
        ...
        Y = (e) => {
            ...
            M && I.current && O.open(I.current, e, H.href, H.routerOptions);
        },
        W = { ref: I };
    if (
        (T
