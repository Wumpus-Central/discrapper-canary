e.exports = function (e) {
    let t = "a-zA-Z_\\-!.?+*=<>&'",
        ...
        c = { scope: "punctuation", match: /,/, relevance: 0 },
        ...
        g = { keywords: i, className: "name", begin: n, relevance: 0, starts: m },
        E = [c, h, o, l, u, d, p, f, s, _, a];
    return (
        (h.contains = [
            {
                beginKeywords: r,
                ...
                contains: [{ className: "title", begin: n, relevance: 0, excludeEnd: !0, endsParent: !0 }].concat(E),
            },
            g,
            m,
        ]),
        (m.contains = E),
        (f.contains = E),
        { name: "Clojure", aliases: ["clj", "edn"], illegal: /\S/, contains: [c, h, o, l, u, d, p, f, s, _] }
    );
};
