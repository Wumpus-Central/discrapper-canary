!(function (t) {
    ...
    function g(e, t) {
        var n,
            ...
            d = e.constructor,
            _ = d.precision;
        if (!e.s || !t.s) return t.s || (t = new d(e)), a ? A(t, _) : t;
    ...
    (h.absoluteValue = h.abs =
        ...
        (h.times = h.mul =
            function (e) {
                ...
                for (; !o[--s]; ) o.pop();
                return t ? ++n : o.shift(), (e.d = o), (e.e = n), a ? A(e, p.precision) : e;
            }),
        (h.toDecimalPlaces = h.todp =
            function (e, t) {
                ...
                return ((n = new i(n)), void 0 === e)
                    ? n
                    : (E(e, 0, r), void 0 === t ? (t = i.rounding) : E(t, 0, 8), A(n, e + v(n) + 1, t));
            }),
        ...
        (h.toFixed = function (e, t) {
            ...
            return void 0 === e
                ...
                : (E(e, 0, r),
                  ...
                  (n = P((i = A(new o(a), e + v(a) + 1, t)).abs(), !1, e + v(i) + 1)),
        ...
        (h.toInteger = h.toint =
            function () {
                var e = this,
                    t = e.constructor;
                return A(new t(e), v(e) + 1, t.rounding);
            }),
        (h.toNumber = function () {
            return +this;
        }),
    ...
    var y = (function () {
        ...
        return function (r, i, a, s) {
            ...
            for (u = 0, c = r.e - i.e, N = x.length, T = D.length, g = (h = new R(w)).d = []; x[u] == (D[u] || 0); )
                ++u;
            if ((x[u] > (D[u] || 0) && --c, (O = null == a ? (a = R.precision) : s ? a + (v(r) - v(i)) + 1 : a) < 0))
                return new R(0);
            if (((O = (O / p + 2) | 0), (u = 0), 1 == N))
                for (d = 0, x = x[0], O++; (u < T || d) && O--; u++)
                    (S = d * f + (D[u] || 0)), (g[u] = (S / x) | 0), (d = (S % x) | 0);
            else {
                for (
                    (d = (f / (x[0] + 1)) | 0) > 1 && ((x = e(x, d)), (D = e(D, d)), (N = x.length), (T = D.length)),
                        I = N,
                        b = (E = D.slice(0, N)).length;
                    b < N;
                )
                    E[b++] = 0;
                (P = x.slice()).unshift(0), (C = x[0]), x[1] >= f / 2 && ++C;
                do
                    (d = 0),
                        (l = t(x, E, N, b)) < 0
                            ? ((y = E[0]),
                            ...
                            : 0 === l && (d++, (E = [0])),
                        (g[u++] = d),
                        l && E[0] ? (E[b++] = D[I] || 0) : ((E = [D[I]]), (b = 1));
                while ((I++ < T || void 0 !== E[0]) && O--);
            }
            return g[0] || g.shift(), (h.e = c), A(h, s ? a + v(h) + 1 : a);
        };
    })();
    function O(e, t) {
        var r,
        ...
        for (c += ((Math.log(u(2, f)) / Math.LN10) * 2 + 5) | 0, r = i = o = new p(n), p.precision = c; ; ) {
            if (
                ...
                return (p.precision = _), null == t ? ((a = !0), A(o, _)) : o;
            }
            o = s;
        }
    }
    ...
    function T(e, t) {
        ...
        for (
            ...
            if (((c = A(c.times(p), f)), b((d = u.plus(y(c, new E(s), f))).d).slice(0, f) === b(u.d).slice(0, f)))
                return (
                    (u = u.times(2)),
    ...
    function N(e, t) {
        var n,
            ...
            m = e.constructor,
            h = m.precision;
        if (!e.s || !t.s) return t.s ? (t.s = -t.s) : (t = new m(e)), a ? A(t, h) : t;
        ...
        for (; 0 === c[--l]; ) c.pop();
        for (; 0 === c[0]; c.shift()) --r;
        return c[0] ? ((t.d = c), (t.e = r), a ? A(t, h) : t) : new m(0);
    }
    function P(e, t, n) {
        var r,
            i = v(e),
    ...
    function w(e) {
        ...
        function i(e) {
            ...
            if ((45 === e.charCodeAt(0) ? ((e = e.slice(1)), (t.s = -1)) : (t.s = 1), d.test(e))) C(t, e);
