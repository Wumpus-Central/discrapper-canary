!(function (t) {
    ...
    function g(e, t) {
        ...
        if (((c = e.d), (u = t.d), (s = e.e), (i = t.e), (c = c.slice()), (o = s - i))) {
            for (o < 0 ? ((r = c), (o = -o), (l = u.length)) : ((r = u), (i = s), (l = c.length)), o > (l = (s = Math.ceil(p / f)) > l ? s + 1 : l + 1) && ((o = l), (r.length = 1)), r.reverse(); o--; ) r.push(0);
            r.reverse();
        }
        for ((l = c.length) - (o = u.length) < 0 && ((o = l), (r = u), (u = c), (c = r)), n = 0; o; ) (n = ((c[--o] = c[o] + u[o] + n) / _) | 0), (c[o] %= _);
    ...
    function b(e) {
        var t,
            ...
            o = e[0];
        if (i > 0) {
            for (a += o, t = 1; t < i; t++) (n = f - (r = e[t] + '').length) && (a += T(n)), (a += r);
            (n = f - (r = (o = e[t]) + '').length) && (a += T(n));
    ...
    (m.absoluteValue = m.abs =
        ...
        (m.logarithm = m.log =
            function (e) {
                ...
                return r.eq(n) ? new i(0) : ((a = !1), (t = y(S(r, l), S(e, l), l)), (a = !0), N(t, s));
            }),
        (m.minus = m.sub =
            function (e) {
                var t = this;
        ...
        (m.precision = m.sd =
            function (e) {
                ...
                if (((t = v(i) + 1), (n = (r = i.d.length - 1) * f + 1), (r = i.d[r]))) {
                    for (; r % 10 == 0; r /= 10) n--;
        ...
        (m.squareRoot = m.sqrt =
            function () {
                ...
                for (e = v(u), a = !1, 0 == (i = Math.sqrt(+u)) || i == 1 / 0 ? (((t = b(u.d)).length + e) % 2 == 0 && (t += '0'), (i = Math.sqrt(t)), (e = c((e + 1) / 2) - (e < 0 || e % 2)), (r = new d((t = i == 1 / 0 ? '1e' + e : (t = i.toExponential()).slice(0, t.indexOf('e') + 1) + e)))) : (r = new d(i.toString())), i = l = (n = d.precision) + 3; ; )
        ...
        (m.times = m.mul =
            function (e) {
                ...
                for (r = u; --r >= 0; ) {
                    for (t = 0, i = c + r; i > r; ) (l = o[i] + h[r] * p[i - r - 1] + t), (o[i--] = l % _ | 0), (t = (l / _) | 0);
                    o[i] = (o[i] + t) % _ | 0;
                }
                for (; !o[--s]; ) o.pop();
                return t ? ++n : o.shift(), (e.d = o), (e.e = n), a ? N(e, f.precision) : e;
            }),
        (m.toDecimalPlaces = m.todp =
            function (e, t) {
                var n = this,
                    i = n.constructor;
                return ((n = new i(n)), void 0 === e) ? n : (E(e, 0, r), void 0 === t ? (t = i.rounding) : E(t, 0, 8), N(n, e + v(n) + 1, t));
            }),
        ...
        (m.toFixed = function (e, t) {
            var n,
                ...
                a = this,
                o = a.constructor;
            return void 0 === e ? R(a) : (E(e, 0, r), void 0 === t ? (t = o.rounding) : E(t, 0, 8), (n = R((i = N(new o(a), e + v(a) + 1, t)).abs(), !1, e + v(i) + 1)), a.isneg() && !a.isZero() ? '-' + n : n);
        }),
        (m.toInteger = m.toint =
            function () {
                var e = this,
                    t = e.constructor;
                return N(new t(e), v(e) + 1, t.rounding);
            }),
        (m.toNumber = function () {
            return +this;
        }),
        (m.toPower = m.pow =
            function (e) {
                ...
                if (((u = (t = e.e) >= (r = e.d.length - 1)), (l = d.s), u)) {
                    if ((r = m < 0 ? -m : m) <= p) {
                        for (s = new _(n), t = Math.ceil(i / f + 4), a = !1; r % 2 && P((s = s.times(d)).d, t), 0 !== (r = c(r / 2)); ) P((d = d.times(d)).d, t);
                        return (a = !0), e.s < 0 ? new _(n).div(s) : N(s, i);
                    }
        ...
        (m.toPrecision = function (e, t) {
            var n,
                ...
                a = this,
                o = a.constructor;
            return void 0 === e ? ((n = v(a)), (i = R(a, n <= o.toExpNeg || n >= o.toExpPos))) : (E(e, 1, r), void 0 === t ? (t = o.rounding) : E(t, 0, 8), (n = v((a = N(new o(a), e, t)))), (i = R(a, e <= n || n <= o.toExpNeg, e))), i;
        }),
    ...
    var y = (function () {
        ...
        return function (r, i, a, s) {
            ...
            for (u = 0, c = r.e - i.e, C = L.length, S = D.length, g = (m = new P(w)).d = []; L[u] == (D[u] || 0); ) ++u;
            if ((L[u] > (D[u] || 0) && --c, (O = null == a ? (a = P.precision) : s ? a + (v(r) - v(i)) + 1 : a) < 0)) return new P(0);
            if (((O = (O / f + 2) | 0), (u = 0), 1 == C)) for (d = 0, L = L[0], O++; (u < S || d) && O--; u++) (I = d * _ + (D[u] || 0)), (g[u] = (I / L) | 0), (d = I % L | 0);
            else {
                for ((d = (_ / (L[0] + 1)) | 0) > 1 && ((L = e(L, d)), (D = e(D, d)), (C = L.length), (S = D.length)), T = C, b = (E = D.slice(0, C)).length; b < C; ) E[b++] = 0;
                (R = L.slice()).unshift(0), (A = L[0]), L[1] >= _ / 2 && ++A;
                do (d = 0), (l = t(L, E, C, b)) < 0 ? ((y = E[0]), C != b && (y = y * _ + (E[1] || 0)), (d = (y / A) | 0) > 1 ? (d >= _ && (d = _ - 1), (h = (p = e(L, d)).length), (b = E.length), 1 == (l = t(p, E, h, b)) && (d--, n(p, C < h ? R : L, h))) : (0 == d && (l = d = 1), (p = L.slice())), (h = p.length) < b && p.unshift(0), n(E, p, b), -1 == l && ((b = E.length), (l = t(L, E, C, b)) < 1 && (d++, n(E, C < b ? R : L, b))), (b = E.length)) : 0 === l && (d++, (E = [0])), (g[u++] = d), l && E[0] ? (E[b++] = D[T] || 0) : ((E = [D[T]]), (b = 1));
                while ((T++ < S || void 0 !== E[0]) && O--);
            }
            return g[0] || g.shift(), (m.e = c), N(m, s ? a + v(m) + 1 : a);
        };
    })();
    function O(e, t) {
        var r,
        ...
        for (null == t ? ((a = !1), (c = p)) : (c = t), s = new f(0.03125); e.abs().gte(0.1); ) (e = e.times(s)), (_ += 5);
        for (c += ((Math.log(u(2, _)) / Math.LN10) * 2 + 5) | 0, r = i = o = new f(n), f.precision = c; ; ) {
            if (((i = N(i.times(e), c)), (r = r.times(++d)), b((s = o.plus(y(i, r, c))).d).slice(0, c) === b(o.d).slice(0, c))) {
                for (; _--; ) o = N(o.times(o), c);
                return (f.precision = p), null == t ? ((a = !0), N(o, p)) : o;
            }
            o = s;
        }
    }
    ...
    function S(e, t) {
        ...
        if ((null == t ? ((a = !1), (_ = O)) : (_ = t), m.eq(10))) return null == t && (a = !0), I(E, _);
        if (((E.precision = _ += h), (i = (r = b(g)).charAt(0)), !(1500000000000000 > Math.abs((l = v(m)))))) return (d = I(E, _ + 2, O).times(l + '')), (m = S(new E(i + '.' + r.slice(1)), _ - h).plus(d)), (E.precision = O), null == t ? ((a = !0), N(m, O)) : m;
        for (; (i < 7 && 1 != i) || (1 == i && r.charAt(1) > 3); ) (i = (r = b((m = m.times(e)).d)).charAt(0)), p++;
        for (l = v(m), i > 1 ? ((m = new E('0.' + r)), l++) : (m = new E(i + '.' + r.slice(1))), u = c = m = y(m.minus(n), m.plus(n), _), f = N(m.times(m), _), s = 3; ; ) {
            if (((c = N(c.times(f), _)), b((d = u.plus(y(c, new E(s), _))).d).slice(0, _) === b(u.d).slice(0, _))) return (u = u.times(2)), 0 !== l && (u = u.plus(I(E, _ + 2, O).times(l + ''))), (u = y(u, new E(p), _)), (E.precision = O), null == t ? ((a = !0), N(u, O)) : u;
            (u = d), (s += 2);
        }
    }
    function A(e, t) {
        ...
        if ((t = t.slice(r, i))) {
            if (((i -= r), (e.e = c((n = n - r - 1) / f)), (e.d = []), (r = (n + 1) % f), n < 0 && (r += f), r < i)) {
    ...
    function N(e, t, n) {
        ...
        if ((r = t - s) < 0) (r += f), (i = t), (m = E[(g = 0)]);
        else {
            if ((g = Math.ceil((r + 1) / f)) >= (o = E.length)) return e;
            for (s = 1, m = o = E[g]; o >= 10; o /= 10) s++;
            (r %= f), (i = r - f + s);
        }
        if ((void 0 !== n && ((d = (m / (o = u(10, s - i - 1))) % 10 | 0), (p = t < 0 || void 0 !== E[g + 1] || m % o), (p = n < 4 ? (d || p) && (0 == n || n == (e.s < 0 ? 3 : 2)) : d > 5 || (5 == d && (4 == n || p || (6 == n && (r > 0 ? (i > 0 ? m / u(10, s - i) : 0) : E[g - 1]) % 10 & 1) || n == (e.s < 0 ? 8 : 7))))), t < 1 || !E[0])) return p ? ((o = v(e)), (E.length = 1), (t = t - o - 1), (E[0] = u(10, (f - (t % f)) % f)), (e.e = c(-t / f) || 0)) : ((E.length = 1), (E[0] = e.e = e.s = 0)), e;
        if ((0 == r ? ((E.length = g), (o = 1), g--) : ((E.length = g + 1), (o = u(10, f - r)), (E[g] = i > 0 ? ((m / u(10, s - i)) % u(10, i) | 0) * o : 0)), p))
            for (;;)
                if (0 == g) {
                    (E[0] += o) == _ && ((E[0] = 1), ++e.e);
                    break;
                } else {
                    if (((E[g] += o), E[g] != _)) break;
                    (E[g--] = 0), (o = 1);
                }
    ...
    function C(e, t) {
        ...
        if (((c = e.d), (p = t.d), (r = t.e), (u = e.e), (c = c.slice()), (s = u - r))) {
            for ((d = s < 0) ? ((n = c), (s = -s), (l = p.length)) : ((n = p), (r = u), (l = c.length)), s > (i = Math.max(Math.ceil(m / f), l) + 2) && ((s = i), (n.length = 1)), n.reverse(), i = s; i--; ) n.push(0);
            n.reverse();
        } else {
    ...
    function R(e, t, n) {
        var r,
            ...
            a = b(e.d),
            o = a.length;
        return t ? (n && (r = n - o) > 0 ? (a = a.charAt(0) + '.' + a.slice(1) + T(r)) : o > 1 && (a = a.charAt(0) + '.' + a.slice(1)), (a = a + (i < 0 ? 'e' : 'e+') + i)) : i < 0 ? ((a = '0.' + T(-i - 1) + a), n && (r = n - o) > 0 && (a += T(r))) : i >= o ? ((a += T(i + 1 - o)), n && (r = n - i - 1) > 0 && (a = a + '.' + T(r))) : ((r = i + 1) < o && (a = a.slice(0, r) + '.' + a.slice(r)), n && (r = n - o) > 0 && (i + 1 === o && (a += '.'), (a += T(r)))), e.s < 0 ? '-' + a : a;
    }
    function P(e, t) {
