!(function (t) {
        ...
        if (((c = e.d), (u = t.d), (s = e.e), (i = t.e), (c = c.slice()), (o = s - i))) {
            for (
                o < 0 ? ((r = c), (o = -o), (l = u.length)) : ((r = u), (i = s), (l = c.length)),
                    o > (l = (s = Math.ceil(p / _)) > l ? s + 1 : l + 1) && ((o = l), (r.length = 1)),
                    r.reverse();
                o--;
            )
                r.push(0);
    ...
    (m.absoluteValue = m.abs =
        ...
        (m.times = m.mul =
            function (e) {
                ...
                for (
                    e.s *= d.s,
                        n = d.e + e.e,
                        (c = p.length) < (u = h.length) && ((o = p), (p = h), (h = o), (s = c), (c = u), (u = s)),
                        o = [],
                        r = s = c + u;
                    r--;
                )
                ...
                for (r = u; --r >= 0; ) {
                    for (t = 0, i = c + r; i > r; )
                        (l = o[i] + h[r] * p[i - r - 1] + t), (o[i--] = (l % f) | 0), (t = (l / f) | 0);
                    o[i] = ((o[i] + t) % f) | 0;
                }
                for (; !o[--s]; ) o.pop();
        ...
        (m.toFixed = function (e, t) {
            ...
            return void 0 === e
                ...
                : (E(e, 0, r),
                  ...
                  (n = R((i = N(new o(a), e + v(a) + 1, t)).abs(), !1, e + v(i) + 1)),
        ...
        (m.toPower = m.pow =
            function (e) {
                ...
                if (((u = (t = e.e) >= (r = e.d.length - 1)), (l = d.s), u)) {
                    if ((r = m < 0 ? -m : m) <= p) {
                        for (
                            s = new f(n), t = Math.ceil(i / _ + 4), a = !1;
        ...
        (m.toPrecision = function (e, t) {
            ...
            return (
                void 0 === e
                    ? ((n = v(a)), (i = R(a, n <= o.toExpNeg || n >= o.toExpPos)))
                    : (E(e, 1, r),
                      void 0 === t ? (t = o.rounding) : E(t, 0, 8),
                      (n = v((a = N(new o(a), e, t)))),
                      (i = R(a, e <= n || n <= o.toExpNeg, e))),
                i
            );
        }),
    ...
    var y = (function () {
        ...
        return function (r, i, a, s) {
            ...
            for (u = 0, c = r.e - i.e, C = L.length, S = D.length, g = (m = new P(w)).d = []; L[u] == (D[u] || 0); )
                ++u;
            if ((L[u] > (D[u] || 0) && --c, (O = null == a ? (a = P.precision) : s ? a + (v(r) - v(i)) + 1 : a) < 0))
                return new P(0);
    ...
    function O(e, t) {
        ...
        for (null == t ? ((a = !1), (c = p)) : (c = t), s = new _(0.03125); e.abs().gte(0.1); )
            (e = e.times(s)), (f += 5);
    ...
    function N(e, t, n) {
        ...
        if (
            (void 0 !== n &&
                ((d = ((m / (o = u(10, s - i - 1))) % 10) | 0),
                (p = t < 0 || void 0 !== E[g + 1] || m % o),
                (p =
                    n < 4
                        ? (d || p) && (0 == n || n == (e.s < 0 ? 3 : 2))
                        : d > 5 ||
        ...
        if (
            (0 == r
                ...
                : ((E.length = g + 1),
                  (o = u(10, _ - r)),
                  (E[g] = i > 0 ? (((m / u(10, s - i)) % u(10, i)) | 0) * o : 0)),
            p)
        )
            for (;;)
                if (0 == g) {
    ...
    function R(e, t, n) {
        ...
        return (
            t
                ? (n && (r = n - o) > 0
                      ? (a = a.charAt(0) + "." + a.slice(1) + T(r))
                      : o > 1 && (a = a.charAt(0) + "." + a.slice(1)),
                  (a = a + (i < 0 ? "e" : "e+") + i))
                : i < 0
                  ? ((a = "0." + T(-i - 1) + a), n && (r = n - o) > 0 && (a += T(r)))
                  : i >= o
                    ? ((a += T(i + 1 - o)), n && (r = n - i - 1) > 0 && (a = a + "." + T(r)))
                    : ((r = i + 1) < o && (a = a.slice(0, r) + "." + a.slice(r)),
                      n && (r = n - o) > 0 && (i + 1 === o && (a += "."), (a += T(r)))),
            e.s < 0 ? "-" + a : a
        );
    }
    function P(e, t) {
