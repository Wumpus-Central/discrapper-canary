!(function (t) {
    ...
    (m.absoluteValue = m.abs =
        ...
        (m.logarithm = m.log =
            function (e) {
                ...
                return r.eq(n) ? new i(0) : ((o = !1), (t = y(T(r, l), T(e, l), l)), (o = !0), N(t, s));
            }),
        (m.minus = m.sub =
            function (e) {
                var t = this;
        ...
        (m.toExponential = function (e, t) {
            var n,
                i = this,
                o = i.constructor;
            return void 0 === e ? (n = P(i, !0)) : (E(e, 0, r), void 0 === t ? (t = o.rounding) : E(t, 0, 8), (n = P((i = N(new o(i), e + 1, t)), !0, e + 1))), n;
        }),
        (m.toFixed = function (e, t) {
            var n,
                ...
                o = this,
                a = o.constructor;
            return void 0 === e ? P(o) : (E(e, 0, r), void 0 === t ? (t = a.rounding) : E(t, 0, 8), (n = P((i = N(new a(o), e + v(o) + 1, t)).abs(), !1, e + v(i) + 1)), o.isneg() && !o.isZero() ? '-' + n : n);
        }),
        (m.toInteger = m.toint =
            function () {
                var e = this,
        ...
        (m.toPower = m.pow =
            function (e) {
                ...
                if (((u = (t = e.e) >= (r = e.d.length - 1)), (l = d.s), u)) {
                    if ((r = m < 0 ? -m : m) <= p) {
                        for (s = new f(n), t = Math.ceil(i / _ + 4), o = !1; r % 2 && R((s = s.times(d)).d, t), 0 !== (r = c(r / 2)); ) R((d = d.times(d)).d, t);
                        return (o = !0), e.s < 0 ? new f(n).div(s) : N(s, i);
                    }
                } else if (l < 0) throw Error(a + 'NaN');
                return (l = l < 0 && 1 & e.d[Math.max(t, r)] ? -1 : 1), (d.s = 1), (o = !1), (s = e.times(T(d, i + h))), (o = !0), ((s = O(s)).s = l), s;
            }),
        (m.toPrecision = function (e, t) {
            var n,
                ...
                o = this,
                a = o.constructor;
            return void 0 === e ? ((n = v(o)), (i = P(o, n <= a.toExpNeg || n >= a.toExpPos))) : (E(e, 1, r), void 0 === t ? (t = a.rounding) : E(t, 0, 8), (n = v((o = N(new a(o), e, t)))), (i = P(o, e <= n || n <= a.toExpNeg, e))), i;
        }),
    ...
    var y = (function () {
        ...
        return function (r, i, o, s) {
            ...
            for (u = 0, c = r.e - i.e, C = L.length, T = D.length, g = (m = new R(w)).d = []; L[u] == (D[u] || 0); ) ++u;
            if ((L[u] > (D[u] || 0) && --c, (O = null == o ? (o = R.precision) : s ? o + (v(r) - v(i)) + 1 : o) < 0)) return new R(0);
            if (((O = (O / _ + 2) | 0), (u = 0), 1 == C)) for (d = 0, L = L[0], O++; (u < T || d) && O--; u++) (I = d * f + (D[u] || 0)), (g[u] = (I / L) | 0), (d = I % L | 0);
            else {
                for ((d = (f / (L[0] + 1)) | 0) > 1 && ((L = e(L, d)), (D = e(D, d)), (C = L.length), (T = D.length)), S = C, b = (E = D.slice(0, C)).length; b < C; ) E[b++] = 0;
                (P = L.slice()).unshift(0), (A = L[0]), L[1] >= f / 2 && ++A;
                do (d = 0), (l = t(L, E, C, b)) < 0 ? ((y = E[0]), C != b && (y = y * f + (E[1] || 0)), (d = (y / A) | 0) > 1 ? (d >= f && (d = f - 1), (h = (p = e(L, d)).length), (b = E.length), 1 == (l = t(p, E, h, b)) && (d--, n(p, C < h ? P : L, h))) : (0 == d && (l = d = 1), (p = L.slice())), (h = p.length) < b && p.unshift(0), n(E, p, b), -1 == l && ((b = E.length), (l = t(L, E, C, b)) < 1 && (d++, n(E, C < b ? P : L, b))), (b = E.length)) : 0 === l && (d++, (E = [0])), (g[u++] = d), l && E[0] ? (E[b++] = D[S] || 0) : ((E = [D[S]]), (b = 1));
                while ((S++ < T || void 0 !== E[0]) && O--);
            }
    ...
    function T(e, t) {
        ...
        if (((E.precision = f += h), (i = (r = b(g)).charAt(0)), !(1500000000000000 > Math.abs((l = v(m)))))) return (d = I(E, f + 2, O).times(l + '')), (m = T(new E(i + '.' + r.slice(1)), f - h).plus(d)), (E.precision = O), null == t ? ((o = !0), N(m, O)) : m;
