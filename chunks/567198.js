!(function (t) {
    ...
    (m.absoluteValue = m.abs =
        ...
        (m.logarithm = m.log =
            function (e) {
                ...
                return r.eq(n) ? new i(0) : ((a = !1), (t = y(S(r, l), S(e, l), l)), (a = !0), C(t, s));
            }),
        (m.minus = m.sub =
            function (e) {
                var t = this;
        ...
        (m.times = m.mul =
            function (e) {
                ...
                for (; !o[--s]; ) o.pop();
                return t ? ++n : o.shift(), (e.d = o), (e.e = n), a ? C(e, _.precision) : e;
            }),
        ...
        (m.toFixed = function (e, t) {
            ...
            return void 0 === e
                ...
                : (E(e, 0, r),
                  ...
                  (n = R((i = C(new o(a), e + v(a) + 1, t)).abs(), !1, e + v(i) + 1)),
    ...
    var y = (function () {
        ...
        return function (r, i, a, s) {
            ...
            for (u = 0, c = r.e - i.e, N = L.length, S = D.length, g = (m = new P(w)).d = []; L[u] == (D[u] || 0); )
                ++u;
            ...
            if (((O = (O / _ + 2) | 0), (u = 0), 1 == N))
                ...
                for (
                    (d = (f / (L[0] + 1)) | 0) > 1 && ((L = e(L, d)), (D = e(D, d)), (N = L.length), (S = D.length)),
                        T = N,
    ...
    function O(e, t) {
        ...
        for (c += ((Math.log(u(2, f)) / Math.LN10) * 2 + 5) | 0, r = i = o = new _(n), _.precision = c; ; ) {
            if (
                ...
                return (_.precision = p), null == t ? ((a = !0), C(o, p)) : o;
            }
            o = s;
        }
    }
    ...
    function S(e, t) {
        ...
        for (
            ...
            if (((c = C(c.times(_), f)), b((d = u.plus(y(c, new E(s), f))).d).slice(0, f) === b(u.d).slice(0, f)))
                return (
                    (u = u.times(2)),
