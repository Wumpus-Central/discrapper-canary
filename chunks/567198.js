!(function (t) {
    ...
    function g(e, t) {
        ...
        if (((c = e.d), (u = t.d), (s = e.e), (i = t.e), (c = c.slice()), (a = s - i))) {
            for (
                a < 0 ? ((r = c), (a = -a), (l = u.length)) : ((r = u), (i = s), (l = c.length)),
                    a > (l = (s = Math.ceil(p / _)) > l ? s + 1 : l + 1) && ((a = l), (r.length = 1)),
                    r.reverse();
                a--;
            )
                r.push(0);
        ...
        for ((l = c.length) - (a = u.length) < 0 && ((a = l), (r = u), (u = c), (c = r)), n = 0; a; )
            (n = ((c[--a] = c[a] + u[a] + n) / f) | 0), (c[a] %= f);
    ...
    (m.absoluteValue = m.abs =
        ...
        (m.times = m.mul =
            function (e) {
                ...
                for (
                    e.s *= d.s,
                        n = d.e + e.e,
                        (c = p.length) < (u = h.length) && ((a = p), (p = h), (h = a), (s = c), (c = u), (u = s)),
                        a = [],
                        r = s = c + u;
                    r--;
                )
                ...
                for (r = u; --r >= 0; ) {
                    for (t = 0, i = c + r; i > r; )
                        (l = a[i] + h[r] * p[i - r - 1] + t), (a[i--] = (l % f) | 0), (t = (l / f) | 0);
                    a[i] = ((a[i] + t) % f) | 0;
                }
                for (; !a[--s]; ) a.pop();
        ...
        (m.toDecimalPlaces = m.todp =
            function (e, t) {
                ...
                return ((n = new i(n)), void 0 === e)
                    ? n
                    : (E(e, 0, r), void 0 === t ? (t = i.rounding) : E(t, 0, 8), N(n, e + v(n) + 1, t));
            }),
        ...
        (m.toFixed = function (e, t) {
            ...
            return void 0 === e
                ...
                : (E(e, 0, r),
                  ...
                  (n = R((i = N(new a(o), e + v(o) + 1, t)).abs(), !1, e + v(i) + 1)),
        ...
        (m.toPower = m.pow =
            function (e) {
                ...
                if (((u = (t = e.e) >= (r = e.d.length - 1)), (l = d.s), u)) {
                    if ((r = m < 0 ? -m : m) <= p) {
                        for (
                            s = new f(n), t = Math.ceil(i / _ + 4), o = !1;
                            r % 2 && P((s = s.times(d)).d, t), 0 !== (r = c(r / 2));
                        )
                            P((d = d.times(d)).d, t);
        ...
        (m.toPrecision = function (e, t) {
            ...
            return (
                void 0 === e
                    ? ((n = v(o)), (i = R(o, n <= a.toExpNeg || n >= a.toExpPos)))
                    : (E(e, 1, r),
                      void 0 === t ? (t = a.rounding) : E(t, 0, 8),
                      (n = v((o = N(new a(o), e, t)))),
                      (i = R(o, e <= n || n <= a.toExpNeg, e))),
                i
            );
        }),
    ...
    var y = (function () {
        ...
        return function (r, i, o, s) {
            ...
            for (u = 0, c = r.e - i.e, C = L.length, S = D.length, g = (m = new P(w)).d = []; L[u] == (D[u] || 0); )
                ++u;
            if ((L[u] > (D[u] || 0) && --c, (O = null == o ? (o = P.precision) : s ? o + (v(r) - v(i)) + 1 : o) < 0))
                return new P(0);
            if (((O = (O / _ + 2) | 0), (u = 0), 1 == C))
                for (d = 0, L = L[0], O++; (u < S || d) && O--; u++)
                    (I = d * f + (D[u] || 0)), (g[u] = (I / L) | 0), (d = (I % L) | 0);
            else {
                for (
                    (d = (f / (L[0] + 1)) | 0) > 1 && ((L = e(L, d)), (D = e(D, d)), (C = L.length), (S = D.length)),
                        T = C,
                        b = (E = D.slice(0, C)).length;
                    b < C;
                )
                    E[b++] = 0;
                            ...
                            ? ((y = E[0]),
                              ...
                              (d = (y / A) | 0) > 1
                                  ? (d >= f && (d = f - 1),
                                    (h = (p = e(L, d)).length),
                                    (b = E.length),
                                    1 == (l = t(p, E, h, b)) && (d--, n(p, C < h ? R : L, h)))
                                  : (0 == d && (l = d = 1), (p = L.slice())),
                              (h = p.length) < b && p.unshift(0),
                              n(E, p, b),
                              -1 == l && ((b = E.length), (l = t(L, E, C, b)) < 1 && (d++, n(E, C < b ? R : L, b))),
                              (b = E.length))
                            : 0 === l && (d++, (E = [0])),
                        (g[u++] = d),
    ...
    function O(e, t) {
        ...
        for (null == t ? ((o = !1), (c = p)) : (c = t), s = new _(0.03125); e.abs().gte(0.1); )
            (e = e.times(s)), (f += 5);
        for (c += ((Math.log(u(2, f)) / Math.LN10) * 2 + 5) | 0, r = i = a = new _(n), _.precision = c; ; ) {
            if (
                ((i = N(i.times(e), c)),
                (r = r.times(++d)),
                b((s = a.plus(y(i, r, c))).d).slice(0, c) === b(a.d).slice(0, c))
            ) {
    ...
    function S(e, t) {
        ...
        if (((E.precision = f += h), (i = (r = b(g)).charAt(0)), !(1500000000000000 > Math.abs((l = v(m))))))
            return (
                (d = I(E, f + 2, O).times(l + "")),
                (m = S(new E(i + "." + r.slice(1)), f - h).plus(d)),
                (E.precision = O),
                null == t ? ((o = !0), N(m, O)) : m
            );
        ...
        for (
            ...
            if (((c = N(c.times(_), f)), b((d = u.plus(y(c, new E(s), f))).d).slice(0, f) === b(u.d).slice(0, f)))
                return (
                    (u = u.times(2)),
                    0 !== l && (u = u.plus(I(E, f + 2, O).times(l + ""))),
                    (u = y(u, new E(p), f)),
                    (E.precision = O),
                    null == t ? ((o = !0), N(u, O)) : u
                );
    ...
    function N(e, t, n) {
        ...
        if (
            (void 0 !== n &&
                ((d = ((m / (a = u(10, s - i - 1))) % 10) | 0),
                (p = t < 0 || void 0 !== E[g + 1] || m % a),
                (p =
                    n < 4
                        ? (d || p) && (0 == n || n == (e.s < 0 ? 3 : 2))
                        : d > 5 ||
                          (5 == d &&
                              (4 == n ||
                                  p ||
                                  (6 == n && ((r > 0 ? (i > 0 ? m / u(10, s - i) : 0) : E[g - 1]) % 10) & 1) ||
                                  n == (e.s < 0 ? 8 : 7))))),
            t < 1 || !E[0])
        )
            return (
        ...
        if (
            (0 == r
                ...
                : ((E.length = g + 1),
                  (a = u(10, _ - r)),
                  (E[g] = i > 0 ? (((m / u(10, s - i)) % u(10, i)) | 0) * a : 0)),
            p)
        )
            for (;;)
                if (0 == g) {
    ...
    function C(e, t) {
        ...
        if (((c = e.d), (p = t.d), (r = t.e), (u = e.e), (c = c.slice()), (s = u - r))) {
            for (
                (d = s < 0) ? ((n = c), (s = -s), (l = p.length)) : ((n = p), (r = u), (l = c.length)),
                    s > (i = Math.max(Math.ceil(m / _), l) + 2) && ((s = i), (n.length = 1)),
                    n.reverse(),
                    i = s;
                i--;
            )
    ...
    function R(e, t, n) {
        ...
        return (
            t
                ? (n && (r = n - a) > 0
                      ? (o = o.charAt(0) + "." + o.slice(1) + T(r))
                      : a > 1 && (o = o.charAt(0) + "." + o.slice(1)),
                  (o = o + (i < 0 ? "e" : "e+") + i))
                : i < 0
                  ? ((o = "0." + T(-i - 1) + o), n && (r = n - a) > 0 && (o += T(r)))
                  : i >= a
                    ? ((o += T(i + 1 - a)), n && (r = n - i - 1) > 0 && (o = o + "." + T(r)))
                    : ((r = i + 1) < a && (o = o.slice(0, r) + "." + o.slice(r)),
                      n && (r = n - a) > 0 && (i + 1 === a && (o += "."), (o += T(r)))),
            e.s < 0 ? "-" + o : o
        );
    }
    function P(e, t) {
