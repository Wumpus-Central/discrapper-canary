...
function E(e) {
    let { navId: t, itemCount: n, focusedIndex: E = 0, onSelect: d, setFocus: _, getNewFocusIndex: A, maintainFocusPosition: T = !0, includeSetSizes: m = !0, focusOnMount: I = !0, enabled: g = !0, onDispatch: f } = e,
        N = r.useCallback(
            (e, t) => {
                let n = (0, l.Z)(e, t);
    ...
    return (
        ...
        (function (e) {
            let { navId: t, itemCount: n, focusedIndex: E, onSelect: d, setFocus: _ = c, getNewFocusIndex: A, dispatch: T, maintainFocusPosition: m, includeSetSizes: I, focusOnMount: g, enabled: f, makeId: N = i.qR, getIndexFromId: h } = e,
                O = r.useRef(n),
                p = r.useRef(h);
                    ...
                    (e) => {
                        ...
                        switch (n) {
                            ...
                            case s.Us.SELECT_FOCUSED_ITEM:
                                ...
                                if ((e.preventDefault(), e.stopPropagation(), T({ type: n }), null != d)) return void d(E);
                                null == r || r.click();
                        }
                    },
                    [N, t, T, E, x, d]
