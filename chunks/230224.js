...
function A(e) {
    ...
    let { invite: n, textClassName: r, className: s } = e,
        o = I(n);
    return null == o || T(n) || (null == n ? void 0 : null === (t = n.guild) || void 0 === t ? void 0 : t.id) === p.fQ
        ? null
        : (0, i.jsx)(a.EJ, {
...
function R(e) {
    let { invite: t, showBigUserIcon: n } = e,
        s = r.useMemo(() => (n ? null : N(t) && null != t.target_user ? h.ZP.getUserAvatarURL(t.target_user) : T(t) && null != t.inviter ? h.ZP.getUserAvatarURL(t.inviter) : null), [t, n]),
    ...
    } else N(t) && null != t.target_user ? (l = x.intl.formatToPlainString(x.t.x2L32d, { username: t.target_user.username })) : Z(t) ? (l = x.intl.string(x.t['FDsl+P'])) : T(t) && null != t.inviter && (l = x.intl.format(x.t.spU2mJ, { username: g.ZP.getFormattedName(t.inviter) }));
    return (0, i.jsxs)('div', {
...
function P(e) {
    let t,
        n,
        r,
        { user: s, guild: l, channel: d, application: h, showBigUserIcon: m } = e;
    if (null != l)
        m &&
            null == h &&
            (t = (0, i.jsx)(a.Vj, {
