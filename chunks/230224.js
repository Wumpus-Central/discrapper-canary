...
function C(e) {
    ...
    if (b(t)) {
        ...
        v(t) && null != t.target_user
            ? (l = f.intl.formatToPlainString(f.t.x2L32d, { username: t.target_user.username }))
            : I(t)
              ? (l = f.intl.string(f.t["FDsl+P"]))
              : O(t) &&
                null != t.inviter &&
                (l = f.intl.format(f.t.spU2mJ, { username: h.ZP.getFormattedName(t.inviter) }));
    return (0, r.jsxs)("div", {
