...
class q {
    ...
    isUsable(e) {
        ...
        let t = R.Ay.getMember(this.id, this._userId);
...
async function eo() {
    ...
    let t = await (0, p.ES)("EmojiStore.loadSavedEmojis", () =>
        c.A.timeAsync("\uD83D\uDCBE", "loadSavedEmojis", () => m.A.getAsync(e)),
    );
...
let el = (e) => ({
    ...
    afterCompute: () => {
        e(), (et = [...$]), l().some(en, (e) => e.usableEmojis.length > 0) || et.splice($.indexOf(j.R2.CUSTOM), 1);
    },
...
class eu {
    ...
    constructor(e) {
        ...
        const t = new Map(),
            ...
            s = (e) => {
                this.emoticonsByName.has(e.name) || (n.push(U.A.escape(e.name)), this.emoticonsByName.set(e.name, e));
            };
        F.Ay.forEach(r);
        const o = (e) => {
            let t = en[null == e ? W.eGj : e];
    ...
    getFrequentlyUsedEmojisWithoutFetchingLatest() {
        ...
        let e = ed.frequently.map((e) => (null != e.id ? this.getById(e.id) : F.Ay.getByName(e.name))).filter(P.Vq),
            t = (0, H.A)(e);
    ...
    rebuildFrequentlyUsedReactionsEmojisWithoutFetchingLatest() {
        ...
        let e = ec.frequently.map((e) => (null != e.id ? this.getById(e.id) : F.Ay.getByName(e.name))).filter(P.Vq),
            t = (0, H.A)(e);
        return (
    ...
    rebuildFavoriteEmojisWithoutFetchingLatest() {
        ...
        let e = (O.A.frecencyWithoutFetchingLatest.favoriteEmojis?.emojis ?? [])
...
let ed = ((r = eu.resetFrequentlyUsed), new E.A({ ...el(r) })),
    ec =
...
function eE() {
    (er = null), eu.reset(), 2 === ee && (ed.compute(), ec.compute());
}
function eh(e) {
    ef(e), eu.clear(e);
    let t = V.A.getGuildEmojis(e);
    if (null == t) return;
...
function ep() {
    ...
    null != t && F.Ay.setDefaultDiversitySurrogate(t), eu.reset();
    let n = O.A.frecencyWithoutFetchingLatest,
    ...
    if (l().isEmpty(r) && l().isEmpty(z.pendingUsages) && O.A.hasLoaded(K.oD.FRECENCY_AND_FAVORITES_SETTINGS))
        for (let e of [
            "thumbsup",
            "eyes",
            "laughing",
    ...
    if (
        ...
        O.A.hasLoaded(K.oD.FRECENCY_AND_FAVORITES_SETTINGS)
    )
        for (let e of [
            "100",
            "100",
...
function em(e) {
    ...
    for (let t of e) {
        ...
        null != e && (ed.track(e), z.pendingUsages.push({ key: e, timestamp: Date.now() }));
    }
    let t = e.length > 0;
    return t && 2 === ee && ed.compute(), t;
}
function eg(e) {
    let {
            guildId: t,
...
class eA extends _.Ay.PersistedStore {
    ...
    initialize(e) {
        this.waitFor(A.A, R.Ay, v.A, C.A, b.A, N.default, V.A, D.Ay, S.A, B.A, O.A, L.default),
            null != e &&
    ...
    getHiddenEmojiIds(e) {
        eo();
        let t = null == e ? void 0 : en[e];
        return t?.hiddenEmojiIds ?? Z;
    }
    getUsableGuildEmoji(e) {
        eo();
        let t = en[e];
        return t?.usableEmojis ?? J;
    }
    getGuilds() {
        return en;
    }
    ...
    getSearchResultsOrder(e, t, n, r, i) {
        ...
        if (e.length > 0) {
            let {
                    ...
                    boostAtEnd: o,
                    boostsIgnoreDisambiguators: d,
                } = x.A.getConfig({ location: "getSearchResultsOrder" }),
                c = RegExp(`^${a}`, "i"),
                _ = RegExp(`${a}$`, "i"),
                f = RegExp(`(^|_|[A-Z])${a}s?([A-Z]|_|$)`),
                E = RegExp(`(^|_|[A-Z])${a}s?([A-Z]|_|$)|(^|_|[a-z])${u}s?([A-Z]|_|$)`),
                h = n ? E : f,
                p = h.test.bind(h),
                m = c.test.bind(c),
                g = _.test.bind(_);
                    ...
                    (e) =>
                        ((e) => {
                            let n = null != e.uniqueName,
                                a = n ? e.names[0] : d ? e.name.split("~")[0] : e.name,
                                l = n ? a : e.id;
                            ...
                            let u = a.toLowerCase(),
                                ...
                                _ = r === Y.EmojiIntention.REACTION ? ec.getScore(l) : ed.getScore(l);
                            return null != _ && (c *= _ / 100), c;
                        })(e),
        ...
        let c = null != n ? n.getGuildId() : null,
            ...
            f = _.nameMatchesChain(t).reduce(
                (e, t) => {
                    ...
                    return (
                        r !== Y.EmojiDisabledReasons.PREMIUM_LOCKED || l
...
let eI = new eA(f.h, {
    ...
    CONNECTION_OPEN: function (e) {
        ...
        (ee = 0 === e.unavailableGuilds.length && e.guilds.every((e) => "full_sync" === e.emojis.op) ? 2 : 0), eE();
    },
    ...
    CACHED_EMOJIS_LOADED: function (e) {
        let { emojis: t } = e;
        for (let [e] of t) v.A.isMember(e) && eh(e);
        eE();
    },
    GUILD_MEMBER_UPDATE: function (e) {
        let { guildId: t, user: n } = e;
        n.id === L.default.getCurrentUser()?.id && (eh(t), eE());
    },
    ...
    MESSAGE_REACTION_ADD: function (e) {
        ...
        (function (e) {
            if (null != e) {
                for (let t of e) {
                    let e = t.id ?? t.uniqueName ?? t.name;
                    null != e && (ec.track(e), z.emojiReactionPendingUsages.push({ key: e, timestamp: Date.now() }));
                }
                e.length > 0 && 2 === ee && ec.compute();
            }
        })([t]),
            em([t]);
    },
    ...
    TOP_EMOJIS_FETCH_SUCCESS: function (e) {
        ...
        ei.set(t, { emojiIds: n.map((e) => e.emojiId), topEmojisTTL: d()(d()()).add(1, "days").valueOf() });
    },
