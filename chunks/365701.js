...
class C extends d.Ay.Store {
    ...
    save = async () => {
        await p.A.updateGuildTemplate(j.A.getProps().guild.id, this.getTemplate().code, this.name, this.description),
            this.emitChange();
    };
    showNotice() {
        let e = this.getTemplate();
    ...
    let t = (0, d.bG)([I], () => I.error),
        ...
        { loading: r, guildTemplate: a } = (function (e) {
            ...
            return (
                ...
                { loading: t, guildTemplate: (0, d.bG)([A.A], () => A.A.getForGuild(e), [e]) }
            );
        })(e.id);
    if (
        (s.useEffect(() => {
