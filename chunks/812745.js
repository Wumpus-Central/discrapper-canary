...
let f = { SMALL: c.cardIconSmall, MEDIUM: c.cardIconMedium, LARGE: c.cardIconLarge, XLARGE: c.cardIconXLarge };
    ...
    render() {
        ...
        return "bank" === t
            ...
            : "gift_card" === t
              ...
              : (0, r.jsx)("div", { "aria-hidden": !0, className: s()(a, c[t], n, { [c.flipped]: e }), children: t });
    }
}
let g = p;
