...
let h = {
    ...
    updateGuildAndChannelNotificationSettings(e, t, n, r) {
        let i = d.default.keys(t.channel_overrides),
            s = (0, u.CP)(e),
            l = (0, u.Xh)(e, i);
        o.A.saveUserGuildSettings(e, t),
            a.h.dispatch({ type: "USER_GUILD_SETTINGS_GUILD_AND_CHANNELS_UPDATE", guildId: e, settings: t }),
            (0, u.Sq)(e, t, s, n, r),
            d.default.keys(t.channel_overrides).forEach((i) => {
                let s = l.get(i);
                (0, u.ct)({
                    guildId: e,
                    channelId: i,
    ...
    async setAccountFlag(e, t) {
        let n = l.Ay.accountNotificationSettings.flags,
            s = (0, r.lA)(n, e, t);
        await i.Bo.patch({ url: c.Rsh.ACCOUNT_NOTIFICATION_SETTINGS, body: { flags: s }, rejectWithError: !1 }),
