...
let p = {
    ...
    updateChannelOverrideSettings(e, t, n, i, r) {
        ...
        o.A.saveUserGuildSettings(e, { channel_overrides: { [t]: n } }),
            ...
            s.O.announce(f.intl.string(f.t.MlIsJ8)),
            (0, u.ct)({ guildId: e, channelId: t, change: n, previous: l, label: i, location: r });
    },
    updateChannelOverrideSettingsBulk(e, t, n, i) {
        ...
        o.A.saveUserGuildSettings(e, { channel_overrides: t }),
            ...
            c.default
                .keys(t)
                .forEach((r) =>
                    (0, u.ct)({ guildId: e, channelId: r, change: t[r], previous: s.get(r), label: n, location: i }),
                );
    },
    ...
    setForumThreadsCreated(e, t) {
        let n = t ? h.vv.NEW_FORUM_THREADS_ON : h.vv.NEW_FORUM_THREADS_OFF,
            i = t ? h.vv.NEW_FORUM_THREADS_OFF : h.vv.NEW_FORUM_THREADS_ON,
            r = l.Ay.getChannelFlags(e);
        this.updateChannelOverrideSettings(e.guild_id, e.id, { flags: (r & ~i) | n }, u.G_.forumThreadsCreated(t));
    },
    async setAccountFlag(e, t) {
        let n = l.Ay.accountNotificationSettings.flags,
            s = (0, i.lA)(n, e, t);
        await r.Bo.patch({ url: d.Rsh.ACCOUNT_NOTIFICATION_SETTINGS, body: { flags: s }, rejectWithError: !1 }),
