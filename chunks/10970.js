...
function _(e) {
    var t;
    let { app: n, currentSubscription: m, currentListing: h, alternativeListings: _, navigateToHome: E, subscriptionGroup: C, renewalSkuId: j } = e,
        O = (0, l.y)(n, 100),
        S = (0, g.KK)(C.flags),
        v = S ? s.QTo : s.tBG,
        T = S ? f.intl.string(f.t['46YF2N']) : f.intl.string(f.t.fFyGiI),
        N = null == (t = m.metadata) ? void 0 : t.application_subscription_guild_id,
