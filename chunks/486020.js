...
function C(e) {
    ...
    return v(e, t, n, i, r) ?? N(e.id, e.discriminator, e.isProvisional, n);
}
function R(e) {
    let t,
    ...
    return "webp" === c && s && H(r) && (h.animated = !0), (t += `?${a.stringify(h)}`);
}
function O(e) {
...
let K = {
    ...
    getUserAvatarSource: (e, t, n) => W(C(e, t, n)),
    getGuildIconURL: k,
    getGuildSplashURL: w,
