"use strict";
n.d(t, { Ay: () => O, KU: () => v, Qt: () => N, r4: () => R }), n(321073);
var i,
    r = n(735438),
    s = n(713402),
    a = n(717558),
...
class O {
    ...
    _getParticipantsForUser(e) {
        ...
        (null != s || S) &&
            ...
            i.push(t));
        let C = c.A.getStreamForUser(e, I) ?? c.A.getActiveStreamForUser(e, I);
        if (null != C && C.channelId === this.channelId) {
            let t = (0, u._z)(C),
                a = this.getParticipant(t),
                o = C.ownerId === d.default.getId() && c.A.isSelfStreamHidden(this.channelId),
                l =
                    a?.type === T.lp.STREAM
                        ? {
