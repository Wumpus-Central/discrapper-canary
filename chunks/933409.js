    ...
    let w = (0, r.e7)([b.Z], () => b.Z.getGuild(t), [t]),
                ...
                ? [
                      ...
                      !B && null != w && m.Z.canWithPartialContext(p.Plq.MOVE_MEMBERS, { channelId: N })
                          ? (0, l.jsx)(
                                ...
                                {
                                    id: 'voice-disconnect',
                                    label: B ? I.intl.string(I.t['6vrfgo']) : I.intl.string(I.t['/jERiI']),
                                    color: 'danger',
        ...
        H = async (t, n, l) => {
            if (t.ctrlKey || t.metaKey)
                try {
                    var i;
                    await o.Z.setCommunicationDisabledDuration(n, l, C.UK.DURATION_60_SEC, null, U), Q(P.jQ.TIMEOUT), (0, a.showToast)((0, a.createToast)(I.intl.formatToPlainString(I.t.O9C3Nj, { user: null != (i = y.ZP.getName(n, null, e)) ? i : '' }), a.ToastType.SUCCESS));
                } catch (e) {
