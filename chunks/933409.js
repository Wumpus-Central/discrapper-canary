...
function x(e, t, x, D, C) {
    ...
    let T = (0, i.e7)([Z.Z], () => Z.Z.getGuild(t), [t]),
            ...
            null != q && null != x && m.Z.canWithPartialContext(h.Plq.VIEW_CHANNEL, { channelId: q }) && !U
                ? [
                      ...
                      (!B || (B && !G)) && m.Z.canWithPartialContext(h.Plq.DEAFEN_MEMBERS, { channelId: x })
                          ...
                          : null,
                      !k && null != T && m.Z.canWithPartialContext(h.Plq.MOVE_MEMBERS, { channelId: x })
                          ? (0, l.jsx)(
                                o.sNh,
                                {
                                    id: "voice-disconnect",
                                    label: k ? A.intl.string(A.t["6vrfgo"]) : A.intl.string(A.t["/jERiI"]),
                                    color: "danger",
        ...
        z =
            null != T &&
            m.Z.canManageUser(h.Plq.MODERATE_MEMBERS, e, T) &&
            m.Z.canManageUser(h.Plq.KICK_MEMBERS, e, T) &&
            m.Z.canManageUser(h.Plq.BAN_MEMBERS, e, T),
        $ = null != T && (m.Z.canManageUser(h.Plq.MANAGE_GUILD, e, T) || m.Z.canManageUser(h.Plq.MANAGE_ROLES, e, T));
    if (
        !k &&
        null != T &&
        null != Y &&
