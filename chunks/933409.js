...
function x(e, t, x, C, D) {
    let N = r.useMemo(() => ({ [t]: [e.id] }), [t, e.id]),
        T = null != C ? [C] : [];
    (0, c.$)(N), (0, i.e7)([j.Z], () => j.Z.getGuildVersion(t), [t]);
    let w = (0, i.e7)([y.Z], () => y.Z.getGuild(t), [t]),
        U = (0, i.e7)([v.default], () => {
            var t;
            return (null == (t = v.default.getCurrentUser()) ? void 0 : t.id) === e.id;
        }, [e.id]),
        k = (0, i.e7)([Z.ZP], () => Z.ZP.isGuestOrLurker(t, e.id), [t, e.id]),
        ...
        Y = (0, i.e7)([Z.ZP], () => Z.ZP.getMember(t, e.id)),
        Q = (0, S.Z)({
            userId: e.id,
            guildId: t,
            channelId: x,
            ...
            null != q && null != x && j.Z.canWithPartialContext(_.Plq.VIEW_CHANNEL, { channelId: q }) && !k
                ? [
                      ...
                      (!B || (B && !G)) && j.Z.canWithPartialContext(_.Plq.DEAFEN_MEMBERS, { channelId: x })
                          ...
                          : null,
                      !U && null != w && j.Z.canWithPartialContext(_.Plq.MOVE_MEMBERS, { channelId: x })
                          ? (0, l.jsx)(
                                o.sNh,
                                {
                                    id: "voice-disconnect",
        ...
        z =
            null != w &&
            j.Z.canManageUser(_.Plq.MODERATE_MEMBERS, e, w) &&
            j.Z.canManageUser(_.Plq.KICK_MEMBERS, e, w) &&
            j.Z.canManageUser(_.Plq.BAN_MEMBERS, e, w),
        $ = null != w && (j.Z.canManageUser(_.Plq.MANAGE_GUILD, e, w) || j.Z.canManageUser(_.Plq.MANAGE_ROLES, e, w));
    if (
        !U &&
        null != w &&
        null != Y &&
        null != Y.joinedAt &&
        (z || $) &&
        w.features.has(_.oNc.GUILD_ONBOARDING_EVER_ENABLED)
    ) {
        var ee;
        X = (0, m.yE)(null != (ee = Y.flags) ? ee : 0, P.q.BYPASSES_VERIFICATION)
            ? (0, l.jsx)(
                  o.sNh,
                  {
                      id: "verify",
                      ...
                      action: () => {
                          ...
                          return u.Z.setMemberFlags(
                              w.id,
                              e.id,
                              (0, m.mB)(null != (t = Y.flags) ? t : 0, P.q.BYPASSES_VERIFICATION, !1),
                          );
                      },
                  },
                  "verify",
                  ...
                  o.sNh,
                  {
                      ...
                      action: () => {
                          ...
                          return u.Z.setMemberFlags(
                              w.id,
                              e.id,
                              (0, m.mB)(null != (t = Y.flags) ? t : 0, P.q.BYPASSES_VERIFICATION, !0),
                          );
                      },
                  },
                  "verify",
