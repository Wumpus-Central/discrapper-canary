...
function M(e, t, M, N, C) {
    ...
    let x = (0, i.e7)([_.Z], () => _.Z.getGuild(t), [t]),
        ...
        J = async (t, n, l) => {
            if (t.ctrlKey || t.metaKey)
                try {
                    var r;
                    await a.Z.setCommunicationDisabledDuration(n, l, j.UK.DURATION_60_SEC, null, N), Y(b.jQ.TIMEOUT), (0, o.showToast)((0, o.createToast)(A.intl.formatToPlainString(A.t.O9C3Nj, { user: null != (r = Z.ZP.getName(n, null, e)) ? r : '' }), o.ToastType.SUCCESS));
                } catch (e) {
    ...
    if (!U && null != x && null != W && null != W.joinedAt && (z || $) && x.hasFeature(S.oNc.GUILD_ONBOARDING_EVER_ENABLED)) {
        var ee;
        X = (0, p.yE)(null != (ee = W.flags) ? ee : 0, P.q.BYPASSES_VERIFICATION)
            ? (0, l.jsx)(
                  o.sNh,
                  {
                      id: 'verify',
                      ...
                      action: () => {
                          var t;
                          return u.Z.setMemberFlags(x.id, e.id, (0, p.mB)(null != (t = W.flags) ? t : 0, P.q.BYPASSES_VERIFICATION, !1));
                      }
                  },
                  'verify'
              )
            : (0, l.jsx)(
                  o.sNh,
                  {
                      ...
                      action: () => {
                          var t;
                          return u.Z.setMemberFlags(x.id, e.id, (0, p.mB)(null != (t = W.flags) ? t : 0, P.q.BYPASSES_VERIFICATION, !0));
                      }
                  },
                  'verify'
              );
