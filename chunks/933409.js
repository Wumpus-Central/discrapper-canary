...
function h(e, t, h, T, C) {
    let D = l.useMemo(() => ({ [t]: [e.id] }), [t, e.id]),
        U = null != T ? [T] : [];
    (0, c.$)(D), (0, i.e7)([_.Z], () => _.Z.getGuildVersion(t), [t]);
    let R = (0, i.e7)([y.Z], () => y.Z.getGuild(t), [t]),
        ...
        Q =
            null != K && null != h && _.Z.canWithPartialContext(S.Plq.VIEW_CHANNEL, { channelId: K }) && !w
                ? [
                      (!k || (k && !F)) && _.Z.canWithPartialContext(S.Plq.MUTE_MEMBERS, { channelId: h })
                          ? (0, r.jsx)(
                                a.S89,
                                {
                                    id: 'voice-mute',
                          ...
                          : null,
                      (!k || (k && !F)) && _.Z.canWithPartialContext(S.Plq.DEAFEN_MEMBERS, { channelId: h })
                          ? (0, r.jsx)(
                                a.S89,
                                {
                                    id: 'voice-deafen',
                      ...
                      !L && null != R && _.Z.canWithPartialContext(S.Plq.MOVE_MEMBERS, { channelId: h })
                          ? (0, r.jsx)(
                                ...
                                {
                                    id: 'voice-disconnect',
                                    label: L ? N.intl.string(N.t['6vrfgo']) : N.intl.string(N.t['/jERiI']),
                                    color: 'danger',
        ...
        X = async (t, n, r) => {
            if (t.ctrlKey || t.metaKey)
                try {
                    var l;
                    await o.Z.setCommunicationDisabledDuration(n, r, A.UK.DURATION_60_SEC, null, T), Y(E.jQ.TIMEOUT), (0, a.showToast)((0, a.createToast)(N.intl.formatToPlainString(N.t.O9C3Nj, { user: null != (l = M.ZP.getName(n, null, e)) ? l : '' }), a.ToastType.SUCCESS));
                } catch (e) {
