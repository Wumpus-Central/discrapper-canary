...
function M(e, t, M, D, N) {
    let C = r.useMemo(() => ({ [t]: [e.id] }), [t, e.id]),
        w = null != D ? [D] : [];
    (0, c.$)(C), (0, i.e7)([y.Z], () => y.Z.getGuildVersion(t), [t]);
    let x = (0, i.e7)([_.Z], () => _.Z.getGuild(t), [t]),
        ...
        J = async (t, n, l) => {
            if (t.ctrlKey || t.metaKey)
                try {
                    var r;
                    await a.Z.setCommunicationDisabledDuration(n, l, j.UK.DURATION_60_SEC, null, D),
                        Y(b.jQ.TIMEOUT),
                        (0, o.showToast)(
                            (0, o.createToast)(
        ...
        z =
            null != x &&
            y.Z.canManageUser(S.Plq.MODERATE_MEMBERS, e, x) &&
            y.Z.canManageUser(S.Plq.KICK_MEMBERS, e, x) &&
            y.Z.canManageUser(S.Plq.BAN_MEMBERS, e, x),
    ...
    if (
        ...
        null != W.joinedAt &&
        (z || $) &&
        x.features.has(S.oNc.GUILD_ONBOARDING_EVER_ENABLED)
    ) {
        var ee;
                  ...
                  o.sNh,
                  {
                      ...
                      action: () => {
                          ...
                          return u.Z.setMemberFlags(
                              x.id,
                              e.id,
                              (0, Z.mB)(null != (t = W.flags) ? t : 0, P.q.BYPASSES_VERIFICATION, !1),
                          );
                      },
                  },
                  "verify",
                  ...
                  o.sNh,
                  {
                      ...
                      action: () => {
                          ...
                          return u.Z.setMemberFlags(
                              x.id,
                              e.id,
                              (0, Z.mB)(null != (t = W.flags) ? t : 0, P.q.BYPASSES_VERIFICATION, !0),
                          );
                      },
                  },
                  "verify",
