...
function T(e, t, T, U, A) {
    ...
    let x = (0, r.e7)([Z.Z], () => Z.Z.getGuild(t), [t]),
        ...
        Y = (0, c.Z)(t, e.id),
        z =
            null != F && null != T && b.Z.canWithPartialContext(S.Plq.VIEW_CHANNEL, { channelId: F }) && !B
                ? [
                      (!R || (R && !V)) && b.Z.canWithPartialContext(S.Plq.MUTE_MEMBERS, { channelId: T })
                          ? (0, l.jsx)(
                                a.S89,
                                {
                                    id: 'voice-mute',
                          ...
                          : null,
                      (!R || (R && !V)) && b.Z.canWithPartialContext(S.Plq.DEAFEN_MEMBERS, { channelId: T })
                          ? (0, l.jsx)(
                                a.S89,
                                {
                                    id: 'voice-deafen',
                          ...
                          : null,
                      !w && null != x && b.Z.canWithPartialContext(S.Plq.MOVE_MEMBERS, { channelId: T })
                          ? (0, l.jsx)(
                                a.sNh,
                                {
                                    id: 'voice-disconnect',
        ...
        H = async (t, n, l) => {
            if (t.ctrlKey || t.metaKey)
                try {
                    var i;
                    await o.Z.setCommunicationDisabledDuration(n, l, p.UK.DURATION_60_SEC, null, U), Q(f.jQ.TIMEOUT), (0, a.showToast)((0, a.createToast)(j.NW.formatToPlainString(j.t.O9C3Nj, { user: null !== (i = N.ZP.getName(n, null, e)) && void 0 !== i ? i : '' }), a.ToastType.SUCCESS));
                } catch (e) {
                    (0, a.showToast)((0, a.createToast)(j.NW.string(j.t.epyCur), a.ToastType.FAILURE));
                }
        },
        J = null,
        $ = null != x && b.Z.canManageUser(S.Plq.MODERATE_MEMBERS, e, x) && b.Z.canManageUser(S.Plq.KICK_MEMBERS, e, x) && b.Z.canManageUser(S.Plq.BAN_MEMBERS, e, x),
        X = null != x && (b.Z.canManageUser(S.Plq.MANAGE_GUILD, e, x) || b.Z.canManageUser(S.Plq.MANAGE_ROLES, e, x));
    if (!w && null != x && null != G && null != G.joinedAt && ($ || X) && x.hasFeature(S.oNc.GUILD_ONBOARDING_EVER_ENABLED)) {
        var ee;
        J = (0, h.yE)(null !== (ee = G.flags) && void 0 !== ee ? ee : 0, C.q.BYPASSES_VERIFICATION)
            ? (0, l.jsx)(
                  a.sNh,
                  {
                      id: 'verify',
