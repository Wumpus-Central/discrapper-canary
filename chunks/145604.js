...
class J extends i.PureComponent {
    componentDidUpdate(e) {
        ...
        if (e.voiceChannelId !== u && null != u) {
            ...
            null != l &&
                N.default.getOverlayMethod(l) !== C.gl.Disabled &&
        ...
        if (e.runningGame !== w && null != w && !w.isLauncher && (!B || H)) {
            ...
            if (
                ...
                null != w.name && null != R && A.Z.shouldReport(w.name))
            ) {
                let e = w.name;
                ...
                let e = D.Z.getMessages(t),
                    i = e
                        ...
                        .find((e) => {
                            var t;
                            return (
                                (0, Y.yE)(e.flags, q.iLy.IS_CROSSPOST) &&
    ...
    let [e, t] = (0, l.Wu)([M.Z], () => [M.Z.getVoiceChannelId(), M.Z.getChannelId()], []),
        ...
        I = (0, l.e7)([w.ZP], () => {
            ...
            return (
                null != E &&
                null != g &&
                null != (t = null == (e = w.ZP.getMember(g, E.id)) ? void 0 : e.isPending) &&
                t
            );
        }, [E, g]),
        ...
        x = (0, l.e7)([b.ZP], () => b.ZP.getCurrentGameForAnalytics(), []),
        A = (0, O.Z)(g),
