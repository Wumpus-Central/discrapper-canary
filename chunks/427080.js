...
let L = (e, l) => {
        switch (e?.entity_type) {
            ...
            case R.Ps.VOICE:
                return (n) => {
                    n.stopPropagation(), v.default.selectVoiceChannel(e.channel_id, !1), l?.(n);
                };
        }
        return () => {};
    },
    U = i.memo(function (e) {
        let { guild: l, guildScheduledEvent: n, channel: a, isMember: t } = e,
            m = (0, r.bG)([C.A], () => {
            ...
            p = i.useCallback(
                (e) => {
                    t && null != n && (e.stopPropagation(), (0, x.rq)(n));
                },
                [t, n],
            ),
            v = i.useCallback(
        ...
        return (0, s.jsxs)("div", {
            className: z.Ix,
            children: [
                (0, s.jsx)(j.A.Icon, { guild: m, onClick: p }),
                (0, s.jsxs)("div", {
                    className: z.YG,
                    children: [
                        (0, s.jsxs)("div", {
                        ...
                        (0, s.jsx)("div", {
                            ...
                            children:
                                t && [R.Ps.STAGE_INSTANCE, R.Ps.VOICE].includes(n?.entity_type)
                                    ? (0, s.jsx)(u.D, { className: z.tR, onClick: v, children: I })
                                    : I,
                        }),
                    ],
                }),
    ...
    w = i.memo(function (e) {
        let {
            ...
            x = (0, r.bG)([f.Ay], () => f.Ay.isInterestedInEventRecurrence(n, i), [n, i]),
            v = (e) => {
                e.stopPropagation(), (0, P.A)(n, i, l);
            },
            N = (e) => {
                e.stopPropagation(), c ? a && o() : u();
            };
        return c
            ? a
                ? d
                    ? (0, s.jsx)(m.$, { text: T.intl.string(T.t.GoCQxU), variant: "secondary" })
                    : (0, s.jsx)(m.$, { text: T.intl.string(T.t.XpeFYr), onClick: N, variant: "active" })
                : t
                  ? (0, s.jsx)(m.$, { text: T.intl.string(T.t.Pj7Xrv), variant: "secondary", disabled: !0 })
                  : x
                    ? (0, s.jsx)(m.$, { text: T.intl.string(T.t.DlcqlU), onClick: v, variant: "active", icon: h.A })
                    : (0, s.jsx)(m.$, { text: T.intl.string(T.t.DlcqlU), onClick: v, variant: "secondary", icon: p.X })
            : (0, s.jsx)(m.$, { text: T.intl.string(T.t.XpeFYr), onClick: N, variant: "active" });
    }),
    $ = i.memo(function (e) {
        let {
            ...
            h = l?.recurrence_rule == null || null == m || (0, S.p$)((0, _.Sn)(l?.recurrence_rule), m),
            p = (0, E.A)(l),
            x = i.useCallback(() => {
            ...
            children: (0, s.jsxs)(u.D, {
                ...
                children: [
                    ...
                    (0, s.jsxs)("div", {
                        className: z.xQ,
                        children: [
                            (0, s.jsx)(U, { guild: n, channel: a, guildScheduledEvent: l, isMember: r }),
                            (0, s.jsx)(w, {
                                isActive: v,
                                isEnded: N,
                                isMember: r,
