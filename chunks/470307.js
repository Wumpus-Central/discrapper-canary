...
function E(e) {
    return (0, i.YW)(e)
        .with({ config_version: 2 }, (e) => ({
            ...
            taskConfigV2: (0, d.z)(e.task_config_v2),
            rewardsConfig: (0, o.S)(e.rewards_config),
            cosponsorMetadata: c(e.cosponsor_metadata),
            sharePolicy: e.share_policy,
            ctaConfig: (0, l.W)(e.cta_config),
        }))
        .exhaustive();
}
function u(e) {
        ...
        progress: (function (e) {
            ...
            for (let [i, a] of Object.entries(e)) {
                ...
                t[i] = {
                    ...
                    heartbeat:
                        null == (n = a.heartbeat) ? null : { lastBeatAt: n.last_beat_at, expiresAt: n.expires_at },
                };
            }
            return t;
        })(e.progress),
...
function T(e) {
    return e.type === a.l.VIRTUAL_CURRENCY
        ? {
              skuId: e.sku_id,
              type: e.type,
              name: e.name,
...
function h(e) {
    ...
    return {
        ...
        config: {
            ...
            cosponsorMetadata: c(t.cosponsor_metadata),
        },
        userStatus: null == e.user_status ? null : u(e.user_status),
    };
}
    ...
    return {
        ...
        tenantMetadata: (function (e) {
            ...
            switch (t.reward.tag) {
                ...
                case a.l.REWARD_CODE:
                    return { questRewards: { reward: { tag: t.reward.tag, rewardCode: S(t.reward.reward_code) } } };
            }
        })(e.tenant_metadata),
        consumed: e.consumed,
    };
...
function f(e) {
    return { claimedAt: e.claimed_at, items: e.entitlements.map(N), errors: e.errors };
}
function p(e) {
    var t;
    if (1 !== e.version || !(r.gh.QUEST_HOME_BANNER in e.placements)) return null;
    let n = e.placements[r.gh.QUEST_HOME_BANNER];
    return null == n
        ? null
        : {
              id: n.campaign_id,
