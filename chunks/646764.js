...
let M = function (e) {
    let t,
        ...
        V = (0, x.Ut)(),
        Y = (0, g.go)(),
        H = (0, o.bG)([C.Ay], () => C.Ay.useReducedMotion),
        z = (0, o.bG)([R.default], () => R.default.getCurrentUser()),
        B = n.useMemo(
            () =>
                (0, h.ks)(i.config) && i.userStatus?.claimedAt != null
                    ? S.intl.formatToPlainString(S.t["nLXlh+"], {
        ...
        G = n.useMemo(() => (0, _.tW)(i, _.fY.REWARD, void 0, void 0, U), [i, U]),
        K = n.useMemo(() => (0, _.tW)(i, _.fY.REWARD_IMAGE), [i]),
        O = n.useCallback(
            (t) => {
                (0, u.vq)(t.currentTarget, HTMLElement) && t.currentTarget.blur(),
                    (0, N.E5)(N.kI.STEP_2_CLICKED_INTERNAL, "quest_reward_tile")
                        ? (0, A.r)({
                    ...
                    (0, v.navigateToQuestHome)({ fromContent: e.questContent, questId: i.id }),
                    e.onClick?.(t);
            },
            [V, i.id, e, W, Y],
        ),
    ...
    if (
        (n.useEffect(() => {
            if (null != X.current) {
                ...
                M && !F.current
                    ? X.current.play()
                    : !M && F.current && ((X.current.currentTime = 0), X.current.pause()),
                    (F.current = M);
            }
        }, [M, G, H]),
        (0, q.A)(X, I.rE.QUEST_HOME_DESKTOP),
        Z)
    )
        t = (0, r.jsx)(j.Sn, {
        ...
        t = (0, r.jsx)(w.N, {
            ...
            imageAsset:
                null != K
                    ...
                    : void 0,
            videoAsset: { asset: G, assetId: "QuestRewardTile_rewardTileAnimated", className: l()(L.eB, L.WY) },
        ...
        t = (0, r.jsx)(j.Sn, {
            ...
            children: (t) =>
                (0, r.jsxs)(r.Fragment, {
                    children: [
                        null != s && (0, r.jsx)("img", { alt: S.intl.string(S.t.UMclVN), className: L.XM, src: s }),
                        (0, r.jsx)(E.A, {
                            ref: (e) => {
        ...
        t = (0, r.jsx)(j.Sn, {
            ...
            children: (t) =>
                (0, r.jsx)("img", { ref: t, alt: B, className: l()(L.eB, L.Qz), src: G.url, onLoad: e.onLoadComplete }),
        });
    return null == Q
