...
function P(e) {
    ...
    return (
        ...
        N.p5
            ? (0, i.jsxs)(E.D, {
                  className: _()(w.S, n ? w.pG : null),
                  onClick: o,
                  children: [
                      (0, i.jsx)(h.q, { size: "md", color: "currentColor", className: w.n7 }),
    ...
    return (0, i.jsxs)(r.Fragment, {
        children: [
            (0, i.jsxs)("div", {
                className: w.NT,
                children: [
                    (0, i.jsx)(m.E, { variant: "text-sm/medium", className: w.V$, children: t }),
                    (0, i.jsx)("div", { className: w.Jb, children: n }),
                ],
            }),
            (0, i.jsx)(f.$, { text: o, loading: d, variant: s, onClick: a, fullWidth: !0, disabled: l }),
        ],
    });
}
let M = (e) => {
        ...
        children: [
            (0, i.jsxs)(m.E, {
                ...
                children: [
                    ...
                    (0, i.jsx)(g.Anchor, {
                        className: w.Pl,
                        href: C.A.getArticleURL(L.MVz.BUILD_OVERRIDE_EMBED),
                        target: "_blank",
                        children: (0, i.jsx)(p.m, { size: "xs", color: "currentColor", className: w.G }),
                    }),
                    t ? null : (0, i.jsx)(P, { url: a }),
                ],
            }),
            (0, i.jsxs)("div", {
                className: w.Qs,
                    ...
                    t
                        ? (0, i.jsxs)(r.Fragment, {
                              children: [
                                  (0, i.jsxs)("div", {
                                      className: w.NT,
                                      children: [
                                          (0, i.jsx)("div", { className: _()(w.Pz, w.w9) }),
                        ...
                        : (function (e) {
                              let t,
                                  ...
                                  d = ["discord_web"];
                              R.isPlatformEmbedded || d.push("discord_marketing", "discord_developers");
                              let _ = (function (e, t) {
                                  ...
                                  let {
                                      ...
                                      o = Object.keys(a);
                                  if (0 === y().intersection(o, t).length)
                                      return {
                                          valid: !1,
                                          reason: b.intl.formatToPlainString(b.t.wySUzv, {
                                              requestedTargets: o.map((e) => D.v_[e] ?? "unknown").join(", "),
                                          }),
                                      };
                                  ...
                                  return null != l && l < Date.now()
                                      ...
                                      : r.length > 0 && !r.includes(v.default.getId())
                              ...
                              let { discord_web: E, discord_developers: h } = s.targetBuildOverride,
                                  m = E ?? h;
                              return (
                                  (c()(
                                      null != m,
                                  ...
                                  null == r || null == r.discord_web
                                      ? 1
                                      : m.id !== r.discord_web.id || m.type !== r.discord_web.type)
                                      ? ((n = b.intl.string(b.t.nOunHC)), (t = a), (i = "primary"))
                                      : ((n = b.intl.string(b.t.tX4xrt)), (t = o), (i = "critical-primary")),
                                  k({
                                      subHead: b.intl.string(b.t.RCYGot),
                                      buildDetails: m.id,
                                      buttonClick: () => {
                                          I.A.isConnected()
                                              ? A.A.show({
...
let F = r.memo(function (e) {
    let { url: t } = e,
        ...
        { payload: d, validatedURL: _ } = a,
        u = n.state === o.U.Resolving || a.state === o.U.Resolving,
        c = r.useCallback(
            () =>
