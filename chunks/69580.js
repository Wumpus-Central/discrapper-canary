        ...
        return (
            (e =
                !0 === d
                    ...
                    : (0, r.jsxs)(r.Fragment, {
                          children: [(0, r.jsx)(R.Dx, { children: eo.intl.string(eo.t['Z+hCVV']) }), (0, r.jsx)(E.$, {})]
                      })),
            (0, r.jsx)(ee.G, {
...
function em(e) {
    ...
    let { header: n, body: i, footer: a, nextStep: s, appDetails: l, hasContentBackground: c, minimalPadding: u, extraWide: d, modalSize: f } = eg(ec({}, ef(e, ['transitionState']))),
        _ = A.w.useExperiment({ location: 'oauth2_authorize' }),
        p = (0, r.jsxs)(r.Fragment, {
            children: [
                n,
                (0, r.jsxs)('div', {
                    className: o()(es.contentWrapper, u ? es.minimalPadding : null),
                    children: [
                        (0, r.jsxs)('div', {
                            className: o()(es.content, c ? es.contentBackground : null, u ? es.minimalPadding : null, d ? es.extraWide : null),
...
function eg(e) {
    ...
    let g,
        ...
        D,
        ee,
        { clientId: ea, responseType: el, redirectUri: eu, codeChallenge: ef, codeChallengeMethod: e_, state: eh, nonce: em, prompt: eg, authorizations: eE, scopes: eb, permissions: ey, guildId: ev, channelId: eO, integrationType: eI, disableGuildSelect: eS = !1, showLogout: eT = !1, cancelCompletesFlow: eA = !0, isTrustedName: eN = !1, isEmbeddedFlow: eC = !1, callback: eR, callbackWithoutPost: eP, onClose: ew, disclosures: eD, isExternalStandaloneOAuthPage: eL = !1 } = e,
    ...
    let [ej, eU] = i.useState(null),
        ...
        e6 = i.useMemo(() => {
            var e;
            return null == ex && null == eI && (null != (e = null == eb ? void 0 : eb.length) ? e : 0) === 0 && null == eu;
        }, [ex, null == eb ? void 0 : eb.length, eu, eI]),
        [e8, e7] = i.useState(null);
    i.useEffect(() => {
        e6 && N.ZP.fetchApplication(ea).then((e) => e7(x.ZP.createFromServer(e)));
    }, [ea, e6]);
    let e9 = i.useMemo(() => {
            var e, t;
    ...
    let tc = i.useCallback(
            ...
            [eP, eA, eR, null == ej ? void 0 : ej.application, e3, ew, ea, tt, el, eu, ef, e_, eh, em, tr, eJ, ez, e4, eQ, ta, e0]
        ),
        tu = i.useRef(!1),
        td = i.useCallback(async () => {
            ...
            if (!ti.current && !tu.current) {
                ...
                try {
                    ...
                    eU((0, Z.d)(e)),
                        eg === W.s.NONE && e.authorized && !ts && tc(!0),
        ...
        }, [eM, ex, ea, tt, el, eu, ef, e_, eh, em, e4, eg, tc, ts]),
        tf = i.useMemo(() => {
            var e;
            return null != e8 && e6
    ...
    switch (eG) {
        ...
        case 'SELECT_INSTALL_TYPE':
            if (null == e8) return { body: (0, r.jsx)(E.$, { className: es.spinner }) };
            (g = (0, r.jsx)($.Z, {
                application: e8,
                onSelect: tm,
                onClose: ew
        ...
        case 'AUTHORIZE_SCOPES':
            if (null == ej || null == e2 || null == e4) return { body: (0, r.jsx)(E.$, { className: es.spinner }) };
            ...
            (g = (0, r.jsxs)(r.Fragment, {
                children: [
                    ...
                    tC
                        ? (0, r.jsx)(b.j7V, {
                              ...
                              note: eo.intl.string(eo.t.hw1nKS),
                              value: e0,
                              children: (0, r.jsx)(b.Text, {
                                  variant: 'text-sm/medium',
                                  children: eo.intl.string(eo.t['Pkw//v'])
                              })
                          })
                        : null,
                    (0, r.jsx)('div', {
                ...
                tt.includes(u.x.BOT) && !f.fS(tr, G.Hn) && (R = 'AUTHORIZE_BOT_PERMISSIONS'),
                tf.length > 1 && (T = 'SELECT_INSTALL_TYPE'),
                (tb = (tN && null == e3) || (tA && null == eQ)),
                (tE = !0);
            break;
        case 'AUTHORIZE_BOT_PERMISSIONS':
            if (null == ej) return { body: (0, r.jsx)(E.$, { className: es.spinner }) };
            (g = (0, r.jsx)(Q.Z, {
                application: ej.application,
                permissions: tr,
                    ...
                    'SELECT_INSTALL_TYPE' !== eG
                        ? eY
                            ? (0, r.jsx)('div', {
                                  className: es.action,
                                  children: (0, r.jsx)(h.zx, {
                                      onClick: null != R ? () => eB(R) : () => tc(!0),
                                      submitting: eZ,
                                      disabled: null == P || tb,
                                      children: tb ? eo.intl.string(eo.t.BwwiSE) : null != R ? eo.intl.string(eo.t['3PatS0']) : eo.intl.string(eo.t['y+/PEx'])
                                  })
                              })
                            : (0, r.jsx)('div', {
                                  className: es.action,
...
function eE(e, t) {
    ...
    l && o === ei.Z5c.OAUTH2_AUTHORIZED
        ...
        : l && (null == o ? void 0 : o.startsWith(ei.Z5c.OAUTH2_ERROR))
          ? (0, m.h7)((e) => {
                var t, n;
                let i = null != (n = null != (t = null == s ? void 0 : s.get('error_description')) ? t : null == s ? void 0 : s.get('error')) ? n : eo.intl.string(eo.t['mqn87+']);
                return (
...
function ev(e) {
    var t;
    let { hostname: n = '', host: r, pathname: i, search: a } = null != (t = B.Z.toURLSafe(e)) ? t : {};
    return null != i && null != a && (B.Z.isDiscordHostname(n) || r === window.location.host) && (i.startsWith('/api'.concat(ei.ANM.OAUTH2_AUTHORIZE)) || i.startsWith(ei.Z5c.OAUTH2_AUTHORIZE)) ? (0, V.y)(a) : null;
}
