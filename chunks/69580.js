                ...
                !0 === d
                    ? (0, r.jsxs)(r.Fragment, {
                          children: [
                              ...
                              (0, r.jsx)(N.DK, { children: o ? en.intl.string(en.t['m1+IBg']) : en.intl.string(en.t.kRzrSE) }),
                              (0, r.jsx)(h.z, {
                                  onClick: () => c(!0),
                                  variant: 'primary',
...
function ec(e) {
    let { label: t, title: n, subtitle: i, header: o, body: s, actions: l, nextStep: c, appDetails: u, hasContentBackground: d, noPadding: f, modalSize: _ } = ed(eo({}, e)),
...
function ed(e) {
    ...
    let h,
        ...
        N,
        C,
        { clientId: P, responseType: Q, redirectUri: et, codeChallenge: ei, codeChallengeMethod: eo, state: ea, nonce: es, prompt: el, authorizations: ec, scopes: ed, permissions: ef, guildId: e_, channelId: ep, integrationType: eh, disableGuildSelect: em = !1, showLogout: eg = !1, cancelCompletesFlow: eE = !0, isTrustedName: eb = !1, isEmbeddedFlow: ey = !1, callback: eO, callbackWithoutPost: ev, onClose: eI, disclosures: eT, isExternalStandaloneOAuthPage: eS = !1, isTwoWayLinkDiscordConsent: eA = !1 } = e,
    ...
    let tr = i.useCallback(
            ...
            [ev, eE, eO, null == eP ? void 0 : eP.application, eQ, eI, P, e4, Q, et, ei, eo, ea, es, e8, eY, eZ, eJ, eV, e9, eK]
        ),
        ti = i.useRef(!1),
...
function e_(e, t) {
    if ((0, P.g)('create-guild-and-oauth2-modal')) return void C.Z.openCreateGuildModal({ onSuccess: (n) => ep(es(eo({}, e), { guildId: n }), t) });
    ep(e, t);
}
function ep(e, t) {
    (0, _.h7)(
