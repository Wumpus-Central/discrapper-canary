...
function P(e) {
    let { channel: t, closePopout: n, onSelect: l } = e,
        ...
        G = (0, g.A)(t),
        U = (0, m.A)(t),
        P = (0, v.A)({ id: t.id, label: D.intl.string(D.t.DQ797g) }),
        w = (0, S.A)(t),
        k = (0, x.A)(t),
        V = (0, A.$)(1e3);
    function B() {
    ...
    function H(e) {
        let n = a()(() => {
                R._.unsubscribe(M.jej.CHANNEL_TEXT_AREA_FOCUSED, i), e();
            }, 250),
            i = (e) => {
                e.channelId === t.id && n();
            };
        R._.subscribe(M.jej.CHANNEL_TEXT_AREA_FOCUSED, i),
            V.addEventListener("abort", () => {
                R._.unsubscribe(M.jej.CHANNEL_TEXT_AREA_FOCUSED, i);
            });
    }
    return (0, i.jsxs)(d.W, {
        ...
        onClose: n,
        "aria-label": D.intl.string(D.t["1NBjqb"]),
        onSelect: l,
        children: [
            (0, i.jsxs)(c.rX, {
                children: [s, (0, i.jsx)(c.Dr, { id: "open", label: D.intl.string(D.t.IxVmZi), action: B })],
            }),
            ...
            (0, i.jsxs)(c.rX, {
                children: [
                    (0, i.jsx)(c.Dr, {
                        ...
                        action: function () {
                            H(() => {
                                R._.dispatch(M.jej.FOCUS_SEARCH, { prefillCurrentChannel: !1 });
                            }),
                                B();
                        },
                    }),
                    (0, i.jsx)(c.Dr, {
                        id: "pins",
                        label: D.intl.string(D.t["2BSH7n"]),
                        icon: u.t,
                        trailingIndicator: { type: "icon", icon: u.t },
                        action: function () {
                            H(() => {
                                R._.dispatch(M.jej.TOGGLE_CHANNEL_PINS);
                            }),
                                B();
                        },
                    }),
