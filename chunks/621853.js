...
function z(e) {
    ...
    (s.fetchStartedAt = o), (s.fetchEndedAt = Date.now()), (s.fetchError = a), A.set(r, s), (null == a ? void 0 : a.status) === 404 && (D.set(r, 0), w.set(r, x), L.set(r, M));
}
function q(e) {
...
function en(e) {
    return [...A.keys()].reduce((e, t) => eo(t) || e, !1);
}
function er(e) {
    return eo(e.user.id);
}
