...
async function C() {
    ...
    };
    {
        ...
        if (null != n) {
            var p, m, O, N, I, C, S, T, P, j, A, Z, x, w, L, R, D, k, M, U, G, W, V, B;
            (u.electron_process_memory_private = [null != (x = null == (p = n.unknown) ? void 0 : p.wss_priv_kb) ? x : -1, null != (w = null == (m = n.main) ? void 0 : m.wss_priv_kb) ? w : -1, null != (L = null == (O = n.renderer) ? void 0 : O.wss_priv_kb) ? L : -1, null != (R = null == (N = n.gpu) ? void 0 : N.wss_priv_kb) ? R : -1, null != (D = null == (I = n.crashpad) ? void 0 : I.wss_priv_kb) ? D : -1, null != (k = null == (C = n.utility) ? void 0 : C.wss_priv_kb) ? k : -1]), (u.electron_process_memory_private_and_shared = [null != (M = null == (S = n.unknown) ? void 0 : S.wss_kb) ? M : -1, null != (U = null == (T = n.main) ? void 0 : T.wss_kb) ? U : -1, null != (G = null == (P = n.renderer) ? void 0 : P.wss_kb) ? G : -1, null != (W = null == (j = n.gpu) ? void 0 : j.wss_kb) ? W : -1, null != (V = null == (A = n.crashpad) ? void 0 : A.wss_kb) ? V : -1, null != (B = null == (Z = n.utility) ? void 0 : Z.wss_kb) ? B : -1]);
        }
