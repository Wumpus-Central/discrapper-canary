n.d(t, { Z: () => eo }), n(266796), n(47120), n(653041), n(789020);
var r,
    i = n(200651),
    s = n(192379),
    a = n(120356),
...
function ei(e) {
    let { guildId: t, guildProductListingId: n } = e,
        ...
        a = (0, j.C)(r),
        o = (0, m.e7)([R.Z], () => R.Z.getGuild(t)),
        l = (null == r ? void 0 : r.role_id) != null && (null == r ? void 0 : r.attachments_count) === 0 ? z.NW.string(z.t.H11qcX) : a,
...
function es(e) {
    ...
    let { guildId: r, guildProductListingId: s } = e,
        ...
        o = (0, m.e7)([E.Z], () => E.Z.getGuildProductFetchState(s) === E.M.FETCHING),
        l = null == a ? void 0 : a.role_id,
        c = (0, m.e7)([R.Z], () => (null != l ? R.Z.getRole(r, l) : void 0), [r, l]),
...
class ea extends (r = s.PureComponent) {
    ...
    renderPaymentBreakdown() {
        let { payment: e, locale: t, application: n } = this.props,
            { taxInclusive: r, tax: a, amount: l, amountRefunded: c, currency: d } = e,
    ...
    renderRefundDetails() {
        ...
        return (
            (e = r.includes('SKU_TYPE')
                ? z.NW.format(z.t['5lvoVV'], { supportURL: o })
                : a
                  ...
                  : n.isCollectible
                    ...
                    : n.isGift
                      ? z.NW.formatToPlainString(z.t.owlOWV, { dateLimit: l })
                      : n.isPremiumSubscription || n.isPremiumGuildSubscription
                        ? z.NW.formatToPlainString(z.t.dk7vyM, { dateLimit: l })
    ...
    renderDescription() {
        let e, t;
        let { compactMode: n, payment: r, application: a, guild: o, stickerPack: l, plan: d } = this.props,
        ...
        if (null != p && 0 !== p.items.length) {
            ...
            if (((t = r.isGuildProductPurchase && r.isSoftDeletedProduct ? z.NW.string(z.t.O7uLm5) : m.name), null != l)) {
                ...
                e =
                    (null === (f = r.sku) || void 0 === f ? void 0 : f.productLine) === G.POd.COLLECTIBLES
                        ? (0, i.jsx)(g.EOn, {
                              size: 'custom',
                              width: 23,
                              height: 23,
                        ...
                        q(
                            {
                                ...
                                className: o()(r ? Y.payment : Y.hoverablePayment, t, { [Y.compact]: n }),
                                focusProps: { offset: 4 }
                            },
                            e
                        ),
