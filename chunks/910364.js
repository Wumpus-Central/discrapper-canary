...
function D(e) {
    let { user: n, currentUser: t, guildId: D, channelId: W, messageId: F, roleId: k, sessionId: G, friendToken: V, initialSection: Y, initialSubsection: K, transitionState: X, customStatusPrompt: z, onClose: J, showGuildProfile: q = !0, sourceAnalyticsLocations: H = [] } = e,
                                                ...
                                                (null == er ? void 0 : er.guildId) == null
                                                    ...
                                                    : (null == et ? void 0 : et.guildId) != null
                                                      ? (0, r.jsx)(s.sNh, {
                                                            ...
                                                            subtext: M.NW.formatToPlainString(M.t['mn/nW1'], { displayName: v.ZP.getName(void 0, void 0, n) }),
                                                            action: () => {
                                                                J(),
                                                      ...
                                                      : (0, r.jsx)(s.sNh, {
                                                            ...
                                                            subtext: M.NW.formatToPlainString(M.t['mn/nW1'], { displayName: v.ZP.getName(D, W, n) }),
                                                            action: () => {
                                                                J(),
                                                                    (0, C.openUserProfileModal)(
                                                                        B(U({}, $), {
