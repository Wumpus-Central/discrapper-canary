...
null != A &&
    ...
    (R = null === (o = (s = A.remoteApp).getBuildNumber) || void 0 === o ? void 0 : o.call(s)));
let x = new Set(['discord_erlpack', 'discord_game_utils', 'discord_rpc', 'discord_spellcheck', 'discord_utils', 'discord_voice']),
    L = !1;
async function w(e) {
    let n = {
            method: 'GET',
...
!(function (e) {
    ...
    (n.ZP = {
        ...
        ensureModule: (e) => (b.isPlatformEmbedded ? (__OVERLAY__ && x.has(e) ? Promise.resolve() : A.nativeModules.ensureModule(e)) : Promise.reject(Error('not embedded'))),
        ...
        setOnInputEventCallback(e) {
            if (!!b.isPlatformEmbedded) this.getDiscordUtils().inputWatchAll(e);
        },
        setFocused(e) {
        ...
        clearObserverDebugCallback() {
            this.getDiscordUtils().setObserverDebugCallback(null, y.l.NONE, 0);
        },
        ...
        isSystemDarkMode() {
            var e, n, r;
            return !!(0, b.isWindows)() && (null === (r = null === (e = (n = this.getDiscordUtils()).isSystemDarkMode) || void 0 === e ? void 0 : e.call(n)) || void 0 === r || r);
        },
        getGameUtils() {
        ...
        setBadge(e) {
            if ('darwin' === (0, b.getPlatformName)()) {
                let n = '';
                -1 === e ? (n = '\u2022') : e > 0 && (n = ''.concat(e)), A.remoteApp.dock.setBadge(n);
            } else 'win32' === (0, b.getPlatformName)() ? this.send('APP_BADGE_SET', e) : 'linux' === (0, b.getPlatformName)() && A.remoteApp.setBadgeCount(e >= 0 ? e : 0);
        },
        setSystemTrayIcon(e) {
            if (!!b.isPlatformEmbedded) this.send('SYSTEM_TRAY_SET_ICON', e);
        },
        setThumbarButtons(e) {
            var n, r;
            if (!!b.isPlatformEmbedded) null === (r = A.thumbar) || void 0 === r || null === (n = r.setThumbarButtons) || void 0 === n || n.call(r, e, this.isSystemDarkMode());
        },
        bounceDock(e) {
        ...
        setSystemTrayApplications(e) {
            if (!!b.isPlatformEmbedded) this.send('SYSTEM_TRAY_SET_APPLICATIONS', e);
        },
        get architecture() {
            return b.isPlatformEmbedded ? A.process.arch : '';
        },
        get releaseChannel() {
        ...
        copy(e) {
            b.isPlatformEmbedded && A.clipboard.copy(e);
        },
        async copyImage(e) {
            h()(b.isPlatformEmbedded, 'Copy image method called outside native app'), h()('function' == typeof A.clipboard.copyImage, 'Copy image not supported');
            let n = await P(e);
        ...
        async saveImage(e) {
            var n;
            h()(b.isPlatformEmbedded, 'Save image method called outside native app');
            let r = I.Z.toURLSafe(e);
            if (null == r) return;
            let i = null !== (n = r.pathname.split('/').pop()) && void 0 !== n ? n : 'unknown',
                a = await P(e),
                o = S.from(a);
            return A.fileManager.saveWithDialog(o, i);
        },
        async saveFile(e, n) {
            var r;
            h()(b.isPlatformEmbedded, 'Save file method called outside native app');
            let i = I.Z.toURLSafe(e);
            if (null == i) return;
            let a = null !== (r = null != n ? n : i.pathname.split('/').pop()) && void 0 !== r ? r : 'unknown',
                o = await w(e),
                s = S.from(o);
            return A.fileManager.saveWithDialog(s, a);
        },
        canCopyImage() {
            let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : void 0;
            if (null != e) {
                var n, r;
                let i = null === (n = I.Z.toURLSafe(e)) || void 0 === n ? void 0 : n.pathname;
                if (null == i) return !1;
                let a = null === (r = i.split('.').pop()) || void 0 === r ? void 0 : r.toLowerCase();
                if (null != a && !C.includes(a)) return !1;
            }
            return 'function' == typeof A.clipboard.copyImage;
        },
        cut() {
            b.isPlatformEmbedded && A.clipboard.cut();
        },
        paste() {
            b.isPlatformEmbedded && A.clipboard.paste();
        },
        readClipboard: () => (b.isPlatformEmbedded ? A.clipboard.read() : ''),
        on(e, n) {
            A.ipc.on(e, n);
        },
        invoke(e) {
        ...
        focus(e) {
            ...
            n && (0, b.isWindows)() && this.minimize(null), A.window.focus(n, e);
        },
        blur() {
            b.isPlatformEmbedded && null != A.window.blur ? A.window.blur() : window.blur();
        },
        fullscreen(e) {
        ...
        purgeMemory() {
            if (!!b.isPlatformEmbedded) A.processUtils.purgeMemory();
        },
        ...
        flushDNSCache() {
            b.isPlatformEmbedded && A.processUtils.flushDNSCache();
        },
        supportsFeature: (e) => A.features.supports(e),
        getEnableHardwareAcceleration: () => !b.isPlatformEmbedded || (!__OVERLAY__ && A.gpuSettings.getEnableHardwareAcceleration()),
        ...
        getGPUDriverVersions() {
            return (0, b.isWindows)() && null != this.getDiscordUtils().getGPUDriverVersions ? this.getDiscordUtils().getGPUDriverVersions() : Promise.resolve(Object.freeze({}));
        },
        setZoomFactor: (e) => !!b.isPlatformEmbedded && (A.window.setZoomFactor(e), !0),
        ...
        getPidFromDesktopSource(e) {
            if (!(0, b.isDesktop)() || null == this.getDiscordUtils().getPidFromWindowHandle) return null;
        ...
        getDesktopSourceFromPid(e) {
            if (!(0, b.isWindows)() || null == this.getDiscordUtils().getWindowHandleFromPid || null == e) return null;
        ...
        setCrashInformation(e, n) {
            var r;
            if (!!b.isPlatformEmbedded && (null == A ? void 0 : null === (r = A.processUtils) || void 0 === r ? void 0 : r.setCrashInformation) != null) A.processUtils.setCrashInformation(e, n);
        },
        blockDisplaySleep: () => (b.isPlatformEmbedded && null != A.powerSaveBlocker ? A.powerSaveBlocker.blockDisplaySleep() : null),
        unblockDisplaySleep(e) {
            if (!!b.isPlatformEmbedded && null != A.powerSaveBlocker) A.powerSaveBlocker.unblockDisplaySleep(e);
        },
        cleanupDisplaySleep() {
            if (!!b.isPlatformEmbedded && null != A.powerSaveBlocker) A.powerSaveBlocker.cleanupDisplaySleep();
        },
        relaunch() {
            if (!!b.isPlatformEmbedded) null != A.remoteApp.relaunch && A.remoteApp.relaunch();
        },
        makeChunkedRequest(e, n, r) {
            let i = ''.concat((0, g.K0)()).concat(e);
            if (!b.isPlatformEmbedded) return Promise.reject(Error('Not embedded!'));
        ...
        submitLiveCrashReport(e) {
            if (!(0, b.isWindows)() || null == this.getDiscordUtils().submitLiveCrashReport) return Promise.resolve();
        ...
        GetWindowFullscreenTypeByPid(e, n, r) {
            ...
            let { getWindowFullscreenTypeByPid: a } = this.getDiscordUtils(),
                o = 0 !== e && null != a && null != n ? a(e, n) : null;
            return -1 === o && (o = null), null !== (i = null != o ? o : r) && void 0 !== i ? i : v.Jx.UNKNOWN;
        },
        ...
        isModuleVersionAtLeast(e, n) {
            ...
            o.push(null !== (i = null === (r = this.moduleVersions) || void 0 === r ? void 0 : r[e]) && void 0 !== i ? i : 0);
            let s = null !== (a = n[this.releaseChannel]) && void 0 !== a ? a : n.stable;
        ...
        fetchRiotGamesLiveClientData: (e, n) => (b.isPlatformEmbedded ? (null == A.riotGames ? Promise.reject(Error('Riot Games module not available')) : A.riotGames.fetchLiveClientData(e, n)) : Promise.reject(Error('Not embedded!'))),
        appViewed() {
            if (!!(0, b.isDesktop)()) this.send('APP_VIEWED');
        }
    });
