...
null != S &&
    ((N = S.remoteApp
        ...
        .split(".")
        .map((e) => parseInt(e))),
    (w = null == (r = (i = S.remoteApp).getModuleVersions) ? void 0 : r.call(i)),
...
let q = {
        ...
        setBadge(e) {
            if ("darwin" === (0, h.getPlatformName)()) {
                ...
                "win32" === (0, h.getPlatformName)()
                    ...
                    : "linux" === (0, h.getPlatformName)() && S.remoteApp.setBadgeCount(e >= 0 ? e : 0);
        },
        setSystemTrayIcon(e) {
        ...
        canCopyImage() {
            ...
            if (!h.isPlatformEmbedded || "function" != typeof S.clipboard.copyImage) return !1;
            if (null != e) {
                let t = K(e, void 0);
        ...
        clipboardHasMixedContent() {
            ...
            return (
                !!h.isPlatformEmbedded &&
                null != (n = null == (e = (t = S.clipboard).hasMixedContent) ? void 0 : e.call(t)) &&
                n
            );
        },
        on(e, t) {
        ...
        getEnableHardwareAcceleration: () =>
            !h.isPlatformEmbedded || (!__OVERLAY__ && S.gpuSettings.getEnableHardwareAcceleration()),
        ...
        blockDisplaySleep: () =>
            h.isPlatformEmbedded && null != S.powerSaveBlocker ? S.powerSaveBlocker.blockDisplaySleep() : null,
