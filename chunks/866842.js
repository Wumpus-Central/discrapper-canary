...
function b(e) {
    ...
    function g(e, i) {
        ...
        return s()(e)
            .map((e) => {
                if (!e.isPrivate() && !A.A.can(C.xB.VIEW_CHANNEL, e)) return null;
    ...
    return {
        ...
        getSections() {
            let e = [];
            (e[N.Xt] = 0), (e[N.PU] = 0), (e[N.HP] = 0), (e[N.yO] = 0), (e[N.bK] = O.channelList.length);
            for (let t = 0; t < b.length; t++) e[N.TF + t] = Math.max(1, b[t].channelList.length);
            return e;
        },
        isPlaceholderRow: (e, t) => !(e < N.TF) && 0 === t && 0 === b[e - N.TF].channelList.length,
        getCategoryFromSection: (e) => (e === N.bK ? O : b[e - N.TF]),
        getNamedCategoryFromSection: (e) => b[e - N.TF],
