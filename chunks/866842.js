...
var i = n(64700),
    ...
    m = n(349828),
    f = n(818348);
let R = 21552 == n.j ? [o.Ay, a.A, u.Ay, h.A, A.A, g.A, C.A, I.A, T.A, p.Ay, S.A, N.Ay] : null;
function b() {
...
function v(e) {
            ...
            .map((e) => {
                ...
                let d = null != l && (l.id === e.id || o === e.id),
                    ...
                    I = {
                        ...
                        subtitle: (0, O.go)(e, g, !1),
                    };
                return d || c || !r().isEmpty(u) || p.Ay.getMentionCount(e.id) > 0
                    ? I
                    : (n && C) ||
                        (s && (C || a || (0, E.gV)(e.type) || ((0, E.ig)(e.type) && !1 === p.Ay.hasUnread(e.id))))
                      ? null
                      : I;
            })
            .filter(L.Vq)
        ...
        v = (0, d.m_)(t)
            ...
            .map((e) => {
                ...
                return {
                    ...
                    isEmpty: () => 0 === l.length,
                    get channelList() {
                        return null == o && (o = I(l, this)), o;
                    },
                };
            })
            .filter((e) => null != e),
        U = 0;
    for (let e of [b, ...v]) for (let t of ((e.position = ++U), e.channelList)) t.position = ++U;
    ...
    return {
        ...
        getSections() {
            let e = [];
            (e[O.Xt] = 0), (e[O.PU] = 0), (e[O.HP] = 0), (e[O.yO] = 0), (e[O.bK] = b.channelList.length);
        ...
        getCategoryFromSection: (e) => (e === O.bK ? b : v[e - O.TF]),
        ...
        forEachChannel(e) {
            for (let t of [b, ...v]) for (let n of t.getChannelRecords()) e(n);
        },
