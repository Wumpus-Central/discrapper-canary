...
var i = n(64700),
    ...
    b = n(349828),
    R = n(818348);
let v = 21552 == n.j ? [a.Ay, o.A, u.A, h.Ay, A.A, E.A, _.A, I.A, p.A, S.A, N.Ay, m.Ay, L.Ay] : null;
function U(e) {
...
function D(e) {
    let t = e ?? o.A.getFavoriteChannels(),
        n = L.Ay.isGuildCollapsed(b.Vc),
        i = m.Ay.getChannelId(),
        l = I.A.getChannel(i),
        a = m.Ay.getVoiceChannelId(),
        u = [],
        h = {};
    for (let e in t) {
        let n = t[e],
    ...
    function C(e, i) {
        ...
        return r()(e)
            .map((e) => {
                if (!e.isPrivate() && !S.A.can(R.xB.VIEW_CHANNEL, e)) return null;
    ...
    return {
        ...
        getSections() {
            let e = [];
            (e[O.Xt] = 0), (e[O.PU] = 0), (e[O.HP] = 0), (e[O.yO] = 0), (e[O.bK] = v.channelList.length);
            for (let t = 0; t < U.length; t++) e[O.TF + t] = Math.max(1, U[t].channelList.length);
            return e;
        },
        isPlaceholderRow: (e, t) => !(e < O.TF) && 0 === t && 0 === U[e - O.TF].channelList.length,
        getCategoryFromSection: (e) => (e === O.bK ? v : U[e - O.TF]),
        getNamedCategoryFromSection: (e) => U[e - O.TF],
