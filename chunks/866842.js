...
var i = n(64700),
    ...
    m = n(349828),
    f = n(818348);
let b = 21552 == n.j ? [a.Ay, o.A, u.Ay, h.A, A.A, g.A, C.A, I.A, T.A, p.Ay, S.A, N.Ay] : null;
function R() {
...
function v(e) {
    ...
    return {
        ...
        getSections() {
            let e = [];
            (e[O.Xt] = 0), (e[O.PU] = 0), (e[O.HP] = 0), (e[O.yO] = 0), (e[O.bK] = R.channelList.length);
        ...
        getCategoryFromSection: (e) => (e === O.bK ? R : v[e - O.TF]),
