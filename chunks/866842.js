...
var i = n(64700),
    ...
    R = n(349828),
    b = n(818348);
let v = 21552 == n.j ? [a.Ay, o.A, u.A, A.Ay, E.A, h.A, _.A, I.A, N.A, p.A, S.Ay, L.Ay, m.Ay] : null;
function U(e) {
...
function D() {
    ...
    i.useEffect(() => {
        ...
        i.useEffect(() => {
            if (e && l) {
                let e;
                0 === (e = U({ limit: R.lj, includeLoading: !1 })).length ? Promise.resolve() : C.A.loadThreadsBulk(e);
            }
        }, [e, l]);
    let a = e ? t : s,
...
function y(e) {
    let t = e ?? o.A.getFavoriteChannels(),
        n = m.Ay.isGuildCollapsed(R.Vc),
        i = L.Ay.getChannelId(),
        l = I.A.getChannel(i),
        a = L.Ay.getVoiceChannelId(),
        u = [],
        A = {};
    for (let e in t) {
        let n = t[e],
