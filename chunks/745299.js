...
let A = function (e) {
    ...
    if (
        ...
        return null;
    let N = n === p.pe.TIER_2 ? m.kqX.PREMIUM_TIER_2_TRIAL_ENDING : m.kqX.PREMIUM_TIER_0_TRIAL_ENDING,
        C = (0, _.re)({
            intervalType: I.subscription_trial?.interval,
            intervalCount: I.subscription_trial?.interval_count,
        }),
        y = d.A.getArticleURL(I.trial_id === p.yo ? m.MVz.NITRO_TRIAL_FOR_ALL : m.MVz.PREMIUM_TRIAL);
    return (0, i.jsxs)(f.T0, {
        onClick: () => {
            t(), c.default.track(m.HAw.APP_NOTICE_CLOSED, { notice_type: N, trial_id: I.trial_id });
        },
        children: [
            (0, i.jsx)(f.In, { children: (0, E.GZ)(n, T, C, y) }),
            (0, i.jsx)(f.fY, {
                onClick: () => {
                    (0, u.A)({
                        trialId: I.trial_id,
