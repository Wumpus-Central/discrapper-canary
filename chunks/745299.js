...
let S = function (e) {
    let { dismissCurrentNotice: t, subscriptionTier: n } = e,
        ...
        O = (0, A.V)(),
        C = (0, r.A)(null != O && null != O.expires_at ? Date.parse(O.expires_at) : 0),
        P =
            null == O ||
    ...
    if (
        ...
        return null;
    let D = n === I.pe.TIER_2 ? N.kqX.PREMIUM_TIER_2_TRIAL_ENDING : N.kqX.PREMIUM_TIER_0_TRIAL_ENDING,
        p = (0, d.re)({
            intervalType: O.subscription_trial?.interval,
            intervalCount: O.subscription_trial?.interval_count,
        }),
        m = c.A.getArticleURL(O.trial_id === I.yo ? N.MVz.NITRO_TRIAL_FOR_ALL : N.MVz.PREMIUM_TRIAL);
    return (0, i.jsxs)(u.T0, {
        onClick: () => {
            t(), _.default.track(N.HAw.APP_NOTICE_CLOSED, { notice_type: D, trial_id: O.trial_id });
        },
        children: [
            (0, i.jsx)(u.In, { children: (0, T.GZ)(n, C, p, m) }),
            (0, i.jsx)(u.fY, {
                onClick: () => {
                    (0, E.A)({
                        trialId: O.trial_id,
                        ...
                        _.default.track(N.HAw.APP_NOTICE_PRIMARY_CTA_OPENED, { notice_type: D, trial_id: O.trial_id });
                },
                text: (function (e) {
                    switch (e) {
                        case I.pe.TIER_0:
