...
let S = function (e) {
    ...
    return (0, i.jsxs)(u.T0, {
        onClick: () => {
            t(), c.default.track(N.HAw.APP_NOTICE_CLOSED, { notice_type: D, trial_id: O.trial_id });
        },
        children: [
            ...
            (0, i.jsx)(u.fY, {
                onClick: () => {
                    (0, E.A)({
                        ...
                        c.default.track(N.HAw.APP_NOTICE_PRIMARY_CTA_OPENED, { notice_type: D, trial_id: O.trial_id });
                },
                text: (function (e) {
                    switch (e) {
                        case I.pe.TIER_0:
