...
var l = n(661531),
    ...
    i = n(953727);
function u(e) {
    let { size: t = "md", width: n, height: u, color: s = l.A.colors.INTERACTIVE_TEXT_DEFAULT, ...o } = e,
        c = (0, a.J)(t),
        d = c?.width ?? n,
        m = c?.height ?? u;
    return (0, r.jsxs)("svg", {
        ...
        children: [
            (0, r.jsx)("path", {
                ...
                style: { fill: "string" == typeof s ? s : s.css, fillRule: "nonzero" },
            ...
            (0, r.jsx)("path", {
                ...
                style: { fill: "string" == typeof s ? s : s.css },
