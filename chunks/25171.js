...
function I() {
    return null != A
        ? Promise.resolve(A)
        : (0, _.isDesktop)()
          ? E.Ay.ensureModule("discord_game_utils").then(() => {
                let e = E.Ay.getGameUtils();
...
let O = {
    ...
    launchDispatchApplication(e, t, n, i, a) {
        ...
        return (0, r.r)([E])
            ...
            .then(() => c.A.runLaunchSetup(f, E))
            .then(() => {
                let e = (0, s.A)(_),
                    r = {
                        DISCORD_INSTANCE_ID: d.A.getId().toString(),
                ...
                return c.A.launch(f, E, g.name, r);
            });
    },
