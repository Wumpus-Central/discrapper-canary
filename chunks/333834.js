...
function D(e) {
    let {
        ...
        L = i.useRef(null),
        M = (0, f.Z)(P, L),
        { entrypoint: k, notificationCenterVariant: U } = (0, O.pN)({ location: "NotificationsInboxSidebarList" }),
        {
            isLoading: G,
            isLoadingComplete: B,
            hasLoadedEver: V,
        ...
        H = !V && G,
        { messageCategoryOpenStates: F, toggleOpenState: z } = (0, v.Z)(),
        W = (function () {
            let e = (0, u.Wu)([j.Z], () => {
                var e;
                      ...
                      : N
                        ...
                        : s().each(A, (t) => {
                              0 !== Y[t].length &&
                                  ...
                                  F[t] && e.push(...Y[t].map((e) => d(e, t === S.KZ.UNREAD))));
                          }),
                e
            );
