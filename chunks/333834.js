...
function D(e) {
    let {
        ...
        L = i.useRef(null),
        M = (0, p.Z)(P, L),
        { entrypoint: k, notificationCenterVariant: U } = _.Lk.useExperiment({
        ...
        Y = i.useMemo(() => {
            ...
            return (
                (t.length > 0 || n.length > 0) &&
                    (a().each(n, (e) => {
                        e.kind === x.fL.MENTION
                            ? r[x.KZ.UNREAD].push(e)
                            : e.channelId in i[x.KZ.UNREAD]
                              ? i[x.KZ.UNREAD][e.channelId].push(e)
                              : (i[x.KZ.UNREAD][e.channelId] = [e]);
                    }),
                    a().each(t, (e) => {
                        let t = (0, j.bl)(e);
                        e.kind === x.fL.MENTION
