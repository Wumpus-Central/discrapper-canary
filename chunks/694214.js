...
function T(e) {
    let t,
        { application: n, scopes: s, redirectUri: T, approximateGuildCount: N, isEmbeddedFlow: O, disclosures: R } = e,
        C = new Date(m.default.extractTimestamp(n.id)),
        y = (0, A.i4)(s),
        D = (0, h.n)(n, I.gfo.EMBEDDED);
    if (null != T && !D && !O)
        try {
            let e = new URL(T);
    ...
    return (0, i.jsxs)("div", {
        ...
        children: [
            ...
            (0, i.jsx)(S, { icon: d.O, text: g.intl.formatToPlainString(g.t["+1bjc8"], { date: C }) }),
...
function S(e) {
    ...
    return (0, i.jsxs)("div", {
        className: p.f_,
        children: [
            (0, i.jsx)(t, { className: p.u7, color: "currentColor" }),
            (0, i.jsx)(s.E, { variant: "text-xs/normal", className: p.z9, children: n }),
        ],
    });
}
