    ...
    return (() => {
        var e = {
                                ...
                                !(function () {
                                    ...
                                    (i.prototype.rate = 0),
                                        ...
                                        (i.prototype._resample = function (e) {
                                            ...
                                            for (var p = 0; p < i; p++) {
                                                ...
                                                a(
                                                    ...
                                                    this._resampleLastSampleData
                                                        ? this._resampleLastSampleData[_]
                                                        : void 0,
                                                    f,
                                                ),
                                                    o.push(h);
                                            ...
                                            return (
                                                (this._resampleFractional = d), (this._resampleLastSampleData = e), o
                                            );
                                        }),
                                        ...
                                        (a.prototype._audioProcess = function (e) {
                                            ...
                                            if (
                                                ...
                                                for (t = 0; t < this.channels; t++)
                                                    for (
                                                        r = e.outputBuffer.getChannelData(t), a = 0;
                                                        a < this.bufferSize;
                                                        a++
                                                    )
                                                        r[a] = 0;
                                                ...
                                                (r = n(0)),
                                                    ...
                                                    (e.exports = function (e) {
                                                        ...
                                                        for (
                                                            ...
                                                            _[m] = 0.5 * (1 - Math.cos((2 * Math.PI * m) / s));
                                                        var h = 1 + (s >> 1),
                                                            g = r.float_array(h),
                                                            E = r.float_array(h),
                                                            b = r.float_array(h),
                                                        ...
                                                        var P = r.float_array(S),
                                                            ...
                                                            B = {
                                                                ...
                                                                flush: function (e) {
                                                                    (k = 0), (I = [0, 0]), (j = 0), (Z = 0), (G = 0);
                                                                    for (var t = 0; t < 2; t++)
                                                                        for (var n = 0; n < h; n++) N[t][n] = 0;
                                                                    for (t = 0; t < u.length; t++) u[t] = 0;
                                                                    for (t = 0; t < d.length; t++) d[t] = 0;
                                                                    if (e) {
                                                                        (D = Math.max(0, D - e)),
                                                                            (w = B.mapOutputToInputTime(D));
                                                                        for (
                                                                            var r = x.length - 1;
                                                                            D <= x[r].out_time && r >= 0;
                                                                        )
                                                        ...
                                                        var F = function (e, t, n) {
                                                            ...
                                                            H = function (e, t, n, r, i, a) {
                                                                ...
                                                                if (0 != e && 0 != E) {
                                                                    var O = 0;
                                                                    for (G = 0; G < E; G++) {
                                                                        for (Z = g[G]; g[G] > f[O] && O != d; ) ++O;
                                                                        var v = O;
                                                                        O > 0 && Z - f[O - 1] < f[O] - Z && (v = O - 1);
                                                                        var S = Z * o;
                                                                        if (
                                                                            Math.abs(f[v] - Z) < S &&
                                                            ...
                                                            Y = function () {
                                                                ...
                                                                for (t = 0; t < s - p; t++)
                                                                    Math.abs(l.m_re[t + p + e] + l.m_im[t]) > i &&
                                                                        (i = Math.abs(l.m_re[t + p + e] + l.m_im[t]));
                                                                for (t = s - p; t < s; t++)
                                                        ...
                                                        return (
                                                            (B.process = function (e) {
                                                                ...
                                                                var g =
                                                                    ...
                                                                    E = Z + p * g + Math.floor(k + U * g);
                                                                Z > E && (E = Z);
                                                                var b = r.float_array(E);
                                                                r.blit(d, 0, b, 0, Z);
                                                                for (var y = 0, O = Z, v = 0, S = 0; ; ) {
                                                                    var I = s + f - G;
                                                                    if (y + I > n) {
                                                                        r.blit(i, y, u, G, n - y),
                                                                            (G += n - y),
                                            ...
                                            function (e, t, n) {
                                                ...
                                                e.exports = function (e) {
                                                    ...
                                                    for (var l = 1, c = 0; c < n.m_logN; c++) {
                                                        ...
                                                        (n.twiddleRe[c] = Math.cos(u)),
                                                            (n.twiddleIm[c] = Math.sin(u)),
                                                            (l <<= 1);
                                                    }
                ...
                964: (e, t, n) => {
                    ...
                    function p(e) {
                        ...
                        return function () {
                            ...
                            return (
                                (n = t
                                    ? Reflect.construct(r, arguments, (0, c.default)(this).constructor)
                                    : r.apply(this, arguments)),
                                (0, l.default)(this, n)
                            );
                        };
                                    ...
                                    },
                                    {
                                        ...
                                        value: function (e, t, r) {
                                            (r = r || {}).worker
                                                ...
                                                : (0, o.default)((0, c.default)(n.prototype), "loadClass", this).call(
                                                      this,
                                                      e,
                                                      t,
                                                      r,
                ...
                869: (e, t, n) => {
                    ...
                    (S =
                        "undefined" == typeof performance || void 0 === (0, u.default)(performance.now)
                            ? Date.now
                                        ...
                                        set: function (e) {
                                            ...
                                            this._audioFeeder
                                                ...
                                                : this._paused ||
                                                  ...
                                                  (this._initialPlaybackPosition = (t * S()) / 1000)),
                                            ...
                                            if (this._paused) this._log("paused during playback; stopping loop");
                                                ...
                                                if (
                                                    ...
                                                    (r = this._decodedFrames.length > 0),
                                                        ...
                                                        r &&
                                                            ((l =
                                                                1000 * (this._decodedFrames[0].frameEndTimestamp - o)),
                                                    ...
                                                    if (this._prebufferingAudio)
                                                        ...
                                                        for (var u = -1, d = 0; d < this._decodedFrames.length - 1; d++)
                                                            this._decodedFrames[d].frameEndTimestamp < o && (u = d - 1);
                                                        if (u >= 0)
                                                            for (; u-- >= 0; ) {
                                                                this._lateFrames++;
                                                        ...
                                                        if (p >= 0 && p != this._codec.frameTimestamp && o >= _) {
                                                            ...
                                                            for (var m = 0; m < this._decodedFrames.length; m++) {
                                                                var h = this._decodedFrames[m];
                                                                this._lateFrames++,
                                                                    this._framesProcessed++,
                                                                    (this._frameEndTimestamp = h.frameEndTimestamp),
                                                                    (l = 1000 * (h.frameEndTimestamp - o)),
                                                                    (this._actualPerFrameTime =
                                                                        this._targetPerFrameTime - l),
                                                                    (h.dropped = !0),
                                                            ...
                                                            for (
                                                                ...
                                                                this._codec.frameReady &&
                                                                this._codec.frameTimestamp < p;
                                                            ) {
                                                                var b = {
                                                                    frameEndTimestamp: this._codec.frameTimestamp,
                                                                    dropped: !0,
                                                                };
                                                                (l = 1000 * (b.frameEndTimestamp - o)),
                                                                    (this._actualPerFrameTime =
                                                                        this._targetPerFrameTime - l),
                                                                    this._lateFrames++,
                                                                    this._codec.discardFrame(function () {}),
                                            ...
                                            if ((this.processingQueue--, "callback" === e.data.action)) {
                                                ...
                                                if (t.props)
                                                    for (var a in t.props)
                                                        t.props.hasOwnProperty(a) && (this[a] = t.props[a]);
                                                            ...
                                                            for (o.s(); !(i = o.n()).done; ) {
                                                                ...
                                                                c > 0
                                                                    ? a.push(
                                                                          l.subarray(
                                                                              0,
                                                                              l.length - Math.min(c, l.length),
                                                                          ),
                                                                      )
                                                                    : a.push(
                                                                          l.subarray(
                                                                              Math.min(Math.abs(c), l.length),
                                                                              l.length,
                                                                          ),
                                                                      );
                                                            }
                                ...
                                (t.drawFrame = function (t) {
                                    ...
                                    (e.width === s.displayWidth && e.height === s.displayHeight) ||
                                        ...
                                        (null !== i && i.width == s.width && i.height == s.height) ||
                                            (function (e, t) {
                                                for (
                                                    var r = (i = n.createImageData(e, t)).data, a = e * t * 4, o = 0;
                                                    o < a;
                                                    o += 4
                                                )
                                                    r[o + 3] = 255;
                                    ...
                                    c
                                        ? (a ||
                                              (function (e, t) {
                                                  ((a = document.createElement("canvas")).width = e),
                                                      (a.height = t),
                                                      (o = a.getContext("2d"));
                        ...
                        function i(e) {
                            ...
                            function s(e, t) {
                                ...
                                if (
                                    ...
                                    throw (
                                        (o.deleteShader(n), Error("GL shader compilation for " + e + " failed: " + r))
                                    );
                                }
                                return n;
                            }
                            ...
                            function I(e, t, r, i) {
                                ...
                                o.activeTexture(o.TEXTURE2),
                                    ...
                                    o.viewport(0, 0, r, i),
                                    o.drawArrays(o.TRIANGLES, 0, E.length / 2),
                            ...
                            return (
                                (a.drawFrame = function (s) {
                                    ...
                                    if (
                                        ...
                                        O(_, 0, s.y.stride), O(h, 0, (s.u.stride * b.width) / b.chromaWidth);
                                    }
                                    S("uTextureY", y, s.y.stride, b.height, s.y.bytes),
                                        S("uTextureCb", y, s.u.stride, b.chromaHeight, s.u.bytes),
                                        S("uTextureCr", y, s.v.stride, b.chromaHeight, s.v.bytes),
                                        i.stripe &&
                                            (I("uTextureY", y, s.y.stride, b.height),
                                            I("uTextureCb", y, s.u.stride, b.chromaHeight),
                                            I("uTextureCr", y, s.v.stride, b.chromaHeight)),
                                        o.useProgram(t),
                                        o.viewport(0, 0, e.width, e.height),
                                        T("uTextureY", o.TEXTURE0, 0),
                                        T("uTextureCb", o.TEXTURE1, 1),
                                        T("uTextureCr", o.TEXTURE2, 2),
                                        o.bindBuffer(o.ARRAY_BUFFER, l),
                                        o.enableVertexAttribArray(c),
                                        o.vertexAttribPointer(c, 2, o.FLOAT, !1, 0, 0),
