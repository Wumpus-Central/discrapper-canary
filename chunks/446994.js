                                    ...
                                    (n.prototype.appendBuffer = function (e) {
                                        ...
                                        for (
                                            ...
                                            ++r == o &&
                                                ...
                                                (i = this._pendingBuffer = this.createBuffer(o)));
                                        }
                                        this._pendingPos = r;
                                    }),
                                        ...
                                        (o.prototype._audioProcess = function (e) {
                                            ...
                                            if (
                                                ...
                                                for (t = 0; t < this.channels; t++)
                                                    for (
                                                        r = e.outputBuffer.getChannelData(t), o = 0;
                                                        o < this.bufferSize;
                                                        o++
                                                    )
                                                        r[o] = 0;
                                                ...
                                                (r = n(0)),
                                                    ...
                                                    (e.exports = function (e) {
                                                        ...
                                                        for (
                                                            ...
                                                            p[h] = 0.5 * (1 - Math.cos((2 * Math.PI * h) / s));
                                                        var m = 1 + (s >> 1),
                                                            g = r.float_array(m),
                                                            E = r.float_array(m),
                                                            b = r.float_array(m),
                                                        ...
                                                        var F = function (e, t, n) {
                                                            ...
                                                            Y = function () {
                                                                ...
                                                                for (t = 0; t < s - _; t++)
                                                                    Math.abs(l.m_re[t + _ + e] + l.m_im[t]) > i &&
                                                                        (i = Math.abs(l.m_re[t + _ + e] + l.m_im[t]));
                                                                for (t = s - _; t < s; t++)
                                                                    Math.abs(2 * l.m_im[t]) > i &&
                                                                        (i = Math.abs(2 * l.m_im[t]));
                                                                var a = 1 / Math.floor(+s / (2 * _));
                                                                for (o * i > a && (o = a / i), t = 0; t < s; t++)
                                                                    (d[t] += o * l.m_re[t]),
                                                                        (d[t + _ + e] += o * l.m_im[t]);
                                                                return (x += 2), (M = 2 * _ + e);
                                                            };
                                    ...
                                    },
                                    {
                                        ...
                                        value: function (e, t, r) {
                                            (r = r || {}).worker
                                                ...
                                                : (0, a.default)((0, c.default)(n.prototype), "loadClass", this).call(
                                                      this,
                                                      e,
                                                      t,
                                                      r,
                                        ...
                                        set: function (e) {
                                            ...
                                            this._audioFeeder
                                                ...
                                                : this._paused ||
                                                  ...
                                                  (this._initialPlaybackPosition = (t * I()) / 1000)),
                                            ...
                                            if (this._paused) this._log("paused during playback; stopping loop");
                                                ...
                                                if (
                                                    (t.hasAudio && this._audioFeeder
                                                        ? ((o = this._audioFeeder.getPlaybackState()),
                                                          ...
                                                          o.dropped != this._droppedAudio &&
                                                              this._log("dropped " + (o.dropped - this._droppedAudio)),
                                                          o.delayed != this._delayedAudio &&
                                                              this._log("delayed " + (o.delayed - this._delayedAudio)),
                                                    ...
                                                    (r = this._decodedFrames.length > 0),
                                                        ...
                                                        r &&
                                                            ((l =
                                                                1000 * (this._decodedFrames[0].frameEndTimestamp - a)),
                                                    ...
                                                    if (this._prebufferingAudio)
                                                        ...
                                                        for (var u = -1, d = 0; d < this._decodedFrames.length - 1; d++)
                                                            this._decodedFrames[d].frameEndTimestamp < a && (u = d - 1);
                                                        if (u >= 0)
                                                            for (; u-- >= 0; ) {
                                                                this._lateFrames++;
                                                        ...
                                                        if (_ >= 0 && _ != this._codec.frameTimestamp && a >= p) {
                                                            ...
                                                            for (
                                                                ...
                                                                this._codec.frameReady &&
                                                                this._codec.frameTimestamp < _;
                                                            ) {
                                                                var b = {
                                                                    frameEndTimestamp: this._codec.frameTimestamp,
                                                                    dropped: !0,
                                                                };
                                                                (l = 1000 * (b.frameEndTimestamp - a)),
                                                                    (this._actualPerFrameTime =
                                                                        this._targetPerFrameTime - l),
                                                                    this._lateFrames++,
                                                                    this._codec.discardFrame(function () {}),
                                            ...
                                            if ((this.processingQueue--, "callback" === e.data.action)) {
                                                ...
                                                if (t.props)
                                                    for (var o in t.props)
                                                        t.props.hasOwnProperty(o) && (this[o] = t.props[o]);
                                ...
                                (t.drawFrame = function (t) {
                                    ...
                                    (e.width === s.displayWidth && e.height === s.displayHeight) ||
                                        ...
                                        (null !== i && i.width == s.width && i.height == s.height) ||
                                            (function (e, t) {
                                                for (
                                                    var r = (i = n.createImageData(e, t)).data, o = e * t * 4, a = 0;
                                                    a < o;
                                                    a += 4
                                                )
                                                    r[a + 3] = 255;
                                    ...
                                    c
                                        ? (o ||
                                              (function (e, t) {
                                                  ((o = document.createElement("canvas")).width = e),
                                                      (o.height = t),
                                                      (a = o.getContext("2d"));
                        ...
                        function i(e) {
                                ...
                                if ((a.activeTexture(a.TEXTURE0), i.stripe)) {
                                    ...
                                    a.bindTexture(a.TEXTURE_2D, l),
                                        s
                                            ...
                                            : a.texSubImage2D(a.TEXTURE_2D, 0, 0, 0, n, r, a.ALPHA, a.UNSIGNED_BYTE, o);
                            }
                            function T(e, t, r, i) {
                                var o = b[e];
                                a.useProgram(n);
                                ...
                                (s && !t) ||
                                    ...
                                    a.framebufferTexture2D(a.FRAMEBUFFER, a.COLOR_ATTACHMENT0, a.TEXTURE_2D, o, 0);
                                var p = b[e + "_temp"];
                                ...
                                a.activeTexture(a.TEXTURE2),
                                    ...
                                    a.viewport(0, 0, r, i),
                                    a.drawArrays(a.TRIANGLES, 0, E.length / 2),
                                    a.bindFramebuffer(a.FRAMEBUFFER, null);
                            }
                            function S(e, n, r) {
                                a.activeTexture(n),
                                    a.bindTexture(a.TEXTURE_2D, b[e]),
                                    a.texParameteri(a.TEXTURE_2D, a.TEXTURE_WRAP_S, a.CLAMP_TO_EDGE),
                                    a.texParameteri(a.TEXTURE_2D, a.TEXTURE_WRAP_T, a.CLAMP_TO_EDGE),
                                    a.texParameteri(a.TEXTURE_2D, a.TEXTURE_MIN_FILTER, a.LINEAR),
                                    a.texParameteri(a.TEXTURE_2D, a.TEXTURE_MAG_FILTER, a.LINEAR),
                            ...
                            return (
                                (o.drawFrame = function (s) {
                                            ...
                                            (function () {
                                                if (i.stripe) {
                                                    ...
                                                    a.bindBuffer(a.ARRAY_BUFFER, u),
                                                        ...
                                                        (f = a.getUniformLocation(n, "uStripe")),
                                                        (_ = a.getUniformLocation(n, "uTexture"));
                                                }
                                                (t = A(r.vertex, r.fragment)),
                                                    (l = a.createBuffer()),
                                                    a.bindBuffer(a.ARRAY_BUFFER, l),
                                                    a.bufferData(a.ARRAY_BUFFER, E, a.STATIC_DRAW),
                                                    (c = a.getAttribLocation(t, "aPosition")),
                                                    (p = a.createBuffer()),
                                                    (h = a.getAttribLocation(t, "aLumaPosition")),
                                                    (m = a.createBuffer()),
                                                    (g = a.getAttribLocation(t, "aChromaPosition"));
                                            })(),
                                        y)
                                    ) {
                                    ...
                                    I("uTextureY", y, s.y.stride, b.height, s.y.bytes),
                                        I("uTextureCb", y, s.u.stride, b.chromaHeight, s.u.bytes),
                                        I("uTextureCr", y, s.v.stride, b.chromaHeight, s.v.bytes),
                                        i.stripe &&
                                            (T("uTextureY", y, s.y.stride, b.height),
                                            T("uTextureCb", y, s.u.stride, b.chromaHeight),
                                            T("uTextureCr", y, s.v.stride, b.chromaHeight)),
                                        a.useProgram(t),
                                        a.viewport(0, 0, e.width, e.height),
                                        S("uTextureY", a.TEXTURE0, 0),
                                        S("uTextureCb", a.TEXTURE1, 1),
                                        S("uTextureCr", a.TEXTURE2, 2),
                                        a.bindBuffer(a.ARRAY_BUFFER, l),
                                        a.enableVertexAttribArray(c),
                                        a.vertexAttribPointer(c, 2, a.FLOAT, !1, 0, 0),
                            ...
                            (i.isAvailable = function () {
                                ...
                                if (e) {
                                    ...
                                    return (
                                        ...
                                        e.texImage2D(e.TEXTURE_2D, 0, s, a, 4, 0, s, e.UNSIGNED_BYTE, o),
                                        !e.getError()
                                    );
                                }
                                return !1;
                        ...
                        e.exports = {
                            convertYCbCr: function (e, n) {
                                ...
                                if (1 == o && 1 == a)
                                    ...
                                    for (b = 0, R = 0; R < i; R++)
                                        for (
                                            P = 0, p = (R * u) | 0, g = ((w = R >> a) * d) | 0, E = (w * f) | 0, C = 0;
                                            C < r;
                                            C++
                                        )
                                            (v = 0 | l[g + (P = C >> o)]),
