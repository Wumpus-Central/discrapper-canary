...
function l(e, t, n) {
    ...
    if (a && "$" === a[0]) {
        let t = "!" !== a[1],
            r = (t ? n[a.slice(1)] : n[a.slice(2)]).map((e) => u[e] || [e]).reduce((e, t) => [...e, ...t], []);
...
let f = (0, i.B)(
        function (e, t) {
            let n = new Intl.Locale(e).maximize(),
                ...
                u = { language: n.language, script: n.script || "", region: n.region || "" },
            ...
            if (e !== n) {
                ...
                for (let o = 0; o < a.length; o++) {
                    ...
                    if (s !== n && u.has(s)) {
                        let a;
                        try {
                            a = new Intl.Locale(s).maximize().toString() === e ? 0 + 40 * t : 10 * o + 40 * t;
                        } catch {
                            a = 10 * o + 40 * t;
                        }
                ...
                i.distances[e] || (i.distances[e] = {}),
                    a.forEach((a, u) => {
                        let o = t[u],
                            s = f(e, a) + 0 + 40 * n;
                        (i.distances[e][o] = s),
                            s < r && ((r = s), (i.matchedDesiredLocale = e), (i.matchedSupportedLocale = o));
                    });
            }),
