...
function T(e, t) {
    let n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2],
        r = (0, s.m1)(e, c.default, u.A, !0),
        o = (0, s.m1)(e, c.default, u.A, !1),
        l = [],
        d = [r, o],
        _ = [];
    e.isGuildVocal() && d.push(`!${o}`);
    let f = a.A.getChannel(e.parent_id);
    if (null != f) {
        let e = (0, s.m1)(f, c.default, u.A, !0),
            t = (0, s.m1)(f, c.default, u.A, !1);
        _.push(e), _.push(t), l.push(e);
    }
    null != t && (_.push(t.name), l.push(t.name));
    let E = r + (l.length > 0 ? ` (${l.join(", ")})` : ""),
...
function N(e) {
    ...
    let n = o.A.getGuild(t.guild_id),
            ...
            ...new Set([
                ...
                ...(function (e) {
                    ...
                    if (
                        ...
                        let [n] = e.recipients.map(c.default.getUser).filter(f.Vq);
                        if (null != n) {
                            let e = E.Ay.getGlobalName(n);
                            null != e && t.push(e), t.push(n.username), t.push("@" + n.username);
                            let r = u.A.getNickname(n.id);
                            null != r && t.push(r);
                            let i = E.Ay.getName(n);
                            null != i && t.push(i);
                        }
                    }
                    return t;
        ...
        d = m.BVt.CHANNEL(t.guild_id, t.id),
        _ = {
            webpageURL: `${m.qF7.BASE_URL}${d}`,
            relatedUniqueIdentifier: d,
...
class v extends r.A {
    ...
    handleInit() {
        N(d.A.getCurrentlySelectedChannelId()),
