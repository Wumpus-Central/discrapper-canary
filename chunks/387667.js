...
function g(A) {
    ...
    if (A <= a.rsA.BOT_ADD || A === a.rsA.MESSAGE_DELETE || A === a.rsA.MESSAGE_PIN || A === a.rsA.MESSAGE_UNPIN)
        return a.KFR.USER;
...
class v extends l.Z {
    constructor(A) {
        ...
        super(),
            ...
            (this.timestampStart = null != (e = A.timestampStart) ? e : r()(s.default.extractTimestamp(this.id))),
            ...
            (this.user = null != (a = A.user) ? a : null);
    }
}
let h = v;
