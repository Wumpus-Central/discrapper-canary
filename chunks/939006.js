...
function _(t) {
    ...
    return (
        ...
        (0, i.jsxs)(o.B, {
            gap: 12,
            children: [
                !n && (0, i.jsx)(R, { title: B.intl.string(B.t["rkA56+"]), description: B.intl.string(B.t.fHiGA0) }),
                !s && (0, i.jsx)(R, { title: B.intl.string(B.t.COu4bk), description: B.intl.string(B.t.b0MaDV) }),
            ],
        })
    );
}
...
function T(t) {
    ...
    return (0, i.jsxs)("div", {
        className: L.tp,
        children: [
            0 !== l.length ? (0, i.jsx)(K, { enabledPermissions: l, onGetPermisisonName: n }) : null,
            (0, i.jsx)(G, { disabledPermissions: s, onGetPermisisonName: n }),
        ],
    });
}
function k(t) {
    ...
    return (0, i.jsxs)(i.Fragment, {
        children: [
            (0, i.jsxs)(o.B, {
                gap: 12,
                children: [
                    !n && (0, i.jsx)(R, { title: B.intl.string(B.t.uPYswy), description: B.intl.string(B.t.pf6ptp) }),
                    !s &&
                        (0, i.jsx)(R, {
...
function Y(t) {
    ...
    let { guild: n } = (0, r.cf)([m.A], () => m.A.getProps()),
        ...
        R = !L || !v,
        K = (0, r.bG)([j.A], () => (null != n ? j.A.getEveryoneRole(n) : void 0)),
        [G, T] = l.useState(!1);
    if (null == n) return null;
    let Y = async () => {
            if (null == K || !G) return;
            let t = v ? null : s.TF(K.permissions, P.e$);
            if (null != t && t !== K.permissions) {
                let e = { ...K, permissions: t };
        ...
        U = [
            ...
            },
            {
                ...
                body: (0, i.jsx)(_, { guild: n, verificationLevelMet: c, contentFilterMet: p }),
            ...
            },
            {
                ...
                body: (0, i.jsx)(k, { guild: n, defaultNotificationSettingsMet: L, everyonePermissionsMet: v }),
                nextButtonProps: { text: B.intl.string(B.t.JFfins) },
            },
            {
                stepKey: P.pj.RULES,
                ...
                body: (0, i.jsx)(F, { guild: n, policyAccepted: G, onPolicyAcceptedChange: T }),
                nextEnabled: G,
            },
        ].filter((t) => (t.stepKey !== P.pj.SAFETY_CHECK || !!x) && (t.stepKey !== P.pj.FINISH || !!R)),
        H = U.slice(1).map((t) => t.stepKey);
    return (0, i.jsx)(g.t, {
        ...e,
        steps: U,
        numberedSteps: H,
