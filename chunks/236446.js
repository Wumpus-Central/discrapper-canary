...
class O extends r.PureComponent {
    componentDidMount() {
        (0, _.e)('guildTemplate'), !R.KO && v.Z.launch('discord://' + j.Z5c.GUILD_TEMPLATE(this.props.code), () => void 0);
    }
    ...
    renderAuthenticatedOrDownload() {
        ...
        return (a()(null != e, 'guild template must not be null'), e.state === T.Rj.RESOLVING)
            ? (0, i.jsx)(d.ZP, {
                  className: L.authBox,
            ...
            case T.Rj.RESOLVED:
                ...
                if (this.props.login)
                    ...
                    return (0, i.jsx)(Z.Z, {
                        ...
                        location: s,
                        onRegister: () => {
                            (0, x.c)(S.M5.ORGANIC_REGISTERED_GUILD_TEMPLATE), E.Z.flowStart(A.MK.ORGANIC_GUILD_TEMPLATES, A.EW.NUF_STARTED);
                        }
                    });
            case T.Rj.EXPIRED:
