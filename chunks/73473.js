...
let o = s.memo(function (e) {
    let t,
            ...
            { focused: t, focusedChanged: o }),
        {
            ...
            let [t, r] = s.useState(!1),
                i = e ?? t,
                d = i !== (0, n.A)(i);
            return { visible: i, visibleChanged: d, reference: (0, a.K)((e) => r(e), 0.5) };
    ...
    return "questOrQuests" in e
        ? (0, s.createElement)(u.xs, { ...m, key: v, adContentIds: b, adCreativeType: i.p.QUEST })
        : (0, s.createElement)(u.xs, { ...m, key: v, adContentIds: b, adCreativeType: e.adCreativeType });
});
