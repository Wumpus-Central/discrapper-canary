...
let x = (e) => {
    let { emojiDescriptors: t, emojiSize: o, onSelect: C, onSelectSoundmoji: R, onInspect: L, surrogateCodePoint: x, getEmojiItemProps: k, getEmojiRowProps: M, isScrolling: j, isUsingKeyboardNavigation: U, rowIndex: G, allowAnimatedEmoji: B, showEmojiFavoriteTooltip: F, channelGuildId: V, category: Z, selectedItemClassName: H, channelId: Y, messageId: W, isBurstReaction: K, inNitroLockedSection: z, handleScrollUpOnSectionCollapse: q } = e,
            ...
            switch (e.type) {
                case v.ld.EXPAND_OR_COLLAPSE_EMOJIS: {
                    let { visibleRowIndex: t, columnIndex: i } = e,
                        ...
                        l = e.sectionCollapsedToThreeRows ? (o ? ((0, s.wj)(ea) ? er : eo) : (0, s.wj)(ea) ? J : $) : o ? ((0, s.wj)(ea) ? en : ei) : (0, s.wj)(ea) ? ee : et,
                ...
                case v.ld.EMOJI: {
                    ...
                    let { columnIndex: n, visibleRowIndex: i } = e,
                        a = el.rowIndex === i && el.columnIndex === n;
                    return (0, r.jsx)(
                        I.Z,
                        {
                            rowIndex: G,
                            ...
                            messageId: W,
                            isBurstReaction: K,
                            rowPosition: null == ef || null == (o = ef.current) ? void 0 : o.getBoundingClientRect(),
    ...
    if (Z !== S.En.TOP_GUILD_EMOJI) return em(t);
    let eg = t.filter((e) => {
    ...
    return 0 === eE.length
        ...
        : (0, r.jsxs)('div', {
              ...
              children: [
                  (0, r.jsx)('div', {
                      className: a()(N.topEmojiContainer, { [N.noEmojis]: 0 === eg.length }),
                      children: em(eg)
                  }),
                  (0, r.jsxs)('div', {
