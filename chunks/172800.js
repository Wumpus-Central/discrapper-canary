...
let x = (e) => {
    ...
    let ef = a === T.Su.LARGE,
        ...
        eh = (e) => {
            let t = ''.concat(e.rowIndex, 'c').concat(e.columnIndex),
                n = function () {
                    var n;
                    let { onMouseEnter: a, onMouseLeave: s, handleSelect: c, icon: u, ariaLabel: d, shouldShowRoundHighlight: _ } = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                        { visibleRowIndex: f, columnIndex: p } = e,
                        h = null != (n = k(p, G)) ? n : {},
                        { ref: m, tabIndex: g, onFocus: E } = h,
                        b = D(h, ['ref', 'tabIndex', 'onFocus']),
                        y = el.rowIndex === f && el.columnIndex === p,
                        O = () => {
    ...
    let eg = t.filter((e) => {
            ...
            let t = e;
            return t.subCategory === T.t0.TOP_GUILD_EMOJI || (t.subCategory === T.t0.NEWLY_ADDED_EMOJI && t.emoji.type === f.B.GUILD && !p.Z.isNewerThanLastSeen(t.emoji.guildId, t.emoji.id));
        }),
        eE = t.filter((e) => {
            let t = e;
            return t.subCategory === T.t0.NEWLY_ADDED_EMOJI && t.emoji.type === f.B.GUILD && p.Z.isNewerThanLastSeen(t.emoji.guildId, t.emoji.id);
        });
    return 0 === eE.length
        ? em(t)
        : (0, r.jsxs)('div', {
