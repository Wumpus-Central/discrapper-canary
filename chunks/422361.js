...
class es extends q.Ay {
    ...
    render() {
        let {
            ...
            D = (0, i.jsxs)("li", {
                ref: this.ref,
                className: a()(this.getModeClass(), { [el.r9]: this.isDisabled(), [el.fy]: j }),
                "data-dnd-name": (0, b.m1)(e, Y.default, F.A),
                children: [
                    G && this.getVoiceStatesCount() > 0 && (0, i.jsx)(J.A, { channel: e }),
                    j &&
                        (0, i.jsxs)(i.Fragment, {
                            children: [
...
function er(e) {
    let {
        ...
        { isSubscriptionGated: I, needSubscriptionToAccess: C } = (0, j.A)(n.id),
        N = (0, v.A)(),
