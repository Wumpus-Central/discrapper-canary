...
class en extends W.Ay {
    ...
    render() {
        let {
            ...
            D = (0, i.jsxs)("li", {
                ref: this.ref,
                className: a()(this.getModeClass(), { [et.r9]: this.isDisabled(), [et.fy]: v }),
        ...
        h = (0, r.cf)([P.A, w.A, B.A], () => {
            ...
            return {
                ...
                canReorderChannel:
                    !0 !== l &&
                    (t.id === Z.Vc ||
                        (null != e ? B.A.can($.xBc.MANAGE_CHANNELS, e) : B.A.can($.xBc.MANAGE_CHANNELS, t))),
