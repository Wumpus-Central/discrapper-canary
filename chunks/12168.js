...
function D(e) {
    ...
    let k = (e) => {
        ...
        U = (e) => {
            null != e && e.key !== v.vn.TAB && (e.key !== v.vn.ENTER || e.shiftKey ? k(!0) : k(!D));
        };
            ...
            (0, r.jsxs)('div', {
                ...
                children: [
                    (0, r.jsx)(h.Z, {
                        analyticsOverride: S,
                        channel: t,
                        className: o()(I.animatedPicker, { [I.animatedPickerTall]: D }),
                        headerClassName: o()(I.emojiPickerHeader, { [I.emojiPickerHeaderExpanded]: D }),
                        closePopout: a,
                        onSelectEmoji: D ? j : () => {},
