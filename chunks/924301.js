...
function P(e) {
    ...
    null == I[r][i] && (I[r][i] = {}), (I[r][i][e.user_id] = e), t && w(e), n && (O += 1);
}
function R(e) {
    var t, n, r, i;
    ...
    (s || !l) &&
        (null == (i = I[e.guild_scheduled_event_id]) || null == (r = i[o]) || delete r[e.user_id], x(e), a && (O += 1));
}
function D(e, t, n) {
    let r = N(t);
...
function w(e) {
    ...
    let r = N(e.guild_scheduled_event_exception_id),
        i =
            (null != (n = null == (t = T[e.guild_scheduled_event_id]) ? void 0 : t[r]) ? n : 0) +
...
function L(e) {
    ...
    return (
        ...
        (T = {}),
        v.forEach(C),
        t.forEach((e) => e.guild_scheduled_events.forEach((e) => C(e))),
        !0
    );
}
function j(e) {
...
function k(e) {
    let { guild: t } = e;
    return G(t.id, !1), t.guild_scheduled_events.forEach((e) => C(e)), !0;
}
function U(e) {
    let { guild: t } = e;
    return G(t.id, !0), !0;
...
function F(e) {
    ...
    return r < 0 ? i.push(t) : (i[r] = t), C(h(_({}, n), { guild_scheduled_event_exceptions: i })), !0;
}
function V(e) {
    let { eventException: t } = e,
        n = y.get(t.event_id);
    ...
    return C(h(_({}, n), { guild_scheduled_event_exceptions: r })), !0;
}
function H(e) {
    let { eventId: t } = e,
        n = y.get(t);
    return null != n && (C(h(_({}, n), { guild_scheduled_event_exceptions: [] })), !0);
}
function Y(e) {
...
function K(e) {
    ...
    let { userId: r, guildEventId: i, guildId: a, guildEventExceptionId: o, response: s } = e,
        l = N(o),
        c = null == (n = I[i]) || null == (t = n[l]) ? void 0 : t[r];
    null != c && R(c, !1);
...
class en extends (r = o.ZP.Store) {
    ...
    getUserCount(e, t) {
        var n, r, i, a;
        if (null == e) return 0;
        let o = null != (i = null == (n = T[e]) ? void 0 : n[S]) ? i : 0;
    ...
    getUsersForGuildEvent(e, t) {
        ...
        if (null == e) return {};
        let i = N(t);
        return null != (r = null == (n = I[e]) ? void 0 : n[i]) ? r : {};
    }
}
