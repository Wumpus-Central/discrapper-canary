...
function F(e) {
    ...
    return r < 0 ? i.push(t) : (i[r] = t), A(h(_({}, n), { guild_scheduled_event_exceptions: i })), !0;
}
function V(e) {
    let { eventException: t } = e,
        n = y.get(t.event_id);
    ...
    return A(h(_({}, n), { guild_scheduled_event_exceptions: r })), !0;
}
function H(e) {
    let { eventId: t } = e,
        n = y.get(t);
    return null != n && (A(h(_({}, n), { guild_scheduled_event_exceptions: [] })), !0);
}
function Y(e) {
