...
function N(e) {
    ...
    y.delete(e), delete T[e], t && delete S[e], (O += 1);
}
function C(e) {
    return null != e ? e : I;
}
function R(e) {
    ...
    null == T[r][i] && (T[r][i] = {}), (T[r][i][e.user_id] = e), t && D(e), n && (O += 1);
}
function P(e) {
    var t, n, r, i;
    let o = !(arguments.length > 1) || void 0 === arguments[1] || arguments[1],
        a = C(e.guild_scheduled_event_exception_id),
        s = (null == (n = T[e.guild_scheduled_event_id]) || null == (t = n[a]) ? void 0 : t[e.user_id]) != null,
        l = e.user_id === c.default.getId();
    (s || !l) &&
        (null == (i = T[e.guild_scheduled_event_id]) || null == (r = i[a]) || delete r[e.user_id], L(e), o && (O += 1));
}
function w(e, t, n) {
    let r = C(t);
...
function D(e) {
    ...
    let r = C(e.guild_scheduled_event_exception_id),
        i =
            (null != (n = null == (t = S[e.guild_scheduled_event_id]) ? void 0 : t[r]) ? n : 0) +
            ((null != e.guild_scheduled_event_exception_id && e.response === f.gv.UNINTERESTED) ||
            (null == e.guild_scheduled_event_exception_id && e.response === f.gv.INTERESTED)
                ? 1
                : -1);
...
function G(e, t) {
    y.values(g.GUILD_EVENT(e)).forEach((e) => N(e.id, t));
}
function B(e) {
    let { guildScheduledEvent: t } = e;
    return A(t), !0;
...
function V(e) {
    ...
    return A(m(p({}, n), { guild_scheduled_event_exceptions: r })), !0;
}
function H(e) {
    let { eventId: t } = e,
        n = y.get(t);
    return null != n && (A(m(p({}, n), { guild_scheduled_event_exceptions: [] })), !0);
}
function Y(e) {
...
function K(e) {
    ...
    let { userId: r, guildEventId: i, guildId: o, guildEventExceptionId: a, response: s } = e,
        l = C(a),
        c = null == (n = T[i]) || null == (t = n[l]) ? void 0 : t[r];
    null != c && P(c, !1);
...
class et extends (r = a.ZP.Store) {
    ...
    getRsvp(e, t, n) {
        ...
        let o = C(t);
        return null == (i = T[e]) || null == (r = i[o]) ? void 0 : r[n];
    }
    ...
    getUserCount(e, t) {
        var n, r, i, o;
        if (null == e) return 0;
        let a = null != (i = null == (n = S[e]) ? void 0 : n[I]) ? i : 0;
        return null == t ? a : a - (null != (o = null == (r = S[e]) ? void 0 : r[t]) ? o : 0);
    }
    hasUserCount(e, t) {
        var n;
        let r = C(t);
