                    ...
                    children: [
                        ...
                        (0, r.jsx)("ul", {
                            children: j.map((e) =>
                                (0, r.jsx)(
                                    "li",
                                    { children: (0, r.jsx)(t9, { application: e }) },
                                    `follow-game-${e.id}`,
                                ),
                            ),
                        }),
...
function a9() {
    ...
    let t,
        ...
        y = (0, aJ.RD)(g, { allowedFlows: [a3._M.RPC], debug: !0 }),
    ...
    TRACK: function (e) {
        ...
        aP.A.isDeveloper &&
            (nE.push({
                ...
                event: t,
                properties: a,
                fingerprint: null != n ? (0, nf.d)(n) : n_.default.getId(),
                timestamp: new Date(),
            }),
            nC++,
...
class n9 extends V.Ay.PersistedStore {
    static displayName = "ChannelAffinitiesV2Store";
    static persistKey = "ChannelAffinitiesStoreV2";
    initialize(e) {
        null != e && ((n5.channelAffinities = e.channelAffinities), (n5.lastFetched = e.lastFetched), n4());
    }
    shouldFetch() {
...
let n7 = new n9(tM.h, {
    ...
    LOAD_CHANNEL_AFFINITIES_V2_SUCCESS: function (e) {
        ...
        (n5.lastFetched = Date.now()), (n3 = !1), (n5.channelAffinities = t), n4();
    },
...
function ly(e) {
    ...
    return 0 === s.length
        ? null
        : (0, r.jsx)(d.n, { label: "Recent Overrides", children: (0, r.jsx)(l_, { items: s }) });
}
function lE(e) {
    let { searchQuery: t = "" } = e,
        a = (0, ls.Ay)((e) => e.recentlyShown)
            ...
            .filter((e) => e.toLowerCase().includes(t.toLowerCase()))
            .slice(0, 3);
    return 0 === a.length ? null : (0, r.jsx)(d.n, { label: "Recently Shown", children: (0, r.jsx)(l_, { items: a }) });
}
var lC = a(594061),
    lS = a(268571);
function lN() {
...
let ie = new s7(tM.h, {
    GENERATED_POOL_BY_ID_FETCH_SUCCESS: function (e) {
        ...
        null == s4.pools && (s4.pools = new Map()), s4.pools.set(t.id, t), a.forEach(s9);
    },
...
let ii = [
    ...
    id = (e) => {
        let { pool: t } = e,
            ...
            s = (0, V.bG)([n_.default], () => n_.default.getId()),
    ...
    let e = (0, iv.G9)(),
        ...
        C = o.useMemo(() => {
            ...
            for (let t = 0; t < ik; t++) {
                ...
                e.push({ color: _.colors[t], opacity: a, position: iN[t] });
            }
            return e;
        }, [_]),
        S = o.useMemo(() => {
            ...
            children: [
                ...
                (0, r.jsxs)("div", {
                    ...
                    children: [
                        ...
                        i4.map((e) => (0, r.jsx)(lf, { className: i7.z6, content: ar.M[e] }, ar.M[e])),
                    ],
                }),
                (0, r.jsxs)("div", {
                    className: i7.uW,
...
let r2 = {
    ...
    CameraPreviewModal: async () => {
        let { default: e } = await Promise.all([a.e("76026"), a.e("10534")]).then(a.bind(a, 308229));
    ...
    GuildRaidLockdownFeedbackModal: async () => {
        let { default: e } = await Promise.all([a.e("44136"), a.e("46313")]).then(a.bind(a, 336496));
        return (t) =>
            (0, r.jsx)(e, {
                ...t,
                guildId: "123456789",
    ...
    UserAgreementsModal: async () => {
        let { default: e } = await Promise.all([a.e("44136"), a.e("82911"), a.e("22220")]).then(a.bind(a, 639719));
        return (t) => (0, r.jsx)(e, { ...t });
    },
    ...
    OtherFriendRequestsModal: async () => {
        let { default: e } = await Promise.all([a.e("69970"), a.e("27917"), a.e("73152"), a.e("25281")]).then(
            a.bind(a, 516259),
        );
        return (t) => (0, r.jsx)(e, { ...t });
    },
...
function oi(e) {
    ...
    let y = null != g,
        ...
        S = async () => {
            u(!0), y ? await N({ expiresAt: null }) : await (0, r5.u1)(t), n(), u(!1);
        },
        N = async (e) => {
            u(!0);
            try {
        ...
        (0, r.jsx)(x.Ip, {
            ...
            children: (0, r.jsxs)("div", {
                ...
                children: [
                    ...
                    f.map((e) => (0, r.jsx)(d9, { paymentSource: e }, e.id)),
                ],
            }),
        })
    );
...
function d8(e) {
    let { experimentName: t, options: a = dX } = e,
        n = (0, tb.bG)([dB.A, n_.default], () => {
            let e = n_.default.getId(),
...
var cu = a(873298),
    ...
    cb = a(385803),
    cf = a(381941);
let c_ = [el.NJ8.DARK, el.NJ8.LIGHT, el.NJ8.DARKER, el.NJ8.MIDNIGHT],
    ...
    return (0, r.jsx)("div", {
        ...
        children: (0, r.jsxs)(F.B, {
            ...
            children: [
                ...
                (0, r.jsx)(j.c, {}),
                (0, r.jsx)(c9, { title: "Running games", count: a.passed.length, entries: a.passed }),
                (0, r.jsx)(j.c, {}),
                (0, r.jsx)(c9, { title: "Filtered: non-game", count: a.nonGames.length, entries: a.nonGames }),
                (0, r.jsx)(j.c, {}),
                (0, r.jsx)(c9, {
...
function mE() {
    let e = (0, V.bG)([mg.Ay], () => mg.Ay.getSnapshot()),
        t = (0, V.bG)([_.Ay], () => _.Ay.supports(mv.O5.VIDEO));
    return (0, r.jsxs)(x.Ip, {
        className: tG.nd,
        children: [
            (0, r.jsx)(j.c, { gap: 16 }),
            (0, r.jsx)(my, { title: "Video Codecs (Sender)", toggles: mj, state: e }),
            t
                ? (0, r.jsxs)(r.Fragment, {
                      children: [
                          (0, r.jsx)(j.c, { gap: 16 }),
                          (0, r.jsx)(my, { title: "Video Encoders", toggles: mb, state: e }),
                          (0, r.jsx)(j.c, { gap: 16 }),
                          (0, r.jsx)(my, { title: "Capture Sources", toggles: mf, state: e }),
                          (0, r.jsx)(j.c, { gap: 16 }),
                          (0, r.jsx)(my, { title: "Capture Options", toggles: m_, state: e }),
                      ],
                  })
                : null,
            (0, r.jsx)(j.c, { gap: 16 }),
...
function mP() {
    ...
    o.useEffect(() => {
        ...
        (0, mD.l0)(() => {
            mI.A.setMode(_.Ay.getMode(), { vadDuringPreProcess: null, vadKrispActivationThreshold: void 0 });
        });
    let P = [];
    return (
...
let hU = "1193992107035983872",
    hG = {
        ...
        config: {
            ...
            features: [],
            sharePolicy: m9.i.SHAREABLE_EVERYWHERE,
                        ...
                        a &&
                            ...
                            (0, r.jsxs)(r.Fragment, {
                                children: [
                                    ...
                                    (0, r.jsx)("div", { className: h6.uk, children: i }),
                                ],
                            }),
                        a &&
                            0 === e.length &&
    ...
    return o.useMemo(() => {
        ...
        return (
            aP.A.isDeveloper &&
                ...
                e.push({ id: "slayer_sdk", name: "Slayer SDK", group: aH.fu.GAMES, render: () => (0, r.jsx)(u9, {}) }),
                e.push({
                    id: "account_linking",
