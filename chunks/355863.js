...
function S(e) {
    ...
    n.forEach((e, t) => {
        ...
        "" === r.id && (r.id = (0, l.Z)()),
            null != n &&
                ((r.pinned = n.pinned),
                -1 !== n.anchor.left && (r.anchor = (0, p.jL)(n.anchor, a)),
                -1 !== n.size.width && (r.size = (0, p.Ox)(n.size, a))),
            (i = y(E({}, i), { [r.id]: new _.Z(r) })),
            s.push(r.id);
    }),
        (r = y(E({}, r), {
            [t]: new f.Z({
                ...
                o.forEach((e) => {
                    ...
                    if (
                        (n.widgets.find((e) => {
                            ...
                            return (
                                null != n &&
                                (null == o && n[1].type === h.Odu.VOICE && (o = n[0]),
                                null == r && n[1].type === h.Odu.TEXT && (r = n[1].pinned),
                                (null != r && null != o) || void 0)
                            );
                        }),
                        r || null == o)
                    )
