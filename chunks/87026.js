...
let J = (e) => {
    ...
    V = (e) => {
        ...
        let { guild: a } = (0, o.cj)([h.Z], () => h.Z.getProps()),
            ...
            z = (0, N.Dt)(),
            { enabled: V } = (0, m.D2)(null !== (t = null == a ? void 0 : a.id) && void 0 !== t ? t : w.lds);
        ...
        let Q = A !== w.sFg.NONE,
            ...
            es = (0, i.jsx)(F, {
                ...
                onAcceptVerificationLevel: (e, t) => {
                    if (!t) {
                        f.Z.updateGuild({ verificationLevel: A });
                        return;
                    }
                ...
                onAcceptContentFilter: (e, t) => {
                    if (!t) {
                        f.Z.updateGuild({ explicitContentFilter: k });
                        return;
                    }
            ...
            en = V
                ...
                : (0, i.jsx)(B, {
                      ...
                      onAcceptDefaultNotifications: (e, t) => {
                          if (!t) {
                              f.Z.updateGuild({ defaultMessageNotifications: Z });
                              return;
                          }
