...
var r = n(503698),
    ...
    u = n(910372);
function c(e) {
    let { className: t, children: n, forceUseColor: r = !1, hideStars: a } = e;
    return (0, i.jsxs)("span", {
        className: s()(u.kL, t, { [u.cu]: r }),
        children: [
            n,
            a
                ? null
                : (0, i.jsxs)(i.Fragment, {
                      children: [
                          (0, i.jsx)(l.A, { foreground: u.yv }),
                          (0, i.jsx)(l.A, { foreground: u.Rq }),
                          (0, i.jsx)(l.A, { foreground: u.xh }),
                      ],
                  }),
        ],
    });
...
function f(e) {
    ...
    return (0, i.jsx)(c, {
        className: t,
        forceUseColor: n,
        children: (0, i.jsx)(a.Lp, {
            disableColor: !0,
            className: s()(_.Tc, { [_.YO]: r, [_.ju]: o }),
