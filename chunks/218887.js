...
var s = {
    resolve: function () {
        for (var e, t, n = "", o = !1, s = arguments.length - 1; s >= -1 && !o; s--)
            s >= 0 ? (t = arguments[s]) : (void 0 === e && (e = r.cwd()), (t = e)),
                i(t),
                0 !== t.length && ((n = t + "/" + n), (o = 47 === t.charCodeAt(0)));
        if (((n = a(n, !o)), o))
        ...
        if (void 0 !== t && t.length > 0 && t.length <= e.length) {
            ...
            for (n = e.length - 1; n >= 0; --n) {
                ...
                if (47 === c) {
                    ...
                    -1 === l && ((o = !1), (l = n + 1)),
                        s >= 0 && (c === t.charCodeAt(s) ? -1 == --s && (a = n) : ((s = -1), (a = l)));
            }
    ...
    parse: function (e) {
        ...
        for (var o = -1, s = 0, l = -1, c = !0, u = e.length - 1, d = 0; u >= t; --u) {
            ...
            -1 === l && ((c = !1), (l = u + 1)),
                46 === r ? (-1 === o ? (o = u) : 1 !== d && (d = 1)) : -1 !== o && (d = -1);
        }
        return (
            -1 === o || -1 === l || 0 === d || (1 === d && o === l - 1 && o === s + 1)
                ? -1 !== l && (0 === s && a ? (n.base = n.name = e.slice(1, l)) : (n.base = n.name = e.slice(s, l)))
                : (0 === s && a
