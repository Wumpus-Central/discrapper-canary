...
var s = {
    resolve: function () {
        for (var e, t, n = "", a = !1, s = arguments.length - 1; s >= -1 && !a; s--)
            s >= 0 ? (t = arguments[s]) : (void 0 === e && (e = r.cwd()), (t = e)),
                i(t),
                0 !== t.length && ((n = t + "/" + n), (a = 47 === t.charCodeAt(0)));
        if (((n = o(n, !a)), a))
    ...
    relative: function (e, t) {
        ...
        var _ = "";
        for (d = n + u + 1; d <= r; ++d)
            (d === r || 47 === e.charCodeAt(d)) && (0 === _.length ? (_ += "..") : (_ += "/.."));
        ...
        if (void 0 !== t && t.length > 0 && t.length <= e.length) {
            ...
            for (n = e.length - 1; n >= 0; --n) {
                ...
                if (47 === c) {
                    ...
                    -1 === l && ((a = !1), (l = n + 1)),
                        s >= 0 && (c === t.charCodeAt(s) ? -1 == --s && (o = n) : ((s = -1), (o = l)));
            }
    ...
    parse: function (e) {
        ...
        for (var a = -1, s = 0, l = -1, c = !0, u = e.length - 1, d = 0; u >= t; --u) {
            ...
            -1 === l && ((c = !1), (l = u + 1)),
                46 === r ? (-1 === a ? (a = u) : 1 !== d && (d = 1)) : -1 !== a && (d = -1);
        }
        return (
            -1 === a || -1 === l || 0 === d || (1 === d && a === l - 1 && a === s + 1)
                ? -1 !== l && (0 === s && o ? (n.base = n.name = e.slice(1, l)) : (n.base = n.name = e.slice(s, l)))
                : (0 === s && o
                      ? ((n.name = e.slice(1, a)), (n.base = e.slice(1, l)))
                      : ((n.name = e.slice(s, a)), (n.base = e.slice(s, l))),
                  (n.ext = e.slice(a, l))),
