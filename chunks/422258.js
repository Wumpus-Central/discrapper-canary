...
function h(n) {
    for (let e in n) {
        ...
        if (
            ...
            !i.isPrivate() && !s.A.can(A.xB.VIEW_CHANNEL, i))
        ) {
            delete n[e];
            continue;
        }
...
function C(n, e) {
    let t = n[e];
    if (null == t || t.parentId === d.O8) return;
    let i = null != t.parentId ? n[t.parentId] : null;
    (null == i || i.type !== l.Ip.CATEGORY) && (t.parentId = d.O8);
}
function O(n) {
    return h(n), a().size(n) >= d.lj;
}
function T() {
    r.A.show({ title: I.intl.string(I.t["+XYXtZ"]), body: I.intl.formatToPlainString(I.t.JaIyFi, { count: d.lj }) });
}
function R() {
    r.A.show({
        title: I.intl.string(I.t.iufib1),
        body: I.intl.string(I.t.eAn6z2),
            ...
            (n) => {
                ...
                for (let r of i) {
                    ...
                    (n.favoriteChannels[r] = l.wL.create({
                        ...
                        position: v(n.favoriteChannels),
                        parentId: e ?? d.O8,
                    })),
                        h(n.favoriteChannels),
                        C(n.favoriteChannels, r),
                        (a = !0),
                        (0, E.LO)(t, N(r, l.Ip.REFERENCE_ORIGINAL), S(n.favoriteChannels));
                }
            },
...
function U(n) {
    let { trackAnalytics: e = !0 } = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
        t = p.A.getFavorite(n);
    if (null == t) return;
    let i = e ? N(n, t.type) : null;
    u.wc.updateAsync(
        "favorites",
        (a) => {
            if ((delete a.favoriteChannels[n], t.type === l.Ip.CATEGORY))
                for (let e in a.favoriteChannels)
                    a.favoriteChannels[e].parentId === n && (a.favoriteChannels[e].parentId = d.O8);
    ...
    u.wc.updateAsync(
        ...
        (i) => {
            ...
            (i.favoriteChannels[t] = l.wL.create({
                nickname: n,
                type: l.Ip.CATEGORY,
                position: v(i.favoriteChannels),
                parentId: d.O8,
            })),
                (0, E.LO)(e, N(t, l.Ip.CATEGORY), S(i.favoriteChannels));
        },
        u.Sb.FREQUENT_USER_ACTION,
        R,
    );
            ...
            (e) => {
                for (let t of n) {
                    ...
                    null != t.position && (e.favoriteChannels[n].position = t.position),
                        void 0 !== t.parent_id &&
                            ((e.favoriteChannels[n].parentId = t.parent_id ?? d.O8), C(e.favoriteChannels, n));
                }
                (0, E.P)();
            },
            u.Sb.FREQUENT_USER_ACTION,
...
function b(n, e) {
    u.wc.updateAsync(
        "favorites",
        (t) => {
            (t.favoriteChannels[n].parentId = e ?? d.O8), C(t.favoriteChannels, n);
        },
        u.Sb.FREQUENT_USER_ACTION,
        R,
    );
