            ...
            (e) => {
                ...
                for (let l of i) {
                    ...
                    (e.favoriteChannels[l] = a.wL.create({
                        ...
                        (r = !0),
                        (0, I.LO)(n, v(l, a.Ip.REFERENCE_ORIGINAL), D(e.favoriteChannels));
                }
            },
...
function P(e) {
    ...
    c.wc.updateAsync(
        ...
        (r) => {
            ...
            C(r.favoriteChannels), t && (0, I.TX)(i, D(r.favoriteChannels));
        },
    ...
    c.wc.updateAsync(
        ...
        (e) => {
            ...
            (e.favoriteChannels[i] = a.wL.create({
                ...
                (0, I.LO)(t, v(i, a.Ip.CATEGORY), D(e.favoriteChannels));
        },
        c.Sb.FREQUENT_USER_ACTION,
        y,
    );
