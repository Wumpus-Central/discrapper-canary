...
let V = (e) => {
        ...
        return (p = p || (null != n && null != g && Date.now() - g.getTime() > H));
    },
    F = (e) => {
        let t,
            n,
            i,
            r,
            { selected: N, route: H, locationState: F, ...z } = e,
        ...
        return ei ? (0, l.jsx)(P.CI, { children: ef }) : er && !ea ? (0, l.jsx)(P.A7, { children: () => ef }) : ef;
    };
