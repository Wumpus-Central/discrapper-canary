...
function E(e) {
    ...
    if (null != t) {
        ...
        if (void 0 !== n)
            return { text: f.intl.formatToPlainString(n, { platform: i }), platformIcon: E, platformLabel: p };
    }
    return e.type === l.$pd.PLAYING
        ? { text: f.intl.string(f.t.BMTj28), platformIcon: E, platformLabel: p }
        : e.type === l.$pd.STREAMING
          ? { text: f.intl.string(f.t["Jpkr/q"]), platformIcon: E, platformLabel: p }
          : (0, r.Cy)(e)
            ? { text: f.intl.formatToPlainString(f.t.pW3Ip3, { name: e.name }) }
            : e.type === l.$pd.LISTENING && null != e.details
              ? { text: f.intl.formatToPlainString(f.t["b+lA5+"], { name: e.name }), platformIcon: E, platformLabel: p }
              : e.type === l.$pd.LISTENING
                ? { text: f.intl.string(f.t.dBISa6), platformIcon: E, platformLabel: p }
                : e.type === l.$pd.WATCHING && null != e.details
                  ...
                  : e.type === l.$pd.WATCHING
                    ? { text: f.intl.string(f.t.GpNXjC), platformIcon: E, platformLabel: p }
                    : e.type === l.$pd.COMPETING && null != e.details
                      ...
                      : e.type === l.$pd.COMPETING
                        ? { text: f.intl.string(f.t.OzCsIA), platformIcon: E, platformLabel: p }
                        : { text: void 0, platformIcon: E, platformLabel: p };
}
