...
class a extends r.V {
    ...
    mergeResults(e, t, n) {
        if (
            ...
            let e = t.start.date(),
                r = n.start.date();
            n.start.isOnlyWeekdayComponent() && (0, i.WK)(r, { day: 7 }) > e
                ? ((r = (0, i.WK)(r, { day: 7 })),
                  n.start.imply("day", r.getDate()),
                  n.start.imply("month", r.getMonth() + 1),
                  n.start.imply("year", r.getFullYear()))
                : t.start.isOnlyWeekdayComponent() && (0, i.WK)(e, { day: -7 }) < r
                  ? ((e = (0, i.WK)(e, { day: -7 })),
                    t.start.imply("day", e.getDate()),
                    t.start.imply("month", e.getMonth() + 1),
                    t.start.imply("year", e.getFullYear()))
                  : n.start.isDateWithUnknownYear() && (0, i.WK)(r, { year: 1 }) > e
                    ? ((r = (0, i.WK)(r, { year: 1 })), n.start.imply("year", r.getFullYear()))
                    : t.start.isDateWithUnknownYear() && (0, i.WK)(e, { year: -1 }) < r
                      ? ((e = (0, i.WK)(e, { year: -1 })), t.start.imply("year", e.getFullYear()))
                      : ([n, t] = [t, n]);
        }
        let r = t.clone();
        return (
