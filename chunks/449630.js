...
function et(e) {
    let { currentUser: t, onClose: n, setPopoutRef: s, highlightBadge: et, className: en } = e,
        ...
        { analyticsLocations: es } = (0, h.Ay)(m.A.USER_PROFILE_ACCOUNT_POPOUT),
        el = (0, j.pb)({ layout: "ACCOUNT_POPOUT", userId: t.id, guildId: void 0 }),
    ...
    let eu = (0, d.bG)([L.A], () => L.A.getStatus(t.id)),
        ...
        e_ = (0, q.T)(eu),
        ef = (0, H.j)(n),
        ev = (0, v.A)({ analyticsLocations: es }),
        eb = (0, F.TW)(t),
        ej = i.useRef(null),
        eA = i.useRef(null),
    ...
    let ey = (e) => {
            n?.(), (0, C.openUserProfileModal)({ customStatusPrompt: eT, sourceAnalyticsLocations: es, ...el, ...e });
        },
        ...
        ek = (0, x.on)({ location: "UserProfileAccountPopout" }),
        ew = i.useId();
    return (0, a.jsx)(h.f5, {
        value: es,
        children: (0, a.jsx)(j.of, {
            ...
            children: (0, a.jsxs)(c.lGe, {
                ...
                children: [
                    (0, a.jsx)(o.AC4, {
                        children: (0, a.jsx)(o.H, { id: ew, children: X.intl.string(X.t["5fWB8U"]) }),
                    }),
                    (0, a.jsxs)(c.Fmo, {
                        children: [
                            (0, a.jsx)($.A, { displayProfile: ei, handleOpenUserProfileModal: ey, height: eo }),
                            (0, a.jsxs)(R.A, {
                                className: Z.BK,
                                user: t,
                                displayProfile: ei,
                                ...
                                children: [
                                    ...
                                    (0, a.jsxs)(c.HOs, {
                                        className: Z.rf,
                                        style: { pointerEvents: eE ? "none" : void 0 },
                                        children: [
                                            ...
                                            (0, a.jsx)(y.A, { isPremiumUser: eb, onInteraction: n }),
                                            (0, a.jsx)(I.A, {
                                                user: t,
                                                currentUser: t,
                                                onOpenUserProfileModal: ey,
                                                        ...
                                                        children: (0, a.jsxs)(K.Gs, {
                                                            children: [
                                                                ...
                                                                (0, a.jsx)(K.N3, {
                                                                    ...
                                                                    sublabel: null != eh && eh,
                                                                    icon: () =>
                                                                        (0, a.jsx)(c.nW6, { status: eu, size: 12 }),
                                                                    trailing:
                                                                        (ep || eu === Q.clD.DND) &&
                            ...
                            eR && ek ? (0, a.jsx)(W.A, { targetElementRef: eA, onClose: n }) : null,
                            (0, a.jsx)(f.A, {}),
                        ],
                    }),
                ],
