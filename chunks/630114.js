...
function E(e, t, n, r, i) {
    ...
    return (
        ...
        o.push(...T(a)),
        o.push(...N(a)),
        l.Z.hasConsented(m.pjP.PERSONALIZATION) ? o.push(...S(e, a, n, r, i)) : o.push(...A(e, a)),
        o.filter(p.lm)
    );
}
function b(e, t) {
...
function v(e, t, n) {
    var r, i;
    (e.flags = (0, _.mB)(null != (i = null != (r = e.flags) ? r : t.flags) ? i : 0, g.vc.UNREADS_ALL_MESSAGES, n)),
        (e.flags = (0, _.mB)(e.flags, g.vc.UNREADS_ONLY_MENTIONS, !n));
}
function I(e) {
    let t = [],
        [n, r] = i()(e)
...
function S(e, t, n, r, o) {
    ...
    t.forEach((e) => {
        ...
        Number(null != (n = o.num_year_opens) ? n : 0) > c || Number(null != (r = o.num_month_opens) ? r : 0) > u
            ? f.push(e)
            : Number(null != (i = o.num_three_month_opens) ? i : 0) > 2 && _.push(e);
    });
    let p = [];
    return (
        f.length > 0 &&
    ...
    let n = [],
        ...
        a = c.Z.getFrequentlyWithoutFetchingLatest()
            ...
            .filter((e) => {
                ...
                let r =
                    null !=
                    (n = null == (t = c.Z.frecencyWithoutFetchingLatest.usageHistory[e.id]) ? void 0 : t.recentUses)
                        ? n
                        : [];
...
function C(e, t, n, r) {
    ...
    r(c, null != (l = null == (a = t.channel_overrides) ? void 0 : a[n]) ? l : {}),
