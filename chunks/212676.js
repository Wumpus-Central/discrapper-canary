...
let S =
    ...
    o.forwardRef(function (e, t) {
        let {
            ...
            y = o.useRef(null),
            [b, T] = o.useState(!1),
            { scrollerRef: N, getScrollerState: v } = (0, A.A)(),
            M = (0, f.A)(N);
        ...
        return (
            ...
            (0, E.A)({ ref: N, key: "container", onUpdate: c, resizeObserver: i, listenerMap: l }),
            (0, E.A)({ ref: y, key: "content", onUpdate: c, resizeObserver: i, listenerMap: l }),
            (0, r.jsx)("div", {
                ref: N,
                className: d()(a, { [x.Rv]: g, [x.D8]: S, [s]: !0, [x.fs]: !0, [x.qw]: b && g }),
                style: _,
                dir: m,
                onScroll: R,
                ...I,
                children: (0, r.jsx)(p.xp, {
                    ...
                    children: (0, r.jsxs)("div", {
                        ref: y,
                        className: d()(u, x.Qs),
                        children: [n, b && (0, r.jsx)("div", { className: x.X3 })],
                    }),
                }),
            })
        );
    ...
    let { channel: t, conversation: n, isFocusMode: l, onClose: i } = e,
        ...
        p = o.useCallback(() => {
            U.X.trackThumbsDownReasonSelected({
                ...
                (0, ey.P0)((0, eb.o)(eR.intl.string(eM.default.xrEgG0), eT.Ck.SUCCESS)),
                i();
        }, [t, n.id, l, s, c, m, i]);
    return (0, r.jsxs)("div", {
        className: eD.oO,
...
function eG(e) {
    let { channel: t, conversation: n, actionsShifted: l, suppressBorder: i, onFocusToggle: s } = e,
        ...
        E = g ? eA.g : ef._,
        x = g ? eR.intl.string(eM.default.pDD8E1) : eR.intl.string(eM.default["o+pmGy"]),
            ...
            children: [
                (0, r.jsx)(ep.m, {
                    ...
                    children: (0, r.jsx)(eC.D, {
                        ...
                        children: (0, r.jsx)(eE.G, { color: "currentColor", size: "refresh_sm" }),
                    }),
                }),
                (0, r.jsx)(ex.Y, {
                    targetElementRef: u,
                ...
                (0, r.jsx)(ep.m, {
                    ...
                    children: (0, r.jsx)(eC.D, {
                        ...
                        onClick: s,
                        className: eO(),
                        children: (0, r.jsx)(E, { color: "currentColor", size: "refresh_sm" }),
                    }),
                }),
            ],
        });
        ...
        o.useCallback(
            (n) => {
                ...
                switch (n.key.toLowerCase()) {
                    case "backspace":
                        i &&
                            (tc.A.can(ec.xBc.MANAGE_MESSAGES, d) || c.canDeleteOwnMessage(u)) &&
                            (n.preventDefault(), (0, tp.RC)(d, c, n));
                        break;
                    case "c":
                        ((0, tu.isMac)() ? r : a) && td.p5 && (n.preventDefault(), (0, td.C)(c.content));
                        break;
                    case "e":
                        i && !d.isSystemDM() && (0, th.A)(c, u) && (n.preventDefault(), (0, tp.u_)(d, c));
                        break;
                    case "p":
                        (i || o) && (0, tm.A)(c, d) && (n.preventDefault(), (0, tp.rS)(d, c, n));
                        break;
                    case "+":
                        (i || o) &&
                            (function (e) {
                                let t = null == e.guild_id || to.A.canChatInGuild(e.guild_id),
                                    n = eJ.jW.getSetting(),
                                    { disableReactionCreates: l } = (0, tg.A)({
                                        channel: e,
                                        canChat: t,
                                        renderReactions: n,
                                        canAddNewReactions: t && tc.A.can(ec.xBc.ADD_REACTIONS, e),
                                        isLurking: null != e.guild_id && tn.A.isLurking(e.guild_id),
                                        isActiveChannelOrUnarchivableThread: (0, ti.jr)(e),
                                    });
                                return !l && n;
                            })(d) &&
                            (n.preventDefault(),
                        ...
                        break;
                    case "r":
                        (i || o) && (0, tl.r)(d, c) && (n.preventDefault(), (0, tp.$b)(d, c, n));
                        break;
                    case "f":
                        (i || o) &&
                            (0, te.p)(c) &&
                            (n.preventDefault(), (0, tt.fO)({ message: c, source: "keyboard-shortcut" }));
                        break;
                    case "s":
                        i &&
                            "" !== c.content &&
                            (n.preventDefault(),
                            n.stopPropagation(),
                            tr.A.isSpeakingMessage(t, e) ? (0, ta.pr)() : (0, ta.kP)(d, c));
                        break;
                    case "t":
                        if (i && (0, ti.D1)(d, c)) n.preventDefault(), (0, ts.Tv)(d, c, "Message Shortcut");
                        else if (c.hasFlag(ec.pr7.HAS_THREAD)) {
                            let e = eZ.A.getChannel(ee.default.castMessageIdAsChannelId(c.id));
                            null != e && (i || o) && (n.preventDefault(), (0, ts.JA)(e, o));
                        }
                        break;
                    case "enter":
                        s && (n.preventDefault(), (0, tp.cl)(d, c));
                        break;
                    case "escape":
...
var tf = n(754459),
    ...
    tM = n(484163),
    tR = n(168147);
let tD = o.memo(function (e) {
        let { message: t, notice: n, compact: l = !1, onDismiss: i } = e;
        return (0, r.jsxs)(r.Fragment, {
            children: [
                (0, r.jsxs)("div", {
                    className: d()(tv.K1, { [tv.oE]: l }),
                    children: [
                        (0, r.jsx)("div", {
                            className: tv.Oz,
                            children: (0, r.jsx)(tI.l, { size: "xs", color: "currentColor", className: tv.F_ }),
                        }),
                        (0, r.jsx)("div", {
                            className: tv.jC,
                            children: (0, r.jsx)(e_.E, {
                                ...
                                children: (0, ty.Tz)(n, void 0, t.channel_id),
                            }),
                        }),
                    ],
                }),
                (0, r.jsx)("div", {
                    className: d()(tv.ah, { [tv.oE]: l }),
    ...
    tL = o.memo(function (e) {
        ...
        return (
            ...
            (0, r.jsxs)("div", {
                ...
                className: d()(t, tR.PT, {
                    [tM.BK]: !0,
                    [tM.nB]: "rtl" === t_()(l.content),
                    [tv.Dy]: h?.isBlockedEdit,
                    [tv.bv]: !h?.isBlockedEdit,
                }),
                children: [
                    i ?? (0, tT._A)(l, s),
                    h?.isBlockedEdit &&
...
function nd(e) {
    ...
    return (0, r.jsx)(ex.Y, {
        ...
        clickTrap: !0,
        children: () =>
            (0, r.jsx)(nr.qv, { ref: a, label: eR.intl.string(eR.t.lfIHs4), icon: nc.n, onClick: l }, "add-reaction"),
    });
}
var nu = n(720882),
    nh = n(307731),
    nm = n(534798);
let ng = [t2.Ay.getByName("100"), t2.Ay.getByName("laughing"), t2.Ay.getByName("sparkling_heart")].filter(ns.Vq);
function np(e) {
    e.stopPropagation();
}
function nA(e) {
...
let nf = o.memo(function (e) {
    let { channel: t, message: n } = e,
        ...
        i = (l.length >= 3 ? l : [...(0, t3.A)(l.concat(ng)).values()]).slice(0, 3),
        s = n.reactions.filter((e) => e.me);
    return (0, r.jsx)(r.Fragment, {
        children: i.map((e) => {
            let l = s.find((t) => (0, t6.i6)(t.emoji, (0, t6.jq)(e))),
                ...
                nr.qv,
                {
                    ...
                    onClick: () =>
                        nx({
                            ...
                            channel: t,
                            message: n,
                            location: t8.qN.MESSAGE_HOVER_BAR,
                        }),
...
function nC(e) {
    let {
            ...
            let {
                ...
                { author: c } = n,
                d = (0, m.bG)([nn.A], () => nn.A.getGuild(t.guild_id), [t.guild_id]),
                u = (0, m.bG)([ea.default], () => ea.default.getId()),
                h = (0, ti.Id)(t),
                g = (0, ti.s5)(t),
                { firstMessage: p } = (0, m.bG)([t4.A], () => t4.A.getMessage(t.id), [t.id]),
                A = eJ.jW.useSetting(),
                f = eJ.Q_.useSetting(),
                C = (0, m.bG)([to.A], () => null == t.guild_id || to.A.canChatInGuild(t.guild_id), [t]),
                { canManageMessages: E, canAddNewReactions: x } = (0, m.cf)(
                    [tc.A],
                    () => ({
                        canAddNewReactions: C && tc.A.can(ec.xBc.ADD_REACTIONS, t),
                        canManageMessages: tc.A.can(ec.xBc.MANAGE_MESSAGES, t),
                    }),
                    [t, C],
                ),
                S = (0, tl.u)(t, n),
                _ = (0, ti.n)(t, n),
                I = (0, ti.R)(n),
                j = (0, m.bG)([tn.A], () => null != t.guild_id && tn.A.isLurking(t.guild_id), [t]),
                y = c.id === u,
                T = (E || n.canDeleteOwnMessage(u)) && h && !ec.MRS.UNDELETABLE.has(n.type);
            n.type === ec.lAJ.AUTO_MODERATION_ACTION && (T = T && E),
                t.isModeratorReportChannel() && (T = T && n.id !== p?.id && !(0, e1.A)(n));
            let N = (0, na.ul)(n),
                v = (0, tm.A)(n, t),
                M = !t.isSystemDM() && (0, th.A)(n, u) && h && !g,
                { disableReactionCreates: R } = (0, tg.A)({
                    channel: t,
                    canChat: C,
                    renderReactions: A,
                ...
                P =
                    ...
                    tc.A.canWithPartialContext(ec.xBc.MANAGE_GUILD, { guildId: L }),
                k = (0, te.m)(n),
                O = (0, eQ.kn)(n, t, "MessageHoverBar"),
                G = n.hasFlag(ec.pr7.IS_GUILD_OFFICIAL),
                { enabled: U } = ne.A.useConfig({ location: "message_utilities" }),
                w = (0, m.bG)([nt.A], () => null != nt.A.getSavedMessage(t.id, n.id)),
                F = (0, tO.A)(a),
        ...
        R = o.useCallback(() => {
            S ||
                nl.default.track(ec.HAw.MESSAGE_POPOUT_MENU_OPENED_DESKTOP, {
                    message_id: n.id,
    ...
    return (0, r.jsxs)(r.Fragment, {
        children: [
                ...
                ? (0, r.jsxs)(r.Fragment, {
                      children: [
                          ...
                          l
                              ? (0, r.jsx)(
                                    nr.qv,
                                    { label: eR.intl.string(eR.t.WqhZss), icon: tU.q, onClick: () => (0, tp.S)(t, n) },
                                    "copy-link",
                                )
                              : null,
                          h
                              ? (0, r.jsx)(
                                    nr.qv,
                                    { label: eR.intl.string(eR.t.NpHUi1), icon: tw.c, onClick: () => (0, tp.vc)(t) },
                                    "configure",
                                )
                              : null,
                          L
                              ? (0, r.jsx)(
                                    nr.qv,
                                    { label: eR.intl.string(eR.t.RpE9k7), icon: tF.Q, onClick: () => (0, tp.cl)(t, n) },
                                    "mark-unread",
                                )
                              : null,
                          j
                              ? (0, r.jsx)(
                                    nr.qv,
                                    {
                                        ...
                                        icon: y ? tH.c : tB.c,
                                        onClick: () => (y ? (0, tp.r7)(t, n) : (0, tp.wF)(t, n)),
                                    },
                                    "bookmark",
                                )
                              : null,
                          ...
                          p && f
                              ? (0, r.jsx)(
                                    nr.qv,
                                    { label: eR.intl.string(eR.t.rBIGBL), icon: tK.y, onClick: () => (0, tp.Nw)(t, n) },
                                    "thread",
                                )
                              : null,
                          g && c
            ...
            g && !c
                ? (0, r.jsx)(
                      nr.qv,
                      { label: eR.intl.string(eR.t["5IEsGx"]), icon: tz.W, onClick: (e) => (0, tp.$b)(t, n, e) },
                      "reply-other",
                  )
                : null,
            c
                ? (0, r.jsx)(
                      nr.qv,
                      { label: eR.intl.string(eR.t.bt75uw), icon: tW.R, onClick: () => (0, tp.u_)(t, n) },
                      "edit",
                  )
                : null,
            f
                ? (0, r.jsx)(
                      nr.qv,
                      { label: eR.intl.string(eR.t.I3ltXO), icon: t7.A, onClick: () => (0, tp.Z4)(t, n) },
                      "forward",
                  )
                : null,
            p && !f
            ...
            !p && A
                ? (0, r.jsx)(
                      nr.qv,
                      { label: eR.intl.string(eR.t["39d0Wj"]), icon: tK.y, onClick: () => (0, tp.mF)(t, n) },
                      "view-thread",
                  )
                : null,
            C
                ? (0, r.jsx)(
                      nr.qv,
                      {
                          label: E ? eR.intl.string(eR.t["2km5Gf"]) : eR.intl.string(eR.t["lE/PG3"]),
                          icon: E ? tq.$ : t$.L,
...
function nE(e) {
    let { channel: t, message: n } = e,
        ...
        i = null == n.interaction || (null != n.interactionData && (0, t5.Bl)(n.interactionData));
    return (0, r.jsxs)(r.Fragment, {
        children: [
            !l &&
                i &&
                (0, r.jsx)(
                    nr.qv,
                    { label: eR.intl.string(eR.t["5911Lb"]), icon: tX.m, onClick: () => (0, tp.Io)(t, n) },
                    "retry",
                ),
            (0, r.jsx)(
                nr.qv,
                { label: eR.intl.string(eR.t.oyYWHE), icon: tZ.u, onClick: (e) => (0, tp.RC)(t, n, e) },
                "delete-usent",
            ),
        ],
    });
...
function nx(e) {
    ...
    let r = (0, t6.jq)(n);
    "add" === t
        ? (0, t8.BB)(l.id, i.id, r, s, { burst: a })
        : (0, t8.et)({ channelId: l.id, messageId: i.id, emoji: r, location: s, options: { burst: a } });
}
function nS(e, t, n) {
    ...
    return (0, r.jsx)(t9.C, {
        ...
        onSelectEmoji: (l) => {
            ...
            nx({ type: "add", emoji: i, channel: e, message: t, location: t8.qN.MESSAGE_REACTION_PICKER, isBurst: a }),
                s && (a ? tk()(n, 150)() : n());
        },
        analyticsOverride: i,
        messageId: t.id,
...
let n_ = o.memo(function (e) {
    let { channel: t, message: n, isHeader: l, isReply: i } = e,
        ...
        a = (function (e) {
            let { channel: t, message: n } = e;
            return n.state === ec.cmJ.SEND_FAILED ? (0, r.jsx)(nE, { channel: t, message: n }) : null;
        })(e),
        o = (function (e) {
            let { message: t } = e;
            return t.state !== ec.cmJ.SEND_FAILED ? (0, r.jsx)(nC, { ...e }) : null;
        })(e);
    ...
    let {
        ...
        A = o.useMemo(() => {
            ...
            if (e.type === ec.lAJ.USER_JOIN)
                return (0, nP.$)(
                    eR.intl.formatToParts(nw.A.getSystemMessageUserJoin(e.id), {
            ...
            if (e.type === ec.lAJ.GUILD_APPLICATION_PREMIUM_SUBSCRIPTION)
                return (0, nP.$)((0, nG.P)({ application: e?.application, username: g?.nick }));
            if (e.type === ec.lAJ.PRIVATE_CHANNEL_INTEGRATION_ADDED)
                return (0, nP.$)((0, nU.g6)({ application: e?.application, username: g?.nick }));
            if (e.type === ec.lAJ.PRIVATE_CHANNEL_INTEGRATION_REMOVED)
                return (0, nP.$)((0, nU.uk)({ application: e?.application, username: g?.nick }));
...
let nV = o.memo(function (e) {
    let {
        ...
        C = (0, e6.Yq)(s, u),
        E = (0, nR.Am)(t),
        x = E?.type === nM.G4.APPLICATION_COMMAND ? E.target_user?.id : void 0,
        S = (0, e6.r4)(x, n.id),
        _ = (0, e6.I)(x, n, c, u),
        I = (0, e6.Ge)(d, u),
        j = (0, e6.U_)(a, u),
...
function nW(e) {
    ...
    let { ...a } = (0, h.rm)(e.id ?? ""),
        ...
        { popouts: c, setPopout: u } = (0, tf.A)(n.id, nz.Fd),
        g = (0, e2.Ay)(n),
        p = (0, e5.fF)(n),
        A = (0, e5.ZD)(n);
...
function nq(e) {
    let {
        ...
        { isFocused: C, handleFocus: E, handleBlur: x } = (0, e6.G8)(A),
        { popouts: S, selected: _, setPopout: I } = (0, tf.A)(n.id, nz.Fd),
        j = eJ.hD.useSetting(),
        y = eJ.rs.useSetting(),
        ...
        N = (0, ez.S)((n.editedTimestamp ?? n.timestamp).valueOf()),
        {
            ...
            handleMouseLeave: M,
            isHovered: R,
        } = (0, e6.yp)({ groupId: u, message: n, defaultValue: _ }),
        ...
        H = (0, e5.fF)(n, u),
        B = (0, e5.ZD)(n),
        V = (0, r.jsx)(e9.x, { value: P, children: (0, nv.A)(e, O, !1) }),
        ...
        children: [
            ...
            (0, r.jsx)(e7.A, {
                ...
                className: d()(c, {
                    ...
                    [nI.M1]: (0, er.ec)(n),
                    [nI.H4]: (0, e1.A)(n),
                    [nI._A]: n.id === u || n.type === ec.lAJ.REPLY,
                    [nI.wH]: L,
                }),
                zalgo: !0,
                onKeyDown: w,
...
let n$ = o.memo(function (e) {
    let t,
        n,
        {
            ...
            groupId: f,
            renderContentOnly: C,
            hideInviteEmbedBanner: E,
        } = e;
    eH()(i.type !== ec.lAJ.THREAD_STARTER_MESSAGE, "Message must not be a thread starter message");
    let x = ec.sl8.has(i.type) ? i.messageReference : void 0,
        { onFocus: S, ..._ } = (0, h.rm)(e.id ?? ""),
        I = eJ.hD.useSetting(),
        j = eJ.rs.useSetting(),
        y = (0, m.bG)([eq.A], () => eq.A.getMessageByReference(x)),
        { popouts: T, selected: N, setPopout: v } = (0, tf.A)(i.id, nz.Fd),
        M = (0, e6.VL)(i, a, v),
        R = (0, e6.ri)(i, a),
        {
            handleMouseEnter: D,
            ...
            hasHovered: P,
            isHovered: k,
        } = (0, e6.yp)({ groupId: f, message: i, defaultValue: N }),
        { isFocused: O, hasFocused: G, handleFocus: U, handleBlur: w } = (0, e6.G8)(S),
        F = o.useCallback(
            (e) => {
                U(e), D(e);
            },
        ...
        V = (0, m.bG)([b.Ay], () => b.Ay.keyboardModeEnabled),
        K = N || B || (V && O),
        z = K || k,
        W = (0, m.bG)(
            [eZ.A],
        ...
        em = (0, e8.o)(),
        eg = (0, tE.A)({ message: i, channel: a, officialMessagesEnabled: eh }),
        ep = o.useRef(window),
        eA = null != eu;
    (n =
        i.type === ec.lAJ.CUSTOM_GIFT
            ...
            : !B && eA
              ? (function (e, t) {
                    ...
                    return (0, r.jsx)(tL, { message: n, content: t, compact: l ?? !1 });
                })(e, Z)
              : (0, nv.A)(e, Z, B)),
        (n = (0, r.jsx)(e9.x, { value: z, children: n }));
    let ef = i.id === f,
        eC = (0, r.jsx)(p.vN, {
            ...
            children: (0, r.jsx)("li", {
                ...
                children: (0, r.jsx)(e7.A, {
                    ...
                    className: d()(g, {
                        ...
                        [nI.mK]: i.mentioned,
                        [nI.M1]: (0, er.ec)(i),
                        [nI.SH]: i.type === ec.lAJ.NITRO_NOTIFICATION,
                        [nI.Sg]: i.hasFlag(ec.pr7.IS_GUILD_OFFICIAL) && eh && !em,
                        [nI.H4]: (0, e1.A)(i),
                        [nI._A]: !C && (ef || i.type === ec.lAJ.REPLY),
                        [nI.wH]: K,
                        [nI.$n]: en?.message.id === i.id,
                        [nI.$w]: i.isCommandType() && i.state === ec.cmJ.SENDING,
                        [nI.DX]: eA,
                    }),
                    zalgo: !B,
                    childrenRepliedMessage:
                    ...
                    messageRef: (e) => {
                        (eg.current = e), (ep.current = e?.ownerDocument?.defaultView ?? window);
                    },
                    author: et,
                }),
            }),
    ...
    return null != el
        ? (0, r.jsx)(
              e4,
              { flashKey: el, className: d()({ [nI.bB]: !0, [nI._A]: !u && i.id === f }), children: eC },
              `bg-flash-${l}`,
          )
        : eC;
});
...
function n2(e) {
    let { expanded: t, onClick: n, count: l, compact: i, collapsedReason: s, canUncollapse: a = !0 } = e,
        o = (0, nJ.YW)({ collapsedReason: s })
            ...
            .otherwise(() => (0, r.jsx)(eN.P, { size: "md", color: "currentColor", className: n1.Q6 }));
    return (0, r.jsx)(e7.A, {
        compact: i,
        role: "group",
            ...
            u
                ? t.content.map((e, s) => {
                      ...
                      if (e.type === ec.TZK.MESSAGE || e.type === ec.TZK.THREAD_STARTER_MESSAGE) {
                          let t = e.type === ec.TZK.THREAD_STARTER_MESSAGE ? nW : n$;
                          return (0, r.jsx)(
                              t,
                              {
...
function lg(e) {
    let { style: t, channel: n, conversation: l, scrollerRef: i, requestDismiss: s } = e,
        ...
        I = o.useCallback(() => {
            let e = i.current;
            null != e && (x(e.getDistanceFromTop() > 5), _(e.getDistanceFromBottom() > 5));
        }, [i]),
              ...
              children: [
                  ...
                  (0, r.jsxs)("div", {
                      ...
                      children: [
                          ...
                          E && (0, r.jsx)("div", { className: lh.iX, "aria-hidden": !0 }),
...
let lI = o.memo(function (e) {
    let t,
        ...
        y = (0, $.z)({ y: c.y, opacity: +!c.hidden, config: li }, "respect-motion-settings"),
        b = (0, $.z)(
            {
                ...((t = h && E),
                (n = 0),
                h && (E && x ? (n = -17) : E ? (n = -13) : x && (n = -24)),
                (l = 0),
                (i = 4),
                (s = 1),
                E && x ? ((l = 0), (i = 0), (s = 0.5)) : h && x && ((l = 1), (i = 0), (s = 1)),
                {
                    textScale: h ? 1 : 0.5,
                    textX: n,
                    textOpacity: +!!h,
    ...
    return (0, r.jsxs)(lx, {
        ...
        className: d()(lE.ng, { [lE._D]: E, [lE.DJ]: x, [lE.KZ]: S }),
        style: {
        ...
        children: [
            ...
            (0, r.jsx)(lS, {
                tag: "span",
                variant: E ? "text-md/semibold" : "text-md/normal",
                color: E ? "text-strong" : x ? "text-default" : S ? "text-muted" : "text-subtle",
                className: lE.QV,
                lineClamp: 1,
                style: {
...
function lR(e) {
    let { channel: t, message: n } = e,
        ...
        a = o.useMemo(() => (0, ty.Ay)(n).content, [n]),
        c = eJ.PZ.useSetting(),
        ...
        children: Array.from({ length: 4 }, (e, t) => {
            ...
            return (0, r.jsxs)(
                "div",
                {
                    className: lv.uA,
                    children: [
                        (0, r.jsx)("div", { className: lv.h }),
                        (0, r.jsxs)("div", {
                            className: lv.jE,
                            children: [
                                (0, r.jsx)("div", { className: lv.zw, style: { width: n.name } }),
                                (0, r.jsx)("div", { className: lv.P4, style: { width: n.l1 } }),
                                null != n.l2 && (0, r.jsx)("div", { className: lv.P4, style: { width: n.l2 } }),
                            ],
                        }),
                    ],
                },
...
function lk(e) {
    ...
    let v = o.useCallback(
        ...
        R = o.useCallback(
            (e) => {
                U.X.trackTopicsUnitClicked({ channel: t, conversationId: e, isFocusMode: a }), s(e), x();
            },
            [t, x, a, s],
        ),
        D = o.useCallback(() => (null != N ? (0, r.jsx)(lL, { channel: t, conversationId: N }) : null), [t, N]),
        L = o.useCallback(
            (e) => {
                let t;
        ...
        P = o.useCallback(() => {
            E(!0), U.X.trackTopicsUnitImpression({ channel: t, conversationIds: _.map((e) => e.id), isFocusMode: a });
        }, [t, _, a]);
    return 0 === l.length
        ? null
        : (0, r.jsx)("div", {
              className: d()(lP.kL, a && lP.tW, { [lP._Y]: !a && "navigation" === c, [lP.J_]: !a && "return" === c }),
              children: (0, r.jsxs)("div", {
                  className: d()(lP.rI, C && lP.RK),
                  onMouseEnter: P,
                  onMouseLeave: M,
                  onWheel: a ? void 0 : L,
                  children: [
                      (0, r.jsx)("div", { className: d()(lP.oT, C && lP.RK), "aria-hidden": !0 }),
                      (0, r.jsx)(ex.Y, {
                          targetElementRef: y,
                          shouldShow: C && null != N,
                          position: "top",
                          ...
                          children: () =>
                              (0, r.jsx)("div", {
                                  ref: y,
                                  className: d()(lP.nd, { [lP.mc]: C, [lP._z]: !C, [lP.OP]: C && I, [lP.yc]: C && j }),
                                  style: { height: 188 },
                                  children: (0, r.jsx)(lj, {
                                      items: S,
                                      isExpanded: C,
...
let lG = (e) => {
    ...
    return (0, k.sV)(t.guild_id, "scrollbar_chips")
        ? (0, r.jsxs)(z, {
              children: [(0, r.jsx)(lA, { channel: t }), (0, r.jsx)(lO, { channel: t, scrollManager: n })],
          })
        : null;
};
var lU = n(354328),
...
class ie {
    ...
    updateVisibleMessagesDebounced = ll().debounce(l5.s_, 300);
    ...
    enableAutomaticAck() {
        this.isInitialized() &&
            ...
            this.updateStoreDimensions(() => {
                (0, l4._9)(this.props.channel.id, this.props.windowId);
            }));
    }
        ...
        return function () {
            ...
            (e.messageFetchAnchor = e.findFetchAnchor(l)),
                ...
                I.A.fetchMessages({
                    ...
                    before: t,
                    after: n,
                    limit: Math.min(ec.EMb, 2 * (0, lY.h)("scrollManager.loadMore")),
                    truncate: !0,
                });
        };
    })();
    ...
    setScrollToBottom() {
        ...
        if (t.hasMoreAfter)
            I.A.jumpToPresent(n.id, (0, lY.h)("scrollManager.jumpToPresent")),
    ...
    updateStoreDimensions(e) {
        ...
        if (this.isPinned()) l3.A.updateChannelDimensions(t.id, Date.now(), 1, 1, 0, e);
        else {
            let { placeholderHeight: n } = this.props,
                { scrollTop: l, scrollHeight: i, offsetHeight: s } = this.getScrollerState();
            l3.A.updateChannelDimensions(t.id, Date.now(), l - n, i - n, s, e);
        }
    }
    scrollIntoViewRect() {}
    scrollPageUp() {
    ...
    scrollToMessage(e) {
        ...
        let s = () => {
            (this.jumping = !1),
                (0, l2.vq)(i) && ((i.tabIndex = -1), i.focus({ preventScroll: !0 })),
                (this.scrollCounter = 0),
                this.handleScroll(),
    ...
    cleanup() {
        (this.acking = !1),
            ...
            (0, l4.Z5)(this.props.channel.id, this.props.windowId);
    }
}
n(667532);
var it = n(95561),
        ...
        children: [
            ...
            s
                ? (0, r.jsx)(eC.D, {
                      ...
                      children: (0, r.jsx)(eN.P, { size: "md", color: "currentColor", className: ip.b }),
                  })
                : null,
        ],
    });
...
function iC(e) {
    ...
    let u = o.useCallback(() => {
        c?.(), (0, im._$)({ channelId: t, warningId: n, senderId: l, warningType: i, cta: im.Wm.USER_BANNER_DISMISS });
    }, [c, t, n, l, i]);
    return (0, r.jsx)(iA, { buttons: d, description: a, header: s, onDismiss: u });
}
var iE = n(477427);
function ix(e) {
    let { channelId: t, warningId: l, senderId: i } = e,
        ...
        c = (e) => {
            ia.A.updateChannelOverrideSettings(null, t, { muted: !0 }, iE.fd.Muted),
    ...
    return (
        o.useEffect(() => {
            (0, im.mO)(ec.HAw.SAFETY_WARNING_VIEWED, {
                channelId: t,
                warningId: l,
                senderId: i,
            ...
            buttons: [
                {
                    ...
                    onClick: () => {
                        (0, is.openModalLazy)(async () => {
                            let { default: e } = await Promise.all([n.e("60709"), n.e("82911"), n.e("47894")]).then(
                                n.bind(n, 129493),
                            );
                            return (n) => {
                ...
                { text: eR.intl.string(eR.t.ftIK2A), onClick: () => c(im.Wm.USER_BANNER_MUTE) },
            ],
        })
    );
}
    ...
    let { appliedTags: t, setAppliedTags: n, wrap: l } = e,
        i =
            null != n
                ...
                : void 0;
    return (0, r.jsx)("div", {
        className: d()(ik._, { [ik.L]: l }),
        children: Array.from(t).map((e) =>
            (0, r.jsx)(iP.A, { tag: e, onRemove: i, size: null == i ? iP.A.Sizes.SMALL : iP.A.Sizes.MEDIUM }, e.id),
        ),
    });
}
var iG = n(930657);
function iU(e) {
    let { channel: t } = e,
        n = (0, iL.kt)(t),
        { firstMessage: l } = (0, m.cf)([t4.A], () => t4.A.getMessage(t.id)),
        i = new Set((0, iL.zt)(t, n)),
        s = (0, iD.gU)(t) ?? iR.o,
        a = (0, P.Ay)(t);
    return (0, r.jsxs)(iM.Ay, {
        channelId: t.id,
        className: iG.kL,
        children: [
            (0, r.jsx)("div", { className: iG.P0, children: (0, r.jsx)(s, { className: iG.Kk, strokeWidth: 1.75 }) }),
            (0, r.jsx)(iM.cr, { className: iG.wx, children: a }),
            null == l &&
                (0, r.jsx)(e_.E, {
                    variant: "text-md/normal",
                    color: "text-default",
...
function iz(e) {
    let { joinRequest: t, guild: n } = e,
        l = (0, m.bG)([l$.default], () => l$.default.getUser(t.userId));
    return (0, r.jsxs)("div", {
        className: iK.I8,
        children: [
            (0, r.jsxs)("div", {
                ...
                children: [
                    null != n &&
                        (0, r.jsxs)("div", {
                            className: iK.yB,
                            children: [
                                (0, r.jsx)(iF.Ay, { guild: n, active: !0, size: iF.Ay.Sizes.SMOL, className: iK.$f }),
                                (0, r.jsx)(eI.D, {
            ...
            t.formResponses
                ?.filter((e) => e.field_type !== iH.rX.TERMS)
                .map((e) => {
                    let t =
                        e.field_type === iH.rX.MULTIPLE_CHOICE && null != e.response
                            ? e.choices[e.response]
                            : e.response;
                    return (0, r.jsxs)(r.Fragment, {
                        children: [
                            (0, r.jsx)("hr", { className: iK.g2 }),
                            (0, r.jsxs)("div", {
                                className: iK.fs,
                                children: [
                                    (0, r.jsx)(e_.E, {
...
function iW(e) {
    let { channel: t } = e,
        { loading: n, joinRequest: l, joinRequestGuild: i } = (0, iB.A)(t.id);
    return (0, r.jsx)(iM.Ay, {
        channelId: t.id,
        className: iK.kL,
        children:
            null != l && null != l.formResponses
                ? (0, r.jsxs)("div", {
                      className: iK.KJ,
                      children: [
                          (0, r.jsx)("div", { children: (0, r.jsx)(iz, { guild: i, joinRequest: l }) }),
                          (0, r.jsx)(iV.A, { channelId: t.id, showProfile: !0 }),
                      ],
                  })
                : n
                  ? (0, r.jsx)(iw.y, {})
    ...
    return i
        ? (0, r.jsx)(ep.m, {
              ...
              children: (0, r.jsxs)(eC.D, {
                  className: d()(i1.e, l),
                  onClick: () => (0, i0.jv)(t.id, s),
                  children: [
                      n,
                      (0, r.jsx)("div", {
                          className: i1.Z,
                          children: (0, r.jsx)(tW.R, { size: "xs", color: "currentColor" }),
                      }),
                  ],
              }),
          })
...
function i5(e) {
    let t,
        ...
        a = (0, P.Ay)(n) ?? "",
        {
            ...
            eventHandlers: d,
            isAnimating: u,
        } = (0, lT.A)({ userId: i?.id, size: ly._3.SIZE_80, animateOnHover: !0 }),
        [h, g] = o.useState(!1),
        p = o.useCallback(() => {
            d.onMouseEnter(), g(!0);
        }, [d]),
        ...
        children: [
            ...
            n.isMultiUserDM()
                ? (0, r.jsx)(i2, {
                      channel: n,
                      editable: !0,
                      location: iJ.A.EMPTY_GROUP_DM,
                      children: (0, r.jsx)(iQ.A, { channel: n, size: ly._3.SIZE_80, animated: t, "aria-label": a }),
                  })
                : (0, r.jsx)(lb.eu, {
                      "aria-label": a,
                      size: ly._3.SIZE_80,
            ...
            (0, r.jsx)(iM.cr, {
                children: f
                    ? (0, r.jsx)(iX.A, {
                          ...
                          effectDisplayType: h ? iY.G.ANIMATED : iY.G.STATIC,
                          loop: !0,
                      })
                    : a,
            }),
            (0, r.jsx)(iM.j1, { children: l }),
            n.isMultiUserDM() &&
                (0, r.jsxs)(iq.e, {
                    className: i7.U,
                    children: [
                        (0, r.jsx)(i4.NE, { channel: n, text: eR.intl.string(eR.t.NB5DFD), icon: i$.D }),
                        (0, r.jsx)(ev.$, {
                            icon: tW.R,
                            variant: "secondary",
                            text: eR.intl.string(eR.t["5Q9+/L"]),
                            "aria-label": eR.intl.string(eR.t["5Q9+/L"]),
                            onClick: () => (0, i3.U)(n.id, iJ.A.EMPTY_GROUP_DM),
                        }),
                    ],
                }),
        ],
...
function ss(e) {
    ...
    return (
        (t = i
            ? (0, r.jsx)(sl.A, { size: 12, color: s, className: si.TS })
            : (0, r.jsx)("div", { className: si.yY, style: { backgroundColor: s } })),
        (0, r.jsxs)("div", { className: d()(n, si.JC), style: { "--custom-role-label-color": s }, children: [t, a, l] })
    );
}
var sa = n(468689),
    sr = n(46054),
...
function sg(e) {
    let { channel: t } = e,
        ...
        i = (0, P.Ay)(t, !0),
        s = t.guild_id,
        a = (0, m.bG)([sc.A], () => (null != s ? sc.A.getSortedRoles(s) : void 0)),
        c = (0, m.bG)([l$.default, nn.A], () => l$.default.getUser(nn.A.getGuild(s)?.ownerId)),
        u = o.useMemo(() => (null != a ? a.filter((e) => !(0, so.Oy)(e)) : []), [a]),
        h = o.useMemo(
            () =>
                ll()(u)
                    .filter((e) => {
                        if (null == s) return !1;
                        let n = sd.aH({ forceRoles: { [e.id]: e }, context: t });
                        return i8.X8(n, i8.kg(ec.xBc.ADMINISTRATOR, ec.xBc.VIEW_CHANNEL));
                    })
                    .value(),
            [t, s, u],
        ),
        g = (0, m.yK)([l$.default], () => {
            ...
            for (let n of (null != c && (e[c.id] = c), Object.values(t.permissionOverwrites))) {
                ...
                let t = l$.default.getUser(n.id);
                null != t && (e[t.id] = t);
            }
            return ll()(e)
                .filter((e) => {
                    let n = sd.$3({ permission: ec.xBc.ADMINISTRATOR, user: e, context: t }),
                        l = t.permissionOverwrites[e.id] ?? sd.x3,
                        i = i8.zy(l.allow, ec.xBc.VIEW_CHANNEL);
                    return n || i;
                })
                .value();
        }, [t, c]),
        p = tc.A.can(ec.xBc.MANAGE_CHANNELS, t) || tc.A.can(ec.xBc.MANAGE_ROLES, t),
        A = o.useCallback(() => l(!1), []);
    return (0, r.jsxs)(iM.Ay, {
        channelId: t.id,
        children: [
            (0, r.jsx)(iM.WK, { locked: !0, channelType: t.type }),
            (0, r.jsx)(iM.cr, { children: eR.intl.format(eR.t.I3R7Vn, { channelName: i }) }),
            (0, r.jsx)(iM.j1, {
                className: tR.PT,
                ...
                children: [
                    (function () {
                        if (1 !== g.length || h.length > 0)
                            return (0, r.jsx)(i6.A, { guildId: t.guild_id, className: sm.HD, maxUsers: 5, users: g });
                        let e = g[0],
                            n = iv.Ay.getName(e);
                        return (0, r.jsxs)("div", {
                            className: sm.HD,
                    ...
                    h.map((e, n) => {
                        ...
                        return p
                            ? (0, r.jsx)(
                                  sh,
                                  {
                                      className: d()(sm.JC, { [sm.HV]: n === h.length - 1 }),
                                      roleName: e.name,
                                      roleColor: l,
                                      disabled: !p,
                                      verified: i,
                                      onClick: () => {
                                          sa.A.open(t.guild_id, ec.BEX.MEMBERS), sa.A.selectRole(e.id);
                                      },
                                  },
                                  e.id,
                              )
            ...
            n
                ? (0, r.jsx)(se.aF, {
                      renderModal: (e) =>
                          (0, r.jsx)(sn.default, { ...e, onClose: () => (A(), e.onClose()), channelId: t.id }),
                      onCloseRequest: () => l(!1),
                  })
                : null,
        ],
...
function sA(e) {
    let { channel: t } = e,
        n = (0, P.Ay)(t, !0),
        l = (0, m.bG)([tc.A], () => tc.A.can(ec.xBc.MANAGE_CHANNELS, t) && iT.bk.has(t.type));
    return (0, r.jsxs)(iM.Ay, {
        channelId: t.id,
        children: [
            (0, r.jsx)(iM.WK, { channelType: t.type }),
            (0, r.jsx)(iM.cr, { children: eR.intl.format(eR.t.I3R7Vn, { channelName: n }) }),
            (0, r.jsx)(iM.j1, {
                className: tR.PT,
...
function sj(e) {
    let { userId: t, channel: l } = e,
        i = o.useRef(null),
        { analyticsLocations: s } = (0, sE.Ay)(iJ.A.USERNAME),
        a = (0, m.bG)([l$.default], () => l$.default.getUser(t)),
        c = (0, m.bG)([s_.Ay], () => (null != t ? s_.Ay.getMember(l.guild_id, t) : null)),
    ...
    let g = c?.nick ?? iv.Ay.getName(a) ?? "???",
        p = c?.colorString;
    return null == a
        ? (0, r.jsx)("span", { className: d()(sI.eM, sI.sL), children: g })
        : (0, r.jsx)(sE.f5, {
              value: s,
              children: (0, r.jsx)(sS.A, {
                  ...
                  children: (e) =>
                      (0, r.jsx)(eC.D, {
                          ...
                          className: sI.eM,
                          onContextMenu: h,
                          children: (0, r.jsx)(sf.g, { name: g, colorString: p ?? null, colorStrings: u }),
                      }),
              }),
          });
}
                  ...
                  (0, r.jsx)(e_.E, {
                      ...
                      children: (0, r.jsx)("div", {
                          ...
                          children: eR.intl.format(eR.t.imPXd5, {
                              usernameHook: (e, n) => (0, r.jsx)(sj, { userId: t.ownerId, channel: t }, n),
                          }),
                      }),
                  }),
...
function sb(e) {
    ...
    return (0, r.jsxs)(iM.Ay, {
        channelId: t.id,
        children: [
            (0, r.jsx)("div", { className: sI.P0, children: (0, r.jsx)(n, { className: sI.Kk }) }),
            (0, r.jsx)(iM.cr, { children: l }),
            (0, r.jsx)(sy, { channel: t }),
        ],
    });
}
var sT = n(328857),
...
function sH(e) {
    let { channel: t, user: n } = e,
        l = !0 === n.bot,
        {
            ...
            let l,
                i =
                    (l = (0, m.bG)([nD.A], () => nD.A.getRelationshipType(t), [t])) === ec.eA$.NONE ||
                    l === ec.eA$.BLOCKED ||
                    l === ec.eA$.PENDING_INCOMING,
                s = n || i,
                a = (0, sF.D)(e.id, t),
                { message: r, loaded: o, error: c } = (0, sw.I)(e, { enabled: s }),
        ...
        h = o.useCallback(() => {
            null != i &&
                (0, sU.b8)(i, () => {
                    sG.A.closePrivateChannel(t.id, u);
                });
        }, [t.id, i, u]);
    return !s || (null == i && a)
        ? null
...
function sV(e) {
    let { channel: t, application: n, oauth2Token: l } = e,
        i = (0, m.bG)([sD.Ay], () => sD.Ay.getSelfEmbeddedActivities());
    function s() {
        sR.A.delete(l.id);
        let e = i.get(n.id);
        null != e && sL.A.leaveActivity({ location: e.location, applicationId: n.id });
    }
    return (0, r.jsx)(ev.$, {
        variant: "secondary",
        ...
        onClick: () => {
            (0, is.openModal)((e) =>
                ...
                nl.default.track(ec.HAw.APP_MANAGE_CTA_CLICKED, {
                    application_id: n.id,
                    channel_id: t.id,
                    channel_type: t.type,
                });
...
function sK(e) {
    ...
    let { channel: n, user: l } = e,
        i =
            ((t = l?.id ?? ec.dJq),
            (0, m.bG)([sP.A], () => (null !== t ? sP.A.getUserProfile(t ?? ec.dJq)?.application : void 0)) ?? void 0),
    ...
    return (o.useEffect(() => {
        l.bot && a === sk.FetchState.NOT_FETCHED && sR.A.fetch();
    }, [l.bot, a]),
    l.bot && null != i && null != s)
        ? (0, r.jsxs)(iq.e, {
              size: "sm",
              children: [
                  (0, r.jsx)(sB, { channel: n }),
                  (0, r.jsx)(sV, { application: i, channel: n, oauth2Token: s }),
                  (0, r.jsx)(sH, { channel: n, user: l }),
              ],
          })
        : (0, r.jsx)(iq.e, { size: "sm", children: (0, r.jsx)(sH, { channel: n, user: l }) });
}
var sz = n(573435),
    sW = n(903209),
    sq = n(975732),
...
function sY(e) {
    let { userId: t, channelId: n, showDivider: l = !1 } = e,
        i = (0, m.bG)([sP.A], () => sP.A.getMutualGuilds(t), [t]),
        s = l$.default.getUser(t);
    o.useEffect(() => {
        null == i && null != s && (0, sW.A)(t, s.getAvatarURL(null, 80), { withMutualGuilds: !0 });
    }, [i, t, s]);
    let a = o.useMemo(() => {
        if (null == i) return [];
        let e = i.slice(0, 3),
        ...
        return e
            .map((e, n) => {
                let { guild: l } = e,
                    i = s$.Ay.getGuildIconURL({ id: l.id, icon: l.icon, size: 24 });
                if (null == i) return null;
                let s = (0, r.jsx)("img", { src: i, alt: "", className: sZ.my }, l.id);
                return n === t
                    ? s
                    : (0, r.jsx)(
                          sz.Ay,
                          {
                              className: sZ.cp,
                              mask: sz.Ay.Masks.VOICE_USER_SUMMARY_ITEM,
                              width: 24,
                              height: 24,
                              children: s,
                          },
    ...
    return null == i || 0 === i.length
        ? (0, r.jsx)("div", {
              className: d()(sZ.kL, l ? sZ.yF : null),
              children: (0, r.jsx)(e_.E, {
                  color: "text-default",
                  variant: "text-sm/normal",
        ...
        : (0, r.jsxs)(eC.D, {
              className: d()(sZ.kL, sZ.vk, { [sZ.yF]: l }),
              onClick: () => {
                  (0, sq.openUserProfileModal)({
                      userId: t,
                      channelId: n,
                      tabSection: sJ.RP.MUTUAL_GUILDS,
                      sourceAnalyticsLocations: [iJ.A.DM_CHANNEL],
                  });
              },
              children: [
                  (0, r.jsx)("div", { className: sZ.H, children: a }),
                  (0, r.jsx)(e_.E, {
                      className: sZ.NI,
                      variant: "text-sm/normal",
...
function s2(e) {
    ...
    return (0, r.jsx)(ev.$, {
        ...
        variant: "secondary",
        onClick: () => {
            sX.A.blockUser(t, { location: ec.liQ.DM_CHANNEL });
        },
...
function s3(e) {
    ...
    return n
        ...
        : (0, r.jsx)(ev.$, {
              variant: "primary",
              onClick: () => {
                  sX.A.addRelationship({ userId: t, context: { location: ec.liQ.DM_CHANNEL } });
              },
              text: l,
          });
}
function s4(e) {
    ...
    return (0, r.jsx)(ev.$, {
        variant: "secondary",
        onClick: () => {
            sX.A.removeFriend(t, { location: ec.liQ.DM_CHANNEL });
        },
...
function s7(e) {
    ...
    return (0, r.jsx)(ev.$, {
        variant: "secondary",
        onClick: () => {
            sX.A.unblockUser(t, { location: ec.liQ.DM_CHANNEL });
        },
            ...
            (0, r.jsxs)(iq.e, {
                ...
                children: [
                    ...
                    (0, r.jsx)(ev.$, {
                        variant: "secondary",
                        onClick: () => {
                            sX.A.cancelFriendRequest(n.id, { location: ec.liQ.DM_CHANNEL });
                        },
                        text: eR.intl.string(eR.t.rQSndv),
                    }),
                    (0, r.jsx)(s2, { userId: n.id }),
                    l ? null : (0, r.jsx)(sH, { channel: t, user: n }),
                ],
            }),
        ],
    });
...
function s8(e) {
    ...
    if (s === ec.eA$.PENDING_INCOMING) return (0, r.jsx)(s5, { channel: n, user: l, showingBanner: i });
    switch (s) {
        case ec.eA$.NONE:
            l.bot || (t = (0, r.jsx)(s3, { userId: l.id, showingBanner: i }));
            break;
        case ec.eA$.FRIEND:
            t = (0, r.jsx)(s4, { userId: l.id });
            break;
        case ec.eA$.BLOCKED:
            t = (0, r.jsx)(s7, { userId: l.id });
            break;
    ...
    return (0, r.jsxs)(iq.e, {
        size: "sm",
        children: [t, a ? (0, r.jsx)(s2, { userId: l.id }) : null, i ? null : (0, r.jsx)(sH, { channel: n, user: l })],
    });
}
var s6 = n(92650),
    s9 = n(138298),
...
function at(e) {
    let { channel: t, user: n } = e,
        l = o.useCallback(() => {
            (0, ey.P0)((0, eb.o)(eR.intl.string(eR.t.a2j0hv), eT.Ck.FAILURE));
        }, []),
        i = o.useCallback(() => {
            s9.A.closeChannelSidebar(ae.fe);
        }, []),
        s = o.useCallback(() => {
            s9.A.closeChannelSidebar(ae.fe);
        }, []),
        ...
        } = (0, s6.t)({ user: l$.default.getUser(n.id), onError: l, onAcceptSuccess: s, onRejectSuccess: i }),
        g = d || u || h || m;
    return (0, r.jsxs)(iq.e, {
        size: "sm",
        children: [
...
function al(e) {
    ...
    return (
        u
            ? (t = null)
            : a || c
              ? (t = (0, r.jsx)(at, { channel: n, user: l }))
              : d
                ? (t = (0, r.jsx)(sK, { channel: n, user: l }))
                : ((t = (0, r.jsx)(s8, { channel: n, user: l, showingBanner: i })),
                  o === ec.eA$.PENDING_INCOMING && (h = an.O)),
        (0, r.jsxs)("div", {
            className: h,
            children: [(0, r.jsx)(sY, { userId: l.id, channelId: n.id, showDivider: h !== an.O }), t],
        })
    );
}
var ai = n(746080),
...
function aa(e) {
    ...
    if (n.isForumPost()) return (0, r.jsx)(iU, { channel: n });
    if (iT.Le.has(n.type)) return (0, r.jsx)(sb, { channel: n });
    if (i) return (0, r.jsx)(sT.A, { channel: n });
    if (l) return (0, r.jsx)(sg, { channel: n });
    return (0, r.jsx)(sA, { channel: n });
}
function ar(e) {
    let { channel: t, showingBanner: n } = e,
        l = (0, P.Ay)(t),
        { type: i } = t,
        s = (0, m.bG)([l$.default], () => (t.isPrivate() ? l$.default.getUser(t.getRecipientId()) : null)),
        a = iv.Ay.useUserTag(s),
        { canManageRoles: o, canReadMessageHistory: c } = (0, m.cf)([tc.A], () => ({
            canManageRoles: tc.A.can(ec.xBc.MANAGE_ROLES, t),
            canReadMessageHistory: tc.A.can(ec.xBc.READ_MESSAGE_HISTORY, t),
        }));
    if (t.isSystemDM()) return (0, r.jsx)(i5, { channel: t, children: eR.intl.string(eR.t.Rzvnig) });
    if (i === ec.rbe.DM)
        return (0, r.jsxs)(i5, {
            channel: t,
            user: s,
            children: [
                null == s || s.isProvisional
                    ? null
                    : (0, r.jsx)(eI.D, { variant: "heading-xl/medium", className: as.SX, children: a }),
                eR.intl.format(eR.t["Qvg+6+"], { username: l }),
                s?.isProvisional ? (0, r.jsx)(ib.Y, { userId: s.id }) : null,
                null != s ? (0, r.jsx)(al, { channel: t, user: s, showingBanner: n }) : null,
            ],
        });
    if (t.isMultiUserDM())
        if (t.isManaged())
            return (0, r.jsxs)(iM.Ay, {
                channelId: t.id,
                children: [
                    (0, r.jsx)(iM.cr, { children: eR.intl.format(eR.t.I3R7Vn, { channelName: l }) }),
                    (0, r.jsx)(iM.j1, { children: eR.intl.string(eR.t.M8Ao6I) }),
                ],
            });
        else if (t.hasFlag(ai.lx.IS_JOIN_REQUEST_INTERVIEW_CHANNEL)) return (0, r.jsx)(iW, { channel: t });
        else return (0, r.jsx)(i5, { channel: t, children: eR.intl.format(eR.t.MFwcqO, { name: l }) });
    return c
        ? (0, r.jsx)(aa, { channel: t, canManageRoles: o })
        : (0, r.jsx)(iM.Ay, {
              channelId: t.id,
              children: (0, r.jsx)(iM.j1, { children: eR.intl.format(eR.t.hPVEQG, { channelName: l }) }),
          });
}
var ao = n(506774),
    ac = n(933832),
...
function aj(e) {
    let { threadId: t } = e,
        n = (0, af.bG)([eZ.A], () => eZ.A.getChannel(t)),
        l = (0, af.bG)([eZ.A], () => eZ.A.getChannel(n?.parent_id)),
        i = o.useCallback(() => {
            null != n &&
                null != l &&
                ((0, it.zV)(ec.HAw.MEDIA_POST_SHARE_PROMPT_CLICKED, { media_post_id: n.id }),
                (0, td.C)((0, aE.af)(n, l)));
        }, [n, l]);
    return (0, r.jsxs)("div", {
        className: aI.BQ,
        children: [
            ...
            (0, r.jsxs)("div", {
                ...
                children: [
                    ...
                    (0, r.jsx)(aC.h, { size: 4 }),
                    (0, r.jsx)(ev.$, { text: eR.intl.string(eR.t.C5UQC9), variant: "primary", icon: tU.q, onClick: i }),
                ],
            }),
            (0, r.jsx)(eC.D, {
                className: aI.b,
...
let aM = () =>
    ...
    aR = o.memo(function (e) {
        let { channel: t, isLastItem: n } = e,
            l = (0, m.bG)([b.Ay], () => b.Ay.useReducedMotion),
            i = (0, m.bG)([tc.A], () => tc.A.can(ec.xBc.SEND_MESSAGES_IN_THREADS, t)),
            s = (0, ti.s5)(t),
        ...
        return n
            ? i && !s && t.ownerId !== a
                ? (0, r.jsxs)("div", {
                      className: av.aP,
                      children: [
                          (0, r.jsx)(aN.a, { importData: aM, shouldAnimate: !l, className: av.lY }),
                          (0, r.jsxs)("div", {
                              className: av.FS,
                              children: [
                                  (0, r.jsx)(eI.D, {
...
function aX(e) {
    let { channel: t, message: l, snapshot: i } = e,
        ...
        c = (0, m.bG)([l$.default], () => (null != a ? l$.default.getUser(a) : null)),
        d = (0, m.bG)([nn.A], () => nn.A.getGuild(t.guild_id));
    (0, aO.ml)(l);
    let u = (function (e) {
            let { channel: t, user: l, guild: i } = e,
                s = (0, m.bG)([aV.A], () => null != l && aV.A.isUserBanned(l.id)),
                a = null != l && null == s,
                [c, d] = o.useState(a),
                u = (0, m.bG)([tc.A], () => null != l && null != i && (0, aB.fJ)(l, i, [tc.A]));
            if (
                ((0, aH.Ay)(() => {
                    a && aF.A.searchGuildBans(t.guild_id, void 0, [l?.id]).finally(() => d(!1));
                }),
                !u)
            )
                return null;
            let h = !0 === s ? eR.intl.string(az.default.dpfwQ1) : eR.intl.string(az.default.ASv23S),
                g = `ban-user-${l?.id}`;
            return (0, r.jsx)(
                aK,
                {
                    ...
                    onClick: () => {
                        null != l &&
                            (0, is.openModalLazy)(async () => {
                                let { default: e } = await Promise.all([n.e("38135"), n.e("2504")]).then(
                                    n.bind(n, 333179),
                                );
        ...
        h = (function (e) {
            let { channel: t, user: l, guild: i } = e,
                s = (0, m.bG)([tc.A], () => null != l && null != i && (0, aB.KX)(l, i, [tc.A])),
                a = (0, m.bG)([s_.Ay], () => null == l || null == s_.Ay.getMember(t.guild_id, l.id));
            if (!s) return null;
            let o = a ? eR.intl.string(az.default.Ux67nW) : eR.intl.string(az.default["snp/lJ"]),
                c = `kick-user-${l?.id}`;
            return (0, r.jsx)(
                aK,
                {
                    ...
                    onClick: () => {
                        null != l &&
                            (0, is.openModalLazy)(async () => {
                                let { default: e } = await Promise.all([n.e("91740"), n.e("40243")]).then(
                                    n.bind(n, 547166),
                                );
                                return (n) => (0, r.jsx)(e, { ...n, guildId: t.guild_id, user: l, modReportId: t.id });
                            });
        ...
        g = [
            (function (e) {
                let { message: t, user: n, guild: l, channel: i } = e,
                    s = (0, m.bG)([tc.A], () => null != n && null != l && (0, aB.Kd)(n, l, [tc.A])),
                ...
                if (!s) return null;
                let u = null == o ? eR.intl.string(az.default["0IZbwC"]) : eR.intl.string(az.default.Uj6oD4),
                    h = null == o,
                ...
                return (0, r.jsx)(
                    aK,
                    {
                        ...
                        onClick: () => {
                            null != c &&
                                null != o &&
                                aW.A.confirmDelete(c, o, !1, { isFlagResolved: d, moderatorReportChannelId: i.id });
                        },
                        disabled: h,
                        color: aU.$n.Colors.RED,
                    },
            ...
            (function (e) {
                let { channel: t, user: n, guild: l } = e,
                    i = (0, m.bG)(
                        [l$.default, nn.A, tc.A],
                        () => null != n && null != l && (0, aZ.b)(l.id, n.id, [l$.default, nn.A, tc.A]),
                    ),
                    [s, a] = (0, aY.Ay)(n?.id, t.guild_id),
                    o = (0, m.bG)([s_.Ay], () => null != l && null != n && null != s_.Ay.getMember(l.id, n.id));
                if (!i || !o) return null;
                let c = `timeout-user-${n?.id}`;
                return (0, r.jsx)(
                    aK,
                    {
                        text: a ? eR.intl.string(az.default["6uMZbv"]) : eR.intl.string(az.default["Sgg/uI"]),
                        icon: a$.O,
                        onClick: () => {
                            null != n && (0, aJ.R)({ guildId: t.guild_id, userId: n.id, modReportId: t.id });
                        },
                        disabled: a,
                    },
                    c,
...
function aQ(e) {
    ...
    return (0, r.jsx)(r.Fragment, {
        children: t.messageSnapshots.map((e, l) => (0, r.jsx)(aX, { channel: n, message: t, snapshot: e }, l)),
    });
}
var a0 = n(152007),
    a1 = n(867455),
...
function a6(e) {
    ...
    return i
        ? (0, r.jsx)(ev.$, {
              size: "sm",
              variant: "secondary",
              text: l ? eR.intl.string(az.default["2Y4vkk"]) : eR.intl.string(az.default.YIbR4r),
              onClick: () => {
                  !0 === ao.w.get(aG.f)
                      ? c()
                      : (0, is.openModalLazy)(async () => {
...
function a9(e) {
    let {
        ...
        { ref: h, width: g } = (0, ag.Ay)(),
        [p, A] = o.useState(3),
        [f, C] = o.useState(!n),
        [E, x] = (0, ap.A)(!1, 2e3),
        S = (0, m.bG)([eZ.A], () => eZ.A.getChannel(t), [t]),
        { firstMessage: _ } = (0, a3.OA)(S),
        j = (0, m.bG)([a0.A], () => a0.A.hasJoined(t)),
        { disableReactionUpdates: y, disableReactionCreates: b, isLurking: T, isPendingMember: N } = (0, ab.A)(S),
        v = (0, aO.W1)(S),
        M = (0, m.bG)([eZ.A], () => eZ.A.getChannel(i)),
        R = (0, a2.Ck)(M),
        D = (0, m.bG)([aA.A], () => aA.A.shouldDisplayPrompt(t) && !0 === n, [t, n]),
        L = o.useCallback(
            (e) => {
                let t = e[0];
                if (null != t && n) {
    ...
    let P = null != _ && _.reactions.length > 0,
        k = () => {
            (0, a4.jC)({ postId: S.id, location: { section: ec.JJy.CHANNEL_HEADER } }),
                (0, td.C)((0, aE.af)(S, M), () => x(!0));
        },
        O = j ? ac.A : ad.X;
    return (0, r.jsxs)(r.Fragment, {
        children: [
            (0, r.jsxs)("div", {
                className: d()(u, a7.kL, { [a7.wx]: f }),
                ref: h,
                children: [
                    v
                        ? (0, r.jsx)("div", {
                              className: a7.kX,
                              children: null != _ && (0, r.jsx)(aQ, { message: _, channel: S }),
                          })
                        : (0, r.jsx)("div", {
                              className: a7.hY,
                              children:
                                      ...
                                      children: [
                                          ...
                                          !b &&
                                              (0, r.jsx)(aT.t, {
                                                  ...
                                                  channel: S,
                                                  useChatFontScaling: !1,
                                                  className: d()(a8.secondary, a7.vU, a5.visible, { [a7.w$]: !P }),
                                                  isForumToolbar: !0,
                                ...
                                : !T &&
                                  ...
                                  (0, r.jsx)(ep.m, {
                                      ...
                                      children: (0, r.jsx)(ev.$, {
                                          ...
                                          onClick: () => {
                                              j
                                                  ? a1.A.leaveThread(S, "Forum Toolbar")
                                                  : a1.A.joinThread(S, "Forum Toolbar");
                                          },
                                      }),
                                  }),
                            (0, r.jsx)(ep.m, {
            ...
            D && (0, r.jsx)(aj, { threadId: t }),
            !s && (0, r.jsx)(aR, { channel: S, isLastItem: l }),
        ],
    });
}
var re = n(364522),
...
function rh(e) {
    let { channel: t, className: n } = e,
        l = (0, ti._M)(t),
        i = (0, m.bG)([rr.A], () => rr.A.isInChannel(t.id)),
        s = (0, m.bG)([ro.Ay], () => ro.Ay.getVoiceStatesForChannel(t), [t]),
        { needSubscriptionToAccess: a } = (0, rs.A)(t.id),
        c = (0, m.bG)([ra.A], () => (ra.A.getChannelId() === t.id ? ra.A.getState() : ec.S7L.RTC_DISCONNECTED), [t.id]),
        u = o.useCallback(() => {
            ri.A.handleVoiceConnect({ channel: t, connected: i, needSubscriptionToAccess: a, locked: !1 });
        }, [t, i, a]),
        h = o.useMemo(() => s.map((e) => e.user.id), [s]),
        g = (0, a2.$I)(t, h),
        p = g.length > 0;
    if (!l && !p) return null;
    let { connectionStatusText: A } = rc.A.getStatus(c, !1);
    return (0, r.jsxs)("div", {
        className: d()(ru.Lz, n),
        children: [
            (0, r.jsxs)(eC.D, {
                ...
                children: [
                    ...
                    (0, r.jsx)(e_.E, {
                        ...
                        color: "text-strong",
                        className: ru.Gp,
                        children: c === ec.S7L.RTC_DISCONNECTED ? eR.intl.string(rd.default.ficpp7) : A,
                    }),
                ],
            }),
            p
...
function rg(e) {
    ...
    return (
        (0, rt.Eq)(c, "GameInviteChannelFirstMessage"),
        (0, r.jsxs)("div", {
            className: rm.TX,
            children: [
                (0, r.jsxs)(re.Ar, {
                    children: [
                        ...
                        s.length > 0 &&
                            (0, r.jsx)("div", {
                                className: rm.GA,
                                children: s.map((e) => (0, r.jsx)(iP.A, { tag: e, size: iP.A.Sizes.MEDIUM }, e.id)),
                            }),
                        (0, r.jsx)("div", { className: rm.b1 }),
                        (0, r.jsx)(a9, {
                            className: rm.Jr,
                        ...
                        a &&
                            (0, r.jsxs)(r.Fragment, {
                                children: [
                                    (0, r.jsx)("div", { className: rm.b1 }),
                                    (0, r.jsx)(rh, { className: rm.Lz, channel: l }),
                                ],
                            }),
                    ],
                }),
                (0, r.jsx)("div", { className: rm.ld }),
            ],
        })
    );
}
...
function rE(e) {
    ...
    o.useEffect(() => {
        (0, im.QF)({ ...c, viewName: im.gN.SAFETY_WARNING_BANNER }), ir.A.increment({ name: ii.K.SAFETY_WARNING_VIEW });
    }, [c]);
    let d = o.useCallback(
            (e) => {
                (0, im._$)({ ...c, cta: e });
    ...
    let { senderId: t, channelId: n, warningId: l } = e,
        ...
        s = o.useCallback(() => {
            (0, im._$)({
                ...
                sX.A.ignoreUser(t, "web_stranger_danger_more", n);
        }, [n, l, t]),
        a = o.useCallback(() => {
            (0, im._$)({
                channelId: n,
                ...
                sX.A.unignoreUser(t, "web_stranger_danger_more", n);
        }, [n, l, t]);
    return (0, r.jsx)(id.PQ, {
...
function r_(e) {
    let { channelId: t, warningId: l, senderId: i } = e,
        ...
        d = o.useCallback(
            (e) => () => {
                sX.A.blockUser(i, { location: rC.Rx }).then(() => {
                    a();
                }),
                    (0, im._$)({ channelId: t, warningId: l, senderId: i, warningType: ih._j.STRANGER_DANGER, cta: e });
            },
            [a, t, l, i],
        );
    o.useEffect(() => {
    ...
    let u = () => {
                ...
                return (n) => {
                    ...
                    return (0, r.jsx)(e, {
                        ...
                        safetyTipRows: c.map((e, t) =>
                            (0, r.jsx)(ic.B, { index: t, listType: "numbered", title: e }, t),
                        ),
                        actionRows: (0, r.jsxs)(r.Fragment, {
                            children: [
                                (0, r.jsx)(rS, { senderId: i, channelId: t, warningId: l }, "more-tips-button"),
                                (0, r.jsx)(
                                    id.PQ,
                                    {
                                        ...
                                        onButtonPress: () => {
                                            a(), h(im.Wm.USER_MODAL_BLOCK_CONFIRM, im.Wm.USER_MODAL_BLOCK_CANCEL, u);
                                        },
                                    },
                                    "block-button",
                                ),
        ...
        h = (e, s, a) => {
            (0, is.openModalLazy)(async () => {
                let { default: o } = await Promise.all([n.e("51138"), n.e("14788"), n.e("67554")]).then(
                    n.bind(n, 219801),
                );
                return (n) =>
                    (0, r.jsx)(o, {
                ...
                : [
                      {
                          ...
                          variant: "critical-primary",
                          onClick: () => h(im.Wm.USER_BANNER_BLOCK_CONFIRM, im.Wm.USER_BANNER_BLOCK_CANCEL),
                      },
                  ]),
        ],
    });
...
function rv(e) {
    let { summary: t, channel: n } = e,
        l = (0, af.bG)([lV.A], () => lV.A.summaryFeedback(t)),
        i = (e, l) => {
                ...
                ? (0, r.jsx)("div", {
                      ...
                      children: (0, r.jsxs)(u.animated.div, {
                          ...
                          children: [
                              ...
                              (0, r.jsx)(eC.D, {
                                  onClick: (e) => i(e, rT.P0.GOOD),
                                  children: (0, r.jsx)(ry.A, { className: rN.O1, width: 12, height: 12 }),
                              }),
                              (0, r.jsx)(eC.D, {
                                  onClick: (e) => i(e, rT.P0.BAD),
                                  children: (0, r.jsx)(rj.A, { className: rN.O1, width: 12, height: 12 }),
                              }),
                          ],
                      }),
                  })
...
function rM(e) {
    let t,
        ...
        s = (0, af.bG)([lV.A], () => lV.A.selectedSummary(l.id));
    ...
    return (
        (t = o
            ? (0, r.jsxs)(r.Fragment, {
                  children: [(0, r.jsx)(rI.K, { size: "xs", color: "currentColor", className: rN.cR }), n.content],
              })
            : (0, r.jsxs)(r.Fragment, {
                  children: [
                      (0, r.jsx)(rv, { summary: s, channel: l }),
                      (0, r.jsx)(rI.K, { size: "xs", color: "currentColor", className: rN.Jq }),
                  ],
              })),
        (0, r.jsx)(
            nQ.A,
...
var rR = n(383233),
    ...
    rO = n(636922),
    rG = n(129765);
let rU = o.memo(function (e) {
    let { loading: t, onClick: n } = e,
        l = o.useCallback(() => {
            t || n();
        }, [t, n]);
    return (0, r.jsx)(eC.D, {
        className: d()(rG.XI, { [rG.Lq]: t }),
        onClick: l,
...
function rW(e) {
    let { channel: t } = e,
        [n, l] = o.useState("");
    o.useEffect(() => {
        (0, rH.zk)("847199849233514549", !0);
    }, []);
    let i = (0, m.bG)(
            [em.A, ea.default],
            () =>
                !!ll()(em.A.getMessages(t.id).toArray())
                    .reverse()
                    .find((e) => e.author.id !== ea.default.getId() && e.state === ec.cmJ.SENT && !(0, e1.A)(e)),
        ),
        s = (0, m.bG)([l$.default], () => l$.default.getUser(t.isPrivate() ? t.getRecipientId() : null)),
        a = iv.Ay.useName(s) ?? eR.intl.string(eR.t.y1Wu2f),
        c = (0, m.bG)([rB.A], () => rB.A.getStickerById(rz)),
        d = o.useCallback(async () => {
            if (null == n || "" === n)
                try {
                    (0, rF.W)({ channelId: t.id, source: "In-channel greet" }), await I.A.sendGreetMessage(t.id, rz);
                } catch (e) {
    ...
    return i
        ? (0, r.jsxs)("div", {
              ...
              children: [
                  (0, r.jsxs)(eC.D, {
                      className: null != n && "" !== n ? rK.AO : rK.Iq,
                      "aria-label": eR.intl.string(eR.t.pJObYI),
                      onClick: d,
                      children: [
                          (0, r.jsx)(rV.A, { sticker: c, size: 24 }),
                          (0, r.jsx)(e_.E, { className: rK.Qq, variant: "text-md/medium", children: u }),
                      ],
                  }),
                  h,
              ],
        ...
        : (0, r.jsxs)("div", {
              className: rK.nj,
              children: [
                  (0, r.jsx)(rV.A, { sticker: c, size: 160, className: rK.Xr }),
                  (0, r.jsx)(ev.$, {
                      fullWidth: !0,
                      variant: "primary",
                      size: "md",
    ...
    return (0, r.jsx)(rO.A, {
        ...
        message: new rR.Ay({
            ...
            customRenderedContent: {
                hasSpoilerEmbeds: !1,
                hasBailedAst: !1,
                content: (0, r.jsx)(iS.e, { channelId: n.id, file: t }),
            },
        }),
    });
});
var rX = n(1987);
let rQ = (0, u.animated)(S),
    r0 = o.memo(
        function (e) {
            var t;
            let n,
                ...
                [U, w] = o.useState(lz.A.isAtBottom(u.id) ?? !1),
                F = (0, P.Ay)(u),
                B = (0, lY.I)(f, N),
                ...
                $ = (function (e) {
                    ...
                    return (0, lJ.Vo)({ event: ec.jej.FOCUS_MESSAGES, handler: c }), r;
                })({ scrollerRef: W.ref, isEditing: null != S, keyboardModeEnabled: v, hasMoreAfter: g.hasMoreAfter }),
                J = (0, m.bG)([lH.A], () =>
                    tc.A.can(ec.xBc.READ_MESSAGE_HISTORY, u) ? null : lH.A.getViewingRolesTimestamp(u.getGuildId()),
                ),
                {
                    ...
                    let t,
                        ...
                        R = (0, j.cI)(s),
                        D = (0, m.bG)([lV.A], () => lV.A.shouldShowTopicsBar() && !x),
                        L = (0, rx.l)(s.id),
                        P = (0, rf.j)(s.id, rC.Rx),
                        k = (0, il.E)(s.id),
                        O = (0, rP.A)(),
                        ...
                        B = (0, aO.W1)(s);
                    (t = eJ.Sf.useSetting()),
                        (n = (0, af.bG)([b.Ay], () => b.Ay.useReducedMotion)),
                        o.useEffect(() => {
                            function e(e) {
                                ...
                                a ||
                                    ...
                                    !t ||
                                    n ||
                                    (0, t8.on)({ channelId: i, messageId: l, emoji: s, key: rq.W.EXTERNAL });
                            }
                            return (
                    ...
                    let V = null,
                        ...
                        z = h.map((e, t) => {
                                    ...
                                    : e.isConversationChannelHeader
                                      ...
                                      : e.isSummaryDivider
                                        ? (0, r.jsx)(rM, {
                                              ...
                                              item: e,
                                              channel: s,
                                              isBeforeGroup: null == e.content && rJ(h[t + 1]),
                                          })
                                        : (0, r.jsx)(
                                              nQ.A,
                                              {
                            ...
                            if (null != C && C > e.content.timestamp.getTime() * rL.A.Millis.SECOND) return;
                            ...
                            let n = e.groupId === V?.groupId ? V.content.id : e.groupId,
                                ...
                                i = e.type === ec.TZK.THREAD_STARTER_MESSAGE ? nW : n$;
                            return (0, r.jsx)(
                                i,
                                {
                                    compact: u && !l,
                    ...
                    if (
                        (null != y &&
                            g.forEach((e, t) => {
                                let n = 0 === t && (0, et.l)(s, W, new rR.Ay({ type: ec.lAJ.DEFAULT, author: y }));
                                K.push(
                                    (0, r.jsx)(
                                        rY,
                        ...
                        a.length > 0 &&
                            (a.length > 1 &&
                                ...
                                K.unshift(
                                    (0, r.jsx)(rU, { loading: a.loadingMore, onClick: () => p() }, "load-more-before"),
                                ),
                            K.unshift((0, r.jsx)("div", { style: { height: nz.N0, flex: "0 0 auto" } }, "buffer")));
                        let { useReducedMotion: e } = b.Ay;
                        ((e && N()) || !e) && K.unshift((0, r.jsx)(lQ, { compact: u, ...f }, "has-more"));
                    }
                    if (
                        ((a.hasMoreBefore && null == C) ||
                            _ ||
                            K.unshift((0, r.jsx)(ar, { channel: s, showingBanner: E }, "empty-message")),
                        a.hasMoreAfter && K.push((0, r.jsx)(lQ, { compact: u, ...f }, "has-more-after")),
                        !E && v && N() && K.push((0, r.jsx)(rW, { channel: s })),
                        c > 0 && d && N())
                    ) {
                        let e,
                            t,
                        ...
                        if (
                            ...
                            if (
                                ...
                                if (D) {
                                    ...
                                    l = (0, r.jsx)(rw.OZ, { scrollManager: A, content: e, channel: s });
                                } else {
                                    let e = (0, r.jsx)("div", {
                                    ...
                                    l = (0, r.jsx)(rw.GN, { content: e, channelId: s.id });
                                }
                            }
                        } else
                            O.includes(r$.i.NEW_MESSAGES) &&
                                (l = (0, r.jsx)(rw.GN, {
                    ...
                    if (
                        (null == l &&
                            (0, j.pk)(s) &&
                            D &&
                            O.includes(r$.i.SUMMARIES) &&
                            (l = (0, r.jsx)(rw.UK, { channel: s, scrollManager: A })),
                        a.error)
                    )
                        i = (0, r.jsx)(rw.Ez, {
                                ...
                                : null != e
                                  ...
                                  : (0, r.jsx)(rw.Ab, {
                                        onClick: () => {
                                            let e;
                                            return (
                                                I.A.jumpToPresent(s.id, (0, lY.h)("renderStream.jumpToPresent")),
                                                (e = rD.A.getChannelId()),
                                                void (s.id === e && (0, rA.iN)(s.id))
                                            );
                                        },
                                        className: S,
                                    });
            ...
            (t = W.ref),
                ...
                (0, lJ.Vo)({ event: ec.jej.SCROLLTO_PRESENT, handler: n }),
                (0, lJ.Vo)({ event: ec.jej.SCROLL_PAGE_UP, handler: l }),
                (0, lJ.Vo)({ event: ec.jej.SCROLL_PAGE_DOWN, handler: i });
            let es = (0, _.R7)(),
                { ref: ea, ...er } = (0, h.LT)($),
                eo = (0, y.A)((e) => {
                ...
                ed = (0, m.bG)([lK.A], () => {
                    let e = lK.A.settings.appearance?.clientThemeSettings;
                    return e?.backgroundGradientPresetId != null || e?.customUserThemeSettings != null;
                }),
                eu = (0, lF.Q)(),
                eh = ed || null != eu,
                em = o.useMemo(() => (O ? (U ? rX.gA : rX.ru) : rX.Zd), [O, U]),
                ep = o.useMemo(() => (O ? (U ? rX.cz : rX.XF) : rX.U6), [O, U]);
            return (0, r.jsxs)(h.hD, {
                ...
                children: [
                    ...
                    null != ei && ei,
                    (0, r.jsxs)("div", {
                        className: d()(rX.Og, s, `group-spacing-${a}`),
                        children: [
                            null == ei && Y,
                            (0, r.jsxs)(H, {
                                channel: u,
                                ...
                                children: [
                                    (0, r.jsxs)(rQ, {
                                        ref: eo,
                                        customTheme: !0,
                                        className: d()(c, rX.XG, eh ? ep : void 0),
                                        contentClassName: rX.gT,
                                            ...
                                            (0, r.jsxs)("ol", {
                                                ...
                                                children: [
                                                    ...
                                                    (0, r.jsx)("div", {
                                                        className: d()({
                                                            [rX.lB]: !R,
                                                            [rX.Ie]: 0 === g.length && !g.loadingMore,
                                                            [rX.Fb]:
                                                                1 === g.length &&
                                                                !g.loadingMore &&
                                                                u.isForumPost() &&
                                    ...
                                    X,
                                    q && (0, r.jsx)(lG, { channel: u, scrollManager: W }),
                                ],
                            }),
                        ],
                    }),
    ...
    r1 = o.memo(function (e) {
        let {
            ...
            } = e,
            {
                ...
                let t = e.getGuildId(),
                    n = (0, m.bG)([to.A], () => null == t || to.A.canChatInGuild(t), [t]),
                    { canManageMessages: l, permissionVersion: i } = (0, m.cf)(
                        [tc.A],
                        () => ({
                            canManageMessages: tc.A.can(ec.xBc.MANAGE_MESSAGES, e),
                            permissionVersion: null != t ? tc.A.getGuildVersion(t) : null,
                        }),
                        [e, t],
                    );
            ...
            })(),
            {
                ...
                let n,
                    ...
                    i = (0, m.bG)([lW.Ay], () => lW.Ay.getOldestUnreadMessageId(e.id) ?? null, [e.id]),
                    { enabled: s } = X.A.useExperiment({ location: "41de6d_1" }, { autoTrackExposure: !1 }),
                    a = l$.default.getUser(ea.default.getId())?.hasFlag(ec.nhx.SPAMMER) ?? !1,
                    r = (0, j.cI)(e),
                    c = (0, lU.A)("use_topic_dividers_in_chat"),
                    d = (0, m.yK)([lV.A], () => (r && c ? (lV.A.summaries(e.id) ?? []) : []), [r, e.id, c]),
                    u = (0, m.bG)([lV.A], () => (r ? lV.A.selectedSummary(e.id) : null), [r, e.id]),
                                    ...
                                    s.forEach((e) => {
                                        ...
                                        (null !== b &&
                                            ([j, I] =
                                                ((x = f = I),
                                                null == f || f.type !== b
                                                    ? ((E = { type: b, content: [], key: e.id }), m.push(E))
                                                    : (x = (E = f).content[E.content.length - 1]),
                                                [E, x])),
                                        a === e.id && null != p)
        ...
        return (0, r.jsx)(lB.Bs.Provider, {
            value: (0, lZ.A)(f, d),
            children: (0, r.jsx)(l0.t, {
                children: (0, r.jsx)(r0, {
                    ...c,
                    messageGroupSpacing: g,
                    ...
                    channelStream: x,
                    permissionVersion: u,
                    uploads: (0, m.bG)([lq.A], () => lq.A.getFiles(t.id), [t]),
                    unreadCount: (0, m.bG)([lW.Ay], () => lW.Ay.getUnreadCount(t.id), [t]),
                    hasUnreads: null != S,
                    canChat: h,
                    editingMessageId: _,
                    fontSize: p,
