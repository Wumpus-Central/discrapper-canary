...
function S() {
    ...
    let R = !0,
        D = !0;
    return (
        y && 1 === A.length && (A.includes(O.s6.PROFILE_SERVER_PROFILES) ? (P(C.NB.GUILD), (D = !1)) : A.includes(O.s6.PROFILE_USER_PROFILE) && (P(C.NB.USER_PROFILE), (R = !1))),
        (0, i.jsxs)(a.y5t, {
            ...
            children: [
                ...
                N === C.NB.GUILD ? (0, i.jsx)(u.Z, { selectedGuild: S }) : (0, i.jsx)(p.Z, {})
            ]
        })
    );
}
