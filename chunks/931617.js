...
function E(e, t) {
    ...
    if (__OVERLAY__ || null == p || null == E || !y) return null;
    let M = Z.Z.getHighestRole(E),
        x = Object.values(j).filter((e) => !(0, s.pM)(E.id, e.id)),
        I =
            S && !N
                ? x.map((n) => {
                      let i = n.managed || !Z.Z.isRoleHigher(E, M, n),
                          r = -1 !== p.indexOf(n.id);
                      return i && !r
                          ? null
                          : (0, l.jsx)(
