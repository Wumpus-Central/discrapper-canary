...
let D = r.memo(function (e) {
    ...
    let { message: r, compact: l = !1, className: D, onContextMenu: v, onClick: M, hideSimpleEmbedContent: k = !0, channel: U, isGroupStart: L, animateAvatar: j, subscribeToComponentDispatch: x, renderThreadAccessory: Z, trackAnnouncementViews: F = !1 } = e,
        ...
        G = r.isFirstMessageInForumPost(U),
        ...
        K = (0, s.JA)(r.id),
        q = (0, p.ZP)(r),
        X = (0, a.e7)([h.Z], () => r.hasFlag(A.iLy.HAS_THREAD) && h.Z.getChannel(_.default.castMessageIdAsChannelId(r.id))),
        J = (0, c.p9)({
            guildId: U.guild_id,
            roleId: q.iconRoleId
        }),
        ...
        b(
            {
                ...
                childrenSystemMessage: (0, m.Z)(P(b({}, e), { disableInteraction: V })),
                onContextMenu: v,
                onClick: M,
