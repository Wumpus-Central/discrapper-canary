...
function lG(e) {
    let { userId: l, guildId: n, disabled: i } = e,
        ...
        h = (0, J.Ac)(d, c)
            ? {
                  onClick: () => (0, lD.rM)(null, c, (e) => (0, lP.p)({ guildId: n ?? void 0, banner: e })),
                  type: p ? "reset" : "remove",
        ...
        A = (0, t.jsx)(lw, { displayProfile: o, pendingBanner: f && a && !x ? void 0 : d });
    return m
        ? (0, t.jsx)(lk.kL, {
              variant: "square",
              onClick: v,
...
function lW(e) {
    let { user: l, guildId: n, disabled: r } = e,
        ...
        v = null === p || (!h && null == x),
        A = o && null != f,
        b = (0, J.lw)({ pendingValue: p, userValue: f, guildValue: m, guildId: n ?? void 0 }),
        ...
        P = (0, t.jsx)("div", {
            ...
            children:
                null != b
                    ...
                    : (0, t.jsx)(eE.E, { variant: lz, className: lV.W, children: N }),
        });
    return v
        ? (0, t.jsx)(lk.kL, {
              variant: "bar",
...
function l3(e) {
    let { user: l, guildId: n, disabled: r = !1 } = e,
        ...
        f = (0, lC.r)(ld.A.unsafe_rawColors.PRIMARY_530).hex(),
        m = null != u ? u : l.getAvatarURL(n ?? void 0, 80),
        p = (0, lE.rh)(m, f, !1),
        x = i.useCallback(
            (e) => {
...
function nc(e) {
    ...
    return (0, t.jsxs)("div", {
        ...
        children: [
            ...
            m({ buttonRef: P, selectButtonProps: K }),
            !u &&
                p &&
                (0, t.jsx)("div", {
                    ref: I,
...
function nx(e) {
            ...
            let e = {
                ...
                l = o
                    .map((e) => {
                        ...
                        return null == l
                            ? null
                            : { id: l.id, label: l.name, value: l.id, leading: (0, t.jsx)(nm, { guild: l }) };
                    })
                    .filter(X.Vq),
                i = null != n ? d[n] : null;
            return null == i
                ? [e, ...l]
                : [e, { id: i.id, label: i.name, value: i.id, leading: (0, t.jsx)(nm, { guild: i }) }, ...l];
        }, [o, d, n]),
        c = l ?? nf,
    ...
    return (0, t.jsx)(nc, {
        ...
        onSelectionChange: f,
        loading: a,
        children: (e) => (0, t.jsx)(np, { leading: g.value === nf ? null : g.leading, label: g.label, ...e }),
    });
}
var nh = n(809467);
...
function nE(e) {
    ...
    return null == g
        ...
        : (0, t.jsxs)("aside", {
              ...
              "aria-busy": r,
              children: [
                  (0, t.jsx)(f.A, { children: (0, t.jsx)(m.H, { id: nA, children: eL.intl.string(eL.t["L+ch00"]) }) }),
                  (0, t.jsxs)("div", {
                      className: nh.wx,
                      children: [
...
function n6(e) {
    ...
    return (0, t.jsx)("div", {
        ref: m,
        className: a()(n2.kL, { [n2.oE]: "compact" === c }, f),
        onBlur: p,
        onKeyDown: x,
        children: (0, t.jsx)(
            "div",
...
function te(e) {
    let l,
        ...
        x = m?.guildId != null,
        h = m?.guildId ?? void 0,
        v = lA.Ay.canUsePremiumProfileCustomization(f),
        {
            value: A,
            previewValue: b,
            onCommit: I,
        ...
        (a = (0, s.bG)([lB.Ay], () => (null != l ? (lB.Ay.getMember(l, f.id)?.nick ?? null) : null))),
        ...
        (g = void 0 !== o ? o : r),
        {
            ...
            onCommit: i.useCallback(
                (e) => {
                    n
                        ? (0, lP.p)({ nickname: e.trim(), guildId: m?.guildId ?? void 0 })
        ...
        R = x ? (f.globalName ?? f.username) : f.username,
        ...
        S = i.useCallback(
            (e) => {
                e.stopPropagation(),
                    C && E(),
                    (0, lF.L)({ analyticsLocations: p, guildId: h, stackingBehavior: "stack", returnRef: D });
            },
            [C, E, p, h],
        ),
        T = {
...
function tn(e) {
    let l,
        ...
        { previewProps: m, inputProps: p, isEditing: x } = n8(c, f),
        h = null != g && g.length > 0;
    return (0, t.jsx)(n6, {
        ...m,
        variant: "compact",
...
var tr = n(97808),
    ...
    tg = n(106106),
    tf = n(338165);
let tm = tc.Ay.getEnableHardwareAcceleration() ? tr.Js : tr.eu;
function tp(e) {
...
function tx(e) {
    let { user: l, guildId: n } = e,
        ...
        f = (function (e) {
            let { user: l, guildId: n, onClose: r } = e,
                ...
                k = i.useCallback(() => {
                    r(),
                        (0, lD.rM)(null, g, (e) => (0, lP.p)({ guildId: n ?? void 0, avatar: e })),
                        (0, J.WU)(m ? "reset" : "remove");
                }, [r, n, g, m]),
                R = i.useCallback(() => {
    ...
    return 0 === f.length
        ...
        : (0, t.jsxs)("div", {
              ...o,
              className: a()(tg.my, tg.vk, tf.kL, { [tf.MO]: d }),
              onMouseDown: (e) => {
                  c.current?.contains(e.target) || u(!0);
              },
              children: [
                  (0, t.jsx)(tm, { ...r, imageClassName: a()(tg.Lw, tf.HU) }),
                  (0, t.jsx)(lN.Y, {
                      targetElementRef: c,
                      shouldShow: d,
                      ...
                      align: "top",
                      onRequestClose: g,
                      renderPopout: (e) => (0, t.jsx)(tp, { ...e, items: f, onMenuClose: g }),
                      children: (e) =>
                          (0, t.jsx)("div", {
                              ref: c,
                              className: tf.r9,
    ...
    let { user: l, guildId: n } = e,
        ...
        c = (function (e) {
            let { user: l, guildId: n, onClose: r } = e,
                ...
                c = u || null == n,
                g = null != n,
                { pendingBanner: f, pendingProfileEffect: m } = (0, s.bG)([Q.A], () =>
                ...
                y = i.useCallback(() => {
                    r(), (0, lD.rM)(null, p, (e) => (0, lP.p)({ guildId: n ?? void 0, banner: e }));
                }, [r, n, p]),
                E = i.useCallback(() => {
    ...
    let F = null != G ? tO[G] : void 0,
        ...
        { appIdentities: el, connections: en } = (function (e) {
            let { filteredAppIdentities: l } = (0, q.A)(e),
                ...
                r = i.useMemo(() => new Set(t.enabled ? (l?.map((e) => e.application_id) ?? []) : []), [l, t.enabled]),
            ...
            (0, t.jsxs)(u.Ip, {
                ...
                children: [
                    ...
                    g?.private &&
                        (0, t.jsx)(eb.A.Overlay, {
                            className: tP.profileOverlay,
                            children: (0, t.jsx)(eA.A, { username: f }),
                        }),
                    (0, t.jsx)("div", {
                    ...
                    Z.length > 0 &&
                        (0, t.jsx)(nR.A, {
                            ...
                            children: (0, t.jsx)(em.A, { applicationIds: Z }),
                        }),
                    (0, t.jsx)(nR.A, {
...
function tw(e) {
    ...
    let q = (0, U.X)("UserProfileModalV2"),
        ...
        })({ user: l, allowEditingInModal: X, guildId: V }),
        {
            ...
            handleExpand: eg,
            handleCollapse: ef,
            refs: { expandIconButtonRef: em, expandTabButtonRef: ep, collapseButtonRef: ex },
        } = (function () {
    ...
    let eI = (0, es.fC)(),
        ...
        eN = (function (e) {
            let l,
                ...
                A = c.length > 0;
            (m || A) && f.push({ text: eL.intl.string(eL.t.laViwx), section: eK.RP.WIDGETS }),
                f.push({ text: eL.intl.string(eL.t.chq59f), section: eK.RP.ACTIVITY });
            let j = !1 === i.nsfwAllowed,
                b = T.A.isFriend(i.id),
                I = h?.visibility === tj.a.PUBLIC;
            return (
                (m || (!m && v && I && g && (!j || (j && b)))) &&
                    f.push({ text: eL.intl.string(eL.t["7lZ31J"]), section: eK.RP.WISHLIST }),
                i.id !== r?.id &&
                    u &&
                    (f.push({ text: (0, ty.A)(a), section: eK.RP.MUTUAL_FRIENDS }),
                    f.push({ text: (0, tE.A)(d), section: eK.RP.MUTUAL_GUILDS })),
                f
            );
                                        ...
                                        (0, t.jsxs)(tL, {
                                            ...
                                            children: [
                                                (0, t.jsxs)("div", {
                                                    className: tk.Oo,
                                                    children: [
                                                        (0, t.jsx)(e8.A, { isCurrentUser: B, onClose: D }),
                                                        (0, t.jsx)(f.A, {
                                                            children: (0, t.jsx)(m.H, { id: eD, children: eS }),
                                                        }),
                                                        eA &&
                                                            (0, t.jsx)(nb, {
                                                                buttonRef: em,
                                        ...
                                        (0, t.jsxs)(m.F, {
                                            children: [
                                                ...
                                                (0, t.jsxs)(eb.A, {
                                                    ...
                                                    children: [
                                                        (0, t.jsx)(tS, { displayProfile: eP, pendingBanner: er }),
