...
var i = a(627968),
    ...
    r = a.n(l);
function n(e) {
    let { alt: t, ariaLabel: a, ariaHidden: s, role: l, width: r = 288, height: n = 162 } = e;
    return (0, i.jsx)("img", {
...
let R = s.forwardRef((e, t) => {
    ...
    let m,
        {
            ...
            original: _,
            children: H = (e) => {
                let { src: t, size: a, alt: s, className: l, mediaLayoutType: r } = e;
                return (0, i.jsx)("img", {
                    className: l ?? void 0,
    ...
    "" !== j && y !== f.Rv1.ERROR
        ...
        : y !== f.Rv1.LOADING && (m = (0, i.jsx)(N, { size: K, mediaLayoutType: G, alt: E })),
        (m = (0, i.jsx)(x.y, {
            disableSpinner: F,
            readyState: y,
            aspectRatio: q,
    ...
    return (
        ...
        (0, i.jsx)(d.vN, {
            ...
            children: (0, i.jsxs)("div", {
                ref: t,
                className: r()("imageWrapper", v.h4, { [v.j3]: P, [v.LF]: y !== f.Rv1.READY, [v.vk]: null != $ }, R),
                style:
                    ((a = K),
                    (l = O),
                    (n = Y),
...
function N(e) {
    ...
    return (0, i.jsxs)("div", {
        ...
        children: [
            (0, i.jsx)("div", {
                className: v.QM,
                children: (0, i.jsx)(n, { alt: s ?? p.intl.string(p.t.X4IxWL), height: "auto" }),
            }),
            (0, i.jsx)(h.E, {
                className: v.b4,
