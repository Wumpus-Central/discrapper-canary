...
let A = r.forwardRef((e, t) => {
    ...
    let X = (0, _.Uj)({ width: O, height: b, maxWidth: D, maxHeight: L, minWidth: w, minHeight: M }),
        Z = 0 !== X.width ? X.width / X.height : 1;
    "" !== N && y !== p.Rv1.ERROR
        ? (h = F({ src: N, size: X, alt: R, className: S, mediaLayoutType: P }))
        : y !== p.Rv1.LOADING && (h = (0, i.jsx)(I, { size: X, mediaLayoutType: P, alt: R })),
        (h = (0, i.jsx)(f.y, {
            disableSpinner: K,
            readyState: y,
            aspectRatio: Z,
