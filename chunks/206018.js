...
function y(e) {
    ...
    let j = (0, _.A)(t),
        ...
        $ = Z === C.TBI.VOICE_ACTIVITY ? C.TBI.PUSH_TO_TALK : C.TBI.VOICE_ACTIVITY,
        K = (0, s.bG)([I.Ay, S.Ay], () => {
            let e = I.Ay.getModeOptions().shortcut?.length > 0,
                t = null != S.Ay.getKeybindForAction(C.hCu.PUSH_TO_TALK, !1, !0),
                n = null != S.Ay.getKeybindForAction(C.hCu.PUSH_TO_TALK_PRIORITY, !1, !0);
            return e || t || n;
        }),
    ...
    return (0, i.jsx)(d.A, {
        ...
        children: (0, i.jsxs)(a.W, {
            ...
            className: M.MK,
            children: [
                (0, i.jsxs)(o.rX, { children: [L && V, x && B, U && k] }),
                (0, i.jsxs)(o.rX, {
                    children: [
                        P && Y,
                        G &&
