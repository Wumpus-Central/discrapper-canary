...
function R(e) {
    ...
    let F = (0, T.A)(t),
        V = (0, h.H)({ deviceType: N.oh.AUDIO_INPUT, analyticsLocations: G, asSubmenu: !0 }),
        B = (0, h.H)({ deviceType: N.oh.AUDIO_OUTPUT, analyticsLocations: G, asSubmenu: !0 }),
        ...
        Z = (0, s.bG)([g.A], () => null != g.A.getChannelId());
    return (0, i.jsx)(c.A, {
