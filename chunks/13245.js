...
let y = new i.Yd('OverlayActionCreators'),
    O = {
        ...
        setPinChat(e) {
            ...
            if (((0, s.JS)(h.Odu.TEXT, { pinned: e }), 0 === n.length || null == i || null == a || null == o)) return;
            ...
            if (
                (n.forEach((e) => {
                    ...
                    switch (t) {
                        ...
                        case h.Odu.GUILDS_TEXT:
                            (y = (0, f.vS)(r, i, l)), (O = (0, f.w_)(i, l)), (0, p.E9)(n);
                    }
                }),
                e)
            ) {
                ...
                e -= i.minSize.width;
                let [n, a] = (0, f.o4)(y, b(g({}, O), { width: i.minSize.width }), l),
                    [s, u] = (0, f.uq)(y, b(g({}, O), { width: e }), l, {
                        x: 10,
                        y: 10
                    }),
                ...
                let e = 'auto' === u.width ? a.minSize.width : u.width;
                e += i.minSize.width;
                let [n, o] = (0, f.o4)(
                        m,
                        {
