...
function ri() {
    let e = (0, d.bG)([ne.A], () => ne.A.getGuildId()),
        ...
        n = (0, d.yK)([i8.A], () => (null != e ? (i8.A.getAppliedGuildBoostsForGuild(e) ?? []) : []));
    if (null != e)
                ...
                children: [
                    ...
                    (0, r.jsx)($.D, {
                        ...
                        onClick: (e) => {
                            let a, n, l;
                            e.stopPropagation(),
                                (a = new Blob([m8()(t.audioBuffer)], { type: "audio/wav" })),
                                (n = URL.createObjectURL(a)),
