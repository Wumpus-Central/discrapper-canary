e.exports = (function () {
    ...
    var q = o.unpack,
        ...
        Q = function () {
            ...
            var n = q(e, "rgba"),
                ...
                a = n[3],
                o = Z(e) || "auto";
            void 0 === a && (a = 1), "auto" === o && (o = a < 1 ? "rgba" : "rgb"), (i = X(i));
            var l = "000000" + ((i << 16) | ((r = X(r)) << 8) | (s = X(s))).toString(16);
            l = l.substr(l.length - 6);
            var u = "0" + X(255 * a).toString(16);
    ...
    (_.prototype.hsv = function () {
        ...
        l.autodetect.push({
            ...
            test: function () {
                for (var e = [], t = arguments.length; t--; ) e[t] = arguments[t];
                if ("array" === eC((e = ey(e, "hsv"))) && 3 === e.length) return "hsv";
            },
        });
    var ev = 18,
        eR = 0.95047,
        ...
        eH = function () {
            ...
            return (
                ...
                (n = isNaN(l) ? t : t - l / 200),
                (t = eO * ej(t)),
                (i = eB(3.2404542 * (e = eR * ej(e)) - 1.5371385 * t - 0.4985314 * (n = eb * ej(n)))),
                [
                    i,
    ...
    var tI = o.unpack,
        ...
        ty = function () {
            ...
            return [
                255 * tC(4.0767416621 * s - 3.3077115913 * a + 0.2309699292 * o),
                255 * tC(-1.2684380046 * s + 2.6097574011 * a - 0.3413193965 * o),
                255 * tC(-0.0041960863 * s - 0.7034186147 * a + 1.707614701 * o),
                e.length > 3 ? e[3] : 1,
            ];
        };
    function tC(e) {
    ...
    (_.prototype.oklab = function () {
        ...
        l.autodetect.push({
            ...
            test: function () {
                for (var e = [], t = arguments.length; t--; ) e[t] = arguments[t];
                if ("array" === tv((e = tN(e, "oklab"))) && 3 === e.length) return "oklab";
            },
        });
    var tR = o.unpack,
        tO = o.unpack,
    ...
    (_.prototype.alpha = function (e, t) {
        ...
        (_.prototype.darken = function (e) {
            void 0 === e && (e = 1);
            var t = this.lab();
            return (t[0] -= ev * e), new _(t, "lab").alpha(this.alpha(), !0);
        }),
    ...
    (_.prototype.mix = _.prototype.interpolate =
        ...
        (_.prototype.saturate = function (e) {
            void 0 === e && (e = 1);
            var t = this.lch();
            return (t[1] += ev * e), t[1] < 0 && (t[1] = 0), new _(t, "lch").alpha(this.alpha(), !0);
        }),
    ...
    (tU.lrgb = function (e, t, n) {
        var i = e._rgb,
            ...
            c = o[2];
        return new _(
            tB(tj(r, 2) * (1 - n) + tj(l, 2) * n),
            tB(tj(s, 2) * (1 - n) + tj(u, 2) * n),
            tB(tj(a, 2) * (1 - n) + tj(c, 2) * n),
            "rgb",
        );
    }),
            ...
            nc = function (e, t, n) {
                ...
                if (("c" === t.substr(0, 1) && (o.push(i), o.push(r)), "e" === t.substr(0, 1))) {
                    ...
                    for (S.push(r); I; ) {
                        ...
                        for (var N = 0; N < m; N++)
                            for (var v = a[N], R = Number.MAX_VALUE, O = void 0, b = 0; b < n; b++) {
                                var D = nl(S[b] - v);
                                D < R && ((R = D), (O = b)), A[O]++, (g[N] = O);
                            }
                    ...
                    for (var B = 1; B < F.length; B += 2) {
                        var j = F[B];
                        isNaN(j) || -1 !== o.indexOf(j) || o.push(j);
                    }
                }
                return o;
            },
    ...
    return (
                ...
                for (var s = 0; s < a.length; s++)
                    if (!isNaN(r[s]))
                        if (((o[s] += n[i + 1]), "h" === t.charAt(s))) {
                            var c = (r[s] / 180) * tz;
                            (l += tq(c) * n[i + 1]), (u += tZ(c) * n[i + 1]);
                        } else a[s] += r[s] * n[i + 1];
            });
            for (var f = 0; f < a.length; f++)
                if ("h" === t.charAt(f)) {
                    for (var p = (tX(u / o[f], l / o[f]) / tz) * 180; p < 0; ) p += 360;
                    for (; p >= 360; ) p -= 360;
                    a[f] = p;
                } else a[f] = a[f] / o[f];
        ...
        (h.deltaE = function (e, t, n, i, r) {
            ...
            var o = Array.from(e.lab()),
                ...
                v = C >= 0 ? C : C + 360,
                R = N >= 0 ? N : N + 360,
                O = nE(v - R) > 180 ? (v + R + 360) / 2 : (v + R) / 2,
                b = 1 - 0.17 * nm(a(O - 30)) + 0.24 * nm(a(2 * O)) + 0.32 * nm(a(3 * O + 6)) - 0.2 * nm(a(4 * O - 63)),
                D = R - v;
            (D = 180 >= nE(D) ? D : R <= v ? D + 360 : D - 360), (D = 2 * nd(T * S) * ng(a(D) / 2));
            var L = S - T,
