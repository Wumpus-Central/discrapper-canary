...
function I(e) {
    let { channel: t } = e,
        ...
        b = (0, a.e7)([p.Z], () => p.Z.getSelectedParticipant(t.id)),
        O = (null == b ? void 0 : b.type) === m.fO.STREAM,
        I = (0, a.e7)([f.Z], () => (O ? f.Z.getActiveStreamForStreamKey(b.id) : null)),
        { ignoreSenderPreference: T } = u.Z.useExperiment({ location: 'ActionBarClipsButton' }, { autoTrackExposure: !1 }),
        { viewerClippingAllowed: S, isAtMaxSavingClipOperations: A } = (0, a.cj)([l.Z], () => ({
        ...
        w = !N || !(C || S) || A || null == b,
        R = () => {
            w || ((0, h.v)(n, h.d.CLIP), C ? (0, c.C1)() : (0, c.C1)(b.id));
        },
        P = () => (null == I ? g.intl.string(g.t.eg5qtb) : C || S ? (N ? (A ? void 0 : g.intl.string(g.t.U4URzM)) : g.intl.string(g.t.wSS1yM)) : g.intl.string(g.t.aRifJS)),
        D = i.useCallback((e) => (0, r.jsx)(o.xmR, v(y({}, e), { color: 'currentColor' })), []);
    return (0, r.jsx)(d.Z, {
