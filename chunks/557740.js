...
class C extends r.Ay.DeviceSettingsStore {
    ...
    filterStaffContent() {
        return !0 === v.filterStaffContent;
    }
    getDoubleTapBehavior() {
        return v.doubleTapBehavior ?? N.Ai.DEFAULT;
    }
    getState() {
        return v;
    }
...
function ed(e) {
    ...
    if ((0, b.xj)(e)) {
        if (e.data.guild_id === N.VL) return !0;
...
function eh() {
    if (
        ((Q = Q.filter((e) => e.type !== N.Mm.RECOMMENDED_GUILDS)),
        (J = J.filter((e) => e.type !== N.Mm.RECOMMENDED_GUILDS)),
        0 === et.length)
    )
        return;
    ...
    let i = { id: e, type: N.Mm.RECOMMENDED_GUILDS, score: 50 };
...
function ef() {
    ...
    if (
        ...
        if (e.has(X.id)) {
            ...
            -1 !== n && ((X = U[n]), (U = U.filter((t) => t.id !== e)), (U = [X, ...U]));
        } else (U = [X, ...U]), e.add(X.id);
    U.forEach((e) => {
        (V[e.id] = e),
            e.type === N.Mm.CUSTOM_STATUS &&
...
function ep(e) {
    ...
    (function () {
            ...
            for (let n of e)
                if (!(0, c.AZ)(n)) {
                    ...
                    if (
                        ...
                        (null == B[n.id] && (B[n.id] = { id: n.id, type: N.Mm.GUILD_EVENT, score: 10, event_id: n.id }),
                        t.push({
                            id: n.id,
                            type: N.Mm.GUILD_EVENT,
                            score: 10,
        ...
        t.forEach((e) => {
            ...
            (Q = e_(Q, n, N.Mm.GUILD_EVENT, 7)),
            (J = e_(J, i, N.Mm.GUILD_EVENT, 7));
    })(),
        (t = new Set()),
        (n = {}),
        (r = []),
        ...
        u.forEach((e) => {
            ...
            null == B[e.content.id] &&
                (B[e.content.id] = { id: e.content.id, type: N.Mm.ACTIVITY, score: 15, activity: e.content });
            let a = {
                id: e.content.id,
                type: N.Mm.ACTIVITY,
                score: 15,
        ...
        (Q = e_(Q, r, N.Mm.ACTIVITY, 5)),
        (J = e_(J, s, N.Mm.ACTIVITY, 5)),
        eh(),
        null != F.load_id &&
            x !== F.load_id &&
            (y.k.trackFeedLoaded({
    ...
    return (
        e.forEach((e) => {
            ...
            e.type === N.Mm.MESSAGE &&
                ...
                r ? t.push(e) : e.type === N.Mm.MESSAGE && e.data.has_mention ? i.push(e) : n.push(e);
        }),
...
function em(e, t) {
    ...
    for (let r of e)
        !(r.type === N.Mm.RECOMMENDED_GUILDS || i.has(r.id)) &&
            null == O.A.getReadTimestamp(r.id) &&
            (r.type !== N.Mm.MESSAGE || ((0, b.$r)(r.data.channel_id, r.data.message_id) && r.data.channel_id !== t)) &&
            n.push(r);
    return n;
}
function eg(e, t) {
...
function eS(e) {
    let { type: t, messageId: n, userId: i, emoji: r, reactionType: s } = e,
        a = B[n];
    if (null == a || a.type !== N.Mm.MESSAGE) return !1;
...
function ey(e) {
    let { channelId: t } = e,
        ...
        i = [];
    Q.forEach((e, r) => {
        (r > ee || !z) && e.type === N.Mm.MESSAGE && e.data.channel_id === t ? n.push(e) : i.push(e);
    });
    let r = $,
        [s, a] = eE(U);
    if (((G = em(s, t)), ($ = z ? r && G.length >= N.$P : r && ec(i, U)), 0 === n.length && r === $)) return !1;
    0 !== n.length && ((Q = i), (J = [...J, ...n]));
}
class eN extends r.Ay.PersistedStore {
    ...
    getMessage(e) {
        let t = B[e];
        return null == t || t.type !== N.Mm.MESSAGE ? null : t.message;
    }
    getHydratedItems() {
        return B;
    }
    ...
    getIndexInHydratedFeed(e) {
        return "recommended_guilds" === e || "recommendedGuilds" === e
            ? [...Q, ...J].findIndex((e) => e.type === N.Mm.RECOMMENDED_GUILDS)
...
let ev = new eN(s.h, {
    ...
    LOAD_ICYMI_FROM_NOTIFICATION: function (e) {
        ...
        if (null != n) return (X = n), null != x && ((U = U.length > 0 ? U : [...P]), ef(), ep()), !0;
        if (null != t) {
            let e = {
                id: t.message.id,
                type: N.Mm.MESSAGE,
    ...
    LOAD_ICYMI_DEHYDRATED: function (e) {
        ...
        (t = new Set(N.H8)),
            (U = n
                ...
                .filter(ed)
                .map((e) => {
                    if (e.type === N.Mm.MESSAGE && null != e.data.message_context) {
                        let t = {};
        ...
        if (((G = em(o)), !z || 0 === W || s))
            ...
            W > 0 && (X = null);
            let e = G.length > N.$P;
            a || ($ = e), e && ((0, b.kx)([...o, ...l], 0, N.w5), o.length + l.length === 0 && (eo = !0));
        }
        y.k.trackFeedLoaded({
            newTrackingProps: F,
            hasNewContent: $,
    ...
    MESSAGE_REACTION_ADD_MANY: function (e) {
        let { messageId: t, reactions: n } = e,
            i = B[t];
        if (null == i || i.type !== N.Mm.MESSAGE) return !1;
    ...
    MESSAGE_REACTION_REMOVE_ALL: function (e) {
        let { messageId: t } = e,
            n = B[t];
        if (null == n || n.type !== N.Mm.MESSAGE) return !1;
