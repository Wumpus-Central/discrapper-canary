        ...
        Z = i.useCallback(
            (e, t) => {
                if ((null == _ || _(e, t), (0, y.Z)(e))) {
                    ...
                    c.Z.trackJump(e.channel_id, e.id, 'Search Results', { search_id: S.Z.getAnalyticsId(l) }), (0, x.uL)(w.Z5c.CHANNEL(n, e.channel_id, e.id));
                }
            },
            [_, l]
        ),
...
function B(e) {
    var t, n, l;
    let { channel: o, results: a, highlighter: c, startIndex: u, resultRefs: d, totalResults: p, scrollTo: y, searchId: x, renderEmbeds: j, offset: S, jumpToMessage: T, listNavigator: R, favoriteSearch: D } = e,
        B = v.cC.useSetting(),
        G = (0, g.p)(),
        F = i.useCallback((e) => {
