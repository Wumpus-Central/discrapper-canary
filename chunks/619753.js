...
function B(e) {
    var t, n, l;
    let { channel: a, results: o, highlighter: c, startIndex: u, resultRefs: d, totalResults: p, scrollTo: E, searchId: x, renderEmbeds: C, offset: T, jumpToMessage: A, listNavigator: w, favoriteSearch: L } = e,
        U = v.cC.useSetting(),
        B = (0, g.p)(),
        G = i.useCallback((e) => {
