...
let f = class {
    ...
    update(t) {
        0 !== this.points.length &&
            ...
            !this.hasEntered && this.points[0].x > c && ((this.hasEntered = !0), this.updateWaveState(l.hO.ENTERED)),
            this.isFilling &&
                this.points[0].x > this.points[0].targetX &&
                ((this.isFilling = !1), this.updateWaveState(l.hO.FILLED)));
    }
    render(t) {
    ...
    fill() {
        let t = Math.sqrt(window.innerWidth * window.innerWidth + window.innerHeight * window.innerHeight) + 100,
            e = p() - 140,
            i = (t, e, i, s) => {
                (t.targetX = -40 + e * Math.cos(l.uo * ((i / 15) * 0.25 + 0))),
                    (t.targetY = -40 + e * Math.sin(l.uo * ((i / 15) * 0.25 + 0))),
                    s &&
                        ((t.targetX += (0, o.M)(0, 30) - 15),
                        (t.targetY += (0, o.M)(0, 30) - 15),
                        (t.speedUp = 3),
                        (t.spring.tension = l.O1 * Math.random() * 0.5 + l.O1));
            };
            ...
            setTimeout(() => {
                this.points.forEach((e, s) => {
                    ...
                    (e.spring.friction += e.spring.friction + e.spring.friction * n),
                        (e.spring.tension = 0.7 * l.O1 + 80 * Math.random()),
        ...
        d(this, "points", []),
            ...
            d(this, "_resizeWave", () => {
                ...
                this.points.forEach((e, i) => {
                    ...
                    0 !== i ? (n += (0, o.M)(0, 30) - 15) : (s += (0, o.M)(0, 30) - 15),
                        (e.targetX = s),
                        (e.targetY = n),
