...
function K(e, t) {
    ...
    return (
        ...
        (j(H({ action: e, enabled: !0, shortcut: (0, m.OH)(t), managed: !0, params: {} })), !0)
    );
}
let $ = [
    function () {
    ...
    function () {
        return !!g.default.getAnyGlobalEnabledOverlay() && K(A.hCu.TOGGLE_OVERLAY_INPUT_LOCK, C());
    },
    function () {
...
let Z = new q(l.h, {
        ...
        KEYBINDS_ENABLE_ALL_KEYBINDS: function (e) {
            let { enable: t } = e;
            (w = t), t ? (u.A.enable(), a().forEach(D, j), F()) : (u.A.disable(), a().forEach(D, (e) => B(e.id)), V());
        },
