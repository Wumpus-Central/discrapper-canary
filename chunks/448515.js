...
function q(e, t, n) {
    ...
    (null != A &&
        ...
        A.flags === l &&
        (A.unusualDMActivityUntil ?? null) === (E ?? null) &&
...
function J(e, t) {
    let n = (0, E.A)(e.activities ?? [], e.hidden_activities ?? []);
    return {
        user: e.user,
        status: e.status,
...
W(
    ...
    Y(["READY_SUPPLEMENTAL"], (e) => {
        A.A.readySupplemental.measure(() => {
            s.Ay.Emitter.batched(() => {
                ...
                t.forEach((e) => {
                    e.presences = Z(e.presences || [], e.id);
                });
                let n = Z(e.presences ?? [], void 0),
    ...
    Y(["GUILD_MEMBERS_CHUNK"], (e) => {
        s.Ay.Emitter.batched(() => {
            B.add({ guildId: e.guild_id, members: e.members, notFound: e.not_found }),
                null != e.presences && Z(e.presences, e.guild_id).forEach(ee),
    ...
    Y(["PRESENCES_REPLACE"], (e) => {
        z({ type: "PRESENCES_REPLACE", presences: Z(e, void 0) });
    }),
    ...
    Y(["USER_PAYMENT_SOURCES_UPDATE"], () => {
        (C.A.hasLayers() || null != O.A.getSection()) && (n(323082).$o(), o.jv(D.A.getFetchedSKUIDs()));
    }),
    Y(["USER_SUBSCRIPTIONS_UPDATE"], () => {
        l.rQ(), (C.A.hasLayers() || null != O.A.getSection()) && n(323082).hP();
    }),
