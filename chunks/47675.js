...
let A = (e) => {
    ...
    I = (e) => {
        ...
        let n,
            ...
            h = c.default.getUser(s);
        if (null == h) return {};
        let f = (0, p.AP)(h?.id, _ ? a : void 0),
            E = _ && null != a ? o.Ay.getMember(a, h?.id) : null;
        return {
            profile_layout: r,
            profile_session_id: u,
            source_profile_session_id: d,
            profile_properties: A({ user: h, userProfile: f?._userProfile }),
            guild_profile_properties: A({ guildMember: E, guildMemberProfile: f?._guildMemberProfile }),
            profile_activity_types: l.A.getActivities(h.id)
                .map((e) => {
                    let { type: t } = e;
                    return t;
                })
    ...
    T = (e) => {
        ...
        return {
            ...
            num_mutual_friends: h.A.getMutualFriendsCount(t),
            num_mutual_guilds: h.A.getMutualGuilds(t)?.length,
