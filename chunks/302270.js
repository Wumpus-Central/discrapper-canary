...
function U(e) {
    ...
    return (0, r.jsxs)(p.Gt, {
        ...
        children: [
            ...
            !P && !t && (0, r.jsx)(b.Z, { className: L.button }, 'clips'),
            !l && x
                ? (0, r.jsx)('div', {
                      className: L.button,
            ...
            !C &&
                ...
                (0, r.jsx)(
                    O.Z,
                    {
                        className: a()(L.button, { [L.sidebarOpen]: g }),
                        onClick: () => {
            ...
            !g &&
                (0, r.jsx)('div', {
                    className: a()(L.button, { [L.sidebarOpen]: I || l }),
...
function B(e) {
    ...
    i.useEffect(() => {
        ...
        i.useEffect(() => {
            ...
            N &&
                P.default.track(M.rMx.BOOSTING_UPSELL_VIEWED, {
                    guild_id: n.guild_id,
                    type: k.cd.VIDEO_STAGE_LIMIT,
                    is_moderator: e,
                    listener_count: r + t
                    ...
                    (0, r.jsxs)(x.ZP.Title, {
                        children: [
                            ...
                            (0, r.jsx)(c.Text, {
                                ...
                                color: B ? 'text-muted' : 'header-secondary',
                                className: L.speakerCount,
                                children: D.intl.format(D.t['+v2pNz'], { count: b })
                            })
                        ]
                    })
                ]
