...
var i = n(73800),
    ...
    S = n(647086),
    v = n(231338);
let T = 12633 == n.j ? [a.ZP, o.Z, d.ZP, u.Z, m.Z, g.Z, h.Z, b.Z, x.Z, _.ZP, E.Z, j.ZP] : null;
function N() {
    ...
    function m(n, l) {
        ...
        return s()(n)
            .map((n) => {
                ...
                return d || m || !s().isEmpty(g) || _.ZP.getMentionCount(n.id) > 0 ? C : (t && E) || (a && (E || o || (0, p.vd)(n.type) || ((0, p.vc)(n.type) && !1 === _.ZP.hasUnread(n.id)))) ? null : C;
            })
            .filter(C.lm)
            .sortBy((e) => {
                let { record: t } = e;
