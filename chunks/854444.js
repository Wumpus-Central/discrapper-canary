...
var l = n(192379),
    ...
    L = n(647086),
    m = n(231338);
let v = [s.ZP, o.Z, d.ZP, c.Z, E.Z, _.Z, h.Z, g.Z, T.Z, S.ZP, A.Z, f.ZP];
function Z() {
...
function P() {
    ...
    function E(n, r) {
        ...
        return a()(n)
            .map((n) => {
                var u;
                if (!n.isPrivate() && !T.Z.can(m.Pl.VIEW_CHANNEL, n)) return null;
                let d = null != l && (l.id === n.id || i === n.id),
                    ...
                    A = f.ZP.isChannelMuted(n.guild_id, n.id),
                    N = {
                        id: n.id,
                        record: n,
                        category: r,
                ...
                return d || E || S.ZP.getMentionCount(n.id) > 0 ? N : (t && A) || (s && (A || o || (0, C.vd)(n.type) || ((0, C.vc)(n.type) && !1 === S.ZP.hasUnread(n.id)))) ? null : N;
            })
            .filter(N.lm)
            .sortBy((e) => {
                let { record: t } = e;
