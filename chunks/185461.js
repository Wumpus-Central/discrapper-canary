...
let b =
    ...
    ({
        ...
        themeLight: Y = {},
        themeDark: x = {},
        addScreenshotButtonLabel: V = L,
        cancelButtonLabel: F = d,
        confirmButtonLabel: j = p,
        emailLabel: X = A,
        emailPlaceholder: $ = T,
        formTitle: q = R,
        isRequiredLabel: z = S,
            ...
            eR = async (e) => {
                let n =
                    ...
                    [a, i] = await Promise.all([
                        ep("FeedbackModal", t, "feedbackModalIntegration"),
                        n ? ep("FeedbackScreenshot", r, "feedbackScreenshotIntegration") : void 0,
                    ]);
                if (!a)
                    throw (
                        (m &&
                ...
                let t = y(el, e),
                    ...
                    n = (function ({ triggerLabel: e, triggerAriaLabel: t, shadow: r }) {
                        ...
                        if (
                            ...
                            t.appendChild(E.createTextNode(e)), n.appendChild(t);
                        }
                        let a = (function () {
...
`),
        ...
        return {
            ...
            setupOnce() {
                (0, s.j)() &&
                    ...
                    ("loading" === E.readyState
                        ? E.addEventListener("DOMContentLoaded", () => eA().appendToDom())
                        : eA().appendToDom());
            },
            attachTo: eT,
            createWidget(e = {}) {
            ...
            createForm: async (e = {}) => eR(y(el, e)),
            remove() {
                eu && (eu.parentElement && eu.parentElement.remove(), (eu = null)), ed.forEach((e) => e()), (ed = []);
            },
        };
    };
function U() {
...
function et(e) {
    ((!e.__d && (e.__d = !0) && W.push(e) && !er.__r++) || k !== K.debounceRendering) &&
...
function er() {
    ...
    for (W.sort(x); (e = W.shift()); )
        e.__d &&
            ...
            0 === r || W.length > r
                ? (ec(n, t, a), (a.length = n.length = 0), (t = void 0), W.sort(x))
                : t && K.__c && K.__c(t, F));
    t && ec(n, t, a), (er.__r = 0);
}
...
function es(e, t, r, n, a, i, o, _, s, c) {
    ...
    t: if ("function" == typeof L)
        try {
            if (
                ((T = t.props),
                (A = (E = L.contextType) && n[E.__c]),
                (N = E ? (A ? A.props.value : E.__) : n),
                r.__c
                    ? (R = (l = t.__c = r.__c).__ = l.__E)
                    : ("prototype" in L && L.prototype.render
                          ? (t.__c = l = new L(T, N))
                          : ((t.__c = l = new Q(T, N)), (l.constructor = L), (l.render = eu)),
                      A && A.sub(l),
                      (l.props = T),
                      l.state || (l.state = {}),
                      (l.context = N),
                ...
                null != L.getDerivedStateFromProps &&
                    (l.__s == l.state && (l.__s = $({}, l.__s)), $(l.__s, L.getDerivedStateFromProps(T, l.__s))),
                (d = l.props),
                (I = l.state),
                (l.__v = t),
                u)
            )
                null == L.getDerivedStateFromProps && null != l.componentWillMount && l.componentWillMount(),
                ...
                if (
                    (null == L.getDerivedStateFromProps &&
                        ...
                        l.componentWillReceiveProps(T, N),
                    !l.__e &&
                        ((null != l.shouldComponentUpdate && !1 === l.shouldComponentUpdate(T, l.__s, N)) ||
                            t.__v === r.__v))
                ) {
                    for (
                ...
                null != l.componentWillUpdate && l.componentWillUpdate(T, l.__s, N),
            ...
            if (
                ...
                for (
                    l.state = l.__s, l.__d = !1, O && O(t), E = l.render(l.props, l.state, l.context), D = 0;
                    D < l._sb.length;
                    D++
                )
                    l.__h.push(l._sb[D]);
            ...
            (l.state = l.__s),
                ...
                en(
                    e,
                    X((S = null != E && E.type === Z && null == E.key ? E.props.children : E)) ? S : [S],
                    t,
                    r,
                    n,
                    a,
        ...
        null == i && t.__v === r.__v
            ...
            : (t.__e = (function (e, t, r, n, a, i, o, _, s) {
                  ...
                  if (null === A) R === T || (_ && e.data === T) || (e.data = T);
                      ...
                      if (((i = i && H.call(e.childNodes)), (R = r.props || V), !_ && null != i))
...
function eP(e, t) {
    var r = eg(ed++, 4);
    !ef.__s && eH(r.__H, t) && ((r.__ = e), (r.i = t), eI.__h.push(r));
}
function ev(e, t) {
    var r = eg(ed++, 7);
...
(ef.__b = function (e) {
            ...
            (ep === eI
                ? ((t.__h = []),
                  ...
                  t.__.forEach(function (e) {
                      e.__N && (e.__ = e.__N), (e.__V = eN), (e.__N = e.i = void 0);
                  }))
    ...
    (ef.diffed = function (e) {
        ...
        t &&
            t.__H &&
            (t.__H.__h.length &&
                ((1 !== eA.push(t) && eR === ef.requestAnimationFrame) ||
                    (
                        (eR = ef.requestAnimationFrame) ||
                        function (e) {
                            var t,
                                r = function () {
...
let eB = {
        ...
        useEffect: function (e, t) {
            var r = eg(ed++, 3);
            !ef.__s && eH(r.__H, t) && ((r.__ = e), (r.i = t), eI.__H.__h.push(r));
        },
    ...
    let {
        ...
        M = ew(
            (e) => {
                ...
                return (
                    t.length > 0 ? C(`Please enter in the following required fields: ${t.join(", ")}`) : C(null),
                    0 === t.length
                );
            },
            [p, T, A, N, O],
