...
function z(e) {
    ...
    let { guildId: n } = e,
        ...
        l = (0, o.e7)([v.ZP], () => v.ZP.getChannels(n)),
        s = (0, o.e7)([_.Z], () => _.Z.getCategories(n)),
        ...
        p = (0, o.e7)([y.Z], () => y.Z.getCollapsed()),
        { scrollTo: f } = (0, o.e7)([O.Z], () => O.Z.getGuildDimensions(n)),
        P = (0, g.Z)((e) => {
            let { channelId: t } = e;
            return t;
        }),
        ...
        V = (0, o.e7)([x.Z], () => x.Z.desyncedVoiceStatesCount);
    return (0, i.jsx)(M, {
        guildId: n,
        guild: r,
        channels: l,
