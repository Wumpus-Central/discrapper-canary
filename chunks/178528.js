...
class L extends r.PureComponent {
    ...
    render() {
        ...
        let n = this.props,
            ...
            { guild: o } = s,
            { controller: l, renderBanner: c, bannerVisible: f, communityInfoVisible: g } = this.state,
