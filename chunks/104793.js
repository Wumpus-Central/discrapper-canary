...
function g(e, t, n) {
    ...
    let { context: l, commandTypes: m, allowNsfw: g, computedPermissions: v, userId: I, roleIds: T, isImpersonating: S, hasBaseAccessPermissions: A } = t,
        { applicationAllowedForUser: N, applicationAllowedForChannel: C, isGuildInstalled: w, isUserInstalled: R, commandBotId: P } = n;
    if (!m.includes(e.type)) return 2;
    if (e.nsfw && !g) return 1;
    let D = null != l ? (0, _.Vh)(l, P) : void 0;
    if (null != e.contexts) {
    ...
    if (null == L || o.e$(v, h.Plq.ADMINISTRATOR) || (R && (null == (r = e.integration_types) ? void 0 : r.includes(a.Y.USER_INSTALL)))) return 0;
    if (!A && w && (null == e.integration_types || e.integration_types.includes(a.Y.GUILD_INSTALL))) return 5;
