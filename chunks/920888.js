    ...
    let { message: t, maxReactions: n, hoistReaction: l } = e,
        {
            ...
            let e = [],
                r = ((e, t) => {
                    if (null == t) return e;
                    let n = e.findIndex(
                        (e) => C(e.emoji.id, null == t ? void 0 : t.id) && C(e.emoji.name, null == t ? void 0 : t.name),
                    );
            ...
            return (
                i.forEach((t) => {
                    t.burst_count > 0 && e.push(E(b({}, t), { type: c.O.BURST })),
                        t.count > 0 && e.push(E(b({}, t), { type: c.O.NORMAL })),
                        null != t.me_vote && --a;
                }),
                {
                    combinedReactions: e,
