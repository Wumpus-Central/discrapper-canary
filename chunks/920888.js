...
let y = (e, t) => (null == e && null == t) || e === t,
    C = (e, t) => e.findIndex((e) => y(e.emoji.id, null == t ? void 0 : t.id) && y(e.emoji.name, null == t ? void 0 : t.name)),
    x = (e, t) => {
        if (null == t) return e;
        let n = C(e, t);
...
class v extends i.PureComponent {
    ...
    render() {
        let { message: e, disableReactionCreates: t, disableReactionUpdates: n, isLurking: i, isGuest: l, isPendingMember: g, isForumToolbar: b, channel: E, className: y, forceAddReactions: C, reactionClassName: x, useChatFontScaling: v, forceHideReactionCreates: O, remainingReactions: j, combinedReactions: I, visibleReactionsCount: S } = this.props,
            ...
            children: [
                ...
                j > 0 &&
                    (0, r.jsx)(s.P3F, {
                        ...
                        className: a()(N.reaction, x, N.remainingReactions),
