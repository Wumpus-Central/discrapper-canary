...
class j extends i.PureComponent {
    ...
    render() {
        let { message: e, disableReactionCreates: t, disableReactionUpdates: n, isLurking: i, isGuest: l, isPendingMember: b, isForumToolbar: x, channel: y, className: E, forceAddReactions: v, reactionClassName: O, useChatFontScaling: j, forceHideReactionCreates: C, remainingReactions: S, combinedReactions: I, visibleReactionsCount: N } = this.props,
