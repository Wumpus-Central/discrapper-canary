...
var i = n(228366),
    ...
    h = n(576705),
    f = n(652215);
let E = new RegExp(/@(:?everyone|here)/);
function p(e, t) {
    let n = 0;
    return t.isThread()
        ? (t.memberCount ?? 0)
...
let m = function (e, t) {
        let n = t.getGuildId();
        return c()(n, "isGuildChannel with null guildId"), p(e, t) > 30 && h.A.can(f.xBc.MENTION_EVERYONE, t);
    },
    g = function (e, t) {
...
function S(e) {
    ...
    return new Promise((e) =>
        (function (e) {
            ...
            if (0 === o.length && !n.submit?.allowEmptyMessage && !h && !E && !p)
