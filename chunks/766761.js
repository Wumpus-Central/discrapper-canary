...
let m = function (e) {
    let {
        ...
        C = a ?? n,
        R = (0, d.Ay)(C, l.A.unsafe_rawColors.PRIMARY_800.css),
        O = (0, A.Ay)(c ?? f.dJq, m),
        L = (0, E.tM)(O?.themeColors?.[0]) ?? f.NJ8.DARK,
        { profileThemeStyle: y, profileThemeClassName: D } = (0, h.A)({
            theme: L,
