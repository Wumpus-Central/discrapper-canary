...
function T(e) {
    let {
        ...
        w = (0, r.bG)([g.A], () => g.A.getMessages(a.id)),
        ...
        G = l.useMemo(
            () =>
                (0, i.jsx)(o.Text, {
                    ...
                    color: "none",
                    lineClamp: 3,
                    children: (0, A.BE)(t, s, a, m, B),
                }),
            [t, s, a, m, B],
        );
    return 0 === O.length
        ? (0, i.jsx)(b, { message: t, applicationName: s, iconSrc: N, channel: a, currentUserId: m, viewAction: y })
        : (0, i.jsxs)(i.Fragment, {
              children: [
                  (0, i.jsx)(c.h, {
                      header: _,
