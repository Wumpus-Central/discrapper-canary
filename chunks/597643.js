...
function eB(e, t) {
    let n = [];
    for (let t of e)
        null != t.member && ej(t.guild_id, t.member.user, t.member),
            n.push({
                userId: t.user_id,
                guildId: t.guild_id,
                ...
                oldChannelId: e_.A.getUserVoiceChannelId(t.guild_id, t.user_id),
                connectedAt: t.connected_at,
            });
    eH({ type: "VOICE_STATE_UPDATES", voiceStates: n, receivedAt: t });
}
function eH(e) {
...
function e$(e, t) {
    let n = (function (e, t) {
        ...
        let i = [],
            r = [];
        for (let t of e) (0, et.Q)(t.content_classification) ? r.push(t) : i.push(t);
        return 0 === r.length
...
eV(
    ...
    (e) => {
        ea.A.initialGuild.measure(() => {
            a.Ay.Emitter.batched(() => {
                var t;
                let n,
                    i = ((t = F.identifyStartTime), (n = eD(e)), (eC = { guild: e, identifyTime: t }), n);
    ...
    eF(["READY_SUPPLEMENTAL"], (e) => {
        ea.A.readySupplemental.measure(() => {
            a.Ay.Emitter.batched(() => {
                let t = (e = ea.A.hydrateReadySupplemental.measure(() =>
                    (function (e, t) {
                ...
                ea.A.dispatchReadySupplemental.measure(() => {
    ...
    eV(
        ...
        (e, t, n) => {
            e.user.bot
                ...
                : ea.A.ready.measure(() => {
                      a.Ay.Emitter.batched(() => {
                          let t = (e = ea.A.hydrateReady.measure(() =>
                                  (function (e, t, n) {
                              ...
                              l = null == e.user_settings_proto ? void 0 : (0, J.Gd)(e.user_settings_proto),
                              o =
                                  e.notification_settings?.declarative_settings_proto == null
                                      ? void 0
                                      : ee(e.notification_settings.declarative_settings_proto);
                          ea.A.dispatchReady.measure(() => {
                              eH({
    ...
    eF(["RESUMED"], () => {
        V.forceUpdate(), B.forceUpdate(), eH({ type: "CONNECTION_RESUMED" });
    }),
    eF(["TYPING_START"], (e) => {
    ...
    eF(["USER_SETTINGS_PROTO_UPDATE"], (e) => {
        let t = (0, J.Y5)(e.settings.type, e.settings.proto);
        if (null != t) {
            if ("string" == typeof t)
                throw (
    ...
    eF(["VOICE_STATE_UPDATE"], (e, t, n, i) => {
        eB([e], i);
    }),
    eF(["VOICE_STATE_UPDATE_BATCH"], (e, t, n, i) => {
        eB(e.voice_states, i);
    }),
    ...
    eF(["USER_PAYMENT_SOURCES_UPDATE"], () => {
        (0, es.f)() && (n(277984).$o(), j.jv(eE.A.getFetchedSKUIDs()));
    }),
    eF(["USER_SUBSCRIPTIONS_UPDATE"], () => {
        W.fetchCurrentUser(), (0, es.f)() && n(277984).hP();
    }),
    ...
    eF(["NOTIFICATION_SETTINGS_UPDATE"], (e) => {
        let t = e?.declarative_settings_proto == null ? void 0 : ee(e.declarative_settings_proto);
        eH({ type: "NOTIFICATION_SETTINGS_UPDATE", settings: { flags: e.flags, declarativeSettings: t } });
    }),
...
let eX = new d.A("ConnectionStore"),
    ...
    e2 = null;
async function e3(e) {
    (eQ = Date.now()), (eJ = e.sessionId), V.handleConnectionOpen();
    let t = {},
...
let e9 = new e8(l.h, {
    START_SESSION: function () {
        return F.isClosed()
            ? (eX.verbose("Socket is reconnecting because of starting new session"), F.connect())
            : (eX.verbose("Socket is not reconnecting during a new session because it is not closed"), !1);
    },
    LOGIN_SUCCESS: function () {
        return (
            eX.verbose("session refresh dispatched", { isEstablished: F.isSessionEstablished() }),
            !!F.isSessionEstablished() && (F.close(), F.connect())
        );
    },
    LOGOUT: function (e) {
        e.isSwitchingAccount && V.handleAccountSwitch(), eX.verbose("Closing socket because of logout"), F.close();
    },
        ...
        return (
            (0, S.isIOS)()
                ? (E.default.isAuthenticated() &&
                      (e1 === G.g6G.INACTIVE && e.state === G.g6G.BACKGROUND && null == B.channelId
                          ? F.close(!0)
                          : e1 === G.g6G.BACKGROUND &&
