...
async function h(e, t) {
    let n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {},
        { invite: c } = await s.Ay.resolveInvite(e, t);
    if (null == c) throw new d.A({ errorCode: m.Lw6.INVALID_INVITE }, `Invalid invite id: ${e}`);
    return (
        ...
        a.default.isAuthenticated()
            ...
            : (n?.installationId != null &&
                  s.Ay.setReceivedInstallationIdForInviteCode(c.code, String(n.installationId)),
