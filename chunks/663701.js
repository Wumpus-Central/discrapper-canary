                        ...
                        en(
                            {
                                onClick: () => {
                                    let e;
                                    (h ? (z.default.track(Q.rMx.GIFT_INTENT_BADGE_CLICKED, { gift_intent_type: J.hX.FRIEND_ANNIVERSARY }), (e = Q.pJs.ALL), b.Z.setSection(Q.pJs.ALL), (0, Z.Gk)()) : (e = F.ZP.getState().section), (0, O.Z)({ tab_opened: e }));
                                },
