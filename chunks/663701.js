...
let ec = l.memo(function (e) {
    let { showLibrary: t, hasLibraryApplication: n, homeLink: l, premiumTabSelected: r, isVisualRefreshEnabled: s, shouldShowNitroTab: o, shouldShowMessageRequestsRow: c, shouldShowFamilyCenterRow: u, shouldShowQuickLauncherRow: h, selectedChannelId: m, path: g, shouldMoveMessageRequests: _ } = e;
    return (0, i.jsxs)('nav', {
            ...
            (0, i.jsxs)(Y.Z, {
                ...
                children: [
                    ...
                    n && t
                        ...
                        : null,
                    c && _ ? (0, i.jsx)(el, { selected: null == g ? null != l && l.startsWith(X.Z5c.MESSAGE_REQUESTS) : g === X.Z5c.MESSAGE_REQUESTS }, 'message-requests') : null,
                    o
                        ? (0, i.jsx)(
                              j.g,
                              {
