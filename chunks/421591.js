...
function S(e) {
    let { initHistory: t, children: n } = e,
        ...
        p = i.useCallback(() => {
            let e = null;
            (o((t) => (t.length <= 1 ? t : ((e = t[t.length - 1]), t.slice(0, -1)))), l((t) => (null == e ? t : y(E({}, t), { [e.type]: e }))));
        }, []),
        h = i.useCallback(
            (e) => {
                var t;
...
function A(e) {
    let { context: t, entrypoint: n } = e,
        [o, s] = i.useState(''),
        { setScroller: l, isCloseToBottom: c } = N(o),
...
function N(e) {
    ...
    return (
        ...
        i.useEffect(() => {
            ...
            function e() {
                null != t && ((o.current = t.scrollTop), a(t.scrollHeight - (t.scrollTop + t.clientHeight) < 0.5 * p.K7));
            }
        }, [t]),
        {
            setScroller: n,
