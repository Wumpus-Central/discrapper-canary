...
async function ed(e) {
    ...
    try {
        ...
        if (s && null != e.gameSessionId && C.Ay.getCurrentClipsSession()?.id !== e.gameSessionId) {
            r.h.dispatch({ type: "CLIPS_SAVE_CLIP_ERROR", clipMethod: t }), eC(e);
            return;
        }
...
async function ec(e) {
    ...
    try {
        ...
        throw (
            ...
            r.h.dispatch({ type: "CLIPS_SAVE_CLIP_ERROR", clipMethod: e ?? "manual", ...es(t) }),
            t)
        );
    }
}
