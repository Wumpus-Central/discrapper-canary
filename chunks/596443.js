...
function S(e) {
    ...
    let { permission: s, roleIds: g, guild: x, specMap: y, categoryTitle: C, userId: E } = e,
        S = (0, c.e7)([b.Z], () => b.Z.getRoles(x.id)),
        P = j.Plq[s],
        Z = null != (l = null == (t = y[P.toString()]) ? void 0 : t.title) ? l : (0, m.wt)(P),
        N = null != (a = null == (n = y[P.toString()]) ? void 0 : n.description) ? a : '',
        T = v._o.has(P),
        A = v.Qn.includes(s),
        w = g.length,
                ...
                children: g.map((e) =>
                    (0, v.Ov)(e, E)
                        ...
                        : (0, r.jsx)(
                              u.P3F,
                              {
                                  className: o()(I.roleTooltipItem, { [I.editable]: R && !(0, d.pM)(x.id, e) }),
                                  onClick: () => k(e),
