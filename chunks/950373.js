            ...
            actions: [
                {
                    ...
                    onClick: () => {
                        P.default.track(k.HAw.GAME_COMMUNITY_UPSELL_ACCEPTED, {
                            ...
                            o(er.i.TAKE_ACTION),
                            eS.A.joinGuild(a, { source: k.Q4z.ACTIVITY_PANEL_GAME_COMMUNITY_UPSELL });
                    },
                },
            ],
        })
...
let tY = s.memo(function (e) {
        let {
            ...
            H = s.useCallback(
                (e) => () => {
                    (0, eE.X)(R, eE.O.LEAVE_ACTIVITY), eI.A.stopFrame({ applicationId: e });
                },
                [R],
            ),
            Y = s.useCallback(() => {
        ...
        let J = null == b || null == m ? null : (0, r.jsx)(t$, { applicationId: b.id }),
            ...
            et = (function () {
                let e, t, n;
                if ((null == d && null != h && !(0, N.f)()) || (!o && !i)) return null;
                let s = null;
                return (
                    o
                        ? ((e = !1),
                          (t = () => {
                              Y(), (0, eE.X)(R, eE.O.STREAM, !1);
                          }),
                          (n = tn.G),
            ...
            ei =
                null == h
                    ...
                    : (0, r.jsx)(tE.A, {
                          ...
                          onClick: j(h.applicationId, h.location),
                          icon: ts.o,
                      }),
            es =
                null == f
                    ...
                    : (0, r.jsx)(tE.A, {
                          tooltipText: z.intl.string(z.t["R/FK4A"]),
                          onClick: H(f.applicationId),
                          icon: ts.o,
                      }),
            eo = null == t ? null : (0, r.jsx)(tv, {}),
            el =
                !y || C
                    ? null
                    : (0, r.jsx)(tW, {
        ...
        return null == et && null == en && null == ei && null == es && null == el && null == J && null == ee
            ? null
            : (0, r.jsxs)("div", { className: tj.o1, children: [el ?? J ?? en, ee, et, ei ?? es ?? eo, eu] });
    }),
...
function tK(e) {
    ...
    let u = (0, tl.A)(),
        ...
        [p, E] = (0, eA.kn)([h.M.GAME_SERVER_GAME_DETECTION_UPSELL_NEW_BADGE], void 0, !0),
        m = s.useCallback(() => {
...
function tX(e) {
    let { onClick: t } = e,
        n = L.tz.useSetting(),
        i = (0, _.bG)([M.A], () => M.A.getStatus());
    return __OVERLAY__ || (n && i !== k.clD.INVISIBLE) ? null : (0, r.jsx)(tZ, { onClick: t });
}
var tQ = n(409626),
    tJ = n(692969),
    t0 = n(16590),
...
function t2(e) {
    let { name: t, applicationId: n } = e,
        i = (0, tJ.A)({
            ...
            applicationId: n,
            source: tQ.Ob.RtcPanel,
            trackEntryPointImpression: !0,
        });
    return (0, r.jsx)(E.D, {
        onClick: i,
        className: o()(null != i && t1.On),
        children: (0, r.jsx)(e9.A, { className: t1.mO, children: t }),
    });
}
function t3(e) {
    let t,
        ...
        E = (0, _.bG)([tg.Ay], () => tg.Ay.getKeybindForAction(k.hCu.SAVE_CLIP)),
        m = null != E && E.shortcut.length > 0 ? tA.dI(E.shortcut, !0) : null,
        g = (0, tT.Et)(),
        A = (0, tT.XT)(),
        I = g && (i || A) && f && null != m;
    return (
        ...
        (0, r.jsxs)("div", {
            ...
            children: [
                (0, r.jsxs)("div", {
                    className: t1.f9,
                    children: [
                        (0, r.jsx)(ew.A, { className: t1.Gt, game: a, pid: o?.pid, ref: d }),
                        i ? (0, r.jsx)(tz.n, { size: "md", color: "currentColor", className: t1.it }) : null,
                    ],
                }),
                (0, r.jsx)(es, {
                    popoutTargetRef: h,
                    ...
                    children: (0, r.jsxs)("div", {
                        className: t1.pq,
                        children: [
                            null != p ? (0, r.jsx)(t2, { name: p, applicationId: a?.id }) : null,
                            I
                                ? (0, r.jsx)(U.E, {
                                      variant: "text-xs/medium",
                                      color: "text-subtle",
                                      className: t1.En,
                                      tag: "div",
                                      children: z.intl.format(t0.default.ESZwQX, {
                                          keybind: m,
                                          keybindHook: () =>
                                              (0, r.jsx)(th.e, { shortcut: m, className: t1.oH, keyClassName: t1.Bj }),
                                      }),
                                  })
                                : f
                                  ? (0, r.jsx)(tX, { onClick: l })
                                  : (0, r.jsx)(U.E, {
                                        variant: "text-xs/medium",
                                        color: "text-subtle",
...
function nn(e) {
    ...
    return (
        n &&
            ((a = z.intl.string(t7.default.ublzTG)),
            (o = z.intl.string(t7.default.JgM2xu)),
            (t = { type: "video", src: ne.A, fallbackImageSrc: t9.A, aspectRatio: "2/1", loop: !0 })),
        (0, r.jsx)(p.A, {
            graphic: t,
            title: a,
            body: o,
    ...
    let E = () => {
            u()(null != s, "Channel cannot be null during navigation click"),
                ...
                !h &&
                    ...
                    (0, eK.pQ)(s.type) && (0, v.gk)(t6.Gd.PANEL));
        },
        m = (0, r.jsxs)(r.Fragment, {
            children: [
                (0, r.jsx)(ew.A, { className: t8.Gt, game: n, size: ew.M.SMALL, ref: d }),
                (0, r.jsx)(es, {
                    popoutTargetRef: _,
                    isForceShowSharingPopout: l,
                    setIsForceShowSharingPopout: c,
                        ...
                        children: [
                            ...
                            null != s && (0, eK.pQ)(s.type)
                                ? (0, r.jsx)(eF.A, {
                                      href: t,
                                      onClick: E,
                                      children: (0, r.jsx)(e8.A, { className: t8.Ix, children: p }),
                                  })
                                : (0, r.jsx)(ns, { timestamps: f }),
                        ],
                    }),
                }),
            ],
        });
    return (0, r.jsx)("div", { className: t8.cm, children: m });
}
function no(e) {
    let { frame: t, application: n, accountLinkUpsellTargetRef: i, isActivityPopoutOpen: a } = e,
        ...
        l = (0, r.jsxs)(r.Fragment, {
            children: [
                (0, r.jsx)(ew.A, { className: t8.Gt, game: n, size: ew.M.SMALL, ref: i }),
                (0, r.jsxs)("div", {
                    className: t8.pq,
                    children: [
                        (0, r.jsx)(E.D, {
                        ...
                        (0, r.jsx)(ns, { timestamps: o }),
                    ],
                }),
            ],
        });
    return (0, r.jsx)("div", { className: t8.cm, children: l });
}
function nl(e) {
    ...
    return (0, r.jsxs)("div", {
        ...
        ref: n,
        children: [
            (0, r.jsx)(eU.A, { title: a, icon: t?.sourceIcon }),
            (0, r.jsxs)("div", {
                className: t8.pq,
                children: [
                    ...
                    null != i &&
                        (0, r.jsxs)("div", {
                            ...
                            children: [
                                ...
                                (0, r.jsx)(eW, { className: t8.s, variant: "text-xxs/semibold", children: i }),
                            ],
                        }),
                ],
            }),
...
let nu = (0, y.A)(function (e) {
    let { guildId: t, analyticsContext: n, className: i } = e,
        a = s.useRef(null),
        l = s.useRef(null),
        u = s.useRef(null),
        c = (0, _.bG)([ez.default], () => ez.default.getId()),
        f = (0, _.bG)([eN.Ay, e6.A], () => (0, eG.A)(eN.Ay, e6.A)),
        { allowAccountLinkingUpsellPostGameClose: p } = ec.useConfig({ location: "ActivityPanelGameCard" }),
        { enabled: E } = eC.useConfig({ location: "ActivityPanelGameCard" }),
        { previouslyRunningGame: m, isWithinThreshold: g } = (function (e) {
            let { enabled: t } = e,
                [n, i] = (0, s.useState)(Date.now()),
                r = (0, _.bG)([eD], () => eD.getLastPreviouslyRunningGame());
            if (
                ((0, s.useEffect)(() => {
                    if (!t || null == r || Date.now() - r.endedAt >= eL) return;
                    let e = setTimeout(
                        () => {
                            i(Date.now());
                        },
                        r.endedAt + eL - Date.now(),
                    );
            ...
            let a = n - r.endedAt;
            return { previouslyRunningGame: r, isWithinThreshold: t && a < eL };
        })({ enabled: p || E }),
        ...
        [y, N] = (0, _.yK)([e$.A], () => [e$.A.getCurrentUserActiveStream(), e$.A.getStreamerActiveStreamMetadata()]),
        v = (0, _.bG)([R.Ay], () => R.Ay.getCurrentEmbeddedActivity()),
        O = (0, _.bG)([eT.A], () => eT.A.getConnectedFrame()),
        b = (0, _.bG)([eX.A, eJ.A], () => null == A || eP.vz(A, eX.A, eJ.A, !1)),
        [L] = (0, ef.A)([
            (function () {
        ...
        U = (0, _.bG)([e3.default, e1.A], () => (null != T ? (0, em.m1)(T, e3.default, e1.A) : void 0)),
        G = (function () {
            let { resolution: e, fps: t } = (0, _.cf)([eB.A], () => eB.A.getState());
            if (e !== eH.on.RESOLUTION_720 || t === eH.kn.FPS_60) return `${(0, eH.zr)(e)} ${(0, ej.Bs)(t)}`;
        })(),
        [F, V] = s.useState(!1),
        B = (0, _.bG)([eV.A], () => eV.A.getWindowOpen(k.MLl.ACTIVITY_POPOUT)),
        { parentAnalyticsLocation: j, analyticsLocations: H } = (0, ea.Ay)(),
        {
            hasAlreadyLinked: Y,
            canStartAuthorization: W,
            connectionApp: K,
            startAuthorization: $,
        } = (0, e_.RD)(L, { allowedFlows: [tB._M.RPC, tB._M.WEB] }),
        [z, q] = s.useState(null),
        Z = null != z,
        X = s.useCallback(
            function () {
    ...
    let J = (0, d.K)((e) => {
        ...
        [ei, es] = (function (e) {
            let {
                ...
                A = s.useMemo(() => {
                    ...
                    let e = [];
                    return (
                        l && u && tH(t, n, i) && null == i && e.push(h.M.ACCOUNT_LINK_INVITE_FRIENDS),
        ...
        eu = s.useMemo(
            () =>
                null != f && (w || W) && (!x || N?.pid != null)
                    ? el(L, f, { isGameRunning: !0 })
                    : null != v && null != L && tH(L, M, v)
                      ? (0, r.jsx)(na, {
                            application: L,
                            embeddedActivity: v,
                            channel: T,
                      ...
                      : null != O &&
                        ...
                        : x
                          ...
                          : null != eo
                            ...
                            : null,
            [N, M, L, w, W, U, T, v, O, S, B, F, x, eo, el, f, G],
        );
    return null == eu
        ? null
        : (0, r.jsx)("div", {
