...
var ev = n(952818),
    eC = n(927813);
let eR = ev.Ay.getRunningGames(),
    eO = [];
class eb extends _.Ay.Store {
    initialize() {
        this.syncWith([ev.Ay], () =>
            (function () {
                let e = ev.Ay.getRunningGames();
                if (eR === e) return !1;
                let t = eR.filter(
                    (t) =>
                        null ==
    ...
    let E = () => {
            u()(null != s, "Channel cannot be null during navigation click"),
                ...
                !h &&
                    ...
                    (0, eK.pQ)(s.type) && (0, C.gk)(t6.Gd.PANEL));
        },
...
let nu = (0, y.A)(function (e) {
    let { guildId: t, analyticsContext: n, className: i } = e,
        ...
        f = (0, _.bG)([ev.Ay, e6.A], () => (0, eG.A)(ev.Ay, e6.A)),
        ...
        b = (0, _.bG)([eZ.A, eJ.A], () => null == A || eP.vz(A, eZ.A, eJ.A, !1)),
        [L] = (0, ef.A)([
            (function () {
