...
let x = s.Z.Types,
    I = function (e) {
        ...
        let I = (0, l.e7)([v.Z, m.Z], () => {
                var e;
                return m.Z.getChannel(null == (e = v.Z.getVoiceStateForUser(n.id)) ? void 0 : e.channelId);
            }),
            P = (0, d.E)("UserActivityContainer", I),
            C = (0, l.e7)([f.Z], () => (a ? f.Z.getAnyStreamForUser(n.id) : null)),
            E = (null == t ? void 0 : t.type) === h.IIU.HANG_STATUS && P ? I : null,
            w = (0, l.e7)([g.Z, v.Z, m.Z], () => {
                var e, r;
                return (0, o.Z)(t, h.xjy.EMBEDDED)
                    ? g.Z.getGuild(
                          null ==
                              (e = m.Z.getChannel(
                                  null == (r = v.Z.getVoiceStateForSession(n.id, null == t ? void 0 : t.session_id))
                                      ? void 0
                                      : r.channelId,
                              ))
                              ? void 0
        ...
        return (i.useEffect(() => {
            (null == t ? void 0 : t.type) === h.IIU.HANG_STATUS &&
                P &&
                _.default.track(h.rMx.VIEW_HANG_STATUS, {
                    source: "UserProfilePopout",
                    guild_id: null == E ? void 0 : E.guild_id,
                    channel_id: null == E ? void 0 : E.id,
                });
        }, [null == t ? void 0 : t.type, P, E]),
        (null == t ? void 0 : t.type) !== h.IIU.HANG_STATUS || P)
            ? (0, r.jsx)(
                  s.Z,
                  j(O({}, x), {
                      activity: t,
