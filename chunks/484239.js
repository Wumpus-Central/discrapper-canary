...
let h = (e) => {
    ...
    let n,
        i,
        { title: h, titleClassName: f, buttonClassName: _, perkImage: b, isCarousel: N, onCtaClick: x, perkComponent: E, subtitle: j = '', descriptionCta: C = '', cardVariant: O, subtitleClassName: S, imageOverlayText: v } = e,
        T = (0, o._)(O),
        I = (0, l.Er)(),
