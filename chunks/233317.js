...
function d(e) {
    ...
    r.h.wait(() => (0, a.mm)(t).catch(l.FXj)), (u.membersData.isUpdating = !1);
}
function _() {
...
let f = new h(r.h, {
    PREMIUM_GROUP_MEMBERS_REQUEST: function (e) {
        let { subscriptionId: t } = e;
        return !u.membersData.isFetching && (r.h.wait(() => (0, a.mm)(t).catch(l.FXj)), !0);
    },
    ...
    PREMIUM_GROUP_MEMBERSHIP_REQUEST: function () {
        return !u.membershipData.isFetching && (r.h.wait(() => (0, a.JV)().catch(l.FXj)), !0);
    },
    ...
    PREMIUM_GROUP_REMOVE_INVITE_FAILURE: function (e) {
        ...
        if (t === o.Hy.BILLING_SUBSCRIPTION_GROUP_INVITE_ALREADY_ACCEPTED)
            return r.h.wait(() => (0, a.mm)(n).catch(l.FXj)), (u.membersData.isUpdating = !1), !0;
        _();
    },
    LOGOUT: function () {
        u = {
