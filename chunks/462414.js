...
function p(e) {
    ...
    if (null == t) throw new a.Z({ errorCode: u.lTL.INVALID_COMMAND }, 'No application.');
    return t;
}
let h = {
    [u.Etm.SET_VOICE_SETTINGS_2]: {
        ...
        handler(e) {
            let {
                    socket: t,
                    args: { input_mode: n, self_mute: r, self_deaf: a }
                } = e,
                s = p(t);
            null != n && i.Z.setMode(n.type, { shortcut: (0, o.Kd)(n.shortcut) }, s), null != r && r !== l.Z.isSelfMute(s) && i.Z.toggleSelfMute({ context: s }), null != a && a !== l.Z.isSelfDeaf(s) && i.Z.toggleSelfDeaf({ context: s });
        }
    },
    [u.Etm.SET_USER_VOICE_SETTINGS_2]: {
        ...
        handler(e) {
            let {
                    socket: t,
                    args: { user_id: n, mute: r, volume: o }
                } = e,
                a = p(t);
