    ...
    if (!E.Z.isFetchingCurrentQuests) {
        ...
        try {
            let e = await i.tn.get({
                ...
                r = t.filter((e) => {
                    ...
                    return (
                        ...
                        v.r.build(e.config).rewardPlatforms.length > 0
                    );
                }),
            ...
            a.Z.dispatch({
                ...
                m.Z.recordQuestRequestApiResponse(T.ANM.QUESTS_CURRENT_QUESTS, { wasSuccessful: !0 });
        } catch (e) {
            a.Z.dispatch({
                type: "QUESTS_FETCH_CURRENT_QUESTS_FAILURE",
                error: new o.Z(e),
            }),
                m.Z.recordQuestRequestApiResponse(T.ANM.QUESTS_CURRENT_QUESTS, { wasSuccessful: !1 });
        }
    }
}
async function M(e) {
        ...
        if (
            (a.Z.dispatch({
                ...
                adDecisionData: {
                    ...
                    ad_set_id: null == (c = y.ad_identifiers) ? void 0 : c.ad_set_id,
                    campaign_id: null == (d = y.ad_identifiers) ? void 0 : d.campaign_id,
                    creative_id: null == (_ = y.ad_identifiers) ? void 0 : _.creative_id,
                    creative_type: null == (p = y.ad_identifiers) ? void 0 : p.creative_type,
            ...
            return;
        e === b.Ok.DESKTOP_ACCOUNT_PANEL_AREA && h.Z.startTracking(v.id),
            f.default.track(
