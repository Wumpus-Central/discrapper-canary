    ...
    J = (e) => {
        ...
        switch (u) {
            ...
            case c.R.PROFILE_FRAME:
                return (0, i.jsx)("div", { className: $.pI, children: (0, i.jsx)(z.A, { frame: o, filterLayer: Z }) });
            case c.R.AVATAR_DECORATION:
                return (0, i.jsx)(Q.i, { item: o, user: a, isHighlighted: l, avatarSize: U._3.SIZE_120 });
            case c.R.NAMEPLATE:
                return (0, i.jsx)(q.A, { nameplate: o, user: a, isHighlighted: l });
            case c.R.BUNDLE:
...
let eR = (e) => {
        ...
        return (0, i.jsx)(ek.$, {
            ...
            text:
                ...
                V.intl.format(c ? V.t.JC15qj : V.t.lOtBOI, {
                    orbPrice: r[0].amount,
                    orbIconHook: () => (0, i.jsx)(eC.A, { className: ey.f }),
                }),
            onClick: (e) => {
                e.stopPropagation(),
    ...
    eV = (e) => {
        let {
            ...
            { handleUseNow: b, isApplying: S } = (0, eh.p)({ product: t });
        if (null != s) return (0, i.jsx)(eN, { onClick: s, skuId: t.skuId, text: l });
        ...
        if (m) return (0, i.jsx)(eO, { handleUseNow: b, isApplying: S, text: l, onTrackClick: c });
        if (o)
            return (0, i.jsx)(C.f5, {
        ...
        if (j && !v)
            if (y.length > 1) return (0, i.jsx)(eH, { handlePreviewButtonClick: L, text: l, onTrackClick: c });
...
let eQ = (e) => {
    ...
    eK = (e) => {
        ...
        return null == s
            ? null
            : (0, i.jsx)(eQ, { product: s, selectedVariantIndex: l, isCardHovered: r, onTrackClick: n });
    };
var eq = r(935094),
    e$ = r(521e3),
    eZ = r(496569);
let eX = n.memo(function (e) {
        ...
        return (0, i.jsx)(d.L, {
            ...
            children: (0, i.jsx)(k.s, {
                ...
                "aria-label": eu,
                "aria-describedby": ec,
                className: l()(q, eZ.ty, { [eZ.yo]: ek }),
                onFocus: () => W?.(t.skuId),
                onBlur: () => G?.(t.skuId),
                onMouseEnter: () => w?.(t.skuId),
                onMouseLeave: () => F?.(t.skuId),
                children: (0, i.jsx)(e$.vf.Provider, {
                    value: ep ? eo : null,
                    children: (0, i.jsxs)("div", {
                        ...
                        children: [
                            ...
                            (0, i.jsx)("div", {
                                className: l()(eZ.Dq, { [eZ.$r]: !s || ey || eP, [eZ.T9]: eh }),
                                children: (0, i.jsx)(et, {
                                    skuId: t.skuId,
                                    isCardHovered: ek,
                            ...
                            (0, i.jsxs)("div", {
                                ...
                                children: [
                                    ...
                                    !r && (0, i.jsx)(eK, { skuId: t.skuId, isCardHovered: ek, onTrackClick: eg }),
                                ],
                            }),
                            eR &&
                                (0, i.jsxs)(i.Fragment, {
                                    children: [
                                        (0, i.jsx)("div", { className: l()(eZ.wY, { [eZ.KY]: eh }) }),
                                        (0, i.jsxs)("div", {
                                            className: eZ.xQ,
                                            children: [
                                                ey &&
