...
let w = function (e) {
    ...
    return (0, r.jsx)(H.E, {
        ...
        className: n,
        lineClamp: 1,
        children: l ? B.intl.format(B.t.UTc0ny, { count: i.items.length, productName: s }) : s,
    });
};
var U = n(947641),
    F = n(17928),
...
function en(e) {
    let t,
        ...
        s = (0, F.bG)([z.default], () => z.default.getCurrentUser()),
        l = (0, T.YW)(n),
        a =
            ((t = (0, y.Q)(n)),
...
function eP(e) {
    ...
    return (0, r.jsx)(eI.$, {
        ...
        text: a ?? B.intl.formatToPlainString(B.t["cNSL/j"], { price: u }),
        fullWidth: !0,
    });
}
function eL(e) {
...
function eO(e) {
    ...
    return (0, r.jsx)(eI.$, {
        ...
        loading: n,
        text: i ?? B.intl.string(B.t.MAS7uK),
        fullWidth: !0,
    });
}
function eN(e) {
    ...
    return (0, r.jsx)(eI.$, {
        ...
        text: t ?? B.intl.string(B.t["2p2aYz"]),
        fullWidth: !0,
    });
}
function eV(e) {
    ...
    return (0, r.jsx)(eI.$, {
        ...
        text: i ?? B.intl.string(B.t.FdGl5A),
        fullWidth: !0,
    });
}
function eM(e) {
...
function eH(e) {
    ...
    return (0, r.jsx)(eI.$, {
        ...
        "aria-label": B.intl.formatToPlainString(B.t.yi41qQ, { orbPrice: n[0].amount }),
        fullWidth: !0,
    });
}
function eD(e) {
    ...
    return (0, r.jsx)(eI.$, {
        ...
        text: n ?? B.intl.string(B.t.GpnHfH),
        fullWidth: !0,
    });
}
function eB(e) {
    let {
        ...
        C = (0, ef.L)(eT.PremiumTypes.TIER_2),
        p = el.Ay.canUseShopDiscounts(d),
        I = (0, h.VZ)(t),
        { isPurchased: f, isPartiallyOwnedBundle: A } = (0, $.h)(t),
        k = (0, j.G0)(t),
        m = (0, j.tt)(t),
        { isDisabled: v } = (0, eo.I)(t.skuId),
        _ = (0, j.Zu)({ product: t, isPartiallyOwnedBundle: A, isPurchased: f }),
        {
        ...
        { analyticsLocations: b } = (0, g.Ay)(x.A.COLLECTIBLES_SHOP_CARD),
        P = (0, D.ql)(t, x.A.COLLECTIBLES_SHOP_CARD_PREVIEW_BUTTON, o),
        [L, S] = (0, es.yK)([e_.A], () => [
    ...
    if (c)
        return (0, r.jsx)(g.f5, {
            value: [...b, x.A.PROFILE_FRAMES_EA_MARKETING],
            children: (0, r.jsx)(eL, { text: B.intl.string(B.t["9wfL34"]), onTrackClick: u }),
        });
    if (k)
        return (0, r.jsx)(eM, {
            product: t,
...
function ez(e) {
    let {
        ...
        C = (0, A.uM)(),
        p = (0, eW.X)(t, a),
        I = (0, D.ql)(t, x.A.COLLECTIBLES_SHOP_CARD_PREVIEW_BUTTON, o);
...
let e1 = i.memo(function (e) {
    let {
        ...
        en = (0, D.gZ)() ?? q,
        er = (0, h.Nc)(t),
        es = en ?? (er ? D.Hi.FIAT : void 0),
        el = (0, k.Mk)(),
        ea = el?.tab,
        eo = (0, A.uM)(),
        eu = i.useMemo(() => (0, D.UU)(t, ea, eo), [t, ea, eo]),
        ec = (0, V.s7)(t),
        ed = i.useId(),
        eC = i.useRef(null),
        { isHoveringOrFocusing: eI } = (0, f.A)(eC),
        ex = (0, e0.$c)(t.skuId),
        eg = (function (e) {
            let t = (0, A.uM)(),
        ...
        ef = (0, o.A)(eC, eg),
        { handleCardVisibilityChange: eA } = (0, E.Z)(t.skuId, ea === ej.G2.CATALOG ? "full" : ea),
        ek = (0, D.ql)(t, x.A.COLLECTIBLES_SHOP_CARD, eu),
        ...
        e_ = i.useCallback(
            (e) => {
                null != _ ? _(e) : (ev(ej.sH.OPEN_DETAILS), ek(e));
            },
            [ev, _, ek],
        );
    !(function (e, t) {
    ...
    let eh = t.type === u.R.BUNDLE && t.previewAssets?.fgStatic != null,
        eE = t.type === u.R.VARIANTS_GROUP && !a,
        eR = i.useMemo(() => ({ maxVariantsToShow: 4, onClick: ek }), [ek]),
        ey = t.type === u.R.BUNDLE && !Z,
        eT = !I || !m,
        eb = !(c && s) || eE,
        eP = eb || eT,
        eL = eT || eE;
            ...
            children: (0, r.jsx)(e0.vf.Provider, {
                ...
                children: (0, r.jsxs)("div", {
                    ...
                    children: [
                        ...
                        (0, r.jsx)("div", {
                            className: l()(e2.Dq, { [e2.$r]: !s || eb || eL, [e2.T9]: eh }),
                            children: (0, r.jsx)(ei, { skuId: t.skuId, isCardHovered: eI, overrideVariantIndex: J }),
                        }),
                        (0, r.jsxs)("div", {
                            className: e2.N1,
                            children: [
                                (0, r.jsx)(M.A, {
                                    ...
                                    badgeOverride: v,
                                    className: K,
                                    prioritizedCurrency: es,
                                }),
                                !n && (0, r.jsx)(eZ, { skuId: t.skuId, isCardHovered: eI, onTrackClick: ev }),
                            ],
                        }),
                        eP &&
                            (0, r.jsxs)(r.Fragment, {
