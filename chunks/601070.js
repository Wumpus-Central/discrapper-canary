        ...
        for (let n in t[e]) {
            ...
            if (null != t) {
                let n = {
                    ...
                    { isUnread: r, isRelevant: i, isTimedRelevant: o } = X(e);
...
function x() {
    for (let e in ((C = {}), S)) for (let t in S[e]) j(e, t);
}
function M(e) {
...
function j(e, t) {
    ...
    if (
        ...
        (null == C[e] && (C[e] = {}), (C[e][t] = 0), null == S[e] || null == S[e][t])
    )
        return;
    ...
    for (let n in S[e][t])
        t === R
            ? f.ZP.isNewForumThread(n, t, r) && C[e][t]++
            : p.default.compare(n, i) > 0 && !f.ZP.hasOpenedThread(n) && C[e][t]++;
}
function k(e, t, n) {
    if (null == t) return !1;
    ...
    if (null != r && h.Z.isActive(e, t, n)) {
        if (null != i) {
            let e = {
                ...
                { isUnread: t, isRelevant: n, isTimedRelevant: o } = X(r);
            ee(I, r, e, !0),
                ee(N, r, n ? e : null, !0),
                ee(T, r, t ? e : null, !0),
                ee(S, r, null, !0),
...
function B(e, t) {
    ...
    let i = S[e],
        o = null == i ? null : i[t];
    if (null != o) {
        for (let e in o) if ((0, l.aC)(o[e])) return !0;
    }
    return !1;
}
function Z(e) {
    ...
    return (
        null != t.guild_id &&
            ...
            t.guild_id in N &&
                ...
                (p.default.keys(N[t.guild_id][t.parent_id]).forEach($), delete N[t.guild_id][t.parent_id], (n = !0)),
...
function V(e) {
    ...
    if (null == t) H();
        ...
        if (null == r) return !1;
        if (en(I, t)) {
            let { isUnread: n, isRelevant: i, isTimedRelevant: o } = X(t);
            Q(t, o);
            let a = en(T, t),
                s = en(N, t);
            if (n === a && i === s) return !1;
...
function H() {
    for (let e in ((T = {}), (N = {}), I))
        for (let t in I[e])
            for (let n in I[e][t]) {
                let r = I[e][t][n],
                    { isUnread: i, isRelevant: o, isTimedRelevant: a } = X(r.channel);
...
function et(e, t, n, r) {
    null != t &&
        ...
        null != r &&
        er(e, t, n, r) &&
        ((e[t] = v(y({}, e[t]), { [n]: y({}, e[t][n]) })), delete e[t][n][r], o().isEmpty(e[t][n]) && delete e[t][n]);
}
function en(e, t) {
...
class ec extends (r = a.ZP.Store) {
    ...
    getActiveThreadCount(e, t) {
        var n, r, i, a;
        return (
            o().size(null != (i = null == (n = I[e]) ? void 0 : n[t]) ? i : {}) +
            o().size(null != (a = null == (r = S[e]) ? void 0 : r[t]) ? a : {})
        );
    }
}
