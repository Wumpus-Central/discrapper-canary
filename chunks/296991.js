...
function S(e) {
    let {
        ...
        S = i.useRef(null),
        _ = i.useRef(null),
        [{ textValue: T, richValue: P }, w] = i.useState((0, m.eK)(t.value)),
        [, Z, R] = (0, c.c)({
            type: I,
            item: {
                rule: t,
...
function _(e) {
    let { rules: t, setRules: n, guild: l, disabled: a } = e,
        ...
        d = (0, u.e7)([p.Z], () => (null != s ? p.Z.getChannel(s) : null)),
        f = (0, u.e7)([h.ZP], () => h.ZP.getDefaultChannel(l.id)),
        [m, b] = i.useState(null),
        [I, _] = i.useState(null),
        T = i.useCallback(
            (e) => {
