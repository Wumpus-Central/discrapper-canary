...
let I = 'RULE';
function E(e) {
    let { rule: t, rulesChannel: n, index: s, onChange: l, onKeyDown: o, onClear: u, onRuleReorder: f, isDropHovered: b, focused: x, onFocus: j, previewEnabled: v, isDragEnabled: y } = e,
        C = i.useRef(null),
        E = i.useRef(null),
        [{ textValue: S, richValue: T }, P] = i.useState((0, g.eK)(t.value)),
        [, w, R] = (0, c.c)({
            type: I,
            item: {
                rule: t,
        ...
        [, D] = (0, d.L)({
            ...
            hover: (e, t) => {
                var n;
                let { index: r } = e,
                    i = null === (n = C.current) || void 0 === n ? void 0 : n.getBoundingClientRect(),
                    a = t.getClientOffset();
