...
function T(e) {
    var t;
    let { user: n, displayProfile: a, guildId: v, pendingBanner: T, children: b, className: S, avatarSize: A, avatarOffsetX: N, avatarOffsetY: C, bannerWidth: R, bannerHeight: O, themePadding: D, animateOnHover: x = !1 } = e,
        L = (0, _.Dt)(),
        [P, w] = r.useState(!1),
