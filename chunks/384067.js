...
let y = (e) => {
    var t, n, a;
    let { wideBannerBlock: y, tab: j } = e,
        k = m.Z.getCategoryByStoreListingId(y.categoryStoreListingId),
        T = l.useRef(null),
        I = l.useRef(null),
        [L, B] = l.useState(),
        [A, N] = l.useState(!1);
    ...
    let P = null != (t = null == k ? void 0 : k.skuId) ? t : "",
        { handleCardVisibilityChange: R } = (0, C.E)(P, "home", "marketing wide banner"),
        Z = (0, b.sp)(),
        { bannerURL: w } = (0, h.UI)(y),
        H = j === v.AW.ORBS,
        ...
        W = l.useCallback(() => {
            if ((N(!0), y.isDismissible)) {
                ...
                (0, u.wH)(i.z.COLLECTIBLES_SHOP_WIDE_BANNER, t, { dismissAction: S.L.USER_DISMISS });
            }
    ...
    let z = o()(x.row, x.between, x.bannerBlockContainer, x.centeredSection, {
        ...
        G = (0, r.jsxs)(r.Fragment, {
            children: [
                ...
                (0, r.jsx)("div", {
                    className: o()(x.wideBannerBackgroundImg, { [x.extraRounded]: H }),
                    style: null != L ? { height: "".concat(L, "px") } : void 0,
                    children: (0, r.jsx)("img", {
                        ref: I,
                        src: w,
                        alt: y.title,
                        className: o()(x.wideBannerArt, { [x.wideBannerArtOrbs]: H }),
                    }),
                }),
                (0, r.jsx)("div", {
                    className: o()(x.wideBannerContentContainer, { [x.wideBannerWithCTAContentContainer]: M }),
