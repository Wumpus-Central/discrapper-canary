...
function O(e) {
    ...
    return e.isStaff() && t === C.$I
        ...
        : null != e.premiumType && (0, a.ki)(e)
          ? e.premiumType === C.PremiumTypes.TIER_2
              ? (0, S.ew)({ location: "getUserMaxFileSize" })
...
var b = n(349871);
let M = new I.A("ProductCatalog.tsx");
class P extends R {
    constructor(e, t) {
        super(
            e,
...
let U = new P(m.w.ANIMATED_EMOJIS),
    w = new P(m.w.EMOJIS_EVERYWHERE),
    G = new P(m.w.STICKERS_EVERYWHERE),
    x = new P(m.w.SOUNDBOARD_EVERYWHERE),
    k = new P(m.w.CUSTOM_CALL_SOUNDS),
    F = new P(m.w.PREMIUM_VOICE_FILTERS),
    V = new P(m.w.ANIMATED_AVATAR),
    B = new P(m.w.CUSTOM_DISCRIMINATOR),
    H = new P(m.w.PREMIUM_GUILD_MEMBER_PROFILE),
    j = new P("profileBadges"),
    W = new P(m.w.PROFILE_PREMIUM_FEATURES, "custom banner and avatar decoration"),
    Y = new P("collectibles"),
    K = new P("appIcons"),
    $ = new P(m.w.CLIENT_THEMES),
    z = new P("boostDiscount"),
    q = new P("freeBoosts"),
    Z = new P(m.w.STREAM_MID_QUALITY),
    X = new P(m.w.STREAM_HIGH_QUALITY),
    Q = new P(m.w.CUSTOM_NOTIFICATION_SOUNDS),
    J = new P("fancyVoiceChannelReactions"),
    ee = new P("installPremiumApplications"),
    et = new P("redeemPremiumPerks"),
    en = new P(m.w.VIDEO_FILTER_ASSETS);
new R(m.w.INCREASED_FILE_UPLOAD_SIZE, O);
let ei = new P(m.w.INCREASED_GUILD_LIMIT),
    er = new P(m.w.INCREASED_MESSAGE_LENGTH),
    ea = new P("increasedVideoUploadQuality"),
    es = new P("uploadLargeFiles"),
    el = new P(m.w.QUEST_ORB_MULTIPLIER),
    eo = Object.freeze({
    ...
    if (null != i && t?.perks != null) {
        ...
        if (n !== D.CONTROL) {
            let r = e.getFeatureValue(t),
                a = (0, b.Nh)(t?.perks, i);
            return n === D.DUAL_READ_RETURN_NEW ? a : r;
        }
    }
...
let eD = {
    ...
    eb = new I.A("PremiumUtils.tsx");
var eM = (((r = {}).MID = "mid"), (r.HIGH = "high"), r);
function eP(e) {
...
function eV(e, t, n) {
    let i,
        ...
        l = (0, T._1)(e);
    null != l && (i = C.hd[l.planId].premiumType);
    let o = (0, a.CC)(i, C.PremiumTypes.TIER_0),
        d = (0, a.CC)(i, C.PremiumTypes.TIER_2);
    for (let i of e) {
        let e;
        (r = C.pW.has(i.planId) ? d : !C.JM.has(i.planId) && o),
...
function eK(e) {
    ...
    switch (e) {
        ...
        case C.gD.PREMIUM_GROUP_MONTH:
            return n
                ? eL.intl.string(eL.t.SmVbHc)
                : eL.intl.formatToPlainString(ey.default["8bPDtb"], { premiumGroupProductName: (0, eO.DP)() });
...
function eQ(e) {
    let { planId: t, additionalPlans: n } = e,
        ...
        a =
            r?.planId === C.gD.PREMIUM_MONTH_GUILD
                ? eL.t.Pi5yMJ
                : r?.planId === C.gD.PREMIUM_YEAR_GUILD
                  ? eL.t.H4KPuV
                  : null,
...
function ts(e, t, n) {
    ...
    if (null != t)
        try {
            ...
            i = eU(e.id, !1, r, void 0, a);
        }
    else i = eU(e.id, !1, r, void 0, a);
    let s = (0, eC.$g)(i.amount, i.currency);
...
function td(e, t, n, i) {
    ...
    let l = ep.A.getForSkuAndInterval(tM(C.pe.GUILD), s.interval, s.intervalCount);
    if (null == l) {
        let t = Error("Unsupported plan");
        throw ((0, em.pM)(t, { tags: { planId: e } }), t);
    }
    return ex(l.id, (0, a.ki)(i), !1, r);
}
function tc(e, t, n) {
    let i = t.id;
    if (null != e)
    ...
    switch (i) {
        ...
        case C.gD.PREMIUM_GROUP_MONTH:
            return eL.intl.formatToPlainString(ey.default.LwdrNi, { premiumGroupProductName: (0, eO.DP)() });
        case C.gD.PREMIUM_YEAR_TIER_2:
...
function th(e, t) {
    if (null != e && null != e.subscriptionTrial && e.subscriptionTrial.skuId === t) {
        ...
        return tA({ intervalType: t.interval, intervalCount: t.intervalCount });
    }
    return null;
}
function tI(e) {
...
function tU() {
    ...
    return (0, a.YE)(e, C.PremiumTypes.TIER_2);
}
function tw(e) {
    var t;
    let n = C.Eg;
...
let tY = Object.freeze({
    ...
    canUseMonthlyOrbs: function (e) {
        return !!(0, p.v)("canUseMonthlyOrbs") && (0, b.Nh)(e?.perks, _.bb.MONTHLY_ORBS);
    },
    canUseShopDiscounts: function (e) {
        return ((0, p.v)("canUseShopDiscounts") && (0, b.Nh)(e?.perks, _.bb.SHOP_DISCOUNTS)) || tv(e);
    },
    canUseMoreQuestOrbs: function (e) {
        return ((0, p.v)("canUseMoreQuestOrbs") && (0, b.Nh)(e?.perks, _.bb.MORE_QUEST_ORBS)) || tD(e);
    },
