...
let X = l.memo((e) => {
    let { user: t, activities: i = [], gameProfileEntry: s, index: O, closeParentPopout: _, isSuggestion: j, relationshipType: T, appContext: Z, nickname: A, onAction: U, onFriendVisible: x } = e,
        {
        ...
        eO = l.useCallback(
            (e) => {
                e.preventDefault(), e.stopPropagation(), null == U || U('open_direct_message', t.id), (0, N.i)(Z, !0), d.Z.openPrivateChannel({ recipientIds: t.id }), null != _ && _();
            },
            [t.id, _, Z, U]
        ),
        eh = l.useCallback(
            ...
            T === q.OGo.PENDING_INCOMING
                ? (0, r.jsxs)(r.Fragment, {
                      children: [
                          ...
                          (0, r.jsx)(C.sF, {
                              ...
                              icon: c.Dio,
                              onClick: (e) => {
                                  e.preventDefault(), e.stopPropagation(), p.Z.removeRelationship(t.id, { location: 'friends-popout' }), null == U || U('decline_friend_request', t.id);
                              }
                          })
                      ]
                  })
                : T === q.OGo.PENDING_OUTGOING
                  ? (0, r.jsx)(C.sF, {
                        ...
                        icon: c.iHX,
                        onClick: (e) => {
                            e.preventDefault(), e.stopPropagation(), p.Z.cancelFriendRequest(t.id, { location: 'friends-popout' }), null == U || U('cancel_friend_request', t.id);
                        }
                    })
                  : j
                    ? (0, r.jsx)(C.sF, {
...
let et = l.memo(function (e) {
    let { containerClassName: t, listClassName: i, closePopout: u, renderHeader: d, onAction: p, onFriendVisible: g, autoFocus: N = !1, appContext: h = q.IlC.APP } = e,
        [E, S] = l.useState([J.SUGGESTIONS, J.FRIEND_REQUESTS]),
        y = l.useRef(null),
        m = (0, O.Z)('friends-popout', y),
        I = (function () {
                    ...
                    return (0, o.cj)(
                        ...
                        () => {
                            ...
                            U.Z.getFriendIDs())) {
                                ...
                                p ? (r.sameActivity.push(g), l.delete(e)) : d.length > 0 ? r.activities.push(g) : u ? r.activities.push(W(z({}, g), { activities: a })) : s === q.Skl.ONLINE || s === q.Skl.IDLE || s === q.Skl.DND ? r.online.push(g) : r.offline.push(g);
                            }
                            let s = (e, t) => {
                                var n, i;
        ...
        { searchQuery: b, setSearchQuery: C, clearSearch: P } = v,
        T = Y(v, ['searchQuery', 'setSearchQuery', 'clearSearch']),
        Z = l.useCallback((e) => {
        ...
        K = l.useCallback(
            ...
            [I.currentActivityName, T.friendRequests.length, T.sameActivity.length, T.suggestions.length, T.activities.length, T.online.length, T.offline.length, E, Z]
        ),
        B = l.useCallback(
            (e) => {
                let t;
