...
var i = n(562708),
    ...
    y = n(788868),
    N = n(49999);
let v = new d.A("PremiumGiftingIntentManager");
class C extends u.A {
    actions = {
    ...
    dismissGiftIntentDC() {
        (0, _.uh)(s.M.GIFT_INTENT_MESSAGE, { dismissAction: N.i.AUTO_DISMISS, forceTrack: !0 });
    }
    ...
    async sendGiftingNotificationIfEligible() {
        ...
        if (null != r)
            try {
                ...
                v.error("Failed to fetch DM channel data for gifting notification", { recipientUserID: r, error: e });
            }
    }
    onChannelSelect(e) {
        let { channelId: t } = e;
