...
function _(e) {
    ...
    switch (_.type) {
        ...
        case c.rbe.GUILD_VOICE:
            let N = [d.intl.formatToPlainString(d.t.bkpadO, { channelName: y })];
            ...
            if (null != p && p.length > 0) {
                ...
                N.push(t),
                    ...
                    R && N.push(d.intl.formatToPlainString(d.t["6qgTOF"], { userCount: p.length, limit: v }));
            }
            null != S &&
                N.push(d.intl.formatToPlainString(d.t.JQtsGh, { duration: (0, i.U3)({ start: S }, Date.now()) })),
                null != m &&
                    m.length > 0 &&
                    N.push(d.intl.formatToPlainString(d.t.LmYuHT, { activeActivities: m.join(", ") })),
                (n = N.join(", "));
            break;
