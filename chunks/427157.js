...
class I extends a.A {
    ...
    hadPremiumSubscription() {
        let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null;
        return !(0, E.ki)(this) && this.hasHadPremium(e);
    }
    hasFreePremium() {
        return this.isStaff() || this.hasFlag(g.nhx.PARTNER) || this.isStaffPersonal();
    }
    isOnReverseTrial() {
        return (0, E.ki)(this) && this.premiumState?.premiumSource === s.fE.REVERSE_TRIAL;
    }
    isPremiumWithPremiumGroup() {
        return (0, E.ki)(this, A.PremiumTypes.TIER_2) && this.premiumState?.premiumSource === s.fE.SUBSCRIPTION_GROUP;
    }
    isPremiumWithFractionalPremiumOnly() {
        return (
            (0, E.ki)(this, A.PremiumTypes.TIER_2) &&
