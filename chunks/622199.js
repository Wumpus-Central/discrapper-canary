...
function e4(e) {
    ...
    return (0, l.jsx)(A.A, {
        ...
        align: "center",
        caretConfig: { align: "center" },
        title: e3.intl.string(e3.t.KOMFUo),
        body: e3.intl.string(e3.t.Nm72JC),
        onRequestClose: i,
        actions: [{ text: e3.intl.string(e3.t.RzWDqY), variant: "primary", onClick: n }],
    });
}
var e9 = n(834730),
    e7 = n(821609),
...
function tt(e) {
    ...
    return (0, l.jsxs)("div", {
        ...
        children: [
            ...
            (0, l.jsx)(e9.E, { variant: "text-sm/normal", className: te.Qs, children: e3.intl.string(e3.t.rdzeVP) }),
            (0, l.jsx)(e7.$, {
                ...
                (0, l.jsxs)("div", {
                    ...
                    children: [
                        null != n
                            ...
                            : null,
                        (0, l.jsx)(e9.E, { variant: "text-sm/normal", children: i }),
                        _,
                    ],
                }),
            ],
...
function tj(e) {
    ...
    let a = t.features.has(H.GuildFeatures.VERIFIED) ? e3.intl.string(e3.t.uUARXe) : e3.intl.string(e3.t["0Dx29f"]);
    return (0, l.jsx)(tg, {
        guild: t,
        ...
        cta: (0, l.jsxs)("span", {
            className: tv.m,
            children: [e3.intl.string(e3.t["2u6ZlY"]), (0, l.jsx)(tU.I, { size: "xs", color: "currentColor" })],
        }),
    ...
    return (0, l.jsxs)("div", {
        ...
        children: [
            ...
            (0, l.jsxs)("div", {
                ...
                children: [
                    i,
                    (0, l.jsx)(e9.E, { color: "none", variant: "text-xs/normal", className: nd.HA, children: n }),
                    null != s &&
                        null != r &&
                        (0, l.jsxs)(l.Fragment, {
                            children: [
...
function n_(e) {
    ...
    return (0, l.jsx)("div", {
        ...
        children: (0, l.jsx)(e7.$, {
            ...
            fullWidth: !0,
            onClick: () => {
                null != t && null != t.getGuildId() && ((0, t2.av)(t), (0, t6.uh)(t.getGuildId(), t.id));
            },
        }),
    });
}
...
let n1 = new n0(I.h),
    ...
    n2 = n6.map((e) => e.store).filter(t7.Vq),
...
function n9(e) {
    ...
    let i,
        ...
        M = r.useCallback(() => {
            var e;
            (e = Date.now()), k.w.set(n3, e), h(e), p(eE.i.UNKNOWN);
        }, [p]),
        O = (() => {
            switch (T) {
                ...
                case u.M.GAME_CLAIM_COACHMARK:
                    return (0, l.jsx)(tj, { guild: A, markAsDismissed: p });
                default:
                    return null;
            }
        })();
    return null == O ? null : (0, l.jsx)("div", { onContextMenu: n5, children: O });
}
let n7 = (e) => {
    let { guild: t } = e;
    switch (ee(t)) {
...
function id(e) {
    let t,
        ...
        G = (0, ea.$)("favorite-guild-header-context"),
    ...
    let eQ = (0, en.JZ)(u.M.PREMIUM_TUTORIAL_SERVER_MENU_TOOLTIP),
        e$ =
            ...
            (O = (0, eg.X9)(T)),
            M && O && p),
        { showFollowup: eJ } = (function (e) {
            let [t, i] = r.useState(!1),
                s = (0, en.JZ)(u.M.GUILD_THEME_NUX, { bypassNewUserCheck: !0 }),
                a = null != (0, eL.Kb)(e, "GuildThemeNuxTrigger"),
                [o, d] = (0, ei.kn)(a ? [u.M.GUILD_THEME_NUX] : [], eE.m.GUILD_THEME_NUX),
                c = o === u.M.GUILD_THEME_NUX,
                A = (0, _.useHasModalOpen)(ef.u),
                E = r.useRef(!1);
            return (
                r.useEffect(() => {
                    E.current = !1;
                ...
                r.useEffect(() => {
                    if (!c || A || E.current) return;
                    let t = setTimeout(() => {
                        (E.current = !0),
                            (0, _.openModalLazy)(
                                async () => {
                                    let t = await Promise.resolve().then(n.bind(n, 684754));
                                    return (n) =>
                                        (0, l.jsx)(t.default, {
                                            guildId: e,
                                            markAsDismissed: (e) => d(e, !0),
                                            onComplete: () => i(!0),
    ...
    eJ && ts.push(u.M.GUILD_THEME_NUX_FOLLOWUP),
        ep && ts.push(u.M.STUDENT_HUB_PRIVACY_SETTINGS_TOOLTIP),
        eT && ts.push(u.M.GUILD_HEADER_ROLE_SUBSCRIPTION_UPSELL),
        eM && ts.push(u.M.GUILD_DISCOVERY_LANDING_PAGE_SETTINGS_UPSELL),
        !1 === e3 && ts.push(u.M.GUILD_POWERUP_PERKS_COACHMARK),
        e8 && ts.push(u.M.GAME_SERVER_HOSTING_NEW_PERK_AVAILABLE_COACHMARK),
        e9 && ts.push(u.M.GAME_SERVER_PRICING_CHANGE_COACHMARK),
        e$ && ts.push(u.M.SERVER_SUBSCRIPTION_TIER_TEMPLATE_UPSELL);
    let [tl, tr] = (0, ei.kn)(ts, eE.m.GUILD_HEADER_TOOLTIPS),
        [ta, to] = (0, ey.vB)(e5 && e6 && !1 === e3 && !(0, el.ai)(L), eE.m.GUILD_HEADER_TOOLTIPS),
        [td, tu] = (0, ei.D8)(
