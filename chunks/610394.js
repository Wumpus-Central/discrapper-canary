...
function ee(e, t) {
    ...
    (j[e] = P({}, j[e], t)), null != i && (j[e].error = i), null != o && (j[e].error_description = o);
}
function et(e) {
    var t, n, r;
    if (null != j[e]) return;
...
function ei(e, t) {
    try {
        ...
        k.add(e), a.Z.updateOverlayState(e, s.mM.WAITING_FOR_OVERLAY_OPEN);
    } catch (t) {
...
function el() {
    ...
    for (let t of new Set([...k].filter((t) => !e.has(t)))) eo(t);
    for (let e of k) ei(e);
}
function ec(e) {
...
function eD() {
    x.verbose('Maybe Enable Overlay'), es() ? (eS(E.v.oopEnabled), (0, g.setOutOfProcessSupport)(!0), ev()) : B && eS(!1);
}
function eL(e) {
    let { oopEnabled: t } = e;
    eS(t);
