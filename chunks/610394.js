...
function el(e) {
    ...
    q(t, null != n ? (0, y.rd)(n) : null), t !== w && N.info("OverlayStore: Focused new PID", t);
}
function ec() {
    X();
}
...
class eb extends (r = i.ZP.Store) {
    ...
    getTargetPID() {
        return v.y3 && (L === d.UNSET_PID || null == L) ? d.DEV_PID : null != L ? L : d.UNSET_PID;
    }
    getFocusedPID() {
        return w;
    }
