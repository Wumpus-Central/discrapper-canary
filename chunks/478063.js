...
function E(e) {
    ...
    return (0, i.jsx)("div", {
        ...
        children: (0, i.jsx)(l.n, { className: h.r$, dotRadius: t * p }),
    });
}
function m(e) {
...
let A = {
    ...
    I = function (e) {
        ...
        let { backSrc: n, frontSrc: s, size: l, isTyping: d, status: p, style: E, className: I, ...T } = e,
            ...
            R = ((t = null != p), d ? A[l].typing : t ? A[l].status : A[l].default),
            O = A[l].back;
        return (0, i.jsxs)("div", {
                ...
                (0, i.jsxs)(_.Ay, {
                    ...
                    children: [
                        (0, i.jsx)(_.Ay, {
                            ...
                            height: S,
                            width: S,
                            children: (0, i.jsx)("img", { src: n, alt: "", width: C, height: C }),
                        }),
                        (0, i.jsx)("div", {
                            style: { position: "absolute", top: N, left: N },
                            children: (0, i.jsx)(g, { src: s, size: v, isTyping: d, status: p }),
                        }),
                    ],
                }),
                (0, i.jsx)(m, { statusCoords: y, status: p, isTyping: d }),
            ],
        });
    };
