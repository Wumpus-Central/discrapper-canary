...
function p(e) {
    ...
    return (0, i.jsx)("div", {
        ...
        children: (0, i.jsx)(l.n, { className: h.r$, dotRadius: t * E }),
    });
}
function m(e) {
    ...
    return t
        ? (0, i.jsx)("div", {
              ...
              children: (0, i.jsx)(p, { height: n.height, fillColor: s }),
          })
        : null != r
...
function g(e) {
    let { src: t, size: n } = e;
    return (0, i.jsx)("img", { className: h.tM, src: t, alt: "", width: n, height: n });
}
let A = {
        [u._3.SIZE_16]: {
    ...
    I = function (e) {
        var t;
        let { backSrc: n, frontSrc: s, size: l, isTyping: d, status: E, style: p, className: I, ...T } = e,
            { size: S } = u.vC[l],
            {
                statusCoords: N,
            ...
            R = ((t = null != E), d ? A[l].typing : t ? A[l].status : A[l].default),
            v = A[l].back;
        return (0, i.jsxs)("div", {
                ...
                (0, i.jsxs)(_.Ay, {
                    ...
                    children: [
                        ...
                        (0, i.jsx)("div", {
                            ...
                            children: (0, i.jsx)(g, { src: s, size: y, isTyping: d, status: E }),
                        }),
                    ],
                }),
                (0, i.jsx)(m, { statusCoords: N, status: E, isTyping: d }),
            ],
        });
    };
