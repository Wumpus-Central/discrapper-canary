...
async function p() {
    ...
    let n = await t(),
        { didCrashReporterSeeCrash: r, didCrashOrUncleanExit: a } = h(i.K.get(_, {}), n),
        o = g(r, a, n);
    s.default.track(c.rMx.APP_NATIVE_CRASH, o), i.K.set(_, { lastId: null == n ? void 0 : n.id }), a && setTimeout(async () => await m(), 10000);
}
function h(e, t) {
    var n;
