...
let Y = B.ZP.getEnableHardwareAcceleration(),
    ...
    K = i.memo(function (e) {
        let { channel: t, sectionId: l, userId: a, guildOwnerId: o } = e,
            ...
            x = (0, p.e7)([T.Z, A.Z], () => (C ? A.Z.getStatus() : T.Z.getStatus(a, t.guild_id))),
            v = (0, p.e7)([T.Z], () => T.Z.isMobileOnline(a)),
            O = (0, p.e7)([T.Z, A.Z], () => (C ? A.Z.getActivities() : T.Z.getActivities(a, t.guild_id))),
            M = (0, p.e7)([S.Z], () => S.Z.getAnyStreamForUser(a)),
            k = (0, c.JA)(a),
            ...
            V = i.useCallback(
                (e) => {
                    null != b &&
                        (0, f.jW)(e, async () => {
                            let { default: e } = await Promise.all([n.e('26881'), n.e('70675')]).then(n.bind(n, 654663));
                            return (n) => {
                                var i, l;
                                return (0, r.jsx)(
                                    e,
    ...
    X = i.memo(function (e) {
        ...
        return t === F.Skl.UNKNOWN
            ...
            : (0, r.jsxs)(C.Z, {
                  ...
                  children: [
                      null != a ? (0, r.jsx)(x.Z, W({ className: z.roleIcon }, a)) : null,
                      (0, r.jsxs)('span', {
                          'aria-hidden': !0,
                          children: [n, ' \u2014 ', i]
                      })
        ...
        children: [
            ...
            (0, r.jsxs)('div', {
                ...
                children: [
                    ...
                    (0, r.jsx)(M.Z, { className: V.emptyStateStars })
                ]
            }),
            (0, r.jsx)(h.X6q, {
