...
let z = U.ZP.getEnableHardwareAcceleration(),
    ...
    q = i.memo(function (e) {
        let { channel: t, sectionId: l, userId: a, guildOwnerId: s } = e,
            ...
            _ = (0, h.e7)([T.Z, N.Z], () => (x ? N.Z.getStatus() : T.Z.getStatus(a, t.guild_id))),
            ...
            B = i.useCallback(
                (e) => {
                    null != b &&
                        (0, f.jW)(e, async () => {
                            let { default: e } = await Promise.all([n.e("79695"), n.e("70675"), n.e("10494")]).then(
                                n.bind(n, 654663),
                            );
                            return (n) => {
                                var i, l;
            ...
            W = i.useCallback(() => {
                ...
                let e = "@".concat(M.ZP.getUserTag(b, { decoration: "never" })),
                    n = "<@".concat(b.id, ">");
                k.S.dispatch(H.CkL.TEXTAREA_FOCUS, { channelId: t.id }),
    ...
    K = i.memo(function (e) {
        ...
        return t === H.Skl.UNKNOWN
            ? (0, r.jsx)("div", {
                  ...
                  children: (0, r.jsx)("div", { className: W.memberGroupsPlaceholder }),
              })
            : (0, r.jsxs)(x.Z, {
                  className: W.membersGroup,
                  ...
                  children: [
                      null != a ? (0, r.jsx)(_.Z, V({ className: W.roleIcon }, a)) : null,
                      (0, r.jsxs)("span", {
                          "aria-hidden": !0,
                          children: [n, " \u2014 ", i],
                      }),
