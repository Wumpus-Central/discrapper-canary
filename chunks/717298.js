...
function Q(e) {
    ...
    let eu = !w.ZP.canStreamQuality(w.ZP.StreamQuality.HIGH, es),
        ...
        eS = i.useMemo(() => {
            let e = [
                {
                    name: J.intl.string(J.t.tHoi7u),
                    value: f.vA.WINDOW,
                    icon: h.GON
                },
                {
                    name: J.intl.string(J.t.MhJ43N),
                    value: f.vA.CAMERA,
                    icon: h.Odl
                }
            ];
                            ...
                            children: [
                                ...
                                eg &&
                                    ...
                                    (0, r.jsx)(A.Z, {
                                        ...
                                        align: 'right',
                                        hideOptionsButton: !ej,
                                        ctaText: J.intl.string(X.default['5AyH/v'])
                                    }),
                                (!ej || !(eg || e_)) &&
                                    (0, r.jsx)(W.Z, {
                                        useSimplifiedMenu: eb,
                                        align: 'right'
                                    })
                            ]
                        })
