...
let p = {
    getActiveErrors: () => {
        ...
        let _ = r.Z.getParticipant(t.channelId, (0, i.V9)(t));
        if (null == _) return null;
        let p = (0, u.hj)(n, t.ownerId);
        if (null == p) return null;
        let h = (0, s.Wc)(_);
        return null == h ? null : p.short.frameRate < (0, u.dj)(h.maxFrameRate) || p.long.frameRate < (0, u.dj)(h.maxFrameRate) ? [f({ type: l.u.STREAM_SEND_LOW_FPS }, (0, c.rT)((0, i.V9)(t)))] : null;
    },
