        ...
        : (0, s.jsxs)(eb.D, {
              ...
              children: [
                  null != a.originIconUrl
                      ...
                      : null,
                  null == a.originIconUrl && o?.isThread() ? (0, s.jsx)(nf, { channel: o }) : null,
                  (0, s.jsx)(p.E, {
                      className: nA.PJ,
                      variant: "text-sm/medium",
                      color: "none",
              ...
              "div",
              {
                  ...
                  children: [
                      ...
                      (0, s.jsxs)("div", {
                          ...
                          children: [
                              (0, s.jsx)(nx, {}),
                              (0, s.jsx)(t8.Ay, { message: a, content: g, compact: E }),
                              (0, nn.A)({
                                  channelMessageProps: { message: a, channel: x, compact: E },
                                  hasSpoilerEmbeds: p,
                                  hasBailedAst: A,
                                  isInteracting: !1,
                                  isMessageSnapshot: !0,
                              ...
                              !m && (0, s.jsx)(nE, { message: t, snapshot: n, index: i }),
                          ],
                      }),
                  ],
              },
...
function ig(e) {
    ...
    let P = (0, w.F_)({ avatarDecoration: v, size: (0, n4.Te)(tI._3.SIZE_40), canAnimate: S }),
...
let iG = (e) => {
    let { reportingUserId: t, guildId: n, compact: i, channel: l, messageId: a, reportedTimestamp: d } = e,
        ...
        u = r.useMemo(() => (i ? (0, iR.A)((0, na.i$)(iL()(), "LT")) : null), [i]),
        m = (0, iP.P)({ user: c, channelId: l.id, guildId: n, messageId: a })((0, t_.m2)(c, l)),
        h = null != c ? c.getAvatarURL(n, (0, tI.FT)(tI._3.SIZE_16)) : iU,
        g =
            null != c
                ? J.intl.format(iM.default["+zqXZs"], { username: c.username, onUserClick: m })
                : J.intl.string(iM.default.xpRjfS);
    return (0, s.jsxs)("div", {
        className: o()(iO.NB, iO.JZ, u),
        children: [
            (0, s.jsx)(tf.eu, { src: h, size: tI._3.SIZE_16, className: iD.my, "aria-label": "" }),
            ...
            (0, s.jsxs)(p.E, {
                ...
                children: [
                    ...
                    (0, s.jsx)(ik.A, { timestamp: d, className: iD.vE }),
                ],
            }),
        ],
    });
                                      ...
                                      onClick: () => {
                                          d &&
                                              (function (e) {
                                                  ...
                                                  lf._.dispatchToLastSubscribed(W.jej.OPEN_EXPRESSION_PICKER, {
                                                      activeView: lI.kx.STICKER,
                                                  });
                                                  let i = n.findIndex((e) => e.id === t.id);
                                                  -1 !== i && lE.bM.setActiveCategoryIndex(i);
            ...
            r.useEffect(() => {
                ...
                (async () => {
                    if (null == e || e.features.has(W.GuildFeatures.DISCOVERABLE)) {
                        ...
                        c(
                            await ((e = n.id),
                            lm.Bo.get({ url: W.Rsh.STICKER_GUILD_DATA(e), oldFormErrors: !0, rejectWithError: !0 })
...
var lL = n(76513);
let lk = (0, ln.xI)(i7.A.STICKERS_CONSTANTS_STICKER_DIMENSION),
    lR = (e) => {
                    ...
                    children: (e) => {
                        ...
                        return (0, s.jsx)(i9.m, {
                            ...
                            children: (0, s.jsx)(eb.D, {
                                ...
                                tag: "span",
                                children: (0, s.jsx)(ls.A, { isInteracting: i, size: lk, sticker: u ?? t }),
                            }),
                        });
                    },
                }),
...
let sy = r.memo(function (e) {
    let t,
        ...
        T = (0, sE.vG)({ userId: g, channelId: i, application: N }),
        y = null == A,
        S = (function (e) {
            ...
            return r.useMemo(
                () =>
                    (function (e) {
                        ...
                        if (null != n && n !== sE.Gy.CAN_JOIN) {
                            let e;
                            switch (n) {
                                case sE.Gy.NO_USE_EMBEDDED_ACTIVITIES_PERMISSION:
                                    e = J.intl.string(J.t.hHGrWz);
                                    break;
                                case sE.Gy.ACTIVITY_AGE_GATED:
                                    e = J.intl.string(J.t["4WuFRE"]);
                                    break;
                                case sE.Gy.ACTIVITIES_FEATURE_NOT_ENABLED_FOR_OS:
                                    e = J.intl.string(J.t.uGDCcw);
                                    break;
                                case sE.Gy.ACTIVITY_NOT_SUPPORTED_ON_OS:
                                    e = J.intl.string(J.t.UXoQTp);
                                    break;
                                case sE.Gy.CHANNEL_FULL:
                                    e = J.intl.string(J.t.rZfiNq);
                                    break;
                                case sE.Gy.NO_CHANNEL_CONNECT_PERMISSION:
                                    e = J.intl.string(J.t.w5SAps);
                                    break;
                                case sE.Gy.NO_CHANNEL:
                                case sE.Gy.NO_GUILD:
                                case sE.Gy.NO_USER:
                                case sE.Gy.IS_AFK_CHANNEL:
            ...
            eG.default.track(W.HAw.ACTIVITY_INSTANCE_EMBED_CLICKED, {
                ...
                y
                    ? await (0, sx.A)({
                          ...
                          componentId: b,
                          commandOrigin: sf.iw.ACTIVITY_INSTANCE_EMBED,
                      })
                    : await (0, sA.A)({
...
function s8(e) {
    ...
    return (0, s.jsxs)("div", {
        className: o()(s4.nM, n),
        children: [(0, s.jsx)(tE.t, { size: "md", color: "currentColor", className: s4.Kk }), s5(t)],
    });
}
function re(e) {
    let { sku: t, className: n } = e;
...
let rP = (0, sP.A)((0, sR.A)(rL)),
    rM = u.Ay.connectStores(rk, rR)(rP),
    rD = (0, sR.A)(u.Ay.connectStores(rk, rR)(rL));
var rO = n(576171);
function rU(e) {
...
class rw extends r.Component {
    ...
    renderCustomGiftBox = (e) => {
        ...
        let n = lC.Wx.includes(e.giftStyle),
            i = o()(rO.gB, { [rO.El]: n, [rO.by]: t >= sk.Tm }),
            l = o()({ [rO.gc]: n, [rO.Ei]: n && t >= sk.Tm, [rO.ww]: !n, [rO.wy]: !n && t >= sk.Tm });
        return (0, s.jsxs)("div", {
            className: i,
            children: [
    ...
    render() {
        ...
        if (null == e || e.revoked)
            ...
            else return (0, s.jsx)(sk.Wb, { isHorizontal: i >= sk.Tm });
        return (0, sD.hU)(e)
            ? (0, s.jsx)("div", { className: rO.mp, children: this.renderEmbed() })
            : this.renderEmbed();
    }
}
let rB = (0, sP.A)((0, sR.A)(rw)),
    rV = function (e) {
...
function al(e) {
    ...
    let {
            ...
            ? (function (e, t, n, i) {
                  ...
                  if (n) {
                      let e = D.A.getChannel(t.channel_id),
                          n = e?.isDM() ? sZ.Ay.getName(G.default.getUser(e.getRecipientId())) : void 0;
                      c =
                          null != n
                              ? null != r
    ...
    return (0, s.jsxs)(nT.A, {
        ...
        children: [
            h
                ...
                : (0, s.jsx)(nT.A.Header, { text: C }),
            (0, s.jsxs)(nT.A.Body, {
                children: [
                    (0, s.jsxs)("div", {
                        className: nF.iH,
                        children: [
                            (!h || null != j.icon) && (0, s.jsx)(nT.A.Icon, { channel: j, onClick: g ? A : void 0 }),
                            (0, s.jsx)(nT.A.Info, {
                                title: I,
                                onClick: g ? A : void 0,
                                ...
                                children: h
                                    ? (0, s.jsxs)("div", {
                                          className: nF.er,
                                          children: [
                                              J.intl.format(J.t.zRl6XR, { count: N.length }),
                                              T.length > 0 &&
                                                  (0, s.jsx)(at.A, {
                                                      users: T,
                                                      maxUsers: 3,
                                    ...
                                    : (0, s.jsx)(nT.A.Data, { members: N.length }),
                            }),
                        ],
                    }),
        ...
        : (0, s.jsxs)(ac.s, {
              ...
              children: [
                  (0, s.jsxs)("div", {
                      ...
                      ref: d,
                      children: [
                          (0, s.jsx)(aA.J$, { profile: I, className: aE.vK }),
                          (0, s.jsx)(aA.CG, { profile: I }),
                          (0, s.jsx)(ap.A, { profile: I }),
                          (0, s.jsx)(ah.P, { profile: I, className: aE.rb }),
                          (0, s.jsx)(ax.A, {
                  ...
                  h && !c
                      ...
                      : null,
                  (0, s.jsxs)("div", {
                      className: o()(aE.qr, { [aE.iK]: h }),
                      children: [
                          h && c ? (0, s.jsx)("div", { className: aE.D7 }) : null,
                          (0, s.jsx)("div", {
                              className: o()(aE.z8, { [aE.it]: h && c }),
                              children: (0, s.jsx)("div", {
                                  className: aE.UD,
                                  children: (0, s.jsx)(aI, {
                                      invite: t,
                        ...
                        ? (0, s.jsx)(eg.$, {
                              onClick: function () {
                                  ...
                                  let { id: e } = l,
                                      ...
                                      n = `<@${e}>`;
                                  lf._.dispatchToLastSubscribed(W.jej.INSERT_TEXT, { plainText: t, rawText: n }),
            ...
            (0, s.jsxs)(nT.A.Body, {
                children: [
                    (0, s.jsxs)("div", {
                        className: nF.iH,
                        children: [
                            (0, s.jsx)(nT.A.Icon, { guild: l, onClick: N && f ? j : void 0 }),
                            (0, s.jsx)(nT.A.Info, { title: t, onClick: N && f ? j : void 0, children: k }),
                        ],
                    }),
...
function aO(e) {
    let { invite: t, message: n, channel: i, onTransitionToInviteChannel: l } = e,
        ...
        d = (0, u.bG)([aP.A], () => aP.A.isInChannel(i.id), [i.id]),
        { voiceStates: c } = (0, u.cf)(
            [aM.Ay],
            () => ({ voiceStates: null != i.guild_id ? aM.Ay.getVoiceStatesForChannelAlt(i.id, i.guild_id) : [] }),
            [i],
        ),
        m = r.useMemo(
                            ...
                            (0, s.jsxs)("div", {
                                ...
                                children: [
                                    ...
                                    (0, s.jsx)(aN.u, {
                                        ...
                                        body: "",
                                        assetSize: 24,
                                        asset: null != o ? (0, s.jsx)(ak.Ay, { guild: o, iconSize: 24 }) : void 0,
                                        position: "top",
                                        children: (0, s.jsx)(eb.D, {
                                            className: aD.HA,
                                            onClick: j,
...
function a1(e) {
    let { className: t, guildId: n, channelId: i, members: l, ref: a, motion: d } = e,
        ...
        [x, E] = (0, aY.z)(() => ({ x: 0, y: 0, scale: 1, config: a0 }));
    return (
        r.useEffect(() => {
            E({ x: g, y: p, scale: A });
        }, [g, p, A, E]),
...
function a6(e) {
    ...
    let h = (0, u.bG)([tl.A, D.A], () => {
        ...
        g = (0, u.bG)([aM.Ay], () => (h ? aM.Ay.getVoiceStatesForChannelAlt(m.id, c.id) : []), [m.id, c.id, h]),
        ...
        { analyticsLocations: j } = (0, E.Ay)(x.A.INVITE_EMBED),
    ...
    let k = (0, u.bG)([sp.Ay], () => sp.Ay.useReducedMotion),
        R = r.useRef(null),
                                        ...
                                        children: [
                                            ...
                                            null != f
                                                ? (0, s.jsx)(p.E, {
                                                      variant: "text-sm/normal",
                                                      className: a3.$B,
                                                      children: (0, s.jsx)(lr.A, { delay: 150, children: f }),
                                                  })
                                                : null,
                                        ],
                                    }),
...
let oA = [W.Auw.GIFV],
    ...
    oE = new Set(["discord-developers", "discord-testers", "discord-townhall", "discordgameslab"]),
    of = (e) => () => {
...
class oI extends r.Component {
    ...
    shouldRenderInvite(e) {
        ...
        return !(t.isDM() && !t.isSystemDM() && !t.isGroupDM() && oE.has(e));
    }
                        ...
                        children: (t) => {
                            switch (n.type) {
                                case tM.I.APP_DIRECTORY_PROFILE:
                                    return (0, s.jsx)(nk, { code: a, message: e });
    ...
    renderStickersAccessories(e) {
        ...
        return 0 === t.length
            ? null
            : t.map((e) => (0, s.jsx)(lR, { channel: n, isInteracting: i, renderableSticker: e }, e.id));
    }
