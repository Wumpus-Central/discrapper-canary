...
class S extends a.G {
    constructor() {
        super("discord_protos.premium_marketing.v1.PremiumMarketingComponentProperties", [
            ...
            { no: 7, name: "mobile_bottom_sheet", kind: "message", oneof: "properties", T: () => E.L },
            { no: 8, name: "gift_icon", kind: "message", oneof: "properties", T: () => m.o },
            ...
            switch (t) {
                ...
                case 7:
                    s.properties = {
                        ...
                        mobileBottomSheet: E.L.internalBinaryRead(e, e.uint32(), n, s.properties.mobileBottomSheet),
                    };
                    break;
                case 8:
                    s.properties = {
                        oneofKind: "giftIcon",
                        giftIcon: m.o.internalBinaryRead(e, e.uint32(), n, s.properties.giftIcon),
                    };
                    break;
                case 9:
                    s.properties = {
    ...
    internalBinaryWrite(e, t, n) {
        "placeholder" === e.properties.oneofKind && t.tag(1, r.O0.LengthDelimited).string(e.properties.placeholder),
            ...
            "mobileBottomSheet" === e.properties.oneofKind &&
                E.L.internalBinaryWrite(
                    e.properties.mobileBottomSheet,
                    t.tag(7, r.O0.LengthDelimited).fork(),
                    n,
                ).join(),
            "giftIcon" === e.properties.oneofKind &&
                m.o.internalBinaryWrite(e.properties.giftIcon, t.tag(8, r.O0.LengthDelimited).fork(), n).join(),
