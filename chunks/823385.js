            ...
            .filter((e) => {
                ...
                return (
                    !(
                        ...
                        e === r ||
                        W.includes(e) ||
                        C.ZP.isChannelMuted(t.guild_id, e) ||
                        (null != t.parent_id && C.ZP.isChannelMuted(t.guild_id, t.parent_id))
                    ) && (0, f.d)(t)
                );
            })
            .map((e) => q(e))
...
function Q(e, t) {
    ...
    if (t !== F) (F = t), (H = Math.max(t.length, H)), (U = (0, u.gJ)(u.a8.DOWN, -1, V));
    else {
        let e = V[U];
