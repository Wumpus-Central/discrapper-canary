...
function b(e) {
    let {
        ...
        { combinedSkus: y, combinedSkusToUserAndReason: C } = r.useMemo(() => {
            let e = { ...S };
    ...
    return (
        (0, o.j)({ skuIds: b }),
        { recommendations: A, wishlistAndRecommendations: y, skusToUserAndReason: C, status: N }
    );
}
function D(e) {
    r.useEffect(() => {
...
function L(e) {
    let { userId: t, numItems: n, source: i = v.B5.USER_PROFILE } = e,
        { userIdsAndWishlistIds: s, defaultWishlistId: a } = D(t),
        {
            ...
            status: u,
        } = b({ userIdsAndWishlistIds: s, applicationIds: N(t), numItems: n, source: i }),
