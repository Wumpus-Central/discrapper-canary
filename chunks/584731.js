...
class m extends i.ZP.Store {
    ...
    handleMessageUpdate(e) {
        ...
        let r = this.data(n);
        if ((null == r ? void 0 : r.messageId(i)) !== l) return !1;
        null == r || r.update(e.message);
    }
    ...
    handleLoadMessagesSuccess(e) {
        ...
        if (null == i) return !1;
        (0, r.Z)(e.messages), e.isAfter || e.isBefore || e.hasMoreAfter ? this.data(i.guild_id).putNew(e.channelId, null !== (n = e.messages[0]) && void 0 !== n ? n : null, this.generation) : this.data(i.guild_id).put(e.channelId, null !== (t = e.messages[0]) && void 0 !== t ? t : null, this.generation);
    }
    handleLocalMessagesLoaded(e) {
        let t = s.Z.getBasicChannel(e.channelId);
        if (null != t) {
            var n;
            (0, r.Z)(e.messages), this.data(t.guild_id).putNew(e.channelId, null !== (n = e.messages[0]) && void 0 !== n ? n : null, u);
        }
    }
