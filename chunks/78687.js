...
let g = [
    ...
    },
    {
        ...
        run(e) {
            ...
            let { state: n } = l.ZP.PersistedStore.migrateAndReadStoreState("StickersPersistedStore", [
            ...
            return (
                n.favorites.length > 0 &&
                    ((e.favoriteStickers = a.Lt.create()),
                    (e.favoriteStickers.stickerIds = i().uniq(n.favorites).slice(0, u.oX)),
                    (r = !0)),
                i().size(n.usageHistory) > 0 &&
                    ((e.stickerFrecency = a.ls.create()),
                    (e.stickerFrecency.stickers = (0, c.tU)(n.usageHistory, 100)),
                    (r = !0)),
                r
            );
        },
        ...
        run(e) {
            ...
            return (
                null != t.favorites &&
                    ...
                    ((e.favoriteEmojis = a.ND.create()),
                    (e.favoriteEmojis.emojis = i().uniq(t.favorites).slice(0, u.oX)),
                    (n = !0)),
                i().size(t.usageHistory) > 0 &&
                    ((e.emojiFrecency = a.PL.create()),
                    (e.emojiFrecency.emojis = (0, c.tU)(t.usageHistory, 100)),
                    (n = !0)),
                n
            );
        },
        ...
        run(e) {
            ...
            return (
                i().size(t.usageHistory) > 0 &&
                    ...
                    (e.applicationCommandFrecency.applicationCommands = (0, c.tU)(t.usageHistory, 500)),
                    (n = !0)),
                n
            );
        },
    ...
    },
    {
        ...
        run(e) {
            ...
            return (
                ...
                (e.guildAndChannelFrecency.guildAndChannels = (0, c.tU)(t, 100)),
                !0
            );
        },
        cleanup() {
    ...
    },
    {
        ...
        run(e) {
            ...
            if (i().size(n) > 0) {
                let t = a.PL.create();
                a.PL.mergePartial(t, e.emojiFrecency),
                    null != e.emojiReactionFrecency && a.PL.mergePartial(t, e.emojiReactionFrecency),
