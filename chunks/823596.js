...
class m {
    ...
    updatePaginationToken(e) {
        return (
            ...
            ((this._paginationState = l(o({}, this._paginationState), { continuationToken: e })), !0)
        );
    }
    ...
    updatePaginationState(e) {
        ...
        return (
            (this._paginationState = o({}, this._paginationState, e)),
    ...
    _findMember(e) {
        ...
        for (; null == a && !((e += t) < 0) && !(e >= this._sortedMemberIds.length); )
            (i = this._sortedMemberIds[e]),
                (null == (a = r.ZP.getMember(this.guildId, i)) ? void 0 : a.joinedAt) == null && (a = null);
        return a;
    }
