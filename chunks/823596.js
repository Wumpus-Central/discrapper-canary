...
class h {
    ...
    updatePaginationToken(e) {
        return (
            ...
            ((this._paginationState = l(a({}, this._paginationState), { continuationToken: e })), !0)
        );
    }
    ...
    updatePaginationState(e) {
        ...
        return (
            (this._paginationState = a({}, this._paginationState, e)),
    ...
    _findMember(e) {
        ...
        for (; null == o && !((e += t) < 0) && !(e >= this._sortedMemberIds.length); )
            (i = this._sortedMemberIds[e]),
                (null == (o = r.ZP.getMember(this.guildId, i)) ? void 0 : o.joinedAt) == null && (o = null);
        return o;
    }
