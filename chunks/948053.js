...
let d = {
    ...
    async gravityJoinGuild(e, t) {
        if ((0, o.rK)("gravityJoinGuild") && 0 !== e.length)
            try {
                return (
                    await r.tn.post({
    ...
    async fetchHydrated(e, t, n) {
        ...
        let { contentGenerationEnabled: l } = (0, s.q3)("fetchHydrated", !1),
            { messageItems: u, summaryItems: d, activityItems: p, generatedCandidateItems: f } = n;
        if (0 === u.length && 0 === d.length && 0 === p.length && 0 === f.length)
    ...
    async getMediaForCurrentStatus() {
        if (!(0, o.rK)("mediaForCurrentStatus")) return;
