    ...
    eF = (e) => {
        ...
        return Object.freeze({
            ...
            [ek.s6.PROFILE_CUSTOMIZATION]: {
                ...
                onSettingsClose: () => {
                    o.Z.wait(() => {
                        (0, S.It)(), (0, u.P6)(), m.Z.clearSubsection(eL.oAB.PROFILE_CUSTOMIZATION);
                    });
                },
            ...
            [ek.s6.PRIVACY_AND_SAFETY_GAME_FRIENDS_CATEGORY]: {
                section: eL.oAB.CONTENT_AND_SOCIAL,
                searchableTitles: [ew.intl.string(ew.t.oPyABA)],
                parent: ek.s6.CONTENT_SOCIAL,
                predicate: () => tn
            },
            ...
            [ek.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_CONNECTION_REPLAY]: {
                ...
                parent: ek.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
                predicate: () => ('canary' === H.ZP.releaseChannel || 'development' === H.ZP.releaseChannel) && eX && M.Z.supports(eM.AN.CONNECTION_REPLAY)
            },
            ...
            [ek.s6.ACTIVITY_PRIVACY]: {
                ...
                searchableTitles: ts ? [ew.intl.string(ew.t['6x5uWV'])] : [ew.intl.string(ew.t.Cq98yM)],
                label: ts ? ew.intl.string(ew.t['6x5uWV']) : ew.intl.string(ew.t.Cq98yM),
                ariaLabel: ts ? ew.intl.string(ew.t['6x5uWV']) : ew.intl.string(ew.t.Cq98yM),
                element: et.Z,
                predicate: () => !eK
            },
            [ek.s6.ACTIVITY_PRIVACY_STATUS]: {
                section: eK ? eL.oAB.GAMES : eL.oAB.ACTIVITY_PRIVACY,
                searchableTitles: [ew.intl.string(ew.t['8ka8lp'])],
                parent: eK ? ek.s6.GAMES_ACTIVITY_PRIVACY : ek.s6.ACTIVITY_PRIVACY
            },
                ...
                onClick: () => {
                    ...
                    V.default.track(eL.rMx.USER_SETTINGS_MERCH_LINK_CLICKED),
                        (0, G.q)({
                            ...
                            shouldConfirm: !0,
                            onConfirm: () => {
                                V.default.track(eL.rMx.USER_SETTINGS_MERCH_LINK_CONFIRMED), (0, x.Z)(e);
                            }
                        });
                },
            ...
            [ek.s6.VIRTUAL_CURRENCY_CONFIGURATION]: {
                section: eL.oAB.VIRTUAL_CURRENCY_CONFIGURATION_PAGE,
            ...
            [ek.s6.DESIGN_SYSTEMS]: {
                ...
                element: ec.Z,
                predicate: () => L.Z.isDeveloper,
                url: eL.Z5c.SETTINGS('design-systems')
            },
            ...
            [ek.s6.NAMEPLATES_PREVIEW_TOOL]: {
                section: eL.oAB.NAMEPLATES_PREVIEW_TOOL,
