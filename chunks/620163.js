...
let e0 = () => {
    ...
    e2 = () => {
        ...
        return (
            ...
            S.J.getCurrentConfig({ location: "SettingsRendererConfig" }).enabled &&
    ...
    e8 = (e) => {
        let {
            ...
            isClipsBetaTagShowing: eX = !1,
            shouldMergeGameSettings: eJ,
            isKeywordFilteringEnabled: e8,
            isStaff: e5,
        ...
        return Object.freeze({
            ...
            [eZ.s6.PROFILE_CUSTOMIZATION]: {
                ...
                onSettingsClose: () => {
                    l.Z.wait(() => {
                        (0, A.It)(), (0, u.P6)(), d.Z.clearSubsection(eV.oAB.PROFILE_CUSTOMIZATION);
                    });
                },
            ...
            [eZ.s6.SESSIONS]: {
                ...
                impressionProperties: { source: null == T ? void 0 : T.source },
            },
            [eZ.s6.CONNECTIONS]: {
            ...
            [eZ.s6.VOICE_AND_VIDEO_VIDEO_CAMERA]: {
                ...
                predicate: () => F.Z.supports(eY.AN.VIDEO),
            },
            ...
            [eZ.s6.VOICE_AND_VIDEO_ADVANCED_CODECS_VIDEO_OPENH264]: {
                ...
                predicate: () => F.Z.supports(eY.AN.OPEN_H264),
            },
            ...
            [eZ.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_CONNECTION_REPLAY]: {
                ...
                predicate: () =>
                    ...
                    e5 &&
                    F.Z.supports(eY.AN.CONNECTION_REPLAY),
            },
            [eZ.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_LOGGING]: {
                ...
                parent: eZ.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
                predicate: () =>
                    K.isPlatformEmbedded && F.Z.supports(eY.AN.DEBUG_LOGGING) && null != _.Z.fileManager.readLogFiles,
            },
            ...
            [eZ.s6.ACTIVITY_PRIVACY_STATUS]: {
                section: eJ ? eV.oAB.GAMES : eV.oAB.ACTIVITY_PRIVACY,
                searchableTitles: [eW.intl.string(eW.t["8ka8lp"])],
                parent: eJ ? eZ.s6.GAMES_ACTIVITY_PRIVACY : eZ.s6.ACTIVITY_PRIVACY,
            },
            ...
            [eZ.s6.MERCHANDISE]: {
                ...
                onClick: () => {
                    ...
                    H.default.track(eV.rMx.USER_SETTINGS_MERCH_LINK_CLICKED),
                        (0, W.q)({
                            href: e,
                            shouldConfirm: !0,
                            onConfirm: () => {
                                H.default.track(eV.rMx.USER_SETTINGS_MERCH_LINK_CONFIRMED), (0, p.Z)(e);
                            },
                        });
                },
            ...
            [eZ.s6.DEVELOPER_OPTIONS_LAYOUT_DEBUGGING_OPTIONS]: {
                ...
                searchableTitles: ["Layout Debugging"],
                parent: eZ.s6.DEVELOPER_OPTIONS_DESIGN_TOOLS_TAB,
                predicate: () => e5 && B.Z.isDeveloper && Z.default.layoutDebuggingEnabled,
            },
            ...
            [eZ.s6.QUEST_PREVIEW_TOOL]: {
                ...
                element: j.Z,
                predicate: () => (0, x.X)({ location: eH.dr.QUEST_PREVIEW_TOOL }),
            },
            [eZ.s6.QUEST_PREVIEW_TOOL_2]: {
                ...
                element: () => (0, r.jsx)(M.Z, { questId: null == T ? void 0 : T.quest_id }),
                predicate: () => (0, x.T)({ location: eH.dr.QUEST_PREVIEW_TOOL_2 }),
            },
            ...
            [eZ.s6.WEB_SETTING_TREE_TOOL]: {
                section: eV.oAB.WEB_SETTING_TREE_TOOL,
