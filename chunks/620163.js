    ...
    eG = (e) => {
        ...
        return Object.freeze({
            ...
            [eZ.s6.PROFILE_CUSTOMIZATION]: {
                ...
                onSettingsClose: () => {
                    o.Z.wait(() => {
                        (0, I.It)(), (0, u.P6)(), m.Z.clearSubsection(ek.oAB.PROFILE_CUSTOMIZATION);
                    });
                }
            },
            ...
            [eZ.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_LOGGING]: {
                ...
                parent: eZ.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
                predicate: () => F.isPlatformEmbedded && M.Z.supports(eB.AN.DEBUG_LOGGING) && null != h.Z.fileManager.readLogFiles
            },
            ...
            [eZ.s6.ACTIVITY_PRIVACY_STATUS]: {
                section: eW ? ek.oAB.GAMES : ek.oAB.ACTIVITY_PRIVACY,
            ...
            [eZ.s6.MERCHANDISE]: {
                ...
                onClick: () => {
                    ...
                    V.default.track(ek.rMx.USER_SETTINGS_MERCH_LINK_CLICKED),
                        (0, G.q)({
                            href: e,
                            shouldConfirm: !0,
                            onConfirm: () => {
                                V.default.track(ek.rMx.USER_SETTINGS_MERCH_LINK_CONFIRMED), (0, x.Z)(e);
                            }
                        });
                },
            ...
            [eZ.s6.DEVELOPER_OPTIONS_LAYOUT_DEBUGGING_OPTIONS]: {
                ...
                searchableTitles: ['Layout Debugging'],
                parent: eZ.s6.DEVELOPER_OPTIONS_FLAGS,
                predicate: () => eq && L.Z.isDeveloper && B.default.layoutDebuggingEnabled
            },
            ...
            [eZ.s6.QUEST_PREVIEW_TOOL]: {
                ...
                element: Z.Z,
                predicate: () => (0, y.X7)({ location: eL.dr.QUEST_PREVIEW_TOOL })
            },
