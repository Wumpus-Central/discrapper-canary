...
let e$ = () => {
    ...
    e0 = () => {
        let e = e$(),
            [t] = (0, N.US)(e);
        return t === s.z.CLIENT_THEMES_SETTINGS_BADGE || t === s.z.DEKSTOP_CUSTOM_APP_ICON_BADGE ? (0, i.jsx)(a.lBU, { text: eq.intl.string(eq.t.y2b7CA) }) : t === s.z.CLIENT_THEMES_APPEARANCE_SETTINGS_NEW_BADGE ? (0, i.jsx)(a.IGR, { text: eq.intl.string(eq.t.y2b7CA) }) : null;
    },
    e1 = () => {
        let e = [];
        return G.c.getCurrentConfig({ location: 'SettingsRendererConfig' }).enabled && e.push(s.z.RECENT_AVATARS_SETTINGS_MENU_NEW_BADGE), e.push(s.z.NAMEPLATE_USER_SETTINGS_MENU_NEW_BADGE), e;
    },
    e3 = () => {
        let e = e1(),
            [t] = (0, N.US)(e);
    ...
    e8 = eZ.Z,
    e6 = (e) => {
        let { unseenGiftCount: t, showPrepaidPaymentPastDueWarning: j, impressionSource: N, numOfPendingFamilyRequests: D, isOverlaySupported: G, isClipsBetaTagShowing: e6 = !1, shouldMergeGameSettings: e2, isKeywordFilteringEnabled: e5, isStaff: e4, isInappropriateConversationWarningEnabled: e7, isInapproprateConversationsDefaultOn: e9, paymentsBlocked: te, isEligibleForQuests: tt, isStricterMessageRequestsEnabled: tn, hasLibraryApplication: ti, hasTOTPEnabled: tr, developerMode: ts, isAdultUser: tl, hasSecureFramesVerifiedUserIds: ta, hypeSquadRemoved: to, hasIgnoredUsers: tc, hasBlockedUsers: td, useRefreshedVoiceAndVideo: tu, isEligibleForSensitiveContentDefaults: tm, inputMode: tg, activeInputProfile: tp, isInputProfileCustom: th, isGoreContentFilteringEnabled: tf } = e;
        return Object.freeze({
            ...
            [eH.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_CONNECTION_REPLAY]: {
                ...
                parent: eH.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
                predicate: () => ('canary' === J.ZP.releaseChannel || 'development' === J.ZP.releaseChannel) && e4 && Y.Z.supports(eK.AN.CONNECTION_REPLAY)
            },
            ...
            [eH.s6.DEVELOPER_OPTIONS_LAYOUT_DEBUGGING_OPTIONS]: {
                ...
                searchableTitles: ['Layout Debugging'],
                parent: eH.s6.DEVELOPER_OPTIONS_DESIGN_TOOLS_TAB,
                predicate: () => e4 && H.Z.isDeveloper && z.default.layoutDebuggingEnabled
            },
