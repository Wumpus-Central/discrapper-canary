...
let eX = () => [s.z.CLIENT_THEMES_SETTINGS_BADGE, s.z.DEKSTOP_CUSTOM_APP_ICON_BADGE],
    ...
    e$ = eR.Z,
    e0 = (e) => {
        let { unseenGiftCount: t, showPrepaidPaymentPastDueWarning: T, impressionSource: A, numOfPendingFamilyRequests: R, isOverlaySupported: V, isClipsBetaTagShowing: e0 = !1, shouldMergeGameSettings: e1, isKeywordFilteringEnabled: e3, isStaff: e8, isInappropriateConversationWarningEnabled: e6, isInapproprateConversationsDefaultOn: e2, paymentsBlocked: e5, isEligibleForQuests: e4, showGiftNitro: e7, isStricterMessageRequestsEnabled: e9, hasLibraryApplication: te, hasTOTPEnabled: tt, developerMode: tn, isAdultUser: ti, hasSecureFramesVerifiedUserIds: tr, hypeSquadRemoved: ts, hasIgnoredUsers: tl, hasBlockedUsers: ta, useRefreshedVoiceAndVideo: to, isEligibleForSensitiveContentDefaults: tc } = e;
        return Object.freeze({
            ...
            [eV.s6.PRIVACY_FAMILY_CENTER]: {
                ...
                searchableTitles: [eW.intl.string(eK.default.gntCQU)],
                label: eW.intl.string(eK.default.gntCQU),
                ariaLabel: eW.intl.string(eK.default.gntCQU),
                element: eb.Z,
                badgeCount: R,
            ...
            [eV.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_CONNECTION_REPLAY]: {
                ...
                parent: eV.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
                predicate: () => ('canary' === Q.ZP.releaseChannel || 'development' === Q.ZP.releaseChannel) && e8 && z.Z.supports(ez.AN.CONNECTION_REPLAY)
            },
            [eV.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_LOGGING]: {
                section: eF.oAB.VOICE,
                searchableTitles: [eW.intl.string(eW.t['726JHB'])],
                parent: eV.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
                predicate: () => X.isPlatformEmbedded && z.Z.supports(ez.AN.DEBUG_LOGGING) && null != g.Z.fileManager.readLogFiles
            },
            ...
            [eV.s6.CLICKER_GAME]: {
                ...
                searchableTitles: [eW.intl.string(eY.default['7qZdOz'])],
                label: eW.intl.string(eY.default['7qZdOz']),
                ariaLabel: eW.intl.string(eY.default['7qZdOz']),
                element: E.Z,
            ...
            [eV.s6.MERCHANDISE]: {
                ...
                onClick: () => {
                    ...
                    Y.default.track(eF.rMx.USER_SETTINGS_MERCH_LINK_CLICKED),
                        (0, q.q)({
                            href: e,
                            shouldConfirm: !0,
                            onConfirm: () => {
                                Y.default.track(eF.rMx.USER_SETTINGS_MERCH_LINK_CONFIRMED), (0, h.Z)(e);
                            }
                        });
                },
            ...
            [eV.s6.DEVELOPER_OPTIONS_LAYOUT_DEBUGGING_OPTIONS]: {
                ...
                searchableTitles: ['Layout Debugging'],
                parent: eV.s6.DEVELOPER_OPTIONS_FLAGS,
                predicate: () => e8 && F.Z.isDeveloper && H.default.layoutDebuggingEnabled
            },
