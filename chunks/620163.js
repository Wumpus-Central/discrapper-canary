    ...
    eV = (e) => {
        ...
        return Object.freeze({
            ...
            [eD.s6.PROFILE_CUSTOMIZATION]: {
                ...
                onSettingsClose: () => {
                    o.Z.wait(() => {
                        (0, b.It)(), (0, u.P6)(), m.Z.clearSubsection(eZ.oAB.PROFILE_CUSTOMIZATION);
                    });
                }
            },
            ...
            [eD.s6.SESSIONS]: {
                ...
                predicate: () => H.Z.getCurrentConfig({ location: '9f7d84_1' }, { autoTrackExposure: !1 }).showSettings
            },
            [eD.s6.CONNECTIONS]: {
            ...
            [eD.s6.APPEARANCE_TIMESTAMP_HOUR_CYCLE]: {
                ...
                parent: eD.s6.APPEARANCE,
                predicate: () => D.Z.getCurrentConfig({ location: 'SettingsRendererConfig' }, { autoTrackExposure: !1 }).enable24HourPref
            },
            [eD.s6.ACCESSIBILITY]: {
            ...
            [eD.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_CONNECTION_REPLAY]: {
                ...
                parent: eD.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
                predicate: () => ('canary' === G.ZP.releaseChannel || 'development' === G.ZP.releaseChannel) && eQ && M.Z.supports(eM.AN.CONNECTION_REPLAY)
            },
            [eD.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_LOGGING]: {
                section: eZ.oAB.VOICE,
                searchableTitles: [ek.intl.string(ek.t['726JHB'])],
                parent: eD.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
                predicate: () => V.isPlatformEmbedded && M.Z.supports(eM.AN.DEBUG_LOGGING) && null != h.Z.fileManager.readLogFiles
            },
                ...
                onClick: () => {
                    ...
                    w.default.track(eZ.rMx.USER_SETTINGS_MERCH_LINK_CLICKED),
                        (0, F.q)({
                            ...
                            shouldConfirm: !0,
                            onConfirm: () => {
                                w.default.track(eZ.rMx.USER_SETTINGS_MERCH_LINK_CONFIRMED), (0, p.Z)(e);
                            }
                        });
                },
            ...
            [eD.s6.TEXT_PLAYGROUND]: {
                ...
                element: eI.Z,
                predicate: () => (0, J.D)() || Z.Z.isDeveloper
            },
            ...
            [eD.s6.DESIGN_SYSTEMS_COMPONENTS]: {
                section: eZ.oAB.DESIGN_SYSTEMS,
