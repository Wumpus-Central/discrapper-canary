...
let eJ = () => [s.z.CLIENT_THEMES_SETTINGS_BADGE, s.z.DEKSTOP_CUSTOM_APP_ICON_BADGE],
    ...
    e0 = () => {
        let e = e$(),
            [t] = (0, T.US)(e);
        return t === s.z.NAMEPLATE_USER_SETTINGS_MENU_NEW_BADGE ? (0, i.jsx)(D.Z, {}) : t === s.z.RECENT_AVATARS_SETTINGS_MENU_NEW_BADGE ? (0, i.jsx)(a.IGR, { text: eK.intl.string(eK.t.y2b7CA) }) : null;
    },
    e1 = eZ.Z,
    e3 = (e) => {
        let { unseenGiftCount: t, showPrepaidPaymentPastDueWarning: T, impressionSource: P, numOfPendingFamilyRequests: D, isOverlaySupported: F, isClipsBetaTagShowing: e3 = !1, shouldMergeGameSettings: e8, isKeywordFilteringEnabled: e2, isStaff: e6, isInappropriateConversationWarningEnabled: e5, isInapproprateConversationsDefaultOn: e4, paymentsBlocked: e7, isEligibleForQuests: e9, showGiftNitro: te, isStricterMessageRequestsEnabled: tt, hasLibraryApplication: tn, hasTOTPEnabled: ti, developerMode: tr, isAdultUser: ts, hasSecureFramesVerifiedUserIds: tl, hypeSquadRemoved: ta, hasIgnoredUsers: to, hasBlockedUsers: tc, useRefreshedVoiceAndVideo: td, isEligibleForSensitiveContentDefaults: tu } = e;
        return Object.freeze({
            ...
            [eF.s6.PROFILE_CUSTOMIZATION]: {
                ...
                onSettingsClose: () => {
                    o.Z.wait(() => {
                        (0, N.It)(), (0, u.P6)(), m.Z.clearSubsection(ez.oAB.PROFILE_CUSTOMIZATION);
                    });
                },
            ...
            [eF.s6.VOICE_AND_VIDEO_SENSITIVITY]: {
                ...
                parent: eF.s6.VOICE_AND_VIDEO_VOICE,
                predicate: () => Y.Z.getMode() === eY.pM.VOICE_ACTIVITY
            },
            ...
            [eF.s6.VOICE_AND_VIDEO_VIDEO_CAMERA]: {
                ...
                predicate: () => Y.Z.supports(eY.AN.VIDEO)
            },
            ...
            [eF.s6.VOICE_AND_VIDEO_ADVANCED_CODECS_VIDEO_OPENH264]: {
                ...
                predicate: () => Y.Z.supports(eY.AN.OPEN_H264)
            },
            ...
            [eF.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_LOGGING]: {
                ...
                parent: eF.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
                predicate: () => J.isPlatformEmbedded && Y.Z.supports(eY.AN.DEBUG_LOGGING) && null != p.Z.fileManager.readLogFiles
            },
            ...
            [eF.s6.MERCHANDISE]: {
                ...
                onClick: () => {
                    ...
                    q.default.track(ez.rMx.USER_SETTINGS_MERCH_LINK_CLICKED),
                        (0, Q.q)({
                            href: e,
                            shouldConfirm: !0,
                            onConfirm: () => {
                                q.default.track(ez.rMx.USER_SETTINGS_MERCH_LINK_CONFIRMED), (0, h.Z)(e);
                            }
                        });
                },
            ...
            [eF.s6.QUEST_PREVIEW_TOOL]: {
                ...
                element: G.Z,
                predicate: () => (0, U.X7)({ location: eW.dr.QUEST_PREVIEW_TOOL })
            },
