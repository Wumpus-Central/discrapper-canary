...
async function c(e) {
    var t;
    try {
        if (null == (t = null == e ? void 0 : e.contentDocument) ? void 0 : t.body)
            return await E(e.contentDocument.body, {}, !0);
    } catch (e) {}
    return e.cloneNode(!1);
}
async function u(e, t) {
    return (0, i.oY)(e, HTMLCanvasElement)
        ? s(e)
        : (0, i.oY)(e, HTMLVideoElement)
          ? l(e, t)
          : (0, i.oY)(e, HTMLIFrameElement)
            ? c(e)
            : e.cloneNode(!1);
}
...
async function f(e, t, n) {
    ...
    return (
        0 ===
            (a =
                d(e) && e.assignedNodes
                    ? (0, i.qo)(e.assignedNodes())
                    : (0, i.oY)(e, HTMLIFrameElement) && (null == (r = e.contentDocument) ? void 0 : r.body)
                      ? (0, i.qo)(e.contentDocument.body.childNodes)
                      : (0, i.qo)((null != (o = e.shadowRoot) ? o : e).childNodes)).length ||
            (0, i.oY)(e, HTMLVideoElement) ||
            (await a.reduce(
                (e, r) =>
                    e
...
function _(e, t) {
    ...
    r.cssText
        ...
        : (0, i.qo)(r).forEach((o) => {
              ...
              (0, i.oY)(e, HTMLIFrameElement) && "display" === o && "inline" === a && (a = "block"),
                  "d" === o && t.getAttribute("d") && (a = `path(${t.getAttribute("d")})`),
                  n.setProperty(o, a, r.getPropertyPriority(o));
          });
}
function p(e, t) {
    (0, i.oY)(e, HTMLTextAreaElement) && (t.innerHTML = e.value),
        (0, i.oY)(e, HTMLInputElement) && t.setAttribute("value", e.value);
}
function h(e, t) {
