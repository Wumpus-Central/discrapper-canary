            ...
            (o =
                d(e) && e.assignedNodes
                    ...
                    : (0, i.oY)(e, HTMLIFrameElement) && (null == (r = e.contentDocument) ? void 0 : r.body)
                      ...
                      : (0, i.qo)((null != (a = e.shadowRoot) ? a : e).childNodes)).length ||
            (0, i.oY)(e, HTMLVideoElement) ||
            (await o.reduce(
                (e, r) =>
                    e
...
function _(e, t) {
    ...
    r.cssText
        ...
        : (0, i.qo)(r).forEach((a) => {
              ...
              (0, i.oY)(e, HTMLIFrameElement) && "display" === a && "inline" === o && (o = "block"),
                  "d" === a && t.getAttribute("d") && (o = `path(${t.getAttribute("d")})`),
                  n.setProperty(a, o, r.getPropertyPriority(a));
          });
}
function p(e, t) {
