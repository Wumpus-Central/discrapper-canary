...
function e$(e) {
    ...
    let m = (0, s.bG)([a.default, eI.A, eE.A, eU.A, D.A, ef.Ay, eH.A, eV.A, eP.A, eS.A, eO.Ay, eY.A], () => {
...
function t6(e) {
    let { currentUser: t, activity: n, currentGameName: l, activeTab: u, onTabChange: d } = e,
        ...
        } = (0, s.cf)([tp.A, eA.Ay, eI.A, eH.A, t$.A, a.default], () => {
...
function nW(e) {
    let t,
        ...
        A = (0, J.Ay)(n, !1) ?? "???",
        f = nX(n),
        S = (0, s.bG)([t$.A, a.default, D.A, nF.A], () => {
            if (null == n) return null;
            switch (
                (function (e, t) {
                    let [n, l, i, r] = t;
