...
let e9 = s.memo(function (e) {
    let { channel: t } = e,
        ...
        d = (0, o.bG)([e6.A], () => e6.A.can(e1.xBc.MANAGE_MESSAGES, t)),
        h = e7.gs.useSetting(),
        { content: A } = s.useMemo(
            () =>
    ...
    if (a)
        ...
        if (null != r && c)
            ...
            let { contentPlaceholder: e, renderedContent: t } = (0, e$.o)(r, A, c, u, i()(e3.BK, e8.tZ), {
                leadingIconClass: e3.AF,
                trailingIconClass: e3.AF,
                iconSize: e2.eJ,
            });
            m =
                null != t
                    ? (0, l.jsx)(g.E, { variant: "text-sm/normal", color: "text-muted", className: e3.BK, children: t })
                    : (0, l.jsx)(g.E, {
                          tag: "span",
                          variant: "text-sm/normal",
                          color: "text-muted",
    ...
    return (0, l.jsx)(e0.Bs.Provider, {
        value: (0, eJ.A)(h, d),
        children: (0, l.jsx)(eX.M, { className: e3.JY, children: m }),
    });
});
var e4 = n(852265);
let e5 = (e) => {
    ...
    return (0, l.jsx)(eG, {
        ...
        onClick: (e) => {
            e.stopPropagation(),
                ...
                eo.default.track(e1.HAw.MESSAGE_REQUEST_PREVIEW_VIEWED, {
                    is_spam: !1,
                    channel_id: s.id,
                    other_user_id: a.id,
                }),
                setTimeout(() => {
                    eI._.dispatch(e1.jej.FOCUS_CHANNEL_TEXT_AREA, { channelId: s.id });
                }, 0);
        },
...
function th() {
    ...
    (0, _.Ay)(() => {
        eo.default.track(e1.HAw.SPAM_MESSAGE_REQUESTS_VIEWED, { num_spam_message_requests: d }),
...
let tj = (0, b.A)(function (e) {
    ...
    (0, _.Ay)(() => {
        C.I(e1.BVt.MESSAGE_REQUESTS),
            ...
            eo.default.track(e1.HAw.MESSAGE_REQUESTS_VIEWED, { num_message_requests: n }),
