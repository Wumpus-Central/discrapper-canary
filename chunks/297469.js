...
function O() {
    ...
    if (
        ...
        delete y[e], null != N[n] && N[n].delete(e);
        return;
    }
    return (y[e]++, null == N[n] && (N[n] = new Set()), S.Ay.isFavorite(n, e))
        ? void N[n].delete(e)
        : (null == C[n] || !C[n].has(e)) && y[e] > 50
          ? (N[n].add(e), !0)
          : void 0;
}
class R extends f.Ay.PersistedStore {
    ...
    initialize(e) {
        if ((this.waitFor(I.A, T.A, S.Ay), this.syncWith([T.A], O), null == e)) return;
...
let v = new R(E.h, {
    ...
    b = new Set();
class L extends f.Ay.PersistedStore {
...
class eu {
    ...
    constructor(e, t, n) {
        (this.id = e),
            ...
            (this.optInEnabled = (0, D.WW)(this.id)),
            (this.hideResourceChannels = (0, d.K)(this.id)),
            (this.favoriteChannelIds = new Set(S.Ay.getGuildFavorites(this.id) ?? [])),
            (this.suggestedFavoriteChannelId = v.getSuggestedChannelId(this.id)),
            (this.collapsedCategoryIds = G.A.getCollapsedCategories());
        const i = I.A.getMutableGuildChannelsForGuild(this.id),
            s = F.A.getGuild(this.id);
        (this.moderatorReportChannelId = null != s ? (0, P.A)(s) : null),
            (this.moderatorReportChannelEnabled = null != s && (0, M.A)(s));
        const o = {},
            l = [],
            u = {};
        for (const e in i) {
        ...
        (this.recentsSectionNumber = er),
            ...
            (this.recentsCategory = A.get("enable_recently_active")
                ...
                : new ef(this, c, f)),
            (this.voiceChannelsCategory = new eE(this, _, o, f)),
            (this.guildActionSection = new em(t, h.length > 0)),
            (this.channelNoticeSection = new ep(n)),
...
class eh extends ec {
    constructor(e, t) {
        super(e),
            (this.channels = a()(S.Ay.getGuildFavorites(e.id) ?? [])
                ...
                .keyBy((e) => e.id)
                .value());
        const n = v.getSuggestedChannelId(e.id),
            i = I.A.getChannel(n);
        null != i &&
            null != n &&
    ...
    updateChannel(e, t) {
        let n = e.id in this.channels && S.Ay.isFavorite(e.guild_id, e.id),
            i = v.getSuggestedChannelId(e.guild_id);
...
class eg {
    ...
    get isCollapsed() {
        return V.A.isCollapsed(this.id);
    }
...
class eA extends eg {
    computeState(e) {
        ...
        if (ey(o, this.record)) return { renderLevel: 1, threadIds: [] };
...
class eS extends eA {
    getRenderLevel(e) {
        ...
        return !B.A.can(Q.xB.VIEW_CHANNEL, this.record) || 4 === e || 3 === e || ey(t, this.record)
            ? 1
            : this.category.isCollapsed
...
let ev = new Set(Object.values(q.n));
