...
let J = "placeholder-channel-id",
    ...
    ea = 4,
    es = 5,
    el = new Set([String(Z.n.GUILD_DIRECTORY)]);
class eo {
    guilds = {};
...
class ed {
    ...
    constructor(e, t, n) {
        ...
        for (const e in i) {
            const t = i[e];
            if (t.type !== q.rbe.GUILD_CATEGORY) {
    ...
    getSectionRowsFromChannel(e) {
        let t = (function (e) {
            ...
            let t = m.A.getChannel(e);
            return t?.isDirectory() ? Z.n.GUILD_DIRECTORY : null;
        })(e);
...
class ef {
    guildActionRows;
    constructor(e, t) {
        (this.guildActionRows = e.map(String)), t && this.guildActionRows.push(String(Z.n.GUILD_DIRECTORY));
    }
    isEmpty() {
...
let eD = new Set(Object.values(Z.n));
