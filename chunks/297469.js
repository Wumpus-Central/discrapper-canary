...
function R() {
    ...
    if (
        ...
        delete O[e], null != N[n] && N[n].delete(e);
        return;
    }
    return (O[e]++, null == N[n] && (N[n] = new Set()), S.Ay.isFavorite(n, e))
        ? void N[n].delete(e)
        : (null == C[n] || !C[n].has(e)) && O[e] > 50
          ? (N[n].add(e), !0)
          : void 0;
}
class L extends A.Ay.PersistedStore {
    ...
    initialize(e) {
        if ((this.waitFor(m.A, g.A, S.Ay), this.syncWith([g.A], R), null == e)) return;
...
class eT extends ep {
    computeState(e) {
        ...
        if (eO(l, this.record)) return { renderLevel: 1, threadIds: [] };
    ...
    computeState(e) {
        ...
        return B.A.can(Q.xB.VIEW_CHANNEL, this.record)
            ? eL(this.category.guild, this.record, e)
                ? { renderLevel: eR(this, e) ? 4 : 3, threadIds: eC(this.record, i[this.id] ?? {}, t, n, !1) }
...
class eS extends eT {
    getRenderLevel(e) {
        ...
        return !B.A.can(Q.xB.VIEW_CHANNEL, this.record) || 4 === e || 3 === e || eO(t, this.record)
            ? 1
            : this.category.isCollapsed
