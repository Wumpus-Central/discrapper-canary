...
class N extends C.Ay.PersistedStore {
    static displayName = "FavoritesSuggestionStore";
    static persistKey = "FavoritesSuggestionStore";
    initialize(e) {
        if ((this.waitFor(S.A, E.Ay, _.Ay), this.syncWith([E.Ay], R), null == e)) return;
...
let L = new N(p.h, {
    ...
    b = new Set();
class G extends C.Ay.PersistedStore {
    ...
    getGuild(e, t, n) {
        return (
            (!(e in this.guilds) ||
                ...
                (this.guilds[e] = new eh(e, t, n)),
            this.guilds[e]
        );
    }
    getGuildChannelRowsOnly(e) {
        return e in this.guilds || (this.guilds[e] = new eh(e, [], [])), this.guilds[e];
    }
    clear() {
        this.guilds = {};
    }
...
class eh {
    ...
    constructor(e, t, n) {
        ...
        for (const e in ((this.categories = {}), h)) this.categories[e] = new ec(this, a[e], h[e], C);
    ...
    getSectionRowsFromChannel(e) {
        ...
        let d = this.getCategory(i),
            h = d instanceof eu ? el : this.getSortedNamedCategories().indexOf(d) + er,
        ...
        return this.id !== a.moderatorReportChannelId || a.moderatorReportChannelEnabled
            ? a.optInEnabled && a.hideResourceChannels && this.record.hasFlag(Z.lx.IS_GUILD_RESOURCE_CHANNEL)
                ...
                : !a.optInEnabled || a.optedInChannels.has(this.id) || (null != l && a.optedInChannels.has(l))
                  ? d || h || !r().isEmpty(c) || Y.Ay.getMentionCount(this.id) > 0
...
class eE extends eA {
    computeState(e) {
        let { selectedChannel: t, selectedVoiceChannelId: n, activeJoinedRelevantThreads: i } = e;
        return H.A.can($.xB.VIEW_CHANNEL, this.record)
            ? eN(this.category.guild, this.record, e)
                ? { renderLevel: eR(this, e) ? 4 : 3, threadIds: ew(this.record, i[this.id] ?? {}, t, n, !1) }
