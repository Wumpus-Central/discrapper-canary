...
class R extends C.Ay.PersistedStore {
    ...
    initialize(e) {
        if ((this.waitFor(S.A, v.Ay, E.Ay), this.syncWith([v.Ay], N), null == e)) return;
...
class eo {
    ...
    get initializationData() {
        return {
            selectedChannel: S.A.getChannel(v.Ay.getChannelId()),
            selectedVoiceChannelId: v.Ay.getVoiceChannelId(),
        ...
        return this.id !== a.moderatorReportChannelId || a.moderatorReportChannelEnabled
            ? a.optInEnabled && a.hideResourceChannels && this.record.hasFlag(Z.lx.IS_GUILD_RESOURCE_CHANNEL)
                ...
                : !a.optInEnabled || a.optedInChannels.has(this.id) || (null != l && a.optedInChannels.has(l))
                  ? d || o || !r().isEmpty(c) || H.Ay.getMentionCount(this.id) > 0
                      ...
                      : a.hideMutedChannels && a.mutedChannelIds.has(this.id)
                        ...
                        : this.category.isCollapsed &&
                            (a.mutedChannelIds.has(this.id) ||
                                ...
                                ((0, F.ig)(this.record.type) && !H.Ay.hasUnread(this.record.id)))
...
class eE extends ef {
    getRenderLevel(e) {
        ...
        return !j.A.can($.xB.VIEW_CHANNEL, this.record) || 4 === e || 3 === e || ew(t, this.record)
            ? 1
            : this.category.isCollapsed
    ...
    if (F.wE.has(e.type)) {
        ...
        return l
            ...
            : a
              ...
              : s
                ? e.filter((e) => !x.A.isMuted(e) || H.Ay.getMentionCount(e) > 0)
                : e;
    }
    return [];
}
...
function eR(e, t, n) {
    ...
    return !!((l.has(t.id) && a.indexOf(t.id) < ee) || H.Ay.hasRecentlyVisitedAndRead(t.id));
}
