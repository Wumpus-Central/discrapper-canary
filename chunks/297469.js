...
let E = {
    ...
    m = {};
class g extends f.Ay.DeviceSettingsStore {
...
function C() {
    ...
    if (
        ...
        delete v[e], null != y[n] && y[n].delete(e);
        return;
    }
    return (v[e]++, null == y[n] && (y[n] = new Set()), S.Ay.isFavorite(n, e))
        ? void y[n].delete(e)
        : (null == N[n] || !N[n].has(e)) && v[e] > 50
          ? (y[n].add(e), !0)
          : void 0;
}
class R extends f.Ay.PersistedStore {
    static displayName = "FavoritesSuggestionStore";
    static persistKey = "FavoritesSuggestionStore";
    initialize(e) {
        if ((this.waitFor(I.A, T.A, S.Ay), this.syncWith([T.A], C), null == e)) return;
        let { suggestedChannels: t, dismissedSuggestions: n, channelOpensByChannelId: i } = e;
        if (null != t) for (let e in t) y[e] = new Set(t[e]) ?? new Set();
        if (null != n) for (let e in n) N[e] = new Set(n[e]) ?? new Set();
        v = i ?? {};
    }
...
let O = new R(p.h, {
        DISMISS_FAVORITE_SUGGESTION: function (e) {
            ...
            return null == N[t] && (N[t] = new Set()), N[t].add(n), y[t].delete(n), !0;
        },
    }),
    b = new Set();
class D extends f.Ay.PersistedStore {
...
class el {
    ...
    nonPositionalChannelIdUpdate(e) {
        ...
        return (
            ...
            (t instanceof U.YB || null != (t = I.A.getChannel(e))) &&
...
class eu {
    ...
    constructor(e, t, n) {
        (this.id = e),
            ...
            (this.suggestedFavoriteChannelId = O.getSuggestedChannelId(this.id)),
        ...
        for (const e in i) {
            const t = i[e];
            t.type === X.rbe.GUILD_CATEGORY && ((o[t.id] = t), (u[t.id] = []));
        }
        const c = [],
            _ = [],
            h = [],
        ...
        for (const e in i) {
            ...
            if (t.type !== X.rbe.GUILD_CATEGORY) {
                if (t.type === X.rbe.GUILD_DIRECTORY) {
                    null == s || s.features.has(X.GuildFeatures.HUB) || h.push(t);
                    continue;
                }
                eR(this, t, f)
                    ? c.push(t)
        ...
        for (const e in ((this.categories = {}), u)) this.categories[e] = new e_(this, o[e], u[e], f);
        (this.recentsSectionNumber = er),
            (this.favoritesSectionNumber = ei),
            (this.noParentCategory = new ed(this, l, f)),
            (this.favoritesCategory = new eh(this, f)),
            (this.recentsCategory = A.get("enable_recently_active")
                ? new ChannelListRecentlyActiveCategory(this, i, f)
                : new ef(this, c, f)),
            (this.voiceChannelsCategory = new ep(this, _, o, f)),
            (this.guildActionSection = new em(t, h.length > 0)),
    ...
    getSectionRowsFromChannel(e) {
        ...
        if ((o >= 0 && n.push({ section: this.recentsSectionNumber, row: o }), i.type === X.rbe.GUILD_CATEGORY))
...
class eh extends ec {
    constructor(e, t) {
        super(e),
            (this.channels = a()(S.Ay.getGuildFavorites(e.id) ?? [])
                ...
                .keyBy((e) => e.id)
                .value());
        const n = O.getSuggestedChannelId(e.id),
            i = I.A.getChannel(n);
        null != i &&
            null != n &&
    ...
    updateChannel(e, t) {
        let n = e.id in this.channels && S.Ay.isFavorite(e.guild_id, e.id),
            i = O.getSuggestedChannelId(e.guild_id);
...
class ef extends ec {
    constructor(e, t, n) {
        if ((super(e), !e.optInEnabled || h.A.isFullServerPreview(e.id))) return;
        (this.isCollapsed = !1),
            (this.isMuted = !1),
            (this.channels = a()(t)
...
class eA extends eg {
    computeState(e) {
        ...
        if (ev(o, this.record)) return { renderLevel: 1, threadIds: [] };
        let l = t?.id === this.id || n === this.id,
            ...
            _ = eN(this.record, d, t, n, o.hideMutedChannels);
        return this.id !== o.moderatorReportChannelId || o.moderatorReportChannelEnabled
            ? o.optInEnabled && o.hideResourceChannels && this.record.hasFlag(Z.lx.IS_GUILD_RESOURCE_CHANNEL)
                      ...
                      : o.hideMutedChannels && o.mutedChannelIds.has(this.id)
                        ...
                        : this.category.isCollapsed &&
                            (o.mutedChannelIds.has(this.id) ||
                                ...
                                ((0, U.ig)(this.record.type) && !H.Ay.hasUnread(this.record.id)))
...
class eI extends eg {
    computeState(e) {
        ...
        return B.A.can(Q.xB.VIEW_CHANNEL, this.record)
            ? { renderLevel: 4, threadIds: eN(this.record, i[this.id] ?? {}, t, n, !1) }
    ...
    computeState(e) {
        ...
        return B.A.can(Q.xB.VIEW_CHANNEL, this.record)
            ? eR(this.category.guild, this.record, e)
                ? { renderLevel: eC(this, e) ? 4 : 3, threadIds: eN(this.record, i[this.id] ?? {}, t, n, !1) }
...
class eS extends eA {
    getRenderLevel(e) {
        ...
        return !B.A.can(Q.xB.VIEW_CHANNEL, this.record) || 4 === e || 3 === e || ev(t, this.record)
            ? 1
            : this.category.isCollapsed
    ...
    if (U.wE.has(e.type)) {
        ...
        return s
            ...
            : o
              ...
              : r
                ? e.filter((e) => !k.A.isMuted(e) || H.Ay.getMentionCount(e) > 0)
                : e;
    }
    return [];
}
...
function eR(e, t, n) {
    ...
    if (
        ...
        (t.isGuildVocal() && (!z.A.isVoiceCategoryCollapsed(e.id) || a().some(j.A.getVoiceStatesForChannel(t.id))))
    )
        return !1;
...
let eO = new Set(Object.values(q.n));
