...
function v() {
    ...
    if (
        ...
        delete N[e], null != y[n] && y[n].delete(e);
        return;
    }
    return (N[e]++, null == y[n] && (y[n] = new Set()), S.Ay.isFavorite(n, e))
        ? void y[n].delete(e)
        : (null == C[n] || !C[n].has(e)) && N[e] > 50
          ? (y[n].add(e), !0)
          : void 0;
}
...
let O = new R(p.h, {
        DISMISS_FAVORITE_SUGGESTION: function (e) {
            ...
            return null == C[t] && (C[t] = new Set()), C[t].add(n), y[t].delete(n), !0;
        },
    }),
    b = new Set();
    ...
    _areGuildVocalChannelsInRecentsInNeedOfAppearingInActiveNow(e) {
        ...
        for (let e in i.channels) {
            ...
            if (
                ...
                a().some(H.A.getVoiceStatesForChannel(t.id)) &&
        ...
        for (const e in i) {
            ...
            if (t.type !== Z.rbe.GUILD_CATEGORY) {
                if (t.type === Z.rbe.GUILD_DIRECTORY) {
                    null == s || s.features.has(Z.GuildFeatures.HUB) || h.push(t);
                    continue;
                }
                eR(this, t, f)
                    ? c.push(t)
...
class eA extends eg {
    computeState(e) {
        ...
        if (eN(o, this.record)) return { renderLevel: 1, threadIds: [] };
        let l = t?.id === this.id || n === this.id,
            ...
            _ = eC(this.record, d, t, n, o.hideMutedChannels);
        return this.id !== o.moderatorReportChannelId || o.moderatorReportChannelEnabled
            ? o.optInEnabled && o.hideResourceChannels && this.record.hasFlag(X.lx.IS_GUILD_RESOURCE_CHANNEL)
                ...
                : !o.optInEnabled || o.optedInChannels.has(this.id) || (null != s && o.optedInChannels.has(s))
                  ? l || u || !a().isEmpty(_) || j.Ay.getMentionCount(this.id) > 0
                      ...
                      : o.hideMutedChannels && o.mutedChannelIds.has(this.id)
                        ...
                        : this.category.isCollapsed &&
                            (o.mutedChannelIds.has(this.id) ||
                                ...
                                ((0, U.ig)(this.record.type) && !j.Ay.hasUnread(this.record.id)))
    ...
    computeState(e) {
        ...
        return B.A.can(Q.xB.VIEW_CHANNEL, this.record)
            ? eR(this.category.guild, this.record, e)
                ? { renderLevel: ev(this, e) ? 4 : 3, threadIds: eC(this.record, i[this.id] ?? {}, t, n, !1) }
...
class eS extends eA {
    getRenderLevel(e) {
        ...
        return !B.A.can(Q.xB.VIEW_CHANNEL, this.record) || 4 === e || 3 === e || eN(t, this.record)
            ? 1
            : this.category.isCollapsed
              ? a().some(H.A.getVoiceStatesForChannel(this.record.id))
                  ? 4
                  : 3
              : 4;
    }
    ...
    if (U.wE.has(e.type)) {
        ...
        return s
            ...
            : o
              ...
              : r
                ? e.filter((e) => !k.A.isMuted(e) || j.Ay.getMentionCount(e) > 0)
                : e;
    }
    return [];
}
...
function eR(e, t, n) {
    ...
    if (
        ...
        (t.isGuildVocal() && (!z.A.isVoiceCategoryCollapsed(e.id) || a().some(H.A.getVoiceStatesForChannel(t.id))))
    )
        return !1;
    ...
    return !!((s.has(t.id) && o.indexOf(t.id) < ee) || j.Ay.hasRecentlyVisitedAndRead(t.id));
}
