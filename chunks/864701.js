    ...
    let { isPaused: t } = e,
        ...
        Z = (0, s.useCallback)(() => {
            for (let n = m.current.length - 1; n >= 0; n--)
                if (0 === n) {
                    var e, t;
                    let r = null !== (e = 0 === (t = m.current[n]).x && t.y <= 0 ? 3 : 23 === t.x && t.y >= 14 ? 2 : t.x <= 0 && 14 === t.y ? 0 : t.x >= 23 && 0 === t.y ? 1 : void 0) && void 0 !== e ? e : m.current[n].direction,
                        s = (function (e, t) {
                            switch (t) {
                                case 0:
                                    return {
        ...
        P = (0, s.useCallback)((e) => {
            m.current.forEach((t, n) => {
                ...
                e.drawImage(N, h[r], v[t.type], 16, 16, 16 * t.x + 19.2, 16 * t.y + 19.2, 16, 16);
            });
        }, []),
        C = (0, s.useCallback)((e) => {
            g.current.forEach((t) => {
