...
function R(e) {
    let {
        ...
        V = (function (e, t) {
                ...
                D = r.useCallback(
                    (e, r, l, s) => {
                        if (e) {
                            if (null != A) {
                                let e = {
                                    qualityOptions: { preset: _.jQ.PRESET_CUSTOM, resolution: r, frameRate: l },
                                    context: x.x.STREAM,
                                };
                            ...
                            var a;
                            (a = { ...I, object: T.ZSU.RADIO_ITEM, objectType: s }),
                                (0, f.openModalLazy)(
                                    async () => {
                                    ...
                                    { contextKey: t === T.BRT.POPOUT ? E.KX : E.SY },
                                );
                        }
                    },
                    [t, I, d, A],
            ...
            let N = a === _.jQ.PRESET_DOCUMENTS ? _.kn.FPS_30 : u,
                M = _.ce.map((e) => {
                    let { value: t, label: n, subtext: r } = e,
                        l = (0, C.A)(_.jQ.PRESET_CUSTOM, o, t, g, p, R);
                    return (0, i.jsx)(
                        s.iD,
                        {
                            ...
                            subtext: r,
                            checked: t === u,
                            action: () => D(l, o, t, T.AnalyticsObjectTypes.RESOLUTION),
                        },
                ...
                L = _.Jk.map((e) => {
                    let { value: t, label: n, subtext: r } = e,
                        l = (0, C.A)(_.jQ.PRESET_CUSTOM, t, N, g, p, R);
                    return (0, i.jsx)(
                        s.iD,
                        {
                            ...
                            subtext: r,
                            checked: t === o,
                            action: () => D(l, t, N, T.AnalyticsObjectTypes.RESOLUTION),
                        },
