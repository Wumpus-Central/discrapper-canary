...
let C = ['#be0351', '#ff2c52', '#f0f0f0'],
    ...
    o = (A) => {
        var g,
            v,
            { width: o = 24, height: l = 24, primaryTintColor: i, secondaryTintColor: s } = A,
            M = (function (A, g) {
                if (null == A) return {};
                var v,
                    t,
        ...
        let H = B.useMemo(() => 'badge-force-gradient-'.concat((0, e.Z)()), []),
            { primaryColorsTransformed: a, secondaryColorsTransformed: E } = (0, r.s)({
                primaryBaseColors: C,
                primaryTintColor: i,
