...
let P = Math.round(1e10 * Math.random()),
    ...
    F = (0, r.forwardRef)(function (e, t) {
        ...
        let { validationBehavior: s } = (0, o.CC)(u.c) || {},
            ...
            [y, C] = (0, o._E)(!e["aria-label"] && !e["aria-labelledby"]),
            {
                radioGroupProps: N,
                labelProps: v,
                descriptionProps: R,
                ...
                let {
                    ...
                    O = (0, m.Bi)(n);
                return (
                    f.set(t, { name: O, form: i, descriptionId: C.id, errorMessageId: N.id, validationBehavior: l }),
                    {
                        radioGroupProps: (0, g.v)(v, {
                            role: "radiogroup",
                            onKeyDown: (e) => {
                                let n, i;
                                switch (e.key) {
            ...
            })({ ...e, label: C, validationBehavior: a }, d),
            D = (0, o.Sl)({
                ...e,
                values: {
        ...
        let s = r.useContext(G),
            a = (0, D.U)((0, r.useMemo)(() => (0, L.P)(n, void 0 !== e.inputRef ? e.inputRef : null), [n, e.inputRef])),
            {
                ...
                let {
                    ...
                    m = t.selectedValue === i,
                    { pressProps: A, isPressed: I } = (0, C.d)({
                        onPressStart: l,
                        onPressEnd: u,
                        onPressChange: c,
                        onPress: d,
                    ...
                    { focusableProps: R } = (0, N.Wc)((0, g.v)(e, { onFocus: () => t.setLastFocusedValue(i) }), n),
                    O = (0, g.v)(A, R),
                    b = (0, p.$)(e, { labelable: !0 }),
                    D = -1;
                ...
                return (
                    ...
                    (0, v.X)({ validationBehavior: x }, t, n),
                    {
                        labelProps: (0, g.v)(
                            T,
                            (0, r.useMemo)(
