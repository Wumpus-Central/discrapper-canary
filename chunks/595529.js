"use strict";
let i;
n.d(t, { Ty: () => x, _L: () => P, Bo: () => D, hI: () => w, eE: () => b, Vu: () => L, DP: () => C, Tr: () => M });
var r = n(64700),
    s = n(17928),
    a = n(554146),
    o = n(206885),
...
function v(e, t, n, o, l) {
    let f = (0, A.Ay)((t) => null != e && t.currentlyShown.has(e)),
    ...
    return (
        ...
        r.useEffect(() => {
            if (null != e) {
                var t;
                return (
                    h.A.hasLoaded(N.oD.PRELOADED_USER_SETTINGS) ||
                        ((t = S.current),
                        p.default.track(y.HAw.DISMISSIBLE_CONTENT_SHOWN_BEFORE_CONNECTION_OPEN, {
                            content_type: a.M[e],
                            group_name: n ?? null,
...
function C(e, t) {
    let n = (0, s.bG)([h.A], () => h.A.settings.userContent?.dismissedContents),
        i = (0, s.bG)([f.A], () => f.A.getGuildId()),
        a = (0, S.Sg)(e),
        o = null;
    return (
        h.A.hasLoaded(N.oD.PRELOADED_USER_SETTINGS)
...
function O(e) {
    return (0, s.bG)(
        [h.A],
        () => (null !== e ? h.A.settings.userContent?.recurringDismissibleContentStates?.[e] : null) ?? R,
    );
}
function b(e, t, n) {
    let { lastDismissedVersion: i } = O(e),
        a = (0, s.bG)([f.A], () => f.A.getGuildId()),
        o = null;
    if (null != e) {
        let n = !(0, S.P3)(e);
        h.A.hasLoaded(N.oD.PRELOADED_USER_SETTINGS)
...
function D(e, t, n) {
    let { lastDismissedAtMs: i, numTimesDismissed: a } = O(e),
        o = (0, s.bG)([f.A], () => f.A.getGuildId()),
        l = null;
    return (
        null != e && (l = k(!(0, S.P3)(e), i, a, t) ? e : null),
        [
            v(l, o, n),
            r.useCallback(
                (e, t) => {
...
function L(e, t, n) {
    let { lastDismissedObjectId: i } = O(e),
        a = (0, s.bG)([f.A], () => f.A.getGuildId()),
        o = null;
    if (null != e) {
        let n = !(0, S.P3)(e);
...
function w(e, t, n, i) {
    let a = (0, s.bG)([h.A], () => h.A.getGuildDismissedContentState(n)),
...
function M(e, t, n, i) {
    let a = (0, s.bG)([f.A], () => f.A.getGuildId()),
        o = null;
    return (
...
function P(e, t, n) {
    let i = (0, s.bG)([h.A], () => h.A.getGuildDismissedContentState(t)),
        a = (0, S.Sg)(e),
        o = null;
    return (
        h.A.hasLoaded(N.oD.PRELOADED_USER_SETTINGS)
...
function x(e, t, n, i) {
    let a = (0, s.bG)([h.A], () => h.A.getGuildDismissedContentState(t)),
        o = null != e ? (null == a ? null : a?.[e]) : null,
        l = o?.numTimesDismissed,
        u = null;
    return (
        null != e && (u = k(!(0, S.P3)(e), o?.lastDismissedAtMs, l, n) ? e : null),
        [
            v(u, t, i),
            r.useCallback(
                (e, n) => {
...
function k(e, t, n, i) {
    ...
    return (
        (h.A.hasLoaded(N.oD.PRELOADED_USER_SETTINGS) || (null != r && null != n)) &&
        e &&
        o &&
        (null == r || a >= s) &&
        l
