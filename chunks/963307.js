"use strict";
n.d(t, { Ay: () => G, QP: () => O, S9: () => v, sN: () => R }), n(321073);
var r,
    i = n(735438),
    s = n.n(i),
    a = n(181370),
...
class L {
    ...
    setGroups(e) {
        ...
        (this.groups = e.map((e) => {
            ...
            return (t += r + 1), C(this.guildId, e.id, r, n);
        })),
            (this.rows.length = t);
    }
    sync(e, t) {
    ...
    update(e, t) {
        ...
        if ((null != i && "MEMBER" === i.type && delete this.members[i.user.id], null != n))
            this.rows[e] = C(this.guildId, n.id, n.count);
        else if (null != r) {
            let t = b(this.guildId, this.ownerId, r.user.id);
            if (null == t) return;
    ...
    rebuildGroup(e) {
        let t = this.groups.findIndex((t) => t.id === e),
            n = this.groups[t];
        null != n && (this.groups.splice(t, 1, C(this.guildId, e, n.count, n.index)), this.version++);
    }
}
let w = new (class {
    _guildLists = {};
...
class x extends u.Ay.Store {
    ...
    initialize() {
        this.waitFor(S.default, A.A, g.A, h.A, m.Ay, I.A, T.A, E.default, p.A, f.A, c.A),
            this.syncWith([T.A], k),
            this.syncWith([f.A], U);
    }
    getProps(e, t) {
