...
class M extends C.G {
    ...
    internalBinaryWrite(e, t, n) {
        (e.measurementPlan && w.internalBinaryWrite(e.measurementPlan, t.tag(1, m.O0.LengthDelimited).fork(), n).join(),
            e.rolloutPlan && x.internalBinaryWrite(e.rolloutPlan, t.tag(2, m.O0.LengthDelimited).fork(), n).join());
        let i = n.writeUnknownFields;
        return (!1 !== i && (!0 == i ? m.f$.onWrite : i)(this.typeName, e, t), t);
    }
}
...
class U extends C.G {
    ...
    internalBinaryWrite(e, t, n) {
        ...
        for (let i = 0; i < e.rampSteps.length; i++)
            F.internalBinaryWrite(e.rampSteps[i], t.tag(2, m.O0.LengthDelimited).fork(), n).join();
        let i = n.writeUnknownFields;
        return (!1 !== i && (!0 == i ? m.f$.onWrite : i)(this.typeName, e, t), t);
    }
}
...
class k extends C.G {
    ...
    internalBinaryWrite(e, t, n) {
        (0 !== e.targetBasisPoints && t.tag(1, m.O0.Varint).int32(e.targetBasisPoints),
            e.holdDuration && D.internalBinaryWrite(e.holdDuration, t.tag(2, m.O0.LengthDelimited).fork(), n).join(),
            !1 !== e.requireManualApproval && t.tag(3, m.O0.Varint).bool(e.requireManualApproval),
            e.startedAt && O.D.internalBinaryWrite(e.startedAt, t.tag(4, m.O0.LengthDelimited).fork(), n).join(),
...
class j extends C.G {
    ...
    internalBinaryWrite(e, t, n) {
        ...
        for (let i = 0; i < e.filters.length; i++)
            z.internalBinaryWrite(e.filters[i], t.tag(2, m.O0.LengthDelimited).fork(), n).join();
        (e.override && K.internalBinaryWrite(e.override, t.tag(3, m.O0.LengthDelimited).fork(), n).join(),
...
class $ extends C.G {
    constructor() {
        super("discord_protos.discord_experimentation.v1.Filter", [
            ...
            { no: 9, name: "client_ip", kind: "message", oneof: "filter", T: () => eg },
        ...
        for (; e.pos < a;) {
            ...
            switch (t) {
                ...
                case 9:
                    r.filter = {
                        oneofKind: "clientIp",
                        clientIp: eg.internalBinaryRead(e, e.uint32(), n, r.filter.clientIp),
                    };
                    break;
                case 10:
                    r.filter = {
    ...
    internalBinaryWrite(e, t, n) {
        ("clientVersion" === e.filter.oneofKind &&
            eU.internalBinaryWrite(e.filter.clientVersion, t.tag(2, m.O0.LengthDelimited).fork(), n).join(),
            "clientOs" === e.filter.oneofKind &&
                eC.internalBinaryWrite(e.filter.clientOs, t.tag(3, m.O0.LengthDelimited).fork(), n).join(),
            "staff" === e.filter.oneofKind &&
                q.internalBinaryWrite(e.filter.staff, t.tag(4, m.O0.LengthDelimited).fork(), n).join(),
            "userInGuild" === e.filter.oneofKind &&
                Q.internalBinaryWrite(e.filter.userInGuild, t.tag(5, m.O0.LengthDelimited).fork(), n).join(),
            "userIds" === e.filter.oneofKind &&
                ee.internalBinaryWrite(e.filter.userIds, t.tag(6, m.O0.LengthDelimited).fork(), n).join(),
            "clientLocale" === e.filter.oneofKind &&
                er.internalBinaryWrite(e.filter.clientLocale, t.tag(7, m.O0.LengthDelimited).fork(), n).join(),
            "clientLocation" === e.filter.oneofKind &&
                eo.internalBinaryWrite(e.filter.clientLocation, t.tag(8, m.O0.LengthDelimited).fork(), n).join(),
            "clientIp" === e.filter.oneofKind &&
                eg.internalBinaryWrite(e.filter.clientIp, t.tag(9, m.O0.LengthDelimited).fork(), n).join(),
            "userLocale" === e.filter.oneofKind &&
                en.internalBinaryWrite(e.filter.userLocale, t.tag(10, m.O0.LengthDelimited).fork(), n).join(),
            "bot" === e.filter.oneofKind &&
                eK.internalBinaryWrite(e.filter.bot, t.tag(11, m.O0.LengthDelimited).fork(), n).join(),
            "userAgeRange" === e.filter.oneofKind &&
                ez.internalBinaryWrite(e.filter.userAgeRange, t.tag(12, m.O0.LengthDelimited).fork(), n).join(),
            "userIdRange" === e.filter.oneofKind &&
                eQ.internalBinaryWrite(e.filter.userIdRange, t.tag(13, m.O0.LengthDelimited).fork(), n).join(),
            "userHasFlag" === e.filter.oneofKind &&
                e0.internalBinaryWrite(e.filter.userHasFlag, t.tag(14, m.O0.LengthDelimited).fork(), n).join(),
            "unitIdInRangeByHash" === e.filter.oneofKind &&
                e2.internalBinaryWrite(e.filter.unitIdInRangeByHash, t.tag(15, m.O0.LengthDelimited).fork(), n).join(),
            "clientReleaseChannel" === e.filter.oneofKind &&
                e5.internalBinaryWrite(e.filter.clientReleaseChannel, t.tag(16, m.O0.LengthDelimited).fork(), n).join(),
            "always" === e.filter.oneofKind &&
                e4.internalBinaryWrite(e.filter.always, t.tag(17, m.O0.LengthDelimited).fork(), n).join(),
            "clientSystemLocale" === e.filter.oneofKind &&
                es.internalBinaryWrite(e.filter.clientSystemLocale, t.tag(18, m.O0.LengthDelimited).fork(), n).join(),
            "unitIdInExperiment" === e.filter.oneofKind &&
                e8.internalBinaryWrite(e.filter.unitIdInExperiment, t.tag(19, m.O0.LengthDelimited).fork(), n).join(),
            "userPremiumType" === e.filter.oneofKind &&
                te.internalBinaryWrite(e.filter.userPremiumType, t.tag(20, m.O0.LengthDelimited).fork(), n).join(),
            ...
            "guildIds" === e.filter.oneofKind &&
                tr.internalBinaryWrite(e.filter.guildIds, t.tag(22, m.O0.LengthDelimited).fork(), n).join(),
            "guildIdRange" === e.filter.oneofKind &&
                to.internalBinaryWrite(e.filter.guildIdRange, t.tag(23, m.O0.LengthDelimited).fork(), n).join(),
            ...
            "guildHasFeature" === e.filter.oneofKind &&
                tc.internalBinaryWrite(e.filter.guildHasFeature, t.tag(26, m.O0.LengthDelimited).fork(), n).join(),
            "userLocation" === e.filter.oneofKind &&
                eI.internalBinaryWrite(e.filter.userLocation, t.tag(27, m.O0.LengthDelimited).fork(), n).join(),
            "userIp" === e.filter.oneofKind &&
                eS.internalBinaryWrite(e.filter.userIp, t.tag(28, m.O0.LengthDelimited).fork(), n).join(),
            "installationIds" === e.filter.oneofKind &&
                t_.internalBinaryWrite(e.filter.installationIds, t.tag(29, m.O0.LengthDelimited).fork(), n).join(),
            "userStoreCountry" === e.filter.oneofKind &&
                ep.internalBinaryWrite(e.filter.userStoreCountry, t.tag(31, m.O0.LengthDelimited).fork(), n).join(),
...
class el extends C.G {
    ...
    internalBinaryWrite(e, t, n) {
        for (let i = 0; i < e.locations.length; i++)
            eA.internalBinaryWrite(e.locations[i], t.tag(1, m.O0.LengthDelimited).fork(), n).join();
        let i = n.writeUnknownFields;
        return (!1 !== i && (!0 == i ? m.f$.onWrite : i)(this.typeName, e, t), t);
    }
}
...
class eE extends C.G {
    ...
    internalBinaryWrite(e, t, n) {
        ("isoRegion" === e.location.oneofKind &&
            e_.internalBinaryWrite(e.location.isoRegion, t.tag(1, m.O0.LengthDelimited).fork(), n).join(),
            "isEu" === e.location.oneofKind && t.tag(2, m.O0.Varint).bool(e.location.isEu),
            "place" === e.location.oneofKind &&
                ec.internalBinaryWrite(e.location.place, t.tag(3, m.O0.LengthDelimited).fork(), n).join());
        let i = n.writeUnknownFields;
        return (!1 !== i && (!0 == i ? m.f$.onWrite : i)(this.typeName, e, t), t);
    }
}
...
class eN extends C.G {
    ...
    internalBinaryWrite(e, t, n) {
        (e.iosVersion && eR.internalBinaryWrite(e.iosVersion, t.tag(1, m.O0.LengthDelimited).fork(), n).join(),
            e.androidVersion &&
                eR.internalBinaryWrite(e.androidVersion, t.tag(2, m.O0.LengthDelimited).fork(), n).join(),
            e.macosVersion && eR.internalBinaryWrite(e.macosVersion, t.tag(3, m.O0.LengthDelimited).fork(), n).join(),
            e.windowsVersion &&
                eR.internalBinaryWrite(e.windowsVersion, t.tag(4, m.O0.LengthDelimited).fork(), n).join(),
            e.playstationVersion &&
                eR.internalBinaryWrite(e.playstationVersion, t.tag(5, m.O0.LengthDelimited).fork(), n).join(),
            e.xboxVersion && eR.internalBinaryWrite(e.xboxVersion, t.tag(6, m.O0.LengthDelimited).fork(), n).join(),
            e.linuxVersion && eR.internalBinaryWrite(e.linuxVersion, t.tag(7, m.O0.LengthDelimited).fork(), n).join());
        let i = n.writeUnknownFields;
        return (!1 !== i && (!0 == i ? m.f$.onWrite : i)(this.typeName, e, t), t);
    }
}
...
class eO extends C.G {
    ...
    internalBinaryWrite(e, t, n) {
        for (let i = 0; i < e.ranges.length; i++)
            ey.internalBinaryWrite(e.ranges[i], t.tag(1, m.O0.LengthDelimited).fork(), n).join();
...
class eL extends C.G {
    ...
    internalBinaryWrite(e, t, n) {
        (e.lowerBound && ev.internalBinaryWrite(e.lowerBound, t.tag(1, m.O0.LengthDelimited).fork(), n).join(),
            e.upperBound && ev.internalBinaryWrite(e.upperBound, t.tag(2, m.O0.LengthDelimited).fork(), n).join());
        let i = n.writeUnknownFields;
        return (!1 !== i && (!0 == i ? m.f$.onWrite : i)(this.typeName, e, t), t);
    }
}
...
class eP extends C.G {
    ...
    internalBinaryWrite(e, t, n) {
        (e.iosVersion && eG.internalBinaryWrite(e.iosVersion, t.tag(1, m.O0.LengthDelimited).fork(), n).join(),
            e.androidVersion &&
                eG.internalBinaryWrite(e.androidVersion, t.tag(2, m.O0.LengthDelimited).fork(), n).join(),
            e.webVersion && eG.internalBinaryWrite(e.webVersion, t.tag(3, m.O0.LengthDelimited).fork(), n).join(),
            e.nativeVersion && eG.internalBinaryWrite(e.nativeVersion, t.tag(4, m.O0.LengthDelimited).fork(), n).join(),
            !1 !== e.allowNonNativeWeb && t.tag(6, m.O0.Varint).bool(e.allowNonNativeWeb),
            e.clientRequiredChanges &&
                eW.internalBinaryWrite(e.clientRequiredChanges, t.tag(5, m.O0.LengthDelimited).fork(), n).join());
        let i = n.writeUnknownFields;
        return (!1 !== i && (!0 == i ? m.f$.onWrite : i)(this.typeName, e, t), t);
    }
}
...
class ew extends C.G {
    ...
    internalBinaryWrite(e, t, n) {
        for (let i = 0; i < e.ranges.length; i++)
            ek.internalBinaryWrite(e.ranges[i], t.tag(1, m.O0.LengthDelimited).fork(), n).join();
        !1 !== e.workAroundPyotoBug && t.tag(2, m.O0.Varint).bool(e.workAroundPyotoBug);
        let i = n.writeUnknownFields;
        return (!1 !== i && (!0 == i ? m.f$.onWrite : i)(this.typeName, e, t), t);
    }
...
class ex extends C.G {
    ...
    internalBinaryWrite(e, t, n) {
        (e.lowerBound && eB.internalBinaryWrite(e.lowerBound, t.tag(1, m.O0.LengthDelimited).fork(), n).join(),
            e.upperBound && eB.internalBinaryWrite(e.upperBound, t.tag(2, m.O0.LengthDelimited).fork(), n).join());
        let i = n.writeUnknownFields;
        return (!1 !== i && (!0 == i ? m.f$.onWrite : i)(this.typeName, e, t), t);
    }
}
...
class eF extends C.G {
    ...
    internalBinaryWrite(e, t, n) {
        (e.version && eH.internalBinaryWrite(e.version, t.tag(1, m.O0.LengthDelimited).fork(), n).join(),
            !1 !== e.inclusive && t.tag(2, m.O0.Varint).bool(e.inclusive));
        let i = n.writeUnknownFields;
        return (!1 !== i && (!0 == i ? m.f$.onWrite : i)(this.typeName, e, t), t);
    }
...
class eV extends C.G {
    ...
    internalBinaryWrite(e, t, n) {
        (0 !== e.major && t.tag(1, m.O0.Varint).uint32(e.major),
            e.minor && B.ZQ.internalBinaryWrite(e.minor, t.tag(2, m.O0.LengthDelimited).fork(), n).join(),
            e.build && B.ol.internalBinaryWrite(e.build, t.tag(3, m.O0.LengthDelimited).fork(), n).join());
        let i = n.writeUnknownFields;
        return (!1 !== i && (!0 == i ? m.f$.onWrite : i)(this.typeName, e, t), t);
    }
}
...
class e$ extends C.G {
    ...
    internalBinaryWrite(e, t, n) {
        (e.minAgeYears && B.ZQ.internalBinaryWrite(e.minAgeYears, t.tag(1, m.O0.LengthDelimited).fork(), n).join(),
            e.maxAgeYears && B.ZQ.internalBinaryWrite(e.maxAgeYears, t.tag(2, m.O0.LengthDelimited).fork(), n).join());
        let i = n.writeUnknownFields;
        return (!1 !== i && (!0 == i ? m.f$.onWrite : i)(this.typeName, e, t), t);
    }
}
...
class eZ extends C.G {
    ...
    internalBinaryWrite(e, t, n) {
        (e.minId && eq.internalBinaryWrite(e.minId, t.tag(1, m.O0.LengthDelimited).fork(), n).join(),
            e.maxId && eq.internalBinaryWrite(e.maxId, t.tag(2, m.O0.LengthDelimited).fork(), n).join());
        let i = n.writeUnknownFields;
        return (!1 !== i && (!0 == i ? m.f$.onWrite : i)(this.typeName, e, t), t);
    }
}
...
class ta extends C.G {
    ...
    internalBinaryWrite(e, t, n) {
        (e.minCount && B.ZQ.internalBinaryWrite(e.minCount, t.tag(1, m.O0.LengthDelimited).fork(), n).join(),
            e.maxCount && B.ZQ.internalBinaryWrite(e.maxCount, t.tag(2, m.O0.LengthDelimited).fork(), n).join());
        let i = n.writeUnknownFields;
        return (!1 !== i && (!0 == i ? m.f$.onWrite : i)(this.typeName, e, t), t);
    }
}
...
class tL extends C.G {
    constructor() {
        super("discord_protos.discord_experimentation.v1.Experiment", [
            ...
            },
            {
                ...
                kind: "enum",
                repeat: 1,
                T: () => ["discord_protos.discord_experimentation.v1.Experiment.ExposurePointId", tg],
            },
    ...
    internalBinaryWrite(e, t, n) {
        ("0" !== e.id && t.tag(1, m.O0.Bit64).fixed64(e.id),
            ...
            e.createdAt && O.D.internalBinaryWrite(e.createdAt, t.tag(3, m.O0.LengthDelimited).fork(), n).join(),
            "0" !== e.creatorId && t.tag(4, m.O0.Bit64).fixed64(e.creatorId),
            0 !== e.version && t.tag(5, m.O0.Varint).int32(e.version),
            e.editedAt && O.D.internalBinaryWrite(e.editedAt, t.tag(6, m.O0.LengthDelimited).fork(), n).join(),
            ...
            e.hypothesis && B.hU.internalBinaryWrite(e.hypothesis, t.tag(10, m.O0.LengthDelimited).fork(), n).join(),
            e.techSpecLink &&
                B.hU.internalBinaryWrite(e.techSpecLink, t.tag(11, m.O0.LengthDelimited).fork(), n).join(),
        ...
        for (let i = 0; i < e.variations.length; i++)
            tb.internalBinaryWrite(e.variations[i], t.tag(15, m.O0.LengthDelimited).fork(), n).join();
        for (let i = 0; i < e.rules.length; i++)
            W.internalBinaryWrite(e.rules[i], t.tag(16, m.O0.LengthDelimited).fork(), n).join();
        ...
        if (
            (e.debugConfig && tx.internalBinaryWrite(e.debugConfig, t.tag(30, m.O0.LengthDelimited).fork(), n).join(),
            e.expectedEndDate &&
                O.D.internalBinaryWrite(e.expectedEndDate, t.tag(31, m.O0.LengthDelimited).fork(), n).join(),
            ...
            e.archiveAt && O.D.internalBinaryWrite(e.archiveAt, t.tag(33, m.O0.LengthDelimited).fork(), n).join(),
            e.guildExperimentVersion &&
                B.as.internalBinaryWrite(e.guildExperimentVersion, t.tag(35, m.O0.LengthDelimited).fork(), n).join(),
        ...
        (!1 !== e.allocateRightToLeft && t.tag(38, m.O0.Varint).bool(e.allocateRightToLeft),
            ...
            e.numberLineSettings &&
                tD.internalBinaryWrite(e.numberLineSettings, t.tag(43, m.O0.LengthDelimited).fork(), n).join(),
            0 !== e.eligibilityPersistence && t.tag(42, m.O0.Varint).int32(e.eligibilityPersistence),
            e.lifecyclePlan &&
                P.internalBinaryWrite(e.lifecyclePlan, t.tag(48, m.O0.LengthDelimited).fork(), n).join());
        let i = n.writeUnknownFields;
        return (!1 !== i && (!0 == i ? m.f$.onWrite : i)(this.typeName, e, t), t);
    }
}
...
class tv extends C.G {
    ...
    internalBinaryWrite(e, t, n) {
        ...
        for (let i = 0; i < e.buckets.length; i++)
            tP.internalBinaryWrite(e.buckets[i], t.tag(4, m.O0.LengthDelimited).fork(), n).join();
        (0 !== e.type && t.tag(5, m.O0.Varint).int32(e.type),
            e.configuration &&
                B.hU.internalBinaryWrite(e.configuration, t.tag(6, m.O0.LengthDelimited).fork(), n).join(),
