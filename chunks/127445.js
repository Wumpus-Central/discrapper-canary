...
let E = (e) => {
                        ...
                        try {
                            let e = Date.now(),
                                [n, r, a] = await Promise.all([
                                    s.Bo.get({ url: t ? c.A : d.A, binary: !0, rejectWithError: !0 }),
                                    s.Bo.get({ url: t ? _.A : f.A, binary: !0, rejectWithError: !0 }),
                                    s.Bo.get({ url: t ? p.A : h.A, binary: !0, rejectWithError: !0 }),
                                ]);
                            T.current &&
                                (i({
    ...
    return { mediaUrls: t, isSuccess: n && m === a.BW.Loaded, isLoading: E || m === a.BW.Loading };
};
