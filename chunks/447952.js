...
function M(e) {
    let {
        ...
        [P, I] = i.useState(!1),
        [_, g] = i.useState(!1),
        [x, v] = i.useState(c === E.pn.CREDIT_CARD_INFORMATION ? y.he.CARD : null),
        [M, R] = i.useState(!1),
    ...
    let w = (0, h.t4)((e) => e.linkWalletEnabled),
        k = i.useMemo(() => (w ? N : N.filter((e) => "link" !== e)), [w]),
        D = i.useMemo(
            () => ({
                onChange: (e, t) => {
                    o && null != a && a.log("PaymentElements onChange event:", e), I(e.complete), v(t);
                },
                onReady: () => {
                    g(!0);
                },
