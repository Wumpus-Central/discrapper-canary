...
function T(e) {
    ...
    if (p || d)
        for (let e = m.length - 1; e >= 0; e--) {
            let t = m[e];
            (Z(t.id) || s().some(t.threadIds, Z)) && (null == a && (a = t.id), (O = !0)), (E(t.id) || s().some(t.threadIds, E)) && (null == o && (o = t.id), (v += b.ZP.getMentionCount(t.id)), (v += s().sumBy(t.threadIds, b.ZP.getMentionCount)));
        }
    if (p || d)
