...
function Z(e) {
    return !O.ZP.isChannelMuted(e.guild_id, e.id) && (e.isGuildStageVoice() ? h.Z.getMutableParticipants(e.id, p.pV.SPEAKER).length > 0 : v.ZP.getVoiceStatesForChannel(e).length > 0);
}
function T(e) {
    var t, n, r;
    ...
    if (h || d)
        for (let e = m.length - 1; e >= 0; e--) {
            let t = m[e];
            (w(t.id) || a().some(t.threadIds, w)) && (null == s && (s = t.id), (_ = !0)), (N(t.id) || a().some(t.threadIds, N)) && (null == o && (o = t.id), (v += b.ZP.getMentionCount(t.id)), (v += a().sumBy(t.threadIds, b.ZP.getMentionCount)));
        }
    if (h || d)
    ...
    let A = null != T && (null == x || ('mentions' !== x.mode && 'mentions' === T.mode)),
        D = null != x && ('mentions' === x.mode || !A);
    return (
        (P[e] = {
            topBar: A && null != T ? T : E,
...
let R = a().throttle(T, 200);
function A(e) {
    let { guildId: t } = e,
        n = m.Z.getGuild(t);
    return null != n && !!n.hasFeature(j.oNc.COMMUNITY) && R(t);
}
function D(e) {
    let { id: t } = e,
        n = g.Z.getChannel(t);
    ...
    return null != r && !!r.hasFeature(j.oNc.COMMUNITY) && R(n.guild_id);
}
function L(e) {
    let { channel: t } = e,
...
function M(e) {
    ...
    if (null == n) return !1;
    let r = m.Z.getGuild(n.guild_id);
    return null != r && !!r.hasFeature(j.oNc.COMMUNITY) && y.Z.getGuildId() === n.guild_id && R(n.guild_id);
}
function k(e) {
    let { guildId: t } = e;
    return null != t && R(t);
...
class U extends (r = c.ZP.Store) {
    initialize() {
        this.waitFor(C.Z, b.ZP, O.ZP, f.Z, v.ZP, y.Z, m.Z);
    }
...
let G = new U(u.Z, {
        ...
        return (
            a()(t)
                ...
                .forEach((e) => {
                    ...
                    null != t && t.hasFeature(j.oNc.COMMUNITY) && R(e) && (n = !0);
                }),
            n
        );
    },
    ...
    PASSIVE_UPDATE_V2: function (e) {
        ...
        return !!(e.channels.length > 0 && null != t && t.hasFeature(j.oNc.COMMUNITY)) && R(e.guildId);
    },
    RESORT_THREADS: M,
    THREAD_CREATE: L,
    THREAD_DELETE: L,
    ...
    VOICE_STATE_UPDATES: function (e) {
        ...
        let r = P[n];
        return null != r && 'voice-channels' === r.bottomBar.mode && R(n);
    },
