...
function T(e) {
    ...
    if (h || d)
        for (let e = m.length - 1; e >= 0; e--) {
            let t = m[e];
            ((N(t.id) || a().some(t.threadIds, N)) && (null == s && (s = t.id), (C = !0)), (w(t.id) || a().some(t.threadIds, w)) && (null == o && (o = t.id), (y += b.ZP.getMentionCount(t.id)), (y += a().sumBy(t.threadIds, b.ZP.getMentionCount))));
        }
    if (h || d)
