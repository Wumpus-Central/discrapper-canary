function n(e) {
    let n = e.regex,
        ...
        T = (e) => e.map((e) => e.replace(/\|\d+$/, '')),
        b = {
            variants: [
                {
                    match: [/new/, n.concat(h, '+'), n.concat('(?!', T(v).join('\\b|'), '\\b)'), a],
                    scope: {
                        1: 'keyword',
                        4: 'title.class'
                    }
        ...
        S = {
            variants: [
                {
                    match: [n.concat(/::/, n.lookahead(/(?!class\b)/)), y],
                ...
                {
                    match: [a, n.concat(/::/, n.lookahead(/(?!class\b)/)), y],
                    scope: {
                        1: 'title.class',
                        3: 'variable.constant'
                    }
        ...
        N = {
            ...
            keywords: I,
            contains: [A, o, S, e.C_BLOCK_COMMENT_MODE, p, m, b]
        },
        C = {
            relevance: 0,
            match: [/\b/, n.concat('(?!fn\\b|function\\b|', T(E).join('\\b|'), '|', T(v).join('\\b|'), '\\b)'), i, n.concat(h, '*'), n.lookahead(/(?=\()/)],
            scope: { 3: 'title.function.invoke' },
            contains: [N]
        };
    N.contains.push(C);
    let R = [A, S, e.C_BLOCK_COMMENT_MODE, p, m, b],
        O = {
            begin: n.concat(/#\[\s*\\?/, n.either(a, s)),
            beginScope: 'meta',
            end: /]/,
            endScope: 'meta',
            keywords: {
            ...
            b,
            {
                ...
                contains: [
                    ...
                    },
                    {
                        ...
                        excludeEnd: !0,
                        keywords: I,
                        contains: ['self', O, o, S, e.C_BLOCK_COMMENT_MODE, p, m]
                    }
                ]
            },
            {
