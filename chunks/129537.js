...
class I extends (i = a.Component) {
    shouldComponentUpdate(e, t) {
        return (
            !(0, u.A)(t, this.state) ||
            !(0, u.A)(e, this.props, ["anchor", "size", "minSize", "container"]) ||
            !(0, u.A)(e.anchor, this.props.anchor) ||
            !(0, u.A)(e.size, this.props.size) ||
            !(0, u.A)(e.minSize, this.props.minSize) ||
            !(0, u.A)(e.container, this.props.container)
        );
    }
    componentDidMount() {
        this.setDOMPositions(v(this.props.anchor)),
            ...
            d._.subscribe(h.jej.OVERLAY_V3_SHOW_WIDGETS, this.handleShowUI);
    }
    componentDidUpdate(e, t) {
        null == t.operation &&
            ((0, u.A)(this.props.anchor, e.anchor) || this.setDOMPositions(v(this.props.anchor)),
            (0, u.A)(this.props.size, e.size) ||
                this.setDOMSize(E(this.props.size, this.props.minSize.width, this.props.minSize.height)));
    }
    ...
    handleDragMove(e, t) {
        ...
        let { width: m, height: g } = S(n, this.size),
            ...
            E = u ? (0, p.h1)(O) : x("RESIZE_SOUTH_EAST", O);
    ...
    handleResizeMove(e, t) {
        let {
            ...
            { startX: m, startY: A } = this.dragState,
            O = 0,
            E = 0;
        if (null == h) return;
        ...
        super(e),
            ...
            m(this, "handleMouseMove", (e) => {
                ...
                !(null == l || (!a && Math.pow(i - t, 2) + Math.pow(r - n, 2) < 3)) &&
                    ("MOVE" === l ? this.handleDragMove(t, n) : O.has(l) && this.handleResizeMove(t, n));
            }),
