...
function m(e, t) {
    ...
    return (
        ...
        (0, u.c0)(e.userContent.dismissedContents, t) ||
            ((e.userContent.dismissedContents = (0, u.Vf)(e.userContent.dismissedContents, t)), (n = !0)),
        n
    );
}
function p(e, t, n) {
...
let g = [
    ...
    },
    {
        ...
        run(e) {
            ...
            return (
                !1 === n[h.n5X.INVITE] && m(e, r.M.CHANNEL_NOTICE_INVITE) && (t = !0),
                !1 === n[h.n5X.QUICKSWITCHER] && m(e, r.M.CHANNEL_NOTICE_QUICKSWITCHER) && (t = !0),
                !1 === n[h.n5X.GUILD_BOOSTING] && m(e, r.M.CHANNEL_NOTICE_PREMIUM_GUILD_SUBSCRIPTION) && (t = !0),
                t
            );
        },
        cleanup() {
    ...
    },
    {
        ...
        run(e) {
            let t = !1;
            return (
                s.w.get("hideNag") && m(e, r.M.NAGBAR_NOTICE_DOWNLOAD) && (t = !0),
                s.w.get("hideConnectSpotify") && m(e, r.M.NAGBAR_NOTICE_CONNECT_SPOTIFY) && (t = !0),
                s.w.get("hideConnectPlayStation") && m(e, r.M.NAGBAR_NOTICE_CONNECT_PLAYSTATION) && (t = !0),
                t
            );
        },
        cleanup() {
    ...
    },
    {
        ...
        run(e) {
            let t = !1;
            return (
                s.w.get("hidePremiumPromo") && m(e, r.M.NAGBAR_NOTICE_PREMIUM_PROMO) && (t = !0),
                s.w.get("hidePremiumTier2TrialEnding") &&
                    m(e, r.M.NAGBAR_NOTICE_PREMIUM_TIER_TWO_TRIAL_ENDING) &&
                    (t = !0),
                s.w.get("hidePremiumReactivateNotice") && m(e, r.M.NAGBAR_NOTICE_PREMIUM_REACTIVATE) && (t = !0),
                t
            );
        },
        cleanup() {
    ...
    },
    {
        ...
        run(e) {
            let t = !1;
            return s.w.get("forumHelperCardStorageKey") && (t = m(e, r.M.FORUM_CHANNEL_HELPER_CARD)), t;
        },
        cleanup() {
