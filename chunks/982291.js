...
function E(e) {
    let { initialPlanId: t } = e,
        ...
        E = (0, m.t4)((e) => e.getIsInOneStepSubscriptionCheckout({ isTrial: h })),
        f = (0, u.px)(s, c, d),
        A = i.useMemo(() => {
            let e = null == t ? a.pn.PLAN_SELECT : a.pn.REVIEW;
            return E && (e = a.pn.REVIEW), f && (e = a.pn.SELECT_FREE_SKU), e;
        }, [E, f, t]);
    return (0, l.jsx)(C, { paymentModalStepProps: e, returnStep: a.pn.REVIEW, returnStepIfNoPaymentSources: A });
}
function f(e) {
