...
class u {
    constructor(e) {
        if (
            (o(this, "capture", void 0),
            o(this, "encode", void 0),
            o(this, "bitrateMin", void 0),
            o(this, "bitrateMax", void 0),
            o(this, "bitrateTarget", void 0),
            o(this, "localWant", void 0),
...
class d {
    ...
    constructor(e) {
        o(this, "width", void 0),
            ...
            o(this, "framerate", void 0),
            o(this, "pixelCount", void 0),
            (this.width = e.width),
...
class f {
    ...
    getGoliveQuality(e, t) {
        ...
        let r = Math.ceil(this.goliveMaxQuality.bitrateMin * n),
            ...
            o =
                null != this.goliveMaxQuality.bitrateTarget
                    ? Math.ceil(this.goliveMaxQuality.bitrateTarget * n)
                    : void 0;
        var a,
            s,
            l = void 0;
        ...
        return new u({
            ...
            bitrateTarget: null != o ? Math.max(o, this.options.videoBitrateFloor) : void 0,
            localWant: e,
        });
    }
    ...
    getGoliveLQQuality() {
        ...
        return new u({
            capture: {
                ...
                height: Math.min(
                    i.ru,
                    null != (f = null == (o = this.goliveMaxQuality.capture) ? void 0 : o.height) ? f : i.ru,
                ),
                framerate: Math.min(
                    i.R$,
                    null != (_ = null == (a = this.goliveMaxQuality.capture) ? void 0 : a.framerate) ? _ : i.R$,
                ),
            },
            encode: {
                width: p,
    ...
    constructor(e, t, n = i.kS) {
        o(this, "contextType", void 0),
            ...
            o(this, "goliveSimulcastLQBitrateMax", void 0),
            o(this, "goliveSimulcastLQBitrateTarget", void 0),
            o(this, "goliveUsePixelCounts", void 0),
            o(this, "goliveAdjustResolution", void 0),
            o(this, "isStreamContext", void 0),
            o(this, "ladder", void 0),
            o(this, "lastGoLivePixelCount", void 0),
            (this.contextType = e),
            (this.connection = t),
            (this.options = n),
            (this.isMuted = !1),
