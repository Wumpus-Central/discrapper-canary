...
function q(e) {
    let t,
        { user: n, currentUser: s, stream: q, className: X, onClose: Z } = e,
        ...
        { previewUrl: el, isLoading: eu } = (0, C.A)(q?.guildId, q?.channelId, q?.ownerId),
        [ec, ed] = (0, R.zP)(et),
        e_ = (0, T.a9)() && (0, T.UK)(et?.id),
        eh = (0, o.bG)([D.A], () => null != et && !e_ && D.A.canBasicChannel(H.hVb.CONNECT, et)),
        ef = (0, g.A)(eu ? null : el),
        ep = eu || null == el ? ef : el,
        eE = r.useId();
    ...
    let em = () =>
            n.id === s.id
                ...
                : (0, i.jsx)("div", {
                      className: W.o1,
                      children: (0, i.jsx)(V.Ay, { channel: et, onAction: ea, onClose: Z }),
                  }),
    ...
    return (0, i.jsx)(y.f5, {
        ...
        children: (0, i.jsxs)(k.A, {
            ...
            children: [
                (0, i.jsx)(U.A, {
                    text: eg,
                    tags: (0, i.jsx)(v.Ay, { size: v.ed.SMALL }),
                    contextMenu: (0, i.jsx)(B.A, { display: "live", user: n, onClose: Z }),
                }),
                ...
                (0, i.jsxs)("div", {
                    ...
                    children: [
                            ...
                            children: [
                                ...
                                Q !== j.d.MODAL && Q !== j.d.MODAL_V2
                                    ...
                                    : (0, i.jsxs)("div", {
                                          className: W.zH,
                                          children: [
                                              (0, i.jsx)(G.A, { channel: et, guild: ee, onAction: ea, onClose: Z }),
                                              (0, i.jsx)(l.A, {
                                                  users: ei,
                                                  guildId: ee.id,
                                                  channelId: et.id,
                        ...
                        Q === j.d.MODAL || Q === j.d.MODAL_V2
                            ? null
                            : (0, i.jsx)(F.A, { user: n, guild: ee, channel: et, onAction: ea, onClose: Z }),
                    ],
                }),
