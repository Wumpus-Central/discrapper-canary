...
class eA extends i.PureComponent {
    ...
    handleJoinServer = async () => {
        ...
        try {
            await f.A.joinGuild(e, { source: b.Q4z.CHAT_INPUT_BLOCKER });
        } catch {
    ...
    render() {
        ...
        if (e && !p && null != v)
            null != v.gameIconUrl && (L.imageSrc = v.gameIconUrl),
                (L.message = F.intl.format(F.t["qxH/YE"], { gameName: v.gameName })),
                ...
                : y || null == N
                  ? i && !I
                      ...
                      : s
                        ...
                        : a
                          ? ((L.message = F.intl.formatToPlainString(F.t.IH7RMF, { min: b.$8o.MEMBER_AGE })),
                            (L.countdown = r))
                          : o &&
                            ((L.message = F.intl.formatToPlainString(F.t["2JA2GH"], { min: b.$8o.ACCOUNT_AGE })),
                            (L.countdown = c))
...
function ef(e) {
    let { channel: t, children: n } = e,
        ...
        c = t.type === b.rbe.GUILD_ANNOUNCEMENT && null != a && a.features.has(b.GuildFeatures.NEWS),
        ...
        f = (0, r.bG)([eo.A], () => eo.A.can(b.xBc.SEND_MESSAGES, t)),
        x = (0, r.bG)([D.A], () => D.A.getRequest(s)),
        { showLinkedLobbyApplicationLoadingIndicator: E, requiredLinkedLobbyApplication: N } = (0, eu.A)(t.linkedLobby),
        v = (function (e) {
            let { channelId: t } = e,
                n = (0, r.bG)([y.A], () => {
            ...
            let o =
                s?.iconHash != null && "" !== s.iconHash
                    ? _.Ay.getGameAssetURL({ id: s.id, hash: s.iconHash, size: b.eQT })
                    : void 0;
        ...
        T = {
            ...
            showLurkerModeUpsellPopout: u && null != a && ed.MJ(b.xBc.SEND_MESSAGES, t),
            theme: el.A.theme,
            canSendMessages: f,
