...
var e = n(17928),
    ...
    c = n(375708);
function b(t) {
    let [i, n, b] = (0, e.yK)([l.A], () => [l.A.isMuted(t.id), l.A.getMuteConfig(t.id), l.A.hasJoined(t.id)]),
        g = (0, d.M)(n);
    function h(i) {
        a.A.setNotificationSettings(t, { muted: i });
    }
    return b
        ? i
            ? (0, s.jsx)(r.Dr, {
            ...
            : (0, s.jsx)(r.Dr, {
                  ...
                  action: () => h(!0),
                  children: (0, u.g)().map((i) => {
                      let { value: n, label: e } = i;
                      return (0, s.jsx)(
                          r.Dr,
                          {
                              id: `${n}`,
