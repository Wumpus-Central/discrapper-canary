...
function Q(e, t) {
    (F[e] = t), t ? b.add(e) : b.delete(e);
}
function J(e) {
    delete F[e], b.delete(e);
}
function ee() {
...
class el extends l.Ay.PersistedStore {
    ...
    getParticipants(e) {
        return H(e).toArray() ?? y;
    }
    getSpeakingParticipants(e) {
        return H(e).toArray(C.r4.SPEAKING) ?? y;
    }
    ...
    getVideoParticipants(e) {
        return H(e).toArray(C.r4.VIDEO) ?? y;
    }
    getStreamParticipants(e) {
        return H(e).toArray(C.r4.STREAM) ?? y;
    }
    getActivityParticipants(e) {
        return H(e).toArray(C.r4.ACTIVITY) ?? y;
    }
    getParticipant(e, t) {
    ...
    getMode(e) {
        return w[e] ?? (es(e) ? L._Of.VIDEO : L._Of.VOICE);
    }
    getLayout(e) {
    ...
    getChatOpen(e) {
        return F[e] ?? f.A.getChannel(e)?.isVocalThread() ?? !1;
    }
    getAllChatOpen() {
        return F;
    }
...
let eo = new el(o.h, {
    ...
    VOICE_CHANNEL_SELECT: function (e) {
        ...
        if (
            (null != t
                ? delete U[t]
                : null != n &&
                  ((!F[n] || O.getConfig({ location: "handleVoiceChannelSelect" }).closeChatOnLeave) && J(n),
                  delete V[n],
                  $(n)),
            t !== n && null != n)
        ) {
    ...
    SPEAKING: et,
    GUILD_SOUNDBOARD_SOUND_PLAY_START: et,
    GUILD_SOUNDBOARD_SOUND_PLAY_END: et,
