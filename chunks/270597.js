...
function o(e) {
    let t,
        {
            ...
            onDataBindingChange: c,
        } = e,
        _ = d ?? u,
        f = (0, i.useViewModel)(n);
    (0, i.useViewModelInstance)(f);
    let { theme: E, saturation: h } = (0, a.G9)(),
        { highContrastModeEnabled: p } = r.useContext(s.C),
        m = r.useRef({}),
        g =
            ((t = r.useRef({})),
    ...
    (function (e) {
    ...
    })({ rive: n, artboard: o, artboardProperties: l, dynamicDataBinding: d, dataBinding: u, onDataBindingChange: c }),
        r.useEffect(() => {
                        ...
                        switch (o) {
                            case "color":
                                if ("number" == typeof l) {
                                    ...
                                    if ("resolve" in l) {
                                        let [e, t, r, s] = l
                                            .resolve({ theme: E, saturation: h, highContrastModeEnabled: p })
                                            .rgba();
                            ...
                            case "number":
                                ...
                                break;
                            case "boolean":
                                let d = n.viewModelInstance?.boolean(i);
                                null != d && (d.value = l);
                                break;
                            case "trigger":
                                let c = null != l && ("boolean" == typeof l ? l : 0 !== l),
                                    _ = A(m.current, i);
                                c && _ !== l && n.viewModelInstance?.trigger(i)?.trigger(), (m.current[i] = l);
                                break;
                            case "string":
        ...
        }, [A, _, n, o, l, E, n?.viewModelInstance, h, p, g]);
}
