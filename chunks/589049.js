...
var a = l(477900),
    ...
    y = l(931540);
function w(e) {
    let { icon: t, title: l, body: n, position: i, compact: r } = e;
    return (0, a.jsx)(m.u, {
        title: l,
        body: n,
        position: "top",
        children: (0, a.jsx)("div", {
            ...
            style: { left: `${i}%` },
            children: (0, a.jsx)(t, { size: "refresh_sm", color: d.A.colors.ICON_DEFAULT }),
        }),
    });
}
let N = {
...
function E(e, t, l, n) {
    ...
    return (0, a.jsx)(
        w,
        { icon: i, title: C.intl.string(s), body: C.intl.string(b.default["ry+jxm"]), position: l, compact: n },
        t,
    );
}
function k(e) {
    ...
    return null == t.emojiId && null == t.emojiName
        ? (0, a.jsx)(w, { icon: h.J, title: t.name, body: o, position: n, compact: i })
        : (0, a.jsx)(m.u, {
              title: t.name,
              body: o,
              position: "top",
    ...
    return [
        ...
        ...o.map(function (e) {
            ...
            switch (e.signal.type) {
                case j.Gy.LAUGHTER:
                    return E(j.Gy.LAUGHTER, n, l, i);
                case j.Gy.SHOUTING:
                    return E(j.Gy.SHOUTING, n, l, i);
                ...
                case j.Gy.SOUNDBOARD:
                    ...
                    return (0, a.jsx)(k, { signal: e.signal, guildId: t.guildId, position: l, compact: i }, n);
                default:
                    return null;
            }
        }),
...
let R = n.memo(function (e) {
    let { videoLength: t, clip: l, onMouseDown: i, noBottomMargin: o = !1, compact: c = !1 } = e,
        { timeNotches: u, subNotches: d } = n.useMemo(() => {
            let e;
    ...
    return (0, a.jsx)("div", {
        ...
        children: (0, a.jsxs)("div", {
            ...
            children: [
                d.map((e, t) =>
                    (0, a.jsx)(
                        "div",
                        {
                            ...
                            children: (0, a.jsx)("div", { className: L.p }),
                        },
                        `sub-${t}`,
                    ),
                ),
                ...
                (0, a.jsx)(A, { clip: l, videoLength: t, compact: c }),
            ],
        }),
    });
});
