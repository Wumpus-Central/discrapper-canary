...
function O(e) {
    let { user: t, context: O, label: E, joinCallVideo: _, id: y, onCall: v } = e,
        h = (0, a.Aq)(),
        p = (0, r.e7)([c.default], () => c.default.getId() === t.id),
        Z = (0, r.e7)([d.Z], () => d.Z.isBlocked(t.id)),
        m = (0, r.e7)([f.Z, s.Z], () => f.Z.getVoiceChannelId() === s.Z.getDMFromUserId(t.id));
    if (p || O === g.IlC.POPOUT || m || t.bot || t.isProvisional) return null;
    let S = () => {
            null == v || v(),
