...
var i,
    ...
    y,
    C,
    N = (((i = {})[(i.ROLE = 0)] = "ROLE"), (i[(i.MEMBER = 1)] = "MEMBER"), i),
    ...
    P =
        ...
        _),
    x =
        (((h = {})[(h.APP_HANDLER = 1)] = "APP_HANDLER"),
        (h[(h.DISCORD_LAUNCH_ACTIVITY = 2)] = "DISCORD_LAUNCH_ACTIVITY"),
        h),
    k =
        (((f = {})[(f.SUB_COMMAND = 1)] = "SUB_COMMAND"),
        (f[(f.SUB_COMMAND_GROUP = 2)] = "SUB_COMMAND_GROUP"),
        (f[(f.STRING = 3)] = "STRING"),
        (f[(f.INTEGER = 4)] = "INTEGER"),
        (f[(f.BOOLEAN = 5)] = "BOOLEAN"),
        (f[(f.USER = 6)] = "USER"),
        (f[(f.CHANNEL = 7)] = "CHANNEL"),
        (f[(f.ROLE = 8)] = "ROLE"),
        (f[(f.MENTIONABLE = 9)] = "MENTIONABLE"),
        (f[(f.NUMBER = 10)] = "NUMBER"),
        (f[(f.ATTACHMENT = 11)] = "ATTACHMENT"),
        f),
    U =
        (((p = {})[(p.CHAT = 1)] = "CHAT"),
        (p[(p.USER = 2)] = "USER"),
    ...
    B =
        ...
        A),
    j = (((I = {})[(I.SMALL = 1)] = "SMALL"), (I[(I.PARAGRAPH = 2)] = "PARAGRAPH"), I),
    H = (((T = {})[(T.SMALL = 1)] = "SMALL"), (T[(T.LARGE = 2)] = "LARGE"), T),
    Y =
