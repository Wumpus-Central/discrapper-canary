...
function x(e) {
    let { guildId: t, triggerType: n } = e,
        ...
        [h] = s.useState(x),
        [_, A] = s.useState(!1),
        { editingRule: p, createNewEditingRule: f } = (0, c.U)(),
        { getDefaultRuleName: j } = d.i$[n],
        N = !(0, o.wC)(p) && p?.triggerType === n,
        [E, b] = s.useState(N ? p : h),
        T = (0, a.zhh)({ opacity: +!N, pointerEvents: N ? "none" : "all", config: { ...l.config.stiff, clamp: !0 } }),
        C = (0, a.zhh)({
            opacity: +!!N,
