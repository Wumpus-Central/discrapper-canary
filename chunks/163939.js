...
function tD() {
    return (0, l.jsx)(eX, {
        textStyles: tR.U,
        bannerIcon: (0, l.jsx)(tv.x, { size: "lg" }),
...
let tZ = i.memo(function (e) {
        let { channelId: t, width: n } = e,
            ...
            a = (0, h.bG)([tV.Ay], () => tV.Ay.getMostRecentMessageCombo(t), [t]),
            [r, o] = i.useState(!1);
        i.useEffect(() => {
        ...
        return (
            ...
            (0, l.jsx)(F.animated.div, {
                className: tJ.Gi,
                style: d,
                children: (0, l.jsx)(q.E, { className: tJ.fX, variant: "text-sm/bold", children: (0, tq.RL)(a.combo) }),
            })
        );
    }),
    tY = i.memo(function (e) {
        ...
        return (0, l.jsxs)(l.Fragment, {
            children: [
                (0, l.jsx)(q.E, { className: tJ.iR, variant: "text-sm/bold", children: t }),
                (0, l.jsxs)("div", {
                    className: tJ._Z,
                    style: { color: s },
                    children: [
                        ...
                        r &&
                            (0, l.jsxs)(l.Fragment, {
                                children: [
                                    (0, l.jsx)("div", { className: a()(tJ.QA, tJ.kb), style: { backgroundColor: s } }),
                                    (0, l.jsx)("div", { className: a()(tJ.QA, tJ.pG), style: { backgroundColor: s } }),
                                ],
                            }),
                        o &&
                            (0, l.jsxs)(l.Fragment, {
                                children: [
                                    (0, l.jsx)("div", {
                                        className: a()(tJ.ox, tJ.kb),
                                        children: (0, l.jsx)(tW.A, { width: 24, height: 24 }),
                                    }),
                                    (0, l.jsx)("div", {
                                        className: a()(tJ.ox, tJ.pG),
                                        children: (0, l.jsx)(tW.A, { width: 24, height: 24 }),
                                    }),
                                ],
                            }),
    ...
    tX = i.memo(function (e) {
        let t,
            ...
            a = (0, h.bG)([tz.A], () => tz.A.isTyping(n, s), [n, s]),
            r = (0, h.bG)([tB.A], () => tB.A.isEnabled()),
            o = (0, h.bG)([tV.Ay], () => tV.Ay.isComboing(s, n), [n, s]),
            { ref: c, width: d = 0 } = (0, tK.Ay)(),
            [u, m] = i.useState(!1),
            g =
                ((t = (0, h.bG)([tB.A], () => !!tB.A.isEnabled() && tB.A.combosEnabled)),
                (0, h.bG)(
                    [tV.Ay, e0.default],
                    () => (t ? tV.Ay.getUserCombo(e0.default.getId(), n) : void 0),
                    [n, t],
                    t$,
                )),
            p = r && o && a;
        ...
        return (0, l.jsxs)(l.Fragment, {
            children: [
                (0, l.jsx)(tZ, { channelId: n, width: d }),
                (0, l.jsx)(F.animated.div, {
                    ref: c,
                    className: tJ.p_,
                    style: A,
                    children: (0, l.jsx)(tY, { value: x, multiplier: E }),
                }),
            ],
        });
    });
...
let t4 = () =>
    (0, l.jsx)(eX, {
        bannerIcon: (0, l.jsx)(t1.M, { alt: "", width: 80, height: 40 }),
        bannerHeader: eD.intl.string(eD.t.EouHwv),
        bannerSubtext: eD.intl.format(eD.t.PThBel, { appealLink: t3.q }),
    });
var t7 = n(118517),
    t5 = n(853145),
    t8 = n(226698),
...
let ne = (e) => {
    let { channelId: t } = e,
        n = i.useCallback(() => {
            t8.A.reopenModReport(t);
        }, [t]);
    return (0, l.jsx)(eX, {
        bannerHeader: (0, l.jsx)(q.E, {
            variant: "text-md/medium",
            color: "text-muted",
            children: eD.intl.string(t6.default["0eUUeF"]),
        }),
        headerStyles: t9.U,
        containerStyles: t9.c,
        children: (0, l.jsx)(W.$, {
            variant: "secondary",
            size: "sm",
            text: eD.intl.string(t6.default["6quCi9"]),
            onClick: n,
        }),
    });
};
var nt = n(151282),
    ...
    nm = n(287809);
function ng(e) {
    let t = nu.A.getChannel(e),
        n = null != t ? (0, nd.m1)(t, nm.default, nh.A) : null,
        l = null == n ? eD.intl.string(eD.t.gi2swM) : eD.intl.formatToPlainString(eD.t.IFPJ6J, { channelName: n });
    (0, nr.P0)((0, no.o)(l, nc.Ck.SUCCESS));
}
var np = n(728321),
    nA = n(761640),
    nf = n(580745),
...
let nw = i.forwardRef((e, t) => (0, l.jsx)(nF, { ...e, ref: t }));
nw.displayName = "ChannelTextAreaForm";
class nF extends i.PureComponent {
    focusEditor() {
    ...
    componentDidUpdate(e, t) {
        ...
        t.textValue.length < eM.uvi && l.length >= eM.uvi && nE.default.track(eM.HAw.MESSAGE_LENGTH_LIMIT_REACHED, {});
    }
    draftDidChange = (() => {
        var e = this;
        return function () {
    ...
    handleKeyDown = (e) => {
        ...
        switch (e.key) {
            case nk.dh.DELETE:
            case nk.dh.BACKSPACE:
                return void this.handleIncrementCombo("", 1);
            case nk.dh.ARROW_UP:
                if (i || s) return;
                if ((e.preventDefault(), t))
                    ex.A.getUploadCount(l.id, eC.C.ChannelMessage) > 0
                        ? n_._.dispatchToLastSubscribed(eM.jej.FOCUS_ATTACHMENT_AREA)
                        : n_._.dispatchToLastSubscribed(eM.jej.FOCUS_MESSAGES, { atEnd: !0 });
                else {
    ...
    handleIncrementCombo = (e, t) => {
        ...
        let n = this.props.channel.id,
            l = e0.default.getId(),
            i = tV.Ay.getUserCombo(l, n),
            s = (i?.value ?? 0) + 1;
        (0, tH.oG)({ channelId: n, userId: l, value: null != e ? e.length : s, multiplier: t });
    };
    handleTextareaChange = (e, t, n) => {
        ...
        let s = "" !== t && n !== this.state.richValue,
            a = s && !nG.test(t) && !t.startsWith("/") && (!this.isFirstChange || t !== this.state.textValue);
    ...
    handleSendMessage = async (e) => {
        ...
        if (null != i) {
            if (i.inputType === k.y$.BUILT_IN_INTEGRATION)
                return (
                    n_._.dispatch(eM.jej.SHAKE_APP, { duration: 200, intensity: 2 }),
            ...
            if (null == e || e === k.iw.CHAT) {
                ...
                let { location: t, sectionName: n } = (0, nT.bV)(i) ?? {},
                    l = e === k.iw.APPLICATION_LAUNCHER ? N.A.lastShownEntrypoint() : v.s4.TEXT,
        ...
        return (0, nI.i)({
            ...
            if (null != n && n.length > 0) {
                let e = (0, nj.LJ)(n);
                if ((0, nj.fJ)(e, d?.id)) return (0, eI.V)(h, e), { shouldClear: !1, shouldRefocus: !1 };
                (I.eagerDispatch = !1),
            ...
            if (null != I.scheduledTimestamp)
                try {
                    await (0, nt.pr)({
                        ...
                        (0, nl.c_)(I.scheduledTimestamp);
                } catch (e) {
                    return (0, nl.kM)(e.message), { shouldClear: !1, shouldRefocus: !1 };
                }
            else
                E.A.sendMessage(h.id, _, void 0, I).then(() => {
                    p && ng(h.parent_id ?? void 0);
        ...
        return (0, l.jsx)(m.Y, {
            ...
            renderPopout: (e) => {
                ...
                return (
                    ...
                    (0, l.jsx)(tU.A, { onClose: t, ...C })
                );
            },
            children: () =>
                p ? (0, l.jsx)(g.b, { isShaking: h > 0, intensity: h, className: nP.Xn, children: E }) : E,
        });
    }
}
class nH extends i.PureComponent {
    ...
    componentDidMount() {
        n_._.subscribe(eM.jej.FOCUS_CHANNEL_TEXT_AREA, this.handleRequestFocus);
    }
    ...
    componentWillUnmount() {
        n_._.unsubscribe(eM.jej.FOCUS_CHANNEL_TEXT_AREA, this.handleRequestFocus);
    }
    ...
    _handleMoveToPane = (e) => {
        ...
        if (t)
            switch (e.key) {
                case nk.dh.ARROW_LEFT:
                    n === U.oU.SIDEBAR &&
                        n_._.dispatch(eM.jej.FOCUS_CHANNEL_TEXT_AREA, { channelId: nC.A.getChannelId() });
                    return;
                case nk.dh.ARROW_RIGHT:
                    n === U.oU.NORMAL &&
                        n_._.dispatch(eM.jej.FOCUS_CHANNEL_TEXT_AREA, {
                            channelId: nA.Ay.getCurrentSidebarChannelId(l.id),
                        });
            }
    };
            ...
            v && t.type === eM.rbe.GUILD_VOICE
                ...
                : v && t.type === eM.rbe.GUILD_STAGE_VOICE
                  ...
                  : d.k.THREADS.has(t.type)
                    ? eD.t["OkzL+Q"]
                    : eD.t.UbNmGc;
        let M = (0, l.jsx)("div", { className: nP.li, children: (0, l.jsx)(nM, {}) }),
            R = (0, l.jsx)("div", {
                className: nP.li,
            ...
            D = y ? M : R,
            L = (0, nd.m1)(t, nm.default, nh.A);
        return (0, l.jsx)(
            I.A,
            {
                page: (0, nx.DJ)(this.props.channel),
                children: (0, l.jsx)(tN.di, {
                    children: (0, l.jsx)(tT.Xq, {
                        children: (0, l.jsxs)(nS.Ah, {
                            ref: this.dispatchGroupRef,
                            children: [
                                (0, l.jsx)(nS.EG, { event: eM.jej.TEXTAREA_FOCUS, handler: this.handleInputFocus }),
                                (0, l.jsx)(nS.EG, { event: eM.jej.TEXTAREA_BLUR, handler: this.handleInputBlur }),
                                (0, l.jsx)(nS.EG, {
                                ...
                                (0, l.jsxs)(nU, {
                                    ...
                                    children: [
                                        (0, l.jsx)(nN.A, { channel: t, guild: n, narrow: v }),
                                        (0, l.jsxs)(p.F, {
                                                        ...
                                                        x
                                                            ...
                                                            : (this.renderMessageBanner({
                                                              ...
                                                              (0, l.jsxs)("form", {
                                                                  ...
                                                                  onSubmit: nO,
                                                                  className: a()(nP.Zd, { [nP.Mf]: !y }),
                                                                  children: [
                                                                      E && (0, l.jsx)(tX, { channelId: t.id }),
                                                                      t.isPrivate()
                                                                          ? (0, l.jsx)(nR.A, {
                                                                                channel: t,
                                                                                children: D,
...
let nV = i.memo(function (e) {
    ...
    let s,
        ...
        { placeholder: p, accessibilityLabel: A } = (0, nb.A)({ channel: d }),
        C =
            ((t = nm.default.getCurrentUser()),
            (s = (0, t2.r)(d)),
            (a = (0, h.bG)([ts.A], () => ts.A.getMessages(d.id).length > 0, [d])),
            null != t && t.hasFlag(eM.nhx.QUARANTINED) && s && !a),
        [x] = (0, tg.c)(u?.id),
        S = (0, eJ.uZ)(u?.id),
        I = (0, h.bG)([nm.default], () => nm.default.getCurrentUser()),
        j = (0, h.bG)([e1.Ay], () => null != I && (e1.Ay.getMember(u?.id ?? eM.dJq, I?.id)?.isPending ?? !1)),
        b = (0, h.bG)([tB.A], () => tB.A.isEnabled()),
        T =
            ((n = d.id),
            (r = (0, tQ.A)(t0.uD.CHAT_INPUT)),
            (o = (0, h.bG)([tB.A], () => tB.A.isEnabled({ shakeLocation: t0.uD.CHAT_INPUT }))),
            (0, h.bG)([tz.A, tV.Ay, e0.default], () =>
                o && tz.A.isTyping(n, e0.default.getId())
                    ? tV.Ay.getUserComboShakeIntensity(e0.default.getId(), n, r)
                    : 0,
            )),
        N = (0, tb.A)(d.id),
        v = ((c = d.id), (0, h.bG)([nn.A], () => nn.A.getPendingScheduledMessage(c))),
        M = (0, h.bG)([na.A], () => na.A.getAlsoSendToChannel(d.id)),
        R = (0, h.bG)([tV.Ay, e0.default], () => tV.Ay.getUserCombo(e0.default.getId(), d.id)),
        D = (0, _.rj)(d),
        L = (0, _.aW)(d),
        k = D.length > 0 || d.rateLimitPerUser > 0 || null != R || null != L,
        { showLinkedLobbyApplicationLoadingIndicator: P } = (0, ny.A)(d.linkedLobby),
        O = eW.useConfig({ location: "ChannelChat" }).announcementComposer,
        G = (0, tF.A)((0, tk.GP)(u, "ChannelChat") ? (u?.officialMessageColor ?? nL.aj) : null);
    return (
        !(function (e) {
            let [t, n] = (function (e) {
