...
function O(e) {
    let { channel: t, transitionState: n, sourceAnalyticsLocations: O, onClose: R } = e,
        L = (0, _.l)(t),
        y = (0, l.bG)([f.A], () => f.A.getMediaSessionId()),
        [D, v] = r.useState(L ?? ""),
        [b, M] = r.useState(!1),
        [P, U] = r.useState(null),
    ...
    async function F(e) {
        D === L && R(), e?.preventDefault(), U(null), M(!0);
        let n = D.length,
    ...
    return (0, i.jsx)(s.k, {
        ...
        actions: [
            { variant: "secondary", text: g.intl.string(g.t["ETE/oC"]), onClick: R },
