...
let S =
    ...
    o.forwardRef(function (e, t) {
        ...
        let R = o.useCallback(
            (e) => {
                null == N.current ? T(!0) : clearTimeout(N.current),
        ...
        return (
            o.useEffect(() => () => clearTimeout(N.current), []),
            (0, E.A)({ ref: b, key: "container", onUpdate: c, resizeObserver: i, listenerMap: l }),
            (0, E.A)({ ref: j, key: "content", onUpdate: c, resizeObserver: i, listenerMap: l }),
            (0, r.jsx)("div", {
                ref: b,
                className: d()(a, { [x.Rv]: A, [x.D8]: S, [s]: !0, [x.fs]: !0, [x.qw]: y && A }),
                style: _,
                dir: m,
                onScroll: R,
                ...I,
                children: (0, r.jsx)(g.xp, {
                    ...
                    children: (0, r.jsxs)("div", {
                        ref: j,
                        className: d()(u, x.Qs),
                        children: [n, y && (0, r.jsx)("div", { className: x.X3 })],
                    }),
                }),
            })
        );
...
let er = o.memo(function (e) {
    let t,
        ...
        N = (0, X.z)({ y: c.y, opacity: +!c.hidden, config: W }, "respect-motion-settings"),
        j = (0, X.z)(
            {
                ...((t = h && C),
                (n = 0),
    ...
    return (0, r.jsxs)(ei, {
        ...
        style: {
            transform: N.y.to((e) => `translateY(${e}px)`),
            opacity: N.opacity,
        ...
        children: [
            ...
            (0, r.jsx)(es, {
                ...
                lineClamp: 1,
                style: {
                    opacity: j.textOpacity,
                    transform: (0, u.to)([j.textScale, j.textX], (e, t) => `scale(${e}) translateX(${t}px)`),
                },
                children: _,
            }),
            (0, r.jsx)("span", {
                ...
                children: (0, r.jsx)(u.animated.span, {
                    ...
                    style: {
                        width: j.lineWidth,
                        opacity: j.lineOpacity,
                        transform: j.lineScaleX.to((e) => `scaleX(${e})`),
                    },
                }),
            }),
            (0, r.jsx)(u.animated.span, {
                ...
                "aria-hidden": "true",
                style: {
                    opacity: j.arrowOpacity,
                    transform: (0, u.to)([j.arrowX, j.arrowScale], (e, t) => `translateX(${e}px) scale(${t})`),
                },
                children:
                    "down" === S
...
function e_(e) {
    ...
    o.useEffect(() => {
        ...
        o.useEffect(() => {
            null != y && B.trackPreviewImpression({ channel: t, conversationId: y });
        }, [t, y]);
    let T = o.useCallback((e) => {
        ...
        M = o.useCallback(() => (null != y ? (0, r.jsx)(ex, { channel: t, conversationId: y }) : null), [t, y]),
        R = o.useCallback(
            (e) => {
                let t;
...
function e1(e) {
    ...
    return o.useMemo(() => {
        ...
        return (0, r.jsx)("div", {
            ...
            style: { height: i },
            children: n.map((n, l) =>
                (0, r.jsx)(eQ.Ay, { groupSpacing: s, compact: t, messages: n, attachmentSpecs: e[l] }, l),
            ),
        });
    }, [t, n, l, i, s]);
}
        ...
        o.useCallback(
            (n) => {
                ...
                switch (n.key.toLowerCase()) {
                    case "backspace":
                        i &&
                            (eO.A.can(F.xBc.MANAGE_MESSAGES, d) || c.canDeleteOwnMessage(u)) &&
                    ...
                    case "+":
                        (i || o) &&
                            (function (e) {
                                let t = null == e.guild_id || eP.A.canChatInGuild(e.guild_id),
                                    n = em.jW.getSetting(),
                                    { disableReactionCreates: l } = (0, tk.A)({
                                        channel: e,
                                        canChat: t,
                                        renderReactions: n,
                                        canAddNewReactions: t && eO.A.can(F.xBc.ADD_REACTIONS, e),
                                        isLurking: null != e.guild_id && tj.A.isLurking(e.guild_id),
                                        isActiveChannelOrUnarchivableThread: (0, tT.jr)(e),
                                    });
                                return !l && n;
                            })(d) &&
                            (n.preventDefault(),
                            e4._.dispatchKeyed(F.zOV.TOGGLE_REACTION_POPOUT, c.id, { emojiPicker: !0 }));
                        break;
                    case "r":
                        (i || o) && (0, ty.r)(d, c) && (n.preventDefault(), (0, tO.$b)(d, c, n));
                        break;
                    case "f":
                        (i || o) &&
                            (0, tI.p)(c) &&
                    ...
                    case "t":
                        if (i && (0, tT.D1)(d, c)) n.preventDefault(), (0, tb.Tv)(d, c, "Message Shortcut");
                            ...
                            let e = th.A.getChannel(z.default.castMessageIdAsChannelId(c.id));
                    ...
                    case "enter":
                        ...
                        break;
                    case "escape":
                        eL.A.isEditing(d.id, c.id) ? I.A.endEditMessage(d.id) : e4._.dispatch(F.jej.TEXTAREA_FOCUS);
                }
            },
            [e, t],
        )
...
let tX = o.memo(function (e) {
    ...
    tQ = o.memo(function (e) {
        let { className: t, compact: n, message: l, children: i, content: s, onUpdate: a } = e,
            ...
            u = o.useRef(!1),
            h = (0, m.bG)([tr.A], () => tr.A.getMessage(l.id), [l.id]),
            A = o.useCallback(() => {
                if (h?.isBlockedEdit) {
                    var e;
...
function nv(e) {
    ...
    return (0, r.jsx)(G.Y, {
        ...
        clickTrap: !0,
        children: () =>
            (0, r.jsx)(ny.qv, { ref: a, label: en.intl.string(en.t.lfIHs4), icon: nb.n, onClick: l }, "add-reaction"),
    });
}
var nM = n(720882),
    nR = n(307731),
    nD = n(237774);
let nL = [nh.Ay.getByName("100"), nh.Ay.getByName("laughing"), nh.Ay.getByName("sparkling_heart")].filter(nN.Vq);
function nP(e) {
    e.stopPropagation();
}
function nk(e) {
...
function nG(e) {
    let {
            ...
            let {
                ...
                u = (0, m.bG)([eR.default], () => eR.default.getId()),
                h = (0, tT.Id)(t),
                A = (0, tT.s5)(t),
                { firstMessage: g } = (0, m.bG)([nA.A], () => nA.A.getMessage(t.id), [t.id]),
                p = em.jW.useSetting(),
                f = em.Q_.useSetting(),
                C = (0, m.bG)([eP.A], () => null == t.guild_id || eP.A.canChatInGuild(t.guild_id), [t]),
                { canManageMessages: E, canAddNewReactions: x } = (0, m.cf)(
                    [eO.A],
                    () => ({
                        canAddNewReactions: C && eO.A.can(F.xBc.ADD_REACTIONS, t),
                        canManageMessages: eO.A.can(F.xBc.MANAGE_MESSAGES, t),
                    }),
                    [t, C],
                ),
                S = (0, ty.u)(t, n),
                _ = (0, tT.n)(t, n),
                I = (0, tT.R)(n),
                N = (0, m.bG)([tj.A], () => null != t.guild_id && tj.A.isLurking(t.guild_id), [t]),
                j = c.id === u,
            ...
            let b = (0, nj.ul)(n),
                ...
                P =
                    ...
                    eO.A.canWithPartialContext(F.xBc.MANAGE_GUILD, { guildId: L }),
                k = (0, tI.m)(n),
                ...
                H = (0, t2.A)(a),
                B = (0, m.bG)([y.A], () => y.A.keyboardModeEnabled);
            return {
                channel: t,
                message: n,
                canPin: v,
                      ...
                      children: [
                          ...
                          N
                              ? (0, r.jsx)(
                                    ny.qv,
                                    {
                                        label: j ? en.intl.string(en.t.LHUP9D) : en.intl.string(en.t["9p3D9p"]),
                                        icon: j ? t8.c : t6.c,
                                        onClick: () => (j ? (0, tO.r7)(t, n) : (0, tO.wF)(t, n)),
                                    },
                                    "bookmark",
                                )
                              : null,
                ...
                ? (0, r.jsxs)(r.Fragment, {
                      children: [
                          x
                              ? null
                              : (0, r.jsxs)(r.Fragment, {
                                    children: [(0, r.jsx)(nO, { channel: t, message: n }), (0, r.jsx)(ny.$$, {})],
                                }),
                          (0, r.jsx)(nv, {
                              togglePopout: D,
...
function nU(e) {
    let { channel: t, message: n } = e,
        l = (0, m.bG)([tr.A], () => null != tr.A.getMessage(n.id), [n.id]),
...
let nH = o.memo(function (e) {
    let { channel: t, message: n, isHeader: l, isReply: i } = e,
        s = (0, m.bG)([eL.A], () => eL.A.isEditing(t.id, n.id), [t.id, n.id]),
        a = (function (e) {
            let { channel: t, message: n } = e;
    ...
    return s || (null == a && null == o)
        ...
        : (0, r.jsx)("div", {
              ...
              children: (0, r.jsxs)(ny.Ay, { className: e.innerClassName, children: [a, o] }),
          });
});
var nB = n(701628),
    nV = n(639288),
...
let n5 = o.memo(function (e) {
    let {
        ...
        h = n.state === tu.a.LOADED ? n.message : void 0,
        A = (0, tp.X4)(h),
        g = (0, tc.S)((t.editedTimestamp ?? t.timestamp).valueOf()),
        p = o.useMemo(() => {
...
let n6 = o.memo(function (e) {
    let {
        ...
        g = (0, m.bG)([tu.A], () => tu.A.getMessageByReference(t?.messageReference)),
...
function le(e) {
    ...
    ti()(n.type === F.lAJ.THREAD_STARTER_MESSAGE, "Message must be a thread starter message");
    let { ...a } = (0, h.rm)(e.id ?? ""),
        o = (0, m.bG)([tu.A], () => tu.A.getMessageByReference(l)),
        { popouts: c, setPopout: u } = (0, tU.A)(n.id, e5.Fd),
        A = (0, tp.Ay)(n),
        g = (0, tx.fF)(n),
        p = (0, tx.ZD)(n);
    return n.type === F.lAJ.THREAD_STARTER_MESSAGE && null != o && o.state === tu.a.LOADED
...
function lt(e) {
    let {
        ...
        { popouts: S, selected: _, setPopout: I } = (0, tU.A)(n.id, e5.Fd),
        N = em.hD.useSetting(),
        j = em.rs.useSetting(),
        T = (0, m.bG)([tu.A], () => tu.A.getMessageByReference(g)),
        b = (0, tc.S)((n.editedTimestamp ?? n.timestamp).valueOf()),
        {
            handleMouseEnter: v,
            handleMouseLeave: M,
            isHovered: R,
        } = (0, tS.yp)({ groupId: u, message: n, defaultValue: _ }),
        D = (0, m.bG)([y.A], () => y.A.keyboardModeEnabled),
        L = _ || (D && C),
        P = L || R,
        ...
        z = o.useCallback(() => (0, tt.uh)(s, i, l), [s, i, l]),
        W = (0, to.$7)({ guildId: s, roleId: H.iconRoleId });
    return (0, r.jsxs)("div", {
        className: nB.m5,
        children: [
            (0, r.jsx)(ts.D, {
...
let ln = o.memo(function (e) {
    ...
    ti()(i.type !== F.lAJ.THREAD_STARTER_MESSAGE, "Message must not be a thread starter message");
    let E = F.sl8.has(i.type) ? i.messageReference : void 0,
        { onFocus: x, ...S } = (0, h.rm)(e.id ?? ""),
        _ = em.hD.useSetting(),
        I = em.rs.useSetting(),
        N = (0, m.bG)([tu.A], () => tu.A.getMessageByReference(E)),
        { popouts: j, selected: T, setPopout: b } = (0, tU.A)(i.id, e5.Fd),
        v = (0, tS.VL)(i, a, b),
        M = (0, tS.ri)(i, a),
        {
            handleMouseEnter: R,
        ...
        B = (0, m.bG)([eL.A], () => eL.A.isEditing(c, s), [c, s]),
        V = (0, m.bG)([y.A], () => y.A.keyboardModeEnabled),
        K = T || B || (V && k),
        W = K || P,
        $ = (0, m.bG)(
            [th.A],
            () => i.hasFlag(F.pr7.HAS_THREAD) && th.A.getChannel(z.default.castMessageIdAsChannelId(i.id)),
        ),
        q = i.isFirstMessageInForumPost(a),
        J = (0, tc.S)((i.editedTimestamp ?? i.timestamp).valueOf()),
        ...
        ee = tG(s, c, V),
        et = (0, tp.Ay)(i),
        el = (0, m.bG)([td.A], () => td.A.getPendingReply(c)),
        ei =
            ((t = o.useRef(p)),
            o.useEffect(() => {
            ...
            p ?? t.current),
        es = (0, to.$7)({ guildId: a.guild_id, roleId: et.iconRoleId }),
        ea = (0, ta.A)(c, s)?.color ?? null,
        er = (0, tx.fF)(i, f),
        eo = (0, tx.ZD)(i),
        ec = (0, m.bG)([tr.A], () => tr.A.getMessage(s), [s]),
                    ...
                    childrenRepliedMessage:
                        C || i.type !== F.lAJ.REPLY
                            ...
                            : n8({
                                  ...e,
                                  setPopout: b,
                                  referencedUsernameProfile: j.referencedUsernameProfile,
                                  referencedAvatarProfile: j.referencedAvatarProfile,
                                  replyReference: E,
                                  replyMessage: N,
                                  isReplySpineClickable: !0,
                              }),
                        ...
                        L || O
                            ? (function (e) {
                                  let {
                                      ...
                                      m = a.id === c,
                                      A = (0, eW.Lt)(a.flags, F.pr7.EPHEMERAL),
...
class la {
    ...
    constructor(e) {
        if (((this.props = e), (this.loading = e.messages.loadingMore), null != e.messages.jumpTargetId))
            ...
            const t = eD.A.isAtBottom(e.channel.id);
            (this.pinned = t ?? !0),
                (this.initialScrollTop = t ? null : (eD.A.getChannelDimensions(e.channel.id)?.scrollTop ?? null));
        }
    }
    isReady() {
        ...
        if (null != o && n !== o) {
            ...
            if (null != e)
                return void this.ref.current?.scrollIntoViewNode({
                    node: e,
                    padding: e5.mZ + this.props.additionalMessagePadding,
    ...
    newMessageBarBuffer() {
        return this.props.channel.isForumPost() ? e5.Gt : e5.k8;
    }
    findAnchor() {
    ...
    updateVisibleMessagesDebounced = K().debounce(tn.s_, 300);
    ...
    enableAutomaticAck() {
        this.isInitialized() &&
            ...
            this.updateStoreDimensions(() => {
                (0, e9._9)(this.props.channel.id, this.props.windowId);
            }));
    }
    ...
    fixJumpTarget() {
        ...
        if (null != e.jumpTargetId) {
            ...
            (0, e8.vq)(l)
                ? this.scrollTo(
                      this.getOffsetOrientationFromNode(l, "middle", t ? this.newMessageBarBuffer() : e5.mZ),
                      !0,
                  )
    ...
    scrollToNewMessages() {
        let e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
            ...
            l = this.getDocument()?.getElementById(e5.q4),
            i = () => {
        ...
        return function () {
            ...
            (e.messageFetchAnchor = e.findFetchAnchor(l)),
                ...
                I.A.fetchMessages({
                    ...
                    before: t,
                    after: n,
                    limit: Math.min(F.EMb, 2 * (0, eX.h)("scrollManager.loadMore")),
                    truncate: !0,
                });
        };
    })();
    scrollTo(e) {
        let t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
            n = arguments.length > 2 ? arguments[2] : void 0;
        this.ref.current?.scrollTo({ to: e, animate: !y.A.useReducedMotion && t, callback: n }),
    ...
    setScrollToBottom() {
        ...
        if (t.hasMoreAfter)
            I.A.jumpToPresent(n.id, (0, eX.h)("scrollManager.jumpToPresent")), (0, tt.uh)(n.getGuildId() ?? F.ME, n.id);
        else
    ...
    updateStoreDimensions(e) {
        ...
        if (this.isPinned()) e6.A.updateChannelDimensions(t.id, Date.now(), 1, 1, 0, e);
        else {
            let { placeholderHeight: n } = this.props,
                { scrollTop: l, scrollHeight: i, offsetHeight: s } = this.getScrollerState();
            e6.A.updateChannelDimensions(t.id, Date.now(), l - n, i - n, s, e);
        }
    }
    scrollIntoViewRect() {}
    scrollPageUp() {
        ...
        (0, e8.vq)(i)
            ? this.scrollTo(
                  this.getOffsetOrientationFromNode(
                      i,
                      "middle",
                      this.props.hasUnreads ? this.newMessageBarBuffer() : e5.mZ,
                  ),
                  n,
                  s,
              )
    ...
    cleanup() {
        (this.acking = !1),
            ...
            (0, e9.Z5)(this.props.channel.id, this.props.windowId);
    }
}
n(667532);
var lr = n(95561),
...
function lj(e) {
    ...
    return (0, r.jsx)(lN, { buttons: d, description: a, header: s, onDismiss: u });
}
var ly = n(477427);
function lT(e) {
    let { channelId: t, warningId: l, senderId: i } = e,
        ...
        c = (e) => {
            lh.A.updateChannelOverrideSettings(null, t, { muted: !0 }, ly.fd.Muted),
...
function l1(e) {
    let { joinRequest: t, guild: n } = e,
        l = (0, m.bG)([ew.default], () => ew.default.getUser(t.userId));
    return (0, r.jsxs)("div", {
        className: l0.I8,
        children: [
            (0, r.jsxs)("div", {
...
function io(e) {
    let t,
        ...
        s = (0, m.bG)([y.A], () => y.A.useReducedMotion),
        a = (0, P.Ay)(n) ?? "",
        {
...
function iT(e) {
    let { channel: t } = e,
        ...
        c = (0, m.bG)([ew.default, n_.A], () => ew.default.getUser(n_.A.getGuild(s)?.ownerId)),
        ...
        g = eO.A.can(F.xBc.MANAGE_CHANNELS, t) || eO.A.can(F.xBc.MANAGE_ROLES, t),
        p = o.useCallback(() => l(!1), []);
    return (0, r.jsxs)(lH.Ay, {
        channelId: t.id,
        children: [
                ...
                children: [
                    (function () {
                        if (1 !== A.length || h.length > 0)
                            return (0, r.jsx)(id.A, { guildId: t.guild_id, className: iy.HD, maxUsers: 5, users: A });
                        let e = A[0],
                            n = lF.Ay.getName(e);
                        return (0, r.jsxs)("div", {
                            className: iy.HD,
                    ...
                    h.map((e, n) => {
                        ...
                        return g
                            ? (0, r.jsx)(
                                  ij,
                                  {
                                      className: d()(iy.JC, { [iy.HV]: n === h.length - 1 }),
                                      roleName: e.name,
                                      roleColor: l,
                                      disabled: !g,
                                      verified: i,
...
function iv(e) {
    let { channel: t } = e,
        n = (0, P.Ay)(t, !0),
        l = (0, m.bG)([eO.A], () => eO.A.can(F.xBc.MANAGE_CHANNELS, t) && lU.bk.has(t.type));
    return (0, r.jsxs)(lH.Ay, {
        channelId: t.id,
        children: [
...
function iG(e) {
    let { userId: t, channel: l } = e,
        ...
        a = (0, m.bG)([ew.default], () => ew.default.getUser(t)),
...
function sf(e) {
    let { channel: t, user: n } = e,
        ...
        } = (0, sA.t)({ user: ew.default.getUser(n.id), onError: l, onAcceptSuccess: s, onRejectSuccess: i }),
        A = d || u || h || m;
    return (0, r.jsxs)(l3.e, {
        size: "sm",
        children: [
...
function sI(e) {
    let { channel: t, showingBanner: n } = e,
        l = (0, P.Ay)(t),
        { type: i } = t,
        s = (0, m.bG)([ew.default], () => (t.isPrivate() ? ew.default.getUser(t.getRecipientId()) : null)),
        a = lF.Ay.useUserTag(s),
        { canManageRoles: o, canReadMessageHistory: c } = (0, m.cf)([eO.A], () => ({
            canManageRoles: eO.A.can(F.xBc.MANAGE_ROLES, t),
            canReadMessageHistory: eO.A.can(F.xBc.READ_MESSAGE_HISTORY, t),
        }));
...
function sF(e) {
    let { threadId: t } = e,
        n = (0, sL.bG)([th.A], () => th.A.getChannel(t)),
        l = (0, sL.bG)([th.A], () => th.A.getChannel(n?.parent_id)),
        i = o.useCallback(() => {
            null != n &&
                null != l &&
...
let sW = () =>
    ...
    s$ = o.memo(function (e) {
        let { channel: t, isLastItem: n } = e,
            ...
            i = (0, m.bG)([eO.A], () => eO.A.can(F.xBc.SEND_MESSAGES_IN_THREADS, t)),
            s = (0, tT.s5)(t),
            a = (0, m.bG)([eR.default], () => eR.default.getId());
        return n
            ? i && !s && t.ownerId !== a
                ? (0, r.jsxs)("div", {
                      className: sz.aP,
...
function ai(e) {
    let { channel: t, message: l, snapshot: i } = e,
        ...
        c = (0, m.bG)([ew.default], () => (null != a ? ew.default.getUser(a) : null)),
    ...
    let u = (function (e) {
            let { channel: t, user: l, guild: i } = e,
                ...
                a = null != l && null == s,
                [c, d] = o.useState(a),
                u = (0, m.bG)([eO.A], () => null != l && null != i && (0, s4.fJ)(l, i, [eO.A]));
            if (
                ((0, s3.Ay)(() => {
        ...
        h = (function (e) {
            let { channel: t, user: l, guild: i } = e,
                s = (0, m.bG)([eO.A], () => null != l && null != i && (0, s4.KX)(l, i, [eO.A])),
        ...
        A = [
            (function (e) {
                let { message: t, user: n, guild: l, channel: i } = e,
                    s = (0, m.bG)([eO.A], () => null != n && null != l && (0, s4.Kd)(n, l, [eO.A])),
                    { messageReference: a } = t,
                    o = (0, m.bG)([ek.A], () => (null != a ? ek.A.getMessage(a.channel_id, a.message_id) : null)),
                    c = (0, m.bG)([th.A], () => (null != o ? th.A.getChannel(o.channel_id) : null)),
                    d = (0, m.bG)([th.A], () => th.A.getChannel(i.id)?.isArchivedThread() ?? !1);
                if (!s) return null;
            ...
            (function (e) {
                let { channel: t, user: n, guild: l } = e,
                    i = (0, m.bG)(
                        [ew.default, n_.A, eO.A],
                        () => null != n && null != l && (0, an.b)(l.id, n.id, [ew.default, n_.A, eO.A]),
                    ),
...
function aA(e) {
    let { postId: t, isFirstMessage: n, isLastItem: l = !1, parentChannelId: i } = e,
        ...
        [h, A] = o.useState(!n),
        [g, p] = (0, sR.A)(!1, 2e3),
        f = (0, m.bG)([th.A], () => th.A.getChannel(t), [t]),
        { firstMessage: C } = (0, ao.OA)(f),
        E = (0, m.bG)([aa.A], () => aa.A.hasJoined(t)),
        { disableReactionUpdates: x, disableReactionCreates: S, isLurking: _, isPendingMember: N } = (0, sB.A)(f),
        j = (0, sX.W1)(f),
        y = (0, m.bG)([th.A], () => th.A.getChannel(i)),
        T = (0, lV.Ck)(y),
    ...
    let M = null != C && C.reactions.length > 0,
        R = () => {
            (0, ac.jC)({ postId: f.id, location: { section: F.JJy.CHANNEL_HEADER } }),
                (0, tR.C)((0, sk.af)(f, y), () => p(!0));
        },
        D = E ? sj.A : sy.X;
    return (0, r.jsxs)(r.Fragment, {
        children: [
            (0, r.jsxs)("div", {
                className: d()(ad.kL, { [ad.wx]: h }),
                ref: s,
                children: [
                    j
                        ? (0, r.jsx)("div", {
                                      ...
                                      children: [
                                          ...
                                          !S &&
                                              (0, r.jsx)(sV.t, {
                                                  ...
                                                  channel: f,
                                                  useChatFontScaling: !1,
                                                  className: d()(ah.secondary, ad.vU, { [ad.w$]: !M }),
                                                  isForumToolbar: !0,
...
function a_(e) {
    let { channelId: t, warningId: l, senderId: i } = e,
        ...
        d = o.useCallback(
            (e) => () => {
                st.A.blockUser(i, { location: aC.Rx }).then(() => {
                    a();
                }),
                ...
                return (n) => {
                    ...
                    return (0, r.jsx)(e, {
                        ...
                        actionRows: (0, r.jsxs)(r.Fragment, {
                            children: [
                                (0, r.jsx)(aS, { senderId: i, channelId: t, warningId: l }, "more-tips-button"),
                                (0, r.jsx)(
                                    lp.PQ,
                                    {
...
function aM(e) {
    let { summary: t, channel: n } = e,
        l = (0, sL.bG)([ev.A], () => ev.A.summaryFeedback(t)),
        i = (e, l) => {
            e.stopPropagation(), (0, aT.A)({ summary: t, channel: n, rating: l });
        },
        s = (0, aI.p)(
            null == l,
            {
                ...
                ? (0, r.jsx)("div", {
                      ...
                      children: (0, r.jsxs)(u.animated.div, {
                          ...
                          children: [
                              ...
                              (0, r.jsx)(ts.D, {
                                  onClick: (e) => i(e, ab.P0.GOOD),
                                  children: (0, r.jsx)(ay.A, { className: av.O1, width: 12, height: 12 }),
                              }),
                              (0, r.jsx)(ts.D, {
                                  onClick: (e) => i(e, ab.P0.BAD),
                                  children: (0, r.jsx)(aj.A, { className: av.O1, width: 12, height: 12 }),
                              }),
                          ],
                      }),
                  })
...
function aR(e) {
    let t,
        ...
        s = (0, sL.bG)([ev.A], () => ev.A.selectedSummary(l.id));
    ...
    return (
        (t = o
            ? (0, r.jsxs)(r.Fragment, {
                  children: [(0, r.jsx)(aN.K, { size: "xs", color: "currentColor", className: av.cR }), n.content],
              })
            : (0, r.jsxs)(r.Fragment, {
                  children: [
                      (0, r.jsx)(aM, { summary: s, channel: l }),
                      (0, r.jsx)(aN.K, { size: "xs", color: "currentColor", className: av.Jq }),
                  ],
              })),
        (0, r.jsx)(
            lD.A,
            {
                className: d()(av.aK, o ? av.Ke : av.hO),
                contentClassName: o ? av.Ew : av.rD,
                isUnread: a,
                id: a ? e5.q4 : void 0,
                children: t,
            },
    ...
    let { expanded: t, onClick: n, count: l, compact: i, collapsedReason: s, canUncollapse: a = !0 } = e,
        o = (0, aU.YW)({ collapsedReason: s })
            .with({ collapsedReason: en.t["VFWjc+"] }, () =>
                (0, r.jsx)(aw.G, { size: "md", color: "currentColor", className: aV.Q6 }),
            )
            .with({ collapsedReason: en.t["+FcYM/"] }, () =>
                (0, r.jsx)(aF.K, { size: "md", color: "currentColor", className: aV.Q6 }),
            )
            .with({ collapsedReason: en.t.rHRovo }, () =>
                (0, r.jsx)(aH._, { size: "md", color: "currentColor", className: aV.TG }),
            )
            .otherwise(() => (0, r.jsx)(l_.P, { size: "md", color: "currentColor", className: aV.Q6 }));
    return (0, r.jsx)(tE.A, {
        compact: i,
        role: "group",
        childrenMessageContent: (0, r.jsx)(aB.A, {
            compact: i,
            className: aV.L9,
            iconNode: o,
            children: (0, r.jsxs)("div", {
                className: a ? aV.Fo : aV.GU,
                children: [
                      ...
                      if (e.type === F.TZK.MESSAGE || e.type === F.TZK.THREAD_STARTER_MESSAGE) {
                          ...
                          return (0, r.jsx)(
                              t,
                              {
                                  ...
                                  className: aV.__invalid_blocked,
                                  compact: l,
                                  channel: n,
                                  message: e.content,
                                  groupId: e.groupId,
...
function a1(e) {
    let { channel: t, className: n } = e,
        l = (0, tT._M)(t),
        i = (0, m.bG)([aX.A], () => aX.A.isInChannel(t.id)),
        s = (0, m.bG)([aQ.Ay], () => aQ.Ay.getVoiceStatesForChannel(t), [t]),
        { needSubscriptionToAccess: a } = (0, aZ.A)(t.id),
        c = o.useCallback(() => {
            aJ.A.handleVoiceConnect({ channel: t, connected: i, needSubscriptionToAccess: a, locked: !1 });
        }, [t, i, a]),
        u = null != s && s.length > 0;
    return l || u
        ? (0, r.jsxs)("div", {
              ...
              children: [
                  (0, r.jsxs)(ts.D, {
                      ...
                      children: [
                          (0, r.jsx)(a$.H, {
                              size: "sm",
                              color: i ? aq.A.colors.STATUS_POSITIVE : aq.A.colors.ICON_MUTED,
                          }),
                          (0, r.jsx)(Y.E, {
                              variant: "text-md/medium",
                              color: "text-strong",
                              className: a0.Gp,
                              children: en.intl.string(en.t.LFHDVw),
                          }),
                      ],
                  }),
                  u
...
function a3(e) {
    ...
    return (0, r.jsxs)("div", {
        ...
        children: [
            ...
            (0, r.jsx)("div", { className: a2.b1 }),
            (0, r.jsx)(a1, { className: a2.Lz, channel: l }),
            (0, r.jsx)("div", { className: a2.ld }),
        ],
    });
}
var a4 = n(34337),
    ...
    a6 = n(148355),
    a9 = n(310876);
let re = "749054660769218631";
function rt(e) {
    let { channel: t } = e,
        [n, l] = o.useState("");
    o.useEffect(() => {
        (0, a5.zk)("847199849233514549", !0);
    }, []);
    let i = (0, m.bG)(
            [ek.A, eR.default],
            () =>
                !!K()(ek.A.getMessages(t.id).toArray())
                    .reverse()
                    .find((e) => e.author.id !== eR.default.getId() && e.state === F.cmJ.SENT && !(0, tg.A)(e)),
        ),
        s = (0, m.bG)([ew.default], () => ew.default.getUser(t.isPrivate() ? t.getRecipientId() : null)),
        a = lF.Ay.useName(s) ?? en.intl.string(en.t.y1Wu2f),
        c = (0, m.bG)([a8.A], () => a8.A.getStickerById(re)),
        d = o.useCallback(async () => {
            if (null == n || "" === n)
                try {
                    (0, a7.W)({ channelId: t.id, source: "In-channel greet" }), await I.A.sendGreetMessage(t.id, re);
                } catch (e) {
    ...
    return i
        ? (0, r.jsxs)("div", {
              ...
              children: [
                  (0, r.jsxs)(ts.D, {
                      className: null != n && "" !== n ? a9.AO : a9.Iq,
                      "aria-label": en.intl.string(en.t.pJObYI),
                      onClick: d,
                      children: [
                          (0, r.jsx)(a6.A, { sticker: c, size: 24 }),
                          (0, r.jsx)(Y.E, { className: a9.Qq, variant: "text-md/medium", children: u }),
                      ],
                  }),
                  h,
              ],
        ...
        : (0, r.jsxs)("div", {
              className: a9.nj,
              children: [
                  (0, r.jsx)(a6.A, { sticker: c, size: 160, className: a9.Xr }),
                  (0, r.jsx)(lS.$, {
                      fullWidth: !0,
                      variant: "primary",
                      size: "md",
    ...
    ro = o.memo(
        function (e) {
            ...
            let n,
                ...
                [U, w] = o.useState(eD.A.isAtBottom(u.id) ?? !1),
                H = (0, P.Ay)(u),
                B = (0, eX.I)(f, b),
                    ...
                    () =>
                        (function (e) {
                            ...
                            for (; m.length < i; ) {
                                ...
                                m.push([h.splice(K().random(0, h.length - 1), 1)[0], e]), (d += e.height + eQ.VF * r);
                            }
                ...
                Z = (function (e) {
                    let { scrollerRef: t, ...n } = e,
                        ...
                        a = o.useCallback(() => {
                            n.hasMoreAfter || e4._.dispatchToLastSubscribed(F.jej.TEXTAREA_FOCUS);
                        }, [n.hasMoreAfter]),
                        r = (0, e3.Ay)({
                            id: e7.D,
                    ...
                    return (0, eF.Vo)({ event: F.jej.FOCUS_MESSAGES, handler: c }), r;
                })({ scrollerRef: q.ref, isEditing: null != S, keyboardModeEnabled: v, hasMoreAfter: A.hasMoreAfter }),
                X = (0, m.bG)([eT.A], () =>
                    eO.A.can(F.xBc.READ_MESSAGE_HISTORY, u) ? null : eT.A.getViewingRolesTimestamp(u.getGuildId()),
                ),
                {
                    ...
                    let t,
                        ...
                        _ = ew.default.getCurrentUser(),
                        j = () => g.isInitialized() || a.ready,
                        b = (0, aO.r)(s),
                        v = a.length > 0 && a.first()?.isFirstMessageInForumPost(s),
                        M = (0, N.cI)(s),
                        R = (0, m.bG)([ev.A], () => ev.A.shouldShowTopicsBar() && !E),
                        D = (0, ax.l)(s.id),
                        L = (0, af.j)(s.id, aC.Rx),
                        P = (0, lo.E)(s.id),
                        k = (0, ak.A)(),
                        ...
                        G = s.isForumPost() && !v ? (0, r.jsx)(aA, { postId: s.id }) : null,
                        { firstMessage: U } = (0, ey.n)(s, S),
                        w =
                            null != U
                                ? (0, r.jsx)(
                                      a3,
                                      { compact: u, channel: s, message: U, id: (0, e7.j)(s.id, U.id) },
                                      U.id,
                                  )
                                : null,
                        H = (0, lO.A)(s.id),
                        B = (0, sX.W1)(s);
                    (t = em.Sf.useSetting()),
                        (n = (0, sL.bG)([y.A], () => y.A.useReducedMotion)),
                        o.useEffect(() => {
                            function e(e) {
                                ...
                                a ||
                                    ...
                                    !t ||
                                    n ||
                                    (0, nf.on)({ channelId: i, messageId: l, emoji: s, key: rn.W.EXTERNAL });
                            }
                            return (
                    ...
                    let V = null,
                        ...
                        W = h.map((e, t) => {
                                    ...
                                    : e.isConversationDivider
                                      ...
                                      : e.isSummaryDivider
                                        ? (0, r.jsx)(aR, {
                                              ...
                                              item: e,
                                              channel: s,
                                              isBeforeGroup: null == e.content && ri(h[t + 1]),
                                          })
                                        : (0, r.jsx)(
                                              lD.A,
                                              {
                            ...
                            if (null != f && f > e.content.timestamp.getTime() * aP.A.Millis.SECOND) return;
                    ...
                    if (
                        (null != _ &&
                            A.forEach((e, t) => {
                                let n = 0 === t && (0, eV.l)(s, $, new aD.Ay({ type: F.lAJ.DEFAULT, author: _ }));
                                K.push(
                                    (0, r.jsx)(
                                        rs,
                        ...
                        a.length > 0 &&
                            K.unshift((0, r.jsx)("div", { style: { height: e5.N0, flex: "0 0 auto" } }, "buffer"));
                        let { useReducedMotion: e } = y.A;
                        ((e && j()) || !e) && K.unshift((0, r.jsx)(e1, { compact: u, ...p }, "has-more"));
                    }
                    if (
                        ((a.hasMoreBefore && null == f) ||
                            S ||
                            K.unshift((0, r.jsx)(sI, { channel: s, showingBanner: C }, "empty-message")),
                        a.hasMoreAfter && K.push((0, r.jsx)(e1, { compact: u, ...p }, "has-more-after")),
                        !C && b && j() && K.push((0, r.jsx)(rt, { channel: s })),
                        c > 0 && d && j())
                    ) {
                        let e,
                            t,
                            n = eG.Ay.getOldestUnreadTimestamp(s.id),
                            i = 0 !== n ? n : z.default.extractTimestamp(s.id),
                            a = (0, eA.ro)(new Date(), new Date(i));
                        if (
                            (eG.Ay.isEstimated(s.id)
                                ? ((e = a ? en.t.wvtbbG : en.t.tHqbtg), (t = en.t.vaPWFe))
                                : ((e = a ? en.t["BctFH/"] : en.t["3wXb9P"]), (t = en.t["4H8ldG"])),
                            M && (0, N.Kc)(s) && k.includes(rl.i.SUMMARIES))
                        ) {
                            let n = eG.Ay.ackMessageId(s.id),
                                a = (function (e, t) {
                                    let n = ev.A.summaries(e) ?? [],
                                        l = 0;
                                    for (let e of n) z.default.compare(e.endId, t) > 0 && (l += 1);
                                    return l;
                                })(s.id, eG.Ay.getOldestUnreadMessageId(s.id));
                            if (
                                ((0, lr.zV)(F.HAw.SUMMARIES_UNREAD_BAR_VIEWED, {
                                    ...
                                    summaries_enabled_for_channel: (0, N.pk)(s),
                                }),
                                (0, N.pk)(s))
                            ) {
                                let n = R
                                ...
                                if (R) {
                                    ...
                                    l = (0, r.jsx)(a4.OZ, { scrollManager: g, content: e, channel: s });
                                } else {
                                    let e = (0, r.jsx)("div", {
                                    ...
                                    l = (0, r.jsx)(a4.GN, { content: e, channelId: s.id });
                                }
                            }
                        } else
                            k.includes(rl.i.NEW_MESSAGES) &&
                                (l = (0, r.jsx)(a4.GN, {
                    ...
                    if (
                        (null == l &&
                            (0, N.pk)(s) &&
                            R &&
                            k.includes(rl.i.SUMMARIES) &&
                            (l = (0, r.jsx)(a4.UK, { channel: s, scrollManager: g })),
                        a.error)
                    )
                        i = (0, r.jsx)(a4.Ez, {
                            ...
                            onClick: () => {
                                ...
                                return (
                                    ...
                                    void I.A.fetchMessages({
                                        channelId: e,
                                        limit: (0, eX.h)("renderStream.reload"),
                                        truncate: !0,
                                    })
                                );
                            },
                                ...
                                : null != e
                                  ...
                                  : (0, r.jsx)(a4.Ab, {
                                        onClick: () => {
                                            let e;
                                            return (
                                                I.A.jumpToPresent(s.id, (0, eX.h)("renderStream.jumpToPresent")),
                                                (e = aL.A.getChannelId()),
                                                void (s.id === e && (0, ap.iN)(s.id))
                                            );
                                        },
                                        className: x,
                                    });
                    ...
                    jumpToPresent: () => {
                        A.hasPresent()
                            ? q.ref.current?.scrollToBottom({ animate: !y.A.useReducedMotion })
            ...
            (t = q.ref),
                ...
                (l = o.useCallback(() => t.current?.scrollPageUp({ animate: !y.A.useReducedMotion }), [t])),
                (i = o.useCallback(() => t.current?.scrollPageDown({ animate: !y.A.useReducedMotion }), [t])),
                (0, eF.Vo)({ event: F.jej.SCROLLTO_PRESENT, handler: n }),
                (0, eF.Vo)({ event: F.jej.SCROLL_PAGE_UP, handler: l }),
                (0, eF.Vo)({ event: F.jej.SCROLL_PAGE_DOWN, handler: i });
            let ea = (0, _.R7)(),
                { ref: er, ...eo } = (0, h.LT)(Z),
                ec = (0, j.A)((e) => {
                ...
                ed = (0, m.bG)([eM.A], () => {
                    let e = eM.A.settings.appearance?.clientThemeSettings;
                    return e?.backgroundGradientPresetId != null || e?.customUserThemeSettings != null;
                }),
                eu = o.useMemo(() => (O ? (U ? ra.gA : ra.ru) : ra.Zd), [O, U]),
                eh = o.useMemo(() => (O ? (U ? ra.cz : ra.XF) : ra.U6), [O, U]);
            return (0, r.jsxs)(h.hD, {
                ...
                children: [
                    ...
                    null != es && es,
                    (0, r.jsxs)("div", {
                        className: d()(ra.Og, s, `group-spacing-${a}`),
                        children: [
                            null == es && ee,
                            (0, r.jsxs)(rr, {
                                ref: ec,
                                customTheme: !0,
                                className: d()(c, ra.XG, ed ? eh : void 0),
                                contentClassName: ra.gT,
                                    ...
                                    (0, r.jsxs)("ol", {
                                        ...
                                        children: [
                                            ...
                                            (0, r.jsx)("div", {
                                                className: d()({
                                                    [ra.lB]: !R,
                                                    [ra.Ie]: 0 === A.length && !A.loadingMore,
                                                    [ra.Fb]:
                                                        1 === A.length &&
                                                        !A.loadingMore &&
                                                        u.isForumPost() &&
    ...
    rc = o.memo(function (e) {
        let {
            ...
            } = e,
            {
                ...
                let t = e.getGuildId(),
                    n = (0, m.bG)([eP.A], () => null == t || eP.A.canChatInGuild(t), [t]),
                    { canManageMessages: l, permissionVersion: i } = (0, m.cf)(
                        [eO.A],
                        () => ({
                            canManageMessages: eO.A.can(F.xBc.MANAGE_MESSAGES, e),
                            permissionVersion: null != t ? eO.A.getGuildVersion(t) : null,
                        }),
                        [e, t],
                    );
            ...
            })(t),
            {
                ...
                let e = em.hH.useSetting(),
                    t = em.gs.useSetting(),
                    {
                        ...
                        let { messageGroupSpacing: e, fontSize: t, keyboardModeEnabled: n } = y.A;
            ...
            })(),
            {
                ...
                var t;
                let n,
                    l = (0, m.bG)([ek.A], () => ek.A.getMessages(e.id), [e.id]),
                    i = (0, m.bG)([eG.Ay], () => eG.Ay.getOldestUnreadMessageId(e.id) ?? null, [e.id]),
                    { enabled: s } = ej.A.useExperiment({ location: "41de6d_1" }, { autoTrackExposure: !1 }),
                    a = ew.default.getUser(eR.default.getId())?.hasFlag(F.nhx.SPAMMER) ?? !1,
                    r = (0, N.cI)(e),
                    c = (0, eN.A)("use_topic_dividers_in_chat"),
                    d = (0, m.yK)([ev.A], () => (r && c ? (ev.A.summaries(e.id) ?? []) : []), [r, e.id, c]),
                    u = (0, m.bG)([ev.A], () => (r ? ev.A.selectedSummary(e.id) : null), [r, e.id]),
                                ...
                                return (
                                    s.forEach((e) => {
                                        ...
                                        let j = (function (e, t, n) {
                                            if (eB.M.NON_COLLAPSIBLE.has(t.type));
                                            ...
                                            else if ((0, eK.iJ)(e) && n) return F.TZK.MESSAGE_GROUP_SPAMMER;
                                            return null;
                                        })(i, e, N && r);
                                        (null !== j &&
                                            ([I, _] =
                                                ((E = p = _),
                                                null == p || p.type !== j
                                                    ? ((C = { type: j, content: [], key: e.id }), h.push(C))
                                        ...
                                        let y =
                                            null !=
                                            (x = (function (e, t) {
                                                if (eZ.get(t.id) === e.id) return eY(e, t.id);
                                                if (
                                                    null == e.applicationId ||
                                                    !(0, eW.Lt)(e.flags, F.pr7.SENT_BY_SOCIAL_LAYER_INTEGRATION) ||
                                                    !t.isDM() ||
                                                    e.author.id === eR.default.getId() ||
                                                    null != e.activity ||
                                                    (0, eW.Lt)(
                                                        t.recipientFlags ?? 0,
                                                        ez.o.DISMISSED_IN_GAME_MESSAGE_NUX,
                                                    ) ||
                                                    eZ.has(t.id)
                                                )
                                                    return null;
                                                ...
                                                return e$.A.updatePrivateChannelRecipientFlags(t.id, l), n;
                                            })(e, i))
                                                ? { message: x, position: "before" }
                                                : null;
                                        null != y &&
                                            "before" === y.position &&
                                            h.push({ type: F.TZK.MESSAGE, content: y.message, groupId: y.message.id });
                                    ...
                                    m && (0, eK.iJ)(i) && ej.A.trackExposure({ location: "416cc9_1" }),
                                    h
                                );
                            })({
                                channel: e,
                ...
                return {
                    ...
                    channelStream: f,
                    oldestUnreadMessageId: i,
                    editingMessageId: (0, m.bG)([eL.A], () => eL.A.getEditingMessage(e.id)?.id),
                    isGameInvitesPost: p,
                };
            })(t),
            j = t.getGuildId();
        return (
            o.useEffect(() => {
                null != j && k.W$.trackExposure({ guildId: j, location: "guild_entry" });
            }, [j]),
            (0, r.jsx)(eb.Bs.Provider, {
                value: (0, eH.A)(f, d),
                children: (0, r.jsx)(e2.t, {
                    children: (0, r.jsx)(ro, {
                        ...c,
                        messageGroupSpacing: A,
                        ...
                        channelStream: x,
                        permissionVersion: u,
                        uploads: (0, m.bG)([eU.A], () => eU.A.getFiles(t.id), [t]),
                        unreadCount: (0, m.bG)([eG.Ay], () => eG.Ay.getUnreadCount(t.id), [t]),
                        hasUnreads: null != S,
                        canChat: h,
                        editingMessageId: _,
                        fontSize: g,
