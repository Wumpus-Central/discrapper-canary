    ...
    return (0, i.jsxs)(d.DUT, {
        ...
        children: [
            null == n
                ...
                : (0, i.jsx)(u.A, { className: N.my, user: n, size: d._3J.SIZE_16 }),
            (0, i.jsx)(d.Text, { className: N.UU, variant: "text-sm/normal", color: "none", children: t.name }),
            (0, i.jsxs)(d.Text, {
                className: N.vE,
                variant: "text-sm/normal",
                color: "none",
                children: [(0, i.jsx)("span", { className: N.xE, children: "•" }), (0, p.aK)(s)],
            }),
        ],
    });
}
