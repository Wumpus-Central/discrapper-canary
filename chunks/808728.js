...
function j(e) {
    let t = M(e);
    return (N[e] = t), (O[e] = []), B(t), U(t), Y(t), ee(e), t;
}
function Y(e) {
    let t = (C[e.id] = {}),
        n = {};
...
function K(e) {
    ...
    return delete N[t], delete C[t], delete b[t], delete O[t], !0;
}
function z(e) {
...
function ee(e) {
    J(I.default.getCurrentUser(), e) ? (b[e] = !0) : delete b[e];
}
function et(e, t) {
    R = t;
