...
function c(e, t) {
    ...
    switch (e) {
        ...
        case u.o2.COFFEE:
            ...
            break;
        case u.o2.SEASONAL_STANDARD_BOX:
            switch (t) {
                case l.oA.IDLE:
                    i = () =>
                        n
...
function d(e) {
    let { giftStyle: t, className: n, shouldAnimate: l = !0, defaultAnimationState: d, idleAnimationState: _ } = e,
        ...
        f = (0, s.bG)([o.Ay], () => o.Ay.useReducedMotion),
        [p, E] = r.useState(d),
        m = r.useRef(c(h, p)),
        [g, A] = r.useState(null == _),
        [I, T] = r.useState(!1),
        [S, y] = r.useState(-1);
    r.useEffect(() => {
        null == _ && E(d);
