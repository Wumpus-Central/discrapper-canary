...
function f(e) {
    ...
    let M = (e) => {
        ...
        k = (0, T.OY)(b, C.name);
    if (null != (null != (f = b.dmsDisabledUntil) ? f : b.invitesDisabledUntil) && D)
    ...
    let L = (0, T.CG)(b) ? N.intl.formatToPlainString(N.t.tZTx2N, { guildName: C.name }) : (0, T.kk)(b) ? N.intl.formatToPlainString(N.t['1bSmxs'], { guildName: C.name }) : N.intl.formatToPlainString(N.t.W87xDA, { guildName: C.name }),
