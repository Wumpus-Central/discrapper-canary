...
function S(e) {
    ...
    let Z = (0, p.CG)(y) ? g.intl.formatToPlainString(g.t.tZTx2N, { guildName: m.name }) : (0, p.kk)(y) ? g.intl.formatToPlainString(g.t['1bSmxs'], { guildName: m.name }) : g.intl.formatToPlainString(g.t.W87xDA, { guildName: m.name }),
        k = D && A === T.oC.MEMBER_SAFETY;
    return (0, i.jsxs)(o.qXd, {
        className: O.notice,
        color: o.DM8.WARNING,
        children: [
