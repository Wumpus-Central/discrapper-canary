...
function T(e) {
    ...
    let { onDismiss: S } = e,
        ...
        C = (0, a.e7)([d.Z], () => (null != T ? d.Z.getChannelId(T) : null), [T]),
        A = null != T ? T : null,
        N = (0, a.e7)([u.Z], () => (null != A ? u.Z.getGuild(A) : null), [A]),
        { shouldShowIncidentActions: P, incidentData: R, isUnderLockdown: D } = (0, _.mI)(A),
        w = (0, l.n2)(null != (t = null == N ? void 0 : N.id) ? t : g.lds),
        x = i.useCallback(() => null != N && (0, c._X)(N.id), [N]);
    if (null == N || null == R || !P) return null;
    let L = (e) => {
            if (e && w && C !== E.oC.MEMBER_SAFETY && x())
        ...
        M = (0, h.OY)(R, N.name);
    if (null != (null != (O = R.dmsDisabledUntil) ? O : R.invitesDisabledUntil) && D)
