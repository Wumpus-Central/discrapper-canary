...
function y(e) {
    ...
    return (0, r.jsxs)('div', {
        ...
        role: 'img',
        'aria-label': _.intl.formatToPlainString(_.t['utf8+f'], { username: i }),
        children: [
            (0, r.jsx)(f.Z, {
                guildId: t,
                user: n,
    ...
    let { channel: f, message: _, compact: b } = e,
        ...
        v = (function (e) {
            let { author: t, channel: n, message: r } = e,
                ...
                f = i.useCallback(() => {
                    (0, d.uL)(h.Z5c.CHANNEL(l, g.oC.ROLE_SUBSCRIPTIONS), { sourceLocationStack: u }), (null == m ? void 0 : m.role_subscription_listing_id) != null && (0, p.y8)(l, n.id, r.id, m.role_subscription_listing_id);
                }, [l, n, r, m, u]);
            return null == m
                ? null
                : (0, p.Tn)({
        ...
        E = (null == (t = _.roleSubscriptionData) ? void 0 : t.total_months_subscribed) != null && (null == (l = _.roleSubscriptionData) ? void 0 : l.total_months_subscribed) <= 1;
    return null == v
        ? null
        : (0, r.jsxs)(r.Fragment, {
              children: [
