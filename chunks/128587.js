        ...
        let e = i().reduce(
            ...
            (e, t) => {
                ...
                return (
                    ...
                    (e.decryptAttempts += null != (s = t.decryptAttempts) ? s : 0),
                    (e.decryptMissingKeyCount += null != (o = t.decryptMissingKeyCount) ? o : 0),
    ...
    getPeriodicStats() {
        ...
        for (let [h, m] of Object.entries(this.periodicInboundStats)) {
            ...
            if (void 0 !== y && b > y) {
                ...
                let A = b - y,
                    v = {
                        ...
                        merged: null != (a = E.merged) ? a : 0 - (null != (s = g.merged) ? s : 0),
                        expanded: null != (o = E.expanded) ? o : 0 - (null != (l = g.expanded) ? l : 0),
                        accelerated: null != (c = E.accelerated) ? c : 0 - (null != (u = g.accelerated) ? u : 0),
                        preemptiveExpanded:
                            null != (d = E.preemptiveExpanded) ? d : 0 - (null != (f = g.preemptiveExpanded) ? f : 0),
            ...
            (this.periodicInboundStats[h].accelerateRateSum = 0),
                ...
                (this.periodicInboundStats[h].previous = E),
                (this.periodicInboundStats[h].previousTimestampMs = b);
        }
        return e;
    }
    calculateMos(e, t) {
        ...
        super(),
            ...
            (this.sampleStats = (e) => {
                    ...
                    if ("audio" === e.type) {
                        ...
                        (r = null != (t = e.bitrateTarget) ? t : 0),
                            (this.outboundStats = _(f({}, this.outboundStats), {
                                ...
                                encryptFailureCount: null != (s = e.encryptFailureCount) ? s : 0,
                        ...
                        i().forEach(t, (t) => {
                            if ("audio" === t.type) {
                                ...
                                let I = null != (r = e.transport.ping) ? r : 0,
                                    ...
                                    N = t.bytesReceived,
                                    R = t.nackCount,
                                    w = null != (a = t.fecPacketsReceived) ? a : 0,
                                    P = null != (s = t.fecPacketsDiscarded) ? s : 0,
                                    D = null != (o = t.jitterBuffer) ? o : 0,
                                    x = {
                                ...
                                if (null != this.inboundStats[n]) {
                                    ...
                                    r > 0 &&
                                        a >= 0 &&
                                        ((s = this.calculateMos(I + D, i().clamp(a / (r + a), 0, 1))),
                                        o[Math.floor(s)]++),
                                        (this.inboundStats[n] = f(
                                            {
                                                ...
                                                fecPacketsReceived: w,
                                                fecPacketsDiscarded: P,
                                                mos: s,
                                                mosSum: e.mosSum + s,
                                                mosCount: e.mosCount + +(s > 0),
                                                mosBuckets: o,
                                                bufferStats: x,
                                                frameOpStats: L,
                ...
                this.outboundStats.packetsSent > t && ((a = !0), this.duration.speaking++),
                    ...
                    (a || s) && this.duration.participation++;
            }),
            (this.networkQuality = new c.A()),
            (this.systemResources = new u.A()),
            (this.inboundStats = {}),
            (this.outboundStats = {
                packetsSent: 0,
                bytesSent: 0,
