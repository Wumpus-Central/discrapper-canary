...
let a = new (n(147567))(),
    ...
    I = (e, t) => {
        ...
        return e.replace(n, (t, n, r, i, a) => {
            let o;
            return l('tilde', e, t, n, r, i, a), v(n) ? (o = '') : v(r) ? (o = `>=${n}.0.0 <${+n + 1}.0.0-0`) : v(i) ? (o = `>=${n}.${r}.0 <${n}.${+r + 1}.0-0`) : a ? (l('replaceTilde pr', a), (o = `>=${n}.${r}.${i}-${a} <${n}.${+r + 1}.0-0`)) : (o = `>=${n}.${r}.${i} <${n}.${+r + 1}.0-0`), l('tilde return', o), o;
        });
    },
    S = (e, t) =>
        e
    ...
    P = (e) => (t, n, r, i, a, o, s, l, c, u, d, f) => ((n = v(r) ? '' : v(i) ? `>=${r}.0.0${e ? '-0' : ''}` : v(a) ? `>=${r}.${i}.0${e ? '-0' : ''}` : o ? `>=${n}` : `>=${n}${e ? '-0' : ''}`), (l = v(c) ? '' : v(u) ? `<${+c + 1}.0.0-0` : v(d) ? `<${c}.${+u + 1}.0-0` : f ? `<=${c}.${u}.${d}-${f}` : e ? `<${c}.${u}.${+d + 1}-0` : `<=${l}`), `${n} ${l}`.trim()),
    w = (e, t, n) => {
