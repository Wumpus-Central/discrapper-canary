...
function v(e) {
    let { handleClose: n, confettiCanvas: t, hideConfetti: l = !1, analyticsLocations: s } = e,
        ...
        p = (0, u.o)(m, o);
    r()(null != f, 'Expected selectedSkuId'), r()(null != C, 'Expected application');
    let v = h[f];
...
function E(e) {
    let { isGift: n, giftCode: t, selectedGiftStyle: s, hasSentMessage: r, giftRecipient: c, giftMessageError: u, isSendingMessage: x } = (0, m.wD)(),
