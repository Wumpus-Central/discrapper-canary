...
function d(e, t, n, r) {
    var i = n.value;
    p(e, i) && (m(e, n), l(e, "allowStale") || (i = void 0)), i && t.call(r, i.value, i.key, e);
}
function f(e, t, n) {
    var r = l(e, "cache").get(t);
    if (r) {
        var i = r.value;
        p(e, i) ? (m(e, r), l(e, "allowStale") || (i = void 0)) : n && l(e, "lruList").unshiftNode(r),
            i && (i = i.value);
    }
    return i;
}
...
(r =
    ...
    (u.prototype.set = function (e, t, n) {
        ...
        return o.length > l(this, "max")
            ? (l(this, "dispose") && l(this, "dispose").call(this, e, t), !1)
            : (l(this, "length", l(this, "length") + o.length),
              l(this, "lruList").unshift(o),
