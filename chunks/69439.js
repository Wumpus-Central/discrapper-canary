...
function O(e) {
    ...
    let { quest: w, location: S, onReceiveErrorHints: P, contentPosition: N, rowIndex: E } = e,
        ...
        ee = o.useCallback(
            (e) => {
                Y(e), e === j.cd.DESKTOP && P([]);
            },
            [Y, P]
        ),
        { text: et, onClick: en } = (0, x.Ks)({
            progressState: U,
            quest: w,
            location: S,
        ...
        { startingConsoleQuest: er, startConsoleQuest: eo } = (0, p.GI)({
            questId: w.id,
            beforeRequest: () => {
                B.startAnimation(),
                    R({
        ...
        es = (null === (O = w.userStatus) || void 0 === O ? void 0 : O.claimedAt) != null,
        ea = null;
    return (V && Z
        ? (ea = (0, r.jsx)(l.zxk, {
              color: l.Ttl.BRAND,
              submitting: W,
              onClick: null != en ? en : void 0,
              className: y.button,
              children: et
          }))
        : L
