var t = {
    ...
    easeInElastic: function (e, t, n, r) {
        ...
        return ((o = 1.70158), (a = 0), (i = s), 0 === e)
            ...
            : 1 == (e /= r)
              ? t + s
              : (a || (a = 0.3 * r),
                i < Math.abs(s) ? ((i = s), (o = a / 4)) : (o = (a / (2 * Math.PI)) * Math.asin(s / i)),
    ...
    easeOutElastic: function (e, t, n, r) {
        ...
        return ((o = 1.70158), (a = 0), (i = s), 0 === e)
            ...
            : 1 == (e /= r)
              ...
              : (a || (a = 0.3 * r),
                i < Math.abs(s) ? ((i = s), (o = a / 4)) : (o = (a / (2 * Math.PI)) * Math.asin(s / i)),
                i * Math.pow(2, -10 * e) * Math.sin((2 * Math.PI * (e * r - o)) / a) + s + t);
    },
        ...
        return ((o = 1.70158), (a = 0), (i = s), 0 === e)
            ...
            : 2 == (e /= r / 2)
              ...
              : (a || (a = 0.3 * 1.5 * r),
                ...
                : i * Math.pow(2, -10 * (e -= 1)) * Math.sin((2 * Math.PI * (e * r - o)) / a) * 0.5 + s + t;
    },
    ...
    easeInOutBounce: function (e, n, r, i) {
        var a,
            o = r - n;
        return e < i / 2
            ? 0.5 * (a = t.easeInBounce(2 * e, 0, o, i)) + n
            : 0.5 * (a = t.easeOutBounce(2 * e - i, 0, o, i)) + 0.5 * o + n;
    },
};
e.exports = t;
