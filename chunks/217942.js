var t = {
    ...
    easeInElastic: function (e, t, n, r) {
        var i,
            ...
            a,
            s = n - t;
        return ((a = 1.70158), (o = 0), (i = s), 0 === e)
            ? t
            : 1 == (e /= r)
              ? t + s
              : (o || (o = 0.3 * r),
                i < Math.abs(s) ? ((i = s), (a = o / 4)) : (a = (o / (2 * Math.PI)) * Math.asin(s / i)),
                -(i * Math.pow(2, 10 * (e -= 1)) * Math.sin((2 * Math.PI * (e * r - a)) / o)) + t);
    },
    easeOutElastic: function (e, t, n, r) {
        ...
        return ((a = 1.70158), (o = 0), (i = s), 0 === e)
            ...
            : 1 == (e /= r)
              ...
              : (o || (o = 0.3 * r),
                i < Math.abs(s) ? ((i = s), (a = o / 4)) : (a = (o / (2 * Math.PI)) * Math.asin(s / i)),
                i * Math.pow(2, -10 * e) * Math.sin((2 * Math.PI * (e * r - a)) / o) + s + t);
    },
        ...
        return ((a = 1.70158), (o = 0), (i = s), 0 === e)
            ...
            : 2 == (e /= r / 2)
              ...
              : (o || (o = 0.3 * 1.5 * r),
                  i < Math.abs(s) ? ((i = s), (a = o / 4)) : (a = (o / (2 * Math.PI)) * Math.asin(s / i)),
                  e < 1)
                ? -0.5 * (i * Math.pow(2, 10 * (e -= 1)) * Math.sin((2 * Math.PI * (e * r - a)) / o)) + t
                : i * Math.pow(2, -10 * (e -= 1)) * Math.sin((2 * Math.PI * (e * r - a)) / o) * 0.5 + s + t;
    },
    ...
    easeInOutBounce: function (e, n, r, i) {
        var o,
            a = r - n;
        return e < i / 2
            ? 0.5 * (o = t.easeInBounce(2 * e, 0, a, i)) + n
            : 0.5 * (o = t.easeOutBounce(2 * e - i, 0, a, i)) + 0.5 * a + n;
    },
};
e.exports = t;
