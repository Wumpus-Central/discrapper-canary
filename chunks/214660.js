...
let T = (e) => {
    ...
    return (0 === t &&
        (T
            ? ((G = b.intl.string(b.t.IRxUlG)), (M = b.intl.string(b.t.fiNVin)))
            : j
              ? ((G = b.intl.string(b.t.vW8iUF)), (M = b.intl.string(b.t["50gfOv"])))
              : y
                ? ((G = b.intl.string(b.t.vdSOpz)), (M = b.intl.string(b.t.lm1UKt)))
                : L
                  ? ((G = b.intl.formatToPlainString(b.t.v1ktYb, { min: I.$8o.MEMBER_AGE })),
                    (M = b.intl.string(b.t.BddRzS)))
                  : R &&
