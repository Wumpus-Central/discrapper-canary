...
})()(
    {
                ...
                function u() {
                    ...
                    switch (u.browser) {
                        ...
                        case 'edge':
                            ...
                            (c('adapter.js shimming edge.'), (d.browserShim = a), a.shimGetUserMedia(t, u), a.shimGetDisplayMedia(t, u), a.shimPeerConnection(t, u), a.shimReplaceTrack(t, u), l.shimMaxMessageSize(t, u), l.shimSendThrowTypeError(t, u));
                            break;
                        case 'safari':
                            if (!s || !n.shimSafari) {
        ...
        3: [
            function (e, t, n) {
                ...
                (Object.defineProperty(n, 'shimGetDisplayMedia', {
                    ...
                    (n.shimGetStats = _),
                    (n.shimSenderReceiverGetStats = f),
                                    ...
                                    if (l && ('user' === l.exact || 'environment' === l.exact || 'user' === l.ideal || 'environment' === l.ideal) && !(n.mediaDevices.getSupportedConstraints && n.mediaDevices.getSupportedConstraints().facingMode && !c)) {
                                        ...
                                        if (('environment' === l.exact || 'environment' === l.ideal ? (u = ['back', 'rear']) : ('user' === l.exact || 'user' === l.ideal) && (u = ['front']), u))
                                            return n.mediaDevices.enumerateDevices().then(function (t) {
                                                ...
                                                return (!n && t.length && u.includes('back') && (n = t[t.length - 1]), n && (e.video.deviceId = l.exact ? { exact: n.deviceId } : { ideal: n.deviceId }), (e.video = a(e.video)), i('chrome: ' + JSON.stringify(e)), o(e));
                                            });
                                    }
                                    e.video = a(e.video);
                                }
        ...
        7: [
            function (e, t, n) {
                ...
                (Object.defineProperty(n, 'shimGetDisplayMedia', {
                    ...
                    (n.shimReceiverGetStats = _),
                    (n.shimRemoveStream = f),
        ...
        11: [
            function (e, t, n) {
                ...
                function c(e) {
                    return 'boolean' != typeof e ? Error('Argument type: ' + (void 0 === e ? 'undefined' : r(e)) + '. Please use a boolean.') : ((a = e), e ? 'adapter.js logging disabled' : 'adapter.js logging enabled');
                }
                function u(e) {
            ...
            function (e, t, n) {
                ...
                ((r.generateIdentifier = function () {
                    ...
                    (r.parseRtpParameters = function (e) {
                        for (
                            ...
                            if (o) {
                                ...
                                switch (((s.parameters = l.length ? r.parseFmtp(l[0]) : {}), (s.rtcpFeedback = r.matchPrefix(e, 'a=rtcp-fb:' + a + ' ').map(r.parseRtcpFb)), t.codecs.push(s), s.name.toUpperCase())) {
                                    case 'RED':
                                    case 'ULPFEC':
                    ...
                    (r.writeSessionBoilerplate = function (e, t, n) {
                        var i,
                            a = void 0 !== t ? t : 2;
                        return 'v=0\r\no=' + (n || 'thisisadapterortc') + ' ' + (i = e || r.generateSessionId()) + ' ' + a + ' IN IP4 127.0.0.1\r\ns=-\r\nt=0 0\r\n';
                    }),
