...
})()(
    {
                    ...
                    switch (u.browser) {
                        case "chrome":
                            ...
                            c("adapter.js shimming chrome."),
                                (d.browserShim = i),
                                l.shimAddIceCandidateNullOrEmpty(t, u),
                                i.shimGetUserMedia(t, u),
                                i.shimMediaStream(t, u),
                                i.shimPeerConnection(t, u),
                                i.shimOnTrack(t, u),
                                i.shimAddTrackRemoveTrack(t, u),
                                i.shimGetSendersWithDtmf(t, u),
                                i.shimGetStats(t, u),
                                i.shimSenderReceiverGetStats(t, u),
                                i.fixNegotiationNeeded(t, u),
                                l.shimRTCIceCandidate(t, u),
                                l.shimConnectionState(t, u),
                                l.shimMaxMessageSize(t, u),
                                l.shimSendThrowTypeError(t, u),
                                l.removeExtmapAllowMixed(t, u);
                            break;
                        case "firefox":
                            ...
                            c("adapter.js shimming firefox."),
                                (d.browserShim = o),
                                l.shimAddIceCandidateNullOrEmpty(t, u),
                                o.shimGetUserMedia(t, u),
                                o.shimPeerConnection(t, u),
                                o.shimOnTrack(t, u),
                                o.shimRemoveStream(t, u),
                                o.shimSenderGetStats(t, u),
                                o.shimReceiverGetStats(t, u),
                                o.shimRTCDataChannel(t, u),
                                o.shimAddTransceiver(t, u),
                                o.shimGetParameters(t, u),
                                o.shimCreateOffer(t, u),
                                o.shimCreateAnswer(t, u),
                                l.shimRTCIceCandidate(t, u),
                                l.shimConnectionState(t, u),
                                l.shimMaxMessageSize(t, u),
                                l.shimSendThrowTypeError(t, u);
                        ...
                        case "edge":
                            ...
                            c("adapter.js shimming edge."),
                                (d.browserShim = a),
                                a.shimGetUserMedia(t, u),
                                a.shimGetDisplayMedia(t, u),
                                a.shimPeerConnection(t, u),
                                a.shimReplaceTrack(t, u),
                                l.shimMaxMessageSize(t, u),
                                l.shimSendThrowTypeError(t, u);
                            break;
                        case "safari":
                            ...
                            c("adapter.js shimming safari."),
                                (d.browserShim = s),
                                l.shimAddIceCandidateNullOrEmpty(t, u),
                                s.shimRTCIceServerUrls(t, u),
                                s.shimCreateOfferLegacy(t, u),
                                s.shimCallbacksAPI(t, u),
                                s.shimLocalStreamsAPI(t, u),
                                s.shimRemoteStreamsAPI(t, u),
                                s.shimTrackEventTransceiver(t, u),
                                s.shimGetUserMedia(t, u),
                                s.shimAudioContext(t, u),
                                l.shimRTCIceCandidate(t, u),
                                l.shimMaxMessageSize(t, u),
                                l.shimSendThrowTypeError(t, u),
                                l.removeExtmapAllowMixed(t, u);
        ...
        3: [
            function (e, t, n) {
                ...
                Object.defineProperty(n, "shimGetDisplayMedia", {
                    ...
                    (n.shimGetStats = f),
                    (n.shimSenderReceiverGetStats = p),
                    (n.shimAddTrackRemoveTrackWithNative = _),
                    (n.shimAddTrackRemoveTrack = m),
                    (n.shimPeerConnection = h),
                ...
                function m(e, t) {
                    if (e.RTCPeerConnection) {
                        ...
                        e.RTCPeerConnection.prototype.setLocalDescription = function () {
                            return (
                                arguments.length && arguments[0].type && (arguments[0] = c(this, arguments[0])),
        ...
        5: [
            function (e, t, n) {
                ...
                function a(e, t) {
                    ...
                    if (n.mediaDevices) {
                        var a = function (e) {
                                if ((void 0 === e ? "undefined" : r(e)) !== "object" || e.mandatory || e.optional)
                                    return e;
                                var t = {};
                                return (
                                    Object.keys(e).forEach(function (n) {
                                        if ("require" !== n && "advanced" !== n && "mediaSource" !== n) {
                                            ...
                                            void 0 !== i.exact && "number" != typeof i.exact
                                                ? ((t.mandatory = t.mandatory || {}), (t.mandatory[a("", n)] = i.exact))
                            ...
                            o = function (e, o) {
                                    ...
                                    if (
                                        ...
                                        if (
                                            ("environment" === l.exact || "environment" === l.ideal
                                                ? (u = ["back", "rear"])
                                                : ("user" === l.exact || "user" === l.ideal) && (u = ["front"]),
                                            u)
                                        )
                                            return n.mediaDevices.enumerateDevices().then(function (t) {
                                                ...
                                                return (
                                                    !n && t.length && u.includes("back") && (n = t[t.length - 1]),
                                                    n &&
                                ...
                                return i("chrome: " + JSON.stringify(e)), o(e);
                            },
                            s = function (e) {
                                return t.version >= 64
                                    ? e
        ...
        6: [
            function (e, t, n) {
                ...
                (n.shimRTCIceCandidate = l),
                    (n.shimMaxMessageSize = c),
                    (n.shimSendThrowTypeError = u),
                    (n.shimConnectionState = d),
                    (n.removeExtmapAllowMixed = f),
                    (n.shimAddIceCandidateNullOrEmpty = p);
                var i = s(e("sdp")),
                    a = o(e("./utils"));
                function o(e) {
                    if (e && e.__esModule) return e;
        ...
        7: [
            function (e, t, n) {
                ...
                Object.defineProperty(n, "shimGetDisplayMedia", {
                    ...
                    (n.shimRemoveStream = p),
                    (n.shimRTCDataChannel = _),
                    (n.shimAddTransceiver = m),
                    (n.shimGetParameters = h),
                    (n.shimCreateOffer = g),
                            ...
                            (e.RTCPeerConnection.prototype.addTransceiver = function () {
                                ...
                                if (n) {
                                    var i = r.sender,
                                        a = i.getParameters();
                                    ("encodings" in a &&
                                        (1 !== a.encodings.length || 0 !== Object.keys(a.encodings[0]).length)) ||
        ...
        10: [
            function (e, t, n) {
                ...
                (n.shimLocalStreamsAPI = o),
                    (n.shimRemoteStreamsAPI = s),
                    (n.shimCallbacksAPI = l),
                    (n.shimGetUserMedia = c),
                    (n.shimConstraints = u),
                    (n.shimRTCIceServerUrls = d),
                    (n.shimTrackEventTransceiver = f),
                    (n.shimCreateOfferLegacy = p),
                    (n.shimAudioContext = _);
                var i = a(e("../utils"));
                function a(e) {
                    if (e && e.__esModule) return e;
                    var t = {};
                        ...
                        if (
                            ...
                            (e.RTCPeerConnection.prototype.addStream = function (e) {
                                ...
                                (e.RTCPeerConnection.prototype.addTrack = function (e) {
                                    for (
                                        var n = this, r = arguments.length, i = Array(r > 1 ? r - 1 : 0), a = 1;
                                        a < r;
                                        a++
                                    )
                                        i[a - 1] = arguments[a];
            ...
            function (e, t, n) {
                ...
                function c(e) {
                    return "boolean" != typeof e
                        ? Error("Argument type: " + (void 0 === e ? "undefined" : r(e)) + ". Please use a boolean.")
                ...
                function p(e) {
                    ...
                    return (
                        n.mozGetUserMedia
                            ? ((t.browser = "firefox"), (t.version = s(n.userAgent, /Firefox\/(\d+)\./, 1)))
                            : n.webkitGetUserMedia ||
                                (!1 === e.isSecureContext && e.webkitRTCPeerConnection && !e.RTCIceGatherer)
                              ? ((t.browser = "chrome"), (t.version = s(n.userAgent, /Chrom(e|ium)\/(\d+)\./, 2)))
                              : n.mediaDevices && n.userAgent.match(/Edge\/(\d+).(\d+)$/)
                                ? ((t.browser = "edge"), (t.version = s(n.userAgent, /Edge\/(\d+).(\d+)$/, 2)))
                                : e.RTCPeerConnection && n.userAgent.match(/AppleWebKit\/(\d+)\./)
                                  ? ((t.browser = "safari"),
                                    (t.version = s(n.userAgent, /AppleWebKit\/(\d+)\./, 1)),
                ...
                function m(e) {
                    return _(e)
                        ? Object.keys(e).reduce(function (t, n) {
                              ...
                              return void 0 === a || o ? t : Object.assign(t, i({}, n, a));
                          }, {})
                        : e;
                }
                function h(e, t, n) {
                ...
                (r.generateIdentifier = function () {
                    ...
                    (r.writeCryptoLine = function (e) {
                        return (
                            ...
                            e.cryptoSuite +
                            " " +
                            ("object" == typeof e.keyParams ? r.writeCryptoKeyParams(e.keyParams) : e.keyParams) +
                    ...
                    (r.parseRtpParameters = function (e) {
                        for (
                            ...
                            if (o) {
                                ...
                                switch (
                                    ((s.parameters = l.length ? r.parseFmtp(l[0]) : {}),
                                    (s.rtcpFeedback = r.matchPrefix(e, "a=rtcp-fb:" + a + " ").map(r.parseRtcpFb)),
                                    t.codecs.push(s),
                                    s.name.toUpperCase())
                                ) {
                                    case "RED":
                            ...
                            u.length &&
                                ((u =
                                    0 === u[0].indexOf("b=TIAS:")
                                        ...
                                        : 0 === u[0].indexOf("b=AS:")
                                          ? 1000 * parseInt(u[0].substr(5), 10) * 0.95 - 16000
                                          : void 0),
                    ...
                    (r.parseRtcpParameters = function (e) {
                        ...
                        return (
                            ...
                            (t.mux = r.matchPrefix(e, "a=rtcp-mux").length > 0),
                            t
                        );
                    }),
