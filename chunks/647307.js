...
function E(e) {
    ...
    i.useEffect(
        ...
        [E, m, F, V, Y, M, P, b, D, C, N, A, k, x, U, f],
    ),
        i.useEffect(
            function () {
                L({ width: 0, height: 0 });
...
function y(e, t) {
    ...
    var D = i.useCallback(
        function (e) {
            return s.default.createElement(S, a({ setContainerRef: N, setCanvasRef: C }, e));
        },
        [C, N],
    );
    return { canvas: u, container: d.current, setCanvasRef: C, setContainerRef: N, rive: f, RiveComponent: D };
}
function C(e, t, n) {
