...
async function g(e) {
    ...
    let m = await (0, a.k)(t);
    if (m.features.has(f.GuildFeatures.COMMUNITY)) {
        var g;
        if (i) (0, u.sy)(t);
        else {
            if (!m.features.has(f.GuildFeatures.GUILD_ONBOARDING)) return;
            await (0, u.h9)(t);
        }
                ...
                (E[g] = e),
                    new Promise((e) => {
                        _.Ay.addConditionalChangeListener(() => {
                            ...
                            return (
                                !(0, d.Lt)(t?.flags ?? 0, h.D.COMPLETED_ONBOARDING) ||
                    ...
                    (0, o.pX)(f.BVt.CHANNEL(g, p.VV.GUILD_ONBOARDING));
            })),
            null != n && (0, o.pX)(f.BVt.CHANNEL(t, n)));
    }
}
function A(e) {
    return null != E[e];
