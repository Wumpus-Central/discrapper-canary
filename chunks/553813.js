...
f("NUMERICIDENTIFIER"),
    ...
    f("COERCE"),
    (c[u.COERCE] = "(^|[^\\d])(\\d{1," + s + "})(?:\\.(\\d{1," + s + "}))?(?:\\.(\\d{1," + s + "}))?(?:$|[^\\d])"),
    f("COERCERTL"),
...
(t.parse = g),
    ...
    (y.prototype.compareMain = function (e) {
        return (
            e instanceof y || (e = new y(e, this.options)),
            T(this.major, e.major) || T(this.minor, e.minor) || T(this.patch, e.patch)
        );
    }),
...
function V(e, t) {
    ...
    r("comparator", e, t),
        ...
        (this.loose = !!t.loose),
        this.parse(e),
        this.semver === F ? (this.value = "") : (this.value = this.operator + this.semver.version),
        r("comp", this);
}
(t.rcompareIdentifiers = S),
    (t.major = A),
    (t.minor = C),
    (t.patch = N),
    (t.compare = R),
            ...
            c
                ...
                : i && f
                  ? (u && (o = 0),
                    (s = 0),
                    ">" === i
                        ? ((i = ">="), u ? ((a = +a + 1), (o = 0)) : (o = +o + 1), (s = 0))
                        : "<=" === i && ((i = "<"), u ? (a = +a + 1) : (o = +o + 1)),
                    (n = i + a + "." + o + "." + s + l))
                  : u
                    ? (n = ">=" + a + ".0.0" + l + " <" + (+a + 1) + ".0.0" + l)
                    : d && (n = ">=" + a + "." + o + ".0" + l + " <" + a + "." + (+o + 1) + ".0" + l),
            r("xRange return", n),
            n
        );
    });
    ...
    for (var i, a, o, s, l, c = 0; c < t.set.length; ++c) {
        ...
        if (
            (u.forEach(function (e) {
                e.semver === F && (e = new V(">=0.0.0")),
                    (d = d || e),
                    (f = f || e),
                    i(e.semver, d.semver, r) ? (d = e) : o(e.semver, f.semver, r) && (f = e);
            }),
            d.operator === s ||
                d.operator === l ||
                ((!f.operator || f.operator === s) && a(e, f.semver)) ||
                (f.operator === l && o(e, f.semver)))
        )
            return !1;
    }
    return !0;
...
(V.prototype.parse = function (e) {
    ...
    (this.operator = void 0 !== n[1] ? n[1] : ""),
        ...
        n[2] ? (this.semver = new y(n[2], this.options.loose)) : (this.semver = F);
}),
    (V.prototype.toString = function () {
        return this.value;
    }),
    (V.prototype.test = function (e) {
        if ((r("Comparator.test", e, this.options.loose), this.semver === F || e === F)) return !0;
        if ("string" == typeof e)
            try {
    ...
    (H.prototype.parseRange = function (e) {
        ...
        r("hyphen replace", (e = e.replace(n, en))),
            ...
            (e = (e = (e = e.replace(l[u.TILDETRIM], _)).replace(l[u.CARETTRIM], p)).split(/\s+/).join(" "));
