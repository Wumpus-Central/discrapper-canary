...
function F(e, t) {
    ...
    r("comparator", e, t),
        ...
        (this.loose = !!t.loose),
        this.parse(e),
        this.semver === Z ? (this.value = "") : (this.value = this.operator + this.semver.version),
        r("comp", this);
}
...
(F.prototype.parse = function (e) {
    ...
    (this.operator = void 0 !== n[1] ? n[1] : ""),
        ...
        n[2] ? (this.semver = new y(n[2], this.options.loose)) : (this.semver = Z);
}),
