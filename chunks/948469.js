n.d(t, { iV: () => cx, OC: () => cE, Ay: () => cf }), n(938796);
var i,
    l,
    s,
    r,
...
function el(e) {
    ...
    let { primaryColor: C, secondaryColor: I } = (0, Z.A)(m ?? r),
        ...
        k = o.useMemo(() => !!T && new URL(d).pathname.endsWith(".gif"), [T, d]),
        M = o.useMemo(() => {
            if (null != f)
                return (e) => {
                    f(e),
...
function eL(e) {
    let { app: t, linkType: n, activityCustomId: i, activityReferrerId: l, message: s, onView: r } = e,
        ...
        { currentChannelId: _, instanceId: j, isCurrentlyInInstance: N, canLaunchInChannel: y } = (0, F.w)(t.id),
        R = (0, S.A)(),
        ...
        V = eS(t),
        H = (function (e) {
            let { canViewApp: t, isInstallable: n } = eT(e),
                i = eS(e);
            return o.useMemo(
                () =>
                    t && null != i
        ...
        }, [m, H, G, t.id, U, w, j, N, _, R, i, f, v, u]),
...
function ek(e) {
    let { app: t } = e,
        ...
        d = o.useMemo(() => {
            ...
            return (0, a.jsxs)(a.Fragment, { children: [(0, a.jsx)(y.n, { size: "xxs", color: "currentColor" }), e] });
        }, [s, r, l, i]);
    return (0, a.jsxs)(a.Fragment, {
        children: [
            n.length > 0 &&
...
function tu(e) {
    ...
    let A = () => {
        (0, eJ.openModalLazy)(async () => {
            let { default: e } = await Promise.all([n.e("14350"), n.e("68031"), n.e("85384"), n.e("20428")]).then(
                n.bind(n, 719847),
            );
            return (n) =>
    ...
    let f = r.type === ed.Puh.SUBSCRIPTION,
        ...
        v = f
            ? E
                ? (0, a.jsxs)(a.Fragment, {
                      children: [
                          (0, a.jsx)(y.n, { size: "custom", width: 12, height: 12 }),
                          " ",
...
var tC = n(778492),
    ...
    tN = n(228366),
    ty = n(812930);
let tT = "ChannelFollowingBumpChannels",
    tS = new Set(),
    tb = new Set();
class tL extends h.Ay.Store {
    static displayName = "ChannelFollowingPublishBumpStore";
    initialize() {
        this.waitFor(D.default, O.A, e_.A, V.default), (tS = new Set(tj.w.get(tT)));
    }
    shouldShowBump(e) {
        return tb.has(e);
    }
...
let tR = new tL(tN.h, {
    ...
    CHANNEL_FOLLOWING_PUBLISH_BUMP_HIDE_PERMANENTLY: function (e) {
        let { channelId: t } = e;
        tS.add(t), tj.w.set(tT, tS), tb.clear();
    },
});
var tk = n(419056),
    tM = n(676544);
    ...
    getForwardInfo() {
        ...
        if (null != c && c.guild_id === a.messageReference?.guild_id) {
            ...
            if (null == s) {
                ...
                return null == e ? { snapshotIndex: r } : { snapshotIndex: r, footerInfo: ny(e, d) };
            }
        ...
        return null == h ? { snapshotIndex: r } : { snapshotIndex: r, footerInfo: ny(h, d) };
    }
}
var nS = n(66834),
    nb = n(449054);
...
function nw(e) {
    let { message: t, snapshot: n, index: i } = e,
        l = o.useMemo(() => new nT(t, n, i), [t, n, i]),
        s = (0, h.bG)(
...
function iT(e) {
    let { embedUrl: t, message: n, channel: i } = e,
        ...
        y = (0, ig.gn)(I?.guildId, r?.authorId ?? void 0, j),
        { reducedMotion: T } = o.useContext(is.C),
        [S, b] = o.useState(!1),
        L = o.useCallback(() => {
            p(!0);
        }, [p]),
                    ...
                    !A &&
                        (!0 === r.shouldShowBlurredThumbnailImage
                            ? (0, a.jsx)("img", {
                                  ...
                                  className: c()(iy.xn, { [iy.p6]: r.shouldSpoiler }),
                                  onContextMenu: u,
                                  onError: () => f(!0),
                              })
                            : (0, a.jsx)(ic.A, {
...
function i0(e) {
    ...
    return (0, a.jsxs)("div", {
        className: c()(iX.Fk, { [iX.EK]: i !== iD.CQ.LIST, [iX.wH]: r }),
        children: [
...
function lR(e) {
    ...
    return (0, a.jsx)(lT.Anchor, { className: lb.zh, href: t, children: ec.intl.string(ec.t["8/GdRB"]) });
}
function lk(e) {
                    ...
                    ? (0, a.jsx)("div", {
                          ...
                          children: (0, a.jsx)(x.E, {
                              ...
                              children: ec.intl.format(ec.t.GiVd2Q, {
                                  ...
                                  orbIconHook: () =>
                                      (0, a.jsx)(lD.C, { size: "xs", color: "currentColor" }, "orbs-icon"),
                              }),
                          }),
                      })
                    : null,
...
let sE = (e) => {
    ...
    sC = (e) => {
        ...
        p
            ...
            : f
              ? ((t = T ? ec.intl.string(ec.t.jNphpt) : ec.intl.string(ec.t.lyD5ZW)),
                (b = !0),
...
function sG(e) {
    ...
    (0, sw.Eq)(s, "ThreadMessageAccessoryMessage");
    let r = o.useMemo(
        () => (null != t.content && "" !== t.content ? (0, sD.Ay)(t, { formatInline: !0 }).content : null),
        [t],
    );
    return (0, a.jsxs)("div", {
        className: lg.up,
...
let rf = o.memo(function (e) {
    let t,
        ...
        y = (0, rd.vG)({ userId: g, channelId: i, application: N }),
        T = null == p,
        S = (function (e) {
        ...
        })({ embeddedActivity: p, joinability: y, currentEmbeddedActivity: A, channel: u }),
        b = o.useId(),
...
class aN extends o.Component {
    ...
    handleAccept = (e) => {
        ...
        (0, rT.h)({ processedCode: n, channelContext: t, customGiftMessage: r, giftInfo: s });
    };
    handleLaunchGame = (e) => {
...
function a2(e) {
    let t,
        ...
        T = (0, m.Lt)(c.flags ?? 0, aQ.Q.IS_GUEST_INVITE),
    ...
    if (null == d) {
        ...
        (d = aD.DY(c.guild)).premiumTier = c.guild.premium_tier ?? ed.TVA.NONE;
    }
    let G = (function (e) {
              ...
              children: [
                  (0, a.jsxs)("div", {
                      ...
                      children: [
                          ...
                          (0, a.jsx)(oe.A, {
                              guild: null != t.guild ? (0, aD.DY)(t.guild) : null,
                              roles: t.roles,
                              className: ot.Ei,
                          }),
                      ],
...
function oa(e) {
    ...
    let y = null != n.channel ? (0, aP.OY)(n.channel) : null,
        T = rG.Ay.getName(I),
        S = A || (!x && N),
        b = ec.intl.string(ec.t.I6JG46),
        L = "active";
    N && !x
        ? ((t = v ? ec.intl.string(ec.t.oBLoZJ) : ec.intl.formatToPlainString(ec.t["0QJmA+"], { name: T })),
          (b = ec.intl.string(ec.t.Wdi5E1)))
        : ((L = "active"),
          A && ((b = ec.intl.string(ec.t.Q1W99y)), (L = "secondary")),
          (t = v ? ec.intl.string(ec.t["4hyaHu"]) : ec.intl.formatToPlainString(ec.t.QmlLEq, { name: T })));
    let R =
        u === l.id && null != y
            ? (0, a.jsx)(nB.A.Channel, { channel: y })
            ...
            c.length > 0
                ? (0, a.jsxs)("div", {
                      ...
                      children: [
                          ...
                          (0, a.jsx)("div", { ref: g, className: oA.wH, style: { display: "none" } }),
                      ],
                  })
                : (0, a.jsx)("div", {
                      className: oA.p$,
...
function ob(e) {
    let { guildId: t, channelId: n, users: i, onHoverOrFocus: l, ...s } = e,
        r = o.useCallback((e) => (0, a.jsx)(oL, { users: e, guildId: t, channelId: n, onHoverOrFocus: l }), [t, n, l]);
...
var oR = n(531657);
let ok = { mass: 1, tension: 170, friction: 26 };
function oM(e) {
    let { className: t, guildId: n, channelId: i, members: l, ref: s, motion: r } = e,
        ...
        [x, f] = (0, iW.z)(() => ({ x: 0, y: 0, scale: 1, config: ok }));
    return (
        o.useEffect(() => {
            f({ x: g, y: p, scale: A });
        }, [g, p, A, f]),
        (0, a.jsxs)(iY.animated.div, {
            ...
            children: [
                ...
                d && (0, a.jsx)(oP, { guildId: n, channelId: i, members: l, count: m }, "overflow"),
            ],
        })
    );
}
...
function oD(e) {
    let { invite: t, message: n, guild: i, onTransitionToInviteChannel: l, onAcceptInstantInvite: s } = e,
        r = o.useRef(null),
        d = i ?? null;
    null == d && null != t.guild && (d = aD.DY(t.guild));
    let c = null != t.channel ? (0, aP.OY)(t.channel) : null;
    eK()(null != d, "Voice Invite Embed must be used in context of a guild."),
        eK()(null != c, "Voice Invite Embed must be able to resolve an invite channel.");
    let u = (0, h.bG)([e_.A, O.A], () => {
            let e = O.A.getChannel(c.id);
            return null == e || e_.A.canBasicChannel(ed.hVb.VIEW_CHANNEL, e);
        }, [c.id]),
        m = (0, h.bG)([op.Ay], () => (u ? op.Ay.getVoiceStatesForChannelAlt(c.id, d.id) : []), [c.id, d.id, u]),
        { label: g, sublabel: p } = (function (e) {
            ...
            return s
                ? {
                      label: l
                          ? ec.intl.format(ec.t["2RWMFV"], { othersCount: a })
                          : ec.intl.format(ec.t.Da7tZx, { othersCount: a }),
                  }
                : {
                      label: l ? ec.intl.string(ec.t.DVDvCD) : ec.intl.string(ec.t.TY77rq),
                      sublabel: ec.intl.string(ec.t.wM2WTM),
                  };
        })({ currentUserId: (0, h.bG)([D.default], () => D.default.getId()), author: n.author, voiceStates: m }),
        A = (0, h.bG)([t8.A], () => null != t8.A.getGuild(d.id), [d.id]),
        f = (0, h.bG)([ej.A], () => ej.A.getVoiceChannelId() === c.id, [c.id]),
        I = (0, h.bG)([iA.Ay], () => a0([iA.Ay], t), [t]),
        v = t.state === ed.elq.ACCEPTING,
        { analyticsLocations: _ } = (0, C.Ay)(E.A.INVITE_EMBED),
        j = (0, n3._U)(t.code, n.id),
        N = (function (e) {
        ...
        })({ invite: t, message: n, voiceStates: m, guildId: d.id, channelId: c.id }),
        y = (0, oC.AO)(N),
        T = null != N,
        S = o.useCallback(() => {
                ...
                (0, aS.he)(
                    {
                        ...
                        stream_key: null != N ? (0, oE._z)(N) : void 0,
                        number_of_users_in_channel: m.length,
                    },
                    _,
                );
        }, [t, n, _, j, A, y, N, m.length, l, s]),
        b = o.useCallback(() => {
            A ? (0, ll.iN)(c.id) : s({ autoJoin: !1 }),
                tt.default.track(ed.HAw.VOICE_INVITE_EMBED_BREADCRUMB_CLICKED, {
                    ...
                    stream_key: null != N ? (0, oE._z)(N) : null,
                    number_of_users_in_channel: m.length,
                    location_stack: _,
                });
        }, [c.id, d.id, t.code, j, A, y, N, m.length, _, s]);
    (0, tx.A)({
        name: tp.ImpressionNames.VOICE_INVITE_EMBED,
        type: tp.ImpressionTypes.VIEW,
        properties: {
    ...
    let L = (0, h.bG)([X.A], () => X.A.useReducedMotion),
        R = o.useRef(null),
        [k, M] = o.useState({ percentX: 0, percentY: 0, proximity: 0 }),
        P = (0, h.bG)([oI.A], () => {
            let e = m.map((e) => e.user),
        ...
        w = o.useMemo(() => tO().throttle(M, 20), [M]);
    o.useEffect(() => () => w.cancel(), [w]);
    let U = o.useCallback(
            (e) => {
                if (L) return;
                ...
                w({ percentX: n, percentY: i, proximity: l });
            },
            [L, w],
        ),
        G = o.useCallback(() => {
            w.cancel(), M({ percentX: 0, percentY: 0, proximity: 0 });
        }, [w]);
    return (0, a.jsxs)("div", {
        ref: R,
        className: ow.kL,
        ...
        onMouseLeave: G,
        children: [
            (0, a.jsx)("div", { className: ow.ys }),
            (0, a.jsx)("div", { className: ow.r$, style: { "--custom-number-of-dots": 20 } }),
            (0, a.jsxs)("div", {
                className: ow.rf,
                children: [
                    (0, a.jsxs)("div", {
                        className: ow.Qs,
                        children: [
                            (0, a.jsx)(o_, { channel: c, guild: d, onClick: b }),
                            (0, a.jsxs)("div", {
                                className: ow.WD,
                                children: [
                                    (0, a.jsx)(x.E, {
                                        variant: "text-md/medium",
                                        children: (0, a.jsx)(l8.A, { lineClamp: 3, delay: 150, children: g }),
                                    }),
                                    null != p
                                        ? (0, a.jsx)(x.E, {
                                              variant: "text-sm/normal",
                                              className: ow.$B,
                                              children: (0, a.jsx)(l8.A, { delay: 150, children: p }),
                                          })
                                        : null,
                                ],
                            }),
                    ...
                    (0, a.jsx)("div", {
                        className: ow.RE,
                        children: (0, a.jsx)(oM, { ref: r, guildId: d.id, channelId: c.id, members: P, motion: k }),
                    }),
                ],
            }),
            (0, a.jsx)("div", {
                ...
                children: (0, a.jsx)(J.$, {
                    ...
                    fullWidth: !0,
                    disabled: !I,
                    text: f ? ec.intl.string(ec.t["3xjX0U"]) : ec.intl.string(ec.t.gpqgah),
                }),
            }),
        ],
    });
    ...
    let c = l ?? { state: ed.elq.RESOLVING, code: "" },
        ...
        f = function () {
            let { autoJoin: e } = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                n = null == m && l?.guild != null ? aD.DY(l.guild) : m;
...
function oY(e, t, n) {
    switch (t) {
        ...
        case ed.xL.STREAM_REQUEST:
            return ec.intl.string(oF.default.DKHhec);
...
function oz(e, t, n) {
    return e.author.id === n
        ? ec.intl.string(oF.default["8B3U5O"])
        : ec.intl.formatToPlainString(oF.default["d/qbC0"], { username: (0, oj.mG)(t.guild_id, t.id, e.author) });
}
...
function o$(e) {
    let { currentUserId: t, message: i, application: l, channel: s, analyticsLocations: r, onView: o } = e,
        ...
        g = (0, h.bG)([oK.Ay, oq.A], () =>
            oK.Ay.getVisibleRunningGames().find((e) => {
                let { id: t } = e;
                if (t === l.id) return !0;
        ...
        A = (0, h.bG)([oX.A], () => oX.A.getChannelId()),
        x = sR.default.extractTimestamp(i.id) + oQ.M < Date.now(),
        f = (0, a.jsx)(a.Fragment, { children: oz(i, s, t) }),
        { analyticsLocations: I } = (0, C.Ay)(r, E.A.REQUEST_TO_STREAM_INVITE_EMBED),
        v = ec.intl.string(oF.default["5+172e"]),
        _ = !1;
    return (
        x
            ? ((v = ec.intl.string(oF.default.u4QmWl)), (_ = !0))
            : null != p
              ? ((v = ec.intl.string(oF.default.P0wwmM)), (_ = !0))
              : A !== s.id
                ? ((v = ec.intl.string(oF.default.qRXats)), (_ = !0))
                : null == g && ((v = ec.intl.string(oF.default["43zohO"])), (_ = !0)),
        (0, a.jsx)(el, {
            header: ec.intl.string(oF.default.nAyuPp),
            title: l.name,
            staticBannerSrc: d,
            videoBannerSrc: c,
            bannerAspectRatio: u,
...
let dn = (0, dt.mj)({
    ...
    di = new Set(["1443349464290168976", "1443350165678198935", "1443033465766281327"]),
    dl = (0, dt.mj)({
...
var ds = n(475743),
    dr = n(942370),
    da = n(311350);
let dd = "in-game-auth-check-modal";
var dc = n(46225),
    du = n(379848),
    dm = n(409626),
    dh = n(692969),
    dg = n(232835),
    dp = n(970928);
let dA = 2 * sJ.A.Millis.HOUR;
function dx(e, t, n) {
    if (null == e) return !1;
    let i = null != t.activity ? t.activity.party_id : null,
        l = null != i && e.party?.id !== i,
        s = sR.default.extractTimestamp(t.id) + dA < Date.now(),
...
var df = n(737393),
    dE = n(835517),
    dC = n(635377);
let dI = new (n.n(dC)())({ max: 500 });
class dv extends h.Ay.Store {
...
function dS(e) {
    let { applicationName: t, iconSrc: n, viewAction: i } = e,
        ...
        d = null == i ? o : (0, a.jsx)(W.D, { onClick: i, className: dT.Qi, children: o });
    return (0, a.jsxs)("div", {
        className: dT.Xy,
        style: { background: r },
        children: [
            ...
            (0, a.jsxs)("div", {
                className: dT.fi,
                children: [
                    null != n ? (0, a.jsx)("img", { className: dT.V$, src: n, alt: "" }) : null,
                    (0, a.jsxs)("div", {
                        className: dT.Cr,
                        children: [
                            d,
...
function db(e) {
    let {
        ...
        N = (0, h.bG)([dg.A], () => dg.A.getMessages(l.id)),
        { actions: y, hasAccountLinkButton: T } = o.useMemo(() => {
            let e = [],
                i = !0,
                l = !1;
            if (
                      ...
                      ? (e = [
                            {
                                ...
                                isDeadEnd: !0,
                                onClick: () => {
                                    dN.Ay.launch({ applicationId: d, embedded: c });
                                },
                            },
                        ])
                      : null != u && ((e = [u]), (i = !1)),
    ...
    dy(
        y.some((e) => e.trackingArea === Q.kY.CLOUD_PLAY),
        E,
    );
    let S = y.length > 0,
        b = o.useMemo(
    ...
    return 0 === y.length
        ? (0, a.jsx)(dS, { applicationName: i, iconSrc: p, viewAction: g })
        : (0, a.jsxs)(a.Fragment, {
              children: [
                  (0, a.jsx)(el, {
                      header: s,
...
function dQ(e) {
            ...
            () =>
                l
                    .map((e) => {
                        switch (e) {
                            case dq.MOBILE:
                                return (0, a.jsx)(dk.u, { size: "xxs", color: "currentColor" });
                            case dq.ANDROID:
                                return (0, a.jsx)(dZ, { width: dR.E.xxs, height: dR.E.xxs, color: "currentColor" });
                            case dq.IOS:
                                return (0, a.jsx)(dM.z, { size: "xxs", color: "currentColor" });
                            case dq.PLAYSTATION:
                                return (0, a.jsx)(dP.X, { size: "xxs", color: "currentColor" });
                            case dq.XBOX:
                                return (0, a.jsx)(dw.Y, { size: "xxs", color: "currentColor" });
                            case dq.VR:
                                return (0, a.jsx)(dL.G, { size: "xxs", color: "currentColor" });
                            case dq.DESKTOP:
                                return (0, a.jsx)(dD.k, { size: "xxs", color: "currentColor" });
                            default:
                                return null;
                        }
                    })
    ...
    return (0, a.jsxs)("div", {
        ...
        children: [
            (0, a.jsx)("div", {
                className: dT.E6,
                children: s.map((e, t) => (0, a.jsx)("div", { className: dT.F2, children: e }, t)),
            }),
            (0, a.jsx)(x.E, { variant: "text-sm/medium", color: "currentColor", className: dT.kB, children: r }),
        ],
    });
}
function d$(e) {
    let {
        ...
        B = o.useMemo(
            () =>
                (0, a.jsxs)(x.E, {
                    ...
                    color: "none",
                    lineClamp: 2,
                    children: [U ? oW(t, i, l, r, !1) : O, U ? null : V],
                }),
            [U, t, i, l, r, O, V],
        ),
        H = o.useMemo(() => {
        ...
        F = o.useMemo(
            () => (0, a.jsxs)("div", { className: dT.pq, children: [H, B, I || U ? null : v] }),
            [B, I, U, v, H],
        ),
        Y = !!d,
        z = (0, M.x)(n),
        { canJoin: W, remoteJoinPlatform: K } = (function (e) {
            ...
            if (l.author.id === i || !dx(t, l, s.id)) return { canJoin: !1, remoteJoinPlatform: null };
            let d = (0, o5._)(t);
            if (!(0, dW.A)(d) || (0, dK.U)(d) || (0, dV.w)(n, t) || o6(l))
            ...
            if (l.activity?.type === ed.xL.JOIN && null != t) {
                let e = (function (e) {
                    ...
                    let n = dF.A.getRemoteApplicationActivity(t);
                    return null == n ||
                        (0, dY.e)(n) ||
                        (null != n.application_id &&
                            (dH.A.isConnected(n.application_id) ||
                                (function (e) {
                                    let { platform: t } = e;
                                    return (0, dB.m0)() ? t === ed.yTV.ANDROID : !!(0, dB.un)() && t === ed.yTV.IOS;
                                })(n)))
                        ? null
                ...
                if ((0, dz.A)(t, ed.jUm.SUPPORTS_JOIN_URL)) return { canJoin: !0, remoteJoinPlatform: null };
            }
            return (0, oZ.platformSupportsActivityJoin)() && o
        ...
        J = !(null == E || !dx(E, t, n.id) || !(0, dz.A)(E, ed.jUm.SYNC) || !oZ.isPlatformEmbedded || (0, dV.w)(C, E)),
        q = (function (e, t, n, i) {
            if (
                t.author.id === i ||
                !dx(e, t, n.id) ||
                t.activity?.type !== ed.xL.JOIN_REQUEST ||
                !(0, dz.A)(e, ed.jUm.JOIN)
            )
                return !1;
            let l = (0, o5._)(e);
            return !(!(0, dW.A)(l) || (0, dK.U)(l));
        })(E, t, n, r),
        X = (0, dV.w)(C, E),
        Z = null != E && (0, dz.A)(E, ed.jUm.SUPPORTS_REMOTE_ACTIVITY_ACTION_JOIN),
        ee = (0, h.bG)(
            [dG.A],
            () =>
                null != E && null != E.application_id && dG.A.getState(E.application_id, ed.xL.JOIN) === ed.eAD.LOADING,
        ),
        { actions: et, hasAccountLinkButton: ei } = o.useMemo(() => {
            let e = null,
                n = !0,
                i = !1;
            W && T
                    ...
                    ? (e = {
                          ...
                          onClick: () => {
                              dN.Ay.join({
                                  ...
                                  source: ed.ThZ.MESSAGE_EMBED,
                                  analyticsLocations: j,
                                  embedded: (0, dz.A)(E, ed.jUm.EMBEDDED),
        ...
        }, [W, T, S, J, q, X, u, t.author.id, t.id, E, l.id, l.guild_id, j, K, r, ee, y, L, k, b, Z]);
    dy(
        et.some((e) => e.trackingArea === Q.kY.CLOUD_PLAY),
        j,
    );
    let es = o.useMemo(
        () => (X ? null : (0, a.jsx)(dQ, { presenceActivity: E, remoteJoinPlatform: K, isGameLaunchable: Y })),
        [X, E, K, Y],
    );
    return (0, a.jsxs)(a.Fragment, {
        children: [
...
function d1(e) {
    ...
    let l,
        ...
        { iconSrc: C, name: v } = (function (e, t) {
            ...
            return {
                iconSrc:
                    (e.activity?.icon_override != null ? (0, dp.uD)(t.id, e.activity?.icon_override) : null) ??
                ...
                let { messageId: t, presenceActivity: n, application: i } = e,
                    { cachedImageURL: l, imageURL: s } = (0, h.cf)(
                        ...
                        () =>
                            ((e) => {
                                let { messageId: t, presenceActivity: n, application: i } = e,
                                    l = d_.getCoverImageURL({ messageId: t });
                                if (null === l) return { cachedImageURL: null, imageURL: null };
                                let s = 600 * (0, dE.A)(),
                                    r =
                                        (n?.assets?.invite_cover_image != null
                                            ? (0, dp.uD)(n.application_id, n.assets.invite_cover_image, s)
                                            : null) ??
                                        l ??
        ...
        y = (0, df.A)({ application: d, analyticsLocations: r }),
        T = o.useMemo(() => {
            if (null != y)
                return { label: ec.intl.string(ec.t["jaYS/h"]), icon: o8.h, trackingArea: Q.kY.CLOUD_PLAY, onClick: y };
        }, [y]),
        S = eS(d),
        b = o.useMemo(() => (null != j ? j : null != S && E ? S : void 0), [E, j, S]),
        L = dn.useConfig({ location: "RichPresenceGameActivityInviteEmbed" }),
        R = dl.useConfig({ location: "RichPresenceGameActivityInviteEmbed" }),
        { canStartAuthorization: k, hasAlreadyLinked: M, startAuthorization: P } = (0, dc.RD)(d),
        w = (function (e, t) {
            ...
            return (
                o.useEffect(() => {
                    if (s && !1 === c && !0 === t) {
                        if (((0, eJ.closeModal)(dd), r(!1), !l)) return;
                        let e = () => {
                            (0, eQ.P0)({
                                id: "account-linked-toast",
                                message: ec.intl.string(da.default.uG6teD),
                                type: e0.Ck.SUCCESS,
                            });
                        };
        ...
        D = (0, h.bG)([oK.Ay, oq.A], () => {
            let e = oq.A.getGameByApplication(d);
            return oK.Ay.getRunningGames().some((t) => t.id === d.id || (null != e && t.id === e.id));
        }, [d]),
        O = (0, h.bG)([oq.A], () => {
            if (di.has(d.id) || (null != d.parentId && di.has(d.parentId))) return !0;
            let e = oq.A.getGameByApplication(d);
            return null != e && di.has(e.id);
        }, [d]),
        U = oZ.isPlatformEmbedded && !O && R.requireAccountLink && k && !M,
        G = oZ.isPlatformEmbedded && !O && R.requireGameLaunch && !D,
        V = !dx(f, p, d.id),
        H = oY(v, p.activity?.type, V),
        F = o.useRef(null),
        Y = (0, h.bG)([dg.A], () => dg.A.getMessages(c.id)),
        z = () => {
            var e;
            let t = [];
            return (
                ...
                !Y.hasAnyAfter(e, (e) => null != e.activity && e.activity.type === ed.xL.JOIN, 25) &&
                    ...
                    !M &&
                    L.enabled &&
                    t.push(o7.M.GAME_INVITE_ACCOUNT_LINK_UPSELL),
                (0, a.jsx)(du.Ay, {
                    contentTypes: t,
                    children: (e) => {
                        let { visibleContent: t, markAsDismissed: n } = e;
                        if (t === o7.M.GAME_INVITE_ACCOUNT_LINK_UPSELL)
                            return (0, a.jsx)(o9.A, {
                                graphic: {
                                    type: "dynamic",
                                    component: de.DynamicGraphicComponent.ACCOUNT_LINK_DISPLAY,
                                    props: { application: d },
                                },
                                ...
                                onRequestClose: () => n(d0.i.USER_DISMISS),
                            });
                    },
                })
            );
...
function d6(e) {
    ...
    let {
        ...
        g = (0, dV.w)(c, s),
        p = (0, d4.Gq)(s, i.author, "Invite Embed"),
        A = o.useMemo(() => {
            let e = [];
            return (
                g ||
    ...
    return (0, a.jsx)(el, {
        ...
        iconSrc:
            ...
            (null == s || null == s.assets || null == s.assets.large_image
                ? null
                : (0, dp.uD)(t, s.assets.large_image, [rp.Ig, rp.Ig])) ?? void 0),
        info: I,
        actions: A,
        onClickContent: u,
        trackingConfig: {
...
function d5(e) {
    let {
        ...
        u = !dx(d, l, t.id),
        m = oY(t.name, l.activity?.type, u),
        h = o.useMemo(() => {
            if (null != d) return () => (0, d2.Mp)(d);
        }, [d]);
    return u
        ? (0, a.jsx)(d3, { application: t, message: l, header: m, onClickContent: h, onView: s, guildId: c })
        : (0, a.jsx)(d6, {
              application: t,
              message: l,
              header: m,
...
function d8(e) {
    let { analyticsLocations: t, app: n, channel: i, message: l, hideParty: s, onView: r } = e,
        ...
        u = (0, h.bG)([rm.A], () => {
            if (null == l.application) return rm.A.findActivity(l.author.id, (e) => e.type === ed.$pd.LISTENING);
            {
                let e = l.author.id;
                return (
                    o6(l) && (e = e === c && i.isPrivate() ? i.getRecipientId() : c),
                    rm.A.getApplicationActivity(e, l.application.id)
                );
            }
        }, [l, i, c]),
        m = (0, h.bG)([o2.A, o3.A], () => (0, o4.A)(o2.A, o3.A, d.id), [d.id]),
        g = (0, h.yK)([o1.A], () => (null == u || null == u.party ? [] : Array.from(o1.A.getParty(u.party.id) ?? [])), [
            u,
        ]),
        { partySize: p, maxPartySize: A } = (0, o5._)(u),
        x = o.useMemo(
            () =>
                g.map((e) => {
    ...
    return (0, d7.pH)(u?.party?.id) || d.id === o0.HT.id
        ? (0, a.jsx)(d5, {
              application: d,
              currentUserPresenceActivity: m,
              hideParty: s,
        ...
        : l.activity?.type === ed.xL.STREAM_REQUEST
          ? (0, a.jsx)(o$, { analyticsLocations: t, application: d, channel: i, currentUserId: c, message: l })
          : (0, a.jsx)(d1, {
    ...
    return (0, a.jsxs)("div", {
        ...
        children: [
            ...
            (0, a.jsx)(x.E, {
                ...
                children: (function (e) {
                    switch (e) {
                        case oH.BLOCK_UNDERAGE:
                            return ec.intl.string(ec.t.GhU4yl);
                        case oH.BLOCK_CHANNEL_RESTRICTION:
...
let ct = (e) => {
    ...
    let { channel: n, message: i, hideParty: l } = e,
        ...
        r =
            null != i.application
                ...
                : null != i.activity && null != i.activity.party_id && (0, d7.pH)(i.activity.party_id)
                  ? o0.HT
                  : void 0,
        ...
        u =
            ...
            null == t || (0, oV.U1)({ type: oV.fS.MINIMAL, data: t }) !== oB.Y.ADULT
                ? "display"
                : !0 !== c
                  ? "block_underage"
                  : n.isPrivate() || n.nsfw
    ...
    switch (u) {
        case oH.DISPLAY:
            ...
            return (0, a.jsx)(d8, { app: d, channel: n, message: i, hideParty: l, analyticsLocations: s });
        case oH.BLOCK_UNDERAGE:
        case oH.BLOCK_CHANNEL_RESTRICTION:
            return (0, a.jsx)(ce, { visibility: u });
        default:
            return null;
    }
};
...
function cl(e) {
    let { applicationId: t, guildId: n } = e,
        { data: i } = (0, e3.YY)(t);
    return null == i ? null : (0, a.jsx)(cs, { app: i, guildId: n });
}
function cs(e) {
...
var cr = n(394839),
    ...
    cm = n(416620);
let ch = [ed.Auw.GIFV],
    cg = 15 * sJ.A.Millis.MINUTE,
    cp = new Set(["discord-developers", "discord-testers", "discord-townhall", "discordgameslab"]),
    cA = (e) => () => {
        ...
        return null != i && null != l && (it.bp.test(n) || (r && (it.P8.test(n) || it.p4.test(n))))
            ? (0, a.jsx)(rC.A, { width: i, height: l, src: n, url: t, format: g.TL.IMAGE, className: cm.jj })
            : null;
    };
class cx extends o.Component {
    ...
    shouldRenderInvite(e) {
        ...
        return !(t.isDM() && !t.isSystemDM() && !t.isGroupDM() && cp.has(e));
    }
    ...
    renderCtaButton() {
        ...
        return (0, a.jsx)("div", { className: cm.od, children: i });
    }
    renderCodedLinks(e) {
                ...
                o = {
                    ...
                    onContextMenu:
                        null != s
                            ...
                            : void 0,
                    renderAudioComponent: x ? oU.SX : oU.Nj,
                    renderImageComponent: oU.Cr,
                    renderVideoComponent: oU.I1,
                    renderPlaintextFilePreview: oU.R6,
                    renderGenericFileComponent: oU.UB,
                    onPlay: (e, n, i) => {
    ...
    renderEmbed = (e, t, n, i) => {
        ...
        let m = ch.includes(e.type) ? e.url : (e.image?.url ?? e.video?.url);
        return (0, a.jsx)(
            nG.G.Provider,
            {
                value: (0, cc.b)(m, e.image, e.video, e.thumbnail, e.provider?.name),
    ...
    renderActivityInvite(e) {
        ...
        let { channel: t } = this.props;
        return (0, a.jsx)(ct, { channel: t, message: e, hideParty: !1 });
    }
    renderPublishBump(e) {
    ...
    renderThreadRoleMentionWarning(e) {
        if (
            ...
            !(Date.now() - sR.default.extractTimestamp(e.id) >= cg)
        )
            return (0, a.jsx)("div", { className: cm.xM, children: ec.intl.string(ec.t.ma8Rs0) });
    }
    ...
    renderInteractionPremiumUpsell(e) {
        ...
        return e.type !== u.l.INTERACTION_PREMIUM_UPSELL || null == t
            ? null
            : (0, a.jsx)(cl, { applicationId: t, guildId: this.props.channel.guild_id });
    }
    ...
    renderMediaPostEmbeds(e) {
        return e.embeds.flatMap((t) =>
            t.type !== ed.Auw.POST_PREVIEW || null == t.url
                ? []
                : (0, a.jsx)(iT, { embedUrl: t.url, message: e, channel: this.props.channel }, t.id),
        );
    }
    renderSafetyPolicyNotice(e) {
        return 1 === e.embeds.length && e.embeds[0].type === ed.Auw.SAFETY_POLICY_NOTICE
            ? (0, a.jsx)(ly, { message: e })
            : null;
    }
    ...
    renderPoll(e, t) {
        if (null != t) return (0, a.jsx)(i7, { message: e, poll: t, className: cm.PM });
    }
    ...
    renderEditedTag(e, t) {
        return (0, a.jsx)(cd.A, { message: e, compact: t, location: cd.O.AFTER_ACCESSORIES });
    }
    render() {
