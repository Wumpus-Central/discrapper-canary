...
class C {
    ...
    get shouldStopPropagation() {
        var e;
        return (e = h(this, v, "get")), e.get ? e.get.call(this) : e.value;
    }
    constructor(e, t, n, i) {
        var r;
        (0, f._)(this, v, { writable: !0, value: void 0 }), p(this, v, !0);
...
function D(e) {
    let {
        ...
        { addGlobalListener: j, removeAllGlobalListeners: Y } = (0, g.A)(),
        W = (0, A.J)((e, t) => {
            let i = H.current;
            if (v || i.didFirePressStart) return !1;
            let r = !0;
        ...
        K = (0, A.J)((e, i, r = !0) => {
            ...
            let a = !0;
            if (h) {
                let t = new C("pressend", i, e);
                h(t), (a = t.shouldStopPropagation);
            }
            if ((n && n(!1), B(!1), t && r && !v)) {
                let n = new C("press", i, e);
                    ...
                    onClick(t) {
                        if (
                            ...
                            if (
                                ...
                                (n = r && s), (e.isOverTarget = !1), X(t), z(t);
                            }
                ...
                (t.onPointerDown = (t) => {
                    ...
                    if (!e.isPressed) {
                        ...
                        "releasePointerCapture" in c && c.releasePointerCapture(t.pointerId),
                            j((0, s.TW)(t.currentTarget), "pointerup", n, !1),
                            j((0, s.TW)(t.currentTarget), "pointercancel", a, !1);
                    }
                    i && t.stopPropagation();
                }),
                    (t.onMouseDown = (t) => {
                                ...
                                let n = !1,
                                    i = setTimeout(() => {
                                        e.isPressed &&
                                            ...
                                            (n ? z(t) : ((0, N.e)(e.target), e.target.click()));
                                    }, 80);
                                j(t.currentTarget, "click", () => (n = !0), !0),
