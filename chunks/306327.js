...
let R = { D50: [0.3457 / 0.3585, 1, 0.8251046025104602], D65: [0.3127 / 0.329, 1, 1.0890577507598784] };
function O(e) {
    return Array.isArray(e) ? e : R[e];
}
function b(e, t, n, r = {}) {
    if (((e = O(e)), (t = O(t)), !e || !t))
...
function w(e, { meta: t } = {}) {
    ...
    if (((n.parsed = _(n.str)), n.parsed)) {
        ...
        if ("color" === e) {
            ...
            let a = "",
                o = e in x.registry ? e : r;
            if (o in x.registry) {
                let e = x.registry[o].formats?.color?.id;
...
function M(e) {
    ...
    return t instanceof x || (e.space = x.get(t)), void 0 === e.alpha && (e.alpha = 1), e;
}
let P = 75e-6;
class x {
    constructor(e) {
        (this.id = e.id),
            (this.name = e.name),
            (this.base = e.base ? x.get(e.base) : null),
        ...
        for (let t in ((this.white = O(n)), (this.formats = e.formats ?? {}), this.formats)) {
        ...
        this.formats.color?.id || (this.formats.color = { ...(this.formats.color ?? {}), id: e.cssId || this.id }),
            e.gamutSpace
                ? (this.gamutSpace = "self" === e.gamutSpace ? this : x.get(e.gamutSpace))
                : this.isPolar
    ...
    to(e, t) {
        ...
        if (((e = x.get(e)), this.equals(e))) return t;
    ...
    static registry = {};
    static get all() {
        return [...new Set(Object.values(x.registry))];
    }
    static register(e, t) {
        if (
    ...
    static get(e, ...t) {
        if (!e || e instanceof x) return e;
        if ("string" === a(e)) {
            let t = x.registry[e.toLowerCase()];
            if (!t) throw TypeError(`No color space found with id = "${e}"`);
            return t;
        }
        if (t.length) return x.get(...t);
    ...
    constructor(e) {
        e.coords ||
            ...
            e.toXYZ_M &&
                ...
                ((e.toBase ??= (t) => {
                    let n = i(e.toXYZ_M, t);
                    return this.white !== this.base.white && (n = b(this.white, this.base.white, n)), n;
                }),
                (e.fromBase ??= (t) => ((t = b(this.base.white, this.white, t)), i(e.fromXYZ_M, t)))),
            (e.referred ??= "display"),
            super(e);
    }
}
function V(e, t) {
    return ((e = M(e)), !t || e.space.equals(t)) ? e.coords.slice() : (t = x.get(t)).from(e);
}
function B(e, t) {
    e = M(e);
    let { space: n, index: r } = x.resolveCoord(t, e.space);
    return V(e, n)[r];
}
function H(e, t, n) {
    return (e = M(e)), (t = x.get(t)), (e.coords = t.to(e.space, n)), e;
}
function j(e, t, n) {
    if (((e = M(e)), 2 == arguments.length && "object" === a(arguments[1]))) {
        let t = arguments[1];
        for (let n in t) j(e, n, t[n]);
    } else {
        "function" == typeof n && (n = n(B(e, t)));
        let { space: r, index: i } = x.resolveCoord(t, e.space),
            s = V(e, r);
        (s[i] = n), H(e, r, s);
    }
    return e;
...
var Y = new x({
    ...
    white: "D50",
    base: G,
    fromBase: (e) => b(G.white, "D50", e),
    toBase: (e) => b("D50", G.white, e),
});
let W = 216 / 24389,
    K = 24 / 116,
    $ = 24389 / 27,
...
var q = new x({
    ...
    base: Y,
    fromBase(e) {
        let t = e.map((e, t) => e / z[t]).map((e) => (e > W ? Math.cbrt(e) : ($ * e + 16) / 116));
    ...
    toBase(e) {
        ...
        return (
            ...
            (t[2] = t[1] - e[2] / 200),
            [
                t[0] > K ? Math.pow(t[0], 3) : (116 * t[0] - 16) / $,
                e[0] > 8 ? Math.pow((e[0] + 16) / 116, 3) : e[0] / $,
                t[2] > K ? Math.pow(t[2], 3) : (116 * t[2] - 16) / $,
            ].map((e, t) => e * z[t])
        );
    },
    formats: {
...
function ei(e, t, { kL: n = 1, kC: r = 1, kH: i = 1 } = {}) {
        ...
        G =
            ...
            0.015 *
                ...
                (o =
                    ...
                    0.17 *
                        Math.cos(
                            ((a = I * T == 0 ? O : b <= 180 ? O / 2 : O < 360 ? (O + 360) / 2 : (O - 360) / 2) - 30) *
                                en,
                        ) +
    ...
    return Math.sqrt(
        (F +=
            ...
            (D / (i * G)) ** 2 +
            (N / (r * U)) *
                (-1 * Math.sin(2 * (30 * Math.exp(-1 * ((a - 275) / 25) ** 2)) * en) * (2 * Math.sqrt(P / (P + J)))) *
                (D / (i * G))),
    );
}
let es = [
...
var ex = new x({
        ...
        fromBase(e) {
            let [t, n, r] = e,
                ...
                [a, o, l] = i(eM, s);
            return [((1 + eb) * a) / (1 + eb * a) - eD, o, l];
        },
        toBase(e) {
            let [t, n, r] = e,
                s = i(eP, [(t + eD) / (1 + eb - eb * (t + eD)), n, r]).map(function (e) {
                    let t = ev - e ** eO,
                        n = eC * e ** eO - eN;
                    return 1e4 * (t / n) ** ey;
                }),
...
function ts(e) {
    ...
    let [r, i] = e7.slice(n, n + 2),
        [s, a] = e8.slice(n, n + 2);
    return Z((t * (a * r - s * i) - 100 * r * a) / (t * (a - s) - 100 * a));
}
...
function tl(e, t) {
    ...
    let n = 0,
        r = Math.cos((n = void 0 !== e.h ? Z(e.h) * tt : ts(e.H) * tt)),
        s = Math.sin(n),
        a = 0;
...
function tC(
    ...
    let o;
    if (((e = M(e)), s(arguments[1]) ? (n = arguments[1]) : n || (n = e.space), e_(e, (n = x.get(n)), { epsilon: 0 })))
        return e;
    if ("css" === t) o = tb(e, { space: n });
    else {
        if ("clip" === t || e_(e, n)) o = tD(e, n);
            ...
            if (s(e, u) > i) {
                if (3 === Object.keys(a).length) {
                    let t = x.resolveCoord(a.channel),
                        n = B(tD(e, t.space), t.id);
                    if ((l(n) && (n = 0), n >= a.max)) return tD({ space: "xyz-d65", coords: R.D65 }, e.space);
                    if (n <= a.min) return tD({ space: "xyz-d65", coords: [0, 0, 0] }, e.space);
                }
                let r = x.resolveCoord(t),
                    u = r.space,
                    c = r.id,
                    d = tD(e, u);
...
tC.returns = "color";
let tR = { space: eu, coords: [1, 0, 0] },
    tO = { space: eu, coords: [0, 0, 0] };
function tb(e, { space: t } = {}) {
    let n = 0.02,
        r = 1e-4;
    (e = M(e)), t || (t = e.space), (t = x.get(t));
    let i = x.get("oklch");
...
function tL(e, { precision: t = C.precision, format: n = "default", inGamut: r = !0, ...i } = {}) {
    ...
    e = M(e);
    let a = n;
    n = e.space.getFormat(n) ?? e.space.getFormat("default") ?? x.DEFAULT_FORMAT;
...
let tM = 1.09929682680944,
    tP = 0.018053968510807;
var tx = new F({
        id: "rec2020",
        name: "REC.2020",
        base: tw,
        toBase: (e) =>
            e.map(function (e) {
                return e < 4.5 * tP ? e / 4.5 : Math.pow((e + tM - 1) / tM, 1 / 0.45);
            }),
        fromBase: (e) =>
            e.map(function (e) {
                return e >= tP ? tM * Math.pow(e, 0.45) - (tM - 1) : 4.5 * e;
            }),
    }),
    tk = new F({
        id: "p3-linear",
...
var tq = Object.freeze({ __proto__: null, getLuminance: tK, register: tz, setLuminance: t$ });
function tZ(e, t) {
    (e = M(e)), (t = M(t));
...
function ne(e, t) {
    let n, r, i, s, a, o;
    (t = M(t)), (e = M(e)), (t = tD(t, "srgb")), ([s, a, o] = t.coords);
    ...
    return (
        100 *
        (i =
            Math.abs((r = Math.abs(d - c) < t6 ? 0 : _ ? (n = d ** tX - c ** tQ) * t4 : (n = d ** t0 - c ** tJ) * t7)) <
            t3
                ? 0
                : r > 0
                  ? r - t5
...
function ni(e, t) {
    return (e = M(e)), (t = M(t)), Math.abs(B(e, [q, "l"]) - B(t, [q, "l"]));
}
let ns = 216 / 24389,
    na = 24 / 116,
    no = 24389 / 27,
...
var nE = Object.freeze({
    ...
    darken: function (e, t = 0.25) {
        return j(e, [x.get("oklch", "lch"), "l"], (e) => e * (1 - t));
    },
...
function nI(e, t, n = {}) {
    ...
    (e = M(e)), (t = M(t)), (e = ef(e)), (t = ef(t));
    let o = { colors: [e, t], options: n };
    if (
        ((r = r ? x.get(r) : x.registry[C.interpolationSpace] || e.space),
        (i = i ? x.get(i) : r),
        (e = tD(e, r)),
        (t = tD(t, r)),
        (e = tC(e)),
...
var nF = new x({
        ...
        fromBase(e) {
            ...
            let s = n <= nx ? nk * n : 116 * Math.cbrt(n) - 16;
...
function nJ(e) {
    let t = Math.pow(e + 16, 3) / 1560896,
        ...
        a = n * (284517 * nK - 94839 * nz),
        o = n * (838422 * nz + 769860 * n$ + 731718 * nK),
        l = n * (632260 * nz - 126452 * n$),
        u = n * (284517 * nq - 94839 * nX),
        c = n * (838422 * nX + 769860 * nZ + 731718 * nq),
        d = n * (632260 * nX - 126452 * nZ);
    return {
        r0s: r / s,
        r0i: (i * e) / s,
        r1s: r / (s + 126452),
...
N.add("chromatic-adaptation-start", (e) => {
    ...
    (R.ACES = [0.32168 / 0.33767, 1, 1.0088251843515859]);
let r_ = [
...
class rg {
    constructor(...e) {
        ...
        1 === e.length && (t = M(e[0])),
            ...
            Object.defineProperty(this, "space", { value: x.get(n), writable: !1, enumerable: !0, configurable: !0 }),
...
Object.assign(rg, { util: y, hooks: N, WHITES: R, Space: x, spaces: x.registry, parse: w, defaults: C }),
Object.keys(rE)))
    x.register(rE[e]);
for (let e in x.registry) rA(e, x.registry[e]);
function rA(e, t) {
    let n = e.replace(/-/g, "_");
        ...
        get() {
            ...
            return "u" < typeof Proxy
                ...
                : new Proxy(n, {
                      has: (e, n) => {
                          try {
                              return x.resolveCoord([t, n]), !0;
                          } catch (e) {}
                          return Reflect.has(e, n);
                      },
                      get: (e, n, r) => {
                          if (n && "symbol" != typeof n && !(n in e)) {
                              let { index: r } = x.resolveCoord([t, n]);
                              if (r >= 0) return e[r];
                          }
                      ...
                      set: (n, r, i, s) => {
                          if ((r && "symbol" != typeof r && !(r in n)) || r >= 0) {
                              let { index: s } = x.resolveCoord([t, r]);
