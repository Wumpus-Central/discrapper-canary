...
async function $(e) {
    ...
    if (!F()) return void P.verbose('Skipping track for pid '.concat(e, ' - overlay is disabled'));
...
async function eo(e) {
    ...
    let o = R === l.R5.OUT_OF_PROCESS_V2 || R === l.R5.OUT_OF_PROCESS_V3 || R === l.R5.OUT_OF_PROCESS_V3_LIMITED_INTERACTION,
...
async function eu(e, t) {
    if (!O.iP) return void P.verbose('setOverlayEnabled: not supported');
...
function eh(e) {
    if ((__OVERLAY__ && P.error('Running handleGameToggleOverlay While in Overlay Context!'), P.verbose('handleGameToggleOverlay', { action: e }), !F())) {
