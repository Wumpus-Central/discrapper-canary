...
function I(e, t, n) {
    ...
    let s = {
        ...
        video_media_session_id: a(r.du.VideoMediaSessionId),
        stream_media_session_id: a(r.du.StreamMediaSessionId),
        intentional_crash_reason: a(r.du.IntentionalCrashReason),
