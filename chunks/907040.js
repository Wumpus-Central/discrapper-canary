...
let ea = (e, t) => {
    ...
    eo = (e, t) => {
        ...
        r.useEffect(() => {
            ...
            r.useEffect(() => {
                i(T.kJ.getState().activeCategoryIndex);
            }, [e]);
    },
    el = (e, t, n, i) => {
        r.useLayoutEffect(() => {
    ...
    e_ = function (e, t) {
        ...
        let { location: eH } = (0, m.O)(),
            ...
            e2 = r.useCallback((e) => {
                x.d4.updateSetting(Array.from(e));
            }, []),
            e3 = (0, N.ep)({
                gridWrapperRef: ek,
                containerWidth: e_,
        ...
        eo(e_, eU),
            ...
            r.useLayoutEffect(() => {
                ...
                (null === (e = e5[n]) || void 0 === e ? void 0 : e[t]) == null && 0 !== t && T.kJ.setInspectedExpressionPosition(0, 0);
            }, [e5]),
            r.useEffect(() => {
