...
let eu = (e, t) => {
    ...
    eE = function (e, t) {
        ...
        let s,
            ...
            eF = i.useRef(null);
        null == c && null != eM && (c = eM);
        let eZ = null != (a = null != (n = null == c ? void 0 : c.getGuildId()) ? n : _) ? a : null,
            [eH, eY] = i.useState(!1),
        ...
        e_(eu, eV),
            ...
            i.useLayoutEffect(() => {
                ...
                (null == (e = tt[n]) ? void 0 : e[t]) == null && 0 !== t && T.kJ.setInspectedExpressionPosition(0, 0);
            }, [tt]),
            i.useEffect(() => {
