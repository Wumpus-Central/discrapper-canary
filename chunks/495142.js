...
let H = {}.toString;
function U(t, e) {
    if (void 0 !== e && "[object Object]" !== H.call(e)) throw Error("Options should be object or undefined");
...
class I extends L {
    ...
    digestInto(t) {
        ...
        let { buffer: s, view: i, blockLen: r, isLE: n } = this,
            { pos: o } = this;
        (s[o++] = 128), this.buffer.subarray(o).fill(0), this.padOffset > r - o && (this.process(i, 0), (o = 0));
...
class B extends I {
    ...
    process(t, e) {
        ...
        for (let t = 0; t < 64; t++) {
            let e = (f + (u(o, 6) ^ u(o, 11) ^ u(o, 25)) + E(o, h, a) + k[t] + _[t]) | 0,
                c = ((u(s, 2) ^ u(s, 13) ^ u(s, 22)) + A(s, i, r)) | 0;
            (f = a), (a = h), (h = o), (o = (n + e) | 0), (n = r), (r = i), (i = s), (s = (e + c) | 0);
        }
        (s = (s + this.A) | 0),
            (i = (i + this.B) | 0),
            (r = (r + this.C) | 0),
...
let O =
    ((i = () => new B()),
    ((r = (t) => i().update(w(t)).digest()).outputLen = (n = i()).outputLen),
...
function j(t, e, s, i) {
    ...
    let n,
        {
            ...
            a(t);
            let { c: r, dkLen: n, asyncTick: h } = U({ dkLen: 32, asyncTick: 10 }, i);
            if ((o(r), o(n), o(h), r < 1)) throw Error("PBKDF2: iterations (c) should be >= 1");
            let f = w(e),
                c = w(s),
                l = new Uint8Array(n),
                u = v.create(t, f),
    ...
    for (let t = 1, e = 0; e < f; t++, e += u.outputLen) {
        ...
        b.setInt32(0, t, !1), (n = d._cloneInto(n)).update(x).digestInto(p), s.set(p.subarray(0, s.length));
        for (let t = 1; t < h; t++) {
            u._cloneInto(n).update(p).digestInto(p);
            for (let t = 0; t < s.length; t++) s[t] ^= p[t];
        }
    }
    return (r = n), u.destroy(), d.destroy(), r && r.destroy(), p.fill(0), c;
}
...
function $(t, e, s, i, r) {
    ...
    for (let i = 0; i < r; i++, n += 16, e += 16) D(s, o, t, e, s, n), i > 0 && (o += 16), D(s, n, t, (e += 16), s, o);
}
async function S(t, e, s) {
    let i,
        {
            ...
            if ((o(i), o(r), o(n), o(h), o(a), o(f), void 0 !== l && "function" != typeof l))
            ...
            return { N: i, r, p: n, dkLen: h, blockSize32: d, V: y, B32: p, B: b, tmp: g, blockMixCb: w, asyncTick: a };
        })(t, e, s);
    x || p(u);
    for (let t = 0; t < h; t++) {
        let e = f * t;
    ...
    return x || p(u), (i = j(O, t, d, { c: 1, dkLen: a })), d.fill(0), l.fill(0), b.fill(0), i;
}
