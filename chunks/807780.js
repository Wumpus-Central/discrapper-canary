                  ...
                  (0, l.jsxs)("div", {
                      children: [
                          ...
                          (0, l.jsx)(p.$, {
                              ...
                              onClick: () => {
                                  ed.A.open(t.id, ee.BEX.ONBOARDING), (0, m.Dr)(s, { dismissAction: eu.i.PRIMARY });
                              },
...
let ej = i.memo(function () {
    ...
    eE = i.memo(function (e) {
        let { index: t } = e;
        return (0, l.jsx)(w.E, { variant: "text-xs/normal", className: eA.Ks, children: "\xb7" }, `separator-${t}`);
    }),
    ...
    let s,
        ...
        N = i.useCallback(
            (e) => {
                ...
                return (0, l.jsx)(ef, { channel: n.channel, guild: o, onCategoryClick: C }, n.channel.id);
            },
            [c, o, g, C],
        ),
        p = i.useCallback(
            (e) => {
                ...
                if (0 === t && -1 === g) return (0, l.jsx)(ex, { guild: o });
...
function eb(e) {
    ...
    return (0, l.jsx)(j.A, {
        ...
        maxWidth: 600,
        children: (0, l.jsx)(E.A, { channelId: t, baseChannelId: em.VV.CHANNEL_BROWSER }),
    });
}
function eS(e) {
    let { guildId: t } = e,
        [s, a] = i.useState(""),
        d = i.useRef(null),
        c = (0, r.bG)([b.A], () => b.A.getGuild(t)),
        o = (0, r.bG)([_.Ay], () => _.Ay.getChannels(t)),
        u = (0, r.bG)([I.A], () => I.A.getCategories(t)),
        h = (0, A.vh)(t, u, o, s),
        x = (0, r.bG)([S.A], () => S.A.canWithPartialContext(ee.xBc.MANAGE_CHANNELS, { guildId: t })),
              ...
              children: [
                  (0, l.jsxs)("div", {
                      ...
                      children: [
                          ...
                          x ? (0, l.jsx)(p.$, { icon: f.j, onClick: j, text: en.intl.string(en.t.CumH4u) }) : null,
                      ],
                  }),
...
var ta = n(164048),
    ...
    to = n(275196),
    tu = n(964623);
let th = eR._3.SIZE_80,
    tx = "required";
function tm(e) {
    let { guild: t, user: n } = e,
        { avatarSrc: i, eventHandlers: s, isAvatarAnimating: d } = (0, eW.A)({ user: n, guildId: t.id, size: 120 }),
        { avatarDecorationSrc: c } = (0, eH.A)({ user: n, size: (0, ek.Te)(th), onlyAnimateOnHoverOrFocus: !d }),
        o = (0, r.bG)([eK.Ay], () => eK.Ay.getSelfMember(t.id)),
        u = (0, r.yK)([eK.Ay], () => eK.Ay.getMemberRoleWithPendingUpdates(t.id, n.id)),
        h = (0, r.bG)([ez.A], () => ez.A.getSortedRoles(t.id)),
        x = (0, eF.Ay)(t.id, n.id),
        m = h.filter((e) => u.includes(e.id)),
        C = (0, eq.Ay)(n.id, t.id);
    (0, eT.Ay)(() => {
        (0, eZ.A)(n.id, n.getAvatarURL(t.id, (0, eR.FT)(th)), { guildId: t.id });
    });
...
function tC(e) {
    let { prompt: t, guild: n } = e,
        ...
        x = t?.options?.filter((e) => o.has(e.id)),
        m = (0, e5.a)(x),
        C = (0, e5.vV)(x),
        ...
        { helpText: g, helpTextAdditional: N } = (0, tt.W)({
            ...
            itemHook: (e, t) => (0, l.jsx)(w.E, { variant: "text-xs/medium", color: "text-strong", children: e }, t),
        }),
        { handleSelectOption: p } = te(n.id),
        f = t.options.map((e) => ({ value: e.id, ...e })),
        j = t.options.filter((e) => A.includes(e.id)).map((e) => e.id);
    return (0, l.jsxs)("div", {
        className: to.J1,
        "data-new": t.isNew,
        children: [
            ...
            (0, l.jsxs)(es.D, {
                ...
                children: [
                    t.title,
                    t.required
                        ? (0, l.jsx)("span", { className: a()(to.mw, { [to.So]: s?.type === tx }), children: "*" })
                        : null,
                ],
            }),
            (0, l.jsx)(tr.A, {
                ...
                onChange: (e) => {
                    ...
                    if (null != n) p(t, n, !0), t.singleSelect && t.options.forEach((e) => o.delete(e.id)), o.add(n.id);
                        ...
                        if (A.length <= n.length && t.required) return void d({ type: tx });
                        n.forEach((e) => {
        ...
        : (0, l.jsxs)("div", {
              ...
              children: [
                  ...
                  (0, l.jsx)("div", {
                      className: to.lA,
                      children: n.map((e, n) =>
                          (0, l.jsx)(tl.A, { connection: e, guildId: t.id, location: eU.A.CHANNELS_AND_ROLES }, n),
                      ),
                  }),
              ],
          });
...
function tN(e) {
    let t,
        ...
        x = i.useCallback(() => {
            (0, q.pX)(ee.BVt.CHANNEL(n, em.VV.CHANNEL_BROWSER)), s?.();
        }, [n, s]),
        m = (0, r.bG)([eX.Ay], () => eX.Ay.hasUnread(n, tc.P.GUILD_ONBOARDING_QUESTION)),
            ...
            children: (0, l.jsxs)("div", {
                ...
                children: [
                    ...
                    (0, l.jsx)(w.E, {
                        ...
                        children: en.intl.format(en.t["jH+ktB"], { onBrowseChannels: x }),
                    }),
                ],
            }),
        });
                                ...
                                (0, l.jsxs)("div", {
                                    children: [
                                        (0, l.jsx)(es.D, {
                                            variant: "heading-md/semibold",
                                            color: "text-strong",
                                            children: en.intl.format(en.t["8IV8K9"], { count: f.length }),
                                        }),
                                        (0, l.jsx)(w.E, {
                                            variant: "text-xs/normal",
                                            color: "text-muted",
...
function tj(e) {
    let { guildId: t, selectedSection: n } = e,
        ...
        d = (0, ey.A)(s),
        [o, x] = i.useState(n ?? td.qC.CUSTOMIZE);
    i.useEffect(() => {
        null != n && x(n);
    }, [n]),
        i.useEffect(() => {
            d || o !== td.qC.CUSTOMIZE || x(td.qC.BROWSE);
        }, [d, o]);
    let m = (0, r.bG)([v.Ay], () => v.Ay.getCurrentSidebarChannelId(em.VV.CHANNEL_BROWSER)),
        C = null != m && o === td.qC.BROWSE,
                                  ...
                                  (function () {
                                      switch (o) {
                                          case td.qC.CUSTOMIZE:
                                              return (0, l.jsx)(tN, {
                                                  guildId: t,
                                                  onBrowseChannels: () => x(td.qC.BROWSE),
                                              });
                                          case td.qC.BROWSE:
                                          default:
