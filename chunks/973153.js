...
class E extends i.Ay.Store {
    ...
    data(e) {
        return this.guilds.has(e) || this.guilds.set(e, new A()), this.guilds.get(e);
    }
    ...
    handleMessagePreviewsLoaded(e) {
        g.verbose(`adding remote previews (guildId: ${e.guildId}, messages: ${e.messages.length})`);
    ...
    handleMessagePreviewsLocallyLoaded(e) {
        g.verbose(`adding local previews (guildId: ${e.guildId}, messages: ${e.messages.length})`);
        let t = this.data(e.guildId);
