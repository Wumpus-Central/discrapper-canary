...
function v(e) {
    var t, n, r;
    let { emojiHose: a, context: v, canvasWidth: h, canvasHeight: S, fallbackColor: b, outlineColorDark: O, outlineColorLight: y, streamerId: _, deadDrawables: Z } = e;
    v.save();
    ...
    (g(a, (e) => {
        ...
        a.lastUpdatedAt + p.FO < Date.now() && (0, u.ZZ)(_, a),
