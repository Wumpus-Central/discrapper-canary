...
function v(e) {
    var t, n, i, a;
    let { emojiHose: v, context: S, canvasWidth: I, canvasHeight: x, fallbackColor: _, outlineColorDark: C, outlineColorLight: b, streamerId: E, deadDrawables: y } = e;
    S.save();
    let Z = c.Z.getEmojiImage(null !== (n = null !== (t = v.emojiId) && void 0 !== t ? t : v.emojiName) && void 0 !== n ? n : ''),
        T = (0, d.np)(v.x, I),
        N = (0, d.np)(v.y, x),
    ...
    if (
        ...
        !(function (e, t, n) {
            var i;
            let a = null !== (i = h.getState().lastSpawned[e.id]) && void 0 !== i ? i : 0,
                o = Date.now();
        ...
        v.state === u.f.STOP && ((i = v), !(Object.keys(null !== (a = h.getState().particles[i.id]) && void 0 !== a ? a : {}).length > 0)))
    )
        y.push(v);
    S.restore();
}
