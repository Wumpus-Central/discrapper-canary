...
function x(e) {
    ...
    return null != f
        ...
        : (0, a.jsxs)(s.E, { className: r()(A.QC, A.O2, u), variant: E, children: [l, " ", c] });
}
function N(e) {
    let {
            user: t,
...
function T(e) {
    let { user: t, usernameIcon: n, onClickUsername: l, pronouns: s, primaryGuild: d, trailing: u, onClose: E } = e,
        m = null != s && s.length > 0,
        g = f(t),
        p = t.isProvisional
            ? null
    ...
    return (0, a.jsxs)("div", {
        ...
        children: [
            null != p && null != l ? (0, a.jsx)(i.D, { onClick: l, className: A.vk, children: p }) : p,
            m &&
                (0, a.jsxs)(a.Fragment, {
                    children: [
                        (0, a.jsx)(I, {}),
                        (0, a.jsx)(o.m, {
                            ...
                            delay: _.In,
                            ariaHidden: !0,
                            children: (0, a.jsx)("span", { className: A.Ez, children: (0, a.jsx)(v, { pronouns: s }) }),
                        }),
                    ],
                }),
            (0, a.jsx)(b.Ay, { primaryGuild: d, userId: t.id, onClose: E, containerClassName: A.L4, className: A.Mp }),
            u,
        ],
    });
}
