...
function S(e) {
    ...
    return null != _
        ...
        : (0, i.jsxs)(s.E, { className: a()(m.QC, m.O2, u), variant: E, children: [r, " ", c] });
}
function N(e) {
    let {
            user: t,
    ...
    return (0, i.jsxs)("div", {
        className: a()(m.K$, "lg" === o && m.lg),
        children: [
            null != c ? (0, i.jsx)(l.D, { onClick: c, className: m.vk, children: h }) : h,
...
function C(e) {
    ...
    return (0, i.jsxs)(s.E, {
        ...
        color: "text-strong",
        children: [
            (0, i.jsx)(o.A, { tag: "span", children: T.intl.formatToPlainString(T.t["DRI+T7"], { pronouns: t }) }),
...
function R(e) {
    let { user: t, usernameIcon: n, onClickUsername: r, pronouns: s, primaryGuild: o, trailing: u, onClose: E } = e,
        A = null != s && s.length > 0,
        h = _(t),
        I = t.isProvisional
            ? null
    ...
    return (0, i.jsxs)("div", {
        ...
        children: [
            null != I && null != r ? (0, i.jsx)(l.D, { onClick: r, className: m.vk, children: I }) : I,
            A &&
                (0, i.jsxs)(i.Fragment, {
                    children: [
                        (0, i.jsx)(O, {}),
                        (0, i.jsx)(d.m, {
                            ...
                            delay: p.In,
                            ariaHidden: !0,
                            children: (0, i.jsx)("span", { className: m.Ez, children: (0, i.jsx)(C, { pronouns: s }) }),
                        }),
                    ],
                }),
            (0, i.jsx)(f.Ay, { primaryGuild: o, userId: t.id, onClose: E, containerClassName: m.L4, className: m.Mp }),
            u,
        ],
    });
}
