...
function A(e) {
    ...
    let { children: n, initialTab: l, guildId: a } = e,
        R = (0, o.e7)([O.Z], () => O.Z.getGuild(a)),
        A = (0, o.e7)([E.Z], () => E.Z.isViewingServerShop(a)),
        b = (0, I.g)(R, 'guild_shop_page'),
            ...
            value: {
                ...
                handlePreviewDismiss: (e) => {
                    ...
                    if (v === T.y.GUILD_PRODUCTS_PREVIEW) (e.stopPropagation(), k(T.y.GUILD_ROLE_SUBSCRIPTIONS), (t.action_taken = g.mz.DISMISS_TAB_PREVIEW));
                        ...
                        var n;
                        ((0, p.dL)(N.Z5c.CHANNEL(a, null == (n = S.ZP.getDefaultChannel(a)) ? void 0 : n.id)), (t.action_taken = g.mz.DISMISS_FULL_PREVIEW));
                    }
                    f.default.track(N.rMx.GUILD_SHOP_PREVIEW_CLICK, t);
                }
            },
            children: n
        })
