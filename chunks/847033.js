...
function A(e) {
    ...
    let [L, k] = r.useState(l),
        Z = (y && !(D && b)) || L === T.y.GUILD_PRODUCTS_PREVIEW;
    return (
        r.useEffect(() => {
            k(l);
        }, [l]),
        (0, i.jsx)(m.Provider, {
            value: {
                ...
                handlePreviewDismiss: (e) => {
                    ...
                    if (L === T.y.GUILD_PRODUCTS_PREVIEW) (e.stopPropagation(), k(T.y.GUILD_ROLE_SUBSCRIPTIONS), (t.action_taken = f.mz.DISMISS_TAB_PREVIEW));
                    else {
                        var n;
