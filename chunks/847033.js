...
function C(e) {
    ...
    let [k, Z] = i.useState(l),
        L = (y && !(h && b)) || k === f.y.GUILD_PRODUCTS_PREVIEW;
    return (
        i.useEffect(() => {
            Z(l);
        }, [l]),
        (0, r.jsx)(g.Provider, {
            value: {
                ...
                handlePreviewDismiss: (e) => {
                    ...
                    if (k === f.y.GUILD_PRODUCTS_PREVIEW) e.stopPropagation(), Z(f.y.GUILD_ROLE_SUBSCRIPTIONS), (t.action_taken = A.mz.DISMISS_TAB_PREVIEW);
                    else {
                        var n;
