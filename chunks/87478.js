a.d(t, { A0: () => en, NI: () => ei, Ay: () => eo, Tb: () => er }), a(321073);
var s,
    r,
    n,
    i = a(627968),
...
var q = a(282818),
    ...
    en = (((r = {}).SMALL = "small"), (r.MEDIUM = "medium"), (r.LARGE = "large"), r),
    ei =
...
let eo = function () {
    let e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
        ...
        { shouldShowBonusOrbsUX: er, multiplier: en } = (0, g.Dl)(Y.rE.NITRO_HOME_MARKETING),
        eo = o.useRef(null),
        el = (0, b.l)("bento_box"),
        ec = {
            ...
            orbRewards: { thumbnail: es.A, assetUrl: ea.A },
            orbMultiplier: { thumbnail: $, assetUrl: T ? Z : J },
            combinedOrbs: { thumbnail: $, assetUrl: T ? Z : J },
            threePPromotions: { thumbnail: el ? (0, i.jsx)(I, { ref: eo }) : Q, assetUrl: el ? void 0 : Q },
        },
        ed = {
            serverProfiles: {
                name: "serverProfiles",
            ...
            threePPromotions: {
                ...
                title: el ? F.intl.string(F.t.E4U4SS) : F.intl.string(D.default.OlObRa),
                description: el ? F.intl.string(F.t["B4uSy/"]) : F.intl.string(D.default["8Gl8gP"]),
                descriptionCta: el ? F.intl.string(F.t.RzWDqY) : F.intl.string(D.default.HINTfJ),
                ...
                badgeText: el ? void 0 : F.intl.string(F.t.y2b7CA).toLocaleUpperCase(),
                badgeVariant: "expressive",
            ...
            orbRewards: {
                ...
                badgeText: el ? void 0 : F.intl.string(F.t.oW0eUd).toLocaleUpperCase(),
                badgeVariant: "expressive",
            },
            orbMultiplier: {
                name: "orbMultiplier",
                title: F.intl.string(F.t.F2MShO),
                description: F.intl.format(F.t["G5k+lZ"], { bonusOrbMultiplier: en }),
                descriptionCta: F.intl.string(F.t.jVcuVY),
            ...
            combinedOrbs: {
                ...
                description: F.intl.format(F.t.djzJx6, { bonusOrbMultiplier: en }),
        ...
        em = (function (e) {
            let t = (0, L.YS)({ location: "bento_box" }).functionalityEnabled,
                ...
                n = r && e;
            return [
                ...(t || a ? [ei.THREE_P_PROMOTIONS] : []),
                ...(n ? [ei.COMBINED_ORBS] : []),
                ...(!n && e ? [ei.ORB_MULTIPLIER] : []),
                ...(s ? [ei.PREMIUM_GROUP] : []),
                ...(!n && r ? [ei.ORB_REWARDS] : []),
                ei.DISPLAY_NAME_STYLES,
                ei.CUSTOM_THEMES,
                ei.SERVER_PROFILES,
                ei.REFERRAL_PROGRAM,
            ];
        ...
        ef = em.slice(+!e, e ? 2 : 3);
    return (
        null != eu && eb.push([ep(eu)]),
        1 === ef.length ? eb.push([ep(ef[0])]) : 2 === ef.length && eb.push([ep(ef[0]), ep(ef[1])]),
        {
            whatsNewBoxes: [...eb],
