...
function G(t, e, n) {
    ...
    if (e.hasFlag(D.xW$.SPAMMER) || n.isManaged()) return !1;
    let l = n.getGuildId();
    return !((null != l && o.Z.isLurking(l)) || (!i.ignoreSameUser && e.id === t.id) || I.Z.isBlockedOrIgnored(e.id) || (!i.ignoreStatus && v.Z.getStatus() === D.Skl.DND) || E.QZ.getSetting() || (!i.ignoreNoMessagesSetting && p.ZP.allowNoMessages(n)));
}
function L(t, e) {
    var n;
    let i = !(arguments.length > 2) || void 0 === arguments[2] || arguments[2],
        l = arguments.length > 3 && void 0 !== arguments[3] && arguments[3];
    if (null != t.flags && (0, A.yE)(t.flags, D.iLy.SUPPRESS_NOTIFICATIONS)) return !1;
    let a = S.Z.getChannel(e);
    t.type === D.uaV.THREAD_STARTER_MESSAGE && (a = S.Z.getChannel(null == a ? void 0 : a.parent_id));
    let o = m.default.getCurrentUser(),
        u = m.default.getUser(null === (n = t.author) || void 0 === n ? void 0 : n.id);
    if (
        null == a ||
        null == o ||
        null == u ||
        (a.type === D.d4z.GROUP_DM && t.type === D.uaV.RECIPIENT_REMOVE) ||
        !G(o, u, a, {
            ignoreStatus: l,
            ignoreSameUser: D.V$x.SELF_MENTIONABLE_SYSTEM.has(t.type)
        }) ||
        r.Z.isMessageRequest(e)
    )
        return !1;
    if (!i) {
    ...
    }
    {
        ...
        if (p.ZP.allowAllMessages(a) && e) return !0;
...
function M(t, e) {
    ...
    t.type === D.uaV.THREAD_STARTER_MESSAGE && (i = S.Z.getChannel(null == i ? void 0 : i.parent_id));
    let l = m.default.getCurrentUser(),
        a = m.default.getUser(null === (n = t.author) || void 0 === n ? void 0 : n.id);
    return !(null == i || null == l || null == a || i.isManaged() || a.hasFlag(D.xW$.SPAMMER) || I.Z.isBlockedOrIgnoredForMessage(t) || a.id === l.id || v.Z.getStatus() === D.Skl.DND || E.QZ.getSetting() || p.ZP.allowNoMessages(i));
}
function k(t, e) {
    ...
    return (
        !(
            ...
            p.ZP.isGuildOrCategoryOrChannelMuted(e.guild_id, e.id)
        ) &&
        (!!n || Z.Z.getChannelId(C.Z.getGuildId()) !== e.id) &&
        p.ZP.getNewForumThreadsCreated(e)
    );
}
let w = (t, e, n) =>
    ''
...
function V(t, e, n) {
    let o;
    let r = y.ZP.getName(t.getGuildId(), t.id, n),
        s = r;
    switch (t.type) {
        case D.d4z.GUILD_ANNOUNCEMENT:
        case D.d4z.GUILD_TEXT:
        ...
        case D.d4z.PRIVATE_THREAD:
            ...
            e.type === D.uaV.THREAD_STARTER_MESSAGE && null != f ? (s = w(s, f, S.Z.getChannel(f.parent_id))) : (0, c.Z)(e) ? null != T.Z.getGuild(t.getGuildId()) && (s = w(s, t, f)) : (s = w(s, t, f));
            break;
        case D.d4z.GROUP_DM:
            (t.isManaged() && n.bot && s === (0, i.F6)(t, m.default, I.Z)) || (s = ''.concat(s, ' (').concat((0, i.F6)(t, m.default, I.Z, !0), ')'));
    }
    let g = e.content;
    if ((0, c.Z)(e) && null == (g = U.Z.stringify(e, t))) throw (new l.Z('NotificationTextUtils').warn('SystemMessageUtils.stringify(...) could not convert', e), Error('failed to stringify system message'));
    ...
    } else o = 0 !== g.length && t.type === D.d4z.DM && !n.bot && g.startsWith('> -# *') ? (o = u.ZP.unparse(g, t.id, !0)).substring(0, 1) + o.substring(4) : u.ZP.unparse(g, t.id, !0);
    return (
        0 === o.length &&
            (o = (function (t) {
                var e;
                ...
                if ((0, A.yE)(null !== (e = t.flags) && void 0 !== e ? e : 0, D.iLy.IS_VOICE_MESSAGE)) return O.intl.string(O.t.slFYgo);
