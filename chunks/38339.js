...
function A(e, t, n) {
    ...
    return t.reference[s] > t.floating[s] && (a = N(a)), [a, N(a)];
}
function I(e) {
...
function V(e, t, n, i) {
    ...
    return v({ width: _, height: h, x: c, y: d });
}
function B(e, t) {
                                  ...
                                  for (; (0, P.vq)(a) && !(0, P.eu)(a); ) {
                                      ...
                                      n || "fixed" !== t.position || (r = null),
                                          (
                                              s
                                                  ? !n && !r
                                                  : (!n && "static" === t.position && !!r && H.has(r.position)) ||
                                                    ((0, P.ZU)(a) &&
                                                        !n &&
                                                        (function e(t, n) {
                                                            let i = (0, P.$4)(t);
...
function X(e, t, n, i) {
                      ...
                      return (
                          !(function u(c, d) {
                              ...
                              function A(t) {
                                  ...
                                  1 !== i || Z(_, e.getBoundingClientRect()) || u(), (g = !1);
                              }
                              try {
    ...
    return (
        _ &&
            (function t() {
                let i = V(e);
                g && !Z(g, i) && n(), (g = i), (r = requestAnimationFrame(t));
            })(),
        n(),
        () => {
            var e;
                    ...
                    let { rects: o, middlewareData: l, placement: u, platform: c, elements: d } = t,
                        ...
                        S =
                            void 0 !== E || m === r
                                ...
                                : m,
                        y = await b(t, T),
                        C = (null == (n = l.autoPlacement) ? void 0 : n.index) || 0,
                        N = S[C];
                    if (null == N) return {};
                    let v = A(N, o, await (null == c.isRTL ? void 0 : c.isRTL(d.floating)));
                    if (u !== N) return { reset: { placement: S[0] } };
                    let R = [y[h(N)], y[v[0]], y[v[1]]],
                        O = [
                            ...((null == (i = l.autoPlacement) ? void 0 : i.overflows) || []),
                            { placement: N, overflows: R },
                        ],
                        D = S[C + 1];
                    if (D) return { data: { index: C + 1, overflows: O }, reset: { placement: D } };
                    let L = O.map((e) => {
                            let t = f(e.placement);
                            return [
                                e.placement,
                        ...
                        w =
                            (null == (s = L.filter((e) => e[2].slice(0, f(e[0]) ? 2 : 3).every((e) => e <= 0))[0])
                                ? void 0
                                : s[0]) || L[0][0];
                    return w !== u ? { data: { index: C + 1, overflows: O }, reset: { placement: w } } : {};
                },
            }
        );
    },
            ...
            void 0 === e && (e = {}),
            {
                ...
                async fn(t) {
                    ...
                    let x = h(c),
                        k = g(E),
                        U = h(E) === E,
                        G = await (null == m.isRTL ? void 0 : m.isRTL(v.floating)),
                        F = D || (U || !M ? [N(E)] : ((o = N(E)), [I(E), o, I(o)])),
                        V = "none" !== w;
                    !D &&
                        V &&
                        F.push(
                    ...
                    if (((Y = [...Y, { placement: c, overflows: H }]), !H.every((e) => e <= 0))) {
            ...
            void 0 === e && (e = {}),
            {
                ...
                async fn(t) {
                    ...
                    let C = y - m.top - m.bottom,
                        ...
                        L = R;
                    if (
                        (null != (n = t.middlewareData.shift) && n.enabled.x && (L = N),
                        null != (i = t.middlewareData.shift) && i.enabled.y && (D = C),
                        O && !I)
                    ) {
                        let e = a(m.left, 0),
                            t = a(m.right, 0),
