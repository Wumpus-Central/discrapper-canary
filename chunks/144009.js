...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "619210", versionHash: "0578acac4237cae26f793714044e5de08112d0eb" }, void 0, 2)}
