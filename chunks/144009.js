...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "616734", versionHash: "27dda8896eef16ab7664a27375811a219b114743" }, void 0, 2)}
