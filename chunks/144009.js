...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "616808", versionHash: "784ad803ebc5e887c6a40f01a843f61493eff943" }, void 0, 2)}
