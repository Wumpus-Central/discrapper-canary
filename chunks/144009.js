...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "619088", versionHash: "5927942105340d59431ca4315c5ea6228cc33bbe" }, void 0, 2)}
