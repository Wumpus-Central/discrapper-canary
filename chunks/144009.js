...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "617134", versionHash: "cc3a250498fce081c70cb3fba91d73ebe2a1730f" }, void 0, 2)}
