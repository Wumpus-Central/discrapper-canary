...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "616334", versionHash: "a726f80734fca05c42ce588b352fdd3cc02d150b" }, void 0, 2)}
