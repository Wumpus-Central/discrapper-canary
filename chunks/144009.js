...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "621325", versionHash: "0629ed6c8cbf13848a57c3a9945a3916d260e954" }, void 0, 2)}
