...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "613691", versionHash: "e342a92a85b0942808e826fa4658e551c35d89e1" }, void 0, 2)}
