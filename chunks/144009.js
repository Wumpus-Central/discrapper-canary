...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "612988", versionHash: "809ec542914f1aeda050caecc5a1cdcd7a98a4fc" }, void 0, 2)}
