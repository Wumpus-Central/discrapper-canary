...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "615210", versionHash: "ba088ac472486cdc58a51478eba170ccadb9d9dc" }, void 0, 2)}
