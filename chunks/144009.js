...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "617440", versionHash: "c6b7bc7a9ffad8d744d8c62de776660da02294ea" }, void 0, 2)}
