...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "619993", versionHash: "2d78ece2d45ba80484f1361fff149a7e5557d5ad" }, void 0, 2)}
