...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "619744", versionHash: "92ccd420f9a69eb8bcfda42827fb2e552ce91ef6" }, void 0, 2)}
