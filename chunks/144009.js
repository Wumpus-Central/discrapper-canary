...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "618171", versionHash: "e3512076fbb6e6ba0e047e7a38ae87f237955c28" }, void 0, 2)}
