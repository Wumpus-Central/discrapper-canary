...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "615298", versionHash: "0420abc8f74641705ae6b439fd0893a4031a80bf" }, void 0, 2)}
