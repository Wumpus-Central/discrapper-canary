...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "622061", versionHash: "468cdc80b8bbc568b874a64c2ce3cecfc6347bda" }, void 0, 2)}
