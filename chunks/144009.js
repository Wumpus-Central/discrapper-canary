...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "621398", versionHash: "e7f13aec0527ba6d4d1e57a606e70997c3b6df7c" }, void 0, 2)}
