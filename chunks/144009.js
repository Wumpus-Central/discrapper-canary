...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "613500", versionHash: "b94db5ba9fda8e1f4b010662c090549e8f0a3ab1" }, void 0, 2)}
