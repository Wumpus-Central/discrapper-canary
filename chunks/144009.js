...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "612540", versionHash: "3d4083dc7f8cd4656e5df6e9b2db12997a73e0f4" }, void 0, 2)}
