...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "616241", versionHash: "e4ceffcfe15fbaccaac9627ee6fb845354a9876f" }, void 0, 2)}
