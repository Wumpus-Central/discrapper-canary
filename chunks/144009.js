...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "622081", versionHash: "71b038e81b3198d48b6e0fadfe1de27ea641cea4" }, void 0, 2)}
