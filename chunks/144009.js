...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "622091", versionHash: "b82b642a2905b1f717bcc6fed224bf928fc3b92a" }, void 0, 2)}
