...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "619487", versionHash: "f9164155822de870a6c8f06d594c10a7c29697c4" }, void 0, 2)}
