...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "613752", versionHash: "eaaec1f2ef852d4b4d7f321f393ea4bff10f3791" }, void 0, 2)}
