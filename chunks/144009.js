...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "614382", versionHash: "de1f6522eb45af3a1bcab397281ab07fad330193" }, void 0, 2)}
