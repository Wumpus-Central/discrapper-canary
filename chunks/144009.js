...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "612680", versionHash: "fcbb6b681193a430a7406c130fb11a0324e0f5e6" }, void 0, 2)}
