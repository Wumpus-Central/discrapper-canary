...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "620897", versionHash: "b9accf6f355cd07388eaae80939601cb12b80748" }, void 0, 2)}
