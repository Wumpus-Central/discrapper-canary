...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "615272", versionHash: "9cb981165bcc5e9196a68f58e33388d63ac240d7" }, void 0, 2)}
