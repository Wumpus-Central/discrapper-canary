...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "615664", versionHash: "72762a936874e3533f43c7baf6068588b861b29d" }, void 0, 2)}
