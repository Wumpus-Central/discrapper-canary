...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "619355", versionHash: "65f79ed044ee0b028e27ddcad2ed6e6846b62fdf" }, void 0, 2)}
