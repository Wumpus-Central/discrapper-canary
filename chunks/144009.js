...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "621372", versionHash: "457a2dd5cd809fee664affc47cf7ed7e1e0f5ade" }, void 0, 2)}
