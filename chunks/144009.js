...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "620168", versionHash: "15a2cbb46abbddfddceaa8d92f8a3477ffeb48ea" }, void 0, 2)}
