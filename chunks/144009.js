...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "618869", versionHash: "9347d31808a5cf45482e56e3557eb5ddd363c967" }, void 0, 2)}
