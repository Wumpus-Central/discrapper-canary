...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "619293", versionHash: "f1d2313b844c4be5dd798c21db618f580d5f2a4b" }, void 0, 2)}
