...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "621316", versionHash: "c543eea18a619db854d25f8b0def06d8d3d0679b" }, void 0, 2)}
