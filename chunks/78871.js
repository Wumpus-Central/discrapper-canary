...
function A(e) {
    ...
    return (0, i.jsxs)(f.er, {
        children: [
            ...
            (0, i.jsx)(E.z, { entry: { start: n, end: d, isCountDown: p }, textColor: "text-feedback-positive" }),
        ],
    });
}
function I(e) {
    ...
    let n = (0, p.gF)(t.state, t.party);
    return null == n ? null : (0, i.jsx)(f.fM, { Icon: c.n, text: n });
}
function T(e) {
    let { activity: t } = e,
        n = (0, p.kR)(t.assets?.large_text);
