...
function N(e) {
    ...
    return (0, n.jsxs)(p.er, {
        children: [
            (0, n.jsx)(N, { size: "xxs", color: o.A.colors.TEXT_FEEDBACK_POSITIVE }),
            (0, n.jsx)(v.z, { entry: { start: l, end: m, isCountDown: f }, textColor: "text-feedback-positive" }),
        ],
    });
}
function T(e) {
    ...
    return null == l ? null : (0, n.jsx)(p.fM, { Icon: c.n, text: l });
}
function E(e) {
    let { activity: t } = e,
        l = (0, f.kR)(t.assets?.large_text);
    return null == l ? null : (0, n.jsx)(p.fM, { Icon: m.K, text: l });
}
