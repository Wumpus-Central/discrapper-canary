...
function W(e) {
    ...
    return (0, l.jsx)(et, {
        ...
        asset:
            n.length > 1
                ? (0, l.jsx)(v.b, { className: r()(F.Sl, F.SV) })
...
function q(e) {
    ...
    return (0, l.jsx)(et, {
        ...
        title: k.intl.string(n === S.o.GAME_SERVER_HOSTING_AVAILABLE ? H.default.wXLChx : H.default["8z8RpY"]),
        body:
        ...
        actions: [
            {
                ...
                variant: "primary",
                onClick: () => {
                    n(w.i.TAKE_ACTION), (0, C.pX)(P.BVt.CHANNEL(t, V.VV.GAME_SERVERS));
                },
            },
        ],
        markAsDismissed: n,
