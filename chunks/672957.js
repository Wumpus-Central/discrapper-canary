...
function nm(e) {
    ...
    return (0, l.jsx)("div", {
        ...
        children: (0, l.jsx)(tn.$, {
            ...
            fullWidth: !0,
            onClick: function () {
                null != t && null != t.getGuildId() && ((0, t6.av)(t), (0, t8.uh)(t.getGuildId(), t.id));
            },
        }),
    });
}
              ...
              children: [
                  o.length > 0
                      ? (0, l.jsxs)("div", {
                            className: tZ()(nA.fI, nA.pF),
                            children: [
                                (0, l.jsx)(t2.Ay, { guildId: a, users: o, showUserPopout: !0, size: t2.DN.SIZE_16 }),
                                (0, l.jsx)(tt.E, {
                                    color: "none",
                                    variant: "text-xs/normal",
                                    className: nA.c8,
...
let n5 = new n2(_.h),
    ...
    n6 = n8.map((e) => e.store).filter(nn.Vq),
...
function it(e) {
    ...
    let i,
        ...
        M = r.useCallback(() => {
            var e;
            (e = Date.now()), w.w.set(n4, e), h(e), p(eg.i.UNKNOWN);
        }, [p]),
        f = (() => {
            switch (T) {
...
function iA(e) {
    ...
    eO && tu.push(u.M.STUDENT_HUB_PRIVACY_SETTINGS_TOOLTIP),
        ...
        !1 === e6 && tu.push(u.M.GUILD_POWERUP_PERKS_COACHMARK),
    ...
    let [tc, tA] = (0, en.kn)(tu, eg.m.GUILD_HEADER_TOOLTIPS),
        [tE, th] = (0, eb.vB)(tn && e7 && !1 === e6 && !(0, es.ai)(f), eg.m.GUILD_HEADER_TOOLTIPS),
        [tg, tI] = (0, en.D8)(
