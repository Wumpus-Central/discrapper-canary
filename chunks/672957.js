...
function it(e) {
    ...
    return null == f ? null : (0, l.jsx)("div", { onContextMenu: n4, children: f });
}
let ii = function (e) {
    let { guild: t } = e;
    switch (J(t)) {
...
function iA(e) {
    ...
    let [tc, tA] = (0, en.kn)(tu, eg.m.GUILD_HEADER_TOOLTIPS),
        [tE, th] = (0, eb.vB)(tn && e4 && !1 === e2 && !(0, es.ai)(f), eg.m.GUILD_HEADER_TOOLTIPS),
        [tg, tI] = (0, en.D8)(
