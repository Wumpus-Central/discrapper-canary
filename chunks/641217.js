...
let p = "NO_CHANNEL";
function f(e) {
    return { value: e.id, label: (0, c.m1)(e, h.default, x.A), channel: e, category: g.A.getChannel(e.parent_id) };
}
function j(e) {
    let { option: t } = e,
...
function N(e) {
    let { canManageGuild: t, guildId: n, afkChannelId: a, label: o } = e,
        c = (0, r.bG)([m.A], () => m.A.getCategories(n)),
        u = s.useMemo(() => {
    ...
    return (0, i.jsx)(b, { label: o, value: a ?? p, options: u, canManageGuild: t, onChange: g });
}
function E(e) {
    let { canManageGuild: t, guildId: n, systemChannelId: a, label: o, description: c, layout: u } = e,
        g = (0, r.bG)([m.A], () => m.A.getCategories(n)),
        x = s.useMemo(() => {
            let e = (0, d.A)(g._categories, g)
                .filter((e) => {
                    let { channel: t } = e;
