...
function B() {
    let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : { fetchPolicy: 'cache-only' },
        ...
        a = (0, u.Wu)([N.Z], () => [...N.Z.excludedQuests.values()]),
        { isFetchingCurrentQuests: o, lastFetchedCurrentQuests: s } = (0, u.cj)([N.Z], () => ({
    ...
    return (
        r.useEffect(() => {
            'cache-only' !== e.fetchPolicy && (('cache-and-network' !== e.fetchPolicy && ('cache-or-network' !== e.fetchPolicy || 0 !== s)) || !l || t || o || (n(!0), (0, A.xw)(), (0, A.w)(C.Ok.DESKTOP_ACCOUNT_PANEL_AREA)));
...
function eo(e, t, n, r) {
    ...
    if ((0, R.pO)(e) && (0, R.KM)(e)) return j.intl.format(j.t['1NaRSk'], { minutes: i });
    let s = j.t['6zWtV1'];
    return (
...
function eO(e) {
    ...
    let r = ei(e),
        ...
        f = l && !c && !o && u && (d || (_ && a === C.LI.DESKTOP)),
        p = (0, v.isWeb)() && f && !(0, R.Gd)(e),
...
function eA(e) {
    ...
    if (i)
        if (o === C.LI.SELECT) return j.intl.string(j.t.sWUpNz);
        else return _;
    if ((0, R.q8)(n)) return j.intl.string(j.t['o+e9ys']);
    if (f > 0)
