...
function eE(e, t, n, r) {
    ...
    if ((0, S.pO)(e) && (0, S.KM)(e)) return M.intl.format(M.t["1NaRSk"], { minutes: i });
    let s = M.t["6zWtV1"];
    return (
        (0, S.Nj)({ quest: e }) && (s = M.t["wmOh/v"]),
        M.intl.format(s, {
            minutes: i,
...
function ek(e) {
    ...
    if (i)
        if (o === N.LI.SELECT) return M.intl.string(M.t.sWUpNz);
        else return f;
    if ((0, S.q8)(n)) return M.intl.string(M.t["o+e9ys"]);
    if (_ > 0)
