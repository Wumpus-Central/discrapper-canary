...
function B() {
    ...
    return (
        r.useEffect(() => {
            'cache-only' !== e.fetchPolicy && (('cache-and-network' !== e.fetchPolicy && ('cache-or-network' !== e.fetchPolicy || 0 !== s)) || !l || t || o || (n(!0), (0, N.xw)(), (0, N.w)(R.Ok.DESKTOP_ACCOUNT_PANEL_AREA)));
...
function X(e) {
    return r.useMemo(() => ((0, A.q8)(e) || (0, A.pO)(e) || (0, A.Vl)(e) ? j.intl.string(j.t.hvVgAQ) : j.intl.string(j.t.lwQdjI)), [e]);
}
function Q(e) {
...
function eo(e, t, n, r) {
    ...
    if ((0, A.pO)(e) && (0, A.KM)(e)) return j.intl.format(j.t['1NaRSk'], { minutes: i });
    let s = j.t['6zWtV1'];
    return (
        (0, A.Nj)({ quest: e }) && (s = j.t['wmOh/v']),
        j.intl.format(s, {
            minutes: i,
...
let e_ = (e) => {
    ...
    ep = () => {
        let { xboxAccounts: e, playstationAccounts: t } = ed(),
            ...
            l = j.intl.format(j.t.HVS7np, { helpdeskArticle: r ? a : o });
        return {
            message: i ? l : s,
            xboxURL: o,
            playstationURL: a
...
function eg(e) {
    let t = (0, u.e7)([m.default], () => m.default.locale),
        ...
        a = 100 * i,
        o = null != r ? ''.concat(null == r ? void 0 : r.progress, '/').concat(null == r ? void 0 : r.target) : (0, O.T3)(t, i, { roundingMode: 'floor' });
    return {
        completedRatio: i,
        percentComplete: a,
...
function eE(e, t) {
    ...
    let i = er(e),
        ...
        l = Q(null == (r = e.userStatus) ? void 0 : r.claimedAt);
    return s ? j.intl.formatToPlainString(j.t.lOVr0N, { claimDate: l }) : null != a ? a.description : null != o ? o : null;
}
function eb(e) {
...
function ey(e, t) {
    let [n, i] = eb(e.id),
        ...
        f = u ? x.cd.DESKTOP : d ? x.cd.CONSOLE : null;
    return [
        r.useMemo(
            () =>
                (0, o.EQ)({
                    ...
                    .with({ currentProgressingPlatform: x.cd.CONSOLE }, () => R.LI.CONSOLE)
                    .with({ currentProgressingPlatform: x.cd.DESKTOP }, () => R.LI.DESKTOP)
                    .with(
                        {
...
function eO(e) {
    ...
    let r = ei(e),
        ...
        f = l && !c && !o && u && (d || (_ && a === R.LI.DESKTOP)),
        p = (0, v.isWeb)() && f && !(0, A.Gd)(e),
        h = (0, v.isMac)() && i.taskType === s.X.STREAM_ON_DESKTOP && f,
        m = [];
...
function eS(e) {
    ...
    return a === R.LI.SELECT ? j.intl.string(j.t.EMrUHR) : (0, A.$J)(e) ? j.intl.string(j.t.mOrpXF) : j.intl.string(j.t['7e5k7O']);
}
function eA(e) {
    var t;
    let { quest: n, isExpanded: i, sourceQuestContent: a, activeScreen: o } = e,
        s = Q(r.useMemo(() => L.r.build(n.config).rewardsExpireAt, [n.config])),
        l = er(n),
        c = ei(n),
        ...
        f = null != c ? c.percentComplete : l.percentComplete;
    if (u) return j.intl.formatToPlainString(j.t.APddvL, { expirationDate: s });
    if (i)
        if (o === R.LI.SELECT) return j.intl.string(j.t.sWUpNz);
        else return _;
    if ((0, A.q8)(n)) return j.intl.string(j.t['o+e9ys']);
    if (f > 0)
        if (!d) return j.intl.string(j.t.mOrpXF);
        else
            return (0, A.AV)({
                quest: n,
                taskDetails: l,
...
function eC(e) {
    ...
    let l = j.intl.formatToPlainString(j.t.o97tNj, { rewardName: t }),
        ...
        _ = j.intl.formatToPlainString(j.t.yCpc0d, {
            duration: n,
            rewardName: t
        }),
        f = s ? l : d,
...
function eR(e) {
    let t = (0, u.e7)([_.ZP], () => _.ZP.getCurrentEmbeddedActivity());
    return {
        launchInGameActivity: r.useCallback(() => {
            null != t && t.applicationId === e.config.application.id ? (0, f.Z)('guild_id' in t.location ? t.location.guild_id : null, t.location) : (0, h.uL)(M.Z5c.ACTIVITY_DETAILS(e.config.application.id));
