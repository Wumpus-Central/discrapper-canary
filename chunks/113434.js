...
function Q(e) {
    return r.useMemo(() => ((0, P.q8)(e) || (0, P.pO)(e) || (0, P.Vl)(e) ? j.intl.string(j.t.hvVgAQ) : j.intl.string(j.t.lwQdjI)), [e]);
}
function X(e) {
...
function eA(e, t, n) {
    var i;
    let a = X(r.useMemo(() => L.r.build(e.config).rewardsExpireAt, [e.config])),
        o = er(e),
        s = ei(e),
