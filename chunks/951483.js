...
let A = {
        ...
        [p.EkH.TOGGLE_MUTE]: T.iN,
        [p.EkH.TOGGLE_DEAFEN]: T.oV,
        [p.EkH.TOGGLE_CATEGORY_COLLAPSED]: C.u,
        [p.EkH.SCROLL_UP]: d.B2,
        [p.EkH.SCROLL_DOWN]: d.gN,
        [p.EkH.SEARCH_EMOJIS]: E.S,
        [p.EkH.TOGGLE_HOTKEYS]: N._,
        [p.EkH.JUMP_TO_FIRST_UNREAD]: o.O,
        [p.EkH.RETURN_TO_AUDIO_CHANNEL]: u.F,
