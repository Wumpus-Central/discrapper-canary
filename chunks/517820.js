...
function B(e) {
    var t;
    let { message: n, compact: a } = e,
        { joinAttempts: r, raidDatetime: s, dmsSent: d, raidType: p, resolvedReason: g } = (0, E.FL)(n),
...
function G(e) {
    ...
    let { message: n, compact: a } = e,
        ...
        { raidDatetime: s, decisionId: c, suspiciousMentionActivityUntil: d } = (0, E.FL)(n);
    return (0, i.jsx)(H, {
        compact: a,
        header: (0, i.jsxs)(l.Fragment, {
            children: [
