"use strict";
let r, i, a, s, o, l, u, c, d, _, f, p, h, m, g, E, A, I, T, S, y, v, C, N, b, R, O, D, L;
n.d(t, { A: () => e5 });
var w = n(735438),
    x = n(412703),
    M = n(440703),
    ...
    for (let e of t)
        c.set(e.id, e),
            ...
            e.targetedContent.includes(F.uF.QUEST_BAR) &&
                (0, j.L)({ location: W.rE.QUESTS_STORE }).log(`Delivered ${e.config.messages.questName} (${e.id})`);
    for (let e of ((d = new Map()), n)) d.set(e.id, e);
    for (let e of L?.values()) c.has(e.id) || (c.set(e.id, e), u.set(e.id, e.config), a.set(e.id, (0, H.Ic)(e)));
...
function eK(e) {
    let { placement: t } = e;
    N.delete(t), (p = Date.now()), (i = !1), (a = new Map(a)).set(t, !1);
}
function ez(e) {
    let { content: t } = e;
...
function eZ() {
    eX();
    let e = (0, H.v1)(Array.from(c.values()));
    if (null == e) return;
...
let e4 = new e6(k.h, {
        ...
        QUESTS_FETCH_QUEST_HOME_TAKEOVER_BEGIN: e1,
        QUESTS_FETCH_QUEST_HOME_TAKEOVER_SUCCESS: e2,
        QUESTS_FETCH_QUEST_HOME_TAKEOVER_FAILURE: e3,
    }),
    e5 = e4;
