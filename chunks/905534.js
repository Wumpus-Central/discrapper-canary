    ...
    [o.Etm.SUBSCRIBE]: {
        async handler(e) {
            ...
            if (!(0, l.Z)(n.authorization.scopes, u.scope))
                throw new i.Z({ errorCode: o.lTL.INVALID_PERMISSIONS }, "Not authenticated or invalid scope");
            if (
                ...
                if (null != e.validate(c, u.validation(e), { convert: !1 }).error)
                    throw new i.Z({ errorCode: o.lTL.INVALID_PAYLOAD }, "Invalid subscription parameters provided");
            }
            let d = u.handler({
                    args: c,
                    socket: n,
            ...
            return new Promise((e) => {
                setImmediate(() => {
                    t.addSubscription(n, s, c, d),
                        null != p && t.dispatchToSubscriptions(s, (e) => e.socket.id === n.id, p);
                }),
                    e({ evt: s });
            });
        },
