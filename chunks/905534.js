    ...
    [s.Etm.SUBSCRIBE]: {
        async handler(e) {
            let { server: t, socket: n, evt: o, args: c } = e,
                d = t.events[o];
            if (null == d) throw new l.Z({ errorCode: s.lTL.INVALID_EVENT }, 'Invalid event: '.concat(o));
            if (!(0, r.Z)(n.authorization.scopes, d.scope)) throw new l.Z({ errorCode: s.lTL.INVALID_PERMISSIONS }, 'Not authenticated or invalid scope');
            if (
                ...
                if (null != e.validate(c, d.validation(e), { convert: !1 }).error) throw new l.Z({ errorCode: s.lTL.INVALID_PAYLOAD }, 'Invalid subscription parameters provided');
            }
            let u = d.handler({
                    args: c,
                    socket: n
