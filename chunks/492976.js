...
function ej(e) {
    ...
    return (0, o.jsxs)("div", {
        className: eh.EF,
        ref: l,
        children: [(0, o.jsx)(eu.A, { category: t, onSelect: a ? d : void 0 }), (0, o.jsx)(eb, { category: t })],
    });
}
function ev(e) {
...
let ek = function () {
    let { sort: e, onSetSort: t, hasRelevanceFilters: n } = (0, R.v)(),
        ...
        i = n(),
        a = c.useMemo(() => eS.QB.filter((e) => e.sortType !== eI.$.RELEVANCE || i), [i]),
        r = c.useCallback((e) => {
        ...
        d = c.useCallback(
            (e) =>
                ({
                    recent: { sortType: eI.$.RECENCY, sortDirection: eA.A.DESC },
                    "price-asc": { sortType: eI.$.PRICE, sortDirection: eA.A.ASC },
                    "price-desc": { sortType: eI.$.PRICE, sortDirection: eA.A.DESC },
                    popularity: { sortType: eI.$.POPULARITY, sortDirection: eA.A.DESC },
                    relevance: { sortType: eI.$.RELEVANCE, sortDirection: eA.A.DESC },
                })[e],
            [],
        ),
        g = c.useCallback(
...
function e3() {
    let {
        ...
        E = c.useRef(null),
        x = (0, eQ.A)(Z.FYj),
        f = c.useMemo(() => eS._6.filter((e) => m || e !== en.q.PROFILE_FRAME), [m]),
        p = c.useCallback(
            (e) => {
                q.default.track(Z.HAw.COLLECTIBLES_SHOP_ELEMENT_CLICKED, {
...
function ta(e) {
    ...
    let b = c.useRef(null),
        ...
        k = t || x || null == d;
    c.useEffect(() => {
        k ? T(!1) : S.length > 0 && T(!0);
    }, [k, S.length]);
    let y = N > 0 && !k && 0 === S.length;
    c.useEffect(() => {
        let e = new ResizeObserver(() => {
            null == b.current || j(Math.floor(5 * getComputedStyle(b.current).gridTemplateColumns.split(/\s+/).length));
        });
...
function to(e) {
    ...
    let r = c.useRef(null),
        ...
        u = (0, D.U)("Shop Browse"),
        { setCategoryRef: g, handleScrollToCategory: m } = (0, eL.k0)(r.current),
        [h, E] = c.useState(l),
        [x, f] = c.useState(!1);
    return (
        c.useEffect(() => {
...
function tI(e) {
    let { endDate: t, size: n = "md", className: s, showSeconds: l = !1 } = e,
        { days: i, hours: a, minutes: r, seconds: c } = (0, tL.A)(t),
...
let tO = c.memo(function (e) {
    ...
    return (0, o.jsxs)(t_.animated.div, {
        ...
        children: [
            (0, o.jsxs)(tb.s, {
                direction: tb.s.Direction.VERTICAL,
                children: [
                    (0, o.jsx)(Y.E, {
...
let tJ = function (e) {
    ...
    tQ = function (e) {
        let {
            ...
            b = (0, P.bG)([B.Ay], () => B.Ay.useReducedMotion),
                  ...
                  children: (0, o.jsxs)("div", {
                      ...
                      children: [
                          (0, o.jsxs)("div", {
                              className: tM.$6,
                              children: [
                                  (0, o.jsx)(tJ, { label: n, personalizedResults: S }),
                                  (0, o.jsxs)("div", {
...
function nn(e) {
    let { gameServerHostingBannerBlock: t, tab: n } = e,
        ...
        m = c.useCallback(() => {
            g("go_to_game_server_hosting"), (0, t6.pX)(Z.BVt.COLLECTIBLES_SHOP_WITH_TAB(eS.G2.GAME_SERVERS));
        }, [g]),
        h = c.useCallback(() => {
            g("dismiss"),
                d(!0),
...
let nb = c.memo(function (e) {
        ...
        return (0, o.jsx)(t4.L, {
            ...
            children: (0, o.jsx)("div", {
                ref: l,
                className: u()(n_.ty, nS.Q3, { [n_.yo]: i }),
                          ...
                          x &&
                              ...
                              (0, o.jsx)(
                                  L.R9,
                                  {
                                      ...
                                      children: (0, o.jsx)(nb, { category: d, rewardSkuId: i.rewardSkuId }),
                                  },
                                  i.rewardSkuId,
                              ),
                          g.map((e, t) => {
...
let nI = function (e) {
    let { shelf: t, handleTransition: n, tab: s } = e,
        l = (0, P.bG)([v.default], () => v.default.getCurrentUser()),
        i = (0, tt.Mk)(s),
        a = (0, P.bG)([A.A], () => (null != t.categorySkuId ? A.A.getCategory(t.categorySkuId) : void 0)),
        r = (0, tW.A)(),
    ...
    return (0, o.jsx)(p.f5, {
        value: m,
        children: (0, o.jsxs)("div", {
            className: u()(nA.mu, tM.YB, C ? nA.VA : nA.Ti),
            children: [
                C && (0, o.jsx)("img", { className: nA.iL, src: f, alt: "", "aria-hidden": !0 }),
                (0, o.jsxs)("div", {
                    className: nA.Qs,
                    children: [
                        (0, o.jsxs)("div", {
            ...
            : E || 0 === f.length
              ? (0, o.jsxs)("div", {
                    ...
                    children: [
                        ...
                        (0, o.jsx)(tQ, {
                            isLoading: E,
                            title: l === eS.G2.ORBS ? el.intl.string(el.t.dFgeuZ) : el.intl.string(el.t.NSv5KV),
                            numVisibleItems: n,
                            tab: l,
                        }),
                    ],
                        ...
                        (function (e, i, a) {
                            ...
                            switch (e.type) {
                                ...
                                case tu.g.REWARD_HERO:
                                    c = (0, o.jsx)(nL, { isLoading: E, handleTransition: t, heroBlock: e, tab: l }, a);
                                    break;
            ...
            (0, o.jsx)(z.Ch, {
                ...
                children: (0, o.jsxs)("div", {
                    ...
                    children: [
                        ...
                        (0, o.jsx)(nU, { peaking: g, transitioning: s === eS.Pf.OUT }),
                    ],
                }),
            })
        );
...
function n1(e) {
    let { tab: t } = e,
        ...
        a = (0, P.bG)([A.A], () => A.A.skipNumCategories),
        r = c.useMemo(() => {
            let e = {};
        ...
        (0, o.jsx)(z.Ch, {
            ...
            children: (0, o.jsxs)("div", {
                ...
                children: [
                    ...
                    (0, o.jsx)(nU, { peaking: m, transitioning: s === eS.Pf.OUT }),
                ],
            }),
        })
    );
...
function n6(e) {
    ...
    let d = (0, H.H)({ location: "collectibles_content" }),
        ...
        S = (0, D.U)("CollectiblesContent"),
        b = (0, G.a)("CollectiblesContent"),
        j = c.useCallback(
            (e) => {
                let {
                    sourceButton: t,
        ...
        : null != r
          ...
          : t === eS.G2.HOME && S
            ...
            : t === eS.G2.ORBS && S
              ...
              : n9.includes(t)
                ? (0, o.jsx)(nW, { handleTransition: j, tab: t, transitionState: l })
...
let ss = function (e) {
    ...
    let i = (0, eO.yB)("CollectiblesShop"),
        ...
        M = c.useMemo(() => (n === eS.G2.HOME && null != r && d() ? r : n), [n, r, d]);
    ...
    let z = c.useCallback((e, t) => {
        ...
        { selectedTab: V, transitionState: Y, transitionToTab: W } = (0, k.o)(M);
    (0, C.HU)({ location: el.intl.string(el.t.pWG4ze) }), (0, O.uS)(s, V, w, Y, G), (0, O.N0)(V, l);
    let { dismissShopButtonDC: K } = (0, se.A)();
    c.useEffect(() => {
        K();
    }, [K]),
        c.useEffect(() => {
