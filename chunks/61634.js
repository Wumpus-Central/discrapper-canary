...
function S(e) {
            ...
            return {
                ...
                guildHasVideo: (() => {
                    ...
                    for (let t of l) {
                        ...
                        if (
                            E(
                                g.Z.getBasicChannel(null == (e = o[t]) ? void 0 : e.channelId),
                                null != i ? i : void 0,
                                b.Z,
                            )
                        )
    ...
    return (0, i.cj)([_.Z, g.Z, o.ZP, d.Z, p.Z, b.Z], () => {
        ...
        return (
            f
                ? ((m = !0), (O = (null == r ? void 0 : r.channel_id) === c), (y = T), (C = D), (E = A), (S = M))
                : ((m = I), (O = null != r), (y = Z), (C = P), (E = R), (S = L)),
            {
                audio: m,
                video: C,
                screenshare: E,
