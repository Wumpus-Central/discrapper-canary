...
function P(e) {
        ...
        N = (0, l.NX)(I),
        {
            ...
            () => {
                ...
                return {
                    guildHasVoice: (() => {
                        if (n) return !1;
                        for (let e in o) if (S(m.Z.getBasicChannel(o[e].channelId), null != i ? i : void 0, _.Z)) return !0;
                        return !1;
                    })(),
                    guildHasVideo: (() => {
                        if (n) return !1;
                        for (let t of l) {
                            var e;
                            if (S(m.Z.getBasicChannel(null == (e = o[t]) ? void 0 : e.channelId), null != i ? i : void 0, _.Z)) return !0;
                        }
                        return !1;
                    })(),
    ...
    return (0, i.cj)(
        ...
        () => {
            ...
            return (
                u ? ((g = !0), (b = (null == r ? void 0 : r.channel_id) === c), (y = A), (O = L), (j = D), (S = M)) : ((g = Z), (b = null != r), (y = I), (O = E), (j = R), (S = k)),
                {
                    audio: g,
                    video: O,
                    screenshare: j,
