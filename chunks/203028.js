...
function _(e) {
    ...
    let { party: _, onUserContextMenu: E } = e,
        { priorityMembers: O, guildContext: I } = _,
        y = O[0],
        v = (function (e) {
            ...
            if (_ + E === 1 && null != O) {
                ...
                switch (I.type) {
                    ...
                    case m.IIU.LISTENING:
                        let i;
                        return (
                            (i = (0, o.Z)(I) ? (0, r.jsx)(f.Z.Header.Icon, { src: f.Z.Header.Icon.Src.SPOTIFY }) : null != e.getIconURL(g.Z) ? (0, r.jsx)(f.Z.Header.Icon, { src: e.getIconURL(g.Z) }) : (0, r.jsx)(f.Z.Header.Icon, { src: n(211827) })),
                            {
                                subtitle: b.intl.formatToPlainString(b.t.NF5xoq, { name: I.name }),
                                icon: i
                            }
                        );
                    case m.IIU.WATCHING:
                        return {
                            subtitle: b.intl.formatToPlainString(b.t.pW3Ip6, { name: I.name }),
                            icon: null != e && null != e.getIconURL(g.Z) ? (0, r.jsx)(f.Z.Header.Icon, { src: e.getIconURL(g.Z) }) : null
                        };
                    default:
                        return {
