...
class b extends s.Z {
    _initialize() {
        a.Z.subscribe('CONNECTION_OPEN', O);
    }
    _terminate() {
        a.Z.unsubscribe('CONNECTION_OPEN', O);
    }
    constructor(...e) {
        super(...e),
            m(this, 'actions', {
...
function y(e) {
    ...
    E.fileOnly('received deleted guild entities (id: '.concat(e.guild_id, ', name: ').concat(n, ')')),
        o.ZP.Emitter.batched(() => {
            null != e.channels && A(e.guild_id, new Set(e.channels)), null != e.roles && N(e.guild_id, new Set(e.roles)), null != e.emojis && C(e.guild_id, new Set(e.emojis)), null != e.stickers && P(e.guild_id, new Set(e.stickers));
        });
}
function O() {
    l.Z.getAll().then((e) => {
