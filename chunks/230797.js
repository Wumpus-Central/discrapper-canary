(n.d(t, { iV: () => d8, OC: () => ce, Ay: () => d4 }), n(938796));
var i,
    l,
    s = n(477900),
    a = n(582128),
...
function er(e) {
    ...
    return (0, s.jsxs)(s.Fragment, {
        children: [
            ...
            (0, s.jsx)(A.E, { variant: "text-xs/normal", className: el.dS, color: "none", lineClamp: 1, children: d }),
        ],
    });
}
var eo = n(582388),
                                ...
                                children: [
                                    (0, s.jsx)("li", {
                                        children: (0, s.jsx)(A.E, {
                                            variant: "text-sm/normal",
                                            color: "text-muted",
                                            children: X.intl.format(X.t.tKZNlb, { listingCount: d.length }),
                                        }),
                                    }),
                                    null != m &&
                                        (0, s.jsx)("li", {
...
function lF(e) {
    let { embedUrl: t, message: n, channel: i } = e,
        ...
        I = (0, i1.bG)([lk.Ay, w.default], () => lk.Ay.isMember(d?.guildId, w.default.getCurrentUser()?.id), [d]),
        C = (0, i1.bG)([lk.Ay], () => (d?.authorId != null ? lk.Ay.getMember(d.guildId, d.authorId) : null)),
                ...
                children: [
                    ...
                    (0, s.jsxs)("div", {
                        ...
                        children: [
                            ...
                            d.canAccess
                                ? (0, s.jsx)(ex.$, { variant: "primary", onClick: k, text: d.ctaText })
                                : (0, s.jsx)(ex.$, { onClick: k, variant: "primary", text: d.ctaText }),
                        ],
                    }),
                ],
            }),
...
let at = function (e) {
    ...
    return null != a && (0, lz.FD)(a)
        ...
        : null != a && (0, lz.Xw)(a)
          ? (0, s.jsx)(s4, { sticker: a, channel: n, closePopout: i, refreshPositionKey: l })
          : r
...
function aE(e) {
    ...
    return (0, s.jsxs)("div", {
        className: l4.up,
        children: [
            (0, s.jsx)("img", { alt: "", src: t.author.getAvatarURL(n.guild_id, 16), className: l4.FJ }),
            (0, s.jsx)(ax.A, { message: t, channel: n, compact: !0 }),
            (0, s.jsx)("div", {
                className: l4.Au,
                children: d
                    ? (0, s.jsx)("span", { className: l4.dp, children: X.intl.string(X.t["5uaI/7"]) })
                    : (function (e, t, n, i) {
                          let {
                              ...
                              leadingIcon: r,
                              trailingIcon: o,
                          } = (0, aA.o)(e, t, n, i, l4.tP, {
                              trailingIconClass: l4._v,
                              leadingIconClass: l4.a5,
                              iconSize: af.eJ,
                          });
                          return (0, s.jsxs)(s.Fragment, {
                              children: [r, a ?? (0, s.jsx)("span", { className: l4.dp, children: l }), o],
                          });
                      })(t, o, i, l),
            }),
        ],
                          ...
                          children: [
                              (0, s.jsxs)(ay.B, {
                                  ...
                                  children: [
                                      ...
                                      (0, s.jsx)(A.E, {
                                          variant: "text-sm/medium",
                                          children: X.intl.format(o ? X.t["8F+WNz"] : X.t["/cZp5s"], { username: d }),
                                      }),
                                  ],
                              }),
                              (0, s.jsxs)(ay.B, {
...
class os extends a.Component {
    ...
    render() {
        ...
        return null == n || i
            ? (0, s.jsx)(r8.A.div, { className: o()(ol.gn, e), style: this.getImageStyle(), children: t })
            : (0, s.jsxs)(r8.A.div, {
    ...
    renderTypeImage() {
        ...
        return null == t
            ...
            : (0, s.jsx)(on.A, {
                  ...
                  className: ol.mZ,
                  disable: !e,
                  children: (0, s.jsx)(r4.F, { children: this.renderSlideItem(t) }),
              });
    }
    render() {
...
function oV(e) {
    ...
    let g = a.useCallback(() => {
        ...
        _ = (0, u.yK)(
            ...
            () =>
                null != d
                    ? em.Ay.getEmbeddedActivitiesForChannelIncludingHidden(d.id)
        ...
        N = a.useMemo(
            () =>
                g && d.current?.clientHeight != null
                    ? {
                          height: m ? 292 : d.current.clientHeight + 36 + 48,
    ...
    let j = (0, s.jsxs)(s.Fragment, {
        children: [
            (0, s.jsxs)("div", {
                ...
                ref: d,
                children: [
                    (0, s.jsx)(o8.J$, { profile: C, className: de.vK }),
...
function dM(e) {
    let { guildId: t, channelId: n, users: i, onHoverOrFocus: l, ...r } = e,
        o = a.useCallback((e) => (0, s.jsx)(dk, { users: e, guildId: t, channelId: n, onHoverOrFocus: l }), [t, n, l]);
