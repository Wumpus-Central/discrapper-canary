...
let P = (e) => {
        var { openInLayer: t = !0, tab: r } = e,
            i = N(e, ["openInLayer", "tab"]);
        {
            let { default: e } = n(342386);
            w(i),
                (0, f.yP)("closeUserSettings") && e(),
                t
                    ? (0, l.jN)(S.S9g.COLLECTIBLES_SHOP)
                    : (0, d.uL)(r ? S.Z5c.COLLECTIBLES_SHOP_WITH_TAB(r) : S.Z5c.COLLECTIBLES_SHOP);
        }
    },
    w = (e) => {
    ...
    j = (e, t) =>
        ...
        L(null == e ? void 0 : e.includePopularPicks, null == t ? void 0 : t.includePopularPicks) &&
    ...
    Z = async (e) => {
        ...
        try {
            ...
            (0, T.G)(new c.Hx(e)), s.Z.dispatch({ type: "COLLECTIBLES_MARKETING_FETCH_FAILURE" });
        }
    },
    F = async (e, t, n) => {
        s.Z.dispatch({
