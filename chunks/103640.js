        ...
        return o <= 0
            ...
            : Math.min(
                  ...
                  i.reduce((e, t, n) => {
                      if (o > t) {
                          let e = s[n];
                          return n + 1 === i.length ? s[n] : ((o - t) / (i[n + 1] - t)) * (s[n + 1] - e) + e;
                      }
                      return o === t ? s[n] : e;
                  }, 0),
              );
...
let l = (e) =>
    1 === e
        ...
        : 2 === e || 3 === e
          ...
          : 4 === e || 5 === e
            ? { color: (0, r.dE)("YELLOW_300"), square: !0 }
            : 6 === e
              ? { color: (0, r.dE)("RED_400"), square: !0 }
              : { color: (0, r.dE)("ORANGE_345"), flair: !0 };
function u(e) {
