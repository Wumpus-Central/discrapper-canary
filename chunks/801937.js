...
class M extends i.PureComponent {
    ...
    considerPaymentRequestWalletsLoaded() {
        ...
        let n = t.reduce((e, t) => S(I({}, e), { [''.concat(t, 'Loaded')]: !0 }), {});
        this.setState(n);
    }
    ...
    render() {
        ...
        let { showAllPaymentMethods: t } = this.state,
            ...
            g = [],
            E = [],
            v = void 0 === s || this.arePaymentRequestWalletsLoading();
        ...
        let T = (0, r.jsxs)('div', {
            children: [
                ...
                t &&
                    (0, r.jsx)('div', {
                        className: o()(O.wrap, O.horizontal, y.allPaymentsSection, y.container, { [O.flex]: t }),
                        children: E
                    })
            ]
        });
