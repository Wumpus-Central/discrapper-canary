...
function en(e) {
    var { isActive: t, disabled: n, iconComponent: r, iconColor: o, tooltip: l, defaultColor: a = 'primaryDark', highlightedColor: s = 'primaryDark', caretColor: c, popoutOpen: u, onClick: d, popoutDisabled: p, onPopoutClick: h, onMouseEnter: f, onMouseLeave: m, onContextMenu: g, fullRegionButton: v } = e,
        y = (function (e, t) {
            if (null == e) return {};
            var n,
                i,
...
function ea(e) {
    ...
    let {
            Component: y,
            events: { onClick: O, onMouseEnter: b, onMouseLeave: _ }
        } = (0, u.j)(),
        E = et(l),
