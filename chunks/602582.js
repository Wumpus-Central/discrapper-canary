...
var c = n(961350),
    ...
    I = n(937136),
    E = n(652215);
let A = new o.A("MessagePreviewManager");
class f extends a.A {
    remote = new Map();
    remoteTicking = !1;
    tickQueued = !1;
            ...
            return async function () {
                ...
                if (!e.remoteTicking && !(t > 5)) {
                    ...
                    try {
                        ...
                        A.log(`couldn't fetch message previews (attempt: ${t}, error: ${n})`),
                            (e.remoteTicking = !1),
                            e.remoteTick(t + 1);
                    }
                }
    ...
    fetchGuilds(e, t) {
        ...
        return 0 === n.length
            ...
            : t.try(
                  n,
                  () => (
                      A.verbose(`fetching guild previews (via: gateway, guild_id: ${e}, channel_ids: ${n.join(", ")})`),
    ...
    fetchDms(e) {
        ...
        return 0 === t.length
            ...
            : e.try(t, async () => {
                  ...
                  let e = (
                      await s.Bo.post({ url: E.Rsh.MESSAGE_PREVIEWS, body: { channel_ids: t }, rejectWithError: !1 })
                  ).body;
                  r.h.dispatch({ type: "MESSAGE_PREVIEWS_LOADED", guildId: null, messages: e });
              });
    }
    syncChannel(e, t) {
