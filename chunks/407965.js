...
let b = (e) => {
    ...
    y = () => {
        ...
        return (
            ...
            I.push({
                text: v ? g.intl.string(g.t.PfnxqK) : g.intl.string(g.t["3PatS0"]),
                onClick: () => a(h.R.CONFIRM),
                variant: "primary",
            }),
            (0, r.jsx)(l.Modal, {
                transitionState: e,
                title: g.intl.string(g.t.PWq8TE),
                subtitle: g.intl.formatToPlainString(g.t.nsGVzs, {}),
                actions: I,
