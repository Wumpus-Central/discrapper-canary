...
class d {
    ...
    checkForLeaks(e, t) {
        var n, r, i, o;
        let s =
            (null != (i = null == (n = this._subscriptions[e]) ? void 0 : n[t]) ? i : 0) -
            (null != (o = null == (r = this._unsubscriptions[e]) ? void 0 : r[t]) ? o : 0);
        s > 5 &&
            new a.Z("GuildMemberSubscriptions").warn(
                "GuildMemberSubscriptions.subscribe(...): Potential reference leak! (".concat(s, " subscriptions)"),
            );
    }
    ...
    constructor(e) {
        c(this, "_subscriptions", {}),
            ...
            c(this, "_unsubscribe", new o.sW(u, () => this.flushUnsubscriptions())),
            (this._onChange = e);
    }
}
