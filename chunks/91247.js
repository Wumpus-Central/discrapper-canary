...
function y(e) {
    var t, n;
    let r = Date.now(),
        { guilds: i, merged_presences: o, merged_members: a, read_state: s, private_channels: l, user_guild_settings: c, user_settings: u, user_settings_proto: d, experiments: p, guild_experiments: _, relationships: h, users: m } = e,
