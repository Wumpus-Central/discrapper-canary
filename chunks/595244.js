...
function w(e) {
    let { guild: t, application: n, ...s } = e,
        ...
        _ = r.useCallback(() => {
            n?.id != null &&
                ...
                null != l && (0, m.pX)(""),
                setImmediate(() => {
                    N._.dispatchToLastSubscribed(R.jej.OPEN_APP_LAUNCHER, { applicationId: n.id }),
    ...
    return (
        (null != t || null != a) &&
            (null != a && v.push({ variant: "secondary", text: O.intl.string(O.t.cpT0Cq), onClick: u }),
            p &&
                v.push({
                    variant: "primary",
                    text:
            ...
            y && v.push({ variant: "primary", text: O.intl.string(O.t["0cCDKP"]), onClick: _ })),
        (0, i.jsx)(C.f, { ...s, actions: v, children: (0, i.jsx)(M, { guild: t, application: n, ...s }) })
    );
}
function M(e) {
    let { guild: t, application: n, ...s } = e,
