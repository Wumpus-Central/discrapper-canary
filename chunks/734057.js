    ...
    static loadGuildIds(e) {
        ...
        return (0, d.ES)("loadChannels", async () => {
            let e = t
                    .map((e) => {
                        ...
                        let t = c.A.getAsync(n, e).then(
                            (t) => (
                                N.fileOnly(`Lazy loaded channels for ${e} #:${t.length}`),
                                { guildId: e, channels: t }
                            ),
                        );
            ...
            try {
                ...
                if (x !== i)
                    return (
                        N.fileOnly("lastResetTime has changed, skipping loads for " + e.map((e) => e.guildId)), null
                    );
...
function en(e) {
    let { messages: t } = e;
    for (let e of t) null != e.thread && !(e.thread.id in D) && I.A_.has(e.thread.type) && X((0, I.UE)(e.thread));
}
function ei(e) {
    let { data: t } = e;
    t.forEach((e) => {
...
function er(e) {
    null != e && !(e.id in D) && I.A_.has(e.type) && X((0, I.UE)(e));
}
function ea() {
