...
function c(e, t, n, i) {
    ...
    if (Array.isArray(e) && Array.isArray(t)) {
        ...
        for (let r = 0; r < e.length; r++) if (!c(e[r], t[r], n, !1)) return !1;
        return !0;
    }
    ...
    for (let r of a) if (!Object.prototype.hasOwnProperty.call(t, r) || !c(e[r], t[r], n, !1)) return !1;
    return !0;
}
function d(e, t) {
    return c(e, t, new Map(), !0);
}
function _(e, t, n) {
    let r = [];
    n((e, t) => {
...
function p(e, t, n) {
    ...
    for (let e in t)
        if (Object.prototype.hasOwnProperty.call(t, e)) {
            ...
            let a = n[e];
            d(i, a) || r.push({ type: "value-mismatch", field: e, primaryValue: i, shadowValue: a });
        }
    ...
    function r(e, t) {
        if (!d(e, t)) {
            ...
            if (Array.isArray(e) && Array.isArray(t)) {
                ...
                for (let i = 0; i < n; i++)
                    d(e[i], t[i]) || (console.group(`Array index ${i} mismatch:`), r(e[i], t[i]), console.groupEnd());
                e.length > t.length
            ...
            if (h(e) && h(t)) {
                ...
                for (let a of Array.from(new Set([...n, ...i])).sort())
                    n.has(a)
                        ? i.has(a)
                            ? d(e[a], t[a]) ||
                              (console.group(`Field ${a} mismatch:`), r(e[a], t[a]), console.groupEnd())
                            : console.info(`Missing field in shadow: ${a} = `, e[a])
                        : console.info(`Extra field in shadow: ${a} = `, t[a]);
                return;
            }
...
function g(e, t, n) {
    ...
    n.forEach((e) => {
        ...
        a.length > 0 && console.info(`Extra records in shadow state: ${a.join(", ")}`),
        console.groupEnd();
}
let E = new Map();
function A(e, t) {
    ...
    if ((E.set(e, r), r.mismatchesReported >= l)) return;
    let a = r.mismatchesByLastAction.get(n) ?? 0;
    if (a >= u) return;
    let c = T(r, t);
    null != c &&
        (r.mismatchesByLastAction.set(n, a + 1),
        r.mismatchesReported++,
        s.default.track(o.HAw.LIBDISCORE_KV_DUAL_READ_ERROR, {
            store_name: e,
            action_type: n,
                    ...
                    switch (t.type) {
                        case "field-missing":
                            n.mismatchedFields.push({
                                fieldName: e,
                                primaryType: I(a.primaryRecord[t.field]),
                                shadowType: "missing",
                            });
                            break;
                        case "value-mismatch":
                            ...
                            "object" == typeof t.shadowValue
                                ? Array.isArray(t.primaryValue) && Array.isArray(t.shadowValue)
                                    ? s(e, t.primaryValue, t.shadowValue)
                                    : i(e, t.primaryValue, t.shadowValue)
                                : r({ fieldName: e, primaryType: I(t.primaryValue), shadowType: I(t.shadowValue) });
                    }
                }
        }
    ...
    function i(e, t, n) {
        ...
        for (let o of Object.keys(t)) {
            ...
            if (!Object.prototype.hasOwnProperty.call(n, o)) {
                r({ fieldName: l, primaryType: I(u), shadowType: "missing" });
                continue;
            }
            let c = n[o];
            u !== c &&
                ("object" == typeof u && "object" == typeof c
                    ? Array.isArray(u) && Array.isArray(c)
                        ? s(l, u, c)
                        : null == u || null == c || a.has(u) || (a.add(u), i(l, u, c, a))
                    : r({ fieldName: l, primaryType: I(u), shadowType: I(c) }));
        }
    }
    function s(e, t, n) {
        (0, a.v)(t, n) ||
