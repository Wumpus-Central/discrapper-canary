...
function es(e, t, n) {
    ...
    n && ((p = "started"), N.default.track(D.HAw.SPOTIFY_LISTEN_ALONG_STARTED, { party_id: l.id, other_user_id: e })),
...
function eu(e) {
    if (e === g.default.getId()) {
        ...
        t && n && null != i ? (B.start(P, el, !1), H.stop()) : H.start(100, () => B.stop(), !1);
    }
    return !1;
}
function ec(e, t, n) {
...
class e_ extends u.Ay.Store {
    ...
    canPlay(e) {
        ...
        return null != Z() && null != t && null != n && null != n.id && (0, b.pH)(n.id);
    }
    getSyncingWith() {
        return r;
    }
