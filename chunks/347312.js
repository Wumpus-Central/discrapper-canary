...
function M(e, t) {
    ...
    return i.useMemo(() => {
        var e;
        return null != (e = P(null != n ? n : [], r)) ? e : N;
    }, [n, r]);
}
function k(e, t, n) {
...
function G(e) {
    let { className: t, waveform: n, currentTime: o, duration: s, played: l, playing: d, onDrag: f, onDragStart: p, onDragEnd: m } = e,
        ...
        { lastBackgroundFillColor: P, backgroundFillColor: w, lastActiveFillColor: D, activeFillColor: k, lastInactiveFillColor: G, inactiveFillColor: B } = j(l, d),
        V = {
            currentTime: o,
            duration: s,
            played: l
