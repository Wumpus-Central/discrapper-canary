...
function G(e) {
    let { className: t, waveform: n, currentTime: o, duration: s, played: l, playing: d, onDrag: f, onDragStart: _, onDragEnd: m } = e,
        { ref: g, width: E } = (0, c.Z)(),
        v = i.useMemo(() => P(s), [s]),
        b = i.useRef(),
        y = M(n, E),
    ...
    i.useEffect(() => {
        ...
        i.useEffect(() => {
            ...
            function t(n) {
                ...
                a = a || p;
                let [_, h] = U(D, k, n, N.current);
                a = a || h;
                for (let e = 0; e < o.length; e++) {
                    let t = o[e],
                        n = Math.max(t.getCurrentValue(), y[e] - 0.1);
                    i.beginPath(),
