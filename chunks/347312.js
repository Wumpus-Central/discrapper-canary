...
function B(e, n) {
    let r = s.useMemo(() => x(e), [e]),
        i = s.useMemo(() => P(n), [n]);
    return s.useMemo(() => {
        var e;
        return null !== (e = L(null != r ? r : [], i)) && void 0 !== e ? e : O;
    }, [r, i]);
}
function G(e, n, r) {
...
function V(e) {
    let { className: n, waveform: r, currentTime: i, duration: a, played: l, playing: c, onDrag: d, onDragStart: h, onDragEnd: _ } = e,
        ...
        { lastBackgroundFillColor: O, backgroundFillColor: x, lastActiveFillColor: L, activeFillColor: P, lastInactiveFillColor: M, inactiveFillColor: G } = Z(l, c),
        V = {
            currentTime: i,
            duration: a,
            played: l
