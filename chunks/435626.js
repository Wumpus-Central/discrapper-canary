...
var s = a(120356),
    ...
    y = a(945182);
function A(t) {
    let { analyticsLocations: e, transitionState: a, onClose: i, giftRecipient: n, analyticsObject: s } = t;
    return (
        (0, l.Z)(() => {
...
((i = n || (n = {}))[(i.NITRO = 0)] = 'NITRO'), (i[(i.NITRO_BASIC = 1)] = 'NITRO_BASIC'), (i[(i.SHOP = 2)] = 'SHOP');
let B = () => ((0, h.Z)(), null);
function R(t) {
    let { giftRecipient: e, analyticsObject: a, onClose: i } = t,
        { showBothNitroSkusInCategorySelect: n } = x.G.useExperiment({ location: 'gift-button' }, { autoTrackExposure: !1 }),
        ...
        _ = (t) => {
            ...
            t === b.Si.TIER_2 ? (i = p.Qqv.NITRO_STANDARD) : t === b.Si.TIER_0 && (i = p.Qqv.NITRO_BASIC),
                (0, j.Z)({
                    isGift: !0,
                    giftRecipient: e,
...
function f(t) {
    let { imageType: e } = t,
        { avatarPlaceholderSrc: a } = (0, m.Z)({ size: (0, T.y9)(r.AvatarSizes.SIZE_80) }),
        i = (0, _.Z)('a_c3cffc19e9784f7d0b005eecdf1b566e', r.AvatarSizes.SIZE_80, !1);
    return 0 === e || 1 === e
        ? (0, o.jsx)('div', {
