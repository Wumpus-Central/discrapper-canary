    ...
    (function (t, n) {
        ...
        (y = Array.prototype.indexOf
            ...
            eU(["MMM", "MMMM"], function (e, t, n, r) {
                ...
                null != i ? (t[eB] = i) : (m(n).invalidMonth = e);
            });
        var e6 = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,
        ...
        function e9(e, t) {
            return e
                ? i(this._months)
                    ...
                    : this._months[(this._months.isFormat || e6).test(t) ? "format" : "standalone"][e.month()]
                : i(this._months)
                  ? this._months
        ...
        function tt(e, t) {
            return e
                ? i(this._monthsShort)
                    ...
                    : this._monthsShort[e6.test(t) ? "format" : "standalone"][e.month()]
                : i(this._monthsShort)
                  ? this._monthsShort
        ...
        eu("H", ["HH", 2], 0, "hour"),
            ...
            eU(["h", "hh"], function (e, t, n) {
                (t[eH] = R(e)), (m(n).bigHour = !0);
            }),
            eU("hmm", function (e, t, n) {
                var r = e.length - 2;
                (t[eH] = R(e.substr(0, r))), (t[eY] = R(e.substr(r))), (m(n).bigHour = !0);
            }),
            eU("hmmss", function (e, t, n) {
                var r = e.length - 4,
                    i = e.length - 2;
                (t[eH] = R(e.substr(0, r))), (t[eY] = R(e.substr(r, 2))), (t[eW] = R(e.substr(i))), (m(n).bigHour = !0);
            }),
            eU("Hmm", function (e, t, n) {
                var r = e.length - 2;
                                ...
                                : n[eY] < 0 || n[eY] > 59
                                  ...
                                  : n[eW] < 0 || n[eW] > 59
                                    ...
                                    : n[eK] < 0 || n[eK] > 999
                                      ? eK
                                      : -1),
                    m(e)._overflowDayOfYear && (t < eF || t > eV) && (t = eV),
                    m(e)._overflowWeeks && -1 === t && (t = ez),
                    m(e)._overflowWeekday && -1 === t && (t = eq),
                    (m(e).overflow = t)),
                e
            );
        }
        ...
        function nn(e) {
            ...
            if (!e._d) {
                for (
                    r = nt(e),
                        e._w && null == e._a[eV] && null == e._a[eB] && nr(e),
                        null != e._dayOfYear &&
                            ((a = ne(e._a[eF], r[eF])),
                ...
                24 === e._a[eH] &&
                    ...
                    (e._d = (e._useUTC ? tp : tf).apply(null, o)),
        ...
        function nr(e) {
            ...
            if (null != (t = e._w).GG || null != t.W || null != t.E)
                (a = 1),
                    (o = 4),
                    (n = ne(t.GG, e._a[eF], th(nN(), 1, 4).year)),
                    (r = ne(t.W, 1)),
            ...
            r < 1 || r > tg(n, a, o)
                ...
                : null != l
                  ...
                  : ((s = tm(n, r, i, a, o)), (e._a[eF] = s.year), (e._dayOfYear = s.dayOfYear));
        }
        var ni =
        ...
        function nu(e) {
            ...
            if (l) {
                for (t = 0, m(e).iso = !0, n = ns.length; t < n; t++)
                    if (ns[t][1].exec(l[1])) {
                        (i = ns[t][0]), (r = !1 !== ns[t][2]);
                        break;
                    }
        ...
        function ny(e) {
            ...
            var n,
                ...
                l = s.length,
                c = 0;
            for (n = 0, i = e_(e._f, e._locale).match(eo) || []; n < i.length; n++)
                (a = i[n]),
                    (r = (s.match(eL(a, e)) || [])[0]) &&
                        ((o = s.substr(0, s.indexOf(r))).length > 0 && m(e).unusedInput.push(o),
                        (s = s.slice(s.indexOf(r) + r.length)),
                        (c += r.length)),
                    ec[a]
                        ? (r ? (m(e).empty = !1) : m(e).unusedTokens.push(a), eZ(a, r, e))
                        : e._strict && !r && m(e).unusedTokens.push(a);
            (m(e).charsLeftOver = l - c),
                s.length > 0 && m(e).unusedInput.push(s),
                e._a[eH] <= 12 && !0 === m(e).bigHour && e._a[eH] > 0 && (m(e).bigHour = void 0),
        ...
        function nM(e) {
            ...
            for (var n = !1, r = 0; r < nj.length; ++r)
                if (e[nj[r]]) {
                    if (n) return !1;
                    parseFloat(e[nj[r]]) !== R(e[nj[r]]) && (n = !0);
                }
            return !0;
        }
        function nk() {
        ...
        function n8(e, t) {
            ...
            return (
                ...
                (r = new nG(a)),
                nZ(e) && d(e, "_locale") && (r._locale = e._locale),
                r
            );
        }
        function n6(e, t) {
        ...
        function rV(e, t, n, r, i) {
            var a;
            return null == e ? th(this, r, i).year : (t > (a = tg(e, r, i)) && (t = a), rH.call(this, e, t, n, r, i));
        }
        ...
        function iu() {
            ...
            return (
                (a >= 0 && o >= 0 && s >= 0) ||
                    (a <= 0 && o <= 0 && s <= 0) ||
                    ((a += 86400000 * ic(ip(s) + o)), (o = 0), (s = 0)),
                (l.milliseconds = a % 1000),
                (l.seconds = (e = P(a / 1000)) % 60),
                (l.minutes = (t = P(e / 60)) % 60),
                (l.hours = (n = P(t / 60)) % 24),
                (o += P(n / 24)),
                (s += i = P(id(o))),
                (o -= ic(ip(i))),
