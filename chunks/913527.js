    ...
    (function (t, n) {
        ...
        function w(e, t, n) {
            var r,
                ...
                a = 0;
            for (r = 0; r < i; r++) ((n && e[r] !== t[r]) || (!n && R(e[r]) !== R(t[r]))) && a++;
            return a + o;
        }
        function D(e) {
        ...
        function ef(e) {
            ...
            return function (t) {
                var i,
                    o = '';
                for (i = 0; i < n; i++) o += M(r[i]) ? r[i].call(t, e) : r[i];
                return o;
            };
        }
        function e_(e, t) {
        ...
        function tZ() {
            ...
            for (a.sort(e), s.sort(e), l.sort(e), c.sort(e), t = 0; t < 7; t++) (s[t] = eM(s[t])), (l[t] = eM(l[t])), (c[t] = eM(c[t]));
        ...
        function nG(e) {
            var t = et(e),
                ...
                c = t.second || 0,
                u = t.millisecond || 0;
            (this._isValid = nM(t)), (this._milliseconds = +u + 1000 * c + 60000 * l + 1000 * s * 3600), (this._days = +a + 7 * o), (this._months = +i + 3 * r + 12 * n), (this._data = {}), (this._locale = t8()), this._bubble();
        }
        function nB(e) {
        ...
        function rt(e, n, r, i) {
            var o = n._milliseconds,
                a = nF(n._days),
                s = nF(n._months);
            e.isValid() && ((i = null == i || i), s && ti(e, e1(e, 'Month') + s * r), a && e3(e, 'Date', e1(e, 'Date') + a * r), o && e._d.setTime(e._d.valueOf() + o * r), i && t.updateOffset(e, a || s));
        }
        ...
        function r8(e, t, n, r) {
            ...
            var i,
                o = t8(),
                a = e ? o._week.dow : 0;
            if (null != n) return r5(t, (n + a) % 7, r, 'day');
            var s = [];
            for (i = 0; i < 7; i++) s[i] = r5(t, (i + a) % 7, r, 'day');
            return s;
        }
        function r7(e, t) {
        ...
        function iu() {
            var e,
                ...
                s = this._months,
                l = this._data;
            return (o >= 0 && a >= 0 && s >= 0) || (o <= 0 && a <= 0 && s <= 0) || ((o += 86400000 * ic(i_(s) + a)), (a = 0), (s = 0)), (l.milliseconds = o % 1000), (l.seconds = (e = P(o / 1000)) % 60), (l.minutes = (t = P(e / 60)) % 60), (l.hours = (n = P(t / 60)) % 24), (a += P(n / 24)), (s += i = P(id(a))), (a -= ic(i_(i))), (r = P(s / 12)), (s %= 12), (l.days = a), (l.months = s), (l.years = r), this;
        }
        function id(e) {
