...
function c(e, t) {
    ...
    if (null != t)
        return null == e || e.type !== a.IIU.PLAYING
            ? o.intl.string(o.t.eXan7O)
            : o.intl.format(s(n)[a.IIU.STREAMING], { name: e.name });
    if (null == e || null == e.name) return null;
    if ((0, l.Z)(e)) {
        let t = null != e.details && "" !== e.details ? e.details : e.name;
        return o.intl.format(s(n)[a.IIU.STREAMING], { name: t });
    }
    return (0, i.Z)(e)
        ? (0, r.Z)(e.name)
        : (function (e, t, n) {
              ...
              switch (e) {
                  ...
                  case a.IIU.COMPETING:
                      return o.intl.format(r[e], { name: t });
                  ...
                  default:
                      return n
                          ? o.intl.formatToPlainString(o.t.Sq9xJy, { game: t })
                          : o.intl.format(o.t.lFApm5, { game: t });
              }
          })(e.type, e.name, n);
}
function u(e, t) {
