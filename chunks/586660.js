...
class d {
    static fromMessage(e, t, n, i) {
        let [r, s] = d.deriveMemberUsers(e, n);
    ...
    static deriveMemberUsers(e, t) {
        ...
        for (let t of n) {
            ...
            let n = u.default.getUser(t),
                s = l.Ay.getTrueMember(e ?? c.dJq, t);
    ...
    constructor(e) {
        if (e.length > 0) {
            const t = e[0]?.connectionId,
                [n, i] = E.computeUsersAndMembers(e);
...
let m = new (class {
    async startupLoad(e, t, n, i) {
        ...
        return new E(await r.getLatest(t, n, i));
    }
    async load(e, t, n) {
        let i = a.A.getBasicChannel(t);
        if (null == t || null == i || !(0, h.c)(i)) return new E([]);
        {
            let r = o.A.messages(e);
            return new E(await r.getLatest(i.guild_id, t, n));
        }
    }
    actions = {
    ...
    handleMessageCreate(e, t) {
        e.optimistic ||
            ...
            ((0, h.J)(e.channelId) && this.upsertOne(e.guildId, e.channelId, e.message, t));
    }
    handleMessageUpdate(e, t) {
        var n;
        null == e.message.id ||
            null == e.message.channel_id ||
            ((0, h.J)(e.message.channel_id) &&
    ...
    handleMessagePreviewsLoaded(e, t) {
        for (let n of e.messages) (0, h.J)(n.channel_id) && this.insertStale(e.guildId, n.channel_id, n, t);
    }
    ...
    insertStale(e, t, n, r) {
        ...
        a.put(e, t, d.fromMessage(e, t, n, l), i.hh.Skip);
    }
    upsertOne(e, t, n, r) {
        let a = o.A.messagesTransaction(r),
            l = s.A.lastTimeConnectedChanged();
        a.put(e, t, d.fromMessage(e, t, n, l), i.hh.Replace), a.trimChannel(e, t, _.Ay.saveLimit(t));
    }
    upsertMany(e, t, n, i) {
        let r = o.A.messagesTransaction(i),
            a = s.A.lastTimeConnectedChanged();
        for (let i of n) r.put(e, t, d.fromMessage(e, t, i, a));
    ...
    replaceChannel(e, t, n, i) {
        let r = o.A.messagesTransaction(i),
            a = s.A.lastTimeConnectedChanged(),
            l = _.Ay.saveLimit(t),
            u = (n.length > l ? n.slice(n.length - l) : n).map((n) => d.fromMessage(e, t, n, a));
        r.replaceChannel(e, t, u), r.trimChannel(e, t, _.Ay.saveLimit(t));
    }
    async updateOne(e, t, n, i) {
        ...
        let r = o.A.messages(i.database),
            ...
            l = s.A.lastTimeConnectedChanged();
        null != a && r.put(e, t, d.fromMessage(e, t, { ...a.message, ...n }, l));
    }
    deleteOne(e, t, n, i) {
