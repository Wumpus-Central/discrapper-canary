...
function s(e, t) {
    ...
    if ((0, a.cS)(t.byweekno)) return f;
    f.wnomask = (0, a.rx)(0, c + 7);
    var p = (n = (0, a.Vy)(7 - _ + t.wkst, 7));
    p >= 4 ? ((p = 0), (o = f.yearlen + (0, a.Vy)(_ - t.wkst, 7))) : (o = c - p);
    for (var h = Math.floor(Math.floor(o / 7) + (0, a.Vy)(o, 7) / 4), m = 0; m < t.byweekno.length; m++) {
        ...
        if ((g < 0 && (g += h + 1), g > 0 && g <= h)) {
            ...
            for (var b = 0; b < 7 && ((f.wnomask[E] = 1), E++, f.wdaymask[E] !== t.wkst); b++);
        }
    }
    if ((0, a.q9)(t.byweekno, 1)) {
        var E = p + 7 * h;
        if ((p !== n && (E -= 7 - n), E < c)) for (var m = 0; m < 7 && ((f.wnomask[E] = 1), (E += 1), f.wdaymask[E] !== t.wkst); m++);
    }
    if (p) {
        var y = void 0;
        ...
        if ((0, a.q9)(t.byweekno, y)) for (var E = 0; E < p; E++) f.wnomask[E] = 1;
    }
    return f;
}
function l(e) {
