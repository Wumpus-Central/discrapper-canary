...
let A = {
    ...
    addRecipient(e, t, n, a) {
        return r.tn
            ...
            .then((t) => ((i.uv.announce(O.intl.string(O.t.cU0t1N)), null == a || a(), 201 === t.status) ? this._openPrivateChannel(t.body).id : e))
    ...
    async updateChannel(e, t, n) {
        ...
        try {
            ...
            return null == o || (null == a ? void 0 : a.isThread()) || l.Z.checkGuildTemplateDirty(o), i && m.default.track(y.rMx.CHANNEL_ICON_EDIT_PROGRESSED, T(I({}, s), { status: 'success' })), n;
        } catch (e) {
            if (i) {
                var c, u;
                m.default.track(
