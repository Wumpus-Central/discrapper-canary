e.exports = function (e) {
    let t = e.regex,
        ...
        a = { className: "attribute", begin: "\\bid\\s*:", starts: { className: "string", end: r, returnEnd: !1 } },
        o = {
            begin: r + "\\s*:",
            returnBegin: !0,
    ...
    return {
        ...
        contains: [
            ...
            i,
            {
                ...
                excludeEnd: !0,
                contains: [
                    e.inherit(e.TITLE_MODE, { begin: /[A-Za-z$_][0-9A-Za-z$_]{0,149}/ }),
                    {
                        className: "params",
                        begin: /\(/,
                        end: /\)/,
