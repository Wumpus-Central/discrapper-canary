...
let a = {
    ...
    f = `(?:${(0, r.q3)(c)}|[0-9]+|[0-9]+\\.[0-9]+|пів|декілька|пар(?:у)|\\s{0,3})`;
function p(e) {
    let t = e.toLowerCase();
    return void 0 !== c[t]
        ? c[t]
...
let _ = `(?:${(0, r.q3)(u)}|[0-9]{1,2}(?:го|ого|е)?)`;
function m(e) {
    let t = e.toLowerCase();
    return void 0 !== u[t] ? u[t] : parseInt(t);
}
let h = "(?:\\s+(?:року|рік|р|р.))?",
    g = `(?:[1-9][0-9]{0,3}${h}\\s*(?:н.е.|до н.е.|н. е.|до н. е.)|[1-2][0-9]{3}${h}|[5-9][0-9]${h})`;
function E(e) {
...
let b = `(${f})\\s{0,3}(${(0, r.q3)(d)})`,
    y = RegExp(b, "i"),
    O = (0, r.Xf)(`(?:(?:близько|приблизно)\\s{0,3})?`, b);
function v(e) {
    let t = {},
        n = e,
        r = y.exec(n);
