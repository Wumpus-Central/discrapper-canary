...
let em = () => {
    let { analyticsLocations: e } = (0, c.ZP)(l.Z.PREMIUM_MARKETING_PERK_CARD),
        ...
        ej = () => {
            eT || (0, p.Q3)(a.z.PERMADECOS_NITRO_HOME_CARD_NEW_BADGE, { dismissAction: x.L.TAKE_ACTION }), eC();
        },
        ek = {
            clientThemes: {
                name: "clientThemes",
            ...
            september2025MarketingMoment: {
                ...
                subtitle: k.intl.format(k.t.dA8CJi, { helpCenterLink: C.lB }),
                pillText: k.intl.string(k.t.OS9KPj).toLocaleUpperCase(),
                cta: k.intl.string(k.t["8g3ANT"]),
