...
let ed = () => {
    let { analyticsLocations: e } = (0, d.ZP)(c.Z.PREMIUM_MARKETING_PERK_CARD),
        ...
        eb = (0, p.Nj)(l.z.PERMADECOS_NITRO_HOME_CARD_NEW_BADGE),
        ex = (0, g.Z)({
        ...
        eO = {
            ...
            permadecos: {
                ...
                onCtaClick: em
                    ? () => {
                          (eb || (0, p.Q3)(l.z.PERMADECOS_NITRO_HOME_CARD_NEW_BADGE, { dismissAction: A.L.TAKE_ACTION }), ex());
                      }
                    : void 0,
