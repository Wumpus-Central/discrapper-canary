...
function P(e) {
    ...
    null == d && (d = T[e.applicationId] = new o.Xp()).start(v, () => P(e)),
        t || ((S[e.applicationId] = e), s.K.set(y, S));
}
function x() {
...
class Z extends (i = a.ZP.Store) {
    initialize() {
        this.waitFor(g.default, _.Z, b.Z, E.Z, p.ZP, O.Z, f.Z), this.syncWith([f.Z], x);
    }
    getActivities() {
        return S;
    }
