...
class T extends (r = a.PureComponent) {
    ...
    render() {
        ...
        let { value: t, active: n, focused: r, sortedMarkers: a, markerPositions: o, closestMarkerIndex: l, newClosestIndex: c, min: d, max: f } = this.state,
            { disabled: m, stickToMarkers: E, className: y, children: v, barStyles: I, fillStyles: S, mini: T, hideBubble: N, defaultValue: C, orientation: R, onValueRender: P, renderMarker: w, getAriaValueText: D, barClassName: L, grabberClassName: x, grabberStyles: M = {}, markerPosition: k = 0, 'aria-hidden': j, 'aria-label': U, 'aria-labelledby': G, 'aria-describedby': B } = this.props,
            V = 0;
                                      ...
                                      null != w
                                          ...
                                          : (0, i.jsxs)(i.Fragment, {
                                                children: [
                                                    ...
                                                    (0, i.jsx)('div', { className: g['markDash'.concat(null == o ? 'simple' : '')] })
                                                ]
                                            })
                              },
                              t
    ...
    moveStaggered(e) {
        ...
        let u = c - l,
            d = (e.clientX - r) / u,
            f = a[i] + 100 * d;
        null != (t = this.props.equidistant ? v(f, a) : v(this.unscaleValue(f), o)) && (null == s || s(o[t])), this.setState({ newClosestIndex: t });
    }
    constructor(e) {
        super(e),
...
function A(e) {
    let { active: t, keyboardFocused: n, children: r } = e,
        ...
        l = (0, f.q)({
            ...
            config: O(b({}, u.config.stiff), { duration: 100 })
        });
    return i
        ? r({
              sliderStyles: l,
