...
let _ = ['#be0351', '#ff2c52', '#f0f0f0'],
    ...
    b = (e) => {
        var { width: t = 24, height: n = 24, primaryTintColor: l, secondaryTintColor: u } = e,
            p = f(e, ['width', 'height', 'primaryTintColor', 'secondaryTintColor']);
        let b = i.useMemo(() => 'badge-force-gradient-'.concat((0, o.Z)()), []),
            { primaryColorsTransformed: y, secondaryColorsTransformed: O } = (0, s.s)({
                primaryBaseColors: _,
                primaryTintColor: l,
