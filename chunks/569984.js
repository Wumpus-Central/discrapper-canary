...
function Q(e) {
    ...
    (r = !1), (a = new Map());
    let s = new Map();
    for (let e of t) a.set(e.id, e), s.set(e.id, (0, P.zi)(e)), e.targetedContent.includes(C.jn.QUEST_BAR) && (0, w.T)({ location: D.dr.QUESTS_STORE }).log('Delivered '.concat(e.config.messages.questName, ' (').concat(e.id, ')'));
