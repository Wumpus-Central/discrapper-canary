...
let k = new Map(),
    ...
    U = 1000;
function G() {
    (r = !1), (i = !1), (o = new Map()), (a = new Map()), (s = new Map()), (l = 0), (c = new Set()), (u = new Set()), (d = new Set()), (f = new Set()), (k = new Map()), (p = new Map()), (h = new Map()), (m = new Map()), (g = null), (E = new Map()), (_ = new Set()), (b = new Map()), (y = new Map()), eA();
}
function B(e, t) {
    var n, r, i, o;
    if (null != t.userStatus) for (let a of Object.values(null != (r = null == (n = t.userStatus) ? void 0 : n.progress) ? r : {})) !(0, O.isNil)(a) && I.T.DESKTOP.has(a.eventName) && ((null == (i = a.heartbeat) ? void 0 : i.lastBeatAt) != null ? _.add(e) : (null == (o = a.heartbeat) ? void 0 : o.lastBeatAt) == null && _.delete(e));
}
function F(e, t) {
...
function q(e) {
    ...
    (r = !1), (o = new Map());
    let i = new Map();
    for (let e of t) o.set(e.id, e), i.set(e.id, (0, C.zi)(e)), e.targetedContent.includes(A.jn.QUEST_BAR) && (0, P.T)({ location: w.dr.QUESTS_STORE }).log('Delivered '.concat(e.config.messages.questName, ' (').concat(e.id, ')'));
    for (let e of ((y = i), (a = new Map()), n)) a.set(e.id, e);
    eN();
}
function Q() {
    (l = 0), (r = !1);
