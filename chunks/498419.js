!(function () {
    var t = function (e) {
        ...
        (C.duration = 40),
            ...
            (C.run = function (e, n, i, r) {
                var a = C.types[E.hidden || E.msHidden || E.webkitHidden || E.mozHidden ? "none" : t.animation];
                ((r = !0 === i ? (void 0 !== r ? r : a.length - 1) : void 0 !== r ? r : 0),
                (n = n || function () {}),
                r < a.length && r >= 0)
                    ? (I[t.type](v(e, a[r])),
                      (f = setTimeout(function () {
                          i ? (r -= 1) : (r += 1), C.run(e, n, i, r);
                      }, C.duration)),
                      y.setIcon(s))
                    : n();
            }),
            ((t = v(m, e)).bgColor = N(t.bgColor)),
            (t.textColor = N(t.textColor)),
            (t.position = t.position.toLowerCase()),
            (t.animation = C.types["" + t.animation] ? t.animation : m.animation),
            (E = t.win.document);
        var R = t.position.indexOf("up") > -1,
            O = t.position.indexOf("left") > -1;
        if (R || O)
            for (var b = 0; b < C.types["" + t.animation].length; b++) {
                var D = C.types["" + t.animation][b];
                R && (D.y < 0.6 ? (D.y = D.y - 0.4) : (D.y = D.y - 2 * D.y + (1 - D.w))),
                    O && (D.x < 0.6 ? (D.x = D.x - 0.4) : (D.x = D.x - 2 * D.x + (1 - D.h))),
                    (C.types["" + t.animation][b] = D);
            }
        return (
