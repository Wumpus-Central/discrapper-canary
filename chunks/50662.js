...
function C(e) {
    var t;
    let { guildJoinRequest: a, guild: C, guildJoinRequestUser: N } = e,
        { createdAt: y, actionedAt: I, guildId: T, userId: w } = a,
        { approveRequest: O, rejectRequest: P, submitting: R } = (0, h.s)(T, w, a.joinRequestId),
        E = null === (t = a.actionedByUser) || void 0 === t ? void 0 : t.id,
        S = (0, o.e7)([p.default], () => p.default.getUser(E)),
        B = (0, o.e7)([m.ZP], () => (null != E ? m.ZP.getMember(T, E) : null), [E, T]),
        k = (0, o.e7)([u.Z], () => u.Z.getMemberCount(T)),
