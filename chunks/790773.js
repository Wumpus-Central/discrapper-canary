...
function x(e) {
    let {
        ...
        g = (0, s.e7)([_.default], () => _.default.getUser(null == t ? void 0 : t.userId)),
        b = null == t || (null != f && null != t && t.userId === f.id),
        E = i.useMemo(() => (null == t ? (null != f ? [f.id] : void 0) : [t.userId]), [t, f]),
        v = (0, I.Z)({
            guildId: (0, O.ac)(),
            numWishlistItems: o,
        ...
        T = v.recommendations.filter((e) => !S.has(e.skuId)).slice(0, c);
