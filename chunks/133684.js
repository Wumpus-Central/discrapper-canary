...
class g extends i.PureComponent {
    ...
    getCurrentWord() {
        ...
        let n = e.selectionStart,
            r = e.selectionEnd;
        for (; n > 0 && !m.test(t[n - 1]); ) n--;
        let i = e.selectionEnd;
        for (; i < t.length && !m.test(t[i]); ) i++;
    ...
    handleTabOrEnterDown(e) {
        (e.key === E.dh.TAB && this.props.onTab()) || (e.key === E.dh.ENTER && this.props.onEnter(e))
    ...
    handleKeyUp = (e) => {
        switch (e.key) {
            case E.dh.ARROW_RIGHT:
            case E.dh.ARROW_LEFT:
            case E.dh.HOME:
            case E.dh.END:
                this.props.maybeShowAutocomplete();
        }
