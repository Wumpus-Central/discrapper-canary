...
function P(e) {
    let { user: t, guildId: n, joinRequest: l } = e,
        { approveRequest: i, rejectRequest: a, handleOpenInterview: o, submitting: s } = (0, p.s)(n, t.id, l.joinRequestId, l.interviewChannelId);
    return (0, r.jsxs)('div', {
...
function A(e) {
    let { guildId: t } = e,
        ...
        s = l.useMemo(() => (null != i ? new g.Z(i) : null), [i]),
