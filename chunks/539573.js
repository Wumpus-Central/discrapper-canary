...
let c = new Set([
    ...
    o.evJ.AUTOMOD_INVALID_RUST_SERVICE_RESPONSE,
]);
function u(e, t) {
    ...
    return (null == s ? void 0 : s.isThread())
        ? a.intl.string(a.t.DVdG9P)
        : ((null == s ? void 0 : s.isForumPost()) || (null == s ? void 0 : s.isForumLikeChannel())) &&
            (n === o.evJ.AUTOMOD_TITLE_BLOCKED || n === o.evJ.AUTOMOD_MESSAGE_BLOCKED)
