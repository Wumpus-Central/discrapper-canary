...
class o extends r.A {
    ...
    static fromType(e, t, n, r, s) {
        switch (e) {
            ...
            case "QUEST_HOME":
                return new o({ path: i.BVt.QUEST_HOME_V2, type: "QUEST_HOME" });
            case "APPS_HOME":
            ...
            case "PLAYGROUND":
                return new o({ path: t ?? i.BVt.APP, type: "PLAYGROUND", label: n, collectionId: r, IconComponent: s });
            case "SHOP_ORBS_TAB":
                return new o({ path: i.BVt.COLLECTIBLES_SHOP, type: "SHOP_ORBS_TAB" });
            case "QUEST_ORBS":
                return new o({ path: `${i.BVt.QUEST_HOME_V2}?filter=${a.BQ.VIRTUAL_CURRENCY}`, type: "QUEST_ORBS" });
            default:
