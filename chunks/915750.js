...
class k {
    ...
    constructor({ questOrQuests: e, questContent: t, triggeredByStatusChange: n, trackGuildAndChannelMetadata: r, questContentPosition: i, questContentRowIndex: s, minViewTimeSeconds: l = D, isQuestEnrollmentBlocked: c, sourceQuestContent: f }) {
        var p = this;
        (A(this, 'id', void 0),
