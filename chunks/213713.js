    ...
    return (0, a.jsx)('div', {
        ...
        children: (0, a.jsxs)(p.zJl, {
            ...
            children: [
                (0, a.jsxs)(p.hjN, {
                    children: [
                        (0, a.jsx)(p.vwX, { children: 'Inventory' }),
                        s.length > 0 &&
                            (0, a.jsx)(v.Z, {
                                columns: k,
                                data: s
                            }),
                        (0, a.jsx)(p.LZC, { size: 8 }),
                        (0, a.jsx)(S.Z, {}),
                        (0, a.jsx)(p.zxk, {
                            fullWidth: !0,
                            onClick: function () {
                ...
                (0, a.jsxs)(p.hjN, {
                    children: [
                        (0, a.jsx)(p.vwX, { children: 'Impression Capping' }),
                        (0, a.jsx)(p.zxk, {
                            fullWidth: !0,
                            onClick: function () {
                ...
                (0, a.jsxs)(p.hjN, {
                    children: [
                        (0, a.jsx)(p.vwX, { children: 'Game Profile' }),
                        (0, a.jsx)(p.oil, {
                            placeholder: 'App ID or full name',
                            onChange: (e) => (0 === e.length || e.length >= 18) && A(e),
                            onKeyDown: (e) => {
                                'Enter' === e.key && (R === e.currentTarget.value ? null == D || D(e) : A(e.currentTarget.value));
                            },
                ...
                (0, a.jsxs)(p.hjN, {
                    children: [
                        (0, a.jsx)(p.vwX, { children: 'Activity Sharing' }),
                        (0, a.jsx)(p.Text, {
                            variant: 'text-md/normal',
