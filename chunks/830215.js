...
let N = new _.A("AuthenticationActionCreators"),
    v = null;
var C = (((i = {}).MFA = "MFA"), (i.SUCCESS = "SUCCESS"), i);
function O(e) {
...
function R(e) {
    ...
    if ((O(), null == t)) return;
    let n = (0, f.Y)();
    null == n ? (0, p.pX)(t, { source: e }) : (T.A.popAll(), n.reset({ index: 0, routes: [{ name: "auth" }] }));
}
let b = {
    startSession(e) {
        u.h.wait(() => {
        ...
        null != v
            ...
            : (clearTimeout(r),
              ...
              (v = o.Bo.get({
                  ...
                  () => {
                      clearTimeout(r), u.h.dispatch({ type: "SET_CONSENT_REQUIRED", consentRequired: !0 }), (v = null);
                  },
              ))),
    closeSuspendedUser() {
