...
function f(e, t, n, r = "react-aria-ListBoxSection") {
    ...
    let a = $e8Bmu$useContext(_),
        ...
        [u, c] = $64fa3d84918910a7$export$9d4c57ee4c6ffdd8(),
...
function p(e, t) {
    ...
    return a ? null : $e8Bmu$react.createElement(h, { ...e, dropIndicatorProps: i, isDropTarget: s, ref: t });
}
let h = null;
(0, a.KU)(s.OJ, function (e, t, n) {
    let a = (0, c.useContext)(_),
        { isLoading: s, onLoadMore: d, scrollOffset: f, ...p } = e,
        h = (0, c.useRef)(null),
        m = (0, c.useMemo)(
            () => ({ onLoadMore: d, collection: null == a ? void 0 : a.collection, sentinelRef: h, scrollOffset: f }),
            [d, f, null == a ? void 0 : a.collection],
        );
    (0, o.n)(m, h);
    let g = (0, r.Sl)({
            ...p,
    ...
    return c.createElement(
        ...
        s &&
            ...
            c.createElement(
                "div",
                { ...(0, i.v)((0, u.$)(e, { global: !0 }), E), ...g, role: "option", ref: t },
                g.children,
            ),
    );
});
