...
async function d(e) {
    ...
    try {
        ...
        return a.h.dispatch({ type: "APPLICATION_FETCH_SUCCESS", application: r.body }), r.body;
    } catch (t) {
...
let _ = {
            ...
            let { name: t, guildId: n, type: r, teamId: s } = e,
                o = (
                    await i.Bo.post({
                        ...
                        body: { name: t, type: r, guild_id: n, team_id: s },
                        rejectWithError: !1,
                    })
                ).body;
            return null != n && null != r && a.h.dispatch({ type: "APPLICATION_FETCH_SUCCESS", application: o }), o;
        },
        async getApplicationsForGuild(e) {
            ...
            return a.h.dispatch({ type: "APPLICATIONS_FETCH_SUCCESS", applications: r }), r;
        },
        async transferApplication(e) {
            ...
            return a.h.dispatch({ type: "APPLICATION_FETCH_SUCCESS", application: r }), r;
        },
        async fetchApplications(e) {
            ...
            if (n.length > 0) {
                ...
                a.h.dispatch({ type: "APPLICATIONS_FETCH_SUCCESS", applications: e.body, unknownApplicationIds: r });
            }
        },
        fetchApplication: d,
    },
