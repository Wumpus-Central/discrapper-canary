"use strict";
let r, i, s, a, o, l;
n.d(t, { BV: () => v, Fy: () => R, Pf: () => S, Pg: () => N, R0: () => I, sv: () => C });
var u = n(214958),
    d = n.n(u);
n(689953);
var c = n(70298),
...
if (null != A) {
    ...
    if (
        ((r = {
            ...
            app_arch: a,
            system_locale: l,
            has_client_mods: (0, c.b)(),
            client_launch_id: h.C,
        }),
        d().name?.toLocaleLowerCase() === "electron" &&
        ...
        r = (function () {
            ...
            if (null == e) {
                ...
                ((t = {}).os = I()),
                    ...
                    (t.has_client_mods = (0, c.b)()),
                    (e = t),
                    f.w.set(m, e);
            }
            let t = f.w.get(g);
            null == t && ((t = O()), f.w.set(g, t));
            let n = E.u.get(g);
            if (null == n) {
                var r;
                let e;
                (r = O()), (e = {}), Object.keys(r).map((t) => (e[`${t}_current`] = r[t])), (n = e), E.u.set(g, n);
            }
            return {
                ...e,
                ...{
                    ...{ browser_user_agent: window.navigator.userAgent || "", browser_version: d().version || "" },
