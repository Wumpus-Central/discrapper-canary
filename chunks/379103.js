...
function a(e) {
    let { width: t = 24, height: n = 24, color: a = "currentColor", foreground: o, gradientConfig: c, ...d } = e,
        h = null;
    return (
        null != c && (h = (0, i.jsx)(s.A, { ...c, color: a, id: r(c.id) })),
        (0, i.jsxs)("svg", {
            ...(0, l.A)(d),
            width: t,
            height: n,
            viewBox: "0 0 24 24",
            children: [
                (0, i.jsx)("defs", { children: h }),
                (0, i.jsx)("path", { d: "M0 0h24v24H0z", fill: "none" }),
                (0, i.jsx)("path", {
                    fill: null != c ? `url(#${r(c.id)})` : a,
                    className: o,
