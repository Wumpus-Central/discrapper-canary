...
function D(e) {
    let { message: t, item: n, autoPlayGif: l, canRemoveItem: u, onRemoveItem: m, onClick: h, handlePreloadImage: p, onContextMenu: f, onPlay: y, renderImageComponent: O, renderVideoComponent: b, renderAudioComponent: C, renderPlaintextFilePreview: M, renderGenericFileComponent: A, renderVisualPlaceholderComponent: L, className: S, imgContainerClassName: D, imgClassName: k, focusable: G, hiddenSpoilers: W, mediaLayoutType: F, maxWidth: R, maxHeight: H, hasFooter: V, useFullWidth: Z, isVisualMediaType: B, onVideoControlsShow: U, onVideoControlsHide: X, isSearchResult: J } = e,
        { width: q, height: z, spoiler: Y, type: K, contentType: Q } = n,
        [$, ee] = i.useState(!1),
        [et, en] = i.useState(!1),
        er = t.getChannelId(),
        ei = j.Z.getChannel(er),
        el = (0, x.Z)(er),
...
let k = function (e) {
    ...
    let { width: g, height: I, type: x } = n,
        j = a(n, (0, O.v)(l)),
        [E, b] = i.useState(null != j),
        P = u === v.hV.MOSAIC,
        T = !P && ((null != g && g < 200) || (null != I && I < 50)),
        M = 'IMAGE' === x || 'VIDEO' === x,
        S = (0, C.R_)(x),
        _ = c && null != j && (0, f.yf)(g, I),
        [k, G] = i.useState(!1),
        W = () => {
            G(!0);
        },
        ...
        children: [
            null != j
                ? (0, r.jsx)(h.ZP, {
                      ...
                      obscurityControlClassName: o()({ [N.obscureVideoSpacing]: 'VIDEO' === x && c && !E && k }),
