...
class M extends l.PureComponent {
    iconRef = l.createRef();
    componentDidMount() {
        T._.subscribe(j.jej.CALL_START, this.handleVoiceClick);
    }
    componentWillUnmount() {
        T._.unsubscribe(j.jej.CALL_START, this.handleVoiceClick);
    }
    renderVideoCallButton() {
        ...
        if (t || (n && r === j._Of.VOICE)) return null;
        let c = a.isManaged(),
            u = null,
            h = !1;
        return (
                    ...
                    children: (e) => {
                        ...
                        return t === a.M.ACTIVITY_GDM_CALL_TOOLTIP
                            ? (0, i.jsx)(r.A, {
                                  ...
                                  body: G.intl.format(G.t.xAW71b, { helpdeskUrl: R.DY }),
                                  position: "bottom",
                                  align: "center",
...
function D(e) {
    let { channel: t } = e,
        ...
        { notFriend: m, isBlocked: g } = (0, s.cf)([N.A], () => ({
            notFriend: t.type === j.rbe.DM && null != u && !N.A.isFriend(u),
            isBlocked: t.type === j.rbe.DM && null != u && N.A.isBlocked(u),
        })),
