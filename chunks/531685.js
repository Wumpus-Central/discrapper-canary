...
function c(e) {
    let t = u.get(e);
    return null == t
        ? (d.has(e) || console.warn("Window state not initialized", e),
...
let f = new _(a.h, {
    ...
    WINDOW_UNLOAD: function (e) {
        return d.add(e.windowId), u.delete(e.windowId), l === e.windowId && (l = null), !0;
    },
...
Promise.resolve()
    ...
    .then((e) => {
        ...
        t((e) => {
            {
                e.client_app_state = f.isAppFocused() ? "focused" : "unfocused";
                let t = f.windowSize();
