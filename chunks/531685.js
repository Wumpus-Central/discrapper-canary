...
let E = new _(s.h, {
    WINDOW_INIT: function (e) {
        ...
        let { width: t, height: n, isElementFullscreen: i, focused: a, visible: s } = e;
        return (
            d.set(e.windowId, { windowSize: { width: t, height: n }, isElementFullscreen: i, focused: a, visible: s }),
            a && (o = e.windowId),
            !0
        );
    },
    ...
    WINDOW_FOCUS: function (e) {
        ...
        return (
            t.focused !== e.focused &&
            (e.focused && (o = e.windowId), d.set(e.windowId, { ...t, focused: e.focused }), !0)
        );
    },
