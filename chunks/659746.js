...
var i,
    ...
    E = n(47775);
let m = Object.freeze({
    DURATION: { [p.PremiumTypes.TIER_0]: 1e3, [p.PremiumTypes.TIER_1]: 1e3, [p.PremiumTypes.TIER_2]: 1500 },
    DELAY: { [p.PremiumTypes.TIER_0]: 400, [p.PremiumTypes.TIER_1]: 400, [p.PremiumTypes.TIER_2]: 2200 },
    FLASH_TIME_PERCENT: 0.72,
    FLASH_DURATION_PERCENT: 0.08,
});
var g =
    (((i = {}).PREMIUM_ACTIVATED = "PREMIUM_ACTIVATED"),
    (i.PREMIUM_UPDATED = "PREMIUM_UPDATED"),
    (i.PREMIUM_UPGRADED = "PREMIUM_UPGRADED"),
    (i.GUILD_BOOST_APPLIED = "GUILD_BOOST_APPLIED"),
    (i.PREMIUM_PAYMENT_STARTED = "PREMIUM_PAYMENT_STARTED"),
    i);
class A extends s.PureComponent {
    ...
    animate() {
        ...
        l.A.timing(this.animation, { toValue: 1, delay: m.DELAY[e], duration: m.DURATION[e] }).start();
    }
    getContainerStyle() {
        let { flashColor: e } = this.props,
            t = m.FLASH_TIME_PERCENT,
            n = m.FLASH_DURATION_PERCENT,
            i = (0, f.tp)(e, 0);
        return {
            backgroundColor: this.animation.interpolate({
                inputRange: [0, t, t, t + n, 1],
                outputRange: [i, i, e, e, i],
            }),
        };
    }
    getShineStyle() {
        return l.A.accelerate({
            transform: [
                { translateX: this.animation.interpolate({ inputRange: [0, 1], outputRange: ["20%", "160%"] }) },
            ],
        });
    }
    getSvgBorderGradientId() {
        ...
        switch (t) {
            case "GUILD_BOOST_APPLIED":
                return h.gi.PREMIUM_GUILD;
            case "PREMIUM_ACTIVATED":
            case "PREMIUM_PAYMENT_STARTED":
            case "PREMIUM_UPGRADED":
            case "PREMIUM_UPDATED":
                if (e === p.PremiumTypes.TIER_0) return h.gi.PREMIUM_TIER_0;
                if (e === p.PremiumTypes.TIER_1) return h.gi.PREMIUM_TIER_1;
                return h.gi.PREMIUM_TIER_2;
            default:
...
function I(e) {
    let { theme: t, ...n } = e,
        i = (0, _.r)(u.A.unsafe_rawColors.WHITE).hex(),
        s = (0, _.r)(u.A.unsafe_rawColors.BRAND_500).hex(),
        a = (0, c.M)(t) ? i : s;
    return (0, r.jsx)(A, { ...n, theme: t, flashColor: a });
}
I.Types = g;
