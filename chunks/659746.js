...
var P =
    (((h = {}).PREMIUM_ACTIVATED = "PREMIUM_ACTIVATED"),
    (h.PREMIUM_UPDATED = "PREMIUM_UPDATED"),
    (h.PREMIUM_UPGRADED = "PREMIUM_UPGRADED"),
    (h.GUILD_BOOST_APPLIED = "GUILD_BOOST_APPLIED"),
    (h.PREMIUM_PAYMENT_STARTED = "PREMIUM_PAYMENT_STARTED"),
    h);
class g extends (t = s.PureComponent) {
    ...
    getContainerStyle() {
        let { flashColor: a } = this.props,
            e = C.FLASH_TIME_PERCENT,
            l = C.FLASH_DURATION_PERCENT,
            t = (0, A.tp)(a, 0);
        return {
    ...
    let { theme: t } = a,
        h = (function (a, e) {
            ...
            if ("u" > typeof Reflect && Reflect.ownKeys) {
                for (h = 0, l = Reflect.ownKeys(a); h < l.length; h++)
                    (t = l[h]),
            ...
            if (
                ((r = (function (a, e) {
                    ...
                    for (t = 0; t < r.length; t++)
                        (l = r[t]),
                            !(e.indexOf(l) >= 0) && Object.prototype.propertyIsEnumerable.call(a, l) && (h[l] = a[l]);
                    return h;
                })(a, e)),
                Object.getOwnPropertySymbols)
            )
                for (h = 0, l = Object.getOwnPropertySymbols(a); h < l.length; h++)
                    (t = l[h]),
                        !(e.indexOf(t) >= 0) && Object.prototype.propertyIsEnumerable.call(a, t) && (r[t] = a[t]);
            return r;
        })(a, ["theme"]),
        s = (0, m.rdh)(o.A.unsafe_rawColors.WHITE).hex(),
        n = (0, m.rdh)(o.A.unsafe_rawColors.BRAND_500).hex(),
        c = (0, d.Mw)(t) ? s : n;
    return (0, r.jsx)(
        g,
        ((e = (function (a) {
