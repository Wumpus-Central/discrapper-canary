...
new c(s.h, {
    ...
    STOREFRONT_PROMOTIONS_FETCH_SUCCESS: function (t) {
        let { applicationIds: e, promotions: i } = t,
            r = Date.now(),
            l = { ...d };
        for (let t of e) l[t] = { state: "success", promotions: [], fetchedAt: r };
        for (let t of i) {
            let e = t.applicationId;
            l[e]?.state === "success" && l[e].promotions.push(t);
        }
        d = l;
    },
...
async function T(t, e) {
    ...
    try {
        ...
        s.h.dispatch({ type: "SKUS_PRICING_FETCH_SUCCESS", priceId: o, data: (0, p.Oj)(t) });
    } catch {
