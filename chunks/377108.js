...
class c extends o.C {
    ...
    internalBinaryWrite(e, t, n) {
        e.versions && s.L.internalBinaryWrite(e.versions, t.tag(1, r.TD.LengthDelimited).fork(), n).join(),
            e.favoriteGifs && f.internalBinaryWrite(e.favoriteGifs, t.tag(2, r.TD.LengthDelimited).fork(), n).join(),
            e.favoriteStickers &&
                h.internalBinaryWrite(e.favoriteStickers, t.tag(3, r.TD.LengthDelimited).fork(), n).join(),
            e.stickerFrecency &&
                E.internalBinaryWrite(e.stickerFrecency, t.tag(4, r.TD.LengthDelimited).fork(), n).join(),
            e.favoriteEmojis &&
                y.internalBinaryWrite(e.favoriteEmojis, t.tag(5, r.TD.LengthDelimited).fork(), n).join(),
            e.emojiFrecency && v.internalBinaryWrite(e.emojiFrecency, t.tag(6, r.TD.LengthDelimited).fork(), n).join(),
            e.applicationCommandFrecency &&
                I.internalBinaryWrite(e.applicationCommandFrecency, t.tag(7, r.TD.LengthDelimited).fork(), n).join(),
            ...
            e.heardSoundFrecency &&
                R.internalBinaryWrite(e.heardSoundFrecency, t.tag(10, r.TD.LengthDelimited).fork(), n).join(),
            e.playedSoundFrecency &&
                w.internalBinaryWrite(e.playedSoundFrecency, t.tag(11, r.TD.LengthDelimited).fork(), n).join(),
            e.guildAndChannelFrecency &&
                M.internalBinaryWrite(e.guildAndChannelFrecency, t.tag(12, r.TD.LengthDelimited).fork(), n).join(),
...
class d extends o.C {
    ...
    internalBinaryWrite(e, t, n) {
        for (let i of Object.keys(e.gifs))
            t.tag(1, r.TD.LengthDelimited).fork().tag(1, r.TD.LengthDelimited).string(i),
...
class p extends o.C {
    ...
    internalBinaryWrite(e, t, n) {
        0 !== e.format && t.tag(1, r.TD.Varint).int32(e.format),
            "" !== e.src && t.tag(2, r.TD.LengthDelimited).string(e.src),
            0 !== e.width && t.tag(3, r.TD.Varint).uint32(e.width),
            0 !== e.height && t.tag(4, r.TD.Varint).uint32(e.height),
            0 !== e.order && t.tag(5, r.TD.Varint).uint32(e.order);
        let i = n.writeUnknownFields;
        return !1 !== i && (!0 == i ? r.z.onWrite : i)(this.typeName, e, t), t;
    }
    constructor() {
    ...
    internalBinaryWrite(e, t, n) {
        for (let i of Object.keys(e.stickers))
            t.tag(1, r.TD.LengthDelimited).fork().tag(1, r.TD.Bit64).fixed64(i),
                t.tag(2, r.TD.LengthDelimited).fork(),
                A.internalBinaryWrite(e.stickers[i], t, n),
                t.join().join();
        let i = n.writeUnknownFields;
        return !1 !== i && (!0 == i ? r.z.onWrite : i)(this.typeName, e, t), t;
    }
...
class O extends o.C {
    ...
    internalBinaryWrite(e, t, n) {
        for (let i of Object.keys(e.emojis))
            t.tag(1, r.TD.LengthDelimited).fork().tag(1, r.TD.LengthDelimited).string(i),
                t.tag(2, r.TD.LengthDelimited).fork(),
                A.internalBinaryWrite(e.emojis[i], t, n),
                t.join().join();
        let i = n.writeUnknownFields;
        return !1 !== i && (!0 == i ? r.z.onWrite : i)(this.typeName, e, t), t;
    }
...
class S extends o.C {
    ...
    internalBinaryWrite(e, t, n) {
        for (let i of Object.keys(e.applicationCommands))
            t.tag(1, r.TD.LengthDelimited).fork().tag(1, r.TD.LengthDelimited).string(i),
                t.tag(2, r.TD.LengthDelimited).fork(),
                A.internalBinaryWrite(e.applicationCommands[i], t, n),
                t.join().join();
        let i = n.writeUnknownFields;
        return !1 !== i && (!0 == i ? r.z.onWrite : i)(this.typeName, e, t), t;
    }
...
class T extends o.C {
    ...
    internalBinaryWrite(e, t, n) {
        ...
        0 !== e.frecency && t.tag(3, r.TD.Varint).int32(e.frecency),
            0 !== e.score && t.tag(4, r.TD.Varint).int32(e.score);
        let i = n.writeUnknownFields;
        return !1 !== i && (!0 == i ? r.z.onWrite : i)(this.typeName, e, t), t;
    }
    constructor() {
...
class P extends o.C {
    ...
    internalBinaryWrite(e, t, n) {
        for (let i of Object.keys(e.heardSounds))
            t.tag(1, r.TD.LengthDelimited).fork().tag(1, r.TD.LengthDelimited).string(i),
                t.tag(2, r.TD.LengthDelimited).fork(),
                A.internalBinaryWrite(e.heardSounds[i], t, n),
                t.join().join();
        let i = n.writeUnknownFields;
        return !1 !== i && (!0 == i ? r.z.onWrite : i)(this.typeName, e, t), t;
    }
...
class D extends o.C {
    ...
    internalBinaryWrite(e, t, n) {
        for (let i of Object.keys(e.playedSounds))
            t.tag(1, r.TD.LengthDelimited).fork().tag(1, r.TD.LengthDelimited).string(i),
                t.tag(2, r.TD.LengthDelimited).fork(),
                A.internalBinaryWrite(e.playedSounds[i], t, n),
                t.join().join();
        let i = n.writeUnknownFields;
        return !1 !== i && (!0 == i ? r.z.onWrite : i)(this.typeName, e, t), t;
    }
...
class x extends o.C {
    ...
    internalBinaryWrite(e, t, n) {
        for (let i of Object.keys(e.applications))
            t.tag(1, r.TD.LengthDelimited).fork().tag(1, r.TD.LengthDelimited).string(i),
                t.tag(2, r.TD.LengthDelimited).fork(),
                A.internalBinaryWrite(e.applications[i], t, n),
                t.join().join();
        let i = n.writeUnknownFields;
        return !1 !== i && (!0 == i ? r.z.onWrite : i)(this.typeName, e, t), t;
    }
...
class j extends o.C {
    ...
    internalBinaryWrite(e, t, n) {
        for (let i of Object.keys(e.guildAndChannels))
            t.tag(1, r.TD.LengthDelimited).fork().tag(1, r.TD.Bit64).fixed64(i),
                t.tag(2, r.TD.LengthDelimited).fork(),
                A.internalBinaryWrite(e.guildAndChannels[i], t, n),
                t.join().join();
        let i = n.writeUnknownFields;
        return !1 !== i && (!0 == i ? r.z.onWrite : i)(this.typeName, e, t), t;
    }
