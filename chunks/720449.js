...
var a = n(913527),
    ...
    c = n(981631);
function d(e) {
    let { text: t, emojiInfo: n, clearAfter: a, analyticsContext: d, createdAtMs: m, prompt: f, customStatusLabel: h } = e,
        p = t.trim();
    if (!(p.length > 0) && null == n) return i.Ok.updateSetting(void 0);
    {
        let e = i.Ok.updateSetting({
            ...
            label: null != h ? l.Gm.create({ value: h }) : void 0
        });
        return (
