...
async function m(e, t) {
    let n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2],
        ...
        h = u?.pid != null ? s.default.getTrackedGameByPid(u?.pid) : null,
        m = h?.source ?? null,
        g = h?.overlayMethod ?? s.default.getRenderMethod(u?.pid) ?? null,
        E = {
            overlay_game_source: m,
            overlay_game_name: null != l ? l.name : "Unknown Game",
            overlay_app_id: null != l ? l.id : null,
            overlay_render_method: null != g ? a.Ue[g] : null,
    ...
    switch ((__OVERLAY__ && (E.overlay_render_method = a.Ue[a.Ue.Hook]), (t = { ...E, ...t }), e)) {
