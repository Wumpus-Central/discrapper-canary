...
let C = {
    ...
    completeOnboarding(e, t) {
        let n = t.length > 0 ? t[t.length - 1] : null,
            ...
            [d, f] = (0, S._N)(e, t, o),
            A = [...a, ...o],
            C = A.map((e) => E.A.getChannel(e)).filter(g.Vq),
            b = (0, y.w)(e, new Set(A), C, !0).length,
        ...
        if (
            (m.default.track(N.HAw.GUILD_ONBOARDING_STEP_COMPLETED, {
                ...
                channels_granted: b,
                guild_onboarding_covered_channel_ids: d.map((e) => e.id),
            ...
            (0, l.hK)(e, R.P.GUILD_ONBOARDING_QUESTION, I.default.fromTimestamp(Date.now())),
            v(e, !0),
            _.A.isFullServerPreview(e))
        ) {
            (0, c.$u)(e, A, []), (0, c.Z$)(e, { optInEnabled: !0 }), (0, c.ID)(e, Array.from(i));
            let t = p.default.getCurrentUser();
            if (null != t) {
                let n = h.Ay.getMember(e, t.id)?.flags ?? 0;
                (0, c.Z$)(e, { memberOptions: { flags: (0, s.lA)(n, O.D.COMPLETED_ONBOARDING, !0) } });
            }
        }
    },
    ...
    async resetOnboarding(e) {
        ...
        if (null != t) {
            let n = h.Ay.getMember(e, t.id)?.flags ?? 0;
            await (0, d.T)(e, { flags: (0, s.lA)(n, O.D.COMPLETED_ONBOARDING, !1) });
        }
    },
};
