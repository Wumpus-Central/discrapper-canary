...
function W(e) {
    ...
    if (((w = null), !L.clipsSettings.clipsEnabled)) return !1;
    N = {
        applicationName: t,
        newClipIds: [],
        ended: !1
...
function q(e) {
    let { streamKey: t } = e;
    if (((R = null), (P[t] = []), null == N || (0, l.my)(t).ownerId !== c.default.getId())) return !1;
