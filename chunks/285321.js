...
t.r(i),
    t.d(i, {
        ...
        AnnouncementsSpoilerIcon: () => Q.u,
        AnnouncementsWarningIcon: () => X.M,
        AppleBrandLightIcon: () => Y,
        AppleNeutralIcon: () => $.z,
        AppsIcon: () => ee.k,
        ArrowAngleDownLeftIcon: () => el,
        ArrowAngleLeftDownIcon: () => et,
        ArrowAngleLeftUpIcon: () => ea.W,
        ArrowAngleRightDownIcon: () => es,
        ArrowAngleRightUpIcon: () => ei.t,
        ArrowAngleUpLeftIcon: () => eh,
        ArrowLargeDownIcon: () => ec,
        ArrowLargeLeftIcon: () => en.Z,
        ArrowLargeRightIcon: () => eo.K,
        ArrowLargeUpIcon: () => er.D,
        ArrowSmallDownIcon: () => ev.M,
        ArrowSmallLeftIcon: () => eg.r,
        ArrowSmallRightIcon: () => ep.E,
        ArrowSmallUpIcon: () => em.z,
        ArrowsLeftRightIcon: () => ed,
        ArrowsUpDownIcon: () => ew.J,
        AsteriskIcon: () => ef,
        AtIcon: () => ex.X,
        AttachmentIcon: () => eA.P,
        BIcon: () => eC,
        ...
        BadgeIcon: () => eI.b,
        BankIcon: () => eM.M,
        BattlenetBrandIcon: () => eZ,
        BattlenetNeutralIcon: () => e_.a,
        BeakerIcon: () => eE.c,
        BellIcon: () => eT.X,
        BellSlashIcon: () => eN.a,
        BellZIcon: () => ej.R,
        ...
        BookCheckIcon: () => eS.B,
        BookmarkIcon: () => eF.c,
        BookmarkOutlineIcon: () => eU.c,
        BoostGemIcon: () => eP._,
        BoostGemOutlineIcon: () => eb.Q,
        BoostGemSlashIcon: () => eD.x,
        BoostTier1Icon: () => ek,
        BoostTier1SimpleIcon: () => eJ.E,
        BoostTier2Icon: () => eG.d,
        BoostTier2SimpleIcon: () => eW.v,
        BoostTier3Icon: () => eq._,
        BoostTier3SimpleIcon: () => ez.q,
        BrowserCheckeredIcon: () => eK.O,
        BrowserIcon: () => eQ.W,
        BrowserLinkIcon: () => eX,
        BrowserPlusIcon: () => eY.q,
        BrowserQuestionMarkIcon: () => e$,
        BugIcon: () => e1.Q,
        BurgerIcon: () => e0.L,
        CalendarIcon: () => e2.C,
        CalendarMinusIcon: () => e3,
        ...
        CarIcon: () => le.A,
        ChannelListIcon: () => ll.$,
        ChannelListMagnifyingGlassIcon: () => lt.k,
        ChannelListMinusIcon: () => la,
        ChannelListPlusIcon: () => ls.f,
        ChannelListRetryIcon: () => li,
        ChannelNotificationIcon: () => lh,
        ChannelsFollowedIcon: () => lc._,
        ChatArrowRightIcon: () => ln.t,
        ChatCheckIcon: () => lo.M,
        ChatDotsIcon: () => lr,
        ChatEyeIcon: () => ld,
        ChatIcon: () => lv.o,
        ChatMarkUnreadIcon: () => lg.Q,
        ChatMinusIcon: () => lp,
        ChatPlusIcon: () => lm.g,
        ChatRetryIcon: () => lw,
        ChatShieldIcon: () => lf,
        ...
        ChatSmileIcon: () => lA.S,
        ChatSpeakIcon: () => lu._,
        ChatWarningIcon: () => lI.E,
        ChatXIcon: () => lM._,
        CheckmarkLargeBoldIcon: () => lZ.r,
        CheckmarkLargeIcon: () => l_.A,
        CheckmarkSmallBoldIcon: () => lE.B,
        CheckmarkSmallIcon: () => lT.U,
        ChevronLargeDownIcon: () => lN.g,
        ChevronLargeLeftIcon: () => lj.f,
        ChevronLargeRightIcon: () => lC.u,
        ChevronLargeUpIcon: () => lR.j,
        ChevronSmallDownIcon: () => lV.a,
        ChevronSmallLeftIcon: () => ly.n,
        ChevronSmallRightIcon: () => lO._,
        ChevronSmallUpIcon: () => lH.t,
        CircleCheckIcon: () => lL.y,
        CircleErrorIcon: () => lB.E,
        CircleInformationIcon: () => lS.m,
        CircleMinusIcon: () => lF,
        CirclePlayIcon: () => lU.S,
        CirclePlusIcon: () => lP.U,
        CircleQuestionIcon: () => lb.c,
        CircleXIcon: () => lD.a,
        ClapperboardIcon: () => lk,
        ClipboardCheckIcon: () => lJ.O,
        ClipboardListIcon: () => lG.s,
        ClipsGalleryIcon: () => lW.T,
        ClipsIcon: () => lq.x,
        ClockIcon: () => lz.O,
        ClockWarningIcon: () => lK.g,
        ClockXIcon: () => lQ.O,
        ClosedCaptionsIcon: () => lX,
        ClosedCaptionsOutlineIcon: () => lY,
        CloudDownloadIcon: () => l$,
        CloudIcon: () => l1.h,
        ClydeIcon: () => l0.p,
        CollapseListIcon: () => l2,
        ...
        CropIcon: () => tl,
        CrownIcon: () => tt.p,
        CrunchyrollBrandLightIcon: () => ta,
        CrunchyrollNeutralIcon: () => ts.k,
        DenyIcon: () => ti.K,
        DiceIcon: () => th.j,
        DoorEnterIcon: () => tc.I,
        DoorExitIcon: () => tn.o,
        DoubleCheckmarkIcon: () => to.i,
        DoubleChevronSmallLeftIcon: () => tr,
        DoubleChevronSmallRightIcon: () => td,
        DownloadIcon: () => tv.s,
        DpadIcon: () => tg.L,
        DragIcon: () => tp.W,
        DyingRoseIcon: () => tm.e,
        ...
        EmoIcon: () => tx,
        EnvelopeIcon: () => E.u,
        EpicGamesBrandDarkIcon: () => tA,
        EpicGamesNeutralIcon: () => tu.r,
        ExpandGifIcon: () => tI,
        ExperimentalCheckpointIcon: () => tM,
        ExperimentalConfettiIcon: () => tZ._,
        ExperimentalCreateEmojiIcon: () => t_,
        ExperimentalGameControllerLinkIcon: () => tE.A,
        ExperimentalLootboxIcon: () => tT,
        ExperimentalMicrophoneSparkleIcon: () => tN,
        ExperimentalMicrophoneSparkleMutedIcon: () => tj,
        ExperimentalPineappleHouseIcon: () => tC,
        ExperimentalSnowflakeIcon: () => tR,
        EyeDropperIcon: () => tV.d,
        EyeIcon: () => ty.b,
        EyePlusIcon: () => tO.v,
        EyeSlashIcon: () => tH.G,
        ...
        ForumIcon: () => tX.b,
        ForumLockIcon: () => tY.Q,
        ForumSpoilerIcon: () => t$.H,
        ForumWarningIcon: () => t1.f,
        FriendsIcon: () => M.$,
        FullscreenEnterIcon: () => t0.T,
        FullscreenExitIcon: () => t2.z,
        GameControllerIcon: () => t3._,
        GifIcon: () => t4.O,
        GiftIcon: () => t5.o,
        GlobeEarthIcon: () => t6.L,
        ...
        HammerRetryIcon: () => an,
        HammerXIcon: () => ao,
        HandRequestDenyIcon: () => ar._,
        HandRequestSpeakIcon: () => ad.E,
        HandRequestSpeakListIcon: () => av.c,
        HashmarkIcon: () => ag,
        HdIcon: () => ap,
        HeadphonesDenyIcon: () => am.T,
        HeadphonesIcon: () => aw.L,
        HeadphonesSlashIcon: () => af.c,
        HeartIcon: () => ax.C,
        HeartOutlineIcon: () => aA.y,
        HomeIcon: () => au.f,
        HomeSlashIcon: () => aI,
        HourglassIcon: () => aM.Q,
        HubIcon: () => aZ.P,
        ...
        KeyboardIcon: () => aU.F,
        LanguageIcon: () => ab.U,
        LaptopPhoneIcon: () => aD.W,
        LeagueOfLegendsBrandIcon: () => ak,
        LettersIcon: () => aJ,
        LightbulbIcon: () => aG.x,
        LinkExternalMediumIcon: () => aW.W,
        LinkExternalSmallIcon: () => aq.I,
        LinkIcon: () => az.q,
        LinkPlusIcon: () => aK,
        LinkshellIcon: () => aQ,
        ListBulletsIcon: () => aX.j,
        ListNumberedIcon: () => aY,
        ListViewIcon: () => a$.p,
        LocationIcon: () => a1.B,
        LockIcon: () => a0.X,
        LockUnlockedIcon: () => a2.w,
        MagicDoorIcon: () => a3.f,
        MagicWandIcon: () => a4.D,
        ...
        MedalIcon: () => st,
        MenuIcon: () => sa.Z,
        MicrophoneArrowRightIcon: () => ss.L,
        MicrophoneDenyIcon: () => si.O,
        MicrophoneIcon: () => sh.c,
        MicrophoneSlashIcon: () => sc.z,
        MicrophoneWarningIcon: () => sn,
        MinecraftBrandIcon: () => so,
        MinecraftNeutralIcon: () => sr.m,
        MinimizeIcon: () => sd.g,
        MinusIcon: () => sv.Q,
        MobilePhoneControllerIcon: () => sg.q,
        MobilePhoneIcon: () => sp.u,
        MobilePhonePlusIcon: () => sm,
        MobilePhoneSettingsIcon: () => sw,
        MobilePhoneShareIcon: () => sf,
        MobilePhoneSpeakerIcon: () => sx,
        MobilePhoneVideoIcon: () => sA,
        MobilePhoneXIcon: () => su,
        ModerationIcon: () => sI.q,
        MoreHorizontalIcon: () => sM.j,
        MoreVerticalIcon: () => sZ.F,
        MusicIcon: () => s_.T,
        MusicSlashIcon: () => sE.C,
        NatureIcon: () => sT.p,
        NearbyScanIcon: () => sN,
        ...
        NintendoSwitchNeutralIcon: () => sR.M,
        NitroWheelIcon: () => sV.t,
        ObjectIcon: () => sy.D,
        OrbsIcon: () => sO.C,
        PaintPaletteIcon: () => sD.B,
        ...
        PaintbrushThinPlusIcon: () => sP,
        PaintbrushThinRetryIcon: () => sb,
        PaperClockIcon: () => sk,
        PaperIcon: () => sJ.u,
        PaperLockIcon: () => sG,
        PaperPlusIcon: () => sW.i,
        PauseIcon: () => sq.E,
        PawPrintIcon: () => sz.N,
        PaymentTypeAmericanExpressIcon: () => sK,
        PaymentTypeApplePayIcon: () => sQ,
        PaymentTypeAthIcon: () => sX,
        PaymentTypeBancontactIcon: () => sY,
        PaymentTypeBcCardIcon: () => s$,
        PaymentTypeBoletoIcon: () => s1,
        PaymentTypeCartesBancairesIcon: () => s0,
        PaymentTypeCashAppIcon: () => s2,
        PaymentTypeDinaCardIcon: () => s3,
        ...
        PaymentTypeInteracIcon: () => ih,
        PaymentTypeJcbIcon: () => ic,
        PaymentTypeKakaoPayIcon: () => io,
        PaymentTypeKlarnaIcon: () => ir,
        PaymentTypeKookminBankIcon: () => id,
        PaymentTypeMaestroIcon: () => iv,
        PaymentTypeMastercardIcon: () => ig,
        PaymentTypeMoMoWalletIcon: () => ip,
        PaymentTypeMultibancoIcon: () => im,
        PaymentTypePayPalIcon: () => iw,
        PaymentTypePaysafeCardIcon: () => ix,
        PaymentTypePrzelewy24Icon: () => iA,
        PaymentTypeUnionPayIcon: () => iu,
        PaymentTypeVenmoIcon: () => iI,
        PaymentTypeVisaIcon: () => iM,
        PencilIcon: () => iZ.R,
        PencilSparkleIcon: () => i_.Z,
        PhoneCallIcon: () => iE._,
        PhoneHangUpIcon: () => iT.z,
        PhoneIcon: () => iN.E,
        PiggyBankIcon: () => ij.m,
        PinIcon: () => iC.t,
        PinUprightIcon: () => iR.q,
        ...
        PollsIcon: () => iU.Y,
        PotionIcon: () => iP.H,
        PrivacyAndSafetyIcon: () => ib,
        PuzzlePieceIcon: () => iD,
        PuzzlePieceMinusIcon: () => ik,
        PuzzlePiecePlusIcon: () => iJ,
        PuzzlePieceRetryIcon: () => iG,
        QrCodeIcon: () => iW.y,
        QuestsIcon: () => iq.r,
        QuoteIcon: () => iz.c,
        ReactionIcon: () => iK.n,
        ReactionMinusIcon: () => iQ.t,
        ReactionPlusIcon: () => iX,
        ReceiptIcon: () => iY.K,
        RecordPlayerIcon: () => i$.Y,
        RedditNeutralIcon: () => i1.T,
        RedoIcon: () => i0,
        RefreshIcon: () => i2.f,
        RemixIcon: () => i3,
        ...
        RobloxNeutralIcon: () => he.H,
        RobotIcon: () => hl.C,
        RotateIcon: () => ht.H,
        ScienceIcon: () => ha.g,
        ScreenArrowIcon: () => hs.F,
        ScreenIcon: () => hi.k,
        ScreenSlashIcon: () => hh.n,
        ScreenStreamIcon: () => hc.o,
        ScreenSystemRequirementsIcon: () => hn.v,
        ScreenXIcon: () => ho.G,
        SendMessageIcon: () => hr.l,
        ServerGridIcon: () => hd.B,
        ServerIcon: () => hv.R,
        SettingsArrowUpIcon: () => hg,
        SettingsCircleIcon: () => hp,
        SettingsIcon: () => hm.Z,
        SettingsInfoIcon: () => hw.H,
        SettingsPlusIcon: () => hf,
        ShareIcon: () => hx.l,
        ShieldAtIcon: () => hA.E,
        ShieldIcon: () => hu.l,
        ...
        ShopMinusIcon: () => hE,
        ShopPlusIcon: () => hT,
        ShopSparkleIcon: () => hN.U,
        SignPostIcon: () => hj.Z,
        SkipBackwardIcon: () => hC.q,
        SkipForwardIcon: () => hR.i,
        SkullIcon: () => hV.V,
        SlashBoxIcon: () => hy.k,
        SlashIcon: () => hO.F,
        SlashMinusIcon: () => hH,
        ...
        SlashRetryIcon: () => hB,
        SoundboardIcon: () => hS.J,
        SoundboardSlashIcon: () => hF,
        SparklesIcon: () => hU.B,
        SpeedometerIcon: () => hP.$,
        SpoilerIcon: () => hb,
        SpotifyBrandIcon: () => hD,
        SpotifyNeutralIcon: () => hk.L,
        StaffBadgeIcon: () => hJ.V,
        StageIcon: () => hG.q,
        StageListIcon: () => hW,
        StageLockIcon: () => hq.D,
        StageMinusIcon: () => hz,
        StageModeratorIcon: () => hK,
        StagePlusIcon: () => hQ,
        StageRetryIcon: () => hX,
        StageXIcon: () => hY,
        StampIcon: () => h$.L,
        StampXIcon: () => h1.$,
        StarIcon: () => h0.G,
        StarOutlineIcon: () => h2.y,
        StarShootingIcon: () => h3.f,
        SteamBrandDarkIcon: () => h4,
        SteamBrandLightIcon: () => h5,
        SteamNeutralIcon: () => h6.N,
        StickerDeadIcon: () => h7,
        StickerIcon: () => h8.t,
        StickerMinusIcon: () => h9,
        StickerPlusIcon: () => ce,
        StickerRetryIcon: () => cl,
        StickerSadIcon: () => ct.d,
        StickerSmallIcon: () => ca.s,
        StickerWink1Icon: () => cs,
        StickerWink2Icon: () => ci,
        StopIcon: () => ch.w,
        StrikethroughIcon: () => cc.t,
        SubscriptionIcon: () => cn.L,
        SuperReactionIcon: () => co.i,
        TagIcon: () => cr.g,
        TagsIcon: () => cd,
        TeacupIcon: () => cv.C,
        TextControllerIcon: () => cg.x,
        TextIcon: () => cp.N,
        TextLockIcon: () => cm.I,
        TextSpoilerIcon: () => cw.n,
        TextUserIcon: () => cf,
        TextWarningIcon: () => cx.r,
        ThemeDarkIcon: () => cA.Z,
        ThemeGrayIcon: () => cu,
        ThemeLightIcon: () => cI.F,
        ThemeMidnightIcon: () => cM.L,
        ThreadIcon: () => cZ.y,
        ThreadLockIcon: () => c_.t,
        ThreadMinusIcon: () => cE,
        ThreadPlusIcon: () => cT.G,
        ThreadRetryIcon: () => cN,
        ThreadWarningIcon: () => cj.m,
        ThumbsDownIcon: () => cC.d,
        ThumbsUpIcon: () => cR.G,
        TicketIcon: () => cV.q,
        TiktokNeutralIcon: () => cy.X,
        TimerIcon: () => cO.x,
        TopicsIcon: () => cH.K,
        TrainIcon: () => cL.E,
        TranscriptIcon: () => cB,
        TranscriptOutlineIcon: () => cS,
        TrashIcon: () => cF.u,
        TreehouseIcon: () => cU.c,
        TrophyIcon: () => cP.O,
        TvIcon: () => cb.U,
        TwitchNeutralIcon: () => cD.a,
        TwitterNeutralIcon: () => ck,
        UnderlineIcon: () => cJ,
        UndoIcon: () => cG.e,
        UnknownGameIcon: () => cW._,
        UnsendIcon: () => cq.n,
        UploadIcon: () => cz.J,
        UserArrowDiagonalBottomRightIcon: () => cK,
        UserCheckIcon: () => cQ.V,
        UserCircleIcon: () => cX.r,
        UserCircleStatusIcon: () => cY.n,
        UserClockIcon: () => c$.l,
        UserIcon: () => c1.n,
        UserMinusIcon: () => c0.N,
        UserPlatformIcon: () => c2._,
        UserPlayIcon: () => c3.J,
        UserPlusIcon: () => c4.R,
        UserRetryIcon: () => c5,
        UserSquareIcon: () => c6.c,
        ...
        VideoLockIcon: () => nl.k,
        VideoSlashIcon: () => nt.O,
        ViewReactionIcon: () => na.S,
        VoiceBluetoothIcon: () => ns,
        VoiceLockIcon: () => ni.t,
        VoiceLowIcon: () => nh.S,
        VoiceNormalIcon: () => nc.H,
        VoiceNormalSpoilerIcon: () => nn.P,
        VoiceWarningIcon: () => no.O,
        VoiceXIcon: () => nr._,
        VrHeadsetIcon: () => nd.G,
        WalletIcon: () => nv,
        WarningIcon: () => ng.i,
        WaveformIcon: () => np,
        WaveformSlashIcon: () => nm.m,
        WebhookIcon: () => nw.X,
        WebhookPlusIcon: () => nf,
        WidgetsIcon: () => nx,
        WidgetsMinusIcon: () => nA,
        WidgetsPlusIcon: () => nu.X,
        WidgetsRetryIcon: () => nI,
        WindowLaunchIcon: () => nM.t,
        WindowReturnIcon: () => nZ._,
        WindowTopIcon: () => n_,
        WindowTopOutlineIcon: () => nE.l,
        WrenchIcon: () => nT.P,
        XLargeBoldIcon: () => nj.U,
        XLargeIcon: () => nC.d,
        XNeutralIcon: () => nR.p,
        ...
        XXsmallBoldIcon: () => ny,
        XXsmallIcon: () => nO,
        XboxNeutralIcon: () => nN.Y,
        YoutubeNeutralIcon: () => nH.C,
    }),
    t(321073);
var h = t(627968),
    c = t(64700),
...
var z = t(778492),
    ...
    X = t(922288);
let Y = (e) => {
    let { size: l = "md", width: t, height: a, color: s = w.A.colors.ICON_OVERLAY_LIGHT, colorClass: i = "", ...c } = e,
        n = (0, P.J)(l),
        o = n?.width ?? t,
        r = n?.height ?? a;
    return (0, h.jsx)("svg", {
...
let lF = (e) => {
    let {
            ...
            color: c = w.A.colors.INTERACTIVE_ICON_DEFAULT,
            colorClass: n = "",
            ...o
        } = e,
        r = (0, P.J)(l),
    ...
    return (0, h.jsxs)("svg", {
        ...
        viewBox: "0 0 24 24",
        children: [
            (0, h.jsx)("circle", { cx: "12", cy: "12", r: "10", fill: "string" == typeof s ? s : s.css, className: i }),
            (0, h.jsx)("path", {
...
let a8 = (e) => {
    ...
    a9 = (e) => {
        let {
                ...
                width: t,
                height: a,
                color: s = w.A.colors.ICON_OVERLAY_DARK,
                colorClass: i = "",
                ...c
            } = e,
            n = (0, P.J)(l),
...
let sn = (e) => {
    ...
    so = (e) => {
        ...
        return (0, h.jsxs)("svg", {
            ...
            viewBox: "0 0 24 24",
            children: [
                (0, h.jsx)("path", { fill: "string" == typeof s ? s : s.css, d: "M22 2H2v20h20V2Z", className: i }),
                (0, h.jsx)("path", {
                    fill: "string" == typeof c ? c : c.css,
                    d: "M18 10V6h-4v4h-4v2H8v6h2v-2h4v2h2v-6h-2v-2h4Z",
                    className: n,
                }),
                (0, h.jsx)("path", { fill: "string" == typeof c ? c : c.css, d: "M10 6H6v4h4V6Z", className: n }),
                (0, h.jsx)("path", {
...
let sK = (e) => {
        ...
        return (0, h.jsxs)("svg", {
            ...
            children: [
                ...
                (0, h.jsx)("path", { fill: "#fff", d: "m15.14 8.53.25-.58.25.58.5 1.2h-1.45l.45-1.2Z" }),
                (0, h.jsx)("path", {
                    fill: "#fff",
                    fillRule: "evenodd",
    ...
    sY = (e) => {
        ...
        return (0, h.jsxs)("svg", {
            ...
            children: [
                ...
                (0, h.jsx)("path", { fill: "url(#b)", d: "M7.21 13.5c2.43 0 3.65-1.63 4.87-3.25H4v3.24h3.21Z" }),
                (0, h.jsx)("path", { fill: "url(#c)", d: "M16.95 7c-2.44 0-3.65 1.62-4.87 3.25h8.08V7h-3.21Z" }),
                (0, h.jsxs)("defs", {
                    children: [
                        (0, h.jsxs)("linearGradient", {
                            id: "b",
                            x1: "7.27",
                            x2: "19.99",
                            y1: "12.48",
                            ...
                            children: [
                                (0, h.jsx)("stop", { stopColor: "#005AB9" }),
                                (0, h.jsx)("stop", { offset: "1", stopColor: "#1E3764" }),
                            ],
                        }),
                        (0, h.jsxs)("linearGradient", {
                            id: "c",
                            ...
                            gradientUnits: "userSpaceOnUse",
                            children: [
                                (0, h.jsx)("stop", { stopColor: "#FBA900" }),
                                (0, h.jsx)("stop", { offset: "1", stopColor: "#FFD800" }),
                            ],
                        }),
                    ],
                }),
            ...
            children: [
                ...
                (0, h.jsx)("defs", {
                    children: (0, h.jsxs)("linearGradient", {
                        ...
                        gradientUnits: "userSpaceOnUse",
                        children: [
                            (0, h.jsx)("stop", { stopColor: "#102C5E" }),
                            (0, h.jsx)("stop", { offset: ".53", stopColor: "#107B9D" }),
                            (0, h.jsx)("stop", { offset: "1", stopColor: "#219943" }),
                        ],
                    }),
                }),
            ],
    ...
    s5 = (e) => {
        ...
        return (0, h.jsxs)("svg", {
            ...
            children: [
                ...
                (0, h.jsx)("defs", {
                    children: (0, h.jsxs)("radialGradient", {
                        id: "b",
                        cx: "0",
                        cy: "0",
                        r: "1",
                        ...
                        gradientUnits: "userSpaceOnUse",
                        children: [
                            (0, h.jsx)("stop", { stopColor: "#F08F14" }),
                            (0, h.jsx)("stop", { offset: ".8", stopColor: "#E0481E" }),
                            (0, h.jsx)("stop", { offset: "1", stopColor: "#661D14" }),
                        ],
                    }),
                }),
            ],
                ...
                (0, h.jsxs)("defs", {
                    children: [
                        (0, h.jsxs)("linearGradient", {
                            ...
                            gradientUnits: "userSpaceOnUse",
                            children: [
                                (0, h.jsx)("stop", { stopColor: "#007940" }),
                                (0, h.jsx)("stop", { offset: ".23", stopColor: "#00873F" }),
                                (0, h.jsx)("stop", { offset: ".74", stopColor: "#40A737" }),
                                (0, h.jsx)("stop", { offset: "1", stopColor: "#5CB531" }),
                            ],
                        }),
                        (0, h.jsxs)("linearGradient", {
                            id: "c",
                        ...
                        (0, h.jsxs)("linearGradient", {
                            ...
                            gradientUnits: "userSpaceOnUse",
                            children: [
                                (0, h.jsx)("stop", { stopColor: "#1F286F" }),
                                (0, h.jsx)("stop", { offset: ".47", stopColor: "#004E94" }),
                                (0, h.jsx)("stop", { offset: ".83", stopColor: "#0066B1" }),
                                (0, h.jsx)("stop", { offset: "1", stopColor: "#006FBC" }),
                            ],
                        }),
                        (0, h.jsxs)("linearGradient", {
                            id: "f",
                            ...
                            gradientUnits: "userSpaceOnUse",
                            children: [
                                (0, h.jsx)("stop", { stopColor: "#6C2C2F" }),
                                (0, h.jsx)("stop", { offset: ".17", stopColor: "#882730" }),
                                (0, h.jsx)("stop", { offset: ".57", stopColor: "#BE1833" }),
                                (0, h.jsx)("stop", { offset: ".86", stopColor: "#DC0436" }),
                                (0, h.jsx)("stop", { offset: "1", stopColor: "#E60039" }),
                            ],
                        }),
                    ],
                }),
        ...
        return (0, h.jsxs)("svg", {
            ...
            children: [
                ...
                (0, h.jsxs)("mask", {
                    ...
                    children: [
                        (0, h.jsx)("path", { fill: "#fff", d: "M2 8h20v8H2z" }),
                        (0, h.jsx)("path", {
    ...
    iv = (e) => {
        ...
        return (0, h.jsxs)("svg", {
            ...
            children: [
                ...
                (0, h.jsx)("path", { fill: "#7375CF", d: "M14.16 8.06H9.84v7.77h4.32V8.06Z" }),
                (0, h.jsx)("path", {
                    fill: "#EB001B",
    ...
    ig = (e) => {
        ...
        return (0, h.jsxs)("svg", {
            ...
            children: [
                ...
                (0, h.jsx)("path", { fill: "#FF5F00", d: "M14.16 8.06H9.84v7.77h4.32V8.06Z" }),
                (0, h.jsx)("path", {
                    fill: "#EB001B",
...
let hg = (e) => {
    ...
    hp = (e) => {
        let {
                ...
                width: t,
                height: a,
                secondaryColor: s = w.A.colors.ICON_FEEDBACK_NOTIFICATION,
                secondaryColorClass: i = "",
                color: c = w.A.colors.INTERACTIVE_ICON_DEFAULT,
                colorClass: n = "",
                ...o
...
let hZ = (e) => {
    ...
    return (0, h.jsxs)("svg", {
        ...
        viewBox: "0 0 24 24",
        children: [
            (0, h.jsx)("circle", { cx: "19", cy: "19", r: "5", fill: "string" == typeof s ? s : s.css, className: i }),
            (0, h.jsx)("path", {
                fill: "string" == typeof c ? c : c.css,
...
let h4 = (e) => {
    ...
    h5 = (e) => {
        let {
                ...
                width: t,
                height: a,
                color: s = w.A.colors.ICON_OVERLAY_LIGHT,
                colorClass: i = "",
                ...c
            } = e,
            n = (0, P.J)(l),
...
let n$ = (e) => {
    let { displayOptions: l, targetElementRef: t, onRequestClose: a, onClick: s } = e,
        { analyticsLocations: i } = (0, nD.Ay)(nb.A.HOME_PAGE_SHOP_TAB),
        n = (0, nP.Ay)(),
        o = (0, nB.M)(n) ? l.assetDark : l.assetLight,
        r = c.useRef(a);
    return (
        (r.current = a),
        c.useEffect(
        ...
        (0, h.jsx)(nK.A, {
            ...
            actions: [
                {
                    text: nY.intl.string(nY.t.fYfGgK),
                    variant: "primary",
                    onClick: () => {
                        s?.(),
                            (0, nQ.pX)(nX.BVt.COLLECTIBLES_SHOP),
                            (0, nq.Cz)({ analyticsLocations: i, analyticsSource: nb.A.HOME_PAGE_SHOP_TAB });
                    },
                },
            ],
            onRequestClose: a,
...
let n0 = (e) => {
    let { targetElementRef: l, onRequestClose: t, onClick: a } = e,
        { analyticsLocations: s } = (0, nD.Ay)(nb.A.HOME_PAGE_SHOP_TAB),
        i = c.useRef(t);
    return (
        (i.current = t),
        c.useEffect(
        ...
        (0, h.jsx)(nK.A, {
            ...
            align: "top",
            caretConfig: { align: "start" },
            title: nY.intl.string(nY.t.epBu6F),
            body: nY.intl.string(nY.t["o8+3AX"]),
            graphic: {
                type: "image",
            ...
            actions: [
                {
                    text: nY.intl.string(nY.t.dp9qDi),
                    variant: "primary",
                    onClick: () => {
                        a?.(),
                            (0, nq.Cz)({
                                analyticsLocations: s,
                                analyticsSource: nb.A.HOME_PAGE_SHOP_TAB,
                                tab: n1.G2.HOME,
                            });
                    },
                },
...
let n7 = (e) => {
        ...
        return (0, h.jsx)("div", {
            className: n6.newBadge,
            children: (0, h.jsx)(nL.E, {
    ...
    n9 = (e) => {
        let {
            ...
            f = (0, v.rm)("shop"),
            x = nb.A.HOME_PAGE_SHOP_TAB,
            { analyticsLocations: A } = (0, nD.Ay)(x),
            [u, I] = c.useState(!1),
            M = c.useCallback(() => {
                void 0 !== s && s(),
                    void 0 !== i && (0, nq.Cz)({ tab: i, analyticsLocations: A, analyticsSource: x }),
                    I(!0),
                    (0, nq.Sw)({ analyticsSource: x, analyticsLocations: A });
            }, [x, A, s, I, i]),
        ...
        return (0, h.jsxs)(h.Fragment, {
            children: [
                ...
                (0, h.jsx)(V.z9, {
                    ...
                    route: Z,
                    icon: a ?? h_.U,
                    text: nY.intl.string(nY.t.pWG4ze),
                    locationState: t,
                    ...f,
                    ...w,
                    hoverGradientStart: g,
    ...
    oe = (e) => (0, h.jsx)(n9, { ...e, children: (0, h.jsx)(n7, {}) }),
    ol = (e) => {
    ...
    ot = (e) => {
        ...
        let f = c.useCallback(() => {
            ...
            x = c.useCallback(() => {
                n(!1), d(!1), null != g.current && (cancelAnimationFrame(g.current), (g.current = null));
            }, []);
        return (
            c.useEffect(
                () => () => {
            ...
            (0, h.jsx)(nG.A, {
                title: a.title(),
                body: a.body?.() ?? "",
                asset: (0, h.jsx)("img", { src: a.asset, alt: "", "aria-hidden": !0 }),
                children: (0, h.jsxs)(n9, {
                    className: null != a.entryPointClassName ? (0, nW.t)(n6, a.entryPointClassName) : void 0,
                    ...s,
                    ...
                    ...(!0 === a.showHoverGradient && {
                        showHoverGradient: !0,
                        hoverGradientStart: w.A.colors.COLLECTIBLES_TAB_GRADIENT_CENTER,
                        hoverGradientMiddle: w.A.colors.COLLECTIBLES_TAB_GRADIENT_INNER,
                        hoverGradientEnd: w.A.colors.COLLECTIBLES_TAB_GRADIENT_OUTER,
                    }),
                    children: [
                        (0, h.jsx)("div", {
                            ref: v,
                            className: n6.marketingButtonBackgroundNew,
                            style: { background: t },
                            children:
                                null != l &&
                                (0, h.jsx)("img", {
                                    src: l,
                                    className: o()(
                                        n6.marketingButtonBackgroundImage,
                                        r && n6.marketingButtonBackgroundImageFaded,
                                    ),
                                    alt: "",
                                    "aria-hidden": !0,
                                }),
                        }),
                        (0, h.jsx)(n7, { badgeIcon: a.badgeIcon, badgeText: a.badgeText }),
                    ],
                }),
            })
        );
    ...
    oa = (e) => {
        let { displayOptions: l, ...t } = e,
            a = c.useMemo(() => {
                let e = null != l.emojiName ? nJ.Ay.getByName(l.emojiName)?.surrogates : null;
                return (0, h.jsxs)(nS.E, {
                    variant: "text-sm/medium",
                    className: n6.marketingBadgeTooltipContent,
                    children: [null != e && (0, h.jsx)(nU.A, { emojiName: e }), l.title()],
                });
            }, [l]);
        return (0, h.jsx)(nF.ST, {
            "data-migration-pending": !0,
            text: a,
            tooltipClassName: n6.marketingBadgeTooltip,
            position: "right",
            delay: 100,
            hideOnClick: !1,
            "aria-label": l.title(),
            children: (e) =>
                (0, h.jsx)(n9, {
                    ...t,
                    ...e,
                    children: (0, h.jsx)(n7, { badgeIcon: l.badgeIcon, badgeText: l.badgeText }),
                }),
        });
    },
    os = (e) => {
        let { displayOptions: l, dismissContent: t, ...a } = e,
            ...
            w = v ? p?.hovered?.dark : p?.hovered?.light;
        return (
            c.useEffect(() => {
                            ...
                            (0, h.jsx)("div", {
                                ...
                                children:
                                    ...
                                    (0, h.jsx)("img", {
                                        ...
                                        className: o()(
                                            n6.marketingButtonBackgroundImage,
                                            n && n6.marketingButtonBackgroundImageFaded,
                                        ),
                                        alt: "",
                                        "aria-hidden": !0,
                                    }),
                            }),
                            (0, h.jsx)(n7, { badgeIcon: l.badgeIcon, badgeText: l.badgeText }),
                        ],
                    }),
                    (0, h.jsx)(n$, {
                        displayOptions: l,
                        targetElementRef: s,
                        onClick: () => t(n5.i.TAKE_ACTION),
                        onRequestClose: () => t(n5.i.USER_DISMISS),
                    }),
                ],
            })
        );
    ...
    oi = (e) => {
        ...
        return (0, h.jsxs)(h.Fragment, {
            children: [
                (0, h.jsx)(n9, { ...t, onClick: () => l(n5.i.TAKE_ACTION), listItemRef: a }),
                (0, h.jsx)(n0, {
                    targetElementRef: a,
                    onClick: () => l(n5.i.TAKE_ACTION),
                    onRequestClose: () => l(n5.i.USER_DISMISS),
                }),
            ],
        });
    },
    oh = (e) => {
        let { selected: l, onClick: t, locationState: a, listItemRef: s } = e,
            { shopButtonDisplayOptions: i, dismissShopButtonDC: c } = (0, n2.A)(),
            n = !(0, x.hasAnyModalOpen)(),
            [o, r] = (0, nk.kn)(n ? [m.M.WISHLIST_SHOP_BUTTON_POPOVER] : []),
            d = {
                selected: l,
                locationState: a,
                onClick: () => {
        ...
        if (null != i)
            switch (i.type) {
                case n4.FF.TOOLTIP:
                    return (0, h.jsx)(oa, { ...d, displayOptions: i });
                case n4.FF.TAB_TOOLTIP:
                    return (0, h.jsx)(ot, { ...d, displayOptions: i });
                case n4.FF.BADGE:
                    return (0, h.jsx)(oe, { ...d });
                case n4.FF.COACHMARK:
                    return (0, h.jsx)(os, { dismissContent: c, ...d, displayOptions: i });
            }
        return o === m.M.WISHLIST_SHOP_BUTTON_POPOVER
            ? (0, h.jsx)(oi, { ...d, dismissContent: r })
            : (0, h.jsx)(n9, { ...d });
    };
var oc = t(771781),
    on = t(379848),
    ...
    op = t(157550);
function om() {
    return (0, p.bG)([ov.A, op.A], () => (0, og.SM)([ov.A, op.A]));
}
var ow = t(945276),
    of = t(834981),
    ox = t(912309),
...
function oV(e) {
    let { location: l } = e,
        { enabled: t } = oR.useConfig({ location: l });
    return t;
}
var oy = t(398523);
let oO = () => {
        (0, oj.Dr)(m.M.RECURRING_3P_PROMOTION_POPOVER);
    },
    oH = () => {
        let { enabled: e } = oy.Ay.useConfig({ location: "useIsRecurring3PPopoverShowable" }),
            l = oV({ location: "useIsRecurring3PPopoverShowable" }),
            t = (0, oj.k8)(m.M.RECURRING_3P_PROMOTION_POPOVER);
        return e && l && !1 === t;
    };
var oL = t(788868);
let oB = (e) => {
    let { targetElementRef: l } = e,
        t = (0, p.bG)([oE.default], () => oE.default.getCurrentUser()),
        a = !1 === oT.Ay.isPremiumExactly(t, oL.PremiumTypes.TIER_2),
        s =
            t?.premiumState?.premiumSource === oZ.fE.FRACTIONAL_NITRO &&
            t?.premiumState.premiumSubscriptionType !== oZ.jK.TIER_2,
        i = !0 === (null == t || a || s) ? nY.intl.string(nY.t.E1ONHQ) : nY.intl.string(nY.t.CMKNhr);
    return (0, h.jsx)(nK.A, {
        targetElementRef: l,
        title: nY.intl.string(nY.t["V8J+16"]),
        body: i,
        graphic: {
            type: "image",
        ...
        actions: [
            {
                text: nY.intl.string(nY.t["CDdYB/"]),
                onClick: () => {
                    (0, o_.A)(nX.BVt.NITRO_HOME), (0, oN.u)({ analyticsLocations: [nb.A.HOME_PAGE_PREMIUM_TAB] }), oO();
                },
            },
        ],
        onRequestClose: oO,
...
let ob = (e) => {
    let { targetElementRef: l } = e,
        a = (0, oS.Tp)(),
        s = (0, p.bG)([oA.A], () => oA.A.getReminderStateId()),
        i = (0, p.bG)([oA.A], () => oA.A.getReferralsRemaining()),
        c = (0, p.bG)([oF.A], () => {
            let e = oF.A.settings.userContent?.recurringDismissibleContentStates[m.M.REFERRAL_PROGRAM_POPOVER_V2];
    ...
    return (0, h.jsx)(nK.A, {
        targetElementRef: l,
        title: nY.intl.string(nY.t.K2DyeS),
        body: nY.intl.string(nY.t["JICo+3"]),
        graphic: { type: "image", src: oP.A },
        size: "md",
        shouldShow: a,
        align: "top",
        position: "right",
        ...
        actions: [
            {
                text: nY.intl.string(nY.t.t2N81y),
                onClick: () => {
                    oU.default.track(nX.HAw.REFERRAL_PROGRAM_SHARE_MODAL_CTA_CLICKED, {
                        location_stack: [nb.A.HOME_PAGE_PREMIUM_TAB],
...
var oW = t(674567),
    oq = (((a = {})[(a.NONE = 0)] = "NONE"), (a[(a.POPOVER = 1)] = "POPOVER"), (a[(a.TOOLTIP = 2)] = "TOOLTIP"), a),
    oz = t(245853),
    oK = t(654487),
    oQ = t(320118),
    oX = t(909536),
...
function o4(e) {
    let { location: l } = e;
    return o3.useConfig({ location: l });
}
var o5 = t(160761),
    o6 = t(953727),
    o7 = t(774774),
        ...
        children: [
            (0, h.jsx)("defs", {
                children: (0, h.jsxs)("linearGradient", {
                    ...
                    y2: "0%",
                    children: [
                        (0, h.jsx)("stop", { offset: "0%", stopColor: "#8547C6" }),
                        (0, h.jsx)("stop", { offset: "50%", stopColor: "#B845C1" }),
                        (0, h.jsx)("stop", { offset: "100%", stopColor: "#AB5D8A" }),
                    ],
                }),
            }),
            (0, h.jsxs)("linearGradient", {
                ...
                gradientUnits: "userSpaceOnUse",
                children: [
                    (0, h.jsx)("stop", { stopColor: "#8547C6" }),
                    (0, h.jsx)("stop", { offset: "0.52899", stopColor: "#B845C1" }),
                    (0, h.jsx)("stop", { offset: "1", stopColor: "#AB5D8A" }),
                ],
            }),
            (0, h.jsx)("path", {
...
function rt(e) {
    let { className: l, startsAt: t, endsAt: a, messageStyle: s, upperCase: i, showSparkles: c } = e,
        [n] = (0, o5.Bo)(m.M.FRACTIONAL_NITRO_DURATION_LEFT_PILL, {
          ...
          (0, h.jsxs)("div", {
              ...
              children: [
                  c
                      ? (0, h.jsxs)(h.Fragment, {
                            children: [
                                (0, h.jsx)(rl, { foreground: o8.QX, color: `url(#${re})` }),
                                (0, h.jsx)(rl, { foreground: o8.J0, color: `url(#${o9})` }),
                            ],
                        })
                      : null,
                  (0, h.jsx)(o7.e4, {
...
var ra = t(920050),
    ...
    rg = t(303816);
function rp(e) {
    let { componentId: l, badgeCopy: t, acknowledgedBadgeCopy: a, isDismissed: s } = e;
    return ((0, B.A)({
        type: d.ImpressionTypes.VIEW,
        name: d.ImpressionNames.PREMIUM_MARKETING_COMPONENT,
        properties: { component_type: oD.C.PREMIUM_TAB, component_id: l },
    }),
    s)
        ? (0, h.jsxs)("div", {
              className: o()(rg.BE, rg.ZA),
              children: [
                  (0, h.jsx)(lz.O, { size: "custom", width: 10, height: 10, color: "currentColor", className: rg.P0 }),
                  (0, h.jsx)(nS.E, { variant: "eyebrow", color: "text-subtle", children: a }),
              ],
          })
        : (0, h.jsx)("div", {
              className: o()(rg.BE, rg.CU),
              children: (0, h.jsx)(nS.E, { variant: "eyebrow", className: rg.lI, children: t }),
          });
}
var rm = t(84483),
    rw = t(105390),
...
let rx = (e) => {
    let { isSelected: l, discountOffer: t } = e,
        [a, s] = (0, nk.kn)([m.M.CHURN_DISCOUNT_PREMIUM_TAB_BADGE], void 0, !0);
    return (c.useEffect(() => {
        l && a === m.M.CHURN_DISCOUNT_PREMIUM_TAB_BADGE && s(n5.i.TAKE_ACTION);
    }, [l, s, a]),
    a === m.M.CHURN_DISCOUNT_PREMIUM_TAB_BADGE)
        ? (0, h.jsx)(rw.MA, {
              badgeCopy: nY.intl.format(nY.t.AYcXGW, { discountOfferAmount: t.discount.amount }).toString(),
              isTabSelected: l,
              offerExpiresAt: null,
          })
        : (0, h.jsxs)("div", {
              className: o()(rf.bv, rf.Hf),
              children: [
                  (0, h.jsx)(lz.O, { size: "custom", width: 14, height: 14, color: "currentColor", className: rf.aW }),
                  (0, h.jsx)(nS.E, {
                      variant: "eyebrow",
                      color: "text-subtle",
                      children: nY.intl.format(nY.t.AYcXGW, { discountOfferAmount: t.discount.amount }),
                  }),
              ],
          });
};
...
let ru = () => {
    let e = (0, rA.bu)(),
        [l, t] = (0, nk.kn)(null != e ? [m.M.WHATS_NEW_TENURE_BADGE_REWARD] : [], void 0, !0);
    return l === m.M.WHATS_NEW_TENURE_BADGE_REWARD
        ? [nY.intl.string(nY.t["jyYgZ+"]).toLocaleUpperCase(), t]
        : [null, t];
};
var rI = t(989349),
    rM = t.n(rI),
    ...
    return (0, h.jsxs)(h.Fragment, {
        children: [
            ...
            (0, h.jsx)(nK.A, {
                ...
                title: nY.intl.string(r_.default.pdaUSE),
                body: nY.intl.format(r_.default.bsMVNi, { termsLink: (0, rZ.W)() }),
                graphic: {
                    type: "image",
                ...
                actions: [
                    {
                        text: nY.intl.string(nY.t.RzWDqY),
                        variant: "expressive",
                        icon: sV.t,
                        onClick: () => {
                            t(n5.i.TAKE_ACTION), (0, nQ.pX)(nX.BVt.NITRO_HOME);
                        },
                    },
                ],
            }),
...
function rN(e) {
    ...
    return (0, h.jsx)(u.u, {
        ...
        assetSize: 80,
        title: nY.intl.string(r_.default.wqhsP3),
        body: nY.intl.string(r_.default.HCJKFl),
        padding: "lg",
        position: "right",
        asContainer: !0,
        children: l,
...
var rj = t(890687);
let rC =
        "https://cdn.discordapp.com/assets/content/d499eaa867393cbe4b7d560aa82343f68e83dcd1fd55a2f86a1b5aceb420c66a.svg",
    rR = (e) => {
        let { children: l, multiplier: t } = e,
            a = (0, rj.Oq)()
                ? nY.intl.format(nY.t.NpUfej, { bonusOrbMultiplier: t })
                : nY.intl.format(nY.t["G5k+lZ"], { bonusOrbMultiplier: t });
        return (0, h.jsx)(u.u, {
            title: nY.intl.string(nY.t.F2MShO),
            body: a,
            asset: (0, h.jsx)("img", { src: rC, alt: "", "aria-hidden": !0 }),
            assetSize: 80,
            position: "right",
            align: "center",
            asContainer: !0,
...
function rO(e) {
    let { children: l } = e;
    return (0, h.jsx)(u.u, {
        body: nY.intl.format(rV.default.zinfZi, { discountPercent: rr.aW }),
        title: nY.intl.string(rV.default.OlObRa),
        asset: (0, h.jsx)("img", { src: ry.A, alt: "", "aria-hidden": !0, style: { borderRadius: 8 } }),
        assetSize: 80,
        padding: "lg",
        position: "right",
        asContainer: !0,
...
function rb(e) {
    let { targetElementRef: l, dismissPopover: t, children: a } = e,
        { analyticsLocations: s } = (0, nD.Ay)(),
        i = c.useCallback(() => {
            t(n5.i.TAKE_ACTION), (0, rU.A)({ subscriptionTier: oL.pe.TIER_2, analyticsLocations: s });
        }, [t, s]);
    return (0, h.jsxs)(h.Fragment, {
        children: [
            (0, h.jsx)("div", { children: a }),
            (0, h.jsx)(rH.x, {
                ...
                children: (0, h.jsxs)("div", {
                    ...
                    children: [
                        (0, h.jsx)(rS.q, { onClick: () => t(n5.i.USER_DISMISS), variant: "color-mix" }),
                        (0, h.jsx)("div", {
                            className: rP.h,
                        ...
                        (0, h.jsx)(rF.D, {
                            title: nY.intl.string(rV.default.OlObRa),
                            body: nY.intl.format(rV.default["A+56/R"], { discountPercent: rr.aW }),
                            badge: { type: "beta", variant: "expressive" },
                        }),
                        (0, h.jsx)(rL.Z, {
                            actions: [
                                {
                                    text: nY.intl.string(nY.t.pj0XBN),
                                    variant: "primary",
                                    icon: sV.t,
                                    iconPosition: "start",
                                    onClick: i,
...
let rG = (e) => {
    let { targetElementRef: l, dismissPopover: a, children: s } = e,
        i = o4({ location: "nitro_tab_popover" }),
        { analyticsLocations: c } = (0, nD.Ay)(),
        n = i
            ? nY.intl.string(rk.default.oOSj1l)
            : nY.intl.format(rk.default["c+NBSl"], { premiumGroupProductName: (0, rD.DP)() }),
        o = i
            ? nY.intl.string(rk.default.nCLJQn)
            : nY.intl.format(rk.default.MuUV5u, { premiumGroupProductName: (0, rD.DP)(), totalSeats: rD.aw }),
        r = (0, h.jsx)(nK.A, {
            targetElementRef: l,
            title: n,
            body: o,
            graphic: { type: "image", src: rJ },
            badge: { type: "beta", variant: "expressive" },
            gradientColor: "nitro-pink",
            size: "md",
            align: "top",
            ...
            actions: [
                {
                    text: i
                        ? nY.intl.format(rk.default.LwdrNi, { premiumGroupProductName: (0, rD.DP)() })
                        : nY.intl.string(rk.default["IO+nlU"]),
                    variant: i ? "expressive" : "primary",
                    onClick: () => {
                        a(n5.i.TAKE_ACTION),
                            i
                                ? (0, rU.A)({
                                      subscriptionTier: oL.pe.TIER_2,
                                      initialPlanId: oL.gD.PREMIUM_GROUP_MONTH,
                                      analyticsLocations: c,
                                  })
                                : (0, x.openModalLazy)(async () => {
                                      let { default: e } = await t.e("24833").then(t.bind(t, 526710));
                                      return (l) => (0, h.jsx)(e, { ...l });
                                  });
                    },
                    ...(i ? { icon: sV.t, iconPosition: "start" } : {}),
                },
            ],
            onRequestClose: () => a(n5.i.USER_DISMISS),
        });
    return (0, h.jsxs)(h.Fragment, { children: [(0, h.jsx)("div", { children: s }), r] });
};
var rW = t(421438);
function rq(e) {
    ...
    return (0, h.jsx)(u.u, {
        targetElementRef: l,
        asset: (0, h.jsx)("img", { src: rW, alt: "" }),
        title: nY.intl.string(rk.default.aFBQ3d),
        body: nY.intl.string(rk.default.HXu14O),
        padding: "lg",
...
function rX(e) {
    let { targetElementRef: l, dismissPopover: t, children: a } = e,
        s = c.useCallback(() => {
            t(n5.i.TAKE_ACTION), (0, nQ.pX)(`${nX.BVt.NITRO_HOME}?section=${rK.L}`);
        }, [t]),
        i = (0, h.jsx)(nK.A, {
            targetElementRef: l,
            onRequestClose: () => t(n5.i.USER_DISMISS),
            graphic: { type: "rive", rive: rz.Z },
            badge: { type: "beta", variant: "expressive" },
            alignmentStrategy: "edge",
            align: "top",
            position: "right",
            caretConfig: { align: "start" },
            size: "md",
            title: nY.intl.string(rQ.default.UPOlxO),
            body: nY.intl.string(rQ.default.e6r8OX),
            actions: [{ text: nY.intl.string(nY.t.RzWDqY), icon: sV.t, onClick: s }],
            gradientColor: "nitro-pink",
        });
    return (0, h.jsxs)(h.Fragment, { children: [(0, h.jsx)("div", { children: a }), i] });
}
var rY = t(31502);
function r$(e) {
    let { targetElementRef: l, dismissPopover: t, lastGrantedRewardAmount: a, children: s } = e,
        i = c.useCallback(() => {
            t(n5.i.TAKE_ACTION);
            let e = (0, rY.Q)("PremiumOrbRewardsOrbDropPopover")
                ? `${nX.BVt.NITRO_HOME}?perk=${ra.NITRO_ORBS_REWARDS_CARD_ID}`
                : `${nX.BVt.NITRO_HOME}?section=${rK.L}`;
            (0, nQ.pX)(e);
        }, [t]),
        n = (0, h.jsx)(nK.A, {
            targetElementRef: l,
            ...
            caretConfig: { align: "start" },
            size: "md",
            title: nY.intl.string(rQ.default["78+gLr"]),
            body: nY.intl.formatToPlainString(rQ.default.Ry1TXC, { orbsCount: a }),
            actions: [{ text: nY.intl.string(nY.t.RzWDqY), icon: sV.t, onClick: i }],
            gradientColor: "nitro-pink",
        });
    return (0, h.jsxs)(h.Fragment, { children: [(0, h.jsx)("div", { children: s }), n] });
}
function r1(e) {
    let { targetElementRef: l, dismissPopover: t, children: a } = e,
        s = c.useCallback(() => {
        ...
        i = (0, h.jsx)(nK.A, {
            ...
            caretConfig: { align: "start" },
            size: "md",
            title: nY.intl.string(rQ.default["3BI7j6"]),
            body: nY.intl.string(rQ.default.XNHr3C),
            actions: [{ text: nY.intl.string(nY.t.hvVgAZ), onClick: s }],
            gradientColor: "nitro-pink",
        });
    return (0, h.jsxs)(h.Fragment, { children: [(0, h.jsx)("div", { children: a }), i] });
}
...
function r3(e) {
    ...
    return (0, h.jsxs)("div", {
        ...
        children: [
            (0, h.jsx)("div", {
                className: r2.dy,
                children: (0, h.jsx)(r0, { alt: "", "aria-hidden": !0, width: 36, height: 36 }),
            }),
            (0, h.jsx)(nS.E, { variant: "display-lg", color: "text-strong", className: r2.Uq, children: l }),
        ],
    });
}
var r4 = t(664184);
function r5(e) {
    let { targetElementRef: l, dismissPopover: t, children: a, numOrbs: s } = e,
        { analyticsLocations: i } = (0, nD.Ay)(nb.A.PREMIUM_MARKETING_NITRO_HOME_ORBS_SECTION),
        n = c.useCallback(() => {
            t(n5.i.TAKE_ACTION),
                (0, rU.A)({
                    subscriptionTier: oL.pe.TIER_2,
                    analyticsLocations: i,
                    analyticsObject: { object: nX.ZSU.BUTTON_CTA, objectType: nX.AnalyticsObjectTypes.TIER_2 },
                });
        }, [t, i]);
    return (0, h.jsxs)(h.Fragment, {
        children: [
            ...
            (0, h.jsx)(rH.x, {
                ...
                children: (0, h.jsxs)("div", {
                    ...
                    children: [
                        (0, h.jsx)(rS.q, { onClick: () => t(n5.i.USER_DISMISS), variant: "color-mix" }),
                        (0, h.jsx)("div", { className: r4.O, children: (0, h.jsx)(r3, { orbsCount: s }) }),
                        (0, h.jsx)(rF.D, {
                            title: nY.intl.string(rQ.default.hx5AFp),
                            body: nY.intl.formatToPlainString(rQ.default.otQEii, { orbsCount: s }),
                            badge: { type: "beta", variant: "expressive" },
                            className: r4.Q,
                        }),
                        (0, h.jsx)(rL.Z, {
                            actions: [
                                { text: nY.intl.string(nY.t.pj0XBN), variant: "primary", icon: sV.t, onClick: n },
                            ],
                        }),
                        (0, h.jsx)(rB.F, {}),
                    ],
...
let r9 = (e) => {
    let { targetElementRef: l, discountOffer: a, premiumSubscription: s, dismissCoachmark: i, children: c } = e,
        { analyticsLocations: n } = (0, nD.Ay)(nb.A.CHURN_DISCOUNT_POPOVER),
        o = (0, r6.iU)(oL.gD.PREMIUM_MONTH_TIER_2, a, s),
        r = (0, h.jsx)(nK.h, {
            targetElementRef: l,
            position: "right",
            align: "top",
            size: "md",
            caretConfig: { align: "start" },
            title: nY.intl.format(nY.t["3yZP0G"], { percent: a.discount.amount }).toString(),
            body: nY.intl.format(nY.t["3Q4wCy"], {
                discountedPrice: o,
                billingPeriod: (0, oT.Ke)(a.discount.user_usage_limit_interval),
            ...
            actions: [
                {
                    text: nY.intl.string(nY.t.zrCzVB),
                    variant: "expressive",
                    onClick: () => {
                        i(n5.i.TAKE_ACTION),
                            (0, x.openModalLazy)(async () => {
    ...
    return (0, h.jsxs)(h.Fragment, { children: [(0, h.jsx)("div", { children: c }), r] });
};
var de = t(498470),
    dl = t(807098),
    dt = t(637706);
function da(e) {
    let { children: l, targetElementRef: t, dismissPopover: a } = e,
        s = (0, ro.c)(oD.C.PREMIUM_TAB_POPOVER),
        i =
                ...
                ? [
                      {
                          ...
                          onClick: (0, de.h)({
                              ...
                              onClose: () => a(n5.i.USER_DISMISS),
                          }),
                          icon: sV.t,
                      },
                  ]
                : void 0,
        o = (0, dt.C)(i.helpArticle, i.helpArticleId);
    return (0, h.jsxs)(h.Fragment, {
        children: [
            (0, h.jsx)("div", { children: l }),
            (0, h.jsx)(nK.A, {
                targetElementRef: t,
                title: i.header,
                body: i.body,
...
function ds(e) {
    let { children: l } = e,
        t = (0, ro.c)(oD.C.PREMIUM_TAB_TOOLTIP),
        a =
    ...
    return null == a
        ...
        : (0, h.jsx)(u.u, {
              title: a.header,
              body: a.body,
              asset: null != s ? (0, h.jsx)("img", { src: s, alt: "" }) : void 0,
              assetSize: 80,
              padding: "lg",
              position: "right",
              asContainer: !0,
              children: (0, h.jsx)("div", { children: l }),
          });
}
function di(e) {
    let { alt: l, ariaLabel: t, ariaHidden: a, role: s, width: i = 144, height: c = 144 } = e;
...
function dc(e) {
    let { children: l, endsAt: t, variant: a = "initial" } = e,
        s = (0, o0.Zb)(t),
        i = (0, dh.$g)(0, (0, oT.Rr)(), { minimumFractionDigits: 0, maximumFractionDigits: 0 }),
        c = "followup" === a,
        n = c ? nY.intl.string(nY.t.gzhz8w) : nY.intl.string(nY.t.aopiS6),
        o = c ? nY.intl.format(nY.t["3iUE+U"], { price: i }) : nY.intl.format(nY.t.AQd9tZ, { days: s });
    return (0, h.jsx)(u.u, {
        title: o,
        body: n,
        asset: (0, h.jsx)(di, { alt: "", width: 48, height: 48 }),
        assetSize: 48,
        position: "right",
        asContainer: !0,
        children: (0, h.jsx)("div", { children: l }),
...
function dr(e) {
    ...
    switch (t) {
        case "churn_discount":
            ...
            break;
        case "premium_group":
            return (0, h.jsx)(rG, { targetElementRef: a, dismissPopover: r, children: l });
        case "premium_group_tooltip":
            return (0, h.jsx)(rq, { targetElementRef: a, children: l });
        case "orbs_upsell":
            if (c) return (0, h.jsx)(r5, { targetElementRef: a, dismissPopover: r, numOrbs: n, children: l });
            return (0, h.jsx)(r1, { targetElementRef: a, dismissPopover: r, children: l });
        case "orbs_intro":
            return (0, h.jsx)(rX, { targetElementRef: a, dismissPopover: r, children: l });
        case "orbs_drop":
            if (null != o)
                return (0, h.jsx)(r$, {
                    targetElementRef: a,
            ...
            break;
        case "reverse_trial": {
            let e = m?.trial_id === oL.Tt,
                t = p ?? (m?.expires_at != null ? rM()(m?.expires_at) : null);
            if (null != t) return (0, h.jsx)(dc, { endsAt: t, variant: e ? "followup" : "initial", children: l });
            break;
        }
        case "tooltip":
            return (0, h.jsx)(ds, { children: l });
        case "marketing_moment_popover":
            return (0, h.jsx)(da, { targetElementRef: a, dismissPopover: v, children: l });
        case "l_premium_sub_tooltip":
            return (0, h.jsx)(rO, { children: l });
        case "l_upsell":
            return (0, h.jsx)(rb, { targetElementRef: a, dismissPopover: r, children: l });
        case "orbs_multiplier":
            return (0, h.jsx)(rR, { multiplier: g, children: l });
        case "croissant_reheat_moment":
            return (0, h.jsx)(rE, { targetElementRef: a, dismissPopover: r, children: l });
        case "croissant_reheat_tooltip":
            return (0, h.jsx)(rN, { children: l });
    }
    return l;
}
function dd(e) {
        ...
        children: [
            t &&
                (0, h.jsxs)(h.Fragment, {
                    children: [
                        (0, h.jsx)("span", {
                            className: o()(dv.d4, dv.Cm),
                            children: (0, h.jsx)(dd, { width: "10", height: "10" }),
                        }),
                        (0, h.jsx)("span", {
                            className: o()(dv.d4, dv.nv),
                            children: (0, h.jsx)(dd, { width: "14", height: "14" }),
                        }),
                    ],
                }),
            (0, h.jsx)(nS.E, { variant: "eyebrow", className: dv.Ad, children: l }),
        ],
    });
}
let dp = new Set([m.M.PREMIUM_WISHLIST_COACHMARK]),
    dm = (e) => {
        let { selected: l } = e,
            t = (0, p.bG)([oE.default], () => oE.default.getCurrentUser()),
            a = (0, p.bG)([oY.A], () => oY.A.getPremiumTypeSubscription()),
            s = (0, rn.V)(),
            i = (0, rc.O)(),
            h = (0, o1.cg)(),
            [c] = ru(),
            n = (0, oT.Of)(t, a),
            o = (0, p.bG)([o$.A], () => o$.A.getCreatedAtOverride()),
            r = l || null != s || null != i || h || null != c || n,
    ...
    dw = (e) => {
        let l,
            t,
            a,
            { selected: s, nitroTabButtonRef: i, route: n, locationState: o, showHoverGradient: r, ...d } = e,
            g = (0, p.bG)([oE.default], () => oE.default.getCurrentUser()),
            w = (0, p.bG)([oY.A], () => oY.A.getPremiumTypeSubscription()),
            f = (0, oT.Of)(g, w),
            u = (0, oT.YE)(g, oL.PremiumTypes.TIER_2),
            I = (0, v.rm)("nitro"),
            M = (0, rn.V)(),
            Z = (0, rc.O)(),
            _ = (0, rh.p)(),
            ...
            [C, R] = ru(),
            {
                ...
                let e = (0, x.useHasAnyModalOpen)(),
                    l = (0, oc.Ay)((e) => e.postConnectionOpen),
                    { shouldShowBonusOrbsUX: t, multiplier: a } = (0, oz.Dl)(oK.rE.NITRO_HOME_TAB),
                    [s, i] = (0, nk.kn)(
                        !e && t && l ? [m.M.NITRO_TAB_QUEST_ORB_MULTIPLIER_TOOLTIP] : [],
                        n5.m.PRIVATE_CHANNELS_LIST,
                    );
                return {
            ...
            L = (0, oS.Tp)(),
            B = (0, p.bG)([oA.A], () => oA.A.getReminderStateId()),
            S = oH(),
            { programReward: F, isEligible: U } = (0, oQ.F)({ location: "NitroTabButton" }),
            { receivesUpdatedUpsellPopover: P, orbsRewardAmount: b } = (0, rm.uX)("NitroTabButton"),
            D = o4({ location: "nitro_tab_popover" }),
            k = (function (e) {
                let { location: l } = e;
                return o2.useConfig({ location: l });
            })({ location: "nitro_tab_popover" }),
            J = !(0, oT.TW)(g),
            G = J && U,
            W = F?.last_granted_reward,
            q = F?.last_granted_reward_amount,
            z = (0, oc.mB)(m.M.PREMIUM_ORBS_REWARDS_INTRO_POPOVER),
            K = u && U && null != W && null != q && !z,
            Q = u && U && !K && null != F,
            X = null != _ && null != w && w.status === nX.Dmq.CANCELED,
            Y = (0, oX.Gh)("NitroTabButton"),
            { functionalityEnabled: $ } = (0, rr.YS)({ location: "NitroTabButton" }),
            ee = oV({ location: "NitroTabButton" }),
            el = $ && ee && u,
            et = $ && ee && J,
            ea = (function () {
                let e = (0, oW.V)();
                if (
                    !(function (e) {
                        let { enabled: l } = oG.useConfig({ location: e });
                        return l;
                    })("nitro_tab_button")
                )
                    return 0;
            ...
            es = ea !== oq.NONE,
            {
                ...
                startsAt: eh,
                endsAt: ec,
                currentEntitlementEndsAt: en,
            } = (0, oJ.A)({ forceFetch: !0 }),
            [eo, er] = (0, nk.Wl)(ei !== oL.xc.NONE ? m.M.FRACTIONAL_NITRO_DURATION_LEFT_PILL : null, {
            ...
            ev = [],
            eg = [];
        (0, oc.Tc)() && (S && ev.push(m.M.RECURRING_3P_PROMOTION_POPOVER), T && ev.push(m.M.BOGO_2025_NITRO_TAB_BADGE));
        let [ep, em] = (0, nk.kn)(ev, void 0, !0);
        ...
        let [ew, ef] = (0, nk.kn)(eg, void 0, !0),
            ex = (0, ro.c)(oD.C.PREMIUM_TAB),
            eA = (0, ro.c)(oD.C.PREMIUM_TAB_TOOLTIP),
            eu = (0, ro.c)(oD.C.PREMIUM_TAB_POPOVER),
            [eI, eM] = (0, nk.Cc)(
            ...
            [eZ, e_] = (0, nk.Cc)(
                null != eu && "premiumTabPopover" === eu.properties.properties.oneofKind
            ...
            [eE, eT] = (0, nk.Cc)(K ? m.M.PREMIUM_ORBS_REWARDS_DROP_POPOVER : null, W ?? "", void 0, !0),
            eN =
                null != eA &&
                "premiumTabTooltip" === eA.properties.properties.oneofKind &&
                eI === m.M.PREMIUM_TAB_MARKETING_MOMENT_OFFER_BADGE,
            ej = el && ew === m.M.L_3PP_NITRO_TOOLTIP,
            eC = et && ew === m.M.L_3PP_NON_NITRO_POPOVER;
        if (
            (c.useEffect(() => {
                !0 === s &&
                    (null != ep && em(n5.i.AUTO_DISMISS),
                    null == ew || dp.has(ew) || ef(n5.i.AUTO_DISMISS),
                    null != eI && eM(n5.i.AUTO_DISMISS),
                    null != eE && eT(n5.i.AUTO_DISMISS),
                    null != eZ && e_(n5.i.AUTO_DISMISS),
                    y && O(n5.i.AUTO_DISMISS),
                    null != C && R(n5.i.AUTO_DISMISS));
            }, [em, s, ep, ef, ew, eI, eM, eE, eT, eZ, e_, y, O, C, R]),
            !dm({ selected: s }))
        )
            return null;
        let eR = () => {
            eo === m.M.FRACTIONAL_NITRO_DURATION_LEFT_PILL && er(n5.i.TAKE_ACTION),
                oU.default.track(nX.HAw.NITRO_TAB_VISITED, { badge_decorator: t, has_premium: f }),
                null != ep && em(n5.i.USER_DISMISS),
                null != eI && eM(n5.i.USER_DISMISS),
                (ew === m.M.PREMIUM_GROUP_POPOVER || ew === m.M.PREMIUM_GROUP_POPOVER_UPSELL_V2) &&
                    ef(n5.i.USER_DISMISS),
                ew === m.M.L_3PP_NITRO_TOOLTIP && ef(n5.i.USER_DISMISS),
                ew === m.M.L_3PP_NON_NITRO_POPOVER && ef(n5.i.USER_DISMISS),
                ew === m.M.CROISSANT_REHEAT_MOMENT && ef(n5.i.USER_DISMISS),
                y && O(n5.i.USER_DISMISS),
                null != C && R(n5.i.USER_DISMISS);
        };
        ei === oL.xc.NONE ||
            E ||
            ((t = 7),
            (l = (0, h.jsx)(rt, {
                ...
                startsAt: eh,
                endsAt: ec,
                messageStyle: ok.yE.SHORT_TIME,
                upperCase: !0,
            })));
        let eV = ew === m.M.PREMIUM_GROUP_POPOVER || ew === m.M.PREMIUM_GROUP_POPOVER_UPSELL_V2,
            ey = j && eV;
        if (L)
            (l = (0, h.jsx)(nL.E, { type: { text: nY.intl.string(nY.t.RDE0Sc) }, variant: "expressive" })),
                (eR = () => {
                    oU.default.track(nX.HAw.NITRO_TAB_VISITED, { badge_decorator: t, has_premium: f }), (0, oS.ne)(B);
                }),
                (t = 6);
        else if (ey) (l = (0, h.jsx)(nL.E, { type: "new", variant: "expressive" })), (t = 10);
        else if (null != ex && "premiumTab" === ex.properties.properties.oneofKind) {
            let e = (0, oj.u$)(m.M.PREMIUM_TAB_MARKETING_MOMENT_OFFER_BADGE, ex?.promotionId ?? "").isDismissed;
            (l = (0, h.jsx)(rp, {
                componentId: ex.id,
        ...
        } else if (T) (l = (0, h.jsx)(rv.A, {})), (t = 0);
        else if (N) {
            let e = (0, oS.ZR)();
            (l = (0, h.jsx)(rw.MA, {
                isTabSelected: s,
                badgeCopy: nY.intl.string(nY.t.OS9KPu),
                offerExpiresAt: !0 === e ? M?.expires_at : null,
            })),
                (t = 4);
        } else
            ep === m.M.RECURRING_3P_PROMOTION_POPOVER
                ? ((l = (0, h.jsx)(nL.E, { type: "new", variant: "expressive" })),
                  (t = 4),
                  (eR = () => {
                      oU.default.track(nX.HAw.NITRO_TAB_VISITED, { badge_decorator: t, has_premium: f }),
                          em(n5.i.USER_DISMISS);
                  }))
                : E
                  ? ((l = (0, h.jsx)(nL.E, { type: { text: nY.intl.string(nY.t.raP9dM) }, variant: "expressive" })),
                    (t = 4))
                  : null != C
                    ? ((l = (0, h.jsx)(dg, { copy: C, showStars: !1 })), (t = 1))
                    : null != Z
                      ? ((l = (0, h.jsx)(rw.fY, { userDiscount: Z, isTabSelected: s, includesAmountOff: !1 })), (t = 3))
                      : null == M || ed
                        ? X
                            ? ((l = (0, h.jsx)(rx, { isSelected: s, discountOffer: _ })), (t = 8))
                            : (G && ew === m.M.PREMIUM_ORBS_UPSELL_POPOVER) ||
                                (Q && ew === m.M.PREMIUM_ORBS_REWARDS_INTRO_POPOVER) ||
                                (K && eE === m.M.PREMIUM_ORBS_REWARDS_DROP_POPOVER)
                              ? ((l = (0, h.jsx)(nL.E, { type: "new", variant: "expressive" })), (t = 2))
                              : ej
                                ? ((l = (0, h.jsx)(nL.E, { type: "new", variant: "expressive" })), (t = 11))
                                : eC
                                  ? ((l = (0, h.jsx)(nL.E, { type: "new", variant: "expressive" })), (t = 12))
                                  : Y && ew === m.M.PREMIUM_WISHLIST_COACHMARK
                                    ? ((l = (0, h.jsx)(nL.E, { type: "new", variant: "expressive" })), (t = 13))
                                    : y
                                      ? ((l = (0, h.jsx)(nL.E, { type: "new", variant: "expressive" })), (t = 14))
                                      : es &&
                                        ew === m.M.CROISSANT_REHEAT_MOMENT &&
                                        ((l = (0, h.jsx)(nL.E, { type: "new", variant: "expressive" })), (t = 2))
                        : ((l = (0, h.jsx)(rw.Ag, { trialOffer: M, isTabSelected: s })), (t = 4));
        let eO = dn.NONE;
        eZ === m.M.PREMIUM_MARKETING_MOMENT_REMINDER_UPSELL
            ? (eO = dn.MARKETING_MOMENT_POPOVER)
            : X && ew === m.M.CHURN_DISCOUNT_PREMIUM_TAB_COACHMARK && 8 === t
              ? (eO = dn.CHURN_DISCOUNT)
              : ey && !k
                ? (eO = dn.PREMIUM_GROUP)
                : ey && k
                  ? ((eO = dn.PREMIUM_GROUP_TOOLTIP), (r = !0))
                  : G && ew === m.M.PREMIUM_ORBS_UPSELL_POPOVER
                    ? (eO = dn.ORBS_UPSELL)
                    : Q && ew === m.M.PREMIUM_ORBS_REWARDS_INTRO_POPOVER
                      ? (eO = dn.ORBS_INTRO)
                      : K && eE === m.M.PREMIUM_ORBS_REWARDS_DROP_POPOVER
                        ...
                        : eN
                          ? (eO = dn.TOOLTIP)
                          : ej
                            ? (eO = dn.L_PREMIUM_SUB_TOOLTIP)
                            : eC
                              ? (eO = dn.L_UPSELL)
                              : E || M?.trial_id === oL.Tt
                                ? (eO = dn.REVERSE_TRIAL)
                                : y
                                  ? (eO = dn.ORBS_MULTIPLIER)
                                  : ea === oq.POPOVER && ew === m.M.CROISSANT_REHEAT_MOMENT
                                    ? (eO = dn.CROISSANT_REHEAT_MOMENT)
                                    : ea === oq.TOOLTIP &&
                                      ew === m.M.CROISSANT_REHEAT_MOMENT &&
                                      ((r = !0), (eO = dn.CROISSANT_REHEAT_TOOLTIP));
        let eH = (0, h.jsx)(V.z9, {
            listItemRef: i,
            selected: s,
            route: n,
            ...
            text: (0, h.jsx)(A.A, { children: u ? nY.intl.string(nY.t["4gwVVn"]) : nY.intl.string(nY.t.Ipxkog) }),
            locationState: o,
            onClick: () => {
                if (eO === dn.CROISSANT_REHEAT_TOOLTIP) {
                    let e = new URL(n, window.location.origin);
                    e.searchParams.set(ri.x6, rs.u), (0, nQ.pX)(`${e.pathname}?${e.searchParams.toString()}`);
                } else if (ej) {
                    let e = new URL(n, window.location.origin);
                    e.searchParams.set(ri.WU, ra.LOGITECH_3PP_CARD_ID),
                        (0, nQ.pX)(`${e.pathname}?${e.searchParams.toString()}`);
                } else if (null != a && "" !== a) {
                    let e = new URL(n, window.location.origin);
                    e.searchParams.set(ri.x6, a), (0, nQ.pX)(`${e.pathname}?${e.searchParams.toString()}`);
                }
                eR();
            },
            ...d,
...
function dM(e) {
    let { className: l, firing: t = !0, wind: a = 2, sprites: s = dx, spriteColors: i = dA, confettiConfig: n } = e,
        [o, r] = c.useState(null),
        [d, v] = c.useState(null),
        g = (0, df.f9)(d, o),
        p = c.useMemo(() => new df.OH({ wind: a }), [a]),
        m = c.useCallback(() => {
            let e = d?.getCanvas();
            if (null == e) return;
    ...
    return (
        c.useEffect(() => {
            let e = t ? setInterval(m, du) : null;
            return () => clearInterval(e);
        }, [t, m]),
        (0, h.jsxs)(h.Fragment, {
            children: [
                (0, h.jsx)(df.Fk, { ref: v, className: l, environment: p }),
                (0, h.jsx)(df.K_, { ref: r, colors: i, sprites: s, spriteWidth: 6, spriteHeight: 6 }),
            ],
        })
    );
}
...
function dV(e) {
    ...
    return (
        ...
        (0, h.jsx)(nK.A, {
            actions: [{ text: nY.intl.string(nY.t.facYnD), variant: "primary", onClick: i }],
            alignmentStrategy: "edge",
            align: "top",
            body: nY.intl.string(nY.t.o4NGXc),
            caretConfig: { align: "start" },
            gradientColor: "purple",
            graphic: { type: "image", src: dR.A },
            onRequestClose: a,
            position: "right",
            size: "lg",
            targetElementRef: s,
            title: nY.intl.string(nY.t.EDDchq),
        })
    );
}
var dy = t(398025),
    ...
    dB = function (e) {
        let { selected: l } = e,
            ...
            a = c.useRef(null),
            {
                ...
                dismissOnboardingContent: n,
            } = (function () {
                let e = (0, x.useHasAnyModalOpen)(),
                    l = (0, p.bG)([dT.A], () => dT.A.quests.size > 0),
                    t = (0, p.bG)([oE.default], () => oE.default.getCurrentUser()),
                    [a, s] = (0, nk.kn)(
                    ...
                    h = a === m.M.QUEST_HOME_ENTRYPOINT_ONBOARDING,
                    n = (0, oj.JZ)(m.M.QUEST_HOME_ENTRYPOINT_ONBOARDING);
                return { shouldShowPopover: h, shouldShowGradientAndBadge: l && !n, dismissOnboardingContent: i };
            })(),
            { shouldShowQuestHomeHeroContent: r, dismissQuestHomeHeroContent: d, questHomeHero: g } = (0, dC.I)(),
            f = c.useCallback(() => {
                dN.A.getState().setUtmCurrentContext({ utmContentCurrent: "PRIMARY_QUEST_HOME" }), r && d();
            }, [r, d]),
            [{ glowSpring: A }, I] = (0, d_.z)(() => ({
                from: { glowSpring: 0 },
                config: { clamp: !0, mass: 1, tension: 240, friction: 12 },
            })),
            [{ shineSpring: M }, _] = (0, d_.z)(() => ({
                from: { shineSpring: 0 },
                config: { clamp: !0, mass: 1, tension: 170, friction: 38 },
            })),
            E = (0, dj.cR)({ questHomeHero: g, shouldShowQuestHomeHeroContent: r }),
            T = c.useCallback(() => {
            ...
            { inlineCssProperties: S, shouldShowQuestHomeHeroGradient: F } = c.useMemo(() => {
                ...
                let i = null != a && null != s,
                    h = null != l && null != t;
                return { inlineCssProperties: e, shouldShowQuestHomeHeroGradient: r && (i || h) };
            }, [r, g]),
            U = (0, h.jsx)("div", {
                className: dO.iE,
                onMouseEnter: T,
                ...
                ref: O,
                style: S,
                children: (0, h.jsxs)(V.z9, {
                    showHoverGradient: !1,
                    className: o()({ [dO.VU]: H || F, [dO.jR]: H, [dO.XO]: r }),
                    icon: iq.r,
                    listItemRef: a,
                    onClick: f,
                    route: nX.BVt.QUEST_HOME,
                    selected: l,
                    text: nY.intl.string(nY.t.JALI2K),
                    ...t,
                    children: [
                        r &&
                            (0, h.jsxs)(h.Fragment, {
                                children: [
                                    (0, h.jsx)("div", {
                                        className: dO.qS,
                                        children: (0, h.jsx)(nL.E, {
                                            type: { text: nY.intl.string(nY.t.y2b7CA) },
                                            variant: "expressive",
                                        }),
                                    }),
                        ...
                        H &&
                            (0, h.jsxs)(h.Fragment, {
                                children: [
                                    (0, h.jsx)(dZ.animated.div, {
                                        className: dO.q2,
                                        style: {
                                            transform: M.to(
                                                (e) =>
                                                    `translateX(calc(${e * C}px + ${e * dH}px)) translateY(-50%) rotate(45deg)`,
                                            ),
                                        },
                                    }),
                                    (0, h.jsx)(dZ.animated.div, {
                                        className: dO.ys,
                                        style: { opacity: (0, dy.a)(A.to({ range: [0, 1], output: [0, 0.5] })) },
                                    }),
                                    (0, h.jsx)(Z.Lp, {
                                        className: dO.qS,
                                        text: nY.intl.string(nY.t.y2b7CA),
        ...
        return (0, h.jsxs)(h.Fragment, {
            children: [
                B
                    ...
                    : U,
                L && (0, h.jsx)(dV, { targetElementRef: a, onNavigateToQuestHome: f, onRender: j, onRequestClose: n }),
            ],
        });
    };
var dS = t(793322),
...
let dX = (e) => {
        let { selected: l, ...t } = e,
            a = (0, oo.c)("PrivateChannels.ICYMIButton"),
            s = (0, v.rm)("icymi");
        return a
            ? (0, h.jsx)("div", {
                  className: dQ.F2,
                  children: (0, h.jsx)(V.z9, {
                      selected: l,
                      route: nX.BVt.ICYMI,
                      icon: I.g,
                      text: (0, h.jsxs)(h.Fragment, {
                          children: [
                              nY.intl.string(nY.t["jnXV/V"]),
                              (0, h.jsx)("span", { className: dQ.HH, children: nY.intl.string(nY.t.Ac2OZA) }),
                          ],
                      }),
                      ...t,
                      ...s,
    ...
    dY = (e) => {
        let { selected: l, ...t } = e,
            a = (0, v.rm)("friends"),
            s = (0, ox.kX)(),
            i = (0, p.bG)([oM.Ay], () => oM.Ay.canShowFriendsTabBadge()),
            n = (0, p.bG)([H.A], () => H.A.useReducedMotion),
            { enabled: o } = ou.u.useConfig({ location: "Friends Tab" }),
            [r, g] = (0, nk.Wl)(i && o ? m.M.GIFTING_INTENT_FRIENDS_TAB_BADGE : null, { cooldownDurationMs: oM.hb }),
            w = r === m.M.GIFTING_INTENT_FRIENDS_TAB_BADGE;
        c.useEffect(() => {
            w &&
                (0, B.x)({
        ...
        let x = () => {
                let e;
                w
                    ? (oU.default.track(nX.HAw.GIFT_INTENT_BADGE_CLICKED, {
                          gift_intent_type: oL.np.FRIEND_ANNIVERSARY,
                      }),
                      (e = nX.m3P.ALL),
                      R.A.setSection(nX.m3P.ALL),
                      g(n5.i.TAKE_ACTION))
                    : (e = dW.Ay.getState().section),
                    (0, L.A)({ tab_opened: e });
            },
            [A, I] = c.useState(!1),
            _ = () => {
            ...
            T = () =>
                (0, h.jsx)(V.z9, {
                    showHoverGradient: !1,
                    onClick: x,
                    interactiveClassName: w ? dQ.hc : void 0,
                    selected: l,
                    route: nX.BVt.FRIENDS,
                    icon: M.$,
                    text: nY.intl.string(nY.t.TdEu5X),
                    onMouseEnter: E,
                    onMouseLeave: _,
                    ...t,
                    ...a,
                    children: s > 0 ? (0, h.jsx)(Z.hV, { count: s }) : null,
                });
        return (0, h.jsx)("div", {
            className: dQ.F2,
            children: w
                ? (0, h.jsxs)(h.Fragment, {
                      children: [
                          (0, h.jsx)(u.u, {
                              title: nY.intl.string(nY.t.Thb5MO),
                              body: nY.intl.string(nY.t.kGvgwS),
                              position: "left",
                              asset: (0, h.jsx)(f, { size: 32, alt: nY.intl.string(nY.t["4LohBA"]) }),
                              children: T(),
                          }),
                          !n &&
                              (0, h.jsx)(dM, {
    ...
    d$ = (e) => {
        ...
        return (0, h.jsx)(V.z9, {
            selected: l,
            route: nX.BVt.APPLICATION_LIBRARY,
            icon: _._,
            text: nY.intl.string(nY.t.cw57ar),
            ...a,
            ...s,
            children: (0, h.jsx)(O.A, { className: o()(dQ.Qw, { [dQ.QI]: t }) }),
        });
    },
    d1 = () => {
        let e = (0, od.W)();
        return e > 0 ? (0, h.jsx)(Z.hV, { count: e }) : null;
    },
    d0 = (e) => {
        let { selected: l } = e,
            ...
            { channelId: a } = (0, or.N)();
        if (!om()) return null;
        let s = null == a ? void 0 : () => C.A.preload(nX.ME, a);
        return (0, h.jsx)(V.z9, {
            selected: l,
            route: nX.BVt.MESSAGE_REQUESTS,
            icon: E.u,
            text: nY.intl.string(nY.t.e7GWjQ),
            onClick: s,
            ...t,
            children: (0, h.jsx)(d1, {}),
        });
    ...
    d2 = (e) => {
        let { selected: l } = e,
            t = nY.intl.string(dK.default.Rkdixs),
            a = (0, v.rm)("family-center"),
            [s, i] = c.useState(!0);
        return (0, h.jsx)(V.z9, {
            selected: l,
            route: nX.BVt.FAMILY_CENTER,
            icon: T.n,
            text: t,
            onMouseEnter: () => {
                i(!0);
            ...
            interactiveClassName: dQ.M1,
            ...a,
            children: (0, h.jsx)(d3, { isParentHovered: s }),
        });
    },
    d3 = (e) => {
        ...
        return l
            ? (0, h.jsx)("div", {
                  ...
                  children: (0, h.jsx)(V.w_, {
                      ...
                      "aria-label": nY.intl.string(nY.t.cpT0Cq),
                      icon: N.P,
                  }),
              })
            : a > 0
              ? (0, h.jsx)("div", { className: o()(dQ.lL, dQ.iL), children: (0, h.jsx)(Z.hV, { count: a }) })
              : (0, h.jsx)("div", {
                    className: dQ.lL,
                    children: (0, h.jsx)(on.Ay, {
    ...
    d4 = () => (0, dS.WU)("DM_SEARCH");
function d5(e) {
    switch (e) {
        case nX.BVt.APPLICATION_LIBRARY:
            return nX.liQ.LIBRARY;
        case nX.BVt.FRIENDS:
            return nX.liQ.FRIENDS_LIST;
        case nX.BVt.COLLECTIBLES_SHOP:
            return nX.liQ.COLLECTIBLES_SHOP;
    }
    return e.startsWith(nX.BVt.APPLICATION_STORE)
        ? e === nX.BVt.APPLICATION_STORE
            ? nX.liQ.STORE_DIRECTORY_HOME
            : e.startsWith(nX.BVt.APPLICATION_STORE)
              ? nX.liQ.STORE_DIRECTORY_BROWSE
              : nX.liQ.STORE_LISTING
        : nX.liQ.DM_CHANNEL;
}
let d6 = c.memo(function (e) {
    let {
            showLibrary: l,
        ...
        x = c.useRef(null),
        u = c.useRef(null),
        I = (0, oo.c)("PrivateChannels"),
        M = null;
    return (
        n ? (M = (0, h.jsx)(ob, { targetElementRef: u })) : r && (M = (0, h.jsx)(oB, { targetElementRef: u })),
        (0, h.jsxs)("nav", {
            className: dQ.AB,
            "aria-label": nY.intl.string(nY.t.ZH9aP4),
            children: [
                (0, h.jsx)(dU.A, {
                    childRef: w,
                    ...
                    children: (0, h.jsx)("div", {
                        ref: w,
                        className: o()(dQ.ON, { [dQ.jD]: g.Fr }),
                        children: (0, h.jsx)(j.$, {
                            fullWidth: !0,
                            variant: "secondary",
                            size: "sm",
                            onClick: d4,
                            text: nY.intl.format(nY.t.fH9FBy, {
                                tooltipHook: (e, l) => (0, h.jsx)(A.A, { children: e }, l),
                            }),
                        }),
                    }),
                }),
                (0, h.jsxs)(y.A, {
                    ...
                    children: [
                        (0, h.jsx)(
                            dY,
                            { selected: null != m ? m === nX.BVt.FRIENDS : a === nX.BVt.FRIENDS },
                            "friends",
                        ),
                        I
                            ? (0, h.jsx)(dX, { selected: null != m ? m === nX.BVt.ICYMI : a === nX.BVt.ICYMI }, "icymi")
                            : null,
                        t && l
                            ? (0, h.jsx)(
                                  d$,
                                  {
                                      selected:
                                          null == m
                                              ? null != a && a.startsWith(nX.BVt.APPLICATION_LIBRARY)
                                              : m.startsWith(nX.BVt.APPLICATION_LIBRARY),
                                      hideGameUpdateProgressIndicator: a === nX.BVt.APPLICATION_LIBRARY,
                                  },
                                  "library",
                              )
                            : null,
                        d
                            ? (0, h.jsx)(
                                  d0,
                                  {
                                      selected:
                                          null == m
                                              ? null != a && a.startsWith(nX.BVt.MESSAGE_REQUESTS)
                                              : m === nX.BVt.MESSAGE_REQUESTS,
                                  },
                                  "message-requests",
                              )
                            : null,
                            ...
                            ? (0, h.jsxs)(
                                  "div",
                                  {
                                      children: [
                                          (0, h.jsx)(dw, {
                                              nitroTabButtonRef: u,
                                              selected: null == m ? s : m.startsWith(nX.BVt.APPLICATION_STORE),
                                              route: nX.BVt.APPLICATION_STORE,
                                              locationState: {
                                                  analyticsSource: {
                                                      page: d5(a),
                                                      section: nX.JJy.NAVIGATION,
                                                      object: nX.ZSU.NAVIGATION_LINK,
                                                  },
                                              },
                                          }),
                                          M,
                        ...
                        (0, h.jsx)(
                            oh,
                            {
                                selected: m === nX.BVt.COLLECTIBLES_SHOP || a?.startsWith(nX.BVt.COLLECTIBLES_SHOP),
                                listItemRef: f,
                                locationState: {
                                    analyticsSource: {
                                        page: d5(a),
                        ...
                        v
                            ? (0, h.jsx)(
                                  ...
                                  {
                                      selected:
                                          (null != a && a.startsWith(nX.BVt.FAMILY_CENTER)) ||
                                          (null != m && m.startsWith(nX.BVt.FAMILY_CENTER)),
                                  },
                                  "family-center",
                              )
                            : null,
                        (0, h.jsx)(
                            ...
                            {
                                selected:
                                    null == m ? null != a && a.startsWith(nX.BVt.QUEST_HOME) : m === nX.BVt.QUEST_HOME,
                            },
                            "quests",
                        ),
                        (0, h.jsx)(d7, {}, "section-divider-top"),
                    ],
                }),
            ],
        })
...
function d7() {
    return (0, h.jsx)("div", { className: dQ.ts });
}
function d8() {
    let e,
        l,
        ...
        a = (0, p.bG)([dJ.A], () => {
            if (t === nX.BVt.APPLICATION_STORE) return !0;
            let e = (0, dq.qt)(t);
            return null != e && (dJ.A.get(e)?.premium ?? !1);
        }, [t]),
        s = !db.l_.useSetting(),
        { theme: i } = (0, p.cf)([dP.A], () => ({ theme: dP.A.theme })),
        c = (0, p.bG)([dD.A], () => dD.A.hasLibraryApplication()),
        n = (0, p.bG)([dk.A], () => dk.A.getCurrentPath()),
        [o, d] = (0, dF.A)((e) => {
            let { channelId: l, path: t } = e;
            return [l, t];
        }, r.x),
        v = dm({ selected: null == d ? a : d.startsWith(nX.BVt.APPLICATION_STORE) }),
        g = (0, oS.Tp)(),
        w = (0, p.bG)([oA.A], () => oA.A.getReminderStateId()),
        f = oH(),
        x = [],
        A = (0, oI.A)({ location: "Private Channels" });
    (0, oc.Tc)() && (g && !A && x.push(m.M.REFERRAL_PROGRAM_POPOVER), f && x.push(m.M.RECURRING_3P_PROMOTION_POPOVER));
    let [u] = (0, nk.Cc)(g && A ? m.M.REFERRAL_PROGRAM_POPOVER_V2 : null, w ?? "", void 0, !0),
        [I, M] = (0, nk.kn)(x, void 0, !0),
        Z = null == u && I === m.M.RECURRING_3P_PROMOTION_POPOVER,
        _ = A ? u === m.M.REFERRAL_PROGRAM_POPOVER_V2 : I === m.M.REFERRAL_PROGRAM_POPOVER,
        E = om(),
        T = ((e = db.dm.useSetting()), (l = (0, ow.A)()), !0 === e && !0 === l);
    return (0, h.jsx)(d6, {
        theme: i,
        showLibrary: s,
