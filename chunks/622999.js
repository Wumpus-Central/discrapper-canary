...
function f() {
    return null == s.Ai1.STRIPE.KEY
        ? (l.warn("getStripeClientMode() called before PaymentSettings.STRIPE.KEY initialized: ", s.Ai1.STRIPE.KEY),
          "unknown")
        : s.Ai1.STRIPE.KEY.startsWith("pk_live")
          ? "live"
          : s.Ai1.STRIPE.KEY.startsWith("pk_test")
            ? "test"
...
function p(e) {
    let { name: t, line1: n, line2: r, city: i, state: o, postalCode: a, country: s } = e;
    return {
        name: t,
        address: {
            line1: n,
