...
async function r(e) {
    ...
    try {
        let t = await l.Bo.post({ url: i.Rsh.ORB_USER_CHALLENGE_CLAIM(e), rejectWithError: !1 });
        return (
...
async function c(e) {
    ...
    try {
        let t = await l.Bo.get({ url: i.Rsh.ORB_USER_CHALLENGES_LIST, rejectWithError: !1 });
        return (
...
async function o() {
    try {
        let e = await l.Bo.get({ url: i.Rsh.ORB_USER_CHALLENGES_UNREAD_STATE, rejectWithError: !1 });
...
async function h() {
    ...
    try {
        let e = await l.Bo.post({ url: i.Rsh.ORB_USER_CHALLENGES_UNREAD_STATE_ACK, rejectWithError: !1 });
        return (n.h.dispatch({ type: "ORB_CHALLENGES_UNREAD_UPDATE", achievementUnreadState: e.body }), e.body);
    } catch (e) {
        return;
    }
