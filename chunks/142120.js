...
N.sZ.dispatcher.getDispatchHandler = C.A;
...
class B extends s.Ay.Store {
    ...
    initialize() {
        this.waitFor(f.default, p.A, h.A, E.Ay, m.A, g.A, A.A, I.A, T.A, _.A),
...
let H = new B(o.h, {
    ...
    RTC_CONNECTION_STATE: function (e) {
        if (e.state !== O.S7L.DISCONNECTED) return !1;
    ...
    VOICE_CHANNEL_SELECT: function (e) {
        return (
            ...
            (x = e.lockVoiceStateForResume && null != e.channelId ? e.channelId : null),
            (0, S.isIOS)() &&
                P === O.g6G.BACKGROUND &&
                (null == e.channelId ? N.sZ.close(!0) : N.sZ.isClosed() && (v.V(!1), N.sZ.connect())),
            !1
        );
    },
    VOICE_STATE_UPDATES: function (e) {
        ...
        return t.reduce((e, t) => {
            ...
            if (t.sessionId === w) {
                if (null != x)
                    return D.verbose("Ignoring voice state for own session due to VSU lock on channel:", x), e;
        ...
        return (
            (0, S.isIOS)()
                ? (f.default.isAuthenticated() &&
                      (P === O.g6G.INACTIVE && e.state === O.g6G.BACKGROUND && null == N.Xo.channelId
                          ? N.sZ.close(!0)
                          : P === O.g6G.BACKGROUND &&
                            e.state === O.g6G.ACTIVE &&
                            N.sZ.isClosed() &&
                            (v.V(!1), N.sZ.connect())),
                  (P = e.state))
                : e.state === O.g6G.ACTIVE &&
                  (v.V(!1), f.default.isAuthenticated() && N.sZ.resetBackoff("App state is active")),
            !1
        );
    },
    ...
    STREAM_WATCH: function (e) {
        ...
        if (N.sZ.isSessionEstablished()) {
            if (n);
                ...
                let e;
                (e = T.A.getAllActiveStreamKeys().find((e) => (0, c.Iy)(e).ownerId === f.default.getId())),
    ...
    USER_SETTINGS_PROTO_UPDATE: function (e) {
        e.settings.type === R.oD.PRELOADED_USER_SETTINGS && e.settings.proto.clips?.allowVoiceRecording != null && U();
    },
});
