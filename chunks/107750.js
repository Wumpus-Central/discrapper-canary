...
n.d(t, {
    ...
    tO: () =>
        function e(t, n, r) {
            ...
            return f
                .put(t, n, { url: d.RQ.NOTIFICATIONS_PLAYER, query: { connection_id: r } })
...
function E(e) {
    return r.Bo.get({ url: c.Rsh.CONNECTION_ACCESS_TOKEN(c.fg2.SPOTIFY, e), oldFormErrors: !0, rejectWithError: !1 })
        .catch((t) => {
            if (t.body?.code === c.t02.CONNECTION_REVOKED)
...
function p(e, t) {
    return f
        .get(e, t, { url: d.RQ.PLAYER_DEVICES })
        .then(
...
function m(e, t, n, r) {
    let i = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : {},
        a = d.RQ.PLAYER_OPEN(r, n, !1),
        { deviceId: o, position: l, contextUri: u, repeat: c } = i;
    return f
        .put(e, t, {
        ...
        .then((n) =>
            null == c
                ? n
                : f.put(e, t, { url: d.RQ.PLAYER_REPEAT, query: { device_id: o, state: c ? "context" : "off" } }),
        )
        .then((e) => (s.h.dispatch({ type: "SPOTIFY_PLAYER_PLAY", id: n, position: null != l ? l : 0 }), e));
}
function g(e, t) {
    return f.put(e, t, { url: d.RQ.PLAYER_PAUSE }).then((e) => (s.h.dispatch({ type: "SPOTIFY_PLAYER_PAUSE" }), e));
}
function A() {
