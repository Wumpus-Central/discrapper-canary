    ...
    function () {
        ...
        var rn = 0,
            ...
            rE = {
                ...
                createNode(r, e, t, n) {
                    ...
                    return (
                        rA.isDir(o.mode)
                            ? ((o.node_ops = rE.ops_table.dir.node),
                              (o.stream_ops = rE.ops_table.dir.stream),
                              (o.contents = {}))
                            : rA.isFile(o.mode)
                              ? ((o.node_ops = rE.ops_table.file.node),
                                (o.stream_ops = rE.ops_table.file.stream),
                                (o.usedBytes = 0),
                                (o.contents = null))
                              : rA.isLink(o.mode)
                                ? ((o.node_ops = rE.ops_table.link.node), (o.stream_ops = rE.ops_table.link.stream))
                                : rA.isChrdev(o.mode) &&
                                  ((o.node_ops = rE.ops_table.chrdev.node),
                                  (o.stream_ops = rE.ops_table.chrdev.stream)),
                ...
                node_ops: {
                    getattr(r) {
                        var e = {};
                        return (
                            (e.dev = rA.isChrdev(r.mode) ? r.id : 1),
                            (e.ino = r.id),
                            (e.mode = r.mode),
                            (e.nlink = 1),
                            (e.uid = 0),
                ...
                stream_ops: {
                    ...
                    write(r, e, t, n, o, a) {
                        ...
                        if ((rE.expandFileStorage(i, o + n), i.contents.subarray && e.subarray))
                    ...
                    llseek(r, e, t) {
                        var n = e;
                        if (
                            (1 === t ? (n += r.position) : 2 === t && rA.isFile(r.node.mode) && (n += r.node.usedBytes),
                            n < 0)
                        )
                            throw new rA.ErrnoError(28);
                        return n;
                    },
                    allocate(r, e, t) {
            ...
            rA = {
                ...
                lookupPath(r) {
                    ...
                    r: for (var t, n = 0; n < 40; n++) {
                        for (
                            var o = r.split("/").filter((r) => !!r && "." !== r), a = rA.root, i = "/", s = 0;
                            s < o.length;
                            s++
                        ) {
                            var l = s === o.length - 1;
                            ...
                            if (
                                (rA.isMountpoint(a) && (!l || e.follow_mount) && (a = a.mounted.root),
                                rA.isLink(a.mode) && (!l || e.follow))
                            ) {
                ...
                mayOpen: (r, e) =>
                    r
                        ? rA.isLink(r.mode)
                            ? 32
                            : rA.isDir(r.mode) && ("r" !== rA.flagsToPermissionString(e) || 512 & e)
                              ? 31
                              : rA.nodePermissions(r, rA.flagsToPermissionString(e))
                        : 44,
                MAX_OPEN_FDS: 4096,
                nextfd() {
                ...
                createStream(r) {
                    ...
                    return (
                        (r = Object.assign(new rA.FSStream(), r)),
                        -1 == e && (e = rA.nextfd()),
                        (r.fd = e),
                        (rA.streams[e] = r),
                        r
                ...
                mount(r, e, t) {
                    ...
                    return (
                        (l.mount = s),
                        (s.root = l),
                        o ? (rA.root = l) : n && ((n.mounted = s), n.mount && n.mount.mounts.push(s)),
                        l
                    );
                },
                unmount(r) {
                ...
                rename(r, e) {
                    var t,
                        ...
                        c = ri.basename(e);
                    if (
                        ((n = rA.lookupPath(r, { parent: !0 }).node),
                        (o = rA.lookupPath(e, { parent: !0 }).node),
                        !n || !o)
                    )
                        throw new rA.ErrnoError(44);
                ...
                chmod(r, e, t) {
                    var n;
                    if (!(n = "string" == typeof r ? rA.lookupPath(r, { follow: !t }).node : r).node_ops.setattr)
                        throw new rA.ErrnoError(63);
                ...
                chown(r, e, t, n) {
                    var o;
                    if (!(o = "string" == typeof r ? rA.lookupPath(r, { follow: !n }).node : r).node_ops.setattr)
                        throw new rA.ErrnoError(63);
                ...
                open(e, t) {
                    ...
                    if ("" === e) throw new rA.ErrnoError(44);
                    if (
                        ((n = 64 & (t = "string" == typeof t ? rT(t) : t) ? (4095 & n) | 32768 : 0),
                        "object" == typeof e)
                    )
                        o = e;
                    else {
                    ...
                    if ((rA.isChrdev(o.mode) && (t &= -513), 65536 & t && !rA.isDir(o.mode)))
                        throw new rA.ErrnoError(54);
                    if (!i) {
                    ...
                    return (
                        ...
                        !r.logReadFiles || 1 & t || e in rA.readFiles || (rA.readFiles[e] = 1),
                        l
                    );
                },
                close(r) {
                ...
                readFile(r) {
                    ...
                    return (
                        rA.read(n, a, 0, o, 0),
                        "utf8" === e.encoding ? (t = rd(a)) : "binary" === e.encoding && (t = a),
                        rA.close(n),
                        t
                    );
                },
                ...
                createDefaultDevices() {
                    ...
                    rA.createDevice("/dev", "random", t),
                        rA.createDevice("/dev", "urandom", t),
                        rA.mkdir("/dev/shm"),
                        rA.mkdir("/dev/shm/tmp");
                },
                ...
                createStandardStreams(r, e, t) {
                    r ? rA.createDevice("/dev", "stdin", r) : rA.symlink("/dev/tty", "/dev/stdin"),
                        e ? rA.createDevice("/dev", "stdout", null, e) : rA.symlink("/dev/tty", "/dev/stdout"),
                        t ? rA.createDevice("/dev", "stderr", null, t) : rA.symlink("/dev/tty1", "/dev/stderr"),
                        rA.open("/dev/stdin", 0),
                        rA.open("/dev/stdout", 1),
                        rA.open("/dev/stderr", 1);
                },
                staticInit() {
                    (rA.nameTable = Array(4096)),
                        rA.mount(rE, {}, "/"),
                        rA.createDefaultDirectories(),
                        rA.createDefaultDevices(),
                        rA.createSpecialDirectories(),
                        (rA.filesystems = { MEMFS: rE });
                },
                init(e, t, n) {
                    (rA.initialized = !0),
                        null != e || (e = r.stdin),
                        null != t || (t = r.stdout),
                        null != n || (n = r.stderr),
                        rA.createStandardStreams(e, t, n);
                },
                quit() {
                    rA.initialized = !1;
                ...
                analyzePath(r, e) {
                    ...
                    try {
                        ...
                        (n.parentExists = !0),
                            ...
                            (n.name = ri.basename(r)),
                            (t = rA.lookupPath(r, { follow: !e })),
                            (n.exists = !0),
                            (n.path = t.path),
                            (n.object = t.node),
                            (n.name = t.node.name),
        ...
        function rB(r, e) {
            ...
            return (function (r, e) {
                ...
                var n = e.name;
                if (
                    (r || rR('type "'.concat(n, '" must have a positive integer typeid pointer')), rO.hasOwnProperty(r))
                )
        ...
        var rU = (r, e, t) => {
            ...
            rY = {},
            rZ = (r, e) => {
                for (void 0 === e && rR("ptr should not be undefined"); r.baseClass; )
            ...
            r6 = (e, t, n) => {
                r.hasOwnProperty(e)
                    ? ((void 0 === n || (void 0 !== r[e].overloadTable && void 0 !== r[e].overloadTable[n])) &&
                          rR("Cannot register public name '".concat(e, "' twice")),
                      r5(r, e, e),
        ...
        var r9 = (r, e, t) => {
            for (; e !== t; )
                e.upcast || rR("Expected null or instance of ".concat(t.name, ", got an instance of ").concat(e.name)),
                    (r = e.upcast(r)),
                    (e = e.baseClass);
            return r;
        };
        function r7(r, e) {
            ...
            e.$$ || rR('Cannot pass "'.concat(rS(e), '" as a ').concat(this.name)),
                e.$$.ptr || rR("Cannot pass deleted object as a pointer of type ".concat(this.name));
            var t = e.$$.ptrType.registeredClass;
            return r9(e.$$.ptr, t, this.registeredClass);
        }
        function er(r, e) {
            if (null === e)
                return (this.isReference && rR("null is not a valid ".concat(this.name)), this.isSmartPointer)
                    ? ((t = this.rawConstructor()), null !== r && r.push(this.rawDestructor, t), t)
                    : 0;
            (e && e.$$) || rR('Cannot pass "'.concat(rS(e), '" as a ').concat(this.name)),
                e.$$.ptr || rR("Cannot pass deleted object as a pointer of type ".concat(this.name)),
                !this.isConst &&
                    e.$$.ptrType.isConst &&
                    rR(
            ...
            if (((t = r9(e.$$.ptr, n, this.registeredClass)), this.isSmartPointer))
                switch (
                    (void 0 === e.$$.smartPtr && rR("Passing raw pointer to smart pointer is illegal"),
                    this.sharingPolicy)
                ) {
                    case 0:
                        e.$$.smartPtrType === this
        ...
        function en(r, e, t, n, o, a, i, s, l, c, u) {
            (this.name = r),
                ...
                o || void 0 !== e.baseClass
                    ? (this.toWireType = er)
                    : (n ? (this.toWireType = r7) : (this.toWireType = ee), (this.destructorFunction = null));
        }
        var eo = (e, t, n) => {
                r.hasOwnProperty(e) || rN("Replacing nonexistent public symbol"),
            ...
            es = (r, e) => {
                ...
                var t = ei(e);
                return (
                    "function" != typeof t && rR("unknown function pointer with signature ".concat(r, ": ").concat(e)),
                    t
                );
            },
            el = (r) => {
                ...
                delete() {
                    this.$$.ptr || rI(this),
                        this.$$.deleteScheduled &&
                            ...
                            rR("Object already scheduled for deletion"),
                        rL(this),
                        rq(this.$$),
        ...
        var e1 = {
                ...
                try {
                    ...
                    for (
                        ...
                        if ("." === p) (u = n.node.id), (f = 4);
                            ...
                            (u = h.id),
                                (f = rA.isChrdev(h.mode) ? 2 : rA.isDir(h.mode) ? 4 : rA.isLink(h.mode) ? 10 : 8);
                        }
                        (v[(e + o) >> 3] = BigInt(u)),
                ...
                rB(r, {
                    ...
                    toWireType: function (r, e) {
                        if ("bigint" != typeof e && "number" != typeof e)
                            throw TypeError('Cannot convert "'.concat(rS(e), '" to ').concat(this.name));
            ...
            m: (r, e, t, n, o, a, i, s, l, c, u, d, f) => {
                ...
                r6(h, function () {
                    ...
                    rW([r, e, t], n ? [n] : [], (e) => {
                        ...
                        m.baseClass &&
                            (null != (o = m.baseClass).__derivedClasses || (o.__derivedClasses = []),
                    ...
                    rW([], [r], (r) => {
                        ...
                        return (
                            ...
                            rW(
                                ...
                                (n) => (
                                    n.splice(1, 0, null),
                                    (r.registeredClass.constructor_body[e - 1] = ep(t, n, null, o, a)),
                                    []
                                ),
                            ),
                            []
                    ...
                    rW([], [r], (r) => {
                        ...
                        return (
                            ...
                            (void 0 === d.overloadTable && d.className !== r.name && d.argCount === t - 2)
                                ...
                                : (r5(c, e, n), (c[e].overloadTable[t - 2] = o)),
                            rW([], u, (o) => {
            ...
            X: (r, e, t, n, o, a, i, s, l, c, u, d) => {
                (t = rj(t)),
                    ...
                    (c = es(l, c)),
                    (d = es(u, d)),
                    rW([r], [e], (r) => ((r = r[0]), [new en(t, r.registeredClass, !1, !1, !0, r, n, a, s, c, d)]));
            },
            U: (r, e) => {
                rB(r, {
                    name: (e = rj(e)),
                    ...
                    toWireType(r, e) {
                        ...
                        n ||
                            ...
                            rR("Cannot pass non-string to std::string"),
                            (t = n ? rh(e) : e.length);
                        var o = e4(4 + t + 1),
                            a = o + 4;
                        if (((p[o >> 2] = t), n)) rD(e, a, t + 1);
                            ...
                            for (var i = 0; i < t; ++i) {
                                ...
                                s > 255 && (e5(a), rR("String has UTF-16 code units that do not fit in 8 bits")),
                                    (u[a + i] = s);
                            }
            ...
            t: (r, e, t) => {
                ...
                (t = rj(t)),
                    2 === e
                        ? ((n = eT), (o = eC), (i = eA), (a = (r) => f[r >> 1]))
                        : 4 === e && ((n = e$), (o = eF), (i = eD), (a = (r) => p[r >> 2])),
                    rB(r, {
                        name: t,
                        fromWireType: (r) => {
        ...
        function e7() {
            ...
            function n() {
                ...
                if (!A && ((A = !0), (r.calledRun = !0), !W)) {
                    if (
                        (r.noFSInit || rA.initialized || rA.init(),
                        (rA.ignorePermissions = !1),
                        rv.init(),
                        Q(z),
                        e(r),
