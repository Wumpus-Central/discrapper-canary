...
async function Z(e) {
    ...
    try {
        ...
        return (n.thumbnail = o), (n.length = e), N.jF.info('Clip save succeeded with '.concat(e, 'ms and thumbnail ').concat(null != (f = null == o ? void 0 : o.length) ? f : 0, ' bytes thumbnail.')), await s.updateClipMetadata(i, JSON.stringify(n)), D(R({}, n), { filepath: i });
    } catch (i) {
        if (
            (null != e &&
                o.Z.dispatch({
