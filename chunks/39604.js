...
function M(e) {
    ...
    a.Z.dispatch({
        type: "CLIPS_SETTINGS_UPDATE",
        settings: w(P({}, t && { clipsEnabled: !0 }), { decoupledClipsEnabled: t }),
    }),
        n &&
            b.default.track(
                N.rMx.CLIPS_SETTINGS_UPDATED,
                w(P({}, t && { clips_enabled: !0 }), { decoupled_clips_enabled: t }),
            );
}
function k(e) {
    a.Z.dispatch({
...
function Z(e) {
    ...
    if (null != e) {
        ...
        (n = null != t ? g.Z.getRTCConnection((0, c.V9)(t)) : null),
...
async function V(e) {
    ...
    try {
        ...
        return (
            ...
            await s.updateClipMetadata(i, JSON.stringify(n)),
            w(P({}, n), { filepath: i })
        );
    } catch (i) {
        if (
...
async function H(e) {
    ...
    let s = O.Z.getSettings().clipsEnabled && null != p.Z.getCurrentUserActiveStream(),
        f =
            n &&
            O.Z.getSettings().decoupledClipsEnabled &&
...
async function q(e) {
    ...
    let n = await o.Z.clips.loadClipsDirectory(e),
        r = [];
    for (let e of n) {
        let t = await (0, T.w)(w(P({}, e.metadata), { filepath: e.filepath }));
        null != t && r.push(t);
    }
    a.Z.dispatch({
