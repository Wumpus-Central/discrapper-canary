...
async function H(e) {
    ...
    try {
        ...
        (N.jF.error('Clip Failed to Save', e), null == T || T.stop(), (0, d.GN)('clip_error', 0.5), o.Z.dispatch({ type: 'CLIPS_SAVE_CLIP_ERROR' }));
    }
...
async function q(e) {
    ...
    let n = await a.Z.clips.loadClipsDirectory(e),
        r = [];
    for (let e of n) {
        let t = await (0, T.w)(D(P({}, e.metadata), { filepath: e.filepath }));
        null != t && r.push(t);
    }
    o.Z.dispatch({
