...
async function Z(e) {
    ...
    try {
        ...
        return (n.thumbnail = a), (n.length = e), N.jF.info('Clip save succeeded with '.concat(e, 'ms and thumbnail ').concat(null != (f = null == a ? void 0 : a.length) ? f : 0, ' bytes thumbnail.')), await s.updateClipMetadata(i, JSON.stringify(n)), D(R({}, n), { filepath: i });
    } catch (i) {
        if (
            (null != e &&
                a.Z.dispatch({
...
async function H(e) {
    ...
    try {
        ...
        N.jF.error('Clip Failed to Save', e), null == S || S.stop(), (0, d.GN)('clip_error', 0.5), a.Z.dispatch({ type: 'CLIPS_SAVE_CLIP_ERROR' });
    }
    N.jF.info(''.concat(O.Z.getSettings().clipsLength / 1000, 's clip save took ').concat(Math.round(performance.now() - T), 'ms'));
}
function Y(e, t) {
    a.Z.dispatch({
...
async function q(e) {
    var t;
    if (!(0, y.isDesktop)() || (null == (t = o.Z.clips) ? void 0 : t.loadClipsDirectory) == null) return;
