...
function t_(e) {
    ...
    let o = (0, c.yK)([eH.A], () => eH.A.getClips()),
        ...
        _ = (0, c.bG)([eQ.Ay], () => eQ.Ay.getKeybindForAction(tl.hCu.SAVE_CLIP)),
        f = r.useRef(null),
        h = r.useMemo(() => {
    ...
    (0, eW.t)(f);
    let g = (0, e1.$)(u.clipsLength / eJ.A.Millis.SECOND),
                ...
                children: [
                    (0, i.jsxs)("div", {
                        ...
                        children: [
                            ...
                            null != m && (0, i.jsx)(eK.e, { className: td.P, shortcut: m }),
                        ],
                    }),
                    (0, i.jsxs)("div", {
                        className: td.$s,
...
function tf(e) {
    let { keybindString: t } = e,
        n = (0, e6.Et)(),
        s = r.useCallback(() => {
            window.open(e0.A.getArticleURL(tl.MVz.CLIPS), "_blank", "noopener,noreferrer");
        }, []),
        a = r.useCallback(() => {
            e4.yO({ clipsEnabled: !0, trackAnalytics: !0 });
        }, []);
    return (0, i.jsxs)("div", {
        className: td.p$,
        children: [
...
var nq = n(371912),
    ...
    n4 = n(499156),
    n5 = n(731854);
let n7 = 2.5 * eJ.A.Millis.SECOND,
    n8 = +eJ.A.Millis.HOUR;
var n9 = n(459838),
    ie = n(485296);
let it = 3 * eJ.A.Millis.SECOND,
    ii = +eJ.A.Millis.DAY;
var ir = n(616356),
    is = n(734057),
    ia = n(629016),
    ...
    t = E
        ...
        : A || m
          ? {
                ...
                tooltipText: ep.intl.format(ep.t.c1qUOQ, { keybind: e2.dI(y).toLocaleUpperCase() }),
                tooltipForceOpen: !0,
            }
          : { tooltipText: F };
    let B = S && N && v,
...
let rh = i_.Ay.getEnableHardwareAcceleration() ? f.Js : f.eu,
    rp = 2.5 * eJ.A.Millis.SECOND,
    rE = 2 * eJ.A.Millis.MINUTE,
    rm = 2 * eJ.A.Millis.MINUTE,
    rg = 5 * eJ.A.Millis.SECOND;
function rA(e) {
    let {
            ref: t,
            speaking: n,
