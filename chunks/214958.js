        ...
        function A(e) {
            ...
            if (
                ...
                /\bAndroid\b/.test(V) &&
                    ...
                    (x = g(s[1]).replace(/^[a-z]{2}-[a-z]{2};\s*/i, "") || null),
                G && !x
                    ? (x = F([G]))
                    : G &&
                      x &&
            ...
            if (
                ...
                "Fennec" == k || ("Firefox" == k && /\b(?:Android|Firefox OS|KaiOS)\b/.test(V)))
            )
                k = "Firefox Mobile";
