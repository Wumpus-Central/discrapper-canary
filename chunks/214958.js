        ...
        function S(e) {
            ...
            if (
                ...
                /\bAndroid\b/.test(B) &&
                    ...
                    (V = y(t[1]).replace(/^[a-z]{2}-[a-z]{2};\s*/i, "") || null),
                F && !V
                    ? (V = K([F]))
                    : F &&
                      V &&
                      (V = V.replace(RegExp("^(" + I(F) + ")[-_.\\s]", "i"), F + " ").replace(
                          RegExp("^(" + I(F) + ")[-_.]?(\\w)", "i"),
                          F + " $2",
                      )),
            ...
            if (
                ...
                "Fennec" == G || ("Firefox" == G && /\b(?:Android|Firefox OS|KaiOS)\b/.test(B)))
            )
                G = "Firefox Mobile";
            ...
            (t = (/\bAppleWebKit\/([\d.]+\+?)/i.exec(e) || 0)[1]) &&
                ...
                "Safari" == G && (!k || parseInt(k) > 45)
                    ? (k = t)
                    : "Chrome" == G && /\bHeadlessChrome/i.test(e) && x.unshift("headless")),
                "Opera" == G && (t = /\bzbov|zvav$/.exec(B))
                    ? ((G += " "),
                      x.unshift("desktop mode"),
                      "zvav" == t ? ((G += "Mini"), (k = null)) : (G += "Mobile"),
                      (B = B.replace(RegExp(" *" + t + "$"), "")))
                    : "Safari" == G && /\bChrome\b/.exec(U && U[1])
                      ? (x.unshift("desktop mode"),
                        (G = "Chrome Mobile"),
                        (k = null),
                        /\bOS X\b/.test(B) ? ((F = "Apple"), (B = "iOS 4.3+")) : (B = null))
                      : /\bSRWare Iron\b/.test(G) && !k && (k = z("Chrome")),
                k &&
