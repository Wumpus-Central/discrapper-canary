...
function E(e, t, n, r, a) {
    ...
    let u = () => {
        (t.backoff = null != t.backoff ? t.backoff : new s.A()),
            ...
            t.backoff.fail(() => C(t.url).then(() => E(e, t, n, r, a)));
    };
    R?.prepareRequest?.(o),
        ...
        o.then(
            (i) => {
                ...
                if (t?.interceptResponse?.(i, d, c) !== !0 && R?.interceptResponse?.(i, d, c) !== !0) {
                    if (i.ok) n(s);
                    else {
...
function p(e) {
    ...
    let n = t.queue.shift();
    if (null == n) {
        c.verbose("rateLimitExpirationHandler: removing key for", e), h.delete(e);
        return;
    }
...
function m(e, t) {
    ...
    if (null != t && 429 === t.status) {
        ...
        c.verbose(`cleanupRequestEntry: rate limit for ${e.url} retry after ${r} seconds`);
        let s = setTimeout(() => p(e.url), 1e3 * r);
        h.set(e.url, {
            queue: n?.queue ?? [],
        ...
        null != n &&
            ...
            (c.verbose("cleanupRequestEntry: rate limit for ", e.url, "expired"), p(e.url));
}
function g(e, t, n) {
    return new Promise((r, i) => {
        ...
        null != s
            ? (c.verbose("makeRequest: queueing request for ", t.url), s.queue.push(E.bind(null, e, t, r, i, n)))
            : E(e, t, r, i, n);
    });
}
