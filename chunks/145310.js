...
let o = (t) => {
    var i;
    let { subscriptionTier: n, hasActivePromotion: o = !1, useShorterCTA: p = !1, isPersistentCTA: v = !1 } = t,
        T = (0, l.V)(),
        c = T?.subscription_trial,
        _ = (0, e.O)(),
        d = (0, a.U9)(_, s.pe.TIER_2) ? s.pe.TIER_2 : void 0,
        b = (0, r.tS)({ intervalType: c?.interval, intervalCount: c?.interval_count }),
              ...
              : ((t) => {
                    ...
                    return i && a
                        ...
                        : i && (n === s.pe.TIER_2 || l)
                          ...
                          : i
                            ? u.intl.formatToPlainString(u.t.nTmm2v, { freeTrialText: e })
                            : void 0;
                })({
                    showTrialCTA: g,
                    subscriptionTier: k,
