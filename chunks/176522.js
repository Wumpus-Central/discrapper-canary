n.d(t, { M$: () => b, Fv: () => f, kF: () => O, Oc: () => m, GY: () => R }), n(667532);
var i = n(310953),
    l = n(473529),
    s = n(519059),
    r = n(380335),
    ...
    C = n(746080);
let _ = () => {
    let e = r.A.getMessageRequestsCount() > 0 || o.A.getSpamChannelsCount() > 0;
    return [
        g.BVt.FRIENDS,
        (0, s.HF)("navigateToChannel") ? g.BVt.ICYMI : null,
...
function I() {
    ...
    if (null == t)
        !(function (e) {
            var t, n;
            let { channelId: i, path: l, basePath: s } = a.A.getState(),
                r = h.A.getPrivateChannelIds(),
                o = __OVERLAY__ ? r : [..._(), ...r],
                d =
                    (null == i ? ((t = l ?? s), _().findIndex((e) => t.startsWith(e))) : null != i ? o.indexOf(i) : 0) +
                    e;
