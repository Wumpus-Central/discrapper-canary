    ...
    n.d(t, {
        transitionToGlobalDiscovery: () =>
            function e(t) {
                var n, g, b;
                let h = t.tab;
                switch ((_.Z.setState({ selectedTab: h }), h)) {
                    case d.GlobalDiscoveryTab.SERVERS:
                        ...
                        return (
                            null != m
                                ...
                                : o.Z.setState({ entrypoint: null !== (g = t.entrypoint) && void 0 !== g ? g : p.Qq.UNKNOWN }),
                        ...
                        if (null != t.newSessionState) {
                            ...
                            if (
                                ...
                                s.default.track(u.rMx.APP_DIRECTORY_OPENED, {
                                    ...
                                    session_id: n,
                                    guild_id: o,
                                    user_id: null === (b = c.default.getCurrentUser()) || void 0 === b ? void 0 : b.id
                                }),
