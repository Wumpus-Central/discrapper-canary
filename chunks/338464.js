...
let _ = (e) => {
        ...
        return (0, r.jsxs)("div", {
            className: a()(d.KT, t === u.tm.TOP_GUILD_EMOJI ? d.S7 : d.lD),
            children: [
            ...
            children: [
                ...
                (0, r.jsxs)("div", {
                    ...
                    children: [
                            ...
                            children: [
                                f
                                    ? (0, r.jsx)(s.Gg5, {
                                          ...
                                          color: "currentColor",
                                          "aria-label": f
                                              ? c.intl.formatToPlainString(c.t["+fdUkf"], { names: o })
                                              : void 0,
                                          width: 15,
                                          height: 15,
                                          className: d.BI,
                        ...
                        null != l && (0, r.jsx)(s.Text, { className: d.Fm, variant: "text-xs/normal", children: l }),
                    ],
                }),
                p === u.tm.NONE
