...
let A = i.memo(function (e) {
    ...
    w = i.memo(function (e) {
        ...
        (0, h.ZP)(() => {
            if (!m) return;
            let e = setTimeout(() => _(!1), 1000);
            return () => clearTimeout(e);
        });
        let v = t.getGuildId();
        s()(null != v, 'Channel cannot be guildless');
        let { isMobile: E, status: N } = (0, c.cj)([C.Z], () => ({
                isMobile: C.Z.isMobileOnline(l.user.id),
                status: C.Z.getStatus(l.user.id, v)
            })),
            I = (0, c.e7)([y.ZP], () => y.ZP.getMember(v, l.user.id)),
            A = (0, g.X)(t.guild_id, null == I ? void 0 : I.colorStrings),
...
function M(e) {
    let { channel: t, toggleRequestToSpeakSidebar: n, chatOpen: i } = e,
        l = (0, v.Fd)(t.id),
        a = [+!!(0, c.e7)([_.Z], () => _.Z.can(I.Pl.MANAGE_CHANNELS, t) || _.Z.can(I.Pl.MANAGE_ROLES, t)), Math.max(1, l.length)];
    return (0, r.jsxs)('div', {
