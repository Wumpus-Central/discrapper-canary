...
function L(e) {
    let { channel: t, toggleRequestToSpeakSidebar: n, chatOpen: i } = e,
        l = (0, v.Fd)(t.id),
        s = [
            +!!(0, c.e7)([_.Z], () => _.Z.can(Z.Pl.MANAGE_CHANNELS, t) || _.Z.can(Z.Pl.MANAGE_ROLES, t)),
            Math.max(1, l.length),
        ];
    return (0, r.jsxs)("div", {
