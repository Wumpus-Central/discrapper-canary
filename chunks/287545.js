...
async function Q(e) {
    ...
    let { applicationId: i, location: a, instanceId: o } = e,
        s = w.ZP.getEmbeddedActivityDurationMs(a.id, i),
        u = b.default.getSessionId();
    null != o &&
        null != u &&
        (await l.tn.post({
            url: V.ANM.ACTIVITY_LEAVE(i, a.id, o),
            body: { session_id: u },
            retries: 2,
            rejectWithError: !1
        }));
    let c = W[i],
        d = I.Z.getChannel((0, B.p)(a)),
        f = A.default.getCurrentUser();
    if (null == c || null == d || null == f) return;
    let p = d.getGuildId(),
        h = w.ZP.getShelfActivities(p),
        m = (0, P.Z)({
            applicationId: i,
            activityConfigs: h
        }),
        { releasePhase: g } = z(m),
        E = _.Z.getRawThermalState();
    C.default.track(V.rMx.ACTIVITY_SESSION_LEFT, {
        channel_id: d.id,
        guild_id: p,
        ...
        C.default.track(V.rMx.ACTIVITY_IFRAME_UNMOUNT, {
            channel_id: d.id,
            guild_id: p,
            application_id: i,
...
function X(e) {
    var n, r, i;
    let { applicationId: a, isFirstActivityInChannel: o, isStart: l, participants: u, embeddedActivity: d, location: p, inviterUserId: m } = e,
        g = b.default.getId(),
    ...
    !(0, O.Ew)(E.nonce) && E.nonce !== (null == Q ? void 0 : Q.nonce) && (Q = void 0),
        C.default.track(V.rMx.ACTIVITY_SESSION_JOINED, {
            channel_id: y.id,
            ...
            raw_thermal_state: H,
            n_participants: h.Z.getUserParticipantCount(y.id),
            is_activity_start: l,
            release_phase: j,
        ...
        C.default.track(V.rMx.ACTIVITY_IFRAME_MOUNT, {
            location_stack: null == Q ? void 0 : Q.locations,
            channel_id: y.id,
            channel_type: y.type,
            guild_id: y.getGuildId(),
...
class $ extends d.Z {
    _initialize() {
        S.Z.addChangeListener(this.handleSelectedChannelUpdate), N.S.subscribe(V.CkL.RELEASE_ACTIVITY_WEB_VIEW, this.handleActivityWebViewRelease), N.S.subscribe(V.CkL.OPEN_EMBEDDED_ACTIVITY, X), u.Z.subscribe('EMBEDDED_ACTIVITY_LAUNCH_START', q), u.Z.subscribe('EMBEDDED_ACTIVITY_LAUNCH_SUCCESS', this.handleActivityLaunchSuccess), u.Z.subscribe('EMBEDDED_ACTIVITY_LAUNCH_FAIL', this.handleActivityLaunchFail), u.Z.subscribe('EMBEDDED_ACTIVITY_CLOSE', Q), u.Z.subscribe('EMBEDDED_ACTIVITY_DEFERRED_OPEN', this.handleDeferredOpen), u.Z.subscribe('RPC_APP_DISCONNECTED', this.handleRPCDisconnect), u.Z.subscribe('CALL_DELETE', this.handleCallDelete), u.Z.subscribe('RTC_CONNECTION_STATE', this.handleRTCConnectionState), u.Z.subscribe('GUILD_DELETE', this.handleGuildDelete), u.Z.subscribe('CHANNEL_DELETE', this.handleChannelDelete);
    }
    _terminate() {
        S.Z.removeChangeListener(this.handleSelectedChannelUpdate), N.S.unsubscribe(V.CkL.RELEASE_ACTIVITY_WEB_VIEW, this.handleActivityWebViewRelease), N.S.unsubscribe(V.CkL.OPEN_EMBEDDED_ACTIVITY, X), u.Z.unsubscribe('EMBEDDED_ACTIVITY_LAUNCH_START', q), u.Z.unsubscribe('EMBEDDED_ACTIVITY_LAUNCH_SUCCESS', this.handleActivityLaunchSuccess), u.Z.unsubscribe('EMBEDDED_ACTIVITY_LAUNCH_FAIL', this.handleActivityLaunchFail), u.Z.unsubscribe('EMBEDDED_ACTIVITY_CLOSE', Q), u.Z.unsubscribe('EMBEDDED_ACTIVITY_DEFERRED_OPEN', this.handleDeferredOpen), u.Z.unsubscribe('RPC_APP_DISCONNECTED', this.handleRPCDisconnect), u.Z.unsubscribe('CALL_DELETE', this.handleCallDelete), u.Z.unsubscribe('RTC_CONNECTION_STATE', this.handleRTCConnectionState), u.Z.unsubscribe('GUILD_DELETE', this.handleGuildDelete), u.Z.unsubscribe('CHANNEL_DELETE', this.handleChannelDelete);
    }
    constructor(...e) {
        super(...e),
            ...
            H(this, 'handleActivityLaunchFail', async (e) => {
                let n,
                    ...
                    c = K[l];
                null != c && c.nonce === o ? delete K[l] : (c = void 0);
                ...
                let p = I.Z.getChannel(s);
                if (null == p) return;
                let h = p.getGuildId(),
                    y = _.Z.getRawThermalState();
                C.default.track(V.rMx.ACTIVITY_SESSION_JOIN_FAILED, {
                    channel_id: s,
                    guild_id: h,
                    application_id: l,
                    raw_thermal_state: y,
            ...
            H(this, 'handleDeferredOpen', async (e) => {
                ...
                let { channelId: a, applicationId: o, analyticsLocations: s, commandOrigin: l, inviterUserId: u } = e,
                    c = I.Z.getChannel(a);
                if (void 0 === c || (y.tx.has(null == c ? void 0 : c.type) && S.Z.getVoiceChannelId() !== a)) return;
                let d = w.ZP.getSelfEmbeddedActivityForChannel(a);
                if ((null == d ? void 0 : d.applicationId) === o) return;
                let f = await p.ZP.fetchApplication(o);
                if (!(0, U.a)(c)) {
                ...
                let g = w.ZP.getEmbeddedActivitiesForChannel(a).find((e) => e.applicationId === o);
