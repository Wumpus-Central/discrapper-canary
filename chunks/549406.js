...
let ec = {
    ...
    [p.IWg.SCROLL_UP]: P.U5,
    [p.IWg.SCROLL_DOWN]: P.fz,
    [p.IWg.QUICKSWITCHER_SHOW]: G.R,
    ...
    [p.IWg.CREATE_GUILD]: {
        ...
        action() {
            (0, S.hasModalOpen)(m.fc)
                ? N.A.updateCreateGuildModal({ slide: m.oS.JOIN_GUILD, location: "Keyboard Shortcut" })
    ...
    [p.IWg.BROWSER_DEVTOOLS]: {
        ...
        comboKeysBindGlobal: !0,
        action(e) {
            if ((0, L.isWeb)() && "discord.com" === location.host) return e.preventDefault(), e.stopPropagation(), !1;
        },
    },
