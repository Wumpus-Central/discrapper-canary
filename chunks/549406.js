n.d(t, { Bx: () => eu, Ay: () => eA, Gm: () => ea, Q_: () => es, zF: () => eo, zR: () => ec });
var i,
    l = n(774603),
    r = n(176522),
    s = n(435558),
...
let ec = {
    ...
    [p.IWg.UPLOAD_FILE]: {
        ...
        comboKeysBindGlobal: !0,
        action() {
            let e = u.A.getChannel(A.Ay.getChannelId());
    ...
    [p.IWg.OPEN_APP_DIRECTORY]: {
        ...
        action() {
            ...
            (0, D.transitionToGlobalDiscovery)({
                ...
                newSessionState: { guildId: e ?? null, entrypoint: { name: y.sW.KEYBOARD_SHORTCUT } },
            });
        },
    },
