...
function T(e) {
    let {
        ...
        { analyticsLocations: E } = (0, p.Ay)(r, _.A.GROUP_DM_ICON_EDITOR),
        C = o ? 32 : 64;
    return (0, i.jsxs)("div", {
        className: s()(N.r2, m),
        children: [
            (0, i.jsxs)(c.D, {
                className: s()(N.zc, { [N.ud]: o }),
                "aria-label": v.intl.string(v.t["0qPSMV"]),
                onClick: () => (0, S.F5)(l, E),
                children: [
                    null != g
                        ? (0, i.jsx)("img", { src: g, alt: "", className: N.Dp })
                        : (0, i.jsx)("div", {
                              className: N.Pz,
...
let y = function (e) {
    let {
        ...
        M = void 0 !== j,
        { analyticsLocations: L } = (0, p.Ay)(d, _.A.GROUP_DM_EDIT_MODAL),
        D = {
            channel_id: t,
            channel_type: u?.type,
            location: d,
        ...
        : (0, i.jsx)(p.f5, {
              ...
              children: (0, i.jsx)("form", {
                  ...
                  children: (0, i.jsx)(r.Modal, {
                      ...
                      actions: [
                          { text: v.intl.string(v.t["ETE/oC"]), variant: "secondary", onClick: c },
                          {
