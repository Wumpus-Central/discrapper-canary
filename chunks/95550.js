...
let em = (0, k.Ld)(),
    ...
    eg = (e) => {
        let { onConfirm: t, channelIds: n, ...l } = e,
            a = (0, c.yK)([K.A], () => Array.from(n).map(K.A.getChannel), [n]);
...
class e_ extends l.PureComponent {
    ...
    pushToExistingDM = (e, t) => {
        let n = this._searchCounter,
            i = (0, P.dI)(e),
            l = J.A.getChannelId() === e.id;
        T.A.addRecipients(e.id, t, ec.ThZ.ADD_FRIENDS_TO_DM).then((n) => {
            if ((this.props.onComplete?.(n), l)) {
                if (e.isDM() && n !== e.id) return void N.A.call(n, !1, !0);
                N.A.ring(n, t, "dm_invite");
            }
        }),
            ee.default.track(ec.HAw.CREATE_DM_USER_LIST_CLICKED, {
                ...i,
...
function ef(e) {
    ...
    return (0, i.jsx)(e_, { channel: t, isStaffOnlyDM: s, onComplete: n, ...l, ...a });
}
function eE(e) {
...
function eI(e) {
    let t = ev(e);
    return new Set(
        (0, a.chain)(K.A.getMutablePrivateChannels())
            .values()
