...
let X = (e) => {
    let { selectedPlanId: t, paymentSources: n, trialId: l, metadata: i, isTrial: a = !1 } = e,
        ...
        ee = M && (0, D.Ik)(b),
        et = u.paymentSourceId,
        en = (0, j.g)(n, et),
        el = (0, E.vg)("PremiumSubscriptionReview") ? (x?.find((e) => e.id === et)?.relocationCountry ?? null) : null,
        { hasEntitlements: er, entitlements: ei } = (0, V.X)(W.id, M),
        ea = (0, U.J$)(u.paymentSourceId),
        es = (0, y.A)({ forceFetch: !1, excludeReverseTrial: !1, excludeReverseTrialFromCountdown: !0 }),
        eo = !B && (es.isFractionalPremiumActive || O) && q.JM.has(t),
        eu = r.useMemo(() => (0, U.Tm)({ skuId: s, isPremium: A, defaultPlanId: p }), [s, p, A]),
        ec = r.useMemo(
            () => (er && null == et ? $.intl.format($.t["2wPRSF"], { months: ei.length }) : null),
            [er, et, ei],
        );
    return {
        disabled: H,
