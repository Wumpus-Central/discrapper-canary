...
function v(e) {
    ...
    return (0, i.jsxs)(C.B, {
        ...
        children: [
            ...
            (0, i.jsx)(R.E, { variant: "text-xs/medium", children: t }),
        ],
    });
}
function b(e) {
...
function B(e) {
    ...
    return (0, i.jsxs)("div", {
        ...
        children: [
            ...
            (0, i.jsx)(R.E, { className: V.TK, variant: "text-xs/medium", lineClamp: 1, children: t }),
        ],
    });
}
function H(e) {
...
function Q(e) {
    ...
    return (0, i.jsxs)("div", {
        className: q.Kk,
        children: [
            (0, i.jsx)("img", { className: S()({ [q.um]: r }), src: t, alt: n }),
            r &&
                (0, i.jsx)("div", {
                    className: q.pp,
                    children: (0, i.jsxs)(R.E, { variant: "text-xs/medium", className: q.gq, children: ["+", a] }),
                }),
        ],
    });
}
...
function ee(e) {
    let { user: t, widgets: n = [], ...g } = e,
        ...
        R = r.useMemo(() => C.map((e) => e.applicationId), [C]),
        O = (0, _.A)(R),
        L = r.useMemo(() => new Map(O.filter(h.Vq).map((e) => [e.id, e])), [O]),
        D = (0, u.A)(R),
