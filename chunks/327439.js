        ...
        if (
                    ...
                    if (s(this, _)[o])
                        throw Error(
                            "You must specify a unique 'id' property in your Backend entry:\n        "
                                ...
                                .concat(JSON.stringify(s(this, _)[o]), ")"),
                        );
                    return {
                        id: o,
                        instance: a,
            ...
            o(this, "teardown", () => {
                "undefined" != typeof window &&
                    ((S.isSetUp = !1), s(this, b).call(this, window), s(this, _)[s(this, f)].instance.teardown());
            }),
            ...
            o(this, "profile", () => s(this, _)[s(this, f)].instance.profile()),
            o(this, "previewEnabled", () => s(this, _)[s(this, f)].preview),
            o(this, "previewsList", () => s(this, p)),
            o(this, "backendsList", () => s(this, m)),
            i(this, E, {
                writable: !0,
                value: (e) => {
                    s(this, m).forEach((t) => {
            ...
            i(this, y, {
                ...
                value: (e) => {
                    ...
                    if (
                        (s(this, m).some(
                            (t) =>
                                !!(t.id !== s(this, f) && t.transition && t.transition.check(e)) &&
                                (c(this, f, t.id), !0),
                        ),
                        s(this, f) !== t)
                    ) {
                        var n;
                        s(this, _)[t].instance.teardown(),
                            Object.keys(s(this, h)).forEach((e) => {
                                let t = s(this, h)[e];
