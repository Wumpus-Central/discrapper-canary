...
function em(e) {
    ...
    q('handleConnectionOpen called'), I.Z.setUser(n.id, n.username, null !== (t = n.email) && void 0 !== t ? t : void 0, (0, E.Z)(n)), (L = i), (x = r), (P = o), (k = a), (D = n.id), void 0 !== s && (B = s.authenticator_types), u.K.set(O, n.id);
}
function eg(e) {
    var t;
