...
function eb(e) {
    ...
    X("handleConnectionOpen called"),
        ...
        et(o),
        (P = n.id),
        void 0 !== a && (G = a.authenticator_types),
        c.K.set(R, n.id);
}
function ey(e) {
    var t;
...
function eO(e) {
    ...
    if (4004 === t) {
        ...
        b.default.track(T.rMx.APP_USER_DEAUTHENTICATED, { user_id: c.K.get(R) }),
            eS(),
            setImmediate(() => (0, g.uL)(T.Z5c.DEFAULT_LOGGED_OUT));
    }
}
function ev(e) {
