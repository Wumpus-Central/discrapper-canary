...
async function B(e) {
    ...
    function Q() {
        '' !== Y.content && '' === P.Z.getDraft(w, U) && o.Z.saveDraft(w, Y.content, U),
    ...
    return (
        ...
        Z.on('error', (e, t, n, r) => {
            if (
                ...
                return void a.Z.sendExplicitMediaClydeError(w, null == n ? void 0 : n.attachments, p.UU.EXPLICIT_MEDIA_MESSAGE_SEND_BLOCKED);
