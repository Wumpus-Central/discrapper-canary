...
async function k(e) {
    ...
    null != B && (H.content = null == B ? void 0 : B.content), null != E.Z.getPendingReply(k) && ((H.type = Z.uaV.REPLY), (H.message_reference = F.messageReference), (H.allowed_mentions = F.allowedMentions), (0, C.A6)(k));
    ...
    return (
        ...
        V.on('error', (e, t, n, i) => {
            ...
            if (t !== Z.evJ.GUILD_FILE_UPLOAD_RATE_LIMITED_ACCESS) {
                ...
                '' !== H.content && '' === P.Z.getDraft(k, U) && o.Z.saveDraft(k, H.content, U),
...
let D = {
    instantBatchUpload: function (e) {
        let { channelId: t, files: n, draftType: i, isThumbnail: r = !1, filesMetadata: o = [] } = e,
    ...
    upload: function e(t) {
        let { channelId: n, file: l, draftType: c, message: u, hasSpoiler: d, filename: h } = t,
            f = {
                content: '',
                tts: !1,
                hasSpoiler: d,
        ...
        if (null != u) {
            ...
            let e = E.Z.getPendingReply(n);
            if (null != e) {
                let t = a.Z.getSendMessageOptionsForReply(e);
                (f.type = Z.uaV.REPLY), (f.message_reference = t.messageReference), (f.allowed_mentions = t.allowedMentions), (0, C.A6)(n);
            }
        }
        ...
        g.on('start', (e) => {
            ...
            g.on('error', (t, d, h) => {
                ...
                (0, s.openUploadError)({
                    ...
                    '' !== f.content && '' === P.Z.getDraft(n, c) && o.Z.saveDraft(n, f.content, c);
            }),
            g.on('complete', (e) => {
                r.Z.dispatch({
                    type: 'UPLOAD_COMPLETE',
