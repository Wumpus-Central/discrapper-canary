...
class L extends l.A {
                ...
                "laughter" === n.label
                    ? (e.laughterData.push({ timestamp_ms: n.timestamp_ms, value: n.confidence }),
                      O(e.laughterData, 0.5) &&
                          this.process(
                              { type: R.Gy.LAUGHTER, userId: t.user_id, confidence: n.confidence },
                              n.timestamp_ms,
                          ))
                    : "shouting" === n.label
                      ? (e.shoutingData.push({ timestamp_ms: n.timestamp_ms, value: n.confidence }),
                        O(e.shoutingData, 0.35) &&
                            this.process(
                                { type: R.Gy.SHOUTING, userId: t.user_id, confidence: n.confidence },
                                n.timestamp_ms,
                            ))
    ...
    handleSpeaking(e) {
        ...
        (e.userId === E.default.getId() || t) &&
            this.process({ type: R.Gy.SPEAKING, speakingFlags: e.speakingFlags, userId: e.userId });
    }
            ...
            case R.Gy.GAME_EVENT: {
                ...
                if (
                    this.scheduledClips.some(
                        (e) =>
                            (e.signal.type === R.Gy.GAME_EVENT ||
                                e.signal.type === R.Gy.LAUGHTER ||
                                e.signal.type === R.Gy.SHOUTING) &&
    ...
    canScheduleClipCandidate(e) {
        ...
        return e.type === R.Gy.GAME_EVENT && i && r;
    }
    scheduleClip(e, t) {
            ...
            c.timeout.start(l > a ? l - a : 0, async () => {
                try {
                    ...
                    R.nx.info(
                        ...
                        await (0, g.yd)({
                            clipMethod: e.type === R.Gy.MANUAL ? "manual" : "auto",
                            request: t,
    ...
    debugCreateRankableLaughterClip() {
        ...
        this.process({ type: R.Gy.LAUGHTER, userId: e, confidence: 1 });
    }
