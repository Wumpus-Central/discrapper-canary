...
function A(e, t, n, g) {
    ...
    if (E.length > 0 && T.test(E)) return new Date(NaN);
    var et = q
            .map(function (e) {
                return e.priority;
            })
