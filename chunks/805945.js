...
let X = i.forwardRef(function (e, t) {
    ...
    let h,
        ...
        ed = (0, H.v)(p, f?.guild_id),
        {
            ...
            p,
            f?.id ?? null,
            (el ? O.HO.getSetting() : O.dG.getSetting()?.volume) ?? 100,
            ...
            !p.available &&
                (0, l.jsx)(d.m, {
                    ...
                    children: (0, l.jsx)("div", {
                        className: q.ET,
                        children: !ee && (0, l.jsxs)("div", { className: q.ld, children: [eO, eD] }),
                    }),
                }),
            !0 === el && (0, l.jsx)(M, { sound: p, containerDimensions: eU, ref: ei }),
        ],
    });
});
