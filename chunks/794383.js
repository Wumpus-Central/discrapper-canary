...
var r = n(812729),
    ...
    f = n(351906),
    E = n(652215);
let h = +c.A.Millis.MINUTE,
    p = 5 * c.A.Millis.MINUTE,
    m = /live_user_(.*)-\{width\}/,
    g = null,
    A = 0,
    I = null,
...
let O = new (class {
    ...
    async _checkTwitch(e) {
        ...
        try {
            ...
            let { thumbnail_url: i, game_id: s, title: a } = r,
                o = { large_image: null != i ? ((0, d.Di)(E.fg2.TWITCH, i) ?? void 0) : void 0 },
                l = await N(s, t),
                c = u.A.get(E.fg2.TWITCH),
                _ = m.exec(i)?.[1] ?? e.name,
                f = null != a && "" !== a ? a.slice(0, 128) : void 0,
                h = null != l && "" !== l ? l.slice(0, 128) : void 0;
            return {
                url: c.getPlatformUserUrl?.({ id: e.id, name: _ }),
                name: c.name,
                assets: o,
                details: f,
                state: h,
    ...
    async _checkYouTube(e) {
        ...
        try {
            ...
            let {
                ...
                o = { large_image: (0, d.Di)(E.fg2.YOUTUBE, s.high.url) ?? void 0 },
                l = null != i && "" !== i ? i.slice(0, 128) : void 0;
            return (I = {
                url: `https://youtube.com/watch?v=${r}`,
                name: u.A.get(E.fg2.YOUTUBE).name,
                details: l,
                assets: o,
            });
        } catch (n) {
    ...
    _check() {
        ...
        let t = [E.fg2.TWITCH],
            n = Date.now();
        A <= n && (t.push(E.fg2.YOUTUBE), (A = n + p)),
            Promise.allSettled(
                e
                    .filter((e) => t.includes(e.type))
                    .map((e) => (e.type === E.fg2.TWITCH ? this._checkTwitch(e) : this._checkYouTube(e))),
            ).then((e) => {
                if (this._started) {
...
function R() {
    f.A.enabled ? O.start() : O.stop();
}
class v extends s.Ay.Store {
    static displayName = "ExternalStreamingStore";
    initialize() {
        R(), this.waitFor(_.A, f.A), this.syncWith([f.A], R);
    }
    getStream() {
        return g;
    }
