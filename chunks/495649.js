    ...
    constructor(...e) {
        (super(...e),
            ...
            m(this, 'handleChannelSelect', (e) => {
                ...
                (null != r && r.features.has(f.oNc.COMMUNITY) && d.Z.shouldFetchPrompts(g, 8 * l.Z.Millis.HOUR) && (0, u.rj)(g), this._openOnboardingIfIncomplete(g, n));
            }),
            ...
            m(this, '_openOnboardingIfIncomplete', async (e, t) => {
                ...
                if (null == s || !s.features.has(f.oNc.GUILD_ONBOARDING)) return;
