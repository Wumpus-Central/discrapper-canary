...
let M = i.memo(function (e) {
        ...
        let { item: l, ackedBeforeId: o } = e,
            ...
            f = i.useCallback(async () => {
                if ((p || (0, x.wt)(l), null != l.item_enum && l.item_enum === y.AM.FIND_FRIENDS))
            ...
            h = null;
        l.type === y.O7.INCOMING_FRIEND_REQUESTS && null != l.other_user
            ? (h = (0, r.jsx)(I.Z, { userId: l.other_user.id }))
            : l.type === y.O7.INCOMING_GAME_FRIEND_REQUESTS &&
              null != l.other_user &&
              (h = (0, r.jsx)(I.Z, {
