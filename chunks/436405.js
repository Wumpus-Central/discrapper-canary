...
class n7 extends a.PureComponent {
    ...
    renderTabBar() {
        let { selectedSection: e } = this.state,
            t = n3.A.isDeveloper
                ? (0, l.jsx)(nV.V.Item, { id: "DEVELOPER", className: n2.YU, children: "Developer" })
                : null;
        return (0, l.jsxs)(nV.V, {
            ...
            children: [
                (0, l.jsx)(nV.V.Item, { id: "GENERAL", className: n2.YU, children: U.intl.string(U.t["0FYxxw"]) }),
                (0, l.jsx)(nV.V.Item, { id: "VOICE", className: n2.YU, children: U.intl.string(U.t["3WeSiE"]) }),
                t,
            ],
        });
    }
...
function is(e) {
    let { guildId: t } = e,
        ...
        p = (0, r.bG)([e7.A], () => e7.A.getVoiceChannelId()),
...
let i2 = r.Ay.connectStores([tt.default], () => ({ opacity: tt.default.getTextWidgetOpacity() }))(i6);
var i8 = n(798805);
...
function ss(e) {
    let { contained: t = !1, ...n } = e,
        ...
        s = (0, r.bG)([e7.A], () => e7.A.getChannelId(i)),
...
function sX(e) {
    let t = (0, r.bG)([e7.A, e3.A], () => e3.A.getChannel(e7.A.getVoiceChannelId())),
        n = (0, t_.Ay)(t),
        i = (function () {
            let [e] = (0, r.bG)(
                [nM.Ay, sS.A, e7.A, e3.A],
                () => {
                    let e = e3.A.getChannel(e7.A.getVoiceChannelId());
                    return null == e
                        ? [[], -1]
                        : e.isGuildStageVoice()
...
let sq = r.Ay.connectStores([e2.A, tt.default], (e) => {
    let { widgetId: t } = e,
        n = e2.A.getWidget(t),
...
let s0 = r.Ay.connectStores([e2.A, tn.A], () => ({
...
let s7 = () =>
    (0, l.jsxs)(s1.dO, {
        children: [
            (0, l.jsx)(s6.A, {
                path: eE.BVt.CHANNEL(s2.pv.guildId(), s2.pv.channelId({ optional: !0 }), ":messageId?"),
                component: s8,
            }),
...
function li() {
    let [e, t] = (0, r.yK)([s9.A], () => [s9.A.enabled, s9.A.keepOpen]),
        n = (0, r.bG)([e7.A], () => e7.A.getVoiceChannelId()),
