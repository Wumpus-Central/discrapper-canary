...
class n2 extends a.PureComponent {
    ...
    handleToggleTextChatNotifications = () => {
        D.A.setNotificationDisabledSetting(n9.M.TEXT_CHAT, !this.props.textChatDisabled), n8();
    };
    handleToggleInviteNotification = () => {
        let e = this.props.shouldShowInviteNotification;
        D.A.setNotificationDisabledSetting(n9.M.GAME_ACTIVITY, !e);
    };
...
let i1 = Object.values(eT.Li).map((e) => 100 * e),
    i3 = (0, iq.Ld)();
class i9 extends a.PureComponent {
...
let i6 = r.Ay.connectStores([tt.default], () => ({ opacity: tt.default.getTextWidgetOpacity() }))(i9);
var i8 = n(798805);
...
function i5(e) {
    let { channel: t, ...n } = e,
        ...
        s = (0, r.bG)([e9.A], () => e9.A.getGuild(t.guild_id)),
...
function sK(e) {
    let { context: t, lobbyId: n, channel: i, ...s } = e,
        a = (0, r.bG)([e9.A], () => e9.A.getGuild(i?.getGuildId())),
...
function lu() {
    let {
        ...
        h = (0, r.bG)([e9.A], () => (null != u ? e9.A.getGuild(u.guild_id) : null)),
