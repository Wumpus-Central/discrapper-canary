...
let i6 = r.Ay.connectStores([tn.default], () => ({ opacity: tn.default.getTextWidgetOpacity() }))(i8);
var i9 = n(431052);
...
function sQ(e) {
    let t = (0, r.bG)([e9.Ay, e5.A], () => e5.A.getChannel(e9.Ay.getVoiceChannelId())),
        n = (0, tN.Ay)(t),
        i = (function () {
            let [e] = (0, r.bG)(
                [nV.Ay, sv.A, e9.Ay, e5.A],
                () => {
                    let e = e5.A.getChannel(e9.Ay.getVoiceChannelId());
                    return null == e
                        ? [[], -1]
                        : e.isGuildStageVoice()
...
let s2 = r.Ay.connectStores([e8.A, ti.A], () => ({
