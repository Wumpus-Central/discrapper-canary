...
class n4 extends a.PureComponent {
    ...
    handleToggleTextChatNotifications = () => {
        R.A.setNotificationDisabledSetting(n5.M.TEXT_CHAT, !this.props.textChatDisabled), n7();
    };
...
let i5 = r.Ay.connectStores([tn.default], () => ({ opacity: tn.default.getTextWidgetOpacity() }))(i3);
var i9 = n(431052);
