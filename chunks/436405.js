    ...
    !__OVERLAY__
        ...
        : {
              ...
              GUILD_RING_STOP: function (e) {
                  ...
                  i.includes(tH.default.getId()) && t0(t2(t));
              },
    ...
    let { position: t, onChange: n } = e,
        ...
        s =
            t === ey.G6Q.DISABLED
                ...
                : z.intl.formatToPlainString(z.t["XXHDM/"], { position: n2(t) });
    return (0, l.jsxs)("div", {
        children: [
            (0, l.jsx)(nQ.vN, {
                within: !0,
...
class n7 extends a.PureComponent {
    ...
    handleToggleTextChatNotifications = () => {
        R.A.setNotificationDisabledSetting(n6.M.TEXT_CHAT, !this.props.textChatDisabled), n4();
    };
...
let i6 = r.Ay.connectStores([tn.default], () => ({ opacity: tn.default.getTextWidgetOpacity() }))(i5);
var i9 = n(431052);
...
function sX(e) {
    let {
        ...
        f = (0, r.bG)([e2.A], () => e2.A.getCurrentUserActiveStream()),
        E = (0, r.yK)([e2.A], () => (null != f ? e2.A.getViewerIds(f) : [])),
        y = (0, sA.A)({ userId: i.id, context: p }),
        S = (0, r.bG)([sO.A], () => sO.A.isPrioritySpeaker(i.id, p)),
        x = (0, r.bG)([e2.A], () => null != e2.A.getStreamForUser(i.id, A)),
...
function sQ(e) {
    let t = (0, r.bG)([e9.Ay, e8.A], () => e8.A.getChannel(e9.Ay.getVoiceChannelId())),
        n = (0, tN.Ay)(t),
        i = (function () {
            let [e] = (0, r.bG)(
                [nV.Ay, sv.A, e9.Ay, e8.A],
                () => {
                    let e = e8.A.getChannel(e9.Ay.getVoiceChannelId());
                    return null == e
                        ? [[], -1]
                        : e.isGuildStageVoice()
...
let s0 = r.Ay.connectStores([e5.A, tn.default], (e) => {
    let { widgetId: t } = e,
        n = e5.A.getWidget(t),
...
let s2 = r.Ay.connectStores([e5.A, ti.A], () => ({
        ...
        return (0, l.jsxs)("div", {
            ...
            children: [
                ...
                (0, q.validResolution)(r)
                    ? (0, l.jsx)(s2, { className: v()({ [la.ZK]: e, [la.al]: !e }) })
                    : e
                      ? null
