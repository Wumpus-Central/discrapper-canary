var r = n(260674),
    ...
    h = {},
    m = function e(t, n, o, a, s, c, d, f, m, g, E, b, y, O, v, I, S, T) {
        for (var A, N = t, C = T, P = 0, R = !1; void 0 !== (C = C.get(h)) && !R; ) {
            var w = C.get(t);
            if (((P += 1), void 0 !== w))
        ...
        if (p(N) || i.isBuffer(N)) return m ? [v(I ? n : m(n, _.encoder, S, 'key', O)) + '=' + v(m(N, _.encoder, S, 'value', O))] : [v(n) + '=' + v(String(N))];
        var D = [];
        if (void 0 === N) return D;
        if ('comma' === o && l(N)) I && m && (N = i.maybeMap(N, m)), (A = [{ value: N.length > 0 ? N.join(',') || null : void 0 }]);
        else if (l(g)) A = g;
        else {
            var L = Object.keys(N);
            A = E ? L.sort(E) : L;
        ...
        for (var M = 0; M < A.length; ++M) {
            ...
            if (!d || null !== U) {
                var G = b && f ? String(j).replace(/\./g, '%2E') : String(j),
                    B = l(N) ? ('function' == typeof o ? o(k, G) : k) : k + (b ? '.' + G : '[' + G + ']');
                T.set(t, P);
                var F = r();
                F.set(h, T), u(D, e(U, B, o, a, s, c, d, f, 'comma' === o && I && l(N) ? null : m, g, E, b, y, O, v, I, S, F));
            }
        }
        return D;
    },
