...
let U = () =>
    ...
    B = (e) => {
        ...
        let { onSubscribeSuccess: a, markAsDismissed: o } = e,
            ...
            [u, f] = (0, l.Wu)([T.default, C.Z], () => [
                C.Z.gradientPreset,
                A.ZP.isPremium(T.default.getCurrentUser()),
            ]),
            p = (0, y.N)(),
            { v2EditorEnabled: h } = N.Mc.useExperiment({ location: "ClientThemesEditor" }),
            m = (0, A.Rt)({
            ...
            b = f
                ...
                : (null == p || null == (i = p.subscription_trial) ? void 0 : i.sku_id) === j.Si.TIER_2
                  ? m
    ...
    Z = (e) => {
        let { markAsDismissed: t, isCoachmark: n } = e,
            ...
            { v2EditorEnabled: o } = N.Mc.useExperiment({ location: "ClientThemesEditor" }),
            [c, d] = i.useState(!1),
            f = (0, P.q)(),
            _ = () => {
...
function V(e) {
    let { markAsDismissed: t, showClientThemesCoachmark: n } = e,
        ...
        { v2EditorEnabled: s } = N.Mc.useExperiment({ location: "ClientThemesEditor" }),
        { isPreview: c, shouldEditorAnimate: u } = (0, l.cj)([C.Z, m.Z], () => ({
            isPreview: C.Z.isPreview,
            shouldEditorAnimate: n && !m.Z.useReducedMotion,
        })),
        d = (0, b.oq)().activePanel === b.wh.CLIENT_THEMES,
        _ = (0, P.q)();
    i.useEffect(() => _(x.rMx.CLIENT_THEME_PREVIEW_VIEWED), [_]),
        i.useEffect(() => {
            c &&
                    ...
                    children: [
                        ...
                        (0, r.jsx)(f.Ttm, {
                            ...
                            children: (0, r.jsxs)(D.ZP, {
                                type: D.yH.EDITOR,
                                children: [
                                    !c && (0, r.jsx)(D.ZP.Basic, { className: k.selectionGroup }),
