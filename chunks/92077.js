...
function A(e) {
    ...
    f.A.setTargetManifest({
        ...
        d.default.track(h.HAw.LIBRARY_INSTALL_INITIATED, {
            application_id: t.id,
...
function I(e, t, n) {
    (0, E.n)(e.id, t).then(() => {
        ...
        d.default.track(h.HAw.LIBRARY_REPAIR_INITIATED, {
            application_id: e.id,
...
function S(e, t, n) {
    ...
    null != r &&
        ...
        d.default.track(h.HAw.LIBRARY_UNINSTALL_INITIATED, {
            application_id: r.id,
        ...
        null != i &&
            ...
            Promise.resolve()
                ...
                .then((e) => {
                    ...
                    t.showNotification(
                        i.getIconURL(64),
                        p.intl.string(p.t["1wR7yI"]),
                        p.intl.formatToPlainString(p.t["89VAgW"], { name: i.name }),
