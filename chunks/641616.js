...
function ec() {
    return i.useMemo(() => {
        ...
        return (
            m.A.isDeveloper &&
                (e.push({ id: "shop", name: "Shop Overrides", group: er.fu.SHOP, render: () => (0, a.jsx)(X.h, {}) }),
                e.push({
                ...
                e.push({ id: "overlay", name: "Overlay v3", group: er.fu.GAMES, render: () => (0, a.jsx)(V.A, {}) }),
                e.push({
                ...
                e.push({ id: "slayer_sdk", name: "Slayer SDK", group: er.fu.GAMES, render: () => (0, a.jsx)(Z.A, {}) }),
                e.push({
            ...
            e.push({
                ...
                name: "Dev Overlays",
                group: er.fu.DEVELOPMENT,
                render: () => (0, a.jsx)(N.A, { devSettingsCategory: h.xW.OVERLAYS }),
            }),
            e.push({
                id: "messaging",
                name: "Messaging",
            ...
            e.push({
                ...
                name: "Reporting",
                group: er.fu.EXPERIMENTS,
                render: () => (0, a.jsx)(N.A, { devSettingsCategory: h.xW.REPORTING }),
            }),
            e.push({ id: "permissions", name: "Permissions", group: er.fu.USERS, render: () => (0, a.jsx)($.A, {}) }),
            e.push({
                id: "modals",
                name: "Modals",
                group: er.fu.UI,
            ...
            e.push({ id: "dcf_events", name: "DCF Events", group: er.fu.DCF, render: () => (0, a.jsx)(v.A, {}) }),
            e.push({
                id: "hotspots",
                name: "Hotspots",
                group: er.fu.EXPERIMENTS,
