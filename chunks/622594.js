...
let g = a.memo(function (e) {
    let { playing: n, onPausePlayback: t, onPlaybackChange: i, onChangePosition: g, disabled: h = !1 } = e,
        ...
        [D, F] = a.useState(0),
        [R, B] = a.useState(-1),
        G = a.useMemo(() => D / v.fineTuningScale, [v.fineTuningScale, D]);
    a.useEffect(() => {
        if (null == p) return;
    ...
    return (
        ...
        a.useEffect(() => {
            ...
            let e = setTimeout(() => {
                P && N == N && -1 === R ? B(N) : I && O == O && -1 === R ? B(O) : k && C == C && -1 === R && B(C);
            }, v.fineTuningDelay);
            return () => {
                clearTimeout(e);
            };
        }, [v.fineTuningDelay, I, O, R, k, C, P, N]),
        (0, l.jsxs)("div", {
                ...
                (0, l.jsxs)("div", {
                    ...
                    children: [
                        ...
                        (0, l.jsx)("div", {
                            ...
                            children: (0, l.jsx)("div", {
                                className: r()(m.playhead, { [m.dragging]: k || P || I || n }),
                                style: { left: "".concat((0, c.pN)(C, R, G, D), "%") },
                            }),
                        }),
                    ],
                }),
