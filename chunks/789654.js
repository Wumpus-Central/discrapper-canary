...
function E(e, t) {
    ...
    crypto.subtle.digest("SHA-256", l).then((t) => {
        let a = Array.from(new Uint8Array(t))
            ...
            .join("");
        (r.href = n),
            (r.download = "".concat(e, "-").concat(a.slice(0, 8), ".json")),
            r.click(),
...
function T() {
    let e = (0, h.Fg)(),
        [t, a, l, s, d, u] = (0, j.zn)(),
        { semanticColorOverrides: v, rawColorOverrides: C, tab: O, scales: T } = t,
        P = r.useMemo(() => {
        ...
        p = r.useCallback(
            (e) => {
                a((t) => {
                    ...
                    if (null == n) return t;
                    let r = _({}, a);
                    return (r[e] = (0, j.GU)(n)), y(_({}, t), { semanticColorOverrides: r });
                });
            },
            [a],
        ),
                                        ...
                                        onChange: (e) => {
                                            ...
                                            isNaN(n) ||
                                                a((e) => {
                                                    ...
                                                    return y(_({}, e), {
                                                        semanticColorOverrides: y(_({}, a), { [t]: s }),
                                                    });
                                                });
                                        },
                                    }),
                        ...
                        P,
                        {
                            ...
                            onHighlightToggle: () => {
                                a((e) => {
                                    ...
                                    let r = _({}, a);
                                    return (
                                        (r[t] = y(_({}, n), { highlight: !n.highlight })),
