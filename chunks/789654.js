        ...
        p = r.useCallback(
            (e) => {
                n((t) => {
                    ...
                    if (null == a) return t;
                    let r = _({}, n);
                    return (r[e] = (0, j.GU)(a)), y(_({}, t), { semanticColorOverrides: r });
                });
            },
            [n],
        ),
