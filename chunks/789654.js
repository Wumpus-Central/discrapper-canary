...
function T() {
    let e = (0, h.Fg)(),
        [t, n, r, o, d, u] = (0, _.zn)(),
        { semanticColorOverrides: b, rawColorOverrides: v, tab: C, scales: T } = t,
        y = l.useMemo(() => {
            ...
            (e) => {
                n((t) => {
                    ...
                    let { semanticColorOverrides: a } = t,
                        l = null !== (n = a[e]) && void 0 !== n ? n : (0, _.$R)(e);
                    return {
                        ...t,
                                    ...
                                    (0, a.jsx)(m.VcW, {
                                        ...
                                        onChange: (e) => {
                                            n((n) => {
                                                ...
                                                let i = l.colors[r];
                                                if (null == i) return n;
                                                let o = (0, _.lT)(l, t, e, i.opacity, r);
                                                return {
                                                    ...n,
                                                    semanticColorOverrides: {
                                                        ...a,
