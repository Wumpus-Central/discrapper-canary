...
function u(e) {
    ...
    let t = Array.from((0, l.a)(e)).map((e) => e.codePointAt(0));
    if (2 !== t.length) return null;
    let a = t.map((e) => (!e || e < 127462 || e > 127487 ? null : String.fromCharCode(e - 127462 + 65)));
    return a.some((e) => null === e) ? null : a.join("");
}
...
function g() {
                ...
                (e = [...new Set(l.o)].map((e) => ({
                    ...
                    label: (function (e, n) {
                        let t = (0, l.a)(e),
                            [a, o] = e.split("-"),
                            i = a || e,
                            s = r(new Intl.DisplayNames([n, "en"], { type: "language" }).of(i) ?? i, n);
                        if (o && !/^[A-Z]{2}$/.test(o))
                            return `${t} ${r(new Intl.DisplayNames([n, "en"], { type: "language" }).of(e) ?? e, n)}`;
                        if (o) return `${t} ${s} (${new Intl.DisplayNames([n, "en"], { type: "region" }).of(o) ?? o})`;
                        let d = u(e);
                        return d ? `${t} ${s} (${d})` : `${t} ${s}`;
                    })(e, o),
                    ariaLabel: (function (e, n) {
                        let [t, l] = e.split("-"),
                            a = t || e,
                            o = r(new Intl.DisplayNames([n, "en"], { type: "language" }).of(a) ?? a, n);
                        if (l && !/^[A-Z]{2}$/.test(l))
                            return r(new Intl.DisplayNames([n, "en"], { type: "language" }).of(e) ?? e, n);
                        if (l) return `${o} (${new Intl.DisplayNames([n, "en"], { type: "region" }).of(l) ?? l})`;
                        let i = u(e);
                        return i ? `${o} (${i})` : o;
                    })(e, o),
    ...
    return {
        ...
        selectedMainLanguageLabel:
            ((e = o.split("-")[0] || o),
            (n = u(o)),
            `${"u" > typeof Intl && void 0 !== Intl.DisplayNames ? r(new Intl.DisplayNames([o, "en"], { type: "language" }).of(e) ?? e, o) : r(e, o)}${n ? ` (${n})` : ""}`),
        selectedMainLanguageEmoji: (0, l.a)(o),
        languageOptions: i,
        changeLanguage: (e) => C(t.changeLanguage.bind(t), e),
    };
}
function h({ onClose: e }) {
    let { t: n } = (0, l.n)(),
        { selectedLanguage: t, languageOptions: o, changeLanguage: r } = g(),
        u = (0, a.l)(null);
    return (
        (0, a._)(() => {
            u.current?.focus();
...
function v({ onContinue: e, isContinueLoading: n }) {
    let { t: t } = (0, l.n)(),
        { logoSrc: c, subtitle: r } = (0, o.n)(),
        { selectedMainLanguageLabel: u, selectedMainLanguageEmoji: C } = g(),
        p = (0, a.l)(null),
        f = (0, a.l)(null),
        [L, I] = (0, a.p)(!1);
    return (
        ...
        (0, a.v)("main", {
            ...
            children: [
                    ...
                    children: [
                                ...
                                (0, a.v)("div", {
                                    ...
                                    children: [
                                        ...
                                        (0, a.v)("p", {
                                            ...
                                            children: [
                                                (0, a.v)("span", { "aria-hidden": "true", children: [C, " "] }),
                                                u,
                                            ],
                                        }),
                                    ],
                        ...
                        (0, a.v)("div", {
                            ...
                            children: [
                                ...
                                r
                                    ? (0, a.v)("h2", { ref: p, class: "IncodeHomeSubtitle", tabIndex: -1, children: r })
                                    : null,
                            ],
                        }),
                        (0, a.v)(s.t, {
                ...
                (0, a.v)(d.t.Root, {
                    ...
                    children: (0, a.v)(d.t.Content, { children: (0, a.v)(h, { onClose: () => I(!1) }) }),
                }),
            ],
        })
    );
