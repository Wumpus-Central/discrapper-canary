...
class m extends o.Z {
        ...
        let e = i().reduce(
            ...
            (e, t) => {
                ...
                return (
                    ...
                    (e.decryptDuration += null != (o = t.decryptDuration) ? o : 0),
                    (e.decryptAttempts += null != (a = t.decryptAttempts) ? a : 0),
    ...
    constructor(e) {
        super(),
            ...
            u(this, "appendTargetRates", void 0),
            u(this, "sampleStats", void 0),
            (this.connection = e),
            (this.sampleAudioDevice = (e, t) => {
                var n, r, i;
                void 0 !== e &&
                    (void 0 !== e.restartCount && (t.restartCount = g(e.restartCount, t.restartCount)),
                    void 0 !== e.bufferViolations && (t.bufferViolations = g(e.bufferViolations, t.bufferViolations)),
            ...
            (this.sampleStats = (e) => {
                ...
                i().forEach(e.rtp.outbound, (e) => {
                    if ("audio" === e.type) {
                        ...
                        (r = null != (t = e.bitrateTarget) ? t : 0),
                            (this.outboundStats = _(d({}, this.outboundStats), {
                        ...
                        i().forEach(t, (t) => {
                            if ("audio" === t.type) {
                                ...
                                if (null != this.inboundStats[n]) {
                                    ...
                                    r > 0 &&
                                        o >= 0 &&
                                        ((a = this.calculateMos(S + D, i().clamp(o / (r + o), 0, 1))),
                                        s[Math.floor(a)]++),
                ...
                let o = !1,
                    a = !1;
                this.outboundStats.packetsSent > t && ((o = !0), this.duration.speaking++),
            ...
            (this.networkQuality = new l.Z()),
            (this.systemResources = new c.Z()),
            (this.inboundStats = {}),
            (this.outboundStats = {
                packetsSent: 0,
                bytesSent: 0,
