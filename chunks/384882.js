e.exports = {
    settingsColumn: 'settingsColumn_b2b948 ' + n('545192').customColumn,
    settingsContainer: 'settingsContainer_b2b948 ' + n('545192').customContainer,
    settingsScroller: 'settingsScroller_b2b948 ' + n('545192').customScroller + ' ' + n('545192').contentRegionScroller,
    settingsContent: 'settingsContent_b2b948 ' + n('545192').contentColumnDefault + ' settingsColumn_b2b948 ' + n('545192').customColumn,
