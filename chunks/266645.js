...
let N = function (e) {
    let { gameId: t, channelId: p, authorId: m, gameName: g, gameIconHash: A } = e,
        ...
        N = null != I ? I.getGuildId() : null,
        { name: v, hasName: C } = (0, S.V)({ gameName: g, gameId: t });
    r.useEffect(
        () => (
            ...
            (e) => {
                C &&
                    (0, l.L3)(e, async () => {
                        ...
                        return (n) => (0, i.jsx)(e, { ...n, gameId: t, gameName: v, guildId: N, authorId: m });
                    });
            },
            [C, t, v, N, m],
        ),
    ...
    return (0, i.jsx)(a.m, {
        ...
        children: (0, i.jsxs)(h.A, {
            ...
            children: [
                ...
                (0, i.jsx)("span", { className: y.UU, children: v }),
            ],
        }),
    });
};
