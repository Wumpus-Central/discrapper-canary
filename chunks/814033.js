!(function (e, n) {
    ...
    try {
        c = 'undefined' != typeof window && void 0 !== window.Buffer ? window.Buffer : r(603882).Buffer;
    } catch (e) {}
    function o(e, n) {
    ...
    function u(e, n, r, i) {
        for (var a = 0, s = Math.min(e.length, r), o = n; o < s; o++) {
            var l = e.charCodeAt(o) - 48;
            (a *= i), l >= 49 ? (a += l - 49 + 10) : l >= 17 ? (a += l - 17 + 10) : (a += l);
        }
        return a;
    }
    (s.isBN = function (e) {
    ...
    var c,
        d = ['', '0', '00', '000', '0000', '00000', '000000', '0000000', '00000000', '000000000', '0000000000', '00000000000', '000000000000', '0000000000000', '00000000000000', '000000000000000', '0000000000000000', '00000000000000000', '000000000000000000', '0000000000000000000', '00000000000000000000', '000000000000000000000', '0000000000000000000000', '00000000000000000000000', '000000000000000000000000', '0000000000000000000000000'],
    ...
    (s.prototype.toString = function (e, n) {
        if (((n = 0 | n || 1), 16 === (e = e || 10) || 'hex' === e)) {
            ...
            for (var r, a = 0, s = 0, o = 0; o < this.length; o++) {
                ...
                (r = 0 != (s = (l >>> (24 - a)) & 16777215) || o !== this.length - 1 ? d[6 - u.length] + u + r : u + r), (a += 2) >= 26 && ((a -= 26), o--);
            }
        ...
        if (e === (0 | e) && e >= 2 && e <= 36) {
            ...
            for (p.negative = 0; !p.isZero(); ) {
                ...
                r = (p = p.idivn(h)).isZero() ? m + r : d[c - m.length] + m + r;
            }
        ...
        (s.prototype.toBuffer = function (e, n) {
            return i(void 0 !== c), this.toArrayLike(c, e, n);
        }),
        ...
        (s.prototype.toArrayLike = function (e, n, r) {
            var a,
                ...
                o = this.byteLength(),
                l = r || Math.max(1, o);
            i(o <= l, 'byte array longer than desired length'), i(l > 0, 'Requested array length <= 0'), this.strip();
            var u = 'le' === n,
                c = new e(l),
                d = this.clone();
            if (u) {
                for (s = 0; !d.isZero(); s++) (a = d.andln(255)), d.iushrn(8), (c[s] = a);
                for (; s < l; s++) c[s] = 0;
            } else {
                for (s = 0; s < l - o; s++) c[s] = 0;
                for (s = 0; !d.isZero(); s++) (a = d.andln(255)), d.iushrn(8), (c[l - s - 1] = a);
            }
            return c;
        }),
        Math.clz32
        ...
        (s.prototype.setn = function (e, n) {
            ...
            var r = (e / 26) | 0,
                a = e % 26;
            return this._expand(r + 1), n ? (this.words[r] = this.words[r] | (1 << a)) : (this.words[r] = this.words[r] & ~(1 << a)), this.strip();
        }),
    ...
    !Math.imul && (m = p),
        (s.prototype.mulTo = function (e, n) {
            ...
            return (r = 10 === this.length && 10 === e.length ? m(this, e, n) : i < 63 ? p(this, e, n) : i < 1024 ? g(this, e, n) : E(this, e, n));
        }),
        (v.prototype.makeRBT = function (e) {
            for (var n = Array(e), r = s.prototype._countBits(e) - 1, i = 0; i < e; i++) n[i] = this.revBin(i, r, e);
            return n;
        }),
        (v.prototype.revBin = function (e, n, r) {
            if (0 === e || e === r - 1) return e;
            for (var i = 0, a = 0; a < n; a++) (i |= (1 & e) << (n - a - 1)), (e >>= 1);
            return i;
        }),
        (v.prototype.permute = function (e, n, r, i, a, s) {
            for (var o = 0; o < s; o++) (i[o] = n[e[o]]), (a[o] = r[e[o]]);
        }),
        (v.prototype.transform = function (e, n, r, i, a, s) {
        ...
        (v.prototype.guessLen13b = function (e, n) {
        ...
        (v.prototype.conjugate = function (e, n, r) {
            if (!(r <= 1))
                for (var i = 0; i < r / 2; i++) {
                    var a = e[i];
        ...
        (v.prototype.normalize13b = function (e, n) {
        ...
        (v.prototype.convert13b = function (e, n, r, a) {
        ...
        (v.prototype.mulp = function (e, n, r) {
            ...
            return this.conjugate(l, u, i), this.transform(l, u, _, s, i, a), this.conjugate(_, s, i), this.normalize13b(_, i), (r.negative = e.negative ^ n.negative), (r.length = e.length + n.length), r.strip();
        }),
        ...
        (s.prototype.mulf = function (e) {
            var n = new s(null);
            return (n.words = Array(this.length + e.length)), E(this, e, n);
        }),
        ...
        (s.prototype.iushrn = function (e, n, r) {
            ...
            return u && 0 !== d && (u.words[u.length++] = d), 0 === this.length && ((this.words[0] = 0), (this.length = 1)), this.strip();
        }),
    ...
    (T.prototype._tmp = function () {
        ...
        (T.prototype.split = function (e, n) {
            e.iushrn(this.n, 0, n);
        }),
        ...
        a(b, T),
        (b.prototype.split = function (e, n) {
        ...
        (s._prime = function (e) {
            ...
            if (I[e]) return I[e];
            if ('k256' === e) n = new b();
            else if ('p224' === e) n = new y();
            else if ('p192' === e) n = new S();
            else if ('p25519' === e) n = new A();
        ...
        (N.prototype._verify2 = function (e, n) {
