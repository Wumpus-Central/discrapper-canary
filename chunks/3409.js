...
function eN(e) {
    ...
    switch (eD) {
        ...
        case N.h8.PAYMENT_REQUEST_INFORMATION:
            (t = (0, r.jsx)(ey, {})), (n = (0, r.jsx)(eT, { onBack: () => eW(N.h8.PAYMENT_TYPE) }));
            break;
        case N.h8.CASH_APP_INFORMATION:
            let tv = null != e7,
                ty = null != eV;
