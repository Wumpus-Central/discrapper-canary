            ...
            let tf = (e, t) => {
                    switch (e) {
                        ...
                        case K.He.PAYMENT_REQUEST:
                            Q && 'googlePay' === t ? eH(A.h8.AWAITING_BROWSER_CHECKOUT_GOOGLE_PAY) : Q && 'applePay' === t ? eH(A.h8.AWAITING_BROWSER_CHECKOUT_APPLE_PAY) : (ek(e_), eH(A.h8.PAYMENT_REQUEST_INFORMATION));
                            break;
