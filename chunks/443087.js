...
function n(e) {
    let n = ['boolean', 'byte', 'word', 'String'],
        ...
        s = t(e),
        o = s.keywords;
    return (o.type = [...o.type, ...n]), (o.literal = [...o.literal, ...a]), (o.built_in = [...o.built_in, ...i]), (o._hints = r), (s.name = 'Arduino'), (s.aliases = ['ino']), (s.supersetOf = 'cpp'), s;
}
e.exports = n;
