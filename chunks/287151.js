...
class ec extends (i = o.PureComponent) {
    ...
    render() {
        let e,
            t,
            { count: n, burst_count: i, colors: o, isBurstReaction: a, hideCount: l, emoji: d, readOnly: h, isLurking: f, isGuest: g, isPendingMember: j, className: v, useChatFontScaling: y, message: x, hideEmoji: T, animationStartPosition: S, emojiSize: _ } = this.props,
        ...
        super(...e),
            ...
            ei(this, 'updateTooltipText', () => {
                let { message: e, emoji: t, type: n } = this.props,
                    i = (0, K.g)(e, t, n),
                    r = this.isKeyboardNavigation ? i : (0, K.g)(e, t, n, Y.dG4);
                this.setState({
                    tooltipText: r,
                    tooltipTextAria: i,
