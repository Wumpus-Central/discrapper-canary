    ...
    let t,
        ...
        (n = (0, d.yK)(
            ...
            () => [
                ...
                ...Object.values(j.A.getThreadsForGuild(t)).flatMap((e) => Object.keys(e)),
            ],
            [t],
        )),
        (s = (0, R.Ay)(t)),
        ...
        (x = (0, d.yK)([M.A], () => M.A.getBlockedOrIgnoredIDs())),
        (I = o().flatMap(n, (e) => {
            if (e === J.afkChannelId) return [];
            let t = (c[e] ?? []).map((e) => {
                let { user: t } = e;
                return t;
            });
            ...
            0 === ee.length
                ...
                : (0, i.jsxs)("div", {
                      ...
                      children: [
                          ...
                          (0, i.jsx)(f.Ay, { guildId: Z, users: ee, max: 3 }),
                          (0, i.jsxs)("div", {
                              className: H.GZ,
                              children: [
        ...
        { isMuted: eo, muteConfig: ed } = (0, d.cf)(
            [U.Ay],
            () => ({ isMuted: U.Ay.isMuted(Z), muteConfig: U.Ay.getMuteConfig(Z) }),
            [Z],
        );
