...
class lt extends z.Ay.PersistedStore {
    ...
    shouldFetch() {
        if (!n9) return Date.now() - n7.lastFetched > n8;
    }
    isFetching() {
        return n9;
    }
...
let rk = {
        ...
        MembersTableJoinTypeContextMenu: async () => {
            let { default: e } = await Promise.all([a.e("657"), a.e("71719"), a.e("14878"), a.e("66016")]).then(
                    a.bind(a, 316173),
                ),
                t = Object.values(a8.A.getGuilds())[0];
            return null == t ? () => null : () => (0, r.jsx)(e, { guildId: t.id, onClose: rN.Z_ });
...
let r3 = {
    ...
    CameraPreviewModal: async () => {
        let { default: e } = await Promise.all([a.e("90163"), a.e("10534")]).then(a.bind(a, 308229));
    ...
    GuildRaidLockdownFeedbackModal: async () => {
        let { default: e } = await Promise.all([a.e("657"), a.e("46313")]).then(a.bind(a, 336496));
        return (t) =>
            (0, r.jsx)(e, {
                ...t,
                guildId: "123456789",
                        ...
                        onChange: function (e) {
                            switch ((i(e), e)) {
                                case hZ.UNENROLLED:
                                    ...
                                    break;
                                case hZ.ENROLLED:
                                    l({ ...t, userStatus: h8({ enrolledAt: new Date().toISOString() }) });
                                    break;
