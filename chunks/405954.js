...
let b = function (e) {
    let { channel: t } = e,
        ...
        v = _ && C === a.FN.TOOLBAR && x,
        [j, O] = (0, d.US)(v ? [l.z.CHAT_WALLPAPERS_TOOLBAR_ENTRYPOINT_BADGE] : []),
        E = j === l.z.CHAT_WALLPAPERS_TOOLBAR_ENTRYPOINT_BADGE,
        N = i.useCallback(() => {
            E && O(m.L.TAKE_ACTION), n === t.id ? (y(), p.default.track(f.rMx.CHAT_WALLPAPER_TOOLBAR_ENTRY_POINT_CLICKED, { action: 'close' })) : (b(t.id), p.default.track(f.rMx.CHAT_WALLPAPER_TOOLBAR_ENTRY_POINT_CLICKED, { action: 'open' }));
        }, [n, t.id, y, b, E, O]);
    return v
        ? (0, r.jsx)(h.JO, {
              onClick: N,
