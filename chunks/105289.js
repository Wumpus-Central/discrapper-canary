                            ...
                            (0, r.jsxs)(z.B, {
                                ...
                                children: [
                                    ...
                                    (0, r.jsx)(x.$, {
                                        ...
                                        text: "Clear all",
                                        onClick: function () {
                                            k(() => n6.Bo.del({ url: sC(sS), rejectWithError: !0 }));
                                        },
...
function s4() {
    let e = (0, sk.G9)(),
        ...
        _ = o.useMemo(() => s8({ theme: t, saturation: 1 }), [t]),
        C = o.useMemo(() => {
            let e = [];
            for (let t = 0; t < sU; t++) {
        ...
        S = o.useMemo(() => {
            ...
            return sP.map((a, n) =>
                sJ[y.scales[n]].map((a) => {
                    let l = s6(e, t, sX(C, n, { ...C[n], color: a.value }));
                            ...
                            if (!s)
                                for (let t = 0; t < e.length; t++) {
                                    ...
                                    for (let { value: o } of sJ[i]) {
                                        ...
                                        let i = s6(n, l, sX(e, t, { ...e[t], color: o }));
                                        if (i >= 4.5) {
...
function m7() {
    ...
    return (0, r.jsxs)(g.Ip, {
        ...
        children: [
            (0, r.jsx)(b.c, { gap: 16 }),
            (0, r.jsx)(m4, { title: "Video Codecs (Sender)", toggles: m6, state: e }),
            t
                ? (0, r.jsxs)(r.Fragment, {
                      children: [
                          (0, r.jsx)(b.c, { gap: 16 }),
                          (0, r.jsx)(m4, { title: "Video Encoders", toggles: m8, state: e }),
                          (0, r.jsx)(b.c, { gap: 16 }),
