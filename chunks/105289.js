...
function te() {
    let { profileEffects: e, upsertProfileEffect: t, clearAll: a } = (0, ew.wu)(),
        ...
        p = o.useCallback(
            (e, a) => {
                if (null == a || !e.type.startsWith("text/")) return (0, eO.Ni)(e7);
                let [n, l] = a.split(",");
                if (!n.includes("text/plain")) return (0, eO.Ni)(e7);
            ...
            (0, r.jsxs)("div", {
                ...
                children: [
                    ...
                    (0, r.jsx)(a2.VT, {
                        overallStatus: C.debug.isSubscribedToAuthorizeRequest
                            ...
                            : N
                              ? a2.nW.WARN
                              : a2.nW.OVERALL_BAD,
                        name: a7.intl.string(a4.default.AGLx00),
                        steps: [
                            {
                                status: N ? a2.nW.GOOD : a2.nW.BAD,
                                text: a7.intl.string(a4.default.kxF9br),
                                description: N ? null : a7.intl.string(a4.default.PFxxJa),
                                learnMoreLink: N
                                    ? null
                            ...
                            },
                            {
                                status: C.debug.isSubscribedToAuthorizeRequest
                                    ...
                                    : N
                                      ? a2.nW.WARN
                                      : a2.nW.BAD,
                                text: a7.intl.string(a4.default.S94dzs),
                                description:
                                    C.debug.isSubscribedToAuthorizeRequest || !N
                                        ? null
                                        : a7.intl.string(a4.default.aTULMB),
                                learnMoreLink:
                                    C.debug.isSubscribedToAuthorizeRequest || !N
                                        ? null
                                        : "https://discord.com/developers/docs/discord-social-sdk/how-to/debug-log",
                    ...
                    (0, r.jsx)(a2.VT, {
                        ...
                        name: a7.intl.string(a4.default.K3ObrU),
                        steps: [
                            {
                                status: S.debug.hasConnectionEntrypointUrl ? a2.nW.GOOD : a2.nW.BAD,
                                text: a7.intl.string(a4.default["8a7IrV"]),
                                description: S.debug.hasConnectionEntrypointUrl
                                    ? a7.intl.formatToPlainString(a4.default["9iLeL2"], {
                    ...
                    (0, r.jsx)(a2.Sy, {
                        ...
                        text: a7.intl.string(a7.t["Vu/zmQ"]),
                    }),
                    0 === A.debug.validFlows.length &&
                        (0, r.jsx)(h.E, {
                            style: { minWidth: 0, overflow: "hidden" },
                            variant: "text-md/medium",
                            children: a7.intl.string(a4.default.eg0mNa),
                        }),
                    (0, r.jsx)(m.$, {
                ...
                children: [
                    (0, r.jsx)(nm.$n, {
                        ...
                        children: (0, r.jsx)("span", {
                            title: a7.intl.string(a7.t.VkKicb),
                            children: (0, r.jsx)(ng.u, {
                                size: "md",
                                color: "currentColor",
                                "aria-label": a7.intl.string(a7.t.VkKicb),
                            }),
                        }),
                    }),
...
let n6 = 12 * n8.A.Millis.HOUR,
    n5 = new Map(),
    n9 = !1,
    n7 = Object.freeze({ channelAffinities: [], lastFetched: 0 }),
    n4 = { ...n7 };
function le() {
    n5 = new Map(n4.channelAffinities.map((e) => [e.channelId, e]));
}
class lt extends z.Ay.PersistedStore {
    ...
    initialize(e) {
        null != e && ((n4.channelAffinities = e.channelAffinities), (n4.lastFetched = e.lastFetched), le());
    }
    shouldFetch() {
        if (!n9) return Date.now() - n4.lastFetched > n6;
    }
    isFetching() {
        return n9;
    }
...
let la = new lt(tP.h, {
    ...
    LOAD_CHANNEL_AFFINITIES_V2_SUCCESS: function (e) {
        ...
        (n4.lastFetched = Date.now()), (n9 = !1), (n4.channelAffinities = t), le();
    },
    LOAD_CHANNEL_AFFINITIES_V2_FAILURE: function () {
        n9 = !1;
    },
    LOGOUT: function () {
        (n4 = { ...n7 }), (n5 = new Map()), (n9 = !1);
    },
});
var ln = a(907360);
let ll = [
...
function is(e) {
    null == il.users && (il.users = new Map()), il.users.set(e.id, new s4.A(e));
}
...
async function id(e, t) {
    return await ie.A.get({
        ...
        .then((e) => {
            let { ok: a, body: n } = e;
            if (!a) return void s7.A.showFailedToast(io.OB.GENERIC_ERROR);
        ...
        .catch(() => (s7.A.showFailedToast(io.OB.GENERIC_ERROR), null));
}
var ic = a(844330),
    iu = a(277851);
let im = [
                                                ...
                                                a.stopPropagation(),
                                                    (function (e, t) {
                                                        ...
                                                        s9.A.login({
                                                            ...
                                                            () => (s7.A.showFailedToast(io.OB.GENERIC_ERROR), null),
                                                        );
                                                    })(t.id, e.id);
                                            },
...
function rc() {
    let e = (0, z.bG)([a5.A], () => a5.A.getGuildId()),
        t = (0, z.bG)([a6.A], () => a6.A.getGuild(e)?.name),
        a = (0, z.yK)([au.A], () => [...rn, ...rl].filter((t) => null != e && (0, i4.zs)(t, e))),
            ...
            children: [
                ...
                (0, r.jsxs)("div", {
                    ...
                    children: [
                        ...
                        (0, r.jsx)(m.$, { variant: "primary", text: "Reset", onClick: i7.O }),
                    ],
                }),
                (0, r.jsxs)("div", {
                    className: rr.uW,
        ...
        children: [
            ...
            (0, r.jsxs)(nO, {
                children: [
                    ...
                    (0, r.jsx)(nw, { name: "System", children: a7.systemLocale }),
                    (0, r.jsx)(nw, { name: "@discord/intl", children: a7.intl.currentLocale }),
            ...
            (0, r.jsx)(nO, {
                children: (0, r.jsx)(nw, { name: "Unique Rendered Main Messages", children: Object.keys(a7.t).length }),
            }),
            (0, r.jsx)("div", {
                style: { margin: 16 },
                children: (0, r.jsx)(v.k, {
...
let oe = {
    EmailEnterModal: async () => {
        ...
        return (t) =>
            (0, r.jsx)(e, {
                ...t,
                headerText: a7.intl.string(a7.t.ZLRYGU),
                confirmButtonText: a7.intl.string(a7.t.PDTjLN),
    ...
    EmailPincodeModal: async () => {
        ...
        return (t) =>
            (0, r.jsx)(e, {
                ...t,
                headerText: a7.intl.string(a7.t.H3Q7U8),
                onFormSubmit: () => {},
                onResend: () => {},
                onSuccess: () => {},
                confirmButtonText: a7.intl.string(a7.t["13ofGu"]),
    ...
    ExistingUserAgeGatePrompt: async () => {
        ...
        return (t) => (0, r.jsx)(e, { ...t, source: r7.w_.NSFW_SERVER });
    },
...
function o2(e) {
    ...
    return (
        ...
        (0, r.jsxs)(nm.$n, {
            ...
            className: oZ.DT,
            children: ["Application Id: ", t, " ", a ? a7.intl.string(a7.t.t5VZ88) : null],
        })
    );
}
...
function ci() {
    let [e, t] = o.useState("US"),
        ...
        [j, f] = o.useState(!1),
        b = Object.values((0, ty.bG)([d7.A], () => d7.A.paymentSources)),
        y = ct[e],
        E = async () => {
            let t = p;
            "" === t && (t = "pm_card_us"),
...
function cg(e) {
    ...
    return (0, r.jsxs)("div", {
        ...
        children: [
            ...
            (0, r.jsx)("img", { alt: t.country, className: d4.bI, src: (0, d8.t)(t.country) }),
            t.isDefault
              ...
              children: [
                  ...
                  (0, r.jsx)("div", {
                      ...
                      children: (0, r.jsx)(m.$, {
                          ...
                          onClick: () => (0, c4.A)({ source: ui.y.KEYBIND }),
                      }),
                  }),
                  (0, r.jsx)("div", {
                      className: G()(ur.N, uo.QB),
                                      ...
                                      async () => {
                                          ...
                                          return (a) =>
                                              (0, r.jsx)(t, {
                                                  ...
                                                  warningType: c7._j.INAPPROPRIATE_CONVERSATION_TIER_2,
                                                  ...a,
                                              });
                                      },
                                      { modalKey: us.V },
                    ...
                    async (e) => {
                        try {
                            ...
                            (function (e) {
                                ...
                                await Promise.all([u9(n, i), u7(n, i)]);
                        } finally {
                            t(!0);
                        }
                    },
                                ...
                                .map((e, t) =>
                                    (0, r.jsx)(
                                        "div",
                                        {
                                            ...
                                            children: (0, r.jsxs)(h.E, {
                                                variant: "text-xs/normal",
                                                className: e.success ? m7.$D : m7.uL,
...
let h2 = function (e) {
    ...
    return (0, r.jsx)(hX.D, {
        label: l,
        children: (0, r.jsx)(hZ.Y, {
            targetElementRef: s,
            renderPopout: (e) => (0, r.jsx)(cX.VN, { ...e, value: a, onChange: (e) => n(t, (0, hQ.Hl)(e)) }),
            children: (e) =>
                (0, r.jsx)(F.D, {
                    ...e,
                    innerRef: s,
                    ...
                    children: (0, r.jsx)(h0.d, { size: "xs", color: "currentColor", className: h1.WY }),
                }),
        }),
    });
};
...
let h8 = function (e) {
    ...
    return (0, r.jsx)(h3.M, {
        children: (0, r.jsx)(hF.Z, {
            className: G()(h1.Rx, { [h1.aK]: n }),
            outline: n,
            children: (0, r.jsx)("div", {
                className: h1.AZ,
                onClickCapture: t
...
let h4 = function (e) {
    let { onSelect: t, quest: a } = e,
        { quests: n } = (0, h7.mL)({ fetchPolicy: "cache-and-network", callerSource: "prefill_selector" }),
        l = [
            { id: "none", label: "NONE", value: null },
                ...
                (0, r.jsx)(xe.Pw, {
                    ...
                    isSelected: (e) => {
                        ...
                        return (
                            e ===
                            ((t = n.tasks),
                            (a = hM.n.PLAY_ON_PLAYSTATION in t || hM.n.PLAY_ON_XBOX in t),
                            (l = hM.n.PLAY_ON_DESKTOP in t),
                            (s = hM.n.STREAM_ON_DESKTOP in t),
                            (i = hM.n.WATCH_VIDEO in t),
                            (r = hM.n.PLAY_ACTIVITY in t),
                    ...
                    select: (e) => {
                        t({
                            ...
                            tasks: (function (e, t) {
                                ...
                                switch (e) {
                                    case 1:
                                        a[hM.n.STREAM_ON_DESKTOP] = { type: hM.n.STREAM_ON_DESKTOP, target: t };
                                        break;
                                    case 0:
                                        a[hM.n.PLAY_ON_DESKTOP] = { type: hM.n.PLAY_ON_DESKTOP, target: t };
                                        break;
                                    case 3:
                                        (a[hM.n.PLAY_ON_PLAYSTATION] = {
                                            type: hM.n.PLAY_ON_PLAYSTATION,
                                            target: t,
                                            externalIds: [],
                                        }),
                                            (a[hM.n.PLAY_ON_XBOX] = {
                                                type: hM.n.PLAY_ON_XBOX,
                                                target: t,
                                                externalIds: [],
                                            });
                                        break;
                                    ...
                                    case 2:
                                        ...
                                        break;
                                    case 5:
                                        a[hM.n.PLAY_ACTIVITY] = { type: hM.n.PLAY_ACTIVITY, target: t };
                                }
                                return a;
                            })(e, a),
                        });
    ...
    return (0, r.jsx)(hX.D, {
        ...
        children: (0, r.jsxs)("div", {
            ...
            children: [
                (0, r.jsx)(eu.zy, {
                    theme: xl.NJ.LIGHT,
                    isSelected: e === xl.NJ.LIGHT,
                    onSelect: () => (0, cU.u_)({ theme: xl.NJ.LIGHT }),
                }),
                (0, r.jsx)(eu.zy, {
                    theme: xl.NJ.DARK,
                    isSelected: e === xl.NJ.DARK,
                    onSelect: () => (0, cU.u_)({ theme: xl.NJ.DARK }),
                }),
            ],
        }),
    });
...
let xd = ["png", "gif", "webp"],
    xc = [...xd, "jpg", "jpeg"],
    xu = Array.from(new Set([...xc, "gif", "mp4", "webm"]));
function xm() {
    let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
    ...
    xx = {
        ...
        config: {
            ...
            taskConfigV2: {
                ...
                tasks: { [hM.n.PLAY_ON_DESKTOP]: { type: hM.n.PLAY_ON_DESKTOP, target: 300 } },
            },
            features: [],
            sharePolicy: hP.i.SHAREABLE_EVERYWHERE,
...
function xp() {
    var e;
    let [t, n] = o.useState(xx),
        l = o.useCallback((e) => {
            n({ ...e, preview: !0 });
        }, []),
        [s, i] = o.useState(xi.UNENROLLED),
        [d, u] = o.useState(!1),
        [p, g] = o.useState(!1),
        [v, j] = o.useState(null),
        f =
    ...
    function y(e, a) {
        ...
        l({
            ...
            config: {
                ...t.config,
                taskConfigV2: { ...t.config.taskConfigV2, tasks: { ...n, [hM.n.WATCH_VIDEO]: { ...s, assets: i } } },
            },
        });
    }
    function E(e, a) {
    ...
    function S() {
        (0, h$.tU)(t.config) && (0, xo.hJ)(t, hB.uF.GIFT_INVENTORY_FOR_YOU, hB.uF.INTERNAL_PREVIEW_TOOL, !0);
    }
    let N = o.useMemo(() => {
        ...
        A = o.useMemo(() => hM.n.WATCH_VIDEO in t.config.taskConfigV2.tasks, [t.config.taskConfigV2.tasks]);
    hR()(!1 !== t.preview && null != t.preview, "Preview config must have property preview: true");
    let k = t.config.taskConfigV2.tasks[hM.n.WATCH_VIDEO];
    return (0, r.jsxs)(x.Ip, {
        className: h1.kL,
        children: [
            (0, r.jsx)(W.D, { variant: "heading-lg/bold", className: h1.R_, children: "Quest Preview Tool" }),
            (0, r.jsx)("div", {
                className: h1.OA,
                children: (0, r.jsx)(h4, {
                    onSelect: function (e) {
                        j(e),
                            null == e ||
                                (i(
                                    (function (e) {
                                        if (null == e.userStatus) return xi.UNENROLLED;
                                        if (null != e.userStatus.claimedAt) return xi.CLAIMED;
                                        if (null != e.userStatus.completedAt) return xi.COMPLETED_100;
                                        let t = (0, hV.Yh)(e),
                                            a = t.progressSeconds,
                                            n = t.targetSeconds;
                                        return a / n >= 1
            ...
            (0, r.jsx)(W.D, { variant: "heading-md/semibold", className: h1.fV, children: "Task Config" }),
            (0, r.jsx)("div", {
                className: h1.OA,
                children: (0, r.jsx)(xn, {
                    taskDuration: N,
            ...
            (0, r.jsx)(W.D, { variant: "heading-md/semibold", className: h1.fV, children: "Messages" }),
            (0, r.jsxs)("div", {
                className: h1.OA,
                children: [
                    (0, r.jsx)(h9, {
                                ...
                                l({
                                    ...
                                    config: {
                                        ...
                                        taskConfigV2: {
                                            ...
                                            tasks: { ...n, [hM.n.WATCH_VIDEO]: { ...s, messages: i } },
                                        },
                                    },
                                });
                            },
            ...
            (0, r.jsx)(W.D, { variant: "heading-md/semibold", className: h1.fV, children: "Assets" }),
            (0, r.jsxs)("div", {
                className: h1.OA,
                children: [
                    (0, r.jsx)(h5, {
            ...
            (0, r.jsx)(W.D, { variant: "heading-md/semibold", className: h1.fV, children: "Colors & Quest States" }),
            (0, r.jsxs)("div", {
                className: h1.OA,
                children: [
                    (0, r.jsxs)("div", {
                    ...
                    (0, r.jsx)("div", { className: h1.OA, children: (0, r.jsx)(xs, {}) }),
                    (0, r.jsx)(xr, {
                        onChange: function (e) {
                            switch ((i(e), e)) {
                                case xi.UNENROLLED:
                                    ...
                                    break;
                                case xi.ENROLLED:
                                    l({ ...t, userStatus: xm({ enrolledAt: new Date().toISOString() }) });
                                    break;
                                case xi.COMPLETED_25:
                                    l({
                                        ...t,
                                        userStatus: xm({
            ...
            (0, r.jsx)(W.D, { variant: "heading-lg/bold", className: h1.R_, children: "Component Previews" }),
            (0, r.jsxs)("div", {
                className: h1.$$,
                children: [
                    (0, r.jsxs)(h8, {
                        ...
                        children: [
                            ...
                            (0, r.jsxs)("div", {
                                ...
                                children: [
                                    ...
                                    (0, r.jsx)("div", {
                                        className: h1.ok,
                                        children: (0, r.jsx)(hW.y5, {
                                            isPreview: !0,
                                            source: "preview",
                                            adCreativeId: "0",
                                            adCreativeType: hw.p.QUEST,
                                            children: (0, r.jsx)(hH.A, { children: (0, r.jsx)(hz.Y, { quest: t }) }),
                                        }),
                                    }),
                                ],
                            }),
                        ...
                        children: [
                            ...
                            (0, r.jsx)(hW.y5, {
                                ...
                                children: (0, r.jsx)(hJ.Ay, {
                                    quest: t,
                                    className: h1.d,
                                    questContent: hB.uF.QUEST_HOME_DESKTOP,
                                    contentPosition: 0,
                                    rowIndex: 0,
                                    sourceQuestContent: hB.uF.INTERNAL_PREVIEW_TOOL,
                                }),
                            }),
                        ],
                    }),
            ...
            ? (0, r.jsxs)("div", {
                  ...
                  children: [
                      ...
                      null != e.message &&
                          (0, r.jsx)(hF.Z, {
                              className: h1.Fx,
                              children: (0, r.jsx)("code", { className: h1.gJ, children: e.message }),
                          }),
                  ],
              })
            : (0, r.jsx)(xp, {}, t);
...
var xv = a(913122),
    ...
    xN = a(860689),
    xA = a(926140);
let xk = new xy.A("SearchDebugUtils");
function xD() {
    xk.info("--------------------------");
}
function xI() {
    let e = xE.A.getProps();
    xk.info("START Quick Switcher State"),
        xk.info(`Query: ${e.query}`),
        e.results.forEach((e) => {
            switch ((xk.info(`Result Type: ${e.type}`), e.type)) {
                case xA.rD.GUILD:
                    xk.info(`guild id: ${e.record.id}`);
                    break;
                case xA.rD.TEXT_CHANNEL:
                case xA.rD.VOICE_CHANNEL:
                    xk.info(`channel type: ${e.record.type}`),
                        xk.info(`channel id: ${e.record.id}`),
                        xk.info(`name: ${e.record.name}`);
                    break;
                case xA.rD.DM:
                    xk.info(`channel type: ${e.record.type}`),
                        xk.info(`channel id: ${e.record.id}`),
                        e.record.isDM() &&
                            (xk.info(`recipient id: ${e.record.getRecipientId()}`),
                            e.record.recipients.forEach((e) => {
                                let t = ea.default.getUser(e);
                                null != t &&
                                    (xk.info(`recipient username: ${t.username}`),
                                    xk.info(`recipient global name: ${eo.Ay.getGlobalName(t)}`),
                                    xk.info(`recipient nickname: ${aE.A.getNickname(t.id)}`));
                            }));
                    break;
                case xA.rD.GROUP_DM:
                    xk.info(`channel type: ${e.record.type}`),
                        xk.info(`channel id: ${e.record.id}`),
                        xk.info(`name: ${(0, ab.m1)(e.record, ea.default, aE.A)}`),
                        e.record.isGroupDM() &&
                            (xk.info(`default name: ${(0, ab.ks)(e.record, ea.default, aE.A)}`),
                            xk.info(`recipient id: ${e.record.recipients}`),
                            e.record.recipients.forEach((e) => {
                                let t = ea.default.getUser(e);
                                null != t &&
                                    (xk.info(`recipient username: ${t.username}`),
                    ...
                    break;
                case xA.rD.USER:
                    xk.info(`user id: ${e.record.id}`),
                        xk.info(`username: ${e.record.username}`),
                        xk.info(`global name: ${eo.Ay.getGlobalName(e.record)}`),
                        xk.info(`nickname: ${aE.A.getNickname(e.record.id)}`),
                        xk.info(`guild nicknames: ${xS.Ay.getNicknames(e.record.id)}`);
            }
            xk.info(`frecency score: ${x_.A.getScoreWithoutFetchingLatest(e.record.id)}`), xD();
        }),
        xk.info("END Quick Switcher State\n");
}
async function xT() {
    xk.info("START User Search Worker State");
    let e = await xb.A.requestDebugState();
    null == e
        ? xk.info("Unable to get debug state from User Search Worker")
        : (Object.entries(JSON.parse(e.users)).forEach((e) => {
              let [t, a] = e;
              xk.info(`id: ${t}`),
                  xk.info(`username: ${a.username}`),
                  xk.info(`global name: ${a.globalName}`),
                  xk.info(`nickname: ${a.friendNickname}`),
                  Object.entries(a.nicknames).forEach((e) => {
                      let [t, a] = e;
                      xk.info(`guild id: ${t}`), xk.info(`guild nickname: ${a}`);
                  }),
                  xD();
          }),
          xk.info("END User Search Worker State\n"));
}
async function xR() {
    let e = await xb.A.requestDebugState();
...
async function xO(e) {
    let t = await xb.A.requestDebugState(),
        a = null != t ? JSON.parse(t.users)[e] : null,
        n = a6.A.getGuildIds(),
        l = [];
    n.forEach((t) => {
        let a = xS.Ay.getMember(t, e);
        null != a && l.push(a);
    });
    let s = xC.A.getDebugState(e);
...
function xP() {
    let e = xL.useField("includeFrecency"),
        t = xL.useField("includeFriends"),
        a = xL.useField("includeDMs"),
        n = xL.useField("includeGDMs"),
        l = xL.useField("includeQuickSwitcherState"),
        s = xL.useField("includeUserSearchWorkerState"),
        i = xL.useField("isUploading"),
        u = xL.useField("isSuccess"),
        m = xL.useField("errorMessage"),
        h = o.useCallback(async () => {
            ...
            if (!i)
                try {
                    ...
                    xL.setState({ isUploading: !0, errorMessage: null, isSuccess: !1 }),
                        t &&
                            ((i = aE.A.getFriendIDs()),
                            xk.info("START Discord Friends"),
                            i.forEach((e) => {
                                let t = ea.default.getUser(e);
                                if (null == t) return;
                                let a = t.username,
                                    ...
                                    s = xS.Ay.getNicknames(t.id);
                                xk.info(`username: ${a}`),
                                    xk.info(`global name: ${n}`),
                                    xk.info(`nickname: ${l}`),
                                    xk.info(`guild nicknames: ${s}`),
                                    xD();
                            }),
                            xk.info("END Discord Friends\n")),
                        a &&
                            ...
                            xk.info("START Logging Group DM Channels"),
                            o.forEach((e) => {
                                let t = (0, ab.m1)(e, ea.default, aE.A),
                                    a = (0, ab.ks)(e, ea.default, aE.A);
                                xk.info(`id: ${e.id}`),
                                    xk.info(`name: ${t}`),
                                    xk.info(`default name: ${a}`),
                                    xk.info(`recipients ids: ${e.recipients}`),
                            ...
                            xk.info("END Logging Group DM Channels\n"),
                            xk.info("START Logging DM Channels"),
                            d.forEach((e) => {
                                let t = (0, ab.m1)(e, ea.default, aE.A);
                                xk.info(`id: ${e.id}`), xk.info(`name: ${t}`);
                                ...
                                xk.info(`username: ${l}`),
                                    xk.info(`global name: ${s}`),
                                    xk.info(`nickname: ${i}`),
                                    xD();
                            }),
                            xk.info("END Logging DM Channels\n")),
                        n &&
                            ...
                            xk.info("END Logging DM Channels\n")),
                        e &&
                            ((h = x_.A.getFrequentlyWithoutFetchingLatest()),
                            (x = []),
                            (p = []),
                            (g = []),
                            (v = []),
                            ...
                            xk.info("START Frecency"),
                            xk.info("Guilds"),
                            x.forEach((e) => {
                                let t = x_.A.getScoreWithoutFetchingLatest(e.id);
                                xk.info(`id: ${e.id} - name: ${e.name} - Frecency Score: ${t}`);
                            }),
                            xD(),
                            xk.info("DM Channels"),
                            g.forEach((e) => {
                                let t = x_.A.getScoreWithoutFetchingLatest(e.id);
                                xk.info(`id: ${e.id} - Frecency Score: ${t}`);
                            }),
                            xD(),
                            xk.info("Group DM Channels"),
                            v.forEach((e) => {
                                let t = x_.A.getScoreWithoutFetchingLatest(e.id);
                                xk.info(`id: ${e.id} - Frecency Score: ${t}`),
                                    xk.info(`default name: ${(0, ab.ks)(e, ea.default, aE.A)}`),
                                    xk.info(`name: ${(0, ab.m1)(e, ea.default, aE.A)}`);
                            }),
                            xD(),
                            xk.info("Guild Channels"),
                            p.forEach((e) => {
                                let t = x_.A.getScoreWithoutFetchingLatest(e.id);
                                xk.info(`id: ${e.id} - Frecency Score: ${t}`);
                            }),
                            xD(),
                            xk.info("END Frecency\n")),
                        l && xI(),
                        s && xT(),
                        await (0, xf.a)(ei.Umv.WEB_APP),
    ...
    return (0, r.jsxs)(d.n, {
        ...
        children: [
            ...
            (0, r.jsx)(c.d, {
                ...
                checked: a,
                onChange: () => xL.setState({ includeDMs: !a }),
            }),
            (0, r.jsx)(c.d, {
                label: "Group DMs",
                description:
                ...
                checked: n,
                onChange: () => xL.setState({ includeGDMs: !n }),
            }),
            (0, r.jsx)(c.d, {
                ...
                checked: l,
                onChange: () => xL.setState({ includeQuickSwitcherState: !l }),
            }),
            (0, r.jsx)(c.d, {
                ...
                checked: s,
                onChange: () => xL.setState({ includeUserSearchWorkerState: !s }),
            }),
            (0, r.jsx)(xM, {
                isUploading: i,
                isSuccess: u,
...
let xU = (0, xj.D)(() => ({ userIds: [], isLoading: !1, isSuccess: !1, errorMessage: null, lastRunAt: null }));
function xG() {
                        ...
                        a &&
                            ...
                            (0, r.jsxs)(r.Fragment, {
                                children: [
                                    ...
                                    (0, r.jsx)("div", { className: xw.uk, children: i }),
                                ],
                            }),
                        a &&
                            0 === e.length &&
...
let xF = (0, xj.D)(() => ({ isRecording: !1, isUploading: !1, isSuccess: !1, errorMessage: null }));
function xB() {
    let e = xF.useField("isRecording"),
        t = xF.useField("isUploading"),
        a = xF.useField("isSuccess"),
        n = xF.useField("errorMessage"),
        l = o.useRef([]),
        s = o.useRef(""),
        i = o.useCallback(() => {
            let { results: e, query: t } = xE.A.getProps();
            (l.current !== e || s.current !== t) && ((l.current = e), (s.current = t), xI());
        }, []);
    o.useEffect(() => {
        if (e) return xE.A.addChangeListener(i), () => xE.A.removeChangeListener(i);
    }, [i, e]);
    let c = o.useCallback(async () => {
        let { isUploading: e } = xF.getState();
        if (!e)
            try {
                xF.setState({ isRecording: !1, isUploading: !0, errorMessage: null, isSuccess: !1 }),
                    await (0, xf.a)(ei.Umv.WEB_APP),
            ...
            (0, r.jsxs)(aQ.e, {
                children: [
                    (0, r.jsx)(m.$, {
                        ...
                        onClick: () => xF.setState({ isRecording: !e }),
...
var x$ = a(145497);
let xV = (0, xj.D)(() => ({ userId: null, state: null, loading: !1, error: null }));
function xW(e) {
                        ...
                        return null == t
                            ...
                            : (0, r.jsxs)(
                                  "div",
                                  {
                                      className: xw.J1,
                                      children: [
                                          (0, r.jsx)(x$.Ay, { guild: t, iconSize: 16 }),
    ...
    let { userState: t } = e,
        ...
        i = o.useCallback((e) => {
            ...
            return t
                ...
                : (0, r.jsx)(hG.E, { size: "sm", color: eV.A.colors.ICON_FEEDBACK_CRITICAL });
        }, []);
    return (0, r.jsxs)("div", {
        className: xw.N6,
        children: [
                                ...
                                Object.entries(n.nicknames).map((e) => {
                                    ...
                                    return (0, r.jsxs)(
                                        "div",
                                        {
                                            className: xw.J1,
                                            children: [
                                                null != n && (0, r.jsx)(x$.Ay, { guild: n, iconSize: 16 }),
                                                null != n &&
            ...
            null != s &&
                (0, r.jsxs)("div", {
                    className: xw.uk,
                    children: [
                        (0, r.jsx)(xW, { title: "Pending Guild Member Requests:", guildIds: s.pendingRequestGuildIds }),
                        (0, r.jsx)(xW, { title: "Sent Guild Member Requests:", guildIds: s.sentRequestGuildIds }),
                        (0, r.jsx)(xW, {
...
let x8 = [
    ...
    x6 = {
                ...
                children: [
                    ...
                    (0, r.jsx)(m.$, {
                        onClick: () => {
                            var e;
                            return (
                                (e = x1.RevenuePlaygroundCollectionId.VIRTUAL_CURRENCY),
                                void (x0.PlaygroundStore.setState({ selectedCollection: e, selectedStory: null }),
                                (0, xZ.id)(ei.zgK.COMPONENT_PLAYGROUND))
                            );
                        },
        ...
        nitro: function () {
            return (0, r.jsxs)("div", { children: [(0, r.jsx)(xJ.o, {}), (0, r.jsx)(xQ.A, {}), (0, r.jsx)(xX.A, {})] });
        },
    };
function x5() {
    ...
    return (0, r.jsxs)("div", {
        ...
        children: [
            (0, r.jsx)(xq.V, {
                ...
                type: "top",
                orientation: "horizontal",
                children: x8.map((e) => (0, r.jsx)(xq.V.Item, { id: e.id, children: e.name }, e.id)),
            }),
            (0, r.jsx)(x.Ar, { children: (0, r.jsx)("div", { className: x3.Qs, children: (0, r.jsx)(a, {}) }) }),
        ],
    });
}
var x9 = a(718446),
    x7 = a(766075),
    x4 = a(355097);
let pe = (0, xj.D)(() => ({ urlString: "", error: null })),
    pt = Object.entries(x4.od).map((e) => {
        let [t, a] = e;
        return { id: t, label: a, value: t };
    });
function pa() {
    let [e, t] = o.useState(),
        a = pe.useField("urlString"),
        n = pe.useField("error"),
        l = o.useCallback(() => {
            let e = pe.getField("urlString");
            if (null == e || "" === e) return void pe.setState({ error: "URL is required" });
            let t = (0, x9.parseSettingsUrl)({ path: e });
            ((0, x9.trackParseSettingsUrl)(t, "devtools"), null == t.target)
                ? pe.setState({ error: "String did not match expected format" })
                : (0, x7.openUserSettings)(t.target, { path: t.path });
        }, []);
    return (0, r.jsxs)(d.n, {
        ...
        children: [
            (0, r.jsx)(at.Z, {
                ...
                onSelectionChange: (e) => {
                    if ((t(e), null != e)) {
                        ...
                        pe.setState({ urlString: ei.BVt.SETTINGS(t, a), error: null });
                    }
                },
                fullWidth: !0,
            }),
            (0, r.jsx)(v.k, {
                ...
                value: a,
                onChange: (e) => pe.setState({ urlString: e, error: null }),
            }),
            (0, r.jsxs)(aQ.e, {
                children: [
                    (0, r.jsx)(m.$, {
...
var pn = a(780964);
let pl = (0, xj.D)(() => ({ setting: pn.X.ACCOUNT_PANEL }));
function ps() {
    let e = pl.useField("setting"),
        t = o.useCallback(() => {
            (0, x7.openUserSettings)(e);
        }, [e]),
        a = o.useMemo(() => Object.values(pn.X).map((e) => ({ id: e, label: e, value: e })), []);
    return (0, r.jsxs)(d.n, {
        ...
        children: [
            (0, r.jsx)(at.Z, {
                ...
                value: e,
                onSelectionChange: (e) => pl.setState({ setting: e }),
                options: a,
                selectionMode: "single",
                clearable: !0,
            }),
...
function pd(e) {
    ...
    return null == l
        ? (0, r.jsx)("div", { className: po.NF, children: u("text-md/normal") })
        : (0, r.jsxs)("div", {
              className: po.NF,
              children: [
                  (0, r.jsxs)(F.D, {
                  ...
                  s && (0, r.jsx)("div", { className: po.m4, children: l }),
              ],
          });
}
function pc(e) {
    ...
    return (
        (0, pi.nW)(t) &&
            t.layout.length > 0 &&
            (i = t.layout.map((e) => (0, r.jsx)(pc, { setting: e, depth: a + 1, inheritedHighlightMode: s }, e.key))),
        (0, r.jsx)(pd, { title: t.key, initExpanded: a <= 2, highlightMode: l, children: i })
    );
}
function pu() {
    let { node: e } = (0, ee.Ay)(pr.D, ""),
        t = (0, ee.KA)();
    return (0, r.jsxs)(d.n, {
        label: "Settings Tree",
        children: [
            ...
            (0, r.jsx)(pc, { setting: e, depth: 1 }, e.key),
        ],
    });
}
var pm = a(168803);
