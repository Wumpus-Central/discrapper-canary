...
let eg = [eu.fO.ACTIVITY, eu.fO.PRESENCE_EMBEDDED_ACTIVITY],
    ev = l.memo((e) => {
        var t, n, a, c, _;
        let { participant: C, onDoubleClick: y, onContextMenu: K, onClick: Q, onMouseDown: es, onKeyDown: ev, className: eS, style: ex, containerStyle: eE, channel: eC, width: ey, inPopout: eZ, onVideoResize: eb, inCall: eT = !1, selected: eN = !1, noBorder: eA = !1, noVideoRender: ej = !1, focused: ew = !1, blocked: eP = !1, ignored: eR = !1, fit: eM = T.L.CONTAIN, paused: eO = !1, pulseSpeakingIndicator: eL = !1, forceIdle: ek = !1, inOverlayPopout: eD = !1 } = e,
