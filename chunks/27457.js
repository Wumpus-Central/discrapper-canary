...
let ed = [et.fO.ACTIVITY, et.fO.PRESENCE_EMBEDDED_ACTIVITY],
    em = i.memo((e) => {
        var l, t, r, o, j;
        let { participant: G, onDoubleClick: W, onContextMenu: Y, onClick: $, onMouseDown: eu, onKeyDown: em, className: ep, style: ef, containerStyle: eg, channel: eh, width: ej, inPopout: eO, onVideoResize: eN, inCall: ey = !1, selected: eC = !1, noBorder: eE = !1, noVideoRender: eT = !1, focused: eI = !1, blocked: eZ = !1, ignored: eb = !1, fit: eS = C.L.CONTAIN, paused: e_ = !1, pulseSpeakingIndicator: eR = !1, forceIdle: eA = !1, inOverlayPopout: eP = !1 } = e,
            ek = i.useContext(A.h9) || eA,
            [eV, ew] = i.useState(!1),
            eD = R.Sb.useSetting(),
            eM = (0, a.e7)([w.default], () => w.default.isStreamInfoOverlayEnabled),
            [ez, eU] = i.useState(!1),
            eL = (0, a.e7)([V.default], () => V.default.getId()),
...
let ev = i.memo((e) => {
    let { idle: l, title: t, width: r, videoToggleState: u, blocked: d, ignored: m, participantType: p, participantUserId: f, platform: v, secureFramesVerified: g, onContextMenu: h, isHovered: j, muted: O, deafened: N, localMuted: y, serverMuted: C, serverDeafened: E, hasVideo: T, hideAudioIcon: I, onToggleMute: Z } = e,
...
let ex = i.memo((e) => {
    let { muted: l, deafened: t, localMuted: i, serverMuted: r, serverDeafened: u, idle: d, title: m, width: p, hasVideo: f, inCall: v, localVideoDisabled: g, videoToggleState: h, focused: O, blocked: N, ignored: y, hideAudioIcon: C, participantType: E, participantUserId: T, onContextMenu: I, onToggleMute: Z, platform: b, application: S, secureFramesVerified: _ } = e,
        R = null,
        A = null,
        P = null,
        k = (0, $.K)(p),
        V = (0, $.N)(p),
        w = (0, a.e7)([M.Z], () => null != T && M.Z.isLocalVideoAutoDisabled(T, (0, x.Z)(E)), [T, E]),
        D = (0, c.bWb)().enabled;
    if (!C) {
        if (i && E === et.fO.STREAM && f && !O)
            R = (0, n.jsx)(c.ua7, {
