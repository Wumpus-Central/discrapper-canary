...
let et = [Y.fO.ACTIVITY],
    en = i.memo((e) => {
        ...
        let {
            ...
            [eA] = (0, f.Z)(b.type === Y.fO.ACTIVITY ? [b.applicationId] : []),
            ...
            { showGameIcon: eW } = _.ZP.useExperiment({ location: "voice_users" }, { autoTrackExposure: !1 }),
            eK = (0, a.e7)(
                [R.Z],
                () =>
                    eW && null != eT
            ...
            eq = (0, a.e7)([h.Z], () =>
                null != eY && (null == eK ? void 0 : eK.application_id) != null
                    ? h.Z.getApplication(null == eK ? void 0 : eK.application_id)
                    : void 0,
            ),
            eX = (0, C.wV)({
                userId: eT,
...
let el = i.memo((e) => {
    let {
        ...
        w = (0, a.e7)([A.Z], () => null != m && A.Z.isLocalVideoAutoDisabled(m, (0, g.Z)(f)), [m, f]),
        Z = (0, b.j)({ displayNameStyles: _ }),
        T = (0, z.N)(l),
        R = (0, z.K)(l),
        [D, L] = i.useState(!1);
    i.useEffect(() => {
