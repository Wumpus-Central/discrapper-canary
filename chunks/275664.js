...
let C = (e) => {
    let {
        ...
        { startPx: v, endPx: E, leftIndicatorIndex: C, rightIndicatorIndex: S } = t,
        A = E - v,
        w = a.to((e) => Math.min(Math.max(0, e - v), A)),
        y = null != n && null != c && C === n,
        N = !y && null != n && null != c && S === n,
        T = y || N,
        R = u && null != o ? Math.min(Math.max(0, o - v), A) : null,
        ...
        P = null != R ? (R <= 0 ? 0 : 1) : w.to((e) => (e <= 0 ? 0 : 1)),
        j = s !== b.Q6.ENDED,
        k = Math.max(0, (f ?? 0) - v),
        I = { borderRadius: `${h}px` },
        D = l.useMemo(
                        ...
                        children: [
                            D?.map((e) =>
                                (0, r.jsx)(
                                    ...
                                    {
                                        className: x.Zn,
                                        style: { width: `${e.endPx - e.startPx}px`, left: `${e.startPx}px`, ...I },
                                    },
                                    `${e.startPx}:${e.endPx}`,
                                ),
                            ),
                            null != f &&
                                k > 0 &&
                                (0, r.jsx)("div", { className: x.YK, style: { width: `${k}px`, opacity: 1, ...I } }),
                        ],
                    }),
...
function A(e) {
    let {
        ...
        } = e,
        {
            ...
            return (
                l.useEffect(
                    () => () => {
                        (I.current = !1), D.current?.(), (D.current = null);
                    },
                    [],
                ),
                {
                    ...
                    handleMouseDown: (e) => {
                        ...
                        let l = (e) => {
                                if (null != j.current) {
                                    ...
                                    T(null != l && n > l), E(n), y(a), B(e.clientX, t);
                                } else B(e.clientX, t);
                            },
                            o = (e) => {
                                (I.current = !1),
        ...
        er = l.useMemo(() => (null == Z || null == $ ? null : (0, s.hc)(Z, $, y)), [Z, $, y]),
        el = l.useMemo(() => (null == er ? null : (0, s.rB)(er)), [er]),
        ea = l.useMemo(() => (null == F || null == er ? null : (0, v.B8)(F, er)), [F, er]),
        ei = l.useMemo(() => {
            if (null != $) return (0, s.TO)(n, $);
        }, [n, $]),
        es = $?.width != null && $?.width !== 0 ? $?.width : 1,
        [{ playbackPxSpring: eu }, eo] = (0, u.z)(() => ({ playbackPxSpring: 0, config: S })),
        ec = l.useRef(W);
    l.useLayoutEffect(() => {
        let e = ec.current;
    ...
    let ed = l.useRef(null),
        ...
        ef = l.useRef(null);
    l.useEffect(() => {
        if (!a || null == O || y <= 0 || es <= 0) return;
        (em.current = ed.current ?? O()), (ef.current = performance.now());
        let e = 0,
            t = () => {
                ...
                null != l &&
                    ...
                    ((em.current = l),
                    (ed.current = l),
                    eo({ playbackPxSpring: Math.min(Math.max(0, (l / y) * es), es), immediate: !0 })),
    ...
    l.useEffect(() => {
        ...
        if (!eh) {
            if (null != O && y > 0 && es > 0) {
                let t = O();
                null != t && Number.isFinite(t) && ((ed.current = t), (e = Math.min(Math.max(0, (t / y) * es), es)));
            }
    ...
    let ep = y > 1,
        ...
        eb = l.useCallback(
            (e) =>
                ...
                eg.some(
                    (t) =>
                        e >= t.leftPx - t.gapPx - (_?.animatingIndex === t.index ? eE : 0) &&
                        e <= t.rightPx + t.gapPx + (_?.animatingIndex === t.index ? eE : 0),
                ),
            [eg, _?.animatingIndex, eE],
        );
    return (0, r.jsx)("div", {
        className: x.jD,
        ref: Q,
                        ...
                        ex.map((e, t) =>
                            (0, r.jsx)(
                                C,
                                {
                                    ...
                                    isDragging: W,
                                    dragX: q,
                                    animatingIndex: _?.animatingIndex,
                                    expansionSpring: _?.expansionSpring,
                                    timelineWidth: es,
                                    preloadedBuffers: A,
                                    maxSeekableX: z,
                                    segmentBorderRadius: L,
