...
let S = (e) => {
    let {
        ...
        { startPx: v, endPx: E, leftIndicatorIndex: S, rightIndicatorIndex: w } = t,
        C = E - v,
        N = a.to((e) => Math.min(Math.max(0, e - v), C)),
        y = null != n && null != c && S === n,
        A = !y && null != n && null != c && w === n,
        R = y || A,
        T = u && null != o ? Math.min(Math.max(0, o - v), C) : null,
        { progressToPlayheadBarTransform: j, glowWidth: L } = (function (e) {
            let {
                segmentWidth: t,
                dragFillWidth: n,
                shrinkEnd: r,
        ...
        M = null != T ? (T <= 0 ? 0 : 1) : N.to((e) => (e <= 0 ? 0 : 1)),
        k = s !== b.Q6.ENDED,
        P = Math.max(0, (h ?? 0) - v),
        D = { borderRadius: `${f}px` },
        I = l.useMemo(
                ...
                children: [
                    (0, r.jsxs)(x.animated.div, {
                        ...
                        children: [
                            ...
                            null != h &&
                                P > 0 &&
                                (0, r.jsx)("div", { className: g.YK, style: { width: `${P}px`, opacity: 1, ...D } }),
                        ],
                    }),
                    (0, r.jsx)(x.animated.div, { className: g.wx, style: { transform: j, opacity: M } }),
                ],
            }),
            k && (0, r.jsx)(x.animated.div, { className: g.fk, style: { width: L, opacity: M } }),
        ],
    });
};
g.f5;
let w = { tension: 300, friction: 30, clamp: !0 };
function C(e) {
    let {
            isFullyVisible: t,
            percent: n,
        ...
        } = e,
        {
            ...
            let {
                ...
                L = l.useMemo(() => (null == v || null == r ? null : (0, s.DX)(r, i, v)), [v, r, i]),
                M = (0, f.A)((e) => {
                    x(e.contentRect);
                }),
                k = (0, h.w)(M),
                    ...
                    handleMouseDown: (e) => {
                        ...
                        let l = (e) => {
                                if (null != k.current) {
                                    ...
                                    R(null != l && n > l), E(n), y(a), B(e.clientX, t);
                                } else B(e.clientX, t);
                            },
                            o = (e) => {
                                (D.current = !1),
                                    ...
                                    R(!1),
                                    null != k.current &&
                                        (((0, d.vq)(e.target, Node) && k.current.contains(e.target)) ||
                                            (S(!1), E(null))),
        ...
        er = l.useMemo(() => (null == Z || null == Q ? null : (0, s.hc)(Z, Q, y)), [Z, Q, y]),
        el = l.useMemo(() => (null == er ? null : (0, s.rB)(er)), [er]),
        ea = l.useMemo(() => (null == _ || null == er ? null : (0, v.B8)(_, er)), [_, er]),
        ei = l.useMemo(() => {
            if (null != Q) return (0, s.TO)(n, Q);
        }, [n, Q]),
        es = Q?.width != null && Q?.width !== 0 ? Q?.width : 1,
        [{ playbackPxSpring: eu }, eo] = (0, u.z)(() => ({ playbackPxSpring: 0, config: w })),
        ec = l.useRef(W);
    l.useLayoutEffect(() => {
        let e = ec.current;
        ...
        children: (0, r.jsxs)(o.D, {
            ...
            children: [
                ...
                (X || k) &&
                    ...
                    null != ei &&
                    !eb(W && null != J ? J : ei) &&
                    (0, r.jsx)(E, { playbackPxSpring: eu, isDragging: W, dragX: J }),
            ],
        }),
    });
}
