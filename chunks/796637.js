...
function b() {
    let { withSuggestionsNotice: e = !1 } = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
        ...
        [n, r] = i.useState(() => M(void 0, { withSuggestionsNotice: e })),
        s = o.A.isConnected(),
        l = i.useMemo(() => M({}), []);
    i.useEffect(() => {
        function t() {
            r(M(void 0, { withSuggestionsNotice: e }));
        }
        t();
        let n = a().throttle(t, 100);
        return (
            y.forEach((e) => e.addChangeListener(n)),
            () => {
                n.cancel(), y.forEach((e) => e.removeChangeListener(n));
            }
        );
    }, [e]),
        i.useEffect(() => {
            if (t && s) {
                let e;
                0 === (e = v({ limit: O.lj, includeLoading: !1 })).length ? Promise.resolve() : E.A.loadThreadsBulk(e);
            }
        }, [t, s]);
    let d = t ? n : l,
        u = t && v({ limit: 1, includeLoading: !0 }).length > 0,
        _ = (function (e) {
...
function M(e) {
    ...
    let U = { isEmpty: () => !0, getRows: () => [], getRow: () => null },
        w = [];
    t && w.push(L.r.FAVORITES_SUGGESTIONS);
