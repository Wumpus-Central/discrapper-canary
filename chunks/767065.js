...
function eb() {
    let e = [],
        t = (0, h.tB)();
    for (let n of ev) e.push({ ...n, t: t - n.t });
...
class eN extends _.A {
    ...
    constructor({
        ...
        super(),
            ...
            (this._fetchAsyncResourcesPromise = F.Ay.fetchAsyncResources().catch((e) => {
            ...
            (this.joinVoiceId = l),
            (this._connectionSerial = eS++),
            (this.logger = new y.A(`RTCConnection(${this.trueServerId}, ${this.context})`)),
        ...
        const d = F.Ay.supports(ed.O5.FIRST_FRAME_CALLBACK) && F.Ay.supports(ed.O5.REMOTE_USER_MULTI_STREAM);
        if (i === ed.x.DEFAULT) {
            const t = G.A.getChannel(this.channelId)?.type === eu.rbe.GUILD_STAGE_VOICE;
            (this._localMediaSinkWantsManager = new et.Ay(e, t, d)),
                this._localMediaSinkWantsManager.on(et.Nb.Update, (e) => {
                ...
                this._localMediaSinkWantsManager.on(et.Nb.UserSSRCUpdate, (e, t, n) => {
                    this._connection?.createUser(e, t, n);
                });
        } else
            i === ed.x.STREAM &&
                ((this._goLiveQualityManager = new C.A(!0)),
                this._goLiveQualityManager.on(C.j.RequestedSSRCsUpdate, (e, t, n) => {
                    this._connection?.createUser(e, t, n);
                }),
                this._goLiveQualityManager.on(C.j.RequestedStreamsUpdate, (e) => {
                    this.state === eu.S7L.RTC_CONNECTED &&
                        null != this._socket &&
        ...
        (this._remoteVideoSinkWants = et.AE),
            ...
            B.Ay.shouldRecordNextConnection()
                ? ((this._recordingEnabled = !0), A.Et(!1))
                : (this._recordingEnabled = !1),
            K.A.addOnlineCallback(this._handleNetworkOnline),
            K.A.addOfflineCallback(this._handleNetworkOffline),
            (0, $.isDesktop)() &&
                (this.powerMonitorListener = X.A.remotePowerMonitor.on("resume", this._handlePowerResume)),
            (this._supportedBandwidthEstimationExperiments = []),
            (this._bandwidthEstimationExperiment = null),
            F.Ay.getMediaEngine().getSupportedBandwidthEstimationExperiments((e) => {
                this._supportedBandwidthEstimationExperiments = e;
            });
    }
    recordEvent(e) {
        for (ev.push({ ...e, t: (0, h.tB)(), n: this._connectionSerial }); ev.length > eC; ) ev.shift();
    }
    get quality() {
        let e = this.getLastPing();
        return this.state !== eu.S7L.RTC_CONNECTED || void 0 === e
            ? eu.bFR.UNKNOWN
            : e > em || (null != this._outboundLossRate && this._outboundLossRate > eE)
              ? eu.bFR.BAD
              : e > eg || (null != this._outboundLossRate && this._outboundLossRate > eA)
                ? eu.bFR.AVERAGE
                : eu.bFR.FINE;
    }
    get endpoint() {
    ...
    set endpoint(e) {
        if ((this.recordEvent({ c: 6, e: null != e }), null == e)) (this._endpoint = null), (this.hostname = null);
            ...
            e = `${ef}//${e}`;
            let { hostname: t, port: n } = q.A.toURLSafe(e) ?? {},
                r = null != n ? parseInt(n) : NaN;
            null != t && (80 === r || 443 === r) && (e = `${ef}//${t}`),
                (this._endpoint = e + "/"),
                (this.hostname = t);
        }
    }
    connect(e, t) {
        ...
        null != i && this._cleanupSocket(),
            ...
            (i = this._socket = new ee.Ay(this.endpoint, this.context)).on(
                ee.yg.Connecting,
                this._handleConnecting.bind(this, i),
            ),
            i.on(ee.yg.Connect, this._handleConnect.bind(this, i)),
            i.on(ee.yg.Disconnect, this._handleDisconnect.bind(this, i)),
            i.on(ee.yg.Resuming, this._handleResuming.bind(this, i)),
            i.on(ee.yg.Ready, this._handleReady.bind(this, i)),
            i.on(ee.yg.Speaking, this._handleSpeaking.bind(this, i)),
            i.on(ee.yg.Video, this._handleVideo.bind(this, i)),
            i.on(ee.yg.Ping, this._handleControlPing.bind(this)),
            i.on(ee.yg.ClientDisconnect, this._handleClientDisconnect.bind(this)),
            i.on(ee.yg.ClientConnect, this._handleClientConnect.bind(this)),
            i.on(ee.yg.Codecs, this._handleCodecs.bind(this)),
            i.on(ee.yg.MediaSessionId, this._handleMediaSessionId.bind(this)),
            i.on(ee.yg.MediaSinkWants, this._handleMediaSinkWants.bind(this)),
            i.on(ee.yg.VoiceBackendVersion, this._handleCodeVersion.bind(this)),
            i.on(ee.yg.KeyframeInterval, this._handleKeyframeInterval.bind(this)),
            i.on(ee.yg.Flags, this.handleFlags.bind(this)),
            i.on(ee.yg.Platform, this.handlePlatform.bind(this)),
            i.on(ee.yg.BandwidthEstimationExperiment, this._handleBandwidthEstimationExperiment.bind(this)),
            i.on(ee.yg.SecureFramesInit, this._handleSecureFramesInit.bind(this)),
            i.on(ee.yg.SecureFramesPrepareTransition, this._handleSecureFramesPrepareTransition.bind(this)),
            i.on(ee.yg.SecureFramesPrepareEpoch, this._handleSecureFramesPrepareEpoch.bind(this)),
            i.on(ee.yg.SecureFramesExecuteTransition, this._handleSecureFramesExecuteTransition.bind(this)),
            i.on(ee.yg.MLSExternalSenderPackage, this._handleMLSExternalSenderPackage.bind(this)),
            i.on(ee.yg.MLSProposals, this._handleMLSProposals.bind(this, i)),
            i.on(ee.yg.MLSPrepareCommitTransition, this._handleMLSPrepareCommitTransition.bind(this)),
            i.on(ee.yg.MLSWelcome, this._handleMLSWelcome.bind(this)),
            i.on(ee.yg.ReceiveMessage, this._recordMessageEvent.bind(this, 4)),
            i.on(ee.yg.SendMessage, this._recordMessageEvent.bind(this, 5)),
            (this._connectStartTime = (0, h.tB)()),
            this._connectCount++,
            (this._connecting = !0),
            null != i &&
                this._socket === i &&
    ...
    reconnect = () => {
        ...
        let e = this._socket;
        null != e &&
            (this._connected && (this._connectStartTime = (0, h.tB)()),
            this._connecting ||
    ...
    destroy() {
        if (
            ...
            K.A.removeOnlineCallback(this._handleNetworkOnline),
            K.A.removeOfflineCallback(this._handleNetworkOffline),
            (0, $.isDesktop)() && this.powerMonitorListener?.(),
    ...
    shouldSendSpeaking(e, t) {
        if ((0, $.isWeb)()) return !0;
        let n = (0, d.Lt)(e, ed.ME.PRIORITY),
            r = (0, d.Lt)(this._lastSentSpeakingStatus, ed.ME.PRIORITY);
        return (
            (this._lastSentSSRC !== t || n !== r) &&
            (void 0 !== this._lastSentSSRC || e !== ed.ME.NONE) &&
            (this._lastSentSSRC === t || e !== ed.ME.NONE) &&
    ...
    getDuration() {
        let e = this._connectCompletedTime > 0 ? (0, h.tB)() - this._connectCompletedTime : 0;
        return e > 0 ? e : 0;
    }
    getDurationSeconds() {
    ...
    _chooseExperiments(e) {
        ...
        if (
            ...
            F.Ay.supports(ed.O5.FIXED_KEYFRAME_INTERVAL) && t.push("fixed_keyframe_interval"),
            0 !== this._supportedBandwidthEstimationExperiments.length)
        ) {
            let e = D.A.workerExperimentString();
            null != e && t.push(e);
        }
        this.context === ed.x.DEFAULT && (0, b.I)("RtcConnection").enabled && t.push("audio_transport_cc");
        let { enabled: n } = T.A.getConfig({ location: "_chooseExperiments" });
        n && t.push("should_analyze_user_voice_volume"),
            t.push("keyframe_on_join"),
            w.A.getCurrentConfig({ location: "_chooseExperiments" }, { autoTrackExposure: !0 }).enabled &&
                t.push("network_aware_socket");
        let r = R.A.getCurrentConfig(
            { location: "_chooseExperiments" },
            { disable: !(0, $.isWindows)(), autoTrackExposure: !0 },
        );
    ...
    _handleConnecting(e) {
        if (null != this.endpoint) {
            let e = G.A.getChannel(this.channelId),
                t = e?.type;
            this.logger.info(
        ...
        this.logger.info("Connected to RTC server."),
            this._fetchAsyncResourcesPromise.finally(() => {
                e.identify({
                    ...
                    token: t,
                    maxDaveProtocolVersion: F.Ay.getSupportedSecureFramesProtocolVersion(),
                    video: F.Ay.supports(ed.O5.VIDEO),
                    streamParameters: F.Ay.getVideoStreamParameters(this.context),
                }),
    ...
    _handleDisconnect(e, t, n, r) {
        this.logger.info(`Disconnected from RTC server, clean: ${t}, code: ${n}, reason: ${r}, state: ${this.state}`),
            t ||
                ...
                (Y.default.track(eu.HAw.VOICE_CONNECTION_SOCKET_FAILURE, {
            ...
            V.A.getRemoteDisconnectVoiceChannelId() === this.channelId && this._connection?.wasRemoteDisconnected();
        let i = "Force Close" !== r;
        if (i) {
        ...
        if (this.state !== eu.S7L.DISCONNECTED) {
            ...
            if (null != e && this.context === ed.x.DEFAULT) {
                if ((e.stop(), this._sentVideo)) {
                    e.getOutboundStats().forEach((t) => {
                        (t.num_frames ?? 0) > 0 &&
                            Y.default.track(eu.HAw.VIDEO_STREAM_ENDED, {
                                ...this._getAnalyticsProperties(),
                                app_hardware_acceleration_enabled: W.A.getAppHardwareAccelerationEnabled(),
                    ...
                    null != t &&
                        ...
                        Y.default.track(eu.HAw.VIDEO_CALL_ENDED, { ...t, media_session_id: this.getMediaSessionId() });
                }
            ...
            F.Ay.getMediaEngine()
                ...
                .then((e) => {
                    ...
                    Y.default.track(eu.HAw.VOICE_CODEC_DETECTED, {
                        ...n,
            ...
            let n = j.A.shouldIncludePreferredRegion() ? j.A.getPreferredRegion() : null,
                a = F.Ay.getSettings(),
                s = G.A.getChannel(this.channelId),
                o = L.A.getConnectionStats(this.getMediaEngineConnectionId())?.stats.rtp.outbound.find(
                    (e) => "audio" === e.type,
                ...
                l = {
                    ...
                    ...V.A.getUserVoiceSettingsStats(this.context),
                    ...
                    no_input_detected_notice: F.Ay.getNoInputDetectedNotice(),
                    ...
                    krisp_sdk_version: F.Ay.getState().krispVersion,
                    ...
                    soundshare_experimental: F.Ay.getExperimentalSoundshare(),
                    join_voice_id: this.joinVoiceId,
                    bypass_system_input_processing: a.bypassSystemInputProcessing,
                    system_microphone_mode: F.Ay.getSystemMicrophoneMode(),
                };
            Promise.all([
                (async () => (await this._systemResources?.getBatteryLevelStats()) ?? { batteryUsageRounded: null })(),
                M.A.getKrispModel(),
                F.Ay.getKrispEnableStats() ? F.Ay.getMediaEngine().getNoiseCancellationStats() : Promise.resolve(null),
            ]).then((e) => {
                let [{ batteryUsageRounded: t }, n, r] = e;
                Y.default.track(eu.HAw.VOICE_DISCONNECT, {
                    ...l,
                    battery_usage: t,
                    krisp_nc_model: n,
        ...
        this.setState(eu.S7L.DISCONNECTED, { willReconnect: i });
    }
    _handleResuming(e) {
        this._connection?.fastUdpReconnect(), this._connection?.clearAllSpeaking();
    }
    _handleReady(e, t, n, r, i, a, s) {
        this.setState(eu.S7L.RTC_CONNECTING), (this.port = n), this._chooseExperiments(s ?? []);
        let o = x.e.getConfig({ location: "media_engine_connect" }).boostProcessPriority;
        0 === a.length &&
            a.push({ type: ed.mI.VIDEO, rid: "100", ssrc: i + 1, rtxSsrc: i + 2, quality: 100, active: !1 });
        let l = F.Ay.getMediaEngine(),
            u = k.A.getPersistentCodesEnabled(),
            c = U.default.getStaticAuthSessionId() ?? void 0,
            d = (0, h.tB)(),
            _ = l.connect(this.context, this.userId, {
                ...
                streamParameters: a,
                qosEnabled: F.Ay.getQoS(),
                signingKeyId: u ? c : void 0,
                boostProcessPriority: o,
                ...this.getExtraConnectionOptions(),
            }),
            g = (0, h.tB)() - d;
        (0, $.isWeb)() && !ec.PF && z.A.captureMessage("Browser does not support Unified Plan"),
            _.setUseElectronVideo(l.supports(ed.O5.ELECTRON_VIDEO)),
            F.Ay.supports(ed.O5.IMAGE_QUALITY_MEASUREMENT) &&
                _.setVideoQualityMeasurement("imageQualityWebrtcPsnrDb:5000,imageQualityVmaf_v061:5000,hwdec");
        let A = ["unk"];
        A.push("nvNewPresets"),
            this.context === ed.x.STREAM ? A.push("nvRelaxRc=250") : A.push("nvRelaxRc=75"),
            F.Ay.getUseVaapiEncoder() && A.push("vaapi"),
            this.context === ed.x.STREAM &&
                "streamer" === this.getVoiceParticipantType() &&
                (0, P.b)("handleReady").enabled &&
                A.push("useCaptureDeviceForEncode"),
            _.setVideoEncoderExperiments(A.join(",")),
            _.on(f.yq.Speaking, (e, t, n) => {
                this.userId === e && this.sendSpeaking(t, n), this.emit(Q.q.Speaking, ey(e), t);
            }),
            _.on(f.yq.ToggleMuteFromNative, () => {
                this.context === ed.x.DEFAULT && E.A.toggleSelfMute({ playSoundEffect: !1 });
            }),
            _.on(f.yq.NativeMuteChanged, (e) => {
                this.context === ed.x.DEFAULT && I.A.nativeMuteChanged(e);
            }),
            _.on(f.yq.Video, (e, t, n, r, i, a) => {
            ...
            _.on(f.yq.FirstFrame, (e, t, n) => {
                null != this._localMediaSinkWantsManager &&
                    ...
                    this.emit(Q.q.Video, this.guildId, this.channelId, ey(e), n, this.streamServerId)),
            ...
            _.on(f.yq.Connected, (r, i) => {
                ...
                switch (
                    ((this._voiceQuality = new eo.A(_)),
                    this._voiceQuality.start(),
                    this._voiceQuality.on(eo.w.InputDeviceSampleRateChanged, (e) => {
                    ...
                    (this._systemResponsiveness = new er.A(_)),
                    this._systemResponsiveness.start(),
                    (this._systemResources = new en.A()),
                    this._systemResources.setLastBattery(),
                    (this._noiseCancellationError = 0),
                    (this._voiceDuration = new es.A(this.userId, _)),
                    ...
                    case "webrtc":
                        this.logger.info("Sending local SDP to RTC server."),
                            e.once(ee.yg.SDP, this._handleSDP.bind(this)),
            ...
            _.on(f.yq.Error, (t) => {
                ...
                this.logger.error(`Error occurred while connecting to RTC server: ${t}`),
                    Y.default.track(eu.HAw.VOICE_CONNECTION_FAILURE, {
                        ...this._getAnalyticsProperties(),
                        hostname: this.hostname,
                        port: this.port,
                        protocol: this.protocol,
            ...
            _.on(f.yq.ConnectionStateChange, (t) => {
                ...
                let n = this.state;
                switch (t) {
                    case ed.$I.DISCONNECTED:
                        this.setState(eu.S7L.RTC_DISCONNECTED);
                        break;
                    case ed.$I.CONNECTING:
                    ...
                    case ed.$I.NO_ROUTE:
                        ...
                        break;
                    case ed.$I.ICE_CHECKING:
                        this.setState(eu.S7L.ICE_CHECKING);
                        break;
                    case ed.$I.DTLS_CONNECTING:
                ...
                if (
                    ...
                    let e = j.A.shouldIncludePreferredRegion() ? j.A.getPreferredRegion() : null;
                    if (this._connecting) {
                        let t = F.Ay.getSettings(),
                            n = this._getAnalyticsProperties();
                        Y.default.track(eu.HAw.VOICE_CONNECTION_SUCCESS, {
                            ...n,
                            hostname: this.hostname,
                            port: this.port,
                            protocol: this.protocol,
                            cloudflare_best_region: e,
                            connect_time: (0, h.tB)() - (this._connected ? this._connectStartTime : this._createdTime),
                            connect_count: this._connectCount,
                            audio_subsystem: F.Ay.getMediaEngine().getAudioSubsystem(),
                            audio_layer: F.Ay.getMediaEngine().getAudioLayer(),
                            ...
                            join_voice_id: this.joinVoiceId,
                            is_camera_enabled:
                                F.Ay.getMediaEngine().getVideoInputDeviceId() !== ed.qe && _.context === ed.x.DEFAULT,
                            ...this.stateHistory.getVoiceConnectionSuccessStats(),
                        });
                        let r = performance.now(),
                            i = (e, t) => (null == e || null == t ? null : e - t);
                        Y.default.track(eu.HAw.VOICE_CONNECTION_TTC_COLLECTED, {
                    ...
                    this._localMediaSinkWantsManager?.setConnection(_),
                        ...
                        (this._connectCompletedTime = (0, h.tB)()),
                        (this._connected = !0),
                        (this._connecting = !1),
                        (this._encountered_socket_failure = !1);
                } else n === eu.S7L.RTC_CONNECTED && this.stateHistory.reset(this.state);
            }),
    ...
    _handleSpeaking(e, t, n, r) {
        ...
        null != i &&
            this.userId !== t &&
            (r !== ed.ME.NONE && i.createUser(t, n), this._localMediaSinkWantsManager?.setAudioSSRC(t, n));
    }
    handleFlags(e, t) {
    ...
    getOrCreateVideoQuality() {
        if (null != this._connection && null == this._videoQuality) {
            (this._videoQuality = new ea.X(this._connection)),
            ...
            if (e) {
                (this._videoHealthManager = new ei.V(t, n, r, i)),
                    null != this._localMediaSinkWantsManager &&
                ...
                this._videoQuality.on(ea.F.FpsUpdate, e);
            }
        }
    ...
    _handleRemoteStreamsReady(e) {
        let t = (0, h.tB)() - this._connectStartTime;
        Y.default.track(eu.HAw.VOICE_CONNECTION_REMOTE_STREAMS_CREATED, {
            ...this._getAnalyticsProperties(),
            number_of_users: e,
            duration_ms: t,
        });
    ...
    _handleVideo(e, t, n, r, i) {
        if (null != this._connection && this.userId !== t) {
            if (null != this._localMediaSinkWantsManager) {
                ...
                0 === e.length &&
                    e.push({ type: ed.mI.VIDEO, rid: "100", ssrc: r, rtxSsrc: r + 1, quality: 100, active: r > 0 }),
    ...
    _handleControlPing(e) {
        F.Ay.supports(ed.O5.NATIVE_PING) || this._handlePing(e);
    }
    _handlePing(e) {
        if (void 0 !== e) {
            for (this._pings.push({ time: Date.now(), value: e }); this._pings.length >= eh; ) this._pings.shift();
            e > em && this._pingBadCount++, this.emit(Q.q.Ping, this._pings, this.quality);
        }
    }
    ...
    _handleClientDisconnect(e) {
        ...
        if (null != t && this.context === ed.x.DEFAULT) {
        ...
        null != n && n.destroyUser(e),
            ...
            this._localMediaSinkWantsManager?.updateCallUserIds(this._userIds),
            this._videoQuality?.updateCallUserIdsCount(this._userIds.size),
            1 === this._userIds.size && (this._secureFramesLastBecameAloneTime = (0, h.tB)());
    }
    _handleCodecs(e, t) {
        let n = this._connection;
        null != n && null != this.protocol
            ? n.setCodecs(null != e && "" !== e ? e : ed.UK.OPUS, null != t && "" !== t ? t : ed.UK.H264, this.context)
    ...
    _handleMediaSessionId(e) {
        ...
        let t = S.A.getRawThermalState();
        Y.default.track(eu.HAw.MEDIA_SESSION_JOINED, {
            ...this._getAnalyticsProperties(),
            media_session_id: this.getMediaSessionId(),
            parent_media_session_id: this.parentMediaSessionId,
            raw_thermal_state: t,
    ...
    _handleBandwidthEstimationExperiment(e) {
        ...
        let t = N.A.getMediaEngineExperiments(e);
    ...
    _trackSecureFrameTransition(e) {
        ...
        Y.default.track(eu.HAw.SECURE_FRAMES_TRANSITION, {
            ...this._getAnalyticsProperties(),
            media_session_id: this.getMediaSessionId(),
            parent_media_session_id: this.parentMediaSessionId,
            sender_user_id: this.userId,
            ...
            time_since_creation: (0, h.tB)() - t.creationTime,
            ...
            e === eT && this._trackRemainingSecureFrameTransitions();
    }
    ...
    _storeSecureFrameNextTransitionData(e) {
        return (
            null == this._secureFramesNextTransitionState &&
                (this._secureFramesNextTransitionState = { creationTime: (0, h.tB)() }),
        ...
        this.recordEvent({ c: 11, v: e }),
            e > 0
                ? (this.logger.info(`DAVE protocol init with protocol version: ${e}`),
                  ...
                  this._connection?.prepareSecureFramesEpoch(eI, e, this.trueChannelId),
                  this._sendMLSKeyPackage(),
                  this._storeSecureFrameNextTransitionData({
                      initReceivedTime: t,
                      initFinishedTime: (0, h.tB)(),
                      protocolVersion: e,
                  }),
                  this.recordEvent({ c: 10 }))
                : this._connection?.prepareSecureFramesTransition(eT, e, () => {
                      let n = !1;
                      try {
                          this._connection?.executeSecureFramesTransition(eT);
                      } catch (e) {
                          (n = !0), z.A.captureException(e);
                      }
                      this._storeSecureFrameTransitionData(eT, {
                          initReceivedTime: t,
                          initFinishedTime: (0, h.tB)(),
                          protocolVersion: e,
                          executeError: n,
                      }),
                          this._trackSecureFrameTransition(eT);
                  });
    }
        ...
        Object.entries(e).forEach((e) => {
            ...
            n.push(ey(t)),
                null == a || 0 === a.byteLength
                    ? (i++, this._secureFramesRosterMap.delete(ey(t)))
                    : (r++, this._secureFramesRosterMap.set(ey(t), a));
        }),
    ...
    _handleSecureFramesPrepareEpoch(e, t) {
        ...
        this._connection?.prepareSecureFramesEpoch(n, t, this.trueChannelId),
            n === eI &&
                ((this._mlsInitReceivedTime = (0, h.tB)()), this._sendMLSKeyPackage(), this.recordEvent({ c: 10 }));
    }
    _sendMLSKeyPackage() {
    ...
    _maybeSendSecureFramesTransitionReady(e) {
        e !== eT &&
            ...
            this._storeSecureFrameTransitionData(e, { readyTime: (0, h.tB)() }));
    }
    ...
    _handleMLSWelcome(e, t) {
        ...
        let n = (0, h.tB)();
        this._connection?.processMLSWelcome(e, t, (r, i, a) => {
            r
                ? (this._trackMLSFailures({ recovered: !0, downgraded: !1 }),
                  (this._mlsSessionResetStartTime = void 0),
                  this._handleSecureFramesRosterChange(a, e),
    ...
    _handleMLSFailure(e, t) {
        ...
        this.recordEvent({ c: 3, i: r }),
            ...
            e.includes("GetPersistedKeyPair")
                ? g.A.show({ title: e_.intl.string(e_.t.fJUioH), body: e_.intl.string(e_.t.CQLWvo) })
    ...
    _trackMLSFailures(e) {
        ...
        for (let {
            ...
            Y.default.track(eu.HAw.MLS_FAILURES, {
                ...this._getAnalyticsProperties(),
                media_session_id: i,
                parent_media_session_id: this.parentMediaSessionId,
                failure_id: e,
    ...
    _alertMLSFailureDebouced = s()(this._alertMLSFailure, 100);
    ...
    _handleVoiceQualityPeriodicsStats = () => {
        if (null != this._voiceQuality) {
            ...
            if (this.shouldReportPeriodicStats(e))
                for (let t of e)
                    Y.default.track(eu.HAw.VOICE_QUALITY_PERIODIC_STATS, {
                        ...this._getAnalyticsProperties(),
                        media_session_id: this.getMediaSessionId(),
    ...
    getAudioDeviceStates = () => ({
        input_device: this.getInputDeviceName(),
        input_device_count: Object.keys(F.Ay.getInputDevices()).length,
        output_device: this.getOutputDeviceName(),
        output_device_count: Object.keys(F.Ay.getOutputDevices()).length,
    });
    getVideoDeviceStates = () => ({
        camera_device: this.getVideoDeviceName(),
        camera_device_count: Object.keys(F.Ay.getVideoDevices()).length,
    });
    _trackVoiceConnectionConnecting = () => {
        let e = G.A.getChannel(this.channelId),
            t = e?.type;
        Y.default.track(eu.HAw.VOICE_CONNECTION_CONNECTING, {
            ...this.getAudioDeviceStates(),
    ...
    getInputDeviceName() {
        ...
        return F.Ay.getInputDevices()[e]?.name;
    }
    getOutputDeviceName() {
        let e = F.Ay.getOutputDeviceId();
        return F.Ay.getOutputDevices()[e]?.name;
    }
    getVideoDeviceName() {
        let e = F.Ay.getVideoDeviceId();
        return F.Ay.getVideoDevices()[e]?.name;
    }
