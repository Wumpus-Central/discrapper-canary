...
var r = n(824120),
    ...
    ea = n(731854),
    eo = n(985018);
let el = /^https/.test("https:") ? "wss:" : "ws:",
    eu = 200,
    ec = 20,
    ed = 500,
    e_ = 250,
...
function eT() {
    let e = [],
        t = (0, p.tB)();
    for (let n of eA) e.push({ ...n, t: t - n.t });
    return JSON.stringify(e);
}
class eS extends _.A {
    context;
    userId;
    sessionId;
    guildId;
    ...
    constructor({
        ...
        super(),
            ...
            (this.state = ei.S7L.AWAITING_ENDPOINT),
        ...
        const d = x.Ay.supports(ea.O5.FIRST_FRAME_CALLBACK) && x.Ay.supports(ea.O5.REMOTE_USER_MULTI_STREAM);
        if (i === ea.x.DEFAULT) {
            const t = M.A.getChannel(this.channelId)?.type === ei.rbe.GUILD_STAGE_VOICE;
            (this._localMediaSinkWantsManager = new Z.Ay(e, t, d)),
                this._localMediaSinkWantsManager.on(Z.Nb.Update, (e) => {
                    this.state === ei.S7L.RTC_CONNECTED &&
                        null != this._socket &&
                        (this.logger.info(`Media sink wants: ${JSON.stringify(e)}`),
                        this._socket.mediaSinkWants(e),
                        this._connection?.setLocalVideoSinkWants(e));
                }),
                this._localMediaSinkWantsManager.on(Z.Nb.UserSSRCUpdate, (e, t, n) => {
        ...
        (this._remoteVideoSinkWants = Z.AE),
            er.X.on(er.N.IncomingVideoEnabledChanged, this.incomingVideoEnabledChanged),
            er.X.on(er.N.WindowVisibilityChanged, this.windowVisibilityChanged),
            k.Ay.shouldRecordNextConnection()
                ? ((this._recordingEnabled = !0), E.Et(!1))
                : (this._recordingEnabled = !1),
            B.A.addOnlineCallback(this._handleNetworkOnline),
            B.A.addOfflineCallback(this._handleNetworkOffline),
            (0, H.isDesktop)() && (this.powerMonitorListener = W.A.powerMonitor.on("resume", this._handlePowerResume)),
    ...
    recordEvent(e) {
        for (eA.push({ ...e, t: (0, p.tB)(), n: this._connectionSerial }); eA.length > eI; ) eA.shift();
    }
    get quality() {
        let e = this.getLastPing();
        return this.state !== ei.S7L.RTC_CONNECTED || void 0 === e
            ? ei.bFR.UNKNOWN
    ...
    connect(e, t) {
        ...
        if (
            ...
            return void this.setState(ei.S7L.AWAITING_ENDPOINT);
        let i = this._socket;
    ...
    destroy() {
        if (
            ...
            B.A.removeOnlineCallback(this._handleNetworkOnline),
            B.A.removeOfflineCallback(this._handleNetworkOffline),
            (0, H.isDesktop)() && this.powerMonitorListener?.(),
            this.recordEvent({ c: 1 }),
            er.X.off(er.N.IncomingVideoEnabledChanged, this.incomingVideoEnabledChanged),
            er.X.off(er.N.WindowVisibilityChanged, this.windowVisibilityChanged),
    ...
    shouldSendSpeaking(e, t) {
        ...
        let n = (0, d.Lt)(e, ea.ME.PRIORITY),
            r = (0, d.Lt)(this._lastSentSpeakingStatus, ea.ME.PRIORITY);
        return (
            (this._lastSentSSRC !== t || n !== r) &&
            (void 0 !== this._lastSentSSRC || e !== ea.ME.NONE) &&
            (this._lastSentSSRC === t || e !== ea.ME.NONE) &&
    ...
    setNextChannelId(e) {
        ...
        let t = M.A.getChannel(this.channelId),
            n = t?.type;
    ...
    _chooseExperiments(e) {
        ...
        this._recordingEnabled && t.push("connection_log"),
            x.Ay.supports(ea.O5.FIXED_KEYFRAME_INTERVAL) && t.push("fixed_keyframe_interval");
        ...
        this.logger.info("Connected to RTC server."),
            this._fetchAsyncResourcesPromise.finally(() => {
                e.identify({
                    ...
                    video: x.Ay.supports(ea.O5.VIDEO),
                    streamParameters: x.Ay.getVideoStreamParameters(this.context),
                }),
                    this.setState(ei.S7L.AUTHENTICATING);
            });
    }
    _handleDisconnect(e, t, n, r) {
        this.logger.info(`Disconnected from RTC server, clean: ${t}, code: ${n}, reason: ${r}, state: ${this.state}`),
            t ||
                ...
                (F.default.track(ei.HAw.VOICE_CONNECTION_SOCKET_FAILURE, {
        ...
        if (this.state !== ei.S7L.DISCONNECTED) {
            let e = this._videoQuality;
            if (null != e && this.context === ea.x.DEFAULT) {
                if ((e.stop(), this._sentVideo)) {
                    e.getOutboundStats().forEach((t) => {
                        (t.num_frames ?? 0) > 0 &&
                            F.default.track(ei.HAw.VIDEO_STREAM_ENDED, {
                                ...this._getAnalyticsProperties(),
                                ...
                                guild_region: U.A.getRegion(this.hostname),
                                hostname: this.hostname,
                    ...
                    null != t &&
                        ...
                        F.default.track(ei.HAw.VIDEO_CALL_ENDED, { ...t, media_session_id: this.getMediaSessionId() });
                }
            ...
            x.Ay.getMediaEngine()
                ...
                .then((e) => {
                    ...
                    F.default.track(ei.HAw.VOICE_CODEC_DETECTED, {
                        ...n,
            ...
            let n = U.A.shouldIncludePreferredRegion() ? U.A.getPreferredRegion() : null,
                s = x.Ay.getSettings(),
                a = M.A.getChannel(this.channelId),
            ...
            Promise.all([
                ...
                F.default.track(ei.HAw.VOICE_DISCONNECT, {
                    ...l,
                    battery_usage: t,
                    krisp_nc_model: n,
        ...
        this.setState(ei.S7L.DISCONNECTED, { willReconnect: i });
    }
    _handleResuming(e) {
        this._connection?.fastUdpReconnect(), this._connection?.clearAllSpeaking();
    }
    _handleReady(e, t, n, r, i, s, a) {
        this.setState(ei.S7L.RTC_CONNECTING), (this.port = n), this._chooseExperiments(a ?? []);
        let o = R.e.getConfig({ location: "media_engine_connect" }).boostProcessPriority;
        0 === s.length &&
            s.push({ type: ea.mI.VIDEO, rid: "100", ssrc: i + 1, rtxSsrc: i + 2, quality: 100, active: !1 });
        let l = x.Ay.getMediaEngine(),
            u = D.A.getPersistentCodesEnabled(),
            c = w.default.getStaticAuthSessionId() ?? void 0,
            d = (0, p.tB)(),
            ...
            m = (0, p.tB)() - d;
        (0, H.isWeb)() && !es.PF && j.A.captureMessage("Browser does not support Unified Plan"),
            _.setUseElectronVideo(l.supports(ea.O5.ELECTRON_VIDEO)),
        ...
        let E = ["unk"];
        E.push("nvNewPresets"),
            this.context === ea.x.STREAM ? E.push("nvRelaxRc=250") : E.push("nvRelaxRc=75"),
            x.Ay.getUseVaapiEncoder() && E.push("vaapi"),
            ...
            _.on(f.yq.NativeMuteChanged, (e) => {
                this.context === ea.x.DEFAULT && g.A.nativeMuteChanged(e);
            }),
            ...
            _.on(f.yq.FirstFrame, (e, t, n) => {
                null != this._localMediaSinkWantsManager &&
                    ...
                    this.emit($.q.Video, this.guildId, this.channelId, eE(e), n, this.streamServerId)),
            ...
            _.on(f.yq.Connected, (r, i) => {
                ...
                switch (
                    ((this._voiceQuality = new en.A(_)),
                    this._voiceQuality.start(),
                    this._voiceQuality.on(en.w.InputDeviceSampleRateChanged, (e) => {
            ...
            _.on(f.yq.VideoDecoderFallback, (t) => {
                let n = M.A.getChannel(this.channelId);
                if (n?.type === ei.rbe.GUILD_STAGE_VOICE) {
            ...
            _.on(f.yq.Error, (t) => {
                ...
                this.logger.error(`Error occurred while connecting to RTC server: ${t}`),
                    F.default.track(ei.HAw.VOICE_CONNECTION_FAILURE, {
                        ...this._getAnalyticsProperties(),
                        hostname: this.hostname,
                        port: this.port,
                        protocol: this.protocol,
            ...
            _.on(f.yq.ConnectionStateChange, (t) => {
                ...
                let n = this.state;
                switch (t) {
                    case ea.$I.DISCONNECTED:
                        this.setState(ei.S7L.RTC_DISCONNECTED);
                        break;
                    case ea.$I.CONNECTING:
                        this.setState(ei.S7L.RTC_CONNECTING);
                        break;
                    case ea.$I.CONNECTED:
                        this.setState(ei.S7L.RTC_CONNECTED);
                        break;
                    case ea.$I.NO_ROUTE:
                        this.setState(ei.S7L.NO_ROUTE);
                        break;
                    case ea.$I.ICE_CHECKING:
                        this.setState(ei.S7L.ICE_CHECKING);
                        break;
                    case ea.$I.DTLS_CONNECTING:
                        this.setState(ei.S7L.DTLS_CONNECTING);
                }
                if (
                    (n === ei.S7L.RTC_CONNECTING && this.state === ei.S7L.RTC_DISCONNECTED
                        ? this.reconnect()
                        : this.state === ei.S7L.NO_ROUTE &&
                          (0 === this._backoff.fails && this._handleNoRoute(), this._backoff.fail(this.reconnect)),
                    this.state === ei.S7L.RTC_CONNECTED)
                ) {
                    let e = U.A.shouldIncludePreferredRegion() ? U.A.getPreferredRegion() : null;
                    if (this._connecting) {
                        let t = x.Ay.getSettings(),
                            n = this._getAnalyticsProperties();
                        F.default.track(ei.HAw.VOICE_CONNECTION_SUCCESS, {
                            ...n,
                            hostname: this.hostname,
                            port: this.port,
                            protocol: this.protocol,
                            ...
                            join_voice_id: this.joinVoiceId,
                            is_camera_enabled:
                                x.Ay.getMediaEngine().getVideoInputDeviceId() !== ea.qe && _.context === ea.x.DEFAULT,
                            ...this.stateHistory.getVoiceConnectionSuccessStats(),
                        });
                        let r = performance.now(),
                            i = (e, t) => (null == e || null == t ? null : e - t);
                        F.default.track(ei.HAw.VOICE_CONNECTION_TTC_COLLECTED, {
                    ...
                    this._localMediaSinkWantsManager?.setConnection(_),
                        ...
                        (this._connecting = !1),
                        (this._encountered_socket_failure = !1);
                } else n === ei.S7L.RTC_CONNECTED && this.stateHistory.reset(this.state);
            }),
            _.on(f.yq.SecureFramesUpdate, (e) => {
                (this._secureFramesState = e), this.emit($.q.SecureFramesUpdate);
            }),
    ...
    _handleSpeaking(e, t, n, r) {
        ...
        null != i &&
            this.userId !== t &&
            (r !== ea.ME.NONE && i.createUser(t, n), this._localMediaSinkWantsManager?.setAudioSSRC(t, n));
    }
    handleFlags(e, t) {
        this.emit($.q.Flags, e, t);
    }
    handlePlatform(e, t) {
        this.emit($.q.Platform, e, t, this.channelId);
    }
    handleUsersMerged(e) {
        this.emit(
            $.q.UsersMerged,
    ...
    getOrCreateVideoQuality() {
        if (null != this._connection && null == this._videoQuality) {
            (this._videoQuality = new ee.X(this._connection)),
            ...
            if (e) {
                ...
                this._videoQuality.on(ee.F.FpsUpdate, e);
            }
        }
    ...
    _handleRemoteStreamsReady(e) {
        ...
        F.default.track(ei.HAw.VOICE_CONNECTION_REMOTE_STREAMS_CREATED, {
            ...this._getAnalyticsProperties(),
            number_of_users: e,
            duration_ms: t,
        });
    ...
    _handleVideo(e, t, n, r, i) {
        if (null != this._connection && this.userId !== t) {
            if (null != this._localMediaSinkWantsManager) {
                ...
                0 === e.length &&
                    e.push({ type: ea.mI.VIDEO, rid: "100", ssrc: r, rtxSsrc: r + 1, quality: 100, active: r > 0 }),
    ...
    _handleControlPing(e) {
        x.Ay.supports(ea.O5.NATIVE_PING) || this._handlePing(e);
    }
    _handlePing(e) {
        if (void 0 !== e) {
            for (this._pings.push({ time: Date.now(), value: e }); this._pings.length >= eu; ) this._pings.shift();
            e > ed && this._pingBadCount++, this.emit($.q.Ping, this._pings, this.quality);
        }
    }
    ...
    _handleOutboundLossRate(e) {
        (this._outboundLossRate = e), this.emit($.q.OutboundLossRate, e);
    }
    ...
    _handleClientDisconnect(e) {
        ...
        if (null != t && this.context === ea.x.DEFAULT) {
        ...
        null != n && n.destroyUser(e),
            ...
            this.emit($.q.ClientDisconnect, e),
            this._goLiveQualityManager?.updateCallUserIds(this._userIds),
            this._localMediaSinkWantsManager?.updateCallUserIds(this._userIds),
            this._videoQuality?.updateCallUserIdsCount(this._userIds.size),
    ...
    _handleCodecs(e, t) {
        ...
        null != n && null != this.protocol
            ? n.setCodecs(null != e && "" !== e ? e : ea.UK.OPUS, null != t && "" !== t ? t : ea.UK.H264, this.context)
    ...
    _handleMediaSessionId(e) {
        ...
        F.default.track(ei.HAw.MEDIA_SESSION_JOINED, {
            ...this._getAnalyticsProperties(),
            media_session_id: this.getMediaSessionId(),
            parent_media_session_id: this.parentMediaSessionId,
            raw_thermal_state: t,
    ...
    _trackSecureFrameTransition(e) {
        ...
        F.default.track(ei.HAw.SECURE_FRAMES_TRANSITION, {
            ...this._getAnalyticsProperties(),
            media_session_id: this.getMediaSessionId(),
            parent_media_session_id: this.parentMediaSessionId,
            sender_user_id: this.userId,
            ...
            e === em && this._trackRemainingSecureFrameTransitions();
    }
        ...
        this.recordEvent({ c: 11, v: e }),
            e > 0
                ? (this.logger.info(`DAVE protocol init with protocol version: ${e}`),
                  ...
                  this._connection?.prepareSecureFramesEpoch(eh, e, this.trueChannelId),
                ...
                : this._connection?.prepareSecureFramesTransition(em, e, () => {
                      let n = !1;
                      try {
                          this._connection?.executeSecureFramesTransition(em);
                      } catch (e) {
                          (n = !0), j.A.captureException(e);
                      }
                      this._storeSecureFrameTransitionData(em, {
                          initReceivedTime: t,
                          initFinishedTime: (0, p.tB)(),
                          protocolVersion: e,
                          executeError: n,
                      }),
                          this._trackSecureFrameTransition(em);
                  });
    }
        ...
        Object.entries(e).forEach((e) => {
            ...
            n.push(eE(t)),
                null == s || 0 === s.byteLength
                    ? (i++, this._secureFramesRosterMap.delete(eE(t)))
                    : (r++, this._secureFramesRosterMap.set(eE(t), s));
        }),
    ...
    _handleMLSFailure(e, t) {
        ...
        this.recordEvent({ c: 3, i: r }),
            ...
            e.includes("GetPersistedKeyPair")
                ? m.A.show({ title: eo.intl.string(eo.t.fJUioH), body: eo.intl.string(eo.t.CQLWvo) })
    ...
    _trackMLSFailures(e) {
        ...
        for (let {
            ...
            F.default.track(ei.HAw.MLS_FAILURES, {
                ...this._getAnalyticsProperties(),
                media_session_id: i,
                parent_media_session_id: this.parentMediaSessionId,
                failure_id: e,
    ...
    _handleVoiceQualityPeriodicsStats = () => {
        if (null != this._voiceQuality) {
            ...
            if (this.shouldReportPeriodicStats(e))
                for (let t of e)
                    F.default.track(ei.HAw.VOICE_QUALITY_PERIODIC_STATS, {
                        ...this._getAnalyticsProperties(),
                        media_session_id: this.getMediaSessionId(),
    ...
    _trackVoiceConnectionConnecting = () => {
        let e = M.A.getChannel(this.channelId),
            t = e?.type;
        F.default.track(ei.HAw.VOICE_CONNECTION_CONNECTING, {
            ...this.getAudioDeviceStates(),
