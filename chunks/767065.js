...
class eC extends _.A {
    ...
    constructor({
        ...
        const d = U.A.supports(eu.O5.FIRST_FRAME_CALLBACK) && U.A.supports(eu.O5.REMOTE_USER_MULTI_STREAM);
        if (i === eu.x.DEFAULT) {
        ...
        (this._remoteVideoSinkWants = J.AE),
            ...
            (0, W.isDesktop)() &&
                (this.powerMonitorListener = $.A.remotePowerMonitor.on("resume", this._handlePowerResume)),
    ...
    recordEvent(e) {
        for (ey.push({ ...e, t: (0, p.tB)(), n: this._connectionSerial }); ey.length > eS; ) ey.shift();
    }
    get quality() {
        ...
        return this.state !== eo.S7L.RTC_CONNECTED || void 0 === e
            ...
            : e > ep || (null != this._outboundLossRate && this._outboundLossRate > em)
              ? eo.bFR.BAD
              : e > eh || (null != this._outboundLossRate && this._outboundLossRate > eg)
                ? eo.bFR.AVERAGE
                : eo.bFR.FINE;
    }
    get endpoint() {
    ...
    _handleDisconnect(e, t, n, r) {
        this.logger.info(`Disconnected from RTC server, clean: ${t}, code: ${n}, reason: ${r}, state: ${this.state}`),
            t ||
                ...
                (j.default.track(eo.HAw.VOICE_CONNECTION_SOCKET_FAILURE, {
        ...
        if (this.state !== eo.S7L.DISCONNECTED) {
            ...
            if (null != e && this.context === eu.x.DEFAULT) {
                if ((e.stop(), this._sentVideo)) {
                    e.getOutboundStats().forEach((t) => {
                        (t.num_frames ?? 0) > 0 &&
                            j.default.track(eo.HAw.VIDEO_STREAM_ENDED, {
                                ...this._getAnalyticsProperties(),
                    ...
                    null != t &&
                        ...
                        j.default.track(eo.HAw.VIDEO_CALL_ENDED, { ...t, media_session_id: this.getMediaSessionId() });
                }
            ...
            U.A.getMediaEngine()
                ...
                .then((e) => {
                    ...
                    j.default.track(eo.HAw.VOICE_CODEC_DETECTED, {
                        ...n,
            ...
            let n = F.A.shouldIncludePreferredRegion() ? F.A.getPreferredRegion() : null,
                a = U.A.getSettings(),
                s = k.A.getChannel(this.channelId),
            ...
            Promise.all([
                ...
                j.default.track(eo.HAw.VOICE_DISCONNECT, {
                    ...l,
                    battery_usage: t,
                    krisp_nc_model: n,
    ...
    _handleReady(e, t, n, r, i, a, s) {
        this.setState(eo.S7L.RTC_CONNECTING),
            ...
            0 === a.length &&
                a.push({ type: eu.mI.VIDEO, rid: "100", ssrc: i + 1, rtxSsrc: i + 2, quality: 100, active: !1 });
        let o = U.A.getMediaEngine(),
            l = P.A.getPersistentCodesEnabled(),
            u = M.default.getStaticAuthSessionId() ?? void 0,
            c = (0, p.tB)(),
        ...
        (0, W.isWeb)() && !el.PF && K.A.captureMessage("Browser does not support Unified Plan"),
            d.setUseElectronVideo(o.supports(eu.O5.ELECTRON_VIDEO)),
        ...
        let m = ["unk"];
        m.push("nvNewPresets"),
            this.context === eu.x.STREAM ? m.push("nvRelaxRc=250") : m.push("nvRelaxRc=75"),
            U.A.getUseVaapiEncoder() && m.push("vaapi"),
            this.context === eu.x.STREAM &&
                "streamer" === this.getVoiceParticipantType() &&
                (0, w.b)("handleReady").enabled &&
                m.push("useCaptureDeviceForEncode"),
            d.setVideoEncoderExperiments(m.join(",")),
            d.on(f.yq.Speaking, (e, t, n) => {
                this.userId === e && this.sendSpeaking(t, n), this.emit(Z.q.Speaking, eI(e), t);
            }),
            d.on(f.yq.ToggleMuteFromNative, () => {
                this.context === eu.x.DEFAULT && g.A.toggleSelfMute({ playSoundEffect: !1 });
            }),
            d.on(f.yq.NativeMuteChanged, (e) => {
                this.context === eu.x.DEFAULT && A.A.nativeMuteChanged(e);
            }),
            ...
            d.on(f.yq.VideoDecoderFallback, (t) => {
                let n = k.A.getChannel(this.channelId),
                    r = n?.type === eo.rbe.GUILD_STAGE_VOICE;
            ...
            d.on(f.yq.Error, (t) => {
                ...
                this.logger.error(`Error occurred while connecting to RTC server: ${t}`),
                    j.default.track(eo.HAw.VOICE_CONNECTION_FAILURE, {
                        ...this._getAnalyticsProperties(),
                        hostname: this.hostname,
                        port: this.port,
                        protocol: this.protocol,
            ...
            d.on(f.yq.ConnectionStateChange, (t) => {
                ...
                if (
                    ...
                    if (this._connecting) {
                        ...
                        j.default.track(eo.HAw.VOICE_CONNECTION_SUCCESS, {
                            ...n,
                            hostname: this.hostname,
                            port: this.port,
                            protocol: this.protocol,
                            ...
                            join_voice_id: this.joinVoiceId,
                            is_camera_enabled:
                                U.A.getMediaEngine().getVideoInputDeviceId() !== eu.qe && d.context === eu.x.DEFAULT,
                            ...this.stateHistory.getVoiceConnectionSuccessStats(),
                        });
                        let r = performance.now(),
                            i = (e, t) => (null == e || null == t ? null : e - t);
                        j.default.track(eo.HAw.VOICE_CONNECTION_TTC_COLLECTED, {
    ...
    _handleRemoteStreamsReady(e) {
        ...
        j.default.track(eo.HAw.VOICE_CONNECTION_REMOTE_STREAMS_CREATED, {
            ...this._getAnalyticsProperties(),
            number_of_users: e,
            duration_ms: t,
        });
    ...
    _handleMediaSessionId(e) {
        ...
        j.default.track(eo.HAw.MEDIA_SESSION_JOINED, {
            ...this._getAnalyticsProperties(),
            media_session_id: this.getMediaSessionId(),
            parent_media_session_id: this.parentMediaSessionId,
            raw_thermal_state: t,
    ...
    _trackSecureFrameTransition(e) {
        ...
        j.default.track(eo.HAw.SECURE_FRAMES_TRANSITION, {
            ...this._getAnalyticsProperties(),
            media_session_id: this.getMediaSessionId(),
            parent_media_session_id: this.parentMediaSessionId,
            sender_user_id: this.userId,
    ...
    _trackMLSFailures(e) {
        ...
        for (let {
            ...
            j.default.track(eo.HAw.MLS_FAILURES, {
                ...this._getAnalyticsProperties(),
                media_session_id: i,
                parent_media_session_id: this.parentMediaSessionId,
                failure_id: e,
    ...
    _handleVoiceQualityPeriodicsStats = () => {
        if (null != this._voiceQuality) {
            ...
            if (this.shouldReportPeriodicStats(e))
                for (let t of e)
                    j.default.track(eo.HAw.VOICE_QUALITY_PERIODIC_STATS, {
                        ...this._getAnalyticsProperties(),
                        media_session_id: this.getMediaSessionId(),
    ...
    _trackVoiceConnectionConnecting = () => {
        let e = k.A.getChannel(this.channelId),
            t = e?.type;
        j.default.track(eo.HAw.VOICE_CONNECTION_CONNECTING, {
            ...this.getAudioDeviceStates(),
    ...
    getInputDeviceName() {
        let e = U.A.getInputDeviceId();
        return U.A.getInputDevices()[e]?.name;
    }
    getOutputDeviceName() {
        let e = U.A.getOutputDeviceId();
        return U.A.getOutputDevices()[e]?.name;
    }
    getVideoDeviceName() {
        let e = U.A.getVideoDeviceId();
        return U.A.getVideoDevices()[e]?.name;
    }
