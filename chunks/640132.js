...
function ed(e) {
    let { creator: n, guildId: t, channelId: s } = e,
        ...
        u = (0, B.gn)(i?.guildId, i?.userId, i?.colorStrings ?? null);
    return (0, l.jsxs)("div", {
        className: eu.nM,
        children: [
            (0, l.jsx)(M.eu, {
...
function ea(e) {
    ...
    return (0, l.jsx)("div", {
        className: eu.nM,
        children: null != t ? (0, l.jsx)(V.D, { onClick: i, className: eu.vk, role: "link", children: u }) : u,
    });
}
function ec(e) {
    ...
    return (0, l.jsxs)("div", {
        ...
        children: [
            ...
            (0, l.jsxs)("div", {
                className: eu.rf,
                children: [
                    (0, l.jsx)(ea, { guild: t, onClick: x ? v : void 0, onClose: u }),
                    (0, l.jsx)(ei.A, { guildScheduledEvent: n, channel: r, onClose: u }),
                    null != j && (0, l.jsx)(ec, { userCount: j, onClick: d }),
                    null != N && (0, l.jsx)(ed, { creator: N, guildId: t.id, channelId: r?.id }, N.id),
                    null != n.description &&
                        (0, l.jsx)("div", {
                            className: eu.h_,
            ...
            null != y && (0, l.jsx)("hr", { className: eu.yF }),
            null != y &&
                (0, l.jsx)(es.A, {
                    guildId: t.id,
                    recurrenceRule: y,
...
function eC(e) {
    let { eventUser: n, guildId: t, onContextMenu: r } = e,
        i = s.useRef(null),
        u = (0, a.bG)([eI.default], () => eI.default.getUser(n.user_id)),
        d = (0, a.bG)(
...
function eR(e) {
    ...
    if (null != u && 0 === r.length) return (0, l.jsx)(eb, { height: d, children: (0, l.jsx)(eE, {}) });
    let c = 0;
    return (
        r.length >= E.C1 && a > E.C1 && (c = Math.max(a - r.length, 0)),
        0 === r.length
            ? (0, l.jsx)(eb, { height: d, children: (0, l.jsx)(e_, {}) })
            : (0, l.jsx)(ep, {
                  children: (0, l.jsx)(ek, {
                      eventUsers: r,
                      guildId: n.guild_id,
...
function eG(e) {
    let { guildEvent: n, guild: t, channel: s, onActionTaken: i, recurrenceId: u } = e,
        d = (0, N.Fd)(n),
        c = (0, a.bG)([N.Ay], () => N.Ay.isInterestedInEventRecurrence(n.id, u), [u, n]),
        o = (0, y.Ay)(n),
        h = (0, a.bG)([m.A], () => m.A.isLurking(t.id), [t.id]),
        x = (0, S.e)(s?.id, n.id),
        g = (0, eT.A)({ guild: t, channel: s, guildScheduledEvent: n, isActive: d, recurrenceId: u, onActionTaken: i }),
        j = (0, p.Zq)({
            isActive: d,
            isUserLurking: h,
            rsvped: c,
...
let eU = (e) => {
    ...
    s.useEffect(() => {
        null == G
            ? p()
            : X.current || ((X.current = !0), v.default.track(eL.HAw.OPEN_MODAL, { type: E.BV, guild_id: G.guild_id }));
    }, [G, p]);
    let W = s.useRef(null),
        [$, J] = s.useState(680);
    s.useLayoutEffect(() => {
    ...
    return (0, l.jsx)(x.f5, {
        ...
        children: (0, l.jsxs)(i.d, {
            ...
            children: [
                            ...
                            children: [
                                (0, l.jsx)(c.q, {
                                    ...
                                    children: (0, l.jsx)(eo, {
                                        ...
                                        headerId: O,
                                        onClose: p,
                                        onClickInterestedCount: () => es(E.al.RSVP_LIST),
                                        containerRef: ee,
                                        recurrenceId: er,
                                        setRecurrenceId: L,
                                    }),
                ...
                (0, l.jsx)(eG, { guildEvent: G, guild: w, channel: V, onActionTaken: p, recurrenceId: er }),
            ],
        }),
    });
};
