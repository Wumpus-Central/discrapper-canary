...
function o(e) {
    let n = e?.location ?? "useNitroProgramReward",
        t = (0, _.DK)(l.W.NITRO, n),
        {
            ...
            isReady: i.A.isReady(),
            programReward: i.A.getRewardForProgram(l.W.NITRO),
            totalDays: i.A.getTotalDaysInDuration(l.W.NITRO),
        })),
        D = (0, r.bG)([a.A], () => a.A.getPremiumTypeSubscription()?.isPurchasedExternally ?? !1),
        c = (0, u.q)(),
        I = (function (e, n) {
