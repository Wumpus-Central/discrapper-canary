...
let I = { any: 100 },
    T = { any: 0 },
    S = 30 * p.A.Millis.SECOND,
    y = 120 * p.A.Millis.SECOND,
    N = -1 !== (0, f.EL)();
var v = (((r = {}).UserSSRCUpdate = "user-ssrc-update"), (r.Update = "update"), r);
function C(e) {
    let { invertWants: t } = (0, d.P)("RTCMediaSinkWantsManager.getDefaultWants");
    return t ? { ...T } : { any: e };
}
class O extends a.A {
    userId;
    ...
    constructor(e, t, n, r = new l.r()) {
        super(),
            ...
            (this.ladder = r),
            (this.delayedCall = new c.J_(100, this.update)),
    ...
    updateOffscreenUsers = () => {
        ...
        let e = Date.now(),
            t = [];
        for (let [n, r] of E.default.entries(this.streamIds))
            null != r &&
    ...
    update = (() => {
        ...
        return function () {
            let t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [],
                ...
                r = C(n),
                i = r;
            (0, d.P)("RTCMediaSinkWantsManager.update").invertWants && (e.invertWants(r, n), N && (i = { ...r })),
                e.updateOffscreenUsers();
            let a = (0, h.isDesktop)() && e.isOneToOneCall() && !e.isStageChannel;
            for (let [i, s] of E.default.entries(e.videoSsrcs)) {
                let o = [],
                    l = !1,
                        ...
                        if (e.supportsSeamless && !e.framesReceived[_])
                            for (let t of ((l = !0), (o = [_]), s))
                                t.ssrc !== _ &&
                                    ...
                                    (100 === t.quality ? (r[t.ssrc] = 100) : (r[t.ssrc] = a ? d : n), o.push(t.ssrc));
                    } else t ? (r[_] = 100) : a && (r[_] = d);
