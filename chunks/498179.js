...
function m(e) {
    let { application: t, fullWidth: n = !1, size: m = l.zx.Sizes.LARGE, color: f, customDisabledColor: _, hideNotLaunchable: g, tooltipPosition: h, onClick: b, className: E, source: C, hover: O, innerClassName: y } = e,
        v = {
            fullWidth: n,
            size: m,
            color: f,
