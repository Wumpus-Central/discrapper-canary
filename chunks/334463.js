...
class p extends o.Ay.PersistedStore {
    ...
    initialize(e) {
        ...
        (h = e.openPosition), (f = e.pipWidths);
    }
    get pipWindow() {
        return null == i && null == r && null == s && null == a ? null : d.get(i ?? r ?? s ?? a ?? "");
    }
    get pipVideoWindow() {
    ...
    getState() {
        return { openPosition: h, pipWidths: f };
    }
}
let E = new p(l.h, {
    PICTURE_IN_PICTURE_OPEN: function (e) {
        ...
        let l = { id: t, component: n, position: o.position ?? h, props: o, docked: o.docked ?? !1 };
        switch ((d.set(t, l), n)) {
            case u.o1q.VIDEO:
                null == i && (i = t);
                break;
    ...
    LOGOUT: function () {
        (i = null), (r = null), (s = null), (a = null), (d = new Map());
    },
});
