...
function j(e) {
    let { application: t, loadingAppId: n, setLoadingAppId: l, analyticsLocations: c } = e,
        p = (0, a.e7)([u.ZP], () => u.ZP.getCurrentEmbeddedActivity()),
    ...
    return (0, r.jsx)(s.P3F, {
        className: o()(I.clickable, { [I.disabledClickable]: m }),
        onClick: b,
...
function x(e) {
    ...
    return (
        i.useLayoutEffect(() => {
            var e;
            !c.current && ((c.current = !0), E.default.track(v.rMx.APP_DMS_QUICK_LAUNCHER_IMPRESSION, { apps_dm_quick_launcher_application_ids_frecency_v2: null !== (e = u.map((e) => e.id)) && void 0 !== e ? e : [] }));
        }, [u]),
        (0, r.jsxs)(r.Fragment, {
            children: [
                (0, r.jsxs)('div', {
