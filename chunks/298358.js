...
function I(e) {
    ...
    return (
        a && (s = r ? A.lj : 3 * !!i),
        { hasAccess: a, isExperimentEnabled: t, hasHigherPrivileges: n, favoriteLimit: s }
    );
}
function f(e) {
    let { enabled: t, hasHigherPrivileges: n, isFreemium: r = !1 } = (0, d.mN)({ location: e }),
...
function p() {
    let { enabled: e, hasHigherPrivileges: t, isFreemium: n = !1 } = (0, d.BM)({ location: "getFavoritesAccess" });
    return I({
