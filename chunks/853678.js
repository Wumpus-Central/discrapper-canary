    ...
    T = {
            ...
            handler(e) {
                ...
                try {
                    ...
                    if (m.isPlatformEmbedded) {
                        let e = (0, a.R)({ isContextless: (null == i ? void 0 : i.location.kind) === r.E.CONTEXTLESS }) ? N.KJ3.ACTIVITY_POPOUT : null;
                        h.Z.focus(e, !0);
                    }
        ...
        [N.Etm.NAVIGATE_TO_CONNECTIONS]: {
            ...
            handler(e) {
                ...
                if (!I.has(n)) throw new b.Z({ errorCode: N.lTL.UNAUTHORIZED_FOR_APPLICATION }, 'Command not available for this application');
        ...
        [N.Etm.SHARE_LINK]: (0, i.S)(N.Etm.SHARE_LINK, {
            ...
            handler(e) {
                ...
                let {
                    socket: n,
                    args: { custom_id: r, message: i, link_id: l, referrer_id: o }
                } = e;
                (0, _.bu)(n.transport);
                let a = (0, _._f)(n.application);
                if (null == a) throw new b.Z({ errorCode: N.lTL.INVALID_COMMAND }, 'No application.');
                if (!(0, f.yE)(null !== (t = n.application.flags) && void 0 !== t ? t : 0, N.udG.EMBEDDED)) throw new b.Z({ errorCode: N.lTL.INVALID_COMMAND }, 'This application cannot access this API');
                return new Promise((e) => {
                    (0, u._)({
                        applicationId: a,
                        customId: r,
