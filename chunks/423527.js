...
class eu extends (r = l.PureComponent) {
    ...
    async handleRegister() {
        let { email: e, username: t, globalName: n, password: r, consent: i, parsedDateOfBirth: l } = this.state,
            { invite: s, guildTemplate: o, giftCode: a, onRegister: c, usernameSuggestion: u } = this.props,
    ...
    renderConsentComponent() {
        ...
        return t
            ...
            : (0, i.jsx)(p.Text, {
                  ...
                  className: o()(ei.marginTop8, er.consentSubText),
                ...
                (0, i.jsxs)(I.gO, {
                    ...
                    children: [
                        ...
                        (0, i.jsx)(p.Text, {
                            variant: 'text-sm/normal',
                            color: 'text-secondary',
                            className: o()(ei.marginTop20, er.consentSubText),
                            children: en.intl.format(en.t['KI+BSU'], {
                                termsURL: X.EYA.TERMS,
                                privacyURL: X.EYA.PRIVACY
                            })
    ...
    renderInviteButton() {
        ...
        return (
            (null == e ? void 0 : e.stage_instance) != null && ((l = I.zx.Colors.GREEN), (s = en.intl.string(en.t['5UKyUl']))),
            (0, i.jsx)(p.ua7, {
                text: !n && t ? en.intl.string(en.t.AY4IVF) : null,
                children: (e) =>
                    (0, i.jsx)(
                        'div',
                        eo(es({ className: ei.marginTop8 }, e), {
    ...
    renderErrorMessage() {
        ...
        return 'string' != typeof e
            ? null
            : (0, i.jsx)(I.i_, {
                  className: o()(ei.marginTop20, er.errorMessage),
                  children: e
              });
    }
    renderFull(e, t) {
        let { email: n, username: r, globalName: s, password: a, consent: c, parsedDateOfBirth: u, globalNameFocused: d, emailClientError: h, usernameClientError: m, passwordClientError: f, dateOfBirthClientError: g, registering: _, apiErrors: { email: b, username: E, global_name: v, password: j, date_of_birth: O } = {} } = this.state,
            ...
            T = (0, i.jsx)(p.ua7, {
                ...
                children: (e) =>
                    (0, i.jsx)(
                        'div',
                        eo(es({ className: ei.marginTop20 }, e), {
                            children: (0, i.jsx)(I.zx, {
                                type: 'submit',
                                submitting: _,
            ...
            Z = null != e ? (0, i.jsx)(l.Fragment, { children: e() }, 'custom-header') : (0, i.jsx)(I.Dx, { children: en.intl.string(en.t.wC4TlZ) }, 'title'),
            R = (0, i.jsxs)(I.gO, {
                className: ei.marginTop20,
                children: [
                    (0, i.jsx)(I.II, {
        ...
        return t
            ? (0, i.jsx)(J.Z, {
                  onSubmit: this.handleSubmit,
                  tag: 'form',
                  className: o()(C, er.horizontalAuthBox),
                  children: () => [
                      Z,
                      (0, i.jsxs)(
                          'div',
    ...
    constructor(e) {
        ...
        (super(e),
            ...
            el(this, 'handleGotoLogin', (e) => {
                let t,
                    { email: n } = this.state,
                    { giftCode: r, guildTemplate: i, invite: l, location: s, onLoginStart: o, redirectTo: c, transitionTo: u } = this.props,
            ...
            el(this, 'handleSubmit', (e) => {
                ...
                let o = this.inGuildOrChannelInviteFlow(),
                    a = !1;
                (o ? 0 === l.length && (this.setState({ globalNameClientError: en.intl.string(en.t.EkokLy) }), (a = !0)) : (0 === t.length && (this.setState({ emailClientError: en.intl.string(en.t.EkokLy) }), (a = !0)), 0 === n.length && (this.setState({ usernameClientError: en.intl.string(en.t.EkokLy) }), (a = !0)), 0 === r.length && (this.setState({ passwordClientError: en.intl.string(en.t.EkokLy) }), (a = !0))), null == i && (this.setState({ dateOfBirthClientError: en.intl.string(en.t.EkokLy) }), (a = !0)), a || this.handleRegister());
            }),
...
function ed(e) {
    let t = (0, d.cj)([G.Z, F.default, g.Z, R.Z, P.Z], () => ({
...
function eh(e) {
    let t,
        { username: n, suggestion: r, globalName: l, isUsernameFocused: s, onClickSuggestion: o } = e,
        a = (0, k.a)(n, !0, !0),
        u = n.length > 0;
    return (
        (t = u
        ...
        (0, i.jsx)(B.Z, {
            show: (u && (null == a ? void 0 : a.type) === D.K.ERROR) || s,
            top: -12,
            bottom: 20,
            children: t
        })
