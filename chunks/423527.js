...
class eu extends (r = s.PureComponent) {
    ...
    renderFull(e, t) {
        let {
                ...
                registering: x,
                apiErrors: { email: v, username: b, global_name: j, password: I, date_of_birth: O } = {},
            } = this.state,
            { consentRequired: y, authBoxClassName: C, hasLoggedInAccounts: A } = this.props,
