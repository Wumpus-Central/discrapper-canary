        ...
        children: [
            g
                ? (0, i.jsxs)("div", {
                      ...
                      children: [
                          (0, i.jsx)(ea.A, {
                              className: r()(eO.k9, s ? eO.y2 : void 0),
                              canEdit: s,
                              userId: n,
                              image: l.image,
                              previewUri: c,
...
function tw(e) {
    let t,
        { widget: s, user: r, allowEditing: a, disableInteraction: o, ...d } = e,
        [c, u] = l.useState(null),
        [g, m] = l.useState(!1),
        x = l.useRef(void 0),
        f =
        ...
        p = 0 === f.length,
        I = f.length >= 4,
        j = f.find((e) => e.key === c) ?? f[f.length - 1],
        A = l.useCallback(() => {
    ...
    return (0, i.jsx)(F.A, {
        ...
        className: ty.kL,
        headerTitle: (0, W.L)(s),
        headerActionButtons: h && p ? [(0, i.jsx)(tN, { onClick: E }, "clips-gallery-add-clip")] : void 0,
        ...d,
        children:
            null != j
                ? (0, i.jsxs)("div", {
                      ...
                      children: [
                          (0, i.jsxs)("div", {
                              ...
                              onMouseLeave: v,
                              children: [
                                  (0, i.jsx)(tl.A, { item: j, ringSize: "lg", isPlaying: g, className: ty.VH }),
                                  (0, i.jsx)(tT, {
                                      children:
                                          ("saved" === j.status || "pending" === j.status) &&
                                          (0, i.jsx)(td, { clipId: j.key, title: j.title, allowEditing: h }),
                                  }),
                              ],
                          }),
                          (0, i.jsx)(tC, {
    ...
    function A() {
        return (0, i.jsxs)(i.Fragment, {
            children: [
                o &&
                    (0, i.jsxs)(i.Fragment, {
                        children: [(0, i.jsx)(e6, { className: nL.cG }), d && (0, i.jsx)(nP, {}), (0, i.jsx)(tU, {})],
                    }),
                r.map((e, l) =>
                    (0, i.jsx)(
                        nO,
