...
var r = {
    ...
    "creditCard.holderName.invalid": "Introduzir o nome como mostrado no cart\xe3o",
    ...
    "firstName.invalid": "Introduza o seu nome pr\xf3prio",
    infix: "Prefixo",
    lastName: "Apelido",
    ...
    gender: "G\xe9nero",
    "gender.notselected": "Selecione um g\xe9nero",
    male: "Homem",
    female: "Feminino",
    ...
    address: "Morada",
    "address.placeholder": "Encontre o seu endere\xe7o",
    "address.errors.incomplete": "Introduza um endere\xe7o para continuar",
    "address.enterManually": "Introduza o endere\xe7o manualmente",
    state: "Estado",
    ...
    "voucher.introduction.doku":
        "Obrigado pela sua compra, use as seguintes informa\xe7\xf5es para concluir o seu pagamento.",
    ...
    "creditCard.taxNumber.label":
        "Data de nascimento do titular do cart\xe3o (AAMMDD) ou n\xfamero de registo da Empresa (10 d\xedgitos)",
    "creditCard.taxNumber.labelAlt": "N\xfamero de registo da empresa (10 d\xedgitos)",
    "creditCard.taxNumber.invalid":
        "Data de nascimento do titular do cart\xe3o ou n\xfamero de registo empresarial inv\xe1lido",
    ...
    "swish.pendingMessage":
        "Ap\xf3s a leitura, o estado pode estar pendente por at\xe9 10 minutos. Tentar pagar novamente dentro desse prazo pode resultar em v\xe1rias cobran\xe7as.",
    ...
    "error.va.sf-cc-num.01": "Introduza um n\xfamero de cart\xe3o v\xe1lido",
    "error.va.sf-cc-num.02": "Introduza o n\xfamero do cart\xe3o",
    "error.va.sf-cc-num.03": "Introduza uma marca de cart\xe3o suportada",
    "error.va.sf-cc-num.04": "Introduza o n\xfamero do cart\xe3o completo",
    "error.va.sf-cc-dat.01": "Introduza uma data de validade v\xe1lida",
    "error.va.sf-cc-dat.02": "Introduza uma data de validade v\xe1lida",
    "error.va.sf-cc-dat.03": "Cart\xe3o de cr\xe9dito prestes a expirar",
    "error.va.sf-cc-dat.04": "Introduza a data de validade",
    "error.va.sf-cc-dat.05": "Introduza a data de validade completa",
    "error.va.sf-cc-mth.01": "Introduza o m\xeas de validade",
    "error.va.sf-cc-yr.01": "Introduza o ano de validade",
    "error.va.sf-cc-yr.02": "Introduza o ano de validade completa",
    "error.va.sf-cc-cvc.01": "Introduza o c\xf3digo de seguran\xe7a",
    "error.va.sf-cc-cvc.02": "Introduza o c\xf3digo de seguran\xe7a completo",
    ...
    "bankTransfer.introduction":
        "Continue para criar um novo pagamento de transfer\xeancia banc\xe1ria. Pode usar os detalhes no ecr\xe3 a seguir para finalizar este pagamento.",
    ...
    "bacs.consent.account":
        "Confirmo que a conta est\xe1 em meu nome e sou o \xfanico signat\xe1rio necess\xe1rio para autorizar o d\xe9bito autom\xe1tico nesta conta.",
    edit: "Editar",
    ...
    "creditCard.encryptedCardNumber.aria.iframeTitle": "Iframe para o n\xfamero do cart\xe3o",
    ...
    "creditCard.encryptedExpiryMonth.aria.iframeTitle": "Iframe para o m\xeas de validade",
    ...
    "giftcard.encryptedCardNumber.aria.iframeTitle": "Iframe para o n\xfamero do cart\xe3o",
    "giftcard.encryptedCardNumber.aria.label": "N\xfamero de cart\xe3o",
    ...
    "ach.encryptedBankAccountNumber.aria.iframeTitle": "Iframe para n\xfamero de conta banc\xe1ria",
    "ach.encryptedBankAccountNumber.aria.label": "N\xfamero da conta",
    "ach.encryptedBankLocationId.aria.iframeTitle": "Iframe para n\xfamero de identifica\xe7\xe3o banc\xe1ria",
    "ach.encryptedBankLocationId.aria.label": "N\xfamero de encaminhamento da ABA",
    "pix.instructions":
        "Abra a aplica\xe7\xe3o com a chave registada PIX, escolha Pagar com PIX e digitalize o QR Code ou copie e cole o c\xf3digo",
    "twint.saved": "salvou",
    orPayWith: "ou pague com",
    invalidFormatExpects: "Formato inv\xe1lido. Formato esperado: %{format}",
    "upi.qrCodeWaitingMessage":
        "Digitalize o c\xf3digo QR usando a sua aplica\xe7\xe3o UPI preferida para concluir o pagamento",
    ...
    "onlineBankingPL.termsAndConditions":
        "Ao continuar, concorda com o %#regulamento%# e a %#obriga\xe7\xe3o de informa\xe7\xe3o%# da Przelewy24",
    ...
    "ctp.infoPopup.subtitle":
        "Um m\xe9todo de pagamento r\xe1pido e seguro suportado pela Mastercard, Visa e outros cart\xf5es de pagamento.",
    ...
    "ctp.errors.NOT_FOUND":
        "Nenhuma conta encontrada, insira um e-mail v\xe1lido ou continue usando a entrada manual do cart\xe3o",
    ...
    "ctp.errors.ACCT_INACCESSIBLE":
        "Esta conta n\xe3o est\xe1 atualmente dispon\xedvel, por exemplo, est\xe1 bloqueada",
    ...
    "companyDetails.registrationNumber.invalid": "Insira o n\xfamero de registo",
    "consent.checkbox.invalid": "Tem de aceitar os termos e condi\xe7\xf5es",
    "form.instruction": "Todos os campos s\xe3o obrigat\xf3rios, a menos que assinalados em contr\xe1rio.",
    "trustly.descriptor": "Pagamento banc\xe1rio instant\xe2neo",
    "trustly.description1":
        "Pague diretamente a partir de qualquer uma das suas contas banc\xe1rias, com a seguran\xe7a de um banco",
    "trustly.description2": "Sem cart\xf5es, sem transferir aplica\xe7\xf5es, sem registo",
};
