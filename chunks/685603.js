...
class E extends l.Component {
    ...
    handleOperationStart = (e, t, n) => {
        ...
        if (null == i || !l) return;
        let { width: o, height: c } = _(i, this.size),
    ...
    handleDragMove(e, t) {
        ...
        let { width: f, height: g } = _(n, this.size),
            E = t - p,
            x = e - h,
            y = (0, d.fh)((0, d.Ly)({ top: E, left: x, bottom: void 0, right: void 0 }, s, l, f, g)),
    ...
    handleOperationEnd = () => {
        ...
        if (t) {
            let { maxX: e, maxY: t } = this.props.container,
                { width: n, height: s } = _(this.ref.current, this.size),
    ...
    setDOMPositions(e) {
        ...
        (this.anchor = { top: t, left: n, bottom: i, right: s }),
            null != l && ((l.style.top = g(t)), (l.style.bottom = g(i)), (l.style.left = g(n)), (l.style.right = g(s)));
    }
    setDOMSize(e) {
        ...
        (t = "auto" === this.size.width ? "auto" : t),
            ...
            null != i && ((i.style.width = g(t)), (i.style.height = g(n)));
    }
    renderResizeHandles() {
