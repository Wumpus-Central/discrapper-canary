...
function p(e) {
    ...
    let m = (0, a.Kj)(r),
        ...
        y = m.size - m.stroke,
        N = { width: 0.4 * S, height: 0.4 * S },
        v = { width: N.width + 1, height: N.height + 1, right: m.stroke + 1, bottom: m.stroke + 1, padding: 0 };
    return (0, i.jsxs)("div", {
        className: _.kL,
        style: { width: y, height: y, padding: m.stroke },
        "aria-label": `${g() ?? ""}`,
        children: [
            (0, i.jsx)("div", {
                className: _.r5,
            ...
            !n &&
                (0, i.jsx)("div", {
                    className: _.dq,
                    style: v,
                    children: (0, i.jsx)(l.X, { size: "custom", color: T.locked, ...N }),
                }),
            n &&
                A === d.md.LEGENDARY &&
                (0, i.jsx)("div", { className: _.dq, style: v, children: (0, i.jsx)(c.A, { className: _.ox, ...N }) }),
        ],
    });
}
p.Sizes = a._3;
