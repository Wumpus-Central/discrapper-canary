...
function p(e) {
    ...
    let m = (0, a.Kj)(r),
        ...
        N = { width: C.width + 1, height: C.height + 1, right: m.stroke + 1, bottom: m.stroke + 1, padding: 0 };
    return (0, i.jsxs)("div", {
        className: _.kL,
        ...
        children: [
            ...
            n &&
                A === d.md.LEGENDARY &&
                (0, i.jsx)("div", { className: _.dq, style: N, children: (0, i.jsx)(c.A, { className: _.ox, ...C }) }),
        ],
    });
}
p.Sizes = a._3;
