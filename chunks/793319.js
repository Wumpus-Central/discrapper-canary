...
function eC(e) {
    let { channel: t, currentUser: n, exitFullScreen: o, canGoLive: a, hasPermission: s, disabled: l } = e,
        ...
        _ = (0, E.bp)(),
        p = (0, u.Wu)([$.Z], () => $.Z.getAllActiveStreams()),
        ...
        [I, T] = i.useState(!1),
        S = () => {
            if (((0, N.v)(c, N.d.STREAM, !0), a)) return void y();
            (0, ef.Z)();
        },
        A = () => {
...
let eP = i.memo(function (e) {
    let { currentUser: t, onDisconnectCall: n, channel: o, connectedEmbeddedActivity: a } = e,
        ...
        O = (0, M.qY)(o.id),
        T = i.useRef(null),
        S = i.useCallback(() => ((null == l ? void 0 : l.type) === em.fO.ACTIVITY && l.applicationId === (null == a ? void 0 : a.applicationId) ? 'ACTIVITY' : b ? 'STREAM' : null != O ? 'EVENT' : 'CALL'), [l, null == a ? void 0 : a.applicationId, b, O]),
        [A, C] = i.useState(S()),
        R = (0, f.q_F)(
            {
                opacity: _ ? 0.2 : 1,
...
let eL = function (e) {
    ...
    let { channel: n, className: o, onDisconnectCall: s, exitFullScreen: c, idleProps: d } = e,
        ...
        M = (0, w.Z)(),
        k = (0, u.e7)([P.Z], () => null != P.Z.getAwaitingRemoteSessionInfo()),
        U = null != M,
        G = (0, u.e7)([en.Z], () => {
            var e;
              ...
              children: (0, r.jsxs)(g.Z, {
                  ...
                  children: [
                      (0, r.jsx)('div', {
                          ...
                          children: (0, r.jsx)(j.Z, { channelId: n.id })
                      }),
                      (0, r.jsxs)('div', {
                          ref: _,
