...
let eA = function (e) {
    ...
    let { channel: l, className: a, onDisconnectCall: c, exitFullScreen: d, idleProps: h } = e,
        ...
        [x, S] = i.useState(void 0),
        A = (0, u.e7)([er.default], () => {
            let e = er.default.getCurrentUser();
            return s()(null != e, 'CenterControlTray: currentUser cannot be undefined'), e;
        }),
        { cameraUnavailable: R, enabled: k } = (0, eo.Z)(),
        M = (0, eu.Z)(l),
        { suppress: D, selfMute: W, mute: U } = (0, ed.Z)(l),
        { canGoLive: F } = (0, u.cj)([et.Z], () => ({ canGoLive: (0, w.Z)(et.Z) })),
        G = (0, T.Z)(),
        V = (0, u.e7)([Z.Z], () => null != Z.Z.getAwaitingRemoteSessionInfo()),
        z = null != G,
        q = (0, u.e7)([en.Z], () => {
            var e;
        ...
        K = (0, O.Z)(l, !0),
        $ = (0, u.e7)([_.ZP], () => _.ZP.getSelfEmbeddedActivityForChannel(l.id)),
        { reachedLimit: ee, limit: ep } = (0, es.Z)(l),
        { analyticsLocations: em } = (0, y.ZP)(v.Z.VOICE_CONTROL_TRAY),
        eb = (0, ea.Z)(l),
        e_ = (0, Q.Hu)({
