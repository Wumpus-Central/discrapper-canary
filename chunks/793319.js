...
function eZ(e) {
    let { channel: t, currentUser: n, exitFullScreen: l, canGoLive: o, hasPermission: a, disabled: s } = e,
        ...
        C = i.useCallback(() => {
            ...
            (0, eC.Z)(_, t.id, ev.ZY5.GUILD_CHANNEL);
        }, [_, t.id, o, l]),
        x = (0, B.B4)(),
        [j, O] = i.useState(!1),
        E = (0, U.bK)(),
...
let eA = i.memo(function (e) {
    let { currentUser: t, onDisconnectCall: n, channel: l, connectedEmbeddedActivity: o } = e,
        ...
        _ = (null == s ? void 0 : s.type) === ej.fO.STREAM && null != y && y.ownerId !== (null == t ? void 0 : t.id),
        C = (0, u.Wu)([et.Z], () =>
        ...
        x = (0, L.qY)(l.id),
        O = i.useCallback(() => ((null == s ? void 0 : s.type) === ej.fO.ACTIVITY && s.applicationId === (null == o ? void 0 : o.applicationId) ? 'ACTIVITY' : _ ? 'STREAM' : null != x ? 'EVENT' : 'CALL'), [s, null == o ? void 0 : o.applicationId, _, x]),
        [E, N] = i.useState(O()),
...
let ek = function (e) {
    ...
    let { channel: l, className: a, onDisconnectCall: c, exitFullScreen: d, idleProps: h } = e,
        ...
        K = (0, O.Z)(l, !0),
        Q = (0, u.e7)([_.ZP], () => _.ZP.getCurrentEmbeddedActivity()),
                              ...
                              (0, r.jsxs)('div', {
                                  ...
                                  children: [
                                      (0, r.jsx)(p.yRy, {
                                          ...
                                          ignoreModalClicks: e_,
                                          align: 'center',
                                          overridePositionRef: y,
                                          position: 'top',
                                          animation: p.yRy.Animation.FADE,
                                          spacing: 8,
                                          children: (e, t) => {
