    ...
    return (
        ...
        (0, l.jsxs)(d.D, {
            ...
            children: [
                ...
                o
                    ? (0, l.jsx)(h.A, { size: "md", color: "currentColor", className: a()($.AI, { [$.i0]: m }) })
                    : (0, l.jsx)(H.A, { className: $.UE, direction: H.A.Directions.RIGHT }),
            ],
        })
    );
}
function Z(e) {
    ...
    let s,
        ...
        ),
        {
            ...
            guildPopulated:
                ...
                (0, o.bG)([T.A], () => {
                    let e = T.A.getMemberCount(ei?.id) ?? 0,
        ...
        ep = !0 === (0, U.A)(ei?.id),
        {
            ...
            E.Ay.trackWithMetadata(L.HAw.SERVER_SETUP_CTA_CLICKED, {
        ...
        (X = i.useCallback(() => {
            E.Ay.trackWithMetadata(L.HAw.SERVER_SETUP_CTA_CLICKED, {
                ...
                null != ei && P.A.open(ei.id, (0, O.x)(), { section: L.JJy.CHANNEL_WELCOME_CTA });
        }, [ei])),
        (Q = i.useCallback(() => {
            E.Ay.trackWithMetadata(L.HAw.SERVER_SETUP_CTA_CLICKED, {
                setup_type: W.XT.CHANNEL_WELCOME,
                ...
                (0, l.jsx)(
                    r.A.div,
                    {
                        ...
                        children: (0, l.jsx)(J, {
                            ...
                            header: q.intl.string(q.t.j0Gbpz),
                            completed: eg,
                            onClick: eS,
                        }),
                    },
    ...
    let ev = ea ? q.intl.string(q.t["1ach9C"]) : q.intl.string(q.t["ezm+/j"]);
    es && (ev = q.intl.string(q.t["gwyU/J"]));
                    ...
                    (0, l.jsxs)(r.A.div, {
                        ...
                        children: [
                            (0, l.jsx)(p.D, {
                                ...
                                children: q.intl.format(q.t.rkHVKf, { guildName: ei.name }),
                            }),
                            (0, l.jsxs)(u.E, {
                                color: "text-default",
                                className: a()({ [$.VA]: !0, [$.lg]: 0 === eN.length }),
                                variant: "text-sm/normal",
                                children: [ev, " ", eN.length > 0 ? q.intl.format(q.t.UOtD32, { guideURL: eM }) : null],
                            }),
                        ],
                    }),
                    eN,
