...
class l {
    setProgress(e, t) {
        ...
        if (null != this.taskID && this.taskID !== e)
            return void s.warn("".concat(this.taskID, " is already running. cannot set ").concat(e));
    ...
    clearProgress(e) {
        ...
        return null == this.taskID
            ? void s.warn("cannot clear progress. No current progress running.")
            : this.taskID !== e
              ? void s.warn("cannot clear progress of ".concat(e, " when ").concat(this.taskID, " is running"))
              : void ((this.taskID = null), a.Z.window.setProgressBar(-1));
    }
    constructor() {
