        ...
        super(...e),
            ...
            eu(this, 'handleStartStream', () => {
                let { canGoLive: e, channel: t } = this.props,
                    n = t.getGuildId();
                if ((o()(null != n, 'Cannot go live in non guild channel'), (0, O.v)(g.Z.VIDEO_PIP, O.d.STREAM, !0), !e)) return (0, ei.Z)();
            ...
            eu(this, 'handleOpenPopout', () => {
                let { channel: e } = this.props;
                (0, O.v)(g.Z.VIDEO_PIP, O.d.POPOUT, !0), w.hP(e);
            }),
...
function eh(e) {
    let { channel: t, width: n } = e,
        ...
        v = (0, S.Z)(g),
        O = (0, c.Wu)([B.Z], () => B.Z.getAllActiveStreams());
    return (0, r.jsx)(ep, {
        channel: t,
        streamId: s,
