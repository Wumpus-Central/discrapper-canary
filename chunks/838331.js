...
function w(e) {
    let { placeholder: t, children: n, value: a, onChange: c, className: u, listClassName: g, 'aria-label': b, multiSelect: v = !1, autoFocus: S = !1, maxVisibleItems: A = 5, itemToString: w = N, showScrollbar: R = !1 } = e,
        [P, D] = i.useState(''),
        [L] = i.useState(!0),
        [x, k] = i.useState(null),
        j = i.useId(),
