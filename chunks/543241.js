...
let P = function (e, t) {
        ...
        let b = Y(n),
            { topEmojis: S, newlyAddedEmojis: C } = (0, I.Z)(n, e),
            { allEmojis: N } = (0, v.Z)({
                topEmojis: S,
                newlyAddedEmojis: C,
            }),
            ...
            x = (0, O.I5)(D),
            L = (0, _.g2)({ location: "useEmojiCategories" });
        return r.useMemo(() => {
                ...
                l.ZP.categories.reduce(
                    (t, r) => {
                        if (r === T.UX.TOP_GUILD_EMOJI) {
                            let { emojisDisabled: e, emojisUnfiltered: n } = f(N);
...
function q(e, t) {
    return e === A.Hz.REACTION
        ? t
            ? R.intl.string(R.t["h7ES+v"])
            : R.intl.string(R.t["6any2N"])
        : R.intl.string(R.t.KgK5qq);
}
