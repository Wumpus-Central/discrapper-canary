...
let k = function () {
    ...
    let { promotionsLoaded: b, activeOutboundPromotions: _, claimedEndedOutboundPromotions: j, claimedOutboundPromotionCodeMap: O, addClaimedOutboundPromotionCode: k } = (0, C.lG)(),
