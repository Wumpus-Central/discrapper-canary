...
function N(e) {
    let t,
        n,
        { closePopout: i, idle: a, pipWindows: u, voiceChannelId: c, onSelect: d } = e;
    a && i();
    let A = (0, s.bG)([p.Ay], () => p.Ay.getCurrentEmbeddedActivity()),
        ...
        : (0, r.jsx)(u.Y, {
              ...
              children: (e) =>
                  (0, r.jsx)(c.D, {
                      ...
                      ...e,
                      innerRef: o,
                      children: (0, r.jsx)(d.F, { size: "md", color: a.A.unsafe_rawColors.WHITE.css }),
                  }),
          });
};
