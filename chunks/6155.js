...
function C(e) {
    ...
    let A = (0, s.bG)([f.Ay], () => f.Ay.getCurrentEmbeddedActivity()),
        ...
        C = (0, s.bG)([E.A], () => E.A.getSelectedParticipant(c)),
        N = (0, s.bG)([E.A], () => E.A.getStreamParticipants(c));
    return (0, i.jsx)(l.W, {
...
let N = function (e) {
    ...
    return h || f
        ...
        : (0, i.jsx)(u.Y, {
              targetElementRef: o,
              position: "bottom",
              renderPopout: (e) => (0, i.jsx)(C, { voiceChannelId: t, pipWindows: l, idle: n, ...e }),
              children: (e) =>
                  (0, i.jsx)(c.D, {
                      className: y.ro,
                      ...e,
