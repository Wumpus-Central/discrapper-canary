...
function P(e) {
    ...
    return t.isImage && t.item.platform === C.xz.WEB
        ? (0, l.jsx)(M, { file: t.item.file, alt: t.description, spoiler: t.spoiler, size: n, onMouseEnter: s })
...
function D(e) {
    let {
        ...
        M = (0, r.bG)([S.A], () => S.A.getChannel(t)?.guild_id),
        O = (e) => {
            e.stopPropagation(),
                (0, u.openModal)((e) =>
                    (0, l.jsx)(x.default, {
    ...
    return (0, l.jsxs)(T.A, {
        ...
        children: [
            (0, l.jsx)(P, { upload: s, size: E, clip: L ? b : void 0, guildId: M }),
            !y &&
                (!N || L) &&
                (0, l.jsx)("div", {
