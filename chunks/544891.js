...
function E(e, t, n, r, a) {
    ...
    let y = () => {
        (t.backoff = null != t.backoff ? t.backoff : new o.Z()),
            (t.retried = (null != t.retried ? t.retried : 0) + 1),
            t.backoff.fail(() => L(t.url).then(() => E(e, t, n, r, a)));
    };
    null == w || null == (d = w.prepareRequest) || d.call(w, b),
        ...
        b.then(
            (i) => {
                ...
                if (
                    (null == t || null == (o = t.interceptResponse) ? void 0 : o.call(t, i, h, b)) !== !0 &&
                    (null == w || null == (c = w.interceptResponse) ? void 0 : c.call(w, i, h, b)) !== !0
                ) {
                    if (i.ok) n(d);
                    else {
        ...
        (null == (_ = t.signal) ? void 0 : _.aborted)
            ? b.abort()
...
function I(e, t, n) {
    return new Promise((r, i) => {
        ...
        null != o
            ? (h.verbose("makeRequest: queueing request for ", t.url), o.queue.push(E.bind(null, e, t, r, i, n)))
            : E(e, t, r, i, n);
    });
}
