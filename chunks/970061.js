...
var r = n(735438),
    ...
    C = n(837921),
    O = n(652215);
let R = v.isPlatformEmbedded && (0, v.isWindows)(),
    b = R && 10 > parseFloat(o.A.os.release),
    D = !0;
if (R && !b) {
...
function k(e, t) {
    return (0, E.A)(t ?? h.A.getSoundpack())[e] ?? e;
}
async function U(e) {
    ...
    if (await x())
        try {
            await C.Ay.invoke("NOTIFICATIONS_SEND_NOTIFICATION", { sound: k(e, n) });
            return;
        } catch (e) {
...
let G = i().throttle(U, 1e3, { leading: !0 });
function F() {
    C.Ay.flashFrame(!1);
}
R && (window.addEventListener("focus", F), C.Ay.on("MAIN_WINDOW_FOCUS", F));
...
if (o.A?.features.supports("notifications")) {
    try {
        C.Ay.on("NOTIFICATIONS_RECEIVED_RESPONSE", (e, t, n, r, i) => {
            ...
            {
                let e = B[n];
                if ((v.isPlatformEmbedded ? C.Ay.focus() : window.focus(), null != e)) {
                    e.options?.omitClickTracking ||
                        (S.default.track(O.HAw.NOTIFICATION_ACTION, { action: "CLICK", ...e.trackingProps }),
                        S.default.track(O.HAw.NOTIFICATION_CLICKED, e.clickTrackingProps)),
                        e.options?.onClick?.(r);
                    return;
                }
                if (null != i) {
...
async function W(e, t, n, r, i) {
    let s,
        ...
        u = null != a ? o : await H(),
        c = I.A.disableNotifications && null == i.overrideStreamerMode,
        p = !v.isPlatformEmbedded || ((0, v.isMac)() && o) || C.Ay.shouldDisplayNotifications(),
        h = { ...r, action: void 0, ping: void 0, banner: void 0, badge: void 0 };
    if (((r.banner = await (0, _.N)()), !(!c && u && p))) {
        null != i.sound &&
            !1 !== i.playSoundIfDisabled &&
            (Y(i.sound, i.volume ?? 1, i.soundpack),
            (r.ping = !0),
            i.omitViewTracking || S.default.track(O.HAw.NOTIFICATION_ACTION, { action: "VIEW", ...r }));
        return;
    }
    ...
    let E = i?.tag ?? null,
        ...
        P = (e, t) => {
            i.onShown?.(),
                i.omitViewTracking ||
                    (S.default.track(O.HAw.NOTIFICATION_ACTION, { action: "VIEW", ...t }),
                    S.default.track(O.HAw.NOTIFICATION_VIEWED, h)),
                w && setTimeout(() => e.close(), 5e3);
        };
    if (
        (null == i.sound || b || (Y(i.sound, i.volume ?? 1, i.soundpack), (r.ping = !0)),
        i.isUserAvatar && null != e && (e = await (0, f.w)(e)),
        R && g.A.taskbarFlash && C.Ay.flashFrame(!0),
        o)
    ) {
        ...
        if (
            ...
            null != i.messageRecord && (0, v.isMac)())
        ) {
    ...
    null != i.sound && o && (Y(i.sound, i.volume ?? 1, i.soundpack), (r.ping = !0));
    let x = { icon: e, body: n, tag: E, silent: !0 };
    try {
        s = new V(t, x);
    } catch (e) {
        return;
    ...
    return (P(s, r),
    (s.onclick = (e) => {
        v.isPlatformEmbedded ? C.Ay.focus() : (window.focus(), s.close()),
            i.omitClickTracking ||
                (S.default.track(O.HAw.NOTIFICATION_ACTION, { action: "CLICK", ...r }),
                S.default.track(O.HAw.NOTIFICATION_CLICKED, h)),
            i.onClick?.("");
    }),
    D)
