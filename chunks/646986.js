...
var i = n(627968),
    ...
    h = n(375708);
function f(e) {
    let { user: t, currentUser: n, guildId: f, onOpenUserProfileModal: E, onClose: p } = e,
    ...
    return I
        ...
        : (0, i.jsx)(l.A, {
              ...
              onExpand: () => {
                  g({ action: "PRESS_SHOW_MORE_ACTIVITY", analyticsLocations: m }), E?.({ tabSection: _.RP.ACTIVITY });
              },
          });
}
