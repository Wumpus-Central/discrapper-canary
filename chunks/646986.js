...
function I(e) {
    let { user: t, currentUser: n, guildId: I, onOpenUserProfileModal: T, onClose: S } = e,
        ...
        L = !(0, s.bG)([c.A], () => c.A.getUserProfile(t.id)?.private === !0) && null == C && null == O && null != R,
        w = r.useCallback(
            (e) => {
                let r = [],
                    s = { ...e, user: t, currentUser: n, onClose: S };
                return (
                    null != C && r.push((0, i.jsx)(p.A, { stream: C, ...s }, "stream")),
                    v.forEach((e, t) => {
    ...
    return D
        ...
        : (0, i.jsx)(h.A, {
              ...
              onExpand: () => {
                  N({ action: "PRESS_SHOW_MORE_ACTIVITY", analyticsLocations: y }), T?.({ tabSection: m.RP.ACTIVITY });
              },
          });
}
