...
function C(e) {
    var t,
        ...
        a = e[0];
    if (r > 0) {
        for (s += a, t = 1; t < r; t++) (n = 7 - (i = e[t] + "").length) && (s += U(n)), (s += i);
        (n = 7 - (i = (a = e[t]) + "").length) && (s += U(n));
...
(v.absoluteValue = v.abs =
        ...
        function () {
            ...
            for (
                ...
                if (
                    ...
                    C(o.d).slice(0, a) === (n = C(i.d)).slice(0, a))
                ) {
    ...
    (v.inverseHyperbolicCosine = v.acosh =
        function () {
            var e,
                t,
                n = this,
    ...
    (v.inverseHyperbolicSine = v.asinh =
        function () {
            var e,
                t,
                n = this,
    ...
    (v.inverseHyperbolicTangent = v.atanh =
        function () {
            var e,
                t,
                n,
    ...
    (v.inverseTangent = v.atan =
        function () {
            ...
            if (u.isFinite()) {
                ...
                else if (u.abs().eq(1) && _ + 4 <= N) return ((a = x(c, _ + 4, h).times(0.25)).s = u.s), a;
            } else {
                if (!u.s) return new c(NaN);
                if (_ + 4 <= N) return ((a = x(c, _ + 4, h).times(0.5)).s = u.s), a;
            }
            ...
            return n && (a = a.times(2 << (n - 1))), (d = !0), L(a, (c.precision = _), (c.rounding = h), !0);
        }),
    (v.isFinite = function () {
        return !!this.d;
    }),
    ...
    (v.logarithm = v.log =
        function (e) {
            ...
            if (((d = !1), O((o = D((s = H(this, (a = u + 5))), t ? P(l, a + 10) : H(e, a), a, 1)).d, (i = u), c)))
                do
                    if (((a += 10), (o = D((s = H(this, a)), t ? P(l, a + 10) : H(e, a), a, 1)), !r)) {
                        +C(o.d).slice(i + 1, i + 15) + 1 == 1e14 && (o = L(o, u + 1, 0));
                        break;
                    }
                while (O(o.d, (i += 10), c));
            return (d = !0), L(o, u, c);
    ...
    (v.minus = v.sub =
        function (e) {
            ...
            if (((u = this.d), (h = e.d), (o = f.precision), (l = f.rounding), !u[0] || !h[0])) {
                if (h[0]) e.s = -e.s;
                else {
                    if (!u[0]) return new f(3 === l ? -0 : 0);
                    e = new f(this);
                }
                return d ? L(e, o, l) : e;
            }
            if (((n = m(e.e / 7)), (c = m(this.e / 7)), (u = u.slice()), (s = c - n))) {
                for (
                    (_ = s < 0) ? ((t = u), (s = -s), (a = h.length)) : ((t = h), (n = c), (a = u.length)),
                ...
                for ((_ = (i = u.length) < (a = h.length)) && (a = i), i = 0; i < a; i++)
                    if (u[i] != h[i]) {
                        _ = u[i] < h[i];
                        break;
                    }
            ...
            for (_ && ((t = u), (u = h), (h = t), (e.s = -e.s)), a = u.length, i = h.length - a; i > 0; --i) u[a++] = 0;
            for (i = h.length; i > s; ) {
                if (u[--i] < h[i]) {
            ...
            for (; 0 === u[--a]; ) u.pop();
            for (; 0 === u[0]; u.shift()) --n;
            return u[0] ? ((e.d = u), (e.e = M(u, n)), d ? L(e, o, l) : e) : new f(3 === l ? -0 : 0);
        }),
    (v.modulo = v.mod =
        function (e) {
            var t,
        ...
        function () {
            ...
            for (
                ...
                if (
                    ...
                    C(s.d).slice(0, n) === (t = C(i.d)).slice(0, n))
                ) {
    ...
    (v.times = v.mul =
        function (e) {
            var t,
                ...
                _ = this.d,
                h = (e = new c(e)).d;
            if (((e.s *= this.s), !_ || !_[0] || !h || !h[0]))
                return new c(!e.s || (_ && !_[0] && !h) || (h && !h[0] && !_) ? NaN : !_ || !h ? e.s / 0 : 0 * e.s);
            for (
                n = m(this.e / 7) + m(e.e / 7),
                    (l = _.length) < (u = h.length) && ((s = _), (_ = h), (h = s), (a = l), (l = u), (u = a)),
                    s = [],
                    i = a = l + u;
                i--;
            )
            ...
            for (i = u; --i >= 0; ) {
                for (t = 0, r = l + i; r > i; )
                    (o = s[r] + h[i] * _[r - i - 1] + t), (s[r--] = (o % 1e7) | 0), (t = (o / 1e7) | 0);
                s[r] = ((s[r] + t) % 1e7) | 0;
            }
            for (; !s[--a]; ) s.pop();
    ...
    (v.toDecimalPlaces = v.toDP =
        function (e, t) {
            ...
            return ((n = new i(n)), void 0 === e)
                ? n
                : (R(e, 0, 1e9), void 0 === t ? (t = i.rounding) : R(t, 0, 8), L(n, e + n.e + 1, t));
        }),
    ...
    (v.toFraction = function (e) {
        ...
        if (
            ((u = n = new E(1)),
            (i = l = new E(0)),
            (a = (s = (t = new E(i)).e = k(p) - this.e - 1) % 7),
            (t.d[0] = g(10, a < 0 ? 7 + a : a)),
            null == e)
        )
            e = s > 0 ? t : u;
        else {
            if (!(o = new E(e)).isInt() || o.lt(u)) throw Error(h + o);
            e = o.gt(t) ? (s > 0 ? t : u) : o;
        }
        for (
            d = !1, o = new E(C(p)), c = E.precision, E.precision = s = 7 * p.length * 2;
    ...
    (v.toNearest = function (e, t) {
        ...
        if (((n = new i(n)), null == e)) {
            ...
            if (((e = new i(e)), void 0 === t ? (t = i.rounding) : R(t, 0, 8), !n.d)) return e.s ? n : e;
        ...
        function (e) {
            ...
            return (t =
                0 != (n = g(+o, u)) && isFinite(n)
                    ? new l(n + "").e
                    : m(u * (Math.log("0." + C(o.d)) / Math.LN10 + o.e + 1))) >
                l.maxE + 1 || t < l.minE - 1
                ? new l(t > 0 ? a / 0 : 0)
                : ((d = !1),
                  (l.rounding = o.s = 1),
                  ...
                  (r = B(e.times(H(o, i + n)), i)).d &&
                      O((r = L(r, i + 5, 1)).d, i, s) &&
                      ((t = i + 10),
                      +C((r = L(B(e.times(H(o, t + n)), t), t + 5, 1)).d).slice(i + 1, i + 15) + 1 == 1e14 &&
                          (r = L(r, i + 1, 0))),
                  (r.s = a),
                  (d = !0),
                  (l.rounding = s),
        ...
        function (e, t) {
            ...
            return (
                void 0 === e
                    ...
                    : (R(e, 1, 1e9), void 0 === t ? (t = n.rounding) : R(t, 0, 8)),
                L(new n(this), e, t)
            );
        }),
    (v.toString = function () {
...
var D = (function () {
    ...
    return function (i, r, a, o, l, u) {
        ...
        for (
            u ? ((f = 1), (d = i.e - r.e)) : ((u = 1e7), (f = 7), (d = m(i.e / f) - m(r.e / f))),
                b = x.length,
                R = P.length,
                I = (A = new w(M)).d = [],
                _ = 0;
        ...
        if (
            (x[_] > (P[_] || 0) && d--,
            null == a ? ((N = a = w.precision), (o = w.rounding)) : (N = l ? a + (i.e - r.e) + 1 : a),
            N < 0)
        )
            I.push(1), (p = !0);
        else {
            if (((N = (N / f + 2) | 0), (_ = 0), 1 == b)) {
                for (h = 0, x = x[0], N++; (_ < R || h) && N--; _++)
                    (v = h * u + (P[_] || 0)), (I[_] = (v / x) | 0), (h = (v % x) | 0);
                p = h || _ < R;
            } else {
                for (
                    (h = (u / (x[0] + 1)) | 0) > 1 &&
                        ((x = e(x, h, u)), (P = e(P, h, u)), (b = x.length), (R = P.length)),
                        C = b,
                        S = (T = P.slice(0, b)).length;
                    S < b;
                )
                    T[S++] = 0;
                (D = x.slice()).unshift(0), (O = x[0]), x[1] >= u / 2 && ++O;
                do
                    (h = 0),
                        (c = t(x, T, b, S)) < 0
                            ? ((y = T[0]),
                              ...
                              (h = (y / O) | 0) > 1
                                  ? (h >= u && (h = u - 1),
                                    (g = (E = e(x, h, u)).length),
                                    (S = T.length),
                                    1 == (c = t(E, T, g, S)) && (h--, n(E, b < g ? D : x, g, u)))
                                  : (0 == h && (c = h = 1), (E = x.slice())),
                              (g = E.length) < S && E.unshift(0),
                              n(T, E, S, u),
                              -1 == c && ((S = T.length), (c = t(x, T, b, S)) < 1 && (h++, n(T, b < S ? D : x, S, u))),
                              (S = T.length))
                            : 0 === c && (h++, (T = [0])),
                        (I[_++] = h),
                        c && T[0] ? (T[S++] = P[C] || 0) : ((T = [P[C]]), (S = 1));
                while ((C++ < R || void 0 !== T[0]) && N--);
                p = void 0 !== T[0];
            }
            I[0] || I.shift();
        }
        if (1 == f) (A.e = d), (s = p);
            ...
            for (_ = 1, h = I[0]; h >= 10; h /= 10) _++;
            (A.e = _ + d * f - 1), L(A, l ? a + A.e + 1 : a, o, p);
        }
        return A;
    };
})();
function L(e, t, n, i) {
    ...
    u: if (null != t) {
        ...
        if ((s = t - r) < 0) (s += 7), (a = t), (l = (((c = _[(h = 0)]) / g(10, r - a - 1)) % 10) | 0);
        else if ((h = Math.ceil((s + 1) / 7)) >= (o = _.length))
            if (i) {
                for (; o++ <= h; ) _.push(0);
                (c = l = 0), (r = 1), (s %= 7), (a = s - 7 + 1);
            } else break u;
        else {
            for (r = 1, c = o = _[h]; o >= 10; o /= 10) r++;
            (s %= 7), (l = (a = s - 7 + r) < 0 ? 0 : ((c / g(10, r - a - 1)) % 10) | 0);
        }
        if (
            ((i = i || t < 0 || void 0 !== _[h + 1] || (a < 0 ? c : c % g(10, r - a - 1))),
            (u =
                n < 4
                    ? (l || i) && (0 == n || n == (e.s < 0 ? 3 : 2))
                    : l > 5 ||
                      (5 == l &&
                          (4 == n ||
                              i ||
                              (6 == n && ((s > 0 ? (a > 0 ? c / g(10, r - a) : 0) : _[h - 1]) % 10) & 1) ||
                              n == (e.s < 0 ? 8 : 7)))),
            t < 1 || !_[0])
        )
            return (
        ...
        if (
            (0 == s
                ...
                : ((_.length = h + 1),
                  (o = g(10, 7 - s)),
                  (_[h] = a > 0 ? (((c / g(10, r - a)) % g(10, a)) | 0) * o : 0)),
            u)
        )
            for (;;)
                if (0 == h) {
                    ...
                    if (((_[h] += o), 1e7 != _[h])) break;
                    (_[h--] = 0), (o = 1);
                }
        for (s = _.length; 0 === _[--s]; ) _.pop();
    }
    return d && (e.e > f.maxE ? ((e.d = null), (e.e = NaN)) : e.e < f.minE && ((e.e = 0), (e.d = [0]))), e;
}
function w(e, t, n) {
    ...
    return (
        t
            ? (n && (i = n - a) > 0
                  ? (s = s.charAt(0) + "." + s.slice(1) + U(i))
                  : a > 1 && (s = s.charAt(0) + "." + s.slice(1)),
              (s = s + (e.e < 0 ? "e" : "e+") + e.e))
            : r < 0
              ? ((s = "0." + U(-r - 1) + s), n && (i = n - a) > 0 && (s += U(i)))
              : r >= a
                ? ((s += U(r + 1 - a)), n && (i = n - r - 1) > 0 && (s = s + "." + U(i)))
                : ((i = r + 1) < a && (s = s.slice(0, i) + "." + s.slice(i)),
                  n && (i = n - a) > 0 && (r + 1 === a && (s += "."), (s += U(i)))),
        s
    );
}
function M(e, t) {
...
function P(e, t, n) {
    if (t > y) throw ((d = !0), n && (e.precision = n), Error(f));
    return L(new e(l), t, 1, !0);
}
function x(e, t, n) {
    if (t > N) throw Error(f);
...
function B(e, t) {
    ...
    for (null == t ? ((d = !1), (l = p)) : (l = t), o = new h(0.03125); e.e > -2; ) (e = e.times(o)), (_ += 5);
    for (l += i = ((Math.log(g(2, _)) / Math.LN10) * 2 + 5) | 0, n = s = a = new h(1), h.precision = l; ; ) {
        if (
            ((s = L(s.times(e), l, 1)),
            (n = n.times(++c)),
            C((o = a.plus(D(s, n, l, 1))).d).slice(0, l) === C(a.d).slice(0, l))
        ) {
            for (r = _; r--; ) a = L(a.times(a), l, 1);
            if (null != t) return (h.precision = p), a;
            if (!(u < 3 && O(a.d, l - i, f, u))) return L(a, (h.precision = p), f, (d = !0));
...
function H(e, t) {
    ...
    for (; (i < 7 && 1 != i) || (1 == i && n.charAt(1) > 3); ) (i = (n = C((p = p.times(e)).d)).charAt(0)), f++;
    for (
        s = p.e,
        ...
        if (((a = L(a.times(h), c, 1)), C((u = l.plus(D(a, new m(r), c, 1))).d).slice(0, c) === C(l.d).slice(0, c))) {
            if (
                ((l = l.times(2)),
            ...
            if (!O(l.d, c - 10, g, o)) return L(l, (m.precision = A), g, (d = !0));
            (m.precision = c += 10),
...
function z(e, t, n, i) {
    var r,
        ...
        E = void 0 !== n;
    if (
        (E ? (R(n, 1, 1e9), void 0 === i ? (i = p.rounding) : R(i, 0, 8)) : ((n = p.precision), (i = p.rounding)),
        e.isFinite())
    ) {
        for (
            l = (_ = w(e)).indexOf("."),
                ...
                l >= 0 &&
                    ((_ = _.replace(".", "")),
                    ((f = new p(1)).e = _.length - l),
                    (f.d = b(w(f), 10, r)),
                    (f.e = f.d.length)),
                a = c = (h = b(_, 10, r)).length;
            0 == h[--c];
        )
            h.pop();
        if (h[0]) {
            if (
                (l < 0
                    ? a--
                    : (((e = new p(e)).d = h), (e.e = a), (h = (e = D(e, f, n, i, 0, r)).d), (a = e.e), (d = s)),
                (l = h[n]),
                (u = r / 2),
                (d = d || void 0 !== h[n + 1]),
                (d =
                    i < 4
                        ...
                        : l > u || (l === u && (4 === i || d || (6 === i && 1 & h[n - 1]) || i === (e.s < 0 ? 8 : 7)))),
                (h.length = n),
                d)
            )
                for (; ++h[--n] > r - 1; ) (h[n] = 0), n || (++a, h.unshift(1));
            for (c = h.length; !h[c - 1]; --c);
            for (l = 0, _ = ""; l < c; l++) _ += o.charAt(h[l]);
            if (E) {
                if (c > 1)
                    if (16 == t || 8 == t) {
                        for (l = 16 == t ? 4 : 3, --c; c % l; c++) _ += "0";
                        for (c = (h = b(_, r, t)).length; !h[c - 1]; --c);
                        for (l = 1, _ = "1."; l < c; l++) _ += o.charAt(h[l]);
...
function ep(e) {
    return e instanceof ek || (e && e.toStringTag === E) || !1;
}
function eE(e) {
...
function ev(e) {
    var t,
        ...
        a = new this(1),
        o = [];
    if ((void 0 === e ? (e = this.precision) : R(e, 1, 1e9), (i = Math.ceil(e / 7)), this.crypto))
...
var ek = (v.constructor = (function e(t) {
    var n, i, r;
    function s(e) {
        var t, n, i;
...
(l = new ek(l)), (u = new ek(u)), new ek(10);
let eU = new ek(0);
function eG(e, t) {
...
let e$ = eG((...e) => new Intl.ListFormat(...e), { strategy: eY.variadic });
function ez(e) {
...
function tr(e) {
    let t = (function e(t) {
        if ("number" == typeof t) return new ek(t);
        if ("bigint" == typeof t) return new ek(t.toString());
        if ((eW("symbol" != typeof t, "Symbol is not supported", TypeError), void 0 === t)) return new ek(NaN);
        if (null === t || 0 === t) return eU;
        if (!0 === t) return new ek(1);
        if ("string" == typeof t)
            try {
                return new ek(t);
            } catch {
...
class tc {
    constructor(e, t) {
        ...
        const n = r(e),
            ...
            s = void 0 === t ? Object.create(null) : ez(t),
            a = eX(s, "localeMatcher", "string", ["best fit", "lookup"], "best fit"),
            o = eX(s, "numberingSystem", "string", void 0, void 0);
        ...
        const h = eX(s, "style", "string", ["long", "short", "narrow", "digital"], "short");
    ...
    static supportedLocalesOf(e, t) {
        return (function (e, t, n) {
            void 0 !== n && eX((n = ez(n)), "localeMatcher", "string", ["lookup", "best fit"], "best fit");
            var i = Array.from(e);
            let r = [];
            for (let e of t) {
