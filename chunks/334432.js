...
(N.absoluteValue = N.abs =
    ...
    (N.inverseTangent = N.atan =
        function () {
            ...
            if (u.isFinite()) {
                ...
                else if (u.abs().eq(1) && _ + 4 <= C) return ((a = x(c, _ + 4, h).times(0.25)).s = u.s), a;
            } else {
                if (!u.s) return new c(NaN);
                if (_ + 4 <= C) return ((a = x(c, _ + 4, h).times(0.5)).s = u.s), a;
            }
    ...
    (N.logarithm = N.log =
        function (e) {
            ...
            if (((d = !1), O((o = D((s = j(this, (a = u + 5))), t ? P(l, a + 10) : j(e, a), a, 1)).d, (i = u), c)))
                do
                    if (((a += 10), (o = D((s = j(this, a)), t ? P(l, a + 10) : j(e, a), a, 1)), !r)) {
        ...
        function (e) {
            ...
            return (t =
                ...
                : ((d = !1),
                  ...
                  (r = B(e.times(j(o, i + n)), i)).d &&
                      O((r = L(r, i + 5, 1)).d, i, s) &&
                      ((t = i + 10),
                      +v((r = L(B(e.times(j(o, t + n)), t), t + 5, 1)).d).slice(i + 1, i + 15) + 1 == 1e14 &&
                          (r = L(r, i + 1, 0))),
                  (r.s = a),
                  (d = !0),
                  (l.rounding = s),
...
var D = (function () {
    ...
    return function (i, r, a, o, l, u) {
        ...
        if (
            (x[_] > (P[_] || 0) && d--,
            null == a ? ((C = a = w.precision), (o = w.rounding)) : (C = l ? a + (i.e - r.e) + 1 : a),
            C < 0)
        )
            I.push(1), (p = !0);
        else {
            if (((C = (C / f + 2) | 0), (_ = 0), 1 == b)) {
                for (h = 0, x = x[0], C++; (_ < R || h) && C--; _++)
                    (N = h * u + (P[_] || 0)), (I[_] = (N / x) | 0), (h = (N % x) | 0);
                p = h || _ < R;
            } else {
                for (
                    (h = (u / (x[0] + 1)) | 0) > 1 &&
...
function j(e, t) {
    ...
    if (
        ...
        return (
            (u = P(m, c + 2, A).times(s + "")),
            (p = j(new m(i + "." + n.slice(1)), c - 10).plus(u)),
            (m.precision = A),
            null == t ? L(p, A, g, (d = !0)) : p
        );
    for (; (i < 7 && 1 != i) || (1 == i && n.charAt(1) > 3); ) (i = (n = v((p = p.times(e)).d)).charAt(0)), f++;
    for (
        s = p.e,
        ...
        if (((a = L(a.times(h), c, 1)), v((u = l.plus(D(a, new m(r), c, 1))).d).slice(0, c) === v(l.d).slice(0, c))) {
            if (
                ((l = l.times(2)),
...
var ek = (N.constructor = (function e(t) {
    var n, i, r;
    function s(e) {
        var t, n, i;
...
class tc {
    constructor(e, t) {
        ...
        const h = eZ(s, "style", "string", ["long", "short", "narrow", "digital"], "short");
    ...
    static supportedLocalesOf(e, t) {
        return (function (e, t, n) {
            void 0 !== n && eZ((n = ez(n)), "localeMatcher", "string", ["lookup", "best fit"], "best fit");
            var i = Array.from(e);
            let r = [];
            for (let e of t) {
