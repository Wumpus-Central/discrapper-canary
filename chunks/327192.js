...
function z(e) {
    ...
    let n,
        s,
        l,
        { onDisconnect: a, account: o, theme: g, locale: p } = e,
    ...
    r.useEffect(() => {
        ...
        r.useEffect(() => {
            ...
            null != e && (S(e), m.Z.setVisibility(o.type, o.id, e), R(null)), null != t && (N(t), m.Z.setMetadataVisibility(o.type, o.id, t), G(null));
        }, [o]);
    function $() {
            ...
            (null == (t = _.Z.get(o.type)) ? void 0 : t.hasMetadata) === !0 &&
                (l = (0, i.jsx)(u.j7V, {
                    ...
                    onChange: function (e) {
                        ...
                        N(n), m.Z.setMetadataVisibility(o.type, o.id, n);
                    },
