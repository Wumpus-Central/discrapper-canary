var i = r(995769),
    ...
    f = function (e, n) {
        ...
        for (g = 0; g < h.length; ++g) {
            if (g !== _) {
                ...
                var T = a.call(r, E);
                T && 'combine' === n.duplicates ? (r[E] = i.combine(r[E], v)) : (!T || 'last' === n.duplicates) && (r[E] = v);
            }
        }
        return r;
    },
    p = function (e, n, r, i) {
        for (var a = i ? n : u(n, r), o = e.length - 1; o >= 0; --o) {
            var s,
                l = e[o];
            if ('[]' === l && r.parseArrays) s = r.allowEmptyArrays && '' === a ? [] : [].concat(a);
            else {
                s = r.plainObjects ? Object.create(null) : {};
                var c = '[' === l.charAt(0) && ']' === l.charAt(l.length - 1) ? l.slice(1, -1) : l,
                    d = r.decodeDotInKeys ? c.replace(/%2E/g, '.') : c,
                    f = parseInt(d, 10);
                r.parseArrays || '' !== d ? (!isNaN(f) && l !== d && String(f) === d && f >= 0 && r.parseArrays && f <= r.arrayLimit ? ((s = [])[f] = a) : '__proto__' !== d && (s[d] = a)) : (s = { 0: a });
            }
            a = s;
        }
        return a;
