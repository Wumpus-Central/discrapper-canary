...
class o {
    ...
    handleDownloadedModule(e) {
        ...
        t.foreground
            ? ((this._report.foreground_download_ms_total += o), (this._report.foreground_bytes_total += s))
            : ((this._report.background_download_ms_total += o), (this._report.background_bytes_total += s)),
        ...
        t.foreground
            ...
            e.succeeded
                ? (!0 === e.delta ? this._report.num_delta_installed++ : this._report.num_full_installed++,
                  this.setReportFieldMaximum(o, t.newVersion))
