...
var i = n(481060),
    ...
    l = n(981631);
function s(e) {
    let { initialPlanId: t, activeSubscription: s, trialId: c, trialFooterMessageOverride: d, onClose: u, analyticsObject: _, analyticsLocation: m, analyticsLocations: f, analyticsSubscriptionType: p, renderHeader: g, renderPurchaseConfirmation: v, planGroup: h, reviewWarningMessage: b, skuId: y } = e;
    (0, i.ZDy)(
        async () => {
            let { PaymentContextProvider: e } = await Promise.resolve().then(n.bind(n, 563132)),
                ...
                { STEPS: l } = await Promise.all([n.e('17938'), n.e('54433'), n.e('11629')]).then(n.bind(n, 7305));
            return (n) => {
                var x,
                    j,
                    { onClose: C } = n,
