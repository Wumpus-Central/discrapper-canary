...
let a = (0, r.C)({
    ...
    treatments: [
        { id: 1, label: "Control - Use File.size directly", config: { useDetectedFileSize: !1 } },
        { id: 2, label: "Treatment - Use detected file size with fallback", config: { useDetectedFileSize: !0 } },
    ],
});
function s(e) {
    let { location: t } = e,
