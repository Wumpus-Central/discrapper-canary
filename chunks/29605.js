...
let z = d().throttle(f.OQ, 1000),
    ...
    q = (e) => {
        ...
        return null == u || d === M.Eu4.TIER_3 || c > 0
            ? null
            : (c > o
                  ? ((t = U.intl.formatToPlainString(U.t.j0UH0t, { level: u })),
                    (n = U.intl.formatToPlainString(U.t.VQeyKy, { level: u })),
                    (i = M.qAy.BOOST_UPSELL_BANNER_LOST_LEVEL))
                  : ((t = U.intl.string(U.t.zT9Sxc)),
                    (n = U.intl.formatToPlainString(U.t.dBZ1RU, { level: u })),
                    (i = M.qAy.BOOST_UPSELL_BANNER_SLOTS_FULL)),
              (0, r.jsx)(N.Z, {
                  header: t,
                  text: n,
                  guild: s,
                        ...
                        (0, r.jsxs)(p.hjN, {
                            ...
                            children: [
                                ...
                                et &&
                                    (0, r.jsx)(p.R94, {
                                        type: p.geA.DESCRIPTION,
                                        children: U.intl.format(U.t.uMkfTk, {
                                            onClick: () =>
                                                A.Z.open(
                                                    e.id,
                                                    M.pNK.ROLE_SUBSCRIPTIONS,
                                                    void 0,
                                                    M.KsC.ROLE_SUBSCRIPTION_EMOJI,
                                                ),
                                        }),
                                    }),
                                Y
