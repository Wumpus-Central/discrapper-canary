...
class E {
    ...
    _dispatchWithLogging(e) {
        a()(null == this._currentDispatchActionType, 'Dispatch.dispatch(...): Cannot dispatch in the middle of a dispatch. Action: '.concat(e.type, ' Already dispatching: ').concat(this._currentDispatchActionType)), a()(e.type, 'Dispatch.dispatch(...) called without an action type'), f.has(e.type) && p.log('Dispatching '.concat(e.type)), (0, l.B1)(e.type), u.IH(e.type);
