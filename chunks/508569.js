...
class y {
    ...
    dispatchMultiple(e, t) {
        ...
        try {
            ...
            if (
                    ...
                    for (let r = 0; r < e.length; r++) {
                        ...
                        if ((this.dispatchOne(a), (l = performance.now() - o), E(a.type, l), b(e, r, t))) {
                            (s = e.slice(r + 1)),
                                null != t &&
                                    0 >= t.timeRemaining() &&
                                    this.scheduler.telemetry.timeTrack(c.JV.TIME_OVER_DEADLINE, t.timeSinceExpiration);
                            break;
                        }
                    }
                    a.Z.flush();
                ...
                return (
                    this.scheduler.telemetry.measure(c.aA.COUNT_DISPATCHES_LEFT_AFTER_YIELD, s.length),
    ...
    dispatchOne(e) {
        ...
        if ((a.Z.flush(s, i), "READY" === s)) {
            ...
            "RESUMED" === s
                ? (null == (n = this.getDispatchHandler(s)) || n.dispatch(i, s, u),
                  (0, l.uB)(this.resumeAnalytics),
