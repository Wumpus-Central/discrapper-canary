...
let _ = function (e) {
    ...
    let { sourceURL: O } = e,
        ...
        [R, L] = a.useState((k = !(null === (n = P.current) || void 0 === n ? void 0 : null === (t = n.videoElement) || void 0 === t ? void 0 : t.paused))),
        T = a.useRef(null),
        [F, D] = a.useState(null),
        [I, A] = a.useState(),
        Z = a.useRef(null),
    ...
    let J = a.useRef(null),
        ...
        q = a.useCallback(
            (e) => {
                ...
                E(y(j({}, S), { start: n })), null === (t = P.current) || void 0 === t || t.seek(n);
            },
            [S, E, P]
        ),
        ee = a.useCallback(
            (e) => {
                ...
                E(y(j({}, S), { end: a })), null === (n = P.current) || void 0 === n || n.seek(a);
            },
            [S, E, P]
        ),
        et = a.useCallback(
