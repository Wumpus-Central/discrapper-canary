n.d(t, { AV: () => P, Ay: () => D, P4: () => U, kD: () => w, sM: () => k });
var i = n(627968),
    l = n(64700),
    s = n(503698),
    a = n.n(s),
...
let M = l.memo(function (e) {
        let t,
            ...
            D = (0, o.bG)([T.Ay], () => T.Ay.isChannelMuted(s.getGuildId(), s.id)),
            U = (0, o.bG)([N.A], () => N.A.isCollapsed(s.id)),
            P = (0, o.bG)([v.A], () => v.A.can(R.xBc.MANAGE_CHANNELS, s)),
            w = (0, C.Ay)(s);
        ...
        let k = l.useCallback(() => {
            ...
            B = l.useCallback(() => {
                let e = s.type === R.rbe.GUILD_CATEGORY ? null : s.type,
                    t = s.getGuildId();
                null != t &&
                ...
                children: [
                    (0, i.jsx)(A.vN, {
                        ...
                        children: (0, i.jsxs)("div", {
                            ref: K,
                            className: a()(O.Ki, O.iE, { [O.yZ]: U, [O.SU]: D, [O.vk]: !0 }),
                            onContextMenu: V,
                            children: [
                                (0, i.jsxs)(_.D, {
                                    innerRef: Y,
    ...
    w = l.memo(function (e) {
        ...
        return l || null == n || n.record.type === R.rbe.GUILD_CATEGORY
            ? l
                ? (0, i.jsx)("li", {
                      className: O.fx,
