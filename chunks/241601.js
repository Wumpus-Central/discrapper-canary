...
async function c(e) {
    ...
    let n = [];
    o.NW.setLocale(e), n.push((0, i.loadAllMessagesInLocale)(e)), null != r && (r.setLocale(e), n.push(r.loadPromise)), n.push(u(e)), n.push(d(e)), n.push(f(e)), await Promise.all(n).catch((n) => t.setLoadingFailed(n, e)), t.setLoadingSucceeded(e);
}
async function u(e) {
    let t = n(602473).q[e];
    if (null == t) return;
