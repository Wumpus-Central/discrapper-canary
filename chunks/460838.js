...
function _(e) {
    let { className: n, guild: t, channel: i, creator: l, name: o, entityType: a, description: u, imageLocation: d = 0, imageSource: g, isActive: p, isUserLurking: f, isJoined: h = !1, isMember: P = !1, isHub: E = !1, speakers: k, speakerCount: w, rsvped: I, canInvite: S, location: _, truncate: D, onContextMenu: G, onJoinClick: L, onJoinGuildClick: M, onGoToGuildClick: R, onRsvpClick: U, onStartClick: H, onInviteClick: A, onEndClick: z, onClick: B, isNew: J, guildEvent: X, eventPreview: V, recurrenceRule: q, recurrenceId: W } = e,
        K = (0, v.Q)(i, a),
        F = a === C.WX.EXTERNAL,
