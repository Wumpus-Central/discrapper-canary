...
function u(e) {
    ...
    try {
        ...
        return new a.Vy("Auth").error("Failed to check external redirect", e), !1;
    }
}
async function c(e) {
    let t = (0, l.A)();
    try {
        ...
        let l,
            a,
            s = (await r.Bo.post({ url: i.Rsh.HANDOFF, body: { key: t }, oldFormErrors: !0, rejectWithError: !0 })).body
                .handoff_token,
            o =
                ((n = { urlString: e, handoffKey: t, handoffToken: s }),
                (l = new URL(n.urlString)),
                (a = `handoff_key=${encodeURIComponent(n.handoffKey)}&handoff_token=${encodeURIComponent(n.handoffToken)}`),
                "" !== l.hash ? (l.hash += `&${a}`) : (l.hash = `#${a}`),
                l.href);
