...
let E = (e, t) => {
    ...
    g = (e) => {
        ...
        if (o) {
            ...
            let o = m.intl.format(p.default.MkcFjx, { receiverName: e, premiumGroupProductName: u });
            switch (l) {
                case f.xI.ACCEPTED:
                    (t = m.intl.formatToPlainString(p.default.K37xCB, { premiumGroupProductName: u })),
                        (n = m.intl.formatToPlainString(p.default["W7e/z1"], { receiverName: e }));
                    break;
                case f.xI.REMOVED:
                case f.xI.NOT_FOUND:
                case f.xI.ERROR:
                    (t = m.intl.formatToPlainString(p.default.YLvraS, { premiumGroupProductName: u })),
                ...
                case f.xI.PENDING:
                default:
                    (t = m.intl.formatToPlainString(p.default["5uwv8J"], { premiumGroupProductName: u })),
        ...
        }
        {
            ...
            switch (l) {
                ...
                case f.xI.NOT_FOUND:
                case f.xI.ERROR:
                    (t = m.intl.formatToPlainString(p.default["AmLUw+"], { premiumGroupProductName: u })),
                        (n = m.intl.formatToPlainString(p.default["7XAuyg"], { premiumGroupProductName: u }));
                    break;
                case f.xI.PENDING:
                default:
                    (t = m.intl.string(p.default.ssge1y)),
    ...
    I = () => {
        let e = (0, d.A)({ location: "PremiumGroupPurchase" }),
            ...
            i = (0, r.bG)([o.A], () => {
                ...
                try {
                    let e = (0, u.I8)(_.gD.PREMIUM_GROUP_MONTH, { purchaseType: h.lid.DEFAULT });
                    return null != e;
                } catch {
                    return !1;
                }
