...
function k(e) {
    ...
    let { IconComponent: B, backgroundDarkColor: Z, backgroundLightColor: F, foregroundDarkColor: V, foregroundLightColor: H, premiumBackgroundColor: Y, premiumForegroundColor: W, sizeAdjustment: K } = D[M];
    if (null == B) return null;
    j.premium && ((t = W), (n = Y));
    let z = (0, c.wj)(k) ? V : H,
        q = (0, c.wj)(k) ? Z : F;
    ((t = null != t ? t : z), (n = null != n ? n : q));
    let $ = Math.floor(0.75 * P) - (null != K ? K : 0);
