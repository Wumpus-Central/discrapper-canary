...
function x(e) {
    let t,
        n,
        { guild: a, tooltipColor: l = c.ua7.Colors.BRAND, tooltipPosition: _, className: v, flowerStarClassName: y, iconClassName: I, badgeStrokeColor: A, badgeColor: C, size: O = 16, disableBoostClick: x, 'aria-label': L = !1 } = e,
