...
t.d(n, { Z: () => i }), t(518263), t(970173), t(520712), t(268111), t(941497), t(32026), t(480839), t(744285), t(492257), t(873817), t(411104), t(47120), t(724458), t(242167), t(653041);
class a {
    appendBytes(e) {
    ...
    addPage(e) {
        ...
        let r = this._buffer.subarray(l, this._offset).reduce((e, n) => ((e << 8) >>> 0) ^ s[(e >>> 24) ^ n], 0) >>> 0;
