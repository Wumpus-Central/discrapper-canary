...
class _ extends o {
    ...
    drawText(e, t, n) {
        ...
        if (
            ...
            this.font.truncate === s.Kq.Truncate && d((e = _(e)), t),
            ...
            for (
                ...
                if ((a = this.context.measureText(o + " " + n[0])).width > i) {
                    let e = !1;
                    if (
                        (u + 1 >= s && n.length > 0 && (e = !0),
                        "" !== o
                            ? (d(e ? _(o + "...") : o, { x: t.x, y: t.y + l * u }), (o = ""))
                            : d(_(n.shift() ?? ""), { x: t.x, y: t.y + l * u }),
                        e)
                    )
                        break;
                    u += 1;
                } else (o += ` ${n.shift()}`), 0 === n.length && d(o, { x: t.x, y: t.y + l * u });
        }
    ...
    drawRoundedImage(e, t, n, i, r) {
        ...
        this.context.save();
        let _ = new Path2D();
        _.roundRect(a, o, l, d, i), this.context.clip(_);
        let u = this.drawImage(e, t, n, r);
    ...
    drawCroppedImage(e, t, n) {
        ...
        if (null != this.offscreenCanvasCache) return this.drawCroppedCachedImage(e, t, n);
        {
            let { x: e, y: r, w: s, h: a } = t,
                { x: o, y: l, w: d, h: _ } = n;
            this.context.drawImage(i, e, r, s, a, o, l, d, _);
        }
        return s.uS.Success;
    }
    ...
    drawCroppedCachedImage(e, t, n) {
        ...
        let { x: o, y: l, w: d, h: _ } = t,
            { x: u, y: c, w: E, h: h } = n;
        return (
            this.context.drawImage(this.offscreenCanvasCache.canvas, a.x + o, a.y + l, d, _, u, c, E, h), s.uS.Success
        );
    }
    drawPath(e, t) {
