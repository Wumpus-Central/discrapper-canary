...
function c(e) {
    ...
    return (
        i !== o.hg.AUTO &&
            a.Z.getCurrentConfig({ location: "makeLongFormatter" }).enable24HourPref &&
            (i === o.hg.H12 ? (r.hourCycle = "h12") : i === o.hg.H23 && (r.hourCycle = "h23")),
        (0, l.s)(r)
    );
}
function u(e, t) {
...
function h(e, t) {
    let n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2],
        r = null != t ? t : _();
    (void 0 !== t || n || !a.Z.getCurrentConfig({ location: "makeDateFormatter" }).enableSystemFormatter) &&
        (e = p(e, r));
    let i = [],
        o = {
            month: !1,
