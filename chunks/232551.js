...
function c(e) {
    ...
    let r = {
        ...
        i = s.hg.getSetting();
    return i !== a.hg.AUTO && o.Z.getCurrentConfig({ location: 'makeLongFormatter' }).enable24HourPref && (i === a.hg.H12 ? (r.hourCycle = 'h12') : i === a.hg.H23 && (r.hourCycle = 'h23')), (0, l.s)(r);
}
function u(e, t) {
