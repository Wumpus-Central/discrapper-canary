n.d(t, { ZP: () => S }), n(388685), n(642613), n(539854);
var r = n(473749),
    i = n(392711),
    l = n.n(i),
    a = n(374470),
...
class E {
    ...
    mergePropsAndUpdate_(e) {
        ...
        if (null != e.messages.jumpTargetId) {
            ...
            if (null == n || this.isJumping() || e.messages.jumpSequenceId === t.jumpSequenceId) {
                ...
                null != i &&
                    ...
                    (r = g.default.extractTimestamp(i.id)),
        ...
        let a = e.messages.last(),
            o = t.last();
        if (null != a && a.state === O.yb.SENDING && (null == o ? void 0 : o.id) !== a.id)
    ...
    getScrollerState() {
        var e, t;
        return null != (t = null == (e = this.ref.current) ? void 0 : e.getScrollerState()) ? t : C;
    }
    isHeightChange(e, t) {
    ...
    handleScrollSpeed(e) {
        ...
        0 !== a &&
            ...
            (1 === a && t + o <= 0
                ...
                : 2 === a && t + o >= r - n && (this.mergeTo(r - l), (this.prevScrollTop = r - l)));
    }
    enableAutomaticAck() {
        this.isInitialized() &&
            !this.acking &&
    ...
    fixJumpTarget() {
        ...
        if (null != e.jumpTargetId) {
            ...
            (0, a.kK)(r)
                ? this.scrollTo(
                      this.getOffsetOrientationFromNode(r, "middle", t ? this.newMessageBarBuffer() : v.kQ),
                      !0,
                  )
    ...
    scrollToNewMessages() {
        ...
        let t = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
            ...
            i = null == (e = this.getDocument()) ? void 0 : e.getElementById(v.j1),
            l = () => {
        ...
        (this.pinned = !1),
            (this.jumping = t),
            null != i
                ? this.scrollTo(this.getOffsetOrientationFromNode(i, n, this.newMessageBarBuffer()), t, l)
    ...
    getOffsetOrientationFromNode(e, t) {
        ...
        let l = this.getScrollerState(),
            a = (0, y.Z)(e, i);
        return "middle" === t ? Math.min(a - 0.5 * l.offsetHeight + 0.5 * e.offsetHeight + -8, a - r) : a - r;
    }
    restoreScroll() {
        ...
        null != t
            ...
            : this.props.hasUnreads &&
                this.props.channel.type !== O.d4z.GUILD_VOICE &&
                this.props.channel.type !== O.d4z.GUILD_STAGE_VOICE
              ? ((0, m.K)(this.props.channel, this.props.messages), this.scrollToNewMessages())
              : null != e
    ...
    scrollToMessage(e) {
        ...
        this.isJumping() ||
            ...
            (g.default.extractTimestamp(e) > n ? this.scrollTo(0) : this.scrollTo(Number.MAX_SAFE_INTEGER)),
            (this.pinned = !1),
            (this.jumping = !0);
        let i = () => {
            (this.jumping = !1),
                (0, a.kK)(r) && ((r.tabIndex = -1), r.focus({ preventScroll: !0 })),
        ...
        (0, a.kK)(r)
            ? this.scrollTo(
                  this.getOffsetOrientationFromNode(
                      r,
                      "middle",
                      this.props.hasUnreads ? this.newMessageBarBuffer() : v.kQ,
                  ),
                  t,
                  i,
              )
    ...
    getOffsetToTriggerLoading(e, t) {
        let { scrollHeight: n, offsetHeight: r } = t,
            { messages: i, hasUnreads: l, placeholderHeight: a } = this.props;
        if ("top" === e)
    ...
    constructor(e) {
        ...
        if (
            ...
            j(this, "updateVisibleMessagesDebounced", l().debounce(f.JR, 300)),
            ...
            j(this, "updateStoreDimensionsDebounced", l().debounce(this.updateStoreDimensions, 200)),
            (this.props = e),
            (this.loading = e.messages.loadingMore),
