n.d(t, { ZP: () => R }), n(388685), n(642613), n(539854);
var r = n(73800),
    i = n(392711),
    o = n.n(i),
    a = n(374470),
...
class C {
    ...
    mergePropsAndUpdate_(e) {
        ...
        if (null != e.messages.jumpTargetId) {
            ...
            if (null == n || this.isJumping() || e.messages.jumpSequenceId === t.jumpSequenceId) {
                ...
                null != i &&
                    ...
                    (r = h.default.extractTimestamp(i.id)),
        ...
        let a = e.messages.last(),
            s = t.last();
        if (null != a && a.state === b.yb.SENDING && (null == s ? void 0 : s.id) !== a.id)
    ...
    findAnchor() {
        let { messages: e, hasUnreads: t, channel: n } = this.props,
            ...
            { scrollTop: i } = r,
            o = t && i >= this.newMessageBarBuffer() ? this.newMessageBarBuffer() : 0,
            a = null,
            s = (t) => {
                var r;
    ...
    updateAutomaticAnchor(e) {
        ...
        n && null != i && null != this.automaticAnchor && (i.offsetFromTop = this.automaticAnchor.offsetFromTop),
    ...
    isInPlaceholderRegion(e) {
        let { scrollTop: t, offsetHeight: n, scrollHeight: r } = e,
            { messages: i, placeholderHeight: o } = this.props,
            a = o,
            s = r - n - o;
    ...
    isInScrollTriggerLoadingRegion(e) {
        ...
        return i.hasMoreBefore && t <= this.getOffsetToTriggerLoading("top", e) && r > n
            ? 1
    ...
    handleScrollSpeed(e) {
        ...
        0 !== a &&
            0 !== s &&
            (1 === a && t + s <= 0
                ? (this.mergeTo(o - n), (this.prevScrollTop = o - n))
                : 2 === a && t + s >= r - n && (this.mergeTo(r - o), (this.prevScrollTop = r - o)));
    }
    enableAutomaticAck() {
        this.isInitialized() &&
            !this.acking &&
    ...
    fixJumpTarget() {
        ...
        if (null != e.jumpTargetId) {
            ...
            (0, a.k)(r)
                ? this.scrollTo(
                      this.getOffsetOrientationFromNode(r, "middle", t ? this.newMessageBarBuffer() : E.kQ),
                      !0,
                  )
    ...
    scrollToNewMessages() {
        ...
        (this.pinned = !1),
            (this.jumping = t),
            null != i
                ? this.scrollTo(this.getOffsetOrientationFromNode(i, n, this.newMessageBarBuffer()), t, o)
                : this.scrollTo(this.getOffsetToPreventLoading("top"), t, o);
    }
    getOffsetOrientationFromNode(e, t) {
        ...
        let o = this.getScrollerState(),
            a = (0, g.Z)(e, i);
        return "middle" === t ? Math.min(a - 0.5 * o.offsetHeight + 0.5 * e.offsetHeight + I, a - r) : a - r;
    }
    restoreScroll() {
        ...
        null != t
            ...
            : this.props.hasUnreads &&
                this.props.channel.type !== b.d4z.GUILD_VOICE &&
                this.props.channel.type !== b.d4z.GUILD_STAGE_VOICE
    ...
    updateStoreDimensions(e) {
        ...
        if (this.isPinned()) s.Z.updateChannelDimensions(t.id, 1, 1, 0, e);
            ...
            let { placeholderHeight: n } = this.props,
                { scrollTop: r, scrollHeight: i, offsetHeight: o } = this.getScrollerState();
    ...
    scrollToMessage(e) {
        ...
        this.isJumping() ||
            ...
            (h.default.extractTimestamp(e) > n ? this.scrollTo(0) : this.scrollTo(Number.MAX_SAFE_INTEGER)),
            (this.pinned = !1),
            (this.jumping = !0);
        let i = () => {
            (this.jumping = !1),
                (0, a.k)(r) && d.Z.keyboardModeEnabled && r.focus({ preventScroll: !0 }),
        ...
        (0, a.k)(r)
            ? this.scrollTo(
                  this.getOffsetOrientationFromNode(
                      r,
                      "middle",
                      this.props.hasUnreads ? this.newMessageBarBuffer() : E.kQ,
                  ),
                  t,
                  i,
              )
            : this.scrollToNewMessages(t, "middle", i);
    }
    getOffsetToTriggerLoading(e, t) {
        let { scrollHeight: n, offsetHeight: r } = t,
            { messages: i, hasUnreads: o, placeholderHeight: a } = this.props;
        if ("top" === e)
    ...
    addAutomaticAnchorCallback(e) {
        ...
        this._automaticAnchorCallbacks.push(e),
            (this._automaticAnchorCallbacks = o().uniq(this._automaticAnchorCallbacks)),
    ...
    addScrollCompleteCallback(e) {
        this._scrollCompleteCallbacks.push(e),
            (this._scrollCompleteCallbacks = o().uniq(this._scrollCompleteCallbacks));
    }
    ...
    constructor(e) {
        ...
        if (
            ...
            y(this, "updateVisibleMessagesDebounced", o().debounce(_.JR, 300)),
            y(this, "handleScroll", (e) => {
                ...
                1 === i ? this.loadMore() : 2 === i ? this.loadMore(!0) : this.enableAutomaticAck(),
            ...
            y(this, "updateStoreDimensionsDebounced", o().debounce(this.updateStoreDimensions, 200)),
            (this.props = e),
            (this.loading = e.messages.loadingMore),
            ...
            (this.pinned = null == r || r),
                (this.initialScrollTop = r
                    ? null
                    : null != (n = null == (t = p.Z.getChannelDimensions(e.channel.id)) ? void 0 : t.scrollTop)
                      ? n
                      : null);
        }
    }
