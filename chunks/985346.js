...
function m({ actor: l, trackElementClicked: t, trackCaptureAttemptFinished: d }) {
    return (
        (l.getSnapshot().context.dependencies.trackCaptureAttemptFinished = d),
        {
            ...
            async nextStep() {
                ...
                if (d.matches("tutorial")) {
                    ...
                    await (0, n.r)({ ds: l.ds, cameraGranted: "granted" === t });
                }
...
function h(l) {
    ...
    if (void 0 !== t) {
        ...
        if ("capture" === t) {
            if (u(l.value, "uploadError")) return `error.${o(l.context.uploadError)}`;
            if (u(l.value, "detecting") && "offline" === l.context.detectionStatus) return "error.noConnection";
        }
    }
}
function W(l) {
    ...
    if ("capture" === t && u(l.value, "detecting") && "offline" === l.context.detectionStatus)
        return { reason: "noConnection" };
    let d = l.context.uploadError;
    if ("string" == typeof d && 0 !== d.length) return { errorCode: d, reason: o(d) };
}
function G(l, t, d = new s.t()) {
    return (0, e.l)({
        actor: l,
        mapState: Z,
        createApi: m,
                                    ...
                                    if (void 0 !== i) {
                                        if ("string" == typeof i)
                                            switch (i) {
                                                ...
                                                case "uploadError":
                                                    return b(d?.uploadError, d?.attemptsRemaining);
                                                case "success":
