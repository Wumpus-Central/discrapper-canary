    ...
    return (0, r.jsxs)("div", {
        ...
        children: [
            (0, r.jsx)(c.u, {
                asContainer: !0,
                shouldShow: M && !A,
                "aria-label": _.intl.string(_.t.SQ7qMD),
                __unsupportedReactNodeAsText: (0, r.jsxs)("div", {
                    className: P.downloadRequiredContent,
                    children: [
                        (0, r.jsx)(u.Text, {
                            variant: "text-sm/medium",
                            children: _.intl.string(_.t.SQ7qMD),
                        }),
                        (0, r.jsx)(u.Text, {
                            variant: "text-xs/normal",
                            children: _.intl.string(_.t.TbnPVl),
                        }),
                    ],
                }),
            ...
            null != R &&
                (0, r.jsx)(c.u, {
                    asContainer: !0,
                    text: _.intl.string(L ? _.t.ItuPbm : _.t["0gtbEx"]),
                    children: (0, r.jsx)(u.P3F, {
                        className: l()([P.hoverButtonCircle, P.previewButton], { [P.visible]: L }),
                        onClick: L ? Y : B,
                        "aria-label": _.intl.formatToPlainString(_.t.gDzvjY, { voiceFilterName: W }),
                        children: L
                            ? (0, r.jsx)(u.wNq, {
                                  size: "custom",
                                  height: 16,
