...
let c = 'url(#gradient)',
    ...
    m = (e) => {
        let { percentage: t = 0, children: n, animationClassName: c, initialPercentage: m = 0, progressCircleStrokeSize: p = 2, progressCircleVariation: h, progressCircleStroke: f } = e,
            b = 43 + p / 2,
            _ = 2 * Math.PI * b,
            [x, E] = r.useState(m);
        r.useEffect(() => {
