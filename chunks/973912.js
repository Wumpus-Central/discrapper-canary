    ...
    let {
        ...
        f = s.useCallback(async () => {
            if (!g) {
                m(!0);
                try {
                    await T.A.addSkuToWishlist(t.id, i), o?.(), r?.({ tabSection: k.RP.WISHLIST });
                } catch (e) {
        ...
        h = s.useMemo(() => a()({ [L.zW]: l || g }, c), [l, g, c]);
    return (0, n.jsx)(P, {
...
function y(e) {
    let { sku: t, analyticsLocations: i, ...s } = e,
        { analyticsLocations: l } = (0, E.Ay)(...(i ?? []), h.A.SLAYER_STOREFRONT_WISHLIST_ITEM_CARD);
    return (0, n.jsx)(G, { sku: t, analyticsLocations: l, ...s });
}
function D(e) {
    let { sku: t, ...i } = e,
        l = s.useMemo(() => {
    ...
    return (0, n.jsx)(G, { sku: t, skuPreviewStyle: l, ...i });
}
function M(e) {
    let { sku: t, ...i } = e;
    return (0, n.jsx)(G, { sku: t, skuPreviewStyle: b.MO, onAddSuccess: j.w, ...i });
}
function F(e) {
    let { sku: t, ...i } = e,
        [l, a] = s.useState(!1);
    switch (t.productLine) {
        case C.EZt.SOCIAL_LAYER_GAME_ITEM:
            return (0, n.jsx)(y, { sku: t, isHoveringOrFocusing: l, setIsHoveringOrFocusing: a, ...i });
...
function H(e) {
    let {
        ...
        p = (0, r.bG)([o.default], () => o.default.getUser(t?.userId)),
        A = (0, d.Gh)("add_to_wishlist_grid_suggested_nitro"),
        h = s.useMemo(() => new Set(t?.items.map((e) => e.skuId) ?? []), [t]),
