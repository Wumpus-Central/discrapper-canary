...
function x(e) {
    let {
        ...
        T = (0, d.Ar)(),
        m = (0, f.A)(() => (0, c.A)()),
        { handleVisibilityChange: g } = (0, R.G)(m),
...
function k(e) {
    let {
        ...
        T = r.useCallback(async () => {
            if (!f) {
                p(!0);
                try {
                    await O.A.addSkuToWishlist(t.id, n), c?.(), l?.({ tabSection: M.RP.WISHLIST });
                } catch (e) {
    ...
    return (0, i.jsxs)(x, {
        ...
        isHoveringOrFocusing: a,
        ..._,
        children: [(0, i.jsx)(D.oU, { isHoveringOrFocusing: a, loading: f }), !a && !f && u],
    });
}
function F(e) {
    ...
    return (0, i.jsx)(k, {
        ...
        promotion: null != s ? (0, i.jsx)(y.s, { spec: G, icon: s.Icon, tooltipText: s.tooltip }) : null,
        ...r,
    });
}
function V(e) {
