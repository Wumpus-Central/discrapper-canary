!(function (t, n) {
    ...
    function eb(e, t, n, r) {
        ...
        if (i) {
            ...
            return new q(function () {
                var e = i[n ? a - o : o];
                return o++ > a ? Q() : X(t, r ? e[0] : o - 1, e[1]);
            });
        }
    ...
    function eS(e, t) {
        ...
        var o = !0,
            s = t.__iterate(function (t, r) {
                if (n ? !e.has(t) : i ? !eT(t, e.get(r, R)) : !eT(e.get(r, R), t)) return (o = !1), !1;
            });
        return o && e.size === s;
    }
    function eA(e, n) {
    ...
    function tt(e, t, n, r, i, a, o, s) {
        return e ? e.update(t, n, r, i, a, o, s) : a === R ? e : (L(s), L(o), new e4(t, r, [i, a]));
    }
    function tn(e) {
    ...
    function ti(e, t, n, r) {
        e || (e = new x());
        for (var i = new e4(e, eM(n), [n, r]), a = 0; a < t.length; a++) {
            var o = t[a];
    ...
    function to(e, t, n, r, i) {
        for (var a = 0, o = Array(C), s = 0; 0 !== n; s++, n >>>= 1) o[s] = 1 & n ? t[a++] : void 0;
    ...
    function tR(e, t, n, r, i, a) {
        ...
        if (n > 0) {
            var c = e && e.array[s],
                u = tR(c, t, n - A, r, i, a);
            return u === c ? e : (((o = tP(e, t)).array[s] = u), o);
        }
        return l && e.array[s] === i
            ? e
            : (L(a), (o = tP(e, t)), void 0 === i && s === o.array.length - 1 ? o.array.pop() : (o.array[s] = i), o);
    }
    function tP(e, t) {
    ...
    function tD(e, t, n) {
        ...
        if ((s < a && (p = p && p.removeAfter(r, 0, s)), o >= f))
            (o -= f), (s -= f), (l = A), (c = null), (p = p && p.removeBefore(r, 0, o));
        else if (o > i || f < d) {
            for (u = 0; c; ) {
                var E = (o >>> l) & N;
                if ((E !== f >>> l) & N) break;
        ...
        return (
            ...
            (r.__iteratorUncached = function (r, i) {
                ...
                return new q(function () {
                    ...
                    var o = i.value,
                        s = o[0];
                    return X(r, s, t.call(n, o[1], s, e), i);
                });
            }),
            r
        );
                ...
                return new q(function () {
                    for (;;) {
                        ...
                        var l = a.value,
                            c = l[0],
                            u = l[1];
                        if (t.call(n, u, c, e)) return X(i, r ? c : s++, u, a);
                    }
                });
            }),
            i
    ...
    function tX(e, t, n, r) {
        ...
        var o = B(t, a),
            s = Z(n, a);
        if (o != o || s != s) return tX(e.toSeq().cacheResult(), t, n, r);
        var l = s - o;
        l == l && (i = l < 0 ? 0 : l);
        var c = nt(e);
        return (
            ...
            !r &&
                ...
                i >= 0 &&
                (c.get = function (t, n) {
                    return (t = j(this, t)) >= 0 && t < i ? e.get(t + o, n) : n;
                }),
            ...
            (r.__iteratorUncached = function (r, i) {
                ...
                return new q(function () {
                    ...
                    var i = e.value,
                        l = i[0],
                        c = i[1];
                    return t.call(n, c, l, a) ? (r === Y ? e : X(r, l, c, e)) : ((s = !1), Q());
                });
            }),
            r
        );
        ...
        return (
            ...
            (n.__iteratorUncached = function (n, r) {
                var i,
                    ...
                    o = 0;
                return new q(function () {
                    return (!i || o % 2) && (i = a.next()).done ? i : o % 2 ? X(n, o++, t) : X(n, o++, i.value, i);
                });
            }),
            n
        );
    ...
    function nI(e) {
        return null == e ? nN() : nT(e) ? e : nN().unshiftAll(e);
    }
    function nT(e) {
        return !!(e && e[nS]);
    }
    ...
    (nA[nS] = !0),
        ...
        nR(f, {
            ...
            min: function (e) {
                return t4(this, e ? nM(e) : nU);
            },
            minBy: function (e, t) {
                return t4(this, t ? nM(t) : nU, e);
            },
            rest: function () {
                return this.slice(1);
            },
    ...
    return (
        ...
        nR(p, {
            ...
            splice: function (e, t) {
                ...
                return t6(this, 1 === n ? r : r.concat(M(arguments, 2), this.slice(e + t)));
            },
            ...
            zip: function () {
                var e = [this].concat(M(arguments));
                return t6(this, t5(this, nj, e));
            },
            zipWith: function (e) {
                var t = M(arguments);
                return (t[0] = this), t6(this, t5(this, e, t));
            },
        }),
        (p.prototype[I] = !0),
        (p.prototype[T] = !0),
