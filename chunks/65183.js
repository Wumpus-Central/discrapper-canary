t.exports = (function () {
    ...
    function tx(t) {
        ...
        if ("string" === e) {
            return t.length > tT
                ? (void 0 === (o = tI[(i = t)]) && ((o = tk(i)), tA === tM && ((tA = 0), (tI = {})), tA++, (tI[i] = o)),
                  o)
                : tk(t);
        }
        ...
        if ("object" === e) {
            ...
            if (((a = ++tO), 1073741824 & tO && (tO = 0), tD)) n.set(u, a);
                ...
                void 0 !== u.propertyIsEnumerable &&
                u.propertyIsEnumerable === u.constructor.prototype.propertyIsEnumerable
            )
        ...
        (tz.prototype.update = function (t, e, r, n, i, o, a) {
            ...
            if ((T(a), (u || !f) && T(o), !u || 1 !== s.length)) {
                ...
                var _ = t && t === this.ownerID,
                    b = _ ? s : A(s);
                return (f ? (u ? (c === l - 1 ? b.pop() : (b[c] = b.pop())) : (b[c] = [n, i])) : b.push([n, i]), _)
                    ? ((this.entries = b), this)
                    : new tz(t, b);
            }
        }),
        ...
        (t9.prototype.set = function (t, e) {
            return (function (t, e, r) {
                ...
                return (e >= ep(t._capacity)
                    ? (n = eu(n, t.__ownerID, 0, e, r, o))
                    : (i = eu(i, t.__ownerID, t._level, e, r, o)),
                o.value)
                    ? t.__ownerID
    ...
    function eu(t, e, r, n, i, o) {
        ...
        return s && t.array[u] === i
            ? t
            : (T(o), (a = es(t, e)), void 0 === i && u === a.array.length - 1 ? a.array.pop() : (a.array[u] = i), a);
    }
    function es(t, e) {
    ...
    function el(t, e, r) {
        ...
        for (var s = t._level, c = t._root, l = 0; a + l < 0; )
            (c = new er(c && c.array.length ? [void 0, c] : [], n)), (s += 5), (l += 1 << s);
        l && ((a += l), (i += l), (u += l), (o += l));
