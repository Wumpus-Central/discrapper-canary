a.d(t, { DX: () => v, _v: () => P, cs: () => T, ec: () => f, kK: () => x, sn: () => S });
var n = a(627968),
    o = a(64700),
    r = a(412703),
    i = a(440703),
...
function C(e) {
    let {
        ...
        C = f(y),
        P = o.useRef(!1);
    P.current || ((P.current = !0), u.Kr.getState().clearState()),
        ...
        stories: [
            {
                ...
                id: "landscape-video",
                component: C,
                controls: { ...P, orientation: { ...P.orientation, defaultValue: "landscape" } },
            },
            {
                name: "Portrait",
                id: "portrait-video",
                component: C,
                controls: { ...P, orientation: { ...P.orientation, defaultValue: "portrait" } },
            },
        ],
    };
