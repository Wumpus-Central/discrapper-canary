...
var i = n(64700),
    ...
    u = n(540185),
    _ = n(282435);
let g = (0, c.sampleSize)(_.cG, _.cG.length),
    m = (0, d.v)((e, t) => ({
        stack: [],
        wishlistStack: [],
        gameIds: {},
        ...
        onLoad: (n, i, a) => {
            ...
            for (let a of (e({
                stack: [...n.filter((e) => !l.has(e)), ...g],
                wishlistStack: [...i.filter((e) => !l.has(e)), ...g],
            }),
            Object.values(u.x)))
                t().setNext(6, a);
        },
...
function f(e) {
    let { bump: t, bumpMultiple: n, gameIds: r } = m();
    !(function (e) {
        let { remove: t, peekedGameIds: n } = m(),
            r = i.useMemo(() => n[e] ?? [], [n, e]);
        (0, s.x)(r);
