...
function E(e) {
    ...
    let { guild: n, selectedChannelId: i, setSelectedChannelId: s, className: m } = e,
        p = null !== (t = n.safetyAlertsChannelId) && void 0 !== t ? t : null,
        h = (0, o.Wu)(
        ...
        f = async (e) => {
            s(e);
            try {
                if ((e !== p && (await v.Z.saveGuild(n.id, { safetyAlertsChannelId: e }, { throwErr: !0 }), v.Z.updateGuild({ safetyAlertsChannelId: e })), null != e)) {
                    let t = {
                        raid_alert_type: g.wR.JOIN_RAID,
...
function S(e) {
    ...
    let { guild: s } = e,
        [a, l] = i.useState(!1),
        o = null !== (t = s.safetyAlertsChannelId) && void 0 !== t ? t : null,
        [c, d] = i.useState(null != o ? o : null !== (n = null == s ? void 0 : s.publicUpdatesChannelId) && void 0 !== n ? n : null);
    return (0, r.jsx)(h.Z, {
...
function T(e) {
    var t, n;
    let { guild: s } = e,
        a = null !== (t = s.safetyAlertsChannelId) && void 0 !== t ? t : null,
        [l, o] = i.useState(null != a ? a : null !== (n = null == s ? void 0 : s.publicUpdatesChannelId) && void 0 !== n ? n : null);
