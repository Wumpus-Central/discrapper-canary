        ...
        (e.onChange = () => {
            if ((i.Ew.isValid(e, e.selection) || (e.selection = s(e)), null != e.selection)) {
                let t,
                    ...
                    l = !1;
                for (; null != a && null != (t = i.bN.getParentVoid(e, a)) && !o.On.includes(t[0].type); )
                    (a = i.bN.before(e, a, { unit: "offset" })), (l = !0);
                for (; null != s && null != (n = i.bN.getParentVoid(e, s)) && !o.On.includes(n[0].type); )
