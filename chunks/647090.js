...
var m = function (e, t, n) {
    ...
    L = function (e) {
        var t, n;
        return (t = e), (n = N), Math.round((t.getTime() - D(t) - (n.getTime() - D(n))) / 864e5);
    },
    w = function (e) {
    ...
    M = function (e) {
        var t = e.getUTCMonth();
        return 1 === t && R(e.getUTCFullYear()) ? 29 : C[t];
    },
    P = function (e) {
    ...
    H = function (e, t) {
        var n = new Date(j(e, Intl.DateTimeFormat().resolvedOptions().timeZone)),
            i = new Date(j(e, null != t ? t : "UTC")).getTime() - n.getTime();
                    ...
                    (0, W.fX)(
                        (0, W.fX)(
                            (0, W.fX)(
                                (0, W.fX)(
                                    (0, W.fX)(
                                        (0, W.fX)((0, W.fX)((0, W.fX)((0, W.fX)([], eN, !0), ey, !0), eN, !0), eC, !0),
                                        eN,
                                        !0,
                                    ),
                                    eC,
                    ...
                    (0, W.fX)(
                        (0, W.fX)(
                            (0, W.fX)(
                                (0, W.fX)(
                                    (0, W.fX)(
                                        (0, W.fX)((0, W.fX)((0, W.fX)((0, W.fX)([], eN, !0), eS, !0), eN, !0), eC, !0),
                                        eN,
                                        !0,
                                    ),
                                    eC,
                ...
                if (
                    (e !== this.lastyear &&
                        (this.yearinfo = (function (e, t) {
                            ...
                            if (h) {
                                var C = void 0;
                                if (S(t.byweekno, -1)) C = -1;
                                else {
                                    var N = P(y(e - 1, 1, 1)),
                                        v = g(7 - N.valueOf() + t.wkst, 7),
                                        O = R(e - 1) ? 366 : 365,
                                        b = void 0;
                                    v >= 4 ? ((v = 0), (b = O + g(N - t.wkst, 7))) : (b = l - h),
                                        (C = Math.floor(52 + g(b, 7) / 4));
                                }
                                if (S(t.byweekno, C)) for (var A = 0; A < h; A++) _.wnomask[A] = 1;
                            }
                            return _;
                        })(e, h)),
    ...
    for (
        ...
        if (T(a))
            ...
            for (var A = f; A < p; A++) {
                var C = h[A];
                if (c(C))
                    for (var N = w(u.yearordinal + C), v = 0; v < d.length; v++) {
                        var I = k(N, d[v]);
                        if (s && I > s) return eP(e);
                        if (I >= n) {
                            var y = eM(I, t);
...
var eY = (function (e) {
    function t(t) {
        ...
        return (
            (n.dtstart = eH.apply(n, ["dtstart"])),
            (n.tzid = eH.apply(n, ["tzid"])),
            (n._rrule = []),
            (n._rdate = []),
            (n._exrule = []),
            (n._exdate = []),
