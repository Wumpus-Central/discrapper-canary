...
function _(e) {
    let {
            ...
            questId: C,
            isQuestCompleted: v,
            isFullEpisodeVideoQuest: A,
            listenForHlsErrors: g = !0,
        } = e,
        h = (0, o.u0)(),
        I = (0, o.Ut)(),
        D = (0, s.bG)([u.A], () => u.A.getEffectiveConnectionSpeed()),
        T = (0, r.useRef)(-1),
        R = r.useCallback(
            (e) => {
                null != t.current &&
            ...
            (e) => {
                null != t.current &&
                    h({
                        ...
                        properties: { duration_ms: e, video_session_id: _, video_asset_id: m, ...f(n) },
                        sourceQuestContent: p,
                    });
            },
            [C, t, m, _, n, h, p],
        ...
        V = r.useCallback(
            (e, t) => {
                I({ questId: C, questContent: e, questContentCTA: t, sourceQuestContent: p });
            },
            [C, p, I],
        ),
        U = r.useCallback(
        ...
        Q = r.useCallback(
            (e, r) => {
                ...
                let s = t.current?.error,
                    ...
                    S = null != r ? { hls_error_subtype: r.errorDetails, hls_error_fatal: r.fatal } : {};
                h({
                    questId: C,
                    ...
                    (e === d.SB.SOURCE_ERROR || e === d.SB.NO_VALID_SOURCE) &&
                        a.A.increment({ name: i.K.QUEST_VIDEO_ERROR, tags: [`quest_id:${C}`, `error_type:${e}`] });
            },
            [C, t, m, _, n, h, p, D, A],
        );
    r.useEffect(() => {
        ...
        function t(e, t) {
            ...
            Q(n, { errorDetails: t.details, fatal: t.fatal });
        }
        return (
            ...
            (e) => {
                null != t.current &&
                    h({
                        ...
                        properties: { video_session_id: _, video_asset_id: m, ...f(n) },
                        sourceQuestContent: p,
                    });
            },
            [C, t, _, n, h, m, p],
    ...
    return {
        trackQuestVideoLoadingStarted: R,
        ...
        trackQuestContentClick: V,
        trackQuestVideoBufferingStarted: N,
        trackQuestVideoBufferingEnded: y,
        trackQuestVideoSegmentWatched: U,
        trackQuestVideoFullscreenChanged: w,
        trackQuestVideoError: Q,
        trackQuestVideoVolumeChanged: M,
    };
}
