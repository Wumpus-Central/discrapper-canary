...
function f(e) {
    let {
        ...
        h = (0, o.u0)(),
        I = (0, o.Ut)(),
        D = (0, a.bG)([u.A], () => u.A.getEffectiveConnectionSpeed()),
        T = (0, r.useRef)(-1),
        R = r.useCallback(
            (e) => {
                null != t.current &&
            ...
            (e) => {
                null != t.current &&
                    h({
                        ...
                        properties: { duration_ms: e, video_session_id: f, video_asset_id: m, ..._(n) },
                        sourceQuestContent: p,
                    });
            },
            [C, t, m, f, n, h, p],
            ...
            (e, r) => {
                ...
                h({
                    ...
                    (e === d.SB.SOURCE_ERROR || e === d.SB.NO_VALID_SOURCE) &&
                        i.A.increment({ name: s.K.QUEST_VIDEO_ERROR, tags: [`quest_id:${C}`, `error_type:${e}`] });
            },
            [C, t, m, f, n, h, p, D, A],
        );
    r.useEffect(() => {
            ...
            (e) => {
                null != t.current &&
                    h({
                        ...
                        properties: { video_session_id: f, video_asset_id: m, ..._(n) },
                        sourceQuestContent: p,
                    });
            },
            [C, t, f, n, h, m, p],
