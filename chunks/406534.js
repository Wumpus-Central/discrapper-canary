...
function et(e) {
    ...
    let r,
        ...
        eO = U.isForumPost() && !eg ? (0, i.jsx)(m.Z, { postId: U.id }) : null,
        eE = (0, b.Z)(U.id),
        eS = (0, y.nw)(U);
    (0, W.Z)();
    let eP = null,
        ...
        eZ = el.map((e, t) => {
            ...
            let l = e.groupId === (null == eP ? void 0 : eP.groupId) ? eP.content.id : e.groupId,
                ...
                o = e.type === Y.ys_.THREAD_STARTER_MESSAGE ? B.Ru : B.ZP;
            return (0, i.jsx)(
                o,
                {
                    compact: er && !a,
    ...
    if (
        ...
        ((e && ef()) || !e) && eI.unshift((0, i.jsx)(G.ZP, Q({ compact: er }, es), "has-more"));
    }
    if (
        ((et.hasMoreBefore && null == ec) ||
            eI.unshift(
        ...
        !eu && em && ef() && eI.push((0, i.jsx)(z.Z, { channel: U })),
        en > 0 && ei && ef())
    ) {
        let e,
            t,
