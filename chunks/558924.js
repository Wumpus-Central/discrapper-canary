    ...
    E)
        ...
        : S
          ? (0, l.jsx)(d.sNh, {
                ...
                action: () => {
                    k && M(x.L.TAKE_ACTION), c.Z.ring(n, [e.id], "user_context_menu"), _ && null != n && (0, p.Kh)(n);
                },
            ...
            ? (0, l.jsx)(d.sNh, {
                  ...
                  subtext: _
                      ? (0, l.jsx)(d.Text, {
                            ...
                            children: y.intl.format(y.t.dwfzZi, { channelName: (0, l.jsx)(C, { channel: u }) }),
                        })
                      : null,
                  action: () => {
                      k && M(x.L.TAKE_ACTION), c.Z.stopRinging(n, [e.id]);
                  },
                  className: N.menuItem,
              })
            : null;
