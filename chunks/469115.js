...
let s = [
        {
            ...
            angle: 180,
            getName: () => a.intl.string(a.t.kCdS4e),
        ...
        },
        {
            ...
            angle: 180,
            getName: () => a.intl.string(a.t.S4UnEx),
            midpointPercentage: 27
        },
        {
            ...
            angle: 148.71,
            getName: () => a.intl.string(a.t['48xnKS']),
        ...
        },
        {
            ...
            angle: 38.08,
            getName: () => a.intl.string(a.t.G4HsBA),
            midpointPercentage: 50
        },
        {
            id: i.Us.SUNRISE,
            ...
            angle: 154.19,
            getName: () => a.intl.string(a.t['NAt88/']),
            midpointPercentage: 50
        },
        {
            ...
            angle: 180.14,
            getName: () => a.intl.string(a.t.godtzM),
            midpointPercentage: 50
        },
        {
            id: i.Us.LOFI_VIBES,
            ...
            angle: 179.52,
            getName: () => a.intl.string(a.t.hlS2xs),
            midpointPercentage: 27
        },
        {
            ...
            angle: 38.99,
            getName: () => a.intl.string(a.t['abMn9/']),
            midpointPercentage: 50
        }
    ],
    l = o.BR.DARK,
    c = [
        {
            ...
            angle: 141.68,
            getName: () => a.intl.string(a.t.JKDra2),
        ...
        },
        {
            ...
            angle: 128.92,
            getName: () => a.intl.string(a.t.kwc8Ul),
        ...
        },
        {
            ...
            angle: 162.27,
            getName: () => a.intl.string(a.t['TeA/j4']),
            midpointPercentage: 50
        },
        {
            ...
            angle: 64.92,
            getName: () => a.intl.string(a.t.blIucn),
        ...
        },
        {
            ...
            angle: 48.17,
            getName: () => a.intl.string(a.t.O1yOXF),
        ...
        },
        {
            ...
            angle: 170.82,
            getName: () => a.intl.string(a.t['1swi9v']),
            midpointPercentage: 50
        },
        {
            id: i.Us.DUSK,
            ...
            angle: 180,
            getName: () => a.intl.string(a.t.So2Wur),
            midpointPercentage: 50
        },
        {
            ...
            angle: 179.14,
            getName: () => a.intl.string(a.t['a22o4+']),
            midpointPercentage: 50
        },
        {
            id: i.Us.RETRO_STORM,
            ...
            angle: 148.71,
            getName: () => a.intl.string(a.t.Bf294e),
        ...
        },
        {
            ...
            angle: 180,
            getName: () => a.intl.string(a.t['p+XCtb']),
            midpointPercentage: 50
        },
        {
            ...
            angle: 161.03,
            getName: () => a.intl.string(a.t['d5Ar+v']),
        ...
        },
        {
            ...
            angle: 239.16,
            getName: () => a.intl.string(a.t.Je1FWF),
        ...
        },
        {
            ...
            angle: 69.98,
            getName: () => a.intl.string(a.t['Z+Un4+']),
            midpointPercentage: 50
        }
    ],
    u = {
        ...
        angle: 47.61,
        getName: () => a.intl.string(a.t.Mfoe3t),
        midpointPercentage: 50
    },
    d = {
        id: i.Us.EASTER_EGG,
        ...
        angle: 180,
        getName: () => a.intl.string(a.t.mFinbW),
        midpointPercentage: 50
    },
    f = [...s, ...c, u, d],
    _ = [u, ...c, ...s, d],
    p = [
        {
            theme: l,
            getName: () => a.intl.string(a.t.b8Cei4)
        },
        {
            theme: o.BR.LIGHT,
            getName: () => a.intl.string(a.t.K2sFfn)
        },
        {
            theme: o.BR.MIDNIGHT,
            getName: () => a.intl.string(a.t.pQwSpa)
        },
        {
            theme: 'system',
            getName: () => a.intl.string(a.t.zlvNOj)
        }
    ],
    h = (0, r.keyBy)(f, 'id');
