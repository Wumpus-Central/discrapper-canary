    ...
    return (0, r.jsxs)('div', {
        ...
        children: [
            ...
            (0, r.jsx)(l.xv, {
                ...
                children: S.intl.string(S.t.ToyvLi)
            })
        ]
    });
}
function T(e) {
    let { message: t, snapshot: n, index: d } = e,
        p = i.useMemo(() => new E.r(t, n, d), [t, n, d]),
        m = (0, a.e7)([g.Z, v.default, y.Z, x.Z, b.Z, u.Z], () => p.getForwardInfo(g.Z, v.default, y.Z, x.Z, b.Z, u.Z).footerInfo, [p], o.Z),
        f = i.useCallback(() => {
            (0, O.Z)(t);
        }, [t]);
    return null == m
...
function P(e) {
    ...
    let { message: n, snapshot: l, index: o } = e,
        ...
        { content: y, hasSpoilerEmbeds: v } = (0, m.Z)(s, {
        ...
        E = (0, a.e7)([g.Z], () => g.Z.getChannel(n.channel_id)),
        O = h.jU.useSetting();
    return null == E
        ? null
        : (0, r.jsxs)(
