...
function T(e) {
    return (0, r.cj)(
        ...
        () => {
            ...
            if (d.has(h.q.AUTOMOD_QUARANTINED_USERNAME_OR_GUILD_NICKNAME))
                if (null == e) {
                    var E;
                    t.nick = [p.intl.formatToPlainString(p.t.WBUh3N, { guildName: null != (E = r.name) ? E : '' })];
                } else t.nick = [p.intl.string(p.t.EPZCrK)];
            return (d.has(h.q.AUTOMOD_QUARANTINED_BIO) && (t.bio = [p.intl.string(p.t.dZh1v7)]), t);
        },
        [e]
    );
}
function g(e) {
    let { guildId: t, scrollPosition: n, analyticsLocation: s, analyticsLocations: a, openWithoutBackstack: u } = e,
        ...
        h = (0, r.e7)([d.Z], () => null != _ && d.Z.can(E.Plq.CHANGE_NICKNAME, _), [_]);
    return [
        i.useCallback(() => {
            if (null == _) return;
            let e = E.oAB.PROFILE_CUSTOMIZATION,
                t = I.NB.GUILD;
            (h ? (0, o.Fq)(_) : (t = I.NB.USER_PROFILE),
                l.Z.open(e, t, {
                    scrollPosition: n,
                    analyticsLocation: s,
