...
let _ = (e) => {
    (0, o.useEffect)(() => {
        e && l.default.track(u.HAw.PREMIUM_BRAND_REFRESH_WOW_MOMENT_ASSETS_PREFETCHING);
    }, [e]);
    let {
            mediaUrls: t,
            isSuccess: n,
                    ...
                    if (!c() && !E) {
                        ...
                        try {
                            ...
                            h.current &&
                                ...
                                _(!0),
                                l.default.track(u.HAw.PREMIUM_BRAND_REFRESH_WOW_MOMENT_ASSETS_PREFETCH_SUCCESS, {
    ...
    return { mediaUrls: t, isSuccess: n && d === a.BW.Loaded, isLoading: _ || d === a.BW.Loading };
};
