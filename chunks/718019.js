...
var i = n(627968),
    ...
    C = n(375708),
    R = n(106106);
let O = m.Ay.getEnableHardwareAcceleration() ? l.Js : l.eu;
function b(e) {
    let {
            user: t,
            displayProfile: n,
        ...
        { theme: g } = (0, T.E)(),
        C = E.Ay.isPremiumAtLeast(n?.premiumType, N.PremiumTypes.TIER_2),
        ...
        [b] = O,
        {
            ...
            status: (0, d.A)(b) ? y.clD.STREAMING : p.A.getStatus(t.id),
            isMobileOnline: p.A.isMobileOnline(t.id),
            isVROnline: p.A.isVROnline(t.id),
        })),
        M = _?.avatarSize ?? v.T[a].avatarSize,
        {
    ...
    return {
        avatarProps: {
            ...
            status: R ? y.clD.UNKNOWN : void 0 !== c ? c : D,
            statusBackdropColor: C && !R ? (0, u.C$)(g) : void 0,
            isMobile: L,
            isVR: w,
            statusTooltip: !0,
...
function D(e) {
    let { onOpenProfile: t, className: n, ...r } = e,
        ...
        d = a()(R.my, n);
    return null == t
        ? (0, i.jsx)("div", { ...u, className: d, children: (0, i.jsx)(O, { ...l }) })
        : (0, i.jsx)(c.s, {
              "aria-label": C.intl.string(C.t["+Xp3hq"]),
              ...u,
              className: a()(d, R.vk),
              ...
              children: (0, i.jsx)(O, { ...l, imageClassName: R.Lw }),
          });
}
