...
function y(e) {
    let {
        ...
        { theme: p } = (0, g.E)(),
        R = I.Ay.isPremiumAtLeast(n?.premiumType, C.PremiumTypes.TIER_2),
        ...
        P = _?.avatarSize ?? O.T[s].avatarSize,
        {
    ...
    return {
        avatarProps: {
            ...
            statusBackdropColor: R && !L ? (0, d.C$)(p) : void 0,
            isMobile: b,
            isVR: M,
            statusTooltip: !0,
...
function v(e) {
    ...
    return null == t
        ...
        : (0, i.jsx)(c.s, {
              "aria-label": R.intl.string(R.t["+Xp3hq"]),
              ...d,
              className: s()(u, L.vk),
