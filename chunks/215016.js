...
function L(e, t) {
    var n, r;
    return e > 0 ? '' : null !== (r = null === (n = P[t]) || void 0 === n ? void 0 : n.id) && void 0 !== r ? r : '';
}
function M(e) {
    return e === u.EO.VIDEO;
}
...
class U extends i.PureComponent {
    ...
    render() {
        ...
        return (0, r.jsxs)(f.P3F, {
            ...
            style: N({ backgroundColor: s ? void 0 : a }, i),
    ...
    renderEmptyFavorites() {
        return (0, r.jsx)(f.Ttm, {
            ...
            children: (0, r.jsxs)('div', {
                ...
                children: [this.renderEmptyFavorite(S.NW.string(S.t['3gyw4e']), !0), this.renderEmptyFavorite(S.NW.string(S.t.yThUi4)), this.renderEmptyFavorite(S.NW.string(S.t.MeP0SE)), Array.from({ length: 15 }).map((e, t) => (0, r.jsx)(i.Fragment, { children: this.renderEmptyFavorite() }, t)), this.renderEmptyFavorite(S.NW.string(S.t['5u99XV'])), Array.from({ length: 16 }).map((e, t) => (0, r.jsx)(i.Fragment, { children: this.renderEmptyFavorite() }, t)), this.renderEmptyFavorite(S.NW.string(S.t.o6CLLy))]
            })
        });
    }
    render() {
        ...
        return 0 === e.length && t === n && i !== O.wI2.TRENDING_GIFS
            ? i === O.wI2.FAVORITES
                ...
                : (0, r.jsx)(h.Z, {
                      message: S.NW.string(S.t['5dX4UF']),
                ...
                return null == a
                    ...
                    : (0, r.jsx)(
                          U,
                          {
                              ...
                              renderExtras: () => (0, r.jsx)(v.Z, N({ className: I.favButton }, a)),
                              focused: w(a) === o,
                                  ...
                                  a.length > 0
                                      ? (0, r.jsxs)(i.Fragment, {
                                            children: [
                                                (0, r.jsx)('div', {
                                                    className: I.endText,
                                                    children: S.NW.string(S.t['3JGJo6'])
                                                }),
                                                (0, r.jsx)('div', {
