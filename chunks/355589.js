...
let G = (e) => {
        ...
        return {
            name: F.NW.string(F.t.UgJu1d),
            description: F.NW.string(F.t['3C6/Gx']),
            clickHandler: () => {
    ...
    q = (e) => {
        ...
        return {
            name: F.NW.string(F.t.xiBFCg),
            description: F.NW.string(F.t.wCv4Oz),
            clickHandler: () => {
                U(M.ZI.TAGS),
                    f.ZP.open(e.id),
                    (0, g.ZDy)(async () => {
    ...
    X = (e) => {
        ...
        return {
            name: F.NW.string(F.t.QlyC9v),
            description: F.NW.string(F.t['+50LJi']),
            clickHandler: () => {
    ...
    K = (e, t, a) => ({
        name: F.NW.string(F.t['6A0O6+']),
        description: t
            ? F.NW.string(F.t['8hI5vr'])
            : F.NW.format(F.t.ysxcAw, {
                  onClick: (e) => {
                      null != a &&
                          (e.preventDefault(),
                          e.stopPropagation(),
    ...
    ea = (e) => {
        ...
        return (0, r.jsx)('div', {
            ...
            'aria-label': F.NW.formatToPlainString(F.t.PCs0oq, { numRoles: n.length }),
            children: n.map((e) =>
                (0, r.jsx)(
                    p.UB,
                    {
                        ...
                        null == e ||
                            ...
                            a.addStep(
                                (function (e, t, a, i) {
                                    ...
                                    return {
                                        name: F.NW.string(F.t['/Ax2go']),
                                        description: F.NW.string(F.t.oMIexc),
                                        isDone: o && c,
                                        shouldWarn: o && !c,
                                        children: o
                                            ? (0, r.jsx)(ea, {
    ...
    eo = (e) => {
        ...
        return (0, r.jsx)(g.P3F, {
            ...
            'aria-label': F.NW.string(F.t.WAI6xs),
    ...
    ec = (e) => {
        ...
        return (0, r.jsx)(g.P3F, {
            onClick: n,
            className: L.closeButton,
            'aria-label': t ? F.NW.string(F.t.iTcumZ) : F.NW.string(F.t.dcl9MT),
            children: t
                ? (0, r.jsx)(g.dOc, {
                      size: 'xs',
                      color: 'currentColor',
                                                  ...
                                                  children: (0, r.jsxs)(g.y5t, {
                                                      ...
                                                      children: [
                                                          (0, r.jsx)(g.X6q, {
                                                              ...
                                                              className: L.header,
                                                              children: F.NW.format(F.t['9L+8b2'], {
