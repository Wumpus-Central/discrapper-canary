        ...
        .then(
            (e) =>
                new Promise((t, a) => {
                    ...
                    i.$1(n, (e, n) => {
                        null != e && a(e);
                        let l = Object.keys(n).reduce((e, t) => ({ ...e, [t]: JSON.parse(i.he(n[t])) }), {}),
                            s = l["manifest.json"];
...
function x() {
    ...
    return (0, n.jsx)("div", {
        ...
        children: (0, n.jsxs)(o.B, {
            ...
            children: [
                (0, n.jsx)(d.Z, {
                    options: Object.keys(h).map((e) => ({ id: e, label: e, value: e })),
                    value: e,
                    onSelectionChange: t,
                ...
                (0, n.jsxs)(o.B, {
                    ...
                    children: [
                        (0, n.jsx)(c.k, { value: a.toString(), onChange: (e) => i(Number(e)), label: "Width" }),
                        (0, n.jsx)(c.k, { value: s.toString(), onChange: (e) => x(Number(e)), label: "Height" }),
                    ],
                }),
                (0, n.jsx)(u.$, {
                    size: "sm",
                        ...
                        let t = h[e],
                            a = new Blob(
                                [
                                    JSON.stringify(
                                        e.endsWith(".lottie")
                                            ? await t().then(p).then(r().cloneDeep)
