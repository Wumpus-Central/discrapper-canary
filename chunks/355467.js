...
async function P(e, t) {
    ...
    try {
        let {
            ...
            o = A(t.billingAddress, ['line1', 'line2', 'postalCode']),
            l = await a.tn.patch({
                url: E.ANM.BILLING_PAYMENT_SOURCE(e),
                body: {
...
async function eo(e) {
    let { items: t, paymentSource: n, trialId: r, code: i, currency: o, metadata: u, referralCode: d, loadId: f, expectedInvoicePrice: _, expectedRenewalPrice: g } = e;
    s.Z.dispatch({ type: 'BILLING_SUBSCRIPTION_UPDATE_START' }), (t = (0, h.gB)(t));
    let b = null;
    if (null != n && y.QL.has(n.type)) {
        let e = await eT(n.type);
        b = (0, a.K0)() + E.ANM.BILLING_POPUP_BRIDGE_CALLBACK_REDIRECT_PREFIX(n.type, null != e ? e : '', 'success');
    }
    try {
