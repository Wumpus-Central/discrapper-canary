...
s(c, "fromMilliseconds", (e) => new c(0, 0, 0, e)),
    s(c, "fromSeconds", (e) => new c(0, 0, e)),
    s(c, "fromMinutes", (e) => new c(0, e)),
    s(c, "fromHours", (e) => new c(e));
class u {
    get lastElapsed() {
    ...
    constructor(e = l) {
        s(this, "timestampProducer", void 0),
            s(this, "startTime", void 0),
            s(this, "timePassed", void 0),
