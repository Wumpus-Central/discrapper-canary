...
function lS(e) {
    ...
    return (0, s.jsxs)("div", {
        ...
        children: [
            (0, s.jsxs)("span", {
                className: ef()(l_.VV, { [l_.Ki]: l, [l_.$G]: n >= 100 }),
                children: [
                    l ? (0, s.jsx)(lN.n, { size: "md", color: "currentColor", className: l_.LB }) : null,
                    n.toString().padStart(2, "0"),
                ],
            }),
            (0, s.jsx)("span", {
                className: ef()(l_.X5, { [l_.$G]: t >= 100 }),
...
function lI(e) {
    ...
    return (
        ...
        (0, s.jsx)(lS, { users: l, total: r, videoLimit: a })
    );
}
var lb = n(701665);
function lG(e) {
...
function lj(e) {
    ...
    return a || o
        ? (0, s.jsxs)("div", {
              className: ed.yW,
              children: [
                  a ? (0, s.jsx)(lI, { userCount: n, video: l, channel: t }) : null,
                  o ? (0, s.jsx)(lG, { mentionsCount: i, isMentionLowImportance: r }) : null,
              ],
          })
        : null;
}
function lM(e) {
    let { style: t, withGuildIcon: n, inverted: l } = e,
        i = { className: ef()(lv.GI, { [lv.a7]: n }, { [lv.BJ]: l }), style: t },
        { density: r } = (0, C.wR)();
    switch (r) {
        case "cozy":
            return (0, s.jsxs)("svg", {
...
let ly = r.memo(function (e) {
        let { thread: t, isSelectedChannel: l, isSelectedVoice: i, isLast: a, withGuildIcon: o } = e,
            ...
            h = (0, u.bG)([lA.A], () => lA.A.hasVideo(t.id)),
            {
                unread: A,
                mentionCount: g,
            ...
            f = r.useCallback(
                (e) => {
                    (0, lh.JA)(t, !e.shiftKey, lm.H9.CHANNEL_LIST);
                },
                [t],
            ),
            C = r.useCallback(() => {
                                    ...
                                    children: [
                                        ...
                                        (0, s.jsxs)("div", {
                                            ...
                                            children: [
                                                ...
                                                (0, s.jsx)(lp, { thread: t, tabIndex: _.tabIndex }),
                                            ],
                                        }),
                                    ],
                                }),
...
let lJ = (e) => {
    ...
    null == m || null == p)
        ...
        : (0, s.jsxs)(lH.l, {
              ...
              "aria-labelledby": r,
              children: [
                  (0, s.jsx)("img", { alt: "", className: lX.Sl, src: n(303528) }),
                  (0, s.jsxs)("div", {
                      className: lX.Qs,
                      children: [
                                                        ...
                                                        : d
                                                          ? (0, $.openModalLazy)(
                                                                async () => {
                                                                    ...
                                                                    return (t) =>
                                                                        (0, s.jsx)(e, {
                                                                            reason: lK.d.GUILD_PHONE_REQUIRED,
                                                                            ...t,
                                                                        });
                                                                },
                                                                { modalKey: lq.V },
                                                            ...
                                                            ? (lk.A.verifyResend(),
                                                              (0, lw.A)({
                                                                  ...
                                                                  subtitle: z.intl.format(z.t.azKEPy, {
                                                                      email: lY.default.getCurrentUser()?.email,
                                                                  }),
                                                              }))
                                                            : A && null != g && (0, lz.b)(g, l),
                                                        i();
...
function ii(e) {
    let { locked: t } = e;
    return (0, s.jsx)("div", {
        className: ef()(ed.Xs, il.U),
        children: (0, s.jsx)(it.A, {
            className: ed.gE,
...
function id(e) {
    ...
    if (n.length <= 0) return null;
    {
        if (1 === n.length)
            return (0, s.jsx)("div", {
                className: ef()(io.kL, t, l && io.F4),
                children: (0, s.jsx)(ia.A, { game: n[0].application, className: io.wK }),
            });
        let e = n.length - 1;
        return (0, s.jsxs)("div", {
            className: ef()(io.kL, t, l && io.F4),
            children: [
                (0, s.jsx)(ia.A, { game: n[0].application, className: io.wK }),
                2 === n.length
                    ? (0, s.jsx)(ia.A, { game: n[1].application, className: io.wK })
                    : (0, s.jsx)(N.E, {
                          className: io.ju,
...
function ic(e) {
    let {
        ...
        E = (0, l4.H)(t),
        x = (0, u.bG)([lA.A], () => lA.A.hasVideo(t.id)),
        _ = (0, l3.qT)(t.id) && t.isGuildStageVoice(),
        S = (function (e) {
        ...
        I = (0, u.bG)([is.A], () => is.A.getNewThreadCount(t.guild_id, t.id)),
        b = (0, ie.ed)(t.guild_id, t.id),
        G = (0, u.bG)([tu.A], () => tu.A.getGuild(t.guild_id)?.features.has(F.GuildFeatures.COMMUNITY) ?? !1);
    if (lE(m)) return (0, s.jsx)(lG, { mentionsCount: m, isMentionLowImportance: p });
    if (o) return (0, s.jsx)(ii, { locked: d });
    ...
    let R = i?.length ?? 0;
    return null != r && r && S
        ? (0, s.jsx)(lI, { userCount: R, video: x || _, channel: t })
        : l && (0, ir.t)(i) && G
          ? (0, s.jsx)(U.Lp, { text: z.intl.string(z.t.dI3q4h), color: h.A.unsafe_rawColors.RED_400.css })
          : null != E
            ? (0, s.jsx)(l8.z, { textColor: "text-feedback-positive", entry: { start: E } })
            : null != a && a && f.length > 0
              ? (0, s.jsx)(id, { embeddedApps: f, muted: A })
              : null;
}
var iu = n(582630);
class ih extends n_ {
    ...
    handleClick = () => {
        let { channel: e, locked: t, connected: n, unverifiedAccount: l, isSuggestedSection: i } = this.props,
            s = e.getGuildId();
        null != s && (0, lV.V)(s) && (0, lP.Ze)(s),
            l && this.setState({ shouldShowGuildVerificationPopout: !0 }),
            t || n || e.isRoleSubscriptionTemplatePreviewChannel() || (0, l0.av)(e),
            __OVERLAY__ || (0, lQ.iN)(e.id, i ? { source: l$.A.CHANNEL_LIST_SUGGESTED_SECTION } : void 0);
    };
    handleClickChat = () => {
        let { channel: e, locked: t, isSuggestedSection: n } = this.props;
        __OVERLAY__ || t || (0, lQ.iN)(e.id, n ? { source: l$.A.CHANNEL_LIST_SUGGESTED_SECTION } : void 0);
    };
    handleContextMenu = (e) => {
    ...
    renderVoiceUsers() {
        ...
        return (0, s.jsx)(lR.A, { channel: e, voiceStates: l, collapsed: t, tabIndex: n, numAudience: i });
    }
    renderPopout = () => {
        let { channel: e } = this.props,
        ...
        if (!t)
            return (0, s.jsx)(Q.m, {
                ...
                children: (0, s.jsx)(ee.D, {
                    ...
                    onClick: () => {
                        lU.A.updateChatOpen(e.id, !0), this.handleClickChat();
                    },
                    "aria-label": z.intl.string(z.t.ZXxLQg),
                    children: (0, s.jsx)(I.o, { size: "xs", color: "currentColor", className: ed.gE }),
                }),
    ...
    render() {
        let {
            ...
            E = (0, s.jsxs)("li", {
                ...
                "data-dnd-name": (0, tq.m1)(e, lY.default, l5.A),
                children: [
                    (0, s.jsx)(lT.Y, {
...
function ig(e) {
    ...
    let n,
        ...
        g = (0, u.cf)([eq.A, lW.A, B.A], () => {
            let e = eq.A.getChannel(r.parent_id),
                t = lW.A.getCheck(r.guild_id);
            return {
        ...
        p =
            ...
            (l = (function (e) {
                ...
                return (0, u.cf)([l9.Ay, l2.default], () => {
                    let n = l2.default.getId();
                    return l9.Ay.getPermissionsForUser(n, e, t);
                }, [e, t]);
            })(t, !0).moderator),
            !n && l ? 1 : 0),
        f = (0, u.bG)([ng.A], () => ng.A.getStageInstanceByChannel(r.id), [r.id]),
        C = (0, l1.zy)(r.id, e0.ip.AUDIENCE),
...
function iD(e) {
    let { channel: t } = e,
        l = (0, u.yK)([is.A, nX.Ay, B.A], () => {
            let e = is.A.getActiveJoinedRelevantThreadsForParent(t.guild_id, t.id);
            return o()(is.A.getActiveJoinedThreadsForParent(t.guild_id, t.id))
                .values()
                .map((e) => e.channel)
                .concat(o().values(is.A.getActiveUnjoinedThreadsForParent(t.guild_id, t.id)))
...
function iO(e) {
    let { thread: t } = e,
        n = (0, u.bG)([lY.default], () => lY.default.getUser(t.ownerId)),
        l = (0, iL.JO)(t);
    return (0, s.jsxs)(ee.D, {
        className: iU.nM,
        onClick: (e) => {
            (0, lh.JA)(t, t.isForumPost() ? e.shiftKey : !e.shiftKey, lm.H9.POPOUT);
        },
        children: [
            (0, s.jsx)("div", {
                className: iU.R4,
                children:
                    null == n
                        ...
                        : (0, s.jsx)(iy.A, { className: iU.my, user: n, size: iM._3.SIZE_16 }),
            }),
            (0, s.jsxs)("div", {
                className: iU.Pf,
                children: [
...
function iK(e) {
    let { activity: t, embeddedApp: n, channel: l } = e,
        ...
        r = (0, u.yK)([lY.default], () => i.map((e) => lY.default.getUser(e)).filter(eZ.Vq));
    return (0, s.jsx)("div", {
        className: ik.ec,
        children: (0, s.jsxs)("div", {
            className: ik.Wh,
...
function iY(e) {
    let { channel: t, presenceActivity: n, embeddedApp: l, onAction: i } = e,
        ...
        a = (0, u.bG)([lY.default], () => lY.default.getUser(r[0]));
    return null == a
        ? null
        : (0, s.jsxs)("div", {
              className: iW.Eb,
...
class iQ extends n_ {
    ...
    handleContextMenu = (e) => {
        ...
        if (t.type === F.rbe.DM) {
            let l = lY.default.getUser(t.getRecipientId());
            null != l &&
                (0, eL.L3)(e, async () => {
                    let { default: e } = await Promise.all([
                        n.e("84738"),
        ...
        let {
            ...
            v = (0, s.jsxs)("li", {
                ...
                children: [
                    (0, s.jsx)(lT.Y, {
                        ...
                        children: () =>
                            (0, s.jsxs)(nS.Ay, {
                                ...
                                resolvedUnreadSetting: C,
                                transitionExtras: S ? { source: l$.A.CHANNEL_LIST_SUGGESTED_SECTION } : void 0,
                                "aria-label": (0, lO.Ay)({
                                    channel: e,
                                    unread: i,
                                    mentionCount: o,
                    ...
                    x && (0, s.jsx)(iS.A, { targetElementRef: I, markMenuItemPopoverAsDismissed: N }),
                ],
            });
        return h ? d(c(v)) : v;
    }
...
function i1(e) {
    let { channel: t, guild: n, disableSorting: l, isFavoriteCategory: i, muted: a, selected: o } = e,
        { hasActiveThreads: d, hasMoreActiveThreads: c } = (0, ib.NR)(t),
        h = (0, u.cf)([nX.Ay], () => ({
            unread: nX.Ay.hasUnread(t.id),
        ...
        { showMenuItemPopover: G, markMenuItemPopoverAsDismissed: R } = (0, iI.z)({
...
var i3 = n(900797),
    ...
    i5 =
        ...
        i);
let i6 = { mode: "hidden", mentionCount: 0, targetChannelId: null },
    i4 = { topBar: i6, bottomBar: i6 },
    i8 = {},
    se = {};
function st(e) {
...
function si(e) {
    ...
    return (i8[e] = { topBar: S ? (N ?? i6) : i6, bottomBar: I ? (x ?? i6) : i6 }), !0;
}
...
function sd(e) {
    ...
    let l = tu.A.getGuild(n.guild_id);
    return (
        null != l && !!l.features.has(F.GuildFeatures.COMMUNITY) && e6.A.getGuildId() === n.guild_id && ss(n.guild_id)
    );
}
function sc(e) {
    let { guildId: t } = e;
...
function sH(e) {
    ...
    return (0, s.jsx)("div", {
        ...
        children: (0, s.jsxs)(ee.D, {
            ...
            onClick: l,
            children: [
                (0, s.jsx)(sy.X, { size: "xs", color: "currentColor" }),
                (0, s.jsx)(N.E, {
                    variant: "text-sm/medium",
                    color: "currentColor",
...
class sZ extends n_ {
    ...
    handleClick = () => {
        let { channel: e } = this.props,
            t = e.getGuildId();
        null != t && (0, lV.V)(t) && (0, lP.Ze)(t), this.handleVoiceConnect();
    };
    ...
    renderSubtitle() {
        let { channel: e, connected: t } = this.props,
            n = i_(this.props.subtitle)?.subtitle,
    ...
    renderPopout = () => {
        let { channel: e } = this.props,
            { shouldShowGuildVerificationPopout: t } = this.state;
        return t
            ? (0, s.jsx)(lJ, { type: lZ.VOICE, guildId: e.guild_id, closePopout: this.closeGuildVerificationPopout })
            : null;
    };
    renderOpenChatButton = () => {
        ...
        if (!t)
            return (0, s.jsx)(Q.m, {
                ...
                children: (0, s.jsx)(ee.D, {
                    className: ef()(ed.Xs, n ? ed.Tf : null),
                    onClick: () => {
                        lU.A.updateChatOpen(e.id, !0),
                            (0, lQ.iN)(e.id, l ? { source: l$.A.CHANNEL_LIST_SUGGESTED_SECTION } : void 0);
                    },
                    "aria-label": z.intl.string(z.t.ZXxLQg),
                    children: (0, s.jsx)(I.o, { size: "xs", color: "currentColor", className: ed.gE }),
                }),
...
function s$(e) {
    let {
        ...
        h = (0, u.cf)([eq.A, lW.A, B.A], () => {
            let e = eq.A.getChannel(n.parent_id),
                i = lW.A.getCheck(n.guild_id);
            return {
        ...
        A = (0, u.bG)([lA.A], () => lA.A.hasVideo(n.id)),
        g = (0, l6.Ay)(n),
        m = (0, u.yK)([sF.A, sk.A, l2.default], () => {
            if (null == o || 0 === o.length) return [];
            let e = l2.default.getId(),
                t = [];
            for (let { user: l } of o)
    ...
    renderRow = (e) => {
        ...
        switch (x.type) {
            ...
            case F.rbe.GUILD_STORE:
                return (0, s.jsx)(iC, { channel: x, guild: l, position: C.position, selected: a === C.id }, N);
