...
let nY = r.memo(function (e) {
    ...
    let A = (0, u.bG)([nj.A], () => nj.A.getAnnouncement(t.id)),
        ...
        [m, f] = (0, el.x_)(L.M.GAME_SHOP_NEW_BADGE, t.id, g?.id ?? "", void 0, !0),
    ...
    let [S, I] = (0, el.x_)(L.M.GAME_SHOP_NEW_DROP_POPOVER, t.id, g?.id ?? ""),
    ...
    let G = r.useCallback(() => {
        ...
        R = r.useCallback(() => {
            (0, nL.X)({ guildId: t.id, forceFetch: b });
        }, [t.id, b]),
        v = r.useCallback(() => {
            I(er.i.USER_DISMISS);
        }, [I]),
        ...
        T = r.useMemo(() => {
            ...
            switch (g.type) {
                case "guild-application-announcement": {
                    let e =
                            null != g.assetId
                                ? nF.A.toURLSafe((0, nk.YE)(g.applicationId, g.assetId, 256, "webp"))
                                : void 0,
                        t =
                            null != g.backgroundImageAssetId
                                ? nF.A.toURLSafe((0, nk.YE)(g.applicationId, g.backgroundImageAssetId, 256, "webp"))
                                : void 0;
                    if (null == e) return null;
                    return {
...
function n0(e) {
    let { guild: t, selected: l } = e,
        i = (0, nJ.A)(t),
        a = (0, nX.JZ)(L.M.CHANNEL_BROWSER_NEW_BADGE_NUX),
        o = (0, tl.yK)([n$.A], () =>
            ...
            children: [
                ...
                n &&
                    (0, s.jsx)(ee.D, {
                        ...
                        onClick: function (e) {
                            e.stopPropagation(),
                                (0, nX.Dr)(L.M.SERVER_SHOP_PHANTOM_PREVIEW),
...
function iw(e) {
    let { channel: t } = e,
        ...
        a = t.isForumLikeChannel() ? iL.b : iT.y;
    return (
        r.useEffect(() => {
            (0, iO.TE)();
        }, []),
...
function sR(e) {
    ...
    async function o() {
        await (0, $.openModalLazy)(async () => {
            ...
            (0, nX.Dr)(L.M.GUILD_HEADER_EVENT_UPSELL);
    }
    let d = (0, tg.Ay)(t.id),
    ...
    return u
        ? (0, s.jsx)(ee.D, {
              ...
              children: (0, s.jsx)(N.E, {
                  ...
                  children: (0, s.jsx)(tN.A, { children: s$.A.parseVoiceChannelStatus(o, !0, { channelId: t.id }) }),
              }),
          })
        : n && h && !c && (!A || l)
          ? (0, s.jsxs)(ee.D, {
                ...
                children: [
                    ...
                    (0, s.jsx)(sU.R, { color: "currentColor", className: sQ.rD, size: "xxs" }),
                ],
            })
          : A
        ...
        if (null != s && null != i)
            if (null != s.threadOffset) {
                let [e] = i.getScrollPosition(s.section, s.row),
                    ...
                    a = s.threadOffset * s7(r);
                i.scrollIntoViewRect({ start: e + a, end: e + a + s7(r), padding: n, animate: t, callback: l });
                      ...
                      (0, s.jsxs)(E.B, {
                          ...
                          children: [
                              (0, s.jsx)(x.D, {
                                  ...
                                  children: K.intl.string(s5.default["1n0TGE"]),
                              }),
                              (0, s.jsx)(N.E, {
                                  variant: "text-sm/medium",
                                  color: "text-muted",
                                  children: K.intl.string(s5.default.Wwzrs9),
                              }),
                          ],
                      }),
