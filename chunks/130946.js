...
let C = function (e) {
    let { variant: t } = e,
        n = (0, g.cg)(),
        i = (0, d.Ay)(),
        l = (0, o.Mwr)(i) ? r.XD.BRAND_INVERTED : r.XD.BRAND;
    return n
                      ...
                      (0, s.jsx)(u.Y, {
                          ...
                          children: (0, s.jsxs)("div", {
                              ...
                              children: [
                                  (0, s.jsx)("div", {
                                      className: p.V2,
                                      children: (0, s.jsx)("div", { className: p.N4 }),
                                  }),
                                  (0, s.jsx)("div", {
                                  ...
                                  (0, s.jsx)("div", {
                                      className: p.ZS,
                                      children: (0, s.jsx)("img", { alt: "", src: f.A, className: p.F$ }),
                                  }),
                              ],
                          }),
                      }),
                        ...
                        (0, s.jsx)(u.Y, {
                            ...
                            children: (0, s.jsxs)("div", {
                                ...
                                children: [
                                    ...
                                    (0, s.jsx)("div", {
                                        className: p.m0,
                                        children: (0, s.jsx)("img", { alt: "", src: S.A, className: p.$V }),
                                    }),
                                ],
                            }),
                        }),
                    ...
                    () =>
                        (0, s.jsxs)("div", {
                            ...
                            children: [
                                (0, s.jsx)("div", {
                                    className: p.yk,
                                    children: (0, s.jsx)("img", { alt: "", src: T.A, className: p.$V }),
                                }),
                                (0, s.jsxs)("div", {
                                    className: p.Ep,
                                    children: [
