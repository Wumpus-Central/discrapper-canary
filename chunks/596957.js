...
let k = function (e) {
    let { titleId: t } = e,
        ...
        { rows: l, section: c } = (0, a.cj)([_.ZP], () => _.ZP.getState()),
        w = (0, a.e7)([E.Z], () => E.Z.isFocused()),
        { relationshipCount: k, hasBlockedOrIgnored: M } = (0, a.cj)([b.Z], () => ({
        ...
        V = i.useCallback(
            (e) => {
                ...
                switch (c) {
                    case P.pJs.PENDING:
                        return (0, r.jsx)(v.Z, x(Z({}, n), { isFocused: w }), t);
