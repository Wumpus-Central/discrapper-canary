...
class N extends o.PureComponent {
    ...
    renderIcon() {
        var e, t;
        let n = this.props,
            { guild: r, className: o, showBadge: a, active: l, size: c, style: u = {}, textScale: f, showTooltip: _, tooltipPosition: p, onClick: h, to: E, badgeStrokeColor: y, animate: I, tabIndex: S, iconSrc: T, 'aria-hidden': N, lossless: C, iconSize: P } = n,
