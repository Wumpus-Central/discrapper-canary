...
function j(e) {
    let { channel: t, message: n } = e,
        ...
        _ = t.type === v.d4z.GUILD_ANNOUNCEMENT,
        j = null != b && b.hasFeature(v.oNc.NEWS),
        N = _ && j,
        {
            editingMessage: E,
            editingTextValue: P,
        ...
        Z = i.useCallback(
            (e, n, r) => {
                let { content: i } = r,
                    l = f.Z.can(v.Plq.MANAGE_MESSAGES, t),
                    s = null != E && null != E.author ? E.author.id : null;
                return N && (s === S || l) && null != E && (0, g.yE)(E.flags, v.iLy.CROSSPOSTED) ? a.Z.confirmEdit(e, n, i) : o.Z.editMessage(e, n, { content: i }), Promise.resolve();
            },
            [E, N, S, t]
        ),
        T = i.useCallback(
