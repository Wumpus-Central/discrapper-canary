...
let j = (e) => {
    ...
    let { isLoading: r, title: i, sortedSkuIds: j, numVisibleItems: P, hasSorting: T, tab: L } = e,
        ...
        H = !F && M,
        { animationPhase: W, startAnimation: V } = (0, C.y)(),
        U = (0, b.sp)(),
        G = null != (t = null == U ? void 0 : U.sessionId) ? t : '',
        z = l.useRef(null),
        q = l.useCallback(
            (e) => {
                (V({
                                        ...
                                        (0, n.jsx)(s.zxk, {
                                            ...
                                            onClick: () => {
                                                (V({
                                                    ...
                                                    f.default.track(S.rMx.COLLECTIBLES_SHOP_FEED_SHUFFLE_CLICKED, { page_session_id: G }));
                                            },
                  ...
                  (0, n.jsx)('div', {
                      ...
                      children: r
                          ...
                          : D.slice(0, P).map((e, t) => {
                                ...
                                if (H)
                                    if (W === C.g.SHUFFLE_OUT) return (0, n.jsx)('div', { className: x.shuffleOutro }, ''.concat(e.skuId, '-').concat(t));
