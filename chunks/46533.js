    ...
    render() {
        ...
        return (0, i.jsxs)("nav", {
            ...
            children: [
                ...
                null != e &&
                    (0, i.jsx)(er.A, { guild: e, setHasSubheader: (e) => this.setState({ hasGuildSubheader: e }) }),
...
function ep(e) {
    let { guildId: t, hideSelectedChannel: n, selectedChannelId: r } = e,
        ...
        [et, en] = a.useState(!q),
        ei = (0, _.A)(t),
        { analyticsLocations: ea } = (0, p.Ay)(m.A.GUILD_HEADER);
    a.useEffect(() => {
        t !== ei && en(!q);
    }, [t, ei, q]);
    let [er, es] = (0, E.Ay)(
        ...
        eT = (0, s.bG)([Y.A], () => Y.A.getChannel(r)),
