...
class T {
    loadServer() {
        for (let e of (_.isPlatformEmbedded && this.registerTransportsForEmbeddedPlatform(), this.transports))
            ...
            N(this, "handleActivityMessage", (e) => {
                ...
                let s =
                    l.type === v.mFx.JOIN_REQUEST
                        ? u.Z.getApplicationActivity(o.id, i.id)
                        : u.Z.getApplicationActivity(a.id, i.id);
