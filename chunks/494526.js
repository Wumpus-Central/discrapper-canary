        ...
        case 1:
            return (0, r.jsxs)(r.Fragment, {
                children: [
                    ...
                    null != i ? (0, r.jsx)(T, { children: i }) : (0, r.jsx)(p.DK, { children: S.intl.format(S.t['Qq+A6u'], {}) }),
                    (0, r.jsx)(c.zxk, {
                        size: c.PhG.LARGE,
                        look: c.iLD.LINK,
                        color: c.Ttl.LINK,
                        ...
                        onClick: () =>
                            (function (e) {
                                let t =
                                    b.isPlatformEmbedded && j.ZP.supportsFeature(I.eRX.WEBAUTHN)
            ...
            return (
                ...
                i.useEffect(() => {
                    ...
                    return (
                        ...
                        (i.onopen = async () => {
                            (s = await (0, E.W_)()), (o = await (0, E.dK)(s));
