...
function H(e) {
    let { streamKey: t } = e,
        n = (0, _.Iy)(t);
    r.delete(t),
        r.set(t, D(w({}, n), { state: C.XYD.CONNECTING })),
...
function X(e) {
    ...
    r.set(t, D(w({}, (0, _.Iy)(t)), { state: s ? C.XYD.PAUSED : C.XYD.ACTIVE })),
        (a[t] = {
            streamKey: t,
            region: n,
            viewerIds: i,
...
function $(e) {
    ...
    r.set(t, D(w({}, o), { state: l })), l === C.XYD.ENDED && x !== t && G(t);
}
function J(e) {
    let { streamKey: t } = e,
        n = r.get(t);
    if (null == n) return !1;
    r.set(t, D(w({}, n), { state: C.XYD.FAILED }));
}
function ee(e) {
