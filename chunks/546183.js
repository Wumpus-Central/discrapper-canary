...
let d = new Map(),
    ...
    E = 0;
function m() {
    h = (_ = [...d.values()]).filter((e) => {
        let { application: t } = e;
        return null == t.parent_id;
    });
}
function g(e, t) {
    if (null == t) (f = e), p.clear(), (E += 1);
    else {
...
let I = new A(s.h, {
    ...
    OAUTH2_TOKEN_CREATE: function (e) {
        ...
        d.set(n.id, { id: t, application: n, scopes: i }), m();
    },
    OAUTH2_TOKEN_DELETE: function (e) {
        let { id: t, applicationId: n } = e,
            i = d.get(n);
        if (null == i || i.id !== t) return !1;
        d.delete(i.application.id), m();
    },
    LOGOUT: function () {
        (d = new Map()), (_ = []), (h = []), (f = "NOT_FETCHED"), p.clear(), (E += 1);
    },
});
