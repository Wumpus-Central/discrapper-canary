...
function es(e) {
    let {
        ...
        { isHoveringOrFocusing: eg, isHovering: ev } = (0, p.Z)(ex);
    r.useEffect(() => {
    ...
    let ej = (0, s.e7)([B.Z], () => B.Z.getStatus(t.id)),
        ...
        eT = (0, J.I)(ej),
        eO = (0, K.g)(n),
        eN = (0, v.Z)({ analyticsLocations: eh }),
        eP = (0, H.I5)(t),
    ...
    let eL = (e) => {
        ...
        eq = (0, _.k)({ location: "UserProfileAccountPopout" }),
        eY = (0, C.S)({ location: "UserProfileAccountPopout" });
    return (0, a.jsx)(m.Gt, {
        value: eh,
