        ...
        h = s.useCallback(
            (e) => {
                null != c && n5.A.remove(t.id, c.id, n3.oU.CREATE_FORUM_POST.drafts.type),
                    (0, lr.R)(e.currentTarget.files, t, n3.oU.CREATE_FORUM_POST.drafts.type, {
                        requireConfirm: !0,
                        isThumbnail: !0,
                        origin: "file_picker",
                    }),
...
function it(e) {
    ...
    return (0, i.jsx)(l7.p, {
        ...
        children: (e) =>
            r.filter((t) => l3()(e.toLowerCase(), t.name.toLowerCase())).map((e) => (0, i.jsx)(ie, { tag: e }, e.id)),
    });
}
var il = n(376310),
    ii = n(291747),
...
var id = n(746080),
    iu = n(883351);
let im = n3.oU.CREATE_FORUM_POST;
function ih(e) {
    var t, n;
    let l,
        a,
            ...
            children: [
                ...
                (0, i.jsxs)("div", {
                    ...
                    children: [
                        ...
                        (0, i.jsx)(n8.A, { type: im, className: iu.n1, onClick: f, channel: t }, "expression"),
                    ],
                }),
                h &&
                    (0, i.jsx)(b.E, {
...
function i5(e) {
    ...
    let T = (0, ev.Mw)(n, iI.T.CREATION_DATE, nk.EG.POSTED_DURATION_AGO),
        { shouldRenderTagsRow: I } = (0, eE.BA)({ channel: n, isNew: !1 }),
        { onFocus: _, ...M } = iW({ id: t, row: o.row, column: o.column, section: o.section, boundaries: c }),
        R = p?.nick ?? v?.username ?? "",
...
function sl(e) {
    ...
    let M = (0, ev.Mw)(n, iI.T.CREATION_DATE, nk.EG.POSTED_DURATION_AGO),
        R = (0, nn.hf)(n),
        { onFocus: k, ...w } = iW({ id: t, row: d.row, column: d.column, section: d.section, boundaries: u });
    return (0, i.jsxs)("li", {
        ref: x,
        onClick: I,
        onFocus: k,
...
function sa(e) {
    let { channel: t, firstMessage: n, isFirstMessageLoaded: l, overrideMedia: s, coords: a } = e,
        ...
        x = (0, eA.no)(n, r, !1),
        f = t.isMediaPost(),
        [j, v] = i6(a.width - 24, f ? i8.SIXTEEN_BY_NINE : i8.THREE_BY_TWO);
        ...
        eU = s.useCallback(
            (e, n, l) =>
                0 === e
                    ...
                    : t.isGameInvitesChannel()
                      ? 280
                      : i9(l, t.isMediaChannel() ? i8.SIXTEEN_BY_NINE : i8.THREE_BY_TWO),
            [t],
        ),
