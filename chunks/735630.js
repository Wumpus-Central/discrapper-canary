...
(a.prototype = {}),
    ...
    (a.prototype.writeType = function (t, e, i) {
        ...
        var s,
            ...
            o = this.position;
        switch (
            ("string" == typeof t && /:/.test(t) && ((t = (s = t.split(":"))[0]), (r = parseInt(s[1]))),
            "string" == typeof t && /,/.test(t) && ((t = (s = t.split(","))[0]), (n = parseInt(s[1]))),
            t)
        ) {
            case "uint8":
                this.writeUint8(e);
            ...
            (this.buffers.length > 0
                ? 0 === (t = this.buffers[0]).fileStart
                    ...
                    : (r.warn("MultiBufferStream", "The first buffer should have a fileStart of 0"),
                      this.logBufferLevel(),
                      !1)
                : (r.warn("MultiBufferStream", "No buffer to start parsing from"), this.logBufferLevel(), !1))
        );
    }),
    ...
    (o.prototype.cleanBuffers = function () {
        ...
        for (t = 0; t < this.buffers.length; t++)
            (e = this.buffers[t]).usedBytes === e.byteLength &&
                (r.debug("MultiBufferStream", "Removing buffer #" + t), this.buffers.splice(t, 1), t--);
    }),
    (o.prototype.mergeNextBuffer = function () {
        if (
            !(this.bufferIndex + 1 < this.buffers.length) ||
            (t = this.buffers[this.bufferIndex + 1]).fileStart !== this.buffer.fileStart + this.buffer.byteLength
        )
            return !1;
        var t,
    ...
    (o.prototype.findPosition = function (t, e, i) {
        ...
        return -1 === a
            ...
            : (n = this.buffers[a]).fileStart + n.byteLength >= e
              ? (r.debug("MultiBufferStream", "Found position in existing buffer #" + a), a)
              : -1;
    }),
    ...
    (o.prototype.seek = function (t, e, i) {
        ...
        return -1 !== (s = this.findPosition(e, t, i))
            ? ((this.buffer = this.buffers[s]),
              ...
              !0)
            : (r.debug("MultiBufferStream", "Position " + t + " not found in buffered data"), !1);
    }),
        ...
        (this.parseOneDescriptor = function (e) {
            ...
            return (
                ...
                r.debug(
                    ...
                    "Found " + (t[s] || "Descriptor " + s) + ", size " + h + " at position " + e.getPosition(),
                ),
...
d.initialize(),
    ...
    (d.parseOneBox = function (t, e, i) {
        ...
        var p = t.readUint32(),
            ...
            f = l;
        if (
            (r.debug("BoxParser", "Found box of type '" + l + "' and size " + p + " at position " + o),
            (h = 8),
            "uuid" == l)
        ) {
    ...
    (d.ContainerBox.prototype.parse = function (t) {
        for (; t.getPosition() < this.start + this.size; ) {
            ...
            if (((i = e.box), this.boxes.push(i), this.subBoxNames && -1 != this.subBoxNames.indexOf(i.type)))
    ...
    d.createBoxCtor("a1lx", function (t) {
        ...
        this.layer_size = [];
        for (var i = 0; i < 3; i++)
            16 == e ? (this.layer_size[i] = t.readUint16()) : (this.layer_size[i] = t.readUint32());
    }),
    ...
    d.createBoxCtor("av1C", function (t) {
        ...
        if (((this.version = 127 & e), 1 !== this.version))
            return void r.error("av1C version " + this.version + " not supported");
        if (
            ((e = t.readUint8()),
            ...
            return void r.error("av1C reserved_1 parsing problem");
    ...
    d.createBoxCtor("colr", function (t) {
        if (((this.colour_type = t.readString(4)), "nclx" === this.colour_type)) {
            ...
            "rICC" === this.colour_type
                ...
                : "prof" === this.colour_type && (this.ICC_profile = t.readUint8Array(this.size - 4));
    }),
    ...
    d.createFullBoxCtor("elst", function (t) {
        ...
        for (var e = t.readUint32(), i = 0; i < e; i++) {
            ...
            this.entries.push(s),
                1 === this.version
                    ? ((s.segment_duration = t.readUint64()), (s.media_time = t.readInt64()))
                    : ((s.segment_duration = t.readUint32()), (s.media_time = t.readInt32())),
    ...
    d.createFullBoxCtor("iref", function (t) {
        ...
        for (this.references = []; t.getPosition() < this.start + this.size; ) {
            ...
            (i =
                0 === this.version
                    ? new d.SingleItemTypeReferenceBox(e.type, e.size, e.hdr_size, e.start)
                    : new d.SingleItemTypeReferenceBoxLarge(e.type, e.size, e.hdr_size, e.start)).write ===
                d.Box.prototype.write &&
                "mdat" !== i.type &&
                (r.warn(
                    "BoxParser",
                    i.type + " box writing not yet implemented, keeping unparsed data in memory for later write",
                ),
    ...
    d.createFullBoxCtor("pixi", function (t) {
        var e;
        for (e = 0, this.num_channels = t.readUint8(), this.bits_per_channels = []; e < this.num_channels; e++)
    ...
    d.createSampleGroupCtor("alst", function (t) {
        var e,
            i = t.readUint16();
        for (e = 0, this.first_output_sample = t.readUint16(), this.sample_offset = []; e < i; e++)
            this.sample_offset[e] = t.readUint32();
        var s = this.description_length - 4 - 4 * i;
        for (e = 0, this.num_output_samples = [], this.num_total_samples = []; e < s / 4; e++)
    ...
    d.createSampleGroupCtor("seig", function (t) {
        ...
        (this.crypt_byte_block = e >> 4),
            ...
            1 === this.isProtected &&
                ...
                ((this.constant_IV_size = t.readUint8()), (this.constant_IV = t.readUint8Array(this.constant_IV_size)));
    }),
    ...
    d.createFullBoxCtor("sidx", function (t) {
        (this.reference_ID = t.readUint32()),
            ...
            0 === this.version
                ...
                : ((this.earliest_presentation_time = t.readUint64()), (this.first_offset = t.readUint64())),
            t.readUint16(),
            (this.references = []);
    ...
    d.createFullBoxCtor("stsd", function (t) {
        ...
        for (e = 1, this.entries = [], s = t.readUint32(); e <= s; e++) {
            ...
            d[i.type + "SampleEntry"]
                ? (((n = new d[i.type + "SampleEntry"](i.size)).hdr_size = i.hdr_size), (n.start = i.start))
    ...
    d.createFullBoxCtor("stsz", function (t) {
        ...
        if (((this.sample_sizes = []), 0 === this.version))
            for (
                e = 0, this.sample_size = t.readUint32(), this.sample_count = t.readUint32();
                e < this.sample_count;
                e++
            )
                0 === this.sample_size
    ...
    d.createFullBoxCtor("tfhd", function (t) {
        ...
        (this.track_id = t.readUint32()),
            this.size - this.hdr_size > e && this.flags & d.TFHD_FLAG_BASE_DATA_OFFSET
    ...
    (d.trefBox.prototype.parse = function (t) {
        for (var e, i; t.getPosition() < this.start + this.size; ) {
            if ((e = d.parseOneBox(t, !0, this.size - (t.getPosition() - this.start))).code !== d.OK) return;
            (i = new d.TrackReferenceTypeBox(e.type, e.size, e.hdr_size, e.start)).write === d.Box.prototype.write &&
                "mdat" !== i.type &&
                (r.info(
                    "BoxParser",
                    "TrackReference " +
    ...
    d.createFullBoxCtor("trun", function (t) {
        ...
        if (
            ...
            for (var i = 0; i < this.sample_count; i++)
                this.flags & d.TRUN_FLAGS_DURATION && (this.sample_duration[i] = t.readUint32()),
                    this.flags & d.TRUN_FLAGS_SIZE && (this.sample_size[i] = t.readUint32()),
                    this.flags & d.TRUN_FLAGS_FLAGS && (this.sample_flags[i] = t.readUint32()),
    ...
    d.createFullBoxCtor("vvcC", function (t) {
        ...
        if (
            ...
            for (
                s.stream_read_1_bytes(t), this.ptl_sublayer_present_mask = 0, i = this.num_sublayers - 2;
                i >= 0;
                --i
            ) {
            ...
            if (this.hvcC) {
                ...
                for (t = 5; t >= 0; t--)
                    (this.hvcC.general_constraint_indicator[t] || r) &&
                        ((n = "." + d.decimalToHex(this.hvcC.general_constraint_indicator[t], 0) + n), (r = !0));
                e += n;
            }
            return e;
        }),
    ...
    (d.FullBox.prototype.writeHeader = function (t) {
        (this.size += 4),
            d.Box.prototype.writeHeader.call(this, t, " v=" + this.version + " f=" + this.flags),
    ...
    (d.stppSampleEntry.prototype.write = function (t) {
        this.writeHeader(t),
            (this.size +=
                this.namespace.length + 1 + this.schema_location.length + 1 + this.auxiliary_mime_types.length + 1),
    ...
    (d.sgpdBox.prototype.write = function (t) {
        var e, i;
        for (e = 0, this.flags = 0, this.size = 12; e < this.entries.length; e++)
            (i = this.entries[e]),
    ...
    (d.tfhdBox.prototype.write = function (t) {
        (this.version = 0),
            ...
            this.flags & d.TFHD_FLAG_BASE_DATA_OFFSET && t.writeUint64(this.base_data_offset),
            this.flags & d.TFHD_FLAG_SAMPLE_DESC && t.writeUint32(this.default_sample_description_index),
            this.flags & d.TFHD_FLAG_SAMPLE_DUR && t.writeUint32(this.default_sample_duration),
            this.flags & d.TFHD_FLAG_SAMPLE_SIZE && t.writeUint32(this.default_sample_size),
            this.flags & d.TFHD_FLAG_SAMPLE_FLAGS && t.writeUint32(this.default_sample_flags);
    }),
    ...
    (d.trunBox.prototype.write = function (t) {
        (this.version = 0),
            ...
            this.flags & d.TRUN_FLAGS_DURATION && (this.size += 4 * this.sample_duration.length),
            this.flags & d.TRUN_FLAGS_SIZE && (this.size += 4 * this.sample_size.length),
            this.flags & d.TRUN_FLAGS_FLAGS && (this.size += 4 * this.sample_flags.length),
            this.flags & d.TRUN_FLAGS_CTS_OFFSET && (this.size += 4 * this.sample_composition_time_offset.length),
            this.writeHeader(t),
            ...
            this.flags & d.TRUN_FLAGS_FIRST_FLAG && t.writeUint32(this.first_sample_flags);
        for (var e = 0; e < this.sample_count; e++)
            this.flags & d.TRUN_FLAGS_DURATION && t.writeUint32(this.sample_duration[e]),
                this.flags & d.TRUN_FLAGS_SIZE && t.writeUint32(this.sample_size[e]),
                this.flags & d.TRUN_FLAGS_FLAGS && t.writeUint32(this.sample_flags[e]),
                this.flags & d.TRUN_FLAGS_CTS_OFFSET &&
                    (0 === this.version
    ...
    (d.sttsBox.prototype.unpack = function (t) {
        ...
        for (e = 0, s = 0; e < this.sample_counts.length; e++)
            for (i = 0; i < this.sample_counts[e]; i++)
                0 === s ? (t[s].dts = 0) : (t[s].dts = t[s - 1].dts + this.sample_deltas[e]), s++;
    }),
...
(u.prototype.setSegmentOptions = function (t, e, i) {
            ...
            for (;;)
                if (this.hasIncompleteMdat && this.hasIncompleteMdat())
                    ...
                    if (
                        ...
                        (t = d.parseOneBox(this.stream, !1)).code === d.ERR_NOT_ENOUGH_DATA)
                    )
                    ...
                    switch (((i = "uuid" !== (e = t.box).type ? e.type : e.uuid), this.boxes.push(e), i)) {
                        ...
                        default:
                            void 0 !== this[i] &&
                                r.warn("ISOFile", "Duplicate Box of type: " + i + ", overriding previous occurrence"),
                                (this[i] = e);
                    }
    ...
    (u.prototype.checkBuffer = function (t) {
        ...
        return 0 === t.byteLength
            ...
            : (r.info("ISOFile", "Processing buffer (fileStart: " + t.fileStart + ")"),
              ...
              this.stream.logBufferLevel(),
              !!this.stream.initialized() || (r.warn("ISOFile", "Not ready to start parsing"), !1));
    }),
    ...
    (u.prototype.processIncompleteMdat = function () {
        var t;
        return ((t = this.parsingMdat), this.stream.seek(t.start + t.size, !1, this.discardMdatData))
            ? (r.debug("ISOFile", "Found 'mdat' end in buffered data"), (this.parsingMdat = null), !0)
    ...
    (u.prototype.resetTables = function () {
        for (
            t = 0, this.initial_duration = this.moov.mvhd.duration, this.moov.mvhd.duration = 0;
            t < this.moov.traks.length;
            t++
        ) {
    ...
    (u.initSampleGroups = function (t, e, i, s, r) {
        ...
        for (
            e && (e.sample_groups_info = []), t.sample_groups_info || (t.sample_groups_info = []), a = 0;
            a < i.length;
            a++
        ) {
            for (
            ...
            if (r)
                for (n = 0; n < r.length; n++)
                    r[n].grouping_type === i[a].grouping_type &&
                        ((o.fragment_description = r[n]), (o.fragment_description.used = !0), (o.is_fragment = !0));
        }
        if (e) {
            if (r)
            ...
            (e.sample_groups[r] = {}),
                ...
                i >= s[r].last_sample_in_run &&
                    ...
                    s[r].entry_index <= s[r].sbgp.entries.length - 1 &&
                        (s[r].last_sample_in_run += s[r].sbgp.entries[s[r].entry_index].sample_count)),
                s[r].entry_index <= s[r].sbgp.entries.length - 1
                ...
                0 !== e.sample_groups[r].group_description_index &&
                    ...
                    e.sample_groups[r].group_description_index > 0
                        ...
                        : a &&
                          ...
                          (e.sample_groups[r].description = a.entries[a.default_group_description_index - 1]));
    }),
                ...
                (B.number = e),
                    ...
                    0 === e
                        ? ((_ = 0),
                          ...
                          (g = 0),
                          (m = _ + 1 < s.first_chunk.length ? s.first_chunk[_ + 1] - 1 : 1 / 0))
                        : e < y
                          ? ((B.chunk_index = c), (B.chunk_run_index = _))
                          : ((B.chunk_index = ++c),
                            (g = 0),
                            c <= m || (m = ++_ + 1 < s.first_chunk.length ? s.first_chunk[_ + 1] - 1 : 1 / 0),
                            (B.chunk_run_index = _),
                            (y += s.samples_per_chunk[_])),
                    ...
                    o
                        ? (e == o.sample_numbers[x] - 1
                          ...
                          d &&
                              ...
                              ((B.subsamples = d.entries[w].subsamples), (E += d.entries[w].sample_delta), w++))
                        : (B.is_sync = !0),
                    u.process_sdtp(t.mdia.minf.stbl.sdtp, B, B.number),
                    f ? (B.degradation_priority = f.priority[e]) : (B.degradation_priority = 0),
                    d &&
                        d.entries[w].sample_delta + E == e &&
                        ((B.subsamples = d.entries[w].subsamples), (E += d.entries[w].sample_delta)),
                    (p.length > 0 || l.length > 0) && u.setSampleGroupProperties(t, B, e, t.sample_groups_info);
            }
            e > 0 &&
                    ...
                    for (t = 0; t < h.trafs.length; t++) {
                        for (
                            p = h.trafs[t],
                                ...
                                p.sample_number = 0,
                                p.sbgps.length > 0 &&
                                    u.initSampleGroups(l, p, p.sbgps, l.mdia.minf.stbl.sgpds, p.sgpds),
                                e = 0;
                            e < p.truns.length;
                            e++
                        ) {
                            ...
                            for (i = 0; i < m.sample_count; i++) {
                                ((_ = {}).moof_number = this.lastMoofIndex),
                                    (_.number_in_traf = p.sample_number),
                                    p.sample_number++,
                                    (_.number = l.samples.length),
                                    (p.first_sample_index = l.samples.length),
                                    l.samples.push(_),
                                    (_.track_id = l.tkhd.track_id),
                                    (_.timescale = l.mdia.mdhd.timescale),
                                    (_.description_index = s - 1),
                                    (_.description = l.mdia.minf.stbl.stsd.entries[_.description_index]),
                                    (_.size = n),
                                    m.flags & d.TRUN_FLAGS_SIZE && (_.size = m.sample_size[i]),
                                    (l.samples_size += _.size),
                                    (_.duration = r),
                                    m.flags & d.TRUN_FLAGS_DURATION && (_.duration = m.sample_duration[i]),
                                    (l.samples_duration += _.duration),
                                    l.first_traf_merged || i > 0
                                        ? (_.dts =
                                              l.samples[l.samples.length - 2].dts +
                                              l.samples[l.samples.length - 2].duration)
                                        : (p.tfdt ? (_.dts = p.tfdt.baseMediaDecodeTime) : (_.dts = 0),
                                          (l.first_traf_merged = !0)),
                                    (_.cts = _.dts),
                                    m.flags & d.TRUN_FLAGS_CTS_OFFSET &&
                                        (_.cts = _.dts + m.sample_composition_time_offset[i]),
                                    (c = a),
                                    m.flags & d.TRUN_FLAGS_FLAGS
                                        ? (c = m.sample_flags[i])
                                        : 0 === i && m.flags & d.TRUN_FLAGS_FIRST_FLAG && (c = m.first_sample_flags),
                                    (_.is_sync = !((c >> 16) & 1)),
                                    (_.is_leading = (c >> 26) & 3),
                                    (_.depends_on = (c >> 24) & 3),
                                    (_.is_depended_on = (c >> 22) & 3),
                                    (_.has_redundancy = (c >> 20) & 3),
                                    (_.degradation_priority = 65535 & c);
                                var g = !!(p.tfhd.flags & d.TFHD_FLAG_BASE_DATA_OFFSET),
                                    ...
                                    b = 0;
                                (b = g ? p.tfhd.base_data_offset : y || 0 === e ? h.start : o),
                                    0 === e && 0 === i
                                        ? U
                                            ? (_.offset = b + m.data_offset)
                                            : (_.offset = b)
                                        : (_.offset = o),
                                    (o = _.offset + _.size),
                                    (p.sbgps.length > 0 ||
                                        ...
                                        u.setSampleGroupProperties(l, _, _.number_in_traf, p.sample_groups_info);
                            }
                        }
                        if (p.subs) {
                            ...
                            for (e = 0; e < p.subs.entries.length; e++)
                                (S += p.subs.entries[e].sample_delta),
                                    ((_ = l.samples[S - 1]).subsamples = p.subs.entries[e].subsamples);
                        }
                    }
        }
    }),
        ...
        if (null != n && void 0 !== n.hdlr && void 0 !== n.iinf) {
            for (t = 0; t < n.iinf.item_infos.length; t++)
                ((i = {}).id = n.iinf.item_infos[t].item_ID),
                    ...
                    n.iinf.item_infos[t].protection_index > 0 &&
                        (i.protection = n.ipro.protections[n.iinf.item_infos[t].protection_index - 1]),
            ...
            if (n.iloc)
                for (t = 0; t < n.iloc.items.length; t++) {
                    ...
                    for (e = 0, i.extents = [], i.size = 0; e < a.extents.length; e++)
                        (i.extents[e] = {}),
            ...
            if (n.iprp)
                for (var h = 0; h < n.iprp.ipmas.length; h++) {
                    ...
                    for (t = 0; t < d.associations.length; t++) {
                        ...
                        for (
                            void 0 === (i = s[p.id]).properties && ((i.properties = {}), (i.properties.boxes = [])),
                                e = 0;
                            e < p.props.length;
                            e++
                        ) {
    ...
    (u.prototype.createFragment = function (t, e, i) {
        ...
        if (null == n)
            return (
                (n = s.samples[e]),
                this.nextSeekPosition
                    ? (this.nextSeekPosition = Math.min(n.offset + n.alreadyRead, this.nextSeekPosition))
