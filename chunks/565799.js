...
function x(e) {
    let t = w[e];
    return (null == t && ((t = new v.ZP(e)), (w[e] = t), t.rebuild()), t);
}
function k(e) {
...
function G(e) {
    for (let t of N.values(e)) (N.delete(t.id), delete w[t.id]);
    C.delete(e);
}
function B(e) {
    return null != e && (delete w[e], N.delete(e), !0);
}
function Z() {
    (C.clear(), N.clear(), (w = {}));
}
...
function J(e) {
    let { guildId: t } = e;
    if (C.has(t)) return M((e) => e.rebuild(), P(t));
}
let ee = [];
