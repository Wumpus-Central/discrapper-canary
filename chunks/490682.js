...
function o(e, t, n) {
    ...
    let [o, l] = t;
    if (1 !== l.length || !i.AS.isInTypes(o, a)) return s;
    ...
    for (let t = 0; t < u.length; t++) {
        ...
        if (n.attributes.length > 0 && n.text.length > 0) {
            ...
            for (let e of n.attributes)
                if (((f[e] = !0), "syntaxBefore" === e && null != s)) for (let e of s.attributes) f[`before_${e}`] = !0;
                else if ("syntaxAfter" === e && null != a) for (let e of a.attributes) f[`after_${e}`] = !0;
            for (let [t, n] of _) {
