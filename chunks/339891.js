...
function tQ(e) {
    let { guild: t, outline: n } = e,
        ...
        l = tI.iu[i],
        s = tI.s[i],
        r = o.useMemo(() => e6.Ay.getGuildIconURL({ id: t.id, icon: t.icon, size: l }), [t.icon, t.id, l]),
        c = (0, tH.Rb)(t),
        d =
            null != r
...
let t3 = { 1: tX._r, 2: tX.Gm, 0: tX.Kt };
function t8(e) {
    let t,
        { invite: n } = e,
        i = t0(n),
    ...
    return (0, a.jsx)(t2, { startAnimHeightPx: 200, sectionClassName: t3[i], inviteCardClassName: h, children: t });
}
function t4(e) {
    let { invite: t, onAcceptInvite: n } = e,
        { guild: i } = t ?? {},
...
function nt(e) {
    ...
    return n
        ? (0, a.jsxs)("div", {
              className: t6.MY,
              children: [
                  (0, a.jsx)("div", { className: t6.r$, children: (0, a.jsx)("img", { src: ne, alt: "" }) }),
                  (0, a.jsxs)("div", {
                      className: t6.Qs,
                      children: [
                          (0, a.jsx)(t9, { alt: "" }),
...
var nJ = n(110782),
    ...
    it = n(788868),
    ii = n(539205);
let il = m.Ay.connectStores([n7.A, n8.A, n6.A, n9.default], (e) => {
    let { giftCode: t } = e,
        n = n7.A.get(t.skuId),
    ...
    return (
        ...
        (0, a.jsxs)(o.Fragment, {
            children: [
                null != n.giftStyle
                    ? (0, a.jsx)(n5.A, { defaultAnimationState: n4.oA.LOOP, giftStyle: n.giftStyle, className: ii.e })
                    : (0, a.jsx)(k.eu, {
...
var i8 = n(493527),
    i4 = n(544395),
    i5 = n(446837);
let i9 = window.ResizeObserver ?? i5.t;
function i6(e) {
...
function lE(e) {
    ...
    return (
        ...
        (0, a.jsx)(i6, { show: (c && o?.type === lp.q.ERROR) || s, top: -12, bottom: 20, children: t })
    );
}
function l_(e) {
    let {
        ...
        [g, x] = o.useState(!1);
    async function f() {
        T.length > 0 && !i4.A.wasRegistrationSuggestionFetched(T) && (await i8.A.fetchSuggestionsRegistration(T));
    }
    function p(e) {
    ...
    let E = (0, m.bG)([le.A], () => le.A.getAuthenticationConsentRequired()),
        _ = (0, m.bG)([i4.A], () => i4.A.registrationUsernameSuggestion()),
        j = o.useRef(null),
        N = o.useRef(null),
        I = o.useRef(null),
        v = o.useRef(null),
...
let lw = m.Ay.connectStores([nR.A, n2.A, ez.default, n7.A, eu.A, n0.A], (e) => {
    ...
    return {
        giftCode: n,
        sku: i,
        libraryApplication: null != i && n?.entitlementBranches != null ? n3.YI(n.entitlementBranches, i, n2.A) : null,
...
let sl = nH(iK),
    ss = nH(function (e) {
        let t = o.useCallback(
                (t) => {
                    let n;
                    ((n = (0, l6.B)(t, { path: b.BVt.CHANNEL(nl.pv.guildId(), nl.pv.channelId()) })),
    ...
    sr = nH(function (e) {
        ...
        return v === b.elq.RESOLVED || v === b.elq.ERROR
            ? (0, a.jsx)(l3, { invite: r, inviteKey: t, handleAccept: j, handleDefaultTransition: N })
            : null;
    }),
    sa = nH(function (e) {
        let t = {
...
let sS = m.Ay.connectStores([ez.default, e9.A, nR.A, ev.A, eC.A], (e) => {
    let { match: t, location: n } = e,
