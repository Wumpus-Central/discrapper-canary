...
class eU extends h.Ay.Store {
    ...
    getState() {
        return { verifySuccess: ek, verifyErrors: eG, redirectGuildId: ew };
    }
}
let eM = new eU(g.h, {
...
function tV(e) {
    let { guild: t, invite: n, discoveryGuild: l, showGuildTag: i = !1, highContrast: s = !1, hideEnglish: r = !1 } = e,
        ...
        c = n.approximate_member_count ?? 0,
        d = (0, h.bG)([tU.default], () => tU.default.locale),
        m = (0, tk.P)(tM.default.extractTimestamp(t.id), d),
        g = (0, h.bG)([tP.A], () =>
            l?.primary_category_id != null ? tP.A.getCategoryName(l.primary_category_id) : null,
        ),
        f = t.premiumTier ?? b.TVA.NONE,
        x = f !== b.TVA.NONE,
        p = t.preferredLocale ?? l?.preferred_locale ?? null,
        A = o.useMemo(() => {
            if ("en-US" === p) return K.intl.string(K.t.LQLMGP);
            let e = (0, K.getAvailableLocales)().find((e) => e.value === p);
            return null != e ? K.intl.string(e.localizedName) : p;
        }, [p]),
    ...
    return (0, a.jsxs)("div", {
        ...
        children: [
            ...
            (0, a.jsx)(tG.X, { onlineCount: u, memberCount: c, className: tB.He, highContrast: s }),
            (0, a.jsxs)("div", {
                className: tB.ov,
                children: [
                    null != m &&
                        (0, a.jsxs)(a.Fragment, {
                            children: [
                                (0, a.jsx)(M.E, {
                                    ...
                                    color: S,
                                    children: K.intl.format(K.t.zb2Q56, { createdAtDate: m }),
                                }),
                                j && (0, a.jsx)("span", { className: tB.LO, "aria-hidden": !0 }),
                            ],
                        }),
                    _ &&
                        (0, a.jsxs)(a.Fragment, {
                            children: [
                                (0, a.jsx)(M.E, { tag: "span", variant: "text-sm/normal", color: S, children: A }),
                                v && (0, a.jsx)("span", { className: tB.LO, "aria-hidden": !0 }),
                            ],
                        }),
                    N &&
                        (0, a.jsxs)(a.Fragment, {
                            children: [
                                (0, a.jsx)(M.E, { tag: "span", variant: "text-sm/normal", color: S, children: g }),
                                x && (0, a.jsx)("span", { className: tB.LO, "aria-hidden": !0 }),
                            ],
                        }),
                    x &&
                        (0, a.jsx)(M.E, {
                            ...
                            variant: "text-sm/normal",
                            color: S,
                            children: K.intl.format(K.t.hmdOwf, { tier: f }),
                        }),
                ],
            }),
        ],
...
function tK(e) {
    let { guild: t, outline: n } = e,
        ...
        c =
            null != r
                ? (0, a.jsx)("img", { src: r, alt: "", className: tB.OV })
                : (0, a.jsx)("div", {
                      className: tB.ef,
        ...
        ? (0, a.jsx)("div", {
              ...
              children: (0, a.jsx)(tW.Ay, {
                  ...
                  children: (0, a.jsx)("div", {
                      className: tB.$d,
                      children: (0, a.jsx)(tW.Ay, { mask: tW.Ay.Masks.SQUIRCLE, width: i, height: i, children: c }),
                  }),
              }),
          })
        : (0, a.jsx)("div", {
        ...
        children: [
            (0, a.jsxs)("div", {
                ...
                children: [
                    (0, a.jsx)("div", {
                        className: tY.WT,
                        children: (0, a.jsx)("div", { className: tY.g_, "aria-hidden": !0 }),
                    }),
                    (0, a.jsxs)("div", {
                        className: tY.TS,
                        children: [
...
function tJ() {
    return (0, a.jsx)("div", { className: tY.$k, children: (0, a.jsx)(eL.y, {}) });
}
function t0(e) {
...
function t2(e) {
    let { children: t, cardChildren: n, startAnimHeightPx: l, sectionClassName: i, inviteCardClassName: s = tY.qF } = e,
...
function t3(e) {
    let t,
        { invite: n } = e,
        l = t0(n),
        { enabled: i } = tq.useConfig({ location: "AcceptInviteMobile" }),
        s = null != n ? (0, e4.oO)(n) : null,
        r = n?.guild != null ? (0, em.DY)(n.guild) : null,
        u = null != r && tZ(s) && null != n && !tg(n),
        c = i && u;
    o.useEffect(() => {
        u && tq.getConfig({ location: "AcceptInviteMobile.hasProfile" });
    }, [u]);
    let d = o.useRef(!1);
    if (
        (o.useEffect(() => {
        ...
        switch (l) {
            case 1:
                t = c
                    ? (0, a.jsx)(tX, { invite: n, guild: r, profile: s, onAcceptInvite: e.onAcceptInvite })
    ...
    let m = 1 === l && c ? tY.c4 : tY.qF;
    return (0, a.jsx)(t2, { startAnimHeightPx: 200, sectionClassName: t8[l], inviteCardClassName: m, children: t });
}
function t4(e) {
    let { invite: t, onAcceptInvite: n } = e,
        { guild: l } = t ?? {},
        i = {},
        { enabled: s } = tq.useConfig({ location: "AcceptInviteMobile" }),
    ...
    return (0, a.jsxs)(P.Ay, {
        ...
        children: [(0, a.jsx)(t3, { ...e, onAcceptInvite: n }), (0, a.jsx)(t7, { ...e })],
    });
}
var t6 = n(723702);
function t9(e) {
                ...
                async () => {
                    ...
                    return (n) =>
                        (0, a.jsx)(l, {
                            ...
                            subtitle: e === nu.tY.MEDIA_TAKEDOWN ? K.intl.string(K.t.jt3z8f) : void 0,
                        });
                },
                { onCloseCallback: i, dismissable: !1 },
            );
    ...
    nE = (e) => {
        ...
        return (0, a.jsxs)(nf.D, {
            ...
            children: [
                ...
                (0, a.jsx)(nx.n, { size: "sm", style: { transform: "rotate(180deg)" } }),
            ],
        });
    },
    n_ = (e) => {
        ...
        return (0, a.jsx)(eR.B, {
            ...
            children: (0, a.jsx)("div", {
                className: np.kL,
                children: t.map((e) =>
                    e === nu.tY.MEDIA_TAKEDOWN || null == nA[e]
                        ? null
                        : (0, a.jsx)(nE, { title: K.intl.string(nA[e]), menuType: e, onReopen: n }, e),
                ),
            }),
        });
    };
...
let ny = (e) => {
        ...
        let x = s.filter((e) => e !== nu.tY.MEDIA_TAKEDOWN),
        ...
        let N = o.useCallback(() => {
                (0, nr.openModalLazy)(() => Promise.resolve((e) => (0, a.jsx)(ny, { ...e })), { dismissable: !1 });
            }, []),
            j = o.useCallback((e, t) => {
                "selection" !== t && "selection" !== e ? c("selection") : c(e);
            }, []),
            v = o.useMemo(() => ng(nu.tY.MEDIA_TAKEDOWN, N), [N]),
        ...
        if (!E) {
            if (A)
                return (0, a.jsx)(ns.Modal, {
                    ...
                    onClose: n,
                    dismissable: !1,
                    children: (0, a.jsx)(n_, { dsaCapabilities: x, onReopen: N }),
                });
            if (p)
                return (0, a.jsx)(ns.Modal, {
        ...
        let C = [
            { stepKey: "selection", modalProps: { title: K.intl.string(K.t.Z11w18) }, body: (0, a.jsx)(nv, {}) },
            {
                stepKey: "dsa",
                modalProps: {
                    title: K.intl.string(K.t.Z11w18),
                ...
                body: (0, a.jsx)(n_, { dsaCapabilities: x, onReopen: N }),
            },
            {
                stepKey: "tida",
        ...
        return (0, a.jsx)("div", {
            className: { selection: nS.a, dsa: nS.q, tida: void 0 }[I],
...
let nD = {
    ...
    getTimeSinceNavigationStart: () => Date.now() - nP.fL,
};
var nk = n(111956),
    nG = n.n(nk),
    nw = n(615300),
...
let nF = (0, nB.xI)(nU.A.WAVE_SPLASH_RESPONSIVE_WIDTH_MOBILE),
    ...
    nH = function (e) {
        return class extends o.Component {
            ...
            handleResizeDebounced = nG()(this.handleResize, 60);
            ...
            animateTo(e, t) {
                nw.A.spring(this.anim, { toValue: e, ...nW }).start(t);
            }
            getAnimatedStyle(e) {
            ...
            render() {
                return (0, a.jsx)("div", {
                    className: nV.i,
                    children: (0, a.jsx)(nM.C.Consumer, {
                        children: (t) => {
                            let { reducedMotion: n } = t;
                            return (0, a.jsx)(nw.A.div, {
                                className: nV.l,
...
let nX = function (e) {
    let { match: t, location: n, attemptDeepLink: l } = e,
        [i, s] = o.useState(0);
    o.useEffect(() => {
        nQ.default.once("connected", () => {
            s(1);
        }),
            nQ.default.once("disconnected", () => {
                (0, D.pX)((0, nY.W)());
            }),
            nQ.default.connect();
    }, []),
        o.useEffect(() => {
            if (0 !== i) return;
            let e = setTimeout(() => (0, D.pX)((0, nY.W)()), 3e3);
...
class n$ extends o.PureComponent {
    ...
    renderSuccess() {
        ...
        if (null != l) {
            let e = nq.px.find((e) => e.category === l);
...
let nZ = h.Ay.connectStores([ed.A], () => ({ defaultRoute: ed.A.defaultRoute }))(n$);
var nJ = n(110782),
    n0 = n(10088),
    n1 = n(871123),
    n2 = n(189081),
...
let ll = h.Ay.connectStores([n7.A, n3.A, n5.A, n9.default], (e) => {
    ...
    return (
        null != r &&
            (c = K.intl.formatToPlainString(r.interval === lt.WT.MONTH ? K.t.CTpcCZ : K.t["rgPWG/"], {
                skuName: i.name,
        ...
        (0, a.jsxs)(o.Fragment, {
            children: [
                null != n.giftStyle
                    ? (0, a.jsx)(n6.A, { defaultAnimationState: n4.oA.LOOP, giftStyle: n.giftStyle, className: ln.e })
                    : (0, a.jsx)(P.eu, {
...
function lm(e) {
    ...
    return (0, a.jsx)(P.Ay, {
        ...l,
        className: U()(n, ld.kL),
        contentClassName: ld.Qs,
        children: i.map((e, t) =>
            (0, a.jsx)("div", { className: ld.fi, style: { flexBasis: `${100 / i.length}%` }, children: e }, t),
        ),
    });
}
var lh = n(895600),
...
let lA = "mweb_handoff_nonce",
    ...
    lj = new Set(["deep_link_failed"]),
    lv = () => {
        lg.w.remove(lA), lg.w.remove(lE);
    },
    lI = () => {
        ...
        if (
            ...
            o.useEffect(() => {
                if (null != d) {
                    let e = lg.w.get(lE);
                    (null == e || Date.now() >= e) && (c("nonce_expired"), lv());
                }
            }, [d, c]),
            o.useEffect(() => {
                null != n &&
            ...
            : (0, a.jsxs)("div", {
                  ...
                  children: [
                      ...
                      (0, a.jsx)(B.$, {
                          ...
                          onClick: () => {
                              let e = lx.A.generateNonce();
                              lg.w.set(lA, e), lg.w.set(lE, Date.now() + l_);
                              let t = new URL(b.J$u),
...
function lP(e) {
    let t,
        ...
        S = (0, h.bG)([lC.A], () => lC.A.getHasLoggedInAccounts()),
        y = o.useCallback(
            (e) => {
                T.default.track(b.HAw.LOGIN_SUCCESSFUL, {
    ...
    o.useEffect(() => {
        ...
        null != G && G !== g && (e("password") ? k.current?.focus() : (e("email") || e("login")) && D.current?.focus());
    }, [g, D, k, G]),
        (t =
            null != n
                ? (0, a.jsx)("div", { className: Q.S3, children: (0, a.jsx)(lu.A, { invite: n }) })
                : null != i
                  ? (0, a.jsx)(ll, { giftCode: i })
                  : (0, a.jsxs)("div", {
                        className: la.wx,
                        children: [
                ...
                children: (0, a.jsxs)(P.eB, {
                    ...
                    children: [
                        ...
                        (0, a.jsxs)("div", {
                            className: Q.a5,
                            children: [
                                (0, a.jsx)("span", { className: la.Qt, children: K.intl.string(K.t.tmE73r) }),
                                (0, a.jsx)("span", {
                                    className: la.Z8,
                                    children: (0, a.jsx)(ec.Q, {
        ...
        : null != l
          ? l.state === lO.QB.RESOLVING
              ...
              : (0, a.jsx)(lm, {
                    ...
                    className: U()(s, la.Sy),
                    children: () => [
                        (0, a.jsx)(lh.A, { guildTemplate: l }, "template"),
                        (0, a.jsx)(o.Fragment, { children: w }, "form-wrapper"),
                    ],
                })
          : S && !x
            ? (0, a.jsx)(lb, { onDismiss: () => p(!0) })
            : (0, a.jsxs)("div", {
                  children: [
                      (0, a.jsx)(P.Ay, {
                          onSubmit: N,
                          tag: "form",
                          className: U()(s, { [la.M0]: O }),
                          expanded: !0,
                          children: (0, a.jsxs)(eR.B, {
...
var lG = n(511815),
    ...
    lV = n(913612),
    lF = n(933924);
let lW = (e) => n.g.location.assign(e);
function lH(e) {
    let {
        invite: t,
        guildTemplate: n,
    ...
    let g = (0, h.bG)([eQ.default], () => eQ.default.isAuthenticated()),
        ...
        A = l?.skuId ?? null,
        _ = (0, h.bG)([n7.A], () => (null != A ? n7.A.get(A) : null)),
        {
            checkingHandoff: N,
            redirecting: j,
            login: v,
            ...
            errors: L,
            conditionalMediationAbortController: G,
            loginSource: w,
            loginOrSSO: U,
            handleLogin: B,
            handleIPAuthorize: V,
            ...
            let k = o.useMemo(() => {
                ...
                U = o.useCallback(
                    function (e, t) {
                        ...
                        e && null != t && (p(!0), n ? f.A.verifySSOToken("login").then(() => w(t)) : w(t));
                    },
                    [w],
                ),
                B = o.useCallback(() => {
    ...
    (0, li.Ay)(() => {
        x && !g ? (0, E.ST)() : g && U(g, i, !0),
            ...
            g || (0, lF.a)({ abortController: G, loginSource: w, giftCodeSKUId: A }),
    ...
    if (
        (o.useEffect(() => {
            let e = N && (x || j);
            g && !1 === ee && !e && (G.abort("Transitioning to authenticated state"), U(g, i));
        }, [g, x, ee, j, N, G, U, i]),
        j || N)
    )
    ...
    switch (p) {
        ...
        case b.aUe.MFA_STEP:
            return (0, a.jsx)(lk, { loginSource: w, giftCodeSKUId: A });
        case b.aUe.ACCOUNT_SCHEDULED_FOR_DELETION:
        case b.aUe.ACCOUNT_DISABLED:
            return (0, a.jsx)(lo, { loginStatus: p, authBoxClassName: c, onSubmit: Y, onCancelAccountDeletion: X });
...
let lQ = null,
    lY = "underage";
class lX extends h.Ay.Store {
    static displayName = "AgeGateStore";
    isUnderageAnonymous() {
        if (t6.isPlatformEmbedded && 1) {
            if (null != lQ && lQ + lz.bm > Date.now()) return !0;
        } else if (1) return null != lK.parse(document.cookie)[lY];
        return !1;
    }
}
let lq = new lX(g.h, {
    AGE_GATE_PREVENT_UNDERAGE_REGISTRATION: function () {
        (lQ = Date.now()), (document.cookie = `${lY}=1;path=/`);
    },
    LOGIN_SUCCESS: function () {
        (lQ = null), (document.cookie = `${lY}=1;path=/;max-age=0`);
    },
});
var l$ = n(509434),
    lZ = n(741449);
let lJ = function () {
    return (0, a.jsx)(P.Ay, {
        children: (0, a.jsxs)("div", {
            className: lZ.hQ,
            children: [
                (0, a.jsx)(P.hE, { className: lZ.DD, children: K.intl.string(K.t.nCB6Ga) }),
                (0, a.jsx)(P.tK, {
                    className: lZ.VA,
...
var l7 = n(493527),
    l8 = n(544395),
    l3 = n(446837);
let l4 = window.ResizeObserver ?? l3.t;
function l6(e) {
...
function ir(e) {
    ...
    if ((g.h.dispatch({ type: "REGISTER" }), null != o)) {
        let e;
        (0, is.A)(o, b.JJy.REGISTER),
            T.default.track(b.HAw.AGE_GATE_ACTION, { source: lz.w_.REGISTER, action: lz.AM.AGE_GATE_SUBMITTED }),
            (e = it()().diff(o, "years")) < 13 ||
    ...
    return W.A.post({
        ...
        (e) => {
            g.h.dispatch({ type: "REGISTER_SUCCESS", token: e.body.token }),
                ...
                T.default.track(b.HAw.AGE_GATE_ACTION, { source: lz.w_.REGISTER, action: lz.AM.AGE_GATE_SUCCESS });
        },
        (e) => {
            if (e instanceof ii.CaptchaCancelError) throw e;
            let t = new V.A(e);
            throw (
                (null != t.getFieldErrors("date_of_birth") && il.Xv(lz.w_.REGISTER),
...
function iE(e) {
    ...
    return (
        (t = u
            ? (0, ix.YW)(o)
                  .with({ type: ip.q.ERROR, message: ix.P.select() }, (e) =>
                      (0, a.jsx)(M.E, { className: ih.vU, variant: "text-sm/normal", children: e }),
                  )
                  .with({ type: ip.q.AVAILABLE, message: ix.P.select() }, (e) =>
                      (0, a.jsx)(M.E, { className: ih.vq, variant: "text-sm/normal", children: e }),
                  )
                  .otherwise(() =>
                      (0, a.jsx)(M.E, {
                          variant: "text-sm/normal",
        ...
        (0, a.jsx)(l6, { show: (u && o?.type === ip.q.ERROR) || s, top: -12, bottom: 20, children: t })
    );
}
function i_(e) {
    let {
        ...
        [g, f] = o.useState(!1);
    async function x() {
        y.length > 0 && !l8.A.wasRegistrationSuggestionFetched(y) && (await l7.A.fetchSuggestionsRegistration(y));
    }
    function p(e) {
    ...
    let eg = o.useCallback(async () => {
            ...
            try {
                ...
                if ((z(!1), !(t instanceof l1.LG))) return;
                let e = (0, lU.W)(t);
                $(e), s?.(e), "number" == typeof e.retry_after && X(e.retry_after);
            }
        }, [l, i, n, C, s, c, _, O, y, D, G, V, X]),
        ef = o.useCallback(
            (e) => {
                ...
                0 === C.length && (es(K.intl.string(K.t.EkokLy)), (t = !0)),
                    ...
                    null == G && (em(K.intl.string(K.t.EkokLy)), (t = !0)),
                    t || eg();
            },
            [C, O, D, G, E, eg],
        ),
        ex = null;
    return (
        "string" == typeof Z && (ex = (0, a.jsx)(P.ME, { className: U()(Q.QX, ih.gJ), children: Z })),
        (0, a.jsx)("form", {
            onSubmit: ef,
            children: (0, a.jsxs)(P.eB, {
                className: Q.QX,
                children: [
                    ...
                    (0, a.jsx)(io, {}),
                    (0, a.jsx)(ig, { consent: V, consentRequired: E, onConsentChange: W }),
                    (0, a.jsx)(l0.m, {
...
function iI(e) {
    ...
    return (0, a.jsxs)("div", {
        ...
        children: [
            ...
            (0, a.jsx)(M.E, { className: iv.dN, color: "none", variant: "text-sm/semibold", children: t.name }),
        ],
    });
}
function iC(e) {
    ...
    return (0, a.jsxs)("div", {
        className: iv.kL,
        children: [
            (0, a.jsx)(tI.Uq, { className: iv.II, guildId: n.guild_id, guildEvent: n, eventPreview: n }),
            (0, a.jsx)(tI.sC, { name: n.name, description: n.description, guildId: n.guild_id }),
            null != t && n.channel_id === t.id ? (0, a.jsx)(iI, { channel: t }) : null,
        ],
    });
}
var iS = n(644977);
function iT(e) {
    ...
    return (0, a.jsxs)("div", {
        children: [
            ...
            null != s &&
                "" !== s &&
                (0, a.jsx)(M.E, { color: "text-default", className: iS.CT, variant: "text-sm/normal", children: s }),
        ],
    });
}
function iy(e) {
...
function iR(e) {
    ...
    t =
        n?.guild_scheduled_event != null
            ? (0, a.jsx)(iC, { channel: n.channel, guildScheduledEvent: n.guild_scheduled_event })
            : (0, a.jsx)("div", { className: Q.S3, children: (0, a.jsx)(lu.A, { invite: n, inUnclaimedFlow: !0 }) });
    let [m, g] = o.useState(""),
        [f, x] = o.useState(null),
        [p, A] = id(u),
        [E, _] = o.useState(!1),
        ...
        k = o.useCallback(async () => {
            ...
            try {
                await (function (e) {
                    ...
                    return ir({ ...l, invite: t, giftCodeSKUId: n });
                })({ consent: p, invite: n.code, globalName: m, birthday: f }),
                    r?.();
            } catch (t) {
                if ((_(!1), !(t instanceof l1.LG))) return;
                let e = (0, lU.W)(t);
    ...
    return n.state === b.elq.RESOLVING
        ? (0, a.jsx)(iy, { authBoxClassName: l, name: m, onNameChange: g })
        : (0, a.jsxs)("div", {
              children: [
                  (0, a.jsx)(P.Ay, {
                      tag: "section",
                      ...
                      children: (0, a.jsxs)("form", {
                          ...
                          children: [
                              t,
                              c ? (0, a.jsx)("div", { className: ih.yF }) : null,
                              (0, a.jsxs)(P.eB, {
                                  className: c ? void 0 : ih.y0,
                                  children: [
                                      (0, a.jsx)(iN.k, {
                                      ...
                                      (0, a.jsx)(ig, { consent: p, consentRequired: u, onConsentChange: A }),
                                      (0, a.jsx)(ib, { consentRequired: u, consent: p, registering: E }),
                                      (0, a.jsx)("div", {
                                          className: Q.QX,
                                          children: (0, a.jsx)(ec.Q, {
                                              text: K.intl.string(K.t["1lWxux"]),
                  ...
                  null != n && c
                      ? (0, a.jsx)(P.Ay, {
                            className: Q.QX,
                            children: (0, a.jsx)(iT, { guild: n.guild, onlineCount: n.approximate_presence_count }),
                        })
                      : null,
              ],
          });
...
function iD(e) {
    ...
    (0, li.Ay)(() => {
        ...
        o.useEffect(() => {
            A && !1 === S && ((0, iO.C)(iP.zY.ORGANIC_REGISTERED), L());
        }, [A, S, L]);
    let G = iL.FULL;
    E || null != I.date_of_birth ? (G = iL.AGE_GATE) : R && (G = iL.INVITE),
        (0, lS.A)(
            {
                type: c.ImpressionTypes.VIEW,
                name: c.ImpressionNames.USER_REGISTRATION,
                properties: { impression_group: c.ImpressionGroups.USER_REGISTRATION_FLOW, step: G },
            },
            {},
            [G],
        );
    ...
    if (E || null != I.date_of_birth) return (0, a.jsx)(lJ, {});
    if (null != s && R)
        return (0, a.jsx)(iR, { invite: s, authBoxClassName: t, onApiErrors: C, onGotoLogin: w, onRegister: g });
    let M = (0, a.jsx)(P.hE, { children: K.intl.string(K.t.wC4TlR) }, "title"),
        V = !1;
    null != i
        ? ((M = (0, a.jsx)(lh.A, { guildTemplate: i })), (V = !0))
        : null != n
          ? (M = (0, a.jsx)(ll, { giftCode: n }))
          : null != s &&
            O &&
            s.state === b.elq.RESOLVED &&
            (M = (0, a.jsx)("div", { className: Q.S3, children: (0, a.jsx)(lu.A, { invite: s, isRegister: !0 }) }));
    let W = (0, a.jsx)(i_, {
        ...
        ? (0, a.jsx)(lm, {
              ...
              children: () => [
                  ...
                  (0, a.jsxs)(
                      ...
                      {
                          className: ih.Uu,
                          children: [(0, a.jsx)(P.hE, { className: ih.lR, children: K.intl.string(K.t.wC4TlR) }), W],
                      },
                      "register-title",
                  ),
              ],
...
class ik extends o.PureComponent {
    ...
    render() {
        ...
        if (i) {
            ...
            return "login" === this.getMode()
                ? (0, a.jsx)(lH, { giftCode: l, transitionTo: r, location: o })
                : (0, a.jsx)(iD, { giftCodeSKU: t, giftCode: l, transitionTo: r, location: o });
        }
        return null;
    }
}
let iG = h.Ay.connectStores([nR.A, n2.A, eQ.default, n7.A, ed.A, n0.A], (e) => {
    let t = e.match.params.giftCode,
        n = nR.A.get(t),
        l = null != n ? n7.A.get(n.skuId) : null;
    return {
        giftCode: n,
        sku: l,
        libraryApplication: null != l && n?.entitlementBranches != null ? n8.YI(n.entitlementBranches, l, n2.A) : null,
...
class iH extends o.PureComponent {
    componentDidMount() {
        (0, k.d)("guildTemplate"),
            iF.VP || eY.A.launch("discord://" + b.BVt.GUILD_TEMPLATE(this.props.code), () => void 0);
    }
    componentDidUpdate(e) {
    ...
    renderAuthenticatedOrDownload() {
        ...
        return (eV()(null != e, "guild template must not be null"), e.state === lO.QB.RESOLVING)
            ? (0, a.jsx)(P.Ay, { className: iW.sL, children: (0, a.jsx)(iM.A, { guildTemplate: e }) })
            : (0, a.jsx)(iK, { guildTemplate: e });
    }
    renderContinue() {
        return (0, a.jsxs)(P.Ay, {
            children: [
    ...
    render() {
        ...
        switch (e.state) {
            ...
            case lO.QB.RESOLVED:
                if (n || !iF.VP) return this.renderAuthenticatedOrDownload();
                if (this.props.login) return (0, a.jsx)(lH, { guildTemplate: e, transitionTo: l, location: i });
                return (0, a.jsx)(iD, {
                    guildTemplate: e,
                    transitionTo: l,
                    location: i,
                    onRegister: () => {
                        (0, iO.C)(iP.zY.ORGANIC_REGISTERED_GUILD_TEMPLATE),
                            iB.A.flowStart(iV.do.ORGANIC_GUILD_TEMPLATES, iV.ju.NUF_STARTED);
                    },
                });
            case lO.QB.EXPIRED:
...
function iK(e) {
    let { guildTemplate: t } = e,
        { form: n, handleSubmit: l } = (0, iU.A)(t, !1);
    iB.A.flowStep(iV.do.ORGANIC_GUILD_TEMPLATES, iV.jC.GUILD_CREATE);
    let i = (0, a.jsxs)(a.Fragment, {
        children: [
            (0, a.jsx)(P.hE, { className: iW.wx, children: K.intl.string(K.t.UNFvtM) }),
            n,
            (0, a.jsx)("div", {
                className: iW.Tf,
    ...
    return (0, a.jsx)(lm, {
        className: iW.sL,
        children: () => [
            (0, a.jsx)(lh.A, { guildTemplate: t }, "template"),
            (0, a.jsx)("div", { className: iW.KJ, children: i }, "contents"),
        ],
    });
}
function iz(e, t, n) {
    ...
    eS.A.openMobileApp(n.state === lO.QB.RESOLVED ? t : void 0, i);
}
function iQ(e) {
    let { code: t } = e,
    ...
    null == n || n.state === lO.QB.RESOLVING)
        ...
        : n.state === lO.QB.RESOLVED
          ? (0, a.jsxs)(P.Ay, {
                children: [
                    (0, a.jsx)(iM.A, { guildTemplate: n, tall: !0 }),
                    (0, a.jsx)("div", {
                        className: Q.QX,
                        children: (0, a.jsx)(B.$, {
    ...
    return (0, a.jsxs)("div", {
        children: [
            (0, a.jsxs)(P.Ay, {
                children: [
                    null != r
                        ? (0, a.jsx)(iC, { channel: t.channel, guildScheduledEvent: r })
                        : (0, a.jsx)(lu.A, { invite: t }),
                    null != s &&
                        (0, a.jsx)("div", {
                            className: Q.QX,
                            role: "alert",
                            children: (0, a.jsxs)(M.E, {
                                ...
                                children: [
                                    (0, a.jsx)(i$.E, { size: "custom", width: 14, height: 14, color: "currentColor" }),
                                    " ",
                                    (0, i0.s)(s.code),
                                ],
                            }),
            ...
            null != r &&
                ...
                (0, a.jsx)(P.Ay, {
                    className: Q.QX,
                    children: (0, a.jsx)(iT, { guild: t.guild, onlineCount: t.approximate_presence_count }),
                }),
        ],
    });
}
...
function i6(e) {
    ...
    return (0, a.jsxs)(P.Ay, {
        children: [
            ...
            (0, a.jsx)(i7, { message: K.intl.string(K.t.fIv16B), onClick: n }),
            (0, a.jsx)("div", {
                className: Q.Ot,
...
function i9(e) {
    ...
    return (0, a.jsxs)(P.Ay, {
        children: [
            (0, a.jsx)(P.hE, { children: K.intl.string(K.t.fOc4gn) }),
            (0, a.jsx)(i7, { message: K.intl.string(K.t.fIv16B), onClick: t }),
        ],
    });
}
var i5 = n(334465);
...
let si = nH(lH),
    ...
    sr = nH(function (e) {
        let { inviteKey: t, location: n, transitionTo: l, login: i } = e,
            ...
            d = (0, h.bG)([lq], () => lq.isUnderageAnonymous()),
            [m, f] = o.useState(!1);
        o.useLayoutEffect(() => {
        ...
        if (
            ((0, iZ.Ay)(() => {
                ...
                if (
                    ...
                    (0, k.d)("invite"),
                    iF.VP || eY.A.launch("discord://" + b.BVt.INVITE(t), () => void 0),
                    !i && d)
                ) {
            ...
            (function (e) {
                ...
                o.useEffect(() => {
                    ...
                    o.useEffect(() => {
                        if (null != t && s === i1 && l && !1 === c) {
                            let { channel: e } = t;
                            if (null != e)
                                if (((0, iO.C)(iP.zY.INVITE_UNCLAIMED), null != t.guild)) {
                                    let e = (0, iX.Lt)(t.flags ?? 0, iY.Q.IS_APPLICATION_BYPASS),
                                        n =
        ...
        if ([b.elq.RESOLVING, b.elq.ACCEPTING, b.elq.APP_OPENING].includes(v)) {
            ...
            return (0, a.jsx)(i4, { title: e });
        }
        if (v === b.elq.EXPIRED) return (0, a.jsx)(i6, { banned: !1, handleDefaultTransition: N });
        if (v === b.elq.BANNED) return (0, a.jsx)(i6, { banned: !0, handleDefaultTransition: N });
        if (v === b.elq.RESOLVED) {
            if (u && (0, iX.Lt)(s.flags ?? 0, iY.Q.IS_GUEST_INVITE))
                return (
                    p.Ay.openApp(s.code),
                    iq.u.set(iJ.B, s.code),
                    (0, a.jsx)(i3, { invite: s, rpcConnected: j, onContinue: () => l(b.BVt.APP) })
                );
            if (!u && iF.VP)
                return x === i2
                    ? (0, a.jsx)(lH, { invite: s, transitionTo: l, location: n })
                    : (0, a.jsx)(iD, {
                          invite: s,
    ...
    sE = nH(function (e) {
        ...
        return (0, a.jsx)(nX, { match: t, location: n, attemptDeepLink: l });
    }),
    s_ = nH(function (e) {
        let { match: t, location: n } = e;
        async function l(e) {
            await (0, nz.W)(nn.XK.GAME_SHOP, {
                guildId: e.params.guildId,
    ...
    sN = nH(function (e) {
        let { match: t, location: n } = e;
        async function l(e, t) {
            await (0, nz.W)(nn.XK.PICK_GUILD_SETTINGS, {
    ...
    sj = nH(function (e) {
        let { location: t } = e,
            ...
            i = se.useExperiment({ location: "RSL - Landing Page" }, { autoTrackExposure: !0 }).enabled,
            [s, r] = o.useState(!1),
        ...
        return (
            ...
            o.useEffect(() => {
                async function e(e) {
                    try {
                        let t = null != e ? await (0, nc.q)(e) : void 0;
    ...
    sI = nH(function (e) {
        ...
        if (
            (o.useEffect(() => {
                ...
                (0, t6.isDesktop)() ? m(i) : c.current || ((c.current = !0), r("rpc_attempting"), g(i));
            }, [i, l, m, g]),
            d.Fr || d.v1)
        ) {
            let e = null == i || "string" != typeof i ? "missing_token" : "invalid_token";
            return (0, a.jsx)(nt, { token: i, hasError: "error" === s, errorReason: e });
        }
        if ((0, D.MX)()) return null;
        if ("app_launched" === s)
            return (0, a.jsx)(nl, {
...
class sC extends o.PureComponent {
    ...
    componentDidMount() {
        ...
        null != e &&
            ...
            T.default.track(
                b.HAw.INVITE_OPENED,
                { invite_code: (0, eX.m0)(e), load_time: nD.getTimeSinceNavigationStart() },
                { flush: !0 },
            )),
    ...
    render() {
        ...
        return (0, a.jsxs)(nK.A, {
            ...
            children: [
                ...
                (0, a.jsx)(en.A, { path: b.BVt.LOGIN_ONE_TIME, render: (e) => (0, a.jsx)(sI, { ...e }) }),
                (0, a.jsx)(en.A, {
                ...
                (0, a.jsx)(en.A, {
                    ...
                    render: (e) => {
                        ...
                        return d.Fr || d.v1
                            ? (0, a.jsx)(su, { inviteKey: s, transitionTo: i }, s)
                            : (0, a.jsx)(
                                  sr,
                                  {
                                      inviteKey: s,
                ...
                (0, a.jsx)(en.A, { path: b.BVt.VERIFY, render: (e) => (0, a.jsx)(sh, { ...e }) }),
                ...
                (0, a.jsx)(en.A, { path: b.BVt.DISABLE_EMAIL_NOTIFICATIONS, render: (e) => (0, a.jsx)(sx, { ...e }) }),
                (0, a.jsx)(en.A, {
                ...
                (0, a.jsx)(en.A, {
                    path: b.BVt.CHANNELS_GAME_SHOP(ni.pv.guildId(), ":pageIndex", ":skuId", ":slug?"),
                    render: (e) => (0, a.jsx)(s_, { ...e }),
                }),
                (0, a.jsx)(en.A, {
                    path: b.BVt.CHANNEL(ni.pv.guildId(), ni.pv.channelId({ optional: !0 }), ":messageId?"),
                    render: (e) => (0, a.jsx)(sE, { ...e }),
                }),
                (0, a.jsx)(en.A, { path: b.BVt.REPORT, render: () => (0, a.jsx)(nb, {}) }),
                (0, a.jsx)(en.A, { path: b.BVt.REPORT_SECOND_LOOK, render: (e) => (0, a.jsx)(sj, { ...e }) }),
