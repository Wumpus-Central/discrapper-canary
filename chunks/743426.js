n.d(t, { Z: () => S }), n(35282), n(388685), n(415506);
var r = n(264344),
    i = n.n(r),
    a = n(47770),
    o = n(579092),
...
class S extends a.Z {
    ...
    connect(e, t, n) {
        (0, d.eJ)(m.eR.EXPERIMENT_CONFIG) || (n.experiments = void 0);
    ...
    setAudioInputDevice(e) {
        ...
        (this.audioInputDeviceId = e),
            (0, d.eJ)(m.eR.SET_AUDIO_DEVICE_BY_ID)
    ...
    setGoLiveSource(e, t) {
        ...
        this.eachConnection((n) => {
            (t !== m.Yn.STREAM || n.streamUserId === n.userId) &&
        ...
        n.setOnClipsRecordingEvent((t) => {
            this.logger.info(
                "Clips recording event: "
                    .concat(m.Pf[t], " received for stream ")
                    .concat(l, " and sound ")
                    .concat(c, "."),
            ),
                t === m.Pf.GoLiveEnded
    ...
    setAudioSubsystem(e) {
        null != (0, d.zS)().setAudioSubsystem
            ...
            : (0, d.zS)().setUseLegacyAudioDevice(e === m.iA.LEGACY);
    }
    ...
    constructor() {
        ...
        super(),
            ...
            g(this, "Video", p.Z),
            g(this, "Camera", f.Z),
            g(this, "audioInputDeviceId", m.Av),
            g(this, "audioOutputDeviceId", m.Av),
            g(this, "videoInputDeviceId", m.Av),
            ...
            g(this, "handleDeviceChange", function () {
                ...
                e.deviceChangeGeneration++,
                    e.emit(
                        s.aB.DeviceChange,
                        (0, u.C1)(m.h7.AUDIO_INPUT, t),
                        (0, u.C1)(m.h7.AUDIO_OUTPUT, n),
                        (0, u.C1)(m.h7.VIDEO_INPUT, r),
                    );
            }),
        ...
        E.setDeviceChangeCallback(this.handleDeviceChange),
            ...
            null != (0, d.zS)().getAudioSubsystem
                ...
                : null != (0, d.zS)().getUseLegacyAudioDevice &&
                  (this.audioSubsystem = (0, d.zS)().getUseLegacyAudioDevice() ? m.iA.LEGACY : m.iA.STANDARD),
            ...
            null == (_ = E.setLoopbackPlaybackGainMultiplier) || _.call(E, m.Jk),
            null == (h = E.setVoiceFiltersFailedCallback) || h.call(E, (e) => this.emit(s.aB.VoiceFiltersFailed, e)),
            (0, l.Z)(this),
            I(this);
    }
}
