...
function k(t) {
    let {
        ...
        [K, R] = i.useState(null != M ? S : C),
        [T, w] = i.useState(""),
        [P, U] = i.useState(null),
        { isModReportClosed: Y, isModReport: E } = (0, s.cj)([v.Z], () => {
        ...
        _ = i.useCallback(() => {
            let t = null != P ? P : T;
            if (null != k) {
                if (!(null != b && (null == b ? void 0 : b.size) > 0 && O) || F) return;
                if ("" === T.trim() && !F) return void I(!0);
                k(e, [...b], K, t);
            } else {
                if (null == n) return;
