...
let h = E()[1].value,
    j = E()[0].value;
function x(t) {
    let { guildId: e, user: n, location: i, userIds: b, onBanMultiple: x, transitionState: y, onClose: S, canBulkBan: M = !1, modReportId: C } = t,
        ...
        J = (() => {
            if (null != x && null != b) return m.intl.formatToPlainString(m.t.HVJexc, { count: null == b ? void 0 : b.size });
            if (null == n) return '';
