        ...
        let z = (0, i.jsx)(eu.mG, {
            ...
            Q = [
                null == Z && ((0, N.A)(h, eW.jUm.JOIN) || (0, C.A)(h))
                    ? (0, i.jsx)(O.A, { activity: h, user: _, variant: "primary", size: "md", icon: t4._ }, "join")
                    : null,
                (0, t5.A)(h)
                    ? (0, i.jsx)(nr.A, { activity: h, size: "md", variant: "primary", icon: t7.b }, "watch")
                    : null,
                Z,
            ].filter(b.Vq);
        return (0, i.jsxs)(tK, {
