...
function eo(e) {
    ...
    for (let { iconPath: e, text: a } of (n.setFont({ size: 12, family: ea, weight: 500, truncate: j.Kq.None }), i)) {
...
function el(e) {
    ...
    for (let e = 0; e < n.length; e++)
        e < n.length - 1 &&
            ...
            t.drawRoundedImage(n[e], { x: i + e * (s - 8), y: r }, { w: s, h: s }, 50, { fillMode: j.VZ.Cover }),
            t.restoreContext();
}
var eu = n(375708);
async function ec(e) {
        ...
        drawImage: (e) =>
            (function (e, t) {
                ...
                e.setSize({ w: 400, h: 120 }, 4),
                    ...
                    e.setColor("white"),
                    e.drawRoundedImage("ApplicationImage", { x: 12, y: 12 }, { w: 96, h: 96 }, 8) === j.uS.Failure &&
                    ...
                    e.setColor("white"),
                    e.setFont({ size: 16, family: ea, weight: 500, truncate: j.Kq.Wrap }),
    ...
    return (0, i.jsx)(eV.Ay, {
        ...
        onSubmit: (e) => {
            ...
            return t.length > 200
                ...
                : (n(t), h(""), p((0, eF.x7)("")), Promise.resolve({ shouldClear: !0, shouldRefocus: !1 }));
        },
        setEditorRef: s,
        focused: l,
        onFocus: u,
...
let tD = function (e) {
    let { children: t } = e,
        [n, s] = (0, tR.kn)([ef.M.CONTENT_INVENTORY_ONE_CLICK_REPLY_COACHTIP]),
        [a, o] = r.useState(!1),
        l = r.useRef(null);
    r.useEffect(() => {
        let e = setTimeout(() => {
...
function tG() {
    return (0, i.jsxs)("div", {
        className: tU.oR,
        children: [
            (0, i.jsx)(tx.y, { type: tx.t.SPINNING_CIRCLE_SIMPLE, className: tk.S }),
            (0, i.jsx)(ev.E, {
                color: "text-strong",
...
function t$(e) {
    ...
    return (
        ...
        (0, i.jsx)(eA.N, {
            ...
            children: (e) => (0, i.jsx)("div", { className: eh()(tH.ZK, e, r), style: s, children: t }),
        })
    );
}
function tz(e) {
...
function tq(e) {
    ...
    let n,
        ...
        a,
        o,
        { channel: l, user: c, onReaction: _, entry: h, buttons: f = [], header: p, onVoiceChannelPreview: m } = e,
        [g, A] = r.useState(!1),
        [T, S] = r.useState(null),
        y = (0, u.bG)(
            [th.A],
            () => null != l && eY.kvI.CONTENT_ENTRY_EMBEDS.has(l.type) && th.A.can(eY.xBc.SEND_MESSAGES, l),
        ),
        [C, N] = r.useState(!1),
        [v, R] = r.useState(!1),
        { voiceBar: O, joinVoiceButton: b } = (function (e) {
            let { channel: t, entry: n, onVoiceChannelPreview: s } = e,
                { streamPreviewUrl: a, channel: o } = (0, tN.A)(n),
                l = (0, eq.Ay)(o),
                { needSubscriptionToAccess: c } = (0, e7.A)(t?.id),
                _ = (0, u.bG)([t_.A], () => (null != o ? t_.A.getGuild(o.guild_id) : void 0)),
                h = (0, u.yK)([tm.Ay], () => (null != o ? tm.Ay.getVoiceStatesForChannel(o) : []), [o]),
                f = (0, u.bG)([tE.A], () => tE.A.isInChannel(o?.id)),
                p = r.useMemo(() => {
                    for (let e of h) {
                        let t = td.A.getDMFromUserId(e.user.id),
                            n = null != t && tp.Ay.isChannelMuted(null, t),
                            i = tf.A.isBlockedOrIgnored(e.user.id);
                        if (n || i) return !0;
                    }
                    return !1;
                }, [h]);
            ...
            function m(e) {
                let { children: t, text: n, hasRestrictedOrMutedVCParticipant: r } = e,
                    s = r
                        ? (0, i.jsxs)(i.Fragment, {
                              children: [
                                  (0, i.jsx)(eb.i, { size: "custom", width: 13, height: 13, className: tH.vb }),
        ...
        { embeddedActivity: D } = (0, tC.A)(h),
        L =
            ((t = D),
            (n = (0, u.bG)([t_.A], () => t_.A.getGuild((0, ek.D)(t?.location)))),
            (s = (0, u.bG)([td.A], () => td.A.getChannel((0, ek.H)(t?.location)))),
        ...
        j = g ? eu.intl.string(eu.t.Z2CUgn) : eu.intl.string(eu.t.XLGiTG),
        H = async (e) => {
            let t,
                { emoji: n } = e;
            if (null != n) {
                if (
                    ...
                    (0, eJ.Dr)(ef.M.CONTENT_INVENTORY_ONE_CLICK_REPLY_COACHTIP),
                    N(!0),
                    R(!1),
                    g)
                )
        ...
        Y = async (e) => {
            let t;
            if (((0, eJ.Dr)(ef.M.CONTENT_INVENTORY_ONE_CLICK_REPLY_COACHTIP), g))
                U()(null != l, "shareToChannelMode should only be true if a valid channel is passed"), (t = l);
            else {
    ...
    return (0, i.jsxs)("div", {
        ...
        children: [
            (0, i.jsx)(tF, { sent: v, shown: C, className: tH.Jt }),
            K ??
                (0, i.jsx)(tD, {
                    children: (0, i.jsxs)("div", {
                        className: tH.T7,
                        children: [
                            (0, i.jsx)(tZ, { channel: l, onClickSuggestion: H }),
                            (0, i.jsx)(ez, { onSelectEmoji: H }),
                        ],
                    }),
                }),
            (0, i.jsxs)("div", {
                className: k ? tH.P2 : tH.VE,
                children: [
                    (0, i.jsx)(e$, {
                        placeholder: B,
                        onEnter: Y,
...
function tX(e) {
    ...
    return (0, i.jsxs)("div", {
        ...
        children: [
                    ...
                    (0, i.jsx)(eN.D, {
                        ...
                        children: eu.intl.format(n, {
                            ...
                            countOthersHook: (e, t) =>
                                (0, i.jsx)(
                                    ev.E,
                                    { variant: "text-sm/medium", className: eh()(tH.Mj, tH.nk), children: e },
                                    t,
                                ),
                            name0Hook: (e, n) =>
                                (0, i.jsx)(
            ...
            null != f && (0, i.jsx)(eX.Ay, { size: eX.Ay.Sizes.SMALL }),
...
function tQ(e) {
    ...
    return null == n ? t : (0, i.jsx)(d.D, { className: tH.Zw, onClick: n, children: t });
}
function tJ(e) {
    let {
            title: t,
    ...
    let T = (0, e3.A)(
        ...
        { largeImage: S, smallImage: y } = (0, M.nO)({
            entry: m,
            showCoverImage: h,
    ...
    return (0, i.jsxs)("div", {
        className: tH.au,
        children: [
            (0, i.jsx)(tX, { disableGameProfileLinks: _, ...E, onUserPopoutClosed: f }),
            (0, i.jsxs)(t$, {
                ...
                children: [
                    (0, i.jsxs)("div", {
                        ...
                        children: [
                                ...
                                children: [
                                    (0, i.jsx)(tQ, {
                                        ...
                                        children: (0, i.jsx)(eN.D, {
                                            ...
                                            className: eh()(tH.$2, { [tH.bC]: null != d }),
                                            lineClamp: 3,
                                            children: t,
                                        }),
                                    }),
                            ...
                            (0, i.jsx)("div", { className: tH.hO, children: d }),
                        ],
                    }),
                    a,
                ],
...
function t0(e) {
    let {
        ...
        [E] = r.useMemo(() => (0, e6.eo)(p, tE.A, t_.A, th.A, e1.default), [p]),
        { entry: m } = f,
        g = (0, tI.zD)(m),
        A = g ? m.extra?.application_id : void 0,
        I = (0, tt.W)();
    ...
    let T = (0, e3.A)(
        ...
        S = g ? T : void 0,
        { activity: y, activityApplication: C, fallbackApplication: N } = (0, tC.A)(m),
        { largeImage: v, smallImage: R } = (0, M.D8)(y, C ?? N),
        { largeImage: O } = (0, M.nO)({ entry: m, trackingSource: "memberlist_streaming_content_popout" }),
    ...
    return (0, i.jsxs)("div", {
        className: tH.au,
        children: [
            (0, i.jsx)(tX, { ...f, onUserPopoutClosed: _ }),
            (0, i.jsxs)(t$, {
                ...
                children: [
                    (0, i.jsx)(tQ, {
                        ...
                        children: (0, i.jsxs)("div", {
                            className: tH.nh,
                            children: [
                                (0, i.jsx)(e4.A, { className: tH.j7, stream: o }),
                                E &&
                                    (0, i.jsx)("div", {
                                        className: tH.NE,
                                        children: (0, i.jsx)(ev.E, {
...
let t2 = function (e) {
    let { channel: t, entry: n, onReaction: s, onVoiceChannelPreview: a, disableActivityProfileLinks: o } = e,
        ...
        { user: c, details: d, activity: _, embeddedActivity: h } = (0, t1.u)(n),
        { primaryColor: f, secondaryColor: p } = (0, X.A)(l?.src),
        E = (0, u.bG)([D.default], () => D.default.locale),
        { displayParticipants: m, participant1: g, participant2: k, numOtherParticipants: U } = (0, P.A)(n, 3);
    function G() {
        (0, O.hg)(n.extra.application_id);
    }
    let F = r.useCallback(
            (e) => {
                let i, r, s;
                    ...
                    U > 0
                        ? (function (e) {
                              ...
                              return eu.intl
                                  ...
                                  .replaceAll("*", "");
                          })({ entry: n, channel: t, users: [g, k], countOthers: U })
                        : ((i = eu.t["bES+y2"]),
    ...
    let j = (0, i.jsx)(ed.iT, { location: ed.N5.POPOUT, entry: n }),
        ...
        Y = (0, y.A)(_, eY.jUm.JOIN) || (0, C.A)(_),
        W = Y
            ? (0, i.jsx)(v.A, { embeddedActivity: h, activity: _, user: c, variant: "primary", size: "md", icon: A.I })
            : null,
        K =
            null == B
                ? null
...
let nh = [...t3.n, ed.Yq],
    ...
    np = function (e) {
        let {
            ...
            { user: _, details: h, appName: f, activity: p, embeddedActivity: E } = (0, t1.u)(n),
            { primaryColor: m, secondaryColor: g } = (0, X.A)(d?.src),
            A = (0, u.bG)([D.default], () => D.default.locale),
            { streamPreviewUrl: I, stream: T } = (0, tN.A)(n),
            { displayParticipants: S, participant1: O, participant2: k, numOtherParticipants: U } = (0, P.A)(n, 3),
            G = n.extra.platform,
            ...
            $ = r.useCallback(
                        ...
                        U > 0
                            ? (function (e) {
                                  ...
                                  return eu.intl
                                      ...
                                      .replaceAll("*", "");
                              })({ entry: n, channel: t, users: [O, k], countOthers: U })
                            : ((i = (0, x.JM)(n)),
                              (r = (0, x.Rf)(n)
                                  ? i
                                      ? eu.t.MHO1AV
                ...
                [d?.src, t, S, n, A, U, O, k, m, g, _],
            );
        if (null == _) return null;
        let z = (0, i.jsx)(ed.mG, {
                location: null == I ? ed.N5.POPOUT : ed.N5.STREAMING_POPOUT,
                children: nh.map((e, t) => (0, i.jsx)(e, { entry: n }, t)),
            }),
            q =
                null == T
                    ? (0, i.jsx)(tJ, {
            ...
            Z =
                !K && W
                    ? (0, i.jsx)(
                          nn,
                          { application: j, analyticsLocation: R.A.MEMBER_LIST_GAMING_CONTENT_POPOUT },
                          "cloud-play",
                      )
                    : null,
            Q = [
                null == Z && ((0, y.A)(p, eY.jUm.JOIN) || (0, C.A)(p))
...
function nm(e) {
    let { entry: t, isFirstApplicationOccurrence: n, targetElementRef: s } = e,
        ...
        h = d === t.id,
        f = c && h ? [ef.M.CLOUD_PLAY_POPOVER] : [],
        [p, E] = (0, tR.kn)(f),
        m = p === ef.M.CLOUD_PLAY_POPOVER;
    r.useEffect(() => {
        c && null === d && _(t.id);
    }, [d, c, t.id, _]),
        r.useEffect(
            () => () => {
                m && (E(tO.i.USER_DISMISS), _(null));
            },
            [m, E, _],
        );
        ...
        drawImage: (e) => {
            ...
            (t = e),
                ...
                (n = e).drawRoundedImage("MediaImage", { x: 12, y: 12 }, { w: 96, h: 96 }, 8, {
                    fillMode: j.VZ.Contain,
                }) === j.uS.Failure && n.drawPath(B, { x: 12, y: 12 }, !0, 2 + 2 / 3),
                e.drawRoundedImage("AvatarImage", { x: 120, y: 12 }, { w: 32, h: 32 }, 50),
                (i = e),
                (r = s),
                i.setColor("white"),
                i.setFont({ size: 16, family: ea, weight: 500, truncate: j.Kq.Wrap }),
...
function nU(e) {
    let t,
        ...
        { activity: h, currentEntry: f, artist: p, title: E, user: m } = (0, nA.u7)(o),
        { primaryColor: g, secondaryColor: A } = (0, X.A)(_?.src),
        T = nd(eY.fg2.SPOTIFY),
        S = (0, u.bG)(
            [nC.A, nO.default],
            () => (h?.type === eY.$pd.LISTENING && null != m ? (0, nv.A)(nC.A, nO.default, m, h) : void 0),
            [h, m],
            nT.A,
        ),
        y = r.useCallback(() => {
        ...
        }, [h, p, a, o, _?.src, g, A, E, m]);
    if (null == h || null == f) return null;
    let C = p,
        N = [];
    f.media.provider === nI.X.SPOTIFY &&
        ((n = () => {
            (0, ny.Mp)(h);
        }),
        (s = () => {
            ...
            N.push(
                (0, i.jsx)(
                    I.$,
                    {
                        ...
                        icon: nS.J,
                        onClick: () => {
                            (0, nR.A)(S, nP.Qp.USER_ACTIVITY_SYNC), l();
                        },
                    },
                    "listen-along",
                ),
    ...
    let v = (0, i.jsx)(tJ, {
        ...
        subtitle: C,
        badges: null,
        children: h.timestamps?.start != null && (0, i.jsx)(nk, { activity: h }),
    });
    return (0, i.jsxs)(tK, {
        children: [
            v,
                  ...
                  children: [
                      (0, i.jsxs)(nV.UA, {
                          children: [
                              ...
                              (0, i.jsx)(ed.mG, {
                                  location: ed.N5.CARD,
                                  children: nj.map((e, n) => (0, i.jsx)(e, { entry: t }, n)),
                              }),
                          ],
                      }),
...
let nK = function (e) {
    ...
    let { channel: s, entry: a, onReaction: o, onVoiceChannelPreview: l } = e,
        ...
        A = r.useCallback(() => {
            var e, t, n;
            let i, r, o, l;
            if (null == s || null == f || !(0, L.S1)(g, nH)) return;
            let u =
                ((e = a),
                (t = s),
                (n = f),
        ...
        I = nd(eY.fg2.SPOTIFY);
    if (null == f || !(0, L.S1)(g, nH)) return null;
    function T() {
        let e = nP.M0.ALBUM,
        ...
        children: [
            (0, i.jsx)(tJ, {
                ...
                badges: (0, i.jsx)(ed.mG, {
                    ...
                    children: nj.map((e, t) => (0, i.jsx)(e, { entry: a }, t)),
                }),
            }),
            (0, i.jsx)(tz, {
                children: (0, i.jsx)(tq, {
...
let nz = function (e) {
    ...
    let { channel: s, entry: a, disableGameProfileLinks: o, onReaction: l, onVoiceChannelPreview: u } = e,
        ...
        { user: d, details: _, appName: h } = (0, t1.u)(a),
        { primaryColor: f, secondaryColor: p } = (0, X.A)(c?.src),
        E = (0, x.ty)(a),
        m = (0, x.TQ)(a),
        g = r.useCallback(
            (e) => {
                if (null != s && null != d && null != E && null != m && (0, n$._E)(m)) {
                    var t, n, i;
                    let r, o, l;
                    return nl({
                        entry: a,
    ...
    if (null == d || null == E || null == m || !(0, n$._E)(m)) return null;
    let A = null != a.extra.platform ? nf[a.extra.platform] : null;
    return (0, i.jsxs)(tK, {
        children: [
            (0, i.jsx)(tJ, {
                channel: s,
                ...
                badges: (0, i.jsx)(ed.mG, {
                    location: ed.N5.POPOUT,
                    children: n$.ac.map((e, t) => (0, i.jsx)(e, { entry: a }, t)),
                }),
    ...
    return await z({
        ...
        drawImage: function (e) {
            ...
            e.setSize({ w: 400, h: 120 }, 4),
                ...
                e.setColor("white");
            let i = e.drawRoundedImage("MediaImage", { x: 12, y: 12 }, { w: 96, h: 96 }, 8, { fillMode: j.VZ.Contain });
            i === j.uS.Failure && (i = e.drawRoundedImage("ApplicationImage", { x: 12, y: 12 }, { w: 96, h: 96 }, 8)),
                i === j.uS.Failure && e.drawPath(B, { x: 12, y: 12 }, !0, 2 + 2 / 3),
                e.drawRoundedImage("AvatarImage", { x: 120, y: 12 }, { w: 32, h: 32 }, 50),
                e.setFont({ size: 16, family: ea, weight: 500, truncate: j.Kq.Wrap }),
                e.drawText(r, { x: 120, y: 64, h: 32, w: 260 }, !0),
                eo({
...
let n0 = function (e) {
        ...
        let { channel: s, entry: a, onReaction: o, onVoiceChannelPreview: l } = e,
            ...
            { primaryColor: _, secondaryColor: h } = (0, X.A)(d?.src),
            f = (0, u.bG)([D.default], () => D.default.locale),
...
let n7 = r.createContext(void 0),
    n8 = r.memo(function (e) {
        let { index: t, ref: s, ...l } = e,
            ...
            { isRich: C, appName: N } = (0, t1.u)(l.entry);
        (0, f.T2)(l.entry.id);
        let v = r.useMemo(
                () => ({
                    entry: l.entry,
                    ...
                    richPresenceName: C ? N : void 0,
                }),
                [N, l.channel.guild_id, l.channel.id, l.entry, l.requestId, C],
            ),
            R = r.useRef(!1),
            [O, b] = r.useState(!1),
            [D, L] = r.useState(!1),
