                ...
                : e < 120
                  ...
                  : e < 180
                    ...
                    : e < 240
                      ...
                      : e < 300
                        ? [o, 0, a]
                        : [a, 0, o]).map((e) => Math.round((e + s) * 255));
    return {
        red: l[0],
        green: l[1],
        blue: l[2],
...
function m({ red: e, green: t, blue: n, alpha: r }) {
    let i = e / 255,
        a = t / 255,
        o = n / 255,
        s = Math.max(i, a, o),
...
class E {
    ...
    static parseString(e) {
        return e.match(g) ? this.parseColorFnString(e) : e.match(h) ? this.parseHexString(e) : void 0;
    }
    ...
    makePositionFromDOMRect(e) {
        ...
        return (
            "number" == typeof this.offset
                ? ((l = this.offset), (c = this.offset), (u = this.offset), (d = this.offset))
                : ((l = null != (t = this.offset.top) ? t : 0),
                  (c = null != (n = this.offset.right) ? n : 0),
                  (u = null != (r = this.offset.bottom) ? r : 0),
...
function G(e) {
        ...
        U(() => {
            ...
            function i(e) {
                if (null != n) {
                    ...
                    h(!0), t && g.showElement(n, v);
                }
            }
            function a() {
                g.hide(), (_.current = !1), h(!1);
            }
        }, [t, v, r, g, o, s]);
    let S = a.useCallback(
            (e) => {
                g.hide(), (_.current = !1), h(!1), null == b || b(e);
            },
            [b, g],
        ),
        I = a.useCallback(
            (e) => {
                ...
                e.currentTarget === e.target
                    ? ((_.current = !0), g.showElement(null != n ? n : e.currentTarget, v))
                    : (h(!0), t && g.showElement(null != n ? n : e.currentTarget, v)),
                    null == y || y(e);
            },
            [s, t, y, g, v],
        );
    return n && null == o && null == r
        ? a.cloneElement(E, {
              ...O,
              className: d(O.className, _.current ? c : void 0, m ? u : void 0),
              onBlur: S,
              onFocus: I,
          })
        : E;
