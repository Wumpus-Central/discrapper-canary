...
function Y(e) {
    ...
    if (!(0, A.l)(n) || Math.random() > H) return;
    let r = (0, S.A)(e);
...
function K(e) {
    ...
    if ((0, C.BS)(t)) return void Q(t);
    let c = (0, i.A)();
    if (!u && t.userStatus?.enrolledAt == null && !(0, v.Ic)(t)) {
        m.A.isEnrolling(t.id) ||
            (0, h.Oy)(t.id, { questContent: n, questContentCTA: y.Cy.ACCEPT_QUEST, sourceQuestContent: a });
        let e = E.Ay.getState().getVideoProgress(t.id);
        null != e &&
            e.timestampSec > 1 &&
            ((0, h.QG)(t.id),
            f.default.track(L.HAw.QUEST_VIDEO_ENROLLMENT_RETRY_ATTEMPTED, {
                quest_id: t.id,
                source_quest_content: (0, y.jO)(a),
    ...
    (0, o.mMO)(
        ...
        {
            modalKey: (0, N.cZ)(t.id),
            backdropStyle: o.F2Z.IMMERSIVE,
            onCloseCallback: () => (0, N.vm)({ questId: t.id, sourceQuestContent: a, videoSessionId: c }),
        },
    );
}
function z(e) {
...
function J(e) {
    if ((0, b.vA)(e)) return e.config.features.includes(D.Li.CLOUD_GAMING_ACTIVITY) ? o.hpF : o._xR;
}
