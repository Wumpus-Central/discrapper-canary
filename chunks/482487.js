...
function G(e) {
    let t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
        ...
        s = u.useCallback(
            function () {
                let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : _.i.TAKE_ACTION;
                i && r(e);
            },
            [i, r],
        );
...
function R(e) {
    let t = d(e);
    u.useEffect(() => {
        t > 0 && (0, i.$l)(a, t, { dismissAction: _.i.AUTO_DISMISS, guildId: e });
    }, [t, e]);
}
