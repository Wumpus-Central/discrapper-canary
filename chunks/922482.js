...
var r = n(749210),
    ...
    h = n(96150);
function g(e, t) {
    return !!d.Z.can(m.gl, e) && (!p.Zl(e.id) || t === e.id || (p.vu(e, () => y(e, !0)), !1));
}
function E(e, t) {
    ...
    return new Promise(async (i) => {
        ...
        await (0, s.O)([e]),
            ...
            u.Z.addConditionalChangeListener(() => {
                ...
                return null == e || (b(e), h.Z.initialize(), i(e), !1);
            });
    });
}
function b(e) {
    ...
    if (
        (!t && !g(e, n)) ||
        (_.Z.initialize(), i.default.selectVoiceChannel(e.id), (n = f.Z.getVoiceChannelId()) !== e.id)
    )
        return !1;
...
function y(e) {
    ...
    !(!r && i !== e.id && (0, o._)(e) && p.Gy(e, () => y(e, t, n, !0))) && b(e, t) && O(e, i);
}
function O(e, t) {
    p.R5(e, t);
}
