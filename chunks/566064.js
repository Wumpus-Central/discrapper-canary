...
function f(e) {
    let { navId: t, columnCounts: n, focusedX: f, focusedY: _, onSelect: p, prepareFocus: h, getNewFocusPosition: m, dispatch: g, maintainFocusPosition: E, enabled: b, autoFocusElement: v, useVirtualFocus: y } = e,
        O = r.useRef(b),
        I = u(c(t, f, _)),
        [S, T] = r.useState(!1),
        [A, N] = r.useState(!1),
...
function _(e) {
    let { navId: t, columnCounts: n, focusedX: o = 0, focusedY: s = 0, onSelect: l, prepareFocus: c, getNewFocusPosition: u, maintainFocusPosition: d = !0, enabled: _ = !0, onDispatch: p, autoFocusElement: h = !0, useVirtualFocus: m = !1 } = e,
        ...
        { columnCounts: v, focusedX: y, focusedY: O } = E,
