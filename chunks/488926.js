...
function P(e) {
    ...
    return (
        (_ = s.zy(_, y.xBc.ADMINISTRATOR) ? N : M(i.id, n, _, r)),
...
function x(e) {
    ...
    if (null == t) return C;
    if (!(l === I.default.getCurrentUser()?.id && u.A.isViewingRoles(t.id)) && (0, h.bM)(t, l)) return w(N, t, l, a);
...
function j(e) {
    return { id: e, type: a.r2.ROLE, allow: C, deny: C };
}
function H(e) {
