...
function R(e) {
    ...
    switch (t.type) {
        case "HERO":
            ...
            return (0, r.jsx)(L, k(D({}, i), { body: B(n) }));
        case "GRID":
            return (0, r.jsx)(M, { children: B(t.children) });
        case "FIELD":
            return (0, r.jsx)(F, {
                value: G(t.value),
                name: G(t.name),
...
let Q = Object.assign(
    function (e) {
        let { user: t, widget: n, cta: a, subtle: u = !1 } = e,
            ...
            L = (0, o.e7)([_.default], () => _.default.locale),
            M = i.useMemo(() => {
