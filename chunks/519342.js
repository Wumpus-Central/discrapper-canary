...
function O(e) {
    let {
        ...
        W = (0, y.tx)(B, a, U),
        K = (0, c.bG)([E.A], () => E.A.getRoom(a)?.background ?? o.I.DEFAULT),
        { seats: Y } = R.iX[K],
        X = Y.find((e) => e.position.x === N && e.position.y === I),
    ...
    let J = null != X ? P.intl.formatToPlainString(S.default["4bL+KW"], { username: W, seatLabel: X.getLabel() }) : W,
        ee = H?.isVoiceDeafened()
            ? P.intl.formatToPlainString(P.t["9hDjai"], { username: J })
            : H?.isVoiceMuted()
              ? P.intl.formatToPlainString(P.t.Hd1oVG, { username: J })
              : J,
        et = (0, i.jsx)(A.A, {
            userId: U.id,
        ...
        en = {
            left: $.x.to((e) => `calc(${e}% - ${w / 2}px)`),
            top: $.y.to((e) => `calc(${e}% - ${w / 2}px)`),
    ...
    let ei = b.x.find((e) => e.id === O),
        el = ei?.icon,
        ea = (0, i.jsx)("div", { className: L.R3, children: et });
