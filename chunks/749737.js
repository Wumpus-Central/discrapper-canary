...
class en extends s.Component {
    ...
    render() {
        ...
        return (0, i.jsxs)(N.A, {
            ...
            className: l()(X.oS, Q.SX, J.N, X.nM),
            children: [
                (0, i.jsx)(C.A, {
...
function ea() {
    let { horizontalSpacing: e, verticalSpacing: t } = (0, b.Or)(),
        ...
        { cssDebuggingEnabled: l, layoutDebuggingEnabled: r } = (0, u.cf)([G.default], () => ({
