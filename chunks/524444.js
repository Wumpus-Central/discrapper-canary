...
function et(e) {
    var { onVolumeChange: t, volume: n, onMute: i } = e,
        o = K(e, ["onVolumeChange", "volume", "onMute"]);
    let a = Q(t),
        s = X(i);
    return (
        (n = null == n ? j.FC : n),
                            ...
                            (0, r.jsx)(d.tEY, {
                                ...
                                children: (0, r.jsx)(
                                    ...
                                    W(H({}, e), {
                                        ...
                                        ref: b,
                                        "aria-label": F.intl.string(F.t.fSiQ3A),
                                        className: a()(B.mediaMosaicAltText, { [B.reducedSize]: u }),
                                        children: F.intl.string(F.t.jCV1Tz),
                                    }),
                                ),
                            }),
...
function ed(e) {
    ...
    return c
        ? null
        : (0, r.jsxs)("div", {
              className: a()(B.newMessagesBar, { [B.disableInteractions]: c }),
              children: [
                  (0, r.jsx)(d.tEY, {
                      offset: 4,
...
function ef(e) {
    var t, n, o;
    let { channel: s, content: _, scrollManager: m } = e,
    ...
    null == H && null == y && (null == j ? void 0 : j.length) >= 1 && (H = null == (o = j[0]) ? void 0 : o.topic);
    let Y = i.useMemo(
            () =>
                l().debounce((e) => {
                    var t;
        ...
        X = i.useCallback(
            function (e) {
                ...
                let r = () => {
                    m.removeScrollCompleteCallback(r),
                        setTimeout(() => {
                            m.addAutomaticAnchorCallback(K, !1);
                        }, 100);
                };
                m.removeAutomaticAnchorCallback(K),
                    m.addScrollCompleteCallback(r),
    ...
    i.useEffect(() => {
        if (null != I && z) {
            var e;
            null == (e = P.current) || e.scrollTo({ top: I });
        }
    }, [I, z]);
    let $ = i.useCallback(
        (e) => {
            var t;
            ((0, c.kK)(e.target) && (null == (t = S.current) ? void 0 : t.contains(e.target))) ||
                (z &&
                    x.default.track(U.rMx.SUMMARIES_TOPICS_PILL_TOGGLED, {
    ...
    i.useEffect(
        () => (
            m.addAutomaticAnchorCallback(K),
            () => {
                m.removeAutomaticAnchorCallback(K);
            }
        ),
    ...
    return (
        j.length > 0 && (er = "" === H || null == H ? F.intl.string(F.t.DwnFuG) : H),
        E
            ? null
            : (0, r.jsxs)("div", {
                  ref: S,
                                      ...
                                      children: [
                                          (0, r.jsxs)("div", {
                                              ...
                                              children: [
                                                  ...
                                                  (0, r.jsx)(O.Z, { className: B.summariesBetaTag }),
                                              ],
                                          }),
                                          (0, r.jsx)(d.P3F, {
...
function em(e) {
    ...
    let { channel: s, scrollManager: p } = e,
        { disableInteractions: _ } = i.useContext(b.G),
        [m, E] = i.useState(null),
        y = i.useRef(null),
        [v, S] = i.useState(null),
        I = i.useRef(null),
    ...
    null == M && null == m && (null == N ? void 0 : N.length) >= 1 && (M = null == (o = N[0]) ? void 0 : o.topic);
            ...
            function (e) {
                ...
                let r = () => {
                    p.removeScrollCompleteCallback(r),
                        setTimeout(() => {
                            p.addAutomaticAnchorCallback(Y, !1);
                        }, 100);
                };
    ...
    i.useEffect(() => {
        if (null != v && W) {
            var e;
            null == (e = I.current) || e.scrollTo({ top: v });
        }
    }, [v, W]);
    let $ = i.useCallback(
        (e) => {
    ...
    i.useEffect(
        () => (
            p.addAutomaticAnchorCallback(Y),
            () => {
                p.removeAutomaticAnchorCallback(Y);
            }
        ),
    ...
    eE = (e) => {
        ...
        return (0, r.jsx)(eg, {
            ...
            children: (0, r.jsx)("div", {
                ...
                children: (0, r.jsx)("div", { className: B.popoutLoadingForeground }),
            }),
        });
    };
