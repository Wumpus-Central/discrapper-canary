...
function M() {
    let { withSuggestionsNotice: e = !1 } = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
        ...
        [n, l] = i.useState(() => P(void 0, { withSuggestionsNotice: e })),
        s = o.A.isConnected(),
        a = i.useMemo(() => P({}), []);
    i.useEffect(() => {
        function t() {
            l(P(void 0, { withSuggestionsNotice: e }));
        }
        t();
        let n = r().throttle(t, 100);
        return (
            G.forEach((e) => e.addChangeListener(n)),
            () => {
                n.cancel(), G.forEach((e) => e.removeChangeListener(n));
            }
        );
    }, [e]),
        i.useEffect(() => {
...
function P(e) {
    ...
    let M = { isEmpty: () => !0, getRows: () => [], getRow: () => null },
        P = [];
    t && P.push(U.r.FAVORITES_SUGGESTIONS);
