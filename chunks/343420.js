    ...
    let e = {};
    {
        ...
        if (null != C) {
            ...
            (e.electron_process_memory_private = [
                ...
                null != (E = null == (o = C.crashpad) ? void 0 : o.wss_priv_kb) ? E : -1,
                null != (b = null == (a = C.utility) ? void 0 : a.wss_priv_kb) ? b : -1,
            ]),
...
function d() {
    let e = {};
    {
        ...
        null != t &&
            ...
            a.Z.isNativeModuleLoaded() && (e.voice_filters_native_module_loaded = !0);
    }
    return e;
}
function f() {
