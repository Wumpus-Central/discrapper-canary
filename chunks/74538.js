...
function z(e, t, n) {
    ...
    let s = (0, T.yd)(r, C.p9.TIER_0),
        l = (0, T.yd)(r, C.p9.TIER_2);
    for (let r of e) {
        let e;
...
function q(e, t, n, r) {
    let a;
    return null === t && (i()(null !== e, "Subscription can't be null"), (t = [])), z((a = null !== e ? eX(e, t) : eQ(t)), n, r);
}
function X(e) {
    let t = C.GP[e];
    if (null != t)
...
function J(e, t, n) {
    ...
    if (t || n)
        switch (e) {
            case C.rV.MONTH:
                let o = P.intl.formatToPlainString(a === C.p9.TIER_0 ? P.t.NPKsLy : P.t.poEovb, { timeInterval: P.intl.string(P.t.FPybU1) });
                return i ? o : P.intl.string(P.t.Mh9bTk);
            case C.rV.YEAR:
                let s = P.intl.formatToPlainString(a === C.p9.TIER_0 ? P.t.NPKsLy : P.t.poEovb, { timeInterval: P.intl.string(P.t.tfqrho) });
...
function es(e) {
    ...
    let { subscription: p, planId: h, price: m, includePremiumGuilds: g, hasDiscountApplied: E, activeDiscountInfo: y, renewalInvoicePreview: O, hasFractionalPremiumWithSub: v } = e,
        I = C.GP[h],
        T = tA(F(I.id), I.interval),
        S = ej(p) || (null == p.paymentSourceId && !p.isPurchasedExternally && !(null == (t = f.default.getCurrentUser()) ? void 0 : t.hasFreePremium())),
        ...
        w = S ? A.O0b.CANCELED : R ? A.O0b.UNPAID : p.status,
                        ...
                        ? h === C.Xh.PREMIUM_YEAR_TIER_2
                            ...
                            : D
                              ...
                              : P.intl.formatToPlainString(P.t['G6+XOT'], {
                                    ...
                                    regularPrice: T,
                                    numMonths: null != (_ = null == y ? void 0 : y.duration) ? _ : C.rt
                                })
                        : k;
            }
        default:
...
function ec(e) {
    let { planId: t, additionalPlans: n } = e,
        ...
        a = (null == i ? void 0 : i.planId) === C.Xh.PREMIUM_MONTH_GUILD || (null == i ? void 0 : i.planId) === C.Xh.PREMIUM_YEAR_GUILD ? P.t.Pi5yMD : null,
        o = null != a ? P.intl.formatToPlainString(a, { num: null == i ? void 0 : i.quantity }) : void 0;
    if (null != r && null != o)
...
function eI(e, t) {
    ...
    }
    {
        ...
        return (
            e.isBoostOnly || (a = eT(a, r.unactivatedUnits)),
            n
...
function eD(e) {
    ...
    let f = em(d),
        p = eB(a.planId, a.paymentSourceId, a.currency, o).amount * f;
    if (null != l) {
        ...
        return a.isPurchasedViaGoogle
            ...
            : h
              ? P.intl.format(P.t['0ozBSE'], {
                    quantity: f,
                    rate: (0, S.og)(s, _.interval, _.intervalCount)
                })
    ...
    switch (a.status) {
        ...
        case A.O0b.PAUSED:
            ...
            return P.intl.format(P.t['5iud9v'], { quantity: f });
        default:
            return a.isPurchasedViaGoogle
...
function ek(e, t) {
    ...
    return (null == r || (0, _.Q0)(r.subscriptionPlanId)) && (n = A.O0b.CANCELED), n;
}
function ej(e) {
    let { status: t, renewalMutations: n } = e;
    return t === A.O0b.CANCELED || (null != n && (0, _.Q0)(n.planId) && !e.isPurchasedExternally);
}
function eU(e) {
