...
function F(e) {
    ...
    return null != o && null != o.paymentSourceId && (i = o.paymentSourceId), V(e, n, r, { paymentSourceId: i });
}
function V(e) {
...
function er(e) {
    var t, n, r, i, o, s, c, u, d, _;
    let { subscription: p, planId: h, price: m, includePremiumGuilds: g, hasDiscountApplied: b, activeDiscountInfo: v, renewalInvoicePreview: y, hasFractionalPremiumWithSub: O } = e,
        I = A.GP[h],
        S = tI(F(I.id), I.interval),
        N = eL(p) || (null == p.paymentSourceId && !p.isPurchasedExternally && !(null === (t = f.default.getCurrentUser()) || void 0 === t ? void 0 : t.hasFreePremium())),
        C = null != m && null == p.paymentGateway,
        P = p.status === T.O0b.UNPAID && null !== p.latestInvoice && (null === (n = p.latestInvoice) || void 0 === n ? void 0 : n.status) === T.hUK.OPEN,
        w = N ? T.O0b.CANCELED : P ? T.O0b.UNPAID : p.status,
        D = null === (o = null !== (i = null == y ? void 0 : y.taxInclusive) && void 0 !== i ? i : null === (r = p.latestInvoice) || void 0 === r ? void 0 : r.taxInclusive) || void 0 === o || o,
        L = A.cb + (g ? ef(p.additionalPlans) : 0),
        x = C ? (D ? R.NW.format(R.t['cd+hqK'], { price: m }) : R.NW.format(R.t.NUkcpK, { price: m })) : R.NW.string(R.t.zYx3Y2),
            ...
            switch (w) {
                ...
                case T.O0b.PAUSE_PENDING:
                    ...
                    return null != j
                        ...
                        : R.NW.format(R.t.VlWufn, { pauseDate: p.currentPeriodEnd });
                case T.O0b.PAUSED:
                    if (O) return x;
                    return R.NW.format(R.t['6RTdZG'], { resumeDate: p.pauseEndsAt });
                case T.O0b.PAST_DUE:
            ...
            switch (w) {
                ...
                case T.O0b.ACCOUNT_HOLD:
                    return C
                        ...
                        : R.NW.format(R.t.ivjxcn, { num: L });
                case T.O0b.UNPAID:
                    return R.NW.format(R.t['0HopYW'], { num: L });
                case T.O0b.PAUSE_PENDING:
                ...
                case T.O0b.BILLING_RETRY:
                    return R.NW.format(R.t['IlJ/HR'], { endDate: a()(p.currentPeriodStart).add(A.A5, 'days').toDate() });
                case T.O0b.PAST_DUE:
                    return R.NW.format(R.t['d+0vws'], {
                        endDate: (0, E.vc)(eE(p).expiresDate, 'LL'),
                        onClick: () => {
                    ...
                    return b
                        ? h === A.Xh.PREMIUM_YEAR_TIER_2
                            ? R.NW.format(R.t['+qqh6u'], {
                                  percent: null !== (s = null == v ? void 0 : v.percentage) && void 0 !== s ? s : A.Bo,
                                  regularPrice: S
                              })
                            : D
                              ? R.NW.formatToPlainString(R.t['3Ziutb'], {
                                    percent: null !== (c = null == v ? void 0 : v.percentage) && void 0 !== c ? c : A.M_,
                                    regularPrice: S,
                                    numMonths: null !== (u = null == v ? void 0 : v.duration) && void 0 !== u ? u : A.rt
                                })
                              : R.NW.formatToPlainString(R.t['G6+XOT'], {
                                    percent: null !== (d = null == v ? void 0 : v.percentage) && void 0 !== d ? d : A.M_,
                                    regularPrice: S,
                                    numMonths: null !== (_ = null == v ? void 0 : v.duration) && void 0 !== _ ? _ : A.rt
                                })
                        : k;
            }
        default:
...
function es(e) {
    ...
    if (null == t || !n) return [];
    let a = void 0 !== o && t === A.GP[o].skuId ? o : void 0,
        s = [];
    switch (t) {
        case A.Si.TIER_0:
...
function eb(e, t) {
    ...
    }
    {
        ...
        if (eS(e)) return R.NW.format(R.t.awpB0N, { prepaidEndDate: e.currentPeriodEnd });
        ...
        return (
            e.isBoostOnly || (o = ev(o, r.unactivatedUnits)),
            n
...
function eC(e) {
    ...
    let f = ef(u),
        _ = ek(o.planId, o.paymentSourceId, o.currency, a).amount * f;
    if (null != l) {
        let e = l.invoiceItems.find((e) => A.Z1.has(e.subscriptionPlanId));
        null != e && (_ = e.amount);
    }
    s = null != s ? s : (0, S.T4)(_, o.currency);
        ...
        return o.isPurchasedViaGoogle
            ...
            : p
              ? R.NW.format(R.t['0ozBSE'], {
                    quantity: f,
                    rate: (0, S.og)(s, d.interval, d.intervalCount)
                })
    ...
    if (null != n) {
        ...
        i()(null != t, 'Missing plan'),
            (e = e.map((e) => {
                ...
                return i()(null != o, 'Missing planForInterval'), L(w({}, e), { planId: o.id });
            }));
    }
    return e;
}
...
function tw() {
    let e = (0, s.e7)([m.ZP], () => m.ZP.getPremiumTypeSubscription());
    return null == e ? void 0 : e.items.some((e) => A.UD.has(e.planId));
}
