...
function h(e) {
    let { location: t, isChannelSelected: n, isTargetInViewport: u = !0, channelType: h, isPopoverAllowed: m = !0 } = e,
        p = (0, a.JZ)(l.M.FAVORITES_SERVER_ONBOARDING_INTRO),
        { isExperimentEnabled: f } = (0, c.TW)(t),
        g = (0, s.bG)([o.A], () => null != o.A.getVoiceChannelId()),
        A = (0, i.useHasAnyModalOpen)(),
        x = f && u && n && d.has(h) && m && !g && !A,
        [C, E] = (0, r.kn)(x && p ? [l.M.FAVORITES_SERVER_ONBOARDING_MENU_ITEM] : []);
    return { showMenuItemPopover: C === l.M.FAVORITES_SERVER_ONBOARDING_MENU_ITEM, markMenuItemPopoverAsDismissed: E };
}
