...
class V extends (r = i.ZP.Store) {
    ...
    getOutboundStats(e) {
        ...
        return (
            Array.isArray(null == a ? void 0 : a.availableOutgoingBitrate) &&
                a.availableOutgoingBitrate.length > 0 &&
                (i = a.availableOutgoingBitrate[a.availableOutgoingBitrate.length - 1].value),
            {
