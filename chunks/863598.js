...
function N(e) {
    let { canManageGuild: t, guildId: n, afkChannelId: a, label: o } = e,
        ...
        u = s.useMemo(() => {
            ...
            return e.unshift({ value: p, label: A.intl.string(A.t.wGiHkK) }), e;
        }, [c]),
        m = s.useCallback((e) => {
            let t = e === p ? null : e;
            _.A.updateGuild({ afkChannelId: t });
        }, []);
    return (0, i.jsx)(b, { label: o, value: a ?? p, options: u, canManageGuild: t, onChange: m });
}
function E(e) {
    let { canManageGuild: t, guildId: n, systemChannelId: a, label: o, description: c, layout: u } = e,
        ...
        x = s.useMemo(() => {
            ...
            return e.unshift({ value: p, label: A.intl.string(A.t.ibUhoa) }), e;
        }, [m]),
        h = s.useCallback((e) => {
            let t = e === p ? null : e;
