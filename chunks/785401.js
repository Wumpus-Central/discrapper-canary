...
class y extends A.G {
    ...
    internalBinaryWrite(e, t, n) {
        ...
        e.override && v.internalBinaryWrite(e.override, t.tag(3, E.O0.LengthDelimited).fork(), n).join(),
...
class R extends A.G {
    constructor() {
        super("discord_protos.discord_experimentation.v1.Filter", [
            ...
            { no: 11, name: "bot", kind: "message", oneof: "filter", T: () => eC },
            ...
            { no: 23, name: "guild_id_range", kind: "message", oneof: "filter", T: () => eZ },
            ...
            { no: 27, name: "user_location", kind: "message", oneof: "filter", T: () => Z },
        ...
        for (; e.pos < s; ) {
            ...
            switch (t) {
                ...
                case 10:
                    ...
                    break;
                case 11:
                    r.filter = { oneofKind: "bot", bot: eC.internalBinaryRead(e, e.uint32(), n, r.filter.bot) };
                    break;
                case 12:
                    r.filter = {
                ...
                case 23:
                    r.filter = {
                        ...
                        guildIdRange: eZ.internalBinaryRead(e, e.uint32(), n, r.filter.guildIdRange),
                    };
                    break;
                case 25:
                    r.filter = {
                ...
                case 27:
                    r.filter = {
                        ...
                        userLocation: Z.internalBinaryRead(e, e.uint32(), n, r.filter.userLocation),
                    };
                    break;
                case 28:
                    r.filter = {
    ...
    internalBinaryWrite(e, t, n) {
        "clientVersion" === e.filter.oneofKind &&
            ...
            "clientLocation" === e.filter.oneofKind &&
                j.internalBinaryWrite(e.filter.clientLocation, t.tag(8, E.O0.LengthDelimited).fork(), n).join(),
            ...
            "bot" === e.filter.oneofKind &&
                eC.internalBinaryWrite(e.filter.bot, t.tag(11, E.O0.LengthDelimited).fork(), n).join(),
            "userAgeRange" === e.filter.oneofKind &&
                ev.internalBinaryWrite(e.filter.userAgeRange, t.tag(12, E.O0.LengthDelimited).fork(), n).join(),
            ...
            "userPremiumType" === e.filter.oneofKind &&
                ej.internalBinaryWrite(e.filter.userPremiumType, t.tag(20, E.O0.LengthDelimited).fork(), n).join(),
            ...
            "guildIdRange" === e.filter.oneofKind &&
                eZ.internalBinaryWrite(e.filter.guildIdRange, t.tag(23, E.O0.LengthDelimited).fork(), n).join(),
            ...
            "userLocation" === e.filter.oneofKind &&
                Z.internalBinaryWrite(e.filter.userLocation, t.tag(27, E.O0.LengthDelimited).fork(), n).join(),
...
class ti extends A.G {
    constructor() {
        super("discord_protos.discord_experimentation.v1.Experiment", [
            ...
            { no: 16, name: "rules", kind: "message", repeat: 1, T: () => C },
        ...
        for (; e.pos < s; ) {
            ...
            switch (t) {
                ...
                case 15:
                    ...
                    break;
                case 16:
                    r.rules.push(C.internalBinaryRead(e, e.uint32(), n));
                    break;
                case 18:
                    r.phase = e.int32();
                    break;
    ...
    internalBinaryWrite(e, t, n) {
        ...
        for (let i = 0; i < e.rules.length; i++)
            C.internalBinaryWrite(e.rules[i], t.tag(16, E.O0.LengthDelimited).fork(), n).join();
