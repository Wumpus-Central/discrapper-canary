...
function B() {
    ...
    return T(
        ...
        {
            os_version:
                null != (t = null === d() || void 0 === d() || null == (e = d().os) ? void 0 : e.version) ? t : "",
        },
    );
}
function F() {
...
function H() {
    let e = _.K.get(A);
    null == e && ((e = Z()), _.K.set(A, e));
    let t = _.K.get(C);
    null == t && ((t = F()), _.K.set(C, t));
    let n = m.x.get(C);
    return null == n && ((n = V(F(), "_current")), m.x.set(C, n)), S({}, e, B(), t, n);
}
function Y() {
    try {
