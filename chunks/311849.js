...
class R extends s.A {
    ...
    async trackNativeHeapPerformanceStats() {
        ...
        !this._nativeHeapHooksInstalled &&
            this._supportedNativeChannel &&
            t > 2097152 &&
            p.A.enablePerfMemoryHooks({ allocationThresholdKB: 12, enableCallStackTracking: !0 }) &&
    ...
    doRestartIfNeeded(e) {
        ...
        null == s ||
            ...
            E.Ay.setCrashInformation(r.du.IntentionalCrashReason, "excessive-memory-usage"),
            h.A.addBreadcrumb({
    ...
    trackPartitionAllocPerformanceStats() {
        ...
        if (!this._paHeapHooksInstalled && t > 1048576) {
            let e = p.A.enablePAMemoryProfiler({ allocationThresholdKB: 12, enableCallStackTracking: !0 });
    ...
    trackV8HeapAlloc() {
        ...
        if (
            (!this._v8ProfilerRunning &&
                t >= 786432 &&
                (p.A.enableProfilingV8Heap({ allocationThresholdKB: 64, sampleIntervalBytes: 65536, stackDepth: 64 }),
    ...
    trackCPUProfiling() {
        let e = p.A.startCPUProfiling({ maxSampleCount: 1e4, sampleRateMS: 1, captureJSThreadOnly: !1 });
        null != e &&
            (e.success ?? !1) !== !1 &&
