...
function q(e) {
    let { avatarSrc: t, avatarDecorationSrc: n, compact: l, onClick: o, onContextMenu: a, onMouseDown: s, onMouseEnter: c, onMouseLeave: u, onKeyDown: d, showCommunicationDisabledStyles: p = !1, className: m, avatarImgRef: g } = e;
...
let X = l.memo(function (e) {
    let { message: t, author: n, channel: o, guildId: i, compact: a = !1, roleIconProps: u, showUsernamePopout: d, renderPopout: p, onClickUsername: f, onContextMenu: O, displayCompactAvatars: y = !1, onPopoutRequestClose: v, preview: j, subscribeToGroupId: P, hideGuildTag: x } = e,
        w = (0, M.ZP)(t, n),
        C = l.useMemo(
            () =>
                (0, U.x)({
        ...
        S = l.useRef(null),
        N = (0, s.e7)([E.Z], () => E.Z.getGuild(i)),
        Z = l.useMemo(() => $(a, y, u, N), [a, y, u, N]),
        R = l.useMemo(
            () =>
                null == u
                    ? null
...
function Y(e, t, n) {
    let { message: l, channel: o, author: i, compact: a = !1, onContextMenu: s, showUsernamePopout: c, roleIcon: u, onClickUsername: d, onPopoutRequestClose: p } = e;
    return (0, r.jsxs)(r.Fragment, {
        children: [
            (0, r.jsx)(D.Z, {
                message: l,
...
function Q(e) {
    let { message: t, avatar: n, username: l, usernameSpanId: o, usernameClassName: a, compact: s, showTimestamp: u, showTimestampOnHover: d, ariaLabelledBy: m, ariaDescribedBy: g, className: f, messageClassname: b, badges: h } = e,
        O = (0, I.yE)(t.flags, F.iLy.SENT_BY_SOCIAL_LAYER_INTEGRATION) ? t.applicationId : null,
        y = (0, p.q)(O);
    return (0, r.jsxs)(r.Fragment, {
        children: [
            !s && n,
...
let ee = l.memo(function (e) {
    ...
    et = l.memo(function (e) {
        let { message: t, repliedMessage: n, compact: o = !1, renderPopout: p, showTimestampOnHover: m, roleIcon: g, subscribeToGroupId: b, hideTimestamp: h, hideGuildTag: y, className: P, channel: w, preview: T } = e,
            _ = l.useMemo(() => (null != p ? (e) => p(e, t) : void 0), [p, t]),
            ...
            Y = (0, s.e7)([E.Z], () => $(o, G, g, E.Z.getGuild(e.guildId)), [o, G, g, e.guildId]),
            J = l.useMemo(() => {
                let e = [];
                return ((0, I.yE)(t.flags, F.iLy.SUPPRESS_NOTIFICATIONS) && e.push((0, r.jsx)(j.Z, {}, 'suppress-notifications')), t.hasPotions() && e.push((0, r.jsx)(O.Z, { message: t })), e);
            }, [t]),
            ee = (0, A.XX)(t, b),
            et = (0, A.Dv)(t),
            en = h ? ''.concat(ee) : ''.concat(ee, ' ').concat(et),
            er = (null == n ? void 0 : n.state) === v.Y.LOADED ? (0, A.Gq)(t) : void 0;
        return (0, r.jsx)(Q, {
            message: t,
            avatar: L,
