...
let F = i.forwardRef(function (e, t) {
    var { options: n, value: o, onChange: l, clearable: d = !1, multi: f = !1, closeOnSelect: _ = !0, onOpen: g, onClose: E, placeholder: y = P.NW.string(P.t.XqMe3N), wrapperClassName: v, className: T, isDisabled: w = !1, maxVisibleItems: D = 7, look: L = C.q.FILLED, autoFocus: x = !1, popoutPosition: k = 'bottom', filter: j = !0, debounceTime: F, renderOptionLabel: H = G, onSearchChange: K, renderOptionPrefix: z = () => null, renderOptionSuffix: X = () => null, 'aria-describedby': J, 'aria-invalid': $, 'aria-labelledby': ee, 'aria-required': et, inputClassNames: en, centerCaret: er = !1, onBlur: ei, matchSorterOptions: eo, clearQueryOnSelect: ea = !1, hidePills: es, renderCustomPill: el, customPillContainerClassName: ec } = e,
    ...
    let eq = i.useCallback(() => {
        ...
        eX = eP;
    eT && null != eI && !1 !== j && (eX = 'function' == typeof j ? j(eP, eI) : (0, s.Lu)(eP, eI, null != eo ? eo : U)),
        i.useEffect(() => {
            let e = eA.current;
            null == e || e.scrollToTop();
        }, [eI]),
        i.useEffect(() => {
            !eR && eT && null !== eI && requestAnimationFrame(() => eW.focusFirstVisibleItem());
        }, [eR, eT, eI, eW]);
    let eJ = f ? Q : q,
        e$ = i.useRef(null),
                            ...
                            (0, r.jsxs)('div', {
                                ...
                                children: [
                                    d && ((null != eI && '' !== eI) || eD.length > 0)
                                        ? (0, r.jsx)(p.P, {
                                              'aria-label': P.NW.string(P.t.VkKicX),
                                              'aria-controls': eU,
                                              onClick: eq,
                                    ...
                                    (0, r.jsx)(p.P, {
                                        ...
                                        'aria-label': ev ? P.NW.string(P.t.cpT0Cg) : P.NW.string(P.t['3xjX0d']),
                                        'aria-controls': eU,
                                        onClick: () => {
                                            eG(!ev);
                                        },
        ...
        : 0 === s.length
          ? (0, r.jsx)('div', {
                ...
                children: (0, r.jsx)(v.x, {
                    ...
                    children: P.NW.string(P.t['Xe+fJC'])
                })
            })
          : (0, r.jsx)(u.SJ, {
                children: (e) => {
    ...
    return (0, r.jsx)(h.t, {
        ...
        children: (0, r.jsxs)(f.zx, {
            ...
            children: [
                ...
                (0, r.jsx)(g.n, { children: P.NW.string(P.t.N86XcH) }),
                !c &&
                    (0, r.jsx)(O.Dio, {
                        size: 'custom',
                        color: 'currentColor',
