        ...
        children: [
            ...
            (0, i.jsxs)("div", {
                ...
                children: [
                    ...
                    (0, i.jsx)(et.M, {
                        enabled: !M,
                        children: (0, i.jsx)(e3, { channel: c, firstMessage: f, facepileRef: S }),
                    }),
                ],
            }),
        ],
...
function t8(e) {
    ...
    return (0, i.jsx)(E.D, {
        ...
        children: (0, i.jsx)(tE.P, { size: "md", color: "currentColor", className: t3.ut }),
    });
}
function t7(e) {
        ...
        children: [
            (0, i.jsx)("div", {
                ...
                children: (0, i.jsxs)("div", {
                    className: t3.wO,
                    children: [
                        (0, i.jsx)(b.E, { tag: "span", className: t3.cy, variant: "text-sm/semibold", children: t }),
                        (0, i.jsx)(b.E, {
            ...
            (0, i.jsx)(tJ.A, { className: t3.Ki, src: l }),
            (0, i.jsx)(tO.h, { size: 10 }),
            (0, i.jsx)("div", {
                className: t3.qr,
                children: (0, i.jsxs)("div", {
                          ...
                          (0, i.jsxs)("div", {
                              ...
                              children: [
                                  (0, i.jsxs)(b.E, {
                                      ...
                                      className: t3.l2,
                                      children: [
                                          (0, i.jsx)(tT.m, { size: "xxs", color: "currentColor", className: t3.Kk }),
                            ...
                            v ||
                                ...
                                j.addStep(
                                    ((o = null != d.topic && d.topic.length > 0),
                                    {
                                        ...
                                        clickHandler: () => {
                                            nP(nR._G.GUIDELINES), tM.Ay.open(d.id, void 0, eX.b7d.TOPIC);
                                        },
                                        isDone: o,
                                    }),
                                ),
                            ...
                            d.isGameInvitesChannel() ||
                                j.addStep(
                                    ((e = c?.id),
                                    {
                                        ...
                                        clickHandler: () => {
                                            (nP(nR._G.CREATE_POST), d.isGameInvitesChannel())
                                                ? (0, z.d)(d)
...
function lj(e) {
    let { channelId: t, closePopout: n } = e,
        ...
        d = (0, g.bG)([tu.A], () => tu.A.getUploads(t, n3.oU.CREATE_FORUM_POST.drafts.type)),
        x = (0, m.Ay)({
                                ...
                                children: [
                                    d.map((e) =>
                                        (0, i.jsx)(
                                            ...
                                            {
                                                channelId: t,
                                                draftType: n3.oU.CREATE_FORUM_POST.drafts.type,
                                                upload: e,
...
function lp(e) {
    let { channelId: t } = e,
        [n, l] = s.useState(!1),
        a = s.useRef(null),
        r = (0, g.bG)([tu.A], () => tu.A.getUploads(t, n3.oU.CREATE_FORUM_POST.drafts.type)),
        o = r.length,
        c = o > 0;
    function d() {
        c && l(!0);
...
function lC(e) {
    let { parentChannel: t } = e,
        n = (0, le.yK)([tu.A], () => {
            let e = tu.A.getUploads(t.id, n3.oU.CREATE_FORUM_POST.drafts.type);
...
function lH(e) {
    let { parentChannel: t } = e,
        ...
        o = (function (e, t) {
            let { mediaAttachments: n, hasThumbnail: l } = (function (e) {
                    let [t, n] = s.useState(null),
                        l = (0, le.yK)([tu.A], () => {
                            let t = tu.A.getUploads(e.id, n3.oU.CREATE_FORUM_POST.drafts.type),
        ...
        h = s.useCallback(
            (e) => {
                null != c && n5.A.remove(t.id, c.id, n3.oU.CREATE_FORUM_POST.drafts.type),
                    (0, lo.R)(e.currentTarget.files, t, n3.oU.CREATE_FORUM_POST.drafts.type, {
                        requireConfirm: !0,
                        isThumbnail: !0,
                        origin: "file_picker",
                    }),
                    ...
                    return (n) =>
                        (0, i.jsx)(l, {
                            ...
                            onSubmit: (n) => {
                                ...
                                n5.A.update(t.id, e.id, n3.oU.CREATE_FORUM_POST.drafts.type, {
                                    filename: l,
                                    description: i,
                                    spoiler: s,
                                });
                  ...
                  children: [
                      ...
                      (0, i.jsxs)("div", {
                          ...
                          children: [
                              ...
                              null == c && (0, i.jsx)(nW.R, { size: "xs", color: "currentColor", className: lF.IZ }),
                          ],
                      }),
                  ],
              })
                      ...
                      actions: (0, i.jsxs)(i.Fragment, {
                          children: [
                              ...
                              (0, i.jsx)(lb.A, {
                                  ...
                                  onClick: () => n5.A.remove(t.id, c.id, n3.oU.CREATE_FORUM_POST.drafts.type),
                                  dangerous: !0,
                                  children: (0, i.jsx)(lN.u, { size: "md", color: "currentColor" }),
                              }),
                          ],
                      }),
                      draftType: n3.oU.CREATE_FORUM_POST.drafts.type,
                ...
                children: (0, i.jsxs)("div", {
                    ...
                    children: [
                        o
                            ...
                            : (0, i.jsx)(n2.g, { size: "md", color: "currentColor", className: ie.__invalid_emoji }),
...
var iu = n(746080),
    im = n(128892);
let ih = n3.oU.CREATE_FORUM_POST;
function ix(e) {
    var t, n;
    let l,
        a,
            ...
            g = s.useMemo(
                () =>
                    ...
                    (r.trim().length > 0 ||
                        ...
                        tu.A.getUploads(t.id, to.C.FirstThreadMessage).length > 0) &&
                    c
                        ? (0, i.jsx)(nW.R, { size: "md", color: "currentColor", className: im.rD })
...
function iI(e) {
    ...
    0 === A.length)
        ...
        : (0, i.jsxs)("div", {
              ...
              ref: x,
              children: [
                  (0, i.jsx)(n2.g, { size: "xs", color: "currentColor", className: im.HZ }),
                  (0, i.jsx)("div", {
                      className: im.kU,
                      ref: f,
                      children: (0, i.jsx)(u.hD, {
    ...
    return 0 === n
        ...
        : (0, i.jsxs)("div", {
              ...
              children: [
                  ...
                  (0, i.jsx)(b.E, { variant: "text-sm/semibold", color: "text-feedback-positive", children: n }),
              ],
          });
}
var i7 = n(106438);
...
function s_(e) {
    ...
    return (0, i.jsx)(eb.Cp, { channel: t, children: (0, i.jsx)(sP, { channel: t, guild: n, sidebarState: l }) }, t.id);
}
let sk = new (class {
    minWidth;
    maxWidth;
...
function sP(e) {
    ...
    let eL = s.useCallback(() => {
        ...
        })({ id: "forum-grid-view", isEnabled: X && eD && !eP, setFocus: ew }),
        eF = (function (e) {
        ...
        })({ listRef: B, padding: 96, isEnabled: !X && eD && !eP, channel: t }),
        eU = s.useCallback(
            (e, n, l) =>
                0 === e
                    ? 0
