...
function a(e) {
    let { oldOrdering: t, newOrdering: n, idGetter: i, existingPositionGetter: r, ascending: a = !0 } = e,
        o = n.length;
    ...
    for (let e = 0; e < o; e++) {
        let t = i(n[e]),
            s = c[t],
            l = a ? e : o - 1 - e;
        (s !== l || r(n[e]) !== l) && d.push({ id: t, position: l });
    }
...
let l = {
    ...
    getPositionUpdates: function (e) {
        ...
        let c = o(t, n, i);
        return a({ oldOrdering: t, newOrdering: c, idGetter: s, existingPositionGetter: l, ascending: u });
    },
};
