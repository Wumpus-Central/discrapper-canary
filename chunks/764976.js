...
class s {
    ...
    setSpeaking(e, t) {
        ...
        if (this.userId === e) {
            ...
            if (t !== o.Dg.NONE) {
                let e = Object.values(r.Z.getVoiceStatesForChannel(this.channelId)).filter(
                    (e) => !e.selfDeaf && !e.deaf,
                );
    ...
    constructor(e, t) {
        a(this, "userId", void 0),
            ...
            a(this, "maxVoiceStateCount", 1),
            a(this, "totalParticipants", void 0),
            a(this, "speaking", o.Dg.NONE),
            a(this, "maxListenerCount", 0),
            a(this, "totalListeners", void 0),
            a(this, "maxSpeakerCount", 0),
            a(this, "totalSpeakers", void 0),
            (this.userId = e),
            this.setChannelId(t);
    }
}
