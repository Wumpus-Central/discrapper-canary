...
function c(e) {
    let { forcedPinnedState: t, shouldTrack: n = !0 } =
        ...
        s = r.h.dispatch({ type: "LAYOUT_SET_PINNED", widgetId: e, pinned: t });
    if (!n) return s;
    let o = a.A.getWidget(e);
    return null == o || (0, i.xp)(o.type, { pinned: t ?? !o.pinned }), s;
}
function d(e) {
    r.h.dispatch({ type: "LAYOUT_SHOW_OVERLAY_EXTRAS_HINT", widgetId: e });
}
function _(e) {
