...
function I(e) {
    ...
    let n = (0, T.X)({ "en-US": f.default["f/cLEi"], "en-GB": f.default["f/cLEi"] }, f.default.CARxAC);
    return (0, o.jsxs)("div", {
        className: d()(N.kL, t),
        children: [
            (0, o.jsx)("div", { className: N.zc, children: (0, o.jsx)("img", { src: _.A, className: N._e, alt: "" }) }),
            (0, o.jsxs)("div", {
                className: N.P_,
                children: [
                    (0, o.jsx)(m.D, { variant: "heading-lg/semibold", color: "text-strong", children: n }),
                    (0, o.jsx)(A.E, { variant: "text-sm/normal", children: r.intl.string(f.default.nla4RG) }),
                ],
            }),
            (0, o.jsx)("div", {
                className: N.UD,
...
let C = (0, n.E2)(s.X.APPEARANCE_CUSTOM_THEMES_UPSELL, {
    useSearchTerms: () => [r.intl.string(r.t.Ksh3ik)],
    Component: function () {
        return (0, o.jsx)(I, { className: N.YH });
    },
});
var b = i(366010),
    v = i(17928),
