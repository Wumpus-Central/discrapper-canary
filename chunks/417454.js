...
let B = r.forwardRef(function (e, l) {
    let o,
        {
            canRemove: i,
            className: a,
        ...
        children: (0, n.jsxs)("div", {
            ...
            children: [
                (0, n.jsxs)(p.D, {
                    ...
                    children: [
                        o,
                        i ? (0, n.jsx)(v.P, { size: "md", color: U, className: F.s$, "aria-hidden": !0 }) : null,
                    ],
                }),
...
function K(e) {
    ...
    return (0, n.jsx)(N.Y, {
        ...
        renderPopout: (l) => {
            let { position: s } = l;
            return (0, n.jsx)(X, { ...e, position: s ?? "top" });
        },
        position: "top",
        align: "center",
        children: (e) =>
...
function Q(e) {
    ...
    function j(e) {
        return !(0, z.Oy)(e) && !e.managed && U.A.isRoleHigher(s, h, e) && (null == g || -1 === g.roles.indexOf(e.id));
    }
    return (0, n.jsx)(N.Y, {
        targetElementRef: l,
        renderPopout: (e) => {
