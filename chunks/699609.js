...
function z() {
    ...
    function h(e) {
        ...
        null != t &&
            (p.A.isFullServerPreview(t) && (0, S.pX)(b.BVt.CHANNEL(t)),
    ...
    return (0, i.jsxs)(c.$T, {
        ...
        children: [
            ...
            o || s === b.BEX.ROLE_SUBSCRIPTIONS
                ? null
                : (0, i.jsx)($, { onClick: () => h({ backToSettings: !1 }), className: Y.ZY }),
        ],
    });
}
function Q(e) {
    ...
    return (0, a.bG)([p.A], () => p.A.isViewingRoles(t))
        ? (0, i.jsx)("div", {
              className: s()(Y.xd, { [Y.KF]: (0, M.isWindows)(), [Y.Xz]: (0, M.isMac)(), [Y.pS]: (0, M.isLinux)() }),
              children: (0, i.jsx)(z, {}),
          })
        : null;
}
