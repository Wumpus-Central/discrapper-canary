        ...
        h = l.useCallback(
            (e) => {
                ...
                let u =
                    ...
                    c = (0, j.hC)(u),
                    d = (function (e) {
                        if (e instanceof x.Sf && (0, x.Km)(e.type) && null != e.rateLimitPerUser && e.rateLimitPerUser > 0 && !(_.Z.can(w.Plq.MANAGE_CHANNELS, e) || _.Z.can(w.Plq.MANAGE_MESSAGES, e))) return { label: T.NW.string(T.t.Icu3bW) };
                    })(o),
                    b = f.includes(c),
                    h = {
                        key: c,
