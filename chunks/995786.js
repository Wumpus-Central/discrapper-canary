n.d(t, { s6: () => p, W5: () => m, Vj: () => N, E5: () => U, nV: () => S, wu: () => D, H0: () => R, G6: () => y });
var a = n(636537),
    r = n(228366),
    i = n(95561),
    o = n(71393),
...
async function p(e) {
    let t = L(e);
    return u(
        (await a.Bo.post({ url: I.Rsh.GUILD_AUTOMOD_VALIDATE_RULE(e.guildId), body: t, rejectWithError: (0, a.fT)() }))
            .body,
    );
}
async function y(e) {
    ...
    return (
        delete t.id,
        M((await a.Bo.post({ url: I.Rsh.GUILD_AUTOMOD_RULES(e.guildId), body: t, rejectWithError: (0, a.fT)() })).body)
    );
}
async function N(e) {
    let t = L(e);
    return M(
        (await a.Bo.patch({ url: I.Rsh.GUILD_AUTOMOD_RULE(e.guildId, e.id), body: t, rejectWithError: (0, a.fT)() }))
            .body,
    );
}
async function S(e, t) {
    return await a.Bo.del({ url: I.Rsh.GUILD_AUTOMOD_RULE(t, e), rejectWithError: (0, a.fT)() }), !0;
}
async function R(e) {
    let t = await a.Bo.get({ url: I.Rsh.GUILD_AUTOMOD_RULES(e), rejectWithError: (0, a.fT)() });
