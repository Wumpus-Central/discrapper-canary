"use strict";
n.d(t, { s6: () => I, W5: () => O, Vj: () => S, E5: () => y, nV: () => N, wu: () => R, H0: () => C, G6: () => T });
var i = n(636537),
    r = n(228366),
    s = n(95561),
    a = n(71393),
...
function h(e) {
    return null == e
        ...
        : Object.keys(e).reduce((t, n) => {
              ...
              return (
                  "object" != typeof e[n] || Array.isArray(e[n]) ? (t[i] = e[n]) : (t[i] = h(e[n])), (t[i] = e[n]), t
              );
          }, {});
}
var f = n(449585),
    E = n(652215);
function p(e) {
    return { type: e.type, metadata: h(e.metadata) };
}
function m(e) {
    let t = h(e.triggerMetadata);
    return (
        null != t && delete t.keywordLists,
        {
            ...
            trigger_metadata: t,
            actions: e.actions.filter(l.Vq).map(p),
            enabled: e.enabled,
...
async function I(e) {
    let t = m(e);
    return _(
        (await i.Bo.post({ url: E.Rsh.GUILD_AUTOMOD_VALIDATE_RULE(e.guildId), body: t, rejectWithError: !1 })).body,
    );
}
async function T(e) {
    let t = m(e);
    return (
        delete t.id,
        A((await i.Bo.post({ url: E.Rsh.GUILD_AUTOMOD_RULES(e.guildId), body: t, rejectWithError: !1 })).body)
    );
}
async function S(e) {
    let t = m(e);
    return A((await i.Bo.patch({ url: E.Rsh.GUILD_AUTOMOD_RULE(e.guildId, e.id), body: t, rejectWithError: !1 })).body);
}
...
function O(e, t, n) {
    ...
    null == r ||
        (o.A.can(E.xBc.MANAGE_GUILD, r) &&
            (0, f.rI)(function () {
                (0, s.zV)(E.HAw.GUILD_AUTOMOD_FEEDBACK, {
