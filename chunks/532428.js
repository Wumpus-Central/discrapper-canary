...
function J(e) {
    ...
    let r = (0, S.ad)({ location: "channelValidator" }) || !1;
...
function eu(e) {
    ...
    if (
        ...
        return ec(t, n.guildId, r);
    let i = (0, S.ad)({ location: "getInFilterAutocompletions" }) || !1;
    return n.type === C.aib.DMS && !h.Z.hidePersonalInformation && i ? el(t, r, !0) : [];
}
