...
class h {
    ...
    setUser(t) {
        return (
            ...
            this._session && (0, c.qO)(this._session, { user: t }),
    ...
    update(t) {
        ...
        let e = "function" == typeof t ? t(this) : t,
            ...
            { tags: s, extra: o, user: a, contexts: c, level: u, fingerprint: h = [], propagationContext: l } = r || {};
        return (
    ...
    addBreadcrumb(t, e) {
        ...
        if (r <= 0) return this;
        let n = { timestamp: (0, s.lu)(), ...t },
            i = this._breadcrumbs;
        return i.push(n), (this._breadcrumbs = i.length > r ? i.slice(-r) : i), this._notifyScopeListeners(), this;
    }
    getLastBreadcrumb() {
    ...
    captureException(t, e) {
        ...
        return (
            this._client.captureException(t, { originalException: t, syntheticException: n, ...e, event_id: r }, this),
            r
        );
    }
    captureMessage(t, e, r) {
        ...
        let i = Error(t);
        return (
            this._client.captureMessage(t, e, { originalException: t, syntheticException: i, ...r, event_id: n }, this),
            n
        );
    }
    captureEvent(t, e) {
        ...
        return (
            this._client
                ? this._client.captureEvent(t, { ...e, event_id: r }, this)
