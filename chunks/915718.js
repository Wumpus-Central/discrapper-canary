...
function O(e) {
    ...
    let { channel: n } = e,
        ...
        { notFriend: x, isBlocked: I } = (0, a.cj)([b.Z], () => ({
            notFriend: n.type === A.d4z.DM && null != C && !b.Z.isFriend(C),
            isBlocked: n.type === A.d4z.DM && null != C && b.Z.isBlocked(C)
        })),
