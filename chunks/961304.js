...
class d extends r.Z {
    ...
    destroy() {
        ...
        null == (e = this.audioElement) || e.pause(),
            null != this.videoStreamId && (0, o.jC)(this.videoStreamId),
            ...
            this.setSpeakingFlags(s.Dg.NONE),
    ...
    addTrack(e) {
        ...
        return (
            "video" === e.kind &&
                ...
                (this.videoStreamId = (0, o.N7)(this.stream)),
    ...
    removeTrack(e) {
        return (
            ...
            "video" === e.kind &&
                (null != this.videoStreamId && (0, o.jC)(this.videoStreamId), this.emit("video", null)),
            this.stream.getTracks().length
        );
    }
    setSinkId(e) {
    ...
    constructor(e, t) {
        super(),
            l(this, "id", void 0),
            l(this, "_speakingFlags", s.Dg.NONE),
            l(this, "_mute", !1),
            l(this, "_volume", s.Qx),
            l(this, "sinkId", null),
