                        ...
                        x(
                            {
                                ...
                                className: i()(j.x6, n),
                                "data-dnd-name": s,
                                "aria-label": O.intl.formatToPlainString(O.t.HWNJJN, { widgetTitle: s }),
                                "aria-describedby": o,
...
let A = (e) => {
        let { children: t } = e,
            ...
            { isDragging: l } = (0, a.V)((e) => ({ isDragging: e.isDragging() }));
        return (0, r.jsx)(o.m_, {
    ...
    w = (e) => {
        let { children: t, widget: l, targetRef: i, additionalMenuItems: a } = e,
            ...
            o = (e) => {
                if (e.shiftKey) {
                    (0, g.qA)(l),
                        s(x({ action: "WIDGET_REMOVED" }, l.getProfileEditAnalyticsOptions())),
