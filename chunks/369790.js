...
function g() {
    let { guildId: e, channelId: t } = (0, u.A)((e) => {
        ...
        n = (0, s.bG)([h.A], () => h.A.getGuild(e)),
        g = (0, s.bG)([d.A], () => (null == n ? d.A.getChannel(t) : null)),
        _ = (0, s.bG)([m.default], () => m.default.getCurrentUser()),
        x = null != g ? (0, o.Y)(g) : null,
        A = null != _ ? _.getAvatarURL(e, 80) : p.vI["0"],
        C = (0, i.jsx)(r.eu, { src: A, "aria-hidden": !0, size: a._3.SIZE_80, className: f.HT }),
        E = null;
    return (
        (E =
            null != n
                ? (0, i.jsx)(c.Ay, { guild: n })
                : null != x
                  ? (0, i.jsx)(r.eu, { "aria-hidden": !0, src: x, size: a._3.SIZE_80, className: f.HT })
                  : C),
        (0, i.jsxs)("div", {
            className: f.kL,
            children: [
                (0, i.jsx)("div", { className: f.$H, children: C }),
                (0, i.jsx)("div", { className: f.XN, children: E }),
                (0, i.jsx)("svg", {
                    className: f.bm,
                    ...
                    children: (0, i.jsxs)("g", {
                        ...
                        children: [
                            ...
                            (0, i.jsxs)("g", {
                                ...
                                children: [
                                    (0, i.jsx)("circle", { cx: "2.5", cy: "2.5", r: "2.5" }),
                                    (0, i.jsx)("circle", { cx: "10.5", cy: "2.5", r: "2.5" }),
                                    (0, i.jsx)("circle", { cx: "18.5", cy: "2.5", r: "2.5" }),
                                ],
                            }),
                            (0, i.jsx)("rect", {
                                width: "40",
