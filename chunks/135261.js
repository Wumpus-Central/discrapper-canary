        ...
        : (0, r.jsxs)("div", {
              ...
              children: [
                  (0, r.jsx)(E, {
                      slateEditor: o,
                      markdownSyntax: "bold",
                      children: (0, r.jsx)(u.$oz, { size: "md", color: "currentColor", className: s()(h.Kk, i) }),
                  }),
                  (0, r.jsx)(E, {
                      slateEditor: o,
                      markdownSyntax: "italics",
                      children: (0, r.jsx)(u.yOR, { size: "md", color: "currentColor", className: s()(h.Kk, i) }),
                  }),
                  (0, r.jsx)(E, {
                      slateEditor: o,
                      markdownSyntax: "strikethrough",
                      children: (0, r.jsx)(u.t64, { size: "md", color: "currentColor", className: s()(h.Kk, i) }),
                  }),
                  (0, r.jsx)("div", { className: s()(h.yF, a) }),
                  !n?.disableBlockQuotes &&
                      (0, r.jsx)(A, {
                          slateEditor: o,
                          blockType: "blockQuote",
                          children: (0, r.jsx)(u.cyi, { size: "md", color: "currentColor", className: s()(h.Kk, i) }),
                      }),
                  !n?.disableInlineCode &&
                      (0, r.jsx)(E, {
                          slateEditor: o,
                  ...
                  (0, r.jsx)(E, {
                      ...
                      children: (0, r.jsx)(u.bMW, { size: "md", color: "currentColor", className: s()(h.Kk, i) }),
                  }),
              ],
          });
}
let g = i.forwardRef(function (e, t) {
    ...
    let { x: S, y } = i.useMemo(() => {
            ...
            let d = c.getBoundingClientRect(),
                f = s.x === u.x,
                h = f ? d.x : Math.min(s.x, u.x),
                m = f ? d.x + d.width : Math.max(s.x, u.x),
                g = a.current?.getBoundingClientRect()?.y ?? 0;
            return { x: h + (m - h) / 2, y: Math.max(g, Math.min(u.y, s.y)) };
        }, [a, _, n]),
        [v, C] = i.useState(0),
        [N, b] = i.useState(0);
    ...
    null == S || null == y || null == n.current?.getSlateEditor())
        ...
        : (0, r.jsx)(c.Ay, {
              children: (0, r.jsx)("div", {
                  ...
                  children: (0, r.jsx)(m, { editorRef: n, options: s }),
              }),
          });
});
function E(e) {
    ...
    return (0, r.jsx)("button", { "aria-pressed": s, className: h.x6, onClick: a, children: i });
}
function A(e) {
    let { blockType: t, slateEditor: n, children: i } = e,
        ...
        s = null != n ? p.VW.getCurrentBlock(n) : null,
        o = null != s && p.AS.isType(s[0], t);
    return (0, r.jsx)("button", { "aria-pressed": o, className: h.x6, onClick: a, children: i });
}
