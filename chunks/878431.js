                ...
                o
                    ? (0, i.jsx)(eN.m, {
                          ...
                          children: (0, i.jsx)(nZ.$n, {
                              ...
                              children: (0, i.jsx)(nq.R, { size: "xs", color: "currentColor", className: n4.IQ }),
                          }),
                      })
                    : null,
                (0, i.jsx)(n7.A, {
                    ...
                    children: (e) => {
                        ...
                        return (0, i.jsx)(eN.m, {
                            ...
                            children: (0, i.jsx)(nZ.$n, {
                                ...
                                children: (0, i.jsx)(nK.j, { size: "md", color: "currentColor", className: n4.IQ }),
                            }),
                        });
                    },
                }),
...
let te = s.memo(function (e) {
    let { entry: n } = e,
        [l, a] = s.useState(!1),
        r = null != (0, A.bG)([n2.A], () => n2.A.getGuild(n.guildId)),
        d = async () => {
            a(!0);
            try {
                r ? (0, n9.u)(n.guildId) : await nQ.A.joinGuild(n.guildId, { source: er.Q4z.DIRECTORY_ENTRY });
            } finally {
                a(!1);
            }
        },
        o = n3.Ay.getGuildSplashURL({ id: n.guildId, splash: n.splash, size: 300 * (0, n1.mZ)() }),
            ...
            children: [
                (0, i.jsxs)("div", {
                    ...
                    children: [
                        (0, i.jsx)("div", {
                            className: n4.Yi,
                            children: null != o && (0, i.jsx)("img", { src: o, alt: "", className: n4.j0 }),
                        }),
                        (0, i.jsx)("div", {
                            className: n4.$f,
                ...
                (0, i.jsxs)("div", {
                    ...
                    children: [
                        (0, i.jsxs)("div", {
                            className: n4.DD,
                            children: [
                                (0, i.jsx)(n0.A, { className: n4.n2, guild: n }),
                                (0, i.jsx)(y.E, {
                                    className: n4.J5,
                                    variant: "heading-md/semibold",
                                    color: "text-strong",
    ...
    return (0, i.jsx)(tE.Y, {
        ...
        children: (e, n) => {
            ...
            return (0, i.jsx)(tf.Ay.Icon, {
                ...
                onClick: () => a((e) => !e),
                tooltip: l ? null : o,
                icon: t === t9.CP.NO_MESSAGES ? t$.a : tZ.X,
                "aria-label": o,
                selected: l,
            });
        },
    ...
    return (0, i.jsxs)(i.Fragment, {
        children: [
            ...
            (0, i.jsx)(tf.Ay.Icon, {
                ...
                onClick: () => (0, t3.xu)((0, tH.j)(n), t ?? n.parent_id),
            }),
        ],
    });
}
...
function ln(e) {
    let { channelId: n } = e,
        ...
        r = (0, A.bG)([n2.A], () => n2.A.getGuild(l?.getGuildId())),
        d = (0, tx.Ay)(l),
        o = s.useRef(!1);
    if (
        (s.useEffect(() => {
...
function lI(e) {
    let { guildId: n, channelId: t } = e,
        ...
        a = (0, lm.uk)(n),
        r = (0, lm.Tq)(n),
        d = (0, A.bG)([n2.A], () => n2.A.getGuild(n), [n]),
        o = d?.name,
            ...
            return (
                s.useEffect(() => {
                    function t(t) {
                        ...
                        (0 === i.length || !0 === t) && l((0, i9.ur)(i)), n(t8.A.getThreadSettings(e.id) ?? {});
                    }
                    return (
                        t(!0),
...
function sk(e) {
    ...
    let l,
        ...
        c = (0, A.bG)([n2.A], () => n2.A.getGuild(o?.getGuildId())),
        h = (0, tx.Ay)(o);
    (n = o),
        ...
        s.useEffect(() => {
            l &&
                ...
                (0, tB.N9)(n, { source: t9.H9.VOICE_AUTO_OPEN }));
        }, [l, n]);
    let m = s.useRef(!1);
    if (
        (s.useEffect(() => {
        ...
        return null;
    let g = (0, i.jsx)(t4, { channel: o, baseChannelId: r });
    return (0, i.jsxs)(i.Fragment, {
        children: [
...
function s8(e) {
    let { context: n, analyticsLocations: t, profileFrame: l, handleOpenProfile: s } = e,
        ...
        r = a
            ...
            : null;
    return null != l
        ? (0, i.jsxs)("div", { className: s4.xQ, children: [(0, i.jsx)(s5.A, { frame: l, layout: "SIDEBAR" }), r] })
        : r;
}
var s6 = t(996988),
    ae = t(556818),
                  ...
                  u &&
                      (0, i.jsx)(a1, {
                          ...
                          items: o.map((e) => {
                              ...
                              return (0, i.jsx)(
                                  a$.A,
                                  { user: n, guild: t, nick: l, onSelect: () => (0, n9.u)(t.id) },
                                  t.id,
                              );
                          }),
                      }),
                  u && c && (0, i.jsx)(aK.A, { className: a9.yF }),
                  c &&
                      (0, i.jsx)(a1, {
...
let r1 = (0, ef.A)(r0),
    r9 = s.memo(function (e) {
        ...
        let l,
            ...
            C = (0, A.bG)([n2.A], () => n2.A.getGuild(f?.guild_id), [f]),
        ...
        let O = (0, A.bG)([eb.Ay], () => eb.Ay.getCurrentEmbeddedActivity()),
            ...
            V =
                ((n = C?.id),
                (l = (0, A.bG)([n2.A, iv, J.default, K.Ay], () => {
                    let e = n2.A.getGuild(n);
                    if (
            ...
            W =
                ((t = C?.id),
                (0, A.bG)([eG.A, n2.A, eU.A], () => {
                    let e = n2.A.getGuild(t);
                    if (
                        !(
