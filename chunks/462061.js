...
function k(e) {
    let {
        ...
        { user: B, streamId: q, speaking: Y } = t,
        z = B.id === H,
        K = (0, P.ZP)(t),
        G = (0, o.e7)([C.Z], () => C.Z.isFocused()),
        Q = (0, o.e7)([E.Z], () => E.Z.getWindowFocused(R.KJ3.CHANNEL_CALL_POPOUT)),
        ...
        $ = w.ZP.getName(n.getGuildId(), n.id, B) + (J ? " ".concat(T.intl.string(T.t["pFO/Ph"])) : ""),
        ee = Y && (Q || G),
        et = c < 124 ? D : N,
