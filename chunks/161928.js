...
var l = n(627968),
    ...
    I = n(653307),
    j = n(818050);
let S = s.Ay.connectStores([p.A, u.A, f.A, g.default], (e) => {
    let { giftCode: t } = e,
        n = p.A.get(t.skuId),
    ...
    let { error: t, giftCode: n, gifter: a, sku: s, application: u, subscriptionPlan: g } = e,
        f = null == a ? x.intl.string(x.t.lTGZAl) : x.intl.formatToPlainString(x.t.TjWdPc, { username: a.username }),
        p = s.name;
    return (
        null != g &&
