...
function j(e) {
    let { user: t, status: j, guildId: v, channelId: E, onSelect: T } = e,
        ...
        R = (0, m.A)(t.id),
        { voiceActivityStatusEnabled: k } = (0, c.g)({ location: "UserProfileMutualFriendRow" }),
        { voiceChannel: L } = (0, d.A)({ userId: k ? t.id : void 0, guildId: v });
        ...
        children: [
            ...
            (0, i.jsxs)("div", {
                ...
                children: [
                    ...
                    (0, i.jsx)(u.A, { user: t, activities: S, applicationStream: R, voiceChannel: L }),
                ],
            }),
        ],
    });
