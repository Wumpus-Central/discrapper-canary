...
function I(e) {
    let { user: t, status: I, guildId: j, channelId: v, onSelect: T } = e,
        ...
        N = a.useMemo(() => t.isNonUserBot() || (0, u.c)(t, v), [t, v]),
        { activities: S, isMobileOnline: y } = (0, l.cf)([m.A], () => ({
    ...
    return (0, i.jsxs)(s.DUT, {
        ...
        onContextMenu: (e) => {
            (0, r.L3)(e, async () => {
                let { default: e } = await Promise.all([n.e("97262"), n.e("11478"), n.e("32418"), n.e("73417")]).then(
                    n.bind(n, 668569),
                );
