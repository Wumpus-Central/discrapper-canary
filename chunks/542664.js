...
let U = (e) => {
    ...
    F = {
        ...
        mention: {
            ...
            parse(e, t, n) {
                ...
                null != s &&
                    ((i = s.id),
                    (r = s.toString()),
                    null != a && (r = h.Ay.getNickname(a.getGuildId(), n.channelId, s) ?? m.Ay.getName(s)));
                let o = e[1],
                    l = null != o && O.Ut1.test(o.trim()),
        ...
        attachmentLink: E.A.attachmentLink,
        commandMention: {
    ...
    X = (0, R.A)([
        {
            highlightWord: {
                ...
                match(e, t) {
                    if (
                        (null != t.parseDepth && t.parseDepth > Z) ||
