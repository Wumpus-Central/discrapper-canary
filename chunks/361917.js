...
function en(e) {
    let { context: n, entrypoint: t, searchQuery: a, setSearchQuery: o, setScroller: r, isScrollCloseToBottom: s } = e,
...
function es(e) {
    let n,
        t,
        { recommendationsSection: a, remainingActivities: o, isInstallOnDemand: r, position: s, context: u } = e,
        h = a.title;
    switch (a.type) {
