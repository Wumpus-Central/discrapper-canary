...
function U() {
    ...
    let { shouldMergeGameSettings: G } = A.b.useExperiment({ location: 'settings' }),
        ...
        H = null !== (n = null === (e = y.default.getCurrentUser()) || void 0 === e ? void 0 : e.isStaff()) && void 0 !== n && n,
        z = (0, C.y0)({ location: 'settings' }),
        Y = (0, j.v4)({ location: 'settings' }),
        K = (0, o.Q)(),
        q = (0, _.Zy)({ location: L.dr.USER_SETTINGS_SEARCH_GIFT_INVENTORY }),
        { enabled: X } = x.Z.useExperiment({ location: 'UserSettingsInventory' }, { autoTrackExposure: !0 }),
        J = (0, i.e7)([S.Z], () => S.Z.hasLibraryApplication()),
        Q = (0, i.e7)([O.default], () => O.default.hasTOTPEnabled()),
        $ = R.Sb.useSetting(),
        ee = (0, p.Z)(),
        { hypeSquadRemoved: et } = m.Z.useExperiment({ location: 'settings' }),
        en = null === (a = (0, h.Z)()) || void 0 === a || a,
        er = (null === (t = (0, E.s)()) || void 0 === t ? void 0 : t.length) > 0,
        ...
        ea = (0, u.B)({ location: 'SettingRendererUtils' }),
    ...
    return r.useMemo(
        ...
        [$, U, ei, es, J, er, Q, et, k, en, ea, q, Y, z, F, B, H, ee, W, K, G, X, P, v, el]
    );
}
function V(e) {
