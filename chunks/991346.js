...
function U() {
    ...
    let O = (0, b.YO)().length,
        A = (0, f.U)(),
        w = (0, r.e7)([N.Z], () => N.Z.getProps().impressionSource),
        k = (0, h.gU)(),
        B = (0, Z.bC)(),
        M = (0, o.Go)(),
        ...
        F = null != (n = null == (e = I.default.getCurrentUser()) ? void 0 : e.isStaff()) && n,
        H = (0, C.y0)({ location: 'settings' }),
        ...
        q = (0, r.e7)([E.default], () => E.default.hasTOTPEnabled()),
        X = P.Sb.useSetting(),
        J = (0, p.Z)(),
