...
function G() {
    ...
    return i.useMemo(
        ...
        [ee, G, es, el, J, er, $, en, L, ei, X, K, Y, z, U, W, et, B, q, H, Q, R, v, ea, eo, ec, ed, eu]
    );
}
function F(e) {
