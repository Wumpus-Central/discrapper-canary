...
function B(e) {
    ...
    let { handleStepChange: G, initialPlanId: D, planGroup: W, subscriptionTier: z, trialId: Y, referralTrialOfferId: K, handleClose: V } = e,
        { activeSubscription: q, hasFetchedSubscriptions: J, paymentSourceId: Q, paymentSources: X, selectedSkuId: $, selectedPlan: ee, step: en, defaultPlanId: et, priceOptions: ei, isPremium: el, premiumRebrandBackgroundClassName: es } = (0, P.JL)(),
        { isGift: er, giftRecipient: ea, giftMessage: eo, claimableRewards: eC } = (0, v.wD)(),
        ...
        ef = !er && null != $ && $ === R.Si.TIER_2 && null != ej && ej.hasHadPremium() && J && null == q && (0, c.aQ)(ex),
        e_ = (0, f.N)(K),
        em = !er && null != e_ && null != $ && R.nG[e_.trial_id].skus.includes($),
        eL = (0, j.Ng)(),
        eg = null == eL || null == (t = eL.discount) ? void 0 : t.plan_ids.some((e) => R.GP[e].skuId === $),
        ey = !er && null != eL && null != $ && eg,
        eS = null != (s = em || ey) && s,
        eE = l.useMemo(
            () =>
                (0, b.V7)({
        ...
        eb = ey && eE.includes(R.Xh.PREMIUM_MONTH_TIER_2) ? R.Xh.PREMIUM_MONTH_TIER_2 : eE[0],
        ev = (0, a.e7)([y.Z], () => y.Z.get(eb)),
        eP = [
            {
        ...
        : (r()(null != en, 'Step should be set'),
          ...
          (0, i.jsxs)(i.Fragment, {
              children: [
                  ...
                  !(er && (0, S.pO)(ea)) && (0, i.jsx)(I.Z, { isEligibleForTrial: em }),
                  (0, i.jsxs)(M.C3, {
                      children: [
