...
function G(e) {
    var r, t, l, G;
    let { handleStepChange: H, initialPlanId: D, planGroup: W, subscriptionTier: Y, trialId: z, referralTrialOfferId: K, handleClose: V } = e,
        { activeSubscription: q, hasFetchedSubscriptions: J, paymentSourceId: Q, paymentSources: X, selectedSkuId: $, selectedPlan: ee, step: er, defaultPlanId: et, priceOptions: en, isPremium: ei, premiumBrandRefreshBackgroundClassName: el } = (0, I.JL)(),
        ...
        ex = (0, a.e7)([b.default], () => b.default.getCurrentUser()),
        em = !eo && null != $ && $ === k.Si.TIER_2 && null != ex && ex.hasHadPremium() && J && null == q && (0, c.aQ)(e_),
        eh = (0, m.N)(K),
