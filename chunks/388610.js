...
function x(e) {
    ...
    if (a === o) {
        ...
        if (null == t) return !1;
        (o = a = t), (s = v.Z.getChannel(o.parent_id));
    } else {
        let t = v.Z.getChannel(e);
        if (null == t) return !1;
        (a = t), null != o && ((o = o.set('permissionOverwrites', a.permissionOverwrites)), (s = v.Z.getChannel(o.parent_id)));
    }
    return !0;
}
function M(e) {
...
function U() {
    (w = !1), (A = O.QZA.CLOSED), (r = null), (o = a = null), (s = null), (R = {});
}
function G() {
