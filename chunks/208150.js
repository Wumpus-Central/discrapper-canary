...
let O = {
    ...
    N = (e) => {
        ...
        return null == u || a === b.Eu4.TIER_3 || o > 0
            ? null
            : (m > d
                  ? ((t = _.intl.formatToPlainString(_.t.ZtAY1d, { level: u })), (n = _.intl.formatToPlainString(_.t['13hOWl'], { level: u })), (i = b.qAy.BOOST_UPSELL_BANNER_LOST_LEVEL))
                  : ((t = _.intl.string(_.t.zT9Sxc)),
                    (n = _.intl.formatToPlainString(_.t.YaW9wM, {
                        level: u,
                        numAdditional: (0, h.ig)(u)
                    })),
