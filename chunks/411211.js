...
class g {
    constructor(e, t) {
        ...
        const E = (0, l.W)(o, "style", "string", ["long", "short", "narrow", "digital"], "short");
        (A.style = E), (A.dataLocale = x.dataLocale);
        let y = "";
        _.forEach((e) => {
            let { styleSlot: t, displaySlot: a, unit: n, values: r, digitalDefault: l } = e,
                i = (0, d.$)(n, o, E, r, l, y);
            (A[t] = i.style),
                (A[a] = i.display),
    ...
    formatToParts(e) {
        ...
        let t = (0, h.H)(e),
            a = (0, u.m)(this, t),
            n = [];
        for (let { type: e, unit: t, value: r } of a) {
            let a = { type: e, value: r };
            t && (a.unit = t), n.push(a);
        }
        return n;
    }
