...
let m = {
    [f.Etm.SEND_ANALYTICS_EVENT]: {
        ...
        handler(e) {
            ...
            if (null == p) throw new u.Z({ errorCode: f.lTL.INVALID_COMMAND }, 'Invalid channel');
            let m = o.Z.getApplication(a);
            if (!(0, c.yE)(null !== (t = null == m ? void 0 : m.flags) && void 0 !== t ? t : 0, f.udG.EMBEDDED_FIRST_PARTY)) throw new u.Z({ errorCode: f.lTL.INVALID_COMMAND }, 'This application cannot access this API');
            let b = (0, l.U)(a),
                _ = {
    ...
    [f.Etm.GET_APPLICATION_TICKET]: {
        ...
        handler(e) {
            let { socket: t } = e,
                n = t.application.id;
            if (null == n) throw new u.Z({ errorCode: f.lTL.INVALID_COMMAND }, 'No application.');
            return r.tn
                .post({
