...
class F extends l.PureComponent {
    ...
    static contextType = w.C;
    rootRef = l.createRef();
    focusTimeout = new P.Ep();
    componentDidMount() {
        this.setState({ shown: !0 }), G._.subscribe(k.jej.QUICKSWITCHER_RESULT_FOCUS, this.handleResultFocus);
    }
    componentWillUnmount() {
        this.focusTimeout.stop(), G._.unsubscribe(k.jej.QUICKSWITCHER_RESULT_FOCUS, this.handleResultFocus);
    }
    componentDidUpdate() {
...
let K = () =>
    (0, i.jsxs)("div", {
        className: W.p$,
        children: [
            (0, i.jsx)("div", { className: W.lv, children: V.intl.string(V.t.bpbATE) }),
            (0, i.jsx)("div", {
                className: W.PA,
                children: (0, i.jsx)(g.Anchor, {
                    href: M.A.getArticleURL(k.MVz.QUICK_SWITCHER_TUTORIAL),
...
let z = A.Ay.connectStores([R.Ay, N.A], (e) => {
        let { channel: t } = e;
        return {
    ...
    X = A.Ay.connectStores([T.default], (e) => {
        let { guild: t } = e;
        return { unread: T.default.hasUnread(t.id) };
    })(D.OS),
    Q = A.Ay.connectStores([R.Ay, y.A], (e) => {
        let { channel: t } = e,
            n = null,
    ...
    J = A.Ay.connectStores([N.A, R.Ay, y.A], (e) => {
        let { user: t } = e,
...
class $ extends l.PureComponent {
    ...
    componentDidMount() {
        C.A.disable(), C.A.enableTemp(E.w);
    }
    componentWillUnmount() {
        C.A.disableTemp(), C.A.enable();
    }
    ...
    selectResult = (e) => {
        (0, o.F6)(e, this.props.queryMode === x.rD.TEXT_CHANNEL);
    };
    handleContextMenu = (e) => {
    ...
    handleKeyDown = (e) => {
        ...
        switch (l) {
            ...
            case "arrowup":
                s = (0, x.Vv)(x.vB.UP, s, i);
                break;
            case "arrowdown":
                s = (0, x.Vv)(x.vB.DOWN, s, i);
                break;
            case "n":
                if (!e.ctrlKey) return;
                s = (0, x.Vv)(x.vB.DOWN, s, i);
    ...
    renderInput() {
        ...
        return (0, i.jsxs)(i.Fragment, {
            children: [
                (0, i.jsx)(O.EG, { event: k.jej.GLOBAL_CLIPBOARD_PASTE, handler: this.handleGlobalPaste }),
                (0, i.jsx)(m.vN, {
    ...
    focusNode(e) {
        G._.dispatch(k.jej.QUICKSWITCHER_RESULT_FOCUS, { node: e });
    }
    getRowId(e) {
    ...
    renderRow = (e) => {
        let { row: t } = e,
            ...
            { selectedIndex: l } = this.props,
            { showScores: s } = I.getCurrentConfig({ location: "62f4be_1" }, { autoTrackExposure: !1 });
        switch (n.type) {
            case x.rD.HEADER:
    ...
    renderProtip() {
        return (0, i.jsx)(b.A, {
            className: u()(W.PP, { [W.ov]: this.state.query.length > 0 }),
            type: b.A.Types.INLINE,
            children: V.intl.format(V.t.wukqXQ, {
                userSymbolHook: (e, t) => Z(t, x.AT.USER, V.intl.string(V.t.GQRCGn)),
                textChannelSymbolHook: (e, t) => Z(t, x.AT.TEXT_CHANNEL, V.intl.string(V.t.wrwhuZ)),
                voiceChannelSymbolHook: (e, t) => Z(t, x.AT.VOICE_CHANNEL, V.intl.string(V.t["jz+hJp"])),
                guildSymbolHook: (e, t) => Z(t, x.AT.GUILD, V.intl.string(V.t.WuwCWi)),
                helpdeskArticle: M.A.getArticleURL(k.MVz.QUICK_SWITCHER_TUTORIAL),
            }),
        });
    }
    renderTutorial() {
        ...
        return t ? null : (0, i.jsx)(F, { hasQuery: e.length > 0 && n.length > 0 });
    }
    render() {
        return (0, i.jsx)(h.d, {
            "aria-label": V.intl.string(V.t.ZvKwYa),
