...
class y extends i.Ay.Store {
    ...
    __getLocalVars = () => ({ channelEventMaps: p, lastLeftUserIds: E });
    getLastLeftUserId(e) {
        return E.get(e);
    }
    getHistory(e) {
...
let j = new y(s.h, {
        ...
        return (
            new Set(i.map((e) => e.oldChannelId).filter((e) => null != e)).forEach((e) => {
                ...
                0 === Object.keys(c.A.getVoiceStatesForChannel(e)).length &&
                    ((t = e), null != (n = p.get(t)) && n.clear(), E.delete(t), x.delete(t));
            }),
            i.forEach((e) => {
                let { userId: i, oldChannelId: l } = e,
                    s = null != l ? p.get(l) : null;
                null != l && null != s && s.values().length > 0 && v(l, i) && ((t = !0), n.add(l));
            }),
            l.forEach((e) => {
                let { userId: i, channelId: l } = e;
                null != l && p.has(l) && S(l, i) && ((t = !0), n.add(l));
            }),
            n.forEach(b),
            n.forEach(N),
            t
    ...
    CHANNEL_DELETE: function (e) {
        let { channel: t } = e;
        return !!p.has(t.id) && (p.delete(t.id), f.delete(t.id), E.delete(t.id), x.delete(t.id), !0);
    },
    ...
    CONNECTION_OPEN: function () {
        return 0 !== p.size && (p.clear(), f.clear(), E.clear(), x.clear(), !0);
    },
    RELATIONSHIP_UPDATE: T,
    RELATIONSHIP_ADD: T,
    RELATIONSHIP_REMOVE: T,
    LOAD_RELATIONSHIPS_SUCCESS: T,
});
