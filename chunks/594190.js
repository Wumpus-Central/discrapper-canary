...
function e$(e) {
    let { game: t } = e,
        n = eP(t);
    (ea.enableDetection[eS(t)] = !n), eD(), C.default.track(k.rMx.USER_SETTINGS_GAME_DETECTION_TOGGLE, { enabled: !n });
}
function e0(e) {
    let t = eS(e.game),
...
!__OVERLAY__ &&
    ...
    (eo = function () {
        ...
        let _ = j.g.getConfig({ location: "RunningGameStore.handleGamesDatabaseUpdate" }).enabled;
...
class e4 extends (i = c.ZP.Store) {
    ...
    getOverlayOptionsForPID(e) {
        let t = this.getGameForPID(e);
        return null == t || t.isLauncher || null == t.id ? null : B({}, es[t.id]);
    }
