...
function eI(e) {
    let [t, n, r] = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [eq, I.Z, T.Z],
        i = G(j({}, e), {
...
function ej(e) {
    ...
    (null == r.lastFocused || 0 === r.lastFocused) && (r.lastFocused = Math.floor(Date.now() / 1000)), (et.gameOverrides[t] = G(j({}, r), { add: !0 })), eC(X), eA(), ev(), em();
}
function eU() {
    eA();
}
...
class ez extends (i = c.ZP.Store) {
    initialize() {
        ...
        this.waitFor(I.Z, g.Z), (Z = a.gamesSeen), this.syncWith([g.Z], eK), this.syncWith([T.Z, I.Z, S.Z], o().throttle(eS, 1000)), s && ev();
    }
    getVisibleGame() {
