...
let B = new h.Z("RunningGameStore"),
    V = "RunningGameStore",
    H = !1,
    Y = "4294967293",
    W = [],
...
!__OVERLAY__ &&
    ((0, R.isDesktop)() || k.iP) &&
    (el = function () {
        if (!I.Z.hasAttemptedFetch || !L.Z.hasAttemptedFetch) return !1;
        let e = [],
            t = new Set();
        r = {};
        let n = I.Z.games,
        ...
        K.forEach((e) => {
            ...
            D.ZP.setObservedGamesCallback(e, !0, (e) => {
                let n = [],
                    ...
                    a = [];
                e = e.filter((e) =>
                    null != e.id && null != L.Z.getById(e.id)
                        ? (a.push(e), !1)
...
class te extends (i = c.ZP.Store) {
    initialize() {
        ...
        this.waitFor(C.Z, m.Z, I.Z, T.Z, L.Z),
            (W = a.gamesSeen.filter((e) => !(0, S.le)(e))),
            this.syncWith([m.Z], e7),
