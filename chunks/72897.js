...
function E(e) {
    ...
    return (0, r.useMemo)(() => {
        let e = p({}, i),
            t = e[d.w5];
        return (null != t && (e[d.w5] = m(p({}, t), { name: t.disabled ? o : t.name.replace(d.fU, _.intl.string(_.t.bBvAEB)) })), e);
    }, [i, o]);
}
function b(e) {
    let t = E(e),
...
function y(e, t) {
    let { location: n } = t,
        ...
        _ = E(e),
        { getAllDeviceIdsSortedByFrecency: f } = g(e),
        p = (0, o.Z)((0, a.Wu)([u.Z], () => f(u.Z))),
        { id: h } = b(e);
    return (0, r.useMemo)(() => {
        let e = (e) => e.map((e) => _[e]),
            t = Object.keys(_);
