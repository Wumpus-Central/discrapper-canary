...
class w extends (r = a.Component) {
    ...
    static preloadImage(e) {
        ...
        if (1 === i && 1 === a) return;
        let { format: f, quality: p } = w.getFormatQuality({
                src: t,
                original: s,
                animated: l,
                srcIsAnimated: o,
    ...
    static async trackLoadingCompleted(e) {
        ...
        let {
            ...
            format: u,
            quality: d,
            imageProps: { src: _, height: g, width: E, original: y, sourceMetadata: O }
        } = e;
        if ((i && f.Z.increment({ name: s.V.IMAGE_LOAD_ERROR }), !D.getCurrentConfig({ location: 'lazy_image' }).enabled)) return;
    ...
    getSrc(e) {
        let t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
            ...
            { format: l, quality: c } = w.getFormatQuality(T(v({}, this.props), { freeze: t }));
        return (0, _.Q4)({
            src: n,
            width: r,
            height: i,
    ...
    getRatio() {
        let { width: e, height: t, maxWidth: n = R, maxHeight: r = P, mediaLayoutType: i, useFullWidth: a } = this.props;
