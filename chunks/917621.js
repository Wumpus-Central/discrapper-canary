...
class I extends i.PureComponent {
    ...
    isEmbeddedActivityApplication() {
        return (0, g.Z)(this.props.activity, y.xjy.EMBEDDED);
    }
    canJoin() {
        let { activity: e, isPreview: t, isGameLaunchable: n, isInBrowser: r, isSender: i } = this.props;
        return !!t || (!(i || this.isDeadInvite() || !this.isActionType(y.mFx.JOIN) || !(0, g.Z)(e, y.xjy.JOIN) || !this.hasPartySize() || this.isPartyFull() || this.isInParty()) && (!!this.isEmbeddedActivityApplication() || (!r && !!n)));
    }
    canSendInvite() {
        let { activity: e, isPreview: t } = this.props;
        return !!t || !(this.isDeadInvite() || !this.isActionType(y.mFx.JOIN_REQUEST) || !(0, g.Z)(e, y.xjy.JOIN) || !this.hasPartySize() || this.isPartyFull());
    }
    canSync() {
        let { activity: e, isPreview: t, isSyncable: n, isInBrowser: r } = this.props;
        return !!t || !((!this.isActionType(y.mFx.LISTEN) && !this.isActionType(y.mFx.WATCH)) || this.isDeadInvite() || !(0, g.Z)(e, y.xjy.SYNC) || r || !n || this.isInParty());
    }
    ...
    render() {
        let { className: e, coverImage: t, name: n, activity: i } = this.props,
            ...
            u = null;
        null == t || null == i || l
            ? !l && c && (u = (0, r.jsx)('div', { className: v.artworkSpotifySessionEnded }))
            : (u = (0, r.jsx)('img', {
                  alt: '',
                  src: t,
            ...
            children: [
                (0, r.jsx)('div', {
                    ...
                    children: (0, r.jsx)('div', {
                        className: a()((0, f.l)(v, 'coverImage', this.getActionableMode()), null != u ? v.blurred : null),
