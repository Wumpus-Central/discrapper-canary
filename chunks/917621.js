...
class N extends i.PureComponent {
    ...
    renderActionButton() {
        ...
        return null != p
            ? p
            : !this.isDeadInvite() && this.isActionType(v.mFx.LISTEN) && null != l && null != s && null != a && (0, y.Ps)(l)
              ? c(
                    S(I({}, d), {
                        activity: a,
                        user: s.author
                                    ...
                                    : this.canSync()
                                      ...
                                      : this.canSendInvite()
                                        ...
                                        : this.isInParty()
                                          ...
                                          : {
                                                children: this.isActionType(v.mFx.JOIN_REQUEST) ? C.intl.string(C.t['hC/Ze3']) : C.intl.string(C.t.VJlc0d),
                                                disabled: !0
                                            }
                                : {
