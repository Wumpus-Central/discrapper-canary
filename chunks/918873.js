...
var n = i(64700),
    ...
    d = i(731854),
    T = i(985018);
let A = (0, r.Hn)(u.X.VOICE_AUDIO_SUBSYSTEM_SETTING, {
    ...
    useOptions: function () {
        ...
        return n.useMemo(() => {
            let n;
            return (
                (n = [{ id: d.rB.STANDARD, value: d.rB.STANDARD, label: T.intl.string(T.t.dqb2JZ) }]),
                t && n.push({ id: d.rB.LEGACY, value: d.rB.LEGACY, label: T.intl.string(T.t["TYfH+5"]) }),
                e && n.push({ id: d.rB.EXPERIMENTAL, value: d.rB.EXPERIMENTAL, label: T.intl.string(T.t.liQmtr) }),
                i && n.push({ id: d.rB.AUTOMATIC, value: d.rB.AUTOMATIC, label: T.intl.string(T.t.qNgtO1) }),
                n
            );
        }, [i, e, t]);
    },
