...
let _ = new Map(),
    ...
    v = (e) => {
        (I = new Map([...(p = e).values()].map((e) => [e.storeListingId, e]))),
            (m = new Map((0, d.P_)(p, !0).map((e) => [e.skuId, e]))),
            (A = [...(g = new Map((0, d.P_)(p, !1).map((e) => [e.storeListingId, e]))).values()]);
    },
    C = () => {
        (p = _), (m = f), (i = void 0), (T = !1), (S = new Set()), (r = void 0), (s = void 0), (O = {}), (R = 0);
    };
...
let D = new b(l.h, {
    COLLECTIBLES_CATEGORIES_FETCH: (e) => {
        (T = !0), (r = void 0), (s = void 0), (O = e.options);
    },
    COLLECTIBLES_CATEGORIES_FETCH_SUCCESS: (e) => {
        let t =
            e.categories.collections.length > 0
                ? e.categories.collections.map(c.A.fromStorefrontCollectionRecord)
                : e.categories.categories;
        if (0 === t.length) (p = _), (m = f);
    ...
    COLLECTIBLES_CATEGORIES_FETCH_FAILURE: (e) => {
        let { error: t } = e;
        (p = _), (m = f), (T = !1), (S = new Set()), (r = t), (s = Date.now());
    },
