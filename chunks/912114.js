    ...
    return (0, o.jsxs)('div', {
        ...
        children: [
            (0, o.jsxs)(i.P3F, {
                ...
                onClick: () => {
                    (0, i.ZDy)(async () => {
                        let { default: e } = await Promise.all([l.e('91689'), l.e('55849'), l.e('46003')]).then(l.bind(l, 192277));
                        return (n) =>
                            (0, o.jsx)(
                                e,
                                (function (e) {
...
let j = function (e) {
    ...
    let { channelId: l, onClose: c, transitionState: p } = e,
        ...
        b = (null !== (n = null == g ? void 0 : g.name) && void 0 !== n ? n : '').length > 0,
        C = (0, s.ZP)(g),
        f = (0, s.cO)(g),
        [v, _] = r.useState(b && null != C ? C : ''),
        [y, k] = r.useState(null);
    return null == g
        ? null
        : (0, o.jsx)('form', {
