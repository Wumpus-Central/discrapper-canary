...
function m(e) {
    let { sitekey: t, theme: n, size: r, onLoad: m, onVerify: y, onError: v, onExpire: C } = e,
        E = c.useRef(null),
        b = c.useRef(null),
        A = c.useRef({ onLoad: m, onVerify: y, onError: v, onExpire: C });
    (A.current = { onLoad: m, onVerify: y, onError: v, onExpire: C }),
        c.useEffect(() => {
            let e = !1;
            return (
                (function () {
