...
function c(e) {
    ...
    if ((0, i.Lt)(c, l.CP.ALL_MESSAGES)) return l.CP.ALL_MESSAGES;
    if ((0, i.Lt)(c, l.CP.ONLY_MENTIONS)) return l.CP.ONLY_MENTIONS;
    if ((0, i.Lt)(c, l.CP.NO_MESSAGES)) return l.CP.NO_MESSAGES;
...
function d(e) {
    return (0, r.bG)([o.A, a.Ay, s.A], () => c(e), [e]);
}
