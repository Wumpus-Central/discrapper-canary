...
class E extends l.G {
    constructor() {
        super("discord_protos.safety_common.v1.RestrictedState", [
            { no: 1, name: "restricted_until", kind: "message", T: () => d.D },
        ]);
    }
    create(e) {
        let t = {};
    ...
    internalBinaryRead(e, t, n, r) {
        ...
        for (; e.pos < a; ) {
            let [t, r] = e.tag();
            if (1 === t) i.restrictedUntil = d.D.internalBinaryRead(e, e.uint32(), n, i.restrictedUntil);
            else {
    ...
    internalBinaryWrite(e, t, n) {
        e.restrictedUntil &&
            d.D.internalBinaryWrite(e.restrictedUntil, t.tag(1, s.O0.LengthDelimited).fork(), n).join();
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? s.f$.onWrite : r)(this.typeName, e, t), t;
    }
}
...
class g extends l.G {
    constructor() {
        super("discord_protos.safety_common.v1.DeferredActionState", [
            { no: 1, name: "action_deferred_until", kind: "message", T: () => d.D },
        ]);
    }
    create(e) {
        let t = {};
    ...
    internalBinaryRead(e, t, n, r) {
        ...
        for (; e.pos < a; ) {
            let [t, r] = e.tag();
            if (1 === t) i.actionDeferredUntil = d.D.internalBinaryRead(e, e.uint32(), n, i.actionDeferredUntil);
            else {
                let a = n.readUnknownField;
                if ("throw" === a)
                    throw new globalThis.Error(`Unknown field ${t} (wire type ${r}) for ${this.typeName}`);
    ...
    internalBinaryWrite(e, t, n) {
        e.actionDeferredUntil &&
            d.D.internalBinaryWrite(e.actionDeferredUntil, t.tag(1, s.O0.LengthDelimited).fork(), n).join();
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? s.f$.onWrite : r)(this.typeName, e, t), t;
    }
}
...
class I extends l.G {
    constructor() {
        super("discord_protos.safety_common.v1.TempBannedState", [
            { no: 1, name: "banned_until", kind: "message", T: () => d.D },
            {
                no: 2,
                name: "classification_types",
                kind: "enum",
                repeat: 1,
                T: () => ["discord_protos.safety_common.v1.ClassificationType", c.N],
            },
        ]);
    }
    create(e) {
    ...
    internalBinaryRead(e, t, n, r) {
        ...
        for (; e.pos < a; ) {
            ...
            switch (t) {
                case 1:
                    i.bannedUntil = d.D.internalBinaryRead(e, e.uint32(), n, i.bannedUntil);
                    break;
                case 2:
    ...
    internalBinaryWrite(e, t, n) {
        if (
            (e.bannedUntil && d.D.internalBinaryWrite(e.bannedUntil, t.tag(1, s.O0.LengthDelimited).fork(), n).join(),
