...
let O = (0, _.Fe)({
    ...
    renderLoader: () => (0, i.jsx)("div", { className: R.Lq }),
});
function L(e) {
    let {
            attachment: t,
    ...
    let z = r.useRef(null);
    (0, m.A)(t.id, z);
    let Z = Math.min(W > 0 ? W : y, v),
        q = Z / $;
    q > b && (Z = (q = b) * $), Z < y && (q = (Z = y) / $);
    let X = Math.round(Math.min(Z, v)),
        Q = Math.round(Math.min(q, b)),
    ...
    return (0, i.jsx)("div", {
        className: s()(R.kL, { [R.HA]: D }, a),
        onClick: (e) => e.stopPropagation(),
        onContextMenu: B,
        style: D ? void 0 : { width: X, height: Q },
        children: (0, i.jsx)(O, {
            src: L,
            downloadUrl: t.url,
