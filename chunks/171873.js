...
let th = (e) => {
        ...
        return t === ed.q.PROFILE_FRAME
            ? (0, c.jsxs)("div", { className: tg.Ym, children: [r, (0, c.jsx)(e4.E, { type: "new" })] })
            : r;
    },
    tE = (e) => {
...
function tb(e) {
    ...
    d.useEffect(() => {
        let e = new ResizeObserver(() => {
            null == b.current || O(Math.floor(5 * getComputedStyle(b.current).gridTemplateColumns.split(/\s+/).length));
        });
            ...
            children: (0, c.jsxs)("div", {
                ...
                children: [
                    ...
                    m
                        ...
                        : (0, c.jsx)(tb, { scrollerRef: a, tab: n }, n),
                ],
            }),
        })
    );
        ...
        let {
            ...
            E = (0, eZ.yB)("FeedBlock"),
            {
                ...
                let { sortedSkuIds: t, hasShopDiscount: s, prioritizeUserDiscounts: l, orbsSupportedOnly: n } = e,
                    ...
                    o = r.length > 0 && a,
                    [c, u] = d.useState(o ? t5.RECOMMENDED : t5.POPULAR),
                ...
                return {
                    ...
                    sortOptions: d.useMemo(() => {
                        let e = [
                            { value: t5.POPULAR, label: G.intl.string(G.t.Y68e5p) },
                            { value: t5.RECENT, label: G.intl.string(G.t["51Bhiz"]) },
                            { value: t5.PRICE_LOW_TO_HIGH, label: G.intl.string(G.t.m8RVU2) },
                        ];
                        return o && e.unshift({ value: t5.RECOMMENDED, label: G.intl.string(G.t.zPWgFG) }), e;
                    }, [o]),
                    showRecommendationOption: o,
                    shuffleProducts: f,
                };
            })({ sortedSkuIds: l, hasShopDiscount: m, prioritizeUserDiscounts: a, orbsSupportedOnly: o }),
            b = (0, I.bG)([$.Ay], () => $.Ay.useReducedMotion),
                  ...
                  children: (0, c.jsxs)("div", {
                      ...
                      children: [
                          (0, c.jsxs)("div", {
                              className: t$.$6,
                              children: [
                                  (0, c.jsx)(sl, { label: s, personalizedResults: A }),
                                  (0, c.jsxs)("div", {
            ...
            () =>
                "nitro" === u
                    ...
                    : {
                          ...
                          onClick: () => (0, sG.default)({ applicationId: s }),
                          onMouseDown: () => (0, sG.G)({ applicationId: s }),
                      },
            [u, s],
        );
    return (0, c.jsx)(sU.A, {
    ...
    let m = l?.skuId ?? "",
        ...
        _ = d.useCallback(() => {
            if ((u(!0), t.isDismissible)) {
                ...
                (0, tT.$l)(tN.M.COLLECTIBLES_SHOP_WIDE_BANNER, e, { dismissAction: s0.i.USER_DISMISS });
            }
...
let ll = () => {
        ...
        return (0, c.jsxs)("div", {
            ...
            className: lt.kL,
            children: [
                l ? (0, c.jsx)("div", { className: lt.D7 }) : (0, c.jsx)(s7.A, { className: lt.Ki, src: ls.A }),
                (0, c.jsxs)("div", {
                    className: lt.Qs,
                    children: [
                        (0, c.jsx)(eu.D, {
    ...
    ln = (e) => {
        let { index: t, wideBannerBlock: s, tab: l } = e,
            n = s5.useConfig({ location: "CollectiblesShopBannerSelector" }),
            a = (0, s2.L)(P.PremiumTypes.TIER_2),
            r = (0, s4.O)();
        return !n || a || r || l !== R.G2.ORBS
            ? (0, c.jsx)(s1, { wideBannerBlock: s, tab: l }, t)
            : (0, c.jsx)(ll, {}, t);
    },
    la = (e) => {
                        ...
                        ((e, a, r) => {
                            ...
                            switch (e.type) {
                                ...
                                case tI.g.WIDE_BANNER:
                                    ...
                                    d = (0, c.jsx)(ln, { index: r, wideBannerBlock: e, tab: n }, r);
                                    break;
            ...
            (0, c.jsx)(X.Ch, {
                ...
                children: (0, c.jsxs)("div", {
                    ...
                    children: [
                        ...
                        (0, c.jsx)(sZ, { peaking: g, transitioning: l === R.Pf.OUT }),
                    ],
                }),
            })
        );
...
var li = s(154323),
    lo = s(295811);
let lc = { "Any:personalization-header": sl },
    ld = { [ec.b.SHOP_HOME]: lc },
    lu = { "1465939725649973269": lc, "1478495181551440044": lc },
    lg = () =>
        (0, c.jsx)("div", {
            style: {
        ...
        if (
            ...
            return t !== Y.HOME || o || l
                ...
                : (0, c.jsx)(eo.Z_, {
                      ...
                      requestParams: i,
                      overrides: ld[ec.b.SHOP_HOME],
                  });
        let u = (0, c.jsx)(eo.Qs, { tenantId: B.FYj, layoutId: s, overrides: lu[s] });
        return (0, c.jsxs)(c.Fragment, {
            children: [
                t === Y.ORBS && (0, c.jsx)(lg, {}),
                t === Y.ORBS ? (0, c.jsx)(ew.v3.Provider, { value: lm, children: u }) : u,
            ],
        });
    },
    lE = (e) => {
    ...
    lx = (e) => {
        let { handleTransition: t, tab: s, transitionState: l } = e,
            n = (0, v.uM)(),
            a = (0, I.bG)([lo.A], () => lo.A.getShopLayoutUrlOverride()),
            r = d.useRef(null),
                ...
                children: (0, c.jsxs)("div", {
                    ...
                    children: [
                        (0, c.jsxs)("div", {
                            ...
                            children: [
                                null != a && "" !== a ? (0, c.jsx)(lE, { url: a }) : (0, c.jsx)(lh, { tab: s }),
                                s !== Y.CATALOG &&
                                    o >= 36 &&
                                    (0, c.jsxs)("div", {
                                        className: t$.R$,
                        ...
                        (0, c.jsx)(sZ, { peaking: m, transitioning: l === R.Pf.OUT }),
                    ],
                }),
            })
        );
...
function lS(e) {
    ...
    return null != C
        ...
        : null != i
          ...
          : t === R.G2.HOME && x
            ? (0, c.jsx)(lx, { tab: Y.HOME, transitionState: n, handleTransition: p })
            : t === R.G2.ORBS && x
              ? (0, c.jsx)(lx, { tab: Y.ORBS, transitionState: n, handleTransition: p })
              : lf.includes(t)
                ? (0, c.jsx)(lr, { handleTransition: p, tab: t, transitionState: n })
                : (0, c.jsx)(tv, {
                      tab: t,
                      categories: E,
                      initialCategoryId: u,
...
let lI = { pink: "pinkCountdown" },
    lN = d.memo(function (e) {
        let { message: t, onClick: s, countdownEndDate: l, variant: n } = e,
            ...
            r = (0, lj.A)(a ?? 0, 1e3, void 0, null == a);
            ...
            { onClose: a } = (function () {
                ...
                return {
                    onClose: d.useCallback(() => {
                        if (0 === l) {
                            (0, sX.aX)(), (0, lv.openUserSettings)();
                            return;
                        }
                        (0, sX.EL)() ? (0, sX.aX)() : (0, sX.pX)(B.BVt.APP);
                    }, [l]),
                    source: l,
                    ...t,
                };
                ...
                children: (0, c.jsx)(O.iM, {
                    ...
                    children: (0, c.jsx)(lk, {
                        ...
                        children: (0, c.jsxs)("div", {
                            ...
                            tabIndex: -1,
                            children: [
                                (0, c.jsx)(lb.G, { handleTransition: ee, selectedTab: Q }),
                                null != er &&
                                    er.type === U.COUNTDOWN &&
                                    (0, c.jsx)(lN, {
                                        message: er.message,
