n.d(t, { Z: () => L }), n(47120), n(653041), n(230036);
var r = n(200651),
    i = n(192379),
    o = n(772848),
    a = n(924826),
...
function x(e) {
    let { user: t, currentUser: n, guild: l, guildMember: u, roles: d, highestRole: f, canManageRoles: p, onAddRole: _, onRemoveRole: S } = e,
        T = i.useRef({}),
        C = (e, t) => {
    ...
    let F = i.useMemo(() => 'roles-'.concat((0, o.Z)()), []),
        ...
        H = d.length,
        W = 0 === H ? y.NW.string(y.t['vR7M+/']) : y.NW.formatToPlainString(y.t.PCs0oq, { numRoles: H }),
        Y = (j ? d : x).map((e, i) => {
            var o;
            return (0, r.jsx)(
                E.Z,
                {
                    role: e,
                    guildId: l.id,
                    style: { maxWidth: j || i !== x.length - 1 ? P : M },
...
function L(e) {
    let { user: t, currentUser: n, guild: o } = e,
        ...
        c = (0, l.e7)([p.Z], () => p.Z.getRoles(o.id)),
        ...
        v = m.e9(o, n.id),
        [y] = (0, l.Wu)([_.Z], () => [_.Z.can(b.Plq.MANAGE_ROLES, o), null != o ? _.Z.getGuildVersion(o.id) : null]),
        O = i.useCallback(
            (e) => {
                var n, r;
