...
let G = (e) => {
    ...
    return (0, s.jsxs)(o.B, {
        ...
        className: F.kL,
        children: [
            (0, s.jsx)(u.D, { variant: "heading-lg/semibold", className: F.R_, children: l }),
            (0, s.jsx)(U.c, { children: t }),
...
let B = {
    ...
    H = (e) => {
        let { onSubmit: t, disabled: n } = e,
            { task: i } = T(),
            l = B[i.ui_component.component.type];
        return null == l
            ? null
            : (0, s.jsx)(l, {
...
function X(e) {
    ...
    return (
        ...
        (0, s.jsxs)(v.Provider, {
            value: o,
            children: [(0, s.jsx)(q, {}), (0, s.jsx)(H, { onSubmit: n, disabled: i })],
        })
    );
}
let J = function (e) {
    ...
    let O = a.useMemo(() => i?.task_type === N.AGE_VERIFICATION, [i]);
    return (0, s.jsxs)("div", {
        className: $.Tp,
        children: [
            (0, s.jsx)("img", { className: $.xX, src: Y, alt: "" }),
            O
                ? (0, s.jsx)(p.default, {
                          ...
                          : (0, s.jsx)("div", {
                                ...
                                children: (0, s.jsxs)(o.B, {
                                    ...
                                    children: [
                                        ...
                                        null === x &&
                                            null != i &&
                                            (0, s.jsx)(X, { task: i, handleSubmit: w, disabled: T }),
                                    ],
                                }),
                            }),
                  }),
