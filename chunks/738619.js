...
function F(e) {
    let { guildId: t, activity: n, showInviteEducation: i, isFocused: a, typingUsers: s, className: l, channel: c, isThreadCreation: u, renderDots: _, poggermodeEnabled: f, isComboing: p } = e,
    ...
    return (
        ...
        (0, r.jsxs)('div', {
            ...
            children: [
                ...
                f && p && (0, r.jsx)(E.Z, { channelId: c.id })
            ]
        })
    );
}
