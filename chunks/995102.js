...
function S(e, t) {
    ...
    switch (e.type) {
        ...
        case b.rbe.GROUP_DM:
            ...
            break;
        case b.rbe.DM:
            (E = n ? g.intl.format(g.t.byjuJm, { name: A }) : g.intl.string(g.t.LO3kaK)),
                (I = n ? g.intl.format(g.t["eC+9rj"], { name: A }) : g.intl.string(g.t["s5/5fm"]));
            break;
        default:
            (E = g.intl.string(g.t.tbeRRJ)), (I = g.intl.string(g.t.OYefme));
    }
    return m
        ? (0, a.jsx)(r.Drp, { id: "unmute-channel", label: I, subtext: C, action: () => h(!1) })
        : (0, a.jsx)(r.Drp, {
              id: "mute-channel",
              label: E,
              action: () => {
