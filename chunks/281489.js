...
let p = (e) => {
    ...
    g = (e) => {
        ...
        let m = r()(n)
            ...
            .value();
        for (let e = 0; e < d && m.length < s; e++) m.push((0, i.jsx)(p, { guildId: a }, `unknown-member-${e}`));
        let g = c - u - d;
        for (let e = 0; e < g && m.length < s; e++)
            m.push((0, i.jsx)(p, { empty: !0, guildId: a }, `empty-member-${e}`));
        let A = Math.max(Math.min(c - m.length, 99), 0);
        if (1 === A) {
            let e = n[s];
            m.push((0, i.jsx)(p, { member: e, guildId: a }, e.id));
        }
        return (0, i.jsx)("div", {
            className: h.iE,
