...
function U(e) {
    let { guildId: t } = e;
    (P = !0), null == t && D.guildFilter === S.NgX.THIS_SERVER && z({ guildFilter: S.NgX.ALL_SERVERS });
}
function G(e) {
...
function J() {
    j({ deletedMessages: o().filter(A, (e) => v.Z.isBlockedOrIgnoredForMessage(e)) }), (A = A.filter((e) => !v.Z.isBlockedOrIgnoredForMessage(e)));
}
function $(e) {
    let { channel: t } = e,
        n = [];
