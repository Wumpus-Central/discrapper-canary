...
function z(e) {
    let t = T({}, D);
    (D = a().defaults(a().pick(e, ['guildFilter', 'roleFilter', 'everyoneFilter']), D)), s.K.set(N, D);
...
function J() {
    j({ deletedMessages: a().filter(A, (e) => b.Z.isBlockedOrIgnoredForMessage(e)) }), (A = A.filter((e) => !b.Z.isBlockedOrIgnoredForMessage(e)));
}
function $(e) {
    let { channel: t } = e,
        n = [];
    (A = a().filter(A, (e) => e.channel_id !== t.id || (delete R[e.id], n.push(e), !1))), j({ deletedMessages: n });
}
function ee(e) {
    Q();
}
