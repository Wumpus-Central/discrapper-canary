...
function U(e) {
    let { guildId: t } = e;
    (R = !0), null == t && D.guildFilter === I.NgX.THIS_SERVER && z({ guildFilter: I.NgX.ALL_SERVERS });
}
function G(e) {
...
function Z(e) {
    ...
    let i = F(n, t);
    if (null == i) return !1;
    (A = A.slice()).unshift(i), (P[i.id] = !0), j({ addedMessages: [i] });
}
function H(e) {
    let t = e.message.id;
...
function $(e) {
    let { channel: t } = e,
        n = [];
    (A = o().filter(A, (e) => e.channel_id !== t.id || (delete P[e.id], n.push(e), !1))), j({ deletedMessages: n });
}
function ee(e) {
    Q();
}
