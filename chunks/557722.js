...
let p = {
    ...
    resendCode(r) {
        ...
        return (
            ...
            h.Bo.post({ url: i.Rsh.RESEND_PHONE, headers: e, body: { phone: r }, rejectWithError: !1 })
        );
    },
    beginAddPhone: (r, e) =>
        h.Bo.post({ url: i.Rsh.PHONE, body: { phone: r, change_phone_reason: e }, rejectWithError: !1 }),
    addPhone: (r, e, o) =>
        h.Bo.post({
            url: i.Rsh.PHONE,
    ...
    addPhoneWithoutPassword: (r) =>
        h.Bo.post({ url: i.Rsh.PHONE_VERIFY_NO_PASSWORD, body: { code: r }, rejectWithError: !1 }),
    beginReverifyPhone: (r, e) =>
        h.Bo.post({ url: i.Rsh.PHONE_REVERIFY, body: { phone: r, change_phone_reason: e }, rejectWithError: !1 }),
    reverifyPhone: (r, e, o) =>
        h.Bo.post({
    ...
    validatePhoneForSupport: (r) =>
        h.Bo.post({ url: i.Rsh.VERIFY_PHONE_FOR_TICKET, body: { token: r }, oldFormErrors: !0, rejectWithError: !1 }),
    async verifyPhone(r, e) {
        let o = !(arguments.length > 2) || void 0 === arguments[2] || arguments[2],
            t = arguments.length > 3 && void 0 !== arguments[3] && arguments[3],
            h = {},
            a = _.default.getFingerprint();
        null != a && "" !== a && (h["X-Fingerprint"] = a), t && (h.authorization = "");
