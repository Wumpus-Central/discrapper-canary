...
var e0 = n(355097),
    ...
    e2 = n(731854),
    e3 = n(375708);
let e5 = new f.A("MediaEngineStore"),
    e6 = "MediaEngineStore",
    e4 = {
        useAGC2: !0,
        enableAnalog: !1,
...
function ny(e) {
    let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : e2.x.DEFAULT,
        ...
        i = nl(t);
    return (Object.assign(i, e), !__OVERLAY__ && n && v.w.set(e6, tc), i);
}
function nD() {
    let e = no();
    (nk(e.inputDeviceId),
...
class n0 extends y.Ay.Store {
    ...
    initialize() {
        ...
        if (
            ...
            null != (e = v.w.get("audio")) && (v.w.set(e6, { [e2.x.DEFAULT]: e }), v.w.remove("audio")),
            (tc = v.w.get(e6) ?? {}),
            N().each(tc, (e) => {
                (N().defaultsDeep(e, ta()),
                    null != e.modeOptions &&
