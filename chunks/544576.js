...
var e0 = n(355097),
    ...
    e2 = n(731854),
    e3 = n(375708);
let e6 = new f.A("MediaEngineStore"),
    e5 = "MediaEngineStore",
    e4 = {
        useAGC2: !0,
        enableAnalog: !1,
...
let tc = {},
    ...
    tg = { [e2.dx]: nb("No Output Devices", e2.oh.AUDIO_OUTPUT) },
    tm = { [e2.dx]: nb("No Video Devices", e2.oh.VIDEO_INPUT) },
    tS = new b.Ep(),
    tN = !1,
    tC = !1,
    tO = !1,
    ...
    if (
        (n?.desktopSource != null &&
            ...
            (null != n.desktopSource.soundshareId && (0, p.isWindows)()
                ...
                : null != n.desktopSource.sourcePid && no().videoHook && U.c1(n.desktopSource.sourcePid),
...
function nf(e, t) {
    if (
        ...
        (0, B.QW)({ type: B.iy.NOISE_CANCELLER_ERROR, underlyingError: nE(e), voiceProcessingErrorDetails: t }),
    ...
    e === e2.CO.KRISP_VAD_CPU_OVERUSE
        ...
        : ((tY = !0), M.h.dispatch({ type: "MEDIA_ENGINE_NOISE_CANCELLATION_ERROR", code: e }));
}
function np(e, t) {
    let n = t === e2.$C.LIVE;
...
function nT(e) {
    return { enabled: e, ...(e ? e4 : { useAGC2: !1 }) };
}
function ng(e, t) {
...
function nm(e, t) {
    ...
    (n !== t && e6.info("Falling back to system noise suppression."),
        (t = n),
...
function nN(e) {
    ...
    if (
        ...
        ng(e, e$.A.hasAutomaticGainControl(n) || t.automaticGainControl),
        nm(e, t.noiseCancellation),
        e.setSpatialAudioEnabled(nj(t.audioMixerSettings)),
        nS(),
        (0, p.isWindows)() && L().satisfies(P.A?.os.release, ">=10.0.15063") && e.context === e2.x.DEFAULT)
    ) {
        let t = (function (e) {
                let { location: t } = e;
                return ef.getConfig({ location: t });
            })({ location: "updateConnectionVoiceProcessing" }),
            n = nU(tT[i.getInputDeviceId()]) || nU(tg[i.getOutputDeviceId()]);
...
function nO() {
    return (0, p.isMac)() && to.supports(e2.O5.SCREEN_CAPTURE_KIT) && L().satisfies(P.A?.os.release, el.e);
}
function nR() {
    return (
        (0, p.isWindows)() &&
...
function ny(e) {
    let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : e2.x.DEFAULT,
        ...
        i = nl(t);
    return (Object.assign(i, e), !__OVERLAY__ && n && v.w.set(e5, tc), i);
}
function nD() {
    let e = no();
    (nk(e.inputDeviceId),
...
function nv() {
    t_ || to.enable().then(() => M.h.dispatch({ type: "MEDIA_ENGINE_SET_AUDIO_ENABLED", enabled: !0, unmute: !1 }));
}
function nb(e, t) {
    return {
        id: e2.dx,
...
function nG(e, t) {
    let n = e[t] ?? e[e2.dx] ?? N()(e).values().first();
...
function nk(e) {
    (to.setAudioInputDevice(e),
        nx(e),
        (function (e) {
            if (!(0, p.isMac)()) return;
            let t = tT[e];
            t?.guid != null && to.watchDeviceHardwareMutedChange?.(t.guid);
        })(e));
}
function nF(e) {
...
function nV(e, t) {
    ...
    return (null != e && no().videoHook && U.GH(e), { soundshareId: null, soundshareSession: null });
}
function nH() {
    let e = e2.x.DEFAULT,
...
async function nX() {
    try {
        ...
        (e6.warn(`Failed to load Krisp module: ${t.message}`), ej.A.captureException(t));
        let e = e2.CO.KRISP_INIT_ERROR;
        if (t.message.includes(": ")) {
            let n = parseInt(t.message.substring(t.message.indexOf(": ") + 1));
            e = isNaN(n) || 0 === n ? e2.CO.KRISP_INIT_ERROR : n;
        }
        ((0, B.QW)({ type: B.iy.NOISE_CANCELLER_ERROR, underlyingError: nE(e) }),
            eM.default.track(eP.HAw.VOICE_PROCESSING, { noise_canceller_error: e }));
    } finally {
        tF = !1;
    }
...
class n0 extends y.Ay.Store {
    ...
    initialize() {
        ...
        if (
            ((l ??= new ed(to, this)),
            tS.start(te, () => {
                (e6.error("Device enumeration timed out"), eM.default.track(eP.HAw.DEVICE_ENUMERATION_TIMEOUT, {}));
            }),
            to.on(D.bg.Connection, (e) => {
                let t;
                (nK(), nd(e), nu(e), nN(e));
                let n = no();
                (e.setAttenuation(n.attenuation, n.attenuateWhileSpeakingSelf, n.attenuateWhileSpeakingOthers),
                    ...
                    (0, p.isWindows)()
                        ...
                        : (0, p.isMac)() && e.setExperimentFlag(e2.fd.H265_HARDWARE_DECODE_AVAILABLE, !0),
                    (0, p.isLinux)() && n.openH264Enabled && e.setExperimentFlag(e2.fd.USE_LIBOPENH264_DECODER, !0),
                    (function (e) {
                        let { location: t, disable: n = !1 } = e;
                    ...
                    (e.setExperimentFlag(e2.fd.SIGNAL_AV1_DECODE, !0),
                        ...
                        e.setExperimentFlag(
                            ...
                            !(
                                ...
                                L().satisfies(window?.DiscordNative?.os.release, e2.Dk)
                            ),
                        ));
                else if ((0, p.isLinux)()) {
            ...
            to.on(D.bg.VideoInputInitialized, (e) => {
            ...
            to.on(D.bg.AudioInputInitialized, (e) => {
            ...
            to.on(D.bg.ClipsRecordingRestartNeeded, () => {
                M.h.dispatch({ type: "CLIPS_RESTART" });
            }),
            to.on(D.bg.ClipsInitFailure, (e, t) => {
                let n = th < 3;
                ((th += 1),
                    M.h.wait(() => {
            ...
            to.on(D.bg.VoiceProcessingError, nf),
            to.on(D.bg.VideoFilterError, np),
            to.on(D.bg.SpatialAudioStatus, nI),
            to.on(D.bg.VoiceQueueMetrics, (e) => {
                let t = n1(e);
            ...
            l.reset(),
            (0, eG.w)().then((e) => {
                null != e && ((t6 = e.gpu_brand), (t5 = e.has_intel_hybrid_igpu), (t4 = e.gpu_count));
            }),
            to.on(D.bg.DeviceHardwareMutedChange, (e, t) => {
                M.h.dispatch({ type: "AUDIO_INPUT_DEVICE_HARDWARE_MUTED_CHANGED", deviceGuid: e, hardwareMuted: t });
            }),
            to.on(D.bg.SystemMicrophoneModeChange, (e) => {
                ((A = e), to.eachConnection(nN), i.emitChange());
            }),
            null != (e = v.w.get("audio")) && (v.w.set(e5, { [e2.x.DEFAULT]: e }), v.w.remove("audio")),
            (tc = v.w.get(e5) ?? {}),
            N().each(tc, (e) => {
                (N().defaultsDeep(e, ta()),
                    null != e.modeOptions &&
            ...
            nD(),
            ((0, p.isWindows)() || (0, p.isLinux)() || (0, p.isMac)()) && !__OVERLAY__ && !tF && !tB
                ? ((tF = !0), nX())
                : (0, p.isWeb)() && to.supports(e2.O5.NOISE_CANCELLATION)
                  ? ((tB = !0), i.emitChange())
                  : (0, p.isWeb)() && ny({ noiseCancellation: !1 }),
            (0, p.isLinux)() && nq(),
            nH(),
            (0, p.isDesktop)() && p.isPlatformEmbedded && !ni)
        ) {
            async function t() {
        ...
        ((0, p.isWindows)() &&
            ...
            this.waitFor(eY.default, eK.A, e$.A, ez.A, x.Ay, V.A, eX.A, j.Ay, ex.A, eq.default, eZ.A));
    }
    supports(e) {
    ...
    getOutputDeviceId() {
        return nG(tg, no().outputDeviceId);
    }
    getVideoDeviceId() {
        return nG(tm, no().videoDeviceId);
    }
    getInputDevices() {
        return tT;
    }
    ...
    getOpenH264Enabled() {
        return (0, p.isLinux)() && no().openH264Enabled;
    }
    getLoopback() {
        return t2.size > 0;
    }
    ...
    getPacketDelay() {
        let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : e2.x.DEFAULT;
        return p.isPlatformEmbedded || this.getMode(e) !== eP.TBI.VOICE_ACTIVITY
            ? 0
    ...
    supportsExperimentalSoundshare() {
        return to.supports(e2.O5.EXPERIMENTAL_SOUNDSHARE) && L().satisfies(P.A?.os.release, el.$x);
    }
    supportsHookSoundshare() {
        return (0, p.isWindows)() && to.supports(e2.O5.SOUNDSHARE) && L().satisfies(P.A?.os.release, el.ws);
    }
    ...
    getVideoEncoderExperiments(e, t) {
        ...
        if (
            ...
            e === e2.x.STREAM && "streamer" === t && (0, p.isWindows)())
        ) {
    ...
    supportsScreenSoundshare() {
        return (0, p.isMac)()
            ? to.supports(e2.O5.SOUNDSHARE) && L().satisfies(P.A?.os.release, el.P$) && nO()
            : (0, p.isWindows)()
              ? to.supports(e2.O5.SCREEN_SOUNDSHARE) && this.getExperimentalSoundshare()
              : !!(0, p.isLinux)() && to.supports(e2.O5.SCREEN_SOUNDSHARE);
    }
        ...
        !t$ &&
            ...
            (0, p.isWeb)() &&
                to.fetchAsyncResources({ fetchDave: !0 }).catch((e) => {
                    (e6.warn("DAVE preload failed:", e), ej.A.captureException(e));
                }));
    }
...
let n2 = (i = new n0(M.h, {
    ...
    VOICE_STATE_UPDATES: function (e) {
        ...
        return t.reduce((e, t) => {
            ...
            return (__OVERLAY__ || t.userId !== eY.default.getId() || null != eX.A.getChannelId() || n_(!1, null), e);
        }, !1);
    },
    CONNECTION_OPEN: function (e) {
        ((r = e.sessionId), (tN = !1), (tR = !1));
        let t = no();
        (nR() && (nL() ? nZ(e2.rB.AUTOMATIC) : t.automaticAudioSubsystem && nQ()),
            ...
            (0, p.isIOS)() && (to.setNcModels?.(ec), i.emitChange()),
            nx(t.inputDeviceId),
            nB());
    },
    ...
    AUDIO_SET_OUTPUT_DEVICE: function (e) {
        let { id: t } = e;
        (ny({ outputDeviceId: (t = nG(tg, t)) }), to.setAudioOutputDevice(t), to.eachConnection(nN));
    },
    ...
    AUDIO_SET_AUTOMATIC_GAIN_CONTROL: function (e) {
        ...
        (to.eachConnection((e) => ng(e, t.automaticGainControl)), nK(), nY(e.location));
    },
    AUDIO_SET_NOISE_CANCELLATION: function (e) {
        let t = ny({ noiseCancellation: e.enabled });
        (to.eachConnection((e) => nm(e, t.noiseCancellation)), nK(), nY(e.location));
    },
    AUDIO_SET_KRISP_MODEL_OVERRIDE: function (e) {
        (ev.A.setKrispModelOverride(e.model), (E = e.model), nK());
    },
    ...
    AUDIO_SET_KRISP_SUPPRESSION_LEVEL: function (e) {
        let { level: t } = e;
        ((_ = t), ev.A.setKrispSuppressionLevel(t));
    },
    AUDIO_SET_NOISE_CANCELLATION_ENABLE_STATS: function (e) {
        (0, p.isWeb)() || ((tj = e.enabled), to.setNoiseCancellationEnableStats?.(e.enabled));
    },
    ...
    MEDIA_ENGINE_DEVICES: function (e) {
        ...
        !(function (e) {
            let t = tg;
            if (
                ((tg = nw(e, { deviceType: e2.oh.AUDIO_OUTPUT, defaultName: e3.intl.string(e3.t.xlUg0v) })),
                !N().isEqual(tg, t))
            ) {
                let e = no(),
                    n = nG(tg, e.outputDeviceId);
        ...
        let n = tm;
        if (
            ((tm = nw(e, { deviceType: e2.oh.VIDEO_INPUT, defaultName: e3.intl.string(e3.t.WKWARY) })),
            tL && !N().isEqual(tm, n))
        ) {
            let e = void 0 !== tm[ty],
                t = ty === e2.dx && n[e2.dx]?.disabled,
                i = "Firefox" === O().name && "" === ty && n[ty]?.name === "Default" && !n[ty]?.disabled;
            n_(e || t || i);
        }
    },
    ...
    AUDIO_INPUT_DEVICE_HARDWARE_MUTED_CHANGED: function (e) {
        let { deviceGuid: t, hardwareMuted: n } = e,
            i = nG(tT, no().inputDeviceId),
            r = tT[i];
        if (t !== r?.guid) return !1;
        ((c = n), eM.default.track(eP.HAw.HARDWARE_MUTE_DETECTED, { input_device_name: r?.name, hardware_muted: n }));
    },
    ...
    MEDIA_ENGINE_SET_GO_LIVE_SOURCE: function (e) {
        ...
        if (t?.desktopSettings != null) {
            ...
            (p.isPlatformEmbedded && ({ soundshareId: e, soundshareSession: n } = nV(o, r)),
    ...
    MEDIA_ENGINE_SET_OPENH264_ENABLED: function (e) {
        let { enabled: t } = e;
        (ny({ openH264Enabled: t }), T.Ay?.setOpenH264Enabled?.(t));
    },
    ...
    MEDIA_ENGINE_NOISE_CANCELLATION_ERROR: function (e) {
        if (e.code === e2.CO.KRISP_CPU_OVERUSE) {
            ...
            let e = no();
            return (to.eachConnection((t) => nm(t, e.noiseCancellation)), nK(), nY(), !0);
        }
        return !1;
    },
        ...
        null != s &&
            ...
            (0, p.isWindows)() &&
                (null != s.desktopSource.soundshareId
                    ...
                    : null != s.desktopSource.sourcePid && no().videoHook && U.c1(s.desktopSource.sourcePid)));
