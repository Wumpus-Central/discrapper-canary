...
let l3 = { "nitro-wheel": r.t, gift: lz.o, orbs: i.C },
    ...
    l4 = {
        ...
        controls: {
            ...
            countryCode: { label: "Country Code", type: "select", defaultValue: lY.d.US, options: l8 },
    ...
    l5 = {
        ...
        stories: [
            ...
            },
            {
                ...
                controls: {
                    storeCountry: { label: "Store Country", type: "select", defaultValue: lY.d.US, options: l8 },
                },
            },
            {
