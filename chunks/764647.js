n.d(t, {
    ...
    function i(e, t, n) {
        let i, {
                reference: a,
                floating: s
            } = e, o = (0, r.TV)(t), l = (0, r.Dz)(t), c = (0, r.sq)(l), u = (0, r.C0)(t), d = 'y' === o, f = a.x + a.width / 2 - s.width / 2, p = a.y + a.height / 2 - s.height / 2, _ = a[c] / 2 - s[c] / 2;
        switch (u) {
        case 'top':
            i = {
                x: f,
    ...
    function o(e, t, n) {
        return (e ? [
            ...n.filter(t => (0, r.Sg)(t) === e),
            ...n.filter(t => (0, r.Sg)(t) !== e)
        ] : n.filter(e => (0, r.C0)(e) === e)).filter(n => !e || (0, r.Sg)(n) === e || !!t && (0, r.aD)(n) !== n);
    }
    let l = function (e) {
            return void 0 === e && (e = {}), {
                name: 'autoPlacement',
                ...
                async fn(t) {
                    ...
                    let T = S.map(e => {
                        ...
                        }).sort((e, t) => e[1] - t[1]), C = (null == (a = T.filter(e => e[2].slice(0, (0, r.Sg)(e[0]) ? 2 : 3).every(e => e <= 0))[0]) ? void 0 : a[0]) || T[0][0];
                    return C !== u ? {
                        data: {
                            index: y + 1,
                            overflows: S
            ...
            return void 0 === e && (e = {}), {
                ...
                async fn(t) {
                    ...
                    if (null != (n = u.arrow) && n.alignmentOffset)
                        return {};
                    let A = (0, r.C0)(c), v = (0, r.TV)(f), S = (0, r.C0)(f) === f, I = await (null == p.isRTL ? void 0 : p.isRTL(_.floating)), T = g || (S || !y ? [(0, r.bV)(f)] : (0, r.WJ)(f)), C = 'none' !== b;
                    !g && C && T.push(...(0, r.lP)(f, y, b, I));
                    let N = [
                            f,
                            ...T
                        ], R = await s(t, O), w = [], P = (null == (i = u.flip) ? void 0 : i.overflows) || [];
                    if (h && w.push(R[A]), m) {
                        let e = (0, r.w7)(c, d, I);
                        w.push(R[e[0]], R[e[1]]);
                    }
                    if (P = [
                        ...
                        if (t && ('alignment' !== m || v === (0, r.TV)(t) || P.every(e => (0, r.TV)(e.placement) !== v || e.overflows[0] > 0)))
                            return {
                                data: {
                                    index: e,
                                    overflows: P
    ...
    let m = function (e) {
            ...
            return void 0 === e && (e = {}), {
                ...
                async fn(t) {
                    ...
                    if (o) {
                        let e = 'y' === _ ? 'top' : 'left', t = 'y' === _ ? 'bottom' : 'right', n = h + f[e], i = h - f[t];
                        h = (0, r.qE)(n, h, i);
                    }
                    if (l) {
                        let e = 'y' === p ? 'top' : 'left', t = 'y' === p ? 'bottom' : 'right', n = m + f[e], i = m - f[t];
                        m = (0, r.qE)(n, m, i);
                    }
                    let g = c.fn({
                        ...t,
            ...
            return void 0 === e && (e = {}), {
                ...
                fn(t) {
                    ...
                    if (c) {
                        let e = 'y' === p ? 'height' : 'width', t = s.reference[p] - s.floating[e] + E.mainAxis, n = s.reference[p] + s.reference[e] - E.mainAxis;
                        h < t ? h = t : h > n && (h = n);
                    }
                    if (u) {
                        var b, y;
                        let e = 'y' === p ? 'width' : 'height', t = _.has((0, r.C0)(a)), n = s.reference[f] - s.floating[e] + (t && (null == (b = o.offset) ? void 0 : b[f]) || 0) + (t ? 0 : E.crossAxis), i = s.reference[f] + s.reference[e] + (t ? 0 : (null == (y = o.offset) ? void 0 : y[f]) || 0) - (t ? E.crossAxis : 0);
                        m < n ? m = n : m > i && (m = i);
                    }
                    return {
                        [p]: h,
            ...
            return void 0 === e && (e = {}), {
                ...
                async fn(t) {
                    ...
                    let a, o, {
                            ...
                            ...p
                        } = (0, r._3)(e, t), _ = await s(t, p), h = (0, r.C0)(l), m = (0, r.Sg)(l), g = 'y' === (0, r.TV)(l), {
                            width: E,
                            height: b
                        } = c.floating;
                    'top' === h || 'bottom' === h ? (a = h, o = m === (await (null == u.isRTL ? void 0 : u.isRTL(d.floating)) ? 'start' : 'end') ? 'left' : 'right') : (o = h, a = 'end' === m ? 'top' : 'bottom');
                    let y = b - _.top - _.bottom, O = E - _.left - _.right, A = (0, r.jk)(b - _[a], y), v = (0, r.jk)(E - _[o], O), S = !t.middlewareData.shift, I = A, T = v;
                    if (null != (n = t.middlewareData.shift) && n.enabled.x && (T = O), null != (i = t.middlewareData.shift) && i.enabled.y && (I = y), S && !m) {
                        let e = (0, r.T9)(_.left, 0), t = (0, r.T9)(_.right, 0), n = (0, r.T9)(_.top, 0), i = (0, r.T9)(_.bottom, 0);
