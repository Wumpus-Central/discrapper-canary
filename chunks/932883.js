"use strict";
n.d(t, { GM: () => p, Hi: () => S, Ml: () => A, P3: () => T, Ut: () => I, X8: () => g, op: () => m });
var r,
    i = n(627968),
    s = n(64700),
    a = n(835245),
...
function A(e) {
    ...
    d.default.track(E.HAw.NOTIFICATIONS_INBOX_ITEM_INTERACTED, {
        interaction_type: n,
        message_id: t.id,
...
function I(e) {
    ...
    d.default.track(E.HAw.NOTIFICATIONS_INBOX_SECTION_INTERACTED, { section: t, enabled: n, view_id: r });
}
function T(e) {
    let {
        timeToLoad: t,
    ...
    d.default.track(E.HAw.NOTIFICATIONS_INBOX_DATA_LOADED, {
        time_to_load: t,
        messages_count: n,
...
function S(e) {
    let {
        ...
        p = s.useRef(null),
        m = s.useRef(!1),
        g = (0, o.bG)([c.A], () => c.A.isLoading),
        A = (0, u.A)(g),
        I = (0, o.bG)([c.A], () => c.A.currentRequestAnalyticsPayload ?? null),
        { unreadRecentMentionsCount: S, unreadChannelIds: y } = (0, _.U4)();
    (0, l.Ay)(() => {
        !(function (e) {
            let { variant: t, viewId: n, entrypoint: r } = e;
            d.default.track(E.HAw.NOTIFICATIONS_INBOX_OPENED, { inbox_variant: t, inbox_entrypoint: r, view_id: n });
        })({ variant: t, viewId: a, entrypoint: n }),
            (p.current = Date.now());
    }),
        s.useEffect(() => {
            if (null != p.current && (r?.length > 0 || i?.length > 0) && !m.current) {
                ...
                (m.current = !0),
                    (function (e) {
                        ...
                        d.default.track(E.HAw.NOTIFICATIONS_INBOX_READY, {
                            time_to_load: t,
                            unreads_count: n,
        ...
        (0, l.l0)(() => {
            !(function (e) {
                ...
                d.default.track(E.HAw.NOTIFICATIONS_INBOX_UNMOUNTED, {
                    unreads_count: t,
