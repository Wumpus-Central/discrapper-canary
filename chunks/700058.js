...
let E = {
    push(e, t) {
        ...
        return (
            (0, d.GR)({
                modal: (function (e, t, n) {
                    ...
                    return {
                        key: t.key ?? i ?? "modal",
                        modal: e,
                        animation: t.animation ?? (u.Ay.useReducedMotion ? _.WMy.FADE : _.WMy.SLIDE_UP),
            ...
            s.h.dispatch({ type: "MODAL_PUSH", modal: e, props: t, key: n, appContext: r }),
            n
        );
    },
    pushLazy(e, t) {
        ...
        return null != r && r.isReady()
            ...
            : new Promise((r) => c.enqueue(() => r(this.pushLazy(e, t, n, i))));
    },
    updateAnimation(e, t) {
