...
let P = (e) => [
    ...
    D = r.memo(function (e) {
        let { channel: t, query: n } = e,
            [l] = (0, a.e7)([j.Z], () => [j.Z.getVoiceStatesForChannel(t.id), j.Z.getVoiceStateVersion()], [t.id], Z.Q),
            [o, u] = r.useState([]);
    ...
    L = r.memo(function (e) {
        ...
        let {
            ...
            b = v ? "text-feedback-positive" : r ? "interactive-text-active" : "text-muted",
            S = v
                    ...
                    .reduce(
                        (e, t) => [
                            ...
                            ...b.ZP.getChannels(t.id)
                                [b.Zb].filter(
                                    (e) => S.Z.can(N.Plq.VIEW_CHANNEL, e.channel) && S.Z.can(N.Plq.CONNECT, e.channel),
                                )
                                .map((e) => {
                                    let { channel: t } = e;
                                    return t;
