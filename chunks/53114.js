...
class y extends a.Z {
    ...
    getStats(e) {
        ...
        let t = Number(this.streamStart),
            ...
            { bytes: b, framesDropped: y, framesCodecError: O, framesCodec: v, framesNetwork: I, packets: T, packetsLost: S, nackCount: A, pliCount: N, qpSum: C, pauseCount: R, freezeCount: P, totalPausesDuration: w, totalFreezesDuration: D, totalFramesDuration: L, keyframes: x, passthroughCount: k, cryptorSuccessCount: M, cryptorFailureCount: j, cryptorDuration: U, cryptorAttempts: G, cryptorMissingKeyCount: B, cryptorInvalidNonceCount: V, qualityDecodeErrors: F, qualityDecoderReboots: Z, qualityScoreErrors: H, qualityFrameDrops: Y, qualitySizeMismatches: W } = e.aggregatedProperties;
        return (
