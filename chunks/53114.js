...
class y extends a.Z {
    ...
    getStats(e) {
        ...
        let n = Number(this.streamStart),
            ...
            _ = e.inboundBitrateEstimateHistogram.getReport(s),
            h = e.localWantHistogram.getReport(l),
            E = e.systemResources.getStats(),
            b = p(
                {
                    ...
                    inbound_bitrate_estimate_percentile1: _.percentiles[1],
                    inbound_bitrate_estimate_percentile5: _.percentiles[5],
                    inbound_bitrate_estimate_percentile10: _.percentiles[10],
                    inbound_bitrate_estimate_percentile25: _.percentiles[25],
                    inbound_bitrate_estimate_percentile50: _.percentiles[50],
                    inbound_bitrate_estimate_percentile75: _.percentiles[75],
                    inbound_bitrate_estimate_percentile99: _.percentiles[99],
                    local_want_percentile1: h.percentiles[1],
                    local_want_percentile5: h.percentiles[5],
                    local_want_percentile10: h.percentiles[10],
                    local_want_percentile25: h.percentiles[25],
                    local_want_percentile50: h.percentiles[50],
                    local_want_percentile75: h.percentiles[75],
                    local_want_percentile90: h.percentiles[90],
                    local_want_percentile95: h.percentiles[95],
                    average_local_want: h.mean,
    ...
    receivedStats(e, t, n) {
        ...
        ((this.cameraDuration.value = this.connection.context === o.Yn.DEFAULT && null != t.camera), (this.cameraOpportunityDuration.value = this.connection.context === o.Yn.DEFAULT && null != t.camera && this.callUserIdsCount > 1), (this.cameraSendDuration.value = this.connection.context === o.Yn.DEFAULT && null != t.camera && c > 0), this.cameraDuration.value && !_ && this.cameraToggles++);
        ...
        (t.rtp.outbound
            ...
            .forEach((t) => {
                ...
                if (null != r) {
                    ...
                    (null == T && (console.warn('Unknown outbound video stream with SSRC: '.concat(t)), (T = new f.nt(this.timestampProducer)), (this.outboundStats[t] = T)), null == T.timeToFirstFrame && (r.framesEncoded > 0 || (null != (i = r.frameRateInput) ? i : 0) > 0) && (T.timeToFirstFrame = Math.max(0, e - T.startTime)), null != m && m >= 0 && this.videoEntropy.addSample(m));
