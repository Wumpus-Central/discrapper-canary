...
class O extends o.Z {
    ...
    getStats(e) {
        ...
        let t = Number(this.streamStart),
            ...
            { bytes: b, framesDropped: y, framesCodecError: O, framesCodec: v, framesNetwork: I, packets: S, packetsLost: T, nackCount: A, pliCount: N, qpSum: C, pauseCount: R, freezeCount: P, totalPausesDuration: w, totalFreezesDuration: D, totalFramesDuration: L, keyframes: x, passthroughCount: M, cryptorSuccessCount: k, cryptorFailureCount: j, cryptorDuration: U, cryptorAttempts: G, cryptorMissingKeyCount: B, cryptorInvalidNonceCount: V, qualityDecodeErrors: F, qualityDecoderReboots: Z, qualityScoreErrors: H, qualityFrameDrops: Y, qualitySizeMismatches: W } = e.aggregatedProperties;
        return (
            ...
            .forEach((t) => {
                ...
                if (null != r) {
                    ...
                    if (this.connection.context === a.Yn.STREAM) {
                        ...
                        (null == I || 0 === I) && (null == T ? void 0 : T.quality) === _ && (I = this.connection.getRemoteVideoSinkWants('any')), (v = (null != I ? I : 0) > 0);
                    }
