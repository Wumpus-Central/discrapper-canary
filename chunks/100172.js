...
function m(e) {
    ...
    return (0, n.jsx)(c.Ay, {
        ...
        onToggleCustomDateRange: function () {
            (0, d.Ld)(t, {
                ...i,
                selectedAccountAgeOption: { optionId: c.H_.CUSTOM, afterDate: g ? m : null, beforeDate: g ? h : null },
            });
        },
        onSelectStartDate: function (e) {
            (0, d.Ld)(t, {
                ...i,
                selectedAccountAgeOption: { optionId: c.H_.CUSTOM, afterDate: e.valueOf(), beforeDate: h },
            });
        },
