...
let _ = {
    ...
    disable() {
        t.Bo.post({ url: s.Rsh.MFA_TOTP_DISABLE, oldFormErrors: !0, rejectWithError: !1 }).then((e) => {
            ...
            return E.h.dispatch({ type: "MFA_DISABLE_SUCCESS", token: r });
        });
    },
    enableSMS: () => (
    ...
    confirmViewBackupCodes(e, r) {
        let { viewNonce: o, regenerateNonce: _ } = h.A.getNonces();
        return t.Bo.post({
    ...
    clearBackupCodes() {
        E.h.dispatch({ type: "MFA_CLEAR_BACKUP_CODES" });
    },
};
