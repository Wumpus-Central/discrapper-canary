...
function b(e) {
    ...
    let g = p ? d.intl.string(d.t.z7I3gY) : d.intl.string(d.t["N2c/Ul"]),
        y = p ? d.intl.string(d.t.M5PWSU) : d.intl.string(d.t.RMpwZm);
            ...
            f
                ? (0, r.jsx)(l.sNh, {
                      ...
                      action: () =>
                          void (
                              null != e.parent_id &&
                              (0, c.XQ)(e.guild_id, e.parent_id, !1, { section: u.jXE.CONTEXT_MENU })
                          ),
                  })
                : (0, r.jsx)(l.sNh, {
                      id: "opt-into-channel",
