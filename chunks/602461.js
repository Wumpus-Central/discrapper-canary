...
function l(e) {
    ...
    return r.useMemo(() => {
        ...
        return (
            ...
            0 !== c && e.push(o.intl.formatToPlainString(o.t["p/l+BI"], { channelCount: c })),
            0 !== u && e.push(o.intl.formatToPlainString(o.t.eXP5vt, { benefitCount: u })),
            0 !== f && e.push(o.intl.formatToPlainString(o.t.YjmQwW, { emojiCount: f })),
            new i.A(e)
        );
    }, [c, u, f, t]);
}
