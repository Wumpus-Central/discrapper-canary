...
function v(e) {
    ...
    return (0, i.jsx)("div", {
        className: D.k,
        children: s
            ? (0, i.jsx)(y.f, { value: r, onChange: (e) => a(n, e), placeholder: "Enter your response...", rows: 4 })
...
function G(e) {
    ...
    let L = r.useCallback(
        ...
        D = r.useCallback(() => {
            ...
            f(t, y), e.isComplete && d.Ay.submitSurveyResponse(t, p), g(e.blockId), N(e.pageIndex), O(e.isComplete);
        }, [n, m, S, p, t, y, f]);
    r.useEffect(() => {
        0 === y.length && D();
    }, [y, D]);
    ...
    return C
        ...
        : (0, i.jsx)(a.Modal, {
              ...
              title: U.intl.string(U.t.OSqLUF),
              size: "md",
              actions: [{ variant: "primary", text: U.intl.string(U.t.PDTjLN), onClick: D, disabled: !v }],
              children: (0, i.jsx)("div", {
                  style: { width: "100%" },
                  children:
                      0 === y.length
                          ...
                          : (0, i.jsx)("div", {
                                ...
                                children: y.map((e) => {
                                    ...
                                    return null == t
                                        ...
                                        : (0, i.jsx)(
                                              P,
                                              { question: t, questionId: e, responses: p, onResponseChange: R },
                                              e,
                                          );
                                }),
                            }),
