...
function U(e) {
    let { question: t, questionId: n, value: l, onValueChange: r } = e;
    return t.Selector === D.BO.SINGLE_ANSWER
        ...
        s = (() => {
            switch (t.QuestionType) {
                case D.SQ.TEXT_ENTRY:
                    return (0, i.jsx)(g, { question: t, questionId: n, value: l[n] ?? "", onValueChange: r });
...
function j(e) {
            ...
            () =>
                null == O
                    ...
                    : (function (e, t) {
                      ...
                      })(n, { blockId: O, pageIndex: P, responses: R }),
            [n, O, P, R],
        ),
        f = l.useCallback(() => {
            ...
            N(t, h), e.isComplete && o.Ay.submitSurveyResponse(t, R), C(e.blockId), D(e.pageIndex), p(e.isComplete);
        }, [n, O, P, R, t, h, N]);
    l.useEffect(() => {
        0 === h.length && f();
    }, [h, f]);
    ...
    return M
        ...
        : (0, i.jsx)(r.Modal, {
              ...
              title: x.intl.string(x.t.OSqLUF),
              size: "md",
              actions: [{ variant: "primary", text: x.intl.string(x.t.PDTjLN), onClick: f, disabled: !g }],
              children: (0, i.jsx)("div", {
                  style: { width: "100%" },
                  children:
                      0 === h.length
