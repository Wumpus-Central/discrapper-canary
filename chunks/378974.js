...
function R(e) {
    ...
    return t.Selector === N.BO.SINGLE_ANSWER
        ? (0, i.jsx)(y, { question: t, questionId: n, value: r, onValueChange: s })
...
function L(e) {
    ...
    return (0, i.jsx)("div", {
        className: b.k,
        children: a
            ? (0, i.jsx)(v.f, { value: r, onChange: (e) => s(n, e), placeholder: "Enter your response...", rows: 4 })
        ...
        a = (function () {
            switch (t.QuestionType) {
                case N.SQ.TEXT_ENTRY:
                    return (0, i.jsx)(L, { question: t, questionId: n, value: r[n] ?? "", onValueChange: s });
                case N.SQ.MULTIPLE_CHOICE:
                    return (0, i.jsx)(R, { question: t, questionId: n, value: r[n] ?? "", onValueChange: s });
...
function U(e) {
    let { surveyId: t, survey: n, onClose: a, transitionState: d } = e,
        { getSurveyResponses: E, setResponse: p, trackDisplayedQuestions: m } = (0, c.i)(),
        g = E(t),
        A = (function (e) {
            for (let t of h(e)) {
                let n = f(e.Blocks[t]);
    ...
    let R = r.useCallback(
            () => (
                C
                    ...
                    : (0, o.openModal)((e) =>
                          (0, i.jsx)(s.Modal, {
                              title: M.intl.string(M.t.T9Sx3z),
                              actions: [
                                  { variant: "secondary", text: M.intl.string(M.t.oEAioF), onClick: e.onClose },
                                  {
                                      variant: "critical-primary",
                                      text: M.intl.string(M.t.p89ACt),
                                      onClick: () => {
                                          e.onClose(), a();
                                      },
                                  },
                              ...
                              children: (0, i.jsx)(l.E, {
                                  variant: "text-md/normal",
                                  children: M.intl.string(M.t.iCK6G0),
                              }),
                          }),
                      ),
                Promise.resolve()
        ...
        b = r.useCallback(() => {
            ...
            m(t, v), e.isComplete && u.Ay.submitSurveyResponse(t, g), T(e.blockId), N(e.pageIndex), y(e.isComplete);
        }, [n, I, S, g, t, v, m]);
    r.useEffect(() => {
        0 === v.length && b();
    }, [v, b]);
    ...
    return C
        ? (0, i.jsxs)(s.Modal, {
              ...
              onClose: a,
              size: "md",
              title: M.intl.string(M.t.OSqLUF),
              actions: [{ variant: "primary", text: M.intl.string(M.t.i4jeWR), onClick: a }],
              children: [
                  (0, i.jsx)(l.E, { variant: "text-md/normal", children: M.intl.string(M.t["2scvdw"]) }),
                  (0, i.jsx)(l.E, { variant: "text-md/normal", children: M.intl.string(M.t.chZxOD) }),
              ],
          })
        : (0, i.jsx)(s.Modal, {
              transitionState: d,
              ...
              title: M.intl.string(M.t.OSqLUF),
              size: "md",
              actions: [{ variant: "primary", text: M.intl.string(M.t.PDTjLN), onClick: b, disabled: !L }],
              children: (0, i.jsx)("div", {
                  style: { width: "100%" },
                  children:
                      0 === v.length
                          ...
                          : (0, i.jsx)("div", {
                                ...
                                children: v.map((e) => {
                                    ...
                                    return null == t
                                        ...
                                        : (0, i.jsx)(
                                              P,
                                              { question: t, questionId: e, responses: g, onResponseChange: O },
                                              e,
                                          );
                                }),
                            }),
...
function G(e) {
    ...
    return null == s
        ? (0, i.jsx)(l.E, { variant: "text-md/medium", className: x.Lq, children: M.intl.string(M.t.MKDeyL) })
