...
var w = (function (e) {
    return (
        ...
        (e.Codecs = "codecs"),
        (e.MediaSessionId = "media-session-id"),
        (e.MediaSinkWants = "media-sink-wants"),
        (e.VoiceBackendVersion = "voice-backend-version"),
        (e.KeyframeInterval = "keyframe-interval"),
        (e.ChannelOptionsUpdateSecureFramesProtocol = "update-secure-frames-protocol"),
        (e.Flags = "flags"),
        (e.Platform = "platform"),
        (e.SDP = "sdp"),
        (e.Encryption = "encryption"),
        (e.BandwidthEstimationExperiment = "bandwidth-estimation-experiment"),
        (e.SecureFramesInit = "secure-frames-init"),
        (e.SecureFramesPrepareTransition = "secure-frames-prepare-transition"),
        (e.SecureFramesExecuteTransition = "secure-frames-execute-transition"),
        (e.SecureFramesPrepareEpoch = "secure-frames-prepare-epoch"),
        (e.MLSExternalSenderPackage = "mls-external-sender-package"),
...
class x extends o.Z {
    createWebSocket() {
        ...
        (e.binaryType = "arraybuffer"),
            (e.onopen = () => {
                ...
                let e = (0, s.zO)() - this.connectionStartTime;
                this.logger.info("[CONNECTED] ".concat(this.url, " in ").concat(e, " ms")),
            ...
            (e.onmessage = (e) => {
                ...
                switch (t) {
                    ...
                    case 5:
                        let i = r.speaking;
                        "boolean" == typeof i && (i = i ? f.Dg.VOICE : f.Dg.NONE),
    ...
    doResumeOrClose() {
        ...
        null !== this.sessionId &&
        this.resumable &&
        (null == this.lastHeartbeatAckTime || e - this.lastHeartbeatAckTime <= v)
    ...
    disconnect(e, t, n) {
        this.logger.warn("[DISCONNECT] (".concat(e.toString(), ", ").concat(t, ", ").concat(n, ")")),
            this.cleanupWebSocket(),
            this.cleanupState(),
            (this.connectionState = 0),
    ...
    reconnect(e, t, n) {
        this.logger.info("[RECONNECT] wasClean=".concat(e.toString(), " code=").concat(t, " reason=").concat(n)),
            this.cleanupWebSocket((e) => e.close(4000)),
    ...
    cleanupWebSocket(e) {
        ...
        (this.webSocket = null),
            null != t && ((t.onopen = b), (t.onmessage = b), (t.onerror = b), (t.onclose = b), null == e || e(t)),
            this.backoff.cancel();
    }
    cleanupState() {
        (this.serverId = null),
    ...
    resetBackoff() {
        ...
        return (
            ...
            null == this.webSocket &&
            (this.logger.info("Connection backoff reset ".concat("" !== e ? "for reason: " + e : "")),
            this.backoff.succeed(),
    ...
    close() {
        this.logger.info("CLOSE"),
            ...
            this.cleanupState(),
            (this.connectionState = 0),
            this.emit("disconnect", !0, 1000, "Force Close");
    }
    destroy() {
        this.close();
    }
