        ...
        track(e, t, n) {
            ...
            for (
                ...
                e?.notification?.close != null &&
                    ...
                    q.default.track(et.HAw.NOTIFICATION_ACTION, { action: "REMOVE", ...e.trackingProps }));
            }
        }
        clearChannel(e) {
            ...
            null != t &&
                ...
                t.forEach((e) => {
                    ...
                    t.close(), q.default.track(et.HAw.NOTIFICATION_ACTION, { action: "ACK", ...n });
                }));
        }
    })();
function eh() {
...
class ep extends a.Ay.Store {
    ...
    initialize() {
        this.waitFor(h.A, x.A, D.A, k.A, g.A, F.A, V.A, B.A, H.Ay, j.A, W.Ay, Y.A, M.A, K.A, $.A, z.default, Z.A);
    }
}
new ep(
    o.h,
    __OVERLAY__
        ...
        : {
              ...
              THREAD_CREATE: function (e) {
                  ...
                  if (null == i || !et.kvI.GUILD_THREADS_ONLY.has(i.type) || !n || !(0, R.q1)(t, i, !ec)) return !1;
              ...
              REACTION_NOTIFICATION_SENT: function (e) {
                  ...
                  if (!(0, R.nR)({ message: s, channel: d, reactor: c, includeSelectedChannel: !ec })) return !1;
                  ee.A.showNotification(
                      t,
                      n,
                      i,
