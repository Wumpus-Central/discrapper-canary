        ...
        i.tn
            ...
            .catch((i) => {
                I(
                    ...
                    { isRetry: p }
                ) && (T('MESSAGE_REACTION_REMOVE', e, t, n, { burst: f }), f ? r.uv.announce(v.intl.formatToPlainString(v.t['fJeu8/'], { name: n.name })) : r.uv.announce(v.intl.formatToPlainString(v.t.UUn5V1, { name: n.name })));
            })
    );
}
function C(e) {
