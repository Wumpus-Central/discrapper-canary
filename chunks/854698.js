...
function C(e) {
    ...
    let n = e.toDate(),
        ...
        o = [
            ...
            {
                value: d.z.WEEKLY,
                label: p.NW.formatToPlainString(p.t['B8/yfn'], { weekday: i })
            },
            {
                value: d.z.BIWEEKLY,
                label: p.NW.formatToPlainString(p.t['z+aIub'], { weekday: i })
            },
            {
                value: d.z.MONTHLY,
    ...
    return (
        A.has(n.getDay())
            ? (null === (t = s.default.getCurrentUser()) || void 0 === t ? void 0 : t.isStaff()) &&
              o.push({
