...
function ek(e) {
    return (0, eP.isWindows)() && c().satisfies(null === m.A || void 0 === m.A ? void 0 : m.A.os.release, eC.PH)
    ...
    21552 == n.j
        ? i.memo(function () {
              ...
              let l = (0, u.bG)([eI.default], () => eI.default.getCurrentUser()),
                  ...
                  O = (0, H.H)(o),
                  { windowsMuteAndZeroVolumeDetectionEnabled: m } = (0, J.I)({
                      location: "AppNotice",
                  }),
                  h = (0, ee.V)();
              i.useEffect(() => {
                  if ((null == s ? void 0 : s.type) != null) {
                      ...
                      if (
                          null == h &&
                          (s.type === ef.kqX.PREMIUM_TIER_2_TRIAL_ENDING ||
                              s.type === ef.kqX.PREMIUM_TIER_0_TRIAL_ENDING)
                      )
                          return;
                      let t = {};
                      null != o && (t.guild_id = o),
              ...
              if (
                  ...
                  }, [m, null == G ? void 0 : G.guid]),
                  null == s)
              )
                  return null;
              let eX = null != s.type ? eN.Re[s.type] : null,
                  eV = null != s.type ? eN.k3[s.type] : null,
                  eF = null != s.type ? eN.f7[s.type] : null,
                  eH = eN.pe[s.type];
              if (null != eX)
                  return (0, r.jsx)(L.$, {
              ...
              switch (s.type) {
                  ...
                  case ef.kqX.VOICE_DISABLED:
                      return (0, r.jsxs)(d.$Td, {
                          ...
                          children: [
                              (0, r.jsx)(d.PMB, {
                                  onClick: () => {
                                      p.A.clearRemoteDisconnectVoiceChannelId(), ew();
                                  },
                                  noticeType: s.type,
                              }),
                  ...
                  case ef.kqX.VOICE_CONNECTED_LAST_SESSION:
                      return (0, r.jsxs)(d.$Td, {
                          ...
                          children: [
                              (0, r.jsx)(d.PMB, {
                                  onClick: () => {
                                      p.A.clearLastSessionVoiceChannelId(), ew();
                                  },
                                  noticeType: s.type,
                              }),
                  ...
                  case ef.kqX.PREMIUM_UNCANCEL:
                      return (0, r.jsxs)(d.$Td, {
                          color:
                              eW === eD.PremiumTypes.TIER_1
                                  ? d.Hv$.PREMIUM_TIER_1
                                  : eW === eD.PremiumTypes.TIER_0
                                    ? d.Hv$.PREMIUM_TIER_0
                                    : d.Hv$.PREMIUM_TIER_2,
                          children: [
                              (0, r.jsx)(d.PMB, {
                      ...
                      return (0, r.jsxs)(d.$Td, {
                          ...
                          children: [
                              ...
                              null != o
                                  ? (0, r.jsx)(d.zr9, {
                                        onClick: () =>
                                            Y.A.open(o, ef.BEX.GUILD_AUTOMOD, void 0, ef.nd0.AUTOMOD_MENTION_SPAM),
