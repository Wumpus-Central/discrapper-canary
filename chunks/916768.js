...
let ex = l.memo(function () {
    ...
    switch (r.type) {
        ...
        case eP.kqX.DISPATCH_INSTALL_SCRIPT_PROGRESS:
            if (null == r.metadata) return null;
            let { progress: eb, total: eV, name: ew } = r.metadata;
            return (0, i.jsxs)(_.$Td, {
                color: _.Hv$.DEFAULT,
                children: [
        ...
        case eP.kqX.PREMIUM_PAST_DUE_ONE_TIME_PAYMENT:
            let { daysPastDue: eF, dismissUntil: eH } = r.metadata;
            return (0, i.jsxs)(_.$Td, {
                color: _.Hv$.WARNING,
                children: [
                    (0, i.jsx)(_.PMB, {
                    ...
                    eM.intl.format(eM.t.zxU0Kp, { daysPastDue: eF }),
                    (0, i.jsx)(_.Z_L, {
