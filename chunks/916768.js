...
function eM(e) {
    return (0, eS.isWindows)() && c().satisfies(null === g.A || void 0 === g.A ? void 0 : g.A.os.release, ey.PH)
...
function ej(e) {
    ...
    let n,
        i,
        { noticeType: l } = e,
        { windowsMuteAndZeroVolumeDetectionEnabled: o } = (0, z.I)({
            location: "AudioIssueNoticeNoInput",
        }),
        a = (0, J.x5)(eg.oh.AUDIO_INPUT),
        ...
        A = (0, eS.isWindows)() && c().satisfies(null === g.A || void 0 === g.A ? void 0 : g.A.os.release, ey.PH) && o,
        T = !1;
    return (
        A && !0 === d
            ? ((n = em.intl.string(em.t.ppW3ri)),
              (i = (0, r.jsx)(E.eCN, {
                  href: eM(s),
                  noticeType: l,
            ...
            : A && 0 === _
              ? ((n = em.intl.string(em.t.j4gGA4)),
                (i = (0, r.jsx)(E.eCN, {
                    href: eM(s),
                    noticeType: l,
                    children: em.intl.string(em.t.QghSIq),
                })))
              : ed.A.supports(eg.O5.LOOPBACK)
                ? ((n = em.intl.string(em.t.dNAJ18)),
                  (T = !0),
                  (i = (0, r.jsx)(E.zr9, {
                      onClick: () => {
        ...
        ? i.memo(function () {
              ...
              if (
                  (i.useEffect(() => {
                      if ((null == s ? void 0 : s.type) != null) {
                          ...
                          if (
                              null == g &&
                              (s.type === eP.kqX.PREMIUM_TIER_2_TRIAL_ENDING ||
                                  s.type === eP.kqX.PREMIUM_TIER_0_TRIAL_ENDING)
                          )
                              return;
                          let t = {};
                          null != o && (t.guild_id = o),
                              (null == g ? void 0 : g.trial_id) != null && (t.trial_id = g.trial_id),
                              (e = eh(
                                  {
                                      notice_type: s.type,
                                  },
              ...
              switch (s.type) {
                  ...
                  case eP.kqX.E2EE_UPDATE_REQUIRED:
                      ...
                      return (0, r.jsxs)(E.$Td, {
                          ...
                          children: [
                              ...
                              em.intl.format(eS.isPlatformEmbedded ? em.t.J232TI : em.t.vceuiL, {
                  ...
                  case eP.kqX.SCHEDULED_MAINTENANCE:
                      ...
                      return (0, r.jsxs)(E.$Td, {
                          ...
                          children: [
                              ...
                              em.intl.format(em.t["yb96S+"], s.metadata),
                              (0, r.jsx)(E.eCN, {
                  ...
                  case eP.kqX.PREMIUM_UNCANCEL:
                      return (0, r.jsxs)(E.$Td, {
                          color:
                              eu === ef.PremiumTypes.TIER_1
                                  ? E.Hv$.PREMIUM_TIER_1
                                  : eu === ef.PremiumTypes.TIER_0
                                    ? E.Hv$.PREMIUM_TIER_0
                                    : E.Hv$.PREMIUM_TIER_2,
                          children: [
                              (0, r.jsx)(E.PMB, {
                      ...
                      return (0, r.jsxs)(E.$Td, {
                          ...
                          children: [
                              ...
                              (0, r.jsx)(E.Z_L, {
                                  ...
                                  onClick: () => {
                                      ek(eY),
                                          (0, es.openUserSettings)(ea.X.SUBSCRIPTIONS_PANEL, {
                  ...
                  case eP.kqX.BACK_TO_PREVIOUS_SCREEN:
                      return (0, r.jsx)(W.y, {
                          buttonText: null != (t = s.buttonText) ? t : em.intl.string(em.t["/g10LC"]),
                          onGoBack: s.callback,
                          onDismiss: () => ek(),
                          showCloseButton: !0,
                      });
                      ...
                      return (0, r.jsxs)(E.$Td, {
                          ...
                          children: [
                              ...
                              null != o
                                  ? (0, r.jsx)(E.zr9, {
                                        onClick: () =>
                                            K.A.open(o, eP.BEX.GUILD_AUTOMOD, void 0, eP.nd0.AUTOMOD_MENTION_SPAM),
