        ...
        ? i.memo(function () {
              ...
              switch (c.type) {
                  ...
                  case em.kqX.HARDWARE_MUTE:
                      if (null == c.metadata) return null;
                      let { vendor: e9, model: e2 } = c.metadata;
                      return (0, r.jsxs)(d.$Td, {
                          color: d.Hv$.DANGER,
                          children: [
                  ...
                  case em.kqX.DETECTED_OFF_PLATFORM_PREMIUM_PERK:
                      if (null == c.metadata) return null;
                      let { skuId: e7, applicationId: e5 } = c.metadata,
                          e6 = eR.A.get(e7),
                          e8 = b.A.getApplication(e5);
                      if (null == e6 || null == e8) return null;
                      let e3 = {
                          page: em.liQ.IN_APP,
                      };
                      return (0, r.jsxs)(d.$Td, {
                  ...
                  case em.kqX.PREMIUM_TIER_2_TRIAL_ENDING:
                      ...
                      return (0, r.jsx)(er.A, {
                          dismissCurrentNotice: () => {
                              (0, k.Dr)(eP.pe[em.kqX.PREMIUM_TIER_2_TRIAL_ENDING]), eX(ta);
                          },
                          subscriptionTier: eh.pe.TIER_2,
                      });
