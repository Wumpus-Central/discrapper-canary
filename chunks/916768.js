...
function ef(e) {
    let t,
        ...
        A = (0, eP.isWindows)() && E().satisfies(m.A?.os.release, ep.PH) && r,
        u = !1;
    return (
        A && !0 === o
              ...
              switch (r.type) {
                  ...
                  case eD.kqX.WIN7_8_DEPRECATED_MESSAGE:
                      ...
                      return (0, i.jsxs)(c.$Td, {
                          color: c.Hv$.WARNING,
                          children: [
                              (0, i.jsx)(c.PMB, { onClick: () => eG(eA), noticeType: r.type }),
                  ...
                  case eD.kqX.HARDWARE_MUTE:
                          ...
                          return (0, i.jsxs)(c.$Td, {
                              ...
                              children: [
                                  ...
                                  (0, i.jsx)(c.PMB, {
                                      noticeType: r.type,
                                      onClick: () => {
                                          A.A.setEnableHardwareMuteNotice(!1), eG();
                                      },
                                  }),
                                  (0, i.jsx)(c.eCN, {
                                      href: t.url,
                      ...
                      if (
                          z.A.getConfig({ location: "Notice.AudioIssueNoticeHardwareMute" })
                  ...
                  case eD.kqX.DETECTED_OFF_PLATFORM_PREMIUM_PERK:
                      if (null == r.metadata) return null;
                      let { skuId: ek, applicationId: ex } = r.metadata,
                          ej = eN.A.get(ek),
                          eB = y.A.getApplication(ex);
                  ...
                  case eD.kqX.PREMIUM_UNCANCEL:
                      return (0, i.jsxs)(c.$Td, {
                          color:
                              Q === eU.PremiumTypes.TIER_1
                                  ? c.Hv$.PREMIUM_TIER_1
                                  : Q === eU.PremiumTypes.TIER_0
                                    ? c.Hv$.PREMIUM_TIER_0
                                    : c.Hv$.PREMIUM_TIER_2,
                          children: [
                              (0, i.jsx)(c.PMB, {
                  ...
                  case eD.kqX.BLOCK_USER_FEEDBACK_NAGBAR:
                      return (0, i.jsxs)(c.$Td, {
                          ...
                          children: [
                              ...
                              (0, i.jsx)(c.Z_L, {
                                  onClick: () => {
                                      (0, er.$)(), eG(r.metadata?.dismissUntil);
                                  },
                                  noticeType: eD.kqX.BLOCK_USER_FEEDBACK_NAGBAR,
