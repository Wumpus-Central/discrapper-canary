...
function d(e, t, n) {
    return (
        void 0 === n && (n = "/"),
        (function (e, t, n, r) {
            let i = E(("string" == typeof t ? u(t) : t).pathname || "/", n);
            ...
            let s = (function e(t, n, r, i) {
                ...
                let s = (t, s, a) => {
                    ...
                    E.relativePath.startsWith("/") &&
                        ...
                        (E.relativePath = E.relativePath.slice(i.length)));
                    let p = h([i, E.relativePath]),
                        m = r.concat(E);
                    t.children &&
                        t.children.length > 0 &&
                        (o(
                        ...
                        (null != t.path || t.index) &&
                            n.push({
                                ...
                                score:
                                    ...
                                    d
                                        .filter((e) => !_(e))
                                        .reduce((e, t) => e + (c.test(t) ? 3 : "" === t ? 1 : 10), f)),
                                routesMeta: m,
                            });
                };
                return (
                ...
                a = (function (e, t, n) {
                    ...
                    for (let e = 0; e < r.length; ++e) {
                        let o = r[e],
                            ...
                            d = f({ path: o.relativePath, caseSensitive: o.caseSensitive, end: l }, u),
                            c = o.route;
                        if (
                            (!d &&
                                l &&
                                ...
                                (d = f({ path: o.relativePath, caseSensitive: o.caseSensitive, end: !1 }, u)),
                            !d)
                        )
                            return null;
                        Object.assign(i, d.params),
                            a.push({
                                params: i,
                                pathname: h([s, d.pathname]),
                                pathnameBase: p(h([s, d.pathnameBase])),
                                route: c,
                            }),
                            "/" !== d.pathnameBase && (s = h([s, d.pathnameBase]));
                    }
                    return a;
                })(s[e], t, r);
            }
...
n.d(t, { HS: () => h, Oi: () => o, Rr: () => u, pX: () => g, pb: () => E, rc: () => r, tH: () => m, ue: () => d }),
    ((s = r || (r = {})).Pop = "POP"),
    (s.Push = "PUSH"),
    (s.Replace = "REPLACE"),
    ((a = i || (i = {})).data = "data"),
...
function f(e, t) {
    ...
    return {
        params: u.reduce((e, t, n) => {
            ...
            if ("*" === r) {
                let e = f[n] || "";
                _ = c.slice(0, c.length - e.length).replace(/(.)\/+$/, "$1");
            }
            let s = f[n];
