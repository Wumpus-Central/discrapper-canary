...
var i = s(825913),
    ...
    v = s(64700),
    b = s(823807);
let f = (0, v.createContext)({}),
    p = (0, v.forwardRef)(function (e, t) {
        [e, t] = (0, i.JT)(e, t, f);
        let s = (0, v.useContext)(r.G0),
            p = (0, b.H)(
                s && null != e.id
                    ? {
            ...
            ),
            {
                ...
                ? (0, o.O)({ ...e, id: e.id }, s, t)
                : (0, a.q)({ ...e, id: null != e.id ? String(e.id) : void 0 }, p, t),
        ...
        return (
            ...
            v.createElement(
                ...
                v.createElement(l.r.Provider, { value: { isSelected: P } }, m.children),
            )
        );
    });
