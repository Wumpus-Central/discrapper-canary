...
e.exports = {
    ...
    event: I,
    isAnimated: _,
    createAnimatedComponent: n(300523),
    inject: {
        ApplyAnimatedValues: n(102419).inject,
        InteractionManager: n(888645).inject,
        FlattenStyle: n(958376).inject,
        RequestAnimationFrame: n(409584).inject,
        CancelAnimationFrame: n(437853).inject,
    },
    __PropsOnlyForTests: n(813141),
};
