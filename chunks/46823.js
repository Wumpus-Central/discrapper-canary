(t.r(n), t.d(n, { default: () => dj }), t(321073));
var i,
    l = t(477900),
    s = t(582128),
    a = t(503698),
                ...
                (0, l.jsxs)("div", {
                    ...
                    children: [
                        (0, l.jsxs)("div", {
                            className: tt.DD,
                            children: [
                                (0, l.jsx)(n6.A, { className: tt.n2, guild: n }),
                                (0, l.jsx)(v.E, {
                                    className: tt.J5,
                                    variant: "heading-md/semibold",
                                    color: "text-strong",
    ...
    if (c) n = (0, l.jsx)("div", { className: tr.$$, children: (0, l.jsx)(x.y, { className: tr.u1 }) });
        ...
        n = (0, l.jsxs)("div", {
            ...
            children: [
                ...
                (0, l.jsx)(v.E, { variant: "text-md/normal", color: "text-default", className: tg.av, children: e }),
            ],
        });
                        ...
                        (0, l.jsxs)("div", {
                            ...
                            children: [
                                (0, l.jsx)(nx.D, {
                                    onClick: a,
                                    className: tg.UE,
                                    children: (0, l.jsx)(tm.A, { direction: tm.A.Directions.LEFT }),
                                }),
                                (0, l.jsx)(R.D, {
                                    variant: "heading-xl/semibold",
                                    className: tg.s7,
    ...
    return (0, l.jsx)(tS.Y, {
        ...
        children: (e, n) => {
            ...
            return (0, l.jsx)(na.Ay.Icon, {
                ...
                onClick: () => a((e) => !e),
                tooltip: i ? null : o,
                icon: t === t4.CP.NO_MESSAGES ? t5.BellSlashIcon : t3.BellIcon,
                "aria-label": o,
                selected: i,
            });
        },
...
function ii(e) {
    let { channel: n, closePopout: t, onSelect: i } = e,
        ...
        A = (0, tk.A)(n),
        m = (0, tD.A)(n),
        g = (0, tY.A)({ id: n.id, label: Y.intl.string(Y.t.DQ797g) }),
        x = (0, tz.A)(n),
        p = (0, tF.A)(n),
        f = (0, tM.$)(1e3);
    function I() {
                    ...
                    children: (e) => {
                        ...
                        return n === m.M.ACTIVITY_GDM_CALL_TOOLTIP
                            ? (0, l.jsx)(i7.A, {
                                  ...
                                  onRequestClose: () => t(lm.i.USER_DISMISS),
                              })
                            : null;
                    },
                }),
    ...
    handleVoiceClick = (e) => {
        ...
        if (
            (i.includes(m.M.ACTIVITY_GDM_CALL_TOOLTIP) &&
                (0, tI.Dr)(m.M.ACTIVITY_GDM_CALL_TOOLTIP, { dismissAction: lm.i.AUTO }),
            n)
        );
            ...
            return {
                ...
                submit: s.useCallback(
                    async (e, l, s) => {
                        ...
                        return ((0, sm.x5)(n.id, sO.drafts.type), m(!1), { shouldClear: !0, shouldRefocus: !1 });
                    },
...
function sJ(e) {
    ...
    if (
        ...
        return null;
    if (null != m) return (0, l.jsx)(tN.A, { guild: c, channelId: m });
...
function rC(e) {
    ...
    return (0, l.jsx)("div", {
        ...
        children: (0, l.jsxs)(rm.A, {
            ...
            children: [
                !0 === g && (0, l.jsx)(rh.A, { className: rb.Pf }),
                E &&
                    (0, l.jsx)(rg.A, {
                        spec: f,
                        onClick: C,
    ...
    0 === E.length)
        ...
        : (0, l.jsx)("section", {
              ...
              children: (0, l.jsxs)(am.A.Overlay, {
                  ...
                  className: rP.kL,
                  children: [
                      g && (0, l.jsx)(rR.kM, { location: "UserProfileSidebarWishlistBreadcrumb" }),
                      (0, l.jsxs)("div", {
                          className: rP.wx,
                          children: [
                              (0, l.jsxs)("div", {
...
function rG(e) {
    ...
    return (0, l.jsxs)("div", {
        ...
        children: [
            ...
            (0, l.jsx)(a7.A, { user: n }),
            i?.private &&
                (0, l.jsx)(am.A.Overlay, { children: (0, l.jsx)(a9.A, { username: s9.Ay.getName(null, a.id, n) }) }),
            n.isProvisional &&
                (0, l.jsx)(am.A.Overlay, {
                    className: aT.Lw,
...
function rQ(e) {
    ...
    function C(e) {
        (0, s1.openUserProfileModal)({ sourceAnalyticsLocations: m, hideRestrictedProfile: !0, ...g, ...e });
    }
...
var de = t(909735),
    ...
    dr = t(999900);
function dd() {
    return (0, l.jsx)("div", { className: dr.wG, children: (0, l.jsx)(x.y, {}) });
}
let dc = (0, nU.Fe)({
        createPromise: () =>
            Promise.all([
...
let dA = (0, nU.Fe)({ createPromise: dh, webpackId: 540462, name: "ChannelCall", renderLoader: dd });
function dm() {
    return Promise.all([
        t.e("764984"),
        t.e("834541"),
...
let dg = (0, nU.Fe)({ createPromise: dm, webpackId: 67319, name: "StageChannelCall", renderLoader: dd }),
    dx = (0, nU.Fe)({
        createPromise: () =>
            Promise.all([
                t.e("855151"),
...
class dI extends s.PureComponent {
    ...
    maybePreloadChannelCall() {
        ...
        e === ed.rbe.GUILD_VOICE ? dh() : e === ed.rbe.GUILD_STAGE_VOICE && dm();
    }
    ...
    renderJoinRequestInterviewButtons = () => {
        let { channel: e } = this.props;
        return e?.hasFlag(dl.lx.IS_JOIN_REQUEST_INTERVIEW_CHANNEL)
            ? (0, l.jsx)(im.A, { channelId: e.id, showTrailingDivider: !0 })
            : null;
    };
    renderClipsEnabledIndicatorToolbarItem = () => {
        let { inCall: e, voiceChannel: n } = this.props;
        return e ? (0, l.jsx)(nm.A, { channelId: null != n ? n.id : null }) : null;
    };
    renderStreamQualityLiveIndicatorToolbarItem = () => {
        ...
        return e?.type !== ds.lp.STREAM
            ...
            : (0, l.jsx)(
                  ih.A,
                  { size: dt.Ay.Sizes.LARGE, participant: e, showQuality: !0, premiumIndicator: n },
                  "live-indicator",
              );
    };
    renderHeaderToolbar = () => {
                    ...
                    children: (a) =>
                        (0, l.jsxs)(
                            i9.A,
                            {
                                ...
                                className: r()(dr.DD, a, { [dr.zh]: e.type === ed.rbe.GROUP_DM }),
                                transparent: x,
                                hidden: c,
    ...
    renderCall() {
        ...
        switch (e.type) {
            case ed.rbe.GUILD_STAGE_VOICE:
                return (0, l.jsx)(dg, { channel: e, popoutType: nh.N.NO_POPOUT }, e.id);
            case ed.rbe.GUILD_VOICE:
            case ed.rbe.DM:
            case ed.rbe.GROUP_DM:
            case ed.rbe.PUBLIC_THREAD:
    ...
    renderChat() {
        ...
        if ((o()(null != e, "Missing channel in Channel.renderChat"), t))
            ...
            e?.isRoleSubscriptionTemplatePreviewChannel())
                ...
                : (0, l.jsx)(ig.H, { guildId: n.id, children: (0, l.jsx)(iS, { channelId: e.id, guildId: n.id }) });
        ...
        if (e.isForumLikeChannel()) {
            ...
            return (0, l.jsx)(dc, { channel: e, guild: n, sidebarState: t }, e.id);
        }
        return e.type === ed.rbe.GUILD_APP
            ? (0, l.jsx)(du, { channel: e }, e.id)
    ...
    renderSidebar() {
        ...
        else if (s === ed.YvQ.SEARCH) return (0, l.jsx)(dx, { guildId: t?.id, channelId: e.id });
        return null;
    }
    openChannelModal() {
        let {
            ...
            switch (i.type) {
                ...
                case iL.PE.VIEW_CHANNEL: {
                    ...
                    if (null != n && (0, r2.ZV)(n.type)) {
                        e = (0, l.jsx)(di.A, { channelId: i.channelId, baseChannelId: i.channelId });
                        break;
                    }
                    return null;
                }
    ...
    render() {
        ...
        if (i) return (0, l.jsx)(r8, {});
        if (null == e) return (0, l.jsx)(dn.A, { channelId: this.props.channelId });
                ...
                children: [
                    (0, l.jsxs)("div", {
                        ...
                        children: [
                            ...
                            (0, l.jsxs)("div", {
                                className: r()(dr.Qs, { [dr.Oo]: s === ed.DUB.NO_CHAT }),
        ...
        return (0, l.jsxs)(l.Fragment, {
            children: [
                ...
                u ? (0, l.jsx)("div", { className: dr.zP, children: y }) : y,
                p && (0, l.jsx)(df, {}),
            ],
        });
    }
...
let db = (0, ef.A)(dI),
    dj = s.memo(function (e) {
        ...
        (s.useEffect(() => (b.A.setFriendsSidebarAvailable(eg), () => b.A.setFriendsSidebarAvailable(!1)), [eg]),
            ...
            s.useEffect(() => {
                let e = (0, ty.JK)();
                if (e?.location?.state?.stageInviteKey === da.J2) {
        ...
        s.useEffect(() => {
            let e = eE && !eC,
                n = eE && eC && f?.id !== ey;
            (e || n) && (0, tI.Dr)(m.M.ACTIVITY_GDM_CALL_TOOLTIP, { dismissAction: lm.i.AUTO });
        }, [f?.id, ey, eC, eE]);
