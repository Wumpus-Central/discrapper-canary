...
function L(e) {
    var t,
        { transitionState: n, children: o, size: u = 'small', role: _ = 'dialog', className: m, fullscreenOnMobile: g = !0, hideShadow: E = !1, onAnimationEnd: b = O.dG, returnRef: v, animation: S = 'default' } = e,
    ...
    let P = n === y.Dv.ENTERING || n === y.Dv.ENTERED,
        { reducedMotion: R } = i.useContext(f.S),
        D = (0, d.q)(
            {
                opacity: +!!P,
        ...
        L = i.useRef(null),
        x = null != A['aria-label'],
        k = null != A['aria-labelledby'],
        M = i.useId(),
        j = null != (t = A['aria-labelledby']) ? t : M,
        U = i.useMemo(
            () => ({
                headerId: j,
                headerIdIsManaged: k
