    ...
    constructor(...e) {
        super(...e),
            ...
            J(this, 'beforeUnload', (e) => {
                let t = () => {
                    B.Z.unmountWindow(this.props.windowKey), V.isPlatformEmbedded && W.ZP.close(this.props.windowKey);
                };
