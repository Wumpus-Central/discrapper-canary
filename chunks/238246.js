...
class z extends (r = o.Component) {
    ...
    render() {
        let { focused: e, forcedColors: t, children: n, windowKey: r, isFullScreen: o, withTitleBar: a, guestWindow: c, clientThemesClassName: u, contentClassName: f, hideModals: _ = !1 } = this.props;
        (0, M.getPlatform)();
        let m = K({
                withTitleBar: a,
                isFullScreen: o
