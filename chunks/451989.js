        ...
        return (
            ...
            (r.performEnter = function (e) {
                var t = this,
                    ...
                    s = this.props.nodeRef ? [n] : [u.findDOMNode(this), n],
                    a = s[0],
                    o = s[1],
                    i = this.getTimeouts(),
            ...
            (r.render = function () {
                ...
                return i.createElement(
                    c.A.Provider,
                    { value: null },
                    "function" == typeof r ? r(e, n) : i.cloneElement(i.Children.only(r), n),
                );
            }),
            t
        );
    ...
    b = (function (e) {
            ...
            return (
                ...
                (t.onEntering = function (e, r) {
                    var n = t.resolveArguments(e, r),
                        s = n[0],
                        a = n[1];
                    t.addClass(s, a ? "appear" : "enter", "active"), t.props.onEntering && t.props.onEntering(e, r);
                }),
                (t.onEntered = function (e, r) {
                    var n = t.resolveArguments(e, r),
                        s = n[0],
                        a = n[1] ? "appear" : "enter";
                    t.removeClasses(s, a), t.addClass(s, a, "done"), t.props.onEntered && t.props.onEntered(e, r);
                }),
                (t.onExit = function (e) {
                ...
                (t.getClassNames = function (e) {
                    var r = t.props.classNames,
                        ...
                        s = n && r ? r + "-" : "",
                        a = n ? "" + s + e : r[e],
                        o = n ? a + "-active" : r[e + "Active"],
                        i = n ? a + "-done" : r[e + "Done"];
                    return { baseClassName: a, activeClassName: o, doneClassName: i };
                }),
                t
            );
        }
        ...
        return (
            (r.addClass = function (e, t, r) {
                var n,
                    s = this.getClassNames(t)[r + "ClassName"],
                    a = this.getClassNames("enter").doneClassName;
                "appear" === t && "done" === r && a && (s += " " + a),
                    "active" === r && e && l(e),
                    s &&
                        ((this.appliedClasses[t][r] = s),
                        (n = s),
                        e &&
                            n &&
            ...
            (r.removeClasses = function (e, t) {
                var r = this.appliedClasses[t],
                    ...
                    s = r.active,
                    a = r.done;
                (this.appliedClasses[t] = {}), n && y(e, n), s && y(e, s), a && y(e, a);
            }),
            (r.render = function () {
                var e = this.props,
