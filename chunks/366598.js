...
class N extends s.A {
    ...
    handleRTCConnectionState(e) {
        ...
        if (!(0, E.Pm)() || n !== S.S7L.RTC_CONNECTED) return;
    ...
    handleRTCConnectionVideo(e) {
        ...
        if (n !== r.x.STREAM || !(0, A.A)(d.Ay)) return;
    ...
    applyUserVoiceRecording(e) {
        if (!(0, A.A)(d.Ay)) return;
        let t = _.A.getRTCConnection();
        if (null == t) return;
        if (e === c.default.getId()) return void t.setClipRecordUser(e, "audio", (0, I.TD)());
    ...
    applyStreamRecording(e, t) {
        if ((0, A.A)(d.Ay) && c.default.getId() === e) {
            let n = (0, I.TD)();
