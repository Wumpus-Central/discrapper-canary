...
function B() {
    M({ deletedMessages: r().filter(C, (e) => A.A.isBlockedOrIgnoredForMessage(e)) }),
        (C = C.filter((e) => !A.A.isBlockedOrIgnoredForMessage(e)));
}
function j(e) {
    let { channel: t } = e,
        n = [];
    (C = r().filter(C, (e) => e.channel_id !== t.id || (delete v[e.id], n.push(e), !1))), M({ deletedMessages: n });
}
class H extends s.Ay.Store {
    ...
    getSettingsFilteredMentions() {
        return D || C.length > 0 ? C.filter(x) : null;
    }
    hasMention(e) {
        return v[e];
    }
...
let Y = new H(l.h, {
    ...
    TRUNCATE_MENTIONS: function (e) {
        ...
        for (let e = t; e < C.length; ++e) delete v[C[e].id];
    ...
    GUILD_DELETE: function (e) {
        ...
        (C = r().filter(C, (e) => {
            ...
            return (null != i && i.getGuildId() !== t.id) || (delete v[e.id], n.push(e), !1);
        })),
            M({ deletedMessages: n });
    },
    MESSAGE_CREATE: function (e) {
        ...
        let r = k(n, t);
        if (null == r) return !1;
        (C = C.slice()).unshift(r), (v[r.id] = !0), M({ addedMessages: [r] });
    },
