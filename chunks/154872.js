...
let I = r.memo(function (e) {
    ...
    return (0, i.jsx)(E.animated.div, {
        ...
        onMouseMove: (e) => I.current && y(e.movementX, e.movementY),
        onWheel: (e) => !e.ctrlKey && y(-e.deltaX, -e.deltaY),
...
let N = r.memo(function (e) {
    var t, n, r, o, E;
    let m,
        { media: g, obscured: A = !1, maxWidth: y, maxHeight: N, onContextMenu: v } = e,
        { width: R, height: O, url: b, proxyUrl: D, alt: L, type: w, maxWidth: M, maxHeight: P, ...x } = g,
        { zoomed: k } = (0, p.Q)(),
        U = (function (e) {
        ...
        G =
            ...
            t && f.A.isDiscordAssetUrl(n, o, E) ? (0, c.XW)(n, o, E) : (0, _.E)({ proxyURL: r, url: n })),
        F = null != R && 0 !== R && null != O && 0 !== O;
    if ("VIDEO" === w && F && null != D) {
        let e = g.poster ?? C(D);
