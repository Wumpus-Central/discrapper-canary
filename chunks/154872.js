...
let g = r.memo(function (e) {
    ...
    return (0, i.jsx)(I.animated.div, {
        ...
        onMouseMove: (e) => S.current && R(e.movementX, e.movementY),
        onWheel: (e) => !e.ctrlKey && R(-e.deltaX, -e.deltaY),
...
let O = r.memo(function (e) {
    var t, n, r, l, I;
    let f,
        { media: p, obscured: T = !1, maxWidth: m, maxHeight: C, onContextMenu: O } = e,
