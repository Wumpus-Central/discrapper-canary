...
function A(e) {
    ...
    return (
        s &&
            ((c += r.x),
            o + r.x > 0 && (c = (t - window.innerWidth) / 2),
            u + r.x < window.innerWidth && (c = (window.innerWidth - t) / 2)),
        a &&
            ((_ += r.y),
            l + r.y > 0 && (_ = (n - window.innerHeight) / 2),
            d + r.y < window.innerHeight && (_ = (window.innerHeight - n) / 2)),
        { x: c, y: _ }
    );
}
...
let y = r.memo(function (e) {
    var t, n, r, o, p;
    let m,
        { media: g, obscured: A = !1, maxWidth: N, maxHeight: y, onContextMenu: v } = e,
        { width: R, height: O, url: b, proxyUrl: L, alt: D, type: P, maxWidth: w, maxHeight: M, ...x } = g,
        { zoomed: U } = (0, E.Q)(),
        k = (function (e) {
        ...
        G =
            ...
            t && f.A.isDiscordAssetUrl(n, o, p) ? (0, d.XW)(n, o, p) : (0, _.E)({ proxyURL: r, url: n })),
        V = null != R && 0 !== R && null != O && 0 !== O;
    if ("VIDEO" === P && V && null != L) {
        let e = g.poster ?? C(L);
        ...
        let t = g.renderLinkComponent ?? c.bU;
        return (0, i.jsx)(u.A, {
            ...x,
            src: G,
            width: R,
