...
function N(e, t, n) {
    ...
    if (null != a) {
        ...
        delete s[t],
            ...
            (i = e ?? d.ME),
            (n = C(i)).has(t) && ((n = new Set(n)).delete(t), 0 === n.size ? m.delete(i) : m.set(i, n));
    }
    if (null != o) {
        if (((s[t] = o), null != o.channelId && ((S(g, o.channelId)[t] = o), o.selfVideo))) {
            let n;
            (S(A, o.channelId)[t] = o), (r = e ?? d.ME), (n = C(r)).has(t) || ((n = new Set(n)).add(t), m.set(r, n));
        }
...
let b = new O(l.h, {
    ...
    OVERLAY_INITIALIZE: function (e) {
        ...
        for (let [e, n] of ((p = {}), (g = {}), (I = {}), (A = {}), Object.entries(t)))
            for (let [t, i] of Object.entries(n)) N(e, t, () => new c.A(i));
        (i = n.id), (r = s);
    },
    VOICE_CHANNEL_SELECT: function (e) {
        let { guildId: t, channelId: n } = e,
            [r] = N(t, i, (e) => e?.set("channelId", n));
        return r;
    },
    ...
    PASSIVE_UPDATE_V2: function (e) {
        ...
        for (let n of e.removedVoiceStateUsers) N(e.guildId, n, () => null), (t = !0);
        return t && f++, t;
    },
