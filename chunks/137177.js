...
let T = { XXSMALL: I.W6, XSMALL: I.s, SMALL: I.EX, MEDIUM: I.Y, MEDIUM_LARGE: I.rZ, LARGE: I.as, XLARGE: I.AQ },
    S = r.forwardRef(function (e, t) {
        ...
        if (
            ...
            return (0, i.jsx)(f.Ay, { className: a()(I.Gt, v, N), guild: c, size: e });
        }
        if (null == s || "" === s)
            return R ? (O ?? (0, i.jsx)(l._, { size: "md", color: "currentColor", className: a()(I.Gt, C, N) })) : null;
        let k = u?.name,
            U =
                null != k && "" !== k
        ...
        return (0, i.jsxs)(i.Fragment, {
            children: [
                V ? null : (0, i.jsx)("div", { className: a()(I.qD, C, N) }),
                (0, i.jsx)("img", {
                    ref: t,
                    alt: U,
                    src: s,
                    className: a()(I.Gt, C, N),
