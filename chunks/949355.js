...
var r,
    ...
    R =
        ...
        (d[(d.UNUSED = 2)] = "UNUSED"),
        (d[(d.BURNED = 3)] = "BURNED"),
        (d[(d.PRESERVED = 4)] = "PRESERVED"),
        d),
    v =
        (((c = {})[(c.UNSPECIFIED = 0)] = "UNSPECIFIED"),
        (c[(c.DRAFT = 1)] = "DRAFT"),
        (c[(c.MEASUREMENT = 2)] = "MEASUREMENT"),
        (c[(c.ROLLING_OUT = 4)] = "ROLLING_OUT"),
        (c[(c.ARCHIVED = 6)] = "ARCHIVED"),
        (c[(c.AA_MODE = 7)] = "AA_MODE"),
        c);
class C extends h.G {
    constructor() {
        super("discord_protos.discord_experimentation.v1.Experiment", [
            ...
            { no: 18, name: "phase", kind: "enum", T: () => ["discord_protos.discord_experimentation.v1.Phase", v] },
            {
                no: 19,
                name: "surfaces",
                kind: "enum",
        ...
        for (; e.pos < s; ) {
            ...
            switch (t) {
                ...
                case 9:
                    ...
                    break;
                case 10:
                    i.hypothesis = p.hU.internalBinaryRead(e, e.uint32(), n, i.hypothesis);
                    break;
                case 11:
                    i.techSpecLink = p.hU.internalBinaryRead(e, e.uint32(), n, i.techSpecLink);
                    break;
                case 12:
                    i.revision = e.int32();
                    break;
                ...
                case 33:
                    ...
                    break;
                case 35:
                    i.guildExperimentVersion = p.as.internalBinaryRead(e, e.uint32(), n, i.guildExperimentVersion);
                    break;
                case 36:
    ...
    internalBinaryWrite(e, t, n) {
        "0" !== e.id && t.tag(1, _.O0.Bit64).fixed64(e.id),
            ...
            e.hypothesis && p.hU.internalBinaryWrite(e.hypothesis, t.tag(10, _.O0.LengthDelimited).fork(), n).join(),
            e.techSpecLink &&
                p.hU.internalBinaryWrite(e.techSpecLink, t.tag(11, _.O0.LengthDelimited).fork(), n).join(),
        ...
        e.debugConfig && P.internalBinaryWrite(e.debugConfig, t.tag(30, _.O0.LengthDelimited).fork(), n).join(),
            ...
            e.guildExperimentVersion &&
                p.as.internalBinaryWrite(e.guildExperimentVersion, t.tag(35, _.O0.LengthDelimited).fork(), n).join(),
...
class b extends h.G {
    constructor() {
        super("discord_protos.discord_experimentation.v1.Variation", [
            ...
            { no: 4, name: "buckets", kind: "message", repeat: 1, T: () => w },
            {
                ...
                name: "type",
                kind: "enum",
                T: () => ["discord_protos.discord_experimentation.v1.Variation.Type", O],
            },
        ...
        for (; e.pos < s; ) {
            ...
            switch (t) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    i.configuration = p.hU.internalBinaryRead(e, e.uint32(), n, i.configuration);
                    break;
                default:
                    let s = n.readUnknownField;
                    if ("throw" === s)
    ...
    internalBinaryWrite(e, t, n) {
        ...
        0 !== e.type && t.tag(5, _.O0.Varint).int32(e.type),
            e.configuration &&
                p.hU.internalBinaryWrite(e.configuration, t.tag(6, _.O0.LengthDelimited).fork(), n).join();
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? _.f$.onWrite : r)(this.typeName, e, t), t;
    }
}
    ...
    constructor() {
        super("discord_protos.discord_experimentation.v1.Bucket", [
            ...
            { no: 2, name: "stop", kind: "scalar", T: 5 },
            {
                ...
                name: "type",
                kind: "enum",
                T: () => ["discord_protos.discord_experimentation.v1.Bucket.Type", R],
            },
        ]);
    }
    create(e) {
