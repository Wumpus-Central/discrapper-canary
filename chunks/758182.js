...
async function G(e, t, n) {
    ...
    let c = null !== (r = T.Z.getGuildId()) && void 0 !== r ? r : null,
        ...
        [[I, y], A, R, Z, w, k, W] = await Promise.all([g, p, h, f, E, j, v]),
        L = performance.now() - m;
        ...
        return (
            ...
            D.verbose(
                'early_cache_summary: (\n        ok: true\n        meta:\n          auth_user_id: '
                    ...
                    .concat(m, '\n              channels: ')
                    .concat(null === (s = R.channels) || void 0 === s ? void 0 : s.length, '\n            user_settings: ')
...
async function Y(e, t, n, r) {
    ...
    let [i, s, o] = await O.Z.fetchLazyCache.measureAsync(() =>
            Promise.all([
        ...
        c = await O.Z.fetchStaleChannels.measureAsync(() =>
    ...
    K(() => {
        ...
        O.Z.deserializeCache.measure(() =>
            ...
            O.Z.dispatchLazyCache.measure(() => d.Z.dispatch(u)),
