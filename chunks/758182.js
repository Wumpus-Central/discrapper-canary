...
function U(e) {
    R.log("Clearing cache store"),
        ...
        o.K.remove(P.O42),
        (w = "no-cache"),
        "CLEAR_CACHES" === e.type && e.preventWritingCachesAgainThisSession && (Z = !0);
}
...
async function G(e, t, n) {
    ...
    let d = null != (i = T.Z.getGuildId()) ? i : null,
        ...
        j =
            null != e
                ? a.Z.timeAsync("\uD83D\uDCBE", "cache: private_channels", () => _.Z.getAsync(e, null))
                : Promise.resolve([]),
        E =
            null == e
                ? Promise.resolve({})
                : a.Z.timeAsync("\uD83D\uDCBE", "cache: user_settings", () => x.Z.getAll(e)),
        ...
        return (
            l.ZP.Emitter.batched(() => {
                a.Z.time("\uD83D\uDCBE", "Dispatch Mini Cache", () => {
                    ...
                    a.Z.time("\uD83D\uDCBE", "socket.processFirstQueuedDispatch()", () =>
                        o.dispatcher.processFirstQueuedDispatch(new Set(["INITIAL_GUILD"])),
                    );
            }),
            R.verbose(
                "early_cache_summary: (\n        ok: true\n        meta:\n          auth_user_id: "
...
async function H(e, t) {
    ...
    if (F)
        return null !=
            (n = await (0, d.dI)(() => a.Z.timeAsync("\uD83D\uDCBE", "cache: guilds", () => m.Z.getAsync(e))))
            ? n
            : [];
...
async function W(e, t, n, i) {
    ...
    let [r, s, l] = await O.Z.fetchLazyCache.measureAsync(() =>
            Promise.all([
                (0, d.dI)(() =>
                    null != e
                        ? a.Z.timeAsync("\uD83D\uDCBE", "cache: cache_version", () => p.Z.okAsync(e))
                        : Promise.resolve(!0),
                ),
                (0, d.dI)(() =>
                    null == e || F
                        ? Promise.resolve([])
                        : a.Z.timeAsync("\uD83D\uDCBE", "cache: lazy guilds", () => m.Z.getAsync(e)),
                ),
                (0, d.dI)(() =>
                    null != e
        ...
        o = await O.Z.fetchStaleChannels.measureAsync(() =>
            null != e && null != l && l.stale.length > 0
                ? (0, d.dI)(() => {
                      ...
                      return (
                          ...
                          Promise.all(t.map((t) => _.Z.getAsync(e, t).then((e) => [t, e])))
                      );
                  })
                : Promise.resolve([]),
        );
    ...
    Y(() => {
        ...
        O.Z.deserializeCache.measure(() => {
            null != d.channels && (0, y.ZP)(d.channels),
                null != d.privateChannels && (0, y.ZP)(d.privateChannels),
                null != d.guildChannels && (0, y._$)(d.guildChannels);
        }),
            O.Z.dispatchLazyCache.measure(() => c.Z.dispatch(d)),
    ...
    async loadCacheAsync(e, t) {
        ...
        if ("initializing" !== w) {
            (0, A.Z)("cache:lazy_cache_not_initializing"),
                ...
                setTimeout(() => {
                    var e, t;
                    return null == (t = C.Z.getSocket()) || null == (e = t.dispatcher)
                        ? void 0
        ...
        try {
            ...
            r
                ? (n(), await W(i, t, s, a))
                : (n(), await (Y(() => c.Z.dispatch({ type: "CACHE_LOADED_LAZY_NO_CACHE" })), Promise.resolve()));
        } catch (e) {
