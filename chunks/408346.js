...
function tw() {
    return null == (0, c.bG)([tB.Ay], () => tB.Ay.getVisibleGame())
        ...
        : (0, i.jsxs)(d.$T, {
              color: d.Hv.DANGER,
              children: [
                  (0, i.jsx)(d.PM, { noticeType: ei.kqX.SYSTEM_SERVICE_WARNING, onClick: () => nt() }),
...
function t4(e) {
    ...
    return (0, i.jsxs)(d.$T, {
        ...
        children: [
            ...
            (0, i.jsx)(t6, { error: eC.iy.NO_INPUT_DEVICES }),
            (0, i.jsx)(d.eC, {
...
function t9(e) {
    ...
    return (0, i.jsxs)(d.$T, {
        ...
        children: [
            ...
            (0, i.jsx)(t6, { error: eC.iy.VIDEO_BACKGROUND_UNAVAILABLE }),
            (0, i.jsx)(d.zr, {
    ...
    return (
        !0 === a
            ? ((t = es.intl.string(es.t.ppW3ri)),
              (n = (0, i.jsx)(d.eC, { href: t8(s), noticeType: l, children: es.intl.string(es.t.QghSIq) })))
            : 0 === o
        ...
        (0, i.jsxs)(d.$T, {
            ...
            children: [
                ...
                t,
                (0, i.jsx)(t6, { allowClick: E, error: eC.iy.NO_AUDIO_INPUT_DETECTED }),
                n,
            ],
        })
    );
              ...
              switch (r.type) {
                  ...
                  case ei.kqX.WIN32_DEPRECATED_MESSAGE:
                      ...
                      return (0, i.jsxs)(d.$T, {
                          color: d.Hv.WARNING,
                          children: [
                              (0, i.jsx)(d.PM, { onClick: () => nt(B), noticeType: r.type }),
                  ...
                  case ei.kqX.WIN7_8_DEPRECATED_MESSAGE:
                      ...
                      return (0, i.jsxs)(d.$T, {
                          color: d.Hv.WARNING,
                          children: [
                              (0, i.jsx)(d.PM, { onClick: () => nt(F), noticeType: r.type }),
                  ...
                  case ei.kqX.WIN_COMPAT_MODE_MESSAGE:
                      ...
                      return (0, i.jsxs)(d.$T, {
                          color: d.Hv.WARNING,
                          children: [
                              (0, i.jsx)(d.PM, { onClick: () => nt(V), noticeType: r.type }),
                  ...
                  case ei.kqX.MACOS_DEPRECATED_MESSAGE:
                      ...
                      return (0, i.jsxs)(d.$T, {
                          color: d.Hv.WARNING,
                          children: [
                              (0, i.jsx)(d.PM, { onClick: () => nt(w), noticeType: r.type }),
                  ...
                  case ei.kqX.E2EE_UPDATE_REQUIRED:
                      ...
                      return (0, i.jsxs)(d.$T, {
                          color: d.Hv.WARNING,
                          children: [
                              (0, i.jsx)(d.PM, { onClick: () => nt(Y), noticeType: r.type }),
                  ...
                  case ei.kqX.WINDOWS_MEDIA_PACK_REQUIRED:
                      return (0, i.jsxs)(d.$T, {
                          color: d.Hv.WARNING,
                          children: [
                              (0, i.jsx)(d.PM, { onClick: () => nt(), noticeType: r.type }),
                  ...
                  case ei.kqX.STREAMER_MODE:
                      return (0, i.jsxs)(d.$T, {
                          ...
                          children: [
                              (0, i.jsx)(d.PM, { onClick: () => nt(), noticeType: ei.kqX.STREAMER_MODE }),
                              ...
                              (0, i.jsx)(d.Z_, {
                                  ...
                                  onClick: async () => {
                                      try {
                                          ...
                                          null != e && t7.error("Failed to open off-platform premium perk modal", e);
                                      }
                                  },
                  ...
                  case ei.kqX.VIDEO_UNSUPPORTED_BROWSER:
                      return (0, i.jsxs)(d.$T, {
                          color: d.Hv.WARNING,
                          children: [
                              (0, i.jsx)(d.PM, { onClick: () => nt(), noticeType: ei.kqX.VIDEO_UNSUPPORTED_BROWSER }),
                  ...
                  case ei.kqX.DISPATCH_ERROR:
                      ...
                      return (0, i.jsxs)(d.$T, {
                          color: d.Hv.DANGER,
                          children: [
                              (0, i.jsx)(d.PM, { onClick: () => nt(), noticeType: ei.kqX.DISPATCH_ERROR }),
                              er?.displayMessage,
                              (0, i.jsx)(d.Z_, {
                      ...
                      return (0, i.jsxs)(d.$T, {
                          ...
                          children: [
                              ...
                              (0, i.jsx)(d.Z_, {
                                  ...
                                  onClick: () => {
                                      nt(ed), (0, Z.openUserSettings)(Q.X.SUBSCRIPTIONS_PANEL);
                                  },
                  ...
                  case ei.kqX.PARENTAL_CONSENT_WARNING:
                      return (0, i.jsx)(tT, { daysRemaining: r.metadata?.daysRemaining ?? null });
