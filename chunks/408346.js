    ...
    21552 == n.j
        ? function () {
              ...
              return (0, i.jsxs)("div", {
                  className: eQ()(...A),
                  children: [
                      (0, i.jsx)(_.E, { className: e7.wx, variant: "text-sm/normal", children: o }),
...
function te(e) {
    ...
    return (0, i.jsxs)(d.$T, {
        className: e9.eR,
        children: [
            r && (0, i.jsx)(d.PM, { onClick: l, className: e9.b, noticeType: ei.kqX.BACK_TO_PREVIOUS_SCREEN }),
...
function tF() {
    return null == (0, c.bG)([tX.Ay], () => tX.Ay.getVisibleGame())
        ...
        : (0, i.jsxs)(d.$T, {
              color: d.Hv.DANGER,
              children: [
                  (0, i.jsx)(d.PM, { noticeType: ei.kqX.SYSTEM_SERVICE_WARNING, onClick: () => t9() }),
...
function t7(e) {
    ...
    return (0, i.jsxs)(d.$T, {
        ...
        children: [
            ...
            (0, i.jsx)(t3, { error: eC.iy.NO_INPUT_DEVICES }),
            (0, i.jsx)(d.eC, {
...
function t6(e) {
    ...
    return (0, i.jsxs)(d.$T, {
        ...
        children: [
            ...
            (0, i.jsx)(t3, { error: eC.iy.VIDEO_BACKGROUND_UNAVAILABLE }),
            (0, i.jsx)(d.zr, {
        ...
        (0, i.jsxs)(d.$T, {
            ...
            children: [
                (0, i.jsx)(d.PM, {
                    noticeType: l,
                    onClick: () => {
                        t9(), (0, N.openModal)((e) => (0, i.jsx)(tY, { ...e }));
                    },
                }),
                t,
                (0, i.jsx)(t3, { allowClick: E, error: eC.iy.NO_AUDIO_INPUT_DETECTED }),
                n,
            ],
        })
    );
        ...
        ? l.memo(function () {
              ...
              switch (r.type) {
                  ...
                  case ei.kqX.GUILD_RAID_NOTIFICATION:
                      ...
                      return (0, i.jsx)(ej, { onDismiss: () => t9(b) });
                  case ei.kqX.WIN32_DEPRECATED_MESSAGE:
                      let { dismissUntil: B } = r.metadata;
                      return (0, i.jsxs)(d.$T, {
                          color: d.Hv.WARNING,
                          children: [
                              (0, i.jsx)(d.PM, { onClick: () => t9(B), noticeType: r.type }),
                  ...
                  case ei.kqX.WIN7_8_DEPRECATED_MESSAGE:
                      ...
                      return (0, i.jsxs)(d.$T, {
                          color: d.Hv.WARNING,
                          children: [
                              (0, i.jsx)(d.PM, { onClick: () => t9(F), noticeType: r.type }),
                  ...
                  case ei.kqX.WIN_COMPAT_MODE_MESSAGE:
                      ...
                      return (0, i.jsxs)(d.$T, {
                          color: d.Hv.WARNING,
                          children: [
                              (0, i.jsx)(d.PM, { onClick: () => t9(V), noticeType: r.type }),
                  ...
                  case ei.kqX.MACOS_DEPRECATED_MESSAGE:
                      ...
                      return (0, i.jsxs)(d.$T, {
                          color: d.Hv.WARNING,
                          children: [
                              (0, i.jsx)(d.PM, { onClick: () => t9(w), noticeType: r.type }),
                  ...
                  case ei.kqX.E2EE_UPDATE_REQUIRED:
                      ...
                      return (0, i.jsxs)(d.$T, {
                          color: d.Hv.WARNING,
                          children: [
                              (0, i.jsx)(d.PM, { onClick: () => t9(Y), noticeType: r.type }),
                  ...
                  case ei.kqX.WINDOWS_MEDIA_PACK_REQUIRED:
                      return (0, i.jsxs)(d.$T, {
                          color: d.Hv.WARNING,
                          children: [
                              (0, i.jsx)(d.PM, { onClick: () => t9(), noticeType: r.type }),
                  ...
                  case ei.kqX.VOICE_DISABLED:
                      return (0, i.jsxs)(d.$T, {
                          ...
                          children: [
                              (0, i.jsx)(d.PM, {
                                  onClick: () => {
                                      p.clearRemoteDisconnectVoiceChannelId(), t9();
                                  },
                                  noticeType: r.type,
                              }),
                  ...
                  case ei.kqX.VOICE_CONNECTED_LAST_SESSION:
                      return (0, i.jsxs)(d.$T, {
                          ...
                          children: [
                              (0, i.jsx)(d.PM, {
                                  onClick: () => {
                                      p.clearLastSessionVoiceChannelId(), t9();
                                  },
                                  noticeType: r.type,
                              }),
                          ...
                          return (0, i.jsxs)(d.$T, {
                              ...
                              children: [
                                  ...
                                  (0, i.jsx)(d.PM, {
                                      noticeType: r.type,
                                      onClick: () => {
                                          O.A.setEnableHardwareMuteNotice(!1), t9();
                                      },
                                  }),
                                  (0, i.jsx)(d.eC, {
                                      href: t.url,
                  ...
                  case ei.kqX.STREAMER_MODE:
                      return (0, i.jsxs)(d.$T, {
                          ...
                          children: [
                              (0, i.jsx)(d.PM, { onClick: () => t9(), noticeType: ei.kqX.STREAMER_MODE }),
                  ...
                  case ei.kqX.VIDEO_UNSUPPORTED_BROWSER:
                      return (0, i.jsxs)(d.$T, {
                          color: d.Hv.WARNING,
                          children: [
                              (0, i.jsx)(d.PM, { onClick: () => t9(), noticeType: ei.kqX.VIDEO_UNSUPPORTED_BROWSER }),
                  ...
                  case ei.kqX.DISPATCH_ERROR:
                      ...
                      return (0, i.jsxs)(d.$T, {
                          color: d.Hv.DANGER,
                          children: [
                              (0, i.jsx)(d.PM, { onClick: () => t9(), noticeType: ei.kqX.DISPATCH_ERROR }),
                              er?.displayMessage,
                              (0, i.jsx)(d.Z_, {
                      ...
                      return (0, i.jsxs)(d.$T, {
                          ...
                          children: [
                              (0, i.jsx)(d.PM, {
                                  ...
                                  onClick: () => {
                                      t9(r.metadata?.premiumSubscription?.currentPeriodEnd);
                                  },
                              }),
                              (0, i.jsx)(I.t, { size: "md", color: "currentColor", className: ea.PC }),
                              X === el.PremiumTypes.TIER_1
                      ...
                      return (0, i.jsxs)(d.$T, {
                          ...
                          children: [
                              ...
                              (0, i.jsx)(d.Z_, {
                                  ...
                                  onClick: () => {
                                      t9(ed), (0, Z.openUserSettings)(Q.X.SUBSCRIPTIONS_PANEL);
                                  },
