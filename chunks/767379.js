...
let M = function (e) {
    let { transitionState: t, entryPoint: n, onClose: d, onComplete: _, dismissable: b, classificationId: M } = e,
        [O, U] = s.useState(r.M.AGE_VERIFICATION_SURVEY_MODAL_GET_STARTED),
        k = s.useRef(O),
        [P, w] = (0, h.kn)([O], void 0, !0),
        L = s.useMemo(() => (0, l.A)(), []),
        D = s.useRef(!1),
        F = (0, A.W$)();
    s.useEffect(() => {
