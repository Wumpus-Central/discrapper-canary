n.d(t, { EB: () => g, G: () => i, Qb: () => I, aU: () => h, o5: () => d }), n(321073);
var l,
    i =
        (((l = {}).GuildText = "GUILD_TEXT"),
        (l.GuildVoice = "GUILD_VOICE"),
        (l.DirectMessage = "DIRECT_MESSAGE"),
        (l.GroupDM = "GROUP_DM"),
        l);
function s(e, t, n, l) {
    let i = 0;
...
class a {
    ...
    computeScore(e) {
        ...
        return (
            ...
            (this.scoreInfo.voiceActivityScore = l),
...
function h(e, t) {
    ...
    let l = 0;
    return (
        null != t.voiceGuildId && n === t.voiceGuildId && (l += 1),
        null != t.mostRecentGuildId && n === t.mostRecentGuildId && (l += 0.4),
        l
    );
}
function g(e, t) {
