...
function A(e) {
    let t,
        { endpoint: n, path: r, id: i, hash: a, size: s, lossless: c = !1, canAnimate: u = !1, keepAspectRatio: d, format: _ = null, canWebP: f = O } = e;
...
function w(e) {
    let t,
        { guildId: n, userId: r, avatar: i, canAnimate: a = !1, size: s = _.IXf, canWebP: c = O } = e,
        u = a && X(i) ? er(c) : 'jpg',
