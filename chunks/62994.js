                ...
                constructor(A, I, g, i) {
                    ...
                    try {
                        g && this.addEventListener("ready", g),
                            ...
                            this.debugLogs &&
                                (x.Logger.info(
                                    "AudioFilterNode:constructor",
                                    "Connecting with other threads for logging",
                                ),
                                x.Logger.collectFrom(this.worker, h),
                                x.Logger.collectFrom(this.port, h)),
                            this.debugLogs &&
                                x.Logger.info("AudioFilterNode:constructor", "Send init WASM processor event"),
                        ...
                        throw (
                            (this.debugLogs && x.Logger.error("AudioFilterNode:constructor", A),
                            Error("WORKER_NOT_SUPPORTED"))
                        );
                    }
                ...
                _onWasmWorkerMessage(A) {
                    ...
                    switch (I) {
                        case "WASM_PROCESSOR_INITIALIZED":
                            this.debugLogs &&
                                x.Logger.info("AudioFilterNode:_onWasmWorkerMessage", "WASM processor initialized"),
                                (this.isReady = !0),
                        ...
                        case "BUFFER_OVERFLOW":
                            this.debugLogs &&
                                x.Logger.info(
                                    "AudioFilterNode:_onWasmWorkerMessage",
                                    "Buffer overflown:",
                                    JSON.stringify(g),
                                ),
                        ...
                        connectedCallback() {
                            ...
                            (this.style.position = "absolute"),
                                ...
                                this.shadowRoot
                                    ...
                                    ?.addEventListener("click", () => C.Logger.downloadReport());
                        }
                    },
                );
        },
                        ...
                        g.channel.port1.addEventListener("message", (A) => {
                            "string" == typeof A.data
                                ...
                                : g.recorder && "LOG_INPUT_AUDIO" === A.data?.event
                                  ...
                                  : g.recorder &&
                                    "LOG_OUTPUT_AUDIO" === A.data?.event &&
                                    g.recorder.pushOutput(A.data.data);
                        }),
                ...
                constructor(A, I = 1) {
                    ...
                    for (let A = 0; A < I; A++)
                        this._channelData.push(
                            new Float32Array(
                                new SharedArrayBuffer(this._bufferLength * Float32Array.BYTES_PER_ELEMENT),
                            ),
                        );
                }
                static from(A) {
    ...
    class i {
        ...
        async createNoiseFilter(I, Q, B) {
            ...
            if (!I || !I.audioWorklet)
                throw (
                    (this.debugLogs &&
                        x.Logger.error(
                            "KrispSDK:createNoiseFilter",
                            "audioContext or audioContext.audioWorklet not found",
                        ),
            ...
            try {
                ...
                throw (
                    (this.debugLogs && x.Logger.error("KrispSDK:createNoiseFilter", A), Error("WORKLET_NOT_SUPPORTED"))
                );
            }
