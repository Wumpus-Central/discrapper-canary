...
let a = (0, r.C)({
    ...
    treatments: [{ id: 1, label: "Enable latching feature", config: { enableLatching: !0 } }],
});
function s(e) {
...
function o(e) {
    let { location: t, autoTrackExposure: n = !0 } = e,
        { isInHoldout: r } = i.p.useExperiment({ location: t }, { autoTrackExposure: n });
    return a.useExperiment({ location: t }, { disable: r, autoTrackExposure: n });
}
