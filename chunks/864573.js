...
function P(e) {
    var t, n;
    let { isPaused: o, width: i, height: P, windowKey: C } = e,
        ...
        W = (0, a.e7)([d.Z], () => d.Z.hasPurchasedUpgrade(b.yN.BOUNCING_LOGO, b.uv.BOUNCING_LOGO_CORNERS)),
        R = (0, a.e7)([d.Z], () => d.Z.getNumPurchasesForItemUpgrade(b.yN.BOUNCING_LOGO, b.uv.BOUNCING_LOGO_SPEED)),
        A = (0, a.e7)([d.Z], () => d.Z.hasPurchasedUpgrade(b.yN.BOUNCING_LOGO, b.uv.BOUNCING_LOGO_COLORS)),
        T = null !== (t = b.SZ[R]) && void 0 !== t ? t : b.SZ['0'],
        L = (i / 1920) * T,
        B = (P / 1080) * T,
        [D, F] = (0, p.Z)(b.yN.BOUNCING_LOGO),
        U = (0, s.useRef)(null !== (n = D.count) && void 0 !== n ? n : 0);
    (0, s.useEffect)(() => {
        var e;
