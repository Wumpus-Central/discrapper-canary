    ...
    A = {
        ...
        setPinChat(e) {
            let t = h.OVERLAY_LAYOUT_ID,
                ...
                i = d.A.getWidgetConfig(m.uss.GUILDS),
            ...
            if (
                (n.forEach((e) => {
                    ...
                    switch (t) {
                        case m.uss.TEXT:
                            (g = (0, p.fd)(i, _)), (0, E.uv)(n);
                            break;
                        case m.uss.GUILDS:
                            (A = (0, p.NR)(r, i, _)), (I = (0, p.fd)(i, _)), (0, E.uv)(n);
                            break;
                        case m.uss.GUILDS_TEXT:
                            (T = (0, p.NR)(r, i, _)), (S = (0, p.fd)(i, _)), (0, E.uv)(n);
                    }
                }),
                e)
            ) {
                ...
                (0, E.jn)({ ...o, type: m.uss.TEXT, id: (0, r.A)(), size: a, anchor: s, layoutId: t });
                ...
                (0, E.jn)({ ...c, type: m.uss.GUILDS, id: (0, r.A)(), size: i, anchor: n, layoutId: t });
            } else {
                ...
                (0, E.jn)({ ...s, type: m.uss.GUILDS_TEXT, id: (0, r.A)(), layoutId: t, anchor: n, size: i });
            }
        },
