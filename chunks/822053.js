...
var n = {
    ...
    'creditCard.expiryDateField.title': 'Udløbsdato',
    ...
    'creditCard.taxNumber.placeholder': 'ÅÅMMDD/0123456789',
    ...
    'idealIssuer.selectField.placeholder': 'Vælg din bank',
    ...
    'dragonpay.voucher.non.bank.selectField.placeholder': 'Vælg din udbyder',
    'dragonpay.voucher.bank.selectField.placeholder': 'Vælg din bank',
    ...
    'creditCard.encryptedPassword.label': 'Første 2 cifre i adgangskode til kort',
    ...
    'error.va.sf-cc-num.03': 'Indtast et understøttet kort',
    'error.va.sf-cc-num.04': 'Indtast det fulde kortnummer',
    'error.va.sf-cc-dat.01': 'Indtast en gyldig udløbsdato',
    'error.va.sf-cc-dat.02': 'Indtast en gyldig udløbsdato',
    'error.va.sf-cc-dat.03': 'Kreditkort udløber snart',
    'error.va.sf-cc-dat.04': 'Indtast udløbsdatoen',
    'error.va.sf-cc-dat.05': 'Indtast den fulde udløbsdato',
    'error.va.sf-cc-mth.01': 'Indtast udløbsmåneden',
    'error.va.sf-cc-yr.01': 'Indtast udløbsåret',
    'error.va.sf-cc-yr.02': 'Indtast det fulde udløbsår',
    ...
    'error.va.sf-ach-num.02': 'Bankkontonummer har den forkerte længde',
    'error.va.sf-ach-loc.01': 'Feltet til registreringsnummeret er tomt',
    'error.va.sf-ach-loc.02': 'Registreringsnummeret har den forkerte længde',
    'error.va.sf-kcp-pwd.01': 'Feltet til adgangskode er tomt',
    'error.va.sf-kcp-pwd.02': 'Adgangskoden har den forkerte længde',
    ...
    'creditCard.encryptedExpiryDate.aria.label': 'Udløbsdato',
    'creditCard.encryptedExpiryMonth.aria.iframeTitle': 'Iframe til udløbsmåned',
    'creditCard.encryptedExpiryMonth.aria.label': 'Udløbsmåned',
    'creditCard.encryptedExpiryYear.aria.iframeTitle': 'Iframe til udløbsår',
    'creditCard.encryptedExpiryYear.aria.label': 'Udløbsår',
    ...
    'creditCard.encryptedPassword.aria.label': 'Første 2 cifre i adgangskode til kort',
