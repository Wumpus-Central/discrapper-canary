...
let m = function (e) {
    ...
    let { dismissCurrentNotice: n, subscriptionTier: m } = e,
        ...
        b = (0, d.N)(),
        g = (0, l.Z)(null != b && null != b.expires_at ? Date.parse(b.expires_at) : 0),
        O = null == b || (null === (t = b.subscription_trial) || void 0 === t ? void 0 : t.sku_id) !== m || null == b.expires_at || Object.values(g).every((e) => 0 === e);
    return ((0, c.Z)(
        {
            type: i.ImpressionTypes.VIEW,
            name: i.ImpressionNames.TRIAL_NOTICE,
            properties: { trial_id: null == b ? void 0 : b.trial_id }
        },
        { disableTrack: O }
    ),
    O)
