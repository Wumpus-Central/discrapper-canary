...
let O = function (e) {
    ...
    let { dismissCurrentNotice: n, subscriptionTier: O } = e,
        ...
        h = (0, d.N)(),
        I = (0, a.Z)(null != h && null != h.expires_at ? Date.parse(h.expires_at) : 0),
        T = null == h || (null == (t = h.subscription_trial) ? void 0 : t.sku_id) !== O || null == h.expires_at || Object.values(I).every((e) => 0 === e);
    return ((0, c.Z)(
        {
