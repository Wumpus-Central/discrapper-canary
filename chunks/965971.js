...
class b {
    ...
    groupCounters = { [v.uj.Viewed]: b.makeEmptyGroupAnalytics(), [v.uj.Clicked]: b.makeEmptyGroupAnalytics() };
    ...
    async getAnalytics() {
        let e = this.overlayMethod ?? _.Ue.Disabled,
            t = {
                ...
                setting_chat_notification: f.A.isNotificationDisabled(v.KS.TextChat) ? "DISABLED" : "ENABLED",
            },
            n = (0, d.hw)(this.game),
            i = (0, c.wH)(this.game),
