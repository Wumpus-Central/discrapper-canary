...
function en(e, l) {
    let s = (0, E.$)(l),
        { category: t } = O(e, { enabled: s, includeUnpublished: (0, x.A)("shop_include_unpublished") }),
        n = (0, c.bG)([j.A], () => j.A.getCategory(e));
    return s ? (t ?? void 0) : n;
}
let ea = { aspectRatio: "1 / 1" },
    er = {
    ...
    let { currentCategorySkuId: l, handleTransition: s } = e,
        ...
        { categories: i } = (function (e) {
            let { anchorCollectionId: l, limit: s, enabled: t = !0 } = e,
                a = n.useMemo(() => ({ applicationId: z.FYj, anchorCollectionId: l ?? "", limit: s }), [l, s]),
                r = t && null != l && "" !== l,
                i = (0, L.HX)(a);
            n.useEffect(() => {
                r && (0, L.Su)(a);
        ...
        u = n.useMemo(() => {
            if (a) return i.filter(d).slice(0, 8);
            let e = [...o.values()],
...
let ex = function (e) {
    let { collectionId: l } = e,
        s = (0, i.W6)(),
        a = en(l, "collection_index_page_content"),
        r = n.useCallback(
            (e) => {
                ...
                c && null != o
                    ? (0, t.jsxs)(t.Fragment, {
                          children: [
                              ...
                              (0, t.jsx)(ei, { category: a }),
                              (0, t.jsx)(eo, { currentCategorySkuId: a.skuId, handleTransition: r }, a.skuId),
                          ],
                      })
                    : (0, t.jsxs)("div", {
                          className: es.AW,
                          children: [
                              ...
                              (0, t.jsx)("div", { className: es.$T, children: (0, t.jsx)(K.A, { category: a }) }),
                              (0, t.jsx)(ei, { category: a }),
                              (0, t.jsx)(eo, { currentCategorySkuId: a.skuId, handleTransition: r }, a.skuId),
                          ],
                      }),
...
let em = function (e) {
    ...
    let B = (0, h.A)((0, o.A)()),
        ...
        { category: P, state: G } = O(l, { enabled: T, includeUnpublished: (0, x.A)("shop_include_unpublished") }),
    ...
    return null == l || !F || X
        ? (0, t.jsx)(i.rd, { to: z.BVt.COLLECTIBLES_SHOP })
        : V?.isOrbsExclusive === !0
          ? (0, t.jsx)(i.rd, { to: z.BVt.COLLECTIBLES_SHOP_WITH_TAB(ee.G2.ORBS) })
          : null == V
            ? (0, t.jsxs)("div", {
                  className: r()(eC.bx, { [eI.jP]: L }),
                  ref: s,
                  tabIndex: -1,
                  children: [
                  ...
                  children: (0, t.jsx)(b.R9, {
                      ...
                      children: (0, t.jsxs)("div", {
                          ...
                          children: [
                              ...
                              (0, t.jsx)(d.Ip, { ref: a, children: (0, t.jsx)(ex, { collectionId: l }) }),
                          ],
                      }),
                  }),
              });
