...
class K extends r.PureComponent {
    ...
    renderProtip() {
        return (0, i.jsx)(_.Z, {
            className: a()(P.protip, { [P.hasContent]: this.state.query.length > 0 }),
    ...
    renderTutorial() {
        ...
        return t ? null : (0, i.jsx)(M.Z, { hasQuery: e.length > 0 && s.length > 0 });
    }
    render() {
    ...
    constructor(...e) {
        super(...e),
                ...
                switch (t.type) {
                    case p.h8.GUILD:
                        return (0, u.jW)(e, async () => {
                            let { default: e } = await Promise.all([s.e('63288'), s.e('7654'), s.e('98479'), s.e('53967'), s.e('20242'), s.e('60696'), s.e('58227'), s.e('16114'), s.e('58531'), s.e('94107'), s.e('33213'), s.e('93702')]).then(s.bind(s, 545135));
                            return (s) =>
                                (0, i.jsx)(e, {
                                    ...s,
                                    guild: t.record,
                    ...
                    case p.h8.USER:
                        return (0, u.jW)(e, async () => {
                            let { default: e } = await Promise.all([s.e('79695'), s.e('69220'), s.e('57375')]).then(s.bind(s, 881351));
                            return (s) =>
                                (0, i.jsx)(e, {
                                    ...s,
                                    user: t.record,
            ...
            v(this, 'handleKeyDown', (e) => {
                ...
                switch (i) {
                    case 'escape':
                        e.preventDefault(), e.stopPropagation(), s.length > 0 ? this.search('') : (0, O.Cp)();
                        return;
                    case 'k':
