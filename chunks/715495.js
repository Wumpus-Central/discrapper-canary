...
function _() {
    ...
    let [t, n] = (0, i.useState)(!1),
        ...
        [m, g] = (0, i.useState)([]),
        h = (0, i.useCallback)((e) => {
            c((t) => (null == t ? { src: e } : b(x({}, t), { src: e })));
        }, []),
        _ = (0, i.useCallback)((e) => {
            c((t) => (null == t ? { animatedSrc: e } : b(x({}, t), { animatedSrc: e })));
        }, []),
        T = (0, i.useCallback)((e) => {
            g((t) => t.filter((t) => t !== e));
        }, []);
                        ...
                        children: [
                            ...
                            s &&
                                (0, r.jsx)(p.Z, {
                                    ...
                                    onSelect: (e) => {
                                        c((t) => (null == t ? { palette: e } : b(x({}, t), { palette: e })));
                                    }
                                })
                        ]
                    })
                ...
                children: [
                    ...
                    (0, r.jsxs)('div', {
                        ...
                        children: [
                            ...
                            (0, r.jsx)(C, {
                                label: 'border color',
                                onChange: (e) => c((t) => (null == t ? { borderColor: e } : b(x({}, t), { borderColor: e })))
                            }),
                            (0, r.jsx)(j, {
                                label: 'set',
                                onClick: () => {}
