...
function ec(e) {
    let { channel: t, width: n } = e,
        ...
        E = (0, u.bG)([j.A], () => j.A.getCurrentUserActiveStream()),
        m = null != s && "user" in s ? s.user.id : "",
        g = (0, v.A)(s?.type === ea.lp.STREAM ? c.x.STREAM : c.x.DEFAULT, m),
        S = (0, N.A)(m),
        y = (0, u.yK)([j.A], () => j.A.getAllActiveStreams()),
