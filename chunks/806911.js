...
class el extends i.PureComponent {
    ...
    getScreenMessage() {
        ...
        return null == n ? null : (0, C.A)(n, e.user, e.user.id === t, this.streamerPaused);
    }
    componentDidMount() {
    ...
    handleJumpToChannel = () => {
        ...
        let n = this.activeStreamForSelectedParticipant;
        null != n && E.A.selectParticipant(n.channelId, (0, R._z)(n));
    };
    handleStopStream = () => {
    ...
    renderSettingsIcon = () => {
        ...
        let n = t.find((t) => (0, R._z)(t) === e.id);
        return null == n || n.state === ei.XYD.ENDED
            ? null
            : (0, r.jsx)(V.A, { stream: n, className: ea.iq, appContext: ei.BRT.APP, location: m.A.VIDEO_PIP });
    };
    renderStreamState() {
        ...
        if (null != s && null == a) {
            if (t?.type === es.lp.STREAM) return (0, r.jsx)(Z.A, { stream: t.stream, width: n, avError: s });
...
function eu(e) {
    let { channel: t, width: n } = e,
        i = (0, u.bG)([j.A], () => j.A.getSpeaker(t.id)),
        ...
        c = null == a || a.disabled,
        _ = !c,
        f = (0, u.bG)([H.Ay], () => !c && H.Ay.isVideoEnabled(), [c]),
        E = (0, u.bG)([H.Ay], () => (0, v.A)(H.Ay)),
        h = (0, u.bG)([B.default], () => B.default.getId()),
        p = (0, u.bG)([F.A], () => F.A.getCurrentUserActiveStream()),
        m = null != s && "user" in s ? s.user.id : "",
        g = (0, O.A)(s?.type === es.lp.STREAM ? d.x.STREAM : d.x.DEFAULT, m),
        T = (0, N.A)(m),
