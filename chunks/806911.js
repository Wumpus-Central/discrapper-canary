...
class el extends i.PureComponent {
    ...
    componentDidMount() {
        ...
        $.default.track(ei.HAw.VIDEO_LAYOUT_TOGGLED, { video_layout: "pip", ...(0, E.QS)(e.id) });
    }
    componentWillUnmount() {
        let { channel: e } = this.props;
        $.default.track(ei.HAw.VIDEO_LAYOUT_TOGGLED, { video_layout: A.A.getLayout(e.id), ...(0, E.QS)(e.id) });
    }
    handleVideo = (e) => {
    ...
    handleJumpToChannel = () => {
        ...
        (0, w.uh)(t, e.id), p.A.channelListScrollTo(t, e.id);
        let n = this.activeStreamForSelectedParticipant;
    ...
    renderSettingsIcon = () => {
        ...
        return null == n || n.state === ei.XYD.ENDED
            ? null
            : (0, r.jsx)(V.A, { stream: n, className: es.iq, appContext: ei.BRT.APP, location: g.A.VIDEO_PIP });
    };
    renderStreamState() {
...
function eu(e) {
    let { channel: t, width: n } = e,
        ...
        p = (0, u.bG)([j.A], () => (0, N.A)(j.A)),
        h = (0, u.bG)([B.default], () => B.default.getId()),
        m = (0, u.bG)([F.A], () => F.A.getCurrentUserActiveStream()),
        g = null != a && "user" in a ? a.user.id : "",
        E = (0, C.A)(a?.type === ea.lp.STREAM ? c.x.STREAM : c.x.DEFAULT, g),
        T = (0, v.A)(g),
        y = (0, u.yK)([F.A], () => F.A.getAllActiveStreams());
    return (0, r.jsx)(el, {
        channel: t,
        streamId: o,
