...
function _(e) {
    let { channelId: t, messageId: n, hasError: r, hasContextMessage: i, numDestinations: c, numDestinationChanges: d, numQueryChanges: f, anyDestinationHasSlowmode: _, source: p } = e;
    if (
