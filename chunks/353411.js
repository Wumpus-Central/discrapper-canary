...
function I(t) {
    let { currentUserTrackId: e, syncingWithUser: l, syncingWithParty: u } = t,
        [n, d] = a.useState(!1),
    ...
    return a.useEffect(() => () => c.stop(), [c]), { loading: n, startLoading: C, clearLoading: E };
}
function S(t, e) {
    return (0, u.cf)([A.A, n.default], () => (0, _.A)(A.A, n.default, e, t), [t, e]);
}
function f(t, e, l) {
    let u = S(t, e),
...
function T(t, e, l, u) {
    let s = u ?? c.Ay.getName(e),
        i = S(t, e),
        { notPlayable: n, syncingWithUser: d, syncingWithParty: A, isCurrentUser: _ } = i,
...
function h(t, e, l) {
    let u = S(t, e),
        { notPlayable: s, syncingWithUser: i, syncingWithParty: n, isCurrentUser: d } = u,
