...
function Y(t) {
    let { currentUserTrackId: e, syncingWithUser: a, syncingWithParty: s } = t,
        [A, p] = l.useState(!1),
    ...
    return l.useEffect(() => () => n.stop(), [n]), { loading: A, startLoading: i, clearLoading: _ };
}
function f(t, e) {
    return (0, s.cf)([C.A, A.default], () => (0, o.A)(C.A, A.default, e, t), [t, e]);
}
function I(t, e, a) {
    let s = f(t, e),
...
function b(t, e, a, s) {
    let c = s ?? n.Ay.getName(e),
        u = f(t, e),
        { notPlayable: A, syncingWithUser: p, syncingWithParty: C, isCurrentUser: o } = u,
...
function T(t, e, a) {
    let s = f(t, e),
        { notPlayable: c, syncingWithUser: u, syncingWithParty: A, isCurrentUser: p } = s,
