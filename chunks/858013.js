n.d(t, { A: () => r }), n(393431), n(532706), n(42231), n(232424), n(949626), n(767709), n(65162), n(321073);
class a {
...
function r(e, t) {
    let n = new Uint8Array([
        ...
        i = new a();
    i.addPage({ pageType: 2, granulePosition: 0, segments: [n] });
    let o = 0;
    for (let t of (i.addPage({ pageType: 0, granulePosition: o, segments: [r] }), e)) {
        let e = (function (e) {
        ...
        (o += t.numSamples), i.addPage({ pageType: 0, granulePosition: o, segments: e });
    }
    return i.finalize(o);
}
let i = (function () {
