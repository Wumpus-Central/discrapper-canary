...
var s = n(827734),
    ...
    g = n(996988),
    m = n(341934);
let E = (0, r.FT)(r._3.SIZE_16);
function x(e) {
    let { user: t, guild: x, nick: y, onSelect: v } = e,
        { theme: S, themeType: C } = (0, f.E)(),
        I = t.hasAvatarForGuild(x.id);
    return (0, i.jsxs)(o.D, {
        ...
        children: [
            (0, i.jsx)(p.Ay, {
                ...
                guild: x,
                showBadge: !0,
                className: null != x.icon ? m.Kk : m.lN,
            ...
            (0, i.jsxs)("div", {
                className: m.zH,
                children: [
                    (0, i.jsx)("div", { className: m.UU, children: x.name }),
                    I &&
                        (0, i.jsxs)("div", {
                            className: m.C9,
                            children: [
                                (0, i.jsx)(c.eu, {
                                    src: t.getAvatarURL(x.id, E),
                                    size: r._3.SIZE_16,
                                    className: m.my,
                                    "aria-hidden": !0,
                                }),
                                (0, i.jsx)(u.E, {
                                    ...
                                    children: (0, i.jsx)(l.A, {
                                        delay: _.In,
                                        children: y ?? A.Ay.getName(x.id, void 0, t),
                                    }),
                                }),
                            ],
                        }),
