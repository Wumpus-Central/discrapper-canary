            ...
            switch (t) {
                ...
                case "bigint": {
                    ...
                    let t = e < B,
                        n = t ? -e : e;
                    if (n < en)
                        if ((this._expand(11), 1 === this._safeBigIntEncoding && n < X))
                            n < $ && !t
        ...
        this.telemetry.time(eN.TIME_TO_FIRE_IDLE_CALLBACK),
            this._scheduleRequestIdleCallback(
                (e) => {
                    ...
                    if ((this.telemetry.timeEnd(eN.TIME_TO_FIRE_IDLE_CALLBACK), (e?.timeRemaining() ?? eM) < eM))
                        this.telemetry.time(eN.TIME_TO_FIRE_IDLE_CALLBACK),
                            this._scheduleRequestIdleCallback(
                                (e) => {
...
class ez {
    ...
    flush = (e) => {
        ...
        return s > ew && !r && eH.log(`Dispatched ${i.length} messages in ${s}ms`), r;
    };
    getDispatchTimings() {
        return e$;
    }
    ...
    dispatchOne(e) {
        ...
        if ((eI.A.flush(r, i), "READY" === r)) {
            ...
            this.getDispatchHandler(r)?.dispatch(i, r, a),
                ...
                v.default.track(em.HAw.READY_PAYLOAD_RECEIVED, n, { logEventProperties: !0 });
        } else
            "RESUMED" === r
                ? (this.getDispatchHandler(r)?.dispatch(i, r, a),
...
class eJ extends eq.EventEmitter {
    ...
    voiceStateUpdate(e) {
        ...
        null != n && eX.A.shouldIncludePreferredRegion() && ((c.preferred_region = a), (c.preferred_regions = o)),
...
class ti extends eJ {
                ...
                onMessage:
                    ...
                    (n = (e, t) => {
                        ...
                        if (
                            ...
                            N.default.isLoggingGatewayEvents)
                        ) {
                            let e = [i];
        ...
        (0, O.isIOS)() &&
            ...
            3 === this.iosGoingAwayEventCount &&
                p.Bo.get({ url: em.Rsh.ME, headers: { authorization: this.token }, rejectWithError: !1 }).then(
                    (e) => {
                        let { status: t } = e;
                        v.default.track(em.HAw.IOS_INVALID_TOKEN_WORKAROUND_TRIGGERED, { api_status_code: t });
                    },
                    (e) => {
                        let { status: t } = e;
                        401 === t &&
    ...
    async _doIdentify() {
        ...
        (this.identifyUncompressedByteSize = d.length),
            ...
            v.default.track(em.HAw.SESSION_START_CLIENT, {});
    }
    ...
    resetSocketAndClearCacheOnError(e) {
        ...
        S.A.increment({ name: _.K.SOCKET_CRASHED, tags: [`action:${i ?? t}`, `modded_client:${r}`] }, !0),
            ...
            v.default.track(em.HAw.GATEWAY_SOCKET_RESET, {
    ...
    send = (e, t, n) => {
        N.default.isLoggingGatewayEvents && e3.verboseDangerously("~>", e, eQ[e], t);
