n.d(t, { Z: () => eo }), n(190126), n(368063), n(65234), n(111804), n(490233), n(97749), n(388685), n(539854), n(49124), n(358797);
var r = n(512722),
    i = n.n(r),
    o = n(457854),
    a = n(990547),
...
let Z = new b.Z('GatewaySocket'),
    H = new w.Z(),
    Y = (0, a.getSuperProperties)();
function W(e) {
    ...
    I.default.track(U.rMx.GATEWAY_CONNECT_SKIPPED, {
        ...
        setTimeout(() => {
            I.default.track(U.rMx.POST_GATEWAY_CONNECT_SKIPPED, {
                actually_skipped: null != t ? t : r,
                original_client_app_state: o,
                client_app_state: g.Z.getState(),
                skip_context: s,
...
function K(e) {
    ...
    if (((window._ws = null), null != l))
        if (((t = l.ws), l.state.gateway !== n)) Z.verbose('[FAST CONNECT] gatewayURL mismatch: '.concat(l.state.gateway, ' !== ').concat(n)), t.close(1000), (t = null);
        else {
            var _;
            let e = B({}, l.state);
            null != e.messages && (e.messages = e.messages.map((e) => (null != e.data && 'string' == typeof e.data ? V(B({}, e), { data: e.data.substring(0, 100) }) : e))), Z.log('[FAST CONNECT] successfully took over websocket, state:', V(B({}, e), { messages: null == (_ = e.messages) ? void 0 : _.length })), (c = l.state.open), (u = l.state.identify), (d = l.state.messages), (f = l.state.clientState);
        }
    null == t && ((t = (0, j.Z)(n)).binaryType = 'arraybuffer'), r(t), c && i(u, f), null != d && d.forEach(o), (t.onopen = () => i(u, f)), (t.onmessage = o), (t.onclose = s), (t.onerror = a);
}
function z() {}
let q = 4,
    Q = 1001,
    ...
    J = 4004,
    $ = 30 * T.Z.Millis.SECOND,
    ee = 3 * T.Z.Millis.MINUTE,
    et = +T.Z.Millis.MINUTE;
function en(e, t, n) {
    let r = 0;
    e.dataReady((e) => {
        try {
    ...
    return (n) => {
        let o = n.data;
        null != n.raw_length ? (r += n.raw_length) : (r += er(o));
        try {
            e.feed(o);
        } catch (e) {
...
class eo extends x.Z {
    get connectionState() {
        return this.connectionState_;
    }
    set connectionState(e) {
        Z.verbose('Setting connection state to '.concat(e)), (this.connectionState_ = e);
    }
    addAnalytics(e) {
        this.analytics = B({}, this.analytics, e);
    }
    setResumeUrl(e) {
        null != e && e.endsWith('/') && (e = e.substring(0, e.length - 1)), null !== e && Z.verbose('Updating resume url to '.concat(e)), (this.resumeUrl = e);
    }
    _connect(e) {
        if (!this.willReconnect()) return void Z.verbose('Skipping _connect because willReconnect is false');
        let t = k.a();
        if ((t || !M.RZ()) && (Z.info('Skipping _connect because socket is paused'), W({ reason: e }), t)) return;
        ...
        l.Z.mark('\uD83C\uDF10', 'Socket._connect'),
            Z.info('[CONNECT] '.concat(i, ', ') + 'encoding: '.concat(r, ', ') + 'version: '.concat(o, ', ') + 'compression: '.concat(null != n ? n : 'none')),
            null !== this.webSocket && (Z.error('_connect called with already existing websocket'), this._cleanup((e) => e.close(4000))),
        ...
        a.searchParams.append('encoding', r),
            ...
            K({
                ...
                onOpen: (e) => {
                    l.Z.mark('\uD83C\uDF10', 'GatewaySocket.onOpen '.concat(e));
                    let t = Date.now() - this.connectionStartTime;
                    Z.info('[CONNECTED] '.concat(a.toString(), ' in ').concat(t, ' ms')), (this.isFastConnect = e), e ? this._doFastConnectIdentify() : this._doResumeOrIdentify();
                },
                onMessage: en(this.compressionHandler, this._handleClose.bind(this), (e, t) => {
                    let n = Date.now(),
                        { op: r, s: i, t: o, d: a } = H.unpack(e);
                    if ((r !== x.j.DISPATCH && l.Z.mark('\uD83C\uDF10', 'GatewaySocket.onMessage '.concat(r, ' ').concat(x.j[r])), v.default.isLoggingGatewayEvents)) {
                        let e = [r];
                        r === x.j.DISPATCH && e.push(o), e.push(a), Z.verboseDangerously('<~', ...e);
                    }
                    let s = Date.now() - n;
                    switch (('READY' === o ? O.Z.parseReady.set(n, s) : 'READY_SUPPLEMENTAL' === o ? O.Z.parseReadySupplemental.set(n, s) : s > 10 && l.Z.mark('\uD83C\uDF10', 'Parse ' + o, s), null != i && (this.seq = i), r)) {
                        case x.j.HELLO:
    ...
    _handleHello(e) {
        ...
        Z.verbose('[HELLO] via '.concat((0, D.TO)(e), ', ') + 'heartbeat interval: '.concat(t, ', ') + 'took '.concat(n, ' ms')), this._startHeartbeater();
    }
    _handleReconnect() {
        Z.verbose('[RECONNECT] gateway requested I reconnect.'), this._cleanup((e) => e.close(4000)), (this.connectionState = C.Z.WILL_RECONNECT), this._connect('reconnect');
    }
    _handleInvalidSession(e) {
        Z.info('[INVALID_SESSION]'.concat(e ? ' can resume)' : '')), e ? this._doResumeOrIdentify() : this._doIdentify();
    }
    _handleDispatch(e, t, n) {
        ...
        if ('READY' === t) {
            ...
            this.sessionId = t;
            let n = (0, D.TO)(e);
            l.Z.setServerTrace(n), Z.info('[READY] took '.concat(r, 'ms, as ').concat(t)), Z.verbose(''.concat(n)), (this.connectionState = C.Z.SESSION_ESTABLISHED), this.gatewayBackoff.succeed(), (this.iosGoingAwayEventCount = 0), this.setResumeUrl(e.resume_gateway_url);
        } else 'READY_SUPPLEMENTAL' === t ? (Z.info('[READY_SUPPLEMENTAL] took '.concat(r, 'ms')), (this.connectionState = C.Z.SESSION_ESTABLISHED), this.gatewayBackoff.succeed(), (this.iosGoingAwayEventCount = 0)) : 'RESUMED' === t && (Z.verbose((0, D.TO)(e)), (this.connectionState = C.Z.SESSION_ESTABLISHED), this.gatewayBackoff.succeed(), (this.iosGoingAwayEventCount = 0));
        this.dispatcher.receiveDispatch(e, t, n);
    }
    handleResumeDispatched() {
        let e = Date.now() - this.connectionStartTime;
        Z.info('[RESUMED] took '.concat(e, 'ms, replayed ').concat(this.dispatcher.resumeAnalytics.numEvents, ' events, new seq: ').concat(this.seq));
    }
    ...
    _handleHeartbeatAck(e) {
        (this.lastHeartbeatAckTime = Date.now()), (this.heartbeatAck = !0), null !== this.expeditedHeartbeatTimeout && (clearTimeout(this.expeditedHeartbeatTimeout), (this.expeditedHeartbeatTimeout = null), Z.verbose('Expedited heartbeat succeeded'));
    }
    _handleHeartbeatTimeout() {
        ...
        Z.warn('[ACK TIMEOUT] reconnecting in '.concat((e / 1000).toFixed(2), ' seconds.'));
    }
    _handleClose(e, t, n) {
        if (
            ((e = e || !1),
            ...
            return (this.connectionState = C.Z.CLOSED), Z.warn('[WS CLOSED] because of authentication failure, marking as closed.'), this._reset(e, t, n);
        if ((this._tryDetectInvalidIOSToken(t, n, e), (this.connectionState = C.Z.WILL_RECONNECT), this.nextReconnectIsImmediate)) Z.info('[WS CLOSED] ('.concat(e.toString(), ', ').concat(t, ', ').concat(n, ') retrying immediately.')), this._connect('_handleCloseImmediateReconnect');
        else {
            ...
            3 === this.iosGoingAwayEventCount &&
                f.tn
                    ...
                    .then(
                        (e) => {
                            let { status: t } = e;
                            I.default.track(U.rMx.IOS_INVALID_TOKEN_WORKAROUND_TRIGGERED, { api_status_code: t });
                        },
                        (e) => {
                            let { status: t } = e;
                            401 === t && ((this.connectionState = C.Z.CLOSED), Z.warn('[WS CLOSED] because of manual authentication failure, marking as closed.'), this._reset(n, J, 'invalid token manually detected')), I.default.track(U.rMx.IOS_INVALID_TOKEN_WORKAROUND_TRIGGERED, { api_status_code: t });
                        }
                    ));
    }
    _reset(e, t, n) {
        (this.sessionId = null),
            (this.seq = 0),
            Z.warn('[RESET] ('.concat(e.toString(), ', ').concat(t, ', ').concat(n, ')')),
    ...
    _cleanup(e) {
        d.ZP.Emitter.resume(), this._stopHeartbeater(), this._clearHelloTimeout();
        let t = this.webSocket;
        (this.webSocket = null), null != t && ((t.onopen = z), (t.onmessage = z), (t.onerror = z), (t.onclose = z), null == e || e(t)), this.gatewayBackoff.cancel(), this.compressionHandler.close(), (this.compressionHandler = (0, R.I)(H));
    }
    _doResume() {
        var e;
        (this.connectionState = C.Z.RESUMING),
            (this.dispatcher.resumeAnalytics = (0, D.zH)(Date.now() - this.connectionStartTime)),
            Z.info('[RESUME] resuming session '.concat(null != (e = this.sessionId) ? e : '', ', seq: ').concat(this.seq)),
            this.send(
                x.j.RESUME,
                {
                    token: this.token,
    ...
    async _doIdentify() {
        ...
        let [n, r, i] = await Promise.all([(0, E.O)() ? p.Z.getCommittedVersions() : {}, (0, E.O)() ? m.Z.getCommittedVersions() : {}, !!(0, E.O)() && h.Z.canUseGuildVersions()]),
            a = i
                ? {
                      guild_versions: n,
                ...
                : { guild_versions: {} };
        if (this.connectionState !== C.Z.IDENTIFYING || this.identifyStartTime !== t) return void Z.warn('Skipping identify because connectionState or identifyStartTime has changed');
        let { token: s, properties: l = {}, presence: c } = e;
        (this.token = s), Z.verbose('[IDENTIFY]');
        let u = {
                token: s,
                capabilities: (0, P.t)(),
                properties: l,
            ...
            d = JSON.stringify(u);
        (this.identifyUncompressedByteSize = d.length), (this.identifyCompressedByteSize = o.deflate(d).length), (this.identifyCount += 1), this.send(x.j.IDENTIFY, u, !1), I.default.track(U.rMx.SESSION_START_CLIENT, {});
    }
    _doFastConnectIdentify() {
        ...
        if (null === e) return void this._handleClose(!0, J, 'No connection info provided');
        let { token: t } = e;
        (this.token = t), (this.connectionState = C.Z.IDENTIFYING), (this.identifyStartTime = Date.now()), (this.identifyCount += 1), Z.verbose('[IDENTIFY, fast-connect]'), this._updateLastHeartbeatAckTime();
    }
    _doResumeOrIdentify() {
        let e = Date.now();
    ...
    connect() {
        return this.isClosed() ? (Z.verbose('.connect() called, new state is WILL_RECONNECT'), (this.connectionState = C.Z.WILL_RECONNECT), this._connect('connect'), !0) : (Z.error('Cannot start a new connection, connection state is not closed'), !1);
    }
    resetSocketOnError(e) {
        let { action: t, error: n, metricAction: r } = e;
        Z.error('resetSocketOnError during '.concat(t, ': ').concat(n.message), n.stack);
        let i = (0, u.e)();
        y.Z.increment(
            {
            ...
            !1 !== e.sentry && N.Z.captureException(n, { tags: { socketCrashedAction: t } }),
            I.default.track(U.rMx.GATEWAY_SOCKET_RESET, {
        ...
        0 === this.dispatchExceptionBackoff._fails ? (Z.verbose('Triggering fast reconnect'), this.dispatchExceptionBackoff.fail(() => {}), setTimeout(() => this._connect('resetSocketOnErrorImmediate'), 0)) : this.dispatchExceptionBackoff.fail(() => this._connect('resetSocketOnError')),
            o &&
    ...
    close() {
        ...
        if (this.isClosed()) return void Z.verbose('close() called, but socket is already closed.');
        Z.info('Closing connection, current state is '.concat(this.connectionState));
        let t = e ? 4000 : void 0;
    ...
    expeditedHeartbeat(e) {
        ...
        if (!this.isClosed()) {
            if (this.isConnected()) {
                Z.verbose('Performing an expedited heartbeat '.concat(null != t && '' !== t ? 'reason: ' + t : '')),
                    (this.heartbeatAck = !1),
                    this._sendHeartbeat(),
            ...
            n ? this.resetBackoff(t, r) : Z.verbose('Expedited heartbeat requested, but, connection state is '.concat(this.connectionState, ' and reconnectImmediately was not requested ').concat(null != t && '' !== t ? 'reason: ' + t : ''));
        }
    }
    resetBackoff() {
        let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : '',
            t = !(arguments.length > 1) || void 0 === arguments[1] || arguments[1];
        Z.verbose('Connection has reset backoff'.concat(null != e && '' !== e ? ' for reason: ' + e : '')), this.gatewayBackoff.succeed(), (this.iosGoingAwayEventCount = 0), (this.nextReconnectIsImmediate = !0), this.willReconnect() ? this._connect(e) : t && this.connectionState !== C.Z.SESSION_ESTABLISHED && this._handleClose(!0, 0, e);
    }
    constructor() {
        super(),
            G(this, 'gatewayBackoff', void 0),
            G(this, 'handleIdentify', void 0),
            G(this, 'dispatchExceptionBackoff', new s.Z(1000, et)),
            ...
            G(this, 'send', (e, t, n) => {
                v.default.isLoggingGatewayEvents && Z.verboseDangerously('~>', e, t);
                let r = H.pack({
                    op: e,
                    d: t
                });
                ...
                else Z.warn('Attempted to send while not being in a connected state opcode: '.concat(e));
            }),
