...
function W(e) {
    ...
    if (((window._ws = null), null != l))
        if (((t = l.ws), l.state.gateway !== n)) (V.verbose('[FAST CONNECT] gatewayURL mismatch: '.concat(l.state.gateway, ' !== ').concat(n)), t.close(1000), (t = null));
            ...
            var _;
            let e = B({}, l.state);
            (null != e.messages && (e.messages = e.messages.map((e) => (null != e.data && 'string' == typeof e.data ? F(B({}, e), { data: e.data.substring(0, 100) }) : e))), V.log('[FAST CONNECT] successfully took over websocket, state:', F(B({}, e), { messages: null == (_ = e.messages) ? void 0 : _.length })), (c = l.state.open), (u = l.state.identify), (d = l.state.messages), (f = l.state.clientState));
        }
...
function et(e, t, n) {
    ...
    return (n) => {
        let o = n.data;
        null != n.raw_length ? (r += n.raw_length) : (r += en(o));
        try {
            e.feed(o);
        } catch (e) {
...
class ei extends x.Z {
    ...
    _connect(e) {
        ...
        (s.searchParams.append('encoding', r),
            s.searchParams.append('v', o.toString()),
            ...
            W({
                ...
                onOpen: (e) => {
                    a.Z.mark('\uD83C\uDF10', 'GatewaySocket.onOpen '.concat(e));
                ...
                onMessage: et(this.compressionHandler, this._handleClose.bind(this), (e, t) => {
                    let n = Date.now(),
                        { op: r, s: i, t: o, d: s } = H.unpack(e);
                    if ((r !== x.j.DISPATCH && a.Z.mark('\uD83C\uDF10', 'GatewaySocket.onMessage '.concat(r, ' ').concat(x.j[r])), O.default.isLoggingGatewayEvents)) {
                        let e = [r];
                        (r === x.j.DISPATCH && e.push(o), e.push(s), V.verboseDangerously('<~', ...e));
                    }
                    let l = Date.now() - n;
                    switch (('READY' === o ? y.Z.parseReady.set(n, l) : 'READY_SUPPLEMENTAL' === o ? y.Z.parseReadySupplemental.set(n, l) : l > 10 && a.Z.mark('\uD83C\uDF10', 'Parse ' + o, l), null != i && (this.seq = i), r)) {
                        case x.j.HELLO:
    ...
    _handleDispatch(e, t, n) {
        ...
        if ('READY' === t) {
            ...
            this.sessionId = t;
            let n = (0, D.TO)(e);
            (a.Z.setServerTrace(n), V.info('[READY] took '.concat(r, 'ms, as ').concat(t)), V.verbose(''.concat(n)), (this.connectionState = N.Z.SESSION_ESTABLISHED), this.gatewayBackoff.succeed(), (this.iosGoingAwayEventCount = 0), this.setResumeUrl(e.resume_gateway_url));
        } else 'READY_SUPPLEMENTAL' === t ? (V.info('[READY_SUPPLEMENTAL] took '.concat(r, 'ms')), (this.connectionState = N.Z.SESSION_ESTABLISHED), this.gatewayBackoff.succeed(), (this.iosGoingAwayEventCount = 0)) : 'RESUMED' === t && (V.verbose((0, D.TO)(e)), (this.connectionState = N.Z.SESSION_ESTABLISHED), this.gatewayBackoff.succeed(), (this.iosGoingAwayEventCount = 0));
            ...
            3 === this.iosGoingAwayEventCount &&
                d.tn
                    ...
                    .then(
                        ...
                        (e) => {
                            let { status: t } = e;
                            (401 === t && ((this.connectionState = N.Z.CLOSED), V.warn('[WS CLOSED] because of manual authentication failure, marking as closed.'), this._reset(n, Q, 'invalid token manually detected')), v.default.track(U.rMx.IOS_INVALID_TOKEN_WORKAROUND_TRIGGERED, { api_status_code: t }));
                        }
                    ));
    }
    _reset(e, t, n) {
    ...
    async _doIdentify() {
        ...
        let u = {
            ...
            d = JSON.stringify(u);
        ((this.identifyUncompressedByteSize = d.length), (this.identifyCompressedByteSize = o.deflate(d).length), (this.identifyCount += 1), this.send(x.j.IDENTIFY, u, !1), v.default.track(U.rMx.SESSION_START_CLIENT, {}));
    }
