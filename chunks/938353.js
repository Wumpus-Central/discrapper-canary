    ...
    return (0, i.jsxs)('div', {
        ...
        children: [
            ...
            (0, i.jsx)(p.Text, {
                ...
                color: 'text-muted',
                children: eq.intl.format(eq.t['G/H+s7'], { onClick: () => (0, $.z)() })
            })
        ]
    });
}
let e2 = 15 * eb.Z.Millis.MINUTE,
    ...
    e8 = (e) => () => {
        let { url: t, proxyUrl: n, width: r, height: l, flags: a } = e,
            o = (0, ex.yE)(a, W.hR.IS_ANIMATED);
        return null != r && null != l && (K.uo.test(n) || (o && (K.YG.test(n) || K.FH.test(n))))
            ? (0, i.jsx)(eR.Z, {
                  width: r,
                  height: l,
                  src: n,
...
class e6 extends (r = l.Component) {
    ...
    renderSocialProofingFileSizeNitroUpsell(e) {
        ...
        return (0, eI.M)('attachment') && t ? (0, i.jsx)(e3, {}) : null;
    }
    renderCodedLinks(e) {
        return 0 === e.codedLinks.length
            ...
            : e.codedLinks.map((t) => {
                  ...
                  if (n === O.g.EVENT) return (0, i.jsx)(D.Z, { code: r }, r);
                  ...
                  else if (n === O.g.QUESTS_EMBED) return (0, i.jsx)(et.Z, { questId: r }, r);
                  ...
                  } else if (n === O.g.APP_OAUTH2_LINK) return (0, i.jsx)(y.Z, { applicationId: r }, r);
    ...
    renderAttachments(e) {
        ...
        let d = c.filter((e) => null == e.flags || !(0, ex.yE)(e.flags, eY.J0y.IS_THUMBNAIL));
        if (0 === d.length) return null;
        let p = d
                .map((t) => {
                    var n;
                    return e1(e0({}, (0, W.JD)(t, e)), {
                        original: t.url,
                        srcIsAnimated: (0, ex.yE)(null != (n = t.flags) ? n : 0, eY.J0y.IS_ANIMATED)
                    });
                })
                .filter((e) => 'INVALID' !== e.type),
            { srcToOnClickOverride: m, srcToHandlePreloadImage: f } = (0, q.G)(
                p,
                {
            ...
            g = p.length > 1,
            h = (0, ex.yE)(u, eY.iLy.IS_VOICE_MESSAGE);
        function _(e, t) {
        ...
        let b = d.map((i) => {
            let o = (0, W.VY)(i),
                s = {
                    ...
                    onPlay: (e, n, r) => {
                        e_.default.track(eY.rMx.MEDIA_ATTACHMENT_PLAYBACK_STARTED, {
                            guild_id: t.guild_id,
                            channel_id: t.id,
                            channel_type: t.type,
                            type: i.content_type,
    ...
    renderEmbeds(e) {
        ...
        return 0 !== e.embeds.length && t
            ? e.embeds.map((t, n) => {
                  if (eK.b.has(t.type) || (0, eE.l3)(t) || ((0, F.b)(t) && !(0, B.M)(e)) || (0, eE.jz)(t)) return null;
                  let r = {
    ...
    renderThreadRoleMentionWarning(e) {
        if (e.hasFlag(eY.iLy.FAILED_TO_MENTION_SOME_ROLES_IN_THREAD) && this.props.isCurrentUser && !(Date.now() - ey.default.extractTimestamp(e.id) >= e2))
            return (0, i.jsx)('div', {
    ...
    renderSafetyPolicyNotice(e) {
        return 1 === e.embeds.length && e.embeds[0].type === eY.hBH.SAFETY_POLICY_NOTICE ? (0, i.jsx)(ei.i, { message: e }) : null;
    }
    renderSafetySystemNotification(e) {
        return 1 === e.embeds.length && e.embeds[0].type === eY.hBH.SAFETY_SYSTEM_NOTIFICATION ? (0, i.jsx)(el.g, { embed: e.embeds[0] }) : null;
    }
    ...
    render() {
        ...
        return null == u && null == m && null == h && null == _ && null == b && null == d && null == p && null == E && null == x && null == y && null == v && null == C && null == j && null == O && null == S && null == T && null != I && null == w && null == P && null == Z && null == R
            ? null
            : (0, i.jsxs)('div', {
                  id: (0, eD.bX)(t),
                  className: o()(e, eQ.container),
                  children: [R, Z, O, w, u, d, p, S, m, f, h, A, _, y, C, j, I, g, c, b, E, x, a && this.renderSuppressConfirmModal(), s && this.renderRemoveAttachmentConfirmModal(), v, T, N, P]
              });
    }
    constructor(...e) {
        (super(...e),
            ...
            e$(this, 'renderEmbed', (e, t, n, r) => {
                let { gifAutoPlay: l, inlineEmbedMedia: a, canSuppressEmbeds: o, hasSpoilerEmbeds: s, enabledContentHarmTypeFlags: c, isSearchResult: u, shouldAgeVerify: d } = this.props,
                    ...
                    m = r.id,
                    f = (0, eO.BP)(e, p, m, s, c);
                return e.type === eY.hBH.GIFT
                    ? null
                    : (0, i.jsx)(
                          w.h.Provider,
                          {
                              value: (0, eW.P)(e.url, e.image, e.video),
                              children: (0, i.jsx)(
                                  C.ZP,
                                  e0(
                                      {
            ...
            e$(this, 'renderEmbedTitle', (e, t) => (e.type === eY.hBH.RICH ? z.Z.parseEmbedTitle(t, !0, { channelId: this.props.channel.id }) : t)),
...
function e4(e) {
    ...
    let { channel: n, message: r, renderSuppressEmbeds: l, isMessageSnapshot: a } = e,
        ...
        g = (0, c.e7)([H.Z], () => null != n.guild_id && H.Z.isLurking(n.guild_id), [n]),
        h = (0, c.e7)([ep.ZP], () => ep.ZP.isCurrentUserGuest(n.guild_id), [n]),
        _ = (0, c.e7)([ep.ZP, eg.default], () => {
            var e, t;
        ...
        [, y] = (0, k.AB)(n.guild_id),
        v = (0, es.$R)(n),
        C = (o === r.author.id || E) && r.author.id !== eY.LAt && !1 !== l && !(0, ex.yE)(r.flags, eY.iLy.EPHEMERAL) && v && 1 === (0, eT.Z)(r),
        O = o === r.author.id && v && !a,
        j = r.author.id === o,
...
let e7 = (e) => {
    ...
    let p = eu.x4.useSetting(),
        ...
        f = eu.NA.useSetting(),
        g = eu.QK.useSetting(),
        h = (0, V.A)((null != (t = n.editedTimestamp) ? t : n.timestamp).valueOf()),
        _ = (0, Y.Z)(null == r ? void 0 : r.id),
        b = (0, T.v)(n),
