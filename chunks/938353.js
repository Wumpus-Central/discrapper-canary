    ...
    return (0, i.jsxs)('div', {
        ...
        children: [
            ...
            (0, i.jsx)(p.Text, {
                ...
                color: 'text-muted',
                children: ez.intl.format(ez.t['G/H+s7'], { onClick: () => (0, Q.z)() })
            })
        ]
    });
}
...
class e3 extends (r = l.Component) {
    ...
    renderAttachments(e) {
        ...
        let d = c.filter((e) => null == e.flags || !(0, eg.yE)(e.flags, eH.J0y.IS_THUMBNAIL));
        if (0 === d.length) return null;
        let p = d
                .map((t) => {
                    var n;
                    return eq(eX({}, (0, V.JD)(t, e)), {
                        original: t.url,
                        srcIsAnimated: (0, eg.yE)(null != (n = t.flags) ? n : 0, eH.J0y.IS_ANIMATED)
                    });
                })
            ...
            h = p.length > 1,
            g = (0, eg.yE)(u, eH.iLy.IS_VOICE_MESSAGE);
        function _(e, t) {
        ...
        let b = d.map((i) => {
            let o = (0, V.VY)(i),
                s = {
                    ...
                    onPlay: (e, n, r) => {
                        em.default.track(eH.rMx.MEDIA_ATTACHMENT_PLAYBACK_STARTED, {
                            guild_id: t.guild_id,
                            channel_id: t.id,
                            channel_type: t.type,
                            type: i.content_type,
    ...
    renderEmbeds(e) {
        ...
        return 0 !== e.embeds.length && t
            ? e.embeds.map((t, n) => {
                  if (eG.b.has(t.type) || (0, eh.l3)(t) || ((0, M.b)(t) && !(0, U.M)(e)) || (0, eh.jz)(t)) return null;
                  let r = {
    ...
    renderThreadRoleMentionWarning(e) {
        if (e.hasFlag(eH.iLy.FAILED_TO_MENTION_SOME_ROLES_IN_THREAD) && this.props.isCurrentUser && !(Date.now() - e_.default.extractTimestamp(e.id) >= eJ))
            return (0, i.jsx)('div', {
    ...
    renderSafetyPolicyNotice(e) {
        return 1 === e.embeds.length && e.embeds[0].type === eH.hBH.SAFETY_POLICY_NOTICE ? (0, i.jsx)(ee.i, { message: e }) : null;
    }
    renderSafetySystemNotification(e) {
        return 1 === e.embeds.length && e.embeds[0].type === eH.hBH.SAFETY_SYSTEM_NOTIFICATION ? (0, i.jsx)(et.g, { embed: e.embeds[0] }) : null;
    }
    ...
    renderEditedTag(e, t) {
        return (0, i.jsx)(eB.Z, {
            message: e,
            compact: t,
            location: eB.H.AFTER_ACCESSORIES
        });
    }
    render() {
        ...
        return null == u && null == m && null == g && null == _ && null == b && null == d && null == p && null == E && null == y && null == x && null == v && null == O && null == C && null == j && null == I && null == N && null != S && null == w && null == P && null == Z
            ? null
            : (0, i.jsxs)('div', {
                  id: (0, eZ.bX)(t),
                  className: o()(e, eW.container),
                  children: [Z, j, w, u, d, p, I, m, f, g, A, _, x, O, C, S, h, c, b, E, y, a && this.renderSuppressConfirmModal(), s && this.renderRemoveAttachmentConfirmModal(), v, N, T, P]
              });
    }
    constructor(...e) {
        super(...e),
            ...
            eY(this, 'renderEmbedTitle', (e, t) => (e.type === eH.hBH.RICH ? H.Z.parseEmbedTitle(t, !0, { channelId: this.props.channel.id }) : t)),
            eY(this, 'renderEmbedDescription', (e, t, n) =>
                e.type === eH.hBH.RICH
                    ? H.Z.parse(t, !0, {
                          channelId: this.props.channel.id,
                          allowLinks: !0,
            ...
            eY(this, 'handleEmbedSuppressed', (e) => {
                let { channel: t, message: n } = this.props;
...
function e5(e) {
    ...
    let { channel: n, message: r, renderSuppressEmbeds: l, isMessageSnapshot: a } = e,
        ...
        { canAddNewReactions: b, canManageMessages: E } = (0, c.cj)(
            [eu.Z],
            () => ({
                canAddNewReactions: f && eu.Z.can(eH.Plq.ADD_REACTIONS, n),
                canManageMessages: eu.Z.can(eH.Plq.MANAGE_MESSAGES, n)
            }),
            [f, n]
        ),
        y = (0, w.ux)(n.guild_id),
        [, x] = (0, Z.AB)(n.guild_id),
        v = (0, ei.$R)(n),
        O = (o === r.author.id || E) && r.author.id !== eH.LAt && !1 !== l && !(0, eg.yE)(r.flags, eH.iLy.EPHEMERAL) && v && 1 === (0, ej.Z)(r),
        j = o === r.author.id && v && !a,
        C = r.author.id === o,
