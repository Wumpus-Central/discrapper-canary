...
let eQ = 15 * ef.Z.Millis.MINUTE,
    ...
    e0 = (e) => () => {
        ...
        return null != r && null != l && (V.uo.test(n) || (a && (V.YG.test(n) || V.FH.test(n))))
            ? (0, i.jsx)(eP.Z, {
                  width: r,
                  height: l,
                  src: n,
...
class e1 extends (r = l.Component) {
    ...
    renderCodedLinks(e) {
        return 0 === e.codedLinks.length
            ...
            : e.codedLinks.map((t) => {
                  ...
                  if (n === N.g.EVENT) return (0, i.jsx)(k.Z, { code: r }, r);
                  ...
                  } else if (n === N.g.GUILD_PRODUCT) return (0, i.jsx)(R.Z, { code: r }, r);
    ...
    render() {
        ...
        return null == s && null == d && null == f && null == h && null == g && null == c && null == u && null == _ && null == b && null == x && null == y && null == E && null == N && null == v && null == j && null == C && null != O && null == P && null == I && null == A
            ? null
            : (0, i.jsxs)('div', {
                  id: (0, eZ.bX)(t),
                  className: o()(e, eV.container),
                  children: [A, v, P, s, c, u, j, d, p, f, T, h, x, E, N, O, m, g, _, b, l && this.renderSuppressConfirmModal(), a && this.renderRemoveAttachmentConfirmModal(), y, C, S, I]
              });
    }
    constructor(...e) {
        super(...e),
...
function e3(e) {
    ...
    let { channel: n, message: r, renderSuppressEmbeds: l, isMessageSnapshot: a } = e,
        ...
        s = ea.x4.useSetting(),
        u = ea.RS.useSetting(),
        d = ea.NA.useSetting() && !(0, ej.Z)(e.message),
        ...
        [, E] = (0, Z.AB)(n.guild_id),
        v = (0, ei.$R)(n),
        N = (o === r.author.id || x) && r.author.id !== eB.LAt && !1 !== l && !(0, eg.yE)(r.flags, eB.iLy.EPHEMERAL) && v && 1 === (0, eO.Z)(r),
        O = o === r.author.id && v && !a,
        j = r.author.id === o,
