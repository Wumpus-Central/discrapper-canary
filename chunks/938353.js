...
class e8 extends (r = l.Component) {
        ...
        return 0 === e.codedLinks.length
            ...
            : e.codedLinks.map((t) => {
                  ...
                  if (n === O.g.APP_DIRECTORY_PROFILE)
                      ...
                      let { referrerId: t = e.author.id, customId: n, linkId: a } = (0, E.U)(l);
                      return (0, i.jsx)(
                          g.Z,
                          {
                              applicationId: r,
    ...
    renderAttachments(e) {
        ...
        let d = c.filter((e) => null == e.flags || !(0, ex.yE)(e.flags, eW.J0y.IS_THUMBNAIL));
        ...
        let p = d
                .map((t) => {
                    ...
                    return e$(eJ({}, (0, z.JD)(t, e)), {
                        original: t.url,
                        srcIsAnimated: (0, ex.yE)(null != (n = t.flags) ? n : 0, eW.J0y.IS_ANIMATED)
                    });
                })
            ...
            h = p.length > 1,
            g = (0, ex.yE)(u, eW.iLy.IS_VOICE_MESSAGE);
        function _(e, t) {
    ...
    renderThreadRoleMentionWarning(e) {
        if (e.hasFlag(eW.iLy.FAILED_TO_MENTION_SOME_ROLES_IN_THREAD) && this.props.isCurrentUser && !(Date.now() - eE.default.extractTimestamp(e.id) >= e1))
            return (0, i.jsx)('div', {
    ...
    renderMediaObscureNotice(e) {
        return (0 !== e.attachments.length || 0 !== e.embeds.length) && (0, S.kC)(e) ? (0, i.jsx)(T.Z, { message: e }) : null;
    }
    renderPoll(e, t) {
        if (null != t)
            return (0, i.jsx)(Q.Z, {
    ...
    render() {
        ...
        return null == u && null == m && null == g && null == _ && null == b && null == d && null == p && null == x && null == E && null == y && null == v && null == C && null == j && null == O && null == I && null == T && null != S && null == w && null == P && null == Z && null == R
            ? null
            : (0, i.jsxs)('div', {
                  id: (0, eL.bX)(t),
                  className: o()(e, eq.container),
                  children: [R, Z, O, w, u, d, p, I, m, f, g, A, _, y, C, j, S, h, c, b, x, E, a && this.renderSuppressConfirmModal(), s && this.renderRemoveAttachmentConfirmModal(), v, T, N, P]
              });
    }
    constructor(...e) {
        super(...e),
...
function e6(e) {
    ...
    let { channel: n, message: r, renderSuppressEmbeds: l, isMessageSnapshot: a } = e,
        ...
        [, y] = (0, R.AB)(n.guild_id),
        v = (0, eo.$R)(n),
        C = (o === r.author.id || x) && r.author.id !== eW.LAt && !1 !== l && !(0, ex.yE)(r.flags, eW.iLy.EPHEMERAL) && v && 1 === (0, eI.Z)(r),
        O = o === r.author.id && v && !a,
        j = r.author.id === o,
        ...
        e$(
            eJ(
                e$(
                    ...
                    { disableReactionReads: !!S || T.disableReactionReads }
                ),
                e
            ),
            {
