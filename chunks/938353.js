...
class e5 extends (r = a.Component) {
    ...
    render() {
        ...
        return null == s && null == d && null == f && null == h && null == g && null == c && null == u && null == _ && null == b && null == x && null == y && null == v && null == O && null == E && null == j && null == C && null != N && null == P && null == S && null == A
            ? null
            : (0, i.jsxs)('div', {
                  id: (0, eD.bX)(t),
                  className: o()(e, eX.container),
                  children: [A, E, P, s, c, u, j, d, p, f, T, h, x, v, O, N, m, g, _, b, a && this.renderSuppressConfirmModal(), l && this.renderRemoveAttachmentConfirmModal(), y, C, I, S]
              });
    }
    constructor(...e) {
        super(...e),
...
function e6(e) {
    ...
    let { channel: n, message: r, renderSuppressEmbeds: a, isMessageSnapshot: l } = e,
        ...
        [, v] = (0, D.AB)(n.guild_id),
        E = (0, eo.$R)(n),
        O = (o === r.author.id || x) && r.author.id !== eV.LAt && !1 !== a && !(0, ex.yE)(r.flags, eV.iLy.EPHEMERAL) && E && 1 === (0, eI.Z)(r),
        N = o === r.author.id && E && !l,
        j = r.author.id === o,
