...
function L(e) {
    let { guildId: t, storedSearchQuery: n } = e,
        ...
        [s, c] = i.useState(!1),
        u = i.useCallback(() => {
            O.Z.setSection(I.pNK.SAFETY), (0, E.K)(N.u.DM_AND_SPAM_PROTECTION);
        }, []),
        g = i.useCallback((e) => {
...
function k() {
    var e, t;
    let { guild: c, searchQuery: u } = (0, s.e7)([y.Z], () => y.Z.getProps(), [], l.isEqual),
    ...
    let B = i.useCallback(
        ...
        H = i.useCallback(
            (e) => {
                var t, n, r;
                null == (t = E.current) || t.scrollToSectionTop(0),
