        ...
        f = i.useCallback(async () => {
            ...
            if (!a)
                try {
                    ...
                    let [e, n] = (0, p.C)(l),
                        r = e[0];
                    x.Z.setSearchQuery(l), await u.Z.searchGuildBans(t, r, n), c(!1);
                } catch (e) {
                    c(!1);
                }
        }, [t, a, l]),
        ...
        children: [
            ...
            (0, r.jsx)("div", {
                ...
                children: (0, r.jsx)(o.Text, {
                    ...
                    children: O.intl.format(O.t.JcZ36i, { onModerationClick: d }),
                }),
            }),
            (0, r.jsxs)("div", {
...
function P() {
    var e, t;
    let { guild: c, searchQuery: m } = (0, a.e7)([b.Z], () => b.Z.getProps(), [], l.isEqual),
        x = null != m && m.trim().length > 0,
        j = (0, d.Z)(x),
        _ = x !== j,
        [y] = (0, a.e7)([b.Z], () => b.Z.getBans(), [], h.Q),
    ...
    let B = i.useCallback(
            (e) => {
                u.Z.fetchGuildBansBatch(w, 1000, e);
            },
            [w],
        ),
        F = i.useMemo(() => s().chunk(A, M.pageSize), [M.pageSize, A]),
        H = i.useCallback(
            (e) => {
                var t, n, r;
