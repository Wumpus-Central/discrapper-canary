...
function N(e) {
    ...
    return (0, n.jsxs)("div", {
        className: m.aT,
        children: [
            (0, n.jsx)(p.A, { channel: e, avatarSize: o._3J.SIZE_16, iconClassName: m.er, iconSize: "xs" }),
            (0, n.jsx)(o.Text, { variant: "text-sm/semibold", color: "text-strong", className: m.HA, children: t }),
        ],
    });
}
function b(e) {
    ...
    return (0, n.jsx)(i.m_, {
        ...
        children: (0, n.jsx)(o.DUT, {
            ...
            children: (0, n.jsx)(o.ucK, { size: "sm", color: "currentColor", className: m.f }),
        }),
    });
}
function F(e) {
...
function O(e) {
    ...
    return (0, n.jsxs)(F, {
        ...
        showDivider: s > 0,
        children: [
            (0, n.jsx)(v, { headerId: o, titleText: o, trailingIcon: u }),
            i.map((e) => {
            ...
            if (o)
                switch (e.type) {
                    ...
                    case R.LWr.ANSWER_USERNAME_MENTIONS:
                        return (0, n.jsx)(w, { token: e, avatarSize: r }, u);
                    case R.LWr.ANSWER_IN:
                        return (0, n.jsx)(j, { token: e, avatarSize: r, iconSize: s }, u);
                    default:
                        return (0, n.jsx)(H, { text: a, className: m.Mj }, u);
                }
            return (0, n.jsx)(H, { text: a, className: i ? m._y : m.Lc }, u);
        });
...
function j(e) {
    let { token: t, avatarSize: r, iconSize: s } = e,
        ...
        h = (0, a.bG)([u.A], () => u.A.getChannel(c[0]));
    ...
    return (0, n.jsxs)("div", {
        ...
        children: [
            ...
            (0, n.jsx)(o.Text, { variant: "text-sm/semibold", color: "text-strong", children: d }),
        ],
    });
}
function D(e) {
    ...
    switch (r) {
        case R.x2k.HISTORY:
            return (0, n.jsx)(o.$p$, { size: "sm", color: "currentColor", className: m.Fx });
        case R.LWr.FILTER_IN:
            return (0, n.jsx)(o.N$i, { size: "sm", color: "currentColor", className: m.Fx });
        case R.LWr.FILTER_FROM:
            return (0, n.jsx)(o.nys, { size: "sm", color: "currentColor", className: m.Fx });
        case R.LWr.FILTER_MENTIONS:
            return (0, n.jsx)(o.XxR, { size: "sm", color: "currentColor", className: m.Fx });
    ...
    return null != t
        ...
        : null != r
          ? {
                label: (0, n.jsxs)("div", {
                    className: m.YL,
                    children: [(0, n.jsx)(W, { size: o._3J.SIZE_16, user: r }), (0, n.jsx)(k, { user: r })],
                }),
...
function q(e) {
    let { result: t, group: r } = e,
        { channel: s, user: l } = t;
    return null != s
        ? (0, n.jsx)(p.A, { channel: s, avatarSize: o._3J.SIZE_20, iconClassName: m.Fx, iconSize: "refresh_sm" })
        : null != l
          ? (0, n.jsx)(W, { size: o._3J.SIZE_20, user: l, className: m.Fx })
          : r === R.LWr.FILTER_HAS
