...
function eJ(e) {
    ...
    let S = null != v || I.length > 0,
        ...
        T = O || o || E,
        P = null != v,
        { Component: j, events: x, play: A } = (0, p.P)(P ? 'disable' : 'enable');
    i.useEffect(() => () => A(), [A, P]);
    let w = (0, r.jsx)(j, {
        size: 'md',
        color: 'currentColor',
                        ...
                        eF(
                            eH(
                                eF(eH({}, e), {
                                    ...
                                    onClick: (r) => {
                                        var i;
                                        ((0, R.v)(d, R.d.STREAM, null == v), S ? n(r) : t(), null == (i = e.onClick) || i.call(e));
                                    },
                                    disabled: !b || s,
                                    className: a()(eG.button, eG.buttonColor, {
    ...
    constructor(...e) {
        (super(...e),
            ...
            eV(this, 'handleChannelLinkClick', (e) => {
                ...
                (s()(null != r, 'Channel is null during navigation click'), e.stopPropagation(), O.Z.channelListScrollTo(null != (t = null == n ? void 0 : n.id) ? t : eR.ME, r.id), (0, R.v)(A.Z.RTC_PANEL, R.d.CHANNEL_LINK));
            }),
...
let e1 = (0, y.Z)(function (e) {
    let t = (0, V.Z)(),
        ...
        p = (0, u.e7)([eO.Z], () => eO.Z.getGuild(d), [d]),
        h = (0, u.cj)([ey.Z], () => ({
        ...
        f = (0, u.e7)([ey.Z, Y.Z], () => Y.Z.hasHotspot(eM.v.VOICE_PANEL_INTRODUCTION) && (0, ex.EO)(l) && !ey.Z.isInteractionRequired() && !(null == c ? void 0 : c.isGuildStageVoice())),
        ...
        v = ea.Fg.useSetting(),
        [I, C, N] = (0, u.Wu)([eT.ZP, $.Z], () => ((null == c ? void 0 : c.isGuildStageVoice()) ? [$.Z.getMutableParticipants(c.id, ee.pV.SPEAKER), $.Z.getParticipantsVersion(c.id), null] : [null, null, null != c ? eT.ZP.getVoiceStatesForChannel(c) : null]), [c]),
        T = i.useMemo(() => {
            var e, t;
            return null !=
                (t =
    ...
    let { analyticsLocations: L } = (0, Z.ZP)(A.Z.RTC_PANEL),
