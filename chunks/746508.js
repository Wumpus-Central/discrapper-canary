...
function eX(e) {
    let t,
        ...
        C = b.find((e) => e.ownerId === (null == h ? void 0 : h.id)),
        S = (0, ec.E)(n, h, b);
    t = null == C ? (l ? y : ed.Z) : () => (0, H.Z)(C);
    ...
    let D = (0, r.jsx)(A, {
        size: "md",
        color: "currentColor",
        className: a()(eU.buttonIcon, { [eU.withText]: !j }),
    });
    return (0, r.jsx)(m.yRy, {
        targetElementRef: c,
        renderPopout: (e) => {
...
class eJ extends i.PureComponent {
    renderConnectionStatus() {
        ...
        let s = (0, D.F6)(t, eC.default, eI.Z);
        return (
            null != n
