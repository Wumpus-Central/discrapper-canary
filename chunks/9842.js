...
class m {
    ...
    set(e, t, n) {
        ...
        null == r && ((r = new p()), this._channelCaches.set(e, r)), r.set(t, n);
    }
...
function A(e) {
    ...
    if ((g.updateExistingMessageIfCached(e) && (t = !0), _.sl8.has(e.type))) {
        ...
        if ("referenced_message" in e) {
            ...
            null != e ? g.set(n.channel_id, r, { state: 0, message: e }) : g.set(n.channel_id, r, E);
        }
        t = !0;
    }
    return t;
...
class v extends a.Ay.Store {
    ...
    initialize() {
        this.waitFor(c.A, d.A);
    }
    getMessageByReference(e) {
        let t;
        return null != e && (t = g.get(e.channel_id, e.message_id)), t ?? E;
    }
    getMessage(e, t) {
        return g.get(e, t) ?? E;
    }
...
let C = new v(o.h, {
    ...
    MESSAGE_CREATE: function (e) {
        let { message: t } = e;
        return !!c.A.getMessages(t.channel_id).ready && A(t);
    },
    ...
    GUILD_DELETE: function () {
        if (0 === g.retainWhere((e) => null != d.A.getChannel(e))) return !1;
    },
    CONNECTION_OPEN: O,
    LOGOUT: O,
});
