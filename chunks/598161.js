...
function J() {
    let {
        ...
        let t = (0, a.bG)([p.default], () => p.default.getCurrentUser()),
            ...
            x = s.useMemo(() => u.filter((e) => c.includes(e.id)), [u, c]);
        return o
            ? { isLoading: o, currentUser: t }
            : { isLoading: o, currentUser: t, eligibleApplications: x, markAsDismissed: d };
    })();
...
function eg(e) {
    ...
    return x ? (0, i.jsx)(ea, { userId: t.id }) : o ? (0, i.jsx)(z.D, { children: v() }) : v();
}
function em(e) {
    let { user: t, ...n } = e,
        l = s.useRef(null);
