...
function V(e) {
    ...
    let {
        ...
        [ee, et] = l.useState(!1),
        { completedRatio: en, completedRatioDisplay: er } = (0, b.I)(Z),
        [el, eo] = (0, D.G6)(A.intl.string(A.t.RDE0SU), A.intl.string(A.t["+5kSoa"]), 1700),
        ei = null != (0, O.LM)(Z.config),
        [ea, es] = l.useState(!1),
        ec = l.useRef(null),
        eu = (0, O.vB)(Z.config),
        ed =
    ...
    let ef = async () => {
        ...
        eE = l.useMemo(() => _.r.build(Z.config).defaultRewardName, [Z]),
        eg = A.intl.formatToPlainString(A.t["12IWPz"], { rewardName: eE }),
        eO = null == (o = Z.config.taskConfigV2) || null == (n = o.tasks) ? void 0 : n[c.X.WATCH_VIDEO];
                                      ...
                                      (0, r.jsxs)("div", {
                                          ...
                                          children: [
                                              ...
                                              (0, r.jsx)(j.i, {
                                                  ...
                                                  useReducedMotion: W,
                                                  isExpanded:
                                                      (null == (x = Z.userStatus) ? void 0 : x.completedAt) != null,
                                                  disabled:
