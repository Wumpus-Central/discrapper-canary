...
let y = {
    ...
    [x.uss.GUILDS_TEXT](e) {
        ...
        return (0, i.jsx)(g.A, { dragStart: s, dragging: t, locked: n, pinned: !1, className: l });
    },
};
class v extends s.PureComponent {
    ...
    render() {
        ...
        let { id: r, pinned: o, zIndex: c, size: u, anchor: h, minSize: A } = e,
            ...
            y = (0, _.AE)({ locked: s, isPreviewingInGame: l, pinned: o }),
...
let C = l.Ay.connectStores([c.A, h.A], () => ({
