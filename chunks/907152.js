n.d(t, { C4: () => y }), n(539854), n(953529), n(804061), n(704826), n(35282), n(512722);
var r = n(913527),
    i = n.n(r),
    o = n(705512);
n(812206);
...
let g = (e, t) => m({ AvatarImage1: e[0] }, null != e[1] && { AvatarImage2: e[1] }, null != e[2] && { AvatarImage3: e[2] }, null != t && { ApplicationImage: t }),
    E = (e, t) => {
        ...
        if (
            ...
            n.push({
                iconPath: _.t1,
                text: p.NW.formatToPlainString(p.t['Klie/P'], { days: t })
            });
        }
        (0, d.ig)(e) === o.o.GLOBAL &&
            n.push({
        ...
        if ((0, d.Jd)(e)) {
            let t = (0, d.yA)(e);
            if (null != t) {
                let e = p.NW.formatToPlainString(p.t.C0Axoa, { hours: Math.round(t / c.Z.Seconds.HOUR) });
                return [
                    {
                        iconPath: _.eF,
