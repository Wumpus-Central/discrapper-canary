...
let p = {
    [d.Etm.SET_USER_VOICE_SETTINGS]: {
        ...
        handler(e) {
            ...
            if (null == a.default.getUser(t) || (null == c ? void 0 : c.id) === t)
                throw new o.Z({ errorCode: d.lTL.INVALID_USER }, "Invalid user id: ".concat(t));
    ...
    [d.Etm.SET_VOICE_SETTINGS]: {
        ...
        handler(e) {
            ...
            if (
                (t &&
                    (null != t.device_id && i.Z.setInputDevice(t.device_id),
                    null != t.volume && i.Z.setInputVolume(t.volume)),
                n &&
                    (null != n.device_id && i.Z.setOutputDevice(n.device_id),
                    null != n.volume && i.Z.setOutputVolume(n.volume)),
                r)
            ) {
                let e = l.Z.getMode(),
            ...
            if (
                (null != a && i.Z.setAutomaticGainControl(a),
                null != o && i.Z.setEchoCancellation(o),
                null != s && i.Z.setNoiseSuppression(s),
                null != u && i.Z.setQoS(u),
                null != d && i.Z.setSilenceWarning(d),
                null != p)
            ) {
