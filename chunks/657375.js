...
async function I(e) {
    ...
    if (!m(t, r)) return;
    let u = null != a ? (a.at(0)?.payload ?? null) : null;
    if (null == u) {
        (0, o.$8)(o.vI.SIGN_FAILED, i), E.delete(t);
        return;
    }
    let d = await (0, l.EO)(t, i, JSON.stringify(u));
    if (!m(t, r)) return void T(d);
    if (null == d) {
        (0, o.$8)(o.vI.NO_TOKEN, i), E.delete(t);
        return;
    }
    (0, o.$8)(o.vI.REGISTERED, i), (r.token = d);
}
async function h(e) {
    let t = E.get(e);
    return null == t
        ? (f.warn(`No tracked impression for ${e} at click time; store sheet will be unattributed`),
          (0, o.y9)(o.s5.NO_IMPRESSION, (0, l.BU)()),
          null)
        : (null == t.token && (await t.registration), m(e, t) && null != t.token)
          ? ((0, o.y9)(o.s5.ATTRIBUTED, t.framework), t.token)
          : (f.warn(`Impression ${e} not registered natively in time; store sheet will be unattributed`),
            (0, o.y9)(o.s5.NOT_READY, t.framework),
            null);
}
async function _(e) {
