...
let A = function (e) {
    ...
    let b = (0, s.e7)([E.Z], () => E.Z.theme),
        A = (0, v.If)(),
        { section: x, rows: Z } = (0, s.cj)([y.ZP], () => y.ZP.getState()),
    ...
    let R = (e) => {
        ...
        M = [
            ...
            },
            {
                ...
                ariaLabel: T.intl.formatToPlainString(T.t.OAC0Z2, { count: A.toString() }),
                className: P.item,
            },
            {
            ...
            (0, r.jsxs)("div", {
                ...
                children: [
                    (0, r.jsx)(c.njP.Panel, {
                        ...
                        "aria-labelledby": k,
                        children: x === S.pJs.ADD_FRIEND ? (0, r.jsx)(I.Z, {}) : (0, r.jsx)(C.Z, { titleId: k }),
                    }),
                    (0, r.jsx)("div", {
