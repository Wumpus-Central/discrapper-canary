    ...
    (0, l.ZDy)(
        async () => {
            switch (t.type) {
                ...
                case h.Us.PERK: {
                    let { default: i } = await Promise.all([n.e('55666'), n.e('30642')]).then(n.bind(n, 326055));
                    return (n) =>
                        (0, r.jsx)(
                            i,
                            g(
...
function v(e, t) {
    var m;
    let { analyticsLocations: v } = (0, a.ZP)(),
        [y, _] = i.useState(!1),
        ...
        C = (0, o.e7)([u.Z], () => u.Z.getGuild(e)),
        S = Math.max((null !== (m = null == C ? void 0 : C.premiumSubscriberCount) && void 0 !== m ? m : 0) - x, 0),
        P = i.useCallback(
            (n) => {
                let r = n ? d.H6 : d.Th;
                return (
