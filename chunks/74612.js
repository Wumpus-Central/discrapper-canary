...
let t8 = (0, o.E2)(d.X.OVERLAY_VOICE_WIDGET_PREVIEW, {
        Component: function () {
            let e,
                ...
                o = [null != t ? (((e = t4(t.username)).user = t), e) : null, ...s].filter(t3.Vq),
...
let lb = (0, o.E2)(d.X.APPEARANCE_IN_APP_ICON, {
    ...
    Component: function () {
        let e = (0, lS.GV)(),
            { ref: t, ...n } = (0, lE._u)({ orientation: "horizontal", labelledBy: e }),
        ...
        return (
            ...
            (0, S.jsx)("div", {
                ...
                children: (0, S.jsx)(R.B, {
                    ...
                    wrap: !0,
                    gap: 8,
                    children: (0, S.jsx)(lT.m, { disabled: i, size: lx.N8.SIZE_48 }),
                }),
            })
        );
    },
...
var l5 = n(77729),
    l3 = n(349230);
let l4 = [],
    l8 = (0, o.Hn)(d.X.STREAMER_MODE_HIDE_OVERLAY_WIDGETS, {
        ...
        useValue: function () {
            return (0, O.bG)([eb.A], () => eb.A.getSettings().disabledOverlayWidgets ?? l4);
        },
...
let s3 = (0, o.E2)(d.X.KEYBINDS_SETTING, {
    ...
    s4 = (0, o.zZ)(d.X.KEYBINDS_CATEGORY, { buildLayout: () => [s3] }),
    s8 = (0, o.t_)(d.X.KEYBINDS_PANEL, { useTitle: () => g.intl.string(g.t.T9DA2K), buildLayout: () => [s4] }),
...
let re = (0, o.E2)(d.X.CAMERA_BACKGROUND_SETTING, {
        ...
        Component: function () {
            let e = (0, a3.p)(),
                ...
                [i, l] = x.useState((0, a4.i)(t5.default.getCurrentUser())),
                s = x.useRef(i);
            return (
                x.useEffect(
                    () => () => {
                        t.current && (0, a8._C)(s.current);
                    },
                    [],
                ),
                (0, S.jsx)(a6.A, {
    ...
    return (0, S.jsxs)("div", {
        ...
        children: [
            l
                ...
                : (0, S.jsx)(c4, { className: c8.$J, boostInCooldown: i, useReducedMotion: s }),
            !l && i && (0, S.jsx)("img", { className: c8.De, src: n(994937), alt: "" }),
        ],
    });
};
var c7 = n(548118),
...
let gD = function (e) {
    let t,
        ...
        E = null != s ? oG.Ay.getNumIncludedPremiumGuildSubscriptionSlots(s.planId) : 0,
        ...
        children: [
            ...
            (0, S.jsxs)(U.D, {
                ...
                children: [
                    ...
                    (0, S.jsx)(k.E, { className: p4._e, variant: "text-sm/bold", color: "always-white", children: s }),
                ],
            }),
        ],
    });
...
function Et(e, t) {
    ...
    (0, x.useEffect)(() => {
        ...
        let s = requestAnimationFrame(() => {
            l.scrollIntoView({ behavior: i ? "auto" : "smooth" }), Ee.A.setState({ scrollPosition: null });
        });
...
function El(e) {
    let { user: t, disabledInputs: i, containerClassName: l } = e,
        { reducedMotion: s } = x.useContext(En.C),
        {
            pendingAvatar: a,
            pendingBanner: r,
    ...
    return (0, S.jsx)(AI.A, {
        ...
        pendingProfileEffect: d,
        avatarClassName: null != h || null != a || s.enabled ? void 0 : Ei.W,
...
function Ea(e) {
    ...
    let E = (0, pW.V)()?.subscription_trial?.sku_id === lf.pe.TIER_2,
        T = (0, pK.O)(),
        f = (0, p9.U9)(T, lf.pe.TIER_2);
    return i
        ? (0, S.jsx)(iM.f5, {
              value: h,
              children: (0, S.jsxs)(uY.A, {
                  ...
                  children: [
                      (0, S.jsx)(AC, {
                          stickyPreview: !1,
                          layoutClassName: Es.th,
                          profilePreviewTitle: (0, S.jsxs)(S.Fragment, {
                              children: [
                                  (0, S.jsx)(oC.t, { size: "md", color: "currentColor", className: Es.PC }),
                                  g.intl.string(g.t.gMlDNd),
                              ],
                          }),
                          profilePreview: (0, S.jsxs)(S.Fragment, {
                              children: [(0, S.jsx)(p8, { preset: c, onShuffle: _ }), (0, S.jsx)(El, { user: t })],
                          }),
                          children: (0, S.jsxs)("div", {
                              className: Es.EN,
                              children: [
                                  ...
                                  (0, S.jsx)(A0, { user: t, className: Es.fz }),
                                  !E &&
                                      (0, S.jsx)(k.E, {
                                          variant: "text-sm/normal",
...
let EA = (0, lS.Ld)(),
    Ep = x.memo(function (e) {
        let { availablePrimaryGuilds: t, pendingPrimaryGuildId: n, onChange: i } = e,
            ...
            s = (0, O.bG)([t5.default], () => (0, Ec.Zo)(t5.default.getCurrentUser()?.primaryGuild).guildId),
            a = void 0 !== n ? n : s,
            r = x.useMemo(
        ...
        s = x.useCallback(
            (e) => {
                "c" === e.key &&
                    e.metaKey &&
                    u8.p5 &&
                    (e.preventDefault(), e.stopPropagation(), (0, u8.C)(i), l?.current?.focus());
            },
            [i],
        );
    return (0, S.jsx)("li", {
...
function Tu(e) {
    let t,
        ...
        o = x.useCallback(function () {
            let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
            (0, b.openModal)((t) => (0, S.jsx)(Tl.default, { reason: Ti.d.USER_SETTINGS_UPDATE, ...t, ...e }), {
                modalKey: Td.V,
            });
        }, []),
        d = x.useCallback(() => {
...
function Tx(e, t) {
    ...
    return { location: n, platform: i, os: l, Icon: s, lastActive: t ? null : (0, Th.Y)(e.approx_last_used_time) };
}
var Tf = n(405814);
function Tb() {
...
function TL(e) {
    let { session: t, current: n } = e,
        { location: i, platform: l, os: s, Icon: a, lastActive: r } = Tx(t, n),
        o = [i, r].filter(t3.Vq);
    return (0, S.jsx)(TR, {
        icon: a,
        label: s,
...
let Sp = (0, o.zZ)(d.X.BACKUP_CODES_CATEGORY, {
    ...
    SS = (0, o.zZ)(d.X.SMS_AUTH_CATEGORY, {
        ...
        useSubtitle: () => (0, O.bG)([t5.default], () => Ts(t5.default.getCurrentUser(), !0)),
        useHeaderDecoration: () => {
            let e = (0, O.bG)([t5.default], () => t5.default.getCurrentUser()?.hasFlag(Q.nhx.MFA_SMS) ?? !1),
                t = (0, O.bG)([t5.default], () => null != Ts(t5.default.getCurrentUser()));
            if (!e)
                return {
                    type: ef.WX.BUTTON_GROUP,
                    buttons: [
...
let xg = (0, o.E2)(d.X.FAMILY_CENTER_SETTING, {
    ...
    xp = (0, o.t0)(d.X.ACCOUNT_FAMILY_CENTER_NESTED_PANEL, {
        ...
        useSubtitle: () => ((0, xo.Z)() ? g.intl.string(xc.default["G/L4VO"]) : g.intl.string(xc.default.Z53oSM)),
        buildLayout: () => [xm],
    });
    ...
    fM = (0, o.E2)(d.X.CONNECTIONS_CONNECTED_ACCOUNTS_SETTING, {
        Component: function () {
            let e = (0, O.bG)([eb.A], () => eb.A.hidePersonalInformation),
                ...
                { authorizedAppsFetchState: i, authorizedApps: l } = (0, O.cf)([fT.default], () => ({
            ...
            e)
                ...
                : (0, S.jsxs)(S.Fragment, {
                      children: [
                          (0, S.jsx)(fh, {}),
                          (0, S.jsx)(fG, {
                              fetching: t || s || (a.length > 0 && i !== fT.FetchState.FETCHED),
                              accounts: n,
                              appIdentities: a,
                              authorizedApps: l,
                              theme: r,
...
function fH(e, t) {
    ...
    return (
        ...
        { showLoadingIndicator: n !== fT.FetchState.FETCHED && (null == i || 0 === i.length), slayerSdkApplications: l }
    );
}
n(505653);
var fK = n(106148);
...
let Cp = (0, o.Hn)(d.X.REACTION_NOTIFICATIONS, {
    ...
    Cx = (0, o.FW)(d.X.NOTIFICATION_SELECTION_FIELD_SET, {
        ...
        buildLayout: () => [C_, Cs, Cr, CE, CS, Cu, Ch, Cp, Cg],
    }),
