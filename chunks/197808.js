...
let G = s.Ay.connectStores([I.A, o.Ay, R.A, T.A, N.A, C.A, v.A, _.A, S.Ay, f.A], (e) => {
    let t,
    ...
    let V = Array.from(v.A.pipWindows.values()),
        ...
        W = [V.find((e) => e.component === b.o1q.HAVEN), H, j, Y].filter(O.Vq),
        K = S.Ay.callChatSidebarWidth,
        $ = C.A.getVoiceChannelId(),
        z = C.A.getChannelId() === $,
        q = null != $ && _.A.getChatOpen($),
        X = m || g,
        Z = X && null != a && (0, l.q)(a.applicationId),
        Q = !X && null != t && z;
    return {
        selectedPIPWindow: t,
