...
function f(e, t) {
    ...
    return e && e.state
        ? ((i = e.state),
          ...
          t && (t < 8 || t > 15))
            ? -2
            : (null !== i.window && i.wbits !== t && (i.window = null), (i.wrap = n), (i.wbits = t), h(e))
        : -2;
}
function p(e, t) {
    var n, i;
    return e ? ((e.state = i = new d()), (i.window = null), 0 !== (n = f(e, t)) && (e.state = null), n) : -2;
}
var E = !0;
function m(e, t, n, i) {
    var r,
    ...
    return (
        ...
        i >= a.wsize
            ...
            : ((r = a.wsize - a.wnext) > i && (r = i),
              s.arraySet(a.window, t, n - i, r, a.wnext),
              (i -= r)
                  ? (s.arraySet(a.window, t, n - i, i, 0), (a.wnext = i), (a.whave = a.wsize))
            ...
            switch (n.mode) {
                ...
                case 2:
                    ...
                    n.head && (n.head.text = (A >> 8) & 1),
                        512 & n.flags && ((U[0] = 255 & A), (U[1] = (A >>> 8) & 255), (n.check = o(n.check, U, 2, 0))),
                        (A = 0),
                        (I = 0),
                        (n.mode = 3);
                case 3:
                ...
                case 5:
                    if (1024 & n.flags) {
                        ...
                        (n.length = A),
                            ...
                            512 & n.flags &&
                                ((U[0] = 255 & A), (U[1] = (A >>> 8) & 255), (n.check = o(n.check, U, 2, 0))),
                            (A = 0),
                            (I = 0);
                    ...
                    if (
                        ...
                        y &&
                            (n.head &&
                                ...
                                s.arraySet(n.head.extra, d, h, y, w)),
                            512 & n.flags && (n.check = o(n.check, d, y, h)),
                            (p -= y),
                            (h += y),
                            (n.length -= y)),
                        n.length)
                ...
                case 7:
                    if (2048 & n.flags) {
                        if (0 === p) break r;
                        y = 0;
                        do (w = d[h + y++]), n.head && w && n.length < 65536 && (n.head.name += String.fromCharCode(w));
                        while (w && y < p);
                        if ((512 & n.flags && (n.check = o(n.check, d, y, h)), (p -= y), (h += y), w)) break r;
                ...
                case 10:
                    ...
                    (e.adler = n.check = c(A)), (A = 0), (I = 0), (n.mode = 11);
                case 11:
                    if (0 === n.havedict)
                        return (
                            (e.next_out = f),
                        ...
                        case 1:
                            if (
                                (!(function (e) {
                                    if (E) {
                                        var t;
                                        for (i = new s.Buf32(512), r = new s.Buf32(32), t = 0; t < 144; )
                                            e.lens[t++] = 8;
                                        for (; t < 256; ) e.lens[t++] = 9;
                                        for (; t < 280; ) e.lens[t++] = 7;
                                        for (; t < 288; ) e.lens[t++] = 8;
                                        for (u(1, e.lens, 0, 288, i, 0, e.work, { bits: 9 }), t = 0; t < 32; )
                                            e.lens[t++] = 5;
                                        u(2, e.lens, 0, 32, r, 0, e.work, { bits: 5 }), (E = !1);
                                    }
                ...
                case 14:
                    ...
                    if (((n.length = 65535 & A), (A = 0), (I = 0), (n.mode = 15), 6 === t)) break r;
                case 15:
                    n.mode = 16;
                case 16:
                    if ((y = n.length)) {
                        if ((y > p && (y = p), y > g && (y = g), 0 === y)) break r;
                        s.arraySet(_, d, h, y, f), (p -= y), (h += y), (g -= y), (f += y), (n.length -= y);
                        break;
                    }
                    n.mode = 12;
                    break;
                ...
                case 19:
                    for (; n.have < n.nlen + n.ndist; ) {
                        for (
                            ;
                            (v = (k = n.lencode[A & ((1 << n.lenbits) - 1)]) >>> 24),
                                (R = (k >>> 16) & 255),
                                (O = 65535 & k),
                                !(v <= I);
                        ) {
                        ...
                        if (O < 16) (A >>>= v), (I -= v), (n.lens[n.have++] = O);
                        else {
                            if (16 === O) {
                                for (x = v + 2; I < x; ) {
                                    if (0 === p) break r;
                                ...
                                (A >>>= v), (I -= v), (w = 0), (y = 3 + (7 & A)), (A >>>= 3), (I -= 3);
                            } else {
                                for (x = v + 7; I < x; ) {
                                    if (0 === p) break r;
                                    p--, (A += d[h++] << I), (I += 8);
                                }
                                (A >>>= v), (I -= v), (w = 0), (y = 11 + (127 & A)), (A >>>= 7), (I -= 7);
                            }
                ...
                case 21:
                    ...
                    if (R && (240 & R) == 0) {
                        for (
                            b = v, D = R, L = O;
                            (v = (k = n.lencode[L + ((A & ((1 << (b + D)) - 1)) >> b)]) >>> 24),
                                (R = (k >>> 16) & 255),
                                (O = 65535 & k),
                                !(b + v <= I);
                        ) {
                    ...
                    if (((A >>>= v), (I -= v), (n.back += v), (n.length = O), 0 === R)) {
                        n.mode = 26;
                        break;
                    }
                    if (32 & R) {
                ...
                case 23:
                    for (
                        ;
                        (v = (k = n.distcode[A & ((1 << n.distbits) - 1)]) >>> 24),
                            (R = (k >>> 16) & 255),
                            (O = 65535 & k),
                            !(v <= I);
                    ) {
                    ...
                    if ((240 & R) == 0) {
                        for (
                            b = v, D = R, L = O;
                            (v = (k = n.distcode[L + ((A & ((1 << (b + D)) - 1)) >> b)]) >>> 24),
                                (R = (k >>> 16) & 255),
                                (O = 65535 & k),
                                !(b + v <= I);
                        ) {
                ...
                case 25:
                    ...
                    if (((y = S - g), n.offset > y)) {
                        ...
                        y > n.wnext ? ((y -= n.wnext), (C = n.wsize - y)) : (C = n.wnext - y),
                            y > n.length && (y = n.length),
                            (N = n.window);
                    } else (N = _), (C = f - n.offset), (y = n.length);
                ...
                case 27:
                    if (n.wrap) {
                        ...
                        if (
                            ...
                            (e.total_out += S),
                            (n.total += S),
                            S && (e.adler = n.check = n.flags ? o(n.check, _, S, f - S) : a(n.check, _, S, f - S)),
                            (S = g),
                            (n.flags ? A : c(A)) !== n.check)
                        ) {
