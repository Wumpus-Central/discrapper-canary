...
function E(e) {
    ...
    let r,
        ...
        d = l?.preferredFlow,
        _ = null != d,
        { token: h, fetched: f } = (0, c.U)(o?.parentId ?? o?.id, { disableFetch: s.disableFetch });
    return {
        fetched: f,
...
function g(e, t) {
    ...
    let u,
        ...
        g =
            ((n = i.useCallback(
                () => e.map((e) => ({ application: e, isSubscribedToAuthorizeRequest: o.A.isSubscribed(e.id, f) })),
                [e],
            )),
            (u = i.useRef(d)),
            (c = i.useRef(n)),
                ...
                if (
                    (E.includes(_._M.RPC) &&
                        ...
                        t.push({
                            type: _._M.RPC,
                            initiate(t) {
                                o.A.dispatchToSubscriptions(f, (t) => t.socket.application.id === e.application.id, {}),
                                    t.onConfirm?.(),
                                    a.Ay.trackWithMetadata(h.HAw.ON_PLATFORM_ACCOUNT_LINK_FLOW_STARTED, {
