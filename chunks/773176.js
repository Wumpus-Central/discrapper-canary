...
function ef(e) {
    let {
            ...
            let { channel: t, message: n, showEmojiPicker: r, showEmojiBurstPicker: i, showMoreUtilities: l, setPopout: a, isFocused: o } = e,
                ...
                { canManageMessages: C, canAddNewReactions: y } = (0, c.cj)(
                    [V.Z],
                    () => ({
                ...
                S = s.id === d,
                Z = (C || n.canDeleteOwnMessage(d)) && p && !ei.V$x.UNDELETABLE.has(n.type);
        ...
        [ex, ey] = (0, m.cv)(A ? [u.z.MESSAGE_FORWARDING_DESKTOP_UTILITIES_NEW_BADGE] : []),
