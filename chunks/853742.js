...
function y(e) {
    ...
    c.A.isLoading(i) ? c.A.addConditionalChangeListener(() => !!c.A.isLoading(i) || (a(), !1)) : a();
}
function S(e) {
    let { guildId: t, channelId: n } = e;
...
function k(e) {
    r.Ay.trackWithMetadata(f.HAw.CHANNEL_OPENED, {
        ...
        (0, a.k)(f.HAw.CHANNEL_OPENED_CLICKSTREAM, { channelId: e.id });
}
function U() {
