...
let L = (0, x.xI)(u.A.GAME_LIST_ROW_MIN_HEIGHT),
    ...
    D = (e) => {
        let { flag: t, icon: n, item: l, tooltip: a } = e,
            s = l.libraryApplication.hasFlag(t);
        return (0, i.jsx)(c.m, { text: a, children: (0, i.jsx)(n, { className: r()(O.up, { [O.R]: !s }) }) });
    },
    M = [
        {
            key: b.DpB.NAME,
...
class w extends l.PureComponent {
    ...
    render() {
        let { sortKey: e, sortDirection: t, applicationViewItems: n, activeRowKey: a, stickyHeader: r } = this.props,
