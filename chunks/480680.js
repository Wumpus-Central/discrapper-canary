...
function V(e) {
    let { includePanelSpacing: t } = e,
        ...
        R = l.useCallback(
            (e) => {
                s !== M.Io.BOOKMARKS && S.A.loadMoreInbox({ viewId: n, loadingTrigger: e });
            },
            [s, n],
        ),
                    ...
                    t.forEach((e) => {
                        ...
                        null != n &&
                            ...
                            m.ack(
                                e,
                                {
                                    section: D.JJy.NOTIFICATIONS_INBOX,
                                    object: D.ZSU.ACK_INBOX_CHANNEL_NO_MESSAGES,
    ...
    return (0, i.jsx)("nav", {
        ...
        children: (0, i.jsxs)(c.F, {
            ...
            children: [
                s === M.Io.ALL && (0, i.jsx)(Y, { hideBanner: !L || s !== M.Io.ALL }),
                q && (0, i.jsx)(u.h, { size: 8 }),
                (0, i.jsx)(G.A, {
                    className: P.cl,
                    renderMessageGroup: W,
                    messages: s === M.Io.BOOKMARKS ? V : B,
                    unreadMessages: s === M.Io.BOOKMARKS ? [] : K,
                    listName: "notifications-inbox",
                    renderLoadingState: F,
                    ignoreGrouping: s === M.Io.BOOKMARKS,
                    loadMore: R,
                }),
            ],
        }),
...
function H(e, t, n) {
    return l.useMemo(
        () =>
            0 === e.length || t === M.Io.BOOKMARKS
                ? w
                : e.filter((e) => {
                      let { id: i } = e;
                      return (
                          !(b.default.age(i) > M.V$ || (null != n && 0 >= b.default.compare(i, n))) && t === M.Io.ALL
                      );
                  }),
        [e, t, n],
    );
