...
class I {
    ...
    mergePropsAndUpdate_(e) {
        ...
        let s = e.messages.last(),
            r = t.last();
        if (null != s && s.state === x.cmJ.SENDING && r?.id !== s.id) return void this.setScrollToBottom();
        ...
        if (null != o && n !== o) {
            ...
            if (null != e)
                return void this.ref.current?.scrollIntoViewNode({
                    node: e,
                    padding: C.mZ + this.props.additionalMessagePadding,
    ...
    newMessageBarBuffer() {
        return this.props.channel.isForumPost() ? C.Gt : C.k8;
    }
    findAnchor() {
    ...
    fixJumpTarget() {
        ...
        if (null != e.jumpTargetId) {
            ...
            (0, s.vq)(i)
                ? this.scrollTo(
                      this.getOffsetOrientationFromNode(i, "middle", t ? this.newMessageBarBuffer() : C.mZ),
                      !0,
                  )
    ...
    scrollToNewMessages() {
        let e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
            ...
            i = this.getDocument()?.getElementById(C.q4),
            l = () => {
        ...
        return function () {
            ...
            (e.messageFetchAnchor = e.findFetchAnchor(i)),
                ...
                o.A.fetchMessages({
                    ...
                    before: t,
                    after: n,
                    limit: Math.min(x.EMb, 2 * (0, f.h)("scrollManager.loadMore")),
                    truncate: !0,
                });
        };
    })();
    ...
    setScrollToBottom() {
        ...
        if (t.hasMoreAfter)
            o.A.jumpToPresent(n.id, (0, f.h)("scrollManager.jumpToPresent")), (0, h.uh)(n.getGuildId() ?? x.ME, n.id);
        else
        ...
        (0, s.vq)(l)
            ? this.scrollTo(
                  this.getOffsetOrientationFromNode(
                      l,
                      "middle",
                      this.props.hasUnreads ? this.newMessageBarBuffer() : C.mZ,
                  ),
                  n,
                  a,
              )
