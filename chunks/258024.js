...
function x(e) {
    ...
    let i = [
        ...
        l = i.indexOf(t),
        a = i[l + (Math.abs(n) > 0 ? n : 1)] ?? i[l - 1];
    return null != a ? a : null;
}
let S = { scrollTop: 0, scrollHeight: 0, offsetHeight: 0 };
class T {
    props;
    ref = i.createRef();
    ...
    mergePropsAndUpdate_(e) {
        ...
        if (null != e.messages.jumpTargetId) {
            ...
            if (null == n || this.isJumping() || e.messages.jumpSequenceId === t.jumpSequenceId) {
                ...
                null != l &&
                    ...
                    (i = p.default.extractTimestamp(l.id)),
        ...
        let s = e.messages.last(),
            r = t.last();
        if (null != s && s.state === C.cmJ.SENDING && r?.id !== s.id) return void this.setScrollToBottom();
        ...
        if (null != o && n !== o) {
            ...
            if (null != e)
                return void this.ref.current?.scrollIntoViewNode({
                    node: e,
                    padding: E.mZ + this.props.additionalMessagePadding,
    ...
    getAnchorData(e, t, n) {
        ...
        if (!(0, s.vq)(i) || null == l) return null;
        let { offsetHeight: a } = i,
            r = (0, _.A)(i, l),
            o = r - t;
        return (
            null != n && (o = Math.max(-a, Math.min(n, o))),
            { id: e, offsetFromTop: o, offsetTop: r, offsetHeight: a, clamped: null != o }
        );
    }
    ...
    newMessageBarBuffer() {
        return this.props.channel.isForumPost() ? E.Gt : E.k8;
    }
    findAnchor() {
        let { messages: e, hasUnreads: t, channel: n } = this.props,
            ...
            s = null,
            r = (t) => (-1 === t ? p.default.castChannelIdAsMessageId(n.id) : e._array[t]?.id),
            o = -1,
            c = !1;
        for (;;) {
            let t = r(o);
            ...
            null != n && (n.offsetTop >= l + a || o === e.length - 1) && ((s = n), (c = !0)), o++;
        }
        return s;
    }
    findFetchAnchor(e) {
        let { messages: t } = this.props,
            ...
            l = null,
            a = t._array.length - 1;
        for (let s = e ? a : 0; null != t._array[s]; s += i) {
            let e = t._array[s],
    ...
    updateVisibleMessagesDebounced = a().debounce(m.s_, 300);
    ...
    getScrollerState() {
        return this.ref.current?.getScrollerState() ?? S;
    }
    handleScroll = (e) => {
    ...
    handleScrollSpeed(e) {
        ...
        0 !== s &&
            0 !== r &&
            (1 === s && t + r <= 0
                ? (this.mergeTo(a - n), (this.prevScrollTop = a - n))
                : 2 === s && t + r >= i - n && (this.mergeTo(i - a), (this.prevScrollTop = i - a)));
    }
    enableAutomaticAck() {
        this.isInitialized() &&
            !this.acking &&
    ...
    fixJumpTarget() {
        ...
        if (null != e.jumpTargetId) {
            ...
            (0, s.vq)(i)
                ? this.scrollTo(
                      this.getOffsetOrientationFromNode(i, "middle", t ? this.newMessageBarBuffer() : E.mZ),
                      !0,
                  )
    ...
    scrollToNewMessages() {
        let e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
            ...
            i = this.getDocument()?.getElementById(E.q4),
            l = () => {
    ...
    getOffsetOrientationFromNode(e, t) {
        ...
        let l = this.getScrollerState(),
            a = (0, _.A)(e, i);
        return "middle" === t ? Math.min(a - 0.5 * l.offsetHeight + 0.5 * e.offsetHeight + -8, a - n) : a - n;
    }
    restoreScroll() {
        if (this.isInitialized()) return;
    ...
    loadMore = (() => {
        ...
        return function () {
            ...
            (e.messageFetchAnchor = e.findFetchAnchor(i)),
                (e.loading = !0),
                o.A.fetchMessages({ channelId: e.props.channel.id, before: t, after: n, limit: C.EMb, truncate: !0 });
        };
    })();
    scrollTo(e) {
        let t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
    ...
    setScrollToBottom() {
        ...
        if (t.hasMoreAfter) o.A.jumpToPresent(n.id, C.EMb), (0, h.uh)(n.getGuildId() ?? C.ME, n.id);
        else
            this.scrollTo(Number.MAX_SAFE_INTEGER, e, () => {
                (this.jumping = !1), this.handleScroll();
            });
    }
    updateStoreDimensionsDebounced = a().debounce(this.updateStoreDimensions, 200);
    updateStoreDimensions(e) {
        ...
        if (this.isPinned()) r.A.updateChannelDimensions(t.id, 1, 1, 0, e);
            ...
            r.A.updateChannelDimensions(t.id, i - n, l - n, a, e);
        }
    }
    scrollIntoViewRect() {}
    scrollPageUp() {
    ...
    scrollToMessage(e) {
        ...
        this.isJumping() ||
            ...
            (p.default.extractTimestamp(t) > i ? this.scrollTo(0) : this.scrollTo(Number.MAX_SAFE_INTEGER)),
            (this.pinned = !1),
            (this.jumping = !0);
        let a = () => {
            (this.jumping = !1),
                (0, s.vq)(l) && ((l.tabIndex = -1), l.focus({ preventScroll: !0 })),
                (this.scrollCounter = 0),
                this.handleScroll(),
        ...
        (0, s.vq)(l)
            ? this.scrollTo(
                  this.getOffsetOrientationFromNode(
                      l,
                      "middle",
                      this.props.hasUnreads ? this.newMessageBarBuffer() : E.mZ,
                  ),
                  n,
                  a,
              )
    ...
    getOffsetToTriggerLoading(e, t) {
        let { scrollHeight: n, offsetHeight: i } = t,
            { messages: l, hasUnreads: a, placeholderHeight: s } = this.props;
        if ("top" === e)
            if (!l.hasMoreBefore) return 0;
            else return a ? s - E.N0 - 2 : s + 500;
        return l.hasMoreAfter ? n - i - s - 500 : n - i;
    }
    ...
    addAutomaticAnchorCallback(e) {
        ...
        this._automaticAnchorCallbacks.push(e),
            (this._automaticAnchorCallbacks = a().uniq(this._automaticAnchorCallbacks)),
    ...
    addScrollCompleteCallback(e) {
        this._scrollCompleteCallbacks.push(e),
            (this._scrollCompleteCallbacks = a().uniq(this._scrollCompleteCallbacks));
    }
