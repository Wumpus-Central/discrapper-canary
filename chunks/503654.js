...
var a = {
    ...
    "creditCard.holderName.invalid": "Ange namnet som det st\xe5r p\xe5 kortet",
    ...
    "creditCard.cvcField.title": "S\xe4kerhetskod",
    ...
    "firstName.invalid": "Ange ditt f\xf6rnamn",
    infix: "Prefix",
    lastName: "Efternamn",
    ...
    gender: "K\xf6n",
    "gender.notselected": "V\xe4lj ett k\xf6n",
    male: "Man",
    female: "Kvinna",
    ...
    cityTown: "Ort",
    address: "Adress",
    "address.placeholder": "Hitta din adress",
    "address.errors.incomplete": "Ange en adress f\xf6r att forts\xe4tta",
    "address.enterManually": "Ange adress manuellt",
    state: "Delstat",
    "field.title.optional": "(valfritt)",
    "creditCard.cvcField.title.optional": "S\xe4kerhetskod (valfritt)",
    ...
    "error.va.sf-cc-num.01": "Ange ett giltigt kortnummer",
    "error.va.sf-cc-num.02": "Ange kortnumret",
    "error.va.sf-cc-num.03": "Ange ett kortm\xe4rke som st\xf6ds",
    "error.va.sf-cc-num.04": "Ange det fullst\xe4ndiga kortnumret",
    "error.va.sf-cc-dat.01": "Ange ett giltigt utg\xe5ngsdatum",
    "error.va.sf-cc-dat.02": "Ange ett giltigt utg\xe5ngsdatum",
    "error.va.sf-cc-dat.03": "Kreditkortet g\xe5r snart ut",
    "error.va.sf-cc-dat.04": "Ange utg\xe5ngsdatumet",
    "error.va.sf-cc-dat.05": "Ange det fullst\xe4ndiga utg\xe5ngsdatumet",
    "error.va.sf-cc-mth.01": "Ange utg\xe5ngsm\xe5naden",
    "error.va.sf-cc-yr.01": "Ange utg\xe5ngs\xe5ret",
    "error.va.sf-cc-yr.02": "Ange det fullst\xe4ndiga utg\xe5ngs\xe5ret",
    "error.va.sf-cc-cvc.01": "Ange s\xe4kerhetskoden",
    "error.va.sf-cc-cvc.02": "Ange den fullst\xe4ndiga s\xe4kerhetskoden",
    ...
    "creditCard.encryptedCardNumber.aria.iframeTitle": "Iframe f\xf6r kortnummer",
    "creditCard.encryptedCardNumber.aria.label": "Kortnummer",
    "creditCard.encryptedExpiryDate.aria.iframeTitle": "Iframe f\xf6r utg\xe5ngsdatum",
    "creditCard.encryptedExpiryDate.aria.label": "Utg\xe5ngsdatum",
    "creditCard.encryptedExpiryMonth.aria.iframeTitle": "Iframe f\xf6r utg\xe5ngsm\xe5nad",
    "creditCard.encryptedExpiryMonth.aria.label": "Utg\xe5ngsm\xe5nad",
    "creditCard.encryptedExpiryYear.aria.iframeTitle": "Iframe f\xf6r utg\xe5ngs\xe5r",
    "creditCard.encryptedExpiryYear.aria.label": "Utg\xe5ngs\xe5r",
    "creditCard.encryptedSecurityCode.aria.iframeTitle": "Iframe f\xf6r s\xe4kerhetskod",
    "creditCard.encryptedSecurityCode.aria.label": "S\xe4kerhetskod",
    "creditCard.encryptedPassword.aria.iframeTitle": "Iframe f\xf6r l\xf6senord",
    "creditCard.encryptedPassword.aria.label": "De tv\xe5 f\xf6rsta siffrorna i kortets l\xf6senord",
    "giftcard.encryptedCardNumber.aria.iframeTitle": "Iframe f\xf6r kortnummer",
    "giftcard.encryptedCardNumber.aria.label": "Kortnummer",
    "giftcard.encryptedSecurityCode.aria.iframeTitle": "Iframe f\xf6r PIN",
    "giftcard.encryptedSecurityCode.aria.label": "PIN-kod",
    giftcardTransactionLimit: "Maximalt %{amount} per transaktion \xe4r till\xe5tet p\xe5 detta presentkort",
    "ach.encryptedBankAccountNumber.aria.iframeTitle": "Iframe f\xf6r bankkontonummer",
    "ach.encryptedBankAccountNumber.aria.label": "Kontonummer",
    "ach.encryptedBankLocationId.aria.iframeTitle": "Iframe f\xf6r clearingnummer",
    ...
    "onlineBankingPL.termsAndConditions":
        "Genom att forts\xe4tta godk\xe4nner du Przelewy24s %#regler%# och %#informationsplikt%#.",
    ...
    "ctp.infoPopup.benefit1":
        "Click to Pay anv\xe4nder kryptering f\xf6r att h\xe5lla din information s\xe4ker och trygg",
    ...
    "ctp.errors.NOT_FOUND":
        "Inget konto hittades, ange en giltig e-postadress eller forts\xe4tt med manuell kortinmatning",
    ...
    "ctp.errors.ACCT_INACCESSIBLE":
        "Det h\xe4r kontot \xe4r f\xf6r n\xe4rvarande inte tillg\xe4ngligt, det kanske \xe4r l\xe5st",
    ...
    "companyDetails.name.invalid": "Ange f\xf6retagsnamnet",
    "companyDetails.registrationNumber.invalid": "Ange registreringsnumret",
    "consent.checkbox.invalid": "Du m\xe5ste godk\xe4nna villkoren",
    "form.instruction": "Alla f\xe4lt \xe4r obligatoriska om inte n\xe5got annat anges.",
    "trustly.descriptor": "Direkt bankbetalning",
    "trustly.description1": "Betala enkelt fr\xe5n ditt \xf6nskade bankkonto, med s\xe4ker verifiering via ditt BankID",
