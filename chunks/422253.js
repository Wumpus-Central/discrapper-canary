                ...
                ((e, t) => {
                    switch (t) {
                        ...
                        case ep.AVATAR_DECO:
                            return eu;
                        case ep.NITRO_LOGO:
                            return e ? "url(#gradient_nitro_logo)" : eu;
                        default:
                            return;
                    }
                })(h, c);
        return (0, i.jsxs)("div", {
            ...
            children: [
                (0, i.jsxs)("svg", {
                    ...
                    children: [
                        (0, i.jsx)("circle", {
                            className: c === ep.NITRO_GEM || c === ep.AVATAR_DECO ? ed.F3 : void 0,
                            fill: "transparent",
                            strokeWidth: r,
                            r: `${d}`,
                            cx: "50%",
                ...
                (0, i.jsx)("div", { className: ed.Vw, children: s }),
            ],
        });
    };
var ex = s(112875),
...
let eh = (e) => {
        let { avatarDecorationLegacyAssetId: t, avatarDecorationSkuId: s, avatarDecoAssetDescription: l } = e,
            a = n.useMemo(() => (0, ea.A)({ legacyAssetId: t, skuId: s, size: J._3.SIZE_120, canAnimate: !1 }), [t, s]);
        return (0, i.jsx)("div", {
            className: ex.Q7,
            children: (0, i.jsx)("div", {
                className: ex.Nk,
                children: null != a && (0, i.jsx)("img", { className: ex.CH, alt: l, src: a }),
            }),
        });
    },
    eg = (e) => {
        let {
            ...
            A = (0, m.bG)([en.A], () => en.A.useReducedMotion),
            _ = t && !A;
        return (0, i.jsx)("div", {
            className: r()(ex.G3, s),
            children: (0, i.jsx)(em, {
                animationClassName: r()(ex._0, { [ex.uJ]: _, [j ?? ""]: _ }),
                ...
                children: (() => {
                    switch (u) {
                        case 0:
                            return (0, i.jsx)(ec, {
                                className: _ ? ex.Ow : void 0,
                                backgroundColor: r()(ex.vH, n),
                                backgroundCircleSize: c,
                            });
                        case 1:
                            return (0, i.jsx)(eo, { circleColor: f, ellipseOpacity: g });
                        case 2:
                            if (null != p)
                                return (0, i.jsx)(eh, {
                                    avatarDecorationLegacyAssetId: x,
...
let e_ = (e) => {
        let { userRecord: t, placement: s } = e,
            { avatarSrc: l, eventHandlers: n } = (0, et.A)({ userId: t?.id, size: J._3.SIZE_32, animateOnHover: !0 }),
            a = null != t,
            r = a
                ? (0, i.jsx)(q.eu, { src: l, "aria-label": t.username, size: J._3.SIZE_32, ...n })
                : (0, i.jsx)(N.D, { variant: "heading-md/semibold", className: eA.n5, children: s });
        return (0, i.jsx)(X.m, {
            text: ef.intl.string(ef.t.UnKHdo),
            shouldShow: !a,
            children: (0, i.jsx)("div", { className: eA.Lg, children: r }),
        });
    },
    eC = (e) => {
        ...
        return (0, i.jsxs)("div", {
            ...
            children: [
                ...
                (0, i.jsx)("div", { className: r()({ [eA.ch]: t > s, [eA.q_]: t === s }) }),
            ],
        });
    },
    eE = (e) => {
        ...
        return (0, i.jsxs)("div", {
            className: eA.ZM,
            children: [
                (0, i.jsx)(e_, { userRecord: l, placement: 1 }),
                (0, i.jsx)(eC, { numSentReferrals: s, placement: 1 }),
                (0, i.jsx)(e_, { userRecord: n, placement: 2 }),
                (0, i.jsx)(eC, { numSentReferrals: s, placement: 2 }),
                (0, i.jsx)(e_, { userRecord: a, placement: 3 }),
            ],
        });
    },
    eI = () => {
        let e = (0, m.bG)([ei.A], () => ei.A.getRecipientStatus()),
            { referralSentUsers: t } = (0, ej.J)(),
            l = n.useMemo(() => t.map((e) => new es.A(e)), [t]),
        ...
        let c = a.sent === ej.Z,
            ...
            p = (0, i.jsxs)("div", {
                className: eA.hE,
                children: [
                    (0, i.jsx)(eg, { percentage: x, progressCircleVariation: ep.NITRO_LOGO, iconClassName: eA.ER }),
                    (0, i.jsxs)("div", {
                        className: eA.Ns,
                        children: [
                            (0, i.jsx)(N.D, {
                            ...
                            (0, i.jsx)(A.E, {
                                ...
                                children: ((e) => {
                                    ...
                                    return ((e) => {
                                        ...
                                        return t
                                            ? ef.intl.format(ef.t["TYu+MH"], { helpdeskArticle: l })
                                            : ef.intl.format(ef.t["omMr+V"], { helpdeskArticle: l });
                                    })({
                                        hasSentAll: s.sent >= ej.Z,
        ...
        return (0, i.jsx)(R.f5, {
            ...
            children: (0, i.jsx)("div", {
                ...
                children: (0, i.jsx)("div", { ref: u, className: r()(eA.d_, { [eA.kS]: h }), children: p }),
            }),
        });
    };
var ev = s(194509),
    ...
    eD = s(88001),
    eO = s(613741);
let ew = "to_premium_home_button",
    eG = "premium home page",
    eL = "gifting_button",
    ek = "payment modal";
function eU(e) {
    ...
    return c
        ? (0, i.jsxs)(i.Fragment, {
              children: [
                  ...
                  (a || !r) && (0, i.jsx)("div", { className: eO.on }),
                  (0, i.jsx)(N.D, {
                      ...
                      children: a
                          ...
                          : r
                            ? ef.intl.format(ef.t["+qqh6g"], { percent: l?.percentage ?? eP.Cq, regularPrice: m })
        ...
        : (0, i.jsx)(eM.A, { variant: void 0, subscriptionTier: eP.pe.TIER_2, interval: u.interval });
}
function eB() {
    let e = (0, z.k5)(),
        t = (0, z.nf)(),
        s = (0, I.Ay)(),
        l = (0, m.bG)([k.A], () => k.A.getPremiumTypeSubscription()),
    ...
    return (0, i.jsxs)("div", {
        ...
        children: [
                ...
                children: [
                    ...
                    (0, i.jsx)(ey.ZP, {
                        featureSet: n?.isPremiumGroupPrimary()
                            ? ey.Nz.PREMIUM_GROUP_PRIMARY
                            : n?.isPremiumGroupMember()
                              ? ey.Nz.PREMIUM_GROUP_MEMBER
                              : u
                                ? ey.Nz.FRACTIONAL_PREMIUM
                                : ey.Nz.DEFAULT,
                    }),
                    u && !d
                        ? (0, i.jsxs)(p.e, {
                                  ...
                                  (0, i.jsx)(h.$, {
                                      ...
                                      onClick: () => {
                                          B.default.track(eN.HAw.PREMIUM_SETTINGS_INTERACTED, {
                                              ...
                                              (0, G.openUserSettings)(O.X.SUBSCRIPTIONS_PANEL);
                                      },
            ...
            (0, i.jsx)("div", {
                className: eO.ah,
                children: (0, i.jsx)("img", { className: eO.ah, alt: "", src: "/assets/3aaa2c2d1874c196.svg" }),
            }),
        ],
    });
}
function eF(e) {
    ...
    return (0, i.jsxs)("div", {
        ...
        style: d,
        children: [
            null != l && (0, i.jsx)("img", { alt: "", className: eO.TB, "aria-hidden": !0, src: l }),
            (0, i.jsxs)("div", {
                className: eO.QT,
                children: [
                    (0, i.jsx)(N.D, {
                    ...
                    (0, i.jsx)(A.E, { className: eO.Oi, style: u, variant: "text-xs/medium", children: s.body }),
...
function eH() {
    return (0, i.jsxs)("div", {
        className: eO.T1,
        children: [
            (0, i.jsx)("img", { className: eO.GY, alt: "", src: "/assets/9f5bdd034cc313ae.svg" }),
            (0, i.jsxs)("div", {
                className: eO.b4,
                children: [
                    (0, i.jsx)(N.D, {
...
let ez = function () {
    ...
    if (e) return (0, i.jsx)(S.uK, {});
    let D = a && null !== l && r,
        O = p.fetched && p.isFractionalPremiumActive,
        w = s?.isPremiumWithPremiumGroup();
    if (!D && !O && !c && !w) return (0, i.jsx)(P.A, { title: ef.intl.string(ef.t.dyq9TR), note: null });
    if ((!D && !O && !w) || c) return (0, i.jsx)(_.y, {});
    let G = !!l?.hasActiveTrial;
    return (0, i.jsx)(R.f5, {
        value: t,
        children: (0, i.jsxs)(i.Fragment, {
            children: [
                ...
                (0, i.jsx)(x.L, {
                    ...
                    children: (0, i.jsx)("div", { ref: f, className: eO._Z }),
                }),
            ],
        }),
    });
