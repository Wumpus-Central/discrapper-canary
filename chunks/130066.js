...
let j = () =>
    ...
    y = () =>
        (0, i.jsxs)(A.A, {
            ...
            children: [
                (0, i.jsx)(l.x, { setting: b.H.PRIVACY_AND_SAFETY_SERVER_SELECTOR, children: (0, i.jsx)(g.A, {}) }),
                (0, i.jsx)(S.A, {}),
                (0, i.jsx)(f.A, {}),
                (0, i.jsx)(E.A, {}),
                (0, i.jsx)(T.A, {}),
...
function L() {
    let e = (0, s.bG)([a.A], () => a.A.getSubsection()),
        t = [
            { title: v.intl.string(v.t["/7xJCF"]), component: O, setting: b.H.CONTENT_SOCIAL_DISCORD_TAB },
            { title: v.intl.string(v.t.YpCiMt), component: c.A, setting: b.H.CONTENT_SOCIAL_CONNECTED_GAMES },
        ];
    return (0, i.jsx)(r.R, {
        header: v.intl.string(v.t["+o1pDZ"]),
        notice: (0, i.jsx)(C.A, { page: C.R.CONTENT_AND_SOCIAL }),
