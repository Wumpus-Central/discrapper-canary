...
var r = n(200651),
    ...
    N = n(652785),
    T = n(921944);
let P = new Set([a.z.CHANNEL_NOTICE_PREMIUM_GUILD_SUBSCRIPTION, a.z.CHANNEL_NOTICE_GUILD_BANNER]);
function j(e) {
    e.stopPropagation();
}
function A(e) {
        ...
        _ = (0, l.Wu)(
            ...
            () =>
                N.XN.filter((e) => {
                    ...
                    return !0 === (null == r ? void 0 : r.channelNoticePredicate(n, u)) && (!P.has(t) || !m);
