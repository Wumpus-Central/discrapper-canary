...
function S(e) {
    var t, n, l, o;
    let { offer: u, offerOptions: m, forceRefetch: x } = e,
        [b, f] = r.useState(!1),
        [g, y] = r.useState(!1),
        [C, O] = r.useState(!1),
        [E, T] = r.useState(!1);
    ...
    let Z = null != P,
        ...
        M = async () => {
            O(!0), Z ? await B({ expiresAt: null }) : await (0, d.a)(u), x(), O(!1);
        },
        B = async (e) => {
            let { expiresAt: t } = e;
            O(!0);
...
function I() {
    let [e, t] = r.useState([]),
        ...
        [L, D] = r.useState([]),
        { entitlements: M, deleteFractionalPremium: B, refreshEntitlementList: U } = (0, f.m)();
    r.useEffect(() => {
        U();
    }, [U]);
