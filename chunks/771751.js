...
function S(e) {
    ...
    let { id: S, expires_at: P, redeemed_at: w, trial_id: I, subscription_trial: k, referrer: R } = u,
        A =
            null !=
            (n =
                null ==
    ...
    let Z = null != P,
        ...
        D = (null == k ? void 0 : k.sku_id) === j.Si.TIER_0,
        M = async () => {
            (N(!0), Z ? await z({ expiresAt: null }) : await (0, d.a)(u), p(), N(!1));
        },
        z = async (e) => {
            let { expiresAt: t } = e;
            N(!0);
