...
function E(e) {
    let t,
        { invite: n, message: a, currentUserId: E, onTransitionToInviteChannel: I, onAcceptInstantInvite: b } = e,
        T = E === a.author.id,
    ...
    let { analyticsLocations: y } = (0, u.Ay)(c.A.INVITE_EMBED),
        ...
        j = r.useCallback(() => {
            ...
            N ? (I(), (e = "transition")) : (b(), (e = "accept")),
                (0, d.he)({ invite: n, action: e, inviter_id: a.author.id, invite_message_id: a.id }, y);
        }, [n, a, y, N, I, b]);
    if (null == S) {
