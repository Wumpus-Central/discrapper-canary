        ...
        a = function (e, t) {
            ...
            var d = function (t, r) {
                    ...
                    for (n = r = r || n; t; ) {
                        ...
                        var I = c.parse(u, d, r);
                        Array.isArray(I)
                            ? Array.prototype.push.apply(i, I)
                            : (null == I.type && (I.type = l), i.push(I)),
                            (r.prevCapture = u),
        ...
        F = function (e) {
            var t = function (n, r) {
                ...
                for (var i = r.key, a = [], o = null, s = 0; s < n.length; s++) {
                    r.key = "" + s;
                    var l = t(n[s], r);
                    "string" == typeof l && "string" == typeof o
                        ? ((o += l), (a[a.length - 1] = o))
                        : (a.push(l), (o = l));
                }
                return (r.key = i), a;
