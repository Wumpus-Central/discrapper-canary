...
function Z(e) {
    ...
    let { guildEvent: N, truncate: P, onActionTaken: k, className: E, isNew: w } = e,
        ...
        A = (0, b.DK)(N),
        B = (0, i.e7)([h.ZP], () => h.ZP.isInterestedInEventRecurrence(I, A), [I, A]),
        U = (0, i.e7)([l.Z], () => l.Z.isLurking(S), [S]),
        z = (0, i.e7)([c.Z], () => c.Z.getStageInstanceByChannel(D), [D]),
        J = (0, i.e7)([s.Z], () => s.Z.getGuild(S), [S]),
        H = (0, i.e7)([o.Z], () => o.Z.getChannel(D), [D]),
        q = (0, i.e7)([g.default], () => g.default.getUser(T), [T]),
        { speakers: K } = (0, v.Z)({
            id: D,
            data: {
                guild: null,
        ...
        X = Q.length,
        Y = (0, i.e7)([u.Z], () => u.Z.can(C.Plq.CONNECT, H), [H]),
        $ = (0, m.ZP)(N),
        ee = null != J,
        en = (0, y.Z)({
            guild: J,
    ...
    return (0, r.jsx)(
        ...
        ((t = (function (e) {
        ...
        })(
            {
                ...
                imageSource: null != M ? (0, x.Z)(N) : void 0,
