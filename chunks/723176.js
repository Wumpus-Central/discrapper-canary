...
class l extends i.Ay.Store {
    ...
    channels = u((e) => new r.Be("guild_channels", r.CV.KvCache, e));
    channelsTemp = u((e) => new r.iW("guild_channels_temp", r.CV.KvCache, e));
    basicChannels = u((e) => new r.Ls("basic_channels", r.CV.KvCache, e));
    syncedBasicChannels = u((e) => new r.Ls("basic_channels_synced", r.CV.KvCache, e));
    cache = u((e) => new r.Ls("cache", r.CV.KvCache, e));
    forceResyncVersion = u((e) => new r.Ls("force_resync_version", r.CV.KvCache, e));
    emojis = u((e) => new r.Be("guild_emojis", r.CV.KvCache, e));
    guilds = u((e) => new r.uh("guilds", r.CV.KvCache, e));
    guildsRequiringDeletedIdsSync = u((e) => new r.uh("guilds_requiring_deleted_ids_sync", r.CV.KvCache, e));
    guildsRequiringChannelSync = u((e) => new r.uh("guilds_requiring_channel_sync", r.CV.KvCache, e));
    messages = u((e) => new r.AR("messages", r.CV.Messages, e));
    stickers = u((e) => new r.Be("guild_stickers", r.CV.KvCache, e));
    guildVersions = u((e) => new r.uh("guild_versions", r.CV.KvCache, e));
    nonGuildVersions = u((e) => new r.uh("non_guild_versions", r.CV.KvCache, e));
    userSettings = u((e) => new r.uh("user_settings", r.CV.KvCache, e));
    readStates = u((e) => new r.Ls("read_states", r.CV.KvCache, e));
    userGuildSettings = u((e) => new r.Ls("user_guild_settings", r.CV.KvCache, e));
    userSearchItems = u((e) => new r.uh("user_search_items", r.CV.KvCache, e));
