...
function H(e) {
                      ...
                      n
                          ...
                          .then((e) => {
                              ...
                              t({
                                  tab: r.APPS,
                                  applicationId: s,
                                  section: (0, I.A)(i, T.type === E.I.APP_DIRECTORY_PROFILE ? i.ABOUT : i.STORE),
                                  skuId: a,
                              });
                          })),
                !0
    ...
    if (null != T && T.type === E.I.ACTIVITY_BOOKMARK)
        return (e) => {
            ...
            let { code: t, url: n } = T,
                ...
                _ = (0, d.A)(),
                { currentChannelId: f, instanceId: E, isCurrentlyInInstance: m, canLaunchInChannel: g } = (0, h.t)(t);
            if (g)
                return (
                    !m &&
                    null != f &&
    ...
    if (null != T && T.type === E.I.QUESTS_EMBED && (0, N.s)())
        return (e) => {
            e?.preventDefault();
    ...
    return H && L?.startsWith("/discovery/quests")
        ? (e) => (e?.preventDefault(), (0, v.navigateToQuestHome)({ fromContent: i.u.QUEST_BADGE }), !0)
