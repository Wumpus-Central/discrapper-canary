...
let y = (e) => {
    let { type: t, guildId: r, closePopout: _ } = e,
        ...
        x = null,
        P = null;
    return (0 === t && (v ? ((x = g.intl.string(g.t.IRxUlJ)), (P = g.intl.string(g.t.fiNVio))) : C ? ((x = g.intl.string(g.t.vW8iUF)), (P = g.intl.string(g.t['50gfOj']))) : O ? ((x = g.intl.string(g.t.vdSOp6)), (P = g.intl.string(g.t.lm1UKi))) : j ? ((x = g.intl.formatToPlainString(g.t.v1ktYW, { min: p.YeM.MEMBER_AGE })), (P = g.intl.string(g.t.BddRzc))) : S && ((x = g.intl.formatToPlainString(g.t['sncw4+'], { min: p.YeM.ACCOUNT_AGE })), (P = g.intl.string(g.t.BddRzc)))), null == E || null == x)
        ? null
        : (0, i.jsxs)(o.VqE, {
