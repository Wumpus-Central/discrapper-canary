...
var i = n(284009),
    ...
    v = n(731854),
    C = n(396574);
let O = new d.Vy("MediaEngineWebRTC");
class R extends l.A {
    Video = N.A;
    ...
    static supported() {
        return (
            ...
            (C.Hz && null != window.AudioContext && null != window.RTCPeerConnection
                ? (n(528416), !0)
                : (O.info("WebRTC is not supported on", o().name, o().version), !1))
        );
    }
    supported() {
        return !0;
    ...
    async _enable() {
        ...
        let e = new E.A(this.getAudioContext());
    ...
    setAudioInputDevice(e) {
        ...
        (this.sourceId = e),
            ...
            this.emit(f.bg.SelectedDeviceChange, v.oh.AUDIO_INPUT, t, e);
    }
    ...
    setAudioOutputDevice(e) {
        ...
        (this.sinkId = e),
            ...
            this.emit(f.bg.SelectedDeviceChange, v.oh.AUDIO_OUTPUT, t, e);
    }
    ...
    setGoLiveSource(e, t) {
        if (null == e) this.eachConnection((e) => e.setDesktopInput(null), t);
            ...
            s()(t === v.x.STREAM, "Go live context is not STREAM");
            let n = !1,
                ...
                ? (0, I.Hv)()
                    ? new Promise((e, t) => {
                          (0, I.zs)()
                              ...
                              .catch((e) => {
                                  (this.maxSupportedProtocolVersion = 0), O.error("Failed to initialize DAVE", e), t(e);
                              });
                      })
        ...
        switch (e) {
            ...
            case f.bg.VoiceActivity:
                null == this.voiceActivityInput &&
                    ((this.voiceActivityInput = new E.A(this.getAudioContext())),
