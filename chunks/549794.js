...
let S = new Set([T.AM, T.eK]),
    x = {
            ...
            async handler(e) {
                ...
                try {
                    ...
                    if (g.isPlatformEmbedded) {
                        let e = (0, a.f)() ? N.MLl.ACTIVITY_POPOUT : null;
                        m.A.focus(e, !0);
                    }
        ...
        [N.e$_.SHARE_LINK]: (0, i.T)(N.e$_.SHARE_LINK, {
            scope: { [C.sm.ANY]: [C.VH] },
            handler(e) {
                let {
                    socket: t,
                ...
                if (null == a) throw new E.A({ errorCode: N.Lw6.INVALID_COMMAND }, "No application.");
                if (!(0, A.n)(t.application, N.gfo.EMBEDDED))
