...
function _(e) {
    ...
    return (function (e, t, n) {
        let {
            ...
            I = e(A, !0, c(t, n), (e, n, r) => {
                ...
                return (
                    ...
                    (f ?? t).embeds.length > 0 &&
                        ((T = e),
                        (p = n ? m(T) : "paragraph" === T[0].type && T[0].content instanceof Array && m(T[0].content))),
                    _ &&
                        (e = (function e(t) {
                            return (
                                t.forEach((t) => {
        ...
        return { hasSpoilerEmbeds: p, hasBailedAst: g, content: I };
...
function p(e, t) {
    if (e instanceof Array) return e.some((e) => p(e, t));
    let n = t(e);
    return null != n
        ? n
        : e.content instanceof Array
          ? p(e.content, t)
          : e.items instanceof Array && e.items.some((e) => p(e, t));
}
function m(e) {
    return p(e, (e) =>
        "spoiler" === e.type ? p(e, (e) => "link" === e.type || "attachmentLink" === e.type || null) : null,
    );
}
