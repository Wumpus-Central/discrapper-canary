...
function y(e) {
    ...
    null == t ||
        ...
        (T[e] = {
            ...
            alwaysOnTop: !!A.isPlatformEmbedded && g[e],
        });
}
function D(e, t, i) {
    let a = e.document,
...
class U extends o.Ay.PersistedStore {
    ...
    isWindowFullyInitialized(e) {
        return null != m[e] && null != S[e] && null != N[e];
    }
...
let w = new U(d.h, {
        POPOUT_WINDOW_OPEN: function (e) {
            ...
            try {
                ...
                throw (
                    (0, u.pj)(e, r ? _.Ue.OutOfProcess : null, {
                        extra: {
                            windowKey: t,
                            totalWindowCount: Object.keys(m).length,
                            features: E,
                            encodedFeatures: O,
            ...
            (r ? p.verbose("Opening out of process overlay window", t) : R.focus(),
                ...
                A.isPlatformEmbedded &&
                    (h.Ay.setAlwaysOnTop(t, I), (g[t] = I), h.Ay.isAlwaysOnTop(t).then((e) => (g[t] = e))),
                C.add(t));
        },
        POPOUT_WINDOW_ADD_STYLESHEET: function (e) {
            let { url: t, integrity: n } = e;
            for (let e of Object.values(m)) null == e || e.closed || D(e, t, n);
        },
        ...
        POPOUT_WINDOW_SET_ALWAYS_ON_TOP: function (e) {
            ...
            A.isPlatformEmbedded &&
                (h.Ay.setAlwaysOnTop(t, n), (g[t] = n), h.Ay.isAlwaysOnTop(t).then((e) => (g[t] = e)));
        },
        LOGOUT: P,
    }),
    G = w;
