                ...
                return (
                    ...
                    void (
                        ...
                        (!(function (e) {
                            ...
                            let s = (0, o.createRoot)(i.getElementById(N));
...
class P extends l.Ay.PersistedStore {
    ...
    isWindowFullScreen(e) {
        let t = T[e];
        return t?.document?.fullscreenElement?.id === N;
    }
    unmountWindow(e) {
        return (
...
let x = new P(u.h, {
        POPOUT_WINDOW_OPEN: function (e) {
            ...
            g.info("Opening popout window", { key: t, encodedFeatures: N });
            let v = window.open(m.BVt.POPOUT_WINDOW, t, N);
            if (null == v) return !1;
            try {
                v.windowKey = t;
            } catch (e) {
            ...
            r ? g.verbose("Opening out of process overlay window", t) : v.focus(),
                (T[t] = v),
                (y[t] = i),
