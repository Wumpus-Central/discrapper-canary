...
let g = new Set(['PageDown', 'PageUp', 'Home', 'End', 'ArrowUp', 'ArrowDown', 'ArrowLeft', 'ArrowRight']),
    m = new Set(['Alt', 'AltGraph', 'CapsLock', 'Control', 'Fn', 'FnLock', 'Hyper', 'Meta', 'NumLock', 'OS', 'ScrollLock', 'Shift', 'Super', 'Symbol', 'SymbolLock']),
    ...
    f = {
        ...
        keydown(e, t) {
            ...
            if ((0, c.VG)(f) || i.fC.isActive() || m.has(t) || p.has(t) || h.has(t)) return !1;
            ...
            return (
                ...
                ('Tab' === t && o.S.hasSubscribers(u.CkL.TEXTAREA_FOCUS) && null != document.querySelector('[data-can-focus="true"]')
                    ...
                    : !(
                      ...
                      ) && void (!e.metaKey && !e.ctrlKey && !g.has(t) && o.S.dispatchToLastSubscribed(u.CkL.TEXTAREA_FOCUS)))
            );
        }
    };
