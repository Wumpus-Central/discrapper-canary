...
let m = new Set(['PageDown', 'PageUp', 'Home', 'End', 'ArrowUp', 'ArrowDown', 'ArrowLeft', 'ArrowRight']),
    ...
    x = {
        ...
        keydown(e, t) {
            var n;
            let x = null === (n = (0, c.uB)(e)) || void 0 === n ? void 0 : n.activeElement;
            if ((0, c.VG)(x) || i.fC.isActive() || g.has(t) || h.has(t) || p.has(t)) return !1;
            let f = null != x && 'BODY' === x.tagName;
            return (
                !((r.Z.keyboardModeEnabled && !f && !/^[a-zA-Z0-9]$/.test(t)) || o.S.hasSubscribers(u.CkL.MODAL_CLOSE) || s.Z.hasLayers()) &&
