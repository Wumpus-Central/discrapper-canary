        ...
        children: [
            ...
            (0, i.jsx)("div", {
                ...
                children: (0, i.jsx)(m.Q, {
                    ...
                    onClick: () => window.open(D.A.getArticleURL(F.MVz.INVALID_INVITES), "_blank"),
                }),
            }),
        ],
    });
...
function ei(e) {
    let { inviteKey: t, location: n, transitionTo: r, login: l } = e,
        ...
        m = (0, d.bG)([O.default], () => O.default.isAuthenticated()),
        v = (0, d.bG)([L.A], () => L.A.defaultRoute),
        N = (0, d.bG)([x.A], () => x.A.isUnderageAnonymous()),
        [j, D] = s.useState(null),
        [B, Q] = s.useState(!1);
    s.useLayoutEffect(() => {
        ...
        er = s.useCallback(() => {
            D(null),
                p.Ay.acceptInvite({
                    ...
                    skipOnboarding: !0,
                    callback: (e) => {
                        (0, I.v)(e), null != e.channel && p.Ay.openApp(t, e.channel.id);
                    },
                }).catch((e) => {
                    if (e instanceof A.Wl || e instanceof A.LG) {
                        let t = (0, P.s)(e.code);
                        D({ code: e.code, message: t });
                    } else D({ code: e.code, message: K.intl.string(K.t.dDZRdy) });
                });
        }, [t, ei]),
        el = s.useCallback(() => {
            r(v);
    ...
    if (
        ((0, f.Ay)(() => {
            let e = O.default.getAnalyticsToken();
            if (
                (null != e &&
                    g.h.dispatch({ type: "SET_ANALYTICS_TOKEN", analyticsToken: e, userId: O.default.getId() }),
                G.default.track(F.HAw.INVITE_VIEWED, { invite_code: t }, { flush: !0 }),
                (0, R.d)("invite"),
                z.VP || U.A.launch("discord://" + F.BVt.INVITE(t), () => void 0),
                !l && N)
            ) {
                let { baseCode: e } = (0, y.y$)(t);
            ...
            s.useEffect(() => {
                ...
                s.useEffect(() => {
                    if (null != t && l === Y && i && !1 === h) {
                        let { channel: e } = t;
                        if (null != e)
                            if (((0, b.C)(H.zY.INVITE_UNCLAIMED), null != t.guild)) {
                ...
                s.useEffect(() => {
                    null != t &&
                        ...
                        G.default.track(F.HAw.INVITE_APP_INVOKED, {
                            ...
                            channel_id: t.channel?.id,
                            inviter_id: t.inviter?.id,
                            user_is_member: null != t.guild && null != w.A.getGuild(t.guild.id),
