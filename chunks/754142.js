...
function D(e, t, n) {
    var r, i, a, o;
    return e
        ? null != (i = null == (r = T(t)) ? void 0 : r.frameRateEncode)
            ? i
            : null
        : null != (o = null == (a = S(t, n)) ? void 0 : a.frameRateDecode)
          ? o
          : null;
}
function w(e, t) {
    ...
    (L =
        null != k && null != Q
            ? es
                ? null == $ || null == (c = $.getOutboundStats())
                    ? void 0
                    : c.find((e) => e.quality === I.y7)
                : null == $
                  ? void 0
                  : $.getInboundStats(Q.ownerId)
            : es
              ? null !=
                (w = i().maxBy(null != (h = null == $ ? void 0 : $.getOutboundStats()) ? h : [], (e) => e.num_frames))
                  ? w
                  : null
              : null != ec
                ? null == $
        ...
        (0, g.q)().then((t) => {
            ...
            let eH = {
                ...
                guild_id: null != (w = null == j ? void 0 : j.guild_id) ? w : null,
                channel_id: null != M ? M : null,
                channel_type: null != (k = null == j ? void 0 : j.type) ? k : null,
                ...
                voice_backend_version:
                    null != (ef = null == (n = _.Z.getRTCConnection()) ? void 0 : n.getVoiceVersion()) ? ef : null,
                rtc_worker_backend_version:
                    null != (e_ = null == (r = _.Z.getRTCConnection()) ? void 0 : r.getRtcWorkerVersion()) ? e_ : null,
                ...
                video_codec:
                    null != (eO = null != V ? V : (0, a.bU)(null == (s = A(es, ed, ec)) ? void 0 : s.codec.name))
                        ...
                        : null,
                video_encoder:
                    null != (ev = null != H ? H : (0, a.lG)(null == (l = T(ed)) ? void 0 : l.encoderImplementationName))
                        ? ev
                        : null,
                video_decoder:
                    null !=
                    (eI = null != Y ? Y : (0, a.z_)(null == (c = S(ed, ec)) ? void 0 : c.decoderImplementationName))
                        ? eI
                        : null,
                ...
                sender_user_id: null != (eC = null == Q ? void 0 : Q.ownerId) ? eC : null,
                stream_region: null != (eN = null == J ? void 0 : J.getRegion()) ? eN : null,
                stream_source_type:
                    es && null != (eR = null == J || null == (h = J.analyticsContext) ? void 0 : h.streamSourceType)
                        ? eR
                        : null,
                num_stream_viewers:
                    null != (eP = null == J || null == (m = J.analyticsContext) ? void 0 : m.numViewers) ? eP : null,
                ...
                video_device_name:
                    null != q ? q : null == (P = f.Z.getVideoDevices()[f.Z.getVideoDeviceId()]) ? void 0 : P.name,
