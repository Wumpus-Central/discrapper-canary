...
function I(e, t, n) {
    ...
    return r.h.dispatch({ type: "OVERLAY_CRASHED", pid: e, error: t, crashType: i, isCrashedDisabled: a });
}
function T(e) {
    let { pid: t, name: n, type: i, data: s, logType: o = a.QJ.Info } = e;
    return r.h.dispatch({
        type: "OVERLAY_ADD_DEBUG_BREADCRUMB",
        breadcrumb: { pid: t, type: i, name: n, data: s, logType: o },
    });
}
function y(e, t, n, r) {
    return T({ pid: e, name: t, type: a.ON.Flux, data: n, logType: r });
}
function S(e, t, n, r) {
    return T({ pid: e, name: t, type: a.ON.OOPModule, data: n, logType: r });
}
function v(e, t, n) {
