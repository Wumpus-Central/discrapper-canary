...
function tP(e) {
    ...
    let ns = a.useCallback(() => {
        ...
        nM = (0, em.A)(tY, tQ),
        nD =
            ((ed = (0, tp.WU)(tQ.getGuildId(), "message_context_menu")),
            (eR = (0, x.bG)([th.A], () => th.A.getConversationForMessage(tQ.id, tY.id) ?? null, [tQ.id, tY.id])),
            (tk = a.useCallback(() => {
                null != tQ.getGuildId() && null != eR && (ty.A.openConversationsSection(), (0, tf.xI)(tQ.id, eR));
            }, [tQ, eR])),
            ed && null != eR
                ? (0, l.jsx)(s.Dr, {
