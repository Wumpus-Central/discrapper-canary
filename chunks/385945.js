...
function u(e) {
    ...
    let g = f(t.fields.text, [r.o.STRING]),
        x = f(t.fields.label, [r.o.STRING]),
        C = f(t.fields.icon, [r.o.MEDIA]),
        A =
            null != C
                ? (0, l.jsx)("img", {
                      alt: "",
        ...
        children:
            null == g && null == x
                ...
                : (0, l.jsxs)(s.E, {
                      ...
                      lineClamp: m,
                      children: [
                          null != A && "left" === p ? (0, l.jsxs)(l.Fragment, { children: [A, " "] }) : null,
                          null != x && "" !== x.value && `${x.value}: `,
                          null != g && "" !== g.value ? g.value : "–",
                          null != A && "right" === p ? (0, l.jsxs)(l.Fragment, { children: [" ", A] }) : null,
                      ],
                  }),
    });
}
