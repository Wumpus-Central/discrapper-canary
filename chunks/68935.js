...
let { API_ENDPOINT: p, MEDIA_PROXY_ENDPOINT: E, PROJECT_ENV: m, ASSET_ENDPOINT: g, CDN_HOST: A } = window.GLOBAL_ENV,
    ...
    R = (e) => (null == e ? null : `${e.name}.${v(e.format_type)}`),
    O = function (e) {
    ...
    b = (e) => null != e.match("development" !== m ? S : y),
    D = (e) => ({ type: _.Z2.PACK, id: e.id, name: e.name, stickers: e.stickers, previewSticker: N(e) }),
    L = (e, t) => (e === h.BJ.ANIMATE_ON_INTERACTION ? t : e !== h.BJ.NEVER_ANIMATE),
    w = (e, t, n, i) => {
