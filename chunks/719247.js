...
function y(e) {
    return (0, p.n2)(e)
        ? null
        : (0, p.kr)(e) && e.author_type === a.i.USER
          ? u.Z.getActivities(e.author_id).find((t) =>
                t.type === h.IIU.PLAYING && (0, f.m9)(e)
                    ? (0, _.cN)(e, t)
                    : !!(t.type === h.IIU.LISTENING && (0, f.dU)(e)) && (0, _.pB)(e, t),
            )
          : void 0;
}
function O(e) {
...
function T() {
    ...
    for (let t of d.Z.getFeeds().values()) {
        let { updatedKeys: i, matchedKeys: o } = O(
    ...
    constructor(...e) {
        super(...e),
            m(
                this,
                "canRenderContent",
                (e) => !(0, p.n2)(e) && (!g.has(e.content_type) || null != this.getMatchingActivity(e)),
            );
    }
}
