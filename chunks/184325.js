    ...
    return (0, r.jsx)('div', {
        ...
        children: n.map((e, t) => {
            ...
            let i = e.id === m.l.ORB_PROFILE_BADGE,
                ...
                v = () => {
                    (e.id === T.i && b.default.track(N.rMx.QUEST_CONTENT_VIEWED, j(x({}, (0, _.mH)(p.jn.QUEST_BADGE)), { is_targeted: !1 })),
