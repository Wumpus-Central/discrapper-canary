...
var r = n(255367),
    ...
    b = n(363987);
let _ = (0, l.Z)((e) => {
    let { participants: t, filteredParticipants: n, selectedParticipant: l, participantsVersion: _, layout: y, onSelectParticipant: C, onContextMenuParticipant: x, onFullscreenParticipant: v, channel: j, hasConnectPermission: O, className: E, inCall: S, showParticipants: P = !0, width: I, height: Z, idle: N, mode: T, popoutWindow: A, awaitingRemoteSessionInfo: w, callContainerDimensions: R } = e;
    i.useEffect(() => {
