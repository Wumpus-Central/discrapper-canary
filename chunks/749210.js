...
let G = {
    ...
    async transitionToGuildSync(e, t, n, r) {
        let i = U((await j(e)).id, n),
            a = t;
        (null == t ? void 0 : t.hasOwnProperty('welcomeModalChannelId')) && null == t.welcomeModalChannelId && (a = w(P({}, t), { welcomeModalChannelId: null != i ? i : void 0 })), (0, c.Z)(A.Z5c.CHANNEL(e, i, r), a), await new Promise(setImmediate);
    },
    deleteGuild: k,
    selectGuild(e) {
        (0, u.a)(e);
