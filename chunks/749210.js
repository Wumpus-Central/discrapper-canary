...
let G = {
    ...
    async transitionToGuildSync(e, t, n, r) {
        let i = U((await j(e)).id, n),
            o = t;
        (null == t ? void 0 : t.hasOwnProperty('welcomeModalChannelId')) && null == t.welcomeModalChannelId && (o = w(P({}, t), { welcomeModalChannelId: null != i ? i : void 0 })), (0, c.Z)(A.Z5c.CHANNEL(e, i, r), o), await new Promise(setImmediate);
    },
    deleteGuild: k,
    selectGuild(e) {
        (0, u.a)(e);
