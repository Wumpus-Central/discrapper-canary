...
function $(e) {
    let { onlyUnread: t, finished: n } = e;
    ((L = !1), t || (k = !0 !== n), (j = !0 !== n), !0 !== n && (x = !0));
}
function ee(e) {
    var t;
    let { onlyUnread: n } = e;
    return null != (null == (t = T.Lk.getCurrentConfig({ location: 'NotificationsInboxStore.canLoadMore' })) ? void 0 : t.notificationCenterVariant) && null != P && !L && (!n || !!j) && k;
}
function et() {
    L = !1;
}
