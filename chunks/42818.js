...
function Y(e) {
    ...
    return (
        (t = o
            ...
            : A.intl.formatToPlainString(A.t.LQLxkZ, { planName: (0, g.Gf)(n.id, !1, a) })),
        (0, r.jsxs)("div", {
            className: i,
            children: [
...
function W(e) {
    ...
    return (
        ...
        i.interval === T.rV.MONTH
            ? (t = n.taxInclusive ? A.t.v9QeOD : A.t.FALkOz)
            : i.interval === T.rV.YEAR
              ? (t = n.taxInclusive ? A.t.ECT4Aw : A.t["0HQxKS"])
