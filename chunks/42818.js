...
function j(e) {
    let { invoice: t, isPrepaidPaymentSource: n } = e,
        ...
        s = (0, c.e7)([p.Z], () => (null != o ? p.Z.get(o.subscriptionPlanId) : null)),
        l = null != o ? o.amount : 0,
...
function U(e) {
    ...
    let c = o.find((e) => !(0, g.Z8)(e.subscriptionPlanId) && e.amount < 0),
        ...
        m = o.filter((e) => e.subscriptionPlanId === S.Xh.PREMIUM_MONTH_GUILD || e.subscriptionPlanId === S.Xh.PREMIUM_YEAR_GUILD).reduce((e, t) => e + t.amount, 0);
    return (0, r.jsxs)(r.Fragment, {
        children: [
            (0, r.jsx)(M, {
                invoiceItem: s,
            ...
            B(G((0, y.j)(i.invoiceItems))).map((e) => {
                ...
                return (0, r.jsx)(
                    M,
                    {
                        ...
                        className: o()({ [A.subscriptionAddedInvoiceItem]: !t || n })
                    },
                    e.id
                );
            }),
...
function Z(e) {
    var t;
    let { proratedInvoice: n, renewalInvoice: i, isTrial: a, isUpdate: o, overrideRenewalDate: s, trialFooterMessageOverride: l } = e,
...
function W(e) {
    let t,
        ...
        h = (0, E.T4)(f, d);
    return (
        (t = o ? (0, g.L7)(n.interval, !0, void 0, void 0, !0, (0, g.Rd)(n.id)) : N.NW.formatToPlainString(N.t.LQLxkZ, { planName: (0, g.Gf)(n.id, !1, a) })),
        (0, r.jsxs)('div', {
            className: i,
            children: [
...
function Y(e) {
    ...
    return (
        ...
        (0, r.jsx)(u.Text, {
            variant: 'text-md/normal',
            children: N.NW.format(t, { price: (0, E.T4)(a.subscriptionPlanPrice, n.currency) })
        })
    );
}
