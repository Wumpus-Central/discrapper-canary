    ...
    v = {
        [b.Etm.VALIDATE_APPLICATION]: {
            ...
            handler(e) {
                let { socket: t } = e,
                    i = t.application.id;
                try {
                    if (null == i) throw new h.Z({ errorCode: b.lTL.INVALID_COMMAND }, "No application.");
                    let e = c.Z.getApplication(i);
                    if (null == e) throw new h.Z({ errorCode: b.lTL.INVALID_ENTITLEMENT }, "SKU does not exist.");
                    let t = e.primarySkuId;
                    if (null == t) throw new h.Z({ errorCode: b.lTL.INVALID_ENTITLEMENT }, "SKU does not exist.");
                    return Promise.race([
                        (function (e, t) {
                            let n = d.Z.isEntitledToSku(u.default.getCurrentUser(), e, t);
                            return null != n
                                ? Promise.resolve(n)
                                : (0, o.yD)(t).then(() => !0 === d.Z.isEntitledToSku(u.default.getCurrentUser(), e, t));
                        })(t, e.id).then((e) => {
                            if (!e)
                                throw new h.Z(
                        ...
                        (0, l.GR)(O).then(() => {
                            throw new h.Z({ errorCode: b.lTL.INVALID_ENTITLEMENT }, "Timed out fetching entitlement.");
                        }),
                    ]);
                } catch (e) {
                    throw (
        ...
        [b.Etm.GET_ENTITLEMENT_TICKET]: {
            ...
            handler(e) {
                let { socket: t } = e,
                    l = t.application.id;
                if (null == l) throw new h.Z({ errorCode: b.lTL.INVALID_COMMAND }, "No application.");
                return i.tn
                    .post({
