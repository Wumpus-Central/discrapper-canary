...
function Z(e) {
    ...
    return (0, s.e7)(
        ...
        () =>
            ...
            (!O.Z.can(C.Plq.MANAGE_CHANNELS, t) &&
                !O.Z.can(C.Plq.MANAGE_ROLES, t) &&
                !O.Z.can(C.Plq.MANAGE_WEBHOOKS, t)) ||
            ((0, b.r8)(t.type) && !O.Z.can(C.Plq.VIEW_CHANNEL, t)) ||
            (t.isGuildVocal() && !O.Z.can(C.Plq.CONNECT, t)) ||
            !b.dF.has(t.type) ||
...
function w(e) {
    let {
        ...
        N = (0, s.e7)([], () =>
            (null == t ? void 0 : t.type) === C.d4z.GUILD_VOICE
                ? x.intl.string(x.t["EE+P0H"])
                : x.intl.string(x.t["0jeAXt"]),
        ),
        Z = l.useRef(null);
...
function A(e) {
    ...
    return (0, i.jsx)(c.u, {
        ...
        children: (0, i.jsx)(u.P3F, {
            className: E.iconItem,
            onClick: () => {
                (0, p.dM)(t.guild_id, t.id, !0, { section: C.jXE.CHANNEL_LIST });
            },
