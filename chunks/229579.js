...
var i = n(430901),
    ...
    p = function (e, t) {
        ...
        var n = getComputedStyle(e),
            ...
            b = i ? 0 : d(n.borderRightWidth),
            T = i ? 0 : d(n.borderBottomWidth),
            ...
            x = s ? A + C : 0,
            L = s ? N + R : 0,
            P = i ? i.width : d(n.width) - x - D,
            w = i ? i.height : d(n.height) - L - O,
            M = P + A + D + C,
            k = w + N + O + R,
            U = Object.freeze({
                devicePixelContentBoxSize: f(Math.round(P * devicePixelRatio), Math.round(w * devicePixelRatio), p),
                borderBoxSize: f(M, k, p),
                contentBoxSize: f(P, w, p),
                contentRect: new r.N(y, g, P, w)
            });
        return o.set(e, U), U;
    },
    h = function (e, t, n) {
