...
function T(e) {
    ...
    let { guild: l, subscriptionsSettings: d } = e,
        m = l.id,
        { nickname: f, nickcolor: h } = (0, o.cj)([_.ZP, g.default], () => {
            var e, t;
        ...
        L = Z === O.y.GUILD_PRODUCTS_PREVIEW ? x.intl.string(x.t["LvXy/P"]) : x.intl.string(x.t.XyqKh4),
        D = P
            ? (0, r.jsxs)(r.Fragment, {
                  children: [
                      (0, r.jsx)(T, {
                      ...
                      E &&
                          (0, r.jsxs)(r.Fragment, {
                              children: [
                                  ...
                                  (0, r.jsx)(I, { onClick: () => (0, y.Z)({ guildId: m }) }),
                              ],
                          }),
                  ],
              })
                        ...
                        children: [
                            (0, r.jsx)("div", {
                                ...
                                children: (0, r.jsx)(s.X6q, {
                                    ...
                                    lineClamp: 2,
                                    children: R
                                        ? x.intl.string(x.t.rtgp7u)
                                        : x.intl.formatToPlainString(x.t.NZeik5, { guildName: l.name }),
                                }),
                            }),
