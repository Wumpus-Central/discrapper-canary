...
function S(e, t, n) {
    let { lastDismissedVersion: r } = T(e),
...
function A(e, t, n) {
    let { lastDismissedAtMs: r, numTimesDismissed: o } = T(e),
        s = (0, a.e7)([c.Z], () => c.Z.getGuildId()),
        l = null;
    return (
        null != e && (l = P(!(0, g.Bh)(e), r, o, t) ? e : null),
        [
            O(l, s, n),
            i.useCallback(
                (e, t) => {
...
function C(e, t, n) {
    let { lastDismissedObjectId: r } = T(e),
        o = (0, a.e7)([c.Z], () => c.Z.getGuildId()),
        s = null;
    if (null != e) {
        let n = !(0, g.Bh)(e);
