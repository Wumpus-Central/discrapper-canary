...
let C = function (e) {
    let {
        ...
        b = (0, c.wj)(x) ? g.BRd.DARK : g.BRd.LIGHT,
        v = (0, d.Gd)(s.id, b),
                        ...
                        (0, o.jsx)(p.Fl, {
                            ...
                            children: (e) => {
                                ...
                                return (0, o.jsx)("img", {
                                    ref: e,
                                    className: a()(
                                        h.partnerBrandingLogotype,
                                        h.partnerBrandingLogotypeWithCosponsor,
                                        n,
                                    ),
                                    alt:
                                        null != (r = null == (t = s.config.cosponsorMetadata) ? void 0 : t.name)
                                            ? r
                                            : "",
                                    src: v.url,
                                    onLoad: f,
