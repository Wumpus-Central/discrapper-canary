...
function j(e) {
    var t, n;
    let i,
        { theme: s, platform: a, integration: m, onRemove: g, locked: p } = e;
    if ((null == m ? void 0 : m.application) != null)
        ...
        i = (0, r.jsx)('img', {
            className: x.verifiedIcon,
            src: e,
            alt: f.NW.formatToPlainString(f.t.rtm15O, { name: a.name })
        });
    }
    return (0, r.jsxs)('div', {
        ...
        children: [
            ...
            (0, r.jsx)(d.Text, {
                ...
                children: f.NW.format(f.t.Nj0a3t, { platformName: null != (n = null == a ? void 0 : a.name) ? n : null == m || null == (t = m.application) ? void 0 : t.name })
            }),
            (0, r.jsx)(d.zxk, {
...
function N(e) {
    var t, n, s;
    let { inputRef: l, existingPendingConfiguration: a, locked: o, onConfigurationChange: c, platform: u, applicationId: m, metadataField: g, operator: p } = e,
        b = null != (n = null == a ? void 0 : a.index) ? n : -1,
        j = null != p ? p : h.iO.GREATER_THAN,
        N = Math.round(Number(null != (s = null == a || null == (t = a.configuration) ? void 0 : t.value) ? s : 0));
...
function _(e) {
    let { titleText: t, fieldText: n, metadataField: s, existingPendingConfiguration: l, platform: a, applicationId: o, onConfigurationChange: c, locked: u } = e,
        m = i.useId();
    return (0, r.jsxs)(
        'div',
        {
...
function v(e) {
    let { titleText: t, fieldText: n, fieldTextHook: s, metadataField: l, existingPendingConfiguration: a, platform: o, applicationId: c, onConfigurationChange: u, locked: m, operator: g } = e,
        p = i.createRef(),
        b = (null == a ? void 0 : a.configuration) != null,
        j = (0, r.jsx)(
            N,
            {
                inputRef: p,
...
function P(e) {
    let t,
        { configurationItems: n, onConfigurationChange: i, locked: s, integrations: l } = e,
        a = (0, m.ZP)();
