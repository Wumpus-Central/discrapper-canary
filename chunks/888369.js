    ...
    if (null == n) {
        ...
        for (let t in f) {
            let n = f[t],
                ...
                { mentionCount: c, unread: p, isMentionLowImportance: _ } = g.ZP.getGuildChannelUnreadState(n, u, o, a, l),
                h = c > 0;
            if (!h && a) continue;
            let m = !l && (!a || h) && p;
            if ((m || h) && j(n, c, u) && (m && ((r.unreadByType[I.W.CHANNEL] = !0), (r.unreadChannelId = t)), h)) {
                ...
                _ ? (r.lowImportanceMentionCount += e) : (r.highImportanceMentionCount += e),
                    (r.mentionCounts[n.id] = {
                        count: e,
