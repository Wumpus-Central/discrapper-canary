...
function H(e, t) {
    ...
    if (
        (t.forEach((e) => {
            ...
            (null !== n && !u && E.ZP.hasUnread(t.id) && k(t, a, !0) && ((u = !0), (i.unreadChannelId = t.id)),
                a > 0 && k(t, a)
    ...
    if (null == n) {
        ...
        for (let t in f) {
            let n = f[t],
                ...
                { mentionCount: c, unread: _, isMentionLowImportance: p } = E.ZP.getGuildChannelUnreadState(n, u, a, o, l),
                h = c > 0;
            if (!h && o) continue;
            let m = !l && (!o || h) && _;
