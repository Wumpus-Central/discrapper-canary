...
function x(e) {
    ...
    return (
        !(
            ...
            (!e.isPrivate() && (L(e, t, (0, o.r1)(e.guild_id)) || !m.Z.can(e.accessPermissions, e)))
        ) &&
...
function F(e, t, n) {
    return (
        ...
        (t.unread !== n.unread ||
            ...
            ((N[null != e ? e : A] = t),
            null != e && (t.unread ? C.add(e) : C.delete(e)),
            R++,
            D(null != e ? e : A),
            Z(t, n),
            !0)
...
function V(e, t) {
    ...
    if (
        (t.forEach((e) => {
            ...
            null !== n && !o && g.ZP.hasUnread(t.id) && x(t, r, !0) && ((o = !0), (i.unreadChannelId = t.id)),
                r > 0 && x(t, r)
...
function Y(e, t) {
    ...
    return (
        ...
        ((N[null != n ? n : A] = r),
        null != n && (r.unread ? C.add(n) : C.delete(n)),
        R++,
        D(null != n ? n : A),
        Z(r, i),
        !0)
