...
let F = {
    ...
    maybeConfirmFriendRequestAccept: function (e) {
        let { userId: n, applicationId: t, location: i, onConfirm: o, onCancel: c, onFinally: a } = e,
            ...
            u = p.getConfig({ location: "maybeConfirmFriendRequestAccept" }).enabled,
            s = y.A.isStranger(n);
        return null == t && (l || u) && !1 !== s
            ? s
                ...
                : void T({ userId: n, applicationId: t, location: i })
                      .then((e) => {
                          N(e, { userId: n, applicationId: t, location: i, onConfirm: o, onCancel: c }) || o?.();
                      })
                      .catch((e) => {
                          N(e, { userId: n, applicationId: t, location: i, onConfirm: o, onCancel: c });
                      })
                      .finally(() => {
                          a?.();
                      })
