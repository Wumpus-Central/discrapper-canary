...
function i() {
    ...
    function P(e, n) {
        ...
        if (i === t)
            return (
                ...
                ("throw" === r &&
                    e.iterator.return &&
                    ((n.method = "return"), (n.arg = t), P(e, n), "throw" === n.method)) ||
                    ("return" !== r &&
                        ((n.method = "throw"),
                        (n.arg = TypeError("The iterator does not provide a '" + r + "' method")))),
                b
            );
        ...
        return a
            ? a.done
                ? ((n[e.resultName] = a.value),
                  ...
                  b)
                : a
            : ((n.method = "throw"), (n.arg = TypeError("iterator result is not an object")), (n.delegate = null), b);
    }
    function w(e) {
        var t = { tryLoc: e[0] };
    ...
    return (
        ...
        (O.displayName = f(v, d, "GeneratorFunction")),
        ...
        (n.mark = function (e) {
            return (
                Object.setPrototypeOf ? Object.setPrototypeOf(e, v) : ((e.__proto__ = v), f(e, d, "GeneratorFunction")),
        ...
        (L.prototype = {
            ...
            abrupt: function (e, t) {
                ...
                return (
                    (o.type = e),
                    (o.arg = t),
                    i ? ((this.method = "next"), (this.next = i.finallyLoc), b) : this.complete(o)
                );
            },
