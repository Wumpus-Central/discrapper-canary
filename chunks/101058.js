...
function E(e) {
    let { userId: t, avatarId: n, storageHash: a, canAnimate: u = !1, allowWebp: l = !0, size: o } = e,
        { CDN_HOST: E } = window.GLOBAL_ENV,
        A = null != E ? `https://${E}` : location.protocol + window.GLOBAL_ENV.API_ENDPOINT,
...
function A(e) {
    ...
    return o.intl.formatToPlainString(n === l.E.EDITED_ARCHIVED_ASSET ? o.t.eC2sZi : o.t.DYil93, {
        name: i,
        dateTime: r,
    });
}
...
function p(e) {
    let { assetOrigin: t = l.E.NEW_ASSET, imageUri: n, description: i, originalAsset: r, originalMd5: a } = e;
    switch (t) {
        case l.E.NEW_ASSET:
