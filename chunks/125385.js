...
class d {
    ...
    checkForLeaks(e, t) {
        var n, r, i, a;
        let o =
            (null != (n = null == (i = this._subscriptions[e]) ? void 0 : i[t]) ? n : 0) -
            (null != (r = null == (a = this._unsubscriptions[e]) ? void 0 : a[t]) ? r : 0);
        o > 5 &&
            new s.A("GuildMemberSubscriptions").warn(
                "GuildMemberSubscriptions.subscribe(...): Potential reference leak! (".concat(o, " subscriptions)"),
            );
    }
    ...
    constructor(e) {
        c(this, "_subscriptions", {}),
            c(this, "_unsubscriptions", {}),
            c(this, "_onChange", void 0),
            c(this, "_unsubscribe", new a.J_(u, () => this.flushUnsubscriptions())),
            (this._onChange = e);
    }
}
