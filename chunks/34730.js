...
class u {
    ...
    status(t) {
        return void 0 === t
            ? this.data.status
            : (t ? (this.data.status = (0, l.checkEnum)(r, t)) : (this.data.status = null), this);
    }
    type(t) {
        return void 0 === t
            ? this.data.type
            : (t ? (this.data.type = (0, l.checkEnum)(n, t)) : (this.data.type = null), this);
    }
    delegatedTo(t) {
        return void 0 === t
            ...
            : (t
                  ? ("string" == typeof t
                        ? (this.data.delegatedTo = new u((0, l.checkNameAndMail)("delegatedTo", t), this.event))
                        : t instanceof u
                          ? (this.data.delegatedTo = t)
                          : (this.data.delegatedTo = new u(t, this.event)),
                    (this.data.status = r.DELEGATED))
                  : ((this.data.delegatedTo = null), this.data.status === r.DELEGATED && (this.data.status = null)),
              this);
    }
    delegatedFrom(t) {
        return void 0 === t
            ...
            : (t
                  ? "string" == typeof t
                      ? (this.data.delegatedFrom = new u((0, l.checkNameAndMail)("delegatedFrom", t), this.event))
                      : t instanceof u
