...
function C(e) {
    let { guild: t } = e,
        n = (0, d.A)({ scrollPosition: p._F.GUILD_TAG });
    return (0, i.jsx)("div", {
...
function S(e) {
    ...
    return n.has(_.D.AUTOMOD_QUARANTINED_USERNAME_OR_GUILD_NICKNAME) || n.has(_.D.AUTOMOD_QUARANTINED_BIO)
        ? (0, i.jsx)(x, { guild: t })
        : n.has(_.D.AUTOMOD_QUARANTINED_SERVER_TAG)
          ? (0, i.jsx)(C, { guild: t })
          : (0, i.jsx)(x, { guild: t });
}
