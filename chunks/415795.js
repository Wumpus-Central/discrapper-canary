...
class T extends (r = s.Component) {
    ...
    renderName() {
        ...
        return (
            ...
            null != r &&
                (t = (0, i.jsx)('span', {
                    className: C.note,
                    children: (0, d.F6)(r, x.default, N.Z)
                })),
            (0, i.jsxs)('div', {
                className: C.name,
                children: [
                    (0, i.jsx)('span', {
                        className: C.match,
                        children: (0, d.F6)(s, x.default, N.Z)
                    }),
                    e,
    ...
    getAccessibilityLabel() {
        var e;
        let { channel: t } = this.props,
            n = null == (e = b.Z.getGuild(this.props.channel.guild_id)) ? void 0 : e.name,
            r = (0, d.F6)(t, x.default, N.Z),
            i = (0, m.Z)(t);
        ...
        return (
            ...
            (0, i.jsxs)('div', {
                ...
                children: [
                    (0, i.jsx)('span', {
                        className: C.match,
                        children: (0, d.F6)(n, x.default, N.Z)
                    }),
                    e
                ]
            })
