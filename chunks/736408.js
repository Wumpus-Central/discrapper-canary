...
function c(e) {
    let { itemId: t, hash: n, containerWidth: c = 1024 } = e,
        ...
        s = a.$k ? 'webp' : 'png';
    return null != l
        ? ''.concat(location.protocol, '//').concat(l, '/app-assets/application-directory/collection-items/').concat(t, '/').concat(n, '.').concat(s, '?').concat(_)
        : ''
              .concat(location.protocol)
              .concat(r)
              .concat(o.ANM.APPLICATION_DIRECTORY_COLLECTION_ITEM_IMAGE(t, n, s), '?')
              .concat(_);
}
