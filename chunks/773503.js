...
function E(e) {
    ...
    return (0, i.jsxs)("div", {
        ...
        children: [
            ...
            s,
            (0, i.jsx)(c.E, { className: f.PW, color: "text-overlay-light", variant: "text-sm/normal", children: r }),
        ],
    });
}
function p(e) {
    let { user: t, guildId: n, channelId: r } = e,
        s = (0, h.tx)(n, r, t);
    return null == t ? null : (0, i.jsx)(E, { avatarURL: t.getAvatarURL(n, 24, !1), avatarLabel: s, text: s });
}
function m(e) {
    ...
    let s =
        null != t.emojiId || null != t.emojiName
            ...
            : null;
    return (0, i.jsx)(E, { avatarURL: n.getAvatarURL(r, 24, !1), avatarLabel: n.username, text: t.name, leading: s });
}
let g = r.memo(function (e) {
    ...
    return (0, i.jsxs)("div", {
        ...
        children: [
            t.map((e) => {
                let t = u[e];
                return (0, i.jsx)(p, { user: t, guildId: s, channelId: l }, e);
            }),
            n.map((e) => {
                let t = u[e.userId];
                return (0, i.jsx)(
