...
function b(e) {
    ...
    if (n.isForumPost()) return (0, i.jsx)(_.A, { channel: n });
...
function j(e) {
    let { channel: t, showingBanner: n } = e,
        ...
        u = A.Ay.useUserTag(d),
        { canManageRoles: _, canReadMessageHistory: E } = (0, l.cf)([h.A], () => ({
            canManageRoles: h.A.can(v.xBc.MANAGE_ROLES, t),
            canReadMessageHistory: h.A.can(v.xBc.READ_MESSAGE_HISTORY, t),
        }));
    ...
    if (t.isMultiUserDM())
        ...
        else if (t.hasFlag(N.lx.IS_JOIN_REQUEST_INTERVIEW_CHANNEL)) return (0, i.jsx)(p.A, { channel: t });
        else return (0, i.jsx)(f.A, { channel: t, children: T.intl.format(T.t.MFwcqO, { name: r }) });
    return E
        ? (0, i.jsx)(b, { channel: t, canManageRoles: _ })
        : (0, i.jsx)(g.Ay, {
              channelId: t.id,
