...
function F(e) {
    let { canManageRoles: t, channel: n } = e,
        l = t && (0, h.Ae)(n),
        a = (0, s.bG)([C.Ay], () => null != n.guild_id && n === C.Ay.getDefaultChannel(n.guild_id), [n]);
...
function H(e) {
    let { channel: t, showingBanner: n } = e,
        ...
        C = T.Ay.useUserTag(_),
        { canManageRoles: v, canReadMessageHistory: M } = (0, s.cf)([x.A], () => ({
    ...
    if (m === P.rbe.DM) {
        ...
        } else e = (0, i.jsx)(N.A, { userId: t.getRecipientId(), channel: t, showingBanner: n });
        return (0, i.jsxs)(R.A, {
            channel: t,
            user: _,
            children: [
                null != _ &&
                    !_.isProvisional &&
                    (0, i.jsx)(a.Heading, { variant: "heading-xl/medium", className: G.SX, children: C }),
    ...
    if (t.isMultiUserDM())
        if (t.isManaged())
            return (0, i.jsxs)(I.Ay, {
                channelId: t.id,
                children: [
                    (0, i.jsx)(I.cr, { children: k.intl.format(k.t.I3R7Vn, { channelName: h }) }),
                    (0, i.jsx)(I.j1, { children: k.intl.string(k.t.M8Ao6I) }),
                ],
            });
    ...
    return M
        ...
        : (0, i.jsx)(I.Ay, {
              channelId: t.id,
              children: (0, i.jsx)(I.j1, { children: k.intl.format(k.t.hPVEQG, { channelName: h }) }),
          });
}
