...
let Q = W.Ay.getEnableHardwareAcceleration(),
    ...
    J = l.memo(function (e) {
        let { channel: t, sectionId: s, userId: a, guildOwnerId: r } = e,
            ...
            _ = (0, h.bG)(
                [M.A],
                () => (A?.colorRoleId != null ? M.A.getRole(t.guild_id, A.colorRoleId)?.name : void 0),
                [t.guild_id, A],
            ),
            m = (0, h.bG)([w.default], () => w.default.getUser(a)),
            g = (0, h.bG)([w.default], () => w.default.getCurrentUser()),
            p = m?.id === g?.id,
            f = (0, h.bG)([D.A, U.A], () => (p ? U.A.getStatus() : D.A.getStatus(a, t.guild_id))),
            I = (0, h.bG)([D.A], () => D.A.isMobileOnline(a)),
            C = (0, h.yK)([D.A, U.A], () => (p ? U.A.getActivities() : D.A.getActivities(a, t.guild_id))),
            b = (0, h.bG)([O.A], () => O.A.getAnyStreamForUser(a)),
            S = (0, d.rm)(a),
            T = (0, h.bG)([R.A], () => R.A.canUserViewChannel(t.id, s, a)),
            y = m?.id != null && m.id === r,
            j = l.useCallback(
                (e) => {
                    null != m &&
...
function et(e) {
    ...
    let R = o().omit(v.containerProps, ["ref"]),
        L = H.wT(f);
    return (0, i.jsx)(b.f5, {
        value: x,
