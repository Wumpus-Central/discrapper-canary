...
function ta(e) {
    let { filteredClips: t, totalClipCount: l, onClipClick: a, onEdit: s, isLoading: r } = e,
        ...
        L = i.useMemo(() => f.map((e) => Math.ceil(e.clips.length / v)), [f, v]),
...
function tE(e) {
    let { closePopout: t } = e,
        ...
        [d, h] = i.useState(() => (l?.preset === "custom" ? tA(l.before) : null)),
        x = i.useMemo(
            () => [
                            ...
                            children: [
                                x.map((e) =>
                                    (0, n.jsx)(
                                        tf.D,
                                        {
                                            className: s()(tP.zD, f === e.key && tP.pH),
                                            onClick: () => y(e.key),
                                ...
                                (0, n.jsxs)(tf.D, {
                                    className: s()(tP.zD, tP.Kl, (r || "custom" === g) && tP.pH),
                                    onClick: v,
                                    "aria-expanded": r,
                                    children: [
                                        (0, n.jsx)($.E, {
...
function lh(e) {
    ...
    let [ev, eb] = i.useState(null != q ? x.ip.ENTERED : x.ip.HIDDEN),
        eC = i.useRef(null),
