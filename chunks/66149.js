...
function S(e) {
    ...
    return (0, i.jsx)(A.A, {
        compact: a,
        role: "group",
        childrenMessageContent: (0, i.jsx)(p.A, {
            compact: a,
            className: C.L9,
            iconNode: g,
    ...
    return (0, i.jsxs)("div", {
        ...
        children: [
            t.hasUnread && (!u || t.content[0]?.type === f.TZK.DIVIDER)
                ? (0, i.jsx)(_.A, { isUnread: !0, id: r }, "divider")
                : null,
            (0, i.jsx)(
                S,
                { count: p, compact: a, expanded: u, onClick: A, collapsedReason: o, canUncollapse: c },
            ...
            u
                ? t.content.map((e, l) => {
                      if (e.type === f.TZK.DIVIDER && l > 0) {
                          ...
                          return (0, i.jsx)(_.A, { isUnread: !0, isBeforeGroup: e, id: r }, "divider");
                      }
