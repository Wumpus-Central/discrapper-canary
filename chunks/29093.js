...
function h(e) {
    let { loginStatus: t, authBoxClassName: n, onSubmit: s, onCancelAccountDeletion: h } = e,
        ...
        g = m ? d.intl.string(d.t["j3rC+U"]) : d.intl.string(d.t.ZFWofo),
        p = m ? d.intl.string(d.t["6eNTWe"]) : d.intl.string(d.t["pCBti+"]);
    return (0, i.jsx)(o.Ay, {
        tag: "form",
        onSubmit: s,
        className: n,
        children: (0, i.jsxs)(l.F, {
            component: (0, i.jsx)(o.hE, { className: _.QB, children: g }),
            children: [
                (0, i.jsx)(o.tK, { className: _.SX, children: p }),
                (0, i.jsxs)(o.eB, {
                    children: [
