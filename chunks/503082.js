...
class h {
    ...
    breakToNewRow() {
        ...
        (this.nextX = 0),
            (this.nextY += this.tallestImageHeight + _),
            (this.tallestImageHeight = 0),
    ...
    getImage(e, t, n) {
        ...
        (this.nextX + t.width + _ > this.MAX_ROW_WIDTH || this.nextY + t.height + _ > this.MAX_HEIGHT) &&
...
class m extends o.Z {
    ...
    drawRoundedRect(e) {
        ...
        if (null == this.context) return;
        let { x: i, y: o, w: a, h: s } = e;
        r && this.setContextProperties(),
            this.context.beginPath(),
            this.context.roundRect(i, o, a, s, t),
    ...
    drawText(e, t, n) {
        ...
        if (
            (this.font.truncate === s.GX.None && f(e, t),
            this.font.truncate === s.GX.Truncate && f((e = _(e)), t),
        ...
        let r = this.font.weight,
            i = (e, t, n) => {
                ...
                return (
                    ...
                    (i = Array.isArray(e.content) ? o(e.content, t, n) : this.drawText(e.content, t, n)),
                    ...
                    i = d(
                        c(
                            {},
                            {
                                ...
                                y:
                                    (o.h - e) *
                                    (null != (u = null == r || null == (l = r.focus) ? void 0 : l.y) ? u : 0.5),
                            },
                        ),
                        {
                            w: a.width,
                    ...
                    i = d(
                        c(
                            {},
                            {
                                x:
                                    (a.width - e) *
                                    (null != (_ = null == r || null == (f = r.focus) ? void 0 : f.x) ? _ : 0.5),
                                y: 0,
                            },
                        ),
                        {
    ...
    drawCachedImage(e, t, n) {
        ...
        return null == l
            ...
            : (this.context.drawImage(
                  ...
                  null != (o = null == n ? void 0 : n.h) ? o : l.h,
              ),
              s.vP.Success);
    }
    drawCroppedCachedImage(e, t, n) {
        ...
        let { x: a, y: l, w: c, h: u } = t,
            { x: d, y: f, w: _, h: p } = n;
        return (
            this.context.drawImage(this.offscreenCanvasCache.canvas, o.x + a, o.y + l, c, u, d, f, _, p), s.vP.Success
        );
    }
    drawPath(e, t) {
    ...
    drawGradientRect(e, t, n, r) {
        return null == this.context
            ? s.vP.Failure
            : (this.setGradientFillStyle(e, t, n), this.drawRect(r, !0, !1), s.vP.Success);
    }
    drawRoundedGradientRect(e, t, n, r, i) {
        return null == this.context
            ? s.vP.Failure
            : (this.setGradientFillStyle(e, t, n), this.drawRoundedRect(r, i, !0, !1), s.vP.Success);
    }
    clip(e, t) {
        if (null == this.context) return;
        this.context.save();
    ...
    constructor(e, t) {
        super(e, t),
            l(this, "canvas", void 0),
            l(this, "context", void 0),
            l(this, "offscreenCanvasCache", void 0),
