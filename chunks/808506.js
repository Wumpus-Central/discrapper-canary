...
function eM(e) {
    ...
    n.append('build_id', '6e3179a5d835db7221e611825614d8365790e878'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
