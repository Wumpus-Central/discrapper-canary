...
function ek(e) {
    ...
    (n.append('build_id', '777176c442ab6594d302ccd8f0c029032e2ff4d4'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function eM(e) {
