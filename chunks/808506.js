...
function ek(e) {
    ...
    n.append('build_id', '35472b8b856a18cde7269a726ddf8066ad790f3b'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
