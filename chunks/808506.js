...
function ek(e) {
    ...
    (n.append('build_id', 'b304dd24fa96798594c03b1c0d519d4221e2eb77'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function eM(e) {
