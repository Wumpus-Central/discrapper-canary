...
function eM(e) {
    ...
    n.append('build_id', '6ffa232b9925c4952a4ef40be379ef5366d090f3'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
