...
function eN(e) {
    ...
    n.append('build_id', 'af46acf8999afd009fc1fed03823b09017142bb7'), n.append('rpc', String(t)), n.append('rpc_auth_token', z), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eC(e) {
