...
function eY(e) {
    ...
    r.append('build_id', '461bc3f4c590321e1e590dacab721131bfcf79a1'), r.append('rpc', String(n)), r.append('rpc_auth_token', ef), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function eW(e) {
