...
function ek(e) {
    ...
    (n.append('build_id', '4736671c2b7c3e97c1b14ca828231645fa1432d6'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function eM(e) {
