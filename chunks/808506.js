...
function eD(e) {
    ...
    n.append('build_id', '7abe843a6a09277ebc4ac986e3dda7981320de37'), n.append('rpc', String(t)), n.append('rpc_auth_token', z), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eL(e) {
