...
function eM(e) {
    ...
    (n.append('build_id', 'c2d799f4ee6e3c9fc402a15b3cddd71c14136d69'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
