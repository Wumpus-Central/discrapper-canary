...
function eM(e) {
    ...
    (n.append('build_id', 'e6526bd5e604f617487349258824daff38d33bf1'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
