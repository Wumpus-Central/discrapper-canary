...
function eM(e) {
    ...
    n.append('build_id', 'dfba403678426ed2bf925b53d01b628710dc19c8'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
