...
function eM(e) {
    ...
    n.append('build_id', '6d1f16970e1bee830e128ddf44e3390edf5e3b6b'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
