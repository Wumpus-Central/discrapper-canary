...
function eM(e) {
    ...
    n.append('build_id', '3f019c65c35cb80562b0d6d26351e988bdde94f2'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
