...
function ek(e) {
    ...
    n.append('build_id', '6fefe26d0dc52eda04d48a98758c750035a05743'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
