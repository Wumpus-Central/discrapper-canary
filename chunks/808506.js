...
function eM(e) {
    ...
    n.append('build_id', 'c8cbb1e47afdcc221b04f03e1209e83bf56106f0'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
