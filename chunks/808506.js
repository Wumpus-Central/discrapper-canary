...
function eM(e) {
    ...
    (n.append('build_id', 'c343244614ce9162b4b10a90f06edab345136375'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
