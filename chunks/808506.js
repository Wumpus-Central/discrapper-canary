...
function ek(e) {
    ...
    n.append('build_id', 'a5cb09580db5cb03bbed831241dbab118663c990'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
