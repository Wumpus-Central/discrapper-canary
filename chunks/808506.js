...
function ek(e) {
    ...
    n.append('build_id', 'df763e5446d4f1cc9869cafee33990ec517ade89'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
