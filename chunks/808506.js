...
function ek(e) {
    ...
    (n.append('build_id', '3184ac37063e2192c31c8096cf96a4017fc67032'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function eM(e) {
