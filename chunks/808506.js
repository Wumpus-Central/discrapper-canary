...
function ek(e) {
    ...
    (n.append('build_id', 'd82f96309a68a92106fec44ec43428e5551e1964'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function eM(e) {
