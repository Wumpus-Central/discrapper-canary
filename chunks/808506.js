...
function ek(e) {
    ...
    n.append('build_id', '6c86867c6c01449ac2e168f9b8982aefcd35b642'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
