...
function ek(e) {
    ...
    n.append('build_id', 'c3d4cb5bc49add064fc5400c7687b3f9ea7a4315'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
