...
function eM(e) {
    ...
    n.append('build_id', '46d08e74920056c65b298d14bc4a9a9da878868d'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
