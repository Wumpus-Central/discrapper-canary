...
function ek(e) {
    ...
    n.append('build_id', 'af8a5b8789b47332213c16107d5be098f02bf75a'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
