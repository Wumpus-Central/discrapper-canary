...
function ek(e) {
    ...
    n.append('build_id', 'deaf4c08ebda86f86693729106124f3e9fa7f428'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
