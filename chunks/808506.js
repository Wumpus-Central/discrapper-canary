...
function ek(e) {
    ...
    n.append('build_id', 'c0374118d13ffb8fcf776ffc428dced7272915da'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
