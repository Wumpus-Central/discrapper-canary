...
function ek(e) {
    ...
    (n.append('build_id', 'd6945b574e23104b5186eb229fec89ebff4ae8b9'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function eM(e) {
