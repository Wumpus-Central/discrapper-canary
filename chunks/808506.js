...
function ek(e) {
    ...
    n.append('build_id', 'd2aa921d4ebcbb03a4f4aecbfa23f2b6384ce585'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
