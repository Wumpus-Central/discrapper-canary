...
function eM(e) {
    ...
    (n.append('build_id', '3259689eb5967ecde624dcdba31120d862a523f5'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
