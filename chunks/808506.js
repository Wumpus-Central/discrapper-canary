...
function eV(e) {
    ...
    r.append('build_id', 'b278f09301442420c906ee4af530560a95b1764d'), r.append('rpc', String(n)), r.append('rpc_auth_token', ec), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function ej(e) {
