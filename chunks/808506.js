...
function ex(e) {
    ...
    n.append('build_id', '6bf18f0f533bf3f7d388796c9abd4fdaf76758bc'), n.append('rpc', String(t)), n.append('rpc_auth_token', J), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
