...
function eM(e) {
    ...
    n.append('build_id', '69c4368e2cb579dbbccaa8fc60c581471f584a5b'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
