...
function eM(e) {
    ...
    (n.append('build_id', 'f2ac2483e0ae34f0cecc3362a99fda1c8265950d'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
