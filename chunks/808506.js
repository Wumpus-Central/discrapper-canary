...
function ek(e) {
    ...
    n.append('build_id', '24ecf6e59ac333bf78dc2b2328db21a65f66b053'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
