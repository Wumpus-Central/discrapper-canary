...
function ek(e) {
    ...
    n.append('build_id', '80879d5679b43457ec8ef64516cae2070846dc24'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
