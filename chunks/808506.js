...
function eM(e) {
    ...
    n.append('build_id', '3cdec780fbc084f279a27469e3ea4f271de98ea3'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
