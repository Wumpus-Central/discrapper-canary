...
function eM(e) {
    ...
    (n.append('build_id', 'fe8a0559e20e88f742d5f847cb6c447721446329'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
