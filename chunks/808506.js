...
function ek(e) {
    ...
    n.append('build_id', '3aef3aed3018906c87311b5063b962ed0765b6de'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
