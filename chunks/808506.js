...
function eM(e) {
    ...
    (n.append('build_id', '2dc3603ff72320dfc3b8ed4dd261abc44431fd7c'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
