...
function eM(e) {
    ...
    (n.append('build_id', '7b33deaef9c27b44ea27087a912e9c16f5a02dd1'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
