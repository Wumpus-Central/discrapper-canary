...
function eM(e) {
    ...
    (n.append('build_id', 'a1705b210ee437bb0f0d77c27531b64e39bd25ad'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
