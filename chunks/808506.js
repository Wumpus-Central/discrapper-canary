...
function ek(e) {
    ...
    n.append('build_id', 'cd4b52c7182a88ab84a929ece42624572d454616'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
