...
function ex(e) {
    ...
    n.append('build_id', '4418ab4a56b2b912c6ded1f47f96eedd42e4cced'), n.append('rpc', String(t)), n.append('rpc_auth_token', J), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
