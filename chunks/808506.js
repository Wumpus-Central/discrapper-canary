...
function eS(e) {
    ...
    n.append('build_id', '61304b3a0dd18fe8a4e28c4576ede0ea08581634'), n.append('rpc', String(t)), n.append('rpc_auth_token', W), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eA(e) {
