...
function ex(e) {
    ...
    n.append('build_id', '352985abf5af6ea57eeabd027f755d43ac6a59bd'), n.append('rpc', String(t)), n.append('rpc_auth_token', J), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
