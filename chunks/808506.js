...
function eM(e) {
    ...
    (n.append('build_id', '9ffb00c3018f10dd9ef531498dfe58997b026efa'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
