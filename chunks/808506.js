...
function eM(e) {
    ...
    n.append('build_id', 'd47a907383b58e2de2ad12018d895bb8fe3fad80'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
