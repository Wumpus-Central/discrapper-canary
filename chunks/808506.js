...
function eM(e) {
    ...
    n.append('build_id', '438b5bdbedf1d0392b83e3c64f97862a949685cb'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
