...
function eM(e) {
    ...
    n.append('build_id', '290efc321dc02864b24ba181c1f959260c852e58'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
