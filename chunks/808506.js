...
function ek(e) {
    ...
    n.append('build_id', '7ca0ac9038cc5412c5096c77231b0bd028d006f0'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
