...
function ek(e) {
    ...
    n.append('build_id', '9265a0948eb04aedbb71c0d3332d8b769035639d'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
