...
function ek(e) {
    ...
    (n.append('build_id', 'b7078ecf67c106e7cf47cd468fe6ec4efe9b64af'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function eM(e) {
