...
function ek(e) {
    ...
    n.append('build_id', 'cdc84e40d094b4cae3bd3cea5f3dca07f9685d5a'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
