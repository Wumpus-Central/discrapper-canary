...
function ex(e) {
    ...
    (n.append('build_id', '48d9241637c4d83ae1d7fbd6698b88d67a45ef0b'), n.append('rpc', String(t)), n.append('rpc_auth_token', J), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
