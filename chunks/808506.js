...
function ek(e) {
    ...
    n.append('build_id', 'fd3eb26595cc65b8bd7465af2ff1456cd66707a1'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
