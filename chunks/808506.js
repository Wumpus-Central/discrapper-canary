...
function eM(e) {
    ...
    (n.append('build_id', '681f89934594a58305dcbf02dfe3a076d82fa377'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
