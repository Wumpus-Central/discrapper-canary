...
function ek(e) {
    ...
    n.append('build_id', 'abddb82def5355315922fb4def3fed8307a19fa3'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
