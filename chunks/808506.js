...
function eM(e) {
    ...
    n.append('build_id', '880c38db6d427bf1c6b4bef81d1a6c6ef0b1cb79'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
