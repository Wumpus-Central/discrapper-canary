...
function eY(e) {
    ...
    r.append('build_id', '739fcd89b5351926995ed19806cb7c76c5da2cfb'), r.append('rpc', String(n)), r.append('rpc_auth_token', ef), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function eW(e) {
