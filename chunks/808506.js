...
function ek(e) {
    ...
    n.append('build_id', 'a65284bcd8e608740201c43a5a60cec390251efd'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
