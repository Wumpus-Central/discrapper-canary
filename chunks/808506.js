...
function ex(e) {
    ...
    n.append('build_id', '1773b59ad0fe3f71efa806879b70cbdb3ae425c4'), n.append('rpc', String(t)), n.append('rpc_auth_token', J), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
