...
function eM(e) {
    ...
    n.append('build_id', '7428312df1999b9ecf8a72aefc79ffb5961d0981'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
