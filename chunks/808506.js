...
function ek(e) {
    ...
    n.append('build_id', 'd4e1c9003349217cb4d7708790402c228d5b372d'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
