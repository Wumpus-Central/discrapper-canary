...
function eD(e) {
    ...
    n.append('build_id', 'c4b95cdd3f5833ecb7172f3bfad062a04fb308c6'), n.append('rpc', String(t)), n.append('rpc_auth_token', z), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eL(e) {
