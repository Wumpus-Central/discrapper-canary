...
function eM(e) {
    ...
    n.append('build_id', '2e304767cb1df0fe82cf814f7b3e0769dfa307ac'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
