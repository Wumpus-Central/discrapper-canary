...
function ex(e) {
    ...
    n.append('build_id', '09c40e95f99b4f16c346d5527a3a50efef039c16'), n.append('rpc', String(t)), n.append('rpc_auth_token', J), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
