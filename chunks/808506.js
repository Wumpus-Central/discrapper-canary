...
function ex(e) {
    ...
    n.append('build_id', '4ea294e6e4be6fd3ab89279b1bd95fe7958eb7a2'), n.append('rpc', String(t)), n.append('rpc_auth_token', J), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
