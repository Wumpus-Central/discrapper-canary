...
function eM(e) {
    ...
    (n.append('build_id', '61fe5f6a855620c22aaf310084d93cc84604f2ed'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
