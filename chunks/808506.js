...
function eV(e) {
    ...
    r.append('build_id', '83b6d47259cb827b76c2cb0b237d9d9152aa1e7d'), r.append('rpc', String(n)), r.append('rpc_auth_token', ec), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function ej(e) {
