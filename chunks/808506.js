...
function eM(e) {
    ...
    n.append('build_id', '235ea3665314f4882441791ce3258648ac3f0a41'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
