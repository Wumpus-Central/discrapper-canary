...
function ek(e) {
    ...
    (n.append('build_id', '2ade7599cc03b96a56384698e95f70b2f02a8949'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function eM(e) {
