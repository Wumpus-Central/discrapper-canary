...
async function eE(e) {
    if ((ef.isMutexHeld() || eo.error('_detachPIDMustBeLocked: overlayMutex is not held.', e), !Y.has(e))) return void eo.warn('Trying to detach from pid '.concat(e, ', which is in an unknown state'));
    eh(e, 'DISCONNECTING');
    try {
...
function eM(e) {
    ...
    n.append('build_id', '3d0e01f4de41ab3c3afcb0aa7861dbf0d80a8a65'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
