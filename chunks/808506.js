...
function ek(e) {
    ...
    (n.append('build_id', '13c60a742b77f14f65de074212a51f439b9f95fa'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function eM(e) {
