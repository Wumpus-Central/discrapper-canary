...
function ec(e, t) {
    ...
    let i = null == (n = es[e]) ? void 0 : n.error,
        a = null == (r = es[e]) ? void 0 : r.error_description;
    ...
    e_ = (0, a.H)({
        ...
        onTimeout: (e, t) => {
            ...
            (ec(
                ...
                w.default.track(j.rMx.OVERLAY_HOOK_RESULT, el((0, k.getPID)())));
        },
        timeoutMs: 180000
    });
function ef(e, t) {
...
function ep() {
    try {
        ...
        (eo.error('tryUploadDiscordHookCrashes', e), (0, y.D1)(e));
    }
}
function eh(e, t) {
    ...
    (null === n || r === n) &&
        ...
        (null == t || 'CRASHED' === t) && (_.Z.setFocusedPID(null), ep()),
        ee.delete(e),
        eo.info(
            'pid='
...
async function em(e) {
    try {
        if (x.ZP.supportsFeature(j.eRX.CREATE_HOST_ON_ATTACH))
            ...
            } else ((ed = 'reconcile.destroyHostProcess'), e.destroyHostProcess(), eO((0, k.getPID)()));
        else if (z) {
            let t = await ev();
            e.createHostProcess(t, eS, eT);
        } else (e.destroyHostProcess(), eO((0, k.getPID)()));
    } catch (t) {
        (eo.error('reconcileHostProcess', t), (0, y.D1)(t), eO((0, k.getPID)()));
        try {
...
async function eg(e) {
    var t;
    e_.isMutexHeld() || eo.error('_attachPIDMustBeLocked: overlayMutex is not held.', e);
    ...
    (await _.Z.updateOverlayState(e, v.mM.WAITING_FOR_OVERLAY_OPEN), (ed = 'attach.getOverlayModule'));
    let i = await (0, M.K)();
...
async function eE(e) {
    if ((e_.isMutexHeld() || eo.error('_detachPIDMustBeLocked: overlayMutex is not held.', e), !W.has(e))) return void eo.warn('Trying to detach from pid '.concat(e, ', which is in an unknown state'));
    eh(e, 'DISCONNECTING');
    try {
        ...
        (e !== k.DEV_PID && ((ed = 'detach.cancelAttachToProcess'), await h.pn(e), await (0, s._v)(16), (ed = 'detach.disconnectProcess'), await t.disconnectProcess(e)), (ed = 'detach.transitionOverlayPIDStatus'), eh(e, null), (ed = 'detach.reconcileHostProcess'), await em(t));
    } catch (t) {
...
async function eb(e) {
    ...
    if (
        ...
        e_.isMutexHeld() || eo.error('updateIntendedOverlayPIDs: overlayMutex is not held.', e),
        !X && null != e)
    )
    ...
    let i = !1;
    if (null == e || !z) {
        for (let t of (eo.verbose('updateIntendedOverlayPIDs: Removing all.', H, e), Object.keys(H))) (await r(Number(t)), (i = !0));
        return;
    }
    for (let n of J) {
    ...
    for (let t of null != (n = e.added) ? n : []) {
        ...
        if ((eo.verbose('updateIntendedOverlayPIDs: newGame', n), n.legacyEnabled))
            switch ((n.pid in H ? eo.error('Unexpected. '.concat(n.pid, ' is being added twice?'), H, e) : eu(n.pid), n.overlayMethod)) {
                case v.gl.Hook:
...
let ey = ef('updateIntendedOverlayPIDs', (e) => (eo.info('updateIntendedOverlayPIDs', e), eb(e))),
    eO = ef('clearPID', (e) => {
        if (null == e) return (0, k.setPID)(k.UNSET_PID);
        A.ZP.isOverlayV3EnabledForPID(e) || (0, k.setPID)(k.UNSET_PID);
    });
function ev() {
...
let eI = ef('setOverlayEnabled', async (e) => {
...
function eS(e, t, n) {
    ...
    (ec(e, B({}, o)),
        (0, d.te)(k.OVERLAY_LAYOUT_ID, P.Z.getDefaultLayout(k.OVERLAY_LAYOUT_ID), U.bv, {
            width: n.graphics_width,
            height: n.graphics_height
        }),
        _.Z.updateOverlayState(e, v.mM.OVERLAY_RENDERING));
    let s = el(e);
    (w.default.track(j.rMx.OVERLAY_HOOK_RESULT, s), eo.info('Overlay connection to '.concat(e, ' ').concat(t ? 'succeeded' : 'failed'), s), t ? eh(e, 'CONNECTED', 'CONNECTING') : eh(e, 'CONNECT_FAILED', 'CONNECTING'));
}
function eA() {
            ...
            ((0, d.te)(k.OVERLAY_LAYOUT_ID, P.Z.getDefaultLayout(k.OVERLAY_LAYOUT_ID), U.bv),
                Promise.all([(0, I.Z)(t, e.pid), o.ZP.PersistedStore.getAllStates()]).then((t) => {
                    ...
                    (m.lW({
                        ...
                        _.Z.overlayReady(i));
                    let o = el(i);
                    ec(i, F(B({}, o), { total_mount_time_ms: null != o.mounting_started_at ? new Date().getTime() - o.mounting_started_at : void 0 }));
                }));
            break;
        case j.BmY.DISPATCH:
...
function ek(e) {
    ...
    (n.append('build_id', '5ee05c0c492e4ce36426b4568f475344aea06011'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function eM(e) {
    let { channelId: t, ring: n } = e;
    setImmediate(() => {
        (f.default.selectPrivateChannel(t), c.Z.call(t, !1, !!n));
    });
}
function ej(e) {
    let { pid: t } = e;
...
function eB() {
    ((X = !1), _.Z.setFocusedPID(null), ey(void 0), eo.verbose('OverlayBridgeStore: handleConnectionClosed'));
}
function eV() {
    return !0;
}
...
function ez() {
    E.Z.hasLoadedExperiments && !Y && ((Y = !0), eI(O.v.legacyEnabled));
}
function eq() {
    Y = !1;
}
...
class eQ extends (i = o.ZP.Store) {
    initialize() {
        !(0, k.supportsLegacy)() || __OVERLAY__ || (this.waitFor(b.ZP, E.Z, C.default, A.ZP, T.default), this.syncWith([E.Z], ez), m.sr(eC, eN), C.default.addChangeListener(eA), l.Z.addInterceptor(en.queueDispatch));
    }
    ...
    get enabled() {
        return A.ZP.isOverlayV3Enabled() ? A.ZP.enabled : z;
    }
    get legacyEnabled() {
        return !A.ZP.isOverlayV3Enabled() && q;
    }
    ...
    getFocusedPID() {
        ...
        return null != e && A.ZP.isOverlayV3EnabledForPID(e) ? e : Q;
    }
    ...
    isCurrentPidOutOfProcess() {
        return T.default.isOverlayOOPEnabledForPid((0, k.getPID)());
    }
    isReady(e) {
