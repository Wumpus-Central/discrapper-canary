...
function eY(e) {
    ...
    r.append('build_id', '3045ef552b6297e4a5a314554bd34445f27a0670'), r.append('rpc', String(n)), r.append('rpc_auth_token', ef), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function eW(e) {
