...
function eM(e) {
    ...
    n.append('build_id', 'aa64f4a667ef9b1705781fac8e54e0e84bbf94a4'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
