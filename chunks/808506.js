...
function ek(e) {
    ...
    n.append('build_id', '9f966a551078055d22001ca85608b16bdd3d5293'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
