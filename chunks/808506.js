...
function eM(e) {
    ...
    (n.append('build_id', '7d93424307f20735949d38f365acb66107f0a404'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
