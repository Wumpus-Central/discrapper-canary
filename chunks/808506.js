...
function eM(e) {
    ...
    (n.append('build_id', 'dec72d5c0a737ab882854bb47df858f5d6ca0cee'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
