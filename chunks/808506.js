...
function ek(e) {
    ...
    n.append('build_id', '9d7e2d612e1a3e4890fefe2552bd781db6d399a3'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
