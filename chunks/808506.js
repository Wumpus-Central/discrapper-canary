...
function eM(e) {
    ...
    n.append('build_id', '87b2486df4bfe874b5fdb1c6344d4d0971d48f68'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
