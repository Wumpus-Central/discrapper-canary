...
async function em(e) {
    try {
        ...
        ea.error('reconcileHostProcess', t), eO((0, k.getPID)());
        try {
...
let ey = e_('updateIntendedOverlayPIDs', (e) => (ea.info('updateIntendedOverlayPIDs', e), eb(e))),
    eO = e_('clearPID', (e) => {
        ...
        T.ZP.isOverlayV3EnabledForPID(e) || (0, k.setPID)(k.UNSET_PID);
    });
function ev() {
...
function eT(e, t, n) {
    ...
    ec(e, B({}, a)),
        (0, d.te)(k.OVERLAY_LAYOUT_ID, P.Z.getDefaultLayout(k.OVERLAY_LAYOUT_ID), 0, {
...
function ek(e) {
    ...
    n.append('build_id', 'aeb00849a2611e9a42b229d8e92fa81d0299408b'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
...
class eX extends (i = a.ZP.Store) {
    ...
    isCurrentPidOutOfProcess() {
        return I.default.isOverlayOOPEnabledForPid((0, k.getPID)());
    }
    isReady(e) {
