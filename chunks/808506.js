...
function eM(e) {
    ...
    n.append('build_id', '819b4bbdb4b7cd1fc64f38999f2d28514d8d71c9'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
