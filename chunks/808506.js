...
function ex(e) {
    ...
    n.append('build_id', 'a92b3fd6780757f277a20068fcd3084d3eccd554'), n.append('rpc', String(t)), n.append('rpc_auth_token', J), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
