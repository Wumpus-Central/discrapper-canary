...
function eM(e) {
    ...
    (n.append('build_id', '9dff93f68c48887f2875f934443a840dbcbc21b6'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
