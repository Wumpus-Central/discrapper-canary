...
function eM(e) {
    ...
    n.append('build_id', '740b99ad7ccc95f0d4d972653f426ca38abacabd'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
