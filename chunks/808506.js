...
function ex(e) {
    ...
    n.append('build_id', '303365cb96cad1ace97e2c23004d3718a0887b5b'), n.append('rpc', String(t)), n.append('rpc_auth_token', J), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
