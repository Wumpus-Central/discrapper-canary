...
function eM(e) {
    ...
    n.append('build_id', 'ef710328a45367968d0b3e8bc90cdb100bb2c1d4'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
