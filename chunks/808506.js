...
function eM(e) {
    ...
    n.append('build_id', '943962b1f342d83720de2222917a78dbaac01038'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
