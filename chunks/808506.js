...
function ek(e) {
    ...
    n.append('build_id', '0cd91291d36e103a38d1bddebfc94cff37f2d47d'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
