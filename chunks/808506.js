...
function eY(e) {
    ...
    r.append('build_id', 'ba75d97b4f736b89058c7900b74f9e5354edcac3'), r.append('rpc', String(n)), r.append('rpc_auth_token', ef), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function eW(e) {
