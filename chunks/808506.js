...
function eY(e) {
    ...
    r.append('build_id', 'a7e4602700f6ee41c476d432da9649d26f78ebb1'), r.append('rpc', String(n)), r.append('rpc_auth_token', ef), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function eW(e) {
