...
function eM(e) {
    ...
    n.append('build_id', '9d150874c7ca84c07e809d3ab2202ac279c5db29'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
