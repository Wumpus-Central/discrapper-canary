...
function eM(e) {
    ...
    (n.append('build_id', '35810c1909f0a8386bf7324c15b1aa389b628702'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
