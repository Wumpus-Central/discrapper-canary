...
function ex(e) {
    ...
    n.append('build_id', 'f01637e2389509921f7a514fb05c2cb1c19d4634'), n.append('rpc', String(t)), n.append('rpc_auth_token', J), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
