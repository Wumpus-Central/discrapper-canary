...
function eM(e) {
    ...
    (n.append('build_id', '5348eb4032a953855b697d15163579cedddb9e24'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
