...
function ek(e) {
    ...
    n.append('build_id', '8c26c30dfd98d27a08539a0147bd717fe5a33d5f'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
