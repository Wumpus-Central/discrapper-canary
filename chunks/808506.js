...
function eM(e) {
    ...
    n.append('build_id', 'f873f3708ec41fe4bd6482fb124c6a01786754ac'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
