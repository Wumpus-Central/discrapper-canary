...
function ek(e) {
    ...
    (n.append('build_id', '07a03208a71c7e2abbd4f07101ee03953211de30'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function eM(e) {
