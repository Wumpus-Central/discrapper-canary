...
function eY(e) {
    ...
    r.append('build_id', '2bd21babd4501209abd7a8a628f71482d991d81b'), r.append('rpc', String(n)), r.append('rpc_auth_token', ef), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function eW(e) {
