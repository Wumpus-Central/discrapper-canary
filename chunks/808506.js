...
function ex(e) {
    ...
    n.append('build_id', 'b555e19db4fa5cef6ff96e75df8d7c6810a3372c'), n.append('rpc', String(t)), n.append('rpc_auth_token', J), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
