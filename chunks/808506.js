...
function eM(e) {
    ...
    (n.append('build_id', '2cb8f6a84fc55ba0a234d0a007f94dfa10874763'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
