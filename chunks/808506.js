...
function ek(e) {
    ...
    n.append('build_id', '04564113500d20dbe79ec80ea441f7e1c15a7bc2'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
