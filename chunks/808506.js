...
function ek(e) {
    ...
    n.append('build_id', 'ffb10bcdd8f452a9df0562c290bc974b04a2badf'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
