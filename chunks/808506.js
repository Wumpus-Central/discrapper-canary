...
function ex(e) {
    ...
    n.append('build_id', '67f93d55e517759da877a414849a2317da02dcc9'), n.append('rpc', String(t)), n.append('rpc_auth_token', J), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
