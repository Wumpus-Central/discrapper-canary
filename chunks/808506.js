...
function ek(e) {
    ...
    n.append('build_id', 'db78250ee2fa914c7a80667dc08084141ab4f549'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
