...
function eM(e) {
    ...
    n.append('build_id', 'b78a7e0253e6792f2d10f41bc66050d2806b7355'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
