...
function ek(e) {
    ...
    n.append('build_id', '19e24b43289c856a9a165f5e8cc899ee45f7fca5'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
