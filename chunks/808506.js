...
function eY(e) {
    ...
    r.append('build_id', '2b34f9f4d9c326c523fd98c3f2f7582d862b6a14'), r.append('rpc', String(n)), r.append('rpc_auth_token', ef), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function eW(e) {
