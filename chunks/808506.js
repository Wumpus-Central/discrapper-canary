...
function eM(e) {
    ...
    (n.append('build_id', 'b54c5c0c55604d0273e67c3b1eecac0113ff9113'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
