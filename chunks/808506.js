...
function ex(e) {
    ...
    n.append('build_id', '512903db5e317021ec2ffd3df3baf4989792fe0e'), n.append('rpc', String(t)), n.append('rpc_auth_token', J), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
