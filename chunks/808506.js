...
function eM(e) {
    ...
    (n.append('build_id', 'cea940fca8a22ebf8f7af1d0d4c22512ddabac22'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
