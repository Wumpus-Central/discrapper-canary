...
function eM(e) {
    ...
    n.append('build_id', '86589ad780ad5af37a7c9c1447a19ad5d2ea1c53'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
