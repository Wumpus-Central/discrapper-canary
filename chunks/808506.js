...
function eM(e) {
    ...
    (n.append('build_id', '84cfec7a2f9d4bc9093a88afd046361cbfc4430e'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
