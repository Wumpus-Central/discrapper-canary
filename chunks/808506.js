...
function ek(e) {
    ...
    (n.append('build_id', '2e308e58ad79fffea6ac8a36d975d4c2f5f08043'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function eM(e) {
