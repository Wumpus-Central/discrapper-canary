...
function ek(e) {
    ...
    (n.append('build_id', 'ba30f002d98e3e7e0fa39fa38934b5a9d93ecbc1'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function eM(e) {
