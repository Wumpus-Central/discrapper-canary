...
function ek(e) {
    ...
    n.append('build_id', 'b8a586224c699d6fc44ad97b52821ae090c7abb1'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
