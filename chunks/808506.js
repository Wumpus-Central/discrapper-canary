...
function eS(e) {
    ...
    n.append('build_id', '52c4c762180c46b49e0d81605b2661fd1e2da517'), n.append('rpc', String(t)), n.append('rpc_auth_token', W), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eA(e) {
