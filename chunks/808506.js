...
function eM(e) {
    ...
    (n.append('build_id', '4946d5f58306bd058a54cfffe5e8fad531137f4c'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
