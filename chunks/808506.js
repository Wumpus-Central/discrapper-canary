...
function ek(e) {
    ...
    n.append('build_id', '96567435ee6ddc35c123db3929cbd119d4c6529d'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
