...
function eM(e) {
    ...
    n.append('build_id', '5c0294160970176327f53c1bbd5698a971d59ff0'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
