...
function eY(e) {
    ...
    r.append('build_id', 'b88045f27c77e3e4dc514969c4de0465af613e58'), r.append('rpc', String(n)), r.append('rpc_auth_token', ef), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function eW(e) {
