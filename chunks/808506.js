...
function ek(e) {
    ...
    n.append('build_id', '3ee63301d3fa8cc258bf903a6c9d9b38079b10f0'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
