...
function ek(e) {
    ...
    n.append('build_id', 'af44348fe8459fd2785a0f603aa57e2c41fdde86'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
