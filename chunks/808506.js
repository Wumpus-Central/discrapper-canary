...
function eV(e) {
    ...
    r.append('build_id', '2445de9b6a2f15ad48596b723abcee63039a4d98'), r.append('rpc', String(n)), r.append('rpc_auth_token', ec), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function ej(e) {
