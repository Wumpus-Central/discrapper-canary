...
function eM(e) {
    ...
    (n.append('build_id', '3cc3e7baac843b9bccd1a2218bbf26dfbc59f74d'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
