...
function ek(e) {
    ...
    n.append('build_id', 'd6df63cacb5d79c44617fe83d2505bdd5e838b6d'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
