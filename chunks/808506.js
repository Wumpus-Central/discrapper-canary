...
function eM(e) {
    ...
    n.append('build_id', '2c803c4ee336312d574d71a18e55bea6245b9c4c'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
