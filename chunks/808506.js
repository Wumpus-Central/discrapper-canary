...
function ek(e) {
    ...
    (n.append('build_id', 'b2e0250d74c64a41539d4f4cb31d63e5e26fdd3a'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function eM(e) {
