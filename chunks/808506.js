...
function ek(e) {
    ...
    n.append('build_id', 'c29644e5e80a3592a87dc772b7ee1a4aa2568789'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
