...
function eN(e) {
    ...
    n.append('build_id', '8241a58584c5261cd62bba18ec88a0df9aa037d1'), n.append('rpc', String(t)), n.append('rpc_auth_token', z), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eC(e) {
