...
function ek(e) {
    ...
    n.append('build_id', 'fb3734039fa6bbff7be063c9045f3184f183fe94'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
