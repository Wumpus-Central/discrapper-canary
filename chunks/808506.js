...
function eV(e) {
    ...
    r.append('build_id', '303faa93e45c34c8d6a5d34b9f32f57a5800a44c'), r.append('rpc', String(n)), r.append('rpc_auth_token', ec), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function ej(e) {
