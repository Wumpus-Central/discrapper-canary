...
function ek(e) {
    ...
    n.append('build_id', 'db7f31f05528085844589f60910dc871a83dec08'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
