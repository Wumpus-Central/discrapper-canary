...
function eM(e) {
    ...
    n.append('build_id', '685e53055b25ca32c17e63801cf23ba654cf09bc'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
