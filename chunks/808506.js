...
function eM(e) {
    ...
    n.append('build_id', '92a988ffa209b8ec1651e66c77dd35025398eeab'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
