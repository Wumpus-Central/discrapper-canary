...
function ek(e) {
    ...
    n.append('build_id', 'b883454e79bb6c3702d8495146366810b7fcc8f6'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
