...
function eM(e) {
    ...
    n.append('build_id', 'fd9b72553a737fba593df55fc69fab134fa08c4c'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
