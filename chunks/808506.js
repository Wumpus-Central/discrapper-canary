...
function eM(e) {
    ...
    n.append('build_id', '4df72f4bd390e3a1dc9d873f365eccd90a1947a1'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
