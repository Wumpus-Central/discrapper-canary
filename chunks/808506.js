...
function eS(e) {
    ...
    n.append('build_id', 'd188413c4580fe317d218c9e23fb65d593d74cd4'), n.append('rpc', String(t)), n.append('rpc_auth_token', W), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eA(e) {
