...
function eM(e) {
    ...
    n.append('build_id', '38d507e8d113026c07393955d4256aa00243a7b0'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
