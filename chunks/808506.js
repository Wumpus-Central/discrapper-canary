...
function eM(e) {
    ...
    n.append('build_id', '81f9ca99001a0e6dfa0f2405ec92573aa39d9171'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
