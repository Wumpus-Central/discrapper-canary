...
function eM(e) {
    ...
    n.append('build_id', 'e0b1dc53d476e6af68e237c85fbc7385124acce9'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
