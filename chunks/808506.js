...
function ek(e) {
    ...
    (n.append('build_id', '84dbf37e647fc6afe1574c5376d3bd626e916642'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function eM(e) {
