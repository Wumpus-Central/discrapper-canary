...
function eY(e) {
    ...
    r.append('build_id', 'e6a9b69f97509eb56775aaea94a082b239a5326a'), r.append('rpc', String(n)), r.append('rpc_auth_token', ef), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function eW(e) {
