...
function eM(e) {
    ...
    (n.append('build_id', 'dd17371b61572d9c52fef3b8db5c6ed2710891d6'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
