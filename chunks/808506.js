...
function eY(e) {
    ...
    r.append('build_id', '8cb82ada9547dbc6ed892e5d16a3b3f7541152c5'), r.append('rpc', String(n)), r.append('rpc_auth_token', ef), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function eW(e) {
