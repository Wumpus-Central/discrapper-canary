...
function eY(e) {
    ...
    r.append('build_id', '5716552e8d5f24c37949db9642d3261ab4821eac'), r.append('rpc', String(n)), r.append('rpc_auth_token', ef), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function eW(e) {
