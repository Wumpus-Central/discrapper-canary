...
function eY(e) {
    ...
    r.append('build_id', '84c82f41b77faca9a4adfadc4ead704d3503b50c'), r.append('rpc', String(n)), r.append('rpc_auth_token', ef), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function eW(e) {
