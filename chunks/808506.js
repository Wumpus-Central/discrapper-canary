...
function eM(e) {
    ...
    n.append('build_id', '3f879e4738ccce78f90bc60881f8d431c160ad24'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
