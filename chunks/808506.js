...
function eM(e) {
    ...
    (n.append('build_id', 'd4c52bf21b33abd3ae82e2cfe79af22ae92954f8'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
