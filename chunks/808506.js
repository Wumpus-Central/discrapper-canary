...
function ek(e) {
    ...
    n.append('build_id', '63085e88e3b54487f570361859a350de342ada9c'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
