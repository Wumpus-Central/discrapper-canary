...
function eM(e) {
    ...
    n.append('build_id', '641d3d382f558ce0473542943282b0a8c7d33188'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
