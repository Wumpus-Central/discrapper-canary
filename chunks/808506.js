...
function eM(e) {
    ...
    n.append('build_id', '99df874ed9db3f9d2d3ae6e54b86a624c14a1f96'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
