...
function eM(e) {
    ...
    (n.append('build_id', '4ed74e2bac9bb662e28401e2a13adce0542d9110'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
