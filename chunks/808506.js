...
function eM(e) {
    ...
    (n.append('build_id', '30f45f21543bb82d3811b81b7ea62766b952eaa7'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
