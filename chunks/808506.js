...
function eM(e) {
    ...
    (n.append('build_id', '0fe9a64eeed2b40e087cbb720c67eea2a44d7a36'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
