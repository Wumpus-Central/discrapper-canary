...
function eM(e) {
    ...
    n.append('build_id', '9233ee3fce239bc2c4f0fd242e16391cb7bfe2b9'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
