...
function eM(e) {
    ...
    (n.append('build_id', '6c6a458e695bd6b78613039f1a2f9a0dc5b4948e'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
