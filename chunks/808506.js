...
function ek(e) {
    ...
    n.append('build_id', '34de2b600942cd35ba7f4a923e0fd4a7e7d4a2c3'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
