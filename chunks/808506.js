...
function eM(e) {
    ...
    n.append('build_id', '173622f34db2ad40eb91149d823ddeb97756a367'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
