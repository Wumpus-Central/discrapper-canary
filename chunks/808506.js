...
function eM(e) {
    ...
    n.append('build_id', 'f2dd1d3df80eacc19bc034d36ee85d238675dcd4'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
