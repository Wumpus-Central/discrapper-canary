...
function ek(e) {
    ...
    n.append('build_id', 'ff76e5315b02b31a7505b0c8d1256c8904f657d7'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
