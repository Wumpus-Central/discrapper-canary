...
function eM(e) {
    ...
    n.append('build_id', 'eabf834ba7203394ffd9d1412b472f8d320f44c8'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
