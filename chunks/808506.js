...
function ek(e) {
    ...
    n.append('build_id', '4975c1cc95094d45a41f5e534d1587f881c4578d'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
