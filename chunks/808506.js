...
function eS(e) {
    ...
    n.append('build_id', '0a54d5b2976bcf6b314c887a990cd602cd6c320b'), n.append('rpc', String(t)), n.append('rpc_auth_token', W), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eA(e) {
