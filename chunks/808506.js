...
function ek(e) {
    ...
    n.append('build_id', '12eb717156ebdd69526eb94d26ca17df2e234c61'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
