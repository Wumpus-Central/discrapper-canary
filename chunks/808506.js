...
function ex(e) {
    ...
    n.append('build_id', '7b5de1bee479339b13da6314dfc15fc81269720f'), n.append('rpc', String(t)), n.append('rpc_auth_token', J), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
