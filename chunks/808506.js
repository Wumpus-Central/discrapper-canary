...
function ek(e) {
    ...
    n.append('build_id', '7adb16583c4aa8fe675d8c80e2f11c5d2d82f1ed'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
