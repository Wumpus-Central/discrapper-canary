...
function eY(e) {
    ...
    r.append('build_id', 'ae0af4b408a5fbf7cb510ca2777f4ee51e1cbd47'), r.append('rpc', String(n)), r.append('rpc_auth_token', ef), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function eW(e) {
