...
function ek(e) {
    ...
    n.append('build_id', 'e8f27199c2490add7a91e2b0bcda1b5bdf0fc5b9'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
