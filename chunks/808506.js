...
function eM(e) {
    ...
    (n.append('build_id', 'c311b0b2bc53ae6c47106f8cfb63679f4aaf4b51'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
