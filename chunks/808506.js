...
function eY(e) {
    ...
    r.append('build_id', '865c7d272d3763be086f60d568f5f5f34406f1a6'), r.append('rpc', String(n)), r.append('rpc_auth_token', ef), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function eW(e) {
