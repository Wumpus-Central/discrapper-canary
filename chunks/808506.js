...
function ek(e) {
    ...
    n.append('build_id', '768e6b6d82cd3bb168dd9fb9f4d7304108037bc1'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
