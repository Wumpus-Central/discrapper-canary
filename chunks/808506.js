...
function eM(e) {
    ...
    (n.append('build_id', '2b71a6dc8729caa228b4429013b31934c408b93c'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
