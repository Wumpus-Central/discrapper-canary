...
function eM(e) {
    ...
    n.append('build_id', '09d8a8b4f2924da07b6ef7abe296a897872bc06a'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
