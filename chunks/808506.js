...
function ek(e) {
    ...
    n.append('build_id', '299dbb24344ae6386c79f6b4e7e611b2371cfc80'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
