...
function eM(e) {
    ...
    (n.append('build_id', '43c0010e7328c73f05300982181864e5e443a34d'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
