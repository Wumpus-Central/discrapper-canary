...
function ek(e) {
    ...
    n.append('build_id', 'ae7dda25aeaadf04733f2a5cb5ced348cbcb3431'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
