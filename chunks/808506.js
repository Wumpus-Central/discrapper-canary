...
function eY(e) {
    ...
    r.append('build_id', '52828fc02d80c4d2be688da6148bc05b3b81fc51'), r.append('rpc', String(n)), r.append('rpc_auth_token', ef), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function eW(e) {
