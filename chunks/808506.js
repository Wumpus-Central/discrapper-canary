...
function eM(e) {
    ...
    (n.append('build_id', '4acbf0dbc3e105f3765561c62f4efe3ba5109725'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
