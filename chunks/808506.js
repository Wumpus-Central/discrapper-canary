...
function eM(e) {
    ...
    n.append('build_id', '5846c02ca955df866b3edc65231f9a059c2bffd0'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
