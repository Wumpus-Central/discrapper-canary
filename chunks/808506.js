...
function eD(e) {
    ...
    n.append('build_id', 'bea4a7214b43644b6b951c25373147e6e45399da'), n.append('rpc', String(t)), n.append('rpc_auth_token', z), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eL(e) {
