...
function ex(e) {
    ...
    n.append('build_id', '9b1412d6fea15c2c9c08bca1c5943f1bdddb3ab2'), n.append('rpc', String(t)), n.append('rpc_auth_token', J), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
