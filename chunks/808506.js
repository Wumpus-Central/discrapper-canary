...
function ek(e) {
    ...
    n.append('build_id', 'b725c002059908fc085ab93816adb79f21b3f059'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
