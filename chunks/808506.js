...
function eM(e) {
    ...
    (n.append('build_id', 'adf53ef8a1d69771dd75cdd3225d1d6e0b28bb45'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
