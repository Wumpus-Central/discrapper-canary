...
function eM(e) {
    ...
    (n.append('build_id', '7e0a3d8a38d3da0db8238818785d70fb08a58b66'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
