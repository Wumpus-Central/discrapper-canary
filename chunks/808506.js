...
function eN(e) {
    ...
    n.append('build_id', '59fc9ccf3abde9ea54e336ca50912c9ef3c316c2'), n.append('rpc', String(t)), n.append('rpc_auth_token', z), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eC(e) {
