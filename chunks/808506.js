...
function ek(e) {
    ...
    n.append('build_id', 'aec87a49caeed28c0484aa34c5ffdebf3310585c'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
