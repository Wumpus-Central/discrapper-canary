...
function ex(e) {
    ...
    n.append('build_id', '2b297ed25294bc9cc78e5ae02adf15baa6231f02'), n.append('rpc', String(t)), n.append('rpc_auth_token', J), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
