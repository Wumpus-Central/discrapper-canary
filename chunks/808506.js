...
function eM(e) {
    ...
    n.append('build_id', '1f22543aeed761e9f86fc74b4ccb38195527118d'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
