...
function ek(e) {
    ...
    n.append('build_id', 'd985e146b6f4e670da321b79690a89ef7ad0edcd'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
