...
function eN(e) {
    ...
    n.append('build_id', 'f687323d7e2865660a6a87e7b310950c8ffbe07d'), n.append('rpc', String(t)), n.append('rpc_auth_token', z), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eC(e) {
