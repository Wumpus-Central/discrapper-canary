...
function eV(e) {
    ...
    r.append('build_id', '3d4ff3b70137ef1c05789485116f5140b1a42fb6'), r.append('rpc', String(n)), r.append('rpc_auth_token', ec), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function ej(e) {
