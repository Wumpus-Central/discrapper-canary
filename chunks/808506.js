...
function ek(e) {
    ...
    n.append('build_id', 'ab82061375a67b169988c2dabb0146cdac358050'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
