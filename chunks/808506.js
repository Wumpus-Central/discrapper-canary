...
function eM(e) {
    ...
    n.append('build_id', '0c3febdc008eebb99c6d37eae57095526bc0025e'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
