...
function eM(e) {
    ...
    n.append('build_id', 'c8c847aa913ad9b74b5ebaade6dd0804b197e0fc'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
