...
function eM(e) {
    ...
    (n.append('build_id', '1ab1df2d2ce1e3a58f0dc2f11fa2dfcdb87e362a'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
