...
function eM(e) {
    ...
    (n.append('build_id', '9000b3321cb67880c410844d34a0b1e37bf5ef81'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
