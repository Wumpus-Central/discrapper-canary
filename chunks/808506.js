...
function eN(e) {
    ...
    n.append('build_id', '5df4995ce5c2ffb36f6febed39352c6d4a2ec19e'), n.append('rpc', String(t)), n.append('rpc_auth_token', z), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eC(e) {
