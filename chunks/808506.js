...
function ek(e) {
    ...
    n.append('build_id', '6067778507db80d7158c25ff532b9a6c1be3ae03'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
