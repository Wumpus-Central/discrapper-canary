...
function eV(e) {
    ...
    r.append('build_id', 'fd77a75b1182bd8673663c9e915985f0a3128652'), r.append('rpc', String(n)), r.append('rpc_auth_token', ec), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function ej(e) {
