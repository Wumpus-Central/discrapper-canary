...
function eM(e) {
    ...
    (n.append('build_id', '1919695f471c0ebb00cf1f65c07520c53a0229fb'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
