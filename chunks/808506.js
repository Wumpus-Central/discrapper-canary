...
function ek(e) {
    ...
    n.append('build_id', '844e1c165d34c6b56f1c1264f85ae6cdd931f01f'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
