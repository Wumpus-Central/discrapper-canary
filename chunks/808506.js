...
function ek(e) {
    ...
    n.append('build_id', '4ab77e318dc2df906c69f4e47ebdd82ca7334181'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
