...
function ek(e) {
    ...
    n.append('build_id', 'bbb6a8f3772297b24ca3073d68851c5fcfeb47bb'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
