...
function ek(e) {
    ...
    (n.append('build_id', '52f1561fdbf9099c45ec25f23dee3b1ed34e5c72'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function eM(e) {
