...
function eN(e) {
    ...
    n.append('build_id', '70e1be7ffa85998680a0ea9b49c02fc6d63d462e'), n.append('rpc', String(t)), n.append('rpc_auth_token', z), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eC(e) {
