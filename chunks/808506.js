...
function ek(e) {
    ...
    (n.append('build_id', '625810670745208991931f75efad7dcd01dac1a7'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function eM(e) {
