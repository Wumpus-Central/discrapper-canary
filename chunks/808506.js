...
function eN(e) {
    ...
    n.append('build_id', '3829b333944014c67f422887aa1859fa8fe11068'), n.append('rpc', String(t)), n.append('rpc_auth_token', z), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eC(e) {
