...
function ek(e) {
    ...
    n.append('build_id', 'ab871fd42ab4474f59c30b7fb19671efe4082ac2'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
