...
function eN(e) {
    ...
    n.append('build_id', 'e682794865f6caad609f04f6adf256a453b8f1f3'), n.append('rpc', String(t)), n.append('rpc_auth_token', z), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eC(e) {
