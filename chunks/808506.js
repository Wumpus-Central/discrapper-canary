...
function eY(e) {
    ...
    r.append('build_id', '0fdd36b0def81e75f5e18a2825291458c4624e45'), r.append('rpc', String(n)), r.append('rpc_auth_token', ef), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function eW(e) {
