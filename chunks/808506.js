...
function ek(e) {
    ...
    n.append('build_id', 'c0406b0b2b40dc3fb81093166cd06daad338796c'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
