...
function eM(e) {
    ...
    (n.append('build_id', '2ebdfa3dd8e1e0794527d85b340be3447c71522d'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
