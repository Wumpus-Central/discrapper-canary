...
function ex(e) {
    ...
    n.append('build_id', 'd3b874cc47c94544a0d8d409000ec92676e5c6db'), n.append('rpc', String(t)), n.append('rpc_auth_token', J), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
