...
function eM(e) {
    ...
    (n.append('build_id', '7be9e37779604dee4d1cbce499a424ac9d104d8e'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
