...
function eM(e) {
    ...
    n.append('build_id', 'e85159af7a1918e02a8f50dbe64fb23961f35c0f'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
