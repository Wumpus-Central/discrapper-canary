...
function ex(e) {
    ...
    n.append('build_id', '5f41bf116d46800e2b3f4ea398caf7cad281e09a'), n.append('rpc', String(t)), n.append('rpc_auth_token', J), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
