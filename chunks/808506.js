...
function eM(e) {
    ...
    (n.append('build_id', 'f0053e58f37f1953133b8bf987a571f071852ccd'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
