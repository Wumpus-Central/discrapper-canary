...
function eM(e) {
    ...
    n.append('build_id', 'd417f029eaf8ea8b05107b7153f80326225b5ea9'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
