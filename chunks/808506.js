...
function ek(e) {
    ...
    n.append('build_id', 'd08aa00acc68fc710046b024c88e3c01586b9e89'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
