...
function ex(e) {
    ...
    n.append('build_id', 'ebb0d5a9e98e0ff8ac8f79fbad2ebfd9aa9855f7'), n.append('rpc', String(t)), n.append('rpc_auth_token', J), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
