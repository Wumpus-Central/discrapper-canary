...
function eM(e) {
    ...
    n.append('build_id', 'cf3a0eec68d90fd6bebcfa6c19a91667e7ed0e10'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
