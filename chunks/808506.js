...
function ek(e) {
    ...
    n.append('build_id', '4b740c331fb2516753c906e72a95865c82de7b0d'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
