...
function eY(e) {
    ...
    r.append('build_id', 'f1320823619c9cbf00e58e295a0170a0c0a02878'), r.append('rpc', String(n)), r.append('rpc_auth_token', ef), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function eW(e) {
