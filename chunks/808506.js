...
function ek(e) {
    ...
    n.append('build_id', 'c9a8555465fe7c892783268c774863e82f806898'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
