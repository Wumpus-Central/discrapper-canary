...
function ek(e) {
    ...
    n.append('build_id', '545a1948c0cd9a8cb36f640da08ec4f4070bdc3c'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
