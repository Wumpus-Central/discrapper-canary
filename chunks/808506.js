...
function eN(e) {
    ...
    n.append('build_id', 'b3c119bbb3b552760f6f7adc0ee80d4b462f960e'), n.append('rpc', String(t)), n.append('rpc_auth_token', z), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eC(e) {
