...
function eM(e) {
    ...
    (n.append('build_id', '304e3bbb5cd403601efc5d3013f1eff772a6ef5f'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
...
class eQ extends (i = o.ZP.Store) {
    initialize() {
        !(0, M.supportsLegacy)() || __OVERLAY__ || (this.waitFor(b.ZP, E.Z, C.default, A.ZP, T.default), this.syncWith([E.Z], ez), m.sr(eC, eN), C.default.addChangeListener(eA), l.Z.addInterceptor(en.queueDispatch));
    }
