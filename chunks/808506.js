...
function eY(e) {
    ...
    r.append('build_id', 'e5c7fbd36cc3ac1a1f1ffca4f8ce9e6f568b4544'), r.append('rpc', String(n)), r.append('rpc_auth_token', ef), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function eW(e) {
