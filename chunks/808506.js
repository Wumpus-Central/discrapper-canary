...
function ex(e) {
    ...
    n.append('build_id', 'f8c8b6c111c8b8d4e22e13f12efa41bdfce41c0b'), n.append('rpc', String(t)), n.append('rpc_auth_token', J), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
