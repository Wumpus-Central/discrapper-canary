...
function eM(e) {
    ...
    (n.append('build_id', 'c1a50adc4208dab9e4c819e5e8de99aba3b811ee'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
