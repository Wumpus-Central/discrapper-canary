...
function ek(e) {
    ...
    (n.append('build_id', '4a902d1586a34f93ad5702b6d0c1ecd50f79b5d7'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function eM(e) {
