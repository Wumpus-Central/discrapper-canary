...
function eY(e) {
    ...
    r.append('build_id', '016f13759c484fa7501782dd6c9069ffe38732c2'), r.append('rpc', String(n)), r.append('rpc_auth_token', ef), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function eW(e) {
