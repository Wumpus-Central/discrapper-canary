...
function eM(e) {
    ...
    n.append('build_id', '0005105f80426ea8cff723b8ca88ac0222f3c9cc'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
