...
function eM(e) {
    ...
    (n.append('build_id', 'e79d4dc638ef9cb1704704b6fbd468364f095a59'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
