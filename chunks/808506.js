...
function eM(e) {
    ...
    n.append('build_id', '72e2d57f2bc7ddbe964d3b331b848183d4b31fdc'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
