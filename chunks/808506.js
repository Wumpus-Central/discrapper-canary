...
function eM(e) {
    ...
    (n.append('build_id', '7e831fadf1fe3dd360e2e3f54568288ae996e91d'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
