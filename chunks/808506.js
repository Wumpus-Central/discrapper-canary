...
function ek(e) {
    ...
    n.append('build_id', 'b7b589387023fd15ef54d6a3f58ff9d4adac9475'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
