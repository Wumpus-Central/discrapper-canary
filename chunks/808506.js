...
function eM(e) {
    ...
    (n.append('build_id', '41c8ac41649ed88455e67ed0d8cf57b7b424cdaa'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
