...
function eM(e) {
    ...
    (n.append('build_id', '59afda73e5a04e3ed3ff960c46076fe8b3ece534'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
