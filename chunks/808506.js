...
function ex(e) {
    ...
    n.append('build_id', 'd66db6722ec63199d9a268ddbc9e862bf6fc6f1f'), n.append('rpc', String(t)), n.append('rpc_auth_token', J), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
