...
function ek(e) {
    ...
    (n.append('build_id', 'dd8d2cfbf040063774eced55304262421ef21e7d'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function eM(e) {
