...
function eM(e) {
    ...
    (n.append('build_id', '42626f73ecbe85252fc76b7349f3d0ec49e89b23'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
