...
function ek(e) {
    ...
    n.append('build_id', 'c2dc347260b2447154b67615b6020758ee403956'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
