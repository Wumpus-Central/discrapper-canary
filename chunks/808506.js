...
function ek(e) {
    ...
    n.append('build_id', 'bbd74a6733c144184d0dbca2101b8b15e18efb98'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
