...
function eD(e) {
    ...
    n.append('build_id', '64b53e788ae0c5e1df7c3eb8e85bc7f5addb6b37'), n.append('rpc', String(t)), n.append('rpc_auth_token', z), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eL(e) {
