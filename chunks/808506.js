...
function eM(e) {
    ...
    n.append('build_id', '62f44536bde96975a278c8d97eaa023551d581b6'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
