...
function ek(e) {
    ...
    n.append('build_id', '702ad15ed1ac8bf1625be1717eb8a37691beedf7'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
