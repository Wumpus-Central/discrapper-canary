...
function ek(e) {
    ...
    n.append('build_id', '0ec68276c5e1ca2225d4dd6cd682dacef5fa89ef'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
