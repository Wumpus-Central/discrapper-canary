...
function eN(e) {
    ...
    n.append('build_id', '073ef3f9a415a761b82bde608a98e1108261004a'), n.append('rpc', String(t)), n.append('rpc_auth_token', z), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eC(e) {
