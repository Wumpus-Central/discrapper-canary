...
function eM(e) {
    ...
    n.append('build_id', '9663c321a58a52486461a4dcc65906bffedf9520'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
