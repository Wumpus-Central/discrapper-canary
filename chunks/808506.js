...
function eY(e) {
    ...
    r.append('build_id', 'caf4d7fab34a73fe4a23b1630d7d394da7fa0c5c'), r.append('rpc', String(n)), r.append('rpc_auth_token', ef), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function eW(e) {
