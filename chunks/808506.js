...
function ek(e) {
    ...
    n.append('build_id', 'b2d637c17906099b1a496cc7ab1702fd745e625b'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
