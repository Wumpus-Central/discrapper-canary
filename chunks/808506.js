...
function ek(e) {
    ...
    n.append('build_id', '31f9d92d9dce47ef89eb1e16f466f534d9d7e87a'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
