...
function ek(e) {
    ...
    n.append('build_id', '725d40336cef34043c7f2235e0837477e7856741'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
