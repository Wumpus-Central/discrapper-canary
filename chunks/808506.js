...
function ek(e) {
    ...
    n.append('build_id', 'b8f002849149b041503ee7aecce9fd3b5c2c4116'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
