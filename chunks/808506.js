...
function eM(e) {
    ...
    (n.append('build_id', 'c1ca6c1130102a84f7d5f60ff82d870ade0a13cd'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
