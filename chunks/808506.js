...
function eY(e) {
    ...
    r.append('build_id', 'a3a1457bd5761279149ca3e60f98725fd3ab2aae'), r.append('rpc', String(n)), r.append('rpc_auth_token', ef), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function eW(e) {
