...
function eD(e) {
    ...
    n.append('build_id', '7a41be6caba5809fc1817f4a4db93950028db68c'), n.append('rpc', String(t)), n.append('rpc_auth_token', z), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eL(e) {
