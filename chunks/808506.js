...
function eM(e) {
    ...
    (n.append('build_id', '71096283faaaae3ddd25935673325f2244b08128'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
