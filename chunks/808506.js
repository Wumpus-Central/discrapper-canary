...
function eM(e) {
    ...
    n.append('build_id', 'dee4db55841abf23c6d8973419db165769a3532e'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
