...
function eN(e) {
    ...
    n.append('build_id', 'c1ccf845c5a82d6327ff98e004d687480e5641a2'), n.append('rpc', String(t)), n.append('rpc_auth_token', z), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eC(e) {
