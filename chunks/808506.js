...
function eY(e) {
    ...
    r.append('build_id', 'daa08113bb6d7842683868ca50e207ec44eda170'), r.append('rpc', String(n)), r.append('rpc_auth_token', ef), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function eW(e) {
