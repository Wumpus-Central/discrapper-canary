...
function eM(e) {
    ...
    (n.append('build_id', '7ad6015dfeaac7f94f251907e56b1940bb0b14f2'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
