...
function eM(e) {
    ...
    (n.append('build_id', '45b214ef2f16e0d144748602038f80043fb29924'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
