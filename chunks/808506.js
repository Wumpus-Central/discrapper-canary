...
function eM(e) {
    ...
    (n.append('build_id', 'd85c4f8d359d04ae7afbd2adf512932225aa4616'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
