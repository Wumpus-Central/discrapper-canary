...
function ex(e) {
    ...
    n.append('build_id', '4c55ab10cf35b65bd8df1e8baf246e988e1fa532'), n.append('rpc', String(t)), n.append('rpc_auth_token', J), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
