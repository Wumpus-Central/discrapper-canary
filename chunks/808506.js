...
function ex(e) {
    ...
    n.append('build_id', '1861d3576efd5cb8fb725707e740b96667d39131'), n.append('rpc', String(t)), n.append('rpc_auth_token', J), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
