...
async function em(e) {
    try {
        ...
        ea.error('reconcileHostProcess', t), eO((0, x.getPID)());
        try {
...
function eT(e, t, n) {
    ...
    let s = el(e);
    R.default.track(M.rMx.OVERLAY_HOOK_RESULT, s), ea.info('Overlay connection to '.concat(e, ' ').concat(t ? 'succeeded' : 'failed'), s), t ? eh(e, 'CONNECTED', 'CONNECTING') : eh(e, 'CONNECT_FAILED', 'CONNECTING');
}
function eA() {
...
function ek(e) {
    ...
    n.append('build_id', '18df0975cb3b0c2ba96854ed95cb658fd32fcad7'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
