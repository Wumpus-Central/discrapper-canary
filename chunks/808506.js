...
function eM(e) {
    ...
    n.append('build_id', 'db1b085386c11bc95c882c4b30557edafe39fa1d'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
