...
function eV(e) {
    ...
    r.append('build_id', '26ecb496b5eac35e9cc0128b0330179fd246763b'), r.append('rpc', String(n)), r.append('rpc_auth_token', ec), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function ej(e) {
