...
function ek(e) {
    ...
    n.append('build_id', '1f38f495bfa5a26f64b40c9280233f28d6b960b0'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
