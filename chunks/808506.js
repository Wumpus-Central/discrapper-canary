...
function eM(e) {
    ...
    n.append('build_id', '266829edb414542db621cb1868625743daea7f3f'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
