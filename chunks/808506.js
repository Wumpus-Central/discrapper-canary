...
function eD(e) {
    ...
    n.append('build_id', '83ab643d9f47fbab6b987de144243509ba9315d0'), n.append('rpc', String(t)), n.append('rpc_auth_token', z), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eL(e) {
