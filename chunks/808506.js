...
function eM(e) {
    ...
    n.append('build_id', 'd454d2f0d257d55123f4270206df548e106b1f9a'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
