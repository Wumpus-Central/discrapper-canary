...
function eM(e) {
    ...
    (n.append('build_id', '07085af1218cc90dac290275b240a967d7c4d391'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
