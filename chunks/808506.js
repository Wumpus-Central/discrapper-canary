...
function eM(e) {
    ...
    n.append('build_id', 'ed653788b67a1767efc82680ea124fb8afa1ccbd'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
