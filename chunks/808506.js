...
function eM(e) {
    ...
    n.append('build_id', '574ec1b110cae7888bd81deb2c240b9ea081e8f9'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
