...
function eM(e) {
    ...
    n.append('build_id', '3d6821b430a030e8f0dad0f65ea812762f865c29'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
