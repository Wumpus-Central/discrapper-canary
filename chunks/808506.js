...
function eM(e) {
    ...
    (n.append('build_id', 'c66b5e37d1789674f0215a5b40dc4416182c1d0c'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
