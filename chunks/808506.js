...
function eN(e) {
    ...
    n.append('build_id', '1c0cf419fadf5fee959abedd700d7971babc96fc'), n.append('rpc', String(t)), n.append('rpc_auth_token', z), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eC(e) {
