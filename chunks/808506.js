...
function ek(e) {
    ...
    n.append('build_id', 'f4cd6b4fae46adb285dded0bcfa309ca8af44d61'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
