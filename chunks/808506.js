...
function eM(e) {
    ...
    n.append('build_id', '1a3336525920d7a00fcc12f7fd38debad99962e0'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
