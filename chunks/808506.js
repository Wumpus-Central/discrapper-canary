...
function eM(e) {
    ...
    n.append('build_id', '343f269e4369c293bd2025193413f5904f9b979d'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
