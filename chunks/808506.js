...
function ek(e) {
    ...
    n.append('build_id', '32afbc807351f58b4decc60638a15cd778507886'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
