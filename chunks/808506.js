...
function ek(e) {
    ...
    n.append('build_id', '3fb9cae8cc324426e5b7b01f7a46c131275cb8ad'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
