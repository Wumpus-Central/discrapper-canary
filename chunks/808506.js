...
function ek(e) {
    ...
    n.append('build_id', '3e9ab53d930e3e24d273eee7e3259736bf78e811'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
