...
function ek(e) {
    ...
    (n.append('build_id', '3c855fdc7cfc2a68a4ddfe225f5b9f4bbdfc3596'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function eM(e) {
