...
function ek(e) {
    ...
    (n.append('build_id', '088c05e0f12891dfa7f8cd18884745a5d94a6e7a'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function eM(e) {
