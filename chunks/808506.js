...
function eV(e) {
    ...
    r.append('build_id', 'bd7fc948df7bf3608bd3720b5d34400b81d5e555'), r.append('rpc', String(n)), r.append('rpc_auth_token', ec), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function ej(e) {
