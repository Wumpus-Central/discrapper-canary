...
function eM(e) {
    ...
    n.append('build_id', 'a66860cc641ebf0bdd72fbdd6a95a6e9a97b8de7'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
