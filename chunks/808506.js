...
function ek(e) {
    ...
    n.append('build_id', 'fa5ebcfd49901c4aac9d78897e5fb6700fe00c45'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
