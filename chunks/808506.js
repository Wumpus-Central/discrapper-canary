...
function ek(e) {
    ...
    n.append('build_id', 'bf15536c1b718d14fa71f383ef494cda8edab056'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
