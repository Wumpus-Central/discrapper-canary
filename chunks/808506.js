...
function eY(e) {
    ...
    r.append('build_id', 'ea86063f0a7b1bc74d141db3f50e5da37e8ed548'), r.append('rpc', String(n)), r.append('rpc_auth_token', ef), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function eW(e) {
