...
function eM(e) {
    ...
    (n.append('build_id', '615e0e791f63e431ad6b800560d8e5d3656e4b65'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
