...
function eV(e) {
    ...
    r.append('build_id', '6562b83274c79d96bf5ad84ba1cfaa016095dced'), r.append('rpc', String(n)), r.append('rpc_auth_token', ec), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function ej(e) {
