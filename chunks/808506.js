...
function ex(e) {
    ...
    n.append('build_id', '0cfd23c3466a083c8d73855059489baf4ecedbc0'), n.append('rpc', String(t)), n.append('rpc_auth_token', J), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
