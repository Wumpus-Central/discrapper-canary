...
function eM(e) {
    ...
    (n.append('build_id', 'f2291a2d4f045c1e8446075cdf022579da09eb0d'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
