...
function ex(e) {
    ...
    n.append('build_id', 'c393773cc27286d712ac141edec45c605235eb8c'), n.append('rpc', String(t)), n.append('rpc_auth_token', J), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
