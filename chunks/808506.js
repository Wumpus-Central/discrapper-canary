...
function eM(e) {
    ...
    n.append('build_id', 'df858a5fbeea40fa30d762289987b4e38b0d39ad'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
