...
function ek(e) {
    ...
    n.append('build_id', '226c58e41806483046510c700fd1dda14dee68c9'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
