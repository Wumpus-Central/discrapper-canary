...
function eM(e) {
    ...
    (n.append('build_id', 'f35840dd76a28eca79499fd6ce6b4ed96fa8c1ca'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
