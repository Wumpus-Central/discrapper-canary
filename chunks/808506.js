...
function ex(e) {
    ...
    (n.append('build_id', '519fbc212be561a73175ccf1a9118a4e563db1d7'), n.append('rpc', String(t)), n.append('rpc_auth_token', J), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
