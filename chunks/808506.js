...
function ek(e) {
    ...
    (n.append('build_id', 'a65cf5759a5fdfb20fc6ef4287e8523d3b830f0a'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function eM(e) {
