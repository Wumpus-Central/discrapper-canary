...
function ek(e) {
    ...
    n.append('build_id', '959c573b736faf47a5dc9116d231106cfba5c5b6'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
