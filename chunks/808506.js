...
function eD(e) {
    ...
    n.append('build_id', '915f91daa2c282040b6c0be03adf1db75e2820fe'), n.append('rpc', String(t)), n.append('rpc_auth_token', z), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eL(e) {
