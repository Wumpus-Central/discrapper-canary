...
function eM(e) {
    ...
    (n.append('build_id', '845bfcf761afb50a993291e763a005335e6e06b7'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
