...
function eD(e) {
    ...
    n.append('build_id', '74f0a074cf8392e4c2e2bc4ba981364e41118fcd'), n.append('rpc', String(t)), n.append('rpc_auth_token', z), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eL(e) {
