...
function eM(e) {
    ...
    n.append('build_id', '4e5ef747e593b084259fff960c52ddb014993f35'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
