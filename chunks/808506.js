...
function eM(e) {
    ...
    (n.append('build_id', 'ee6379223316e671bd1e1512d9e29c32f8d71774'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
