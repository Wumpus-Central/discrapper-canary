...
function ex(e) {
    ...
    n.append('build_id', 'a0086814db7f13ce06bbdbeaa2975be05bad7fcf'), n.append('rpc', String(t)), n.append('rpc_auth_token', J), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
