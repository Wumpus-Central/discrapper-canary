...
function eN(e) {
    ...
    n.append('build_id', '816d5e49d0c5f5d83821bda12063e0b4ddd64ca4'), n.append('rpc', String(t)), n.append('rpc_auth_token', z), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eC(e) {
