...
function ex(e) {
    ...
    n.append('build_id', 'f4090287767b09e337692467e615422bbf5d7cff'), n.append('rpc', String(t)), n.append('rpc_auth_token', J), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
