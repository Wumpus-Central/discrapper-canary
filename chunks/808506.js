...
function ek(e) {
    ...
    n.append('build_id', 'ae40a37a359ffc44696fab02e6982d6a059970e8'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
