...
function eM(e) {
    ...
    n.append('build_id', '358a8cc01d4694aa434481e04dcb4be1225ab6e7'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
