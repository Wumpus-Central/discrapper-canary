...
function eM(e) {
    ...
    (n.append('build_id', 'dc8c2e14b9d8f0cfa052e905012ef9fa9ec6607c'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
