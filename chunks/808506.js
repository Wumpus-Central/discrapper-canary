...
function ev(e) {
    switch ((ee && et.info('[app data received]', e), e.type)) {
        case k.BmY.CONNECT:
            ...
            if (null == t) break;
            (0, d.te)(w.qU, O.Z.getDefaultLayout(w.qU), 0),
                Promise.all([(0, b.Z)(t, e.pid), s.ZP.PersistedStore.getAllStates()]).then((t) => {
                    let [n, i] = t,
                        { pid: r, token: a } = e;
                    g.lW({
...
function eT(e) {
    let { locked: t, pid: n } = e,
        i = F.get(n);
    if ((K.has(n) && ed(void 0), t || 'READY' === i || 'CRASHED' === i))
        t ? q.delete(n) : q.add(n),
            $.clear(),
            (null == eb || (clearTimeout(eb), (eb = null), !t)) &&
                (t
                    ? eI(t, n)
                    : (eb = setTimeout(() => {
                          eI(t, n), (eb = null);
...
function eN(e) {
    ...
    n.append('build_id', '5e1822788a77367642a11ed9faffa2ce891ae9ca'), n.append('rpc', String(t)), n.append('rpc_auth_token', z), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eC(e) {
...
class eZ extends (r = s.ZP.Store) {
    ...
    isInputLocked(e) {
        return T.Z.isOverlayOOPEnabledForPid(e) ? A.ZP.isInputLocked(e) : !q.has(e);
    }
    ...
    isSupported() {
        return !!A.ZP.isOverlayV3Enabled() || U.iP;
    }
    get enabled() {
