...
function ex(e) {
    ...
    n.append('build_id', 'c385e627b4c4cd6679116422bae5ae4fade6c0d1'), n.append('rpc', String(t)), n.append('rpc_auth_token', J), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
