...
function eM(e) {
    ...
    (n.append('build_id', 'd08a11fd844b80fd54fd252f2b86d4c193705d59'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
