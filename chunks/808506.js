...
function eM(e) {
    ...
    n.append('build_id', '254f7bbeb7895b94e5ee90f1d7e1be5200b4d2ae'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
