...
function ek(e) {
    ...
    n.append('build_id', 'e311838116f4d8cd4c10d4f31a7094beb36ba95e'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
