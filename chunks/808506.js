...
function ek(e) {
    ...
    n.append('build_id', '5a46a4ff48e29019644f2b657291b3f3013de0f9'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
