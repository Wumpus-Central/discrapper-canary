...
function eM(e) {
    ...
    n.append('build_id', '9c6c65036e1a93685f8e9577e14fb93868fb6277'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
