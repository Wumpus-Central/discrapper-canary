...
function eM(e) {
    ...
    n.append('build_id', '6c9fe4b3ddce2f5cb7ffb668008666e1a2990552'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
