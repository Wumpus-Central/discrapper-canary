...
function eM(e) {
    ...
    (n.append('build_id', '2e4dab33800162a27ea128cfea8c1ba4ff10a349'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
