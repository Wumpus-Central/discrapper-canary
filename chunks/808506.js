...
function ek(e) {
    ...
    n.append('build_id', 'e67e2e1d225d70d8bfce78b3f686fc693c02ef5d'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
