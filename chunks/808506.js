...
function ek(e) {
    ...
    n.append('build_id', 'ce2fe16e1738e70c4a65fbb45a40f5e6bb850152'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
