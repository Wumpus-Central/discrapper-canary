...
function eM(e) {
    ...
    (n.append('build_id', '04cce36aa2e0efd5aeb4f1cb6c58b9ea77737aed'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
