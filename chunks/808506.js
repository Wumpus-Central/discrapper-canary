...
function ek(e) {
    ...
    n.append('build_id', '1ac3ed71efb393503f595d0d551f2a6bbdcec382'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
