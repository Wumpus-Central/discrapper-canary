...
function eM(e) {
    ...
    n.append('build_id', '5722f444a10401ff5f6a55d2c96c8eaba5f3e42c'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
