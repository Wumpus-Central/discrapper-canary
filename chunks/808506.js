...
function eM(e) {
    ...
    n.append('build_id', 'ca86e1afa32cb7da2091069f38a5497ad01d865d'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
