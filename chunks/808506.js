...
function ek(e) {
    ...
    n.append('build_id', '4612a08c16713966aff6e39d566f857e1d402112'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
