...
function eM(e) {
    ...
    (n.append('build_id', '060c833dbb5fd36192c8e3bb8eb5b5a92411cc7c'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
