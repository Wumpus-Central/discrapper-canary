...
function eM(e) {
    ...
    n.append('build_id', '940174ef2ae740aca4691aca7b015b6ed1e0b9ab'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
