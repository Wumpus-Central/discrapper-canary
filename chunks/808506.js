...
function eV(e) {
    ...
    r.append('build_id', 'c9dd30fdcc5b39af1f9fe551702ffccfc14f177e'), r.append('rpc', String(n)), r.append('rpc_auth_token', ec), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function ej(e) {
