...
function ek(e) {
    ...
    n.append('build_id', '390660722035c3ec33e950d1672ac0ec4473bccf'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
