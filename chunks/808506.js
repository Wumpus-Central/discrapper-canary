...
function ex(e) {
    ...
    (n.append('build_id', 'a7f87045cfb25436be5ea31952904406bb87cb95'), n.append('rpc', String(t)), n.append('rpc_auth_token', J), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
