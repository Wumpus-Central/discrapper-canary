...
function ek(e) {
    ...
    n.append('build_id', '3aa3bc29a70f279a28f7419a0d2eeb57ae6613ea'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
