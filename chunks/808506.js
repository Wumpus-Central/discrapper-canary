...
function eD(e) {
    ...
    n.append('build_id', '8ac84824edd03d15f1ee72b9061f632d1830719f'), n.append('rpc', String(t)), n.append('rpc_auth_token', z), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eL(e) {
