...
function ek(e) {
    ...
    n.append('build_id', 'b145264d88adca08335c4edc8954b56d890c0c0e'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
