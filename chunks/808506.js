...
function eM(e) {
    ...
    (n.append('build_id', '999c73cea49b59f7c68f174c18c8eecde3adfb82'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
