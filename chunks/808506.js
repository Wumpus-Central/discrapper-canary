...
function eN(e) {
    ...
    n.append('build_id', '61058678ce8b4c0ffe2b4d866c28c956f34447ad'), n.append('rpc', String(t)), n.append('rpc_auth_token', z), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eC(e) {
