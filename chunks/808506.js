...
function ek(e) {
    ...
    n.append('build_id', 'f038786a1e1634aefbadc84af8d4dae8c52063cb'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
