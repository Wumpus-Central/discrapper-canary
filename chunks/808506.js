...
function eM(e) {
    ...
    (n.append('build_id', 'f2941567867fc51a58f9a532453fc6a451f1a78f'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
