...
function ek(e) {
    ...
    n.append('build_id', '6b323d9262264c873d72800a473ebbb3c52c0ed2'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
