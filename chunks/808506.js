...
function ek(e) {
    ...
    n.append('build_id', '8c072c44d00b49c112386f50946fe4870b905619'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
