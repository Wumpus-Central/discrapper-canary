...
function eM(e) {
    ...
    (n.append('build_id', 'f6ef848162083ae298188737e7fe088f5050bbfd'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
