...
function ex(e) {
    ...
    n.append('build_id', '0b2e80692cc1397dad6a2c21c19852480ff7b853'), n.append('rpc', String(t)), n.append('rpc_auth_token', J), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
