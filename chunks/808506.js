...
function eN(e) {
    ...
    n.append('build_id', 'c0245879b100d41751efe59c21762ea13f609f91'), n.append('rpc', String(t)), n.append('rpc_auth_token', z), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eC(e) {
