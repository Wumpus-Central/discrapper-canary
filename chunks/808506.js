...
function ek(e) {
    ...
    n.append('build_id', 'dd15959f2c809967629decef804babae465177a1'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
