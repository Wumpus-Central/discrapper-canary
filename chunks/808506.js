...
function eS(e) {
    ...
    n.append('build_id', '59252ca318f0f2c5a9f2eaa950ebba8efe1d082b'), n.append('rpc', String(t)), n.append('rpc_auth_token', W), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eA(e) {
