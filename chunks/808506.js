...
function eM(e) {
    ...
    n.append('build_id', 'dbf013836b9e2ab83f757cee415e2bb317340a5a'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
