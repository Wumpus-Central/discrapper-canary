...
function eM(e) {
    ...
    (n.append('build_id', 'b554c850ec5cfdc934bc2fb8bfdcff96ba4ec4e3'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
