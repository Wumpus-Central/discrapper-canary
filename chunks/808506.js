...
function ek(e) {
    ...
    n.append('build_id', '270a76e226bcc332fdef26287f82e70e321d72b2'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
