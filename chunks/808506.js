...
function eM(e) {
    ...
    (n.append('build_id', '208575e540dc5dac76c2d9604a7d58b4d0299d08'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
