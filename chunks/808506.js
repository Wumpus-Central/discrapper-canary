...
function eS(e) {
    ...
    n.append('build_id', '14fe6153bee723877d5569e184a7231f63cc9fb2'), n.append('rpc', String(t)), n.append('rpc_auth_token', W), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eA(e) {
