...
function eM(e) {
    ...
    n.append('build_id', 'ac9c6c9137459402638e70b50222113379a322cc'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
