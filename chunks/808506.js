...
function eM(e) {
    ...
    n.append('build_id', '9542c950e91442950c65ffbbd16570e15eab2fd5'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
