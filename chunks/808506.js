...
function eM(e) {
    ...
    n.append('build_id', 'ad753f80141ab6dbe9f990728efd7a5ef7446f6b'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
