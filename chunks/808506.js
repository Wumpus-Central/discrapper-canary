...
function eM(e) {
    ...
    (n.append('build_id', '695ee08a03002b400767ac0a0102430b02c922e4'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
