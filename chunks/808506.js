...
function ex(e) {
    ...
    n.append('build_id', '59fa3619805726f46ff0c77de4308f3f1173746b'), n.append('rpc', String(t)), n.append('rpc_auth_token', J), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
