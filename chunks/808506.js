...
function ek(e) {
    ...
    n.append('build_id', '41c5d088ef6a50eeacb88afbbc8186cd13b5a7db'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
