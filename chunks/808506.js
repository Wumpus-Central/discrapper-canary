...
function eN(e) {
    ...
    n.append('build_id', '923493c8db8617b0bee0ebfb42dcf8539a8a4292'), n.append('rpc', String(t)), n.append('rpc_auth_token', z), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eC(e) {
