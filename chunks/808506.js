...
function ek(e) {
    ...
    n.append('build_id', '4459b986b3ec296bc2b2b1088894539dc3311681'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
