...
function eM(e) {
    ...
    n.append('build_id', 'c1dea38bfff8876286851471c4fe4776d7eaaf40'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
