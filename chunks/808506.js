...
function ek(e) {
    ...
    n.append('build_id', '76a80aa38dfd2eaa59b75c6b3714d36d078da5cb'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
