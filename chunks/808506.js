...
function ek(e) {
    ...
    n.append('build_id', 'cab9ffe56e1a332512047f0932acd18fd8563be2'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
