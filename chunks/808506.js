...
function ek(e) {
    ...
    n.append('build_id', '9267c4b5b34d67cd20e5ee8946eabb69a0e42d18'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
