...
function ek(e) {
    ...
    n.append('build_id', '21d9046c765d7e2196d4f23540f207a84d090983'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
