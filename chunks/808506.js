...
function eM(e) {
    ...
    (n.append('build_id', '2280a88c2654c95d50147451b5a651d85defa803'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
