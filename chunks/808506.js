...
function eS(e) {
    ...
    n.append('build_id', '800f9f937dfee09ac4810ef17f095749cafbb616'), n.append('rpc', String(t)), n.append('rpc_auth_token', W), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eA(e) {
