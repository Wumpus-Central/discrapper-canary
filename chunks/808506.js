...
function eM(e) {
    ...
    (n.append('build_id', '450801822e4974355aff53dcbf00ca5c756c3025'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
