...
function ek(e) {
    ...
    n.append('build_id', '26180262c0ce809ac840ade47c28519d35c701ab'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
