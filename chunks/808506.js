...
function eM(e) {
    ...
    n.append('build_id', '279d352551496e969a118c946eb68bc0ee3b5f34'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
