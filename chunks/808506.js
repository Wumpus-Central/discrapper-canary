...
function ek(e) {
    ...
    n.append('build_id', 'a8332ce5fb832acaeedc1f5fe116c32ed4102671'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
