...
function ek(e) {
    ...
    n.append('build_id', '59d6fd8bcafa22bc72da4017e232f09bf746779f'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
