...
function ek(e) {
    ...
    n.append('build_id', 'ddd8687ca5a2009803a76bcf171d6c723e1f664a'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
