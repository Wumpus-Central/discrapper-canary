...
function eM(e) {
    ...
    n.append('build_id', '261801454a2a0b1b9193cb4263cbb0ed3a2acabb'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
