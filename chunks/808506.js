...
function ek(e) {
    ...
    n.append('build_id', '10e89f00ea9020949d4df0a3c271665a6af8ff76'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
