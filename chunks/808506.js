...
function eY(e) {
    ...
    r.append('build_id', '80402fe4bfec9a24c9227f91c9a90ad5e3fe2b9c'), r.append('rpc', String(n)), r.append('rpc_auth_token', ef), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function eW(e) {
