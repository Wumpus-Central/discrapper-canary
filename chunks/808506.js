...
function ek(e) {
    ...
    (n.append('build_id', '3758bebe618344c1023fa1fe35a00edcac19cdbb'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function eM(e) {
