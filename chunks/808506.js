...
function ek(e) {
    ...
    n.append('build_id', 'fd9b6708cdb569b609bba1c7abf03a76e8a81fc5'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
