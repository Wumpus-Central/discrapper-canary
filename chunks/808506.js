...
function ek(e) {
    ...
    n.append('build_id', 'ea1e03f6ee1d3829ad2876d09d31722188efb6b2'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
