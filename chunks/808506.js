...
function eM(e) {
    ...
    (n.append('build_id', 'a34c5c9121364abd56ace63c88862416d4003f11'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
