...
function ek(e) {
    ...
    n.append('build_id', '97da7205111cb02bf0cd8739273a44486f5dfb2a'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
