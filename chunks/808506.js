...
function eY(e) {
    ...
    r.append('build_id', 'e18a9e56939038625f0b744952efd12df1656146'), r.append('rpc', String(n)), r.append('rpc_auth_token', ef), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function eW(e) {
