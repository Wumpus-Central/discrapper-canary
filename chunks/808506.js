...
function eM(e) {
    ...
    (n.append('build_id', '2b7d293b16adf56fe31bfe7d44e56a261b7796fc'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
