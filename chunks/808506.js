...
function eM(e) {
    ...
    n.append('build_id', 'b8fc8c70f064c91379c2c0ddfdb4ec67dbc9ebef'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
