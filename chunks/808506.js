...
function eY(e) {
    ...
    r.append('build_id', '5326f1c25924523c86beb00559e2eaa1d769fc5c'), r.append('rpc', String(n)), r.append('rpc_auth_token', ef), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function eW(e) {
