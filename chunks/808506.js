...
function eM(e) {
    ...
    n.append('build_id', '8162ad6bc76aa4ada2694efd7867e597c71501a6'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
