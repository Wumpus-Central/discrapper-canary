...
function eM(e) {
    ...
    n.append('build_id', 'e77817286d9078d1ae4408e5c7840a8263764873'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
