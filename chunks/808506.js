...
function eY(e) {
    ...
    r.append('build_id', '9b8733d676d42ca06798af9d2b00d2576a68ff32'), r.append('rpc', String(n)), r.append('rpc_auth_token', ef), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function eW(e) {
