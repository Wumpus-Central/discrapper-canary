...
function eY(e) {
    ...
    r.append('build_id', '85142c2cbb4c43b3a92afb6ea4f6d863bfa0d6e5'), r.append('rpc', String(n)), r.append('rpc_auth_token', ef), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function eW(e) {
