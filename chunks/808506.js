    ...
    ef = (0, a.H)({
        ...
        onTimeout: (e, t) => {
            ...
            (ec(
                ...
                P.default.track(M.rMx.OVERLAY_HOOK_RESULT, el((0, k.getPID)())));
        },
        timeoutMs: 180000
    });
function e_(e, t) {
...
async function em(e) {
    try {
        if (x.ZP.supportsFeature(M.eRX.CREATE_HOST_ON_ATTACH))
            if (W.size > 0) {
...
async function eb(e) {
    ...
    if (
        ...
        ef.isMutexHeld() || eo.error('updateIntendedOverlayPIDs: overlayMutex is not held.', e),
        !$ && null != e)
    )
    ...
    async function r(e) {
        ...
        try {
            ...
            ((0, y.D1)(n, v.gl.Hook), eo.error('Failed to deconstruct tracked game '.concat(e), n), (H[e] = t), Q.add(e));
        }
    }
    let i = !1;
    if (null == e || !z) {
...
function eS(e, t, n) {
    ...
    (ec(e, B({}, o)),
        (0, d.te)(k.OVERLAY_LAYOUT_ID, R.Z.getDefaultLayout(k.OVERLAY_LAYOUT_ID), U.bv, {
            width: n.graphics_width,
            height: n.graphics_height
        }),
        f.Z.updateOverlayState(e, v.mM.OVERLAY_RENDERING));
    let s = el(e);
    (P.default.track(M.rMx.OVERLAY_HOOK_RESULT, s), eo.info('Overlay connection to '.concat(e, ' ').concat(t ? 'succeeded' : 'failed'), s), t ? eh(e, 'CONNECTED', 'CONNECTING') : eh(e, 'CONNECT_FAILED', 'CONNECTING'));
}
function eA() {
...
function eD(e) {
    let { locked: t, pid: n } = e,
        r = W.get(n);
    if ((Q.has(n) && ey(void 0), null != r && null != H[n]) && (t || 'READY' === r || 'CRASHED' === r)) {
        if ((t ? ee.delete(n) : ee.add(n), ei.clear(), null != eP && (clearTimeout(eP), (eP = null), t))) return;
        t
            ? eR(t, n)
            : (eP = setTimeout(() => {
                  (eR(t, n), (eP = null));
...
function ek(e) {
    ...
    (n.append('build_id', '4f51c3d0373ec286d71df64ac16ea7de61cc1686'), n.append('rpc', String(t)), n.append('rpc_auth_token', J), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ej(e) {
...
function eB() {
    (($ = !1), f.Z.setFocusedPID(null), ey(void 0), eo.verbose('OverlayBridgeStore: handleConnectionClosed'));
}
function eZ() {
    return !0;
}
...
class eX extends (i = o.ZP.Store) {
    ...
    getFocusedPID() {
        ...
        return null != e && A.ZP.isOverlayV3EnabledForPID(e) ? e : X;
    }
