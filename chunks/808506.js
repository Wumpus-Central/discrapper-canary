...
function ek(e) {
    ...
    n.append('build_id', '83b022959d44ee184b070fdc522066b288cb9b0e'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
