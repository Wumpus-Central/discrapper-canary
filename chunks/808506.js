...
function eM(e) {
    ...
    n.append('build_id', '1c599b5303f0e71015d079d04f2aa6ff60f7b4a1'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
