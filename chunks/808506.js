...
function ek(e) {
    ...
    (n.append('build_id', '501414f08e100bf10a91a59bc8ce58f5ec103b25'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function eM(e) {
