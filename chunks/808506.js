...
function ek(e) {
    ...
    (n.append('build_id', '907ffe9638dfbeca9bf80302739c88c88b5e04f2'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function eM(e) {
