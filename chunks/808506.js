...
function eD(e) {
    ...
    n.append('build_id', '33dfe58f0e9e6f60066757753527a9b2e4e63a63'), n.append('rpc', String(t)), n.append('rpc_auth_token', z), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eL(e) {
