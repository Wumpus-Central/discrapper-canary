...
function ek(e) {
    ...
    n.append('build_id', '8dbe0be91b13abc957d62b673d2f2f7bfb8d16f9'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
