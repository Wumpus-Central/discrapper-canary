...
function ek(e) {
    ...
    n.append('build_id', '9b7caff7633ca0e50e6917ef1a09c36059a4bf27'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
