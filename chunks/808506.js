...
function eM(e) {
    ...
    n.append('build_id', '0afc354133a8d303b38fa0d67d641095db8b5e2c'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
