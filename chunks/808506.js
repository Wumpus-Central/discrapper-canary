...
function eM(e) {
    ...
    n.append('build_id', '2f8e3be8f7e8b73da81016dad4ab5732a2f7f59e'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
