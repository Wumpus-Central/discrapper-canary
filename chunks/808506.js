...
async function em(e) {
    try {
        ...
        eo.error('reconcileHostProcess', t), ev((0, M.getPID)());
        try {
...
let ey = e_('updateIntendedOverlayPIDs', (e) => (eo.info('updateIntendedOverlayPIDs', e), eb(e))),
    ev = e_('clearPID', (e) => {
        ...
        T.default.isOverlayV3EnabledForPID(e) || (0, M.setPID)(M.UNSET_PID);
    });
function eO() {
...
function eC(e) {
    switch ((ea && eo.info('[app data received]', e), e.type)) {
        case j.BmY.CONNECT:
            ...
            if (null == t) break;
            (0, d.te)(M.OVERLAY_LAYOUT_ID, R.Z.getDefaultLayout(M.OVERLAY_LAYOUT_ID), 0),
                Promise.all([(0, O.Z)(t, e.pid), o.ZP.PersistedStore.getAllStates()]).then((t) => {
                    let [n, r] = t,
                        { pid: i, token: a } = e;
                    g.lW({
...
function eM(e) {
    ...
    n.append('build_id', '5d26118b18d464baea34bf5ae4c1255e10b1390c'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
...
function eB() {
    (Q = !1), f.Z.setFocusedPID(null), ey(void 0), eo.verbose('OverlayBridgeStore: handleConnectionClosed');
}
function eV() {
    return !0;
}
...
class eX extends (i = o.ZP.Store) {
    initialize() {
        !U.iP || __OVERLAY__ || (this.waitFor(y.ZP, b.Z, N.default, T.default, I.default), this.syncWith([b.Z], ez), g.sr(eC, eN), N.default.addChangeListener(eA), l.Z.addInterceptor(en.queueDispatch));
    }
    ...
    isInputLocked(e) {
        return I.default.isOverlayOOPEnabledForPid(e) ? T.default.isInputLocked(e) : !ee.has(e);
    }
    DEV_isInputLockedV3(e) {
        return T.default.isInputLocked(e);
    }
    DEV_isInputLocked(e) {
        return !ee.has(e);
    }
    ...
    get enabled() {
        return T.default.isOverlayV3Enabled() ? T.default.enabled : z;
    }
    get legacyEnabled() {
        return !T.default.isOverlayV3Enabled() && q;
    }
    ...
    getFocusedPID() {
        ...
        return null != e && T.default.isOverlayV3EnabledForPID(e) ? e : X;
    }
    ...
    isReady(e) {
        return T.default.isOverlayV3EnabledForPID(e) ? T.default.isReady(e) : 'READY' === W.get(e);
    }
    isCrashed(e) {
        return !T.default.isOverlayV3EnabledForPID(e) && 'CRASHED' === W.get(e);
    }
