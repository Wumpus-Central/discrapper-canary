...
function eY(e) {
    ...
    r.append('build_id', '9db51d84f7e9cf0bfe784f5416b2b8351136b8ac'), r.append('rpc', String(n)), r.append('rpc_auth_token', ef), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function eW(e) {
