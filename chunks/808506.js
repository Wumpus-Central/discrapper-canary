...
function ek(e) {
    ...
    (n.append('build_id', '324504f468ec67dd8c749512f3f2c623c8d10be3'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function eM(e) {
