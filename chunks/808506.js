...
function eM(e) {
    ...
    n.append('build_id', '230af8433cada9ec48dce2788f15ab0fd119ab90'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
