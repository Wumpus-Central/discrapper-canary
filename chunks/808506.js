...
function ek(e) {
    ...
    n.append('build_id', '5db713d72ef0cdf6b568df36540ccff20fc806b2'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
