...
function eM(e) {
    ...
    (n.append('build_id', '1d5daf127244e4219387a36fc520da41ea252f15'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
