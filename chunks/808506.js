...
function ex(e) {
    ...
    (n.append('build_id', '6945d9236b906433bec9083e51efdab93aaae72c'), n.append('rpc', String(t)), n.append('rpc_auth_token', J), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
