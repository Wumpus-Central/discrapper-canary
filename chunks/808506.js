...
function eM(e) {
    ...
    (n.append('build_id', 'c4203e9019d7fdacf630a7752bb3d88f644d7360'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
