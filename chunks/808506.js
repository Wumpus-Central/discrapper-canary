...
function eM(e) {
    ...
    (n.append('build_id', 'bd26584382badeb2dc0fdb6fe0f64e263ed4e074'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
