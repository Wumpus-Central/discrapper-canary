...
function ek(e) {
    ...
    (n.append('build_id', '1623902e41bdd6a1651f9952902526979b93c910'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function eM(e) {
