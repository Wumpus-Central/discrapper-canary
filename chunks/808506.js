...
function eM(e) {
    ...
    (n.append('build_id', '9b36738cbecff91c242d440779ea3d14f3627fa0'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
