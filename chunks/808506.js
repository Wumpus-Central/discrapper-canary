...
function ek(e) {
    ...
    n.append('build_id', 'b6d060c4d83461ce4948749532648aad5bada98e'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
