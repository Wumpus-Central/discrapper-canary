...
function eM(e) {
    ...
    n.append('build_id', '6cf8cfa52a982174825a1a40737a45a175f5d855'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
