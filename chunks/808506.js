...
function ek(e) {
    ...
    n.append('build_id', '3defe637f3b4dc76b33e776d2b7ff4ff11218037'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
