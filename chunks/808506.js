...
function eN(e) {
    ...
    n.append('build_id', '4a8810b4871ef89a6faf804667937d3f03dd1113'), n.append('rpc', String(t)), n.append('rpc_auth_token', z), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eC(e) {
