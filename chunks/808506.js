...
function eM(e) {
    ...
    n.append('build_id', 'fc30f331159c5b0ae6c5c1067d3ce5c3da61adca'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
