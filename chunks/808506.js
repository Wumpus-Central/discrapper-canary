...
function eM(e) {
    ...
    (n.append('build_id', '7d2cfa2a96d0133d5746976d97902dcc4aa6f8c3'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
