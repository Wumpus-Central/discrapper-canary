...
function ek(e) {
    ...
    n.append('build_id', 'ae8eac62e0022487840a526225c9dc40b6012ffa'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
