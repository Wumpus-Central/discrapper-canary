...
function ek(e) {
    ...
    n.append('build_id', '2e33ef821807a3fa95d4680415092b4acfa44b22'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
