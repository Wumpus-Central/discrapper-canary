...
function eY(e) {
    ...
    r.append('build_id', 'ea9467415ed0487943b19a9c1849513404f8e8a3'), r.append('rpc', String(n)), r.append('rpc_auth_token', ef), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function eW(e) {
