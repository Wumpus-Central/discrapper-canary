...
function ex(e) {
    ...
    n.append('build_id', 'adb91a7e26b5b9785ca392ea3cd653f2515eacd4'), n.append('rpc', String(t)), n.append('rpc_auth_token', J), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
