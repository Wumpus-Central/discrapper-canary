...
function eM(e) {
    ...
    n.append('build_id', '68678e60ec996a99713ca378e9304c3f95953d89'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
