...
function eY(e) {
    ...
    r.append('build_id', 'a18c580ad8004a694ceb0080b5ccfcbe08a2c1ac'), r.append('rpc', String(n)), r.append('rpc_auth_token', ef), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function eW(e) {
