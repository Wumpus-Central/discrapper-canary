...
function eM(e) {
    ...
    n.append('build_id', '66abfa920aee1d25425e0e4cfd0b71b29abe0f54'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
