...
function eV(e) {
    ...
    r.append('build_id', '7a0b0fc9c2667a6e972df684ef20cf21f963a686'), r.append('rpc', String(n)), r.append('rpc_auth_token', ec), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function ej(e) {
