...
function eM(e) {
    ...
    (n.append('build_id', '1645f11d3d937707e97ba4b1071e4e08041fe7d2'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
