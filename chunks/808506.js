...
function eH(e) {
    ...
    r.append('build_id', '7db62bec615f1c2fde875b103ee9b7da9ed17d45'), r.append('rpc', String(n)), r.append('rpc_auth_token', ed), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function eY(e) {
