...
function eM(e) {
    ...
    n.append('build_id', '98b22c8fad0eabd3ecb1b46db46ebfba2963af31'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
