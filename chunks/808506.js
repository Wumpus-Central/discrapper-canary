...
function ek(e) {
    ...
    n.append('build_id', '46a99ab6735f2c88e1dd90b244210b7cbf7dfee6'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
