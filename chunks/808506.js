...
function eM(e) {
    ...
    n.append('build_id', '26494d011f6224072465219688fd5a542f51de5e'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
