...
function ex(e) {
    ...
    n.append('build_id', '01b7c776625e0ff9a7f226cb7afa0a258da72d96'), n.append('rpc', String(t)), n.append('rpc_auth_token', J), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
