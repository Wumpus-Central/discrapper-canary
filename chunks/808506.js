...
function ek(e) {
    ...
    n.append('build_id', '7081784fd35f597f09bef31583a26e558fad8958'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
