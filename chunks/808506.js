...
function ek(e) {
    ...
    n.append('build_id', 'e940cb4b092a4d9cad676b7add96d323a789a0ec'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function eM(e) {
