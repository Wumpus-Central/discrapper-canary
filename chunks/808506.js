...
function eY(e) {
    ...
    r.append('build_id', 'f20595e5acae13b96a3024becf4c2e10da8f21cc'), r.append('rpc', String(n)), r.append('rpc_auth_token', ef), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function eW(e) {
