...
function ex(e) {
    ...
    (n.append('build_id', '74c06d1c9bd86d7438b1122f8cf190c522fcf373'), n.append('rpc', String(t)), n.append('rpc_auth_token', J), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
