...
function eM(e) {
    ...
    n.append('build_id', '770faa4dfa3f8f702d8820ac67aee7f93f21df2a'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
