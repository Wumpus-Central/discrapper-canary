...
function eM(e) {
    ...
    n.append('build_id', 'be19031b73833c14722e79f8d51678d438a8fb4e'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function ek(e) {
