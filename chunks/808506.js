...
function eM(e) {
    ...
    (n.append('build_id', 'b4039c3de2440bd4a802a055deb41ae5e17ccce4'), n.append('rpc', String(t)), n.append('rpc_auth_token', $), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString())));
}
function ek(e) {
