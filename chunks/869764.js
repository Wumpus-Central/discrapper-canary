...
function O(e) {
    ...
    let { action: t, completed: a } = e,
        { channelId: i, title: m, emoji: h, icon: g } = t,
        { id: p, name: x } = null != h ? h : {},
        j = (0, s.e7)([u.Z], () => u.Z.getChannel(i)),
        C = (0, o.ZP)(j, !0),
        v = (0, s.e7)([f.Z], () => f.Z.can(_.Plq.VIEW_CHANNEL, j)),
        Z = r.useMemo(() => {
            if (null != j) return () => (0, b.gp)(j.guild_id, j.id);
        }, [j]);
    if (null == j || !v) return null;
    let I = null != (n = (0, d.KS)(j)) ? n : c.VL1;
    return (0, l.jsx)(N, {
        variant: 'channel',
        channelId: i,
        title: m,
...
function P(e) {
    ...
    r.useEffect(() => {
        var e;
        null == a && (null == o ? void 0 : o.flags) != null && (0, x.yE)(null != (e = o.flags) ? e : 0, Z.q.STARTED_HOME_ACTIONS) && (0, b.Fg)(n);
                          ...
                          children: [
                              ...
                              (0, l.jsx)('div', {
                                  ...
                                  children: (0, l.jsx)(c.Text, {
                                      variant: 'text-md/semibold',
                                      color: 'header-primary',
                                      children: I.intl.string(I.t['K/i3iY'])
                                  })
                              })
                          ]
                      })
