...
function eu(e) {
    let t,
        n,
        { recommendationsSection: l, remainingActivities: a, isInstallOnDemand: o, position: s, context: d } = e,
        f = l.title;
    switch (l.type) {
    ...
    return (0, i.jsxs)('div', {
        children: [
            ...
            (0, i.jsx)('div', {
                ...
                children: x.map((e, n) => {
                    let r,
                        { collectionItemId: l, collectionItemImageHash: a, application: o, installOnDemand: c, showsPromoted: u } = e;
                    return (
                        null != l &&
                            null != a &&
                            (r = (0, O.$_)({
