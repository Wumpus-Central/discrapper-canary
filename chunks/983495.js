...
var Q = n(478437),
    ...
    X = n(562153),
    J = n(451438);
let Z = (0, W.createChannelRecord)({ id: "1", type: Q.r.DM });
function ee(e) {
    let {
            user: t,
            guildId: n,
...
let ef = r.forwardRef(function (e, t) {
    ...
    eh = r.forwardRef(function (e, t) {
        let {
            ...
            v = (0, N.NR)(),
            { trackUserProfileAction: y } = (0, C.NJ)(),
            R = 1.25 * (null != n),
            j = 36 + R,
            P = 144 + R,
            L = r.useRef(null),
            ...
            [F, D] = r.useState(!w && p),
            H = p && $,
            Y = c === et.d.MODAL || c === et.d.MODAL_V2,
            Q = r.useCallback((e) => (Y ? e : Math.min(e, P)), [P, Y]),
            B = (0, o.bG)([S.Ay], () => S.Ay.useReducedMotion),
            [z] = r.useState(() => new u.Ep());
        r.useEffect(() => () => z.stop(), [z]),
            r.useEffect(() => {
                v?.onInteractionPopoutTargetRefChange(L);
            }, [v]);
        let [q, K] = (0, A.z)(() => ({ maxHeight: `${_.current}px`, config: { clamp: !0, duration: 150 } }));
        function W(e) {
            F &&
                (e
                    ? K({ maxHeight: `${Q(I.current)}px`, delay: 300 * !B, config: { clamp: !0, duration: 150 * !B } })
                    : K({ maxHeight: `${Math.min(_.current, j)}px`, delay: 0 }),
                B ? k(!e) : z.start(e ? 300 : 150, () => k(!e)));
        }
        r.useLayoutEffect(() => {
            if ((U(!0), null == b.current || null == M.current || !H)) return;
            let e = b.current.getBoundingClientRect().height,
                t = M.current.getBoundingClientRect().height,
                n = Q(t);
            D(n > e), (_.current = e), (I.current = t), K({ maxHeight: `${O ? Math.min(_.current, j) : n}px` });
        }, [H, i, n, K, O, j, Q]);
        let X =
                null != n
                    ? (0, l.jsx)(T.A, { emoji: n, animate: d, hideTooltip: !1, tooltipDelay: V.In, className: ec.H0 })
                    : null,
            J = null != i ? (0, l.jsx)(f.E, { variant: "text-sm/normal", className: ec.qS, children: i }) : null,
            Z =
                void 0 !== E && null == n
                    ? (0, l.jsx)(f.E, {
                          variant: "text-sm/normal",
                          color: "text-muted",
                          "aria-label": `${G.intl.string(G.t.EVV6uZ)}: ${E}`,
                          className: a()(ec.qS, ec.R9),
                          children: E ?? "",
                      })
                    : null,
            ee = null == J || "" === i ? Z : J,
            en = (0, l.jsxs)("div", { className: ec.Qs, children: [X, ee] }),
            el = (0, l.jsxs)("div", { ref: b, className: a()(ec.Qs, ec.mj), children: [X, ee] }),
            er = (0, l.jsxs)("div", { ref: M, className: a()(ec.Qs, ec.m2, ec.mj), children: [X, ee] }),
            ei = (0, l.jsx)("div", {
                ref: t,
                className: ec.A7,
                children: (0, l.jsx)("span", {
                    ...
                    children: (0, l.jsxs)(s.animated.div, {
                        style: q,
                        className: a()(ec.Qs, { [ec.m2]: !O && Y, [ec.p$]: !O && !Y }),
                        children: [X, ee],
                    }),
                }),
            }),
            ea = (0, l.jsxs)(ed, { children: [en, el, er] });
        return null == g
            ? (0, l.jsxs)(l.Fragment, {
                  children: [
                      ea,
                      (0, l.jsxs)("div", {
                          ...
                          className: a()(ec.kL, h),
                          onMouseEnter: () => {
                              y({ action: "HOVER_CUSTOM_STATUS" }), W(!0);
                          },
                          onMouseLeave: () => {
                              W(!1);
                          },
            ...
            : (0, l.jsxs)(l.Fragment, {
                  children: [
                      ...
                      (0, l.jsxs)("div", {
                          ...
                          onBlur: (e) => {
                              L.current?.contains(e.relatedTarget) || (g(!1), W(!1));
                          },
                          onMouseEnter: () => {
                              y({ action: "HOVER_CUSTOM_STATUS" }), g(!0), W(!0);
                          },
                          onMouseLeave: () => {
                              g(!1), W(!1);
                          },
