...
var Y = n(478437),
    ...
    X = n(562153),
    Q = n(451438);
let J = (0, q.createChannelRecord)({ id: "1", type: Y.r.DM });
function ee(e) {
    let {
            user: t,
            guildId: n,
...
let e_ = r.forwardRef(function (e, t) {
    ...
    eE = r.forwardRef(function (e, t) {
        let {
            ...
            S = (0, L.NR)(),
            { trackUserProfileAction: N } = (0, O.NJ)(),
            C = 1.25 * (null != n),
            R = 36 + C,
            D = 144 + C,
            y = r.useRef(null),
        ...
        let [z, Z] = (0, h.z)(() => ({ maxHeight: `${M.current}px`, config: { clamp: !0, duration: 150 } }));
        function q(e) {
            V &&
                (e
                    ? Z({ maxHeight: `${Y(P.current)}px`, delay: 300 * !K, config: { clamp: !0, duration: 150 * !K } })
                    : Z({ maxHeight: `${Math.min(M.current, R)}px`, delay: 0 }),
        ...
        r.useLayoutEffect(() => {
            ...
            let e = v.current.getBoundingClientRect().height,
                ...
                n = Y(t);
            B(n > e), (M.current = e), (P.current = t), Z({ maxHeight: `${x ? Math.min(M.current, R) : n}px` });
        }, [j, a, n, Z, x, R, Y]);
        let X =
                null != n
            ...
            : (0, i.jsxs)(i.Fragment, {
                  children: [
                      ...
                      (0, i.jsxs)("div", {
                          ...
                          onBlur: (e) => {
                              y.current?.contains(e.relatedTarget) || (T(!1), q(!1));
                          },
                          onMouseEnter: () => {
                              N({ action: "HOVER_CUSTOM_STATUS" }), T(!0), q(!0);
                          },
                          onMouseLeave: () => {
                              T(!1), q(!1);
                          },
