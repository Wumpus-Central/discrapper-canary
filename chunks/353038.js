...
class C extends (i = l.Component) {
    ...
    componentDidMount() {
        this.setDOMPositions(_(this.props.anchor)), this.setDOMSize(E(this.props.size, this.props.minSize.width, this.props.minSize.height)), d.S.subscribe(h.CkL.OVERLAY_V3_SHOW_WIDGETS, this.handleShowUI);
    }
    ...
    handleDragMove(e, t) {
        ...
        let { width: m, height: g } = S(n, this.size),
            ...
            b = u ? (0, p.R)(v) : I('RESIZE_SOUTH_EAST', v);
    ...
    handleResizeMove(e, t) {
        ...
        this.setDOMSize(y(g({}, E), { fixed: this.size.fixed }), !0), (0, u.Z)(_, this.dragState.dragOrientedCoords) || ((this.dragState.dragOrientedCoords = _), this.setDOMPositions(this.dragState.dragOrientedCoords)), f || (null != s && s(), this.setState({ operationStarted: !0 })), null != c && c(n, h, this.anchor, this.size);
    }
    setDOMPositions(e) {
        let { top: t, left: n, bottom: i, right: r } = e,
            { current: o } = this.ref;
