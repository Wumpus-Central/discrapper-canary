...
class P extends s.PureComponent {
    ...
    componentDidMount() {
        let { guildId: e } = this.props,
            { scrollTop: t } = E.A.getGuildDimensions(e);
        this.setAnimatedValue(t ?? 0);
    }
    componentDidUpdate(e) {
        let { guild: t, guildId: n } = this.props;
        if (e.guild !== t) {
            let { scrollTop: e } = E.A.getGuildDimensions(n);
            this.setAnimatedValue(e ?? 0);
        }
    }
    renderSettings(e) {
        let { closePopout: t } = e;
        return (0, i.jsx)(j.A, { onClose: t });
    }
    handleScroll = (e) => {
        let { scrollTop: t } = e;
                ...
                (0, i.jsx)("div", {
                    ...
                    children:
                        null != n
                            ...
                            : (0, i.jsx)(A.A, { withBannerPadding: !1 }),
                }),
                null != n &&
                    (0, i.jsx)("section", {
                        className: M.C3,
                        "aria-label": k.intl.string(k.t.StREWK),
                        children: (0, i.jsx)(f.A, { guildId: n.id }),
                    }),
            ],
        });
    }
...
function G(e) {
    let { guildId: t } = e,
        ...
        { scrollTo: p } = (0, a.bG)([E.A], () => E.A.getGuildDimensions(t)),
        A = (0, _.A)((e) => {
            let { channelId: t } = e;
            return t;
        }),
        f = (0, a.bG)([T.A], () => T.A.getVoiceChannelId()),
        D = (0, a.bG)([C.A], () => C.A.getGuildVersion(t)),
        j = (0, a.bG)([g.A], () => g.A.version),
        L = (0, a.bG)([v.default], () => v.default.getGuildChangeSentinel(t)),
        w = (0, d.a1)(n?.id),
        k = (0, c.vj)(n?.id),
        M = n?.features.has(R.GuildFeatures.COMMUNITY) ?? !1,
