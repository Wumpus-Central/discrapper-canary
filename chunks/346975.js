...
function eZ(e) {
    var t, n, a;
    let { channel: s, isEmpty: b, isSearchLoading: C, numResults: w, children: N, coords: S, onHeightChange: T } = e,
        {
            name: E,
            formOpen: R,
            titleFocused: M,
    ...
    let e_ = (0, g.e7)([U.Z], () => U.Z.getUploads(s.id, z.d.FirstThreadMessage)),
        ...
        ew = i.useRef(null),
        [eN, eS] = i.useState(0),
        { width: eT } = (0, g.e7)([G.Z], () => G.Z.windowSize()),
