...
function eN(e) {
    ...
    let { columns: ek } = i.useMemo(() => (eo ? ev.getRenderOptions(eE) : es.eU), [eo, eE]),
        ...
        eD = i.useMemo(() => (!ee && ej ? [[], []] : er ? (ej ? [[], b, [], []] : [[], m, f, []]) : [[], m, []]), [ej, ee, er, b, m, f]),
        ez = i.useCallback(
            (e, n) => {
                (0, Y.B5)({
                    guildId: t.guild_id,
                    ...
                    children: [
                        u &&
                            (0, r.jsx)(p.Z, {
                                ...
                                style: { right: ti && (null == n ? void 0 : n.isThreadSidebarFloating) ? n.threadSidebarWidth : 0 }
                            }),
