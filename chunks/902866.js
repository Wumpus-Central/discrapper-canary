...
function o() {
    ...
    if (null != a.Z.Messages.SELF_XSS_HEADER)
        if (
            (console.log(
                "%c".concat(a.Z.Messages.SELF_XSS_HEADER),
                "color: #5865f2; -webkit-text-stroke: 2px black; font-size: 72px; font-weight: bold;",
            ),
            console.log("%c".concat(a.Z.Messages.SELF_XSS_LINE_1), "font-size: 16px;"),
            console.log("%c".concat(a.Z.Messages.SELF_XSS_LINE_2), "font-size: 18px; font-weight: bold; color: red;"),
            e >= 4)
        ) {
