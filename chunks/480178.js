...
var r = i(627968),
    ...
    g = i(953727);
function j(e) {
    let { width: t = 255, height: i = 178, color: s = c.A.unsafe_rawColors.WHITE.css, ...n } = e,
        l = (0, p.Ay)(),
        a = (0, m.q)(l);
    return (0, r.jsx)("svg", {
        ...(0, g.A)(n),
...
function v(e) {
    let { width: t = 160, height: i = 210, color: s = c.A.unsafe_rawColors.WHITE.css, ...n } = e,
        l = (0, p.Ay)(),
        a = (0, m.q)(l);
    return (0, r.jsx)("svg", {
        ...(0, g.A)(n),
                ...
                (function (e, t) {
                    ...
                    switch (t) {
                        ...
                        case D.p$.PRICE_DESC:
                            (i = "price_tier"), (r = "desc");
                            break;
                        case D.p$.NEWEST_ARRIVALS:
                            (i = "published_at"), (r = "desc");
                            break;
                        default:
                            return e;
                    }
                    return k().orderBy(e, [i], [r]);
                })(a, c),
            [a, c],
        );
    return n
        ? (0, r.jsx)("ul", {
              className: U.Ui,
              "aria-label": V.intl.string(V.t.qe4kTa),
              children: _.map((e) =>
                  (0, r.jsx)(
                      "li",
                      {
...
function $(e) {
    let { guildId: t } = e,
        i = (0, G.uk)(t)[0],
        { editStateIds: s } = O.d0(i?.id ?? null, t),
        { activeSubscription: n } = (0, H.A)(i?.id);
    return (0, r.jsxs)("div", {
        className: F.k,
        children: [
            null != i ? (0, r.jsx)(y.A, { groupListingId: i.id, subscription: n }) : null,
            (0, r.jsx)(z.A, { subscription: n }),
            (0, r.jsx)(Z.A, {
                children: s.map((e) =>
                    (0, r.jsx)(
                        W.A,
...
function X(e) {
    let { guildId: t } = e;
    return (0, r.jsx)(B.H, { guildId: t, children: (0, r.jsx)($, { guildId: t }) });
}
var Q = i(702841),
    K = i(506774),
    Y = i(890856),
    ...
    ec = i(305015);
function ed(e) {
    let { width: t = 24, height: i = 24, color: s = "currentColor", ...n } = e;
    return (0, r.jsx)("svg", {
        ...(0, g.A)(n),
        xmlns: "http://www.w3.org/2000/svg",
        width: t,
...
function ex(e) {
    ...
    return (0, r.jsxs)(Y.s, {
        onClick: a ? void 0 : o,
        "aria-disabled": a,
        className: l()(ef.Mf, { [ef.wH]: n, [ef.ac]: a, [ef.VH]: !n && null != d }),
        "aria-label": i,
        children: [
            (0, r.jsx)("div", { className: ef.zc, children: t }),
            (0, r.jsx)(_.h, { size: 8, horizontal: !0 }),
            (0, r.jsxs)("div", {
                children: [
                    (0, r.jsx)(J.E, {
                        variant: "text-sm/semibold",
                        color: n ? "always-white" : "text-strong",
                        children: i,
                    }),
                    (0, r.jsx)(J.E, {
                        variant: "text-xs/normal",
                        color: n ? "always-white" : a ? "text-muted" : "text-strong",
                        children: s,
                    }),
                ],
            }),
            ...
            null != d &&
                (0, r.jsx)(et.D, {
                    ...
                    children: (0, r.jsx)(ei.a, { size: "xs", color: "currentColor" }),
                }),
        ],
    });
}
function eh(e) {
    let { guild: t } = e,
        i = (0, ea.w)(t.id),
        { selectedTab: s, setSelectedTab: n, categoryTabs: l, handlePreviewDismiss: a } = (0, N.k)(),
        o = "false" === K.w.get(eu.Db, "false"),
        c = (0, Q.bG)([en.A], () => en.A.useReducedMotion),
        d = l.map((e) => {
            switch (e) {
                case A.B.GUILD_PRODUCTS:
                    return (0, r.jsx)(
                        ex,
                        {
                            icon: (0, r.jsx)(ec.A, { width: 20, height: 20 }),
                            title: V.intl.string(V.t.odvTUp),
                            body: V.intl.string(V.t["0JFpRW"]),
                            selected: s === A.B.GUILD_PRODUCTS,
                            onClick: () => n(A.B.GUILD_PRODUCTS),
                        },
                        e,
                    );
                case A.B.GUILD_ROLE_SUBSCRIPTIONS:
                    return (0, r.jsx)(
                        ex,
                        {
                            icon: (0, r.jsx)(ed, { width: 20, height: 20 }),
                            title: V.intl.string(V.t["KzCF/6"]),
                            body: i
                                ? V.intl.string(V.t["jqz+ly"])
                                : V.intl.format(V.t.ycs4oO, {
                                      openRoleSubPage: () => (0, eo.pX)(q.BVt.CHANNEL(t.id, eC.VV.ROLE_SUBSCRIPTIONS)),
                                  }),
                            disabled: !i,
                            selected: s === A.B.GUILD_ROLE_SUBSCRIPTIONS,
                            onClick: () => n(A.B.GUILD_ROLE_SUBSCRIPTIONS),
                        },
                        e,
                    );
                case A.B.GUILD_PRODUCTS_PREVIEW:
                    return (0, r.jsx)(
                        ex,
                        {
                            icon: o
                                ? (0, r.jsx)("img", {
                                      src: c
                                          ? (0, el.n)("server_products/storefront/question-mark.png")
                                          : (0, el.n)("server_products/storefront/question-mark.gif"),
                                      className: ef.kz,
                                      alt: "",
                                  })
                                : (0, r.jsx)(er.o, { size: "custom", color: "currentColor", width: 20, height: 20 }),
                            title: V.intl.string(V.t.odvTUp),
                            body: V.intl.string(V.t["827i8I"]),
                            selected: s === A.B.GUILD_PRODUCTS_PREVIEW,
                            onClick: () => {
                                n(A.B.GUILD_PRODUCTS_PREVIEW), K.w.set(eu.Db, "true");
                            },
                            onPreviewDismiss: a,
                            isNew: o,
                        },
    ...
    return (0, r.jsxs)("div", {
        className: ef.kL,
        children: [
            (0, r.jsx)(es.D, { variant: "heading-sm/bold", className: ef.wx, children: V.intl.string(V.t.GF433I) }),
            (0, r.jsx)(_.h, { size: 12 }),
            (0, r.jsxs)("div", {
                className: ef.uW,
                children: [
                    (0, r.jsx)("div", { className: ef.vR, children: d }),
                    s === A.B.GUILD_PRODUCTS && (0, r.jsx)(e_.default, {}),
                ],
            }),
        ],
    });
...
var em = i(885574),
    ...
    eI = i(68817);
function eb() {
    let e = eg.kt.useSetting(),
        t = (0, ev.j)(),
        i = (0, Q.bG)([en.A], () => en.A.useReducedMotion),
        s =
            t && e && !i
                ? (0, el.n)("server_products/storefront/question-mark.gif")
                : (0, el.n)("server_products/storefront/question-mark.png");
    return (0, r.jsxs)("div", {
        ...
        children: [
            (0, r.jsx)(ep.A, {
                role: void 0,
                ctaComponent: null,
                imageUrl: (0, el.n)("server_products/storefront/preview-thumbnail.png"),
                name: V.intl.string(V.t.U2hvDo),
                description: V.intl.string(V.t["w/TNGT"]),
                formattedPrice: (0, ej.$g)(0, q.Yri.USD, {
                    localeMatcher: "best fit",
                    style: "currency",
                    maximumSignificantDigits: 1,
                }),
                shouldShowFullDescriptionButton: !1,
                productType: V.intl.string(V.t.ih4QMU),
                onTapCard: () => null,
                hideRoleTag: !0,
                lineClamp: 3,
                thumbnailHeight: 197,
            ...
            (0, r.jsx)("img", { className: eI.kz, alt: "", src: s }),
        ],
    });
}
function eS() {
    return (0, r.jsxs)("div", {
        className: eI.od,
        children: [
            (0, r.jsx)(em.m, { size: "md", color: "currentColor", className: eI.ZC }),
            (0, r.jsx)(J.E, {
                variant: "text-sm/normal",
                color: "text-muted",
                children: V.intl.format(V.t.umfZ8q, { learnMoreLink: eu.rv }),
            }),
        ],
    });
}
function ew(e) {
    ...
    return (0, r.jsxs)("div", {
        ...
        children: [
            (0, r.jsxs)("div", {
                className: eI.gp,
                children: [(0, r.jsx)(eb, {}), (0, r.jsx)(eL.A, { guildId: t, showCTA: !0 })],
            }),
            (0, r.jsx)(eS, {}),
        ],
    });
...
var eN = i(821609),
    ...
    eT = i(503046);
function ek() {
    let { selectedTab: e, isPhantomPreview: t, handlePreviewDismiss: i } = (0, N.k)();
    return t
        ? (0, r.jsxs)(r.Fragment, {
              children: [
                  (0, r.jsxs)("div", {
                      className: eT.ZF,
                      children: [
                          (0, r.jsx)(eA.G, { size: "xs", color: "currentColor" }),
                          (0, r.jsx)(J.E, {
                              variant: "text-sm/normal",
                              className: eT.cP,
                              children:
                                  e === A.B.GUILD_PRODUCTS_PREVIEW
                                      ? V.intl.string(V.t.F4Z0nV)
                                      : V.intl.string(V.t.pzTFpM),
                          }),
                      ],
                  }),
                  (0, r.jsx)(eN.$, {
                      text: e === A.B.GUILD_PRODUCTS_PREVIEW ? V.intl.string(V.t.YF35pV) : V.intl.string(V.t.r30bky),
                      size: "sm",
                      variant: "secondary",
                      onClick: i,
                  }),
...
function eU(e) {
    let { guildId: t, productId: i } = e,
        { loaded: s, subscriptionsSettings: n } = (0, b.G)(t),
        l = (0, o.bG)([I.A], () => I.A.getGuild(t)),
        { selectedTab: a, isPhantomPreview: c, categoryTabs: u } = (0, N.k)(),
        C = !s || null == n;
    return null == l || (!c && C)
        ? (0, r.jsx)(d.y, {})
        : (0, r.jsx)(w.default, {
              defaultSortOption: n?.store_page_guild_products_default_sort ?? D.p$.NAME,
              children: (0, r.jsxs)("div", {
                  className: eD.hQ,
                  children: [
                      (0, r.jsx)(eR.A, { guild: l, subscriptionsSettings: n }),
                      (0, r.jsx)(_.h, { size: 32 }),
                      u.length > 0 && (0, r.jsx)(eh, { guild: l }),
                      (0, r.jsxs)("div", {
                          className: eD.v_,
                          children: [
                              (0, r.jsx)(_.h, { size: 32 }),
                              c && (0, r.jsx)(ew, { guildId: t }),
                              a === A.B.GUILD_PRODUCTS && (0, r.jsx)(M, { guildId: t, productId: i }),
                              a === A.B.GUILD_ROLE_SUBSCRIPTIONS && (0, r.jsx)(X, { guildId: t }),
                          ],
                      }),
                  ],
              }),
...
function eM(e) {
    let { guildId: t, productId: i } = e,
        n = (0, o.bG)([h.A], () => h.A.isConnected()),
        _ = (0, o.bG)([I.A], () => I.A.getGuild(t)),
        { shouldHideGuildPurchaseEntryPoints: m, restrictionsLoading: p } = (0, x.MH)(t),
        { selectedTab: g, isPhantomPreview: b, categoryTabs: w } = (0, N.k)(),
        A = n && (null == _ || (0 === w.length && !b) || (m && !p));
    return (
        s.useEffect(() => {
            A && (0, S.B)(t, eC.VV.GUILD_SHOP);
        }, [t, A]),
        (0, f.A)(
            { type: eP.z.PAGE, name: a.ImpressionNames.GUILD_SHOP_PAGE, properties: { product_id: i, tab: g } },
            { disableTrack: A },
        ),
        (0, r.jsxs)("div", {
            "data-has-border": !0,
            className: l()(eV.TE, eD.kL),
            children: [
                (0, r.jsxs)(L.A, {
                    children: [
                        (0, r.jsx)(L.A.Icon, {
                        ...
                        (0, r.jsx)(L.A.Title, { children: V.intl.string(V.t.al5EXL) }),
                        (0, r.jsx)(ek, {}),
                    ],
                }),
                (0, r.jsx)(C.d_, {
                    className: eD.Qs,
                    children: n ? (0, r.jsx)(eU, { guildId: t, productId: i }) : (0, r.jsx)(d.y, {}),
                }),
                (0, r.jsx)(v, { className: eD.Dv }),
                (0, r.jsx)(j, { className: eD.xC }),
            ],
        })
    );
}
function eB(e) {
    let { guildId: t, productId: i, initialTab: s } = e;
    return (
        null == s && null != i && (s = A.B.GUILD_PRODUCTS),
        (0, r.jsx)(N.A, {
            initialTab: s,
            guildId: t,
            children: (0, r.jsx)(eM, { initialTab: s, productId: i, guildId: t }),
        })
    );
}
