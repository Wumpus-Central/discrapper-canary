    ...
    (function (t) {
            ...
            return (
                ...
                (this._initBody = function (t) {
                    if (((this.bodyUsed = this.bodyUsed), (this._bodyInit = t), t))
                        ...
                        else if (r.searchParams && URLSearchParams.prototype.isPrototypeOf(t))
                ...
                (this.text = function () {
                    ...
                    if (this._bodyArrayBuffer)
                        return Promise.resolve(
                            (function (t) {
                                for (var e = new Uint8Array(t), r = Array(e.length), o = 0; o < e.length; o++)
        ...
        function b(t, e) {
            ...
            if (
                ...
                (this.method = ((o = (r = e.method || this.method || "GET").toUpperCase()), p.indexOf(o) > -1 ? o : r)),
        ...
        function v(o, n) {
            return new Promise(function (i, s) {
                var h = new b(o, n);
                if (h.signal && h.signal.aborted) return s(new t.DOMException("Aborted", "AbortError"));
                ...
                (u.onload = function () {
                    ...
                    !n || "object" != typeof n.headers || n.headers instanceof f
                        ? h.headers.forEach(function (t, e) {
                              u.setRequestHeader(e, t);
                          })
                        : Object.getOwnPropertyNames(n.headers).forEach(function (t) {
                              u.setRequestHeader(t, a(n.headers[t]));
                          }),
                    h.signal &&
                        (h.signal.addEventListener("abort", c),
