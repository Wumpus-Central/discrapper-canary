e.exports = function (e) {
    let t = e.regex.either(
        ...
        s = { begin: /\{/, end: /\}/, relevance: 0, contains: ["self", ...r] },
        a = e.inherit(s, { relevance: 0, endsParent: !0, contains: [s, ...r] }),
        o = { begin: /\s+/, relevance: 0 },
        l = [a],
        u = [{ begin: /\[/, end: /\]/, endsParent: !0, relevance: 0, contains: [s, ...r] }],
        c = function (e, t) {
    ...
    return {
        ...
        aliases: ["tex"],
        contains: [
            ...["verb", "lstinline"].map((e) => d(e, { contains: [h()] })),
            d("mint", c(l, { contains: [h()] })),
            d("mintinline", c(l, { contains: [p(), h()] })),
            d("url", { contains: [p("link"), p("link")] }),
