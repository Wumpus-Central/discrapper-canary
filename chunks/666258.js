...
function C(e) {
    let { channel: t, guild: n, inviteTarget: s } = e,
        { guildProfile: r, fetchGuildProfile: a } = (0, v.u)(n.id);
    i.useEffect(() => {
        a();
    }, [a]);
    let o = (0, h.KS)(t, n),
                              ...
                              (0, l.jsxs)('div', {
                                  ...
                                  children: [
                                      ...
                                      (0, l.jsx)(u.Text, {
                                          variant: 'text-xs/medium',
                                          color: 'header-muted',
                                          children: f.NW.format(f.t['LC+S+v'], { membersOnline: r.onlineCount })
                                      })
                                  ]
                              }),
                              (0, l.jsxs)('div', {
                                  ...
                                  children: [
                                      ...
                                      (0, l.jsx)(u.Text, {
                                          variant: 'text-xs/medium',
                                          color: 'header-muted',
                                          children: f.NW.format(f.t.zRl6XV, { count: r.memberCount })
                                      })
                                  ]
                              })
                          ]
...
function y(e) {
    var t;
    let { className: s, guild: h, channel: v, inviteTarget: p, sendInvite: y, inviteKey: O, sending: P, options: Z, setOptions: A, isApplicationBypassAllowed: w, isGuestInviteAllowed: k, isTemporaryInviteAllowed: R } = e,
        [M] = (0, o.Wu)([x.Z], () => [x.Z.hideInstantInvites]),
        [W, L] = i.useState(!1),
        [D, U] = i.useState(!1),
        V = i.useRef(null),
        B = (0, m.Dt)(),
            ...
            (0, l.jsxs)('div', {
                ...
                children: [
                                        ...
                                        children: W
                                            ? (0, l.jsxs)(l.Fragment, {
                                                  children: [
                                                      ...
                                                      (0, l.jsx)('span', { children: f.NW.string(f.t['+5kSoa']) })
                                                  ]
                                              })
                                            : (0, l.jsxs)(l.Fragment, {
                                                  children: [
                                                      ...
                                                      (0, l.jsx)('span', { children: f.NW.string(f.t.WqhZsr) })
                                                  ]
                                              })
                                    }
                                )
                    ...
                    (0, l.jsxs)(u.zxk, {
                        ...
                        disabled: P,
                        children: [
                            (0, l.jsx)('span', { children: f.NW.string(f.t.BcAABg) }),
                            (0, l.jsx)(u.Uuj, {
                                size: 'xs',
                                color: 'currentColor'
                            })
