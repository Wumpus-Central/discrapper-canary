...
class eI extends i.PureComponent {
    ...
    renderGuildHeader(e) {
        let { guild: t, isHeaderPopoutOpen: n, showGuildHeaderTutorial: i, showGuildTemplateDirtyTooltip: l, isGuildHeaderDismissibleTooltipShown: o, headerAnalyticsLocations: a, isRefreshEnabled: s } = this.props,
    ...
    constructor(...e) {
        super(...e),
            ...
            e_(this, 'handleHeaderContextMenu', (e) => {
                ...
                null != t &&
                    (0, m.jW)(e, async () => {
                        let { default: e } = await Promise.all([n.e('7654'), n.e('44156'), n.e('23682'), n.e('6850'), n.e('16114'), n.e('58227'), n.e('44088'), n.e('10396'), n.e('69760'), n.e('33213'), n.e('67892')]).then(n.bind(n, 545135));
                        return (n) => (0, r.jsx)(e, eO(eE({}, n), { guild: t }));
                    });
            }),
            ...
            e_(this, 'renderMenuPopout', async () => {
                let { default: e } = await Promise.all([n.e('69760'), n.e('54132')]).then(n.bind(n, 859432));
                return (t) => {
                    let { closePopout: n } = t,
                        { guild: i } = this.props;
                    return (
            ...
            e_(this, 'renderGuildHeaderDropdownButton', (e) =>
                (0, U.jW)({ location: 'guild_sidebar' })
                    ...
                    : (0, r.jsx)(b.Z, {
                          open: e,
                          className: o()(eb.dropdownButton, { [eb.dropdownButtonBannerVisible]: this.state.bannerVisible })
                      })
            ),
...
function eC(e) {
    ...
    let c = (0, A.Z)(n),
        ...
        { enableStudyGroup: U } = (0, k.s)(a),
        V = (0, T.ZP)((e) => e.currentlyShown.has(p.z.NAGBAR_NOTICE_CONNECT_PLAYSTATION)),
        [H, z] = i.useState(!V),
        X = (0, E.Z)(n),
        { analyticsLocations: ea } = (0, N.ZP)(O.Z.GUILD_HEADER),
    ...
    let [ec, eu] = (0, T.ZP)((e) => [eh.XN.some((t) => e.currentlyShown.has(t.dismissibleContentType)), e.currentlyShownGroup.has(ef.R.GUILD_HEADER_TOOLTIPS)], u.X),
        ...
        e_ = m && (null == a ? void 0 : a.premiumProgressBarEnabled) === !1 && !eo.s.isDisallowPopupsSet(),
        eE = (0, d.e7)([J.Z], () => J.Z.getMemberCount(n)),
        eO = m && null != eE && eE >= 30 && (null == a ? void 0 : a.premiumProgressBarEnabled) === !1 && !eo.s.isDisallowPopupsSet(),
        eN = b && null != a && (a.hasFeature(ep.oNc.COMMUNITY) || (null != eE && eE > 50)),
        ey = (0, w.Z)(n),
        eC = (null == a ? void 0 : a.hasFeature(ep.oNc.HUB)) === !0,
        eS = m && (null == a ? void 0 : a.hasFeature(ep.oNc.DISCOVERABLE)) === !0,
        eT = (0, v.Q)(),
        eP = (m || (null == a ? void 0 : a.premiumTier) === ep.Eu4.NONE) && !eo.s.isDisallowPopupsSet() && !eT,
        ej = (0, d.e7)([D.Z, ee.Z], () => null != a && null != R && m && !ee.Z.hasLayers() && D.Z.shouldShowGuildTemplateDirtyTooltip(n)),
        eA = (0, d.e7)([K.Z], () => K.Z.getChannel(o)),
        { isPopoutOpen: eZ } = (0, Z.y)(),
        ex = null !== (t = null == a ? void 0 : a.hasFeature(ep.oNc.COMMUNITY)) && void 0 !== t && t,
