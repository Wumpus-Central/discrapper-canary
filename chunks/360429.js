...
function D(e) {
    let { stream: t, analyticsContext: n, appContext: v, exitFullscreen: D, onSelect: _ } = e,
        T = (function (e) {
            let t = M(e),
                n = (0, p.Z)(x.Z),
                o = g.Z.getSettings().clipsEnabled,
                a = e.ownerId === w.default.getId(),
                { enableViewerClipping: c, ignoreSenderPreference: u } = I.Z.useExperiment({ location: 'StreamContextMenu' }, { autoTrackExposure: !1 }),
