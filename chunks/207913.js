...
function V(e) {
    let { message: t, goToSidebar: i, groupedMessages: l } = e,
        ...
        g = (0, c.e7)(
            ...
            () => {
                ...
                return A.default.compare(t.id, e) > 0;
            },
            [f, t.id]
        );
    return null == t || null == f
        ? null
        : (0, r.jsx)(u.P3F, {
              className: o()(U.messageClickableContainer, { [U.selected]: t.id === s.messageId }),
              onClick: () => {
                  h.Z.trackJump(f.id, t.id, 'Notifications Inbox'), g && p.In(t.channel_id, !0, void 0, t.id);
                  let e = i ? k.Z5c.NOTIFICATIONS_INBOX(f.id, t.id) : k.Z5c.CHANNEL(f.guild_id, f.id, t.id);
                  (0, I.uL)(e);
              },
        ...
        { previewContent: s, Icon: a } = (function (e) {
            ...
            return (0, i.useMemo)(() => {
                let e = '' === t.content,
                    ...
                    c = (0, y.Z)(t),
                    d = t.type === k.uaV.REPLY,
                    h = t.stickerItems.length > 0,
                    p = t.isPoll(),
                    f = t.type === k.uaV.POLL_RESULT,
                    g = t.hasFlag(k.iLy.IS_VOICE_MESSAGE),
                    m = null;
                1 === a ? (m = u.XBm) : a > 1 ? (m = u.Ka2) : c ? (m = O.Z) : p || f ? (m = u.QDj) : d ? (m = u.n$P) : h ? (m = u.SlE) : g && (m = u.gj8);
                let b = !0,
                    v = null;
                if (e)
                    ...
                    } else v = f ? M.intl.string(M.t.sad2PD) : i ? M.intl.string(M.t.p0oZm5) : a > 1 ? M.intl.formatToPlainString(M.t.rtfTKi, { count: a }) : 1 === a ? M.intl.string(M.t.tCcq5u) : h ? M.intl.format(M.t.zY4v1N, { stickerName: t.stickerItems[0].name }) : g ? M.intl.string(M.t.slFYgo) : M.intl.string(M.t.sDqZHB);
                else
                    (b = !1),
                        (v = (0, r.jsx)(C.ZP, {
                            content: s,
