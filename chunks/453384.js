...
let f = r.forwardRef((e, t) => {
    let {
        ...
        S = 2 * Math.PI * T,
        N = S - n * S,
        C = r.useMemo(() => ({ strokeDasharray: `${S} ${S}`, strokeDashoffset: N }), [S, N]),
        { progressTextAnimation: y } = (0, l.z)({ progressTextAnimation: +(null != E && 1 !== n), config: c.N }),
        v = Math.round(100 * n),
        R = r.useMemo(() => (g ? "rgba(123, 194, 112, 1)" : "var(--status-positive)"), [g]),
            ...
            (0, i.jsxs)("div", {
                ...
                children: [
                    ...
                    (0, i.jsxs)(o.animated.div, {
                        style: { opacity: (0, d.a)(y), inset: A },
                        className: a()(h.rD, h.qk),
                        children: [
                            (0, i.jsx)("div", { className: a()(h.rD, h.LU) }),
                            (0, i.jsx)(u.E, { variant: p, color: "text-strong", className: h.l_, children: E }),
                        ],
                    }),
                ],
            }),
