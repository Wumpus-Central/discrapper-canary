...
let f = r.forwardRef((e, t) => {
    let {
        ...
        S = 2 * Math.PI * T,
        y = S - n * S,
        C = r.useMemo(() => ({ strokeDasharray: `${S} ${S}`, strokeDashoffset: y }), [S, y]),
        { progressTextAnimation: N } = (0, l.z)({ progressTextAnimation: +(null != p && 1 !== n), config: d.N }),
        v = Math.round(100 * n),
