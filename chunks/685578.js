...
function th(e) {
    var { editor: t, scheduleOnDOMSelectionChange: n, onDOMSelectionChange: r } = e,
        ...
        _ = () => {
            ...
            j.set(t, t.marks), t_("flush", U.get(t), k.get(t));
            for (var a = y(); (l = null == (_ = k.get(t)) ? void 0 : _[0]); ) {
                var l,
                    _,
                    p,
                    h = M.get(t);
    ...
    tR = (e) => {
        ...
        eC(() => {
            k.current && (e = H(k.current))
                ? (v.set(N, e), I.set(N, k.current), A.set(N, k.current), S.set(k.current, N))
                : A.delete(N);
            var e,
                { selection: t } = N,
                                ...
                                onCompositionEnd: (0, c.useCallback)(
                                    (e) => {
                                        if (
                                            ...
                                            var t = M.get(N);
                                            M.delete(N),
                                                void 0 !== t && (j.set(N, N.marks), (N.marks = t)),
...
var tz = function (e) {
        ...
        return (
            ...
            (n.addMark = (e, t) => {
                var r, i;
                null == (r = x.get(n)) || r(),
                    !M.get(n) && null != (i = k.get(n)) && i.length && M.set(n, null),
                    j.delete(n),
                    o(e, t);
            }),
            (n.removeMark = (e) => {
