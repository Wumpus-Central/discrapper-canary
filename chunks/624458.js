...
let T = {
    fetchGuildJoinRequest: async (e) => {
        let t = await i.Bo.get({ url: u.Rsh.GUILD_JOIN_REQUEST_BY_ID(e), rejectWithError: !1 }),
            n = (0, _.j)(t.body);
        ...
        if (!o.A.isFetching() && A) {
            ...
            try {
                let e = await i.Bo.get({
                        url: u.Rsh.GUILD_JOIN_REQUESTS(t),
                        query: { status: n, limit: a, before: r, after: s },
                        rejectWithError: !1,
                    }),
                    E = e.body.total,
                    o = (e.body.guild_join_requests ?? []).map(_.j);
                return (
                    l.h.dispatch({
    ...
    ackUserGuildJoinRequest: async (e, t) => {
        try {
            return await i.Bo.post({ url: u.Rsh.GUILD_JOIN_REQUEST_ACK(e, t), rejectWithError: !1 });
        } catch (e) {
        } finally {
    ...
    removeGuildJoinRequest: async (e) => {
        try {
            let t = await i.Bo.del({ url: u.Rsh.GUILD_MEMBER_REQUEST_TO_JOIN(e), rejectWithError: !1 });
    ...
    updateGuildJoinRequest: async function (e, t, n) {
        ...
        let o = await i.Bo.patch({
            url: u.Rsh.GUILD_JOIN_REQUEST_ID(e, n),
            ...
            (e) => (
                e &&
                    e.body &&
                    e.body.code === u.t02.REQUEST_TO_JOIN_USER_INELIGIBLE &&
    ...
    actionAllPendingJoinRequests: async (e, t) => {
        let n = await i.Bo.patch({ url: u.Rsh.GUILD_JOIN_REQUESTS(e), body: { action: t }, rejectWithError: !1 });
        return l.h.dispatch({ type: "GUILD_JOIN_REQUESTS_BULK_ACTION", guildId: e, action: t }), n.body;
    },
    resetGuildJoinRequest: async (e) => {
        try {
            let { body: t } = await i.Bo.post({ url: u.Rsh.GUILD_MEMBER_REQUEST_TO_JOIN(e), rejectWithError: !1 });
    ...
    fetchRequestToJoinGuilds: async () => {
        let e = await i.Bo.get({ url: u.Rsh.USER_JOIN_REQUEST_GUILDS, rejectWithError: !1 });
    ...
    createOrEnterJoinRequestInterview: async function (e) {
        let t = !(arguments.length > 1) || void 0 === arguments[1] || arguments[1],
            n = await i.Bo.post({ url: u.Rsh.GUILD_JOIN_REQUEST_INTERVIEW(e), rejectWithError: !1 }),
            r = (0, a.UE)(n.body);
    ...
    fetchJoinRequestCooldown: async (e) => {
        try {
            let t = await i.Bo.get({ url: u.Rsh.GUILD_MEMBER_JOIN_REQUEST_COOLDOWN(e), rejectWithError: !1 });
            return (
