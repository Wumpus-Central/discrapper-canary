...
let T = {
    ...
    fetchGuildJoinRequestsForUser: async (e, t) => {
        let n = await i.Bo.get({ url: u.Rsh.GUILD_JOIN_REQUESTS_FOR_USER(e, t), rejectWithError: !1 }),
            r = (n.body ?? []).map(_.j);
        return (
    ...
    updateGuildJoinRequest: async function (e, t, n) {
        ...
        let o = await i.Bo.patch({
            url: u.Rsh.GUILD_JOIN_REQUEST(e, n),
    ...
    fetchJoinRequestForInterview: async (e) => {
        let t = await i.Bo.get({ url: u.Rsh.JOIN_REQUEST(e), rejectWithError: !1 }),
            n = (0, _.j)(t.body);
    ...
    createOrEnterJoinRequestInterview: async function (e) {
        let t = !(arguments.length > 1) || void 0 === arguments[1] || arguments[1],
            n = await i.Bo.post({ url: u.Rsh.JOIN_REQUEST_INTERVIEW(e), rejectWithError: !1 }),
            r = (0, a.UE)(n.body);
