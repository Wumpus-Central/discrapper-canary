e.exports = function (e) {
    let t,
        ...
        C = { scope: "attr", match: n.concat(r, n.lookahead(":"), n.lookahead(/(?!::)/)) },
        N = { relevance: 0, begin: /\(/, end: /\)/, keywords: A, contains: [C, o, y, e.C_BLOCK_COMMENT_MODE, f, p, T] },
        v = {
            relevance: 0,
            match: [
                /\b/,
    ...
    N.contains.push(v);
    let R = [C, y, e.C_BLOCK_COMMENT_MODE, f, p, T],
        O = {
