...
let _ = c.isPlatformEmbedded && null != u.ZP.getDiscordUtils().inputCaptureRegisterElement;
class p extends i.PureComponent {
    ...
    constructor(e) {
        super(e),
            ...
            f(this, "_mounted", !1),
            f(this, "recordStart", () => {
                c.isPlatformEmbedded && !_ && ((this.gs = new s.Z()), this.gs.on("change", this.handleGSChange)),
