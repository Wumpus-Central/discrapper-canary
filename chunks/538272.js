...
let z = (0, F.mj)({
    ...
    Y = (0, a.AK)(u.X.ACTIVITY_PRIVACY_TO_PROFILE_PRIVACY_NAVIGATOR, {
...
let q = (0, a.Qx)(u.X.ACTIVITY_PRIVACY_PER_GUILD_DEFAULT_SETTING, {
    useTitle: () =>
        X("GuildActivitySharingDefaultSetting") ? j.intl.string(j.t.vpgck1) : j.intl.string(D.default["/LHVbt"]),
    useOptions: function () {
...
let ep = (0, a.E2)(u.X.ACTIVITY_PRIVACY_PER_GUILD_SETTING, {
    ...
    ef = (0, a.zZ)(u.X.ACTIVITY_PRIVACY_PER_GUILD_CATEGORY, {
        useTitle: () => {
            let e = (0, o.SV)("GuildActivitySharingCategory"),
                t = X("GuildActivitySharingCategory");
            return e
        ...
        useSubtitle: () => {
            let e = X("GuildActivitySharingCategory");
    ...
    eN = (0, a.zZ)(u.X.ACTIVITY_PRIVACY_MY_SERVERS_CATEGORY, {
        ...
        useSubtitle: () => (X("MyServersCategory") ? j.intl.string(D.default.OO17Lg) : null),
        buildLayout: () => [ep, H],
    }),
...
function e1(e) {
    let t = eY.default.getNotificationPositionMode(),
        i = t !== U.G6Q.DISABLED,
        n = ez.Ay.getOverlayKeybind(),
        s = ez.Ay.getOverlayChatKeybind();
    return {
        enabled: eX.default.enabled,
        ...
        text_opacity_slider: eY.default.getTextWidgetOpacity(),
        old_enabled: e?.enabled ?? eX.default.enabled,
    };
}
var e2 = i(793574),
    e3 = i(237984),
...
let tk = (0, a.E2)(u.X.OVERLAY_LEGACY_SETTING, {
    ...
    tB = (0, a.zD)(u.X.OVERLAY_CLICKABLE_REGIONS_SETTING, {
        useValue: () => (0, g.bG)([eY.default], () => !eY.default.disableClickableRegions),
        setValue: (e) => {
                ...
                children: [
                    ...
                    (0, E.jsx)("div", {
                        ...
                        children: (0, E.jsx)(tH.A, {
                            ...
                            onChange: function (t) {
                                tX()(null != e, "Keybind should never be undefined"),
                                    tY.A.setKeybind({ ...e, shortcut: t });
                            },
                        }),
                    }),
                ],
...
let t1 = (0, a.FW)(u.X.OVERLAY_NOTIFICATIONS_LIST, {
    ...
    t3 = (0, a.Hn)(u.X.OVERLAY_VOICE_WIDGET_AVATAR_SIZE, {
        ...
        useValue: () => (0, g.bG)([eY.default], () => eY.default.getAvatarSizeMode()),
        setValue: (e) => {
    ...
    t6 = (0, a.Hn)(u.X.OVERLAY_VOICE_WIDGET_DISPLAY_NAMES, {
        ...
        useValue: () => (0, g.bG)([eY.default], () => eY.default.getDisplayNameMode()),
        setValue: (e) => {
    ...
    t4 = (0, a.Hn)(u.X.OVERLAY_VOICE_WIDGET_DISPLAY_USERS, {
        ...
        useValue: () => (0, g.bG)([eY.default], () => eY.default.getDisplayUserMode()),
        setValue: (e) => {
        ...
        Component: function () {
            let e,
                t = (0, g.bG)([iu.default], () => iu.default.getCurrentUser()),
                {
                    ...
                    avatarSizeMode: eY.default.getAvatarSizeMode(),
                    displayNameMode: eY.default.getDisplayNameMode(),
                    displayUserMode: eY.default.getDisplayUserMode(),
                })),
                [l] = S.useState(() => [
...
let sQ = (0, a.E2)(u.X.CHAT_FAVORITES_TOGGLE, {
        ...
        Component: function () {
            let e = (0, g.bG)([sX.A], () => sX.A.favoriteGuildEnabled),
                t = (0, g.bG)([iu.default], () => {
                ...
                n = S.useCallback(
                    (e) => {
                        (0, sY.tV)(e, "settings_page"), !e && i && (0, sB.pX)(U.BVt.ME);
                    },
                    [i],
                );
            return t
            ...
            (0, W.openModalLazy)(
                async () => (e) =>
                    (0, E.jsx)(l5, {
                        ...e,
                        onSelect: (e) => {
                            l(e), tY.A.setKeybind({ ...n.current, params: { channelId: e } });
                        },
                    }),
            );
        }, []);
...
class rr extends S.PureComponent {
    handleActionChanged = (e) => {
        tY.A.setKeybind({ ...this.props.keybind, action: e });
    };
    handleShortcutChange = (e) => {
        tY.A.setKeybind({ ...this.props.keybind, shortcut: e });
    };
    handleDeleteKeybind = () => {
        tY.A.deleteKeybind(this.props.keybind.id);
    };
    handleEnableDisable = () => {
        let { keybind: e } = this.props;
        tY.A.setKeybind({ ...this.props.keybind, enabled: !e.enabled });
    };
    renderMessage() {
        let { keybind: e } = this.props,
            t = eQ.dI(e.shortcut);
            ...
            n.length > 0 &&
                (0, E.jsx)("div", {
                    ...
                    children: (0, E.jsx)("div", {
                        ...
                        children: n.map((e) => {
                            let { achievementId: t, dateUnlocked: i } = e;
                            return (0, E.jsx)(rY, { achievementId: t, dateUnlocked: i }, t);
                        }),
                    }),
                }),
            s.length > 0 &&
                (0, E.jsxs)("div", {
                    ...
                    children: [
                        ...
                        (0, E.jsx)("div", {
                            className: rH.Eh,
                            children: s.map((e) => (0, E.jsx)(rY, { achievementId: e.id }, e.id)),
                        }),
                    ],
                }),
...
let ah = S.memo(function (e) {
    let { keybind: t, keybindDescriptions: i, keybindActionTypes: n } = e,
        s = S.useCallback((e) => tY.A.setKeybind({ ...t, action: e }), [t]),
        l = S.useCallback((e) => tY.A.setKeybind({ ...t, shortcut: e }), [t]),
        r = S.useCallback(() => tY.A.setKeybind({ ...t, enabled: !t.enabled }), [t]),
        a = S.useCallback(() => tY.A.deleteKeybind(t.id), [t.id]),
        o = S.useId(),
...
let aS = function () {
    ...
    af = (0, a.zZ)(u.X.SYSTEM_CUSTOM_KEYBINDS_CATEGORY, {
        ...
        buildLayout: () => [aT],
        initialize: () => (tY.A.enableAll(!1), () => tY.A.enableAll(!0)),
        useInlineNotice: function () {
            return c.Av
                ? {
...
var aB = i(745317),
    az = i(886964);
let aX = (0, a.E2)(u.X.CAMERA_VIDEO_PREVIEW, {
...
function of(e, t) {
    ...
    tX()(i > 0, "[useSettingCollapsibleSubtitle] Limit must be greater than 0");
...
let oX = (0, a.E2)(u.X.VOICE_INPUT_SENSITIVITY_FIELD_SET, {
...
function oZ() {
    let e = (0, g.bG)([ib.A], () => (0, oY.q)(ib.A.theme));
...
let o3 = (0, a.E2)(u.X.VOICE_PUSH_TO_TALK_KEYBIND_SETTING, {
    ...
    o7 = (0, a.zZ)(u.X.VOICE_INPUT_PROFILE_CATEGORY, {
        ...
        buildLayout: () => [o4, oX, oq, oM, o1, o3, o6, oG],
    });
var o5 = i(403581),
    o8 = i(983851),
    o9 = i(687021),
...
let uG = [
    ...
    uX = (0, a.bd)(u.X.STREAMING_ADVANCED_ACCORDION, {
    ...
    uY = (0, a.zZ)(u.X.STREAMING_CATEGORY, { useTitle: () => j.intl.string(j.t.KDdjou), buildLayout: () => [uV, uX] });
var uH = i(106713);
...
let u5 = (0, a.zZ)(u.X.VOICE_CATEGORY, {
    ...
    u8 = (0, a.t_)(u.X.VOICE_AND_VIDEO_PANEL, {
        ...
        buildLayout: () => [u5, o7, aY, uY, uU, uI, og],
    }),
                ...
                children: (0, E.jsxs)("div", {
                    ...
                    children: [
                        ...
                        r.map((e) => {
                            ...
                            return (0, E.jsx)(cY, { outboundPromotion: i, code: t, disabled: !n }, i.id);
                        }),
                        l.map((e) => (0, E.jsx)(cY, { outboundPromotion: e, code: a[e.id], disabled: !n }, e.id)),
                        null != o
                            ? (0, E.jsx)(
                                  cw,
                                  {
            ...
            children: [
                ...
                (0, E.jsx)("div", {
                    ...
                    children: (0, E.jsxs)(cd.F, {
                        ...
                        children: [(0, E.jsx)(eU.c, { className: cF.yF }), (0, E.jsx)(cX, {})],
                    }),
                }),
            ],
        });
...
let c0 = (0, a.zZ)(u.X.PURCHASED_GIFTS_CATEGORY, { useTitle: c2, buildLayout: () => [c1] }),
    c1 = (0, a.E2)(u.X.PURCHASED_GIFTS_CONTENT, { useSearchTerms: () => [c2()], Component: () => (0, E.jsx)(cX, {}) });
function c2() {
            ...
            (0, E.jsxs)("div", {
                ...
                children: [
                    ...
                    (0, E.jsx)("div", {
                        ...
                        children:
                            null != o && u && !d
                                ? (0, E.jsx)(gY, { className: g2.xm, cooldown: o.getTime() })
                                : (0, E.jsx)(g3, {
                                      guildTier: t,
                                      guildBoostSlot: i,
                                      showAltText: l,
                ...
                ? (0, E.jsxs)(E.Fragment, {
                      children: [
                          (0, E.jsxs)("div", {
                              ...
                              children: [
                                  null != f &&
                                      (0, E.jsx)(AX._, { src: f.href, imageClassName: A6.Z2, width: 40, height: 40 }),
                                  (0, E.jsxs)("div", {
                                      className: A6.aF,
                                      children: [
                                          (0, E.jsx)(eG.D, {
                        ...
                        content: d
                            ? (0, E.jsxs)(E.Fragment, {
                                  children: [
                                      (0, E.jsxs)("span", {
                                          className: A6.yW,
                                          children: [(0, E.jsx)(AY.R, { size: "xs" }), j.intl.string(j.t.QjL3vn)],
                                      }),
                                      null != c &&
                                          (0, E.jsxs)("span", {
                                              className: A6._t,
              ...
              header: (0, E.jsxs)(E.Fragment, {
                  children: [
                      (0, E.jsxs)("div", {
                          ...
                          children: [
                              null != a &&
                                  (0, E.jsx)(AX._, { src: a.href, imageClassName: hc.rW, width: 48, height: 48 }),
                              (0, E.jsxs)("div", {
                                  children: [
    ...
    return (0, E.jsxs)("div", {
        children: [
            (0, E.jsxs)("div", {
                className: hA.wx,
                children: [
                    null != o && (0, E.jsx)(AX._, { src: o.href, imageClassName: hA.Z2, width: 48, height: 48 }),
                    (0, E.jsxs)("div", {
                        children: [
...
let hw = function () {
    ...
    hX = (0, a.i4)(u.X.SUBSCRIPTIONS_SIDEBAR_ITEM, {
    ...
    hY = (0, a.WI)(u.X.BILLING_SECTION, {
        useTitle: () => j.intl.string(j.t.oeUm2s),
        buildLayout: () => [gs, m5, hX, c5, d4],
    });
var hH = i(540999),
    hK = i(306471),
    hW = i(964355),
                ...
                children: (0, E.jsx)("div", {
                    ...
                    children: (0, E.jsx)(Si.vN, {
                        children: (0, E.jsx)("button", {
                            ...
                            type: "button",
                            onClick: function () {
                                sa.h.dispatch({ type: "CONNECTIONS_GRID_MODAL_SHOW", onComplete: SY });
                            },
              ...
              children: (0, E.jsxs)("div", {
                  ...
                  children: [
                      (0, E.jsx)(eM.$, {
                          ...
                          onClick: () => {
                              (0, TY.w)({ analyticsLocations: s, guild: i }), d(im.i.TAKE_ACTION);
                          },
                      }),
...
function T2(e) {
    let {
        ...
        d = S.useRef(null),
        c = (0, TW.r)(ea.A.colors.BACKGROUND_BASE_LOW).hex(),
...
function T6(e) {
    let {
        ...
        S = (0, TW.r)(ea.A.unsafe_rawColors.PRIMARY_530).hex(),
        T = (0, TZ.rh)(h, S, !1);
    return null == g || null == m
        ...
        : (0, E.jsx)(ue.A, {
              ...
              disabled: !A && !l,
              className: e4()(T3.__invalid_profileThemesSection, a),
              showPremiumIcon: o,
              forcedDivider: d,
              children: (0, E.jsxs)("div", {
                  className: T3.hd,
...
function xl() {
    let e = (0, g.bG)([iu.default], () => {
            let e = iu.default.getCurrentUser();
            return tX()(null != e, "GuildIdentitySettingsPage: user cannot be undefined"), e;
        }),
        t = (0, Sm.L)(sD.PremiumTypes.TIER_2),
        i = (0, g.bG)([S7.A, eg.A], () => eg.A.getGuild(S7.A.selectedGuildId));
    tX()(null != i, "guild should not be null");
    let {
            pendingAvatar: n,
            pendingNickname: s,
            pendingBanner: l,
        ...
        children: [
            ...
            (0, E.jsxs)(es.D, {
                ...
                children: [
                    ...
                    (0, E.jsx)(el.E, { className: xV._e, variant: "text-sm/bold", color: "always-white", children: l }),
                ],
            }),
        ],
    });
...
let x4 = (0, sR.Ld)(),
    x7 = S.memo(function (e) {
        let { availablePrimaryGuilds: t, pendingPrimaryGuildId: i, onChange: n } = e,
            ...
            l = (0, g.bG)([iu.default], () => (0, x0.Zo)(iu.default.getCurrentUser()?.primaryGuild).guildId),
            r = void 0 !== i ? i : l,
            a = S.useMemo(
...
function pi(e) {
    let { user: t, savedUserColor: i, pendingColor: n, setPendingAccentColor: s } = e,
        ...
        r = (0, TW.r)(ea.A.unsafe_rawColors.PRIMARY_530).hex(),
        a = (0, TZ.rh)(l, r, !1),
        o = (0, TJ.LX)(a[0]);
    return (0, E.jsx)(ue.A, {
...
function pr() {
    let e = (0, g.bG)([iu.default], () => {
            let e = iu.default.getCurrentUser();
            return tX()(null != e, "DefaultCustomizationSections: user cannot be undefined"), e;
        }),
...
function pu() {
    let e = (0, g.bG)([iu.default], () => {
            let e = iu.default.getCurrentUser();
            return tX()(null != e, "UserSettingsProfileCustomization: user cannot be undefined"), e;
        }),
              ...
              children: [
                  ...
                  T &&
                      ...
                      (0, E.jsx)(x_.d, {
                          ...
                          useUpdatedStyling: !0,
                          leadingAction: c
                              ? (0, E.jsx)(xI.l, { size: "md", location: e2.A.PREMIUM_WISHLIST_EDIT_PROFILE_UPSELL })
                              : void 0,
                          button: (0, E.jsx)("div", {
                              className: po.Xl,
                              children: (0, E.jsx)(eM.$, {
...
var pd = i(625494),
    pc = i(454078);
let pg = { [nw.Eq.USER_PROFILE]: "main_profile_tab", [nw.Eq.GUILD]: "guild_profile_tab" },
...
let pJ = (0, a.Tf)(u.X.ACCOUNT_CHANGE_PASSWORD_SETTING, {
    ...
    useVariant: () => "secondary",
    onClick: () => {
        (0, W.openModal)((e) => (0, E.jsx)(pQ.default, { ...e, onSuccess: () => e.onClose() }));
    },
});
var p$ = i(200921);
let p0 = [];
...
function fe(e) {
    ...
    return (0, E.jsxs)(J.B, {
        ...
        role: "listitem",
        children: [
            (0, E.jsx)(p7.A, { Icon: t, color: r ? ea.A.colors.ICON_MUTED : "currentColor" }),
            (0, E.jsxs)(J.B, {
                direction: "vertical",
                gap: "xxs",
                children: [
...
function fE() {
    let e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
    return (0, u$.bG)([eg.A, T8.A, iu.default], () =>
...
function fj(e) {
    let {
        ...
        l = (0, E.jsxs)(E.Fragment, {
            children: [(0, E.jsx)(f_.P, { checked: i }), (0, E.jsx)(el.E, { variant: "text-md/normal", children: n })],
        });
    return cG.p5
        ? (0, E.jsx)(es.D, {
              tag: "li",
              className: e4()(fb.aY, fb.vk),
              innerRef: s,
              onKeyDown: (e) => {
                  "c" === e.key &&
                      (e.metaKey || e.ctrlKey) &&
...
let fO = (0, a.zZ)(u.X.BACKUP_CODES_CATEGORY, {
    ...
    fR = (0, a.E2)(u.X.BACKUP_CODES_SETTING, {
        ...
        Component: function () {
            ...
            return 0 === e.length
                ? (0, E.jsx)(eM.$, { text: j.intl.string(j.t.Jc2myK), size: "sm", variant: "secondary", onClick: fC })
                : (0, E.jsxs)(E.Fragment, {
                      children: [
                          (0, E.jsx)("ul", {
                              className: fb.E5,
    ...
    fD = (0, a.zZ)(u.X.SMS_AUTH_CATEGORY, {
        ...
        useSubtitle: () => (0, g.bG)([iu.default], () => fg(iu.default.getCurrentUser(), !0)),
        useHeaderDecoration: () => {
            let e = (0, g.bG)([iu.default], () => iu.default.getCurrentUser()?.hasFlag(U.nhx.MFA_SMS) ?? !1),
                t = (0, g.bG)([iu.default], () => null != fg(iu.default.getCurrentUser()));
            if (!e)
                return {
                    type: h.WX.BUTTON_GROUP,
                    buttons: [
...
var Ng = i(176781),
    Nm = i(611371);
let NA = () =>
    (0, E.jsx)(ta.m, { asContainer: !0, text: j.intl.string(j.t["/fgfWh"]), children: (0, E.jsx)(Nm.A, {}) });
var Nh = i(888916),
    NE = i(572164),
    NS = i(315240),
    NT = i(274372),
...
let Np = (0, a.zD)(u.X.CLIPS_ENABLE_AUTOCLIPPING, {
        ...
        useSubtitle: () => j.intl.format(Nx.default.UCzGcQ, { learnMoreLink: t_.A.getArticleURL(U.MVz.CLIPS) }),
...
let NX = (0, a.E2)(u.X.CLIPS_KEYBIND, {
        ...
        Component: () => {
            ...
            tX()(null != e, "Save clip keybind unset");
            let t = (0, Nh.Rt)(),
                i = (0, Nh.As)(),
                n = S.useRef(null),
                s = S.useCallback(
                ...
                l = S.useCallback(() => {
                    tY.A.setKeybind({ ...e, shortcut: (0, eQ.OH)(Nb.Ot) });
                }, [e]);
            return (0, E.jsx)(sF.D, {
    ...
    NY = (0, a.E2)(u.X.CLIPS_SCREENSHOT_KEYBIND, {
        ...
        Component: () => {
            ...
            tX()(null != e, "Save clip keybind unset"), tX()(null != t, "Save screenshot keybind unset");
            let i = S.useCallback(
                (e) => {
                    tY.A.setKeybind({ ...t, shortcut: e });
                },
                [t],
            );
            return (0, E.jsx)(sF.D, {
...
let NW = (0, a.zD)(u.X.CLIPS_ENABLE_DECOUPLED_CLIPPING, {
    ...
    Nq = (0, a.zZ)(u.X.CLIPS_GENERAL_CATEGORY, {
        ...
        useSubtitle: () => j.intl.format(Nx.default["dh7g+S"], { learnMoreLink: t_.A.getArticleURL(U.MVz.CLIPS) }),
        usePredicate: Nh.As,
        buildLayout: () => [NZ],
    }),
...
let _i = (0, a.E2)(u.X.CONTENT_AND_SOCIAL_CONNECTED_GAMES, {
    ...
    Component: function () {
        ...
        return e ? (0, E.jsx)(du.y, {}) : (0, E.jsx)(_t, { applications: t });
    },
});
function _n() {
...
function _c() {
    ...
    let t = S.useCallback(() => {
            window.open(t_.A.getArticleURL(e), "_blank"), (0, _u.N)(_d.YA.AGE_CONFIRMATION_NOTICE, _d.YX.LEARN_MORE);
        }, [e]),
        i = S.useCallback(() => {
...
function _y() {
    let e,
        ...
        } = ((e = (0, u$.cf)([uh.A], () => uh.A.settings.textAndImages?.explicitContentSettings ?? (0, _I.C$)())),
        {
...
function _j() {
    let e,
        ...
        } = ((e = (0, u$.cf)([uh.A], () => uh.A.settings.textAndImages?.goreContentSettings ?? (0, _o.T4)())),
        {
...
function _7(e) {
    ...
    return (0, E.jsxs)("div", {
        className: _4.wx,
        children: [
            (0, E.jsx)("div", { className: _4.zc, children: n ? (0, E.jsx)(_2.K, {}) : (0, E.jsx)(ij.G, {}) }),
            (0, E.jsxs)("div", {
                className: _4.Qq,
                children: [
                    (0, E.jsx)(el.E, {
        ...
        a = S.useCallback(() => {
            r(!0),
                n
                    ...
                    : _3.A.unignoreUser(t, e2.A.USER_SETTINGS).catch(() => {
                          r(!1);
                      });
        }, [n, t]);
    return null == s
        ? null
        : (0, E.jsxs)("div", {
              className: e4()(_4.nM, { [_4.fW]: i }),
              children: [
                  (0, E.jsxs)("div", {
                      className: _4.eF,
                      children: [
                          (0, E.jsx)(_6.A, { user: s, size: i7._3.SIZE_40 }),
                          (0, E.jsxs)("div", {
                              className: _4.Qq,
                              children: [
                                  (0, E.jsx)(el.E, {
        ...
        if (t === Ii.YG) {
            ...
            (i = !e),
                (0, IS.O)({
                    ...
                    onCancel: () => {
                        L.n6.updateSetting(i), L.$s.updateSetting(i ? eg.A.getGuildIds() : []), IN(i, !0);
                    },
                });
        } else {
            let i = (0, rP.Tb)();
            ...
            if (t === Ii.YG) {
                ...
                (i = !e),
                    (0, IS.O)({
                        ...
                        onCancel: () => {
                            L.YX.updateSetting(i), L.Zr.updateSetting(i ? eg.A.getGuildIds() : []), Iv(i, !0);
                        },
                    });
            } else {
                let i = (0, rP.xo)();
...
function Ch(e) {
    ...
    return (
        ...
        (0, E.jsxs)("div", {
            className: CA.uW,
            children: [
                null != s && (0, E.jsx)(Cm.A, { className: CA.my, user: s, size: i7._3.SIZE_40 }),
                (0, E.jsxs)("div", {
                    className: CA.Qq,
                    children: [
                        (0, E.jsx)(es.D, {
                ...
                (0, E.jsx)(es.D, { onClick: r, className: CA.Qz, children: (0, E.jsx)(lD.u, { size: "xs" }) }),
            ],
        })
    );
}
...
let CI = (0, a.AK)(u.X.CONNECTED_GAMES_AUTHORIZED_APPS_NAVIGATOR, {
    ...
    Cb = (0, a.E2)(u.X.CONNECTED_GAMES_UNAVAILABLE, {
        Component: function () {
            ...
            return e ? (0, E.jsx)(du.y, {}) : (0, E.jsx)(_e, {});
        },
...
let bT = (0, a.zD)(u.X.NOTIFICATION_HOLIDAY_SOUNDPACK, {
    ...
    setValue: function (e) {
        ...
        tX()(null != t, "predicate should fail if no soundpack is available"), (0, bh.p)(e ? t : bS.i.CLASSIC);
    },
...
let bG = (0, a.zD)(u.X.APPLICATION_TEST_MODE, {
        ...
        setValue: (e) => {
            e ? (0, W.openModal)((e) => (0, E.jsx)(bP.A, { ...e })) : bL.cL();
        },
    }),
...
let bB = (0, a.i4)(u.X.LOGOUT_SIDEBAR_ITEM, {
    ...
    bX = (0, a.Hr)({
        buildLayout: function () {
            return [pf, bO, hY, dn, (0, o.Bv)("UserSettingsRoot_buildLayout") ? S3 : i2, E8, bz];
        },
