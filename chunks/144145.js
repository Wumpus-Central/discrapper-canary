...
function P(e) {
    let { currentActivities: t } = e,
        ...
        P = (function (e) {
            let { currentActivities: t } = e,
                n = (0, l.e7)([m.Z], () => m.Z.getAccounts().some((e) => e.type === u.Z.get(y.ABu.XBOX).type)),
                i = t.some((e) => {
                    let { activity: t } = e;
                    return (0, h.Z)(t);
                });
            return n || !i
                ...
                : (0, r.jsx)(o.sNh, {
                      ...
                      label: I.NW.formatToPlainString(I.t.XWSHTU, { platform: T })
                  });
        })(e),
        j = (function (e) {
            let { currentActivities: t } = e,
            ...
            A.push(
                (function (e, t) {
                    ...
                    return (0, r.jsx)(o.sNh, {
                        ...
                        label: t ? I.NW.formatToPlainString(I.t.wFAvxM, { name: l.toString() }) : I.NW.string(I.t.OKsSCQ),
                        action: c
                    });
                })(e, n),
                (function (e, t) {
                    let { activity: n, game: i, libraryApplication: l, location: a, canPlay: s, isRunning: c, isLaunching: u } = e;
                    if (!s || null == n) return null;
                    let d = c ? I.NW.formatToPlainString(I.t['gBme//'], { name: i.name }) : u ? I.NW.formatToPlainString(I.t.WtSQwM, { name: i.name }) : void 0;
                    return (0, r.jsx)(o.sNh, {
                        id: 'play-'.concat(n.session_id),
                        action: function () {
                            (0, v.playApplication)(i.id, l, { analyticsParams: { location: S(C({}, a), { object: y.qAy.LIST_ITEM }) } });
                        },
                        label: t ? I.NW.formatToPlainString(I.t.ZDZEJC, { name: i.name }) : I.NW.string(I.t.XKUw8v),
                        subtext: d
                    });
                })(e, n)
            );
