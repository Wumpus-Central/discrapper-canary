...
function m(t) {
    let { userId: e, skuId: a, nuxGraphic: u, onNuxShow: o, location: d, onAddSuccess: E, onError: m } = t,
        [y, g] = (0, c.kn)([l.M.WISHLIST_NUX_TOOLTIP_AND_MODAL], void 0, !0),
        R = y === l.M.WISHLIST_NUX_TOOLTIP_AND_MODAL;
    return {
        ...(function (t) {
            let { userId: e, skuId: i, location: r, onAddSuccess: l, onRemoveSuccess: n, onError: a } = t,
                { analyticsLocations: u } = (0, S.Ay)((0, A.uJ)(r) ? [] : [r]),
                o = (0, p.bG)([h.A], () => h.A.getFirstWishlistId(e)),
                d = (0, f.rJ)(o, i),
                [c, _] = s.useState(null),
                [E, m] = s.useState(!1),
                T = null !== c ? c : d;
            ...
            let y = s.useCallback(async () => {
                if (!E)
                    if ((m(!0), T && null != o)) {
                        ...
                        _(!0);
                        try {
                            await I.A.addSkuToWishlist(i, u), l?.();
                        } catch (t) {
                            a?.(t);
                        } finally {
                            _(null), m(!1);
