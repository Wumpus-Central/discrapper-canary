...
var r = n(442837),
    ...
    O = n(514656);
function v(e) {
    let { user: t, currentUser: n, displayProfile: v, guildId: C, channelId: P, subsection: A, onClose: T } = e,
        ...
        L = (0, r.e7)([a.Z], () => a.Z.isFetchingUserOutbox(t.id)),
        U = t.id === n.id,
        D = (0, r.e7)([s.Z, l.Z], () => {
