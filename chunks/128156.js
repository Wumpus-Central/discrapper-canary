...
var l = n(442837),
    ...
    I = n(514656);
function P(e) {
    let { user: t, currentUser: n, displayProfile: P, guildId: Z, channelId: N, subsection: T, onClose: E } = e,
        ...
        B = (0, l.e7)([a.Z], () => a.Z.isFetchingUserOutbox(t.id)),
        R = t.id === n.id,
        M = (0, l.e7)([d.Z, s.Z], () => {
