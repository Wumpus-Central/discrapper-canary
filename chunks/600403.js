...
let o = {
    [s.e$_.SUBSCRIBE]: {
        async handler(e) {
            let { server: t, socket: n, evt: o, args: c } = e,
                u = t.events[o];
            if (null == u) throw new i.A({ errorCode: s.Lw6.INVALID_EVENT }, "Invalid event: ".concat(o));
            if (!(0, l.A)(n.authorization.scopes, u.scope))
                throw new i.A({ errorCode: s.Lw6.INVALID_PERMISSIONS }, "Not authenticated or invalid scope");
            if (
                ...
                if (null != e.validate(c, u.validation(e), { convert: !1 }).error)
                    throw new i.A({ errorCode: s.Lw6.INVALID_PAYLOAD }, "Invalid subscription parameters provided");
            }
            let d = u.handler({
                    args: c,
                    socket: n,
    ...
    [s.e$_.UNSUBSCRIBE]: {
        handler(e) {
            ...
            if (null == t.events[r]) throw new i.A({ errorCode: s.Lw6.INVALID_EVENT }, "Invalid event: ".concat(r));
