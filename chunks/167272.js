    ...
    let { user: n, activity: e, onAction: U, onClose: M, application: G, containerClassName: V } = t,
        ...
        J = (() => {
            ...
            if (e?.buttons != null && e?.buttons.length >= 1)
                return (0, i.jsx)(O.A, { user: n, activity: e, onAction: U });
            if (!B && W && null != G && !Q)
