    ...
    getDurationStats() {
        return (
            ...
            a(
                ...
                c.filter((e) => this.timesUntilSpeakingDurationMilestonesMs.has(e)).reduce((e, t) => l(a({}, e), { ['time_to_first_'.concat(t, 'ms_speech_ms')]: this.timesUntilSpeakingDurationMilestonesMs.get(t) }), {})
            )
        );
    }
