...
function b(e) {
    ...
    return null == i ? g.x3 : (v[e] = g.cc({ user: r, context: i, checkElevated: t }));
}
function D(e) {
    let t = !(arguments.length > 1) || void 0 === arguments[1] || arguments[1],
...
function H(e, t, n, r) {
    ...
    if (e instanceof f.YB) {
        if (f.Le.has(e.type)) {
            ...
            return null == i ? g.x3 : g.TJ(e, H(i, t, n, r), d.A.hasJoined(e.id), I.Ay.isCurrentUserGuest(e.guild_id));
        }
        i = L(e.id);
...
class j extends a.Ay.Store {
    ...
    canBasicChannel(e, t, n, r, i) {
        return "basicPermissions" in t ? E.A.has(t.basicPermissions, e) : s.zy(H(t, n, r, i), E.A.asBigFlag(e));
    }
    computePermissions(e, t, n, r) {
        return H(e, t, n, r);
    }
    computeBasicPermissions(e) {
        return "basicPermissions" in e ? e.basicPermissions : E.A.asBasicFlag(H(e));
    }
    canManageUser(e, t, n) {
...
let W = new j(o.h, {
    ...
    CHANNEL_UPDATES: function (e) {
        ...
        for (let { id: e } of t) {
            ...
            C[t.id] !== i && ((C[t.id] = i), w(t.getGuildId()), (n = !0));
        }
        return !!n && ((R += 1), n);
    },
    ...
    CHANNEL_DELETE: function (e) {
        let { channel: t } = e;
        return delete C[t.id], (R += 1), w(t.guild_id), !1;
    },
    GUILD_ROLE_CREATE: F,
    GUILD_ROLE_UPDATE: F,
    GUILD_ROLE_DELETE: F,
