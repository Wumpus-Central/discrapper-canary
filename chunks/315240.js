...
class y {
    ...
    computeScore(e) {
        let t = L(e, this.lastActivityAtMs);
...
function w(e, t) {
    return 0.8 * (null != e.guildId ? v(t.getNormalizedGuildAffinity(e.guildId)) : 0);
}
class P {
    candidate;
    signals;
...
function q(e, t) {
    let n = D(e.candidate, { voiceGuildId: K(), mostRecentGuildId: F });
    return (
        e.score *
        (1 + n) *
...
function J(e, t) {
    ...
    if (null == n) return !1;
    let [i] = M.A.isFavorite(A.x.MESSAGES, e);
...
class es extends s.Ay.Store {
    ...
    initialize() {
        this.waitFor(u.A, c.A, M.A, S.default, d.A, h.Ay, _.A, o.A, E.default, f.Ay, p.A);
    }
    ...
    getScoreBreakdownForChannelId(e) {
        ...
        let n = t.candidate.kind === N.GuildVoice ? "VOICE" : "TEXT",
            ...
            r = D(t.candidate, { voiceGuildId: K(), mostRecentGuildId: F }),
    ...
    __OVERLAY__
        ...
        : {
              ...
              MESSAGE_CREATE: ea(function (e) {
                  ...
                  let t = E.default.getCurrentUser()?.id ?? null,
                  ...
                  return (
                      (c || _) &&
                          ((p.mentionCount = Math.max(h.mentionCount, +!!c + +!!_)),
                          c && (p.lastDirectMentionAtMs = r),
                          _ && (p.lastRoleMentionAtMs = r)),
                      o.updateSignalsAndRescore(p, r),
                      ...
                      j.applyBatch(() => {
                          for (let r of e.voiceStates) {
                              ...
                              if (
                                  ...
                                  let E = new Map(d.videoUsersWithTimestampMs);
                                  r.selfVideo ? E.has(e) || E.set(e, t) : E.delete(e);
                                  let p = new Map(d.lastUnmuteActivityAtMs);
              ...
              CHANNEL_SELECT: ea(function (e) {
                  ...
                  return !(null == n || n.isPrivate()) && ((F = n.getGuildId?.() ?? null), Z(), !0);
              }),
              ...
              LOGOUT: ea(function () {
                  ...
                  return H.clear(), j.clear(), (V = !1), (B = !1), (F = null), e;
              }),
          },
);
