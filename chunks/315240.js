...
function q(e, t) {
    ...
    if (null == n) return !1;
    let [i] = w.A.isFavorite(m.x.MESSAGES, e);
    if (i || n.isPrivate?.()) return !1;
    let l = n.getGuildId?.() ?? null;
    return (
        !(null == l || A.Ay.isGuildOrCategoryOrChannelMuted(l, n.id)) &&
...
class es extends s.Ay.Store {
    ...
    initialize() {
        this.waitFor(u.A, d.A, w.A, _.default, c.A, g.Ay, h.A, a.A, f.default, A.Ay, E.A);
    }
        ...
        __OVERLAY__
            ...
            : {
                  ...
                  OVERLAY_UPDATE_OVERLAY_METHOD: er(function (e) {
                      ...
                      return t === p.Ue.OutOfProcess || t === p.Ue.OutOfProcessLimitedInteraction
                          ? (W(!0), K(), !0)
                          : !Y() && W(!1);
                  }),
                  ...
                  MESSAGE_CREATE: er(function (e) {
                      ...
                      let d = (e.message?.mentions ?? []).some((e) => e?.id === t),
                          ...
                          A = new Map(g.recentMessageAuthorIds);
                      A.set(n, l);
                      let E = {
                          lastMessageAtMs: l,
                          unread: !0,
                          ...
                          B.applyBatch(() => {
                              for (let l of e.voiceStates) {
                                  ...
                                  if ((null != r && r !== s && a(r), null != s)) {
                                      ...
                                      h && !g.has(e) && g.set(e, t);
                                      let A = new Map(c.streamUsersWithTimestampMs);
                                      l.selfStream ? A.has(e) || A.set(e, t) : A.delete(e);
                  ...
                  LOGOUT: er(function () {
                      ...
                      return H.clear(), B.clear(), (F = !1), (k = !1), (V = null), e;
                  }),
              },
    );
