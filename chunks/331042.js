...
let es = 880,
    ...
    ed = (e) => {
        let { product: t, onClose: n, confettiTarget: o, confettiCanvas: a, hideConfetti: s = !1, analyticsLocations: l, overrideTitle: c, overrideDescription: p, selectedVariantIndex: E, shouldShowPromotionalExperience: b, itemConsumed: y = !0, purchaseType: v = X.o8.FIAT } = e,
            ...
            children: [
                ...
                !s &&
                    ...
                    (0, r.jsx)(G.Z, {
                        ...
                        confettiCanvas: a,
                        sprites: (0, V.vK)(I.categorySkuId),
    ...
    e_ = (e) => {
        ...
        let { product: n, pairedProduct: o, onClose: a, analyticsLocations: s, overrideTitle: l, overrideDescription: d, shouldShowPromotionalExperience: f } = e,
            ...
            { handleUseNow: v, isApplying: O } = (0, M.W)({
                product: n,
                onSuccess: a,
                onError: a
            }),
        ...
        i.useEffect(() => {
            X.Vt.ORB_PROFILE_BADGE === n.skuId && (0, N.Ls)([(0, H.X2)()], ef);
        }, [n.skuId]);
        let R = i.useMemo(
                () =>
                    null != l
                        ? l
                        : X.Vt.ORB_PROFILE_BADGE === n.skuId
