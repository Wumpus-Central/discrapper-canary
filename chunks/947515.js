...
var l = i(242003),
    ...
    _ = class {
        ...
        velocityFrom(t) {
            return this.time === t.time ? 0 : this.distanceTo(t) / (this.time - t.time);
        }
    },
    p = class t {
                ...
                (this._strokeMoveUpdate = this.throttle
                    ? (function (t, e = 250) {
                          let i = 0,
                              ...
                              r,
                              a = () => {
                                  (i = Date.now()), (n = null), (s = t.apply(o, r)), n || ((o = null), (r = []));
                              };
                          return function (...h) {
                              let l = Date.now(),
                                  d = e - (l - i);
            ...
            return (
                (0, s.u)(
                    ...
                    () => ({
                        ...
                        toDataURL: (t = "image/png", e) => c.current?.toDataURL(t, e) ?? "",
                        getCanvas: () => d.current,
                        ...
                        getBlob: (t = d.current ?? void 0, e = "image/jpeg", i = 0.92) =>
                            t
                                ? new Promise((n, s) => {
                                      t.toBlob(
                                          (t) => {
                ...
                (0, s._)(() => {
                    ...
                    let i = null,
                        ...
                        r = new m(e, { ...(s ? { penColor: s } : {}), ...(o ? { maxWidth: o } : {}) });
                    c.current = r;
                    let a = () => u.current?.();
                    r.addEventListener("beginStroke", a), v();
                    ...
                    return (
                        ...
                        () => {
                            null !== i && cancelAnimationFrame(i),
                                h.disconnect(),
                                r.removeEventListener("beginStroke", a),
                                r.off(),
                                (c.current = null);
                        }
                    );
                ...
                (0, s.v)("div", {
                    ...
                    style: r || a ? { ...(r ? { backgroundColor: r } : {}), ...(a ? { borderColor: a } : {}) } : void 0,
                    ref: l,
                    children: [
                        (0, s.v)("canvas", { class: "SignatureCanvas", ref: d, "aria-label": i }),
                        !e && (0, s.v)("p", { class: "SignatureCanvasPlaceholder", children: i }),
                    ],
                })
            );
        },
...
var f = ({ config: t, onFinish: e, onError: i }) => {
        let { t: r } = (0, n.n)(),
            [c, u] = (0, o.o)(() => (0, v.y)({ config: t }), { autoLoad: !0 }),
            [_, p] = (0, s.p)(!1),
            g = (0, s.l)(null),
            m = "error" === c.status ? c.error : void 0,
            f = "submitting" === c.status,
            y = "capture" === c.status && c.canContinue && !f,
            E = (0, s.h)(() => {
                g.current && (g.current.on(), g.current.clear(), p(!1), u.setSignatureValid(!1));
            }, [u]);
        (0, s._)(() => {
            "finished" === c.status && e?.();
        }, [c.status, e]),
        ...
        let x = async () => {
            ...
            if (i)
                return t.sendBase64 ? i.toDataURL("image/png").replace(/^data:image\/png;base64,/, "") : e.getBlob(i);
        };
        return "idle" === c.status || "finished" === c.status || "error" === c.status
            ? null
            : "success" === c.status
              ? (0, s.v)(d.t, { status: "success", successTitle: r("signature.successTitle") })
              : (0, s.v)(h.t, {
                    className: "IncodeSignature IncodeSignatureFadeIn",
                    title: t.title?.trim() || r("signature.fullSignatureTitle"),
                    subtitle: t.subTitle?.trim() || r("signature.subtitle"),
                    children: [
                        (0, s.v)("div", {
                            ...
                            children: [
                                (0, s.v)(w, {
                                    ...
                                    hasDrawing: _,
                                    onBeginStroke: () => {
                                        p(!0), u.setSignatureValid(!0);
                                    },
                                    placeholder: r("signature.fullSignaturePlaceholder"),
                        ...
                        (0, s.v)("div", {
                            ...
                            children: (0, s.v)(l.t, {
                                ...
                                onClick: async () => {
                                    let t = g.current;
                                    if (!(!t || "capture" !== c.status || t.isEmpty())) {
                                        t.off();
                                        try {
                                            let e = await x();
