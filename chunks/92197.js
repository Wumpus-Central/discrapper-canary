n.d(t, { iV: () => o2, OC: () => o6, Ay: () => o3 }), n(938796);
var i,
    l,
    s = n(627968),
    r = n(64700),
...
function np(e) {
    let { message: t, snapshot: n, index: i } = e,
        ...
        a = (0, u.bG)(
            [D.A, U.default, w.A, tl.A, tF.A, t4.A],
            () => l.getForwardInfo(D.A, U.default, w.A, tl.A, tF.A, t4.A).footerInfo,
            [l],
            h.A,
        ),
...
function iV(e) {
    ...
    return (0, s.jsxs)("div", {
        className: o()(iw.Fk, { [iw.EK]: i !== iC.CQ.LIST, [iw.wH]: a }),
        children: [
...
function lH(e) {
    ...
    (0, lL.pE)();
    let I = (0, u.bG)([U.default], () =>
            i.isDM() && null != i.recipients && 0 !== i.recipients.length ? U.default.getUser(i.recipients[0]) : null,
        ),
        C = (0, u.bG)([lM.A], () => (null != n ? lM.A.getNormalizedSKUEligibility(n) : void 0), [n]),
    ...
    let S = r.useCallback(
        ...
        L = r.useCallback(() => {
            null != d &&
                (0, lD.a)(
                    d,
                    { isGift: !0, giftRecipient: I ?? void 0 },
                        ...
                        children: [
                            (0, s.jsxs)("div", {
                                ...
                                children: [
                                    ...
                                    (0, s.jsx)(lV, { sku: d, normalPrice: j, discountedPrice: N, discountPercent: T }),
                                ],
                            }),
                            (0, s.jsxs)(lj.e, {
                                wrap: !1,
                                ...
                                children: [
                                    (0, s.jsx)(iR.m, {
                                        text: C ? void 0 : J.intl.string(J.t.IqlPbQ),
                                        children: (0, s.jsx)(eg.$, {
...
function sM(e) {
    let { message: t, compact: n } = e,
        i = (0, u.bG)([D.A], () => D.A.getChannel(sI.default.castMessageIdAsChannelId(t.id)));
                              ...
                              (0, s.jsxs)("div", {
                                  ...
                                  children: [
                                      ...
                                      (0, s.jsxs)("div", {
                                          ...
                                          children: [
                                              (0, s.jsx)("div", {
                                                  children: (0, s.jsx)(s5.u, { size: "xxs", color: "currentColor" }),
                                              }),
                                              (0, s.jsx)(p.E, {
                                                  variant: "text-xs/medium",
                                                  color: "none",
    ...
    renderViewInStoreButton() {
        return (0, s.jsx)("div", {
            ...
            children: (0, s.jsx)(eg.$, {
                ...
                onClick: () => {
                    (0, rC.pX)(K.BVt.APPLICATION_STORE);
                },
            }),
        });
    }
...
class aA extends r.Component {
    ...
    handleViewLibrary = (e) => {
        ...
        e.preventDefault(),
            null != t && t.isHidden()
                ? (0, rC.pX)(K.BVt.APPLICATION_LIBRARY_SETTINGS)
                : (0, rC.pX)(K.BVt.APPLICATION_LIBRARY, { state: { applicationId: null != t ? t.id : void 0 } });
    };
...
function aD(e) {
    ...
    eI()(c === aR.yV.EMBEDDED_APPLICATION && null != m, "invalid application invite");
    let h = r.useCallback(() => {
...
function aB(e) {
    ...
    let E = a ? J.intl.string(J.t.eQyu1F) : J.intl.string(J.t.PYJHW6),
        ...
        C = null != t.inviter ? rL.Ay.getUserTag(t.inviter) : "";
    return (0, s.jsxs)(n_.A, {
        children: [
...
function aY(e) {
    let { location: t } = e;
    return aF.useConfig({ location: t });
}
function az(e) {
    ...
    let { analyticsLocations: m } = (0, f.Ay)(x.A.INVITE_EMBED),
        { enabled: h } = aY({ location: "GroupDMInvite" }),
        g = null != c,
        A = r.useCallback(() => {
            let e = "noop";
    ...
    let {
            ...
            ? (function (e, t, n, i) {
                  ...
                  let { recipients: s, customGroupName: r } = e,
                      a =
                          ...
                          (l = s
                              .map((e) => {
                                  let t = w.A.getNickname(e.id);
                                  if (null != t && "" !== t) return t;
                                  let n = e instanceof aV.A ? e : U.default.getUser(e.id);
                                  if (null != n) {
                                      let e = rL.Ay.getName(n);
                                      if (null != e) return e;
                                  }
                                  return e.username;
                              })
                  ...
                  if (n) {
                      let e = D.A.getChannel(t.channel_id),
                          n = e?.isDM() ? rL.Ay.getName(U.default.getUser(e.getRecipientId())) : void 0;
                      c =
                          null != n
                              ? null != r
            ...
            : (function (e, t, n) {
                  ...
                  null != r
                      ? (i = r)
                      : (null == (i = (0, nl.m1)(l, U.default, w.A)) || "" === i) &&
                        (i =
                            s.length > 0
                                ? s
                                      .filter(rl.Vq)
            ...
            ? N.map((e) =>
                  e instanceof aV.A
                      ...
                      : (U.default.getUser(e.id) ??
                        new aV.A({ id: e.id, username: e.username, avatar: e.avatar ?? null })),
              )
            : [];
    return (0, s.jsxs)(n_.A, {
...
let aJ = function (e, t) {
    ...
    return (
        ...
        (0, c.Lt)(t.flags ?? 0, aW.Q.IS_GUEST_INVITE)
    );
};
var aq = n(517905);
function aZ(e) {
    let t,
        ...
        y = (0, c.Lt)(m.flags ?? 0, aW.Q.IS_GUEST_INVITE),
        ...
        : (0, s.jsxs)(aX.s, {
              ...
              children: [
                  (0, s.jsxs)("div", {
                      ...
                      ref: d,
                      children: [
                          (0, s.jsx)(a3.J$, { profile: I, className: a5.vK }),
                          (0, s.jsx)(a3.CG, { profile: I }),
                          (0, s.jsx)(a2.A, { profile: I }),
                          (0, s.jsx)(a0.P, { profile: I, className: a5.rb }),
                          (0, s.jsx)(a6.A, {
                  ...
                  h && !c
                      ...
                      : null,
                  (0, s.jsxs)("div", {
                      className: o()(a5.qr, { [a5.iK]: h }),
                      children: [
                          h && c ? (0, s.jsx)("div", { className: a5.D7 }) : null,
                          (0, s.jsx)("div", {
                              className: o()(a5.z8, { [a5.it]: h && c }),
                              children: (0, s.jsx)("div", {
                                  className: a5.UD,
                                  children: (0, s.jsx)(a7, {
                                      invite: t,
...
function a7(e) {
    let {
        ...
        { guildId: c, ctaType: u } = (0, a$.Ay)(n, a$.cn.INVITE, t.code),
...
function a8(e) {
    let t,
        ...
        c = rL.Ay.useName(l),
        m = d === l.id,
        { enabled: h } = aY({ location: "InvalidInvite" }),
        g = (0, u.bG)([D.A, tl.A], () => {
...
function ot(e) {
    let t,
        ...
        h = (0, u.bG)(
            [oe.A],
            () => (null != n && null != n.target_user ? oe.A.getActiveStreamForUser(n.target_user.id, c) : null),
            [n, c],
        ),
        g = (0, u.bG)(
            [oe.A],
            () => (null != n && null != n.target_user ? oe.A.getStreamForUser(n.target_user.id, c) : null),
            [n, c],
        ),
    ...
    eI()(I === aR.yV.STREAM && null != C, "invalid streaming invite");
    let v = i === C.id,
...
function oh(e) {
    let { invite: t, message: n, channel: i, onTransitionToInviteChannel: l } = e,
        ...
        d = (0, u.bG)([oc.A], () => oc.A.isInChannel(i.id), [i.id]),
        { voiceStates: c } = (0, u.cf)(
            [ou.Ay],
            () => ({ voiceStates: null != i.guild_id ? ou.Ay.getVoiceStatesForChannelAlt(i.id, i.guild_id) : [] }),
            [i],
        ),
        m = r.useMemo(
        ...
        h = (0, u.bG)([or.A], () => or.A.getStartTime(i), [i]);
    r.useEffect(() => {
        null != h || null == i.guild_id || or.A.hasRequestedStartTimes(i.guild_id) || (0, os.U)(i.guild_id);
    }, [i, h]);
    let g = r.useRef(null),
        A = r.useRef(null),
        E = r.useCallback(() => {
    ...
    return (0, s.jsxs)("div", {
        ...
        children: [
                            ...
                            (0, s.jsxs)("div", {
                                ...
                                children: [
                                    ...
                                    (0, s.jsx)(on.u, {
                                        ...
                                        body: "",
                                        assetSize: 24,
                                        asset: null != o ? (0, s.jsx)(oo.Ay, { guild: o, iconSize: 24 }) : void 0,
                                        position: "top",
                                        children: (0, s.jsx)(eb.D, {
                                            className: om.HA,
                                            onClick: j,
                    ...
                    m.length > 0
                        ? (0, s.jsxs)("div", {
                              ...
                              children: [
                                  ...
                                  (0, s.jsx)("div", { ref: A, className: om.wH }),
                              ],
                          })
                        : (0, s.jsx)("div", {
                              className: om.p$,
            ...
            (0, s.jsxs)("div", {
                className: om.qr,
                children: [
                    (0, s.jsx)(ol.G, { size: "custom", color: "currentColor", className: om.Dq }),
                    (0, s.jsx)(p.E, {
                        variant: "text-sm/medium",
                        color: "currentColor",
                        lineClamp: 1,
...
function og(e) {
    ...
    return null == a
        ...
        : (0, s.jsx)(oh, { invite: t, message: n, channel: a, onTransitionToInviteChannel: i });
}
var op = n(652896),
    oA = n(834757),
    ox = n(427358),
...
function oE(e) {
    ...
    return (0, s.jsxs)(eb.D, {
        ...
        children: [
            null != r &&
                (0, s.jsx)(r, { className: of.p, color: "currentColor", size: "custom", width: 12, height: 12 }),
            (0, s.jsx)(p.E, {
                variant: "text-xs/medium",
                lineClamp: 1,
                color: "currentColor",
            ...
            (0, s.jsx)(t6._, { className: of.t4, color: "currentColor", size: "custom", width: 12, height: 12 }),
        ],
    });
}
var oI = n(562153),
            ...
            return (0, s.jsxs)(eb.D, {
                ...
                children: [
                    ...
                    (0, s.jsx)(p.E, {
                        ...
                        variant: "text-sm/medium",
                        color: "text-default",
                        children: (0, s.jsx)(ov.A, { user: t, nick: l, hideDiscriminator: !0 }),
                    }),
                ],
            });
        },
...
function oT(e) {
    let { guildId: t, channelId: n, users: i, onHoverOrFocus: l, ...a } = e,
        o = r.useCallback((e) => (0, s.jsx)(oy, { users: e, guildId: t, channelId: n, onHoverOrFocus: l }), [t, n, l]);
    return (0, s.jsx)(lW.Y, { renderPopout: () => o(i), ...a });
}
function oy(e) {
    let { users: t, guildId: n, channelId: i, onHoverOrFocus: l } = e,
        a = r.useRef(null),
        { isHoveringOrFocusing: o } = (0, oC.A)(a);
    return (
        r.useEffect(() => {
            l?.(o);
        }, [l, o]),
        (0, s.jsx)("div", {
            ...
            children: (0, s.jsx)(oi.Ip, {
                className: oN.G,
                children: t.map((e) =>
                    (0, s.jsx)(
                        oj,
                        { user: e, guildId: n ?? void 0, channelId: i, nick: oI.Ay.getNickname(n, i, e) },
                        e.id,
                    ),
                ),
            }),
...
function oL(e) {
    let { className: t, guildId: n, channelId: i, members: l, ref: a, motion: d } = e,
        ...
        [x, f] = (0, ik.z)(() => ({ x: 0, y: 0, scale: 1, config: ob }));
    return (
        r.useEffect(() => {
            f({ x: g, y: p, scale: A });
        }, [g, p, A, f]),
        (0, s.jsxs)(ib.animated.div, {
            ...
            children: [
                ...
                c && (0, s.jsx)(oR, { guildId: n, channelId: i, members: l, count: m }, "overflow"),
            ],
        })
    );
}
    ...
    let { guildId: t, channelId: n, members: i, count: l } = e,
        {
            ...
            let e = r.useRef(null),
                { isHoveringOrFocusing: t } = (0, oC.A)(e),
                [n, i] = r.useState(!1),
                l = t || n,
                [s, a] = r.useState(!1),
                o = r.useRef(null);
...
function oM(e) {
    ...
    let h = (0, u.bG)([tl.A, D.A], () => {
        ...
        g = (0, u.bG)([ou.Ay], () => (h ? ou.Ay.getVoiceStatesForChannelAlt(m.id, c.id) : []), [m.id, c.id, h]),
        ...
        T = (function (e) {
            ...
            return (0, u.bG)([oe.A, ox.A], () => {
                ...
                for (let e of [...r].sort((e, t) => {
                    let n = ox.A.getUserAffinity(e)?.vcProbability ?? 0;
                    return (ox.A.getUserAffinity(t)?.vcProbability ?? 0) - n;
                })) {
                    let t = oe.A.getStreamForUser(e, l);
                    if (null != t && t.channelId === s) return t;
                }
        ...
        O = (0, u.bG)([ox.A], () => {
            let e = g.map((e) => e.user),
                ...
                i = e
                    ...
                    .sort((e, t) => {
                        let n = ox.A.getUserAffinity(e.id)?.vcProbability ?? 0;
                        return (ox.A.getUserAffinity(t.id)?.vcProbability ?? 0) - n;
                    });
            return null != t ? [t, ...i] : i;
        }, [g, n.author.id]),
    ...
    return (0, s.jsxs)("div", {
        ...
        children: [
            (0, s.jsxs)("div", {
                ...
                onMouseLeave: V,
                children: [
                    (0, s.jsx)("div", { className: ok.ys }),
                    (0, s.jsx)("div", { className: ok.r$, style: { "--custom-number-of-dots": 20 } }),
                    (0, s.jsxs)("div", {
                        className: ok.rf,
                        children: [
                            (0, s.jsxs)("div", {
                                className: o()(ok.Qs, { [ok.tE]: 0 === O.length }),
                                children: [
                                    (0, s.jsx)(oE, { channel: m, guild: c, onClick: L }),
                                    (0, s.jsxs)("div", {
                                        className: ok.WD,
                                        children: [
                                            (0, s.jsx)(p.E, {
            ...
            (0, s.jsxs)("div", {
                className: ok.qr,
                children: [
                    (0, s.jsx)(ol.G, { size: "custom", color: "currentColor", className: ok.Dq }),
                    (0, s.jsx)(p.E, {
                        variant: "text-sm/medium",
                        color: "currentColor",
                        lineClamp: 1,
...
function oP(e) {
    ...
    let c = l ?? { state: K.elq.RESOLVING, code: "" },
        ...
        A = (0, u.bG)([aC.Ay], () => aC.Ay.getGuildScheduledEvent(c.guild_scheduled_event?.id), [c]),
        x = () => {
    ...
    switch (c.state) {
        ...
        case K.elq.BANNED:
            ...
            break;
        case K.elq.ERROR:
            I = (0, s.jsx)(aU, { author: n.author, inviteError: a });
            break;
        default:
            switch ((0, a_.On)(c)) {
                case a_.Xd.GROUP_DM:
                    ...
                    break;
                case a_.Xd.FRIEND:
                    I = (0, s.jsx)(aB, { invite: c, message: n, getAcceptInviteContext: i });
                    break;
                default:
                    if ((0, a_.G4)(c)) {
                    ...
                    if ((0, a_.oK)(c)) {
                        I = (0, s.jsx)(aD, { invite: c, getAcceptInviteContext: i, message: n });
                        break;
                    }
                    if (null != c.channel && (0, aN.OY)(c.channel).isGuildVoice() && null != c.guild) {
    ...
    return (0, s.jsx)(rk.A, { section: K.JJy.INVITE_LINK, children: I });
}
var oD = n(266620),
    ow = n(860227),
    oO = n(67416),
    ...
    let { channel: t, message: n, hideParty: i, hideInviteEmbedBanner: l } = e,
        ...
        a =
            null != n.application
                ...
                : null != n.activity && null != n.activity.party_id && (0, oG.pH)(n.activity.party_id)
                  ? oU.HT
                  : void 0,
...
function oF(e) {
    let { applicationId: t, guildId: n } = e,
        { data: i } = (0, eX.YY)(t);
    return null == i ? null : (0, s.jsx)(oY, { app: i, guildId: n });
}
function oY(e) {
...
var oz = n(394839),
    ...
    oX = n(229612);
let oQ = [K.Auw.GIFV],
    o$ = 15 * sU.A.Millis.MINUTE,
    o0 = new Set(["discord-developers", "discord-testers", "discord-townhall", "discordgameslab"]),
    o1 = (e) => () => {
        ...
        return null != i && null != l && (nZ.bp.test(n) || (a && (nZ.P8.test(n) || nZ.p4.test(n))))
            ? (0, s.jsx)(ru.A, { width: i, height: l, src: n, url: t, format: m.TL.IMAGE, className: oX.jj })
            : null;
    };
class o2 extends r.Component {
    ...
    shouldRenderInvite(e) {
        ...
        return !(t.isDM() && !t.isSystemDM() && !t.isGroupDM() && o0.has(e));
    }
    ...
    renderCtaButton() {
        ...
        return (0, s.jsx)("div", { className: oX.od, children: i });
    }
    renderCodedLinks(e) {
        ...
        return e.codedLinks.map((n) => {
            ...
            switch (i) {
                ...
                case tP.I.CHANNEL_LINK:
                    return (0, s.jsx)(sZ, { code: l, message: e }, l);
    ...
    renderEmbed = (e, t, n, i) => {
        ...
        return (0, s.jsx)(
            nE.G.Provider,
            {
                value: (0, oq.b)(m, e.image, e.video, e.thumbnail, e.provider?.name),
    ...
    renderActivityInvite(e) {
        ...
        return (0, s.jsx)(oV, { channel: t, message: e, hideParty: !1, hideInviteEmbedBanner: n });
    }
    renderPublishBump(e) {
    ...
    renderThreadRoleMentionWarning(e) {
        if (
            ...
            !(Date.now() - sI.default.extractTimestamp(e.id) >= o$)
        )
            return (0, s.jsx)("div", { className: oX.xM, children: J.intl.string(J.t.ma8Rs0) });
    }
    ...
    renderInteractionPremiumUpsell(e) {
        ...
        return e.type !== d.l.INTERACTION_PREMIUM_UPSELL || null == t
            ? null
            : (0, s.jsx)(oF, { applicationId: t, guildId: this.props.channel.guild_id });
    }
    ...
    renderPoll(e, t) {
        if (null != t) return (0, s.jsx)(iK, { message: e, poll: t, className: oX.PM });
    }
    ...
    renderEditedTag(e, t) {
        return (0, s.jsx)(oJ.A, { message: e, compact: t, location: oJ.O.AFTER_ACCESSORIES });
    }
    render() {
...
function o3(e) {
    let t,
        ...
        p = nn.kt.useSetting(),
        A = (0, u.bG)([sw.A], () => null == n.guild_id || sw.A.canChatInGuild(n.guild_id), [n]),
