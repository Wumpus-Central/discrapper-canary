...
var r = n(74538),
    ...
    s = n(388032);
let l = (e) => {
        let { showTrialCTA: t, subscriptionTier: n, trialDurationCopy: i, isPersistentCTA: o, shouldShowReferralTrialCopy: l, subscriptionTrial: c } = e;
        return t && l
    ...
    c = (e, t, n, r) => (t || n ? s.intl.string(s.t.fkPGam) : e === a.Si.TIER_2 ? s.intl.formatToPlainString(s.t.bkQ4bG, { percent: r }) : void 0),
    u = (e) => {
        var t, n;
        let { subscriptionTier: u, hasActivePromotion: d = !1, useShorterCTA: f = !1, isPersistentCTA: _ = !1 } = e,
            ...
            m = (0, i.Ng)(),
            g = (0, i.Wp)(m, a.Si.TIER_2) ? a.Si.TIER_2 : void 0,
            E = (0, r.a5)({
            ...
            y = null != h && b === h.sku_id,
            O = (null == p ? void 0 : p.trial_id) === a.a7;
        return {
            buttonText: d
