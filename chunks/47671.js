...
let C = () => {
    ...
    R = () => {
        ...
        let e = h.eh.getSetting().backgroundGradientPresetId;
        if (null == e) {
            if (null == i) return !1;
            i = void 0;
        } else {
...
class b extends s.Ay.PersistedStore {
    ...
    initialize(e) {
        null != e && (i = e?.gradientPresetId != null ? T.ag[e.gradientPresetId] : void 0),
            this.waitFor(E.A, u.A, d.A, _.Ay, f.A, m.default),
            this.syncWith([m.default], C),
            this.syncWith([u.A], R);
    }
    getState() {
        return y ? {} : { gradientPresetId: i?.id };
    }
    get gradientPreset() {
        return i;
    }
