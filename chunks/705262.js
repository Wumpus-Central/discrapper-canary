...
let W = Object.freeze({
    ...
    q = (e) => {
        let { type: t, isPreview: n, isCoachmark: i } = e,
            o = (0, E.Q3)('GradientSelectorsTitle'),
            a = (0, s.EQ)({
        ...
        return (0, r.jsxs)('div', {
            ...
            children: [
                ...
                (0, r.jsx)(v.Z, { className: U.premiumIcon })
            ]
        });
    },
    Q = (e) => {
        ...
        if ((null == (n = (0, y.N)()) || null == (t = n.subscription_trial) ? void 0 : t.sku_id) === L.Si.TIER_2 && o) return null;
        let l = (0, s.EQ)({
            type: i,
            isPreview: o,
            isCoachmark: a
            ...
            .with(
                ...
                () => j.intl.format(j.t.G8yQXl, { onPremiumClick: () => b.z })
            )
            .with(
                {
                    type: 'EDITOR',
            ...
            .with({ isPreview: !0 }, () => j.intl.format(j.t.DWIjJy, { onPremiumClick: () => b.z }))
    ...
    X = (e) => {
        ...
        return 'EDITOR' === s && c && u
            ? (0, r.jsx)(O.ZP, {
                  ...
                  children: j.intl.format(j.t.G8yQXl, { onPremiumClick: () => b.z })
              })
            : (0, r.jsxs)('div', {
                  className: U.header,
                  children: [
