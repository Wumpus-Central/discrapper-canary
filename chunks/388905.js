...
R.Sizes = s.EFr;
let P = (e) => {
        let { label: t, error: n, placeholder: i, value: o, className: l, inputClassName: c, setRef: u, type: _ = 'text', onChange: f, autoComplete: p, autoFocus: h, maxLength: m, spellCheck: E, name: b, description: y, required: O, onFocus: v, onBlur: I } = e,
            T = (0, d.Dt)();
