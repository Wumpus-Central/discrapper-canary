...
function E(e) {
    ...
    void 0 !== E && (N.avatar_decoration_sku_id = E?.skuId ?? null),
        void 0 !== I && (N.nameplate_sku_id = I?.skuId ?? null),
        void 0 !== T && (N.primary_guild_id = T),
        null != S
            ? ((N.display_name_font_id = S.fontId),
              (N.display_name_effect_id = S.effectId),
              (N.display_name_colors = S.colors))
            : null === S &&
              ((N.display_name_font_id = null), (N.display_name_effect_id = null), (N.display_name_colors = null));
    let v = r.w.get(c.Xlh),
        C = (0, d.oH)();
    null != C && null != v && ((N.push_provider = C), (N.push_token = v));
    let R = r.w.get(c.Ahp);
    return (
        null != d.vz && null != R && ((N.push_voip_provider = d.vz), (N.push_voip_token = R)),
        p(N, { headers: a.A.buildHeadersForMd5({ [o.f.USER_DEFAULT_PROFILE_AVATAR]: y }) }).then(
            (e) => (
