...
function E(e) {
    ...
    void 0 !== E && (C.avatar_decoration_sku_id = E?.skuId ?? null),
    ...
    let N = r.w.get(c.Xlh),
        v = (0, d.oH)();
    null != v && null != N && ((C.push_provider = v), (C.push_token = N));
    let R = r.w.get(c.Ahp);
    return (
        null != d.vz && null != R && ((C.push_voip_provider = d.vz), (C.push_voip_token = R)),
        p(C, { headers: a.A.buildHeadersForMd5({ [o.f.USER_DEFAULT_PROFILE_AVATAR]: y }) }).then(
            (e) => (
