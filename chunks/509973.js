var i = n(105953).RBTree;
function r(e, t, n) {
    (this.discrete = !1 === e),
        (this.delta = e || 0.01),
        (this.K = void 0 === t ? 25 : t),
        (this.CX = void 0 === n ? 1.1 : n),
        (this.centroids = new i(s)),
        (this.nreset = 0),
        this.reset();
}
function s(e, t) {
...
function o(e) {
    (this.config = e || {}),
        ...
        r.call(this, "cont" === this.mode && e.delta),
...
(r.prototype.reset = function () {
    ...
    (r.prototype._digest = function (e, t) {
        ...
        if (r && r.mean === e) this._addweight(r, e, t);
            ...
            var s = r.mean_cumn / this.n;
            Math.floor(4 * this.n * this.delta * s * (1 - s)) - r.n >= t
                ? this._addweight(r, e, t)
                : this._new_centroid(e, t, r.cumn);
        }
    ...
    (r.prototype._percentile = function (e) {
        if (0 !== this.size()) {
            ...
            var t = this.n * e,
                ...
                i = n[0],
                r = n[1];
            return r === i || null === i || null === r
                ? (i || r).mean
                : this.discrete
                  ? t <= i.cumn
                      ? i.mean
                      : r.mean
                  : i.mean + ((t - i.mean_cumn) * (r.mean - i.mean)) / (r.mean_cumn - i.mean_cumn);
        }
    }),
