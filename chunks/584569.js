...
function S() {
    ...
    return (
        A.forEach((i) => {
            if (null != h.A.getVoiceStateForChannel(e, i)) return void A.delete(i);
...
class C extends i.Ay.Store {
    ...
    initialize() {
        this.waitFor(h.A, _.default, c.A, d.A), this.syncWith([_.default], S);
    }
...
let y = new C(s.h, {
    ...
    RTC_CONNECTION_STATE: function (e) {
        ...
        if (n !== r.x.DEFAULT || t !== E.S7L.DISCONNECTED) return !1;
        N();
    },
    ...
    RTC_CONNECTION_CLIENT_CONNECT: function (e) {
        ...
        return (
            s === r.x.DEFAULT &&
            t.reduce((e, t) => {
                if (null != h.A.getVoiceStateForChannel(i, t)) return e;
