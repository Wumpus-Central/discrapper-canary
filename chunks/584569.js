...
function _() {
    ...
    return (
        m.forEach((i) => {
            ...
            null != l && ((n = !0), m.delete(i), p(l, t, e));
        }),
        n
    );
}
function N() {
    I.clear(), S.clear(), m.clear();
}
...
let v = new T(s.h, {
    ...
    RTC_CONNECTION_STATE: function (e) {
        ...
        if (n !== l.x.DEFAULT || t !== f.S7L.DISCONNECTED) return !1;
        N();
    },
    ...
    RTC_CONNECTION_CLIENT_CONNECT: function (e) {
        ...
        return (
            ...
            t.reduce((e, t) => {
                ...
                return null == l ? (m.add(t), e) : (p(l, n, i), !0);
            }, !1)
        );
    },
