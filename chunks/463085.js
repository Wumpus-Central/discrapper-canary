...
var r = n(255367),
    ...
    a = n(710260);
function o(e) {
    let { children: t, theme: n, primaryColor: o, secondaryColor: s, gradient: l, flags: c, contrast: u, saturation: d, density: _, disableAdaptiveTheme: f, reduceAdaptiveTheme: p } = e,
        h = i.useContext(a.Ni);
    a.qF;
    let m = i.useMemo(
        () =>
