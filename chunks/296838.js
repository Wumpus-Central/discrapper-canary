...
function G(e) {
    switch (e.key) {
        case j.dh.ARROW_UP:
            return "UP";
        case j.dh.ARROW_DOWN:
            return "DOWN";
        case j.dh.ARROW_LEFT:
            return "LEFT";
        case j.dh.ARROW_RIGHT:
            return "RIGHT";
        default:
            return null;
    }
}
let M = [I.Q_.MESSAGE, I.Q_.NAVIGATION, I.Q_.VOICE_AND_VIDEO, I.Q_.CHAT, I.Q_.MISCELLANEOUS];
function D(e) {
        ...
        return (0, i.jsxs)(u.A.div, {
            ...
            children: [
                (0, i.jsxs)(p.H, {
                    className: L.GK,
                    children: [
                        (0, i.jsx)("div", { className: L.Qs, children: R.intl.string(R.t["1BdUtx"]) }),
                        (0, i.jsx)(g.e, { shortcut: "mod+/" }),
                    ],
                }),
                (0, i.jsx)("div", { className: L.KV, children: R.intl.string(R.t["2t19lU"]) }),
                (0, i.jsxs)("div", {
                    className: L.Pg,
                    children: [
    ...
    return (0, i.jsxs)(i.Fragment, {
        children: [
            ...
            (0, i.jsx)(x.EO, {
                ...
                size: x.rI.DYNAMIC,
                "aria-label": R.intl.string(R.t.T9DA2K),
                transitionState: t,
