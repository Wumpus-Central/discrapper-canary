!(function (t, n) {
    ...
    var ej = d.unpack,
        ...
        eF = function () {
            ...
            return (
                0 === c
                    ? (e = NaN)
                    : ((e = eZ((e = (i - a + (i - o)) / 2 / eB((i - a) * (i - a) + (i - o) * (a - o))))),
                      o > a && (e = eU - e),
                      (e /= eU)),
                [360 * e, c, l]
            );
    ...
    var tP = d.unpack,
        ...
        tM = function () {
            ...
            var n = tP(e, "lab"),
                ...
                o = tw(i * i + a * a),
                s = (tL(a, i) * tD + 360) % 360;
            return 0 === tx(10000 * o) && (s = NaN), [r, o, s];
        },
        tk = d.unpack,
        tj = tg,
        tU = tM,
    ...
    var nD = d.unpack,
        ...
        nx = function () {
            ...
            return [
                255 * nM(4.0767416621 * a - 3.3077115913 * o + 0.2309699292 * s),
                255 * nM(-1.2684380046 * a + 2.6097574011 * o - 0.3413193965 * s),
                255 * nM(-0.0041960863 * a - 0.7034186147 * o + 1.707614701 * s),
                e.length > 3 ? e[3] : 1,
            ];
        };
    function nM(e) {
        var t = Math.abs(e);
        return t > 0.0031308 ? (nL(e) || 1) * (1.055 * nw(t, 1 / 2.4) - 0.055) : 12.92 * e;
    }
    var nk = d.unpack,
        nj = d.type,
        nU = y,
        ...
        rO = function (e, t, n, r) {
            ...
            return (
                ...
                ("h" === r.substr(0, 1) || "oklch" === r) &&
                    ((l = (i = o)[0]), (u = i[1]), (f = i[2]), (c = (a = s)[0]), (d = a[1]), (_ = a[2])),
                isNaN(l) || isNaN(c)
                    ? isNaN(l)
                        ? isNaN(c)
                            ? (h = NaN)
    ...
    var rD = E,
        ...
        rB = function (e, t) {
            ...
            return (
                (r[0] = rx(r[0])), (r[1] = rx(r[1])), (r[2] = rx(r[2])), r[3] > 0.9999999 && (r[3] = 1), new rD(rw(r))
            );
        },
        rZ = y,
        rF = d.type,
        ...
        var r7 = rJ,
            ...
            iy = function (e, t, n) {
                ...
                if (("c" === t.substr(0, 1) && (o.push(r), o.push(i)), "e" === t.substr(0, 1))) {
                    ...
                    for (O.push(i); b; ) {
                        ...
                        for (var T = 0; T < m; T++)
                            for (var S = a[T], A = Number.MAX_VALUE, C = void 0, N = 0; N < n; N++) {
                                var R = iE(O[N] - S);
                                R < A && ((A = R), (C = N)), E[C]++, (g[T] = C);
                            }
                        for (var P = Array(n), D = 0; D < n; D++) P[D] = null;
                        for (var w = 0; w < m; w++) null === P[(h = g[w])] ? (P[h] = a[w]) : (P[h] += a[w]);
            ...
            ik = function (e, t, n, r, i) {
                ...
                var s = Array.from(e.lab()),
                    ...
                    p = d[2],
                    h = (l + f) / 2,
                    m = (iA(iC(c, 2) + iC(u, 2)) + iA(iC(_, 2) + iC(p, 2))) / 2,
                    g = 0.5 * (1 - iA(iC(m, 7) / (iC(m, 7) + iC(25, 7)))),
                    E = c * (1 + g),
                    b = _ * (1 + g),
                    y = iA(iC(E, 2) + iC(u, 2)),
                    O = iA(iC(b, 2) + iC(p, 2)),
                    ...
                    N =
                        ...
                        0.2 * iw(o(4 * C - 63)),
                    R = A - S;
                (R = 180 >= iD(R) ? R : A <= S ? R + 360 : R - 360), (R = 2 * iA(y * O) * iL(o(R) / 2));
                var P = f - l,
                    D = O - y,
                    w = 1 + (0.015 * iC(h - 50, 2)) / iA(20 + iC(h - 50, 2)),
                    L = 1 + 0.045 * v,
                    x = 1 + 0.015 * v * N,
                    M = 30 * ix(-iC((C - 275) / 25, 2)),
                    k = -(2 * iA(iC(v, 7) / (iC(v, 7) + iC(25, 7)))) * iL(2 * o(M));
                return iR(
                    0,
                    iN(
                        100,
