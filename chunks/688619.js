!(function (t, n) {
    ...
    var ej = d.unpack,
        ...
        eV = function () {
            ...
            var r = ej(t, 'rgb'),
                ...
                l = (i + a + o) / 3,
                c = l > 0 ? 1 - s / l : 0;
            return 0 === c ? (e = NaN) : ((e = eF((e = (i - a + (i - o)) / 2 / eB((i - a) * (i - a) + (i - o) * (a - o))))), o > a && (e = eU - e), (e /= eU)), [360 * e, c, l];
        },
        eZ = d.unpack,
        eH = d.limit,
        eY = d.TWOPI,
    ...
    var tP = d.unpack,
        ...
        tH = function () {
            ...
            var n = tB(e, 'lch'),
                ...
                i = n[1],
                a = n[2];
            return isNaN(a) && (a = 0), [r, tZ((a *= tF)) * i, tV(a) * i];
        },
        tY = d.unpack,
        tW = tH,
        tK = tI,
    ...
    var nw = d.unpack,
        ...
        nx = function () {
            ...
            return [255 * nM(4.0767416621 * a - 3.3077115913 * o + 0.2309699292 * s), 255 * nM(-1.2684380046 * a + 2.6097574011 * o - 0.3413193965 * s), 255 * nM(-0.0041960863 * a - 0.7034186147 * o + 1.707614701 * s), e.length > 3 ? e[3] : 1];
        };
    function nM(e) {
        var t = Math.abs(e);
    ...
    var rw = E,
        ...
        rG = function (e, t, n) {
            ...
            return (f /= r), new rw(o, t).alpha(f > 0.99999 ? 1 : f, !0);
        },
        rB = function (e, t) {
        ...
        rH = function (e) {
            ...
            return (
                ...
                (v.padding = function (e) {
                    return null != e ? ('number' === rV(e) && (e = [e, e]), (o = e), v) : o;
                }),
        ...
        var r7 = rJ,
            ...
            iy = function (e, t, n) {
                ...
                if (('c' === t.substr(0, 1) && (o.push(r), o.push(i)), 'e' === t.substr(0, 1))) {
                    ...
                    for (var j = 0; j < m; j++) M[(h = g[j])].push(a[j]);
                    ...
                    for (var B = 1; B < U.length; B += 2) {
                        var F = U[B];
                        isNaN(F) || -1 !== o.indexOf(F) || o.push(F);
                    }
                }
                return o;
            },
            ...
            ik = function (e, t, n, r, i) {
                ...
                var P = f - l,
                    ...
                    k = -(2 * iA(iN(v, 7) / (iN(v, 7) + iN(25, 7)))) * iL(2 * o(M));
    ...
    var iz = iH,
        iq = y;
    return (iq.average = rG), (iq.bezier = rX), (iq.blend = r7), (iq.cubehelix = is), (iq.mix = iq.interpolate = rs), (iq.random = i_), (iq.scale = rH), (iq.analyze = iO), (iq.contrast = iT), (iq.deltaE = ik), (iq.distance = iU), (iq.limits = iv), (iq.valid = iB), (iq.scales = iZ), (iq.colors = t4), (iq.brewer = iz), iq;
});
