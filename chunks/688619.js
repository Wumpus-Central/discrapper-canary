    ...
    var tP = d.unpack,
        ...
        tH = function () {
            ...
            var n = tB(e, "lch"),
                ...
                i = n[1],
                a = n[2];
            return isNaN(a) && (a = 0), [r, tF((a *= tZ)) * i, tV(a) * i];
        },
        tY = d.unpack,
        tW = tH,
        tK = tI,
    ...
    var rw = E,
        ...
        rG = function (e, t, n) {
            ...
            for (var _ = 0; _ < o.length; _++)
                if ("h" === t.charAt(_)) {
                    for (var p = (rU(c / s[_], l / s[_]) / rj) * 180; p < 0; ) p += 360;
                    for (; p >= 360; ) p -= 360;
                    o[_] = p;
                } else o[_] = o[_] / s[_];
        ...
        var r7 = rJ,
            ...
            iM = function (e, t, n, r, i) {
                ...
                var P = f - l,
                    ...
                    M = -(2 * iA(iC(v, 7) / (iC(v, 7) + iC(25, 7)))) * ix(2 * o(j));
                return iR(
                    0,
                    iN(
                        100,
            ...
            iF = {
                cool: function () {
                    return iV([iZ.hsl(180, 1, 0.9), iZ.hsl(250, 0.7, 0.4)]);
                },
                hot: function () {
