        ...
        var r7 = rJ,
            ...
            iy = function (e, t, n) {
                ...
                if (("c" === t.substr(0, 1) && (o.push(r), o.push(i)), "e" === t.substr(0, 1))) {
                    ...
                    for (O.push(i); b; ) {
                        ...
                        for (var I = 0; I < h; I++)
                            for (var T = a[I], A = Number.MAX_VALUE, C = void 0, N = 0; N < n; N++) {
                                var P = iE(O[N] - T);
                                P < A && ((A = P), (C = N)), E[C]++, (g[I] = C);
                            }
                        for (var R = Array(n), w = 0; w < n; w++) R[w] = null;
                        for (var D = 0; D < h; D++) null === R[(m = g[D])] ? (R[m] = a[D]) : (R[m] += a[D]);
            ...
            iM = function (e, t, n, r, i) {
                ...
                var s = Array.from(e.lab()),
                    ...
                    _ = d[2],
                    m = (l + f) / 2,
                    h = (iA(iC(c, 2) + iC(u, 2)) + iA(iC(p, 2) + iC(_, 2))) / 2,
                    g = 0.5 * (1 - iA(iC(h, 7) / (iC(h, 7) + iC(25, 7)))),
                    E = c * (1 + g),
                    b = p * (1 + g),
                    y = iA(iC(E, 2) + iC(u, 2)),
                    O = iA(iC(b, 2) + iC(_, 2)),
                    ...
                    N =
                        ...
                        0.2 * iD(o(4 * C - 63)),
                    P = A - T;
                (P = 180 >= iw(P) ? P : A <= T ? P + 360 : P - 360), (P = 2 * iA(y * O) * ix(o(P) / 2));
                var R = f - l,
                    w = O - y,
                    D = 1 + (0.015 * iC(m - 50, 2)) / iA(20 + iC(m - 50, 2)),
                    x = 1 + 0.045 * v,
                    L = 1 + 0.015 * v * N,
