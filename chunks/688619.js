    ...
    var ek = d.unpack,
        ...
        eB = function () {
            ...
            return (
                0 === c
                    ? (e = NaN)
                    : ((e = eF((e = (i - a + (i - o)) / 2 / eZ((i - a) * (i - a) + (i - o) * (a - o))))),
                      o > a && (e = eU - e),
                      (e /= eU)),
                [360 * e, c, l]
            );
    ...
    var tR = d.unpack,
        ...
        tH = function () {
            ...
            var n = tZ(e, "lch"),
                ...
                i = n[1],
                a = n[2];
            return isNaN(a) && (a = 0), [r, tV((a *= tF)) * i, tB(a) * i];
        },
        tY = d.unpack,
        tW = tH,
        tK = tS,
                    ...
                    if (_ && p[f]) i = p[f];
                        ...
                        if ("array" === rB(l))
                            for (var h = 0; h < a.length; h++) {
                                ...
                                if (c > y && c < a[h + 1]) {
                                    (c = (c - y) / (a[h + 1] - y)), (i = rF.interpolate(l[h], l[h + 1], c, t));
                                    break;
                                }
                            }
            ...
            iM = function (e, t, n, r, i) {
                ...
                var s = Array.from(e.lab()),
                    ...
                    N =
                        ...
                        0.2 * iD(o(4 * A - 63)),
                    P = C - T;
                (P = 180 >= iw(P) ? P : C <= T ? P + 360 : P - 360), (P = 2 * iC(y * O) * ix(o(P) / 2));
                var R = f - l,
                    w = O - y,
                    D = 1 + (0.015 * iA(m - 50, 2)) / iC(20 + iA(m - 50, 2)),
                    x = 1 + 0.045 * v,
                    L = 1 + 0.015 * v * N,
