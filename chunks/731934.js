                    ...
                    (0, i.jsxs)('div', {
                        children: [
                            (0, i.jsx)(c.X6q, {
                                ...
                                children: (0, i.jsx)(c.y5t, { children: v.intl.string(E.default.pHEnV1) })
                            }),
                            (0, i.jsx)(c.Text, {
                                variant: 'text-sm/medium',
                                color: 'text-muted',
                                className: N.marginBottom20,
                                children: v.intl.string(E.default['1J/gZ2'])
                            })
                        ]
                    }),
                    (0, i.jsx)('img', {
                        ...
                        src: I,
                        alt: v.intl.string(E.default['r+PDmp'])
                    })
                ]
            }),
            (0, i.jsxs)('div', {
                ...
                children: [
                    (0, i.jsx)(y, {
                        header: v.intl.string(E.default['7xxAnp']),
                        description: v.intl.string(E.default['1M9So6']),
                        stepNumber: 1
                    }),
                    (0, i.jsx)(y, {
                        header: v.intl.string(E.default['AXgx+f']),
                        description: v.intl.string(E.default.GzMFnZ),
                        stepNumber: 2
                    }),
                    (0, i.jsx)(y, {
                        header: v.intl.string(E.default.MZn1tL),
                        description: v.intl.string(E.default['8rLBxM']),
                        stepNumber: 3
                    })
                ]
            })
            ...
            (0, i.jsxs)('div', {
                children: [
                    (0, i.jsx)(c.X6q, {
                        className: N.marginBottom8,
                        variant: 'heading-xl/medium',
                        children: (0, i.jsx)(c.y5t, { children: v.intl.string(E.default.zUCWEB) })
                    }),
                    (0, i.jsx)(c.Text, {
                        variant: 'text-sm/medium',
                        color: 'text-muted',
                        className: N.marginBottom20,
                        children: v.intl.format(E.default.yMnoDg, { link: 'https://support.discord.com/hc/articles/14155060633623' })
                    }),
                    e ? null : (0, i.jsx)(b.Z, {})
                ]
            }),
        ...
        return t.length > 0
            ...
            : (0, i.jsxs)('div', {
                  ...
                  children: [
                      ...
                      (0, i.jsx)('div', {
                          className: T.box,
                          children: (0, i.jsx)(f.Z, { text: v.intl.string(E.default.C4ScLC) })
                      })
                  ]
              });
    },
            ...
            : (0, i.jsxs)('div', {
                  ...
                  children: [
                      (0, i.jsx)(c.X6q, {
                          ...
                          children: (0, i.jsx)(c.y5t, { children: v.intl.string(E.default['7/tVho']) })
                      }),
                      (0, i.jsx)(c.Text, {
