    ...
    return (0, i.jsxs)('div', {
        ...
        children: [
            ...
            (0, i.jsxs)('div', {
                ...
                children: [
                    (0, i.jsx)(y, {
                        header: v.intl.string(O.default['7xxAnp']),
                        description: v.intl.string(O.default['1M9So6']),
                        stepNumber: 1
                    }),
                    (0, i.jsx)(y, {
                        header: v.intl.string(O.default['AXgx+f']),
                        description: v.intl.string(O.default.GzMFnZ),
                        stepNumber: 2
                    }),
                    (0, i.jsx)(y, {
                        header: v.intl.string(O.default.MZn1tL),
                        description: v.intl.string(O.default['8rLBxM']),
                        stepNumber: 3
                    })
                ]
            })
            ...
            (0, i.jsxs)('div', {
                children: [
                    ...
                    (0, i.jsx)(c.Text, {
                        ...
                        color: 'text-muted',
                        className: I.marginBottom20,
                        children: v.intl.format(O.default.yMnoDg, { link: 'https://support.discord.com/hc/articles/14155060633623' })
                    }),
                    e ? null : (0, i.jsx)(b.Z, {})
                ]
            }),
...
let D = () => {
        let e = (0, g.Z)(),
            ...
            s = (0, m.o)(v.intl.formatToPlainString(O.default['+tnO39'], r), v.intl.formatToPlainString(O.default['pu6/U1'], r));
        return t.length > 0
            ? (0, i.jsx)(R, {
            ...
            : (0, i.jsxs)('div', {
                  ...
                  children: [
                      ...
                      (0, i.jsx)('div', {
                          className: T.box,
                          children: (0, i.jsx)(f.Z, { text: v.intl.string(O.default.C4ScLC) })
                      })
                  ]
              });
    },
    Z = () => {
        let e = (0, h.VM)(),
            t = (0, g.Z)() ? E.AG : E.i0,
            n = (0, m.o)(v.intl.formatToPlainString(O.default['1/PzIi'], { maxConnections: t }), v.intl.formatToPlainString(O.default.RcTgiI, { maxConnections: t }));
        return e
            ? (0, i.jsx)('div', {
    ...
    w = () => {
        let e = (0, p.o)(),
            ...
            n = (0, l.EQ)({
                ...
                .with({ helpline: !0 }, () => v.intl.format(O.default.KOwsf3, { helpLink: 'https://support.discord.com/hc/articles/7925648993943-Crisis-Text-Line' }))
                .with({ throughline: !0 }, () => v.intl.format(O.default['6tsC8v'], { helpLink: C.$l }))
                .otherwise(() => null);
        return null == n
            ? null
            : (0, i.jsxs)('div', {
                  ...
                  children: [
                      (0, i.jsx)(c.X6q, {
                          ...
                          children: (0, i.jsx)(c.y5t, { children: v.intl.string(O.default['7/tVho']) })
                      }),
                      (0, i.jsx)(c.Text, {
    ...
    k = () => {
        let e = (0, h.mq)(E.ne.PENDING),
            t = (0, m.o)(v.intl.formatToPlainString(O.default.IkAgkJ, { count: e.length }), v.intl.formatToPlainString(O.default.Q8XnAQ, { count: e.length }));
        return 0 === e.length
            ? null
            : (0, i.jsx)(R, {
