...
function x(e) {
    let { currentUser: t, channel: n, message: a, buttonLabels: d, stickers: u, event: m, eventProperties: _ } = e,
        E = l.useMemo(() => p({ assets: u, currentUser: t, message: a }), [u, t, a]),
        h = l.useMemo(() => p({ assets: d, currentUser: t, message: a }), [d, t, a]),
