...
let ts = r.memo(function (e) {
    let { clip: t, isNew: n, onClose: a, className: l } = e,
        o = r.useRef(null),
        { isHoveringOrFocusing: d } = (0, e7.A)(o),
        c = r.useCallback(() => {
...
var tP = n(282613);
let tU = r.lazy(() => Promise.all([n.e("22683"), n.e("24832")]).then(n.bind(n, 748579)));
function tw() {
...
function nQ(e) {
    let { currentUser: t, onClose: n, setPopoutRef: a, highlightBadge: l, openedAt: o, className: d } = e,
        ...
        { isHoveringOrFocusing: S, isHovering: N } = (0, e7.A)(m);
    r.useEffect(() => {
        a?.(m.current);
    }, [m, a]),
        r.useEffect(
        ...
        en = (function () {
            ...
            return (
                ...
                r.useEffect(() => {
                    ...
                    return (
                        s && e && i && null != a && n7.Ay.getMediaEngine().on(ir.bg.VoiceActivity, o),
                        () => {
                            n7.Ay.getMediaEngine().removeListener(ir.bg.VoiceActivity, o), r.stop();
                        }
                    );
                }, [e, i, s, a]),
                t
