...
class x extends A.A {
    ...
    handleRTCConnectionState(e) {
        ...
        if (!(0, v.Pm)() || n !== M.S7L.RTC_CONNECTED) return;
    ...
    handleClipsInitFailure(e) {
        ...
        C.default.track(M.HAw.CLIPS_INIT_FAILURE, {
            application_name: t,
            error_message: n,
    ...
    async classifyHardwareAndTrack() {
        try {
            ...
            return (
                C.default.track(M.HAw.CLIPS_HARDWARE_CLASSIFICATION, {
                    classification: t,
                    version: w.V0,
                    gpu_models: e,
...
class V {
    ...
    async start() {
        if ((F.info("Clips asset manager started"), !(0, L.TD)() || !(0, N.isWindows)() || __OVERLAY__))
    ...
    async refreshCatalog() {
        if (!this.catalogRefreshing)
            try {
                ...
                await m.Ay.cleanupUnusedClipsFiles(t), F.info("Clips asset catalog refreshed");
            } catch (e) {
...
class ee extends x {
    ...
    handleClipsReminder(e) {
        ...
        let { enabled: n } = j.O.getConfig({ location: "ClipsManager" }),
            i = n && !R.Ay.getSettings().showPovClipsInGallery;
        t.newClipIds.some((t) => {
            let n = R.Ay.getClipById(t);
            return null != n && n.applicationId === e && (!i || !(0, Y.kD)(n));
        }) && (0, K.M8)(e);
    }
    showClipsToast() {
        (0, r.P0)({
            id: "CLIPS_IN_CALL_WARNING",
            message: $.intl.string($.t["d+41qJ"]),
            type: s.Ck.CLIP,
        ...
        (0, L.TD)()
            ? (!(function () {
                  ...
                  i && a.setClipsV3Enabled(e),
                      w.nx.info(
                          `clips v3 runtime flags pushed: v3=${e} (was ${Z}), ml=${t} (was ${X}), autoclipping=${n} (was ${Q})`,
                      ),
                      (Z = e),
                      (X = t),
                      (Q = n),
    ...
    handleClipsInitOnGamesChange(e) {
        let t = c.Ay.getVisibleGame();
        if (((0, W.yj)(), e.removed.length > 0 && null == t)) {
