        ...
        actions: [
            {
                ...
                variant: "primary",
                onClick: () => {
                    n(U.i.TAKE_ACTION), (0, f.pX)(D.BVt.CHANNEL(t, M.VV.GAME_SERVERS));
                },
            },
        ],
        markAsDismissed: n,
        ...
        actions: [
            {
                ...
                onClick: () => {
                    n(U.i.TAKE_ACTION),
                        (0, g.K4)({
                            guildId: t,
                            location: { section: D.JJy.GUILD_HEADER, object: D.ZSU.BUTTON_CTA },
        ...
        actions: [
            {
                ...
                onClick: async () => {
                    ...
                    if (null == e) return;
                    let i = { page: D.liQ.GUILD_CHANNEL, section: D.JJy.GUILD_HEADER };
                    await (0, p.g)({
                        guild: e,
