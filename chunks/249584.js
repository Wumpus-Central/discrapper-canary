...
function W(e) {
    ...
    return (0, i.jsx)(et, {
        asset: (0, i.jsx)(T.b, { className: a()(w.Sl, w.SV) }),
...
function z(e) {
    ...
    return (0, i.jsx)(et, {
        ...
        asset:
            n.length > 1
                ? (0, i.jsx)(T.b, { className: a()(w.Sl, w.SV) })
                : (0, i.jsx)("img", { alt: "", src: h, className: w.Sl }),
        title: P.intl.formatToPlainString(U.default.LmpChE, { guildName: r }),
        body: m,
        actions: [
            {
                text: g ? P.intl.string(U.default.gSxlHf) : P.intl.string(P.t.RzWDqY),
                variant: "primary",
                onClick: (e) => {
...
function q(e) {
    ...
    return null != d
        ? (0, i.jsx)(et, {
              ...
              size: "video",
              asset: (0, i.jsx)("img", { alt: "", src: k.A, className: w.Sl }),
              actions: [
                  {
                      text: P.intl.string(P.t.RzWDqY),
                      variant: "primary",
    ...
    return (0, i.jsx)(et, {
        ...
        body:
            n === E.o.GAME_SERVER_HOSTING_AVAILABLE
                ? P.intl.formatToPlainString(G.default["7KXp9J"], { gameName: r, gameName2: d })
                : P.intl.format(G.default["IQ1E+d"], { boostCount: a }),
        actions: [
            {
                text: P.intl.string(P.t.RzWDqY),
                variant: "primary",
...
function Q(e) {
    ...
    return (0, i.jsx)(et, {
        ...
        body: P.intl.formatToPlainString(G.default.V9qFAU, { gameName: l, gameName2: a }),
        actions: [
            {
...
function $(e) {
    ...
    return (0, i.jsx)(et, {
        ...
        alignmentStrategy: "edge",
        caretConfig: l ? { align: "start" } : { align: "center" },
        asset: (0, i.jsx)("img", { alt: "", src: V.A, className: a()(w.Sl, w.RV) }),
...
function ee(e) {
    let { guildId: t, featuredExpiringPowerup: n, channelRowRef: l, markAsDismissed: a } = e,
        r = (0, c.bG)([C.A], () => C.A.getStateForGuild(t)),
        { analyticsLocations: d } = (0, m.Ay)(A.A.GUILD_POWERUPS_COACHMARK_EXPIRING_PERK),
        u = (0, b.A)(t),
        g = r?.allPowerups[n.skuId],
        _ = (0, I.A)(g, !0),
        x = s.useRef(null),
    ...
    return (0, i.jsx)(et, {
        ...
        asset: n.isGameServer
            ...
            : g?.type === O.o9.LEVEL
              ? (0, i.jsx)(v.n, { powerup: g, eventTargetRef: x, className: w.Lj })
        ...
        actions: [
            {
                ...
                onClick: async () => {
                    ...
                    await (0, p.g)({
                        ...
                        analyticsLocation: i,
                        analyticsLocations: d,
                        intent: g?.type === O.o9.PERK || n.isGameServer ? O.Pn.PERK : void 0,
                    }),
                        a(D.i.TAKE_ACTION);
                },
            },
