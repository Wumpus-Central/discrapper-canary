...
let m = new E(l.h, {
    ...
    MULTI_ACCOUNT_VALIDATE_TOKEN_REQUEST: (e) => p(e.userId, 1),
    MULTI_ACCOUNT_VALIDATE_TOKEN_SUCCESS: (e) => p(e.userId, 2),
    MULTI_ACCOUNT_VALIDATE_TOKEN_FAILURE: (e) => p(e.userId, 0),
