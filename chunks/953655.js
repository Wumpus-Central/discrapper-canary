...
let g = (e) => {
        let { handleTransition: t, featuredBlockRecord: n } = e,
            l = u.Z.getCategory(a.T.ROBERT),
            c = (0, C.c)('CollectiblesFeedShop') && null != l,
            d = u.Z.getCategory(a.T.ANIME_V2),
            g = i.useMemo(() => f.intl.string(new Date() > p.gJ ? f.t.l0CjbW : f.t.uPewb2), []);
        return (0, r.jsx)('div', {
            className: s()(m.section, m.col2, m.featuredBlocksContainer),
            children:
                null == n
                    ? void 0
                    : n.subblocks.map((e, n) => {
                          if (e.type === o.O.CATEGORY) {
                              let i = null != e.unpublishedAt ? f.intl.string(f.t['h/uBCQ']) : e.categoryStoreListingId === (null == d ? void 0 : d.storeListingId) ? f.intl.string(f.t['o/oRJC']) : void 0,
                                  s = c && e.categoryStoreListingId === (null == l ? void 0 : l.storeListingId) ? g : i;
                              return (0, r.jsx)(
                                  h.q,
                                  {
                                      subblock: e,
    ...
    b = (e) => {
        let { handleTransition: t, categories: n } = e,
            i = (0, C.c)('CollectiblesFeedShop') && null != u.Z.getCategory(a.T.ROBERT);
...
t.Z = (e) => {
    ...
    return t
        ? (0, r.jsxs)('div', {
              ...
              children: [
                  (0, r.jsx)('div', {
                      className: s()(m.skeleton, m.featuredBlock),
