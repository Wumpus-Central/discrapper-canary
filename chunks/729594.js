...
((i.prototype.parse = function (e, t, n) {
    ...
    if (n || v || y.match(/^\/\/[^@/]+@[^@/]+/)) {
        var T = '//' === y.substr(0, 2);
        T && !(v && h[v]) && ((y = y.substr(2)), (this.slashes = !0));
    }
    if (!h[v] && (T || (v && !m[v]))) {
        for (var S, A, N = -1, C = 0; C < u.length; C++) {
            var w = y.indexOf(u[C]);
            -1 !== w && (-1 === N || w < N) && (N = w);
        }
        (-1 !== (A = -1 === N ? y.lastIndexOf('@') : y.lastIndexOf('@', N)) && ((S = y.slice(0, A)), (y = y.slice(A + 1)), (this.auth = decodeURIComponent(S))), (N = -1));
        ...
        if (!R)
            for (var P = this.hostname.split(/\./), C = 0, D = P.length; C < D; C++) {
                var L = P[C];
                if (L && !L.match(f)) {
                    for (var x = '', k = 0, j = L.length; k < j; k++) L.charCodeAt(k) > 127 ? (x += 'x') : (x += L[k]);
                    if (!x.match(f)) {
                        var M = P.slice(0, C),
                            U = P.slice(C + 1),
                            G = L.match(_);
                        (G && (M.push(G[1]), U.unshift(G[2])), U.length && (y = '/' + U.join('.') + y), (this.hostname = M.join('.')));
                        break;
                    }
                }
            }
        ...
        var B = this.port ? ':' + this.port : '',
            Z = this.hostname || '';
        ((this.host = Z + B), (this.href += this.host), R && ((this.hostname = this.hostname.substr(1, this.hostname.length - 2)), '/' !== y[0] && (y = '/' + y)));
    }
    if (!p[I])
    ...
    (i.prototype.resolveObject = function (e) {
        ...
        if ((I && ((n.hostname = ''), (n.port = null), n.host && ('' === v[0] ? (v[0] = n.host) : v.unshift(n.host)), (n.host = ''), e.protocol && ((e.hostname = null), (e.port = null), e.host && ('' === _[0] ? (_[0] = e.host) : _.unshift(e.host)), (e.host = null)), (y = y && ('' === _[0] || '' === v[0]))), b)) ((n.host = e.host || '' === e.host ? e.host : n.host), (n.hostname = e.hostname || '' === e.hostname ? e.hostname : n.hostname), (n.search = e.search), (n.query = e.query), (v = _));
            ...
            if (I) {
                ...
                T && ((n.auth = T.shift()), (n.hostname = T.shift()), (n.host = n.hostname));
            }
        ...
        for (var S = v.slice(-1)[0], A = ((n.host || e.host || v.length > 1) && ('.' === S || '..' === S)) || '' === S, N = 0, C = v.length; C >= 0; C--) '.' === (S = v[C]) ? v.splice(C, 1) : '..' === S ? (v.splice(C, 1), N++) : N && (v.splice(C, 1), N--);
        if (!y && !O) for (; N--; ) v.unshift('..');
        (y && '' !== v[0] && (!v[0] || '/' !== v[0].charAt(0)) && v.unshift(''), A && '/' !== v.join('/').substr(-1) && v.push(''));
        ...
        return ((y = y || (n.host && v.length)) && !w && v.unshift(''), v.length > 0 ? (n.pathname = v.join('/')) : ((n.pathname = null), (n.path = null)), (null !== n.pathname || null !== n.search) && (n.path = (n.pathname ? n.pathname : '') + (n.search ? n.search : '')), (n.auth = e.auth || n.auth), (n.slashes = n.slashes || e.slashes), (n.href = n.format()), n);
    }),
