...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "607714", versionHash: "ac157ae13113b0b95fb2a41cdf49bdb28afc3b30" }, void 0, 2)}
