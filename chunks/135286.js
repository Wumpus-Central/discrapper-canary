...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "605835", versionHash: "a61035925cecadbe548e5a1e51935ddc91ffb84d" }, void 0, 2)}
