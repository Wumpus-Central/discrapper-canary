...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "606928", versionHash: "7e5a7181b6b37cabe7040fe0496af72c4b957a0f" }, void 0, 2)}
