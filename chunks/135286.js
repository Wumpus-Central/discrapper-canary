...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "607262", versionHash: "29b8daf80f374707ef1ca637a6cbbfe6e011b0ad" }, void 0, 2)}
