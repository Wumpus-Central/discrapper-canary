...
class O extends (n = o.Component) {
    ...
    render() {
        ...
        null != O && (C.autoFocus = O),
            null != E && (C.isDisabled = E),
            null != x && (C.isClearable = x),
            null != _ && (C.isSearchable = _);
        let M = { IndicatorSeparator: () => null };
        if (
            (null != i && (M.Option = (e) => (0, a.jsx)(s.c.Option, m(b({}, e), { children: i(e.data) }))),
            null != o && (M.SingleValue = (e) => (0, a.jsx)(s.c.SingleValue, m(b({}, e), { children: o(e.data) }))),
            null != p && (M.MultiValue = (e) => p(e.data)),
            A && Array.isArray(y))
        ) {
            let t = {};
            v.forEach((e) => {
