...
let y = {
    ...
    input: (e) => b(v({}, e), { color: 'var(--interactive-normal)' }),
    menu: (e) =>
        b(v({}, e), {
    ...
    indicatorsContainer: (e) => b(v({}, e), { alignItems: 'flex-start' }),
    ...
    placeholder: (e) => b(v({}, e), { color: 'var(--text-muted)' })
};
class g extends (n = o.Component) {
    ...
    render() {
        ...
        if ((null != i && (w.Option = (e) => (0, l.jsx)(c.wx.Option, b(v({}, e), { children: i(e.data) }))), null != o && (w.SingleValue = (e) => (0, l.jsx)(c.wx.SingleValue, b(v({}, e), { children: o(e.data) }))), null != d && (w.MultiValue = (e) => d(e.data)), k && Array.isArray(m))) {
            let t = {};
            f.forEach((e) => {
                t[String(e.value)] = e;
            }),
