...
function v(e) {
    var n;
    let { user: t, currentUser: v, guildId: Z, channelId: g, displayProfile: j, initialSection: A, initialSubsection: O, onClose: N } = e,
        ...
        w = t.id === v.id,
        S = (0, d.I5)(v),
        E = r.ZP.useName(null == j ? void 0 : j.guildId, g, t),
        M = (0, h.Z)({
            user: t,
            currentUser: v,
            guildId: Z,
