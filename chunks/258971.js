...
function m() {
    ...
    let f = (0, a.LX)(i, {
        ...
        { applicationId: _, section: m, skuId: I } = null !== (t = null == f ? void 0 : f.params) && void 0 !== t ? t : {};
    if (null != f && null != _) {
        ...
        return {
            ...
            applicationId: _,
            applicationName: e,
            section: null != m ? m : null != I ? u.GlobalDiscoveryAppsSections.STORE : u.GlobalDiscoveryAppsSections.ABOUT
        };
    }
}
