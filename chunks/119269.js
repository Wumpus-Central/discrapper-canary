...
let f = (e) => {
    ...
    _ = (e) => {
        let { showAnimations: t = !0, iconClassName: n, staticPercentage: r, innerCircleClassName: l, progressCircleStrokeSize: i, backgroundCircleSize: c, percentage: u, initialPercentage: b, progressCircleVariation: _ = 0, avatarDecoAssetId: g, avatarDecoAssetDescription: v, ellipseOpacity: j, customAnimationClassName: y, circleColor: C, circleStroke: T } = e,
