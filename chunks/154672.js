        ...
        if (null != e)
            try {
                let t = await l.A.post({
                    ...
                    n = t.body.guild?.id;
                r.h.dispatch({ type: "HUB_VERIFY_EMAIL_SUCCESS", guildId: n });
            } catch (e) {
                r.h.dispatch({ type: "HUB_VERIFY_EMAIL_FAILURE", errors: e.body });
            }
    },
    async verifyCode(e, t, n) {
        if (null != e)
            try {
                let s = await l.A.post({
                    ...
                    o = s.body.guild?.id;
                return r.h.dispatch({ type: "HUB_VERIFY_EMAIL_SUCCESS", guildId: o }), s.body;
            } catch (e) {
                throw (r.h.dispatch({ type: "HUB_VERIFY_EMAIL_FAILURE", errors: e.body }), e);
            }
    },
};
