...
function B(e) {
    ...
    let { quest: a } = e,
        ...
        M = (0, d.Z)(O),
        L = (null === (n = a.userStatus) || void 0 === n ? void 0 : n.completedAt) != null,
        D = (0, d.Z)(L),
        ...
        el = r.useCallback(() => {
            X(!1), z.current || L || er(!1);
        }, [L, er]),
        ec = r.useCallback(() => {
            X(!1), L || er(!1), (z.current = !1);
        }, [L, er]),
        ed = r.useCallback(
            function () {
    ...
    r.useLayoutEffect(() => {
        L && U.shouldExpandOnQuestComplete && eo();
    }, [eo, L, U.shouldExpandOnQuestComplete]),
        r.useLayoutEffect(() => {
            O && !M && z.current && eo();
        }, [eo, O, M]),
        r.useLayoutEffect(() => {
            L || !O || M || z.current || er(!1);
        }, [O, L, M, er]),
        r.useLayoutEffect(() => {
    ...
    r.useLayoutEffect(() => {
        L && !D && U.canCollapseOnBlur && ea();
    }, [L, eo, U.canCollapseOnBlur, ea, D]),
    r.useEffect(() => {
        var e, t;
        Z &&
            (0, m.dA)({
