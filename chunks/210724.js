...
function F(e) {
    ...
    let { quest: i } = e,
        ...
        eg = r.useCallback(() => {
            ed(!1), eo.current || Y || ee(!1);
        }, [Y, ee]),
        ev = r.useCallback(() => {
            ed(!1), Y || ee(!1), (eo.current = !1);
        }, [Y, ee]),
        ej = r.useCallback(() => {
            em(!0);
        }, []),
    ...
    if (
        ...
        return Q ? u.log("Not rendered due to asset error") : g || u.log("Not rendered due to ineligibility"), null;
    let eO = 70 + 78 * !!Y;
    return (0, a.jsx)(S.A, {
        questOrQuests: i,
        questContent: b.jn.QUEST_BAR_V2,
