...
function k(e) {
    ...
    let { quest: o } = e,
        ...
        G = s.useRef(-1),
        J = s.useRef(!1),
        $ = _.H.useConfig({ location: A.dr.QUESTS_BAR }).enabled && U,
        [ee, et] = s.useState(!1),
        [en, er] = s.useState(!1),
        [es, eo] = s.useState(!0),
        [ea, ei] = s.useState(!0),
        ...
        ep = s.useCallback(() => {
            var e, t;
            ec((null != (t = null == (e = eu.current) ? void 0 : e.offsetHeight) ? t : 84) + 2 * Y.paddingVertical);
        }, [Y.paddingVertical]),
        em = s.useCallback(() => {
            ep(), ed(!0);
        }, [ep, ed]),
        ...
        ef = s.useCallback(() => {
            et(!1), J.current || U || ed(!1);
        }, [U, ed]),
        ex = s.useCallback(() => {
            et(!1), U || ed(!1), (J.current = !1);
        }, [U, ed]),
        eh = s.useCallback(
            function () {
        ...
        eb = s.useCallback(() => {
            window.clearTimeout(G.current), Y.canCollapseOnBlur && !ee && (J.current || ed(!1));
        }, [ee, Y, ed]),
        e_ = s.useCallback(() => {
            var e;
            (0, m.dA)({
                        ...
                        (0, r.jsx)(i.animated.div, {
                            ...
                            children: (0, r.jsx)(i.animated.div, {
                                ...
                                style: {
                                    ...
                                    backgroundImage: Z && !eS ? Y.postEnrollmentBackgroundImage : void 0,
                                },
