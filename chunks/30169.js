...
function R(e) {
    ...
    return (
        Object.keys(C).filter(function (e) {
            return C[e].matchesTypes.some(function (e) {
                            ...
                            if (l) {
                                var u,
                                    ...
                                    G =
                                        ...
                                        (O = ((C = f ? l.width : I),
                                        (N = f ? l.height : T),
                                        h() && f && ((N /= window.devicePixelRatio), (C /= window.devicePixelRatio)),
                                        (v = { dragPreviewWidth: C, dragPreviewHeight: N })).dragPreviewWidth),
        ...
        (e = [
            ...
            },
            {
                ...
                value: function (e, t) {
                    var n;
                    this.clearCurrentDragSourceNode(),
                        (this.currentNativeSource = ((n = new v(C[e])).loadDataTransfer(t), n)),
...
let ev = new (class {
        ...
        constructor() {
            (this.queue = []),
                ...
                (this.requestFlush = eC(this.flush)),
    ...
    eR = new (class {
        create(e) {
            let t = this.freeTasks,
                n = t.length ? t.pop() : new eN(this.onError, (e) => (t[t.length] = e));
            return (n.task = e), n;
        }
        constructor(e) {
    ...
    constructor() {
        !(function (e, t, n) {
            (function (e, t) {
                ...
                t.set(e, n);
        })(this, ej, { writable: !0, value: void 0 }),
            eF(this, "register", (e) => {
                eV(this, ej).push(e);
            }),
            eF(this, "unregister", (e) => {
                let t;
                for (; -1 !== (t = eV(this, ej).indexOf(e)); ) eV(this, ej).splice(t, 1);
            }),
            eF(this, "backendChanged", (e) => {
                for (let t of eV(this, ej)) t.backendChanged(e);
            }),
            (function (e, t, n) {
                var i = eB(e, t, "set"),
                    r = e,
