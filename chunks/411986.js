...
function v(e, t) {
    return e?.body?.code === c.t02.RELATIONSHIP_INVALID_NO_CONFIRMATION
        ? (r.h.dispatch({ type: "UPDATE_STRANGER_STATUS", userId: t.userId, isStranger: !0 }),
          C({
              onConfirm: () => {
                  N({ ...t, confirmStrangerRequest: !0 }), t.onConfirm?.();
              },
              onCancel: () => {
                  t.onCancel?.();
              },
    ...
    maybeConfirmFriendRequestAccept: function (e) {
        ...
        return null == n && (l || u) && !1 !== c
            ? c
                ? void C({
                      onConfirm: () => {
                          N({ userId: t, applicationId: n, location: r, confirmStrangerRequest: !0 }), s?.();
                      },
                      onCancel: () => {
                          a?.();
                      },
                ...
                : void N({ userId: t, applicationId: n, location: r })
                      .then((e) => {
            ...
            : N({ userId: t, applicationId: n, location: r, confirmStrangerRequest: !0 }).then(() => {
                  s?.(), o?.();
              });
    },
};
