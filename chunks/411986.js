...
function N(e) {
    ...
    S.default.track(c.HAw.OPEN_MODAL, { type: y.C }),
...
function C(e, t) {
    return e?.body?.code === c.t02.RELATIONSHIP_INVALID_NO_CONFIRMATION
        ? (r.h.dispatch({ type: "UPDATE_STRANGER_STATUS", userId: t.userId, isStranger: !0 }),
          N({
              onConfirm: () => {
                  v({ ...t, confirmStrangerRequest: !0 }), t.onConfirm?.();
              },
              onCancel: () => {
                  t.onCancel?.();
              },
    ...
    maybeConfirmFriendRequestAccept: function (e) {
        ...
        return null == n && (l || u) && !1 !== c
            ? c
                ? void N({
                      onConfirm: () => {
                          v({ userId: t, applicationId: n, location: r, confirmStrangerRequest: !0 }), s?.();
                      },
                      onCancel: () => {
                          a?.();
                      },
                ...
                : void v({ userId: t, applicationId: n, location: r })
                      .then((e) => {
                          C(e, { userId: t, applicationId: n, location: r, onConfirm: s, onCancel: a }) || s?.();
                      })
                      .catch((e) => {
                          C(e, { userId: t, applicationId: n, location: r, onConfirm: s, onCancel: a });
                      })
                      .finally(() => {
                          o?.();
                      })
            : v({ userId: t, applicationId: n, location: r, confirmStrangerRequest: !0 }).then(() => {
                  s?.(), o?.();
              });
    },
};
