...
r(_, a),
    (_.prototype._update = function () {
        ...
        for (var r = 0 | this._a, a = 0 | this._b, _ = 0 | this._c, y = 0 | this._d, I = 0 | this._e, b = 0 | this._a, T = 0 | this._b, S = 0 | this._c, A = 0 | this._d, N = 0 | this._e, C = 0; C < 80; C += 1) C < 16 ? ((e = h(r, a, _, y, I, n[o[C]], d[0], u[C])), (t = v(b, T, S, A, N, n[l[C]], f[0], c[C]))) : C < 32 ? ((e = m(r, a, _, y, I, n[o[C]], d[1], u[C])), (t = E(b, T, S, A, N, n[l[C]], f[1], c[C]))) : C < 48 ? ((e = g(r, a, _, y, I, n[o[C]], d[2], u[C])), (t = g(b, T, S, A, N, n[l[C]], f[2], c[C]))) : C < 64 ? ((e = E(r, a, _, y, I, n[o[C]], d[3], u[C])), (t = m(b, T, S, A, N, n[l[C]], f[3], c[C]))) : ((e = v(r, a, _, y, I, n[o[C]], d[4], u[C])), (t = h(b, T, S, A, N, n[l[C]], f[4], c[C]))), (r = I), (I = y), (y = p(_, 10)), (_ = a), (a = e), (b = N), (N = A), (A = p(S, 10)), (S = T), (T = t);
        var R = (this._b + _ + A) | 0;
        (this._b = (this._c + y + N) | 0), (this._c = (this._d + I + b) | 0), (this._d = (this._e + r + T) | 0), (this._e = (this._a + a + S) | 0), (this._a = R);
    }),
