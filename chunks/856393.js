...
function eu(e) {
    ...
    return (
        ...
        (0, r.jsx)(N.Z, {
                ...
                !k || _ || S
                    ...
                    : (0, r.jsx)(C.ZP, {
                          children: (0, r.jsx)(Z.Z, {
                              className: a()(er.chatToasts, { [er.rtsSidebarOpen]: c }),
                              channelId: n.id
                          })
                      }),
            onActive: () => {},
            ...
            onAllowIdle: () => {},
            onForceIdle: () => {},
            screenMessage: S ? { mainText: en.intl.string(en.t.J5bXZW) } : null,
            idle: !1,
            children: !S && t
        })
    );
...
function ed(e) {
    let { channel: t } = e,
        ...
        S = (0, f.bp)(),
        { chatOpen: P, participantsListOpen: Z } = (0, s.cj)(
            [b.Z],
            () => ({
