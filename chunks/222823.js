...
let el = () => !1;
!__OVERLAY__ && R.O && ({ isOverlayChannelVisible: el } = n(267355));
...
function eL(e, t) {
    ...
    if (!(r && !e._isJoinedThread) && !Y.A.isAtBottom(e.channelId)) return eD(e, "Not at bottom"), !1;
...
class ew {
    ...
    canHaveMentions() {
        return (
            !(
                ...
                (this._isThread && !this._isJoinedThread) ||
                (0, S.k_)(this.channelId, [T.A, y.A]) ||
                ((0, O.WW)(this._guildId) && this._lastMessageTimestamp < eI)
            ) && this.canTrackUnreads()
        );
    }
    ...
    ackPins() {
        ...
        if (null == e) {
            ...
            (this._persisted = !0),
                eR(() => u.Bo.post({ url: et.Rsh.PINS_ACK(this.channelId), oldFormErrors: !0, rejectWithError: !0 }));
        }
        let t = eN(e);
                ...
                (function (e) {
                    ...
                    D.A.hasLoaded(n.guild_id) &&
                        V.default
                            ...
                            .every((e) => e1.hasOpenedThread(e) || 0 > V.default.compare(e, i.ackMessageId)) &&
                        i.ack({
                            trackAnalytics: !0,
                            location: {
    ...
    _nonChannelAck() {
        ...
        if (null != t) {
            ...
            (this._persisted = !0), eR(() => u.Bo.post({ url: e, body: {}, oldFormErrors: !0, rejectWithError: !0 }));
        }
    }
    delete() {
...
let e1 = new e0(_.h, {
        ...
        CONNECTION_OPEN: function (e) {
            ...
            ey(),
                ...
                i.entries.forEach((e) => {
                    ...
                    let i = j.A.getBasicChannel(e.id);
                    null != i && (0, x.fT)(i.type) && (null == e.last_message_id || 0 === e.last_message_id)
                        ? (r.ackMessageId = V.default.fromTimestamp(ek(i.guild_id, i.id)))
                        : r.ackedWhileCached
                          ? -1 === V.default.compare(r.ackMessageId, e.last_message_id) &&
        ...
        MESSAGE_CREATE: function (e) {
            ...
            if (
                ...
                let { shouldMention: e, isMentionLowImportance: t } = (function (e, t, n) {
                    ...
                    if (eC(r)) return { shouldMention: !0, isMentionLowImportance: !1 };
                    if (Z.Ay.mentionOnAllMessages && null != r) {
                        if (r.isThread()) {
                            ...
                            Z.Ay.resolvedMessageNotifications(r) === et.orn.ALL_MESSAGES
                        )
                            return { shouldMention: !0, isMentionLowImportance: !0 };
                    }
        ...
        CHANNEL_SELECT: function (e) {
            ...
            let i = !1;
            return (
                ec !== t && ((i = eX(ec) || i), (i = eX(ed) || i)),
                (ec === t || (r?.type != null && et.kvI.GUILD_THREADS_ONLY.has(r.type))) &&
                    (i =
                        eF(
                            {
                                section: et.JJy.CHANNEL,
        ...
        OVERLAY_TEXT_CHAT_ACK_CHANNEL: function (e) {
            ...
            return (
                ...
                ((r = ew.get(t)).ackMessageIdAtChannelSelect =
                    r.ackMessageId ?? V.default.fromTimestamp(r.getAckTimestamp())),
        ...
        GUILD_SCHEDULED_EVENT_CREATE: function (e) {
            ...
            ((r.lastMessageId = t.id), eK(t))
                ? eZ({ type: "GUILD_FEATURE_ACK", id: n, ackType: es.P.GUILD_EVENT, ackedId: t.id, local: !1 })
        ...
        NOTIFICATION_CENTER_ITEM_CREATE: function (e) {
            ...
            ((r.lastMessageId = t.id), v.A.active || 0) ? eJ(n, es.P.NOTIFICATION_CENTER, t.id, !1) : r.mentionCount++;
        },
        RELATIONSHIP_ADD: function (e) {
            ...
            (null != n.ackMessageId ? V.default.extractTimestamp(n.ackMessageId) : 0) < i &&
                ...
                v.A.active ? eJ(t.id, es.P.NOTIFICATION_CENTER, void 0, !1) : r ? n.mentionCount-- : n.mentionCount++);
        },
