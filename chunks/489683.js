...
function eX() {
    ...
    return (
        n
            ? ((s = eK.intl.string(eK.t.mXZgC9)),
              (o = eK.intl.format(eK.t.F6lrb4, {
                  onSettingsClick: () => {
                      eb.Ay.getMediaEngine().showSystemCaptureConfigurationUI("microphone_modes");
                  },
              })))
            : a &&
              (s = eK.intl.formatToPlainString(eK.t["/tqmfM"], { enabled: t ? "true" : "false", inputProfile: l })),
        (0, i.jsxs)("div", {
            ref: e,
            className: ez.dD,
            children: [
...
function eJ(e) {
    let { channel: t, enableActivities: n, disabled: l } = e,
        ...
        h = (0, er.Ay)(t),
        { reachedLimit: _, limit: p } = (0, em.A)(t),
        C = r.useCallback(() => {
            (0, eE.A)();
        }, []),
        T = (0, Q.Us)(),
        ...
        (0, i.jsx)(eT.r, {
            ...
            children: (e) => {
                let { unavailable: t, isActive: n, label: r, iconComponent: l, iconColor: d, ...c } = e,
                    u = (0, i.jsx)(v, { size: "md", className: a()(ez.iA, { [ez.ij]: !S }), color: "currentColor" });
                    ...
                    children: (e, l) => {
                        ...
                        return (0, i.jsx)(g.m_, {
                            ...
                            children: (0, i.jsx)(E.$n, {
                                ...
                                className: a()(ez.x6, ez.Sq, { [ez.rK]: n, [ez.tU]: t, [ez.r9]: c.disabled }),
              ...
              children: (e) => {
                  ...
                  return (0, i.jsx)(g.m_, {
                      ...
                      children: (0, i.jsxs)(E.$n, {
                          ...
                          disabled: p,
                          className: a()(ez.x6, ez.Sq, { [ez.rK]: _, [ez.r9]: p }),
                          innerClassName: ez.bk,
                          wrapperClassName: ez.x6,
                          focusProps: e$,
                          children: [
    ...
    let { channel: t } = e,
        ...
        N = r.useCallback(() => {
            o(),
                _ ? m(!1) : m(!0),
                (0, w.X)(l, w.O.GIFTING),
                p === u.M.GAME_SHOP_RTC_GIFTING_NEW_BADGE && f(eY.i.TAKE_ACTION);
        }, [l, o, _, p, f]);
    return (0, i.jsx)(I.YNO, {
        targetElementRef: n,
        shouldShow: _,
...
function e7(e) {
    ...
    r.useEffect(() => () => D(), [D, L]);
    let M = (0, i.jsx)(R, { size: "md", color: "currentColor", className: a()(ez.iA, { [ez.ij]: !O }) });
    return (0, i.jsx)(I.YNO, {
        targetElementRef: d,
        renderPopout: (e) => {
            let { closePopout: t } = e;
        ...
        children: (e) => {
            ...
            return (0, i.jsx)(g.m_, {
                ...
                children: (0, i.jsx)(E.$n, {
                    ...
                    disabled: !p || o,
                    className: a()(ez.x6, ez.Sq, { [ez.rK]: null != S, [ez.r9]: !p || o }),
                    ...(y ? l : null),
                    onMouseEnter: () => {
                        r?.(), j.onMouseEnter();
                    },
                    ...
                    children: O
                        ? M
                        : (0, i.jsxs)(k.A, { align: k.A.Align.CENTER, children: [M, eK.intl.string(eK.t["r0/+v7"])] }),
                }),
            });
        },
    });
        ...
        [C, T, N] = (0, c.yK)(
            ...
            () =>
                o?.isGuildStageVoice()
                    ...
                    : [null, null, null != o ? eD.Ay.getVoiceStatesForChannel(o) : null],
            [o],
        ),
        S = r.useMemo(
            () =>
