...
let S = {
    ...
    I = function (e) {
        var t,
            { backSrc: n, frontSrc: l, size: u, isTyping: E, status: _, style: I, className: b } = e,
            T = (function (e, t) {
                if (null == e) return {};
                var n,
                    r,
        ...
        let { size: h } = s.ny6[u],
            ...
            P = ((t = null != _), E ? S[u].typing : t ? S[u].status : S[u].default);
        return (0, r.jsxs)('div', {
            style: (function (e) {
