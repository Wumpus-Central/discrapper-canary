"use strict";
n.d(t, { $p: () => p, D$: () => f, Ml: () => c, S$: () => g, bB: () => d, lu: () => h });
var r = n(73153),
    i = n(308528),
    a = n(961350),
    s = n(734057),
...
async function f(e) {
    let { target: t, source: n, widgetType: i } = e,
        a = "CHANNEL" === t.kind ? t.channelId : await _(t);
    if (null == a) return null;
    let s = "CHANNEL" === t.kind ? t.guildId : null,
        c = t.messageId ?? null,
        d = u.A.getSelectedChannelId();
    return (
        null != i &&
            n !== l.B9.AUTOMATIC_CHANNEL_SELECT &&
            (null == d
                ? (0, o.YX)(i, { type: o.Z5.TEXT_CHAT, value: o.IP.OPENED_TEXT_CHAT, secondaryValue: n })
                : d !== a && (0, o.YX)(i, { type: o.Z5.TEXT_CHAT, value: o.IP.CHANNEL_SELECTED, secondaryValue: n })),
        await r.h.dispatch({
