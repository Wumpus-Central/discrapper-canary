...
var r = (function (e) {
    return (
        ...
        (e.GUILD_BOOSTING_ANNOUNCEMENT_MESSAGE = "guild boosting announcement message"),
        (e.GUILD_BOOSTING_ANNOUNCEMENT_MESSAGE_FIRST_TIME_BOOSTER =
        ...
        (e.COLLECTIBLES_SHOP_HERO = "collectibles shop hero"),
        (e.COLLECTIBLES_SHOP_FEATURED_BLOCK = "collectibles shop featured block"),
        (e.COLLECTIBLES_SHOP_POPULAR_PICKS = "collectibles shop popular picks"),
        (e.COLLECTIBLES_SHOP_SHELF = "collectibles shop shelf"),
        ...
        (e.THIRD_PARTY_PROMOTIONS_MODAL = "third party promotions modal"),
        (e.RECURRING_3PP_MODAL = "recurring 3pp modal"),
        ...
        (e.USER_SETTINGS_CONNECTIONS = "user settings connections"),
        ...
        (e.PREMIUM_WISHLIST_MARKETING_PAGE = "premium wishlist marketing page"),
        (e.PREMIUM_WISHLIST_SETTINGS_HERO = "premium wishlist settings hero"),
        (e.PREMIUM_WISHLIST_STREAM_UPSELL = "premium wishlist stream upsell"),
        (e.PREMIUM_WISHLIST_SOUNDBOARD_UPSELL = "premium wishlist soundboard upsell"),
        (e.PREMIUM_WISHLIST_EMOJI_UPSELL = "premium wishlist emoji upsell"),
        (e.PREMIUM_WISHLIST_CLIENT_THEMES_EDITOR = "premium wishlist client themes editor"),
        (e.PREMIUM_WISHLIST_CUSTOM_THEMES_EDITOR = "premium wishlist custom themes editor"),
        (e.PREMIUM_WISHLIST_NITRO_MEMBER_HUB = "premium wishlist nitro member hub"),
        (e.PREMIUM_WISHLIST_EDIT_PROFILE_UPSELL = "premium wishlist edit profile upsell"),
        (e.PREMIUM_WISHLIST_CHURN_MODAL = "premium wishlist churn modal"),
