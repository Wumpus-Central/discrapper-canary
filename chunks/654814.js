...
let M = l.memo(function (e) {
    ...
    let { row: n, guildId: l, className: i } = e,
        { id: o, name: s } = n.record,
        u = (0, f.p9)({
            guildId: l,
            roleId: o,
            size: 16,
        }),
        C = (0, c.e7)([x.Z], () => x.Z.getRole(l, o)),
        m = s.includes(g.CR) ? "" : "@",
        b = (0, d.dQu)(d.TVs.unsafe_rawColors.PRIMARY_300).hsl(),
    ...
    return (0, r.jsxs)("div", {
        ...
        children: [
            ...
            null != u ? (0, r.jsx)(h.Z, S(w({ className: H.roleTagIcon }, u), { enableTooltip: !1 })) : m,
            (0, r.jsx)(d.Text, {
                variant: R,
...
function E(e) {
    let { channel: t, row: n, className: l } = e,
        ...
        o = (0, m.KS)(t);
    return (0, r.jsxs)("div", {
        className: a()(H.rowLabel, H.channelLabel, { [H.hasParent]: i }, l),
        children: [
            null != o &&
                (0, r.jsx)(o, {
                    size: "xs",
    ...
    let Y = (e, t, n) => {
        ...
        K = l.useMemo(
            () =>
                v.map((e) => {
                    var n;
                    return (n = g[e]), S(w({}, n.tag), { label: T(n.row, t, H.noIndent) });
                }),
            [g, v, t],
        );
    return (0, r.jsxs)("div", {
