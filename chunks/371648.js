    ...
    $ = l.memo(
        function (e) {
            ...
            let n,
                ...
                [G, B] = l.useState(j.A.isAtBottom(p.id) ?? !1),
                $ = (0, f.Ay)(p),
                Z = (0, F.I)(S, R),
                ...
                ei = (0, c.bG)([I.A], () =>
                    D.A.can(K.xBc.READ_MESSAGE_HISTORY, p) ? null : I.A.getViewingRolesTimestamp(p.getGuildId()),
                ),
                {
            ...
            (t = et.ref),
                ...
                (0, U.Vo)({ event: K.jej.SCROLLTO_PRESENT, handler: n }),
                (0, U.Vo)({ event: K.jej.SCROLL_PAGE_UP, handler: a }),
                (0, U.Vo)({ event: K.jej.SCROLL_PAGE_DOWN, handler: r });
            let ec = (0, u.R7)(),
                { ref: ed, ...eu } = (0, o.LT)(en),
                eh = (0, A.A)((e) => {
                ...
                eA = l.useMemo(() => (k ? (G ? q.gA : q.ru) : q.Zd), [k, G]),
                eg = l.useMemo(() => (k ? (G ? q.cz : q.XF) : q.U6), [k, G]);
            return (0, i.jsxs)(o.hD, {
                navigator: en,
                children: [
                    null != eo && eo,
                    (0, i.jsxs)("div", {
                        className: s()(q.Og, d, `group-spacing-${m}`),
                        children: [
                            null == eo && ea,
                            (0, i.jsxs)(J, {
                                ref: eh,
                                customTheme: !0,
                                className: s()(_, q.XG, em ? eg : void 0),
                                ...
                                children: [
                                    er,
                                    (0, i.jsxs)("ol", {
                                        className: s()(q.bv, { [q.FD]: p.isModeratorReportChannel() }),
                                            ...
                                            (0, i.jsx)("div", {
                                                className: s()({
                                                    ...
                                                    [q.Fb]:
                                                        ...
                                                        !E.loadingMore &&
                                                        p.isForumPost() &&
                                                        E.first()?.isFirstMessageInForumPost(p),
                                                }),
                                            }),
                                        ],
                                    }),
        ...
        let {
            ...
            } = e,
            {
                ...
                let t = e.getGuildId(),
                    ...
                    { canManageMessages: i, permissionVersion: l } = (0, c.cf)(
                        [D.A],
                        () => ({
                            canManageMessages: D.A.can(K.xBc.MANAGE_MESSAGES, e),
            ...
            })(),
            {
                ...
                let n,
                    ...
                    r = w.default.getUser(b.default.getId())?.hasFlag(K.nhx.SPAMMER) ?? !1,
                    o = (0, m.cI)(e),
                    d = (0, x.A)("use_topic_dividers_in_chat"),
                    u = (0, c.yK)([N.A], () => (o && d ? (N.A.summaries(e.id) ?? []) : []), [o, e.id, d]),
                    h = (0, c.bG)([N.A], () => (o ? N.A.selectedSummary(e.id) : null), [o, e.id]),
