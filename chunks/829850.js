...
function Z(e) {
    let { headerBadgeConfig: t } = e,
        ...
        s = (0, T.S3)(),
        r = (0, j.bB)(),
        { checkoutPaymentSources: o, storeCountry: a } = (0, B.t)(),
        d = l.useMemo(() => {
            if (null == u) return null;
            let e = o.find((e) => e.id === u);
...
function q() {
    let {
        ...
        { isPremiumGroupPurchase: u, isEligibleForTrial: s, isEligibleForDiscount: r } = (0, z.i)(),
        o = (0, V.G)(t ?? "") && !s,
        a = l.useMemo(() => {
            let t, i;
            return (
...
function $(e) {
    let { renderHeader: t, handleClose: n, skipUnifiedHeaderForSteps: u } = e,
        s = (0, j.bB)(),
        r = (0, P.t4)((e) => e.unifiedCheckoutFlow),
        { shouldRenderCoreUnifiedHeader: o, renderCoreUnifiedHeader: a } = l.useMemo(
            () => ({
                ...
                renderCoreUnifiedHeader: null != r && r in Q ? Q[r] : null,
            }),
            [s, u, r],
        );
    return l.useMemo(
        () => (o ? (null != a ? a() : (0, i.jsx)(Z, {})) : (0, i.jsx)(X, { renderHeader: t, handleClose: n })),
        [o, a, t, n],
    );
}
var ee = n(482132);
...
function eu(e) {
    let {
        ...
        _ =
            null != o
                ? o({ canCurrentlyPurchasePremiumGroup: c, isGift: u, giftRecipient: s })
                : (function (e, t) {
...
function es(e) {
    let {
        ...
        { displayCurrency: ej } = (0, E.Jn)(),
        { activitySessionId: eL } = (0, m.V)(),
        { paymentAuthenticationState: eW } = (0, f.o)(),
        eB = (0, s.bG)([w.A], () => w.A.purchaseTokenAuthState),
        ez = (0, A.sw)(),
        eK = (0, I.A)(),
        eV = (0, T.S3)(),
    ...
    l.useEffect(() => {
        e9((e) => {
            let n = null != eK ? (0, F.y8)(eK.id, !1, eJ, { paymentSourceId: eR.paymentSourceId }) : void 0;
            return {
                ...e,
    ...
    }, [eK, eD, eJ, eR, ej, t, eV?.productLine]),
        (0, c.Ay)(() => {
            (0, C.b)({
                ...e8,
        ...
        l.useEffect(() => {
            null == eK && (null != eF && null != eC ? eb(eF) : eb(V)),
                null != ef ? eg(ef) : null != V && eg(R.A.get(V)?.skuId);
        }, [eb, eK, eg, V, ef, eF, eC]);
    let ti = l.useCallback(() => {
        ...
        }, [e8, eQ, eq, eZ, eJ, eX, eO.startTime, e7, te, tt]),
        tl = l.useCallback(() => {
            let { enabled: e } = M.u.getConfig({ location: "maybeSoftDismissGiftIntentOnPurchase" }),
                t = null != h ? (0, D.NE)(h) : null;
            eJ && null != eZ && e && null != t && (0, y.Yd)(eZ.id, t);
        }, [h, eJ, eZ]),
        tu = l.useMemo(() => () => q?.(ev === Y.h.COMPLETED, eD), [q, ev, eD]),
        ts = (0, u.A)(() => Date.now(), [e0]),
        tr = l.useCallback(
            function (e) {
                let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                    { trackedFromStep: n, analyticsDataOverride: i, fulfillment: l, emitPaymentFlowLoadedEvent: u } = t,
                    s = Date.now();
                if (e === O.pn.CONFIRM && (ti(), z?.(l), tl(), eP)) return void tu();
                e6(e), eE?.(e), eU(null), e === O.pn.ADD_PAYMENT_STEPS && (o.h.wait(a.ET), o.h.wait(d.T3));
                let r = null != n ? n : e0;
                null === r || u
                    ...
                    : x.default.track(et.HAw.PAYMENT_FLOW_STEP, {
                          ...
                          step_duration_ms: s - ts,
                          flow_duration_ms: s - eO.startTime,
                          gift_card_balance: te,
                          gift_card_currency: tt,
                      });
            },
            [e6, eE, eU, e0, eC, e8, ts, eO.startTime, ti, z, tl, eP, tu, ey, te, tt],
        );
    return (
        (0, N.b)(e0, eW, tr, eN),
        l.useEffect(() => {
            null != e0 && e0 !== O.pn.AWAITING_PURCHASE_TOKEN_AUTH && eB === w.C.PENDING
                ? tr(O.pn.AWAITING_PURCHASE_TOKEN_AUTH)
                : e0 === O.pn.AWAITING_PURCHASE_TOKEN_AUTH && eB === w.C.SUCCESS && tr(O.pn.REVIEW);
        }, [e0, eB, tr]),
        (0, k.A)(tu),
        (0, U.s)(ex, () => q(!1), eJ, !ep),
        (0, N.QR)(eW),
        (0, i.jsx)(r.b, {
            className: ei.Xn,
            isShaking: eA && ev === Y.h.PURCHASING,
            intensity: 2,
            children: (0, i.jsx)(eu, {
                step: e0,
                transitionState: K,
