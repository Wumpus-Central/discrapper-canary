...
function J(e) {
    let {
        ...
        I = r.useCallback(() => C(!1), []),
        S = (0, s.e7)([h.Z, _.Z], () => h.Z.inDevModeForApplication(t.id) || _.Z.inTestModeForApplication(t.id), [
            t.id,
        ]),
        T = (0, L.WA)(t);
...
function K() {
    return (0, i.jsx)(u.ua7, {
        ...
        children: (e) =>
            (0, i.jsx)(
                "div",
                z(G({ className: V.devShelfBadge }, e), { children: (0, i.jsx)(I.Z, { className: V.devShelfIcon }) }),
            ),
    });
}
function $(e) {
