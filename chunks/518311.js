...
function eS(e) {
    var t, n;
    let { channel: r, iconClassName: a, className: s, icon: l, tooltip: c, tooltipPosition: u = 'bottom', popoutPosition: d = 'bottom', popoutAlign: _ = 'right', subscribeToGlobalHotkey: h = !1, location: m } = e,
