        ...
        : (0, t.jsx)(u.A, {
              ...
              infoRows: (function (i) {
                  let { channelId: e, blockedUsers: n, ignoredUsers: s } = i,
                      ...
                      u = [
                          {
                              icon: (0, t.jsx)("div", { className: A.Kk, children: (0, t.jsx)(r.WarningIcon, {}) }),
                  ...
                  if (d && c) {
                      ...
                      u.unshift({
                          ...
                          text: (0, g.T)(r, i.length, o?.guild_id, e),
                          className: A.nM,
                      });
                  } else {
                      let i = d ? n.slice(0, 2).map((i) => i.id) : s.slice(0, 2).map((i) => i.id),
                          r = d ? n.length : s.length;
                      u.unshift({
                          icon: (0, t.jsx)("div", { className: A.Kk, children: (0, g.I)(i, o?.guild_id) }),
                          text: (0, g.T)(i, r, o?.guild_id, e),
                          className: A.nM,
                      });
                  }
                  return u;
