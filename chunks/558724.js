...
function N() {
    !j && (P() || null != O.surveyOverride) && ((j = !0), (0, d.wk)(O.surveyOverride, !0));
}
function A(e) {
    return (function (e) {
...
function w(e) {
    let { survey: t } = e;
    (j = !1), (O.lastFetched = Date.now()), null == O.hiddenSurveys && (O.hiddenSurveys = {});
    let n = null != t,
...
let D = new R(u.Z, {
    ...
    SURVEY_HIDE: function (e) {
        let { key: t } = e;
        (O.hiddenSurveys[t] = !0), (x = null), (y = null != y ? y : {}), delete y[t];
    },
