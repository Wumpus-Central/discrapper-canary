...
function t_(e) {
    ...
    let I = (0, e_.A)(
        ...
        v = (0, eL.w)({ location: "content_inventory" }),
        N = (0, u.bG)([eM.A], () => eM.A.getDetectableIdsToApplicationIds()),
        _ = A ? I : void 0,
        j = i.useContext(tA);
    return (0, l.jsxs)("div", {
        className: tg.au,
...
function tj(e) {
    ...
    let I = (0, e_.A)(
        ...
        y = A ? I : void 0,
        { activity: S, activityApplication: v, fallbackApplication: N } = (0, e7.A)(x),
    ...
    h.media.provider === t2.X.SPOTIFY &&
        ...
        (A = (0, l.jsx)(t6.A, {
            ...
            onOpenSpotifyArtist: function (e) {
                null != d && null != p && (0, t7.mN)(d, p.id, e);
            },
        })),
        x?.syncDisabled === !1 &&
            C.push(
