...
function tI(e) {
    ...
    let n,
        ...
        k = L.length >= 2,
        [w, G] = i.useState(!M),
        V = eX.Ay.getName(o?.guild_id, o?.id, c),
        F = (0, eC.Ay)(o, !0),
        Y =
            null != o && A
...
function tS(e) {
    let { channel: t, userDescription: n, entry: i, disableGameProfileLinks: s, onUserPopoutClosed: r } = e,
        a = t?.guild_id,
        { displayParticipants: o, participant1: c, participant2: d, numOtherParticipants: h } = (0, e8.A)(i, 3),
...
let tY = [...tT.n, L.Yq],
    ...
    tJ = function (e) {
        let {
            ...
            b = (0, N.JC)(E),
            M = (0, tF.o)(h?.application_id ?? m?.applicationId ?? E?.id);
        ...
        let k = (0, l.jsx)(L.mG, {
            ...
            D = [
                null == P && ((0, S.A)(h, em.jUm.JOIN) || (0, v.A)(h))
                    ...
                    : null,
                (0, tM.A)(h)
                    ? (0, l.jsx)(tV.A, { activity: h, size: "md", variant: "primary", icon: tL.EyeIcon }, "watch")
                    : null,
                P,
            ].filter(R.Vq);
        return (0, l.jsxs)(tA, {
...
function nr(e) {
    let t,
        ...
        x = (0, u.bG)(
            [t8.A, t9.default],
            () => (d?.type === em.$pd.LISTENING && null != p ? (0, t5.A)(t8.A, t9.default, p, d) : void 0),
            [d, p],
            t2.A,
        );
