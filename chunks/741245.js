...
var H = (((t = H || {}).PREMIUM_ACTIVATED = 'PREMIUM_ACTIVATED'), (t.PREMIUM_UPDATED = 'PREMIUM_UPDATED'), (t.PREMIUM_UPGRADED = 'PREMIUM_UPGRADED'), (t.GUILD_BOOST_APPLIED = 'GUILD_BOOST_APPLIED'), (t.PREMIUM_PAYMENT_STARTED = 'PREMIUM_PAYMENT_STARTED'), t);
class Z extends (e = r.PureComponent) {
    componentDidMount() {
        this.animate();
    }
    animate() {
        let { premiumType: a } = this.props;
        n.Z.timing(this.animation, {
            toValue: 1,
            delay: L.DELAY[a],
    ...
    getSvgBorderGradientId() {
        ...
        switch (l) {
            case 'GUILD_BOOST_APPLIED':
                return A.Rj.PREMIUM_GUILD;
            case 'PREMIUM_ACTIVATED':
            case 'PREMIUM_PAYMENT_STARTED':
            case 'PREMIUM_UPGRADED':
            case 'PREMIUM_UPDATED':
                if (a === E.p9.TIER_0) return A.Rj.PREMIUM_TIER_0;
                if (a === E.p9.TIER_1) return A.Rj.PREMIUM_TIER_1;
                ...
                return (0, s.jsx)('svg', {
                    ...
                    children: (0, s.jsxs)('g', {
                        ...
                        children: [
                            ...
                            (0, s.jsx)('path', { d: 'M161.19,29.35a.52.52,0,0,1,.19.8A9,9,0,0,1,154,34c-3.86,0-7.43-2.23-6.81-6.65l.94-6.7C148.77,16.25,153,14,157,14a6.16,6.16,0,0,1,6.12,4,.53.53,0,0,1-.31.68l-3.36,1.27a.54.54,0,0,1-.64-.21,3,3,0,0,0-2.58-1.19c-1.42,0-2.84.8-3,2.12l-.94,6.7c-.2,1.27,1,2.06,2.42,2.06A3.51,3.51,0,0,0,157.47,28a.53.53,0,0,1,.67-.16Z' }),
                            (0, s.jsx)('path', { d: 'M174.59,19.21l-2,14.06a.54.54,0,0,1-.53.46h-3.95a.54.54,0,0,1-.54-.61l1.92-13.76a.53.53,0,0,0-.53-.61h-4.08a.53.53,0,0,1-.53-.6l.51-3.45a.54.54,0,0,1,.53-.45H180a.54.54,0,0,1,.54.6L180,18.3a.54.54,0,0,1-.54.45h-4.38A.54.54,0,0,0,174.59,19.21Z' }),
                            (0, s.jsx)('path', { d: 'M184.73,33.73h-3.89a.53.53,0,0,1-.53-.61l2.6-18.39a.54.54,0,0,1,.53-.46h3.9a.54.54,0,0,1,.53.61l-2.6,18.39A.55.55,0,0,1,184.73,33.73Z' }),
                            (0, s.jsx)('path', { d: 'M203.71,14.25h4.13a.52.52,0,0,1,.48.76L199,33.43a.53.53,0,0,1-.48.3h-3.8a.54.54,0,0,1-.52-.42l-4.11-18.42a.54.54,0,0,1,.53-.64h4.23a.53.53,0,0,1,.52.43l1.67,9s0,0,0,.06l.27,4.62h.06l1.49-4.59,0-.06,4.32-9.2A.55.55,0,0,1,203.71,14.25Z' }),
                            (0, s.jsx)('path', { d: 'M214,24.87l-.52-5a.12.12,0,0,0-.12-.11h0a.11.11,0,0,0-.11.08l-1.87,4.89a.53.53,0,0,0,.5.72h1.58A.54.54,0,0,0,214,24.87Zm6,8.86h-4.23a.55.55,0,0,1-.53-.44l-.58-3a.55.55,0,0,0-.53-.44h-4.47a.55.55,0,0,0-.49.32l-1.47,3.27a.54.54,0,0,1-.49.32h-4.13a.53.53,0,0,1-.48-.77l9.1-18.39a.55.55,0,0,1,.48-.3H216a.54.54,0,0,1,.52.42l4.05,18.39A.53.53,0,0,1,220,33.73Z' }),
                            (0, s.jsx)('path', { d: 'M230.49,19.21l-2,14.06a.55.55,0,0,1-.53.46h-4a.54.54,0,0,1-.53-.61l1.92-13.76a.54.54,0,0,0-.53-.61h-4.08a.52.52,0,0,1-.53-.6l.51-3.45a.54.54,0,0,1,.53-.45h14.58a.52.52,0,0,1,.53.6l-.51,3.45a.53.53,0,0,1-.53.45H231A.53.53,0,0,0,230.49,19.21Z' }),
                            (0, s.jsx)('path', { d: 'M243.26,21.8H250a.54.54,0,0,1,.53.61l-.47,3.3a.52.52,0,0,1-.53.46H242.5a.53.53,0,0,0-.53.46l-.27,1.85a.53.53,0,0,0,.53.6h7.45a.53.53,0,0,1,.53.6l-.49,3.59a.54.54,0,0,1-.53.46H236.56a.53.53,0,0,1-.53-.61l2.6-18.39a.54.54,0,0,1,.53-.46h12.63a.54.54,0,0,1,.54.61l-.52,3.58a.54.54,0,0,1-.53.46h-7.75a.53.53,0,0,0-.53.45l-.27,1.83A.53.53,0,0,0,243.26,21.8Z' }),
                            (0, s.jsx)('path', { d: 'M260.57,29.11c1.36,0,2.59-.74,2.73-1.79l.94-6.53c.14-1.08-.83-1.93-2.19-1.93H260a.54.54,0,0,0-.53.46l-1.32,9.19a.53.53,0,0,0,.53.6Zm1.95-14.84c4,0,7.37,2,6.73,6.52l-.94,6.53c-.64,4.48-4.59,6.41-8.55,6.41H253a.53.53,0,0,1-.53-.61l2.6-18.39a.54.54,0,0,1,.53-.46Z' })
                        ]
                    })
                });
            case 'PREMIUM_PAYMENT_STARTED':
    ...
    constructor(...a) {
        super(...a), p(this, 'animation', new n.Z.Value(0));
    }
}
function v(a) {
    let { theme: l, ...h } = a,
        e = (0, M.dQu)(o.Z.unsafe_rawColors.WHITE_500).hex(),
        t = (0, M.dQu)(o.Z.unsafe_rawColors.BRAND_500).hex(),
        r = (0, d.wj)(l) ? e : t;
    return (0, s.jsx)(Z, {
        ...h,
        theme: l,
