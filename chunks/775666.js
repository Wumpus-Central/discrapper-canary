                  ...
                  (0, i.jsxs)(_.kSQ, {
                      children: [
                          (0, i.jsx)(_.k5B, {
                              ...
                              action: () => ((0, r.JK)(e.guild_id, e.id), p(!1)),
                          }),
                          (0, i.jsx)(_.k5B, {
                              id: "cns_everything",
                              group: "channel_notification_settings",
                              ...
                              action: () => ((0, r._m)(e.guild_id, e.id, d.s8.ALL_MESSAGES), p(!1)),
                          }),
                          (0, i.jsx)(_.k5B, {
                              id: "cns_essentials",
                              group: "channel_notification_settings",
                              ...
                              action: () => ((0, r._m)(e.guild_id, e.id, d.s8.MENTIONS), p(!1)),
                          }),
                          (0, i.jsx)(_.k5B, {
                              id: "cns_nothing",
                              group: "channel_notification_settings",
                              ...
                              action: () => ((0, r._m)(e.guild_id, e.id, d.s8.NOTHING), p(!1)),
                          }),
                          (0, i.jsx)(_.k5B, {
                              id: "cns_custom",
                              group: "channel_notification_settings",
...
function L(e, n) {
    let { notification: t, unread: a } = (0, r.ZA)(e),
        ...
        d = (n) => {
            ...
            n === h.bL.ALL_MESSAGES &&
                a !== u.i.ALL_MESSAGES &&
                (t.flags = (0, c.pq)(l.ZP.getChannelIdFlags(e.guild_id, e.id), S.ic.UNREADS_ALL_MESSAGES)),
                s.Z.updateChannelOverrideSettings(e.guild_id, e.id, t, g.UE.notifications(n));
        };
                ...
                _.sNh,
                {
                    ...
                    children: [
                        ...
                        (0, i.jsx)(_.k5B, {
                            ...
                            subtext:
                                a !== u.i.ONLY_MENTIONS && t === h.bL.ALL_MESSAGES ? b.intl.string(b.t.eP8yWV) : void 0,
                ...
                _.sNh,
                {
                    ...
                    children: [
                        (0, i.jsx)(_.k5B, {
                            ...
                            subtext:
                                a !== u.i.ALL_MESSAGES && t !== h.bL.ALL_MESSAGES ? b.intl.string(b.t.idXSbG) : void 0,
