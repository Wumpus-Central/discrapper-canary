...
function Y() {
    let { notifyingChannelIds: e, staleChannelIds: t } = (function () {
        let e = A.Ay.getFlattenedGuildIds().flatMap((e) => E.Ay.getSelectableChannelIds(e)),
            ...
            n = (e) =>
                !(!O.kvI.GUILD_TEXTUAL.has(e.type) || (0, o.UK)(e.id)) &&
                ((0, f.fT)(e.type)
                    ? (0, _.l)(e) === R.CP.ALL_MESSAGES && !d.A.isMuted(e.id)
    ...
    for (let e of n)
        if (((b[e] = { loadState: C.Ve.UNLOADED, mostRecentMessageId: g.Ay.lastMessageId(e) }), m.A.isReady(e))) {
            let t = H(e);
            null != t &&
                ((b[e].loadState = C.Ve.LOADED), (b[e].mostRecentMessageId = t.last()?.id ?? b[e].mostRecentMessageId));
        }
    w.updateChannelIds(D), j();
}
function W() {
    (b = {}),
        (D = null),
...
function K() {
    for (let e of (W(), Y(), D ?? [])) {
        let t = H(e);
        null != t && ((b[e].loadState = C.Ve.LOADED), (b[e].mostRecentMessageId = t.last()?.id ?? null), j());
    }
...
class q extends s.Ay.Store {
    ...
    initialize() {
        this.waitFor(c.A, h.A, E.Ay, d.A, m.A, g.Ay, u.Ay, A.Ay, I.Ay, T.default);
    }
    canLoadMore(e) {
        let { preload: t } = e;
        return (function (e) {
...
let X = new q(a.h, {
    ...
    LOAD_MESSAGES_SUCCESS: function (e) {
        ...
        b[t].loadState !== C.Ve.LOADED && (b[t].loadState = r ? C.Ve.LOADED : C.Ve.LOADED_UNREAD), j();
    },
    ...
    THREAD_MEMBERS_UPDATE: function (e) {
        ...
        if (n?.some((e) => e.userId === i)) {
            let e = h.A.getBasicChannel(t);
            return !(null == e || d.A.isMuted(t)) && (0, _.l)(e) !== R.CP.NO_MESSAGES && void K();
        }
    ...
    NOTIFICATIONS_INBOX_LOAD_MORE_INBOX_SUCCESS: function (e) {
        ...
        (M = !1), t ? (k = !0) : (null != n && (G = n), (x = !0)), (V = r ?? null);
    },
    ...
    NOTIFICATIONS_INBOX_ITEM_ACK: function (e) {
        ...
        (0, N.zo)({ channelId: t, id: n }, F) && (F = null);
    },
