...
(t.isArgumentsObject = i),
    ...
    (t.isArrayBufferView = function (e) {
        return "u" > typeof ArrayBuffer && ArrayBuffer.isView ? ArrayBuffer.isView(e) : a(e) || N(e);
    }),
    ...
    (t.isDataView = N);
var v = "u" > typeof SharedArrayBuffer ? SharedArrayBuffer : void 0;
function C(e) {
    return "[object SharedArrayBuffer]" === c(e);
}
function R(e) {
    return void 0 !== v && (void 0 === C.working && (C.working = C(new v())), C.working ? C(e) : e instanceof v);
}
function O(e) {
    return E(e, d);
}
