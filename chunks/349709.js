...
function y(e) {
    let { className: t, guildId: l, error: s, emojiId: y, emojiName: N, isRequiredField: E = !0, shouldUpdateBothEmojiFields: I = !1, setEmojiId: O, setEmojiName: S } = e,
        k = (0, p.Z)({
            emojiId: y,
            emojiName: N
        }),
        w = (0, r.e7)([g.ZP], () => (null != l ? g.ZP.getDefaultChannel(l) : null)),
        C = i.useRef(null),
        D = (0, d.Z)(C),
        P = () => {
            S(void 0), O(void 0);
