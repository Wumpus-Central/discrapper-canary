...
let U = r.memo((e) => {
    ...
    let { mute: a, deaf: s, user: y, channel: C, sessionId: j, nick: Z } = e,
        ...
        ee = (0, o.e7)([N.Z], () => N.Z.getSessionById(j)),
        et = M.ZP.useName(y),
...
let F = [],
    B = function (e) {
        let {
            ...
            V = r.useCallback(
                (e) => {
                    t && (N(!0), H.current.cancel(), (A.current = e), B.current.delay());
                },
                [t],
            ),
            G = r.useCallback(
                (e) => {
                    t && (B.current.cancel(), (A.current = null), N(!1), H.current.delay());
                },
                [t],
            ),
            z = (0, o.Wu)([T.Z], () => {
