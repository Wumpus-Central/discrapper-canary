...
let en = i.memo(function (e) {
    let { disabled: t, channel: n } = e,
        { analyticsLocations: i } = (0, Q.Ay)($.A.GIFT_BUTTON),
        s = (0, et.R1)(n),
        { Component: a, events: r, play: o } = X(),
        {
            openGiftModal: c,
...
function eC(e) {
    let { Component: t, events: n, play: s } = X(),
...
let eA = ep.A.Millis.DAYS_30,
    eE = i.memo(function (e) {
        let { disabled: t, channel: n } = e,
            { analyticsLocations: s } = (0, Q.Ay)($.A.GIFT_BUTTON),
            [r, o] = i.useState(!1),
...
let ej = i.memo(function (e) {
    ...
    return (!s.Fr &&
        (_.gifts?.button != null &&
            null == b &&
            !N &&
            (null == R || O.Ay.isPremiumEligible(R)) &&
