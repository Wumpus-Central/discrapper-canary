...
let v = s()((e) => {
    ...
    E = (e) => {
        let { variantGroupProduct: t, variant: r, variantIndex: o, totalVariants: a, selectedVariantIndex: s, onEnter: d, onLeave: g, minimal: E } = e,
            ...
            T = l.useCallback(
                (e) => {
                    (e.preventDefault(), e.stopPropagation(), (0, f.$)(t, o), x());
                },
                [x, t, o]
            );
