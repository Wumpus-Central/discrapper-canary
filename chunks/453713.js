...
let y = s()((e) => {
    ...
    j = (e) => {
        var t, r;
        let { variantGroupProduct: i, className: o, previewingVariantIndexProps: a, setIsHoveringOnSwitch: s, minimal: d, selectedVariantIndex: v, alternativeBackgroundColor: f } = e,
            y = a.previewingVariantIndex,
            j = null == (t = i.variants) ? void 0 : t[v],
