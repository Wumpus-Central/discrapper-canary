...
let _ = s()((e) => {
    ...
    j = (e) => {
        let { variantGroupProduct: t, variant: r, variantIndex: l, totalVariants: a, selectedVariantIndex: s, onEnter: d, onLeave: v, minimal: j } = e,
    ...
    x = (e) => {
        var t, r;
        let { variantGroupProduct: i, className: l, previewingVariantIndexProps: a, setIsHoveringOnSwitch: s, minimal: d, selectedVariantIndex: b, alternativeBackgroundColor: f } = e,
