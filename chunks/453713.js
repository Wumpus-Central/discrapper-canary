...
let O = s()((e) => {
    ...
    S = (e) => {
        var t, n;
        let { variantGroupProduct: l, className: a, previewingVariantIndexProps: o, setIsHoveringOnSwitch: s, minimal: d, selectedVariantIndex: p, alternativeBackgroundColor: g } = e,
