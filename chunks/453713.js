...
let E = s()((e) => {
    ...
    v = (e) => {
        let { variantGroupProduct: t, variant: n, variantIndex: i, totalVariants: a, selectedVariantIndex: s, onEnter: d, onLeave: f, minimal: v } = e,
            ...
            T = l.useCallback(
                (e) => {
                    (e.preventDefault(), e.stopPropagation(), (0, g.$)(t, i), y());
                },
                [y, t, i]
            );
