...
function B(e) {
    var t;
    let { quest: n, progressState: r, isCollectibleQuest: a, questContent: o, questContentPosition: s, questContentRowIndex: u, inGiftInventory: f, isVideoQuest: p, inGameQuest: b, sourceQuestContent: y } = e,
        v = M({
            quest: n,
            questContent: o,
