...
let N = r.memo((e) => {
    let { name: t, canReveal: n = !0, dismissibleContentType: s, forceShadow: h, cardType: _ } = e,
        ...
        G = (0, l.debounce)(() => {
            g.default.track(C.rMx.PREMIUM_MARKETING_WHAT_IS_NEW_CARD_HOVERED, { card_type: (0, l.snakeCase)(t) });
        }, 800),
        F = (0, l.debounce)(() => {
            null != j &&
                g.default.track(C.rMx.PERK_DISCOVERABILITY_CARD_CTA_CLICKED, {
    ...
    let H = k !== s || null == s || R;
    return (r.useEffect(() => {
        y && A && (D(!0), g.default.track(C.rMx.PREMIUM_MARKETING_PERK_CARD_FLIPPED, { card_type: t }), null != s && L(O.L.TAKE_ACTION));
    }, [y, A, s, t, L]),
    (0, m.Z)({
              ...
              : (0, i.jsx)('div', {
                    ...
                    children: (0, i.jsx)('div', {
                        ...
                        children: (0, i.jsxs)(d.P3F, {
                            ...
                            onTransitionEnd: (e) => {
                                A && 'transform' === e.propertyName && e.target.classList.contains(v.flipCard) && (D(!0), g.default.track(C.rMx.PREMIUM_MARKETING_PERK_CARD_FLIPPED, { card_type: t }), null != s && L(O.L.TAKE_ACTION));
                            },
                            children: [
                                (0, i.jsx)('div', {
...
let I = r.forwardRef((e, t) => {
    var n;
    let { title: r, titleClassName: s = '', subtitle: l = '', description: o = '', descriptionCta: c = '', isPremiumGetCta: u, onCtaClick: m, onMouseEnter: p, className: g, perkComponent: f, cardVariant: b, cardType: C, onClick: O, backgroundImage: E, pillText: S, perkImage: T, imageOverlayText: N, hasNitroGradientBackground: I } = e,
        y = C === x.gM.CARD_CAROUSEL_FIRST_ROW || C === x.gM.CARD_CAROUSEL_SECOND_ROW || C === x.gM.CARD_CAROUSEL_THIRD_ROW,
