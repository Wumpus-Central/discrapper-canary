...
let N = r.forwardRef((e, t) => {
    var n;
    let { title: r, titleClassName: s = '', subtitle: l = '', description: o = '', descriptionCta: c = '', isPremiumGetCta: u, onCtaClick: m, onMouseEnter: p, className: g, perkComponent: f, cardVariant: b, cardType: C, onClick: E, backgroundImage: O, pillText: S, perkImage: T, imageOverlayText: I, hasNitroGradientBackground: N } = e,
