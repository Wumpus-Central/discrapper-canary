...
function e1(e) {
    ...
    let { message: i, channel: o, compact: c } = e,
        ...
        f = () => {
            (0, w.lL)(o, i.author.id, !1), l.A.deleteMessage(o.id, i.id, !0);
        },
...
let tn = Object.freeze({
    ...
    [eC.lAJ.GUILD_INCIDENT_REPORT_RAID]: eX,
    [eC.lAJ.GUILD_INCIDENT_REPORT_FALSE_ALARM]: eZ,
