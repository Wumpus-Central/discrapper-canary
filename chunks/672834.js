...
let eO = Object.freeze({
        ...
        [ey.lAJ.GUILD_BOOST]: eL,
        [ey.lAJ.GUILD_BOOST_TIER_1]: eL,
        [ey.lAJ.GUILD_BOOST_TIER_2]: eL,
        [ey.lAJ.GUILD_BOOST_TIER_3]: eL,
        ...
        [ey.lAJ.GUILD_STREAM]: function (e) {
            let { message: t, compact: n, channel: r } = e,
                ...
                g = l.useCallback(() => {
                    null != _ &&
                        null != h &&
                        (0, c.Nl)({ streamType: ej.U4.GUILD, ownerId: o, channelId: _.id, guildId: h });
                }, [o, _, h]);
        ...
        [ey.lAJ.GUILD_DISCOVERY_REQUALIFIED]: eo.wj,
        [ey.lAJ.GUILD_DISCOVERY_GRACE_PERIOD_INITIAL_WARNING]: eo.Cq,
        [ey.lAJ.GUILD_DISCOVERY_GRACE_PERIOD_FINAL_WARNING]: eo.If,
        ...
        [ey.lAJ.THREAD_STARTER_MESSAGE]: ev.A,
        ...
        [ey.lAJ.GUILD_INCIDENT_ALERT_MODE_ENABLED]: eM,
        [ey.lAJ.GUILD_INCIDENT_ALERT_MODE_DISABLED]: eM,
        ...
        [ey.lAJ.REPORT_TO_MOD_BAN_USER]: y.A,
        [ey.lAJ.REPORT_TO_MOD_KICK_USER]: y.A,
        [ey.lAJ.REPORT_TO_MOD_TIMEOUT_USER]: y.A,
        [ey.lAJ.REPORT_TO_MOD_DELETED_MESSAGE]: y.A,
        [ey.lAJ.REPORT_TO_MOD_CLOSED_REPORT]: y.A,
