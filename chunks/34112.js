...
function W(e) {
    var t, s, c;
    let { role: d, guild: g, highestRole: h, currentPosition: x, memberCount: N, onDragStart: _, onDragReset: v, onDragComplete: O, disableHover: y, disableDrag: I, setEditRoleId: S, setSelectedSection: A } = e,
        k = (0, C.T)(g, h, d),
        W = null != k,
        [M, G] = i.useState(!1),
        U = i.useMemo(
