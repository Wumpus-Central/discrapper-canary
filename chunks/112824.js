...
function j(e) {
    let { guild: t } = e,
        ...
        u = b(t),
        m = u.length > 0,
        j = g.$X.some((e) => !d.Z.can(e, t, null, { [i.id]: x(f({}, i), { permissions: a.Od(i.permissions, e) }) })),
    ...
    return m
        ? j
            ? (0, r.jsx)(o.ua7, {
                  ...
                  children: (e) => (0, r.jsx)('div', x(f({ className: l()(h.simpleItemWrapper, h.disabled) }, e), { children: v }))
              })
            : (0, r.jsx)(o.P3F, {
                  onClick: () => {
                      (0, o.ZDy)(async () => {
