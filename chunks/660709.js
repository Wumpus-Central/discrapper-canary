e.exports = function (e) {
    let t = e.regex,
        ...
        i = "[a-zA-Z_]\\w{0,149}::",
        s = "<[^<>]+>",
        a = "(" + r + "|" + t.optional(i) + "[a-zA-Z_]\\w{0,149}" + t.optional(s) + ")",
        o = {
            className: "type",
        ...
        E = {
            ...
            contains: [
                ...
                { begin: f, returnBegin: !0, contains: [e.inherit(_, { className: "title.function" })], relevance: 0 },
                { relevance: 0, match: /,/ },
                {
                    className: "params",
                    begin: /\(/,
    ...
    return {
        ...
        exports: { preprocessor: d, strings: u, keywords: p },
    };
};
