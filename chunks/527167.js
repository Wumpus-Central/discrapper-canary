e.exports = function (e) {
    let t = e.regex,
        ...
        u = [e.BACKSLASH_ESCAPE, i, o],
        c = [/!/, /\//, /\|/, /\?/, /'/, /"/, /#/],
        d = (e, r, i = "\\1") => {
            let s = "\\1" === i ? i : t.concat(i, r);
            return t.concat(t.concat("(?:", e, ")"), r, /(?:\\.|[^\\\/])*?/, s, /(?:\\.|[^\\\/])*?/, i, n);
        },
    ...
    return (i.contains = f), (s.contains = f), { name: "Perl", aliases: ["pl", "pm"], keywords: r, contains: f };
};
