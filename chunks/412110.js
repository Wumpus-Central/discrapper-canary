...
function s(e, t, s) {
    ...
    switch (e.code) {
        ...
        case i.evJ.CREATOR_MONETIZATION_PAYMENT_ACCOUNT_VERIFICATION_REQUIRED:
            let u, g;
            null != s ? ((u = o.t.j2VMk5), (g = { url: i.EYA.DEVELOPER_PORTAL_PAYOUT_SETTINGS(s) })) : (u = o.t.ZVV1go),
                (0, l.B)(o.intl.string(o.t["+CT/gY"]), u, a.A.WARNING, g);
            break;
        default:
            let f =
                null != (d = e.getFirstFieldErrorMessage(["published"]))
                    ? d
                    : (null == (c = e.hasFieldErrors) ? void 0 : c.call(e))
                      ? void 0
                      : e.message;
