...
var eV = n(541830),
    eW = n(240248);
let eU = [G.V.OFFICIAL, G.V.FACEBOOK, G.V.TWITTER, G.V.INSTAGRAM, G.V.YOUTUBE, G.V.BLUESKY, G.V.REDDIT, G.V.TWITCH];
var eY = n(808380);
...
function tX(e) {
    let { game: t, className: n, trackAction: l } = e,
        ...
        { enabled: j } = tk.A.useConfig({ location: "GameProfileOverflowMenu" }),
        v = a.useCallback(() => {
...
function t7(e) {
    let { trackAction: t, analyticsLocations: n } = e,
        ...
        m = (0, d.bG)([B.default], () => B.default.getCurrentUser()),
        x = a.useCallback(() => {
...
function nG(e) {
    ...
    return (0, i.jsx)(ey, {
        ...
        onClickViewAll: r,
        children: (0, i.jsx)(nM, { skuIds: o, analyticsLocations: s, onCardClick: c }),
    });
}
n(667532);
var nP = n(853022);
let nw = new Set(["1402418703554842694", "356877880938070016"]),
    nD = [G.V.EPICGAMES, G.V.STEAM, G.V.ROBLOX, G.V.BATTLENET, G.V.RIOT, G.V.MINECRAFT];
var nV = n(349361),
    nW = n(924895),
    nU = n(422688),
    nY = n(505200),
        ...
        r =
            ...
            a.useMemo(() => {
                ...
                let e =
                    i?.filter(
                        (e) =>
                            (e.category !== G.V.EPICGAMES || !!nw.has(l)) &&
                            (e.category !== G.V.STEAM || s !== u.Y.RETIRED_ABANDONED) &&
                            nD.includes(e.category),
                    ) ?? [];
                null == t ||
                    s === u.Y.RETIRED_ABANDONED ||
                    e.some((e) => e.category === G.V.STEAM) ||
                    e.push({ category: G.V.STEAM, url: t });
                let a = e.sort((e, t) => (e.category === G.V.STEAM ? -1 : +(t.category === G.V.STEAM)));
...
let n5 = function (e) {
    let {
        ...
        [g, j] = a.useState(!0),
        [E, N] = a.useState(null),
        { clientThemesClassName: k } = (0, S.Ay)(),
        G = (0, d.bG)([O.default], () => O.default.locale),
        P = a.useMemo(() => (0, _.u9)(), []),
        { analyticsLocations: w } = (0, I.Ay)(A.A.GAME_PROFILE),
        z = (0, M.s)(t),
        { data: X } = (0, T.I)(t),
        K = X?.name ?? "",
        J = (0, V.A)(X),
    ...
    let {
        ...
        { invite: en, isMember: el } = D(X, N),
        { socialLayerStorefrontRecommendationsData: ei } = (function (e) {
    ...
    function ea(e, l) {
        let { guildId: i, isVerified: a } = (0, _.VO)($.current);
        (0, _.Tn)({
            gameName: K,
            gameId: t,
            action: e,
    ...
    (0, v.Ay)(() => {
        (0, _.rw)({ source: n, viewId: P, gameId: t, gameName: K, authorId: l, profileType: _.HV.FullProfile }),
            (0, C.He)();
    }),
        (0, v.Ay)(() => () => {
            let { isVerified: e, guildId: n } = (0, _.VO)($.current),
                l = Date.now(),
                i = z.map((e) => {
                    let t = (0, R.JM)(e) ? (0, R.W6)(e, l) : (0, R.aJ)(e, G);
            ...
            (0, _.V_)({
                ...
                gameId: t,
                gameName: K,
                playedFriendIds: z.map((e) => e.author_id),
                playedFriendsData: i,
                similarGames: [],
                guildId: n,
                isVerified: e,
    ...
    let es = a.useCallback((e) => {
        ...
        eo = a.useCallback(() => ec(!1), [ec]),
        eu = a.useRef(null),
        ed = a.useCallback(() => eu.current?.getScrollerNode()?.scrollTop ?? 0, []),
        em = a.useMemo(
            () => ({
                isTwoColumn: g,
                canStartAuthorization: Z,
                hasAlreadyLinked: q,
                fetchedAuthorization: Q,
                startAuthorization: ee,
                connectionApp: et,
                invite: en,
                isMember: el,
                socialLayerStorefrontRecommendationsData: ei,
                closeModal: ec,
                getScrollOffset: ed,
            }),
            [g, Z, q, Q, ee, et, en, el, ei, ec, ed],
        ),
        [ex, eh] = a.useState(!1),
        [eg, ef] = a.useState(150),
        ep = a.useRef(null);
    a.useEffect(() => {
        null != h && h > 0 && eu.current?.getScrollerNode()?.scrollTo({ top: h, behavior: "instant" });
    }, []);
                  ...
                  children: (0, i.jsx)(H.Provider, {
                      ...
                      children: (0, i.jsx)("div", {
                          ...
                          children: (0, i.jsxs)(y.A, {
                              ...
                              onClose: eo,
                              children: [
                                  (0, i.jsx)(tq, { game: X, ref: ep }),
                                  (0, i.jsx)(tJ, { game: X, show: ex, trackAction: ea }),
                                  (0, i.jsx)(t$, { show: ex }),
                                  (0, i.jsxs)(f.Ch, {
                                      ref: eu,
                                      onScroll: ej,
                                      children: [
                                          (0, i.jsx)(t1, {
                                              game: X,
                                              onSetCompactBarScrollThreshold: ef,
                                              showCompactBar: ex,
                                          }),
                                          (0, i.jsx)(p.F, {
                                              children: g
                                                  ? (0, i.jsxs)("div", {
                                                        className: te.jC,
                                                        children: [
                                                            (0, i.jsx)(nQ, { game: X, trackAction: ea }),
                                                            (0, i.jsx)(n4, {
                                                                game: X,
                                                                appContext: u,
                                                                source: n,
