...
let r = (0, n(600975).C)({
    ...
    defaultConfig: { enabled: !1, includeImages: !1, includeStickers: !1 },
    treatments: [
        {
            id: 1,
            label: "Enable communication notifications",
            config: { enabled: !0, includeImages: !1, includeStickers: !1 },
        },
        {
            id: 2,
            label: "Also embed (SFW) images in notification content",
            config: { enabled: !0, includeImages: !0, includeStickers: !1 },
        },
        {
            id: 3,
            label: "Also embed stickers in notification content",
            config: { enabled: !0, includeImages: !0, includeStickers: !0 },
        },
    ],
});
