...
function D() {
    return (0, i.jsx)("div", { className: w.$k, children: (0, i.jsx)(o.y, {}) });
}
function P(e) {
...
function U(e) {
    ...
    return t?.state === O.elq.BANNED
        ? (0, i.jsx)(_.N, { text: L.intl.string(L.t["5AkWAd"]), buttonCta: L.intl.string(L.t["8osdkn"]), onClick: n })
        : (0, i.jsx)(_.N, { text: L.intl.string(L.t["usP+Mb"]), buttonCta: L.intl.string(L.t["8osdkn"]), onClick: n });
}
function B(e) {
    let { children: t, cardChildren: n, startAnimHeightPx: s, sectionClassName: l, inviteCardClassName: a = w.qF } = e,
...
function M(e) {
    ...
    return (0, i.jsx)(B, {
        startAnimHeightPx: 0,
        sectionClassName: w.ui,
        children: 1 === n ? (0, i.jsx)(b.s, { invite: t }) : null,
    });
}
let V = { 1: w._r, 2: w.Gm, 0: w.Kt };
function F(e) {
    let t,
        { invite: n } = e,
        r = P(n),
    ...
    if (
        ...
        switch (r) {
            case 1:
                t = d
                    ? (0, i.jsx)(y.A, { invite: n, guild: o, profile: a, onAcceptInvite: e.onAcceptInvite })
                    : (0, i.jsx)(T.A, { ...e, invite: n });
                break;
            case 2:
                t = (0, i.jsx)(U, { ...e, invite: n });
                break;
            default:
                t = (0, i.jsx)(D, {});
        }
    let u = 1 === r && d ? w.c4 : w.qF;
    ...
    return (
        ...
        (0, i.jsx)(W, {
            ...
            onAcceptInvite: (e) => {
                let n, i, s, l;
                e?.preventDefault(),
                    x.default.track(O.HAw.INVITE_APP_OPENED, {
                    ...
                    (n = null != r && r.state !== O.elq.EXPIRED && r.state !== O.elq.BANNED ? t : void 0),
