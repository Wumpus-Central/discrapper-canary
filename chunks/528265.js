            ...
            let { direction: i } = (0, L.Y)(),
                ...
                { gridProps: d } = (function (e, t, n) {
                    ...
                    let m = (0, y.m)({ selectionManager: t.selectionManager, hasItemActions: !!o }),
                        g = (0, N.$)(n, { isDisabled: 0 !== t.collection.size }),
                        A = (0, f.$)(e, { labelable: !0 }),
                        T = (0, u.v)(
                            A,
                            {
    ...
    let i = (0, r.useContext)(p),
        ...
        { focusProps: c, isFocusVisible: d } = (0, M.o)({ within: !1 }),
        {
                        ...
                        D = (0, u.v)(v, b, {
                            ...
                            onKeyDown: (e) => {
                                if (
                                    ...
                                    let t = (0, H.N$)(n.current, { tabbable: !0 });
            ...
            let g = l && ("keyboard" === m || "virtual" === m) ? a.format("removeDescription") : "",
                ...
                C = null != t.selectionManager.focusedKey,
                N = -1;
            E || (!y && C) || (N = 0);
            let v = (0, f.$)(s.props),
                R = (0, k.HI)(s.props),
