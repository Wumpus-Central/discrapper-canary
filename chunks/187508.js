...
function G(e) {
    ...
    (P = !0),
        null == t &&
            x.guildFilter === S.KE7.THIS_SERVER &&
            Z({
                guildFilter: S.KE7.ALL_SERVERS,
            });
}
...
function ee() {
    U({
        deletedMessages: a().filter(N, (e) => y.A.isBlockedOrIgnoredForMessage(e)),
    }),
...
function et(e) {
    let { channel: t } = e,
        n = [];
    (N = a().filter(N, (e) => e.channel_id !== t.id || (delete w[e.id], n.push(e), !1))),
        U({
            deletedMessages: n,
        });
}
