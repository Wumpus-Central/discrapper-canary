        ...
        h =
            0 === s.length
                ...
                : (0, r.jsxs)("div", {
                      className: ey.nM,
                      children: [
                          (0, r.jsx)(eA.q, { size: "lg", color: "currentColor", className: ey.RI }),
    ...
    return (0, r.jsxs)(r.Fragment, {
        children: [
            (0, r.jsx)("div", {
                ...
                children: (0, r.jsx)("span", { className: l()(ey.cN, ey.NT), children: eu.intl.string(eu.t.wMWyci) }),
            }),
            (0, r.jsx)(ev, {}),
        ],
    });
...
function ex(e) {
    let t,
        ...
        y = (0, E.bG)([$.Ay], () => $.Ay.getChannelId(eL.YYv)),
        D = (0, E.bG)([K.A], () => K.A.getChannel(y)),
        v = (0, j.A)((e) => e.guildId),
        b = (0, ee.ai)(v),
                    ...
                    children: (0, r.jsx)(U.Q, {
                        ...
                        children: (0, r.jsx)("div", {
                            ...
                            children: (0, r.jsx)(w.j, {
                                ...
                                "aria-selected": b,
                                to: { pathname: eL.BVt.CHANNEL(eL.YYv, y), state: eG },
                                selected: b || N,
                                onClick: () => {
                                    f && ef(!1);
                                },
                                ...
                                onMouseDown: function () {
                                    null != D && x.A.preload(D.guild_id, D.id);
                                },
                                onContextMenu: O,
...
function tT(e) {
    ...
    return (0, r.jsxs)(r.Fragment, {
        children: [
            ...
            C,
            O,
            R ? (0, r.jsx)(tp, { muteConfig: L, className: l()(ey.LM, { [ey.Sx]: null != N || null != C }) }) : null,
        ],
    });
}
function tm(e) {
...
function tv(e) {
    let {
        ...
        E = i ? t : (0, r.jsx)("div", { className: l()(tD.p, { [tD.w]: u }), children: t });
    return (0, r.jsx)(em.m, {
...
function iF(e) {
    let t,
        ...
        { isMuted: F, muteConfig: V } = (0, E.cf)(
            [es.Ay],
            () => ({ isMuted: es.Ay.isMuted(y), muteConfig: es.Ay.getMuteConfig(y) }),
            [y],
        );
    return (0, r.jsxs)(r.Fragment, {
        children: [
            ...
            G,
            x,
            F ? (0, r.jsx)(ik, { muteConfig: V, className: l()(ey.LM, { [ey.Sx]: null != U || null != G }) }) : null,
        ],
    });
}
function iV(e) {
    ...
    return (0, r.jsxs)(r.Fragment, {
        children: [
            (0, r.jsxs)("div", {
                ...
                children: [
                    n
                        ? (0, r.jsx)(ib.A, { disableBoostClick: !0, guild: t, className: ey.WX })
                        : (0, r.jsx)(iv.A, { guild: t, size: 20, className: ey.aL }),
...
let iY = a.memo(function (e) {
    ...
    let J = a.useCallback(() => {
            null != o ? (0, iR.pX)(o, { state: ij }) : (0, W.u)(D, { state: ij });
        }, [D, o]),
        ee = a.useCallback(() => {
        ...
        et = (0, iC.bG)([ej.Ay], () => ej.Ay.isCurrentUserGuest(D)),
        en = a.useCallback(
            (e) => {
                null == d || et || g(e, d);
            },
...
function rs(e) {
    ...
    let { disableAppDownload: n = eK.isPlatformEmbedded, isOverlay: i = !1, className: s, themeOverride: o } = e,
        ...
        A = a.useMemo(() => (i ? [] : _), [_, i]),
        f = (0, E.bG)([y.A], () => y.A.isFullscreenInContext()),
