"use strict";
n.d(t, { Fx: () => N, JH: () => y, SY: () => S, aV: () => O, fE: () => A, pF: () => C, zu: () => I }),
    n(938796),
    n(321073);
var i = n(64700),
    r = n(975975),
...
function y(e, t) {
    ...
    let r = E.A.getTemplateWithCategory(t, i);
...
function O(e) {
    return (0, f.X9)(e) && e.features.has(p.GuildFeatures.ROLE_SUBSCRIPTIONS_ENABLED) && (0, d.TG)(e.id);
}
