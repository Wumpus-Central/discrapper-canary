...
let _ = [],
    h = function (e) {
        ...
        let f = (0, s.A)(h);
        return { listingsLoaded: _ === c.e.FETCHED && !0 !== f };
    },
    f = function (e) {
    ...
    p = (e) => (0, r.bG)([c.A], () => (null != e ? c.A.getSubscriptionListing(e) : null)),
    E = (e) => {
    ...
    S = (e) => (0, r.bG)([c.A], () => (null != e ? c.A.getSubscriptionSettings(e) : void 0)),
    y = () => {
        let [e, t] = i.useState(!1),
            [n, r] = i.useState(null);
        return {
    ...
    N = (e) => (0, r.bG)([c.A], () => (null != e ? c.A.getSubscriptionTrial(e) : null));
