...
function U(e, t, n) {
    switch (e) {
        ...
        case "defaultForumLayout":
            if (n === R.rbe.GUILD_MEDIA) return E.C.GRID;
...
function w(e) {
    (i = e.section),
        (r = e.subsection),
        null != s &&
            i === R.p_A.INSTANT_INVITES &&
            ((v = !0),
            I.Bo.get({ url: R.Rsh.INSTANT_INVITES(s.id), oldFormErrors: !0, rejectWithError: !0 }).then(
                (e) => {
...
function G() {
    (b = !1), (L = R.XlH.CLOSED), (i = null), (s = a = null), (l = null), (D = {});
}
let x = c().debounce(() => {
...
let H = new B(f.h, {
        CHANNEL_SETTINGS_INIT: function (e) {
            ...
            (L = R.XlH.OPEN),
                ...
                (l = C.A.getChannel(s.parent_id)),
                (o = s.getGuildId());
            let n = s.isModeratorReportChannel() ? R.p_A.PERMISSIONS : R.p_A.OVERVIEW;
            return (y = {}), w({ type: "CHANNEL_SETTINGS_SET_SECTION", section: i ?? n, subsection: r }), !0;
        },
        CHANNEL_SETTINGS_SUBMIT: function () {
            (L = R.XlH.SUBMITTING), (y = {});
        },
