...
function P(e, t, n) {
    switch (e) {
        ...
        case "defaultForumLayout":
            if (n === v.rbe.GUILD_MEDIA) return h.C.GRID;
...
function x(e) {
    (i = e.section),
        (r = e.subsection),
        null != a &&
            i === v.p_A.INSTANT_INVITES &&
            ((D = !0),
            E.Bo.get({ url: v.Rsh.INSTANT_INVITES(a.id), oldFormErrors: !0, rejectWithError: !0 }).then(
                (e) => {
...
function k() {
    (L = !1), (R = v.XlH.CLOSED), (i = null), (a = s = null), (o = null), (b = {});
}
let U = c().debounce(() => {
    ...
    return (
        !!(function (e) {
            ...
            if (s === a) {
                ...
                if (null == t) return !1;
                (a = s = t), (o = N.A.getChannel(a.parent_id));
            } else {
                let t = N.A.getChannel(e);
                if (null == t) return !1;
                (s = t),
...
let H = new B(m.h, {
        CHANNEL_SETTINGS_INIT: function (e) {
            let t = N.A.getChannel(e.channelId);
            if (null == t) return k();
            (R = v.XlH.OPEN),
                (a = s = t),
