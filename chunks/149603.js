n.d(t, { iV: () => cf, OC: () => cC, Ay: () => cE }), n(938796);
var i,
    l,
    s,
    r,
...
function tu(e) {
    ...
    let A = () => {
        (0, eJ.openModalLazy)(async () => {
            let { default: e } = await Promise.all([n.e("17014"), n.e("68031"), n.e("85384"), n.e("20428")]).then(
                n.bind(n, 719847),
            );
            return (n) =>
...
function sY(e) {
    let { message: t, compact: n } = e,
        i = (0, h.bG)([O.A], () => O.A.getChannel(sk.default.castMessageIdAsChannelId(t.id)));
    return null == i ? null : (0, a.jsx)(sz, { channel: i, compact: n, isSystemMessage: (0, sR.A)(t) });
}
function sz(e) {
    var t;
    let i,
    ...
    renderViewInStoreButton() {
        return (0, a.jsx)("div", {
            ...
            children: (0, a.jsx)(J.$, {
                ...
                onClick: () => {
                    (0, rR.pX)(ed.BVt.APPLICATION_STORE);
                },
            }),
        });
    }
...
class aN extends o.PureComponent {
    ...
    handleViewInventory() {
        (0, rM.openUserSettings)(rk.X.GIFT_PANEL);
    }
...
class aT extends o.Component {
    ...
    handleViewLibrary = (e) => {
        ...
        e.preventDefault(),
            null != t && t.isHidden()
                ? (0, rR.pX)(ed.BVt.APPLICATION_LIBRARY_SETTINGS)
                : (0, rR.pX)(ed.BVt.APPLICATION_LIBRARY, { state: { applicationId: null != t ? t.id : void 0 } });
    };
    handleVerificationClick = (e) => {
        e.stopPropagation(), e.preventDefault(), (0, rM.openUserSettings)(rk.X.ACCOUNT_PANEL);
    };
    handleAccept = (e) => {
    ...
    handleEmbedClick = (e) => {
        ...
        null != n && (0, lF.bF)(n) && null != i && null != i.guildId
            ...
            : null != t && t.isSubscription && (e.preventDefault(), (0, rM.openUserSettings)(rk.X.NITRO_PANEL));
    };
...
function oG(e) {
    ...
    let R = (0, h.bG)([Z.A], () => Z.A.useReducedMotion),
        k = o.useRef(null),
...
function oV(e) {
    ...
    let c = l ?? { state: ed.elq.RESOLVING, code: "" },
        ...
        A = (0, h.bG)([aR.Ay], () => aR.Ay.getGuildScheduledEvent(c.guild_scheduled_event?.id), [c]),
        x = () => {
...
function o2(e) {
    let { currentUserId: t, message: i, application: l, channel: s, analyticsLocations: r, onView: o } = e,
        ...
        x = sk.default.extractTimestamp(i.id) + o1.M < Date.now(),
...
function dC(e) {
    ...
    let n = dx.A.getRemoteApplicationActivity(t);
    return null == n ||
        (0, dE.e)(n) ||
        (null != n.application_id &&
            (dA.A.isConnected(n.application_id) ||
                (function (e) {
                    let { platform: t } = e;
                    return (0, df.m0)() ? t === ed.yTV.ANDROID : !!(0, df.un)() && t === ed.yTV.IOS;
                })(n)))
        ? null
...
let dI = 2 * sq.A.Millis.HOUR;
function dv(e, t, n) {
    if (null == e) return !1;
    let i = null != t.activity ? t.activity.party_id : null,
        l = null != i && e.party?.id !== i,
        s = sk.default.extractTimestamp(t.id) + dI < Date.now(),
...
var d_ = n(737393),
    dj = n(835517),
    dN = n(635377);
let dT = new (n.n(dN)())({ max: 500 });
class dy extends h.Ay.Store {
...
function dM(e) {
    let { applicationName: t, iconSrc: n, viewAction: i } = e,
        ...
        d = null == i ? o : (0, a.jsx)(W.D, { onClick: i, className: dk.Qi, children: o });
    return (0, a.jsxs)("div", {
        className: dk.Xy,
        style: { background: r },
        children: [
            ...
            (0, a.jsxs)("div", {
                className: dk.fi,
                children: [
                    null != n ? (0, a.jsx)("img", { className: dk.V$, src: n, alt: "" }) : null,
                    (0, a.jsxs)("div", {
                        className: dk.Cr,
                        children: [
                            d,
...
function dP(e) {
                      ...
                      ? (e = [
                            {
                                ...
                                isDeadEnd: !0,
                                onClick: () => {
                                    dL.Ay.launch({ applicationId: d, embedded: c });
                                },
                            },
                        ])
                      : null != u && ((e = [u]), (i = !1)),
    ...
    return 0 === T.length
        ? (0, a.jsx)(dM, { applicationName: i, iconSrc: p, viewAction: g })
        : (0, a.jsxs)(a.Fragment, {
              children: [
                  (0, a.jsx)(el, {
                      header: s,
...
function d$(e) {
            ...
            () =>
                l
                    .map((e) => {
                        switch (e) {
                            case dZ.MOBILE:
                                return (0, a.jsx)(dO.u, { size: "xxs", color: "currentColor" });
                            case dZ.ANDROID:
                                return (0, a.jsx)(dQ, { width: dD.E.xxs, height: dD.E.xxs, color: "currentColor" });
                            case dZ.IOS:
                                return (0, a.jsx)(dU.z, { size: "xxs", color: "currentColor" });
                            case dZ.PLAYSTATION:
                                return (0, a.jsx)(dG.X, { size: "xxs", color: "currentColor" });
                            case dZ.XBOX:
                                return (0, a.jsx)(dV.Y, { size: "xxs", color: "currentColor" });
                            case dZ.VR:
                                return (0, a.jsx)(dw.G, { size: "xxs", color: "currentColor" });
                            case dZ.DESKTOP:
                                return (0, a.jsx)(dB.k, { size: "xxs", color: "currentColor" });
                            default:
                                return null;
                        }
                    })
    ...
    return (0, a.jsxs)("div", {
        ...
        children: [
            (0, a.jsx)("div", {
                className: dk.E6,
                children: s.map((e, t) => (0, a.jsx)("div", { className: dk.F2, children: e }, t)),
            }),
            (0, a.jsx)(x.E, { variant: "text-sm/medium", color: "currentColor", className: dk.kB, children: r }),
        ],
    });
}
function d0(e) {
    let {
        ...
        H = o.useMemo(
            () => (0, a.jsxs)("div", { className: dk.pq, children: [B, V, C || O ? null : I] }),
            [V, C, O, I, B],
        ),
        F = !!d,
        Y = (0, M.x)(n),
        { canJoin: z, remoteJoinPlatform: W } = (function (e) {
            ...
            if (l.author.id === i || !dv(t, l, s.id)) return { canJoin: !1, remoteJoinPlatform: null };
            let d = (0, o8._)(t);
            if (!(0, dK.A)(d) || (0, dJ.U)(d) || (0, dz.w)(n, t) || o9(l))
            ...
            if (l.activity?.type === ed.xL.JOIN && null != t) {
                ...
                if ((0, dW.A)(t, ed.jUm.SUPPORTS_JOIN_URL)) return { canJoin: !0, remoteJoinPlatform: null };
            }
        ...
        K = !(null == f || !dv(f, t, n.id) || !(0, dW.A)(f, ed.jUm.SYNC) || !o0.isPlatformEmbedded || (0, dz.w)(E, f)),
        J = (function (e, t, n, i) {
            if (
                t.author.id === i ||
                !dv(e, t, n.id) ||
                t.activity?.type !== ed.xL.JOIN_REQUEST ||
                !(0, dW.A)(e, ed.jUm.JOIN)
            )
                return !1;
            let l = (0, o8._)(e);
            return !(!(0, dK.A)(l) || (0, dJ.U)(l));
        })(f, t, n, r),
        q = (0, dz.w)(E, f),
        Z = null != f && (0, dW.A)(f, ed.jUm.SUPPORTS_REMOTE_ACTIVITY_ACTION_JOIN),
        X = (0, h.bG)(
            [dY.A],
            () =>
                null != f && null != f.application_id && dY.A.getState(f.application_id, ed.xL.JOIN) === ed.eAD.LOADING,
        ),
                    ...
                    ? (e = {
                          ...
                          onClick: () => {
                              dL.Ay.join({
                                  ...
                                  source: ed.ThZ.MESSAGE_EMBED,
                                  analyticsLocations: v,
                                  embedded: (0, dW.A)(f, ed.jUm.EMBEDDED),
    ...
    let ei = o.useMemo(
        () => (q ? null : (0, a.jsx)(d$, { presenceActivity: f, remoteJoinPlatform: W, isGameLaunchable: F })),
        [q, f, W, F],
    );
    return (0, a.jsxs)(a.Fragment, {
        children: [
...
function d2(e) {
    ...
    let i,
        ...
        v =
                ...
                let { messageId: t, presenceActivity: n, application: i } = e,
                    { cachedImageURL: l, imageURL: s } = (0, h.cf)(
                        ...
                        () =>
                            ((e) => {
                                let { messageId: t, presenceActivity: n, application: i } = e,
                                    l = dS.getCoverImageURL({ messageId: t });
            ...
            })({ messageId: g.id, presenceActivity: x, application: r }) ?? void 0,
        { openGameProfileModal: _, launchableAppId: j } =
            ((t = r.id),
            (n = g.author.id),
            (i = (0, rL.d)(t)),
            (l = (0, h.bG)([e4.A, oQ.A], () => {
        ...
        N = (0, d_.A)({ application: r, analyticsLocations: s }),
        T = o.useMemo(() => {
            if (null != N)
                return { label: ec.intl.string(ec.t["jaYS/h"]), icon: dn.h, trackingArea: Q.kY.CLOUD_PLAY, onClick: N };
        }, [N]),
        y = eS(r),
        S = o.useMemo(() => (null != _ ? _ : null != y && f ? y : void 0), [f, _, y]),
        b = ds.useConfig({ location: "RichPresenceGameActivityInviteEmbed" }),
        L = da.useConfig({ location: "RichPresenceGameActivityInviteEmbed" }),
        { canStartAuthorization: R, hasAlreadyLinked: k, startAuthorization: M } = (0, dc.RD)(r),
        P = (0, dd.z)(M, k),
        w = (0, h.bG)([dA.A, dx.A], () => !!dA.A.isConnected(r.id) || null != dC(x), [r, x]),
        D = dr.has(r.id) || (null != r.parentId && dr.has(r.parentId)),
        O = o0.isPlatformEmbedded && !D && L.requireAccountLink && R && !k,
        U = o0.isPlatformEmbedded && !D && L.requireGameLaunch && !w,
        G = !dv(x, g, r.id),
        V = oK(C, g.activity?.type, G),
        H = o.useRef(null),
        F = (0, h.bG)([dg.A], () => dg.A.getMessages(d.id)),
        Y = () => {
            var e;
            let t = [];
            return (
                (e = g.id),
                !F.hasAnyAfter(e, (e) => null != e.activity && e.activity.type === ed.xL.JOIN, 25) &&
                    R &&
                    !k &&
                    b.enabled &&
                    ...
                    children: (e) => {
                        ...
                        if (t === de.M.GAME_INVITE_ACCOUNT_LINK_UPSELL)
                            return (0, a.jsx)(dt.A, {
                                ...
                                title: ec.intl.formatToPlainString(ec.t["lo6H6+"], { gameName: r.name }),
                                body: ec.intl.string(ec.t.qYAzOp),
                                targetElementRef: H,
                                caretConfig: { align: "start" },
                                shouldShow: !0,
                                gradientColor: "purple",
                                onRequestClose: () => n(d1.i.USER_DISMISS),
                            });
                    },
                })
            );
...
function d5(e) {
    ...
    let {
        ...
        g = (0, dz.w)(c, s),
        p = (0, d6.Gq)(s, i.author, "Invite Embed"),
        A = o.useMemo(() => {
            let e = [];
            return (
                g ||
    ...
    return (0, a.jsx)(el, {
        ...
        iconSrc:
            ...
            (null == s || null == s.assets || null == s.assets.large_image
                ? null
                : (0, dp.uD)(t, s.assets.large_image, [rA.Ig, rA.Ig])) ?? void 0),
        info: I,
        actions: A,
        onClickContent: u,
        trackingConfig: {
...
function d7(e) {
    let {
        ...
        h = o.useMemo(() => {
            if (null != d) return () => (0, d3.Mp)(d);
        }, [d]);
    return u
        ? (0, a.jsx)(d4, { application: t, message: l, header: m, onClickContent: h, onView: s, guildId: c })
        : (0, a.jsx)(d5, {
              application: t,
              message: l,
              header: m,
...
function ce(e) {
    ...
    return (0, d9.pH)(u?.party?.id) || d.id === o3.HT.id
        ? (0, a.jsx)(d7, {
              application: d,
...
let cn = (e) => {
    ...
    let { channel: n, message: i, hideParty: l } = e,
        ...
        r =
            null != i.application
                ...
                : null != i.activity && null != i.activity.party_id && (0, d9.pH)(i.activity.party_id)
                  ? o3.HT
                  : void 0,
    ...
    switch (u) {
        case oz.DISPLAY:
            ...
            return (0, a.jsx)(ce, { app: d, channel: n, message: i, hideParty: l, analyticsLocations: s });
        case oz.BLOCK_UNDERAGE:
        case oz.BLOCK_CHANNEL_RESTRICTION:
            return (0, a.jsx)(ct, { visibility: u });
        default:
            return null;
    }
};
...
function cs(e) {
    let { applicationId: t, guildId: n } = e,
        { data: i } = (0, e3.YY)(t);
    return null == i ? null : (0, a.jsx)(cr, { app: i, guildId: n });
}
function cr(e) {
...
var ca = n(394839),
    ...
    ch = n(416620);
let cg = [ed.Auw.GIFV],
    cp = 15 * sq.A.Millis.MINUTE,
    cA = new Set(["discord-developers", "discord-testers", "discord-townhall", "discordgameslab"]),
    cx = (e) => () => {
        ...
        return null != i && null != l && (it.bp.test(n) || (r && (it.P8.test(n) || it.p4.test(n))))
            ? (0, a.jsx)(rI.A, { width: i, height: l, src: n, url: t, format: g.TL.IMAGE, className: ch.jj })
            : null;
    };
class cf extends o.Component {
    ...
    shouldRenderInvite(e) {
        ...
        return !(t.isDM() && !t.isSystemDM() && !t.isGroupDM() && cA.has(e));
    }
    ...
    renderCtaButton() {
        ...
        return (0, a.jsx)("div", { className: ch.od, children: i });
    }
    renderCodedLinks(e) {
    ...
    renderEmbed = (e, t, n, i) => {
        ...
        let m = cg.includes(e.type) ? e.url : (e.image?.url ?? e.video?.url);
        return (0, a.jsx)(
            nG.G.Provider,
            {
                value: (0, cu.b)(m, e.image, e.video, e.thumbnail, e.provider?.name),
    ...
    renderActivityInvite(e) {
        ...
        let { channel: t } = this.props;
        return (0, a.jsx)(cn, { channel: t, message: e, hideParty: !1 });
    }
    renderPublishBump(e) {
    ...
    renderThreadRoleMentionWarning(e) {
        if (
            ...
            !(Date.now() - sk.default.extractTimestamp(e.id) >= cp)
        )
            return (0, a.jsx)("div", { className: ch.xM, children: ec.intl.string(ec.t.ma8Rs0) });
    }
    ...
    renderInteractionPremiumUpsell(e) {
        ...
        return e.type !== u.l.INTERACTION_PREMIUM_UPSELL || null == t
            ? null
            : (0, a.jsx)(cs, { applicationId: t, guildId: this.props.channel.guild_id });
    }
    ...
    renderPoll(e, t) {
        if (null != t) return (0, a.jsx)(i7, { message: e, poll: t, className: ch.PM });
    }
    ...
    renderEditedTag(e, t) {
        return (0, a.jsx)(cc.A, { message: e, compact: t, location: cc.O.AFTER_ACCESSORIES });
    }
    render() {
...
function cE(e) {
    let t,
        ...
        o = nv.X6.useSetting(),
        d = nv.hD.useSetting(),
        c = nv.rs.useSetting() && !(0, sR.A)(e.message),
