...
(j.canUseDOM = H),
    (j.propTypes = { context: s().shape({ helmet: s().shape() }), children: s().node.isRequired }),
            ...
            (n.emitChange = function () {
                var e,
                    ...
                    s = {
                        ...
                        linkTags: C(E.LINK, ["rel", "href"], t),
                        metaTags: C(E.META, ["name", "charset", "http-equiv", "property", "itemprop"], t),
                        noscriptTags: C(E.NOSCRIPT, ["innerHTML"], t),
                        onChangeClientState: y(t, "onChangeClientState") || function () {},
                        scriptTags: C(E.SCRIPT, ["src", "innerHTML"], t),
                        styleTags: C(E.STYLE, ["cssText"], t),
                        title: N(t),
...
(Z.propTypes = {
    ...
    (Z.defaultProps = { defer: !0, encodeSpecialCharacters: !0, prioritizeSeoTags: !1 }),
