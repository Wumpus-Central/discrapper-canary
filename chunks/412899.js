...
function q(e) {
    ...
    return (0, r.jsx)(m.yRy, {
        ...
        renderPopout: (t) => {
            let { position: n } = t;
            return (0, r.jsx)(K, B(G({}, e), { position: null != n ? n : "top" }));
        },
        position: "top",
        align: "center",
        children: (e) =>
            (0, r.jsx)(m.tEY, {
                children: (0, r.jsx)(
                    "button",
                    B(G(B(G({ ref: l }, e), { className: o()(k.overflowButton, a) }), s), { children: "+".concat(n) }),
                ),
            }),
    });
}
function Q(e) {
    let t = i.useRef(null),
        ...
        E = (e) =>
            !(0, P.fI)(e) && !e.managed && w.Z.isRoleHigher(n, h, e) && (null == g || -1 === g.roles.indexOf(e.id));
    return (0, r.jsx)(m.yRy, {
        targetElementRef: t,
        renderPopout: (e) => {
            let { closePopout: t } = e;
