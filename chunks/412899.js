...
let B = l.forwardRef(function (e, t) {
    var s, a, o;
    let u,
        { canRemove: d, className: I, role: g, onRemove: h, guildId: p, disableBorderColor: S, onMouseDown: v } = e,
        D = (0, c.JA)(g.id),
        { tabIndex: b } = D,
        L = F(D, ["tabIndex"]),
        x = (0, R.p9)({
    ...
    return (0, r.jsx)(T.yRy, {
        ...
        children: (e) =>
            (0, r.jsx)(T.tEY, {
                children: (0, r.jsx)(
                    "button",
                    k(G(k(G({ ref: o }, e), { className: i()(w.overflowButton, s) }), a), { children: "+".concat(n) }),
                ),
            }),
    });
}
function H(e) {
    let t = l.useRef(null),
        { guild: n, user: s, handleAddRole: a, roleClassName: o, addButtonClassName: u, addButtonIconClassName: d } = e,
        E = (0, c.JA)("overflow-add-roles-".concat(s.id)),
        A = (0, _.e7)([f.Z], () => f.Z.roleStyle),
        m = x.Z.getHighestRole(n),
        I = b.ZP.getMember(n.id, s.id),
        g = (e) =>
            !(0, D.fI)(e) && !e.managed && x.Z.isRoleHigher(n, m, e) && (null == I || -1 === I.roles.indexOf(e.id));
    return (0, r.jsx)(T.yRy, {
        targetElementRef: t,
        renderPopout: (e) => {
            let { closePopout: t } = e;
        ...
        h = l.useCallback(
            (e) => {
                ...
                (null == (t = e.tags) ? void 0 : t.guild_connections) === null
                    ? I.Z.unassignGuildRoleConnection(s.id, e.id)
                    : S.Z.updateMemberRoles(s.id, n.id, r, [], [e.id]);
            },
            [a, s.id, n.id],
        ),
        O = l.useCallback(
