...
let z = i.forwardRef(function (e, t) {
    var a, s, l;
    let c,
        { canRemove: d, className: g, role: E, onRemove: O, guildId: I, disableBorderColor: S, onMouseDown: C } = e,
        N = (0, u.JA)(E.id),
        { tabIndex: R } = N,
        P = F(N, ["tabIndex"]),
        w = (0, T.p9)({
            ...
            Z(
                ...
                ),
                {
                    children: [
                        ...
                        null != w ? (0, r.jsx)(v.Z, Z(G({ className: j.roleIcon }, w), { enableTooltip: !1 })) : null,
                        (0, r.jsx)("div", {
                            "aria-hidden": !0,
...
function X(e) {
    let t = i.useRef(null),
        ...
        E = (e) =>
            !(0, N.fI)(e) && !e.managed && w.Z.isRoleHigher(n, m, e) && (null == g || -1 === g.roles.indexOf(e.id));
    return (0, r.jsx)(h.yRy, {
        targetElementRef: t,
        renderPopout: (e) => {
            let { closePopout: t } = e;
