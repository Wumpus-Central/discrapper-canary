...
let n = (e, a) => {
    switch (e) {
        ...
        case s.w7.PREMIUM_TENURE_6_MONTH:
            return d.NW.formatToPlainString(d.t.erUSmJ, { months: a });
        ...
        case s.w7.PREMIUM_TENURE_60_MONTH:
            return d.NW.formatToPlainString(d.t.IfYQVF, { years: a / 12 });
        case s.JN.PREMIUM_TENURE_72_MONTH:
        case s.w7.PREMIUM_TENURE_72_MONTH:
            return d.NW.formatToPlainString(d.t.IfYQVF, { years: '6+' });
        default:
            return null;
    }
};
