...
function O(e) {
    let t = e.toDate(),
        ...
        r = e.format("dddd"),
        i = [
            { id: "none", value: c.z.NONE, label: f.intl.string(f.t["0bK0B1"]) },
            { id: "weekly", value: c.z.WEEKLY, label: f.intl.formatToPlainString(f.t["B8/yfp"], { weekday: r }) },
            { id: "biweekly", value: c.z.BIWEEKLY, label: f.intl.formatToPlainString(f.t["z+aIuX"], { weekday: r }) },
            {
                id: "monthly",
                value: c.z.MONTHLY,
    ...
    return (
        N.has(t.getDay())
            ? o.default.getCurrentUser()?.isStaff() &&
              i.push({ id: "weekendOnly", value: c.z.WEEKEND_ONLY, label: f.intl.string(f.t.hRpynV) })
            : i.push({ id: "weekdayOnly", value: c.z.WEEKDAY_ONLY, label: f.intl.string(f.t["jYR/MY"]) }),
        i
    );
}
let R = () => {
    ...
    v = (e, t) => (0, l.i$)(e, e.get("years") === t.get("years") ? "ddd MMM Do \xb7 LT" : "ddd MMM Do, YYYY \xb7 LT");
function C(e, t, n) {
    var r;
    let i;
    null == n && (n = s()());
    ...
    return {
        ...
        endDateTimeString: null != o ? (u ? o.format("LT") : v(o, n)) : void 0,
...
function L(e, t) {
    ...
    let r = D((n = t).scheduled_start_time, n.scheduled_end_time),
        i = s()(d.default.extractTimestamp(e)),
...
function Y(e, t) {
    ...
    switch (n.options.freq) {
        ...
        case a.p3.MONTHLY:
            return c.z.MONTHLY;
        case a.p3.DAILY:
            if ((0, r.isEqual)(n.options.byweekday, F(e))) return c.z.WEEKDAY_ONLY;
            if ((0, r.isEqual)(n.options.byweekday, B(e))) return c.z.WEEKEND_ONLY;
            return c.z.NONE;
        default:
            return c.z.NONE;
    }
