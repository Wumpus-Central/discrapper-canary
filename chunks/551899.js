e.exports = function (e) {
    ...
    return {
        ...
        supersetOf: "sql",
        case_insensitive: !0,
        keywords: { keyword: i + a + s, built_in: u + c + d },
        ...
        contains: [
            ...
            { begin: "\\b(" + _ + ")\\s*\\(" },
            { begin: "\\.(" + l + ")\\b" },
            { begin: "\\b(" + l + ")\\s+PATH\\b", keywords: { keyword: "PATH", type: o.replace("PATH ", "") } },
            { className: "type", begin: "\\b(" + l + ")\\b" },
            ...
            { className: "symbol", begin: r, relevance: 10 },
        ],
    };
};
