...
let i = (function () {
            ...
            parse: function (t, i) {
                ...
                return (
                    ...
                    ("string" == typeof t
                        ...
                        : function (e, t) {
                              for (
                                  var i,
                                      ...
                                      g,
                                      A = (function e(t, n) {
                                          for (var i, r, s = t.childNodes, o = s.length; o--; )
                                              3 === (r = (i = s[o]).nodeType)
                                                  ? n.push(i)
                                                  : 1 !== r ||
                                                    "ownerSVGElement" in i ||
                                                    a.test(i.nodeName.toLowerCase()) ||
                                                    e(i, n);
                                          return n;
                                      })(e, []),
                                      I = A.length;
                                  ...
                                  for (
                                      ...
                                      if (
                                          ...
                                          for (r in (((p = new Image()).onerror = t.onerror),
                                          p.setAttribute("draggable", "false"),
                                          (i = t.attributes(E, m))))
                                              i.hasOwnProperty(r) &&
                                                  0 !== r.indexOf("on") &&
                                                  !p.hasAttribute(r) &&
                                                  p.setAttribute(r, i[r]);
                        ...
                        callback: i.callback || u,
                        attributes: "function" == typeof i.attributes ? i.attributes : _,
                        base: "string" == typeof i.base ? i.base : e.base,
                        ext: i.ext || e.ext,
                        size: i.folder || ("number" == typeof (r = i.size || e.size) ? r + "x" + r : r),
    ...
    function h(e, t) {
        for (var n = [], i = 0, r = 0, s = 0; s < e.length; )
            (i = e.charCodeAt(s++)),
                r
                    ? (n.push((65536 + ((r - 55296) << 10) + (i - 56320)).toString(16)), (r = 0))
                    : 55296 <= i && i <= 56319
                      ? (r = i)
