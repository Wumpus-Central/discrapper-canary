...
class N extends a.Z {
    ...
    setConnection(e) {
        ...
        null == (t = this.connection) || t.removeListener(o.Sh.LocalVideoDisabled, this.handleLocalVideoDisabled),
            null == (n = this.connection) || n.removeListener(o.Sh.LocalMute, this.handleLocalMute),
            null == (r = this.connection) || r.removeListener(o.Sh.ActiveSinksChange, this.delayedUpdate),
            (this.connection = e),
            null == (i = this.connection) || i.addListener(o.Sh.LocalVideoDisabled, this.handleLocalVideoDisabled),
            null == (a = this.connection) || a.addListener(o.Sh.LocalMute, this.handleLocalMute),
            null == (s = this.connection) || s.addListener(o.Sh.ActiveSinksChange, this.delayedUpdate),
            l && this.update();
    }
    setAudioSSRC(e, t) {
    ...
    reset() {
        this.setConnection(null, !1),
            ...
            (this.latestWants = O),
            m.w.off(m.e.IncomingVideoEnabledChanged, this.incomingVideoEnabledChanged);
    }
        ...
        super(),
            ...
            (this.update = function () {
                ...
                for (let [t, i] of _.default.entries(a.videoSsrcs)) {
                    ...
                    for (let e of (_ === g.Z.HIGH ? (o[p] = b) : _ === g.Z.LOW && (o[p] = 50),
                ...
                return A
                    ...
                    : (null == a.connection ||
                          ...
                          ((a.latestWants = o), a.emit("update", o)),
                      o);
            }),
            ...
            m.w.on(m.e.IncomingVideoEnabledChanged, this.incomingVideoEnabledChanged);
    }
}
