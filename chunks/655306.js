...
class C extends o.Z {
    ...
    setConnection(e) {
        ...
        null == (t = this.connection) || t.removeListener(a.Sh.LocalVideoDisabled, this.handleLocalVideoDisabled),
            null == (n = this.connection) || n.removeListener(a.Sh.LocalMute, this.handleLocalMute),
            null == (r = this.connection) || r.removeListener(a.Sh.ActiveSinksChange, this.delayedUpdate),
            (this.connection = e),
            null == (i = this.connection) || i.addListener(a.Sh.LocalVideoDisabled, this.handleLocalVideoDisabled),
            null == (o = this.connection) || o.addListener(a.Sh.LocalMute, this.handleLocalMute),
            null == (s = this.connection) || s.addListener(a.Sh.ActiveSinksChange, this.delayedUpdate),
            l && this.update();
    }
    setAudioSSRC(e, t) {
    ...
    reset() {
        this.setConnection(null, !1),
            ...
            (this.latestWants = O),
            h.w.off(h.e.IncomingVideoEnabledChanged, this.incomingVideoEnabledChanged);
    }
                        ...
                        if (i.length > 1) {
                            for (let t of i)
                                t.quality === b
                                    ...
                                    : e
                                      ? (a[t.ssrc] = y)
                                      : (c && (a[t.ssrc] = f), (_ = t.ssrc));
                            if (o.supportsSeamless && !o.framesReceived[_])
                                for (let e of ((u = !0), (s = [_]), i))
                                    e.ssrc !== _ &&
                                        o.framesReceived[e.ssrc] &&
                                        (e.quality === b ? (a[e.ssrc] = b) : (a[e.ssrc] = c ? f : r), s.push(e.ssrc));
                        } else e ? (a[_] = b) : c && (a[_] = f);
                    } else for (let e of i) a[e.ssrc] = y;
                    let p = o.getSimulcastOverrideQuality(t);
                    for (let e of (p === g.Z.HIGH ? (a[_] = b) : p === g.Z.LOW && (a[_] = 50),
                    (o.supportsSeamless && u) || (s = [_]),
                    i))
                        s.includes(e.ssrc) || delete o.framesReceived[e.ssrc];
                    (n.includes(t) || (void 0 !== o.remoteVideoSsrcs[t] && !(0, l.Z)(o.remoteVideoSsrcs[t], s))) &&
                        ((o.remoteVideoSsrcs[t] = [...s]), o.emit("user-ssrc-update", t, o.audioSsrcs[t], s));
                }
                for (let [e, n] of Object.entries(o.audioSsrcs))
                    (null == (t = o.connection) ? void 0 : t.getLocalMute(e)) && (a[n] = 0);
                return A
                    ? o.latestWants
                    : (null == o.connection ||
                          i().isEqual(o.latestWants, a) ||
                          ((o.latestWants = a), o.emit("update", a)),
                      a);
            }),
