            ...
            (0, i.r)(() => {
                e((e) => {
                    ...
                    let l = URL.createObjectURL(a),
                        r = { ...e.collectionAssets };
                    return (
                        (r[t] = { type: t, name: a.name, src: l }), { ...e, collectionAssets: r, previewEnabled: !0 }
                    );
                });
            }),
        deleteCollectionAsset: (t) =>
            (0, i.r)(() => {
                e((e) => {
                    ...
                    let { [t]: n, ...l } = e.collectionAssets,
                        r = Object.keys(l).length > 0 || Object.keys(e.avatarDecorationAssets).length > 0;
                    return { ...e, collectionAssets: l, previewEnabled: r };
                });
            }),
            ...
            (0, i.r)(() => {
                e((e) => {
                    ...
                    let n = URL.createObjectURL(t),
                        l = { ...e.avatarDecorationAssets };
                    return (
                        (l[t.name] = { type: c.Jn.AVATAR_DECORATION, name: t.name, src: n }),
                        { ...e, avatarDecorationAssets: l, previewEnabled: !0 }
                    );
                });
            }),
        deleteAvatarDecorationAsset: (t) =>
            (0, i.r)(() => {
                e((e) => {
                    ...
                    if (null == a) return e;
                    URL.revokeObjectURL(a.src);
                    let { [t]: n, ...l } = e.avatarDecorationAssets,
                        r = Object.keys(l).length > 0 || Object.keys(e.collectionAssets).length > 0;
                    return { ...e, avatarDecorationAssets: l, previewEnabled: r };
                });
            }),
        clearAssets: () =>
            (0, i.r)(() => {
