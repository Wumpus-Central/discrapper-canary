    ...
    let { applicationId: t, similarApplications: n, onSelectApplication: i, similarLoadId: o } = e,
        s = (function (e) {
            ...
            return (
                a.useEffect(() => {
                    r === t &&
                        (0, p.zZ)(m.rMx.APP_DIRECTORY_RECOMMENDATIONS_VIEWED, {
                            application_id: t,
...
function f(e) {
    var t, n, l;
    let { applicationId: o, similarApplication: c, onSelectApplication: h, position: _, similarLoadId: f } = e,
        v = (0, d.Z)({ application: c }),
        b = null === (t = c.categories) || void 0 === t ? void 0 : t[0],
        x = a.useMemo(
            () =>
