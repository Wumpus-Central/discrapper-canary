                                ...
                                typeof (s = h[u]) === a && s.length > 0
                                    ? 2 === s.length
                                        ...
                                        : 3 === s.length
                                          ...
                                          : 4 === s.length &&
                                            (this[s[0]] = l ? s[3].call(this, l.replace(s[1], s[2])) : n)
                                    : (this[s] = l || n);
                f += 2;
            }
        },
            ...
            return (
                (this.getBrowser = function () {
                    ...
                    return (
                        (e[l] = n),
                        (e[h] = n),
                        G.call(e, m, b.browser),
                        (e[s] = typeof (t = e[h]) === u ? t.replace(/[^\d\.]/g, "").split(".")[0] : n),
                        S && g && g.brave && typeof g.brave.isBrave == i && (e[l] = "Brave"),
                        e
                    );
                }),
                ...
                (this.getOS = function () {
                    ...
                    return (
                        ...
                        S &&
                            ...
                            _.platform &&
                            "Unknown" != _.platform &&
                            (t[l] = _.platform.replace(/chrome os/i, z).replace(/macos/i, P)),
                        t
                    );
                }),
