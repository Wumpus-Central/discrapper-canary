            ...
            useInjectEntriesWithPreviewData: (e) =>
                (function (e, t) {
                    let n = (0, A.A)(),
                        ...
                        v = r.useMemo(
                            () => [...new Set(T.filter((e) => e.extra.application_id in N).map((e) => e.author_id))],
                            [T, N],
                        ),
                        R = (0, a.cf)([d.A], () =>
                            Object.fromEntries(v.map((e) => [e, d.A.getUserIdentities(e)]).filter(E.QE)),
                        ),
                        O = (0, a.yK)([d.A], () => v.filter((e) => d.A.getFetchState(e) === d.e.NOT_FETCHED)),
                        b = (0, a.bG)([d.A], () => v.some((e) => d.A.isFetchingUser(e)));
                    r.useEffect(() => {
                        if (O.length > 0) for (let e of O) c.A.fetchUserApplicationIdentitiesWithProfiles(e);
                    }, [O]);
                    let D = (0, a.cf)([f.A], () =>
                            Object.fromEntries(v.map((e) => [e, f.A.getUserProfile(e) ?? null]).filter(E.QE)),
                        ),
                        L = (0, a.yK)([f.A], () =>
                            v.filter((e) => null == f.A.getUserProfile(e) && !f.A.isFetchingProfile(e)),
                        ),
                        w = (0, a.bG)([f.A], () => v.some((e) => f.A.isFetchingProfile(e)));
                    r.useEffect(() => {
