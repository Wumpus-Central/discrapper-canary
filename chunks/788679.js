...
function d(e) {
    let { channelId: t, messageId: n, mediaItemUrl: d, embedId: f, transitionState: g, onClose: m } = e,
        p = (0, s.K)(t, n, d),
        b = (0, s.b)(t, n, f),
        { reportFalsePositive: h, isReportFalsePositiveLoading: O } = (0, o.$)({
            onSuccess: () => (0, c.s)(m),
            onError: () => {
    ...
    return (
        ...
        (0, i.jsx)(c.$, {
            ...
            onConfirmPress: h,
            attachmentPreview: 1 === p.length && 0 === b.length ? p[0] : void 0,
            embedPreview: 1 === b.length && 0 === p.length ? b[0] : void 0,
            transitionState: g,
            onClose: m
        })
    );
