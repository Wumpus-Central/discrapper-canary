...
function t1(e) {
    let {
        ...
        h = (function (e) {
            ...
            let b = (0, th.V)()?.subscriptionTrial?.skuId === eG.pe.TIER_2,
...
function no(e) {
    let { shouldUpsellFromNoneTier: t } = e,
        n = (0, U.bG)([tA.default], () => tA.default.locale);
    return (0, r.jsxs)("div", {
        className: ns.mH,
        children: [
            (0, r.jsx)(na.A, {
            ...
            children: [
                ...
                (0, r.jsxs)(eg.c, {
                    children: [
                        ...
                        (0, r.jsx)(no, { shouldUpsellFromNoneTier: C }),
                    ],
                }),
                (0, r.jsx)(t7.j, {
...
function n1(e) {
    ...
    y)
        ? (0, r.jsx)(eK.dZ, { children: (0, r.jsx)(n0.A, {}) })
        : null;
}
function n2(e) {
    let {
        ...
        d = (0, nY.bG)([nK.Ay], () => nK.Ay.useReducedMotion),
        m = c.useRef(null),
        p = (0, S.t4)((e) => e.selectedSkuId),
        C = (0, nY.bG)([nq.A], () => nq.A.getProduct(p)),
        { confettiColors: h } = (0, nz.A)(C?.styles);
    return (
        c.useEffect(() => {
            t &&
                null != a &&
                  ...
                  children: [
                      ...
                      !e.hideConfetti &&
                          ...
                          (0, r.jsx)(nQ.A, {
                              ...
                              sprites: (0, n$.rA)(C?.categorySkuId),
...
function lm(e) {
    ...
    let [I] = E.items,
        A = (0, lo.VG)(E),
        g = null != o && o.id !== d?.id && E.type !== n5.R.BUNDLE && I.type !== n5.R.NAMEPLATE && !s;
    return (0, r.jsxs)("div", {
        className: i,
        children: [
            (0, r.jsx)("div", {
...
function lv(e) {
    ...
    let n,
        ...
        { displayNameSearchEnabled: m, affinityOrderingEnabled: p } = lC.useConfig({
                ...
                customMatchSorter: c.useMemo(
                    () =>
                        null == l
                            ? void 0
                            : (e, t) =>
                                  (0, lh.Ht)(e, t, { keys: ["label", (e) => l.get(e.value)?.names ?? []] }).map((e) => {
                                      let n = l.get(e.value);
                                      if (null == n) return e;
                                      let i = (function (e, t) {
                                          let n = (0, lE.HI)(t);
                    ...
                    return (
                        ...
                        }),
                        {
                            ...
                            renderRightColumn: function () {
                                let e = (0, n6.pA)({ invoicePreview: C, selectedSkuId: p, skusById: h });
...
var lF = n(809029),
    ...
    lX = n(795791);
function l0(e, t) {
    return !e && t === eG.pe.TIER_2 && !lJ.Ct && !lJ.KY && null == (0, lX.uM)();
}
var l1 = n(771566),
    l2 = n(625494),
    l3 = n(45938),
...
function l5(e) {
    let t,
        ...
        K = (0, U.bG)([l$.A], () => l$.A.getGiftPromotion()?.id),
        V = (0, U.bG)([l$.A], () => {
            ...
            if (A)
                if (null != y && y.hasAnyPremiumGroup) {
                    ...
                    (0, nS.openModalLazy)(
                        async () => {
                            ...
                            return (t) =>
                                (0, r.jsx)(e, {
                                    ...
                                    onClose: async () => {
                                        (l2._.dispatch(eB.jej.PREMIUM_GROUP_PURCHASE_FLOW_COMPLETED),
                                            await t.onClose());
                                    },
                                });
                        },
                        {
                            onCloseRequest: () => {
                                (l2._.dispatch(eB.jej.PREMIUM_GROUP_PURCHASE_FLOW_COMPLETED), (0, nS.closeModal)(e));
                            },
                            modalKey: e,
                        },
                    );
                ...
                null != q && q > 0
                    ...
                    : l0(N, h) && (X?.id === lQ.Ym || X?.name?.includes(lQ.YX)) && (0, lQ.tu)();
        }
        return (
            l2._.subscribe(eB.jej.WOW_MOMENT_CONFIRMATION_MODAL_CLOSED, e),
            () => {
                l2._.unsubscribe(eB.jej.WOW_MOMENT_CONFIRMATION_MODAL_CLOSED, e);
            }
        );
    }, [A, y, q, X, N, h, C, D, G]),
        c.useEffect(() => {
            !N || null == b || null == j || R || M || (0, l3.Ik)(b) || L({ onSubscriptionConfirmation: a });
        }, [L, N, b, j, R, M, a]),
        c.useEffect(() => {
            B &&
                null != V &&
                null != K &&
                (0, lK.qr)(lH.M.GIFTING_PROMOTION_REMINDER, K, { dismissAction: l6.i.INDIRECT_ACTION });
        }, [V, K, B]));
    let ee = null != m ? l1.Rs.DEEPLINK_TO_DESKTOP_APP : void 0;
    if (null != s) t = s(x, J, y);
    else if (N) t = (0, r.jsx)(l1.fw, { planId: x.id, onClose: J, shouldUsePostPurchaseRecipientDelivery: W });
    else {
        let e =
            g === x.id
                ? { postSuccessGuild: o }
    ...
    return (0, r.jsxs)(r.Fragment, {
        children: [
            (0, r.jsxs)(eK.dZ, { children: [(0, r.jsx)(n0.A, {}), t] }),
            null != F && F,
            Q && (0, r.jsx)(l7, { rewardSkuIds: w, onClose: J, onRewardModalClose: D }),
        ],
    });
}
let [l8, l9] = (0, d.A)(),
    ie = {
        ...
        TENANT_PROVIDER_CONFIGS: {
            CustomTenantProvider: (e) => {
                ...
                return (0, r.jsx)(l8.Provider, { value: i, children: (0, r.jsx)(u.Qt, { children: l }) });
            },
            tenantProvidesCheckoutRoot: !1,
        },
        CustomHeaderComponent: function (e) {
            let { onClose: t, step: n } = e,
                { guildId: l, listing: i } = l9();
            return (0, r.jsx)(lB.Y, { onClose: t, listing: i, step: n, guildId: l });
        },
        CUSTOM_CONFIRM_STEP_CONFIG: {
            renderStep: (e) => (0, r.jsx)(l5, { ...e }),
    ...
    return null == S
        ...
        : ((0, lr.T)(S)
              ? ((n = n5.R.AVATAR_DECORATION),
                (t = (0, r.jsx)(im.i, { item: S, user: i, isHighlighted: f, avatarSize: le._3.SIZE_96 })))
              : (0, id.F)(S) &&
                ((n = n5.R.NAMEPLATE),
                (t = (0, r.jsx)(ip.A, { nameplate: S, user: i, isHighlighted: f, size: "small" }))),
          (0, r.jsxs)(io.s, {
              ref: p,
              "aria-label": E.name ?? "",
              onClick: function () {
              ...
              className: e3()(iC._x, { [iC.Vp]: !a, [iC.mr]: f, [iC.md]: o }),
              children: [
                  (0, r.jsx)("div", {
                      className: e3()(iC.VH, { [iC._Q]: n === n5.R.AVATAR_DECORATION, [iC.M4]: n === n5.R.NAMEPLATE }),
                      children:
                          null != t
                              ? (0, r.jsxs)(r.Fragment, {
                                    children: [
                                        (0, r.jsx)("div", { className: e3()(iC.i1, { [iC.r9]: a || u }), children: t }),
                                        a &&
                                            (0, r.jsx)(iu.r, {
                                                size: "custom",
                                                width: 48,
...
function iy(e) {
    ...
    return (0, r.jsx)(iE.H, {
        leading: !p && a && null != i ? (0, r.jsx)(iS.A, { onClick: i }) : void 0,
        actions: P,
        actionsFullWidth: p,
    });
}
...
function iA(e) {
    ...
    return (0, r.jsxs)(r.Fragment, {
        children: [
            ...
            (0, r.jsx)(eg.c, { children: (0, r.jsx)("div", { className: iI.Dq, children: _ }) }),
            x,
        ],
    });
}
function ig(e) {
    ...
    function A(e) {
        1 === C ? s([e]) : u.includes(e) ? s(u.filter((t) => t !== e)) : u.length >= C || s([...u, e]);
    }
    c.useEffect(() => {
    ...
    return (0, r.jsxs)(r.Fragment, {
        children: [
            ...
            (0, r.jsx)(eg.c, { children: (0, r.jsx)("div", { className: iI.Dq, children: P }) }),
            v,
        ],
    });
}
...
function iM(e) {
    let { className: t } = e,
        ...
        { claimableRewards: l } = (0, nL.Pv)(),
        i = Math.min(
            (0, S.t4)((e) => e.quantity),
            l?.length ?? 0,
        ),
        a = (0, tT.T)(n?.asset),
        s = (0, tT.T)(n?.backgroundAsset),
        o = (0, U.bG)([l$.A], () => l$.A.getGiftPromotion()),
        u = (0, iN.dA)(o?.endDate),
        c = (0, lZ.gc)(s);
    return (null != c && ((c.backgroundSize = "cover, auto"), (c.backgroundPosition = "right center, 0% 0%")),
    null == n || null == l || 0 === l.length)
        ? null
        : (0, r.jsx)(iO, {
              className: t,
              graphic: (0, r.jsx)(ib.A, {
                  claimableRewards: l,
                  maxRewardImageSrc: a ?? "",
                  size: le._3.SIZE_40,
                  imageScaling: 1.25,
...
let iW = function (e) {
    let { className: t } = e,
        n = (0, iG.A)(),
        { avatarSrc: l, eventHandlers: i } = (0, iD.A)({ userId: n?.id, size: le._3.SIZE_32, animateOnHover: !0 }),
        a = (0, iU.DP)(),
        s = (0, ik.q)(a),
        o = ly.Ay.getName(n);
    return null == n
        ...
        : (0, r.jsxs)("div", {
              ...
              children: [
                  (0, r.jsx)("div", {
                      className: iH.H,
                      children: (0, r.jsx)(iw.eu, { src: l, "aria-label": n.username, size: le._3.SIZE_32, ...i }),
                  }),
                  (0, r.jsx)(y.E, {
                  ...
                  (0, r.jsx)(s ? iF : iB, { className: iH.q3 }),
              ],
          });
};
var iY = n(73663),
    ...
    iQ =
        ...
        (l.ERROR = "error"),
        l),
    i$ = (((i = i$ || {}).SMALL = "small"), (i.LARGE = "large"), (i.NONE = "none"), i);
let iJ = { primary: iz.cG, secondary: iz.QU, warning: iz.SO, error: iz._r },
    iX = { small: iz.EX, large: iz.as, none: null };
class i0 extends c.PureComponent {
    static Colors = iQ;
    static Sizes = i$;
    render() {
        let { icon: e, color: t, children: n, iconSize: l, className: i, iconClassName: a } = this.props;
        return (0, r.jsxs)(iq.A, {
            className: e3()(iz.N4, iJ[t], i),
            align: iq.A.Align.CENTER,
            children: [
                (0, r.jsx)(e, { className: e3()(iz.Kk, iX[l], a), color: "currentColor" }),
...
function i2(e) {
    ...
    return !n || (0, l3.Ik)(l)
        ...
        : (0, r.jsx)(i0, {
              className: i1.z,
              iconSize: i0.Sizes.SMALL,
              icon: iZ.GiftIcon,
              color: null == t ? i0.Colors.PRIMARY : i0.Colors.SECONDARY,
              children: t,
          });
}
var i3 = n(577381),
...
function i7(e) {
    let { handleStepChange: t, initialPlanId: n, planGroup: l, subscriptionTier: i, trialId: a, handleClose: s } = e,
        ...
        b = (0, il.p)("PremiumPaymentPlanSelectStep"),
        j = (0, lZ.Mq)(A),
        R = (0, nY.bG)([l$.A], () => {
            let e = l$.A.getMarketingComponentByType(tP.C.GIFT_CUSTOMIZATION_BANNER);
            return null != e && "giftCustomizationBanner" === e.properties.properties.oneofKind;
    ...
    M
        ? (B = b
              ? (0, r.jsx)("div", {
                    className: e3()(i4.RC, i4.oq, F ? i4.ek : i4.lz),
                    children: (0, r.jsx)(iM, { className: i4.j2 }),
                })
              : (0, r.jsx)(iM, {}))
        : w &&
          (B = (0, r.jsx)("div", {
              className: e3()(i4.RC, F ? i4.ek : i4.lz),
    ...
    let el = (0, i3.i)({ planSkuId: Z?.skuId, invoice: $ }),
        ...
        eo = c.useMemo(
            ...
            [m, A?.id, l, $?.subscriptionPeriodEnd, M, s],
        );
    if (en) return (0, r.jsx)(v.Ed, { className: i4.QW });
    (ez()(null != g, "Step should be set"), ez()(m.length > 0, "Premium plan options should be set"));
    let eu = P
        ? (0, r.jsx)(iY.$p, { ...eo })
        : (0, r.jsx)(iV.X, { ...eo, isInPlanSelectStep: !0, showPlanStatusSubText: !0 });
    return (0, r.jsxs)(r.Fragment, {
        children: [
            (0, r.jsx)(i2, { giftMessage: x }),
            !(P && (0, l3.Ik)(_)) && (0, r.jsx)(iK.A, { isEligibleForTrial: p }),
            (0, r.jsxs)(eK.dZ, {
                children: [
                    !b && es,
                    (0, r.jsx)(n0.A, { className: i4.tg }),
                    et ? (0, r.jsx)(eQ.w, { type: "critical", children: X }) : eu,
                    !b &&
                        ee &&
                        (0, r.jsxs)(r.Fragment, {
                            children: [
                                (0, r.jsx)("hr", { className: e3()(i4.IM, i4.Go) }),
                                (0, r.jsx)(y.E, {
    ...
    return (0, r.jsx)(rn, {
        selectSku: (e) =>
            (function (e) {
                ...
                let p = c({ isTrial: (0, i9.t)({ userTrialOffer: a, isGift: r, skuId: n }), selectedSkuId: n });
                (d !== o.pn.WHAT_YOU_LOSE && p && ((d = o.pn.REVIEW), s((0, i8.x)(n, t, u))),
            ...
            footer: (0, r.jsxs)(rl.e, {
                ...
                children: [
                    (0, r.jsx)(eJ.$, {
                        ...
                        text: H.intl.string(H.t["3PatSz"]),
                        onClick: () => {
                            s ? (i((0, i8.x)(l, a)), t(o.pn.REVIEW)) : t(o.pn.PLAN_SELECT);
                        },
                    }),
...
let rs = [
        ...
        },
        {
            ...
            renderStep: (e) => (0, r.jsx)(iP, { ...e }),
            options: { modalSizeGetter: () => "lg", hideDefaultModalBody: !0 },
        },
    ],
    ro = {
        CustomHeaderComponent: ra.kc,
        ...
        TENANT_PROVIDER_CONFIGS: {
            ...
            CustomTenantProvider: (e) => {
                let {
                    ...
                    y = (0, ii.Sq)() ? eG.gD.PREMIUM_MONTH_TIER_2 : void 0,
                ...
                let g = (0, ia.tA)({ giftRecipient: A, isGift: I ?? !1 }),
                    P = c.useMemo(
                        () =>
                            g
                                ? p.map((e) =>
            ...
            TenantPaymentModalRenderer: (e) => {
                ...
                c.useEffect(() => {
                    eU.A.isLoadedForPremiumSKUs() || nU.h.wait(() => (0, it.zS)());
                }, []);
                let {
                        selectedSkuId: u,
                        selectedPlanId: d,
                    ...
                    p = (0, ea.s2)(),
                    { isGift: C, giftRecipient: h } = (0, nL.Pv)(),
                    f = (0, lV.Wh)({ location: "PremiumPaymentModalRenderer" }),
                    E = (0, il.p)("PremiumPaymentModalRenderer"),
                    y = p === o.pn.CONFIRM && f && (0, lq.M)({ isGift: C, giftRecipient: h, selectedPlanId: d }),
                    I = l0(C, u),
                    A = m === ed.h.PURCHASING;
                return (0, r.jsx)(is.A, {
        ...
        : (0, r.jsxs)("div", {
              ...
              children: [
                  ...
                  (0, r.jsx)(nv.D, {
                      ...
                      children: (0, r.jsx)(n_.P, { size: "md", color: "currentColor", className: rC.ut }),
                  }),
              ],
          });
}
function rE(e) {
    ...
    return null == i
        ...
        : (0, r.jsx)("div", {
              className: rC.RP,
              children: (0, r.jsxs)(rm.$K, {
                  children: [
                      (0, r.jsx)(rm.KF, { application: i, asset: t }),
                      (0, r.jsx)(rm.kj, { children: a }),
                      (0, r.jsx)(rm.ri, {}),
                      (0, r.jsx)(rm.Mx, { title: s, description: o }),
                      (0, r.jsx)(rm.iH, { applicationId: i.id, storeListingBenefits: n, skuBenefits: l }),
                  ],
              }),
          });
}
function rS(e) {
    ...
    return (0, r.jsxs)("div", {
        className: rC.NV,
        children: [
            (0, r.jsx)("img", { src: rh, alt: "", width: 300, height: 126 }),
            (0, r.jsx)(tt.D, {
                className: rC.i1,
            ...
            (0, r.jsx)(eK.UX, {
                children: (0, r.jsx)(rd.Ay, {
                    onPrimary: n,
                    primaryCTA: rd.ti.CONTINUE,
...
function rg(e) {
    ...
    return (0, r.jsx)(rI.Provider, { value: s, children: l });
}
n(938796);
var rP = n(266060),
    rv = n(163437),
...
function rT(e) {
    ...
    return (0, r.jsxs)("div", {
        className: rx.RP,
        children: [
            (0, r.jsx)(tt.D, { className: rx.RS, variant: "heading-lg/extrabold", children: l }),
            null != i
                ? (0, r.jsx)(y.E, { className: rx.sT, variant: "text-sm/normal", color: "text-default", children: i })
                : null,
            (0, r.jsxs)("div", {
                className: rx.UD,
                children: [
                    s &&
                        (0, r.jsx)(eJ.$, {
                            ...
                            fullWidth: !0,
                            onClick: () => (0, r_.A)("application_sub_mweb_success_modal"),
                        }),
...
function rb(e) {
    let { handleStepChange: t, handleClose: n } = e,
        l = (0, rP.K)(),
        { subscriptionMetadataRequest: i } = rA(),
...
function rR(e) {
    let t,
        ...
        m = (0, nZ.S3)(),
        p = (0, rc.A)(rp),
        { createMultipleConfettiAt: C } = c.useContext(rj.x),
        h = m?.name ?? "";
    function f() {
        (l(), i?.());
    }
    ...
    return (
        A
            ? (t = p
                  ? (0, r.jsx)(rN, { tierName: h, onConfirm: f, subscription: d })
                  : (0, r.jsx)(rS, { tierName: h, onConfirm: f, subscription: d }))
            : p
              ? (t = (0, r.jsx)(rT, {
        ...
        c.useEffect(() => {
            nK.Ay.useReducedMotion && E && C(window.innerWidth / 2, window.innerHeight / 2);
        }, [C, E]),
        (0, r.jsxs)(r.Fragment, {
            children: [
                (0, r.jsxs)(eK.dZ, { children: [(0, r.jsx)(n0.A, {}), t] }),
...
let rw = (e) => {
    ...
    rU = {
        ...
        CUSTOM_PREDICATE_STEP_CONFIG: { renderStep: (e) => (0, r.jsx)(rM, { ...e }) },
        CustomHeaderComponent: function (e) {
            let { step: t, onClose: n } = e,
                l = c.useCallback(() => n(!1), [n]);
            return (0, r.jsx)(rf, { step: t, onClose: l });
        },
        STEPS_BEFORE_CHECKOUT: [
            {
                key: o.pn.BENEFITS,
                renderStep: (e) => (0, r.jsx)(rb, { ...e }),
        ...
        CHECKOUT_STEPS: {
            [o.pn.REVIEW]: function (e) {
                let { handleStepChange: t, planGroup: n, openInvoiceId: l, analyticsData: i, analyticsLocation: a } = e,
                    ...
                    { subscriptionMetadataRequest: C, showBenefitsFirst: h } = rA(),
                        ...
                        (e) => {
                            (r(e),
                                e &&
                                    ...
                                    (0, ru.f5)(i),
                                    null != a && a(),
                                    null != i && (l || ry.A.getGuildId() !== i) && (0, lO.pX)(eB.BVt.CHANNEL(i))));
                        },
                        [r, a, l, i],
                    );
        ...
        CUSTOM_CONFIRM_STEP_CONFIG: { renderStep: (e) => (0, r.jsx)(rR, { ...e }) },
    };
var rD = n(237412),
    rG = n(869038),
    rF = n(852218),
...
function rK(e) {
    ...
    c.useEffect(() => {
        (u ||
            (0, l3.GM)(t, !1, !0)
                .then((e) => {
                    let t = rB.A.createFromServer(e);
                    (p(t), d(!0), E(t.promotion?.promotionType === rF.pt.THIRD_PARTY_DIRECT_FULFILLMENT));
                })
                .catch((e) => {
                    (h(e), d(!0));
                }),
    ...
    let A = (0, eb.p)(),
        ...
        Y = c.useCallback(async () => {
            ...
            try {
                return (
                    await rG.Ay.redeemGiftCode({ code: t, options: { paymentSource: e } }),
                    N(ed.h.COMPLETED),
...
function rQ(e) {
    ...
    return (0, r.jsx)(y.E, {
        ...
        children: H.intl.format(H.t["TcA3+W"], {
            ...
            logoutHook: () => {
                rV.A.logout("inbound_promotion_redemption_modal", eB.BVt.BILLING_PROMOTION_REDEMPTION(n));
            },
        }),
    });
}
    ...
    return (0, r.jsxs)("div", {
        ...
        children: [
            (0, r.jsxs)("div", {
                className: rq.u5,
                children: [
                    (0, r.jsx)("img", { alt: "", src: s, className: rq.hb }),
                    (0, r.jsxs)("div", {
                        children: [
                            (0, r.jsx)(tt.D, {
            ...
            l || null == i ? null : (0, r.jsx)(rQ, { className: rq.KZ, user: i, code: n }),
        ],
    });
}
function rJ(e) {
    ...
    return (0, r.jsxs)(r.Fragment, {
        children: [
            (0, r.jsxs)("div", {
                className: rq.t4,
                children: [
                    (0, r.jsx)("img", { alt: "", src: rz, className: rq.M6 }),
                    (0, r.jsx)(tt.D, { variant: "heading-lg/semibold", className: rq.DD, children: t }),
                    (0, r.jsx)(y.E, { variant: "text-md/normal", className: rq.G3, children: n }),
                    null != l
                        ? (0, r.jsx)(y.E, {
                              variant: "text-md/normal",
                              className: rq.G3,
                        ...
                        : null,
                    i && null != a ? (0, r.jsx)(rQ, { className: rq.EF, user: a, code: s }) : null,
                ],
            }),
...
function r0(e) {
    let { plan: t, isDirectFulfillment: n, addPaymentMethodStepState: l, handleClose: i } = rY();
    ...
    return (0, r.jsxs)(r.Fragment, {
        children: [
            (0, r.jsx)(eK.dZ, {
                children: (0, r.jsx)(l1.Ay, { hideClose: !0, planId: t.id, onClose: i, paymentSourceType: o }),
            }),
            n
                ? (0, r.jsx)(eK.UX, {
                      children: (0, r.jsx)(iE.H, {
...
function r1(e) {
    let { handleStepChange: t } = e,
        { promotion: n, code: l, isDirectFulfillment: i } = rY();
    return (
        ez()(null != n, "Missing promotion"),
        (0, r.jsxs)(r.Fragment, {
            children: [
                (0, r.jsx)(eK.dZ, { children: (0, r.jsx)(r$, { promotion: n, code: l, isDirectFulfillment: i }) }),
                (0, r.jsx)(eK.UX, {
                    children: (0, r.jsx)(eo.lo, {
...
var r2 = n(732159),
    r3 = n(262427),
    r4 = n(134638);
let r7 = { headerBadgePreset: "trial" };
function r6(e) {
    let {
            plan: t,
    ...
    let m = i
            ? [{ key: "fractional-premium-notice", directContent: (0, r.jsx)(r5, { fractionalPremiumInfo: a }) }]
            : null,
        p = (0, r.jsx)(r8, { plan: t, renewalInvoicePreview: n }),
        C = (0, r.jsx)(r9, { renewalInvoicePreview: n, subscriptionTrial: l });
    return (0, r.jsx)(v.T_, {
        shouldShowGlobalNotices: !0,
        headerBadgeConfig: r7,
            ...
            [o.pn.REVIEW]: function (e) {
                ...
                let L = c.useCallback(async () => {
                        ...
                        null == A || m || null == i || null == a
                            ...
                            : (0, nS.openModal)((t) => {
                                  let n;
                                  if (null == x) n = (0, r.jsx)(tr.y, { className: rq.wG });
                                  else {
                                  ...
                                  return (0, r.jsx)(r2.ConfirmModal, {
                                      onConfirm: async () => {
                                          (p(!0), (await d()) && e());
                                      },
                            ...
                            (0, r.jsx)(eK.UX, {
                                children: (0, r.jsx)(eo.lo, {
                                    ...
                                    primaryButtonProps: {
                                        ...
                                        variant: (0, rd.CY)(rd.ti.PURCHASE),
                                    },
                                }),
                            }),
                        ],
        ...
        TENANT_PROVIDER_CONFIGS: {
            ...
            CustomTenantProvider: (e) => {
                ...
                return (0, r.jsx)(ei.M, {
                    ...
                    children: (0, r.jsx)(u.Qt, { children: (0, r.jsx)(rK, { code: t, onClose: i, children: a }) }),
                });
            },
            TenantPaymentModalRenderer: (e) => {
                let { originalPaymentModalProps: t, renderPaymentModal: n } = e;
    ...
    return (0, r.jsxs)(eK.dZ, {
        children: [
            ...
            (0, r.jsxs)("div", {
                className: al.EL,
                children: [
                    (0, r.jsx)(tt.D, { variant: "heading-xxl/bold", className: al.RS, children: "Success!" }),
                    (0, r.jsx)(y.E, { variant: "text-md/normal", children: u }),
                    (0, r.jsx)("div", { className: al.yF }),
...
let au = {
    ...
    CHECKOUT_STEPS: {
        [o.pn.GIFT_CUSTOMIZATION]: (e) => {
            let { customGiftMessage: t = "", setCustomGiftMessage: n, giftRecipient: l } = (0, nL.Pv)(),
                ...
                o = (0, U.bG)([ar.A], () => (null != i ? ar.A.get(i) : null), [i]),
                u = lT(),
                d = (0, U.bG)([aa.A], () => (null != i ? aa.A.getForSKU(i) : null), [i]),
                m =
                    d?.headerBackground != null && o?.applicationId != null
                        ? (0, as.YE)(o.applicationId, d.headerBackground, 256)
                        : void 0;
                ...
                renderLeftColumn: function () {
                    return (0, r.jsxs)("div", {
                        ...
                        children: [
                            ...
                            null != m && (0, r.jsx)("img", { src: m, alt: o?.name ?? "", className: ao.LC }),
                        ],
                    });
                },
                renderRightColumn: function () {
                    return (0, r.jsxs)("div", {
                        className: ao.P6,
                        children: [
                            (0, r.jsx)(l_, { recipients: u, selectedSkuId: i, validateSelectedGift: p }),
                            (0, r.jsx)(lj.A, {
                                onTextChange: (e) => n?.(e),
                                pendingText: t,
                                currentText: t,
    ...
    CUSTOM_CONFIRM_STEP_CONFIG: { renderStep: (e) => (0, r.jsx)(ai, { ...e }) },
    TENANT_PROVIDER_CONFIGS: {
...
function ay(e) {
    ...
    let m = i.find((e) => e.sku_id === l),
        p = (0, ap.G)(m, { isGift: o });
    return (c.useEffect(() => {
        o || ((0, ah.j)(), t(), (0, aC.n)({ sku: d, application: a, analyticsLocations: n, entitlement: m }));
    }, [o, d, a, t, n, m]),
    o)
        ? (0, r.jsxs)(eK.dZ, {
              children: [
                  ...
                  (0, r.jsxs)("div", {
                      ...
                      children: [
                          (0, r.jsx)("div", {
                              className: aS.KD,
                              children: (0, r.jsx)(af.default, {
                                  imageUrl: (0, am.fq)(d) ?? void 0,
                                  backgroundImageUrl: (0, am.xf)(d),
                                  altText: d.name,
                          ...
                          null != p &&
                              (0, r.jsx)("div", {
                                  className: aS.Is,
                                  children: (0, r.jsx)(aE.O0, { Icon: p.Icon, text: p.text }),
                              }),
                          (0, r.jsx)("div", {
                              className: aS.UD,
                              children: (0, r.jsx)(eJ.$, {
...
function ak(e) {
    let { handleClose: t, sku: n, application: l } = e,
        i = c.useCallback(() => {
            (0, aj.G)({ applicationId: n.applicationId });
        }, [n.applicationId]),
        a = c.useCallback(() => {
            t();
            ...
            (0, am.uV)({
                ...
                ((0, nS.closeAllModals)(),
                (0, aj.default)({ applicationId: n.applicationId, pageIndex: e ?? 0, skuId: n.id, slug: n.slug }));
...
let aw = {
                ...
                { renderStepBody: l, disabled: i } = (function (e) {
                    ...
                    let n,
                        ...
                        P =
                            ...
                            (n = lT()),
                            (l = (function (e) {
                                let t = (0, U.bG)([ax.A], () => (ax.A.isConnected() ? ax.A.getChannelId() : null)),
                                    [n, l] = c.useState([]);
                                return (
                                    c.useEffect(() => {
                                        let n = null != t ? ag.A.getParticipants(t) : [],
                                            i = [],
                                            r = new Set();
                                        for (let t of n)
                                            (!(0, aO.Xw)(t) && !(0, aO.Ay)(t)) ||
                            ...
                            (i = (0, U.yK)([F.default], () => E?.map(F.default.getUser).filter(aT.Vq) ?? [], [E])),
                            c.useMemo(
                                () =>
                                    lg().uniqWith(
                                        [...(null != d ? [d] : []), ...i, ...l, ...n],
                        ...
                        v = (0, U.bG)([ar.A], () => (null != I ? ar.A.get(I) : null), [I]),
                        { userPrice: _ } = (0, a_.CD)({ sku: v, priceSetAssignmentPurchaseType: eB.lid.GIFT }),
                        x = (0, ab.D)({ surface: "gift_customization", applicationId: A?.id, skuId: v?.id }),
                        T = (0, am.fq)(v),
                        N = (0, am.xf)(v);
                        ...
                        return (0, r.jsxs)("div", {
                            ...
                            children: [
                                ...
                                (0, r.jsxs)("div", {
                                    className: aL._T,
                                    children: [
                                        (0, r.jsx)(av.A, { sound: p, onSelect: j }),
                                        (0, r.jsx)(aP.A, {
                                            setEmojiConfetti: C,
                    ...
                    function M() {
                        return (0, r.jsxs)("div", {
                            ...
                            children: [
                                              ...
                                              (0, r.jsxs)("div", {
                                                  ...
                                                  children: [
                                                      ...
                                                      (0, r.jsxs)("div", {
                                                          className: aL.vz,
                                                          children: [
                                                              null != A && (0, r.jsx)(aR.Q, { application: A }),
                                                              (0, r.jsx)(y.E, {
                                ...
                                null != v && (0, r.jsx)(ak, { handleClose: s, sku: v, application: A }),
                            ],
                        });
                    }
                    return {
                        renderStepBody: function () {
                            return (0, r.jsxs)("div", { className: aL.Du, children: [R(), M()] });
                        },
    ...
    CUSTOM_CONFIRM_STEP_CONFIG: { renderStep: (e) => (0, r.jsx)(ay, { ...e }) },
    TENANT_PROVIDER_CONFIGS: {
        tenantProvidesCheckoutRoot: !0,
        CustomTenantProvider: (e) => {
            ...
            return (
                !(function (e) {
                    let { applicationId: t, skuId: n } = e,
                        l = (0, ac.h)(t);
                    c.useEffect(() => {
                        null == l || null == n || ar.A.isFetching(n) || null != ar.A.get(n) || (0, ad.Pp)(l.id, n);
                    }, [l, n]);
...
function a0(e) {
    let { sku: t, orbPriceAmount: n } = e,
        { product: l, isSocialLayerGameItem: i } = (0, aJ.AO)({ sku: t }),
        a = (0, a$.oO)(l);
    i ? (a = H.intl.string(Z.default.qwSlCO)) : (0, aH.Ab)(l) && (a = H.intl.string(H.t["0TmQRG"]));
    let s = (0, a$.dL)(t),
        o = (0, nF.EZ)(t.id) ? az.m[t.id].render({ className: aX.$ }) : (0, r.jsx)(tw.WH, { sku: t, product: l });
    return (0, r.jsx)(tw.f7, { label: s, description: a, graphic: o, price: null != n ? `${n}` : "", PriceIcon: aq.C });
}
function a1(e) {
    let { skuId: t, orbPriceAmount: n } = e;
    (0, aQ.c)({ applicationId: (0, aY.P)(t), skuIDs: [t] });
    let l = (0, nY.bG)([ar.A], () => ar.A.get(t), [t]);
    return null == l
        ? (0, r.jsx)(tr.y, { type: tr.y.Type.PULSING_ELLIPSIS })
        : (0, r.jsx)(a0, { sku: l, orbPriceAmount: n });
}
function a2(e) {
    let { orbBalance: t } = e;
    return (0, r.jsx)(G.vW, { label: H.intl.string(H.t.y0WGqP), value: null != t ? `${t}` : "", Icon: aq.C });
}
function a3() {
...
function a6() {
    return (0, c.useContext)(a7);
}
let a5 = { payment_gateway: tG.kM.VIRTUAL_CURRENCY, currency: eB.Yri.DISCORD_ORB },
    a8 = {
            ...
            [o.pn.REVIEW]: (e) => {
                let { handleStepChange: t } = e,
                    { primaryButtonProps: n, ...l } = (function (e) {
                        let { handleStepChange: t } = e,
                            { isRedeeming: n, skuId: l, skuApplicationId: i } = a6(),
                            { enabled: a } = aG.A.useConfig({ location: "orb_checkout_review_step" }),
                            ...
                            }),
                            {
                                ...
                                return {
                                    ...
                                    errorMessage: (0, c.useMemo)(() => (0, aV.$9)(l, p), [l, p]),
                                    orbPriceAmount: I,
                            ...
                            f = (0, aU.uS)(i),
                            {
                                ...
                                return { disabled: i, tooltipText: r, text: a3() };
                        ...
                        return {
                            ...
                            purchaseItemContent: (0, r.jsx)(a1, { skuId: l, orbPriceAmount: a ? u : m }),
                            paymentMethodContent: (0, r.jsx)(a2, { orbBalance: p }),
                            legalContent: (0, r.jsx)(a4, {}),
                            primaryButtonProps: A,
                            invoiceSummaryContent: null,
        ...
        TENANT_PROVIDER_CONFIGS: {
            ...
            CustomTenantProvider: (e) => {
                let { skuId: t, loadId: n, analyticsSourceLocation: l, children: i } = e,
                    { order: a, setOrder: s } = (0, S.t4)((e) => ({ order: e.order, setOrder: e.setOrder })),
                    {
                        ...
                        let { skuId: t, loadId: n, onCheckoutSuccess: l, onSignFailure: i, order: r } = e,
                            ...
                            s = (0, U.bG)([ar.A], () => ar.A.get(t), [t]),
                            o = null != s ? s.productLine : null,
                            u = s?.applicationId ?? (0, aY.P)(t),
                            d = (0, a_.JL)({ sku: s }),
                            { product: m } = (0, li.q)(t),
                            p = (0, c.useMemo)(() => {
                                if (null != d) return { orbPriceAmount: d.amount };
                                if (null != m) {
                                    let e = (0, aH.CW)({ product: m, hasShopDiscount: a });
                                    return { orbPriceAmount: null !== e ? e.amount : null };
                                }
                                return null;
                            }, [d, m, a]);
                        p?.orbPriceAmount == null &&
                            (0, aW.hD)("Orb price not found for product", { tags: { sku_id: t } });
                        let {
                ...
                return (0, r.jsx)(a7.Provider, { value: h, children: i });
            },
            TenantPaymentModalRenderer: (e) => {
                let { originalPaymentModalProps: t, renderPaymentModal: n } = e,
                    { orbProductContext: l, skuProductLine: i } = a6(),
                    r = (function (e) {
                    ...
                    })({ orbProductContext: l, skuProductLine: i, overrideAnalyticParams: a5 });
                return n({ ...t, ...r });
            },
            overrideAnalyticParams: a5,
        },
    };
var a9 = n(75304);
let se = {
    [a9.C.ORB_CHECKOUT]: {
        flowType: a9.C.ORB_CHECKOUT,
        implemented: !0,
        purchaseType: eB.VVm.ONE_TIME,
        TENANT_CHECKOUT_FLOW_CONFIG: a8,
    },
    [a9.C.COLLECTIBLES_CHECKOUT]: {
        flowType: a9.C.COLLECTIBLES_CHECKOUT,
        implemented: !0,
        purchaseType: eB.VVm.ONE_TIME,
        TENANT_CHECKOUT_FLOW_CONFIG: lG,
    },
    [a9.C.SLAYER_STOREFRONT_CHECKOUT]: {
        implemented: !0,
        flowType: a9.C.SLAYER_STOREFRONT_CHECKOUT,
        purchaseType: eB.VVm.ONE_TIME,
        TENANT_CHECKOUT_FLOW_CONFIG: aw,
    },
    [a9.C.PREMIUM_CHECKOUT]: {
        implemented: !0,
        flowType: a9.C.PREMIUM_CHECKOUT,
        purchaseType: eB.VVm.SUBSCRIPTION,
        TENANT_CHECKOUT_FLOW_CONFIG: ro,
    },
    [a9.C.INBOUND_PREMIUM_PROMOTION_CHECKOUT]: {
        implemented: !0,
        flowType: a9.C.INBOUND_PREMIUM_PROMOTION_CHECKOUT,
        purchaseType: eB.VVm.SUBSCRIPTION,
        TENANT_CHECKOUT_FLOW_CONFIG: an,
    },
    [a9.C.PREMIUM_APPS_OTP_CHECKOUT]: {
        implemented: !0,
        flowType: a9.C.PREMIUM_APPS_OTP_CHECKOUT,
        purchaseType: eB.VVm.ONE_TIME,
        TENANT_CHECKOUT_FLOW_CONFIG: au,
    },
    [a9.C.PREMIUM_APPS_SUBSCRIPTION_CHECKOUT]: {
        implemented: !0,
        flowType: a9.C.PREMIUM_APPS_SUBSCRIPTION_CHECKOUT,
        purchaseType: eB.VVm.SUBSCRIPTION,
        TENANT_CHECKOUT_FLOW_CONFIG: rU,
    },
    [a9.C.GUILD_PRODUCT_CHECKOUT]: {
        implemented: !0,
        purchaseType: eB.VVm.ONE_TIME,
        TENANT_CHECKOUT_FLOW_CONFIG: nM,
        flowType: a9.C.GUILD_PRODUCT_CHECKOUT,
    },
    [a9.C.GUILD_ROLE_CHECKOUT]: {
        implemented: !0,
        flowType: a9.C.GUILD_ROLE_CHECKOUT,
        TENANT_CHECKOUT_FLOW_CONFIG: ie,
        purchaseType: eB.VVm.SUBSCRIPTION,
    },
    [a9.C.GUILD_BOOST_CHECKOUT]: {
        implemented: !0,
        flowType: a9.C.GUILD_BOOST_CHECKOUT,
        purchaseType: eB.VVm.SUBSCRIPTION,
        TENANT_CHECKOUT_FLOW_CONFIG: nf,
    },
    [a9.C.GAME_SERVER_SUBSCRIPTION_CHECKOUT]: {
        implemented: !0,
        flowType: a9.C.GAME_SERVER_SUBSCRIPTION_CHECKOUT,
        purchaseType: eB.VVm.SUBSCRIPTION,
        TENANT_CHECKOUT_FLOW_CONFIG: ee,
    },
    [a9.C.PAST_DUE_MAGIC_LINK_CHECKOUT]: { implemented: !1, flowType: a9.C.PAST_DUE_MAGIC_LINK_CHECKOUT },
};
