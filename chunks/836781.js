        ...
        : null == r
          ...
          : (0, d.qo)({ type: u.D.GenericMedia, media: t }, n)
            ? (0, i.jsx)(v.B, {
                  ...
                  children: (0, i.jsx)(C.D, { size: "sm", color: "white" }),
              })
            : (0, i.jsx)(L.Ay, {
                  width: t.width ?? 40,
                  height: t.height ?? 40,
                ...
                children: t.map((e, r) => {
                    ...
                    return (0, i.jsx)(
                        O.D,
                        {
                            ...
                            onClick: () => s(r),
                            children: (0, i.jsx)(U, { item: e, enabledContentHarmTypeFlags: l }),
                        },
                        r,
                    );
                }),
...
function Y(e) {
    let {
        ...
        T = r.useCallback(
            (e) => {
                var i;
                f((e = ((e % (i = t.length)) + i) % i)), (E.current = e), n?.(e), I(!1);
            },
            [n, t, I],
        );
    r.useEffect(() => {
    ...
    let y = t[h],
        v = (0, d.qo)({ type: u.D.GenericMedia, media: y }, c),
        C = _
            ? (e) => {
            ...
            (0, i.jsx)(N, {
                ...
                children: (e, t) =>
                    (0, i.jsx)(H, {
                        ...
                        src: y.url,
                        children: (n) =>
                            (0, i.jsx)(w.Ay, { media: y, maxWidth: e, maxHeight: t, obscured: n, onContextMenu: C }),
                    }),
            }),
            R &&
                (0, i.jsx)(S.Ay, {
