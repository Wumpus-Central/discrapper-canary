...
function G(e) {
    let { channel: t } = e,
        ...
        z = j.A.can(O.xBc.MANAGE_CHANNELS, t) || j.A.can(O.xBc.MANAGE_ROLES, t),
        K = l.useCallback(() => a(!1), []);
        ...
        children: [
            ...
            (0, i.jsx)(D.j1, {
                ...
                children: w.intl.format(w.t.QuwqjG, {
                    channelName: r,
                    topicHook: () => N.A.parseTopic(t.topic, !0, { channelId: t.id }),
                }),
            }),
            z
                ? (0, i.jsxs)("div", {
            ...
            (0, i.jsxs)("div", {
                ...
                children: [
                    (function () {
                        if (1 !== W.length || V.length > 0)
                            return (0, i.jsx)(u.A, { guildId: t.guild_id, className: U.HD, maxUsers: 5, users: W });
                        let e = W[0],
                            n = L.Ay.getName(e);
                        return (0, i.jsxs)("div", {
                            className: U.HD,
                        ...
                        return z
                            ? (0, i.jsx)(
                                  P.A,
                                  {
                                      ...
                                      verified: a,
                                      onClick: () => {
                                          v.A.open(t.guild_id, O.BEX.MEMBERS), v.A.selectRole(e.id);
                                      },
                                  },
                                  e.id,
                              )
            ...
            n
                ? (0, i.jsx)(f.aF, {
                      renderModal: (e) =>
                          (0, i.jsx)(S.default, { ...e, onClose: () => (K(), e.onClose()), channelId: t.id }),
                      onCloseRequest: () => a(!1),
                  })
                : null,
        ],
