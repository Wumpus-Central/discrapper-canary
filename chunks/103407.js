...
function W(e) {
    ...
    return (0, r.jsxs)("div", {
        className: L()(q.Vr, { [q.tF]: o }),
        children: [
            null != l ? (0, r.jsx)(Q, { tagText: l, className: q.bX }) : null,
            (0, r.jsx)("img", { alt: "", className: L()(q._n, { [q.tF]: o }), src: i }),
            (0, r.jsxs)("div", {
                className: L()(q.Zz, { [q.tF]: o }),
                children: [
...
function Z(e) {
    ...
    return (
        ...
        a.useEffect(
            () => () => {
                if ("video" === c.type || "embed" === c.type) {
                    let [e, t] = eg();
                    M.default.track(f.HAw.CHANGE_LOG_VIDEO_PLAYED, {
                        change_log_id: g,
                        seconds_played: Math.round(e / 1e3),
                    }),
                        M.default.track(f.HAw.CHANGE_LOG_VIDEO_UNMUTE, {
                            change_log_id: g,
        ...
        a.useEffect(() => {
            if (z.A.getLayers().includes(f.zgK.COMPONENT_PLAYGROUND)) return;
            (0, A.Vh)(l.M.PREMIUM_MARKETING_MOMENT_DESKTOP_ANNOUNCEMENT_MODAL, { snowflakeId: n });
            let e = Date.now();
            return (
                M.default.track(f.HAw.CHANGE_LOG_OPENED, { change_log_id: g }),
                () => {
                    M.default.track(f.HAw.CHANGE_LOG_CLOSED, {
                        change_log_id: g,
                        seconds_open: Math.round((Date.now() - e) / 1e3),
                    }),
                        (0, A.qr)(l.M.PREMIUM_MARKETING_MOMENT_DESKTOP_ANNOUNCEMENT_MODAL, n, {
                                ...
                                switch (c.type) {
                                    case "video":
                                        return (0, r.jsx)(F.A, {
                                            ...
                                            poster: c.poster,
                                            onPlay: (e) => {
                                                M.default.track(f.HAw.CHANGE_LOG_VIDEO_INTERACTED, {
                                                    change_log_id: g,
                                                }),
                                                    en(Date.now()),
                                                    es(!0),
...
function J(e) {
    ...
    {
        let { isDismissed: e } = (0, h.u$)(l.M.PREMIUM_MARKETING_MOMENT_DESKTOP_ANNOUNCEMENT_MODAL, t);
    ...
    if ("announcementModalVariant1" === o.properties.oneofKind) {
        let e = (function (e) {
            let {
                ...
                D = (0, g.C)(i.helpArticle, i.helpArticleId),
                k =
                    null != D
                        ? () =>
                              (0, r.jsxs)(r.Fragment, {
                        ...
                        : void 0,
                C = (0, g.C)(i.disclaimer?.disclaimerHelpArticle, ""),
                j =
                    null != C
                        ? () =>
                              (0, r.jsxs)(r.Fragment, {
            ...
            return (
                    ...
                    (v = { type: "image", src: d ? i.heroArtImageLinkLightTheme : i.heroArtImageLinkDarkTheme }),
                {
                    ...
                    button: () => {
                        let e = Date.now(),
                            t = async () => {
                                M.default.track(f.HAw.CHANGE_LOG_CTA_CLICKED, {
                                    change_log_id: u,
                                    cta_type: L,
                                    seconds_open: Math.round((Date.now() - e) / 1e3),
                                    target: u,
                                ...
                                try {
                                    (I === _.dz.OPEN_MARKETING_PAGE || I === _.dz.OPEN_SOCIAL_LAYER_STOREFRONT) &&
                                        (await (0, A.qr)(l.M.PREMIUM_MARKETING_MOMENT_DESKTOP_ANNOUNCEMENT_MODAL, n, {
                            ...
                            { icon: a } = (0, T.x)({ buttonAction: i.button?.buttonAction });
