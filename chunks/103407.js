...
function Z(e) {
    ...
    return (0, i.jsx)(P.Lp, { className: L()($.Tc, n), text: t });
}
function q(e) {
    ...
    return (0, i.jsxs)("div", {
        className: L()($.Vr, { [$.tF]: l }),
        children: [
            null != s ? (0, i.jsx)(Z, { tagText: s, className: $.bX }) : null,
            (0, i.jsx)("img", { alt: "", className: L()($._n, { [$.tF]: l }), src: a }),
            (0, i.jsxs)("div", {
                className: L()($.Zz, { [$.tF]: l }),
                children: [
                    (0, i.jsx)(U.D, { variant: "heading-md/bold", className: $.Hf, children: t }),
                    (0, i.jsxs)(w.E, { variant: "text-md/medium", color: "text-subtle", children: [n, r?.()] }),
                ],
            }),
        ],
    });
        ...
        r.useEffect(() => {
            ...
            function i() {
                eg.current ||
                    ...
                    ((eg.current = !0),
                    T.default.track(S.HAw.PREMIUM_MARKETING_COMPONENT_BOTTOM_VIEWED, {
                        component_id: t,
        ...
        (0, i.jsx)(M.EO, {
            ...
            children: (0, i.jsxs)(G.h, {
                ...
                children: [
                    (0, i.jsx)("div", {
                        className: $.cG,
                        children: (0, i.jsx)(b.J, { "data-migration-pending": !0, onClick: async () => await Z() }),
                    }),
                    (0, i.jsxs)(M.$m, {
                        "data-migration-pending": !0,
                        className: $.Qs,
                        ...
                        children: [
                            ...
                            (0, i.jsxs)("div", {
                                className: $.Z,
                                children: [
                                    (0, i.jsx)(U.D, { variant: "display-md", className: L()($.TK, _), children: u }),
                                    (0, i.jsxs)(w.E, {
                            ...
                            null != R &&
                                "" !== R &&
                                (0, i.jsx)(U.D, { variant: "heading-lg/semibold", className: $.G3, children: R }),
                            f.length > 0 &&
                                (0, i.jsx)("div", {
                                    className: $.IS,
                                    children: f.map((e, t) =>
                                        (0, i.jsx)(q, { ...e, wideStyle: J }, `${e.header}_${t}`),
                                    ),
                                }),
                        ],
                    }),
    ...
    if ("announcementModalVariant1" === l.properties.oneofKind) {
        let e = (function (e) {
            let {
                ...
                L =
                    O === h.d.OPEN_MARKETING_PAGE
                        ? "jump_to_mkt_button"
                        : O === h.d.OPEN_SOCIAL_LAYER_STOREFRONT
                    ...
                    (P = { type: "image", src: c ? a.heroArtImageLinkLightTheme : a.heroArtImageLinkDarkTheme }),
                {
                    ...
                    button: function () {
                        ...
                        async function t() {
                            ...
                            try {
                                (O === h.d.OPEN_MARKETING_PAGE || O === h.d.OPEN_SOCIAL_LAYER_STOREFRONT) &&
                        ...
                        let { icon: r } = (0, g.x)({ buttonAction: a.button?.buttonAction });
