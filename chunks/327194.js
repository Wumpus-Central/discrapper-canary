...
var i = n(77729),
    ...
    f = n(237984),
    g = n(392164);
let A = new r.A("OverlayV3NativeModule");
function I(e, t, n) {
...
class N {
    ...
    destroy() {
        (this.module = null),
            ...
            A.info("OverlayV3 Native Module destroyed");
    }
    ...
    async loadOutOfProcessOverlayModule() {
        if (!l.O) return void A.error("Attempted to load overlay on an unsupported platform.");
        A.info("Loading Out of Process Overlay Module");
        try {
            var e;
            ...
            t.init(),
                ...
                A.verbose("Native module callbacks setup"),
                (0, E.Mi)(),
                A.info("OverlayV3 Module Loaded");
        } catch (e) {
            throw (
                (A.error("failed loading overlay module", e),
    ...
    async createOutOfProcessOverlayHostWindow(e) {
        A.verbose(`Creating OOP Host Window for pid ${e}`), (0, E.wX)(e);
        let t = null;
        try {
            ...
            A.error("Error creating OOP host window:", t),
        ...
        try {
            ...
            A.error("Error setting background throttling:", t),
        ...
        try {
            ...
            A.error("Error getting native window handle:", t),
                (0, E.lo)(e, t, n),
                (0, E._r)(
                    e,
    ...
    destroyOutOfProcessOverlayHostWindow() {
        A.verbose("Destroying OOP host window"), (0, E._r)(this.lastAssociatedPID, "host_window_destroyed");
        try {
    ...
    setRenderingWindowHandle(e, t) {
        this.module?.setRenderingWindowHandle?.(e), A.verbose(`Setting rendering window handle for pid ${t}: ${e}`);
    }
