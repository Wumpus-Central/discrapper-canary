...
var r,
    ...
    f = n(731854);
function p() {}
let h = 20 * d.A.Millis.SECOND,
    E = +d.A.Millis.MINUTE,
    m = 5 * d.A.Millis.SECOND;
function g(e) {
    return e.map((e) => ({
        name: e.name,
        type: e.type,
...
class S extends o.A {
    ...
    send(e) {
        ...
        c.default.isLoggingGatewayEvents && this.logger.info(`<~ ${r}`), this.emit("send-message", e, t);
        try {
            n.send(r);
        } catch (e) {}
    }
    ...
    cleanupWebSocket(e) {
        ...
        (this.webSocket = null),
            null != t && ((t.onopen = p), (t.onmessage = p), (t.onerror = p), (t.onclose = p), e?.(t)),
            this.backoff.cancel();
    }
    cleanupState() {
        (this.serverId = null),
