...
function y(e) {
    let n,
        ...
        { isGift: N, giftRecipient: U, giftCode: R, hasSentMessage: F, isSendingMessage: B, sendGiftMessage: H, claimableRewards: G, selectedGiftingPromotionReward: D } = (0, x.wD)(),
    ...
    return (
        i.useEffect(() => {
            !N || null == U || null == R || F || B || (0, u.pO)(U) || H({ onSubscriptionConfirmation: y });
        }, [H, N, U, R, F, B, y]),
        i.useEffect(() => {
