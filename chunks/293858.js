...
function y(e) {
    let t,
        ...
        { activeSubscription: T, paymentSources: M, paymentSourceId: P, selectedPlan: O, selectedSkuId: Z, step: v, updatedSubscription: w, startingPremiumSubscriptionPlanIdRef: k } = (0, f.JL)(),
