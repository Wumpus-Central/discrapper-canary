...
function d(e) {
    ...
    if (((0, o.EN)(t.byeaster) && (t.freq = a.Ci.YEARLY), !((0, o.EN)(t.freq) && a.Ci.FREQUENCIES[t.freq])))
        throw Error("Invalid frequency: ".concat(t.freq, " ").concat(e.freq));
    if (
        (t.dtstart || (t.dtstart = new Date(new Date().setMilliseconds(0))),
        (0, o.EN)(t.wkst) ? (0, o.hj)(t.wkst) || (t.wkst = t.wkst.weekday) : (t.wkst = a.Ci.MO.weekday),
        (0, o.EN)(t.bysetpos))
    ) {
    ...
    if (
        ((0, o.EN)(t.bymonth) && !(0, o.kJ)(t.bymonth) && (t.bymonth = [t.bymonth]),
        (0, o.EN)(t.byyearday) && !(0, o.kJ)(t.byyearday) && (0, o.hj)(t.byyearday) && (t.byyearday = [t.byyearday]),
        (0, o.EN)(t.bymonthday))
    )
    ...
    if (((0, o.EN)(t.byweekno) && !(0, o.kJ)(t.byweekno) && (t.byweekno = [t.byweekno]), (0, o.EN)(t.byweekday)))
        if ((0, o.hj)(t.byweekday)) (t.byweekday = [t.byweekday]), (t.bynweekday = null);
            ...
            !t.byweekday.n || t.freq > a.Ci.MONTHLY
    ...
    return (
        (0, o.EN)(t.byhour)
            ? (0, o.hj)(t.byhour) && (t.byhour = [t.byhour])
            : (t.byhour = t.freq < a.Ci.HOURLY ? [t.dtstart.getUTCHours()] : null),
        (0, o.EN)(t.byminute)
            ? (0, o.hj)(t.byminute) && (t.byminute = [t.byminute])
            : (t.byminute = t.freq < a.Ci.MINUTELY ? [t.dtstart.getUTCMinutes()] : null),
        (0, o.EN)(t.bysecond)
            ? (0, o.hj)(t.bysecond) && (t.bysecond = [t.bysecond])
            : (t.bysecond = t.freq < a.Ci.SECONDLY ? [t.dtstart.getUTCSeconds()] : null),
        { parsedOptions: t }
    );
}
function f(e) {
