...
function p(e, t) {
    let {
            ...
            getIsLoading: h,
            getError: E,
            retryConfig: { maxRetries: m = 5, backoff: g = _, retryableErrors: A = d } = {},
        } = t,
        I = new Map();
    function T(e) {
        if (null == e) return f;
    ...
    async function S(e) {
        ...
        if (null != t && !o) {
            ...
            try {
                i.setState({ isLoading: !0 }), await p(...n), a.succeed(), i.setState({ error: null, isLoading: !1 });
            } catch (s) {
                let e = (function (e) {
    ...
    function y() {
        ...
        let d = (function (e) {
            ...
            p = T(f),
            m = (0, o.bG)(_, () => h?.(...d), [d]),
            g = p((e) => null == h && e.isLoading),
            A = (0, o.bG)(_, () => E?.(...d), [d]),
            I = p((e) => (null == E ? e.error : null)),
            y = (0, o.bG)(_, () => s(...d), [d], c);
        return (
            (0, r.useEffect)(() => {
                S({ queryId: f, args: d, useStoreState: p });
            }, [f, d, p]),
            {
                data: y === l ? null : y,
                error: A ?? I,
                ...
                refetch: (0, r.useCallback)(() => {
                    S({ queryId: f, args: d, useStoreState: p, refetch: !0 });
                }, [f, d, p]),
            }
        );
    }
