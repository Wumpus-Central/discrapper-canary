        ...
        h = s.useCallback(
            (e) => {
                ...
                e ? i.delete(n) : i.add(n),
                    ...
                    r.default.track(x.rMx.USER_SERVER_PRIVACY_SETTINGS_ACTION, {
    ...
    return n === _.T
        ...
        : (0, i.jsx)(d.U, {
              ...
              children: (0, i.jsx)(u.Z, {
                  ...
                  value: !c,
                  onChange: h,
                  note: p.intl.format(p.t.jXKQCg, { helpdeskArticle: l.Z.getArticleURL(x.BhN.ACTIVITY_STATUS_SETTINGS) })
              })
          });
}
function C(e) {
