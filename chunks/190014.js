    ...
    return n === x.T
        ...
        : (0, i.jsx)(d.U, {
              ...
              children: (0, i.jsx)(u.Z, {
                  ...
                  value: !c,
                  onChange: m,
                  note: p.intl.format(p.t.jXKQCg, { helpdeskArticle: r.Z.getArticleURL(_.BhN.ACTIVITY_STATUS_SETTINGS) })
              })
          });
}
function C(e) {
    let { ingress: t = m.f4.USER_SETTINGS_PRIVACY_SAFETY, guildId: n } = e,
        s = (0, c.is)();
    return (0, i.jsx)(E, {
        ingress: t,
        guildId: null != n ? n : s
