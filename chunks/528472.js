...
class u {
    ...
    detectCapabilities() {
        ...
        if (this.isDetecting) {
            if (null === this.detectionPromise || void 0 === this.detectionPromise)
                throw Error("Detection promise is null while isDetecting is true");
    ...
    constructor() {
        a(this, "capabilities", null),
            a(this, "isDetecting", !1),
            a(this, "detectionPromise", null),
            a(this, "hasAttemptedDetection", !1);
    }
}
a(u, "instance", void 0);
let d = u;
