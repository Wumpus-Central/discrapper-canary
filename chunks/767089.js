...
var l = n(627968),
    ...
    d = n(953727);
function C(e) {
    let { width: t = 12, height: n = 12, color: i = "currentColor", foreground: a, ...r } = e;
    return (0, l.jsxs)("svg", {
        ...(0, d.A)(r),
        width: t,
        height: n,
...
function A(e) {
    let { width: t = 10, height: n = 10, color: i = "currentColor", foreground: a, ...r } = e;
    return (0, l.jsx)("svg", {
        ...(0, d.A)(r),
        width: t,
        height: n,
...
let f = {
    ...
    N = i.memo(function (e) {
        let {
            ...
            G = (0, s.p)(null != m, { ...f, keys: (e) => (e ? "children" : "icon") }),
            L = (e) => {
                let { component: t } = e;
                return null != E
                    ? (0, l.jsxs)("div", {
        ...
        return (0, l.jsxs)(c.D, {
            ...
            "aria-disabled": i,
            tabIndex: i ? -1 : 0,
            className: r()(n, g.x6, { [g.vu]: _, [g.CK]: x, [g.s0]: O, [g.r9]: i }),
            onClick: i ? void 0 : p,
            onDoubleClick: i ? void 0 : T,
            onMouseEnter: I,
            onMouseLeave: h,
            onFocus: b,
            onBlur: R,
            ...
            children: [
                G((e, t, n) => {
                    ...
                    return t
                        ? (0, l.jsx)(
                              o.animated.div,
                              { style: e, className: r()(g._o, a), children: L({ component: m }) },
                              i,
                          )
                        : null != N
                          ? (0, l.jsx)(
                ...
                M &&
                    (0, l.jsxs)("div", {
                        className: g.YX,
                        children: [(0, l.jsx)(A, { className: g.XR }), (0, l.jsx)(C, { className: g.Hv })],
                    }),
            ],
        });
    });
