...
var n,
    ...
    A = i(388032),
    a =
        (((n = {})[(n.EMPTY_STATE = 0)] = "EMPTY_STATE"),
        (n[(n.ADMINISTRATOR = 1)] = "ADMINISTRATOR"),
        (n[(n.ROLE = 2)] = "ROLE"),
        (n[(n.OWNER = 3)] = "OWNER"),
        (n[(n.MEMBER = 4)] = "MEMBER"),
        (n[(n.USER = 5)] = "USER"),
...
function D(t, e, i) {
    ...
    return {
        ...
        [_.Plq.SEND_MESSAGES.toString()]: {
            title: _.TPd.GUILD_THREADS_ONLY.has(n)
                ? A.intl.string(A.t.nJwAHR)
                : n === _.d4z.GUILD_CATEGORY
                  ? A.intl.string(A.t.S1VOwc)
                  : A.intl.string(A.t.T32rkJ),
            description: (() => {
                switch (n) {
                    case _.d4z.GUILD_CATEGORY:
                        return A.t.IjeLur;
                    case _.d4z.GUILD_FORUM:
                        return (null == i ? void 0 : i.createPostsDisabled) && !t.isMediaChannel()
                            ? l.Z.getForumChannelPermissionText()
                            : A.t.LG9VAg;
                    case _.d4z.GUILD_MEDIA:
                        return A.t.LG9VAg;
                    case _.d4z.GUILD_ANNOUNCEMENT:
                        return A.intl.format(A.t.WFwfSE, {
                            articleURL: S.Z.getArticleURL(_.BhN.ANNOUNCEMENT_CHANNELS),
                        });
                    case _.d4z.GUILD_VOICE:
                        return s.Z.getTextInVoiceSendMessageChannelPermissionText(
        ...
        [_.Plq.MENTION_EVERYONE.toString()]: {
            title:
                n === _.d4z.GUILD_STAGE_VOICE
                    ? A.intl.string(A.t.VDUAHB)
                    : (null == i ? void 0 : i.inGameMentionsExperiment)
                      ? A.intl.string(A.t.lEO7Wl)
                      : A.intl.string(A.t.Y78KGB),
            description:
                n === _.d4z.GUILD_CATEGORY
                    ? A.t["HOhg/P"]
                    : n === _.d4z.GUILD_STAGE_VOICE
            ...
            description: (() => {
                switch (n) {
                    case _.d4z.GUILD_CATEGORY:
                        return A.t["5R9nYm"];
                    case _.d4z.GUILD_ANNOUNCEMENT:
                        return A.intl.format(A.t.XRxOo6, {
                            articleURL: S.Z.getArticleURL(_.BhN.ANNOUNCEMENT_CHANNELS),
                        });
                    default:
                        return A.t["SeA+Gx"];
            ...
            description: (() => {
                switch (n) {
                    case _.d4z.GUILD_CATEGORY:
                        return A.t["cJRv/v"];
                    case _.d4z.GUILD_VOICE:
                        return s.Z.getTextInVoiceReadMessageHistoryChannelPermissionText(
        ...
        [_.Plq.MANAGE_THREADS.toString()]: {
            title: _.TPd.GUILD_THREADS_ONLY.has(n)
                ? A.intl.string(A.t.ossiZG)
                : n === _.d4z.GUILD_CATEGORY
                  ? A.intl.string(A.t.QKe7Q0)
                  : A.intl.string(A.t.kEqgr6),
            description: (() => {
                switch (n) {
                    case _.d4z.GUILD_CATEGORY:
                        return A.t.S31soa;
        ...
        [_.Plq.SEND_MESSAGES_IN_THREADS.toString()]: {
            title: _.TPd.GUILD_THREADS_ONLY.has(n)
                ? A.intl.string(A.t.fqhqWl)
                : n === _.d4z.GUILD_CATEGORY
                  ? A.intl.string(A.t["5QlVGx"])
                  : A.intl.string(A.t.fTE74u),
            description: (() => {
                switch (n) {
                    case _.d4z.GUILD_CATEGORY:
                        return A.t.DlIVcH;
