...
class P extends i.PureComponent {
    ...
    renderElement(e) {
        ...
        "rtl" === a.dir && (a.style = N(S({}, a.style), { textAlign: "right" }));
        let l = null != (t = null == o ? void 0 : o(e)) ? t : (0, b.Z)(e, n, i);
        return null != l ? l : (0, r.jsx)("div", N(S({}, a), { children: s }));
    }
    renderLeaf(e) {
        var t;
        ...
        return null != s ? s : (0, r.jsx)("span", N(S({}, o), { children: a }));
    }
    handleOnChange() {
        var e, t;
        ...
        if (
            ...
            null == (e = (t = this.props).onChange) || e.call(t, m.bN.richValue(n)),
    ...
    handleCompositionStart() {
        ...
        let o = s.F3.findDocumentOrShadowRoot(this.props.editor).getSelection(),
            a =
                (null != (e = null == o ? void 0 : o.rangeCount) ? e : 0) > 0
                    ? null == o
                        ? void 0
                        : o.getRangeAt(0)
                    : null;
        if (
            ...
            (n.selection = null),
                null != e ? h.Q.select(n, e) : h.Q.select(n, null != (t = n.selection) ? t : m.bN.end(n, []));
        }
        n.composition = r;
    }
        ...
        if (null != e && null != t)
            for (let n = e.rangeCount - 1; n >= 0; n--) {
                let r = e.getRangeAt(n),
                    ...
                    a = r.startOffset,
                    s = r.endOffset;
                if ((0, p.hasDomParent)(i, t) || (!(0, p.isDOMRangeCollapsed)(i, a, o, s) && (0, p.hasDomParent)(o, t)))
                    return !0;
            }
        return !1;
    }
