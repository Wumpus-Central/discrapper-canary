...
function p(e) {
    ...
    let R = I.intl.format(h(), { actorName: c.nick, actorHook: p, targetName: C?.nick, targetHook: f });
    return (0, i.jsx)(E.A, { iconNode: (0, i.jsx)(g, { type: o }), timestamp: t.timestamp, compact: r, children: R });
}
function C(e) {
    let { message: t, channel: n, compact: r } = e,
        { author: l, type: s } = t,
