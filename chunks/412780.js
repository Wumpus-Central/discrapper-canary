"use strict";
n.d(t, { Ay: () => b, Bz: () => C, EM: () => d, Xi: () => y, iA: () => p }), n(134528), n(947204), n(321073);
var i = n(17928),
    r = n(459838),
    s = n(228366),
    a = n(233545),
...
class O extends i.Ay.Store {
    ...
    getInboundStats(e, t) {
        ...
        return { codec: r?.codec.name, resolution: r?.resolution, bitrateEstimate: void 0, fps: N(r?.frameRateRender) };
    }
    getOutboundStats(e) {
        ...
        return {
            ...
            bitrateEstimate: N(n?.availableOutgoingBitrate),
            fps: N(r?.frameRateEncode),
        };
    }
    getAllStats() {
...
let b = new O(s.h, {
    ...
    VOICE_CHANNEL_SELECT: function (e) {
        null != e.channelId && (v(), f.clear(), S.clear());
    },
