...
let J = l.memo(function (e) {
        let {
            ...
            eo = (0, w.A)(P?.id),
            ed = Z(P, y, I),
            { enabled: ec } = M._.useConfig({ location: "activity-panel" }),
            eu = (0, D.Bp)("activity-panel"),
            eh = (0, G.C$)(r ?? void 0, "activity-panel"),
            eA = (0, o.bG)([H.A], () => H.A.hasConsented(K.YAq.PERSONALIZATION)),
            e_ = (0, D.TF)(E?.id, { shouldFetch: eu || eh }),
            em = ec && eA && e_,
            eg = em && eu,
            ep = em && eh,
            ef = l.useCallback(() => {
        ...
        return null == eL && null == eO && null == eG && null == eM && null == eU && null == ej && null == eR
            ? null
            : (0, i.jsxs)("div", { className: Q.o1, children: [ej ?? eU ?? eO, eR, eL, eG ?? eM ?? eD, eP] });
    }),
