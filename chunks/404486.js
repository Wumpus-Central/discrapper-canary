...
let rL = {
    ...
    GuildRaidLockdownFeedbackModal: async () => {
        let { default: e } = await Promise.all([a.e("116"), a.e("46313")]).then(a.bind(a, 336496));
        return (t) =>
            (0, r.jsx)(e, {
                ...t,
                guildId: "123456789",
...
function dT() {
    return (0, r.jsxs)(D.B, {
        ...
        gap: 8,
        children: [
            (0, r.jsx)(dI, { experimentName: du.W2.definition.name, options: dN }),
            (0, r.jsx)(dI, { experimentName: du._$.definition.name, options: dN }),
            (0, r.jsx)(dI, { experimentName: dd.A.definition.name, options: dA }),
            (0, r.jsx)(dI, { experimentName: dc._.definition.name, options: dk }),
            (0, r.jsx)(dI, { experimentName: dp.A.definition.name, options: dD }),
        ],
    });
}
let dO = [
...
async function d9() {
    ...
    try {
        if (a) {
            ...
            } else e = d4([H.NJ8.DARK, H.NJ8.DARKER, H.NJ8.MIDNIGHT]);
            await d0.u_(
...
async function d7() {
    ...
    if (n || l)
        try {
            let e = {};
            n && (e.avatarDecoration = d4([...t, null])), l && (e.nameplate = d4([...a, null])), (0, e6.p)(e);
            ...
            children: [
                (0, r.jsxs)("div", {
                    children: [
                        ...
                        (0, r.jsx)(x.$, { variant: "primary", size: "sm", text: "Randomize Theme", onClick: d9 }),
                        (0, r.jsx)(x.$, {
                            variant: "primary",
                            size: "sm",
...
function uT() {
    ...
    return (0, r.jsxs)("div", {
        ...
        children: [
            ...
            (0, r.jsx)(tk, { columns: uD, data: l, selectedRowKey: s, onClickRow: (e) => i(e.key) }),
            null != c &&
                (0, r.jsx)(uI, { store: c, initialHeight: null != e.current ? e.current.clientHeight / 2 : 300 }, s),
        ],
    });
}
var uO = a(91871),
...
function mg() {
    let e = (0, d.bG)([uV.Ay], () => uV.Ay.getAudioMixerSettings()),
        ...
        h = (0, d.yK)(
            [ms.A],
            () => (null == m ? [] : Object.values(ms.A.getVoiceStatesForChannel(m)).filter((e) => e.userId !== u)),
            [m, u],
        ),
        p = e.mode ?? "line",
        g = o.useMemo(
    ...
    o.useEffect(() => {
        "manual" === p ||
            uV.Ay.getMediaEngine().eachConnection((e) => {
                h.forEach((t, a) => {
                    a < g.length && e.setUserPosition(t.userId, g[a]);
                });
            });
    }, [p, g, h]);
    let b = o.useCallback(
                    ...
                    children: [
                        ...
                        (0, r.jsxs)("div", {
                            ...
                            children: [
                                ...
                                (0, r.jsx)(j.d, { checked: e.enabled, onChange: (e) => b({ enabled: e }) }),
                            ],
                        }),
                        ...
                        (0, r.jsx)("div", {
                            ...
                            children: mr.map((t) => {
                                ...
                                return (0, r.jsx)(
                                    "button",
                                    {
                                        className: `${mi._V} ${p === a ? mi.cB : ""}`,
                                        onClick: () => {
                                            b({ mode: a }), l > 0 && n(md(l, e.distance));
                                        },
                                        children: s,
                                    },
                                    a,
...
function hy() {
    ...
    return (0, r.jsxs)(c.Ip, {
        className: m4.kL,
        children: [
            (0, r.jsx)(T.D, { variant: "heading-lg/bold", className: m4.R_, children: "Quest Preview Tool" }),
            (0, r.jsx)("div", {
                className: m4.OA,
                children: (0, r.jsx)(hs, {
                    onSelect: function (e) {
            ...
            (0, r.jsx)(T.D, { variant: "heading-md/semibold", className: m4.fV, children: "Task Config" }),
            (0, r.jsx)("div", {
                className: m4.OA,
                children: (0, r.jsx)(hd, {
                    taskDuration: S,
            ...
            (0, r.jsx)(T.D, { variant: "heading-md/semibold", className: m4.fV, children: "Messages" }),
            (0, r.jsxs)("div", {
                className: m4.OA,
                children: [
                    (0, r.jsx)(hn, {
            ...
            (0, r.jsx)(T.D, { variant: "heading-md/semibold", className: m4.fV, children: "Assets" }),
            (0, r.jsxs)("div", {
                className: m4.OA,
                children: [
                    (0, r.jsx)(ha, {
            ...
            (0, r.jsx)(T.D, { variant: "heading-md/semibold", className: m4.fV, children: "Colors & Quest States" }),
            (0, r.jsxs)("div", {
                className: m4.OA,
                children: [
                    (0, r.jsxs)("div", {
            ...
            (0, r.jsx)(T.D, { variant: "heading-lg/bold", className: m4.R_, children: "Component Previews" }),
            (0, r.jsxs)("div", {
                className: m4.$$,
                children: [
                    (0, r.jsxs)(he, {
            ...
            switch ((hw.info(`Result Type: ${e.type}`), e.type)) {
                        ...
                        e.record.isDM() &&
                            ...
                            e.record.recipients.forEach((e) => {
                                ...
                                null != t &&
                                    ...
                                    hw.info(`recipient nickname: ${t9.A.getNickname(t.id)}`));
                            }));
                    break;
                case hR.rD.GROUP_DM:
                    hw.info(`channel type: ${e.record.type}`),
                        hw.info(`channel id: ${e.record.id}`),
                        hw.info(`name: ${(0, t5.m1)(e.record, V.default, t9.A)}`),
                        e.record.isGroupDM() &&
                            (hw.info(`default name: ${(0, t5.ks)(e.record, V.default, t9.A)}`),
                ...
                case hR.rD.USER:
                    hw.info(`user id: ${e.record.id}`),
                        ...
                        hw.info(`nickname: ${t9.A.getNickname(e.record.id)}`),
                        hw.info(`guild nicknames: ${hT.Ay.getNicknames(e.record.id)}`);
            }
            hw.info(`frecency score: ${hD.A.getScoreWithoutFetchingLatest(e.record.id)}`), hM();
        }),
                    ...
                    hV.setState({ isUploading: !0, errorMessage: null, isSuccess: !1 }),
                        ...
                        e &&
                            ...
                            v.forEach((e) => {
                                let t = hD.A.getScoreWithoutFetchingLatest(e.id);
                                hw.info(`id: ${e.id} - Frecency Score: ${t}`),
                                    hw.info(`default name: ${(0, t5.ks)(e, V.default, t9.A)}`),
                                    hw.info(`name: ${(0, t5.m1)(e, V.default, t9.A)}`);
                            }),
                            hM(),
    ...
    let { userState: t } = e,
        ...
        i = o.useCallback((e) => {
            ...
            return t
                ...
                : (0, r.jsx)(mz.E, { size: "sm", color: eD.A.colors.ICON_FEEDBACK_CRITICAL });
        }, []);
    return (0, r.jsxs)("div", {
        className: hB.N6,
        children: [
