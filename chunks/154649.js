...
function _(t) {
    let { guild: i, onClick: l } = t,
        e = (0, s.bG)([g.A], () => g.A.getMemberCount(i.id));
    return (0, a.jsxs)(c.D, {
        className: I._S,
        onClick: l,
        children: [
...
function v(t) {
    let { gameName: i, gameApplicationId: l, onClose: s, transitionState: c } = t,
    ...
    return (0, a.jsxs)(n.a, {
        ...
        children: [
            (0, a.jsxs)("div", {
                className: I.fA,
                children: [
                    (0, a.jsx)(d.E, { variant: "text-sm/semibold", children: b.intl.string(N.default["4MInNs"]) }),
                    (0, a.jsx)(o.m, {
                        position: "top",
