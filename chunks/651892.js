...
function l(e) {
    ...
    if (t) {
        ...
        let e =
            null == o
                ? a.intl.formatToPlainString(a.t.Piihy1, { gamePublisher: i })
                : a.intl.formatToPlainString(a.t.DV47Gy, { gamePublisher: i, cosponsorName: o });
        return `${e} ${a.intl.string(a.t.fEbrT8)}`;
    }
    return r
        ? a.intl.formatToPlainString(a.t.zDHY3s, { gamePublisher: i })
        : a.intl.formatToPlainString(a.t.euizJY, { gamePublisher: i, gameTitle: s });
}
function u(e) {
