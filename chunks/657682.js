...
let s = /^\d+$/,
    ...
    c = /^[a-zA-Z0-9_\\.]+$/;
function u(e) {
    return c.test(e) || (e.includes('#') && l.test(e)) ? null : (f(e), o.NW.string(o.t.paDJBA));
}
function d(e, t) {
    switch (e) {
        case a.evJ.RELATIONSHIP_INCOMING_DISABLED:
            return o.NW.format(o.t.Oxe6Ul, { discordTag: t });
        case a.evJ.TOO_MANY_FRIENDS:
            return o.NW.string(o.t.tnBalJ);
        case a.evJ.RELATIONSHIP_ALREADY_FRIENDS:
            return o.NW.string(o.t.VNLnen);
        case a.evJ.USER_QUARANTINED:
        case a.evJ.USER_FRIEND_REQUEST_LIMITED_ACCESS:
            return o.NW.string(o.t.EouHws);
        case a.evJ.TOO_MANY_BLOCKED_USERS:
            return o.NW.string(o.t.sIGo1t);
        case a.evJ.TOO_MANY_PENDING_OUTGOING:
            return o.NW.string(o.t.k1K15u);
