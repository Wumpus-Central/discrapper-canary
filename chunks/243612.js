"use strict";
n.d(t, { JH: () => m, VC: () => c, b4: () => E, oQ: () => _, qv: () => f, tg: () => p, xl: () => h });
var r = n(311907),
    i = n(52133),
    s = n(833349);
n(313961);
...
function p(e) {
    let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : l.A,
        n = t.getActivities(!0);
    return (
        (null != e ? n.find((t) => (0, s.A)(t, d.jUm.JOIN) && t.application_id === e) : void 0) ??
        n.find((e) => (0, s.A)(e, d.jUm.JOIN)) ??
        null
    );
}
function m(e) {
    return (0, r.bG)([l.A], () => p(e, l.A), [e]);
}
