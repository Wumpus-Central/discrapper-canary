...
let c = '1340102344645283891',
    ...
    v = () => ({
        ...
        [a.oNc.AUDIO_BITRATE_128_KBPS]: {
            perkIcon: i.Ro.AUDIO,
            description: s.intl.formatToPlainString(s.t.zoT1ZG, { bitrate: o.HO[a.Eu4.TIER_1].limits.bitrate / 1000 })
        },
        [a.oNc.INVITE_SPLASH]: {
        ...
        [a.oNc.AUDIO_BITRATE_256_KBPS]: {
            perkIcon: i.Ro.AUDIO,
            description: s.intl.formatToPlainString(s.t.zoT1ZG, { bitrate: o.HO[a.Eu4.TIER_2].limits.bitrate / 1000 })
        },
        [a.oNc.ROLE_ICONS]: {
        ...
        [a.oNc.AUDIO_BITRATE_384_KBPS]: {
            perkIcon: i.Ro.AUDIO,
            description: s.intl.formatToPlainString(s.t.zoT1ZG, { bitrate: o.HO[a.Eu4.TIER_3].limits.bitrate / 1000 })
        },
        [a.oNc.VANITY_URL]: {
