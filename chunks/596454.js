...
function A(e) {
    var t,
        n,
        { src: o, alt: s, className: c, emojiId: f, emojiName: p, channelId: g, messageId: b, animated: O, size: S = 'default', isInteracting: A = !1, shouldAnimate: N, onMouseEnter: C, onMouseLeave: P, canSelect: R = !0, autoplay: w, registerInnerRef: D, registerAnimatedElementRef: L } = e,
