                    ...
                    return (
                        ...
                        d ||
                            ...
                            (e = n
                                ? h(i)
                                : ("paragraph" === i[0].type &&
                                      i[0].content instanceof Array &&
                                      (i[0].content = h(i[0].content)),
                                  i))),
                        (e = (function (e) {
...
function b(e, t) {
    ...
    return null != n
        ...
        : e.content instanceof Array
          ? b(e.content, t)
          : e.items instanceof Array && e.items.some((e) => b(e, t));
}
function p(e) {
    return b(e, (e) =>
        "spoiler" === e.type ? b(e, (e) => "link" === e.type || "attachmentLink" === e.type || null) : null,
    );
}
