...
function y() {
    ...
    let { hasFetchedSubscriptions: e, premiumSubscription: t } = (0, s.cj)([h.Z], () => ({
            hasFetchedSubscriptions: h.Z.hasFetchedSubscriptions(),
            premiumSubscription: h.Z.getPremiumTypeSubscription(),
        })),
        n = (0, p.V)(),
        a = (0, s.e7)([m.Z], () => m.Z.hasFetchedPaymentSources),
        y = (0, s.e7)([_.Z], () => _.Z.isFetchingCurrentUserAppliedBoosts);
    return e && n && a && !y
        ? (0, r.jsxs)("div", {
