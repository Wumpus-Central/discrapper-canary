...
function p(e) {
    var t, n, r, a, s;
    if ('string' != typeof e && (null == e ? void 0 : null === (t = e.body) || void 0 === t ? void 0 : t.code) === i.f$) {
        ...
        (null === (s = e.body) || void 0 === s ? void 0 : s.errors) != null && (e.body = (0, i.J9)(e.body.errors));
    }
    return new h(e);
}
class h extends r.Z {
...
s(h, 'ErrorCodes', o), s(h, 'Fields', l), s(h, 'Sections', d), s(h, 'CARD_ERRORS', f), s(h, 'ADDRESS_ERRORS', _);
let m = h;
