...
let Z = (0, P.Mg)(l.Z.MEMBER_LIST_ITEM_AVATAR_DECORATION_PADDING),
    ...
    W = i.memo(function (e) {
        ...
        return null == t
            ? null
            : (0, r.jsx)(c.ua7, {
                  text: k.intl.formatToPlainString(k.t.IWkAq6, { date: t }),
                  children: (e) =>
                      (0, r.jsx)(c.P3F, {
                          onClick: n,
                          tabIndex: -1,
    ...
    X = i.memo(function (e) {
        let { user: t, shouldAnimateStatus: n, activities: i, status: a, eventHandlers: o, avatarSrc: s, isMobile: l, isTyping: d, avatarDecorationSrc: _, handleSetTypingRef: f, typingRef: p, currentUser: h } = e,
            m = a === D.Skl.OFFLINE,
            g = n ? c.Xo$ : c.qEK,
    ...
    Q = i.memo(function (e) {
        let { hideSubtext: t, hideTooltip: n = !1, activities: a, status: o, applicationStream: s, voiceStatusChannel: l, user: c, channel: u, isHoveringOrFocusing: d, quest: f } = e,
            h = i.useMemo(
                () =>
                    (0, _.Z)({
                        activities: a,
    ...
    J = i.memo(function (e) {
        var t;
        let { selected: n = !1, colorString: a, colorStrings: l, colorRoleName: u, isOwner: _, ownerTooltipText: p, lostPermissionTooltipText: h, isTyping: E = !1, nick: b, user: y, currentUser: O, activities: v, applicationStream: I, status: P, shouldAnimateStatus: L = !1, isMobile: x, premiumSince: k, channel: j, guildId: G, className: F, nameplate: Z, hideClanTag: Y = !1, hideSubtext: W = !1, hideTooltip: K = !1, onMouseDown: J, onKeyDown: $, onClick: ee, onContextMenu: et, onClickPremiumGuildIcon: en, 'aria-controls': er, 'aria-expanded': ei, 'aria-posinset': ea, 'aria-setsize': eo, id: es, tabIndex: el, itemProps: ec, ref: eu } = e,
            ed = null == y ? void 0 : y.id,
            e_ = w.ZP.useName(y),
            ef = (null == (t = R.default.getCurrentUser()) ? void 0 : t.id) === ed,
            ep = i.useRef(null),
            eh = null != eu ? eu : ep,
            [em, eg] = i.useState(!1),
            [eE, eb] = i.useState(!1),
            [ey, eO] = i.useState(null),
            { voiceChannel: ev } = (0, f.Z)({
                userId: ed,
                guildId: G
            }),
