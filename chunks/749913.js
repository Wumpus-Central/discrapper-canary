...
function el(e) {
    let { parentChannel: t, isSearchLoading: n, onChange: i, canCreatePost: s, inputRef: o } = e,
        ...
        j = (0, h.Wu)([A.Z], () => A.Z.getUploads(t.id, R.d.FirstThreadMessage)),
        C = u && v && s,
        ...
        T = (function (e) {
            ...
            return a.useCallback(
                async (t, a, l) => {
                    ...
                    let { content: x, stickers: b, uploads: v, hasNameError: j, hasMessageError: C } = i(t, a, l);
                    if ((s(j ? (0, z.V_)() : null), o(C ? (0, z.T4)() : null), j || C))
                        return {
                            shouldClear: !1,
                            shouldRefocus: !0
                        };
                    try {
                        ...
                        var _, y;
                        return (
                            (null === (_ = t.body) || void 0 === _ ? void 0 : _.code) === $.evJ.AUTOMOD_TITLE_BLOCKED ? s((0, z.Gx)(t.body, e)) : (null === (y = t.body) || void 0 === y ? void 0 : y.code) === $.evJ.AUTOMOD_MESSAGE_BLOCKED && o((0, z.Gx)(t.body, e)),
                            {
                                shouldClear: !1,
                                shouldRefocus: !0
                            }
