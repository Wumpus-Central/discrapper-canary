...
let eU = (0, c.Fe)({ createPromise: () => Promise.resolve().then(n.bind(n, 500831)), webpackId: 500831 }),
    ...
    ez = (e) => {
        ...
        let u = (0, A.bG)([eS.A], () => eS.A.getGuild(l)),
            ...
            g = u?.features.has(eR.GuildFeatures.GAME_SERVERS) ?? !1,
            E = (0, A.bG)([Q.A], () => {
                if (null == l) return;
                let e = Q.A.getData(l);
        ...
        if (null != l && null != c && (0, eP.jq)(c))
            switch (c) {
                ...
                case eP.VV.GAME_SERVERS:
                    if (!_ || (!g && !m)) return (0, i.jsx)(o.rd, { to: eR.BVt.CHANNEL(l) });
...
function ti(e) {
    ...
    r.useLayoutEffect(() => {
        if (c) {
            ...
            Number.isNaN(e) && (e = 375), (e = Math.min(Math.max(e, 264), 432)), !c && e <= 76 && (e = 375), tn(e);
            let t = (e) => {
    ...
    if (
        ...
        return null;
    let x = { className: a()(ew.th, { [ew.Qd]: !t }) };
            ...
            (0, i.jsxs)("div", {
                ...
                children: [
                    ...
                    !s &&
                        (0, i.jsxs)(i.Fragment, {
                            children: [
                                (0, i.jsx)("div", { ...x, children: (0, i.jsx)(e$, {}) }),
                                (0, i.jsx)(_.DUT, {
                                    onClick: S,
...
function tr() {
    let e,
        ...
        a =
            ((e = (0, o.zy)()),
            (0, eE.B)(e.pathname, eR.BVt.GUILD_BOOSTING_MARKETING(eg.pv.guildId()))?.isExact === !0),
        s = (0, A.bG)([et.A], () => et.A.getIsOpen()),
        { notificationCenterVariant: c } = (0, ei.X8)({ location: "Sidebar" }),
        h = (0, w.f)("AppView"),
        _ = (0, o.W5)([
            eR.BVt.CHANNEL(eR.ME, eg.pv.channelId()),
            eR.BVt.CHANNEL(eg.pv.guildId(), eg.pv.channelId({ optional: !0 }), ":messageId?"),
        ]),
                                    ...
                                    children: [
                                        (0, i.jsxs)(o.dO, {
                                            children: [
                                                ...
                                                (0, i.jsx)(v.A, { path: eR.BVt.ICYMI, render: e4, disableTrack: !0 }),
                                                (0, i.jsx)(v.A, {
                                                ...
                                                (0, i.jsx)(v.A, {
                                                    path: eR.BVt.GUILD_MEMBER_VERIFICATION(eg.pv.guildId()),
                                                    render: e0,
                                                ...
                                                (0, i.jsx)(v.A, {
                                                    path: eR.BVt.GUILD_FEATURE(":feature", eg.pv.guildId()),
                                                    exact: !0,
                                                    render: tt,
                                                    disableTrack: !0,
                                                }),
