...
function em(e) {
    ...
    let { analyticsLocations: v, application: j, channel: I, currentUserId: S, currentUserPresenceActivity: T, hideParty: N, message: P, onView: A, partyStatusElement: w, presenceActivity: R } = e,
                      ...
                      : ex
                        ...
                        : ey
                          ...
                          : null != eh
                            ? eh
                            : void 0,
            [v, eb, ex, eE, I.id, I.guild_id, S, ey, P.author.id, P.id, R, eh]
        ),
        ev = i.useMemo(
            () =>
                en
        ...
        eI = i.useMemo(() => {
            let e = [];
            return (K || null == eC ? K && null != ev && e.push(ev) : e.push(eC), e);
        }, [ev, K, eC]),
        ...
        eT = k
            ...
            : void 0,
        eN = (0, O.N)(j.id).some((e) => (0, C.ig)(e) === l.o.GLOBAL)
            ? (0, r.jsxs)(r.Fragment, {
                  children: [
                      (0, r.jsx)(s.YqE, {
                          size: 'xxs',
...
function ef(e) {
    ...
    let { analyticsLocations: l, app: a, channel: s, message: c, hideParty: u, onView: d } = e,
        ...
        x = (0, en.Ps)(null == f || null == (t = f.party) ? void 0 : t.id) || p.id === N.r9.id,
        C = (0, r.jsx)(el, {
            partyMembers: y,
            partySize: h,
            maxPartySize: E,
