...
function ec(e) {
    var t, n, a, h;
    let { analyticsLocations: x, application: v, channel: C, currentUserId: O, currentUserPresenceActivity: j, hideParty: I, message: S, onView: T, partyStatusElement: N, presenceActivity: A } = e,
        w = (0, p.ye)(v),
        { bot: Z } = v,
        ...
        ex = (0, y.N)(v.id).some((e) => (0, E.ig)(e) === l.o.GLOBAL)
            ? (0, r.jsxs)(r.Fragment, {
                  children: [
                      (0, r.jsx)(s.YqE, {
                          size: 'xxs',
            ...
            : null,
        ey = (0, r.jsx)(es, { presenceActivity: A });
    if (F) {
        let e = (0, r.jsx)(s.Text, {
            variant: 'text-xs/medium',
            className: ee.description,
    ...
    let ev = null != (h = null == A || null == (n = A.timestamps) ? void 0 : n.start) ? h : null == A ? void 0 : A.created_at,
        ...
        eO = (0, r.jsxs)(s.Text, {
            ...
            color: 'none',
            lineClamp: 2,
            children: [G ? (0, B.$v)(S, v, C, O, F) : eC, G ? null : ex]
        }),
        ej = (0, r.jsxs)('div', {
            className: ee.info,
...
function eu(e) {
    ...
    let { analyticsLocations: l, app: a, channel: s, message: c, hideParty: u, onView: d } = e,
        ...
        y = (0, J.Ps)(null == f || null == (t = f.party) ? void 0 : t.id) || p.id === I.r9.id,
        v = (0, r.jsx)(et, {
            partyMembers: x,
            partySize: b,
            maxPartySize: E,
