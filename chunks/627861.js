...
function eo(e) {
    ...
    let { application: c, currentUserPresenceActivity: u, hideParty: d, message: p, onView: g, partyStatusElement: _, presenceActivity: h } = e,
        ...
        O = (0, G.dQ)(c.name, null == (t = p.activity) ? void 0 : t.type);
    if (x) {
...
function eu(e) {
    var t, n, a, g;
    let { analyticsLocations: x, application: y, channel: O, currentUserId: j, currentUserPresenceActivity: I, hideParty: S, message: T, onView: N, partyStatusElement: P, presenceActivity: w } = e,
        Z = (0, C.A)(y),
        R = (0, p.ye)(y),
        { bot: L } = y,
        ...
        { staticBannerSrc: k, videoBannerSrc: U, bannerAspectRatio: B } = (0, _.E)(y),
        H = !(0, W.Z)(w, T, y.id),
        Y = er(T),
        ...
        em = !(null == w || !(0, W.Z)(w, T, y.id) || !(0, z.Z)(w, J.xjy.SYNC) || !F.isPlatformEmbedded || ea(I, w)),
        ef = ea(I, w),
        eg = (function (e, t, n, r) {
            var i;
                      ...
                      : eg
                        ...
                        : ef
                          ...
                          : null != ed
                            ? ed
                            : void 0,
            [x, ep, eg, em, O.id, O.guild_id, j, ef, T.author.id, T.id, w, ed]
        ),
        eh = i.useMemo(
            () =>
                $
        ...
        ex = (0, G.dQ)(y.name, null == (t = T.activity) ? void 0 : t.type),
    ...
    let eO = null != (g = null == w || null == (n = w.timestamps) ? void 0 : n.start) ? g : null == w ? void 0 : w.created_at,
        ej =
            null != eO
                ? (0, r.jsxs)('div', {
                      className: et.timestampContainer,
        ...
        eI = (0, r.jsxs)(s.Text, {
            ...
            color: 'none',
            lineClamp: 2,
            children: [Y ? (0, G.$v)(T, y, O, j, H) : ej, Y ? null : ev]
        }),
        eS = (0, r.jsxs)('div', {
            className: et.info,
