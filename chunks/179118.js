...
function M(e) {
    let {
        ...
        W = () =>
            null != p || (_ && null == g)
                ? x.intl.string(x.t.zOmK9P)
                : null != g
                  ? x.intl.string(x.t.d1lrmZ)
                  : x.intl.string(x.t["/s1xR0"]),
        K = (e, t) => {
            null != a &&
                (0, C.dM)(
                    new v.Z({
        ...
        z = () => {
            ...
            return (0, r.jsxs)("div", {
                ...
                children: [
                    (0, r.jsx)(f.vwX, { children: x.intl.string(x.t["/dG4ND"]) }),
                    null != t &&
                        (0, r.jsx)(f.kO8, {
                            hideMessage: S ? x.intl.string(x.t["0RLn4+"]) : null,
                            value: (0, C.Nz)(t),
                            mode: O,
                            text: e,
                            onCopy: (e) => K(e, t),
...
let k = (e) => {
    ...
    return (0, r.jsxs)("div", {
        ...
        children: [
            (0, r.jsx)(f.vwX, { children: x.intl.string(x.t.MJw05e) }),
            (0, r.jsxs)("div", {
                className: L.giftRecipient,
                children: [
                    (0, r.jsx)(f.VcW, {
                    ...
                    (0, r.jsx)(u.z, {
                        ...
                        text: x.intl.string(x.t["+EgwQk"]),
                    }),
                ],
            }),
            (0, r.jsx)("div", {
                className: s ? L.subtextError : L.subtext,
                children: s ? x.intl.string(x.t.jo5Vbm) : x.intl.string(x.t["8/N3v7"]),
            }),
        ],
    });
};
