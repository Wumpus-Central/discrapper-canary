...
let m = (e) => e / 400,
    g = !1,
    E = (0, a.tu)('stage_waiting', 'stage_waiting', m(o.Z.getOutputVolume()));
function v() {
    ...
    if (p.Z.shouldPlay()) {
        (E.volume = m(o.Z.getOutputVolume())), E.loop(), (g = !0);
        return;
    }
    if (_.Z.isLive(e)) {
        E.stop(), (g = !1);
    ...
    n || g ? n && (E.pause(), (g = !1)) : ((E.volume = m(o.Z.getOutputVolume())), E.loop(), (g = !0));
}
function y(e) {
