...
function K(e) {
    ...
    let v = null != n && (0, O.Z)(n, F.xjy.JOIN),
        b = async (e) => {
            if (null != a && 'unsent' === s) {
                e.stopPropagation();
                try {
        ...
        E = v ? B.NW.string(B.t['3fRyS0']) : B.NW.string(B.t.XHxDIS),
        I = v
            ? (0, i.jsx)(d.ejJ, {
                  color: 'currentColor',
                  size: 'sm'
...
function X(e) {
    ...
    if (!(null != s && (0, O.Z)(s, F.xjy.JOIN))) return null;
    let f = async (e) => {
            if (null != l && 'unsent' === c) {
                e.stopPropagation();
                try {
                ...
                return e
                    ...
                    .filter((e) => {
                        ...
                        return (
                            ...
                            })(null === (t = N.Z.getUserAffinity(i)) || void 0 === t ? void 0 : t.affinity, r, n) ||
                            (function (e, t, n) {
                                let { v2: i } = n;
                                if (null == e) return t;
