...
function T(e) {
    ...
    let H = (0, r.useRef)(n.focusedKey),
        j = (0, r.useRef)(null);
    (0, r.useEffect)(() => {
        if (
            n.isFocused &&
            null != n.focusedKey &&
            (n.focusedKey !== H.current || B.current) &&
            w.current &&
            T.current
        ) {
            let e = (0, g.ME)(),
        ...
        !b && n.isFocused && null == n.focusedKey && null != H.current && T.current && (0, A.l)(T.current),
            (H.current = n.focusedKey),
            (B.current = !1);
    }),
        (0, r.useEffect)(
            () => () => {
