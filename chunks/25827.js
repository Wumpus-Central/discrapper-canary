...
function S(e) {
    var { enabled: t, join: n, channel: i, onChange: a, onCameraUnavailable: s, cameraUnavailable: l, hasPermission: c, className: _, channelLimitReached: h, channelLimit: g, centerButton: b = !1, onPopoutClick: v } = e,
