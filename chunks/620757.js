...
let V = ["#B3269C", "#FF4CD2", "#FF7CDE", "#FD99E9"],
    s = [0.25, 0.5, 0.6, 0.7],
    i = [
        { base: 5, tint: 1 },
        { base: 3, tint: 1 },
...
function Ak(A) {
    let { width: v = 24, height: h = 24, primaryTintColor: f, secondaryTintColor: M, ...H } = A,
        w = B.useMemo(() => `badge-force-gradient-${(0, Au.A)()}`, []),
        { primaryColorsTransformed: t, secondaryColorsTransformed: D } = Q({
            primaryBaseColors: AY,
            primaryTintColor: f,
    ...
    return (0, g.jsxs)("svg", {
        ...
        children: [
            ...
            (0, g.jsx)("path", { d: "M10 13v-1H9v-2H8V6h1V4h1V3H7v1H6v3H5v4h1v2h1v1h4v-1h-1Z", fill: `url(#${w})` }),
...
function Aq(A) {
    ...
    return (0, g.jsxs)("svg", {
        ...
        xmlns: "http://www.w3.org/2000/svg",
        children: [
            (0, g.jsx)("path", { d: "M9 2V3H7V2H3V3H2V7H1V12H2V13H4V14H12V13H14V12H15V7H14V3H13V2H9Z", fill: H[1] }),
...
function A6(A) {
    ...
    return (0, g.jsxs)("svg", {
        ...
        children: [
            ...
            (0, g.jsx)("path", { d: "M5.99998 5H3.99998V3H2.99998V2H1.99998V1H4.99998V2H5.99998V5Z", fill: "white" }),
...
let vg = ["#ba3500", "#fd6214", "#ffb84b", "#f0f0f0"],
...
let vw = ["#4a8359", "#7fb134", "#bcef42", "#f0f0f0"],
    vt = [0.1, 0.2, 0.6, 0.9],
    vD = [
        { base: 4, tint: 1 },
        { base: 3, tint: 1 },
...
let va = ["#4E0B11", "#730E17", "#AC1F2B", "#EB2823", "#FF514C"],
...
function vy(A) {
    let { width: v = 24, height: h = 24, primaryTintColor: B, secondaryTintColor: f, ...M } = A,
        { primaryColorsTransformed: H, secondaryColorsTransformed: w } = Q({
            primaryBaseColors: vL,
            primaryTintColor: B,
            primaryTintLuminances: vb,
...
function v1(A) {
    ...
    return (0, g.jsxs)("svg", {
        ...
        xmlns: "http://www.w3.org/2000/svg",
        children: [
            (0, g.jsx)("path", { d: "M13 3V2h-2v1h-1V2H9V1H7v1H6v1H5V2H3v1H2v4h2v1h1V7h6v1h1V7h2V3h-1Z", fill: w[1] }),
...
function v7(A) {
    ...
    return (0, g.jsxs)("svg", {
        ...
        children: [
            ...
            (0, g.jsx)("path", { d: "M12 7H9v1h-1v1h-2v-1h1v-1h1v-1h4v1ZM13 8h-1v-1h1v1ZM8 6h-1v-1h1v1Z", fill: H[1] }),
            (0, g.jsx)("path", {
...
let hC = ["#4282d8", "#47baff", "#b5e3ff", "#f0f0f0"],
...
function ht(A) {
    ...
    return (0, g.jsxs)("svg", {
        ...
        children: [
            ...
            (0, g.jsx)("path", { d: "M7 2H6v1h1V2ZM8 3H7v1h1V3ZM5 5H4v1h1V5ZM3 6H2v1h1V6ZM2 7H1v1h1V7Z", fill: H[3] }),
...
function ha(A) {
    let { width: v = 24, height: h = 24, primaryTintColor: B, secondaryTintColor: f, ...M } = A,
        { primaryColorsTransformed: H, secondaryColorsTransformed: w } = Q({
            ...
            secondaryTintColor: f,
            secondaryTintLuminances: hi,
            secondaryLuminanceWeights: hZ,
        });
    return (0, g.jsxs)("svg", {
        ...(0, C.A)(M),
        width: v,
...
function hj(A) {
    let { width: v = 24, height: h = 24, primaryTintColor: B, secondaryTintColor: f, ...M } = A,
        { primaryColorsTransformed: H, secondaryColorsTransformed: w } = Q({
            ...
            primaryTintColor: B,
            primaryTintLuminances: hc,
            primaryLuminanceWeights: hx,
            secondaryBaseColors: ho,
            secondaryTintColor: f,
            secondaryTintLuminances: hL,
            secondaryLuminanceWeights: hb,
        });
    return (0, g.jsxs)("svg", {
        ...(0, C.A)(M),
        width: v,
...
function hT(A) {
    let { width: v = 24, height: h = 24, primaryTintColor: B, secondaryTintColor: f, ...M } = A,
        { primaryColorsTransformed: H, secondaryColorsTransformed: w } = Q({
            ...
            secondaryBaseColors: hF,
            secondaryTintColor: f,
            secondaryTintLuminances: hu,
            secondaryLuminanceWeights: hY,
        });
    return (0, g.jsxs)("svg", {
        ...(0, C.A)(M),
        width: v,
...
function hW(A) {
    ...
    return (0, g.jsxs)("svg", {
        ...
        children: [
            ...
            (0, g.jsx)("path", { opacity: ".5", d: "M11 8V7h-1V6H9V5H7v1H6v1H5v1H4v3h1v1h6v-1h1V8h-1Z", fill: "#fff" }),
            (0, g.jsx)("path", {
...
function h1(A) {
    ...
    return (0, g.jsxs)("svg", {
        ...
        children: [
            ...
            (0, g.jsx)("path", { d: "M2 10H1v-1h1v1ZM8 10h-1v-1h1v1ZM9 7h-1V4h1v3ZM10 4h-1v-1h1v1Z", fill: "white" }),
            (0, g.jsx)("path", {
...
function h7(A) {
    ...
    return (0, g.jsxs)("svg", {
        ...
        xmlns: "http://www.w3.org/2000/svg",
        children: [
            (0, g.jsx)("path", { d: "M14 4V3h-2V1H8v1H7v1H6V2H3v1H2v4H1v3h1V9h1V8h5V6h1V5h5v1h1V4h-1Z", fill: H[1] }),
            (0, g.jsx)("path", { d: "M9 6v1H8v2h1v2h2v1h3v-1h1V6H9Z", fill: w[1] }),
            (0, g.jsx)("path", { d: "M4 10v4h1v1h3v-1h1v-4H4Z", fill: w[1] }),
            (0, g.jsx)("path", { d: "M8 14H5v1h3v-1ZM14 11h-3v1h3v-1ZM15 10h-1v1h1v-1ZM9 13H8v1h1v-1Z", fill: w[0] }),
            ...
            (0, g.jsx)("path", { d: "M6 2H3v1h3V2ZM7 3H6v1h1V3ZM4 5H3v1h1V5ZM2 7H1v1h1V7ZM3 3H2v1h1V3Z", fill: H[2] }),
            (0, g.jsx)("path", {
...
function h5(A) {
    ...
    switch (v) {
        ...
        case h6.bl.MOON:
            return (0, g.jsx)(vx, { primaryTintColor: h, ...C });
        case h6.bl.LIGHTNING:
            return (0, g.jsx)(vZ, { primaryTintColor: h, ...C });
        case h6.bl.LEAF:
            return (0, g.jsx)(vl, { primaryTintColor: h, ...C });
        case h6.bl.HEART:
            return (0, g.jsx)(vh, { primaryTintColor: h, ...C });
        case h6.bl.FIRE:
            return (0, g.jsx)(Ax, { primaryTintColor: h, ...C });
        case h6.bl.COMPASS:
        ...
        case h6.bl.BUNNY:
            return (0, g.jsx)(n, { primaryTintColor: h, ...C });
        case h6.bl.DOG:
            return (0, g.jsx)(An, { primaryTintColor: h, secondaryTintColor: B, ...C });
        case h6.bl.FROG:
