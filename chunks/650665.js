...
function L() {
    let t = (0, N.QV)();
    if (t && s.Z1) {
        t.mark && d.m.performance.mark('sentry-tracing-init');
        let e = (0, R.to)(({ metric: t }) => {
            ...
            if ('navigation' !== R || !L || !(a + r < L))
                switch (e.entryType) {
                    ...
                    case 'measure': {
                        ...
                        let d = (0, A.Y)(),
                            R = e.startTime < d.firstHiddenTime;
                        'first-paint' === e.name &&
                            R &&
                    ...
                    case 'resource':
                        !(function (t, e, a, r, _, n) {
                            ...
                            let s = n + r;
                            (0, N.Y)(t, s, s + _, {
                                name: a.replace(d.m.location.origin, ''),
