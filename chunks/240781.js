...
let I = [
            ...
            children: [
                ...
                null != o &&
                    (0, r.jsx)(c.Text, {
                        ...
                        color: 'text-muted',
                        children: O.intl.format(O.t.Io7ozs, { days: o.days.toString() })
                    }),
                (0, r.jsxs)(c.Text, {
                    variant: 'text-xxs/normal',
                    color: 'text-muted',
                    children: [
                        a ? O.intl.format(O.t['req+eX'], { dateAcquired: d }) : O.intl.format(O.t.gW9R4O, { date: d }),
                        null != t.expiresAt &&
                            (0, r.jsxs)(r.Fragment, {
                                children: [
                                    (0, r.jsx)('br', {}),
    ...
    T = (e) => {
        let { user: t, guildId: n, avatarDecorationOverride: a, className: p } = e,
            ...
            { product: T, purchase: A } = (0, f.Z)(null == a ? void 0 : a.skuId),
