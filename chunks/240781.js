...
let y = [
    ...
    w = (e) => {
        let { user: t, guildId: n, avatarDecoration: l, className: v } = e,
        ...
        return null != l && (null == S || E)
            ? (0, r.jsxs)("div", {
                  className: a()(P.modalPreview, P.shopPreviewContainer, v),
                  children: [
                      (0, r.jsx)("div", {
