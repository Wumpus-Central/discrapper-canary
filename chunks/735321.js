...
function y(e, t) {
    ...
    if (null == n) return;
    let i = t.trim(),
        r = new o.k({ id: n.id, clips: n.clips.map((t) => (t.id === e ? { ...t, title: "" === i ? void 0 : i } : t)) });
    _.A.setPendingWidgets(C(r));
}
function v(e) {
    let t = L();
    if (null == t) return;
...
function B(e, t, n) {
    return (
        ...
        e.every((e, i) =>
            (function (e, t, n) {
                if (e.gameId !== t.gameId || (p(n) && V(e.comment) !== V(t.comment))) return !1;
                if (T(n)) {
                    let n = V(e.tags),
                        i = V(t.tags);
                    if (
