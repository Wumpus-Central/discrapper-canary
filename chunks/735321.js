...
function D(e) {
    ...
    let u = v(new c.Yy({ ...(s ?? { type: n }), games: t }));
...
function U(e, t, n) {
    return e.length === t.length && e.every((e, r) => k(e, t[r], n));
}
function G(e) {
