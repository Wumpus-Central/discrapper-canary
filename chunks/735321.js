...
function D(e) {
    ...
    let u = N(new d.Yy({ ...(s ?? { type: n }), games: t }));
...
function k(e, t, n) {
    return (
        ...
        e.every((e, r) =>
            (function (e, t, n) {
                if (e.applicationId !== t.applicationId || (g(n) && U(e.comment) !== U(t.comment))) return !1;
                if (A(n)) {
                    let n = U(e.tags),
                        r = U(t.tags);
                    if (
