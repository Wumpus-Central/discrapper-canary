...
function I(e, t) {
    let { showEditingControls: n } = t,
        i = e.games.length > 0;
    if (n && i)
        return 1 === a.u[e.type] ? A.intl.string(A.t.wiXdEa) : A.intl.format(A.t["zR1+0/"], { numGames: a.u[e.type] });
}
function f(e) {
...
function D(e) {
    ...
    u.A.setPendingWidgets(c), l.I.fetchMany([i.applicationId]);
}
function v(e, t) {
    if (e === t) return;
    let n = g();
...
function w(e, t, n) {
    return (
        ...
        e.every((e, i) =>
            (function (e, t, n) {
                if (e.applicationId !== t.applicationId || (f(n) && U(e.comment) !== U(t.comment))) return !1;
                if (p(n)) {
                    let n = U(e.tags),
                        i = U(t.tags);
                    if (
