...
let P = o.ZP.connectStores([_.Z, s.ZP, y.Z, h.Z, E.Z, b.Z, v.Z, f.Z, m.ZP], (e) => {
    var t, n, r, i;
    let o,
        ...
        C = N && A === I.Ez.PANEL,
        R = null != p && null != g && (null === (t = f.Z.getSelectedParticipant(g)) || void 0 === t ? void 0 : t.type) === T.fO.ACTIVITY,
        P = y.Z.windowSize();
    if (a) {
    ...
    let D = Array.from(v.Z.pipWindows.values()),
        x = v.Z.pipWidth(T.cL.VIDEO),
        L = [D.find((e) => e.component === S.NYg.VIDEO), D.find((e) => e.component === S.NYg.EMBED_IFRAME)].filter(O.lm),
        M = m.ZP.callChatSidebarWidth,
        k = b.Z.getVoiceChannelId(),
        j = b.Z.getChannelId() === k,
        U = null != k && f.Z.getChatOpen(k),
        G = C || R,
        B = G && null != p && (0, l.q)(p.applicationId),
        Z = !G && null != o && j && U;
    return {
        selectedPIPWindow: o,
        pipWindows: L,
