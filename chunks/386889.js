                                  ...
                                  s.Fragment,
                                  {
                                      children: [
                                          ...
                                          (0, i.jsxs)("div", {
                                              className: n8.vY,
                                              children: [
                                                  e.entries.map((e) => (0, i.jsx)(n9, { entry: e }, e.guildId)),
...
let ta = (e) => {
    ...
    } else n = (0, i.jsx)("div", { className: n8.vY, children: o.map((e) => (0, i.jsx)(n9, { entry: e }, e.guildId)) });
    return (0, i.jsx)("div", {
        className: n8.$$,
...
let td = (e) => {
    ...
    return I
        ...
        : null == u && null == a
          ...
          : u?.length === 0 && null == a
            ? (0, i.jsx)("div", { className: n8.$$, children: (0, i.jsx)(nw, { guild: l, onAddGuild: y }) })
            : (0, i.jsx)(te, {
                  channel: n,
                  searchQuery: f,
                  setSearchQuery: j,
...
function lV(e) {
    let { channel: n } = e,
        ...
        s = (0, lH.l)(n.id),
        { sortOrder: a, tagFilter: r, tagSetting: d } = (0, lU.R)(n.id),
        o = (0, A.bG)(
            [lw.A, lB.A],
            () => !!(lw.A.getThreadIds(n.id, a, r, d).length > 0) || !!(lB.A.getThreads(n.id, a, r, d).length > 0),
            [n.id, a, r, d],
        ),
        c = n.isMediaChannel();
...
class l4 extends s.PureComponent {
    ...
    renderVideoCallButton() {
        ...
        return (
            ...
            (0, i.jsx)(tA.Ay.Icon, { icon: lz.n, onClick: e, disabled: u || l, tooltip: c })
        );
    }
                    ...
                    children: (e) => {
                        ...
                        return n === g.M.ACTIVITY_GDM_CALL_TOOLTIP
                            ? (0, i.jsx)(lY.A, {
                                  ...
                                  onRequestClose: () => t(l5.i.USER_DISMISS),
                              })
                            : null;
                    },
                }),
    ...
    handleVoiceClick = (e) => {
        ...
        if (
            (l.includes(g.M.ACTIVITY_GDM_CALL_TOOLTIP) &&
                (0, to.Dr)(g.M.ACTIVITY_GDM_CALL_TOOLTIP, { dismissAction: l5.i.AUTO }),
            n)
        );
...
let ic = s.memo(function (e) {
    ...
    s.useEffect(() => {
        null != r &&
            null != l &&
            (it.O.announce(Y.intl.string(Y.t.acsXuG)),
            setTimeout(() => {
                (0, ii.xi)(n.id, [r.id]);
            }, 5e3),
            (0, id.QF)({
                ...
                viewName: id.gN.SAFETY_TOOLS_NUDGE_TOOLTIP,
            })),
            a &&
                (it.O.announce(Y.intl.string(Y.t["1dxCqG"])),
                setTimeout(() => {
                    (0, ii.bg)(n.id);
                }, 5e3));
    }, [n, r, l, a]),
        (0, F.Ay)(() => {
            null != l &&
                (0, id.QF)({
                    ...
                    warningType: l.type,
                    isNudgeWarning: null != r,
                    viewName: id.gN.SAFETY_TOOLS_BUTTON,
                });
        }),
        s.useEffect(() => {
            let e = c();
        ...
        null != r && (0, ii.xi)(n.id, [r.id]),
            null != l &&
                ...
                (0, id._$)({
                    ...
                    warningId: l.id,
                    warningType: l.type,
                    cta: id.Wm.USER_SAFETY_TOOLS_BUTTON_CLICK,
                    isNudgeWarning: null != r,
                }));
    }, [r, l, n]);
    return null == l
...
let ig = s.memo(function (e) {
    let { channel: n } = e,
        t = (0, lZ.A)(),
        l = (0, A.bG)([tw.A], () => tw.A.isInChannel(n.id)),
        a = (0, A.bG)([tw.A], () => !u().isEmpty(tw.A.getVoiceStatesForChannel(n.id))),
        r = (0, A.bG)([iA.A], () => iA.A.can(er.xBc.CONNECT, n)),
        { needSubscriptionToAccess: d } = (0, la.A)(n.id),
        o = (0, ih.Id)(n),
        { enabled: c } = ih.io.useExperiment({ guildId: n.guild_id, location: "63250c_1" }, { autoTrackExposure: !1 }),
        h = s.useCallback(() => {
            iu.A.handleVoiceConnect({ channel: n, connected: l, needSubscriptionToAccess: d, locked: !1 });
        }, [n, l, d]);
    return (s.useEffect(() => {
        if (c)
            return (
...
function iI(e) {
    ...
    return (0, i.jsx)(tA.In, {
        ...
        icon: im.n,
        onClick: () => {
            (0, ix.am)({ displayProfile: s, isProfileOpen: !r }), lI.A.toggleUserProfileSidebarSection();
        },
        selected: r && !t,
    });
}
let ib = {};
class iC extends A.Ay.PersistedStore {
...
let iE = new iC(nR.h, {
    GUILD_PROMPT_VIEWED: function (e) {
        let { prompt: n, guildId: t } = e,
            l = ib[t];
        return null == l ? ((ib[t] = new Set()), ib[t].add(n), !0) : !l.has(n) && (l.add(n), !0);
    },
    GUILD_DELETE: function (e) {
        let { guild: n } = e;
        return null != ib[n.id] && !n.unavailable && (delete ib[n.id], !0);
    },
});
var iy = (((l = {}).REAL_NAME_PROMPT = "REAL_NAME_PROMPT"), l),
    iv = t(376943),
    iN = t(394953),
    i_ = t(241541),
    iT = t(709066),
...
function ik(e) {
    ...
    let d = l && r.every((e) => e.user.isStaff()),
        o = (0, iR.G)("PrivateChannelRecipients"),
                        ...
                        o &&
                            (0, i.jsx)("div", {
                                ...
                                children: (0, i.jsx)(ie.NE, {
                                    ...
                                    entryPointType: ie.YW.MEMBER_LIST,
                                }),
                            }),
                    ],
                }),
...
function sj(e) {
    ...
    return (0, i.jsxs)(tA.Ay, {
        ...
        children: [
            (0, i.jsx)(tA.Ay.Icon, { icon: iz.y, disabled: !0, "aria-label": Y.intl.string(Y.t["7Xm5QI"]) }),
...
function sE(e) {
    ...
    let p = (0, A.bG)([iA.A], () => iA.A.can(er.xBc.ATTACH_FILES, n)),
...
function sk(e) {
    ...
    let l,
        ...
        h = (0, tu.Ay)(o);
    (n = o),
        (l = (0, A.bG)([tw.A], () => null != n && !u().isEmpty(tw.A.getVoiceStatesForChannel(n.id)))),
        s.useEffect(() => {
            l &&
                null != n &&
    ...
    let { context: n, analyticsLocations: t, profileFrame: l, handleOpenProfile: s } = e,
        ...
        r = a
            ? (0, i.jsx)("div", {
                  ...
                  children: (0, i.jsx)(ns.D, {
                      onClick: () => {
                          s(), (0, ix.Wn)({ action: "PRESS_VIEW_PROFILE", analyticsLocations: t, ...n });
                      },
                      className: s8.wC,
                      children: (0, i.jsx)(y.E, {
                          color: "text-strong",
            ...
            : null;
    return null != l
        ? (0, i.jsxs)("div", { className: s8.xQ, children: [(0, i.jsx)(s9.A, { frame: l, filterLayer: s4 }), r] })
        : r;
}
var ae = t(996988),
    an = t(556818),
        ...
        children: [
            (0, i.jsx)("div", {
                ...
                children: (0, i.jsx)(a6.A, {
                    ...
                    onClick: x,
                    "aria-label": Y.intl.formatToPlainString(Y.t.ZBB4Ty, { productName: (0, a4.TC)(n) }),
            ...
            a && (0, i.jsx)(rt, { title: g.title, description: g.description, onClick: x }),
        ],
    });
}
function ru(e) {
...
function rp(e) {
    let { unownedWishlistItems: n = [], profileOwner: t, onClick: l, wishlistId: a, title: r } = e,
        ...
        m = (0, rm.A)({ wishlistId: a ?? null, onAction: u, productLines: A }),
        x = (0, s.useMemo)(
            () =>
                h
                    .map((e, s) =>
    ...
    return (0, i.jsxs)("div", {
        ...
        children: [
            (0, i.jsxs)(lW.A, {
                ...
                children: [
                    (0, i.jsx)(lW.A.Icon, { icon: rS.N, "aria-hidden": !0 }),
...
var rM = t(943712),
    ...
    rw = t(516607),
    rU = t(964623);
let rF = () => (0, i.jsx)("div", { className: rU.wG, children: (0, i.jsx)(x.y, {}) }),
    rH = (0, nT.Fe)({
        createPromise: () =>
            Promise.all([
                t.e("48272"),
    ...
    rY = (0, nT.Fe)({ createPromise: rW, webpackId: 67319, name: "StageChannelCall", renderLoader: rF }),
    rz = (0, nT.Fe)({
        createPromise: () =>
            Promise.all([
                t.e("48272"),
...
class rq extends s.PureComponent {
        ...
        switch (e.type) {
            ...
            case er.rbe.DM:
                d.push(this.renderClipsEnabledIndicatorToolbarItem()),
                    ...
                    d.push((0, i.jsx)(l6, { channel: e }, "calls")),
                    ...
                    d.push((0, i.jsx)(iI, { channel: e, showCallOrActivityPanel: l || s || a }, "profile")),
                    d.push((0, i.jsx)(ic, { channel: e }, "safety_tools"));
                break;
            case er.rbe.GROUP_DM:
                d.push(this.renderJoinRequestInterviewButtons()),
                    ...
                    d.push((0, i.jsx)(lS, { channel: e }, "pins")),
                    e.isManaged() ||
                        d.push((0, i.jsx)(ie.Ay, { channel: e, tooltip: Y.intl.string(Y.t.NB5DFD) }, "invite")),
            ...
            case er.rbe.PUBLIC_THREAD:
                e.isModeratorReportChannel() && d.push((0, i.jsx)(tq, { channel: e })),
                    ...
                    e.isVocalThread() &&
                        (d.push((0, i.jsx)(ig, { channel: e }, "thread-call")),
                        d.push((0, i.jsx)(tU, { channel: e }, "thread-view-toggle"))),
    ...
    renderEmbeddedActivityPanel() {
        ...
        return (0, i.jsx)(e9, { maxHeight: t, renderExternalHeader: this.renderHeaderBar });
    }
    renderChat() {
        let {
            channel: e,
            ...
            null == e ||
                ...
                (d &&
                    (0, m.openModalLazy)(
                        ...
                        { onCloseCallback: () => ll(iy.REAL_NAME_PROMPT, n), modalKey: "Guild Hub Real Name Modal" },
                    ),
                s &&
                    (0, m.openModalLazy)(
                        async () => {
...
let rX = (0, ep.A)(rq),
    rQ = s.memo(function (e) {
        ...
        let O = (0, A.bG)([eI.Ay], () => eI.Ay.getCurrentEmbeddedActivity()),
            ...
            w = (0, A.bG)([le.A], () => le.A.getFrameLayoutMode() === rG.y.FOCUSED),
            ...
            V =
                ((n = E?.id),
                (l = (0, A.bG)([nZ.A, iE, J.default, X.Ay], () => {
                    let e = nZ.A.getGuild(n);
                    if (
                        e?.features.has(er.GuildFeatures.HUB) !== !0 ||
                        !0 === iE.hasViewedPrompt(iy.REAL_NAME_PROMPT, e.id)
                    )
                        return null;
                ...
                s.useEffect(() => {
                    null != n && null != l && (l || ll(iy.REAL_NAME_PROMPT, n));
                }, [l, n]),
                !0 === l),
            W =
                ((t = E?.id),
                (0, A.bG)([ek.A, nZ.A, eG.A], () => {
                    ...
                    return U === eG.A.getChannelId(t) && null != n && n.getGuildId() === e.id && (0, rE.ke)(n.type);
                })),
            ...
            K = E?.id,
            q = (0, A.bG)([lb.Ay], () => lb.Ay.getGuildSidebarState(K), [K]),
            $ = (0, iN.lI)(),
            Z = (0, tu.Ay)(f),
            ee = (0, tu.Ay)(f, !0),
        ...
        !(function (e) {
            ...
            s.useEffect(() => {
                ...
                if (e?.location?.state?.stageInviteKey === rw.J2) {
                    let { channelId: n } = (0, iv.vu)(e?.location?.pathname) ?? {};
                    null != n && d(n);
                }
            }, []);
        ...
        s.useEffect(() => {
            let e = eA && !eh,
                n = eA && eh && f?.id !== eg;
            (e || n) && (0, to.Dr)(g.M.ACTIVITY_GDM_CALL_TOOLTIP, { dismissAction: l5.i.AUTO });
        }, [f?.id, eg, eh, eA]);
