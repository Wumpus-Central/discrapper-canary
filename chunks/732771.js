...
let C = r.createContext({
    ...
    setActiveDescendantIndex: N.tEg,
    loading: !1,
    selectionMode: "single",
    handleSelectionChange: N.tEg,
    onSelectionChange: N.tEg,
    isOpen: !1,
    setIsOpen: N.tEg,
    isEditing: !1,
    setIsEditing: N.tEg,
...
function P(e) {
    let {
        ...
        ea = "multiple" === U && z,
        eo = null != x ? (0, f.ZN)(j, x) : void 0,
        el = r.useCallback(() => {
            K || Q?.((e) => (e || w.current?.focus(), !e));
        }, [K, Q]),
        eu = r.useCallback(() => {
            !0 === B && ("multiple" === U ? X([]) : X(null), ei(""), w.current?.focus());
        }, [X, U, B, ei]),
        ec = r.useCallback(
            (e) => {
    ...
    let eh = r.useCallback(() => {
        ...
        eE = r.useCallback(
            ...
            [U, H, B, z, W, Z, y, eu, q, ee, en, Q, et, x, k],
        ),
        em = r.useCallback(
            (e) => {
        ...
        children: [
            (0, i.jsx)(E.p, {
                ...
                children: (0, i.jsx)("div", {
                    className: a()(D._U, { [D.kS]: ea, [D.kj]: ea && N }),
                    onClick: eh,
