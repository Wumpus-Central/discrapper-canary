...
function R(e) {
    let { guildBoostSlot: t, isCancellable: n, onCancel: s, onUncancel: l, premiumSubscription: a, useReducedMotion: o, boostManagementDisabledFromFractionalPremium: d } = e,
        ...
        h = d ? I.intl.format(I.t.hshta2, { helpCenterLink: C.Z.getArticleURL(T.BhN.FRACTIONAL_PREMIUM_ABOUT) }) : I.intl.string(I.t.mOWsFx);
    return (0, i.jsxs)(
        'li',
        {
...
let w = function (e) {
    ...
    let Q = U.length;
    if (((t = Y ? I.intl.formatToPlainString(F ? I.t['3DW6DQ'] : I.t['/u15QU'], { numUnappliedGuildBoostSlots: Q }) : I.intl.formatToPlainString(F ? I.t['3DW6DQ'] : I.t.BPadnJ, { numUnappliedGuildBoostSlots: Q })), j.ZP.isPremium(w))) {
        let e = (e, t) =>
            (0, i.jsx)(
                c.P3F,
                {
    ...
    let J = (0, a.EQ)({
        ...
        .with(
            ...
            () => I.intl.format(I.t['4RgA6O'], { helpCenterLink: C.Z.getArticleURL(T.BhN.FRACTIONAL_PREMIUM_ABOUT) })
        )
        .with(
            {
                subscriptionIsPausedOrPausePending: !0,
