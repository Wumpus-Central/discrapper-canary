...
function C(e) {
    ...
    let Z = i.useRef(S),
        ...
        R = i.useCallback(
            (e, r) => {
                r !== e &&
                    ...
                    r === y.AEg.FULL_SCREEN && t.isPrivate() && g.S.dispatch(y.CkL.TEXTAREA_BLUR));
            },
            [n, t],
        ),
        M = i.useCallback(
        ...
        D = i.useCallback(
            (e) => () => {
                null != N &&
                    ((0, d.v)(O, d.d.FULL_SCREEN, e !== y.AEg.FULL_SCREEN),
                    e !== y.AEg.FULL_SCREEN ? ((Z.current = e), R(e, y.AEg.FULL_SCREEN), (0, _.Dj)(N)) : M(e));
            },
            [R, M, N, O],
        );
    i.useEffect(() => {
