...
function G(e) {
    ...
    let eb = (e) => {
            if ((e.preventDefault(), el === C.j8.PUBLIC && q.length < 20 && !ec)) return void eu(!0);
            J ||
                null == z ||
                z({
                    topic: q,
        ...
        ej = (0, r.jsxs)(r.Fragment, {
            children: [
                (0, r.jsx)("div", {
                    ...
                    children: null == M && (es > 0 || eo > 0) && (0, r.jsx)(S.mv, { channelId: i.id }),
                }),
                (0, r.jsxs)("form", {
                    onSubmit: eb,
                    className: I.form,
                    children: [
                        (0, r.jsx)(c.oil, {
                            ...
                            onChange: (e) => L(e),
                            helperText: ec ? D.intl.string(D.t.AqTyaR) : void 0,
