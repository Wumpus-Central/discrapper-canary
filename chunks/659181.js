...
class d extends o.Z {
    ...
    isAvailableForDistribution() {
        return (
            ...
            null != this.getPrice() &&
            null == this.externalPurchaseUrl &&
            (!this.premium || (0, a.yE)(this.flags, l.l4R.PREMIUM_AND_DISTRIBUTION))
        );
    }
    isAvailable() {
    ...
    isPremiumPerk() {
        return (
            this.premium &&
            ((0, a.yE)(this.flags, l.l4R.PREMIUM_PURCHASE) || (0, a.yE)(this.flags, l.l4R.PREMIUM_AND_DISTRIBUTION))
        );
    }
    hasFeature(e) {
