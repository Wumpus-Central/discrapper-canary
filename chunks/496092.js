...
let h = {
    ...
    joinVoiceEvent(e, t) {
        a.default.selectVoiceChannel(t), (0, s.pX)(p.BVt.CHANNEL(e, t));
    },
    saveEvent(e, t, n) {
        let i = f.GW.has(t.entityType) ? t.channelId : null,
            a = f.o_.has(t.entityType) ? t.entityMetadata : null,
    ...
    async fetchGuildEventUserCounts(e, t, n) {
        let a = {
            ...
            l = { eventCount: s, recurrenceCounts: o };
        return (
            i.h.dispatch({
    ...
    async createRsvpForGuildEvent(e, t, n, a) {
        ...
        try {
            return (
                ...
                await r.Bo.put({ url: p.Rsh.USER_GUILD_EVENT(n, e, t), body: { response: a }, rejectWithError: !1 })
            );
        } catch (r) {
            throw (
                (i.h.dispatch({
    ...
    async fetchUsersForGuildEvent(e, t, n) {
        let a = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : f.C1;
        if (null == e || null == n) return [];
        let s = await r.Bo.get({
            url: p.Rsh.GUILD_EVENT_USERS(n, e, t),
            query: { limit: a, with_member: !0, upgrade_response_type: !0 },
            rejectWithError: !1,
        });
        return (
            i.h.dispatch({
    ...
    createGuildEventException(e, t, n) {
        ...
        return r.Bo.post({
            ...
            body: { original_scheduled_start_time: i, scheduled_start_time: a, scheduled_end_time: s, is_canceled: o },
            rejectWithError: !1,
        });
    },
    updateGuildEventException(e, t, n, i) {
        ...
        return r.Bo.patch({
            ...
            body: { scheduled_start_time: a, scheduled_end_time: s, is_canceled: o },
            rejectWithError: !1,
        });
    },
