...
let p = {
    startEvent: (e, t) =>
        i.Bo.patch({ url: f.Rsh.GUILD_EVENT(t, e), body: { status: h.XG.ACTIVE }, rejectWithError: !1 }),
    endEvent: (e, t) =>
        i.Bo.patch({ url: f.Rsh.GUILD_EVENT(t, e), body: { status: h.XG.COMPLETED }, rejectWithError: !1 }),
    joinVoiceEvent(e, t) {
        s.default.selectVoiceChannel(t), (0, a.pX)(f.BVt.CHANNEL(e, t));
    },
    saveEvent(e, t, n) {
        let r = h.GW.has(t.entityType) ? t.channelId : null,
            s = h.o_.has(t.entityType) ? t.entityMetadata : null,
        ...
        return i.Bo.patch({ url: f.Rsh.GUILD_EVENT(n, e), body: o, rejectWithError: !1 });
    },
    createGuildEvent(e, t) {
        ...
        return i.Bo.post({ url: f.Rsh.GUILD_EVENTS_FOR_GUILD(t), body: n, rejectWithError: !1 });
    },
    async fetchGuildEvent(e, t) {
        let { body: n } = await (0, u.aP)({ url: f.Rsh.GUILD_EVENT(e, t), rejectWithError: !1 });
        return r.h.dispatch({ type: "FETCH_GUILD_EVENT", guildScheduledEvent: n }), n;
    },
    async fetchGuildEventsForGuild(e) {
        let t = { url: f.Rsh.GUILD_EVENTS_FOR_GUILD(e), rejectWithError: !1 },
    ...
    async fetchGuildEventUserCounts(e, t, n) {
        let s = {
                url: f.Rsh.GUILD_EVENT_USER_COUNTS(e, t),
    ...
    cancelGuildEvent: (e, t) =>
        i.Bo.patch({ url: f.Rsh.GUILD_EVENT(t, e), body: { status: h.XG.CANCELED }, rejectWithError: !1 }),
    deleteGuildEvent: (e, t) => i.Bo.del({ url: f.Rsh.GUILD_EVENT(t, e), rejectWithError: !1 }),
    async getGuildEventsForCurrentUser(e) {
        let { body: t } = await i.Bo.get({
            url: f.Rsh.USER_GUILD_EVENTS,
            query: { guild_ids: [e] },
            rejectWithError: !1,
        });
    ...
    async createRsvpForGuildEvent(e, t, n, s) {
        ...
        try {
            return (
                ...
                await i.Bo.put({ url: f.Rsh.USER_GUILD_EVENT(n, e, t), body: { response: s }, rejectWithError: !1 })
            );
        } catch (i) {
            throw (
                (r.h.dispatch({
        ...
        if (null != a)
            try {
                return (
                    ...
                    await i.Bo.del({ url: f.Rsh.USER_GUILD_EVENT(n, e, t), rejectWithError: !1 })
                );
            } catch (i) {
                throw (
                    (r.h.dispatch({
    ...
    async fetchUsersForGuildEvent(e, t, n) {
        let s = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : h.C1;
    ...
    createGuildEventException(e, t, n) {
        ...
        return i.Bo.post({
            url: f.Rsh.GUILD_EVENT_EXCEPTIONS(t, n),
    ...
    updateGuildEventException(e, t, n, r) {
        ...
        return i.Bo.patch({
            url: f.Rsh.GUILD_EVENT_EXCEPTION(t, n, r),
            body: { scheduled_start_time: s, scheduled_end_time: a, is_canceled: o },
            rejectWithError: !1,
        });
    },
    deleteGuildEventException: (e, t, n) =>
        i.Bo.del({ url: f.Rsh.GUILD_EVENT_EXCEPTION(e, t, n), rejectWithError: !1 }),
