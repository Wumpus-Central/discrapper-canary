...
class L extends n.PureComponent {
    ...
    renderItem = (e, t, r, n) => {
        ...
        return (0, s.jsx)(
            b,
            {
                ...
                renderExtras: () => (0, s.jsx)(S.A, { className: x.uJ, ...a }),
                focused: T(a) === l,
    ...
    renderContent = (e, t, r) => {
        let { className: n, data: l, resultQuery: a, query: o, resultType: c } = this.props;
        return 0 === l.length && (a !== o || c === w.dD.TRENDING_GIFS)
            ? (0, s.jsx)(
                  I.f,
                  {
                      fade: !0,
