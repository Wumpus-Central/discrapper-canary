...
let v = o.vB(0),
    ...
    P = o.$e(b.Plq.MANAGE_GUILD, b.Plq.MANAGE_ROLES, b.Plq.ADMINISTRATOR, b.Plq.BAN_MEMBERS, b.Plq.MANAGE_NICKNAMES, b.Plq.CREATE_GUILD_EXPRESSIONS, b.Plq.MANAGE_GUILD_EXPRESSIONS, b.Plq.MANAGE_WEBHOOKS, b.Plq.VIEW_AUDIT_LOG);
function R(e, t, n) {
...
function D(e) {
    ...
    return (f = o.e$(f, b.Plq.ADMINISTRATOR) ? I : w(r.id, n, f, i)), (u.Z.isLurking(r.id) || (null == n ? void 0 : n.isPending)) && (f = o.hX(f, c)), h.ZP.isCurrentUserGuest(r.id) && (f = o.hX(f, A)), R(f, r, t, s);
}
function L(e) {
    let t,
    ...
    if (r instanceof f.Sf) {
        ...
        (l = null != (c = r.computeLurkerPermissionsAllowList()) ? c : l), (i = null != i ? O({}, r.permissionOverwrites, i) : r.permissionOverwrites);
        let e = r.getGuildId();
