...
class et {
    ...
    _areGuildVocalChannelsInRecentsInNeedOfAppearingInActiveNow(e) {
        ...
        for (let e in r.channels) {
            let t = r.channels[e];
            if (2 === t.renderLevel && t.record.isGuildVocal() && null == n.channels[t.id] && o().some(Z.Z.getVoiceStatesForChannel(t.id)) && N.ZP.getMentionCount(t.id) > 0) return !0;
        }
        return !1;
    }
    getGuild(e, t, n) {
    ...
    nonPositionalChannelIdUpdate(e) {
        ...
        return null != t && null != t.guild_id && null != this.guilds[t.guild_id] && (t instanceof j.Sf || null != (t = S.Z.getChannel(e))) && this.nonPositionalChannelUpdate(t);
    }
...
class en {
    get initializationData() {
        return {
            selectedChannel: S.Z.getChannel(w.Z.getChannelId()),
            selectedVoiceChannelId: w.Z.getVoiceChannelId(),
            activeJoinedRelevantThreads: C.Z.getActiveJoinedRelevantThreadsForGuild(this.id),
            activeJoinedUnreadThreads: C.Z.getActiveJoinedUnreadThreadsForGuild(this.id)
        };
    }
    invalidate() {
    ...
    constructor(e, t, n) {
        ...
        for (let e in a) {
            ...
            if (t.type !== G.d4z.GUILD_CATEGORY) {
                ...
                (ev(this, t, C) ? p.push(t) : (t.type === G.d4z.GUILD_VOICE || t.type === G.d4z.GUILD_STAGE_VOICE) && (null != t.parent_id && null != c[t.parent_id] && m.push(c[t.parent_id]), m.push(t)), null != t.parent_id && t.parent_id in h ? h[t.parent_id].push(t) : u.push(t));
            }
        }
        for (let e in ((this.categories = {}), h)) this.categories[e] = new el(this, c[e], h[e], C);
        ((this.recentsSectionNumber = Q), (this.favoritesSectionNumber = X), (this.noParentCategory = new ei(this, u, C)), (this.favoritesCategory = new eo(this, C)), (this.recentsCategory = (0, f.Q)() ? new ea(this, a, C) : new es(this, p, C)), (this.voiceChannelsCategory = new ec(this, m, c, C)), (this.guildActionSection = new ed(t, _.length > 0)), (this.channelNoticeSection = new eu(n)), i()(!('null' in this.categories), 'somehow a null got into categories'), (this.voiceChannelsSectionNumber = $ + o().size(this.categories)));
    }
}
class er {
    updateChannel(e, t) {
...
class el extends er {
    ...
    constructor(e, t, n, r) {
        for (let i of (super(e), H(this, 'id', void 0), H(this, 'record', void 0), (this.record = t), (this.id = t.id), (this.isCollapsed = !0 === e.collapsedCategoryIds[t.id]), (this.isMuted = e.mutedChannelIds.has(t.id)), (this.channels = {}), n)) this.channels[i.id] = new ep(this, i, r);
    }
}
class eo extends er {
    updateChannel(e, t) {
    ...
    constructor(e, t) {
        ...
        this.channels = o()(null != (n = T.ZP.getGuildFavorites(e.id)) ? n : [])
...
class ea extends er {
    ...
    constructor(e, t, n) {
        if ((super(e), H(this, 'enabled', !1), (this.isCollapsed = m.Z.isCollapsed(e.id)), (this.enabled = !1), this.enabled)) for (let e of Object.values(t)) (0, j.vc)(e.type) && !(0, j.Q5)(e.type) && (this.channels[e.id] = new em(this, e, n));
    }
}
(H(ea, 'MIN_READABLE_CHANNELS', 7), H(ea, 'MAX_RECENT_CHANNELS', 10), H(ea, 'MAX_TIMESTAMP_DELTA', 604800000));
class es extends er {
    updateAllChannels(e) {
        let t = !1;
        return (
    ...
    updateChannel(e, t) {
        ...
        if (this.guild.optInEnabled) {
            ...
            if (ev(this.guild, e, t) && null == n) return ((this.channels[e.id] = new eg(this, e, t)), this.invalidate(), !0);
        }
        return n;
    }
    getFirstVoiceChannel(e) {
...
class ed {
    ...
    constructor(e, t) {
        (H(this, 'guildActionRows', void 0), (this.guildActionRows = e.map(String)), t && this.guildActionRows.push(String(U.z.GUILD_DIRECTORY)));
    }
}
class eh {
    get isMuted() {
...
class eg extends eh {
    computeState(e) {
        ...
        let { selectedChannel: n, selectedVoiceChannelId: r, activeJoinedRelevantThreads: i } = e;
        return P.Z.can(V.Pl.VIEW_CHANNEL, this.record)
            ? ev(this.category.guild, this.record, e)
                ? {
...
class em extends ep {
    computeState(e) {
        ...
        if (t > 1) {
            ...
            (i.mutedChannelIds.has(this.id) || (null != r && i.mutedChannelIds.has(r)) ? (t = 2) : 4 === t ? (t = 3) : 2 === t && ev(this.category.guild, this.record, e) && (t = 3), 3 === t && eC(this, e) && (t = 4), (n = o().sortBy(n, (e) => -N.ZP.lastMessageTimestamp(e))));
        }
        return {
            renderLevel: t,
            threadIds: n
...
class eb extends ep {
    getRenderLevel(e) {
        ...
        return !P.Z.can(V.Pl.VIEW_CHANNEL, this.record) || 4 === e || 3 === e || ey(t, this.record) ? 1 : this.category.isCollapsed ? (o().some(Z.Z.getVoiceStatesForChannel(this.record.id)) ? 4 : 3) : 4;
    }
    computeState(e) {
...
function eO(e, t, n, r, i) {
    ...
    if (j.uC.has(e.type)) {
        let e = o()
            ...
            .map((e) => e.channel.id);
        return l ? e : a ? (n.id in t || e.unshift(n.id), e) : i ? e.filter((e) => !v.Z.isMuted(e) || N.ZP.getMentionCount(e) > 0) : e;
    }
    return [];
}
function ey(e, t) {
...
function ev(e, t, n) {
    ...
    if (t.isGuildVocal()) {
        ...
        if (!n) return !1;
        let r = o().some(Z.Z.getVoiceStatesForChannel(t.id));
        if (n && r) return !1;
    }
