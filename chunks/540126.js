...
class ea extends er {
    shouldShowEmptyCategory() {
        return !!(
            ...
            (N.Z.can(B.Pl.MANAGE_CHANNELS, this.record) &&
                N.Z.can(B.Pl.VIEW_CHANNEL, this.record) &&
...
class e_ extends ep {
    computeState(e) {
        ...
        if (!N.Z.can(B.Pl.VIEW_CHANNEL, this.record)) {
            if (this.id === r)
                return {
                    renderLevel: 4,
                    threadIds: [],
...
class em extends ep {
    computeState(e) {
        ...
        return N.Z.can(B.Pl.VIEW_CHANNEL, this.record)
            ? {
                  renderLevel: 4,
