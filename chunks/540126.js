...
let H = 'placeholder-channel-id',
    ...
    W = 4,
    K = 5,
    q = new Set([String(x.z.GUILD_DIRECTORY)]);
class X {
    ...
    nonPositionalChannelIdUpdate(e) {
        ...
        return null != t && null != t.guild_id && null != this.guilds[t.guild_id] && (t instanceof m.Sf || null != (t = T.Z.getChannel(e))) && this.nonPositionalChannelUpdate(t);
    }
...
class Q {
    get initializationData() {
        return {
            selectedChannel: T.Z.getChannel(A.Z.getChannelId()),
            selectedVoiceChannelId: A.Z.getVoiceChannelId(),
    ...
    constructor(e, t, n) {
        ...
        for (let e in a) {
            ...
            if (t.type !== U.d4z.GUILD_CATEGORY) {
                ...
                ev(this, t, _) ? g.push(t) : (t.type === U.d4z.GUILD_VOICE || t.type === U.d4z.GUILD_STAGE_VOICE) && (null != t.parent_id && null != d[t.parent_id] && p.push(d[t.parent_id]), p.push(t)), null != t.parent_id && t.parent_id in h ? h[t.parent_id].push(t) : u.push(t);
            }
        }
        for (let e in ((this.categories = {}), h)) this.categories[e] = new ee(this, d[e], h[e], _);
        (this.recentsSectionNumber = Y), (this.favoritesSectionNumber = z), (this.noParentCategory = new $(this, u, _)), (this.favoritesCategory = new et(this, _)), (this.recentsCategory = (0, f.Q)() ? new en(this, a, _) : new ei(this, g, _)), (this.voiceChannelsCategory = new el(this, p, d, _)), (this.guildActionSection = new es(t, E.length > 0)), (this.channelNoticeSection = new er(n)), l()(!('null' in this.categories), 'somehow a null got into categories'), (this.voiceChannelsSectionNumber = K + s().size(this.categories));
    }
}
class J {
    updateChannel(e, t) {
...
class ee extends J {
    shouldShowEmptyCategory() {
        return !!(super.shouldShowEmptyCategory() || (O.Z.can(j.Pl.MANAGE_CHANNELS, this.record) && O.Z.can(j.Pl.VIEW_CHANNEL, this.record) && s().isEmpty(this.channels) && (!this.guild.optInEnabled || this.guild.optedInChannels.has(this.id))));
    }
    constructor(e, t, n, i) {
        for (let l of (super(e), F(this, 'id', void 0), F(this, 'record', void 0), (this.record = t), (this.id = t.id), (this.isCollapsed = !0 === e.collapsedCategoryIds[t.id]), (this.isMuted = e.mutedChannelIds.has(t.id)), (this.channels = {}), n)) this.channels[l.id] = new eo(this, l, i);
    }
}
class et extends J {
    updateChannel(e, t) {
        let n = e.id in this.channels && b.ZP.isFavorite(e.guild_id, e.id),
            i = C.Z.getSuggestedChannelId(e.guild_id);
        return (e.id !== i ||
            n ||
            (t = {
                ...t,
    ...
    constructor(e, t) {
        ...
        this.channels = s()(null !== (n = b.ZP.getGuildFavorites(e.id)) && void 0 !== n ? n : [])
            ...
            .keyBy((e) => e.id)
            .value();
        let i = C.Z.getSuggestedChannelId(e.id),
            l = T.Z.getChannel(i);
        null != l &&
            null != i &&
...
class en extends J {
    ...
    constructor(e, t, n) {
        if ((super(e), F(this, 'enabled', !1), (this.isCollapsed = p.Z.isCollapsed(e.id)), (this.enabled = !1), this.enabled)) for (let e of Object.values(t)) (0, m.vc)(e.type) && !(0, m.Q5)(e.type) && (this.channels[e.id] = new ec(this, e, n));
    }
}
F(en, 'MIN_READABLE_CHANNELS', 7), F(en, 'MAX_RECENT_CHANNELS', 10), F(en, 'MAX_TIMESTAMP_DELTA', 604800000);
class ei extends J {
    updateAllChannels(e) {
        let t = !1;
        return (
...
class es {
    ...
    constructor(e, t) {
        F(this, 'guildActionRows', void 0), (this.guildActionRows = e.map(String)), t && this.guildActionRows.push(String(x.z.GUILD_DIRECTORY));
    }
}
class ea {
    get isMuted() {
...
class eo extends ea {
    computeState(e) {
        ...
        if (!O.Z.can(j.Pl.VIEW_CHANNEL, this.record)) {
            if (this.id === i)
                return {
                    renderLevel: 4,
                    threadIds: []
        ...
        return o.optInEnabled && o.hideResourceChannels && this.record.hasFlag(G.zZ.IS_GUILD_RESOURCE_CHANNEL)
            ...
            : !o.optInEnabled || o.optedInChannels.has(this.id) || (null != a && o.optedInChannels.has(a))
              ? d || c || !s().isEmpty(g) || P.ZP.getMentionCount(this.id) > 0
                  ? {
                        renderLevel: 4,
                        threadIds: g
                    }
                  : o.hideMutedChannels && o.mutedChannelIds.has(this.id)
                    ...
                    : this.category.isCollapsed && (o.mutedChannelIds.has(this.id) || (null != a && o.mutedChannelIds.has(a)) || this.record.isGuildVocal() || this.record.type === U.d4z.GUILD_STORE || ((0, m.vc)(this.record.type) && !P.ZP.hasUnread(this.record.id)))
                      ? {
                            renderLevel: 3,
                            threadIds: g
                        }
...
class ed extends ea {
    computeState(e) {
        ...
        return O.Z.can(j.Pl.VIEW_CHANNEL, this.record)
            ? {
                  renderLevel: 4,
...
class ec extends eo {
    computeState(e) {
        ...
        if (t > 1) {
            ...
            l.mutedChannelIds.has(this.id) || (null != i && l.mutedChannelIds.has(i)) ? (t = 2) : 4 === t ? (t = 3) : 2 === t && ev(this.category.guild, this.record, e) && (t = 3), 3 === t && ep(this, e) && (t = 4), (n = s().sortBy(n, (e) => -P.ZP.lastMessageTimestamp(e)));
        }
        return {
            renderLevel: t,
            threadIds: n
...
class eh extends eo {
    getRenderLevel(e) {
        ...
        return !O.Z.can(j.Pl.VIEW_CHANNEL, this.record) || 4 === e || 3 === e || eC(t, this.record) ? 1 : this.category.isCollapsed ? (s().some(L.Z.getVoiceStatesForChannel(this.record.id)) ? 4 : 3) : 4;
    }
    computeState(e) {
...
function ef(e, t, n, i, l) {
    ...
    if (m.uC.has(e.type)) {
        let e = s()
            ...
            .map((e) => e.channel.id);
        return r ? e : a ? (n.id in t || e.unshift(n.id), e) : l ? e.filter((e) => !I.Z.isMuted(e) || P.ZP.getMentionCount(e) > 0) : e;
    }
    return [];
}
function eC(e, t) {
...
function ev(e, t, n) {
    ...
    if (t.type === U.d4z.GUILD_DIRECTORY || !e.optInEnabled || t.isGuildVocal() || e.optedInChannels.has(t.id) || t.isThread() || (null != t.parent_id && e.optedInChannels.has(t.parent_id)) || (e.hideResourceChannels && t.hasFlag(G.zZ.IS_GUILD_RESOURCE_CHANNEL))) return !1;
    ...
    for (let e in l[t.id]) if (P.ZP.getMentionCount(e) > 0 || P.ZP.hasUnread(e) || P.ZP.hasRecentlyVisitedAndRead(e)) return !0;
