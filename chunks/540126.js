    ...
    constructor(e, t, n) {
        ...
        for (let e in a) {
            ...
            if (t.type !== x.d4z.GUILD_CATEGORY) {
                ...
                ev(this, t, m) ? g.push(t) : (t.type === x.d4z.GUILD_VOICE || t.type === x.d4z.GUILD_STAGE_VOICE) && (null != t.parent_id && null != d[t.parent_id] && C.push(d[t.parent_id]), C.push(t)), null != t.parent_id && t.parent_id in h ? h[t.parent_id].push(t) : u.push(t);
            }
        }
        for (let e in ((this.categories = {}), h)) this.categories[e] = new ee(this, d[e], h[e], m);
        (this.recentsSectionNumber = Y), (this.favoritesSectionNumber = z), (this.noParentCategory = new $(this, u, m)), (this.favoritesCategory = new et(this, m)), (this.recentsCategory = (0, f.Q)() ? new en(this, a, m) : new ei(this, g, m)), (this.voiceChannelsCategory = new el(this, C, d, m)), (this.guildActionSection = new es(t, E.length > 0)), (this.channelNoticeSection = new er(n)), l()(!('null' in this.categories), 'somehow a null got into categories'), (this.voiceChannelsSectionNumber = K + s().size(this.categories));
    }
}
class J {
    updateChannel(e, t) {
...
class ee extends J {
    shouldShowEmptyCategory() {
        return !!(super.shouldShowEmptyCategory() || (O.Z.can(F.Pl.MANAGE_CHANNELS, this.record) && O.Z.can(F.Pl.VIEW_CHANNEL, this.record) && s().isEmpty(this.channels) && (!this.guild.optInEnabled || this.guild.optedInChannels.has(this.id))));
    }
    constructor(e, t, n, i) {
...
class eo extends ea {
    computeState(e) {
        ...
        if (!O.Z.can(F.Pl.VIEW_CHANNEL, this.record)) {
            if (this.id === i)
                return {
                    renderLevel: 4,
                    threadIds: []
            ...
            : !o.optInEnabled || o.optedInChannels.has(this.id) || (null != a && o.optedInChannels.has(a))
              ? d || c || !s().isEmpty(g) || A.ZP.getMentionCount(this.id) > 0
                  ...
                  : o.hideMutedChannels && o.mutedChannelIds.has(this.id)
                    ...
                    : this.category.isCollapsed && (o.mutedChannelIds.has(this.id) || (null != a && o.mutedChannelIds.has(a)) || this.record.isGuildVocal() || this.record.type === x.d4z.GUILD_STORE || ((0, I.vc)(this.record.type) && !A.ZP.hasUnread(this.record.id)))
                      ? {
                            renderLevel: 3,
                            threadIds: g
                        }
...
class ed extends ea {
    computeState(e) {
        ...
        return O.Z.can(F.Pl.VIEW_CHANNEL, this.record)
            ? {
                  renderLevel: 4,
...
class eh extends eo {
    getRenderLevel(e) {
        ...
        return !O.Z.can(F.Pl.VIEW_CHANNEL, this.record) || 4 === e || 3 === e || ep(t, this.record) ? 1 : this.category.isCollapsed ? (s().some(L.Z.getVoiceStatesForChannel(this.record.id)) ? 4 : 3) : 4;
    }
    computeState(e) {
...
function ef(e, t, n, i, l) {
    ...
    if (I.uC.has(e.type)) {
        let e = s()
            ...
            .map((e) => e.channel.id);
        return r ? e : a ? (n.id in t || e.unshift(n.id), e) : l ? e.filter((e) => !_.Z.isMuted(e) || A.ZP.getMentionCount(e) > 0) : e;
    }
    return [];
}
function ep(e, t) {
