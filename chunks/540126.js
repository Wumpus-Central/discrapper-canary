...
class et {
    ...
    _areGuildVocalChannelsInRecentsInNeedOfAppearingInActiveNow(e) {
        let t = this.guilds[e];
        if (null == t || !(0, k.K)('recents_channels_active_now_check')) return !1;
        ...
        for (let e in r.channels) {
            let t = r.channels[e];
            if (2 === t.renderLevel && t.record.isGuildVocal() && null == n.channels[t.id] && o().some(T.Z.getVoiceStatesForChannel(t.id)) && N.ZP.getMentionCount(t.id) > 0) return !0;
        }
        return !1;
    }
    getGuild(e, t, n) {
    ...
    nonPositionalChannelIdUpdate(e) {
        let t = x.Z.getBasicChannel(e);
        return null != t && null != t.guild_id && null != this.guilds[t.guild_id] && (t instanceof j.Sf || null != (t = x.Z.getChannel(e))) && this.nonPositionalChannelUpdate(t);
    }
...
class en {
    get initializationData() {
        return {
            selectedChannel: x.Z.getChannel(w.Z.getChannelId()),
            selectedVoiceChannelId: w.Z.getVoiceChannelId(),
            activeJoinedRelevantThreads: v.Z.getActiveJoinedRelevantThreadsForGuild(this.id),
            activeJoinedUnreadThreads: v.Z.getActiveJoinedUnreadThreadsForGuild(this.id)
        };
    }
    invalidate() {
    ...
    getSectionRowsFromChannel(e) {
        ...
        let i = r.isThread();
        if ((i && (r = x.Z.getChannel(r.parent_id)), null == r)) return n;
        ...
        let a = this.recentsCategory.getShownChannelIds().indexOf(r.id);
        if (
            (a >= 0 &&
                n.push({
            ...
            return [{ section: o().findIndex(this.getSortedNamedCategories(), (e) => e.id === (null == r ? void 0 : r.id)) + $ }];
        let s = this.getCategory(r),
            c = s instanceof ei ? J : this.getSortedNamedCategories().indexOf(s) + $,
            u = s.getShownChannelIds().indexOf(r.id);
        if (c >= 0 && u >= 0) {
            let t = i ? s.channels[r.id].threadIds.indexOf(e) : 0;
            n.push({
                section: c,
                row: u,
                threadOffset: t
    ...
    getSlicedChannels(e, t) {
        ...
        for (let e of this.getSortedCategories()) {
            ...
            for (let t of e.getShownChannelIds()) {
                let c = e.channels[t];
                (l && (c.id === n.id ? (l = !1) : i || a.push(c)), o && !i && s.push(c), l || o || c.id !== r.id || (o = !0));
            }
        }
        return [a, e, s];
    }
    ...
    constructor(e, t, n) {
        ...
        let p = [],
            m = [],
            _ = [],
            v = this.initializationData;
        for (let e in a) {
            let t = a[e];
            if (t.type !== G.d4z.GUILD_CATEGORY) {
                if (t.type === G.d4z.GUILD_DIRECTORY) {
                    null == s || s.features.has(G.oNc.HUB) || _.push(t);
                    continue;
                }
                (eC(this, t, v) ? p.push(t) : (t.type === G.d4z.GUILD_VOICE || t.type === G.d4z.GUILD_STAGE_VOICE) && (null != t.parent_id && null != c[t.parent_id] && m.push(c[t.parent_id]), m.push(t)), null != t.parent_id && t.parent_id in h ? h[t.parent_id].push(t) : u.push(t));
            }
        }
        for (let e in ((this.categories = {}), h)) this.categories[e] = new el(this, c[e], h[e], v);
        ((this.recentsSectionNumber = Q), (this.favoritesSectionNumber = X), (this.noParentCategory = new ei(this, u, v)), (this.favoritesCategory = new eo(this, v)), (this.recentsCategory = (0, f.Q)() ? new ea(this, a, v) : new es(this, p, v)), (this.voiceChannelsCategory = new ec(this, m, c, v)), (this.guildActionSection = new ed(t, _.length > 0)), (this.channelNoticeSection = new eu(n)), i()(!('null' in this.categories), 'somehow a null got into categories'), (this.voiceChannelsSectionNumber = $ + o().size(this.categories)));
    }
}
class er {
    updateChannel(e, t) {
...
class el extends er {
    shouldShowEmptyCategory() {
        return !!(super.shouldShowEmptyCategory() || (P.Z.can(V.Pl.MANAGE_CHANNELS, this.record) && P.Z.can(V.Pl.VIEW_CHANNEL, this.record) && o().isEmpty(this.channels) && (!this.guild.optInEnabled || this.guild.optedInChannels.has(this.id))));
    }
    constructor(e, t, n, r) {
        for (let i of (super(e), F(this, 'id', void 0), F(this, 'record', void 0), (this.record = t), (this.id = t.id), (this.isCollapsed = !0 === e.collapsedCategoryIds[t.id]), (this.isMuted = e.mutedChannelIds.has(t.id)), (this.channels = {}), n)) this.channels[i.id] = new ep(this, i, r);
    }
}
class eo extends er {
    updateChannel(e, t) {
    ...
    constructor(e, t) {
        ...
        this.channels = o()(null != (n = Z.ZP.getGuildFavorites(e.id)) ? n : [])
...
class ea extends er {
    ...
    updateChannel(e, t) {
        ...
        if (!(0, j.vc)(e.type)) return !1;
        let n = super.updateChannel(e, t),
            r = this.channels[e.id];
        return null == r ? ((r = new em(this, e, t)), (this.channels[e.id] = r), this.invalidate(), !0) : this.updateShownChannelIds(r) || n;
    }
    getFirstVoiceChannel(e) {
        return null;
    }
    ...
    constructor(e, t, n) {
        if ((super(e), F(this, 'enabled', !1), (this.isCollapsed = m.Z.isCollapsed(e.id)), (this.enabled = !1), this.enabled)) for (let e of Object.values(t)) (0, j.vc)(e.type) && !(0, j.Q5)(e.type) && (this.channels[e.id] = new em(this, e, n));
    }
}
(F(ea, 'MIN_READABLE_CHANNELS', 7), F(ea, 'MAX_RECENT_CHANNELS', 10), F(ea, 'MAX_TIMESTAMP_DELTA', 604800000));
class es extends er {
    updateAllChannels(e) {
        let t = !1;
        return (
    ...
    updateChannel(e, t) {
        ...
        if (this.guild.optInEnabled) {
            ...
            if (eC(this.guild, e, t) && null == n) return ((this.channels[e.id] = new eg(this, e, t)), this.invalidate(), !0);
        }
        return n;
    }
    getFirstVoiceChannel(e) {
    ...
    getShownChannelIds() {
        ...
        if (null == this.shownChannelIds) {
            ...
            for (let n = 0; n < t.length; n++) {
                var e;
                let r = t[n];
                (n < t.length - 1 && r.record.type === G.d4z.GUILD_CATEGORY && (null == (e = t[n + 1]) ? void 0 : e.record.type) === G.d4z.GUILD_CATEGORY) || ((n !== t.length - 1 || r.record.type !== G.d4z.GUILD_CATEGORY) && this.shownChannelIds.push(r.id));
            }
        }
        return this.shownChannelIds;
    }
...
class ep extends eh {
    computeState(e) {
        ...
        if (!P.Z.can(V.Pl.VIEW_CHANNEL, this.record)) {
            if (this.id === r)
                return {
                    renderLevel: 4,
                    threadIds: []
        ...
        let c = (null == n ? void 0 : n.id) === this.id || r === this.id,
            ...
            p = eO(this.record, h, n, r, s.hideMutedChannels);
        return this.id !== s.moderatorReportChannelId || s.moderatorReportChannelEnabled
            ? s.optInEnabled && s.hideResourceChannels && this.record.hasFlag(B.zZ.IS_GUILD_RESOURCE_CHANNEL)
                ? {
                      renderLevel: c ? 4 : 1,
                      threadIds: p
                  }
                : !s.optInEnabled || s.optedInChannels.has(this.id) || (null != a && s.optedInChannels.has(a))
                  ? c || d || !o().isEmpty(p) || N.ZP.getMentionCount(this.id) > 0
                      ? {
                            renderLevel: 4,
                            threadIds: p
                        }
                      : s.hideMutedChannels && s.mutedChannelIds.has(this.id)
                        ...
                        : this.category.isCollapsed && (s.mutedChannelIds.has(this.id) || (null != a && s.mutedChannelIds.has(a)) || this.record.isGuildVocal() || this.record.type === G.d4z.GUILD_STORE || ((0, j.vc)(this.record.type) && !N.ZP.hasUnread(this.record.id)))
                          ? {
                                renderLevel: 3,
                                threadIds: p
                            }
...
class ef extends eh {
    computeState(e) {
        ...
        return P.Z.can(V.Pl.VIEW_CHANNEL, this.record)
            ? {
                  renderLevel: 4,
...
class eg extends eh {
    computeState(e) {
        ...
        let { selectedChannel: n, selectedVoiceChannelId: r, activeJoinedRelevantThreads: i } = e;
        return P.Z.can(V.Pl.VIEW_CHANNEL, this.record)
            ? eC(this.category.guild, this.record, e)
                ? {
...
class em extends ep {
    computeState(e) {
        ...
        if (t > 1) {
            ...
            (i.mutedChannelIds.has(this.id) || (null != r && i.mutedChannelIds.has(r)) ? (t = 2) : 4 === t ? (t = 3) : 2 === t && eC(this.category.guild, this.record, e) && (t = 3), 3 === t && ev(this, e) && (t = 4), (n = o().sortBy(n, (e) => -N.ZP.lastMessageTimestamp(e))));
        }
        return {
            renderLevel: t,
            threadIds: n
...
class eb extends ep {
    getRenderLevel(e) {
        ...
        return !P.Z.can(V.Pl.VIEW_CHANNEL, this.record) || 4 === e || 3 === e || ey(t, this.record) ? 1 : this.category.isCollapsed ? (o().some(T.Z.getVoiceStatesForChannel(this.record.id)) ? 4 : 3) : 4;
    }
    computeState(e) {
        let t = super.computeState(e),
            n = this.getRenderLevel(t.renderLevel);
        return (
            4 === n && (this.subtitle = e_(this.record, this.isCollapsed || this.category.isCollapsed, this.category.guild.optInEnabled)),
            {
                threadIds: [],
                renderLevel: n
            }
...
function e_(e, t, n) {
    switch (e.type) {
        case G.d4z.GUILD_VOICE: {
            ...
            let i = A.ZP.getVoiceStatesForChannel(e);
            if (n && t && (0, L.a)(i)) return { type: 'go-live' };
            ...
            let o = a.ZP.getEmbeddedActivitiesForChannel(e.id)
                .map((e) => {
                    var t;
                    return null == (t = s.Z.getApplication(e.applicationId)) ? void 0 : t.name;
                })
                .filter(R.lm);
            if (o.length > 0)
                return {
...
function eO(e, t, n, r, i) {
    ...
    if (j.uC.has(e.type)) {
        let e = o()
            ...
            .map((e) => e.channel.id);
        return l ? e : a ? (n.id in t || e.unshift(n.id), e) : i ? e.filter((e) => !C.Z.isMuted(e) || N.ZP.getMentionCount(e) > 0) : e;
    }
    return [];
}
function ey(e, t) {
...
function ev(e, t) {
    ...
    for (let t in r[e.id]) if (N.ZP.getMentionCount(t) > 0) return !0;
    if (null != n && (n.id === e.id || (n.isThread() && n.parent_id === e.id))) return !0;
    let i = _.Z.getNewChannelIds(e.category.guild.id);
    if (i.size > K);
...
function eC(e, t, n) {
    ...
    if (t.type === G.d4z.GUILD_DIRECTORY || !e.optInEnabled || e.optedInChannels.has(t.id) || t.isThread() || (null != t.parent_id && e.optedInChannels.has(t.parent_id)) || (e.hideResourceChannels && t.hasFlag(B.zZ.IS_GUILD_RESOURCE_CHANNEL))) return !1;
    if (t.isGuildVocal()) {
        if (!(0, k.K)('should_show_in_recents')) return !1;
        let n = M.Z.isVoiceCategoryCollapsed(e.id);
        if (!n) return !1;
        let r = o().some(T.Z.getVoiceStatesForChannel(t.id));
        if (n && r) return !1;
    }
    if ((null != r && (r.id === t.id || (r.isThread() && r.parent_id === t.id))) || N.ZP.getMentionCount(t.id) > 0) return !0;
    for (let e in i[t.id]) if (N.ZP.getMentionCount(e) > 0 || N.ZP.hasUnread(e) || N.ZP.hasRecentlyVisitedAndRead(e)) return !0;
    if (e.mutedChannelIds.has(t.id) || (null != t.parent_id && e.mutedChannelIds.has(t.parent_id))) return !1;
    let l = _.Z.getNewChannelIds(e.id),
        a = Array.from(l).sort((e, t) => D.default.compare(t, e));
    return !!((l.has(t.id) && a.indexOf(t.id) < K) || N.ZP.hasRecentlyVisitedAndRead(t.id));
}
let ej = new Set(Object.values(U.z));
