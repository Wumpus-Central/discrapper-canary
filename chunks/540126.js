...
class J {
    ...
    nonPositionalChannelIdUpdate(e) {
        ...
        return null != t && null != t.guild_id && null != this.guilds[t.guild_id] && (t instanceof _.Sf || null != (t = j.Z.getChannel(e))) && this.nonPositionalChannelUpdate(t);
    }
        ...
        for (let e in c) {
            ...
            if (t.type !== M.d4z.GUILD_CATEGORY) {
                if (t.type === M.d4z.GUILD_DIRECTORY) {
                    null == u || u.hasFeature(M.oNc.HUB) || v.push(t);
                    continue;
                }
                eO(this, t, _) ? y.push(t) : (t.type === M.d4z.GUILD_VOICE || t.type === M.d4z.GUILD_STAGE_VOICE) && (null != t.parent_id && null != h[t.parent_id] && O.push(h[t.parent_id]), O.push(t)), null != t.parent_id && t.parent_id in m ? m[t.parent_id].push(t) : p.push(t);
            }
        }
        for (let e in ((this.categories = {}), m)) this.categories[e] = new en(this, h[e], m[e], _);
        (this.recentsSectionNumber = K), (this.favoritesSectionNumber = Y), (this.noParentCategory = new et(this, p, _)), (this.favoritesCategory = new er(this, _)), (this.recentsCategory = (0, f.Q)() ? new ei(this, c, _) : new el(this, y, _)), (this.voiceChannelsCategory = new eo(this, O, h, _)), (this.guildActionSection = new ea(t, v.length > 0)), (this.channelNoticeSection = new es(n)), i()(!('null' in this.categories), 'somehow a null got into categories'), (this.voiceChannelsSectionNumber = Q + o().size(this.categories));
    }
}
class ee {
    updateChannel(e, t) {
...
class ei extends ee {
        ...
        if (null == this.shownChannelIds) {
            ...
            this.shownChannelIds = this.enabled
                ? o()(this.channels)
                      ...
                      .sortBy((e) => {
                          let [, t, n] = e;
                          return -(t - (4 === n ? 0 : R.DISCORD_EPOCH));
                      })
    ...
    constructor(e, t, n) {
        if ((super(e), G(this, 'enabled', !1), (this.isCollapsed = m.Z.isCollapsed(e.id)), (this.enabled = !1), this.enabled)) for (let e of Object.values(t)) (0, _.vc)(e.type) && !(0, _.Q5)(e.type) && (this.channels[e.id] = new ep(this, e, n));
    }
}
...
class el extends ee {
    updateAllChannels(e) {
        let t = !1;
        return (
            R.default.keys(this.channels).forEach((n) => {
                ...
                : !a.optInEnabled || a.optedInChannels.has(this.id) || (null != s && a.optedInChannels.has(s))
                  ? c || d || !o().isEmpty(p) || P.ZP.getMentionCount(this.id) > 0
                      ...
                      : a.hideMutedChannels && a.mutedChannelIds.has(this.id)
                        ...
                        : this.category.isCollapsed && (a.mutedChannelIds.has(this.id) || (null != s && a.mutedChannelIds.has(s)) || this.record.isGuildVocal() || this.record.type === M.d4z.GUILD_STORE || ((0, _.vc)(this.record.type) && !P.ZP.hasUnread(this.record.id)))
                          ? {
                                renderLevel: 3,
                                threadIds: p
                            }
...
class ep extends eu {
    computeState(e) {
        ...
        if (t > 1) {
            ...
            i.mutedChannelIds.has(this.id) || (null != r && i.mutedChannelIds.has(r)) ? (t = 2) : 4 === t ? (t = 3) : 2 === t && eO(this.category.guild, this.record, e) && (t = 3), 3 === t && ey(this, e) && (t = 4), (n = o().sortBy(n, (e) => -P.ZP.lastMessageTimestamp(e)));
        }
        return {
            renderLevel: t,
            threadIds: n
...
class ef extends eu {
    getRenderLevel(e) {
        ...
        return !x.Z.can(U.Pl.VIEW_CHANNEL, this.record) || 4 === e || 3 === e || eb(t, this.record) ? 1 : this.category.isCollapsed ? (o().some(N.Z.getVoiceStatesForChannel(this.record.id)) ? 4 : 3) : 4;
    }
    computeState(e) {
...
function eg(e, t, n) {
    switch (e.type) {
        case M.d4z.GUILD_VOICE: {
            ...
            if (n && t && (0, A.a)(i)) return { type: 'go-live' };
...
function em(e, t, n, r, i) {
    ...
    if (_.uC.has(e.type)) {
        let e = o()
            ...
            .map((e) => e.channel.id);
        return l ? e : s ? (n.id in t || e.unshift(n.id), e) : i ? e.filter((e) => !v.Z.isMuted(e) || P.ZP.getMentionCount(e) > 0) : e;
    }
    return [];
}
function eb(e, t) {
...
function eO(e, t, n) {
    ...
    let l = y.Z.getNewChannelIds(e.id),
        o = Array.from(l).sort((e, t) => R.default.compare(t, e));
...
let ev = new Set(Object.values(L.z));
