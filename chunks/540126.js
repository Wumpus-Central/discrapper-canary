...
class Q {
    get initializationData() {
        return {
            selectedChannel: T.Z.getChannel(O.Z.getChannelId()),
...
class ee extends J {
    shouldShowEmptyCategory() {
        return !!(super.shouldShowEmptyCategory() || (b.Z.can(F.Pl.MANAGE_CHANNELS, this.record) && b.Z.can(F.Pl.VIEW_CHANNEL, this.record) && s().isEmpty(this.channels) && (!this.guild.optInEnabled || this.guild.optedInChannels.has(this.id))));
    }
    constructor(e, t, n, i) {
        for (let l of (super(e), G(this, 'id', void 0), G(this, 'record', void 0), (this.record = t), (this.id = t.id), (this.isCollapsed = !0 === e.collapsedCategoryIds[t.id]), (this.isMuted = e.mutedChannelIds.has(t.id)), (this.channels = {}), n)) this.channels[l.id] = new eo(this, l, i);
    }
}
class et extends J {
    updateChannel(e, t) {
...
class en extends J {
    ...
    constructor(e, t, n) {
        if ((super(e), G(this, 'enabled', !1), (this.isCollapsed = C.Z.isCollapsed(e.id)), (this.enabled = !1), this.enabled)) for (let e of Object.values(t)) (0, I.vc)(e.type) && !(0, I.Q5)(e.type) && (this.channels[e.id] = new ec(this, e, n));
    }
}
G(en, 'MIN_READABLE_CHANNELS', 7), G(en, 'MAX_RECENT_CHANNELS', 10), G(en, 'MAX_TIMESTAMP_DELTA', 604800000);
class ei extends J {
    updateAllChannels(e) {
        let t = !1;
        return (
...
class es {
    ...
    constructor(e, t) {
        G(this, 'guildActionRows', void 0), (this.guildActionRows = e.map(String)), t && this.guildActionRows.push(String(x.z.GUILD_DIRECTORY));
    }
}
class ea {
    get isMuted() {
...
class eo extends ea {
    computeState(e) {
        ...
        if (!b.Z.can(F.Pl.VIEW_CHANNEL, this.record)) {
            if (this.id === i)
                return {
                    renderLevel: 4,
                    threadIds: []
        ...
        let d = (null == n ? void 0 : n.id) === this.id || i === this.id,
            ...
            g = ep(this.record, h, n, i, o.hideMutedChannels);
        return o.optInEnabled && o.hideResourceChannels && this.record.hasFlag(j.zZ.IS_GUILD_RESOURCE_CHANNEL)
            ? {
                  renderLevel: d ? 4 : 1,
                  threadIds: g
              }
...
class ed extends ea {
    computeState(e) {
        ...
        return b.Z.can(F.Pl.VIEW_CHANNEL, this.record)
            ? {
                  renderLevel: 4,
...
class eh extends eo {
    getRenderLevel(e) {
        ...
        return !b.Z.can(F.Pl.VIEW_CHANNEL, this.record) || 4 === e || 3 === e || ef(t, this.record) ? 1 : this.category.isCollapsed ? (s().some(L.Z.getVoiceStatesForChannel(this.record.id)) ? 4 : 3) : 4;
    }
    computeState(e) {
...
function ev(e, t, n) {
    ...
    if (t.type === U.d4z.GUILD_DIRECTORY || !e.optInEnabled || t.isGuildVocal() || e.optedInChannels.has(t.id) || t.isThread() || (null != t.parent_id && e.optedInChannels.has(t.parent_id)) || (e.hideResourceChannels && t.hasFlag(j.zZ.IS_GUILD_RESOURCE_CHANNEL))) return !1;
