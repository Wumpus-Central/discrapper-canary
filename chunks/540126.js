        ...
        for (let e in a) {
            ...
            if (t.type !== x.d4z.GUILD_CATEGORY) {
                if (t.type === x.d4z.GUILD_DIRECTORY) {
                    null == o || o.hasFeature(x.oNc.HUB) || E.push(t);
                    continue;
                }
                ev(this, t, _) ? g.push(t) : (t.type === x.d4z.GUILD_VOICE || t.type === x.d4z.GUILD_STAGE_VOICE) && (null != t.parent_id && null != d[t.parent_id] && p.push(d[t.parent_id]), p.push(t)), null != t.parent_id && t.parent_id in h ? h[t.parent_id].push(t) : u.push(t);
            }
        }
        for (let e in ((this.categories = {}), h)) this.categories[e] = new ee(this, d[e], h[e], _);
        (this.recentsSectionNumber = Y), (this.favoritesSectionNumber = z), (this.noParentCategory = new $(this, u, _)), (this.favoritesCategory = new et(this, _)), (this.recentsCategory = (0, C.Q)() ? new en(this, a, _) : new ei(this, g, _)), (this.voiceChannelsCategory = new el(this, p, d, _)), (this.guildActionSection = new es(t, E.length > 0)), (this.channelNoticeSection = new er(n)), l()(!('null' in this.categories), 'somehow a null got into categories'), (this.voiceChannelsSectionNumber = K + s().size(this.categories));
    }
}
class J {
    updateChannel(e, t) {
...
class ee extends J {
    shouldShowEmptyCategory() {
        return !!(super.shouldShowEmptyCategory() || (y.Z.can(F.Pl.MANAGE_CHANNELS, this.record) && y.Z.can(F.Pl.VIEW_CHANNEL, this.record) && s().isEmpty(this.channels) && (!this.guild.optInEnabled || this.guild.optedInChannels.has(this.id))));
    }
    constructor(e, t, n, i) {
...
class en extends J {
    ...
    constructor(e, t, n) {
        if ((super(e), j(this, 'enabled', !1), (this.isCollapsed = p.Z.isCollapsed(e.id)), (this.enabled = !1), this.enabled)) for (let e of Object.values(t)) (0, m.vc)(e.type) && !(0, m.Q5)(e.type) && (this.channels[e.id] = new ec(this, e, n));
    }
}
...
class eo extends ea {
    computeState(e) {
        ...
        if (!y.Z.can(F.Pl.VIEW_CHANNEL, this.record)) {
            if (this.id === i)
                return {
                    renderLevel: 4,
                    threadIds: []
            ...
            : !o.optInEnabled || o.optedInChannels.has(this.id) || (null != a && o.optedInChannels.has(a))
              ? d || c || !s().isEmpty(g) || A.ZP.getMentionCount(this.id) > 0
                  ...
                  : o.hideMutedChannels && o.mutedChannelIds.has(this.id)
                    ...
                    : this.category.isCollapsed && (o.mutedChannelIds.has(this.id) || (null != a && o.mutedChannelIds.has(a)) || this.record.isGuildVocal() || this.record.type === x.d4z.GUILD_STORE || ((0, m.vc)(this.record.type) && !A.ZP.hasUnread(this.record.id)))
                      ? {
                            renderLevel: 3,
                            threadIds: g
                        }
...
class ed extends ea {
    computeState(e) {
        ...
        return y.Z.can(F.Pl.VIEW_CHANNEL, this.record)
            ? {
                  renderLevel: 4,
...
class ec extends eo {
    computeState(e) {
        ...
        if (t > 1) {
            ...
            l.mutedChannelIds.has(this.id) || (null != i && l.mutedChannelIds.has(i)) ? (t = 2) : 4 === t ? (t = 3) : 2 === t && ev(this.category.guild, this.record, e) && (t = 3), 3 === t && ep(this, e) && (t = 4), (n = s().sortBy(n, (e) => -A.ZP.lastMessageTimestamp(e)));
        }
        return {
            renderLevel: t,
            threadIds: n
...
class eh extends eo {
    getRenderLevel(e) {
        ...
        return !y.Z.can(F.Pl.VIEW_CHANNEL, this.record) || 4 === e || 3 === e || ef(t, this.record) ? 1 : this.category.isCollapsed ? (s().some(L.Z.getVoiceStatesForChannel(this.record.id)) ? 4 : 3) : 4;
    }
    computeState(e) {
...
function eC(e, t, n, i, l) {
    ...
    if (m.uC.has(e.type)) {
        let e = s()
            ...
            .map((e) => e.channel.id);
        return r ? e : a ? (n.id in t || e.unshift(n.id), e) : l ? e.filter((e) => !I.Z.isMuted(e) || A.ZP.getMentionCount(e) > 0) : e;
    }
    return [];
}
function ef(e, t) {
