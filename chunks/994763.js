...
class L extends c.PureComponent {
    componentDidMount() {
        E(this.props.section, null, this.props.analyticsLocation);
    }
    ...
    render() {
        ...
        let {
            ...
            showDirtyGuildTemplateIndicator: O,
            memberCount: v,
            onboardingStep: T,
            onboardingEnabled: w,
        ...
        let D = (0, j.vE)({
            ...
            E = (null == (a = D.find((e) => e.section === o)) || null == (e = a.predicate) ? void 0 : e.call(a)) !== !1,
            k = (0, A.r)();
        return (0, n.jsxs)("div", {
            children: [
                (0, n.jsx)(i.ZP, {
                    theme: t,
                    sidebarTheme: c,
                    section: E && null != o ? o : k,
                    onSetSection: P.Z.setSection,
                    onClose: r.xf,
                    title: "" !== l.name ? l.name : N.intl.string(N.t["154/bG"]),
                    sections: D,
                }),
