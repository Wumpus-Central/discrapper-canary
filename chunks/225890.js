...
function b(e) {
    ...
    return (
        i.useEffect(() => {
            (null == C ? void 0 : C.id) == null && g.Z.fetchGuildEvent(n, b),
                m.Z.getGuildEventUserCounts(n, b, null != E ? [E] : []),
        ...
        (0, r.jsx)(_.ZP, {
            ...
            onTransitionToInviteChannel: function () {
                ...
                (null == v ? void 0 : v.isGuildStageVoice())
                    ? (0, s.Cq)(v)
                    : (null == v ? void 0 : v.isGuildVoice()) && g.Z.joinVoiceEvent(v.guild_id, v.id);
            },
            recurrenceId: E,
        })
    );
