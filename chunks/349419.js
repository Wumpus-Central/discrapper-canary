...
function W(e) {
    ...
    return (0, i.jsxs)("div", {
        className: H.Kk,
        children: [
            (0, i.jsx)("img", { className: y()({ [H.um]: r }), src: t, alt: n }),
            r &&
                (0, i.jsx)("div", {
                    className: H.pp,
                    children: (0, i.jsxs)(N.E, { variant: "text-xs/medium", className: H.gq, children: ["+", s] }),
                }),
        ],
    });
}
...
function Z(e) {
    let { user: t, widgets: n = [], ...l } = e,
        ...
        y = (0, f.A)(S),
        C = r.useMemo(() => new Map(y.filter(m.Vq).map((e) => [e.id, e])), [y]),
        N = (0, h.A)(S),
        v = r.useMemo(() => new Map(N.map((e) => [e.application_id, e])), [N]),
        { data: R } = (0, p.P)(t.id),
