...
function u(e) {
    return !!e && (p(e) || Array.isArray(e) || !!e[o] || !!e.constructor?.[o] || b(e) || m(e));
}
...
function d(e) {
    let t = e[a];
    return t ? t.type_ : Array.isArray(e) ? 1 : b(e) ? 2 : 3 * !!m(e);
}
function y(e, t) {
...
function S(e, t = !1) {
    return (
        w(e) ||
            l(e) ||
            !u(e) ||
            (d(e) > 1 && (e.set = e.add = e.clear = e.delete = g),
            Object.freeze(e),
...
function F(e) {
    A(e), e.drafts_.forEach(C), (e.drafts_ = null);
}
function A(e) {
    e === n && (n = e.parent_);
}
...
function k(e, t) {
    ...
    return (
        void 0 !== e && e !== r
            ? (r[a].modified_ && (F(t), c(4)),
              u(e) && ((e = M(t, e)), t.parent_ || N(t, e)),
              t.patches_ && O("Patches").generateReplacementPatches_(r[a].base_, e, t.patches_, t.inversePatches_))
            : (e = M(t, r, [])),
        F(t),
...
function M(e, t, r) {
    if (w(t)) return t;
    let n = t[a];
    if (!n) return _(t, (i, o) => E(e, n, t, i, o, r)), t;
    ...
    if (!n.finalized_) {
        ...
        3 === n.type_ && ((i = new Set(t)), t.clear(), (o = !0)),
            _(i, (i, a) => E(e, n, t, i, a, r, o)),
            N(e, t, !1),
            r && e.patches_ && O("Patches").generatePatches_(n, r, e.patches_, e.inversePatches_);
    }
    return n.copy_;
}
function E(e, t, r, n, i, o, a) {
    if (l(i)) {
        let a = M(e, i, o && t && 3 !== t.type_ && !y(t.assigned_, n) ? o.concat(n) : void 0);
        if ((h(r, n, a), !l(a))) return;
        e.canAutoFreeze_ = !1;
    } else a && r.add(i);
    if (u(i) && !w(i)) {
...
var R = {
        get(e, t) {
            ...
            if (!y(r, t)) {
                var n = e,
                    ...
                    o = t;
                let a = W(i, o);
                return a ? ("value" in a ? a.value : a.get?.call(n.draft_)) : void 0;
            }
            let c = r[t];
            return e.finalized_ || !u(c) ? c : c === U(e.base_, t) ? (I(e), (e.copy_[t] = L(c, e))) : c;
        },
        has: (e, t) => t in v(e),
        ...
        deleteProperty: (e, t) => (
            void 0 !== U(e.base_, t) || t in e.base_ ? ((e.assigned_[t] = !1), I(e), x(e)) : delete e.assigned_[t],
        ...
        : m(e)
          ...
          : (function (e, t) {
                let r = Array.isArray(e),
                    ...
                    a = R;
                r && ((o = [i]), (a = K));
                let { revoke: c, proxy: s } = Proxy.revocable(o, a);
                return (i.draft_ = s), (i.revoke_ = c), s;
            })(e, t);
        ...
        constructor(e) {
            (this.autoFreeze_ = !0),
                ...
                (this.produce = (e, t, r) => {
                    ...
                    if (("function" != typeof t && c(6), void 0 !== r && "function" != typeof r && c(7), u(e))) {
                        let i = D(this),
                            o = L(e, void 0),
                            a = !0;
                        try {
                    ...
                    if (e && "object" == typeof e) c(1, e);
                        ...
                        if (
                            (void 0 === (n = t(e)) && (n = e), n === i && (n = void 0), this.autoFreeze_ && S(n, !0), r)
                        ) {
                            let t = [],
                                i = [];
                            O("Patches").generateReplacementPatches_(e, n, t, i), r(t, i);
                        }
                        return n;
                    }
                }),
