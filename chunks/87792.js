...
function F(e) {
    let { displayType: t } = e,
        ...
        c = (0, E.C7)(t),
        u = (0, E.A)(t),
        { loadMore: f, isMoreLoading: m } = (0, g.G)({ onError: n }),
        b = (0, h.E2)().get(t),
        [y, v] = i.useState(R.iB),
        S = i.useCallback(() => {
            v((e) => e + R.iB), f(t);
    ...
    let A = t === R.MY.PURCHASES && null != u ? b.sectionHeader(u) : b.sectionHeader(c),
        N = i.useCallback(
            (e) => {
                ...
                if ((0, h.f0)(n)) return (0, r.jsx)(I.Z, { guildId: n.entity_id }, n.event_id);
                if ((0, h.m4)(n)) {
    ...
    return (0, r.jsxs)("div", {
        ...
        children: [
            ...
            w.length < c
                ? (0, r.jsx)(d.P3F, {
                      className: o()(j.loadMoreBar, { [j.disabled]: m }),
                      onClick: S,
                      role: "button",
                      "aria-disabled": m,
                      children: m
...
let H = () => {
        let e = (0, v.zu)(),
            ...
            a = (e) => {
                n(e), f.default.track(D.rMx.FAMILY_CENTER_ACTION, { action: R.YC.SelectTeen });
            },
            o = e.map((e) => ({
                label: e.id,
                value: e.id,
