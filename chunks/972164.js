...
function c(e, t, n) {
    ...
    let p = 128 * l,
        h = p / 4;
    if (s <= 1 || (s & (s - 1)) != 0 || s > 4294967296) throw Error('Scrypt: N must be larger than 1, a power of 2, and less than 2^32');
    if (c < 0 || c > ((4294967296 - 1) * 32) / p) throw Error('Scrypt: p must be a positive integer less than or equal to ((2^32 - 1) * 32) / (128 * r)');
