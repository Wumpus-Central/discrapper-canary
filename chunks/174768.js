...
let b = "seenQSTutorial",
    ...
    V = null;
function B() {
    (M = A.A.getGuildCount() >= 3 || s().size(p.A.getMutablePrivateChannels()) >= 20), (G = []);
}
function H(e) {
    let t = (0, c.A)(e);
...
function j(e) {
    ...
    null != s && a.add(`guild:${s}`),
        (V = Date.now()),
        (i = i ?? new u.Ay(Y, D, null != n ? 100 : 5, { frecencyBoosters: !0, blacklist: a, allowSnowflake: !0 }, 100)),
        (k = null),
        (U = r.length),
        (P = n),
        i.search(r);
                    ...
                    ? (function () {
                          ...
                          switch (P) {
                              case u.rD.USER: {
                                  ...
                                  return v.Ay.getRecentlyTalked(i, 100).filter((t) => {
                                      let { record: n } = t;
                                      return n.id !== e;
                                  });
                              }
                          ...
                          let o =
                              ...
                              t);
                          if (o.length > 0)
                              for (let e of (r.push((0, u.jF)(O.intl.string(O.t["4B63jZ"]))), o))
                          ...
                          if (c.length > 0)
                              for (let { channelId: e, result: t } of (r.push((0, u.jF)(O.intl.string(O.t["61Df13"]))),
                              c))
                          ...
                          if (null != n) {
                              ...
                              Object.values(_.A.getActiveJoinedUnreadThreadsForGuild(n)).forEach((t) => {
                                  ...
                                  e.length > 0 && (r.push((0, u.jF)(O.intl.string(O.t.ieCAhD))), (r = r.concat(e)));
                          }
                          let h = r.length > 0 ? 3 : 7;
                          return (
                              a.length > h && a.splice(h),
                              a.length > 0 && (r = [(0, u.jF)(O.intl.string(O.t["80lOZ1"])), ...a, ...r]),
                              r
                          );
                      })()
                    : e),
        ...
        switch (P) {
            case u.rD.USER: {
                ...
                n.unshift(
                    (0, u.jF)(
                        null != e
                            ? O.intl.formatToPlainString(O.t.FREzQs, { name: e.name })
                            : O.intl.string(O.t.XFYW1o),
                    ),
                ),
                    (x = n);
                break;
            ...
            case u.rD.TEXT_CHANNEL:
                n.unshift((0, u.jF)(O.intl.string(O.t.W26k4V))), (x = n);
                break;
            case u.rD.VOICE_CHANNEL:
                n.unshift((0, u.jF)(O.intl.string(O.t.zUoI5C))), (x = n);
                break;
            case u.rD.GUILD:
                n.unshift((0, u.jF)(O.intl.string(O.t.olADPs))), (x = n);
                break;
            case u.rD.APPLICATION:
                n.unshift((0, u.jF)(O.intl.string(O.t.VwK1ld))), (x = n);
                break;
            default:
                x = n;
        }
        if (i !== k) (k = i), (U = Math.max(i.length, U)), (L = (0, u.Vv)(u.vB.DOWN, -1, x));
        else {
            let e = x[L];
...
function W() {
    (k = null), (U = 0), (G = []), null != i && (i.destroy(), (i = null));
}
class K extends a.Ay.PersistedStore {
    static displayName = "QuickSwitcherStore";
    static persistKey = "QuickSwitcherStore";
    initialize(e) {
        this.waitFor(_.A, f.default, p.A, E.A, m.Ay, g.Ay, A.A, I.A, T.Ay, S.A, y.A, h.A, N.Ay),
            this.syncWith([h.A], () => !0),
            (w = o.w.get(b) || !1),
            (F = e?.channelHistory ?? []);
    }
...
let $ = new K(l.h, {
        ...
        QUICKSWITCHER_SEARCH: function (e) {
            ...
            if (null == i) return !1;
            if (P !== n) {
                i.setResultTypes(null != n ? [n] : D), i.setLimit(null != n ? 100 : 5);
