...
function K(e, l, t, s) {
    ...
    switch (e.type) {
        ...
        case Y.rbe.GUILD_FORUM:
            ...
            if ((0, P.A)(e)) return i ? Q.intl.string(Q.t.gfVCfL) : Q.intl.string(Q.t.UbLM3J);
...
function q(e, l) {
    ...
    switch (e.type) {
        ...
        case Y.rbe.GUILD_TEXT:
            ...
            if ((0, P.A)(e)) return w.I;
            return m.N;
        case Y.rbe.GUILD_FORUM:
            let el = e.isMediaChannel();
            if (ee) return el ? x.D : N.f;
            if (e.isSpoilerChannel()) return I.H;
            if ((0, P.A)(e)) return el ? E.c : T.Q;
            else if (el) return Z.x;
            else if (e.isGameInvitesChannel()) return u.x;
            else return M.b;
        case Y.rbe.GUILD_MEDIA:
            if (ee) return x.D;
            if ((0, P.A)(e)) return E.c;
            return Z.x;
        case Y.rbe.GUILD_STAGE_VOICE:
            if ($) return (0, P.A)(e) ? R.X : _.D;
            if (Q) return R.X;
        ...
        case Y.rbe.GUILD_VOICE:
            if (z) return f.o;
            if (ee) return L.O;
            if (e.isSpoilerChannel()) return j.P;
            if (q) return D.F;
            if ($)
                if ((0, P.A)(e)) return R.X;
