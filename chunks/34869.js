    ...
    constructor() {
        super("discord_protos.premium_marketing.v1.Nagbar", [
            ...
            { no: 2, name: "cta_label", kind: "scalar", T: 9 },
            {
                ...
                name: "cta_action",
                kind: "enum",
                T: () => ["discord_protos.premium_marketing.v1.ButtonAction", h.dz, "BUTTON_ACTION_"],
            },
        ...
        for (; e.pos < a; ) {
            ...
            switch (t) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    s.helpArticle = _.O.internalBinaryRead(e, e.uint32(), n, s.helpArticle);
                    break;
                case 6:
                    s.bodyLocalized = o.X.internalBinaryRead(e, e.uint32(), n, s.bodyLocalized);
                    break;
                case 7:
                    ...
                    break;
                case 8:
                    s.navigableStorefrontApplicationId = c.ol.internalBinaryRead(
                        e,
                        e.uint32(),
                        n,
...
class p extends a.G {
    constructor() {
        super("discord_protos.premium_marketing.v1.PremiumTabPopoverCTAButton", [
            ...
            { no: 5, name: "navigable_storefront_application_id", kind: "message", T: () => c.ol },
        ]);
    }
    create(e) {
...
class D extends a.G {
    ...
    internalBinaryWrite(e, t, n) {
        "" !== e.boxAnimationUrl && t.tag(1, i.O0.LengthDelimited).string(e.boxAnimationUrl),
            ...
            e.gradient && L.H.internalBinaryWrite(e.gradient, t.tag(4, i.O0.LengthDelimited).fork(), n).join();
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? i.f$.onWrite : r)(this.typeName, e, t), t;
    }
}
...
class U extends a.G {
    constructor() {
        super("discord_protos.premium_marketing.v1.MobileBottomSheet", [
            ...
            { no: 5, name: "button", kind: "message", T: () => x },
            {
                no: 6,
        ...
        for (; e.pos < a; ) {
            ...
            switch (t) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    s.button = x.internalBinaryRead(e, e.uint32(), n, s.button);
                    break;
                case 6:
    ...
    internalBinaryWrite(e, t, n) {
        "" !== e.assetUrl && t.tag(1, i.O0.LengthDelimited).string(e.assetUrl),
            ...
            e.button && x.internalBinaryWrite(e.button, t.tag(5, i.O0.LengthDelimited).fork(), n).join(),
...
class F extends a.G {
    constructor() {
        super("discord_protos.premium_marketing.v1.MarketingPageBanner", [
            ...
            { no: 3, name: "body", kind: "scalar", T: 9 },
            { no: 4, name: "help_article_id", kind: "scalar", T: 9 },
            { no: 5, name: "button", kind: "message", T: () => H },
            { no: 6, name: "help_article", kind: "message", T: () => _.O },
            { no: 7, name: "header_localized", kind: "message", T: () => o.X },
            { no: 8, name: "body_localized", kind: "message", T: () => o.X },
        ]);
    ...
    internalBinaryWrite(e, t, n) {
        "" !== e.assetUrl && t.tag(1, i.O0.LengthDelimited).string(e.assetUrl),
            ...
            "" !== e.body && t.tag(3, i.O0.LengthDelimited).string(e.body),
            "" !== e.helpArticleId && t.tag(4, i.O0.LengthDelimited).string(e.helpArticleId),
            e.button && H.internalBinaryWrite(e.button, t.tag(5, i.O0.LengthDelimited).fork(), n).join(),
            e.helpArticle && _.O.internalBinaryWrite(e.helpArticle, t.tag(6, i.O0.LengthDelimited).fork(), n).join(),
            e.headerLocalized &&
                o.X.internalBinaryWrite(e.headerLocalized, t.tag(7, i.O0.LengthDelimited).fork(), n).join(),
            e.bodyLocalized &&
...
class K extends a.G {
    constructor() {
        super("discord_protos.premium_marketing.v1.PremiumMarketingComponentProperties", [
            ...
            { no: 5, name: "marketing_page_banner", kind: "message", oneof: "properties", T: () => B },
            ...
            { no: 10, name: "gift_plan_selection_card_banner", kind: "message", oneof: "properties", T: () => O.s },
            { no: 11, name: "gift_customization_banner", kind: "message", oneof: "properties", T: () => R.E },
            { no: 12, name: "billing_settings_nitro_gift_banner", kind: "message", oneof: "properties", T: () => v.v },
            { no: 13, name: "gift_reminder_nagbar", kind: "message", oneof: "properties", T: () => y },
            { no: 14, name: "gift_reminder_coachmark", kind: "message", oneof: "properties", T: () => N },
            { no: 15, name: "premium_tab_tooltip", kind: "message", oneof: "properties", T: () => T },
            { no: 16, name: "premium_tab_popover", kind: "message", oneof: "properties", T: () => A },
            { no: 17, name: "nagbar", kind: "message", oneof: "properties", T: () => E },
            ...
            switch (t) {
                ...
                case 4:
                    s.properties = {
                        ...
                        premiumTab: Y.internalBinaryRead(e, e.uint32(), n, s.properties.premiumTab),
                    };
                    break;
                case 5:
                    s.properties = {
                        oneofKind: "marketingPageBanner",
                        marketingPageBanner: B.internalBinaryRead(e, e.uint32(), n, s.properties.marketingPageBanner),
                    };
                    break;
                case 6:
                    s.properties = {
                        oneofKind: "paymentModalBanner",
                        paymentModalBanner: V.internalBinaryRead(e, e.uint32(), n, s.properties.paymentModalBanner),
                    };
                    break;
                case 7:
                    s.properties = {
                        oneofKind: "mobileBottomSheet",
                        mobileBottomSheet: k.internalBinaryRead(e, e.uint32(), n, s.properties.mobileBottomSheet),
                    };
                    break;
                case 8:
                    s.properties = {
                ...
                case 9:
                    s.properties = {
                        ...
                        giftIconCoachmark: b.l.internalBinaryRead(e, e.uint32(), n, s.properties.giftIconCoachmark),
                    };
                    break;
                case 10:
                    s.properties = {
                        oneofKind: "giftPlanSelectionCardBanner",
                        giftPlanSelectionCardBanner: O.s.internalBinaryRead(
                            e,
                            e.uint32(),
                            n,
                ...
                case 11:
                    s.properties = {
                        ...
                        giftCustomizationBanner: R.E.internalBinaryRead(
                            e,
                            e.uint32(),
                            n,
                ...
                case 12:
                    s.properties = {
                        ...
                        billingSettingsNitroGiftBanner: v.v.internalBinaryRead(
                            e,
                            e.uint32(),
                            n,
                ...
                case 14:
                    s.properties = {
                        ...
                        giftReminderCoachmark: N.internalBinaryRead(
                            e,
                            e.uint32(),
                            n,
                ...
                case 15:
                    s.properties = {
                        ...
                        premiumTabTooltip: T.internalBinaryRead(e, e.uint32(), n, s.properties.premiumTabTooltip),
                    };
                    break;
                case 16:
                    s.properties = {
                        oneofKind: "premiumTabPopover",
                        premiumTabPopover: A.internalBinaryRead(e, e.uint32(), n, s.properties.premiumTabPopover),
                    };
                    break;
                case 17:
                    s.properties = {
                        oneofKind: "nagbar",
                        nagbar: E.internalBinaryRead(e, e.uint32(), n, s.properties.nagbar),
                    };
                    break;
                case 19:
                    s.properties = {
    ...
    internalBinaryWrite(e, t, n) {
        "placeholder" === e.properties.oneofKind && t.tag(1, i.O0.LengthDelimited).string(e.properties.placeholder),
            ...
            "premiumTabTooltip" === e.properties.oneofKind &&
                T.internalBinaryWrite(e.properties.premiumTabTooltip, t.tag(15, i.O0.LengthDelimited).fork(), n).join(),
            "premiumTabPopover" === e.properties.oneofKind &&
                A.internalBinaryWrite(e.properties.premiumTabPopover, t.tag(16, i.O0.LengthDelimited).fork(), n).join(),
            "nagbar" === e.properties.oneofKind &&
                E.internalBinaryWrite(e.properties.nagbar, t.tag(17, i.O0.LengthDelimited).fork(), n).join(),
