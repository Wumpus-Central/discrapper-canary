e.exports = function (e) {
    let t = "a-zA-Z_\\-!.?+*=<>&#'",
        ...
        u = { begin: "[\\[\\{]", end: "[\\]\\}]", relevance: 0 },
        c = { className: "comment", begin: "\\^" + n },
        d = e.COMMENT("\\^\\{", "\\}"),
        _ = { className: "symbol", begin: "[:]{1,2}" + n },
        f = { begin: "\\(", end: "\\)" },
        p = { endsWithParent: !0, relevance: 0 },
        h = { className: "name", relevance: 0, keywords: r, begin: n, starts: p },
        m = [f, a, c, d, o, _, u, s, l, i];
    return (
        (f.contains = [e.COMMENT("comment", ""), h, p]),
        (p.contains = m),
        (u.contains = m),
        { name: "Hy", aliases: ["hylang"], illegal: /\S/, contains: [e.SHEBANG(), f, a, c, d, o, _, u, s, l] }
    );
};
