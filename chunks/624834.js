...
function _(e) {
    let { width: t, channelId: n, participant: i, applicationId: m } = e,
        ...
        M = l.useCallback(
            ...
            [m, D, R.location, w, A, n, C]
        );
    return null == _ || null == j || null == P
        ? null
        : (0, r.jsxs)('div', {
              className: I.splash,
              children: [
                  ...
                  (0, r.jsx)(s.Text, {
                      ...
                      children: O.intl.formatToPlainString(O.t['7Uuia2'], { username: j.username })
                  }),
                  (0, r.jsx)(s.Text, {
