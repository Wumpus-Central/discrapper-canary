...
let x = l.memo(function (e) {
    let { guild: t } = e,
        ...
        x = (0, a.bG)([c.A], () => c.A.getCompletedActions(t.id)),
        f = l.useMemo(() => {
            if (null == n || null == x) return 0;
            let e = 0;
            return (
                n.forEach((t) => {
                    null != x[t.channelId] && e++;
                }),
                e
            );
        }, [x, n]),
        E = null == n ? 0 : n.length,
        C = (0, s.rm)(`progress-bar-${t.id}`);
    return (0, i.jsxs)("li", {
        children: [
            (0, i.jsxs)(o.DUT, {
                ...C,
                ...
                className: p.G9,
                onClick: function () {
                    (0, u.pX)(A.BVt.CHANNEL(t.id, g.VV.GUILD_HOME));
                },
                children: [
                    (0, i.jsxs)("div", {
                        className: p.A1,
