...
function S(e) {
    let t,
        ...
        l = o ?? a,
        { largeImage: u, smallImage: c } = v(s, a),
        { largeImage: _ } = y(s, l),
    ...
    return (
        ...
        N({ activity: s, application: o ?? a, largeImageSrc: t.largeImage?.src, trackingSource: r }),
        t
    );
}
function y(e, t) {
...
function C(e, t, n) {
    let i = y(e, t);
    return N({ activity: e, application: t, largeImageSrc: i.largeImage?.src, trackingSource: n }), i;
}
function N(e) {
