...
function h(t) {
    let e = t.isForumPost(),
        ...
        { firstMessage: O } = (0, l.e7)([d.Z], () => d.Z.getMessage(t.id), [t.id]),
        p = h && N && null == O,
        v = e && (N || (n && L < 1) || p),
        A = e && n && !N && L > 0 && null != O;
    return b && (!h || p) && (N || v || A)
        ? (0, i.jsx)(a.sNh, {
              ...
              label:
                  t.type === S.d4z.GUILD_CATEGORY
                      ? E.intl.string(E.t.ifbXnJ)
                      : t.isForumPost()
                        ? v
                            ? E.intl.string(E.t.nEOg1N)
                            : E.intl.string(E.t.xwMqDw)
                        : t.isThread()
                          ? E.intl.string(E.t.H7vTe3)
                          : E.intl.string(E.t["8D8Rsb"]),
              color: "danger",
              action: () => {
                  (0, o.w)(t, function () {
