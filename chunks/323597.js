...
function h(t) {
    ...
    return b && (!h || O) && (N || v || A)
        ? (0, i.jsx)(a.sNh, {
              id: 'delete-channel',
              label: t.type === S.d4z.GUILD_CATEGORY ? E.intl.string(E.t.ifbXnJ) : t.isForumPost() ? (v ? E.intl.string(E.t.nEOg1N) : E.intl.string(E.t.xwMqDw)) : t.isThread() ? E.intl.string(E.t.H7vTe3) : E.intl.string(E.t['8D8Rsb']),
              color: 'danger',
              action: () => {
                  (0, o.w)(t, function () {
                      A ? r.Z.deleteMessage(t.id, f.default.castChannelIdAsMessageId(t.id)) : s.ZP.deleteChannel(t.id);
                  });
              }
          })
        : null;
