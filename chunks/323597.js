...
function b(t) {
    let n = t.isForumPost(),
        ...
        { canManageChannel: p, canAccessChannel: m } = (0, r.cj)(
            ...
            () => ({
                ...
                canManageChannel: h.Z.can(t.isThread() ? v.Plq.MANAGE_THREADS : v.Plq.MANAGE_CHANNELS, t),
            }),
            [t],
        ),
        O = (0, r.e7)([c.Z], () => {
    ...
    return m && (!b || j) && (p || C || E)
        ? (0, i.jsx)(l.sNh, {
              ...
              action: () => {
                  (0, s.w)(t, function () {
                      E ? o.Z.deleteMessage(t.id, g.default.castChannelIdAsMessageId(t.id)) : a.ZP.deleteChannel(t.id);
                  });
              },
          })
        : null;
