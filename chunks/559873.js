...
function O(e) {
    ...
    return (0, i.jsx)(a.m, {
        ...
        children: (0, i.jsx)(r.D, {
            ...
            children: (0, i.jsx)(o, { size: c ? "sm" : "xs", className: R.gE }),
        }),
    });
}
function G(e) {
...
let M = {
    [T.kR.ACK]: {
        type: "standard",
        Icon: c.A,
        label: j.intl.string(j.t.e6RscS),
        onClick: (e) => {
    ...
    [T.kR.BOOKMARK]: {
        type: "menu",
        label: j.intl.string(j.t["9p3D9p"]),
        Icon: (e) =>
        ...
        Menu: (e) => {
            ...
            return (0, i.jsxs)(A.W, {
                ...
                "aria-label": j.intl.string(j.t.mJ3P0N),
    ...
    [T.kR.SETTINGS]: {
        type: "menu",
        Icon: m.X,
        label: j.intl.string(j.t.h850Ss),
        interactionType: N.X8.SETTINGS,
        Menu: (e) => {
            let { channel: t, renderPopoutProps: n } = e;
            return t.isThread()
                ? (0, i.jsx)(b.A, { ...n, channel: t, navId: "thread-context", label: j.intl.string(j.t["1NBjqb"]) })
                : (0, i.jsx)(E.A, { ...n, channel: t, navId: "channel-context", label: j.intl.string(j.t.Xm41aV) });
        },
    },
};
function D(e) {
