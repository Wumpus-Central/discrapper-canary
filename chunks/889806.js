...
class H extends D.Ay {
    ...
    renderPopout = (e) => {
        ...
        return t.isModeratorReportChannel() || s
            ...
            : null != l && l.length > 0 && a && !n
              ...
              : (0, i.jsx)(M.A, { ...e, channel: this.props.channel });
    };
    ...
    render() {
        let {
            ...
            O = j ?? this.channelItemRef,
            M = !T && o,
            D = !T && v && null != N && N.length > 0,
            U = (0, f.M)(I),
            w = (0, i.jsxs)("li", {
                className: a()(this.getClassName(), { [B.r9]: this.isDisabled(), [B.wH]: n }),
                "data-dnd-name": (0, p.m1)(e, G.default, L.A),
                onMouseEnter: M || D ? this.handleMouseEnter : void 0,
                onMouseLeave: M || D ? this.handleMouseLeave : void 0,
                children: [
                    (0, i.jsx)(d.Y, {
                        targetElementRef: O,
                        position: "right",
                        ...
                        spacing: 17,
                        shouldShow: (M && this.state.shouldShowThreadsPopout) || (D && this.state.shouldShowActivities),
                        children: () =>
                            (0, i.jsxs)(P.Ay, {
                                ...
                                resolvedUnreadSetting: S,
                                transitionExtras: R ? { source: b.A.CHANNEL_LIST_SUGGESTED_SECTION } : void 0,
                                "aria-label": (0, g.Ay)({
                                    channel: e,
                                    unread: s,
                                    mentionCount: c,
...
function W(e) {
    ...
    return (0, o.bG)([j.A, v.Ay], () => j.A.getChannelId() !== t.id && v.Ay.isCurrentUserGuest(t.getGuildId()))
        ? null
        : (0, i.jsx)(F, {
              ...g,
              ...f,
