...
function f(e) {
    ...
    return (
        s.useEffect(() => {
            if (t) return;
            let e = 0,
                n = [1000, 1000, 1000, 800, 800].map((t, n) => setTimeout(() => a(n + 1), (e += t)));
            return () => {
...
function p(e) {
    ...
    return (0, i.jsxs)("div", {
        className: r()(n, _.tip, { [_.hidden]: s }),
        children: [
            (0, i.jsx)(c.Text, {
...
function N(e) {
    let { grey: t, nodot: n, selected: s, name: a } = e;
    return (0, i.jsxs)("div", {
...
function C(e) {
    let { text: t, active: n, small: s, icon: a } = e;
    return (0, i.jsxs)("div", {
        className: r()(_.menuItem, { [_.active]: n }),
        children: [
            (0, i.jsx)(c.Text, {
