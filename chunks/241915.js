...
let A = (e) => {
        let { selectedPIPWindow: t, pipWindows: n, pipWidth: r, maxX: a, maxY: l, onWindowMove: c, onWindowResize: u, dockedRect: d, pictureInPictureComponents: _, appContext: h, roundCorners: g, resizeConfig: E } = e,
            [b, O] = o.useState(!1),
            v = o.useMemo(
                () =>
                    null == t
