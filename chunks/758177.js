...
let u = {
    [c.Etm.GET_IMAGE]: {
        ...
        handler(e) {
            let t,
                {
                    args: { type: n, id: a, format: s = 'png', size: u = 128 }
                } = e;
            if ('user' === n) {
                ...
                } else throw new o.Z({ errorCode: c.lTL.INVALID_USER }, 'Invalid user id: '.concat(a));
            }
            if (null == t) throw new o.Z({ errorCode: c.lTL.INVALID_COMMAND }, 'No valid type.');
            return fetch(t)
                .then((e) => e.blob())
                .then((e) => (0, l.fD)(e))
                .then((e) => ({ data_url: e }));
