...
function J(e) {
    ...
    return (0, n.jsx)(q.mG, {
        ...
        "aria-label": Q.intl.formatToPlainString(Q.t["7SnyMA"], { positionNumber: i + 1 }),
        onReorder: s,
        onEnd: () => r(String(t.skuId)),
        className: $.C,
        dropBeforeClassName: $.A,
        dropAfterClassName: $.Ze,
        draggingClassName: $.Id,
        children: (0, n.jsx)("div", { className: $.An, children: a }),
    });
}
...
function ec(e) {
    ...
    let m = (0, d.bG)([U.A], () =>
        ...
        j = x === ei.M.USER_PROFILE_WISHLIST_RECOMMENDATIONS;
    return s && (!c || j || u)
        ? (0, n.jsxs)("div", {
              className: a()(er.kL, o),
              children: [
                  (0, n.jsxs)("div", {
                      ...
                      children: [
                          (0, n.jsx)(h.E, {
                              ...
                              color: "text-subtle",
                              children: Q.intl.string(Q.t["+GB8Kt"]),
                          }),
                          c &&
                              (0, n.jsx)(et.J, {
                                  size: "xs",
    ...
    let {
        ...
        h = (function (e) {
            ...
            return l.useMemo(
                () =>
                    t.filter(w.Vq).map((e) => {
                        let t = ej.Ay.getApplicationIconURL({ id: e.id, icon: e.icon, size: 20 });
                        return {
                            id: `browse-social-layer-storefront-${e.id}`,
                            label: Q.intl.formatToPlainString(Q.t["HDT/rg"], { applicationName: e.name }),
                            iconLeft: null != t ? () => (0, n.jsx)("img", { className: eA.I, src: t, alt: "" }) : u.U,
                    ...
                    children: [
                        null != s &&
                            (0, n.jsx)(eu.Dr, {
                                ...
                                label: Q.intl.string(Q.t["5upuqx"]),
                                iconLeft: u.U,
                        ...
                        null != r &&
                            (0, n.jsx)(eu.Dr, {
                                ...
                                label: Q.intl.string(Q.t.lG6a5x),
                                iconLeft: eg.t,
    ...
    return (0, n.jsx)(em.Y, {
        ...
        renderPopout: (e) => {
            ...
            return (0, n.jsx)(eh.W, {
                ...
                onSelect: void 0,
                onClose: t,
                "aria-label": Q.intl.string(Q.t.GdNkvG),
                children: x,
            });
        },
        children: (e) =>
...
var eI = i(509434),
    ...
    ev = i(975571),
    eE = i(993401);
let ey = ev.A.getArticleURL(Y.MVz.CUSTOM_PROFILES_WISHLIST);
function eb(e) {
                    ...
                    ? (0, n.jsxs)(eu.rX, {
                          children: [
                              (0, n.jsx)(eu.fP, {
                                  ...
                                  label: Q.intl.string(Q.t.b2nFyA),
                                  subtext: Q.intl.string(Q.t.dw58pE),
                                  checked: i,
                                  action: s,
                              }),
                              (0, n.jsx)(eu.bX, {}),
                              (0, n.jsx)(eu.Dr, {
                                  ...
                                  label: Q.intl.string(Q.t.hvVgAZ),
                                  icon: eI.I,
              ...
              children: (0, n.jsx)(em.Y, {
                  ...
                  children: (e) =>
                      (0, n.jsx)(eE.q3, {
                          buttonRef: a,
                          icon: eS.j,
                          tooltipText: Q.intl.string(Q.t["UKOtz+"]),
...
function ew(e) {
    ...
    return t.length > 0
        ? (0, n.jsx)(ef, {
              title: Q.intl.string(Q.t["i/yzHs"]),
...
function eR(e) {
    ...
    return (0, n.jsxs)("div", {
        ...
        children: [
            t.length > 0 || null != a
                ? (0, n.jsx)(ef, {
                      title: Q.intl.string(Q.t.SDUwM0),
                ...
                : (0, n.jsx)(c.$, {
                      ...
                      size: "sm",
                      icon: g.j,
                      text: Q.intl.string(Q.t.SDUwM0),
                      onClick: l,
                  }),
            (0, n.jsx)(eb, { isOwner: !0, isWishlistPublic: i, onToggleVisibility: r }),
        ],
    });
}
function eO(e) {
    ...
    return (0, n.jsx)(c.$, {
        ...
        size: "sm",
        icon: u.U,
        text: Q.intl.formatToPlainString(Q.t["HDT/rg"], { applicationName: t.name }),
        onClick: a,
        onMouseDown: r,
    });
}
function ek(e) {
    let {
        ...
        o = l.useMemo(() => {
            ...
            return (0, n.jsx)(ef, {
                title: Q.intl.string(Q.t.FkjcWY),
                variant: "primary",
                handleOpenGameShop: a,
                socialLayerStorefrontApplicationIds: i,
            });
            ...
            (0, n.jsxs)("div", {
                ...
                children: [
                    (0, n.jsx)(m.D, {
                        ...
                        color: "text-strong",
                        children: Q.intl.string(Q.t.HGnLLT),
                    }),
                    (0, n.jsx)(h.E, {
                        variant: "text-sm/normal",
                        color: "text-default",
                        children: Q.intl.string(Q.t["/X1ny6"]),
                    }),
                ],
            }),
            (0, n.jsxs)(x.e, {
    ...
    let S = l.useCallback(
        ...
        E = l.useCallback(() => {
            ...
            I(!f),
                ...
                x({
                    wishlistId: g,
                    action: f ? eT.Mq.WISHLIST_TOGGLE_PRIVATE : eT.Mq.WISHLIST_TOGGLE_PUBLIC,
                ...
                (0, n.jsxs)("div", {
                    ...
                    children: [
                        ...
                        (0, n.jsx)(h.E, {
                            variant: "text-xs/normal",
                            color: "text-subtle",
                            children: Q.intl.string(Q.t.RX7D9h),
                        }),
                    ],
                }),
            f &&
                ...
                (0, n.jsxs)("div", {
                    ...
                    children: [
                        ...
                        (0, n.jsx)(h.E, {
                            variant: "text-xs/normal",
                            color: "text-subtle",
                            children: Q.intl.string(Q.t.d78ChW),
                        }),
                    ],
                }),
            (0, n.jsxs)("div", {
                ...
                children: [
                    (0, n.jsx)(h.E, {
                        ...
                        color: "text-subtle",
                        children: Q.intl.format(Q.t.r6Y1Lg, { count: s.items.length }),
                    }),
                    t
                        ? (0, n.jsx)(eR, {
                              socialLayerStorefrontApplicationIds: a,
...
function eG(e) {
    ...
    let { wishlistId: s, currentUser: r } = (0, d.cf)([U.A, M.default], () => ({
                ...
                : (0, n.jsxs)(n.Fragment, {
                      children: [
                          ...
                          (0, n.jsx)(eL, {
                              ...
                              handleOpenShop: j,
                              handleOpenGameShop: k,
                              handleAddNitroToWishlist: p && !(0, P.C3)(g, eC.pe.TIER_2) ? D : void 0,
                          }),
