...
var E = (function (e) {
    ...
    function n() {
        ...
        return g(p((e = t.call.apply(t, [this].concat(r)))), 'priority', 90), g(p(e), 'subpriority', 1), g(p(e), 'incompatibleTokens', ['Y', 'R', 'q', 'Q', 'M', 'L', 'w', 'I', 'd', 'E', 'i', 'e', 'c', 't', 'T']), e;
    }
    return (
        u(n, [
            {
