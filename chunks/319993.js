...
function H(e) {
    let { discoverableGuildId: t, closePopout: n, buttonType: i } = e,
        a = s.useCallback(async () => {
            if ((n(), null != t))
                try {
                    await O.A.joinGuild(t), O.A.transitionToGuildSync(t);
                } catch {}
        }, [n, t]);
...
function Y(e) {
    ...
    let { buttonType: R, description: O } =
            ((t = "0" === o.guildId),
            (n = (0, l.bG)([T.default], () => y.Ay.canUseSoundboardEverywhere(T.default.getCurrentUser()))),
                      ...
                      children: [
                          (0, r.jsxs)("div", {
                              ...
                              children: [
                                  ...
                                  (0, r.jsx)(_.E, { variant: "text-sm/normal", children: O }),
                              ],
                          }),
                          null != B &&
                              (0, r.jsxs)("div", {
                                  ...
                                  children: [
                                      ...
                                      (0, r.jsx)(H, { buttonType: R, discoverableGuildId: g?.id, closePopout: d }),
                                  ],
                              }),
                      ],
                  }),
                  (0, r.jsx)(f.Lp, { text: "BETA", color: u.A.colors.BACKGROUND_BRAND.css, className: j.aZ }),
              ],
          });
}
var W = n(14870);
function K() {
    ...
    return (0, r.jsxs)(d.D, {
        ...
        children: [
            ...
            (0, r.jsx)(h.A, { onValueChange: t, className: j.aw, initialValue: (0, S.M)(e), maxValue: 100 }),
        ],
    });
}
function $(e) {
    let { sound: t, forceShowBetaLabel: n = !1 } = e,
        ...
        s = (0, l.bG)([T.default], () => y.Ay.canUseSoundboardEverywhere(T.default.getCurrentUser())),
    ...
    return n || s || "0" === t.guildId || t.guildId === a || !i
        ...
        : (0, r.jsxs)("div", {
              className: j.Mq,
              children: [
                  (0, r.jsx)("div", { className: j.Nh }),
                  (0, r.jsxs)("div", {
                      className: j.Pc,
                      children: [
                          (0, r.jsx)(p.t, { size: "xxs", color: "white", className: j.aJ }),
                          (0, r.jsx)(_.E, {
                          ...
                          (0, r.jsx)(f.Lp, { text: "BETA", color: u.A.colors.BACKGROUND_BRAND.css, className: j.KD }),
                      ],
                  }),
              ],
          });
            ...
            (0, r.jsxs)("div", {
                ...
                children: [
                    (0, r.jsxs)("div", {
                        className: j.tn,
                        children: [
                            (0, r.jsx)(E.J, { size: "sm", className: j.nR }),
