...
function c(e, t, n) {
    ...
    switch (e) {
        ...
        case s.w.UNIGNORE_SUCCESS:
            return l.NW.formatToPlainString(l.t.THExKS, { username: f });
        case s.w.BLOCK_SUCCESS:
            return l.NW.formatToPlainString(l.t.XXPrIi, { username: f });
        case s.w.UNBLOCK_SUCCESS:
            return l.NW.formatToPlainString(l.t.uExcGR, { username: f });
        case s.w.MUTE_SUCCESS:
            return l.NW.formatToPlainString(l.t.X4NtYW, { username: f });
