...
var eQ = s(364522),
    ey = s(761508),
    eU = s(797788);
let eH = () => (0, r.jsx)("div", { className: eU.y });
var eD = s(834615),
    eF = s(332544);
let eq = function (e) {
    let { quest: t } = e;
...
function tC(e) {
    let { quest: t, questContent: s, sourceQuestContent: n, isHovering: l, isInFeaturedSection: a } = e,
        ...
        c = i === e5.UA.EXPIRED || (i === e5.UA.CLAIMED && (0, tf.GL)(t)),
...
let tJ = function (e) {
    ...
    tX = (e) => {
        ...
        return (0, r.jsxs)(r.Fragment, {
            children: [
                l("quest_bar") &&
                    (0, r.jsxs)(r.Fragment, { children: [(0, r.jsx)(eW, { quest: n }), (0, r.jsx)(eH, {})] }),
                l("home_card") &&
                    (0, r.jsxs)(r.Fragment, { children: [(0, r.jsx)(tV, { quest: n }), (0, r.jsx)(eH, {})] }),
                l("share_embed") &&
    ...
    return (0, r.jsx)(st, {
        renderPopout: (e, i) => {
            ...
            return (0, r.jsxs)("div", {
                children: [
                    n.map((e, t) => {
                        let n = e.options.map((e) => ({ label: (0, t4.up)(e.filter), value: e.filter })),
...
let sa = function (e) {
    ...
    return (0, r.jsx)(st, {
        ...
        children: (e, t) =>
            (0, r.jsx)(f.$, {
                ...e,
                "aria-label": ej.intl.formatToPlainString(ej.t.lPlIMo, { selected: (0, t4.Js)(n) }),
                buttonRef: t,
                size: "sm",
                text: (0, t4.Js)(n),
                icon: sr.g,
                    ...
                    s.map((t, s) => {
                        ...
                        return (0, r.jsxs)(
                            si.animated.div,
                            {
                                ...
                                style: su(l, a, v),
                                children: [
                                    l && (0, r.jsx)("div", { className: sf.E4 }, f),
                                    C
                                        ? (0, r.jsx)(tB, {
                                              quest: t,
                                              questContent: Z.uF.QUEST_HOME_DESKTOP,
...
let sN = [],
    ...
    sA = a.forwardRef(function (e, t) {
        let s,
            ...
            { enabled: g } = es.jm.useConfig({ location: tS.rE.QUEST_HOME_DESKTOP }),
            {
                quests: f,
                excludedQuests: j,
        ...
        return (
            ...
            (0, el.$P)({ selectedSortMethod: m, selectedFilters: E, numQuestsVisible: f.length }),
...
let sY = [
    ...
    sJ = (e) => e_.A.space.SPACE_XL.resolve({ density: e }),
    sX = (e, t) => (1220 - 2 * sJ(e) * (t ? 2 : 0.75)) / 3;
var sZ = s(522403);
...
let s8 = a.memo(function (e) {
        let {
            ...
            b = a.useCallback(() => {
                ...
                null == e ||
                    (0 !== e.clientWidth && (f(e.scrollLeft > 0), S(e.scrollLeft + e.clientWidth < e.scrollWidth - 1)));
            }, []),
            I = a.useCallback(() => {
        ...
        return (0, r.jsxs)("div", {
            ...
            children: [
                (0, r.jsx)("div", {
                    className: o()(sZ.k9, sZ.RW, { [sZ.Q2]: g }),
                    "aria-hidden": !0,
                    children: (0, r.jsx)(ed.K, {
                        icon: sG.Z,
                ...
                (0, r.jsx)("div", {
                    className: o()({ [sZ.sF]: g && _, [sZ.RC]: j && _, [sZ.Ni]: D && !g, [sZ.GA]: D && !j }),
    ...
    s4 = a.createContext({ targetQuestId: null, highlightCount: null, highlightAnimationProgress: null });
var s5 = s(76060);
function s6(e) {
    let { children: t, questId: s, featuredSection: n } = e,
        { targetQuestId: l, highlightCount: i, highlightAnimationProgress: o } = a.useContext(s4),
        u = l === s,
        c = null != l && l !== s,
...
function nl(e) {
    let { questContent: t, questIds: s, rowIndex: n, sectionIdentifier: l } = e,
        { targetQuestId: i } = a.useContext(s4),
...
class no extends E.Ay.PersistedStore {
    ...
    initialize(e) {
        ...
        return this.syncWith([eu.A], ni), t;
    }
    getState() {
        let e = {};
...
let nu = new no(ei.h, {
    ...
    nc = 2 * ti.A.Millis.DAY,
    nd = new Map(sY.map((e) => [e.identifier, e])),
    nm = {
...
let ng = {
    ...
    nj = a.forwardRef(function (e, t) {
                                          ...
                                          let c = (function (e) {
                                              ...
                                              return (0, tM.kd)(t) && !u
                                                  ...
                                                  : null != i && null != i.enrolledAt && null == i.claimedAt
                                                    ...
                                                    : n.has(t.id)
                                                      ? s$.DISCOVERED
                                                      : null != s && (0, e7.I0)(s, t.id) && nh(s$.FEATURED, l)
                                                        ? s$.FEATURED
        ...
        (0, sh.g)(h, A, [A], { fireOnMount: !0 });
        let [{ highlightAnimationProgress: O }, b] = (0, so.z)(() => ({
                highlightAnimationProgress: 1,
                config: { duration: nf },
            })),
            I = a.useCallback(
        ...
        a.useImperativeHandle(t, () => ({ scrollToQuest: I }), [I]),
            a.useLayoutEffect(() => {
                ...
                T.current !== s && ((0, eo.sB)(s), I(s) && (T.current = s));
            }, [s, I]);
        let R = a.useMemo(() => ({ targetQuestId: g, highlightCount: j, highlightAnimationProgress: O }), [g, j, O]),
            M = a.useMemo(
                () =>
                    d.findIndex((e) => {
                        let { identifier: t } = e;
                    ...
                    return (0, r.jsxs)(
                        "div",
                        {
                            ...
                            children: [
                                ...
                                s === s$.FEATURED && u && c
                                    ? (0, r.jsx)(ne, { questIds: n, setMaxRowIndex: p, containerWidth: C })
                                    : (0, r.jsx)(nl, {
                                          questIds: n,
                                          rowIndex: t < M ? t : t + N,
                                          sectionIdentifier: s,
...
let nv = (0, nS.v)((e, t) => ({
    ...
    logger: null,
    registerAssetLoad: () => {
        let s = t().logger ?? (0, nC.L)({ location: tS.rE.QUEST_HOME_DESKTOP });
...
function nI(e, t) {
    ...
    (0, ns.Qg)({
        adContentId: e,
        adCreativeType: np.p.QUEST_HOME_HERO,
        event: t,
        properties: n,
...
let nR = a.forwardRef(function (e, t) {
    let { adContentId: s, topContent: n, title: l, subtitle: i, buttons: u, background: c, className: d } = e,
        ...
        x = (0, nO.w)(h, [], { fireOnMount: !0 }),
        g = a.useCallback(() => nI(s, eO.HAw.QUEST_HOVER), [s]),
        f = a.useCallback(() => nI(s, eO.HAw.QUEST_HOVER_OFF), [s]);
    return (0, r.jsx)(tx.N, {
...
function nV(e) {
    ...
    a.useEffect(() => {
        let e = n.current;
        (0, nQ.vq)(e, HTMLVideoElement) && (l ? ((e.currentTime = 0), e.play().catch(eR.tE)) : e.pause());
    }, [l]);
...
function nW(e) {
    let { heroId: t, quest: s, onQuestCtaClick: n, contentPosition: l } = e,
        ...
        x = (0, E.bG)([tR.default], () => tR.default.getCurrentUser()),
        g = a.useMemo(() => (0, tL.mq)(s.config, x), [s.config, x]),
        j = a.useMemo(
            () =>
                (function (e, t) {
                    switch ((0, t4.xv)(e).type) {
                        case sb.l.IN_GAME:
    ...
    return (0, r.jsxs)(ev.D, {
        ...
        children: [
            (0, r.jsxs)(v.B, {
                ...
                gap: 4,
                children: [
                    (0, r.jsx)(ny.E, { type: { text: j } }),
                    (0, r.jsx)(si.animated.div, {
                        style: { opacity: (0, nP.a)(M.to([0, 1], [1, 0])) },
                        children: (0, r.jsx)(ny.E, { type: { text: h }, icon: nU.O }),
                    }),
                ],
            }),
            (0, r.jsx)(si.animated.div, {
                        ...
                        (0, r.jsxs)(v.B, {
                            ...
                            children: [
                                (0, r.jsxs)(v.B, {
                                    ...
                                    fullWidth: !1,
                                    children: [
                                        (0, r.jsx)(nH.y, { size: "xs", color: e_.A.colors.ICON_MUTED.css }),
                                        (0, r.jsx)(_.E, {
                                            variant: "text-sm/normal",
                                            color: "text-muted",
                                ...
                                (0, r.jsxs)(v.B, {
                                    ...
                                    fullWidth: !1,
                                    children: [
                                        (0, e7.pv)(s.config) === nL.Z.VIDEO
                                            ? (0, r.jsx)(nD.S, { size: "xs", color: e_.A.colors.ICON_MUTED.css })
                ...
                (0, r.jsx)(e8.R, {
                    ...
                    children: (e) =>
                        (0, r.jsx)("div", {
                            ...
                            children: (0, r.jsx)(nV, { hero: t, contentPosition: 0 }),
                        }),
                }),
                s.map((e, s) =>
                    (0, r.jsx)(
...
function nY(e) {
    let { heroImage: t, heroVideo: s } = e,
        n = a.useRef(null);
    (0, nA.A)(n, tS.rE.QUEST_HOME_DESKTOP);
...
function nJ(e) {
    let { hero: t, onQuestCtaClick: s } = e,
        ...
        { dismissQuestHomeHeroContent: o } = (0, nM.I)();
    a.useEffect(() => {
        o();
    }, [o]);
                ...
                children: (e) =>
                    (0, r.jsx)(nR, {
                        ...
                        topContent: (0, r.jsxs)(v.B, {
                            ...
                            children: [
                                null != t.sponsorImage &&
                                    (0, r.jsx)("img", { src: t.sponsorImage, alt: "", className: nz.wm }),
                                (0, r.jsx)(_.E, {
                                    color: "text-strong",
                                    variant: "text-sm/normal",
                                    className: nz.yu,
                        ...
                        buttons: (0, r.jsxs)(g.e, {
                            children: [
                                (0, r.jsx)(f.$, {
                                    onClick: () => {
                                        (0, nT._Q)(
                                            { adContentId: t.id, adCreativeType: np.p.QUEST_HOME_HERO, cta: t.cta },
                                            {
                        ...
                        background:
                            null != t.heroImage && (0, r.jsx)(nY, { heroImage: t.heroImage, heroVideo: t.heroVideo }),
                    }),
            }),
...
function nX() {
    return (0, r.jsx)("div", { className: o()(nb.iE, nb.FG, nb.B3), children: (0, r.jsx)(ex.y, {}) });
}
var nZ = s(740879),
    n0 = s(604880),
    n1 = s(318808);
function n2(e) {
    ...
    return (0, r.jsxs)("div", {
        className: nZ.MY,
        children: [
            (0, r.jsx)("img", { className: nZ.Bg, src: n1.Ay, alt: "" }),
            (0, r.jsx)("div", { className: nZ.r$, children: (0, r.jsx)("img", { src: n0, alt: "" }) }),
            (0, r.jsxs)("div", {
                className: nZ.Nr,
                children: [
                    (0, r.jsx)(S.D, {
        ...
        children: [
            ...
            0 === t.length
                ? (0, r.jsxs)(v.B, {
                      ...
                      className: n3.y7,
                      children: [
                          (0, r.jsx)(n7, { alt: ej.intl.string(ej.t["Xe+fJM"]) }),
                          (0, r.jsxs)(v.B, {
                              direction: "vertical",
                              align: "center",
                              children: [
...
let lt = {
    ...
    sortType: n6.r.JARO_WINKLER,
    throttleMs: 200,
};
var ls = s(758836),
    ln = s(613057),
    ll = s(935824);
let lr = a.createContext({});
function la(e) {
    let { banner: t, children: s, header: n, withFullBleedBanner: l = !1 } = e,
        { onScroll: i, scrollerRef: o } = a.useContext(lr);
    return (0, r.jsxs)(e6.X.Provider, {
        ...
        children: [
            ...
            (0, r.jsxs)(B.A, {
                ...
                children: [
                    l && t,
                    (0, r.jsxs)(P.A, { className: ll.Jo, innerClassName: ll.FG, children: [!l && t, s] }),
                ],
            }),
        ],
    });
...
function lu(e) {
    ...
    return (0, r.jsxs)("div", {
        className: o()(ll.Tv, { [ll.lJ]: s }),
        children: [
            (0, r.jsx)(n$, {}),
            (0, r.jsx)("div", { className: o()(ll.nz, { [ll.ZZ]: s }) }),
            (0, r.jsx)(lo, { onLoadComplete: t, className: o()(ll.Fe, { [ll.H4]: s, [ll.Q8]: !s }) }),
        ],
    });
}
function lc(e) {
...
let lE = function (e) {
    let { topLevelRoute: t } = e,
        ...
        g = (0, E.bG)([M.A], () => M.A.getState("quests")),
        {
            selectedTab: j,
            onSelectTab: T,
            tabs: y,
        ...
        })({ withClaimedQuestsTab: !l }),
        {
            ...
            let d = a.useCallback(
                (e) => {
                    if (
                        ...
                        let { searchSession: t, isNew: s } = (0, le.$N)();
            ...
            return (0, n9.RT)(r, l, d, lt), { matchingQuestIds: s, query: e, setQuery: t, onSearchClose: c };
        })();
    a.useLayoutEffect(() => {
    ...
    let eo = a.useRef(null),
        ...
        ef = a.useMemo(() => ((0, X.uJ)(s.hash) ? null : s.hash.substring(1)), [s.hash]),
        ...
        eC = a.useCallback(() => {
            (0, W.Y)({
                ...
                (0, L.Cz)({ tab: ls.G2.ORBS, analyticsLocations: [], analyticsSource: b.A.ORBS_BALANCE_MENU });
        }, []);
    a.useEffect(() => {
    ...
    return x
        ? (0, r.jsx)(n2, { adCreativeIds: i })
        : (0, r.jsx)(nN.M.Provider, {
              value: eT,
              children: (0, r.jsx)(lr.Provider, {
                  value: eA,
                  children: (0, r.jsx)("div", {
                      className: o()(ll.kL, { [ll.KY]: !t }),
                      children: l
                          ? (0, r.jsx)(la, {
                                withFullBleedBanner: !0,
                                header: (0, r.jsx)(li, { selectedTab: j, onSelectTab: eN, tabs: y }),
                                banner: (0, r.jsx)(w.A, {
                                    ...
                                    className: ll.Gj,
                                    children: (0, r.jsx)(lm, { onLoadComplete: Y }),
                                }),
                                children: (0, r.jsxs)("div", {
                                    className: ll.kj,
                                    children: [
                          ...
                          : (0, r.jsxs)(la, {
                                ...
                                children: [
                                    ep && null != P && (0, r.jsx)(n8, { matchingQuestIds: P }),
                                    j === el.NC.CLAIMED
                                        ? (0, r.jsx)(sW, { onSelectTab: eN, className: ep ? ll.R : void 0 })
                                        : j === el.NC.PREVIEW_TOOL
                                          ? (0, r.jsx)(t1, { className: ep ? ll.R : void 0 })
                                          : eE
                                            ? (0, r.jsx)(nj, {
                                                  className: ep ? ll.R : void 0,
                                                  ref: ex,
                                                  deepLinkedQuestId: ef,
