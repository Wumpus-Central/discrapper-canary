...
var tL = n(282613);
let tw = r.lazy(() => Promise.all([n.e("22683"), n.e("24832")]).then(n.bind(n, 748579)));
function tM() {
...
function n2(e) {
    ...
    let P = (0, c.bG)([t6.A], () => t6.A.getStatus(E.id)),
        ...
        H = r.useRef(null),
        Y = r.useRef(null),
        W = (0, tE.A)(N?.profileFrame?.skuId, "UserProfileAccountPopout"),
        { profileFrameStyle: K, profileFrameClassName: $ } = (0, tg.A)(N?.profileFrame?.skuId),
        z = (0, tU.$)("UserProfileAccountPopout");
    (0, tp.A)({ skuId: N?.profileFrame?.skuId, openedAt: S, context: R, analyticsLocations: v });
    let q = r.useRef((0, tT.A)((e) => e.shouldRenderTenureLevelUp)),
        Z = r.useMemo(() => (0, tA.A)(), []),
        [X, Q] = r.useState(() => tT.A.getState().shouldRenderTenureLevelUp);
    r.useEffect(() => {
        let e = setTimeout(() => {
            Q(!1);
        }, 500);
    ...
    let ee = (e) => {
            g?.(), (0, tF.openUserProfileModal)({ customStatusPrompt: Z, sourceAnalyticsLocations: v, ...R, ...e });
        },
        ...
        children: (0, i.jsx)(tk.of, {
            ...
            children: (0, i.jsxs)(eT.l, {
                ...
                children: [
                    ...
                    (0, i.jsxs)(eA.F, {
                        children: [
                            (0, i.jsx)(n$, { displayProfile: N, handleOpenUserProfileModal: ee, height: b }),
                            (0, i.jsxs)(t$.A, {
                                ...
                                children: [
                                    ...
                                    N?.profileEffect != null &&
                                        !q.current &&
                                        (0, i.jsx)(tf.A, { skuId: N.profileEffect.skuId, isHovering: L }),
