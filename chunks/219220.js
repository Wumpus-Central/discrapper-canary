    ...
    return (
        ...
        n.useEffect(() => {
            if (r !== k.current) {
                ...
                for (let r of t ?? []) {
                    let t = l(r);
                    !g.current.has(t) && ((e = !1), E.current.has(t) || E.current.set(t, 0));
                }
                d(e), (i.current = 0);
            }
        }, [r, t, u]),
        n.useEffect(() => {
            if (null == r || null == t || 0 === t.length || !1 === R || 0 !== i.current) return;
            i.current = 1;
            let e = w.current;
            t.forEach(async (t) => {
                let n = l(t);
                if (g.current.has(n)) E.current.set(n, 2), o(E.current) && (d(!0), (i.current = 2));
                else
                    try {
                        let u =
                            "id" in t
