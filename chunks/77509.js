...
class c {
    ...
    initialize() {
        ...
        let { pathname: t } = (0, o.JK)().location;
        s.A.getState().resetPath(t),
    ...
    handleConnectionChange = () => {
        let t = r.A.isConnected(),
            e = t && !this.connected;
        (this.connected = t),
            e && ((this.routeChangeCount = 0), this.executeRouteRewrites((0, o.JK)().location, "REPLACE"));
    };
    handleRouteChange = (t, e) => {
        if ("POP" !== e) {
            if (this.executeRouteRewrites(t, e)) return;
            if (!(0, l.o)(t)) return void (0, o.bG)(a.BVt.ME);
        }
        let i = s.A.getState();
    ...
    executeRouteRewrites(t, e) {
        if (((this.routeChangeCount += 1), this.routeChangeCount < 10))
            for (let i of this.rewrites) {
                let r = (0, o.JK)().location.pathname,
                    s = i(t, e);
                if (null != s)
                    return (
                        (0, n.Z)({
    ...
    addRouteChangeListener(t) {
        return (
            null != this.unlistenHistory && t((0, o.JK)().location, "REPLACE"),
    ...
    addRouteRewriter(t) {
        if (null != this.unlistenHistory) {
            let e = t((0, o.JK)().location, (0, o.JK)().action);
            null != e && (0, o.bG)(e.path, e.state);
        }
