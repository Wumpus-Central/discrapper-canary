...
class Q {
        ...
        for (const e in i) {
            ...
            if (t.type !== M.rbe.GUILD_CATEGORY) {
                ...
                ey(this, t, y)
                    ...
                    null != t.parent_id && t.parent_id in h ? h[t.parent_id].push(t) : o.push(t);
            }
        }
        for (const e in ((this.categories = {}), h)) this.categories[e] = new et(this, a[e], h[e], y);
    ...
    isPlaceholderRow(e, t) {
        return s()(e > H, "Invalid section"), e !== this.recentsSectionNumber && this.getRows()[e][t] === Y;
    }
    ...
    getSectionRowsFromChannel(e) {
        ...
        if (null != t) return [{ row: this.getGuildActionSection().getRows().indexOf(t), section: H }];
        let n = [],
            i = _.A.getChannel(e);
        ...
        let o = this.getCategory(i),
            h = o instanceof ee ? J : this.getSortedNamedCategories().indexOf(o) + K,
    ...
    updateChannel(e, t) {
        ...
        if (this.guild.optInEnabled) {
            ...
            if (ey(this.guild, e, t) && null == n)
                return (this.channels[e.id] = new ed(this, e, t)), this.invalidate(), !0;
        }
        return n;
    }
    getFirstVoiceChannel(e) {
...
class ea {
    ...
    get lastMessageTimestamp() {
        return Math.max(L.Ay.lastMessageTimestamp(this.id), ...this.threadIds.map(L.Ay.lastMessageTimestamp));
    }
    updateChannel(e, t) {
        let n = !1;
...
class eo extends ea {
    computeState(e) {
        ...
        if (!N.A.can(j.xB.VIEW_CHANNEL, this.record)) {
            ...
            else if (!d.A.isChannelGatedAndVisible(this.record.guild_id, this.record.id))
        ...
        let o = t?.id === this.id || n === this.id,
            ...
            u = (o || h || (!this.category.isCollapsed && !this.isMuted) ? i[this.id] : s[this.id]) ?? {},
                      ...
                      : a.hideMutedChannels && a.mutedChannelIds.has(this.id)
                        ...
                        : this.category.isCollapsed &&
                            (a.mutedChannelIds.has(this.id) ||
                                ...
                                ((0, w.ig)(this.record.type) && !L.Ay.hasUnread(this.record.id)))
...
class eu extends eo {
    getRenderLevel(e) {
        ...
        return !N.A.can(j.xB.VIEW_CHANNEL, this.record) || 4 === e || 3 === e || eC(t, this.record)
            ? 1
            : this.category.isCollapsed
    ...
    if (w.wE.has(e.type)) {
        ...
        return r
            ...
            : a
              ...
              : s
                ? e.filter((e) => !S.A.isMuted(e) || L.Ay.getMentionCount(e) > 0)
                : e;
    }
    return [];
}
...
function ey(e, t, n) {
    ...
    if (
        ...
        (t.isGuildVocal() && (!B.A.isVoiceCategoryCollapsed(e.id) || l().some(x.A.getVoiceStatesForChannel(t.id))))
    )
        return !1;
    if ((null != i && (i.id === t.id || (i.isThread() && i.parent_id === t.id))) || L.Ay.getMentionCount(t.id) > 0)
        return !0;
    for (let e in s[t.id])
        if (L.Ay.getMentionCount(e) > 0 || L.Ay.hasUnread(e) || L.Ay.hasRecentlyVisitedAndRead(e)) return !0;
    ...
    return !!((r.has(t.id) && a.indexOf(t.id) < z) || L.Ay.hasRecentlyVisitedAndRead(t.id));
}
