...
class X {
    ...
    nonPositionalChannelIdUpdate(e) {
        ...
        return (
            ...
            (t instanceof N.YB || null != (t = w.A.getChannel(e))) &&
...
class ee {
    ...
    constructor(e, t, n) {
        (this.id = e),
            ...
            (this.optInEnabled = (0, p.WW)(this.id)),
        ...
        (this.moderatorReportChannelId = null != l ? (0, y.A)(l) : null),
            (this.moderatorReportChannelEnabled = null != l && (0, f.A)(l));
        const a = {},
            d = [],
            h = {};
        for (const e in i) {
        ...
        (this.recentsSectionNumber = Z),
            ...
            (this.recentsCategory = (0, I.i)()
                ...
                : new el(this, o, C)),
            (this.voiceChannelsCategory = new er(this, c, a, C)),
    ...
    getSectionRowsFromChannel(e) {
        ...
        if ((a >= 0 && n.push({ section: this.recentsSectionNumber, row: a }), i.type === M.rbe.GUILD_CATEGORY))
            return [{ section: r().findIndex(this.getSortedNamedCategories(), (e) => e.id === i?.id) + $ }];
...
class es extends et {
    constructor(e, t) {
        ...
        this.channels = r()(D.Ay.getGuildFavorites(e.id) ?? [])
        ...
        return this.id !== a.moderatorReportChannelId || a.moderatorReportChannelEnabled
            ? a.optInEnabled && a.hideResourceChannels && this.record.hasFlag(k.lx.IS_GUILD_RESOURCE_CHANNEL)
                ...
                : !a.optInEnabled || a.optedInChannels.has(this.id) || (null != l && a.optedInChannels.has(l))
                  ? d || h || !r().isEmpty(c) || O.Ay.getMentionCount(this.id) > 0
                      ...
                      : a.hideMutedChannels && a.mutedChannelIds.has(this.id)
                        ...
                        : this.category.isCollapsed &&
                            (a.mutedChannelIds.has(this.id) ||
                                ...
                                ((0, N.ig)(this.record.type) && !O.Ay.hasUnread(this.record.id)))
...
class ec extends eh {
    computeState(e) {
        let { selectedChannel: t, selectedVoiceChannelId: n, activeJoinedRelevantThreads: i } = e;
        return b.A.can(H.xB.VIEW_CHANNEL, this.record)
            ? eE(this.category.guild, this.record, e)
    ...
    switch (e.type) {
        case M.rbe.GUILD_VOICE: {
            ...
            let l = h.A.getChannelStatus(e),
                { enableHangoutWindow: r } = (0, g.kY)({ guildId: e.guild_id, location: "ChannelListState" });
            if (null != l && l.length > 0 && !(r && (0, C.TP)(l))) return { type: "voice", text: l };
            let o = a.Ay.getEmbeddedActivitiesForChannel(e.id)
                .map((e) => d.A.getApplication(e.applicationId)?.name)
                .filter(U.Vq);
            if (o.length > 0) return { type: "embedded-activities", name: o.join(", ") };
            return null;
        }
    ...
    if (N.wE.has(e.type)) {
        ...
        return l
            ...
            : a
              ...
              : s
                ? e.filter((e) => !v.A.isMuted(e) || O.Ay.getMentionCount(e) > 0)
                : e;
    }
    return [];
}
