...
function q(e, t) {
    ...
    return (
        ...
        void 0 !== n &&
            ((ep.indices[i] = n),
            "application" === e.type &&
                (ep.applicationIndices.set(i, n), (ep.applicationIndicesVersion = ep.applicationIndicesVersion + 1))),
        o
    );
}
function X(e) {
...
function ee(e) {
    ...
    let { target: n } = e,
        r = z(n);
    eC(null != (t = ep.indices[r]) ? t : V) && en(n);
}
async function et(e) {
    var t, n, r;
    let i = z(e),
        o = null != (t = ep.indices[i]) ? t : V;
    if (!eC(o)) {
...
function er(e) {
    ...
    let r = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
        { target: i, index: o } = e,
        a = null == (t = b.default.getCurrentUser()) ? void 0 : t.id;
    if (null == a) return W || K.push(e), !1;
    let s = {},
        l = {},
        u = new Set();
    for (let e of o.applications) {
        ...
        let t = {
            descriptor: j(x({}, (0, C.X0)(eP(e))), {
                permissions: null != e.permissions ? (0, _.tk)(ex(e.permissions, a)) : void 0,
                botId: e.bot_id,
            }),
            commands: {},
        };
    ...
    (0, C.nG)(
        o.application_commands.map((e) => ew(e, a)),
        !0,
    ))) {
...
function ea(e, t) {
    ...
    return (
        t.forEach((e) => {
            ...
            if (null == n) return;
            let r = i.sections[n];
            a()(null != r, "Bot has no matching index section"),
                a()(null != r.descriptor.application, "Bot's index section has no application info");
            let s = (0, C.X0)(j(x({}, r.descriptor.application), { bot: t }));
...
class e_ extends (r = s.ZP.Store) {
    ...
    getUserState() {
        var e;
        return null != (e = this.indices[U]) ? e : V;
    }
    ...
    constructor(...e) {
        super(...e),
            ...
            L(this, "oldLocale", p.default.locale),
            L(this, "collator", new Intl.Collator(p.default.locale, Y));
    }
}
...
function em(e, t, n) {
    let [r, o] = i.useState(!0),
        a = (0, s.cj)([ep], () => ("channel" === e.type ? ep.getContextState(e) : ep.getUserState()));
    return (
        i.useEffect(() => {
            if (r) {
                if ("contextless" === e.type) {
                    n && eC(a) && (0, S.j)({ type: "user" });
                    return;
                }
                n &&
                    t &&
...
function eE(e, t) {
    let [n, r] = i.useState(!0),
        o = (0, s.cj)([ep], () => ep.getUserState());
    return (
        i.useEffect(() => {
            n && (t && eC(o) && e && (0, S.j)({ type: "user" }), r(!1));
        }, [o, t, e, n]),
        o
    );
}
function eb(e, t) {
    let [n, r] = i.useState(!0),
        o = (0, s.e7)([ep], () => ep.getApplicationState(e));
    i.useEffect(() => {
        n &&
            (t &&
                eC(o) &&
...
function ey() {
    return (0, s.e7)([ep], () => ep.getApplicationStates());
}
function eO() {
    return (0, s.e7)([ep], () => ep.applicationIndicesVersion);
}
function ev(e, t, n, r) {
    ...
    return i.useMemo(() => {
        ...
        return 0 === e.length
            ...
            : {
                  descriptors: [v.Tm[w.bi.FRECENCY], ...o],
                  commands: e.concat(a),
                  sectionedCommands: [
                      {
...
function eS(e) {
    ...
    let {
        ...
        U = null != (o = null == (n = f.result) ? void 0 : n.sections) ? o : {},
        G = new Set();
    if (g) {
        ...
        if (null != r && null != i) {
            ...
            null != r
                ...
                : null != i
                  ...
                  : null != o && ((t = o.descriptor), (n = Object.values(o.commands)));
    ...
    return {
        ...
        loading:
            ...
            (null != b && (null == (r = _.get(b)) ? void 0 : r.fetchState.fetching) === !0),
    };
}
function eA(e, t, n, r, i) {
    ...
    return 0 !== (o = c !== A.p.NONE && null != a && null != s ? eM(a, s, E, e, c) : E).length || l
        ? ((c === A.p.NONE || c === A.p.APPLICATION_ONLY) && o.sort((e, t) => ek(e.displayName, t.displayName)),
          {
              section: e,
              data: o,
          })
...
function ew(e, t) {
    ...
    let s = j(x({}, e), {
        ...
        options: null != (a = null == (n = e.options) ? void 0 : n.map(eD)) ? a : [],
...
function eM(e, t, n, r, i) {
    ...
    for (let t of n) {
        ...
        (i === A.p.COMMAND_ONLY || i === A.p.COMMAND_OR_APPLICATION) && (n = ej(t, e, c, u)),
            (void 0 === n || (void 0 !== o && o < n)) && (n = o),
            void 0 !== n && a.push(j(x({}, t), { score: n }));
    }
    return a;
}
function ej(e, t, n, r) {
    ...
    for (let { name: n, serverLocalizedName: r } of null != (i = e.options) ? i : []) {
        if (
            ...
            (null != a && "".concat(a, " ").concat(n).startsWith(t)) ||
            (null != r &&
                (r.startsWith(t) ||
                    "".concat(o, " ").concat(r).startsWith(t) ||
                    (null != a && "".concat(a, " ").concat(r).startsWith(t))))
        )
            return 3;
...
function eG(e, t) {
    ...
    let d = ep.getContextState(e),
        f = ep.getUserState(),
        _ = null != (a = null == (n = d.result) ? void 0 : n.sections) ? a : {},
        p = null != (s = null == (r = f.result) ? void 0 : r.sections) ? s : {},
        h = _[t],
        m = p[t],
        g = null == (o = ep.getApplicationState(t).result) || null == (i = o.sections) ? void 0 : i[t];
    if (null != h && null != m) {
