...
function es(e, t) {
    ...
    return (
        t.forEach((e) => {
            ...
            let l = (0, R.X0)(j(M({}, s.descriptor.application), { bot: t }), !1, n);
...
class ep extends (r = s.ZP.Store) {
    ...
    constructor(...e) {
        super(...e),
            ...
            L(this, "collator", new Intl.Collator(p.default.locale, W));
    }
}
...
function eA(e) {
    ...
    if (
        ...
        let e = eC(I.Tm[w.bi.BUILT_IN], D, !0, !0, L);
        null != e && x.push(e);
    }
    let Z = x.flatMap((e) => e.data.map((t) => j(M({}, t), { section: e.section })));
...
function eC(e, t, n, r, i) {
    ...
    return 0 !== (a = c !== C.p.NONE && null != o && null != s ? ek(o, s, E, e, c) : E).length || l
...
function ek(e, t, n, r, i) {
    ...
    for (let t of n) {
        let n;
        (i === C.p.COMMAND_ONLY || i === C.p.COMMAND_OR_APPLICATION) && (n = ej(t, e, c, u)),
            (void 0 === n || (void 0 !== a && a < n)) && (n = a),
            void 0 !== n && o.push(j(M({}, t), { score: n }));
    }
    return o;
}
function ej(e, t, n, r) {
