    ...
    for (let e of a.applications) {
        ...
        let t = {
            descriptor: j(M({}, (0, R.X0)(ew(e))), {
                permissions: null != e.permissions ? (0, p.tk)(eM(e.permissions, o)) : void 0,
                botId: e.bot_id
            }),
            commands: {}
        };
...
function es(e, t) {
    ...
    return (
        t.forEach((e) => {
            ...
            (r.descriptor = M({}, r.descriptor, s)), (a = !0);
        }),
        a
    );
}
...
function eg(e, t, n) {
    let [r, a] = i.useState(!0),
        o = (0, l.cj)([eh], () => ('channel' === e.type ? eh.getContextState(e) : eh.getUserState()));
    return (
        i.useEffect(() => {
            if (r) {
...
function ey(e, t) {
    let [n, r] = i.useState(!0),
        a = (0, l.e7)([eh], () => eh.getApplicationState(e));
    i.useEffect(() => {
        n &&
            (t &&
                eR(a) &&
...
function eN(e, t, n, r, i) {
    ...
    return 0 !== (a = c !== N.p.NONE && null != o && null != s ? ek(o, s, y, e, c) : y).length || l
        ? ((c === N.p.NONE || c === N.p.APPLICATION_ONLY) && a.sort((e, t) => eU(e.displayName, t.displayName)),
          {
              section: e,
              data: a
          })
...
function ek(e, t, n, r, i) {
    ...
    for (let t of n) {
        let n;
        (i === N.p.COMMAND_ONLY || i === N.p.COMMAND_OR_APPLICATION) && (n = ej(t, e, c, u)), (void 0 === n || (void 0 !== a && a < n)) && (n = a), void 0 !== n && o.push(j(M({}, t), { score: n }));
    }
    return o;
}
function ej(e, t, n, r) {
