...
class e_ extends (r = l.ZP.Store) {
    ...
    getContextState(e) {
        var t, n;
        return 'contextless' !== e.type && eN(e.channel) ? (null != (n = this.indices[null != (t = e.channel.guild_id) ? t : e.channel.id]) ? n : Z) : V;
    }
    ...
    getGuildState(e) {
        var t;
        return null == e ? V : null != (t = this.indices[e]) ? t : Z;
    }
    getUserState() {
        var e;
    ...
    query(e, t, n) {
        if (null == b.default.getCurrentUser()) return F;
...
function eT(e) {
    ...
    let F = L.flatMap((e) => e.data.map((t) => M(x({}, t), { section: e.section })));
...
function eA(e, t, n, r, i) {
    ...
    return 0 !== (o = c !== A.p.NONE && null != a && null != s ? ek(a, s, E, e, c) : E).length || l
...
function ek(e, t, n, r, i) {
    ...
    for (let t of n) {
        let n;
        (i === A.p.COMMAND_ONLY || i === A.p.COMMAND_OR_APPLICATION) && (n = eM(t, e, c, u)), (void 0 === n || (void 0 !== o && o < n)) && (n = o), void 0 !== n && a.push(M(x({}, t), { score: n }));
    }
    return a;
}
function eM(e, t, n, r) {
