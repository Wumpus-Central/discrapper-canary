...
function eo(e, t) {
    ...
    return (
        t.forEach((e) => {
            ...
            let s = (0, N.X0)(j(L({}, r.descriptor.application), { bot: t }));
...
class e_ extends (r = s.ZP.Store) {
    initialize() {
        this.waitFor(p.default),
            this.waitFor(T.ZP, d.Z, m.default, g.Z, E.Z, b.default),
...
function ex(e) {
    var t;
    let n = j(L({}, e), { name: null != (t = e.name_default) ? t : e.name });
