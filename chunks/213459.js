...
function Q(e, t) {
    ...
    return (
        null != o
            ? ('fetchState' in t && o.fetchState.fetching && o.fetchState.abort.abort(), (n = k({}, o, t)))
            : r &&
              (n = k(
                  {
                      serverVersion: B,
...
function et(e) {
    ...
    let { target: n } = e,
        r = q(n);
    eP(null != (t = eh.indices[r]) ? t : H) && er(n);
}
async function en(e) {
    var t, n, r;
    let i = q(e),
...
function es(e, t) {
    ...
    return (
        t.forEach((e) => {
            ...
            let s = (0, P.X0)(j(k({}, r.descriptor.application), { bot: t }));
            (r.descriptor = k({}, r.descriptor, s)), (o = !0);
        }),
        o
    );
}
...
class ep extends (r = l.ZP.Store) {
    ...
    constructor(...e) {
        super(...e), x(this, 'indices', {}), x(this, 'applicationIndices', new Map()), x(this, 'applicationIndicesVersion', 0), x(this, 'oldLocale', h.default.locale), x(this, 'collator', new Intl.Collator(h.default.locale, W));
    }
}
...
function eb(e, t) {
    ...
    return (
        i.useEffect(() => {
            n && (t && eP(o) && e && (0, A.j)({ type: 'user' }), r(!1));
        }, [o, t, e, n]),
        o
    );
}
...
function eA(e) {
    var t, n, r, i, o, s, l;
    let { permissionContext: c, contextState: u, userState: d, applicationStates: f, text: p, builtIns: h = N.D.ALLOW, allowApplicationCommands: g = !0, singleApplicationId: E, allowEmptySections: y = !1, scoreMethod: O = N.p.NONE, sortOptions: v = eS, installOnDemand: S = !1 } = e,
        { commandTypes: A } = c,
        C = null == p ? void 0 : p.toLowerCase(),
        P = null == C ? void 0 : C.split(' '),
        R = h === N.D.ONLY_TEXT,
        w = h !== N.D.DENY ? (0, I.Kh)(A, !0, R) : [],
        L = [],
        x = {
            permissionContext: c,
            query: C,
    ...
    if (
        ...
        L.sort((e, t) => {
            if (v.applications.useScore && O === N.p.APPLICATION_ONLY) {
                var n, r, i, o;
    ...
    let F = L.flatMap((e) => e.data.map((t) => j(k({}, t), { section: e.section })));
    if (O === N.p.COMMAND_ONLY || O === N.p.COMMAND_OR_APPLICATION) {
        let e = c.context,
...
function eN(e, t, n, r, i) {
    ...
    for (let i of t)
        if (
            ...
            var O;
            if (b && i.applicationId === f.gu && (null == (O = u.context) ? void 0 : O.isGuildVoice())) continue;
            y.push(i);
        }
    return 0 !== (o = c !== N.p.NONE && null != a && null != s ? eM(a, s, y, e, c) : y).length || l
...
function ex(e) {
    var t;
    let n = j(k({}, e), { name: null != (t = e.name_default) ? t : e.name });
...
function eM(e, t, n, r, i) {
    ...
    for (let t of n) {
        let n;
        (i === N.p.COMMAND_ONLY || i === N.p.COMMAND_OR_APPLICATION) && (n = ej(t, e, c, u)), (void 0 === n || (void 0 !== o && o < n)) && (n = o), void 0 !== n && a.push(j(k({}, t), { score: n }));
    }
    return a;
}
function ej(e, t, n, r) {
