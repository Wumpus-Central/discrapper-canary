...
async function V(e) {
    ...
    if (await F())
        try {
            await y.Ay.invoke("NOTIFICATIONS_SEND_NOTIFICATION", { sound: B(e, n) });
            return;
        } catch (e) {
...
let H = r().throttle(V, 1e3, { leading: !0 });
function j() {
    y.Ay.flashFrame(!1);
}
...
function z(e) {
    let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 1,
        n = arguments.length > 2 ? arguments[2] : void 0;
    e.includes("message") ? H(e, t, n) : V(e, t, n);
}
async function X(e, t, n, i, r) {
    ...
    if (u) {
        ...
        if (
            (null != e && (a.icon = e),
            r?.sound != null && (a.sound = B(r.sound, r.soundpack)),
        ...
        try {
            ...
            ((V = "native_ipc_error"), P.warn("Native notification failed with error: ", e));
        }
    ...
    if (j) {
        let { result: e, reason: t } = h({ embeddedMac: j, constructed: !1, nativeFailureReason: V });
        w(e, t, "html5");
        return;
    }
    try {
    ...
    let { result: $, reason: X } = h({ embeddedMac: j, constructed: !0, nativeFailureReason: V });
    return (w($, X, "html5"),
    F(l, i),
    (l.onclick = (e) => {
