        ...
        return i.useMemo(() => {
            ...
            if (0 !== a) {
                ...
                if (null == n)
                    for (let e of d)
                        e.stickers.length > 0
                            ? (E++, i(e.stickers, e.type, t?.has(e.id) === !0))
                            : e.type === g.Z2.EMPTY_GUILD_UPSELL && ((f[m] = 0), m++);
                else
                    n.sendable.length > 0 && i(n.sendable, g.Z2.SEARCH_RESULTS),
                        n.sendableWithPremium.length > 0 && i(n.sendableWithPremium, g.Z2.SEARCH_RESULTS);
            }
