...
function c(e) {
    ...
    return (0, r.useMemo)(() => {
        var r, i, a;
        let l = (0, o.b)('collectibles/'.concat(e.src, 'img.png')),
            c = (0, o.b)('collectibles/'.concat(e.src, 'asset.webm')),
            u = (0, o.b)('collectibles/'.concat(e.src, 'static.png'));
        if (e.preview)
            return {
                staticAsset: null == (r = t(e.src)) ? void 0 : r.staticUrl,
                animatedAsset: null == (i = t(e.src)) ? void 0 : i.animatedUrl
            };
        let d = (null != (a = platform.name) ? a : 'unknown').toLowerCase();
        return {
            staticAsset: u,
