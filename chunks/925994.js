...
function b(e, t) {
    let { mode: n, ignoreTrailingEmptyNodes: r, preventEmojiSurrogates: i } = null != t ? t : {},
        [a, o] = (null == t ? void 0 : t.range) != null ? _.M8.edges(t.range) : [void 0, void 0];
    return y(e, {
        mode: n,
        start: a,
        end: o,
...
function O(e, t) {
    let { mode: n, start: r, allowBlockQuotePrefix: i = !1, preventEmojiSurrogates: m = !1 } = null != t ? t : {};
...
function v(e, t) {
    ...
    return (
        ...
        i()(null == o || 0 === o.path.length, "Invalid end provided to serializeText"),
        e.substring(
            null != (n = null == a ? void 0 : a.offset) ? n : 0,
            null != (r = null == o ? void 0 : o.offset) ? r : e.length,
        )
    );
}
