        ...
        return (
            (function (e, t, n) {
                if (t === y.VL.UPDATE) {
                    let t = e.attachments ?? [],
                        n = e.embeds ?? [],
                        r = t.filter((e) => (0, C.gh)(v.kn.EXPLICIT, { type: S.D.Attachment, media: e })),
                        i = n.filter((e) => (0, C.gh)(v.kn.EXPLICIT, { type: S.D.Embed, media: e }));
                    (0, y.Kl)({
                        messageId: e.id,
...
function k(e, t) {
    let { forceBatchScan: n = !1, jitter: r = !1 } = t ?? {},
        i = t?.isMessageUpdate
            ? e.filter((e) => (0, C.s9)(e) && (0, C.mS)(e)).filter(x)
            : e.filter((e) => (0, C.s9)(e)).filter(x);
    i.forEach((e) => {
        let t = L(e);
        null == D[t] &&
        ...
        e.forEach((e) => {
            ...
            (l.numOfAttachments += r),
                ...
                (l.numOfExplicitAttachments =
                    e.attachments?.filter((e) => (0, C.gh)(v.kn.EXPLICIT, { type: S.D.Attachment, media: e })).length ??
                    0),
                (l.numOfExplicitEmbeds =
                    e.embeds?.filter((e) => (0, C.gh)(v.kn.EXPLICIT, { type: S.D.Embed, media: e })).length ?? 0),
                (l.numOfGoreAttachments =
                    e.attachments?.filter((e) => (0, C.gh)(v.kn.GORE, { type: S.D.Attachment, media: e })).length ?? 0),
                (l.numOfGoreEmbeds =
                    e.embeds?.filter((e) => (0, C.gh)(v.kn.GORE, { type: S.D.Embed, media: e })).length ?? 0),
                (l.numOfSelfHarmAttachments =
                    e.attachments?.filter((e) => (0, C.gh)(v.kn.SELF_HARM, { type: S.D.Attachment, media: e }))
                        .length ?? 0),
                (l.numOfSelfHarmEmbeds =
                    e.embeds?.filter((e) => (0, C.gh)(v.kn.SELF_HARM, { type: S.D.Embed, media: e })).length ?? 0);
        }),
...
function G(e, t) {
    let n,
        ...
        (s = (i = a()(n, (e, t) => e.id === t.id && e.channel_id === t.channel_id)).filter((e) => (0, C.mS)(e))),
        {
            messagesPendingScan: s,
            attributesByMessageId: (o = U(i)).messageLookup,
    ...
    return (
        ...
        (function (e) {
            let t,
                ...
                } = ((t = e.filter((e) => (0, I.b)(e) && 0 !== (0, C.Fg)(e))),
                (n = e
                    .map((e) => {
                ...
                )),
                {
                    ...
                    attributesByChannelId: (s = U(r)).channelLookup,
