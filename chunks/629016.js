...
function f(e, t) {
    ...
    if (null == n) return;
    let r = c[e];
    delete r[t], i().isEmpty(r) && delete c[e];
    let s = _.get(n);
...
function E(e, t, n, r) {
    let i = n.find((e) => null != e.party && e.party.id),
        ...
        a = (c[t] ?? {})[e];
    if (null == s || r === d.clD.OFFLINE) return null != a && (f(t, e), !0);
    if (null != a) {
        if (a === s) return !1;
        f(t, e);
    }
    return (
        !(function (e, t, n) {
            let r = c[e];
            if ((null == r && (r = c[e] = {}), (r[t] = n), l.A.isBlocked(e) || l.A.isIgnored(e))) return;
...
function h(e) {
    let { guild: t } = e,
        n = !1;
    for (let { user: e, status: r, activities: i } of t.presences) !1 !== E(t.id, e.id, i, r) && (n = !0);
    return n;
}
function p(e, t) {
    let n = !1;
...
let I = new A(a.h, {
    CONNECTION_OPEN_SUPPLEMENTAL: function (e) {
        let { guilds: t, presences: n } = e,
            r = !1;
        for (let { user: e, status: t, activities: i } of n) null != e && !1 !== E(d.ME, e.id, i, t) && (r = !0);
        for (let e of t) !1 !== h({ guild: e }) && (r = !0);
        return r;
    },
    OVERLAY_INITIALIZE: function (e) {
        let { parties: t, userParties: n } = e;
        (_ = new Map()), (c = { ...n }), Object.keys(t).forEach((e) => _.set(e, new Set(t[e])));
    },
    GUILD_CREATE: h,
    PRESENCES_REPLACE: function (e) {
        let { presences: t } = e,
            n = !1;
        for (let { user: e, activities: r } of t) null != e && !1 !== E(d.ME, e.id, r) && (n = !0);
        return n;
    },
