...
class f {
    ...
    constructor({ id: e, windowId: t, isPaused: n }) {
        o(this, "trackedFeedItems", void 0),
            o(this, "_lastFlushTimeMillis", void 0),
            o(this, "_pausedFeedItemIds", void 0),
            o(this, "_paused", void 0),
            o(this, "_windowId", void 0),
            o(this, "_isReactNavigationFocused", void 0),
            o(this, "_id", void 0),
            o(this, "onInitialize", void 0),
            o(this, "onTerminate", void 0),
            o(this, "onFeedItemSeen", void 0),
            o(this, "onFeedItemUnseen", void 0),
            o(this, "initialize", () => {
                var e, t;
                a.Z.subscribe("ANALYTICS_FEED_ITEM_SEEN", this.handleFeedItemSeen),
                    a.Z.subscribe("ANALYTICS_FEED_ITEM_UNSEEN", this.handleFeedItemUnseen),
                    a.Z.subscribe("ANALYTICS_FEED_FLUSH", this.handleFeedItemFlush),
                    a.Z.subscribe("APP_STATE_UPDATE", this.handleAppStateUpdate),
                    a.Z.subscribe("WINDOW_FOCUS", this.handleWindowFocus),
                    null == (e = (t = this).onInitialize) || e.call(t);
            }),
            o(this, "terminate", () => {
                var e, t;
                a.Z.unsubscribe("ANALYTICS_FEED_ITEM_SEEN", this.handleFeedItemSeen),
                    a.Z.unsubscribe("ANALYTICS_FEED_ITEM_UNSEEN", this.handleFeedItemUnseen),
                    a.Z.unsubscribe("ANALYTICS_FEED_FLUSH", this.handleFeedItemFlush),
                    a.Z.unsubscribe("APP_STATE_UPDATE", this.handleAppStateUpdate),
                    a.Z.unsubscribe("WINDOW_FOCUS", this.handleWindowFocus),
