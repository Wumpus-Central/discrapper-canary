...
function E(e, t) {
    let { id: n, features: m } = e,
        ...
        T = r.useMemo(() => {
            ...
            return I.includes(n)
                ? 2
                : (null == m ? void 0 : m.includes(h.oNc.MEMBER_VERIFICATION_GATE_ENABLED)) &&
                    (null == m ? void 0 : m.includes(h.oNc.MEMBER_VERIFICATION_MANUAL_APPROVAL)) &&
                    (null != O || e.visibility === p.k.PUBLIC_WITH_RECRUITMENT) &&
                    !v
                  ? 3
                  : null != O
                    ? 5
                    : (null == m ? void 0 : m.includes(h.oNc.DISCOVERABLE))
                      ? 4
                      : null;
