...
function I(e) {
    let { id: t, features: n } = e,
        ...
        { validInviteKey: I, isBypassInvite: j } = (0, a.cj)([u.Z], () => {
            var e;
        ...
        h = (0, o.Z)(),
        b = l.useMemo(() => (f ? 0 : h.includes(t) ? 1 : (null == n ? void 0 : n.includes(v.oNc.MEMBER_VERIFICATION_GATE_ENABLED)) && (null == n ? void 0 : n.includes(v.oNc.MEMBER_VERIFICATION_MANUAL_APPROVAL)) && (null != I || e.visibility === m.k.PUBLIC_WITH_RECRUITMENT) && !j ? 2 : null != I ? 4 : (null == n ? void 0 : n.includes(v.oNc.DISCOVERABLE)) ? 3 : null), [n, t, j, f, h, e.visibility, I]);
    return {
        guildId: t,
        ctaType: b,
        validInviteKey: I
