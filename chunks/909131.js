...
class m extends l.A {
    ...
    constructor(e) {
        super(e.context, e.userId),
            ...
            this.input.on(c.T.Mute, (e) => this.emit(u.yq.Mute, e)),
    ...
    handleInputSpeaking = (e) => {
        this.emit(u.yq.Speaking, this.userId, e ? p.ME.VOICE : p.ME.NONE, this.audioSSRC);
    };
    ...
    createOutput(e, t) {
        ...
        let n = this.outputs[e];
        null == n &&
            (((n = new d.A(e, this.audioContext)).mute = this.selfDeaf || this.localMutes[e]),
            (n.volume = this.computeLocalVolume(e)),
            n.on(d.i.Speaking, (t) => this.emit(u.yq.Speaking, e, t, this.audioSSRC)),
            n.on(d.i.Video, (t) =>
                this.emitUnsafe(
                    u.yq.Video,
                    e,
            ...
            n.on(d.i.InteractionRequired, (e) => this.emit(u.yq.InteractionRequired, e)),
            n.setSpeakingFlags(this.localSpeakingFlags[e] ?? p.ME.NONE),
