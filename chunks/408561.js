...
function x(e) {
    let { transitionState: t, onClose: x, channel: N } = e,
        k = (0, i.Z)(m.TL),
        g = (0, o.e7)([d.default], () => d.default.getUser(N.getRecipientId()));
    return (
        r.useEffect(() => {
            h.default.track(f.rMx.OPEN_MODAL, { type: 'DM Mute Feedback Modal' });
        }, []),
        (0, a.jsx)(u.Z, {
            hasCloseButton: !0,
            header: b.NW.string(b.t.SxsBFB),
            body: b.NW.formatToPlainString(b.t['7kb7z8'], { username: null == g ? void 0 : g.username }),
            problems: k,
            feedbackProblems: {
                [m.YA.OTHER]: {
