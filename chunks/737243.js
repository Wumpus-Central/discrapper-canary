...
let h = i.memo(function (e) {
    ...
    let { message: _, channel: p, compact: h = !1, interactionUsernameProfile: m, interactionAvatarProfile: g, interactionData: E, referencedUsernameProfile: b, referencedAvatarProfile: y, setPopout: O } = e,
        { isInteractionUserBlocked: v, isInteractionUserIgnored: I } = (0, a.cj)(
            [c.Z],
            () => ({
        ...
        T = (0, a.e7)([l.Z], () => l.Z.getMessageByReference(null == _ ? void 0 : _.messageReference)),
        S = (0, d.wq)(null == (t = _.interaction) ? void 0 : t.user.id, p.id),
        A = (0, d.Nk)(_.interaction, p, m, O),
        N = (0, d.NU)(g, O),
        C = (0, s.t0)(_),
        w = (null == C ? void 0 : C.type) === o.B8.APPLICATION_COMMAND ? (null == (n = C.target_user) ? void 0 : n.id) : void 0,
        R = (0, d.wq)(w, p.id),
        P = (0, d.JC)(w, p, b, O),
        D = (0, d.rY)(y, O),
        L = (0, d.Xn)(E, O),
