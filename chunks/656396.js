...
function E(e) {
    let {
        ...
        G = i.useCallback(() => {
            k(null), b.Z.openSearchFiltersModal(t);
        }, [t, k]),
            ...
            (e) => {
                if (h !== e) {
                    if (
                        ...
                        b.Z.transitionStateToSearchContext(t, e, b.Z.cleanUpPrivateChannelSearchState);
                    } else {
                        let e = {
                            type: j.aib.CHANNEL,
                            channelId: n,
                        };
                        b.Z.transitionStateToSearchContext(t, e);
                    }
