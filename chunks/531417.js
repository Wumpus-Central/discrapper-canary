...
class g extends s.A {
    ...
    setInputVolume(e) {
        (0, d.lE)().setInputVolume(m(e));
    }
    setOutputVolume(e) {
        (0, d.lE)().setOutputVolume(m(e));
    }
    ...
    processBatchAudioFiles(e, t, n, r) {
        (0, d.lE)().processBatchAudioFiles?.(e, t, n, r);
    }
    ...
    setSidechainCompressionStrength(e) {
        var t, n;
        let r = 100 - e,
            i = (t = p.Zi) + ((p.Xg - t) * r) / 100,
            s = (n = p.d_) + ((p.nO - n) * r) / 100;
        (0, d.lE)().applySidechainCompressionSettings?.({ threshold: i, ratio: s });
    }
