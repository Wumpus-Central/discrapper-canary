...
async function N(e, t, n) {
    let r,
        ...
        s,
        c,
        { client_id: u, response_type: I = 'code', redirect_uri: v, code_challenge: C, code_challenge_method: S, state: N, nonce: T, scope: P, permissions: j, guild_id: A, channel_id: Z, prompt: x, disable_guild_select: L, integration_type: w, pid: R, signal: D } = e;
    ...
    if (null != v) throw new O.Z({ errorCode: y.lTL.OAUTH2_ERROR }, 'Redirect URI cannot be used in the RPC OAuth2 Authorization flow');
    let k = [];
