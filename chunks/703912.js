...
async function Z(e, t, n) {
    let i,
        ...
        o,
        c,
        { client_id: d, response_type: u = 'code', redirect_uri: g, code_challenge: _, code_challenge_method: v, state: N, nonce: S, scope: A, permissions: Z, guild_id: x, channel_id: b, prompt: L, disable_guild_select: y, integration_type: P, pid: O, signal: R } = e;
...
async function x(e, t, n) {
    ...
    let d,
        ...
        N,
        S,
        { client_id: A, response_type: Z = 'code', redirect_uri: x, code_challenge: b, code_challenge_method: L, state: y, nonce: P, scope: O, permissions: R, guild_id: j, channel_id: D, prompt: w, disable_guild_select: M, integration_type: k, pid: U, signal: G } = e;
