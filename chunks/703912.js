...
async function N(e, t, n) {
    let r,
        ...
        s,
        c,
        { client_id: u, response_type: y = 'code', redirect_uri: v, code_challenge: C, code_challenge_method: S, state: N, nonce: T, scope: P, permissions: j, guild_id: A, channel_id: x, prompt: Z, disable_guild_select: w, integration_type: L, pid: R, signal: D } = e;
    ...
    return {
        ...
        [I.Etm.AUTHORIZE]: {
            handler(n) {
                ...
                if (r.application.id !== a) throw ((r.authorization.authing = !1), new O.Z({ errorCode: I.lTL.INVALID_CLIENTID }, "Application does not match the connection's"));
