...
function T(e) {
    ...
    return (
        n !== f &&
            ...
            null != n &&
                E.Ut1.test(n) &&
                ((i = !0), I.track(n), m.pendingUsages.push({ key: n, timestamp: Date.now() }))),
        t !== p &&
            ((p = t ?? null),
            null != t &&
                E.Ut1.test(t) &&
                ((i = !0), I.track(t), m.pendingUsages.push({ key: t, timestamp: Date.now() }))),
        i
    );
}
function g() {
...
class S extends a.Ay.PersistedStore {
    ...
    initialize(e) {
        (this.waitFor(d.A, c.A, u.Ay, _.A, o.A),
            null != e && ((e.pendingUsages = e.pendingUsages.filter((e) => null != e && E.Ut1.test(e.key))), (m = e)),
            this.syncWith([o.A], g));
    }
    getState() {
        return m;
...
let N = new S(s.h, {
    ...
    USER_SETTINGS_PROTO_UPDATE: function (e) {
        ...
        return t === A.oD.FRECENCY_AND_FAVORITES_SETTINGS && !!n && ((m.pendingUsages = []), !0);
    },
});
