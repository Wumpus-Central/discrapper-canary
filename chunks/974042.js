...
class P extends c.Z {
    get comparator() {
        ...
        return [
            this.type,
            +(this.giftIntentType !== y.hX.FRIEND_ANNIVERSARY),
            null !=
            (i =
                    ...
                    new P(
                        S(
                            ...
                            ),
                            {
                                ...
                                giftIntentType:
                                    r === v.OGo.FRIEND && h.ZP.getFriendAnniversaries().includes(n)
...
function M() {
    ...
    A && (e || (w !== v.pJs.ONLINE && w !== v.pJs.ADD_FRIEND)) && !Z && ((A = !1), (Z = !0), o.Z.fetchRelationships());
}
function k() {
