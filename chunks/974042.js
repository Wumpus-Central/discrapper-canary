    ...
    reset() {
                    ...
                    new j(
                        C(
                            ...
                            ),
                            {
                                ...
                                giftIntentType: n === N.OGo.FRIEND && f.Z.isTopAffinityFriendAnniversary({ userId: r }) ? v.hX.FRIEND_ANNIVERSARY : void 0,
        ...
        if (t) {
            let t = h.Z.getGameRelationships().values(),
                n = new Set();
            t.forEach((t) => {
                let { id: i, applicationId: l, type: o } = t;
                !e.has(i) &&
                    ((o === N.OGo.FRIEND && n.has(i)) ||
                        (o === N.OGo.FRIEND && n.add(i),
                        r.push(
                            new j(
                                C(
                                    I(
