...
function W(e) {
    ...
    if ((0, m.HJ)(n)) {
        let e = n.config.features.includes(C.S7.MOBILE_ONLY_QUEST_PUSH_TO_MOBILE),
            { enabled: t } = O.S.getCurrentConfig({ location: C.dr.VIDEO_MODAL }, { autoTrackExposure: e });
        if (t && e) return void q(n);
    }
    let d = (0, i.Z)();
    if (
        (0, v.D)(C.dr.VIDEO_MODAL) &&
        !u &&
