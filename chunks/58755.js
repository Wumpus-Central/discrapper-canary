        ...
        o = (0, n.jsxs)('div', {
            ...
            children: [
                (0, n.jsx)(d.VcW, {
                    ...
                    value: void 0,
                    onChange: (e) => {
                        let n = t.scales.find((t) => t.name === e);
                        null == n &&
                            ((n = {
                                name: e,
            ...
            (0, n.jsxs)('div', {
                ...
                children: [
                    (0, n.jsx)(d.P3F, {
                        onClick: r,
                        style: { maxWidth: 80 },
                        children: (0, n.jsx)(d.whL, { size: 'sm' })
                    }),
                    (0, n.jsx)(d.Text, {
                    ...
                    (0, n.jsx)(d.P3F, {
                        onClick: function () {
                            let e = Object.entries(T).reduce((e, t) => {
                                ...
                                return (
                                    (e[a] = {
                                        value: (0, l.Z)((0, i.Z)(n, p.HW.sRGB), { format: 'hex' }),
                                        type: 'color'
                                    }),
                                    e
                                );
            ...
            (0, n.jsxs)(d.xJW, {
                ...
                children: [
                    (0, n.jsxs)(d.Text, {
                        ...
                        children: ['The base color the ', (0, n.jsx)('code', { children: c }), ' palette is generated from.']
                    }),
                    (0, n.jsx)('input', {
                        type: 'color',
                        value: h,
                        onChange: (e) => (0, p.Ib)(c, e.target.value, a)
                    })
                ]
            }),
            (0, n.jsxs)(d.xJW, {
                ...
                children: [
                    ...
                    (0, n.jsx)(d.xJW, {
                        ...
                        children: (0, n.jsx)(d.iRW, {
                            ...
                            maxValue: 100,
                            onValueChange: (e) => (0, p.YC)(c, Math.round(e), a),
                            onMarkerRender: () => null
                        })
                    }),
                    (0, n.jsx)(d.xJW, {
                                    ...
                                    'div',
                                    {
                                        ...
                                        children: [
                                            (0, n.jsxs)(d.Text, {
                                                ...
                                                style: { color: m },
                                                children: [t.name, '.', a + 1, g && null != x ? (0, n.jsx)('strong', { children: ' - '.concat(x) }) : '']
                                            }),
                                            g &&
                                                (0, n.jsxs)(d.Text, {
                                                    ...
                                                    children: [(0, l.Z)((0, i.Z)(c, p.HW.sRGB), { format: 'hex' }).toUpperCase(), ' - ', u]
                                                })
                                        ]
                                    },
                                    r
...
function _(e) {
    let { scale: t, onRemove: a } = e,
        s = r.useMemo(() => Object.values((0, p.XM)(t)).map((e) => (0, l.Z)((0, i.Z)(e, p.HW.sRGB), { format: 'hex' })), [t]);
    return (0, n.jsxs)('li', {
