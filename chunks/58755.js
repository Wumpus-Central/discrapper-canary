                            ...
                            "li",
                            {
                                children: (0, n.jsx)(d.P3F, {
                                    ...
                                    children: (0, n.jsx)(_, {
                                        scale: e,
                                        onRemove: () =>
                                            a(f(p({}, t), { scales: t.scales.filter((t) => t.name !== e.name) })),
                                    }),
                                }),
                            },
                            e.name,
                    ...
                    (0, n.jsx)(d.P3F, {
                        onClick: function () {
                            let e = Object.entries(O).reduce((e, t) => {
                                ...
                                return (
                                    (e[a] = {
                                        value: (0, l.Z)((0, i.Z)(n, x.HW.sRGB), { format: "hex" }),
                                        type: "color",
                                    }),
                                    e
                                );
                                        ...
                                        children: [
                                            (0, n.jsxs)(d.Text, {
                                                ...
                                                children: [
                                                    ...
                                                    a + 1,
                                                    j && null != h
                                                        ? (0, n.jsx)("strong", { children: " - ".concat(h) })
                                                        : "",
                                                ],
                                            }),
                                            j &&
...
function _(e) {
    let { scale: t, onRemove: a } = e,
        s = r.useMemo(
            () => Object.values((0, x.XM)(t)).map((e) => (0, l.Z)((0, i.Z)(e, x.HW.sRGB), { format: "hex" })),
            [t],
        );
    return (0, n.jsxs)("li", {
