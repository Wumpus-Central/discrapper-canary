...
function I(e) {
    ...
    let { width: o, height: d } = s,
        ...
        h = d;
    return (
        (o > 500 || d > 400) && (o > d ? ((u = 500), (h = (500 * d) / o)) : ((u = (400 * o) / d), (h = 400))),
        (0, r.jsx)("iframe", {
            className: n()(y.FS, l),
            src: a,
    ...
    return (0, r.jsx)(b.G.Consumer, {
        children: (e) =>
            u({
                ...
                dataSafeSrc: l,
                children(e) {
                    let { src: t, size: a, animating: u, alt: h } = e;
                    return (0, r.jsx)(P, {
                        alt: h,
                        className: o,
                        poster: t,
...
class en extends s.PureComponent {
    ...
    renderVideo() {
        let {
            ...
            { maxMediaWidth: p, maxMediaHeight: g, sourceMetadata: f } = this.state;
    ...
    renderAll() {
        let e,
            { embed: l, hideMedia: t } = this.props,
        ...
        let d = this.renderFooter(),
            u = null == e;
        return (
            l.type === c.Auw.RICH && (u = null == l.video),
            {
                provider: s,
                author: i,
                title: n,
                description: a,
                thumbnail: !t && u ? this.renderThumbnail(r) : null,
                fields: o,
                media: e,
                footer: d,
            }
            ...
            return (0, r.jsx)("article", {
                ...
                children: (0, r.jsx)("div", {
                    ...
                    children: (0, r.jsxs)("div", {
                        ...
                        children: [null != s ? e.renderSuppressButton(s) : null, a, o, d, u, h, m, c, p],
                    }),
                }),
            });
        };
