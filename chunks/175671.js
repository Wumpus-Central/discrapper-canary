...
function y(e) {
    ...
    if (null == o || Array.isArray(o) || null == C(o)) return null;
...
function b(e) {
    let {
        ...
        alt: d = R.intl.string(R.t.I5gL2H),
        sourceMetadata: _,
        ...h
    } = e;
...
function ei(e) {
    ...
    let { width: V, height: B } = l;
    null != u && ((V = u.width), (B = u.height));
    let j = (0, Y.Uj)({ width: V, height: B, maxWidth: s, maxHeight: o });
    (V = Math.max(j.width, 150)), (B = Math.max(j.height, 144));
    let W = (0, F.E)(l);
    ...
    if (M && null != u) {
        ...
        if (h) {
            ...
            (l = { maxWidth: s, maxHeight: o, width: void 0, height: void 0 }),
                (_ = { paddingBottom: `${100 * t}%`, maxWidth: V }),
                (e = { position: "absolute", top: 0, left: 0, maxWidth: V, maxHeight: B });
        }
        return (0, i.jsx)("div", {
            className: t,
            style: l,
    ...
    return (0, i.jsxs)("div", {
        className: a()(g.pu, t),
        style: h ? { maxWidth: V } : { width: V, height: B },
        children: [
            f({
                src: W,
                width: V,
...
class es extends r.PureComponent {
    ...
    renderContentPlaceholder(e) {
        ...
        return (0, i.jsx)(P.FQ, { className: g.Jl, width: t, height: n, opacity: 0.3 });
    }
    renderTitle() {
        let e = !(arguments.length > 0) || void 0 === arguments[0] || arguments[0],
                  ...
                  children: [
                      (0, i.jsxs)("div", {
                          ...
                          children: [
                              (0, i.jsx)(
                                  T.G.Provider,
                                  { value: (0, M.b)(n.images[0].url, n.images[0]), children: s },
                                  0,
                              ),
                              null != l &&
                                  (0, i.jsx)(
                                      T.G.Provider,
                                      { value: (0, M.b)(n.images[2]?.url, n.images[2]), children: o },
                                      2,
                                  ),
                          ],
                      }),
                      (0, i.jsxs)("div", {
                          ...
                          children: [
                              (0, i.jsx)(
                                  T.G.Provider,
                                  { value: (0, M.b)(n.images[1]?.url, n.images[1]), children: a },
                                  1,
                              ),
                              null == l &&
                                  null != o &&
                              ...
                              null != l &&
                                  (0, i.jsx)(
                                      T.G.Provider,
                                      { value: (0, M.b)(n.images[3]?.url, n.images[3]), children: l },
                                      3,
                                  ),
                          ],
                      }),
    ...
    handleImageHover() {
        let e = V.A.getChannel(this.props.message?.channel_id);
    ...
    renderImage() {
        let {
                ...
                image: n,
                isGalleryImage: r = !1,
                alt: s = R.intl.string(R.t.X4IxWL),
                allImages: o = null,
            } = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
            { renderImageComponent: l, className: u, autoPlayGif: c } = this.props,
            { maxMediaWidth: d, maxMediaHeight: _, sourceMetadata: h } = this.state;
        if (null == n) return null;
        let f = (0, F.E)(n),
            { srcToOnClickOverride: E, srcToHandlePreloadImage: p } =
                null == o
            ...
            m = L.Ay.isAnimated({ src: (0, F.E)(n), original: n.url, animated: !1, srcIsAnimated: n.srcIsAnimated }),
            A = {
    ...
    renderVideo() {
        let {
            ...
            { maxMediaWidth: f, maxMediaHeight: E, sourceMetadata: p } = this.state;
    ...
    renderStaticPlaceholderMedia() {
        let { className: e, embed: t } = this.props,
            ...
            s = t.image ?? t.video;
        if (null == s) return null;
        let { width: a, height: l } = (0, Y.Uj)({ width: s.width, height: s.height, maxWidth: n, maxHeight: r });
        return (0, i.jsx)(o._, {
            className: e,
    ...
    getMaxWidth(e) {
        let {
            ...
            l = t ?? i;
        if (null == l) return;
        let { width: u } = (0, Y.Uj)({ width: l.width, height: l.height, maxWidth: a, maxHeight: o });
            ...
            return (0, i.jsx)("article", {
                ...
                children: (0, i.jsx)("div", {
                    ...
                    children: (0, i.jsxs)("div", {
                        ...
                        children: [null != r ? e.renderSuppressButton(r) : null, o, l, u, c, d, h, _, f],
                    }),
                }),
            });
        };
