...
var I = n(338717),
    T = n(643612),
    S = n(731068);
let y = RegExp("^music\\.amazon\\.(?:com|co\\.uk|de|co\\.jp|es|fr|it|com\\.au|in|ca|com\\.mx|com\\.br)");
function C(e) {
    let t = null,
        n = null,
        i = null;
    ...
    return null != i && y.test(t ?? "") && null != n ? i : null;
}
function N(e) {
    let {
        className: t,
...
function ei(e) {
    ...
    let H = (0, W.Uj)({ width: F, height: B, maxWidth: s, maxHeight: o });
    (F = Math.max(H.width, 150)), (B = Math.max(H.height, 144));
    let Y = (0, V.E)(l);
    ...
    return (0, i.jsxs)("div", {
        className: a()(g.pu, t),
        style: h ? { maxWidth: F } : { width: F, height: B },
        children: [
            f({
                src: Y,
                width: F,
...
class es extends r.PureComponent {
    ...
    renderVideo() {
        let {
            ...
            { maxMediaWidth: f, maxMediaHeight: p, sourceMetadata: E } = this.state;
    ...
    renderFooter() {
        ...
        return null != t
            ...
            : null != n
              ? (0, i.jsx)("div", {
                    className: a()(g.te, g.aK),
                    children: (0, i.jsx)("span", { className: g.oy, children: (0, H.mk)(n) }),
                })
              : void 0;
    }
