...
function nd(e) {
    let t = no(e.context),
        n = t.mode;
    e.context === e2.x.DEFAULT && (0, eE.N)(!1, !1);
...
function nu(e) {
    ...
    e.setSelfMute(n), e.setSelfDeaf(t.deaf), e.context === e2.x.DEFAULT && U.A.updateNativeMute();
}
function n_() {
...
function nS() {
    let e = no(),
        ...
        { maxSampleRateHz: a, maxChannelCount: s } = (function (e, t) {
            let { location: n } = e;
            if (!X("any", t)) return { maxSampleRateHz: 0, maxChannelCount: 0 };
            let i = (function (e) {
                let { location: t } = e;
                return Z.getConfig({ location: t });
            })({ location: n });
            return X(i.condition, t)
...
function nO() {
    return (0, f.isMac)() && to.supports(e2.O5.SCREEN_CAPTURE_KIT) && R().satisfies(M.A?.os.release, el.e);
}
function nR() {
    return (
        (0, f.isWindows)() &&
...
function nx(e) {
    if (!(0, f.isWindows)() || !z.getConfig({ location: "MediaEngineStore.setInputDevice" }).probeAudioEffects) return;
    let t = tT[e];
...
class n0 extends L.Ay.Store {
    ...
    initialize() {
        ...
        if (
            ...
            to.on(y.bg.Connection, (e) => {
                ...
                (0, x.A)(i) && e.setClipsKeyFrameInterval(e2.X1),
                (n = no(e.context)),
                e.setPostponeDecodeLevel(100),
                Object.keys(n.localMutes)))
                    r !== eY.default.getId() && e.setLocalMute(r, n.localMutes[r]);
        ...
        (0, f.isWindows)() &&
            ...
            this.waitFor(eY.default, eK.A, e$.A, ez.A, G.Ay, B.A, eq.A, j.Ay, ex.A, eZ.default, eX.A);
    }
    supports(e) {
    ...
    supportsExperimentalSoundshare() {
        return to.supports(e2.O5.EXPERIMENTAL_SOUNDSHARE) && R().satisfies(M.A?.os.release, el.$x);
    }
    supportsHookSoundshare() {
        return (0, f.isWindows)() && to.supports(e2.O5.SOUNDSHARE) && R().satisfies(M.A?.os.release, el.ws);
    }
    ...
    supportsScreenSoundshare() {
        return (0, f.isMac)()
            ? to.supports(e2.O5.SOUNDSHARE) && R().satisfies(M.A?.os.release, el.P$) && nO()
            : (0, f.isWindows)()
...
let n2 = (i = new n0(b.h, {
    ...
    CONNECTION_OPEN: function (e) {
        ...
        nR() && (nL() ? nX(e2.rB.AUTOMATIC) : t.automaticAudioSubsystem && nQ()),
            ...
            (0, f.isIOS)() && (to.setNcModels?.(eu.getConfig({ location: "setupKrisp" }).models), i.emitChange()),
            nx(t.inputDeviceId),
            nV();
    },
