...
let E = a.createElement(function () {
    var e;
    let t,
        n,
        r,
        ...
        d =
            ((s = a.useContext(p)),
            (l = (A.UseRouteError, (t = a.useContext(c)) || (0, o.Oi)(!1), t)),
            (u =
                (A.UseRouteError,
        ...
        _ = (0, o.pX)(d) ? d.status + " " + d.statusText : d instanceof Error ? d.message : JSON.stringify(d),
        h = d instanceof Error ? d.stack : null;
    ...
    render() {
        return void 0 !== this.state.error
            ? a.createElement(
                  ...
                  a.createElement(p.Provider, { value: this.state.error, children: this.props.component }),
              )
            : this.props.children;
    }
}
...
function S(e) {
    ...
    let f = t.replace(/^\/*/, "/"),
        p = a.useMemo(
            () => ({ basename: f, navigator: s, static: u, future: l({ v7_relativeSplatPath: !1 }, c) }),
            [f, c, s, u],
        );
    "string" == typeof r && (r = (0, o.Rr)(r));
    let { pathname: E = "/", search: m = "", hash: g = "", state: A = null, key: I = "default" } = r,
        T = a.useMemo(() => {
            let e = (0, o.pb)(E, f);
            return null == e
                ? null
    ...
    return null == T
        ? null
        : a.createElement(d.Provider, { value: p }, a.createElement(_.Provider, { children: n, value: T }));
}
function y(e) {
    ...
    return (function (e, t) {
        let n;
        h() || (0, o.Oi)(!1);
        let { navigator: r } = a.useContext(d),
        ...
        s && s.route;
        let p = (h() || (0, o.Oi)(!1), a.useContext(_).location);
        if (t) {
            var A;
            let e = "string" == typeof t ? (0, o.Rr)(t) : t;
            "/" === c || (null == (A = e.pathname) ? void 0 : A.startsWith(c)) || (0, o.Oi)(!1), (n = e);
        } else n = p;
        let T = n.pathname || "/",
            S = T;
        if ("/" !== c) {
            ...
            N = (function (e, t, n, r) {
                ...
                return l.reduceRight((e, r, i) => {
                    ...
                    n &&
                        ...
                        (f = r.route.errorElement || E),
                        c &&
                            (d < 0 && 0 === i
                                ? ((s = "route-fallback"), I[s] || (I[s] = !0), (_ = !0), (p = null))
                                : d === i && ((_ = !0), (p = r.route.hydrateFallbackElement || null))));
