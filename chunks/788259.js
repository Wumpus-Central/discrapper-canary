...
function O(a) {
    let { applicationId: e, size: i = "default", userId: s } = a,
        t = (0, D.A)(s, e),
        n = t.surfaceConfigs[_.m.ADD_WIDGET_PREVIEW];
    return null == n
        ? null
        : (0, l.jsx)("div", {
              className: G.kL,
...
function k(a) {
    let { applicationId: e, size: i = "default" } = a,
        ...
        { analyticsLocations: m } = (0, p.Ay)(x.A.USER_PROFILE_APPLICATION_WIDGET),
        N = s.useCallback(() => {
            c &&
...
function U(a) {
    let { applicationId: e } = a,
        i = (0, v.h)(e),
        { hasAlreadyLinked: s, fetched: t } = (0, A.RD)(i);
    return null == i
        ? null
        : (0, l.jsx)(u.E, {
              variant: "text-sm/medium",
...
function $(a) {
    let {
        ...
        P = N.useConfig({ location: x.A.USER_PROFILE_APPLICATION_WIDGET }).enabled,
        ...
        V = C && !F && w,
        { analyticsLocations: K } = (0, p.Ay)(x.A.USER_PROFILE_APPLICATION_WIDGET),
        M = s.useCallback(() => {
            !j &&
                ((0, g.Y5)(e),
    ...
    return (0, l.jsxs)("div", {
        ...
        children: [
            (0, l.jsxs)(o.D, {
                className: n()(X.PH, "small" === t && X.PG, j && X.Lq),
                onClick: M,
                "aria-label":
                    ...
                    (function () {
                        ...
                        switch (a.variant) {
                            ...
                            case "application-widget":
                                return (0, l.jsx)(S, { applicationId: a.applicationId, size: t });
                            case "clips-gallery":
            ...
            !P &&
                (function () {
                    ...
                    switch (a.variant) {
                        case "application-widget":
                            return (0, l.jsx)(k, { applicationId: a.applicationId, size: t });
                        case "personal":
                            return (0, l.jsx)(Y, {});
                        default:
                            return null;
