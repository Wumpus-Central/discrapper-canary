...
class ts extends i.PureComponent {
    ...
    constructor(...e) {
        (super(...e),
            ...
            ti(this, 'renderHeaderBar', () => {
                let { channel: e, channelName: t, parentChannel: n, guild: i, guildId: l, showCall: o, showActivityPanel: c, showFramePanel: u, hasVideo: d, showHeaderGuildBreadcrumb: p, isFavorites: h } = this.props;
                ...
                let f = e.isDM() && !e.isSystemDM() ? this.openUserProfile : p ? () => (0, ey.Kh)(e.id) : void 0,
                    b = (null == n ? void 0 : n.guild_id) != null && (null == n ? void 0 : n.id) != null ? this.handleTitleParentClick : void 0;
                return (0, r.jsxs)('div', {
                                ...
                                (0, r.jsxs)(
                                    ea.Z,
                                    {
                                        ...
                                        children: [
                                            ...
                                            p
                                                ? (0, r.jsx)(m.zx, {
                                                      onClick: () => (0, e_.XU)(e.guild_id, e.id),
                                                      className: tr.followButton,
