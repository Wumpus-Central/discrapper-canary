        ...
        super(...e),
            ...
            tr(this, 'renderHeaderToolbar', () => {
                ...
                switch (e.type) {
                    ...
                    case e8.d4z.GUILD_ANNOUNCEMENT:
                    case e8.d4z.GUILD_TEXT:
                        a.push((0, r.jsx)(G.Z, { channel: e }, 'favorites')), a.push((0, r.jsx)(eS.Z, { channel: e }, 'browser')), n || a.push((0, r.jsx)(et.Z, { channel: e }, 'notifications')), a.push((0, r.jsx)(en.Z, { channel: e }, 'pins')), a.push((0, r.jsx)(ee.Z, { channelId: e.id }, 'members')), (0, E.Lp)(e) && a.push((0, r.jsx)(er.Z, { channel: e }, 'summaries'));
                        break;
                    case e8.d4z.GUILD_FORUM:
                    case e8.d4z.GUILD_MEDIA:
            ...
            tr(this, 'renderHeaderBar', () => {
                ...
                let h = e.isDM() && !e.isSystemDM() ? this.openUserProfile : d ? () => (0, ey.Kh)(e.id) : void 0,
...
let ts = (0, O.Z)(to),
    tc = i.memo(function (e) {
        ...
        let ed = (0, E.ts)(c),
            ...
            eb = (0, I.Z)(ep),
            ey = (0, I.Z)(null == c ? void 0 : c.id);
        i.useEffect(() => {
            let e = eb && !ep,
                t = eb && ep && (null == c ? void 0 : c.id) !== ey;
            (e || t) && (0, F.EW)(f.z.ACTIVITY_GDM_CALL_TOOLTIP, { dismissAction: e6.L.AUTO });
        }, [null == c ? void 0 : c.id, ey, ep, eb]);
        let ex = (0, m.f9)(),
            eC = (0, U.Q3)('Channel');
        return (0, r.jsx)(
            ts,
                ...
                ti(
                    {
                        ...
                        showFollowButton: ((null == c ? void 0 : c.type) === e8.d4z.GUILD_ANNOUNCEMENT && (null == y ? void 0 : y.hasFeature(e8.oNc.NEWS))) || !1
                    },
