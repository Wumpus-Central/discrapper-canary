...
var i = n(627968),
    ...
    j = n(666153);
let b = () => {
    x.Ay.getMediaEngine().once(I.bg.ConnectionStats, (e) => {
        ...
        (0, O.C)(t, () => (0, S.P0)((0, m.o)(G.intl.string(G.t.t5VZ88), p.Ck.SUCCESS)));
    });
};
function F(e) {
    (0, l.useEffect)(() => {
        R.default.track(w.HAw.OPEN_POPOUT, { type: "RTC Connection" });
    }, []);
    ...
    return (0, i.jsxs)(i.Fragment, {
        children: [
            "function" == typeof u ? u() : (0, i.jsx)("p", { className: r()(j.xB, j.xJ), children: u }),
            (0, i.jsx)("hr", { className: j.me }),
            (0, i.jsxs)("div", {
                className: j.Vf,
                children: [
                    (0, i.jsxs)("span", {
                        className: r()(j.uO, j.ro),
                        children: [
                            (0, i.jsx)(C.X, {
                                size: "xxs",
                    ...
                    o &&
                        x.Ay.supports(P.O5.DIAGNOSTICS) &&
                        !__OVERLAY__ &&
                        (0, i.jsxs)(i.Fragment, {
                            children: [
                                (0, i.jsxs)(N.Anchor, {
                                    className: r()(j.Ce, j.ro),
                                    onClick: t,
                                    children: [
    ...
    let s = (0, l.useCallback)(() => {
        ...
        r = (0, l.useCallback)(() => {
            ...
            (e = () => {
                ...
                x.Ay.getMediaEngine().once(I.bg.ConnectionStats, (t) => {
...
function er(e) {
    let { channelId: t } = e,
        ...
        h = l.useCallback(() => {
            null != d &&
                (0, O.C)(d, () => {
                    o(!0), (0, A.k0)({ channelId: t }), setTimeout(() => o(!1), 2e3);
                });
        }, [t, d]);
    return (0, i.jsxs)("div", {
        className: es.kL,
...
function eA(e) {
    let { lobbyId: t, connectionTypeText: n, closePopout: l } = e,
        s = eh(t);
    return (0, i.jsx)(F, { ...s, closePopout: l, connectionTypeText: n });
}
function ef(e) {
...
function eE(e) {
    let { closePopout: t, connectionTypeText: n } = e,
        l = ec();
    return (0, i.jsx)(F, { ...l, closePopout: t, connectionTypeText: n });
}
function eI(e) {
    ...
    return n
        ...
        : (0, i.jsx)(ef, { closePopout: s, connectionTypeText: r });
}
function eS(e) {
    let { channelId: t, isOverlay: n, lobbyId: l, closePopout: s } = e,
        r = (0, E.k)({ channelId: t }) ? G.intl.string(G.t["3BogKe"]) : G.intl.string(G.t.ETIVvg);
    return n
        ? (0, i.jsx)(eA, { lobbyId: l, closePopout: s, connectionTypeText: r })
...
function eC(e) {
    return (0, E.k)({ channelId: e.channelId })
        ...
        : (0, i.jsx)("div", {
              className: eo.L3,
              children: (0, i.jsx)("section", { className: eo.J8, children: (0, i.jsx)(eS, { ...e }) }),
          });
}
function e_(e) {
    return (0, E.k)({ channelId: e.channelId })
