    ...
    return (
        ...
        (0, i.jsx)(d.vN, {
            ...
            children: (0, i.jsxs)(l.sx, {
                className: o()([h.radioGroupOption, "string" == typeof I && h[I]]),
                value: u,
                isDisabled: n,
                inputRef: A,
                ref: g,
...
function p(e) {
    ...
    if (t?.experiments?.enabledExperiments?.includes("mana-toggle-inputs")) return (0, i.jsx)(A, { ...e });
    let { ...n } = e,
...
function T(e) {
    ...
    return o?.experiments?.enabledExperiments?.includes("mana-toggle-inputs")
        ...
        : (0, i.jsx)(I.nG, { checked: n, disabled: t, radioItemIconClassName: a });
}
