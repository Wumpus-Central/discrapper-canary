    ...
    render() {
        let e = this.props,
            ...
            u = (0, i.jsx)(d.yRy, {
                ...
                onRequestClose: () => {
                    var e;
                    null == a || null == (e = a.onCancel) || e.call(a), this.setState({ contentWarningProps: null });
                },
                shouldShow: null != a,
                renderPopout: (e) => {
                    let { closePopout: t } = e;
            ...
            et(this, 'handleSendMessage', (e) => {
                ...
                return 0 === t.length
                    ...
                    : (0, F.v)({
                          ...
                          return (p.Z.sendMessage(n.id, P.ZP.parse(n, t), !0, a), this.setState((0, C.H2)()), (0, T.A6)(n.id), r)
...
class ea extends r.PureComponent {
    ...
    renderContent() {
        let e,
            { channel: t, placeholder: n, nsfwAgree: s, guild: a, locked: l, activated: c, chatKeybind: d, pinned: u, isPreviewingInGame: h, dragging: p, pendingReply: f } = this.props;
