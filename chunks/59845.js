...
function _(e) {
    ...
    return c.createElement(
        c.Fragment,
        null,
        c.createElement(s.jZ, null, c.createElement(p.Provider, { value: n }, e.content)),
        c.createElement(h, {
            render: e.children,
            collection: t,
        }),
...
function O(e, t, n, r, i, a) {
    ...
    if (o) {
        ...
        return (
            ...
            i ? c.createElement(b.Provider, { value: s }, i) : null
        );
    }
    return c.createElement(e.type, { ref: s }, i);
}
function A(e, t) {
    let n = ({ node: e }) => t(e.props, e.props.ref, e),
        r = (0, c.forwardRef)((r, i) => {
            ...
            return O(e, r, i, "children" in r ? r.children : null, null, (e) =>
                c.createElement(l.gY.Provider, { value: a }, c.createElement(n, { node: e })),
            );
        });
...
function v(e, t, n = S) {
    let r = ({ node: e }) => t(e.props, e.props.ref, e),
        i = (0, c.forwardRef)((t, i) => {
            var a;
            let s = n(t);
            return null != (a = O(e, t, i, null, s, (e) => c.createElement(r, { node: e })))
                ? a
...
function T(e) {
    ...
    return (
        ...
        c.createElement(I.Provider, { value: t }, i)
    );
}
function C({ children: e }) {
    ...
    return (0, u.wR)() ? c.createElement(b.Provider, { value: t }, n) : (0, o.createPortal)(n, t);
}
