...
let E =
        "function" == typeof u.useSyncExternalStore
            ...
            : function (e, t, n) {
                  ...
                  return (0, d.useSyncExternalStore)(e, s);
              },
...
function g(e, t, n, i, s, a) {
    ...
    let c = (0, u.useCallback)(
        ...
        d = (0, u.useContext)(m);
    if (d) {
        let r = d.ownerDocument.nodesByProps.get(t);
        return (
            r ||
                ((r = d.ownerDocument.createElement(e.type)).setProps(t, n, e, i, a),
                d.appendChild(r),
                d.ownerDocument.updateCollection(),
                d.ownerDocument.nodesByProps.set(t, r)),
            s ? u.createElement(m.Provider, { value: r }, s) : null
        );
    }
    return u.createElement(e.type, { ref: c }, s);
}
function A(e, t) {
...
function N({ children: e }) {
    ...
    return (0, c.wR)() ? u.createElement(m.Provider, { value: t }, n) : (0, o.createPortal)(n, t);
}
