...
function u(e, t) {
    var n, a, l, u, d, f, _, p, h, m, g, E, b, y, O, v, I, S;
    let T = null == (n = t.powerup_metadata) ? void 0 : n.category_type;
    if (null == T) return;
    let A = null == (a = t.sku) ? void 0 : a.powerup_metadata;
    if (null == A) return;
    let N = {
        title: t.summary,
        skuId: t.sku.id,
    ...
    switch (T) {
        case i.Us.LEVEL: {
            ...
            for (; null != S; ) {
                ...
                (a += null != (O = null == t || null == (p = t.sku) || null == (_ = p.powerup_metadata) || null == (f = _.guild_features) ? void 0 : f.additional_emoji_slots) ? O : 0), (l += null != (v = null == t || null == (g = t.sku) || null == (m = g.powerup_metadata) || null == (h = m.guild_features) ? void 0 : h.additional_sound_slots) ? v : 0), (u += null != (I = null == t || null == (y = t.sku) || null == (b = y.powerup_metadata) || null == (E = b.guild_features) ? void 0 : E.additional_sticker_slots) ? I : 0), (S = null == t ? void 0 : t.sku.dependent_sku_id);
            }
            return s(
                {
                    type: i.Us.LEVEL,
