                    ...
                    let r = (() => {
                        ...
                        return function (t = {}) {
                                ...
                                (a.ptrToAsset = (e) => {
                                    ...
                                    (a.CustomFileAssetLoader = n.extend('CustomFileAssetLoader', {
                                        ...
                                        loadContents: function (e, t) {
                                            return (e = a.ptrToAsset(e)), this.Gb(e, t);
                                        }
                                    })),
                                    ...
                                    (this.Qb = function (n, r, s, c, p) {
                                        if (e()) {
                                            var h = u.push(n),
                                                m = d.push(r);
                                            if (t.canvas) {
                                                for (var g of ((t.canvas.width != h || t.canvas.height != m) && ((t.canvas.width = h), (t.canvas.height = m)), t.viewport(0, m - r, n, r), t.disable(t.SCISSOR_TEST), t.clearColor(0, 0, 0, 0), t.clear(t.COLOR_BUFFER_BIT), t.enable(t.SCISSOR_TEST), s.sort((e, t) => t.wb - e.wb), (h = _.push(c)), o != h && (t.bufferData(t.ARRAY_BUFFER, 8 * h, t.DYNAMIC_DRAW), (o = h)), (h = 0), s)) t.bufferSubData(t.ARRAY_BUFFER, h, g.Ta), (h += 4 * g.Ta.length);
                                                for (var E of (console.assert(h == 4 * c), s)) t.bufferSubData(t.ARRAY_BUFFER, h, E.Db), (h += 4 * E.Db.length);
                                                for (var b of (console.assert(h == 8 * c), (h = f.push(p)), l != h && (t.bufferData(t.ELEMENT_ARRAY_BUFFER, 2 * h, t.DYNAMIC_DRAW), (l = h)), (g = 0), s)) t.bufferSubData(t.ELEMENT_ARRAY_BUFFER, g, b.indices), (g += 2 * b.indices.length);
                                                for (let e of (console.assert(g == 2 * p), (b = 0), (E = !0), (h = g = 0), s)) {
                                                    ...
                                                    let o = -2 / r;
                                                    t.uniform4f(i, e.ha[0] * s * e.Ba, e.ha[1] * o * e.Ca, e.ha[2] * s * e.Ba, e.ha[3] * o * e.Ca), t.uniform2f(a, e.ha[4] * s * e.Ba + s * (e.Ya - e.ic * e.Ba) - 1, e.ha[5] * o * e.Ca + o * (e.Za - e.jc * e.Ca) + 1), t.vertexAttribPointer(0, 2, t.FLOAT, !1, 0, h), t.vertexAttribPointer(1, 2, t.FLOAT, !1, 0, h + 4 * c), t.drawElements(t.TRIANGLES, e.indices.length, t.UNSIGNED_SHORT, g), (h += 4 * e.Ta.length), (g += 2 * e.indices.length);
                                                }
                            ...
                            a.onRuntimeInitialized = function () {
                                ...
                                function n() {
                                    for (let e of (0 < T.length && (u.Qb(I.drawWidth(), I.drawHeight(), T, S, A), (T = []), (A = S = 0), I.reset(512, 512)), v)) {
                                        for (let t of e.H) t();
                                        e.H = [];
                                    }
                                    v.clear();
                                ...
                                var b = a.RenderImage.extend('CanvasRenderImage', {
                                    ...
                                    O = s.extend('CanvasRenderPaint', {
                                        ...
                                        draw: function (e, n, r) {
                                            ...
                                            var a = this.Xa,
                                                o = this.ja;
                                            if (((e.globalCompositeOperation = this.Eb), null != o)) {
                                                a = o.yb;
                                                var s = o.zb;
                                                let n = o.bb;
                                                var l = o.cb;
                                                let r = o.Ra;
                                                o.ec ? ((o = n - a), (l -= s), (a = e.createRadialGradient(a, s, 0, a, s, Math.sqrt(o * o + l * l)))) : (a = e.createLinearGradient(a, s, n, l));
                                                for (let e = 0, n = r.length; e < n; e++) (s = r[e]), a.addColorStop(s.stop, t(s.color));
                                                (this.Xa = a), (this.ja = null);
                                            }
                                            switch (i) {
                                                case m:
                                                    (e.strokeStyle = a), (e.lineWidth = this.Ib), (e.lineCap = this.Ha), (e.lineJoin = this.Ia), e.stroke(n);
                                                    break;
                                                case h:
                                ...
                                var N = (a.CanvasRenderer = l.extend('Renderer', {
                                    ...
                                    transform: function (e, t, n, r, i, a) {
                                        let o = this.S,
                                            s = o.length - 6;
                                        o.splice(s, 6, o[s] * e + o[s + 2] * t, o[s + 1] * e + o[s + 3] * t, o[s] * n + o[s + 2] * r, o[s + 1] * n + o[s + 3] * r, o[s] * i + o[s + 2] * a + o[s + 4], o[s + 1] * i + o[s + 3] * a + o[s + 5]), this.H.push(this.C.transform.bind(this.C, e, t, n, r, i, a));
                                    },
                                    rotate: function (e) {
                                        let t = Math.sin(e);
                                    ...
                                    _drawImageMesh: function (t, r, i, o, s, l, c, d, _, f) {
                                        var p = this.C.canvas.width,
                                            h = this.C.canvas.height;
                                        let m = _ - c,
                                            g = f - d;
                                        (c = Math.max(c, 0)), (d = Math.max(d, 0));
                                        let E = (_ = Math.min(_, p)) - c,
                                            b = (f = Math.min(f, h)) - d;
                                        if ((console.assert(E <= Math.min(m, p)), console.assert(b <= Math.min(g, h)), !(0 >= E || 0 >= b))) {
                                            (_ = E < m || b < g), (p = f = 1);
                                            var y = Math.ceil(E * f),
                                                O = Math.ceil(b * p);
                                            (h = u.hc()), y > h && ((f *= h / y), (y = h)), O > h && ((p *= h / O), (O = h)), I || (I = new a.DynamicRectanizer(h)).reset(512, 512), 0 > (h = I.addRect(y, O)) && (n(), v.add(this), console.assert(0 <= (h = I.addRect(y, O))));
                                            var N = 65535 & h,
                                                C = h >> 16;
                                            T.push({
                                            ...
                                            this.H.push(function () {
                                                ...
                                                let e = u.canvas();
                                                e && R.drawImage(e, N, C, y, O, c, d, E, b), R.restore();
                                            });
                                        }
                                    },
                                    ...
                                    clear: function () {
                                        v.add(this), this.H.push(this.C.clearRect.bind(this.C, 0, 0, this.Ua.width, this.Ua.height));
                                    },
                                    flush: function () {},
                                ...
                                let P = a.RendererWrapper.prototype.align;
                                (a.RendererWrapper.prototype.align = function (e, t, n, r, i = 1) {
                                    P.call(this, e, t, n, r, i);
                                }),
                                    (a.requestAnimationFrame = (r = new o()).requestAnimationFrame.bind(r)),
                                    (a.cancelAnimationFrame = r.cancelAnimationFrame.bind(r)),
                                    (a.enableFPSCounter = r.Rb.bind(r)),
                                    (a.disableFPSCounter = r.Ob),
                                    (r.ob = n),
                            ...
                            var G = 0,
                                ...
                                V = null;
                            function F(e) {
                                throw (a.onAbort && a.onAbort(e), y((e = 'Aborted(' + e + ')')), (D = !0), (e = new WebAssembly.RuntimeError(e + '. Build with -sASSERTIONS for more info.')), i(e), e);
                            }
                            function Z(e) {
                            ...
                            function Y(e) {
                                if (e == q && O) return new Uint8Array(O);
                                if (f) return f(e);
                            ...
                            function z(e, t) {
                                var n = q;
                                return O || 'function' != typeof WebAssembly.instantiateStreaming || Z(n) || n.startsWith('file://') || 'function' != typeof fetch
                                    ? K(n, e, t)
                                ...
                                J = {
                                    452908: (e, t, n, r, i) => {
                                        ...
                                        if (void 0 === window.h) {
                                            ...
                                            (a.D = []),
                                                (a.yc = function (e) {
                                                    for (var t = 0; t < a.D.length; ++t) if (null == a.D[t]) return (a.D[t] = e), t;
                                                ...
                                                (a.Sc = function (e) {
                                                    for (var t = 0; t < a.D.length; ++t) if (a.D[t] == e) return a.Cb(t);
                                                }),
                                                (a.ra = function (e) {
                                                    return a.D[e];
                                                }),
                                    ...
                                    455250: () => void 0 !== navigator.mediaDevices && void 0 !== navigator.mediaDevices.getUserMedia,
                                    455354: () => {
                                        try {
                                    ...
                                    455525: (e, t, n, r, i, a) => {
                                        ...
                                        return (
                                            ...
                                            (o.J = new (window.AudioContext || window.webkitAudioContext)(s)),
                                            o.J.suspend(),
                                            ...
                                            (o.Z.onaudioprocess = function (n) {
                                                if (((null == o.sa || 0 == o.sa.length) && (o.sa = new Float32Array(P.buffer, i, r * t)), e == window.h.I.capture || e == window.h.I.La)) {
                                                    for (var s = 0; s < t; s += 1) for (var l = n.inputBuffer.getChannelData(s), c = o.sa, u = 0; u < r; u += 1) c[u * t + s] = l[u];
                                                    nv(a, r, i);
                                                }
                                                if (e == window.h.I.ya || e == window.h.I.La) for (nI(a, r, i), s = 0; s < n.outputBuffer.numberOfChannels; ++s) for (l = n.outputBuffer.getChannelData(s), c = o.sa, u = 0; u < r; u += 1) l[u] = c[u * t + s];
                                            ...
                                            (e != window.h.I.capture && e != window.h.I.La) ||
                                                navigator.mediaDevices
                                                    ...
                                                    .then(function (e) {
                                                        (o.Da = o.J.createMediaStreamSource(e)), o.Da.connect(o.Z), o.Z.connect(o.J.destination);
                                                    })
                                                    .catch(function (e) {
                                    ...
                                    458402: (e) => window.h.ra(e).J.sampleRate,
                                    458475: (e) => {
                            ...
                            var eh = {
                                    ...
                                    read: function (e, t, n, r) {
                                        ...
                                        for (var i = 0, a = 0; a < r; a++) {
                                            ...
                                            if (void 0 === o && 0 === i) throw new ew(6);
                                            if (null == o) break;
                                            i++, (t[n + a] = o);
                                        }
                            ...
                            var eb = {
                                ...
                                m: {
                                    ...
                                    write(e, t, n, r, i, a) {
                                        if ((t.buffer === T.buffer && (a = !1), !r)) return 0;
                                    ...
                                    lb(e, t, n, r, i) {
                                        ...
                                        if (((e = e.node.j), 2 & i || e.buffer !== T.buffer)) throw ((0 < n || n + t < e.length) && (e = e.subarray ? e.subarray(n, n + t) : Array.prototype.slice.call(e, n, n + t)), (n = !0), F(), (t = void 0), new ew(48));
                                        return (
                                            (n = !1),
                                            (t = e.byteOffset),
                                            {
                            ...
                            var eO,
                                ...
                                eV = () => {
                                    for (var e = 0; 4096 >= e; e++) if (!eN[e]) return e;
                                    throw new ew(33);
                                },
                                eF = (e) => {
                                ...
                                eW = (e, t) => {
                                    ...
                                    (t = {
                                        ...
                                        ((e = e.U(t)).U = t),
                                        (t.root = e),
                                        n ? (eS = e) : i && ((i.wa = t), i.U && i.U.kc.push(t));
                                },
                                eK = (e, t, n) => {
                                ...
                                eQ = (e, t, n) => {
                                    ...
                                    return (
                                        ...
                                        !a.logReadFiles || 1 & t || (eT || (eT = {}), e in eT || (eT[e] = 1)),
                                        i
                                    );
                                },
                                eJ = (e, t, n) => {
                                    ...
                                    eY(i, {
                                        ...
                                        read: (e, n, r, i) => {
                                            for (var a = 0, o = 0; o < i; o++) {
                                                ...
                                                if (void 0 === s && 0 === a) throw new ew(6);
                                                if (null == s) break;
                                                a++, (n[r + o] = s);
                                            }
                            ...
                            function tf(e, t) {
                                var n = td[e];
                                return void 0 === n && e9(t + ' has unknown type ' + t_(e)), n;
                            }
                            function tp() {}
                            var th = !1;
                            function tm(e) {
                            ...
                            function tv(e, t) {
                                return (t.u && t.o) || tO('makeClassHandle requires ptr and ptrType'), !!t.L != !!t.G && tO('Both smartPtrType and smartPtr must be specified'), (t.count = { value: 1 }), tI(Object.create(e, { g: { value: t } }));
                            }
                            function tI(e) {
                            ...
                            function tR(e, t, n) {
                                function r(t) {
                                    (t = n(t)).length !== e.length && tO('Mismatched type converter count');
                            ...
                            function tZ(e, t, n) {
                                a.hasOwnProperty(e) || tO('Replacing nonexistant public symbol'), void 0 !== a[e].B && void 0 !== n ? (a[e].B[n] = t) : ((a[e] = t), (a[e].ea = n));
                            }
                            var tH = [],
                                tY = (e) => {
                                    var t = tH[e];
                            ...
                            function tq(e, t) {
                                ...
                                var r = [],
                                    i = {};
                                throw (t.forEach(n), new tz(`${e}: ` + r.map(t_).join([', '])));
                            }
                            function tX(e, t, n, r, i) {
                                var a = t.length;
                                2 > a && e9("argTypes array size mismatch! Must at least get return value and 'this' types!");
                                ...
                                var l = 'void' !== t[0].name,
                                    ...
                                    _ = [];
                                return function () {
                                    if ((arguments.length !== c && e9(`function ${e} called with ${arguments.length} arguments, expected ${c} args!`), (_.length = 0), (d.length = o ? 2 : 1), (d[0] = i), o)) {
                                        var n = t[1].toWireType(_, this);
                                        d[1] = n;
                                    }
                                    for (var a = 0; a < c; ++a) (u[a] = t[a + 2].toWireType(_, arguments[a])), d.push(u[a]);
                                    if (((a = r.apply(null, d)), s)) tS(_);
                                    else
                            ...
                            function t0(e, t, n) {
                                switch (t) {
                                    case 0:
                                        return function (e) {
                                            return this.fromWireType((n ? T : S)[e]);
                                        };
                                    case 1:
                                        return function (e) {
                            ...
                            var t4 = 'undefined' != typeof TextDecoder ? new TextDecoder('utf-16le') : void 0,
                                ...
                                t9 = (e, t, n) => {
                                    ...
                                    for (var i = 0; i < e.length; ++i) {
                                        ...
                                        if ((55296 <= a && 57343 >= a && (a = (65536 + ((1023 & a) << 10)) | (1023 & e.charCodeAt(++i))), (C[t >> 2] = a), (t += 4) + 4 > n)) break;
                                    }
                                    return (C[t >> 2] = 0), t - r;
                                },
                                ne = (e) => {
                            ...
                            function na(e, t) {
                                for (var n = Array(e), r = 0; r < e; ++r) n[r] = tf(R[(t + 4 * r) >> 2], 'parameter ' + r);
                                return n;
                            }
                            var no,
                                ns = [],
                                ...
                                np = (e, t, n, r) => {
                                    ...
                                    var d = 'Sunday Monday Tuesday Wednesday Thursday Friday Saturday'.split(' '),
                                        _ = 'January February March April May June July August September October November December'.split(' ');
                                    for (u in ((c = {
                                        '%a': (e) => d[e.R].substring(0, 3),
                                        '%A': (e) => d[e.R],
                                        '%b': (e) => _[e.Ga].substring(0, 3),
                                        '%B': (e) => _[e.Ga],
                                        ...
                                        '%G': (e) => l(e),
                                        '%H': (e) => a(e.Fa, 2),
                                        '%I': (e) => (0 == (e = e.Fa) ? (e = 12) : 12 < e && (e -= 12), a(e, 2)),
                                        '%j': (e) => {
                                            for (var t = 0, n = 0; n <= e.Ga - 1; t += (nd(e.da + 1900) ? n_ : nf)[n++]);
                                            return a(e.Sa + t, 3);
                                        },
                                        '%m': (e) => a(e.Ga + 1, 2),
                                        '%M': (e) => a(e.vc, 2),
                                    ...
                                    return (u = e_((n = n.replace(/\0\0/g, '%')), !1)).length > t ? 0 : (T.set(u, e), u.length - 1);
                                };
                            function nh(e, t, n, r) {
                            ...
                            (ti = nm),
                                ...
                                (tx.prototype.deleteLater = function () {
                                    return this.g.o || tL(this), this.g.fa && !this.g.ia && e9('Object already scheduled for deletion'), to.push(this), 1 === to.length && tl && tl(ts), (this.g.fa = !0), this;
                                }),
                                ...
                                (tF.prototype.readValueFromPointer = tA),
                            ...
                            var nE = {
                                ...
                                __syscall_ioctl: function (e, t, n) {
                                    ...
                                    try {
                                        ...
                                        switch (t) {
                                            ...
                                            case 21508:
                                                if (!r.s) return -59;
                                                if (r.s.V.cc) for (i = e3(), t = [], a = 0; 32 > a; a++) t.push(T[(i + a + 17) >> 0]);
                                                return 0;
                                            case 21519:
                                                if (!r.s) return -59;
                                                return (C[(i = e3()) >> 2] = 0);
                                ...
                                _embind_create_inheriting_constructor: function (e, t, n) {
                                    ...
                                    (a.__construct = function () {
                                        this === a && e9("Pass correct 'this' to __construct");
                                    ...
                                    (a.__destruct = function () {
                                        this === a && e9("Pass correct 'this' to __destruct"), tp(this);
                                        var e = this.g.o;
                                            ...
                                            [
                                                {
                                                    ...
                                                    toWireType: function (e, t) {
                                                        for (var i in a) if (!(i in t)) throw TypeError(`Missing field: "${i}"`);
                                                        var o = n();
                                ...
                                _embind_register_class: function (e, t, n, r, i, a, o, s, l, c, u, d, _) {
                                    (u = ta(u)), (a = tK(i, a)), s && (s = tK(o, s)), c && (c = tK(l, c)), (_ = tK(d, _));
                                    var f = e4(u);
                                    tk(f, function () {
                                ...
                                _embind_register_class_constructor: function (e, t, n, r, i, a) {
                                    ...
                                    (i = tK(r, i)),
                                        tR([], [e], function (e) {
                                            ...
                                            return (
                                                (e.i.$[t - 1] = () => {
                                                    tq(`Cannot construct ${e.name} due to unbound types`, o);
                                                }),
                                                tR([], o, function (r) {
                                                    return r.splice(1, 0, null), (e.i.$[t - 1] = tX(n, r, null, i, a)), [];
                                                }),
                                                []
                                            );
                                        });
                                ...
                                _embind_register_class_property: function (e, t, n, r, i, a, o, s, l, c) {
                                    (t = ta(t)),
                                        (i = tK(r, i)),
                                        tR([], [e], function (e) {
                                            e = e[0];
                                            var r = `${e.name}.${t}`,
                                                u = {
                                                    get() {
                                                        tq(`Cannot access ${r} due to unbound types`, [n, o]);
                                                    },
                                                    enumerable: !0,
                                                    configurable: !0
                                                };
                                ...
                                _embind_register_function: function (e, t, n, r, i, a) {
                                    ...
                                    (e = ta(e)),
                                        ...
                                        tR([], o, function (n) {
                                            return tZ(e, tX(e, [n[0], null].concat(n.slice(1)), null, i, a), t - 1), [];
                                        });
                                },
                                _embind_register_integer: function (e, t, n, r, i) {
                                    (t = ta(t)), -1 === i && (i = 4294967295), (i = tP(n));
                                    var a = (e) => e;
                                    if (0 === r) {
                                        var o = 32 - 8 * n;
                                        a = (e) => (e << o) >>> o;
                                    ...
                                    tD(e, {
                                        ...
                                        toWireType: function (e, t) {
                                            ...
                                            var i = n && r ? eu(t) : t.length,
                                                a = ny(4 + i + 1),
                                                o = a + 4;
                                            if (((R[a >> 2] = i), n && r)) ed(t, S, o, i + 1);
                                            else if (r)
                                                for (r = 0; r < i; ++r) {
                                                    var s = t.charCodeAt(r);
                                                    255 < s && (nb(o), e9('String has UTF-16 code units that do not fit in 8 bits')), (S[o + r] = s);
                                                }
                                            else for (r = 0; r < i; ++r) S[o + r] = t[r];
                                ...
                                _embind_register_std_wstring: function (e, t, n) {
                                    ...
                                    tD(e, {
                                        name: n,
                                        fromWireType: function (e) {
                                            for (var n, i = R[e >> 2], a = o(), l = e + 4, c = 0; c <= i; ++c) {
                                                var u = e + 4 + c * t;
                                                (c == i || 0 == a[u >> s]) && ((l = r(l, u - l)), void 0 === n ? (n = l) : ((n += '\0'), (n += l)), (l = u + t));
                                            }
                                            return nb(e), n;
                                        },
                                ...
                                _embind_register_value_object_field: function (e, t, n, r, i, a, o, s, l, c) {
                                    tT[e].eb.push({
                                        Sb: ta(t),
                                        Yb: n,
                                        Wb: tK(r, i),
                                ...
                                _emval_get_method_caller: function (e, t) {
                                    ...
                                    return (
                                        (i = ni((t, i, o, s) => {
                                            for (var l = 0, c = 0; c < e - 1; ++c) (a[c] = n[c + 1].readValueFromPointer(s + l)), (l += n[c + 1].argPackAdvance);
                                            for (c = 0, t = t[i].apply(t, a); c < e - 1; ++c) n[c + 1].Nb && n[c + 1].Nb(a[c]);
                                            if (!r.fc) return r.toWireType(o, t);
                                        })),
                                        (ns[t] = i)
                                    );
                                },
                                ...
                                _emval_take_value: function (e, t) {
                                    return tt((e = (e = tf(e, '_emval_take_value')).readValueFromPointer(t)));
                                },
                                abort: () => {
                                    F('');
                                },
                                emscripten_asm_const_int: (e, t, n) => {
                                    var r;
                                    for (nl.length = 0, n >>= 2; (r = S[t++]); ) (n += (105 != r) & n), nl.push(105 == r ? C[n] : w[n++ >> 1]), ++n;
                                ...
                                emscripten_memcpy_big: (e, t, n) => S.copyWithin(e, t, t + n),
                                emscripten_resize_heap: (e) => {
                                    ...
                                    for (var n = 1; 4 >= n; n *= 2) {
                                        ...
                                        r = Math.max(e, r);
                                        e: {
                                            i = (i.min.call(i, 2147483648, r + ((65536 - (r % 65536)) % 65536)) - v.buffer.byteLength + 65535) >>> 16;
                                            try {
                                                v.grow(i), L();
                                                var a = 1;
                                                break e;
                                ...
                                environ_get: (e, t) => {
                                    ...
                                    return (
                                        nu().forEach(function (r, i) {
                                            var a = t + n;
                                            for (i = R[(e + 4 * i) >> 2] = a, a = 0; a < r.length; ++a) T[i++ >> 0] = r.charCodeAt(a);
                                ...
                                fd_seek: function (e, t, n, r, i) {
                                    ...
                                    try {
                                        ...
                                        var a = eF(e);
                                        return eJ(a, t, r), (Q = [a.position >>> 0, ((X = a.position), 1 <= +Math.abs(X) ? (0 < X ? +Math.floor(X / 4294967296) >>> 0 : ~~+Math.ceil((X - +(~~X >>> 0)) / 4294967296) >>> 0) : 0)]), (C[i >> 2] = Q[0]), (C[(i + 4) >> 2] = Q[1]), a.Ma && 0 === t && 0 === r && (a.Ma = null), 0;
                                    } catch (e) {
                                        if (void 0 === e1 || 'ErrnoError' !== e.name) throw e;
                                        return e.aa;
                                    }
                                    ...
                                    try {
                                        e: {
                                            ...
                                            for (var a, o = (t = 0); o < n; o++) {
                                                ...
                                                var h = c.m.write(c, f, u, d, _, void 0);
                                                p || (c.position += h);
                                                var m = h;
                                                if (0 > m) {
                                                    var g = -1;
                            ...
                            !(function () {
                                ...
                                if ((G++, a.monitorRunDependencies && a.monitorRunDependencies(G), a.instantiateWasm))
                                    try {
                            ...
                            var nb = (e) => (nb = I.free)(e),
                                ny = (e) => (ny = I.malloc)(e),
                                nO = (a._ma_device__on_notification_unlocked = (e) => (nO = a._ma_device__on_notification_unlocked = I.ma_device__on_notification_unlocked)(e));
                            (a._ma_malloc_emscripten = (e, t) => (a._ma_malloc_emscripten = I.ma_malloc_emscripten)(e, t)), (a._ma_free_emscripten = (e, t) => (a._ma_free_emscripten = I.ma_free_emscripten)(e, t));
                            var nv = (a._ma_device_process_pcm_frames_capture__webaudio = (e, t, n) => (nv = a._ma_device_process_pcm_frames_capture__webaudio = I.ma_device_process_pcm_frames_capture__webaudio)(e, t, n)),
                                nI = (a._ma_device_process_pcm_frames_playback__webaudio = (e, t, n) => (nI = a._ma_device_process_pcm_frames_playback__webaudio = I.ma_device_process_pcm_frames_playback__webaudio)(e, t, n)),
                                nT = () => (nT = I.__errno_location)(),
                                nS = (e) => (nS = I.__getTypeName)(e);
                            function nA() {
                                function e() {
                            ...
                            if (
                                ((a.__embind_initialize_bindings = () => (a.__embind_initialize_bindings = I._embind_initialize_bindings)()),
                                (a.dynCall_iiji = (e, t, n, r, i) => (a.dynCall_iiji = I.dynCall_iiji)(e, t, n, r, i)),
                                (a.dynCall_jiji = (e, t, n, r, i) => (a.dynCall_jiji = I.dynCall_jiji)(e, t, n, r, i)),
                                (a.dynCall_iiiji = (e, t, n, r, i, o) => (a.dynCall_iiiji = I.dynCall_iiiji)(e, t, n, r, i, o)),
                                (a.dynCall_iij = (e, t, n, r) => (a.dynCall_iij = I.dynCall_iij)(e, t, n, r)),
                                (a.dynCall_jii = (e, t, n) => (a.dynCall_jii = I.dynCall_jii)(e, t, n)),
                                (a.dynCall_viijii = (e, t, n, r, i, o, s) => (a.dynCall_viijii = I.dynCall_viijii)(e, t, n, r, i, o, s)),
                                (a.dynCall_iiiiij = (e, t, n, r, i, o, s) => (a.dynCall_iiiiij = I.dynCall_iiiiij)(e, t, n, r, i, o, s)),
                                (a.dynCall_iiiiijj = (e, t, n, r, i, o, s, l, c) => (a.dynCall_iiiiijj = I.dynCall_iiiiijj)(e, t, n, r, i, o, s, l, c)),
                                (a.dynCall_iiiiiijj = (e, t, n, r, i, o, s, l, c, u) => (a.dynCall_iiiiiijj = I.dynCall_iiiiiijj)(e, t, n, r, i, o, s, l, c, u)),
                                (V = function e() {
                                    n || nA(), n || (V = e);
                                }),
                                a.preInit)
                        ...
                        a = function (e) {
                            ...
                            var h = null,
                                ...
                                g = function (e) {
                                    ...
                                    (m = _ && 'touchend' === e.type && 'touchstart' === h), (h = e.type);
                                    ...
                                    if (a || s) {
                                        var d = a - t.left,
                                            ...
                                            E = new l.Mat2D();
                                        g.invert(E);
                                        var b = new l.Vec2D(d, f),
                                            y = l.mapXY(E, b),
                                            O = y.x(),
                                            v = y.y();
                                        switch ((y.delete(), E.delete(), b.delete(), g.delete(), console.debug(e), e.type)) {
                                            case 'mouseleave':
                                            case 'mouseout':
                                                for (var I = 0, T = o; I < T.length; I++) {
                                                    var S = T[I];
                                                    S.pointerMove(O, v);
                                                }
                                                break;
                            ...
                            return (
                                t.addEventListener('mouseover', g, !0),
                                t.addEventListener('mouseenter', g, !0),
                                t.addEventListener('mouseout', g, !0),
                                t.addEventListener('mouseleave', g, !0),
                                t.addEventListener('mousemove', g, !0),
                                t.addEventListener('mousedown', g, !0),
                                t.addEventListener('mouseup', g, !0),
                                t.addEventListener('touchmove', g, { passive: _ }),
                                t.addEventListener('touchstart', g, { passive: _ }),
                                t.addEventListener('touchend', g),
                                function () {
                                    t.removeEventListener('mouseover', g, !0), t.removeEventListener('mouseenter', g, !0), t.removeEventListener('mouseout', g, !0), t.removeEventListener('mouseleave', g, !0), t.removeEventListener('mousemove', g, !0), t.removeEventListener('mousedown', g, !0), t.removeEventListener('mouseup', g, !0), t.removeEventListener('touchmove', g), t.removeEventListener('touchstart', g), t.removeEventListener('touchend', g);
                                }
                            );
                        };
                },
                                ...
                                if ((void 0 === n && (n = !0), 0 === (e = W(e)).length))
                                    ...
                                    for (
                                        ...
                                        if (s >= 0 || l >= 0) s >= 0 ? (this.animations[s].playing = t) : (this.stateMachines[l].playing = t);
                                            ...
                                            if (c) {
                                                var u = new _.Animation(c, this.artboard, this.runtime, t);
                                                u.advance(0), u.apply(1), this.animations.push(u);
                                            } else {
                                                var d = this.artboard.stateMachineByName(e[a]);
                                                if (d) {
                                                    var f = new T(d, this.runtime, t, this.artboard);
                            ...
                            (e.prototype.initLinearAnimations = function (e, t) {
                                for (
                                    ...
                                    if (i >= 0) this.animations[i].playing = t;
                                        ...
                                        if (a) {
                                            var o = new _.Animation(a, this.artboard, this.runtime, t);
                            ...
                            (e.prototype.initStateMachines = function (e, t) {
                                for (
                                    ...
                                    if (i >= 0) this.stateMachines[i].playing = t;
                                        ...
                                        if (a) {
                                            var o = new T(a, this.runtime, t, this.artboard);
                                ...
                                return m(this, void 0, void 0, function () {
                                    ...
                                    return g(this, function (a) {
                                        switch (a.label) {
                                            ...
                                            case 3:
                                                if (((r.file = a.sent()), this.destroyed)) return null == (i = this.file) || i.delete(), (this.file = null), [2];
                                                if (null !== this.file)
                                                    this.eventManager.fire({
                                                        type: o.Load,
                                                        data: this
                    ...
                    L = (function () {
                        function t(e) {
                            ...
                            (this.loaded = !1),
                                ...
                                (this.taskQueue = new N(this.eventManager)),
                                this.init({
                                    src: this.src,
                                    buffer: this.buffer,
                        ...
                        return (
                            ...
                            (t.prototype.setupRiveListeners = function (e) {
                                ...
                                if ((this.eventCleanup && this.eventCleanup(), !this.shouldDisableRiveListeners)) {
                                    ...
                                    var i = this.canvas;
                                    null != this.eventTarget && (i = this.eventTarget),
                            ...
                            (t.prototype.initData = function (e, n, r, i, a) {
                                return m(this, void 0, void 0, function () {
                                    var s, l;
                            ...
                            (t.prototype.initArtboard = function (e, t, n, r, i) {
                                if (this.file) {
                                    ...
                                    if (
                                        ((this.animator = new S(this.runtime, this.artboard, this.eventManager)),
                                        t.length > 0 || n.length > 0 ? ((a = t.concat(n)), this.animator.initLinearAnimations(t, r), this.animator.initStateMachines(n, r)) : (a = [this.animator.atLeastOne(r, !1)]),
                                        this.taskQueue.add({
                                            event: {
                            ...
                            (t.prototype.draw = function (e, t) {
                                                ...
                                                if (E.type === a.OpenUrl) {
                                                    if (
                                                        ...
                                                        var b = document.createElement('a'),
                                                            ...
                                                            v = y.target,
                                                            I = (0, f.sanitizeUrl)(O);
                                                        O && b.setAttribute('href', I), v && b.setAttribute('target', v), I && I !== f.BLANK_URL && b.click();
                                                    }
                                                } else
                                                    this.eventManager.fire({
                                                        type: o.RiveEvent,
                                ...
                                var T = this.renderer;
                                T.clear(), T.save(), this.alignRenderer(), this._hasZeroSize || this.artboard.draw(T), T.restore(), T.flush(), this.animator.handleLooping(), this.animator.handleStateChanges(), this.animator.handleAdvancing(i), this.frameCount++;
                                var S = performance.now();
                                for (this.frameTimes.push(S), this.durations.push(S - r); this.frameTimes[0] <= S - 1000; ) this.frameTimes.shift(), this.durations.shift();
                        ...
                        return (
                            ...
                            (e.prototype.propertyFromPathSegments = function (e, t, n) {
                                if (t < e.length - 1) {
                                    ...
                                    return null !== E ? E.propertyFromPathSegments(e, t + 1, n) : null;
                                }
                                var b = null;
                                switch (n) {
                                    case c.Number:
                                        if (null !== (b = null != (i = null == (r = this._runtimeInstance) ? void 0 : r.number(e[t])) ? i : null)) return new G(b, this);
                                        break;
                                    case c.String:
                                        if (null !== (b = null != (o = null == (a = this._runtimeInstance) ? void 0 : a.string(e[t])) ? o : null)) return new U(b, this);
                                        break;
                                    case c.Boolean:
                                        if (null !== (b = null != (l = null == (s = this._runtimeInstance) ? void 0 : s.boolean(e[t])) ? l : null)) return new B(b, this);
                                        break;
                                    case c.Color:
                                        if (null !== (b = null != (d = null == (u = this._runtimeInstance) ? void 0 : u.color(e[t])) ? d : null)) return new H(b, this);
                                        break;
                                    case c.Trigger:
                                        if (null !== (b = null != (f = null == (_ = this._runtimeInstance) ? void 0 : _.trigger(e[t])) ? f : null)) return new V(b, this);
                                        break;
                                    case c.Enum:
                                        if (null !== (b = null != (h = null == (p = this._runtimeInstance) ? void 0 : p.enum(e[t])) ? h : null)) return new F(b, this);
                                        break;
                                    case c.List:
                                        if (null !== (b = null != (g = null == (m = this._runtimeInstance) ? void 0 : m.list(e[t])) ? g : null)) return new Z(b, this);
                                }
                                return null;
                            }),
