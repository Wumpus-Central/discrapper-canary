...
let _ = new f(i.q.ANIMATED_EMOJIS),
    ...
    b = new f('profileBadges'),
    T = new f(i.q.PROFILE_PREMIUM_FEATURES, 'custom banner and avatar decoration'),
    ...
    x = new f(i.q.STREAM_HIGH_QUALITY),
    L = new f(i.q.CUSTOM_NOTIFICATION_SOUNDS),
...
let U = new f(i.q.INCREASED_GUILD_LIMIT),
    ...
    F = Object.freeze({
        [l.Si.TIER_0]: new o.Z(l.Si.TIER_0, [_, p, h, b, k, B, Z, N]),
        [l.Si.TIER_1]: new o.Z(l.Si.TIER_1, [_, p, v, y, b, R, D, P, B, Z, N]),
        [l.Si.TIER_2]: new o.Z(l.Si.TIER_2, [_, p, h, m, g, v, y, I, b, T, C, R, O, D, x, P, w, M, k, U, G, B, Z, N, S, L, E, A])
    });
function V(e, t) {
