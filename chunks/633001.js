n.d(t, { Z: () => eR }), n(388685), n(583741), n(539854), n(49124), n(35282), n(781311);
var a = n(54381),
    l = n(473749),
    i = n(120356),
    r = n.n(i),
...
function eN() {
    ...
    let [S, E] = l.useState(""),
        ...
        [O, P] = l.useState(N),
        [w, k] = l.useState(null),
        A = l.useMemo(() => y.find((e) => e.key === w), [y, w]),
        R = l.useCallback((e) => {
            P(e);
        }, []),
...
let eI = (e) => {
    ...
    ek = l.memo(function () {
        let e = (0, C.xj)(),
            t = (0, d.e7)([R.ZP], () => R.ZP.getOverlayKeybind());
        return (0, a.jsxs)("div", {
            className: J.panelGroup,
            children: [
                (0, a.jsx)(m.Heading, {
                ...
                (0, a.jsx)(m.Text, {
                    ...
                    children: (0, a.jsx)("pre", {
                        children: JSON.stringify($(Q({}, e), { overlayKeybind: (0, B.BB)(t.shortcut) }), void 0, 2),
                    }),
                }),
                (0, a.jsx)(m.Heading, {
                    variant: "heading-md/semibold",
