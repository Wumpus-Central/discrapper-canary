t.d(E, { GL: () => n, IM: () => s, JJ: () => a, RE: () => r, V2: () => o, go: () => S, x8: () => I });
var e = t(636537),
    d = t(228366),
    i = t(77257),
    l = t(652215);
async function n(_, E) {
    ...
    let c = {
        ...
        collectibles: void 0 !== r ? { nameplate: null === r ? null : { sku_id: r.skuId } } : void 0,
    ...
    try {
        ...
        return (
            ...
            (null != n || null != o) && d.h.dispatch({ type: "RECENT_AVATARS_UPDATE" }),
            E
        );
    } catch (t) {
        let E = t.body;
