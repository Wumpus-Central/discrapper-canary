a.r(t), a.d(t, { default: () => r }), a(321073);
var i = a(626584),
    l = a(274372),
    s = a(372684),
    o = a(672412);
...
class d {
    ...
    handleYellClassification(e) {
        ...
        window.__CLIPS_DEBUG__?.yell &&
            ...
            i && this.emitSignal({ type: s.Gy.YELLING, userId: t }, o);
    }
    handleWakeWord(e) {
        ...
        for (let [e, t] of Object.entries(a))
            if (("number" == typeof t ? t : 0) >= 0.5 && d.includes(e)) {
                this.emitSignal({ type: s.Gy.PHRASE, text: e }, i);
                break;
            }
    }
    handleEmotionClassification(e) {
        ...
        this.emotionHistory.push({ timestamp: i, userId: t, emotions: a }),
            ...
            window.__CLIPS_DEBUG__?.emotion && n.info(`Emotion classification: ${t}: ${JSON.stringify(a)}`);
    }
            ...
            for (let t of d(e.text).matchAll(c)) {
                ...
                if (null != l) {
                    ...
                    if (null != e.words && e.words.length > 0) {
                        let a = d(l).split(" "),
                            s = e.words.map((e) => ({ ...e, cleanText: d(e.text) }));
                    ...
                    this.emitSignal({ type: s.Gy.PHRASE, text: l }, t);
                }
            }
    }
}
