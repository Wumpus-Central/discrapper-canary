...
function B(e, t, n) {
    ...
    (0, C.aS)({ pid: e, name: t, type: I.ON.Renderer, data: n, logType: i });
}
function j() {
...
function z(e, t) {
    ...
    $(e, "timer", i, "timeOverlayEvent"), ed.emitChange();
}
async function q(e) {
    let t = H(e);
    if (null != t) return t;
...
function Z(e, t) {
    ...
    let r = f.A.findGame(n)?.id,
        s = (0, S.zi)(n) || y.A.isLimitedInteractionOverrideEnabled(n.id ?? r);
    switch (t) {
        case o.aI.MINIMIZED:
        case o.aI.WINDOWED:
        case o.aI.MAXIMIZED:
...
async function X(e) {
    ...
    if (!(j() || b)) return void R.verbose(`Skipping track for pid ${e} - overlay is disabled`);
    let t = await q(e);
...
async function Q(e) {
    if (!K(e)) return void R.verbose(`Skipping untrack for pid ${e} - not tracked`);
...
async function et(e, t, n) {
    ...
    $(e, "state", s, o),
        ...
        R.verbose(`Updating overlay method for pid ${e} "${H(e)?.gameName}" to ${(0, S.gK)(r)}`),
        ed.emitChange();
    let l = H(e);
...
async function ei(e) {
    ...
    if (T.has(a.state)) return R.verbose(`Skipping overlay method swap for pid ${e} - state is ${a.state}`), !1;
    let o = await (0, S.E1)(e, 0);
    if (null == o) return R.error(`Failed to get revised fullscreen type for pid ${e}`), !1;
    a.fullscreenType !== o &&
    ...
    if (
        ...
        return s;
    let u = O === A.V6.OUT_OF_PROCESS_V3 || O === A.V6.OUT_OF_PROCESS_V3_LIMITED_INTERACTION,
        c = O === A.V6.IN_PROCESS_V2,
        d = (0, S.e3)(o, j()),
        _ = (0, S.Zj)(a, o, j());
    ...
    switch (l.overlayMethod) {
        ...
        case A.Ue.OutOfProcessLimitedInteraction:
            ((d && !c) || u) &&
                ...
                (n = l),
                K(t)
                    ? H(t)?.overlayMethod === n.overlayMethod
        ...
        case A.Ue.Hook:
            ...
            break;
        case A.Ue.Disabled:
            h(), et(e, l, "determineOverlayMethodSwap - disabled");
    }
    return s;
}
async function er(e) {
...
class ec extends i.Ay.Store {
    ...
    initialize() {
        this.waitFor(h.default, c.A, f.A, y.A, d.Ay, N.A, _.A), this.syncWith([c.A], eu);
    }
    ...
    getOverlayMethod(e) {
        return __OVERLAY__ ? A.Ue.Hook : (H(e)?.overlayMethod ?? A.Ue.Disabled);
    }
    ...
    hasChangedRenderMode(e) {
        return H(e)?.hasChangedRenderMode ?? !1;
    }
    ...
    getGlobalEnabledStatus() {
        return { oopEnabled: j(), legacyEnabled: b };
    }
    ...
    getRenderMethod(e) {
        if (null != e) return H(e)?.overlayMethod ?? void 0;
    }
        ...
        !L
            ...
            : {
                  ...
                  OVERLAY_SET_ENABLED: function (e) {
                      ...
                      return R.info("handleOverlaySetEnabled", { legacyEnabled: t, oopEnabled: n }), es(t, n), !0;
                  },
                  ...
                  OVERLAY_RELOAD: function (e) {
                      return R.error("Overlay reload for pid", { pid: e.pid }), eo(), !0;
                  },
