...
let x = (e) => {
    ...
    let _ = (0, p.aL)(),
        D = i.useCallback(() => {
            _.dispatch(y.jej.POPOUT_SHOW);
        }, [_]),
        I = i.useCallback(() => {
            _.dispatch(y.jej.POPOUT_HIDE);
        }, [_]),
        T = (0, a.D)("ContextMenu"),
        j = u.ownerDocument;
    return T
        ? (0, r.jsx)(o.Ow, {
              ...
              ownerDocument: j,
              onOpenChange: (e, t, n) => {
                  e ? D() : (I(), "outside-press" === n && setTimeout(v, 0), b.current());
              },
...
class w extends i.PureComponent {
    ...
    componentDidMount() {
        ...
        if (
            ...
            A._.subscribe(y.jej.CONTEXT_MENU_CLOSE, this.props.closeContextMenu),
            null != e)
        ) {
            let t = setTimeout(() => {
    ...
    componentWillUnmount() {
        ...
        e.removeEventListener("resize", this.closeResize, !0),
            A._.unsubscribe(y.jej.CONTEXT_MENU_CLOSE, this.props.closeContextMenu);
    }
    closeResize = (e) => {
