...
let o = {
    openGameProfileModal: function (e) {
        ...
        s()(
            ...
            (0, a.mMO)(
                async () => {
                    let { default: e } = await Promise.all([n.e("42006"), n.e("34273")]).then(n.bind(n, 225732));
    ...
    openGameProfileStoreLinksModal: function (e) {
        let { detectedGame: t, storeWebsites: i } = e;
        (0, a.mMO)(async () => {
            let { default: e } = await n.e("76758").then(n.bind(n, 459477));
            return (n) => (0, r.jsx)(e, { detectedGame: t, storeWebsites: i, ...n });
        });
    },
};
