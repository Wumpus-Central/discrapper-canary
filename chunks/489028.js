...
function T(e) {
    let { guild: t, eligibleTeams: n, isGuildOwner: s } = e,
        ...
        f = async () => {
            (await d(t, a, C.wW.GUILD_ROLE_SUBSCRIPTIONS)) &&
                (g(t.id),
                (0, j.B)({
                    Icon: v.Z,
...
let P = (e) => {
    let { guild: t } = e,
        ...
        c = t.isOwner(n),
        x = (0, o.Ob)(t),
        b = (0, s.e7)([h.Z], () => h.Z.isFocused()),
        { teams: j, loading: v } = (0, g.Z)({ refreshOnDepChange: b }),
        C = i.useMemo(
            () =>
                j.filter((e) => {
                    var t;
                    return e.payout_account_status !== y.C.BLOCKED && (0, m.Z)(null != (t = null == n ? void 0 : n.id) ? t : O.lds, e);
                }),
            [j, n]
        ),
        P = C.length > 0,
