...
let P = (e) => {
    let { guild: t } = e,
        ...
        c = t.isOwner(n),
        b = (0, o.Ob)(t),
        x = (0, s.e7)([f.Z], () => f.Z.isFocused()),
        { teams: j, loading: _ } = (0, g.Z)({ refreshOnDepChange: x }),
        O = i.useMemo(
            () =>
                j.filter((e) => {
                    var t;
        ...
        w = i.useCallback(async () => {
            h.default.track(y.rMx.GUILD_ROLE_SUBSCRIPTION_TEAM_SETUP_CLICKED, {
                is_onboarding_v2: b,
                has_eligible_team: P,
                guild_id: t.id,
                is_owner: c
