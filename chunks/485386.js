...
function h(e) {
    for (let n of e.guilds) {
        ...
        _[n.id] = 'partial' === n.data_mode ? s.EO(n.id, null != (t = _[n.id]) ? t : S, n.partial_updates.roles, n.partial_updates.deleted_role_ids) : l.C5(n.id, n.roles);
    }
}
function m(e) {
    for (let t of ((_ = {}), e)) {
        for (let e in t.roles) l.cf(t.roles[e]);
        _[t.id] = t.roles;
    }
}
function g(e) {
