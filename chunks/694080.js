...
async function _(e) {
    ...
    if (t) {
        ...
        try {
            ...
            let { offerId: p, paymentGatewayOverride: h } = n,
                E =
                    void 0 !== h
                        ? h
                        : ((t = null),
                          (0, u.isAndroid)() ? (t = d.kM_.GOOGLE) : (0, u.isIOS)() && (t = d.kM_.APPLE),
                          t),
                m = await r.Bo.post({
                    url: d.Rsh.USER_OFFER,
                    body: null != E || null != p ? { payment_gateway: E, offer_id: p } : {},
                    rejectWithError: !0,
            ...
            if (null != p && null != I && I.discount_id !== p) {
                ...
                throw (c.A.captureException(e, { extra: { offer_id: p, user_discount_offer: I }, ...f }), e);
            }
            return (
                null == g &&
