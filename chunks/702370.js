    ...
    eA = (e) => {
        ...
        return t === m.a.PREMIUM_TIER_2_3_DAY
            ? (0, r.jsx)(v.Text, {
                  ...
                  children: ek.NW.format(ek.t.BPDKoK, { helpdeskArticle: D.Z.getArticleURL(eN.BhN.FRACTIONAL_PREMIUM_ABOUT) })
              })
            : null;
    },
    eB = (e) => {
        var t, n;
        let a;
        let { product: o, user: c, category: m, shouldCheckoutWithOrbs: b, onClose: P, returnRef: C, previewingVariantIndexProps: j, selectedVariantIndex: _, tab: w } = e,
