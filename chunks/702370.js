...
let eZ = (e) => {
    ...
    eF = (e) => {
        ...
        let A = (0, X.L)(t),
            ...
            F = (0, p.e7)([H.Z], () => H.Z.isClaiming === (null == N ? void 0 : N.skuId)),
            V = (0, P.ZP)(),
            Q = (0, v.wj)(V),
            $ = (0, W.G1)(N),
    ...
    ez = (e) => {
        let { product: t, user: n, activeBundleSlide: i, isTransitioning: l } = e,
            ...
            s = U.ZP.canUsePremiumProfileCustomization(n),
    ...
    eV = (e) => {
        let {
            ...
            h = (0, p.e7)([D.default], () => D.default.getCurrentUser()),
            P = (0, eC.f)(l),
        ...
        let I = (0, Z.r9)(),
            ...
            { activeSlide: B, isTransitioning: F } = (0, $.b)({
                slideCount: L,
                intervalMs: 5000,
            });
