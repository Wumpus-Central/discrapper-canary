...
let eZ = (e) => {
    ...
    eF = (e) => {
        let {
            ...
            { previewingVariantIndex: T, handleEntering: N, handleLeaving: S } = g,
            R = (0, eP.N)(t, T),
            k = (0, ej.W)(t, P);
        ...
        let _ = (0, Q.L)(t),
            ...
            { handleUseNow: eO, isApplying: ey } = (0, K.W)({
                product: k,
                onSuccess: u,
            }),
            eL = (0, eT.To)(k),
    ...
    eW = (e) => {
        ...
        let { analyticsLocations: w } = (0, x.ZP)([...p, g.Z.COLLECTIBLES_SHOP_DETAILS_MODAL]);
        (0, ea.u9)(T.skuId);
        let A = (0, eO.kc)(o),
