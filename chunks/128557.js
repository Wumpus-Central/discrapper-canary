...
function B(e) {
    let { channel: t } = e,
        ...
        p = null != l && I.default.extractTimestamp(l.id) < Date.now() - P._8R,
            ...
            let t = i.useCallback(() => {
                ...
                a = i.useCallback(() => {
                    h.ZP.trackWithMetadata(P.rMx.SERVER_SETUP_CTA_CLICKED, {
                        ...
                        null != e && g.Z.open(e.id, (0, _.r)(), { section: P.jXE.CHANNEL_WELCOME_CTA });
                }, [e]);
            return {
                handleInvite: t,
                handleMessage: l,
            ...
            el.push(
                (0, r.jsx)(
                    o.Z.div,
                    {
                        ...
                        children: (0, r.jsx)(U, {
                            iconUrl: ei ? u.YvY : R,
                            header: N.intl.string(N.t.q9n0TU),
                            completed: V,
                            onClick: Y
                        })
                    },
            ...
            el.push(
                (0, r.jsx)(
                    o.Z.div,
                    {
                        ...
                        children: (0, r.jsx)(U, {
                            iconUrl: ei ? u.yIb : w,
                            header: N.intl.string(N.t.pGVNIy),
                            completed: H,
                            onClick: X
                        })
                    },
    ...
    let ea = v ? N.intl.string(N.t['1ach9P']) : N.intl.string(N.t['ezm+/v']);
    p && (ea = N.intl.string(N.t['gwyU/P']));
    let eo = ''.concat(O.Z.getArticleURL(P.BhN.GUILD_GETTING_STARTED), '?utm_source=discord&utm_medium=blog&utm_campaign=2020-06_help-new-user&utm_content=--t%3Apm');
    return (0, r.jsx)(S.ZP, {
        channelId: t.id,
                    ...
                    (0, r.jsxs)(o.Z.div, {
                        ...
                        children: [
                            (0, r.jsx)(u.X6q, {
                                ...
                                children: N.intl.format(N.t.rkHVKS, { guildName: l.name })
                            }),
                            (0, r.jsxs)(u.Text, {
                                ...
                                variant: 'text-sm/normal',
                                children: [ea, ' ', el.length > 0 ? N.intl.format(N.t.UOtD39, { guideURL: eo }) : null]
                            })
                        ]
                    }),
                    el
