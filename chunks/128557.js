...
function R(e) {
        ...
        { guildPopulated: k, guildMessaged: U, guildPersonalized: B } = (0, f.h_)(l),
        {
            ...
            let t = i.useCallback(() => {
                    h.ZP.trackWithMetadata(I.rMx.SERVER_SETUP_CTA_CLICKED, {
                        ...
                        null != e &&
                            (0, u.ZDy)(async () => {
                                let { default: t } = await Promise.all([n.e("7654"), n.e("62292")]).then(
                                    n.bind(n, 560114),
                                );
                                return (n) =>
                                    (0, r.jsx)(
                ...
                handleDownload: i.useCallback(() => {
                    h.ZP.trackWithMetadata(I.rMx.SERVER_SETUP_CTA_CLICKED, {
                        ...
                        (0, u.ZDy)(async () => {
                            ...
                            return (t) => (0, r.jsx)(e, N({ source: I.jXE.CHANNEL_WELCOME_CTA }, t));
                        });
                }, []),
    ...
    let ee = "".concat(
        O.Z.getArticleURL(I.BhN.GUILD_GETTING_STARTED),
