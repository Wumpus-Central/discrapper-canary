...
function B(e) {
    let { channel: t } = e,
        ...
        { canInvite: B, canManageGuild: F, canMessage: G } = (0, m.TE)(t, l),
        H = (0, s.e7)([x.default], () => {
            var e, t;
    ...
    if (
        (i.useEffect(() => {
            (async () => {
                try {
                    var e;
                    let t = await (0, b.i)(null != (e = null == l ? void 0 : l.id) ? e : S.lds);
                    en(t.map((e) => e.id));
                } catch (e) {}
            })();
        }, [null == l ? void 0 : l.id]),
    ...
    let eo = ''.concat(O.Z.getArticleURL(S.BhN.GUILD_GETTING_STARTED), '?utm_source=discord&utm_medium=blog&utm_campaign=2020-06_help-new-user&utm_content=--t%3Apm');
    return (0, r.jsx)(P.ZP, {
        channelId: t.id,
