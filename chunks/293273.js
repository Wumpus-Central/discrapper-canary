...
function k() {
    ...
    n.push(...i);
    let o = A.Z.getStream();
    null != o && n.push(D({ type: w.IIU.STREAMING }, o));
    let l = new Set();
    s().forEach(M, (e) => {
        let [, t] = e;
    ...
    null != S && n.push(D({ type: w.IIU.LISTENING }, S));
...
function B() {
    ...
    for (let [i, [a, o, s]] of Object.entries(M)) {
        ...
        let c = null != (n = o.flags) ? n : 0,
            u = (0, f.S)(
                o,
                (0, l.yE)(null != (r = null == o ? void 0 : o.flags) ? r : 0, w.xjy.INSTANCE),
                o.platform === w.M7m.EMBEDDED,
                (0, f.D)(o),
                s,
            );
...
class H extends (r = c.ZP.Store) {
    initialize() {
        this.waitFor(p.Z, I.Z, T.Z, d.ZP, A.Z, E.Z, C.Z, g.Z, h.ZP, N.Z, P.Z, O.Z, S.Z),
