...
s(_, "displayName", "ApplicationStoreUserSettingsStore"),
    s(_, "persistKey", "ApplicationStoreUserSettingsStore"),
    s(_, "migrations", [(e) => (null == e.hasAcceptedEulaIds ? u(l({}, e), { hasAcceptedEulaIds: [] }) : e)]);
let m = new _(o.Z, {
