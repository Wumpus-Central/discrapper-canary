...
function O(e) {
    let { guild: t, prejoinOnly: n, postjoinOnly: l } = e,
        c = (0, s.e7)([f.Z], () => f.Z.editedOnboardingPrompts),
        ...
        ],
        {
            ...
            if (n.length > b.b3)
                return void c.Z.show({
                    ...
                    body: h.intl.formatToPlainString(h.t["pkbZ+U"], { numQuestions: b.b3 }),
                });
            (0, m.tS)(d, [...n, ...r]);
        });
    return null == d
