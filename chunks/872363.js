...
let L = (0, o.xI)(h.A.LIVE_INDICATOR_BORDER_RADIUS),
    ...
    F = (e) => {
        ...
        let U = t || a,
            ...
            F = o && !N.Ay.isPremium(G, j.PremiumTypes.TIER_1) && !N.Ay.canStreamQuality(N.Ay.StreamQuality.MID, G),
            H = l.useCallback(() => {
                F &&
                    U &&
        ...
        if (
            (l.useEffect(() => {
                !f &&
                    U &&
                    (v.default.track(b.HAw.PREMIUM_UPSELL_VIEWED, {
        ...
        let B = (0, i.jsx)(u.m, {
            ...
            children: (0, i.jsxs)(A.D, {
                onClick: H,
                className: s()(M.t5, p, S.u1[h], w ? M.Y5 : M.Lc, { [M.vk]: F && U }),
                children: [
    ...
    H = (e) => {
        let { participant: t, showQuality: n, isUpsellEnabled: a = !0, size: o, className: c, premiumIndicator: d } = e,
            [u, h] = l.useState(!1),
            m = (0, T.N5)(t),
            { reducedMotion: A } = l.useContext(p.C),
            g = n && null != m,
            C = (0, f.p)(
                g,
                ...
                children: [
                    ...
                    (0, i.jsx)(r.animated.div, {
                        ...
                        children: (0, i.jsx)(S.Ay, {
                            look: S.gv.RED,
                            size: o,
                            shape: g ? _.EG.ROUND_RIGHT : _.EG.ROUND,
                        }),
                    }),
                ],
            });
