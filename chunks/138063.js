        ...
        children: [
            (0, n.jsxs)("div", {
                ...
                children: [
                    ...
                    (0, n.jsx)(O.E, { variant: "text-sm/normal", color: "text-default", children: i }),
                ],
            }),
            s,
        ],
...
function q(e) {
    ...
    return (0, n.jsx)(z, {
        ...
        children: (0, n.jsx)("div", {
            className: W.v0,
            children: (0, n.jsx)(U.FD, { icon: k.o, text: F.intl.string(F.t["g33r/P"]), onClick: c }),
        }),
    });
}
function Q() {
...
function et(e) {
    let { user: t, currentUser: i, displayProfile: s, guildId: l, channelId: r, onClose: a } = e,
        ...
        O = o.length > 0 || null != c,
        k = s?.private !== !0 && null == c && null == g && null != u,
        y = !R && (O || k),
        _ = d.length > 0;
    return y || _ || !m
        ? y || _ || m
...
let e6 = s.memo(function (e) {
    ...
    return r
        ? (0, n.jsx)("li", {
              children: (0, n.jsx)(e3, { item: t, index: i, wishlistId: a, onReorder: d, children: g }),
          })
...
function tm(e) {
    let {
        ...
        { minItemsToDismiss: c } = tg.useConfig({ location: "user_profile_wishlist_suggestions_grid" }),
        u = (i?.items.length ?? 0) >= c,
        [g, m] = s.useState(!1);
    !l || u || g || m(!0);
    let x = (0, f.bG)([eV.A], () =>
            null != i ? new Date(eV.A.getWishlistSettings(t.id, i.id)?.updated_at ?? 0).valueOf() : 0,
        ),
        [h, I] = (0, tn.Wl)(
            ti.M.USER_PROFILE_WISHLIST_RECOMMENDATIONS,
            { showAfterTimestamp: x + tu, cooldownDurationMs: tc },
            void 0,
            !0,
        ),
        p = h === ti.M.USER_PROFILE_WISHLIST_RECOMMENDATIONS;
    return l && (!u || p || g)
        ? (0, n.jsxs)("div", {
              className: r()(td.kL, d),
              children: [
                ...
                () =>
                    t.filter(eG.Vq).map((e) => {
                        ...
                        return {
                            ...
                            iconLeft: null != t ? () => (0, n.jsx)("img", { className: tE.I, src: t, alt: "" }) : eA.U,
...
var tT = i(509434),
    tv = i(365199);
let tN = E.A.getArticleURL(x.MVz.CUSTOM_PROFILES_WISHLIST);
function tb(e) {
...
function tO(e) {
    ...
    return (0, n.jsxs)("div", {
        ...
        children: [
            ...
            (0, n.jsx)(tb, { isOwner: !0, isWishlistPublic: s, onToggleVisibility: o }),
        ],
    });
}
function tk(e) {
    ...
    let {
        ...
        c = s.useMemo(() => {
            ...
            if (1 === i.length) {
                ...
                return null == t
                    ? null
                    : (0, n.jsx)(tk, { application: t, handleOpenGameShop: r, handleOpenGameShopMouseDown: a });
            }
            return (0, n.jsx)(tS, {
...
function tG(e) {
    ...
    let m = (function (e) {
            let { wishlist: t, profileOwner: i, currentUser: n } = e,
                ...
                x = (0, eD.px)();
            return s.useMemo(
                () => (0, w.uniq)([...o, ...d, ...c, ...u, ...(l ? [...g, ...m, ...x] : [])].filter(eG.Vq)),
                [o, d, c, u, g, m, x, l],
            );
        })({ wishlist: c, profileOwner: t, currentUser: a }),
        x = (0, eU.Gh)("user-profile-modal-v2-wishlist"),
        h = (0, ev.A)(() => (0, ex.A)()),
        I = s.useCallback(() => {
            (0, eI.closeAllModals)(),
        ...
        { handleToggle: j } = (0, eR.c)({
            userId: a?.id,
            skuId: tC.pe.TIER_2,
            nuxGraphic: x ? ey.g : void 0,
            onNuxShow: ew.D,
            location: eN.A.USER_PROFILE_WISHLIST,
            onAddSuccess: ek.w,
        });
    if (null == a || null != g) return null;
    let E = null == c || 0 === c.items.length;
    return (0, n.jsxs)(tD, {
        scrollerRef: i,
        className: r()({ [tw.XG]: !E }),
        fade: !0,
        children: [
                ...
                : (0, n.jsxs)(n.Fragment, {
                      children: [
                          ...
                          (0, n.jsx)(t_, {
                              ...
                              handleOpenShop: I,
                              handleOpenGameShop: A,
                              handleAddNitroToWishlist: x && !(0, eH.C3)(c, tC.pe.TIER_2) ? j : void 0,
                          }),
            ...
            d &&
                (0, n.jsx)(tm, {
                    user: t,
                    wishlist: c,
                    hasFetchedWishlist: u,
                    analyticsLocations: o,
                    impressionSessionId: h,
                    className: E ? tw._E : tw.HZ,
                }),
        ],
    });
}
...
function tD(e) {
    ...
    return (0, n.jsx)(a.Ip, { ref: s, className: r()(tL.gN, i), fade: !0, ...l, children: t });
}
function tP(e) {
