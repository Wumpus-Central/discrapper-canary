...
function O(e) {
    ...
    return (
        null != g.Ay.getGlobalName(e) && (r.globalName = e.globalName),
        e.bot && (r.isBot = !0),
        e instanceof c.A
            ? (r.isProvisional = e.isProvisional)
            : "flags" in e
              ? (r.isProvisional = s.Lt(null != (t = e.flags) ? t : 0, E.nhx.PROVISIONAL_ACCOUNT))
              : (r.isProvisional = !1),
        f.A.isFriend(e.id) && ((r.isFriend = !0), (r.friendNickname = f.A.getNickname(e.id))),
        e instanceof c.A
            ? (r.isStaff = e.isStaff())
            : "flags" in e
              ? (r.isStaff = s.Lt(null != (n = e.flags) ? n : 0, E.nhx.STAFF))
              : (r.isStaff = !1),
        r
    );
}
...
function I(e) {
    ...
    if (null != n.author) {
        let e = O(n.author);
        null != e && (s.push(e), null != a && A(e, a));
    }
    return (
        null == (t = n.mentions) ||
            t.forEach((e) => {
                let t = O(e);
                null != t && (s.push(t), null != a && A(t, a));
            }),
        s
    );
}
        ...
        super(...e),
                                ...
                                null == (t = e.activity_instances) ||
                                    t.forEach((t) => {
                                        t.participants.forEach((t) => {
                                            ...
                                            if (null != r) {
                                                let t = O(r.user);
                                                null != t && (A(t, e.id, r.nick), n.push(t));
                                            }
                                        });
                                    }),
                                n
                ...
                for (let e of m.default.keys(n)) {
                    ...
                    if (null != t)
                        for (let n of m.default.keys(t)) {
                            let i = r.get(n),
                                a = t[n];
                            null != i && null != a && null != a.nick && (A(i, e, a.nick), r.set(n, i));
                        }
                }
            ...
            b(this, "_handleGuildMemberUpdate", (e) => {
                let { guildId: t, user: n, nick: r } = e,
                    i = O(n);
                null != i && (A(i, t, r), this.updateUsers([i], "guild_member_update"));
            }),
            ...
            b(this, "_handleDMCreate", (e) => {
                let {
                    ...
                    n = v(u.A.getChannel(t));
                if (0 === n.length) return;
                let r = O(p.default.getCurrentUser());
                A(r, t), n.push(r), this.updateUsers(n, "dm_create");
            }),
            b(this, "_handleDMUpdates", (e) => {
                let { channels: t } = e;
                for (let e of t) {
                    let t = v(u.A.getChannel(e.id));
                    if (0 === t.length) continue;
                    let n = O(p.default.getCurrentUser());
                    A(n, e.id), t.push(n), this.updateUsers(t, "dm_updates");
                }
            }),
            b(this, "_handleRecipientChanges", (e) => {
                ...
                if (!r) return;
                let i = O(n);
                A(i, t), this.updateUsers([i], "recipient_changes");
            }),
            ...
            b(this, "_handleGuildScheduledEventUsersFetchSuccess", (e) => {
                ...
                n.forEach((e) => {
                    let { user: n, member: i } = e,
                        a = O(n);
                    null != a && (A(a, t, null == i ? void 0 : i.nick), r.push(a));
                }),
