...
for (var i in s)
    if (s.hasOwnProperty(i)) {
        ...
        delete s[i].channels,
            delete s[i].labels,
            Object.defineProperty(s[i], "channels", { value: c }),
            Object.defineProperty(s[i], "labels", { value: u });
    }
(s.rgb.hsl = function (e) {
    ...
    return (
        ...
        (r = (s + i) / 2),
        [t, 100 * (i === s ? 0 : r <= 0.5 ? c / (i + s) : c / (2 - i - s)), 100 * r]
    );
}),
        ...
        return (
            0 === l
                ...
                : ((o = l / u),
                  ...
                  (r = f(i)),
                  (a = f(c)),
                  s === u ? (n = a - r) : i === u ? (n = 1 / 3 + t - a) : c === u && (n = 2 / 3 + r - t),
                  n < 0 ? (n += 1) : n > 1 && (n -= 1)),
            [360 * n, 100 * o, 100 * u]
        );
    }),
    ...
    (s.hsl.rgb = function (e) {
        ...
        for (var u = 0; u < 3; u++)
            (a = s + -((1 / 3) * (u - 1))) < 0 && a++,
                a > 1 && a--,
                (o = 6 * a < 1 ? t + (r - t) * 6 * a : 2 * a < 1 ? r : 3 * a < 2 ? t + (r - t) * (2 / 3 - a) * 6 : t),
                (n[u] = 255 * o);
        return n;
    }),
    (s.hsl.hsv = function (e) {
        ...
        return (
            ...
            (o *= s <= 1 ? s : 2 - s),
            (t = (n + a) / 2),
            [r, 100 * (0 === n ? (2 * o) / (s + o) : (2 * a) / (n + a)), 100 * t]
        );
    }),
    ...
    (s.hsv.hsl = function (e) {
        ...
        return (
            (a = (2 - o) * s),
            (t = (2 - o) * i),
            [n, 100 * (r = (r = (o * i) / (t <= 1 ? t : 2 - t)) || 0), 100 * (a /= 2)]
        );
    }),
    ...
    (s.xyz.rgb = function (e) {
        var t,
            ...
            s = e[2] / 100;
        return (
            (t = 3.2406 * n + -1.5372 * o + -0.4986 * s),
            (r = -0.9689 * n + 1.8758 * o + 0.0415 * s),
            (a = 0.0557 * n + -0.204 * o + 1.057 * s),
    ...
    (s.rgb.ansi256 = function (e) {
        ...
        return t === r && r === a
            ...
            : 16 + 36 * Math.round((t / 255) * 5) + 6 * Math.round((r / 255) * 5) + Math.round((a / 255) * 5);
    }),
    ...
    (s.rgb.hcg = function (e) {
        ...
        return (
            ...
            [
                360 *
                    (((i <= 0 ? 0 : o === r ? ((a - n) / i) % 6 : o === a ? 2 + (n - r) / i : 4 + (r - a) / i + 4) /
                        6) %
                        1),
                100 * i,
                100 * t,
    ...
    (s.hsl.hcg = function (e) {
        var t = e[1] / 100,
            ...
            n = 0;
        return (
            (a = r < 0.5 ? 2 * t * r : 2 * t * (1 - r)) < 1 && (n = (r - 0.5 * a) / (1 - a)), [e[0], 100 * a, 100 * n]
        );
    }),
