    ...
    e &&
        ...
        i.forEach((t) => {
            ...
            !(function (t, e, n) {
                ...
                (0, l.difference)([...(null != (a = t_[e]) ? a : [])], t)
                    .filter((t) => null != t)
                    .forEach((t) => t_[e].delete(t)),
                    r.length > 0 && null == t_[e] && (t_[e] = new Set()),
                    r.forEach((t) => {
                        if ((t_[e].add(t), n)) {
                            var i, l;
...
to(th, 'displayName', 'NotificationStore'),
    new th(
        s.Z,
        __OVERLAY__
            ? {}
            : {
                  ...
                  MESSAGE_CREATE: function (t) {
                      ...
                      if (
                          ...
                          (0, U.R)(u, f.guild_id),
                          x.Z.getDesktopType() === tl.qrD.NEVER)
                      )
