...
function P(e, t) {
    ...
    if (null == w) return;
    let { canTapAnswers: Z, canRemoveVote: R, canShowVoteCounts: k, canSubmitVote: D, expirationLabel: L = O.NW.string(O.t['e+J3JS']), hasSelectedAnswer: M, hasVoted: W, isEditingVote: U, isExpired: F, isInteractive: B, reactions: G, selectedAnswerIds: H, submitting: V, tapShouldOpenVotersModal: z, showResults: K } = w,
        Y = (0, b.cZ)(G),
        X = O.NW.formatToPlainString(O.t.XRkuoa, { count: Y.toLocaleString() }),
        q = Math.max(
            ...P.map((e) => {
                var t, n;
        ...
        Q = P.map((e) => {
            ...
            return {
                ...
                votes: (0, r.EQ)(A)
                    ...
                    .otherwise(() => O.NW.formatToPlainString(O.t.XRkuoa, { count: d.toLocaleString() }))
            };
        }),
        J = (0, r.EQ)({
            isExpired: F,
        ...
        $ = (0, g.isIOS)() ? O.NW.string(O.t.PVATMz) : O.NW.string(O.t.cHfFqq),
        ee = (0, r.EQ)({
            isExpired: F,
            isInteractive: B,
            isEditingVote: U
        ...
        er = (0, r.EQ)({
            ...
            .with({ isInteractive: !1 }, () => void 0)
            .with({ isExpired: !0 }, () => void 0)
            .with({ canSelectMultipleAnswers: !0 }, () => O.NW.string(O.t.yCXvxc))
            .otherwise(() => O.NW.string(O.t['9Y2wKC']));
    return {
        question: _.question,
        promptLabel: er,
        answers: Q,
