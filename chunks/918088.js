...
function P(e, t) {
    ...
    if (null == w) return;
    let { canTapAnswers: Z, canRemoveVote: R, canShowVoteCounts: D, canSubmitVote: L, expirationLabel: M = O.intl.string(O.t['e+J3JS']), hasSelectedAnswer: k, hasVoted: U, isEditingVote: F, isExpired: B, isInteractive: G, reactions: H, selectedAnswerIds: V, submitting: z, tapShouldOpenVotersModal: W, showResults: K } = w,
        Y = (0, b.cZ)(H),
