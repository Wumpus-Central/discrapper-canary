        ...
        function () {
            if (C && o.current && n) {
                ...
                if (i) {
                    var s = t !== h || r !== p;
                    if (
                        (d.fitCanvasToArtboardHeight && s && ((o.current.style.height = r + "px"), (a = !0)),
        ...
        function () {
            if (s && e) {
                ...
                if (null == f) {
                    ...
                    (t = new i.Rive(a(a({ useOffscreenRenderer: r }, e), { canvas: s }))).on(
                        i.EventType.Load,
                        function () {
                            (n = !0), s ? _(t) : t.cleanup();
                        },
                    ...
                    function t() {
                        ...
                        if (e) {
                            ...
                            u(
                                (n =
                                    null != o
                                        ? (null == (t = e.viewModelByName) ? void 0 : t.call(e, o)) || null
                ...
                function () {
                    ...
                    if (e) {
                        ...
                        f(
                            ...
                            c && o && c.viewModelInstance !== o && c.bindViewModelInstance(o);
                    } else f(null);
                },
                [e, i, a, l, c],
            ),
