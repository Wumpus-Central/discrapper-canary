...
let L = function (e) {
    let { markAsDismissed: t, applicationName: s } = e,
        ...
        P = (0, A.h)(w);
    s = s ?? P?.name;
    let { startAuthorization: M, canStartAuthorization: x, hasAlreadyLinked: U, fetched: k } = (0, C.RD)(P),
        { analyticsLocations: G } = (0, g.Ay)(m.A.NOTICE);
    if (
        (r.useEffect(() => {
            U &&
                k &&
                (null != w && (0, N.M8)(w), (0, I.Dr)(o.M.RIOT_CONNECTION_DEPRECATION_DISABLE), t(O.i.INDIRECT_ACTION));
        }, [U, k, t, w]),
        null == P || !x || !k || U)
    )
        return null;
    ...
    return (0, i.jsxs)(_.$T, {
        ...
        children: [
            (0, i.jsx)(_.PM, {
                ...
                onClick: () => {
                    (0, I.Dr)(o.M.RIOT_CONNECTION_DEPRECATION_DISABLE), t(O.i.USER_DISMISS);
                },
            }),
            (0, i.jsx)("img", {
                src: "light" === L ? F?.icon.blackSVG : F?.icon.whiteSVG,
                alt: v.intl.string(R.default["1S6oAo"]),
                className: u()(b.tV, b._R),
            }),
            v.intl.format(R.default.DfSSdL, {
            ...
            (0, i.jsx)(_.Z_, {
                ...
                className: b.HE,
                noticeType: y.kqX.RIOT_MIGRATION,
                children: v.intl.string(R.default.ZeOhh9),
            }),
            (0, i.jsx)(_.zr, {
                onClick: () => {
                    t(O.i.USER_DISMISS);
                ...
                className: b.wX,
                children: v.intl.string(R.default["MVB/Ab"]),
            }),
        ],
    });
};
...
let B = function (e) {
    let { dismissCurrentNotice: t, subscriptionTier: n } = e,
        ...
        s = (0, U.O)(),
        a = (0, P.A)(null != s && null != s.expiresAt ? s.expiresAt.getTime() : 0);
    return null == s ||
...
function $(e) {
    ...
    switch (u) {
        ...
        case o.M.RIOT_CONNECTION_DEPRECATION:
            return (0, i.jsx)(L, { markAsDismissed: c, applicationName: v.intl.string(R.default["1S6oAo"]) });
        case o.M.RIOT_CONNECTION_DEPRECATION_ADMIN:
            return (0, i.jsx)(D.A, { markAsDismissed: () => c(O.i.USER_DISMISS) });
    }
}
