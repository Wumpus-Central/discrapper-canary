        ...
        let {
            ...
            F = l.useCallback(
                (e) => {
                    ...
                    t >= 0 &&
                        t < D.length &&
                        (null != _.current && (D[t].length > _.current ? k(t, _.current) : M()), P(t));
                },
                [m, S, D, k, M],
            ),
            G = l.useMemo(
                () =>
                    D[S].map((e, l) => {
                        ...
                        if (null == i)
                            throw Error(
                                "Too many items supplied ".concat(v.length, " expected max of ").concat(f.length),
                            );
                        let o = g(i.x, t, O),
                            s = g(i.y, n, N);
                        return (0, r.jsx)(
