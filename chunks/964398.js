...
let g = (e, t) => {
    ...
    O = l.memo(function (e) {
        let { wheelWidth: t, wheelHeight: n, itemWidth: O, itemHeight: N, showDeadZoneIndicator: y, activeItem: b, onItemSelect: x, onItemAction: E, interactive: m = !0, onClose: v, children: C } = e,
            I = l.useRef(null),
            T = l.useRef([]),
            j = l.useRef(!1),
            S = l.useRef(null),
