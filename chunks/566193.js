    ...
    stories: [
        {
            ...
            component: function (e) {
                let { selectionMode: l, removeable: a, layout: c } = e,
                    ...
                    g = a && (0, t.jsx)(s.$, { disabled: m.length === p.length, text: "Reset", onClick: v });
                return "inline" === c
                    ? (0, t.jsxs)(d.B, {
                          gap: 24,
                          children: [(0, t.jsx)("div", { style: { display: "flex", gap: 4 }, children: f }), g],
                      })
                    : (0, t.jsxs)(d.B, { gap: 24, children: [f, g] });
            },
            controls: {
                selectionMode: {
