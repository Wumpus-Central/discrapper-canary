...
function J(e) {
    ...
    let j = [
        (0, s.jsx)(
            T.Ay.Icon,
            { icon: R.P, tooltip: B.intl.string(B.t.cpT0Cq), onClick: () => V.A.closeChannelSidebar(n) },
            "close",
        ),
    ];
        ...
        children: [
            ...
            d &&
                (0, s.jsxs)("div", {
                    className: X.F,
                    children: [
                        (0, s.jsx)(A.E, { variant: "text-sm/normal", children: B.intl.string(B.t.XVOKgj) }),
                        (0, s.jsx)("div", {
                            className: X.$,
                            children: (0, s.jsx)(N.$, {
                                size: "sm",
...
var Y = n(485947),
    ...
    eA = n(572009);
function eE() {
    return (0, o.bG)([em.default], () => (0, eA.I9)(em.default.getCurrentUser()));
}
var ex = n(166643),
    eS = n(957283),
    ef = n(411976),
...
function eN(e) {
    ...
    return (0, s.jsxs)(eb.pp, {
        ...
        className: ev.y,
        children: [
            (0, s.jsx)(eb.G8, { width: 415, height: 200, lightSrc: eR, darkSrc: e_ }),
        ...
        children: (e) =>
            (0, s.jsx)(eG.vN, {
                ...
                children: (0, s.jsx)(eT.A.div, {
                    className: a()(ey.Cf, g, { [ey.vu]: h || x, [ey.CJ]: 0 === t }),
                    onContextMenu: (e) => {
                        null != c &&
                            (S(!0),
                            (0, ek.L3)(
...
let tt = l.memo(function (e) {
    let { channel: t } = e,
        ...
        { isBlocked: c, isIgnored: d } = (0, o.cf)(
            [eO.A],
            () => ({
                isBlocked: null != r && eO.A.isBlockedForMessage(r),
                isIgnored: null != r && eO.A.isIgnoredForMessage(r),
            }),
            [r],
        ),
        u = (0, o.bG)([e1.A], () => e1.A.can(e4.xBc.MANAGE_MESSAGES, t)),
        h = e6.gs.useSetting(),
        { content: m } = l.useMemo(
            () =>
    ...
    if (i)
        ...
        if (null != r && c)
            ...
            let { contentPlaceholder: e, renderedContent: t } = (0, e8.o)(r, m, c, d, a()(e5.BK, te.tZ), {
...
function ti(e) {
    let t,
        ...
        d = (0, o.bG)([eO.A], () => (null == i ? null : eO.A.getNickname(i.id))),
        u = !c && a,
        h =
            ((t = (0, eX.I)(l)),
            null ==
            (n = (function (e) {
                ...
                ? ""
                : (0, eB.aK)(n)),
        { avatarDecorationSrc: m } = (0, eV.A)({
            user: i,
            size: (0, eq.Te)(ew._3.SIZE_40),
    ...
    return (0, s.jsx)(eP, {
        ...
        onClick: function (e) {
            e.stopPropagation(),
                ...
                eu.default.track(e4.HAw.MESSAGE_REQUEST_PREVIEW_VIEWED, {
                    is_spam: !1,
                    channel_id: l.id,
                    other_user_id: i.id,
                }),
                setTimeout(() => {
                    eM._.dispatch(e4.jej.FOCUS_CHANNEL_TEXT_AREA, { channelId: l.id });
                }, 0);
        },
...
function tE() {
    ...
    (0, I.Ay)(() => {
        eu.default.track(e4.HAw.SPAM_MESSAGE_REQUESTS_VIEWED, { num_spam_message_requests: u }),
    ...
    let R = l.useCallback(
            (e) => {
                ...
                return (0, s.jsx)(
                    ...
                    {
                        index: t,
                        className: a()({ [tA.wH]: null != p && p === i, [tA.wZ]: null != p && p === l }),
                        channel: n.channel,
                        user: n.user,
        ...
        R = l.useCallback(
            (e) => {
                let { row: t } = e,
                    ...
                    l = u[t + 1]?.channel?.id,
                    i = n.channel.id,
                    r = a()({ [tS.wH]: null != I && I === i, [tS.wZ]: null != I && I === l });
                return (0, s.jsx)(
                    tc,
                    {
                        index: t,
...
function tp(e) {
    ...
    return (0, s.jsx)(_.A, {
        ...
        maxWidth: a,
        onWidthChange: n,
        children: (0, s.jsx)(J, { channel: i, baseChannelId: O.fe }),
    });
}
function tC(e) {
    let t = (0, ex.A)();
              ...
              children: (n) => {
                  let { visibleContent: l, markAsDismissed: i } = n,
                      a = {
                          ...
                          shouldShow: !0,
                          onRequestClose: () => i(tx.i.USER_DISMISS),
                            ...
                            children: [
                                ...
                                t
                                    ? (0, s.jsx)(u.A, {
                                          ...
                                          actions: [
                                              { text: B.intl.string(B.t.LNoAQW), onClick: () => i(tx.i.TAKE_ACTION) },
                                          ],
                                      })
                                    : (0, s.jsx)(u.A, {
                                          ...a,
...
let tI = (0, b.A)(function (e) {
    let { width: t } = e,
        n = (0, ef.W)();
    (0, I.Ay)(() => {
        C.I(e4.BVt.MESSAGE_REQUESTS),
            (0, ei.d0)("message-requests"),
            eu.default.track(e4.HAw.MESSAGE_REQUESTS_VIEWED, { num_message_requests: n }),
    ...
    let i = (0, o.bG)([ea.A], () => ea.A.theme),
        ...
        x = l.useRef(null);
    l.useEffect(() => {
        null != m && !A && E && g && ((0, q.iN)(m), V.A.closeChannelSidebar(O.fe));
    }, [m, E, g, A]);
    let [S, b] = l.useState(eI.zz.REQUESTS);
    function v(e) {
        b(e);
    }
    return (
        ...
        (0, s.jsxs)(s.Fragment, {
            children: [
                (0, s.jsxs)("div", {
                    className: a()(tf.TE, tS.kL, { [tf.js]: g, [tf.jl]: g && d }),
                    children: [
                        (0, s.jsx)(f.N, {
                            theme: i,
                            children: (e) =>
                        ...
                        (0, s.jsx)("div", { className: tf.Qs, children: (0, s.jsx)(tb, { section: S }) }),
                    ],
                }),
                g &&
                    (0, s.jsx)(tp, {
