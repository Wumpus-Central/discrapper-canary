...
let ej = {
        ...
        [eA.kVF.PASSKEY_BACKUP]: l.z.NAGBAR_NOTICE_PASSKEY_BACKUP,
        ...
        [eA.kVF.REPORT_TO_MOD_EXIT_SURVEY]: l.z.REPORT_TO_MOD_EXIT_SURVEY_NOTICE,
    },
...
function eX(e, t, n) {
    if (null == e) return;
    let r = eB[e];
    null == r || t || c.K.set(r, !0), eZ.has(e) && (eF[e] = !0), null != n && null != r ? ez(e, n) : eq(e);
}
function eQ(e) {
...
let eJ = [
        ...
        eA.kVF.REPORT_TO_MOD_EXIT_SURVEY,
    ],
    e$ = [
        eA.kVF.QUARANTINED,
        eA.kVF.AUTOMOD_QUARANTINED_USER_PROFILE,
    ...
    e0 = {
        ...
        [eA.kVF.PASSKEY_BACKUP]: {
            predicate: (e) => {
                let { currentUser: t } = e;
                return (null == t ? void 0 : t.mfaEnabled) && K.Z.hasFetchedCredentials() && !K.Z.hasCredentials;
            },
        },
        [eA.kVF.PREMIUM_TIER_2_TRIAL_ENDING]: {
            predicate: () => {
                let e = eE.Z.getAlmostExpiringTrialOffers([eN.Si.TIER_2]),
                    { showNagbar: t } = (0, L.xZ)("PremiumDiscountEndingNotice");
                return e.length > 0 && !eQ(eA.kVF.PREMIUM_TIER_2_TRIAL_ENDING) && t;
            },
        },
        [eA.kVF.PREMIUM_TIER_0_TRIAL_ENDING]: {
            predicate: () =>
        ...
        [eA.kVF.PREMIUM_TIER_2_DISCOUNT_ENDING]: {
            predicate: () => {
                let e = eE.Z.getAlmostExpiringDiscountOffers([eN.Si.TIER_2]),
                    { showNagbar: t } = (0, L.xZ)("PremiumDiscountEndingNotice");
                return e.length > 0 && !eQ(eA.kVF.PREMIUM_TIER_2_DISCOUNT_ENDING) && t;
            },
        },
        [eA.kVF.PREMIUM_UNCANCEL]: {
            predicate: (e) => {
                let { premiumSubscription: t, currentUser: n } = e,
                    ...
                    s =
                        ...
                        r <= 7 &&
                        r >= 0 &&
                        (0, ev.M5)(n, eN.PremiumTypes.TIER_2) &&
                        !i &&
                        !n.hasFreePremium() &&
...
function e5() {
    return ed.Z.enabled || delete eF[eA.kVF.STREAMER_MODE], e1();
}
function e6() {
    return delete eF[eA.kVF.DISPATCH_ERROR], e1();
}
function e7() {
    return delete eF[eA.kVF.DISPATCH_INSTALL_SCRIPT_PROGRESS], e1();
}
function e9() {
    return e1();
}
...
class tr extends (r = o.ZP.Store) {
    initialize() {
        this.syncWith([ef.Z, eo.Z, ee.Z, ec.Z, j.Z, eE.Z, X.Z, $.Z, W.Z, S.Z, G.Z, z.Z, O.ZP, K.Z], e1),
            this.waitFor(
                ep.default,
                eu.Z,
                en.Z,
