...
let eM = {
    ...
    eZ = { [eD.kVF.GIFTING_PROMOTION_REMINDER]: s.z.GIFTING_PROMOTION_REMINDER },
    eL = { [eD.kVF.OUTBOUND_PROMOTION]: s.z.THIRD_PARTY_OUTBOUND_PROMO_NAGBAR },
    ev = {
...
function ew(e, t, n) {
    if (null == e) return;
    let r = ev[e];
    (null == r || t || c.K.set(r, !0), ek.has(e) && (ej[e] = !0), null != n && null != r) ? c.K.set(eG(e), n.format('YYYY-MM-DDTHH:mm:ss.SSSZ')) : c.K.remove(eG(e));
}
function eB(e) {
    if (null == e) return !1;
    let t = eZ[e];
    ...
    ez = {
        [eD.kVF.GIFTING_PROMOTION_REMINDER]: {
            predicate: () => {
                ...
                return e && t && (0, T.H4)(s.z.GIFTING_PROMOTION_DESKTOP_FIRST_TIME_COACHMARK).isDismissed && !eB(eD.kVF.GIFTING_PROMOTION_REMINDER);
            }
        },
        ...
        [eD.kVF.SPOTIFY_AUTO_PAUSED]: { predicate: () => B.Z.wasAutoPaused() },
        [eD.kVF.BLOCKED_BY_PROXY]: { predicate: () => !eB(eD.kVF.BLOCKED_BY_PROXY) && F.Z.blockedByProxy && j.Z.getCurrentConfig({ location: 'notice_store' }).eligibleForNotice },
        ...
        [eD.kVF.VIDEO_UNSUPPORTED_BROWSER]: {
            predicate: (e) => {
                let { voiceChannelId: t } = e;
                return null != t && e_.Z.hasVideo(t) && !et.Z.supports(eb.AN.VIDEO) && !eB(eD.kVF.VIDEO_UNSUPPORTED_BROWSER);
            }
        },
        ...
        [eD.kVF.DETECTED_OFF_PLATFORM_PREMIUM_PERK_UPSELL]: {
            predicate: () => !eB(eD.kVF.DETECTED_OFF_PLATFORM_PREMIUM_PERK_UPSELL) && J.Z.getDetectedOffPlatformPremiumPerks().length > 0,
            metadata: () => J.Z.getDetectedOffPlatformPremiumPerks()[0]
        },
        [eD.kVF.STREAMER_MODE]: { predicate: () => ec.Z.enabled },
        [eD.kVF.DOWNLOAD_NAG]: { predicate: () => !eR.isPlatformEmbedded && !eB(eD.kVF.DOWNLOAD_NAG) },
        ...
        [eD.kVF.SERVER_USAGE_SURVEY]: {
            predicate: (e) => {
                let { selectedGuildId: t } = e;
                return null != t && P.Z.getCurrentConfig({ location: 'notice_store' }).showSurvey && !eB(eD.kVF.SERVER_USAGE_SURVEY);
            },
            metadata: (e) => {
        ...
        [eD.kVF.CONNECT_SPOTIFY]: { predicate: () => !B.Z.hasConnectedAccount() && R.ZP.isObservedAppRunning(E.Z.get(eD.ABu.SPOTIFY).name) && !eB(eD.kVF.CONNECT_SPOTIFY) },
        ...
        [eD.kVF.CONNECT_PLAYSTATION]: { predicate: () => Q.Z.isSuggestedAccountType(eD.ABu.PLAYSTATION) && null == Q.Z.getAccount(null, eD.ABu.PLAYSTATION) && !eB(eD.kVF.CONNECT_PLAYSTATION) },
        [eD.kVF.PREMIUM_TIER_2_TRIAL_ENDING]: { predicate: () => eN.Z.getAlmostExpiringTrialOffers([ey.Si.TIER_2]).length > 0 && !eB(eD.kVF.PREMIUM_TIER_2_TRIAL_ENDING) },
        [eD.kVF.PREMIUM_TIER_0_TRIAL_ENDING]: { predicate: () => eN.Z.getAlmostExpiringTrialOffers([ey.Si.TIER_0]).length > 0 && !eB(eD.kVF.PREMIUM_TIER_0_TRIAL_ENDING) },
        [eD.kVF.PREMIUM_UNCANCEL]: {
            predicate: (e) => {
                let { premiumSubscription: t, currentUser: n } = e,
                    ...
                    a = null != t && t.status === eD.O0b.CANCELED && !o && r <= 7 && r >= 0 && (0, eA.M5)(n, ey.p9.TIER_2) && !i && !n.hasFreePremium() && !t.isPurchasedExternally;
        ...
        [eD.kVF.PREMIUM_MISSING_PAYMENT]: {
            predicate: (e) => {
                ...
                return !eB(eD.kVF.PREMIUM_MISSING_PAYMENT) && E;
            },
            metadata: (e) => {
                var t;
                let { premiumSubscription: n } = e,
        ...
        [eD.kVF.PREMIUM_REACTIVATE]: { predicate: () => !eB(eD.kVF.PREMIUM_REACTIVATE) && L.Z.shouldShowReactivateNotice() },
        ...
        [eD.kVF.POMELO_ELIGIBLE]: { predicate: () => (0, U.e)() && !eB(eD.kVF.POMELO_ELIGIBLE) && !(0, b.ov)() },
        [eD.kVF.UU_MIGRATION]: { predicate: () => (0, U.e)() && !eB(eD.kVF.UU_MIGRATION) && (0, b.ov)() },
        [eD.kVF.AUTO_MODERATION_MENTION_RAID_DETECTION]: {
            predicate: (e) => {
                let { selectedGuildId: t } = e,
                    n = null != t ? ee.Z.getGuild(t) : null;
                return (null != t && null != y.Z.getMentionRaidDetected(t) && (null == n ? void 0 : n.hasFeature(eD.oNc.COMMUNITY)) && !eB(eD.kVF.AUTO_MODERATION_MENTION_RAID_DETECTION)) || !1;
            },
            metadata: (e) => {
                let { selectedGuildId: t } = e,
        ...
        [eD.kVF.ACTIVATE_SERVER_SUBSCRIPTION]: { predicate: () => !eB(eD.kVF.ACTIVATE_SERVER_SUBSCRIPTION) && 0 !== I.Z.getEligibleGuildsForNagActivate().length && (0, O.Lm)() },
        [eD.kVF.SAFETY_USER_SENTIMENT_NAGBAR]: {
            predicate: (e) => {
                let { currentUser: t } = e;
                return G.SI(t);
...
function eH() {
    ...
    if (null == r) return !1;
    let i = eT.ZP.getPremiumSubscription(),
        l = eO.Z.isLocalizedPromoEnabled,
        o = ea.Z.getGuildId(),
        a = eo.Z.getVoiceChannelId(),
        s = null != a ? e_.Z.getVoiceStateForChannel(a) : null;
    for (let n of eg.a ? eY : eW)
        if (
            null != ez[n] &&
            ez[n].predicate({
                selectedGuildId: o,
...
class eq extends (r = o.ZP.Store) {
    initialize() {
        this.syncWith([eu.Z, ei.Z, J.Z, ea.Z, k.Z, eN.Z, K.Z, Q.Z, Y.Z, D.Z, x.Z, z.Z], eH), this.waitFor(eE.default, es.Z, ee.Z, $.ZP, el.Z, et.Z, ec.Z, p.Z, ea.Z, ed.Z, B.Z, R.ZP, ei.Z, ef.Z, eP.Z, ep.Z, en.Z, eT.ZP, eC.Z, J.Z, eI.Z, er.Z, k.Z, eS.Z, eN.Z, Q.Z, h.Z, I.Z, F.Z, x.Z, z.Z);
    }
    hasNotice() {
