    ...
    ez = {
        [eD.kVF.GIFTING_PROMOTION_REMINDER]: {
            predicate: () => {
                ...
                return e && t && (0, O.H4)(s.z.GIFTING_PROMOTION_DESKTOP_FIRST_TIME_COACHMARK).isDismissed && !ew(eD.kVF.GIFTING_PROMOTION_REMINDER);
            }
        },
        ...
        [eD.kVF.VIDEO_UNSUPPORTED_BROWSER]: {
            predicate: (e) => {
                let { voiceChannelId: t } = e;
                return null != t && e_.Z.hasVideo(t) && !et.Z.supports(eU.AN.VIDEO) && !ew(eD.kVF.VIDEO_UNSUPPORTED_BROWSER);
            }
        },
        ...
        [eD.kVF.CONNECT_SPOTIFY]: { predicate: () => !W.Z.hasConnectedAccount() && R.ZP.isObservedAppRunning(d.Z.get(eD.ABu.SPOTIFY).name) && !ew(eD.kVF.CONNECT_SPOTIFY) },
        ...
        [eD.kVF.PREMIUM_MISSING_PAYMENT]: {
            predicate: (e) => {
                let { premiumSubscription: t, currentUser: n } = e,
                    ...
                    o = null != t && l()(t.currentPeriodEnd).isBefore(l()()),
                    a = eS.Z.applicationIdsFetched.has(em.CL),
                    s = eS.Z.getForApplication(em.CL),
        ...
        [eD.kVF.POMELO_ELIGIBLE]: { predicate: () => (0, b.e)() && !ew(eD.kVF.POMELO_ELIGIBLE) && !(0, U.ov)() },
        [eD.kVF.UU_MIGRATION]: { predicate: () => (0, b.e)() && !ew(eD.kVF.UU_MIGRATION) && (0, U.ov)() },
        ...
        [eD.kVF.ACTIVATE_SERVER_SUBSCRIPTION]: { predicate: () => !ew(eD.kVF.ACTIVATE_SERVER_SUBSCRIPTION) && 0 !== N.Z.getEligibleGuildsForNagActivate().length && (0, I.Lm)() },
        [eD.kVF.SAFETY_USER_SENTIMENT_NAGBAR]: {
            predicate: (e) => {
                let { currentUser: t } = e;
                return G.SI(t);
...
function eH() {
    ...
    if (null != ex) {
        (null == (n = ex.metadata) ? void 0 : n.sampleRate) != null && null == ev[ex.type] && (ev[ex.type] = Math.random() <= ex.metadata.sampleRate);
        let e = !1 === ev[ex.type];
...
class eK extends (r = o.ZP.Store) {
    ...
    getNotice() {
        return null == eE.Z.getAction() ? ex : null;
    }
    isNoticeDismissed(e) {
        return ew(e);
    }
...
let eX = new eK(u.Z, {
    ...
    NOTICE_DISMISS: function (e) {
        return null != ex && (null == e.id || e.id === ex.id) && (eG(ex.type, e.isTemporary, e.untilAtLeast), eH());
    },
