...
let eD = {
    ...
    ev = new Set([eN.kVF.NO_INPUT_DETECTED, eN.kVF.NO_INPUT_DEVICES_DETECTED, eN.kVF.STREAMER_MODE, eN.kVF.VIDEO_UNSUPPORTED_BROWSER, eN.kVF.SPOTIFY_AUTO_PAUSED, eN.kVF.DISPATCH_ERROR, eN.kVF.DISPATCH_ERROR, eN.kVF.DISPATCH_INSTALL_SCRIPT_PROGRESS, eN.kVF.BLOCKED_BY_PROXY]),
    ek = {},
    eZ = {},
    eL = Object.freeze({
        id: null,
...
function ew(e, t, n) {
    if (null == e) return;
    let r = ex[e];
    (null == r || t || c.K.set(r, !0), ev.has(e) && (ek[e] = !0), null != n && null != r) ? c.K.set(eF(e), n.format('YYYY-MM-DDTHH:mm:ss.SSSZ')) : c.K.remove(eF(e));
}
function eG(e) {
    if (null == e) return !1;
    let t = eM[e];
    ...
    eW = {
        [eN.kVF.GIFTING_PROMOTION_REMINDER]: {
            predicate: () => {
                ...
                return e && t && (0, f.H4)(s.z.GIFTING_PROMOTION_DESKTOP_FIRST_TIME_COACHMARK).isDismissed && !eG(eN.kVF.GIFTING_PROMOTION_REMINDER);
            }
        },
        [eN.kVF.GUILD_RAID_NOTIFICATION]: {
            predicate: () => (0, y.g)().show && !eG(eN.kVF.GUILD_RAID_NOTIFICATION),
        ...
        [eN.kVF.NO_INPUT_DETECTED]: { predicate: () => I.Z.hasActiveErrorOfType(h.u.NO_AUDIO_INPUT_DETECTED) },
        [eN.kVF.NO_INPUT_DEVICES_DETECTED]: { predicate: () => I.Z.hasActiveErrorOfType(h.u.NO_INPUT_DEVICES) },
        ...
        [eN.kVF.BLOCKED_BY_PROXY]: { predicate: () => !eG(eN.kVF.BLOCKED_BY_PROXY) && L.Z.blockedByProxy && Z.Z.getCurrentConfig({ location: 'notice_store' }).eligibleForNotice },
        ...
        [eN.kVF.OUTBOUND_PROMOTION]: { predicate: () => (0, v.tq)() },
        ...
        [eN.kVF.DETECTED_OFF_PLATFORM_PREMIUM_PERK]: {
            predicate: (e) => {
                let { currentUser: t } = e;
                return eI.ZP.canRedeemPremiumPerks(t) && X.Z.getDetectedOffPlatformPremiumPerks().length > 0;
            },
            metadata: () => X.Z.getDetectedOffPlatformPremiumPerks()[0]
        },
        [eN.kVF.DETECTED_OFF_PLATFORM_PREMIUM_PERK_UPSELL]: {
            predicate: () => !eG(eN.kVF.DETECTED_OFF_PLATFORM_PREMIUM_PERK_UPSELL) && X.Z.getDetectedOffPlatformPremiumPerks().length > 0,
            metadata: () => X.Z.getDetectedOffPlatformPremiumPerks()[0]
        },
        ...
        [eN.kVF.CONNECT_PLAYSTATION]: { predicate: () => Q.Z.isSuggestedAccountType(eN.ABu.PLAYSTATION) && null == Q.Z.getAccount(null, eN.ABu.PLAYSTATION) && !eG(eN.kVF.CONNECT_PLAYSTATION) },
        [eN.kVF.PREMIUM_TIER_2_TRIAL_ENDING]: { predicate: () => eS.Z.getAlmostExpiringTrialOffers([eR.Si.TIER_2]).length > 0 && !eG(eN.kVF.PREMIUM_TIER_2_TRIAL_ENDING) },
        [eN.kVF.PREMIUM_TIER_0_TRIAL_ENDING]: { predicate: () => eS.Z.getAlmostExpiringTrialOffers([eR.Si.TIER_0]).length > 0 && !eG(eN.kVF.PREMIUM_TIER_0_TRIAL_ENDING) },
        [eN.kVF.PREMIUM_UNCANCEL]: {
            predicate: (e) => {
                let { premiumSubscription: t, currentUser: n } = e,
                    ...
                    o = null != t && t.status === eN.O0b.CANCELED && !a && r <= 7 && r >= 0 && (0, eI.M5)(n, eR.p9.TIER_2) && !i && !n.hasFreePremium() && !t.isPurchasedExternally;
            ...
            metadata: (e) => {
                ...
                let { premiumSubscription: n } = e,
                    ...
                    i = null != n ? (null == (t = (0, eI.Af)(n)) ? void 0 : t.planId) : null;
                return {
                    daysLeft: r,
                    premiumType: null != i ? eI.ZP.getPremiumType(i) : null,
        ...
        [eN.kVF.PREMIUM_MISSING_PAYMENT]: {
            predicate: (e) => {
                let { premiumSubscription: t, currentUser: n } = e,
                    ...
                    a = null != t && l()(t.currentPeriodEnd).isBefore(l()()),
                    o = eO.Z.applicationIdsFetched.has(eR.CL),
                    s = eO.Z.getForApplication(eR.CL),
                    c = null != t ? (0, eI.Af)(t) : null,
                    u = null != c ? eI.ZP.getSkuIdForPlan(c.planId) : null,
                    d =
                        null != s &&
                        null != c &&
            ...
            metadata: (e) => {
                ...
                return null == t
                    ...
                    : {
                          ...
                          dismissUntil: (0, eI.lY)(t).expiresDate.toDate()
                      };
            }
        },
        ...
        [eN.kVF.AUTO_MODERATION_MENTION_RAID_DETECTION]: {
            predicate: (e) => {
                ...
                return (null != t && null != b.Z.getMentionRaidDetected(t) && (null == n ? void 0 : n.features.has(eN.oNc.COMMUNITY)) && !eG(eN.kVF.AUTO_MODERATION_MENTION_RAID_DETECTION)) || !1;
            },
            metadata: (e) => {
                let { selectedGuildId: t } = e,
        ...
        [eN.kVF.ACTIVATE_SERVER_SUBSCRIPTION]: { predicate: () => !eG(eN.kVF.ACTIVATE_SERVER_SUBSCRIPTION) && 0 !== S.Z.getEligibleGuildsForNagActivate().length && (0, p.Lm)() },
        ...
        [eN.kVF.CHECKOUT_RECOVERY_NAGBAR]: {
            predicate: (e) => {
                ...
                return M.Z.getIsTargeted() && !(0, eI.I5)(n) && 0 !== Object.keys(r).length;
            }
        },
...
function eH() {
    ...
    if (null != eU) {
        (null == (n = eU.metadata) ? void 0 : n.sampleRate) != null && null == eZ[eU.type] && (eZ[eU.type] = Math.random() <= eU.metadata.sampleRate);
        let e = !1 === eZ[eU.type];
        (eG(eU.type) || e) && (eU = null);
    }
}
function ez() {
    return (es.Z.enabled || delete ek[eN.kVF.STREAMER_MODE], eH());
}
class eY extends (r = a.ZP.Store) {
    initialize() {
        (this.syncWith([ec.Z, er.Z, X.Z, ea.Z, k.Z, eS.Z, Y.Z, Q.Z, W.Z, R.Z, U.Z, H.Z], eH), this.waitFor(ed.default, eo.Z, $.Z, J.ZP, ei.Z, ee.Z, es.Z, T.Z, ea.Z, eu.Z, V.Z, m.ZP, er.Z, eT.Z, em.Z, ef.Z, et.Z, ep.Z, eg.Z, X.Z, eE.Z, en.Z, k.Z, eO.Z, eS.Z, Q.Z, P.Z, S.Z, L.Z, U.Z, H.Z));
    }
    hasNotice() {
...
let eK = new eY(u.Z, {
    ...
    NOTICE_DISMISS: function (e) {
        return null != eU && (null == e.id || e.id === eU.id) && (ew(eU.type, e.isTemporary, e.untilAtLeast), eH());
    },
