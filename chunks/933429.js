    ...
    eH = {
        ...
        [eA.kVF.PENDING_MEMBER]: {
            predicate: (e) => {
                ...
                return null != (i = null != r && null != l && !(null == (t = $.Z.getGuild(r)) ? void 0 : t.hasFeature(eA.oNc.GUILD_ONBOARDING)) && (null == (n = Q.ZP.getMember(r, l.id)) ? void 0 : n.isPending)) && i;
            }
        },
        ...
        [eA.kVF.AUTO_MODERATION_MENTION_RAID_DETECTION]: {
            predicate: (e) => {
                ...
                return (null != t && null != P.Z.getMentionRaidDetected(t) && (null == n ? void 0 : n.hasFeature(eA.oNc.COMMUNITY)) && !eV(eA.kVF.AUTO_MODERATION_MENTION_RAID_DETECTION)) || !1;
            },
            metadata: (e) => {
                let { selectedGuildId: t } = e,
