...
let eU = {
    ...
    eZ = new Set([eg.kVF.NO_INPUT_DETECTED, eg.kVF.NO_INPUT_DEVICES_DETECTED, eg.kVF.STREAMER_MODE, eg.kVF.VIDEO_UNSUPPORTED_BROWSER, eg.kVF.SPOTIFY_AUTO_PAUSED, eg.kVF.DISPATCH_ERROR, eg.kVF.DISPATCH_ERROR, eg.kVF.DISPATCH_INSTALL_SCRIPT_PROGRESS, eg.kVF.BLOCKED_BY_PROXY]),
    ej = {},
    ek = {},
    ex = Object.freeze({
        id: null,
...
function eV(e, t, n) {
    if (null == e) return;
    let r = eL[e];
    (null == r || t || s.K.set(r, !0), eZ.has(e) && (ej[e] = !0), null != n && null != r) ? s.K.set(eG(e), n.format('YYYY-MM-DDTHH:mm:ss.SSSZ')) : s.K.remove(eG(e));
}
function ew(e) {
    if (null == e) return !1;
    let t = eM[e];
    ...
    ez = {
        [eg.kVF.GIFTING_PROMOTION_REMINDER]: {
            predicate: () => {
                ...
                return e && t && (0, p.H4)(c.z.GIFTING_PROMOTION_DESKTOP_FIRST_TIME_COACHMARK).isDismissed && !ew(eg.kVF.GIFTING_PROMOTION_REMINDER);
            }
        },
        [eg.kVF.GUILD_RAID_NOTIFICATION]: {
            predicate: () => (0, g.g)().show && !ew(eg.kVF.GUILD_RAID_NOTIFICATION),
        ...
        [eg.kVF.NO_INPUT_DETECTED]: { predicate: () => N.Z.hasActiveErrorOfType(S.u.NO_AUDIO_INPUT_DETECTED) },
        [eg.kVF.NO_INPUT_DEVICES_DETECTED]: { predicate: () => N.Z.hasActiveErrorOfType(S.u.NO_INPUT_DEVICES) },
        ...
        [eg.kVF.BLOCKED_BY_PROXY]: { predicate: () => !ew(eg.kVF.BLOCKED_BY_PROXY) && k.Z.blockedByProxy && j.Z.getCurrentConfig({ location: 'notice_store' }).eligibleForNotice },
        ...
        [eg.kVF.OUTBOUND_PROMOTION]: { predicate: () => (0, L.tq)() },
        ...
        [eg.kVF.DOWNLOAD_NAG]: { predicate: () => !eN.isPlatformEmbedded && !ew(eg.kVF.DOWNLOAD_NAG) },
        ...
        [eg.kVF.CONNECT_SPOTIFY]: { predicate: () => !w.Z.hasConnectedAccount() && A.ZP.isObservedAppRunning(_.Z.get(eg.ABu.SPOTIFY).name) && !ew(eg.kVF.CONNECT_SPOTIFY) },
        ...
        [eg.kVF.POMELO_ELIGIBLE]: { predicate: () => (0, h.e)() && !ew(eg.kVF.POMELO_ELIGIBLE) },
        ...
        [eg.kVF.ACTIVATE_SERVER_SUBSCRIPTION]: { predicate: () => !ew(eg.kVF.ACTIVATE_SERVER_SUBSCRIPTION) && 0 !== I.Z.getEligibleGuildsForNagActivate().length && (0, O.Lm)() },
        ...
        [eg.kVF.BLOCK_USER_FEEDBACK_NAGBAR]: {
            predicate: () => !ew(eg.kVF.BLOCK_USER_FEEDBACK_NAGBAR) && V.L0(),
            metadata: () => ({
...
function eH() {
    ...
    if (null == r) return !1;
    let i = eI.Z.getPremiumSubscription(),
...
function eY() {
    return (ec.Z.enabled || delete ej[eg.kVF.STREAMER_MODE], eH());
}
class eK extends (r = o.ZP.Store) {
    initialize() {
        (this.syncWith([es.Z, er.Z, J.Z, eo.Z, Z.Z, eT.Z, Y.Z, X.Z, W.Z, P.Z, x.Z, z.Z], eH), this.waitFor(ed.default, ea.Z, $.Z, Q.ZP, ei.Z, ee.Z, ec.Z, f.Z, eo.Z, eu.Z, w.Z, A.ZP, er.Z, eA.Z, em.Z, eS.Z, et.Z, eI.Z, eR.Z, J.Z, eO.Z, en.Z, Z.Z, ep.Z, eT.Z, X.Z, D.Z, I.Z, k.Z, x.Z, z.Z));
    }
    hasNotice() {
...
let eq = new eK(u.Z, {
    ...
    DISPATCH_APPLICATION_ERROR: function () {
        return (delete ej[eg.kVF.DISPATCH_ERROR], eH());
    },
    DISPATCH_APPLICATION_LAUNCH_SETUP_START: function () {
        return (delete ej[eg.kVF.DISPATCH_INSTALL_SCRIPT_PROGRESS], eH());
    },
