...
function es(e) {
    ...
    let { setCaptionEnabled: m, muted: f, volume: p, captionEnabled: C } = b.Ay.getState(),
        { enabled: E, variant: g } = q.Ig.getConfig({ location: Y.rE.VIDEO_MODAL }),
        y = null != (0, Q.tW)(t, Q.fY.VIDEO_PLAYER_CAPTION, void 0, !1);
    f &&
        E &&
        (g === q.sy.AUTO_ENABLE_CAPTIONS && y && !C
            ? m(!0)
            : g === q.sy.AUTO_UNMUTE && (b.Ay.getState().setMuted(!1), 0 === p && b.Ay.getState().setVolume(0.3)));
