...
function es(e) {
    ...
    if ((0, R.K$)(t)) return void ed(t);
    let d = (0, o.A)();
    if (!c && t.userStatus?.enrolledAt == null && !(0, V.Ic)(t)) {
        L.A.isEnrolling(t.id) ||
            (0, N.Oy)(t.id, { questContent: n, questContentCTA: O.Cy.ACCEPT_QUEST, sourceQuestContent: a });
        let e = q.Ay.getState().getVideoProgress(t.id);
        null != e &&
            e.timestampSec > 1 &&
            ((0, N.QG)(t.id),
    ...
    let { setCaptionEnabled: m, muted: f, volume: p, captionEnabled: C } = q.Ay.getState(),
        { enabled: E, variant: g } = b.Ig.getConfig({ location: Y.rE.VIDEO_MODAL }),
        y = null != (0, Q.tW)(t, Q.fY.VIDEO_PLAYER_CAPTION, void 0, !1);
    f &&
        E &&
        (g === b.sy.AUTO_ENABLE_CAPTIONS && y && !C
            ? m(!0)
            : g === b.sy.AUTO_UNMUTE && (q.Ay.getState().setMuted(!1), 0 === p && q.Ay.getState().setVolume(0.3)));
...
function el(e) {
    ...
    null != n &&
        ...
        w.A.launch(t, (t) => {
            t || (0, I.bG)({ pathname: F.BVt.QUEST_HOME, hash: e });
        });
}
function er(e) {
    let t = (function (e) {
...
function eu(e) {
    ...
    null != n &&
        ...
        w.A.launch(t, (e) => {
            e || (0, I.bG)({ pathname: F.BVt.QUEST_HOME });
        });
}
function ec(e, t) {
    (0, r.openModalLazy)(async () => {
...
function ef(e) {
    ...
    if ((0, z.vA)(e)) return e.config.features.includes(Y.Li.CLOUD_GAMING_ACTIVITY) ? (t ? void 0 : c.h) : d._;
}
function ep(e) {
    let t = (0, H.bg)(e);
    return (0, R.K$)(e)
