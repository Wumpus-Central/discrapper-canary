...
function eo(e) {
    ...
    if (!c && t.userStatus?.enrolledAt == null && !(0, R.Ic)(t)) {
        w.A.isEnrolling(t.id) ||
            (0, v.Oy)(t.id, { questContent: n, questContentCTA: P.Cy.ACCEPT_QUEST, sourceQuestContent: a });
...
function ed(e) {
    ...
    if ((0, U.vA)(e)) return e.config.features.includes(H.Li.CLOUD_GAMING_ACTIVITY) ? (t ? void 0 : c.h) : d._;
}
function em(e) {
