...
let I = (e) => {
    ...
    E = (e) => {
        ...
        if (i.type === f.s9s.YOUTUBE_VIDEO) (t = C({ url: (0, f.n8r)(i.youtubeVideoId) }, P)), (n = C({ url: ''.concat((0, f.ivE)(i.youtubeVideoId), '?').concat('rel=0&iv_load_policy=3&showinfo=0&modestbranding=1') }, S)), (r = u.pn.YOUTUBE);
        else {
