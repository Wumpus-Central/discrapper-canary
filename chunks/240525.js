...
class g extends s.A {
    ...
    saveLimit(e) {
        ...
        return (null != t && (0, c.Z)(t)) || (null != t && (a.A.getChannelId() === e || h.has(e))) ? 25 : 1;
    }
    getSaveableChannels() {
        let e = r.A.getChannelIds(null).map((e) => ({ guildId: null, channelId: e }));
        return o.A.isLowDisk ? (null != E ? [...e, E] : e) : [...e, ...h.values()];
    }
    takeSnapshot() {
        return {
            version: g.LATEST_SNAPSHOT_VERSION,
            data: { channels: [...h.allValues()].filter((e) => !e.fallback), penalized: [...p.keys()], lastChannel: E },
        };
    }
    ...
    static recordChannel(e) {
        ...
        if (null != t && (0, _.c)(t)) {
            ...
            (E = n), h.put(e, n), (0, d.qA)(t) && null != p.put(e, null) && h.delete(e);
        }
    }
