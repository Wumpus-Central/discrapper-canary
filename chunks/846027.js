...
let v = {
    ...
    { enable: y, isNotSupported: I, trackToggleSelfMute: T, trackToggleSelfDeaf: b } = (v = n(929782)),
    S = {
        enable: y,
        toggleSelfMute() {
        ...
        setInputDevice(e) {
            ...
            !I() &&
                ((null != t || null != n) &&
                    E(c.Z.getInputDevices(), c.Z.getInputDeviceId(), e, 'Audio Input', {
                        location: t,
        ...
        setOutputDevice(e) {
            ...
            !I() &&
                ((null != t || null != n) &&
                    E(c.Z.getOutputDevices(), c.Z.getOutputDeviceId(), e, 'Audio Output', {
                        location: t,
                        analyticsLocations: n
                    }),
                i.Z.dispatch({
        ...
        setVideoDevice(e) {
            ...
            !I() &&
                ((null != t || null != n) &&
                    E(c.Z.getVideoDevices(), c.Z.getVideoDeviceId(), e, 'Video', {
                        location: t,
                        analyticsLocations: n
                    }),
                i.Z.dispatch({
