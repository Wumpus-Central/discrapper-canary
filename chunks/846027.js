...
let S = {
    ...
    { enable: A, isNotSupported: C, trackToggleSelfMute: N, trackToggleSelfDeaf: R } = (S = n(929782)),
    P = {
        enable: A,
        toggleSelfMute() {
            var e;
            let {
                context: t = E.Yn.DEFAULT,
                syncRemote: n = !0,
                usedKeybind: i = !1,
                playSoundEffect: a = !0,
                location: o,
        ...
        setTemporarySelfMute(e) {
            var t;
            C() ||
                ((null == (t = _.default.getCurrentUser()) ? void 0 : t.isStaff()) &&
                    O.info("Setting temporary self mute", e),
                r.Z.dispatch({
        ...
        setActiveInputProfile(e) {
            ...
            C() ||
                ((0, s.Z)("active_input_profile", e, null != (t = d.Z.getActiveInputProfile()) ? t : void 0, n),
                r.Z.dispatch({
        ...
        setAttenuation(e, t, n) {
            C() ||
                ((() => {
                    ...
                    return r !== e
                        ? (0, s.Z)("global_attenuation_strength", e, r)
                        : i !== t
                          ? (0, s.Z)("global_attenuation_for_self_speak_enabled", t, i)
                          : a !== n && (0, s.Z)("global_attenuation_for_other_speak_enabled", n, a);
                })(),
                r.Z.dispatch({
        ...
        reset() {
            C() || r.Z.dispatch({ type: "AUDIO_RESET" });
        },
        setSilenceWarning(e) {
            C() ||
        ...
        setGoLiveSource(e) {
            (null == e ? void 0 : e.qualityOptions) != null &&
                (0, h.Ye)(e.qualityOptions.preset, e.qualityOptions.resolution, e.qualityOptions.frameRate),
                r.Z.dispatch({
