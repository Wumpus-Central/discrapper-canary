...
function y(e) {
    let { isDisabled: t, onSelect: n, size: s } = e,
        ...
        { shouldShowNewBadge: N, markNewBadgeAsDismissed: v } = (0, g.L)(),
        C = (0, p.JZ)(u.M.CUSTOM_THEME_ENTRYPOINT_GRADIENT),
        O = (0, f.Ay)(),
        R = (0, d.M)(O) ? T.Xu : T.VO,
        b = null != y && null != y.colors && y.colors.length > 0,
        D = (0, l.bG)([E.A], () => E.A.getSavedCustomTheme()),
        L = b || null != D,
        w = i.useMemo(() => {
            let e, t;
        ...
        M = L ? c.A.unsafe_rawColors.WHITE.css : void 0,
        P = i.useCallback(() => {
            N && v(), n?.();
        }, [N, v, n]);
    return (0, r.jsxs)("div", {
