n.d(t, { iV: () => oL, OC: () => ok, Ay: () => oR }), n(938796);
var i,
    l,
    s = n(627968),
    r = n(64700),
...
function ei(e) {
    let { app: t, linkType: n, activityCustomId: i, activityReferrerId: l, message: a, onView: o } = e,
        ...
        }, [h, Y, B, t.id, G, U, j, b, _, P, i, C, v, m]),
...
function nL(e) {
    let { gameId: t } = e,
        { enabled: n } = nv.A.useConfig({ location: "game_profile_embed" });
    return n ? (0, s.jsx)(nR, { gameId: t }) : null;
}
function nR(e) {
    let { gameId: t } = e,
        { gameRecord: n, isLoading: i } = (0, nS.A)({ gameId: t }),
        l = (0, ny.A)({ gameId: t, source: nN.Ob.Embed }),
        r = (0, nT.A)(n);
    ...
    return (0, s.jsxs)(eb.D, {
        ...
        children: [
            (0, s.jsxs)("div", {
                ...
                className: nb.yl,
                children: [
                    null != o && (0, s.jsx)("div", { className: nb.Tp, style: { backgroundImage: `url("${o}")` } }),
                    (0, s.jsx)("div", { className: nb.N4 }),
                ],
            }),
            null != a && (0, s.jsx)("img", { src: a, alt: "", className: nb.Kk, draggable: !1 }),
            (0, s.jsxs)("div", {
                className: nb.Qs,
                children: [
                    (0, s.jsx)(e8.D, {
...
function nV(e) {
    let { code: t, message: n } = e,
        [i, l, a] = (0, nD.yK)(
            [nw.A],
            () => [nw.A.getApplication(t), nw.A.isInvalidApplication(t), nw.A.getApplicationFetchState(t)],
            [t],
        ),
        o = (0, nD.bG)([U.A], () => U.A.getGuildId() ?? void 0),
        [d, c] = r.useState(!1),
        u = r.useCallback((e) => {
            e && c(!0);
        }, []),
    ...
    l)
        ? (0, s.jsxs)(nO.A, {
              containerRef: m,
              children: [
                  (0, s.jsx)(nO.A.Header, { text: J.intl.string(J.t.j4KtLa) }),
                  (0, s.jsx)(nO.A.Body, {
                      children: (0, s.jsxs)("div", {
                          className: nB.k,
                          children: [
                              (0, s.jsx)(nO.A.Icon, { expired: !0 }),
                              (0, s.jsx)(nO.A.Info, {
                                  expired: !0,
        ...
        : null == i || a === nw.e.FETCHING
          ? (0, s.jsxs)(nO.A, {
                containerRef: m,
                children: [
                    (0, s.jsx)(nO.A.Header, { text: J.intl.string(J.t.m9hXGR) }),
                    (0, s.jsx)(nO.A.Body, { resolving: !0 }),
                ],
            })
          : (0, s.jsx)(ei, { app: nU.Ay.createFromServer(i), linkType: et.J.APP_DISCOVERY, onView: h, message: n });
}
var nH = n(229527),
    nF = n(870136),
    nY = n(330075),
...
function n0(e) {
    let { code: t } = e,
        i = (0, u.bG)([nX.A], () => nX.A.getGuildTemplate(t));
    if (null == i || i.state === nZ.QB.RESOLVING)
        return (0, s.jsxs)(nO.A, {
            children: [
                (0, s.jsx)(nO.A.Header, { text: J.intl.string(J.t.Xj87Yf) }),
                (0, s.jsx)(nO.A.Body, { resolving: !0 }),
            ],
        });
    if (i.state === nZ.QB.EXPIRED)
        return (0, s.jsxs)(nO.A, {
            children: [
                (0, s.jsx)(nO.A.Header, { text: J.intl.string(J.t.C7ZRNw) }),
                (0, s.jsxs)(nO.A.Body, {
                    children: [
                        (0, s.jsx)(nO.A.Icon, { expired: !0 }),
                        (0, s.jsx)(nO.A.Info, { expired: !0, title: J.intl.string(J.t.A6MwXE) }),
                    ],
                }),
            ],
        });
    let l = __OVERLAY__
        ...
        : (0, s.jsx)(eg.$, {
              ...
              loading: i.state === nZ.QB.ACCEPTING,
              variant: "active",
              text: J.intl.string(J.t["a3Gl+e"]),
          });
    return (0, s.jsxs)(nO.A, {
        children: [
            (0, s.jsx)(nO.A.Header, { text: J.intl.string(J.t.kAvFkO) }),
            (0, s.jsxs)(nO.A.Body, {
                children: [
                    (0, s.jsxs)("div", {
                        className: nQ.iH,
                        children: [
                            (0, s.jsx)(nq, { className: n$.K }),
                            (0, s.jsx)(nO.A.Info, {
                                title: i.name,
...
var n1 = n(842241),
    ...
    n3 = n(155718);
let n6 = new Set([
    n2.ContentInventoryEntryType.TOP_ARTIST,
    n2.ContentInventoryEntryType.TOP_GAME,
    n2.ContentInventoryEntryType.PLAYED_GAME,
    n2.ContentInventoryEntryType.WATCHED_MEDIA,
    n2.ContentInventoryEntryType.LISTENED_SESSION,
    n2.ContentInventoryEntryType.LAUNCHED_ACTIVITY,
]);
var n5 = n(398817),
    n4 = n(857071),
    n9 = n(46054),
...
function iN(e) {
    let { embedUrl: t, message: n, channel: i } = e,
        ...
        d = (function (e, t) {
            let n = (0, iv.CI)(e),
                i = (0, nD.bG)([ig.Ay, M.default], () => {
                    let e = M.default.getId();
                    return ig.Ay.isMember(n?.guildId, e);
                }, [n]),
                l = (0, nD.bG)(
                    [ix.A],
                    () => null != n && n?.channelId != null && ix.A.isChannelGated(n.guildId, n.channelId),
                    [n],
                ),
                s = t.hasFlag(W.pr7.IS_CROSSPOST),
                {
                    ...
                    selectedGuildId: u,
                    canAccess: m,
                } = (0, nD.cf)([iC.A, tF.A, D.A, G.default, U.A], () => {
        ...
        { setPopout: c } = (0, iu.A)(n.id, i_.Fd),
        u = (0, ic.VL)(n, i, c, !0),
        m = nl.kt.useSetting(),
        h = (0, ip.j)(),
        [g, A] = r.useState(!1),
        [f, E] = r.useState(d?.coverImage == null),
        I = (0, nD.bG)([ig.Ay, G.default], () => ig.Ay.isMember(d?.guildId, G.default.getCurrentUser()?.id), [d]),
        C = (0, nD.bG)([ig.Ay], () => (d?.authorId != null ? ig.Ay.getMember(d.guildId, d.authorId) : null)),
        v = (0, ir.A)(C?.avatarDecoration != null ? C?.avatarDecoration : d?.user?.avatarDecoration),
        [_, j, N] = r.useMemo(() => [C?.colorString ?? "inherit", C?.colorStrings ?? null, C?.colorRoleId], [C]),
        T = (0, im.gn)(C?.guildId, d?.authorId ?? void 0, j),
        { reducedMotion: y } = r.useContext(ii.C),
        [S, b] = r.useState(!1),
        L = r.useCallback(() => {
            A(!0);
        }, [A]),
    ...
    let P = (0, w.F_)({ avatarDecoration: v, size: (0, ia.Te)(tI._3.SIZE_40), canAnimate: S }),
                    ...
                    !f &&
                        (!0 === d.shouldShowBlurredThumbnailImage
                            ? (0, s.jsx)("img", {
                                  ...
                                  className: o()(ij.xn, { [ij.p6]: d.shouldSpoiler }),
                                  onContextMenu: u,
                                  onError: () => E(!0),
                              })
                            : (0, s.jsx)(io.A, {
                        ...
                        (0, s.jsx)(eb.D, {
                            ...
                            children: (0, s.jsx)("div", {
                                ...
                                children: (0, s.jsxs)("div", {
                                    className: ij.BS,
                                    children: [
                                        (0, s.jsx)(iA, { color: tD.A.colors.WHITE.css }),
                                        (0, s.jsx)(p.E, {
                                            variant: "text-sm/semibold",
                                            color: "always-white",
...
let iJ = (e) => {
    let { reportingUserId: t, guildId: n, compact: i, channel: l, messageId: a, reportedTimestamp: d } = e,
        ...
        u = r.useMemo(() => (i ? (0, iH.A)((0, na.i$)(iB()(), "LT")) : null), [i]),
        m = (0, iF.P)({ user: c, channelId: l.id, guildId: n, messageId: a })((0, t_.m2)(c, l)),
        h = null != c ? c.getAvatarURL(n, (0, tI.FT)(tI._3.SIZE_16)) : iW,
        g =
            null != c
                ? J.intl.format(iY.default["+zqXZs"], { username: c.username, onUserClick: m })
                : J.intl.string(iY.default.xpRjfS);
    return (0, s.jsxs)("div", {
        className: o()(iK.NB, iK.JZ, u),
        children: [
            (0, s.jsx)(tE.eu, { src: h, size: tI._3.SIZE_16, className: iz.my, "aria-label": "" }),
            (0, s.jsx)(p.E, { variant: "text-sm/medium", color: "text-subtle", className: iz.Xh, children: g }),
            (0, s.jsxs)(p.E, {
                variant: "text-sm/medium",
                color: "text-subtle",
                children: [
                    (0, s.jsx)("span", { className: iz.Ek, children: "\u2022" }),
                    (0, s.jsx)(iV.A, { timestamp: d, className: iz.vE }),
                ],
            }),
        ],
    });
...
function iX(e) {
    let { message: t, snapshot: n, index: i } = e,
        ...
        o = r.useCallback(() => {
            let e = D.A.getChannel(t.channel_id),
                ...
                s = iG.Ay.getCurrentSidebarChannelId(t.messageReference?.channel_id),
                r = l === i && s === e?.id;
            null == e ||
                null == n ||
                r ||
                null == i ||
                (iU.A.openModReportAsSidebar({ channelId: e.id, baseChannelId: i, guildId: e.guild_id }),
                (0, iO.iN)(i),
    ...
    return null == a
        ...
        : (0, s.jsxs)(eb.D, {
              ...
              children: [
                  null != a.originIconUrl
                      ? (0, s.jsx)("img", { className: iq.yl, src: a.originIconUrl, alt: "" })
                      : null,
                  (0, s.jsx)(p.E, {
                      className: iq.PJ,
                      variant: "text-sm/medium",
...
function iZ(e) {
    let { mergedMessageRecord: t, content: n, channel: i, reportingUserId: l, reportedTimestamp: a } = e,
        o = (0, t_.m2)(t.author, i),
        {
            ...
            let { popouts: n, setPopout: i } = (0, iu.A)(e.id, i_.Fd),
                { usernameProfile: l, avatarProfile: s } = n,
                a = (0, ic.m)(e, t, l, i);
            return {
                onClickUsername: a,
                onClickAvatar: (0, ic.Jo)(s, i),
    ...
    return (0, s.jsx)(iP.A, {
        childrenExecutedCommand: (0, s.jsx)(iJ, {
            reportingUserId: l,
            guildId: i.guild_id,
            channel: i,
            messageId: t.id,
              ...
              "div",
              {
                  ...
                  children: (0, s.jsxs)("div", {
                      ...
                      children: [
                          ...
                          (0, s.jsx)(iX, { message: t, snapshot: n, index: i }),
                      ],
                  }),
              },
              i,
...
function iQ(e) {
    let { message: t } = e;
    return (0, s.jsx)(s.Fragment, {
        children: t.messageSnapshots.map((e, n) => (0, s.jsx)(i$, { message: t, snapshot: e, index: n }, n)),
    });
}
var i0 = n(302031),
    i1 = n(738188),
...
function i5(e) {
    ...
    let t = e.message.embeds[0],
        i = t.fields?.find((e) => e.rawName === i3.AT.CLASSIFICATION_ID) ?? void 0,
        l = i?.rawValue ?? void 0,
        r = t.fields?.find((e) => e.rawName === i3.AT.INCIDENT_TIMESTAMP) ?? void 0,
    ...
    return null == l || null == a
        ...
        : (0, s.jsxs)(eb.D, {
              ...
              children: [
                  (0, s.jsxs)("div", {
                      ...
                      children: [
                          (0, s.jsxs)("div", {
                              className: i6.U1,
                              children: [
                                  (0, s.jsx)(i1.i, { className: i6.QW, color: tD.A.colors.ICON_FEEDBACK_CRITICAL }),
                                  (0, s.jsx)(p.E, {
                                      variant: "text-md/semibold",
                          ...
                          (0, s.jsx)("div", {
                              ...
                              children: (0, s.jsx)(p.E, {
                                  variant: "text-xs/medium",
                                  children: J.intl.format(J.t.eevFb6, { daysAgo: iB()().diff(iB().unix(a), "days") }),
                              }),
                          }),
                          (0, s.jsx)("div", {
                              className: i6.vv,
                  ...
                  (0, s.jsx)("div", {
                      className: i6.xQ,
                      children: (0, s.jsx)(i2.Q, { text: J.intl.string(J.t.zKnzwm), variant: "secondary" }),
                  }),
              ],
          });
}
...
function le(e) {
    ...
    return (0, s.jsx)(i4.Anchor, { className: i7.zh, href: t, children: J.intl.string(J.t["8/GdRB"]) });
}
function lt(e) {
    let { ctaType: t, classificationId: n, learnMoreLink: i } = e;
    switch (t) {
        case i3.xw.POLICY_VIOLATION_DETAIL:
            if (null == n) return null;
            return (0, s.jsx)(i8, { classificationId: n });
        case i3.xw.LEARN_MORE_LINK:
            if (null == i) return null;
            return (0, s.jsx)(le, { learnMoreLink: i });
        default:
            return null;
    }
}
function ln(e) {
    let { iconType: t } = e,
        n = {
            ...
            danger: (0, s.jsx)(i1.i, { color: tD.A.colors.ICON_FEEDBACK_CRITICAL }),
        };
    return null != t && t in n ? (0, s.jsx)("div", { className: i7.Kk, children: n[t] }) : null;
}
function li(e) {
    let { children: t, theme: n } = e,
        i = { default: i7._y, danger: i7.yk };
    return (0, s.jsx)("div", { className: i[n ?? "default"], children: t });
}
function ll(e) {
    var t;
    if (null == e.embed || null == e.embed.fields) return null;
    let n = (0, i9.f4)(e.embed);
    return null == n
        ? null
        : (0, s.jsxs)(eb.D, {
              className: i7.o3,
                          ...
                          (0, s.jsx)("div", {
                              ...
                              children: (0, s.jsx)(p.E, {
                                  ...
                                  children: J.intl.format(J.t.eevFb6, {
                                      daysAgo: ((t = n.timestamp ?? 0), iB()().diff(iB().unix(t), "days")),
                                  }),
                              }),
                          }),
                          (0, s.jsx)("div", {
...
function lD(e) {
    ...
    return (0, s.jsxs)(lI.A, {
        children: [
            (0, s.jsx)(lp.A, { sticker: t, size: 48, isInteracting: !0 }),
            (0, s.jsxs)(lI.A, {
                direction: lI.A.Direction.VERTICAL,
                justify: lI.A.Justify.CENTER,
                className: lP.bM,
                children: [
                    (0, s.jsx)(p.E, { variant: "text-md/semibold", children: (0, s.jsx)(lA.A, { children: t.name }) }),
...
let lO = (e) => {
        let { closePopout: t, sticker: n, channel: i, refreshPositionKey: l } = e,
            [a, o, d] = (0, u.yK)(
                [ly.A],
                () => [ly.A.getStickerPack(n.pack_id), !ly.A.hasLoadedStickerPacks, ly.A.isPremiumPack(n.pack_id)],
                [n],
            ),
            c = ((e) => {
        ...
        o || null == a)
            ...
            : (0, s.jsxs)(lu.Uq, {
                  ...
                  children: [
                      ...
                      (0, s.jsx)("ul", {
                          className: lk.pQ,
                          children: c.map((e) => (0, s.jsx)(lp.A, { isInteracting: !0, size: 80, sticker: e }, e.id)),
                      }),
                      d &&
                          (0, s.jsx)("div", {
                              className: lk.j0,
                                      ...
                                      onClick: () => {
                                          d &&
                                              (function (e) {
                                                  ...
                                                  lb._.dispatchToLastSubscribed(W.jej.OPEN_EXPRESSION_PICKER, {
                                                      activeView: lL.kx.STICKER,
                                                  });
                                                  let i = n.findIndex((e) => e.id === t.id);
                                                  -1 !== i && lS.bM.setActiveCategoryIndex(i);
    ...
    lU = (e) => {
        let t,
            ...
            A = lT.Ay.canUseCustomStickersEverywhere(g),
            ...
            r.useEffect(() => {
                ...
                (async () => {
                    if (null == e || e.features.has(W.GuildFeatures.DISCOVERABLE)) {
                        ...
                        c(
                            await ((t = n.id),
                            lv.Bo.get({ url: W.Rsh.STICKER_GUILD_DATA(t), oldFormErrors: !0, rejectWithError: !0 })
        ...
        if (
            ...
            return (0, s.jsx)(lu.Y0, { className: lk.v0 });
        {
            let e;
            return (0, s.jsxs)(lu.Uq, {
                className: lP.Bm,
                children: [
                    ((e = async () => {
                        if (null == d || f) return;
                    ...
                    (0, s.jsxs)("div", {
                        className: lP.gH,
                        children: [
                            (0, s.jsx)(lD, { description: t, sticker: n }),
                            b &&
                                (0, s.jsx)(lN.A, {
                                    className: lP.lI,
                                    subscriptionTier: lR.pe.TIER_2,
                                    size: lx.$n.Sizes.SMALL,
                                    fullWidth: !0,
                    ...
                    (null != x || null != d) &&
                        (() => {
                            ...
                            let e = (d?.stickers ?? [])
                                    ...
                                    .filter((e) => e.id !== n.id)
                                    .slice(0, 12),
                                t = null != d ? lC.GO.createFromDiscoverableGuild(d) : lC.GO.createFromGuildRecord(x);
                            return (0, s.jsxs)("div", {
                                className: lP.tl,
                                children: [
                                    (0, s.jsx)(p.E, {
                                        ...
                                        (0, s.jsxs)(s.Fragment, {
                                            children: [
                                                (0, s.jsx)(eb.D, {
                                                    ...
                                                    className: lP.wK,
                                                    children: (0, s.jsxs)(lI.A, {
                                                        children: [
                                                            (0, s.jsx)(p.E, {
                                                                className: lP.__invalid_showMoreEmojisLabel,
                                                                variant: "text-xs/normal",
                                                                color: "none",
                                                ...
                                                E &&
                                                    (0, s.jsx)(lI.A, {
                                                        wrap: lI.A.Wrap.WRAP,
                                                        align: lI.A.Align.START,
                                                        justify: lI.A.Justify.START,
                                                        className: lP.LX,
                                                        children: e.map((e) =>
                                                            (0, s.jsx)(
                                                                la.m,
...
let lw = function (e) {
    let { renderableSticker: t, channel: n, closePopout: i, refreshPositionKey: l } = e,
        [r, a] = (0, lh.Zq)(t, !0);
    return null != r && (0, iy.FD)(r)
        ? (0, s.jsx)(lO, { sticker: r, closePopout: i, channel: n, refreshPositionKey: l })
        : null != r && (0, iy.Xw)(r)
          ? (0, s.jsx)(lU, { sticker: r, channel: n, closePopout: i, refreshPositionKey: l })
          : a
            ? null == r
                ? (0, s.jsx)(lG, { channel: n, closePopout: i, sticker: t })
                : (i(), null)
            : (0, s.jsx)(lu.Y0, {});
};
var lB = n(182497);
let lV = (0, lm.xI)(lo.A.STICKERS_CONSTANTS_STICKER_DIMENSION),
    lH = (e) => {
        let { renderableSticker: t, channel: n, isInteracting: i } = e,
            ...
            h = (0, s.jsxs)("span", {
                className: lB.Zl,
                children: [(0, s.jsx)(ld.s, { size: "xs", color: "currentColor", className: lB.lA }), (u ?? t).name],
            });
        return (0, s.jsx)(f.f5, {
            value: m,
            children: (0, s.jsx)("div", {
                className: lB.be,
                children: (0, s.jsx)(lc.Y, {
                    align: "center",
                    animation: lc.Y.Animation.TRANSLATE,
                    positionKey: d,
                    onRequestClose: () => {
                        o(!0);
                    },
                    ...
                    children: (e) => {
                        ...
                        return (0, s.jsx)(la.m, {
                            ...lu.Uk,
                            shouldShow: a,
                            __unsupportedReactNodeAsText: (0, lu.yR)(h),
                            "aria-label": !1,
                            onTooltipShow: () => {
                                var e;
                                null != (e = u) &&
                                    tG.Ay.trackWithMetadata(W.HAw.EXPRESSION_TOOLTIP_VIEWED, {
                                        type: lR.e.STICKER_IN_MESSAGE_HOVER,
                                        expression_id: e.id,
                                        expression_name: e.name,
                                        is_animated: (0, lg.Tw)(e.format_type),
                                        is_custom: (0, lg.zN)(e.type),
                                    });
                            },
                            children: (0, s.jsx)(eb.D, {
                                ...
                                tag: "span",
                                children: (0, s.jsx)(lp.A, { isInteracting: i, size: lV, sticker: u ?? t }),
                            }),
                        });
                    },
                }),
...
function l3(e) {
    ...
    (0, l$.Eq)(a, "ThreadMessageAccessoryMessage");
    let o = r.useMemo(
        () =>
            null != t.content && "" !== t.content
                ? (0, lQ.Ay)(t, { formatInline: !0, allowLinks: !0, allowGameMentions: !0 }).content
                : null,
        [t],
    );
    return (0, s.jsxs)("div", {
        className: iK.up,
        children: [
            (0, s.jsx)("img", { alt: "", src: t.author.getAvatarURL(n.guild_id, 16), className: iK.FJ }),
            (0, s.jsx)(l1.A, { message: t, channel: n, compact: !0 }),
            (0, s.jsx)("div", {
                className: iK.Au,
                children: (function (e, t, n, i) {
                    let {
                        ...
                        leadingIcon: a,
                        trailingIcon: o,
                    } = (0, l0.o)(e, t, n, i, iK.tP, {
                        trailingIconClass: iK._v,
                        leadingIconClass: iK.a5,
                        iconSize: l2.eJ,
                    });
                    return (0, s.jsxs)(s.Fragment, {
                        children: [a, r ?? (0, s.jsx)("span", { className: iK.dp, children: l }), o],
                    });
                })(t, o, i, l),
            }),
        ],
...
function l9(e) {
    let { message: t, compact: n } = e,
        i = (0, u.bG)([D.A], () => D.A.getChannel(lJ.default.castMessageIdAsChannelId(t.id)));
    return null == i ? null : (0, s.jsx)(l7, { channel: i, compact: n, isSystemMessage: (0, lW.A)(t) });
}
function l7(e) {
    var t;
    let i,
        ...
        m = (0, nr.Ay)(a),
        h = (0, u.bG)([lX.A], () => lX.A.getCount(a.id)),
        g =
            ((t = a),
            (i = (0, u.bG)([lX.A], () => lX.A.getMostRecentMessage(t.id))),
            (l = (0, u.bG)([lX.A], () => lX.A.getCount(t.id))),
            (r = (0, lZ.JO)(t)),
                  ...
                  : null == i
                    ? (0, s.jsxs)(s.Fragment, {
                          children: [
                              ...
                              (0, s.jsx)("span", { className: l4.vE, children: (0, lZ.aK)(r) }),
                          ],
                      })
                    : (0, s.jsxs)(s.Fragment, {
                          children: [
                              (0, s.jsx)(l3, { message: i, channel: t }),
                              (0, s.jsx)("span", { className: l4.vE, children: (0, lZ.aK)(r) }),
                          ],
                      })),
        A = null != h && h > 0;
    return (0, s.jsxs)(s.Fragment, {
        children: [
            (0, s.jsx)("div", { className: o()(l4.GI, { [l4.E]: !d, [l4.E_]: c }) }),
            (0, s.jsx)(eb.D, {
                onClick: function (e) {
                    e.stopPropagation(), (0, l6.JA)(a, e.shiftKey);
                },
                onKeyDown: function (e) {
                    e.stopPropagation();
                    let t = !e.altKey && !e.ctrlKey && !e.metaKey && !e.shiftKey,
                        n = e.shiftKey && !(e.altKey || e.ctrlKey || e.metaKey);
                    (e.key === l5.dh.SPACE || e.key === l5.dh.ENTER) &&
                        (e.preventDefault(), (t || n) && (0, l6.JA)(a, n));
                },
                ...
                className: o()(l4.kL, { [l4.og]: c }),
                children: (0, s.jsxs)(lY.R, {
                    children: [
                        (0, s.jsxs)("div", {
                            className: l4.kq,
                            children: [
                                (0, s.jsx)(lz.A, { children: J.intl.string(J.t["7Xm5QI"]) }),
                                (0, s.jsx)(p.E, {
                                    variant: "text-sm/semibold",
                                    color: "text-strong",
                                    tag: "span",
    ...
    let { guild: t, channel: n, message: i } = e,
        ...
        o = r.useCallback(() => {
            eG.default.track(W.HAw.CHANNEL_LINK_PREVIEW_JOINED, {
                ...
                (0, su.i)(t.id, n.id),
                sc.default.selectVoiceChannel(n.id);
        }, [i, t, n, l, a]),
        d = (0, s.jsx)(nO.A.Channel, { channel: n });
    return (0, s.jsx)(nO.A, {
        children: (0, s.jsxs)(nO.A.Body, {
            children: [
                (0, s.jsxs)("div", {
                    className: nQ.iH,
                    children: [
                        (0, s.jsx)(nO.A.Icon, { guild: t }),
                        (0, s.jsx)(nO.A.Info, {
                            title: d,
                            onClick: o,
                            children: (0, s.jsxs)("span", {
                                ...
                                children: [
                                    ...
                                    (0, s.jsx)("span", {
                                        className: nQ.E3,
                                        children: (0, s.jsx)(sm.A, { guild: t, isBannerVisible: !1 }),
                                    }),
                                ],
                            }),
                        }),
...
function sg(e) {
    ...
    return null != r && r.isGuildVocal() && null != a && tl.A.can(W.xBc.VIEW_CHANNEL, r) && tl.A.can(W.xBc.CONNECT, r)
        ? (0, s.jsx)(sh, { guild: a, channel: r, message: n })
        : null;
}
var sp = n(789645),
    sA = n(298236),
...
function sC(e) {
    ...
    return 0 === t.length
        ...
        : (0, s.jsx)(sf.N, {
              ...
              shouldHideMediaOptions: a,
              enabledContentHarmTypeFlags: d,
              children: (0, s.jsx)(sA.f5, {
                  message: n,
                  shouldDisableInteractiveComponents: !0,
                  children: (0, s.jsx)(sx.O7.Root, {
                      containerInnerWidth: h,
                      children: (0, s.jsx)("div", {
                          style: { width: "100%" },
                          ref: m,
                          children: (0, s.jsx)(sx.O7.AutoMeasuredNestedContainer, {
                              children: (e) =>
                                  (0, s.jsxs)("div", {
                                      ref: e,
                                      "aria-hidden": u,
                                      className: o()(sE.O0, sI.k, sI.z, { [sE.dK]: u }),
                                      children: [
                                          null != c &&
                                              (0, s.jsx)(eb.D, {
                                                  ...
                                                  children: (0, s.jsx)(sp.P, { size: "xs", color: "currentColor" }),
                                              }),
                                          (0, n5.fD)(t),
                                      ],
                                  }),
...
let sO = r.memo((e) => {
    let { start: t } = e,
        [n, i] = r.useState(0),
        l = (0, ip.j)(),
        s = (0, u.bG)([sN.Ay], () => sN.Ay.useReducedMotion),
        a = !1 === l || s;
    return (
        r.useEffect(() => {
            let e = new sv.IX();
            return (
                e.start(a ? 15 * sn.A.Millis.SECOND : sn.A.Millis.SECOND, () => {
                    i((new Date().getTime() - t) / sn.A.Millis.SECOND);
                }),
                () => e.stop()
            );
        }, [a, t]),
...
sO.displayName = "ActivityRuntimeCounter";
let sU = r.memo(function (e) {
    let t,
        ...
        _ = (0, u.bG)([sR.A], () => {
            ...
            for (let e of C) {
                let t = sR.A.findActivity(e, (e) => e.application_id === n.id);
                if (null != t) return t;
            }
            return null;
        }, [n.id, C]),
        ...
        N = r.useMemo(() => {
            let e = new nU.Ay(n);
            return null == e.embeddedActivityConfig && (e.embeddedActivityConfig = sM.Gl), e;
        }, [n]),
        T = (0, sS.vG)({ userId: g, channelId: i, application: N }),
        y = null == A,
        S = (function (e) {
            ...
            return r.useMemo(
                () =>
                    (function (e) {
                        ...
                        if (null != n && n !== sS.Gy.CAN_JOIN) {
                            let e;
                            switch (n) {
                                case sS.Gy.NO_USE_EMBEDDED_ACTIVITIES_PERMISSION:
                                    e = J.intl.string(J.t.hHGrWz);
                                    break;
                                case sS.Gy.ACTIVITY_AGE_GATED:
                                    e = J.intl.string(J.t["4WuFRE"]);
                                    break;
                                case sS.Gy.ACTIVITIES_FEATURE_NOT_ENABLED_FOR_OS:
                                    e = J.intl.string(J.t.uGDCcw);
                                    break;
                                case sS.Gy.ACTIVITY_NOT_SUPPORTED_ON_OS:
                                    e = J.intl.string(J.t.UXoQTp);
                                    break;
                                case sS.Gy.CHANNEL_FULL:
                                    e = J.intl.string(J.t.rZfiNq);
                                    break;
                                case sS.Gy.NO_CHANNEL_CONNECT_PERMISSION:
                                    e = J.intl.string(J.t.w5SAps);
                                    break;
                                case sS.Gy.NO_CHANNEL:
                                case sS.Gy.NO_GUILD:
                                case sS.Gy.NO_USER:
                                case sS.Gy.IS_AFK_CHANNEL:
            ...
            eG.default.track(W.HAw.ACTIVITY_INSTANCE_EMBED_CLICKED, {
                ...
                y
                    ? await (0, sy.A)({
                          ...
                          componentId: b,
                          commandOrigin: sb.iw.ACTIVITY_INSTANCE_EMBED,
                      })
                    : await (0, sT.A)({
                                          ...
                                          (0, s.jsxs)("div", {
                                              ...
                                              children: [
                                                  ...
                                                  (0, s.jsx)(p.E, {
                                                      variant: "text-xs/medium",
                                                      color: "none",
                                                      children: (0, s.jsx)(sO, { start: B }),
                                                  }),
                                              ],
                                          }),
                                      (0, s.jsxs)("div", {
                                          className: o()(sD.DT, sD.PK),
                                          children: [
                                              (0, s.jsx)("div", {
                                                  children: (0, s.jsx)(s_.u, { size: "xxs", color: "currentColor" }),
                                              }),
                                              (0, s.jsx)(p.E, {
                                                  variant: "text-xs/medium",
                                                  color: "none",
...
function ri(e) {
    let {
        ...
        A = (0, u.bG)([s2.A], () => s2.A.getActiveLibraryApplication(t.id)),
        x = null != A ? A.sku.id : null,
        f = null != x ? x : t.primarySkuId,
        E = (0, u.bG)([eO.A], () => null != f && !eO.A.didFetchingSkuFail(f));
    return null != A && (0, re.XZ)(A)
        ? (0, s.jsx)(rn.A, { ...p, playButtonVariant: l, libraryApplication: A, source: m })
        : E
          ? (0, s.jsx)("div", { children: "deprecated!" })
          : (0, s.jsx)(rt.A, { ...p, variant: l, hideNotLaunchable: a, applicationId: t.id });
}
var rl = n(580630);
function rs(e) {
    ...
    if (null != i)
        if (i.amount > 0) return (0, rl.$g)(i.amount, i.currency);
        else return J.intl.string(J.t.QQsaCc);
    return J.intl.string(J.t.RWouSQ);
}
var rr = n(235583),
    ra =
        (((l = ra || {})[(l.DIRECTORY_HERO = 1)] = "DIRECTORY_HERO"),
...
function ro(e) {
    ...
    return (0, s.jsxs)("div", {
        className: o()(rr.nM, t),
        children: [
            (0, s.jsx)(sB._, { size: "md", color: "currentColor", className: rr.Kk }),
...
function rd(e) {
    ...
    return (0, s.jsxs)("div", {
        className: o()(rr.nM, n),
        children: [(0, s.jsx)(tf.t, { size: "md", color: "currentColor", className: rr.Kk }), rs(t)],
    });
}
function rc(e) {
    let { sku: t, className: n } = e;
    return (0, s.jsx)("div", { className: o()(rr.EQ, n), children: t.getDisplaySalePercentage() });
}
function ru(e) {
    let { sku: t, className: n } = e;
    return (0, s.jsx)("div", { className: o()(rr.I8, n), children: rs(t, !1) });
}
function rm(e) {
    let { sku: t, className: n } = e;
    return (0, s.jsx)("div", { className: n, children: rs(t) });
}
function rh(e) {
    let { sku: t, className: n } = e;
    return (0, s.jsxs)("div", {
        className: o()(rr.nM, n),
        children: [(0, s.jsx)(rc, { sku: t }), (0, s.jsx)(ru, { sku: t }), (0, s.jsx)(rm, { sku: t })],
    });
}
function rg(e) {
    let { className: t } = e;
...
class rp extends r.PureComponent {
    ...
    renderGeneric(e, t) {
        ...
        switch (e) {
            case 5:
                return (0, s.jsx)(rg, { className: o()(t, n) });
            case 1:
                return (0, s.jsx)(ro, { className: o()(t, n) });
            case 3:
                return (0, s.jsx)(rd, { sku: i, className: o()(t, n) });
            case 2:
                return (0, s.jsx)(rh, { sku: i, className: o()(t, n) });
            default:
                return (0, s.jsx)(rm, { className: o()(t, n), sku: i });
        }
    }
    renderDirectoryHero(e) {
        ...
        switch (e) {
            case 5:
                return (0, s.jsx)(rg, { className: t });
            case 3:
                return (0, s.jsx)(rd, { sku: n, className: o()(rr.OB, t) });
            case 2:
                return (0, s.jsx)(rh, { sku: n, className: o()(rr.dk, t) });
            default:
                return (0, s.jsx)(rm, { className: o()(rr.dk, t), sku: n });
        }
    }
    renderListing(e) {
        let t,
            ...
            case 2:
                t = (0, s.jsxs)(r.Fragment, {
                    children: [
                        (0, s.jsxs)("div", {
                            className: rr.nM,
                            children: [(0, s.jsx)(rm, { sku: i }), (0, s.jsx)(rc, { sku: i })],
                        }),
                        (0, s.jsx)(ru, { sku: i }),
                    ],
                });
        ...
        return (0, s.jsx)("div", { className: o()(rr.IH, n), children: t });
    }
    render() {
        let e = this.getState();
        ...
        switch (this.props.type) {
            ...
            case 2:
                return this.renderGeneric(e, rr.Pl);
            case 3:
                return this.renderGeneric(e, rr.jh);
            case 4:
                return this.renderListing(e);
            case 5:
                return this.renderGeneric(e, rr.bk);
            default:
...
function rf(e) {
    ...
    let l = i.icon;
    return (0, s.jsx)(la.m, { text: i.getLabel(), children: (0, s.jsx)(l, { className: n }) });
}
function rE(e) {
    let { systems: t, className: n, iconClassName: i } = e;
    return (0, s.jsx)("div", {
        className: o()(rA.I, n),
        children: t.map((e) => (0, s.jsx)(rf, { operatingSystem: e, className: o()(rA.A, i) }, e)),
    });
}
var rI = n(924750);
let rC = function (e) {
    ...
    return (0, s.jsx)("div", {
        className: o()(rI.T, t),
        children: (0, s.jsx)("span", { className: rI.Q, children: J.intl.string(J.t["14lP0W"]) }),
    });
};
var rv = n(619329);
let r_ = function (e) {
    ...
    return (0, s.jsx)("div", {
        className: o()(rv.T, t),
        children: (0, s.jsx)("span", { className: rv.Q, children: J.intl.string(J.t["8IfYqa"]) }),
    });
};
var rj = n(615300),
    rN = n(868285),
...
class rR extends r.Component {
    _animatedValue = new rj.A.Value(1);
    state = { imageLoadError: !1, imageLoading: !0 };
    componentWillEnter = (e) => {
        this._animatedValue.setValue(0), rj.A.timing(this._animatedValue, { toValue: 1, duration: 400 }).start(e);
    };
    componentWillLeave = (e) => {
        rj.A.timing(this._animatedValue, { toValue: 0, duration: 400 }).start(e);
    };
    ...
    renderMedia() {
        ...
        return (0, s.jsx)(rj.A.img, {
            className: o()({ [rL.YC]: i }, t),
            src: e,
            alt: n,
    ...
    render() {
        ...
        return null == n || i
            ? (0, s.jsx)(rj.A.div, { className: o()(rL.gn, e), style: this.getImageStyle(), children: t })
            : (0, s.jsxs)(rj.A.div, {
                  className: o()(l ? rL.g4 : null, e),
                  style: this.getImageStyle(),
                  children: [
                      l
                          ? (0, s.jsx)(tO.y, {
...
class rk extends r.Component {
    ...
    renderTypeVideo = () => {
        ...
        return (0, s.jsxs)(r.Fragment, {
            children: [
                ...
                (0, s.jsx)(rN.F, {
                    children: l && e ? null : (0, s.jsx)(rR, { className: o()(rL.NB, c), src: n, title: i }, 0),
                }),
                (0, s.jsx)(eb.D, {
                    className: o()(rL.b4, { [rL.HY]: l && e, [rL.Hy]: null != u }),
                    onClick: this.handleToggleMute,
                    children: l && e ? (0, s.jsx)(m, { className: rL.i2 }) : null,
                }),
            ],
        });
    };
    ...
    renderSlideItem = (e) => {
        ...
        return i
            ? (0, s.jsx)(rR, { className: o()(rL.Yi, l), src: e[r], title: n }, r)
            : (0, s.jsx)(rR, { className: o()(rL.Yi, l), src: t, title: n }, "image");
    };
    renderTypeImage() {
        let { playing: e, slideImages: t, image: n, title: i, splashClassName: l } = this.props;
        return null == t
            ? (0, s.jsx)(rR, { className: o()(rL.Yi, l), src: n, title: i }, "image")
            : (0, s.jsx)(rS.A, {
                  onInterval: this.nextItem,
                  interval: 2e3,
                  className: rL.mZ,
                  disable: !e,
                  children: (0, s.jsx)(rN.F, { children: this.renderSlideItem(t) }),
              });
    }
    render() {
        ...
        return n
            ...
            : (0, s.jsxs)("figure", {
                  className: o()(rL.__invalid_tileMedia, t),
    ...
    renderActions = () => {
        ...
        return null != n
            ...
            : (0, s.jsxs)("div", {
                  ...
                  children: [
                      (0, s.jsx)(rp, {
                          type: rp.Types.DIRECTORY_TILE,
                          sku: t,
                          inLibrary: e,
                          className: r && i ? rO.ae : rO.Ek,
                      }),
                      (0, s.jsx)(rE, { systems: [W.uje.WINDOWS], className: rO.iD }),
    ...
    renderMedia = () => {
        ...
        return (0, sZ.bF)(l)
            ...
            : (0, s.jsxs)(r.Fragment, {
                  children: [
                      (0, s.jsx)(rk, {
                          className: o()(rO.H1, { [rO.ZC]: a }),
                          video: null != d.previewVideo ? (0, rM.YE)(l.applicationId, d.previewVideo) : void 0,
                          image: null != d.thumbnail ? (0, rM.YE)(l.applicationId, d.thumbnail, 600) : void 0,
                          title: l.name,
                          playing: e,
                          muted: t,
                          placeholder: n,
                      ...
                      l.exclusive
                          ? (0, s.jsx)(r_, { className: o()(rO.LJ, { [rO.V9]: e }) })
                          : l.isTheGameAwardsWinner
                            ? (0, s.jsx)(rC, { className: o()(rO.LJ, { [rO.V9]: e }) })
                            : null,
                  ],
              });
    };
...
class rB extends r.Component {
    ...
    renderViewInStoreButton() {
        return (0, s.jsx)("div", {
            ...
            children: (0, s.jsx)(eg.$, {
                ...
                onClick: () => {
                    (0, sX.pX)(W.BVt.APPLICATION_STORE);
                },
            }),
        });
    }
    ...
    renderActions = (e) => {
        ...
        if (null != r) return (0, s.jsx)("div", { className: rw.i, children: r() });
        if (null == n) return null;
        ...
        return (0, s.jsxs)("div", {
            ...
            children: [
                ...
                (t && !o) || e.premium ? null : (0, s.jsx)(rp, { type: rp.Types.EMBED, sku: e, inLibrary: !1 }),
            ],
        });
    };
    render() {
        ...
        return null == e || null == t
            ? i
                ? l()
                : (0, s.jsx)(sV.Wb, { isHorizontal: r })
            : e.productLine === W.EZt.COLLECTIBLES
              ? (0, s.jsx)(s8.A, { section: W.JJy.APPLICATION_EMBED, children: this.renderApplicationTile(e, t) })
              : (0, s.jsx)(s8.A, {
                    section: W.JJy.APPLICATION_EMBED,
                    children: (0, s.jsx)(s7.N_, {
...
let rV = [eO.A, s2.A, eU.A];
function rH(e) {
    let { skuId: t } = e,
        n = eO.A.get(t),
        i = null != n ? rG.A.getApplication(n.applicationId) : null;
    return {
        sku: n,
        application: i,
        fetchFailed: eO.A.didFetchingSkuFail(t),
        inLibrary: null != n && s2.A.hasApplication(n.applicationId, n.applicationId, !0),
        storeListing: null != n ? eU.A.getForSKU(n.id) : null,
        libraryApplication: null != n ? s2.A.getLibraryApplication(n.applicationId, n.applicationId, !0) : null,
    };
}
let rF = (0, sF.A)((0, sH.A)(rB)),
    rY = u.Ay.connectStores(rV, rH)(rF),
    rz = (0, sH.A)(u.Ay.connectStores(rV, rH)(rB));
var rK = n(724459);
function rW(e) {
    ...
    return (0, s.jsxs)(eb.D, {
        ...
        onClick: t,
        children: [
            (0, s.jsx)(sB._, { size: "md", color: "currentColor", className: rK.dy }),
...
class rJ extends r.PureComponent {
    ...
    handleViewInventory() {
        (0, s0.openUserSettings)(sQ.X.GIFT_PANEL);
    }
...
class rq extends r.Component {
    ...
    handleViewLibrary = (e) => {
        ...
        e.preventDefault(),
            null != t && t.isHidden()
                ? (0, sX.pX)(W.BVt.APPLICATION_LIBRARY_SETTINGS)
                : (0, sX.pX)(W.BVt.APPLICATION_LIBRARY, { state: { applicationId: null != t ? t.id : void 0 } });
    };
    handleVerificationClick = (e) => {
        e.stopPropagation(), e.preventDefault(), (0, s0.openUserSettings)(sQ.X.ACCOUNT_PANEL);
    };
    handleAccept = (e) => {
        ...
        (0, sW.h)({ processedCode: n, channelContext: t, customGiftMessage: r, giftInfo: s });
    };
    handleLaunchGame = (e) => {
        ...
        null != t &&
            ...
            s6.A.launchGame(t.id));
    };
    handleEmbedClick = (e) => {
        let { giftCode: t, sku: n, skuApplication: i } = this.props;
        null != n && (0, sZ.bF)(n) && null != i && null != i.guildId
            ? (e.preventDefault(),
              (0, s$.R)({
                  skuId: n.id,
                  applicationId: i.id,
            ...
            : null != t && t.isSubscription && (e.preventDefault(), (0, s0.openUserSettings)(sQ.X.NITRO_PANEL));
    };
                ...
                (0, s.jsxs)(lI.A, {
                    children: [
                        ...
                        null == t || e.isSubscription
                            ? null
                            : (0, s.jsx)(rW, { onClick: this.handleViewLibrary, libraryApplication: t }),
                    ],
                }),
                (0, s.jsxs)(lI.A, {
                    align: lI.A.Align.END,
                    justify: lI.A.Justify.END,
                    className: rK.yu,
                    direction: lI.A.Direction.VERTICAL,
                    children: [
                        ...
                        e.redeemed || e.isClaimed || null != t || null == e.expiresAt
                            ? null
                            : (0, s.jsx)("div", {
                                  children: J.intl.format(J.t.nZBvUR, { hours: e.expiresAt.diff(iB()(), "h") }),
                              }),
                    ],
                }),
            ],
    ...
    renderButton(e) {
        ...
        let r =
                ...
                (e.isExistingPremiumSubscriptionDisallowed && (0, lT.TW)(n)),
        ...
        return (0, s.jsx)("div", {
            className: (0, sz.hU)(e) ? rK.UQ : void 0,
            children: (0, s.jsx)(eg.$, {
                variant: "primary",
                size: "sm",
                text: o,
    ...
    renderTitle(e) {
        ...
        return this.isCustomGiftMessage() && !n
            ? J.intl.formatToPlainString(J.t.t1SOId, { recipientDisplayName: s9.Ay.getName(t) })
            : null == i
              ? null
              : e.isSubscription
                ? n
    ...
    renderBody(e) {
        ...
        if (!n && this.isCustomGiftMessage() && !e.redeemed) return (0, sZ.bF)(i) ? this.props.content : void 0;
        let a = i.isPreorder() ? J.intl.formatToPlainString(J.t.evinTd, { name: i.name }) : i.name;
        if (e.redeemed)
            return e.isSubscription || (0, sz.hU)(e) || (0, sZ.bF)(i)
        ...
        if (e.hasMultipleCopies)
            return null != l
                ? e.isSubscription
                    ? J.intl.format(J.t.l3VxgG, { username: s9.Ay.getUserTag(l), maxUses: e.maxUses, skuName: a })
                    : J.intl.format(J.t["9cYrw5"], {
                          username: s9.Ay.getUserTag(l),
        ...
        if (e.isSubscription) {
            ...
            if (null != l) {
                let e = s.interval === lR.WT.MONTH ? J.t["/RDIEA"] : J.t["3CX6Ev"];
                return J.intl.format(e, { username: s9.Ay.getUserTag(l), skuName: a, intervalCount: s.intervalCount });
            }
            let e = s.interval === lR.WT.MONTH ? J.t["2O4lo5"] : J.t["+XjmsR"];
            return J.intl.format(e, { skuName: a, intervalCount: s.intervalCount });
        }
        return null != l ? J.intl.format(J.t["3HsdQ/"], { username: s9.Ay.getUserTag(l) }) : J.intl.string(J.t.Jdnjjj);
    }
    renderCustomGiftBox = (e) => {
        let { width: t } = this.props;
        if (null == e || null == e.giftStyle) return null;
        let n = lR.Wx.includes(e.giftStyle),
            i = o()(rK.gB, { [rK.El]: n, [rK.by]: t >= sV.Tm }),
            l = o()({ [rK.gc]: n, [rK.Ei]: n && t >= sV.Tm, [rK.ww]: !n, [rK.wy]: !n && t >= sV.Tm });
        return (0, s.jsxs)("div", {
            className: i,
            children: [
                n && (0, s.jsx)(s3, { className: rK.nr }),
                null != e.giftStyle &&
                    (0, s.jsx)(sJ.A, {
                        defaultAnimationState: e.redeemed ? sK.oA.LOOP : sK.oA.IDLE,
    ...
    renderEmbed() {
        ...
        if (null == e) return null;
        let i = null != e.giftStyle && !(0, sZ.bF)(n);
        return (0, s.jsx)(rz, {
            skuId: e.skuId,
    ...
    render() {
        ...
        if (null == e || e.revoked)
            if (t) return (0, s.jsx)(rJ, { isSelfGift: l, width: i, resolveErrorCode: n });
            else return (0, s.jsx)(sV.Wb, { isHorizontal: i >= sV.Tm });
        return (0, sz.hU)(e)
            ? (0, s.jsx)("div", { className: rK.mp, children: this.renderEmbed() })
            : this.renderEmbed();
    }
}
let rX = (0, sF.A)((0, sH.A)(rq)),
    rZ = function (e) {
        let { code: t, author: n } = e,
            {
                ...
                let e = s1.A.getError(t);
                return { giftCode: s1.A.get(t), resolved: s1.A.getIsResolved(t), resolveErrorCode: e?.code ?? null };
            }),
            a = (0, u.bG)([G.default], () => (null != i && null != i.userId ? G.default.getUser(i.userId) : null)),
            o = (0, u.bG)([eO.A], () => (null != i ? eO.A.get(i.skuId) : null)),
            d = (0, u.bG)([s2.A], () =>
                null != o && i?.entitlementBranches != null ? s5.YI(i.entitlementBranches, o, s2.A) : null,
            ),
            c = (0, sY.h)(o?.applicationId),
            m = null != o && (0, sZ.bF)(o) && i?.redeemed === !0,
            [h] = (0, sq.L)(m ? c?.id : null),
            g = (0, s4.zz)(i?.subscriptionPlanId),
...
function r7(e) {
    ...
    return r9.getCurrentConfig({ guildId: t, location: n });
}
function r8() {
    return (0, s.jsxs)(nO.A, {
        children: [
            (0, s.jsx)(nO.A.Header, { text: J.intl.string(J.t["N/g9Z4"]) }),
            (0, s.jsx)(nO.A.Body, { resolving: !0 }),
        ],
    });
}
...
function an(e) {
    ...
    return (
        ...
        (0, s.jsx)("div", { className: at.rc, children: l })
    );
}
function ai(e) {
    ...
    if (null != t && null != n) {
        let e = (0, t5.gU)(t, n);
        return (0, s.jsxs)("div", {
            className: o()(at.Ix, { [at.v6]: i }),
            children: [
                null != e ? (0, s.jsx)(e, { className: at.p, size: "xs", color: "currentColor" }) : null,
                (0, s.jsx)(lA.A, {
                    children: (0, s.jsx)(p.E, {
                        variant: "text-xs/normal",
                        color: l,
...
function al(e) {
    ...
    eI()(c === ae.yV.EMBEDDED_APPLICATION && null != m, "invalid application invite");
    let h = r.useCallback(() => {
            ...
            (0, r$.he)(
                {
                    ...
                    invite_instance_id: (0, n1._U)(i.code, l.id),
                },
                v,
            ),
        ...
        y = null != g;
    if (null == g) {
        if (null == i.guild) return (0, s.jsx)(r8, {});
        g = (0, r4.DY)(i.guild);
    }
    t = y
        ? A
...
function as(e) {
    ...
    return (0, s.jsx)(H.h, {
        ...
        info: (0, s.jsxs)("div", {
            className: at.QR,
            children: [
                (0, s.jsx)(ai, { channel: l, guild: a, hasEnded: !u, textColor: "none" }),
                i
                    ? _ > 0 &&
                      (0, s.jsx)(X, {
                          activityUsers: n,
                    ...
                    : (0, s.jsx)(an, { members: d, membersOnline: c, textColor: "none" }),
            ],
        }),
        actions: j,
        onClickContent: C,
...
function ac(e) {
    let { invite: t, message: n, getAcceptInviteContext: i } = e,
        ...
        m = r.useCallback(() => {
            ...
            null != t.inviter &&
                ...
                ((e = "transition"), ao.A.openPrivateChannel({ recipientIds: [t.inviter.id] })),
                (0, r$.he)(
                    {
                        invite: t,
                        action: e,
                        ...
                        invite_instance_id: (0, n1._U)(t.code, n.id),
                    },
                    d,
                );
        }, [t, n, d]),
    ...
    let E = a ? J.intl.string(J.t.eQyu1F) : J.intl.string(J.t.PYJHW6),
        ...
        C = null != t.inviter ? s9.Ay.getUserTag(t.inviter) : "";
    return (0, s.jsxs)(nO.A, {
        children: [
            (0, s.jsx)(nO.A.Header, { text: E }),
            (0, s.jsxs)(nO.A.Body, {
                children: [
                    (0, s.jsxs)("div", {
                        className: nQ.iH,
                        children: [
                            (0, s.jsx)(nO.A.Icon, { user: new ad.A(t.inviter), onClick: c ? g : void 0 }),
                            (0, s.jsx)(nO.A.Info, { title: I, onClick: c ? g : void 0, children: C }),
                        ],
                    }),
...
function ah(e) {
    let { location: t } = e;
    return am.useConfig({ location: t });
}
function ag(e) {
    ...
    let { analyticsLocations: m } = (0, f.Ay)(x.A.INVITE_EMBED),
        { enabled: h } = ah({ location: "GroupDMInvite" }),
        g = null != c,
        A = r.useRef(null),
        E = r.useCallback(() => {
            let e = "noop";
                              ...
                              : 0 ===
                                  (i = l
                                      .map((e) => {
                                          ...
                                          let n = e instanceof ad.A ? e : G.default.getUser(e.id);
                                          if (null != n) {
                                              let e = s9.Ay.getName(n);
                                              if (null != e) return e;
                                          }
                                          return e.username;
                                      })
            ...
            ? T.map((e) =>
                  e instanceof ad.A
                      ...
                      : (G.default.getUser(e.id) ??
                        new ad.A({ id: e.id, username: e.username, avatar: e.avatar ?? null })),
              )
            : [],
        S = null != N.icon,
        b = J.intl.format(J.t.zRl6XR, { count: T.length });
    return (0, s.jsxs)(nO.A, {
        className: h ? nQ.TV : void 0,
        children: [
            h
                ? (0, s.jsx)(p.E, {
                      variant: "text-sm/medium",
                ...
                : (0, s.jsx)(nO.A.Header, { text: v }),
            (0, s.jsxs)(nO.A.Body, {
                children: [
                    (0, s.jsxs)("div", {
                        className: h ? `${nQ.iH} ${nQ.mx}` : nQ.iH,
                        children: [
                            (!h || S) &&
                                (0, s.jsx)(nO.A.Icon, {
                                    channel: N,
                            ...
                            (0, s.jsx)(nO.A.Info, {
                                title: h ? (0, s.jsx)(lA.A, { children: C }) : C,
                                onClick: g ? E : void 0,
                                ...
                                children: h
                                    ...
                                    : (0, s.jsx)(nO.A.Data, { members: T.length }),
                            }),
                            h &&
                                y.length > 0 &&
                                (0, s.jsx)(au.A, {
...
let ax = function (e, t) {
    let [n] = e,
        { guild: i } = t;
    return (
        !(null != i && (0, c.Lt)(n.getSelfMember(i.id)?.flags ?? 0, aA.D.IS_GUEST)) ||
        (0, c.Lt)(t.flags ?? 0, ap.Q.IS_GUEST_INVITE)
    );
};
var af = n(517905);
function aE(e) {
    let t,
        ...
        _ = null != E ? (0, r6.OY)(E) : null,
        j = null != d,
        N = null != _,
        T = null != _ && _.isGuildStageVoice(),
        y = (0, c.Lt)(m.flags ?? 0, ap.Q.IS_GUEST_INVITE),
    ...
    (0, e4.A)({
        ...
        properties: {
            ...
            invite_instance_id: (0, n1._U)(m.code, h.id),
            invite_channel_type: E?.type,
            embed_type: "guild_invite",
            location_stack: R,
        },
    });
    let [k, P] = r.useState(!1),
        M = r.useCallback(() => P(!1), []),
        D = r.useRef(null),
        O = (0, u.bG)([ig.Ay], () => ax([ig.Ay], m)),
        U = r.useCallback(() => {
            P(!0), (0, r$.Pq)(L, "show profile", R);
        }, [L, R]),
        G = r.useCallback(() => {
            let e = "noop";
    ...
    if (null == d) {
        if (null == m.guild) return (0, s.jsx)(r8, {});
        (d = r4.DY(m.guild)).premiumTier = m.guild.premium_tier ?? W.TVA.NONE;
    }
    let w = (function (e) {
        ...
        (i = (0, s.jsxs)("span", {
            ...
            children: [
                (0, s.jsx)(af.A, {
                    ...
                    onRequestClose: M,
                    targetElementRef: D,
                    children: () => (0, s.jsx)(nO.A.GuildName, { guild: d, ref: D }),
                }),
                (0, s.jsx)("span", {
                    className: nQ.E3,
                    children: (0, s.jsx)(sm.A, { guild: d, isBannerVisible: !1, disableBoostClick: !0 }),
                }),
            ],
        })),
        y &&
            (l = (0, s.jsx)(la.m, {
                ...
                children: (0, s.jsx)(t$.m, { size: "md", color: "currentColor", className: nQ.G }),
            })),
        S
            ? ((i = (0, s.jsx)(nO.A.Channel, { channel: _ })),
              (t = (0, s.jsxs)("span", {
                  className: nQ.FA,
                  children: [
                      ...
                      (0, s.jsx)("span", {
                          className: nQ.E3,
                          children: (0, s.jsx)(sm.A, { guild: d, isBannerVisible: !1 }),
                      }),
                  ],
              })))
            : (null != I && I >= 5) || (null != C && C > 0)
              ? (t = (0, s.jsx)(nO.A.Data, { members: I, membersOnline: C }))
              : N && (t = (0, s.jsx)(nO.A.Channel, { channel: _, guild: d })),
        (0, s.jsxs)(nO.A, {
            children: [
                (0, s.jsx)(nO.A.GuildSplash, { guild: d }),
                (0, s.jsx)(nO.A.Header, { text: w, extra: l }),
                (0, s.jsxs)(nO.A.Body, {
                    children: [
                        (0, s.jsxs)("div", {
                            className: nQ.iH,
                            children: [
                                (0, s.jsx)(nO.A.Icon, { guild: d }),
                                (0, s.jsx)(nO.A.Info, { title: i, onClick: U, children: t }),
                            ],
                        }),
                        (0, s.jsx)("div", {
                            className: nQ.UD,
...
function ab(e) {
    let { invite: t, isMemberOfGuild: n, message: i, onTransitionToInviteChannel: l, onAcceptInstantInvite: a } = e,
        ...
        A = (0, u.bG)([sN.Ay], () => sN.Ay.useReducedMotion),
    ...
    (0, e4.A)({
        ...
        properties: {
            ...
            invite_instance_id: (0, n1._U)(t.code, i.id),
        ...
        : (0, s.jsxs)(aI.s, {
              ...
              children: [
                  (0, s.jsxs)("div", {
                      ...
                      ref: d,
                      children: [
                          (0, s.jsx)(aT.J$, { profile: I, className: aS.vK }),
                          (0, s.jsx)(aT.CG, { profile: I }),
                          (0, s.jsx)(aN.A, { profile: I }),
                          (0, s.jsx)(a_.P, { profile: I, className: aS.rb }),
                          (0, s.jsx)(ay.A, {
                              guild: null != t.guild ? (0, r4.DY)(t.guild) : null,
                              roles: t.roles,
                              className: aS.Ei,
                          }),
                      ],
                  ...
                  h && !c
                      ...
                      : null,
                  (0, s.jsxs)("div", {
                      className: o()(aS.qr, { [aS.iK]: h }),
                      children: [
                          h && c ? (0, s.jsx)("div", { className: aS.D7 }) : null,
                          (0, s.jsx)("div", {
                              className: o()(aS.z8, { [aS.it]: h && c }),
                              children: (0, s.jsx)("div", {
                                  className: aS.UD,
                                  children: (0, s.jsx)(aL, {
                                      invite: t,
...
function aL(e) {
    let {
        ...
        { guildId: c, ctaType: u } = (0, av.Ay)(n, av.cn.INVITE, t.code),
            ...
            (0, r$.he)(
                {
                    ...
                    inviter_id: l.author.id,
                    invite_message_id: l.id,
                    invite_instance_id: (0, n1._U)(t.code, l.id),
                },
                m,
            );
        }, [t, l, m, i]);
...
function ak(e) {
    let t,
        ...
        c = s9.Ay.useName(l),
        m = d === l.id,
        { enabled: h } = ah({ location: "InvalidInvite" }),
        g = (0, u.bG)([D.A, tl.A], () => {
                    ...
                    null != c && g && !h
                        ? (0, s.jsx)(eg.$, {
                              onClick: function () {
                                  o?.();
                                  let { id: e } = l,
                                      t = `@${s9.Ay.getUserTag(l, { decoration: "never" })}`,
                                      n = `<@${e}>`;
                                  lb._.dispatchToLastSubscribed(W.jej.INSERT_TEXT, { plainText: t, rawText: n }),
                                      null != a && aR.A.startTyping(a);
                              },
...
function aM(e) {
    let t,
        ...
        h = (0, u.bG)(
            [aP.A],
            () => (null != n && null != n.target_user ? aP.A.getActiveStreamForUser(n.target_user.id, c) : null),
            [n, c],
        ),
        g = (0, u.bG)(
            [aP.A],
            () => (null != n && null != n.target_user ? aP.A.getStreamForUser(n.target_user.id, c) : null),
            [n, c],
        ),
    ...
    (0, e4.A)({
        ...
        properties: {
            ...
            invite_instance_id: (0, n1._U)(n.code, a.id),
            invite_channel_type: n.channel?.type,
            embed_type: "streaming_invite",
            location_stack: p,
        },
    });
    let A = null != n && n.target_type === ae.yV.STREAM && null != n.target_user && null != h,
        E =
            null != n &&
            null != g &&
            null != n.channel &&
    ...
    eI()(I === ae.yV.STREAM && null != C, "invalid streaming invite");
    let v = i === C.id,
        ...
        N = null != l;
    if (null == l) {
        if (null == n.guild) return (0, s.jsx)(r8, {});
        l = (0, r4.DY)(n.guild);
    }
    let T = null != n.channel ? (0, r6.OY)(n.channel) : null,
        y = s9.Ay.getName(C),
        S = A || (!E && N),
    ...
    let R =
        m === l.id && null != T
            ? (0, s.jsx)(nO.A.Channel, { channel: T })
            : J.intl.formatToPlainString(J.t.u0vaDE, { guildName: l.name });
    return (0, s.jsxs)(nO.A, {
        children: [
            (0, s.jsx)(nO.A.Header, { text: J.intl.string(J.t["wS+5Wb"]) }),
            (0, s.jsxs)(nO.A.Body, {
                children: [
                    (0, s.jsxs)("div", {
                        className: nQ.iH,
                        children: [
                            (0, s.jsx)(nO.A.Icon, { guild: l, onClick: N && E ? j : void 0 }),
                            (0, s.jsx)(nO.A.Info, { title: t, onClick: N && E ? j : void 0, children: R }),
                        ],
                    }),
...
function aK(e) {
    let { invite: t, message: n, channel: i, onTransitionToInviteChannel: l } = e,
        ...
        d = (0, u.bG)([aF.A], () => aF.A.isInChannel(i.id), [i.id]),
        { voiceStates: c } = (0, u.cf)(
            [aY.Ay],
            () => ({ voiceStates: null != i.guild_id ? aY.Ay.getVoiceStatesForChannelAlt(i.id, i.guild_id) : [] }),
            [i],
        ),
        m = r.useMemo(
        ...
        h = (0, u.bG)([aw.A], () => aw.A.getStartTime(i), [i]);
    r.useEffect(() => {
        null != h || null == i.guild_id || aw.A.hasRequestedStartTimes(i.guild_id) || (0, aG.U)(i.guild_id);
    }, [i, h]);
    let g = r.useRef(null),
        A = r.useRef(null),
        E = r.useCallback(() => {
    ...
    return (0, s.jsxs)("div", {
        ...
        children: [
                ...
                children: [
                    (0, s.jsxs)("div", {
                        ...
                        children: [
                            (0, s.jsxs)("div", {
                                ...
                                children: [
                                    ...
                                    (0, s.jsx)(aD.u, {
                                        ...
                                        body: "",
                                        assetSize: 24,
                                        asset: null != o ? (0, s.jsx)(aV.Ay, { guild: o, iconSize: 24 }) : void 0,
                                        position: "top",
                                        children: (0, s.jsx)(eb.D, {
                                            className: az.HA,
                                            onClick: j,
                            ...
                            null != h
                                ? (0, s.jsx)(aB.z, { entry: { start: h }, textColor: "text-feedback-positive" })
                                : null,
                        ],
                    }),
                    m.length > 0
                        ? (0, s.jsxs)("div", {
                              ...
                              children: [
                                  ...
                                  (0, s.jsx)("div", { ref: A, className: az.wH }),
                              ],
                          })
                        : (0, s.jsx)("div", {
                              className: az.p$,
            ...
            (0, s.jsxs)("div", {
                className: az.qr,
                children: [
                    (0, s.jsx)(aU.G, { size: "custom", color: "currentColor", className: az.Dq }),
                    (0, s.jsx)(p.E, {
                        variant: "text-sm/medium",
                        color: "currentColor",
                        lineClamp: 1,
...
function aW(e) {
    ...
    return null == a
        ...
        : (0, s.jsx)(aK, { invite: t, message: n, channel: a, onTransitionToInviteChannel: i });
}
var aJ = n(652896),
    aq = n(834757),
    aX = n(427358),
...
function a$(e) {
    ...
    return (0, s.jsxs)(eb.D, {
        ...
        children: [
            null != r &&
                (0, s.jsx)(r, { className: aZ.p, color: "currentColor", size: "custom", width: 12, height: 12 }),
            (0, s.jsx)(p.E, {
                variant: "text-xs/medium",
                lineClamp: 1,
                color: "currentColor",
                children: (0, s.jsxs)(lA.A, { children: [i.name, " / ", a] }),
            }),
            (0, s.jsx)(t6._, { className: aZ.t4, color: "currentColor", size: "custom", width: 12, height: 12 }),
        ],
    });
}
var aQ = n(308186),
            ...
            return (0, s.jsxs)(eb.D, {
                ...
                children: [
                    ...
                    (0, s.jsx)(p.E, {
                        ...
                        variant: "text-sm/medium",
                        color: "text-default",
                        children: (0, s.jsx)(a3.A, { user: t, nick: l, hideDiscriminator: !0 }),
                    }),
                ],
            });
        },
...
function a9(e) {
    let { guildId: t, channelId: n, users: i, onHoverOrFocus: l, ...a } = e,
        o = r.useCallback((e) => (0, s.jsx)(a7, { users: e, guildId: t, channelId: n, onHoverOrFocus: l }), [t, n, l]);
    return (0, s.jsx)(lc.Y, { renderPopout: () => o(i), ...a });
}
function a7(e) {
    let { users: t, guildId: n, channelId: i, onHoverOrFocus: l } = e,
        a = r.useRef(null),
        { isHoveringOrFocusing: o } = (0, a2.A)(a);
    return (
        r.useEffect(() => {
            l?.(o);
        }, [l, o]),
        (0, s.jsx)("div", {
            ...
            children: (0, s.jsx)(aO.Ip, {
                className: a4.G,
                children: t.map((e) =>
                    (0, s.jsx)(
                        a5,
                        { user: e, guildId: n ?? void 0, channelId: i, nick: a1.Ay.getNickname(n, i, e) },
                        e.id,
                    ),
                ),
            }),
...
var a8 = n(233161);
let oe = { mass: 1, tension: 170, friction: 26 };
function ot(e) {
    let { className: t, guildId: n, channelId: i, members: l, ref: a, motion: d } = e,
        ...
        [x, f] = (0, a0.z)(() => ({ x: 0, y: 0, scale: 1, config: oe }));
    return (
        r.useEffect(() => {
            f({ x: g, y: p, scale: A });
        }, [g, p, A, f]),
        (0, s.jsxs)(aQ.animated.div, {
            ref: a,
            className: o()(a8.gg, t),
            "data-count": h,
            "aria-hidden": !0,
            style: {
                transform: (0, aQ.to)([x.x, x.y, x.scale], (e, t, n) => `translate3d(${e}px, ${t}px, 0) scale(${n})`),
            },
            children: [
                u.map((e, t) =>
                    (0, s.jsx)(
                        ...
                        {
                            className: a8.my,
                            children: (0, s.jsx)(la.m, {
                                text: a1.Ay.getName(n, i, e),
                                asContainer: !0,
                                tag: "div",
                                children: (0, s.jsx)(tE.eu, {
                                    src: (function (e, t, n) {
                                        let i = ig.Ay.getMember(t, e.id);
                                        if (null != i) {
                                            let e = (0, w.xT)(i);
                                            if (null != e) return e;
                                        }
                ...
                c && (0, s.jsx)(on, { guildId: n, channelId: i, members: l, count: m }, "overflow"),
            ],
        })
    );
}
    ...
    let { guildId: t, channelId: n, members: i, count: l } = e,
        {
            ...
            let e = r.useRef(null),
                { isHoveringOrFocusing: t } = (0, a2.A)(e),
                [n, i] = r.useState(!1),
                l = t || n,
                [s, a] = r.useState(!1),
                o = r.useRef(null);
...
function ol(e) {
    let { invite: t, message: n, guild: i, onTransitionToInviteChannel: l, onAcceptInstantInvite: a } = e,
        d = r.useRef(null),
        c = i ?? null;
    null == c && null != t.guild && (c = r4.DY(t.guild));
    let m = null != t.channel ? (0, r6.OY)(t.channel) : null;
    ...
    let h = (0, u.bG)([tl.A, D.A], () => {
        ...
        g = (0, u.bG)([aY.Ay], () => (h ? aY.Ay.getVoiceStatesForChannelAlt(m.id, c.id) : []), [m.id, c.id, h]),
        ...
        T = (function (e) {
            ...
            return (0, u.bG)([aP.A, aX.A], () => {
                ...
                for (let e of [...r].sort((e, t) => {
                    let n = aX.A.getUserAffinity(e)?.vcProbability ?? 0;
                    return (aX.A.getUserAffinity(t)?.vcProbability ?? 0) - n;
                })) {
                    let t = aP.A.getStreamForUser(e, l);
                    if (null != t && t.channelId === s) return t;
                }
                ...
                (0, r$.he)(
                    {
                        ...
                        stream_key: null != T ? (0, aJ._z)(T) : void 0,
        ...
        L = r.useCallback(() => {
            I ? (0, iO.iN)(m.id) : a({ autoJoin: !1 }),
                eG.default.track(W.HAw.VOICE_INVITE_EMBED_BREADCRUMB_CLICKED, {
                    ...
                    stream_key: null != T ? (0, aJ._z)(T) : null,
                    number_of_users_in_channel: g.length,
                    location_stack: j,
                });
    ...
    let R = (0, u.bG)([sN.Ay], () => sN.Ay.useReducedMotion),
        k = r.useRef(null),
        ...
        U = (0, u.bG)([aX.A], () => {
            let e = g.map((e) => e.user),
                ...
                i = e
                    ...
                    .sort((e, t) => {
                        let n = aX.A.getUserAffinity(e.id)?.vcProbability ?? 0;
                        return (aX.A.getUserAffinity(t.id)?.vcProbability ?? 0) - n;
                    });
            return null != t ? [t, ...i] : i;
        }, [g, n.author.id]),
    ...
    return (0, s.jsxs)("div", {
        ...
        children: [
            (0, s.jsxs)("div", {
                ...
                onMouseLeave: B,
                children: [
                    (0, s.jsx)("div", { className: oi.ys }),
                    (0, s.jsx)("div", { className: oi.r$, style: { "--custom-number-of-dots": 20 } }),
                    (0, s.jsxs)("div", {
                        className: oi.rf,
                        children: [
                            (0, s.jsxs)("div", {
                                className: o()(oi.Qs, { [oi.tE]: 0 === U.length }),
                                children: [
                                    (0, s.jsx)(a$, { channel: m, guild: c, onClick: L }),
                                    (0, s.jsxs)("div", {
                                        className: oi.WD,
                                        children: [
                                            (0, s.jsx)(p.E, {
                                                variant: "text-md/medium",
                                                children: (0, s.jsx)(lA.A, { lineClamp: 3, delay: 150, children: A }),
                                            }),
                                            null != E
                                                ? (0, s.jsx)(p.E, {
                                                      variant: "text-sm/normal",
                                                      className: oi.$B,
                                                      children: (0, s.jsx)(lA.A, { delay: 150, children: E }),
                                                  })
                                                : null,
                                        ],
                                    }),
            ...
            (0, s.jsxs)("div", {
                className: oi.qr,
                children: [
                    (0, s.jsx)(aU.G, { size: "custom", color: "currentColor", className: oi.Dq }),
                    (0, s.jsx)(p.E, {
                        variant: "text-sm/medium",
                        color: "currentColor",
                        lineClamp: 1,
...
function os(e) {
    let { code: t, message: n, getAcceptInviteContext: i } = e,
        { invite: l, inviteError: a } = (0, u.cf)(
            [r5.A],
            () => ({ invite: r5.A.getInvite(t), inviteError: r5.A.getInviteError(t) }),
            [t],
        ),
        o = (0, n1._U)(t, n.id);
    r.useEffect(() => {
        null == l && r$.Ay.resolveInvite(t, void 0, { inviteInstanceId: o });
    }, [t]);
    let d = l ?? { state: W.elq.RESOLVING, code: "" },
        { analyticsLocations: c } = (0, f.Ay)(),
        m = (0, u.bG)([tF.A], () => (l?.guild != null ? tF.A.getGuild(l.guild.id) : null), [l]),
        h = (0, u.bG)([D.A, tl.A], () => {
            let e = l?.channel?.id;
            if (null == e) return !1;
        ...
        g = (0, u.bG)([M.default], () => M.default.getId()),
        p = (0, u.bG)([r0.Ay], () => r0.Ay.getGuildScheduledEvent(d.guild_scheduled_event?.id), [d]);
    function A() {
        null != d.channel && r$.Ay.transitionToInviteSync(d);
    }
    let x = function () {
            let { autoJoin: e } = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                n = null == m && l?.guild != null ? r4.DY(l.guild) : m;
            (0, r3.g)({ guild: n, isMember: null != m, analyticsLocations: c }) === r3.W.PROCEED &&
                r$.Ay.acceptInviteAndTransitionToInviteChannel({
                    inviteKey: t,
    ...
    switch (d.state) {
        ...
        case W.elq.BANNED:
            ...
            break;
        case W.elq.ERROR:
            E = (0, s.jsx)(aa, { author: n.author, inviteError: a });
            break;
        default:
            switch ((0, r2.On)(d)) {
                case r2.Xd.GROUP_DM:
                    ...
                    break;
                case r2.Xd.FRIEND:
                    E = (0, s.jsx)(ac, { invite: d, message: n, getAcceptInviteContext: i });
                    break;
                default:
                    if ((0, r2.G4)(d)) {
                        if (null != d.channel && (0, r6.OY)(d.channel).isGuildVoice() && null != d.guild) {
                            let e = r7({ location: "InviteEmbed.isStreamInvite", guildId: d.guild.id });
                            if (h)
                                if (e.enabled) {
                                    E = (0, s.jsx)(aW, {
                                        onTransitionToInviteChannel: A,
                    ...
                    if ((0, r2.oK)(d)) {
                        E = (0, s.jsx)(al, { invite: d, getAcceptInviteContext: i, message: n });
                        break;
                    }
                    if (null != d.channel && (0, r6.OY)(d.channel).isGuildVoice() && null != d.guild) {
                        let e = r7({ location: "InviteEmbed.isGuildVoice", guildId: d.guild.id });
                        if (h)
                            if (e.enabled) {
                                E = (0, s.jsx)(aW, {
                                    onTransitionToInviteChannel: A,
    ...
    return (0, s.jsx)(s8.A, { section: W.JJy.INVITE_LINK, children: E });
}
var or = n(266620),
    oa = n(860227),
    oo = n(568006),
...
let ou = function (e) {
    let { channel: t, message: n, hideParty: i, hideInviteEmbedBanner: l } = e,
        ...
        a =
            null != n.application
                ? nU.Ay.createFromServer(n.application)
                : null != n.activity && null != n.activity.party_id && (0, oc.pH)(n.activity.party_id)
                  ? od.HT
                  : void 0,
...
function og(e) {
    let { applicationId: t, guildId: n } = e,
        { data: i } = (0, eZ.YY)(t);
    return null == i ? null : (0, s.jsx)(op, { app: i, guildId: n });
}
function op(e) {
            ...
            Array.from({ length: t }, (e, t) =>
                (0, s.jsxs)(
                    "div",
                    {
                        className: oC.Yf,
                        children: [
                            (0, s.jsx)(oI.D, { size: "lg", color: tD.A.colors.TEXT_MUTED }),
                            (0, s.jsx)(p.E, {
                                variant: "text-sm/medium",
                                color: "text-muted",
...
var o_ = n(343552),
    ...
    oN = n(229612);
let oT = [W.Auw.GIFV],
    oy = 15 * sn.A.Millis.MINUTE,
    oS = new Set(["discord-developers", "discord-testers", "discord-townhall", "discordgameslab"]),
    ob = (e) => () => {
        let { url: t, proxyUrl: n, width: i, height: l, flags: r } = e,
            a = (0, c.Lt)(r, n7.e5.IS_ANIMATED);
        return null != i && null != l && (n8.bp.test(n) || (a && (n8.P8.test(n) || n8.p4.test(n))))
            ? (0, s.jsx)(sw.A, { width: i, height: l, src: n, url: t, format: m.TL.IMAGE, className: oN.jj })
            : null;
    };
class oL extends r.Component {
    ...
    getAcceptInviteContext = (e, t) => {
        ...
        return {
            ...
            ...(null != t ? { invite_instance_id: (0, n1._U)(t, i.id) } : {}),
        };
    };
    shouldRenderInvite(e) {
        let { channel: t } = this.props;
        return !(t.isDM() && !t.isSystemDM() && !t.isGroupDM() && oS.has(e));
    }
    ...
    renderCtaButton() {
        let { message: e, channel: t, ctaButtonType: n } = this.props,
            i = null;
        switch (n) {
            case ss.xC.MARK_AS_FALSE_POSITIVE:
                i = (0, s.jsx)(t3, { messageId: e.id, channelId: t.id });
                break;
            case ss.xC.AGE_VERIFICATION_RETRY:
                i = (0, s.jsx)(ef, { channelId: t.id });
                break;
            default:
                return null;
        }
        return (0, s.jsx)("div", { className: oN.od, children: i });
    }
    renderCodedLinks(e) {
        ...
        return e.codedLinks.map((n) => {
                        ...
                        children: (t) => {
                            switch (n.type) {
                                case tM.I.APP_DIRECTORY_PROFILE:
                                    return (0, s.jsx)(nV, { code: a, message: e });
            ...
            switch (i) {
                ...
                case tM.I.TEMPLATE:
                    return (0, s.jsx)(n0, { code: l }, l);
                case tM.I.EVENT:
                    return (0, s.jsx)(nW.A, { code: l }, l);
                case tM.I.CHANNEL_LINK:
                    return (0, s.jsx)(sg, { code: l, message: e }, l);
                case tM.I.GUILD_PRODUCT:
                    return (0, s.jsx)(nK, { code: l }, l);
                    ...
                    return (0, s.jsx)(
                        lr.A,
                        {
                            ...
                            customNavigateToSocialLayerStorefront: () => {
                                (0, ls.navigateToSocialLayerStorefrontWithGuildPreview)({ guildId: n });
                            },
                        },
                        l,
                    );
                ...
                case tM.I.SOCIAL_LAYER_STOREFRONT_APP: {
                    let [e, n] = l.split("-");
                    return (0, s.jsx)(lr.I, { applicationId: n, skuId: e, channel: t }, l);
                }
                case tM.I.QUESTS_EMBED:
                    return (0, s.jsx)(iL.A, { questId: l }, l);
                case tM.I.GAME_PROFILE:
                    return (0, s.jsx)(nL, { gameId: l }, l);
    ...
    renderAttachments(e) {
        ...
        if (0 === d.length || e.isPoll() || (0, l8._c)(e)) return null;
        ...
        function f(e, t) {
            return (0, sr.iW)(e.originalItem, t);
        }
        let E = m.map((s) => {
            let a = (0, n7.aG)(s),
                o = {
                    ...
                    onContextMenu:
                        null != r
                            ...
                            : void 0,
                    renderAudioComponent: x ? or.SX : or.Nj,
                    renderImageComponent: or.Cr,
                    renderVideoComponent: or.I1,
                    renderPlaintextFilePreview: or.R6,
                    renderGenericFileComponent: or.UB,
    ...
    renderEmbed = (e, t, n, i) => {
        ...
        let m = oT.includes(e.type) ? e.url : (e.image?.url ?? e.video?.url);
        return (0, s.jsx)(
            nk.G.Provider,
            {
                value: (0, o_.b)(m, e.image, e.video, e.thumbnail, e.provider?.name),
            ...
            : e.embeds.map((t, n) => {
                  ...
                  if (
                      ...
                      ((0, c.Lt)(t.flags ?? 0, W.iSj.IS_CONTENT_INVENTORY_ENTRY) &&
                          !(
                              0 ===
                                  (i = (e.components ?? []).filter((e) => e.type === n3.I5.CONTENT_INVENTORY_ENTRY))
                                      .length ||
                              i.some((e) => {
                      ...
                      (0, si.V)(t) ||
                      (0, si.G8)(t) ||
                      ((0, si.Xk)(t) && nv.A.getConfig({ location: "MessageAccessories.renderEmbeds" }).enabled)
                  )
                      return null;
                  ...
                  let r = { renderImageComponent: lu.LL, renderVideoComponent: lu.$o, renderLinkComponent: lu.bU };
                  if (
                      ...
                      let i = sl.A.safeParseWithQuery(t.url);
    ...
    renderComponentAccessories(e) {
        ...
        return (0, s.jsx)(sf.N, {
            ...
            shouldHideMediaOptions: i,
            enabledContentHarmTypeFlags: n,
            children: (0, s.jsx)(n5.Ay, { message: e, shouldDisableInteractiveComponents: l }),
        });
    }
    renderActivityInvite(e) {
        if (null == e.activity) return null;
        let { channel: t, hideInviteEmbedBanner: n } = this.props;
        return (0, s.jsx)(ou, { channel: t, message: e, hideParty: !1, hideInviteEmbedBanner: n });
    }
    renderPublishBump(e) {
    ...
    renderStickersAccessories(e) {
        ...
        return 0 === t.length
            ? null
            : t.map((e) => (0, s.jsx)(lH, { channel: n, isInteracting: i, renderableSticker: e }, e.id));
    }
    renderThreadAccessories(e) {
        if (e.hasFlag(W.pr7.HAS_THREAD) && !1 !== this.props.renderThreadAccessory)
            return (0, s.jsx)(l9, { message: e, compact: this.props.compact });
    }
    renderThreadRoleMentionWarning(e) {
        if (
            e.hasFlag(W.pr7.FAILED_TO_MENTION_SOME_ROLES_IN_THREAD) &&
            this.props.isCurrentUser &&
            !(Date.now() - lJ.default.extractTimestamp(e.id) >= oy)
        )
            return (0, s.jsx)("div", { className: oN.xM, children: J.intl.string(J.t.ma8Rs0) });
    }
    ...
    renderPoll(e, t) {
        if (null != t) return (0, s.jsx)(ib.A, { message: e, poll: t, className: oN.PM });
    }
    renderShareClientTheme(e) {
        return null != e.sharedClientTheme ? (0, s.jsx)(tR, { message: e }) : null;
    }
    renderReportedMessage(e) {
        if (e.messageSnapshots.length > 0 && (0, iR.Mn)(e, this.props.channel)) return (0, s.jsx)(iQ, { message: e });
    }
    renderForwardedMessage(e) {
        if (e.messageSnapshots.length > 0 && !(0, iR.Mn)(e, this.props.channel))
            return (0, s.jsx)(nC, {
                message: e,
    ...
    renderEditedTag(e, t) {
        return (0, s.jsx)(oE.A, { message: e, compact: t, location: oE.O.AFTER_ACCESSORIES });
    }
    renderRestrictedHiddenMedia(e) {
        ...
        return 0 === i
            ...
            : (0, s.jsx)("div", {
                  id: (0, oa.XL)(e),
                  className: o()(this.props.className, oN.kL),
                  children: (0, s.jsx)(ov, { count: i }),
              });
    }
    render() {
        ...
        if (!0 === this.props.restrictedPreview) {
            ...
            return null != n
                ? (0, s.jsx)("div", { id: (0, oa.XL)(t), className: o()(e, oN.kL), children: n })
...
function oR(e) {
    let t,
        ...
        d = nl.X6.useSetting(),
        m = nl.hD.useSetting(),
        h = nl.rs.useSetting() && !(0, lW.A)(e.message),
        g = nl.jW.useSetting() && !1 !== e.renderReactions,
        p = nl.kt.useSetting(),
        A = (0, u.bG)([se.A], () => null == n.guild_id || se.A.canChatInGuild(n.guild_id), [n]),
        x = (0, u.bG)([n4.A], () => null != n.guild_id && n4.A.isLurking(n.guild_id), [n]),
        f = (0, u.bG)([ig.Ay, G.default], () => {
            let e = G.default.getCurrentUser();
            return (null != n.guild_id && null != e ? ig.Ay.getMember(n.guild_id, e.id)?.isPending : null) ?? !1;
        }),
