...
function ej(e) {
    let { onDismiss: t } = e,
        ...
        a = r ?? null,
        E = (0, c.bG)([eU.A], () => (null != a ? eU.A.getGuild(a) : null), [a]),
    ...
    let I = (e) => {
        ...
        R = (0, i.jsx)(ep.Ay, { className: eG.$f, guild: E, size: ep.Ay.Sizes.MINI }),
        S = (0, eL.ql)(_, E.name);
...
function eY(e) {
    ...
    return r.has(ew.D.AUTOMOD_QUARANTINED_USERNAME_OR_GUILD_NICKNAME) || r.has(ew.D.AUTOMOD_QUARANTINED_BIO)
        ? (0, i.jsx)(eH, { ...n, analyticsLocations: l })
        : r.has(ew.D.AUTOMOD_QUARANTINED_SERVER_TAG)
          ? (0, i.jsx)(eV, {})
          : (0, i.jsx)(eH, { ...n, analyticsLocations: l });
}
var eW = n(202384),
...
let e8 =
    21552 == n.j
        ? () => {
              let e = (0, c.bG)([ef.A], () => ef.A.getGuildId(), []),
                  t = (0, c.bG)([eU.A], () => eU.A.getGuild(e), [e]),
                  l = (0, c.bG)([e6.A], () => (null != e ? e6.A.getRequest(e) : null), [e]),
                  r = (0, eZ.zy)(),
              ...
              return (0, i.jsxs)("div", {
                  className: eQ()(...A),
                  children: [
                      (0, i.jsx)(u.E, { className: e3.wx, variant: "text-sm/normal", children: E }),
...
function tN(e) {
    let { premiumSubscription: t } = e,
        r = t?.id,
        s = l.useCallback(() => {
            null != r && (0, tu.qr)(b.M.PREMIUM_GROUP_PRIMARY_REMINDER_NAGBAR, r, { dismissAction: en.i.USER_DISMISS });
        }, [r]),
        a = l.useCallback(() => {
            s(),
    ...
    return (0, i.jsxs)(tA.T0, {
        onClick: a,
        className: tI.A,
        children: [
            (0, i.jsx)(I.t, { color: t_.A.colors.ICON_STRONG }),
            (0, i.jsx)(tA.In, {
                children: es.intl.format(td.default.fFt9bd, { premiumGroupProductName: (0, tT.DP)() }),
            }),
            (0, i.jsx)(eJ.$, {
                onClick: E,
                text: es.intl.string(td.default["5fZHp3"]),
                size: "sm",
...
var tR = n(754804),
    ...
    tC = n(14594);
function tP() {
    let [e, t] = (0, e_.Wl)(b.M.NAGBAR_NOTICE_IGNORE_USER_FEEDBACK, { cooldownDurationMs: tC.aH });
...
function ty(e) {
    if (!e && (0, tf.Cf)())
        return void tM.A.showAgeVerificationGetStartedModal({ entryPoint: tp.q1.STAGE_CHANNEL_RAISE_HAND });
...
function tL(e) {
    ...
    return n > 0 && l > 0
        ? (0, i.jsx)("div", {
              className: tk.Z5,
              children: (0, i.jsx)("div", { className: eQ()(tk.qQ, tk.lN), children: es.intl.string(es.t.xlJRfv) }),
          })
        : n > 0
          ? (0, i.jsx)("div", {
                className: tk.Z5,
                children: (0, i.jsx)("div", { className: eQ()(tk.qQ, tk.lN), children: es.intl.string(es.t.WYad9Z) }),
            })
          : l > 0
            ? (0, i.jsx)("div", {
                  className: tk.Z5,
                  children: (0, i.jsx)("div", { className: eQ()(tk.qQ, tk.lN), children: es.intl.string(es.t.eHq2OF) }),
              })
            : null;
}
function tx() {
...
function tv() {
    return null == (0, c.bG)([tG.Ay], () => tG.Ay.getVisibleGame())
        ? null
        : (0, i.jsxs)(T.$T, {
              color: T.Hv.DANGER,
              children: [
                  (0, i.jsx)(T.PM, { noticeType: ei.kqX.SYSTEM_SERVICE_WARNING, onClick: () => t6() }),
...
if (21552 == n.j) var tb = n(189213);
if (21552 == n.j) var tB = n(150934);
function tF(e) {
    ...
    t0 = (e) => {
        ...
        return n
            ? (0, i.jsx)(A.D, {
                  tag: "span",
                  className: ea.wz,
                  onClick: () => open(tK.A.getArticleURL(ei.MVz.AV_ERROR_CODES)),
                  children: s,
              })
            : s;
    },
    t1 = (e) => {
        ...
        return (0, i.jsxs)(T.$T, {
            ...
            children: [
                ...
                (0, i.jsx)(t0, { error: eC.iy.NO_INPUT_DEVICES }),
                (0, i.jsx)(T.eC, {
                    href: tK.A.getArticleURL(ei.MVz.NO_INPUT_DETECTED),
                    noticeType: t,
...
function t2(e) {
    return (0, t$.isWindows)() && o().satisfies(y.A?.os.release, tQ.PH)
...
function t5(e) {
    let t,
        n,
        { noticeType: l } = e,
        r = (0, to.x5)(tz.oh.AUDIO_INPUT),
        s = r?.guid ?? "",
        { inputDeviceOSMuted: a, inputDeviceOSVolume: E } = (0, c.cf)([tw.Ay], () => ({
    ...
    return (
        !0 === a
            ? ((t = es.intl.string(es.t.ppW3ri)),
              (n = (0, i.jsx)(T.eC, { href: t2(s), noticeType: l, children: es.intl.string(es.t.QghSIq) })))
            : 0 === E
              ? ((t = es.intl.string(es.t.j4gGA4)),
                (n = (0, i.jsx)(T.eC, { href: t2(s), noticeType: l, children: es.intl.string(es.t.QghSIq) })))
              : tw.Ay.supports(tz.O5.LOOPBACK)
        ...
        (0, i.jsxs)(T.$T, {
            ...
            children: [
                (0, i.jsx)(T.PM, {
                    noticeType: l,
                    onClick: () => {
                        t6(), (0, N.openModal)((e) => (0, i.jsx)(tF, { ...e }));
                    },
                }),
                t,
                (0, i.jsx)(t0, { allowClick: o, error: eC.iy.NO_AUDIO_INPUT_DETECTED }),
                n,
            ],
        })
    );
    ...
    21552 == n.j
        ? l.memo(function () {
              let e = (0, c.bG)([eI.default], () => eI.default.getCurrentUser()),
                  t = (0, c.bG)([ef.A], () => ef.A.getGuildId()),
                  r = (0, c.bG)([tW.Ay], () => tW.Ay.getNotice()),
              ...
              if (
                  ...
                  return null;
              let A = null != r.type ? tW.Re[r.type] : null,
                  P = null != r.type ? tW.rV[r.type] : null,
                  M = null != r.type ? tW.f7[r.type] : null,
                  y = tW.pe[r.type];
              if (null != A) return (0, i.jsx)(eO.$, { dismissibleContent: A, noticeType: r.type });
              if (null != P) return (0, i.jsx)(eA, { dismissibleContent: P });
              ...
              switch (r.type) {
                  ...
                  case ei.kqX.GUILD_RAID_NOTIFICATION:
                      ...
                      return (0, i.jsx)(ej, { onDismiss: () => t6(X) });
                  case ei.kqX.WIN32_DEPRECATED_MESSAGE:
                      let { dismissUntil: b } = r.metadata;
                      return (0, i.jsxs)(T.$T, {
                          color: T.Hv.WARNING,
                          children: [
                              (0, i.jsx)(T.PM, { onClick: () => t6(b), noticeType: r.type }),
                              es.intl.format(es.t["08KQ1P"], {
                                  helpCenterLink: tK.A.getArticleURL(ei.MVz.WIN32_DEPRECATE),
                              }),
                          ],
                      });
                      ...
                      return (0, i.jsxs)(T.$T, {
                          ...
                          children: [
                              ...
                              es.intl.format(es.t["8Je+dX"], {
                                  helpCenterLink: tK.A.getArticleURL(ei.MVz.WIN7_8_DEPRECATE),
                              }),
                          ],
                      });
                  case ei.kqX.WIN_COMPAT_MODE_MESSAGE:
                      ...
                      return (0, i.jsxs)(T.$T, {
                          color: T.Hv.WARNING,
                          children: [
                              (0, i.jsx)(T.PM, { onClick: () => t6(F), noticeType: r.type }),
                  ...
                  case ei.kqX.MACOS_19_DEPRECATED_MESSAGE:
                      ...
                      return (0, i.jsxs)(T.$T, {
                          color: T.Hv.WARNING,
                          children: [
                              (0, i.jsx)(T.PM, { onClick: () => t6(w), noticeType: r.type }),
                              es.intl.format(es.t.q8VPLo, {
                                  helpCenterLink: tK.A.getArticleURL(ei.MVz.MACOS_19_DEPRECATE),
                              }),
                          ],
                      });
                  case ei.kqX.E2EE_UPDATE_REQUIRED:
                      ...
                      return (0, i.jsxs)(T.$T, {
                          color: T.Hv.WARNING,
                          children: [
                              (0, i.jsx)(T.PM, { onClick: () => t6(H), noticeType: r.type }),
                              es.intl.format(t$.isPlatformEmbedded ? es.t.J232TI : es.t.vceuiL, {
                                  helpCenterLink: tK.A.getArticleURL(ei.MVz.END_TO_END_ENCRYPTION),
                              }),
                          ],
                      });
                  case ei.kqX.WINDOWS_MEDIA_PACK_REQUIRED:
                      return (0, i.jsxs)(T.$T, {
                          color: T.Hv.WARNING,
                          children: [
                              (0, i.jsx)(T.PM, { onClick: () => t6(), noticeType: r.type }),
                              es.intl.string(es.t.iW0fcQ),
                              (0, i.jsx)(T.eC, {
                                  href: tK.A.getArticleURL(ei.MVz.WINDOWS_MEDIA_PACK),
                                  target: "_blank",
                                  noticeType: r.type,
                  ...
                  case ei.kqX.VOICE_DISABLED:
                      return (0, i.jsxs)(T.$T, {
                          ...
                          children: [
                              (0, i.jsx)(T.PM, {
                                  onClick: () => {
                                      p.clearRemoteDisconnectVoiceChannelId(), t6();
                                  },
                                  noticeType: r.type,
                              }),
                              ...
                              (0, i.jsx)(T.Z_, {
                                  onClick: () => {
                                      let e = tH.A.getRemoteDisconnectVoiceChannelId();
                                      null != e && null != tm.A.getChannel(e) && m.default.selectVoiceChannel(e);
                                  },
                                  noticeType: r.type,
                  ...
                  case ei.kqX.VOICE_CONNECTED_LAST_SESSION:
                      return (0, i.jsxs)(T.$T, {
                          ...
                          children: [
                              (0, i.jsx)(T.PM, {
                                  onClick: () => {
                                      p.clearLastSessionVoiceChannelId(), t6();
                                  },
                                  noticeType: r.type,
                              }),
                              ...
                              (0, i.jsx)(T.Z_, {
                                  onClick: () => {
                                      let e = tH.A.getLastSessionVoiceChannelId();
                                      null != e && null != tm.A.getChannel(e) && m.default.selectVoiceChannel(e);
                                  },
                                  noticeType: r.type,
                                  children: es.intl.string(es.t.vD60Pv),
                  ...
                  case ei.kqX.SPOTIFY_AUTO_PAUSED:
                      ...
                      return (0, i.jsxs)(T.$T, {
                          ...
                          children: [
                              ...
                              (0, i.jsx)(d.Anchor, {
                                  className: ea.uD,
                                  href: tK.A.getArticleURL(ei.MVz.SPOTIFY_AUTO_PAUSED),
                                  target: "_blank",
                  ...
                  case ei.kqX.UNCLAIMED_ACCOUNT:
                      return (0, i.jsxs)(T.$T, {
                          ...
                          children: [
                              ...
                              (0, i.jsx)(T.Z_, {
                                  noticeType: r.type,
                                  onClick: () => (o && null != t ? (0, eW.Ze)(t) : q.R()),
                  ...
                  case ei.kqX.SCHEDULED_MAINTENANCE:
                      ...
                      return (0, i.jsxs)(T.$T, {
                          color: T.Hv.DEFAULT,
                          children: [
                              (0, i.jsx)(T.PM, { onClick: () => h.A.ackScheduledMaintenance(), noticeType: r.type }),
                  ...
                  case ei.kqX.NO_INPUT_DEVICES_DETECTED:
                      return (0, i.jsx)(t1, { noticeType: r.type });
                          ...
                          return (0, i.jsxs)(T.$T, {
                              ...
                              children: [
                                  ...
                                  (0, i.jsx)(T.PM, {
                                      noticeType: r.type,
                                      onClick: () => {
                                          O.A.setEnableHardwareMuteNotice(!1), t6();
                                      },
                                  }),
                                  (0, i.jsx)(T.eC, {
                                      href: t.url,
                  ...
                  case ei.kqX.STREAMER_MODE:
                      return (0, i.jsxs)(T.$T, {
                          ...
                          children: [
                              (0, i.jsx)(T.PM, { onClick: () => t6(), noticeType: ei.kqX.STREAMER_MODE }),
                      ...
                      return (0, i.jsxs)(T.$T, {
                          ...
                          children: [
                              ...
                              (0, i.jsx)(T.Z_, {
                                  noticeType: ei.kqX.SURVEY,
                                  onClick: () => {
                                      a ? (0, tS.K)(E) : window.open(s, "_blank"), (0, g.pX)(t, !1);
                                  },
                                  children: l,
                              }),
                          ],
                  ...
                  case ei.kqX.CORRUPT_INSTALLATION:
                      return (0, i.jsxs)(T.$T, {
                          ...
                          children: [
                              ...
                              (0, i.jsx)(T.eC, {
                                  href: tK.A.getArticleURL(ei.MVz.CORRUPT_INSTALLATION),
                                  target: "_blank",
                                  noticeType: r.type,
                  ...
                  case ei.kqX.VIDEO_UNSUPPORTED_BROWSER:
                      return (0, i.jsxs)(T.$T, {
                          color: T.Hv.WARNING,
                          children: [
                              (0, i.jsx)(T.PM, { onClick: () => t6(), noticeType: ei.kqX.VIDEO_UNSUPPORTED_BROWSER }),
                  ...
                  case ei.kqX.DISPATCH_ERROR:
                      ...
                      return (0, i.jsxs)(T.$T, {
                          color: T.Hv.DANGER,
                          children: [
                              (0, i.jsx)(T.PM, { onClick: () => t6(), noticeType: ei.kqX.DISPATCH_ERROR }),
                              et?.displayMessage,
                              (0, i.jsx)(T.Z_, {
                  ...
                  case ei.kqX.APPLICATION_TEST_MODE:
                      if (null == r.metadata) return null;
                      if (null != tY.A.testModeEmbeddedApplicationId)
                          return (0, i.jsx)(T.$T, {
                              color: T.Hv.WARNING,
                              children: (0, i.jsxs)(v.A, {
                                  ...
                                  children: [
                                      ...
                                      (0, i.jsx)(T.PM, { onClick: f.cL, noticeType: ei.kqX.APPLICATION_TEST_MODE }),
                                  ],
                              }),
                          });
                      return (0, i.jsx)(T.$T, {
                      ...
                      return (0, i.jsxs)(T.$T, {
                          ...
                          children: [
                              ...
                              (0, i.jsx)(T.Z_, {
                                  ...
                                  onClick: () => {
                                      t6(e_), (0, z.openUserSettings)(Q.X.SUBSCRIPTIONS_PANEL);
                                  },
                  ...
                  case ei.kqX.QUARANTINED:
                      return (0, i.jsxs)(T.$T, {
                          ...
                          children: [
                              ...
                              (0, i.jsx)(d.Anchor, {
                                  href: tK.A.getArticleURL(ei.MVz.QUARANTINE),
                                  target: "_blank",
                                  className: ea.yw,
                                  children: es.intl.string(es.t.hvVgAZ),
                              }),
                  ...
                  case ei.kqX.AUTO_MODERATION_MENTION_RAID_DETECTION:
                      let { dismissUntil: eu, decisionId: eT } = r.metadata;
                      return (0, i.jsxs)(T.$T, {
                          color: T.Hv.WARNING,
                          children: [
                              (0, i.jsx)(T.PM, {
                      ...
                      return (0, i.jsxs)(T.$T, {
                          ...
                          children: [
                              (0, i.jsx)(T.PM, {
                                  ...
                                  onClick: () => {
                                      r.metadata?.streamKey != null && (0, tO.lk)(r.metadata.streamKey);
                                  },
                              }),
                  ...
                  case ei.kqX.PREMIUM_GROUP_PRIMARY_REMINDER_NAGBAR:
                      return (0, i.jsx)(tN, { premiumSubscription: r.metadata.premiumSubscription });
