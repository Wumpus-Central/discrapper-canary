...
function tM(e) {
    ...
    return n > 0 && r > 0
        ? (0, i.jsx)("div", {
              className: tL.Z5,
              children: (0, i.jsx)("div", { className: eZ()(tL.qQ, tL.lN), children: ea.intl.string(ea.t.xlJRfv) }),
          })
        : n > 0
          ? (0, i.jsx)("div", {
                className: tL.Z5,
                children: (0, i.jsx)("div", { className: eZ()(tL.qQ, tL.lN), children: ea.intl.string(ea.t.WYad9Z) }),
            })
          : r > 0
            ? (0, i.jsx)("div", {
                  className: tL.Z5,
                  children: (0, i.jsx)("div", { className: eZ()(tL.qQ, tL.lN), children: ea.intl.string(ea.t.eHq2OF) }),
              })
            : null;
}
function tP() {
...
function t6(e) {
    let t,
        ...
        a = s?.guid ?? "",
        { inputDeviceOSMuted: o, inputDeviceOSVolume: l } = (0, c.cf)([tH.Ay], () => ({
            inputDeviceOSMuted: tH.Ay.getInputDeviceOSMuted(),
            inputDeviceOSVolume: tH.Ay.getInputDeviceOSVolume(),
        })),
        u = !1;
    return (
        !0 === o
...
let t5 = r.memo(function () {
    ...
    let h = null != s.type ? t$.Re[s.type] : null,
        ...
        C = null != s.type ? t$.f7[s.type] : null,
        P = t$.pe[s.type];
    ...
    switch (s.type) {
        ...
        case ei.kqX.GUILD_RAID_NOTIFICATION:
            ...
            return (0, i.jsx)(ek, { onDismiss: () => t4(V) });
            ...
            return (0, i.jsxs)(f.$T, {
                ...
                children: [
                    ...
                    ea.intl.format(ea.t.q8VPLo, {
                        helpCenterLink: tz.A.getArticleURL(W ? ei.MVz.MACOS_20_DEPRECATE : ei.MVz.MACOS_19_DEPRECATE),
                    }),
                ],
            });
        case ei.kqX.E2EE_UPDATE_REQUIRED:
            ...
            return (0, i.jsxs)(f.$T, {
                color: f.Hv.WARNING,
                children: [
                    (0, i.jsx)(f.PM, { onClick: () => t4(K), noticeType: s.type }),
                ...
                children: [
                    ...
                    (0, i.jsx)(f.Z_, {
                        onClick: () => {
                            ...
                            null != e && null != tv.A.getChannel(e) && v.default.selectVoiceChannel(e);
                        },
                        noticeType: s.type,
            ...
            return (0, i.jsxs)(f.$T, {
                ...
                children: [
                    ...
                    (0, i.jsx)(f.Z_, {
                        ...
                        onClick: () => {
                            t4(ef), (0, Q.openUserSettings)(Z.X.SUBSCRIPTIONS_PANEL);
                        },
