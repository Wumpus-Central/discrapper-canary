...
function t5(e, t) {
    o.useEffect(() => {
        t8.bW.loadIfUncached(t7.oD.FRECENCY_AND_FAVORITES_SETTINGS);
    }, []);
            ...
            let {
                ...
                { apps: m } = (function (e) {
                    let {
                        ...
                        c = (0, n3.MW)(r, [M.kc.CHAT]).hasBaseAccessPermissions,
                        d = (0, g.SD)(t, c, i),
                        u = (0, g.A4)(c, i),
                        m = o.useCallback(
                            (e) => {
                ...
                h = o.useMemo(() => {
                    ...
                    return n4(c, {
                        limit: l,
                        filterPredicates: [
                            ((m = (0, n3.Bh)("channel" === t.type ? t.channel : void 0, [M.kc.CHAT])),
                            (p = {}),
                            (e) => {
...
function lp(e) {
    ...
    let E = A || x,
        g = A ? nZ.buttonTypes.VIEW_LESS : nZ.buttonTypes.VIEW_MORE,
        C = E ? n : s;
    return (0, r.jsxs)("div", {
        children: [
            (0, r.jsx)(nZ, { title: et.intl.string(et.t["0hKkS+"]), buttonType: g, onClickViewButton: i ? m : void 0 }),
            (0, r.jsx)("div", {
                className: lr._,
                ref: f,
                onTransitionEnd: N,
...
function lA(e) {
    ...
    return s
        ? (0, r.jsxs)("div", {
              children: [
                  (0, r.jsx)(nZ, { title: et.intl.string(et.t.PHjkRE) }),
                  (0, r.jsxs)("div", {
                      className: lr._,
                      children: [
                          n.map((e, n) => {
        ...
        : (0, r.jsxs)("div", {
              children: [
                  (0, r.jsx)(nZ, { title: et.intl.string(et.t.shUONg) }),
                  (0, r.jsxs)("div", {
                      className: lr.H$,
                      children: [
                          n.map((e, n) => {
...
function lx() {
    return (0, r.jsxs)("div", {
        children: [
            (0, r.jsx)(nZ, { title: et.intl.string(et.t["0hKkS+"]) }),
...
function lv(e) {
        ...
        { frecentApps: s, loading: a } = (function (e) {
            ...
            return {
                ...
                frecentApps: (function (e) {
                    ...
                    o.useEffect(() => {
                        i && s === ne.FetchState.NOT_FETCHED && t2.A.fetch();
                    }, [i, s]);
    ...
    a || f)
        ...
        : (0, r.jsxs)("div", {
              children: [
                  (0, r.jsx)(nZ, { title: d, buttonType: nZ.buttonTypes.VIEW_MORE, onClickViewButton: h }),
                  (0, r.jsx)("div", {
                      className: lN._,
                      children: (0, r.jsx)("div", {
                          className: lN.Ye,
        ...
        : (0, r.jsxs)("div", {
              children: [
                  (0, r.jsx)("div", {
                      ...
                      children: (0, r.jsx)(nZ, { title: et.intl.string(et.t.shUONg) }),
                  }),
                  (0, r.jsx)("div", {
                      className: lN.a2,
                      children: l.map((e, n) => {
        ...
        : (0, r.jsxs)("div", {
              children: [
                  (0, r.jsx)("div", {
                      ...
                      children: (0, r.jsx)(nZ, {
                          title: et.intl.string(et.t.KfkuGc),
                          buttonType: nZ.buttonTypes.VIEW_MORE,
                          onClickViewButton: c,
                      }),
                  }),
                  (0, r.jsx)("div", {
    ...
    let { context: t, entrypoint: n, onEmptyState: l } = e,
        {
            ...
            o.useEffect(() => {
                (0, X.An)({ surface: l_, activeState: s });
            }, [s]);
            let { sectionDescriptors: a } = H.cu({
                ...
                c = (0, A.bG)([tZ.A], () => tZ.A.getFetchState({ surface: l_, activeState: s })),
                d = (0, A.bG)([tZ.A], () => tZ.A.getCollections({ surface: l_, activeState: s })),
                u = i === _.s4.VOICE;
            return {
                fetchState: c,
