...
let A = (e) => {
    ...
    let _ = d[0] ?? null,
        f = g.xc.NONE;
    null != _ && (f = null != a && a.status === m.Dmq.PAUSED ? g.xc.FP_SUB_PAUSED : g.xc.FP_ONLY);
    let p = u && _?.sourceType === m.GD.REVERSE_TRIAL;
    return {
        isFractionalPremiumActive: null != _,
        fractionalState: f,
        startsAt: null != _ ? l()(_.startsAt) : l()(0),
        endsAt: null != _ ? l()((0, E._e)(_.endsAt, r, void 0, p)) : l()(0),
...
function T(e) {
    return null != e && !p.A.applicationIdsFetching.has(g.tv) && !p.A.applicationIdsFetched.has(g.tv);
}
function S() {
    let {
            forceFetch: e,
        ...
        [E, S] = r.useState(
            A({
                isFetching: I(e, i) || p.A.fetchingAllEntitlements || T(i) || p.A.applicationIdsFetching.has(g.tv),
                entitlements: s,
    ...
    return (
        (0, d.Ay)(() => {
            I(e, i) && (0, c.qw)({ entitlementType: m.zF_.FRACTIONAL_REDEMPTION }), T(i) && (0, c.LM)(g.tv);
        }),
        r.useEffect(() => {
            let e = A({
                entitlements: s,
