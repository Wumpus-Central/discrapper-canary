...
function g(e) {
    ...
    r.add(n),
        p.set(i, r),
        null == e.message && f.add(n),
        null != e.saveData.dueAt && new Date() > e.saveData.dueAt ? h.add(n) : h.delete(n);
}
function A(e) {
    let { messageId: t, channelId: n } = e,
        i = m({ messageId: t, channelId: n }),
        r = c.get(i);
    if (r?.message == null) return !1;
    let s = { ...r };
    return (s.message = null), c.set(i, s), !0;
}
function I() {
    if (0 === f.size || d) return !1;
    d = !0;
}
...
let S = new T(s.h, {
    ...
    LOGOUT: function () {
        (d = !0), c.clear(), p.clear(), f.clear();
    },
    SAVED_MESSAGES_UPDATE: function (e) {
        let { savedMessages: t } = e;
        for (let e of ((d = !1), c.clear(), p.clear(), f.clear(), t)) g(e);
    },
    ...
    SAVED_MESSAGE_DELETE: function (e) {
        ...
        c.delete(n);
        let r = t.messageId;
        p.get(i.saveData.channelId)?.delete(r), f.delete(r), h.delete(r), (_ = Date.now());
    },
    ...
    MESSAGE_UPDATE: function (e) {
        ...
        let r = { ...i };
        (r.message = (0, a.IU)(i.message, t)), c.set(n, r);
    },
    GUILD_CREATE: I,
    GUILD_UPDATE: I,
    GUILD_DELETE: I,
    ...
    GUILD_MEMBER_UPDATE: function (e) {
        let { user: t } = e;
        if (0 === f.size || d || t.id !== o.default.getCurrentUser()?.id) return !1;
        d = !0;
    },
    GUILD_ROLE_CREATE: I,
    GUILD_ROLE_UPDATE: I,
