...
function O(e) {
    let {
        ...
        s = (0, l.e7)([h.Z], () => h.Z.get(a), [a]),
        c = (0, l.e7)([h.Z], () => (null != a ? h.Z.getParentSKU(a) : void 0), [a]),
        d = i.useId(),
        u = i.useCallback(() => (0, f.Gp)(v.Z5c.GLOBAL_DISCOVERY_APPS_PROFILE_SECTION(t, _.GlobalDiscoveryAppsSections.STORE)), [t]);
    return (
        i.useLayoutEffect(() => {
            var e;
            switch (null == s ? void 0 : s.type) {
                ...
                case v.epS.SUBSCRIPTION:
                    ...
                    return (
                        ...
                        void (0, o.ZDy)(
                            async () => {
                                let { SubscriptionDetailsModal: i } = await Promise.all([n.e('97349'), n.e('65207')]).then(n.bind(n, 519896));
                                return (n) =>
                                    (0, r.jsx)(
                                        i,
                                        C(
        ...
        }, [t, d, u, null == c ? void 0 : c.flags, null == s ? void 0 : s.flags, null == s ? void 0 : s.type, a]),
        i.useLayoutEffect(
            () => () => {
                (0, o.Mr3)(d);
            },
        ...
        children: (0, r.jsx)(a.xv, {
            ...
            children:
                null != i && null != l
                    ...
                    : null != i
                      ? b.NW.format(b.t['0cPyDw'], { termsHook: (e) => o(e, i) })
                      : null != l
