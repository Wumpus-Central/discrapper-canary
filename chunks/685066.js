                    ...
                    let r = (() => {
                        ...
                        return function (t = {}) {
                                    ...
                                    function e() {
                                        if (!t) {
                                            ...
                                            if (/iPhone|iPad|iPod/i.test(navigator.userAgent)) {
                                                if (((l = e.getContext("webgl", a)), (n = 1), !l))
                                                    return (
                                    ...
                                    (this.Qb = function (n, r, s, c, p) {
                                        if (e()) {
                                            ...
                                            if (t.canvas) {
                                                ...
                                                s.sort((e, t) => t.wb - e.wb),
                                                (h = f.push(c)),
                                                a != h &&
                                                    (t.bufferData(t.ARRAY_BUFFER, 8 * h, t.DYNAMIC_DRAW), (a = h)),
                                                (h = 0),
                                                s))
                                                    t.bufferSubData(t.ARRAY_BUFFER, h, g.Ta), (h += 4 * g.Ta.length);
                                                for (var E of (console.assert(h == 4 * c), s))
                                                    t.bufferSubData(t.ARRAY_BUFFER, h, E.Db), (h += 4 * E.Db.length);
                                                for (var b of (console.assert(h == 8 * c),
                                                (h = _.push(p)),
                                                l != h &&
                                                ...
                                                s)) {
                                                    e.image.Ka != b &&
                                                        (t.bindTexture(t.TEXTURE_2D, e.image.Ja || null),
                                                        (b = e.image.Ka)),
                                                        e.mc
                                                            ? (t.scissor(e.Ya, m - e.Za - e.jb, e.Ac, e.jb), (E = !0))
                                                    ...
                                                    t.uniform4f(
                                                        ...
                                                        t.uniform2f(
                                                            o,
                                                            e.ha[4] * s * e.Ba + s * (e.Ya - e.ic * e.Ba) - 1,
                                                            e.ha[5] * a * e.Ca + a * (e.Za - e.jc * e.Ca) + 1,
                                                        ),
                            ...
                            o.onRuntimeInitialized = function () {
                                ...
                                function n() {
                                    for (let e of (0 < T.length &&
                                        (u.Qb(I.drawWidth(), I.drawHeight(), T, S, A),
                                        (T = []),
                                        (A = S = 0),
                                        I.reset(512, 512)),
                                    v)) {
                                ...
                                var b = o.RenderImage.extend("CanvasRenderImage", {
                                        ...
                                        __destruct: function () {
                                            this.Ja && (u.Mb(this.Ja), URL.revokeObjectURL(this.Wa)),
                                        ...
                                        draw: function (e, n, r) {
                                            ...
                                            if (((e.globalCompositeOperation = this.Eb), null != a)) {
                                                ...
                                                a.ec
                                                    ...
                                                    : (o = e.createLinearGradient(o, s, n, l));
                                                for (let e = 0, n = r.length; e < n; e++)
                                                    (s = r[e]), o.addColorStop(s.stop, t(s.color));
                                ...
                                var N = (o.CanvasRenderer = l.extend("Renderer", {
                                    ...
                                    transform: function (e, t, n, r, i, o) {
                                        ...
                                        a.splice(
                                            ...
                                            this.H.push(this.C.transform.bind(this.C, e, t, n, r, i, o));
                                    },
                                    rotate: function (e) {
                                        let t = Math.sin(e);
                                    ...
                                    _drawImageMesh: function (t, r, i, a, s, l, c, d, f, _) {
                                        ...
                                        if (
                                            ...
                                            (h = u.hc()),
                                                y > h && ((_ *= h / y), (y = h)),
                                                O > h && ((p *= h / O), (O = h)),
                                                I || (I = new o.DynamicRectanizer(h)).reset(512, 512),
                                                0 > (h = I.addRect(y, O)) &&
                                                    (n(), v.add(this), console.assert(0 <= (h = I.addRect(y, O))));
                                            var N = 65535 & h,
                                                C = h >> 16;
                                            T.push({
                                    ...
                                    clear: function () {
                                        v.add(this),
                                            this.H.push(
                                                this.C.clearRect.bind(this.C, 0, 0, this.Ua.width, this.Ua.height),
                                            );
                                    },
                                    flush: function () {},
                            ...
                            function L() {
                                ...
                                (o.HEAP8 = T = new Int8Array(e)),
                                    (o.HEAP16 = A = new Int16Array(e)),
                                    (o.HEAP32 = C = new Int32Array(e)),
                                    (o.HEAPU8 = S = new Uint8Array(e)),
                                    (o.HEAPU16 = N = new Uint16Array(e)),
                                    (o.HEAPU32 = R = new Uint32Array(e)),
                                ...
                                J = {
                                    ...
                                    455525: (e, t, n, r, i, o) => {
                                        ...
                                        return (
                                            ...
                                            (a.Z.onaudioprocess = function (n) {
                                                if (
                                                    ((null == a.sa || 0 == a.sa.length) &&
                                                        (a.sa = new Float32Array(P.buffer, i, r * t)),
                                                    e == window.h.I.capture || e == window.h.I.La)
                                                ) {
                                                    for (var s = 0; s < t; s += 1)
                                                        for (
                                                            var l = n.inputBuffer.getChannelData(s), c = a.sa, u = 0;
                                                            u < r;
                                                            u += 1
                                                        )
                                                            c[u * t + s] = l[u];
                                                ...
                                                if (e == window.h.I.ya || e == window.h.I.La)
                                                    for (nI(o, r, i), s = 0; s < n.outputBuffer.numberOfChannels; ++s)
                                                        for (
                                                            l = n.outputBuffer.getChannelData(s), c = a.sa, u = 0;
                                                            u < r;
                                                            u += 1
                                                        )
                                                            l[u] = c[u * t + s];
                                            ...
                                            (e != window.h.I.capture && e != window.h.I.La) ||
                                                navigator.mediaDevices
                                                    ...
                                                    .then(function (e) {
                                                        (a.Da = a.J.createMediaStreamSource(e)),
                                                            a.Da.connect(a.Z),
                                                            a.Z.connect(a.J.destination);
                                                    })
                                                    .catch(function (e) {
                                    ...
                                    458475: (e) => {
                                        void 0 !== (e = window.h.ra(e)).Z &&
                                            ((e.Z.onaudioprocess = function () {}), e.Z.disconnect(), (e.Z = void 0)),
                                            void 0 !== e.Da && (e.Da.disconnect(), (e.Da = void 0)),
                                            e.J.close(),
                                            (e.J = void 0),
                                            (e.pb = void 0);
                                    },
                            ...
                            function ea() {
                                for (var e = "", t = !1, n = arguments.length - 1; -1 <= n && !t; n--) {
                                    if (((t = 0 <= n ? arguments[n] : "/"), "string" != typeof t))
                            ...
                            var eb = {
                                ...
                                createNode(e, t, n, r) {
                                    ...
                                    return (
                                        ...
                                        16384 == (61440 & (n = ej(e, t, n, r)).mode)
                                            ...
                                            : 32768 == (61440 & n.mode)
                                              ? ((n.l = eb.O.file.node),
                                                (n.m = eb.O.file.stream),
                                                (n.v = 0),
                                                (n.j = null))
                                              : 40960 == (61440 & n.mode)
                                                ? ((n.l = eb.O.link.node), (n.m = eb.O.link.stream))
                                                : 8192 == (61440 & n.mode) &&
                                                  ((n.l = eb.O.$a.node), (n.m = eb.O.$a.stream)),
                                ...
                                m: {
                                    read(e, t, n, r, i) {
                                        ...
                                        if (8 < (e = Math.min(e.node.v - i, r)) && o.subarray)
                                            t.set(o.subarray(i, i + e), n);
                                        else for (r = 0; r < e; r++) t[n + r] = o[i + r];
                                        return e;
                                    },
                                    write(e, t, n, r, i, o) {
                                        if ((t.buffer === T.buffer && (o = !1), !r)) return 0;
                                        if (
                                        ...
                                        if ((eE(e, i + r), e.j.subarray && t.subarray))
                                    ...
                                    lb(e, t, n, r, i) {
                                        ...
                                        if (((e = e.node.j), 2 & i || e.buffer !== T.buffer))
                                            throw (
                                                ((0 < n || n + t < e.length) &&
                                                    (e = e.subarray
                                                        ? e.subarray(n, n + t)
                            ...
                            var eO,
                                    ...
                                    for (var n = eS, r = "/", i = 0; i < e.length; i++) {
                                        ...
                                        if (
                                            ...
                                            for (o = 0; 40960 == (61440 & n.mode); )
                                                if (
                                                    ((n = eX(r)),
                                                    (n = eL((r = ea(en(r), n)), { Qa: t.Qa + 1 }).node),
                                                    40 < o++)
                                                )
                                                    throw new ew(32);
                                        }
                                ...
                                ex = (e) => {
                                    for (var t; ; ) {
                                        if (e === e.parent)
                                            return (
                                                (e = e.U.mb), t ? ("/" !== e[e.length - 1] ? `${e}/${t}` : e + t) : e
                                            );
                                ...
                                eQ = (e, t, n) => {
                                    ...
                                    if (
                                        ((n = 64 & t ? ((void 0 === n ? 438 : n) & 4095) | 32768 : 0),
                                        "object" == typeof e)
                                    )
                                        var i = e;
                                    else {
                                    ...
                                    if (
                                        (8192 == (61440 & i.mode) && (t &= -513),
                                        65536 & t && 16384 != (61440 & i.mode))
                                    )
                                        throw new ew(54);
                                    if (
                                        !r &&
                                        ...
                                        throw new ew(n);
                                    if (512 & t && !r) {
                                        if (!(n = "string" == typeof (n = i) ? eL(n, { fb: !0 }).node : n).l.P)
                                            throw new ew(63);
                                    ...
                                    return (
                                        ...
                                        !o.logReadFiles || 1 & t || (eT || (eT = {}), e in eT || (eT[e] = 1)),
                                        i
                                    );
                                },
                                eJ = (e, t, n) => {
                            ...
                            function tv(e, t) {
                                return (
                                    (t.u && t.o) || tO("makeClassHandle requires ptr and ptrType"),
                                    !!t.L != !!t.G && tO("Both smartPtrType and smartPtr must be specified"),
                                    (t.count = { value: 1 }),
                                    tI(Object.create(e, { g: { value: t } }))
                                );
                            }
                            function tI(e) {
                            ...
                            function tw(e, t, n = {}) {
                                var r = t.name;
                                if (
                                    (e || e9(`type "${r}" must have a positive integer typeid pointer`),
                                    td.hasOwnProperty(e))
                                ) {
                                    if (n.$b) return;
                                ...
                                (td[e] = t),
                                    delete tC[e],
                                    tN.hasOwnProperty(e) && ((t = tN[e]), delete tN[e], t.forEach((e) => e()));
                            }
                            function tD(e, t, n = {}) {
                            ...
                            function tU(e, t, n) {
                                for (; t !== n; )
                                    t.na || e9(`Expected null or instance of ${n.name}, got an instance of ${t.name}`),
                                        (e = t.na(e)),
                                        (t = t.A);
                                return e;
                            }
                            function tG(e, t) {
                                return null === t
                                    ? (this.Na && e9(`null is not a valid ${this.name}`), 0)
                                    : (t.g || e9(`Cannot pass "${t1(t)}" as a ${this.name}`),
                                      t.g.o || e9(`Cannot pass deleted object as a pointer of type ${this.name}`),
                                      tU(t.g.o, t.g.u.i, this.i));
                            }
                            function tB(e, t) {
                                if (null === t) {
                                ...
                                if (
                                    ...
                                    (n = tU(t.g.o, t.g.u.i, this.i)),
                                    this.ua)
                                )
                                    switch (
                                        (void 0 === t.g.G && e9("Passing raw pointer to smart pointer is illegal"),
                                        this.tc)
                                    ) {
                                        case 0:
                                            t.g.L === this
                            ...
                            function tF(e, t, n, r) {
                                (this.name = e),
                                    ...
                                    void 0 !== t.A
                                        ? (this.toWireType = tB)
                                        : ((this.toWireType = r ? tG : tZ), (this.K = null));
                            }
                            function tV(e, t, n) {
                                o.hasOwnProperty(e) || tO("Replacing nonexistant public symbol"),
                                    void 0 !== o[e].B && void 0 !== n ? (o[e].B[n] = t) : ((o[e] = t), (o[e].ea = n));
                            }
                            var tH = [],
                                tY = (e) => {
                                    var t = tH[e];
                            ...
                            function tK(e, t) {
                                ...
                                return (
                                    "function" != typeof n && e9(`unknown function pointer with signature ${e}: ${t}`),
                                    n
                                );
                            }
                            var tz = void 0;
                            ...
                            function tX(e, t, n, r, i) {
                                ...
                                return function () {
                                    ...
                                    for (var o = 0; o < c; ++o)
                                        (u[o] = t[o + 2].toWireType(f, arguments[o])), d.push(u[o]);
                                    if (((o = r.apply(null, d)), s)) tS(f);
                                    else
                            ...
                            function tJ(e, t, n) {
                                return (
                                    e instanceof Object || e9(`${n} with invalid "this": ${e}`),
                                    e instanceof t.i.constructor ||
                                        e9(`${n} incompatible with "this" of type ${e.constructor.name}`),
                                    e.g.o || e9(`cannot call emscripten binding method ${n} on deleted object`),
                                    tU(e.g.o, e.g.u.i, t.i)
                                );
                            }
                            function t$(e) {
                            ...
                            var t5 = "undefined" != typeof TextDecoder ? new TextDecoder("utf-16le") : void 0,
                                t4 = (e, t) => {
                            ...
                            (ti = nm),
                                ...
                                (tx.prototype.delete = function () {
                                    this.g.o || tL(this),
                                        this.g.fa && !this.g.ia && e9("Object already scheduled for deletion"),
                                        tp(this),
                                        tm(this.g),
                            ...
                            var nE = {
                                ...
                                _embind_create_inheriting_constructor: function (e, t, n) {
                                    ...
                                    (o.__construct = function () {
                                        ...
                                        e.notifyOnDestruction(),
                                            ...
                                            (e = tu(i, (e = t.o))),
                                            tc.hasOwnProperty(e)
                                                ? e9(`Tried to register registered instance: ${e}`)
                                                : (tc[e] = this);
                                    }),
                                    (o.__destruct = function () {
                                        ...
                                        (e = tu(i, e)),
                                            tc.hasOwnProperty(e)
                                                ? delete tc[e]
                                                : e9(`Tried to unregister unregistered instance: ${e}`);
                                    }),
                                    ...
                                    tk(_, function () {
                                        ...
                                        tR([e, t, n], r ? [r] : [], function (t) {
                                            ...
                                            var a = Object.create(i, {
                                                constructor: {
                                                    value: (t = e4(_, function () {
                                                        if (Object.getPrototypeOf(this) !== a)
                                                            throw new e7("Use 'new' to construct " + u);
                                                        if (void 0 === l.$)
                                                            throw new e7(u + " has no accessible constructor");
                                                        var e = l.$[arguments.length];
                                                        if (void 0 === e)
                                                            throw new e7(
                                                                `Tried to invoke ctor of ${u} with invalid number of parameters (${arguments.length}) - expected (${Object.keys(l.$).toString()}) parameters instead!`,
                                                            );
                                    ...
                                    (t = to(t)),
                                        ...
                                        tR([], [e], function (e) {
                                            ...
                                            return (
                                                void 0 === l[t]
                                                    ? ((r.ea = n - 1), (l[t] = r))
                                                    : (tM(l, t, i), (l[t].B[n - 1] = r)),
                                                tR([], s, function (r) {
                                                    if (
                                                        ((r = tX(i, [r[0], null].concat(r.slice(1)), null, o, a)),
                                                        void 0 === l[t].B
                                                            ? ((r.ea = n - 1), (l[t] = r))
                                                            : (l[t].B[n - 1] = r),
                                                        e.i.oa)
                                ...
                                _embind_register_class_constructor: function (e, t, n, r, i, o) {
                                    ...
                                    (i = tK(r, i)),
                                        tR([], [e], function (e) {
                                            ...
                                            if ((void 0 === e.i.$ && (e.i.$ = []), void 0 !== e.i.$[t - 1]))
                                                throw new e7(
                                            ...
                                            return (
                                                ...
                                                tR([], a, function (r) {
                                                    return (
                                                        r.splice(1, 0, null), (e.i.$[t - 1] = tX(n, r, null, i, o)), []
                                                    );
                                                }),
                                                []
                                            );
                                ...
                                _embind_register_class_function: function (e, t, n, r, i, o, a, s) {
                                    ...
                                    (t = to(t)),
                                        ...
                                        tR([], [e], function (e) {
                                            ...
                                            return (
                                                void 0 === u ||
                                                (void 0 === u.B && u.className !== e.name && u.ea === n - 2)
                                                    ? ((r.ea = n - 2), (r.className = e.name), (c[t] = r))
                                                    : (tM(c, t, i), (c[t].B[n - 2] = r)),
                                                tR([], l, function (r) {
                                                    return (
                                                        (r = tX(i, r, e, o, a)),
                                                        void 0 === c[t].B
                                ...
                                _embind_register_function: function (e, t, n, r, i, o) {
                                    ...
                                    (e = to(e)),
                                        ...
                                        tR([], a, function (n) {
                                            return tV(e, tX(e, [n[0], null].concat(n.slice(1)), null, i, o), t - 1), [];
                                        });
                                },
                                    ...
                                    tD(e, {
                                        ...
                                        fromWireType: function (e) {
                                            ...
                                            if (n)
                                                for (var i = r, o = 0; o <= t; ++o) {
                                                    var a = r + o;
                                                    if (o == t || 0 == S[a]) {
                                                        if (((i = i ? el(S, i, a - i) : ""), void 0 === s)) var s = i;
                                                        else (s += "\0"), (s += i);
                                                        i = a + 1;
                                                    }
                                                }
                                        ...
                                        toWireType: function (e, t) {
                                            ...
                                            r ||
                                                ...
                                                e9("Cannot pass non-string to std::string");
                                            var i = n && r ? eu(t) : t.length,
                                                o = ny(4 + i + 1),
                                                a = o + 4;
                                            if (((R[o >> 2] = i), n && r)) ed(t, S, a, i + 1);
                                            else if (r)
                                                for (r = 0; r < i; ++r) {
                                                    var s = t.charCodeAt(r);
                                                    255 < s &&
                                                        (nb(a),
                                                        e9("String has UTF-16 code units that do not fit in 8 bits")),
                                                        (S[a + r] = s);
                                                }
                                            else for (r = 0; r < i; ++r) S[a + r] = t[r];
                                ...
                                _embind_register_std_wstring: function (e, t, n) {
                                    ...
                                    tD(e, {
                                        ...
                                        toWireType: function (e, r) {
                                            "string" != typeof r &&
                                                e9(`Cannot pass non-string to C++ string type ${n}`);
                                            var a = o(r),
                                                l = ny(4 + a + t);
                                            return (
                                                (R[l >> 2] = a >> s), i(r, l + 4, a + t), null !== e && e.push(nb, l), l
                                            );
                                        },
                                        argPackAdvance: 8,
                                        readValueFromPointer: tA,
                                    ...
                                    return (
                                        (i = ni((t, i, a, s) => {
                                            for (var l = 0, c = 0; c < e - 1; ++c)
                                                (o[c] = n[c + 1].readValueFromPointer(s + l)),
                                                    (l += n[c + 1].argPackAdvance);
                                            for (c = 0, t = t[i].apply(t, o); c < e - 1; ++c)
                                                n[c + 1].Nb && n[c + 1].Nb(o[c]);
                                ...
                                emscripten_asm_const_int: (e, t, n) => {
                                    var r;
                                    for (nl.length = 0, n >>= 2; (r = S[t++]); )
                                        (n += (105 != r) & n), nl.push(105 == r ? C[n] : w[n++ >> 1]), ++n;
                            ...
                            var nb = (e) => (nb = I.free)(e),
                                ny = (e) => (ny = I.malloc)(e),
                                nO = (o._ma_device__on_notification_unlocked = (e) =>
                                    (nO = o._ma_device__on_notification_unlocked =
                                        I.ma_device__on_notification_unlocked)(e));
                            (o._ma_malloc_emscripten = (e, t) =>
                                (o._ma_malloc_emscripten = I.ma_malloc_emscripten)(e, t)),
                                (o._ma_free_emscripten = (e, t) =>
                                    (o._ma_free_emscripten = I.ma_free_emscripten)(e, t));
                            var nv = (o._ma_device_process_pcm_frames_capture__webaudio = (e, t, n) =>
                                    (nv = o._ma_device_process_pcm_frames_capture__webaudio =
                                        I.ma_device_process_pcm_frames_capture__webaudio)(e, t, n)),
                                nI = (o._ma_device_process_pcm_frames_playback__webaudio = (e, t, n) =>
                                    (nI = o._ma_device_process_pcm_frames_playback__webaudio =
                                        I.ma_device_process_pcm_frames_playback__webaudio)(e, t, n)),
                                    ...
                                    if (!n && ((n = !0), (o.calledRun = !0), !D)) {
                                        if (
                                            (o.noFSInit ||
                                                ...
                                                (o.stdout = o.stdout),
                                                (o.stderr = o.stderr),
                                                o.stdin ? e0("stdin", o.stdin) : eq("/dev/tty", "/dev/stdin"),
                                                o.stdout ? e0("stdout", null, o.stdout) : eq("/dev/tty", "/dev/stdout"),
                                                o.stderr
                                                    ? e0("stderr", null, o.stderr)
                            ...
                            if (
                                ((o.__embind_initialize_bindings = () =>
                                    (o.__embind_initialize_bindings = I._embind_initialize_bindings)()),
                                ...
                                (o.dynCall_iiiji = (e, t, n, r, i, a) =>
                                    (o.dynCall_iiiji = I.dynCall_iiiji)(e, t, n, r, i, a)),
                                (o.dynCall_iij = (e, t, n, r) => (o.dynCall_iij = I.dynCall_iij)(e, t, n, r)),
                                (o.dynCall_jii = (e, t, n) => (o.dynCall_jii = I.dynCall_jii)(e, t, n)),
                                (o.dynCall_viijii = (e, t, n, r, i, a, s) =>
                                    (o.dynCall_viijii = I.dynCall_viijii)(e, t, n, r, i, a, s)),
                                (o.dynCall_iiiiij = (e, t, n, r, i, a, s) =>
                                    (o.dynCall_iiiiij = I.dynCall_iiiiij)(e, t, n, r, i, a, s)),
                                (o.dynCall_iiiiijj = (e, t, n, r, i, a, s, l, c) =>
                                    (o.dynCall_iiiiijj = I.dynCall_iiiiijj)(e, t, n, r, i, a, s, l, c)),
                                (o.dynCall_iiiiiijj = (e, t, n, r, i, a, s, l, c, u) =>
                                    (o.dynCall_iiiiiijj = I.dynCall_iiiiiijj)(e, t, n, r, i, a, s, l, c, u)),
                                (Z = function e() {
                                    n || nA(), n || (Z = e);
                                }),
                                o.preInit)
                    ...
                    var r = void 0,
                        ...
                        o = function (e) {
                            ...
                            return (
                                ...
                                function () {
                                    t.removeEventListener("mouseover", g, !0),
                                        t.removeEventListener("mouseenter", g, !0),
                                        t.removeEventListener("mouseout", g, !0),
                                        t.removeEventListener("mouseleave", g, !0),
                                        t.removeEventListener("mousemove", g, !0),
                                        t.removeEventListener("mousedown", g, !0),
                                        t.removeEventListener("mouseup", g, !0),
                        ...
                        function n(n) {
                            ...
                            (this.fit = null != (r = null == n ? void 0 : n.fit) ? r : e.Contain),
                                ...
                                (this.layoutScaleFactor =
                                    null != (o = null == n ? void 0 : n.layoutScaleFactor) ? o : 1),
                        ...
                        return (
                            ...
                            (e.prototype.mapRuntimeInput = function (e, t) {
                                return e.type === t.SMIInput.bool
                                    ? new I(i.Boolean, e.asBool())
                                    : e.type === t.SMIInput.number
                                      ? new I(i.Number, e.asNumber())
                                      : e.type === t.SMIInput.trigger
                                        ? new I(i.Trigger, e.asTrigger())
                                        : void 0;
                            }),
                            (e.prototype.cleanup = function () {
                            ...
                            (e.prototype.initStateMachines = function (e, t) {
                                for (
                                    ...
                                    if (i >= 0) this.stateMachines[i].playing = t;
                                        ...
                                        if (o) {
                                            var a = new T(o, this.runtime, t, this.artboard);
                                        ...
                                        switch (o.label) {
                                            ...
                                            case 3:
                                                if (((r.file = o.sent()), this.destroyed))
                                                    return (
                                                        null == (i = this.file) || i.delete(), (this.file = null), [2]
                                                    );
                                                if (null !== this.file)
                                                    this.eventManager.fire({
                                                        type: a.Load,
                        ...
                        function t(e) {
                            ...
                            (this.loaded = !1),
                                ...
                                e.canvas.constructor === HTMLCanvasElement &&
                                    (this._observed = w.add(this.canvas, this.onCanvasResize)),
                                (this.src = e.src),
                                (this.buffer = e.buffer),
                        ...
                        return (
                            ...
                            (t.prototype.initArtboard = function (e, t, n, r, i) {
                                if (this.file) {
                                    ...
                                    if (
                                        ((this.artboard = s),
                                        (s.volume = this._volume * C.systemVolume),
                                                ...
                                                if (E.type === o.OpenUrl) {
                                                    if (
                                                        ...
                                                        var b = document.createElement("a"),
                                                            ...
                                                            v = y.target,
                                                            I = (0, _.sanitizeUrl)(O);
                                                        O && b.setAttribute("href", I),
                                                            v && b.setAttribute("target", v),
                                                            I && I !== _.BLANK_URL && b.click();
                                                    }
                                                } else
                                                    this.eventManager.fire({
                                                        type: a.RiveEvent,
                            ...
                            (t.prototype.cleanup = function () {
                                ...
                                (this.destroyed = !0),
                                    ...
                                    null !== this._audioEventListener &&
                                        (C.remove(this._audioEventListener), (this._audioEventListener = null)),
                                ...
                                switch (n) {
                                    ...
                                    case c.String:
                                        if (
                                            ...
                                            (b =
                                                null !=
                                                (a = null == (o = this._runtimeInstance) ? void 0 : o.string(e[t]))
                                                    ? a
                                                    : null)
                                        )
                                            return new U(b, this);
                                    ...
                                    case c.Trigger:
                                        if (
                                            ...
                                            (b =
                                                null !=
                                                (_ = null == (f = this._runtimeInstance) ? void 0 : f.trigger(e[t]))
                                                    ? _
                                                    : null)
                                        )
                                            return new Z(b, this);
