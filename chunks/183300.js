    ...
    let g = n.useCallback(() => {
        ...
        R()(null != e, "VoiceInviteSuggestionsPopover must be used in context of a guild"),
            (0, I.openModalLazy)(async () => {
                let { default: n } = await Promise.all([i.e("28136"), i.e("22547"), i.e("42738")]).then(
                    i.bind(i, 1310),
                );
...
function ep(e) {
    ...
    let R = (0, r.bG)([P.A], () => P.A.can(M.xBc.CREATE_INSTANT_INVITE, t), [t]),
        ...
        B = n.useCallback(() => {
            null != U &&
                (0, I.openModalLazy)(async () => {
                    let { default: e } = await Promise.all([i.e("28136"), i.e("22547"), i.e("42738")]).then(
                        i.bind(i, 1310),
                    );
...
function td(e) {
    ...
    return (0, l.jsxs)("div", {
        ...
        children: [
            ...
            null != p && (0, l.jsx)(e6.z, { textColor: "text-feedback-positive", entry: { start: p } }),
        ],
    });
}
function tc(e) {
    ...
    let { enabled: h } = tl.useExperiment({ guildId: s.guild_id, location: "VoiceUserPopout" }),
        ...
        I = (0, r.bG)([ei.A], () => (0, e8.nr)(g, ei.A), [g]),
        ...
        j = (0, r.bG)([e9.A], () => e9.A.getDetectableIdsToApplicationIds()),
        S = u ?? I,
