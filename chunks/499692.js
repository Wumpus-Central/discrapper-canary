    ...
    let { collection: t, index: n, onSelectApplication: i } = e,
        o = (function (e) {
            ...
            return (
                a.useEffect(() => {
                    r &&
                        (0, v.zZ)(C.rMx.APP_DIRECTORY_COLLECTION_VIEWED, {
                            collection_id: t,
...
let I = function (e) {
    let { onSelectApplication: t } = e,
        n = (0, u.e7)([f.default], () => f.default.onlyShowPreviewAppCollections) ? o.E.PREVIEW : o.E.ACTIVE,
        i = (0, u.e7)([g.Z], () =>
            g.Z.getFetchState({
                surface: y,
                activeState: n
    ...
    return i === g.M.ERROR
        ? (0, r.jsx)('div', {
              ...
              children: (0, r.jsx)(x.Z, { className: j.error })
          })
        : (0, r.jsx)(_.Z, {
