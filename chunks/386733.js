...
let v = (e) => {
        ...
        return (0, i.jsx)(o.ua7, {
            ...
            children: (e) =>
                (0, i.jsx)('div', {
                    className: l()({
                        [I.redeemedCircle]: c && (s === _.Fe.REDEEMED || s === _.Fe.CONVERTED),
                        [I.convertedCircleGlow]: c && s === _.Fe.CONVERTED,
                        [I.standardCircle]: c && (s === _.Fe.PENDING || null == s)
                    }),
    ...
    O = (e) => {
        let t,
            r,
            { isInSettings: u = !1 } = e,
            v = (0, a.e7)([x.Z], () => x.Z.getRecipientStatus()),
        ...
        v.forEach((e) => {
            e === _.Fe.REDEEMED && B.redeemed++, e === _.Fe.CONVERTED && (B.redeemed++, B.converted++);
        });
        let M = B.sent === E.Q,
