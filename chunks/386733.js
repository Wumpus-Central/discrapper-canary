...
let I = (e) => {
        ...
        return (0, r.jsx)(o.ua7, {
            ...
            children: (e) => (0, r.jsx)('div', T(v({ className: O.userAvatarProgressBarUnit }, e), { children: l }))
        });
    },
    y = (e) => {
    ...
    P = (e) => {
        let { isInSettings: t = !1 } = e,
            ...
            { referralSentUsers: u } = (0, b.G)(),
            I = i.useMemo(() => u.map((e) => new m.Z(e)), [u]),
            { subscriberHomeVariant: y } = _.g.useExperiment({ location: 'ReferralProgramProgressBar' }, { autoTrackExposure: !1 }),
            P = y === _.p.VARIANT_2,
            R = {
                redeemed: 0,
                converted: 0,
