...
let I = (e) => {
    ...
    P = (e) => {
        ...
        m.default.track(j.rMx.REFERRAL_PROGRAM_SHARE_MODAL_CTA_CLICKED, { location_stack: t }),
            (0, o.ZDy)(async () => {
    ...
    R = (e) => {
        let { isInSettings: t = !1 } = e,
            ...
            u = r.useMemo(() => s.map((e) => new g.Z(e)), [s]),
            { subscriberHomeVariant: m } = b.g.useExperiment({ location: 'ReferralProgramProgressBar' }, { autoTrackExposure: !1 }),
            T = m === b.p.VARIANT_2,
            N = {
                redeemed: 0,
                converted: 0,
                            ...
                            (0, i.jsxs)('div', {
                                ...
                                children: [
                                    ...
                                    (0, i.jsx)(o.gtL, {
                                        ...
                                        color: o.Ttl.CUSTOM,
                                        onClick: () => P({ analyticsLocations: R }),
                                        onlyShineOnHover: !0,
        ...
        return (0, i.jsx)(d.Gt, {
            ...
            children: (0, i.jsx)('div', {
                className: l()({
                    [S.containerWithGlowWithoutBanner]: k,
                    [S.containerWithoutGlow]: !k,
                    [S.containerWithMargins]: !t,
                    [S.containerWithGlowOnSettingsPage]: k && t
                }),
                children: (0, i.jsx)('div', {
                    ref: D,
                    className: l()({
                        ...
                        [S.expandedProgressBarContainerVariant1]: !T && !t,
                        [S.expandedProgressBarContainerVariant2]: T && !t,
                        [S.allReferralsSentBorder]: k
                    }),
                    children: w
                })
            })
