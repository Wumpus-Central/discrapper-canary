...
function ep(e, t) {
    ...
    (n = e.state).mode === k && (n.mode = M), (en = e.next_out), (i = e.output), (eo = e.avail_out), (et = e.next_in), (r = e.input), (er = e.avail_in), (ea = n.hold), (es = n.bits), (el = er), (ec = eo), (ev = m);
    i: for (;;)
        switch (n.mode) {
            case S:
                if (0 === n.wrap) {
                ...
                (n.dmax = 1 << eO), (e.adler = n.check = 1), (n.mode = 512 & ea ? L : k), (ea = 0), (es = 0);
                break;
            case T:
                for (; es < 16; ) {
                    if (0 === er) break i;
            ...
            case H:
                if (er >= 6 && eo >= 258) {
                    (e.next_out = en), (e.avail_out = eo), (e.next_in = et), (e.avail_in = er), (n.hold = ea), (n.bits = es), l(e, ec), (en = e.next_out), (i = e.output), (eo = e.avail_out), (et = e.next_in), (r = e.input), (er = e.avail_in), (ea = n.hold), (es = n.bits), n.mode === k && (n.back = -1);
                    break;
                }
    ...
    return ((e.next_out = en), (e.avail_out = eo), (e.next_in = et), (e.avail_in = er), (n.hold = ea), (n.bits = es), (n.wsize || (ec !== e.avail_out && n.mode < $ && (n.mode < Q || t !== _))) && e_(e, e.output, e.next_out, ec - e.avail_out)) ? ((n.mode = ee), O) : ((el -= e.avail_in), (ec -= e.avail_out), (e.total_in += el), (e.total_out += ec), (n.total += ec), n.wrap && ec && (e.adler = n.check = n.flags ? s(n.check, i, ec, e.next_out - ec) : a(n.check, i, ec, e.next_out - ec)), (e.data_type = n.bits + 64 * !!n.last + 128 * (n.mode === k) + 256 * (n.mode === Z || n.mode === U)), ((0 === el && 0 === ec) || t === _) && ev === m && (ev = v), ev);
}
function eh(e) {
