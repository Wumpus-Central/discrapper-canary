...
function ep(e, t) {
    ...
    ((n = e.state).mode === M && (n.mode = k), (en = e.next_out), (i = e.output), (eo = e.avail_out), (et = e.next_in), (r = e.input), (er = e.avail_in), (ea = n.hold), (es = n.bits), (el = er), (ec = eo), (ev = m));
    i: for (;;)
        switch (n.mode) {
            case T:
                if (0 === n.wrap) {
                ...
                if (((ea >>>= 4), (es -= 4), (eO = (15 & ea) + 8), 0 === n.wbits)) n.wbits = eO;
                else if (eO > n.wbits) {
                    ((e.msg = 'invalid window size'), (n.mode = $));
                    break;
                }
                ((n.dmax = 1 << eO), (e.adler = n.check = 1), (n.mode = 512 & ea ? L : M), (ea = 0), (es = 0));
                break;
            case S:
                for (; es < 16; ) {
                    if (0 === er) break i;
            ...
            case C:
                ...
                n.mode = R;
            case R:
                if (1024 & n.flags && ((eu = n.length) > er && (eu = er), eu && (n.head && ((eO = n.head.extra_len - n.length), n.head.extra || (n.head.extra = Array(n.head.extra_len)), o.arraySet(n.head.extra, r, et, eu, eO)), 512 & n.flags && (n.check = s(n.check, r, eu, et)), (er -= eu), (et += eu), (n.length -= eu)), n.length)) break i;
                ((n.length = 0), (n.mode = P));
            case P:
                if (2048 & n.flags) {
                    if (0 === er) break i;
            ...
            case F:
                for (; n.have < n.nlen + n.ndist; ) {
                    for (; (eh = (eS = n.lencode[ea & ((1 << n.lenbits) - 1)]) >>> 24), (em = (eS >>> 16) & 255), (eg = 65535 & eS), !(eh <= es); ) {
                        if (0 === er) break i;
                        (er--, (ea += r[et++] << es), (es += 8));
                    }
                    if (eg < 16) ((ea >>>= eh), (es -= eh), (n.lens[n.have++] = eg));
                        ...
                        if (16 === eg) {
                            ...
                            ((eO = n.lens[n.have - 1]), (eu = 3 + (3 & ea)), (ea >>>= 2), (es -= 2));
                        } else if (17 === eg) {
                            for (eT = eh + 3; es < eT; ) {
                                if (0 === er) break i;
                                (er--, (ea += r[et++] << es), (es += 8));
                            }
                            ((ea >>>= eh), (es -= eh), (eO = 0), (eu = 3 + (7 & ea)), (ea >>>= 3), (es -= 3));
                        } else {
                            for (eT = eh + 7; es < eT; ) {
                                if (0 === er) break i;
                                (er--, (ea += r[et++] << es), (es += 8));
                            }
                            ((ea >>>= eh), (es -= eh), (eO = 0), (eu = 11 + (127 & ea)), (ea >>>= 7), (es -= 7));
                        }
                ...
                if (((n.distbits = 6), (n.distcode = n.distdyn), (eI = { bits: n.distbits }), (ev = c(f, n.lens, n.nlen, n.ndist, n.distcode, 0, n.work, eI)), (n.distbits = eI.bits), ev)) {
            ...
            case H:
                ...
                if (em && (240 & em) == 0) {
                    for (eE = eh, eb = em, ey = eg; (eh = (eS = n.lencode[ey + ((ea & ((1 << (eE + eb)) - 1)) >> eE)]) >>> 24), (em = (eS >>> 16) & 255), (eg = 65535 & eS), !(eE + eh <= es); ) {
                        if (0 === er) break i;
                        (er--, (ea += r[et++] << es), (es += 8));
                    }
            ...
            case W:
                for (; (eh = (eS = n.distcode[ea & ((1 << n.distbits) - 1)]) >>> 24), (em = (eS >>> 16) & 255), (eg = 65535 & eS), !(eh <= es); ) {
                    if (0 === er) break i;
                    (er--, (ea += r[et++] << es), (es += 8));
                }
                if ((240 & em) == 0) {
                    for (eE = eh, eb = em, ey = eg; (eh = (eS = n.distcode[ey + ((ea & ((1 << (eE + eb)) - 1)) >> eE)]) >>> 24), (em = (eS >>> 16) & 255), (eg = 65535 & eS), !(eE + eh <= es); ) {
                        if (0 === er) break i;
                        (er--, (ea += r[et++] << es), (es += 8));
                    }
                    ((ea >>>= eE), (es -= eE), (n.back += eE));
    ...
    return ((e.next_out = en), (e.avail_out = eo), (e.next_in = et), (e.avail_in = er), (n.hold = ea), (n.bits = es), (n.wsize || (ec !== e.avail_out && n.mode < $ && (n.mode < X || t !== _))) && e_(e, e.output, e.next_out, ec - e.avail_out)) ? ((n.mode = ee), O) : ((el -= e.avail_in), (ec -= e.avail_out), (e.total_in += el), (e.total_out += ec), (n.total += ec), n.wrap && ec && (e.adler = n.check = n.flags ? s(n.check, i, ec, e.next_out - ec) : a(n.check, i, ec, e.next_out - ec)), (e.data_type = n.bits + 64 * !!n.last + 128 * (n.mode === M) + 256 * (n.mode === V || n.mode === U)), ((0 === el && 0 === ec) || t === _) && ev === m && (ev = v), ev);
}
function eh(e) {
