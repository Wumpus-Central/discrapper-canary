...
function ep(e, t) {
        ...
        switch (n.mode) {
            ...
            case V:
                for (; n.have < n.nlen + n.ndist; ) {
                    for (
                        ;
                        (eh = (eS = n.lencode[eo & ((1 << n.lenbits) - 1)]) >>> 24),
                            (em = (eS >>> 16) & 255),
                            (eg = 65535 & eS),
                            !(eh <= es);
                    ) {
            ...
            case H:
                ...
                if (em && (240 & em) == 0) {
                    for (
                        eE = eh, eb = em, ey = eg;
                        (eh = (eS = n.lencode[ey + ((eo & ((1 << (eE + eb)) - 1)) >> eE)]) >>> 24),
                            (em = (eS >>> 16) & 255),
                            (eg = 65535 & eS),
                            !(eE + eh <= es);
                    ) {
            ...
            case W:
                for (
                    ;
                    (eh = (eS = n.distcode[eo & ((1 << n.distbits) - 1)]) >>> 24),
                        (em = (eS >>> 16) & 255),
                        (eg = 65535 & eS),
                        !(eh <= es);
                ) {
                ...
                if ((240 & em) == 0) {
                    for (
                        eE = eh, eb = em, ey = eg;
                        (eh = (eS = n.distcode[ey + ((eo & ((1 << (eE + eb)) - 1)) >> eE)]) >>> 24),
                            (em = (eS >>> 16) & 255),
                            (eg = 65535 & eS),
                            !(eE + eh <= es);
                    ) {
    ...
    (n.wsize || (ec !== e.avail_out && n.mode < $ && (n.mode < X || t !== _))) &&
        ...
        : ((el -= e.avail_in),
          ...
          (e.data_type = n.bits + 64 * !!n.last + 128 * (n.mode === j) + 256 * (n.mode === F || n.mode === U)),
