...
function O(e) {
    let { className: t } = e;
    return (0, o.jsx)("div", { className: h()(R.z, t) });
}
var b = n(254179);
function D(e) {
...
function k(e) {
    ...
    return (0, o.jsx)(D, {
        ...
        image: (0, o.jsx)("div", {
            ...
            children:
                null != i
                    ? (0, o.jsx)(M, { alt: "", media: i.media, className: h()(x.c8, P.g) })
                    : (0, o.jsx)(O, { className: x.pm }),
        }),
    });
}
var U = n(123292),
    ...
    return (0, o.jsx)(F, {
        image:
            null != n
                ? (0, o.jsx)("div", {
                      className: j.Xr,
                      children: (0, o.jsx)(M, { media: n.media, className: h()(j.c8, P.g) }),
                  })
                : (0, o.jsx)(O, { className: j.pm }),
    });
}
var Y = n(82433);
function W(e) {
...
function q() {
    ...
    return (0, o.jsxs)("div", {
        ...
        children: [
            null != i
                ? (0, o.jsx)("img", { src: i.media.url, className: $.Sl, alt: "" })
                : (0, o.jsx)(O, { className: $.Sl }),
            (0, o.jsxs)("div", {
                className: $.Qs,
                children: [
                    (0, o.jsx)("div", {
                        ...
                        children: (0, o.jsx)("div", { className: $.qB, style: { "--custom-progress": `${c}%` } }),
                    }),
                    (0, o.jsxs)("div", {
                        className: $.P_,
                        children: [
        ...
        children: [
            ...
            (t = (() => {
                ...
                : (0, o.jsxs)("div", {
                      className: Z.U,
                      children: [
                          (0, o.jsx)(f.E, { variant: "text-sm/medium", lineClamp: 2, children: t }),
                          null != c && (0, o.jsx)(I, { variant: "text-sm/medium", media: c.media }),
                      ],
                  }),
            null != u
                ? (0, o.jsx)(f.E, { variant: "text-xs/normal", color: "text-subtle", lineClamp: 2, children: u.value })
                : (0, o.jsx)(S, { variant: "text-xs/normal", width: "6ch" }),
        ],
    });
}
        ...
        children: [
            ...
            null != i
                ? (0, o.jsx)("div", {
                      ...
                      children: (0, o.jsx)("div", {
                          className: er.PX,
                          children: (0, o.jsx)("img", { alt: "", src: i.media.url, className: h()(er.Sl, P.g) }),
                      }),
                  })
                : (0, o.jsx)(O, { className: er.h2 }),
        ],
    });
}
...
let el = {
    ...
    [c.m.ADD_WIDGET_PREVIEW]: {
        [d.ADD_WIDGET_PREVIEW_HERO]: (e) => (0, o.jsx)(k, { ...e }),
