...
function x() {
    ...
    return (0, n.jsx)(r.A, { submitting: h, onSave: S, onReset: p, disabled: !t, errorMessage: T ?? void 0 });
}
var T = i(631670),
    S = i(933725),
    p = i(885386),
    ...
    let { canSubmit: e, errors: t } = (0, l.cf)([u.A], () => ({ canSubmit: u.A.canSubmit(), errors: u.A.getErrors() })),
        ...
        m = s.useCallback(async () => {
            ...
            if (void 0 !== e.pendingLegacyUsernameDisabled)
                try {
                    await p.m$.updateSetting(e.pendingLegacyUsernameDisabled), (0, T._e)();
                } catch {
                    h(), (s = !1);
                }
            if (Object.keys(n).length > 0) {
...
var C = i(507553),
    _ = i(355097);
function I() {
    return C.A.useField("subsection") === _.Eq.GUILD ? (0, n.jsx)(x, {}) : (0, n.jsx)(f, {});
}
