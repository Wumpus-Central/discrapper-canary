n.d(t, { Z: () => F }), n(704826), n(35282), n(290780);
var r = n(913527),
    i = n.n(r),
    l = n(570140),
    a = n(241601),
...
function R(e, t, n, r) {
    let l = b.Z.getGuild(n),
        a = e
            .replace(L, j.NW.string(j.t['F+x38P']))
            .replace(/<@!?(\d+)>/g, (e, t) => {
                var r;
                let i = I.default.getUser(t);
                return null == i ? e : null != (r = m.ZP.getNick(n, i.id)) ? r : v.ZP.getName(i);
            })
            .replace(/<@&?(\d+)>/g, (e, t) => {
            ...
            .replace(/<#(\d+)>/g, (e, t) => {
                ...
                return null == n ? e : (0, s.F6)(n, I.default, O.Z);
            })
...
async function k(e, t, n, r, i) {
    let l = o.e6(e, n);
    null !== l && (null == x && D(), t ? await (0, C.NB)() : null == Z || Z.removeEventListener('end', C.NB), l.addEventListener('end', C.NB), null != r && l.addEventListener('start', r), null != i && l.addEventListener('end', i), (Z = l), o.iq(l, x));
}
...
function G() {
    return null !== Z && Z.removeEventListener('end', C.NB), o.M9(), (Z = null), !0;
}
function W(e) {
    var t, n, r;
    let { message: i, channel: l } = e,
        ...
        s = null != o ? (null != (n = m.ZP.getNick(l.guild_id, null == o ? void 0 : o.id)) ? n : v.ZP.getName(o)) : null,
        c = l.getGuildId(),
        d = null != (r = m.ZP.getNick(c, i.author.id)) ? r : v.ZP.getName(i.author);
...
function V(e) {
    ...
    let d = N.Z.getChannelId(),
        ...
        I = o === d || o === b,
        C = p.OW.getSetting() && s.tts && I,
        S = E.Z.getTTSType(),
        j = (null == (t = s.author) ? void 0 : t.id) !== h.default.getId() && (S === P.PrB.ALL_CHANNELS || (S === P.PrB.SELECTED_CHANNEL && I));
    if ((C || j) && !O.Z.isBlockedOrIgnoredForMessage(s)) {
        ...
        let t = null != (l = null != (i = m.ZP.getNick(e, null == (n = s.author) ? void 0 : n.id)) ? i : v.ZP.getName(s.author)) ? l : '',
            c = s.type === P.uaV.REPLY ? (null == (r = s.referenced_message) ? void 0 : r.author) : null,
            d = null != c ? (null != (a = m.ZP.getNick(e, null == c ? void 0 : c.id)) ? a : v.ZP.getName(c)) : null;
...
let F = {
    init() {
        l.Z.subscribe('SPEAK_TEXT', U), l.Z.subscribe('SPEAK_MESSAGE', W), l.Z.subscribe('STOP_SPEAKING', G), l.Z.subscribe('MESSAGE_CREATE', V), l.Z.subscribe('MESSAGE_DELETE', B), l.Z.subscribe('AUDIO_TOGGLE_SELF_DEAF', H), l.Z.subscribe('USER_SETTINGS_PROTO_UPDATE', D), (0, a.Ql)(D);
    }
};
