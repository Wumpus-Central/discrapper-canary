...
var i = n(255367),
    ...
    I = n(73433);
function O(e) {
    let { context: t, application: n, videoUrl: l, imageCoverUrl: c, sectionName: u, hasCommands: p } = e,
        m = r.useMemo(() => {
            var e;
...
function T(e) {
    var t;
    let { application: n } = e,
        r = (0, x.BQ)(n) ? n.name : null != (t = (0, x.$d)(n)) ? t : '',
        l = (0, x.vJ)(n);
    return (0, i.jsxs)('div', {
...
function R(e) {
    ...
    let r = null != (t = (0, x.BQ)(n) ? (n instanceof C.ZP ? n.maxParticipants : n.max_participants) : 0) ? t : 0;
    return (0, i.jsxs)('div', {
        className: A.tagContainer,
        children: [
            (0, i.jsx)(c.BFJ, {
