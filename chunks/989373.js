    ...
    let { withTitleBar: t, windowKey: n } = e,
        d = (function (e, t) {
            let n = (0, r.e7)([S.Z], () => !p.isPlatformEmbedded || S.Z.isWindowHandleInitialized()),
                ...
                k = o.useRef(!1);
            o.useEffect(() => {
                if (!m.current && ((0, T.Z)("hasUseEffectFired", !0), (0, T.Z)("trackedPidFocused", d), n)) {
                    ...
                    (m.current = !0), (0, T.Z)("reactInitializationStarted", !0), A(a, e);
                }
            }, [A, d, e, a, n]),
                (0, c.zq)(() => {
                    clearInterval(O.current), (P.current = !0);
                });
