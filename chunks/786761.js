...
function P(e) {
    ...
    let f,
        ...
        V = e.content;
    return new d.ZP(
        (e.type === v.uaV.PREMIUM_REFERRAL ? ((f = E.default.isProbablyAValidSnowflake(e.content) ? e.content : void 0), (V = '')) : e.type === v.uaV.CHAT_WALLPAPER_SET && ((h = (0, o.Z)(e.content)), (V = '')), C(e))
            ? T(I({}, L), {
                  id: e.id,
