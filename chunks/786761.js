...
function R(e) {
    ...
    let h,
        ...
        V = e.content;
    return new d.ZP(
        (e.type === O.uaV.PREMIUM_REFERRAL ? ((h = E.default.isProbablyAValidSnowflake(e.content) ? e.content : void 0), (V = '')) : e.type === O.uaV.CHAT_WALLPAPER_SET && ((m = (0, a.Z)(e.content)), (V = '')), C(e))
            ? S(I({}, U), {
                  id: e.id,
