...
function P(e) {
    ...
    let f,
        ...
        F = e.content;
    return new d.ZP(
        (e.type === O.uaV.PREMIUM_REFERRAL ? ((f = E.default.isProbablyAValidSnowflake(e.content) ? e.content : void 0), (F = '')) : e.type === O.uaV.CHAT_WALLPAPER_SET && ((h = (0, a.Z)(e.content)), (F = '')), C(e))
            ? T(I({}, L), {
                  id: e.id,
