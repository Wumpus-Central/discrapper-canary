...
var i = n(200651),
    ...
    N = n(112650);
function C(e) {
    let { user: t, currentUser: n, guildId: C, channelId: R, messageId: O, roleId: D, closePopout: L, setPopoutRef: x, disableUserProfileLink: P = __OVERLAY__, newAnalyticsLocations: w = [] } = e,
