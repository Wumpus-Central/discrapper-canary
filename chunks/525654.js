(e = r.nmd(e)),
    function () {
        ...
        function C(e) {
            ...
            if ((U && (n = /(?:[ab]|dp|pre|[ab]\d+pre)(?:\d+\+?)?$/i.exec(U) || /(?:alpha|beta)(?: ?\d)?/i.exec(e + ';' + (k && s.appMinorVersion)) || (/\bMinefield\b/i.test(e) && 'a')) && ((M = /b/i.test(n) ? 'beta' : 'alpha'), (U = U.replace(RegExp(n + '\\+?$'), '') + ('beta' == M ? O : R) + (/\d+\+?/.exec(n) || ''))), 'Fennec' == G || ('Firefox' == G && /\b(?:Android|Firefox OS)\b/.test(V)))) G = 'Firefox Mobile';
