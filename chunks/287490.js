...
function v() {
    let { experiments: e, overridesInfo: t } = (0, g.Q)(),
        ...
        a = r.useMemo(() => C({}, n, e), [n, e]),
        l = r.useMemo(() => C({}, s, t), [s, t]),
        [o, d] = r.useState(''),
...
function S(e) {
    ...
    let P = '';
    return (
        (P = t.system === u.I.LEGACY ? 'Currently assigned to bucket '.concat(null != T ? T : E.NZ.NOT_ELIGIBLE) : null != T ? 'Currently assigned to variant '.concat(T) : 'Currently unassigned'),
        (0, i.jsxs)('div', {
            className: O.group,
            children: [
                (0, i.jsxs)(c.hjN, {
