...
let b = {
    ...
    _ = r.memo(function (e) {
        let {
            ...
            R = r.useMemo(
                () => (0 === k.length ? f.bt : k.reduce((e, t) => e + t.width, 0) + (P ? 0 : Z * (k.length - 1))),
                [k, P, Z],
            ),
            L = (0, s.Yzy)(
                k,
            ...
            M = (0, h.ee)(() => new Set(I.map((e) => e.user.id)), [I, j]),
            z = (0, h.ee)(() => new Set(I.filter((e) => x.has((0, u.V9)(e.stream))).map((e) => e.user.id)), [I, x, j]);
        return (
            r.useEffect(() => {
                0 !== M.size &&
