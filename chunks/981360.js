...
function eN(e) {
    let { productRecord: t, productName: n, selectedProduct: i, previewingVariantIndexProps: l } = e,
        ...
        o = b(t, a) ?? i,
        u = Q(o),
        { disabledReason: m } = (0, eg.I)(i.skuId),
        p = (0, y.Q)(t),
        x = (0, L.B1)(t),
        ...
        (0, s.jsxs)(s.Fragment, {
            children: [
                (0, s.jsxs)("div", {
                    className: ef.sn,
                    children: [
                        (0, s.jsx)(H.D, { ref: g, variant: "heading-xl/bold", className: ef.R_, children: n }),
                            ...
                            null != E &&
                                (0, s.jsx)(U.E, {
                                    ...
                                    children: K.intl.format(K.t.EcaRWt, {
                                        value: (0, s.jsx)("span", { className: ef.I8, children: E.variantLabel }),
                                    }),
                                }),
                            (0, s.jsx)("div", {
                                className: ef._x,
...
function eG(e) {
    let { product: t, user: n, pendingProfile: i, activeBundleSlide: r } = e,
        ...
        { firstAvatarDecoration: x, firstProfileEffect: E, firstNameplate: g, firstProfileFrame: h } = (0, er.f5)(t),
        f = o?.type === D.R.AVATAR_DECORATION ? o : x,
        v = o?.type === D.R.PROFILE_EFFECT ? o : E,
        N = o?.type === D.R.PROFILE_FRAME ? o : h,
        j = o?.type === D.R.NAMEPLATE ? o : g;
...
let e1 = {
    [ej.COLLECTIBLE]: { LeftPreview: em, Info: eN, RightPreview: eU },
    [ej.BUNDLE]: {
        LeftPreview: em,
        Info: function (e) {
            let {
    ...
    [ej.EXTERNAL_ORB_BADGE]: { LeftPreview: ex, Info: eN, RightPreview: e0 },
    [ej.EXTERNAL_FRACTIONAL_NITRO]: { LeftPreview: ex, Info: eN, RightPreview: e0 },
    [ej.EXTERNAL_GENERIC]: { LeftPreview: ex, Info: eN, RightPreview: e0 },
};
function e2(e) {
    var t;
    return e1[
...
function tT(e) {
    ...
    let { showDiscountPrice: p, originalPrice: x, finalPrice: E } = o;
    return (0, s.jsxs)("div", {
        className: F()(t_.kG, l),
        children: [
    ...
    return (0, s.jsxs)("div", {
        ...
        children: [
            (0, s.jsxs)("div", {
                className: tz.fZ,
                children: [
                    (0, s.jsx)(e5.TagIcon, { size: "xs", color: "currentColor", className: tz.CE }),
...
function tW(e) {
    let {
        ...
        { cardId: g, sessionId: h, tilePosition: f } = (0, C.uM)() ?? {},
        v = (0, tc.L)(eX.PremiumTypes.TIER_2),
        N = (0, _.xM)(t),
        A = eD.Ay.canUseShopDiscounts(t),
        I = (0, V.g)(i),
        y = (0, tp.MX)(I),
        T = (0, tp.Jl)(I),
        k = r.useMemo(
        ...
        { isDisabled: D } = (0, eg.I)(i.skuId),
        b = (0, _.Zu)({ product: i, isPartiallyOwnedBundle: S, isPurchased: P }),
        w = (0, o.bG)([tu.A], () => tu.A.isClaiming === i?.skuId),
        M = (0, tr.Ay)(),
        B = (0, te.M)(M),
        G = (0, _.G0)(i),
        H = (0, _.yt)(i, O.lid.DEFAULT),
        z = H?.amount === 0,
        Z = (0, tF.X)(i),
        Y = T ? tA.Hi.FIAT : c === ee.G2.ORBS && a ? tA.Hi.ORBS : void 0,
        { checkoutEligiblePrices: $, hasSufficientOrbs: q } = (0, tG.F)({
            product: i,
            hasShopDiscount: A,
            prioritizedCurrency: Y,
        }),
        J = r.useMemo(() => (0, _.fT)(i, A, $[0]?.currency), [i, A, $]),
        Q = r.useMemo(() => $.some((e) => e.currency === tb.Yr.DISCORD_ORB), [$]);
    (0, td.W)({ disableFetch: !Q });
    let et = r.useCallback(() => {
        (E(ee.sH.BUY_WITH_FIAT),
            (0, tl.A)({
                skuId: i.skuId,
                analyticsLocations: m,
    ...
    return (0, s.jsxs)("div", {
        ...
        children: [
            L.isPurchased || L.isPartiallyOwnedBundle
                ? (0, s.jsx)(tg, { className: tz.On, isPartiallyPurchased: S })
                : G
                  ? (0, s.jsxs)("div", {
                        className: tz.pq,
                        children: [
                    ...
                    if (G && !v && !z) {
                        ...
                        return (
                            ...
                            (0, s.jsx)(ta.A, {
                                ...
                                onClick: () => {
                                    (E(ee.sH.UNLOCK_WITH_NITRO), (0, tf.M)());
                                },
                        ...
                        ? P
                            ? Z
                                ? (0, s.jsxs)(ti.e, {
                                      ...
                                      fullWidth: !0,
                                      children: [
                                          (0, s.jsx)(tj, { product: i, onSuccess: x, onTrackClick: E }),
                                          (0, s.jsx)(th.A, {
                                              primary: !0,
                                              product: i,
                                              onSuccess: x,
                            ...
                            : G
                              ...
                              : (0, s.jsx)(s.Fragment, {
                                    children: $.map((e, t) => {
                                        ...
                                        return (0, s.jsx)(r.Fragment, { children: g }, e.currency);
                                    }),
                                })
                        : Z
                          ? (0, s.jsx)(th.A, {
...
function t7(e) {
    let {
        ...
        A = r.useCallback(() => {
            (h(ee.sH.GO_TO_COLLECTION), g(), j(x, "go_to_collection_button"));
        }, [x, g, h, j]),
        R = r.useCallback(() => {
            N <= 1 || o((e) => (e - 1 + N) % N);
        }, [N, o]),
    ...
    return (
        ...
        (0, s.jsxs)("div", {
            ...
            children: [
                ...
                v && N > 1 && (0, s.jsx)(t5, { goPrev: R, goNext: y }),
                (0, s.jsxs)("div", {
                    className: t9.VG,
                    children: [
                        (0, s.jsx)(tJ.R, {
...
let ne = (0, u.FT)(u._3.SIZE_152),
    nt = function (e) {
        let {
            ...
            z = (0, o.bG)([A.default], () => A.default.getCurrentUser()),
        ...
        let { analyticsLocations: $ } = (0, E.Ay)([...B, x.A.COLLECTIBLES_SHOP_DETAILS_MODAL]);
        (0, S.Yr)(Y.skuId);
        let q = (0, w.U1)(l),
            [J, Q] = r.useState(0);
        r.useEffect(() => {
