...
function ec(e) {
    let { error: t, onLock: n, onReload: s, onDisable: o, onCrashDisabled: l } = e,
        ...
        [d, u] = i.useState(!1),
        [h, f] = i.useState(!1),
        g = (0, p.bG)([X.default], () => X.default.getCurrentUser());
    (0, Y.Ay)(
        () => (
...
class eE extends i.Component {
    ...
    componentDidMount() {
        ...
        null == t.querySelector("title") && null != t.head && t.head.appendChild(t.createElement("title")),
            ...
            ep.isPlatformEmbedded
                ? t.addEventListener("contextmenu", eg.contextMenuCallbackNative, !1)
                : t.addEventListener("contextmenu", eg.contextMenuCallbackWeb, !1),
    ...
    beforeUnload = (e) => {
        let { onBeforeUnload: t } = this.props,
            n = () => {
                ey.A.unmountWindow(this.props.windowKey), ep.isPlatformEmbedded && em.Ay.close(this.props.windowKey);
            };
    ...
    componentWillUnmount() {
        ...
        this.unregisterPopoutGlobalKeybinds(),
            ...
            ep.isPlatformEmbedded
                ? t.removeEventListener("contextmenu", eg.contextMenuCallbackNative)
                : t.removeEventListener("contextmenu", eg.contextMenuCallbackWeb),
            (0, d.r)(() => g.useModalsStore.setState((e) => ({ ...e, [m.KX]: [] }))),
...
let eC = i.forwardRef(function (e, t) {
    ...
    eN = i.forwardRef(function (e, t) {
        let { guestWindow: n, isFullScreen: i } = (0, p.cf)([ey.A], () => ({
