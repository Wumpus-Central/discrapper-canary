...
function d(e) {
    return class extends i.PureComponent {
        ...
        render() {
            ...
            return null != n.end
                ? (0, r.jsx)(e, c(s({}, i), { message: a.intl.formatToPlainString(a.t["I/J7vL"], d) }))
                : null != n.start
                  ? (0, r.jsx)(e, c(s({}, i), { message: a.intl.formatToPlainString(a.t.M9Fexc, d) }))
                  : null;
        }
        constructor(e) {
            super(e),
                o(this, "_interval", void 0),
                (this._interval = new l.Xp()),
                (this.state = s({}, this.getUpdatedTime()));
        }
    };
}
