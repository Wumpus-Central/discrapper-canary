...
let g = {},
    ...
    O = {};
function R() {
    for (let e in ((g = {}), (S = {}), (A = {}), (I = {}), (T = {}), (N = _.A.getChannelId()), O)) clearTimeout(O[e]);
    (O = {}),
        E.A.forEachGuild((e) => {
            C(e);
        }),
...
function v(e) {
    for (let t in (delete g[e], delete S[e], delete A[e], delete I[e], delete T[e], C(e), I[e])) L(e, t);
}
function C(e) {
    let t = E.A.getThreadsForGuild(e);
    for (let e in t)
        for (let n in t[e]) {
            F(n);
            ...
            if (null != t) {
                ...
                B(g, e, n, !1), B(S, e, i ? n : null, !1), B(A, e, r ? n : null, !1), s && V(e, !0);
            } else {
                B(I, e, e, !1);
                let t = c.Ay.isForumPostUnread(e.id);
                B(T, e, t ? e : null, !1);
            }
        }
}
...
function L(e, t) {
    ...
    if (null == r) return;
    let i = c.Ay.getTrackedAckMessageId(t);
    if (null == i) {
        let e = Date.now();
        null != r.joinedAt &&
    ...
    for (let n in I[e][t])
        t === N
            ? c.Ay.isNewForumThread(n, t, r) && y[e][t]++
            : f.default.compare(n, i) > 0 && !c.Ay.hasOpenedThread(n) && y[e][t]++;
}
function w(e, t, n) {
    if (null == t) return !1;
    let r = u.A.getChannel(n),
        i = h.A.joinTimestamp(n);
    if (null != r && E.A.isActive(e, t, n)) {
        if (null != i) {
            ...
            let e = c.Ay.isForumPostUnread(r.id);
            B(g, r, null, !0), B(A, r, null, !0), B(S, r, null, !0), B(I, r, r, !0), B(T, r, e ? r : null, !0), F(r.id);
        }
        L(e, t);
    } else H(g, e, t, n), H(S, e, t, n), H(A, e, t, n), H(I, e, t, n), H(T, e, t, n), F(n), L(e, t);
}
function M(e) {
...
function P(e) {
    ...
    return null != t && !!E.A.isActive(e.guildId, t.parent_id, e.id) && w(t.guild_id, t.parent_id, t.id);
}
function U(e) {
    ...
    if (null == t) k();
        ...
        if (Y(g, t)) {
            ...
            let l = g[e][n][t.id],
                u = r ? l : null,
                d = i ? l : null;
            B(A, t, u, !0), B(S, t, d, !0), L(e, n);
        } else {
            let e = Y(T, t),
                n = c.Ay.isForumPostUnread(t.id);
            if (n === e) return !1;
            B(T, t, n ? t : null, !0);
        }
    }
    ...
    for (let e in ((A = {}), (S = {}), g))
        for (let t in g[e])
            for (let n in g[e][t]) {
                ...
                i && B(A, r.channel, r, !1), s && B(S, r.channel, r, !1), V(r.channel, a);
            }
    for (let e in ((T = {}), I))
        for (let t in I[e])
            for (let n in I[e][t]) {
                let r = I[e][t][n];
                c.Ay.isForumPostUnread(n) && B(T, r, r, !1);
            }
    b();
}
function x() {
...
function G(e) {
    let t = c.Ay.getMentionCount(e.id) > 0,
        n = c.Ay.hasUnread(e.id) && !h.A.isMuted(e.id),
        r = e.hasFlag(m.lx.PINNED),
        i = e.isActiveThread(),
        s = i && (0, p.A)(e) > Date.now();
...
class X extends s.Ay.Store {
    ...
    initialize() {
        this.waitFor(E.A, u.A, d.A, h.A, c.Ay, _.A), this.syncWith([_.A], x);
    }
        ...
        return (
            null != t.guild_id &&
                ...
                t.guild_id in S &&
                    ...
                    (f.default.keys(S[t.guild_id][t.parent_id]).forEach(F),
