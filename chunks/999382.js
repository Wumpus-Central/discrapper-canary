...
function eb(e) {
    if (null == s) return !1;
    let t = r;
    if (((r = e.section), (i = e.subsection), r === M.pNK.INSTANT_INVITES || r === M.pNK.INVITES))
        b.tn
            .get({
...
function ez(e) {
    ...
    null != s &&
        t === s.id &&
        (s = (0, v.t8)(s, "features", s.features.union(new Set([M.GuildFeatures.PIN_PERMISSION_MIGRATION_COMPLETE]))));
}
function eq(e) {
...
function e0(e) {
    ...
    -1 !== i && ((t = [...el.secondaryCategoryIds]).splice(i, 1), (el = Z(G({}, el), { secondaryCategoryIds: t }))),
...
class e9 extends (_ = E.ZP.Store) {
    initialize() {
        this.waitFor(N.Z, I.Z, R.default);
    }
    getMetadata() {
        return el;
    }
