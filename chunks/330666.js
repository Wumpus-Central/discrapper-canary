e.exports = function (e) {
    let t = "a-zA-Z_\\-!.?+*=<>&#'",
        ...
        s = { begin: "[\\[\\{]", end: "[\\]\\}]", relevance: 0 },
        l = { className: "comment", begin: "\\^" + a },
        c = e.COMMENT("\\^\\{", "\\}"),
        _ = { className: "symbol", begin: "[:]{1,2}" + a },
        d = { begin: "\\(", end: "\\)" },
        m = { endsWithParent: !0, relevance: 0 },
        p = [d, r, l, c, i, _, s, n, o, { begin: a, relevance: 0 }];
    return (
        (d.contains = [
            e.COMMENT("comment", ""),
            {
        ...
        (m.contains = p),
        (s.contains = p),
        { name: "Hy", aliases: ["hylang"], illegal: /\S/, contains: [e.SHEBANG(), d, r, l, c, i, _, s, n, o] }
    );
};
