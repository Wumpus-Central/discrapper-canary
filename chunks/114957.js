...
class d extends a.Z {
    handlePostConnectionOpen() {
        (0, c.isDesktop)() && (s.Z.fetched || (0, i.b8)(), r.Z.getDetectableGames(), (this.intervalId = setInterval(r.Z.getDetectableGames, o.Z.detectableGamesTtl + Math.random() * l.Z.Millis.HOUR)));
    }
    _terminate() {
