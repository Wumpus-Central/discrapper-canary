...
function J(e) {
    ...
    let {
        ...
        [ej, ex] = l.useState(!1),
        eT = (0, _.il)(ee),
        [eD, eR] = l.useState(eT.percentComplete),
        [eP, eI] = l.useState(!1),
        [eN, ek] = l.useState(!0),
        [ew, eA] = l.useState(!1),
        [eL, eM] = l.useState([]),
    ...
    (0, p.Ng)(() => {
        e4.current &&
            ...
            e6 && eX.timestampSec >= eX.duration && e$(ee.id, 0, eX.duration));
    });
    let {
            videoVariant: tc,
            videoAsset: tu,
        ...
        tT = l.useRef(null),
        tD = ee.id,
        tR = ee.config.application.id,
        tP = ee.config.application.name,
    ...
    let tk = l.useCallback(() => {
        ...
        { forceSendCurrentSegment: tw } = (0, P.Z)({
    ...
    let t6 = eC === V.rq.ENDED,
        ...
        t5 = e6 || eX.maxTimestampSec >= (null != (B = null == (m = e2.current) ? void 0 : m.currentTime) ? B : 0) + 1,
    ...
    return (0, r.jsx)(f.P3F, {
        ...
        children: (0, r.jsxs)("div", {
            ...
            children: [
                ...
                (0, r.jsxs)(g.Z, {
                    ...
                    onTimeUpdate: (e) => {
                        null != e2.current &&
                            ...
                            eR((e2.current.currentTime / e2.current.duration) * 100));
                    },
                    onEnded: (e) => {
                        null != e2.current &&
                ...
                eC === V.rq.PAUSED && e7 === j.yE.LOST_FOCUS && (0, r.jsx)(K, {}),
                eu &&
                    eC !== V.rq.ENDED &&
                    (0, r.jsxs)(r.Fragment, {
                        children: [
