...
function S() {
    ...
    return (0, n.jsx)(r.A, { submitting: h, onSave: x, onReset: p, disabled: !t, errorMessage: T ?? void 0 });
}
var T = i(631670),
    x = i(933725),
    p = i(885386),
            ...
            if (Object.keys(t).length > 0) {
                ...
                if (((s = s && (i?.ok ?? !1)), i?.ok)) {
                    ...
                    void 0 !== e.pendingAvatar &&
                        ...
                        (0, T.pZ)();
                } else i?.body?.username != null && (0, f.E)();
            }
            if (Object.keys(i).length > 0) {
...
var _ = i(507553),
    I = i(355097);
function C() {
    return _.A.useField("subsection") === I.Eq.GUILD ? (0, n.jsx)(S, {}) : (0, n.jsx)(N, {});
}
