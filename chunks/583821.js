...
function Q() {
    ...
    return a.useMemo(() => (null == l ? null : K.intl.formatToPlainString(K.t.BXpdIg, { days: Math.max(l, 1) })), [l]);
}
var Z = t(44724);
function ee(e, l, t, n) {
    let { heroWidth: a } = n,
        s = [],
        r = [];
    if (null == e || 0 === e.length) return [s, r];
    for (let n of e) {
        ...
        null != e &&
            ...
            e.mime_type.startsWith("video/")
                ? r.push({
                      type: "video",
                      src: (0, Y.YE)(l, e, a, "mp4"),
                      videoThumbnailSrc: (0, Y.YE)(l, e, a, "webp"),
                      thumbnailSrc: null != n.thumbnailAssetId ? (0, Y.YE)(l, n.thumbnailAssetId, 112, "webp") : void 0,
                      backgroundSrc: null != n.backgroundAssetId ? (0, Y.YE)(l, n.backgroundAssetId, a, F.pV) : void 0,
                  })
                : r.push({
                      type: "image",
                      src: (0, Y.YE)(l, e, a, "webp"),
                      thumbnailSrc: null != n.thumbnailAssetId ? (0, Y.YE)(l, n.thumbnailAssetId, 112, "webp") : void 0,
                      backgroundSrc: null != n.backgroundAssetId ? (0, Y.YE)(l, n.backgroundAssetId, a, F.pV) : void 0,
                  }));
    }
    ...
    let { sku: l, location: t, analyticsLocations: s, onCheckout: r } = e,
        ...
        o = (function (e) {
            let { orbPriceAmount: l, location: t } = e,
                n = J({ location: t }),
                a = (0, c.bG)([ej.default], () => ej.default.getCurrentUser()?.hasPaidTier2Subscription() ?? !1),
                { balance: s } = (0, D.W)({ disableFetch: !n || null == l || !a });
            return n && null != l
                ? a
                    ? null == s || s < l
                        ? "NOT_ENOUGH_ORBS"
                ...
                a.useEffect(() => {
                    if (null != s)
                        return (
                            ...
                            () => {
                                s.removeEventListener("mouseenter", u), s.removeEventListener("mouseleave", d);
                            }
                        );
                }, [s, u, d]),
                {
...
function eR(e) {
    let { item: l, isMuted: t, className: s, alt: i = "" } = e,
        o = (function (e) {
                    ...
                    null != s && null != a
                        ? (0, n.jsxs)(n.Fragment, {
                              children: [
                                  ...
                                  (0, n.jsx)(m.E, { variant: "text-md/semibold", color: "text-strong", children: a }),
                                  (0, n.jsx)(m.E, { variant: "text-md/bold", className: eD.Fi, children: s }),
                              ],
                          })
...
function ew(e) {
    let {
        ...
        N = a.useMemo(() => [...u, I.A.SLAYER_STOREFRONT_PRODUCT_DETAILS_MODAL_PURCHASE_BUTTON], [u]),
        k = a.useCallback(() => {
            null != E &&
                ...
                (0, M.B4)({
                    ...
                    applicationId: l.applicationId,
                    onComplete: () => {
                        (0, en.j)(), (0, et.n)({ sku: l, application: E, analyticsLocations: N });
                    },
    ...
    return (0, n.jsxs)("div", {
        ...
        children: [
            ...
            f && (0, n.jsx)(eA, { sku: l, location: "product_details_modal", analyticsLocations: N, onCheckout: k }),
        ],
    });
}
function eB(e) {
    ...
    return (0, n.jsxs)("div", {
        className: eD.HI,
        children: [
            null != a && (0, n.jsx)("img", { className: eD.IX, src: a, alt: "" }, a),
...
function eH(e) {
    ...
    return (0, n.jsx)(g.D, { onClick: l, className: eD.jU, "aria-label": a, role: "button", children: t });
}
function eY(e) {
    let { selectedCarouselItem: l, title: t, description: a, applicationId: s, className: r } = e;
    return (0, n.jsxs)("div", {
        className: r,
        children: [
            null != t && (0, n.jsx)(u.D, { variant: "heading-md/semibold", color: "text-strong", children: t }),
            (0, n.jsx)(eB, { applicationId: s, selectedCarouselItem: l }),
            null != a && (0, n.jsx)(m.E, { variant: "text-sm/normal", color: "text-subtle", children: a }),
        ],
    });
}
function eF(e) {
                ...
                (0, n.jsxs)("div", {
                    ...
                    children: [
                        ...
                        (0, n.jsxs)("div", {
                            className: eD.il,
                            children: [
                                (0, n.jsx)(eR, { item: z[en], isMuted: L, alt: es?.label ?? M.name }),
                                (0, n.jsxs)("div", {
                                    className: eD.V7,
                                    children: [
                                        null != M &&
...
function eZ(e) {
    ...
    return null != l && "#000000" !== t ? s : void 0;
}
function e0(e) {
    let { item: l, onPlay: t, onEnded: a, onClick: s, playable: r, isMuted: i } = e,
        o = eZ(l),
        c = (0, n.jsx)(
            eE.rr,
            {
    ...
    return r
        ...
        : (0, n.jsx)(g.D, { className: eX.AU, onClick: s, style: u, children: c });
}
function e1(e) {
    let { item: l, setHasInteracted: t, onSetItem: a, isCurrentItem: s, itemIndex: r } = e,
        i = { background: eZ(l) };
    return s
        ? (0, n.jsx)(g.D, {
              onClick: () => t(!0),
    ...
    let {
        ...
        I = (0, a.useCallback)(
            (e, t) => {
                let n = l[e]?.backgroundSrc,
                    a = t.interpolate({ inputRange: [0, 1], outputRange: [1, 0], extrapolate: eG.A.Extrapolate.CLAMP });
                return {
                    ...
                    filter: eG.A.template`grayscale(${a})`,
        ...
        T = (0, a.useCallback)(function (e) {
            ...
            (C.current = a),
                ...
                d.current++,
                x(d.current),
                f(1 === Math.abs(a - n) || (a === t - 1 && 0 === n) || (0 === a && n === t - 1));
        }, []),
        R = (0, a.useCallback)(() => {
            T(C.current + 1, !1);
        }, [T]),
        ...
        w = (0, a.useCallback)(
            (e, t, a) => {
                let s = t === (0, ez.U3)(h, l.length);
                return (0, n.jsx)(eG.A.div, {
                    className: o()(eX.AS, { [eX.Xt]: s }),
                    style: null != a ? I(t, a) : null,
                    onMouseEnter: s ? null : () => D(t),
                    onMouseLeave: s ? null : M,
                    children:
                        "video" === e.type
                            ? (0, n.jsx)(
                                  e0,
            ...
            return l.length <= 1
                ...
                : (0, n.jsxs)("div", {
                      ...
                      children: [
                          ...
                          (0, n.jsx)(eJ.Oj, { onClick: y, className: o()(eX.UE, { [eX.h_]: k }) }),
                      ],
                  });
        }, [l, w, h, g, O, y, E, k]),
        H = (0, a.useCallback)(
        ...
        : null != s && null != a
          ? (0, n.jsxs)("div", {
                ...
                children: [
                    ...
                    (0, n.jsx)(u.D, { variant: "heading-md/bold", color: "text-strong", children: a }),
                    (0, n.jsxs)(u.D, {
    ...
    let N = (0, R.h)(l?.applicationId),
        ...
        O = a.useCallback(() => {
            ...
            (0, M.B4)({
                ...
                applicationId: l.applicationId,
                onComplete: () => {
                    (0, en.j)(), (0, et.n)({ sku: l, application: N, analyticsLocations: e });
                },
...
function e5(e) {
    let { sku: l, applicationId: t, assets: s, onSelectedCarouselItemChange: r, isMuted: i, trackPDPClick: o } = e,
        [c, u] = a.useState([]),
        [d, m] = a.useState([]),
        x = a.useCallback(
            (e) => {
    ...
    return (a.useEffect(() => {
        let [e, n] = ee(l?.tenantMetadata?.socialLayer?.carouselItems ?? [], t, s, { heroWidth: 747 });
        u(e), m(n);
    }, [l, s, t]),
    0 === d.length)
        ? null
...
function le(e) {
    ...
    a.useEffect(() => {
        null != g && null != s && (0, q.iR)(g, s);
    }, [g, s]);
    let I = (0, c.bG)([G.A], () => G.A.getStorefrontMetadata(i), [i]),
        R = (0, c.bG)([G.A], () => G.A.getSkuAssets()),
        L = (0, c.bG)([B.A], () => B.A.isFetchingForSKU(s)),
        D = (0, f.M)((0, S.Ay)()),
        [M, $] = a.useState(!0),
        W = (0, U.A)({ skuId: s, location: "SocialLayerStorefrontProductDetailsModal" }),
        [J, z] = a.useState(null),
        V = (function (e, l) {
    ...
    (0, P.pE)(),
        (0, k.Ay)(() => {
            H.default.track(eU.HAw.OPEN_MODAL, { location_stack: j, type: eL.Nh, sku_id: s, application_id: i }),
                (0, q.Xw)();
        });
    let X = a.useCallback(
        (e) => {
    ...
    a.useEffect(() => {
        null == g || null == s || B.A.isFetchingForSKU(s) || (0, q.qf)(g, s);
    }, [g, s]);
    let Q = a.useCallback(() => {
            null != W &&
                null != g &&
