...
let E = (e) => {
        let { entry: t, inline: n = !1, textColor: a, textTabularNumbers: s = !0, textFontCode: l = !0, hovered: u = !1, bold: d = !1, scaleFontToUserSetting: _ = !1 } = e,
            { now: f } = g(u),
            p = i.useMemo(() => (0, h.T_)(t, f), [t, f]),
            E = i.useRef(p),
            b = i.useRef(p);
        return (
            i.useEffect(() => {
