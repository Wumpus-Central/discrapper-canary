...
var r = n(200651),
    ...
    b = n(89273);
function x(e) {
    let { guildId: t, emojiId: n, emojiName: s, title: l, description: c, targetType: d, index: u, dndName: p, onEdit: g, onMove: x, disabled: j = !1 } = e,
        N = i.useRef(null),
        v = i.useRef(null),
        { drag: _, dragPreview: O, drop: y, isDragging: C } = (0, h.Z)(N, d, u, x);
    return (
        _(v),
        O(y(N)),
        (0, r.jsxs)('div', {
