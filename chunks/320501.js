"use strict";
n.d(t, { A: () => j }), n(938796), n(321073), n(142703);
var r = n(735438),
    i = n.n(r),
    s = n(665260),
    a = n(311907),
...
function H(e) {
    ...
    (o = o.update(
        i,
        (e) => (
            e.embeds?.filter(E._).length > 0 && (e = e.set("embeds", [])),
...
class Y extends a.Ay.Store {
    ...
    initialize() {
        this.waitFor(S.default, y.A, N.A, O.Ay, R.Ay, v.A, h.A, I.default, C.A, b.A, D.A, L.A, w.default),
            this.syncWith([h.A], () => {});
    }
    getMessages(e) {
        if (h.A.hasViewingRoles()) {
            let t = y.A.getChannel(e),
                n = t?.getGuildId();
            if (h.A.isViewingRoles(n) && !C.A.can(M.xBc.VIEW_CHANNEL, t)) return new u.A(e);
        }
...
let W = new Y(o.h, {
        ...
        LOAD_MESSAGES_SUCCESS: function (e) {
            ...
            (_ = _.loadComplete({
                ...
                null != d && (n || r) && (!n || !r) && (_ = _.truncate(n, r)),
                u.A.commit(_);
        },
        ...
        TRUNCATE_MESSAGES: function (e) {
            ...
            U.log(`Truncating messages for ${t} bottom:${n} top:${r}`);
            let i = u.A.getOrCreate(t);
            (i = i.truncate(n, r)), u.A.commit(i);
        },
        CLEAR_MESSAGES: function (e) {
            let { channelId: t } = e;
            U.log(`Clearing messages for ${t}`), u.A.clear(t), P.clear();
        },
        MESSAGE_CREATE: function (e) {
            ...
            return i
                ? (0, g.K)()
                    ? (G(t, r, a), !1)
                    : (U.log("Inserting message tapped on from a push notification", r.id, r.channel_id),
