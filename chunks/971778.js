...
class y extends a.Ay.Store {
    ...
    isVoiceFilterDownloaded(e) {
        return Object.values(f.voiceFilters[e]?.modelIds ?? {}).every(
            (e) => f.modelState[e]?.status === u.u.DOWNLOADED,
        );
    }
    isModelDownloaded(e) {
...
let x = new y(s.h, {
    ...
    VOICE_FILTER_DOWNLOAD_FAILED: b,
    VOICE_FILTER_FILE_READY: N,
