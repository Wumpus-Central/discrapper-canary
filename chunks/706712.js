...
var i = n(477900),
    ...
    l = n.n(r),
    a = n(17928);
if (588245 != n.j) var o = n(834730);
if (588245 != n.j) var d = n(866665);
if (588245 != n.j) var u = n(821609);
if (588245 != n.j) var c = n(150934);
if (588245 != n.j) var h = n(364522);
var m = n(964486),
    g = n(597643),
    p = n(643784),
    f = n(730441);
...
function j(e) {
    let t = s.useRef(Array(I).fill(0)),
        ...
        o = s.useRef(a);
    o.current = a;
    let d = s.useRef(a ? performance.now() : 0);
    return (
        s.useEffect(() => {
        ...
        m = s.useCallback(
            function () {
                let s = performance.now(),
                    h = s - r.current;
                if (((r.current = s), t.current && !n)) return;
                if (
                    ((a.current -= i.current[u.current]),
                    (i.current[u.current] = h),
                    (a.current += h),
                    d.current < I && (d.current += 1),
...
function C(e) {
    let t = e.dispatcher.getIsSchedulerBackgrounded(),
        n = s.useRef(t);
    n.current = t;
    let i = s.useRef(t ? performance.now() : 0);
    return (
        s.useEffect(() => {
...
function y(e) {
    ...
    return (0, i.jsxs)("div", {
        ...
        children: [
            ...
            (0, i.jsx)("div", {
                className: p.m8,
                children: (0, i.jsx)(u.$, { variant: "primary", size: "sm", text: "Reset Frame Data", onClick: M }),
            }),
        ],
    });
}
        ...
        (0, i.jsxs)("div", {
            ...
            children: [
                (0, i.jsx)(d.m, {
                    ...
                    asContainer: !0,
                    children: (0, i.jsx)(c.S, { label: "Use Average Frame Time", checked: n, onChange: () => r(!n) }),
                }),
                (0, i.jsx)(c.S, {
...
function w(e) {
    ...
    return (0, i.jsxs)("div", {
        ...
        children: [
            (0, i.jsx)("div", {
                className: l()(r && p.Mq),
                children: (0, i.jsx)(c.S, { label: "Show Dispatch Timings", checked: r, onChange: () => a((e) => !e) }),
            }),
            r
                ? (0, i.jsxs)(i.Fragment, {
                      children: [
...
function R() {
    let e = (0, a.bG)([g.A], () => g.A.getSocket()),
        [t, n] = s.useState(!1);
    return (
        _(),
        (0, i.jsx)("div", {
