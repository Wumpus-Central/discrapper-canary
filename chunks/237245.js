...
function v() {
    ...
    let [t, v] = r.useState(!1),
        ...
        j = null == N ? void 0 : N.hasFeature(f.oNc.MEMBER_VERIFICATION_MANUAL_APPROVAL),
        b = null !== (e = (0, m.A)({ guildId: T })) && void 0 !== e ? e : 0,
        ...
        A = r.useCallback(() => {
            if (null != T && null != S) {
                if (j && b > 0 && (null == S ? void 0 : S.joinType) !== x.A.APPLY) {
