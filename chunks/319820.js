...
let S = (e, t) => {
    ...
    D = (e) => {
        ...
        return (0, r.jsx)(f.Yx, {
            ...
            children: (0, r.jsxs)(v, {
                children: [
                    "THREE_COLUMN" === s && (0, r.jsx)(N, { children: (0, r.jsx)(O, { sku: t }) }),
                    (0, r.jsx)(C, { className: T.Hi, children: t.name }),
                    (0, r.jsx)(R, { className: T.Hi, children: n }),
                ],
            }),
        });
    },
...
function x(e) {
    let { sku: t, skuPricePreview: n, application: i } = e,
        ...
        { showSeparateTotal: o, discount: l, basePrice: u, showTaxes: d } = M({ skuPricePreview: n });
        ...
        children: [
            (0, r.jsxs)(v, {
                children: [
                    ...
                    (0, r.jsx)(R, { className: T.Hi, children: (0, g.$g)(u, n.currency) }),
                ],
            }),
            null != l &&
                (0, r.jsxs)(v, {
                    children: [
                        "THREE_COLUMN" === s && (0, r.jsx)(N, { children: (0, r.jsx)(b, { discount: l }) }),
                        (0, r.jsx)(C, { className: T.ys, children: l.description }),
                        (0, r.jsx)(R, { className: T.ys, children: (0, g.$g)(-1 * l.amount, n.currency) }),
                    ],
                }),
            d &&
                (0, r.jsxs)(v, {
                    children: [
                        ...
                        (0, r.jsx)(R, { className: T.Hi, children: (0, g.$g)(n.tax, n.currency) }),
                    ],
                }),
            o &&
                (0, r.jsxs)(r.Fragment, {
                    children: [
                        ...
                        (0, r.jsxs)(v, {
                            ...
                            children: [
                                ...
                                (0, r.jsx)(R, { className: T.Hi, children: (0, g.$g)(n.amount, n.currency) }),
                            ],
                        }),
                    ],
                }),
