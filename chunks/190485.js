...
function k(e, t, n) {
    ...
    for (; o < t + n; ) {
        let t = g(e, o);
        if (void 0 === t) break;
        void 0 !== t.type && (void 0 === t.itemType || -1 !== r.indexOf(t.itemType)) && i.push(t), (o += t.length);
    }
    return i;
}
...
function B(e, t, n, r, o) {
    ...
    return (
        (0 === n || 1 === n) &&
            ...
            (r += 2),
            (a.itemName = (0, i.o7)(e, r)),
            (r += a.itemName.length + 1)),
        n >= 2 &&
            (2 === n ? ((a.itemId = e.getUint16(r)), (r += 2)) : 3 === n && ((a.itemId = e.getUint32(r)), (r += 4)),
            (a.itemProtectionIndex = e.getUint16(r)),
            (r += 2),
            ...
            (r += a.itemName.length + 1),
            a.itemType === h
                ? ((a.contentType = (0, i.o7)(e, r)),
                  t + o > (r += a.contentType.length + 1) &&
                      ((a.contentEncoding = (0, i.o7)(e, r)), (r += a.contentEncoding.length + 1)))
                : a.itemType === m && ((a.itemUri = (0, i.o7)(e, r)), (r += a.itemUri.length + 1))),
        a
    );
}
