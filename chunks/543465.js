"use strict";
n.d(t, { Ay: () => eu, b5: () => Y, wn: () => j }), n(938796);
var r = n(735438),
    i = n.n(r),
    s = n(665260),
    a = n(311907),
...
let I = {},
    ...
    O = {
        [m.orn.ALL_MESSAGES]: { ...R, message_notifications: m.orn.ALL_MESSAGES },
        [m.orn.ONLY_MENTIONS]: { ...R, message_notifications: m.orn.ONLY_MENTIONS },
    },
    b = {},
    D = {},
    L = new Set(),
...
function x(e, t) {
    ...
    (D[e] = new Set(l.map((e) => e.channel_id))), U(e), delete T[e];
}
function k(e, t) {
    !0 === t.muted &&
        N.setTimer(e, t.mute_config, () => {
            G(e, { muted: !1 }), o.h.dispatch({ type: "GUILD_MUTE_EXPIRED", guildId: e });
        }) &&
        (t.muted = !1),
...
function j(e) {
    ...
    return O[null != t ? t.defaultMessageNotifications : m.orn.ALL_MESSAGES];
}
function Y() {
...
function $(e) {
    Z(e.notificationSettings), N.reset(), C.reset(), e.userGuildSettings.partial || ((I = {}), (b = {}), (D = {}));
    let t = new Set();
...
function J(e) {
    let { guildId: t, settings: n } = e;
    G(t, n), V(t, n.channel_overrides);
}
function ee(e) {
    let { guildId: t, channelId: n, settings: r } = e;
    null != t && null != r.flags && (M[t] = { ...M[t], [n]: { flags: r.flags } }), F(t, n, r);
}
function et(e) {
    let { guildId: t } = e;
    if (null == t) return !1;
...
class el extends a.Ay.PersistedStore {
    ...
    resolveUnreadSetting(e) {
        if (d.Le.has(e.type) || (0, d.Gw)(e.type) || !eo()) return g.e.ALL_MESSAGES;
    ...
    resolveGuildUnreadSetting(e) {
        ...
        return !eo() || s.Lt(t, A.n3.UNREADS_ALL_MESSAGES)
            ? g.e.ALL_MESSAGES
            : s.Lt(t, A.n3.UNREADS_ONLY_MENTIONS)
              ? g.e.ONLY_MENTIONS
...
let eu = new el(o.h, {
    ...
    USER_GUILD_SETTINGS_CHANNEL_UPDATE_BULK: er,
    CONNECTION_OPEN: $,
    CACHE_LOADED: K,
    OVERLAY_INITIALIZE: z,
    GUILD_CREATE: ea,
    GUILD_UPDATE: ea,
    GUILD_TOGGLE_COLLAPSE_MUTED: ei,
    IMPERSONATE_UPDATE: ea,
    IMPERSONATE_STOP: ea,
    USER_GUILD_SETTINGS_REMOVE_PENDING_CHANNEL_UPDATES: en,
