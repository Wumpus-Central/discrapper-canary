...
class o extends i {
    ...
    get level() {
        var e;
        return this.parentNode instanceof o
    ...
    updateNode() {
        var e, t, r, n, i, a, s, l, u, c, f, d, p, h, m;
        ...
        if (
            ...
            (y.level = this.level),
            (y.parentKey =
                this.parentNode instanceof o && null != (u = null == (e = this.parentNode.node) ? void 0 : e.key)
                    ? u
                    : null),
            (y.prevKey =
            ...
            (y.firstChildKey =
                null != (d = null == (a = this.firstVisibleChild) || null == (i = a.node) ? void 0 : i.key) ? d : null),
            (y.lastChildKey =
    ...
    setProps(e, t, r, n, i) {
        ...
        if (
            (null == this.node
                ? ((o = new r(null != l ? l : `react-aria-${++this.ownerDocument.nodeId}`)), (this.node = o))
        ...
        "function" == typeof f.useSyncExternalStore
            ...
            : function (e, t, r) {
                  let n = (0, d.wR)(),
                      i = (0, f.useRef)(n);
                  i.current = n;
                  let o = (0, f.useCallback)(() => (i.current ? r() : t()), [t, r]);
...
function w(e, t, r, i, o, a) {
    ...
    if (c) {
        ...
        return (
            n ||
                ((n = c.ownerDocument.createElement(e.type)).setProps(t, r, e, i, a),
                c.appendChild(n),
                c.ownerDocument.updateCollection(),
                c.ownerDocument.nodesByProps.set(t, n)),
            o ? f.createElement(b.Provider, { value: n }, o) : null
        );
    }
    return f.createElement(e.type, { ref: u }, o);
}
function _(e, t) {
    let r = ({ node: e }) => t(e.props, e.props.ref, e),
        n = (0, f.forwardRef)((n, i) => {
            let o = (0, f.useContext)(c.gY);
            if (!(0, f.useContext)(h)) {
            ...
            return w(e, n, i, "children" in n ? n.children : null, null, (e) =>
                f.createElement(c.gY.Provider, { value: o }, f.createElement(r, { node: e })),
            );
        });
...
function S(e, t, r = x) {
    let n = ({ node: e }) => t(e.props, e.props.ref, e),
        i = (0, f.forwardRef)((t, i) => {
            var o;
            let a = r(t);
            return null != (o = w(e, t, i, null, a, (e) => f.createElement(n, { node: e })))
                ? o
...
function k(e) {
    ...
    return (
        (0, f.useContext)(m) && (i = f.createElement(C, null, i)),
        (t = (0, f.useMemo)(() => ({ dependencies: r, idScope: n }), [n, ...r])),
        f.createElement(E.Provider, { value: t }, i)
    );
}
function C({ children: e }) {
    ...
    return (0, d.wR)() ? f.createElement(b.Provider, { value: t }, r) : (0, u.createPortal)(r, t);
}
