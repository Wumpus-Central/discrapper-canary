...
function M(e) {
    let { message: n } = e,
        ...
        v = (0, S.uJ)(n.content) ? null : (0, p.Ay)(n, { allowGameMentions: !0 }).content,
        {
            ...
            trailingIcon: O,
            leadingIcon: L,
        } = (0, x.o)(n, v, t, s, R.BK, { trailingIconClass: R.sl, leadingIconClass: R.aG, iconSize: y.eJ }),
        M = (0, I.o6)(n),
        D =
            M.length > 0
                ? M.map((e) => (0, l.jsx)(T.A, { className: R.yI, size: 128, sticker: e, isInteracting: d }, e.id))
                : null;
    return (0, l.jsx)(f.x, {
        value: d,
