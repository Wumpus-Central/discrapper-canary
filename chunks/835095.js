...
class s extends r.A {
    ...
    static createFromServer(e) {
        return new s({
            ...
            countryListMode: e.country_list_mode ?? a.qn.BLOCKLIST,
    ...
    constructor(e) {
        super(),
            ...
            (this.countryListMode = e.countryListMode ?? a.qn.BLOCKLIST),
    ...
    isCountryRestricted(e) {
        if (this.countryListMode === a.qn.ALLOWLIST) return !this.allowedCountries.includes(e);
        switch (this.promotionType) {
            case a.pt.THIRD_PARTY_INBOUND:
            case a.pt.THIRD_PARTY_DIRECT_FULFILLMENT:
