...
function _(t, e) {
    let [n, r] = (0, a.Wu)([f.ZP], () => [f.ZP.isChannelMuted(t.guild_id, t.id), f.ZP.getChannelMuteConfig(t.guild_id, t.id)]),
        ...
        O = (0, h.ZP)(t, !0);
    function _(e) {
        e && t.type === g.d4z.GUILD_CATEGORY && (0, c.c4)(t.id), s.Z.updateChannelOverrideSettings(t.guild_id, t.id, { muted: e }, b.UE.muted(e));
    }
    let j = Z.intl.string(Z.t.tbeRRE),
        v = Z.intl.string(Z.t.OYefmZ);
    switch (t.type) {
        case g.d4z.GUILD_CATEGORY:
            (j = Z.intl.string(Z.t.pNMCg4)), (v = Z.intl.string(Z.t.olaBeH));
            break;
        case g.d4z.GROUP_DM:
            (j = Z.intl.string(Z.t.LO3kaG)), (v = Z.intl.string(Z.t['s5/5fn']));
            break;
        case g.d4z.DM:
            (j = Z.intl.format(Z.t.byjuJi, { name: O })), (v = Z.intl.format(Z.t['eC+9rq'], { name: O }));
            break;
        default:
            (j = Z.intl.string(Z.t.tbeRRE)), (v = Z.intl.string(Z.t.OYefmZ));
    }
    return n
        ? (0, i.jsx)(o.sNh, {
              id: 'unmute-channel',
                      ...
                      o.sNh,
                      {
                          ...
                          action: () =>
                              (function (n) {
                                  ...
                                  let i = m(n);
                                  s.Z.updateChannelOverrideSettings(t.guild_id, t.id, i, b.ZB.Muted, e);
                              })(r)
                      },
                      r
                  );
