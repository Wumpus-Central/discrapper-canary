...
function T(e) {
    let t,
        ...
        W = r.useCallback(() => {
            null != l.role_id && (h.Z.setSection(w.pNK.ROLES), h.Z.selectRole(l.role_id));
        }, [l.role_id]),
        {
            serviceName: H,
            channelURL: G,
        ...
        { roleLink: V, syncDescriptionText: Y } = r.useMemo(() => {
            let e;
            e =
                null != q
                    ? (0, i.jsx)(p.eee, {
        ...
        }, [q, W, l.revoked, l.synced_at, l.type, l.user]),
                              ...
                              return (0, i.jsxs)(g.Z, {
                                  ...
                                  children: [
                                      (0, i.jsx)(p.XZJ, {
                                          ...
                                          className: o()(P.marginTop20, P.marginBottom8),
