...
function D(e) {
    let t,
        ...
        H = (0, p.e7)([_.Z], () => _.Z.can(E.Plq.KICK_MEMBERS, n)),
        G = r.useCallback(() => {
            B(!0), M(l);
        }, [l, M]),
        F = r.useCallback(() => {
                ...
                (0, g.h7j)((e) => {
                    if (!H && l.expire_behavior === c.l.KICK)
                        return (0, i.jsx)(
                            g.ConfirmModal,
                            A(k({}, e), {
                                header: I.intl.string(I.t.emx3lN),
                                confirmText: I.intl.string(I.t.BddRzS),
                                confirmButtonColor: m.Tt.BRAND,
                                children: (0, i.jsx)(g.Text, {
                                    variant: "text-md/normal",
                                    children:
                                        l.type === u.b.YOUTUBE ? I.intl.string(I.t.pDCiEf) : I.intl.string(I.t.sQqHFk),
                                }),
                            }),
                        );
                    let t =
                    ...
                    return (0, i.jsx)(
                        ...
                        A(k({}, e), {
                            ...
                            children: (0, i.jsx)(g.Text, {
                                variant: "text-md/normal",
                                children:
                                    l.type === u.b.YOUTUBE ? I.intl.string(I.t.anKQWU) : I.intl.string(I.t["BW/xtn"]),
                            }),
                        }),
                    );
                });
            ...
            return {
                ...
                syncDescriptionText:
                    l.revoked && null != t
                        ...
                        : I.intl.formatToPlainString(I.t.unl3AP, { datetime: s()(l.synced_at).calendar() }),
            };
        ...
        t = [
            {
                icon: g.T39,
                text: W
                    ? I.intl.formatToPlainString(I.t.gcdJ8J, { timestamp: P.default.extractTimestamp(l.id) })
                    : I.intl.formatToPlainString(I.t.Nu9sat, {
                          user: null != l.user ? new v.Z(l.user).tag : null,
                                ...
                                (0, i.jsx)(x.Z.Child, {
                                    ...
                                    children: (0, i.jsx)(g.q4e, {
                                        ...
                                        options: Object.values(d.W)
                                            ...
                                            .map((e) => ({
                                                value: "".concat(e),
                                                label: I.intl.formatToPlainString(I.t.eGjmy5, { days: e }),
                                            })),
