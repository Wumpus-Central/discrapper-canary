...
function L(e) {
    let t,
        { channel: l, guild: h, onAction: _, voiceStates: f, isChannelSelected: x, shouldShowSettingNudge: E } = e;
    (t = s.useMemo(
        () =>
            null == f || f.length > 50
                ? {}
    ...
    let N = (0, u.Ay)(l),
        ...
        D = (0, a.bG)([A.A], () => A.A.getStorefrontDetectableGameAndApplicationIds()),
        ...
        ? (0, i.jsxs)(o.HOs, {
              ...
              children: [
                  ...
                  b.map((e, t) =>
                      (0, i.jsx)(
                          I.A,
                          { embeddedApp: e, presenceActivity: e.presenceActivity ?? void 0, channel: l, onAction: _ },
                          t,
                      ),
                  ),
                  R.map((e, t) => {
                      let { members: n, activity: r } = e,
                          a = r.application_id;
                      return (null != S && (a = S), L && null != a && D.has(a))
                          ? (0, i.jsxs)(
                                s.Fragment,
                                {
                                    children: [
                                        (0, i.jsx)(I.A, { presenceActivity: r, channel: l, members: n, onAction: _ }),
                                        (0, i.jsx)(g.A, {
                                            className: j.L,
                          ...
                          : (0, i.jsx)(I.A, { presenceActivity: r, channel: l, members: n, onAction: _ }, t);
                  }),
                  E &&
                      (0, i.jsxs)(i.Fragment, {
                          children: [
...
function M(e) {
    let { channel: t, isChannelSelected: n, voiceStatesCount: s } = e,
        l = (0, a.bG)([f.A], () => !f.A.can(T.xBc.CONNECT, t)),
        o = (0, a.bG)([x.A], () => x.A.hasVideo(t.id)),
        c = (0, E.Ay)({ channel: t, locked: l, video: o, selected: n }),
        d = (0, a.bG)([_.A], () => _.A.getGuild(t.guild_id));
