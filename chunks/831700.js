...
class en extends H.ZP {
    ...
    render() {
        let { channel: e, selected: t, connected: n, unread: i, resolvedUnreadSetting: l, mentionCount: s, locked: a, sorting: u, isUserOver: d, connectChannelDropTarget: h, connectChannelDragSource: p, connectUserDropTarget: f, connectDragPreview: g, canReorderChannel: y, canMoveMembers: _, showTutorial: v, hasActiveEvent: O, embeddedApps: C, isSubscriptionGated: j, isFavoriteSuggestion: S, withGuildIcon: E } = this.props,
...
function ei(e) {
    let { guild: t, channel: n, disableSorting: i, isFavoriteCategory: l, selected: o, collapsed: a, voiceStates: c } = e,
        ...
        m = (0, y.ZP)(n),
        b = (0, E.qY)(n.id),
        { isSubscriptionGated: _, needSubscriptionToAccess: v } = (0, S.Z)(n.id),
        C = (0, O.Z)(),
