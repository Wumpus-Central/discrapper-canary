            ...
            : (0, i.jsx)(s.ua7, {
                  ...
                  children: (t) => {
                      ...
                      return (0, i.jsx)(s.P3F, {
                          ...
                          onClick: () => {
                              (0, E.X)('VoiceChannel') ? (0, A.k)(e, 'VoiceChannel') : window.open(O.Z.getArticleURL(q.BhN.HD_STREAMING_POTION), '_blank');
                          },
...
function ee(e) {
    let { guild: t, channel: n, disableSorting: l, isFavoriteCategory: r, selected: o, collapsed: s, voiceStates: c } = e,
        ...
        j = e.connected || (null == I ? void 0 : I.channelId) === n.id,
        E = (0, V.Z)({
            channel: n,
            isChannelSelected: o,
