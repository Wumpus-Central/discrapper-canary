...
function b(e) {
    let { guild: t, stageInstance: n, showGuildPopout: r, setShowGuildPopout: a, handleGuildNameClick: m, source: b, speakers: f, speakerCount: p, audienceCount: x, channelName: v } = e,
        j = l.useRef(null),
        N = t.id;
    return (0, i.jsx)('div', {
