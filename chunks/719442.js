...
var m = () => {
    var e = {
        ...
        apply: (t) => {
            ...
            if (el.operationCanTransformPath(t)) for (var f of ((a = []), (s = new Set()), c)) _(el.transform(f, t));
            else (a = c), (s = d);
        ...
        addMark: (t, n) => {
            ...
            if (r) {
                ...
                if (s || o) eW.setNodes(e, { [t]: n }, { match: a, split: !0, voids: !0 });
                else {
        ...
        deleteBackward: (t) => {
            var { selection: n } = e;
            n && eg.isCollapsed(n) && eW.delete(e, { unit: t, reverse: !0 });
        },
        deleteForward: (t) => {
            var { selection: n } = e;
                ...
                for (
                    ...
                    if (!eb.isText(l)) {
                        var u = n.children[o],
                            ...
                            _ = eb.isText(u) || (z.isElement(u) && e.isInline(u));
                        if (_ !== a) eW.removeNodes(e, { at: r.concat(s), voids: !0 }), s--;
                        else if (z.isElement(u)) {
                            if (e.isInline(u))
                                if (null != c && eb.isText(c)) {
                                    if (d) {
                                        var f = { text: "" };
                                        eW.insertNodes(e, f, { at: r.concat(s + 1), voids: !0 }), s++;
                                    }
                                } else {
                                    var p = { text: "" };
                                    eW.insertNodes(e, p, { at: r.concat(s), voids: !0 }), s++;
                                }
                        } else
                            null != c &&
                                eb.isText(c) &&
                                (eb.equals(u, c, { loose: !0 })
                                    ? (eW.mergeNodes(e, { at: r.concat(s), voids: !0 }), s--)
                                    : "" === c.text
                                      ? (eW.removeNodes(e, { at: r.concat(s - 1), voids: !0 }), s--)
                                      : "" === u.text && (eW.removeNodes(e, { at: r.concat(s), voids: !0 }), s--));
                    }
                }
            }
        },
        removeMark: (t) => {
            ...
            if (n) {
                ...
                if (i || a) eW.unsetNodes(e, t, { match: r, split: !0, voids: !0 });
                else {
                    var c = h({}, J.marks(e) || {});
...
var A = function (e) {
        ...
        for (var c of i) {
            ...
            if (
                (([a, s] = n ? [s, _] : [_, a]),
                (V(a, r.ZWJ) && V(s, r.ExtPict) && !(l = n ? H(e.substring(0, o)) : H(e.substring(0, e.length - o)))) ||
                    (V(a, r.RI) && V(s, r.RI) && !(u = null !== u ? !u : !!n || W(e.substring(0, e.length - o)))) ||
                    (a !== r.None && s !== r.None && B(a, s)))
            )
                break;
            o += c.length;
        }
...
function B(e, t) {
    return -1 === F.findIndex((n) => V(e, n[0]) && V(t, n[1]));
}
var j =
...
var X = new WeakMap(),
    J = {
        above(e) {
            ...
            if (i) {
                var s = J.path(e, i),
                    o = "lowest" === r;
                for (var [l, u] of J.levels(e, { at: s, voids: n, match: a, reverse: o }))
                    if (!eb.isText(l)) {
                        if (eg.isRange(i)) {
        ...
        after(e, t) {
            var n,
                ...
                { distance: a = 1 } = r,
                s = 0;
            for (var o of J.positions(e, Q(Q({}, r), {}, { at: i }))) {
                if (s > a) break;
                0 !== s && (n = o), s++;
            }
            return n;
        ...
        before(e, t) {
            var n,
                ...
                { distance: a = 1 } = r,
                s = 0;
            for (var o of J.positions(e, Q(Q({}, r), {}, { at: i, reverse: !0 }))) {
                if (s > a) break;
                0 !== s && (n = o), s++;
            }
            return n;
        ...
        hasInlines: (e, t) => t.children.some((t) => eb.isText(t) || J.isInline(e, t)),
        ...
        isEmpty(e, t) {
            var { children: n } = t,
                [r] = n;
            return 0 === n.length || (1 === n.length && eb.isText(r) && "" === r.text && !e.isVoid(t));
        },
        ...
        *levels(e) {
            ...
            if ((null == a && (a = () => !0), n)) {
                ...
                for (var [l, u] of ei.levels(e, o))
                    if (a(l, u) && (s.push([l, u]), !i && z.isElement(l) && J.isVoid(e, l))) break;
                r && s.reverse(), yield* s;
            }
        },
        marks(e) {
            ...
            if (t) return t;
            if (eg.isExpanded(n)) {
                var [r] = J.nodes(e, { match: eb.isText });
                if (!r) return {};
                var [i] = r;
                return E(i, $);
            }
            var { anchor: a } = n,
                ...
                [o] = J.leaf(e, s);
            if (0 === a.offset) {
                var l = J.previous(e, { at: s, match: eb.isText });
            ...
            if ((c || (c = () => !0), a)) {
                ...
                for (var [h, m] of f) {
                    ...
                    if ("highest" !== s || !g) {
                        ...
                        E && (o ? p.push(E) : yield E), (r = [h, m]);
                    }
                }
                "lowest" === s && r && (o ? p.push(r) : yield r), o && (yield* p);
            }
        },
        normalize(e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
        ...
        *positions(e) {
            ...
            if (n) {
                var s = J.range(e, n),
                    ...
                    f = 0,
                    p = 0;
                for (var [h, m] of J.nodes(e, { at: n, reverse: i, voids: a })) {
                    if (z.isElement(h)) {
                        if (!a && e.isVoid(h)) {
                            yield J.start(e, m);
                            continue;
                        ...
                        if (J.hasInlines(e, h)) {
                            ...
                            (d = J.string(e, { anchor: E, focus: g }, { voids: a })), (c = !0);
                        }
                    }
                    if (eb.isText(h)) {
        ...
        range: (e, t, n) => (eg.isRange(t) && !n ? t : { anchor: J.start(e, t), focus: J.end(e, n || t) }),
        rangeRef(e, t) {
            var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {},
                { affinity: r = "forward" } = n,
                i = {
        ...
        string(e, t) {
            var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {},
                ...
                [a, s] = eg.edges(i),
                o = "";
            for (var [l, u] of J.nodes(e, { at: i, match: eb.isText, voids: r })) {
                var c = l.text;
                el.equals(u, s.path) && (c = c.slice(0, s.offset)),
                    el.equals(u, a.path) && (c = c.slice(a.offset)),
                    (o += c);
            }
            return o;
        },
        unhangRange(e, t) {
            ...
            var s = J.above(e, { at: a, match: (t) => z.isElement(t) && J.isBlock(e, t), voids: r }),
                o = s ? s[1] : [],
                l = { anchor: J.start(e, i), focus: a },
                u = !0;
            for (var [c, d] of J.nodes(e, { at: l, match: eb.isText, reverse: !0, voids: r })) {
                if (u) {
                    u = !1;
                    continue;
                }
        ...
        void(e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            return J.above(e, Q(Q({}, t), {}, { match: (t) => z.isElement(t) && J.isVoid(e, t) }));
        },
    ...
    ei = {
        ...
        *ancestors(e, t) {
        ...
        child(e, t) {
            if (eb.isText(e)) throw Error("Cannot get the child of a text node: ".concat(eI.stringify(e)));
            var n = e.children[t];
        ...
        *elements(e) {
        ...
        first(e, t) {
            for (var n = t.slice(), r = ei.get(e, n); r; )
                if (eb.isText(r) || 0 === r.children.length) break;
        ...
        has(e, t) {
            for (var n = e, r = 0; r < t.length; r++) {
                var i = t[r];
                if (eb.isText(n) || !n.children[i]) return !1;
                n = n.children[i];
            }
            return !0;
        },
        isNode: (e) => eb.isText(e) || z.isElement(e) || J.isEditor(e),
        isNodeList(e) {
        ...
        *levels(e, t) {
        ...
        matches: (e, t) =>
            ...
            (eb.isText(e) && eb.isTextProps(t) && eb.matches(e, t)),
        *nodes(e) {
            for (
                var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                ...
                if (
                    (s.has(l) || (yield [l, o]),
                    !s.has(l) && !eb.isText(l) && 0 !== l.children.length && (null == n || !1 === n([l, o])))
                ) {
                    s.add(l);
        ...
        string: (e) => (eb.isText(e) ? e.text : e.children.map(ei.string).join("")),
        *texts(e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            for (var [n, r] of ei.nodes(e, t)) eb.isText(n) && (yield [n, r]);
        },
    };
function ea(e, t) {
    var n = Object.keys(e);
...
var eo = {
        ...
        inverse(e) {
            switch (e.type) {
                ...
                case "merge_node":
                    return es(es({}, e), {}, { type: "split_node", path: el.previous(e.path) });
                case "move_node":
                    var { newPath: t, path: n } = e;
                    if (el.equals(t, n)) return e;
                    if (el.isSibling(n, t)) return es(es({}, e), {}, { path: t, newPath: n });
                    var r = el.transform(n, e),
                        i = el.transform(el.next(n), e);
                    return es(es({}, e), {}, { path: r, newPath: i });
                case "remove_node":
                ...
                case "set_node":
                    ...
                    return es(es({}, e), {}, { properties: s, newProperties: a });
                case "set_selection":
                    var { properties: o, newProperties: l } = e;
                    if (null == o) return es(es({}, e), {}, { properties: l, newProperties: null });
                    if (null == l) return es(es({}, e), {}, { properties: null, newProperties: o });
                    return es(es({}, e), {}, { properties: l, newProperties: o });
                case "split_node":
                    return es(es({}, e), {}, { type: "merge_node", path: el.next(e.path) });
            }
        },
    },
    el = {
...
var eg = {
        ...
        includes(e, t) {
            ...
            return (
                e_.isPoint(t)
                    ? ((l = e_.compare(t, s) >= 0), (u = 0 >= e_.compare(t, o)))
                    : ((l = el.compare(t, s.path) >= 0), (u = 0 >= el.compare(t, o.path))),
                l && u
            );
        },
        intersection(e, t) {
            var n = E(e, ep),
                [r, i] = eg.edges(e),
                [a, s] = eg.edges(t),
                o = e_.isBefore(r, a) ? a : r,
                l = e_.isBefore(i, s) ? i : s;
    ...
    decorations(e, t) {
        ...
        for (var r of t) {
            ...
            for (var d of n) {
                ...
                if (c < l) {
                    var g = c - f;
                    (m = eC(eC({}, p), {}, { text: p.text.slice(g) })),
                        (p = eC(eC({}, p), {}, { text: p.text.slice(0, g) }));
                }
                if (u > f) {
                    var A = u - f;
                    (h = eC(eC({}, p), {}, { text: p.text.slice(0, A) })),
                        (p = eC(eC({}, p), {}, { text: p.text.slice(A) }));
                }
...
var eO = (e, t, n) => {
        switch (n.type) {
            case "insert_node":
                ...
                if ((a.children.splice(s, 0, i), t)) for (var [o, l] of eg.points(t)) t[l] = e_.transform(o, n);
                break;
            case "insert_text":
                ...
                var _ = ei.leaf(e, u),
                    f = _.text.slice(0, c),
                    p = _.text.slice(c);
                if (((_.text = f + d + p), t)) for (var [h, m] of eg.points(t)) t[m] = e_.transform(h, n);
                break;
            case "merge_node":
                var { path: g } = n,
                    E = ei.get(e, g),
                    ...
                    T = ei.parent(e, g),
                    y = g[g.length - 1];
                if (eb.isText(E) && eb.isText(I)) I.text += E.text;
                else if (eb.isText(E) || eb.isText(I))
                    throw Error(
                        'Cannot apply a "merge_node" operation at path ['
                            .concat(g, "] to nodes of different interfaces: ")
                            .concat(eI.stringify(E), " ")
                            .concat(eI.stringify(I)),
                    );
                else I.children.push(...E.children);
                if ((T.children.splice(y, 1), t)) for (var [S, v] of eg.points(t)) t[v] = e_.transform(S, n);
                break;
            case "move_node":
                var { path: C, newPath: b } = n;
                if (el.isAncestor(C, b))
                    throw Error(
                        "Cannot move a path ["
                ...
                var D = el.transform(C, n),
                    L = ei.get(e, el.parent(D)),
                    w = D[D.length - 1];
                if ((L.children.splice(w, 0, N), t)) for (var [x, P] of eg.points(t)) t[P] = e_.transform(x, n);
                break;
            case "remove_node":
                var { path: M } = n,
                    k = M[M.length - 1];
                if ((ei.parent(e, M).children.splice(k, 1), t))
                    for (var [U, G] of eg.points(t)) {
                        var V = e_.transform(U, n);
                        if (null != t && null != V) t[G] = V;
                        else {
                            var F = void 0,
                                B = void 0;
                            for (var [j, H] of ei.texts(e))
                                if (-1 === el.compare(H, M)) F = [j, H];
                                else {
                                    B = [j, H];
                                    break;
                                }
                            ...
                            F &&
                                ...
                                (Y = el.equals(B[1], M)
                                    ? !el.hasPrevious(B[1])
                                    : el.common(F[1], M).length < el.common(B[1], M).length),
                                F && !Y
                                    ? ((U.path = F[1]), (U.offset = F[0].text.length))
                                    : B
            ...
            case "remove_text":
                ...
                if ((($.text = q + Z), t)) for (var [Q, X] of eg.points(t)) t[X] = e_.transform(Q, n);
                break;
            case "set_node":
            ...
            case "split_node":
                ...
                if (eb.isText(em)) {
                    var eT = em.text.slice(0, ep),
                        ey = em.text.slice(ep);
                    (em.text = eT), (ed = eR(eR({}, eh), {}, { text: ey }));
                } else {
                    var eS = em.children.slice(0, ep),
                        ev = em.children.slice(ep);
                    (em.children = eS), (ed = eR(eR({}, eh), {}, { children: ev }));
                }
                if ((eE.children.splice(eA + 1, 0, ed), t))
                    for (var [eC, eN] of eg.points(t)) t[eN] = e_.transform(eC, n);
        }
        return t;
    },
    eD = {
...
var eM = {
            ...
            J.withoutNormalizing(e, () => {
                ...
                if ((ei.isNode(t) && (t = [t]), 0 !== t.length)) {
                    ...
                    if (
                        ...
                        if ((r || (s = J.unhangRange(e, s, { voids: i })), eg.isCollapsed(s))) s = s.anchor;
                        else {
                            var [, c] = eg.edges(s),
                                d = J.pointRef(e, c);
                            eW.delete(e, { at: s }), (s = d.unref());
                        }
                    if (e_.isPoint(s)) {
                        null == o &&
                            (o = eb.isText(u)
                                ? (e) => eb.isText(e)
                                : e.isInline(u)
                                  ? (t) => eb.isText(t) || J.isInline(e, t)
                                  : (t) => z.isElement(t) && J.isBlock(e, t));
                        var [_] = J.nodes(e, { at: s.path, match: o, mode: a, voids: i });
                        if (!_) return;
                        var [, f] = _,
                            p = J.pathRef(e, f),
                            h = J.isEnd(e, s, f);
                        eW.splitNodes(e, { at: s, match: o, mode: a, voids: i });
                        var m = p.unref();
                        s = h ? el.next(m) : m;
                    }
                    var g = el.parent(s),
                    ...
                    if (!(!i && J.void(e, { at: g }))) {
                        for (var A of t) {
                            var I = g.concat(E);
                            E++, e.apply({ type: "insert_node", path: I, node: A }), (s = el.next(s));
                        }
        ...
        liftNodes(e) {
            ...
            J.withoutNormalizing(e, () => {
                var { at: n = e.selection, mode: r = "lowest", voids: i = !1 } = t,
                    { match: a } = t;
                if ((null == a && (a = el.isPath(n) ? eG(e, n) : (t) => z.isElement(t) && J.isBlock(e, t)), n)) {
                    var s = J.nodes(e, { at: n, match: a, mode: r, voids: i }),
                        o = Array.from(s, (t) => {
                            var [, n] = t;
                    ...
                    for (var l of o) {
                        ...
                        if (1 === f) {
                            ...
                            var m = el.next(u),
                                g = el.next(d);
                            eW.splitNodes(e, { at: m, voids: i }), eW.moveNodes(e, { at: u, to: g, voids: i });
                        }
                    }
                }
            });
        ...
        mergeNodes(e) {
            ...
            J.withoutNormalizing(e, () => {
                ...
                if (a) {
                    ...
                    if ((!s && eg.isRange(a) && (a = J.unhangRange(e, a, { voids: o })), eg.isRange(a)))
                        if (eg.isCollapsed(a)) a = a.anchor;
                        else {
                            var [, c] = eg.edges(a),
                                d = J.pointRef(e, c);
                            eW.delete(e, { at: a }), (a = d.unref()), null == t.at && eW.select(e, a);
                        }
                    var [_] = J.nodes(e, { at: a, match: i, voids: o, mode: l }),
                        f = J.previous(e, { at: a, match: i, voids: o, mode: l });
                    if (_ && f) {
                        var [p, h] = _,
                            [m, g] = f;
                        if (0 !== h.length && 0 !== g.length) {
                            var A = el.next(g),
                                I = el.common(h, g),
                                T = el.isSibling(h, g),
                                y = Array.from(J.levels(e, { at: h }), (e) => {
                                    var [t] = e;
                                    return t;
                                })
                                    .slice(I.length)
                                    .slice(0, -1),
                                S = J.above(e, { at: h, mode: "highest", match: (t) => y.includes(t) && ek(e, t) }),
                                v = S && J.pathRef(e, S[1]);
                            if (eb.isText(p) && eb.isText(m)) {
                                var C = E(p, eL);
                                (r = m.text.length), (n = C);
                            } else if (z.isElement(p) && z.isElement(m)) {
                                var C = E(p, ew);
                                (r = m.children.length), (n = C);
                            } else
                                throw Error(
                            ...
                            T || eW.moveNodes(e, { at: h, to: A, voids: o }),
                                ...
                                (eb.isText(m) && "" === m.text && 0 !== g[g.length - 1])
                                    ? eW.removeNodes(e, { at: g, voids: o })
        ...
        moveNodes(e, t) {
            J.withoutNormalizing(e, () => {
                var { to: n, at: r = e.selection, mode: i = "lowest", voids: a = !1 } = t,
                    { match: s } = t;
                if (r) {
                    null == s && (s = el.isPath(r) ? eG(e, r) : (t) => z.isElement(t) && J.isBlock(e, t));
                    var o = J.pathRef(e, n),
                        l = J.nodes(e, { at: r, match: s, mode: i, voids: a }),
                        u = Array.from(l, (t) => {
                            var [, n] = t;
                            return J.pathRef(e, n);
                        });
        ...
        removeNodes(e) {
            ...
            J.withoutNormalizing(e, () => {
                ...
                if (a) {
                    null == s && (s = el.isPath(a) ? eG(e, a) : (t) => z.isElement(t) && J.isBlock(e, t)),
                        !n && eg.isRange(a) && (a = J.unhangRange(e, a, { voids: r }));
                    var o = J.nodes(e, { at: a, match: s, mode: i, voids: r }),
                        l = Array.from(o, (t) => {
                            var [, n] = t;
                            return J.pathRef(e, n);
                        });
            ...
            J.withoutNormalizing(e, () => {
                ...
                if (i) {
                    if (
                        ...
                        !o && eg.isRange(i) && (i = J.unhangRange(e, i, { voids: c })),
                        u && eg.isRange(i))
                    ) {
                        ...
                        if (0 !== E.length) {
                            ...
                            for (var y in t)
                                "children" !== y &&
                                    ...
                                    a(t[y], g[y]) &&
                                    ((T = !0),
                                    g.hasOwnProperty(y) && (A[y] = g[y]),
                                    s ? null != t[y] && (I[y] = s(g[y], t[y])) : null != t[y] && (I[y] = t[y]));
                            T && e.apply({ type: "set_node", path: E, properties: A, newProperties: I });
                        }
                    }
                }
            });
        ...
        splitNodes(e) {
            ...
            J.withoutNormalizing(e, () => {
                ...
                if (o) {
                    ...
                    try {
                        var [p] = J.nodes(e, { at: o, match: s, mode: i, voids: a });
                        if (!p) return;
                        ...
                        if (!a && h) {
                            ...
                            if (z.isElement(g) && e.isInline(g)) {
                                ...
                                if (!A) {
                                    var I = { text: "" },
                                        T = el.next(E);
                                    eW.insertNodes(e, I, { at: T, voids: a }), (A = J.point(e, T));
                                }
                                (o = A), (u = !0);
                            }
                        ...
                        var y = o.path.length - l,
                            [, S] = p,
                            v = o.path.slice(0, y),
                            C = 0 === l ? o.offset : o.path[y] + m;
                        for (var [b, N] of J.levels(e, { at: v, reverse: !0, voids: a })) {
                            var R = !1;
                            if (N.length < S.length || 0 === N.length || (!a && z.isElement(b) && J.isVoid(e, b)))
                                break;
                            var O = f.current,
                                D = J.isEnd(e, O, N);
                            if (u || !f || !J.isEdge(e, O, N)) {
                                R = !0;
                                var L = ei.extractProps(b);
                                e.apply({ type: "split_node", path: N, position: C, properties: L });
                            }
                            C = N[N.length - 1] + (R || D ? 1 : 0);
                        }
                        if (null == t.at) {
            ...
            J.withoutNormalizing(e, () => {
                ...
                if (a) {
                    ...
                    var o = eg.isRange(a) ? J.rangeRef(e, a) : null,
                        l = J.nodes(e, { at: a, match: s, mode: n, voids: i }),
                        u = Array.from(l, (t) => {
                            var [, n] = t;
                            return J.pathRef(e, n);
                        }).reverse(),
        ...
        wrapNodes(e, t) {
            ...
            J.withoutNormalizing(e, () => {
                ...
                if (o) {
                    if (
                        (null == s &&
                            (s = el.isPath(o)
                                ? eG(e, o)
                                : e.isInline(t)
                                  ? (t) => (z.isElement(t) && J.isInline(e, t)) || eb.isText(t)
                                  : (t) => z.isElement(t) && J.isBlock(e, t)),
                        i && eg.isRange(o))
                    ) {
                        var [l, u] = eg.edges(o),
                            c = J.rangeRef(e, o, { affinity: "inward" });
                        eW.splitNodes(e, { at: u, match: s, voids: a }),
                            eW.splitNodes(e, { at: l, match: s, voids: a }),
                            (o = c.unref()),
                    ...
                    for (var [, _] of d) {
                        var f = eg.isRange(o) ? eg.intersection(o, J.range(e, _)) : o;
                        if (f) {
                            var p = Array.from(J.nodes(e, { at: f, match: s, mode: r, voids: a }));
                            if (
                                p.length > 0 &&
                                "continue" ===
                                    (function () {
                                        ...
                                        var o = el.equals(i, s) ? el.parent(i) : el.common(i, s),
                                            ...
                                            _ = eP(eP({}, t), {}, { children: [] });
                                        eW.insertNodes(e, _, { at: d, voids: a }),
                                            eW.moveNodes(e, {
                                                at: l,
        ...
        move(e) {
            ...
            if (n) {
                ...
                var { anchor: o, focus: l } = n,
                    ...
                    c = {};
                if (null == s || "anchor" === s) {
                    var d = a ? J.before(e, o, u) : J.after(e, o, u);
                    d && (c.anchor = d);
                }
                if (null == s || "focus" === s) {
        ...
        setPoint(e, t) {
            ...
            if (r) {
                ...
                var { anchor: a, focus: s } = r,
                    o = "anchor" === i ? a : s;
                eW.setSelection(e, { ["anchor" === i ? "anchor" : "focus"]: eF(eF({}, o), t) });
            }
        },
        setSelection(e, t) {
            var { selection: n } = e,
            ...
            if (n) {
                for (var a in t)
                    (("anchor" !== a || null == t.anchor || e_.equals(t.anchor, n.anchor)) &&
                        ("focus" !== a || null == t.focus || e_.equals(t.focus, n.focus)) &&
    ...
    ej = {
        delete(e) {
            ...
            J.withoutNormalizing(e, () => {
                ...
                if (o) {
                    var u = !1;
                    if ((eg.isRange(o) && eg.isCollapsed(o) && ((u = !0), (o = o.anchor)), e_.isPoint(o))) {
                    ...
                    if (el.isPath(o)) return void eW.removeNodes(e, { at: o, voids: s });
                    if (!eg.isCollapsed(o)) {
                        if (!l) {
                            var [, p] = eg.edges(o),
                                h = J.end(e, []);
                            e_.equals(p, h) || (o = J.unhangRange(e, o, { voids: s }));
                        }
                        var [m, g] = eg.edges(o),
                            E = J.above(e, { match: (t) => z.isElement(t) && J.isBlock(e, t), at: m, voids: s }),
                            A = J.above(e, { match: (t) => z.isElement(t) && J.isBlock(e, t), at: g, voids: s }),
                            I = E && A && !el.equals(E[1], A[1]),
                            T = el.equals(m.path, g.path),
                            y = s ? null : J.void(e, { at: m, mode: "highest" }),
                            S = s ? null : J.void(e, { at: g, mode: "highest" });
                        if (y) {
                            var v = J.before(e, m);
                            v && E && el.isAncestor(E[1], v.path) && (m = v);
                        }
                        if (S) {
                            var C = J.after(e, g);
                            C && A && el.isAncestor(A[1], C.path) && (g = C);
                        }
                        var b = [];
                        for (var N of J.nodes(e, { at: o, voids: s })) {
                            var [R, O] = N;
                            (!n || 0 !== el.compare(O, n)) &&
                                ((!s && z.isElement(R) && J.isVoid(e, R)) ||
                                    (!el.isCommon(O, m.path) && !el.isCommon(O, g.path))) &&
                                (b.push(N), (n = O));
                        }
                        var D = Array.from(b, (t) => {
                                var [, n] = t;
                                return J.pathRef(e, n);
                            }),
                            L = J.pointRef(e, m),
                        ...
                        if (
                            (D.reverse()
                                .map((e) => e.unref())
                                .filter((e) => null !== e)
                                .forEach((t) => eW.removeNodes(e, { at: t, voids: s })),
                            !S)
                        ) {
                            var V = w.current,
                                [F] = J.leaf(e, V),
                                { path: B } = V,
                                j = T ? m.offset : 0,
                                H = F.text.slice(j, g.offset);
                            H.length > 0 && (e.apply({ type: "remove_text", path: B, offset: j, text: H }), (x = H));
                        }
                        !T && I && w.current && L.current && eW.mergeNodes(e, { at: w.current, hanging: !0, voids: s }),
                            u &&
                                r &&
                                "character" === i &&
                                x.length > 1 &&
        ...
        insertFragment(e, t) {
            ...
            J.withoutNormalizing(e, () => {
                ...
                if (t.length) {
                    if (s) {
                        if (eg.isRange(s))
                            if ((i || (s = J.unhangRange(e, s, { voids: a })), eg.isCollapsed(s))) s = s.anchor;
                            else {
                                var [, o] = eg.edges(s);
                                if (!a && J.void(e, { at: o })) return;
                                var l = J.pointRef(e, o);
                                eW.delete(e, { at: s }), (s = l.unref());
                            }
                        ...
                        if (!(!a && J.void(e, { at: s }))) {
                            ...
                            if (u) {
                                var [, c] = u;
                                J.isEnd(e, s, c) ? (s = J.after(e, c)) : J.isStart(e, s, c) && (s = J.before(e, c));
                            }
                            var d = J.above(e, { match: (t) => z.isElement(t) && J.isBlock(e, t), at: s, voids: a }),
                                [, _] = d,
                                f = J.isStart(e, s, _),
                                p = J.isEnd(e, s, _),
                                h = f && p,
                            ...
                            for (var y of ei.nodes({ children: t }, { pass: T })) T(y) && I.push(y);
                            var S = [],
                                v = [],
                                C = [],
                                b = !0,
                            ...
                            var [O] = J.nodes(e, {
                                    at: s,
                                    match: (t) => eb.isText(t) || J.isInline(e, t),
                                    mode: "highest",
                                    voids: a,
                                }),
                                [, D] = O,
                                L = J.isStart(e, s, D),
                                w = J.isEnd(e, s, D),
                                x = J.pathRef(e, p && !C.length ? el.next(_) : _),
                                P = J.pathRef(e, w ? el.next(D) : D);
                            eW.splitNodes(e, {
                                at: s,
                                match: (t) =>
                                    N ? z.isElement(t) && J.isBlock(e, t) : eb.isText(t) || J.isInline(e, t),
                                mode: N ? "lowest" : "highest",
                                always: N && (!f || S.length > 0) && (!p || C.length > 0),
                                voids: a,
                            });
                            var M = J.pathRef(e, !L || (L && w) ? el.next(D) : D);
                            if (
                                (eW.insertNodes(e, S, {
                                    at: M.current,
                                    match: (t) => eb.isText(t) || J.isInline(e, t),
                                ...
                                h && !S.length && v.length && !C.length && eW.delete(e, { at: _, voids: a }),
                                eW.insertNodes(e, v, {
                                    at: x.current,
                                ...
                                !n.at &&
                                    (C.length > 0 && P.current
                                        ? (r = el.previous(P.current))
                                        : v.length > 0 && x.current
                                          ? (r = el.previous(x.current))
                                          : M.current && (r = el.previous(M.current)),
                                    r))
                            ) {
                                var k = J.end(e, r);
                                eW.select(e, k);
                            }
                            M.unref(), x.unref(), P.unref();
                        }
                    }
                }
            });
...
var eW = eY(eY(eY(eY({}, eD), eM), eB), ej);
