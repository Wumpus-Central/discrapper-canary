...
function Z(e) {
    let { streamKey: t } = e,
        n = (0, p.my)(t);
    r.delete(t), r.set(t, D(R({}, n), { state: A.jm8.CONNECTING })), n.ownerId === b.default.getId() && (x[n.channelId] = !1);
}
function H(e) {
    var t;
...
function z(e) {
    ...
    r.set(t, D(R({}, (0, p.my)(t)), { state: a ? A.jm8.PAUSED : A.jm8.ACTIVE })),
        (o[t] = {
            streamKey: t,
            region: n,
            viewerIds: i
...
function X(e) {
    ...
    r.set(t, D(R({}, s), { state: l })), l === A.jm8.ENDED && L !== t && G(t);
}
function J(e) {
    let { streamKey: t } = e,
        n = r.get(t);
