...
let _ = (e, t) => {
    ...
    let i = new Set(
            n.map((e) => "".concat(e.userId, "-").concat(e.activity.session_id, "-").concat(e.activity.application_id)),
        ),
        a = new Set(
            r.map((e) => "".concat(e.userId, "-").concat(e.activity.session_id, "-").concat(e.activity.application_id)),
        );
...
function p(e) {
    let t = (0, s.e7)(
        [c.Z],
        () => (null != e && f.Hw.includes(e) ? f.yh.flatMap((e) => c.Z.getAllApplicationActivities(e)) : []),
        [e],
        _,
    );
...
function h(e, t) {
    ...
    return (
        t.forEach((t) => {
            var r, s, c;
            let d = t.userId;
            if (null == d || !l.ZP.isMember(e, d) || null == t.activity.application_id || "" === t.activity.name)
                return;
            let f =
                    null !=
                    (c =
                        null != (s = null == (r = t.activity.timestamps) ? void 0 : r.start)
                            ? s
