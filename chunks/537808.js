...
function f(e) {
    ...
    async function E() {
        (w(null), v(new Set(S)));
        try {
            for (let e of S) (await h.A.createForumTag({ name: e }, n), z(e, !1));
            t.onClose();
        } catch (e) {
            (w(new u.LG(e)), v(new Set()));
        }
    }
    return (0, i.jsxs)(l.a, {
        size: "sm",
        ...
        children: [
            null != f
                ? (0, i.jsx)("div", {
                      className: C.z3,
                      children: (0, i.jsx)(d.w, { type: "critical", children: f.message }),
                  })
                : null,
            (0, i.jsxs)("div", {
                className: C._A,
