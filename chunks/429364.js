...
function h(e) {
    ...
    let v,
        ...
        y,
        E,
        { children: C, clip: k, modalContainerRef: A, editOnly: N = !1 } = e,
        ...
        em = n.useCallback(
            () => ({
                ...k,
                name: _,
                editMetadata: { start: P, end: U, applicationAudio: G, voiceAudio: B, soundboardAudio: $ },
            }),
            [k, _, P, U, G, B, $],
        ),
        ef = n.useCallback((e) => {
    ...
    (t = k.filepath),
        ...
        (h = k.id),
        (p = { name: _, editMetadata: { start: P, end: U, voiceAudio: B, applicationAudio: G, soundboardAudio: $ } }),
        ((j = n.useRef(p)).current = p),
        n.useEffect(() => {
            async function e() {
                let e = {},
                    t = j.current;
                w || null == M || (e = { thumbnail: await (0, c.m)(M, t.editMetadata.start) }),
                    (0, u.Yy)(h, { ...t, ...e }, !0);
            }
            return () => {
                N || e();
    ...
    let ev = n.useMemo(() => U - P, [P, U]),
        ...
        ),
        {
            ...
            (e) => {
                ...
                O((e) => ({ ...e, cropStart: t })), z?.current?.seek(t);
            },
            [U, O, z],
        )),
        {
            ...
            setCropEnd: n.useCallback(
                (e) => {
                    ...
                    O((e) => ({ ...e, cropEnd: t })), z?.current?.seek(t);
                },
                [P, H, O, z],
            ),
    ...
    (0, r.A)(() => {
        ...
        n.useEffect(() => {
            ...
            let e = () => {
                ...
                a = () => {
                    X(!0), V(Q.duration), z?.current?.seek(I);
                },
                n = () => {
                    J.current = !0;
                };
            return (
                ...
                Q.readyState >= 1 && (X(!0), z?.current?.seek(I)),
                Z(!Q.paused),
                () => {
    ...
    return (0, a.jsx)(f.Provider, { value: eL, children: C });
}
function p() {
