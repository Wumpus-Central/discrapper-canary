...
var r = n(54381),
    ...
    O = n(388032),
    h = n(802690);
let m = (0, f.Mg)(o.Z.INTERACTION_IFRAME_MODAL_MODAL_MIN_WIDTH),
    g = (0, f.Mg)(o.Z.INTERACTION_IFRAME_MODAL_MODAL_MAX_WIDTH),
    j = (0, f.Mg)(o.Z.INTERACTION_IFRAME_MODAL_MODAL_MARGIN),
    w = (0, f.Mg)(o.Z.INTERACTION_IFRAME_MODAL_MODAL_HEADER_HEIGHT);
function v(e) {
    var t, n, o;
    let { title: f, onClose: v } = e,
        { applicationIconURL: x, applicationName: y, queryParams: I, iframeUrl: M } = (0, b.b8)(e),
        { width: N, height: A } = (0, d.Z)(),
        _ = a.useMemo(() => {
