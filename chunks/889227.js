...
class A extends a.A {
    ...
    constructor(e) {
        ...
        (this.id = e.id),
            ...
            (this.primaryGuild = (0, _.j)(e.primary_guild ?? e.primaryGuild ?? null)),
            ...
            (this.perks = e.perks?.activePerksBitmask != null ? e.perks : (0, c.c$)(e.perks)),
    ...
    isPremiumWithPremiumGroup() {
        return (0, m.ki)(this, p.PremiumTypes.TIER_2) && this.premiumState?.premiumSource === s.fE.SUBSCRIPTION_GROUP;
    }
    isPremiumWithFractionalPremiumOnly() {
        return (
            (0, m.ki)(this, p.PremiumTypes.TIER_2) &&
