...
function I(e) {
    return (0, i.bG)([d.A, c.A], () => {
        let t = d.A.getGuild(e),
            ...
            r = c.A.can(m.xBc.MANAGE_GUILD, t),
            i = c.A.can(m.xBc.MANAGE_ROLES, t);
        return n && r && i;
    });
}
function T(e) {
        ...
        () => {
            ...
            for (let e of n[u.I6])
                (0, h.S)(e.channel.guild_id, e.channel.id) &&
                    ...
                    ((s[e.channel.id] = e), r.push(e.channel), C(e.channel) && i.push(e.channel.id));
            return [i, r];
        },
        [e, t],
        w,
...
function k(e) {
    let t = e.filter((e) => e.connection_type === p.wZ.PROVIDER_CONNECTED_ACCOUNT && e.provider_id),
        n = [],
        r = [];
    return (
        t.forEach((e) => {
...
function x(e) {
    let t = e.filter((e) => e.connection_type === p.wZ.APPLICATION && e.application_id),
        r = [],
        i = [],
        s = n(546183).default,
