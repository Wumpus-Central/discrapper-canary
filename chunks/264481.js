...
function O(e) {
    let { user: n, guildId: t, channelId: l } = e,
        ...
        [p] = r.useState(() => {
            var e;
            return (null != (e = (0, c.sample)(g)) ? e : g[0])(s);
        }),
        _ = r.useCallback(() => {
