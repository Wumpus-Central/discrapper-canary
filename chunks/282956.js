...
let o = {
    ...
    setSection(e) {
        ...
        r.h.dispatch({ type: "INTEGRATION_SETTINGS_SET_SECTION", section: e, sectionId: t });
    },
    startEditingCommandPermissions(e) {
        r.h.dispatch({ type: "INTEGRATION_SETTINGS_START_EDITING_COMMAND", commandId: e });
    },
    stopEditingCommandPermissions(e) {
        r.h.dispatch({ type: "INTEGRATION_SETTINGS_STOP_EDITING_COMMAND", commandId: e });
    },
    startEditingIntegration(e) {
        r.h.dispatch({ type: "INTEGRATION_SETTINGS_START_EDITING_INTEGRATION", integrationId: e });
    },
    stopEditingIntegration() {
        r.h.dispatch({ type: "INTEGRATION_SETTINGS_STOP_EDITING_INTEGRATION" });
    },
    updateIntegration(e) {
        r.h.dispatch({ type: "INTEGRATION_SETTINGS_UPDATE_INTEGRATION", settings: e });
    },
    startEditingWebhook(e) {
        r.h.dispatch({ type: "INTEGRATION_SETTINGS_START_EDITING_WEBHOOK", webhookId: e });
    },
    stopEditingWebhook() {
        r.h.dispatch({ type: "INTEGRATION_SETTINGS_STOP_EDITING_WEBHOOK" });
    },
    updateWebhook(e) {
        r.h.dispatch({ type: "INTEGRATION_SETTINGS_UPDATE_WEBHOOK", settings: e });
    },
    async saveApplicationPermissions(e, t, n) {
        try {
            ...
            r.h.dispatch({ type: "INTEGRATION_SETTINGS_SAVE_FAILURE", errors: e.body });
        }
    },
