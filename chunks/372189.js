            ...
            i.useMemo(() => {
                if (0 !== Object.values(t ?? {}).length)
                    return l.length > 0
                        ...
                        : { type: "active", statusText: T.intl.string(G.default.FFLkmx) };
            }, [l, t])),
...
function ec(e) {
    let { powerup: t, targetRef: l, isCardVisible: s } = e,
        ...
        u =
            t.skuId === K.FB
                ? {
                      title: T.intl.string(G.default.YWo6VL),
                      body: T.intl.string(G.default.gXVvKc),
        ...
        children: [
            ...
            (0, n.jsx)("div", {
                ...
                children: (0, n.jsx)(E.E, {
                    color: s,
                    variant: "text-sm/medium",
                    children: T.intl.string(G.default.nIj3LZ),
                }),
            }),
        ],
    });
...
function eI(e) {
    ...
    return (0, n.jsxs)(eg, {
        ...
        children: [
            ...
            !m && (0, n.jsx)(y.kd, { children: (0, n.jsx)(en.Ay, { guildId: l, powerup: r, onError: g }) }),
        ],
    });
}
var ej = l(866665),
                ...
                "guildTagsBadgePacks" === r
                    ? (function (e) {
                          let { guildId: t, canUseBoosts: i, allPowerups: s, hasServerTags: r } = e,
                              o = T.intl.string(G.default.KC9HRW),
                              a = T.intl.string(G.default.GJiSmP),
                              u = s?.[K.SL],
                              d = T.intl.string(G.default["/egwJA"]),
                              c = r ? void 0 : T.intl.string(G.default.W6Vwn3),
                              m = r ? void 0 : T.intl.string(G.default.lvk1Gc),
                              p = r ? T.intl.string(G.default["9CfkLO"]) : T.intl.string(T.t["+7XY31"]),
                                      ...
                                      async () => {
                                          ...
                                          return (l) =>
                                              (0, n.jsx)(s, {
                                                  guildId: t,
                                                  title: o,
                                                  description: T.intl.string(G.default.BBRFRd),
                                                  powerups: e,
                                                  forceStaticImages: !0,
                                                  footerInfoText: m,
                                                  footerAction:
    ...
    let { guildId: t, group: l, powerups: s } = e,
        ...
        m = (function (e) {
            ...
            null != r
                ...
                : s && (t = { type: "active", statusText: T.intl.string(G.default.FFLkmx) });
            let o = i.reduce((e, t) => {
                ...
                children:
                    d?.viewCtaTooltip != null
                        ? (0, n.jsx)(ej.m, {
                              ...
                              delay: 100,
                              children: (0, n.jsx)(S.$, { text: d.viewCta, fullWidth: !0 }),
                          })
                        : (0, n.jsx)(S.$, { text: d.viewCta, fullWidth: !0 }),
            }),
        ],
    });
}
    ...
    return (0, n.jsxs)("div", {
        ...
        children: [
            ...
            (0, n.jsx)(E.E, {
                ...
                children: T.intl.string(G.default.diMhWc),
            }),
            (0, n.jsx)(E.E, {
                color: "text-overlay-light",
                variant: "text-sm/medium",
                children: T.intl.string(G.default.pycxTr),
            }),
            (0, n.jsx)("div", {
                className: eG.VN,
...
function eV(e) {
    ...
    return (0, n.jsxs)("div", {
        ...
        children: [
            ...
            (0, n.jsx)(eO.E, { color: w.A.colors.TEXT_FEEDBACK_WARNING, className: eU.Kk }),
...
function eB(e) {
            ...
            return i.useMemo(
                () =>
                    s <= 0
                        ...
                        : {
                              shouldShow: !0,
                              title: T.intl.string(G.default.n5hQhc),
                              description: T.intl.formatToPlainString(G.default.iAaAiG, {
                                  boostCount: s,
                                  perksString: t.join(", "),
                              }),
    ...
    return o
        ? (0, n.jsxs)("div", {
              className: eF.kL,
              children: [
                  (0, n.jsx)(eO.E, { color: w.A.colors.TEXT_FEEDBACK_WARNING, className: eF.Kk }),
...
function e$(e) {
    let { guildId: t } = e,
        l = (0, r.bG)([c.A], () => c.A.getGuild(t)?.features.has(ex.GuildFeatures.PREMIUM_TIER_3_OVERRIDE) === !0)
            ? { shouldShow: !0, text: T.intl.string(G.default.l9n4QZ) }
            : { shouldShow: !1, text: "" },
        s = (function (e) {
            let t,
                l =
            ...
            let o = n.length > 0 ? T.intl.string(U.default["B3OfL/"]) : void 0,
                ...
                u = [];
            return (
                l.some((e) => e.skuId === K.FB) && u.push(T.intl.string(G.default.Sfr0Jw)),
        ...
        ? (0, n.jsxs)("div", {
              ...
              children: [
                  (0, n.jsx)(E.E, {
                      variant: "eyebrow",
                      color: "text-subtle",
                      children: T.intl.string(G.default["3FRirU"]),
                  }),
...
function eX(e) {
    ...
    let [a, u] = i.useState(!1),
        { textColor: d } = C((0, el.Ay)(t, l).type !== O.b_.INACTIVE);
    return (0, n.jsxs)(eg, {
        onHover: (e) => u(e),
        guildId: t,
        powerup: l,
        ...
        children: [
            ...
            (0, n.jsx)(y.kd, { children: (0, n.jsx)(en.Ay, { guildId: t, powerup: l, onError: o }) }),
        ],
    });
}
var eH = l(862482),
...
function eY(e) {
    let { count: t, type: l } = e,
        i = (function (e, t) {
            switch (t) {
                case O.yG.AVAILABLE:
                    return T.intl.formatToPlainString(G.default.BdRXZA, { boostCount: e });
                case O.yG.SPENT:
                    return T.intl.formatToPlainString(G.default.xvgIVG, { boostCount: e });
                case O.yG.TOTAL:
                    return T.intl.string(G.default["/F7Z2y"]);
            }
        })(t, l);
    return (0, n.jsxs)("div", {
        className: eq.k,
        ...
        children: [
            (0, n.jsxs)("div", {
                ...
                children: [
                    (0, n.jsx)(x._, {
                        size: "sm",
                        color: l !== O.yG.AVAILABLE ? w.A.colors.TEXT_MUTED : w.A.unsafe_rawColors.GUILD_BOOSTING_PINK,
                    }),
                    (0, n.jsx)(h.D, {
                ...
                (0, n.jsxs)("div", {
                    ...
                    children: [
                        (0, n.jsx)(E.E, {
                            variant: "eyebrow",
                            color: "text-subtle",
                            children: T.intl.string(G.default.hjvcLO),
                        }),
                        (0, n.jsx)(E.E, {
                            className: e0.C2,
                            variant: "text-xs/semibold",
                            children: T.intl.format(G.default.fXE30d, {
              ...
              children: [
                  (0, n.jsxs)("div", {
                      ...
                      children: [
                          (0, n.jsx)(E.E, {
                              variant: "text-md/semibold",
                              children: T.intl.string(u ? G.default.KSWK1U : G.default.XXXX5l),
                          }),
                          (0, n.jsx)(E.E, {
                              variant: "text-sm/medium",
        ...
        d = i.useCallback(
            async (e) => {
                ...
                try {
                    ...
                    u(!e), (0, to.P0)((0, ta.o)(T.intl.string(T.t["rTU7/z"]), tu.Ck.FAILURE));
                }
            },
            [t],
        );
    return null == l || !o || s
        ...
        : (0, n.jsx)("div", {
              ...
              children: (0, n.jsx)(td.d, {
                  label: T.intl.string(G.default.UuwXRZ),
                  description: T.intl.string(G.default.MIwlcR),
                  checked: a,
                  onChange: d,
              }),
          });
...
function t_(e) {
    let t,
        ...
        c = new Date(s),
        { Icon: m, color: p } = (function (e) {
            switch (e) {
                case "gave":
                    return { Icon: x._, color: w.A.colors.ICON_MUTED };
                case "expiring":
                    return { Icon: th.x, color: w.A.colors.ICON_FEEDBACK_WARNING };
                case "expired":
                    return { Icon: th.x, color: w.A.colors.ICON_FEEDBACK_CRITICAL };
            }
        })(i);
    return (0, n.jsxs)("div", {
        className: tj.og,
        children: [
            (0, n.jsx)(m, { color: p, size: "sm" }),
            (0, n.jsxs)("span", {
                className: tj.x$,
                children: [
                    (0, n.jsx)(E.E, {
                    ...
                    (0, n.jsx)(E.E, {
                        ...
                        children: (function (e) {
                            switch (e.phase) {
                                case "gave":
                                    return T.intl.string(G.default.plwH8d);
                                case "expiring":
                                    return T.intl.formatToPlainString(G.default.vct4l8, { date: e.endsAt.valueOf() });
                                case "expired":
                                    return T.intl.string(G.default.hSXjlI);
                            }
                        })(e),
                    }),
                ],
            ...
            (0, n.jsx)(tE.A, {
                timestamp: c,
                timestampFormat:
                    0 === (t = (0, tv.m_)(c, new Date()))
                        ? `[${T.intl.string(T.t.mbs4NX)}]`
                        : -1 === t
                          ? `[${T.intl.string(T.t.ZdDLO0)}]`
                          : "L",
                className: g()(tb["text-xs/semibold"], tj.vE),
            }),
        ],
    });
}
...
function ty(e) {
    let { guildId: t } = e,
        l = (function (e) {
            let t = (0, r.yK)([eM.A], () => eM.A.getAppliedGuildBoostsForGuild(e) ?? [], [e]),
            ...
            i.useEffect(() => {
                s.length > 0 && s.forEach((t) => tx.A.requestMember(e, t));
            }, [e, s]);
            let o = (0, r.bG)([c.A], () => c.A.getGuild(e)?.premiumSubscriberCount),
                a = i.useMemo(() => t.filter((e) => !e.ended).length, [t]),
                u = (0, r.bG)([eM.A], () => null != eM.A.getLastFetchedAtForGuild(e), [e]);
            return (
                i.useEffect(() => {
                    (o === a && u) || (0, tf.VU)(e, { includeEnded: !0 });
                }, [e, o, a, u]),
                n
            );
        })(t);
...
function tC(e) {
    let t,
        ...
        y,
        w,
        { guildId: C, powerupListingId: R } = e;
    (t = (0, b.C$)(C, "useLoadGuildPowerups")),
        i.useEffect(() => {
            t && (0, H.z9)(C);
        }, [C, t]),
        i.useEffect(() => {
    ...
    let N = (0, b.C$)(C, "GuildPowerupsOverview");
    (0, X.Pq)(C);
    let L = (0, r.bG)([B.A], () => B.A.getStateForGuild(C)),
        P = (0, m.A)(C),
        U = i.useRef(!1),
        { shouldShow: V, modalConfig: M } =
            ((s = (0, r.bG)([c.A], () => c.A.getGuild(C))),
            (o = (0, m.A)(C) ?? !1),
            (a = (0, r.bG)([B.A], () => B.A.getStateForGuild(C))),
            (u = a?.allPowerups?.[K.zY]),
            (p = u?.storeRemovalDate),
            (_ = (0, $.p)(C, "GuildPowerupsOverview")),
            (S = o && _ && null != s),
            (y = i.useMemo(() => {
                if (!S || null == u || null == p) return null;
                let e = (0, J.A)(p);
                return {
                    dismissibleContent: z.M.FILE_UPLOAD_POWERUP_ROLLBACK_MODAL,
                    header: `${u.title} ${T.intl.formatToPlainString(G.default["6e2ry1"], { dateString: e })}`,
                    bodies: [
                        T.intl.formatToPlainString(G.default.jd8fki, {
                            startDate: e,
                            endDate: e,
                            perkName: u.title,
                            boostCount: u.cost,
    ...
    let [ei, es] = (0, j.kn)(en),
        er =
            ((w = (0, r.bG)([B.A], () => B.A.getStateForGuild(C))),
            i.useMemo(
                () =>
                    Y.reduce((e, t) => {
            ...
            for (let e of er)
                for (let t of e.listings) {
                    if (("singleLevel" === t.type || "singlePerk" === t.type) && t.powerup.skuId === R) {
                        (0, ey.A)(C, t.powerup), (U.current = !0);
                        return;
                    }
                    ...
                    if ("gameServer" === t.type && R === D.W5) {
                        (0, k.A)({ guildId: C, analyticsLocation: I.A.GUILD_POWERUPS_OVERVIEW }), (U.current = !0);
                        return;
                    }
                }
    }, [C, R, er, eo]),
        ...
        : (0, n.jsxs)("div", {
              ...
              children: [
                  (0, n.jsxs)(F.A, {
                      ...
                      toolbar: (0, n.jsx)("div", {}),
                      children: [
                          (0, n.jsx)(F.A.Icon, { icon: x._, "aria-label": "" }),
                          (0, n.jsx)(F.A.Title, { children: T.intl.string(G.default.yv3DJJ) }),
                      ],
                  }),
                  (0, n.jsxs)("div", {
                      className: tw.hQ,
                                  ...
                                  let { type: t, listings: l } = e,
                                      { title: i, description: s } = (function (e) {
                                          switch (e) {
                                              case O.o9.LEVEL:
                                                  return {
                                                      title: T.intl.string(G.default["TXY/b0"]),
                                                      description: T.intl.string(G.default.aJv4PB),
                                                  };
                                              case O.o9.PERK:
                                                  return {
                                                      title: T.intl.string(G.default.TV3Vm8),
                                                      description: T.intl.string(G.default.STx9hp),
                                                  };
                                          }
                                      })(t),
                          ...
                          (0, n.jsxs)("div", {
                              ...
                              children: [
                                  P
                                      ? (0, n.jsxs)(n.Fragment, {
                                            children: [
                                                (0, n.jsx)(e1, { guildId: C }),
                                                (0, n.jsx)(tg, { guildId: C }),
                                                (0, n.jsx)(e$, { guildId: C }),
                                            ],
                                        })
                                      : (0, n.jsxs)("div", {
                                            ...
                                            children: [
                                                ...
                                                (0, n.jsx)(tr, { guildId: C }),
                                            ],
                                        }),
                                  (0, n.jsx)(ty, { guildId: C }),
                              ],
                          }),
                      ],
                  }),
