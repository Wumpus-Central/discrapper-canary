...
var eS = i(580630),
    ...
    eC = i(788868),
    e_ = i(657127);
let eI = { page: eo.liQ.USER_SETTINGS, section: eo.JJy.SETTINGS_PREMIUM, object: eo.ZSU.CARD };
function eb(e) {
    ...
    let u = (0, eS.$g)(o.amount, s.currency),
        d = (0, O.y8)(eC.gD.PREMIUM_MONTH_TIER_2, !1, !1, { currency: t.currency, paymentSourceId: t.paymentSourceId }),
...
function ev(e) {
    let { discountOffer: t, premiumSubscription: i } = e,
        s = (0, ep.tQ)(i, eC.gD.PREMIUM_MONTH_TIER_2, t);
    return (0, n.jsxs)(n.Fragment, {
        children: [
            (0, n.jsx)(m.D, {
                variant: "heading-xl/semibold",
            ...
            (0, n.jsx)(g.E, {
                ...
                children: $.intl.format($.t["PH7Q+R"], {
                    ...
                    discountedPrice: s,
                    billingPeriod: (0, O.Ke)(t.discount.user_usage_limit_interval),
                }),
            }),
        ],
    });
...
let ej = function (e) {
    let t,
        ...
        { analyticsLocations: m } = (0, N.Ay)(p.A.CHURN_DISCOUNT_SUBSCRIPTION_HEADER),
        A = (e) => {
            (0, V.openModalLazy)(async () => {
        ...
        h = O.Ay.getPlanIdFromInvoice(l, r),
        E = (0, eN.ux)(c?.expires_at);
    return (0, b.m1)(h)
        ? null
        : (0, n.jsx)("div", {
              className: e_.S6,
                          ...
                          (0, n.jsxs)("div", {
                              ...
                              children: [
                                  (0, n.jsxs)("div", {
                                      ...
                                      children: [
                                          null != c
                                              ? (0, n.jsx)(ev, { discountOffer: c, premiumSubscription: l })
                                              : (0, n.jsx)(eb, {
                                                    premiumSubscription: l,
                                                    discountInfo: u ?? d,
                                                    invoicePreview: r,
                                          ...
                                          (0, n.jsx)("div", {
                                              className: e_.e_,
                                              children:
                                                  ((t = O.Ay.isSwitchingPlansDisabled(l)),
                                                  (s = O.Ay.getSwitchingPlansDisabledMessage(l)),
                                                  O.Ay.isBaseSubscriptionCanceled(l)
                                                      ? (0, n.jsx)(w.$, {
                                                            variant: "expressive",
                                                            icon: eT.t,
                                                            size: "md",
                                                            ...
                                                            loading: a,
                                                            onClick: () => A(ef.g.CONFIRM_DISCOUNT),
                                                        })
                                                      : (0, n.jsxs)("div", {
                                                            className: e_.qK,
                                                            children: [
...
var ey = i(284009),
    ...
    ek = i(601107),
    ew = i(428797);
let eF = [eo.Dmq.PAST_DUE, eo.Dmq.ACCOUNT_HOLD, eo.Dmq.BILLING_RETRY],
    eB = (e) => {
        ...
        return (0, n.jsx)(eL.Modal, {
            ...
            actions: m,
            onClose: async () => i(),
            children: d ? (0, n.jsx)(eD.w, { type: "critical", children: $.intl.string($.t["5mlOCW"]) }) : null,
        });
    };
function ez(e) {
    let t,
        ...
        d = (0, u.bG)([v.default], () => {
            ...
            return eO()(null != e, "GuildBoostingHeader: currentUser cannot be undefined"), e;
        }),
        { analyticsLocations: c } = (0, N.Ay)(p.A.GUILD_BOOSTING_SUBSCRIPTION_HEADER);
    if (0 === (0, O.bx)(i.additionalPlans)) return null;
    let { status: m } = i,
        A = (0, O.$k)(i),
        h = !A && i.isBoostOnly && eF.includes(i.status);
    if (A) t = ew.v2;
    else
        switch (m) {
            case eo.Dmq.PAST_DUE:
        ...
        children: [
                    ...
                    a &&
                        (0, n.jsxs)("div", {
                            ...
                            children: [
                                ...
                                (0, n.jsx)(eV.A, {
                                    onClick: () => (0, eM.openUserSettings)(eU.X.PREMIUM_GUILD_SUBSCRIPTIONS_PANEL),
            ...
            !a &&
                (0, n.jsx)(g.E, {
                    ...
                    children: $.intl.format(eR.Fr ? $.t.uxYBEa : $.t.k6haR9, { openAppHook: () => (0, eP.A)("app") }),
                }),
        ],
    });
}
...
function eW(e) {
    ...
    return (
        o.fractionalState === eC.xc.FP_SUB_PAUSED && (u = o.endsAt.toDate()),
        (0, n.jsxs)("div", {
            className: r()(eK.zr, l),
            children: [
    ...
    return (
        ...
        (0, n.jsxs)("div", {
            ...
            children: [
                ...
                (0, n.jsx)(g.E, { className: eZ.Cy, variant: "text-sm/normal", children: $.intl.string($.t.xFHEMa) }),
            ],
        })
    );
}
...
function eJ(e) {
    let { daysPastDue: t, subscription: i, openInvoiceId: l } = e,
        { analyticsLocations: r } = (0, N.Ay)(p.A.PAST_DUE_ONE_TIME_PAYMENT_METHOD_BANNER);
    return (
        s.useEffect(() => {
            j.default.track(eo.HAw.TOOLTIP_VIEWED, { type: "subscription_settings_invalid_payment_method" });
        }, []),
...
function e$(e) {
    ...
    return (0, n.jsxs)("div", {
        className: r()(eZ.KF, l),
        children: [
            (0, n.jsx)(m.D, { variant: "heading-md/semibold", className: eZ.QL, children: $.intl.string($.t.KXQjfc) }),
...
function e0() {
    ...
    return (0, n.jsxs)("div", {
        children: [
            ...
            (0, n.jsx)("p", { className: eZ.yV, children: $.intl.string($.t.D8UpUo) }),
            !t &&
                (0, n.jsx)(A.Z, {
                    className: eZ.wb,
                    ...
                    children: (0, n.jsxs)(C.A, {
                        ...
                        children: [
                            (0, n.jsx)(_.A, { game: null, size: _.M.SMALL, className: eZ.pV }),
                            (0, n.jsx)("span", { className: eZ.O, children: $.intl.string($.t.xCRgr1) }),
                        ],
                    }),
                }),
...
function e1(e) {
    let {
        ...
        { analyticsLocations: A } = (0, N.Ay)(p.A.SUBSCRIPTION_DETAILS),
    ...
    if (null == S || null == _) return (0, n.jsx)(h.y, {});
    let P = y ? (0, D.Bv)(_) : null,
        U = null != P || (null != v && (v.discountId === eC.q || v.discountId === eC.EG)),
        M =
            y && ((j && null != b) || (!j && U))
                ? (0, n.jsx)(ej, {
                      subscription: t,
...
let e2 = new Set([eo.Dmq.ACTIVE, eo.Dmq.PAST_DUE, eo.Dmq.CANCELED, eo.Dmq.PAUSE_PENDING, eo.Dmq.PAUSED]);
function e3() {
    return (
        s.useEffect(() => {
...
function e6(e) {
    ...
    let A = (0, u.bG)([v.default], () => v.default.getCurrentUser()),
        { analyticsLocations: T } = (0, N.Ay)(p.A.SUBSCRIPTION_DETAILS),
        f = (0, G.p)(),
        C = null != l ? l.slice(1) : [],
        [_, I] = s.useState(0);
    s.useEffect(() => {
        ...
        : (null != i.renewalMutations &&
          ...
          (0, n.jsxs)(E.n, {
              ...
              children: [
                  V ? (0, n.jsx)(eq, {}) : null,
                  k ? (0, n.jsx)(eQ, {}) : null,
                  F && null != H ? (0, n.jsx)(eJ, { daysPastDue: z, subscription: i, openInvoiceId: H.id }) : null,
                  Y && X && (0, n.jsx)(eA, { subscription: i, analyticsLocations: T }),
                  t,
                  (0, n.jsxs)("div", {
                      children: [
                          (0, n.jsx)("div", {
                              className: C.length > 0 ? eZ.HZ : eZ.__invalid_singleSubscription,
                              children: (0, n.jsx)(e1, {
                                  subscription: i,
                                  analyticsLocation: c,
                                  paymentSource: r,
