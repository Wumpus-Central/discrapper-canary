...
let E = (e) => {
    ...
    C = (e) => {
        var t;
        let { className: n, variant: s = f.R0.PERKS_DISCOVERABILITY, noBackground: C = !1, leftAlignHeaders: j = !1, showAllPerksButton: O, headerClassname: S, isFullScreen: v = !0, shouldAutoScroll: T = !1 } = e,
            I = r.useRef(null),
            N = (0, u.Er)(),
            y = (0, m.v)(N),
            A = s === f.R0.WHATS_NEW,
