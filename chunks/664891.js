...
function k(e) {
    ...
    n = K || eo ? P.intl.string(P.t.nyzoFR) : (0, b.PV)(x) ? (0, b.W_)(a, en) : P.intl.formatToPlainString(P.t['sBpy9/'], { planName: en.name });
    let eu = null;
    return (
        null != a &&
            (eu = K
...
function F(e) {
    ...
    t = n.type === L.NYc.PREMIUM ? (0, b.Gf)(r.id) : r.name;
