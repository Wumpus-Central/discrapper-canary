n.d(e, { $V: () => P, $k: () => S, aG: () => M, mO: () => N, v8: () => v }), n(321073);
var i = n(64700),
    r = n(106778),
    a = n(284009),
    l = n.n(a),
...
let k = (t) => (null != t ? g.intl.format(g.t["4kp0AB"], { itemName: t }) : null),
    S = (t) => {
        ...
        if (null != n) return n;
        if (b.Dp.ORB_PROFILE_BADGE === e.skuId) return g.intl.string(y.default.nvaTQq);
    ...
    v = (t) => {
        ...
        if (null != n) return n;
        if (b.Dp.ORB_PROFILE_BADGE === e.skuId) return g.intl.string(y.default.UnPGii);
        if (b.Dp.FRACTIONAL_PREMIUM === e.skuId) {
            let t = g.intl.formatToPlainString(g.t.Cz1G97, { days: 3 });
            return l
                ? g.intl.format(g.t.bhLChO, {
                      helpCenterLink: O.A.getArticleURL(T.MVz.FRACTIONAL_PREMIUM_ABOUT),
                      duration: t,
                      expirationDate: u,
                  })
                : d
    ...
    M = (t) => {
        ...
        if (b.Dp.ORB_PROFILE_BADGE === e.skuId)
            _.push(
                {
                    text: g.intl.string(y.default.yfwZuy),
                    variant: "primary",
                    onClick: () => {
                        n(), A._.dispatch(T.jej.SHOW_ACCOUNT_PROFILE_POPOUT, {});
                    },
                },
                {
            ...
            R
                ...
                : _.push(
                      { text: g.intl.string(g.t.cpT0Cq), variant: "secondary", onClick: n },
                      {
                          ...
                          variant: "primary",
                          onClick: () => {
                              (0, f.openUserSettings)(p.X.SUBSCRIPTIONS_PANEL), n();
                          },
                      },
                  );
        else {
            ...
            _.push({
                ...
                onClick: () => {
                    if ((n(), (0, d.jH)(), O?.(), e.type === s.R.AVATAR_DECORATION)) {
                    ...
                    if (e.type === s.R.NAMEPLATE) {
                        l()(t.type === s.R.NAMEPLATE, "product type and item type are the same"),
                            (0, C.p)({ initialSelectedNameplate: t, analyticsLocations: i });
                        return;
                    }
                },
            });
        }
        return r && _.push({ text: g.intl.string(g.t.MAS7uK), variant: "primary", onClick: a, loading: h }), _;
    },
    P = (t, e) => {
        let n = i.useMemo(() => (0, R.V6)(t.type, t.skuId), [t.type, t.skuId]);
        return (
            i.useEffect(() => {
                h.default.track(T.HAw.OPEN_MODAL, {
    ...
    N = (t, e) => {
        let n = i.useRef(new r.OH()),
            a = (0, i.useRef)(null),
            [l, s] = i.useState(null),
            d = (0, m.AB)({ purchaseType: e, skuId: t.skuId });
        return {
