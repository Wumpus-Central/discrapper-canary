...
let ec = es.Ay.getEnableHardwareAcceleration(),
    eu = s.memo(function (e) {
        let { channel: n, sectionId: i, userId: a, guildOwnerId: r } = e,
            ...
            I = (0, A.bG)([K.A], () => K.A.getAnyStreamForUser(a)),
            C = (0, b.rm)(a),
                ...
                (0, l.jsx)(nG.Ch, {
                    ...
                    children: (0, l.jsxs)(nF.V, {
                        ...
                        children: [
                            (0, l.jsx)(
                                nF.V.Item,
                                { className: n7.YU, id: n3.mU.ALL, children: `${z.intl.string(z.t.hEAa2a)} (${A})` },
                                n3.mU.ALL,
                            ),
                            (0, n3.g2)(n.id).map((e) => {
                              ...
                              s.Fragment,
                              {
                                  children: [
                                      ...
                                      (0, l.jsxs)("div", {
                                          className: n9.vY,
                                          children: [
                                              e.entries.map((e) => (0, l.jsx)(n6, { entry: e }, e.guildId)),
...
let ts = function (e) {
    ...
    } else n = (0, l.jsx)("div", { className: n9.vY, children: o.map((e) => (0, l.jsx)(n6, { entry: e }, e.guildId)) });
    return (0, l.jsx)("div", {
        className: n9.$$,
...
let tr = function (e) {
    let { channel: n, guild: i } = e,
        {
            ...
            let e = nM.A.getCurrentCategoryId(n.id),
                t = nM.A.getDirectoryEntries(n.id, e === n3.mU.ALL ? null : e),
    ...
    let u = s.useMemo(
            () =>
                null != r
                    ? (function (e, n) {
                          if (n !== n3.mU.ALL) return [{ entries: (0, te._t)(e), appendEndCard: !0 }];
                          let t = [],
                              i = (0, te.A3)(e),
                          ...
                          (0, m.openModalLazy)(async () => {
                              ...
                              return (t) =>
                                  (0, l.jsx)(e, {
                                      ...
                                      currentCategoryId: a === n3.mU.ALL ? null : a,
                                  });
                          });
                      }
                    : void 0,
    ...
    return (0, l.jsx)(tI.Y, {
        ...
        children: (e, n) => {
            ...
            return (0, l.jsx)(th.Ay.Icon, {
                ...
                onClick: () => a((e) => !e),
                tooltip: i ? null : o,
                icon: t === tJ.CP.NO_MESSAGES ? tK.BellSlashIcon : tX.BellIcon,
                "aria-label": o,
                selected: i,
            });
        },
...
function t8(e) {
    ...
    let u = (0, l.jsx)(t6, { channel: i });
    return (0, l.jsxs)(l.Fragment, {
        children: [
            (0, l.jsx)(ex.A, { channel: i, draftType: t3.C.ChannelMessage }),
            (0, l.jsx)(th.Ay, {
                toolbar: u,
        ...
        return (
            d
                ...
                : i4.Ay.supports(ll.O5.VIDEO)
                  ...
                  : i6.k.getConfig({ location: "PrivateChannelCallButton" }).videoEnabled
                    ? ((u = !0), (e = this.handleBrowserNotSupported), (c = z.intl.string(z.t.UVpg3U)))
                    : ((u = !0), (c = z.intl.string(z.t.UoW002))),
            (0, l.jsx)(th.Ay.Icon, { icon: iQ.VideoIcon, onClick: e, disabled: u || i, tooltip: c })
        );
    }
...
t(696101);
let lF = [],
    lH = es.Ay.getEnableHardwareAcceleration();
function lB(e) {
...
function lW(e) {
                ...
                for (let e of i)
                    le.A.isFriend(e.id) || e.id === J.default.getCurrentUser()?.id
                        ? (l[e.id] = {
                              ...
                              activities: $.A.getActivities(e.id) ?? lF,
                          })
                        : (l[e.id] = { status: er.clD.OFFLINE, activities: lF });
                let s = [];
                for (let e of i) {
    ...
    let d = i && r.every((e) => e.user.isStaff()),
        ...
        c = (0, lU.A)({ useNitroCapExperiment: !0 }),
        h = (0, lw.qH)(),
                        ...
                        (0, l.jsxs)(D.A, {
                            ...
                            children: [
                                g
                                    ...
                                    : `${z.intl.string(z.t["9Oq93m"])}\u{2014}${r.length} `,
                                d && (0, l.jsx)(lD.A, { type: lD.A.Types.STAFF_ONLY_DM }),
                            ],
                        }),
                        r.map((e) =>
                            (0, l.jsx)(
...
async function sI(e) {
    try {
        let n = await sx.Bo.post({
            url: er.Rsh.AI_TITLE,
            body: { content: e },
            oldFormErrors: !0,
            rejectWithError: (0, sx.fT)(),
        });
        ...
        : (0, l.jsx)(M.f5, {
              ...
              children: (0, l.jsx)(eQ.Ah, {
                  children: (0, l.jsxs)("section", {
                      ...
                      className: sb.kL,
                      children: [
                          (0, l.jsx)(ex.A, { channel: s, draftType: t3.C.FirstThreadMessage }),
                          (0, l.jsx)(sv, { parentChannelId: n }),
                          (0, l.jsx)(sN, { parentChannel: s, parentMessageId: t, location: i }),
                      ],
                  }),
              }),
          });
...
function sv(e) {
    let { parentChannelId: n } = e,
        t = s.useCallback(() => {
            let e = t3.A.getThreadSettings(n),
                t = t3.A.getDraft(n, t3.C.FirstThreadMessage).trim(),
                i = sd.A.getUploads(n, t3.C.FirstThreadMessage);
    ...
    return (0, l.jsxs)(th.Ay, {
        ...
        children: [
            (0, l.jsx)(th.Ay.Icon, { icon: lZ.y, disabled: !0, "aria-label": z.intl.string(z.t["7Xm5QI"]) }),
...
function sN(e) {
    let n,
            ...
            }, [n])),
        {
            ...
            let t = (0, A.bG)([t3.A], () => t3.A.getThreadSettings(e.id) ?? {}, [e.id]),
                [i, l] = s.useState(t),
                a = s.useCallback(
                    (t) => {
                        l((e) => ({ ...e, ...t })), l3.A.changeThreadSettings(e.id, { ...t, parentMessageId: n });
                    },
                    [e.id, n],
                );
        ...
        { textAreaState: g, setTextAreaState: m } = (function (e, n) {
            let [t, i] = s.useState((0, l8.N3)());
            return (
                s.useEffect(() => {
                    function t(t) {
                        let l = t3.A.getDraft(e.id, t3.C.FirstThreadMessage);
                        (0 === l.length || !0 === t) && i((0, l8.ur)(l)), n(t3.A.getThreadSettings(e.id) ?? {});
                    }
                    return (
                        t(!0),
                        t3.A.addChangeListener(t),
                        () => {
                            t3.A.removeChangeListener(t);
                        }
                    );
                }, [e.id, n]),
                ...
                submit: s.useCallback(
                    async (e, l, s) => {
                        ...
                        g(!0),
                            ...
                            (e = e.trim()),
                            (null == l || 0 === l.length) &&
                                (l = sl.A.getStickerPreview(n.id, sE.drafts.type)?.map((e) => e.id)),
                            (null == s || 0 === s.length) && (s = sd.A.getUploads(n.id, t3.C.FirstThreadMessage));
                        let r = (i.name ?? "").trim(),
                            o = (d || null == t) && 0 === r.length,
                            u = "" === e && (null == l || 0 === l.length) && 0 === s.length;
                        if (
                            (c(o ? sh(0, z.intl.string(z.t.uXA573)) : null),
                            h(u ? sh(0, z.intl.string(z.t.kesTVT)) : null),
                            o || u)
                        )
                            return g(!1), { shouldClear: !1, shouldRefocus: !0 };
                        let { valid: x } = await (0, so.i)({
                            content: e,
                        ...
                        try {
                            ...
                            if (e.body?.code === er.t02.AUTOMOD_TITLE_BLOCKED) {
                                var p;
                                c(((p = e.body), sh(1, (0, su.cw)(p, n?.id))));
                            } else
                                e.body?.code === er.t02.INVALID_FORM_BODY &&
                                    e.body?.errors?.name != null &&
                                    c(sh(2, z.intl.string(z.t.uXA573)));
                            return g(!1), { shouldClear: !1, shouldRefocus: !0 };
                        }
                        return (0, ss.x5)(n.id, sE.drafts.type), g(!1), { shouldClear: !0, shouldRefocus: !1 };
                    },
        ...
        y = (0, sg.Iy)(c, x) ? lJ.t : lZ.y;
    return (0, l.jsx)("div", {
        className: sb.TE,
        onMouseDown: o,
        onFocus: o,
        children: (0, l.jsx)("div", {
            className: r()(sb.Og, `group-spacing-${d}`),
                        ...
                        children: (0, l.jsxs)("div", {
                            ...
                            children: [
                                (0, l.jsxs)(st.Ay, {
                                    ...
                                    children: [
                                        (0, l.jsx)("div", {
                                            className: r()(sC.P0, sb.P0),
                                            children: (0, l.jsx)(y, { className: sC.Kk }),
                                        }),
                                        (0, l.jsxs)(l0.n, {
                                            children: [
                                                (0, l.jsx)(s_, {
                                ...
                                (0, l.jsx)(sR, { parentChannel: t, parentMessageId: i }),
                            ],
                        }),
                    }),
                    (0, l.jsxs)("div", {
...
function s_(e) {
    ...
    return (0, l.jsx)(l5.k, {
        ...
        maxLength: er.Ign,
        onChange: function (e) {
            s({ name: (0, sm.A)(e, !1) }), "" !== e ? R.A.startTyping(n.id) : R.A.stopTyping(n.id);
        },
        onBlur: function () {
            let e = (0, sm.A)(u, !0);
            e !== u && s({ name: e });
...
function sS(e) {
    let { parentChannel: n, textAreaState: t, setTextAreaState: i, submit: a, error: d } = e,
        ...
        m = s.useCallback(
            (e, t, l) => {
                l3.A.saveDraft(n.id, t, t3.C.FirstThreadMessage),
                    i(
                        (e) => (
    ...
    return (0, l.jsxs)(l.Fragment, {
        children: [
            (0, l.jsx)(se.A, { channelId: n.id, type: sE, canAttachFiles: p }),
            (0, l.jsx)("div", { className: sb.xN, children: (0, l.jsx)(l6.U, { error: f }) }),
            (0, l.jsx)(l4.Ay, {
                type: sE,
                channel: n,
                ...
                focused: o,
                className: r()(sb.gM, sb.Yy),
                innerClassName: r()(sb.SL, { [sb.cr]: null != f }),
                onFocus: h,
                onBlur: g,
                onChange: m,
                onSubmit: x,
...
function sR(e) {
    let { parentChannel: n, parentMessageId: t } = e,
        i = (0, A.bG)([sr.A], () => (null == t ? null : sr.A.getMessage(n.id, t))),
        s = sa.hH.useSetting();
    return null != i
        ? (0, l.jsx)(si.A, {
              className: sb.IL,
...
function sD(e) {
    ...
    return (0, l.jsx)(tI.Y, {
        ...
        renderPopout: function () {
            return (0, l.jsx)(sL.l, {
                children: (0, l.jsx)(sM.A, { className: sP.T, channel: n, onClose: d, context: "popout" }),
            });
        },
        clickTrap: !0,
        children: (e, n) => {
    ...
    let { channel: n, closePopout: t, onSelect: i } = e,
        ...
        I = n.isThread()
            ? (0, l.jsx)(tb.Dr, {
                  ...
                  action: function () {
                      sU.A.jumpToMessage({ channelId: n.id, messageId: "0", jumpType: sw.vx.INSTANT });
                  },
              })
            : null,
        j = sa.SY.useSetting(),
...
function sW(e) {
    ...
    if (
        (s.useEffect(() => {
            ...
            m.current = !0;
            let e = (0, sH.C)(ek.A.getChannel(o.id), !0);
            (0, eS.zV)(er.HAw.CHANNEL_OPENED, { ...e, ...(0, eS.qL)(o.id), channel_view: d }),
                (0, sB.A)({ channelId: o.id });
        }, [o, d]),
        null == o || null == c)
    )
        return null;
    if (null != g) return (0, l.jsx)(tx.A, { guild: c, channelId: g });
    let x = (0, l.jsx)(t6, { channel: o, baseChannelId: r });
    return (0, l.jsxs)(l.Fragment, {
        children: [
            (0, l.jsx)(ex.A, { channel: o, draftType: t3.C.ChannelMessage }),
            (0, l.jsx)(th.Ay, {
                toolbar: x,
                "aria-label": z.intl.string(z.t.Pwe8tN),
                children: (0, tA.zF)({
...
function s1(e) {
    return s0.useConfig({ location: e }).enabled;
}
var s2 = t(215530),
    s5 = t(454719),
    s6 = t(736653),
...
function am(e) {
    let { context: n, analyticsLocations: t, profileFrame: i, isRedesignEnabled: s, handleOpenProfile: a } = e,
        { showButton: r } = ah.useConfig({ location: "UserProfileSidebarFooter" });
    if (s && !r) return null;
    function d() {
    ...
    let o = r
        ...
        : null;
    return null != i
        ? (0, l.jsxs)("div", { className: aA.xQ, children: [(0, l.jsx)(au.A, { frame: i, filterLayer: ag }), o] })
        : o;
}
var ax = t(518477),
    ap = t(996988),
...
function ab(e) {
    let { user: n, channel: t, isRedesignEnabled: i } = e,
        a = __OVERLAY__ || !(0, s3.A)(n.id),
        d = (0, lE.Ay)(n.id),
        o = (0, s6.Ay)(),
        c = s.useRef(Date.now()),
        { analyticsLocations: u } = (0, M.Ay)(O.A.USER_PROFILE_SIDEBAR),
        h = (0, s4.pb)({ layout: "SIDEBAR", userId: n.id, channelId: t.id });
    (0, s8.A)(u, d, ax.R7.SIDEBAR);
    let A = s.useRef(null),
        { isHoveringOrFocusing: g, isHovering: m } = (0, s7.A)(A);
    function x() {
        (0, sY.openUserProfileModal)({ sourceAnalyticsLocations: u, hideRestrictedProfile: !0, ...h });
    }
    return (0, l.jsx)(M.f5, {
        value: u,
        children: (0, l.jsx)(s4.of, {
            value: h,
            openedAt: c.current,
            ...
            children: (0, l.jsxs)(aa.A, {
                ...
                children: [
                    (0, l.jsxs)(tt.d_, {
                        ...
                        children: [
                            (0, l.jsx)(ao.A, { children: (0, l.jsx)(ad.A, { user: n }) }),
                            (0, l.jsxs)("div", {
                                className: aI.wx,
                                children: [
                                    (0, l.jsx)(at.A, {
                                    ...
                                    (0, l.jsx)(ae.A, {
                                        ...
                                        displayProfile: d,
                                        channelId: t.id,
                                        avatarSize: af.T[ap.d.SIDEBAR].avatarSize,
                                        ...
                                        ? (0, l.jsxs)(l.Fragment, {
                                              children: [
                                                  ...
                                                  (0, l.jsx)(as.A, {
                                                      ...
                                                      children: (0, l.jsx)(al.A, { userId: n.id }),
                                                  }),
                                              ],
                                          })
                    ...
                    d?.profileEffect != null && (0, l.jsx)(s9.A, { skuId: d?.profileEffect?.skuId, isHovering: m }),
                ],
            }),
        }),
    });
...
function aT(e) {
    let { user: n, channel: t, isRedesignEnabled: i, onHide: a } = e,
        ...
        u = (0, s4.pb)({ layout: "SIDEBAR", userId: n.id, channelId: t.id });
    (0, s8.A)(c, r, ax.R7.SIDEBAR);
    let h = s.useRef(null);
    return (0, l.jsx)(M.f5, {
        value: c,
        children: (0, l.jsx)(s4.of, {
...
function ru(e) {
    let {
        ...
        { trackUserProfileWishlistAction: g } = (0, s4.NJ)(),
        m = s1("DMSidePanelWishlistItemCard") ? rr.y.SIZE_78 : rr.y.SIZE_90,
        x = rr.Z[m],
        p = s.useCallback(() => {
            g({
                action: ax.Mq.PRESS_WISHLIST_BREADCRUMB_CARD,
                skuId: n.id,
                wishlistId: i,
        ...
        }, [h, n.id, i, n.productLine, g]),
        {
            ...
            label: E,
            icon: y,
        } = (0, ra.P)({ wishlistOwner: t, isOwned: !1, shortText: !0, onDetailsClick: p, onPurchaseClick: f }),
        [v, N] = s.useState(!1);
    return (0, l.jsx)("div", {
        className: ro.kL,
        children: (0, l.jsxs)(ri.A, {
            ...
            spec: x,
            cardStyle: r()(ro.Nr, a),
            skuPreviewStyle: r()(ro.ho, d),
            skuAssetClassName: v ? o : void 0,
            onClick: I,
            "aria-label": C ? (0, rt.T)(n) : z.intl.formatToPlainString(z.t.ZBB4Ty, { productName: (0, rt.T)(n) }),
...
function rh(e) {
    let { sku: n, wishlistOwner: t, analyticsLocations: i, ...a } = e,
        ...
        d = s.useCallback(() => {
            (0, rn.a)(
                n,
                { isGift: !0, giftRecipient: t, giftingOrigin: rd.vQ.USER_PROFILE_WISHLIST },
        ...
        o = s.useCallback(() => {
            (0, re.R)({
                ...
                isStorefront: !1,
                giftRecipient: t,
                giftingOrigin: rd.vQ.USER_PROFILE_WISHLIST,
                analyticsLocations: r,
            });
...
function rA(e) {
    let { sku: n, wishlistOwner: t, analyticsLocations: i, ...a } = e,
        ...
        o = (0, rs.e)({ sku: n, giftRecipient: t, giftingOrigin: rd.vQ.USER_PROFILE_WISHLIST, analyticsLocations: i }),
        c = s.useMemo(
            () =>
                r()(ro.ML, {
                    [ro.M]: n?.tenantMetadata?.collectibles?.type === a7.R.AVATAR_DECORATION,
                    [ro.Hm]: n?.tenantMetadata?.collectibles?.type === a7.R.PROFILE_EFFECT,
                    [ro.hH]: n?.tenantMetadata?.collectibles?.type === a7.R.PROFILE_FRAME,
                    [ro.qF]: n?.tenantMetadata?.collectibles?.type === a7.R.NAMEPLATE,
                    [ro.l2]: n?.tenantMetadata?.collectibles?.type === a7.R.BUNDLE,
                }),
...
function rg(e) {
    ...
    return (0, l.jsx)(ru, {
        ...
        onDetailsClick: c,
        onPurchaseClick: c,
        skuPreviewStyle: r()(rc.MO, { [ro.F5]: u }),
        style: d,
        disableRiveHover: !0,
        renderChildren: (e) =>
            u
                ? (0, l.jsx)("div", {
                      ...
                      children: (0, l.jsx)(y.E, {
                          className: r()(ro.p7, { [ro.SW]: h.length >= 10, [ro.ot]: h.length >= 12 }),
                          variant: "text-xs/bold",
                          lineClamp: 1,
                          children: h,
                      }),
...
function rI(e) {
    let { unownedWishlistItems: n, profileOwner: t, onClick: i, wishlistId: a, isNitroRecEnabled: r } = e,
        ...
        { trackUserProfileWishlistAction: o } = (0, s4.NJ)(),
        c = (0, s.useId)(),
        u = (0, s.useMemo)(() => n ?? [], [n]),
        h = (0, s.useCallback)(
            (e) => {
        ...
        A = (0, s.useMemo)(() => {
            let e = u.slice(0, 3).map((e) => ({ item: e, source: aO.uS.WISHLIST }));
            if (r && e.length < 3) {
                let n = u.some((e) => rx.Ay.isPremiumSku(e.skuId));
                if (!rx.Ay.isPremiumAtLeast(t.premiumType, rd.PremiumTypes.TIER_2) && !n) {
                    let n = a9.A.fromSKU((0, a5.rI)());
                    null != n && e.push({ item: n, source: aO.uS.POPULAR });
                }
            }
            return e;
        }, [u, r, t.premiumType]),
        ...
        m = (0, rp.A)({ wishlistId: a ?? null, onAction: h, productLines: g }),
        x = (0, s.useMemo)(
            () =>
                A.map((e, n) => {
        ...
        : (0, l.jsx)("section", {
              ...
              children: (0, l.jsxs)(aa.A.Overlay, {
                  ...
                  children: [
                      ...
                      (0, l.jsx)(sq.F, { children: (0, l.jsx)("div", { className: rf.vY, children: x }) }),
                  ],
              }),
          });
}
function rj(e) {
    let { isLoading: n, unownedWishlistItems: t, canSeeWishlist: i = !1, ...s } = e,
        a = a6.useConfig({ location: "UserProfileSidebarWishlistBreadcrumb" }).isEnabled && i;
    ...
    return (0, l.jsx)(a3.h, {
        ...
        children: (0, l.jsx)(rI, { ...s, unownedWishlistItems: t, isNitroRecEnabled: a }),
    });
}
function rb(e) {
    let {
        ...
        m = (0, A.bG)([aY.A], () => aY.A.hidePersonalInformation),
        x = (0, A.bG)([aM.A], () => aM.A.getUserProfile(n.id)?.application),
        p = i?.widgets != null && i.widgets.length > 0,
        { defaultWishlistId: f } = (0, A.cf)([aM.A], () => ({ defaultWishlistId: aM.A.getFirstWishlistId(n.id) })),
        { wishlist: I, isFetching: j } = (0, aO.fw)({ wishlistId: d ? f : void 0, userId: n.id });
    (0, aL.A)(I);
        ...
        children: [
            ...
            c === er.eA$.PENDING_INCOMING &&
                (0, l.jsx)(aa.A.Overlay, {
                    children: (0, l.jsx)(a$.A, { user: n, channelId: a.id, applicationId: u }),
                }),
            h.map((e) =>
                (0, l.jsx)(
                    aa.A.Overlay,
                              ...
                              children: [
                                  ...
                                  g.length > 0 &&
                                      (0, l.jsx)(as.A, {
                                          ...
                                          headingColor: "text-strong",
                                          children: (0, l.jsx)(aX.A, { applicationIds: g }),
                                      }),
                              ],
                          })
                        : (0, l.jsxs)(aa.A.Overlay, {
...
function rL(e) {
    let { section: n, header: t, items: i, listClassName: a, onExpand: d } = e,
        { trackUserProfileAction: o } = (0, s4.NJ)(),
        c = s.useId(),
        [u, h] = s.useState(!1),
        A = u ? r_.a : rS._;
    return (0, l.jsxs)("section", {
        ...
        children: [
            ...
            i.length > 0 && (0, l.jsx)("ul", { id: c, hidden: !u, className: r()(rR.p_, a), children: i }),
        ],
    });
}
var rO = t(341278);
function rM(e) {
    let { user: n, channelId: t } = e,
        ...
        { context: s } = (0, s4.NJ)(),
        a = (0, ty.A)(),
        { mutualFriendsCount: r, mutualFriends: d, mutualGuilds: o } = (0, rE.A)(n),
        c = !n.bot && null != r && r > 0,
        u = null != o && o.length > 0;
    return c || u
        ? (0, l.jsxs)(aa.A.Overlay, {
              ...
              children: [
                  ...
                  u && c && (0, l.jsx)(rv.A, { className: rO.yF }),
                  c &&
                      (0, l.jsx)(rL, {
                          section: "MUTUAL_FRIENDS",
                          header: z.intl.string(z.t["0mTJ3j"]),
                          listClassName: rO.p_,
                          onExpand: () => (0, ry.A)(n.id, a),
                          items:
                              null == d
...
function rP(e) {
    ...
    let { analyticsLocations: g } = (0, M.Ay)(O.A.USER_PROFILE_SIDEBAR),
        m = (0, s4.pb)({ layout: "SIDEBAR", userId: n.id, channelId: i.id });
    (0, s8.A)(g, o, ax.R7.SIDEBAR);
    let x = s.useRef(null),
        { isHoveringOrFocusing: p, isHovering: f } = (0, s7.A)(x),
        I = (0, aP.fC)(),
        j = (0, sQ.A)(o?.profileFrame?.skuId, "UserProfileSidebar");
    (0, aR.A)({ skuId: o?.profileFrame?.skuId, openedAt: u.current, context: m, analyticsLocations: g });
    let b = (0, aS.z)({ opacity: +(null != I.interactionType), config: { duration: 150 } });
    function C(e) {
        (0, sY.openUserProfileModal)({ sourceAnalyticsLocations: g, hideRestrictedProfile: !0, ...m, ...e });
    }
    let E = o?.widgets != null && o.widgets.length > 0,
        { defaultWishlistId: y } = (0, A.cf)([aM.A], () => ({ defaultWishlistId: aM.A.getFirstWishlistId(n.id) })),
        { wishlist: v, isFetching: N } = (0, aO.fw)({ wishlistId: a ? void 0 : y, userId: n.id });
    (0, aL.A)(v);
        ...
        children: (0, l.jsx)(s4.of, {
            ...
            children: (0, l.jsx)(aP.Hl, {
                ...
                children: (0, l.jsxs)(aa.A, {
                    ...
                    className: a ? r()(aI.BK, "user-profile-sidebar-redesign") : void 0,
                    isPrivate: o?.private === !0,
                    children: [
                        o?.private === !0 && (0, l.jsx)(ak.A, {}),
                        null != I.interactionType && (0, l.jsx)(a_.animated.div, { style: b, className: aI.tB }),
                        (0, l.jsxs)(tt.d_, {
                            className: r()(a && aI.BE, !a && null != j && aI.It),
                            children: [
                                (0, l.jsxs)(ao.A, {
                                    children: [
                                        (0, l.jsx)(aG.A, { user: n, themeType: ap.d.SIDEBAR }),
                                        n.bot ? (0, l.jsx)(aw.A, { user: n }) : (0, l.jsx)(aF.yo, { user: n }),
                                    ],
                                }),
                                (0, l.jsxs)("div", {
                                    className: aI.wx,
                                    children: [
                                        ...
                                        (0, l.jsx)(aD.A, { userId: n.id, className: aI.oR }),
                                        (0, l.jsx)(ae.A, {
                                            user: n,
                                            displayProfile: o,
                                            channelId: i.id,
                                ...
                                !a &&
                                    (0, l.jsx)("div", {
                                        ...
                                        children: (0, l.jsx)(rj, {
                                            ...
                                            isLoading: N,
                                            onClick: () => {
                                                C?.({ tabSection: ax.RP.WISHLIST });
                                            },
                                            canSeeWishlist: null != v,
                                        }),
                                    }),
                                !a && (0, l.jsx)(rM, { user: n, channelId: i.id }),
                            ],
                        }),
                        !d &&
                            (0, l.jsx)(am, {
                        ...
                        o?.profileEffect != null && (0, l.jsx)(s9.A, { skuId: o?.profileEffect?.skuId, isHovering: f }),
                        a && null != j && (0, l.jsx)(au.A, { frame: j, fadeIn: !1 }),
                    ],
                }),
            }),
        }),
...
function rk(e) {
    let { channel: n } = e,
        ...
        [d, o] = (0, s2.A)(t),
        [c, u] = s.useState(!1),
        h = s1("UserProfileSidebarRenderer"),
        g = (0, lE.Ay)(t),
        m = (0, s$.c)("UserProfileSidebarRenderer") ? g?.profileFrame?.skuId : void 0,
        x = (0, sQ.A)(m, "UserProfileSidebarRenderer"),
        p = (0, A.bG)([sX.A], () => sX.A.getProductFetch(m));
    if (
        (s.useEffect(() => {
            let e = {
                type: "sidebar",
            ...
            null != i ? (0, s5.A)(i, e) : (0, s5.A)(t, void 0, e);
        }, [i, t, n.id, h]),
        null == i ||
            null == a ||
            !r ||
    ...
    return (0, l.jsx)("aside", {
        "aria-labelledby": f,
        className: h ? rD.H : void 0,
        children: (0, l.jsx)(sq.F, {
            component: (0, l.jsx)(sK.A, {
                children: (0, l.jsx)(sq.H, { id: f, children: z.intl.format(z.t.KRe1Fk, { name: I }) }),
            }),
            children:
                null == i || null == a
                    ? null
                    : d
                      ? (0, l.jsx)(aT, { user: i, currentUser: a, onHide: o, isRedesignEnabled: h, ...e })
                      : i.isNonUserBot()
                        ? (0, l.jsx)(ab, { user: i, currentUser: a, isRedesignEnabled: h, ...e })
                        : (0, l.jsx)(rP, { user: i, currentUser: a, isRedesignEnabled: h, ...e }),
        }),
    });
}
var rU = t(522556),
...
let rX = () => {
    ...
    let n = (0, rz.M)(e) ? rK : "/assets/a51b44063e9d3bdb.svg";
    return (0, l.jsxs)("div", {
        className: rq.kL,
        children: [
            (0, l.jsxs)(iX.A, {
                ...
                children: [
                    (0, l.jsx)(iX.A.Icon, { icon: rY.N, "aria-hidden": !0 }),
            ...
            (0, l.jsxs)("div", {
                className: rq.Qs,
                children: [
                    (0, l.jsx)("img", { alt: "", className: rq.j0, src: n }),
                    (0, l.jsx)(S.D, {
                        className: rq.Zd,
...
var r$ = t(943712),
    ...
    r2 = t(999900);
function r5() {
    return (0, l.jsx)("div", { className: r2.wG, children: (0, l.jsx)(x.y, {}) });
}
let r6 = (0, nT.Fe)({
    createPromise: () =>
        Promise.all([
...
let r9 = (0, nT.Fe)({ createPromise: r3, webpackId: 540462, name: "ChannelCall", renderLoader: r5 });
function r7() {
    return Promise.all([
        t.e("770583"),
        t.e("947359"),
...
let r8 = (0, nT.Fe)({ createPromise: r7, webpackId: 67319, name: "StageChannelCall", renderLoader: r5 }),
    r4 = (0, nT.Fe)({
        createPromise: () =>
            Promise.all([
                t.e("855151"),
...
class dn extends s.PureComponent {
    ...
    maybePreloadChannelCall() {
        ...
        e === er.rbe.GUILD_VOICE ? r3() : e === er.rbe.GUILD_STAGE_VOICE && r7();
    }
    ...
    renderJoinRequestInterviewButtons = () => {
        let { channel: e } = this.props;
        return e?.hasFlag(rZ.lx.IS_JOIN_REQUEST_INTERVIEW_CHANNEL)
        ...
        switch (e.type) {
            ...
            case er.rbe.PUBLIC_THREAD:
                e.isModeratorReportChannel() && d.push((0, l.jsx)(tq, { channel: e })),
                    null == n || n.isForumLikeChannel() || d.push((0, l.jsx)(sD, { channel: n }, "browser")),
                    ...
                    d.push((0, l.jsx)(sG, { channel: e }, "threads-overflow"));
                break;
            case er.rbe.GUILD_ANNOUNCEMENT:
            case er.rbe.GUILD_TEXT:
            case er.rbe.GUILD_APP:
                d.push((0, l.jsx)(sD, { channel: e }, "browser")),
                    ...
                    children: (a) =>
                        (0, l.jsxs)(
                            iX.A,
                            {
                                ...
                                className: r()(r2.DD, a, { [r2.zh]: e.type === er.rbe.GROUP_DM }),
                                transparent: x,
                                hidden: c,
    ...
    renderChat() {
        ...
        if (e.isForumLikeChannel()) {
            ...
            return (0, l.jsx)(r6, { channel: e, guild: n, sidebarState: t }, e.id);
        }
    ...
    renderSidebar() {
        ...
        if ((o()(null != e, "Missing channel in Channel.renderSidebar"), __OVERLAY__ || i));
            ...
            return (0, l.jsx)(rk, { channel: e }, `private-channel-profile-${e.id}`);
            ...
            switch (e.type) {
                ...
                case er.rbe.GUILD_APP:
                    ...
                    return (0, l.jsx)(rW.A, { channel: e }, `channel-members-${c}`);
                case er.rbe.ANNOUNCEMENT_THREAD:
                    if (null != n) return (0, l.jsx)(rW.A, { channel: n }, `channel-members-${n.id}`);
                    break;
                case er.rbe.PUBLIC_THREAD:
                case er.rbe.PRIVATE_THREAD:
        ...
        if (t === er.YvQ.SIDEBAR_CHAT && null != i) {
            ...
            switch (i.type) {
                case l$.PE.CREATE_THREAD:
                    ...
                    break;
                case l$.PE.VIEW_THREAD:
                    let t = n?.isForumLikeChannel() ? t8 : sW;
                    e = (0, l.jsx)(t, { channelId: i.channelId });
                    break;
                case l$.PE.VIEW_MOD_REPORT:
                    e = (0, l.jsx)(sW, { channelId: i.channelId, baseChannelId: i.baseChannelId });
                    break;
                case l$.PE.VIEW_CHANNEL:
                case l$.PE.VIEW_MESSAGE_REQUEST:
                default:
                    return null;
            }
        }
        if (null != s && null == e)
            if (s.type !== l$.QV.GUILD_MEMBER_MOD_VIEW) return null;
            else {
                ...
                return (0, l.jsx)("div", {
                    ...
                    children: (0, l.jsx)(de, {
                        ...
                        userId: n,
                        moderatorReportId: t,
                        onClose: () => lX.A.closeGuildSidebar(e),
                    }),
                });
            }
        ...
        return (0, l.jsxs)(l.Fragment, {
            children: [
                ...
                (0, l.jsxs)("div", {
                    ...
                    className: r()(r2.TE, { [r2.js]: g || m, [r2.jl]: g && h }),
                    children: [
                        x
                            ? (0, l.jsx)(ex.A, {
                        ...
                        (0, l.jsxs)("div", {
                            className: r()(r2.Qs, { [r2.Oo]: s === er.DUB.NO_CHAT }),
...
let dt = (0, ep.A)(dn),
    di = s.memo(function (e) {
        ...
        let i,
            ...
            S = (0, A.bG)([rB.A], () => rB.A.isConnected()),
            R = (0, eI.Ay)(S),
            L = S && !1 === R;
        s.useEffect(() => {
            T &&
                ...
                I.A.selectParticipant(
                    f.id,
                    (0, e4.Qt)({ applicationId: _.applicationId, instanceId: _.compositeInstanceId }),
                );
        }, [L, f, T, _]);
        let O = (0, A.bG)([ej.Ay], () => ej.Ay.getCurrentEmbeddedActivity()),
            ...
            F = (0, A.bG)([t4.A], () => {
                let e = (0, r0.ny)(t4.A.getMainFrame());
                return e?.data.layoutMode === r0.y0.FOCUSED;
            }),
            ...
            Y =
                ...
                (0, A.bG)([ek.A, nQ.A, eU.Ay], () => {
                    ...
                    return H === eU.Ay.getChannelId(t) && null != n && n.getGuildId() === e.id && (0, rF.ke)(n.type);
                })),
        ...
        !(function (e) {
            ...
            s.useEffect(() => {
                let e = (0, tg.JK)();
                if (e?.location?.state?.stageInviteKey === r1.J2) {
        ...
        return (0, l.jsx)(dt, {
            ...
            isUnavailable: (0, A.bG)([rH.A, iv.A], () => {
                let e = f?.guild_id ?? iv.A.getGuildId();
                return null != e && rH.A.isUnavailable(e);
            }, [f]),
            showRealNameModal: z,
