...
let tn = (0, e5.L_)((e, t, n) => ["null", ...t, ...e, e9, eR.sFm.E3_SERVER_DISCOVERY_BADGE, e8]),
...
class tL extends a.PureComponent {
    ...
    componentWillEnter(e) {
        ...
        e(),
            t
                .update({ immediate: !e7.A.isFocused(), height: 1, opacity: 1, scale: 1, config: tR })
                .start()
    ...
    componentWillLeave(e) {
        ...
        this.setState({ animating: !0 }, () =>
            t.update({ immediate: !e7.A.isFocused(), height: 0, opacity: 0, scale: 0, config: tR }).start().then(e),
        );
    }
