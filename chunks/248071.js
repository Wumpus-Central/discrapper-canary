e.exports = function (e) {
    let t = e.regex,
        ...
        h = { relevance: 0, match: /\b[A-Z]+[a-z]+([A-Z]+[a-z]+)*/, scope: "title.class", keywords: { _: s } },
        m = e.C_NUMBER_MODE,
        g = {
            match: [n, /\s*/, /=/, /\s*/, /\(/, n, /\)\s*\{/],
            scope: { 1: "title.function", 3: "operator", 6: "params" },
        },
        E = e.COMMENT(/\/\*\*/, /\*\//, { contains: [{ match: /@[a-z]+/, scope: "doctag" }, "self"] }),
    ...
    return {
        name: "Wren",
        keywords: { keyword: r, "variable.language": a, literal: i },
        contains: [S, m, I, _, E, e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE, h, c, g, u, l, d, p, f, y],
    };
};
