...
class f extends o.A {
    ...
    fetchFeaturedGuilds = async (e) => {
        ...
        if (t || (0, c.M9)(n)) {
            s.h.dispatch({ type: "GLOBAL_DISCOVERY_SERVERS_SEARCH_START", categoryId: d.Iq, reset: !0 });
            try {
                ...
                s.h.dispatch({ type: "GLOBAL_DISCOVERY_SERVERS_SEARCH_FAILURE", categoryId: d.Iq, error: e }),
    ...
    fetchCategoryFeaturedGuilds = async (e) => {
        ...
        if (n || (0, c.M9)(i)) {
            s.h.dispatch({ type: "GLOBAL_DISCOVERY_SERVERS_SEARCH_START", categoryId: t, reset: !0 });
            try {
                let e = await a.Bo.get({
                        url: _.Rsh.GUILD_DISCOVERY,
                ...
                s.h.dispatch({ type: "GLOBAL_DISCOVERY_SERVERS_SEARCH_SUCCESS", categoryId: t, guilds: i, total: n });
            } catch (e) {
                s.h.dispatch({ type: "GLOBAL_DISCOVERY_SERVERS_SEARCH_FAILURE", categoryId: t, error: e }),
                    l.uf({ categoryId: t });
            }
        }
    };
