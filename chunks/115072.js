...
function w(e) {
    ...
    r.useEffect(() => {
        ...
        o.tn
            ...
            .then((e) => {
                if (null != e.body && '6e0fbc6d3c695189f24964951e1cb0a7b70acf53' !== e.body.hash) {
                    let e = new Date('1750725857928'),
                        t = new Date(),
                        n = (0, g.TD)(t, e);
                ...
                children: (0, i.jsxs)('form', {
                    ...
                    children: [
                        ...
                        null == ep &&
                            ...
                            (0, i.jsx)(s.ToO, {
                                type: s.ToO.Types.DANGER,
                                title: O.intl.formatToPlainString(O.t['ql2Q/f'], { hours: em }),
