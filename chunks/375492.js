...
function L() {
    ...
    let u = null != l && null != l.name && (s.has(l.name) || (0, E.v)(l, [...e, ...C.A.getRemoteActivities()])),
    ...
    let d = g.A.getActivity();
    null != d && e.push({ type: O.$pd.LISTENING, ...d }), i()(R, e) || (R = e);
}
class w extends l.Ay.Store {
    static displayName = "LocalActivityStore";
    initialize() {
        this.waitFor(_.A, T.A, S.A, c.Ay, N.A, h.A, y.A, p.Ay, v.A, C.A, g.A, I.A), this.syncWith([h.A], () => L());
    }
    getActivities() {
        return R;
    }
        ...
        !(function () {
            ...
            for (let [n, [r, i, s]] of Object.entries(b)) {
                let a = i.flags ?? 0,
                    l = (0, d.E)(
                        i,
                        (0, o.Lt)(i?.flags ?? 0, O.jUm.INSTANCE),
                        i.platform === O.yTV.EMBEDDED,
                        (0, d.e)(i),
                        s,
                    );
