...
function z(e) {
    let { overwrite: t } = e,
        ...
        l = (0, o.e7)([O.Z], () => (null != n ? O.Z.getGuild(n.getGuildId()) : null)),
        r = (0, o.e7)([O.Z], () => (null != l ? O.Z.getRoles(l.id) : void 0));
    if (null == n || null == l || null == t) return null;
    let { guild_id: s, id: c } = n,
        { id: m } = t,
        f = () => {
            var e;
            if (null == O.Z.getGuild(s) || null == r) return '';
            let t = r[m],
        ...
        j = (e, i) => {
            ...
            if (
                ...
                if (t.type === x.BN.MEMBER) {
                    ...
                    let i = O.Z.getGuild(n.getGuildId());
                    if (null != i) {
                        let n = O.Z.getRole(i.id, t.id);
                        null != n && (e = n.name);
                    }
                }
                M.X(e);
        ...
        b = (e) => {
            let t = E.Z.can(B.Plq.ADMINISTRATOR, l) || E.Z.can(B.Plq.MANAGE_ROLES, n, void 0, void 0, !0);
            return n.isGuildStageVoice() && C.xS.has(e) ? V.intl.string(V.t.bTS5lZ) : !((!a.fS(e, B.Plq.MANAGE_ROLES) || t) && (null == e || E.Z.can(e, l) || t)) && V.intl.string(V.t.nOtPMD);
        },
        v = m === s,
        N = n.isForumLikeChannel() && a.e$(t.deny, B.Plq.SEND_MESSAGES),
        w = a.e$(t.deny, B.Plq.SEND_MESSAGES),
        Z = a.e$(t.deny, B.Plq.READ_MESSAGE_HISTORY),
