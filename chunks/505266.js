        ...
        switch (e.type) {
            ...
            case "linear-random":
                ...
                var o = S(e.minAddValue),
                    a = S(e.maxAddValue);
                return new g(
                    new b(O(n.x, r.x), O(o.x, a.x)),
                    new b(O(n.y, r.y), O(o.y, a.y)),
                    new b(O(n.z, r.z), O(o.z, a.z)),
                    e.uniformVectorValues,
                );
            case "oscillating":
                t = S(e.value);
    ...
    L = r.forwardRef(function (e, t) {
        ...
        return (
            ...
            r.useEffect(
                function () {
                    null != u.current &&
                        ((u.current.width = (l + 2) * Math.max(s.length, 1)), (u.current.height = (c + 2) * a.length));
                },
    ...
    var d = r.useCallback(
            function (n, r) {
                ...
                if (null != l && null != s && 0 !== s.sprites.length)
                    return null == e ? void 0 : e.createConfetti(n, l, s, o, a);
            },
            [e, t],
        ),
        f = r.useCallback(
