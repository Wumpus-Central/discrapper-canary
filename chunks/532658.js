...
let K = i.memo(function (e) {
    ...
    X = i.memo(function (e) {
        let {
            ...
            Z = (0, l.e7)([S.default], () => S.default.getId() === s.id, [s.id]),
            ...
            ei = R && (null == D ? void 0 : D.discoverable),
            ea =
                (0, h.Z)({
                    userId: s.id,
                    context: O,
                }) || ei,
            eo = (0, l.e7)([I.Z], () => I.Z.getStreamForUser(s.id, T)),
            es = null != eo,
            el = i.useCallback(() => {
                (L || null != es) && M(null);
            }, [M, L, es]),
            ...
            eh = i.useMemo(() => s.getAvatarURL(T, ep), [s, T, ep]);
