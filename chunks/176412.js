...
let I =
    ...
    j = c.w4(S);
function D(e) {
    let { context: t, application: n, location: i, sectionName: r, commandName: o, autoDismissOnClick: u = !0, launchingComponentId: c, submitting: m = !1, fetchesApplication: E = !0, onConfirmActivityLaunchChecksAlertOpen: O } = e,
        Z = (0, s.O)(),
        I = (0, p.Qv)({
            context: t,
            applicationId: n.id,
