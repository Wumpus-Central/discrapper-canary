...
let I =
    ...
    S = u.w4(j);
function N(e) {
    let { context: t, application: n, location: i, sectionName: r, commandName: l, autoDismissOnClick: c = !0, launchingComponentId: u, submitting: m = !1, fetchesApplication: E = !0, onConfirmActivityLaunchChecksAlertOpen: O } = e,
        g = (0, s.O)(),
        I = (0, p.Qv)({
            context: t,
            applicationId: n.id,
        ...
        D = d.Ttl.BRAND,
        C = null != l ? l : A.NW.string(A.t.zKX8Nj);
    return (
        j === p.JS.JOIN ? ((D = d.Ttl.GREEN), (C = A.NW.string(A.t.d9PsMj))) : j !== p.JS.LEAVE || m || ((D = d.Ttl.RED), (C = A.NW.string(A.t['Hi1/aW']))),
        {
