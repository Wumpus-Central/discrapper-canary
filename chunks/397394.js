...
function j(e) {
    ...
    return (
        (0, _.Tt)({ location: A.intl.string(A.t["3S2494"]) }),
        (0, r.jsxs)("div", {
            className: N.wrapper,
            children: [
                s ? (0, r.jsx)(f.$jN, {}) : null,
    ...
    let { onClose: o } = a,
        s = i.useCallback(() => {
            (null == t ? void 0 : t.id) != null &&
                ...
                null == o || o(),
                O.default.track(C.rMx.OAUTH2_AUTHORIZE_SUCCESS_GO_TO_GUILD_CLICKED, {
        ...
        c = i.useCallback(() => {
            null == o || o(),
                O.default.track(C.rMx.OAUTH2_AUTHORIZE_SUCCESS_CLOSE_CLICKED, {
                    application_id: null == n ? void 0 : n.id,
                });
        ...
        f = i.useCallback(() => {
            (null == n ? void 0 : n.id) != null &&
                ...
                null != l && (0, h.uL)(""),
                setImmediate(() => {
                    S.S.dispatchToLastSubscribed(C.CkL.OPEN_APP_LAUNCHER, { applicationId: n.id }),
                        O.default.track(C.rMx.OAUTH2_AUTHORIZE_SUCCESS_OPEN_APP_CLICKED, { application_id: n.id });
                }));
        }, [null == n ? void 0 : n.id, o, l]),
        p = (0, u.e7)([y.Z, E.Z], () => E.Z.getChannel(y.Z.getChannelId())),
        _ = (0, u.e7)([b.Z], () => b.Z.can(C.Plq.SEND_MESSAGES, p)),
        v = null != t,
        I = null == t && _ && (!d || null != l),
        N = [];
    return (
                ...
                N.push({
                    ...
                    text:
                        (null == t ? void 0 : t.name.length) > 30
                            ? A.intl.string(A.t.M35zFB)
                            : A.intl.format(A.t.UdYYP3, { guildName: null == t ? void 0 : t.name }),
                    onClick: s,
                }),
            I &&
                N.push({
...
function U(e) {
    ...
    i.useEffect(() => {
        O.default.track(C.rMx.OAUTH2_AUTHORIZE_SUCCESS_VIEWED, { application_id: null == n ? void 0 : n.id });
    }, [null == n ? void 0 : n.id]);
    let s = i.useMemo(
            () =>
                null != n
                    ? null != t
                        ? A.intl.format(A.t.IlF6IY, {
                              installedApplicationName: null == n ? void 0 : n.name,
                              guildName: null == t ? void 0 : t.name,
                          })
                        : A.intl.format(A.t.vTVC5T, { installedApplicationName: null == n ? void 0 : n.name })
                    : A.intl.string(A.t["Dp+rgP"]),
            [n, t],
        ),
        l = (0, r.jsx)(d.x, {
...
function G(e) {
    ...
    let { onClose: a } = n;
    i.useEffect(() => {
        O.default.track(C.rMx.OAUTH2_AUTHORIZE_SUCCESS_VIEWED, { application_id: t.id });
    }, [t.id]);
    let o = i.useCallback(() => {
        null == a || a(), O.default.track(C.rMx.OAUTH2_AUTHORIZE_SUCCESS_CLOSE_CLICKED, { application_id: t.id });
    }, [a, t.id]);
    return (0, r.jsx)(
        T.j,
        D(R({}, n), {
                    ...
                    (0, r.jsxs)("div", {
                        ...
                        children: [
                            ...
                            (0, r.jsx)(d.x, {
                                variant: "text-md/normal",
                                color: "text-muted",
                                children: A.intl.format(A.t.Mr7x5U, { appName: t.name }),
                            }),
                        ],
                    }),
                ],
