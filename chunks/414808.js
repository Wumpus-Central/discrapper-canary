...
function p(e) {
    ...
    let O = r.useCallback(() => {
        ...
        R = C ? h.default.TWuDTt : h.default["25YCHl"];
    return (0, i.jsx)(s.A, {
        targetElementRef: t,
        ...
        title: I.intl.string(S ? R : h.default.A3ZjbM),
        body: I.intl.string(S ? h.default.DFjrWw : h.default.qJUI2v),
        onRequestClose: () => n?.(E.i.USER_DISMISS),
        actions: S
            ? void 0
            : [{ icon: l.t, text: I.intl.string(h.default["avps/2"]), onClick: () => O(), variant: "expressive" }],
    });
}
