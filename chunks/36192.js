                                ...
                                ? (0, i.jsxs)(d.hjN, {
                                      ...
                                      children: [
                                          ...
                                          (0, i.jsx)(d.zxk, {
                                              ...
                                              children: E.size > 0 ? j.intl.formatToPlainString(j.t['83CPLi'], { count: E.size }) : j.intl.string(j.t.cLmmeX)
                                          })
                                      ]
                                  })
                                : null
            ...
            (0, i.jsxs)('div', {
                ...
                children: [
                    (0, i.jsx)(d.Text, {
                        ...
                        className: S.sessionInfoRow,
                        color: 'text-muted',
                        children: (0, i.jsx)('span', { children: j.intl.string(j.t.iUa0sr) })
                    }),
                    (0, i.jsx)(d.Text, {
                        variant: 'text-sm/medium',
                        className: S.sessionInfoRow,
                        color: 'text-muted',
                        children: (0, i.jsx)('span', { children: j.intl.format(j.t['044+8v'], { onClick: () => u.Z.setSection(C.oAB.ACCOUNT, null, { analyticsLocations: [g.Z.USER_SETTINGS_SESSIONS] }) }) })
                    })
                ]
            })
        ]
