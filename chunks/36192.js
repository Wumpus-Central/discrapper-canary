                                      ...
                                      children: [
                                          ...
                                          (0, i.jsx)('div', {
                                              ...
                                              children: (0, i.jsx)(d.zxk, {
                                                  ...
                                                  size: 'sm',
                                                  text: j.size > 0 ? C.intl.formatToPlainString(C.t['83CPLi'], { count: j.size }) : C.intl.string(C.t.cLmmeX),
                                                  onClick: () => {
...
function T(e) {
    ...
    let { session: o, current: c, setChecked: u, checked: m, useChecks: p } = e,
        ...
        O = c ? null : (0, h.p)(o.approx_last_used_time),
        E = [x, b].filter(j.lm),
        S = [f, O].filter(j.lm);
    return (0, i.jsxs)(
        'div',
            ...
            (0, i.jsxs)('div', {
                ...
                children: [
                    ...
                    (0, i.jsx)(d.Text, {
                        ...
                        className: v.sessionInfoRow,
                        color: 'text-muted',
                        children: (0, i.jsx)('span', { children: C.intl.format(C.t['044+8v'], { onClick: () => u.Z.setSection(O.oAB.ACCOUNT, null, { analyticsLocations: [p.Z.USER_SETTINGS_SESSIONS] }) }) })
                    })
                ]
            })
        ]
