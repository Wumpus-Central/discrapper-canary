...
function v() {
    let e,
        ...
        [u, g] = r.useState(!1);
    r.useEffect(() => {
        (0, f.EW)(c.z.AUTH_SESSIONS_NEW, { dismissAction: O.L.AUTO }), (0, p.fw)();
                                ...
                                ? (0, i.jsxs)(d.hjN, {
                                      ...
                                      children: [
                                          ...
                                          (0, i.jsx)(d.zxk, {
                                              ...
                                              children: E.size > 0 ? C.intl.formatToPlainString(C.t['83CPLi'], { count: E.size }) : C.intl.string(C.t.cLmmeX)
                                          })
                                      ]
                                  })
                                : null
            ...
            (0, i.jsxs)('div', {
                ...
                children: [
                    (0, i.jsx)(d.Text, {
                        ...
                        className: S.sessionInfoRow,
                        color: 'text-muted',
                        children: (0, i.jsx)('span', { children: C.intl.string(C.t.iUa0sr) })
                    }),
                    (0, i.jsx)(d.Text, {
                        variant: 'text-sm/medium',
                        className: S.sessionInfoRow,
                        color: 'text-muted',
                        children: (0, i.jsx)('span', { children: C.intl.format(C.t['044+8v'], { onClick: () => u.Z.setSection(j.oAB.ACCOUNT, null, { analyticsLocations: [g.Z.USER_SETTINGS_SESSIONS] }) }) })
                    })
                ]
            })
        ]
