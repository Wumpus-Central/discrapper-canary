...
function e_(e) {
    ...
    function P(e, t) {
        ...
        if (
            ...
            d && "SETTINGS" === a
                ? ((n = e), (0, v.GQ)(n.theme), (0, I.nf)(I.HP.CLIENT_THEMES), (0, D.default)())
                : d
                  ? (0, v.GQ)(e.theme)
...
function eh(e) {
    ...
    return (0, r.jsxs)(r.Fragment, {
        children: [
            ...
            !i && !n && (0, r.jsx)(H.zy, { size: t, theme: "system", isSelected: c && d, onSelect: () => _("system") }),
        ],
    });
}
function ef(e) {
...
(ef.Basic = function (e) {
    ...
    (ef.BasicAndGradient = function (e) {
