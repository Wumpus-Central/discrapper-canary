...
function G(e) {
    ...
    let { channel: o, isLoading: N } = e,
        [C, G] = s.useState(!1),
        F = (0, u.e7)([S.ZP], () => S.ZP.getSelfEmbeddedActivityForChannel(o.id)),
        Z = (0, u.e7)([S.ZP], () => S.ZP.getActivityPanelMode()),
        V = (0, p.q)(null == F ? void 0 : F.applicationId),
        j = null == F ? void 0 : F.launchId,
        ...
        K = (0, A.sU)({ channelId: o.id }),
        {
            ...
            activityParticipant: null != F ? m.Z.getParticipant(o.id, F.applicationId) : null,
    ...
    function ei() {
        var e;
        null != F && f.Z.selectParticipant(o.id, F.applicationId);
    ...
    function es(e, n, r, i, s) {
        var l;
        return en && null != F && ((null == z ? void 0 : z.type) === M.fO.ACTIVITY || i)
    ...
    if (
        ...
        }, [null == F ? void 0 : F.applicationId, en]),
        null == F || null == j || (null == z && (0, O.Z)(o.id)) || null == V)
    )
        return null;
    let eo = Array.from(F.userIds)
            ...
            children: (e) => {
                ...
                return (0, a.jsxs)(E.Z, {
                    className: l()(k.root, {
                        [k.pipMode]: en,
                        [B.elevationHigh]: en,
                        [U.idle]: i && !(null === (n = F.config) || void 0 === n ? void 0 : n.useInteractivePIP),
                        [k.pipModeShort]: en && !C,
                        [k.pipModeTall]: en && C,
                        [k.hidden]: W,
                        [k.multiPIPMode]: er
                    ...
                    children: [
                        ...
                        N
                            ...
                            : (0, a.jsx)(D.J, {
                                  allowPopups: (0, R.h)(V),
                                  referrerPolicy: x.um.has(F.applicationId) ? 'no-referrer' : 'origin',
                                  url: F.url,
                                  queryParams: el,
                                  className: l()(k.iframe, {
                                      [k.pipModeShort]: en && !C,
                                      [k.pipModeTall]: en && C,
                                      [k.pipNonInteractive]: en && !(null === (r = F.config) || void 0 === r ? void 0 : r.useInteractivePIP)
                                  }),
                                  shouldRefocus: !en && H
                              }),
                        !en &&
