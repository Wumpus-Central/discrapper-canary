...
let Z = new h.Z("AuditLogUtils"),
    S = [c.J6.DAYS, c.J6.HOURS, c.J6.MINUTES, c.J6.SECONDS],
    R = () => ({ [j.zUn.REASON]: () => L.t["2IW3Cw"] }),
    G = () =>
        x(
            {
        ...
        x(
            {
                ...
                [j.zUn.COLOR]: Am({ "#000000": L.t.TK6E1N }, L.t["2FQFi4"]),
        ...
        x(
            {
                ...
                [j.zUn.MAX_USES]: Am({ 0: L.t.Yx8LNj }, L.t["3ygnwc"]),
                [j.zUn.MAX_AGE]: Am({ [L.intl.string(L.t.PqEzn5)]: L.t.uWrLv7 }, L.t["Q+5kcH"]),
    ...
    J = () => x({ [j.zUn.NAME]: AQ(L.t.ahU1o6, L.t["wxs+vb"]) }, R()),
    q = () =>
        x(
            {
    ...
    As = () => x({ [j.zUn.STATUS]: () => L.t.HyCSnJ }, R()),
    Aa = () => ({
...
function Av(A) {
    ...
    return null != Ac(j.zUn.COMMUNICATION_DISABLED_UNTIL, A)
...
function Aw(A, e) {
    switch (A) {
        ...
        case j.Plq.MANAGE_CHANNELS:
            if (e.targetType === j.KFR.CHANNEL || e.targetType === j.KFR.CHANNEL_OVERWRITE)
    ...
    return (
        A.forEach((A) => {
            ...
            if (
                ...
                [
                    j.rsA.MEMBER_PRUNE,
                    j.rsA.MEMBER_DISCONNECT,
                    j.rsA.MEMBER_MOVE,
                    j.rsA.CREATOR_MONETIZATION_REQUEST_CREATED,
                    j.rsA.CREATOR_MONETIZATION_TERMS_ACCEPTED,
                ].includes(A.action)
            ) {
                if (
                    null !=
                        ...
                        let l = (function (A, e, t) {
                            ...
                            switch (A.key) {
                                ...
                                case j.zUn.VIDEO_QUALITY_MODE:
                                    return AI(A, (A) =>
                                        A === j.Ucd.FULL ? L.intl.string(L.t["7jOoJC"]) : L.intl.string(L.t.jjKYpq),
                                    );
                                case j.zUn.SYSTEM_CHANNEL_FLAGS:
                                    let n = {
                                            [j.xmn.SUPPRESS_JOIN_NOTIFICATIONS]:
                                                j.zUn.SYSTEM_CHANNEL_FLAG_JOIN_NOTIFICATIONS,
                                            [j.xmn.SUPPRESS_PREMIUM_SUBSCRIPTIONS]:
                                                j.zUn.SYSTEM_CHANNEL_FLAG_PREMIUM_SUBSCRIPTIONS,
                                            [j.xmn.SUPPRESS_GUILD_REMINDER_NOTIFICATIONS]:
                                                j.zUn.SYSTEM_CHANNEL_FLAG_REMINDER_NOTIFICATIONS,
                                            [j.xmn.SUPPRESS_JOIN_NOTIFICATION_REPLIES]:
                                                j.zUn.SYSTEM_CHANNEL_FLAG_JOIN_NOTIFICATION_REPLIES,
                                        },
                                        l = [];
                                    return (
                                ...
                                case j.zUn.AVAILABLE_TAGS:
                                    return (function (A) {
                                        ...
                                        if (
                                            ...
                                            for (let A in i)
                                                if (null == l[A])
                                                    return new D.ms(j.zUn.AVAILABLE_TAG_ADD, null, Ap(i[A]));
                                        }
                                        if (n.length > r.length) {
                                            for (let A in l)
                                                if (null == i[A])
                                                    return new D.ms(j.zUn.AVAILABLE_TAG_DELETE, null, Ap(l[A]));
                                        }
                                        for (let A in l) {
                                            let e = l[A],
                                                t = i[A];
                                            if (
                                                ...
                                                return new D.ms(j.zUn.AVAILABLE_TAG_EDIT, Ap(e), Ap(t));
                                        }
                                        return A;
                                    })(A);
