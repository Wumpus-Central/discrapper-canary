...
let y = new Set([
    ...
    v = (e) => {
        let {
            ...
            L = a.useCallback(
                (e) => {
                    h.default.track(m.HAw.CAPTCHA_EVENT, {
        ...
        let D = a.useCallback(
                (e) => {
                    L("error"), j("error", null != e && y.has(e) ? e : "unknown"), P(), b?.();
                },
                [L, j, P, b],
            ),
            N = a.useCallback(
        ...
        return ((null == n || "" === n) && (n = m._Ak), t === l.MS.RECAPTCHA)
            ? (0, r.jsx)(c.A, { ...x, onLoad: T, onRender: M, onVerify: N, onError: D, sitekey: n })
            : t === l.MS.RECAPTCHA_ENTERPRISE
              ? (0, r.jsx)(f.d, { ...x, onLoad: T, onRender: M, onVerify: N, onError: D, sitekey: n, action: _ })
              : t === l.MS.HCAPTCHA
                ? (0, r.jsx)(i.A, {
                      ref: k,
                      ...x,
                ...
                : t === l.MS.TURNSTILE
                  ...
                  : (0, r.jsx)(c.A, { ...x, sitekey: n, onLoad: T, onRender: M, onVerify: N, onError: D });
    };
