...
class y {
    ...
    handleMessage = (e) => {
        ...
        switch (e.type) {
            case "MESSAGE_CREATE":
                ...
                (t = S.ZE4.MESSAGE_CREATE), (n = e.channelId), (i = e.message), (r = `${t}${e.message.id}`);
                break;
            case "MESSAGE_UPDATE":
    ...
    handleSpeaking = (e) => {
        ...
        if (e.context === b.x.DEFAULT) {
            ...
            if (null != n) {
                ...
                if (null == i) return;
                let r = g.A.getVoiceState(i.getGuildId(), e.userId);
                if (null == r) return;
    ...
    handleNotificationCreate = (e) => {
        ...
        0 !== this.rpcServer.subscriptions.length &&
            this.rpcServer.dispatchToSubscriptions(
                ...
                {},
                { channel_id: t, message: (0, C.Yj)(n), icon_url: null != i ? (0, C.hk)(i) : null, title: r, body: a },
            );
    };
    handleActivityJoin = (e) => {
        ...
        let a = { secret: n };
        r && (a.intent = i),
            this.rpcServer.dispatchToSubscriptions(S.ZE4.ACTIVITY_JOIN, (e) => e.socket.application.id === t, a),
        ...
        switch (r.type) {
            ...
            case S.xL.JOIN_REQUEST:
                this.rpcServer.dispatchToSubscriptions(
                    ...
                    { user: (0, T.A)(a), activity: s, type: r.type, channel_id: t, message_id: n.id },
                );
        }
    };
    ...
    handleRelationshipAdd = (e) => {
        ...
        this.rpcServer.dispatchToSubscriptions(S.ZE4.RELATIONSHIP_UPDATE, {}, (e) =>
            (0, C.LP)(r, e.socket.application.id),
        );
    };
