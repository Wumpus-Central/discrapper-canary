...
let a = {
    ...
    delete(e, t) {
        let { at: n, distance: i, unit: r, reverse: a = !1, select: o = !1, bounds: c, voids: u } = t;
        if (null == n) {
    ...
    voidToText(e, t, n) {
        ...
        l.gB.delete(e, { at: n, voids: !0 }), l.gB.insertText(e, t, { at: r }), c(e, i, r, r, a);
    },
    removeInline(e, t) {
    ...
    keyboardMove(e, t) {
        ...
        if (s.ZF.isExpanded(o)) {
            ...
            "focus" !== a && (c = "line" === i || r ? s.ZF.start(o) : s.ZF.end(o));
        }
        let u = (r ? s.VW.before : s.VW.after)(e, c, { unit: i, distance: n });
        null != u && l.gB.setSelection(e, "focus" === a ? { focus: u } : { anchor: u, focus: u });
    },
};
