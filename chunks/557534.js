...
function O(e, t) {
    return null == t ? R.fx : e > t ? R.mU : R.TR;
}
function G(e) {
    ...
    return (0, r.bG)(
        ...
        : (0, i.jsx)(o.m, {
              ...
              children: (0, i.jsx)(d.D, {
                  className: a()(R.Xs, s ? R.Tf : void 0, u ? R.bw : R.UI),
                  onClick: function () {
                      m.Ay.open(t.id);
                  },
                  tabIndex: l,
                  "aria-label": j.intl.string(j.t["3gUsJb"]),
                  children: (0, i.jsx)(c.Z, { size: "xs", color: "currentColor", className: R.gE }),
              }),
          });
}
function M(e) {
    let {
        ...
        T = (0, r.bG)([], () =>
            t?.type === y.rbe.GUILD_VOICE ? j.intl.string(j.t["EE+P0H"]) : j.intl.string(j.t["0jeAXt"]),
        ),
        L = l.useRef(null);
    if (c || !v || t.isModeratorReportChannel() || t.isThread()) return null;
    let O = (0, i.jsx)(h.R, { size: "xs", className: R.gE, "aria-hidden": !0, color: "currentColor" });
    return (
        s &&
            (O = (0, i.jsx)(I.A, {
                childRef: L,
        ...
        (0, i.jsx)(o.m, {
            ...
            text: T,
            children: (0, i.jsx)(d.D, {
                className: a()(R.Xs, _ ? R.Tf : void 0, m ? R.bw : R.UI),
                onClick: function () {
                    if (null != g) {
...
function D(e) {
    ...
    return (0, i.jsx)(o.m, {
        asContainer: !0,
        text: j.intl.string(j.t["ROh4T+"]),
        children: (0, i.jsx)(d.D, {
            className: R.Xs,
            onClick: () => {
                (0, E.Ol)(t.guild_id, t.id);
            },
            "aria-label": j.intl.string(j.t["ROh4T+"]),
            children: (0, i.jsx)(A.P, { size: "xs", color: "currentColor", className: R.gE }),
        }),
    });
}
function U(e) {
    ...
    return (0, i.jsx)(o.m, {
        asContainer: !0,
        text: j.intl.string(j.t["N2c/Un"]),
        children: (0, i.jsx)(d.D, {
            className: R.Xs,
            onClick: () => {
                (0, E.jA)(t.guild_id, t.id, !0, { section: y.JJy.CHANNEL_LIST });
            },
            "aria-label": j.intl.string(j.t["N2c/Un"]),
            children: (0, i.jsx)(_.A, { size: "xs", color: "currentColor", className: R.gE }),
        }),
    });
}
