...
function v(e) {
    return (0, a.bG)([h.A, y.A], () => {
        let t = i()(h.A.getThreadsForParent(e.guild_id, e.parent_id))
            .keys()
            .filter((e) => y.A.getChannel(e)?.hasFlag(D.lx.PINNED) === !0)
            .head();
        return y.A.getChannel(t);
    });
}
function H(e, t) {
    let n = (0, a.yK)([T.default], () => t.map((e) => T.default.getUser(e)).filter(R.Vq));
    return (
        (0, o.Ay)(() => {
            n.forEach((t) => {
...
function K(e, t) {
    let n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : O.EG.DURATION_AGO,
        u = r.useMemo(() => b.default.extractTimestamp(e.id), [e.id]),
        i = (0, _.JO)(e),
...
function J(e) {
    return (0, a.bG)([M.A], () => M.A.can(j.xBc.MANAGE_CHANNELS, e));
}
let V = { isNew: !1, hasUnreads: !1 };
function $(e) {
    return (0, a.cf)([I.A, S.Ay], () => {
        let t = I.A.getGuild(e.getGuildId() ?? j.dJq);
...
function Z(e) {
    return (0, a.bG)([M.A], () => M.A.can(j.xBc.READ_MESSAGE_HISTORY, e));
}
function W(e) {
    return (0, a.bG)([M.A], () => M.A.can(j.xBc.READ_MESSAGE_HISTORY, e));
}
