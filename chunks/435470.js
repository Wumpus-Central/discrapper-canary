    ...
    r.useEffect(() => {
        ...
        let r = k.A.getThreadIds(e.id, t, n, u),
            i = w.A.getThreadIdsMissingCounts(e.guild_id, r)
                ...
                .slice(0, 180)
                .map((e) => ({ threadId: e, ackMessageId: C.Ay.getTrackedAckMessageId(e) }));
        i.length > 0 &&
            d.h.dispatch({ type: "REQUEST_FORUM_UNREADS", guildId: e.guild_id, channelId: e.id, threads: i });
...
function q(e, t) {
    let n = (0, a.yK)([p.default], () => t.map((e) => p.default.getUser(e)).filter(G.Vq));
    return (
        (0, o.Ay)(() => {
            n.forEach((t) => {
...
function P(e, t) {
    let n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : F.EG.DURATION_AGO,
        u = r.useMemo(() => S.default.extractTimestamp(e.id), [e.id]),
        l = (0, T.JO)(e),
        a = r.useMemo(() => (0, O.mf)(t, n), [t, n]);
    return r.useMemo(() => (t === i.T.CREATION_DATE ? (0, T.aK)(u, a) : (0, T.aK)(l, a)), [l, t, u, a]);
}
function Y(e) {
    return r.useMemo(() => {
        let t = e?.reactions ?? [];
        if (0 !== t.length)
            return l().orderBy(t, [(e) => e.count + e.burst_count, (e) => e.burst_count], ["desc", "desc"])[0];
    }, [e?.reactions]);
}
function z(e) {
...
function $(e) {
    let { firstMessage: t, formatInline: n = !0, noStyleAndInteraction: u = !0, hasUnreads: l = !0 } = e,
...
function ed(e) {
    let { channel: t, sortOrder: n, tagFilter: u, tagSetting: l, shouldAutomaticallyAck: i } = e,
        d = (0, a.yK)([k.A], () => k.A.getThreadIds(t.id, n, u, l)),
        o = ea(t.guild_id, t.id),
        c = (0, a.bG)([k.A], () => i && (o > 0 || k.A.getCanAckThreads()), [i, o]);
    return (
        r.useEffect(() => {
            c &&
                (0, s.hS)(t, {
