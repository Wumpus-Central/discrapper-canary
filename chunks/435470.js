...
function k(e, t, n, r) {
    ...
    i.useEffect(() => {
        if (!a) return;
        let i = D.A.getThreadIds(e.id, t, n, r),
...
function V(e, t) {
    let n = (0, l.yK)([C.default], () => t.map((e) => C.default.getUser(e)).filter(O.Vq));
    return (
        (0, c.Ay)(() => {
            n.forEach((t) => {
...
function ei(e) {
    let { channel: t, sortOrder: n, tagFilter: r, tagSetting: a, shouldAutomaticallyAck: s } = e,
        o = (0, l.yK)([D.A], () => D.A.getThreadIds(t.id, n, r, a)),
        c = en(t.guild_id, t.id),
        u = (0, l.bG)([D.A], () => s && (c > 0 || D.A.getCanAckThreads()), [s, c]);
    return (
        i.useEffect(() => {
            u &&
                (0, d.hS)(t, {
