    ...
    let { message: A, channel: w } = e,
        ...
        R =
            ...
            null ==
                ...
                ? void 0
                : O.rawValue,
        L = (0, a.e7)([h.Z], () => h.Z.getGuild(Z)),
        D = (0, a.e7)([g.Z], () => g.Z.getChannel(R)),
        ...
        H = (0, a.Wu)([E.ZP], () => (null != D ? E.ZP.getVoiceStatesForChannel(D) : []), [D]),
        ...
        Y = k && null != F ? x.intl.formatToPlainString(x.t['er/cHx'], { username: G }) : x.intl.formatToPlainString(x.t.noNjkZ, { username: B.nick }),
        X = null != L && null != D,
        q = null;
    ((q = X ? (k || V ? x.intl.format(x.t.CaLQqK, { channelHook: (e, t) => (0, r.jsx)(m.Z, { channel: null != D ? D : void 0 }, t) }) : x.intl.format(x.t.VugXpK, { channelHook: (e, t) => (0, r.jsx)(m.Z, { channel: null != D ? D : void 0 }, t) })) : x.intl.string(x.t['tHT/Vl'])), 0 === H.length && (q = k ? x.intl.string(x.t.IE2uZW) : x.intl.string(x.t.QVhmGx)));
