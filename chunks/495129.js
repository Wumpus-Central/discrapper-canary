...
function O(e) {
    ...
    let { message: A, channel: w } = e,
        ...
        Y = k && null != F ? C.intl.formatToPlainString(C.t['er/cHx'], { username: G }) : C.intl.formatToPlainString(C.t.noNjkZ, { username: B.nick }),
        X = null != L && null != D,
        q = null;
    ((q = X ? (k || V ? C.intl.format(C.t.CaLQqK, { channelHook: (e, t) => (0, r.jsx)(m.Z, { channel: null != D ? D : void 0 }, t) }) : C.intl.format(C.t.VugXpK, { channelHook: (e, t) => (0, r.jsx)(m.Z, { channel: null != D ? D : void 0 }, t) })) : C.intl.string(C.t['tHT/Vl'])), 0 === H.length && (q = k ? C.intl.string(C.t.IE2uZW) : C.intl.string(C.t.QVhmGx)));
