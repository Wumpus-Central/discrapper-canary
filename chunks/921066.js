...
function O(e) {
    ...
    return (0, r.jsx)("div", {
        className: t,
        children: (0, r.jsx)("img", { className: f.fj, src: n ? R.A : h.A, alt: "", "aria-hidden": !0 }),
    });
}
function x(e) {
...
function P(e) {
    let t,
        ...
        U = S(E?.id),
        y = P
            ? C.intl.format(C.t["/1IQGD"], { username: R.nick, usernameHook: h })
            : C.intl.format(C.t.SbSWvY, { username: R.nick, usernameHook: h, numSubscriptions: (0, m.A)(_) }),
        L = I
