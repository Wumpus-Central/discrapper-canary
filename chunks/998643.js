    ...
    render() {
        ...
        return (0, i.jsxs)(M.A, {
            ...
            children: [
                ...
                (0, i.jsx)(m.A, { path: ei.BVt.DISABLE_EMAIL_NOTIFICATIONS, render: (e) => (0, i.jsx)(ef, { ...e }) }),
                (0, i.jsx)(m.A, {
                ...
                (0, i.jsx)(m.A, {
                    path: ei.BVt.CHANNEL(T.pv.guildId(), T.pv.channelId({ optional: !0 }), ":messageId?"),
                    render: (e) => (0, i.jsx)(ex, { ...e }),
                }),
                (0, i.jsx)(m.A, { path: ei.BVt.REPORT, render: () => (0, i.jsx)(R.Kz, {}) }),
                (0, i.jsx)(m.A, { path: ei.BVt.REPORT_SECOND_LOOK, render: (e) => (0, i.jsx)(eN, { ...e }) }),
                (0, i.jsx)(m.A, { path: ei.BVt.ACCOUNT_REVERT(":token"), render: (e) => (0, i.jsx)(eS, { ...e }) }),
            ],
        });
    }
}
let ey = c.Ay.connectStores([O.default, w.A, L.A, v.A, I.A], (e) => {
    ...
    return {
        ...
        guildTemplate: null != l ? I.A.getGuildTemplate(l) : null,
