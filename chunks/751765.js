...
let v = (e, t) => {
    ...
    C = (e, t) => {
        ...
        return i && null != n && n > t
            ? v(n, t)
            : v(null == n || i ? t : Math.min(n, t), "id" in e ? y.default.extractTimestamp(e.id) : e.start);
    },
    R = (e, t) => {
    ...
    O = (e) => {
        let { hours: t, minutes: n, seconds: i } = e,
            r = [];
        return (
            t > 0 && r.push(N.intl.formatToPlainString(N.t.xCjYxK, { hours: t })),
            r.push(N.intl.formatToPlainString(N.t.iXLF9W, { minutes: n })),
            r.push(N.intl.formatToPlainString(N.t.geSp4K, { seconds: i })),
            r.join(", ")
        );
    },
    b = (e, t) => {
    ...
    D = {
        secondsAgo: (e) => N.intl.formatToPlainString(N.t.EOrEJl, { count: e }),
        minutesAgo: (e) => N.intl.formatToPlainString(N.t.LRNgHp, { count: e }),
        hoursAgo: (e) => N.intl.formatToPlainString(N.t.raJpz3, { count: e }),
        daysAgo: (e) => N.intl.formatToPlainString(N.t.KkvKhi, { count: e }),
        weeksAgo: (e) => N.intl.formatToPlainString(N.t.sDtO6D, { count: e }),
        monthsAgo: (e) => N.intl.formatToPlainString(N.t.ITymou, { count: e }),
    },
    L = function (e, t, n) {
...
function H(e) {
    ...
    return N.intl.formatToPlainString(N.t.NXBtjF, { months: t, weeks: t > 0 ? 0 : n, days: t > 0 || n > 0 ? 0 : r });
}
function j(e) {
    if (null == e || "" === e) return null;
    let t = /\w+ (\d+), \w+ (\d+)/.exec(e);
    return null == t ? null : N.intl.formatToPlainString(N.t.ijVm6y, { seasonNum: t[1], episodeNum: t[2] });
}
function Y(e, t) {
    let n,
        i = t?.size?.[0] ?? void 0,
    ...
    return (
        null != i && null != r && i > 0 && r > 0
            ? (n = N.intl.formatToPlainString(N.t.wmUSiy, { count: i, max: r }))
            : null != i && i > 0 && (n = N.intl.formatToPlainString(N.t.UTYMsa, { count: i })),
...
function z(e) {
    ...
    return n <= 0
        ...
        : {
              text: N.intl.formatToPlainString(N.t.vZaMem, { hours: n }),
              tooltipText: N.intl.formatToPlainString(N.t.S5F485, { hours: n }),
          };
}
function q(e) {
