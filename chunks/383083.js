...
(t.encode = function (e) {
    ...
    for (var t = 0, n = 0, a = 0, s = 0, l = new r(8 * o(e)); t < e.length; ) {
        var c = e[t];
        a > 3
            ? ((s = ((s = c & (255 >> a)) << (a = (a + 5) % 8)) | ((t + 1 < e.length ? e[t + 1] : 0) >> (8 - a))), t++)
            : ((s = (c >> (8 - (a + 5))) & 31), 0 == (a = (a + 5) % 8) && t++),
            (l[n] = i.charCodeAt(s)),
            n++;
    }
                ...
                (i = a[c]),
                    n <= 3
                        ? 0 == (n = (n + 5) % 8)
                            ? ((t |= i), (s[o] = t), o++, (t = 0))
                            : (t |= 255 & (i << (8 - n)))
                        : ((t |= 255 & (i >>> (n = (n + 5) % 8))), (s[o] = t), o++, (t = 255 & (i << (8 - n))));
