...
(t.encode = function (e) {
    ...
    for (var t, r, s = 0, i = 0, a = 0, o = 0, c = new n(8 * ((r = Math.floor((t = e).length / 5)), t.length % 5 == 0 ? r : r + 1)); s < e.length; ) {
        var l = e[s];
        a > 3 ? ((o = ((o = l & (255 >> a)) << (a = (a + 5) % 8)) | ((s + 1 < e.length ? e[s + 1] : 0) >> (8 - a))), s++) : ((o = (l >> (8 - (a + 5))) & 31), 0 == (a = (a + 5) % 8) && s++), (c[i] = 'ABCDEFGHIJKLMNOPQRSTUVWXYZ234567'.charCodeAt(o)), i++;
    }
    ...
    (t.decode = function (e) {
        ...
        for (var o = new n(Math.ceil((5 * e.length) / 8)), c = 0; c < e.length && 61 != e[c]; c++) {
            var l = e[c] - 48;
            if (l < s.length) (i = s[l]), r <= 3 ? (0 == (r = (r + 5) % 8) ? ((t |= i), (o[a] = t), a++, (t = 0)) : (t |= 255 & (i << (8 - r)))) : ((t |= 255 & (i >>> (r = (r + 5) % 8))), (o[a] = t), a++, (t = 255 & (i << (8 - r))));
