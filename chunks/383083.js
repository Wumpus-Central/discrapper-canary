...
((t.encode = function (e) {
    ...
    for (var t, r, i = 0, s = 0, o = 0, a = 0, c = new n(8 * ((r = Math.floor((t = e).length / 5)), t.length % 5 == 0 ? r : r + 1)); i < e.length; ) {
        var l = e[i];
        (o > 3 ? ((a = ((a = l & (255 >> o)) << (o = (o + 5) % 8)) | ((i + 1 < e.length ? e[i + 1] : 0) >> (8 - o))), i++) : ((a = (l >> (8 - (o + 5))) & 31), 0 == (o = (o + 5) % 8) && i++), (c[s] = 'ABCDEFGHIJKLMNOPQRSTUVWXYZ234567'.charCodeAt(a)), s++);
    }
    ...
    (t.decode = function (e) {
        ...
        for (var a = new n(Math.ceil((5 * e.length) / 8)), c = 0; c < e.length && 61 != e[c]; c++) {
            var l = e[c] - 48;
            if (l < i.length) ((s = i[l]), r <= 3 ? (0 == (r = (r + 5) % 8) ? ((t |= s), (a[o] = t), o++, (t = 0)) : (t |= 255 & (s << (8 - r)))) : ((t |= 255 & (s >>> (r = (r + 5) % 8))), (a[o] = t), o++, (t = 255 & (s << (8 - r)))));
