...
function tj(e) {
    ...
    let { hoverSpring: c } = (0, e7.z)({ hoverSpring: +!!a, config: e0.config.gentle }),
        d = i.useCallback(() => {
            (0, eo._Q)(
...
function tS(e) {
    ...
    let { topFade: v, bottomFade: j } = (0, e7.z)({
            topFade: +!!x.top,
            bottomFade: +!!x.bottom,
...
function tC(e) {
    let { heroId: t, quest: s, onQuestCtaClick: n, contentPosition: l } = e,
        ...
        { hoverSpring: R } = (0, e7.z)({ hoverSpring: +!!A, config: e0.config.gentle }),
        b = i.useCallback(() => {
            n(s.id),
...
function nt(e) {
    ...
    return (0, r.jsxs)(r.Fragment, {
        children: [
            ...
            l("activity_panel") &&
                (0, r.jsxs)(r.Fragment, { children: [(0, r.jsx)(t3, { quest: n }), (0, r.jsx)(t2, {})] }),
        ],
    });
}
var ns = s(875696);
...
let nA = i.forwardRef(function (e, t) {
    let {
        ...
        [{ highlightAnimationProgress: j }, S] = (0, e7.z)(() => ({
...
let ll = {
    ...
    li = i.forwardRef(function (e, t) {
        ...
        let [{ highlightAnimationProgress: A }, I] = (0, e7.z)(() => ({
                highlightAnimationProgress: 1,
                config: { duration: lr },
            })),
            R = i.useCallback(
