...
class y extends i.Component {
    ...
    calculateState() {
        ...
        if (t && o < 0) {
            ...
            (d = i.style), (c = i.nudge);
            let s = I(t, d, n, r);
            if ((s > o && ((a = { position: t, style: d, nudge: c }), (u = s)), o < 0 && s < 0)) {
                let i,
                    s = a.position;
                if (
                    (i =
    ...
    componentDidMount() {
        ...
        l()(null != n, "Missing elementRef"),
            null != e.current && p.set(n, e.current),
    ...
    render() {
        let { id: e, className: t, children: n, fixed: i, disablePointerEvents: s, clickTrap: o = !1 } = this.props,
            ...
            E = this.calculateMaxHeight();
        return (0, r.jsx)("div", {
            className: a()({ [h.ld]: !0, [h.x7]: o }),
            children: (0, r.jsx)(c.aS, {
                children: (o) => {
                    let { disableAdaptiveTheme: c } = o;
                    return (0, r.jsx)(_.N, {
                        ...
                        children: (o) =>
                            (0, r.jsx)("div", {
                                ...
                                style: {
                                    ...
                                    ...this.state.style,
                                    "--reference-position-layer-max-height": null != E ? `${E}px` : void 0,
                                },
                                ref: this.elementRef,
