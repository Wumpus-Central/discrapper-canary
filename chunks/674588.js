...
async function P(e) {
    ...
    let { query: n, guildId: r, options: i, onSuccessCallback: o } = e,
        { page: a, pageSize: d, categoryId: f, integrationType: p, minUserInstallCommandCount: _, excludeAppsWithCustomInstallUrl: h, excludeNonEmbeddedApps: g, excludeEmbeddedAppsWithoutPrimaryEntryPointAppCommand: E, source: b = s.F.APP_DIRECTORY } = null != i ? i : {},
        y = Date.now(),
        O = m.Z.getFetchState({
            query: n,
            guildId: r,
