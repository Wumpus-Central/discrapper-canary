...
function nq(e) {
    let { targetElementRef: t } = e,
        ...
        [i, a] = (0, s.useState)(!0),
        r = (0, s.useCallback)(() => {
            a(!1), (0, es.openUserSettings)(el.X.PROFILE_PANEL, { analyticsLocations: n });
        }, [n]),
        o = (0, s.useCallback)(() => {
            a(!1);
        }, []);
    return i && (0, tK.Gn)()
        ? (0, l.jsx)(nr.A, {
              ...
              body: ["Your Nitro perks unlock avatar decorations, nameplates, and profile effects."],
              actions: [{ text: "Customize", variant: "primary", onClick: r }],
          })
        : null;
}
var nZ = n(201805),
    ...
    n5 = n(499156),
    n6 = n(731854);
let n8 = 2.5 * eY.A.Millis.SECOND,
    n4 = +eY.A.Millis.HOUR;
var n9 = n(205693),
    n7 = n(485296);
let le = 3 * eY.A.Millis.SECOND,
    lt = +eY.A.Millis.DAY;
var ln = n(616356),
    ll = n(734057),
    ls = n(629016),
...
function lL(e) {
    let { recentlyLeveledTenureBadge: t, markAsDismissed: n, targetElementRef: i, shouldShow: a } = e,
        r = t_.sp.indexOf(t),
        o = (0, lk.I)(t_.sp[r > 0 ? r - 1 : r]).ambient,
        c = (0, s.useCallback)(() => {
            n(eh.i.TAKE_ACTION),
                tC.A.setState({ shouldRenderTenureLevelUp: !0 }),
                lo._.dispatch(ts.jej.SHOW_ACCOUNT_PROFILE_POPOUT, {});
        }, [n]),
        u = (0, s.useCallback)(() => {
            n(eh.i.USER_DISMISS);
        }, [n]),
    ...
    let { isQuestBarEmpty: t, hasLoadedQuestBar: n } = (0, nZ.c9)(),
        ...
        [i, a] = (function (e) {
            let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                { shouldShow: n = !0 } = t,
                l = (0, lE.G$)(d.V.ADOPT_CLAN_IDENTITY_NOTICE, e ?? ts.dJq),
                s = (0, u.bG)([lT.A, ne.default, lv.Ay], () => {
                    if (null === e) return !1;
            ...
            return (0, lC.ww)(s && n && !l ? [d.M.GUILD_TAG_AVAILABLE_COACHMARK_V2] : [], e ?? ts.eGj);
...
function l4(e) {
    let t,
        ...
        { showPTTIconIndicator: T } = n5.A.useConfig({ location: "MicrophoneButton" }),
        j = (0, u.bG)([n2.Ay], () => n2.Ay.getMode() === n6.TB.PUSH_TO_TALK),
    ...
    return (0, l.jsxs)(O.f5, {
        ...
        children: [
            ...
            (0, l.jsx)(nr.A, {
                ...
                position: "top",
                title: em.intl.string(l5.default.VG4zAf),
                body: em.intl.string(l5.default["8VIRzR"]),
            }),
        ],
    });
}
...
function so(e) {
    ...
    (0, l9.Ay)(() => {
        let e = () => p(!0);
        return (
            lo._.subscribe(ts.jej.PREMIUM_GROUP_PURCHASE_FLOW_COMPLETED, e),
            () => {
                lo._.unsubscribe(ts.jej.PREMIUM_GROUP_PURCHASE_FLOW_COMPLETED, e);
            }
        );
    });
    let f = s.useCallback(() => {
...
let su = lu.Ay.getEnableHardwareAcceleration() ? m.Js : m.eu,
    sd = 2.5 * eY.A.Millis.SECOND,
    sh = 2 * eY.A.Millis.MINUTE,
    sm = 2 * eY.A.Millis.MINUTE,
    sp = 5 * eY.A.Millis.SECOND;
function sf(e) {
    let {
            ref: t,
            speaking: n,
        ...
        j = (0, Z.A)(),
        {
            ...
            return (
                ...
                s.useEffect(() => {
                    ...
                    return (
                        lo._.subscribe(ts.jej.SHOW_ACCOUNT_PROFILE_POPOUT, t),
                        () => {
                            lo._.unsubscribe(ts.jej.SHOW_ACCOUNT_PROFILE_POPOUT, t);
                        }
                    );
                }),
        ...
        return null == e
            ...
            : (0, l.jsxs)(l.Fragment, {
                  children: [
                      ...
                      (0, l.jsx)(eg, {}),
                      (0, l.jsx)(nq, { targetElementRef: this.containerRef }),
                  ],
              });
    }
}
...
function sC() {
    let e = (0, u.bG)([ne.default], () => ne.default.getCurrentUser()),
        ...
        c = (0, T.A)({ userId: t }),
        m = (0, u.bG)([n7.A], () => n7.A.getVoiceVolume(t)),
    ...
    let { shouldShowTooltip: q, dismissTooltip: Z } = sx(n6.oh.AUDIO_INPUT),
        { shouldShowTooltip: K, dismissTooltip: $ } = sx(n6.oh.AUDIO_OUTPUT),
        { shouldShowTooltip: X, dismissTooltip: J } = (function () {
            let [e, t] = s.useState(!1),
                n = (0, u.bG)([n2.Ay], () => n2.Ay.getMode() === n6.TB.PUSH_TO_TALK),
                l = (0, u.bG)(
                    [n3.A],
                    () => null != n3.A.getChannelId() && (n3.A.getDuration() ?? Number.MAX_VALUE) < n8,
                ),
                [i, a] = s.useState(!1),
                { showPTTJoinTooltip: r } = n5.A.useConfig({ location: "usePTTJoinTooltip" }),
                o = s.useRef(new h.Ep()),
                c = s.useRef(new h.Ep());
            s.useEffect(() => {
                if (l && n && !e) {
                    if ((n5.A.getConfig({ location: "usePTTJoinTooltip:couldDisplayTooltip" }), !r)) return;
                    a(!0),
                        t(!0),
                        c.current.start(n4, () => {
                            t(!1);
        ...
        ee = (function () {
            let { showPTTSpeakingIndicator: e } = n5.A.useConfig({ location: "useSpeakingWhilePTT" }),
                [t, n] = s.useState(!1),
                l = (0, u.bG)([n2.Ay], () => n2.Ay.getMode() === n6.TB.PUSH_TO_TALK),
            ...
            return (
                ...
                s.useEffect(() => {
                    ...
                    return (
                        a && e && l && null != i && n2.Ay.getMediaEngine().on(n9.bg.VoiceActivity, o),
                        () => {
                            n2.Ay.getMediaEngine().removeListener(n9.bg.VoiceActivity, o), s.stop();
                        }
                    );
                }, [e, l, a, i]),
                t
