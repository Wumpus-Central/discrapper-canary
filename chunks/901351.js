...
function nK(e) {
    ...
    return a && (0, tK.Gn)()
        ? (0, l.jsx)(nr.A, {
              ...
              size: "video",
              graphic: { type: "video", ref: i, src: nZ.A, aspectRatio: "6/4", loop: !0 },
              title: "Make your profile pop",
              body: ["Animated display names, decorations, and more — only with Nitro."],
              actions: [
                  { text: "Customize Profile", variant: "secondary", onClick: o },
                  { text: "Get Nitro", variant: "primary", onClick: c },
              ],
          })
        : null;
}
