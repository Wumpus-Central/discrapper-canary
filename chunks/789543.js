...
let tf = l.memo(function (e) {
    let { clip: t, isNew: n, onClose: a, className: r } = e,
        o = l.useRef(null),
        { isHoveringOrFocusing: d } = (0, tr.A)(o),
        c = l.useCallback(() => {
    ...
    return (0, i.jsx)(to.Cl, {
        ...
        children: (0, i.jsx)(ts.s, {
            ...
            onClick: c,
            className: s()(tg.Z1, r),
            children: (0, i.jsxs)(tm.d, {
                isStatic: !0,
                children: [
                    n && (0, i.jsx)(eL.Lp, { className: tg.Ad, text: H.intl.string(H.t.y2b7CA) }),
                    (0, i.jsxs)(tp.h, {
                        isVisible: d,
                        className: tg.Lw,
                        children: [
...
function tE(e) {
    ...
    let r = (0, c.yK)([eX.Ay], () => Object.values(eX.Ay.getClips())),
        ...
        m = (0, c.bG)([e7.Ay], () => e7.Ay.getKeybindForAction(tA.hCu.SAVE_CLIP)),
        p = l.useCallback(
            (e) => {
                s?.(e);
            },
        ...
        f = l.useMemo(() => {
            let e = r.filter((e) => e.type === tt.nQ.CLIP && "" !== e.thumbnail && (!g || !(0, eJ.kD)(e)));
            ...
            children: [
                ...
                A.length > 0
                    ? (0, i.jsxs)(e5.Ch, {
                          ...
                          children: [
                              A.map((e) => (0, i.jsx)(tf, { clip: e, isNew: d.includes(e.id), onClose: a }, e.id)),
                              x &&
                                  (0, i.jsx)("div", {
                                      className: tC.qr,
                                      children: (0, i.jsx)(e4.$, {
...
var tW = n(620701);
let tB = l.lazy(() => Promise.all([n.e("3379"), n.e("24832")]).then(n.bind(n, 748579)));
function tZ() {
              ...
              actions: [
                  {
                      ...
                      onClick: function () {
                          r(!0),
                              (0, t$.openUserProfileModal)({ userId: o, tabSection: nk.RP.WIDGETS })
                                  .then(() => {
                                      let e = d.map((e) => e.id);
                                      (0, v.openModalLazy)(
                                          async () => {
        ...
        children: (0, i.jsxs)("aside", {
            ...
            children: [
                ...
                (0, i.jsx)(eO.Ip, {
                    className: nB.XG,
                    fade: !0,
                    children: (0, i.jsx)("div", { className: s()(nB.gT, c), children: r }),
                }),
            ],
        }),
    });
...
function n9(e) {
    let { currentUser: t, onClose: n, setPopoutRef: a, highlightBadge: r, openedAt: o, className: d } = e,
        ...
        { isHoveringOrFocusing: T, isHovering: _ } = (0, tr.A)(C);
    l.useEffect(() => {
        a?.(C.current);
    }, [C, a]),
        l.useEffect(
    ...
    let I = (0, c.bG)([na.A], () => na.A.getStatus(t.id)),
        ...
        b = (function (e) {
            ...
            let s = (0, i.jsx)(i.Fragment, {
                ...
                r = n5({ status: tA.clD.ONLINE, currentStatus: e }),
                o = n5({ status: tA.clD.IDLE, currentStatus: e, description: a(tA.clD.IDLE) }),
                d = n5({ status: tA.clD.DND, currentStatus: e, description: a(tA.clD.DND) }),
                c = n5({ status: tA.clD.INVISIBLE, currentStatus: e, description: a(tA.clD.INVISIBLE) });
            return (0, i.jsxs)(i.Fragment, {
                children: [
                    r,
    ...
    let G = l.useRef((0, tw.A)((e) => e.shouldRenderTenureLevelUp)),
        F = l.useMemo(() => (0, tb.A)(), []),
        [V, W] = l.useState(() => tw.A.getState().shouldRenderTenureLevelUp);
    function B(e) {
        ...
        children: (0, i.jsx)(tq.of, {
            ...
            children: (0, i.jsxs)(ew.l, {
                ...
                children: [
                    ...
                    (0, i.jsxs)(eR.F, {
                        children: [
                            (0, i.jsx)(n0, { displayProfile: g, handleOpenUserProfileModal: B, height: E }),
                            (0, i.jsxs)(t6.A, {
                                className: ez.BK,
                                user: t,
                                displayProfile: g,
                                ...
                                children: [
                                    (0, i.jsxs)("div", {
                                        className: n8.wx,
                                        children: [
                                            (0, i.jsx)(tQ.A, { user: t, displayProfile: g, themeType: n7.d.POPOUT }),
                                            (0, i.jsx)(tX.A, {
                                                user: t,
                                                displayProfile: g,
                                                themeType: n7.d.POPOUT,
                            ...
                            (0, i.jsx)(nw, { targetElementRef: L, onClose: n }),
                            (0, i.jsx)(tZ, {}),
                        ],
                    }),
                ],
    ...
    let { isQuestBarEmpty: t, hasLoadedQuestBar: n } = (0, ie.c9)(),
        ...
        [a, s] = (function (e) {
            let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                ...
                l = (0, c.bG)([iW.A, np.default, iV.Ay], () => {
                    if (null === e) return !1;
...
function lA(e) {
    ...
    t = f
        ...
        : v || A
          ...
          : { tooltipText: G };
    let V = T && _ && N,
        W = M ? no.A.colors.ICON_VOICE_MUTED : "currentColor",
        B = l.useCallback(() => {
...
class lL extends l.PureComponent {
    ...
    speakingWhilePTTInactiveBackoff = new d.A(lw, null, !1);
    ...
    handleToggleSelfMute = () => {
        ...
        (0, X.A)(e, t, tA.JJy.ACCOUNT_PANEL), (0, J.X)(k.A.ACCOUNT, J.O.MIC, n);
    };
    handleToggleSelfDeaf = () => {
        let { serverDeaf: e, selfDeaf: t } = this.props;
        (0, $.A)(e, tA.JJy.ACCOUNT_PANEL), (0, J.X)(k.A.ACCOUNT, J.O.DEAFEN, !t);
    };
