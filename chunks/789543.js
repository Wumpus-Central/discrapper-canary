    ...
    let I = (0, c.bG)([ns.A], () => ns.A.getStatus(t.id)),
        ...
        b = (function (e) {
            ...
            let s = (0, i.jsx)(i.Fragment, {
                ...
                r = n6({ status: tA.clD.ONLINE, currentStatus: e }),
                o = n6({ status: tA.clD.IDLE, currentStatus: e, description: a(tA.clD.IDLE) }),
                d = n6({ status: tA.clD.DND, currentStatus: e, description: a(tA.clD.DND) }),
                c = n6({ status: tA.clD.INVISIBLE, currentStatus: e, description: a(tA.clD.INVISIBLE) });
            return (0, i.jsxs)(i.Fragment, {
                children: [
                    r,
...
var it = n(764336),
    ...
    ih = n(499156),
    im = n(731854);
let ip = 2.5 * e8.A.Millis.SECOND,
    ig = +e8.A.Millis.HOUR;
var iA = n(459838),
    ix = n(485296);
let iv = 3 * e8.A.Millis.SECOND,
    iC = +e8.A.Millis.DAY;
var iE = n(616356),
    iT = n(734057),
    i_ = n(629016),
...
function iH(e) {
    let { markAsDismissed: t, targetElementRef: n, children: a } = e,
        ...
        d = (0, iP.L)(tG.PremiumTypes.TIER_2),
...
function i7(e) {
    let { recentlyLeveledTenureBadge: t, markAsDismissed: n, targetElementRef: a, shouldShow: s } = e,
        r = tG.sp.indexOf(t),
        o = (0, i3.I)(tG.sp[r > 0 ? r - 1 : r]).ambient,
        d = (0, l.useCallback)(() => {
            n(Z.i.TAKE_ACTION),
    ...
    let { isQuestBarEmpty: t, hasLoadedQuestBar: n } = (0, it.c9)(),
        ...
        [a, s] = (function (e) {
            let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                { shouldShow: n = !0 } = t,
                i = (0, iV.G$)(u.V.ADOPT_CLAN_IDENTITY_NOTICE, e ?? tA.dJq),
                l = (0, c.bG)([iB.A, nf.default, iW.Ay], () => {
                    if (null === e) return !1;
