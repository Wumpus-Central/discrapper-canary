...
var tW = n(620701);
let tB = l.lazy(() => Promise.all([n.e("103379"), n.e("924832")]).then(n.bind(n, 748579)));
function tZ() {
    ...
    return (0, i.jsx)(tw.Ok, {
        ...
        children: (0, i.jsxs)("div", {
            ...
            children: [
                ...
                (0, i.jsx)(l.Suspense, { fallback: null, children: (0, i.jsx)(tB, { levelUpData: t }) }),
            ],
        }),
    });
}
              ...
              actions: [
                  {
                      ...
                      onClick: function () {
                          r(!0),
                              (0, tX.openUserProfileModal)({ userId: o, tabSection: nk.RP.WIDGETS })
                                  .then(() => {
                                      let e = d.map((e) => e.id);
                                      (0, v.openModalLazy)(
                                          async () => {
    ...
    let { displayProfile: t, handleOpenUserProfileModal: n, height: a } = e,
        s = (function (e) {
            let { location: t } = e,
                ...
                s = (0, nW.i)((e) => e.recommendationApplicationIds),
                o = (0, nV.rY)(),
                d = (0, nV.qx)();
            return l.useMemo(
...
function it(e) {
    ...
    let I = (0, c.bG)([ns.A], () => ns.A.getStatus(t.id)),
        ...
        M = (function (e) {
            let t = (0, c.bG)([nf.default], () => nf.default.getCurrentUser()),
                n = (0, c.bG)([nr.A], () => nr.A.hidePersonalInformation),
                l = (0, c.bG)([np.A], () => (0, tO.M)(np.A.theme)),
    ...
    let G = l.useRef((0, tk.A)((e) => e.shouldRenderTenureLevelUp)),
        F = l.useMemo(() => (0, tb.A)(), []),
        [V, W] = l.useState(() => tk.A.getState().shouldRenderTenureLevelUp);
    function B(e) {
        ...
        children: (0, i.jsx)(tq.of, {
            ...
            children: (0, i.jsxs)(ek.l, {
                ...
                children: [
                    ...
                    (0, i.jsxs)(eR.F, {
                        children: [
                            (0, i.jsx)(n1, { displayProfile: g, handleOpenUserProfileModal: B, height: E }),
                            (0, i.jsxs)(t4.A, {
                                className: ez.BK,
                                user: t,
                                displayProfile: g,
                            ...
                            (0, i.jsx)(nO, { targetElementRef: L, onClose: n }),
                            (0, i.jsx)(tZ, {}),
                        ],
                    }),
                ],
...
var iP = n(626584),
    ...
    iG = n(259065),
    iF = n(864386);
let iH = new iP.A("DisplayNameStylesFlywheelCoachmark");
function iV(e) {
    ...
    let p = d ? [H.intl.string(iF.default.TyUdka)] : [H.intl.string(iF.default.dluV0R)];
    return (0, i.jsxs)(i.Fragment, {
        children: [
            a,
            (0, i.jsx)(F.A, {
                ...
                size: "lg",
                title: H.intl.string(iF.default.cYwrp8),
                body: p,
    ...
    let { isQuestBarEmpty: t, hasLoadedQuestBar: n } = (0, ii.c9)(),
        ...
        [a, s] = (function (e) {
            let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                { shouldShow: n = !0 } = t,
                i = (0, iW.G$)(u.V.ADOPT_CLAN_IDENTITY_NOTICE, e ?? tA.dJq),
                l = (0, c.bG)([iZ.A, nf.default, iB.Ay], () => {
                    if (null === e) return !1;
    ...
    return l
        ? a === u.M.GUILD_TAG_AVAILABLE_COACHMARK_V2
            ...
            : r === u.M.GUILD_TAG_UPDATED_COACHMARK
              ...
              : (0, i.jsxs)(i.Fragment, {
                    children: [
                        (0, i.jsx)(i4, { groupName: Z.m.ACCOUNT_NAME_ZONE, targetElementRef: e.targetElementRef }),
                        (0, i.jsx)(nG.Ay, {
...
function lv(e) {
    ...
    t = f
        ...
        : v || A
          ...
          : { tooltipText: G };
    let V = T && _ && N,
        W = M ? nc.A.colors.ICON_VOICE_MUTED : "currentColor",
        B = l.useCallback(() => {
    ...
    return (0, i.jsxs)(k.f5, {
        ...
        children: [
                    ...
                    return (0, i.jsxs)("div", {
                        ...
                        children: [
                            (0, i.jsx)(ll.A, {
                                ...
                                className: la.eT,
                                disabled: o,
                                icon: (0, i.jsx)(U, { size: "custom", width: 20, height: 20, color: W, className: d }),
                                onClick: B,
                                onContextMenu: l,
                                onMouseEnter: () => {
                                    u(), L.onMouseEnter();
                                ...
                                role: "switch",
                                ...t,
                                children: V ? (0, i.jsx)("div", { className: s()(lA.U, { [lA.z]: E }) }) : null,
                            }),
                            (0, i.jsx)(ll.A, {
                                "aria-label": x
            ...
            (0, i.jsx)(F.A, {
                ...
                position: "top",
                title: H.intl.string(lf.default.VG4zAf),
                body: H.intl.string(lf.default["8VIRzR"]),
            }),
        ],
    });
}
...
function lN(e) {
    ...
    return (0, i.jsx)(F.A, {
        ...
        shouldShow: n,
        title: H.intl.format(lI.default.bx8sR9, { premiumGroupProductName: (0, l_.DP)() }),
        body: H.intl.format(lI.default.Pw4OFZ, { premiumGroupProductName: (0, l_.DP)() }),
        onRequestClose: a,
        actions: [{ text: H.intl.string(lI.default.DD26QR), onClick: s }],
    });
}
var lS = n(873298),
    ly = n(840387);
...
var lR = n(948198);
let lw = iM.Ay.getEnableHardwareAcceleration() ? m.Js : m.eu,
    lk = 2.5 * e8.A.Millis.SECOND,
    lO = 2 * e8.A.Millis.MINUTE,
    ...
    handleSpeakingWhileMutedChanged = () => {
        let {
            ...
            o =
                ...
                performance.now() - this.lastSpeakingWhileMutedNotificationTime > lO;
        i
            ? r ||
              !e ||
              t ||
...
function lH() {
    let e = (0, c.bG)([nf.default], () => nf.default.getCurrentUser()),
        ...
        { isQuestBarEmpty: V } = (0, ii.c9)(),
        W = (0, c.bG)([il.A, nf.default, iI.A], () => {
            let e,
