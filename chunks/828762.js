...
let U = new g.Z("ProductAttachmentManager");
class O {
    addAttachment(e, t) {
        let A = this.target.getMaxAttachmentsCount();
        if (this.uploads.length >= A)
            throw (
                (l.uv.announce(C.intl.formatToPlainString(C.t["0QDZ4O"], { maxAttachmentsCount: A })),
...
function V(e, t) {
    ...
    return {
        ...
        canAttachArchives:
            null != (A = null == i ? void 0 : i.features.has(b.oNc.GUILD_PRODUCTS_ALLOW_ARCHIVED_FILE)) && A,
    };
}
