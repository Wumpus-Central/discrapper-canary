...
function L(e, t) {
    return 0 === t.length
        ...
        : (0, i.jsxs)("div", {
              className: R.nM,
              children: [
                  (0, i.jsx)(e, { className: R.RI, color: "currentColor" }),
...
function O() {
    let e = (0, d.yK)([T.A, C.A], () =>
        ...
        O = (0, d.yK)([b.default], () => j.map((e) => b.default.getUser(e)), [j]),
        G = (0, d.yK)([b.default], () => c.map((e) => b.default.getUser(e)), [c]),
        M = L(
            _.H,
            s.filter((e) => !c.includes(e.id) && !j.includes(e.id)),
        ),
        D =
            0 === a.length
                ? null
                : (0, i.jsxs)("div", {
                      className: R.nM,
                      children: [
                          (0, i.jsx)(u.q, { size: "lg", color: "currentColor", className: R.RI }),
        ...
        U = L(
            m.F,
            G.filter((e) => null != e && !j.includes(e.id)),
        ),
        P = L(g.k, O);
    return (0, i.jsxs)(i.Fragment, { children: [D, M, U, P] });
}
function G() {
    return (0, i.jsxs)(i.Fragment, {
        children: [
            (0, i.jsx)("div", {
                className: a()(R.nM, R.Dl),
                children: (0, i.jsx)("span", { className: a()(R.cN, R.NT), children: j.intl.string(j.t.wMWyci) }),
            }),
            (0, i.jsx)(O, {}),
        ],
    });
...
function M(e) {
    let { "aria-label": t = !1, children: n } = e,
        s = l.useMemo(() => (0, i.jsx)("div", { className: R.A_, children: (0, i.jsx)(G, {}) }), []);
    return (0, i.jsx)(c.m, {
