...
let l = new Map();
function u(e) {
    if (i.h.isDispatching()) return Promise.resolve().then(() => u(e));
    let t = l.get(e);
    if (null != t) return t;
    i.h.dispatch({ type: "GUILD_TEMPLATE_RESOLVE", code: e });
    let n = r.Bo.get({ url: o.Rsh.UNRESOLVED_GUILD_TEMPLATE(e), oldFormErrors: !0, rejectWithError: !0 })
        .then(
            (t) => {
                let n = t.body;
                return (
                    ...
                    i.h.dispatch({ type: "GUILD_TEMPLATE_RESOLVE_SUCCESS", guildTemplate: n, code: e }),
                    { guildTemplate: (0, s.A)(n), code: e }
                );
            },
            () => (
                a.default.track(o.HAw.GUILD_TEMPLATE_RESOLVED, { resolved: !1, guild_template_code: e }),
                i.h.dispatch({ type: "GUILD_TEMPLATE_RESOLVE_FAILURE", code: e }),
                { guildTemplate: null, code: e }
            ),
        )
        .finally(() => {
            l.delete(e);
