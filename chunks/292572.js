    ...
    d = {
                ...
                .then(
                    (e) => {
                        ...
                        return (
                            ...
                            l.h.dispatch({ type: "GUILD_TEMPLATE_RESOLVE_SUCCESS", guildTemplate: n, code: t }),
                            { guildTemplate: (0, r.A)(n), code: t }
                        );
                    },
                    () => (
                        a.default.track(s.HAw.GUILD_TEMPLATE_RESOLVED, { resolved: !1, guild_template_code: t }),
                        l.h.dispatch({ type: "GUILD_TEMPLATE_RESOLVE_FAILURE", code: t }),
        ...
        loadTemplatesForGuild: (e) =>
            i.Bo.get({ url: s.Rsh.GUILD_TEMPLATES(e), oldFormErrors: !0, rejectWithError: !1 }).then(
                (e) => (l.h.dispatch({ type: "GUILD_TEMPLATE_LOAD_FOR_GUILD_SUCCESS", guildTemplates: e.body }), e),
            ),
        createGuildTemplate: (e, t, n) =>
            i.Bo.post({
                ...
                l.h.dispatch({ type: "GUILD_TEMPLATE_CREATE_SUCCESS", guildTemplate: e.body, code: e.body.code });
            }),
        syncGuildTemplate: (e, t) =>
            i.Bo.put({ url: s.Rsh.GUILD_TEMPLATE(e, t), oldFormErrors: !0, rejectWithError: !1 }).then((e) => {
                l.h.dispatch({ type: "GUILD_TEMPLATE_SYNC_SUCCESS", guildTemplate: e.body, code: t });
            }),
        ...
        deleteGuildTemplate: (e, t) =>
            i.Bo.del({ url: s.Rsh.GUILD_TEMPLATE(e, t), oldFormErrors: !0, rejectWithError: !1 }).then(() => {
                l.h.dispatch({ type: "GUILD_TEMPLATE_DELETE_SUCCESS", guildId: e, code: t });
            }),
    };
