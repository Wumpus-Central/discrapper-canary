...
function $(e) {
    let {
        ...
        { themeType: er } = (0, D.E)(),
        ei = (0, g.A)({ activity: i, user: t }),
        es = (0, N.A)({ display: "live", user: t, activity: i, entry: ei, analyticsLocations: en }),
        ea = (0, C.A)({ userId: t.id, onAction: es }),
        eo = (0, b.A)(i),
        ...
        e_ = () =>
            i.type !== j.$pd.HANG_STATUS || t.id !== n.id || null == Z
                ? null
                : (0, r.jsx)(o.m, { text: K.intl.string(K.t.QSOBaq), children: (0, r.jsx)(l.mir, { size: "xxs" }) }),
        ef = () => {
            let e = (0, u.A)(i) ? "crunchyroll" : "default",
                n = er === W.d.MODAL_V2 ? E.w.SIZE_100 : E.w.SIZE_60;
            return i.type === j.$pd.HANG_STATUS
                ? (0, r.jsx)(T.A, {
                      userId: t.id,
                      size: er !== W.d.MODAL_V2 ? 60 : 100,
                      hangStatusActivity: i,
                      className: s()(z.W9, z.Sl, { [z.EX]: er !== W.d.MODAL_V2 }),
                  })
                : null == ed
                  ? (0, r.jsx)(E.d, { image: eu, smallImage: ec, size: n, aspectRatio: e, className: z.Sl })
                  : (0, r.jsx)(E.d, {
                        image: eu,
                        smallImage: ec,
                        size: n,
            ...
            i.type === j.$pd.HANG_STATUS
                ...
                : (0, _.A)(i) && null != q
                  ? (0, r.jsx)(U.A, {
                        ...
                        onClick: () => {
                            (0, y.u)(q.id), es({ action: "OPEN_VOICE_GUILD" }), Q?.();
                        },
                    })
                  : (0, d.A)(i)
                    ? (0, r.jsx)(m.O, {
        ...
        em = () => {
            if (i.type === j.$pd.WATCHING) return null;
        ...
        eg = () => {
            ...
            return (0, r.jsx)(F.A, { start: e, end: t });
        },
        eA = () =>
            null == ed
        ...
        eI = () =>
            null == q || null == Z
                ? null
                : (0, r.jsx)(G.A, { user: t, guild: q, channel: Z, onAction: es, onClose: Q }),
        eT = () =>
            (0, r.jsx)(w.A, {
                            ...
                            (0, r.jsx)(L.A, {
                                ...
                                onClickViewMore: (e) => {
                                    e.stopPropagation(),
                                        ...
                                        Q?.(),
                                        (0, O.openUserProfileModal)({ userId: t.id, tabSection: H.RP.WIDGETS });
                                },
                            }),
                        ],
                    }),
                (0, r.jsx)(M.A, { applicationId: $?.id, onAction: es, onClose: Q, activity: i }),
            ],
        }),
    });
}
