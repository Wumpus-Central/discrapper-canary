...
class eZ extends l.PureComponent {
    ...
    renderChannelInfo(e, t) {
        ...
        let m,
            ...
            R = I && (null == (n = e.availableTags) ? void 0 : n.every((e) => e.moderated)),
            ...
            k = G.TK.has(e.type)
                ? (0, i.jsx)(p.gNt, {
                      ...
                      children: (0, i.jsx)(N.ZP, {
                          className: a()(ed.topicContainer, { [ed.disabled]: !b }),
                          innerClassName: a()(ed.topic, { [ed.disabled]: !b }),
    ...
    constructor(e) {
        ...
        super(e),
            ...
            eh(this, "handleChangeTopic", (e) => {
                (0, b.pW)({ topic: M.ZP.translateInlineEmojiToSurrogates(e) });
            }),
            ...
            eh(this, "handleChangeTemplate", (e) => {
                (0, b.pW)({ template: M.ZP.translateInlineEmojiToSurrogates(e) });
            }),
...
function eN() {
    let { errors: e, channel: t, submitting: n, subsection: r } = (0, g.cj)([W.Z], () => W.Z.getProps()),
        a = (0, g.e7)([q.Z], () => {
            var e;
