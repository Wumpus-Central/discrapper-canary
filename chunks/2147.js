...
let em = (0, w.hQ)(),
    ...
    eC = {
        breakingChangeDate: (0, J.vc)(o()(el.zQD), "LL"),
...
class eO extends l.PureComponent {
    ...
    renderChannelInfo(e, t) {
            ...
            Q =
                !0 === T
                    ? (0, i.jsx)(et.Z, {
                          ...
                          helperText: this.getSlowmodeHelpText(J),
                          channel: e,
                              ...
                              (0, i.jsxs)(p.C3N, {
                                  ...
                                  children: [
                                      ...
                                      (0, i.jsx)(p.iRW, {
                                          ...
                                          helperText: J ? ec.intl.format(ec.t.nZSuEj, eC) : ec.intl.string(ec.t.kdZU6H),
        ...
        e.type === el.d4z.GUILD_CATEGORY
            ? ((f = ec.intl.string(ec.t.OCAkGP)), (m = "category-name"))
            : e.isForumPost()
              ? ((f = ec.intl.string(ec.t.uyVrTN)), (m = "post-title"))
              : _
                ? ((f = ec.intl.string(ec.t.j3XWjD)), (m = "thread-name"))
                : ((f = ec.intl.string(ec.t.PVbHDl)), (m = "channel-name"));
        let eO = w ? j : x;
    ...
    constructor(e) {
        ...
        super(e),
            ...
            eh(this, "handleChangeName", (e) => {
                ...
                if (null == i) return;
                i.isThread() ? (e = (0, k.Z)(e, !1)) : el.TPd.LIMITED_CHANNEL_NAME.has(i.type) && (e = (0, X.Nj)(e));
