        ...
        var tt = {
            a: function (t, n, r, e) {
                W(
                    "Assertion failed: " +
                        I(t) +
                        ", at: " +
                        [n ? I(n) : "unknown filename", r, e ? I(e) : "unknown function"],
                );
            },
            g: function (t) {
                return tr(t + 16) + 16;
            ...
            l: function (t, n, r, e) {
                for (var a = 0, u = 0; u < r; u++) {
                    for (var i = h[(n + 8 * u) >> 2], o = h[(n + (8 * u + 4)) >> 2], f = 0; f < o; f++)
                        q.printChar(t, m[i + f]);
                    a += o;
                }
                return (h[e >> 2] = a), 0;
        ...
        !(function () {
            ...
            function n(t, n) {
                if (
                    ...
                    0 == P && (null !== T && (clearInterval(T), (T = null)), U))
                ) {
                    var r = U;
                    (U = null), r();
                }
                ...
                return "string" !== n && a && !e
                    ...
                    : function () {
                          return (function (t, n, r, e, a) {
                              ...
                              return (
                                  (u = g), (g = "string" === n ? I(u) : "boolean" === n ? !!u : u), 0 !== c && ta(c), g
                              );
                          })(t, n, r, arguments, 0);
                      };
            }),
