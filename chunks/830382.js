"use strict";
n.d(t, { Aj: () => T, EX: () => E, O1: () => g, QX: () => A, T3: () => v, XU: () => S, lo: () => y });
var r = n(635358),
    i = n(562465),
    s = n(73153),
    a = n(198982),
...
async function g(e) {
    ...
    let n = (await (0, h.aP)({ url: m.Rsh.APPLICATION_SKUS(e), rejectWithError: !1 })).body;
...
async function T(e, t, n, r, o) {
    ...
    try {
        ...
        let l = (await i.Bo.post({ url: m.Rsh.ORDER_CREATE, body: a, rejectWithError: !1 })).body,
            u = l.id;
...
async function S(e, t, n) {
    ...
    try {
        ...
        if (v) e.test_mode = !0;
            ...
            if (
                null != r &&
                ((e.payment_source_id = r.id), (e.payment_source_token = await (0, u.jV)(r)), m.KcG.has(r.type))
            ) {
                let t = await (0, u.jf)(r.type);
                e.return_url =
                    (0, i.TP)() + m.Rsh.BILLING_POPUP_BRIDGE_CALLBACK_REDIRECT_PREFIX(r.type, t ?? "", "success");
            }
        ...
        if (
            ((n.code === o.tG.CONFIRMATION_REQUIRED || n.code === o.tG.AUTHENTICATION_REQUIRED) &&
                s.h.dispatch({ type: "SKU_PURCHASE_AWAIT_CONFIRMATION", skuId: t, isGift: E }),
