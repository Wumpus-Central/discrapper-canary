...
function S(e) {
    ...
    let t = c.A.getChannel(e.channel_id);
    null != t &&
        A(t, (t) => {
...
let D = new b(a.h, {
    CONNECTION_OPEN: function (e) {
        (g = {}), p.clear(), e.guilds.forEach(T);
    },
    OVERLAY_INITIALIZE: function (e) {
        let { threadMessages: t } = e;
        for (let e in (m = { ...t })) {
            let n = t[e].mostRecentMessage;
            null != n && (t[e].mostRecentMessage = new u.Ay({ ...n, author: new d.A(n.author) }));
        }
    },
    ...
    MESSAGE_CREATE: function (e) {
        ...
        let o = c.A.getChannel(r.channel_id);
        if (
            null == o ||
            !l.Le.has(o.type) ||
            ((t = o),
            ...
            return !1;
        A(o, (e) => {
            (e.count = Math.min(e.count + 1, E.su)), (e.mostRecentRawMessage = r), (e.mostRecentMessage = null);
        });
    },
    ...
    LOAD_MESSAGES_SUCCESS: function (e) {
        ...
        let n = c.A.getChannel(e.channelId);
        ...
        A(n, (t) => {
            if (0 === e.messages.length) (t.mostRecentRawMessage = null), (t.mostRecentMessage = null), (t.count = 0);
                ...
                (t.count = e.messages.length >= E.su ? E.su : t.count),
