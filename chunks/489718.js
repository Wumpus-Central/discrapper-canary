...
function C(e) {
    let t,
        ...
        k = i.useRef(null),
        U = M ?? k,
        G = (0, l.H)({ isSelected: n, onChange: R, isDisabled: C }),
        {
            inputProps: F,
            labelProps: V,
            isPressed: B,
        } = (0, s.K)({ id: O, isDisabled: C, "aria-describedby": L, "aria-labelledby": w }, G, U),
        { hoverProps: H, isHovered: j } = (0, a.M)({ isDisabled: C }),
        ...
        $ = (0, d.r)(u.A.colors.SWITCH_BACKGROUND_ACTIVE).spring(),
        z = (0, d.r)(u.A.colors.SWITCH_BORDER_DEFAULT).spring(),
        q = (0, d.r)(u.A.colors.SWITCH_BORDER_SELECTED_DEFAULT).spring(),
        X = (0, d.r)(u.A.colors.SWITCH_BACKGROUND_HOVER).spring(),
        Q = (0, d.r)(u.A.colors.SWITCH_BACKGROUND_SELECTED_HOVER).spring(),
        Z = (0, d.r)(u.A.colors.SWITCH_BORDER_HOVER).spring(),
        ...
        er = (0, d.r)(u.A.colors.SWITCH_THUMB_BACKGROUND_SELECTED_DEFAULT).spring(),
        { state: ei, opacity: es } = (0, c.z)(
            {
                config: { duration: P.enabled ? 200 : 300 },
                opacity: C ? 0.5 : 1,
                state: B ? (n ? v[v.length - 2] : N[1]) : +!!n,
            },
            "animate-always",
        ),
        ea = function (e) {
            let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [...e].reverse();
            return n ? ei.to({ range: v, output: t }) : ei.to({ range: N, output: e });
        };
    return (0, r.jsx)(f.vN, {
        ...b,
        ringTarget: x,
        ...
        children: (0, r.jsxs)("label", {
            ...
            children: [
                (0, r.jsx)(o.animated.div, {
                    ...
                    style: {
                        ...
                        backgroundColor: ei.to({
                            range: y,
                            output: [j ? X : Y, W, $, j ? Q : K],
                            extrapolate: "clamp",
                        }),
                        border: "1px solid",
                        borderColor: ei.to({
                            range: y,
                            output: [j ? Z : z, j ? Z : z, j ? J : q, j ? J : q],
                            extrapolate: "clamp",
                        }),
                    },
                                    ...
                                    children: (0, r.jsxs)("g", {
                                        ...
                                        children: [
                                            (0, r.jsx)(o.animated.path, {
                                                fill: t,
                                                d: ei.to({ range: y, output: [E, g, g, I], extrapolate: "clamp" }),
                                            }),
                                            (0, r.jsx)(o.animated.path, {
                                                fill: t,
                ...
                (0, r.jsx)(p.A, { children: (0, r.jsx)("input", { ...F, ref: U }) }),
            ],
        }),
    });
}
