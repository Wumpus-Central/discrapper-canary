...
function D(e) {
    var { onClick: t, tooltipText: n, selected: r, icon: o } = e,
        c = (function (e, t) {
            if (null == e) return {};
            var n,
                a,
                ...
                I(
                    M(
                        I(M({}, n), {
                            ...
                            className: i()(P.actionButton, { [P.selected]: r }),
...
function w(e) {
    ...
    let { item: o } = e,
        ...
        c = null === (n = o.sourceMetadata) || void 0 === n ? void 0 : n.identifier,
        l = r.useCallback(() => {
            if (null != i && null != c) {
...
function L(e) {
    ...
    let i = (0, _.s$)(t.url);
    async function c() {
        if (((0, v.yg)(v.uG.SAVE_MEDIA_PRESSED), 'VIDEO' === t.type && (0, b.q)({ href: i }), 'IMAGE' === t.type)) {
            o(!0);
            try {
...
function R(e) {
    ...
    return (0, a.jsx)(D, {
        onClick: () => {
            (0, v.yg)(v.uG.OPEN_LINK_PRESSED), (0, b.q)({ href: r });
        },
    ...
    let { item: r, canCopyImage: o, canCopyLink: i, onClose: c, onSelect: l } = e,
        ...
        m = (function (e) {
            ...
            let d = (0, g.Z)(r.identifier),
                p = (0, f.BU)(r.identifier.size / 1000);
            return (0, a.jsxs)(
                s.sNh,
                {
...
function B(e) {
    ...
    let { item: o } = e,
        [i, c] = r.useState(!1),
        l = y.Sb.useSetting(),
        u = 'IMAGE' === o.type && h.isPlatformEmbedded && null == o.children && S.ZP.canCopyImage() && (0, _.Lz)(o.url),
        d = (0, _.Jj)(o.url);
