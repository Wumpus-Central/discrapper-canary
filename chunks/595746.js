...
let R = function (e) {
    let { onClose: t, classificationId: n, onGoogleWalletSelect: i } = e,
        { methods: s, loading: a } = (0, T.cf)([y.A], () => ({ methods: y.A.methods, loading: y.A.loading })),
            ...
            return (
                Promise.resolve(!1).then((t) => {
                    !e &&
                        ...
                        u(t && N.getConfig({ location: "age_verification_methods" }).enabled));
                }),
                () => {
                    e = !0;
                }
            ...
            ageVerificationMethods: r.useMemo(() => {
                let e =
                    s
                        ...
                        .filter((e) => null != e) ?? [];
                if (l && null != i) {
                    let t = v.uv[v.VF.GOOGLE_WALLET];
                    if (null != t)
                        return [
                            ...e,
                            {
                                id: v.VF.GOOGLE_WALLET,
                                title: C.intl.string(t.title),
                                description: C.intl.string(t.description),
                                onClick: (e) => {
                                    S.A.increment({ name: I.K.GOOGLE_WALLET_METHOD_SELECTED }),
                                        (0, m.St)(e, m.WU.EXPRESSIVE_PRIMARY, m._7.METHOD_SELECT, v.VF.GOOGLE_WALLET),
                                        i();
                                },
                            },
                        ];
...
function M(e) {
    ...
    return (0, f.W$)()
        ? (0, i.jsx)(o.E, {
              ...
              children: C.intl.format(D.default.htWh1G, {
                  handleOnHelpUrlHook: () => {
...
let P = function (e) {
    let { transitionState: t, entryPoint: n, onClose: l, onComplete: h, dismissable: I, classificationId: T } = e,
        S = r.useMemo(() => (0, s.A)(), []),
        y = (0, f.W$)(),
        { loading: N, ageVerificationMethods: v } = R({
            onClose: () => {
                h?.(), l();
            },
            classificationId: T,
    ...
    return (
        ...
        (0, i.jsx)(a.k, {
            ...
            subtitle: (0, A.mK)(
                n,
                () => {
                    E.A.openUrl(p.A.getArticleURL(O.MVz.TIGGER_PAWTECT_LEARN_MORE)),
                    ...
                    (0, i.jsxs)(u.B, {
                        ...
                        children: [
                            ...
                            (0, i.jsx)(o.E, {
                                ...
                                children: C.intl.string(D.default.ar3a3q),
                            }),
                        ],
                    }),
                    null == v || 0 === v.length
                        ? (0, i.jsxs)(u.B, {
                              ...
                              children: [
                                  (0, i.jsx)(o.E, {
                                      variant: "text-xs/medium",
                                      color: "text-subtle",
                                      children: C.intl.string(D.default.cR6336),
                                  }),
                                  (0, i.jsx)(d.$, {
                                      variant: "primary",
                                      size: "sm",
                                      text: C.intl.string(D.default.hDvmYP),
                                      onClick: () => {
                                          (0, g.DJ)();
                                      },
                                  }),
