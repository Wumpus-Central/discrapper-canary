...
class Y extends s.PureComponent {
            ...
            : w.Yy.has(t)
              ? (0, i.jsx)(u.p, {
                    ...
                    children: B.intl.format(B.t.MOIaNd, {
                        keyboardNavArticle: P.A.getArticleURL(V.MVz.KEYBOARD_NAVIGATION),
                    }),
                })
              : (0, i.jsx)(c.E, {
    ...
    renderExtraSettings() {
        ...
        return e === V.hCu.SWITCH_TO_VOICE_CHANNEL ? (0, i.jsx)(U.A, { keybind: this.props.keybind }) : void 0;
    }
}
class X extends s.PureComponent {
    get keybindActionTypes() {
        let {
            ...
            l = [
                { id: "unassigned", value: V.hCu.UNASSIGNED, label: B.intl.string(B.t["0Uh579"]) },
                { id: "push-to-talk", value: V.hCu.PUSH_TO_TALK, label: B.intl.string(B.t.Y5lgTP) },
                { id: "push-to-talk-priority", value: V.hCu.PUSH_TO_TALK_PRIORITY, label: B.intl.string(B.t.DkSwJ2) },
                { id: "push-to-mute", value: V.hCu.PUSH_TO_MUTE, label: B.intl.string(B.t.hSCRqd) },
                { id: "vad-priority", value: V.hCu.VAD_PRIORITY, label: B.intl.string(B.t["49d6Nd"]) },
                { id: "toggle-mute", value: V.hCu.TOGGLE_MUTE, label: B.intl.string(B.t.PlkYKD) },
                { id: "toggle-deafen", value: V.hCu.TOGGLE_DEAFEN, label: B.intl.string(B.t.NvGq1K) },
                { id: "toggle-voice-mode", value: V.hCu.TOGGLE_VOICE_MODE, label: B.intl.string(B.t.Wa5H9S) },
                { id: "toggle-streamer-mode", value: V.hCu.TOGGLE_STREAMER_MODE, label: B.intl.string(B.t.BK0Ncc) },
                { id: "toggle-camera", value: V.hCu.TOGGLE_CAMERA, label: B.intl.string(B.t.hf8JVT) },
            ];
        return (
            e &&
                (l.push({
            ...
            (0, G.isDesktop)() &&
                (l.push(
                    { id: "navigate-back", value: V.hCu.NAVIGATE_BACK, label: B.intl.string(B.t.gRSaOa) },
                    { id: "navigate-forward", value: V.hCu.NAVIGATE_FORWARD, label: B.intl.string(B.t.zOXpjU) },
                    {
                ...
                n &&
                    l.push(
                        { id: "soundboard", value: V.hCu.SOUNDBOARD, label: B.intl.string(B.t.yPH4xm) },
                        { id: "soundboard-hold", value: V.hCu.SOUNDBOARD_HOLD, label: B.intl.string(B.t["1xFbP/"]) },
                    ),
                i &&
                    (l.push({ id: "save-clip", value: V.hCu.SAVE_CLIP, label: B.intl.string(B.t.U4URzP) }),
                    s &&
                        l.push({
                            id: "save-screenshot",
    ...
    get keybindDescriptions() {
        let { overlaySupported: e, canGoLive: t, enableClips: n, enableScreenshotKeybind: i } = this.props,
            s = {
                [V.hCu.UNASSIGNED]: B.intl.string(B.t.rvlNLv),
                [V.hCu.PUSH_TO_MUTE]: B.intl.string(B.t.xtESim),
                [V.hCu.PUSH_TO_TALK]: B.intl.string(B.t.wTcBSy),
                [V.hCu.PUSH_TO_TALK_PRIORITY]: B.intl.string(B.t.FhHvWH),
                [V.hCu.TOGGLE_MUTE]: B.intl.string(B.t.X2fbUm),
                [V.hCu.TOGGLE_DEAFEN]: B.intl.string(B.t.MjREZV),
                [V.hCu.TOGGLE_VOICE_MODE]: B.intl.string(B.t.snm5YW),
                [V.hCu.TOGGLE_STREAMER_MODE]: B.intl.string(B.t.YszLLx),
                [V.hCu.VAD_PRIORITY]: B.intl.string(B.t.rSe8IZ),
                [V.hCu.TOGGLE_CAMERA]: B.intl.string(B.t.v1JBtL),
            };
        return (
            e && (s[V.hCu.TOGGLE_OVERLAY_INPUT_LOCK] = B.intl.string(B.t.IoP5vc)),
            t && (0, G.isWindows)() && (s[V.hCu.TOGGLE_GO_LIVE_STREAMING] = B.intl.string(B.t.s4C238)),
            (0, G.isDesktop)() &&
                ((s[V.hCu.NAVIGATE_BACK] = B.intl.string(B.t.nKDlEt)),
                (s[V.hCu.NAVIGATE_FORWARD] = B.intl.string(B.t.DK0FFk)),
                (s[V.hCu.SOUNDBOARD] = (0, G.isWindows)() ? B.intl.string(B.t["5wJefL"]) : B.intl.string(B.t.gzjsSP)),
                (s[V.hCu.SOUNDBOARD_HOLD] = (0, G.isWindows)() ? B.intl.string(B.t.RRkZc9) : B.intl.string(B.t.laNlTl)),
                n &&
                    ((s[V.hCu.SAVE_CLIP] = B.intl.string(B.t.z3Wbam)),
                    i && (s[V.hCu.SAVE_SCREENSHOT] = B.intl.string(B.t.m0zd57)))),
            s
        );
    }
    handleAddKeybind = () => {
                ...
                (0, i.jsx)(k.A, {
                    ...
                    children: G.isPlatformEmbedded
                        ...
                        : (0, i.jsx)(u.p, {
                              ...
                              className: F.Ly,
                              children: B.intl.format(B.t.mPi3F3, { downloadLink: V.X7G.DOWNLOAD }),
                          }),
                }),
                (0, i.jsxs)(T.B, {
                    gap: 48,
