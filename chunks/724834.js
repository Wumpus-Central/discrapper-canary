...
function Q(e) {
    ...
    let { trackUserProfileWishlistAction: y } = (0, I.NJ)(),
        N = l.useCallback(() => {
            null != E &&
                (y({
                    wishlistId: E,
        ...
        _ = null != u ? (0, i.jsx)("div", { ref: k, className: q.BU, children: u }) : null,
        {
            onBodyClick: O,
            onOverlayClick: P,
            showOverlayButton: D,
            ...
            label: G,
            icon: U,
        } = (0, z.P)({ wishlistOwner: n, isOwned: C, onDetailsClick: N, onPurchaseClick: R }),
        W = f && D;
    return (0, i.jsxs)("div", {
        className: q.kL,
        children: [
