n.d(t, { Z: () => v }), n(539854), n(415506), n(388685), n(49124), n(290780), n(35282);
var r,
    i = n(74514),
    a = n.n(i),
    o = n(117806),
...
class v extends _.Z {
    ...
    setCodecs(e, t, n) {
        var r, i, a;
        let o;
        (this.audioCodec !== e || this.videoCodec !== t) && ((o = this.codecs.find((t) => t.name === e)), (this.audioCodec = e), (this.audioPayloadType = null != (r = null == o ? void 0 : o.payloadType) ? r : 0), (o = this.codecs.find((e) => e.name === t)), (this.videoCodec = t), (this.videoPayloadType = null != (i = null == o ? void 0 : o.payloadType) ? i : 0), (this.rtxPayloadType = null != (a = null == o ? void 0 : o.rtxPayloadType) ? a : 0), this.logger.info('Renegotiating: Codecs changed'), this.handleNegotiationNeeded());
    }
    setStream(e) {
        let t = 'closed' === this.iceConnectionState;
        null != e && !t && (O(this.audioTransceiver, e.getAudioTracks()[0]), this.videoSupported && O(this.videoTransceiver, e.getVideoTracks()[0])), this.logger.info('Renegotiating: Streams changed'), this.handleNegotiationNeeded();
    }
    createUser(e, t, n) {
        var r;
        ...
        if (this.videoSupported && void 0 !== n && (!y || void 0 === a.videoSSRC)) {
    ...
    parseLocalDescription() {
        ...
        let t = e.sdp,
            { outboundStreams: n, codecs: r, audioSSRC: i, videoSSRC: a, rtxSSRC: o } = (0, p.Nl)(t),
            s = (0, p.nX)(t);
        return {
            sdp: t,
            outboundStreams: n,
    ...
    generateSDPAnswer(e, t, n, r) {
        ...
        let { ssrcs: f, remainingAudioStreams: h, remainingVideoStreams: m } = this.buildSSRCsFromOutboundStreams(e, t, n, r);
        return {
    ...
    setConnected() {
        this.input.reset(), this.setConnectionState(h.$j.CONNECTED), this.on(d.Sh.Stats, this.handleStats), this.input.on(f.G.VoiceActivity, this.handleVoiceActivity);
    }
    async handleNegotiationNeeded() {
        ...
        let { sdp: l, outboundStreams: c, codecs: u, audioSSRC: _, videoSSRC: f, rtxSSRC: h, extensions: m } = this.parseLocalDescription();
        (this.codecs = u), (this.extensions = m), (this.audioSSRC = _), (this.videoReady = f > 0 && h > 0), (this.videoStreamParameters[0].ssrc !== f || this.videoStreamParameters[0].rtxSsrc !== h || this.videoReady) && ((this.videoStreamParameters[0].ssrc = 0 === f ? this.videoStreamParameters[0].ssrc : f), (this.videoStreamParameters[0].rtxSsrc = 0 === h ? this.videoStreamParameters[0].rtxSsrc : h), (this.videoStreamParameters[0].active = this.videoReady), this.emit(d.Sh.Video, this.userId, this.input.getVideoStreamId(), this.audioSSRC, f, h, this.videoStreamParameters)), null == this.sdp ? this.emit(d.Sh.Connected, 'webrtc', (0, p.sc)(l)) : this.setRemoteAnswer(c, t, n, r);
    }
    constructor(e, t, n, r) {
        super(e, t, n, r),
            g(this, 'pc', void 0),
