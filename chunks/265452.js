...
function es(e) {
    let { rows: t, onToggle: n, selection: r, scrollerRef: s, disabled: a } = e,
        ...
        h = i.useCallback(() => 48, []);
    return 0 === t.length
        ? (0, l.jsx)(g.OZU, { children: X.NW.string(X.t.ojoWgY) })
        : (0, l.jsx)(d.bG, {
              navigator: u,
...
function ea(e) {
    ...
    let y = (0, S.Z)({ guildId: r.id }),
        ...
        ed = i.useRef(null),
        ec = i.useRef(null),
        { analyticsLocations: eg } = (0, f.ZP)(N.Z.INSTANT_INVITE_MODAL),
        eh = i.useCallback(
            (e) => {
                var t;
        ...
        { canCreateApplicationBypassInvites: eS, isManualApprovalGuild: eb } = (0, z.R)(r),
        eE = e_ && ej,
        {
            rows: eT,
            showFriends: eO,
