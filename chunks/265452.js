...
function er(e) {
    ...
    let S = (0, j.Z)({ guildId: r.id }),
        [E, _] = i.useState([]),
        [P, R] = i.useState(''),
        { current: k } = i.useRef(X({}, $, null == S ? {} : { max_age: S }, null == x ? {} : { target_application_id: x }, null == f ? {} : { target_type: f }, null == m ? {} : { target_user_id: m })),
        [L, J] = i.useState(k),
        [Q, ee] = i.useState(!1),
        [et, en] = i.useState(!1),
    ...
    return (0, l.jsx)(I.Gt, {
        ...
        children: (0, l.jsxs)(c.Y0X, {
            ...
            children: [
                ...
                (0, l.jsx)(c.hzk, {
                    className: s()(K.body, { [K.empty]: 0 === eb.length }),
                    children: (0, l.jsx)(ei, {
                        rows: eb,
                        onToggle: eg,
                        scrollerRef: ea,
