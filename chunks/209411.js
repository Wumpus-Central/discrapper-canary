n.d(t, { Z: () => _ }), n(388685), n(35282), n(457542);
var r = n(54381),
    i = n(473749),
    s = n(593473),
    a = n(828700),
...
function _(e) {
    ...
    let _ = i.useCallback(
            (t) => {
                if (
                    (function (e) {
                        ...
                        return (null == n || null == (t = n.params) ? void 0 : t.channelId) === x.oC.ROLE_SUBSCRIPTIONS;
                    })(t)
                )
                    f.dL(t);
                else {
        ...
        { isAuthenticated: E, loginStatus: v } = (0, l.cj)([g.default], () => ({
