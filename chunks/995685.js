...
var o = {
    ...
    "creditCard.cvcField.title": "C\xf3digo de seguridad",
    ...
    gender: "G\xe9nero",
    "gender.notselected": "Seleccione un g\xe9nero",
    male: "Masculino",
    female: "Femenino",
    ...
    "address.placeholder": "Encuentre su direcci\xf3n",
    "address.errors.incomplete": "Introduzca una direcci\xf3n para continuar",
    "address.enterManually": "Introduzca la direcci\xf3n manualmente",
    state: "Estado",
    "field.title.optional": "(opcional)",
    "creditCard.cvcField.title.optional": "C\xf3digo de seguridad (opcional)",
    ...
    "error.va.sf-cc-num.01": "Introduzca un n\xfamero de tarjeta v\xe1lido",
    "error.va.sf-cc-num.02": "Introduzca el n\xfamero de tarjeta",
    "error.va.sf-cc-num.03": "Introduzca una marca de tarjeta admitida",
    "error.va.sf-cc-num.04": "Introduzca el n\xfamero de tarjeta completo",
    "error.va.sf-cc-dat.01": "Introduzca una fecha de caducidad v\xe1lida",
    "error.va.sf-cc-dat.02": "Introduzca una fecha de caducidad v\xe1lida",
    "error.va.sf-cc-dat.03": "La tarjeta de cr\xe9dito est\xe1 a punto de caducar",
    ...
    "error.va.sf-cc-yr.01": "Introduzca el a\xf1o de caducidad",
    "error.va.sf-cc-yr.02": "Introduzca el a\xf1o de caducidad completo",
    "error.va.sf-cc-cvc.01": "Introduzca el c\xf3digo de seguridad",
    "error.va.sf-cc-cvc.02": "Introduzca el c\xf3digo de seguridad completo",
    ...
    "creditCard.encryptedCardNumber.aria.iframeTitle": "Utilice Iframe para el n\xfamero de tarjeta",
    ...
    "creditCard.encryptedExpiryYear.aria.iframeTitle": "Utilice iframe para el a\xf1o de caducidad",
    "creditCard.encryptedExpiryYear.aria.label": "A\xf1o de caducidad",
    "creditCard.encryptedSecurityCode.aria.iframeTitle": "Utilice iframe para el c\xf3digo de seguridad",
    "creditCard.encryptedSecurityCode.aria.label": "C\xf3digo de seguridad",
    "creditCard.encryptedPassword.aria.iframeTitle": "Utilice iframe para la contrase\xf1a",
    "creditCard.encryptedPassword.aria.label": "Primeros 2 d\xedgitos de la contrase\xf1a de la tarjeta",
    "giftcard.encryptedCardNumber.aria.iframeTitle": "Utilice iframe para el n\xfamero de tarjeta",
    "giftcard.encryptedCardNumber.aria.label": "N\xfamero de tarjeta",
    ...
    "ach.encryptedBankAccountNumber.aria.iframeTitle": "Utilice iframe para el n\xfamero de cuenta bancaria",
    "ach.encryptedBankAccountNumber.aria.label": "N\xfamero de cuenta",
    "ach.encryptedBankLocationId.aria.iframeTitle": "Utilice iframe para el n\xfamero de ruta bancaria",
    "ach.encryptedBankLocationId.aria.label": "N\xfamero de ruta ABA",
    ...
    "onlineBankingPL.termsAndConditions":
        "Al continuar, acepta las %#regulaciones%# y la %#obligaci\xf3n de informaci\xf3n%# de Przelewy24",
    ...
    "ctp.login.subtitle":
        "Introduzca la direcci\xf3n de correo electr\xf3nico que tiene conectada a Click to Pay para continuar.",
    ...
    "ctp.infoPopup.subtitle":
        "Un m\xe9todo de pago r\xe1pido y seguro compatible con Mastercard, Visa y otras tarjetas de pago.",
    ...
    "ctp.errors.NOT_FOUND":
        "No se ha encontrado ninguna cuenta, escriba un correo electr\xf3nico v\xe1lido o contin\xfae usando la escritura manual de la tarjeta",
    ...
    "ctp.errors.RETRIES_EXCEEDED":
        "Se ha excedido el l\xedmite de reintentos para la generaci\xf3n de una contrase\xf1a de un solo uso",
    ...
    "ctp.errors.REQUEST_TIMEOUT":
        "Se ha producido un error, int\xe9ntelo de nuevo o utilice la escritura manual de la tarjeta",
    ...
    "companyDetails.registrationNumber.invalid": "Introduzca el n\xfamero de registro",
    "consent.checkbox.invalid": "Debe aceptar los t\xe9rminos y condiciones",
    "form.instruction": "Todos los campos son obligatorios a menos que se indique lo contrario.",
    "trustly.descriptor": "Pago bancario instant\xe1neo",
