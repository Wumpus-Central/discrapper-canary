...
(o.rgb.hsl = function (e) {
    ...
    return (
        ...
        (r = (o + i) / 2),
        [t, 100 * (i === o ? 0 : r <= 0.5 ? c / (i + o) : c / (2 - i - o)), 100 * r]
    );
}),
        ...
        return (
            0 === u
                ...
                : ((s = u / l),
                  ...
                  (r = b(i)),
                  (a = b(c)),
                  o === l ? (n = a - r) : i === l ? (n = 1 / 3 + t - a) : c === l && (n = 2 / 3 + r - t),
                  n < 0 ? (n += 1) : n > 1 && (n -= 1)),
            [360 * n, 100 * s, 100 * l]
        );
    }),
    ...
    (o.hsv.hsl = function (e) {
        ...
        return (
            (a = (2 - s) * o),
            (t = (2 - s) * i),
            [n, 100 * (r = (r = (s * i) / (t <= 1 ? t : 2 - t)) || 0), 100 * (a /= 2)]
        );
    }),
    ...
    (o.lab.xyz = function (e) {
        ...
        return (
            ...
            [
                ...
                r,
                (a = (l > 0.008856 ? l : (a - 16 / 116) / 7.787) * 108.883),
            ]
        );
    }),
    ...
    (o.rgb.hcg = function (e) {
        ...
        return (
            ...
            [
                360 *
                    (((i <= 0 ? 0 : s === r ? ((a - n) / i) % 6 : s === a ? 2 + (n - r) / i : 4 + (r - a) / i + 4) /
                        6) %
                        1),
                100 * i,
                100 * t,
