...
function G() {
    ...
    return {
        ...
        [b.KS]: {
            title: U.t.p7BkHh,
            titleParams: { discountPercentage: (0, y.LR)("getRecurringPromotionPartnerAttributes") ? O.zG : O.H7 },
            body: e ? U.t.nmvvaN : U.t.igiSKe,
            bodyWithExpiration: U.t.w8CXUl,
            redemptionURL: "https://steelseries.com/",
            logos: { dark: (0, i.jsx)(L, {}), light: (0, i.jsx)(D, {}) },
        ...
        [b.Cs]: {
            ...
            bodyNote: (0, y.Se)("getRecurringPromotionPartnerAttributes") ? U.t.vblnHk : void 0,
            redemptionURL: "https://www.kontrolfreek.com/",
            logos: { dark: (0, i.jsx)(w, {}), light: (0, i.jsx)(P, {}) },
            ...
            children: (0, i.jsx)(l.K, {
                ...
                onClick: () => {
                    navigator.clipboard.writeText(t.code),
                        h(a),
                        T.default.track(M.HAw.THIRD_PARTY_PARTNER_CTA_CLICKED, {
                            partner: t.partnerId,
                            cta_type: "copy code",
                    ...
                    (0, i.jsx)(c.$, {
                        ...
                        onClick: () => {
                            window.open(t.redemptionURL, "_blank"),
                                T.default.track(M.HAw.RECURRING_PROMOTION_CLAIMED),
                                T.default.track(M.HAw.THIRD_PARTY_PARTNER_CTA_CLICKED, {
                                    partner: t.partnerId,
...
function j(e) {
    ...
    return (0, i.jsxs)("div", {
        ...
        children: [
                                            ...
                                            (0, i.jsx)(h.D, {
                                                ...
                                                children: T
                                                    ? U.intl.format(U.t.i2EuFO, {
                                                          helpdeskArticle: N.A.getArticleURL(M.MVz.RECURRING_PROMOTION),
                                                      })
                                                    : y
                                                      ? o.body
            ...
            _ && (0, i.jsx)(V, {}),
            null != g && (0, i.jsx)(B, { recurrence: { ...o, code: g }, analyticsLocations: p }),
            _ &&
                null == g &&
                (0, i.jsx)(F, {
                    children: (0, i.jsx)(H, {
