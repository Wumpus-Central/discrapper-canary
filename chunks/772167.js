...
function k() {
    ...
    return {
        [O.XY]: {
            title: e ? U.default.PF1aT5 : U.default.LsJ9hj,
            titleParams: e ? { discountPercentage: S.aW } : { discountPercent: S.aW },
            body: e ? U.default.KoKwMn : U.default.Yl5ww1,
            bodyWithExpiration: U.default["6KjkUa"],
            redemptionURL: "https://www.logitech.com/",
            logos: {
                dark: (0, r.jsx)(n.Fragment, {}, "logitech-logo-dark"),
                light: (0, r.jsx)(n.Fragment, {}, "logitech-logo-light"),
            },
            asset: "https://cdn.discordapp.com/assets/content/c93472f5033e3079579ad496c9a54a95faa23623f5b1d11590d536c861f52e7c.svg",
        },
        [O.KS]: {
            title: y.t.p7BkHh,
            titleParams: { discountPercentage: (0, v.LR)("getRecurringPromotionPartnerAttributes") ? I.zG : I.H7 },
            body: e ? y.t.nmvvaN : y.t.igiSKe,
            bodyWithExpiration: y.t.w8CXUl,
            redemptionURL: "https://steelseries.com/",
            logos: { dark: (0, r.jsx)(N, {}), light: (0, r.jsx)(j, {}) },
            asset: "https://cdn.discordapp.com/assets/content/c23a186569a2e8606d206cd4b5cc7f4ee8f880c844bc0debd5fd3400400ff7bc.png",
        },
        [O.Cs]: {
            title: e ? y.t.QEJnti : y.t["9N8obd"],
            titleParams: e ? { discountPercentage: I.F0 } : void 0,
            body: e ? y.t.eT5vm0 : y.t["34g+Z3"],
            bodyWithExpiration: y.t.rqmpXc,
            bodyNote: (0, v.Se)("getRecurringPromotionPartnerAttributes") ? y.t.vblnHk : void 0,
            redemptionURL: "https://www.kontrolfreek.com/",
            logos: { dark: (0, r.jsx)(M, {}), light: (0, r.jsx)(D, {}) },
    ...
    return (0, r.jsxs)("div", {
        ...
        children: [
            (0, r.jsx)(s.E, {
                ...
                color: "text-muted",
                className: L.kT,
                children: y.intl.format(U.default["65EEvD"], { days: t }),
            }),
            (0, r.jsx)(R.Ay, {
                progress: e,
                variant: R.qP.UNSET,
...
function F(e) {
    let { children: t } = e;
    return (0, r.jsx)("div", { className: L.oP, children: (0, r.jsx)("div", { className: L.t0, children: t }) });
}
let Y = (e) => {
    let { recurrence: t, analyticsLocations: i = [] } = e,
        a = (0, r.jsx)(l.r, { color: h.A.colors.CONTROL_CONNECTED_BACKGROUND_DEFAULT }),
        u = (0, r.jsx)("span", {
            className: L.nP,
            children: (0, r.jsx)(o.K, {
                ...
                onClick: () => {
                    navigator.clipboard.writeText(t.code),
                        p(a),
                        P.default.track(T.HAw.THIRD_PARTY_PARTNER_CTA_CLICKED, {
                            partner: t.partnerId,
                            cta_type: "copy code",
            ...
            children: (0, r.jsxs)("div", {
                ...
                children: [
                    ...
                    (0, r.jsx)(c.$, {
                        variant: "secondary",
                        size: "sm",
                        text: y.intl.formatToPlainString(y.t.DF68t7, { redemptionURL: t.redemptionURL }),
                        onClick: () => {
                            window.open(t.redemptionURL, "_blank"),
                                P.default.track(T.HAw.RECURRING_PROMOTION_CLAIMED),
                                P.default.track(T.HAw.THIRD_PARTY_PARTNER_CTA_CLICKED, {
                                    partner: t.partnerId,
...
function G(e) {
    ...
    let i,
        ...
        [g, R] = n.useState(l.code),
        [P, x] = n.useState(!1),
        A =
            ((t = l.partnerId),
            (i = (0, b.bG)([_.A], () => (0, a.M)(_.A.theme))),
            null == (s = k()[t]) ? null : i ? s.logos.dark : s.logos.light),
        v = null == g;
    return (0, r.jsxs)("div", {
        className: L.lA,
        children: [
                                    ...
                                    (0, r.jsxs)(f.B, {
                                        ...
                                        children: [
                                            (0, r.jsx)(p.D, {
                                                ...
                                                color: "text-subtle",
                                                children: P
                                                    ? y.intl.format(y.t.i2EuFO, {
                                                          helpdeskArticle: E.A.getArticleURL(T.MVz.RECURRING_PROMOTION),
                                                      })
                                                    : v
                                                      ? l.body
                                                      : null != l.bodyWithExpiration
                                                        ? y.intl.format(l.bodyWithExpiration, { date: l.endDate })
                                                        : l.body,
                                            }),
                                            null != l.bodyNote &&
                                                (0, r.jsx)(p.D, {
                                                    variant: "heading-sm/medium",
                                                    color: "text-subtle",
                                                    children: y.intl.format(l.bodyNote, {
                                                        partnerName: O.CD[l.partnerId].label,
                                                        helpdeskArticle: E.A.getArticleURL(T.MVz.RECURRING_PROMOTION),
                                                    }),
                                                }),
                                        ],
                    ...
                    c &&
                        (0, r.jsx)("div", {
                            ...
                            children: (0, r.jsx)(C._, {
                                src: l.asset ?? "",
                                className: L.Ys,
                                imageClassName: l.partnerId === O.XY ? L.Cy : void 0,
                                width: 100,
                                height: 100,
                                zoomable: !1,
                            }),
            ...
            m && (0, r.jsx)(B, {}),
            null != g && (0, r.jsx)(Y, { recurrence: { ...l, code: g }, analyticsLocations: h }),
            m &&
                null == g &&
                (0, r.jsx)(F, {
                    children: (0, r.jsx)(H, {
