...
function B() {
    ...
    return {
        [I.XY]: {
            ...
            logos: {
                dark: (0, r.jsx)(s.Fragment, {}, "logitech-logo-dark"),
                light: (0, r.jsx)(s.Fragment, {}, "logitech-logo-light"),
            },
        ...
        [I.KS]: {
            ...
            logos: { dark: (0, r.jsx)(w, {}), light: (0, r.jsx)(O, {}) },
        ...
        [I.Cs]: {
            ...
            logos: { dark: (0, r.jsx)(M, {}), light: (0, r.jsx)(U, {}) },
...
function H(e) {
    let { children: t } = e;
    return (0, r.jsx)("div", { className: D.oP, children: (0, r.jsx)("div", { className: D.t0, children: t }) });
}
let V = (e) => {
    let { recurrence: t, analyticsLocations: i = [] } = e,
        n = (0, r.jsx)(o.r, { color: g.A.colors.CONTROL_CONNECTED_BACKGROUND_DEFAULT }),
        l = (0, r.jsx)("span", {
            className: D.nP,
...
function Z(e) {
    ...
    let i,
        ...
        [v, j] = s.useState(a.code),
        [R, P] = s.useState(!1),
        A =
            ((t = a.partnerId),
            (i = (0, b.bG)([_.A], () => (0, l.M)(_.A.theme))),
    ...
    return (0, r.jsxs)("div", {
        ...
        children: [
                                            ...
                                            (0, r.jsx)(f.D, {
                                                ...
                                                children: R
                                                    ? k.intl.format(k.t.i2EuFO, {
                                                          helpdeskArticle: E.A.getArticleURL(L.MVz.RECURRING_PROMOTION),
                                                      })
                                                    : y
                                                      ? a.body
                                                      : null != a.bodyWithExpiration
                                                        ? k.intl.format(a.bodyWithExpiration, { date: a.endDate })
                                                        : a.body,
                                            }),
                                            null != a.bodyNote &&
                                                (0, r.jsx)(f.D, {
                                                    variant: "heading-sm/medium",
                                                    color: "text-subtle",
                                                    children: k.intl.format(a.bodyNote, {
                                                        partnerName: I.CD[a.partnerId].label,
                                                        helpdeskArticle: E.A.getArticleURL(L.MVz.RECURRING_PROMOTION),
                                                    }),
                                                }),
                                        ],
                    ...
                    d &&
                        (0, r.jsx)("div", {
                            ...
                            children: (0, r.jsx)(x._, {
                                src: a.asset ?? "",
                                className: D.Ys,
                                imageClassName: u || a.partnerId === I.XY ? D.Cy : void 0,
                                width: 100,
                                height: 100,
                                zoomable: !1,
                            }),
            ...
            "footer" === p && g,
            null != v && (0, r.jsx)(V, { recurrence: { ...a, code: v }, analyticsLocations: C }),
            "footer" === p &&
                null == v &&
                (0, r.jsx)(H, {
                    children: (0, r.jsx)(Y, {
