...
class Z extends (r = a.Component) {
    ...
    getButtonState() {
        ...
        return null != r ? r : null != t && t.type === O.vxO.UNINSTALLING ? 'uninstalling' : (0, E.isWeb)() ? 'play' : 'unsupported_os';
    }
    renderPlayButton() {
        ...
        return (0, l.jsxs)('div', {
            ...
            children: [
                ...
                (0, l.jsx)(c.ua7, {
                    text: t,
                    position: o,
                    children: (e) => (0, l.jsx)('div', T({ className: S.disabledButtonOverlay }, e))
                })
            ]
        });
    }
