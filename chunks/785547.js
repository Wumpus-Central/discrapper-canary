...
class Z extends (r = a.Component) {
    ...
    getButtonState() {
        ...
        return null != r ? r : null != t && t.type === j.vxO.UNINSTALLING ? 'uninstalling' : (0, E.isWeb)() ? 'play' : 'unsupported_os';
    }
    renderPlayButton() {
    ...
    renderProgressBar() {
        ...
        let r = n.type === j.vxO.UNINSTALLING ? c.Exd.INDETERMINATE : y.xI(Number(n.progress), Number(n.total));
