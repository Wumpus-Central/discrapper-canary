    ...
    let { status: t, currentStatus: n, description: s } = e,
        {
            ...
            hasButtonStyling: u,
        } = o.Y.useExperiment({ location: "UserProfileAccountPopout" }),
        f = c && t !== h.Skl.ONLINE,
...
function O(e) {
    ...
    return n
        ...
        : f.intl.formatToPlainString(f.t["9OFjSU"], {
              dateString: r
                  ? f.intl.data.formatRelativeTime(1, "day", { numeric: "auto" })
                  : f.intl.data.formatDate(t, { dateStyle: "short" }),
                                          ...
                                          children: [
                                              ...
                                              (0, i.jsxs)("div", {
                                                  ...
                                                  children: [
                                                      ...
                                                      (0, i.jsx)(l.IGR, {
                                                          text: r
                                                              ? f.intl.string(f.t.ApAu9f)
                                                              : p
                                                                ? f.intl.string(f.t.gH3Fra)
                                                                : f.intl.string(f.t["64pl8/"]),
