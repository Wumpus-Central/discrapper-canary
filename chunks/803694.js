...
function y(e) {
    let t,
        ...
        { dropdownPaymentSources: g, giftCardWallet: _ } = l.useMemo(() => {
        ...
        N = l.useMemo(
            () =>
                null != v ? v : p({ giftCardWallet: null, dropdownPaymentSources: g, subscriptionPaymentSourceId: S }),
            [g, S, v],
        ),
