...
function c() {
    ...
    let t = {
        ...
        c = [
            { applicationId: a.J6["0"] },
            { applicationId: a.J6["1"] },
            { applicationId: a.J6["2"] },
            { applicationId: a.J6["3"] },
            { applicationId: a.J6["4"] },
            { applicationId: a.J6["5"] },
            { applicationId: a.J6["6"] },
        ],
        s = [
            { applicationId: a.J6["14"] },
            { applicationId: a.J6["15"] },
            { applicationId: a.J6["16"] },
            { applicationId: a.J6["17"] },
            { applicationId: a.J6["18"] },
            { applicationId: a.J6["19"] },
            { applicationId: a.J6["20"] },
        ];
    return [
        {
            id: "1",
