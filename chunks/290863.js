...
function C(e) {
    if ((delete p[e], delete m[e], delete g[e], delete A[e], delete I[e], null == h[e])) return;
...
function L(e) {
    ...
    if (u) d[t] = { status: r, clientStatus: s, activities: E, hiddenActivities: E, processedAtTimestamp: l };
    else {
        let e = a.length > 1 ? [...a].sort(O) : a,
            n = b(o ?? []),
            u = d[t];
        (a = null != u && i()(u.activities, e) ? u.activities : e),
            (d[t] = { status: r, clientStatus: s, activities: a, hiddenActivities: n, processedAtTimestamp: l });
    }
    return delete T[n], C(n), !0;
}
function w(e) {
    let {
        guildId: t,
...
function M(e, t) {
    ...
    delete n[e], 0 === Object.keys(n).length && delete h[t], C(t);
}
function P(e) {
    for (let t of d.default.keys(h)) M(e, t);
}
class U extends o.Ay.Store {
    ...
    setCurrentUserOnConnectionOpen(e, t) {
        (p[c.default.getId()] = e), v(c.default.getId(), [...t].sort(O));
    }
    getStatus(e) {
        let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null,
            n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : f.clD.OFFLINE,
            r = _.default.getUser(e);
        if ((null != r && r.hasFlag(f.nhx.BOT_HTTP_INTERACTIONS) && (n = f.clD.UNKNOWN), null == t)) return p[e] ?? n;
        let i = S(e, t);
        return i?.status ?? n;
    }
    getActivities(e) {
        let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null;
        if (null == t) return g[e] ?? E;
        let n = S(e, t);
        return null == n || null == n.activities ? E : R(n.activities);
    }
    getUnfilteredActivities(e) {
        let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null;
        if (null == t) return m[e] ?? E;
        let n = S(e, t);
        return null == n || null == n.activities ? E : n.activities;
    }
    getHiddenActivities(e) {
        let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null;
        return null == t ? (A[e] ?? E) : (S(e, t)?.hiddenActivities ?? E);
    }
...
let k = new U(l.h, {
    ...
    SELF_PRESENCE_STORE_UPDATE: function (e) {
        ...
        if (p[t] === e.status && m[t] === e.activities && A[t] === e.hiddenActivities) return !1;
        (p[t] = e.status), v(t, [...e.activities].sort(O)), (A[t] = [...e.hiddenActivities].sort(O)), delete T[t];
    },
});
