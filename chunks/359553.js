...
class c {
    ...
    constructor(e = 500, t = null, r = !0) {
        ...
        (this.min = e), (this.max = null != t ? t : 10 * e), (this.jitter = r), (this._current = e);
    }
    get fails() {
        return this._fails;
    }
    ...
    fail(e, t) {
        ...
        this.jitter && (r *= Math.random()), (this._current = Math.min(this._current + r, this.max));
...
class g {
    ...
    logDangerously = (() => {
        ...
        return function (t) {
            ...
            h(e.name, "log", t, ...n), e.nativeLoggerEnabled && b?.(e.name, "log", t, ...n);
        };
    })();
    log = (() => {
        var e = this;
        return function (t) {
            for (var r = arguments.length, n = Array(r > 1 ? r - 1 : 0), o = 1; o < r; o++) n[o - 1] = arguments[o];
            f(t, ...n), h(e.name, "log", t, ...n), e.nativeLoggerEnabled && b?.(e.name, "log", t, ...n);
        };
    })();
    verboseDangerously = (() => {
        var e = this;
        return function (t) {
            for (var r = arguments.length, n = Array(r > 1 ? r - 1 : 0), o = 1; o < r; o++) n[o - 1] = arguments[o];
            h(e.name, "debug", t, ...n), e.nativeLoggerEnabled && b?.(e.name, "debug", t, ...n);
        };
    })();
    verbose = (() => {
        var e = this;
        return function (t) {
            for (var r = arguments.length, n = Array(r > 1 ? r - 1 : 0), o = 1; o < r; o++) n[o - 1] = arguments[o];
            f(t, ...n), h(e.name, "debug", t, ...n), e.nativeLoggerEnabled && b?.(e.name, "debug", t, ...n);
        };
    })();
    info = (() => {
        var e = this;
        return function (t) {
            for (var r = arguments.length, n = Array(r > 1 ? r - 1 : 0), o = 1; o < r; o++) n[o - 1] = arguments[o];
            f(t, ...n), h(e.name, "info", t, ...n), e.nativeLoggerEnabled && b?.(e.name, "info", t, ...n);
        };
    })();
    warn = (() => {
        var e = this;
        return function (t) {
            for (var r = arguments.length, n = Array(r > 1 ? r - 1 : 0), o = 1; o < r; o++) n[o - 1] = arguments[o];
            f(t, ...n), h(e.name, "warn", t, ...n), e.nativeLoggerEnabled && b?.(e.name, "warn", t, ...n);
        };
    })();
    error = (() => {
        var e = this;
        return function (t) {
            for (var r = arguments.length, n = Array(r > 1 ? r - 1 : 0), o = 1; o < r; o++) n[o - 1] = arguments[o];
            f(t, ...n), h(e.name, "error", t, ...n), e.nativeLoggerEnabled && b?.(e.name, "error", t, ...n);
        };
    })();
    trace = (() => {
        var e = this;
        return function (t) {
            for (var r = arguments.length, n = Array(r > 1 ? r - 1 : 0), o = 1; o < r; o++) n[o - 1] = arguments[o];
            h(e.name, "trace", t, ...n), e.nativeLoggerEnabled && b?.(e.name, "trace", t, ...n);
        };
    })();
    time = (e, t) => {
        let r = Date.now(),
    ...
    fileOnly = (() => {
        ...
        return function (t) {
            for (var r = arguments.length, n = Array(r > 1 ? r - 1 : 0), o = 1; o < r; o++) n[o - 1] = arguments[o];
            h(e.name, "file-only", t, ...n), e.nativeLoggerEnabled && b?.(e.name, "file-only", t, ...n);
        };
    })();
}
let m = "_errors";
...
class w extends Error {
    ...
    headers;
    retryAfter;
    constructor({ method: e, url: t, ok: r, status: n, body: o, text: a, headers: l, retryAfter: i }, ...s) {
...
function x(e, t, r, n, o) {
    ...
    if (
        ...
        null != t.reason && a.set("X-Audit-Log-Reason", encodeURIComponent(t.reason)),
    ...
    null != t.retried && 0 !== t.retried && a.set("X-Failed-Requests", `${t.retried}`),
    ...
    a.ok((e) => null != e.status),
        a.then(
            (a) => {
                if (null != t.retries && t.retries-- > 0 && v.has(a.status)) return l();
                let s = {
                    ok: a.ok,
                    headers: a.headers,
                    body: a.body,
                ...
                let u = !1,
                    d = (a, l) => {
                        let i = { ...t, headers: { ...t.headers, ...a }, interceptResponse: l };
                        (u = !0), x(e, i, r, n, o);
                    },
                    c = (e) => {
                            ...
                            null != e &&
                                (s.body = (function (e) {
                                    ...
                                    for (let r in e) {
                                        ...
                                        if (
                                            null == n ||
                                            (r === m && (t._misc = e[r].map((e) => e.message)), Array.isArray(n))
                                        )
                                            continue;
                                        let o = n[m];
                                        null != o ? (t[r] = o.map((e) => e.message)) : (t[r] = [Object.keys(n)[0]]);
                                    }
                                    return t;
                                })(e));
                        }
        ...
        t.signal?.aborted ? a.abort() : t.signal?.addEventListener("abort", () => a.abort(), { once: !0 });
}
let k = new Map();
function A(e) {
    let t = k.get(e);
    ...
    let r = t.queue.shift();
    if (null == r) {
        y.verbose("rateLimitExpirationHandler: removing key for", e), k.delete(e);
        return;
    }
    y.verbose("rateLimitExpirationHandler: moving to next record for ", e), r();
}
function L(e, t) {
    var r;
    let n = k.get(e.url);
    if (null != t && ((r = t.status), E.has(r))) {
        ...
        if (null != n && n.retryAfterTimestamp >= l)
            return void y.verbose("cleanupRequestEntry: already has rate limit for ", e.url);
        null != n && (y.verbose("cleanupRequestEntry: extending rate limit for ", e.url), clearTimeout(n.timeoutId)),
            y.verbose(`cleanupRequestEntry: rate limit for ${e.url} retry after ${a}ms`);
        ...
        null != n &&
            ...
            (y.verbose("cleanupRequestEntry: rate limit for ", e.url, "expired"), A(e.url));
}
function R(e, t, r) {
    return new Promise((n, o) => {
        ...
        if (null != a && t.failImmediatelyWhenRateLimited) {
            ...
            return (
                ...
                void (o((t = { status: a.status, body: { message: a.latestErrorMessage, retry_after: e } })),
                null != r && r({ ok: !0, hasErr: !1, status: t.status, body: t.body, text: "", headers: {} }))
            );
        }
        null != a
            ? (y.verbose("makeRequest: queueing request for ", t.url), a.queue.push(x.bind(null, e, t, n, o, r)))
            : x(e, t, n, o, r);
    });
}
R.bind(null, "get"),
    ...
    j = (function (e) {
        ...
        return () => {
            ...
            return (
                ...
                !!(n.budgetUsed < t) && (n.budgetUsed++, !!(o.budgetUsed < r)) && (o.budgetUsed++, !0)
            );
        };
    ...
    n.Ts({
        ...
        beforeSend: function (e, t) {
            ...
            if (
                ...
                T.some((e) => window.navigator.appVersion.toLowerCase().indexOf(e) >= 0) ||
