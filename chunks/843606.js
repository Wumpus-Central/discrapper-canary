...
let f = ["#ffb84b", "#ffe361", "#f0f0f0"],
    ...
    D = (A) => {
        ...
        return (0, g.jsxs)("svg", {
            ...
            children: [
                (0, g.jsx)("path", { d: "M11 1v1h-1v1H9v1H8v1H7v2H6v1h2v2h1V9h2V8h1V7h1V6h1V5h1V1h-4Z", fill: a[1] }),
                (0, g.jsx)("path", { d: "M3 9h1v1h2v2h1v1h2v1h2v-2H9v-1H8v-1H7V9H6V8H5V7H4V5H2v2h1v2Z", fill: s[1] }),
                (0, g.jsx)("path", { d: "M5 11H3v2h2v-2ZM3 13H1v2h2v-2Z", fill: s[1] }),
                (0, g.jsx)("path", {
                ...
                (0, g.jsx)("path", { d: "M15 1h-1v4h1V1Z", fill: a[0] }),
                (0, g.jsx)("path", { d: "M1 13H0v2h1v-2ZM11 14H9v1h2v-1ZM9 13H7v1h2v-1Z", fill: "#000" }),
                (0, g.jsx)("path", { d: "M5 12H3v1h2v-1ZM3 14H1v1h2v-1Z", fill: s[0] }),
                (0, g.jsx)("path", {
                ...
                (0, g.jsx)("path", { d: "M7 7H6v1h1V7Z", fill: a[2] }),
                (0, g.jsx)("path", {
                ...
                (0, g.jsx)("path", { d: "M8 5H7v1h3V5H9V4H8v1ZM10 2v1H9v1h3V3h-1V2h-1ZM14 1h-3v1h3V1Z", fill: a[2] }),
                (0, g.jsx)("path", {
                    d: "M14 5h-1v1h1V5ZM13 6h-1v1h1V6ZM12 7h-1v1h1V7ZM11 8h-1v1h1V8ZM9 9H8v1h1V9Z",
                    fill: a[0],
                }),
                (0, g.jsx)("path", { d: "M4 5H3v1h1V5ZM4 11H3v1h1v-1ZM2 13H1v1h1v-1Z", fill: s[2] }),
            ],
        });
    };
