                          ...
                          balanceHook: () =>
                              (0, i.jsxs)(
                                  k,
                                  {
                                      questId: t.id,
                                      children: [
                                          (0, i.jsx)(m.A, { shouldUseThemeColor: !0, className: M.Kq, customSize: 14 }),
                                          J,
                                      ],
                                  },
                                  t.id,
...
let k = r.memo(function (e) {
    ...
    return (0, i.jsx)(
        d.EYj,
        { variant: "text-md/semibold", color: "text-strong", tag: "span", className: M.wx, children: n },
        `${t}_reward`,
    );
});
function O(e) {
