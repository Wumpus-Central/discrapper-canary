...
function ea(e) {
    let {
        ...
        E = (0, r.yK)([z.A], () => (null != m ? z.A.getViewerIds(m) : [])),
        x = (0, C.A)({ userId: l.id, context: A }),
        y = (0, r.bG)([F.A], () => F.A.isPrioritySpeaker(l.id, A)),
        v = (0, r.bG)([z.A], () => null != z.A.getStreamForUser(l.id, f)),
        S = s.useMemo(() => null != m && m.ownerId !== l.id && E.includes(l.id), [m, l.id, E]);
    if (c === en.f5z.ONLY_WHILE_SPEAKING && n && !x) return null;
    let { mute: I, selfMute: N, suppress: T, deaf: b, selfDeaf: O } = _;
    return (0, i.jsx)(U.Ay, {
        guildId: f,
        onClick: n ? void 0 : (e) => h?.(e, l),
        onContextMenu: n ? void 0 : (e) => p?.(e, l),
        className: a()(el.TX, { [el.zj]: !x, [el.bG]: !n }),
        user: l,
        nick: o,
        speaking: !1,
        flipped: t,
        ...
        userNameClassName: a()(el.Xh, {
            [el.xt]: n,
            [el.R]: n && (d === en.pwA.NEVER || (!x && d === en.pwA.ONLY_WHILE_SPEAKING)),
        }),
    });
}
class er extends s.PureComponent {
    ...
    renderStreamerSettings() {
        ...
        let { sanitizedTitle: u, title: h } = (0, j.A)(r);
