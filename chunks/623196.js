...
function E() {
    ...
    let j = (0, m.$6)(t, e) || n,
        C = null != t && a()().diff(a()(t.created_at), 'days') < _.eBq,
        O = j && C,
        S = () => {
            x({
                header: b.NW.string(b.t.jxXMEx),
                body: b.NW.format(b.t.fSv59f, { helpdeskArticle: u.Z.getArticleURL(_.BhN.GDPR_PACKAGE_CONTENTS) }),
                    ...
                    E(!0),
                        (0, g.h)(e)
                            .then(
                                (e) => {
                                    null != e && null != e.body
                                        ? c.Z.show({ body: b.NW.string(b.t['6Nmv4u']) })
                                        : c.Z.show({
    ...
    return (0, r.jsxs)(h.U, {
        ...
        children: [
            (0, r.jsx)(h.H, {
                ...
                description: b.NW.format(b.t.P3kNfn, { helpdeskArticle: u.Z.getArticleURL(_.BhN.GDPR_REQUEST_DATA) })
            }),
            O
                ? (0, r.jsx)(o.Zbd, {
                      className: N.card,
                      children: (0, r.jsx)(o.Text, {
                          ...
                          children: b.NW.format(b.t.RNDlV1, { date: a()(t.created_at).add(_.eBq, 'days').format('MMMM Do YYYY') })
                      })
                  })
                : (0, r.jsx)('div', {
                      className: N.button,
