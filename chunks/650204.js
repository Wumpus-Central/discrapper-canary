...
var k = n(857192),
    ...
    B = n(70956),
    F = n(378799);
k.default.cssDebuggingEnabled && n.e('34600').then(n.bind(n, 671996)), (0, M.ZP)(), (0, F.s5)();
...
if (((0, R.O)(window), __OVERLAY__)) K(p.Z.Overlay);
    ...
    if ((document.addEventListener('scroll', (e) => e.preventDefault()), N.isPlatformEmbedded)) {
        ...
        S.ZP.on('MAIN_WINDOW_BLUR', () => {
            e.delay(), S.ZP.setFocused(!1), (0, P.T_)(window, !1);
        }),
            S.ZP.on('MAIN_WINDOW_FOCUS', () => {
                e.cancel(), S.ZP.setFocused(!0), (0, P.T_)(window, !0);
            }),
