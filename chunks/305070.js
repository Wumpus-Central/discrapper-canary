...
let G = i.forwardRef(function (e, t) {
    let { channel: n, type: s, editorHeight: G, onVisibilityChange: F, editorScrollerRef: B, barsHeight: H } = e,
        ...
        [Z, q, J] = (function (e, t, n) {
            let { channel: l, type: s } = e,
                ...
                { canMentionEveryone: d, hidePersonalInformation: h } = (0, o.cf)(
                    ...
                    () => ({
                        canMentionEveryone:
                            l.isPrivate() || u || s === b.oU.RULES_INPUT || j.A.can(O.xBc.MENTION_EVERYONE, l),
                ...
                g = (function (e) {
                    let { navId: t, scrollerRef: n, state: l, onFocus: s } = e,
                        { renderWindow: a } = i.useContext(M.Ay),
                        r = (e, t, i) => {
        ...
        X = (0, p.aI)(Z.selectedIndex);
    (0, f.gf)(W, Z.isVisible, X);
    let $ = (0, E.l)({ editorHeight: G, type: s, state: Z }),
        Q = (0, o.bG)([h.Ay], () => {
        ...
        ee = i.useMemo(
            () =>
                $?.top == null && $?.left == null && $?.bottom == null && $?.right == null ? "" : String(Date.now()),
    ...
    let en = { [V.pK]: null == $, [V.YB]: null != $, [V.sQ]: null == $ && "bottom" === e.position, [V.mO]: Q },
        el = 490;
    null != $ && (el = s.autocomplete?.small ? 200 : Z.query?.type === A.DB.EMOJIS_AND_STICKERS ? 490 : 245);
