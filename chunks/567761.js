        ...
        if (null != t && s - t < b) {
            ...
            if (
                ...
                Promise.resolve()
                    ...
                    .then((n) => {
                        let { default: i } = n;
                        N.default.track(L.HAw.REPLY_NUDGE_DISMISSED, {
                            channel_id: e,
                            channel_type: t?.type,
                            guild_id: t?.guild_id,
                            dismiss_method: g,
...
class j extends l.Ay.PersistedStore {
    ...
    initialize(e) {
        (x = e?.nudgedChannels ?? {}),
            this.waitFor(p.A, A.default, I.A, T.Ay, S.A, y.A, E.A, C.Ay, g.A),
...
function q(e) {
    ...
    return {
        channelId: e.id,
        lastMessageId: t,
        isFavorite: C.Ay.isMessagesFavorite(e.id),
        isRequest: _.A.isMessageRequest(e.id) || h.A.isSpam(e.id),
        nudgeTimestamp: H.getNudgeDMTimestamp(e.id),
    };
}
function Z() {
    z.clear(),
...
class J extends l.Ay.Store {
    ...
    initialize() {
        this.waitFor(I.A, W.A, _.A, T.Ay, h.A, C.Ay, K.default, H), this.syncWith([C.Ay, _.A, H], Z);
    }
