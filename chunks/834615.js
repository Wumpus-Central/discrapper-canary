...
function W(e) {
    let { quest: t } = e,
        ...
        r = (0, v.S5)(t.config.rewardsConfig.rewardsExpireAt),
        s = (0, l.bG)([A.A], () => A.A.getState().theme),
        a = (0, u.M)(s) ? j.NJ8.DARK : j.NJ8.LIGHT,
            ...
            (0, i.jsxs)("div", {
                ...
                children: [
                    (0, i.jsx)(c.D, {
                        ...
                        color: "text-strong",
                        children: o
                            ? H.intl.string(H.t.XBboAK)
                            : H.intl.formatToPlainString(H.t.EQa7os, { questName: t.config.messages.questName }),
                    }),
                    (0, i.jsx)(d.E, {
                        variant: "text-xs/normal",
                        color: "text-default",
                        children: o
                            ? H.intl.formatToPlainString(H.t.APddvF, { expirationDate: r })
                            : H.intl.formatToPlainString(H.t["pX+fmn"], { expirationDate: n }),
                    }),
                ],
            }),
        ],
...
function K(e) {
    let { nodeRef: t, quest: n } = e,
        ...
        R = r.useCallback(() => A(!0), []),
        M = r.useCallback(() => A(!1), []),
        { launchInGameActivity: j } = (0, v.zW)(n),
        K = C.t.useConfig({ location: B.rE.ACTIVITY_PANEL }),
        $ = (0, k.Pd)(n),
        z = r.useCallback((e) => {
            e.stopPropagation();
        }, []),
        ...
        en = (0, w.vA)(n),
        ei = (0, N.NA)({ quest: n }),
        er = en ? ei : H.intl.string(H.t.l7E81v);
    return (0, i.jsxs)("div", {
        ref: (e) => {
            t.current = e;
        },
                ...
                children: [
                    !J &&
                        (0, i.jsxs)(f.e, {
                            ...
                            fullWidth: !0,
                            children: [
                                (0, i.jsx)(p.$, { variant: "secondary", text: H.intl.string(H.t.LLLLPD), onClick: X }),
                                K.enabled &&
                                $ === k.UA.UNENROLLED &&
