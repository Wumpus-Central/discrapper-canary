...
class c extends o.i {
                        ...
                        () => {
                            c.clearPersistQueue(e),
                                c.allPersistKeys.forEach((t) => {
                                    c.shouldClear(e, t) && s.w.remove(t);
                                }),
    ...
    static migrateAndReadStoreState(e, t) {
        if (null != u && c.shouldClear(u, e)) return s.w.remove(e), { state: void 0, requiresPersist: !1 };
        let { _state: n, _version: r, ...i } = (null != c._clearAllPromise ? null : s.w.get(e)) ?? l,
            a = null == t ? 0 : t.length;
        if (0 !== a && r !== a && null != t) {
            let e = r ?? 0,
                s = n;
            for (null == r && (s = i); e < a; ) (s = (0, t[e])(s)), e++;
