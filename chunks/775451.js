...
let S = {
    ...
    b = (e) => {
            ...
            { shouldOpen: U } = (0, h.Mm)({
                renderEarnedOrbsCoachmark: (e) => {
                    ...
                    (t = {
                        ...
                        onClickPill: () => {},
                        linkOnClick: () => {
                            (0, g.navigateToQuestHome)(T.dr.VIRTUAL_CURRENCY_EARNED_ORBS_COACHMARK, o.j.ACTIVITY_PANEL);
                        },
                        ctaOnClick: () => {
        ...
        return (
            s.useEffect(() => {
                y(Z ? _.b.SELECTED : _.b.DEFAULT);
            }, [Z, y]),
            s.useEffect(() => {
                v && ((0, h.wH)() || U ? (B(!0), k(!1)) : B(!1));
            }, [v, U]),
            (0, i.jsxs)('div', {
