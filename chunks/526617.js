...
function ef(e) {
    let { guildId: t, channel: a, containerWidth: d, onClose: g, onSelect: I, shouldValidateSelectedSound: P = !1, suppressPlaySound: z = !1, shouldShowUpsell: Q = !0, gridNotice: J, soundButtonOverlay: ef, listPadding: e_, renderHeader: ep, defaultSoundsOnly: eh = !1, inExpressionPicker: em, refreshEnabled: eg, analyticsSource: eE } = e,
        ...
        ew = null != eP && '' !== eP,
        eD = (0, m.Dt)(),
        { categories: eL, allSounds: ex, soundCounts: eM } = (0, G.ZP)(a, {}, eh),
        [ek, ej] = i.useState([]),
        [eU, eG] = i.useState(!1),
        eB = (0, G.FS)(eL, ek, eP).filter((e) => e.items.length > 0),
        eV = eB.some((e) => !!(0, D._O)(e.categoryInfo) && e.categoryInfo.isNitroLocked),
        eF = !eN && Q && eV,
        eZ = A.T4.useSetting(),
        ...
        eQ = i.useCallback(
            ...
            [eB, Q, eN, t, z, eq, a, eY, eW, eR, ey, ef, eF, eg, em]
        ),
        eX = i.useCallback(
            (e, t) => {
                if (e <= 0 || !Q) return !1;
        ...
        e1 = i.useCallback(
            (e, t) => {
                let n = t === eB.length - 1;
                return eF && n ? (0, r.jsx)('div', { className: K.sectionFooter }) : null;
            },
            [eB, eF]
        ),
