...
function ef(e) {
    let {
        ...
        eP = null != eR && "" !== eR,
        ew = (0, m.Dt)(),
        eD = x.C.useExperiment({ location: "SoundboardSoundGrid" }),
        ...
        eX = i.useCallback(
            ...
            [eB, J, eA, t, X, eq, a, eY, eW, eN, eb, ef, eV, em],
        ),
        eQ = i.useCallback(
            (e, t) => {
                if (e <= 0 || !J) return !1;
        ...
        e4 = i.useCallback((e) => ek((0, G.cK)(e, Array.from(eL.values()).flat(), eS, a, eb)), [a, eS, eL, eb]),
        e8 = i.useCallback(
            (e) => {
                (0, u.jW)(e, async () => {
        ...
        tn = (0, l.e7)([C.Z], () => C.Z.getMediaSessionId());
    return (
        (0, h.Z)({
