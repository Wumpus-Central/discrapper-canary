...
function F(e) {
    ...
    let J = (0, I.yU)();
    return (
        (r = Q ? D.NW.string(D.t['5UKyUl']) : f ? D.NW.format(D.t['9sWQNT'], { usernameHook: () => (0, i.jsx)('span', { children: null != F && '' !== F.trim() ? F : C.globalName }) }) : q ? D.NW.string(D.t['e/6Ogo']) : D.NW.format(D.t.QD7BDA, { guildName: t })),
        (0, i.jsx)(_.Gt, {
            value: V,
