    ...
    handleRequest(e, t) {
        ...
        if ("/rpc" === n && ("GET" === r || s)) {
            let n = new URLSearchParams(i),
                r = s ? C(e.headers)["content-type"].split("/")[1] : "json",
                a = function () {
                ...
                o = new b(!s ? a : v.bind(null, e, t), !s ? a : R.bind(null, e, t, 400), Number(n.get("v")), r);
            s
                ? (0, E.j7)(o, C(e.headers).origin, n.get("client_id"))
                      .then(() => {
                          let n = "";
                          e.on("data", (e) => (n += e)),
