...
class O extends p.A {
    ...
    send(e) {
        (c.default.isLoggingOverlayEvents || (e.cmd !== g.e$_.OVERLAY && e.evt !== g.ZE4.OVERLAY)) &&
            S.info(`Socket Emit: ${this.id}`, (0, f.A)(e)),
...
class D extends s.EventEmitter {
    constructor() {
        ...
        (r = I.http.createServer()).on("error", (t) => {
            S.error(`Error: ${t.message}`),
                ("EADDRINUSE" === t.code || t.message.includes("EADDRINUSE")) && setTimeout(() => v(++e), 1e3);
        }),
    ...
    handleRequest(e, t) {
        let [n, i] = N(e.url).split("?"),
            r = N(e.method);
        if ("/rpc" === n && "OPTIONS" === r) return void C(e, t, { body: "" });
        let s = "POST" === r;
        if ("/rpc" === n && ("GET" === r || s)) {
            let n = new URLSearchParams(i),
                r = s ? N(e.headers)["content-type"].split("/")[1] : "json",
                a = function () {
                ...
                o = new b(!s ? a : C.bind(null, e, t), !s ? a : R.bind(null, e, t, 400), Number(n.get("v")), r);
            s
                ? (0, E.j7)(o, N(e.headers).origin, n.get("client_id"))
                      .then(() => {
                          let n = "";
                          e.on("data", (e) => (n += e)),
    ...
    handleConnection(e) {
        ...
        try {
            t = new O(e, Number(n.get("v")), n.get("encoding") ?? "json");
        } catch (t) {
        ...
        S.info(`Socket Opened: ${t.id}`),
            ...
            (0, E.j7)(t, i, n.get("client_id"))
                .then(() => {
                    y.push(t), e.on("message", (e) => this.handleMessage(t, e)), this.emit("connect", t);
                })
                .catch((e) => {
    ...
    handleMessage(e, t) {
        ...
        (c.default.isLoggingOverlayEvents || n.cmd !== g.e$_.OVERLAY) && S.info(`Socket Message: ${e.id}`, (0, f.A)(n)),
