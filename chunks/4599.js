...
function N(e) {
    let { user: n, guildId: t, channelId: N, messageId: O, roleId: C, transitionState: P, openedAt: T, onHide: w, showGuildProfile: S = !0, sourceAnalyticsLocations: E = [] } = e,
        ...
        F = c.useRef(null),
        U = (0, i.e7)([s.default], () => ['en-US', 'en-GB'].includes(s.default.locale)) ? Z.intl.formatToPlainString(Z.t.KRe1Fh, { name: k }) : Z.intl.string(Z.t['3N/J2t']);
    return (0, o.jsx)(d.Gt, {
        value: D,
                                    ...
                                    (0, o.jsxs)('div', {
                                        ...
                                        children: [
                                            ...
                                            (0, o.jsx)(a.Text, {
                                                ...
                                                color: 'header-primary',
                                                children: Z.intl.format(L ? Z.t['8F+WNz'] : Z.t['/cZp5u'], { username: k })
                                            })
                                        ]
                                    }),
                                    (0, o.jsx)('div', {
