...
class w extends i.PureComponent {
    ...
    validNavigation() {
        ...
        return null != n && n.stores.some((e) => e.showNotice() && !(null != e.canCloseEarly && e.canCloseEarly()))
            ? (p.S.dispatch(_.CkL.SHAKE_APP, {
                  duration: 300,
                  intensity: this._intensity
              }),
              (this._intensity = Math.min(this._intensity + E, x)),
              p.S.dispatch(_.CkL.EMPHASIZE_NOTICE),
              !1)
            : ((this._intensity = j), !0);
    }
    renderSidebar(e) {
        ...
        return (0, r.jsx)(u.ZP, {
            ...
            children: (t) => {
                ...
                return (0, r.jsxs)(l.njP, {
                    ...
                    'aria-label': n,
                    children: [
                        i ? (0, r.jsx)(f.Z, { style: v.searchBar }) : null,
                        e.map((e, t) => {
    ...
    constructor(...e) {
        super(...e),
            ...
            O(this, 'state', S(y({}, C), { sidebarOpen: this.props.section !== _.oAB.SUBSCRIPTIONS && this.props.section !== _.oAB.PROFILE_CUSTOMIZATION })),
                ...
                let { onSetSection: t, sections: n } = this.props,
                    ...
                    s = () => {
                        ...
                        null != s &&
                            ...
                            this.setState(S(y({}, C), { sidebarOpen: !1 }));
                    };
                ...
                i === _.oAB.ACCOUNT && this.props.isEligibleForPomelo
                    ...
                    : null != e.decoration
                      ...
                      : null != n && (null == b ? void 0 : b.includes(n)) && !t
                        ? (O = null != g ? g : (0, r.jsx)(l.IGR, { text: h.intl.string(h.t.y2b7CA) }))
                        : null != f
                          ? (O = f)
