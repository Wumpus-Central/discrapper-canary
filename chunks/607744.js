...
function b(e) {
    ...
    r.isPhoneVerified() ||
        r.isStaff() ||
        ((O = n.verificationLevel >= _.sFg.LOW && !r.verified),
        (v = n.verificationLevel >= _.sFg.VERY_HIGH),
        (I = n.verificationLevel >= _.sFg.MEDIUM && h > 0),
        (T = n.verificationLevel >= _.sFg.HIGH && m > 0));
    let S = [];
    T && S.push(m),
        I && S.push(h),
        S.length > 0 &&
