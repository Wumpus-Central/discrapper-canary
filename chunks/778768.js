...
function X(e) {
    let { channel: t, onHoverOrFocus: s, setPopoutRef: r, closePopout: c } = e,
        ...
        g = (0, O.A)(u),
        f = (0, F.kt)({ channel: t }),
        { enabled: E } = D.A.useExperiment({ guildId: t.guild_id, location: "VoiceInviteSuggestionsPopover" }),
...
function Q(e) {
    let { channel: t, user: n, ringingEnabled: s } = e,
        ...
        { activityStatusText: J, activityStatusIcon: $ } = l.useMemo(() => {
            let e = Z.find((e) => e.type !== p.$pd.CUSTOM_STATUS && e.type !== p.$pd.HANG_STATUS);
                ...
                children: [
                    ...
                    (eA || eh) &&
                        (0, i.jsxs)("div", {
                            ...
                            children: [
                                eA
                                    ? (0, i.jsx)(M.A, { size: "custom", color: en, channel: ee, className: Y.RI })
                                    : null != $
