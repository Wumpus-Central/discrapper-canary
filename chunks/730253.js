...
function X(e) {
    let t,
        ...
        eo = (0, s.Vd)("favorites"),
        { favoriteAdded: ed, clearFavoriteAdded: ec } = (0, D.CJ)(),
        eu = l.useRef(null),
        ...
        eE = (0, a.bG)([j.A], () => j.A.getChannelId(V.YYv)),
        ex = (0, a.bG)([y.A], () => y.A.getChannel(eE)),
        eI = (0, S.A)((e) => e.guildId),
        eC = (0, U.ai)(eI),
        { badge: eb, unread: eN } = (0, P.A)(ef),
        eS =
            ((X = null != (t = (0, a.bG)([j.A], () => j.A.getVoiceChannelId())) && null != ef[t]),
            (Q = (0, a.bG)([T.A], () => {
                if (!X) return !1;
                let e = T.A.getCurrentUserActiveStream();
                return null != e && null != ef[e.channelId];
            })),
            (Z = (0, a.bG)([T.A], () => T.A.getAllApplicationStreams().some((e) => null != ef[e.channelId]))),
            (J = (0, a.bG)([R.A], () => X && null != t && R.A.hasVideo(t), [X, t])),
            ($ = (0, a.yK)([g.Ay], () =>
            ...
            (el = !1),
            (es = !1),
            X ? ((en = !J), (ei = J), (el = Q), (es = ee)) : ((el = Z), (es = et)),
            (0, C.oi)({
                audio: en,
                video: ei,
                screenshare: el,
        ...
        eT = l.useRef(!1),
        { hasAccess: ey } = (0, D.TW)("FavoritesButton"),
        ej = l.useCallback(
            (e, t) => {
                (eT.current = !0), er(e, t);
            },
    ...
    return (
        ...
        l.useEffect(
            () => () => {
                ea && !eT.current && ej(H.i.AUTO_DISMISS, !0);
            },
            [ej, ea],
        ),
        l.useEffect(() => {
            ...
            children: [
                ...
                ea &&
                    (0, i.jsx)(r.A, {
                        ...
                        onRequestClose: () => ej(H.i.USER_DISMISS),
                        actions: [
                            {
                                icon: _.t,
