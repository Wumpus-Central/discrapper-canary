...
class T extends i.Z {
    ...
    getActivelyProgressingPlayOnDesktopQuestIds() {
        ...
        for (let t of r)
            for (let r of n.values()) I(r) && (0, _.Nj)({ quest: r }) && r.config.application.id === t && e.add(r.id);
    ...
    getActivelyProgressingStreamOnDesktopQuestIds() {
        ...
        let r = n.id;
        if (null == r) return e;
        for (let t of h.Z.quests.values())
            I(t) && (0, _.Dr)({ quest: t }) && t.config.application.id === r && e.add(t.id);
    ...
    constructor(...e) {
        super(...e),
            ...
            E(this, "calculateHeartbeatDurationMs", (e) => {
                ...
                let { progressSeconds: n, targetSeconds: i } = (0, _.il)(t, r.T.DESKTOP),
            ...
            E(this, "initiateHeartbeat", (e, t) => {
                ...
                if (n.has(e))
                    return void v.log("~ initiateHeartbeat -> Heartbeat already initiated for questId: ".concat(e));
                let i = () => {
            ...
            E(this, "terminateHeartbeat", (e, t) => {
                let n = this.heartbeats[t],
                    ...
                    i = n.get(e);
                if (null != i) {
                    v.log("~ terminateHeartbeat -> Terminating heartbeat for questId: ".concat(e)),
            ...
            E(this, "handleSendHeartbeatSuccess", (e) => {
                ...
                if (
                    (v.log("~ handleSendHeartbeatSuccess -> Heartbeat succeeded for questId: ".concat(t, ")")),
                    null != n.completedAt)
                )
                    for (let e of (v.log(
