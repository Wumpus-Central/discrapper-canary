...
let P = null != navigator.mediaDevices && null != navigator.mediaDevices.enumerateDevices,
    k = P && "setSinkId" in HTMLAudioElement.prototype;
function M(e) {
    return { id: w.dx, type: e, index: 0, name: "Default" };
}
function U() {
    return {
        [w.oh.AUDIO_INPUT]: [M(w.oh.AUDIO_INPUT)],
        [w.oh.AUDIO_OUTPUT]: [M(w.oh.AUDIO_OUTPUT)],
        [w.oh.VIDEO_INPUT]: [M(w.oh.VIDEO_INPUT)],
    };
}
function x(e, t) {
    return {
...
async function G() {
    ...
    try {
        let e = await navigator.mediaDevices.enumerateDevices(),
            { [w.oh.AUDIO_INPUT]: t = [], [w.oh.AUDIO_OUTPUT]: n = [], [w.oh.VIDEO_INPUT]: i = [] } = b()(e, "kind"),
            [r, s, a] = [t, n, i].map((e) => e.map(x));
        return { [w.oh.AUDIO_INPUT]: r, [w.oh.AUDIO_OUTPUT]: k ? s : [M(w.oh.AUDIO_OUTPUT)], [w.oh.VIDEO_INPUT]: a };
    } catch {
        return U();
    }
}
...
class eo {
    ...
    static getCalculatorOrCreate(e, t, n, i) {
        let r = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 0,
            s = e[t.ssrc];
        return null == s && ((s = new e_(n, i, r)), (e[t.ssrc] = s)), s;
    }
...
class em extends S.A {
    ...
    async getStats() {
            ...
            for (let e of l) {
                ...
                if ("audio" === e.kind) _.push({ ...i, type: "audio" });
                    ...
                    _.push({
                        ...
                        qpSum: e.qpSum,
                        averageEncodeTime:
                            null == e.framesEncoded || null === (u = e.totalEncodeTime) || 0 === u
                                ? void 0
                ...
                if ("audio" === e.kind) {
                    let t =
                        void 0 !== e.jitterBufferDelay && void 0 !== e.jitterBufferEmittedCount
                            ...
                            : 0;
                    null == c[s] && (c[s] = []),
                        c[s].push({ ...o, audioLevel: e.audioLevel, jitter: 1e3 * e.jitter, jitterBuffer: t });
        ...
        })(e, this.getUserIdBySsrc, this.remoteVideoSinkWants, this.localVideoSinkWants, t);
    }
...
function ey(e) {
    ...
    switch (n) {
        case "audio":
            "Firefox" === h().name
                ? (m.ext = _.filter((e) => "urn:ietf:params:rtp-hdrext:ssrc-audio-level" === e.uri))
                : ((m.ext = _.filter(
                      (e) =>
                  ...
                  !0 === E && m.rtcpFb?.push({ type: "nack", payload: o })),
                m.rtp.push({ codec: a, encoding: 2, payload: o, rate: 48e3 }),
                a === w.UK.OPUS &&
                    m.fmtp.push({ config: `minptime=10;useinbandfec=1;usedtx=${c ? "0" : "1"}`, payload: o }),
                (m.maxptime = 60);
            break;
        case "video":
            (m.ext = _.filter(
            ...
            a === w.UK.H264
                ...
                : a === w.UK.H265 && (f += ";level-id=180;profile-id=1;tier-flag=0;tx-mode=SRST"),
                ...
                null != u &&
                    (m.rtp.push({ codec: "rtx", payload: u, rate: 9e4 }),
                    m.fmtp.push({ config: `apt=${o}`, payload: u }),
                    (m.payloads = `${m.payloads} ${u}`));
    }
    return m;
}
...
function eD(e, t) {
    let n = eI.parse(e).media.reduce(
        (e, n) => {
            ...
            switch ((e.outboundStreams.push({ type: r, direction: l, mid: d }), r)) {
                case "audio":
...
class eP extends D.EventEmitter {
    ...
    set sdp(e) {
        if (!eb(e)) throw Error(`Incorrect SDP received from rtc-worker: ${e}`);
        (this._sdp = e),
            this.createAnswer(),
            (this.connected = !0),
    ...
    getSSRCs(e) {
        let t = this.streams.map((e, t) => {
            let { cname: n, ssrc: i, type: r } = e,
                ...
                o = `${r}_inbound_${t}`;
            return [i, n, r, s === i || a === i ? this.direction : eS.INACTIVE, o];
        });
    ...
    generateSessionDescription(e) {
        ...
        let o = (function (e) {
            let {
                ...
                E = [];
            if ((eT.info(`generateSessionDescription: ${JSON.stringify(u)}`), "Firefox" === h().name)) {
...
class eM extends D.EventEmitter {
    ...
    createOffer() {
        ...
        return e
            ...
            .catch((t) => {
                if ("have-remote-offer" === e.signalingState) return ek.error(t), this.createOffer();
                throw t;
            });
    }
    createAnswer() {
    ...
    makeOfferAnswerOptions() {
        return { offerToReceiveAudio: !0, offerToReceiveVideo: eE.g7, iceRestart: !1 };
    }
    ...
    handleIceConnectionStateChange = () => {
        ...
        ek.info("iceConnectionState =>", e), "completed" === e && (e = "connected"), this.emit(e);
    };
    handleSignalingStateChange = () => {
        ek.info(`signalingState => ${this.signalingState}, negotiation needed: ${this._negotiationNeeded.toString()}`),
...
var eF =
        ...
        d),
    eB = (((_ = {})[(_.ENCRYPT = 0)] = "ENCRYPT"), (_[(_.DECRYPT = 1)] = "DECRYPT"), _),
    eH = (((u = {})[(u.PROTOCOL_VERSION_CHANGED = 0)] = "PROTOCOL_VERSION_CHANGED"), u),
    ej = n(264572).Buffer;
class eW extends p.A {
    ...
    createUser(e) {
        this.recognizedUserIds.add(e), this.setupKeyRatchetForUser(e, this.latestPreparedTransitionVersion, eB.DECRYPT);
    }
    destroyUser(e) {
...
class eJ extends em {
    ...
    buildSSRCsFromOutboundStreams(e, t, n, i) {
        return {
            ssrcs: e.map((e) => {
                ...
                let l = "audio" === s ? t : n,
                    d = this.inactiveTransceivers[s],
                    _ = d.indexOf(r);
                return (
                    null == o &&
                        l.length > 0 &&
                        -1 !== _ &&
                        ((o = l.pop()), d.splice(_, 1), this.assignedStreams.set(r, o)),
    ...
    generateSDPAnswer(e, t, n, i) {
        let r = this.audioCodec,
            ...
            _ = this.sdp;
        if (null == r || null == s || null == a || null == o || null == d || null == _)
            throw Error(
                `Invalid payload: audioCodec: ${r}, audioPayloadType: ${null == s ? "null" : s}, videoCodec: ${a}, videoCodecPayloadType: ${null == o ? "null" : o}, rtxPayloadType: ${null == d ? "null" : d}, sdp: ${null == _ ? "null" : _}`,
            );
        let {
            ssrcs: u,
    ...
    async handleNegotiationNeeded() {
        ...
        (this.codecs = l),
            (this.extensions = c),
            (d !== this.audioSSRC || _ !== this.videoSSRC) && this.daveSessionManager?.updateSsrcs(this.userId, d, [_]),
            (this.audioSSRC = d),
            (this.videoSSRC = _),
            (this.videoReady = _ > 0 && u > 0),
...
class e1 extends em {
    ...
    constructor(e) {
        ...
        t.on("answer", (e) =>
            ...
            (t.direction = null != this.input.stream ? eS.SENDRECV : eS.SENDONLY),
            (this.fpc = t);
    ...
    setStream(e) {
        (this.fpc.direction = null != e ? eS.SENDRECV : eS.SENDONLY), this.pc.setStream(e ?? null);
    }
    createUser(e, t, n) {
...
let e2 = n.p + "worklet.8d84a64a97f8451a.js",
    e3 = { voiceActivityDetection: !0, offerToReceiveAudio: !0, offerToReceiveVideo: !1, iceRestart: !1 };
    ...
    m.useLayoutEffect(() => {
        ...
        if (null != e)
            return (
                ...
                () => {
                    v(t), (e.srcObject = null), e.load();
                }
            );
    }, [t]),
        m.useEffect(
            () => (
                n ? (o.current?.pause(), v(t)) : o.current?.play().catch(() => {}),
                () => {
                    n && y(t);
                }
            ),
...
function tt(e) {
    ...
    return (
        ...
        null == a
            ? (0, c.jsx)("div", { className: "media-engine-video", style: { width: n, height: i } })
...
class ti extends p.A {
    Video = te;
    Camera = (e) => (0, c.jsx)(tt, { ...e, onDeviceChange: this.handleDeviceChange });
    _audioContext = null;
    outputVolume = w.Hz;
    sourceId = w.dx;
    sinkId = w.dx;
    ...
    static supported() {
        return (
            !__OVERLAY__ &&
            (eE.Hz && null != window.AudioContext && null != window.RTCPeerConnection
                ? (n(528416), !0)
                : (tn.info("WebRTC is not supported on", h().name, h().version), !1))
        );
    }
    supported() {
        return !0;
    ...
    connect(e, t, n) {
        ...
        let r,
            s,
            { ssrc: a, address: o, port: l, modes: d, streamUserId: _, streamParameters: u } = n,
            c =
                ((i = {
                    context: e,
                    userId: t,
                ...
                eE.PF ? (s.info(`Using Unified Plan (${r})`), new eJ(i)) : (s.info(`Using Plan B (${r})`), new e1(i)));
        return (
            (c.streamUserId = _),
            c.setOutputVolume(this.outputVolume),
            c.setSinkId(this.sinkId),
            c.once(S.y.Destroy, (e) => this.connections.delete(e)),
            c.on(S.y.Silence, (e) => this.emit(N.bg.Silence, e)),
            c.on(S.y.DesktopSourceEnd, this.handleDesktopSourceEnd),
            c.on(S.y.AudioPermission, this.handleAudioPermission),
            c.on(S.y.VideoPermission, this.handleVideoPermission),
            this.interacted && c.interact(),
            e === w.x.DEFAULT && (c.setAudioSource(this.sourceId), this.enabled && c.input.enableAudioInput()),
            this.connections.add(c),
            this.emit(N.bg.Connection, c),
            c
        );
    }
    findConnection(e) {
    ...
    setGoLiveSource(e, t) {
        if (null == e) this.eachConnection((e) => e.setDesktopInput(null), t);
            ...
            g()(t === w.x.STREAM, "Go live context is not STREAM");
            let n = !1,
                              ...
                              : (eK = new Promise((e, t) => {
                                    n.e("16566")
                                        ...
                                        .then((n) => {
                                            ...
                                            i(eq)
                                                .then((t) => {
                                                    eY.info("Successfully initialized DAVE"), (ez = t), e(t);
                                                })
                                                .catch((e) => {
                                                    eY.error("Failed to initialize DAVE", e), t(e);
                                                });
                                        })
                                        .catch((e) => {
                              ...
                              .then((t) => {
                                  (this.dave = t),
                                      (this.transientKeys = (function () {
                                          ...
                                          return null == e$ && (e$ = new ez.TransientKeys()), e$;
                                      })()),
