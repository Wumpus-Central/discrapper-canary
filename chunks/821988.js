...
var m = n(241678),
    p = n(985018);
let f = async (e) => {
    let { applicationImageSrc: t, entry: n, avatarSrcs: l, description: f, timestamp: g, colors: x, channelId: C } = e,
        A = n.extra.game_name,
        E = {
            AvatarImage1: l[0],
        ...
        drawImage: (e) =>
            ((e, t) => {
                let { timestamp: n, colors: l, description: o, entry: f, numAvatars: g } = t,
                    x = l.map((e, t) => ({ color: e, stop: t }));
                e.setSize({ w: 400, h: 120 }, 4),
                    e.drawRoundedGradientRect(x, { x: 0, y: 120 }, { x: 400, y: 0 }, { x: 0, y: 0, h: 120, w: 400 }, 8),
                    e.setColor("white"),
                ...
                (0, h.$)({ canvas: e, badges: C, startPosition: 120, maxWidth: 260 });
            })(e, { timestamp: g, colors: x, description: f, entry: n, numAvatars: l.length }),
        exportConfigs: {
