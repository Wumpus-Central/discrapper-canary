...
let h = (e, t) => ({
    ...
    m = (e, t) => {
        ...
        (0, d.CZ)(e) === a.m.GLOBAL && n.push({ iconPath: f.Cv, text: p.intl.string(p.t.kAlUsy) });
        let s = (0, d.KH)(e);
        if ((null != s && n.push({ iconPath: f.$S, text: (0, d.us)(s) }), (0, d.L7)(e))) {
            let { text: t } = (0, d.Pj)(e);
    ...
    g = (e, t) => {
        let { timestamp: n, colors: r, description: i, entry: a, numAvatars: l } = t,
            u = r.map((e, t) => ({ color: e, stop: t }));
        e.setSize({ w: 400, h: 120 }, 4),
            e.drawRoundedGradientRect(u, { x: 0, y: 120 }, { x: 400, y: 0 }, { x: 0, y: 0, h: 120, w: 400 }, 8),
            e.setColor("white"),
            e.drawRoundedImage("ApplicationImage", { x: 12, y: 12 }, { w: 96, h: 96 }, 8) === o.uS.Failure &&
                e.drawPath(s.f, { x: 12, y: 12 }, !0, 2 + 2 / 3);
        let c = ["AvatarImage1", "AvatarImage2", "AvatarImage3"];
        (0, _.v)({ canvas: e, avatarSrcs: c.slice(0, l), position: { x: 120, y: 12 }, avatarImageSize: 32 }),
            e.setColor("white"),
            e.setFont({ size: 16, family: f.mw, weight: 500, truncate: o.Kq.Wrap }),
            e.drawText(i, { x: 120, y: 64, h: 32, w: 260 }, !0);
        let d = m(a, n);
        (0, _.$)({ canvas: e, badges: d, startPosition: 120, maxWidth: 260 });
    },
    E = async (e) => {
        let {
        ...
        return await (0, l.r)({
            assetsToLoad: d,
            drawImage: (e) => g(e, { timestamp: a, colors: s, description: i, entry: n, numAvatars: r.length }),
            exportConfigs: {
