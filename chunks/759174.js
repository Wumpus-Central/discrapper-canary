...
class l {
    ...
    size(e) {
        ...
        return null == e
            ...
            : null != (n = null == (t = this.valueIndexes[e]) ? void 0 : t.length)
              ? n
              : 0;
    }
    clear() {
    ...
    set(e, t) {
        ...
        return (
            ...
            o(this.valueArray, n, t, this.sortBy),
            null != n && this.indexBy(n).forEach((e) => o(this.getIndex(e), n, null, this.sortBy)),
            null != t && this.indexBy(t).forEach((e) => o(this.getIndex(e), null, t, this.sortBy)),
            (this.dirty = !0),
            this._version++,
            !0)
        );
