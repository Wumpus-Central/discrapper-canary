...
function el(e) {
    for (let { guildId: t, channels: n } of e.channels) for (let e of (C.fileOnly('Lazy loaded guild channels for '.concat(t)), (0, p.ZP)(n), G.add(t), f.Z.restored(t), n)) Object.hasOwn(P, e.id) || et((0, g._H)(e));
    return !1;
}
function ec() {
...
function eu(e) {
    ...
    for (let e of [n, r]) for (let t of e) J((0, p.d7)((0, g._H)(t)));
...
function e_(e) {
    ...
    if (null == t) t = e.channel;
        ...
        var n;
        t = t.merge(A(T({}, e.channel.toJS()), { bitrate: null !== (n = e.channel.bitrate) && void 0 !== n ? n : t.bitrate }));
    }
    J(t);
}
function eh(e) {
...
function eO(e) {
    var t, n;
    let { channel: r } = e,
        i = null !== (n = null !== (t = P[r.id]) && void 0 !== t ? t : D[r.id]) && void 0 !== n ? n : L[r.id];
    if (null == i) return !1;
    ey(i), eb(i);
}
function eS(e) {
