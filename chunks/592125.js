...
function z(e, t, n) {
    ...
    a))
        Object.hasOwn(R, n.id) || en((0, g._H)(n));
    N.verbose(
...
function X(e) {
    ...
    return (
        ...
        null != (i = null != (r = null != (n = null != (t = R[e]) ? t : w[e]) ? n : L[e]) ? r : G[e])
            ? i
...
function J(e) {
    ...
    return (
        q(e, 1, "getChannel"),
        null != (i = null != (r = null != (n = null != (t = R[e]) ? t : w[e]) ? n : L[e]) ? r : G[e]) ? i : V[e]
    );
}
function $(e) {
...
function en(e) {
    ...
    (R[a] = e),
        ...
        null != e.linkedLobby
            ? ((j[o] = null != (r = j[o]) ? r : {}), (j[o][a] = e))
            : null == (i = j[o]) || delete i[a];
}
function er(e) {
    en(e);
}
    ...
    (R = {}),
        ...
        t.forEach((e) => {
            if ("unavailable" === e.data_mode)
                ...
                i.length > 0 && (z(e.id, 1, "handleBackgroundSync"), i.forEach((e) => ev(R[e]))),
...
function ec(e) {
    for (let { guildId: t, channels: n } of e.channels)
        ...
        f.Z.restored(t),
        n))
            Object.hasOwn(R, e.id) || en((0, g._H)(e));
    return !1;
}
function eu() {
...
function ed(e) {
    ...
    for (let e of [n, r]) for (let t of e) $((0, p.d7)((0, g._H)(t)));
...
function ev(e) {
    ...
    e.id in w && delete w[e.id],
        ...
        null != t &&
            (null != D[t] && e.id in D[t] && delete D[t][e.id], null != j[t] && e.id in j[t] && delete j[t][e.id]),
        ei(e);
}
function eS(e) {
    var t, n;
    let { channel: r } = e,
        i = null != (n = null != (t = R[r.id]) ? t : w[r.id]) ? n : L[r.id];
    if (null == i) return !1;
    ev(i), eO(i);
}
function eI(e) {
...
class ex extends (r = s.ZP.Store) {
    initialize() {
        this.waitFor(y.default, f.Z, h.Z, O.Z, v.default), this.syncWith([h.Z], eD);
    }
    hasChannel(e) {
        return null != X(e);
    }
    ...
    getChannelIds(e) {
        ...
        return (z(e, 0, "getChannelIds"), null == e)
            ? b.default.keys(w)
            : b.default.keys(null != (n = null != (t = f.Z.getGuildBasicChannels(e)) ? t : D[e]) ? n : P);
    }
    ...
    getMutableBasicGuildChannelsForGuild(e) {
        ...
        return (
            ...
            null != (n = null != (t = f.Z.getGuildBasicChannels(e)) ? t : D[e]) ? n : P
        );
    }
