...
function h(e, t) {
    ...
    return (
        r.useEffect(
            () => (
                x && null === g.current
                    ...
                    : x || (null !== g.current && (clearTimeout(g.current), (g.current = null)), b(!1)),
                () => {
        ...
        }, [null == h ? void 0 : h.sessionId, null == h ? void 0 : h.categoryPosition, null == h ? void 0 : h.pageCategory, null == h ? void 0 : h.pageSection, null == h ? void 0 : h.tilePosition, v, f, k, t, p, e, n]),
        {
