"use strict";
n.d(t, { B_: () => N, FC: () => E, Fk: () => T, IK: () => y, PX: () => j, TZ: () => w, ji: () => R, zN: () => S });
var i = n(627968),
    s = n(64700),
    r = n(503698),
    l = n.n(r),
...
let E = 100,
    ...
    v = (e) => e.target_type === p.yV.STREAM && null != e.target_user,
...
function w(e) {
    let t,
        n,
        s,
        { user: r, guild: l, channel: u, application: h, showBigUserIcon: p } = e,
        g = (0, d.Ay)(u);
    if (null != l)
        p && null == h && (t = (0, i.jsx)(c.$v, { guild: l, size: c.$v.Sizes.SMALL })),
            (n = l.name),
            null != h &&
                ((n = h.name),
                (s = (0, i.jsxs)("div", {
        ...
        null != g && "" !== g
            ? ((n = g), null != u.icon && (t = (0, i.jsx)(c.F4, { channel: u, size: a._3.SIZE_32 })))
            : (n = e);
    } else if (null != r) {
        let e = m.Ay.getFormattedName(r);
