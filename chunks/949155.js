"use strict";
n.d(t, { B_: () => N, FC: () => x, Fk: () => T, IK: () => S, PX: () => j, TZ: () => O, ji: () => R, zN: () => b });
var i = n(627968),
    s = n(64700),
    r = n(503698),
    l = n.n(r),
...
let x = 100,
    ...
    y = (e) => {
        let t;
        return !T(e) && (!!j(e) || (null != e.inviter && !C(e) && ((t = I(e)), !((t?.memberCount ?? 0) > x))));
    },
    b = (e) => {
        let { guild: t, user: n, application: s } = e;
        return null != s
            ? (0, i.jsx)(u.A, { className: E.Z2, game: s, size: E.q6 })
            : null != n
              ? (0, i.jsx)(c.eu, { src: n.getAvatarURL(void 0, 100), size: a._3.DEPRECATED_SIZE_100, className: E.my })
              : null != t
                ? (0, i.jsx)(c.$v, { guild: t, size: c.$v.Sizes.LARGER, className: E.$f, animate: !0 })
                : null;
    };
function S(e) {
    let { invite: t, textClassName: n, className: s } = e,
        r = I(t);
    return null == r || y(t) || t?.guild?.id === A.TA
        ? null
        : (0, i.jsx)(c.R1, {
              className: l()(E.He, s),
...
function R(e) {
    ...
    return (
        ...
        (0, i.jsxs)("div", {
            ...
            children: [
                null != r &&
                    (0, i.jsx)("div", { className: E._t, children: (0, i.jsx)(c.eu, { src: r, size: a._3.SIZE_24 }) }),
                (0, i.jsx)(c.tK, { className: E.__invalid_inviteJoinSubTitle, children: l }),
            ],
        })
    );
}
function O(e) {
    ...
    if (null != l)
        g && null == h && (t = (0, i.jsx)(c.$v, { guild: l, size: c.$v.Sizes.SMALL })),
            ...
            null != h &&
                ...
                (s = (0, i.jsxs)("div", {
                    className: E.JB,
                    children: [
                        (0, i.jsx)(c.tK, { className: E.R9, children: f.intl.string(f.t["3gg9fF"]) }),
                        (0, i.jsxs)("div", {
                            className: E.bo,
                            children: [
        ...
        (n = f.intl.formatToPlainString(f.t["4aF92R"], { username: e })),
            (s = (0, i.jsx)(c.tK, { className: E.b$, children: f.intl.format(f.t.Quj7HX, { username: e }) }));
    }
    return (0, i.jsxs)(i.Fragment, {
        children: [
            (0, i.jsxs)(c.hE, {
                className: E.DD,
                children: [
                    null != l ? (0, i.jsx)(_.A, { guild: l, className: E.n2, tooltipPosition: "left" }) : null,
                    t,
                    n,
                ],
            }),
