...
function f(e, t) {
    (i.Z.show({
        title: _.intl.string(_.t.l8rYLi),
        body: _.intl.formatToPlainString(_.t.FfjF19, {
            currentLength: e,
            maxLength: t
        }),
...
function p(e) {
    var t;
    let { openWarningPopout: n, type: s, content: l, stickers: u, uploads: p, channel: h, restrictMentions: m, respectCooldown: g, userCanUsePremiumMessageLength: E, resolve: b } = e;
    if (0 === l.length && !(null == (t = s.submit) ? void 0 : t.allowEmptyMessage) && (null == u || 0 === u.length) && (null == p || 0 === p.length))
        return void b({
            valid: !1,
    ...
    if (a.ZP.isFull()) {
        (i.Z.show({
            title: _.intl.string(_.t['7Q4eo6']),
            body: _.intl.string(_.t.gi6XHh),
            confirmText: _.intl.string(_.t.Z4U1g4)
        }),
            b({
                valid: !1,
