...
function rr(e) {
    ...
    let u = () => {
        ...
        h = (e, s, a) => {
            (0, io.openModalLazy)(async () => {
                let { default: o } = await Promise.all([n.e("96762"), n.e("14788"), n.e("67554")]).then(
                    n.bind(n, 219801),
                );
                return (n) =>
                    (0, r.jsx)(o, {
...
function rR(e) {
    let { channel: t, className: n } = e,
        ...
        s = (0, m.bG)([rb.Ay], () => rb.Ay.getVoiceStatesForChannel(t), [t]),
        { needSubscriptionToAccess: a } = (0, ry.A)(t.id),
        c = o.useCallback(() => {
            rv.A.handleVoiceConnect({ channel: t, connected: i, needSubscriptionToAccess: a, locked: !1 });
        }, [t, i, a]),
        u = null != s && s.length > 0;
    return l || u
        ? (0, r.jsxs)("div", {
...
function rU(e) {
    let { application: t, channel: n, message: l, presenceActivity: i, analyticsLocations: s, hideParty: a = !1 } = e,
        ...
        c = (0, m.bG)([rP.A, rG.A], () => (0, rD.A)(rP.A, rG.A, t.id), [t.id]),
                ...
                ),
                {
                    ...
                    let K = null,
                        ...
                        W = h.map((e, t) => {
                            ...
                            if (null != C && C > e.content.timestamp.getTime() * rC.A.Millis.SECOND) return;
                    ...
                    if (
                        (null != v &&
                            g.forEach((e, t) => {
                                let n = 0 === t && (0, ei.l)(s, q, new rA.Ay({ type: w.lAJ.DEFAULT, author: v }));
                                z.push(
                                    (0, r.jsx)(
                                        r1,
