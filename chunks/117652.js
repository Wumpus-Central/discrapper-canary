...
let M = {
    ...
    options: {
        isLargeModal: !0,
        useBreadcrumbLabel: () => P.intl.string(P.t["W685+f"]),
    },
};
function j(e) {
...
function k(e) {
    let { handleStepChange: t, handleClose: n } = e,
        ...
        X = z === p.u.POPULAR ? P.intl.string(P.t.Kwgrrq) : P.intl.string(P.t.r1huYW),
        Q = async (e, t) => {
            k(!0), null != g && b(), (await (0, c.B1)(e.id, t)) || b(P.intl.string(P.t["4kgVqa"])), k(!1);
        };
    (0, o.ZP)(() => {
        null != B &&
            null != L &&
            (v.default.track(N.rMx.COLLECTIBLES_GIFTING_SHOP_ITEM_CLICKED, { sku_id: B }), Q(L, B));
    });
    let J = (e) => {
            v.default.track(N.rMx.COLLECTIBLES_GIFTING_SHOP_ITEM_CLICKED, { sku_id: e }), null != L && Q(L, e), Z(e);
        },
        $ = (e) => {
            let t = H[e],
                n = null;
        ...
        en = () => {
            ...
            return M === R.Wt.USER_PROFILE_WISHLIST
                ? (0, r.jsxs)("div", {
                      className: w.bodyColumnRight,
                      children: [
                          (0, r.jsx)(E.s, { giftRecipient: L }),
