        ...
        p
            ...
            : null != u
              ...
              : null != a && (a.isDM() || a.isGroupDM())
                ...
                : t.pathname.startsWith(w.Z5c.GLOBAL_DISCOVERY)
                  ? ((e = R.intl.string(R.t['4nEZLi'])), (f = (0, r.jsx)(s.Jmo, { size: 'xs' })))
                  : t.pathname.startsWith(w.Z5c.NITRO_HOME)
                    ? ((e = R.intl.string(R.t.Ipxkoq)), (f = (0, r.jsx)(s.SrA, { size: 'xs' })))
                    : t.pathname.startsWith(w.Z5c.COLLECTIBLES_SHOP)
                      ? ((e = R.intl.string(R.t.pWG4zc)), (f = (0, r.jsx)(s.EOn, { size: 'xs' })))
                      : t.pathname.startsWith(w.Z5c.FRIENDS)
                        ? ((e = R.intl.string(R.t.TdEu5e)), (f = (0, r.jsx)(s.iFz, { size: 'xs' })))
                        : t.pathname.startsWith(w.Z5c.FAMILY_CENTER) && ((e = R.intl.string(D.default.RZqaJi)), (f = (0, r.jsx)(s.BFJ, { size: 'xs' }))),
        null != e &&
            '' !== e &&
            (0, r.jsxs)('div', {
                className: k.title,
...
let V = i.memo(function () {
    ...
    let l = (0, o.e7)([C.Z], () => (C.Z.darkSidebar ? w.BRd.DARK : void 0)),
