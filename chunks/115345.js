...
function B() {
    ...
    for (let i of e) {
        ...
        (e = (0, O.mB)(e, D.vc.UNREADS_ALL_MESSAGES, !0)),
            (e = (0, O.mB)(e, D.vc.UNREADS_ONLY_MENTIONS, !1)),
            (t[i.id] = { flags: e });
    }
    W(t),
...
async function X() {
    s.K.set("turnedOffNewNotifications", !0),
        y.default.track(P.rMx.NOTIFICATION_MIGRATION_OPTOUT, {
            num_guilds_with_new_setting: g.Z.getGuildsArray().filter(
                (e) => b.ZP.resolveGuildUnreadSetting(e) === w.i.ONLY_MENTIONS,
            ).length,
        });
    let e = await (0, S.Tn)(),
