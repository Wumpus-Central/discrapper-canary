...
var r = (function (e) {
    return (
        ...
        (e.SAFETY_HUB_VIEW = "safety_hub_view"),
        (e.APPEAL_INGESTION_VIEW = "appeal_ingestion_view"),
        ...
        (e.SAFETY_WARNING_VIEW = "safety_warning_view"),
        (e.SAFETY_WARNING_MODAL_VIEW = "safety_warning_modal_view"),
        (e.EXPLICIT_MEDIA_SCAN_CLIENT_TIMED_OUT = "explicit_media_scan_client_timed_out"),
        (e.EXPLICIT_MEDIA_SCAN_CLIENT_TIMING = "explicit_media_scan_client_timing"),
        (e.EXPLICIT_MEDIA_SENDER_FP_BUTTON_VIEW = "explicit_media_sender_fp_button_view"),
        (e.EXPLICIT_MEDIA_PENDING_MESSAGE_LOADED = "explicit_media_pending_message_loaded"),
        (e.EXPLICIT_MEDIA_PENDING_MESSAGE_LOADED_V2 = "explicit_media_pending_message_loaded_v2"),
        (e.EXPLICIT_MEDIA_SCAN_CLIENT_TIMED_OUT_DISTRIBUTION = "explicit_media_scan_client_timed_out_distribution"),
        (e.EXPLICIT_MEDIA_SCAN_CLIENT_TIMEOUT_CREATE = "explicit_media_scan_client_timeout_create"),
        (e.RTC_CONNECTION_DESYNC_STORE_UNKNOWN_USER = "rtc_connection_desync_store_unknown_user"),
        ...
        (e.DEBUG_OTA_200_TIMEOUT = "debug_ota_200_timeout"),
        (e.IMAGE_LOAD_ERROR = "image_load_error"),
