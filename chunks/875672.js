            ...
            let { applicationId: t, surface: n } = e,
                {
                    ...
                    let { applicationId: t, surface: n } = e,
                        ...
                        r = (0, x.bG)(
                            [k.A, w.A],
                            () => k.A.getWindowOpen(_.MLl.ACTIVITY_POPOUT) && w.A.getMainFrame()?.id === l,
                            [l],
                        ),
    ...
    let N = s.useCallback(
            ...
            (e) => {
                ...
                for (let l of e) {
                    ...
                    if (l.size > ($.Wb.has(e) ? 5242880 : 0xa00000)) {
                        t.push({ ...s, status: "error", errorText: I.intl.string(R.default.cI7t94) });
                        continue;
                    }
                ...
                for (let { file: e, localId: a } of (w(t), n))
                    l(e).then(
                        (e) => {
                            k.current.has(a) ? y(e) : N(a, { status: "ready", ref: e });
                        },
                        (e) => {
                            k.current.has(a) ||
                                (console.error("[vibegrations] attachment upload failed", e),
                                N(a, { status: "error", errorText: I.intl.string(R.default.GwEHvn) }));
                        },
                    );
            },
            [y, l, N, w],
        ...
        O = s.useCallback(
            (e) => {
                ...
                0 !== n.length && (e.preventDefault(), _(n));
            },
            [t, _],
        ),
        D = s.useCallback(
            (e) => {
                e.preventDefault(), f(!1), t && _(Array.from(e.dataTransfer.files));
            },
            [t, _],
        ),
        G = s.useCallback((e) => {
...
function ef(e) {
    ...
    return (0, a.jsx)("span", {
        ...
        "aria-label": (function (e) {
            switch (e) {
                case "completed":
                    return I.intl.string(R.default.TkPGOH);
                case "in_progress":
                    return I.intl.string(R.default["oK+fmd"]);
                default:
                    return I.intl.string(R.default.d7lieu);
            }
        })(t),
        children: "completed" === t ? (0, a.jsx)(em.B, { size: "xxs", color: "currentColor" }) : null,
    });
}
function eg(e) {
                  ...
                  (0, a.jsxs)("header", {
                      ...
                      children: [
                          (0, a.jsx)(h.E, {
                              ...
                              color: "text-muted",
                              tag: "span",
                              children: I.intl.string(R.default.qCRC6c),
                          }),
                          (0, a.jsx)("span", {
                              className: ep.mA,
                              ...(n
                                  ? {
                                        role: "status",
                                        "aria-live": "polite",
                                        "aria-label": I.intl.formatToPlainString(R.default["QG/EiF"], {
                                            completed: l,
                                            total: s,
                                        }),
                                    }
                              ...
                              children: (0, a.jsx)(h.E, {
                                  ...
                                  color: "text-muted",
                                  tag: "span",
                                  children: I.intl.formatToPlainString(R.default.bQvqly, { completed: l, total: s }),
                              }),
                          }),
                      ],
                  }),
...
function ey(e) {
    let { task: t } = e,
        ...
        u = (function (e) {
            switch (e) {
                case "running":
                    return I.intl.string(R.default["fW7T+d"]);
                case "succeeded":
                    return I.intl.string(R.default.X3c4hc);
                case "failed":
                    return I.intl.string(R.default.LK4Wsd);
                case "cancelled":
                    return I.intl.string(R.default.msWvKA);
                case "incomplete":
                    return I.intl.string(R.default.esfcU6);
            }
        })(t.state),
        m = o ? et.a : ee._,
        p = "failed" === t.state,
    ...
    return (0, a.jsxs)("li", {
        ...
        children: [
            r
                ? (0, a.jsx)(J.D, {
                      tag: "div",
                      className: A()(ew.qI, ew.EZ),
                      "aria-expanded": o,
                      "aria-controls": i,
                      "aria-label": I.intl.formatToPlainString(R.default.SxMgMJ, { title: t.title, state: u }),
                      onClick: c,
                      children: g,
                  })
        ...
        d = (0, a.jsx)(a.Fragment, {
            children: t.blocks.map((e) =>
                "rows" === e.type
                    ...
                    : (0, a.jsx)(
                          "ol",
                          { className: eu.On, children: e.tasks.map((e) => (0, a.jsx)(ey, { task: e }, e.taskId)) },
                          e.key,
                      ),
            ),
        });
        ...
        ? (0, a.jsxs)("li", {
              ...
              children: [
                  (0, a.jsxs)(J.D, {
                      ...
                      "aria-expanded": !n,
                      "aria-controls": i,
                      "aria-label": I.intl.formatToPlainString(R.default.s1wx5H, { activity: t.label }),
                      onClick: r,
                      children: [
                          (0, a.jsx)(h.E, {
                              tag: "span",
...
function eE(e) {
    let {
            ...
            () =>
                (function (e) {
                                ...
                                let p = {
                                    ...
                                    title:
                                        null != e.task_title && "" !== e.task_title
                                            ? e.task_title
                                            : I.intl.string(R.default.MdXWEK),
                                    state: "running",
                                    groups: [],
                                    rawSteps: [],
                                };
                    ...
                    for (let e of (d(), a)) {
                        ...
                        null != n && (e.latestActivity = n), !t && ek(e.state) && (e.state = "incomplete");
                    }
        ...
        g = f.at(-1),
        x = g?.type === "message" && g.content.trim() === l.trim(),
        v = null == i && "" !== l && !x;
    return (0, a.jsxs)("div", {
        className: eu.ue,
        children: [
            null != n && "" !== n
                ...
                : null,
            null != o && o.length > 0
                ? (0, a.jsx)("div", { className: A()(eu.ky, X.XR), children: (0, a.jsx)(ev, { todos: o }) })
                : null,
            f.length > 0
                ? (0, a.jsx)("ol", {
                      className: eu.dO,
            ...
            null != i
                ? (0, a.jsx)("div", {
                      className: A()(eu.ky, X.XR),
                      children: (0, a.jsx)(ed, { proposal: i, onApprove: c }),
                  })
                : v
                  ? (0, a.jsxs)("div", {
                        className: A()(eu.ky, X.XR),
                        children: [
                            ...
                            !0 === m
                                ? (0, a.jsx)("div", { className: eu.IN, children: (0, a.jsx)(er, { onAsk: p }) })
                                : null,
                        ],
                    })
                  : null,
            null != d && d.length > 0
                ? (0, a.jsx)("div", { className: A()(eu.ky, X.XR), children: (0, a.jsx)(ei, { ideas: d, onPick: u }) })
                : null,
            !0 !== m || v
                ? null
                : (0, a.jsx)("div", { className: A()(eu.ky, X.XR), children: (0, a.jsx)(er, { onAsk: p }) }),
        ],
    });
}
var eS = n(289149);
function eA(e) {
    ...
    return (0, a.jsx)("ol", {
        ...
        children: n.map((e) => {
                        ...
                        children: (0, a.jsxs)("div", {
                            ...
                            children: [
                                ...
                                null != e.attachments && e.attachments.length > 0
                                    ? (0, a.jsx)(eC, { projectId: t, attachments: e.attachments })
                                    : null,
                            ],
                        }),
                    },
            ...
            let n = e.steps.filter((e) => !eb.has(e.kind)).length > 0,
        ...
        children: n.map((e, n) =>
            null == e.id
                ...
                : $.Wb.has(e.content_type)
                  ? (0, a.jsx)(eM, { projectId: t, id: e.id, name: e.name }, n)
                  : (0, a.jsx)(eP, { projectId: t, id: e.id, name: e.name }, n),
        ),
    });
}
let eT = A()(X._B, X.ND);
...
function eI(e) {
    ...
    return (0, a.jsx)("div", { className: eT, children: eR(l, null) });
}
function eP(e) {
...
function eL(e) {
    ...
    return (0, a.jsx)("li", { "data-role": t, className: eS.xk, children: n });
}
var eO = n(379307),
    eD = n(922016),
    eG = n(863610),
...
function eW(e) {
    ...
    return (0, a.jsx)(eD.Y, {
        ...
        shouldShow: u,
        onRequestClose: p,
        renderPopout: () => (0, a.jsx)(eB, { id: l, activity: t }),
        children: () =>
            (0, a.jsxs)(J.D, {
                innerRef: n,
                className: A()(eH.h, c && eH.X),
                "aria-label": I.intl.string(R.default.SzdX35),
                "aria-expanded": u,
                "aria-describedby": u ? l : void 0,
                "data-vibegrations-thinking-trigger": !0,
                onClick: m,
                children: [
                    (0, a.jsx)(eG.n, { dotRadius: 3.5, themed: !0 }),
                    (0, a.jsx)(h.E, {
                        tag: "span",
                        variant: "text-xs/semibold",
                        color: "text-strong",
                        children: I.intl.string(o ? R.default.Ly7F7x : R.default.QDGuNS),
                    }),
                ],
            }),
    });
...
function ez(e) {
    ...
    return (0, a.jsx)("div", {
        className: eF.B,
        role: "dialog",
        "aria-label": I.intl.string(R.default.qCRC6c),
        children: (0, a.jsx)(ev, { todos: t, announceProgress: !1 }),
    });
}
function e$(e) {
    let { todos: t } = e,
        n = s.useRef(null),
        { completed: l, total: i } = eg(t);
    return 0 === i
        ? null
        : (0, a.jsx)(eD.Y, {
              targetElementRef: n,
              position: "top",
              align: "right",
              renderPopout: () => (0, a.jsx)(ez, { todos: t }),
              children: (e) =>
                  (0, a.jsxs)(J.D, {
                      innerRef: n,
                      className: eF.T,
                      "aria-label": I.intl.formatToPlainString(R.default["QG/EiF"], { completed: l, total: i }),
                      ...e,
                      children: [
                          (0, a.jsx)(eV.O, { size: "xxs", color: "currentColor", "aria-hidden": !0 }),
                          (0, a.jsx)(h.E, {
                              tag: "span",
                              variant: "text-xs/medium",
                              color: "none",
                              children: I.intl.formatToPlainString(R.default["6zuiBa"], { completed: l, total: i }),
                          }),
                      ],
                  }),
          });
        ...
        children: [
            ...
            (0, a.jsxs)(h.E, {
                ...
                children: [
                    ...
                    eK(n.output_tokens),
                    " out \xb7 ",
                    eK(n.cache_creation_input_tokens),
                    " cache write \xb7 ",
                    eK(n.cache_read_input_tokens),
                    " cache read",
                ],
            }),
        ],
...
function eZ(e) {
    ...
    return (0, a.jsxs)("div", {
        ...
        children: [
                ...
                children: (0, a.jsxs)("div", {
                    ...
                    children: [
                        (0, a.jsxs)(h.E, {
                            ...
                            color: "text-default",
                            children: [eK((0, $.a7)(t.cost_usd)), " runes"],
                        }),
                        (0, a.jsxs)(h.E, {
                            variant: "text-xs/normal",
                            color: "text-muted",
            ...
            (0, a.jsx)(eY, { label: I.intl.string(R.default.hk4jJr), usage: t.orchestrator }),
            (0, a.jsx)(eY, { label: I.intl.string(R.default.R9aduM), usage: t.codegen }),
            (0, a.jsxs)("div", {
                className: eX.mf,
                children: [
                    (0, a.jsx)(h.E, {
...
function eJ(e) {
    ...
    return (0, a.jsx)(eD.Y, {
        ...
        position: "top",
        align: "right",
        renderPopout: () => (0, a.jsx)(eZ, { project: t }),
        children: (e) =>
            (0, a.jsx)(J.D, {
                innerRef: n,
                className: eX.Y$,
                ...
                ...e,
                children: (0, a.jsx)(eq.m, { size: "xxs", color: "currentColor", "aria-hidden": !0 }),
            }),
    });
}
var eQ = n(154861);
    ...
    return (0, a.jsxs)("div", {
        ...
        children: [
            (0, a.jsx)("div", {
                ...
                children: t ? (0, a.jsx)(eW, { activity: n }) : null,
            }),
            null == r
                ? null
                : (0, a.jsx)(eO.A, { settings: r.settings, choices: r.choices, disabled: "open" !== i, onChange: o }),
            null == l || 0 === l.length ? null : (0, a.jsx)(e$, { todos: l }),
            null == s
                ? null
                : (0, a.jsxs)("span", {
                      className: eQ.BP,
                      children: [
                          (0, a.jsx)(h.E, {
                              ...
                              "aria-label": I.intl.formatToPlainString(R.default["7SZZvj"], {
                                  runes: (0, $.a7)(s.cost_usd),
                                  turns: s.turns,
                              }),
                              children: I.intl.formatToPlainString(R.default["4PFO2p"], {
                                  runes: (0, $.a7)(s.cost_usd).toLocaleString(),
                              }),
                          }),
                          (0, a.jsx)(eJ, { project: s }),
                      ],
                  }),
            (0, a.jsx)(h.E, {
                tag: "span",
                ...
                "aria-label": I.intl.formatToPlainString(R.default.eDDdhB, { status: e0(i) }),
...
var e2 = n(506774),
    ...
    e5 = n(651649),
    e7 = n(670455);
let e8 = "shownVibegrationsFeedbackProjectIds";
var e3 = n(104071);
function e4(e) {
        ...
        s.useEffect(
            () => () =>
                (function (e) {
                    ...
                    !(t < 3) &&
                        ((e2.w.get(e8) ?? []).includes(e) ||
                            e5.A.possiblyShowFeedbackModal(e7.MW.VIBEGRATIONS, () => {
                                let l;
                                (l = e2.w.get(e8) ?? []).includes(e) || e2.w.set(e8, [...l, e]),
    ...
    let g = s.useCallback(
        ...
        b = s.useCallback(() => g(I.intl.string(R.default["3sTTBu"])), [g]),
        k = s.useCallback((e) => (0, o.XZ)(t, e), [t]),
        j = s.useCallback((e) => (0, o.vX)(t, e), [t]),
        w = s.useCallback((e) => (0, o.Vm)(t, e), [t]),
        y = s.useCallback(() => g(I.intl.string(R.default.Jj8Ftb)), [g]),
        N = "open" === r,
        _ = i[i.length - 1],
        E = null != _ && "assistant" === _.role && null != _.proposal,
        S = null != _ && "assistant" === _.role && !(0, G.B)(_),
        A = E && N ? y : void 0,
        C = S && _?.role === "assistant" ? _.todos : void 0;
    return (0, a.jsxs)("section", {
        ref: h,
...
function ts(e) {
    let { open: t, maxWidth: n, onWidthChange: l, children: i } = e,
        r = (0, tt.r)(te.A.modules.chat.RESIZE_HANDLE_WIDTH),
        o = s.useRef(null),
        [c, d] = (0, tn.V)("VibegrationsChatSidebarWidth", 460),
        [u, h] = s.useState(c ?? 460),
        m = (0, e9.clamp)(u, 360, n);
    s.useLayoutEffect(() => {
        l(t ? m + r : 0);
    }, [m, t, r, l]);
    let p = (0, tl.A)({
            ...
            orientation: tl.R.HORIZONTAL_LEFT,
            throttleDuration: 16,
            usePointerEvents: !0,
        }),
        f = s.useCallback(
    ...
    return (0, a.jsxs)("div", {
        ...
        hidden: !t,
        children: [
            (0, a.jsx)("div", { className: ta.Di, onPointerDown: f }),
            (0, a.jsx)("div", { ref: o, className: ta.kL, style: { width: m }, children: i }),
        ],
    });
}
var ti = n(333007),
...
function tm(e) {
    let { applicationId: t, surface: n, previewReady: l, content: r, sidebar: o } = e,
                ...
                p(null),
                    null != m &&
                        (function (e, t) {
                            ...
                            let a = `vibegrations-capture-${++tu}-${Date.now()}`;
        ...
        v = l && null != t && n.type === N.U4.MAIN;
    return (0, a.jsxs)(a.Fragment, {
        children: [
            (0, a.jsx)("div", { ref: d, className: th.fm, children: r }),
            o(v ? f : void 0),
            null != m ? (0, a.jsx)(tc, { targetRect: m.targetRect, onSelect: g, onCancel: x }) : null,
        ],
    });
}
function tp(e) {
                ...
                null != t && f
                    ? (0, a.jsx)(ts, {
                          ...
                          children: (0, a.jsxs)("div", {
                              className: th.cO,
                              children: [
                                  (0, a.jsx)(td, { projectId: t }),
                                  (0, a.jsx)(e4, { projectId: t, onRegionCapture: e }, t),
                              ],
                          }),
                      })
                    : null,
