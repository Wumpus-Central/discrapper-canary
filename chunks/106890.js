...
function f(t) {
    let { user: n, entry: e, display: f, onAction: _, onClose: m } = t,
        g = (0, l.bG)([A.default], () => A.default.getCurrentUser()?.id === n.id),
        E = (0, l.bG)([c.A], () => c.A.hasConnectedAccount());
    ...
    if (g) return null;
    let T = (0, a.Tq)(e) ? e.extra.entries[0]?.media : e.extra.media;
    return null == T
        ? null
        : (0, i.jsx)(r.Dr, {
              id: "play-on-spotify",
              ...
              action: () => {
                  _?.({ action: "PRESS_PLAY_ON_SPOTIFY_MENU_ITEM" }), (0, s.n)(x.M0.TRACK, T.external_id);
              },
          });
}
