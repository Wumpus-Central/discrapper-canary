...
class d extends r.Ay.Store {
    ...
    getWishlistItems(t) {
        ...
        return null != e ? (0, n.Lh)(e) : [];
    }
    hasSkuId(t, e) {
        let i = this.get(t).data;
        return null != i && (0, n.C3)(i, e);
    }
    getStatus(t) {
...
let c = new d(l.h, {
    ...
    WISHLIST_FETCH_SUCCESS: function (t) {
        let { wishlistId: e, wishlistData: i, updatedAt: r } = t,
            l = o(e);
        (l.data = i), (l.status = "success"), (l.error = void 0), (l.updatedAt = r), (l.lastFetchedAt = Date.now());
    },
    ...
    WISHLIST_REMOVE_SKU_FAILURE: function (t) {
        let { wishlistId: e, error: i } = t;
        (o(e).updatedAt = void 0), s.A.captureException(i);
    },
    ...
    WISHLIST_ITEM_PURCHASED: function (t) {
        let { recipientId: e, skuId: r } = t,
            l = i(841595).A.getFirstWishlistId(e);
        null != l && null != a[l] && null != a[l].data && (0, n.C3)(a[l].data, r) && (a[l].updatedAt = void 0);
    },
});
