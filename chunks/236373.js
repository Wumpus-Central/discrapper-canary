...
function l(e) {
    ...
    return null == e
        ...
        : {
              ...
              by_month: e.byMonth,
              by_month_day:
                  (null != (n = null == (t = e.byMonthDay) ? void 0 : t.length) ? n : 0) > 0 ? e.byMonthDay : null,
...
function _(e, t) {
    ...
    if (f(e) && (null == e ? void 0 : e.entity_type) === o.WX.EXTERNAL) {
        let t = (0, i.cS)(e);
        null != t && (m.entityMetadata = { location: t });
    } else
        null == m.channelId &&
            null != t &&
            ((m.channelId = t.id),
            t.isGuildStageVoice()
                ? (m.entityType = o.WX.STAGE_INSTANCE)
                : t.isGuildVoice() && (m.entityType = o.WX.VOICE));
    return m;
}
