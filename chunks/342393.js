    ...
    var R = function (e, t) {
        ...
        O = function (e) {
            ...
            return (
                ...
                t.createElement(C.Provider, { value: l }, r)
            );
        };
    O.propTypes = { stripe: p.any, options: p.object };
    var b = function (e) {
            return R(t.useContext(C), e);
        },
        D = function (e) {
                ...
                r = n
                    ...
                    : function (n) {
                          ...
                          E(L, "blur", d),
                              ...
                              E(L, "confirm", y),
                              E(L, "cancel", N),
                              E(L, "shippingaddresschange", v),
                              E(L, "shippingratechange", C),
                              E(L, "change", f),
                              h &&
                                  (r =
                                      "expressCheckout" === e
    ...
    var H = function () {
        ...
        j = V
            ? function (e) {
                  var n = e.id,
                      i = e.className;
                  return H(), t.createElement("div", { id: n, className: i });
              }
            : function (e) {
                  var n = e.id,
                      i = e.className,
                      r = H().embeddedCheckout,
                      s = t.useRef(!1),
                      a = t.useRef(null);
                  return (
                      t.useLayoutEffect(
