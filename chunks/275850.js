...
function T(e, t) {
    let n = null;
    return (e && null != t && !t.canRedeemTrial() ? (n = m.intl.string(m.t.SvheW1)) : e && null != t && t.hasFlag(h.Cw.NEW) && (n = m.intl.format(m.t.d7ZLKC, { helpDeskArticle: f.Z.getArticleURL(p.BhN.PAYMENT_AUTHORIZATION_CHARGE) })), n);
}
function S(e) {
    let { selectedPaymentSourceId: t, paymentSources: n, prependOption: a, hidePersonalInformation: u, onChange: f, onPaymentSourceAdd: p, isTrial: h = !1, disabled: E = !1, className: b, optionClassName: y, dropdownLoading: S, paymentGatewayRestrictions: A } = e,
        N = 0 === n.length,
        C = (e) => {
            if (e === O) null != p && p();
            else {
