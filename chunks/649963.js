"use strict";
n.d(t, { BB: () => v, Go: () => O, Jf: () => b, ao: () => N, et: () => D, on: () => R, qN: () => T });
var i,
    r = n(636537),
    s = n(765178),
    a = n(228366),
...
async function v(e, t, n) {
    ...
    if (
        !R &&
        ((i = e), (a = t), (d = n), (p = N), null != (E = h.A.getMessage(i, a)) && E.userHasReactedWithEmoji(d, p))
    )
    ...
    let O = await L(n, N);
    return (
        y("MESSAGE_REACTION_ADD", e, t, n, { burst: N, colors: O }),
        await c.A.unarchiveThreadIfNecessary(e),
        r.Bo.put({
            url: C({ channelId: e, messageId: t, emoji: n, userId: "@me" }),
            query: { location: m, type: N ? u.v.BURST : u.v.NORMAL },
            oldFormErrors: !0,
            rejectWithError: !1,
        })
            .then(() => {
            ...
            .catch((i) => {
                S(i, () => v(e, t, n, m, { burst: N, isRetry: !0 }), { isRetry: R }) &&
                    (y("MESSAGE_REACTION_REMOVE", e, t, n, { burst: N }),
                    N
