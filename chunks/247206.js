...
n(388032);
let v = {
        [E.TI.DISABLED.valueOf()]: r.Q4.SHOW,
        [E.TI.NON_FRIENDS.valueOf()]: r.Q4.SHOW,
        [E.TI.FRIENDS_AND_NON_FRIENDS.valueOf()]: r.Q4.BLOCK
    },
    y = {
        [E.TI.DISABLED.valueOf()]: r.Q4.SHOW,
        [E.TI.NON_FRIENDS.valueOf()]: r.Q4.BLOCK,
        [E.TI.FRIENDS_AND_NON_FRIENDS.valueOf()]: r.Q4.BLOCK
    },
    I = {
        [E.TI.DISABLED.valueOf()]: r.Q4.BLUR,
        [E.TI.NON_FRIENDS.valueOf()]: r.Q4.BLUR,
        [E.TI.FRIENDS_AND_NON_FRIENDS.valueOf()]: r.Q4.BLOCK
    },
    b = {
        [E.TI.DISABLED.valueOf()]: r.Q4.BLUR,
    ...
    C = () => {
        ...
        return {
            explicitContentGuilds: S({ setting: null == e ? void 0 : e.explicitContentGuilds }),
...
function O(e) {
    ...
    let { explicitContentGuilds: i, explicitContentFriendDm: r, explicitContentNonFriendDm: a } = C(),
        s = c.Z.getChannel(e.channel_id);
    return null != s && (s.isDM() || s.isGroupDM() ? (null != e.author && d.Z.getFriendIDs().includes(e.author.id) ? R(r) : R(a)) : R(i));
}
let D = (e) => {
    let t = C();
    u.Sh.updateSetting({
...
function L(e, t) {
    ...
    switch (e.type) {
        case 1:
            return (0, p.yE)(null !== (n = e.media.flags) && void 0 !== n ? n : 0, g.xPJ.CONTAINS_EXPLICIT_MEDIA);
        case 0:
            return (0, p.yE)(null !== (i = e.media.flags) && void 0 !== i ? i : 0, g.J0y.CONTAINS_EXPLICIT_MEDIA);
        case 2:
...
function G(e) {
    ...
    _.default.track(g.rMx.EXPLICIT_MEDIA_ACTION, {
        action: t,
...
function Z(e, t) {
    ...
    o.Z.increment({
        ...
        tags: ['timingBucket:'.concat(n), 'source:'.concat(t), 'metricVersion:'.concat(T)]
    });
}
function F(e) {
    var t, n, r, a;
    ...
    _.default.track(g.rMx.EXPLICIT_MEDIA_SCAN_CLIENT_TIMED_OUT, {
        channel_id: s,
...
function V(e) {
    ...
    _.default.track(g.rMx.EXPLICIT_MEDIA_REDACTABLE_MESSAGES_LOADED, {
        channel_id: t,
...
function j(e) {
    ...
    _.default.track(g.rMx.EXPLICIT_MEDIA_RETROACTIVE_SCAN_COMPLETE, {
        message_id: t,
        channel_id: n,
...
let K = (e, t) => null != e && null != t && (e <= m.LN || t <= m.iE);
