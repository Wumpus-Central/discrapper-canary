    ...
    (0, r.N)(() => {
        ...
        (0, d.useEffect)(() => {
            let e = (0, i.bq)((0, a.TW)(u.current ? u.current[0] : void 0)),
                t = null;
            if (A(e, u.current)) {
                for (let n of U.traverse()) n.scopeRef && A(e, n.scopeRef.current) && (t = n);
            ...
            () => () => {
                ...
                let r =
                    null != (n = null == (t = U.getTreeNode(u)) || null == (e = t.parent) ? void 0 : e.scopeRef)
                        ? n
                        : null;
                (u === _ || S(u, _)) && (!r || U.getTreeNode(r)) && (_ = r), U.removeTreeNode(u);
            },
            [u],
        );
...
function m(e) {
    return {
        focusNext(t = {}) {
            var n;
            let r = e.current,
                { from: s, tabbable: o, wrap: l, accept: c } = t,
                u = s || (0, i.bq)((0, a.TW)(null != (n = r[0]) ? n : void 0)),
            ...
            f.currentNode = A(u, r) ? u : d;
            let p = f.nextNode();
            return !p && l && ((f.currentNode = d), (p = f.nextNode())), p && I(p, !0), p;
        },
        focusPrevious(t = {}) {
            var n;
            let r = e.current,
            ...
            return !p && l && ((f.currentNode = d), (p = f.previousNode())), p && I(p, !0), p;
        },
        focusFirst(t = {}) {
            let n = e.current,
...
function y(e, t) {
    ...
    (0, r.N)(() => {
        ...
        let l = (0, a.TW)(r ? r[0] : void 0),
            ...
            d = (t) => {
                (!_ || S(_, e)) && A((0, i.wt)(t), e.current)
                    ? ((_ = e), (n.current = (0, i.wt)(t)))
                    : E(e) && !v((0, i.wt)(t), e)
                      ? n.current
                          ? n.current.focus()
...
function N(e, t) {
    ...
    (0, d.useEffect)(() => {
        if (n.current) {
            ...
            !A((0, i.bq)(t), _.current) && e.current && C(e.current);
        }
        n.current = !1;
    }, [e]);
}
...
function P(e, t, n) {
    ...
    (0, r.N)(() => {
        ...
        if (!t || n) return;
        let o = () => {
            (!_ || S(_, e)) && A((0, i.bq)(s), e.current) && (_ = e);
        };
        return (
            s.addEventListener("focusin", o, !1),
            null == r || r.forEach((e) => e.addEventListener("focusin", o, !1)),
        ...
        (0, r.N)(() => {
            ...
            let i = (t) => {
                ...
                if (
                    ...
                    while (v(o, e));
                    t.preventDefault(), t.stopPropagation(), o ? I(o, !0) : O(a) ? I(a, !0) : n.blur();
                }
            };
            return (
                                ...
                                if (r.activeElement === r.body) {
                                    ...
                                    for (n = t.getTreeNode(e); n; ) {
                                        if (n.scopeRef && n.scopeRef.current && U.getTreeNode(n.scopeRef))
                                            return void D(T(n.scopeRef.current, !0));
                                        n = n.parent;
                                    }
                                }
                            });
...
function x(e, t, n) {
    let r = (null == t ? void 0 : t.tabbable) ? o.A : o.t,
        ...
        s = (0, a.TW)(i),
        c = (0, l.H)(s, e || s, NodeFilter.SHOW_ELEMENT, {
            acceptNode(e) {
                var i;
                return (null == t || null == (i = t.from) ? void 0 : i.contains(e)) ||
                    ...
                    : r(e) && (!n || A(e, n)) && (!(null == t ? void 0 : t.accept) || t.accept(e))
...
function L(e, t = {}) {
    return {
        focusNext(n = {}) {
            let r = e.current;
            if (!r) return null;
            let { from: s, tabbable: o = t.tabbable, wrap: l = t.wrap, accept: c = t.accept } = n,
                u = s || (0, i.bq)((0, a.TW)(r)),
                d = x(r, {
                    tabbable: o,
                    accept: c,
            ...
            let f = d.nextNode();
            return !f && l && ((d.currentNode = r), (f = d.nextNode())), f && I(f, !0), f;
        },
        focusPrevious(n = t) {
            let r = e.current;
            if (!r) return null;
