...
function _(e) {
    ...
    function p(e) {
        ...
        ((t.exposureType = n ? u.vf.AUTO_FALLBACK : u.vf.AUTO), (t.excluded = !1), null == r) ? h(e, t) : E(e, t, r);
    }
    function h(t) {
        let n =
    ...
    function m(t, n) {
        ...
        function f() {
            ...
            (s !== a || l !== o) && (n(d(e, s, _, r), s, o), (a = s), (l = o));
        }
        return (
            n(d(e, a, _, s), a, l),
    ...
    return {
        useExperiment: function (t) {
            let n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : { autoTrackExposure: !0 },
                ...
                [[h, E, g], A] = (0, r.useState)(() => {
                    let t = null == o || s ? u.RE.NOT_ELIGIBLE : o.bucket;
                    return [d(e, t, _, o), t, null == o ? -1 : o.revision];
                }),
                I = (0, i.A)(t);
            return (
                (0, r.useEffect)(() => {
                    !s && (a || f) && null == e.commonTriggerPoint && p(I, l, !1 === a);
                }, [s, a, I, l, E, g, f]),
                (0, r.useEffect)(
                    () =>
                        m(
        ...
        getCurrentConfig: function (t) {
            let n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : { autoTrackExposure: !0 },
                r = c(e.kind, e.id, t);
            if (null == r || n.disable) return d(e, u.RE.NOT_ELIGIBLE, _, r);
