...
class k extends I.ZP {
    ...
    async uploadFileToCloud() {
        ...
        let n = (0, p.m)({ location: "CloudUpload" });
        if (n.enableNewRetry)
            return (
                (0, S.Z_)(this.item) &&
    ...
    async upload() {
        ...
        let f = _.Z.getCurrentConfig({ location: "CloudUpload" }, { autoTrackExposure: !0 }),
            p = null;
        f.enabled;
        try {
    ...
    static async tryConvertToWebP(e, t, n) {
        ...
        try {
            ...
            D.warn("webp conversion failed for ".concat(n, ":"), e), (c.conversionFailureReason = A.S8.UNKNOWN_ERROR);
        }
