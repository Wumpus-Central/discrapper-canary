...
class P extends Error {
    ...
    constructor(e, t = {}) {
        ...
        let { cause: i, response: o } = t,
            a = P.getErrorKind(null != i ? i : Error(''.concat(null != (n = null == o ? void 0 : o.text) ? n : 'Unknown error')), o),
            s =
                'server_error' === a
                    ? ''
                          .concat(e, ':')
                    ...
                    : ''.concat(e, ':').concat(a);
        (super(s, { cause: i }), T(this, 'kind', void 0), T(this, 'phase', void 0), T(this, 'messageShort', void 0), (this.name = 'ResumableUploadError'), (this.phase = e), (this.kind = a), (this.messageShort = s));
    }
}
let w = 'Content-MD5';
var D = (function (e) {
...
class x extends y.ZP {
    ...
    async upload() {
        ...
        if ((null != (e = this.currentSize) ? e : 0) > o.getMaxFileSize(this.channelId)) return void this.handleError(I.evJ.ENTITY_TOO_LARGE);
    ...
    async reactNativeCompressAndExtractData() {
        ...
        C.log('Completed compression and conversion. Output size='.concat(s, ' bytes; filename=').concat(i, '; mimeType=').concat(a, ' for ').concat(this.id));
        let l = {
            uri: r,
            filename: i,
            mimeType: a
