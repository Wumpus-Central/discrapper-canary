...
function S(e) {
    ...
    let _ = s || E(r),
        A = _ && (0, f.d)(r),
        I = { modalKey: T.SW, onCloseCallback: t, backdropStyle: m(r), Layer: l.Ay, dismissable: !A };
    return (
        _
...
let C = {
    ...
    showManualReviewPendingModal: function () {
        (0, a.openModalLazy)(
            async () => {
                let { default: e } = await Promise.all([n.e("417886"), n.e("492758")]).then(n.bind(n, 174453));
                return (t) => (0, i.jsx)(e, { ...t });
            },
            { modalKey: T.v7 },
        );
