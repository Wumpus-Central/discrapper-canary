...
function B(e, t) {
    ...
    return D(
        ...
        r.useMemo(() => {
            var e;
            return null != (e = null == n ? void 0 : n.color) ? e : x.p6O;
        }, [n])
    );
}
function U(e, t) {
    ...
    return D(
        e,
        'channelAccessFormat',
        r.useMemo(() => (null == n ? _.I.SOME_CHANNELS_ACCESS : (0, y.MT)(n) ? _.I.ALL_CHANNELS_ACCESS : _.I.SOME_CHANNELS_ACCESS), [n])
    );
}
let F = [];
function G(e) {
    ...
    return [
        r.useMemo(() => {
            ...
            return {
                ...
                currency: null != (r = null == t ? void 0 : t.currency) ? r : x.pKx.USD,
