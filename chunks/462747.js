...
function j(e) {
    let { eventUser: n, guildId: t, onContextMenu: r } = e,
        s = l.useRef(null),
        u = (0, d.e7)([I.default], () => I.default.getUser(n.user_id)),
        f = (0, d.e7)([m.Z, p.Z, g.default], () => (n.user_id === g.default.getId() ? m.Z.getStatus() : p.Z.getStatus(n.user_id, t)), [n.user_id, t]);
    return null == u
        ? null
        : (0, i.jsx)(_.Z, {
              targetElementRef: s,
