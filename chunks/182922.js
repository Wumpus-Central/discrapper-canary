...
let h = (e) => {
        ...
        return (0, i.jsxs)("div", {
            className: s()(E.KT, t === u.tm.TOP_GUILD_EMOJI ? E.S7 : E.lD),
            children: [
                t === u.tm.TOP_GUILD_EMOJI
                    ? (0, i.jsx)(d, { foreground: E.Gb })
                    : (0, i.jsx)(_.A, { foreground: E.Gb }),
                (0, i.jsx)(a.E, {
            ...
            children: [
                ...
                (0, i.jsxs)("div", {
                    ...
                    children: [
                            ...
                            children: [
                                _
                                    ? (0, i.jsx)(o.G, {
                                          size: "custom",
                                          color: "currentColor",
                                          "aria-label": c.intl.formatToPlainString(c.t["+fdUkf"], { names: l }),
                                          width: 15,
                                          height: 15,
                                          className: E.BI,
                                      })
                        ...
                        null != d && (0, i.jsx)(a.E, { className: E.Fm, variant: "text-xs/normal", children: d }),
                    ],
                }),
                m === u.tm.NONE
                    ? null != r && (0, i.jsx)("div", { className: E.vK, "aria-hidden": !0, children: r })
                    : (0, i.jsx)(h, { emojiSubCategory: m }),
            ],
        });
    };
