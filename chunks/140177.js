...
class S extends i.PureComponent {
    ...
    handleBeforeInput(e) {
        ...
        if (null == t.composition) {
            ...
            if (e.inputType.startsWith("deleteContent") && null != r && !r.collapsed) {
                let n = E.VW.toSlateRange(t, r, { exactMatch: !0, suppressThrow: !0 });
                null != n &&
                    E.ZF.isExpanded(n) &&
                    ((t.selection = n),
    ...
    handleCompositionStart() {
        ...
        if (null == (null != i ? E.VW.toSlateRange(e, i, { exactMatch: !0, suppressThrow: !0 }) : null) && null != i) {
            ...
            (e.selection = null), null != t ? h.b.select(e, t) : h.b.select(e, E.VW.end(e, []));
        }
        e.composition = t;
    }
    handleCompositionEnd(e) {
        ...
        if (n && null != t.selection && E.ZF.isCollapsed(t.selection)) {
            ...
            E.VW.withoutNormalizing(t, () => {
                ...
                h.b.delete(t, { unit: "offset", distance: n.text.length, reverse: !0 }), E.VW.insertText(t, e);
            });
        }
        t.composition = null;
    }
        ...
        if (c.isPlatformEmbedded) {
            ...
            (0, l.L3)(
                ...
                async () => {
                    ...
                    return (n) => (0, r.jsx)(e, { ...n, editor: t, text: E.VW.getSelectedText(t, !0) });
                },
                {
                    align: null != i && null != s && i < s / 2 ? "top" : "bottom",
                    enableSpellCheck: a === A.BRT.APP,
