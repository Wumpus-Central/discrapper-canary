                ...
                switch (n.key.toLowerCase()) {
                    ...
                    case '+':
                        (r || w) &&
                            ...
                            (n.preventDefault(), y.S.dispatchKeyed(S.LPv.TOGGLE_REACTION_POPOUT, R.id, { emojiPicker: !0 }));
                        break;
                    case 'r':
                    ...
                    case 'enter':
                        ...
                        break;
                    case 'escape':
                        f.Z.isEditing(k.id, R.id) ? i.Z.endEditMessage(k.id) : y.S.dispatch(S.CkL.TEXTAREA_FOCUS);
                }
            },
            [e, t]
        )
