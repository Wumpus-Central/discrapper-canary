...
function M(e, t, n) {
    ...
    let l = n.getGuildId();
    return !((null != l && u.Z.isLurking(l)) || (!i.ignoreSameUser && t.id === e.id) || v.Z.isBlockedOrIgnored(t.id) || (!i.ignoreStatus && m.Z.getStatus() === L.Skl.DND) || N.QZ.getSetting() || (!i.ignoreNoMessagesSetting && A.ZP.allowNoMessages(n)));
}
function W(e, t) {
    var n, a;
    ...
    let d = y.default.getCurrentUser(),
        c = y.default.getUser(null === (n = e.author) || void 0 === n ? void 0 : n.id);
    if (
        null == u ||
        null == d ||
        null == c ||
...
function w(e, t) {
    ...
    let l = y.default.getCurrentUser(),
        a = y.default.getUser(null === (n = e.author) || void 0 === n ? void 0 : n.id);
    return !(null == i || null == l || null == a || i.isManaged() || a.hasFlag(L.xW$.SPAMMER) || v.Z.isBlockedOrIgnoredForMessage(e) || a.id === l.id || m.Z.getStatus() === L.Skl.DND || N.QZ.getSetting() || A.ZP.allowNoMessages(i)) && e.type !== L.uaV.CHAT_WALLPAPER_SET && e.type !== L.uaV.CHAT_WALLPAPER_REMOVED;
}
function V(e, t) {
    ...
    return (
        !(
            ...
            A.ZP.isGuildOrCategoryOrChannelMuted(t.guild_id, t.id)
        ) &&
        (!!n || h.Z.getChannelId(Z.Z.getGuildId()) !== t.id) &&
        A.ZP.getNewForumThreadsCreated(t)
    );
}
let F = (e, t, n) =>
    ''
        .concat(e, ' (')
        .concat((0, a.F6)(t, y.default, v.Z, !0))
        .concat(null != n ? ', '.concat((0, a.F6)(n, y.default, v.Z)) : '', ')');
function H(e, t, n, i) {
    switch (e.type) {
...
function x(e, t, n) {
    let i;
    let l = D.ZP.getName(e.getGuildId(), e.id, n),
        u = l;
    switch (e.type) {
        case L.d4z.GUILD_ANNOUNCEMENT:
        case L.d4z.GUILD_TEXT:
        ...
        case L.d4z.PRIVATE_THREAD:
            ...
            break;
        case L.d4z.GROUP_DM:
            (e.isManaged() && n.bot && u === (0, a.F6)(e, y.default, v.Z)) || (u = ''.concat(u, ' (').concat((0, a.F6)(e, y.default, v.Z, !0), ')'));
    }
    let f = t.content;
    ...
    if ('message_reference' in t ? (0, r.s)(t) : (0, r.Z)(t)) i = k.NW.string(k.t['9ddYKi']);
