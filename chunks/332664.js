...
function j(e) {
    var t;
    let { modalType: n, header: i, body: s, problemTitle: v, problems: j, transitionState: R, ratingOptions: T, ratingEmojiKind: I, ratingTextLabels: L, freeformNeededProblems: y = [], otherKey: D, hideDontShowAgainCheckbox: k, startRating: C = null, hideHelpDeskLink: P = !1, onSubmit: A, onClose: F, impression: Z, freeformDescription: M } = e,
        U = (0, d.Z)(j),
        [B, $] = a.useState(!1),
        [w, G] = a.useState(C),
        [H, z] = a.useState(null),
        ...
        en = null;
    return (
        null == w ? (en = 'RATING') : w !== N.aZ.GOOD && null == H ? (en = 'PROBLEM') : null != H && y.includes(H.value) && (en = 'FREEFORM'),
        a.useEffect(() => {
            u().isEqual(U, j) || J((0, p.Bi)(j, D));
        }, [j, U, D]),
        (0, o.ZP)(
            () => (
