...
function eM(e, t, n) {
    ...
    let E,
        b,
        { device: y, progress_ms: O, is_playing: v, repeat_state: I, item: S, context: T } = n;
    ...
    if ((null != y && !0 !== y.is_active && (y = k(L({}, y), { is_active: !0 })), null != T && [P.Hw.PLAYLIST, P.Hw.ALBUM].includes(T.type))) {
