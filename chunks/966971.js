...
class n {
    ...
    style;
    animated;
    constructor({ src: e, style: c, animated: t }) {
        (this.src = e), (this.style = c), (this.animated = t);
    }
    getSrc = (() => {
        var e = this;
        return function () {
            let c = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
            return "string" == typeof e.src ? e.src : c ? e.src.dark : e.src.light;
        };
    })();
}
let p = {
    ...
    i = (e) => {
        let { purchaseType: c, skuId: t } = e;
        if (c === a.gs.ORB) return p.ORB_PURCHASE;
        switch (t) {
    ...
    r = (e) => ("1262491137386614805" === e ? p.ROBERT : null);
