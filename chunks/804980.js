...
function F(e) {
    let { participants: t, application: n, channel: s, width: l } = e,
        ...
        N = (0, m.vG)({ userId: w.default.getCurrentUser()?.id, channelId: s.id, application: n }) === m.Gy.CAN_JOIN,
    ...
    return (0, i.jsxs)("div", {
        className: k.Yi,
        children: [
            (0, i.jsx)(G, { avatarSize: g, guildId: v, channelId: s.id, users: A }),
            (0, i.jsx)(c.E, {
...
function V(e) {
    let { participant: t, width: n, selected: s, interactible: a, channel: l } = e,
        { analyticsLocations: u } = (0, C.Ay)(v.A.ACTIVITY_TILE),
        { applicationId: c } = t,
        d = (0, g.A)(),
        ...
        m = !_,
        S = !_ && !s,
        R = (0, o.bG)([L.A, b.A], () => (0, N.A)({ LayerStore: L.A, PopoutWindowStore: b.A }));
    return (
        r.useEffect(() => {
            if (p && null != d && !R) {
