...
function j(e) {
    let { participants: t, application: n, channel: s, width: u } = e,
        ...
        C = (0, h.p)(),
        N = L.Ay.getName(s.getGuildId(), s.id, S?.[0]),
    ...
    return (0, i.jsxs)("div", {
        className: G.Yi,
        children: [
            (0, i.jsx)(F, { avatarSize: p, guildId: v, channelId: s.id, users: S }),
            (0, i.jsx)(d.E, {
...
function V(e) {
    let { participant: t, width: n, selected: s, interactible: r, channel: o } = e,
        ...
        [g] = (0, D.A)([d]),
        { url: f } = (0, S.A)({ applicationId: d, names: b, size: 1024 }),
        A = !s && h,
        I = !h,
        C = !h && !s,
