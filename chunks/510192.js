n.d(t, { iV: () => og, OC: () => oA, Ay: () => op }), n(938796);
var i,
    l,
    s = n(627968),
    r = n(64700),
...
function ei(e) {
    let { app: t, linkType: n, activityCustomId: i, activityReferrerId: l, message: a, onView: o } = e,
        ...
        C = (0, u.bG)([M.default], () => l ?? M.default.getId(), [l]),
        { analyticsLocations: v } = (0, E.Ay)(x.A.APP_MESSAGE_EMBED),
        { currentChannelId: _, instanceId: N, isCurrentlyInInstance: b, canLaunchInChannel: R } = (0, V.w)(t.id),
        P = (0, T.A)(),
        ...
        }, [h, Y, B, t.id, G, U, N, b, _, P, i, C, v, m]),
...
function em(e) {
    let { application: t, customId: n, customLink: i, referrerId: l, message: r } = e,
        ...
        d = null != t && (0, f.Ag)(t),
        c = null != a && d && o,
        { analyticsLocations: m } = (0, E.Ay)(x.A.ACTIVITY_CUSTOM_LINK),
...
function eh(e) {
    let { application: t, message: n, params: i } = e,
        ...
        { analyticsLocations: o } = (0, E.Ay)(x.A.ACTIVITY_BOOKMARK),
...
let eK = (0, u.UT)([eO.A, eU.A, eM.A], {
    ...
    eW = (0, u.UT)([eO.A], {
        ...
        load: async (e, t) => {
            eI()(null != e && null != t, "appId is null"), await (0, ek.JI)(t);
        },
    });
function eJ(e) {
...
function eq(e) {
    let { application: t, skuId: i, message: l } = e,
        ...
        g = (0, eH.G)(t.id),
        { openModal: p, subscriptionPurchaseButtonState: A } = (0, eP.A)({ skuId: i, initialSubscribeForGuild: m });
...
function e9(e) {
    let { application: t, message: n } = e,
        { analyticsLocations: i } = (0, E.Ay)(x.A.APP_OAUTH2_LINK_EMBED),
        l = r.useCallback(() => {
            (0, e4.x)({
...
class td extends u.Ay.Store {
    ...
    initialize() {
        this.waitFor(M.default, D.A, tl.A, G.default), (ta = new Set(tn.w.get(tr)));
    }
    shouldShowBump(e) {
        return to.has(e);
    }
                      ...
                      (0, s.jsxs)("div", {
                          ...
                          children: [
                              (0, s.jsxs)(e8.D, {
                                  ...
                                  className: tb.qP,
                                  children: [J.intl.string(tS.default.KSBBpC), " ", (0, s.jsx)(tE.t, {})],
                              }),
                              (0, s.jsx)(p.E, {
...
async function nc(e) {
    ...
    if (null == l && null != t && null == tF.A.getGuild(t))
        try {
            await (0, nd.Z2)(t, { object: W.ZSU.FORWARD_BREADCRUMB }, { shouldNavigate: !1 }),
                (s = !0),
                await (0, no.k)(t),
                (l = D.A.getChannel(n));
        } catch {}
...
function nx(e) {
    let { message: t, snapshot: n, index: i, disableComponentInteractivity: l } = e,
        a = r.useMemo(() => (0, nu.A)(t, n), [t, n]),
        o = nn.hD.useSetting(),
        d = nn.rs.useSetting(),
        c = (0, u.bG)([ni.A], () => ni.A.isDeveloper),
        m = (0, t9.S)((a.editedTimestamp ?? a.timestamp).valueOf()),
        {
            content: h,
            hasSpoilerEmbeds: g,
            hasBailedAst: p,
        ...
        A = (0, u.bG)([D.A], () => D.A.getChannel(t.channel_id)),
        x = nn.hH.useSetting();
    return null == A
        ? null
        : (0, s.jsxs)(
              "div",
              {
                  ...
                  children: [
                      ...
                      (0, s.jsxs)("div", {
                          ...
                          children: [
                              (0, s.jsx)(ng, {}),
                              (0, s.jsx)(t7.Ay, { message: a, content: h, compact: x }),
                              (0, ne.A)({
                                  channelMessageProps: { message: a, channel: A, compact: x },
                                  hasSpoilerEmbeds: g,
                                  hasBailedAst: p,
                                  isInteracting: !1,
                                  isMessageSnapshot: !0,
...
function nE(e) {
    ...
    return (0, s.jsx)(s.Fragment, {
        children: t.messageSnapshots.map((e, i) =>
            (0, s.jsx)(nx, { message: t, snapshot: e, index: i, disableComponentInteractivity: n }, i),
        ),
    });
}
var nf = n(643612),
...
function nS(e) {
    let { code: t, message: n } = e,
        ...
        o = (0, nv.bG)([U.A], () => U.A.getGuildId() ?? void 0),
        [d, c] = r.useState(!1),
        u = r.useCallback((e) => {
            e && c(!0);
        }, []),
        ...
        h = r.useCallback(() => {
            eG.default.track(W.HAw.APP_DIRECTORY_PROFILE_EMBED_VIEWED, {
                application_id: t,
                device_platform: nC.Fr ? "mobile_web" : "desktop_web",
    ...
    l)
        ...
        : null == i || a === nT.e.FETCHING
          ...
          : (0, s.jsx)(ei, { app: nN.Ay.createFromServer(i), linkType: et.J.APP_DISCOVERY, onView: h, message: n });
}
var nb = n(229527),
    nL = n(870136),
    nk = n(330075),
...
function nV(e) {
    let { code: t } = e,
        i = (0, u.bG)([nU.A], () => nU.A.getGuildTemplate(t));
    if (null == i || i.state === nG.QB.RESOLVING)
    ...
    let l = __OVERLAY__
        ...
        : (0, s.jsx)(eg.$, {
              ...
              loading: i.state === nG.QB.ACCEPTING,
              variant: "active",
...
function iu(e) {
    let { embedUrl: t, message: n, channel: i } = e,
        ...
        d = (function (e, t) {
            let n = (0, io.CI)(e),
                ...
                s = t.hasFlag(W.pr7.IS_CROSSPOST),
                {
                    ...
                    selectedGuildId: u,
                    canAccess: m,
                } = (0, nv.cf)([ia.A, tF.A, D.A, G.default, U.A], () => {
        ...
        h = (0, it.j)(),
        [g, A] = r.useState(!1),
        [E, f] = r.useState(d?.coverImage == null),
        I = (0, nv.bG)([ie.Ay, G.default], () => ie.Ay.isMember(d?.guildId, G.default.getCurrentUser()?.id), [d]),
        ...
        [_, N, j] = r.useMemo(() => [C?.colorString ?? "inherit", C?.colorStrings ?? null, C?.colorRoleId], [C]),
        T = (0, n7.gn)(C?.guildId, d?.authorId ?? void 0, N),
        { reducedMotion: y } = r.useContext(nQ.C),
        [S, b] = r.useState(!1),
        L = r.useCallback(() => {
            A(!0);
        }, [A]),
    ...
    let P = (0, w.F_)({ avatarDecoration: v, size: (0, n3.Te)(tI._3.SIZE_40), canAnimate: S }),
...
let iM = (e) => {
    let { reportingUserId: t, guildId: n, compact: i, channel: l, messageId: a, reportedTimestamp: d } = e,
        ...
        u = r.useMemo(() => (i ? (0, iS.A)((0, ns.i$)(iT()(), "LT")) : null), [i]),
        m = (0, ib.P)({ user: c, channelId: l.id, guildId: n, messageId: a })((0, t_.m2)(c, l)),
        h = null != c ? c.getAvatarURL(n, (0, tI.FT)(tI._3.SIZE_16)) : iP,
        g =
            null != c
                ? J.intl.format(iL.default["+zqXZs"], { username: c.username, onUserClick: m })
                : J.intl.string(iL.default.xpRjfS);
    return (0, s.jsxs)("div", {
        className: o()(iR.NB, iR.JZ, u),
        children: [
            (0, s.jsx)(tf.eu, { src: h, size: tI._3.SIZE_16, className: ik.my, "aria-label": "" }),
            (0, s.jsx)(p.E, { variant: "text-sm/medium", color: "text-subtle", className: ik.Xh, children: g }),
            (0, s.jsxs)(p.E, {
                variant: "text-sm/medium",
                color: "text-subtle",
                children: [
                    (0, s.jsx)("span", { className: ik.Ek, children: "\u2022" }),
                    (0, s.jsx)(iy.A, { timestamp: d, className: ik.vE }),
                ],
            }),
        ],
    });
...
function iO(e) {
    let { message: t, snapshot: n, index: i } = e,
        ...
        o = r.useCallback(() => {
            let e = D.A.getChannel(t.channel_id),
                ...
                s = iN.Ay.getCurrentSidebarChannelId(t.messageReference?.channel_id),
                r = l === i && s === e?.id;
            null == e ||
                null == n ||
                r ||
                null == i ||
                (i_.A.openModReportAsSidebar({ channelId: e.id, baseChannelId: i, guildId: e.guild_id }),
                (0, iv.iN)(i),
    ...
    return null == a
        ...
        : (0, s.jsxs)(eb.D, {
              ...
              children: [
                  null != a.originIconUrl
                      ? (0, s.jsx)("img", { className: iD.yl, src: a.originIconUrl, alt: "" })
                      : null,
                  (0, s.jsx)(p.E, {
                      className: iD.PJ,
                      variant: "text-sm/medium",
...
function iU(e) {
    ...
    return (0, s.jsx)(iE.A, {
        childrenExecutedCommand: (0, s.jsx)(iM, {
            reportingUserId: l,
            guildId: i.guild_id,
            channel: i,
            messageId: t.id,
...
function iG(e) {
    ...
    r.useEffect(() => {
        n?.moderatorReport?.reported_user_id != null &&
            (0, ix.wz)(n.moderatorReport.reported_user_id)
                .then((e) => {
                    a(e);
                })
                .catch(() => {});
              ...
              "div",
              {
                  ...
                  children: (0, s.jsxs)("div", {
                      ...
                      children: [
                          ...
                          (0, s.jsx)(iO, { message: t, snapshot: n, index: i }),
                      ],
                  }),
              },
              i,
...
function iw(e) {
    let { message: t } = e;
    return (0, s.jsx)(s.Fragment, {
        children: t.messageSnapshots.map((e, n) => (0, s.jsx)(iG, { message: t, snapshot: e, index: n }, n)),
    });
}
var iB = n(302031),
    iV = n(738188),
...
function iz(e) {
    ...
    let t = e.message.embeds[0],
        i = t.fields?.find((e) => e.rawName === iF.AT.CLASSIFICATION_ID) ?? void 0,
        l = i?.rawValue ?? void 0,
        r = t.fields?.find((e) => e.rawName === iF.AT.INCIDENT_TIMESTAMP) ?? void 0,
                  ...
                  (0, s.jsxs)("div", {
                      ...
                      children: [
                          (0, s.jsxs)("div", {
                              className: iY.U1,
                              children: [
                                  (0, s.jsx)(iV.i, { className: iY.QW, color: tD.A.colors.ICON_FEEDBACK_CRITICAL }),
                                  (0, s.jsx)(p.E, {
                                      variant: "text-md/semibold",
                          ...
                          (0, s.jsx)("div", {
                              ...
                              children: (0, s.jsx)(p.E, {
                                  variant: "text-xs/medium",
                                  children: J.intl.format(J.t.eevFb6, { daysAgo: iT()().diff(iT().unix(a), "days") }),
                              }),
                          }),
                          (0, s.jsx)("div", {
                              className: iY.vv,
...
function iX(e) {
    ...
    return (0, s.jsx)(iK.Anchor, { className: iJ.zh, href: t, children: J.intl.string(J.t["8/GdRB"]) });
}
function iZ(e) {
    let { ctaType: t, classificationId: n, learnMoreLink: i } = e;
    switch (t) {
        case iF.xw.POLICY_VIOLATION_DETAIL:
            if (null == n) return null;
            return (0, s.jsx)(iq, { classificationId: n });
        case iF.xw.LEARN_MORE_LINK:
            if (null == i) return null;
            return (0, s.jsx)(iX, { learnMoreLink: i });
        default:
            return null;
    }
}
function i$(e) {
    let { iconType: t } = e,
        n = {
            ...
            danger: (0, s.jsx)(iV.i, { color: tD.A.colors.ICON_FEEDBACK_CRITICAL }),
        };
    return null != t && t in n ? (0, s.jsx)("div", { className: iJ.Kk, children: n[t] }) : null;
}
function iQ(e) {
    let { children: t, theme: n } = e,
        i = { default: iJ._y, danger: iJ.yk };
    return (0, s.jsx)("div", { className: i[n ?? "default"], children: t });
}
function i0(e) {
    let t;
    if (null == e.embed || null == e.embed.fields) return null;
    let n = (0, iW.f4)(e.embed);
    return null == n
        ? null
        : (0, s.jsxs)(eb.D, {
              className: iJ.o3,
                          ...
                          (0, s.jsx)("div", {
                              ...
                              children: (0, s.jsx)(p.E, {
                                  ...
                                  children: J.intl.format(J.t.eevFb6, {
                                      daysAgo: ((t = n.timestamp ?? 0), iT()().diff(iT().unix(t), "days")),
                                  }),
                              }),
                          }),
                          (0, s.jsx)("div", {
...
function lv(e) {
    ...
    return (0, s.jsxs)(la.A, {
        children: [
            (0, s.jsx)(ln.A, { sticker: t, size: 48, isInteracting: !0 }),
            (0, s.jsxs)(la.A, {
                direction: la.A.Direction.VERTICAL,
                justify: la.A.Justify.CENTER,
                className: lI.bM,
                children: [
                    (0, s.jsx)(p.E, { variant: "text-md/semibold", children: (0, s.jsx)(li.A, { children: t.name }) }),
...
let l_ = (e) => {
        let { closePopout: t, sticker: n, channel: i, refreshPositionKey: l } = e,
            [a, o, d] = (0, u.yK)(
                [lg.A],
                () => [lg.A.getStickerPack(n.pack_id), !lg.A.hasLoadedStickerPacks, lg.A.isPremiumPack(n.pack_id)],
                [n],
            ),
            c = ((e) => {
        ...
        o || null == a)
            ...
            : (0, s.jsxs)(i7.Uq, {
                  ...
                  children: [
                      ...
                      (0, s.jsx)("ul", {
                          className: lf.pQ,
                          children: c.map((e) => (0, s.jsx)(ln.A, { isInteracting: !0, size: 80, sticker: e }, e.id)),
                      }),
                      d &&
                          (0, s.jsx)("div", {
                              className: lf.j0,
                                      ...
                                      onClick: () => {
                                          d &&
                                              (function (e) {
                                                  ...
                                                  lA._.dispatchToLastSubscribed(W.jej.OPEN_EXPRESSION_PICKER, {
                                                      activeView: lx.kx.STICKER,
                                                  });
                                                  let i = n.findIndex((e) => e.id === t.id);
                                                  -1 !== i && lp.bM.setActiveCategoryIndex(i);
    ...
    lN = (e) => {
        let t,
            ...
            A = lh.Ay.canUseCustomStickersEverywhere(g),
            ...
            { current: N } = r.useRef({ guild_id: i.getGuildId(), ...(0, tG.dI)(i) }),
            j = { stickerSourceGuild: x, refreshPositionKey: a },
            T = r.useRef(j);
        r.useEffect(() => {
            T.current = j;
        }),
            r.useEffect(() => {
                ...
                (async () => {
                    if (null == e || e.features.has(W.GuildFeatures.DISCOVERABLE)) {
                        ...
                        c(
                            await ((e = n.id),
                            ld.Bo.get({ url: W.Rsh.STICKER_GUILD_DATA(e), oldFormErrors: !0, rejectWithError: !0 })
        ...
        if (
            ...
            (0, lr.Ay)(() => {
                eG.default.track(W.HAw.OPEN_POPOUT, { type: L, ...N });
            }),
            !m)
        )
            return (0, s.jsx)(i7.Y0, { className: lf.v0 });
        {
            let e;
            return (0, s.jsxs)(i7.Uq, {
                className: lI.Bm,
                children: [
                    ((e = async () => {
                        if (null == d || E) return;
                    ...
                    (0, s.jsxs)("div", {
                        className: lI.gH,
                        children: [
                            (0, s.jsx)(lv, { description: t, sticker: n }),
                            b &&
                                (0, s.jsx)(lm.A, {
                                    className: lI.lI,
                                    subscriptionTier: lE.pe.TIER_2,
                                    size: ll.$n.Sizes.SMALL,
                                    fullWidth: !0,
                                    textOptions: { textOverride: J.intl.string(J.t["gl/XHJ"]) },
                                    onSubscribeModalClose: (t) => (t ? e() : l()),
                                    postSuccessGuild: E || null == d ? void 0 : d,
                    ...
                    (null != x || null != d) &&
                        (() => {
                            ...
                            let e = (d?.stickers ?? [])
                                    ...
                                    .filter((e) => e.id !== n.id)
                                    .slice(0, 12),
                                t = null != d ? lo.GO.createFromDiscoverableGuild(d) : lo.GO.createFromGuildRecord(x);
                            return (0, s.jsxs)("div", {
                                className: lI.tl,
                                children: [
                                    (0, s.jsx)(p.E, {
                                        ...
                                        color: "text-subtle",
                                        className: lI.YW,
                                        children: E ? J.intl.string(J.t.kx6pEG) : J.intl.string(J.t.pDE7Gb),
                                    }),
                                    (0, s.jsx)(lc.G7, {
                                        ...
                                        (0, s.jsxs)(s.Fragment, {
                                            children: [
                                                (0, s.jsx)(eb.D, {
                                                    ...
                                                    className: lI.wK,
                                                    children: (0, s.jsxs)(la.A, {
                                                        children: [
                                                            (0, s.jsx)(p.E, {
                                                                className: lI.__invalid_showMoreEmojisLabel,
                                                                variant: "text-xs/normal",
                                                                color: "none",
                                                ...
                                                f &&
                                                    (0, s.jsx)(la.A, {
                                                        wrap: la.A.Wrap.WRAP,
                                                        align: la.A.Align.START,
                                                        justify: la.A.Justify.START,
                                                        className: lI.LX,
                                                        children: e.map((e) =>
                                                            (0, s.jsx)(
                                                                i6.m,
...
let lT = (e) => {
    let { renderableSticker: t, channel: n, closePopout: i, refreshPositionKey: l } = e,
        [r, a] = (0, le.Zq)(t, !0);
    return null != r && (0, i3.FD)(r)
        ? (0, s.jsx)(l_, { sticker: r, closePopout: i, channel: n, refreshPositionKey: l })
        : null != r && (0, i3.Xw)(r)
          ? (0, s.jsx)(lN, { sticker: r, channel: n, closePopout: i, refreshPositionKey: l })
          : a
            ? null == r
                ? (0, s.jsx)(lj, { channel: n, closePopout: i, sticker: t })
                : (i(), null)
            : (0, s.jsx)(i7.Y0, {});
};
var ly = n(76513);
let lS = (0, i8.xI)(i5.A.STICKERS_CONSTANTS_STICKER_DIMENSION),
    lb = (e) => {
        let { renderableSticker: t, channel: n, isInteracting: i } = e,
            ...
            [u] = (0, le.Zq)(t, i),
            { analyticsLocations: m } = (0, E.Ay)(x.A.STICKER_MESSAGE),
            h = (0, s.jsxs)("span", {
                className: ly.Zl,
                children: [(0, s.jsx)(i4.s, { size: "xs", color: "currentColor", className: ly.lA }), (u ?? t).name],
            });
        return (0, s.jsx)(E.f5, {
            value: m,
            children: (0, s.jsx)("div", {
                className: ly.be,
                children: (0, s.jsx)(i9.Y, {
                    align: "center",
                    animation: i9.Y.Animation.TRANSLATE,
                    positionKey: d,
                    onRequestClose: () => {
                        o(!0);
                    },
                    ...
                    children: (e) => {
                        ...
                        return (0, s.jsx)(i6.m, {
                            ...i7.Uk,
                            shouldShow: a,
                            __unsupportedReactNodeAsText: (0, i7.yR)(h),
                            "aria-label": !1,
                            onTooltipShow: () => {
                                var e;
                                null != (e = u) &&
                                    tG.Ay.trackWithMetadata(W.HAw.EXPRESSION_TOOLTIP_VIEWED, {
                                        type: lE.e.STICKER_IN_MESSAGE_HOVER,
                                        expression_id: e.id,
                                        expression_name: e.name,
                                        is_animated: (0, lt.Tw)(e.format_type),
                                        is_custom: (0, lt.zN)(e.type),
                                    });
                            },
                            children: (0, s.jsx)(eb.D, {
                                ...
                                tag: "span",
                                children: (0, s.jsx)(ln.A, { isInteracting: i, size: lS, sticker: u ?? t }),
                            }),
                        });
                    },
                }),
...
function lY(e) {
    ...
    (0, lw.Eq)(a, "ThreadMessageAccessoryMessage");
    let o = r.useMemo(
        () =>
            null != t.content && "" !== t.content ? (0, lB.Ay)(t, { formatInline: !0, allowLinks: !0 }).content : null,
        [t],
    );
    return (0, s.jsxs)("div", {
        className: iR.up,
        children: [
            (0, s.jsx)("img", { alt: "", src: t.author.getAvatarURL(n.guild_id, 16), className: iR.FJ }),
            (0, s.jsx)(lH.A, { message: t, channel: n, compact: !0 }),
            (0, s.jsx)("div", {
                className: iR.Au,
                children: (function (e, t, n, i) {
                    let {
                        ...
                        leadingIcon: a,
                        trailingIcon: o,
                    } = (0, lV.o)(e, t, n, i, iR.tP, {
                        trailingIconClass: iR._v,
                        leadingIconClass: iR.a5,
                        iconSize: lF.eJ,
                    });
                    return (0, s.jsxs)(s.Fragment, {
                        children: [a, r ?? (0, s.jsx)("span", { className: iR.dp, children: l }), o],
                    });
                })(t, o, i, l),
            }),
        ],
...
function lJ(e) {
    let { message: t, compact: n } = e,
        i = (0, u.bG)([D.A], () => D.A.getChannel(lD.default.castMessageIdAsChannelId(t.id)));
    return null == i ? null : (0, s.jsx)(lq, { channel: i, compact: n, isSystemMessage: (0, lM.A)(t) });
}
function lq(e) {
    var t;
    let i,
        ...
        m = (0, nl.Ay)(a),
        h = (0, u.bG)([lU.A], () => lU.A.getCount(a.id)),
        g =
            ((t = a),
            (i = (0, u.bG)([lU.A], () => lU.A.getMostRecentMessage(t.id))),
            (l = (0, u.bG)([lU.A], () => lU.A.getCount(t.id))),
            (r = (0, lG.JO)(t)),
                  ...
                  : null == i
                    ? (0, s.jsxs)(s.Fragment, {
                          children: [
                              ...
                              (0, s.jsx)("span", { className: lW.vE, children: (0, lG.aK)(r) }),
                          ],
                      })
                    : (0, s.jsxs)(s.Fragment, {
                          children: [
                              (0, s.jsx)(lY, { message: i, channel: t }),
                              (0, s.jsx)("span", { className: lW.vE, children: (0, lG.aK)(r) }),
                          ],
                      })),
        A = null != h && h > 0;
    return (0, s.jsxs)(s.Fragment, {
        children: [
            (0, s.jsx)("div", { className: o()(lW.GI, { [lW.E]: !d, [lW.E_]: c }) }),
            (0, s.jsx)(eb.D, {
                onClick: function (e) {
                    e.stopPropagation(), (0, lz.JA)(a, e.shiftKey);
                },
                onKeyDown: function (e) {
                    e.stopPropagation();
                    let t = !e.altKey && !e.ctrlKey && !e.metaKey && !e.shiftKey,
                        n = e.shiftKey && !(e.altKey || e.ctrlKey || e.metaKey);
                    (e.key === lK.dh.SPACE || e.key === lK.dh.ENTER) &&
                        (e.preventDefault(), (t || n) && (0, lz.JA)(a, n));
                },
                ...
                className: o()(lW.kL, { [lW.og]: c }),
                children: (0, s.jsxs)(lk.R, {
                    children: [
                        (0, s.jsxs)("div", {
                            className: lW.kq,
                            children: [
                                (0, s.jsx)(lR.A, { children: J.intl.string(J.t["7Xm5QI"]) }),
                                (0, s.jsx)("span", { className: lW.UU, children: m }),
                                (0, s.jsx)("span", {
                                    className: lW.lO,
                                    "aria-hidden": !A,
                                    children: (0, lO.ub)(h, a.id),
                                }),
                            ],
                        }),
                        (0, s.jsx)(p.E, {
    ...
    let { guild: t, channel: n, message: i } = e,
        ...
        o = r.useCallback(() => {
            eG.default.track(W.HAw.CHANNEL_LINK_PREVIEW_JOINED, {
                ...
                (0, l7.i)(t.id, n.id),
                l9.default.selectVoiceChannel(n.id);
        }, [i, t, n, l, a]),
                        ...
                        (0, s.jsx)(n_.A.Info, {
                            ...
                            children: (0, s.jsxs)("span", {
                                ...
                                children: [
                                    ...
                                    (0, s.jsx)("span", {
                                        className: nB.E3,
                                        children: (0, s.jsx)(l8.A, { guild: t, isBannerVisible: !1 }),
                                    }),
                                ],
                            }),
                        }),
...
function st(e) {
    ...
    return null != r && r.isGuildVocal() && null != a && tl.A.can(W.xBc.VIEW_CHANNEL, r) && tl.A.can(W.xBc.CONNECT, r)
        ? (0, s.jsx)(se, { guild: a, channel: r, message: n })
        : null;
}
var sn = n(789645),
    si = n(298236),
...
function so(e) {
    ...
    return 0 === t.length
        ...
        : (0, s.jsx)(ss.N, {
              ...
              shouldHideMediaOptions: a,
              enabledContentHarmTypeFlags: d,
              children: (0, s.jsx)(si.f5, {
                  message: n,
                  shouldDisableInteractiveComponents: !0,
                  children: (0, s.jsx)(sl.O7.Root, {
                      containerInnerWidth: h,
                      children: (0, s.jsx)("div", {
                          style: { width: "100%" },
                          ref: m,
                          children: (0, s.jsx)(sl.O7.AutoMeasuredNestedContainer, {
                              children: (e) =>
                                  (0, s.jsxs)("div", {
                                      ref: e,
                                      "aria-hidden": u,
                                      className: o()(sr.O0, sa.k, sa.z, { [sr.dK]: u }),
                                      children: [
                                          null != c &&
                                              (0, s.jsx)(eb.D, {
                                                  ...
                                                  children: (0, s.jsx)(sn.P, { size: "xs", color: "currentColor" }),
                                              }),
                                          (0, nK.fD)(t),
                                      ],
                                  }),
...
let s_ = r.memo((e) => {
    let { start: t } = e,
        [n, i] = r.useState(0),
        l = (0, it.j)(),
        s = (0, u.bG)([sm.Ay], () => sm.Ay.useReducedMotion),
        a = !1 === l || s;
    return (
        r.useEffect(() => {
            let e = new sd.IX();
            return (
                e.start(a ? 15 * lQ.A.Millis.SECOND : lQ.A.Millis.SECOND, () => {
                    i((new Date().getTime() - t) / lQ.A.Millis.SECOND);
                }),
                () => e.stop()
            );
        }, [a, t]),
...
s_.displayName = "ActivityRuntimeCounter";
let sN = r.memo(function (e) {
    let t,
        { application: n, channelId: i, guildId: l, message: a } = e,
        { analyticsLocations: d } = (0, E.Ay)(x.A.ACTIVITY_INSTANCE_EMBED),
        c = (0, su.p)(),
        m = (0, u.bG)([D.A], () => D.A.getChannel(i), [i]),
        h = m?.isThread?.() ? m?.parent_id : i,
        g = (0, u.bG)([M.default], () => M.default.getId()),
        {
            embeddedActivity: A,
        ...
        _ = (0, u.bG)([sE.A], () => {
            ...
            for (let e of C) {
                let t = sE.A.findActivity(e, (e) => e.application_id === n.id);
                if (null != t) return t;
            }
            return null;
        }, [n.id, C]),
        ...
        j = r.useMemo(() => {
            let e = new nN.Ay(n);
            return null == e.embeddedActivityConfig && (e.embeddedActivityConfig = sC.Gl), e;
        }, [n]),
        T = (0, sp.vG)({ userId: g, channelId: i, application: j }),
        y = null == A,
        S = (function (e) {
            ...
            return r.useMemo(
                () =>
                    (function (e) {
                        ...
                        if (null != n && n !== sp.Gy.CAN_JOIN) {
                            let e;
                            switch (n) {
                                case sp.Gy.NO_USE_EMBEDDED_ACTIVITIES_PERMISSION:
                                    e = J.intl.string(J.t.hHGrWz);
                                    break;
                                case sp.Gy.ACTIVITY_AGE_GATED:
                                    e = J.intl.string(J.t["4WuFRE"]);
                                    break;
                                case sp.Gy.ACTIVITIES_FEATURE_NOT_ENABLED_FOR_OS:
                                    e = J.intl.string(J.t.uGDCcw);
                                    break;
                                case sp.Gy.ACTIVITY_NOT_SUPPORTED_ON_OS:
                                    e = J.intl.string(J.t.UXoQTp);
                                    break;
                                case sp.Gy.CHANNEL_FULL:
                                    e = J.intl.string(J.t.rZfiNq);
                                    break;
                                case sp.Gy.NO_CHANNEL_CONNECT_PERMISSION:
                                    e = J.intl.string(J.t.w5SAps);
                                    break;
                                case sp.Gy.NO_CHANNEL:
                                case sp.Gy.NO_GUILD:
                                case sp.Gy.NO_USER:
                                case sp.Gy.IS_AFK_CHANNEL:
        ...
        })({ embeddedActivity: A, joinability: T, currentEmbeddedActivity: f, channel: m }),
        b = r.useId(),
            ...
            eG.default.track(W.HAw.ACTIVITY_INSTANCE_EMBED_CLICKED, {
                ...
                y
                    ? await (0, sg.A)({
                          ...
                          componentId: b,
                          commandOrigin: sA.iw.ACTIVITY_INSTANCE_EMBED,
                      })
                    : await (0, sh.A)({
                                          ...
                                          (0, s.jsxs)("div", {
                                              ...
                                              children: [
                                                  ...
                                                  (0, s.jsx)(p.E, {
                                                      variant: "text-xs/medium",
                                                      color: "none",
                                                      children: (0, s.jsx)(s_, { start: B }),
                                                  }),
                                              ],
                                          }),
                                      (0, s.jsxs)("div", {
                                          className: o()(sv.DT, sv.PK),
                                          children: [
                                              (0, s.jsx)("div", {
                                                  children: (0, s.jsx)(sc.u, { size: "xxs", color: "currentColor" }),
                                              }),
                                              (0, s.jsx)(p.E, {
                                                  variant: "text-xs/medium",
                                                  color: "none",
...
function s0(e) {
    let {
        ...
        A = (0, u.bG)([sF.A], () => sF.A.getActiveLibraryApplication(t.id)),
        x = null != A ? A.sku.id : null,
        E = null != x ? x : t.primarySkuId,
        f = (0, u.bG)([eO.A], () => null != E && !eO.A.didFetchingSkuFail(E));
    return null != A && (0, sZ.XZ)(A)
        ? (0, s.jsx)(sQ.A, { ...p, playButtonVariant: l, libraryApplication: A, source: m })
        : f
          ? (0, s.jsx)("div", { children: "deprecated!" })
          : (0, s.jsx)(s$.A, { ...p, variant: l, hideNotLaunchable: a, applicationId: t.id });
}
var s1 = n(580630);
function s2(e) {
    ...
    if (null != i)
        if (i.amount > 0) return (0, s1.$g)(i.amount, i.currency);
        else return J.intl.string(J.t.QQsaCc);
    return J.intl.string(J.t.RWouSQ);
}
var s3 = n(257727),
    s6 =
        (((l = s6 || {})[(l.DIRECTORY_HERO = 1)] = "DIRECTORY_HERO"),
...
function s5(e) {
    ...
    return (0, s.jsxs)("div", {
        className: o()(s3.nM, t),
        children: [
            (0, s.jsx)(sy._, { size: "md", color: "currentColor", className: s3.Kk }),
...
function s4(e) {
    ...
    return (0, s.jsxs)("div", {
        className: o()(s3.nM, n),
        children: [(0, s.jsx)(tE.t, { size: "md", color: "currentColor", className: s3.Kk }), s2(t)],
    });
}
function s9(e) {
    let { sku: t, className: n } = e;
    return (0, s.jsx)("div", { className: o()(s3.EQ, n), children: t.getDisplaySalePercentage() });
}
function s7(e) {
    let { sku: t, className: n } = e;
    return (0, s.jsx)("div", { className: o()(s3.I8, n), children: s2(t, !1) });
}
function s8(e) {
    let { sku: t, className: n } = e;
    return (0, s.jsx)("div", { className: n, children: s2(t) });
}
function re(e) {
    let { sku: t, className: n } = e;
    return (0, s.jsxs)("div", {
        className: o()(s3.nM, n),
        children: [(0, s.jsx)(s9, { sku: t }), (0, s.jsx)(s7, { sku: t }), (0, s.jsx)(s8, { sku: t })],
    });
}
function rt(e) {
    let { className: t } = e;
...
class rn extends r.PureComponent {
    ...
    renderGeneric(e, t) {
        ...
        switch (e) {
            case 5:
                return (0, s.jsx)(rt, { className: o()(t, n) });
            case 1:
                return (0, s.jsx)(s5, { className: o()(t, n) });
            case 3:
                return (0, s.jsx)(s4, { sku: i, className: o()(t, n) });
            case 2:
                return (0, s.jsx)(re, { sku: i, className: o()(t, n) });
            default:
                return (0, s.jsx)(s8, { className: o()(t, n), sku: i });
        }
    }
    renderDirectoryHero(e) {
        ...
        switch (e) {
            case 5:
                return (0, s.jsx)(rt, { className: t });
            case 3:
                return (0, s.jsx)(s4, { sku: n, className: o()(s3.OB, t) });
            case 2:
                return (0, s.jsx)(re, { sku: n, className: o()(s3.dk, t) });
            default:
                return (0, s.jsx)(s8, { className: o()(s3.dk, t), sku: n });
        }
    }
    renderListing(e) {
        let t,
            ...
            case 2:
                t = (0, s.jsxs)(r.Fragment, {
                    children: [
                        (0, s.jsxs)("div", {
                            className: s3.nM,
                            children: [(0, s.jsx)(s8, { sku: i }), (0, s.jsx)(s9, { sku: i })],
                        }),
                        (0, s.jsx)(s7, { sku: i }),
                    ],
                });
        ...
        return (0, s.jsx)("div", { className: o()(s3.IH, n), children: t });
    }
    render() {
        let e = this.getState();
        ...
        switch (this.props.type) {
            ...
            case 2:
                return this.renderGeneric(e, s3.Pl);
            case 3:
                return this.renderGeneric(e, s3.jh);
            case 4:
                return this.renderListing(e);
            case 5:
                return this.renderGeneric(e, s3.bk);
            default:
...
function rs(e) {
    ...
    let l = i.icon;
    return (0, s.jsx)(i6.m, { text: i.getLabel(), children: (0, s.jsx)(l, { className: n }) });
}
function rr(e) {
    let { systems: t, className: n, iconClassName: i } = e;
    return (0, s.jsx)("div", {
        className: o()(ri.I, n),
        children: t.map((e) => (0, s.jsx)(rs, { operatingSystem: e, className: o()(ri.A, i) }, e)),
    });
}
var ra = n(111758);
let ro = (e) => {
    ...
    return (0, s.jsx)("div", {
        className: o()(ra.T, t),
        children: (0, s.jsx)("span", { className: ra.Q, children: J.intl.string(J.t["14lP0W"]) }),
    });
};
var rd = n(246337);
let rc = (e) => {
    ...
    return (0, s.jsx)("div", {
        className: o()(rd.T, t),
        children: (0, s.jsx)("span", { className: rd.Q, children: J.intl.string(J.t["8IfYqa"]) }),
    });
};
var ru = n(615300),
    rm = n(868285),
...
class rE extends r.Component {
    _animatedValue = new ru.A.Value(1);
    state = { imageLoadError: !1, imageLoading: !0 };
    componentWillEnter = (e) => {
        this._animatedValue.setValue(0), ru.A.timing(this._animatedValue, { toValue: 1, duration: 400 }).start(e);
    };
    componentWillLeave = (e) => {
        ru.A.timing(this._animatedValue, { toValue: 0, duration: 400 }).start(e);
    };
    ...
    renderMedia() {
        ...
        return (0, s.jsx)(ru.A.img, {
            className: o()({ [rx.YC]: i }, t),
            src: e,
            alt: n,
    ...
    render() {
        ...
        return null == n || i
            ? (0, s.jsx)(ru.A.div, { className: o()(rx.gn, e), style: this.getImageStyle(), children: t })
            : (0, s.jsxs)(ru.A.div, {
                  className: o()(l ? rx.g4 : null, e),
                  style: this.getImageStyle(),
                  children: [
                      l
                          ? (0, s.jsx)(tO.y, {
...
class rf extends r.Component {
    ...
    renderTypeVideo = () => {
        ...
        return (0, s.jsxs)(r.Fragment, {
            children: [
                ...
                (0, s.jsx)(rm.F, {
                    children: l && e ? null : (0, s.jsx)(rE, { className: o()(rx.NB, c), src: n, title: i }, 0),
                }),
                (0, s.jsx)(eb.D, {
                    className: o()(rx.b4, { [rx.HY]: l && e, [rx.Hy]: null != u }),
                    onClick: this.handleToggleMute,
                    children: l && e ? (0, s.jsx)(m, { className: rx.i2 }) : null,
                }),
            ],
        });
    };
    ...
    renderSlideItem = (e) => {
        ...
        return i
            ? (0, s.jsx)(rE, { className: o()(rx.Yi, l), src: e[r], title: n }, r)
            : (0, s.jsx)(rE, { className: o()(rx.Yi, l), src: t, title: n }, "image");
    };
    renderTypeImage() {
        let { playing: e, slideImages: t, image: n, title: i, splashClassName: l } = this.props;
        return null == t
            ? (0, s.jsx)(rE, { className: o()(rx.Yi, l), src: n, title: i }, "image")
            : (0, s.jsx)(rp.A, {
                  onInterval: this.nextItem,
                  interval: 2e3,
                  className: rx.mZ,
                  disable: !e,
                  children: (0, s.jsx)(rm.F, { children: this.renderSlideItem(t) }),
              });
    }
    render() {
        ...
        return n
            ...
            : (0, s.jsxs)("figure", {
                  className: o()(rx.__invalid_tileMedia, t),
            ...
            : (0, s.jsxs)("div", {
                  ...
                  children: [
                      (0, s.jsx)(rn, {
                          ...
                          sku: t,
                          inLibrary: e,
                          className: r && i ? r_.ae : r_.Ek,
                      }),
                      (0, s.jsx)(rr, { systems: [W.uje.WINDOWS], className: r_.iD }),
    ...
    renderMedia = () => {
        ...
        return (0, sG.bF)(l)
            ? (0, s.jsx)(rI.e, {
                  sku: l,
                  shape: "custom",
                  containerClassName: r_.A$,
                  backgroundImageClassName: r_.iZ,
                  foregroundImageClassName: r_.O7,
              })
            : (0, s.jsxs)(r.Fragment, {
                  children: [
                      (0, s.jsx)(rf, {
                          className: o()(r_.H1, { [r_.ZC]: a }),
                          video: null != d.previewVideo ? (0, rC.YE)(l.applicationId, d.previewVideo) : void 0,
                          image: null != d.thumbnail ? (0, rC.YE)(l.applicationId, d.thumbnail, 600) : void 0,
                          title: l.name,
                          playing: e,
                          muted: t,
                          placeholder: n,
                          onToggleMute: i,
                          splashClassName: r_.ZI,
                          splashPlaceholderClassName: r_.NB,
                      }),
                      l.exclusive
                          ? (0, s.jsx)(rc, { className: o()(r_.LJ, { [r_.V9]: e }) })
                          : l.isTheGameAwardsWinner
                            ? (0, s.jsx)(ro, { className: o()(r_.LJ, { [r_.V9]: e }) })
                            : null,
                  ],
              });
    };
...
class ry extends r.Component {
    ...
    renderViewInStoreButton() {
        return (0, s.jsx)("div", {
            ...
            children: (0, s.jsx)(eg.$, {
                ...
                onClick: () => {
                    (0, sU.pX)(W.BVt.APPLICATION_STORE);
                },
            }),
        });
    }
    ...
    renderActions = (e) => {
        ...
        if (null != r) return (0, s.jsx)("div", { className: rT.i, children: r() });
        if (null == n) return null;
        ...
        return (0, s.jsxs)("div", {
            ...
            children: [
                ...
                (t && !o) || e.premium ? null : (0, s.jsx)(rn, { type: rn.Types.EMBED, sku: e, inLibrary: !1 }),
            ],
        });
    };
    render() {
        ...
        return null == e || null == t
            ? i
                ? l()
                : (0, s.jsx)(sS.Wb, { isHorizontal: r })
            : e.productLine === W.EZt.COLLECTIBLES
              ? (0, s.jsx)(sX.A, { section: W.JJy.APPLICATION_EMBED, children: this.renderApplicationTile(e, t) })
              : (0, s.jsx)(sX.A, {
                    section: W.JJy.APPLICATION_EMBED,
                    children: (0, s.jsx)(sq.N_, {
...
let rS = [eO.A, sF.A, eU.A];
function rb(e) {
    let { skuId: t } = e,
        n = eO.A.get(t),
        i = null != n ? rj.A.getApplication(n.applicationId) : null;
    return {
        sku: n,
        application: i,
        fetchFailed: eO.A.didFetchingSkuFail(t),
        inLibrary: null != n && sF.A.hasApplication(n.applicationId, n.applicationId, !0),
        storeListing: null != n ? eU.A.getForSKU(n.id) : null,
        libraryApplication: null != n ? sF.A.getLibraryApplication(n.applicationId, n.applicationId, !0) : null,
    };
}
let rL = (0, sL.A)((0, sb.A)(ry)),
    rk = u.Ay.connectStores(rS, rb)(rL),
    rR = (0, sb.A)(u.Ay.connectStores(rS, rb)(ry));
var rP = n(576171);
function rM(e) {
    ...
    return (0, s.jsxs)(eb.D, {
        ...
        onClick: t,
        children: [
            (0, s.jsx)(sy._, { size: "md", color: "currentColor", className: rP.dy }),
...
class rD extends r.PureComponent {
    ...
    handleViewInventory() {
        (0, sV.openUserSettings)(sB.X.GIFT_PANEL);
    }
...
class rO extends r.Component {
    ...
    handleViewLibrary = (e) => {
        ...
        e.preventDefault(),
            null != t && t.isHidden()
                ? (0, sU.pX)(W.BVt.APPLICATION_LIBRARY_SETTINGS)
                : (0, sU.pX)(W.BVt.APPLICATION_LIBRARY, { state: { applicationId: null != t ? t.id : void 0 } });
    };
    handleVerificationClick = (e) => {
        e.stopPropagation(), e.preventDefault(), (0, sV.openUserSettings)(sB.X.ACCOUNT_PANEL);
    };
    handleAccept = (e) => {
        ...
        (0, sM.h)({ processedCode: n, channelContext: t, customGiftMessage: r, giftInfo: s });
    };
    handleLaunchGame = (e) => {
        ...
        null != t &&
            ...
            sz.A.launchGame(t.id));
    };
    handleEmbedClick = (e) => {
        let { giftCode: t, sku: n, skuApplication: i } = this.props;
        null != n && (0, sG.bF)(n) && null != i && null != i.guildId
            ? (e.preventDefault(),
              (0, sw.R)({
                  skuId: n.id,
                  applicationId: i.id,
            ...
            : null != t && t.isSubscription && (e.preventDefault(), (0, sV.openUserSettings)(sB.X.NITRO_PANEL));
    };
                ...
                (0, s.jsxs)(la.A, {
                    children: [
                        ...
                        null == t || e.isSubscription
                            ? null
                            : (0, s.jsx)(rM, { onClick: this.handleViewLibrary, libraryApplication: t }),
                    ],
                }),
                (0, s.jsxs)(la.A, {
                    align: la.A.Align.END,
                    justify: la.A.Justify.END,
                    className: rP.yu,
                    direction: la.A.Direction.VERTICAL,
                    children: [
                        ...
                        e.redeemed || e.isClaimed || null != t || null == e.expiresAt
                            ? null
                            : (0, s.jsx)("div", {
                                  children: J.intl.format(J.t.nZBvUR, { hours: e.expiresAt.diff(iT()(), "h") }),
                              }),
                    ],
                }),
            ],
    ...
    renderButton(e) {
        ...
        let r =
                ...
                (e.isExistingPremiumSubscriptionDisallowed && (0, lh.TW)(n)),
        ...
        return (0, s.jsx)("div", {
            className: (0, sR.hU)(e) ? rP.UQ : void 0,
            children: (0, s.jsx)(eg.$, {
                variant: "primary",
                size: "sm",
                text: o,
    ...
    renderTitle(e) {
        ...
        return this.isCustomGiftMessage() && !n
            ? J.intl.formatToPlainString(J.t.t1SOId, { recipientDisplayName: sJ.Ay.getName(t) })
            : null == i
              ? null
              : e.isSubscription
                ? n
    ...
    renderBody(e) {
        ...
        if (!n && this.isCustomGiftMessage() && !e.redeemed) return (0, sG.bF)(i) ? this.props.content : void 0;
        let a = i.isPreorder() ? J.intl.formatToPlainString(J.t.evinTd, { name: i.name }) : i.name;
        if (e.redeemed)
            return e.isSubscription || (0, sR.hU)(e) || (0, sG.bF)(i)
        ...
        if (e.hasMultipleCopies)
            return null != l
                ? e.isSubscription
                    ? J.intl.format(J.t.l3VxgG, { username: sJ.Ay.getUserTag(l), maxUses: e.maxUses, skuName: a })
                    : J.intl.format(J.t["9cYrw5"], {
                          username: sJ.Ay.getUserTag(l),
        ...
        if (e.isSubscription) {
            ...
            if (null != l) {
                let e = s.interval === lE.WT.MONTH ? J.t["/RDIEA"] : J.t["3CX6Ev"];
                return J.intl.format(e, { username: sJ.Ay.getUserTag(l), skuName: a, intervalCount: s.intervalCount });
            }
            let e = s.interval === lE.WT.MONTH ? J.t["2O4lo5"] : J.t["+XjmsR"];
            return J.intl.format(e, { skuName: a, intervalCount: s.intervalCount });
        }
        return null != l ? J.intl.format(J.t["3HsdQ/"], { username: sJ.Ay.getUserTag(l) }) : J.intl.string(J.t.Jdnjjj);
    }
    renderCustomGiftBox = (e) => {
        let { width: t } = this.props;
        if (null == e || null == e.giftStyle) return null;
        let n = lE.Wx.includes(e.giftStyle),
            i = o()(rP.gB, { [rP.El]: n, [rP.by]: t >= sS.Tm }),
            l = o()({ [rP.gc]: n, [rP.Ei]: n && t >= sS.Tm, [rP.ww]: !n, [rP.wy]: !n && t >= sS.Tm });
        return (0, s.jsxs)("div", {
            className: i,
            children: [
                n && (0, s.jsx)(sY, { className: rP.nr }),
                null != e.giftStyle &&
                    (0, s.jsx)(sD.A, {
                        defaultAnimationState: e.redeemed ? sP.oA.LOOP : sP.oA.IDLE,
    ...
    renderEmbed() {
        ...
        if (null == e) return null;
        let i = null != e.giftStyle && !(0, sG.bF)(n);
        return (0, s.jsx)(rR, {
            skuId: e.skuId,
    ...
    render() {
        ...
        if (null == e || e.revoked)
            if (t) return (0, s.jsx)(rD, { isSelfGift: l, width: i, resolveErrorCode: n });
            else return (0, s.jsx)(sS.Wb, { isHorizontal: i >= sS.Tm });
        return (0, sR.hU)(e)
            ? (0, s.jsx)("div", { className: rP.mp, children: this.renderEmbed() })
            : this.renderEmbed();
    }
}
let rU = (0, sL.A)((0, sb.A)(rO)),
    rG = function (e) {
        let { code: t, author: n } = e,
            {
                ...
                let e = sH.A.getError(t);
                return { giftCode: sH.A.get(t), resolved: sH.A.getIsResolved(t), resolveErrorCode: e?.code ?? null };
            }),
            a = (0, u.bG)([G.default], () => (null != i && null != i.userId ? G.default.getUser(i.userId) : null)),
            o = (0, u.bG)([eO.A], () => (null != i ? eO.A.get(i.skuId) : null)),
            d = (0, u.bG)([sF.A], () =>
                null != o && i?.entitlementBranches != null ? sK.YI(i.entitlementBranches, o, sF.A) : null,
            ),
            c = (0, sk.h)(o?.applicationId),
            m = null != o && (0, sG.bF)(o) && i?.redeemed === !0,
            [h] = (0, sO.L)(m ? c?.id : null),
            g = (0, sW.zz)(i?.subscriptionPlanId),
            p = (0, u.bG)([M.default], () => (null != i ? M.default.getId() === i.userId : M.default.getId() === n.id));
        return (0, s.jsx)(rU, {
            ...e,
            skuApplication: c,
...
function rq(e) {
    ...
    return rJ.getCurrentConfig({ guildId: t, location: n });
}
function rX() {
    return (0, s.jsxs)(n_.A, {
        children: [
...
function rQ(e) {
    ...
    return (
        ...
        (0, s.jsx)("div", { className: r$.rc, children: l })
    );
}
function r0(e) {
    ...
    if (null != t && null != n) {
        let e = (0, t5.gU)(t, n);
        return (0, s.jsxs)("div", {
            className: o()(r$.Ix, { [r$.v6]: i }),
            children: [
                null != e ? (0, s.jsx)(e, { className: r$.p, size: "xs", color: "currentColor" }) : null,
                (0, s.jsx)(li.A, {
                    children: (0, s.jsx)(p.E, {
                        variant: "text-xs/normal",
                        color: l,
...
function r1(e) {
    ...
    eI()(c === rZ.yV.EMBEDDED_APPLICATION && null != m, "invalid application invite");
    let h = r.useCallback(() => {
        ...
        { analyticsLocations: v } = (0, E.Ay)(x.A.INVITE_EMBED),
        _ = (0, u.yK)(
            [ec.Ay],
            () =>
                null != I
        ...
        N = (0, u.yK)([G.default], () => _.map((e) => G.default.getUser(e)).filter((e) => null != e), [_]),
        j = r.useCallback(() => {
            (0, rw.he)(
                {
                    invite: i,
                ...
                rw.Ay.acceptInviteAndTransitionToInviteChannel({
                    inviteKey: i.code,
        ...
        y = null != g;
    if (null == g) {
        if (null == i.guild) return (0, s.jsx)(rX, {});
        g = (0, rW.DY)(i.guild);
    }
    t = y
        ? A
...
function r2(e) {
    let {
        ...
        { bot: E, icon: f } = t,
        I = w.Ay.getApplicationIconURL({ id: t.id, icon: f, bot: E }),
        C = (0, ee.F)(t),
        v = (0, Q.f)(t),
        _ = n.length,
        N = r.useMemo(
    ...
    return (0, s.jsx)(H.h, {
        ...
        info: (0, s.jsxs)("div", {
            className: r$.QR,
            children: [
                (0, s.jsx)(r0, { channel: l, guild: a, hasEnded: !u, textColor: "none" }),
                i
                    ? _ > 0 &&
                      (0, s.jsx)(X, {
                          activityUsers: n,
                    ...
                    : (0, s.jsx)(rQ, { members: d, membersOnline: c, textColor: "none" }),
            ],
        }),
        actions: N,
        onClickContent: C,
...
function r6(e) {
    let { author: t, inviteError: n } = e,
        i =
            (0, u.bG)([M.default], () => M.default.getId()) === t.id
...
function r9(e) {
    let { invite: t, message: n, getAcceptInviteContext: i } = e,
        l = (0, u.bG)([M.default], () => M.default.getId()),
        a = t.inviter?.id === l,
        o = t.state === W.elq.ACCEPTING,
        { analyticsLocations: d } = (0, E.Ay)(x.A.INVITE_EMBED),
        c = (0, u.bG)([O.A], () => null != t.inviter && O.A.isFriend(t.inviter?.id)),
        m = r.useCallback(() => {
            let e = "noop";
            null != t.inviter &&
                null != D.A.getDMFromUserId(t.inviter.id) &&
                ((e = "transition"), r5.A.openPrivateChannel({ recipientIds: [t.inviter.id] })),
                (0, rw.he)(
                    {
                        invite: t,
                        action: e,
        ...
        h = r.useCallback(() => {
            ...
            rw.Ay.acceptInviteAndTransitionToInviteChannel({ inviteKey: t.code, context: e });
        }, [t, n, d, i]);
    ...
    let f = a ? J.intl.string(J.t.eQyu1F) : J.intl.string(J.t.PYJHW6),
        I = null != t.inviter ? `${t.inviter.username}` : "",
        C = null != t.inviter ? sJ.Ay.getUserTag(t.inviter) : "";
    return (0, s.jsxs)(n_.A, {
        children: [
            (0, s.jsx)(n_.A.Header, { text: f }),
            (0, s.jsxs)(n_.A.Body, {
                children: [
                    (0, s.jsxs)("div", {
                        className: nB.iH,
                        children: [
                            (0, s.jsx)(n_.A.Icon, { user: new r4.A(t.inviter), onClick: c ? g : void 0 }),
                            (0, s.jsx)(n_.A.Info, { title: I, onClick: c ? g : void 0, children: C }),
                        ],
                    }),
...
function ae(e) {
    let { location: t } = e;
    return r8.useConfig({ location: t });
}
function at(e) {
    ...
    let { analyticsLocations: m } = (0, E.Ay)(x.A.INVITE_EMBED),
        { enabled: h } = ae({ location: "GroupDMInvite" }),
        g = null != c,
        A = r.useCallback(() => {
            let e = "noop";
    ...
    let {
            ...
            ? (function (e, t, n, i) {
                  var l;
                  let { recipients: s, customGroupName: r } = e,
                      a =
                          0 ===
                          (l = s
                              .map((e) => {
                                  ...
                                  let n = e instanceof r4.A ? e : G.default.getUser(e.id);
                                  if (null != n) {
                                      let e = sJ.Ay.getName(n);
                                      if (null != e) return e;
                                  }
                                  return e.username;
                              })
                              ...
                              : 1 === l.length
                                ? l[0]
                                : 2 === l.length
                                  ? J.intl.formatToPlainString(J.t.gwRP0Y, { first: l[0], second: l[1] })
                                  : 3 === l.length
                                    ...
                                    : J.intl.formatToPlainString(J.t.m5uYso, { first: l[0], second: l[1] }),
                      o = J.intl.string(J.t.gVDdRn),
                      d = "active";
                  i && ((o = J.intl.string(J.t.cEnaWx)), (d = "secondary"));
                  let c = J.intl.string(J.t["3p3/BK"]);
                  if (n) {
                      let e = D.A.getChannel(t.channel_id),
                          n = e?.isDM() ? sJ.Ay.getName(G.default.getUser(e.getRecipientId())) : void 0;
                      c =
                          null != n
                              ? null != r
                                  ? J.intl.formatToPlainString(J.t.XMYrqF, { user: n, groupName: r })
                                  : J.intl.formatToPlainString(J.t["8XOu5v"], { user: n })
                              : null != r
                                ? J.intl.formatToPlainString(J.t.ysbTP8, { groupName: r })
                                : J.intl.string(J.t.Fyamu8);
                  } else {
                      let e = sJ.Ay.getName(t.author);
                      c =
                          null != r
                              ? J.intl.formatToPlainString(J.t.HfTWGa, { username: e, groupName: r })
                              : J.intl.formatToPlainString(J.t.NQyAXK, { username: e });
                  }
                  return { bodyTitle: a, headerText: c, buttonText: o, buttonVariant: d };
              })(f, n, o, g)
            : (function (e, t, n) {
                  let i,
                  ...
                  null != r
                      ? (i = r)
                      : (null == (i = (0, nl.m1)(l, G.default, O.A)) || "" === i) &&
                        (i =
                            s.length > 0
                                ? s
                                      .filter(sf.Vq)
        ...
        { channel: N, recipients: j } = f,
        T = h
            ? j.map((e) =>
                  e instanceof r4.A
                      ? e
                      : (G.default.getUser(e.id) ??
                        new r4.A({ id: e.id, username: e.username, avatar: e.avatar ?? null })),
              )
            : [];
    return (0, s.jsxs)(n_.A, {
        className: h ? nB.TV : void 0,
        children: [
            h
                ? (0, s.jsx)(p.E, {
                      variant: "text-xs/medium",
                ...
                : (0, s.jsx)(n_.A.Header, { text: C }),
            (0, s.jsxs)(n_.A.Body, {
                children: [
                    (0, s.jsxs)("div", {
                        className: nB.iH,
                        children: [
                            (!h || null != N.icon) && (0, s.jsx)(n_.A.Icon, { channel: N, onClick: g ? A : void 0 }),
                            (0, s.jsx)(n_.A.Info, {
                                title: I,
                                onClick: g ? A : void 0,
                                ...
                                children: h
                                    ? (0, s.jsxs)("div", {
                                          className: nB.er,
                                          children: [
                                              J.intl.format(J.t.zRl6XR, { count: j.length }),
                                              T.length > 0 &&
                                                  (0, s.jsx)(r7.A, {
                                                      users: T,
                                                      maxUsers: 3,
                                    ...
                                    : (0, s.jsx)(n_.A.Data, { members: j.length }),
                            }),
                        ],
                    }),
                    (0, s.jsx)(eg.$, { onClick: A, loading: d, disabled: g, variant: _, text: v, fullWidth: !0 }),
                ],
            }),
        ],
    });
...
let al = function (e, t) {
    let [n] = e,
        { guild: i } = t;
    return (
        !(null != i && (0, c.Lt)(n.getSelfMember(i.id)?.flags ?? 0, ai.D.IS_GUEST)) ||
        (0, c.Lt)(t.flags ?? 0, an.Q.IS_GUEST_INVITE)
    );
};
var as = n(517905);
function ar(e) {
    let t,
        ...
        A = g === h.author.id,
        { channel: f, approximate_member_count: I, approximate_presence_count: C } = m,
        v = m.state === W.elq.ACCEPTING,
        _ = null != f ? (0, rz.OY)(f) : null,
        N = null != d,
        j = null != _,
        T = null != _ && _.isGuildStageVoice(),
        y = (0, c.Lt)(m.flags ?? 0, an.Q.IS_GUEST_INVITE),
        S = _?.isGuildVoiceOrThread() ?? !1,
        b = d?.features.has(W.GuildFeatures.HUB) ?? !1,
        L = d?.id,
        { analyticsLocations: k } = (0, E.Ay)(x.A.INVITE_EMBED);
    (0, e4.A)({
        ...
        properties: {
            ...
            invite_channel_id: f?.id,
            invite_instance_id: (0, nH._U)(m.code, h.id),
            invite_channel_type: f?.type,
            embed_type: "guild_invite",
            location_stack: k,
        },
    });
    let [R, P] = r.useState(!1),
        M = r.useCallback(() => P(!1), []),
        D = r.useRef(null),
        O = (0, u.bG)([ie.Ay], () => al([ie.Ay], m)),
        U = r.useCallback(() => {
            P(!0), (0, rw.Pq)(L, "show profile", k);
        }, [L, k]),
        G = r.useCallback(() => {
            let e = "noop";
    ...
    if (null == d) {
        if (null == m.guild) return (0, s.jsx)(rX, {});
        (d = rW.DY(m.guild)).premiumTier = m.guild.premium_tier ?? W.TVA.NONE;
    }
    let w = (function (e) {
    ...
    return (
        (i = (0, s.jsxs)("span", {
            ...
            children: [
                ...
                (0, s.jsx)("span", {
                    className: nB.E3,
                    children: (0, s.jsx)(l8.A, { guild: d, isBannerVisible: !1, disableBoostClick: !0 }),
                }),
            ],
        })),
        y &&
            (l = (0, s.jsx)(i6.m, {
                ...
                children: (0, s.jsx)(t$.m, { size: "md", color: "currentColor", className: nB.G }),
            })),
        S
            ? ((i = (0, s.jsx)(n_.A.Channel, { channel: _ })),
              (t = (0, s.jsxs)("span", {
                  ...
                  children: [
                      ...
                      (0, s.jsx)("span", {
                          className: nB.E3,
                          children: (0, s.jsx)(l8.A, { guild: d, isBannerVisible: !1 }),
                      }),
                  ],
              })))
            : (null != I && I >= 5) || (null != C && C > 0)
              ? (t = (0, s.jsx)(n_.A.Data, { members: I, membersOnline: C }))
              : j && (t = (0, s.jsx)(n_.A.Channel, { channel: _, guild: d })),
        (0, s.jsxs)(n_.A, {
            children: [
                (0, s.jsx)(n_.A.GuildSplash, { guild: d }),
                (0, s.jsx)(n_.A.Header, { text: w, extra: l }),
                (0, s.jsxs)(n_.A.Body, {
                    children: [
                        (0, s.jsxs)("div", {
                            className: nB.iH,
                            children: [
                                ...
                                (0, s.jsx)(n_.A.Info, { title: i, onClick: U, children: t }),
                            ],
                        }),
                        (0, s.jsx)("div", {
                            className: nB.UD,
...
function aA(e) {
    let { invite: t, isMemberOfGuild: n, message: i, onTransitionToInviteChannel: l, onAcceptInstantInvite: a } = e,
        ...
        A = (0, u.bG)([sm.Ay], () => sm.Ay.useReducedMotion),
        { analyticsLocations: f } = (0, E.Ay)(x.A.INVITE_EMBED);
    (0, e4.A)({
        name: e5.ImpressionNames.INVITE_EMBED,
        type: e5.ImpressionTypes.VIEW,
        properties: {
        ...
        : (0, s.jsxs)(aa.s, {
              ...
              children: [
                  (0, s.jsxs)("div", {
                      ...
                      ref: d,
                      children: [
                          (0, s.jsx)(ah.J$, { profile: I, className: ap.vK }),
                          (0, s.jsx)(ah.CG, { profile: I }),
                          (0, s.jsx)(am.A, { profile: I }),
                          (0, s.jsx)(ac.P, { profile: I, className: ap.rb }),
                          (0, s.jsx)(ag.A, {
                              guild: null != t.guild ? (0, rW.DY)(t.guild) : null,
                              roles: t.roles,
                              className: ap.Ei,
                          }),
                      ],
                  ...
                  h && !c
                      ...
                      : null,
                  (0, s.jsxs)("div", {
                      className: o()(ap.qr, { [ap.iK]: h }),
                      children: [
                          h && c ? (0, s.jsx)("div", { className: ap.D7 }) : null,
                          (0, s.jsx)("div", {
                              className: o()(ap.z8, { [ap.it]: h && c }),
                              children: (0, s.jsx)("div", {
                                  className: ap.UD,
                                  children: (0, s.jsx)(ax, {
                                      invite: t,
...
function ax(e) {
    let {
        ...
        { guildId: c, ctaType: u } = (0, ad.Ay)(n, ad.cn.INVITE, t.code),
        { analyticsLocations: m } = (0, E.Ay)(x.A.INVITE_EMBED),
        h = r.useCallback(() => {
...
function af(e) {
    let t,
        ...
        d = (0, u.bG)([M.default], () => M.default.getId()),
        c = sJ.Ay.useName(l),
        m = d === l.id,
        { enabled: h } = ae({ location: "InvalidInvite" }),
        g = (0, u.bG)([D.A, tl.A], () => {
    ...
    return (
        m
            ? ((i = h ? J.intl.string(J.t["7Vsu1h"]) : J.intl.string(J.t.C89OLE)),
              (t = h ? J.intl.string(J.t.y7uT5j) : J.intl.string(J.t["F/OLvL"])))
            : r
              ? ((i = J.intl.string(J.t.YVub5y)), (t = J.intl.string(J.t["57nBty"])))
              : ((i = h ? J.intl.formatToPlainString(J.t.Rw6VmE, { username: c }) : J.intl.string(J.t.YVub5y)),
                (t = h
                    ...
                    null != c && g && !h
                        ? (0, s.jsx)(eg.$, {
                              onClick: function () {
                                  o?.();
                                  let { id: e } = l,
                                      t = `@${sJ.Ay.getUserTag(l, { decoration: "never" })}`,
                                      n = `<@${e}>`;
                                  lA._.dispatchToLastSubscribed(W.jej.INSERT_TEXT, { plainText: t, rawText: n }),
                                      null != a && aE.A.startTyping(a);
                              },
...
function aC(e) {
    let t,
        ...
        h = (0, u.bG)(
            [aI.A],
            () => (null != n && null != n.target_user ? aI.A.getActiveStreamForUser(n.target_user.id, c) : null),
            [n, c],
        ),
        g = (0, u.bG)(
            [aI.A],
            () => (null != n && null != n.target_user ? aI.A.getStreamForUser(n.target_user.id, c) : null),
            [n, c],
        ),
        { analyticsLocations: p } = (0, E.Ay)(x.A.INVITE_EMBED);
    (0, e4.A)({
        name: e5.ImpressionNames.INVITE_EMBED,
        type: e5.ImpressionTypes.VIEW,
        properties: {
    ...
    let A = null != n && n.target_type === rZ.yV.STREAM && null != n.target_user && null != h,
        f =
            null != n &&
            null != g &&
            null != n.channel &&
    ...
    eI()(I === rZ.yV.STREAM && null != C, "invalid streaming invite");
    let v = i === C.id,
        ...
        j = null != l;
    if (null == l) {
        if (null == n.guild) return (0, s.jsx)(rX, {});
        l = (0, rW.DY)(n.guild);
    }
    let T = null != n.channel ? (0, rz.OY)(n.channel) : null,
        y = sJ.Ay.getName(C),
        S = A || (!f && j),
            ...
            (0, s.jsxs)(n_.A.Body, {
                children: [
                    (0, s.jsxs)("div", {
                        className: nB.iH,
                        children: [
                            (0, s.jsx)(n_.A.Icon, { guild: l, onClick: j && f ? N : void 0 }),
                            (0, s.jsx)(n_.A.Info, { title: t, onClick: j && f ? N : void 0, children: k }),
                        ],
                    }),
                    (0, s.jsx)(eg.$, { onClick: N, loading: _, disabled: S, variant: L, text: b }),
                ],
            }),
        ],
    });
...
function aP(e) {
    let { invite: t, message: n, channel: i, onTransitionToInviteChannel: l } = e,
        ...
        d = (0, u.bG)([aL.A], () => aL.A.isInChannel(i.id), [i.id]),
        { voiceStates: c } = (0, u.cf)(
            [ak.Ay],
            () => ({ voiceStates: null != i.guild_id ? ak.Ay.getVoiceStatesForChannelAlt(i.id, i.guild_id) : [] }),
            [i],
        ),
        m = r.useMemo(
        ...
        h = (0, u.bG)([aT.A], () => aT.A.getStartTime(i), [i]);
    r.useEffect(() => {
        null != h || null == i.guild_id || aT.A.hasRequestedStartTimes(i.guild_id) || (0, aj.U)(i.guild_id);
    }, [i, h]);
    let g = r.useRef(null),
        A = r.useRef(null),
        f = r.useCallback(() => {
    ...
    let I = r.useCallback(
            (e) => {
                null != g.current && g.current.removeEventListener("scroll", f),
                    (g.current = e),
                    null != e && e.addEventListener("scroll", f);
            },
            [f],
        ),
        { analyticsLocations: C } = (0, E.Ay)(x.A.INVITE_EMBED, x.A.VOICE_CHANNEL_LIST_INVITE_EMBED),
    ...
    return (0, s.jsxs)("div", {
        ...
        children: [
                ...
                children: [
                    (0, s.jsxs)("div", {
                        ...
                        children: [
                            (0, s.jsxs)("div", {
                                ...
                                children: [
                                    ...
                                    (0, s.jsx)(av.u, {
                                        ...
                                        body: "",
                                        assetSize: 24,
                                        asset: null != o ? (0, s.jsx)(aS.Ay, { guild: o, iconSize: 24 }) : void 0,
                                        position: "top",
                                        children: (0, s.jsx)(eb.D, {
                                            className: aR.HA,
                                            onClick: N,
                            ...
                            null != h
                                ? (0, s.jsx)(ay.z, { entry: { start: h }, textColor: "text-feedback-positive" })
                                : null,
                        ],
                    }),
                    m.length > 0
                        ? (0, s.jsxs)("div", {
                              ...
                              children: [
                                  ...
                                  (0, s.jsx)("div", { ref: A, className: aR.wH }),
                              ],
                          })
                        : (0, s.jsx)("div", {
                              className: aR.p$,
            ...
            (0, s.jsxs)("div", {
                className: aR.qr,
                children: [
                    (0, s.jsx)(aN.G, { size: "custom", color: "currentColor", className: aR.Dq }),
                    (0, s.jsx)(p.E, {
                        variant: "text-sm/medium",
                        color: "currentColor",
                        lineClamp: 1,
...
function aM(e) {
    ...
    return null == a
        ...
        : (0, s.jsx)(aP, { invite: t, message: n, channel: a, onTransitionToInviteChannel: i });
}
var aD = n(652896),
    aO = n(834757),
    aU = n(427358),
...
function aw(e) {
    ...
    return (0, s.jsxs)(eb.D, {
        ...
        children: [
            null != r &&
                (0, s.jsx)(r, { className: aG.p, color: "currentColor", size: "custom", width: 12, height: 12 }),
            (0, s.jsx)(p.E, {
                variant: "text-xs/medium",
                lineClamp: 1,
                color: "currentColor",
                children: (0, s.jsxs)(li.A, { children: [i.name, " / ", a] }),
            }),
            (0, s.jsx)(t6._, { className: aG.t4, color: "currentColor", size: "custom", width: 12, height: 12 }),
        ],
    });
}
var aB = n(922139),
            ...
            return (0, s.jsxs)(eb.D, {
                ...
                children: [
                    ...
                    (0, s.jsx)(p.E, {
                        ...
                        variant: "text-sm/medium",
                        color: "text-default",
                        children: (0, s.jsx)(aY.A, { user: t, nick: l, hideDiscriminator: !0 }),
                    }),
                ],
            });
        },
...
function aJ(e) {
    let { guildId: t, channelId: n, users: i, onHoverOrFocus: l, ...a } = e,
        o = r.useCallback((e) => (0, s.jsx)(aq, { users: e, guildId: t, channelId: n, onHoverOrFocus: l }), [t, n, l]);
    return (0, s.jsx)(i9.Y, { renderPopout: () => o(i), ...a });
}
function aq(e) {
    let { users: t, guildId: n, channelId: i, onHoverOrFocus: l } = e,
        a = r.useRef(null),
        { isHoveringOrFocusing: o } = (0, aF.A)(a);
    return (
        r.useEffect(() => {
            l?.(o);
        }, [l, o]),
        (0, s.jsx)("div", {
            ...
            children: (0, s.jsx)(a_.Ip, {
                className: aW.G,
                children: t.map((e) =>
                    (0, s.jsx)(
                        aK,
                        { user: e, guildId: n ?? void 0, channelId: i, nick: aH.Ay.getNickname(n, i, e) },
                        e.id,
                    ),
                ),
            }),
...
var aX = n(531657);
let aZ = { mass: 1, tension: 170, friction: 26 };
function a$(e) {
    let { className: t, guildId: n, channelId: i, members: l, ref: a, motion: d } = e,
        ...
        [x, E] = (0, aV.z)(() => ({ x: 0, y: 0, scale: 1, config: aZ }));
    return (
        r.useEffect(() => {
            E({ x: g, y: p, scale: A });
        }, [g, p, A, E]),
        (0, s.jsxs)(aB.animated.div, {
            ref: a,
            className: o()(aX.gg, t),
            "data-count": h,
            "aria-hidden": !0,
            style: {
                transform: (0, aB.to)([x.x, x.y, x.scale], (e, t, n) => `translate3d(${e}px, ${t}px, 0) scale(${n})`),
            },
            children: [
                u.map((e, t) =>
                    (0, s.jsx)(
                        ...
                        {
                            className: aX.my,
                            children: (0, s.jsx)(i6.m, {
                                text: aH.Ay.getName(n, i, e),
                                asContainer: !0,
                                tag: "div",
                                children: (0, s.jsx)(tf.eu, {
                                    src: (function (e, t, n) {
                ...
                c && (0, s.jsx)(aQ, { guildId: n, channelId: i, members: l, count: m }, "overflow"),
            ],
        })
    );
}
    ...
    let { guildId: t, channelId: n, members: i, count: l } = e,
        {
            ...
            let e = r.useRef(null),
                { isHoveringOrFocusing: t } = (0, aF.A)(e),
                [n, i] = r.useState(!1),
                l = t || n,
                [s, a] = r.useState(!1),
                o = r.useRef(null);
...
function a1(e) {
    let { invite: t, message: n, guild: i, onTransitionToInviteChannel: l, onAcceptInstantInvite: a } = e,
        d = r.useRef(null),
        c = i ?? null;
    null == c && null != t.guild && (c = rW.DY(t.guild));
    let m = null != t.channel ? (0, rz.OY)(t.channel) : null;
    ...
    let h = (0, u.bG)([tl.A, D.A], () => {
        ...
        g = (0, u.bG)([ak.Ay], () => (h ? ak.Ay.getVoiceStatesForChannelAlt(m.id, c.id) : []), [m.id, c.id, h]),
        { label: A, sublabel: f } = (function (e) {
        ...
        })({ currentUserId: (0, u.bG)([M.default], () => M.default.getId()), author: n.author, voiceStates: g }),
        I = (0, u.bG)([tF.A], () => null != tF.A.getGuild(c.id), [c.id]),
        C = (0, u.bG)([ed.A], () => ed.A.getVoiceChannelId() === m.id, [m.id]),
        v = (0, u.bG)([ie.Ay], () => al([ie.Ay], t), [t]),
        _ = t.state === W.elq.ACCEPTING,
        { analyticsLocations: N } = (0, E.Ay)(x.A.INVITE_EMBED),
        j = (0, nH._U)(t.code, n.id),
        T = (function (e) {
            let { invite: t, message: n, voiceStates: i, guildId: l, channelId: s } = e;
            return (0, u.bG)([aI.A, aU.A], () => {
                if ((0, rF.G4)(t) && null != t.target_user) {
                    let e = aI.A.getStreamForUser(t.target_user.id, l);
                    if (null != e && e.channelId === s) return e;
                }
                let e = n.author.id;
                if (i.some((t) => t.voiceState.userId === e && t.voiceState.selfStream)) {
                    let t = aI.A.getStreamForUser(e, l);
                ...
                for (let e of [...r].sort((e, t) => {
                    let n = aU.A.getUserAffinity(e)?.vcProbability ?? 0;
                    return (aU.A.getUserAffinity(t)?.vcProbability ?? 0) - n;
                })) {
                    let t = aI.A.getStreamForUser(e, l);
                    if (null != t && t.channelId === s) return t;
                }
                ...
                (0, rw.he)(
                    {
                        ...
                        stream_key: null != T ? (0, aD._z)(T) : void 0,
                        number_of_users_in_channel: g.length,
                    },
                    N,
                );
        }, [t, n, N, j, I, y, T, g.length, l, a]),
        L = r.useCallback(() => {
            I ? (0, iv.iN)(m.id) : a({ autoJoin: !1 }),
                eG.default.track(W.HAw.VOICE_INVITE_EMBED_BREADCRUMB_CLICKED, {
                    ...
                    stream_key: null != T ? (0, aD._z)(T) : null,
                    number_of_users_in_channel: g.length,
                    location_stack: N,
                });
        }, [m.id, c.id, t.code, j, I, y, T, g.length, N, a]);
    (0, e4.A)({
        name: e5.ImpressionNames.VOICE_INVITE_EMBED,
        type: e5.ImpressionTypes.VIEW,
        properties: {
    ...
    let k = (0, u.bG)([sm.Ay], () => sm.Ay.useReducedMotion),
        R = r.useRef(null),
        [P, O] = r.useState({ percentX: 0, percentY: 0, proximity: 0 }),
        U = (0, u.bG)([aU.A], () => {
            let e = g.map((e) => e.user),
                ...
                i = e
                    ...
                    .sort((e, t) => {
                        let n = aU.A.getUserAffinity(e.id)?.vcProbability ?? 0;
                        return (aU.A.getUserAffinity(t.id)?.vcProbability ?? 0) - n;
                    });
            return null != t ? [t, ...i] : i;
        }, [g, n.author.id]),
    ...
    return (0, s.jsxs)("div", {
        ...
        children: [
            (0, s.jsxs)("div", {
                ...
                onMouseLeave: B,
                children: [
                    (0, s.jsx)("div", { className: a0.ys }),
                    (0, s.jsx)("div", { className: a0.r$, style: { "--custom-number-of-dots": 20 } }),
                    (0, s.jsxs)("div", {
                        className: a0.rf,
                        children: [
                            (0, s.jsxs)("div", {
                                className: o()(a0.Qs, { [a0.tE]: 0 === U.length }),
                                children: [
                                    (0, s.jsx)(aw, { channel: m, guild: c, onClick: L }),
                                    (0, s.jsxs)("div", {
                                        className: a0.WD,
                                        children: [
                                            (0, s.jsx)(p.E, {
                                                variant: "text-md/medium",
                                                children: (0, s.jsx)(li.A, { lineClamp: 3, delay: 150, children: A }),
                                            }),
                                            null != f
                                                ? (0, s.jsx)(p.E, {
                                                      variant: "text-sm/normal",
                                                      className: a0.$B,
                                                      children: (0, s.jsx)(li.A, { delay: 150, children: f }),
                                                  })
                                                : null,
                                        ],
                                    }),
            ...
            (0, s.jsxs)("div", {
                className: a0.qr,
                children: [
                    (0, s.jsx)(aN.G, { size: "custom", color: "currentColor", className: a0.Dq }),
                    (0, s.jsx)(p.E, {
                        variant: "text-sm/medium",
                        color: "currentColor",
                        lineClamp: 1,
...
function a2(e) {
    let { code: t, message: n, getAcceptInviteContext: i } = e,
        { invite: l, inviteError: a } = (0, u.cf)(
            [rK.A],
            () => ({ invite: rK.A.getInvite(t), inviteError: rK.A.getInviteError(t) }),
            [t],
        ),
        o = null == l,
        d = (0, nH._U)(t, n.id);
    r.useEffect(() => {
        o && rw.Ay.resolveInvite(t, void 0, { inviteInstanceId: d });
    }, [t, o, d]);
    let c = l ?? { state: W.elq.RESOLVING, code: "" },
        ...
        p = (0, u.bG)([M.default], () => M.default.getId()),
        A = (0, u.bG)([rV.Ay], () => rV.Ay.getGuildScheduledEvent(c.guild_scheduled_event?.id), [c]),
        x = () => {
            null != c.channel && rw.Ay.transitionToInviteSync(c);
        },
        f = function () {
            let { autoJoin: e } = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                n = null == h && l?.guild != null ? rW.DY(l.guild) : h;
            (0, rY.g)({ guild: n, isMember: null != h, analyticsLocations: m }) === rY.W.PROCEED &&
                rw.Ay.acceptInviteAndTransitionToInviteChannel({
                    inviteKey: t,
    ...
    switch (c.state) {
        ...
        case W.elq.BANNED:
            ...
            break;
        case W.elq.ERROR:
            I = (0, s.jsx)(r6, { author: n.author, inviteError: a });
            break;
        default:
            switch ((0, rF.On)(c)) {
                case rF.Xd.GROUP_DM:
                    ...
                    break;
                case rF.Xd.FRIEND:
                    I = (0, s.jsx)(r9, { invite: c, message: n, getAcceptInviteContext: i });
                    break;
                default:
                    if ((0, rF.G4)(c)) {
                        if (null != c.channel && (0, rz.OY)(c.channel).isGuildVoice() && null != c.guild) {
                            let e = rq({ location: "InviteEmbed.isStreamInvite", guildId: c.guild.id });
                            if (g)
                                if (e.enabled) {
                                    I = (0, s.jsx)(aM, {
                                        onTransitionToInviteChannel: x,
                    ...
                    if ((0, rF.oK)(c)) {
                        I = (0, s.jsx)(r1, { invite: c, getAcceptInviteContext: i, message: n });
                        break;
                    }
                    if (null != c.channel && (0, rz.OY)(c.channel).isGuildVoice() && null != c.guild) {
                        let e = rq({ location: "InviteEmbed.isGuildVoice", guildId: c.guild.id });
                        if (g)
                            if (e.enabled) {
                                I = (0, s.jsx)(aM, {
                                    onTransitionToInviteChannel: x,
    ...
    return (0, s.jsx)(sX.A, { section: W.JJy.INVITE_LINK, children: I });
}
var a3 = n(266620),
    a6 = n(860227),
    a5 = n(67416),
...
let a7 = (e) => {
    let { channel: t, message: n, hideParty: i, hideInviteEmbedBanner: l } = e,
        { analyticsLocations: r } = (0, E.Ay)(x.A.INVITE_EMBED),
        a =
            null != n.application
                ? nN.Ay.createFromServer(n.application)
                : null != n.activity && null != n.activity.party_id && (0, a9.pH)(n.activity.party_id)
                  ? a4.HT
                  : void 0,
...
function ot(e) {
    let { applicationId: t, guildId: n } = e,
        { data: i } = (0, eZ.YY)(t);
    return null == i ? null : (0, s.jsx)(on, { app: i, guildId: n });
}
function on(e) {
...
var oi = n(394839),
    ...
    od = n(416620);
let oc = [W.Auw.GIFV],
    ou = 15 * lQ.A.Millis.MINUTE,
    om = new Set(["discord-developers", "discord-testers", "discord-townhall", "discordgameslab"]),
    oh = (e) => () => {
        let { url: t, proxyUrl: n, width: i, height: l, flags: r } = e,
            a = (0, c.Lt)(r, nq.e5.IS_ANIMATED);
        return null != i && null != l && (nX.bp.test(n) || (a && (nX.P8.test(n) || nX.p4.test(n))))
            ? (0, s.jsx)(sT.A, { width: i, height: l, src: n, url: t, format: m.TL.IMAGE, className: od.jj })
            : null;
    };
class og extends r.Component {
    ...
    shouldRenderInvite(e) {
        ...
        return !(t.isDM() && !t.isSystemDM() && !t.isGroupDM() && om.has(e));
    }
    ...
    renderCtaButton() {
        let { message: e, channel: t, ctaButtonType: n } = this.props,
            i = null;
        switch (n) {
            case l2.xC.MARK_AS_FALSE_POSITIVE:
                i = (0, s.jsx)(t3, { messageId: e.id, channelId: t.id });
                break;
            case l2.xC.AGE_VERIFICATION_RETRY:
                i = (0, s.jsx)(eE, { channelId: t.id });
                break;
            default:
                return null;
        }
        return (0, s.jsx)("div", { className: od.od, children: i });
    }
    renderCodedLinks(e) {
        ...
        return e.codedLinks.map((n) => {
            ...
            switch (i) {
                ...
                case tM.I.TEMPLATE:
                    return (0, s.jsx)(nV, { code: l }, l);
                case tM.I.EVENT:
                    return (0, s.jsx)(nM.A, { code: l }, l);
                case tM.I.CHANNEL_LINK:
                    return (0, s.jsx)(st, { code: l, message: e }, l);
                case tM.I.GUILD_PRODUCT:
                    return (0, s.jsx)(nP, { code: l }, l);
                case tM.I.SERVER_SHOP:
                    return (0, s.jsx)(tJ, { guildId: l }, l);
                case tM.I.SOCIAL_LAYER_STOREFRONT: {
                    let [e, n] = l.split("-");
                    return (0, s.jsx)(
                        i2.A,
                        {
                            ...
                            customNavigateToSocialLayerStorefront: () => {
                                (0, i1.navigateToSocialLayerStorefrontWithGuildPreview)({ guildId: n });
                            },
                        },
                        l,
                    );
                }
                case tM.I.SOCIAL_LAYER_STOREFRONT_APP: {
                    let [e, n] = l.split("-");
                    return (0, s.jsx)(i2.I, { applicationId: n, skuId: e, channel: t }, l);
                }
                case tM.I.QUESTS_EMBED:
                    return (0, s.jsx)(ip.A, { questId: l }, l);
                case tM.I.COLLECTIBLES_SHOP:
                case tM.I.EXPERIMENT:
                    return null;
                default:
    ...
    renderAttachments(e) {
        ...
        if (0 === d.length || e.isPoll() || (0, lX._c)(e)) return null;
        ...
        function E(e, t) {
            return (0, l3.iW)(e.originalItem, t);
        }
        let f = m.map((s) => {
            let a = (0, nq.aG)(s),
                o = {
                    ...
                    onContextMenu:
                        null != r
                            ...
                            : void 0,
                    renderAudioComponent: x ? a3.SX : a3.Nj,
                    renderImageComponent: a3.Cr,
                    renderVideoComponent: a3.I1,
                    renderPlaintextFilePreview: a3.R6,
                    renderGenericFileComponent: a3.UB,
                    onPlay: (n, i, l) => {
    ...
    renderEmbed = (e, t, n, i) => {
        ...
        let m = oc.includes(e.type) ? e.url : (e.image?.url ?? e.video?.url);
        return (0, s.jsx)(
            nf.G.Provider,
            {
                value: (0, oa.b)(m, e.image, e.video, e.thumbnail, e.provider?.name),
    ...
    renderEmbeds(e) {
        ...
        return 0 === e.embeds.length || !t || n
            ...
            : e.embeds.map((t, n) => {
                  ...
                  let r = { renderImageComponent: i7.LL, renderVideoComponent: i7.$o, renderLinkComponent: i7.bU };
                  if (
                      ...
                      let i = l1.A.safeParseWithQuery(t.url);
    ...
    renderComponentAccessories(e) {
        ...
        return (0, s.jsx)(ss.N, {
            ...
            shouldHideMediaOptions: i,
            enabledContentHarmTypeFlags: n,
            children: (0, s.jsx)(nK.Ay, { message: e, shouldDisableInteractiveComponents: l }),
        });
    }
    renderActivityInvite(e) {
        if (null == e.activity) return null;
        let { channel: t, hideInviteEmbedBanner: n } = this.props;
        return (0, s.jsx)(a7, { channel: t, message: e, hideParty: !1, hideInviteEmbedBanner: n });
    }
    renderPublishBump(e) {
    ...
    renderStickersAccessories(e) {
        ...
        return 0 === t.length
            ? null
            : t.map((e) => (0, s.jsx)(lb, { channel: n, isInteracting: i, renderableSticker: e }, e.id));
    }
    renderThreadAccessories(e) {
        if (e.hasFlag(W.pr7.HAS_THREAD) && !1 !== this.props.renderThreadAccessory)
            return (0, s.jsx)(lJ, { message: e, compact: this.props.compact });
    }
    renderThreadRoleMentionWarning(e) {
        if (
            e.hasFlag(W.pr7.FAILED_TO_MENTION_SOME_ROLES_IN_THREAD) &&
            this.props.isCurrentUser &&
            !(Date.now() - lD.default.extractTimestamp(e.id) >= ou)
        )
            return (0, s.jsx)("div", { className: od.xM, children: J.intl.string(J.t.ma8Rs0) });
    }
    ...
    renderInteractionPremiumUpsell(e) {
        ...
        return e.type !== d.l.INTERACTION_PREMIUM_UPSELL || null == t
            ? null
            : (0, s.jsx)(ot, { applicationId: t, guildId: this.props.channel.guild_id });
    }
    ...
    renderPoll(e, t) {
        if (null != t) return (0, s.jsx)(ig.A, { message: e, poll: t, className: od.PM });
    }
    renderShareClientTheme(e) {
        return null != e.sharedClientTheme ? (0, s.jsx)(tk, { message: e }) : null;
    }
    renderReportedMessage(e) {
        if (e.messageSnapshots.length > 0 && (0, iA.Mn)(e, this.props.channel)) return (0, s.jsx)(iw, { message: e });
    }
    renderForwardedMessage(e) {
        if (e.messageSnapshots.length > 0 && !(0, iA.Mn)(e, this.props.channel))
            return (0, s.jsx)(nE, {
                message: e,
    ...
    renderEditedTag(e, t) {
        return (0, s.jsx)(or.A, { message: e, compact: t, location: or.O.AFTER_ACCESSORIES });
    }
    render() {
...
function op(e) {
    let t,
        ...
        o = (0, u.bG)([M.default], () => M.default.getId()),
        d = nn.X6.useSetting(),
        m = nn.hD.useSetting(),
        h = nn.rs.useSetting() && !(0, lM.A)(e.message),
        g = nn.jW.useSetting() && !1 !== e.renderReactions,
        p = nn.kt.useSetting(),
        A = (0, u.bG)([lZ.A], () => null == n.guild_id || lZ.A.canChatInGuild(n.guild_id), [n]),
        x = (0, u.bG)([nW.A], () => null != n.guild_id && nW.A.isLurking(n.guild_id), [n]),
        E = (0, u.bG)([ie.Ay, G.default], () => {
            let e = G.default.getCurrentUser();
            return (null != n.guild_id && null != e ? ie.Ay.getMember(n.guild_id, e.id)?.isPending : null) ?? !1;
        }),
        { canAddNewReactions: f, canManageMessages: I } = (0, u.cf)(
            [tl.A],
            () => ({
