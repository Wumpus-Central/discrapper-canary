    ...
    componentDidUpdate(e) {
        ...
        if (
            (null != t &&
                ...
                (0, s.a)(x.rMx.GUILD_VIEWED_CLICKSTREAM, { guildId: t })),
            null != n && n !== e.selectedChannel)
        ) {
            let e = (0, a.K)(u.Z.getChannel(n), !0);
            (0, d.Q)(x.rMx.CHANNEL_OPENED, {
                ...e,
                ...(0, o.$H)(n)
            }),
                (0, s.a)(x.rMx.CHANNEL_OPENED_CLICKSTREAM, { channelId: n });
        }
    }
    render() {
        return null;
...
let C = r.ZP.connectStores([m.Z, f.Z, _.Z, g.default, v.Z, c.ZP, p.Z, h.ZP], () => {
    var e, t, n;
