...
var i = n(228366),
    ...
    d = n(19575),
    _ = n(652215);
let h = { development: [0, 0, 0, 0], canary: [1, 0, 30, 10], ptb: [1, 0, 1005, 2], stable: [1, 0, 9001, 2] };
function f() {
    return !d.Ay?.isModuleVersionAtLeast?.("discord_hook", h);
}
let p = null;
async function E() {
    ...
    return E().then((n) => {
        ...
        return new Promise((o) => {
            let l = (e, n) => {
                ...
                f = a.Ay.getOverlayOptionsForPID(e),
                p = { ...s.gH, ...f, elevate: a.Ay.shouldElevateProcessForPID(e) };
