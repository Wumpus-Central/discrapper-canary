...
let d = new Set([
    ...
    V.BV.WELCOME(T.p.guildId({ optional: !0 }), T.p.channelId({ optional: !0 })),
    V.BV.GUILD_EVENT_DETAILS(T.p.guildId({ optional: !0 }), ":guildEventId"),
    V.BV.GUILD_SETTINGS(T.p.guildId(), ":section?", ":subsection?"),
    V.BV.CHANNEL_THREAD_VIEW(T.p.guildId(), T.p.channelId(), ":threadId", ":messageId?"),
    V.BV.CHANNEL(T.p.guildId(), T.p.channelId({ optional: !0 }), ":messageId?"),
    V.BV.ACTIVITY,
    V.BV.ACTIVITIES,
