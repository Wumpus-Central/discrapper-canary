...
class y extends o.Z {
    ...
    handlePostConnectionOpen() {
        (this.nativeUpdateCountThreshold = (0, f.W)({ location: 'post_connection_open' }).nativeUpdateCount), this.checkForUpdates(), (this._checkInterval = setInterval(this.checkForUpdates, h));
    }
            ...
            p(this, '_handleNativeUpdateNotAvailable', () => {
                this._handleCheckingForUpdates(),
                    r.tn
                        ...
                        .then(
                            (e) => {
                                if (null == e.body || 'fe314ef8bad1190c57a4813cbd559ea9360bde7d' === e.body.hash) return this._handleUpdateNotAvailable();
