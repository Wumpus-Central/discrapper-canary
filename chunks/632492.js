        ...
        drawImage: (e) =>
            ((e, t) => {
                ...
                let o = ((e, t) => {
                    ...
                    if (
                        (7 >= y()().diff(y()(l), "days") && n.push({ iconPath: k.fB, text: O.intl.string(O.t.vYuyWf) }),
                        (0, I.Rf)(e) && n.push({ iconPath: k._P, text: O.intl.string(O.t.keY6mW) }),
                        (0, I.BZ)(e))
                    ) {
                        let t = (0, I.iy)(e);
                        n.push({ iconPath: k.Jd, text: O.intl.formatToPlainString(O.t["Klie/P"], { days: t }) });
                    }
                    (0, I.CZ)(e) === b.m.GLOBAL && n.push({ iconPath: k.Cv, text: O.intl.string(O.t.kAlUsy) });
                    let i = (0, I.KH)(e);
                    ...
                    if ((0, I.uw)(e)) {
                        let t = (0, I.ty)(e);
                        if (null != t) {
                            let e = O.intl.formatToPlainString(O.t.C0AxoR, { hours: Math.round(t / T.A.Seconds.HOUR) });
                            return [{ iconPath: k.pc, text: `${O.intl.string(O.t["/50eHi"])} — ${e}` }];
                        }
                    }
                    return n;
                })(s, n);
...
let G = (e) => {
                ...
                let a =
                    W > 0
                        ...
                        : ((l = O.t["bES+y2"]),
                          ...
                          O.intl.formatToMarkdownString(l, { gameName: s, userName: i }).replaceAll("*", ""));
                return M({
                    entry: n,
    ...
    let J = (0, l.jsx)(P.iT, { location: P.N5.POPOUT, entry: n }),
        Y = (0, l.jsx)(D.BC, {
            channel: t,
            userDescription: (0, I.JM)(n) ? O.t.vPg1JT : O.t.rPqqts,
        ...
        ee =
            null != Q || b
                ...
                : (0, l.jsx)(r.$, {
                      ...
                      fullWidth: !0,
                      onClick: K,
                      text: O.intl.string(O.t.GDWYR8),
                      icon: c.k,
                  }),
        et = [Q, $ && !b ? X : ee].filter(x.Vq);
        ...
        children: [
            ...
            (0, l.jsx)(D.Eh, {
                children: (0, l.jsx)(D.fD, {
                    ...
                    reactionImageAltText: O.intl.formatToPlainString(O.t.tAwI1k, {
                        username: N.username,
