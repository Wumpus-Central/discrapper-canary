...
e.exports = (function (e) {
    function t(e) {
        ...
        return (
            ...
            (r._restSpeedThreshold = f(e.restSpeedThreshold, 0.001)),
            (r._initialVelocity = e.velocity),
            (r._lastVelocity = f(e.velocity, 0)),
            ...
            void 0 !== e.bounciness || void 0 !== e.speed
                ? (u(
                  ...
                  (n = d.fromBouncinessAndSpeed(f(e.bounciness, 8), f(e.speed, 12))))
                : (n = d.fromOrigamiTensionAndFriction(f(e.tension, 40), f(e.friction, 7))),
            ...
            },
            {
                ...
                value: function () {
                    ...
                    if (
                        ...
                        if (
                            (0 !== this._tension &&
                                (v = Math.abs(this._toValue - e) <= this._restDisplacementThreshold),
                            y || (O && v))
                        ) {
