...
class S extends (r = o.Component) {
    ...
    render() {
        var e, t;
        let { disabled: n, value: r, placeholder: o, autoFocus: a, minLength: l, maxLength: u, allowOverflow: f, spellCheck: E, resizeable: b, className: v, id: I, rows: S, flex: T, autosize: A, required: N, onInvalid: C, inputRef: P } = this.props,
            R = A ? _.l : 'textarea',
            w = this.hasError(),
