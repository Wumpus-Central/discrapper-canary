...
function w(e) {
    ...
    return (
        i && !o ? (A = !0) : (i || o) && (A = (0, c.Bd)(null != T ? T : E.p6O) > 0.1),
        (0, r.jsx)(f.t, {
            offset: -2,
            children: (0, r.jsxs)(
                'button',
...
function x(e) {
    let { value: t, eagerUpdate: n = !1, onChange: o, onClose: s, suggestedColors: l, middle: f, footer: m, showEyeDropper: E, wrapperComponentType: O, className: I } = e,
        T = (0, h.Z)(),
        A = P(t),
        R = null != A ? A : 0,
        w = (0, c.Rf)(R),
