        ...
        return (0, a.jsxs)("div", {
            ...
            children: [
                ...
                (0, a.jsx)(u.$, {
                    ...
                    onClick: () => {
                        var e;
                        return (e = t.id), void ((0, D.default)(), y.A.openPrivateChannel({ recipientIds: e }), s());
                    },
                }),
            ],
        });
    ...
    w = (e) => {
        ...
        return null === l
            ...
            : (0, a.jsx)(T.k, {
                  ...
                  subtitle:
                      !0 === r
                          ? U.intl.format(U.t["4gJJfD"], { helpdeskArticle: h.A.getArticleURL(L.MVz.REFERRAL_PROGRAM) })
                          : U.intl.format(U.t.AwGSWl, { helpdeskArticle: h.A.getArticleURL(L.MVz.REFERRAL_PROGRAM) }),
                  onClose: s,
                  transitionState: t,
              ...
              : !1 === A
                ? (0, a.jsx)(c.Modal, {
                      ...
                      subtitle: U.intl.format(U.t.OOCbz8, {
                          helpdeskArticle: h.A.getArticleURL(L.MVz.REFERRAL_PROGRAM),
                      }),
                      onClose: i,
                      actions: [],
                  })
...
let z = (e) => {
    let { transitionState: t, onClose: i, startingScreen: s = 1 } = e,
        ...
        [l, c] = n.useState(s),
        [o, u] = n.useState([]),
        { analyticsLocations: A } = (0, x.Ay)([g.A.PREMIUM_MARKETING_REFERALL_PROGRAM_SHARE_MODAL]),
        p = async (e) => {
            E.default.track(L.HAw.REFERRAL_PROGRAM_SHARE_CTA_CLICKED, { location_stack: A });
    ...
    return null === r
        ? (0, a.jsx)(m.y, {})
        : 2 === l
          ? (0, a.jsx)(w, { transitionState: t, isReminderConfirmation: 3 === s, results: o, onClose: i })
          : 1 === l
