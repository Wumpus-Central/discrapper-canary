                ...
                connect: i.useCallback(
                    (t) => {
                        ...
                        async function s() {
                            ...
                            if ((l(t.type), "url" === n.type)) return void (0, eT.h)({ href: n.url, trusted: !1 });
                            let a =
        ...
        children: (0, l.jsxs)("div", {
            ...
            children: [
                ...
                null != a
                    ...
                    : null,
                (0, l.jsx)(T.A.Title, { className: ez.Qw, wrapperClassName: ez.DD, children: t }),
            ],
        }),
    });
}
...
function eZ() {
    let e = (function () {
        ...
        t = i.useCallback(() => {
            null != e &&
                ("channel" === e.kind
                    ? (0, D.pX)(eq.BVt.CHANNEL(e.guildId, e.channelId))
                    : (0, eT.h)({ href: e.url, trusted: !0 }));
        }, [e]);
    return null == e
        ? null
        : (0, l.jsx)("div", {
                        ...
                        (e) => {
                            ...
                            null != a
                                ...
                                : (0, c.A)({
                                      ...
                                      variant: "critical",
                                      onConfirm: async () => {
                                          (0, D.pX)(eq.BVt.CHANNEL(u, eM.VV.VIBEGRATIONS, t));
                                          try {
...
function ts(e) {
    ...
    let K = (0, u.bG)([$.Ay], () => (null == z ? null : $.Ay.getIntegrationStatus(z)), [z]),
        ...
        eT = (0, te.x1)(eR) && eR.data.proxyTicketRefreshing,
        eD = i.useCallback(() => {
            null == eR || eT || R.A.refreshProxyTicket(eR.id);
        }, [eR, eT]),
        eL = i.useCallback(() => {
            var e, n;
    ...
    let eH = K?.integration_installed === !0 && t?.guild_id != null ? t.guild_id : o,
        ...
        eW = ed
            ...
            : ee && null == K
              ...
              : void 0;
    i.useEffect(() => {
        null == t && a && (0, D.pX)(eq.BVt.CHANNEL(o, eM.VV.VIBEGRATIONS));
    }, [o, t, a]);
                    ...
                    : (0, l.jsxs)("div", {
                          ...
                          children: [
                              ...
                              (0, l.jsx)(eV, {
                                  ...
                                  isOwner: (0, $.PV)(t),
                                  canRemix: (0, $.H_)(t),
                                  onRefresh: (0, te.x1)(eR) ? eD : void 0,
                                  isRefreshing: eT,
                                  onClose: eL,
                                  onExport: eO,
                                  onImport: ez.open,
                              ...
                              ef
                                  ? null
                                  : (0, l.jsx)(T.A.Icon, { icon: tn, tooltip: eg, "aria-label": eg, onClick: ey }),
                          ],
                      }),
        });
    return (0, l.jsxs)("div", {
...
function tr(e) {
    ...
    let E = i.useCallback((e) => {
                ...
                if ("idea" !== a && "submitting" !== a) {
                    ...
                    try {
                        ...
                        ((0, Z.Hc)(e),
                            (0, Z.r2)(e, I ?? H.Cl),
                            (0, Z.dv)(e, t),
                            (0, D.pX)(eq.BVt.CHANNEL(n, eM.VV.VIBEGRATIONS, e)),
                            m(""),
                            N(null));
                    } catch (e) {
                        v((0, Y.Xd)(e));
            ...
            async (e, t) => {
                ...
                try {
                    ((l = await (0, B.gA)({ guild_id: n, install_scope: t })),
                        ...
                        (0, D.pX)(eq.BVt.CHANNEL(n, eM.VV.VIBEGRATIONS, l)),
                        N(null));
                } catch {
        ...
        M = i.useCallback(() => {
            (0, D.pX)(eq.BVt.CHANNEL(n, eM.VV.VIBEGRATIONS));
        }, [n]),
        z = i.useCallback((e) => {
            (m(e), v(null));
        }, []),
