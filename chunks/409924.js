...
function d(e) {
    let a = e.regex,
        s = c(e),
        o = n,
        d = ['any', 'void', 'number', 'boolean', 'string', 'object', 'never', 'symbol', 'bigint', 'unknown'],
        f = {
    ...
    Object.assign(s.keywords, m), s.exports.PARAMS_CONTAINS.push(g);
    let v = s.contains.find((e) => 'attr' === e.scope),
        I = Object.assign({}, v, { match: a.concat(o, a.lookahead(/\s*\?:/)) });
    return (
        s.exports.PARAMS_CONTAINS.push([s.exports.CLASS_REFERENCE, v, I]),
        (s.contains = s.contains.concat([g, f, _, I])),
        E(s, 'shebang', e.SHEBANG()),
        E(s, 'use_strict', h),
