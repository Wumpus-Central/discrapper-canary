...
function B(e) {
    ...
    let W,
        ...
        { isEmbeddedIAP: em, activeSubscription: ep, selectedSkuId: ex, defaultPlanId: eh, isPremium: ef, startedPaymentFlowWithPaymentSourcesRef: ev, setInvoicePreview: eg, contextMetadata: eE, inReverseTrial: eS, setPurchaseError: ej } = (0, f.usePaymentContext)(),
