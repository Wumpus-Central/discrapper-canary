...
class eE extends f.Z {
    ...
    _handleDisconnect(e, t, n, r) {
        ...
        this.setState(en.hes.DISCONNECTED, { willReconnect: S });
    }
    _handleResuming(e) {
        var t, n;
    ...
    constructor({ userId: e, sessionId: t, guildId: n, channelId: r, context: i = er.Yn.DEFAULT, rtcServerId: o, parentMediaSessionId: a }) {
        ...
        super(),
            ...
            ei(this, 'incomingVideoEnabledChanged', (e) => {
                ...
                let { revertOcclusionTrackingChanges: i } = P.C.getCurrentConfig({ location: 'Incoming Video Enabled Changed' });
            ...
            ei(this, 'windowVisibilityChanged', (e) => {
                var t, n;
                let { revertOcclusionTrackingChanges: r } = P.C.getCurrentConfig({ location: 'Window Viz Changed' });
