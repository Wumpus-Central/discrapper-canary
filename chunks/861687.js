n.d(t, { Z: () => eS }), n(35282), n(415506), n(539854), n(457542), n(388685), n(49124);
var r = n(654861),
    i = n.n(r),
    a = n(954955),
    o = n.n(a),
...
class eS extends d.Z {
    get quality() {
        ...
        return this.state !== ec.hes.RTC_CONNECTED || void 0 === e
            ? ec.IE4.UNKNOWN
    ...
    connect(e, t) {
        ...
        if (
            ...
            return void this.setState(ec.hes.AWAITING_ENDPOINT);
        let i = this._socket;
        null != i && this._cleanupSocket(),
            null != this._nextChannelId && ((this._channelId = this._nextChannelId), (this._nextChannelId = void 0)),
            (i = this._socket = new $.Z(this.endpoint, this.context)).on(
                $.V.Connecting,
                this._handleConnecting.bind(this, i),
            ),
            i.on($.V.Connect, this._handleConnect.bind(this, i)),
            i.on($.V.Disconnect, this._handleDisconnect.bind(this, i)),
            i.on($.V.Resuming, this._handleResuming.bind(this, i)),
            i.on($.V.Ready, this._handleReady.bind(this, i)),
            i.on($.V.Speaking, this._handleSpeaking.bind(this, i)),
            i.on($.V.Video, this._handleVideo.bind(this, i)),
            i.on($.V.Ping, this._handleControlPing.bind(this)),
            i.on($.V.ClientDisconnect, this._handleClientDisconnect.bind(this)),
            i.on($.V.ClientConnect, this._handleClientConnect.bind(this)),
            i.on($.V.Codecs, this._handleCodecs.bind(this)),
            i.on($.V.MediaSessionId, this._handleMediaSessionId.bind(this)),
            i.on($.V.MediaSinkWants, this._handleMediaSinkWants.bind(this)),
            i.on($.V.VoiceBackendVersion, this._handleCodeVersion.bind(this)),
            i.on($.V.KeyframeInterval, this._handleKeyframeInterval.bind(this)),
            i.on($.V.Flags, this.handleFlags.bind(this)),
            i.on($.V.Platform, this.handlePlatform.bind(this)),
            i.on($.V.BandwidthEstimationExperiment, this._handleBandwidthEstimationExperiment.bind(this)),
            i.on($.V.SecureFramesInit, this._handleSecureFramesInit.bind(this)),
            i.on($.V.SecureFramesPrepareTransition, this._handleSecureFramesPrepareTransition.bind(this)),
            i.on($.V.SecureFramesPrepareEpoch, this._handleSecureFramesPrepareEpoch.bind(this)),
            i.on($.V.SecureFramesExecuteTransition, this._handleSecureFramesExecuteTransition.bind(this)),
            i.on($.V.MLSExternalSenderPackage, this._handleMLSExternalSenderPackage.bind(this)),
            i.on($.V.MLSProposals, this._handleMLSProposals.bind(this, i)),
            i.on($.V.MLSPrepareCommitTransition, this._handleMLSPrepareCommitTransition.bind(this)),
            i.on($.V.MLSWelcome, this._handleMLSWelcome.bind(this)),
    ...
    destroy() {
        ...
        if (
            ...
            Y.Z.removeOnlineCallback(this._handleNetworkOnline),
            Y.Z.removeOfflineCallback(this._handleNetworkOffline),
            (0, W.isDesktop)() && (null == (o = (s = this).powerMonitorListener) || o.call(s)),
            el.w.off(el.e.IncomingVideoEnabledChanged, this.incomingVideoEnabledChanged),
            el.w.off(el.e.WindowVisibilityChanged, this.windowVisibilityChanged),
            this._backoff.cancel(),
            this._cleanupSocket(),
    ...
    shouldSendSpeaking(e, t) {
        ...
        return (
            ...
            (void 0 !== this._lastSentSSRC || e !== eu.Dg.NONE) &&
            (this._lastSentSSRC === t || e !== eu.Dg.NONE) &&
    ...
    setNextChannelId(e) {
        ...
        this.logger.info("Updating channel: ".concat(e, "(").concat(n, ")")),
            L.Z.getCurrentConfig({ location: "setNextChannelId" }).enabled
    ...
    _chooseExperiments(e) {
        ...
        if ((this._recordingEnabled && t.push("connection_log"), null != this.guildId)) {
            let { shouldOverrideKrisp: e, overrideKrispSetting: n } = R.Z.getCurrentConfig(
                {
        ...
        if (
            (j.Z.supports(eu.AN.FIXED_KEYFRAME_INTERVAL) && t.push("fixed_keyframe_interval"),
            0 !== this._supportedBandwidthEstimationExperiments.length)
        ) {
            let e = N.Z.workerExperimentString();
            null != e && t.push(e);
        }
        this.context === eu.Yn.DEFAULT && (0, I.f)("RtcConnection").enabled && t.push("audio_transport_cc"),
            C.Z.getCurrentConfig({ location: "_chooseExperiments" }, { autoTrackExposure: !0 }).enabled &&
        ...
        n.prewarm && t.push("prewarm_cuda_cache"),
            n.clear && t.push("clear_cuda_cache"),
    ...
    _handleDisconnect(e, t, n, r) {
        ...
        this.logger.info(
            ...
            t ||
                ...
                (F.default.track(
                    ec.rMx.VOICE_CONNECTION_SOCKET_FAILURE,
                    ep(ef({}, this._getAnalyticsProperties()), {
                        hostname: this.hostname,
        ...
        if (this.state !== ec.hes.DISCONNECTED) {
            ...
            if (null != e && this.context === eu.Yn.DEFAULT) {
                if ((e.stop(), this._sentVideo)) {
                    ...
                    null != t &&
                        ...
                        F.default.track(
                            ec.rMx.VIDEO_CALL_ENDED,
                            ep(ef({}, t), { media_session_id: this.getMediaSessionId() }),
                        );
                }
            ...
            let n = B.Z.shouldIncludePreferredRegion() ? B.Z.getPreferredRegion() : null,
                ...
                o =
                    null == (u = P.Z.getConnectionStats(this.getMediaEngineConnectionId())) ||
            ...
            Promise.all([
                ...
                D.Z.getKrispModel(),
                j.Z.getKrispEnableStats() ? j.Z.getMediaEngine().getNoiseCancellationStats() : Promise.resolve(null),
            ]).then((e) => {
                let [{ batteryUsageRounded: t }, n, r] = e;
                F.default.track(
                    ec.rMx.VOICE_DISCONNECT,
                    ep(ef({}, s), {
                        battery_usage: t,
                        krisp_nc_model: n,
        ...
        this.setState(ec.hes.DISCONNECTED, { willReconnect: N });
    }
    _handleResuming(e) {
        var t, n;
    ...
    _handleReady(e, t, n, r, i, a, o) {
        ...
        let l = j.Z.getMediaEngine(),
            ...
            u = null != (s = M.default.getStaticAuthSessionId()) ? s : void 0,
            d = A.Z.getConfig({ location: "RTCConnection" }).minBitrate,
            h = (0, _.zO)(),
            g = l.connect(
                this.context,
                this.userId,
            ...
            b = (0, _.zO)() - h;
        g.setUseElectronVideo(l.supports(eu.AN.ELECTRON_VIDEO)),
            j.Z.supports(eu.AN.IMAGE_QUALITY_MEASUREMENT) &&
                g.setVideoQualityMeasurement("imageQualityWebrtcPsnrDb:5000,imageQualityVmaf_v061:5000,hwdec");
        let y = ["unk"];
        this.context === eu.Yn.STREAM && (y.push("nvRelaxRc=250"), y.push("nvNewPresets")),
            ...
            g.on(f.Sh.ToggleMuteFromNative, () => {
                this.context === eu.Yn.DEFAULT && m.Z.toggleSelfMute({ playSoundEffect: !1 });
            }),
            ...
            g.on(f.Sh.FirstFrame, (e, t, n) => {
                null != this._localMediaSinkWantsManager &&
                    ...
                    this.emit(Q.z.Video, this.guildId, this.channelId, eT(e), n, this.streamServerId)),
            ...
            g.on(f.Sh.Connected, (r, i) => {
                ...
                switch (
                    ((this._voiceQuality = new es.Z(g)),
                    this._voiceQuality.start(),
                    this._voiceQuality.on(es.B.InputDeviceSampleRateChanged, (e) => {
                        p.Z.dispatch({
                    ...
                    (this._systemResponsiveness = new er.Z(g)),
                    this._systemResponsiveness.start(),
                    (this._systemResources = new en.Z()),
                    this._systemResources.setLastBattery(),
                    (this._noiseCancellationError = 0),
                    (this._voiceDuration = new eo.Z(this.userId, g)),
                    this._voiceDuration.start(g.getSelfMute(), g.getVoiceFilterId()),
                    (this.protocol = r),
                    r)
                ) {
                    case "udp":
                    ...
                    case "webrtc":
                        this.logger.info("Sending local SDP to RTC server."),
                            e.once($.V.SDP, this._handleSDP.bind(this)),
            ...
            g.on(f.Sh.Error, (t) => {
                ...
                this.logger.error("Error occurred while connecting to RTC server: ".concat(t)),
                    F.default.track(
                        ec.rMx.VOICE_CONNECTION_FAILURE,
                        ep(ef({}, this._getAnalyticsProperties()), {
                            hostname: this.hostname,
                            port: this.port,
                            protocol: this.protocol,
            ...
            g.on(f.Sh.ConnectionStateChange, (t) => {
                ...
                if (
                    (n === ec.hes.RTC_CONNECTING && this.state === ec.hes.RTC_DISCONNECTED
                        ? this.reconnect()
                        : this.state === ec.hes.NO_ROUTE &&
                          (0 === this._backoff.fails && this._handleNoRoute(), this._backoff.fail(this.reconnect)),
                    this.state === ec.hes.RTC_CONNECTED)
                ) {
                    ...
                    if (this._connecting) {
                        ...
                        F.default.track(
                            ec.rMx.VOICE_CONNECTION_SUCCESS,
                            ef(
                                ep(ef({}, n), {
                                    hostname: this.hostname,
                                    port: this.port,
                            ...
                            F.default.track(ec.rMx.VOICE_CONNECTION_TTC_COLLECTED, {
            ...
            g.on(f.Sh.Ping, this._handlePing.bind(this)),
            g.on(f.Sh.PingTimeout, this._handlePingTimeout.bind(this)),
            g.on(f.Sh.OutboundLossRate, this._handleOutboundLossRate.bind(this)),
            g.on(f.Sh.SoundshareTrace, this._handleSoundshareTrace.bind(this)),
            g.on(f.Sh.LocalVideoDisabled, this._handleLocalVideoDisabled.bind(this)),
            g.on(f.Sh.Stats, X.Z.create()),
            g.on(f.Sh.RemoteStreamsReady, this._handleRemoteStreamsReady.bind(this)),
            g.on(f.Sh.UsersMerged, this.handleUsersMerged.bind(this)),
            g.on(f.Sh.NoiseCancellationError, (e) => {
                this._noiseCancellationError = e;
            }),
            g.on(f.Sh.MLSFailure, this._handleMLSFailure.bind(this)),
            g.setRemoteVideoSinkWants(this._remoteVideoSinkWants),
            (this._connection = g),
            (this._mediaEngineConnectionId = g.mediaEngineConnectionId);
    }
    _handleSpeaking(e, t, n, r) {
        let i = this._connection;
        if (null != i && this.userId !== t) {
            var a;
            r !== eu.Dg.NONE && i.createUser(t, n),
    ...
    getOrCreateVideoQuality() {
        if (null != this._connection && null == this._videoQuality) {
            (this._videoQuality = new ea.S(this._connection)),
            ...
            if (e) {
                (this._videoHealthManager = new ei.y(t, n, r, i)),
                    null != this._localMediaSinkWantsManager &&
                ...
                this._videoQuality.on(ea.d.FpsUpdate, e);
            }
        }
    ...
    _handleRemoteStreamsReady(e) {
        ...
        F.default.track(
            ec.rMx.VOICE_CONNECTION_REMOTE_STREAMS_CREATED,
            ep(ef({}, this._getAnalyticsProperties()), {
                number_of_users: e,
                duration_ms: t,
            }),
    ...
    _handleCodecs(e, t) {
        ...
        null != n && null != this.protocol
            ? n.setCodecs(null != e && "" !== e ? e : eu.ad.OPUS, null != t && "" !== t ? t : eu.ad.H264, this.context)
    ...
    _trackSecureFrameTransition(e) {
        ...
        F.default.track(
            ec.rMx.SECURE_FRAMES_TRANSITION,
            ep(ef({}, this._getAnalyticsProperties()), {
                media_session_id: this.getMediaSessionId(),
                parent_media_session_id: this.parentMediaSessionId,
                sender_user_id: this.userId,
    ...
    _trackMLSFailures(e) {
        ...
        for (let { id: e, source: i, reason: a, count: o, countDuringReset: s, firstOccurrence: l } of this
            ._mlsFailures)
            F.default.track(
                ec.rMx.MLS_FAILURES,
                ep(ef({}, this._getAnalyticsProperties()), {
    ...
    getInputDeviceName() {
        var e;
        let t = j.Z.getInputDeviceId();
        return null == (e = j.Z.getInputDevices()[t]) ? void 0 : e.name;
    }
    getOutputDeviceName() {
        var e;
        let t = j.Z.getOutputDeviceId();
        return null == (e = j.Z.getOutputDevices()[t]) ? void 0 : e.name;
    }
    getVideoDeviceName() {
        var e;
        let t = j.Z.getVideoDeviceId();
        return null == (e = j.Z.getVideoDevices()[t]) ? void 0 : e.name;
    }
    ...
    constructor({
        ...
        super(),
            ...
            ed(this, "_handleVoiceQualityPeriodicsStats", () => {
                if (null != this._voiceQuality) {
                    ...
                    if (this.shouldReportPeriodicStats(e))
                        for (let t of e)
                            F.default.track(
                                ec.rMx.VOICE_QUALITY_PERIODIC_STATS,
                                ep(ef({}, this._getAnalyticsProperties()), {
                                    media_session_id: this.getMediaSessionId(),
            ...
            ed(this, "_trackVoiceConnectionConnecting", () => {
                let e = k.Z.getChannel(this.channelId),
                    t = null == e ? void 0 : e.type;
                F.default.track(
                    ec.rMx.VOICE_CONNECTION_CONNECTING,
                    ep(ef({}, this.getAudioDeviceStates(), this.getVideoDeviceStates()), {
                        guild_id: this.guildId,
                        channel_id: this.channelId,
                        rtc_connection_id: this.getRTCConnectionId(),
                        hostname: this.hostname,
            ...
            (this.state = ec.hes.AWAITING_ENDPOINT),
        ...
        if (i === eu.Yn.DEFAULT) {
            var p;
            let t = (null == (p = k.Z.getChannel(this.channelId)) ? void 0 : p.type) === ec.d4z.GUILD_STAGE_VOICE;
            (this._localMediaSinkWantsManager = new ee.ZP(e, t, f)),
        ...
        (this._remoteVideoSinkWants = ee.Yy),
            el.w.on(el.e.IncomingVideoEnabledChanged, this.incomingVideoEnabledChanged),
            el.w.on(el.e.WindowVisibilityChanged, this.windowVisibilityChanged),
            ...
            (0, W.isDesktop)() &&
                (this.powerMonitorListener = q.Z.remotePowerMonitor.on("resume", this._handlePowerResume)),
            (this._supportedBandwidthEstimationExperiments = []),
            (this._bandwidthEstimationExperiment = null),
            j.Z.getMediaEngine().getSupportedBandwidthEstimationExperiments((e) => {
