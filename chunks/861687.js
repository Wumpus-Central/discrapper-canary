n.d(t, { Z: () => eA }), n(35282), n(539854), n(388685), n(49124), n(415506), n(457542);
var r = n(654861),
    i = n.n(r),
    a = n(954955),
    o = n.n(a),
...
function eS() {
    let e = [],
        t = (0, _.zO)();
    for (let n of eI) e.push(ed(ec({}, n), { t: t - n.t }));
...
class eA extends d.Z {
    ...
    get quality() {
        ...
        return this.state !== eo.hes.RTC_CONNECTED || void 0 === e
            ? eo.IE4.UNKNOWN
    ...
    set endpoint(e) {
        if (
            ...
            null != n && (80 === i || 443 === i) && (e = "".concat(ef, "//").concat(n)),
                (this._endpoint = e + "/"),
                (this.hostname = n);
        }
    }
    ...
    destroy() {
        ...
        if (
            ...
            F.Z.removeOnlineCallback(this._handleNetworkOnline),
            F.Z.removeOfflineCallback(this._handleNetworkOffline),
            (0, V.isDesktop)() && (null == (o = (s = this).powerMonitorListener) || o.call(s)),
    ...
    shouldSendSpeaking(e, t) {
        ...
        return (
            ...
            (void 0 !== this._lastSentSSRC || e !== es.Dg.NONE) &&
            (this._lastSentSSRC === t || e !== es.Dg.NONE) &&
    ...
    _chooseExperiments(e) {
        ...
        if (
            ...
            L.Z.supports(es.AN.FIXED_KEYFRAME_INTERVAL) && t.push("fixed_keyframe_interval"),
            0 !== this._supportedBandwidthEstimationExperiments.length)
        ) {
            let e = C.Z.workerExperimentString();
            null != e && t.push(e);
        }
        this.context === es.Yn.DEFAULT && (0, I.f)("RtcConnection").enabled && t.push("audio_transport_cc"),
    ...
    _handleDisconnect(e, t, n, r) {
        ...
        if (this.state !== eo.hes.DISCONNECTED) {
            ...
            if (null != e && this.context === es.Yn.DEFAULT) {
                if ((e.stop(), this._sentVideo)) {
                    ...
                    null != t &&
                        ...
                        G.default.track(
                            eo.rMx.VIDEO_CALL_ENDED,
                            ed(ec({}, t), { media_session_id: this.getMediaSessionId() }),
                        );
                }
            ...
            Promise.all([
                ...
                P.Z.getKrispModel(),
                L.Z.getKrispEnableStats() ? L.Z.getMediaEngine().getNoiseCancellationStats() : Promise.resolve(null),
                L.Z.getMediaEngine().getSystemMicrophoneMode(),
            ]).then((e) => {
    ...
    _handleReady(e, t, n, r, i, a, o) {
        ...
        let l = L.Z.getMediaEngine(),
            ...
            b = (0, _.zO)() - h;
        g.setUseElectronVideo(l.supports(es.AN.ELECTRON_VIDEO)),
            L.Z.supports(es.AN.IMAGE_QUALITY_MEASUREMENT) &&
                g.setVideoQualityMeasurement("imageQualityWebrtcPsnrDb:5000,imageQualityVmaf_v061:5000,hwdec");
        let y = ["unk"];
        this.context === es.Yn.STREAM && (y.push("nvRelaxRc=250"), y.push("nvNewPresets")),
            L.Z.getUseVaapiEncoder() && y.push("vaapi"),
            ...
            g.on(f.Sh.FirstFrame, (e, t, n) => {
                null != this._localMediaSinkWantsManager &&
                    ...
                    this.emit(z.z.Video, this.guildId, this.channelId, eO(e), n, this.streamServerId)),
            ...
            g.on(f.Sh.ConnectionStateChange, (t) => {
                ...
                if (
                    (n === eo.hes.RTC_CONNECTING && this.state === eo.hes.RTC_DISCONNECTED
                        ? this.reconnect()
                        : this.state === eo.hes.NO_ROUTE &&
                          (0 === this._backoff.fails && this._handleNoRoute(), this._backoff.fail(this.reconnect)),
                    this.state === eo.hes.RTC_CONNECTED)
                ) {
    ...
    getOrCreateVideoQuality() {
        if (null != this._connection && null == this._videoQuality) {
            (this._videoQuality = new en.S(this._connection)),
            ...
            if (e) {
                (this._videoHealthManager = new et.y(t, n, r, i)),
                    null != this._localMediaSinkWantsManager &&
    ...
    _handleClientDisconnect(e) {
        ...
        null != l && l.destroyUser(e),
            ...
            this.emit(z.z.ClientDisconnect, e),
            null == (n = this._goLiveQualityManager) || n.updateCallUserIds(this._userIds),
            null == (r = this._localMediaSinkWantsManager) || r.updateCallUserIds(this._userIds),
    ...
    _handleCodecs(e, t) {
        ...
        null != n && null != this.protocol
            ? n.setCodecs(null != e && "" !== e ? e : es.ad.OPUS, null != t && "" !== t ? t : es.ad.H264, this.context)
    ...
    _storeSecureFrameTransitionData(e, t) {
        ...
        null == n &&
            ...
            this._secureFramesTransitionStates.set(e, ec({}, n, t)),
        ...
        Object.entries(e).forEach((e) => {
            ...
            n.push(eO(t)),
                null == a || 0 === a.byteLength
                    ? (i++, this._secureFramesRosterMap.delete(eO(t)))
                    : (r++, this._secureFramesRosterMap.set(eO(t), a));
        }),
    ...
    constructor({
        ...
        super(),
            ...
            el(this, "_nextChannelId", void 0),
            el(this, "joinVoiceId", void 0),
            ...
            el(this, "_connectionSerial", void 0),
            ...
            el(this, "_nextFailureId", 0),
            el(this, "_mlsFailures", []),
            ...
            el(this, "_mlsInitReceivedTime", void 0),
        ...
        if (i === es.Yn.DEFAULT) {
            var p;
            let t = (null == (p = x.Z.getChannel(this.channelId)) ? void 0 : p.type) === eo.d4z.GUILD_STAGE_VOICE;
        ...
        (this._remoteVideoSinkWants = Q.Yy),
            ...
            M.ZP.shouldRecordNextConnection()
            ...
            (0, V.isDesktop)() &&
                (this.powerMonitorListener = W.Z.remotePowerMonitor.on("resume", this._handlePowerResume)),
