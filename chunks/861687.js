n.d(t, { Z: () => eS }), n(35282), n(539854), n(388685), n(49124), n(415506), n(457542);
var r = n(654861),
    i = n.n(r),
    a = n(954955),
    o = n.n(a),
...
function eT() {
    let e = [],
        t = (0, _.zO)();
    for (let n of ev) e.push(eu(el({}, n), { t: t - n.t }));
...
class eS extends d.Z {
    ...
    get quality() {
        ...
        return this.state !== ea.hes.RTC_CONNECTED || void 0 === e
            ? ea.IE4.UNKNOWN
    ...
    set endpoint(e) {
        if (
            ...
            let { hostname: n, port: r } = null != (t = H.Z.toURLSafe(e)) ? t : {},
                i = null != r ? parseInt(r) : NaN;
            null != n && (80 === i || 443 === i) && (e = "".concat(ed, "//").concat(n)),
                (this._endpoint = e + "/"),
                (this.hostname = n);
        }
    }
    connect(e, t) {
        ...
        if (
            ...
            return void this.setState(ea.hes.AWAITING_ENDPOINT);
        let i = this._socket;
    ...
    destroy() {
        ...
        if (
            ...
            (0, F.isDesktop)() && (null == (o = (s = this).powerMonitorListener) || o.call(s)),
            this.recordEvent({ c: 1 }),
            ei.w.off(ei.e.IncomingVideoEnabledChanged, this.incomingVideoEnabledChanged),
            ei.w.off(ei.e.WindowVisibilityChanged, this.windowVisibilityChanged),
            this._backoff.cancel(),
            this._cleanupSocket(),
    ...
    shouldSendSpeaking(e, t) {
        ...
        return (
            ...
            (void 0 !== this._lastSentSSRC || e !== eo.Dg.NONE) &&
            (this._lastSentSSRC === t || e !== eo.Dg.NONE) &&
    ...
    _chooseExperiments(e) {
        ...
        if (
            ...
            x.Z.supports(eo.AN.FIXED_KEYFRAME_INTERVAL) && t.push("fixed_keyframe_interval"),
            0 !== this._supportedBandwidthEstimationExperiments.length)
        ) {
            let e = A.Z.workerExperimentString();
            null != e && t.push(e);
        }
        this.context === eo.Yn.DEFAULT && (0, I.f)("RtcConnection").enabled && t.push("audio_transport_cc"),
            t.push("keyframe_on_join"),
            N.Z.getCurrentConfig({ location: "_chooseExperiments" }, { autoTrackExposure: !0 }).enabled &&
    ...
    _handleDisconnect(e, t, n, r) {
        ...
        this.logger.info(
            ...
            t ||
                ...
                (U.default.track(
                    ea.rMx.VOICE_CONNECTION_SOCKET_FAILURE,
            ...
            L.Z.getRemoteDisconnectVoiceChannelId() === this.channelId &&
        ...
        if (this.state !== ea.hes.DISCONNECTED) {
            ...
            if (null != e && this.context === eo.Yn.DEFAULT) {
                if ((e.stop(), this._sentVideo)) {
                    ...
                    null != t &&
                        ...
                        U.default.track(
                            ea.rMx.VIDEO_CALL_ENDED,
                            eu(el({}, t), { media_session_id: this.getMediaSessionId() }),
                        );
                }
            ...
            let n = M.Z.shouldIncludePreferredRegion() ? M.Z.getPreferredRegion() : null,
                ...
                o =
                    null == (u = C.Z.getConnectionStats(this.getMediaEngineConnectionId())) ||
            ...
            Promise.all([
                ...
                x.Z.getMediaEngine().getSystemMicrophoneMode(),
            ]).then((e) => {
                let [{ batteryUsageRounded: t }, n, r, i] = e;
                U.default.track(
                    ea.rMx.VOICE_DISCONNECT,
                    eu(el({}, s), {
                        battery_usage: t,
                        krisp_nc_model: n,
        ...
        this.setState(ea.hes.DISCONNECTED, { willReconnect: N });
    }
    _handleResuming(e) {
        var t, n;
    ...
    _handleReady(e, t, n, r, i, a, o) {
        ...
        let l = x.Z.getMediaEngine(),
            ...
            g = (0, _.zO)() - d;
        h.setUseElectronVideo(l.supports(eo.AN.ELECTRON_VIDEO)),
            x.Z.supports(eo.AN.IMAGE_QUALITY_MEASUREMENT) &&
                h.setVideoQualityMeasurement("imageQualityWebrtcPsnrDb:5000,imageQualityVmaf_v061:5000,hwdec");
        let b = ["unk"];
        this.context === eo.Yn.STREAM && (b.push("nvRelaxRc=250"), b.push("nvNewPresets")),
            x.Z.getUseVaapiEncoder() && b.push("vaapi"),
            ...
            h.on(f.Sh.FirstFrame, (e, t, n) => {
                null != this._localMediaSinkWantsManager &&
                    ...
                    this.emit(K.z.Video, this.guildId, this.channelId, ey(e), n, this.streamServerId)),
            ...
            h.on(f.Sh.Connected, (r, i) => {
                ...
                switch (
                    ((this._voiceQuality = new er.Z(h)),
                    this._voiceQuality.start(),
                    this._voiceQuality.on(er.B.InputDeviceSampleRateChanged, (e) => {
                        p.Z.dispatch({
                    ...
                    (this._systemResponsiveness = new $.Z(h)),
                    this._systemResponsiveness.start(),
                    (this._systemResources = new J.Z()),
                    this._systemResources.setLastBattery(),
                    (this._noiseCancellationError = 0),
                    (this._voiceDuration = new en.Z(this.userId, h)),
            ...
            h.on(f.Sh.Error, (t) => {
                ...
                this.logger.error("Error occurred while connecting to RTC server: ".concat(t)),
                    U.default.track(
                        ea.rMx.VOICE_CONNECTION_FAILURE,
                        eu(el({}, this._getAnalyticsProperties()), {
                            hostname: this.hostname,
                            port: this.port,
                            protocol: this.protocol,
            ...
            h.on(f.Sh.ConnectionStateChange, (t) => {
                ...
                if (
                    (n === ea.hes.RTC_CONNECTING && this.state === ea.hes.RTC_DISCONNECTED
                        ? this.reconnect()
                        : this.state === ea.hes.NO_ROUTE &&
                          (0 === this._backoff.fails && this._handleNoRoute(), this._backoff.fail(this.reconnect)),
                    this.state === ea.hes.RTC_CONNECTED)
                ) {
                    ...
                    if (this._connecting) {
                        ...
                        U.default.track(
                            ea.rMx.VOICE_CONNECTION_SUCCESS,
                            el(
                                eu(el({}, n), {
                                    hostname: this.hostname,
                                    port: this.port,
                        ...
                        U.default.track(ea.rMx.VOICE_CONNECTION_TTC_COLLECTED, {
                            ...
                            time_3_media_engine_create_native_connection:
                                null == (a = h.transportInfo) ? void 0 : a.createConnectionTime,
                            time_4_media_engine_connect_to_socket:
                                null == (o = h.transportInfo) ? void 0 : o.connectTime,
                            ...
                            rtc_connecting_native_codecs: i(
                                ...
                                null == (m = this._connection) ? void 0 : m.onConnectCallbackAt,
                            ),
    ...
    getOrCreateVideoQuality() {
        if (null != this._connection && null == this._videoQuality) {
            (this._videoQuality = new et.S(this._connection)),
            ...
            if (e) {
                (this._videoHealthManager = new ee.y(t, n, r, i)),
                    null != this._localMediaSinkWantsManager &&
    ...
    _handleVideoStreamId(e) {
        ...
        if (
            (this.emit(K.z.Video, this.guildId, this.channelId, a, o, this.streamServerId),
            null != o &&
    ...
    _handleRemoteStreamsReady(e) {
        ...
        U.default.track(
            ea.rMx.VOICE_CONNECTION_REMOTE_STREAMS_CREATED,
            eu(el({}, this._getAnalyticsProperties()), {
                number_of_users: e,
                duration_ms: t,
            }),
    ...
    _handleCodecs(e, t) {
        ...
        null != n && null != this.protocol
            ? n.setCodecs(null != e && "" !== e ? e : eo.ad.OPUS, null != t && "" !== t ? t : eo.ad.H264, this.context)
    ...
    _storeSecureFrameTransitionData(e, t) {
        ...
        null == n &&
            ...
            this._secureFramesTransitionStates.set(e, el({}, n, t)),
        ...
        this.recordEvent({
            ...
            e > 0
                ? (this.logger.info("DAVE protocol init with protocol version: ".concat(e)),
                  ...
                  null == (t = this._connection) || t.prepareSecureFramesEpoch(eE, e, this.trueChannelId),
    ...
    constructor({
        ...
        super(),
            es(this, "context", void 0),
            es(this, "userId", void 0),
            es(this, "sessionId", void 0),
            es(this, "guildId", void 0),
            es(this, "parentMediaSessionId", void 0),
            es(this, "hostname", void 0),
            es(this, "state", void 0),
            es(this, "_videoQuality", void 0),
            es(this, "_soundshareStats", void 0),
            es(this, "logger", void 0),
            es(this, "streamServerId", void 0),
            es(this, "streamChannelId", void 0),
            es(this, "_channelId", void 0),
            es(this, "_nextChannelId", void 0),
            es(this, "joinVoiceId", void 0),
            es(this, "channelIds", void 0),
            es(this, "_endpoint", void 0),
            es(this, "port", void 0),
            es(this, "token", void 0),
            es(this, "protocol", void 0),
            es(this, "voiceVersion", void 0),
            es(this, "rtcWorkerVersion", void 0),
            es(this, "_socket", void 0),
            es(this, "_backoff", void 0),
            es(this, "_destroyed", void 0),
            es(this, "_pings", void 0),
            es(this, "_pingBadCount", void 0),
            es(this, "_pingTimeouts", void 0),
            es(this, "_mediaSessionId", void 0),
            es(this, "_voiceQuality", void 0),
            es(this, "_voiceQualityPeriodicStatsInterval", void 0),
            es(this, "_voiceQualityPeriodicStatsSequenceId", void 0),
            es(this, "_systemResponsiveness", void 0),
            es(this, "_systemResources", void 0),
            es(this, "_noiseCancellationError", void 0),
            es(this, "_voiceDuration", void 0),
            es(this, "_videoHealthManager", void 0),
            es(this, "_sentVideo", void 0),
            es(this, "_outboundLossRate", void 0),
            es(this, "_recordingEnabled", void 0),
            es(this, "_selectedExperiments", void 0),
            es(this, "_localMediaSinkWantsManager", void 0),
            es(this, "_goLiveQualityManager", void 0),
            es(this, "_remoteVideoSinkWants", void 0),
            es(this, "_connection", void 0),
            es(this, "_mediaEngineConnectionId", void 0),
            es(this, "_createdTime", void 0),
            es(this, "_connectStartTime", void 0),
            es(this, "_connectCompletedTime", void 0),
            es(this, "_rtcConnectionId", void 0),
            es(this, "_connectCount", void 0),
            es(this, "_connectionSerial", void 0),
            es(this, "_connected", void 0),
            es(this, "_connecting", void 0),
            es(this, "_encountered_socket_failure", void 0),
            es(this, "_inputDetected", void 0),
            es(this, "_encryptionMode", void 0),
            es(this, "stateHistory", void 0),
            es(this, "_supportedBandwidthEstimationExperiments", void 0),
            es(this, "_bandwidthEstimationExperiment", void 0),
            es(this, "_secureFramesState", void 0),
            es(this, "_userIds", void 0),
            es(this, "_secureFramesRosterMap", new Map()),
            es(this, "_nextFailureId", 0),
            es(this, "_mlsFailures", []),
            ...
            es(this, "_secureFramesLastBecameAloneTime", void 0),
            es(this, "_mlsSessionResetStartTime", void 0),
            es(this, "_mlsInitReceivedTime", void 0),
            es(this, "_numNoiseCancellationChanges", 0),
            es(this, "_fetchAsyncResourcesPromise", void 0),
            ...
            es(this, "_alertMLSFailureDebouced", o()(this._alertMLSFailure, 100)),
            ...
            es(this, "_handleVoiceQualityPeriodicsStats", () => {
                if (null != this._voiceQuality) {
                    ...
                    if (this.shouldReportPeriodicStats(e))
                        for (let t of e)
                            U.default.track(
                                ea.rMx.VOICE_QUALITY_PERIODIC_STATS,
                                eu(el({}, this._getAnalyticsProperties()), {
                                    media_session_id: this.getMediaSessionId(),
            ...
            es(this, "_trackVoiceConnectionConnecting", () => {
                let e = D.Z.getChannel(this.channelId),
                    t = null == e ? void 0 : e.type;
                U.default.track(
                    ea.rMx.VOICE_CONNECTION_CONNECTING,
                    eu(el({}, this.getAudioDeviceStates(), this.getVideoDeviceStates()), {
                        guild_id: this.guildId,
                        channel_id: this.channelId,
                        rtc_connection_id: this.getRTCConnectionId(),
                        hostname: this.hostname,
            ...
            (this.state = ea.hes.AWAITING_ENDPOINT),
        ...
        if (i === eo.Yn.DEFAULT) {
            var p;
            let t = (null == (p = D.Z.getChannel(this.channelId)) ? void 0 : p.type) === ea.d4z.GUILD_STAGE_VOICE;
            (this._localMediaSinkWantsManager = new X.ZP(e, t, f)),
                this._localMediaSinkWantsManager.on(X.ai.Update, (e) => {
        ...
        (this._remoteVideoSinkWants = X.Yy),
            ei.w.on(ei.e.IncomingVideoEnabledChanged, this.incomingVideoEnabledChanged),
            ei.w.on(ei.e.WindowVisibilityChanged, this.windowVisibilityChanged),
            ...
            (0, F.isDesktop)() &&
                (this.powerMonitorListener = Y.Z.remotePowerMonitor.on("resume", this._handlePowerResume)),
