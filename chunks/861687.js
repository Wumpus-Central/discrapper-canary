n.d(t, { Z: () => eb }), n(35282), n(415506), n(539854), n(388685), n(784620), n(973216), n(49124);
var r = n(654861),
    i = n.n(r),
    a = n(954955),
    o = n.n(a),
...
class eb extends d.Z {
    ...
    _handleDisconnect(e, t, n, r) {
        ...
        this.logger.info('Disconnected from RTC server, clean: '.concat(t, ', code: ').concat(n, ', reason: ').concat(r, ', state: ').concat(this.state)),
            t ||
                ...
                (j.default.track(
                    ...
                    el(eo({}, this._getAnalyticsProperties()), {
                        hostname: this.hostname,
        ...
        if (this.state !== er.hes.DISCONNECTED) {
            ...
            (async () => {
                ...
                j.default.track(er.rMx.VOICE_DISCONNECT, el(eo({}, s), { battery_usage: t }));
            });
        }
        ...
        this.setState(er.hes.DISCONNECTED, { willReconnect: A });
    }
    _handleResuming(e) {
        var t, n;
    ...
    getOrCreateVideoQuality() {
        if (null != this._connection && null == this._videoQuality) {
            ...
            let { featureEnabled: e, windowLength: t, allowedPoorFpsRatio: n, fpsThreshold: r, backoffTimeSec: i } = J.y.defaultConfig;
            if (e) {
    ...
    _handleVideoStreamId(e) {
        ...
        if (
            (this.emit(Y.z.Video, this.guildId, this.channelId, a, o, this.rtcServerId),
        ...
        super(),
            ...
            ea(this, '_trackVoiceConnectionConnecting', () => {
                ...
                j.default.track(
                    ...
                    el(eo({}, this.getAudioDeviceStates(), this.getVideoDeviceStates()), {
                        guild_id: this.guildId,
                        channel_id: this.channelId,
                        rtc_connection_id: this.getRTCConnectionId(),
                        hostname: this.hostname,
