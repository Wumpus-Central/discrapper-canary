...
class x extends p.Z {
    ...
    initialize(e) {
        ...
        let n = (0, b.zS)(),
            r = (r, i) => {
                ...
                if (null != r && "" !== r) {
                    this.setConnectionState(v.$j.NO_ROUTE), this.emit(m.Sh.Error, r);
                    return;
                }
                    ...
                    n.getCodecCapabilities((r) => {
                        ...
                        this.logger.info("Experimental codecs: ".concat(JSON.stringify(i))),
                            ...
                            t.getEncryptionModes((r) => {
                                var i, l, c, u, d, f, p, _, h, g, E, b, y, O, S, I;
                                (this.onEncryptionModesCallbackAt = performance.now()),
                                    ...
                                    null == (h = t.setOnMLSFailureCallback) || h.call(t, this.handleMLSFailure),
                                ...
                                for (let e of (T.forEach((e) => {
                                    ...
                                    return this.logger.info(
                                        "Creating user: "
                                            ...
                                            .concat(
                                                null != (n = null == (t = e.videoSsrcs) ? void 0 : t.join(",")) ? n : 0,
                                            ),
                                    );
                                }),
                                this.mergeUsers(T),
        ...
        null == (i = (t = this.conn = o(this.userId, e, r)).setSecureFramesStateUpdateCallback) ||
            i.call(t, (e) => {
                this.logger.info("DAVE protocol state update: ".concat(JSON.stringify(e))),
                    this.emit(m.Sh.SecureFramesUpdate, e);
            }),
            null == (a = t.setDesktopSourceStatusCallback) ||
                a.call(t, (e) => {
                    if ("videohook_start" === e.type) this.emit(m.Sh.VideoHookStart);
                        ...
                        "video_state" === e.type
                            ? this.emit(m.Sh.VideoState, e.state)
                            : e.type.startsWith("soundshare_") && this.emit(m.Sh.SoundshareTrace, e);
                }),
            ...
            : (0, d.timeout)(
                  new Promise((e) => {
                      null != this.conn.getFilteredStats
                          ? this.conn.getFilteredStats(O.QP.ALL, (t) =>
                                e(
                                    (0, y.Z)(
    ...
    createUser(e, t, n) {
        ...
        if (
            ...
            null != o && o !== v.Dg.NONE && this.setSpeakingFlags(e, o);
        }
    }
    destroyUser(e) {
    ...
    getLocalVolume(e) {
        ...
        return null == t && (t = this.context === v.Yn.DEFAULT ? v.Qx : v.Yh), R(t);
    }
    setLocalVolume(e, t) {
    ...
    setSpeakingFlags(e, t) {
        null != this.conn.setRemoteUserSpeakingStatus
            ...
            : null != this.conn.setRemoteUserSpeaking &&
              this.conn.setRemoteUserSpeaking(e, (t & v.Dg.VOICE) === v.Dg.VOICE),
        ...
        return new Promise((t, n) => {
            for (let t of this.videoStreamParameters) {
                ...
                l()(this.videoStreamParameters[r], e[r]) ||
                    ((this.videoStreamParameters[r] = I({}, e[r])), i.push(I({}, e[r]))),
    ...
    getCodecOptions(e, t, n) {
        ...
        for (o of this.codecs) {
            ...
            this.experimentFlags.has(O.V8.RESET_DECODER_ON_ERRORS) && (n.params["reset-on-errors"] = "1"),
                ...
                this.experimentFlags.has(O.V8.USE_H264_MF_DECODER) && (n.params["h264-mf"] = "1"),
                c.push(n),
                o.name === t &&
    ...
    getConnectionTransportOptions() {
        ...
        return (
            (0, b.eJ)(v.eR.VIDEO_EFFECTS) && this.context === v.Yn.STREAM && (e.enableVideoEffects = !0),
            this.experimentFlags.has(O.V8.MUTE_BEFORE_PROCESSING) && (e.muteBeforeProcessing = !0),
            this.experimentFlags.has(O.V8.PTT_BEFORE_PROCESSING) && (e.pttBeforeProcessing = !0),
            this.experimentFlags.has(O.V8.SKIP_ENCODE) && (e.skipEncode = !0),
            e
        );
    }
    setStream(e) {
    ...
    constructor(e, t, n) {
        super(e, t),
            S(this, "mediaEngineConnectionId", "Native-".concat(w++)),
            ...
            S(this, "inputMode", v.pM.VOICE_ACTIVITY),
            S(this, "vadThreshold", -40),
            S(this, "vadAutoThreshold", !0),
            S(this, "vadKrispActivationThreshold", 0.5),
            S(this, "vadUseKrisp", !0),
            S(this, "vadLeading", 5),
            S(this, "vadTrailing", 25),
            S(this, "vadDuringPreProcess", !1),
            ...
            S(this, "automaticGainControl", { enabled: !0 }),
            S(this, "noiseCancellation", !1),
            S(this, "noiseCancellationDuringProcessing", !1),
            S(this, "noiseCancellationAfterProcessing", !1),
            S(this, "vadAfterWebrtc", !1),
            S(this, "voiceFilterId", null),
            ...
            S(this, "lastPreparedTransitionId", -1),
            S(this, "lastExecutedTransitionId", -1),
            S(this, "logger", void 0),
            S(this, "transportInfo", void 0),
            S(this, "beginInitializeAt", void 0),
            ...
            S(this, "handleSpeakingFlags", (e, t, n) => {
                ...
                this.emit(m.Sh.Speaking, e, t, r, n),
                    (t & v.Dg.SOUNDSHARE) != 0 &&
                        !1 === this.soundshareSentSpeakingEvent &&
                        (this.emit(m.Sh.SoundshareSpeaking), (this.soundshareSentSpeakingEvent = !0));
            }),
            ...
            S(this, "handleVideoEncoderFallback", (e) => {
                this.videoEncoderFallbackPending ||
                    ...
                    this.emit(m.Sh.VideoEncoderFallback, this.codecs),
            ...
            S(this, "handleVideoDecoderFallback", (e) => {
                this.videoDecoderFallbackSent.has(e) ||
                    ...
                    (this.codecs = this.codecs
                        ...
                        .filter((e) => "video" !== e.type || !1 !== e.encode || !1 !== e.decode)),
                    this.emit(m.Sh.VideoDecoderFallback, this.codecs));
            }),
                ...
                if (e === O.ym.REMB && this.context === v.Yn.STREAM) {
                    ...
                    e.ssrcs.forEach((t) => {
                        ...
                        if (void 0 !== s && (null != (n = s.quality) ? n : 0) < 100 && "video" === s.type) {
                            ...
                            (Math.abs(n - l) / ((n + l) / 2) > P || void 0 === s.targetBitrate) &&
                                (this.logger.info(
            ...
            S(this, "handleSoundshare", (e) => {
                e &&
                    ...
                    this.conn.setTransportOptions({ encodingVoiceBitRate: Math.max(v.ed, this.voiceBitrate) }),
                    ...
                    if (null != this.stats) {
                        ...
                        if (null != o && null != s && null != o.framesCaptured && null != s.framesCaptured) {
                            ...
                            if (
                                ...
                                e / t > 8
                                    ? this.emit(m.Sh.NoiseCancellationError, v.H3.CPU_OVERUSE)
                                    : 0 === e && this.emit(m.Sh.NoiseCancellationError, v.H3.FAILED);
                            }
                            this.inputMode === v.pM.VOICE_ACTIVITY &&
                                ...
                                this.emit(m.Sh.VoiceActivityDetectorError, v.H3.VAD_CPU_OVERUSE);
                        }
                    }
                    this.stats = e;
                }
