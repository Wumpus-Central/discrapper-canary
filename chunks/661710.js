...
function i(e, t, n, r) {
    ...
    c.item.baseOffset = f;
    let _ = a(e, i.indexSize, t);
    c.item.extent.extentIndex = void 0 !== _ ? _ : 0;
...
function l(e, t, n, r, i, o, a, s) {
    ...
    for (let n = 0; n < s; n++) {
        ...
        for (let s = 0; s < n.extentCount; s++) {
            let s = {};
            (s.extentIndex = u(e, t, f, a)),
                (s.extentOffset = d(e, (f += r.item.extent.extentIndex), i)),
                (s.extentLength = d(e, (f += r.item.extent.extentOffset), o)),
