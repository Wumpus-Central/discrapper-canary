...
let U = {
    ...
    j = (0, C.L_)((e) => e.filter((e) => null != e.libraryApplication && e.libraryApplication.isHidden()));
function H(e, t) {
        ...
        r = Object.values(m.A.getAllLibraryApplications())
            .map((i) =>
                (function (e, t, n, i, r) {
                    ...
                    let a = H(s, n);
                    return (t.add(e.id), (0, v.XZ)(e) || T.A.isInstalled(e.id, e.branchId))
                        ? {
                              key: `${e.id}-${e.branchId}`,
                              application: s,
                              ...
                              shouldShowInLibrary: (0, v.Tr)(s, e, g.A),
