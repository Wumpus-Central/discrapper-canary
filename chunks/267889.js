...
let e4 = (0, ec.xI)(p.A.EMOJI_PICKER_CONSTANTS_GUILD_CATEGORY_ICON_SIZE),
    e5 = (0, ec.xI)(p.A.EMOJI_PICKER_CONSTANTS_GUILD_CATEGORY_ICON_MARGIN_VERICAL),
    e8 = (0, ec.xI)(p.A.EMOJI_PICKER_CONSTANTS_UNICODE_CATEGORY_ICON_SIZE),
        ...
        g = (0, s.jsxs)(F.D, {
            ...
            children: [
                null != f
                    ...
                    : null,
                null == f && null != m
                    ? (0, s.jsx)(eq, { categoryId: m, className: e7.Yl, height: e8, width: e8, size: "custom" })
                    : null,
            ],
        }),
        x = i[n + 1],
    ...
    let O = a.useCallback(
        ...
        w = a.useCallback(
            (e, t) => {
                ...
                if (n.type === eZ.s.GUILD) {
                    let n = x[e + 1];
                    return null != n && n.type !== eZ.s.GUILD ? (t ? tn + -2 * tl + e5 + l : e5) : t ? l : e5;
                }
                return t ? e5 + l : 2 * e5;
            },
            [x, b],
        ...
        children: (e) =>
            ...
            (0, s.jsx)(
                F.D,
                {
                    ...
                    tabIndex: b ? 0 : -1,
                    onClick: () => L(e),
                    children: (0, s.jsx)(eL.n, { size: "custom", color: "currentColor", height: e8, width: e8 }),
                },
                D,
            ),
    });
...
let nb = (0, ec.xI)(p.A.EMOJI_PICKER_CONSTANTS_EMOJI_LIST_PADDING_TOP),
    ...
    nP = a.memo(function (e) {
        let t,
            ...
            V = (0, eo.ki)(M),
            G = (0, t5.St)("emoji_picker_floating_upsell"),
            { location: H } = (0, C.p)(),
