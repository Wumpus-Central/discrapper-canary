...
function S(e) {
    let { guild: t } = e,
        n = (0, o.e7)([g.Z], () => null != t && g.Z.can(O.Plq.MANAGE_GUILD, t), [t]),
        s = i.useCallback(
            async (e) => {
                let { value: n } = e;
                try {
        ...
        a = i.useMemo(() => {
            let e = (0, x.IF)(null == t ? void 0 : t.hasFeature(O.oNc.COMMUNITY)).map((e) => E(I({}, e), { tooltipPosition: 'left' }));
            return (0, x.LJ)(e);
        }, [t]),
...
function T(e) {
    let { guild: t, className: n, withDivider: s = !0 } = e,
        l = (0, o.e7)([g.Z], () => null != t && g.Z.can(O.Plq.MANAGE_GUILD, t), [t]),
        d = i.useCallback(
            async (e) => {
                let { value: n } = e;
                try {
        ...
        u = i.useMemo(() => {
            let e = (0, x.MF)(null == t ? void 0 : t.hasFeature(O.oNc.COMMUNITY)).map((e) => E(I({}, e), { tooltipPosition: 'left' }));
            return (0, x.LJ)(e);
        }, [t]),
                    ...
                    (0, r.jsxs)('div', {
                        ...
                        children: [
                            ...
                            (0, r.jsx)(c.Text, {
                                color: 'header-secondary',
                                variant: 'text-sm/normal',
                                children: y.NW.format(y.t.zOmxND, { helpdeskArticle: b.Z.getArticleURL(O.BhN.SAFE_DIRECT_MESSAGING) })
                            })
                        ]
                    }),
                    (0, r.jsx)(_.Z, {
...
function w(e) {
    let { guild: t } = e,
        ...
        a = (0, p.n2)(t.id),
        [l, d] = i.useState(t.hasFeature(O.oNc.ENABLED_MODERATION_EXPERIENCE_FOR_NON_COMMUNITY)),
        u = i.useCallback(
            async (e) => {
                d(e), await P(t, e);
            },
                              ...
                              children: (0, r.jsxs)('div', {
                                  ...
                                  children: [
                                      (0, r.jsxs)(c.Text, {
                                          color: 'header-primary',
                                          variant: 'text-md/semibold',
                                          children: [y.NW.string(y.t.jDarm5), (0, r.jsx)(m.Z, { className: C.betaTag })]
                                      }),
                                      (0, r.jsx)(c.Text, {
                                          color: 'header-secondary',
                                          variant: 'text-sm/normal',
...
function R(e) {
    let { guild: t, mfaLevel: n } = e,
        s = (0, o.e7)([g.Z], () => null != t && g.Z.can(O.Plq.MANAGE_GUILD, t), [t]),
