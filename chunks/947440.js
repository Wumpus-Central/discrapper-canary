...
function M(t, e) {
    let { analyticsLocations: M } = (0, c.ZP)(),
        ...
        B = (0, l.Wu)(
            ...
            () => [
                ...$.map(
                    (t) => null != t.application_id && P.Z.getState(t.application_id, F.mFx.JOIN) === F.OcF.LOADING,
                ),
                ...z.map((t) => P.Z.getState(t.applicationId, F.mFx.JOIN) === F.OcF.LOADING),
            ],
            [$, z],
        ),
        K = (0, u.Z)([
        ...
        te = (0, l.Wu)(
            [s.Z, v.default],
            () => $.map((t) => (t.type === F.IIU.LISTENING && null != e ? (0, b.Z)(s.Z, v.default, e, t) : void 0)),
            [e, $],
        ),
        ti = (0, r.O)();
        ...
        tl = (l, o) => {
            ...
            if (null != d && null != r) {
                ...
                if (null != t && t.type === F.d4z.GUILD_VOICE)
                    return (0, a.ZDy)(
                        async () => {
                            let { default: e } = await Promise.all([i.e("7654"), i.e("49049"), i.e("29328")]).then(
                                i.bind(i, 560114),
                            );
                            return (i) => {
                                var l, a;
                                    ...
                                    (a = a =
                                        {
                                            ...
                                            applicationId: o,
                                            analyticsLocation:
                                                t.type === F.d4z.GUILD_VOICE ? F.ZY5.GUILD_CHANNEL : F.ZY5.DM_CHANNEL,
