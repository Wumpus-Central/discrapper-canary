...
e.exports = function (e, t, r) {
    ...
    function S() {
        var e,
            ...
            o = i();
        if (y(o)) return x(o);
        p = setTimeout(S, ((e = o - d), (r = o - v), (n = t - e), g ? l(n, c - r) : n));
    }
    function x(e) {
        return ((p = void 0), b && s) ? h(e) : ((s = u = void 0), f);
    }
    function E() {
        var e,
            r = i(),
        ...
        if (((s = arguments), (u = this), (d = r), n)) {
            ...
            if (g) return clearTimeout(p), (p = setTimeout(S, t)), h(d);
        }
    ...
    return (
        ...
        n(r) &&
            ((m = !!r.leading),
            (c = (g = "maxWait" in r) ? a(o(r.maxWait) || 0, t) : c),
