...
class y {
    ...
    queryUsers(e, t, n) {
        ...
        void 0 !== t && E.A.requestMembers(t, e, 100),
            r.setLimit(n),
    ...
    queryLink(e, t) {
        ...
        let { pathname: s, hostname: u = "", host: c } = n,
            _ = m.A.isDiscordHostname(u) || window.location.host === c;
        return null !== s && _ && m.A.isAppRoute(s) ? [{ type: I.rD.LINK, record: d.A.fromPath(s), score: 1 }] : [];
    }
