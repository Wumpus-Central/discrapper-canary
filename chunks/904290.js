...
function b(e) {
    let { user: t, analyticsLocations: n, confettiEnabled: s = !0, onClose: a } = e,
        { giftButtonRef: o, handleMouseEnter: l } = (function (e) {
            let { enabled: t } = e,
                n = (0, y.bG)([N.Ay], () => N.Ay.useReducedMotion),
                i = r.useRef(null),
                s = r.useRef(0),
                { createMultipleConfettiAt: a } = r.useContext(v.x),
                o = r.useMemo(
                    () => ({
...
var D = n(788868),
    L = n(831111);
let w = (0, m.createChannelRecord)({ id: "1", type: R.rbe.DM });
function M(e) {
    let { user: t, guildId: s, channelId: m, onClose: T, disableAutoFocus: S = !1, upsell: y = !1 } = e,
        { newestAnalyticsLocation: C, analyticsLocations: N } = (0, d.Ay)(),
        { trackUserProfileAction: v } = (0, A.NJ)(),
        [R, M] = r.useState(""),
        [P, x] = r.useState((0, h.x7)(R)),
        k = r.useRef(!1),
        U = r.useRef(null),
        G = r.useRef(null),
        { Component: F } = (0, o.V)(),
        V = r.useMemo(() => ({ ..._.oU.USER_PROFILE, disableAutoFocus: S }), [S]),
        B = r.useCallback(async () => {
            (0, E.xs)(t.id),
                ...
                (0, l.openModalLazy)(async () => {
                    ...
                    return (t) =>
                        (0, i.jsx)(e, { ...t, giftIntentType: D.np.FRIEND_ANNIVERSARY, analyticsLocationHistory: N });
                });
        }, [t.id, N]),
        j = r.useCallback(
            () =>
                (0, i.jsxs)("div", {
                    ...
                    children: [
                        ...
                        (0, i.jsx)(b, { user: t, analyticsLocations: N, onClose: T, confettiEnabled: y }),
                    ],
                }),
            [F, B, t, N, T, y],
        );
    return (0, i.jsx)(f.Ay, {
        className: a()(L.kL, { [L.UX]: y }),
        editorClassName: L.EN,
        type: V,
        placeholder: O.intl.formatToPlainString(O.t["0ZQw/X"], { name: g.Ay.getName(s, m, t) }),
        channel: w,
        textValue: R,
        richValue: P,
        onChange: (e, t, n) => {
        ...
        onSubmit: async (e) => {
            ...
            (U.current !== i || null == G.current) && ((U.current = i), (G.current = (0, p.m)()));
            try {
                return (
