...
function O(e) {
    let { user: t, guildId: l, channelId: g, onClose: y, disableAutoFocus: E = !1, upsell: I = !1 } = e,
        { newestAnalyticsLocation: j, analyticsLocations: S } = (0, u.Ay)(),
        ...
        H = n.useCallback(async () => {
            (0, b.xs)(t.id),
                ...
                (0, o.openModalLazy)(async () => {
                    ...
                    return (t) =>
                        (0, r.jsx)(e, { ...t, giftIntentType: k.np.FRIEND_ANNIVERSARY, analyticsLocationHistory: S });
                });
        }, [t.id, S]),
        W = n.useCallback(
            () =>
                (0, r.jsxs)("div", {
                    ...
                    children: [
                        ...
                        (0, r.jsx)(w, { user: t, analyticsLocations: S, onClose: y, confettiEnabled: I }),
                    ],
                }),
            [B, H, t, S, y, I],
        );
