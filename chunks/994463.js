...
function g(A) {
    ...
    return {
        transform: [{ translateX: e(A.x) }, { translateY: e(A.y) }],
    };
}
class c extends r.Component {
    componentDidMount() {
        this._isMounted = !0;
        let { x: A, y: e } = this.state;
        "Firefox" !== i().name &&
            (s.Z.animate(A, {
                loop: !0,
                toValueMin: -74,
    ...
    render() {
        return (0, n.jsxs)("div", {
            ...
            children: [
                (0, n.jsx)("div", { className: a.searchIndexBackground }),
                (0, n.jsxs)("svg", {
    ...
    constructor(...A) {
        super(...A),
            ...
            o(this, "_isMounted", !1),
            o(this, "shouldLoop", () => this._isMounted);
    }
}
let f = c;
