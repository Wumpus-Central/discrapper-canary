...
function v(e) {
    ...
    if (null == o || Array.isArray(o) || null == N(o)) return null;
        ...
        G = (e) => {
            e.preventDefault(),
                ...
                k &&
                    ...
                    H._.subscribeOnce(_.jej.VIDEO_EMBED_PLAYBACK_STARTED, U));
        };
    r.useEffect(
        () => () => {
            k && H._.unsubscribe(_.jej.VIDEO_EMBED_PLAYBACK_STARTED, U);
        },
        [k, U],
    );
