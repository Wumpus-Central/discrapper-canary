...
let e3 = s.memo(function (e) {
    let {
        ...
        { registerDragHandleRef: u } = (0, e6.r)(),
        g = s.useMemo(
            () =>
                a
                    ? (0, n.jsx)(e2.jV, {
...
function e9(e) {
    let { items: t, profileOwner: i, guildId: l, showEditingControls: r, isSortingNitroToFront: a } = e,
        ...
        { defaultWishlistId: d } = (0, x.cf)([eB.A], () => ({ defaultWishlistId: eB.A.getFirstWishlistId(i.id) })),
        ...
        f = s.useCallback(
            (e, t) => {
                ...
                eD.A.reorderWishlistItem(d, n.skuId, { previousSkuId: l, nextSkuId: r, newWishlistData: s });
            },
            [d, g],
        );
    ...
    return r ? (0, n.jsx)(e6.B, { emptyListFallbackRef: null, children: h }) : h;
}
function e4(e) {
...
function te(e) {
    ...
    return (0, n.jsx)(e$.h, {
        ...
        children: i && s ? (0, n.jsx)(e4, { ...e }) : (0, n.jsx)(e9, { ...e, isSortingNitroToFront: !1 }),
    });
}
var tt = i(815021),
    ti = i(299679),
                  ...
                  (0, n.jsxs)("div", {
                      ...
                      children: [
                          ...
                          d &&
                              (0, n.jsx)("div", {
                                  className: tm.b,
                                  children: (0, n.jsx)(tt.J, { size: "xs", onClick: c }),
                              }),
                      ],
                  }),
                  (0, n.jsx)(ti.dB, {
                ...
                () =>
                    t.filter(e_.Vq).map((e) => {
                        ...
                        return {
                            ...
                            iconLeft: null != t ? () => (0, n.jsx)("img", { className: tT.I, src: t, alt: "" }) : ep.U,
...
var tN = i(509434),
    tb = i(365199);
let tC = E.A.getArticleURL(f.MVz.CUSTOM_PROFILES_WISHLIST);
function tw(e) {
...
function tL(e) {
    let {
        ...
        u = r.id,
        m = (0, x.bG)([eB.A], () => eB.A.getWishlistSettings(l.id, u)),
    ...
    let j = s.useCallback(
        ...
        A = (0, ez.A)({ wishlistId: u, onAction: j, productLines: null != r ? (0, eW.y9)(r) : null }),
        E = s.useCallback(() => {
            if (null == u) return;
...
function tP(e) {
    ...
    let { wishlistId: a, currentUser: o } = (0, x.cf)([eB.A, eH.default], () => ({
    ...
    let I = (function (e) {
            let { wishlist: t, profileOwner: i, currentUser: n } = e,
                ...
                a = (0, x.bG)([eG.A], () => eG.A.getDetectableIdsToApplicationIds()),
                o = s.useMemo(() => {
                    let e = [];
                ...
                f = (0, eL.px)();
            return s.useMemo(
                () => (0, w.uniq)([...o, ...d, ...c, ...u, ...(l ? [...g, ...m, ...f] : [])].filter(e_.Vq)),
                [o, d, c, u, g, m, f, l],
            );
                ...
                : (0, n.jsxs)(n.Fragment, {
                      children: [
                          ...
                          (0, n.jsx)(tL, {
                              ...
                              handleOpenShop: A,
                              handleOpenGameShop: S,
                              handleAddNitroToWishlist: p && !(0, eW.C3)(u, tR.pe.TIER_2) ? T : void 0,
                          }),
                          (0, n.jsx)(te, { items: u.items, profileOwner: t, guildId: i, showEditingControls: c }),
                      ],
                  }),
            c &&
                (0, n.jsx)(tx, {
        ...
        : s === $.RP.MUTUAL_FRIENDS
          ...
          : s === $.RP.MUTUAL_GUILDS
            ...
            : s === $.RP.WIDGETS
              ...
              : s === $.RP.WISHLIST
                ? (0, n.jsx)(tP, { profileOwner: t, guildId: r })
                : null;
}
function tF(e) {
    let {
        ...
        children: [
            ...
            (0, n.jsx)(o.V.Panel, {
                ...
                children: (0, n.jsx)(d.F, {
                    component: (0, n.jsx)(c.A, { children: (0, n.jsx)(d.H, { children: A }) }),
                    children: (0, n.jsx)(tU, {
                        user: t,
                        currentUser: i,
                        displayProfile: l,
