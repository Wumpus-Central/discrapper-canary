...
class x extends s.G {
    constructor() {
        super("discord_protos.discord_users.v1.PreloadedUserSettings", [
            ...
            { no: 15, name: "favorites", kind: "message", T: () => ej },
            { no: 16, name: "audio_context_settings", kind: "message", T: () => ez },
            { no: 17, name: "communities", kind: "message", T: () => eX },
            ...
            { no: 24, name: "ads", kind: "message", T: () => th },
        ...
        for (; e.pos < s; ) {
            ...
            switch (t) {
                case 1:
                    ...
                    break;
                case 2:
                    a.inbox = k.internalBinaryRead(e, e.uint32(), n, a.inbox);
                    break;
                case 3:
                    a.guilds = G.internalBinaryRead(e, e.uint32(), n, a.guilds);
                    break;
                case 4:
                    a.userContent = Q.internalBinaryRead(e, e.uint32(), n, a.userContent);
                    break;
                case 5:
                    a.voiceAndVideo = ei.internalBinaryRead(e, e.uint32(), n, a.voiceAndVideo);
                    break;
                case 6:
                    a.textAndImages = eh.internalBinaryRead(e, e.uint32(), n, a.textAndImages);
                    break;
                case 7:
                    a.notifications = em.internalBinaryRead(e, e.uint32(), n, a.notifications);
                    break;
                case 8:
                    a.privacy = eE.internalBinaryRead(e, e.uint32(), n, a.privacy);
                    break;
                case 9:
                    a.debug = eI.internalBinaryRead(e, e.uint32(), n, a.debug);
                    break;
                case 10:
                ...
                case 11:
                    ...
                    break;
                case 12:
                    a.localization = eR.internalBinaryRead(e, e.uint32(), n, a.localization);
                    break;
                case 13:
                    a.appearance = ew.internalBinaryRead(e, e.uint32(), n, a.appearance);
                    break;
                case 14:
                    a.guildFolders = eG.internalBinaryRead(e, e.uint32(), n, a.guildFolders);
                    break;
                case 15:
                ...
                case 16:
                    ...
                    break;
                case 17:
                    a.communities = eX.internalBinaryRead(e, e.uint32(), n, a.communities);
                    break;
                case 18:
                    a.broadcast = e2.internalBinaryRead(e, e.uint32(), n, a.broadcast);
                    break;
                case 19:
                    a.clips = e6.internalBinaryRead(e, e.uint32(), n, a.clips);
                    break;
                case 20:
                    a.forLater = tn.internalBinaryRead(e, e.uint32(), n, a.forLater);
                    break;
                case 21:
                    a.safetySettings = te.internalBinaryRead(e, e.uint32(), n, a.safetySettings);
                    break;
                case 22:
                    a.icymiSettings = ti.internalBinaryRead(e, e.uint32(), n, a.icymiSettings);
                    break;
                case 23:
                    a.applications = ts.internalBinaryRead(e, e.uint32(), n, a.applications);
                    break;
                case 24:
                    a.ads = th.internalBinaryRead(e, e.uint32(), n, a.ads);
                    break;
                case 25:
    ...
    internalBinaryWrite(e, t, n) {
        e.versions && u.u.internalBinaryWrite(e.versions, t.tag(1, r.O0.LengthDelimited).fork(), n).join(),
            ...
            e.textAndImages && eh.internalBinaryWrite(e.textAndImages, t.tag(6, r.O0.LengthDelimited).fork(), n).join(),
            ...
            e.favorites && ej.internalBinaryWrite(e.favorites, t.tag(15, r.O0.LengthDelimited).fork(), n).join(),
            e.audioContextSettings &&
                ez.internalBinaryWrite(e.audioContextSettings, t.tag(16, r.O0.LengthDelimited).fork(), n).join(),
            e.communities && eX.internalBinaryWrite(e.communities, t.tag(17, r.O0.LengthDelimited).fork(), n).join(),
            ...
            e.ads && th.internalBinaryWrite(e.ads, t.tag(24, r.O0.LengthDelimited).fork(), n).join(),
...
class U extends s.G {
    constructor() {
        super("discord_protos.discord_users.v1.AllGuildSettings", [
            { no: 1, name: "guilds", kind: "map", K: 6, V: { kind: "message", T: () => j } },
        ]);
    }
    create(e) {
        let t = { guilds: {} };
    ...
    internalBinaryWrite(e, t, n) {
        for (let i of Object.keys(e.guilds))
            t.tag(1, r.O0.LengthDelimited).fork().tag(1, r.O0.Bit64).fixed64(i),
                ...
                j.internalBinaryWrite(e.guilds[i], t, n),
                t.join().join();
        let i = n.writeUnknownFields;
        return !1 !== i && (!0 == i ? r.f$.onWrite : i)(this.typeName, e, t), t;
    }
        ...
        for (; e.pos < s; ) {
            ...
            switch (t) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    a.joinSound = e0.internalBinaryRead(e, e.uint32(), n, a.joinSound);
                    break;
                case 7:
                    a.mobileRedesignChannelListSettings = eD.internalBinaryRead(
                        e,
                        e.uint32(),
                        n,
        ...
        for (; e.pos < s; ) {
            ...
            switch (t) {
                case 1:
                    ...
                    break;
                case 2:
                    a.iconEmoji = Y.internalBinaryRead(e, e.uint32(), n, a.iconEmoji);
                    break;
                case 3:
                    a.customNotificationSoundConfig = z.internalBinaryRead(
                        e,
    ...
    internalBinaryWrite(e, t, n) {
        ...
        Object.keys(e.recurringDismissibleContentStates)))
            t.tag(7, r.O0.LengthDelimited).fork().tag(1, r.O0.Varint).int32(parseInt(i)),
                t.tag(2, r.O0.LengthDelimited).fork(),
                X.internalBinaryWrite(e.recurringDismissibleContentStates[i], t, n),
                t.join().join();
        let i = n.writeUnknownFields;
        return !1 !== i && (!0 == i ? r.f$.onWrite : i)(this.typeName, e, t), t;
    }
            ...
            switch (t) {
                case 1:
                    a.videoBackgroundFilterDesktop = {
                        oneofKind: "blur",
                        blur: en.internalBinaryRead(e, e.uint32(), n, a.videoBackgroundFilterDesktop.blur),
                    };
                    break;
                case 2:
                ...
                case 3:
                    a.videoBackgroundFilterDesktop = {
                        ...
                        customAsset: ee.internalBinaryRead(
                            ...
                            e.uint32(),
                            n,
                            a.videoBackgroundFilterDesktop.customAsset,
                        ),
                    };
                    break;
                case 5:
        ...
        for (; e.pos < s; ) {
            ...
            switch (t) {
                ...
                case 28:
                    ...
                    break;
                case 29:
                    a.explicitContentSettings = es.internalBinaryRead(e, e.uint32(), n, a.explicitContentSettings);
                    break;
                case 30:
                    a.keywordFilterSettings = e_.internalBinaryRead(e, e.uint32(), n, a.keywordFilterSettings);
                    break;
                case 31:
                    ...
                    break;
                case 32:
                    a.goreContentSettings = el.internalBinaryRead(e, e.uint32(), n, a.goreContentSettings);
                    break;
                case 33:
                    a.defaultReactionEmoji = tE.internalBinaryRead(e, e.uint32(), n, a.defaultReactionEmoji);
                    break;
                case 34:
    ...
    constructor() {
        super("discord_protos.discord_users.v1.NotificationSettings", [
            ...
            { no: 6, name: "focus_mode_expires_at_ms", kind: "scalar", T: 6 },
            {
                ...
                kind: "enum",
                T: () => ["discord_protos.discord_users.v1.ReactionNotificationType", h],
            },
            {
                no: 8,
                name: "game_activity_notifications",
                kind: "enum",
                T: () => ["discord_protos.discord_users.v1.GameActivityNotificationType", p],
            },
            {
                no: 9,
                name: "custom_status_push_notifications",
                kind: "enum",
                T: () => ["discord_protos.discord_users.v1.CustomStatusPushNotificationType", g],
            },
    ...
    constructor() {
        super("discord_protos.discord_users.v1.PrivacySettings", [
            ...
            { no: 31, name: "show_local_time", kind: "message", T: () => o._t },
            {
                ...
                kind: "enum",
                T: () => ["discord_protos.discord_users.v1.ProfileVisibility", y, "PROFILE_VISIBILITY_"],
            },
        ]);
    }
    create(e) {
...
class eS extends s.G {
    constructor() {
        super("discord_protos.discord_users.v1.StatusSettings", [
            ...
            { no: 2, name: "custom_status", kind: "message", T: () => eb },
    ...
    internalBinaryWrite(e, t, n) {
        e.status && o.hU.internalBinaryWrite(e.status, t.tag(1, r.O0.LengthDelimited).fork(), n).join(),
            e.customStatus && eb.internalBinaryWrite(e.customStatus, t.tag(2, r.O0.LengthDelimited).fork(), n).join(),
            e.showCurrentGame &&
        ...
        for (; e.pos < s; ) {
            ...
            switch (t) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    a.clientThemeSettings = ek.internalBinaryRead(e, e.uint32(), n, a.clientThemeSettings);
                    break;
                case 4:
...
class eM extends s.G {
    constructor() {
        super("discord_protos.discord_users.v1.ClientThemeSettings", [
            ...
            { no: 4, name: "custom_user_theme_settings", kind: "message", T: () => eP },
        ]);
    }
    create(e) {
        let t = {};
    ...
    internalBinaryWrite(e, t, n) {
        e.backgroundGradientPresetId &&
            ...
            e.customUserThemeSettings &&
                eP.internalBinaryWrite(e.customUserThemeSettings, t.tag(4, r.O0.LengthDelimited).fork(), n).join();
        let i = n.writeUnknownFields;
        return !1 !== i && (!0 == i ? r.f$.onWrite : i)(this.typeName, e, t), t;
    }
}
...
class eU extends s.G {
    ...
    internalBinaryRead(e, t, n, i) {
        ...
        for (; e.pos < s; ) {
            ...
            switch (t) {
                case 1:
                    a.folders.push(eV.internalBinaryRead(e, e.uint32(), n));
                    break;
                case 2:
                    if (i === r.O0.LengthDelimited)
        ...
        for (; t.pos < i; ) {
            ...
            switch (e) {
                case 1:
                    ...
                    break;
                case 2:
                    s = eK.internalBinaryRead(t, t.uint32(), n);
                    break;
                default:
                    throw new globalThis.Error(
...
class e7 extends s.G {
    ...
    internalBinaryRead(e, t, n, i) {
        ...
        for (; e.pos < s; ) {
            let [t, i] = e.tag();
            if (1 === t) a.oneTimePurchaseLimit = e5.internalBinaryRead(e, e.uint32(), n, a.oneTimePurchaseLimit);
            else {
                let s = n.readUnknownField;
                if ("throw" === s)
                    throw new globalThis.Error(`Unknown field ${t} (wire type ${i}) for ${this.typeName}`);
        ...
        for (; e.pos < s; ) {
            ...
            switch (t) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    a.spendingLimitSettings = e8.internalBinaryRead(e, e.uint32(), n, a.spendingLimitSettings);
                    break;
                default:
                    let s = n.readUnknownField;
                    if ("throw" === s)
        ...
        for (; e.pos < s; ) {
            ...
            switch (t) {
                case 1:
                    ...
                    break;
                case 2:
                    a.appSharingSettings = t_.internalBinaryRead(e, e.uint32(), n, a.appSharingSettings);
                    break;
                default:
                    let s = n.readUnknownField;
                    if ("throw" === s)
        ...
        for (; t.pos < i; ) {
            ...
            switch (e) {
                case 1:
                    ...
                    break;
                case 2:
                    s = tm.internalBinaryRead(t, t.uint32(), n);
                    break;
                default:
                    throw new globalThis.Error(
