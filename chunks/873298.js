...
var r,
    ...
    j =
        ...
        f),
    Y =
        (((p = {})[(p.SLAYER_SDK_RECEIVE_IN_GAME_DMS_UNSET = 0)] = "SLAYER_SDK_RECEIVE_IN_GAME_DMS_UNSET"),
        (p[(p.SLAYER_SDK_RECEIVE_IN_GAME_DMS_ALL = 1)] = "SLAYER_SDK_RECEIVE_IN_GAME_DMS_ALL"),
        (p[(p.SLAYER_SDK_RECEIVE_IN_GAME_DMS_USERS_WITH_GAME = 2)] = "SLAYER_SDK_RECEIVE_IN_GAME_DMS_USERS_WITH_GAME"),
        (p[(p.SLAYER_SDK_RECEIVE_IN_GAME_DMS_NONE = 3)] = "SLAYER_SDK_RECEIVE_IN_GAME_DMS_NONE"),
        p),
    W =
        (((h = {})[(h.UNSET = 0)] = "UNSET"),
...
class en extends b.G {
    constructor() {
        super("discord_protos.discord_users.v1.PreloadedUserSettings", [
            ...
            { no: 6, name: "text_and_images", kind: "message", T: () => eU },
            ...
            { no: 14, name: "guild_folders", kind: "message", T: () => e5 },
            ...
            { no: 20, name: "for_later", kind: "message", T: () => tv },
            ...
            { no: 24, name: "ads", kind: "message", T: () => tU },
        ...
        for (; e.pos < s; ) {
            ...
            switch (t) {
                ...
                case 6:
                    ...
                    break;
                case 7:
                    i.notifications = eF.internalBinaryRead(e, e.uint32(), n, i.notifications);
                    break;
                case 8:
                    i.privacy = eB.internalBinaryRead(e, e.uint32(), n, i.privacy);
                    break;
                case 9:
                    i.debug = ej.internalBinaryRead(e, e.uint32(), n, i.debug);
                    break;
                case 10:
                    i.gameLibrary = eW.internalBinaryRead(e, e.uint32(), n, i.gameLibrary);
                    break;
                case 11:
                ...
                case 13:
                    ...
                    break;
                case 14:
                    i.guildFolders = e5.internalBinaryRead(e, e.uint32(), n, i.guildFolders);
                    break;
                case 15:
                ...
                case 19:
                    ...
                    break;
                case 20:
                    i.forLater = tv.internalBinaryRead(e, e.uint32(), n, i.forLater);
                    break;
                case 21:
                    i.safetySettings = ty.internalBinaryRead(e, e.uint32(), n, i.safetySettings);
                    break;
                case 22:
                    i.icymiSettings = tO.internalBinaryRead(e, e.uint32(), n, i.icymiSettings);
                    break;
                case 23:
                    i.applications = tb.internalBinaryRead(e, e.uint32(), n, i.applications);
                    break;
                case 24:
                    i.ads = tU.internalBinaryRead(e, e.uint32(), n, i.ads);
                    break;
                case 25:
                    i.inAppFeedbackSettings = tj.internalBinaryRead(e, e.uint32(), n, i.inAppFeedbackSettings);
                    break;
                default:
                    ...
                    let a = e.skip(r);
                    !1 !== s && (!0 === s ? C.f$.onRead : s)(this.typeName, i, t, r, a);
            }
        }
        return i;
    }
    internalBinaryWrite(e, t, n) {
        e.versions && w.u.internalBinaryWrite(e.versions, t.tag(1, C.O0.LengthDelimited).fork(), n).join(),
            e.inbox && es.internalBinaryWrite(e.inbox, t.tag(2, C.O0.LengthDelimited).fork(), n).join(),
            e.guilds && eo.internalBinaryWrite(e.guilds, t.tag(3, C.O0.LengthDelimited).fork(), n).join(),
            e.userContent && eT.internalBinaryWrite(e.userContent, t.tag(4, C.O0.LengthDelimited).fork(), n).join(),
            e.voiceAndVideo && eO.internalBinaryWrite(e.voiceAndVideo, t.tag(5, C.O0.LengthDelimited).fork(), n).join(),
            e.textAndImages && eU.internalBinaryWrite(e.textAndImages, t.tag(6, C.O0.LengthDelimited).fork(), n).join(),
            e.notifications && eF.internalBinaryWrite(e.notifications, t.tag(7, C.O0.LengthDelimited).fork(), n).join(),
            e.privacy && eB.internalBinaryWrite(e.privacy, t.tag(8, C.O0.LengthDelimited).fork(), n).join(),
            e.debug && ej.internalBinaryWrite(e.debug, t.tag(9, C.O0.LengthDelimited).fork(), n).join(),
            e.gameLibrary && eW.internalBinaryWrite(e.gameLibrary, t.tag(10, C.O0.LengthDelimited).fork(), n).join(),
            e.status && e$.internalBinaryWrite(e.status, t.tag(11, C.O0.LengthDelimited).fork(), n).join(),
            e.localization && eQ.internalBinaryWrite(e.localization, t.tag(12, C.O0.LengthDelimited).fork(), n).join(),
            e.appearance && e1.internalBinaryWrite(e.appearance, t.tag(13, C.O0.LengthDelimited).fork(), n).join(),
            e.guildFolders && e5.internalBinaryWrite(e.guildFolders, t.tag(14, C.O0.LengthDelimited).fork(), n).join(),
            e.favorites && tt.internalBinaryWrite(e.favorites, t.tag(15, C.O0.LengthDelimited).fork(), n).join(),
            e.audioContextSettings &&
                to.internalBinaryWrite(e.audioContextSettings, t.tag(16, C.O0.LengthDelimited).fork(), n).join(),
            e.communities && tu.internalBinaryWrite(e.communities, t.tag(17, C.O0.LengthDelimited).fork(), n).join(),
            e.broadcast && th.internalBinaryWrite(e.broadcast, t.tag(18, C.O0.LengthDelimited).fork(), n).join(),
            e.clips && tm.internalBinaryWrite(e.clips, t.tag(19, C.O0.LengthDelimited).fork(), n).join(),
            e.forLater && tv.internalBinaryWrite(e.forLater, t.tag(20, C.O0.LengthDelimited).fork(), n).join(),
            e.safetySettings &&
                ty.internalBinaryWrite(e.safetySettings, t.tag(21, C.O0.LengthDelimited).fork(), n).join(),
            e.icymiSettings &&
                tO.internalBinaryWrite(e.icymiSettings, t.tag(22, C.O0.LengthDelimited).fork(), n).join(),
            e.applications && tb.internalBinaryWrite(e.applications, t.tag(23, C.O0.LengthDelimited).fork(), n).join(),
            e.ads && tU.internalBinaryWrite(e.ads, t.tag(24, C.O0.LengthDelimited).fork(), n).join(),
            e.inAppFeedbackSettings &&
                tj.internalBinaryWrite(e.inAppFeedbackSettings, t.tag(25, C.O0.LengthDelimited).fork(), n).join();
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? C.f$.onWrite : r)(this.typeName, e, t), t;
    }
}
let er = new en();
class ei extends b.G {
    ...
    internalBinaryWrite(e, t, n) {
        0 !== e.currentTab && t.tag(1, C.O0.Varint).int32(e.currentTab),
            !1 !== e.viewedTutorial && t.tag(2, C.O0.Varint).bool(e.viewedTutorial);
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? C.f$.onWrite : r)(this.typeName, e, t), t;
    }
}
...
class ea extends b.G {
    ...
    internalBinaryWrite(e, t, n) {
        for (let r of Object.keys(e.guilds))
            t.tag(1, C.O0.LengthDelimited).fork().tag(1, C.O0.Bit64).fixed64(r),
                t.tag(2, C.O0.LengthDelimited).fork(),
                ed.internalBinaryWrite(e.guilds[r], t, n),
                t.join().join();
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? C.f$.onWrite : r)(this.typeName, e, t), t;
    }
...
class el extends b.G {
    ...
    internalBinaryWrite(e, t, n) {
        !1 !== e.dismissed && t.tag(1, C.O0.Varint).bool(e.dismissed),
            0 !== e.lastDismissedVersion && t.tag(2, C.O0.Varint).uint32(e.lastDismissedVersion),
            "0" !== e.lastDismissedAtMs && t.tag(3, C.O0.Varint).uint64(e.lastDismissedAtMs),
            "0" !== e.lastDismissedObjectId && t.tag(4, C.O0.Varint).uint64(e.lastDismissedObjectId),
            0 !== e.numTimesDismissed && t.tag(5, C.O0.Varint).uint32(e.numTimesDismissed);
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? C.f$.onWrite : r)(this.typeName, e, t), t;
    }
}
        ...
        for (; e.pos < s; ) {
            ...
            switch (t) {
                ...
                case 6:
                    ...
                    break;
                case 7:
                    i.mobileRedesignChannelListSettings = eJ.internalBinaryRead(
                        e,
                        e.uint32(),
                        n,
    ...
    internalBinaryWrite(e, t, n) {
        for (let r of Object.keys(e.channels))
            t.tag(1, C.O0.LengthDelimited).fork().tag(1, C.O0.Bit64).fixed64(r),
                ...
                t.join().join();
        for (let r of (0 !== e.hubProgress && t.tag(2, C.O0.Varint).uint32(e.hubProgress),
        0 !== e.guildOnboardingProgress && t.tag(3, C.O0.Varint).uint32(e.guildOnboardingProgress),
        e.guildRecentsDismissedAt &&
            L.D.internalBinaryWrite(e.guildRecentsDismissedAt, t.tag(4, C.O0.LengthDelimited).fork(), n).join(),
        e.dismissedGuildContent.length && t.tag(5, C.O0.LengthDelimited).bytes(e.dismissedGuildContent),
        e.joinSound && tf.internalBinaryWrite(e.joinSound, t.tag(6, C.O0.LengthDelimited).fork(), n).join(),
        e.mobileRedesignChannelListSettings &&
            eJ
                .internalBinaryWrite(e.mobileRedesignChannelListSettings, t.tag(7, C.O0.LengthDelimited).fork(), n)
                .join(),
        !1 !== e.disableRaidAlertPush && t.tag(8, C.O0.Varint).bool(e.disableRaidAlertPush),
        !1 !== e.disableRaidAlertNag && t.tag(9, C.O0.Varint).bool(e.disableRaidAlertNag),
        e.customNotificationSoundConfig &&
            em.internalBinaryWrite(e.customNotificationSoundConfig, t.tag(10, C.O0.LengthDelimited).fork(), n).join(),
        !1 !== e.leaderboardsDisabled && t.tag(11, C.O0.Varint).bool(e.leaderboardsDisabled),
        Object.keys(e.guildDismissibleContentStates)))
            t.tag(12, C.O0.LengthDelimited).fork().tag(1, C.O0.Varint).int32(parseInt(r)),
                t.tag(2, C.O0.LengthDelimited).fork(),
...
class e_ extends b.G {
    ...
    internalBinaryWrite(e, t, n) {
        e.id && D.ol.internalBinaryWrite(e.id, t.tag(1, C.O0.LengthDelimited).fork(), n).join(),
            e.name && D.hU.internalBinaryWrite(e.name, t.tag(2, C.O0.LengthDelimited).fork(), n).join(),
            e.color && D.ol.internalBinaryWrite(e.color, t.tag(3, C.O0.LengthDelimited).fork(), n).join();
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? C.f$.onWrite : r)(this.typeName, e, t), t;
    }
}
...
class ep extends b.G {
    ...
    internalBinaryWrite(e, t, n) {
        !1 !== e.collapsedInInbox && t.tag(1, C.O0.Varint).bool(e.collapsedInInbox),
            e.iconEmoji && ef.internalBinaryWrite(e.iconEmoji, t.tag(2, C.O0.LengthDelimited).fork(), n).join(),
            e.customNotificationSoundConfig &&
                em
                    .internalBinaryWrite(e.customNotificationSoundConfig, t.tag(3, C.O0.LengthDelimited).fork(), n)
                    .join();
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? C.f$.onWrite : r)(this.typeName, e, t), t;
    }
...
class eE extends b.G {
    ...
    internalBinaryWrite(e, t, n) {
        e.notificationSoundPackId &&
            D.hU.internalBinaryWrite(e.notificationSoundPackId, t.tag(1, C.O0.LengthDelimited).fork(), n).join();
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? C.f$.onWrite : r)(this.typeName, e, t), t;
    }
}
...
class eg extends b.G {
    ...
    internalBinaryWrite(e, t, n) {
        0 !== e.lastDismissedVersion && t.tag(1, C.O0.Varint).uint32(e.lastDismissedVersion),
            "0" !== e.lastDismissedAtMs && t.tag(2, C.O0.Varint).uint64(e.lastDismissedAtMs),
            "0" !== e.lastDismissedObjectId && t.tag(3, C.O0.Varint).uint64(e.lastDismissedObjectId),
            0 !== e.numTimesDismissed && t.tag(4, C.O0.Varint).uint32(e.numTimesDismissed);
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? C.f$.onWrite : r)(this.typeName, e, t), t;
    }
}
...
class eI extends b.G {
    ...
    internalBinaryWrite(e, t, n) {
        for (let r of (e.dismissedContents.length && t.tag(1, C.O0.LengthDelimited).bytes(e.dismissedContents),
        ...
        e.premiumTier0ModalDismissedAt &&
            L.D.internalBinaryWrite(e.premiumTier0ModalDismissedAt, t.tag(3, C.O0.LengthDelimited).fork(), n).join(),
        e.guildOnboardingUpsellDismissedAt &&
            L.D.internalBinaryWrite(
                e.guildOnboardingUpsellDismissedAt,
                t.tag(4, C.O0.LengthDelimited).fork(),
                n,
            ).join(),
        e.safetyUserSentimentNoticeDismissedAt &&
            L.D.internalBinaryWrite(
                e.safetyUserSentimentNoticeDismissedAt,
                t.tag(5, C.O0.LengthDelimited).fork(),
                n,
            ).join(),
        "0" !== e.lastReceivedChangelogId && t.tag(6, C.O0.Bit64).fixed64(e.lastReceivedChangelogId),
        Object.keys(e.recurringDismissibleContentStates)))
            t.tag(7, C.O0.LengthDelimited).fork().tag(1, C.O0.Varint).int32(parseInt(r)),
                t.tag(2, C.O0.LengthDelimited).fork(),
...
class eS extends b.G {
    ...
    internalBinaryWrite(e, t, n) {
        "0" !== e.id && t.tag(1, C.O0.Bit64).fixed64(e.id),
            "" !== e.assetHash && t.tag(2, C.O0.LengthDelimited).string(e.assetHash);
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? C.f$.onWrite : r)(this.typeName, e, t), t;
    }
}
...
class eN extends b.G {
    ...
    internalBinaryWrite(e, t, n) {
        !1 !== e.useBlur && t.tag(1, C.O0.Varint).bool(e.useBlur);
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? C.f$.onWrite : r)(this.typeName, e, t), t;
    }
}
...
class eC extends b.G {
    constructor() {
        super("discord_protos.discord_users.v1.VoiceAndVideoSettings", [
            { no: 1, name: "blur", kind: "message", oneof: "videoBackgroundFilterDesktop", T: () => ev },
            ...
            switch (t) {
                case 1:
                    i.videoBackgroundFilterDesktop = {
                        oneofKind: "blur",
                        blur: ev.internalBinaryRead(e, e.uint32(), n, i.videoBackgroundFilterDesktop.blur),
                    };
                    break;
                case 2:
                ...
                case 8:
                    ...
                    break;
                case 9:
                    i.soundboardSettings = td.internalBinaryRead(e, e.uint32(), n, i.soundboardSettings);
                    break;
                case 10:
    ...
    internalBinaryWrite(e, t, n) {
        "blur" === e.videoBackgroundFilterDesktop.oneofKind &&
            ev
                .internalBinaryWrite(e.videoBackgroundFilterDesktop.blur, t.tag(1, C.O0.LengthDelimited).fork(), n)
                .join(),
            "presetOption" === e.videoBackgroundFilterDesktop.oneofKind &&
                t.tag(2, C.O0.Varint).uint32(e.videoBackgroundFilterDesktop.presetOption),
            "customAsset" === e.videoBackgroundFilterDesktop.oneofKind &&
                ey
                    .internalBinaryWrite(
                        e.videoBackgroundFilterDesktop.customAsset,
                        t.tag(3, C.O0.LengthDelimited).fork(),
                        n,
                    )
                    .join(),
            e.alwaysPreviewVideo &&
                D._t.internalBinaryWrite(e.alwaysPreviewVideo, t.tag(5, C.O0.LengthDelimited).fork(), n).join(),
            e.afkTimeout && D.ZQ.internalBinaryWrite(e.afkTimeout, t.tag(6, C.O0.LengthDelimited).fork(), n).join(),
            e.streamNotificationsEnabled &&
                D._t.internalBinaryWrite(e.streamNotificationsEnabled, t.tag(7, C.O0.LengthDelimited).fork(), n).join(),
            e.nativePhoneIntegrationEnabled &&
                D._t
                    .internalBinaryWrite(e.nativePhoneIntegrationEnabled, t.tag(8, C.O0.LengthDelimited).fork(), n)
                    .join(),
            e.soundboardSettings &&
                td.internalBinaryWrite(e.soundboardSettings, t.tag(9, C.O0.LengthDelimited).fork(), n).join(),
            e.disableStreamPreviews &&
                D._t.internalBinaryWrite(e.disableStreamPreviews, t.tag(10, C.O0.LengthDelimited).fork(), n).join(),
            e.soundmojiVolume &&
                D.uN.internalBinaryWrite(e.soundmojiVolume, t.tag(11, C.O0.LengthDelimited).fork(), n).join();
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? C.f$.onWrite : r)(this.typeName, e, t), t;
    }
}
...
class eR extends b.G {
    ...
    internalBinaryWrite(e, t, n) {
        0 !== e.explicitContentGuilds && t.tag(1, C.O0.Varint).int32(e.explicitContentGuilds),
            0 !== e.explicitContentFriendDm && t.tag(2, C.O0.Varint).int32(e.explicitContentFriendDm),
            0 !== e.explicitContentNonFriendDm && t.tag(3, C.O0.Varint).int32(e.explicitContentNonFriendDm);
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? C.f$.onWrite : r)(this.typeName, e, t), t;
    }
}
...
class eD extends b.G {
    ...
    internalBinaryWrite(e, t, n) {
        0 !== e.goreContentGuilds && t.tag(1, C.O0.Varint).int32(e.goreContentGuilds),
            0 !== e.goreContentFriendDm && t.tag(2, C.O0.Varint).int32(e.goreContentFriendDm),
            0 !== e.goreContentNonFriendDm && t.tag(3, C.O0.Varint).int32(e.goreContentNonFriendDm);
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? C.f$.onWrite : r)(this.typeName, e, t), t;
    }
}
...
class ew extends b.G {
    ...
    internalBinaryWrite(e, t, n) {
        0 !== e.selfHarmContentGuilds && t.tag(1, C.O0.Varint).int32(e.selfHarmContentGuilds),
            0 !== e.selfHarmContentFriendDm && t.tag(2, C.O0.Varint).int32(e.selfHarmContentFriendDm),
            0 !== e.selfHarmContentNonFriendDm && t.tag(3, C.O0.Varint).int32(e.selfHarmContentNonFriendDm);
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? C.f$.onWrite : r)(this.typeName, e, t), t;
    }
}
...
class eP extends b.G {
    ...
    internalBinaryWrite(e, t, n) {
        e.profanity && D._t.internalBinaryWrite(e.profanity, t.tag(1, C.O0.LengthDelimited).fork(), n).join(),
            e.sexualContent &&
                D._t.internalBinaryWrite(e.sexualContent, t.tag(2, C.O0.LengthDelimited).fork(), n).join(),
            e.slurs && D._t.internalBinaryWrite(e.slurs, t.tag(3, C.O0.LengthDelimited).fork(), n).join();
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? C.f$.onWrite : r)(this.typeName, e, t), t;
    }
}
...
class ek extends b.G {
        ...
        for (; e.pos < s; ) {
            ...
            switch (t) {
                ...
                case 29:
                    ...
                    break;
                case 30:
                    i.keywordFilterSettings = ex.internalBinaryRead(e, e.uint32(), n, i.keywordFilterSettings);
                    break;
                case 31:
    ...
    internalBinaryWrite(e, t, n) {
        e.diversitySurrogate &&
            D.hU.internalBinaryWrite(e.diversitySurrogate, t.tag(1, C.O0.LengthDelimited).fork(), n).join(),
            e.useRichChatInput &&
                D._t.internalBinaryWrite(e.useRichChatInput, t.tag(2, C.O0.LengthDelimited).fork(), n).join(),
            e.useThreadSidebar &&
                D._t.internalBinaryWrite(e.useThreadSidebar, t.tag(3, C.O0.LengthDelimited).fork(), n).join(),
            e.renderSpoilers &&
                D.hU.internalBinaryWrite(e.renderSpoilers, t.tag(4, C.O0.LengthDelimited).fork(), n).join();
        for (let n = 0; n < e.emojiPickerCollapsedSections.length; n++)
            t.tag(5, C.O0.LengthDelimited).string(e.emojiPickerCollapsedSections[n]);
        for (let n = 0; n < e.stickerPickerCollapsedSections.length; n++)
            t.tag(6, C.O0.LengthDelimited).string(e.stickerPickerCollapsedSections[n]);
        e.viewImageDescriptions &&
            D._t.internalBinaryWrite(e.viewImageDescriptions, t.tag(7, C.O0.LengthDelimited).fork(), n).join(),
            e.showCommandSuggestions &&
                D._t.internalBinaryWrite(e.showCommandSuggestions, t.tag(8, C.O0.LengthDelimited).fork(), n).join(),
            e.inlineAttachmentMedia &&
                D._t.internalBinaryWrite(e.inlineAttachmentMedia, t.tag(9, C.O0.LengthDelimited).fork(), n).join(),
            e.inlineEmbedMedia &&
                D._t.internalBinaryWrite(e.inlineEmbedMedia, t.tag(10, C.O0.LengthDelimited).fork(), n).join(),
            e.gifAutoPlay && D._t.internalBinaryWrite(e.gifAutoPlay, t.tag(11, C.O0.LengthDelimited).fork(), n).join(),
            e.renderEmbeds &&
                D._t.internalBinaryWrite(e.renderEmbeds, t.tag(12, C.O0.LengthDelimited).fork(), n).join(),
            e.renderReactions &&
                D._t.internalBinaryWrite(e.renderReactions, t.tag(13, C.O0.LengthDelimited).fork(), n).join(),
            e.animateEmoji &&
                D._t.internalBinaryWrite(e.animateEmoji, t.tag(14, C.O0.LengthDelimited).fork(), n).join(),
            e.animateStickers &&
                D.ZQ.internalBinaryWrite(e.animateStickers, t.tag(15, C.O0.LengthDelimited).fork(), n).join(),
            e.enableTtsCommand &&
                D._t.internalBinaryWrite(e.enableTtsCommand, t.tag(16, C.O0.LengthDelimited).fork(), n).join(),
            e.messageDisplayCompact &&
                D._t.internalBinaryWrite(e.messageDisplayCompact, t.tag(17, C.O0.LengthDelimited).fork(), n).join(),
            e.explicitContentFilter &&
                D.ZQ.internalBinaryWrite(e.explicitContentFilter, t.tag(19, C.O0.LengthDelimited).fork(), n).join(),
            e.viewNsfwGuilds &&
                D._t.internalBinaryWrite(e.viewNsfwGuilds, t.tag(20, C.O0.LengthDelimited).fork(), n).join(),
            e.convertEmoticons &&
                D._t.internalBinaryWrite(e.convertEmoticons, t.tag(21, C.O0.LengthDelimited).fork(), n).join(),
            e.expressionSuggestionsEnabled &&
                D._t
                    .internalBinaryWrite(e.expressionSuggestionsEnabled, t.tag(22, C.O0.LengthDelimited).fork(), n)
                    .join(),
            e.viewNsfwCommands &&
                D._t.internalBinaryWrite(e.viewNsfwCommands, t.tag(23, C.O0.LengthDelimited).fork(), n).join(),
            e.useLegacyChatInput &&
                D._t.internalBinaryWrite(e.useLegacyChatInput, t.tag(24, C.O0.LengthDelimited).fork(), n).join();
        for (let n = 0; n < e.soundboardPickerCollapsedSections.length; n++)
            t.tag(25, C.O0.LengthDelimited).string(e.soundboardPickerCollapsedSections[n]);
        e.dmSpamFilter && D.ZQ.internalBinaryWrite(e.dmSpamFilter, t.tag(26, C.O0.LengthDelimited).fork(), n).join(),
            0 !== e.dmSpamFilterV2 && t.tag(27, C.O0.Varint).int32(e.dmSpamFilterV2),
            e.includeStickersInAutocomplete &&
                D._t
                    .internalBinaryWrite(e.includeStickersInAutocomplete, t.tag(28, C.O0.LengthDelimited).fork(), n)
                    .join(),
            e.explicitContentSettings &&
                eb.internalBinaryWrite(e.explicitContentSettings, t.tag(29, C.O0.LengthDelimited).fork(), n).join(),
            e.keywordFilterSettings &&
                ex.internalBinaryWrite(e.keywordFilterSettings, t.tag(30, C.O0.LengthDelimited).fork(), n).join(),
            e.includeSoundmojiInAutocomplete &&
                D._t
                    .internalBinaryWrite(e.includeSoundmojiInAutocomplete, t.tag(31, C.O0.LengthDelimited).fork(), n)
                    .join(),
            e.goreContentSettings &&
                eL.internalBinaryWrite(e.goreContentSettings, t.tag(32, C.O0.LengthDelimited).fork(), n).join(),
            e.defaultReactionEmoji &&
                tB.internalBinaryWrite(e.defaultReactionEmoji, t.tag(33, C.O0.LengthDelimited).fork(), n).join(),
            e.showMentionSuggestions &&
                D._t.internalBinaryWrite(e.showMentionSuggestions, t.tag(34, C.O0.LengthDelimited).fork(), n).join(),
            e.selfHarmContentSettings &&
                eM.internalBinaryWrite(e.selfHarmContentSettings, t.tag(35, C.O0.LengthDelimited).fork(), n).join(),
            e.isCrossDmSearchEnabled &&
                D._t.internalBinaryWrite(e.isCrossDmSearchEnabled, t.tag(36, C.O0.LengthDelimited).fork(), n).join(),
            0 !== e.searchProvider && t.tag(37, C.O0.Varint).int32(e.searchProvider),
            e.customSearchUrl &&
                D.hU.internalBinaryWrite(e.customSearchUrl, t.tag(38, C.O0.LengthDelimited).fork(), n).join();
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? C.f$.onWrite : r)(this.typeName, e, t), t;
    }
}
...
class eG extends b.G {
    ...
    internalBinaryWrite(e, t, n) {
        e.showInAppNotifications &&
            D._t.internalBinaryWrite(e.showInAppNotifications, t.tag(1, C.O0.LengthDelimited).fork(), n).join(),
            e.notifyFriendsOnGoLive &&
                D._t.internalBinaryWrite(e.notifyFriendsOnGoLive, t.tag(2, C.O0.LengthDelimited).fork(), n).join(),
            "0" !== e.notificationCenterAckedBeforeId &&
                t.tag(3, C.O0.Bit64).fixed64(e.notificationCenterAckedBeforeId),
            e.enableBurstReactionNotifications &&
                D._t
                    .internalBinaryWrite(e.enableBurstReactionNotifications, t.tag(4, C.O0.LengthDelimited).fork(), n)
                    .join(),
            e.quietMode && D._t.internalBinaryWrite(e.quietMode, t.tag(5, C.O0.LengthDelimited).fork(), n).join(),
            "0" !== e.focusModeExpiresAtMs && t.tag(6, C.O0.Bit64).fixed64(e.focusModeExpiresAtMs),
            0 !== e.reactionNotifications && t.tag(7, C.O0.Varint).int32(e.reactionNotifications),
            0 !== e.gameActivityNotifications && t.tag(8, C.O0.Varint).int32(e.gameActivityNotifications),
            0 !== e.customStatusPushNotifications && t.tag(9, C.O0.Varint).int32(e.customStatusPushNotifications),
            e.gameActivityExcludeSteamNotifications &&
                D._t
                    .internalBinaryWrite(
                        e.gameActivityExcludeSteamNotifications,
                        t.tag(10, C.O0.LengthDelimited).fork(),
                        n,
                    )
                    .join(),
            e.enableVoiceActivityNotifications &&
                D._t
                    .internalBinaryWrite(e.enableVoiceActivityNotifications, t.tag(11, C.O0.LengthDelimited).fork(), n)
                    .join(),
            e.enableFriendOnlineNotifications &&
                D._t
                    .internalBinaryWrite(e.enableFriendOnlineNotifications, t.tag(12, C.O0.LengthDelimited).fork(), n)
                    .join(),
            e.enableUserResurrectionNotifications &&
                D._t
                    .internalBinaryWrite(
                        e.enableUserResurrectionNotifications,
                        t.tag(13, C.O0.LengthDelimited).fork(),
                        n,
                    )
                    .join(),
            e.enableFriendAnniversaryNotifications &&
                D._t
                    .internalBinaryWrite(
                        e.enableFriendAnniversaryNotifications,
                        t.tag(14, C.O0.LengthDelimited).fork(),
                        n,
                    )
                    .join(),
            e.enableGameUpdateNotifications &&
                D._t
                    .internalBinaryWrite(e.enableGameUpdateNotifications, t.tag(15, C.O0.LengthDelimited).fork(), n)
                    .join(),
            e.enableProfileUpdatesNotifications &&
                D._t
                    .internalBinaryWrite(e.enableProfileUpdatesNotifications, t.tag(16, C.O0.LengthDelimited).fork(), n)
                    .join(),
            e.enableServerTrendingNotifications &&
                D._t
                    .internalBinaryWrite(e.enableServerTrendingNotifications, t.tag(17, C.O0.LengthDelimited).fork(), n)
                    .join(),
            e.enableDmReplyNudgeReminders &&
                D._t
                    .internalBinaryWrite(e.enableDmReplyNudgeReminders, t.tag(18, C.O0.LengthDelimited).fork(), n)
                    .join(),
            e.enableSummaryReminderNotifications &&
                D._t
                    .internalBinaryWrite(
                        e.enableSummaryReminderNotifications,
                        t.tag(19, C.O0.LengthDelimited).fork(),
                        n,
                    )
                    .join(),
            e.enableGdmAllReactionNotifications &&
                D._t
                    .internalBinaryWrite(e.enableGdmAllReactionNotifications, t.tag(20, C.O0.LengthDelimited).fork(), n)
                    .join(),
            e.enableFriendGamingActivityNotifications &&
                D._t
                    .internalBinaryWrite(
                        e.enableFriendGamingActivityNotifications,
                        t.tag(21, C.O0.LengthDelimited).fork(),
                        n,
                    )
                    .join(),
            e.enableUpcomingServerEventNotifications &&
                D._t
                    .internalBinaryWrite(
                        e.enableUpcomingServerEventNotifications,
                        t.tag(22, C.O0.LengthDelimited).fork(),
                        n,
                    )
                    .join();
        let r = n.writeUnknownFields;
    ...
    internalBinaryWrite(e, t, n) {
        if (
            (e.allowActivityPartyPrivacyFriends &&
                D._t
                    .internalBinaryWrite(e.allowActivityPartyPrivacyFriends, t.tag(1, C.O0.LengthDelimited).fork(), n)
                    .join(),
        ...
        if (
            (!1 !== e.defaultGuildsRestricted && t.tag(4, C.O0.Varint).bool(e.defaultGuildsRestricted),
            !1 !== e.allowAccessibilityDetection && t.tag(7, C.O0.Varint).bool(e.allowAccessibilityDetection),
            e.detectPlatformAccounts &&
                D._t.internalBinaryWrite(e.detectPlatformAccounts, t.tag(8, C.O0.LengthDelimited).fork(), n).join(),
            e.passwordless && D._t.internalBinaryWrite(e.passwordless, t.tag(9, C.O0.LengthDelimited).fork(), n).join(),
            e.contactSyncEnabled &&
                D._t.internalBinaryWrite(e.contactSyncEnabled, t.tag(10, C.O0.LengthDelimited).fork(), n).join(),
            e.friendSourceFlags &&
                D.ZQ.internalBinaryWrite(e.friendSourceFlags, t.tag(11, C.O0.LengthDelimited).fork(), n).join(),
            e.friendDiscoveryFlags &&
                D.ZQ.internalBinaryWrite(e.friendDiscoveryFlags, t.tag(12, C.O0.LengthDelimited).fork(), n).join(),
        ...
        if (
            (0 !== e.defaultGuildsActivityRestricted && t.tag(14, C.O0.Varint).int32(e.defaultGuildsActivityRestricted),
            e.activityJoiningRestrictedGuildIds.length)
        ) {
            t.tag(15, C.O0.LengthDelimited).fork();
        ...
        if (e.messageRequestRestrictedGuildIds.length) {
            t.tag(16, C.O0.LengthDelimited).fork();
        ...
        e.defaultMessageRequestRestricted &&
            D._t
                .internalBinaryWrite(e.defaultMessageRequestRestricted, t.tag(17, C.O0.LengthDelimited).fork(), n)
                .join(),
            e.dropsOptedOut &&
                D._t.internalBinaryWrite(e.dropsOptedOut, t.tag(18, C.O0.LengthDelimited).fork(), n).join(),
            e.nonSpamRetrainingOptIn &&
                D._t.internalBinaryWrite(e.nonSpamRetrainingOptIn, t.tag(19, C.O0.LengthDelimited).fork(), n).join(),
            e.familyCenterEnabled &&
                D._t.internalBinaryWrite(e.familyCenterEnabled, t.tag(20, C.O0.LengthDelimited).fork(), n).join(),
            e.familyCenterEnabledV2 &&
                D._t.internalBinaryWrite(e.familyCenterEnabledV2, t.tag(21, C.O0.LengthDelimited).fork(), n).join(),
            e.hideLegacyUsername &&
                D._t.internalBinaryWrite(e.hideLegacyUsername, t.tag(22, C.O0.LengthDelimited).fork(), n).join(),
            e.inappropriateConversationWarnings &&
                D._t
                    .internalBinaryWrite(e.inappropriateConversationWarnings, t.tag(23, C.O0.LengthDelimited).fork(), n)
                    .join(),
            e.recentGamesEnabled &&
                D._t.internalBinaryWrite(e.recentGamesEnabled, t.tag(24, C.O0.LengthDelimited).fork(), n).join(),
            0 !== e.guildsLeaderboardOptOutDefault && t.tag(25, C.O0.Varint).int32(e.guildsLeaderboardOptOutDefault),
            e.allowGameFriendDmsInDiscord &&
                D._t
                    .internalBinaryWrite(e.allowGameFriendDmsInDiscord, t.tag(26, C.O0.LengthDelimited).fork(), n)
                    .join(),
            e.defaultGuildsRestrictedV2 &&
                D._t.internalBinaryWrite(e.defaultGuildsRestrictedV2, t.tag(27, C.O0.LengthDelimited).fork(), n).join(),
            0 !== e.slayerSdkReceiveDmsInGame && t.tag(28, C.O0.Varint).int32(e.slayerSdkReceiveDmsInGame),
            0 !== e.defaultGuildsActivityRestrictedV2 &&
                t.tag(29, C.O0.Varint).int32(e.defaultGuildsActivityRestrictedV2),
            e.quests3PDataOptedOut &&
                D._t.internalBinaryWrite(e.quests3PDataOptedOut, t.tag(30, C.O0.LengthDelimited).fork(), n).join(),
            e.showLocalTime &&
                D._t.internalBinaryWrite(e.showLocalTime, t.tag(31, C.O0.LengthDelimited).fork(), n).join(),
            0 !== e.profileVisibility && t.tag(32, C.O0.Varint).int32(e.profileVisibility);
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? C.f$.onWrite : r)(this.typeName, e, t), t;
    }
}
...
class eH extends b.G {
    ...
    internalBinaryWrite(e, t, n) {
        e.rtcPanelShowVoiceStates &&
            D._t.internalBinaryWrite(e.rtcPanelShowVoiceStates, t.tag(1, C.O0.LengthDelimited).fork(), n).join();
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? C.f$.onWrite : r)(this.typeName, e, t), t;
    }
}
...
class eY extends b.G {
    ...
    internalBinaryWrite(e, t, n) {
        e.installShortcutDesktop &&
            D._t.internalBinaryWrite(e.installShortcutDesktop, t.tag(1, C.O0.LengthDelimited).fork(), n).join(),
            e.installShortcutStartMenu &&
                D._t.internalBinaryWrite(e.installShortcutStartMenu, t.tag(2, C.O0.LengthDelimited).fork(), n).join(),
            e.disableGamesTab &&
                D._t.internalBinaryWrite(e.disableGamesTab, t.tag(3, C.O0.LengthDelimited).fork(), n).join();
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? C.f$.onWrite : r)(this.typeName, e, t), t;
    }
}
...
class eK extends b.G {
    ...
    internalBinaryWrite(e, t, n) {
        e.status && D.hU.internalBinaryWrite(e.status, t.tag(1, C.O0.LengthDelimited).fork(), n).join(),
            e.customStatus && eq.internalBinaryWrite(e.customStatus, t.tag(2, C.O0.LengthDelimited).fork(), n).join(),
            e.showCurrentGame &&
                D._t.internalBinaryWrite(e.showCurrentGame, t.tag(3, C.O0.LengthDelimited).fork(), n).join(),
            "0" !== e.statusExpiresAtMs && t.tag(4, C.O0.Bit64).fixed64(e.statusExpiresAtMs),
            e.statusCreatedAtMs &&
                D.ol.internalBinaryWrite(e.statusCreatedAtMs, t.tag(5, C.O0.LengthDelimited).fork(), n).join();
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? C.f$.onWrite : r)(this.typeName, e, t), t;
    }
}
...
class ez extends b.G {
    ...
    internalBinaryWrite(e, t, n) {
        "" !== e.text && t.tag(1, C.O0.LengthDelimited).string(e.text),
            "0" !== e.emojiId && t.tag(2, C.O0.Bit64).fixed64(e.emojiId),
            "" !== e.emojiName && t.tag(3, C.O0.LengthDelimited).string(e.emojiName),
            "0" !== e.expiresAtMs && t.tag(4, C.O0.Bit64).fixed64(e.expiresAtMs),
            "0" !== e.createdAtMs && t.tag(5, C.O0.Bit64).fixed64(e.createdAtMs),
            e.label && D.hU.internalBinaryWrite(e.label, t.tag(6, C.O0.LengthDelimited).fork(), n).join();
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? C.f$.onWrite : r)(this.typeName, e, t), t;
    }
}
...
class eX extends b.G {
    ...
    internalBinaryWrite(e, t, n) {
        e.locale && D.hU.internalBinaryWrite(e.locale, t.tag(1, C.O0.LengthDelimited).fork(), n).join(),
            e.timezoneOffset &&
                D.as.internalBinaryWrite(e.timezoneOffset, t.tag(2, C.O0.LengthDelimited).fork(), n).join(),
            e.timezoneName && D.hU.internalBinaryWrite(e.timezoneName, t.tag(3, C.O0.LengthDelimited).fork(), n).join();
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? C.f$.onWrite : r)(this.typeName, e, t), t;
    }
}
...
class eZ extends b.G {
    ...
    internalBinaryWrite(e, t, n) {
        e.layout && D.hU.internalBinaryWrite(e.layout, t.tag(1, C.O0.LengthDelimited).fork(), n).join(),
            e.messagePreviews &&
                D.hU.internalBinaryWrite(e.messagePreviews, t.tag(2, C.O0.LengthDelimited).fork(), n).join();
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? C.f$.onWrite : r)(this.typeName, e, t), t;
    }
}
...
class e0 extends b.G {
    ...
    internalBinaryWrite(e, t, n) {
        0 !== e.theme && t.tag(1, C.O0.Varint).int32(e.theme),
            !1 !== e.developerMode && t.tag(2, C.O0.Varint).bool(e.developerMode),
            e.clientThemeSettings &&
                e4.internalBinaryWrite(e.clientThemeSettings, t.tag(3, C.O0.LengthDelimited).fork(), n).join(),
            !1 !== e.mobileRedesignDisabled && t.tag(4, C.O0.Varint).bool(e.mobileRedesignDisabled),
            e.channelListLayout &&
                D.hU.internalBinaryWrite(e.channelListLayout, t.tag(6, C.O0.LengthDelimited).fork(), n).join(),
            e.messagePreviews &&
                D.hU.internalBinaryWrite(e.messagePreviews, t.tag(7, C.O0.LengthDelimited).fork(), n).join(),
            e.searchResultExactCountEnabled &&
                D._t
                    .internalBinaryWrite(e.searchResultExactCountEnabled, t.tag(8, C.O0.LengthDelimited).fork(), n)
                    .join(),
            0 !== e.timestampHourCycle && t.tag(9, C.O0.Varint).int32(e.timestampHourCycle),
            e.happeningNowCardsDisabled &&
                D._t.internalBinaryWrite(e.happeningNowCardsDisabled, t.tag(10, C.O0.LengthDelimited).fork(), n).join(),
            0 !== e.launchPadMode && t.tag(11, C.O0.Varint).int32(e.launchPadMode),
            0 !== e.uiDensity && t.tag(12, C.O0.Varint).int32(e.uiDensity),
            0 !== e.swipeRightToLeftMode && t.tag(13, C.O0.Varint).int32(e.swipeRightToLeftMode);
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? C.f$.onWrite : r)(this.typeName, e, t), t;
    }
}
...
class e2 extends b.G {
    ...
    internalBinaryWrite(e, t, n) {
        for (let n = 0; n < e.colors.length; n++) t.tag(1, C.O0.LengthDelimited).string(e.colors[n]);
        if (e.gradientColorStops.length) {
            t.tag(2, C.O0.LengthDelimited).fork();
            for (let n = 0; n < e.gradientColorStops.length; n++) t.float(e.gradientColorStops[n]);
            t.join();
        }
        0 !== e.gradientAngle && t.tag(3, C.O0.Varint).int32(e.gradientAngle),
            0 !== e.baseMix && t.tag(4, C.O0.Varint).int32(e.baseMix);
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? C.f$.onWrite : r)(this.typeName, e, t), t;
    }
}
...
class e6 extends b.G {
    ...
    internalBinaryWrite(e, t, n) {
        e.backgroundGradientPresetId &&
            D.ZQ.internalBinaryWrite(e.backgroundGradientPresetId, t.tag(2, C.O0.LengthDelimited).fork(), n).join(),
            e.customUserThemeSettings &&
                e3.internalBinaryWrite(e.customUserThemeSettings, t.tag(4, C.O0.LengthDelimited).fork(), n).join();
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? C.f$.onWrite : r)(this.typeName, e, t), t;
    }
}
...
class e7 extends b.G {
    ...
    internalBinaryWrite(e, t, n) {
        for (let r = 0; r < e.folders.length; r++)
            e9.internalBinaryWrite(e.folders[r], t.tag(1, C.O0.LengthDelimited).fork(), n).join();
...
class e8 extends b.G {
    ...
    internalBinaryWrite(e, t, n) {
        if (e.guildIds.length) {
            t.tag(1, C.O0.LengthDelimited).fork();
            for (let n = 0; n < e.guildIds.length; n++) t.fixed64(e.guildIds[n]);
            t.join();
        }
        e.id && D.j1.internalBinaryWrite(e.id, t.tag(2, C.O0.LengthDelimited).fork(), n).join(),
            e.name && D.hU.internalBinaryWrite(e.name, t.tag(3, C.O0.LengthDelimited).fork(), n).join(),
            e.color && D.ol.internalBinaryWrite(e.color, t.tag(4, C.O0.LengthDelimited).fork(), n).join();
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? C.f$.onWrite : r)(this.typeName, e, t), t;
    }
}
    ...
    internalBinaryWrite(e, t, n) {
        for (let r of Object.keys(e.favoriteChannels))
            t.tag(1, C.O0.LengthDelimited).fork().tag(1, C.O0.Bit64).fixed64(r),
                ...
                t.join().join();
        !1 !== e.muted && t.tag(2, C.O0.Varint).bool(e.muted),
            e.guildVisible && D._t.internalBinaryWrite(e.guildVisible, t.tag(3, C.O0.LengthDelimited).fork(), n).join();
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? C.f$.onWrite : r)(this.typeName, e, t), t;
    }
}
...
class tn extends b.G {
    constructor() {
        super("discord_protos.discord_users.v1.FavoriteChannel", [
            ...
            { no: 2, name: "type", kind: "enum", T: () => ["discord_protos.discord_users.v1.FavoriteChannelType", Z] },
    ...
    internalBinaryWrite(e, t, n) {
        "" !== e.nickname && t.tag(1, C.O0.LengthDelimited).string(e.nickname),
            0 !== e.type && t.tag(2, C.O0.Varint).int32(e.type),
            0 !== e.position && t.tag(3, C.O0.Varint).uint32(e.position),
            "0" !== e.parentId && t.tag(4, C.O0.Bit64).fixed64(e.parentId);
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? C.f$.onWrite : r)(this.typeName, e, t), t;
    }
}
...
class ti extends b.G {
    ...
    internalBinaryWrite(e, t, n) {
        !1 !== e.muted && t.tag(1, C.O0.Varint).bool(e.muted),
            0 !== e.volume && t.tag(2, C.O0.Bit32).float(e.volume),
            "0" !== e.modifiedAt && t.tag(3, C.O0.Bit64).fixed64(e.modifiedAt),
            !1 !== e.soundboardMuted && t.tag(4, C.O0.Varint).bool(e.soundboardMuted);
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? C.f$.onWrite : r)(this.typeName, e, t), t;
    }
}
...
class ta extends b.G {
    ...
    internalBinaryWrite(e, t, n) {
        ...
        for (let r of Object.keys(e.stream))
            t.tag(2, C.O0.LengthDelimited).fork().tag(1, C.O0.Bit64).fixed64(r),
                t.tag(2, C.O0.LengthDelimited).fork(),
...
class tl extends b.G {
    ...
    internalBinaryWrite(e, t, n) {
        e.disableHomeAutoNav &&
            D._t.internalBinaryWrite(e.disableHomeAutoNav, t.tag(1, C.O0.LengthDelimited).fork(), n).join();
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? C.f$.onWrite : r)(this.typeName, e, t), t;
    }
}
...
class tc extends b.G {
    ...
    internalBinaryWrite(e, t, n) {
        0 !== e.volume && t.tag(1, C.O0.Bit32).float(e.volume);
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? C.f$.onWrite : r)(this.typeName, e, t), t;
    }
}
...
class t_ extends b.G {
    ...
    internalBinaryWrite(e, t, n) {
        "0" !== e.soundId && t.tag(1, C.O0.Bit64).fixed64(e.soundId),
            "0" !== e.guildId && t.tag(2, C.O0.Bit64).fixed64(e.guildId);
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? C.f$.onWrite : r)(this.typeName, e, t), t;
    }
}
...
class tp extends b.G {
    ...
    internalBinaryWrite(e, t, n) {
        if (
            (e.allowFriends &&
                D._t.internalBinaryWrite(e.allowFriends, t.tag(1, C.O0.LengthDelimited).fork(), n).join(),
        ...
        e.autoBroadcast && D._t.internalBinaryWrite(e.autoBroadcast, t.tag(4, C.O0.LengthDelimited).fork(), n).join();
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? C.f$.onWrite : r)(this.typeName, e, t), t;
    }
}
...
class tE extends b.G {
    ...
    internalBinaryWrite(e, t, n) {
        e.allowVoiceRecording &&
            D._t.internalBinaryWrite(e.allowVoiceRecording, t.tag(1, C.O0.LengthDelimited).fork(), n).join();
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? C.f$.onWrite : r)(this.typeName, e, t), t;
    }
}
...
class tg extends b.G {
    ...
    internalBinaryWrite(e, t, n) {
        "0" !== e.amount && t.tag(1, C.O0.Varint).uint64(e.amount),
            "" !== e.currency && t.tag(2, C.O0.LengthDelimited).string(e.currency);
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? C.f$.onWrite : r)(this.typeName, e, t), t;
    }
}
...
class tI extends b.G {
    ...
    internalBinaryWrite(e, t, n) {
        e.oneTimePurchaseLimit &&
            tA.internalBinaryWrite(e.oneTimePurchaseLimit, t.tag(1, C.O0.LengthDelimited).fork(), n).join();
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? C.f$.onWrite : r)(this.typeName, e, t), t;
    }
}
...
class tS extends b.G {
    ...
    internalBinaryWrite(e, t, n) {
        0 !== e.safetySettingsPreset && t.tag(1, C.O0.Varint).int32(e.safetySettingsPreset),
            !1 !== e.ignoreProfileSpeedbumpDisabled && t.tag(2, C.O0.Varint).bool(e.ignoreProfileSpeedbumpDisabled),
            e.spendingLimitSettings &&
                tT.internalBinaryWrite(e.spendingLimitSettings, t.tag(3, C.O0.LengthDelimited).fork(), n).join();
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? C.f$.onWrite : r)(this.typeName, e, t), t;
    }
}
...
class tC extends b.G {
    ...
    internalBinaryWrite(e, t, n) {
        "0" !== e.feedGeneratedAt && t.tag(1, C.O0.Bit64).fixed64(e.feedGeneratedAt);
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? C.f$.onWrite : r)(this.typeName, e, t), t;
    }
}
...
class tD extends b.G {
        ...
        for (; e.pos < s; ) {
            ...
            switch (t) {
                case 1:
                    ...
                    break;
                case 2:
                    i.appSharingSettings = tx.internalBinaryRead(e, e.uint32(), n, i.appSharingSettings);
                    break;
                default:
                    let s = n.readUnknownField;
                    if ("throw" === s)
    ...
    internalBinaryWrite(e, t, n) {
        e.appDmSettings && tM.internalBinaryWrite(e.appDmSettings, t.tag(1, C.O0.LengthDelimited).fork(), n).join(),
            e.appSharingSettings &&
                tx.internalBinaryWrite(e.appSharingSettings, t.tag(2, C.O0.LengthDelimited).fork(), n).join();
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? C.f$.onWrite : r)(this.typeName, e, t), t;
    }
}
...
class tw extends b.G {
    ...
    internalBinaryWrite(e, t, n) {
        !1 !== e.allowMobilePush && t.tag(2, C.O0.Varint).bool(e.allowMobilePush);
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? C.f$.onWrite : r)(this.typeName, e, t), t;
    }
}
...
class tP extends b.G {
    ...
    internalBinaryWrite(e, t, n) {
        !1 !== e.disableApplicationActivitySharing && t.tag(1, C.O0.Varint).bool(e.disableApplicationActivitySharing);
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? C.f$.onWrite : r)(this.typeName, e, t), t;
    }
}
...
class tk extends b.G {
    ...
    internalBinaryWrite(e, t, n) {
        !1 !== e.alwaysDeliver && t.tag(1, C.O0.Varint).bool(e.alwaysDeliver);
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? C.f$.onWrite : r)(this.typeName, e, t), t;
    }
}
...
class tG extends b.G {
    ...
    internalBinaryWrite(e, t, n) {
        e.lastImpressionTime &&
            D.ol.internalBinaryWrite(e.lastImpressionTime, t.tag(1, C.O0.LengthDelimited).fork(), n).join(),
            e.optOutExpiryTime &&
                D.ol.internalBinaryWrite(e.optOutExpiryTime, t.tag(2, C.O0.LengthDelimited).fork(), n).join();
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? C.f$.onWrite : r)(this.typeName, e, t), t;
    }
}
...
class tV extends b.G {
    ...
    internalBinaryWrite(e, t, n) {
        e.emojiId && D.ol.internalBinaryWrite(e.emojiId, t.tag(1, C.O0.LengthDelimited).fork(), n).join(),
            e.emojiName && D.hU.internalBinaryWrite(e.emojiName, t.tag(2, C.O0.LengthDelimited).fork(), n).join(),
            e.animated && D._t.internalBinaryWrite(e.animated, t.tag(3, C.O0.LengthDelimited).fork(), n).join(),
            e.disableDoubleTap &&
                D._t.internalBinaryWrite(e.disableDoubleTap, t.tag(4, C.O0.LengthDelimited).fork(), n).join();
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? C.f$.onWrite : r)(this.typeName, e, t), t;
    }
}
...
class tH extends b.G {
    ...
    internalBinaryWrite(e, t, n) {
        for (let r of Object.keys(e.inAppFeedbackStates))
            t.tag(1, C.O0.LengthDelimited).fork().tag(1, C.O0.Varint).int32(parseInt(r)),
                t.tag(2, C.O0.LengthDelimited).fork(),
                tF.internalBinaryWrite(e.inAppFeedbackStates[r], t, n),
                t.join().join();
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? C.f$.onWrite : r)(this.typeName, e, t), t;
    }
