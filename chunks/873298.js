...
class er extends D.G {
    constructor() {
        super("discord_protos.discord_users.v1.PreloadedUserSettings", [
            ...
            { no: 8, name: "privacy", kind: "message", T: () => eH },
        ...
        for (; e.pos < s; ) {
            ...
            switch (t) {
                ...
                case 7:
                    ...
                    break;
                case 8:
                    r.privacy = eH.internalBinaryRead(e, e.uint32(), n, r.privacy);
                    break;
                case 9:
    ...
    internalBinaryWrite(e, t, n) {
        e.versions && M.u.internalBinaryWrite(e.versions, t.tag(1, R.O0.LengthDelimited).fork(), n).join(),
            ...
            e.privacy && eH.internalBinaryWrite(e.privacy, t.tag(8, R.O0.LengthDelimited).fork(), n).join(),
            ...
            e.safetySettings &&
                tN.internalBinaryWrite(e.safetySettings, t.tag(21, R.O0.LengthDelimited).fork(), n).join(),
            e.icymiSettings &&
...
class eG extends D.G {
    constructor() {
        super("discord_protos.discord_users.v1.TextAndImagesSettings", [
            ...
            { no: 33, name: "default_reaction_emoji", kind: "message", T: () => tH },
        ...
        for (; e.pos < s; ) {
            ...
            switch (t) {
                ...
                case 32:
                    ...
                    break;
                case 33:
                    r.defaultReactionEmoji = tH.internalBinaryRead(e, e.uint32(), n, r.defaultReactionEmoji);
                    break;
                case 34:
    ...
    internalBinaryWrite(e, t, n) {
        ...
        e.dmSpamFilter && L.ZQ.internalBinaryWrite(e.dmSpamFilter, t.tag(26, R.O0.LengthDelimited).fork(), n).join(),
            ...
            e.defaultReactionEmoji &&
                tH.internalBinaryWrite(e.defaultReactionEmoji, t.tag(33, R.O0.LengthDelimited).fork(), n).join(),
...
class ez extends D.G {
    ...
    internalBinaryWrite(e, t, n) {
        e.status && L.hU.internalBinaryWrite(e.status, t.tag(1, R.O0.LengthDelimited).fork(), n).join(),
            e.customStatus && eX.internalBinaryWrite(e.customStatus, t.tag(2, R.O0.LengthDelimited).fork(), n).join(),
            e.showCurrentGame &&
