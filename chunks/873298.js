...
var i,
    ...
    j =
        ...
        _),
    Y =
        (((h = {})[(h.OFF_FOR_NEW_GUILDS = 0)] = "OFF_FOR_NEW_GUILDS"),
        (h[(h.ON_FOR_NEW_GUILDS = 1)] = "ON_FOR_NEW_GUILDS"),
        h),
    W =
        (((f = {})[(f.SLAYER_SDK_RECEIVE_IN_GAME_DMS_UNSET = 0)] = "SLAYER_SDK_RECEIVE_IN_GAME_DMS_UNSET"),
        (f[(f.SLAYER_SDK_RECEIVE_IN_GAME_DMS_ALL = 1)] = "SLAYER_SDK_RECEIVE_IN_GAME_DMS_ALL"),
        (f[(f.SLAYER_SDK_RECEIVE_IN_GAME_DMS_USERS_WITH_GAME = 2)] = "SLAYER_SDK_RECEIVE_IN_GAME_DMS_USERS_WITH_GAME"),
        (f[(f.SLAYER_SDK_RECEIVE_IN_GAME_DMS_NONE = 3)] = "SLAYER_SDK_RECEIVE_IN_GAME_DMS_NONE"),
        f),
    K =
        (((p = {})[(p.UNSET = 0)] = "UNSET"),
    ...
    X =
        ...
        A),
    Z = (((I = {})[(I.AUTO = 0)] = "AUTO"), (I[(I.H12 = 1)] = "H12"), (I[(I.H23 = 2)] = "H23"), I),
    Q =
    ...
    J =
        ...
        S),
    ee =
        (((y = {})[(y.UNSET_FAVORITE_CHANNEL_TYPE = 0)] = "UNSET_FAVORITE_CHANNEL_TYPE"),
        (y[(y.REFERENCE_ORIGINAL = 1)] = "REFERENCE_ORIGINAL"),
        (y[(y.CATEGORY = 2)] = "CATEGORY"),
        y),
    et =
    ...
    en =
        ...
        (v[(v.ALL = 1)] = "ALL"),
        (v[(v.BOOKMARKS = 2)] = "BOOKMARKS"),
        (v[(v.REMINDERS = 3)] = "REMINDERS"),
        v),
    ei =
        (((C = {})[(C.VOICE = 0)] = "VOICE"),
        (C[(C.STREAM = 1)] = "STREAM"),
...
class er extends D.G {
    constructor() {
        super("discord_protos.discord_users.v1.PreloadedUserSettings", [
            ...
            { no: 4, name: "user_content", kind: "message", T: () => ey },
            ...
            { no: 20, name: "for_later", kind: "message", T: () => tR },
            { no: 21, name: "safety_settings", kind: "message", T: () => tv },
        ...
        for (; e.pos < s; ) {
            ...
            switch (t) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    r.userContent = ey.internalBinaryRead(e, e.uint32(), n, r.userContent);
                    break;
                case 5:
                ...
                case 19:
                    ...
                    break;
                case 20:
                    r.forLater = tR.internalBinaryRead(e, e.uint32(), n, r.forLater);
                    break;
                case 21:
                    r.safetySettings = tv.internalBinaryRead(e, e.uint32(), n, r.safetySettings);
                    break;
                case 22:
    ...
    internalBinaryWrite(e, t, n) {
        e.versions && M.u.internalBinaryWrite(e.versions, t.tag(1, R.O0.LengthDelimited).fork(), n).join(),
            e.inbox && eo.internalBinaryWrite(e.inbox, t.tag(2, R.O0.LengthDelimited).fork(), n).join(),
            e.guilds && eu.internalBinaryWrite(e.guilds, t.tag(3, R.O0.LengthDelimited).fork(), n).join(),
            e.userContent && ey.internalBinaryWrite(e.userContent, t.tag(4, R.O0.LengthDelimited).fork(), n).join(),
            e.voiceAndVideo && eb.internalBinaryWrite(e.voiceAndVideo, t.tag(5, R.O0.LengthDelimited).fork(), n).join(),
            e.textAndImages && eF.internalBinaryWrite(e.textAndImages, t.tag(6, R.O0.LengthDelimited).fork(), n).join(),
            e.notifications && eB.internalBinaryWrite(e.notifications, t.tag(7, R.O0.LengthDelimited).fork(), n).join(),
            e.privacy && ej.internalBinaryWrite(e.privacy, t.tag(8, R.O0.LengthDelimited).fork(), n).join(),
            e.debug && eW.internalBinaryWrite(e.debug, t.tag(9, R.O0.LengthDelimited).fork(), n).join(),
            e.gameLibrary && e$.internalBinaryWrite(e.gameLibrary, t.tag(10, R.O0.LengthDelimited).fork(), n).join(),
            e.status && eq.internalBinaryWrite(e.status, t.tag(11, R.O0.LengthDelimited).fork(), n).join(),
            e.localization && eJ.internalBinaryWrite(e.localization, t.tag(12, R.O0.LengthDelimited).fork(), n).join(),
            e.appearance && e3.internalBinaryWrite(e.appearance, t.tag(13, R.O0.LengthDelimited).fork(), n).join(),
            e.guildFolders && e9.internalBinaryWrite(e.guildFolders, t.tag(14, R.O0.LengthDelimited).fork(), n).join(),
            e.favorites && ti.internalBinaryWrite(e.favorites, t.tag(15, R.O0.LengthDelimited).fork(), n).join(),
            e.audioContextSettings &&
                tu.internalBinaryWrite(e.audioContextSettings, t.tag(16, R.O0.LengthDelimited).fork(), n).join(),
            e.communities && td.internalBinaryWrite(e.communities, t.tag(17, R.O0.LengthDelimited).fork(), n).join(),
            e.broadcast && tm.internalBinaryWrite(e.broadcast, t.tag(18, R.O0.LengthDelimited).fork(), n).join(),
            e.clips && tA.internalBinaryWrite(e.clips, t.tag(19, R.O0.LengthDelimited).fork(), n).join(),
            e.forLater && tR.internalBinaryWrite(e.forLater, t.tag(20, R.O0.LengthDelimited).fork(), n).join(),
            e.safetySettings &&
                tv.internalBinaryWrite(e.safetySettings, t.tag(21, R.O0.LengthDelimited).fork(), n).join(),
            e.icymiSettings &&
                tb.internalBinaryWrite(e.icymiSettings, t.tag(22, R.O0.LengthDelimited).fork(), n).join(),
...
class e_ extends D.G {
    ...
    internalBinaryWrite(e, t, n) {
        ...
        e.guildRecentsDismissedAt &&
            w.D.internalBinaryWrite(e.guildRecentsDismissedAt, t.tag(4, R.O0.LengthDelimited).fork(), n).join(),
        e.dismissedGuildContent.length && t.tag(5, R.O0.LengthDelimited).bytes(e.dismissedGuildContent),
        e.joinSound && tp.internalBinaryWrite(e.joinSound, t.tag(6, R.O0.LengthDelimited).fork(), n).join(),
        ...
        e.customNotificationSoundConfig &&
            eA.internalBinaryWrite(e.customNotificationSoundConfig, t.tag(10, R.O0.LengthDelimited).fork(), n).join(),
        ...
        Object.keys(e.guildDismissibleContentStates)))
            t.tag(12, R.O0.LengthDelimited).fork().tag(1, R.O0.Varint).int32(parseInt(i)),
                ...
                t.join().join();
        0 !== e.guildThemeSourcePreference && t.tag(13, R.O0.Varint).int32(e.guildThemeSourcePreference);
        let i = n.writeUnknownFields;
        return !1 !== i && (!0 == i ? R.f$.onWrite : i)(this.typeName, e, t), t;
    }
}
let eh = new e_();
class ef extends D.G {
    constructor() {
    ...
    internalBinaryWrite(e, t, n) {
        e.id && L.ol.internalBinaryWrite(e.id, t.tag(1, R.O0.LengthDelimited).fork(), n).join(),
            e.name && L.hU.internalBinaryWrite(e.name, t.tag(2, R.O0.LengthDelimited).fork(), n).join(),
            e.color && L.ol.internalBinaryWrite(e.color, t.tag(3, R.O0.LengthDelimited).fork(), n).join();
        let i = n.writeUnknownFields;
        return !1 !== i && (!0 == i ? R.f$.onWrite : i)(this.typeName, e, t), t;
    }
}
...
class eE extends D.G {
    ...
    internalBinaryWrite(e, t, n) {
        !1 !== e.collapsedInInbox && t.tag(1, R.O0.Varint).bool(e.collapsedInInbox),
            e.iconEmoji && ep.internalBinaryWrite(e.iconEmoji, t.tag(2, R.O0.LengthDelimited).fork(), n).join(),
            e.customNotificationSoundConfig &&
                eA
...
class eg extends D.G {
    ...
    internalBinaryWrite(e, t, n) {
        e.notificationSoundPackId &&
            L.hU.internalBinaryWrite(e.notificationSoundPackId, t.tag(1, R.O0.LengthDelimited).fork(), n).join();
        let i = n.writeUnknownFields;
        return !1 !== i && (!0 == i ? R.f$.onWrite : i)(this.typeName, e, t), t;
    }
}
...
class eS extends D.G {
    ...
    internalBinaryWrite(e, t, n) {
        ...
        e.premiumTier0ModalDismissedAt &&
            w.D.internalBinaryWrite(e.premiumTier0ModalDismissedAt, t.tag(3, R.O0.LengthDelimited).fork(), n).join(),
...
let eR = new eC();
class eO extends D.G {
    constructor() {
        super("discord_protos.discord_users.v1.VoiceAndVideoSettings", [
            { no: 1, name: "blur", kind: "message", oneof: "videoBackgroundFilterDesktop", T: () => eR },
            { no: 2, name: "preset_option", kind: "scalar", oneof: "videoBackgroundFilterDesktop", T: 13 },
            { no: 3, name: "custom_asset", kind: "message", oneof: "videoBackgroundFilterDesktop", T: () => ev },
            ...
            switch (t) {
                case 1:
                    r.videoBackgroundFilterDesktop = {
                        oneofKind: "blur",
                        blur: eR.internalBinaryRead(e, e.uint32(), n, r.videoBackgroundFilterDesktop.blur),
                    };
                    break;
                case 2:
                ...
                case 3:
                    r.videoBackgroundFilterDesktop = {
                        ...
                        customAsset: ev.internalBinaryRead(
                            e,
                            e.uint32(),
                            n,
    ...
    internalBinaryWrite(e, t, n) {
        "blur" === e.videoBackgroundFilterDesktop.oneofKind &&
            ...
            e.alwaysPreviewVideo &&
                L._t.internalBinaryWrite(e.alwaysPreviewVideo, t.tag(5, R.O0.LengthDelimited).fork(), n).join(),
            e.afkTimeout && L.ZQ.internalBinaryWrite(e.afkTimeout, t.tag(6, R.O0.LengthDelimited).fork(), n).join(),
            e.streamNotificationsEnabled &&
                L._t.internalBinaryWrite(e.streamNotificationsEnabled, t.tag(7, R.O0.LengthDelimited).fork(), n).join(),
            ...
            e.soundboardSettings &&
                th.internalBinaryWrite(e.soundboardSettings, t.tag(9, R.O0.LengthDelimited).fork(), n).join(),
            e.disableStreamPreviews &&
                L._t.internalBinaryWrite(e.disableStreamPreviews, t.tag(10, R.O0.LengthDelimited).fork(), n).join(),
            e.soundmojiVolume &&
                L.uN.internalBinaryWrite(e.soundmojiVolume, t.tag(11, R.O0.LengthDelimited).fork(), n).join();
        let i = n.writeUnknownFields;
        return !1 !== i && (!0 == i ? R.f$.onWrite : i)(this.typeName, e, t), t;
    }
}
        ...
        super("discord_protos.discord_users.v1.ExplicitContentSettings", [
            {
                ...
                kind: "enum",
                T: () => ["discord_protos.discord_users.v1.ExplicitContentRedaction", k],
            },
            {
                no: 2,
...
class ek extends D.G {
    ...
    internalBinaryWrite(e, t, n) {
        e.profanity && L._t.internalBinaryWrite(e.profanity, t.tag(1, R.O0.LengthDelimited).fork(), n).join(),
            e.sexualContent &&
                L._t.internalBinaryWrite(e.sexualContent, t.tag(2, R.O0.LengthDelimited).fork(), n).join(),
            e.slurs && L._t.internalBinaryWrite(e.slurs, t.tag(3, R.O0.LengthDelimited).fork(), n).join();
        let i = n.writeUnknownFields;
        return !1 !== i && (!0 == i ? R.f$.onWrite : i)(this.typeName, e, t), t;
    }
}
...
class eG extends D.G {
        ...
        for (; e.pos < s; ) {
            ...
            switch (t) {
                ...
                case 29:
                    ...
                    break;
                case 30:
                    r.keywordFilterSettings = eU.internalBinaryRead(e, e.uint32(), n, r.keywordFilterSettings);
                    break;
                case 31:
    ...
    internalBinaryWrite(e, t, n) {
        e.diversitySurrogate &&
            L.hU.internalBinaryWrite(e.diversitySurrogate, t.tag(1, R.O0.LengthDelimited).fork(), n).join(),
            e.useRichChatInput &&
                L._t.internalBinaryWrite(e.useRichChatInput, t.tag(2, R.O0.LengthDelimited).fork(), n).join(),
            e.useThreadSidebar &&
                L._t.internalBinaryWrite(e.useThreadSidebar, t.tag(3, R.O0.LengthDelimited).fork(), n).join(),
            e.renderSpoilers &&
                L.hU.internalBinaryWrite(e.renderSpoilers, t.tag(4, R.O0.LengthDelimited).fork(), n).join();
        ...
        e.viewImageDescriptions &&
            L._t.internalBinaryWrite(e.viewImageDescriptions, t.tag(7, R.O0.LengthDelimited).fork(), n).join(),
            e.showCommandSuggestions &&
                L._t.internalBinaryWrite(e.showCommandSuggestions, t.tag(8, R.O0.LengthDelimited).fork(), n).join(),
            e.inlineAttachmentMedia &&
                L._t.internalBinaryWrite(e.inlineAttachmentMedia, t.tag(9, R.O0.LengthDelimited).fork(), n).join(),
            e.inlineEmbedMedia &&
                L._t.internalBinaryWrite(e.inlineEmbedMedia, t.tag(10, R.O0.LengthDelimited).fork(), n).join(),
            e.gifAutoPlay && L._t.internalBinaryWrite(e.gifAutoPlay, t.tag(11, R.O0.LengthDelimited).fork(), n).join(),
            e.renderEmbeds &&
                L._t.internalBinaryWrite(e.renderEmbeds, t.tag(12, R.O0.LengthDelimited).fork(), n).join(),
            e.renderReactions &&
                L._t.internalBinaryWrite(e.renderReactions, t.tag(13, R.O0.LengthDelimited).fork(), n).join(),
            e.animateEmoji &&
                L._t.internalBinaryWrite(e.animateEmoji, t.tag(14, R.O0.LengthDelimited).fork(), n).join(),
            e.animateStickers &&
                L.ZQ.internalBinaryWrite(e.animateStickers, t.tag(15, R.O0.LengthDelimited).fork(), n).join(),
            e.enableTtsCommand &&
                L._t.internalBinaryWrite(e.enableTtsCommand, t.tag(16, R.O0.LengthDelimited).fork(), n).join(),
            e.messageDisplayCompact &&
                L._t.internalBinaryWrite(e.messageDisplayCompact, t.tag(17, R.O0.LengthDelimited).fork(), n).join(),
            e.explicitContentFilter &&
                L.ZQ.internalBinaryWrite(e.explicitContentFilter, t.tag(19, R.O0.LengthDelimited).fork(), n).join(),
            e.viewNsfwGuilds &&
                L._t.internalBinaryWrite(e.viewNsfwGuilds, t.tag(20, R.O0.LengthDelimited).fork(), n).join(),
            e.convertEmoticons &&
                L._t.internalBinaryWrite(e.convertEmoticons, t.tag(21, R.O0.LengthDelimited).fork(), n).join(),
            e.expressionSuggestionsEnabled &&
                L._t
                    .internalBinaryWrite(e.expressionSuggestionsEnabled, t.tag(22, R.O0.LengthDelimited).fork(), n)
                    .join(),
            e.viewNsfwCommands &&
                L._t.internalBinaryWrite(e.viewNsfwCommands, t.tag(23, R.O0.LengthDelimited).fork(), n).join(),
            e.useLegacyChatInput &&
                L._t.internalBinaryWrite(e.useLegacyChatInput, t.tag(24, R.O0.LengthDelimited).fork(), n).join();
        ...
        e.dmSpamFilter && L.ZQ.internalBinaryWrite(e.dmSpamFilter, t.tag(26, R.O0.LengthDelimited).fork(), n).join(),
            ...
            e.explicitContentSettings &&
                eL.internalBinaryWrite(e.explicitContentSettings, t.tag(29, R.O0.LengthDelimited).fork(), n).join(),
            ...
            e.goreContentSettings &&
                eM.internalBinaryWrite(e.goreContentSettings, t.tag(32, R.O0.LengthDelimited).fork(), n).join(),
            e.defaultReactionEmoji &&
                tj.internalBinaryWrite(e.defaultReactionEmoji, t.tag(33, R.O0.LengthDelimited).fork(), n).join(),
            e.showMentionSuggestions &&
                L._t.internalBinaryWrite(e.showMentionSuggestions, t.tag(34, R.O0.LengthDelimited).fork(), n).join(),
            e.selfHarmContentSettings &&
                ex.internalBinaryWrite(e.selfHarmContentSettings, t.tag(35, R.O0.LengthDelimited).fork(), n).join(),
            e.isCrossDmSearchEnabled &&
                L._t.internalBinaryWrite(e.isCrossDmSearchEnabled, t.tag(36, R.O0.LengthDelimited).fork(), n).join(),
            0 !== e.searchProvider && t.tag(37, R.O0.Varint).int32(e.searchProvider),
            e.customSearchUrl &&
                L.hU.internalBinaryWrite(e.customSearchUrl, t.tag(38, R.O0.LengthDelimited).fork(), n).join();
        let i = n.writeUnknownFields;
        return !1 !== i && (!0 == i ? R.f$.onWrite : i)(this.typeName, e, t), t;
    }
}
...
class eV extends D.G {
        ...
        for (; e.pos < s; ) {
            ...
            switch (t) {
                ...
                case 23:
                    ...
                    break;
                case 24:
                    r.notifyFriendsOnProfileUpdate = L._t.internalBinaryRead(
                        e,
                        e.uint32(),
                        n,
    ...
    internalBinaryWrite(e, t, n) {
        e.showInAppNotifications &&
            L._t.internalBinaryWrite(e.showInAppNotifications, t.tag(1, R.O0.LengthDelimited).fork(), n).join(),
            e.notifyFriendsOnGoLive &&
                L._t.internalBinaryWrite(e.notifyFriendsOnGoLive, t.tag(2, R.O0.LengthDelimited).fork(), n).join(),
            ...
            e.enableBurstReactionNotifications &&
                L._t
                    ...
                    .join(),
            e.quietMode && L._t.internalBinaryWrite(e.quietMode, t.tag(5, R.O0.LengthDelimited).fork(), n).join(),
            ...
            e.notifyFriendsOnProfileUpdate &&
                L._t
                    .internalBinaryWrite(e.notifyFriendsOnProfileUpdate, t.tag(24, R.O0.LengthDelimited).fork(), n)
                    .join(),
            e.notifyFriendsOnComeOnline &&
                L._t.internalBinaryWrite(e.notifyFriendsOnComeOnline, t.tag(25, R.O0.LengthDelimited).fork(), n).join();
        let i = n.writeUnknownFields;
        return !1 !== i && (!0 == i ? R.f$.onWrite : i)(this.typeName, e, t), t;
    }
}
    ...
    internalBinaryWrite(e, t, n) {
        ...
        if (
            ...
            e.detectPlatformAccounts &&
                L._t.internalBinaryWrite(e.detectPlatformAccounts, t.tag(8, R.O0.LengthDelimited).fork(), n).join(),
            e.passwordless && L._t.internalBinaryWrite(e.passwordless, t.tag(9, R.O0.LengthDelimited).fork(), n).join(),
            e.contactSyncEnabled &&
                L._t.internalBinaryWrite(e.contactSyncEnabled, t.tag(10, R.O0.LengthDelimited).fork(), n).join(),
            e.friendSourceFlags &&
                L.ZQ.internalBinaryWrite(e.friendSourceFlags, t.tag(11, R.O0.LengthDelimited).fork(), n).join(),
            e.friendDiscoveryFlags &&
                L.ZQ.internalBinaryWrite(e.friendDiscoveryFlags, t.tag(12, R.O0.LengthDelimited).fork(), n).join(),
        ...
        e.defaultMessageRequestRestricted &&
            L._t
                ...
                .join(),
            e.dropsOptedOut &&
                L._t.internalBinaryWrite(e.dropsOptedOut, t.tag(18, R.O0.LengthDelimited).fork(), n).join(),
            e.nonSpamRetrainingOptIn &&
                L._t.internalBinaryWrite(e.nonSpamRetrainingOptIn, t.tag(19, R.O0.LengthDelimited).fork(), n).join(),
            e.familyCenterEnabled &&
                L._t.internalBinaryWrite(e.familyCenterEnabled, t.tag(20, R.O0.LengthDelimited).fork(), n).join(),
            e.familyCenterEnabledV2 &&
                L._t.internalBinaryWrite(e.familyCenterEnabledV2, t.tag(21, R.O0.LengthDelimited).fork(), n).join(),
            e.hideLegacyUsername &&
                L._t.internalBinaryWrite(e.hideLegacyUsername, t.tag(22, R.O0.LengthDelimited).fork(), n).join(),
            ...
            e.recentGamesEnabled &&
                L._t.internalBinaryWrite(e.recentGamesEnabled, t.tag(24, R.O0.LengthDelimited).fork(), n).join(),
            ...
            e.defaultGuildsRestrictedV2 &&
                L._t.internalBinaryWrite(e.defaultGuildsRestrictedV2, t.tag(27, R.O0.LengthDelimited).fork(), n).join(),
            ...
            e.quests3PDataOptedOut &&
                L._t.internalBinaryWrite(e.quests3PDataOptedOut, t.tag(30, R.O0.LengthDelimited).fork(), n).join(),
            e.showLocalTime &&
                L._t.internalBinaryWrite(e.showLocalTime, t.tag(31, R.O0.LengthDelimited).fork(), n).join(),
            0 !== e.profileVisibility && t.tag(32, R.O0.Varint).int32(e.profileVisibility),
            e.hideFriendRequestNotes &&
                L._t.internalBinaryWrite(e.hideFriendRequestNotes, t.tag(33, R.O0.LengthDelimited).fork(), n).join();
        let i = n.writeUnknownFields;
        return !1 !== i && (!0 == i ? R.f$.onWrite : i)(this.typeName, e, t), t;
    }
}
...
class eY extends D.G {
    ...
    internalBinaryWrite(e, t, n) {
        e.rtcPanelShowVoiceStates &&
            L._t.internalBinaryWrite(e.rtcPanelShowVoiceStates, t.tag(1, R.O0.LengthDelimited).fork(), n).join();
        let i = n.writeUnknownFields;
        return !1 !== i && (!0 == i ? R.f$.onWrite : i)(this.typeName, e, t), t;
    }
}
...
class eK extends D.G {
    ...
    internalBinaryWrite(e, t, n) {
        e.installShortcutDesktop &&
            L._t.internalBinaryWrite(e.installShortcutDesktop, t.tag(1, R.O0.LengthDelimited).fork(), n).join(),
            e.installShortcutStartMenu &&
                L._t.internalBinaryWrite(e.installShortcutStartMenu, t.tag(2, R.O0.LengthDelimited).fork(), n).join(),
            e.disableGamesTab &&
                L._t.internalBinaryWrite(e.disableGamesTab, t.tag(3, R.O0.LengthDelimited).fork(), n).join();
        let i = n.writeUnknownFields;
        return !1 !== i && (!0 == i ? R.f$.onWrite : i)(this.typeName, e, t), t;
    }
}
...
class ez extends D.G {
    constructor() {
        super("discord_protos.discord_users.v1.StatusSettings", [
            ...
            { no: 2, name: "custom_status", kind: "message", T: () => eZ },
        ...
        for (; e.pos < s; ) {
            ...
            switch (t) {
                case 1:
                    ...
                    break;
                case 2:
                    r.customStatus = eZ.internalBinaryRead(e, e.uint32(), n, r.customStatus);
                    break;
                case 3:
    ...
    internalBinaryWrite(e, t, n) {
        e.status && L.hU.internalBinaryWrite(e.status, t.tag(1, R.O0.LengthDelimited).fork(), n).join(),
            e.customStatus && eZ.internalBinaryWrite(e.customStatus, t.tag(2, R.O0.LengthDelimited).fork(), n).join(),
            e.showCurrentGame &&
                L._t.internalBinaryWrite(e.showCurrentGame, t.tag(3, R.O0.LengthDelimited).fork(), n).join(),
            "0" !== e.statusExpiresAtMs && t.tag(4, R.O0.Bit64).fixed64(e.statusExpiresAtMs),
            e.statusCreatedAtMs &&
                L.ol.internalBinaryWrite(e.statusCreatedAtMs, t.tag(5, R.O0.LengthDelimited).fork(), n).join();
        let i = n.writeUnknownFields;
        return !1 !== i && (!0 == i ? R.f$.onWrite : i)(this.typeName, e, t), t;
    }
}
let eq = new ez();
class eX extends D.G {
    constructor() {
    ...
    internalBinaryWrite(e, t, n) {
        "" !== e.text && t.tag(1, R.O0.LengthDelimited).string(e.text),
            ...
            e.label && L.hU.internalBinaryWrite(e.label, t.tag(6, R.O0.LengthDelimited).fork(), n).join();
        let i = n.writeUnknownFields;
        return !1 !== i && (!0 == i ? R.f$.onWrite : i)(this.typeName, e, t), t;
    }
}
...
class eQ extends D.G {
    ...
    internalBinaryWrite(e, t, n) {
        e.locale && L.hU.internalBinaryWrite(e.locale, t.tag(1, R.O0.LengthDelimited).fork(), n).join(),
            e.timezoneOffset &&
                L.as.internalBinaryWrite(e.timezoneOffset, t.tag(2, R.O0.LengthDelimited).fork(), n).join(),
            e.timezoneName && L.hU.internalBinaryWrite(e.timezoneName, t.tag(3, R.O0.LengthDelimited).fork(), n).join();
        let i = n.writeUnknownFields;
        return !1 !== i && (!0 == i ? R.f$.onWrite : i)(this.typeName, e, t), t;
    }
}
...
class e0 extends D.G {
    ...
    internalBinaryWrite(e, t, n) {
        e.layout && L.hU.internalBinaryWrite(e.layout, t.tag(1, R.O0.LengthDelimited).fork(), n).join(),
            e.messagePreviews &&
                L.hU.internalBinaryWrite(e.messagePreviews, t.tag(2, R.O0.LengthDelimited).fork(), n).join();
        let i = n.writeUnknownFields;
        return !1 !== i && (!0 == i ? R.f$.onWrite : i)(this.typeName, e, t), t;
    }
}
    ...
    constructor() {
        super("discord_protos.discord_users.v1.AppearanceSettings", [
            ...
            { no: 8, name: "search_result_exact_count_enabled", kind: "message", T: () => L._t },
            {
                ...
                kind: "enum",
                T: () => ["discord_protos.discord_users.v1.TimestampHourCycle", Z],
            },
    ...
    internalBinaryWrite(e, t, n) {
        0 !== e.theme && t.tag(1, R.O0.Varint).int32(e.theme),
            ...
            e.clientThemeSettings &&
                e7.internalBinaryWrite(e.clientThemeSettings, t.tag(3, R.O0.LengthDelimited).fork(), n).join(),
            !1 !== e.mobileRedesignDisabled && t.tag(4, R.O0.Varint).bool(e.mobileRedesignDisabled),
            e.channelListLayout &&
                L.hU.internalBinaryWrite(e.channelListLayout, t.tag(6, R.O0.LengthDelimited).fork(), n).join(),
            e.messagePreviews &&
                L.hU.internalBinaryWrite(e.messagePreviews, t.tag(7, R.O0.LengthDelimited).fork(), n).join(),
            ...
            e.happeningNowCardsDisabled &&
                L._t.internalBinaryWrite(e.happeningNowCardsDisabled, t.tag(10, R.O0.LengthDelimited).fork(), n).join(),
            ...
            0 !== e.defaultGuildThemePreference && t.tag(14, R.O0.Varint).int32(e.defaultGuildThemePreference),
            !1 !== e.darkSidebar && t.tag(15, R.O0.Varint).bool(e.darkSidebar);
        let i = n.writeUnknownFields;
        return !1 !== i && (!0 == i ? R.f$.onWrite : i)(this.typeName, e, t), t;
    }
}
...
class e5 extends D.G {
    ...
    internalBinaryWrite(e, t, n) {
        e.backgroundGradientPresetId &&
            L.ZQ.internalBinaryWrite(e.backgroundGradientPresetId, t.tag(2, R.O0.LengthDelimited).fork(), n).join(),
            e.customUserThemeSettings &&
                e4.internalBinaryWrite(e.customUserThemeSettings, t.tag(4, R.O0.LengthDelimited).fork(), n).join();
        let i = n.writeUnknownFields;
        return !1 !== i && (!0 == i ? R.f$.onWrite : i)(this.typeName, e, t), t;
    }
}
...
class e8 extends D.G {
    ...
    internalBinaryWrite(e, t, n) {
        for (let i = 0; i < e.folders.length; i++)
            tt.internalBinaryWrite(e.folders[i], t.tag(1, R.O0.LengthDelimited).fork(), n).join();
...
class te extends D.G {
    ...
    internalBinaryWrite(e, t, n) {
        ...
        e.id && L.j1.internalBinaryWrite(e.id, t.tag(2, R.O0.LengthDelimited).fork(), n).join(),
            e.name && L.hU.internalBinaryWrite(e.name, t.tag(3, R.O0.LengthDelimited).fork(), n).join(),
            e.color && L.ol.internalBinaryWrite(e.color, t.tag(4, R.O0.LengthDelimited).fork(), n).join();
        let i = n.writeUnknownFields;
        return !1 !== i && (!0 == i ? R.f$.onWrite : i)(this.typeName, e, t), t;
    }
}
...
class tn extends D.G {
    ...
    internalBinaryWrite(e, t, n) {
        ...
        !1 !== e.muted && t.tag(2, R.O0.Varint).bool(e.muted),
            e.guildVisible && L._t.internalBinaryWrite(e.guildVisible, t.tag(3, R.O0.LengthDelimited).fork(), n).join();
        let i = n.writeUnknownFields;
        return !1 !== i && (!0 == i ? R.f$.onWrite : i)(this.typeName, e, t), t;
    }
}
...
class tc extends D.G {
    ...
    internalBinaryWrite(e, t, n) {
        e.disableHomeAutoNav &&
            L._t.internalBinaryWrite(e.disableHomeAutoNav, t.tag(1, R.O0.LengthDelimited).fork(), n).join();
        let i = n.writeUnknownFields;
        return !1 !== i && (!0 == i ? R.f$.onWrite : i)(this.typeName, e, t), t;
    }
}
...
class tE extends D.G {
    ...
    internalBinaryWrite(e, t, n) {
        if (
            (e.allowFriends &&
                L._t.internalBinaryWrite(e.allowFriends, t.tag(1, R.O0.LengthDelimited).fork(), n).join(),
        ...
        e.autoBroadcast && L._t.internalBinaryWrite(e.autoBroadcast, t.tag(4, R.O0.LengthDelimited).fork(), n).join();
        let i = n.writeUnknownFields;
        return !1 !== i && (!0 == i ? R.f$.onWrite : i)(this.typeName, e, t), t;
    }
}
...
class tg extends D.G {
    ...
    internalBinaryWrite(e, t, n) {
        e.allowVoiceRecording &&
            L._t.internalBinaryWrite(e.allowVoiceRecording, t.tag(1, R.O0.LengthDelimited).fork(), n).join();
        let i = n.writeUnknownFields;
        return !1 !== i && (!0 == i ? R.f$.onWrite : i)(this.typeName, e, t), t;
    }
}
...
class tS extends D.G {
    ...
    internalBinaryWrite(e, t, n) {
        e.oneTimePurchaseLimit &&
            tT.internalBinaryWrite(e.oneTimePurchaseLimit, t.tag(1, R.O0.LengthDelimited).fork(), n).join();
        let i = n.writeUnknownFields;
        return !1 !== i && (!0 == i ? R.f$.onWrite : i)(this.typeName, e, t), t;
    }
}
...
class tN extends D.G {
    constructor() {
        super("discord_protos.discord_users.v1.SafetySettings", [
            ...
            { no: 3, name: "spending_limit_settings", kind: "message", T: () => ty },
        ]);
    }
    create(e) {
        ...
        for (; e.pos < s; ) {
            ...
            switch (t) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    r.spendingLimitSettings = ty.internalBinaryRead(e, e.uint32(), n, r.spendingLimitSettings);
                    break;
                default:
                    let s = n.readUnknownField;
                    if ("throw" === s)
    ...
    internalBinaryWrite(e, t, n) {
        0 !== e.safetySettingsPreset && t.tag(1, R.O0.Varint).int32(e.safetySettingsPreset),
            ...
            e.spendingLimitSettings &&
                ty.internalBinaryWrite(e.spendingLimitSettings, t.tag(3, R.O0.LengthDelimited).fork(), n).join();
        let i = n.writeUnknownFields;
        return !1 !== i && (!0 == i ? R.f$.onWrite : i)(this.typeName, e, t), t;
    }
}
...
class tw extends D.G {
        ...
        for (; e.pos < s; ) {
            ...
            switch (t) {
                case 1:
                    ...
                    break;
                case 2:
                    r.appSharingSettings = tU.internalBinaryRead(e, e.uint32(), n, r.appSharingSettings);
                    break;
                default:
                    let s = n.readUnknownField;
                    if ("throw" === s)
    ...
    internalBinaryWrite(e, t, n) {
        e.appDmSettings && tx.internalBinaryWrite(e.appDmSettings, t.tag(1, R.O0.LengthDelimited).fork(), n).join(),
...
class tV extends D.G {
    ...
    internalBinaryWrite(e, t, n) {
        e.lastImpressionTime &&
            L.ol.internalBinaryWrite(e.lastImpressionTime, t.tag(1, R.O0.LengthDelimited).fork(), n).join(),
            e.optOutExpiryTime &&
                L.ol.internalBinaryWrite(e.optOutExpiryTime, t.tag(2, R.O0.LengthDelimited).fork(), n).join();
        let i = n.writeUnknownFields;
        return !1 !== i && (!0 == i ? R.f$.onWrite : i)(this.typeName, e, t), t;
    }
}
...
class tH extends D.G {
    ...
    internalBinaryWrite(e, t, n) {
        e.emojiId && L.ol.internalBinaryWrite(e.emojiId, t.tag(1, R.O0.LengthDelimited).fork(), n).join(),
            e.emojiName && L.hU.internalBinaryWrite(e.emojiName, t.tag(2, R.O0.LengthDelimited).fork(), n).join(),
            e.animated && L._t.internalBinaryWrite(e.animated, t.tag(3, R.O0.LengthDelimited).fork(), n).join(),
            e.disableDoubleTap &&
                L._t.internalBinaryWrite(e.disableDoubleTap, t.tag(4, R.O0.LengthDelimited).fork(), n).join();
        let i = n.writeUnknownFields;
        return !1 !== i && (!0 == i ? R.f$.onWrite : i)(this.typeName, e, t), t;
    }
}
