...
function eT(e) {
    ...
    return (0, c.jsxs)("div", {
        className: e_.EF,
        ref: l,
        children: [(0, c.jsx)(ef.A, { category: t, onArrowClick: i ? o : void 0 }), (0, c.jsx)(eN, { category: t })],
    });
}
function ek(e) {
            ...
            (0, c.jsxs)("div", {
                ...
                children: [
                    ...
                    (0, c.jsxs)("div", {
                        ...
                        ref: j,
                        children: [
                            R && [...Array(N)].map((e, t) => (0, c.jsx)(eC.A, {}, t)),
                            !R &&
                                S.map((e, t) =>
...
let tT = (e) => {
    let { endDate: t, size: n = "md", className: s, showSeconds: l = !1 } = e,
        { days: a, hours: i, minutes: r, seconds: o } = (0, tO.A)(t),
        ...
        let {
            ...
            E = (0, eB.yB)("FeedBlock"),
            {
                ...
                let { sortedSkuIds: t, hasShopDiscount: n, prioritizeUserDiscounts: s, orbsSupportedOnly: l } = e,
                    a = (0, N.bG)([t$.A], () => t$.A.hasConsented(es.YAq.PERSONALIZATION)),
                  ...
                  children: (0, c.jsxs)("div", {
                      ...
                      children: [
                          (0, c.jsxs)("div", {
                              className: tD.$6,
                              children: [
                                  (0, c.jsx)(t1, { label: n, personalizedResults: S }),
                                  (0, c.jsxs)("div", {
...
function nm(e, t) {
    let n = d.useMemo(() => e?.products.filter((e) => e.skuId !== t).map((e) => e.skuId) ?? [], [e?.products, t]),
        s = (0, N.bG)([Y.A], () => Y.A.getPurchases(n));
    return {
...
let nx = d.memo(function (e) {
        ...
        return (0, c.jsx)(ni.L, {
            ...
            children: (0, c.jsx)("div", {
                ref: l,
                className: g()(nh.ty, nE.Q3, { [nh.yo]: a }),
    ...
    np = function (e) {
        let t,
            ...
            h = l || m,
            { readyToClaim: E } = nm(o, a.rewardSkuId),
                          ...
                          x &&
                              ...
                              (0, c.jsx)(
                                  v.R9,
                                  {
                                      ...
                                      children: (0, c.jsx)(nx, { category: o, rewardSkuId: a.rewardSkuId }),
                                  },
                                  a.rewardSkuId,
                              ),
                          g.map((e, t) => {
            ...
            () =>
                "nitro" === u
                    ...
                    : {
                          ...
                          onClick: () => (0, nj.default)({ applicationId: n }),
                          onMouseDown: () => (0, nj.G)({ applicationId: n }),
                      },
            [u, n],
        );
    return (0, c.jsx)(nv.A, {
...
function nR(e) {
    ...
    return (0, c.jsx)("div", {
        ...
        children: null != i && r === nI.R.AVATAR_DECORATION && (0, c.jsx)(nN.i, { item: i }),
    });
}
let ny = (e) => {
    ...
    nM = function (e) {
        ...
        return (
            ...
            (0, c.jsx)("div", {
                ref: s,
                className: nT.eL,
                children: (0, c.jsx)(ny, { peaking: t, transitioning: n, parentWidth: l }),
            })
        );
    };
var nP = n(815021),
...
let nw = function (e) {
    ...
    let m = s?.skuId ?? "",
        ...
        _ = d.useCallback(() => {
            if ((u(!0), t.isDismissible)) {
                ...
                (0, tx.$l)(tE.M.COLLECTIBLES_SHOP_WIDE_BANNER, e, { dismissAction: nH.i.USER_DISMISS });
            }
                ...
                if ((S(e), null != t.ctaRoute && "" !== t.ctaRoute)) {
                    ...
                    if (e.includes("game-shop")) {
                        ...
                        if (null != t) {
                            let e = t[1],
                                n = parseInt(t[2], 10);
                            (0, nj.default)({ guildId: e, pageIndex: n });
                        }
                    } else (0, nD.pX)(e);
                }
            },
    ...
    let A = g()(tD.nM, tD.Tq, tD.TS, tD.YB, { [tD._1]: p, [tD.vb]: f }),
        I = (0, c.jsxs)(c.Fragment, {
            children: [
                t.isDismissible &&
                    (0, c.jsx)("div", {
                        className: tD.Mh,
                        children: (0, c.jsx)(nP.J, {
                            size: "sm",
                            onClick: (e) => {
                                e.stopPropagation(), _();
                            },
    ...
    return (0, c.jsx)(nB.N, {
        ...
        children: (e) =>
            (0, c.jsx)(ni.L, {
                ...
                threshold: 0,
                children: f
                    ? (0, c.jsx)(eK.D, { innerRef: l, onClick: () => j(null), className: g()(e, A), children: I })
                    : (0, c.jsx)("div", { ref: l, className: g()(e, A), children: I }),
            }),
    });
};
var nF = n(757036),
    nU = n(212739);
let nG = (0, R.mj)({ name: "2026-05-orbs-shop-upsell-banner", kind: "user", defaultConfig: !1, variations: { 1: !0 } });
var nz = n(462887),
    nV = n(765671),
    nW = n(303136),
    nK = n(792656),
...
let nX = (e) => {
        let { category: t, tab: n } = e,
            { ref: s, width: l } = (0, nV.Ay)(),
            a = null != l && l <= 560,
            i = (0, h.bG)([nY.A], () => (0, nz.q)(nY.A.theme)),
            r = t?.skuId ?? "",
                ...
                children: (e) =>
                    (0, c.jsx)(ni.L, {
                        ...
                        children: (0, c.jsxs)("div", {
                            ...
                            className: g()(e, nq.kL),
                            children: [
                                (0, c.jsx)(nW.A, { className: nq.Ki, src: nZ.A }),
                                (0, c.jsxs)("div", {
                                    className: nq.Qs,
                                    children: [
                                        (0, c.jsx)(ed.D, {
    ...
    nJ = (e) => {
        let { index: t, wideBannerBlock: n, tab: s } = e,
            l = nG.useConfig({ location: "CollectiblesShopBannerSelector" }),
            a = (0, nF.L)(P.PremiumTypes.TIER_2),
            i = (0, nU.O)();
        if (l && !a && !i && s === M.G2.ORBS) {
            let e = L.A.getCategoryByStoreListingId(n.categoryStoreListingId);
            return (0, c.jsx)(nX, { category: e, tab: s }, t);
        }
        return (0, c.jsx)(nw, { wideBannerBlock: n, tab: s }, t);
    },
    nQ = (e) => {
        ...
        let {
            ...
            C = d.useMemo(() => x.some((e) => e instanceof tb.p), [x])
        ...
        }, [E, h, x.length, i, a, m, l]),
        null != E)
            ? (0, c.jsx)(tm.h, { onRetry: f, errorOrigin: tm.A.SHOP_PAGE, errorMessage: E.message })
            : h || 0 === x.length
              ? (0, c.jsxs)("div", {
                                ...
                                case th.g.WIDE_BANNER:
                                    if (e.isDismissible) {
                                        let t = e.dismissibleContentVersion ?? 0,
                                            { isDismissed: n } = (0, tx.En)(tE.M.COLLECTIBLES_SHOP_WIDE_BANNER, t);
                                        if (n) return null;
                                    }
                                    d = (0, c.jsx)(nJ, { index: i, wideBannerBlock: e, tab: l }, i);
                                    break;
            ...
            (0, c.jsx)(Z.Ch, {
                ...
                children: (0, c.jsxs)("div", {
                    ...
                    children: [
                        ...
                        (0, c.jsx)(nM, { peaking: g, transitioning: s === M.Pf.OUT }),
                    ],
                }),
            })
        );
...
var n1 = n(154323),
    n2 = n(295811),
    n5 = n(870216);
let n4 = { "Any:personalization-header": t1 },
    n7 = { [eo.b.SHOP_HOME]: n4 },
    n9 = { "1465939725649973269": n4, "1478495181551440044": n4 },
    n3 = function () {
        return (0, c.jsx)("div", {
            style: {
    ...
    n6 = { prioritizedCurrency: ev.Hi.ORBS };
function n8(e) {
    let { tab: t } = e,
        [n, s, l] = (0, N.yK)([n5.A], () => [n5.A.getLayout(t), n5.A.isFetchingLayout(t), n5.A.getLayoutFetchError(t)]),
        a = (0, N.bG)([n1.A], () => n1.A.get("shop_include_unpublished")),
    ...
    let u = (0, c.jsx)(er.Qs, { tenantId: es.FYj, layoutId: n, overrides: n9[n] });
    return (0, c.jsxs)(c.Fragment, {
        children: [
            t === z.ORBS && (0, c.jsx)(n3, {}),
            t === z.ORBS ? (0, c.jsx)(ev.v3.Provider, { value: n6, children: u }) : u,
        ],
    });
}
function se(e) {
...
let st = (e) => {
    let { handleTransition: t, tab: n, transitionState: s } = e,
        l = (0, v.uM)(),
        a = (0, N.bG)([n2.A], () => n2.A.getShopLayoutUrlOverride()),
        i = d.useRef(null),
            ...
            children: (0, c.jsxs)("div", {
                ...
                children: [
                    (0, c.jsxs)("div", {
                        ...
                        children: [
                            null != a && "" !== a ? (0, c.jsx)(se, { url: a }) : (0, c.jsx)(n8, { tab: n }),
                            n !== z.CATALOG &&
                                o >= 36 &&
                                (0, c.jsxs)("div", {
                                    className: tD.R$,
                    ...
                    (0, c.jsx)(nM, { peaking: m, transitioning: s === M.Pf.OUT }),
                ],
            }),
        })
    );
...
function sa(e) {
    ...
    return null != _
        ...
        : null != r
          ...
          : t === M.G2.HOME && f
            ? (0, c.jsx)(st, { tab: z.HOME, transitionState: l, handleTransition: b })
            : t === M.G2.ORBS && f
              ? (0, c.jsx)(st, { tab: z.ORBS, transitionState: l, handleTransition: b })
              : sl.includes(t)
                ? (0, c.jsx)(n0, { handleTransition: b, tab: t, transitionState: l })
                : (0, c.jsx)(tu, {
                      tab: t,
                      categories: p,
                      initialCategoryId: m,
...
let sc = { pink: "pinkCountdown" },
    sd = d.memo(function (e) {
        ...
        let r = null != l ? so[l] : void 0,
            o = null != l ? so[sc[l]] : void 0;
        return (0, c.jsx)(eK.D, {
            className: g()(so.nagBar, r),
            onClick: n,
...
let sh = function (e) {
    ...
    let l = (0, eB.yB)("CollectiblesShop"),
        { onClose: a } = (function () {
            ...
            return {
                onClose: d.useCallback(() => {
                    if (0 === s) {
                        (0, nD.aX)(), (0, sr.openUserSettings)();
                        return;
                    }
                    (0, nD.EL)() ? (0, nD.aX)() : (0, nD.pX)(es.BVt.APP);
                }, [s]),
                source: s,
                ...t,
            };
        ...
        { categories: u, refreshCategories: R } = (0, H.Ay)({ logPerf: !0 }, { sessionId: n, tab: o }),
    ...
    (0, b.HU)({ location: B.intl.string(B.t.pWG4ze) }), (0, O.uS)(n, Z, K, X, Y), (0, O.N0)(Z, s);
    let { dismissShopButtonDC: Q } = (0, su.A)();
    d.useEffect(() => {
        Q();
    }, [Q]),
        d.useEffect(() => {
    ...
    d.useEffect(() => {
        ...
        (0, eB.gB)();
    let { analyticsLocations: el } = (0, O.lC)(Z),
        ea = (function (e, t) {
            let n = (0, N.bG)([k.A], () => k.A.getUserDiscount(P.tU)),
                s = (0, N.bG)([T.default], () => T.default.locale),
        ...
        children: (0, c.jsx)(v.R9, {
            ...
            children: (0, c.jsx)(I.iM, {
                ...
                children: (0, c.jsx)(sm, {
                    ...
                    children: (0, c.jsxs)("div", {
                        className: g()(e_.bx, { [eB.jP]: l }),
                        ref: et,
                        inert: en,
                        tabIndex: -1,
                        children: [
                            (0, c.jsx)(si.G, { handleTransition: J, selectedTab: Z }),
                            null != ea &&
                                ea.type === D.COUNTDOWN &&
                                (0, c.jsx)(sd, {
                                    message: ea.message,
