...
let g = (e) => {
    ...
    m = (e) => {
        let { user: t, showStatus: n, speaker: l, channelId: s } = e,
            h = (0, i.e7)([_.ZP], () => _.ZP.isModerator(t.id, s)),
            g = (0, i.e7)([u.Z], () => u.Z.isBlocked(t.id)),
            f = null;
        return (
            n && (f = l ? b.intl.string(b.t.LqMmGx) : h ? b.intl.string(b.t.GMZqSk) : b.intl.string(b.t.suRAp6)),
            (0, r.jsxs)('div', {
                className: p.user,
                children: [
                    (0, r.jsx)(
