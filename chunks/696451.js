"use strict";
n.d(t, { Ay: () => eM, DL: () => j, vg: () => H }), n(938796), n(321073);
var r = n(735438),
    i = n.n(r),
    s = n(665260),
    a = n(311907),
...
function W(e) {
    let {
        ...
        { colorString: T, colorStrings: S, colorRoleId: y, iconRoleId: N, hoistRoleId: b, highestRoleId: O } = Y(o, l),
        D = {
            userId: t,
            nick: n,
            guildId: r,
...
function eA(e) {
    let { guild: t } = e;
    delete C[t.id], delete b[t.id], G(t.id);
}
function eI(e) {
    let t = C[e.guildId];
    if (null == t) return !1;
