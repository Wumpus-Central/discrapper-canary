    ...
    let t = (0, o.e7)([b.Z], () => b.Z.getNotificationStateForGuild(e), [e]),
        ...
        { trailing: m, showUnread: P } = (function (e, t, n) {
            let l = (0, j.Z)(e).available,
                ...
                d = [];
            o && d.push(a.z.VANITY_URL_POWERUP_ROLLBACK_NOTIFICATION);
            let [h] = (0, u.zH)(d, e);
            return i.useMemo(() => {
                var e, i, o;
                if (null == t)
        ...
        N = (function (e, t) {
            let [n, r] = (0, d.US)(null != t ? [a.z.GUILD_POWERUP_PERKS_COACHMARK] : []),
                ...
                c = (function (e, t) {
                    ...
                    return i.useMemo(() => {
                        ...
                        if (n) {
                            ...
                            let a = (0, g.Jh)(e);
                            if (null != a && null != r && a < r && !o) return x.Du.VANITY_URL;
                        }
                        return 0;
                    }, [n, r, e, t]);
                })(e, t),
                    ...
                    let r = (function (e, t, n) {
                        ...
                        let l = null != (i = null == (r = p.Z.getGuild(e)) ? void 0 : r.premiumTier) ? i : I.Eu4.NONE,
                            o = Array.from(x.KW.values())
                                ...
                                .filter(f.lm);
                        if (0 !== o.length) {
                            if (1 === o.length && !(0, h.OY)(a.C.GUILD_POWERUP_SINGLE_SKU_PURCHASE_COACHMARK, e))
                                return {
                                    type: O.J.PERKS_PURCHASABLE,
                                    powerups: o,
                                    markAsDismissed: (t) => {
                                        (0, h.Qd)(a.C.GUILD_POWERUP_SINGLE_SKU_PURCHASE_COACHMARK, e, !0, t);
                                    }
                                };
                            if (o.length > 1 && !(0, h.OY)(a.C.GUILD_POWERUP_CHOICE_SKU_PURCHASE_COACHMARK, e))
                                return {
                                    type: O.J.PERKS_PURCHASABLE,
                                    powerups: o,
                                    markAsDismissed: (t) => {
                                        (0, h.Qd)(a.C.GUILD_POWERUP_CHOICE_SKU_PURCHASE_COACHMARK, e, !0, t);
                                    }
                                };
                        }
                    })(e, t, s);
                ...
                [E, S] = (0, d.bf)(null != _ ? a.z.GUILD_POWERUP_NOTIFICATION : null, { cooldownDurationMs: O.d });
            return i.useMemo(() => {
                if (null != t) {
                    if (o)
                        return {
