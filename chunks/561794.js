        ...
        (0, l.useEffect)(() => {
            for (let { wishlistId: t, userId: r } of e) {
                ...
                let e = I.A.getWishlist(t),
                    ...
                    l = o[T(r, t)];
                (null == e || (null != l && s !== l)) && S.A.fetchWishlist(t, l, i);
            }
        }, [e, i, o]),
...
function g(t) {
    let { wishlistId: e, userId: i, source: r = "user_profile" } = t,
        ...
        h = l.useMemo(() => (null == s ? [] : (0, n.uniq)((0, f.Lh)(s))), [s]);
    ...
    return (
        (0, l.useEffect)(() => {
            null == e ||
                I.A.isFetching(e) ||
                null != c ||
                ((null == s || (null != A && p !== A)) && S.A.fetchWishlist(e, A, r));
        }, [e, r, s, A, p, c]),
...
function k(t) {
    let { isGift: e, giftRecipient: i, isSocialLayerStorefrontEnabled: r = !0 } = t,
        ...
        c = l.useMemo(() => o?.items.filter((t) => !0 !== t.isOwned) ?? [], [o]);
    return l.useMemo(() => !0 === e && null != i && (c.length > 0 || (r && s.length > 0)), [e, i, c, s, r]);
}
function C() {
    return (function (t) {
