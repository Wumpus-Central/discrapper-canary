        ...
        (0, s.useEffect)(() => {
            for (let { wishlistId: e, userId: i } of t) {
                ...
                let t = p.A.getWishlist(e),
                    ...
                    s = u[T(i, e)];
                (null == t || (null != s && r !== s)) && f.A.fetchWishlist(e, s, n);
            }
        }, [t, n, u]),
    ...
    return (
        (0, s.useEffect)(() => {
            null == t ||
                p.A.isFetching(t) ||
                null != d ||
                ((null == r || (null != m && _ !== m)) && f.A.fetchWishlist(t, m, i));
        }, [t, i, r, m, _, d]),
...
function v() {
    return (function (e) {
        ...
        return (
            ...
            { ...y({ wishlistId: i, userId: e }), wishlistId: i, userProfile: n }
        );
