...
function R(e) {
    return C(1e6 - Math.max(0, Math.min(1e6, Math.round(1e6 * e))), 7);
}
let O = new Map();
function b() {
    let e = new Map();
...
function L(e) {
    return (
        e.type === y.$pd.PLAYING ||
        e.type === y.$pd.COMPETING ||
        e.type === y.$pd.WATCHING ||
        e.type === y.$pd.STREAMING
    );
}
function w(e) {
    let t = (function (e) {
        ...
        let n = _.A.getRelationshipType(e),
            r = n === y.eA$.PENDING_INCOMING || n === y.eA$.PENDING_OUTGOING,
            s = _.A.isFriend(e),
            ...
            ? (function (e) {
                  ...
                  return {
                      ...
                      sortKey:
                          ...
                          (n = i),
                          `REQ\0${C(Math.max(0, Math.min(0x9184e729fff, 0x9184e729fff - Math.floor(t))), 13)}\0${n}`),
                  };
            ...
            : s
              ? (function (e) {
                    let t,
                        ...
                        u,
                        _,
                        { userId: p, user: A, activities: S, nickname: N, affinity: v } = e,
                        { category: C, displayActivities: b } =
...
function M() {
    ...
    for (let [t, n] of _.A.getMutableRelationships().entries())
        (n === y.eA$.PENDING_INCOMING || n === y.eA$.PENDING_OUTGOING) && (e = w(t) || e);
...
class P extends s.Ay.Store {
    ...
    initialize() {
        this.waitFor(c.A, l.A, I.A, d.A, _.A, h.A, f.A, u.A, p.default, E.A), M();
    }
    getRows(e) {
    ...
    k = new P(
        ...
        __OVERLAY__
            ...
            : {
                  ...
                  LOGOUT: x(function () {
                      let e = v.size() > 0;
                      return v.clear(), (i = void 0), (O = new Map()), e;
                  }),
              },
    );
