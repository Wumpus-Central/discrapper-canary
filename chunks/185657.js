            ...
            : s
              ? (function (e) {
                    let t,
                        ...
                        u,
                        h,
                        { userId: A, user: S, activities: C, nickname: T, affinity: v } = e,
                        ...
                        U = D.get(A) ?? [],
                        [w] = m.A.isFavorite(p.x.FRIENDS, A),
                        L = g.A.getVoiceChannelId() ?? g.A.getChannelId(),
                        P = null != L ? d.A.getChannel(L)?.guild_id : null,
                        G = c.A.getStatus(A),
                        F = G === N.clD.ONLINE,
                        b = R.some(O),
                        j = G === N.clD.DND || G === N.clD.IDLE,
                        V = I.Ay.getName(P, L, S);
                    return {
                        id: A,
                        userId: A,
                        user: S,
...
class L extends s.Ay.Store {
    ...
    initialize() {
        this.waitFor(d.A, o.A, m.A, c.A, h.A, g.A, f.A, u.A, A.default, E.A), w();
    }
    getRows(e) {
...
function P(e) {
    return (0, S.v$)(e, "FriendsWidgetFriendsStore");
}
let G = new L(
    a.h,
    __OVERLAY__
