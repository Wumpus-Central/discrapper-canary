            ...
            : s
              ? (function (e) {
                    let t,
                        ...
                        u,
                        h,
                        { userId: A, user: S, activities: _, nickname: T, affinity: v } = e,
                        ...
                        U = D.get(A) ?? [],
                        [L] = m.A.isFavorite(p.x.FRIENDS, A),
...
class w extends s.Ay.Store {
    ...
    initialize() {
        this.waitFor(d.A, o.A, m.A, c.A, h.A, g.A, f.A, u.A, A.default, E.A), L();
    }
    getRows(e) {
