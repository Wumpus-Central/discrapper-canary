...
function L(e) {
    return R(1e6 - Math.max(0, Math.min(1e6, Math.round(1e6 * e))), 7);
}
let D = new Map();
function y() {
    let e = new Map();
...
function M(e) {
            ...
            ? (function (e) {
                  ...
                  return {
                      ...
                      sortKey:
                          ...
                          (n = i),
                          `REQ\0${R(Math.max(0, Math.min(0x9184e729fff, 0x9184e729fff - Math.floor(t))), 13)}\0${n}`),
                  };
            ...
            : a
              ? (function (e) {
                    let t,
                        ...
                        d,
                        _,
                        { userId: h, user: T, activities: S, nickname: C, affinity: O } = e,
                        { category: R, displayActivities: y } =
                        ...
                        v = "IN_GAME" === R ? (y[0]?.name ?? null) : null,
                        M = D.get(h) ?? [],
    ...
    return null == t ? O.delete(e) : O.set(e, t);
}
function P() {
    O.clear(), y(), v();
    let e = !1;
    ...
    __OVERLAY__
        ...
        : {
              ...
              RELATIONSHIP_PENDING_INCOMING_REMOVED: w(function (e) {
                  let t = !1;
                  for (let e of O.values("FRIEND_REQUESTS", !0))
              ...
              LOGOUT: w(function () {
                  let e = O.size() > 0;
                  return O.clear(), (i = void 0), (D = new Map()), e;
              }),
          },
);
