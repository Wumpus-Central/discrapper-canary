...
let V = (e) => {
    ...
    H = {
        ...
        escape: k(L({}, a().defaultRules.escape), { match: (e, t, n) => (!1 === t.allowEscape ? null : a().defaultRules.escape.match(e, t, n)) }),
        ...
        link: b.ZP,
        autolink: k(L({}, a().defaultRules.autolink), { parse: F }),
