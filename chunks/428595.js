...
let H = (e) => {
    ...
    Y = (e) =>
        null != e.guildId ? p.Z.getGuild(e.guildId) : null != e.channelId ? p.Z.getGuild(H(e.channelId)) : null,
    W = {
        ...
        link: v.ZP,
        autolink: k(M({}, a().defaultRules.autolink), { parse: V }),
                    ...
                    content: [
                        {
                            type: "text",
                            content: "".concat(
                                null != (o = null == l ? void 0 : l.name) ? o : L.intl.string(L.t["11pdXV"]),
                            ),
                        },
                    ],
                    icon:
