...
var i = n(200651),
    ...
    _ = n(711508);
function x(e) {
    let { context: t, application: n, sectionName: x, primaryEntryPointCommand: y, buttonSize: N = l.PhG.MEDIUM, playSolo: g = !1 } = e,
        j = r.useId(),
        P = r.useCallback(() => {
            s.yT(p.ti.ACTIVITY);
        }, []),
                ...
                (r = r =
                    {
                        ...
                        onClick: () => {
                            S(!0),
                                w(),
                                null == o || o(),
                                c.default.track(v.rMx.APP_DETAIL_PAGE_ENTRY_POINT_COMMAND_BUTTON_CLICKED, {
                                    application_id: n.id,
