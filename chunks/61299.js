...
let O = o.Ay.connectStores([f.A, M.A], () => ({
    braintreeEmail: M.A.braintreeEmail,
...
class D extends a.PureComponent {
    ...
    render() {
        ...
        return (0, r.jsxs)("div", {
            className: t,
            children: [
                (0, r.jsx)(R.Ay, { type: R.Ay.Types.VENMO, size: R.y3.MEDIUM, className: w.Z }),
                l
                    ? (0, r.jsxs)(r.Fragment, {
                          children: [
                              (0, r.jsx)(L.D, {
...
let U = o.Ay.connectStores([f.A, M.A], () => ({ venmoUsername: M.A.venmoUsername, venmoClient: f.A.getVenmoClient() }))(
    D,
);
var G = n(891197),
    F = n(503698),
                ...
                children: (0, r.jsxs)(em.B, {
                    ...
                    children: [
                        ...
                        (0, r.jsxs)(em.B, {
                            gap: 4,
                            children: [
                                (0, r.jsx)(k.E, { variant: "text-sm/semibold", children: b.intl.string(b.t.De3b8t) }),
                ...
                children: (0, r.jsxs)(em.B, {
                    ...
                    children: [
                        ...
                        (0, r.jsxs)(em.B, {
                            gap: 4,
                            children: [
                                (0, r.jsx)(k.E, { variant: "text-sm/semibold", children: b.intl.string(b.t.dFyV07) }),
    ...
    return (
        ...
        (0, r.jsxs)("div", {
            ...
            children: [
                ...
                (0, r.jsx)(k.E, { variant: "text-md/normal", className: eW.h_, children: b.intl.string(b.t.xfG7Jp) }),
            ],
        })
    );
}
...
function tl(e) {
    let { className: t } = e,
        ...
        l = (0, o.bG)([M.A], () => M.A.adyenPaymentData);
    a.useEffect(
        () => (
            null == l && null != n && (e9(), tt()),
            () => {
...
var tP = n(376289);
function tI(e) {
    return () => (null != M.A.error && (0, v.ET)(), e());
}
function t_(e) {
...
function tk(e) {
    let { billingAddressInfo: t, onBillingAddressChange: n, paymentSourceType: l } = e,
        i = (0, o.bG)([M.A], () => M.A.error);
    return (0, r.jsx)(tM, { billingAddressInfo: t, billingError: i, onBillingAddressChange: n, paymentSourceType: l });
}
function tw(e) {
...
function tz() {
    let e = (0, o.bG)([eZ.A], () => eZ.A.isBusy),
        t = (0, o.bG)([M.A], () => M.A.stripePaymentMethod);
...
function t$(e) {
    ...
    let K = a.useMemo(() => {
            ...
            return B && e ? (k ? eg.pn.AWAITING_BROWSER_CHECKOUT : eg.pn.PAYMENT_ELEMENT) : i;
        }, [B, i, k]),
        Z = a.useMemo(() => (0, eX.Gn)(), []),
        {
            CREDIT_CARD_STEPS: q,
    ...
    let eh = (0, o.bG)([M.A], () => M.A.redirectedPaymentSourceId),
    ...
    a.useEffect(() => {
        ...
        a.useEffect(() => {
            let { completeSteps: e, setIsSubmittingCurrentStep: t } = eM.current;
            !(async function () {
                if (null == eh) return;
                await (0, E.$o)();
                let n = ez.A.getPaymentSource(eh);
                null != n && (e(n), t(!1), M.A.clearRedirectedPaymentSourceId());
            })();
        }, [eh]);
    ...
    let ek = a.useCallback(
            (e) => {
                ej(e),
                    (0, u.P0)(
                        (0, c.o)(void 0 !== w ? w : b.intl.string(b.t["VJPg+l"]), d.Ck.SUCCESS, {
...
function tJ(e) {
    ...
    let [d, p] = a.useState(() => ({ info: tY, isValid: !1 })),
        ...
        [b, j, O, L, k] = (0, o.yK)([M.A], () => [
            M.A.braintreeEmail,
            M.A.braintreeNonce,
            M.A.error,
            M.A.venmoUsername,
            M.A.adyenPaymentData,
        ]),
        [w, D] = (0, o.yK)([eq.A], () => [eq.A.error, eq.A.isAwaitingAuthentication]);
    a.useEffect(() => {
        function e(e) {
    ...
    return (
        ...
        }, [B]),
        {
            ...
            paymentAuthenticationState: D ? e0.oc.PENDING : null != w ? e0.oc.ERROR : e0.oc.NONE,
            purchaseError: B,
            setPurchaseError: Y,
