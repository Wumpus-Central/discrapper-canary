...
function v(e) {
    let { channelId: t } = e,
        ...
        v = (0, E.z)({ fingerprintBase64: n, chunkSize: 5, desiredLength: 30 }),
        [N, T] = l.useState(!1),
        y = l.useMemo(() => v?.join(" "), [v]),
        b = l.useCallback(() => {
            null != y &&
                (0, _.C)(y, () => {
                    T(!0), (0, p.k0)({ channelId: t }), setTimeout(() => T(!1), 2e3);
                });
        }, [t, y]);
    return (0, i.jsxs)("div", {
        className: I.kL,
        children: [
            ...
            (0, i.jsx)("div", {
                className: I.on,
                children: (0, i.jsx)(C.j, { chunks: v, columns: 3, className: I.lu }),
            }),
            null != v &&
                (0, i.jsxs)(o.D, {
                    className: S.n2,
