...
if (null != y) {
    ...
    if (
        ((r = {
            ...
            app_arch: u,
            system_locale: p,
            has_client_mods: (0, l.e)(),
            client_launch_id: f.s,
        }),
        (null == (a = s().name) ? void 0 : a.toLocaleLowerCase()) === "electron" &&
...
function P() {
    ...
    return (
        ...
        (e.browser = T()),
        (e.device = C()),
        (e.system_locale = (0, c.q)()),
        (e.has_client_mods = (0, l.e)()),
        e
    );
}
function R() {
    ...
    return g(
        ...
        {
            os_version:
                null != (t = null === s() || void 0 === s() || null == (e = s().os) ? void 0 : e.version) ? t : "",
        },
    );
}
...
M(
    (function () {
        ...
        return (
            ...
            (n.has_client_mods = (0, l.e)()),
            (n.client_launch_id = f.s),
            n
        );
    })(),
);
