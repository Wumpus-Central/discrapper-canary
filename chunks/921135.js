...
class c {
    ...
    getStats() {
        ...
        let u,
            ...
            f,
            p = this.videoElement;
        (null == (e = this.cachedCodecInfo) ? void 0 : e.videoWidth) != null &&
        (null == (t = this.cachedCodecInfo) ? void 0 : t.videoHeight) != null
        ...
        if ((null == (n = this.cachedCodecInfo) ? void 0 : n.frameRate) != null) v = this.cachedCodecInfo.frameRate;
            ...
            if (null !== this.lockedFrameRate) v = this.lockedFrameRate;
                ...
                if (t >= s && e > 0) {
                    ...
                    this.recentFrameRates.push(n),
                        this.recentFrameRates.length > o && this.recentFrameRates.shift(),
                        (v = Math.round(
                            this.recentFrameRates.reduce((e, t) => e + t, 0) / this.recentFrameRates.length,
                        )),
                        (this.lastKnownFrameRate = v);
                } else null !== this.lastKnownFrameRate && (v = this.lastKnownFrameRate);
            }
            this.lastCurrentTime = p.currentTime;
        }
        let S = null != (l = null == (r = p.error) ? void 0 : r.code) ? l : null,
            I = null != (c = null == (i = p.error) ? void 0 : i.message) ? c : null;
        return (
