    ...
    [_.Etm.TOGGLE_SCREENSHARE]: {
        ...
        handler(e) {
            let {
                ...
                o = d.Z.getStreamerActiveStreamMetadata(),
                u = (0, c.Z)(s.ZP, h.Z),
                p = (0, m.Z)();
            null != p &&
                (null != t && null != o && o.pid !== t && (0, g.isWindows)()
                    ? (0, a.WH)(p.guild_id, p.id, { pid: t })
                    : null != i
                      ? (0, a.L6)(!1)
                      : null != t && (0, g.isWindows)()
                        ? (0, a.WH)(p.guild_id, p.id, { pid: t })
                        : null != u
                          ? (0, a.WH)(p.guild_id, p.id, { pid: u.pid })
                          : (0, l.ZDy)(async () => {
                                let { default: e } = await Promise.all([n.e('93382'), n.e('79477'), n.e('69362')]).then(n.bind(n, 60594));
                                return (t) => {
                                    var n, i;
                                    return (0, r.jsx)(
                                        e,
