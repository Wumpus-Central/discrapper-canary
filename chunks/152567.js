...
function R(e) {
    let {
        ...
        p = s.useMemo(() => (null != f ? C(f) : 0), [f]),
        E = s.useMemo(() => {
            let e = Math.abs(C((p * (100 - Math.max(0, Math.min(100, n)))) / 100) - p);
        ...
        children: [
            (0, r.jsxs)("div", {
                ...
                children: [
                    ...
                    0 !== p && (0, r.jsx)(T, { width: p, height: _, className: o()(S.DR, N[t], c) }),
                ],
            }),
            d,
        ],
...
class P extends s.PureComponent {
    ...
    setupVoiceActivity = () => {
        O.Ay.getMediaEngine().on(d.bg.VoiceActivity, this.handleVoiceActivity);
    };
    componentWillUnmount() {
        this._initTimeout.stop(),
            this._silenceTimeout.stop(),
            this._micTestStop(),
            O.Ay.getMediaEngine().removeListener(d.bg.VoiceActivity, this.handleVoiceActivity);
    }
    ...
    render() {
        let {
            ...
            y = e && !I ? w.intl.string(w.t["9viE2A"]) : null;
                                ...
                                (0, r.jsxs)(r.Fragment, {
                                    children: [
                                        (0, r.jsx)("div", {
                                            className: M.km,
                                            "aria-hidden": !0,
                                            children: (0, r.jsx)(E.$, { buttonRef: _, size: u, variant: l, text: N }),
                                        }),
                                        (0, r.jsx)(h.m, {
                                            text: y,
...
function x(e) {
    let {
            ...
            let e = O.Ay.getInputDeviceId(),
                t = O.Ay.getInputDevices(),
                n = u().find(t, (t) => {
                    let { id: n } = t;
                    return n === e;
                }),
                i = O.Ay.getOutputDeviceId(),
                r = O.Ay.getOutputDevices(),
                s = u().find(r, (e) => {
                    let { id: t } = e;
                    return t === i;
                }),
                { threshold: a, autoThreshold: o } = O.Ay.getModeOptions(),
                l = O.Ay.getInputVolume(),
                c = O.Ay.getOutputVolume();
            return {
                inputDevice: n,
                outputDevice: s,
                threshold: a,
                ...
                inputVolume: l,
                outputVolume: c,
                inputMode: O.Ay.getMode(),
                isDeafened: O.Ay.isSelfDeaf(),
            };
        }),
