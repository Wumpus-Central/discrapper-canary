...
function y(e) {
    let {
            ...
            progress: n,
            size: i = "md",
            gradientStart: r = S.A.unsafe_rawColors.YELLOW_260.css,
            gradientEnd: o = S.A.unsafe_rawColors.GREEN_360.css,
            className: u,
            notchClassName: d,
            children: c,
        } = e,
        h = v[i],
        { ref: g, width: f } = (0, p.Ay)(),
...
class w extends s.PureComponent {
    ...
    render() {
        let {
            ...
            { isMicTesting: m, volume: C, isDetectingInput: _ } = this.state,
            ...
            children: [
                ...
                null != S &&
                    (0, l.jsx)(f.E, {
                        ...
                        color: "text-subtle",
                        style: { visibility: m && !_ ? "hidden" : "visible" },
                        children: S,
                    }),
            ],
        });
