...
class U extends a.PureComponent {
    ...
    setupVoiceActivity = () => {
        y.Ay.getMediaEngine().on(u.bg.VoiceActivity, this.handleVoiceActivity);
    };
    componentWillUnmount() {
        this._initTimeout.stop(),
            this._silenceTimeout.stop(),
            this._micTestStop(),
            y.Ay.getMediaEngine().removeListener(u.bg.VoiceActivity, this.handleVoiceActivity);
    }
...
function w(e) {
    let {
            ...
            let e = y.Ay.getInputDeviceId(),
                ...
                r = y.Ay.getOutputDevices(),
                a = d().find(r, (e) => {
                    let { id: t } = e;
                    return t === i;
                }),
                { threshold: s, autoThreshold: l } = y.Ay.getModeOptions(),
                o = y.Ay.getInputVolume(),
                c = y.Ay.getOutputVolume();
            return {
                inputDevice: n,
                outputDevice: a,
                threshold: s,
