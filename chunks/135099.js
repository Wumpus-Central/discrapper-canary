              ...
              return (0, i.jsxs)(c.$T, {
                  ...
                  children: [
                      ...
                      (0, i.jsx)("img", {
                          ...
                          alt: R.intl.string(f.default["1S6oAo"]),
                          className: s()(h.tV, h._R),
                      }),
                      R.intl.format(f.default.YnnXb6, { connectionName: x?.name, applicationName: n }),
                      (0, i.jsx)(c.Z_, {
                          onClick: () => {
                          ...
                          className: h.HE,
                          noticeType: p.kqX.RIOT_MIGRATION,
                          children: R.intl.string(f.default.ZeOhh9),
                      }),
                      (0, i.jsx)(c.zr, {
                          onClick: () => {
                              t(C.i.USER_DISMISS);
                          ...
                          className: h.wX,
                          children: R.intl.string(f.default["MVB/Ab"]),
                      }),
                  ],
              });
          }
