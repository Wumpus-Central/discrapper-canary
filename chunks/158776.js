...
function U(e) {
    ...
    if (c)
        ...
        let { visible: e, hidden: c } = L(o.length > 1 ? [...o].sort(x) : o, n),
            d = M([...(null != s ? s : []), ...c]),
            f = u[t];
...
function G(e) {
    ...
    if (l)
        ...
        let { visible: e, hidden: l } = L(a.length > 1 ? [...a].sort(x) : a, n),
            u = M([...(null != o ? o : []), ...l]);
        c[t] = {
            status: r,
            clientStatus: i,
    ...
    getHiddenActivities(e) {
        ...
        return null == i
            ? null != (n = T[e])
                ? n
                : y
            : null != (r = null == (t = C(e, i)) ? void 0 : t.hiddenActivities)
              ? r
              : y;
    }
