...
var r = (function (e) {
    ...
    function l(e, t, n, r) {
        return void 0 === e ? l[0] : void 0 !== t && (10 != +t || n) ? $(e, t, n, r) : ea(e);
    }
    function c(e, t) {
    ...
    function S(e, n) {
        ...
        for (a = 0; a < o; ++a) {
            s = e[a];
            for (var d = 0; d < l; ++d)
                (i = Math.floor((r = s * n[d] + c[a + d]) / u)), (c[a + d] = r - i * u), (c[a + d + 1] += i);
        }
        return h(c), c;
    }
    function I(e, n) {
    ...
    function R(e, n, r) {
        return e < t ? new c(I(n, e), r) : new c(S(n, p(e)), r);
    }
    function w(e) {
        var n,
            r,
        ...
        for (E.length <= u && E.push(0), b.push(0), h = b[d - 1], i = u - d; i >= 0; i--) {
            for (
                ...
                (a += r * b[o]),
                    ...
                    (s += E[i + o] - (a - c * f)),
                    (a = c),
                    s < 0 ? ((E[i + o] = s + f), (s = -1)) : ((E[i + o] = s), (s = 0));
            for (; 0 !== s; ) {
                for (r -= 1, a = 0, o = 0; o < l; o++)
                    (a += E[i + o] - f + b[o]) < 0 ? ((E[i + o] = a + f), (a = 0)) : ((E[i + o] = a), (a = 1));
                s += a;
            }
            p[i] = r;
        }
    ...
    (c.prototype = Object.create(l.prototype)),
        ...
        (c.prototype.subtract = function (e) {
            ...
            var n = this.value,
                r = t.value;
            return t.isSmall ? v(n, Math.abs(r), this.sign) : A(n, r, this.sign);
        }),
        ...
        (c.prototype.multiply = function (e) {
            ...
            if (r.isSmall) {
                ...
                if ((n = Math.abs(a)) < t) return new c(I(i, n), s);
                a = p(n);
            }
            return N(i.length, a.length) ? new c(C(i, a), s) : new c(S(i, a), s);
        }),
        ...
        (u.prototype._multiplyBySmall = function (e) {
            return f(e.value * this.value)
                ...
                : R(Math.abs(e.value), p(Math.abs(this.value)), this.sign !== e.sign);
        }),
        ...
        (c.prototype.square = function () {
            return new c(w(this.value), !1);
        }),
        (u.prototype.square = function () {
            var e = this.value * this.value;
            return f(e) ? new u(e) : new c(w(p(Math.abs(this.value))), !1);
        }),
        ...
        (d.prototype.pow = function (e) {
            ...
            for (var o = this, c = l[1]; (r & a) === a && ((c = c.times(o)), --r), r !== i; )
                (r /= s), (o = o.square());
            return c;
        }),
        ...
        (c.prototype.isProbablePrime = function (e, t) {
            var n = M(this);
        ...
        (c.prototype.next = function () {
            var e = this.value;
            return this.sign ? v(e, 1, this.sign) : new c(y(e, 1), this.sign);
        }),
        ...
        (c.prototype.prev = function () {
            var e = this.value;
            return this.sign ? new c(y(e, 1), !0) : v(e, 1, this.sign);
        }),
    ...
    function B(e, t, n) {
        ...
        for (
            ...
            (l = (u = L(s, V))[1].toJSNumber()),
                i && (l = V - 1 - l),
                (c = (d = L(o, V))[1].toJSNumber()),
                a && (c = V - 1 - c),
                (s = u[0]),
                (o = d[0]),
                f.push(n(l, c));
        for (var p = 0 !== n(+!!i, +!!a) ? r(-1) : r(0), _ = f.length - 1; _ >= 0; _ -= 1)
            p = p.multiply(V).add(r(f[_]));
        return p;
    }
    ...
    function X(e, t) {
        ...
        for (var n, r, i = l[1]; e.isEven() && t.isEven(); )
            (n = q(W(e), W(t))), (e = e.divide(n)), (t = t.divide(n)), (i = i.multiply(n));
    ...
    function er(e) {
        ...
        for (var p = [], _ = e.length, m = n, E = _ - m; _ > 0; )
            p.push(+e.slice(E, _)), (E -= m) < 0 && (E = 0), (_ -= m);
    ...
    for (var es = 0; es < 1000; es++) (l[es] = ea(es)), es > 0 && (l[-es] = ea(-es));
    return (
        (l.one = l[1]),
        (l.zero = l[0]),
        (l.minusOne = l[-1]),
