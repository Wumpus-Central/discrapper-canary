...
var i = (function () {
    ...
    function r(e, t, n, i) {
        return void 0 === e ? r[0] : void 0 !== t && (10 != +t || n) ? G(e, t, n, i) : j(e);
    }
    function s(e, t) {
    ...
    function v(e, t) {
        ...
        i = (l =
            p.length + E.length <= 200
                ? (function (e, t) {
                      ...
                      return (E = N(E, p)[0]), [c(h), c(E)];
                  })(p, E)
                : (function (e, t) {
                      for (var n, i, r, s, a, o = e.length, l = t.length, u = [], _ = []; o; ) {
                          if ((_.unshift(e[--o]), d(_), 0 > C(_, t))) {
                              u.push(0);
                              continue;
                          }
                          (i = _.length),
        ...
        return (
            ...
            "number" == typeof y ? (v && (y = -y), (y = new a(y))) : (y = new s(y, v)),
            [i, y]
        );
    }
    function C(e, t) {
    ...
    (s.prototype = Object.create(r.prototype)),
        ...
        (o.prototype.add = function (e) {
            return new o(this.value + j(e).value);
        }),
        ...
        (s.prototype.subtract = function (e) {
            ...
            return i.isSmall
                ...
                : ((t = this.sign),
                  (C(r, o) >= 0 ? (n = m(r, o)) : ((n = m(o, r)), (t = !t)), "number" == typeof (n = c(n)))
                      ? (t && (n = -n), new a(n))
                      : new s(n, t));
        }),
        ...
        (s.prototype.modInv = function (e) {
            for (var t, n, r, s = i.zero, a = i.one, o = j(e), l = this.abs(); !l.isZero(); )
                (t = o.divide(l)),
                    (n = s),
                    (r = o),
                    (s = a),
    ...
    function M(e, t, n) {
        ...
        for (
            ...
            (l = (c = v(a, L))[1].toJSNumber()),
                r && (l = L - 1 - l),
                (u = (d = v(o, L))[1].toJSNumber()),
                s && (u = L - 1 - u),
                (a = c[0]),
                (o = d[0]),
                _.push(n(l, u));
    ...
    (s.prototype.shiftLeft = function (e) {
        ...
        (s.prototype.shiftRight = function (e) {
            ...
            for (var i = this; n >= D; ) {
                ...
                (i = (t = v(i, L))[1].isNegative() ? t[0].prev() : t[0]), (n -= D - 1);
            }
            return (t = v(i, b[n]))[1].isNegative() ? t[0].prev() : t[0];
        }),
    ...
    var G = function (e, n, i, r) {
        ...
        for (s = +!!d; s < e.length; s++) {
            var u = e[s];
            if (u in l) c.push(j(l[u]));
            else if ("<" === u) {
                var _ = s;
                do s++;
                while (">" !== e[s] && s < e.length);
                c.push(j(e.slice(_ + 1, s)));
    ...
    for (var Y = 0; Y < 1e3; Y++) (r[Y] = j(Y)), Y > 0 && (r[-Y] = j(-Y));
    return (
        (r.one = r[1]),
        (r.zero = r[0]),
        (r.minusOne = r[-1]),
        ...
        (r.gcd = U),
        (r.lcm = function (e, t) {
            return (e = j(e).abs()), (t = j(t).abs()), e.divide(U(e, t)).multiply(t);
        }),
