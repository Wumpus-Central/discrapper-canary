...
let W = (0, p.J)(function (e) {
    let {
        ...
        ew = (0, a.bG)([R.A], () => R.A.hasVoiceDareForUserId(l.id), [l.id]),
    ...
    let eK = (e) => {
        ...
        ez = (e) =>
            em
                ...
                : null != ef
                  ? (0, i.jsx)(S.E, { ...e, hangStatusActivity: ef, channel: p, userId: l.id })
                  : null,
        eX = () => (0, i.jsx)(T.A, { userId: l.id, channel: p }),
        eq = () =>
            (0, g.r9)() && (0, g.UK)(p.id)
                ? null
                : (0, i.jsx)(b.A, {
        ...
        eJ = (0, i.jsx)("div", {
            ...
            onMouseEnter: eA
                ...
                : () => {
                      eE
                          ? (!em || !eC || eE || eN || eU || ey(!0), eN || ea?.(l.id))
                          : (ei || eC || eP || ek) && !eN && ea?.(l.id);
                  },
                    ...
                    ((e) => {
                        ...
                        if (eA)
                            return (0, i.jsx)(o.m, {
                                ...
                                children: (0, i.jsx)(y.Ay, { ref: eb, ...s }),
                            });
                        let a = () => null;
                        return (
                            eC && eU && !eE
