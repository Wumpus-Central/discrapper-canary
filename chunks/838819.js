...
let Z = (e) => {
    ...
    R = function (e) {
        ...
        let { onClose: F } = (0, T.Db)(),
            { categories: D, refreshCategories: H } = (0, E.ZP)(
                {
        ...
        let M = (0, y.O)(D),
            ...
            { selectedTab: X, transitionState: $, transitionToTab: J } = (0, j.B)(N, n, t),
            { handleScroll: Q } = (0, b.z)(N, a, X);
        (0, S.q3)(a, X, z, $, q),
            (0, S.EB)(X, c),
            (0, L.Z)(),
            l.useEffect(() => {
        ...
        let { analyticsLocations: er } = (0, S.MV)(X);
        return (0, r.jsx)(f.Gt, {
            value: er,
