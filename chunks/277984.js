...
class ee extends J {
    ...
    async confirmDirectPaymentSource(e) {
        ...
        return { pendingCustomerAction: a, customerActionCancelled: "requires_action" === o.status };
    }
...
function eC() {
    a.h.dispatch({ type: "PAYMENT_AUTHENTICATION_CANCEL" });
}
async function ey(e) {
