n.d(t, { Z: () => ed }), n(388685), n(49124), n(35282), n(781311), n(415506);
var i = n(255367),
    r = n(73800),
    s = n(120356),
    l = n.n(s),
...
class ee extends r.Component {
    render() {
        ...
        return (0, i.jsxs)(v.Z, {
            ...
            children: [
                (0, i.jsx)(_.Z, {
                    className: l()(H.removeBuildOverride, { [H.removeBuildOverrideDisabled]: r }),
...
class et extends r.Component {
    ...
    render() {
        ...
        e = t ? (0, i.jsx)(m.$jN, { className: W.marginTop20 }) : null != r && 0 === Object.keys(r).length ? this.renderEmpty() : this.renderItems();
        let s = !n && !t && this.getAvailableProjects().length > 0,
            l =
                $(null != r ? r : {}) && 'stable' !== window.GLOBAL_ENV.RELEASE_CHANNEL
                    ? (0, i.jsx)(m.Text, {
                          color: 'text-danger',
        ...
        super(...e),
            ...
            K(this, 'handleBuildOverrideUpdated', (e, t) => {
                let { buildOverrides: n } = this.state,
                    i = q({}, null != n ? n[e] : {}, t),
                    r = X(q({}, this.state.buildOverrides), { [e]: i });
            ...
            K(this, 'handleLinkGeneration', () => {
                let { buildOverrides: e } = this.state;
                (0, m.h7j)((t) => (0, i.jsx)(en, X(q({}, t), { buildOverrides: e })));
            });
    }
}
class en extends r.Component {
    ...
    renderPayloadBlock() {
        ...
        return (0, i.jsx)(v.Z.Child, { children: (0, i.jsx)(m.Zbd, { children: (0, i.jsx)('pre', { children: r }) }) });
    }
    renderLinkForm() {
...
let el = d.ZP.connectStores([D.default], () => ({
    ...
    let { isTracingRequests: t, isForcedCanary: n, isLoggingGatewayEvents: r, isLoggingOverlayEvents: s, isLoggingAnalyticsEvents: l, isAxeEnabled: a, cssDebuggingEnabled: o, layoutDebuggingEnabled: c, isSourceMapsEnabled: d, isAnalyticsDebuggerEnabled: u, isIdleStatusIndicatorEnabled: g, onlyShowPreviewAppCollections: p, disableAppCollectionsCache: h, preventPopoutClose: b } = e,
        _ = M.zY.useSetting();
    return (0, i.jsxs)(i.Fragment, {
        children: [
            (0, i.jsx)(R.F, {
                    ...
                    children: [
                        ...
                        (0, i.jsxs)(R.F, {
                            ...
                            children: [
                                ...
                                (0, i.jsx)(m.$i$, { className: H.divider })
                            ]
                        })
                    ]
                })
            ...
            children: (0, i.jsxs)(m.Kqy, {
                ...
                children: [
                    (0, i.jsxs)(m.Kqy, {
                        gap: 8,
                        children: [
                            (0, i.jsx)(m.vwX, { children: 'Changelog Override' }),
                            (0, i.jsx)(m.R94, { children: 'Enter the ID of the changelog you want to test This will override the changelog that is shown to the user.' }),
                            (0, i.jsxs)('div', {
                                className: H.surveyOverride,
                                children: [
                                    (0, i.jsx)(m.oil, {
                    ...
                    (0, i.jsxs)(m.Kqy, {
                        gap: 8,
                        children: [
                            (0, i.jsx)(m.vwX, { children: 'Reset Changelog' }),
                            (0, i.jsx)(m.R94, { children: 'This will reset the changelog, so it will show again on the next startup.' }),
                            (0, i.jsx)(m.zxk, {
                                onClick: () => {
