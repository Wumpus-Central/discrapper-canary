...
function $(e) {
    let { guild: t, channel: n, disableSorting: l, isFavoriteCategory: s, collapsed: a, voiceStates: o } = e,
        ...
        u = (0, r.cf)([O.A, M.A, D.A], () => {
            let e = O.A.getChannel(n.parent_id),
                i = M.A.getCheck(n.guild_id);
            return {
                canManageChannel: null != t && D.A.can(K.xBc.MANAGE_CHANNELS, n),
                canReorderChannel:
                    !0 !== l &&
                    (t.id === z.Vc ||
                        (null != e ? D.A.can(K.xBc.MANAGE_CHANNELS, e) : D.A.can(K.xBc.MANAGE_CHANNELS, t))),
                canMoveMembers: D.A.can(K.xBc.MOVE_MEMBERS, n),
                locked: !D.A.can(K.xBc.CONNECT, n),
                bypassLimit: D.A.can(K.xBc.MOVE_MEMBERS, n),
