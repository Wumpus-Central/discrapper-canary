...
class W extends U.Ay {
    ...
    handleContextMenu = (e) => {
        ...
        null != s &&
            (0, h.L3)(e, async () => {
                let { default: e } = await Promise.all([n.e("97262"), n.e("57287"), n.e("40394"), n.e("81107")]).then(
                    n.bind(n, 698193),
                );
...
function z(e) {
    let { guild: t, channel: n, disableSorting: s, isFavoriteCategory: l, collapsed: a, voiceStates: o } = e,
        ...
        A = (0, T.Ay)(n.id),
        p = (0, r.bG)([S.A], () => S.A.getStageInstanceByChannel(n.id), [n.id]),
        m = (0, I.zy)(n.id, N.ip.AUDIENCE),
