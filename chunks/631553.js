        ...
        if (t) {
            ...
            if (!e.locked && this.props.locked) {
                ...
                O.Z.disable(),
                    ...
                    B.default.isPinned(eu.Odu.TEXT) && (O.Z.setLayout(_.Xq), O.Z.enable());
            } else
                e.locked &&
                    !this.props.locked &&
...
function eO() {
    let {
        ...
        l = (0, f.e7)([H.Z], () => H.Z.windowSize()),
        a = (0, f.e7)([U.ZP], () => U.ZP.getOverlayKeybind()),
        ...
        { analyticsLocations: m } = (0, S.ZP)(x.Z.OVERLAY),
