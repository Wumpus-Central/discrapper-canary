...
let y = 25,
    ...
    P = s.z.MATCH_SOME;
function R() {
    (O = !1), (v = !0), (I = !1), (S = !1), (T = null), (A = l.z.LATEST_ACTIVITY), (r = new Set()), (C = 0), (N = []), (P = s.z.MATCH_SOME);
}
function w(e, t) {
    return t === l.z.LATEST_ACTIVITY ? h.ZP.lastMessageId(e.id) : e.id;
}
function D(e) {
    (e.channelId === T && e.sortOrder === A && (0, m.OL)(e.tagFilter, r) && e.tagSetting === P) || R(), (T = e.channelId), (A = e.sortOrder), (r = e.tagFilter instanceof Set ? e.tagFilter : new Set(e.tagFilter)), (P = e.tagSetting), (O = !0), (v = !1);
}
function L(e) {
    if (e.channelId !== T || e.sortOrder !== A || !(0, m.OL)(e.tagFilter, r) || e.tagSetting !== P) return !1;
...
function x(e) {
    return (null == T || null == e.channelId || T === e.channelId) && k();
}
function k() {
    if (null == T) return !1;
    let e = !I,
        ...
        n = null == t ? null : w(t, A);
    N = a()(p.Z.getAllThreadsForParent(T))
...
class V extends (i = c.ZP.Store) {
    ...
    isLoading(e, t, n, i) {
        return T === e && A === t && (0, m.OL)(r, n) && P === i ? O : (R(), !1);
    }
    getThreads(e, t, n, i) {
        return T === e && A === t && (0, m.OL)(r, n) && P === i ? N : F;
    }
}
