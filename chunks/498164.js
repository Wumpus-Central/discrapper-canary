    ...
    [C.Etm.INVITE_BROWSER]: {
        ...
        async handler(e) {
            let {
                ...
                { invite: n } = await d.ZP.resolveInvite(t, 'Desktop Modal');
    ...
    [C.Etm.GUILD_TEMPLATE_BROWSER]: {
        ...
        async handler(e) {
            ...
            return (
                v.ZP.focus(),
                (0, l.ZDy)(async () => {
                    let { default: e } = await Promise.all([n.e('10778'), n.e('73923')]).then(n.bind(n, 112951));
                    return (t) => {
                        var n, l;
                        return (0, r.jsx)(
                            e,
                    ...
                    u.Z.resolveGiftCode(t, !0, !0)
                        .then((i) => {
                            ...
                            v.ZP.focus(),
                                ...
                                (0, l.ZDy)(async () => {
                                    let { default: e } = await Promise.all([n.e('92446'), n.e('41149')]).then(n.bind(n, 409858));
        ...
        handler(e) {
            ...
            switch ((v.ZP.focus(), t)) {
                case I.jE.USER_SETTINGS:
                    null != n && ((0, g.dL)(C.Z5c.SETTINGS(n.section, n.subsection)), T(n.fingerprint, (0, I.O)(t)));
                    break;
                case I.jE.CHANGELOG:
                    null != n && ((0, g.dL)(N.Z.formatPathWithQuery(C.Z5c.CHANGELOGS(n.date), n.query)), T(n.fingerprint, (0, I.O)(t)));
                    break;
                case I.jE.LIBRARY:
                    (0, g.dL)(C.Z5c.APPLICATION_LIBRARY), null != n && T(n.fingerprint, (0, I.O)(t));
                    break;
                case I.jE.STORE_HOME:
                    (0, g.dL)(C.Z5c.APPLICATION_STORE), null != n && T(n.fingerprint, (0, I.O)(t));
                    break;
                case I.jE.STORE_LISTING:
                    null != n && ((0, g.dL)(C.Z5c.APPLICATION_STORE_LISTING_SKU(n.skuId, n.slug)), T(n.fingerprint, (0, I.O)(t)));
                    break;
                ...
                case I.jE.FEATURES:
                case I.jE.SHOP:
                    (null == n ? void 0 : n.path) != null && ((0, g.dL)({ pathname: n.path }), T(n.fingerprint, (0, I.O)(t)));
            }
        }
    },
