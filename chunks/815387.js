...
let eR = Object.freeze({
        ...
        [eT.uaV.GUILD_DISCOVERY_DISQUALIFIED]: function (e) {
            ...
            return (0, r.jsx)(eu.FJ, {
                ...
                compact: n,
                onClick: () => {
                    null != o && I.Z.open(o, eT.pNK.ACCESS, eT.KsC.ACCESS_DISCOVERABLE);
                }
            });
        },
        ...
        [eT.uaV.STAGE_START]: function (e) {
            let { message: t, channel: n, compact: i } = e,
                ...
                o = (0, l.e7)([x.ZP], () => x.ZP.getActiveEventByChannel(n.id), [n.id]);
            return (0, r.jsxs)(r.Fragment, {
                children: [
                    (0, r.jsx)(eC.Z, {
                        message: t,
                    ...
                    null != o && o.name === t.content ? (0, r.jsx)(y.Z, { code: ''.concat(n.guild_id, '-').concat(o.id) }) : null
                ]
            });
        },
