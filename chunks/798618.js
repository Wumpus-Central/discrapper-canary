...
function p(e) {
    ...
    let { position: l, caretConfig: o } = r,
        p = (0, u.g)(l),
        { align: f, customOffset: m } = o,
        g =
            "custom" === f && void 0 !== m
                ? {
                      "--custom-caret-offset-x": ["top", "bottom"].includes(p) ? `${h(m)}px` : "0px",
                      "--custom-caret-offset-y": ["left", "right"].includes(p) ? `${h(m)}px` : "0px",
                  }
                : void 0,
        x = s()(d.caret, d[`caret--${p}`], d[`caret--${f}`], t);
    return (0, n.jsx)("div", { className: x, style: g, children: (0, n.jsx)(c, {}) });
}
