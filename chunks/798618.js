...
function h(e) {
    ...
    let { position: s, caretConfig: l } = n,
        h = (0, c.g)(s),
        { align: f, customOffset: p } = l,
        E =
            "custom" === f && void 0 !== p
                ? {
                      "--custom-caret-offset-x": ["top", "bottom"].includes(h) ? `${_(p)}px` : "0px",
                      "--custom-caret-offset-y": ["left", "right"].includes(h) ? `${_(p)}px` : "0px",
                  }
                : void 0,
        m = a()(d.caret, d[`caret--${h}`], d[`caret--${f}`], t);
