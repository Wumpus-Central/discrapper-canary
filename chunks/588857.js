...
function tK(e) {
    ...
    let {
        ...
        A = null != t ? (0, tD.Q)({ enabled: s, cameraUnavailable: a, hasPermission: d, channel: t }) : void 0;
    c.useEffect(() => () => p(), [s, p]);
    let E = tX(n),
        S = null == t || !d;
    return (0, r.jsx)(tt.Y, {
        ...
        renderPopout: (e) => {
            let { closePopout: t } = e;
            return (0, r.jsx)(tu.A, { onClose: E(t), appContext: em.BRT.OVERLAY });
        },
        align: "center",
        position: "top",
        animation: tt.Y.Animation.FADE,
...
function t0(e) {
    ...
    switch (!0) {
        ...
        case null != n:
            return (0, r.jsxs)(r.Fragment, {
                children: [
                    (0, r.jsx)("div", { className: tY.rK }),
                    (0, r.jsxs)("div", {
                        className: tY._C,
                        children: [
                            (0, r.jsx)(tw.Ay, { guild: n, size: tw.Ay.Sizes.SMOL, className: tY.$f }),
                            (0, r.jsx)(E.E, {
                                tag: "div",
...
function t1(e) {
    ...
    return (0, r.jsxs)("div", {
        ...
        children: [
            ...
            null != i &&
                (0, r.jsx)(E.E, { variant: "text-sm/medium", color: "text-muted", className: tY.HA, children: i }),
        ],
    });
}
function t2(e) {
...
var ni = n(459192),
    ...
    nT = n(172491),
    nC = n(912156),
    ny = (((i = {})[(i.SIZE_24 = 24)] = "SIZE_24"), (i[(i.SIZE_40 = 40)] = "SIZE_40"), i);
function nb(e, t) {
    switch (t) {
        case "user":
        case "groupDm":
            return 24 === e ? nv._3.SIZE_24 : nv._3.SIZE_40;
        case "guild":
...
let nw = c.memo(function (e) {
    let {
        ...
        c = t?.isMultiUserDM() ?? !1,
        h = n?.id,
        m = (0, y.bG)([nj.A], () => (null != h ? nj.A.getStatus(h) : null), [h]),
        g = (0, y.bG)([nj.A], () => null != h && nj.A.isMobileOnline(h), [h]);
    if (u || c)
        return (0, r.jsx)(nT.h, {
            channel: t ?? null,
            user: n,
    ...
    if (null == i) return (0, r.jsx)(t4.o, { size: nb(l, "default"), color: nu.A.colors.INTERACTIVE_ICON_DEFAULT });
    {
        if (null == t) return (0, r.jsx)(tw.Ay, { guild: i, size: nb(l, "guild"), active: !0, showTooltip: !1 });
        let e = 40 === l ? nC.Q.MEDIUM_40 : nC.Q.TINY_24;
        return (0, r.jsx)(nC.A, { channel: t, guild: i, size: e, isTyping: a });
    }
});
var nN = n(769015);
function n_(e) {
    ...
    return null == t
        ? n
        : (0, r.jsx)(nN.A, { game: t, size: nN.M.XSMALL, allowUnknownGameIcon: !0, unknownGameIconFallback: n });
}
var nR = n(429913),
    nO = n(34307),
    nM = n(499214),
...
function nP(e) {
    let { channel: t } = e,
        ...
        [l, a] = (0, y.yK)(
            ...
            () =>
                s && null != i && null != t
                    ? [nA.Ay.isChannelMuted(t.getGuildId(), t.id), nA.Ay.resolvedMessageNotifications(t)]
        ...
        m = l || a !== em.orn.ALL_MESSAGES ? nl.a : na.X;
    return s && null != t
        ? (0, r.jsx)(tt.Y, {
              targetElementRef: n,
              shouldShow: o,
    ...
    return nD(t)
        ? (0, r.jsxs)(r.Fragment, {
              children: [
                  ...
                  (0, r.jsx)(nz, { channel: t, pinsOpen: i, onTogglePinsPopout: s, onRequestClosePinsPopout: l }),
                  t.isMultiUserDM()
                      ? (0, r.jsx)(Y.m, {
...
function nV(e) {
    ...
    return null == t || t.isPrivate()
        ...
        : (0, r.jsxs)(r.Fragment, {
              children: [
                  (0, r.jsx)(nP, { channel: t }),
                  (0, r.jsx)(nz, { channel: t, pinsOpen: n, onTogglePinsPopout: i, onRequestClosePinsPopout: s }),
              ],
          });
}
function nG(e) {
                ...
                null == e
                    ...
                    : e.isDM() && null != t
                      ? t7.A.isFriend(t.id)
                          ...
                          : null
                      : (0, nx.ke)(e.type)
                        ? { tab: nE.x.MESSAGES, targetId: e.id }
                        : (0, nx.ay)(e.type)
                          ? { tab: nE.x.VOICE, targetId: e.id }
                          : null
            );
        }, [n, i]),
        b = c.useCallback(
            (e) => {
                nD(n) &&
                    ...
                    nm.A.call(n.id, e, !0, n.isDM() ? n.getRecipientId() : null));
            },
            [n],
        ),
        w = c.useCallback(() => {
            ...
            (0, r.jsxs)("div", {
                ...
                children: [
                    (0, r.jsx)("div", {
                        ...
                        children: (0, r.jsx)(n_, {
                            application: S,
                            fallback: (0, r.jsx)(nw, { channel: null, user: i, guild: s, size: ny.SIZE_24 }),
                        }),
                    }),
                    (0, r.jsxs)("div", {
                        className: nk.G1,
                        children: [
                            (function () {
                                ...
                                let e = (0, tg.gU)(n, s);
                                return null != e ? (0, r.jsx)(e, { className: nk.gr, size: "xs" }) : null;
                            })(),
                            null != j && null != T
                                ? (0, r.jsxs)(r.Fragment, {
                                      children: [
                                ...
                                children: [
                                    ...
                                    S?.name != null && "" !== S.name
                                        ? (0, r.jsx)(E.E, {
                                              ...
                                              color: "text-muted",
                                              children: eg.intl.formatToPlainString(nM.default.x1k3cO, {
                                                  gameName: S.name,
                                              }),
                                          })
                                        : null,
                ...
                children: [
                    ...
                    n?.id != null &&
                        (I
                            ...
                            : (0, r.jsx)(ni.u, {
                                  title: eg.intl.string(nM.default.ERApc4),
                                  body: eg.intl.string(nM.default.PBVXVW),
                                  children: (0, r.jsx)(ns.K, {
                                      icon: nh.P,
                                      "aria-label": eg.intl.string(nM.default.ERApc4),
                                      size: "sm",
                                      variant: "icon-only",
                                      onClick: (e) => {
                                          e.shiftKey
...
async function nq(e) {
    if (!nB.has(e)) {
        nB.add(e);
        try {
            let t = await nW.A.fetchChannel(e),
                n = (0, nx.UE)(t);
            nX.h.dispatch({ type: "CHANNEL_CREATE", channel: n });
            let i = n.getGuildId?.() ?? n.guild_id ?? null;
            if (null != i) return void nW.A.preload(i, n.id);
        } catch {}
    }
}
var nK = n(95231),
...
let nJ = c.memo(function (e) {
    let { channelId: t, selectedVoiceChannelId: i, iconVariant: s = "DEFAULT" } = e,
        ...
        h = (0, nU.r)(nu.A.colors.ICON_STATUS_ONLINE),
        g = (0, y.bG)([nZ.A], () => !!a && !!(nZ.A.isAnyoneElseSpeaking() || nZ.A.isCurrentUserSpeaking()), [a]),
        [p, f] = c.useState(!1),
    ...
    let T = (0, y.bG)([nY.A, eu.default], () => {
            if (null == j) return !1;
            let e = eu.default.getCurrentUser()?.id ?? null,
                t = nY.A.getTypingUsers(j.id);
        ...
        M = (() => {
            ...
            let e = (0, tg.gU)(j, v);
            return (e ??= t4.o), (0, r.jsx)(e, { size: "sm", color: nu.A.colors.INTERACTIVE_ICON_DEFAULT });
        })();
    return null == j
        ...
        : (0, r.jsx)(ni.u, {
              ...
              children: (0, r.jsxs)(A.D, {
                  className: nK.pc,
                  onClick: () => {
                      a && (0, nI.S$)({ minimized: !1 }),
                          (0, nI.D$)({
                              target: { kind: nI.bB.CHANNEL, channelId: t, guildId: v?.id ?? null, messageId: null },
                              source: nO.B.MANUAL,
                              widgetType: em.uss.TEXT_CHAT_V3,
                          });
                  },
                  ...
                  children: [
                      ...
                      (0, r.jsx)("div", {
                          className: nK.vT,
                          children: (0, r.jsx)(nF.A, { selected: d, hovered: p, unread: C }),
                      }),
                  ],
              }),
          });
...
function n8(e) {
    ...
    c.useEffect(() => {
        null == t || (!n.current.has(t) && a && (n.current.add(t), n$.A.fetchMessages({ channelId: t, limit: 50 })));
    }, [t, a]),
    c.useEffect(() => {
        if (null == o) return;
...
function n9(e) {
    ...
    return v
                                        ...
                                        children: [
                                            (0, r.jsx)(
                                                nJ,
                                                {
                                                    ...
                                                    iconVariant: nQ.CHANNEL_TYPE,
                                                },
                                                `tiv-${m}`,
                                            ),
                                            g.length > 0 ? (0, r.jsx)("hr", { className: n4.mF }) : null,
                                        ],
                                    })
                                  : null,
                              g.map((e) =>
                                  (0, r.jsx)(nJ, { channelId: e.channelId, selectedVoiceChannelId: m }, e.channelId),
                              ),
                          ],
                      }),
                  }),
        ...
        : (0, r.jsx)(V.g, { emptyText: eg.intl.string(nM.default["xpv/t5"]), icon: t4.o });
}
...
let ia = c.memo(function (e) {
    ...
    io = c.memo(function (e) {
        let {
                context: t = ir.x.DEFAULT,
                participants: i,
                locked: s,
                channel: a,
                width: o,
    ...
    id = c.memo(function (e) {
        ...
        c.useEffect(() => {
            (0, is.j_)({ locked: s, pinned: l.pinned, widget: l.type, isPreviewingInGame: !1 }, p);
        }, [s, l, p]);
        let f = c.useMemo(() => ({ opacity: l.opacity }), [l.opacity]),
            x = c.useMemo(() => m()({ [il.wb]: !0, [il.Vd]: !g, [il.R]: !p && s }), [g, p, s]);
        return 0 !== n.length || s
            ? null == a
                ? null
                : (0, r.jsx)("div", {
            ...
            : u
              ? (0, r.jsx)("div", {
                    ref: h,
                    children: (0, r.jsx)(V.g, { emptyText: eg.intl.string(eg.t.aTiM42), icon: ie.n, absolute: !0 }),
                })
              : null;
    }),
    iu = (e) => {
...
function ic(e) {
    let t = (0, y.bG)([P.Ay, D.A], () => D.A.getChannel(P.Ay.getVoiceChannelId())),
        ...
        { participantTileWidth: h, visibleParticipants: m } = (0, ii.i4)(a ? o : d, s, {
            tileWidth: 192,
            tileMinWidth: 120,
            tileMargin: 4,
            limit: 8,
...
function iT(e, t, n, i) {
    ...
    return (0, r.jsx)(ix.A, { index: s, notification: l, locked: a, pinned: o, transitionState: n, cleanUp: i }, e);
}
function iC(e) {
    return (0, r.jsx)("div", { className: iI.k, children: e });
}
let iy = c.memo(function (e) {
        let { locked: t, pinned: n, showEmpty: i = !0 } = e,
            s = (0, y.bG)(
                [iE.default, ip.A],
                () => {
                    if (ip.A.isNotificationDisabled(iS.KS.TextChat)) return iv;
                    let e = [],
                        i = 0;
                    for (let s of iE.default.getNotifications()) {
                        if (i > 4) break;
            ...
            l = c.useState(() => new iA.Fn(t))[0];
        return (c.useLayoutEffect(() => l.updateState(s, t)),
        c.useLayoutEffect(() => (l.initialize((0, eR.b)()), () => l.cleanUp()), [l]),
        0 !== s.length || t)
            ? (0, r.jsx)(iA.Gt.Provider, {
                  value: l,
                  children: (0, r.jsx)(ig.F, { items: s, renderItem: iT, getItemKey: ij, wrapChildren: iC }),
              })
            : i
              ? t
                  ? null
                  : (0, r.jsx)(V.g, { emptyText: eg.intl.string(eg.t.O1Nbjq), icon: na.X, absolute: !0 })
              : null;
    }),
    ib = {
        [em.uss.VIDEO]: {
            ...
            renderTitle: () => (0, r.jsx)(im.Pl, { children: eg.intl.string(eg.t.UPvOia) }),
            renderButtons: (e) =>
                (0, r.jsxs)(r.Fragment, {
                    children: [
                        (0, r.jsx)(im.CS, {
                        ...
                        (0, r.jsx)(im.O0, { id: e.id, pinned: e.pinned }),
                    ],
                }),
            resizeValidation: iu,
        },
        [em.uss.VOICE_V3]: {
            ...
            renderTitle: () => (0, r.jsx)(im.Pl, { children: eg.intl.string(eg.t.nFv3Gb) }),
            renderButtons: (e) =>
                (0, r.jsxs)(r.Fragment, {
                    children: [
                        (0, r.jsx)(im.CS, {
        ...
        [em.uss.CLICK_ZONE_DEBUG]: {
            ...
            renderTitle: () => (0, r.jsx)(im.Pl, { children: "Click Zone Tester" }),
            renderButtons: (e) =>
                (0, r.jsxs)(r.Fragment, {
                    children: [
                        (0, r.jsx)(im.CS, {
        ...
        [em.uss.PERFORMANCE_DEBUG]: {
            ...
            renderTitle: () => (0, r.jsx)(im.Pl, { children: "Overlay Performance" }),
            renderButtons: (e) => (0, r.jsx)(im.O0, { id: e.id, pinned: e.pinned }),
        },
        [em.uss.GO_LIVE]: {
            ...
            renderTitle: (e) => (0, r.jsx)(im.we, { widgetId: e.id, children: eg.intl.string(eg.t["386XRo"]) }),
            renderButtons: (e) =>
                (0, e_.dO)(e)
                    ? (0, r.jsxs)(r.Fragment, {
                          children: [
                              ...
                              (0, r.jsx)(im.GQ, { widgetId: e.id, showAllStreams: e.meta.showAllStreams ?? !0 }),
                              (0, r.jsx)(im.O0, { id: e.id, pinned: e.pinned }),
                          ],
                      })
                    : null,
        ...
        [em.uss.NOTIFICATIONS]: {
            renderWidget(e) {
                ...
                return (0, r.jsx)(iy, { pinned: i.pinned, locked: t, showEmpty: n });
            },
            renderTitle: () => (0, r.jsx)(im.Pl, { children: eg.intl.string(eg.t.gnKWdS) }),
            renderButtons: (e) =>
                (0, r.jsxs)(r.Fragment, {
                    children: [
                        (0, r.jsx)(im.CS, {
        ...
        [em.uss.ACTIVITY]: {
            ...
            renderTitle: () => (0, r.jsx)(im.Pl, { children: eg.intl.string(eg.t["6gwSFY"]) }),
            renderButtons: () => null,
        ...
        [em.uss.FRIENDS]: {
            ...
            renderTitle: () => (0, r.jsx)(im.Pl, { children: eg.intl.string(eg.t.TdEu5X) }),
            renderButtons: () => null,
            predicate: () => (0, d.NI)("WidgetRenderConfig").hasFriendList,
        },
        [em.uss.TEXT_CHAT_V3]: {
