...
class E extends i.Ay.Store {
    ...
    isFullServerPreview(e) {
        return f[e]?.type === d._.NEW_MEMBER;
    }
    isOptInEnabled(e) {
        let t = f[e];
    ...
    isViewingServerShop(e) {
        return null != e && f[e]?.type === d._.SERVER_SHOP;
    }
    ...
    getBackNavigationSection(e) {
        if (null == e) return c.BEX.ROLES;
        let t = f[e];
        if (null == t) return c.BEX.ROLES;
        switch (t.type) {
            case d._.ROLES:
            case d._.SERVER_SHOP:
                return t.returnToSection;
            case d._.NEW_MEMBER:
                return c.BEX.ONBOARDING;
            default:
                return c.BEX.ROLES;
        }
    }
...
let h = new E(s.h, {
    ...
    USER_GUILD_SETTINGS_CHANNEL_UPDATE_BULK: function (e) {
        ...
        let i = f[t];
        if (null == i || i.type !== d._.NEW_MEMBER) return !1;
