...
class f extends r.Ay.Store {
    ...
    getViewingRolesTimestamp(e) {
        return null != e ? h[e]?.timestamp : null;
    }
    getData(e) {
        return h[e];
    }
    isFullServerPreview(e) {
        return h[e]?.type === c._.NEW_MEMBER;
    }
    isOptInEnabled(e) {
        let t = h[e];
    ...
    isViewingServerShop(e) {
        return null != e && h[e]?.type === c._.SERVER_SHOP;
    }
...
let p = new f(s.h, {
    IMPERSONATE_UPDATE: function (e) {
        ...
        delete n.roles[u.default.castGuildIdAsEveryoneGuildRoleId(t)], (h[t] = { ...n, timestamp: Date.now() });
    },
    ...
    USER_GUILD_SETTINGS_CHANNEL_UPDATE_BULK: function (e) {
        ...
        return (
            u.default.keys(n).forEach((e) => {
                let t = n[e];
                i.Lt(t.flags ?? 0, _.vv.OPT_IN_ENABLED) ? s.add(e) : s.delete(e);
            }),
            (r.optInChannels = s),
            !0
        );
