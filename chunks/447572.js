...
function en() {
    ...
    let t = B.intl.string(F.default.x07mpp);
            ...
            (0, i.jsxs)("div", {
                ...
                children: [
                    ...
                    (0, i.jsx)(f.E, {
                        ...
                        color: "text-subtle",
                        children: B.intl.string(F.default.h5CwHI),
                    }),
                ],
            }),
            (0, i.jsx)("ol", {
...
function eu(e) {
    ...
    return (0, Y.x5)(e.size, t)
        ? null
        : B.intl.formatToPlainString(F.default.AzziHF, { size: (0, Y.ZJ)((0, Y.yr)(t)) });
}
            ...
            (0, i.jsx)(el.Y, {
                ...
                renderPopout: (e) => {
                    ...
                    return (0, i.jsx)(es.W, {
                        ...
                        "aria-label": B.intl.string(F.default.oq8F8s),
                        onClose: t,
                        onSelect: t,
                        children: (0, i.jsx)(er.rX, {
                            label: B.intl.string(F.default.MLg0S8),
                            children: ef
                                .map((e) => ({
                ...
                children: (e, n) => {
                    ...
                    return (0, i.jsx)(j.$, {
                        ...
                        size: "sm",
                        icon: eo.H,
                        text: B.intl.string(F.default["NHP2+t"]),
                        loading: t,
                        disabled: t,
                        "aria-haspopup": "menu",
                        "aria-expanded": l,
...
function eL(e) {
    let {
        ...
        N = l.useRef(null),
        { pending: I, refresh: E } = (0, eE.A)(C ?? null),
        { pending: S, connect: P } = (function (e) {
            ...
            return {
                ...
                connect: l.useCallback(
                    (t) => {
                        if (null == e) return;
                        let l = (0, eR.K9)(a.current, t.type);
                        async function s() {
        ...
        _ = (function (e) {
            ...
            for (let { connection: e, offer: s } of (t &&
                l.push({
                    id: "preview-refresh",
                    label: B.intl.string(F.default["8oRfMw"]),
                    kind: "refresh",
                    disabled: n,
                }),
            a))
                l.push(
                    "authorize" === s
                        ? {
                              ...
                              label: B.intl.formatToPlainString(F.default.JXACNA, { label: e.label }),
                              kind: "connect",
                        ...
                        : {
                              id: `preview-connect-${e.type}`,
                              label: B.intl.formatToPlainString(F.default.JMd7xW, { label: e.label }),
                              kind: "connect",
                              connectionType: e.type,
                              disabled: !0,
                          },
            ...
            canRefresh: null != C,
            refreshPending: I,
            offers: l.useMemo(() => (0, eR.Xl)(R), [R]),
            connectPending: S,
        }),
        T = l.useMemo(() => new Map(R.map((e) => [e.type, e])), [R]),
        M = null != m && o,
        V = r && null != p,
        z = M || null != d || V || null != h || null != g || null != f,
        L = eP.p5 && null != a,
        G = eP.p5;
    return null != j || null != k || z || G || r
        ? (0, i.jsx)(el.Y, {
              targetElementRef: N,
              position: "bottom",
              align: "right",
                                    ...
                                    children: [
                                        null != j
                                            ? (0, i.jsx)(er.Dr, {
                                                  ...
                                                  label: B.intl.string(F.default.xKexN1),
                                                  disabled: v,
                                                  action: j,
                                              })
                                            : null,
                                        null != k
                                            ? (0, i.jsx)(er.Dr, {
                                                  ...
                                                  label: B.intl.string(F.default.Ea0Wrr),
                                                  action: k,
                                              })
                                            : null,
                                    ],
                              ...
                              ? (0, i.jsxs)(er.rX, {
                                    children: [
                                        M
                                            ? (0, i.jsx)(er.Dr, {
                                                  id: "remix",
                                                  label: B.intl.string(F.default.vPI794),
                                                  action: m,
                                              })
                                            : null,
                                        null != d
                                            ? (0, i.jsx)(er.Dr, {
                                                  id: "export",
                                                  label: B.intl.string(F.default["7iamDC"]),
                                                  action: d,
                                              })
                                            : null,
                                        V
                                            ? (0, i.jsx)(er.Dr, {
                                                  id: "import",
                                                  label: B.intl.string(F.default.lf8HqE),
                                                  action: p,
                                              })
                                            : null,
                                        null != h
                                            ? (0, i.jsx)(er.Dr, {
                                                  id: "connect-tool",
                                                  label: B.intl.string(F.default["3qelzD"]),
                                                  action: h,
                                              })
                                            : null,
                                        null != g
                                            ? (0, i.jsx)(er.Dr, {
                                                  id: "version-history",
                                                  label: B.intl.string(F.default.jAWwzi),
                                                  action: g,
                                              })
                                            : null,
                                        null != f
                                            ? (0, i.jsx)(er.Dr, {
                                                  id: "restore-points",
                                                  label: B.intl.string(F.default.FRjicO),
                                                  action: f,
                                              })
                                            : null,
                                    ],
                          ...
                          G
                              ? (0, i.jsxs)(er.rX, {
                                    children: [
                                        ...
                                        (0, i.jsx)(er.Dr, {
                                            id: "copy-project-id",
                                            label: B.intl.string(F.default.b4TqpT),
                                            icon: eN.L,
                          ...
                          r
                              ? (0, i.jsxs)(er.rX, {
                                    children: [
                                        (0, i.jsx)(er.Dr, {
                                            id: "settings",
                                            label: B.intl.string(F.default["xhcY+n"]),
                                            icon: w.SettingsIcon,
                                        ...
                                        (0, i.jsx)(er.Dr, {
                                            ...
                                            action: () => {
                                                (0, u.A)({
                                                    title: B.intl.formatToPlainString(F.default.ZokHVz, { name: n }),
                                                    subtitle: B.intl.string(F.default.NmF939),
                                                    confirmText: B.intl.string(B.t.oyYWHE),
                                                    variant: "critical",
                                                    onConfirm: async () => {
                                                        if (!(await (0, O.xx)(t)).ok)
                                                            throw Error(B.intl.string(F.default.tqKZCi));
                                                    },
                                                });
                                            },
                                        }),
        ...
        children: (0, i.jsxs)("div", {
            ...
            children: [
                ...
                null != a
                    ...
                    : null,
                (0, i.jsx)(D.A.Title, { className: eG.Qw, wrapperClassName: eG.DD, children: t }),
            ],
        }),
    });
}
var eB = n(73432),
    ...
    eX = n(107148);
function eU() {
    return (0, c.bG)([eO.default], () => eO.default.getCurrentUser()?.isStaff() ?? !1)
        ? (0, i.jsx)("div", {
              className: eX.l,
              children: (0, i.jsx)(eY.w, {
                  type: "info",
                  iconAlign: "center",
                  children: B.intl.format(eH.default["4BsHmp"], {}),
              }),
          })
        : null;
}
...
function eQ(e) {
    let { reason: t, transitionState: n, onClose: a } = e,
        l = "permissions" === t;
    return (0, i.jsx)(eZ.Modal, {
        transitionState: n,
        onClose: a,
        title: B.intl.string(l ? F.default.Rtlv25 : F.default["+UouPe"]),
        subtitle: B.intl.string(l ? F.default["nDQB/b"] : F.default["E0QD++"]),
        size: "sm",
        actions: [{ text: B.intl.string(l ? B.t.BddRzS : F.default["+Zh4FA"]), variant: "primary", onClick: a }],
    });
}
function eJ(e) {
    (0, eW.openModal)((t) => (0, i.jsx)(eQ, { ...t, reason: e }));
}
var e0 = n(480007),
    e2 = n(584936),
    e1 = n(899154),
...
function tn(e) {
    let t,
                                ...
                                (0, y.P0)(
                                    (0, x.o)(
                                        409 === (n = e instanceof Z._v ? e.status : null)
                                            ...
                                            : 404 === n
                                              ? B.intl.string(F.default.wCq2jC)
                                              : B.intl.string(F.default.G2GqyP),
                                        b.Ck.FAILURE,
                                    ),
                                ));
                        })
                        ...
                        (e) => {
                            ...
                            null != a
                                ...
                                : (0, u.A)({
                                      ...
                                      confirmText: B.intl.string(F.default.pgFuyr),
                                      variant: "critical",
                                      onConfirm: async () => {
                                          (0, T.pX)(e6.BVt.CHANNEL(c, eM.VV.VIBEGRATIONS, t));
                                          try {
        ...
        j = o.preview_application_id ?? o.application_id,
        { data: v } = (0, P.YY)(j),
        w =
            null == o.updated_at
                ? null
                : B.intl.formatToPlainString(F.default.oMDaqr, { time: d()(o.updated_at).fromNow() });
    return (0, i.jsxs)("div", {
        className: e5.OY,
        children: [
            (0, i.jsx)(eK.Ay, { projectId: o.id }),
            (0, i.jsxs)(g.D, {
                className: e5.W6,
                onClick: p,
                children: [
                    (0, i.jsx)("img", {
                        alt: "",
                        src: G.Ay.getApplicationIconURL({ id: j, icon: v?.icon, size: 40 }),
                        className: e5.VJ,
                    }),
                    (0, i.jsxs)("div", {
                        className: e5.MM,
...
function ta(e) {
    ...
    let q = (0, c.bG)([$.Ay], () => (null == G ? null : $.Ay.getIntegrationStatus(G)), [G]),
        ...
        eC = l.useCallback(() => {
            if (null != G) {
                if (eb) return void (0, e9.PS)(G);
                (I(!1), g(!1), A(!1), m(!0), (0, e9.nI)(G));
            }
        }, [G, eb]),
        eA = l.useCallback(() => {
            I((e) => !e && (m(!0), g(!1), A(!1), !0));
        ...
        eR = (0, _.A)(t?.preview_application_id ?? null, e7.sd),
        eD = (0, e7.x1)(eR) && eR.data.proxyTicketRefreshing,
        eT = l.useCallback(() => {
        ...
        eO = l.useCallback(async () => {
            ...
            ((K.current = e), L(null));
            try {
                await (0, O.U1)(G, e.signal);
            } catch {
            } finally {
                e.signal.aborted || K.current !== e || Y.current !== G || L(G);
            }
        }, [G]);
    l.useEffect(
        () => (
    ...
    let eH = q?.integration_installed === !0 && t?.guild_id != null ? t.guild_id : r,
        eX = l.useCallback(async () => {
            null == t ||
                (t.guild_id === eH && t.preview_guild_id === eH) ||
                (await (0, O.M7)(t.id, { guild_id: eH, preview_guild_id: eH }));
        }, [eH, t]),
        ...
        eZ = ed
            ...
            : ee && null == q
              ...
              : void 0;
    l.useEffect(() => {
        null == t && a && (0, T.pX)(e6.BVt.CHANNEL(r, eM.VV.VIBEGRATIONS));
    }, [r, t, a]);
    let eQ = l.useCallback((e) => {
        ...
        tn = l.useCallback(() => {
            if (null == t) return;
            if (!et) return void eJ(e$.NO_PREVIEW);
            if (ed) return void eJ(e$.PERMISSIONS);
                    ...
                    : (0, i.jsxs)("div", {
                          ...
                          children: [
                              ...
                              (0, $.PV)(t)
                                  ? (0, i.jsx)(D.A.Icon, {
                                        icon: w.SettingsIcon,
                                        tooltip: B.intl.string(F.default["xhcY+n"]),
                                        "aria-label": B.intl.string(F.default["xhcY+n"]),
                              ...
                              (0, i.jsx)(eL, {
                                  ...
                                  isOwner: (0, $.PV)(t),
                                  canRemix: (0, $.H_)(t),
                                  onRefresh: (0, e7.x1)(eR) ? eT : void 0,
                                  isRefreshing: eD,
                                  onClose: eV,
                                  onExport: ez,
                                  onImport: eG.open,
                              ...
                              eg
                                  ? null
                                  : (0, i.jsx)(D.A.Icon, { icon: e4, tooltip: ef, "aria-label": ef, onClick: ey }),
                          ],
                      }),
        });
    return (0, i.jsxs)("div", {
                                  ...
                                  (0, i.jsxs)("div", {
                                      ...
                                      children: [
                                          (0, i.jsx)(k.D, {
                                              ...
                                              children: B.intl.string(F.default.F2dRba),
                                          }),
                                          (0, i.jsx)(f.E, {
                                              variant: "text-md/normal",
                                              color: "text-muted",
                                              children: B.intl.string(F.default.GnEJ3o),
                                          }),
                                          (0, i.jsx)(j.$, {
                                              variant: "secondary",
                                              size: "sm",
                                              text: B.intl.string(F.default["42EdIV"]),
                                              onClick: () => (0, O.hF)(r),
                                          }),
                                      ],
                                  }),
...
function ti(e) {
    ...
    let T = l.useMemo(
        ...
        M = B.intl.string(F.default.TU9IGR),
        V = [
            B.intl.string(F.default["E+Q26x"]),
            B.intl.string(F.default["06/jqP"]),
            B.intl.string(F.default["3gSfUa"]),
        ],
        z = [
            {
                id: "feature-showcase",
                name: B.intl.string(F.default.BLDsiz),
                description: B.intl.string(F.default.jK1PL5),
            },
            {
        ...
        G = B.intl.string(F.default["/SUK82"]),
        H = l.useCallback(
            (e) => {
                "Enter" !== e.key || e.shiftKey || e.nativeEvent.isComposing || (e.preventDefault(), u || w());
            },
            [u, w],
        );
    return (0, i.jsxs)("div", {
        className: r()(e5.nj, e5.a0),
        children: [
            (0, i.jsx)(eF, { title: B.intl.string(F.default.Xmvb23) }),
            (0, i.jsxs)("div", {
                className: e5.Yo,
                children: [
                    (0, i.jsxs)("main", {
                            ...
                            (0, i.jsx)(C.Ip, {
                                ...
                                children: (0, i.jsx)("div", {
                                    ...
                                    children: (0, i.jsxs)("section", {
                                        className: r()(e5.Qs, e5.Ix),
                                        children: [
                                            (0, i.jsx)(eU, {}),
                                            (0, i.jsx)(k.D, {
                                                variant: "heading-xl/semibold",
                                                children: B.intl.string(F.default["2tYpRK"]),
                                            }),
                                            (0, i.jsxs)("section", {
                                                className: e5.WI,
                                                "aria-label": L,
                                                    ...
                                                    (0, i.jsxs)("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            (0, i.jsx)(f.E, {
                                                                variant: "text-sm/normal",
                                                                color: "text-subtle",
                                                                children: B.intl.string(F.default.BTNdyX),
                                                            }),
                                                        ],
                                                    }),
                                                    (0, i.jsx)("ol", {
                                                    ...
                                                    (0, i.jsxs)("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            (0, i.jsx)(f.E, {
                                                                variant: "text-sm/normal",
                                                                color: "text-subtle",
                                                                children: B.intl.string(F.default["+aBXyx"]),
                                                            }),
                                                        ],
                                                    }),
                                                    (0, i.jsx)("ol", {
                                            ...
                                            children: [
                                                (0, i.jsx)("div", {
                                                    ...
                                                    children: (0, i.jsx)(N.l, {
                                                        ...
                                                        label: B.intl.string(F.default.MLg0S8),
                                                        hideLabel: !0,
                                                        placeholder: B.intl.string(F.default.MLg0S8),
                                                        options: [
                                                            {
                                                                label: B.intl.string(F.default.MLg0S8),
                                                                options: ef.map((e) => ({
                    ...
                    (0, i.jsxs)("aside", {
                        className: e5.pA,
                        "aria-label": B.intl.string(F.default.Bo5fE3),
                        children: [
                            (0, i.jsxs)("div", {
                                className: e5.IR,
                                children: [
                                    (0, i.jsxs)("div", {
                                        ...
                                        children: [
                                            (0, i.jsx)(f.E, {
                                                variant: "text-md/medium",
                                                color: "text-strong",
                                                children: B.intl.string(F.default.Bo5fE3),
                                            }),
                                            (0, i.jsx)(f.E, {
                                                variant: "text-sm/normal",
                                                color: "text-subtle",
                                                children: B.intl.string(F.default.YnAFtT),
                                            }),
                                        ],
                                    }),
                            ...
                            (0, i.jsxs)(C.Ip, {
                                ...
                                children: [
                                    (null == a || "loading" === a.type) && 0 === T.length
                                        ? (0, i.jsx)("div", { className: e5.E8, children: (0, i.jsx)(I.y, {}) })
                                          ...
                                          ? (0, i.jsxs)("div", {
                                                ...
                                                children: [
                                                    (0, i.jsx)(f.E, {
                                                        ...
                                                        color: "text-muted",
                                                        className: e5.JS,
                                                        children: B.intl.string(F.default["IN/HRP"]),
                                                    }),
                                                    (0, i.jsx)(j.$, {
                                                        variant: "secondary",
                                                        size: "sm",
                                                  ...
                                                  children: (0, i.jsxs)("div", {
                                                      ...
                                                      children: [
                                                          ...
                                                          (0, i.jsx)(f.E, {
                                                              ...
                                                              color: "text-subtle",
                                                              className: e5.sI,
                                                              children: B.intl.string(F.default["vqy+in"]),
                                                          }),
                                                      ],
                                                  }),
                                              })
                                                  ...
                                                  (0, i.jsxs)("div", {
                                                      ...
                                                      children: [
                                                          (0, i.jsx)(f.E, {
                                                              variant: "text-md/medium",
                                                              color: "text-strong",
                                                              children: B.intl.string(F.default.jrCnUc),
                                                          }),
                                                          (0, i.jsx)(f.E, {
                                                              variant: "text-sm/normal",
                                                              color: "text-subtle",
                                                              children: B.intl.string(F.default["1KEhDu"]),
                                                          }),
                                                      ],
                                                  }),
                                                  (0, i.jsx)("div", {
...
function tl(e) {
    let t,
        ...
        o = (0, c.yK)([$.Ay], () => $.Ay.getSharedProjects(n), [n]),
        d = (0, c.yK)([V.Ay], () => V.Ay.getSelfMember(n)?.roles ?? [], [n]),
        u = (0, c.bG)(
            [z.A, L.A],
            () => {
    ...
    let E = l.useCallback((e) => {
        ...
        S = l.useCallback(
            async (e) => {
                let t = (e ?? p).trim(),
                    a = Q({ idea: t, installScope: w, submitting: g });
                if ("idea" !== a && "submitting" !== a) {
                    if (null == w) return void A(B.intl.string(F.default.jQ3nQB));
                    ...
                    try {
                        ...
                        ((0, Z.Hc)(e),
                            (0, Z.r2)(e, N ?? X.Cl),
                            (0, Z.dv)(e, t),
                            (0, T.pX)(e6.BVt.CHANNEL(n, eM.VV.VIBEGRATIONS, e)),
                            m(""),
                            I(null));
                    } catch (e) {
                        v((0, H.Xd)(e));
            ...
            async (e, t) => {
                ...
                try {
                    ((i = await (0, O.gA)({ guild_id: n, install_scope: t })),
                        (0, Z.Hc)(i),
                        (0, Z.r2)(i, N ?? X.Cl),
                        await ec(i, e, B.intl.string(F.default.KjEtrZ)),
                        (0, T.pX)(e6.BVt.CHANNEL(n, eM.VV.VIBEGRATIONS, i)),
                        I(null));
                } catch {
        ...
        M = l.useCallback(() => {
            (0, T.pX)(e6.BVt.CHANNEL(n, eM.VV.VIBEGRATIONS));
        }, [n]),
        G = l.useCallback((e) => {
            (m(e), v(null));
        }, []),
        ...
        U = (0, c.bG)([$.Ay], () => $.Ay.hasFetchedGuildProjects(n), [n]);
    return null != h
        ? (0, i.jsx)(ta, { project: Y, projectsLoaded: U, onBack: M, guildId: n }, h)
        : (0, i.jsx)(ti, {
              projects: s,
              sharedProjects: o,
              fetchState: r,
              ...
              submitting: g,
              createError: j,
              createDisabled: "idea" === (t = Q({ idea: p, installScope: w, submitting: g })) || "submitting" === t,
              onSelectProject: D,
              onIdeaChange: G,
              onCreate: S,
