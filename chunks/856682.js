...
function g(e) {
    let { className: t, paperColor: l, paperColorAlt: n, axleColor: a } = e;
    return (0, i.jsxs)('svg', {
        className: t,
        width: '365',
        height: '59',
...
function f(e) {
    let { paperColor: t, paperColorAlt: l, className: n } = e;
    return (0, i.jsxs)('svg', {
        className: s()(x.bottom, n),
        width: '365',
        height: '101',
        viewBox: '0 0 365 101',
        fill: 'none',
...
function v(e) {
    let { children: t, fullHeight: l = !1 } = e,
        ...
        H = (0, d.Fg)(),
        b = H === u.BR.LIGHT ? '#FFFFFF' : '#1C1D23',
        w = H === u.BR.LIGHT ? '#EBEDEF' : '#26272F',
        S = H === u.BR.LIGHT ? '#CCCCCC' : '#1A1A1E';
    return (0, i.jsx)('div', {
