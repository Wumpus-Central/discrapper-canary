...
function x(e) {
    let { className: t, paperColor: l, paperColorAlt: r, axleColor: i } = e;
    return (0, n.jsxs)('svg', {
        className: t,
        width: '365',
        height: '59',
...
function g(e) {
    let { paperColor: t, paperColorAlt: l, className: r } = e;
    return (0, n.jsxs)('svg', {
...
function p(e) {
    var t, l;
    let { children: i, fullHeight: p = !1 } = e,
        [j, v] = r.useState(!1),
        { height: C, ref: b } = (0, c.Z)(),
        { height: y, ref: N } = (0, c.Z)(),
        O = p ? y : 59 + (null != C ? C : 100) + 101,
        w = (0, o.q_F)({
            from: { height: 0 },
            to: { height: O },
            config: m,
        ...
        T = S === u.BR.LIGHT ? '#EBEDEF' : '#26272F',
        H = S === u.BR.LIGHT ? '#CCCCCC' : '#1A1A1E';
    return (0, n.jsx)('div', {
