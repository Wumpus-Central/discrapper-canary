...
function h(e) {
    let { className: t, paperColor: r, paperColorAlt: l, axleColor: i } = e;
    return (0, n.jsxs)('svg', {
        className: t,
        width: '365',
        height: '59',
...
function g(e) {
    let { paperColor: t, paperColorAlt: r, className: l } = e;
    return (0, n.jsxs)('svg', {
...
function x(e) {
    var t, r;
    let { children: i, fullHeight: x = !1 } = e,
        [j, b] = l.useState(!1),
        { height: y, ref: v } = (0, c.Z)(),
        { height: O, ref: C } = (0, c.Z)(),
        w = x ? O : 59 + (null != y ? y : 100) + 101,
        N = (0, o.q_F)({
            from: { height: 0 },
            to: { height: w },
            config: m,
        ...
        T = S === d.BR.LIGHT ? '#EBEDEF' : '#26272F',
        D = S === d.BR.LIGHT ? '#CCCCCC' : '#1A1A1E';
    return (0, n.jsx)('div', {
