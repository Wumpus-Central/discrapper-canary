...
function j(e) {
    var t;
    let { user: n, currentUser: a, activity: x, profileGuildId: j, className: M, onClose: U } = e,
        G = (0, p.Dt)(),
        B = (0, p.Dt)(),
        Z = i.useRef(null),
        { themeType: F } = (0, I.z)(),
                                ...
                                i.Fragment,
                                {
                                    children: [
                                        (0, r.jsx)(s.P3F, {
                                            ...
                                            onClick: (e) => {
                                                (e.stopPropagation(), $({ action: 'OPEN_SPOTIFY_ARTIST' }), (0, h.d$)(x, n.id, t));
                                            },
                                            children: e
                                        }),
                                        t < a.length - 1 ? ', ' : ''
            ...
            children: (0, r.jsx)(O.Z, {
                ...
                children: () =>
                    (0, r.jsx)(v.Z, {
                        ...
                        onAction: $,
                        onShowToolbar: () => $({ action: 'HOVER_ACTIVITY_CARD' }),
                                    ...
                                    children: (0, r.jsxs)('div', {
                                        ...
                                        children: [
                                            (0, r.jsx)(f.E, {
                                                ...
                                                onClick: (e) => {
                                                    (e.stopPropagation(), $({ action: 'OPEN_SPOTIFY_ALBUM' }), (0, h.Z5)(x, n.id));
                                                }
                                            }),
                                            (0, r.jsxs)('div', {
                                                className: L.details,
                                                    ...
                                                    (0, r.jsxs)('div', {
                                                        children: [
                                                            (0, r.jsx)(C.f, {
                                                                ...
                                                                text: x.details,
                                                                onClick: () => {
                                                                    ($({ action: 'OPEN_SPOTIFY_TRACK' }), (0, h.aG)(x));
                                                                },
                                                                id: G
                                                            }),
                                                            Q()
