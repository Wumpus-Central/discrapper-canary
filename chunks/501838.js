l.d(e, { mn: () => a, px: () => h, qx: () => g, rY: () => I, tR: () => c, w: () => s }), l(321073);
var i = l(17928),
    n = l(517164),
    r = l(20805),
    u = l(328153),
...
function a(t) {
    let { userIds: e } = t;
    return (0, i.yK)([n.A, p.A], () => {
        let t = [];
        for (let l of e)
            for (let e of n.A.getUserOutbox(l)?.entries ?? [])
                if (null != e && (0, r.zD)(e)) {
                    let l = p.A.getApplicationIdFromDetectableId(e.extra.application_id);
                    null != l && t.push(l);
                }
        return t;
    }, [e]);
            ...
            for (let l of e)
                for (let e of f.A.getActivities(l))
                    if (null != e.application_id) {
                        let l = p.A.getApplicationIdFromDetectableId(e.application_id);
                        null != l && t.push(l);
                    }
            return t;
        }, [e]),
