...
function m(e) {
    var t, n, a;
    let { user: c, currentUser: s, displayProfile: d, guildId: u, channelId: m, items: b, initialSection: g, initialSubsection: y, onClose: _ } = e,
        { trackUserProfileAction: O } = (0, i.KZ)(),
        [{ section: h, subsection: j, text: x }, v] = o.useState(
            ((n = (function (e) {
