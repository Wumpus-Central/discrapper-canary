...
function w() {
    let e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
        ...
        })(N, (e) => l.A.getUserAffinity(e)?.dmProbability, e);
    (v = t), (C = n);
}
function M() {
        ...
        for (let e of _.A.getFriendIDs()) {
            ...
            if (_.A.isFriend(e) && null != n && n.dmProbability > 0 && null != t) {
                ...
                (function (e) {
                    ...
                    return !1;
                })(n) && (N.push(e), (R[e] = { friendsSince: n }));
            }
        }
        N.sort((e, t) => l.A.compareByDmProbability(e, t)), w();
    }
}
function P() {
    (N.length = 0), (v = new Set()), (C = new Set()), (R = {});
}
function x() {
    let e = L();
...
function U(e) {
    ...
    (b = s),
        ...
        N.sort((e, t) => l.A.compareByDmProbability(e, t)),
        w(!0);
}
class G extends s.Ay.PersistedStore {
    ...
    getNextRecipientUserIDForNotification() {
        if (!this.isNotificationCooldownActive())
            return Array.from(v).find((e) => null == y.messageGiftIntentLastShownMap[e]);
    }
    ...
    canShowFriendsTabBadge() {
        return Array.from(C).some((e) => !y.lastShownFriendsListGiftIntents.includes(e));
    }
...
let F = new G(a.h, {
    ...
    FRIENDS_LIST_GIFT_INTENTS_SHOWN: function () {
        y.lastShownFriendsListGiftIntents = Array.from(N);
    },
