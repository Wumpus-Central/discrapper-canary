...
let f = () => {
    ...
    return [p.Z5c.FRIENDS, e ? p.Z5c.MESSAGE_REQUESTS : null, c.Z.hasLibraryApplication() && !o.bm.getSetting() ? p.Z5c.APPLICATION_LIBRARY : null, p.Z5c.APPLICATION_STORE, p.Z5c.COLLECTIBLES_SHOP, o.Ex.getSetting() ? p.Z5c.FAMILY_CENTER : null].filter(g.lm);
};
function b() {
    ...
    null == t
        ? (function (e) {
              ...
              if (f().includes(o)) {
                  ...
                  o === p.Z5c.APPLICATION_STORE && null != e ? (0, m.z)(e) : (0, m.z)(o);
              } else (g = p.ME), (0, m.K)(g, o);
          })(e)
        : (function (e, t) {
              var n, s, l;
