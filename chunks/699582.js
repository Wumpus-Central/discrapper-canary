...
function R(e) {
    ...
    (t = (e = m.call(n, "-")).match(i.expExtSequences)) &&
        ...
        c.call(A.tags, e) && (e = A.tags[e]),
        (n = e.split("-"));
    for (var r = 1, o = n.length; r < o; r++)
        c.call(A.subtags, n[r])
            ? (n[r] = A.subtags[n[r]])
            : c.call(A.extLang, n[r]) &&
              ((n[r] = A.extLang[n[r]][0]), 1 === r && A.extLang[n[1]][1] === n[0] && ((n = _.call(n, r++)), (o -= 1)));
    return m.call(n, "-");
}
function P() {
    return r;
...
function eo(e, t) {
    ...
    return (
        !0 === n["[[hour12]]"] && ((m = ed(f, _, "dayPeriods", h ? "pm" : "am")), (u = u.replace("{ampm}", m))),
        r.exp.test(r.input),
        u
    );
}
...
function el(e, t) {
    ...
    void 0 === r && (r = t),
        v || (V(a.NumberFormat.prototype), (v = !0)),
        e.date && !I && (Q(a.DateTimeFormat.prototype), (I = !0));
}
function ec(e) {
