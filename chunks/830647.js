...
function ef(e) {
    ...
    let {
        ...
        { primaryIconAsset: S, primaryIconLabel: N } = i.useMemo(() => (0, P.Cv)(s, s.applicationId), [s]),
        {
            priceComponent: b,
            extendedHeight: y,
            displayPrice: T,
    ...
    return (0, l.jsxs)("div", {
        ...
        children: [
            ...
            (0, l.jsxs)(c.B, {
                ...
                justify: "center",
                children: [
                    (0, l.jsx)(h.A, { className: eS.Ku, size: "xs" }),
            ...
            let {
                ...
                _ = i.useCallback(() => {
                    ...
                    (0, y.Y5)(e),
                        ...
                        setTimeout(() => (0, D.XA)(e_.jM.WIDGET_ADDED), 700);
                }, [x, n, t, r]);
            return a && !c && g && null != m
                ? !h && f
                    ? (0, l.jsx)(eO, {
...
function eM(e) {
    let { className: t, userId: n, applicationId: s, channel: r, onClose: a } = e,
        ...
        _ = (0, U.F)(d ? "vc_purchase_recommendations" : "vc_gift_recommendations", { applicationId: s });
    return (0, l.jsxs)(ey, {
        className: t,
        "aria-labelledby": eN,
        children: [
