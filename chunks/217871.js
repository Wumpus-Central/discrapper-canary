...
let I = 1000,
    ...
    S = i.memo(function (e) {
        let { channelId: t, width: n } = e,
            ...
            o = (0, l.e7)([E.ZP], () => E.ZP.getMostRecentMessageCombo(t), [t]),
            [u, f] = i.useState(!1);
        i.useEffect(() => {
            if (null == o ? void 0 : o.displayed) return;
            (f(!1),
                setImmediate(() => {
                    f((null != o ? (0, b.Eo)(o.combo) : 0) > 0);
                }));
            let e = setTimeout(() => {
                (f(!1), null != o && (0, m.ew)(o));
            }, T);
    ...
    A = i.memo(function (e) {
        let { value: t, multiplier: n } = e,
            { color: a, square: s, flair: l } = i.useMemo(() => (0, b.yz)(n), [n]),
            u = (0, f.Lq)(a);
    ...
    N = i.memo(function (e) {
        let { channelId: t } = e,
            ...
            a = (0, l.e7)([p.Z], () => p.Z.isTyping(t, n), [t, n]),
            o = (0, l.e7)([g.Z], () => g.Z.isEnabled()),
        ...
        let N = (0, c.q_F)({
            ...
            w = i.useRef(C);
        i.useEffect(() => {
            (C.multiplier > 1 || C.value > 0) && (w.current = C);
        }, [C]);
        let { multiplier: R, value: P } = i.useMemo(
            () => ({
                value: T ? C.value : w.current.value,
                multiplier: T ? C.multiplier : w.current.multiplier
            }),
            [T, C, w]
        );
        return (0, r.jsxs)(r.Fragment, {
