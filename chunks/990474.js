...
function y(e, t, n, i, r) {
    ...
    let s = () => {
        ...
        if (null == s) return;
        let { command: a, application: o } = c.EW({ channel: s, type: "channel" }, n, r);
        if (null != a && a.untranslatedName === t) {
            ...
            u.Gf({ channelId: e, command: null, section: null }),
                u.Gf({ channelId: e, command: a, section: t, location: i });
        }
    };
...
function N(e) {
    let { node: t, stateKey: n, children: a } = e,
        o = (0, s.bG)([p.A, g.A], () => p.A.getChannel(t.channelId ?? g.A.getChannelId()), [t.channelId]),
    ...
    return N
        ? (0, i.jsxs)(_.A, { role: "link", onClick: v, children: ["/", a] }, n)
        : (0, i.jsxs)("span", { children: ["/", a] });
}
function v(e) {
    let { commandId: t, commandName: n, commandDescription: r, applicationId: a, onClick: u } = e,
...
function C(e) {
    return { react: (e, t, n) => (0, i.jsx)(N, { node: e, stateKey: n.key, children: t(e.content, n) }) };
}
