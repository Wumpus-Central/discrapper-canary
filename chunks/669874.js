...
class s extends o.PureComponent {
    ...
    componentDidCatch(e, t) {
        let {
            ...
            p = { loadId: n, selectedSkuId: o, selectedPlanId: r, isGift: s, purchaseType: _, locationStack: d },
            h = {
                tags: {
                    app_context: "billing",
                    checkout_error: "true",
        ...
        i.A.captureException(e, h), u.error("Checkout error occurred:", { error: e, additionalErrorContext: p });
