...
function _(e) {
    null != e &&
        "" !== e &&
        ((e = d(e)).endsWith("/") || (e += "/"), c.push(e), (0, l.isLinux)() && c.push("/var" + e));
}
function h(e) {
    e = d(e);
    let t = !1;
...
async function f() {
    if (null != i) return i;
    try {
        await u.Ay.ensureModule("discord_game_utils"), (i = await u.Ay.requireModule("discord_game_utils"));
    } catch (e) {
