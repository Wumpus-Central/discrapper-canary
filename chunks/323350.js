...
function h(e, t) {
    ...
    return E(e, { mode: n, start: s, end: a, ignoreTrailingEmptyNodes: r, preventEmojiSurrogates: i });
}
function E(e, t) {
    let {
            mode: n,
...
function m(e, t) {
    let { mode: n, start: r, allowBlockQuotePrefix: h = !1, preventEmojiSurrogates: m = !1 } = t ?? {};
    if (p.l5.isText(e))
        return (function (e, t) {
            let { start: n, end: r } = t ?? {};
            return (
