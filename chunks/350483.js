...
let b = s().throttle(function (e, t) {
    var i, s;
    let l,
        { channelPredicate: m = () => !0, guildPredicate: f = () => !0, guildFeaturePredicate: b = () => !1, ensureChatIsVisible: N = () => !1, withVoiceChannels: x = !1 } = t,
    ...
    for (; null != E && '' !== E; ) {
        if (((l = S[v]), f(E)))
            for (; null != l && '' !== l; ) {
                ...
                } else if ('object' == typeof l && b(l.resourceId, l.type))
                    return (
