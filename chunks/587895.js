...
let A = new g(i.h, {
    LOGOUT: function () {
        o.clear(), l.clear(), u.clear(), d.clear(), c.clear();
    },
    ...
    USER_PROFILE_FETCH_SUCCESS: function (e) {
        ...
        n.bot && null != r && p({ userId: n.id, applicationId: r.id });
    },
    ...
    WISHLIST_FETCH_SUCCESS: E,
    WISHLIST_ADD_SKU_SUCCESS: E,
    WISHLIST_REMOVE_SKU_SUCCESS: E,
