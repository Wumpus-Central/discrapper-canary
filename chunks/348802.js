...
let p = new (class {
    ...
    upsertOne(e, t, n, i) {
        let a = o.A.messagesTransaction(i),
            c = s.A.lastTimeConnectedChanged();
        a.put(e, t, l.B.fromMessage(e, t, n, c), r.hh.Replace), a.trimChannel(e, t, u.Ay.saveLimit(t));
    }
    upsertMany(e, t, n, r) {
    ...
    replaceChannel(e, t, n, r) {
        let i = o.A.messagesTransaction(r),
            a = s.A.lastTimeConnectedChanged(),
            c = u.Ay.saveLimit(t),
            d = (n.length > c ? n.slice(n.length - c) : n).map((n) => l.B.fromMessage(e, t, n, a));
