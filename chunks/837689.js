    ...
    constructor(...e) {
        super(...e),
            C(this, 'maybeOpenServerDriveAnnouncementModal', async (e, t) => {
                ...
                if (null != i) {
                    if (!1 === t) {
                        ...
                        } else if ((null == i ? void 0 : i.contentIdentifier) === 'Q1_MARKETING_MOMENT_ANNOUNCEMENT_CONTENT_IDENTIFIER' && !1 === (await (0, v.M)({ location: 'OfferAnnouncementManager' }))) return !1;
                    }
                    return (
                        (0, o.Mr3)(S),
                        (0, o.ZDy)(
            ...
            C(this, 'mayShowAnnouncementModal', async () => {
                ...
                if ((t && !n && !(0, o.$sL)() && !(0, p.I5)(r) && (await (0, g.G)(e.userTrialOffer)) && (0, N.Z)({ upsellType: I.cd.REVERSE_TRIAL_FOLLOWUP_UPSELL }), (null == r || r.verified) && !(0, o.$sL)() && m.Z.getCurrentConfig({ location: 'OfferAnnouncementManager' }).enabled && !i.tq)) {
