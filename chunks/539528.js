...
function L(e) {
    ...
    function V(e) {
        var t = document.querySelector('base'),
            n = '';
        return t && t.getAttribute('href') && (n = R(window.location.href)), n + '#' + b(_ + f(e));
    }
    function F(e, t) {
        var n = 'PUSH',
        ...
        I.confirmTransitionTo(r, n, a, function (e) {
            if (e) {
                ...
                if (a) {
                    (A = t), w(i);
                    var o = B.lastIndexOf(f(J.location)),
                        s = B.slice(0, o + 1);
                    s.push(t),
                        (B = s),
                        T({
