...
e.exports = function (e) {
    ...
    let c = e.regex,
        ...
        C = [e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, A, I, T, S, { match: /\$\d+/ }, m];
    g.contains = C.concat({ begin: /\{/, end: /\}/, keywords: h, contains: ["self"].concat(C) });
    let N = [].concat(y, g.contains),
        v = N.concat([{ begin: /(\s*)\(/, end: /\)/, keywords: h, contains: ["self"].concat(N) }]),
        R = {
            className: "params",
            begin: /(\s*)\(/,
            end: /\)/,
