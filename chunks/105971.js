...
let c = {
    ...
    trackFeedFeedbackSubmitted(e) {
        r.default.track(o.HAw.HOME_FEEDBACK_SUBMITTED, { load_id: s.A.getLoadId(), home_session_id: "gravity", ...e });
    },
    ...
    trackFeedEmptyLoadingSeen() {
        r.default.track(o.HAw.ICYMI_FEED_EMPTY_LOADING_SEEN, { load_id: s.A.getLoadId(), version: s.A.getVersion() });
    },
