...
function M() {
    let e = Object.keys(P).filter((e) => isNaN(Number(e)));
    return P[e[Math.floor(Math.random() * e.length)]];
}
let k = [
        {
            name: 'Boulder',
