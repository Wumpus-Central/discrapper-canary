...
if (isNaN(Number(Object.values(O).pop()))) throw Error('Failed to get the last step in the ClanSetupSteps enum');
...
function H(e) {
    ...
    return (
            ...
            }, {})),
        {
            ...
            badge: {
                badgeKind: e.badge,
                primaryColor: Z(e.badge_color_primary, n.primary),
                secondaryColor: Z(e.badge_color_secondary, n.secondary),
                imageHash: e.badge_hash
            },
            branding: {
                primaryColor: Z(e.brand_color_primary, r.primary),
                secondaryColor: Z(e.brand_color_secondary, r.secondary)
            },
