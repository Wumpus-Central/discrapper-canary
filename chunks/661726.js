...
class a {
    ...
    extendSelection(e) {
        ...
        if (null != n) {
            if ("all" === this.state.selectedKeys) t = new (0, r.Y)([n], n, n);
                ...
                for (let i of ((t = new (0, r.Y)(e, o, n)), this.getKeyRange(o, null != (a = e.currentKey) ? a : n)))
                    t.delete(i);
    ...
    toggleSelection(e) {
        ...
        let t = this.getKey(e);
        if (null == t) return;
        let n = new (0, r.Y)("all" === this.state.selectedKeys ? this.getSelectAllKeys() : this.state.selectedKeys);
    ...
    replaceSelection(e) {
        ...
        let t = this.getKey(e);
        if (null == t) return;
        let n = this.canSelectItem(t) ? new (0, r.Y)([t], t, t) : new (0, r.Y)();
            ...
            t = (n) => {
                for (; null != n; ) {
                    if (this.canSelectItem(n)) {
                        ...
                        (null == o ? void 0 : o.type) === "item" && e.push(n),
                            (null == o ? void 0 : o.hasChildNodes) &&
                                (this.allowsCellSelection || "item" !== o.type) &&
                                t(
                                    null !=
                                        (a = null == (r = (0, i.l8)((0, i._P)(o, this.collection))) ? void 0 : r.key)
                                        ? a
                                        : null,
                                );
                    }
    ...
    clearSelection() {
        !this.disallowEmptySelection &&
            ...
            this.state.setSelectedKeys(new (0, r.Y)());
    }
    toggleSelectAll() {
