            ...
            () =>
                "nitro" === u
                    ...
                    : {
                          ...
                          onClick: () => (0, sF.default)({ applicationId: s }),
                          onMouseDown: () => (0, sF.G)({ applicationId: s }),
                      },
            [u, s],
        );
    return (0, c.jsx)(sU.A, {
...
let sY = [
    ...
    s$ = (e) => {
        ...
        return (0, c.jsx)("div", {
            ...
            children: null != r && i === eS.R.AVATAR_DECORATION && (0, c.jsx)(sK.i, { item: r }),
        });
    },
    sq = (e) => {
        ...
        return (
            ...
            (0, c.jsx)("div", {
                className: g()(sW.rA, { [sW.Kb]: t, [sW.pp]: n }),
                children: r.map((e, t) => {
    ...
    let m = l?.skuId ?? "",
        ...
        S = d.useCallback(() => {
            if ((u(!0), t.isDismissible)) {
                ...
                (0, ty.$l)(tN.M.COLLECTIBLES_SHOP_WIDE_BANNER, e, { dismissAction: s0.i.USER_DISMISS });
            }
    ...
    return (0, c.jsx)(sQ.N, {
        ...
        children: (e) =>
            (0, c.jsx)(tK.L, {
                ...
                threshold: 0,
                children: C
                    ? (0, c.jsx)(e7.D, { innerRef: n, onClick: () => L(null), className: g()(e, A), children: O })
...
var s2 = s(757036),
    s5 = s(212739);
let s4 = (0, w.mj)({ name: "2026-05-orbs-shop-upsell-banner", kind: "user", defaultConfig: !1, variations: { 1: !0 } });
var s9 = s(462887),
    s7 = s(765671),
    s3 = s(303136),
    s6 = s(792656),
...
let ll = (e) => {
        let { category: t, tab: s } = e,
            { ref: l, width: n } = (0, s7.Ay)(),
            a = null != n && n <= 560,
            r = (0, h.bG)([s8.A], () => (0, s9.q)(s8.A.theme)),
            i = t?.skuId ?? "",
                ...
                children: (e) =>
                    (0, c.jsx)(tK.L, {
                        ...
                        children: (0, c.jsxs)("div", {
                            ...
                            className: g()(e, lt.kL),
                            children: [
                                (0, c.jsx)(s3.A, { className: lt.Ki, src: ls.A }),
                                (0, c.jsxs)("div", {
                                    className: lt.Qs,
                                    children: [
                                        (0, c.jsx)(eu.D, {
    ...
    ln = (e) => {
        let { index: t, wideBannerBlock: s, tab: l } = e,
            n = s4.useConfig({ location: "CollectiblesShopBannerSelector" }),
            a = (0, s2.L)(M.PremiumTypes.TIER_2),
            r = (0, s5.O)();
        if (n && !a && !r && l === R.G2.ORBS) {
            let e = j.A.getCategoryByStoreListingId(s.categoryStoreListingId);
            return (0, c.jsx)(ll, { category: e, tab: l }, t);
        }
        return (0, c.jsx)(s1, { wideBannerBlock: s, tab: l }, t);
    },
    la = (e) => {
...
let lc = { "Any:personalization-header": sl },
    ...
    lm = { prioritizedCurrency: eF.Hi.ORBS },
    lh = (e) => {
        let { tab: t } = e,
        ...
        return (0, c.jsxs)(c.Fragment, {
            children: [
                t === Y.ORBS && (0, c.jsx)(lg, {}),
                t === Y.ORBS ? (0, c.jsx)(eF.v3.Provider, { value: lm, children: u }) : u,
            ],
        });
    },
    lE = (e) => {
