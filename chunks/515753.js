...
let en = q.ZP.getEnableHardwareAcceleration() ? m.Xo$ : m.qEK,
    ...
    eo = (e) => {
        var { route: t, selected: n, icon: r, iconClassName: s, avatarWithTextClassName: a, interactiveClassName: o, text: d, children: g, locationState: p, onClick: h, className: f, role: b, 'aria-posinset': _, 'aria-setsize': x, listItemRef: E } = e,
...
function ec(e) {
    let { channel: t, isGDMFacepileEnabled: s, selected: a = !1, user: u, activities: b, applicationStream: x, voiceChannel: y, isTyping: P, status: Z, isMobile: w, nameplate: V, ref: G, 'aria-posinset': z, 'aria-setsize': Y } = e,
        [K, q] = r.useState(!1),
        [eo, ec] = r.useState(!1),
        ed = r.useRef(null),
        eu = r.useRef(null),
        ...
        eC = (0, g.e7)([W.ZP], () => W.ZP.isChannelMuted(t.getGuildId(), t.id)),
        { ignored: ej, blocked: eO } = (0, g.cj)([H.Z], () => ({
        ...
        ev = ex && eO,
        eT = (eC || eS || ev) && !(a || K),
        eN = (0, g.e7)([F.ZP], () => F.ZP.getMentionCount(t.id) > 0),
        eI = (0, T.ZP)(t),
        ey = (0, g.e7)([A.Z], () => A.Z.isFavorite(t.id)),
        ...
        eV = (e) => {
            ...
            let r = Q.intl.formatToPlainString(Q.t.hJ5Ap6, { name: eI }),
                s = Q.intl.format(Q.t.SSIVOj, { name: eI });
            t.isManaged() && ((r = Q.intl.formatToPlainString(Q.t.hVGjER, { name: eI })), (s = Q.intl.format(Q.t.IK1Qvr, { name: eI }))),
                (0, m.ZDy)(async () => {
    ...
    return (0, i.jsx)(d.mh, {
        ...
        children: (e) => {
            ...
            return (0, i.jsxs)(N.Z, {
                ...
                'aria-posinset': z,
                children: [
                    eA && eN ? (0, i.jsx)('div', { className: l()(J.unreadPill, { [J.muted]: eT }) }) : null,
                    (0, i.jsxs)(m.vjx, {
