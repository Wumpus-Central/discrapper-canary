...
async function s(e) {
    let { location: t, twoWayLinkType: n, successRedirect: s, handle: l } = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
        ...
        p = null;
    (0, i.isDesktop)() || (p = window.open(''.concat(window.location.protocol, '//').concat(window.location.host).concat(o.Z5c.CONNECTIONS(e), '?loading=true'), 'authorize', 'scrollbars=yes,resizable=yes,toolbar=no,location=yes,top='.concat(_, ',left=').concat(f, ',width=').concat(u, ',height=').concat(d)));
    let h = c;
    if (null == h && e !== a.Kt)
        try {
