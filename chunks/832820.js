...
let y = function (e) {
    let { channel: t } = e,
        n = (0, d.z8)(t.id),
        o = (0, d.OG)(t.id),
        { entitlement: c, numPotions: y } = (0, m.t6)(p.D1),
        O = i.useCallback(
            (e) => {
                (0, d.Hi)(e, t.id);
            },
        ...
        N = i.useMemo(() => (null != y && y > 0 ? ((null == c ? void 0 : c.type) === g.qc2.DEVELOPER_GIFT ? E.NW.format(E.t['b+P6ra'], { numPotions: y }) : E.NW.format(E.t.RiQ4cn, { numPotions: y })) : E.NW.string(E.t.hvVgAQ)), [y, c]),
        [A, C] = i.useState(!1 === o);
    i.useEffect(() => {
        !1 === o && S();
    }, [o, S]);
