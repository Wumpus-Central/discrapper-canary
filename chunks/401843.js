...
function R(e, t) {
    ...
    return i()(null != n, "Cannot join a null voice channel"), !g.A.isInChannel(t) && (0, A.Pd)(n, g.A, E.A);
}
function b(e, t) {
    if (null != l.default.getRemoteSessionId()) return;
    let { guildId: n, channelId: r } = e;
    if (null != n && R(n, r)) return;
    let i = (0, u._z)(e),
        s =
            t?.forceMultiple ||
...
function L(e, t) {
    ...
    if (null != n && R(n, r)) return;
    b(e, t);
    let i = d.A.getWindowOpen(N.MLl.CHANNEL_CALL_POPOUT),
...
async function P(e, t, n) {
    ...
    let r = (0, u._z)({ streamType: null != e ? v.U4.GUILD : v.U4.CALL, guildId: e, channelId: t, ownerId: n });
