...
var i = n(627968),
    ...
    j = n(909340),
    P = n(455482);
let y = x.A.getArticleURL(f.MVz.ORBS_REWARDS_FAQ);
function L(e) {
    (0, T.o8)(e), window.open(y, "_blank");
}
let D = (e) => {
    let { className: t } = e,
        ...
        x = (0, _.A)("(min-width: 720px)"),
        y = (0, m.DP)(),
        D = s.useMemo(() => ({ hueRotate: 25, glowAmount: (0, d.M)(y) ? 2 : 8, blurAmount: 20 }), [y]);
        ...
        switch (n) {
            case E.L.ACTIVE:
                ...
                return {
                    ...
                    actionButton: (0, i.jsx)(c.$nd, {
                        ...
                        onClick: () => {
                            (0, T.WD)(n), (0, h.pX)(b.BV.COLLECTIBLES_SHOP_WITH_TAB(N.G2.ORBS));
                        },
                    }),
                    headerText: v.intl.format(R.default.BxLJQL, { days: Math.max(1, s), orbsCount: e.reward_amount }),
                    subheaderText: v.intl.format(R.default.tUV1vV, { helpdeskArticle: () => L(n) }),
                };
            case E.L.PAYMENT_PROCESSING:
                return {
                    ...
                    actionButton: (0, i.jsx)(c.$nd, {
                        ...
                        variant: t ? "overlay-primary" : "secondary",
                        onClick: () => {
                            (0, T.CC)(n), (0, C.openUserSettings)(p.X.BILLING_PANEL, { section: f.nc_.BILLING });
                        },
                    }),
                    headerText: v.intl.string(R.default.uuZJXR),
                    subheaderText: v.intl.format(R.default.dkeEV7, { helpdeskArticle: () => L(n) }),
                };
            case E.L.PAYMENT_ERROR:
                return {
                    ...
                    subheaderText: v.intl.format(R.default.nWKEBZ, { helpdeskArticle: () => L(n) }),
                };
            case E.L.PROGRAM_ROLLBACK:
                return {
                    ...
                    subheaderText: v.intl.format(R.default["5tzNTa"], { helpdeskArticle: () => L(n) }),
                };
            case E.L.PREMIUM_CHURNING:
                return {
                    ...
                    actionButton: (0, i.jsx)(c.$nd, {
                        ...
                        icon: c.tvc,
                        onClick: () => {
                            (0, T.Jv)(n), (0, C.openUserSettings)(p.X.BILLING_PANEL, { section: f.nc_.BILLING });
                        },
                    }),
                    headerText: v.intl.string(R.default.ISnOet),
                    subheaderText: v.intl.format(R.default["vjaRZ/"], { helpdeskArticle: () => L(n) }),
                };
            default:
                return null;
        }
    ...
    let { displayTotalLifetimeRewards: G, displayProgressBar: U, actionButton: k, headerText: B, subheaderText: w } = M;
    return (0, i.jsx)("div", {
        className: a()(O.Hc, t),
