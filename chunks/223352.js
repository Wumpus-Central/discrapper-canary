...
let v = (e) => {
    let { isFullyExpanded: t, partnerBranding: n } = e,
        ...
        { quest: b } = s.useContext(p.T),
        { expansionSpring: j } = s.useContext(x.PW),
        A = i ? -4 : 6;
    return (0, a.jsxs)(a.Fragment, {
        children: [
            ...
            (0, a.jsxs)(r.animated.div, {
                ...
                children: [
                    (0, a.jsx)("div", { className: l()({ [f.Iu]: !i }), children: n }),
                    (0, a.jsx)(r.animated.div, {
                        className: l()(f.ol, { [f.yZ]: i }),
                        style: { opacity: (0, h.a)(j.to({ range: [0, 1], output: [i ? 1 : 0.7, 0] })) },
