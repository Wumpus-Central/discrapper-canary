...
function S(e) {
    let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 3,
        n = [],
        { h: r, s: i, l: s } = d(e[0], e[1], e[2]),
        a = r,
        o = i,
        l = s;
    o < m && (o += A), l > E && (l -= I), l < g && (l += T);
    let u = 360 / (t + 1);
    for (; n.length < t; ) {
        (a -= u) < 0 && (a += 360);
        let { r: e, g: t, b: r } = h(a, o, l);
        n.push([e, t, r]);
    }
    return n;
}
...
function R(e) {
    return e
        .slice(0, 3)
        .map((e) => ({ hex: e, hsv: p(e) ?? { h: 0, s: 0, v: 0 } }))
        .sort(O)[0].hex;
}
function O(e, t) {
    let n = e.hsv,
...
function b(e) {
    ...
    if (null == t) return t;
    let r = y(t.get("rgb.r"), t.get("rgb.g"), t.get("rgb.b"));
    return null == r ? t?.hex() : v(r.hue, r.saturation * n, r.lightness)?.toHexString();
}
function D(e, t, n) {
