e.exports = function (e) {
    let t = {
        ...
        g = { className: "meta", begin: "^#!", end: "$", relevance: 5 },
        E = { className: "meta", begin: "#(line)", end: "$", relevance: 5 },
        A = { className: "keyword", begin: "@[a-zA-Z_][a-zA-Z_\\d]*" },
        I = e.COMMENT("\\/\\+", "\\+\\/", { contains: ["self"], relevance: 10 });
    return {
        name: "D",
        keywords: t,
        contains: [e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE, I, h, _, f, p, m, c, u, d, g, E, A],
    };
};
