...
var b = function (e) {
        ...
        for (var u of i) {
            ...
            if (
                (([a, o] = n ? [o, f] : [f, a]),
                (G(a, r.ZWJ) && G(o, r.ExtPict) && !(l = n ? Z(e.substring(0, s)) : Z(e.substring(0, e.length - s)))) ||
                    (G(a, r.RI) && G(o, r.RI) && !(c = null !== c ? !c : !!n || Y(e.substring(0, e.length - s)))) ||
                    (a !== r.None && o !== r.None && V(a, o)))
            )
                break;
            s += u.length;
        }
        ...
        switch (n.type) {
            ...
            case "move_node":
                ...
                var P = el.transform(S, n),
                    ...
                    D = P[P.length - 1];
                if ((w.children.splice(D, 0, N), t)) for (var [L, x] of eg.points(t)) t[x] = ef.transform(L, n);
                break;
            case "remove_node":
                var { path: M } = n,
                    k = M[M.length - 1];
                    ...
                    for (var [j, U] of eg.points(t)) {
                        ...
                        if (null != t && null != G) t[U] = G;
                            ...
                            B &&
                                ...
                                (H = el.equals(V[1], M)
                                    ? !el.hasPrevious(V[1])
                                    : el.common(B[1], M).length < el.common(V[1], M).length),
                                B && !H
                                    ? ((j.path = B[1]), (j.offset = B[0].text.length))
                                    : V
                                      ? ((j.path = V[1]), (j.offset = 0))
                                      : (t = null);
                        }
                    }
                break;
            ...
            case "split_node":
                ...
                if (eA.isText(em)) {
                    var eO = em.text.slice(0, ep),
                        ev = em.text.slice(ep);
                    (em.text = eO), (ed = eC(eC({}, eh), {}, { text: ev }));
                } else {
                    var eI = em.children.slice(0, ep),
                        eT = em.children.slice(ep);
                    (em.children = eI), (ed = eC(eC({}, eh), {}, { children: eT }));
                }
                ...
                if (s) {
                    ...
                    try {
                        ...
                        for (var [A, N] of $.levels(e, {
                            ...
                            var C = !1;
                            if (N.length < I.length || 0 === N.length || (!a && K.isElement(A) && $.isVoid(e, A)))
                                break;
                            var R = _.current,
                                P = $.isEnd(e, R, N);
                            if (c || !_ || !$.isEdge(e, R, N)) {
                    ...
                    if (o) {
                        ...
                        if (!(!a && $.void(e, { at: o }))) {
                            ...
                            eY.splitNodes(e, {
                                at: o,
                                match: (t) =>
                                    N ? K.isElement(t) && $.isBlock(e, t) : eA.isText(t) || $.isInline(e, t),
