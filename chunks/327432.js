...
var b = function (e) {
        ...
        for (var u of i) {
            ...
            if (
                (([o, a] = n ? [a, f] : [f, o]),
                (G(o, r.ZWJ) && G(a, r.ExtPict) && !(l = n ? V(e.substring(0, s)) : V(e.substring(0, e.length - s)))) ||
                    (G(o, r.RI) && G(a, r.RI) && !(c = null !== c ? !c : !!n || Y(e.substring(0, e.length - s)))) ||
                    (o !== r.None && a !== r.None && Z(o, a)))
            )
                break;
            s += u.length;
        }
        ...
        *positions(e) {
        ...
        string(e, t) {
            ...
            for (var [l, c] of $.nodes(e, {
                ...
                var u = l.text;
                el.equals(c, a.path) && (u = u.slice(0, a.offset)),
                    el.equals(c, o.path) && (u = u.slice(o.offset)),
                    (s += u);
            }
            return s;
        },
        ...
        *nodes(e) {
            for (
                var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                    ...
                    s = [],
                    l = e;
                !(o && (r ? el.isBefore(s, o) : el.isAfter(s, o)));
            ) {
                if (
                    (a.has(l) || (yield [l, s]),
                    !a.has(l) && !eA.isText(l) && 0 !== l.children.length && (null == n || !1 === n([l, s])))
                ) {
                    a.add(l);
...
var eg = {
        ...
        includes(e, t) {
            ...
            return (
                ef.isPoint(t)
                    ? ((l = ef.compare(t, a) >= 0), (c = 0 >= ef.compare(t, s)))
                    : ((l = el.compare(t, a.path) >= 0), (c = 0 >= el.compare(t, s.path))),
                l && c
            );
        },
        intersection(e, t) {
    ...
    eP = {
        transform(e, t) {
            ...
            try {
                ...
                (e.children = (0, o._x)(e.children)),
                    n ? (e.selection = (0, o.mv)(n) ? (0, o._x)(n) : n) : (e.selection = null);
            }
        },
    },
    ew = ["text"],
...
var eM = {
        insertNodes(e, t) {
            ...
            $.withoutNormalizing(e, () => {
                ...
                if ((ei.isNode(t) && (t = [t]), 0 !== t.length)) {
                    var [c] = t;
                    if (
                        (a || ((a = e.selection ? e.selection : e.children.length > 0 ? $.end(e, []) : [0]), (l = !0)),
                        null == l && (l = !1),
                        eg.isRange(a))
                    )
                ...
                if (o) {
                    ...
                    if ((!a && eg.isRange(o) && (o = $.unhangRange(e, o, { voids: s })), eg.isRange(o)))
                        if (eg.isCollapsed(o)) o = o.anchor;
                            ...
                            var [, u] = eg.edges(o),
                                d = $.pointRef(e, u);
                            eY.delete(e, { at: o }), (o = d.unref()), null == t.at && eY.select(e, o);
                        }
                    var [f] = $.nodes(e, {
                            at: o,
                            match: i,
        ...
        removeNodes(e) {
            ...
            $.withoutNormalizing(e, () => {
                ...
                if (o) {
                    null == a && (a = el.isPath(o) ? eU(e, o) : (t) => K.isElement(t) && $.isBlock(e, t)),
                        ...
                        if (0 !== E.length) {
                            ...
                            for (var v in t)
                                "children" !== v &&
                                    ...
                                    a ? null != t[v] && (y[v] = a(g[v], t[v])) : null != t[v] && (y[v] = t[v]));
                            O &&
                                e.apply({
                                    type: "set_node",
                                    path: E,
        ...
        splitNodes(e) {
            ...
            $.withoutNormalizing(e, () => {
                ...
                if (
                    (null == a && (a = (t) => K.isElement(t) && $.isBlock(e, t)),
                ...
                if (s) {
                    ...
                    try {
                        ...
                        for (var [A, N] of $.levels(e, {
                            ...
                            var C = !1;
                            if (N.length < I.length || 0 === N.length || (!o && K.isElement(A) && $.isVoid(e, A)))
                                break;
                            var R = _.current,
                                P = $.isEnd(e, R, N);
                            if (c || !_ || !$.isEdge(e, R, N)) {
...
var eZ = {
        ...
        move(e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                ...
                { edge: a = null } = t;
            if (n) {
                "start" === a && (a = eg.isBackward(n) ? "focus" : "anchor"),
                    "end" === a && (a = eg.isBackward(n) ? "anchor" : "focus");
        ...
        setSelection(e, t) {
            ...
            if (n) {
                for (var o in t)
                    (("anchor" !== o || null == t.anchor || ef.equals(t.anchor, n.anchor)) &&
                        ("focus" !== o || null == t.focus || ef.equals(t.focus, n.focus)) &&
                    ...
                    if (!eg.isCollapsed(s)) {
                        ...
                        !O &&
                            ...
                            c &&
                                ...
                                L.length > 1 &&
                                L.match(/[\u0E00-\u0E7F]+/) &&
                                eY.insertText(e, L.slice(0, L.length - o));
                        var H = w.unref(),
                            Y = D.unref(),
                            W = r ? H || Y : Y || H;
