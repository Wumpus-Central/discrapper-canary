    ...
    J = {
        ...
        after(e, t) {
            var n,
                ...
                i = {
                    anchor: J.point(e, t, { edge: 'end' }),
                    focus: J.end(e, [])
                },
                { distance: a = 1 } = r,
                o = 0;
            for (var s of J.positions(e, X(X({}, r), {}, { at: i }))) {
                if (o > a) break;
                (0 !== o && (n = s), o++);
            }
            return n;
        ...
        *levels(e) {
            ...
            if ((null == a && (a = () => !0), n)) {
                var o = [],
                    s = J.path(e, n);
                for (var [l, c] of ei.levels(e, s)) if (a(l, c) && (o.push([l, c]), !i && K.isElement(l) && J.isVoid(e, l))) break;
                (r && o.reverse(), yield* o);
            }
        },
        marks(e) {
            ...
            if (t) return t;
            if (eg.isExpanded(n)) {
                var [r] = J.nodes(e, { match: eA.isText });
                if (!r) return {};
                var [i] = r;
                return E(i, z);
            }
            ...
            if (0 === a.offset) {
                ...
                if (!J.above(e, { match: (t) => K.isElement(t) && J.isVoid(e, t) && e.markableVoid(t) })) {
                    var c = J.above(e, { match: (t) => K.isElement(t) && J.isBlock(e, t) });
                    if (l && c) {
                        var [u, d] = l,
                            [, f] = c;
                ...
                switch (t.type) {
                    ...
                    case 'split_node':
                        if (el.equals(t.path, i))
                            ...
                            else (t.position < a || (t.position === a && 'forward' === r)) && ((e.offset -= t.position), (e.path = el.transform(i, t, ed(ed({}, n), {}, { affinity: 'forward' }))));
    ...
    decorations(e, t) {
        ...
        for (var r of t) {
            ...
            for (var d of n) {
                ...
                if (u < l) {
                    var g = u - _;
                    ((m = eS(eS({}, p), {}, { text: p.text.slice(g) })), (p = eS(eS({}, p), {}, { text: p.text.slice(0, g) })));
                }
                if (c > _) {
                    var b = c - _;
                    ((h = eS(eS({}, p), {}, { text: p.text.slice(0, b) })), (p = eS(eS({}, p), {}, { text: p.text.slice(b) })));
                }
        ...
        switch (n.type) {
            ...
            case 'move_node':
                ...
                var R = el.transform(S, n),
                    ...
                    D = R[R.length - 1];
                if ((P.children.splice(D, 0, N), t)) for (var [L, x] of eg.points(t)) t[x] = ef.transform(L, n);
                break;
            case 'remove_node':
                var { path: k } = n,
                    j = k[k.length - 1];
            ...
            case 'remove_text':
                ...
                if (((z.text = q + $), t)) for (var [X, Q] of eg.points(t)) t[Q] = ef.transform(X, n);
                break;
            case 'set_node':
            ...
            case 'split_node':
                ...
                if ((eE.children.splice(eb + 1, 0, ed), t)) for (var [eS, eN] of eg.points(t)) t[eN] = ef.transform(eS, n);
        }
        return t;
    },
    eR = {
...
var ek = {
            ...
            J.withoutNormalizing(e, () => {
                ...
                if ((ei.isNode(t) && (t = [t]), 0 !== t.length)) {
                    ...
                    if ((o || ((o = e.selection ? e.selection : e.children.length > 0 ? J.end(e, []) : [0]), (l = !0)), null == l && (l = !1), eg.isRange(o)))
                        if ((r || (o = J.unhangRange(e, o, { voids: i })), eg.isCollapsed(o))) o = o.anchor;
                        else {
                            var [, u] = eg.edges(o),
                                d = J.pointRef(e, u);
        ...
        mergeNodes(e) {
            ...
            J.withoutNormalizing(e, () => {
                ...
                if (a) {
                    ...
                    if ((!o && eg.isRange(a) && (a = J.unhangRange(e, a, { voids: s })), eg.isRange(a)))
                    ...
                    if (f && _) {
                        ...
                        if (0 !== h.length && 0 !== g.length) {
                            var b = el.next(g),
                                y = el.common(h, g),
                                O = el.isSibling(h, g),
                                v = Array.from(J.levels(e, { at: h }), (e) => {
                                    var [t] = e;
                                    return t;
                                })
                                    .slice(y.length)
                            ...
                            (O ||
                                ...
                                (K.isElement(m) && J.isEmpty(e, m)) || (eA.isText(m) && '' === m.text && 0 !== g[g.length - 1])
                                    ? eY.removeNodes(e, {
                                          at: g,
                                          voids: s
                                      })
        ...
        removeNodes(e) {
            ...
            J.withoutNormalizing(e, () => {
                ...
                if (a) {
                    (null == o && (o = el.isPath(a) ? eU(e, a) : (t) => K.isElement(t) && J.isBlock(e, t)), !n && eg.isRange(a) && (a = J.unhangRange(e, a, { voids: r })));
                    var s = J.nodes(e, {
                            at: a,
                            match: o,
                            mode: i,
        ...
        setNodes(e, t) {
            ...
            J.withoutNormalizing(e, () => {
                ...
                if (i) {
                    if ((null == r && (r = el.isPath(i) ? eU(e, i) : (t) => K.isElement(t) && J.isBlock(e, t)), !s && eg.isRange(i) && (i = J.unhangRange(e, i, { voids: u })), c && eg.isRange(i))) {
        ...
        splitNodes(e) {
            ...
            J.withoutNormalizing(e, () => {
                ...
                if (s) {
                    var _ = J.pointRef(e, s, { affinity: 'backward' });
                    try {
                        var [p] = J.nodes(e, {
                            at: s,
                            match: o,
            ...
            J.withoutNormalizing(e, () => {
                ...
                if (s) {
                    if ((null == o && (o = el.isPath(s) ? eU(e, s) : e.isInline(t) ? (t) => (K.isElement(t) && J.isInline(e, t)) || eA.isText(t) : (t) => K.isElement(t) && J.isBlock(e, t)), i && eg.isRange(s))) {
                        var [l, c] = eg.edges(s),
                            u = J.rangeRef(e, s, { affinity: 'inward' });
                        (eY.splitNodes(e, {
                            at: c,
                            match: o,
                            voids: a
                ...
                if (s) {
                    ...
                    if (!eg.isCollapsed(s)) {
                        if (!l) {
                            var [, p] = eg.edges(s),
                                h = J.end(e, []);
                            ef.equals(p, h) || (s = J.unhangRange(e, s, { voids: o }));
                        }
                        var [m, g] = eg.edges(s),
                            E = J.above(e, {
                                match: (t) => K.isElement(t) && J.isBlock(e, t),
        ...
        insertFragment(e, t) {
            ...
            J.withoutNormalizing(e, () => {
                ...
                if (t.length) {
                    if (o) {
                        if (eg.isRange(o))
                            if ((i || (o = J.unhangRange(e, o, { voids: a })), eg.isCollapsed(o))) o = o.anchor;
                            else {
                                var [, s] = eg.edges(o);
                        ...
                        if (!(!a && J.void(e, { at: o }))) {
                            ...
                            var [w] = J.nodes(e, {
                                ...
                                P = J.isStart(e, o, R),
                                D = J.isEnd(e, o, R),
                                L = J.pathRef(e, p && !S.length ? el.next(f) : f),
                                x = J.pathRef(e, D ? el.next(R) : R);
                            eY.splitNodes(e, {
                                at: o,
