...
var m = () => {
    var e = {
        ...
        apply: (t) => {
            ...
            if (el.operationCanTransformPath(t)) for (var _ of ((a = []), (o = new Set()), u)) f(el.transform(_, t));
            else (a = u), (o = d);
            ...
            if (n) {
                ...
                for (var [h, m] of $.nodes(e, {
                    ...
                    if (eA.isText(h)) {
                        ...
                        for (
                            y
                                ? ((_ = i ? c.offset : h.text.length - c.offset), (p = c.offset))
                                : ((_ = h.text.length), (p = i ? _ : 0)),
                                (y || u || "offset" === r) &&
                                    (yield {
                                        path: m,
                                        offset: p,
            ...
            switch (t.type) {
                ...
                case "move_node":
                    ...
                    if (el.isAncestor(d, r) || el.equals(d, r)) {
                        var _ = f.slice();
                        return (
                            el.endsBefore(d, f) && d.length < f.length && (_[d.length - 1] -= 1),
                            _.concat(r.slice(d.length))
                        );
                    }
    ...
    decorations(e, t) {
        ...
        for (var r of t) {
            ...
            for (var d of n) {
                ...
                if (u < l) {
                    var g = u - _;
                    (m = eS(eS({}, p), {}, { text: p.text.slice(g) })),
                        (p = eS(eS({}, p), {}, { text: p.text.slice(0, g) }));
                }
                if (c > _) {
                    var b = c - _;
                    (h = eS(eS({}, p), {}, { text: p.text.slice(0, b) })),
                        (p = eS(eS({}, p), {}, { text: p.text.slice(b) }));
                }
...
var eR = (e, t, n) => {
        switch (n.type) {
            ...
            case "merge_node":
                ...
                if ((O.children.splice(v, 1), t)) for (var [I, T] of eg.points(t)) t[T] = ef.transform(I, n);
                break;
            case "move_node":
                var { path: S, newPath: A } = n;
                if (el.isAncestor(S, A))
                    throw Error(
                        "Cannot move a path ["
                            .concat(S, "] to new path [")
                ...
                var P = el.transform(S, n),
                    ...
                    w = P[P.length - 1];
                if ((D.children.splice(w, 0, C), t)) for (var [L, x] of eg.points(t)) t[x] = ef.transform(L, n);
                break;
            case "remove_node":
                var { path: M } = n,
                    k = M[M.length - 1];
                    ...
                    for (var [j, U] of eg.points(t)) {
                        ...
                        if (null != t && null != G) t[U] = G;
                            ...
                            B &&
                                ...
                                (H = el.equals(Z[1], M)
                                    ? !el.hasPrevious(Z[1])
                                    : el.common(B[1], M).length < el.common(Z[1], M).length),
                                B && !H
                                    ? ((j.path = B[1]), (j.offset = B[0].text.length))
                                    : Z
            ...
            case "split_node":
                ...
                if (eA.isText(em)) {
                    var eO = em.text.slice(0, ep),
                        ev = em.text.slice(ep);
                    (em.text = eO), (ed = eN(eN({}, eh), {}, { text: ev }));
                } else {
                    var eI = em.children.slice(0, ep),
                        eT = em.children.slice(ep);
                    (em.children = eI), (ed = eN(eN({}, eh), {}, { children: eT }));
                }
                    ...
                    if (f && _) {
                        ...
                        if (0 !== h.length && 0 !== g.length) {
                            ...
                            O ||
                                ...
                                (K.isElement(m) && $.isEmpty(e, m)) ||
                                (eA.isText(m) && "" === m.text && 0 !== g[g.length - 1])
                                    ? eY.removeNodes(e, {
                                          at: g,
                                          voids: s,
                                      })
                ...
                if (s) {
                    ...
                    try {
                        ...
                        for (var [A, C] of $.levels(e, {
                            ...
                            var N = !1;
                            if (C.length < I.length || 0 === C.length || (!a && K.isElement(A) && $.isVoid(e, A)))
                                break;
                            var R = _.current,
                                P = $.isEnd(e, R, C);
                            if (c || !_ || !$.isEdge(e, R, C)) {
        ...
        setPoint(e, t) {
            ...
            if (r) {
                ...
                var { anchor: a, focus: o } = r,
                    s = "anchor" === i ? a : o;
                eY.setSelection(e, { ["anchor" === i ? "anchor" : "focus"]: eB(eB({}, s), t) });
            }
        },
        setSelection(e, t) {
            var { selection: n } = e,
                ...
                if (s) {
                    ...
                    if (!eg.isCollapsed(s)) {
                        if (!l) {
                            var [, p] = eg.edges(s),
                                h = $.end(e, []);
                            ef.equals(p, h) || (s = $.unhangRange(e, s, { voids: o }));
                        }
                        var [m, g] = eg.edges(s),
                            E = $.above(e, {
                                match: (t) => K.isElement(t) && $.isBlock(e, t),
                        ...
                        !O &&
                            ...
                            c &&
                                ...
                                L.length > 1 &&
                                L.match(/[\u0E00-\u0E7F]+/) &&
                                eY.insertText(e, L.slice(0, L.length - a));
                        var H = D.unref(),
                            Y = w.unref(),
                            W = r ? H || Y : Y || H;
                    ...
                    if (o) {
                        ...
                        if (!(!a && $.void(e, { at: o }))) {
                            ...
                            var [R] = $.nodes(e, {
                                ...
                                D = $.isStart(e, o, P),
                                w = $.isEnd(e, o, P),
                                L = $.pathRef(e, p && !S.length ? el.next(f) : f),
                                x = $.pathRef(e, w ? el.next(P) : P);
                            eY.splitNodes(e, {
                                at: o,
                                match: (t) =>
