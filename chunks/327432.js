...
var h = () => {
    var e = {
        ...
        apply: (t) => {
            ...
            if (el.operationCanTransformPath(t)) for (var p of ((a = []), (o = new Set()), u)) f(el.transform(p, t));
            else (a = u), (o = d);
...
var b = function (e) {
        ...
        for (var u of i) {
            ...
            if (
                (([a, o] = n ? [o, f] : [f, a]),
                (G(a, r.ZWJ) && G(o, r.ExtPict) && !(l = n ? V(e.substring(0, s)) : V(e.substring(0, e.length - s)))) ||
                    (G(a, r.RI) && G(o, r.RI) && !(c = null !== c ? !c : !!n || Y(e.substring(0, e.length - s)))) ||
                    (a !== r.None && o !== r.None && B(a, o)))
            )
                break;
            s += u.length;
        }
...
var P =
    ...
    U = (e, t) => {
        var n = r.Any;
        return (
            -1 !== e.search(P) && (n |= r.Extend),
            8205 === t && (n |= r.ZWJ),
            t >= 127462 && t <= 127487 && (n |= r.RI),
            -1 !== e.search(R) && (n |= r.Prepend),
            -1 !== e.search(D) && (n |= r.SpacingMark),
            -1 !== e.search(w) && (n |= r.L),
            -1 !== e.search(x) && (n |= r.V),
            -1 !== e.search(L) && (n |= r.T),
            -1 !== e.search(j) && (n |= r.LV),
...
function B(e, t) {
    return -1 === Z.findIndex((n) => G(e, n[0]) && G(t, n[1]));
}
var F =
...
var J = new WeakMap(),
    $ = {
        ...
        *nodes(e) {
            var t,
                ...
                { at: a = e.selection, mode: o = "all", universal: s = !1, reverse: l = !1, voids: c = !1 } = i,
                { match: u } = i;
            if ((u || (u = () => !0), a)) {
        ...
        *positions(e) {
            ...
            if (n) {
                ...
                for (var [m, h] of $.nodes(e, {
                    ...
                    if (eA.isText(m)) {
                        ...
                        for (
                            y
                                ? ((p = i ? c.offset : m.text.length - c.offset), (_ = c.offset))
                                : ((p = m.text.length), (_ = i ? p : 0)),
                                (y || u || "offset" === r) &&
                                    (yield {
                                        path: h,
                                        offset: _,
        ...
        string(e, t) {
            ...
            for (var [l, c] of $.nodes(e, {
                ...
                var u = l.text;
                el.equals(c, o.path) && (u = u.slice(0, o.offset)),
    ...
    ei = {
        ...
        *levels(e, t) {
        ...
        matches: (e, t) =>
            (K.isElement(e) && K.isElementProps(t) && K.matches(e, t)) ||
            (eA.isText(e) && eA.isTextProps(t) && eA.matches(e, t)),
        *nodes(e) {
            for (
                var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                    ...
                    s = [],
                    l = e;
                !(a && (r ? el.isBefore(s, a) : el.isAfter(s, a)));
            ) {
                if (
                    (o.has(l) || (yield [l, s]),
                    !o.has(l) && !eA.isText(l) && 0 !== l.children.length && (null == n || !1 === n([l, s])))
                ) {
                    o.add(l);
            ...
            switch (e.type) {
                ...
                case "set_selection":
                    return (
                        ...
                        ((0, i.P)(e.properties) && (0, i.P)(e.newProperties))
                    );
                case "split_node":
        ...
        transform(e, t) {
            ...
            switch (t.type) {
                ...
                case "merge_node":
                    ...
                    el.equals(s, r) || el.endsBefore(s, r)
                        ? (r[s.length - 1] -= 1)
                        : el.isAncestor(s, r) && ((r[s.length - 1] -= 1), (r[s.length] += l));
                    break;
                case "split_node":
...
var eg = {
        ...
        includes(e, t) {
            ...
            return (
                ef.isPoint(t)
                    ? ((l = ef.compare(t, o) >= 0), (c = 0 >= ef.compare(t, s)))
                    : ((l = el.compare(t, o.path) >= 0), (c = 0 >= el.compare(t, s.path))),
                l && c
            );
        },
        intersection(e, t) {
    ...
    decorations(e, t) {
        ...
        for (var r of t) {
            ...
            for (var d of n) {
                ...
                if (u < l) {
                    var g = u - p;
                    (h = eT(eT({}, _), {}, { text: _.text.slice(g) })),
                        (_ = eT(eT({}, _), {}, { text: _.text.slice(0, g) }));
                }
                if (c > p) {
                    var b = c - p;
                    (m = eT(eT({}, _), {}, { text: _.text.slice(0, b) })),
                        (_ = eT(eT({}, _), {}, { text: _.text.slice(b) }));
                }
...
var eP = (e, t, n) => {
        switch (n.type) {
            case "insert_node":
                ...
                if ((a.children.splice(o, 0, i), t)) for (var [s, l] of eg.points(t)) t[l] = ef.transform(s, n);
                break;
            case "insert_text":
                ...
                var f = ei.leaf(e, c),
                    p = f.text.slice(0, u),
                    _ = f.text.slice(u);
                if (((f.text = p + d + _), t)) for (var [m, h] of eg.points(t)) t[h] = ef.transform(m, n);
                break;
            case "merge_node":
                var { path: g } = n,
                    E = ei.get(e, g),
                ...
                else if (eA.isText(E) || eA.isText(y))
                    throw Error(
                ...
                if ((O.children.splice(v, 1), t)) for (var [S, I] of eg.points(t)) t[I] = ef.transform(S, n);
                break;
            case "move_node":
                var { path: T, newPath: A } = n;
                if (el.isAncestor(T, A))
                    throw Error(
                        "Cannot move a path ["
                            .concat(T, "] to new path [")
                            .concat(A, "] because the destination is inside itself."),
                    );
                var C = ei.get(e, T),
                    N = ei.parent(e, T),
                    P = T[T.length - 1];
                ...
                var R = el.transform(T, n),
                    ...
                    w = R[R.length - 1];
                if ((D.children.splice(w, 0, C), t)) for (var [x, L] of eg.points(t)) t[L] = ef.transform(x, n);
                break;
            case "remove_node":
                var { path: j } = n,
                    M = j[j.length - 1];
                    ...
                    for (var [k, U] of eg.points(t)) {
                        ...
                        if (null != t && null != G) t[U] = G;
                            ...
                            Z &&
                                ...
                                (H = el.equals(B[1], j)
                                    ? !el.hasPrevious(B[1])
                                    : el.common(Z[1], j).length < el.common(B[1], j).length),
                                Z && !H
                                    ? ((k.path = Z[1]), (k.offset = Z[0].text.length))
                                    : B
            ...
            case "split_node":
                var ed,
                    { path: ep, position: e_, properties: em } = n;
                if (0 === ep.length)
                    throw Error(
                ...
                if (eA.isText(eh)) {
                    var eO = eh.text.slice(0, e_),
                        ev = eh.text.slice(e_);
                    (eh.text = eO), (ed = eN(eN({}, em), {}, { text: ev }));
                } else {
                    var eS = eh.children.slice(0, e_),
                        eI = eh.children.slice(e_);
                    (eh.children = eS), (ed = eN(eN({}, em), {}, { children: eI }));
                }
    ...
    eR = {
        transform(e, t) {
            ...
            try {
                ...
                (e.children = (0, a._x)(e.children)),
                    n ? (e.selection = (0, a.mv)(n) ? (0, a._x)(n) : n) : (e.selection = null);
            }
        },
    },
    eD = ["text"],
...
var ej = {
        insertNodes(e, t) {
            ...
            $.withoutNormalizing(e, () => {
                ...
                if ((ei.isNode(t) && (t = [t]), 0 !== t.length)) {
                    var [c] = t;
                    if (
                        (o || ((o = e.selection ? e.selection : e.children.length > 0 ? $.end(e, []) : [0]), (l = !0)),
                        null == l && (l = !1),
                        eg.isRange(o))
                    )
                        if ((r || (o = $.unhangRange(e, o, { voids: i })), eg.isCollapsed(o))) o = o.anchor;
                        else {
                            var [, u] = eg.edges(o),
                                d = $.pointRef(e, u);
                            eY.delete(e, { at: o }), (o = d.unref());
                        }
                    if (ef.isPoint(o)) {
                        null == s &&
                            (s = eA.isText(c)
                                ? (e) => eA.isText(e)
                                : e.isInline(c)
                                  ? (t) => eA.isText(t) || $.isInline(e, t)
                                  : (t) => K.isElement(t) && $.isBlock(e, t));
                        var [f] = $.nodes(e, {
                            at: o.path,
                            match: s,
                            mode: a,
        ...
        mergeNodes(e) {
            ...
            $.withoutNormalizing(e, () => {
                ...
                if (a) {
                    ...
                    if ((!o && eg.isRange(a) && (a = $.unhangRange(e, a, { voids: s })), eg.isRange(a)))
                    ...
                    if (f && p) {
                        ...
                        if (0 !== m.length && 0 !== g.length) {
                            ...
                            O ||
                                ...
                                (K.isElement(h) && $.isEmpty(e, h)) ||
                                (eA.isText(h) && "" === h.text && 0 !== g[g.length - 1])
                                    ? eY.removeNodes(e, {
                                          at: g,
                                          voids: s,
                                      })
        ...
        removeNodes(e) {
            ...
            $.withoutNormalizing(e, () => {
                ...
                if (a) {
                    null == o && (o = el.isPath(a) ? eU(e, a) : (t) => K.isElement(t) && $.isBlock(e, t)),
                        !n && eg.isRange(a) && (a = $.unhangRange(e, a, { voids: r }));
                    var s = $.nodes(e, {
                            at: a,
                            match: o,
                            mode: i,
        ...
        setNodes(e, t) {
            ...
            $.withoutNormalizing(e, () => {
                ...
                if (i) {
                    if (
                        (null == r && (r = el.isPath(i) ? eU(e, i) : (t) => K.isElement(t) && $.isBlock(e, t)),
                        !s && eg.isRange(i) && (i = $.unhangRange(e, i, { voids: u })),
                        c && eg.isRange(i))
                    ) {
                        ...
                        if (0 !== E.length) {
                            ...
                            for (var v in t)
                                "children" !== v &&
                                    ...
                                    a(t[v], g[v]) &&
                                    ((O = !0),
                                    g.hasOwnProperty(v) && (b[v] = g[v]),
                                    o ? null != t[v] && (y[v] = o(g[v], t[v])) : null != t[v] && (y[v] = t[v]));
                            O &&
                                e.apply({
                                    type: "set_node",
                                    path: E,
        ...
        splitNodes(e) {
            ...
            $.withoutNormalizing(e, () => {
                ...
                if (
                    (null == o && (o = (t) => K.isElement(t) && $.isBlock(e, t)),
                    eg.isRange(s) && (s = ek(e, s)),
                    el.isPath(s))
                ) {
                    var u = s,
                        d = $.point(e, u),
                ...
                if (s) {
                    ...
                    try {
                        ...
                        for (var [A, C] of $.levels(e, {
                            ...
                            var N = !1;
                            if (C.length < S.length || 0 === C.length || (!a && K.isElement(A) && $.isVoid(e, A)))
                                break;
                            var P = p.current,
                                R = $.isEnd(e, P, C);
                            if (c || !p || !$.isEdge(e, P, C)) {
                    ...
                    var s = eg.isRange(a) ? $.rangeRef(e, a) : null,
                        ...
                        u = function (t) {
                            var n = t.unref(),
                                [a] = $.node(e, n),
                                o = $.range(e, n);
                            r && s && (o = eg.intersection(s.current, o)),
                                eY.liftNodes(e, {
                                    at: o,
                    ...
                    if (
                        (null == o &&
                            (o = el.isPath(s)
                                ? eU(e, s)
                                : e.isInline(t)
                                  ? (t) => (K.isElement(t) && $.isInline(e, t)) || eA.isText(t)
                                  : (t) => K.isElement(t) && $.isBlock(e, t)),
                        i && eg.isRange(s))
                    ) {
                        var [l, c] = eg.edges(s),
    ...
    ek = (e, t) => {
        ...
        var [, n] = eg.edges(t),
            r = $.pointRef(e, n);
        return eY.delete(e, { at: t }), r.unref();
    },
    eU = (e, t) => {
        var [n] = $.node(e, t);
        return (e) => e === n;
...
var eB = {
        ...
        move(e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                ...
                { edge: o = null } = t;
            if (n) {
                "start" === o && (o = eg.isBackward(n) ? "focus" : "anchor"),
                    "end" === o && (o = eg.isBackward(n) ? "anchor" : "focus");
        ...
        setPoint(e, t) {
            ...
            if (r) {
                ...
                var { anchor: a, focus: o } = r,
                    s = "anchor" === i ? a : o;
                eY.setSelection(e, { ["anchor" === i ? "anchor" : "focus"]: eZ(eZ({}, s), t) });
            }
        },
        setSelection(e, t) {
            var { selection: n } = e,
                ...
                if (s) {
                    ...
                    if (!eg.isCollapsed(s)) {
                        if (!l) {
                            var [, _] = eg.edges(s),
                                m = $.end(e, []);
                            ef.equals(_, m) || (s = $.unhangRange(e, s, { voids: o }));
                        }
                        var [h, g] = eg.edges(s),
                            E = $.above(e, {
                                match: (t) => K.isElement(t) && $.isBlock(e, t),
                        ...
                        for (var C of $.nodes(e, {
                            ...
                            var [N, P] = C;
                            (!n || 0 !== el.compare(P, n)) &&
                                ((!o && K.isElement(N) && $.isVoid(e, N)) ||
                                    (!el.isCommon(P, h.path) && !el.isCommon(P, g.path))) &&
                                (A.push(C), (n = P));
                        }
                        ...
                        !O &&
                            ...
                            c &&
                                ...
                                x.length > 1 &&
                                x.match(/[\u0E00-\u0E7F]+/) &&
                                eY.insertText(e, x.slice(0, x.length - a));
                        var H = D.unref(),
                            Y = w.unref(),
                            W = r ? H || Y : Y || H;
        ...
        insertFragment(e, t) {
            ...
            $.withoutNormalizing(e, () => {
                ...
                if (t.length) {
                    if (o) {
                        if (eg.isRange(o))
                            if ((i || (o = $.unhangRange(e, o, { voids: a })), eg.isCollapsed(o))) o = o.anchor;
                            else {
                                var [, s] = eg.edges(o);
                                if (!a && $.void(e, { at: s })) return;
                                var l = $.pointRef(e, s);
                                eY.delete(e, { at: o }), (o = l.unref());
                            }
                        ...
                        if (!(!a && $.void(e, { at: o }))) {
                            ...
                            for (var v of ei.nodes({ children: t }, { pass: O })) O(v) && y.push(v);
                            var S = [],
                                I = [],
                                T = [],
                                A = !0,
                            ...
                            var [P] = $.nodes(e, {
                                ...
                                D = $.isStart(e, o, R),
                                w = $.isEnd(e, o, R),
                                x = $.pathRef(e, _ && !T.length ? el.next(f) : f),
                                L = $.pathRef(e, w ? el.next(R) : R);
                            eY.splitNodes(e, {
                                at: o,
                                match: (t) =>
                                    C ? K.isElement(t) && $.isBlock(e, t) : eA.isText(t) || $.isInline(e, t),
                            ...
                            if (
                                ...
                                !n.at &&
                                    (T.length > 0 && L.current
                                        ? (r = el.previous(L.current))
                                        : I.length > 0 && x.current
