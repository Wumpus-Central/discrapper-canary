...
var eP = (e, t, n) => {
        switch (n.type) {
            ...
            case 'merge_node':
                ...
                if ((O.children.splice(v, 1), t)) for (var [I, S] of eg.points(t)) t[S] = ef.transform(I, n);
                break;
            case 'move_node':
            ...
            case 'split_node':
                ...
                if ((eE.children.splice(eb + 1, 0, ed), t)) for (var [eT, eN] of eg.points(t)) t[eN] = ef.transform(eT, n);
        }
        return t;
    },
    eR = {
