...
function e9(e) {
    ...
    let N = C.width / Math.max(C.height, 1) < eZ.B5,
        _ = 0,
        T = 0,
        S = (0, eF.A)(a?.id);
    if (!S) {
        let e = C.width,
            n = C.height;
        N
            ? ((n = C.width / eZ.B5) > C.height && (e = (n = C.height) * eZ.B5), (T = (C.height - n) / 2))
            : ((e = Math.min(C.height * eZ.B5)) > C.width && (n = (e = C.width) / eZ.B5), (_ = (C.width - e) / 2));
    }
    let R = h.get(a?.id ?? ""),
...
function e7(e) {
    let { maxHeight: n, renderExternalHeader: t } = e,
        ...
        r = (0, eb.bG)([eE.A], () => eE.A.getWindowOpen(er.MLl.ACTIVITY_POPOUT));
    if (!(0, eC.Gp)(i)) return null;
...
function n_(e) {
    let { channel: n } = e,
        t = (0, A.bG)([nb.A], () => nb.A.getChannelConversations(n.id) ?? [], [n.id], nC),
...
function tJ(e) {
    ...
    return (0, l.jsx)(tf.Y, {
        ...
        onRequestClose: () => a(!1),
        renderPopout: (e) =>
            (0, l.jsx)(tQ.A, { ...e, channel: n, navId: "thread-context", label: Y.intl.string(Y.t["1NBjqb"]) }),
        children: (e, n) => {
            let { isShown: i } = n;
...
function t3(e) {
    ...
    return n.isMediaThread()
        ...
        : (0, l.jsxs)(l.Fragment, {
              children: [
                  n.isForumPost() ? null : (0, l.jsx)(tJ, { channel: n }),
                  n.isModeratorReportChannel() ? (0, l.jsx)(tz, { channel: n }) : null,
...
function t5(e) {
    ...
    if (
        (s.useEffect(() => {
            null == i || o.current || ((o.current = !0), (0, t7.rH)(i));
        }, [i]),
        null == i || null == r)
    )
        return null;
    let c = (0, l.jsx)(t3, { channel: i });
                ...
                (0, l.jsxs)("div", {
                    ...
                    children: [
                        ...
                        (0, l.jsx)("div", {
                            ...
                            className: io.__invalid_button,
                            children: (0, l.jsx)(p.$, {
                                variant: "primary",
                                text: Y.intl.string(Y.t["I/XhUn"]),
                                onClick: () => {
                                    (0, ir.rf)(n),
                                        ia.A.open(n, er.BEX.ROLE_SUBSCRIPTIONS, void 0, er.nd0.ROLE_SUBSCRIPTION_TIERS),
                                        (0, id.Fx)(n);
                                },
                            }),
                        }),
...
function ip(e) {
    let { guildId: n, channelId: t } = e,
        i = (0, ih.e)({ guildId: n, channelId: t }),
        a = (0, iu.uk)(n),
        r = (0, iu.Tq)(n),
    ...
    null == d)
        ? (0, l.jsx)("div", {
              ...
              children: (0, l.jsx)(x.y, { className: ix.__invalid_spinner }),
          })
        : (0, l.jsxs)(ti.Ar, {
              className: ix.$$,
              children: [
...
let iS = function (e) {
    ...
    return (
        ...
        (0, l.jsx)(tf.Y, {
            ...
            onRequestClose: () => a(!1),
            renderPopout: function (e) {
                return (0, l.jsx)(iT.A, { ...e, onJump: u, channel: n });
            },
            clickTrap: !0,
            children: (e, n) => {
                let { isShown: i } = n;
...
function iD(e) {
    let { channel: n } = e,
        t = (0, e8.ni)(n),
        i = (0, A.bG)([iO.A], () => iO.A.shouldShowTopicsBar());
    return (0, l.jsx)(tA.Ay.Icon, {
        icon: iR.K,
        onClick: () => {
...
function iV(e) {
    ...
    return (0, l.jsx)(tA.In, {
        tooltip: u,
        icon: iP.m,
        onClick: () => iG.A.hideAdminOnboarding(n.id, !i),
        selected: !i,
    });
}
var iW = t(742589),
...
class i6 extends s.PureComponent {
    ...
    renderVideoCallButton() {
        ...
        return (
            ...
            (0, l.jsx)(tA.Ay.Icon, { icon: iz.n, onClick: e, disabled: u || i, tooltip: c })
        );
    }
    ...
    handleVoiceClick = (e) => {
        ...
        if (
            (i.includes(g.M.ACTIVITY_GDM_CALL_TOOLTIP) &&
                (0, to.Dr)(g.M.ACTIVITY_GDM_CALL_TOOLTIP, { dismissAction: i5.i.AUTO }),
            n)
        );
...
function le(e) {
    let { channel: n } = e,
        ...
        s = (0, A.bG)([i7.A], () => i7.A.isInChannel(n.id)),
...
let lc = s.memo(function (e) {
    ...
    s.useEffect(() => {
        null != r &&
            null != i &&
            (lt.O.announce(Y.intl.string(Y.t.acsXuG)),
            setTimeout(() => {
                (0, ll.xi)(n.id, [r.id]);
            }, 5e3),
            (0, ld.QF)({
            ...
            a &&
                (lt.O.announce(Y.intl.string(Y.t["1dxCqG"])),
                setTimeout(() => {
                    (0, ll.bg)(n.id);
                }, 5e3));
    }, [n, r, i, a]),
...
let lg = s.memo(function (e) {
    let { channel: n } = e,
        t = (0, iZ.A)(),
        i = (0, A.bG)([i7.A], () => i7.A.isInChannel(n.id)),
        a = (0, A.bG)([i7.A], () => !u().isEmpty(i7.A.getVoiceStatesForChannel(n.id))),
        r = (0, A.bG)([lA.A], () => lA.A.can(er.xBc.CONNECT, n)),
        { needSubscriptionToAccess: d } = (0, is.A)(n.id),
        o = (0, lh.Id)(n),
...
var lC = (((i = {}).REAL_NAME_PROMPT = "REAL_NAME_PROMPT"), i),
    ly = t(376943),
    lv = t(394953),
    lN = t(241541),
    l_ = t(709066),
                ...
                for (let e of i)
                    i9.A.isFriend(e.id) || e.id === J.default.getCurrentUser()?.id
                        ? (l[e.id] = {
                              ...
                              activities: $.A.getActivities(e.id) ?? lL,
                          })
...
function sf(e) {
    let { parentChannelId: n } = e,
        t = s.useCallback(() => {
            let e = t9.A.getThreadSettings(n),
                ...
                i = sn.A.getUploads(n, t9.C.FirstThreadMessage);
    ...
    return (0, l.jsxs)(tA.Ay, {
        toolbar: (0, l.jsx)(tA.Ay.Icon, { icon: tE.P, tooltip: Y.intl.string(Y.t.cpT0Cq), onClick: t }),
        children: [
            ...
            return (
                s.useEffect(() => {
                    function t(t) {
                        ...
                        (0 === l.length || !0 === t) && i((0, l1.ur)(l)), n(t9.A.getThreadSettings(e.id) ?? {});
                    }
                    return (
                        t(!0),
            ...
            return {
                ...
                submit: s.useCallback(
                    async (e, l, s) => {
                        ...
                        return (0, l8.x5)(n.id, sx.drafts.type), g(!1), { shouldClear: !0, shouldRefocus: !1 };
                    },
...
function sE(e) {
    let { parentChannel: n, textAreaState: t, setTextAreaState: i, submit: a, error: d } = e,
        ...
        m = s.useCallback(
            (e, t, l) => {
                lZ.A.saveDraft(n.id, t, t9.C.FirstThreadMessage),
                    i(
                        (e) => (
...
function sL(e) {
    let { channel: n, closePopout: t, onSelect: i } = e,
        ...
        f = (0, tR.A)(n),
        j = l6.SY.useSetting(),
        I = (0, A.bG)([i7.A], () => !u().isEmpty(i7.A.getVoiceStatesForChannel(n.id)));
    return (0, l.jsxs)(tj.W, {
        "data-menu-migrated": !0,
        navId: "thread-context",
        onClose: t,
...
function sP(e) {
    ...
    let i,
        ...
        h = (0, tu.Ay)(o);
    (n = o),
        (i = (0, A.bG)([i7.A], () => null != n && !u().isEmpty(i7.A.getVoiceStatesForChannel(n.id)))),
        s.useEffect(() => {
            i &&
                null != n &&
    ...
    if (
        ...
        return null;
    let m = (0, l.jsx)(t3, { channel: o, baseChannelId: r });
    return (0, l.jsxs)(l.Fragment, {
        children: [
...
function an(e) {
    let { context: n, analyticsLocations: t, profileFrame: i, isRedesignEnabled: s, handleOpenProfile: a } = e,
        { showButton: r } = s8.useConfig({ location: "UserProfileSidebarFooter" });
    if (s && !r) return null;
    let d = () => {
    ...
    let o = r
        ...
        : null;
    return null != i
        ? (0, l.jsxs)("div", { className: s6.xQ, children: [(0, l.jsx)(s4.A, { frame: i, filterLayer: ae }), o] })
        : o;
}
var at = t(996988),
    ai = t(556818),
...
function as(e) {
    let { user: n, channel: t, isRedesignEnabled: i } = e,
        ...
        h = (0, sq.pb)({ layout: "SIDEBAR", userId: n.id, channelId: t.id }),
        A = s.useRef(null),
        { isHoveringOrFocusing: g, isHovering: m } = (0, sK.A)(A),
        x = () => {
            ...
            children: (0, l.jsxs)(s1.A, {
                ...
                children: [
                    (0, l.jsxs)(ti.d_, {
                        ...
                        children: [
                            (0, l.jsx)(s9.A, { children: (0, l.jsx)(s3.A, { user: n }) }),
                            (0, l.jsxs)("div", {
                                className: ai.wx,
                                children: [
                                    (0, l.jsx)(sQ.A, {
...
function au(e) {
    let { user: n, channel: t, isRedesignEnabled: i, onHide: a } = e,
        ...
        u = (0, sq.pb)({ layout: "SIDEBAR", userId: n.id, channelId: t.id }),
        h = s.useRef(null);
    return (0, l.jsx)(M.f5, {
        value: c,
        children: (0, l.jsx)(sq.of, {
...
function aV(e) {
    let {
        ...
        { relationshipType: o, originApplicationId: c } = (0, A.cf)([i9.A], () => ({
            relationshipType: i9.A.getRelationshipType(n.id),
            originApplicationId: i9.A.getOriginApplicationId(n.id),
        })),
        u = (0, aR.fi)(n.id),
        h = (0, aL.q)({ userId: n.id }),
        g = (0, A.bG)([aM.A], () => aM.A.hidePersonalInformation),
        m = (0, A.bG)([aj.A], () => aj.A.getUserProfile(n.id)?.application),
    ...
    return (0, l.jsxs)("div", {
        ...
        children: [
                ...
                children: [
                    (0, l.jsx)(s2.Ay, {
                        ...
                        displayNameTrailing: g
                            ? null
                            : (0, l.jsx)(aH.A, { userId: n.id, isVisible: a, onOpenProfile: d }),
                        pronouns: i?.pronouns,
                        trailing: (0, l.jsx)(s$.A, { displayProfile: i, themeType: at.d.SIDEBAR }),
                    }),
                    r && (0, l.jsx)(aB.A, { user: n, onOpenProfile: (e) => d?.({ tabSection: e }) }),
                ],
            }),
            o === er.eA$.PENDING_INCOMING &&
                (0, l.jsx)(s1.A.Overlay, {
                    children: (0, l.jsx)(aG.A, { user: n, channelId: s.id, applicationId: c }),
                }),
            u.map((e) =>
                (0, l.jsx)(
                    s1.A.Overlay,
            ...
            (0, l.jsx)(aU.A, { user: n }),
            i?.private &&
                (0, l.jsx)(s1.A.Overlay, { children: (0, l.jsx)(aw.A, { username: sF.Ay.getName(null, s.id, n) }) }),
            n.isProvisional &&
                (0, l.jsx)(s1.A.Overlay, {
                    className: al.Lw,
            ...
            (0, l.jsxs)("div", {
                className: al.kR,
                children: [
                    r && x && (0, l.jsx)(aC.A, { user: n, widgets: i?.widgets, onOpenUserProfileModal: d }),
                    (0, l.jsx)(aF.A, { user: n, currentUser: t, onOpenUserProfileModal: d }),
                    r
                        ? (0, l.jsxs)(l.Fragment, {
                              children: [
                                  ...
                                  h.length > 0 &&
                                      (0, l.jsx)(s0.A, {
                                          ...
                                          headingColor: "text-strong",
                                          children: (0, l.jsx)(ak.A, { applicationIds: h }),
                                      }),
                              ],
                          })
                        : (0, l.jsxs)(s1.A.Overlay, {
...
function aJ(e) {
    ...
    return (0, l.jsxs)("section", {
        ...
        children: [
            ...
            i.length > 0 && (0, l.jsx)("ul", { id: c, hidden: !u, className: r()(aZ.p_, a), children: i }),
        ],
    });
}
var a0 = t(54557);
function a1(e) {
    let { user: n, channelId: t } = e,
        ...
        { context: s } = (0, sq.NJ)(),
        a = (0, tC.A)(),
        { mutualFriendsCount: r, mutualFriends: d, mutualGuilds: o } = (0, aY.A)(n),
        c = !n.bot && null != r && r > 0,
        u = null != o && o.length > 0;
    return c || u
        ? (0, l.jsxs)(s1.A.Overlay, {
              ...
              children: [
                  ...
                  u && c && (0, l.jsx)(aK.A, { className: a0.yF }),
                  c &&
                      (0, l.jsx)(aJ, {
                          section: "MUTUAL_FRIENDS",
                          header: Y.intl.string(Y.t["0mTJ3j"]),
                          listClassName: a0.p_,
                          onExpand: () => (0, az.A)(n.id, a),
                          items:
                              null == d
                                  ? Array.from({ length: r }).map((e, n) =>
                                        (0, l.jsxs)(
                                            "div",
                                            {
                                                className: a0.nC,
                                                children: [
                                                    (0, l.jsx)(aW.FQ, { width: 40, opacity: 0.08 }),
                                                    (0, l.jsx)(aW.FQ, { width: 135, opacity: 0.08 }),
                                                ],
                                            },
                                            n,
                                        ),
...
function rg(e) {
    let {
        ...
        x = (0, sH.$)("DMSidePanelWishlistItemCard") ? ro.y.SIZE_76 : ro.y.SIZE_90,
        p = ro.Z[x],
        f = s.useCallback(() => {
            m({
                action: ru.Mq.PRESS_WISHLIST_BREADCRUMB_CARD,
                skuId: n.id,
                wishlistId: i,
        ...
        { label: I, icon: b, isPromptingPurchase: E } = (0, rs.h)({ wishlistOwner: t, isOwned: !1, shortText: !0 }),
        [C, y] = s.useState(!1),
        v = ri.useConfig({ location: "dm_side_panel_wishlist_item_card" }).shouldHideSideText;
        ...
        children: [
            (0, l.jsx)("div", {
                ...
                children: (0, l.jsx)(rl.A, {
                    ...
                    skuAssetClassName: C ? c : void 0,
                    onClick: f,
                    "aria-label": Y.intl.formatToPlainString(Y.t.ZBB4Ty, { productName: (0, rt.TC)(n) }),
            ...
            a && !v && (0, l.jsx)(rr, { title: g.title, description: g.description, onClick: f }),
        ],
    });
}
function rm(e) {
...
function rx(e) {
    let { sku: n, wishlistOwner: t, analyticsLocations: i, ...a } = e,
        ...
        o = (0, rd.e)({ sku: n, giftRecipient: t, giftingOrigin: rc.vQ.USER_PROFILE_WISHLIST, analyticsLocations: i }),
        c = s.useMemo(() => {
            switch (n?.tenantMetadata?.collectibles?.type) {
                case a4.R.PROFILE_EFFECT:
                case a4.R.NAMEPLATE:
                case a4.R.BUNDLE:
                case a4.R.PROFILE_FRAME:
                    return;
                case a4.R.AVATAR_DECORATION:
...
function rb(e) {
    let { unownedWishlistItems: n = [], profileOwner: t, onClick: i, wishlistId: a, title: r } = e,
        ...
        m = (0, rj.A)({ wishlistId: a ?? null, onAction: u, productLines: A }),
        x = (0, s.useMemo)(
            () =>
                h
                    .map((e, s) =>
...
function rE(e) {
    let { user: n, currentUser: t, channel: i, isRedesignEnabled: a } = e,
        ...
        g = (0, sq.pb)({ layout: "SIDEBAR", userId: n.id, channelId: i.id }),
        m = s.useRef(null),
        { isHoveringOrFocusing: x, isHovering: p } = (0, sK.A)(m),
        f = (0, aI.fC)(),
    ...
    let E = (0, aA.z)({ opacity: +(null != f.interactionType), config: { duration: 150 } }),
        C = (e) => {
        ...
        { wishlist: N } = (0, af.fw)({ wishlistId: v, userId: n.id });
    (0, ap.A)(N);
            ...
            children: (0, l.jsx)(aI.Hl, {
                ...
                children: (0, l.jsxs)(s1.A, {
                    ...
                    children: [
                        ...
                        null != f.interactionType && (0, l.jsx)(ah.animated.div, { style: E, className: ai.tB }),
                        (0, l.jsxs)(ti.d_, {
                                ...
                                null != _ &&
                                    ...
                                    (0, l.jsx)("div", {
                                        ...
                                        children: (0, l.jsx)(rb, {
                                            ...
                                            onClick: () => {
                                                C?.({ tabSection: ru.RP.WISHLIST });
                                            },
                                        }),
                                    }),
                                !a && (0, l.jsx)(a1, { user: n, channelId: i.id }),
                            ],
                        }),
                        !d &&
                            (0, l.jsx)(an, {
    ...
    return (0, l.jsxs)("div", {
        ...
        children: [
            (0, l.jsxs)(iW.A, {
                ...
                children: [
                    (0, l.jsx)(iW.A.Icon, { icon: rD.N, "aria-hidden": !0 }),
                    (0, l.jsx)(iW.A.Title, { children: Y.intl.string(Y.t["8LKchl"]) }),
                ],
            }),
            (0, l.jsxs)("div", {
                className: rP.Qs,
...
class rJ extends s.PureComponent {
    ...
    maybePreloadChannelCall() {
        ...
        e === er.rbe.GUILD_VOICE ? rK() : e === er.rbe.GUILD_STAGE_VOICE && rX();
    }
    ...
    renderJoinRequestInterviewButtons = () => {
        ...
        return e?.hasFlag(rF.lx.IS_JOIN_REQUEST_INTERVIEW_CHANNEL)
            ? (0, l.jsx)(ii.A, { channelId: e.id, showTrailingDivider: !0 })
            : null;
    };
        ...
        switch (e.type) {
            ...
            case er.rbe.DM:
                d.push(this.renderClipsEnabledIndicatorToolbarItem()),
                    ...
                    d.push((0, l.jsx)(le, { channel: e }, "calls")),
                    d.push((0, l.jsx)(iS, { channel: e }, "pins")),
                    d.push(
                        (0, l.jsx)(
                            ln.Ay,
                    ...
                    d.push((0, l.jsx)(lj, { channel: e, showCallOrActivityPanel: i || s || a }, "profile")),
                    d.push((0, l.jsx)(lc, { channel: e }, "safety_tools"));
                break;
            case er.rbe.GROUP_DM:
                d.push(this.renderJoinRequestInterviewButtons()),
                    ...
                    d.push((0, l.jsx)(iS, { channel: e }, "pins")),
                    e.isManaged() ||
                        d.push((0, l.jsx)(ln.Ay, { channel: e, tooltip: Y.intl.string(Y.t.NB5DFD) }, "invite")),
                    d.push((0, l.jsx)(iv, { channelId: e.id }, "members"));
                break;
            case er.rbe.ANNOUNCEMENT_THREAD:
            case er.rbe.PRIVATE_THREAD:
            case er.rbe.PUBLIC_THREAD:
                e.isModeratorReportChannel() && d.push((0, l.jsx)(tz, { channel: e })),
                    null == n || n.isForumLikeChannel() || d.push((0, l.jsx)(sT, { channel: n }, "browser")),
                    e.isVocalThread() && d.push((0, l.jsx)(lg, { channel: e }, "thread-call")),
                    d.push((0, l.jsx)(tJ, { channel: e }, "notifications")),
                    d.push((0, l.jsx)(iS, { channel: e }, "pins")),
                    e.isArchivedThread() || d.push((0, l.jsx)(iv, { channelId: e.id }, "members")),
            ...
            case er.rbe.GUILD_TEXT:
                d.push((0, l.jsx)(sT, { channel: e }, "browser")),
                    t || d.push((0, l.jsx)(iN.A, { channel: e }, "notifications")),
                    d.push((0, l.jsx)(iS, { channel: e }, "pins")),
                    (0, nl.PD)(e.guild_id, "channel_header") &&
                        d.push((0, l.jsx)(iC, { channelId: e.id }, "conversations")),
                    d.push((0, l.jsx)(iv, { channelId: e.id }, "members")),
            ...
            case er.rbe.GUILD_MEDIA:
                t ||
                    (d.push((0, l.jsx)(iV, { channel: e }, "forum-onboarding")),
                    d.push((0, l.jsx)(iN.A, { channel: e }, "notifications"))),
                    __OVERLAY__ || d.push((0, l.jsx)(iv, { channelId: e.id }, "members"));
                break;
    ...
    renderChat() {
        ...
        if ((o()(null != e, "Missing channel in Channel.renderChat"), t))
            ...
            e?.isRoleSubscriptionTemplatePreviewChannel())
                ...
                : (0, l.jsx)(il.H, { guildId: n.id, children: (0, l.jsx)(ip, { channelId: e.id, guildId: n.id }) });
        if (i) return (0, l.jsx)(rv.A, { guild: n, channelId: e.id });
        if (null != s) return (0, l.jsx)(lV.A, { guild: n, channelId: s });
            ...
            null == e ||
                ...
                (d &&
                    (0, m.openModalLazy)(
                        ...
                        { onCloseCallback: () => it(lC.REAL_NAME_PROMPT, n), modalKey: "Guild Hub Real Name Modal" },
                    ),
                s &&
                    (0, m.openModalLazy)(
                        async () => {
        ...
        if (t === er.YvQ.SIDEBAR_CHAT && null != i) {
            ...
            switch (i.type) {
                ...
                case lH.PE.VIEW_THREAD:
                    let t = n?.isForumLikeChannel() ? t5 : sP;
...
let r0 = (0, ep.A)(rJ),
    r1 = s.memo(function (e) {
        ...
        let i,
            ...
            b = f?.parent_id,
            E = (0, A.bG)([ek.A], () => ek.A.getChannel(b), [b]),
            C = (0, A.bG)([nZ.A], () => nZ.A.getGuild(f?.guild_id), [f]),
            { needSubscriptionToAccess: y } = (0, is.A)(f?.id ?? void 0),
            v = (0, A.bG)([ne.A], () => {
        ...
        let O = (0, A.bG)([eI.Ay], () => eI.Ay.getCurrentEmbeddedActivity()),
            ...
            P = (0, A.bG)(
                [i7.A],
                () => null != f && f.isVocalThread() && !u().isEmpty(i7.A.getVoiceStatesForChannel(f.id)),
                [f],
            ),
            k = null != f && f.isPrivate() && !D && v,
            G = f?.isGuildVocal() || k || P,
            w = (0, A.bG)([t8.A], () => t8.A.getFrameLayoutMode() === rB.y.FOCUSED),
            ...
            V =
                ...
                (i = (0, A.bG)([nZ.A, lE, J.default, X.Ay], () => {
                    ...
                    if (
                        ...
                        !0 === lE.hasViewedPrompt(lC.REAL_NAME_PROMPT, e.id)
                    )
                        return null;
                ...
                s.useEffect(() => {
                    null != n && null != i && (i || it(lC.REAL_NAME_PROMPT, n));
                }, [i, n]),
                !0 === i),
            W =
                ((t = C?.id),
                (0, A.bG)([ek.A, nZ.A, eG.A], () => {
                    ...
                    return U === eG.A.getChannelId(t) && null != n && n.getGuildId() === e.id && (0, rT.ke)(n.type);
                })),
            ...
            K = C?.id,
            q = (0, A.bG)([ib.Ay], () => ib.Ay.getGuildSidebarState(K), [K]),
            Q = (0, lv.lI)(),
            Z = (0, tu.Ay)(f),
            ee = (0, tu.Ay)(f, !0),
        ...
        s.useEffect(() => {
            let e = eA && !eh,
                n = eA && eh && f?.id !== eg;
            (e || n) && (0, to.Dr)(g.M.ACTIVITY_GDM_CALL_TOOLTIP, { dismissAction: i5.i.AUTO });
        }, [f?.id, eg, eh, eA]);
        ...
        return (0, l.jsx)(r0, {
            ...
            ...(0, A.cf)([i7.A], () => ({ hasVideo: null != f && i7.A.hasVideo(f.id) }), [f]),
            inCall: es,
