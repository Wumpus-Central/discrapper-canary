...
let ta = (e) => {
    ...
    } else n = (0, i.jsx)("div", { className: n4.vY, children: o.map((e) => (0, i.jsx)(n9, { entry: e }, e.guildId)) });
    return (0, i.jsx)("div", {
        className: n4.$$,
...
function t4(e) {
    ...
    if (
        (s.useEffect(() => {
            null == l || o.current || ((o.current = !0), (0, t9.rH)(l));
        }, [l]),
        null == l || null == r)
    )
        return null;
                    ...
                    children: (e) => {
                        ...
                        return n === g.M.ACTIVITY_GDM_CALL_TOOLTIP
                            ? (0, i.jsx)(lV.A, {
                                  ...
                                  onRequestClose: () => t(l9.i.USER_DISMISS),
                              })
                            : null;
                    },
                }),
    ...
    handleVoiceClick = (e) => {
        ...
        if (
            (l.includes(g.M.ACTIVITY_GDM_CALL_TOOLTIP) &&
                (0, to.Dr)(g.M.ACTIVITY_GDM_CALL_TOOLTIP, { dismissAction: l9.i.AUTO }),
            n)
        );
...
class rX extends s.PureComponent {
    ...
    renderChat() {
        ...
        if (e.isGuildVocal() || e.isVocalThread()) return null;
        if (e.isDirectory())
            return (
...
let rQ = (0, ep.A)(rX),
    r$ = s.memo(function (e) {
        ...
        s.useEffect(() => {
            let e = eA && !eh,
                n = eA && eh && f?.id !== eg;
            (e || n) && (0, to.Dr)(g.M.ACTIVITY_GDM_CALL_TOOLTIP, { dismissAction: l9.i.AUTO });
        }, [f?.id, eg, eh, eA]);
