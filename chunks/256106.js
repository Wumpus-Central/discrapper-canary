...
function eA(e) {
    let t,
        ...
        [a, E] = (0, eu.Cc)(s ? l : null, r ?? "", en.m.NOTICE_BAR, !0);
    return null == a
        ? null
        : a === b.M.GIFTING_PROMOTION_REMINDER
          ? (0, i.jsx)(e_.y, { markAsDismissed: (e) => E(e) })
          : void 0;
}
var eT = n(264779),
    ed = n(962644),
...
function ej(e) {
    let { onDismiss: t } = e,
        ...
        { shouldShowIncidentActions: o, incidentData: u, isUnderLockdown: _ } = (0, ey.Li)(a),
    ...
    function I(e) {
        if (null != E) {
            ...
            (0, N.openModalLazy)(async () => {
                let e = { source: eL.Eo.NAGBAR, alertType: (0, ek.$5)(u) },
    ...
    21552 == n.j
        ? function () {
              ...
              return (0, i.jsxs)("div", {
                  className: ez()(...A),
                  children: [
                      (0, i.jsx)(_.E, { className: e6.wx, variant: "text-sm/normal", children: E }),
                      (0, i.jsx)(eJ.$, { variant: "overlay-primary", size: "sm", onClick: u, text: o }),
                  ],
              });
          }
        : null;
...
function te(e) {
    ...
    return (0, i.jsxs)(T.$T, {
        className: e8.eR,
        children: [
            r && (0, i.jsx)(T.PM, { onClick: l, className: e8.b, noticeType: ei.kqX.BACK_TO_PREVIOUS_SCREEN }),
...
function tg(e) {
    let { noticeType: t, analyticsLocation: n, location: l, onFallback: r, children: s } = e,
        ...
        u = null != a && a.status === ei.Dmq.PAST_DUE,
        [_, A] = (0, tf.C8)({ subscriptionId: null != a ? a.id : "", preventFetch: !E || !u }),
        d = E && u && null == _ && null == A;
    return (0, i.jsx)(T.Z_, {
        noticeType: t,
        disabled: d,
        onClick: () => {
            E && null != a && null != _
                ? (0, Y.A)({ initialPlanId: a.planIdFromItems, openInvoiceId: _.id, analyticsLocations: o })
                : r();
        },
        children: s,
    });
...
var th = n(378974),
    ...
    ty = n(14594);
function tL() {
    let [e, t] = (0, eu.Wl)(b.M.NAGBAR_NOTICE_IGNORE_USER_FEEDBACK, { cooldownDurationMs: ty.aH });
...
function ni(e) {
    return (0, t6.isWindows)() && o().satisfies(L.A?.os.release, t9.PH)
        ...
        (0, i.jsxs)(T.$T, {
            ...
            children: [
                (0, i.jsx)(T.PM, {
                    noticeType: l,
                    onClick: () => {
                        nr(), (0, N.openModal)((e) => (0, i.jsx)(tQ, { ...e }));
                    },
                }),
                t,
        ...
        ? l.memo(function () {
              ...
              switch (r.type) {
                      ...
                      return (0, i.jsxs)(T.$T, {
                          ...
                          children: [
                              ...
                              es.intl.format(es.t.q8VPLo, {
                                  helpCenterLink: t3.A.getArticleURL(
                      ...
                      return (0, i.jsxs)(T.$T, {
                          ...
                          children: [
                              ...
                              (0, i.jsx)("img", {
                                  alt: "",
                                  className: ea.tV,
                                  src: (0, u.q)(E) ? Z.icon.darkSVG : Z.icon.whiteSVG,
                              }),
                  ...
                  case ei.kqX.UNCLAIMED_ACCOUNT:
                      return (0, i.jsxs)(T.$T, {
                          ...
                          children: [
                              ...
                              (0, i.jsx)(T.Z_, {
                                  noticeType: r.type,
                                  onClick: () => (o && null != t ? (0, eY.Ze)(t) : v.R()),
                              ...
                              (0, i.jsx)(T.Z_, {
                                  ...
                                  onClick: async () => {
                                      try {
                                          ...
                                          null != e && t8.error("Failed to open off-platform premium perk modal", e);
                                      }
                                  },
                  ...
                  case ei.kqX.DISPATCH_INSTALL_SCRIPT_PROGRESS:
                      if (null == r.metadata) return null;
                      let { progress: ec, total: eu, name: e_ } = r.metadata;
                      return (0, i.jsxs)(T.$T, {
                          color: T.Hv.DEFAULT,
                          children: [
                              (0, i.jsx)(T.PM, {
                      ...
                      return (0, i.jsxs)(T.$T, {
                          ...
                          children: [
                              ...
                              (0, i.jsx)(tg, {
                                  ...
                                  onFallback: () => {
                                      nr(ed), (0, Q.openUserSettings)(z.X.SUBSCRIPTIONS_PANEL);
                                  },
