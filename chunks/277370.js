n.d(t, { Jz: () => e1, Ay: () => e2, NE: () => e9 }), n(321073);
var i = n(627968),
    l = n(64700),
    s = n(735438),
    r = n(989349),
    ...
    D = n(231723),
    R = n(192308);
if (21552 == n.j) var x = n(888366);
if (21552 == n.j) var O = n(241541);
var U = n(228366),
    L = n(387755),
    w = n(308528),
    P = n(711950),
...
let F = {
    search(e, t) {
        U.h.dispatch({ type: "PRIVATE_CHANNEL_RECIPIENTS_INVITE_QUERY", query: e, channelId: t });
    },
    clear(e) {
        U.h.dispatch({ type: "PRIVATE_CHANNEL_RECIPIENTS_INVITE_QUERY", query: "", channelId: e });
    },
    select(e) {
        U.h.dispatch({ type: "PRIVATE_CHANNEL_RECIPIENTS_INVITE_SELECT", row: e });
    },
    addUser(e) {
        U.h.dispatch({ type: "PRIVATE_CHANNEL_RECIPIENTS_ADD_USER", userId: e });
    },
    removeUser(e) {
        U.h.dispatch({ type: "PRIVATE_CHANNEL_RECIPIENTS_REMOVE_USER", userId: e });
    },
    open: (e) => U.h.dispatch({ type: "PRIVATE_CHANNEL_RECIPIENTS_INVITE_OPEN", channelId: e }),
    close() {
        U.h.dispatch({ type: "PRIVATE_CHANNEL_RECIPIENTS_INVITE_CLOSE" });
    },
};
var b = n(717398),
    j = n(684136),
...
function X(e) {
    let { location: t } = e,
        { inviteMaxAgeSeconds: n } = K.getConfig({ location: t });
    return n;
}
var Q = n(287809),
    q = n(427262),
...
async function en(e, t) {
    if (0 !== t.length)
        try {
            let n = await G.Ay.createInvite(e, { max_age: X({ location: "5326c5_1" }) }, ee.PE1.GROUP_DM),
                i = new Set();
            for (let e of t) {
            ...
            i.size > 0 &&
                (function (e) {
                    let t = Array.from(e).map((e) => q.Ay.getName(e));
            ...
            (0, h.P0)((0, g.o)(et.intl.string(et.t.iRntUl), f.Ck.FAILURE));
        }
}
var ei = n(279208),
    el = n(267102),
                                          ...
                                          children: [
                                              ...
                                              (0, i.jsx)("span", {
                                                  ...
                                                  children:
                                                      1 === r.length
                                                          ? r[0].name
                                                          : et.intl.format(et.t.E215W7, { count: r.length }),
                                              }),
                                          ],
                                      })
                                    : null,
...
function eZ() {
    (0, h.P0)((0, g.o)(et.intl.string(et.t.fEptJP), f.Ck.FAILURE));
}
let eJ = (e) => {
        let { channel: t, onClose: n } = e,
            l = (0, W.Ay)(t) ?? "",
            s = (0, u.bG)([ef.Ay], () => ef.Ay.lastMessageId(t.id) ?? t.id);
        return (0, i.jsx)(A.D, {
            onClick: () => {
            ...
            children: (0, i.jsxs)("div", {
                className: eH.us,
                children: [
                    (0, i.jsx)(E.eu, { src: (0, Y.Y)(t), size: I._3.SIZE_24, "aria-label": l }),
    ...
    e$ = (e) => {
        ...
        return (0, i.jsx)(o.Modal, {
            ...
            children: s
                ...
                .map((e) => (0, i.jsx)(eJ, { onClose: l.onClose, channel: e }, e.id)),
        });
    };
function eK(e) {
...
class eX extends l.PureComponent {
    ...
    componentDidMount() {
        ...
        let t = (0, H.dI)(e);
        eI.default.track(ee.HAw.OPEN_POPOUT, {
            ...t,
            type: this._getAnalyticsEntryPoint().entryPointType,
            source: this._getAnalyticsEntryPoint().entryPointSource,
            is_friend: !this.isNotFriends(),
        }),
            eS._.subscribe(ee.jej.SCROLL_PAGE_UP, this.scrollPageUp),
            eS._.subscribe(ee.jej.SCROLL_PAGE_DOWN, this.scrollPageDown),
    ...
    trackModalOpened = () => {
        ...
        eI.default.track(ee.HAw.PRIVATE_CHANNEL_INVITE_MODAL_OPENED, {
            ...(0, H.dI)(e),
    ...
    componentWillUnmount() {
        eS._.unsubscribe(ee.jej.SCROLL_PAGE_UP, this.scrollPageUp),
            eS._.unsubscribe(ee.jej.SCROLL_PAGE_DOWN, this.scrollPageDown),
    ...
    getResultsSections() {
        ...
        let i = [],
            l = [];
        for (let t of e) eA.A.isFriend(t.user.id) ? i.push(t) : l.push(t);
        let s = [];
        return (
    ...
    getCreateGroupButtonAction() {
        let { channel: e, selectedUsers: t } = this.props,
            ...
            l = t.size > 1 || null != e ? et.intl.string(et.t["h1/FMu"]) : et.intl.string(et.t.bA875g);
        ...
        return (0, i.jsxs)("div", {
            ...
            children: [
                (0, i.jsx)(m.k, {
                    ...
                    autoFocus: !0,
                    fullWidth: !0,
                    helperText: l ? et.intl.string(d ? et.t.xHuK72 : et.t.FIHggl) : void 0,
                    placeholder: 0 === n.size ? (l ? et.intl.string(et.t["5h0QOP"]) : et.intl.string(et.t.K5e6bn)) : "",
                ...
                l && (0, i.jsx)(eK, { targetElementRef: this.searchBarRef }),
            ],
        });
    }
        ...
        (0, i.jsx)("div", {
            ...
            children: (0, i.jsx)(C.xp, {
                ...
                children: (0, i.jsx)("div", {
                    children: (0, i.jsx)(j.A, { className: eH.RR, closeAction: this.props.onClose, keybind: "ESC" }),
                }),
            }),
        });
    renderBody() {
        ...
        return {
            ...
            renderRow: (l) => {
                ...
                if (a >= o.results.length)
                    return (0, i.jsx)("div", {
                        className: eH.Q_,
                        children: (0, i.jsx)(_.y, { type: _.t.SPINNING_CIRCLE, className: eH.u1 }),
                    });
                let u = o.results[a];
            ...
            renderSection: (n) => {
                ...
                let r = t.has(s.type),
                    a = "friends" === s.type ? et.intl.string(et.t.TdEu5X) : et.intl.string(et.t.y29JXs),
                    o = r ? N._ : T.a;
                return (0, i.jsxs)(A.D, {
                    className: eH.bV,
    ...
    getInviteLinkFooter() {
        ...
        let s = (0, eN.G)("PrivateChannelRecipientsInvite"),
            r = null != t ? (0, ei.A)(t.code) : "",
            a = r.length > 0;
        return (0, i.jsx)(M.D, {
            label: s ? et.intl.string(et.t.dTqtcN) : et.intl.string(et.t.t3O2BR),
            helperText: r.length > 0 ? et.intl.format(et.t.ZVdJMy, { numHours: "24" }) : void 0,
            children: (0, i.jsx)(y.e, {
                supportsCopy: ep.p5,
                placeholder: (0, ei.A)(et.intl.string(et.t.lPVBqP)),
                value: a ? (n ? et.intl.string(et.t["6HzNgZ"]) : r) : "",
                buttonColor: c.$n.Colors.BRAND,
                text: a ? (l ? et.intl.string(et.t.q30c5i) : et.intl.string(et.t.OpuAlK)) : et.intl.string(et.t.qzxqUf),
    ...
    getFooterProps() {
        ...
        if (this.isNotFriends() && !this.allowNonFriendRecipientPicker()) {
            ...
            let n = Q.default.getUser(e),
                i = null != n && eA.A.getRelationshipType(n.id) === ee.eA$.PENDING_OUTGOING;
            return {
                actions: [
                    {
                        variant: "primary",
    ...
    handleQueryChange = (e) => {
        ...
        F.search(e, t?.id),
            ...
            (this._existingTimeout = setTimeout(() => {
                eI.default.track(ee.HAw.SEARCH_USER_LIST_STARTED, {
                    ...n,
    ...
    handleClick = (() => {
        ...
        return function (t) {
            ...
            r
                ? e.getRemaining() > 0 &&
                  (eI.default.track(ee.HAw.CREATE_DM_USER_ROW_INTERACTED, {
                      ...(0, H.dI)(s),
                      section: o,
                      row: u,
                      interaction_type: "select",
                      affinity_score: ea.A.getUserAffinity(t)?.communicationProbability ?? -1,
                  }),
                  F.addUser(t),
                  l.length > 0 && (F.clear(s?.id), e.forceFocus()))
                : (eI.default.track(ee.HAw.CREATE_DM_USER_ROW_INTERACTED, {
                      ...(0, H.dI)(s),
                      section: o,
                      row: u,
    ...
    updateGDM = (e, t) => {
        ...
        "" !== this.state.newChannelName && (n.name = this.state.newChannelName),
            ...
            eI.default.track(ee.HAw.GDM_EDIT_INTERACTED, {
                channel_id: e,
    ...
    createNewDM = (e) => {
        let t = this._searchCounter,
            ...
            i = (0, H.dI)(n),
            l = !0;
        1 === e.length && (l = null == w.A._openCachedDMChannel(e[0]));
        let s = (0, H.g4)(e);
        eI.default.track(ee.HAw.CREATE_DM_USER_LIST_CLICKED, {
            ...i,
            is_new_dm: l,
            entry_point_type: this._getAnalyticsEntryPoint().entryPointType,
            entry_point_source: this._getAnalyticsEntryPoint().entryPointSource,
        ...
        let r = (0, eN.G)("PrivateChannelRecipientsInvite"),
            { channelRecipientIds: a, inviteLinkOnlyUserIds: o } =
                r && e.length > 1 ? eW(e) : { channelRecipientIds: e, inviteLinkOnlyUserIds: [] };
        ez({ recipientIds: a, location: "New Group DM", useGroupDmShell: r && o.length > 0 })
            .then((e) => {
                this.props.onComplete?.(e), this.updateGDM(e, k.A.NEW_GROUP_DM_INVITE_MODAL), en(e, o);
            })
            .catch(eZ);
    };
    ...
    _addRecipientsToExistingGroupDM = (e, t, n) => {
        let { addToDMUpdatesEnabled: i } = this.props,
            l = eg.A.getChannelId() === e;
        (t.length > 0 ? w.A.addRecipients(e, t, ee.ThZ.ADD_FRIENDS_TO_DM) : Promise.resolve(e))
            .then((e) => {
                this.props.onComplete?.(e),
                    i && this.updateGDM(e, ee.ThZ.ADD_FRIENDS_TO_DM),
                    en(e, n),
                    l && t.length > 0 && L.A.ring(e, t, "dm_invite");
            })
            .catch(eZ);
    };
    _promoteDMToGroupDM = (e, t, n, i, l) => {
        let { addToDMUpdatesEnabled: s } = this.props,
            r = eg.A.getChannelId() === e,
            a = eY(t),
            o = l && a ? [...n, t] : n,
            u = l && !a ? [...i, t] : i;
        (a && n.length > 0
            ? w.A.addRecipients(e, n, ee.ThZ.ADD_FRIENDS_TO_DM)
            : o.length > 0 || u.length > 0
              ? ez({ recipientIds: o, location: "New Group DM", useGroupDmShell: l && u.length > 0 })
              : Promise.resolve(e)
        )
            .then((t) => {
                if ((this.props.onComplete?.(t), s && this.updateGDM(t, ee.ThZ.ADD_FRIENDS_TO_DM), en(t, u), r)) {
    ...
    handleInviteUsers = () => {
        ...
        if (null != e) {
            ...
            t.size > 0
                ? (0, R.openModal)(
                      (n) => (0, i.jsx)(e$, { ...n, onConfirm: () => this.pushToExistingDM(e, l), channelIds: t }),
                      {},
            ...
            l.length > 1 && e.size > 0
                ? (0, R.openModal)(
                      (t) => (0, i.jsx)(e$, { ...t, onConfirm: () => this.createNewDM(l), channelIds: e }),
                      {},
                      (0, R.modalContextFromAppContext)(this.context.appContext),
                  )
                : this.createNewDM(l);
    ...
    handleCopyInvite = (e) => {
        ...
        null != n && (0, ep.C)(e),
            ...
            eI.default.track(ee.HAw.COPY_INSTANT_INVITE, {
                server: null,
...
function eQ(e) {
    let { selectedUsers: t, channelName: n, previewIcon: l, onIconChange: s, onIconRemove: r, onChange: a } = e,
        ...
        u = (0, W.Jo)(Array.from(t), Q.default, eA.A);
    return (0, i.jsxs)("div", {
        className: eH.zj,
        children: [
            (0, i.jsx)(J.X, {
...
function eq(e) {
    let { channel: t, onComplete: n, ...l } = e,
        s = (0, u.cf)([eE.A, eh.A, ec.A, ed.A, eA.A], () => {
            let e;
            return (
                null != t && null != (e = ec.A.getInvite(t.id)) && e.isExpired() && (e = null),
                {
                    ...eh.A.getState(),
                    hasFriends: eA.A.getFriendCount() > 0,
                    invite: e,
...
function e0(e) {
    let { channel: t, subscribeToGlobalHotkey: n } = e,
        ...
        r = (0, R.useHasModalOpen)(s),
        a = l.useCallback(
            () =>
                (0, R.openModalLazy)(() => Promise.resolve((e) => (0, i.jsx)(eq, { ...e, channel: t })), {
                    modalKey: s,
                }),
            [t, s],
        ),
        o = l.useCallback(() => (r ? (0, R.closeModal)(s) : a()), [r, s, a]);
    return (
        l.useEffect(
            () => (
                n && eS._.subscribe(ee.jej.TOGGLE_DM_CREATE, o),
                () => {
                    eS._.unsubscribe(ee.jej.TOGGLE_DM_CREATE, o);
                }
            ),
            [n, o],
        ),
...
function e1(e) {
    ...
    (0, R.openModalLazy)(() => Promise.resolve((e) => (0, i.jsx)(eq, { ...e, channel: t, onComplete: n })), {
        modalKey: l,
    });
}
function e2(e) {
    let {
        ...
        c = l.useRef(null),
        h = r ?? (null == t ? x.g : O.D),
        { showModal: g } = e0({ channel: t, subscribeToGlobalHotkey: d }),
...
function e9(e) {
    let {
        ...
        c = l.useRef(null),
        { showModal: h } = e0({ channel: t, subscribeToGlobalHotkey: a }),
        g = l.useMemo(() => (o ? [d.M.INVITE_NONFRIENDS_TO_GDM_COACHMARK] : []), [o]),
        [f, A] = (0, Z.kn)(g),
        E = l.useCallback(() => {
            f === d.M.INVITE_NONFRIENDS_TO_GDM_COACHMARK && A(ej.i.TAKE_ACTION), h();
        }, [h, f, A]);
    return (0, i.jsxs)(i.Fragment, {
        children: [
            ...
            f === d.M.INVITE_NONFRIENDS_TO_GDM_COACHMARK && (0, i.jsx)(eV, { targetElementRef: c, markAsDismissed: A }),
        ],
    });
}
function e7(e) {
