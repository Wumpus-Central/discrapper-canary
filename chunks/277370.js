n.d(t, { Ay: () => e9, NE: () => e5, Jz: () => e2, YW: () => eW }), n(321073);
var i = n(477900),
    l = n(582128),
    s = n(435558),
    r = n(989349),
...
function eb(e) {
    ...
    return (0, i.jsx)(A.D, {
        ...
        children: (0, i.jsxs)(eU.A, {
            ...
            children: [
                (0, i.jsx)(ex.A, { user: t, status: E, className: eG.my }),
                (0, i.jsxs)("div", {
                    className: eG.YW,
                    children: [
                        (0, i.jsx)(p.E, {
...
class eX extends l.PureComponent {
    ...
    componentDidMount() {
        ...
        ep.default.track(et.HAw.OPEN_POPOUT, {
            ...
            eS._.subscribe(et.jej.SCROLL_PAGE_UP, this.scrollPageUp),
            eS._.subscribe(et.jej.SCROLL_PAGE_DOWN, this.scrollPageDown),
            this.createInvite(),
            setTimeout(() => {
                this.forceFocus();
            }, 0);
    ...
    componentWillUnmount() {
        eS._.unsubscribe(et.jej.SCROLL_PAGE_UP, this.scrollPageUp),
            eS._.unsubscribe(et.jej.SCROLL_PAGE_DOWN, this.scrollPageDown),
    ...
    getSubtitle() {
        ...
        if (null == e) return en.intl.format(en.t.t9mhPt, { number: this.getMaxParticipants() });
        let n = this.getRemaining();
        return n <= 0
            ? en.intl.formatToPlainString(en.t.xYr004, { number: this.getMaxParticipants() })
            : en.intl.formatToPlainString(en.t.barkEr, { number: n });
    }
    handleKeyDown(e) {
    ...
    renderSearchBar() {
        ...
        n.forEach((e) => {
            let t = Q.default.getUser(e);
            null != t &&
                r.push({ id: e, label: ee.Ay.getName(t), icon: { type: "avatar", src: t.getAvatarURL(void 0, 32) } });
        });
        ...
        return (0, i.jsxs)("div", {
            ...
            children: [
                (0, i.jsx)(S.k, {
                    ...
                    autoFocus: !0,
                    fullWidth: !0,
                    helperText: en.intl.string(c ? en.t.xHuK72 : en.t.FIHggl),
                    placeholder: 0 === n.size ? en.intl.string(en.t["5h0QOP"]) : "",
    ...
    getInviteLinkFooter() {
        ...
        let s = null != t ? (0, el.A)(t.code) : "",
            r = s.length > 0;
        return (0, i.jsx)(M.D, {
            label: en.intl.string(en.t.dTqtcN),
            ...
            children: (0, i.jsx)(y.e, {
                ...
                value: r ? (n ? en.intl.string(en.t["6HzNgZ"]) : s) : "",
                buttonColor: c.$n.Colors.BRAND,
                text: r ? (l ? en.intl.string(en.t.q30c5i) : en.intl.string(en.t.OpuAlK)) : en.intl.string(en.t.qzxqUf),
    ...
    createNewDM = (e) => {
        ...
        let { channelRecipientIds: r, inviteLinkOnlyUserIds: a } =
            e.length > 1 ? ez(e) : { channelRecipientIds: e, inviteLinkOnlyUserIds: [] };
        eJ({ recipientIds: r, location: "New Group DM", useGroupDmShell: a.length > 0 })
            .then((e) => {
                this.props.onComplete?.(e), this.updateGDM(e, H.A.NEW_GROUP_DM_INVITE_MODAL), ei(e, a);
            })
            .catch(eZ);
    };
    pushToExistingDM = (e, t) => {
        let { channelRecipientIds: n, inviteLinkOnlyUserIds: i } = ez(t),
            l = e.id;
        e.isGroupDM()
    ...
    _promoteDMToGroupDM = (e, t, n, i) => {
        ...
        (s && n.length > 0
            ...
            .then((t) => {
                if ((this.props.onComplete?.(t), ei(t, a), l)) {
...
function e1(e) {
    ...
    return (
        l.useEffect(
            () => (
                n && eS._.subscribe(et.jej.TOGGLE_DM_CREATE, u),
                () => {
                    eS._.unsubscribe(et.jej.TOGGLE_DM_CREATE, u);
                }
            ),
            [n, u],
        ),
...
function e2(e) {
    ...
    (0, O.openModalLazy)(() => Promise.resolve((e) => (0, i.jsx)(e0, { ...e, channel: t, onComplete: n })), {
        modalKey: l,
    });
}
function e9(e) {
