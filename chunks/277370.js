n.d(t, { Ay: () => e7, NE: () => e3, Jz: () => e9, YW: () => eW }), n(321073);
var i = n(627968),
    l = n(64700),
    s = n(735438),
    r = n(989349),
...
function eb(e) {
    ...
    return (0, i.jsx)(A.D, {
        ...
        children: (0, i.jsxs)(ew.A, {
            ...
            className: ey()(eF.Bc, { [eF.oz]: a }),
            children: [
                (0, i.jsx)(eU.A, { user: t, status: E, className: eF.my }),
                (0, i.jsxs)("div", {
                    className: eF.YW,
                    children: [
                        (0, i.jsx)(p.E, {
                        ...
                        (0, i.jsxs)(p.E, {
                            ...
                            color: "text-muted",
                            className: null != r && r.length > 0 ? eF.dj : void 0,
                            children: [
                                (0, i.jsx)(ex.A, {
                                    user: t,
                                    hideDiscriminator: l,
        ...
        return (0, i.jsx)(A.D, {
            ...
            children: (0, i.jsxs)("div", {
                ...
                children: [
                    ...
                    (0, i.jsx)("span", { className: eB.J2, children: l }),
...
class eQ extends l.PureComponent {
    ...
    componentDidMount() {
        ...
        ep.default.track(et.HAw.OPEN_POPOUT, {
            ...
            (0, eT.G)("PrivateChannelRecipientsInvite") && this.createInvite(),
            setTimeout(() => {
                this.forceFocus();
            }, 0);
    }
    ...
    renderSearchBar() {
        ...
        let l = (0, eT.G)("PrivateChannelRecipientsInvite"),
            s = [];
        n.forEach((e) => {
            let t = Q.default.getUser(e);
            null != t &&
        ...
        return (0, i.jsxs)("div", {
            ...
            children: [
                ...
                l && (0, i.jsx)(eq, { targetElementRef: this.searchBarRef }),
            ],
        });
    }
    ...
    getFooterProps() {
        ...
        if (null == t || (t.isDM() && l)) {
            let e = null != t || n.size > 1,
                r = new Set(t?.isDM() && l ? [t.getRecipientId(), ...n] : n),
                a = null == t || (t.isDM() && s);
            return {
                actionBarInput: e
                    ? (0, i.jsx)(e0, {
    ...
    _promoteDMToGroupDM = (e, t, n, i, l) => {
        ...
        (a && n.length > 0
            ...
            .then((t) => {
                if ((this.props.onComplete?.(t), s && this.updateGDM(t, et.ThZ.ADD_FRIENDS_TO_DM), ei(t, u), r)) {
    ...
    handleInviteUsers = () => {
        let { channel: e, selectedUsers: t, onClose: n } = this.props,
            l = Array.from(t);
        if (null != e) {
            let t = e5(Array.from(new Set([...e.recipients, ...l])));
            t.size > 0
                ? (0, O.openModal)(
...
function e1(e) {
    let { channel: t, onComplete: n, entryPointType: l, ...s } = e,
        ...
        { enabled: o } = eN.n.useConfig({
            location: t?.isDM() ? "DM Channel Invite Modal" : "Invalid Channel for Experiment",
        }),
        { canCustomizeGDM: d, addCancelButton: c } = eN.c.useConfig({
            location: t?.isDM() ? "DM Channel Invite Modal" : "Invalid Channel for Experiment",
        });
    return (0, i.jsx)(eQ, {
        channel: t,
