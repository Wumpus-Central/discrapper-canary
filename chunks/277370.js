...
function eK(e) {
    ...
    return (0, i.jsx)(o.Modal, {
        ...
        input: (0, i.jsx)(S.E, { variant: "text-md/normal", className: eH.Jv, children: en.intl.string(en.t.cjE7wH) }),
        ...l,
        children: s
            .filter(e_.Vq)
            .sort((e, t) => {
...
class eq extends l.PureComponent {
    ...
    componentDidMount() {
        ...
        let t = (0, B.dI)(e);
        eS.default.track(et.HAw.OPEN_POPOUT, {
            ...t,
    ...
    trackModalOpened = () => {
        ...
        eS.default.track(et.HAw.PRIVATE_CHANNEL_INVITE_MODAL_OPENED, {
            ...(0, B.dI)(e),
    ...
    handleQueryChange = (e) => {
        ...
        b.search(e, t?.id),
            ...
            (this._existingTimeout = setTimeout(() => {
                eS.default.track(et.HAw.SEARCH_USER_LIST_STARTED, {
                    ...n,
    ...
    handleClick = (() => {
        ...
        return function (t) {
            ...
            r
                ? e.getRemaining() > 0 &&
                  (eS.default.track(et.HAw.CREATE_DM_USER_ROW_INTERACTED, {
                      ...(0, B.dI)(s),
                      section: o,
                      row: u,
    ...
    updateGDM = (e, t) => {
        ...
        "" !== this.state.newChannelName && (n.name = this.state.newChannelName),
            ...
            eS.default.track(et.HAw.GDM_EDIT_INTERACTED, {
                channel_id: e,
    ...
    createNewDM = (e) => {
        ...
        let s = (0, B.g4)(e);
        eS.default.track(et.HAw.CREATE_DM_USER_LIST_CLICKED, {
            ...i,
            is_new_dm: l,
            entry_point_type: this._getAnalyticsEntryPoint().entryPointType,
            entry_point_source: this._getAnalyticsEntryPoint().entryPointSource,
    ...
    handleCopyInvite = (e) => {
        ...
        null != n && (0, ep.C)(e),
            ...
            eS.default.track(et.HAw.COPY_INSTANT_INVITE, {
                server: null,
