...
n.d(t, { Ay: () => np }), n(323874), n(14289), n(35956), n(321073), n(790599);
var p = n(284009),
    h = n.n(p),
    E = n(735438),
    m = n.n(E),
...
let eF = new P.A("MediaEngineStore"),
    ...
    ej = 2 * eI.A.Millis.SECOND,
    eY = 30 * eI.A.Millis.SECOND,
    eW = +eI.A.Millis.MINUTE,
...
function ez() {
    return {
        ...
        qos: !1,
        qosMigrated: !1,
        videoHook: eX.supports(eU.O5.VIDEO_HOOK),
...
let eQ = {},
    eZ = new Set([eU.x.DEFAULT]),
    eJ = eX.supports(eU.O5.AUTO_ENABLE),
    e0 = !1,
    e1 = eU.x.STREAM,
    e2 = performance.now(),
    e3 = null,
    e6 = { [eU.dx]: t4("No Input Devices") },
    e4 = { [eU.dx]: t4("No Output Devices") },
    e7 = { [eU.dx]: t4("No Video Devices") },
    e5 = new v.Ep(),
    e8 = !1,
    e9 = !1,
    te = !1,
...
function tW(e) {
    ...
    e.context === eU.x.DEFAULT
        ? (n = n || e8 || e9 || te || !ec.A.didHavePermission(eP.iL.AUDIO))
    ...
    if (
        (n?.desktopSource != null &&
            ...
            (null != n.desktopSource.soundshareId && (0, eT.isWindows)()
                ? R.c1(n.desktopSource.soundshareId)
                : null != n.desktopSource.sourcePid && tH().videoHook && R.c1(n.desktopSource.sourcePid),
        ...
        tn && t === eU.dx && ti === eU.dx && tr !== eU.qe ? (t = tr) : (ti = t),
            (tr = (tn = e) ? t5(e7, t) : eU.qe),
            eX.setVideoInputDevice(tr);
    }
    if (((s = t), null != t)) {
        let e = { resolution: t.quality.resolution, frameRate: t.quality.frameRate };
        if (null != t.desktopSource) {
            let n = tF("MediaEngineStore go live"),
                i = tH().videoHook,
                s = tZ(),
                a = s ? ((0, eT.isWindows)() && T().satisfies(O.A?.os.release, eM.fG) ? eM.zl : eM.eg) : 0,
                o = !1;
            (0, eT.isWindows)() &&
                a >= eM.zl &&
                (o =
...
function tQ(e) {
    ...
    if (
        ...
        tq(e, eO.A.hasAutomaticGainControl(n) || t.automaticGainControl),
...
function tZ() {
    return (0, eT.isWindows)() && T().satisfies(O.A?.os.release, eM.yg);
}
function tJ() {
    return (0, eT.isMac)() && eX.supports(eU.O5.SCREEN_CAPTURE_KIT) && T().satisfies(O.A?.os.release, eM.e);
}
function t0() {
    return (
        (0, eT.isWindows)() &&
        eX.supports(eU.O5.AUTOMATIC_AUDIO_SUBSYSTEM) &&
        eX.supports(eU.O5.AUDIO_SUBSYSTEM_DEFERRED_SWITCH)
    );
}
function t1() {
    return eX.supports(eU.O5.AUDIO_BYPASS_SYSTEM_INPUT_PROCESSING);
}
function t2(e) {
    let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : eU.x.DEFAULT,
        n = !(arguments.length > 2) || void 0 === arguments[2] || arguments[2],
        r = tB(t);
    return Object.assign(r, e), !__OVERLAY__ && n && N.w.set(eV, eQ), r;
}
function t3() {
    let e = tH();
    t9(e.inputDeviceId),
...
function t6() {
    eJ || eX.enable().then(() => C.h.dispatch({ type: "MEDIA_ENGINE_SET_AUDIO_ENABLED", enabled: !0, unmute: !1 }));
}
function t4(e) {
...
function t5(e, t) {
    let n = e[t] ?? e[eU.dx] ?? m()(e).values().first();
    return null != n ? n.id : t;
}
function t8(e) {
    if (!(0, eT.isWindows)() || !j.A.getConfig({ location: "MediaEngineStore.setInputDevice" }).probeAudioEffects)
        return;
    let t = e6[e];
...
function nn(e, t) {
    if (t) {
        ...
        if (null != t) {
            ...
            return (
                ...
                (0, eT.isWindows)() &&
                    n > 1 &&
                    R.GH(n, { soundshare_session: i }).then((e) => {
                        null == e ||
                            F.Ay.shouldContinueWithoutElevatedProcessForPID(n) ||
                            C.h.wait(() => {
                                C.h.dispatch({ type: "MEDIA_ENGINE_SOUNDSHARE_FAILED", errorMessage: e });
                            });
                    }),
    ...
    return null != e && tH().videoHook && R.GH(e), { soundshareId: null, soundshareSession: null };
}
function nr() {
    let e = eU.x.DEFAULT,
...
function ns() {
    let e = tH(),
        ...
        i = eO.A.hasNoiseSuppression(n) || e.noiseSuppression,
        s = tz(eO.A.hasAutomaticGainControl(n) || e.automaticGainControl),
...
async function na() {
    if (!eX.supports(eU.O5.VAAPI) || window.DiscordNative?.processUtils?.getSystemInfo == null) return;
    let e = await window.DiscordNative.processUtils.getSystemInfo();
    (e.electronGPUInfo?.gpuDevice ?? []).some((e) => 4098 === e.vendorId) &&
        ((tU = !0), (tk = eX.supports(eU.O5.GAMESCOPE_CAPTURE)));
}
async function no() {
    try {
        ...
        eF.warn(`Failed to load Krisp module: ${t.message}`), eS.A.captureException(t);
...
function nu(e) {
    e === eU.rB.AUTOMATIC
        ? (t2({ automaticAudioSubsystem: !0 }), nc())
        : (t2({ automaticAudioSubsystem: !1 }), eX.setAudioSubsystem(e));
}
function nc() {
    eX.queueAudioSubsystem(eU.rB.EXPERIMENTAL);
}
function nd(e) {
    let { section: t } = e;
...
class n_ extends S.Ay.Store {
    ...
    initialize() {
        ...
        if (
            (e5.start(eY, () => {
                eF.error("Device enumeration timed out"), eg.default.track(ew.HAw.DEVICE_ENUMERATION_TIMEOUT, {});
            }),
            eX.on(y.bg.Connection, (e) => {
                ...
                e.setAttenuation(t.attenuation, t.attenuateWhileSpeakingSelf, t.attenuateWhileSpeakingOthers),
                    ...
                    (0, eT.isWindows)()
                        ...
                        : (0, eT.isMac)() && e.setExperimentFlag(eU.fd.H265_HARDWARE_DECODE_AVAILABLE, !0),
                    (0, eT.isLinux)() && t.openH264Enabled && e.setExperimentFlag(eU.fd.USE_LIBOPENH264_DECODER, !0),
                    ...
                    e.setExperimentFlag(eU.fd.SOFTWARE_FALLBACK_ON_CONSECUTIVE_ERRORS, !0);
                let { swallowVolumeOnlySpeakingEvents: n } = D.A.getConfig({ location: "MediaEngineStore" });
                if (
                    (n && e.setExperimentFlag(eU.fd.SWALLOW_VOLUME_ONLY_SPEAKING_EVENTS, !0), e.context === eU.x.STREAM)
                ) {
                    let t = ne(e4);
                    e.setSoundshareDiscardRearChannels(t);
                }
                if ((0, eT.isWindows)())
                    e.setExperimentFlag(eU.fd.SIGNAL_AV1, !0),
                        e.setExperimentFlag(eU.fd.SIGNAL_AV1_HARDWARE_DECODE, !0);
                else if ((0, eT.isMac)())
                    e.setExperimentFlag(eU.fd.SIGNAL_AV1_DECODE, !0),
                        e.setExperimentFlag(eU.fd.SIGNAL_AV1_HARDWARE_DECODE, !0);
                else if ((0, eT.isLinux)()) e.setExperimentFlag(eU.fd.SIGNAL_AV1_DECODE, !0);
                else if ((0, eT.isIOS)())
                    e.setExperimentFlag(eU.fd.SIGNAL_AV1_DECODE, !0),
                        e.setExperimentFlag(eU.fd.SIGNAL_AV1_HARDWARE_DECODE, !0);
                ...
                (0, eT.isWindows)() &&
                    ...
                    (0, eo.F)("MediaEngineStore").enabled &&
                    e.setExperimentFlag(eU.fd.WMF_GPU_ENCODE, !0),
                eX.setHasFullbandPerformance((0, x.A)()),
                ...
                e.on(y.yq.Speaking, (t, n, r, i) => {
                    ...
                    e.on(y.yq.VoiceActivityDetectorError, (e) => {
                        eF.warn(`voiceactivitydetectorerror event: ${e}`),
                            ...
                            C.h.dispatch({
                                ...
                                mode: ew.TBI.VOICE_ACTIVITY,
                                options: { ...tH(eU.x.DEFAULT).modeOptions, vadUseKrisp: !1 },
                            }),
                    ...
                    (0, eT.isWindows)() &&
                        eX.supports(eU.O5.ASYNC_VIDEO_INPUT_DEVICE_INIT) &&
            ...
            eX.on(y.bg.WatchdogTimeout, async () => {
                ...
                let t =
                    ei.A.getConfig({ location: "watchdog_timeout" }).enabled && null != O.A.processUtils.setCrashReason;
                try {
                ...
                t &&
                    ...
                    await O.A.processUtils.setCrashReason("voice-watchdog-timeout"),
            ...
            eX.on(y.bg.ClipsRecordingEnded, (e, t) => {
                a?.desktopSource?.id === e &&
                    (null != t && s?.desktopSource?.soundshareId !== t && R.c1(t), (a = null));
            }),
            ...
            null != (e = N.w.get("audio")) && (N.w.set(eV, { [eU.x.DEFAULT]: e }), N.w.remove("audio")),
            (eQ = N.w.get(eV) ?? {}),
            m().each(eQ, (e) => {
                m().defaultsDeep(e, ez()),
                    null != e.modeOptions &&
                    ...
                    eX.supports(eU.O5.SIDECHAIN_COMPRESSION) &&
            ...
            t3(),
            ((0, eT.isWindows)() || (0, eT.isLinux)() || (0, eT.isMac)()) && !__OVERLAY__ && !tp && !th
                ? ((tp = !0), no())
                : (0, eT.isWeb)() && eX.supports(eU.O5.NOISE_CANCELLATION)
                  ? ((th = !0), r.emitChange())
            ...
            let e = async () => {
                ...
                t.periodMs = eU.tl;
                let n = nf(t);
                null !== n && eg.default.track(ew.HAw.VOICE_QUEUE_METRICS, n), setTimeout(e, eU.tl);
            };
            setTimeout(e, eU.tl);
        }
        (0, eT.isWindows)() &&
            ...
            eX
                ...
                .then((e) => {
                    try {
                        ...
                        eF.error("Failed to parse codec survey", e), (e3 = !1);
                    }
                })
                .catch((e) => {
                    eF.error("Failed to get codec survey", e), (e3 = !1);
                })
                .finally(() => {
            ...
            (0, eT.isAndroid)(),
            (tb = {
                [eU.O5.VIDEO]: eX.supports(eU.O5.VIDEO),
                [eU.O5.DESKTOP_CAPTURE]: eX.supports(eU.O5.DESKTOP_CAPTURE),
                [eU.O5.HYBRID_VIDEO]: eX.supports(eU.O5.HYBRID_VIDEO),
            }),
            this.waitFor(ev.default, eC.A, eO.A, eR.A, L.A, U.A, eb.A, F.Ay, eE.A, eD.default, eL.A);
    }
    supports(e) {
    ...
    isNoiseSuppressionSupported() {
        return eX.supports(eU.O5.NOISE_SUPPRESSION);
    }
    ...
    isAutomaticGainControlSupported() {
        return eX.supports(eU.O5.AUTOMATIC_GAIN_CONTROL);
    }
    shouldOfferManualSubsystemSelection() {
        return !t1() && (eX.supports(eU.O5.LEGACY_AUDIO_SUBSYSTEM) || eX.supports(eU.O5.EXPERIMENTAL_AUDIO_SUBSYSTEM));
    }
    showBypassSystemInputProcessing() {
        return eX.supports(eU.O5.AUDIO_BYPASS_SYSTEM_INPUT_PROCESSING) && "experimental" === eX.getAudioSubsystem();
    }
    isAdvancedVoiceActivitySupported() {
        return th || !1;
    }
    isAecDumpSupported() {
        return eX.supports(eU.O5.AEC_DUMP);
    }
    isSimulcastSupported() {
        return eX.supports(eU.O5.VIDEO) && eX.supports(eU.O5.SIMULCAST);
    }
    getAecDump() {
    ...
    isLocalMute(e) {
        let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : eU.x.DEFAULT;
        return e !== ev.default.getId() && (tH(t).localMutes[e] || !1);
    }
    supportsDisableLocalVideo() {
        return eX.supports(eU.O5.DISABLE_VIDEO);
    }
    ...
    isLocalVideoAutoDisabled(e) {
        let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : eU.x.DEFAULT;
        return t === eU.x.DEFAULT && tC.has(e);
    }
    isAnyLocalVideoAutoDisabled() {
        let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : eU.x.DEFAULT;
        return e === eU.x.DEFAULT && tC.size > 0;
    }
    ...
    getShortcuts() {
        ...
        return (
            m().each(eQ, (t, n) => {
                ...
                r === ew.TBI.PUSH_TO_TALK && eZ.has(n) && (e[n] = i);
            }),
            e
        );
    }
    getInputDeviceId() {
        return t5(e6, tH().inputDeviceId);
    }
    getOutputDeviceId() {
        return t5(e4, tH().outputDeviceId);
    }
    getVideoDeviceId() {
        return t5(e7, tH().videoDeviceId);
    }
    getInputDevices() {
        return e6;
    }
    ...
    getSidechainCompression() {
        return eX.supports(eU.O5.SIDECHAIN_COMPRESSION) && tH().sidechainCompression;
    }
    ...
    getAudioSubsystem() {
        return t0() && tH().automaticAudioSubsystem ? eU.rB.AUTOMATIC : eX.getAudioSubsystem();
    }
    ...
    supportsVideoHook() {
        return eX.supports(eU.O5.VIDEO_HOOK);
    }
    ...
    supportsExperimentalSoundshare() {
        return eX.supports(eU.O5.EXPERIMENTAL_SOUNDSHARE) && T().satisfies(O.A?.os.release, eM.$x);
    }
    supportsHookSoundshare() {
        return (0, eT.isWindows)() && eX.supports(eU.O5.SOUNDSHARE) && T().satisfies(O.A?.os.release, eM.ws);
    }
    ...
    supportsSystemScreensharePicker() {
        return eX.supports(eU.O5.NATIVE_SCREENSHARE_PICKER);
    }
    getUseVaapiEncoder() {
        return tU;
    }
    getVideoEncoderExperiments(e, t) {
        ...
        if (
            ...
            e === eU.x.STREAM && "streamer" === t && (0, eT.isWindows)())
        ) {
    ...
    supportsScreenSoundshare() {
        return (0, eT.isMac)()
            ? eX.supports(eU.O5.SOUNDSHARE) && T().satisfies(O.A?.os.release, eM.P$) && tJ()
            : (0, eT.isWindows)()
              ? eX.supports(eU.O5.SCREEN_SOUNDSHARE) && this.getExperimentalSoundshare()
              : !!(0, eT.isLinux)() && eX.supports(eU.O5.SCREEN_SOUNDSHARE);
    }
        ...
        !tT &&
            ...
            (0, eT.isWeb)() &&
                eX.fetchAsyncResources({ fetchDave: !0 }).catch((e) => {
                    eF.warn("DAVE preload failed:", e), eS.A.captureException(e);
                }));
    }
...
(r = new n_(C.h, {
    VOICE_CHANNEL_SELECT: function (e) {
        ...
        tf = !0;
        let s = tH();
        (s.mute || s.deaf) && (t2({ deaf: !1, mute: !1 }), eX.eachConnection(tW));
    },
    VOICE_STATE_UPDATES: function (e) {
        let { voiceStates: t } = e;
        return t.reduce((e, t) => {
            if (i === t.sessionId) {
                (e8 = t.mute || t.suppress), (tt = t.deaf), eX.eachConnection(tW);
                let e = null != t.guildId && null != t.channelId && null != tg && tg !== t.channelId,
                    n = !tf && null == t.channelId;
                return tK(!e && !n && tn), (tg = t.channelId), !0;
            }
            return __OVERLAY__ || t.userId !== ev.default.getId() || null != eb.A.getChannelId() || tK(!1, null), e;
        }, !1);
    },
    CONNECTION_OPEN: function (e) {
        (i = e.sessionId), (e8 = !1), (tt = !1);
        let t = tH();
        t0() && (t1() ? nu(eU.rB.AUTOMATIC) : t.automaticAudioSubsystem && nc()),
            eX.supports(eU.O5.OFFLOAD_ADM_CONTROLS) && eX.setOffloadAdmControls(!0),
            (0, eT.isIOS)() &&
    ...
    RTC_CONNECTION_STATE: function (e) {
        switch (e.state) {
            ...
            case ew.S7L.RTC_CONNECTING:
                (td = !1), (l = void 0), (u = void 0), (tc = !1), (tM = !1), tP.stop(), t_.stop(), o.reset();
                break;
    ...
    AUDIO_SET_TEMPORARY_SELF_MUTE: function (e) {
        let { mute: t } = e;
        (e9 = t), eX.eachConnection(tW);
    },
    AUDIO_TOGGLE_SELF_MUTE: function (e) {
        let { context: t, playSoundEffect: n } = e,
            { mute: r, deaf: i } = tH(t);
        if (t === eU.x.DEFAULT && (ec.A.requestPermission(eP.iL.AUDIO), te)) return !1;
        (r = !i && !r) || (i = !1), n || (ts = !0), t2({ mute: r, deaf: i }, t), eX.eachConnection(tW);
    },
    AUDIO_SET_SELF_MUTE: function (e) {
        let { context: t, mute: n, playSoundEffect: r } = e;
        t2({ mute: n }, t), r || (ts = !0), eX.eachConnection(tW);
    },
    AUDIO_TOGGLE_SELF_DEAF: function (e) {
        let { context: t } = e;
        t2({ deaf: !tH(t).deaf }, t), eX.eachConnection(tW);
    },
    ...
    AUDIO_SET_LOCAL_VIDEO_DISABLED: function (e) {
        ...
        let { videoToggleStateMap: E } = tH(t);
        if (
            (E[n] === ew.bb8.AUTO_PROBING &&
                r === ew.bb8.AUTO_ENABLED &&
                (0, eu.A)(n, a ? eU.Al.AUTO_DISABLE : eU.Al.AUTO_ENABLE, c),
            (E[n] = r),
            t2({ videoToggleStateMap: E }, t, i),
            ...
            tO ||
                (eF.info(`isAutoDisableAllowed=${tO} - disabling VideoHealthManager`),
                eb.A.getRTCConnection()?.getVideoHealthManager()?.disable()),
            f)
        ) {
            if ((!a && !u) || (a && !tO)) return;
            (0, eu.A)(n, a ? eU.Al.AUTO_DISABLE : eU.Al.AUTO_ENABLE, c), a ? tC.add(n) : tC.delete(n);
        } else
            p &&
                (u && !a
    ...
    AUDIO_SET_MODE: function (e) {
        ...
        t2({ mode: n, modeOptions: { ...r, updatedAt: Date.now() } }, t), eX.eachConnection(tj);
    },
    AUDIO_SET_INPUT_VOLUME: function (e) {
        let { volume: t } = e;
        t2({ inputVolume: tY(t) }), eX.setInputVolume(t);
    },
    ...
    AUDIO_SET_OUTPUT_DEVICE: function (e) {
        let { id: t } = e;
        t2({ outputDeviceId: (t = t5(e4, t)) }), eX.setAudioOutputDevice(t);
    },
    ...
    AUDIO_SET_LOOPBACK: function (e) {
        ...
        return t ? tR.add(n) : tR.delete(n), ns();
    },
    ...
    AUDIO_SET_KRISP_MODEL_OVERRIDE: function (e) {
        ed.A.setKrispModelOverride(e.model), (_ = e.model), ns();
    },
    ...
    MEDIA_ENGINE_DEVICES: function (e) {
        let { inputDevices: t, outputDevices: n, videoDevices: r } = e,
            i = e6;
        if (((e6 = t7(t, eG.intl.string(eG.t["/QIjDA"]))), !m().isEqual(e6, i))) {
            let e = tH();
            t9(t5(e6, e.inputDeviceId)), eX.eachConnection(tQ);
        }
        !(function (e) {
            let t = e4;
            if (((e4 = t7(e, eG.intl.string(eG.t.xlUg0v))), !m().isEqual(e4, t))) {
                let e = tH(),
                    n = t5(e4, e.outputDeviceId);
                eX.setAudioOutputDevice(n);
                let r = ne(t),
                    i = ne(e4);
                r !== i &&
                    eX.eachConnection((e) => {
                        e.context === eU.x.STREAM && e.setSoundshareDiscardRearChannels(i);
                    });
            }
        })(n);
        tu = r.length > 0;
        let s = e7;
        if (((e7 = t7(r, eG.intl.string(eG.t.WKWARY))), tn && !m().isEqual(e7, s))) {
            let e = void 0 !== e7[tr],
                t = tr === eU.dx && s[eU.dx]?.disabled,
    ...
    AUDIO_VOLUME_CHANGE: function (e) {
        ...
        t2({ inputVolume: tY(t), outputVolume: n });
    },
    AUDIO_RESET: function () {
        N.w.remove(eV), location.reload();
    },
    AUDIO_INPUT_DETECTED: function (e) {
        let { inputDetected: t } = e;
        if (null == t) return !1;
        if (((td = !0 !== tc && !t), t)) (tc = !0), (tM = !1), tP.stop(), t_.stop();
        else if (tH().mode === ew.TBI.VOICE_ACTIVITY && tc) {
            ...
            e &&
                tP.start(eW, () => {
                    eg.default.track(ew.HAw.HARDWARE_MUTE_GUESSED, {
                        input_device_name: e6[t5(e6, tH().inputDeviceId)]?.name,
                        rtc_connection_id: eb.A.getRTCConnectionId(),
                    }),
                        (tM = !0),
                        r.emitChange();
    ...
    MEDIA_ENGINE_SET_AUDIO_ENABLED: function (e) {
        (eJ = e.enabled), e.unmute && t2({ mute: !1, deaf: !1 }), eX.eachConnection(tW);
    },
    MEDIA_ENGINE_SET_VIDEO_ENABLED: function (e) {
        let { enabled: t } = e;
        ec.A.requestPermission(eP.iL.CAMERA), tK(t);
    },
    ...
    MEDIA_ENGINE_RESET_SETTINGS: function (e) {
        ...
        (eQ = Object.values(eU.x).reduce((e, n) => {
            let r = ez();
    ...
    CLIPS_INIT: function (e) {
        ...
        if (!(0, M.Ao)() || null == O.A) return !1;
        null != a &&
            (eX.setClipsSource(null),
            (0, eT.isWindows)() &&
                (null != a.desktopSource.soundshareId
                    ? R.c1(a.desktopSource.soundshareId)
                    : null != a.desktopSource.sourcePid && tH().videoHook && R.c1(a.desktopSource.sourcePid)));
        ...
        let u = tF("MediaEngineStore clips"),
            c = tH().videoHook,
