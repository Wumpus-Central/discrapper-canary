...
function ns(e) {
    let t = ni(e.context),
        n = t.mode;
    e.context === eH.x.DEFAULT && (0, er.N)(!1, !1);
    ...
    if (((s = t), null != t)) {
        ...
        if (null != t.desktopSource) {
            let n = ne("MediaEngineStore go live"),
                ...
                o = (0, eN.isWindows)() && (0, eo.b)("updateVideo").enabled,
                l = !1;
            (0, eN.isWindows)() &&
                a >= eG.zl &&
                (l =
...
function np(e, t) {
    ...
    let { noiseCancellationAfterProcessing: s, vadAfterWebrtc: a } = (0, ee.$)({ location: "setNoiseCancellation" });
    ...
    tg.start(e3, () => {
        ...
        to.on(T.bg.Connection, (e) => {
            ...
            e.setAttenuation(t.attenuation, t.attenuateWhileSpeakingSelf, t.attenuateWhileSpeakingOthers),
                ...
                (0, eN.isLinux)() &&
                    (0, et.b)({ location: "setupMediaEngine" }).enabled &&
                    t.openH264Enabled &&
            ...
            (0, eN.isWindows)() &&
                ...
                (0, ec.F)("MediaEngineStore").enabled &&
                e.setExperimentFlag(eH.fd.WMF_GPU_ENCODE, !0),
            to.setHasFullbandPerformance((0, M.A)()),
            e.setRemoteAudioHistory(1e3),
            (0, D.A)(r) && e.setClipsKeyFrameInterval(eH.X1),
            (t = ni(e.context)),
...
function nG(e) {
    ...
    if (
        ...
        (0, eN.isDesktop)()
            ...
            : ((0, eN.isIOS)() || (0, eN.isAndroid)()) && (e = (0, j.Y)({ location: "handleConnectionOpen" }).enabled),
...
function nZ(e) {
    ...
    if (
        ...
        if ((!a && !u) || (a && !tQ)) return;
        (0, e_.A)(n, a ? eH.Al.AUTO_DISABLE : eH.Al.AUTO_ENABLE, c), a ? tX.add(n) : tX.delete(n);
    } else
        p &&
            (u && !a
...
function n6(e) {
    ...
    (t = nb(th, t)),
        ...
        t4.stop(),
        (t6 = !1);
    let { resetSilenceWarningOnDeviceChange: n } = es.A.getConfig({
...
function rf(e) {
    ep.A.setKrispModelOverride(e.model), (_ = e.model), rl();
}
function rp(e) {
...
function rN(e) {
    ...
    if (((tw = !0 !== tL && !t), t)) (tL = !0), (t6 = !1), t4.stop(), tM.stop();
        ...
        let { enableHardwareSilenceWarning: e, resetSilenceWarningAfterNMinutes: t } = es.A.getConfig({
...
function r$(e) {
    let { enabled: t } = e;
    ef.A.requestPermission(eF.iL.CAMERA), nu(t);
}
function rz(e) {
...
class ir extends I.Ay.Store {
    ...
    initialize() {
        nm(),
            ...
            this.waitFor(eb.default, eD.A, eL.A, ew.A, b.A, P.A, eM.A, U.Ay, em.A, eg.A, eP.default, ek.A, eT.A);
    }
    supports(e) {
    ...
    goLiveSimulcastEnabled() {
        return ew.A.getChannel(tj)?.type !== eU.rbe.GUILD_STAGE_VOICE && e4 && Z.A.simulcastEnabled();
    }
    getAecDump() {
    ...
    supportsScreenSoundshare() {
        return (0, eN.isMac)()
            ? to.supports(eH.O5.SOUNDSHARE) && A().satisfies(N.A?.os.release, eG.P$) && nA()
            : (0, eN.isWindows)()
