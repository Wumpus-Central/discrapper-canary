            ...
            return {
                handleTranslate: i.useCallback(
                    async (i, l) => {
                        ...
                        (b.has(e.id) || b.set(e.id, e.content), (0, o.showToast)((0, o.createToast)(f.intl.formatToPlainString(f.t.Znl8Z2, { targetLanguage: p }), o.ToastType.AI)));
                        try {
                            ...
                            t.ok &&
                                ...
                                (0, o.showToast)((0, o.createToast)(f.intl.formatToPlainString(f.t.FtVUqq, { targetLanguage: p }), o.ToastType.SUCCESS)));
                        } finally {
                            n(!1);
                        }
                    },
