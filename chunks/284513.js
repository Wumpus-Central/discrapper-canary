...
function y(e) {
    ...
    if (null == d && null == _) return (0, l.jsx)(N, { variant: n, className: s });
...
function b(e) {
    let { className: t } = e;
    return (0, l.jsx)("div", { className: f()(v.z, t) });
}
var L = n(603427);
function D(e) {
    ...
    return (0, l.jsx)(F, {
        image:
            null != n
                ? (0, l.jsx)("div", {
                      className: j.Xr,
                      children: (0, l.jsx)(M, { media: n.media, className: f()(j.c8, x.g) }),
                  })
                : (0, l.jsx)(b, { className: j.pm }),
    });
}
var Y = n(174529);
function K(e) {
...
var ed = n(832696);
let e_ = ed.Ikc({ value_type: ed.k5n(m), presentation_type: ed.k5n(p), value: ed.YjP() }),
    eh = ed.Ikc({ value_type: ed.k5n(m), presentation_type: ed.k5n(p), value: ed.YjP(), fallback: e_.nullish() }),
    ef = ed.Ikc({ fields: ed.jgl(ed.YjP(), eh) }),
    eE = ed.Ikc({ layout: ed.YjP(), components: ed.jgl(ed.YjP(), ef) });
ed.jgl(ed.k5n(d.m), eE);
