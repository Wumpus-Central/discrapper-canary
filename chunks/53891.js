...
function b(e) {
    ...
    let { isAdopting: n, onAdoptTag: i, onEditProfile: l } = (0, h.Z)(e.guild.id, () => t(x.L.TAKE_ACTION)),
        c = [
            {
...
function v(e) {
    ...
    let { isAdopting: n, onAdoptTag: i, onEditProfile: c } = (0, h.Z)(e.guild.id, () => t(x.L.TAKE_ACTION)),
        u = [
            {
                text: g.intl.string(g.t.jwEaiX),
                loading: n,
