...
function d(e) {
    let { shortcut: t, dim: n = !1, className: i, keyClassName: a } = e,
        { i18n: d } = (0, o.G9)(),
        _ = {
            ctrl: () => (0, r.jsx)(c, { macText: "⌃", text: "ctrl", label: d.KEY_CTRL_A11Y_LABEL }),
            cmd: () => (0, r.jsx)(c, { macText: "⌘", text: "cmd", label: d.KEY_CMD_A11Y_LABEL }),
            mod: () =>
                (0, r.jsx)(c, {
                    macText: "⌘",
                    text: "ctrl",
            ...
            shift: () => (0, r.jsx)(c, { macText: "⇧", text: d.KEY_SHIFT, label: d.KEY_SHIFT_A11Y_LABEL }),
            up: () =>
                (0, r.jsx)(c, {
            ...
            escape: () => (0, r.jsx)(c, { text: d.KEY_ESCAPE, label: d.KEY_ESCAPE_A11Y_LABEL }),
            esc: () => (0, r.jsx)(c, { text: d.KEY_ESCAPE, label: d.KEY_ESCAPE_A11Y_LABEL }),
            backspace: () =>
                (0, r.jsx)(c, {
                    macText: "⌫",
