...
var n = i(627968),
    ...
    T = i(540185),
    v = i(282435);
let N = (0, E.sampleSize)(v.cG, v.cG.length),
    b = (0, S.v)((e, t) => ({
        stack: [],
        wishlistStack: [],
        gameIds: {},
...
function M(e) {
    let { className: t } = e,
        { trackUserProfileEditAction: l } = (0, L.NJ)(),
        a = s.useCallback(() => {
...
function eh(e) {
    let { widgetType: t, widget: i, onAddGame: l, children: r, ...a } = e,
        ...
        { trackUserProfileEditAction: d } = (0, L.NJ)(),
        [c, u] = s.useState(""),
        g = s.useRef(""),
        { options: m, matchSorterOptions: f } = (0, ef.R)({ query: c }),
        x = c.trim().length > 0,
        { applicationIds: h, onAddGame: I } = C(t),
        p = s.useCallback(
            (e) => {
                (0, Q.ew)({ widgetType: t, game: { applicationId: e } }),
                    er.O.announce(D.intl.string(D.t.q0U3DE)),
        ...
        j = s.useCallback((e) => e, []),
        E = s.useMemo(() => ({ ...f, threshold: el.Ht.rankings.CONTAINS, keys: ["label"] }), [f]),
        S = s.useCallback((e) => (x || "" === e.trim() ? A.length : (0, el.Ht)(A, e, E).length), [x, A, E]),
        T = s.useCallback(
            (e) => {
...
function ej(e) {
    let { widgetType: t, children: i } = e,
        ...
        [r, o] = s.useState(l);
    return (0, n.jsx)(eA.Provider, { value: { expanded: r, setExpanded: o }, children: i });
}
function eE() {
    let e = s.useContext(eA);
    if (null == e)
...
function eT(e) {
    ...
    return (0, n.jsxs)("div", {
        className: s ? eS.O : eS.k,
        children: [
            s && (0, n.jsx)(ep, { widget: t, widgetType: t.type }),
...
function e_(e) {
    let { games: t, user: i, widgetType: s, ...l } = e,
        { registerItemRef: r, manageFocusOnDelete: a } = (0, eN.r)();
    return (0, n.jsx)("ul", {
        className: ey.h,
        children: t.map((e, t) =>
            (0, n.jsx)(
...
function eG(e) {
    let { widgetType: t, allowEditing: i, disableInteraction: s = !1, games: l } = e,
        ...
        a = r(t),
        { expanded: o, setExpanded: d } = eE(),
        c = o ? l : l.slice(0, 2),
        u = l.length > 2,
        g = (0, n.jsxs)(n.Fragment, {
            children: [
                (0, n.jsx)(e_, { ...e, games: c }),
    ...
    return i && !s
        ? (0, n.jsxs)(n.Fragment, {
              children: [
                  (0, n.jsx)(ew, { widgetType: t, gameCount: l.length }),
                  (0, n.jsx)(eN.B, { emptyListFallbackRef: a, children: g }),
              ],
          })
        : g;
}
...
function ez(e) {
    let { index: t, widgetType: i, game: l, coverImageUrl: r, gameName: a, children: o } = e,
        { manageFocusOnReorder: d } = (0, eN.r)(),
        c = s.useRef(null);
    return (0, n.jsx)(eW.mG, {
        index: t,
        ...
        className: eX.kL,
        dropBeforeClassName: eX.A,
        dropAfterClassName: eX.Ze,
        draggingClassName: eX.Id,
        children: (0, n.jsx)("div", { ref: c, className: eX.An, children: o }),
    });
}
function eY(e) {
    let {
        ...
        { coverImageUrl: c, gameName: u, isLoading: g } = (0, eF.A)(t.applicationId),
        { registerDragHandleRef: m } = (0, eN.r)(),
        f = l && !r,
        { isDragging: x } = (0, eU.V)((e) => ({ isDragging: e.isDragging() }));
    function h() {
        return (0, n.jsxs)(n.Fragment, {
            children: [
                (0, n.jsx)(eH.A, {
                    ...
                    className: null == c || r ? void 0 : eV.iL,
                    hideTooltip: x,
                    coverRef: d,
                }),
                f && (0, n.jsx)(eW.jV, { buttonRef: m(t.applicationId), className: eX.BU }),
                f &&
                    (0, n.jsx)(eB.A, {
                        game: t,
                        widgetType: s,
...
function e8(e) {
    let { applicationId: t, userId: i, onClick: s } = e,
        { coverImageUrl: l, gameName: r, isLoading: o } = (0, eF.A)(t),
        ...
        : (0, n.jsx)(z.m, {
              ...
              children: (0, n.jsxs)(eg.D, {
                  ...
                  children: [
                      ...
                      (0, n.jsx)(em.p, { size: "md", className: e1.Xv, color: eZ.A.colors.WHITE }),
                  ],
              }),
          });
}
        ...
        children: [
            ...
            (0, n.jsx)("ul", {
                ...
                children: i.map((e) => {
                    ...
                    return (0, n.jsx)(
                        "li",
                        { children: (0, n.jsx)(e8, { onClick: () => l(i), userId: t, applicationId: i }) },
                        i,
                    );
                }),
            }),
...
function e6(e) {
    ...
    return (0, n.jsx)(e2, { games: l, onClick: d, ...i });
}
var e7 = i(344287);
function e5(e) {
    let { widget: t, ...i } = e;
...
function e3(e) {
    let { widget: t, user: i, allowEditing: l, disableInteraction: r, ...o } = e,
        ...
        m = g && c,
        f = (0, Q.L)(t),
        x = (0, Q.FM)(t, { showEditingControls: g }),
        h = (0, Q.uA)(t),
        I = 1 === (0, Q.cv)(t.type);
    return (0, n.jsx)(e5, {
        widget: t,
        ...
        headerActionButtons:
            g && !I
                ...
                : void 0,
        trailingContent: m && (0, n.jsx)(e6, { userId: i.id, widgetType: t.type, onDismiss: u, className: e7.r }),
        ...o,
    });
}
function e9(e) {
    let { widget: t, ...i } = e;
    return (0, n.jsx)(ej, { widgetType: t.type, children: (0, n.jsx)(e3, { widget: t, ...i }) });
}
var e4 = i(576260),
    te = i(841417),
    tt = i(725386),
...
function ts(e) {
    let { userId: t } = e,
        { trackUserProfileAction: i, trackUserProfileEditAction: l } = (0, L.NJ)(),
        r = s.useRef(!1),
...
function to(e) {
    let { user: t, guildId: i, channelId: l } = e,
        ...
        E = s.useMemo(() => r.filter((e) => e instanceof x.R), [r]);
    function S() {
        return (0, n.jsxs)(n.Fragment, {
            children: [
                o &&
                    (0, n.jsxs)(n.Fragment, {
                        children: [(0, n.jsx)(M, { className: tl.cG }), d && (0, n.jsx)(ta, {}), (0, n.jsx)(et, {})],
                    }),
                r.map((e, s) =>
                    (0, n.jsx)(
                        tr,
...
function td(e) {
    ...
    let a = (0, e4.k)(t.id);
    return (0, n.jsxs)(te.K, {
        "data-scroller": !0,
        scrollerRef: l,
        className: r()(tl.XG, { [tl.az]: a }),
        fade: !0,
        children: [(0, n.jsx)(ei.A, { scrollerRef: l }), (0, n.jsx)(to, { user: t, ...i })],
    });
}
