...
var eQ = l(97808),
    ...
    e8 = l(19575),
    e9 = l(941610);
let e2 = e8.Ay.getEnableHardwareAcceleration() ? eQ.Js : eY.A;
function te(e) {
    let { guildId: t } = e,
        l = (0, i.bG)([c.A], () => c.A.getGuild(t)),
        n = (0, i.bG)([e3.A], () => e3.A.getSortedRoles(t).find((e) => e.tags?.premium_subscriber === null)),
        r = (0, i.bG)([e4.default], () => e4.default.getCurrentUser()),
        a = r?.id,
        o = (0, i.bG)([e5.Ay], () => (null != a ? e5.Ay.getMember(t, a) : void 0), [a, t]),
            ...
            let t = new Date(ts.default.extractTimestamp(e.id)),
                {
                    ...
                    return {
                        username:
                            e5.Ay.getNick(e.guildId, e.userId) ?? e.user?.username ?? T.intl.string(T.t["30mdIx"]),
            ...
            let t = (0, tn.H)("GuildPowerupsRecentActivity"),
                ...
                a = (0, i.yK)([e5.Ay], () => {
                    ...
                    return (
                        r.forEach((l) => {
                            let { boost: s } = l;
                            null == e5.Ay.getMember(e, s.userId) && t.add(s.userId);
                        }),
                        Array.from(t)
                    );
                }, [e, r]);
