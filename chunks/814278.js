...
var i = n(827762),
    ...
    R = n(375708);
function O() {
    return m.A.getArticleURL(C.MVz.END_TO_END_ENCRYPTION);
}
function b() {
    return m.A.getArticleURL(C.MVz.END_TO_END_ENCRYPTION);
}
...
function L(e, t, n, i, r) {
    n ? T.A.createSecureFramesVerifiedKey(e, t) : T.A.createSecureFramesTransientKey(e, t),
        (0, N.cw)({ channelId: i, userId: e, analyticsLocation: r });
}
function w(e, t, n) {
    if (n) {
...
function M(e, t) {
    y.A.openSecureFramesUpdateConfirmation({
        ...
        onConfirm: () => {
            T.A.deleteSecureFramesVerifiedKey(e, t), (0, N.Jk)();
        },
    });
}
function P(e) {
    ...
    y.A.openSecureFramesUpdateConfirmation({
        ...
        onConfirm: () => {
            T.A.deleteSecureFramesUserVerifiedKeys(e), (0, N.YT)();
        },
    });
}
function x(e) {
...
function W(e) {
    ...
    (0, N.kF)({ userId: t, channelId: n, keyVersion: 1, reason: v.m4.OTHER_USER_INCONSISTENT_KEYS }),
