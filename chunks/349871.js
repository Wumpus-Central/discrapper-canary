                ...
                if (null != e.kind)
                    switch (e.kind.type) {
                        case i.INCREASED_FILE_UPLOAD_SIZE:
                            return { type: i.INCREASED_FILE_UPLOAD_SIZE, maxSize: e.kind.max_size };
                        case i.INCREASED_GUILD_LIMIT:
                            return { type: i.INCREASED_GUILD_LIMIT, maxGuilds: e.kind.max_guilds };
                        default:
                            return;
                    }
            })(o),
...
function s(e, t) {
    ...
    return n?.source != null ? n.source : u(e, t) ? [a.g$.SOURCE_NITRO] : void 0;
}
