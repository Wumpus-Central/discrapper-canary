    ...
    en = (function (e) {
        ...
        return (
                                    ...
                                    if (a.decay) {
                                        ...
                                        for (
                                            var A = null == u.lastVelocity ? E : u.lastVelocity,
                                                ...
                                                C = Math.ceil(e / 1),
                                                R = 0;
                                            R < C && !(!(Math.abs(A) > T) && (_ = Math.abs(d - h) <= I));
                                            ++R
                                        ) {
                                            y && (h == d || h > d == N) && ((A = -A * S), (h = d));
                                            var O =
            ...
            (i._merge = function (e, t, n) {
                ...
                var y = !s.isEqual(m, f);
                y && this._focus(m);
                var v = s.getFluidConfig(m),
                    C = s.getFluidConfig(A);
                C && (A = C.get());
                ...
                t.config &&
                    !R &&
                    (function (e, t, n) {
                        for (var i in (n && (N((n = a({}, n)), t), (t = a(a({}, n), t))),
                        N(e, t),
                        Object.assign(e, t),
                        S))
                            null == e[i] && (e[i] = S[i]);
                ...
                var x = s.is.und(t.reset) ? u && !t.default : !s.is.und(A) && D(t.reset, i),
                    ...
                    j = !R && (!F || D(o.immediate || t.immediate, i));
                if (y)
                    if (j) P = this._updateNode(G);
                    else {
                ...
                if ((z && this.is(J) && (r.changed && !x ? ($ = !0) : $ || this._stop()), !R)) {
                    ($ || s.getFluidConfig(f)) &&
                        ...
                        (r.toValues = v ? null : K == _.AnimatedString ? [1] : s.toArray(G))),
                        (r.immediate = j),
                        (r.onStart = er(c("onStart"), i)),
                        (r.onChange = er(c("onChange"), i));
                    var X = r.onRest,
                        ee = x && !t.onRest ? X[0] || s.noop : es(er(c("onRest"), i), this);
                    if ($) {
...
function eb(e, t, n) {
    ...
    if (
        ...
        s.each(A, function (e, t) {
            I[t] || (I[t] = { key: T[t], item: e, phase: ev, ctrl: new ed() });
        }),
        N.length)
    ) {
        var v = -1;
        s.each(N, function (e, n) {
            var i = y[n];
            ~e ? ((v = I.indexOf(i)), (I[v] = a(a({}, i), {}, { item: A[e] }))) : t.leave && I.splice(++v, 0, i);
        });
    }
    s.is.fun(f) &&
        I.sort(function (e, t) {
    ...
    s.each(I, function (e, n) {
        ...
        var d = a(a({}, O), {}, { delay: (C += E), reset: !1 }, i);
        r == eC && s.is.und(d.from) && (d.from = b(s.is.und(t.initial) || y ? t.from : t.initial, e.item, n));
        var _ = d.onRest;
        ...
        r.useLayoutEffect(
            function () {
                s.each(D, function (e, t) {
                    ...
                    ef(t.ctrl, i),
                        L.cancel ||
                            ((t.phase = n), n == eC && t.ctrl.start({ default: L }), t.ctrl[_ ? "update" : "start"](r));
                });
            },
            h ? void 0 : n,
        );
