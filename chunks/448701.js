                ...
                (0, e.jsxs)(l.rQ0, {
                    ...
                    children: [
                        (0, e.jsx)(l.Heading, {
                            ...
                            children:
                                null != i
                                    ? p.intl.formatToPlainString(p.t.N2mILu, { applicationName: i.name })
                                    : p.intl.string(p.t.nS8PUT),
                        }),
                        (0, e.jsx)(l.s_y, { onClick: a }),
                    ],
                }),
                (0, e.jsxs)(l.$mQ, {
                    children: [
                        (0, e.jsx)("div", { className: d.r }),
                        (0, e.jsx)(l.Text, {
                            className: d.Q,
                            ...
                            children:
                                null != i
                                    ...
                                    : p.intl.format(p.t["IfQUx+"], { supportArticleURL: m }),
                        }),
                    ],
                }),
                (0, e.jsx)(l.jlY, {
