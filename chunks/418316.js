...
function g(e) {
    ...
    switch (I.type) {
        case d.O7.FRIEND_REQUESTS_GROUPED:
            let w = u.ZP.getName(s.default.getUser(null == (m = I.other_users) || null == (g = m[0]) ? void 0 : g.id)),
