...
function l(e) {
    ...
    let u = (0, i.NQ)(n, e.document.body, l);
    function c() {
        (0, r.XC)(e, !0);
    }
    function d() {
    ...
    function f() {
        (0, r.GP)(e), (0, i.$v)(u, e.document.body), (0, i.JE)(n, e.document.body);
    }
    function p() {
        (0, o.I_)(n);
    }
    ...
    for (let n of ((0, i.wB)(u, e.document.body),
    e.addEventListener("focus", c),
    e.addEventListener("blur", d),
    e.addEventListener("unload", f),
