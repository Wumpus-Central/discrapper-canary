...
let Z = {
    ...
    action(e) {
        ...
        if (E.S.hasSubscribers(I.CkL.CALL_DECLINE)) return E.S.dispatch(I.CkL.CALL_DECLINE), !1;
        if (j.Z.close()) return !1;
        if (E.S.hasSubscribers(I.CkL.MEDIA_MODAL_CLOSE)) return E.S.dispatch(I.CkL.MEDIA_MODAL_CLOSE), !1;
        let t = (0, o.AN)(e);
        if (null == t ? void 0 : t.hasSubscribers(I.CkL.POPOUT_CLOSE)) return t.dispatch(I.CkL.POPOUT_CLOSE), !1;
        if (E.S.hasSubscribers(I.CkL.CLOSE_GIF_PICKER)) return E.S.dispatch(I.CkL.CLOSE_GIF_PICKER), !1;
        if (E.S.hasSubscribers(I.CkL.MODAL_CLOSE)) return E.S.dispatch(I.CkL.MODAL_CLOSE), !1;
        if (E.S.hasSubscribers(I.CkL.SEARCH_RESULTS_CLOSE)) return E.S.dispatch(I.CkL.SEARCH_RESULTS_CLOSE), !1;
        ...
        let p = C(l),
            f = C(c);
        return null == l || p || f || null == s ? (null != l && !p && a.Z.getChatOpen(l) ? r.Z.updateChatOpen(l, !1) : E.S.dispatch(I.CkL.SCROLLTO_PRESENT)) : u.Z.closeChannelSidebar(l), !1;
    }
};
function x(e) {
    if (null != e) {
...
function C(e) {
    if (null == e) return !1;
    let t = !1;
    return h.Z.getMessages(e).hasMoreAfter && (l.Z.jumpToPresent(e, I.AQB), (t = !0)), y.ZP.hasUnread(e) && ((0, i.In)(e), (t = !0)), (0, i.iV)(e), t;
}
