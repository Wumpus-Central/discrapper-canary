...
function I(e) {
    let { surveyId: t, survey: n, onClose: s, transitionState: d } = e,
        ...
        D = r.useMemo(() => (null == C ? [] : (0, _.uy)(n, { blockId: C, pageIndex: R, responses: g })), [n, C, R, g]),
        P = r.useCallback(() => {
            if (null == n || null == C) return;
            let e = (0, _.vt)(n, { blockId: C, pageIndex: R, responses: g });
            N(t, D), e.isComplete && c.Ay.submitSurveyResponse(t, g), f(e.blockId), h(e.pageIndex), O(e.isComplete);
        }, [n, C, R, g, t, D, N]);
    r.useEffect(() => {
        0 === D.length && P();
    }, [D, P]);
