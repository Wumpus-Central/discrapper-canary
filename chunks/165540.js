...
let A = i.forwardRef(function (e, t) {
    ...
    let { type: g, animateRef: b } = e,
        ...
        { Component: x, events: j, play: O } = (0, c.w)(),
        E = (0, v.Q3)('ChannelAppLauncherButton');
    ...
    let T = i.useCallback(() => {
        (0, p.yw)(N.rMx.APP_LAUNCHER_ENTRYPOINT_BUTTON_CLICKED), _ ? h.yT(m.ti.DISMISSED) : ((0, y.EW)(s.z.DESKTOP_APP_LAUNCHER_ONBOARDING, { dismissAction: P.L.TAKE_ACTION }), h.__(m._b.TEXT, g)), O();
    }, [_, g, O]);
    return (0, r.jsx)('div', {
