...
var r = n(255367),
    ...
    P = n(915298);
function w(e) {
    return e.isActiveThread() ? (0, r.jsx)(C, { channel: e }) : (0, r.jsx)(S, { channel: e });
}
function C(e) {
    let { channel: t } = e,
...
function O(e) {
    ...
    let c = (0, l.e7)([v.default], () => {
        ...
        { nick: f, colorString: x, colorStrings: b } = (0, h.ZP)(n),
        p = (0, m.X)(t.guild_id, b, 'ThreadBrowserRowSubtext'),
...
function S(e) {
    ...
    let g = (0, l.e7)([v.default], () => v.default.getUser(d.ownerId)),
        ...
        p = (0, m.X)(d.guild_id, null == j ? void 0 : j.colorStrings, 'ArchiveTimeSubtext'),
                              ...
                              authorHook(e, t) {
                                  ...
                                  return (0, r.jsx)(
                                      s.PUh,
                                      {
                                          ...
                                          roleColors: p,
                                          name: null != (a = null == j ? void 0 : j.nick) ? a : b.ZP.getName(g)
                                      },
                                      t
                                  );
                              }
