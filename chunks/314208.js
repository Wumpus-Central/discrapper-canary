...
function T(e) {
    ...
    let c = (0, a.e7)([v.default], () => {
        ...
        N = l.useMemo(() => {
            let e = null != n.content && "" !== n.content ? (0, u.ZP)(n, { formatInline: !0 }).content : null,
                {
...
function C(e) {
    ...
    let { channel: d } = e,
        ...
        j =
            null == h
                ? new Date(
                      null != (n = null == (t = d.threadMetadata) ? void 0 : t.archiveTimestamp) ? n : Date.now(),
                  ).getTime()
            ...
            null == b
                ? (0, r.jsxs)(r.Fragment, {
                      children: [
                          ...
                          O.intl.format(O.t["5Wk9+o"], { time: (0, Z.Ye)(j) }),
                      ],
                  })
                : (0, r.jsxs)(r.Fragment, {
                      children: [
