...
let z = (e) => {
    let {
        ...
        b = m.kJ.useStore((e) => e.activeCategoryIndex),
        y = (0, I.Ni)({
            sectionDescriptors: a,
            emojiListRef: n,
        }),
        v = (0, p.O)(),
        S = (0, O.kI)(s, c, null == c ? void 0 : c.guild_id, d),
        A = i.useMemo(() => (g ? (0, O.ZF)() : S), [S, g]),
        C = i.useRef(null),
        R = (0, u.e7)([E.Z], () => E.Z.isFocused()),
        w = (0, u.e7)([_.Z], () => _.Z.useReducedMotion, []),
        D = i.useMemo(
            () =>
                l().memoize((e, t) => {
                    let n = A[t];
