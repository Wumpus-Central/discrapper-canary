...
let eP = {
    getSectionDefinition: function (e, t) {
        ...
        let ew = (0, j.p)(t.guild.id, 'guild_settings'),
            ...
            ek = (null === (eP = t.guild.profile) || void 0 === eP ? void 0 : eP.badge) != null ? (0, c.ky)(t.guild.id, t.guild.profile.badge, eO.NC.SIZE_16) : null;
        switch (e) {
            case e_.pNK.PROFILE:
                return {
                    section: e_.pNK.PROFILE,
                    impressionName: i.ImpressionNames.GUILD_SETTINGS_PROFILE,
                    label: eI.NW.string(eI.t.txdaxc),
                    ariaLabel: eI.NW.string(eI.t.txdaxc),
                    element: ej.Z,
            ...
            case e_.pNK.TAG:
                return {
                    ...
                    label: eI.NW.string(eI.t['2QmKZ2']),
                    ariaLabel: eI.NW.string(eI.t['2QmKZ2']),
                    element: ev.Z,
                    predicate: () => !1
                };
            case e_.pNK.ENGAGEMENT:
                return {
                    ...
                    label: eI.NW.string(eI.t['6TAHb2']),
                    ariaLabel: eI.NW.string(eI.t['6TAHb2']),
                    element: eg.Z,
                    notice: {
                        stores: [k.Z],
                        element: ep.R
            ...
            case e_.pNK.BOOST_PERKS:
                return {
                    ...
                    label: eI.NW.string(eI.t.UKgg5O),
                    ariaLabel: eI.NW.string(eI.t.UKgg5O),
                    element: eu.I,
                    notice: {
                        stores: [k.Z, A.Z],
                        element: em.C
            ...
            case e_.pNK.INVITES:
                return {
                    ...
                    label: eI.NW.string(eI.t.YOt3Oj),
                    ariaLabel: eI.NW.string(eI.t.YOt3Oj),
                    element: eh.Z,
                    type: o.bT.CUSTOM,
            ...
            case e_.pNK.OVERVIEW:
                return {
                    ...
                    label: eI.NW.string(eI.t['/dp6yc']),
                    ariaLabel: eI.NW.string(eI.t['/dp6yc']),
                    element: et.Z,
                    notice: {
                        stores: [k.Z],
                        element: et.O
            ...
            case e_.pNK.ROLES:
                return {
                    ...
                    label: eI.NW.string(eI.t.LPJmLy),
                    element: B.Z,
                    type: o.bT.MINIMAL,
                    ariaLabel: eI.NW.string(eI.t.KXcECw),
                    notice: {
                        stores: [D.Z],
                        element: B._
                    },
            ...
            case e_.pNK.EMOJI:
                return {
                    ...
                    label: eI.NW.string(eI.t.sMOuub),
                    element: X.ZP,
            ...
            case e_.pNK.STICKERS:
                return {
                    ...
                    label: eI.NW.string(eI.t.R5nQkZ),
                    ariaLabel: eI.NW.string(eI.t.R5nQkZ),
                    element: ea.Z,
                    predicate: () => t.canManageGuildExpressions
                };
            case e_.pNK.SOUNDBOARD:
                return {
                    ...
                    label: eI.NW.string(eI.t.OWQNYm),
                    ariaLabel: eI.NW.string(eI.t.OWQNYm),
                    element: es.Z,
                    predicate: () => t.canManageGuildExpressions
                };
            case e_.pNK.WIDGET:
                return {
                    ...
                    label: eI.NW.string(eI.t.ACjbTk),
                    element: ed.Z,
                    predicate: () => t.canManageGuild
                };
            case e_.pNK.GUILD_TEMPLATES:
                return {
                    ...
                    ariaLabel: eI.NW.string(eI.t.KUw7Sk),
                    element: el.ZP,
                    notice: {
                        stores: [el.Sf],
                        element: el.Q5
            ...
            case e_.pNK.VANITY_URL:
                return {
                    ...
                    label: eI.NW.string(eI.t['5XZKy8']),
                    element: ec.Z,
                    notice: {
                        stores: [A.Z],
                        element: ec.T
            ...
            case e_.pNK.APP_DIRECTORY:
                return {
                    ...
                    label: eI.NW.string(eI.t.AKcFUl),
                    ariaLabel: eI.NW.string(eI.t.AKcFUl),
                    onClick() {
            ...
            case e_.pNK.SAFETY:
                return {
                    ...
                    label: eI.NW.string(eI.t['suhY+f']),
                    ariaLabel: eI.NW.string(eI.t['suhY+f']),
                    element: F.Z,
            ...
            case e_.pNK.GUILD_AUTOMOD:
                return {
                    ...
                    ariaLabel: eI.NW.string(eI.t.uRelg4),
                    element: f.Z,
            ...
            case e_.pNK.AUDIT_LOG:
                return {
                    ...
                    label: eI.NW.string(eI.t.SPWLyc),
                    element: W.Z,
                    type: o.bT.CUSTOM,
            ...
            case e_.pNK.BANS:
                return {
                    ...
                    label: eI.NW.string(eI.t.ZbeITU),
                    element: H.Z,
            ...
            case e_.pNK.CLAN:
                return {
                    section: e_.pNK.CLAN,
                    label: eI.NW.string(eI.t['6g8uHB']),
                    ariaLabel: eI.NW.string(eI.t['6g8uHB']),
                    onClick() {
                        (0, I.q4)(
                            (e) => {
                                let { closeLayer: n } = e;
                    ...
                    icon: null != ek ? (0, r.jsx)(u.KQ, { src: ek }) : null
                };
            case e_.pNK.COMMUNITY:
                let eA = eI.NW.string(eI.t.ElKTeX);
                return (
                    t.guild.hasFeature(e_.oNc.COMMUNITY) && (eA = t.isGuildSettingsFoundationEnabled ? eI.NW.string(eI.t['8nY2LC']) : eI.NW.string(eI.t['/dp6yc'])),
                    {
            ...
            case e_.pNK.ONBOARDING:
                return {
                    ...
                    label: eI.NW.string(eI.t.LdxCKy),
                    element: ee.Z,
                    ariaLabel: eI.NW.string(eI.t.LdxCKy),
                    ...
                    decoration: (function (e, t) {
                        ...
                        let n = M.ug,
                            r = n.findIndex((e) => e === t);
                        if (-1 !== r)
                            return eI.NW.formatToPlainString(eI.t['5r28iY'], {
                                count: r + 1,
                                total: n.length
                            });
            ...
            case e_.pNK.ANALYTICS:
                return {
                    ...
                    label: eI.NW.string(eI.t['0wWfUF']),
                    ariaLabel: eI.NW.string(eI.t['0wWfUF']),
                    element: z.Z,
                    predicate: () => eD
                };
            case e_.pNK.DISCOVERY:
                return {
                    ...
                    label: eI.NW.string(eI.t.oGaVGx),
                    element: K.Z,
                    notice: {
                        stores: [k.Z],
                        element: K.s
                    ...
                    ariaLabel: t.guild.hasFeature(e_.oNc.DISCOVERABLE) ? eI.NW.string(eI.t.oGaVGx) : eI.NW.string(eI.t.XU0S6u)
                };
            case e_.pNK.DISCOVERY_LANDING_PAGE:
                return {
                    ...
                    ariaLabel: eI.NW.string(eI.t.kGlQGB),
                    element: q.Z,
                    notice: {
                        stores: [k.Z],
                        element: q.J
            ...
            case e_.pNK.COMMUNITY_WELCOME:
                return {
                    ...
                    label: eI.NW.string(eI.t['2rkmDg']),
                    ariaLabel: eI.NW.string(eI.t['2rkmDg']),
                    element: Y.Z,
                    notice: {
                        stores: [E.Z],
                        element: S.Z
            ...
            case e_.pNK.GUILD_PRODUCTS:
                return {
                    ...
                    label: eI.NW.string(eI.t.X6h2g4),
                    ariaLabel: eI.NW.string(eI.t.X6h2g4),
                    element: N.Z,
            ...
            case e_.pNK.ROLE_SUBSCRIPTIONS_STORE_PAGE:
                return {
                    ...
                    label: eI.NW.string(eI.t.ipTYsr),
                    ariaLabel: eI.NW.string(eI.t.ipTYsr),
                    element: y.Z,
            ...
            case e_.pNK.GUILD_PREMIUM:
                return {
                    ...
                    label: eI.NW.string(eI.t['8+VX4+']),
                    ariaLabel: eI.NW.string(eI.t['8+VX4+']),
                    element: en.Z,
                    className: eE.serverBoostTabItem,
                    icon: (0, r.jsx)(ei.Z, { className: eE.icon })
                };
            case e_.pNK.MEMBERS:
                return {
                    ...
                    label: (0, r.jsx)($.$, {}),
                    ariaLabel: eI.NW.string(eI.t['9Oq93t']),
                    element: $.Z,
                    type: o.bT.CUSTOM,
            ...
            case e_.pNK.INSTANT_INVITES:
                return {
                    ...
                    label: eI.NW.string(eI.t['9F90iY']),
                    element: J.Z,
                    type: o.bT.CUSTOM,
                    predicate: () => t.canManageGuild
                };
                ...
                return {
                    ...
                    onClick() {
                        ...
                        let i = t.guild.toString(),
                            s = {
                                header: eI.NW.formatToPlainString(eI.t.us7mCw, { name: i }),
                                  ...
                                  (0, r.jsx)(
                                      ...
                                      eT(eS({}, e, s), {
                                          children: (0, r.jsx)(a.Text, {
                                              ...
                                              children: eI.NW.format(eI.t['Zuo+VV'], { name: i })
                                          })
                                      })
                                  )
                              )
                    ...
                    label: eI.NW.string(eI.t.l3hWPz),
                    ariaLabel: eI.NW.string(eI.t.l3hWPz),
                    icon: (0, r.jsx)(a.XHJ, {
                        size: 'xs',
                        color: 'currentColor'
                    }),
