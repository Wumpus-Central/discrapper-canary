        ...
        switch (e.type) {
            ...
            case "linear-random":
                ...
                var a = I(e.minAddValue),
                    o = I(e.maxAddValue);
                return new h(new b(O(n.x, r.x), O(a.x, o.x)), new b(O(n.y, r.y), O(a.x, o.x)), e.uniformVectorValues);
            case "oscillating":
                t = I(e.value);
                var s = I(e.start),
                    l = I(e.final),
                    ...
                    u = I(e.direction);
                return new h(
                    new y(t.x, s.x, l.x, c.x, u.x, e.easingFunction),
                    new y(t.y, s.y, l.y, c.x, u.y, e.easingFunction),
            ...
            case "oscillating-random":
                ...
                var d = I(e.minStart),
                    ...
                    C = I(e.maxDirection);
                return new h(
                    new y(O(n.x, r.x), O(d.x, f.x), O(p.x, _.x), O(m.x, g.x), S(T.x, C.x), v(e.easingFunctions)[0]),
                    new y(O(n.y, r.y), O(d.y, f.y), O(p.y, _.y), O(m.y, g.y), S(T.y, C.y), v(e.easingFunctions)[0]),
                    e.uniformVectorValues,
                );
        }
        ...
        switch (e.type) {
            ...
            case "linear-random":
                ...
                var a = T(e.minAddValue),
                    o = T(e.maxAddValue);
                return new g(
                    new b(O(n.x, r.x), O(a.x, o.x)),
                    new b(O(n.y, r.y), O(a.y, o.y)),
                    new b(O(n.z, r.z), O(a.z, o.z)),
                    e.uniformVectorValues,
                );
            case "oscillating":
                t = T(e.value);
                ...
                return new g(
                    new y(t.x, s.x, l.x, c.x, u.x, e.easingFunction),
                    new y(t.y, s.y, l.y, c.z, u.y, e.easingFunction),
                    new y(t.z, s.z, l.z, c.z, u.z, e.easingFunction),
                    e.uniformVectorValues,
                );
            case "oscillating-random":
                (n = T(e.minValue)), (r = T(e.maxValue));
                var d = T(e.minStart),
                    ...
                    C = T(e.maxDirection);
                return new g(
                    new y(O(n.x, r.x), O(d.x, f.x), O(p.x, _.x), O(m.x, h.x), S(I.x, C.x), v(e.easingFunctions)[0]),
                    new y(O(n.y, r.y), O(d.y, f.y), O(p.y, _.y), O(m.y, h.y), S(I.y, C.y), v(e.easingFunctions)[0]),
                    new y(O(n.z, r.z), O(d.z, f.z), O(p.z, _.z), O(m.z, h.z), S(I.z, C.z), v(e.easingFunctions)[0]),
                    e.uniformVectorValues,
                );
        }
...
var D = r.forwardRef(function (e, t) {
        var o = e.className,
            ...
            h = void 0 === m ? window.requestAnimationFrame : m,
                    ...
                    if (null != e) {
                        ...
                        if (null != t) {
                            t.clearRect(0, 0, e.width, e.height),
                                null == p || p(t),
                                C.current.forEach(function (n, r) {
                                    var i = n.confetti,
                                        a = n.spriteCanvas;
                                ...
                                C.current.size > 0
                                    ? (A.current = h(w))
                                    : (t.clearRect(0, 0, e.width, e.height), (A.current = null));
                            var n = Date.now();
        ...
        var x = r.useCallback(
            ...
            L = r.useCallback(
                function (e, t, n, r, a) {
                    var o,
                        s = P(null != (o = e.id) ? o : (0, i.Z)(), e, n, r, a);
                    return x(s, t), s;
                },
                [x],
            ),
    ...
    x = r.forwardRef(function (e, t) {
                    ...
                    null != t &&
                        ...
                        d.current.forEach(function (e, n) {
                            var r = function (r, i) {
                                var a = l * i + 2 * i,
                                    o = c * n + 2 * n;
                                if ((t.drawImage(e.image, a, o, l, c), null != r)) {
                                    for (
                                        var s = t.getImageData(a, o, l, c),
                                            u = (function (e) {
                                                "#" === e[0] && (e = e.slice(1));
                                                var t = parseInt(e, 16);
                                                return {
        ...
        return (
            ...
            r.useEffect(
                function () {
                    null != u.current &&
                        ((u.current.width = (l + 2) * Math.max(s.length, 1)), (u.current.height = (c + 2) * o.length));
                },
                [s.length, c, l, o.length],
            ),
