...
class c {
    ...
    constructor(e, t, n, r) {
        o(this, "milliseconds", 0),
            o(this, "asMilliseconds", () => this.milliseconds),
            o(this, "asSeconds", () => this.milliseconds / 1000),
            o(this, "asMinutes", () => this.milliseconds / 1000 / 60),
            o(this, "asHours", () => this.milliseconds / 1000 / 60 / 60),
            o(this, "add", (e) => c.fromMilliseconds(this.milliseconds + e.milliseconds)),
            o(this, "subtract", (e) => c.fromMilliseconds(this.milliseconds - e.milliseconds)),
            o(this, "subtractOrZero", (e) => c.fromMilliseconds(Math.max(this.milliseconds - e.milliseconds, 0))),
...
o(c, "fromMilliseconds", (e) => new c(0, 0, 0, e)),
    o(c, "fromSeconds", (e) => new c(0, 0, e)),
    o(c, "fromMinutes", (e) => new c(0, e)),
    o(c, "fromHours", (e) => new c(e));
class u {
    get lastElapsed() {
    ...
    constructor(e = l) {
        o(this, "timestampProducer", void 0),
            o(this, "startTime", void 0),
            o(this, "timePassed", void 0),
...
class d {
    ...
    constructor(e, t = l) {
        o(this, "stopwatch", void 0),
            o(this, "state", void 0),
            (this.stopwatch = new u(t)),
            (this.state = e),
            this.stopwatch.toggle(e);
    }
}
class f {
    hasTimedOut() {
