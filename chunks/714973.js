...
function C(e) {
    ...
    return (0, a.jsxs)("div", {
        className: b.Nr,
        children: [t, (0, a.jsx)(i.E, { color: "text-default", variant: "text-sm/medium", children: l })],
    });
}
function y() {
    let e = (0, s.bG)([f.Ay], () => f.Ay.getKeybindForAction(g.hCu.SAVE_CLIP)),
        t = null != e ? v.dI(e.shortcut, !0) : null;
    return (0, a.jsxs)("div", {
        className: b.kR,
        children: [
            (0, a.jsx)(C, {
                header: (0, a.jsx)(r._, { size: "refresh_sm", color: d.A.colors.ICON_DEFAULT }),
                description: j.intl.string(x.default["4K56sP"]),
            }),
            (0, a.jsx)(C, {
                header: null != t ? (0, a.jsx)(o.e, { shortcut: t }) : null,
                description:
                    null != t
                        ? (0, a.jsxs)(a.Fragment, {
                              children: [
            ...
            (0, a.jsx)(C, {
                header: (0, a.jsx)(u.t, { size: "refresh_sm", color: d.A.colors.ICON_DEFAULT }),
...
function A(e) {
    ...
    return (0, a.jsx)("div", {
        ...
        children: (0, a.jsxs)("div", {
            className: b.Qs,
            children: [
                (0, a.jsx)(n.N, { width: 213, height: 135, alt: "" }),
                (0, a.jsx)(m.D, {
                    className: b.wx,
