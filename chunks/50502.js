...
(0, r.C)({
    ...
    defaultConfig: { isMultiAccountMobileEnabled: !1, clearCanUseMultiAccountMobile: !1 },
    treatments: [
        {
            id: 1,
            label: "Enable Account Switcher on Mobile",
            config: { isMultiAccountMobileEnabled: !0, clearCanUseMultiAccountMobile: !1 },
        },
        {
            id: 2,
            label: "Unenroll Account Switcher on Mobile and Clear Local Flag",
            config: { isMultiAccountMobileEnabled: !1, clearCanUseMultiAccountMobile: !0 },
        },
    ],
});
let i = (0, r.C)({
