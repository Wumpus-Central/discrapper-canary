...
function p(e) {
    let { presetImages: t, image: r, imageName: a, savedImageName: p, onChange: m, uploadButtonLabel: h = s.NW.string(s.t['MsUY/f']), radioGroupAriaLabel: b = s.NW.string(s.t['0Q0UJi']), disabled: v = !1 } = e,
        C = a === g,
