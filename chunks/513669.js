...
function p(e) {
    let { presetImages: t, image: A, imageName: l, savedImageName: p, onChange: m, uploadButtonLabel: h = s.intl.string(s.t['MsUY/f']), radioGroupAriaLabel: C = s.intl.string(s.t['0Q0UJi']), disabled: q = !1 } = e,
        b = l === f,
