    ...
    return (0, r.jsxs)(t, {
        ...
        children: [
            (0, r.jsxs)(O.D, {
                ...d,
                "aria-expanded": i,
                className: A()(ey.AS, { [ey.vu]: s, [ey.RD]: "destructive" === f }),
                ...
                children: [
                    null != g
                        ...
                        : (0, r.jsxs)("div", {
                              className: ey.Ly,
                              children: [
                                  (0, r.jsx)(m, { color: j, size: ef, className: ey.Kk }),
...
function ev(e) {
    let { node: t, visibleContent: n, dismissibleBadges: s, hoisted: i = !1 } = e,
        ...
        y = i ? "li" : "div",
        f = l.useMemo(() => en(t.key, n, s), [t.key, n, s]);
    return i
        ? (0, r.jsx)(ep, {
              tag: y,
              panelKey: a?.key,
...
function eM(e) {
    let {
        ...
        { node: g, visibleDirectory: x, accessibleDirectory: y } = (0, eE.Ay)(t, d ?? ""),
    ...
    let C = l.useMemo(() => ({ visibleDirectory: x, accessibleDirectory: y }), [x, y]),
...
function eI(e) {
    let {
        ...
        [A, b] = l.useState(1.4),
        S = l.useRef(null),
        C = (0, m.bG)([y.A], () => y.A.useReducedMotion),
        N = (0, m.bG)([f.A], () => f.A.isFocused());
    return (
        l.useEffect(() => {
            let e = (e) => {
...
function e4(e) {
    ...
    return (l.useLayoutEffect(() => {
        ...
        return (
            ...
            () => {
                eT.default.removeChangeListener(e), e7.A.resetState(), d.A.resetState(), u.A.close(), (0, c.ZQ)();
            }
        );
    }, []),
    m)
