...
function tt(e) {
    ...
    let n,
        ...
        a,
        r,
        { channel: h, user: p, onReaction: v, entry: L, buttons: k = [], header: M, onVoiceChannelPreview: P } = e,
        [D, U] = i.useState(!1),
        [V, G] = i.useState(null),
        F = i.useRef(null),
        B = (0, c.bG)(
        ...
        ei =
            ((t = el),
            (n = (0, c.bG)([ey.A], () => ey.A.getGuild((0, O.D)(t?.location)))),
            (s = (0, c.bG)([ev.A], () => ev.A.getChannel((0, O.H)(t?.location)))),
...
function ts(e) {
    ...
    let E = (0, ei.A)(
        ...
        { largeImage: b, smallImage: S } = (0, eM.nO)({ entry: _, showCoverImage: m }),
...
function ta(e) {
    ...
    let E = (0, ei.A)(
        ...
        { largeImage: T, smallImage: w } = (0, eM.D8)(S, N ?? j),
        { largeImage: R } = (0, eM.nO)({ entry: _ }),
        M = (0, ed.w)({ location: "content_inventory" }),
        O = (0, c.bG)([eu.A], () => eu.A.getDetectableIdsToApplicationIds());
    return (0, l.jsxs)("div", {
        className: e7.au,
        children: [
