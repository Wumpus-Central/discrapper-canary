...
class N extends f.A {
    ...
    static createReplay(e, t) {
        ...
        let i = (t, i) => {
            ...
            s = r.createReplayConnection("default", i, t);
        return null == s ? null : ((n.conn = s), n);
    }
    transportInfo;
    beginInitializeAt;
    onConnectCallbackAt;
    ...
    initialize(e) {
        ...
        let n = (0, g.lE)(),
            r = (r, i) => {
                ...
                if (null != r && "" !== r) {
                    this.setConnectionState(T.$I.NO_ROUTE), this.emit(p.yq.Error, r);
                    return;
                }
    ...
    destroy() {
        this.conn.destroy(),
            Object.keys(this.localSpeakingFlags)
                ...
                .forEach((e) => this.emit(p.yq.Speaking, e, T.ME.NONE, this.remoteAudioSSRCs[e])),
    ...
    createUser(e, t, n) {
        ...
        let s = r !== t,
            a = !l()(i, n);
        if (((this.remoteAudioSSRCs[e] = t), (this.remoteVideoSSRCs[e] = n ?? []), this.userId !== e && (s || a))) {
    ...
    setGoLiveSource(e) {
        ...
        if (
            (null != e.desktopDescription
                ? (s = e.desktopDescription.id)
                : null != e.cameraDescription &&
                  (s = `${e.cameraDescription.videoDeviceGuid}:${e.cameraDescription.audioDeviceGuid}`),
            this.goLiveSourceIdentifier === s)
        ) {
        ...
        if (((this.goLiveSourceIdentifier = s), null != this.conn.setDesktopSource)) {
            if (null != e.desktopDescription) {
                let {
                    ...
                    hdrCaptureMode: m,
                    enableGlobalFramePoolLock: E,
                    useGraphicsCaptureDirtyRegions: g,
                } = e.desktopDescription;
                this.setSoundshareSource(s, a);
                let [A, I] = null != t ? t.split(":") : ["", ""];
                null != t
                    ? this.logger.info(
                          `capturing desktop (type: ${A}, handle: ${I}, use-video-hook: ${o.toString()}, use-graphics-capture: ${d?.toString()}, use-graphics-capture-api-level: ${u?.toString()}, use-capture-device-for-encode: ${c?.toString()}).`,
                      )
                    ...
                    null != this.conn.setDesktopSourceWithOptions
                        ...
                        : this.conn.setDesktopSource(`wumpus-${I}`, o, A);
    ...
    setDesktopEncodingOptions(e, t, n) {
        ...
        let r = (0 === t && n >= 10) || t > 720 || n > 30 ? I.oL : I.lo,
            ...
            a = !h.Xb.equals(i, s.capture) || s.bitrateMax !== r,
        ...
        -1 === o && (o = 0),
            a &&
                ...
                this.emit(
                    ...
                    C(this.videoStreamParameters[o].ssrc),
                    this.videoStreamParameters,
                ),
    ...
    setLocalVideoSinkWants(e) {
        ...
        for (let [e, r] of Object.entries(this.remoteVideoSSRCs)) {
            let i = 0,
                s = 0;
            for (let e of r) (i += t?.[e]), (s += n?.[e]);
            0 === i && 0 !== s && this.conn.setDisableLocalVideo?.(e, !1),
                0 !== i && 0 === s && this.conn.setDisableLocalVideo?.(e, !0);
        }
    ...
    getCodecParams(e, t) {
        ...
        if (t) return { "level-asymmetry-allowed": "1", "packetization-mode": "1", "profile-level-id": "42e034" };
        {
            ...
            return {
                ...
                "profile-level-id": "android" === (0, g.lE)().platform ? t : e,
            };
        }
    }
    ...
    handleSpeakingFlags = (e, t, n) => {
        ...
        this.emit(p.yq.Speaking, e, t, i, n),
            (t & T.ME.SOUNDSHARE) != 0 &&
    ...
    handleVideo = (e, t, n, r) => {
        ...
        e === this.userId
            ? null != r && Array.isArray(r) && r.length > 0
                ...
                : t > 0
                  ? ((i[0].active = !0), (i[0].ssrc = t), (i[0].rtxSsrc = C(t)))
                  : (i[0].active = !1)
            : t > 0 &&
    ...
    handleStats = (e) => {
        if (this.connectionState === T.$I.DISCONNECTED) return void this.off(p.yq.Stats, this.handleStats);
        if (null != e) {
            if (null != this.stats) {
                let t = c()(
                        e.rtp.outbound,
                ...
                if (null != a && null != o && null != a.framesCaptured && null != o.framesCaptured) {
                    ...
                    if (
                        ...
                        e / t > 8
                            ? this.emit(p.yq.NoiseCancellationError, T.CO.CPU_OVERUSE)
                            : 0 === e && this.emit(p.yq.NoiseCancellationError, T.CO.FAILED);
                    }
                    this.inputMode === T.TB.VOICE_ACTIVITY &&
                        ...
                        this.emit(p.yq.VoiceActivityDetectorError, T.CO.VAD_CPU_OVERUSE);
                }
            }
            this.stats = e;
        }
