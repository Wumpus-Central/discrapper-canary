r.d(t, { default: () => j }), r(47120), r(411104);
var n = r(200651),
    i = r(192379),
    a = r(120356),
    o = r.n(a),
...
function j(e) {
    ...
    let ea = i.useCallback(
        ...
        eo = i.useCallback(() => {
            ...
            let { width: e, height: t } = P.current.getBoundingClientRect(),
                { width: r, height: n } = (0, R.Es)(j, e, t, en),
                i = (0, R.AK)(j, r, n, t, en),
                a = (0, R.kH)(r, n, i);
            V({
                type: 'SET_DIMENSIONS',
        ...
        ed = i.useCallback(
            (e, t) => {
                let { width: r, height: n } = e,
                    { width: i, height: a } = (0, R.Es)(j, n, r, en),
                    o = (0, R.AK)(j, i, a, r, en),
                    s = (0, R.kH)(i * t, a * t, o);
                return {
                    newImageDimensions: {
    ...
    let ef = j === O.pC.AVATAR || j === O.pC.BANNER,
        eR = (0, h.M)(!ef);
    return (0, n.jsx)(d.Gt, {
        value: er,
                            ...
                            children: q
                                ...
                                : (0, n.jsxs)(n.Fragment, {
                                      children: [
                                          ...
                                          (0, n.jsx)('div', {
                                              className: j === O.pC.AVATAR ? T.overlayAvatar : T.overlayBanner,
                                              style: {
                                                  opacity: +(null != W),
                                                  width: H.width,
                                                  height: H.height
