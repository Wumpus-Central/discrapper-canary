...
function S(e) {
    let { file: t, imageUri: r, originalAsset: a, transitionState: f, onCrop: y, onClose: G, uploadType: S = O.pC.AVATAR, showUpsellHeader: j = !1, analyticsPage: k } = e,
        B = i.useRef(_),
        P = i.useRef(null),
        z = i.useRef(null),
        [L, U] = i.useReducer(v, M),
