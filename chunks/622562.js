...
function b(e) {
    let { backgroundElementRef: t, getOffsetsRelativeToElement: n, fallbackAbsoluteOffsets: r, minimumOffsets: a, positionControlRef: o, onGetBoundingRect: l = () => {}, debounceTime: c = 60 } = e,
        [u, d] = i.useState(null);
    return (
        E({
