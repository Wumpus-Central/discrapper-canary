...
function I(e) {
    let { channelId: t, messageId: n, isReportFalsePositiveLoading: a, analyticsContext: r, attachmentPreview: s, embedPreview: c, onConfirmPress: u, transitionState: m, onClose: h } = e,
        p = (0, d.Dt)(),
        C = l.useCallback(() => {
            (0, _.aP)({
