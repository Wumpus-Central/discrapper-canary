...
function M(e) {
    ...
    y(A.dD.TRENDING_GIFS),
        a.Bo.get({
            ...
            (n) => {
                let { body: i } = n;
                C(i, A.dD.TRENDING_GIFS, { startTime: t, limit: e }),
