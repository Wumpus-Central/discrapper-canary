...
var y = new WeakMap(),
    ...
    $ = (e, t, n) => {
        for (var { childNodes: r } = e, i = r[t], a = t, o = !1, s = !1; (Y(i) || (W(i) && 0 === i.childNodes.length) || (W(i) && 'false' === i.getAttribute('contenteditable'))) && (!o || !s); ) {
            if (a >= r.length) {
    ...
    eb = (!ef || !ep) && !ed && 'undefined' != typeof globalThis && globalThis.InputEvent && 'function' == typeof globalThis.InputEvent.prototype.getTargetRanges,
    ey = {
        ...
        toDOMRange(e, t) {
            ...
            return (s.setStart(l, f ? 1 : c), s.setEnd(u, p ? 1 : _), s);
        },
        toSlateNode(e, t) {
        ...
        findEventRange(e, t) {
            ...
            if (d.W_.isElement(o) && d.ML.isVoid(e, o)) {
                var l = a.getBoundingClientRect(),
                    ...
                    _ = c ? d.ML.before(e, u) : d.ML.after(e, u);
                if (_) return d.ML.range(e, _);
            }
            var { document: f } = ey.getWindow(e);
        ...
        toSlatePoint(e, t, n) {
            ...
            if (s) {
                ...
                g && c === g.textContent.length && el && 'z' === g.getAttribute('data-slate-zero-width') && null != (u = g.textContent) && u.startsWith('\uFEFF') && (s.hasAttribute('data-slate-zero-width') || (ec && null != (_ = g.textContent) && _.endsWith('\n\n'))) && c--;
            }
            if (el && !l && !r) {
            ...
            var N = ey.toSlateNode(e, l);
            return {
                path: ey.findPath(e, N),
                offset: c
            };
        },
        toSlateRange(e, t, n) {
            ...
            if (!f) return null;
            if (ec && !s && r !== a) {
                var p = d.ML.isEnd(e, _, _.path),
                    h = d.ML.isStart(e, f, f.path);
                (p && (_ = d.ML.after(e, _) || _), h && (f = d.ML.before(e, f) || f));
            }
            var m = {
                anchor: _,
                focus: f
    ...
    eN = eE ? c.useLayoutEffect : c.useEffect,
    eC = (e) => {
    ...
    ex = (e) => {
        var { leaf: t, isLast: n, text: r, parent: i, renderPlaceholder: a, renderLeaf: o = (e) => c.createElement(eM, Object.assign({}, e)) } = e,
            s = (0, c.useRef)(null),
            l = (0, c.useRef)(null),
            u = eL(),
            d = (0, c.useRef)(null);
            ...
            (0, c.useEffect)(() => {
                ...
                if (
                    ...
                    d.current
                        ...
                        : e &&
                          ((d.current = new (window.ResizeObserver || _.do)(() => {
                              var e = B.get(u);
                              null == e || e();
                          })),
                          d.current.observe(e)),
        ...
        if (t[V]) {
            ...
            f = c.createElement(c.Fragment, null, a(p), f);
        }
        return o({
    ...
    ek = c.memo(ex, (e, t) => t.parent === e.parent && t.isLast === e.isLast && t.renderLeaf === e.renderLeaf && t.renderPlaceholder === e.renderPlaceholder && t.text === e.text && d.xv.equals(t.leaf, e.leaf) && t.leaf[V] === e.leaf[V]),
    eM = (e) => {
        var { attributes: t, children: n } = e;
        return c.createElement('span', Object.assign({}, t), n);
    },
    ej = (e) => {
        for (var { decorations: t, isLast: n, parent: r, renderPlaceholder: i, renderLeaf: a, text: o } = e, s = eL(), l = (0, c.useRef)(null), u = d.xv.decorations(o, t), _ = ey.findKey(s, o), f = [], p = 0; p < u.length; p++) {
            var h = u[p];
            f.push(
                c.createElement(ek, {
        ...
        var m = (0, c.useCallback)(
            (e) => {
                var t = C.get(s);
                (e ? (null == t || t.set(_, e), A.set(o, e), S.set(e, o)) : (null == t || t.delete(_), A.delete(o), l.current && S.delete(l.current)), (l.current = e));
            },
            [l, s, _, o]
        );
    ...
    eU = c.memo(ej, (e, t) => t.parent === e.parent && t.isLast === e.isLast && t.renderLeaf === e.renderLeaf && t.renderPlaceholder === e.renderPlaceholder && t.text === e.text && eA(t.decorations, e.decorations)),
    eG = (e) => {
        var { decorations: t, element: n, renderElement: r = (e) => c.createElement(eV, Object.assign({}, e)), renderPlaceholder: a, renderLeaf: o, selection: s } = e,
            l = eL(),
            u = ez(),
            _ = l.isInline(n),
            f = ey.findKey(l, n),
            p = (0, c.useCallback)(
                (e) => {
                    var t = C.get(l);
                    e ? (null == t || t.set(f, e), A.set(n, e), S.set(e, n)) : (null == t || t.delete(f), A.delete(n));
                },
                [l, f, n]
            ),
            h = eW({
        ...
        if ((_ && (m['data-slate-inline'] = !0), !_ && d.ML.hasInlines(l, n))) {
            var g = d.NB.string(n),
                E = i()(g);
            'rtl' === E && (m.dir = E);
        }
        if (d.ML.isVoid(l, n)) {
            ((m['data-slate-void'] = !0), !u && _ && (m.contentEditable = !1));
            var b = _ ? 'span' : 'div',
                [[v]] = d.NB.texts(n);
            ((h = c.createElement(
                b,
    ...
    eB = c.memo(eG, (e, t) => e.element === t.element && e.renderElement === t.renderElement && e.renderLeaf === t.renderLeaf && e.renderPlaceholder === t.renderPlaceholder && eS(e.decorations, t.decorations) && (e.selection === t.selection || (!!e.selection && !!t.selection && d.e6.equals(e.selection, t.selection)))),
    eV = (e) => {
    ...
    eW = (e) => {
        for (var { decorations: t, node: n, renderElement: r, renderPlaceholder: i, renderLeaf: a, selection: o } = e, s = eZ(), l = eL(), u = ey.findPath(l, n), _ = [], f = d.W_.isElement(n) && !l.isInline(n) && d.ML.hasInlines(l, n), p = 0; p < n.children.length; p++) {
            var h = u.concat(p),
                m = n.children[p],
                g = ey.findKey(l, m),
                E = d.ML.range(l, h),
...
function th(e) {
    var { editor: t, scheduleOnDOMSelectionChange: n, onDOMSelectionChange: r } = e,
        ...
        f = () => {
            ...
            (M.set(t, t.marks), tf('flush', U.get(t), j.get(t)));
            for (var a = y(); (l = null == (f = j.get(t)) ? void 0 : f[0]); ) {
                var l,
                    f,
                    p,
                    h = k.get(t);
                (void 0 !== h && (k.delete(t), (t.marks = h)), h && !1 === c && (c = null));
                var m = tr(l);
                ((t.selection && d.e6.equals(t.selection, m)) || d.YR.select(t, m),
                    ...
                    e8(t, l) || ((a = !1), U.delete(t), M.delete(t), (i = 'action'), G.delete(t), n.cancel(), r.cancel(), null == e || e.unref()));
            }
            var g = null == e ? void 0 : e.unref();
            if ((!g || G.get(t) || (t.selection && d.e6.equals(g, t.selection)) || d.YR.select(t, g), b())) return void _();
            ...
            if (
                ...
                if (n.startsWith('delete')) {
                    if (d.e6.isExpanded(r)) {
                        var [u, _] = d.e6.edges(r);
                        if (d.NB.leaf(t, u.path).text.length === u.offset && 0 === _.offset) {
                            var f = d.ML.next(t, {
                                at: u.path,
                                match: d.xv.isText
                            });
                            f &&
                                d.y$.equals(f[1], _.path) &&
                                (r = {
                                    anchor: _,
                                    focus: _
                                });
                ...
                switch (n) {
                    ...
                    case 'deleteContentBackward':
                        var P,
                            w,
                            { anchor: D } = r,
                            L = z(a) ? a.isCollapsed : !!(null != (w = a) && w.collapsed);
                    ...
                    case 'insertText':
                        ...
                        var x = null != i ? i : '';
                        if ((k.get(t) && (x = x.replace('\uFEFF', '')), 'insertText' === n && /.*\n.*\n$/.test(x) && (x = x.slice(0, -1)), x.includes('\n')))
                            return g(
                                () => {
                                    var e = x.split('\n');
                                    e.forEach((n, r) => {
                        ...
                        if (d.y$.equals(r.anchor.path, r.focus.path)) {
                            ...
                            if (x && c && 'insertCompositionText' === n) {
                                ...
                                G.start + G.text.search(/\S|$/) === B + 1 && G.end === c.start + c.text.length ? ((G.start -= 1), (c = null), A()) : (c = !1);
                            } else c = 'insertText' === n && (null === c ? G : !!(c && d.e6.isCollapsed(r)) && c.end + c.text.length === M.offset && tu(tu({}, c), {}, { text: c.text + x }));
        ...
        v = (e) => {
            ...
            if (e) {
                ...
                (((r && c) || i) && (c = !1), (r || y()) && (o = setTimeout(f, t_)));
            }
        },
        I = () => {
            (b() || !y()) && f();
...
var tC = (e) => c.createElement(c.Fragment, null, eW(e)),
    tR = (e) => {
        var t,
            n,
            r = (0, c.useCallback)((e) => c.createElement(tP, Object.assign({}, e)), []),
            { autoFocus: a, decorate: s = tw, onDOMBeforeInput: u, placeholder: _, readOnly: f = !1, renderElement: p, renderLeaf: h, renderPlaceholder: m = r, scrollSelectionIntoView: E = tD, style: b = {}, as: y = 'div', disableDefaultStyles: O = !1 } = e,
            N = g(e, tT),
            C = eX(),
            [L, x] = (0, c.useState)(!1),
            j = (0, c.useRef)(null),
                ...
                l()(() => {
                    if ((el || !ey.isComposing(C)) && (!z.isUpdatingSelection || (null != J && J.isFlushing())) && !z.isDraggingInternally) {
                        ...
                        var { anchorNode: i, focusNode: a } = r,
                            o = ey.hasEditableTarget(C, i) || ey.isTargetInsideNonReadonlyVoid(C, i),
                            s = ey.hasEditableTarget(C, a) || ey.isTargetInsideNonReadonlyVoid(C, a);
                        if (o && s) {
        ...
        eN(() => {
            j.current && (e = H(j.current)) ? (v.set(C, e), I.set(C, j.current), A.set(C, j.current), S.set(j.current, C)) : A.delete(C);
            var e,
                { selection: t } = C,
        ...
        var $ = (0, c.useCallback)(
                (e) => {
                    if ((G(), !f && ey.hasEditableTarget(C, e.target) && !tx(e, u))) {
                        ...
                        if (!(i && ey.isComposing(C))) {
                            ...
                            if ('insertText' === n && t && d.e6.isCollapsed(t) && e.data && 1 === e.data.length && /[a-z ]/i.test(e.data) && 0 !== t.anchor.offset) {
                                ((a = !0), C.marks && (a = !1));
                                var { anchor: o } = t,
                                    [s, l] = ey.toDOMPoint(C, o),
                                    c = null == (h = s.parentElement) ? void 0 : h.closest('a'),
                                    _ = ey.getWindow(C);
                                if (a && c && ey.hasDOMNode(C, c)) {
                                    var p,
                                        h,
                                        m,
                                        g,
                                        E = null == _ ? void 0 : _.document.createTreeWalker(c, NodeFilter.SHOW_TEXT).lastChild();
                                    E === s && (null == (g = E.textContent) ? void 0 : g.length) === l && (a = !1);
                                }
                                if (a && s.parentElement && (null == _ || null == (m = _.getComputedStyle(s.parentElement)) ? void 0 : m.whiteSpace) === 'pre') {
                                    var b = d.ML.above(C, {
                                        at: o.path,
                            ...
                            if (!n.startsWith('delete') || n.startsWith('deleteBy')) {
                                ...
                                if (y) {
                                    var O = ey.toSlateRange(C, y, {
                                        exactMatch: !1,
                                        suppressThrow: !1
                                    });
                                    if (!t || !d.e6.equals(t, O)) {
                                        a = !1;
                                        var v = !i && C.selection && d.ML.rangeRef(C, C.selection);
                                        (d.YR.select(C, O), v && D.set(C, v));
                                    }
                                }
                            }
                            if (!i) {
                                ...
                                switch (n) {
                                    ...
                                    case 'insertReplacementText':
                                    case 'insertText':
                                        ('insertFromComposition' === n && ey.isComposing(C) && (x(!1), w.set(C, !1)), (null == r ? void 0 : r.constructor.name) === 'DataTransfer' ? ey.insertData(C, r) : 'string' == typeof r && (a ? U.current.push(() => d.ML.insertText(C, r)) : d.ML.insertText(C, r)));
                                }
                                var T = null == (p = D.get(C)) ? void 0 : p.unref();
                                (D.delete(C), !T || (C.selection && d.e6.equals(C.selection, T)) || d.YR.select(C, T));
                            }
                        }
                    }
                },
            ...
            ee = (0, c.useCallback)(
                (e) => {
                    (null == e ? (q.cancel(), Q.cancel(), I.delete(C), A.delete(C), j.current && eb && j.current.removeEventListener('beforeinput', $)) : eb && e.addEventListener('beforeinput', $), (j.current = e));
                },
                [j, $, q, Q]
            );
        eN(() => {
        ...
        var et = s([C, []]);
        if (_ && 1 === C.children.length && 1 === Array.from(d.NB.texts(C)).length && '' === d.NB.string(C) && !L) {
            var en = d.ML.start(C, []);
            et.push({
                [V]: !0,
                placeholder: _,
        ...
        (0, c.useEffect)(() => {
            setTimeout(() => {
                ...
                if (e) {
                    ...
                    if (er && !d.xv.equals(n, er, { loose: !0 })) return void k.set(C, er);
                }
                k.delete(C);
            });
        });
        var ef = null == (t = T.get(C)) || null == (n = t.getBoundingClientRect()) ? void 0 : n.height;
        return c.createElement(
            eK.Provider,
            { value: f },
            c.createElement(
                ...
                c.createElement(
                    ...
                    c.createElement(
                        ...
                        Object.assign(
                            ...
                            N,
                            {
                                spellCheck: (!!eb || !eE) && N.spellCheck,
                                autoCorrect: eb || !eE ? N.autoCorrect : 'false',
                                autoCapitalize: eb || !eE ? N.autoCapitalize : 'false',
                                'data-slate-editor': !0,
                                ...
                                onBeforeInput: (0, c.useCallback)(
                                    (e) => {
                                        if (!eb && !f && !tL(e, N.onBeforeInput) && ey.hasSelectableTarget(C, e.target) && (e.preventDefault(), !ey.isComposing(C))) {
                                            var t = e.data;
                                            d.ML.insertText(C, t);
                                        }
                                    },
                                ...
                                onBlur: (0, c.useCallback)(
                                    (e) => {
                                        if (f || z.isUpdatingSelection || !ey.hasSelectableTarget(C, e.target) || tL(e, N.onBlur)) return;
                                        var t = ey.findDocumentOrShadowRoot(C);
                                        if (z.latestElement !== t.activeElement) {
                                            var { relatedTarget: n } = e;
                                            if (n !== ey.toDOMNode(C, C) && !(W(n) && n.hasAttribute('data-slate-spacer'))) {
                                ...
                                onClick: (0, c.useCallback)(
                                    (e) => {
                                        if (ey.hasTarget(C, e.target) && !tL(e, N.onClick) && K(e.target)) {
                                ...
                                onCompositionEnd: (0, c.useCallback)(
                                    (e) => {
                                        if (ey.hasSelectableTarget(C, e.target) && (ey.isComposing(C) && (x(!1), w.set(C, !1)), null == J || J.handleCompositionEnd(e), !tL(e, N.onCompositionEnd) && !el && !eu && !eh && !eo && !eg && !em) && e.data) {
                                            var t = k.get(C);
                                            (k.delete(C), void 0 !== t && (M.set(C, C.marks), (C.marks = t)), d.ML.insertText(C, e.data));
                                            var n = M.get(C);
                                            (M.delete(C), void 0 !== n && (C.marks = n));
                                        }
                                    },
                                    [N.onCompositionEnd]
                                ),
                                onCompositionUpdate: (0, c.useCallback)(
                                    (e) => {
                                        !ey.hasSelectableTarget(C, e.target) || tL(e, N.onCompositionUpdate) || ey.isComposing(C) || (x(!0), w.set(C, !0));
                                    },
                                    [N.onCompositionUpdate]
                                ),
                                onCompositionStart: (0, c.useCallback)(
                                    (e) => {
                                        if (ey.hasSelectableTarget(C, e.target) && (null == J || J.handleCompositionStart(e), !tL(e, N.onCompositionStart) && !el)) {
                                            x(!0);
                                            var { selection: t } = C;
                                            if (t) {
                                ...
                                onCopy: (0, c.useCallback)(
                                    (e) => {
                                        ey.hasSelectableTarget(C, e.target) && !tL(e, N.onCopy) && (e.preventDefault(), ey.setFragmentData(C, e.clipboardData, 'copy'));
                                    },
                                    [N.onCopy]
                                ),
                                onCut: (0, c.useCallback)(
                                    (e) => {
                                        if (!f && ey.hasSelectableTarget(C, e.target) && !tL(e, N.onCut)) {
                                ...
                                onDragOver: (0, c.useCallback)(
                                    (e) => {
                                        if (ey.hasTarget(C, e.target) && !tL(e, N.onDragOver)) {
                                            var t = ey.toSlateNode(C, e.target);
                                ...
                                onDragStart: (0, c.useCallback)(
                                    (e) => {
                                        if (!f && ey.hasTarget(C, e.target) && !tL(e, N.onDragStart)) {
                                            var t = ey.toSlateNode(C, e.target),
                                                n = ey.findPath(C, t);
                                            if (
                                ...
                                onDrop: (0, c.useCallback)(
                                    (e) => {
                                        if (!f && ey.hasTarget(C, e.target) && !tL(e, N.onDrop)) {
                                            e.preventDefault();
                                            var t = C.selection,
                                ...
                                onDragEnd: (0, c.useCallback)(
                                    (e) => {
                                        (!f && z.isDraggingInternally && N.onDragEnd && ey.hasTarget(C, e.target) && N.onDragEnd(e), (z.isDraggingInternally = !1));
                                    },
                                    [f, N.onDragEnd]
                                ),
                                onFocus: (0, c.useCallback)(
                                    (e) => {
                                        if (!f && !z.isUpdatingSelection && ey.hasEditableTarget(C, e.target) && !tL(e, N.onFocus)) {
                                ...
                                onKeyDown: (0, c.useCallback)(
                                    (e) => {
                                        if (!f && ey.hasEditableTarget(C, e.target)) {
                                            null == J || J.handleKeyDown(e);
                                            var { nativeEvent: t } = e;
                                            if ((ey.isComposing(C) && !1 === t.isComposing && (w.set(C, !1), x(!1)), !(tL(e, N.onKeyDown) || ey.isComposing(C)))) {
                                                var { selection: n } = C,
                                                ...
                                                if (e2.isMoveBackward(t)) {
                                                    (e.preventDefault(), n && d.e6.isCollapsed(n) ? d.YR.move(C, { reverse: !a }) : d.YR.collapse(C, { edge: 'start' }));
                                                    return;
                                                }
                                                if (e2.isMoveForward(t)) {
                                                    (e.preventDefault(), n && d.e6.isCollapsed(n) ? d.YR.move(C, { reverse: a }) : d.YR.collapse(C, { edge: 'end' }));
                                                    return;
                                                }
                                                ...
                                                if (eb) {
                                                    if ((e_ || eu) && n && (e2.isDeleteBackward(t) || e2.isDeleteForward(t)) && d.e6.isCollapsed(n)) {
                                ...
                                onPaste: (0, c.useCallback)(
                                    (e) => {
                                        !f && ey.hasEditableTarget(C, e.target) && !tL(e, N.onPaste) && (!eb || X(e.nativeEvent) || eu) && (e.preventDefault(), ey.insertData(C, e.clipboardData));
                                    },
                                    [f, N.onPaste]
                                )
                            }
...
var tV = ['editor', 'children', 'onChange', 'value'],
    tF = (e) => {
        var { editor: t, children: n, onChange: r, value: i } = e,
            ...
            { selectorContext: u, onChange: _ } = tB(t),
            f = (0, c.useCallback)(() => {
                (r && r(t.children),
                    l((e) => ({
                        v: e.v + 1,
        ...
        return (
            ...
            c.createElement(tU.Provider, { value: u }, c.createElement(eq.Provider, { value: s }, c.createElement(eD.Provider, { value: s.editor }, c.createElement(tk.Provider, { value: p }, n))))
        );
    },
    tZ = (e, t) => {
    ...
    tY = (e, t) => {
        ...
        for (; o !== r.length && o !== i; ) (tH(e, d.ML.range(e, r[o]), n) ? (a = o) : (i = o), (o = Math.floor((i + a) / 2)));
...
var tz = function (e) {
        ...
        return (
            ...
            (n.addMark = (e, t) => {
                var r, i;
                (null == (r = x.get(n)) || r(), !k.get(n) && null != (i = j.get(n)) && i.length && k.set(n, null), M.delete(n), o(e, t));
            }),
            (n.removeMark = (e) => {
                var t;
                (!k.get(n) && null != (t = j.get(n)) && t.length && k.set(n, null), M.delete(n), s(e));
            }),
            (n.deleteBackward = (e) => {
                    ...
                    if (!d.e6.isCollapsed(r) || o) {
                        ...
                        if (
                            ...
                            var [_] = s,
                                f = l.cloneRange(),
                                p = ey.toDOMNode(n, _);
                            (f.setEndAfter(p), (c = f.cloneContents()));
                        }
                        if (
