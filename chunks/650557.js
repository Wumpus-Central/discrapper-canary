...
var y = new WeakMap(),
    ...
    $ = (e, t, n) => {
        for (var { childNodes: r } = e, i = r[t], o = t, a = !1, s = !1; (Y(i) || (W(i) && 0 === i.childNodes.length) || (W(i) && 'false' === i.getAttribute('contenteditable'))) && (!a || !s); ) {
            if (o >= r.length) {
        ...
        toSlatePoint(e, t, n) {
            ...
            if (el && !l && !r) {
                ...
                if (I && ey.hasDOMNode(e, I, { editable: !0 })) {
                    ...
                    return (
                        I.querySelector('[data-slate-leaf]') || (A = a),
                        {
                            path: T,
                            offset: A
                        }
    ...
    ex = (e) => {
        var { leaf: t, isLast: n, text: r, parent: i, renderPlaceholder: o, renderLeaf: a = (e) => c.createElement(eM, Object.assign({}, e)) } = e,
            s = (0, c.useRef)(null),
            l = (0, c.useRef)(null),
            u = eL(),
            d = (0, c.useRef)(null);
    ...
    ej = (e) => {
        ...
        var m = (0, c.useCallback)(
            (e) => {
                var t = C.get(s);
                e ? (null == t || t.set(f, e), A.set(a, e), T.set(e, a)) : (null == t || t.delete(f), A.delete(a), l.current && T.delete(l.current)), (l.current = e);
            },
            [l, s, f, a]
        );
        ...
        _ = () => {
            ...
            for (var o = y(); (l = null == (_ = j.get(t)) ? void 0 : _[0]); ) {
                ...
                (t.selection && d.e6.equals(t.selection, m)) || d.YR.select(t, m),
                    ...
                    e8(t, l) || ((o = !1), U.delete(t), M.delete(t), (i = 'action'), G.delete(t), n.cancel(), r.cancel(), null == e || e.unref());
            }
...
function tv(e) {
    ...
    return tg(t, o.handleDomMutations, tO), x.set(r, o.scheduleFlush), i && o.flush(), o;
}
function tI() {
    var e = eL(),
        t = (0, c.useRef)(!1),
...
var tC = (e) => c.createElement(c.Fragment, null, eW(e)),
    tP = (e) => {
        var t,
            ...
            { autoFocus: o, decorate: s = tw, onDOMBeforeInput: u, placeholder: f, readOnly: _ = !1, renderElement: p, renderLeaf: h, renderPlaceholder: m = r, scrollSelectionIntoView: E = tD, style: b = {}, as: y = 'div', disableDefaultStyles: O = !1 } = e,
            N = g(e, tS),
            C = eQ(),
            [L, x] = (0, c.useState)(!1),
            j = (0, c.useRef)(null),
                        ...
                        Object.assign(
                            ...
                            N,
                            {
                                ...
                                onCompositionEnd: (0, c.useCallback)(
                                    (e) => {
                                        if (ey.hasSelectableTarget(C, e.target) && (ey.isComposing(C) && (x(!1), w.set(C, !1)), null == J || J.handleCompositionEnd(e), !tL(e, N.onCompositionEnd) && !el && !eu && !eh && !ea && !eg && !em) && e.data) {
                                            var t = k.get(C);
...
var tz = function (e) {
        ...
        return (
            ...
            (n.addMark = (e, t) => {
                var r, i;
                null == (r = x.get(n)) || r(), !k.get(n) && null != (i = j.get(n)) && i.length && k.set(n, null), M.delete(n), a(e, t);
            }),
            (n.removeMark = (e) => {
                var t;
