...
var y = new WeakMap(),
    ...
    eM = c.memo(ex, (e, t) => t.parent === e.parent && t.isLast === e.isLast && t.renderLeaf === e.renderLeaf && t.renderPlaceholder === e.renderPlaceholder && t.text === e.text && d.xv.equals(t.leaf, e.leaf) && t.leaf[Z] === e.leaf[Z]),
    ek = (e) => {
    ...
    ej = (e) => {
        ...
        var m = (0, c.useCallback)(
            (e) => {
                var t = C.get(s);
                (e ? (null == t || t.set(f, e), A.set(a, e), S.set(e, a)) : (null == t || t.delete(f), A.delete(a), l.current && S.delete(l.current)), (l.current = e));
            },
            [l, s, f, a]
        );
    ...
    eG = (e) => {
        var { decorations: t, element: n, renderElement: r = (e) => c.createElement(eZ, Object.assign({}, e)), renderPlaceholder: o, renderLeaf: a, selection: s } = e,
            l = eL(),
            u = ez(),
            f = l.isInline(n),
            _ = ey.findKey(l, n),
    ...
    eW = (e) => {
        for (var { decorations: t, node: n, renderElement: r, renderPlaceholder: i, renderLeaf: o, selection: a } = e, s = eV(), l = eL(), u = ey.findPath(l, n), f = [], _ = d.W_.isElement(n) && !l.isInline(n) && d.ML.hasInlines(l, n), p = 0; p < n.children.length; p++) {
            var h = u.concat(p),
                m = n.children[p],
                g = ey.findKey(l, m),
                E = d.ML.range(l, h),
