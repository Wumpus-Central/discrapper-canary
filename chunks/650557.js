...
var y = new WeakMap(),
    ...
    $ = (e, t, n) => {
        for (
            var { childNodes: r } = e, i = r[t], o = t, a = !1, s = !1;
    ...
    ey = {
        ...
        hasDOMNode(e, t) {
            ...
            return (
                !!n &&
                n.closest("[data-slate-editor]") === o &&
                (!i ||
                    !!n.isContentEditable ||
                    ("boolean" == typeof n.isContentEditable && n.closest('[contenteditable="false"]') === o) ||
    ...
    ex = (e) => {
        var {
                ...
                parent: i,
                renderPlaceholder: o,
                renderLeaf: a = (e) => c.createElement(ej, Object.assign({}, e)),
            } = e,
            s = (0, c.useRef)(null),
            l = (0, c.useRef)(null),
            u = eL(),
    ...
    ek = (e) => {
        for (
            var { decorations: t, isLast: n, parent: r, renderPlaceholder: i, renderLeaf: o, text: a } = e,
                s = eL(),
                l = (0, c.useRef)(null),
                u = d.xv.decorations(a, t),
                f = ey.findKey(s, a),
                _ = [],
                p = 0;
            p < u.length;
        ...
        var m = (0, c.useCallback)(
            (e) => {
                var t = C.get(s);
                e
                    ? (null == t || t.set(f, e), A.set(a, e), S.set(e, a))
                    : (null == t || t.delete(f), A.delete(a), l.current && S.delete(l.current)),
                    (l.current = e);
            },
            [l, s, f, a],
        );
    ...
    eW = (e) => {
        for (
            var { decorations: t, node: n, renderElement: r, renderPlaceholder: i, renderLeaf: o, selection: a } = e,
                s = eV(),
                l = eL(),
                u = ey.findPath(l, n),
                f = [],
...
function th(e) {
    var { editor: t, scheduleOnDOMSelectionChange: n, onDOMSelectionChange: r } = e,
        ...
        _ = () => {
            ...
            for (var o = y(); (l = null == (_ = k.get(t)) ? void 0 : _[0]); ) {
                var l,
                    _,
                    p,
                    h = M.get(t);
    ...
    tR = (e) => {
                ...
                l()(() => {
                    if (
                        ...
                        var e = ey.findDocumentOrShadowRoot(C),
                            ...
                            n = ey.toDOMNode(C, C),
                            r = e.getSelection();
                        if ((t === n ? ((z.latestElement = t), P.set(C, !0)) : P.delete(C), !r))
                            return d.YR.deselect(C);
        ...
        eN(() => {
            k.current && (e = H(k.current))
                ? (v.set(C, e), I.set(C, k.current), A.set(C, k.current), S.set(k.current, C))
                : A.delete(C);
            var e,
                { selection: t } = C,
                        ...
                        if (!(i && ey.isComposing(C))) {
                            ...
                            if (!i) {
                                ...
                                switch (n) {
                                    ...
                                    case "insertReplacementText":
                                    case "insertText":
                                        "insertFromComposition" === n && ey.isComposing(C) && (x(!1), w.set(C, !1)),
                                            (null == r ? void 0 : r.constructor.name) === "DataTransfer"
                                                ? ey.insertData(C, r)
                                                : "string" == typeof r &&
                                                  (o
                                                      ? U.current.push(() => d.ML.insertText(C, r))
                                                      : d.ML.insertText(C, r));
                                }
                            ...
                            N,
                            {
                                ...
                                onBeforeInput: (0, c.useCallback)(
                                    (e) => {
                                        if (
                                            !eb &&
                                            !_ &&
                                            !tL(e, N.onBeforeInput) &&
                                            ey.hasSelectableTarget(C, e.target) &&
                                            (e.preventDefault(), !ey.isComposing(C))
                                        ) {
                                            var t = e.data;
                                            d.ML.insertText(C, t);
                                        }
                                ...
                                onCompositionEnd: (0, c.useCallback)(
                                    (e) => {
                                        if (
                                            ey.hasSelectableTarget(C, e.target) &&
                                            (ey.isComposing(C) && (x(!1), w.set(C, !1)),
                                            null == J || J.handleCompositionEnd(e),
                                            !tL(e, N.onCompositionEnd) && !el && !eu && !eh && !ea && !eg && !em) &&
                                            e.data
                                        ) {
                                            var t = M.get(C);
                                            M.delete(C),
                                                void 0 !== t && (j.set(C, C.marks), (C.marks = t)),
                                                d.ML.insertText(C, e.data);
                                            var n = j.get(C);
                                ...
                                onCopy: (0, c.useCallback)(
                                    (e) => {
                                        ey.hasSelectableTarget(C, e.target) &&
                                            !tL(e, N.onCopy) &&
                                            (e.preventDefault(), ey.setFragmentData(C, e.clipboardData, "copy"));
                                    },
                                    [N.onCopy],
                                ),
                                    ...
                                    (e) => {
                                        if (!_ && ey.hasTarget(C, e.target) && !tL(e, N.onDragStart)) {
                                            ...
                                            (z.isDraggingInternally = !0),
                                                ey.setFragmentData(C, e.dataTransfer, "drag");
                                        }
                                    },
                                    [_, N.onDragStart],
                                ),
                                ...
                                onFocus: (0, c.useCallback)(
                                    (e) => {
                                        if (
                                            !_ &&
                                            !z.isUpdatingSelection &&
                                            ey.hasEditableTarget(C, e.target) &&
                                            !tL(e, N.onFocus)
                                        ) {
                                            var t = ey.toDOMNode(C, C);
                                            if (
                                                ((z.latestElement = ey.findDocumentOrShadowRoot(C).activeElement),
                                                ec && e.target !== t)
                                            )
                                                return void t.focus();
                                            P.set(C, !0);
                                ...
                                onKeyDown: (0, c.useCallback)(
                                    (e) => {
                                        if (!_ && ey.hasEditableTarget(C, e.target)) {
                                            ...
                                            var { nativeEvent: t } = e;
                                            if (
                                                (ey.isComposing(C) && !1 === t.isComposing && (w.set(C, !1), x(!1)),
                                                !(tL(e, N.onKeyDown) || ey.isComposing(C)))
                                            ) {
                                                var { selection: n } = C,
                                                ...
                                                if (e2.isMoveBackward(t)) {
                                                    e.preventDefault(),
                                                        n && d.e6.isCollapsed(n)
                                                            ? d.YR.move(C, { reverse: !o })
                                                            : d.YR.collapse(C, { edge: "start" });
                                                    return;
                                                }
                                                ...
                                                if (eb) {
                                                    if (
                                                        ...
                                                        if (
                                                            d.W_.isElement(l) &&
                                                            d.ML.isVoid(C, l) &&
                                                            (d.ML.isInline(C, l) || d.ML.isBlock(C, l))
                                                        ) {
                                                            e.preventDefault(),
                                                                d.ML.deleteBackward(C, { unit: "block" });
                                                            return;
                                                    ...
                                                    if (e2.isDeleteBackward(t)) {
                                                        e.preventDefault(),
                                                            n && d.e6.isExpanded(n)
                                                                ? d.ML.deleteFragment(C, { direction: "backward" })
                                                                : d.ML.deleteBackward(C);
                                                        return;
                                                    }
                                                    if (e2.isDeleteForward(t)) {
                                                        e.preventDefault(),
                                                            n && d.e6.isExpanded(n)
                                                                ? d.ML.deleteFragment(C, { direction: "forward" })
                                                                : d.ML.deleteForward(C);
                                                        return;
                                                    }
                                ...
                                onPaste: (0, c.useCallback)(
                                    (e) => {
                                        !_ &&
                                            ...
                                            (e.preventDefault(), ey.insertData(C, e.clipboardData));
                                    },
                                    [_, N.onPaste],
                                ),
                            },
...
var tZ = ["editor", "children", "onChange", "value"],
        ...
        return (
            ...
            c.createElement(
                ...
                c.createElement(
                    eq.Provider,
                    { value: s },
                    c.createElement(eD.Provider, { value: s.editor }, c.createElement(tM.Provider, { value: p }, n)),
                ),
            )
        );
    },
    ...
    tY = (e, t) => {
        ...
        for (; a !== r.length && a !== i; )
            tH(e, d.ML.range(e, r[a]), n) ? (o = a) : (i = a), (a = Math.floor((i + o) / 2));
