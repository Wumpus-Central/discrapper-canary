    ...
    handleWriteCaches(e, t) {
        ...
        if (t) {
            ...
            let t = '0',
                ...
                d = new Set(l);
            for (let e of ((s = null !== (i = r()(l).sort(o.default.compare).reverse().value()[0]) && void 0 !== i ? i : '0'), n)) null != e._lastMessageId && (1 === o.default.compare(e._lastMessageId, t) && (t = e._lastMessageId), d.has(e.channelId) && 1 === o.default.compare(e._lastMessageId, s) && (s = e._lastMessageId));
