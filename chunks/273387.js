...
let C = new _(l.Z, {
    ...
    GUILD_DIRECTORY_ENTRY_CREATE: function (e) {
        ...
        if (((m[s] = u(c({}, m[s]), { [f]: u(c({}, null === (n = m[s]) || void 0 === n ? void 0 : n[f]), { [p.guildId]: p }) })), null != g[s])) {
    ...
    GUILD_DIRECTORY_ENTRY_DELETE: function (e) {
        ...
        let { channelId: r, guildId: i } = e,
            l = null === (t = h[r]) || void 0 === t ? void 0 : t[i];
        if (null == l) return;
    ...
    GUILD_DIRECTORY_ENTRY_UPDATE: function (e) {
        ...
        let { channelId: b, entry: _ } = e,
            C = (0, o.MQ)(_),
            v = null === (t = h[b]) || void 0 === t ? void 0 : t[C.guildId];
        h[b] = u(c({}, h[b]), { [C.guildId]: c({}, v, C) });
        ...
        null != v && y !== x && delete j[C.guildId],
            (m[b] = u(c({}, m[b]), {
                [y]: j,
                [x]: u(c({}, null === (r = m[b]) || void 0 === r ? void 0 : r[x]), { [C.guildId]: c({}, v, C) })
            })),
            x !== y &&
                null != g[b] &&
                (g[b] = u(c({}, g[b]), {
