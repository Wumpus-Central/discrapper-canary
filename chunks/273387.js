...
let O = new y(l.Z, {
    ...
    GUILD_DIRECTORY_ENTRY_UPDATE: function (e) {
        ...
        let { channelId: b, entry: y } = e,
            O = (0, a.MQ)(y),
            j = null == (t = h[b]) ? void 0 : t[O.guildId];
        h[b] = d(c({}, h[b]), { [O.guildId]: c({}, j, O) });
        let x = null != (i = null == j ? void 0 : j.primaryCategoryId) ? i : s.AR.UNCATEGORIZED,
            v = null != (l = O.primaryCategoryId) ? l : s.AR.UNCATEGORIZED,
            C = Object.assign({}, null == (n = g[b]) ? void 0 : n[x]);
        null != j && x !== v && delete C[O.guildId],
            (g[b] = d(c({}, g[b]), {
                [x]: C,
                [v]: d(c({}, null == (r = g[b]) ? void 0 : r[v]), { [O.guildId]: c({}, j, O) }),
            })),
            v !== x &&
                null != m[b] &&
                (m[b] = d(c({}, m[b]), {
