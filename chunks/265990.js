...
function U(e) {
    let { section: t, showSpamCta: n } = e,
        l = r.useMemo(() => (n ? w : t !== L.m3P.PENDING ? M : void 0), [n, t]);
    return (0, i.jsx)("div", { className: j.y7, children: (0, i.jsx)(S.A, { type: t, onClick: l }, t) });
}
let G = function (e) {
    let { titleId: t } = e,
    ...
    let [Y, W] = r.useState(() => {
        ...
        $ = r.useCallback(
            (e, t) => {
                ...
                switch (d) {
                    case L.m3P.PENDING:
                        return (0, i.jsx)(x.A, { ...r, isFocused: M, onAcceptFriendRequest: () => F(e) }, n);
                    case L.m3P.SUGGESTIONS:
                        return (0, i.jsx)(O.A, { ...r, isFocused: M }, n);
                    case L.m3P.ALL:
                        return (0, i.jsx)(
                            N.A,
                            { ...r, isFocused: M, sectionIndex: t, hasFriendAnniversarySection: q },
                            `${t}-${n}`,
                        );
                    case L.m3P.ONLINE:
                    default:
                        return (0, i.jsx)(N.A, { ...r, isFocused: M }, n);
                }
            },
            [d, M, q, F],
        ),
    ...
    let en = r.useMemo(
            () =>
                d === L.m3P.ALL && q && J.some((e) => e.giftIntentType === R.np.FRIEND_ANNIVERSARY)
        ...
        ei = r.useMemo(() => {
            switch (d) {
                ...
                case L.m3P.ALL:
                    if (!(q && J.some((e) => e.giftIntentType === R.np.FRIEND_ANNIVERSARY))) return [J];
                    {
                        let e = [];
                        return (
                            J.forEach((t) => {
        ...
        eo = r.useCallback(
            (e) => {
                ...
                return d === L.m3P.PENDING && 0 === e
                    ...
                    : (0, i.jsx)("div", { className: j.Gf, children: (0, i.jsx)(b.A, { id: t, title: r }) }, r);
            },
            [ei, d, t, el, ea],
        ),
        ed = r.useCallback(
                ...
                d === L.m3P.ALL && 0 === e && q && en > p.ZD
                    ? (0, i.jsx)("div", {
                          ...
                          children: (0, i.jsx)(o.Button, {
                              ...
                              variant: "secondary",
                              size: "sm",
                              text: P.intl.string(K ? P.t["6MwJo/"] : P.t["37C26f"]),
                              onClick: es,
                              "aria-label": P.intl.string(K ? P.t["6MwJo/"] : P.t["37C26f"]),
                          }),
                      })
                    : null,
            [d, en, K, es, q],
