"use strict";
n.d(t, { Pq: () => ef, rq: () => e_, Ay: () => ep, he: () => eh }), n(938796);
var i = n(481613),
    r = n.n(i),
    s = n(562708),
    a = n(607399),
...
function ec(e) {
    ...
    if (!d && !_ && !r?.forceTransition && o && K.A.getGuildId() !== t) return;
    let { type: f } = i,
        p = V.A.getChannel(i.id),
        E = (function (e, t, n) {
            if (n?.targetType === es.yV.ROLE_SUBSCRIPTIONS_PURCHASE) return ei.VV.ROLE_SUBSCRIPTIONS;
            if (n?.targetType == null && !(0, G.QE)(t.type) && (0, R.K)(e)) return ei.VV.GUILD_HOME;
            let i = V.A.getChannel(t.id),
                r = (0, G.TA)(t.type);
            return W.A.can(r, i) ? t.id : (B.Ay.getDefaultChannel(e, !0, et.xBc.CREATE_INSTANT_INVITE)?.id ?? t.id);
        })(t, i, r),
        m = f === et.rbe.GUILD_STAGE_VOICE,
              ...
              Promise.resolve()
                  ...
                  .then((e) => {
                      let { default: n } = e,
                          a = () => {
                              if (m) {
                                  (0, U.av)(i instanceof G.YB ? i : (0, G.createChannelRecord)(i)), (0, k.pX)(I);
                                  return;
                              }
                              r?.muteOnJoinVoiceChannel && Q.A.setSelfMute(h.x.DEFAULT, !0),
                                  n.selectVoiceChannel(E),
                                  u === es.yV.STREAM &&
                                      null != l &&
                                      ee.Nl({ streamType: er.U4.GUILD, ownerId: l, guildId: t, channelId: E }),
                                  u === es.yV.EMBEDDED_APPLICATION &&
                                      null != c &&
                                      ((0, k.pX)(et.BVt.CHANNEL(t ?? et.ME, E)),
                                      A({
                                          channelId: E,
                                          applicationId: c,
                                          intent: r?.intent,
                      ...
                      !d && (0, v.V)(t, [H.A, $.default, j.Ay]) ? (0, N.Ze)(t, a) : a();
                  });
          })
        : (0, g.AX)(p) &&
          u === es.yV.EMBEDDED_APPLICATION &&
...
let ep = {
    ...
    async getAllFriendInvites(e) {
        ...
        (el = _.Bo.get({ url: et.Rsh.FRIEND_INVITES, context: { location: e }, rejectWithError: !1 })),
    ...
    createFriendInvite: (e, t) => (
        ...
        _.Bo.post({ url: et.Rsh.FRIEND_INVITES, body: e ?? {}, context: { location: t }, rejectWithError: !1 }).then(
            (e) => {
                let { body: t } = e;
    ...
    revokeFriendInvites: () => (
        ...
        _.Bo.del({ url: et.Rsh.FRIEND_INVITES, context: { location }, rejectWithError: !1 }).then((e) => {
            let { body: t } = e;
            p.h.dispatch({ type: "FRIEND_INVITE_REVOKE_SUCCESS", invites: t });
        })
    ),
    revokeFriendInvite: (e) => _.Bo.del({ url: et.Rsh.INVITE(e), rejectWithError: !1 }),
    ...
    acceptInvite(e) {
        let { inviteKey: t, context: i, callback: r, skipOnboarding: s } = e,
            a = (0, w.y$)(t),
            u = a.baseCode,
            c = F.default.getSessionId(),
            d = Y.A.getReceivedInstallationIdForInviteCode(u),
            h = { ...i, invite_guild_scheduled_event_id: a.guildScheduledEventId },
            f = $.default.getCurrentUser();
        return f?.hasFlag(et.nhx.QUARANTINED)
            ...
            : (p.h.dispatch({ type: "INVITE_ACCEPT", code: t }),
              _.Bo.post({
                  ...
                  context: h,
                  oldFormErrors: !0,
                  body: { session_id: c, invite_instance_id: i.invite_instance_id, received_installation_id: d },
                  rejectWithError: !1,
              }).then(
                  async (e) => {
                      null != d && this.clearReceivedInstallationIdForInviteCode(u),
                          p.h.dispatch({ type: "INVITE_ACCEPT_SUCCESS", invite: e.body, code: t });
                      let i = b.Ay.getGuildScheduledEvent(a.guildScheduledEventId),
                          c = { ...e.body, guild_scheduled_event: i },
                          _ = c?.guild_id ?? c?.guild?.id,
                          h = (0, l.Lt)(c.flags ?? 0, o.Q.IS_GUEST_INVITE);
                      if (!s && !h && null != _ && c.new_member && !c.show_verification_form) {
                  ...
                  (e) => {
                      throw (
                          (e.body?.code === et.t02.USER_GUILD_JOIN_LARGE_GUILD_UNDERAGE_DISALLOWED &&
                              (0, I.yO)(en.w_.JOIN_LARGE_GUILD_UNDERAGE),
                          p.h.dispatch({
    ...
    transitionToInvite(e, t, n) {
        ...
        if (null != r && r.features?.includes(et.GuildFeatures.HUB)) return void L.A.onOpenHubInvite(e);
        let s = e.flags ?? 0,
            a = (0, l.Lt)(s, o.Q.IS_GUEST_INVITE) || (0, l.Lt)(s, o.Q.IS_APPLICATION_BYPASS);
        if (null != r && !a && e.new_member && (0, D.h)(r)) return void (0, D.W)(r.id);
        if (null == i) return;
        let u = eu(e);
        null != t && (u.transitionTo = t),
            null != n && (u.muteOnJoinVoiceChannel = n),
            ec({ guildId: null != r ? r.id : et.ME, channel: i, options: u });
    },
    ...
    openApp(e, t, n, i, s) {
        ...
        } else "#" === (o = null != t ? et.BVt.INVITE_PROXY(t) : "")[0] && (o = o.slice(1)), (o = `discord://${o}`);
        X.A.launch(o, (t) => {
