...
var i = n(477900),
    ...
    Z = n(375708);
function q(e) {
    let { application: t, onAction: n, onClose: a } = e,
        s = (0, P.bG)([$.default], () => $.default.getId()),
        l = (0, Y.Ay)(s, null),
        o = t.getCanonicalGameId(),
        { data: d } = (0, H.I)(o),
        c = r.useMemo(
            () =>
                !(
    ...
    return c ? (0, i.jsx)(K.FD, { text: Z.intl.string(Z.t.BjYzmC), onClick: u, fullWidth: !0 }) : null;
}
var X = n(601007),
    Q = n(206828),
    J = n(308335),
        ...
        ? (0, i.jsx)("div", {
              ...
              children: n.buttons.map((e, a) =>
                  (0, i.jsx)(
                      K.FD,
                      {
                          text: s ? Z.intl.string(Z.t.I6JG46) : e,
                          onClick: (e) => {
                              e.stopPropagation(),
...
function eO(e) {
    let { platformType: t, icon: n, onAction: r } = e,
        ...
        { themeType: s } = (0, b.E)(),
        l = s === ea.d.MODAL_V2;
    return (0, P.bG)([eR.A], () => null != eR.A.getAccount(null, t))
        ? null
        : (0, i.jsx)(K.FD, {
              icon: n,
              text: Z.intl.formatToPlainString(Z.t.XWSHTb, { platform: eN.A.get(t).name }),
              fullWidth: !l,
              onClick: (e) => {
                  e.stopPropagation();
                  let n = t === eg.fg2.XBOX;
...
function eP(e) {
    ...
    return (0, R.Cy)(t) && c && null != o && null != l
        ? (0, i.jsx)(K.FD, {
...
function ex(e) {
    let { user: t, activity: n, onAction: r, onClose: a, application: s, containerClassName: l } = e,
        { themeType: o } = (0, b.E)(),
        d = (0, P.bG)([$.default], () => $.default.getId() === t.id),
        c = (0, V.JC)(s),
        ...
        L = (function () {
            if (d)
                return N && n?.type === eg.$pd.PLAYING && null != s
                    ? (0, i.jsx)(q, { application: s, onAction: r, onClose: a })
                    : null;
            if (n?.buttons != null && n?.buttons.length >= 1)
                return null != O
                    ? (0, i.jsxs)("div", {
                          className: C,
                          children: [(0, i.jsx)(eo, { user: t, activity: n, onAction: r }), O],
                      })
                    : (0, i.jsx)(eo, { user: t, activity: n, onAction: r });
            if (!u && c && null != s && !S) {
                let e = (0, i.jsx)(eG.A, { application: s, onAction: r, onClose: a, analyticsLocations: E });
                return null != O ? (0, i.jsxs)("div", { className: C, children: [e, O] }) : e;
            }
            ...
            if (!(0, w.A)(n)) {
                if ((0, k.A)(n))
                    return (0, i.jsx)(eO, { platformType: eg.fg2.XBOX, icon: () => (0, i.jsx)(et.A, {}), onAction: r });
                if ((0, x.A)(n))
                    return (0, i.jsx)(eO, {
...
function eq(e) {
    let {
        ...
        K = (0, D.A)(r),
        $ = null != K.text && "" !== K.text,
        { largeImage: q, smallImage: X } = (0, p.XN)(r, a, "user_profile_activity_card"),
        Q = (function (e) {
        ...
        return r.type === eg.$pd.HANG_STATUS
            ...
            : (0, A.A)(r) && null != P
              ? (0, i.jsx)(eH.A, {
                    ...
                    text: Z.intl.formatToPlainString(Z.t["hq/Qze"], { guildName: P.name }),
                    onClick: () => {
    ...
    function et() {
        ...
        if ((0, E.A)(r))
            return r.party?.size == null && r.application_id === eZ.I4
                ? (0, i.jsxs)("div", {
                      className: es.CI,
                      children: [
                          (0, i.jsx)(T.O, {
                ...
                : (0, _.A)(r) && r.party?.size != null && r.party?.size.length >= 2
                  ...
                  : null == r.party
                    ...
                    : null;
        if ((0, R.Cy)(r) && r.party?.size != null && r.party?.size.length >= 2) {
