e.exports = (function () {
    ...
    var e,
                            ...
                            if (null != m)
                                for (var g = 0; g < m.length; g++) {
                                    ...
                                    var S = null == a.prevCapture ? "" : a.prevCapture[0],
                                        y = I.match(t, a, S);
                                    if (y) {
                                        var C = I.quality ? I.quality(y, a, S) : 0;
                                        (T < f || C > h) && ((c = A), (d = I), (_ = y), (h = C), (f = T));
                                    }
                                }
                        }
                        if (null == d || null == _)
        ...
        A = function (e, t, n, i) {
            ...
            for (var s in (n = n || {})) {
                var a = n[s];
                Object.prototype.hasOwnProperty.call(n, s) && a && (r += " " + C(s) + '="' + C(a) + '"');
            }
            var o = "<" + e + r + ">";
            return i ? o + t + "</" + e + ">" : o;
        },
    ...
    var W = 0,
        K = {
            ...
            link: {
                ...
                match: f(RegExp("^\\[(" + V + ")\\]\\(" + B + "\\)")),
                parse: function (e, t, n) {
                    return { content: t(e[1], n), target: v(e[2]), title: e[3] };
                },
                react: function (e, t, n) {
            ...
            image: {
                ...
                match: f(RegExp("^!\\[(" + V + ")\\]\\(" + B + "\\)")),
                parse: function (e, t, n) {
                    return { alt: e[1], target: v(e[2]), title: e[3] };
                },
                react: function (e, t, n) {
