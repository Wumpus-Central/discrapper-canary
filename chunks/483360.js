    ...
    tt = {
            ...
            t =
                null != r
                    ? s()(F.ZP.getChannels(r)[l])
                          .map((e) => e.channel)
                          .concat(g ? (m ? U.Z.getAllThreadsForGuild(r) : R.Z.computeAllActiveJoinedThreads(r)) : [])
                          .value()
        ...
        queryMentionSuggestionResults(e) {
            ...
            c: for (let e of o) {
                ...
                if (
                    (e instanceof M.Z
                        ? ((o = e), (t = null == (h = B.ZP.getNick(c, o.id)) ? void 0 : h.toLocaleLowerCase()))
