...
let ey = new m.Z("AutocompleteUtils"),
    ...
    eZ = /(\t|\s)/,
    eF = [],
    eB = (r = n(786074).Z).MENTION_EVERYONE,
    eV = r.MENTION_HERE,
    eH = r.MENTION_GAME,
...
function ez(e) {
    ...
    let r = Z.Z.getFrequentlyWithoutFetchingLatest(),
        i = r.reduce((e, t) => {
            let { id: n } = t,
                r = Z.Z.getScoreWithoutFetchingLatest(n);
            return r > e ? r : e;
        }, 0),
        a = [];
    switch (e) {
...
let eq = [F.sH, F.Zb, ec.d4z.GUILD_CATEGORY];
function eQ(e, t) {
...
function e2(e, t, n) {
    return (
        e === t || ((!!n || !!(0, L.Km)(t)) && (e === F.sH ? (0, L.r8)(t) || (0, L.bw)(t) : e === F.Zb && (0, L.bw)(t)))
    );
}
function e4(e, t) {
...
let te = (0, ee.oH)((e, t, n) => {
    ...
    tt = {
        ...
        queryChannels(e) {
            ...
            t =
                null != r
                    ? s()(F.ZP.getChannels(r)[l])
                          .map((e) => e.channel)
                          .concat(g ? (h ? U.Z.getAllThreadsForGuild(r) : w.Z.computeAllActiveJoinedThreads(r)) : [])
                          .value()
            ...
            for (let e of t) {
                ...
                if (0 !== c) {
                    ...
                    0 !== c &&
                        ...
                        e.isThread() && (e.isActiveThread() || (c -= eN), R.Z.hasJoined(e.id) || (c -= eP)),
                        (c = Math.min(
                            c + Math.min(null != (O = Z.Z.getScoreWithoutFetchingLatest(e.id)) ? O : 0 / y, 1) * ew,
                            c >= eS ? eO : eS,
                        )),
                        b.push({
        ...
        queryMentionResults(e) {
            ...
            !n.isPrivate() &&
                r &&
                c &&
                (y < h && a()(O, eB().test) && (S.push(eB()), (y += 1)),
                i && y < h && a()(O, eV().test) && (S.push(eV()), (y += 1)));
            ...
            return (
                r &&
                    ...
                    (y < h || 0 === O.length) &&
                    a()(O, eH().test) &&
                    (y >= h && (S.length > 0 ? S.pop() : v.length > 0 ? v.pop() : E.length > 0 && E.pop()),
                    S.push(eH()),
                    (y += 1)),
                _.Z.getConfig({ location: "mention autocomplete" }).enabled &&
                    ...
                    (y >= h && (v.length > 0 ? v.pop() : E.length > 0 && E.pop()), S.push(eY()), (y += 1)),
                {
                    users: E,
                    globals: S,
                    roles: v,
        ...
        queryGuildMentionResults(e) {
            ...
            return (
                r &&
                    o &&
                    (u < ec.rnv && a()(d, eB().test) && (p.push(eB()), (u += 1)),
        ...
        queryChannelResults(e) {
            let { query: t, channel: n, type: r = F.sH, channelTypes: i } = e;
            return {
        ...
        querySoundmoji(e, t) {
            ...
            let r = Array.from(I.Z.getSounds().values()).reduce(
                (e, n) => (
                    n.forEach((n) => {
        ...
        queryMentionSuggestionResults(e) {
            let { query: t, channel: n, limit: r = 3, boosters: i, onlyExactMatch: a = !1 } = e,
                o = n.isPrivate()
                    ...
                    : B.ZP.getMembers(n.guild_id).filter(eJ),
                s = k.default.getId(),
                l = X.default.getUsers(),
                c = Q.Z.getGuildId(),
                u = t.toLocaleLowerCase(),
            ...
            c: for (let e of o) {
                ...
                if (
                    (e instanceof M.Z
                        ? ((o = e), (t = null == (m = B.ZP.getNick(c, o.id)) ? void 0 : m.toLocaleLowerCase()))
