    ...
    for (; m < h; ) {
        ...
        if (null != r && (null == i || i(r))) {
            ...
            (o && t === r.id) || n.substring(0, u.length) === u || i.substring(0, u.length) === u || (null == e ? void 0 : e.substring(0, u.length)) === u || (null == c ? void 0 : c.substring(0, u.length)) === u || (null == h ? void 0 : h.substring(0, u.length)) === u || (null == m ? void 0 : m.substring(0, u.length)) === u
                ...
                : l.substring(0, d.length) === d || (null == _ ? void 0 : _.substring(0, d.length)) === d || (null == E ? void 0 : E.substring(0, d.length)) === d
                  ? f.push({
                        type: el.h8.USER,
                        record: r,
                  ...
                  : g < ek &&
                    (a()(u, i) || a()(d, l) || (null != c && a()(u, c)) || (null != _ && a()(d, _)) || (null != m && a()(u, m)) || (null != E && a()(d, E))) &&
                    (p.push({
                        type: el.h8.USER,
                        record: r,
                        score: eZ(eI, null == s ? void 0 : s[r.id]),
...
let e5 = (0, J.oH)((e, t, n) => {
    ...
    e6 = {
        ...
        queryChannels(e) {
            let t,
                { query: n, guildId: r, limit: i = es.rnv, fuzzy: a = !0, filter: o = eM, type: l = G.sH, allowEmptyQueries: c = !1, requireVocalConnectAccess: u = !0, boosters: d = {}, allowSnowflake: p, includeAllThreads: h } = e,
                m = e0(n, c),
                g = eQ(l);
            t =
                null != r
        ...
        queryDMChannels(e) {
            let { query: t, limit: n = 10, boosters: r = {} } = e,
                { channelsByRecipientId: i, recipientsById: a, recipients: o } = e5(M.Z.getPrivateChannelsVersion(), W.Z.getVersion(), q.default.getUserStoreVersion()),
                s = eq({
                    query: t,
                    members: o,
                    limit: o.length,
        ...
        queryMentionResults(e) {
            let { query: t, channel: n, canMentionEveryone: r = !1, canMentionHere: i = !0, canMentionUsers: o = !0, canMentionRoles: c = !0, includeAllGuildUsers: u = !1, includeNonMentionableRoles: d = !1, checkRecentlyTalkedOnEmptyQuery: _ = !0, limit: f = es.rnv, request: p, allowSnowflake: h = !1 } = e,
                m = o
                    ? (u && null != n.guild_id
            ...
            if (g < f && c) {
                ...
                if (null != i) {
                    let n = s()(V.Z.getSortedRoles(i.id))
                        ...
                        .value();
                    ((y = (0, l.Lu)(n, t, { keys: ['name'] }).slice(0, f - g)), (g += y.length));
                }
            }
            let O = [];
            return (
                !n.isPrivate() && r && c && (g < f && a()(b, eG().test) && (O.push(eG()), (g += 1)), i && g < f && a()(b, eB().test) && (O.push(eB()), (g += 1))),
        ...
        queryGuildMentionResults(e) {
            let { query: t, guildId: n, canMentionEveryone: r = !1, canMentionUsers: i = !0, canMentionRoles: o = !0, canMentionNonMentionableRoles: l = !1 } = e,
                c = i
                    ? this.queryGuildUsers({
                          guildId: n,
                          query: t
                      }).map((e) => eh(ef({}, e), { status: Y.Z.getStatus(e.record.id) }))
                    : [],
                u = c.length,
                d = t.toLowerCase(),
                _ = [];
            ...
            let f = [];
            return (
                r && o && (u < es.rnv && a()(d, eG().test) && (f.push(eG()), (u += 1)), u < es.rnv && a()(d, eB().test) && f.push(eB())),
                {
                    users: c,
                    globals: f,
                    roles: _
        ...
        queryStaticRouteChannels(e) {
            let { query: t, guild: n } = e,
                ...
                a = (0, y.s)(n.id) && !n.features.has(es.oNc.HUB),
        ...
        hasSameRoleAsUsername(e, t) {
            ...
            for (let { name: e } of null != n ? V.Z.getSortedRoles(n.id) : []) if (t.username.startsWith(e.toLowerCase())) return !0;
            return !1;
        }
    };
