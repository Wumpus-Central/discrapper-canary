...
function ei(e) {
    ...
    let p = $(
        ...
        h = (0, u.e7)([y.Z], () => y.Z.getMessageByReference(l)),
        ...
        C = (0, x.Z)(g),
        v = (0, Z.k)(i);
    return i.type === X.uaV.THREAD_STARTER_MESSAGE && null != h && h.state === y.Y.LOADED
        ? (0, r.jsx)(
              el,
              et(ee({}, e), {
...
function el(e) {
    ...
    let {
        ...
        { popouts: F, selected: H, setPopout: W } = (0, D.Z)(o.id, K.d$),
        $ = j.RS.useSetting(),
        er = j.NA.useSetting(),
