...
function G(e) {
    ...
    let G,
        ...
        en = (0, i.e7)([D.Z], () => null != B && null != B.application_id && D.Z.getState(B.application_id, M.mFx.JOIN) === M.OcF.LOADING),
        er = (0, b.q)(q),
        ei = (0, y.A)(er),
        ea = (0, p.s5)({
            userId: F.id,
        ...
        el = (0, l.O)();
    if (X && null == V && (null == B || !(0, h.Z)(B, M.xjy.CONTEXTLESS))) return null;
