...
function G(e) {
    ...
    let G,
        ...
        en = (0, o.e7)([D.Z], () => null != B && null != B.application_id && D.Z.getState(B.application_id, k.mFx.JOIN) === k.OcF.LOADING),
        er = (0, y.q)(q),
        ...
        ea = (0, o.e7)([O.Z, T.Z, S.Z, C.Z, R.Z, w.Z, A.Z], () =>
            null == F || ei
                ? (0, f.Z)({
                      user: V,
                      activity: B,
    ...
    let ef = null != (n = null == F ? void 0 : F.launchId) ? n : null == B ? void 0 : B.session_id,
        ...
        eh = ea ? U.NW.string(U.t.VJlc0d) : U.NW.string(U.t.OKsSCQ);
    return (
