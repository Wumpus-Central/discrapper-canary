...
let p = /\\([*?+/])/g,
    h = {
        ...
        nick: {
            action(e, t) {
                let { channel: n } = t;
                if (null != n.guild_id) return (a.Z.changeNickname(n.guild_id, n.id, _.ME, e), { content: '' });
            }
        },
        reaction: {
            ...
            action(e, t) {
                ...
                if (null != a) return ((0, c.rU)(r.id, i.id, (0, u.g1)(a)), { content: '' });
            }
        },
        searchReplace: {
            ...
            action(e, t) {
                ...
                return ((null == h || '' === h.trim()) && 0 === s.attachments.length ? o.Z.deleteMessage(a.id, s.id) : h !== s.content && o.Z.editMessage(a.id, s.id, { content: h }), { content: '' });
            }
        },
