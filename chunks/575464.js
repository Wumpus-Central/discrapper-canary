...
function m(e) {
    var t, n;
    let { user: i, row: m, hideDiscriminator: g, comparator: b, selected: y, checked: _, onClick: C, onMouseEnter: x, 'aria-setsize': v, 'aria-posinset': j } = e,
        ...
        (n = n =
            {
                ...
                children: (0, r.jsxs)(d.Z, {
                    ...
                    className: l()(f.friend, { [f.friendSelected]: y }),
                    children: [
                        (0, r.jsx)(u.Z, {
                            user: i,
                            status: O,
