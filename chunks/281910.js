    ...
    return (0, i.jsxs)("div", {
        ...
        children: [
            (0, i.jsxs)("div", {
                className: V.$R,
                children: [
                    (0, i.jsx)(I.Ay, { className: V.$f, guild: a, size: I.Ay.Sizes.LARGER, iconSize: 70, active: !0 }),
                    (0, i.jsxs)("div", {
                        className: V.CR,
                        children: [
                            (0, i.jsx)(E.D, { className: V.J5, variant: "heading-lg/semibold", children: a.name }),
                            (0, i.jsxs)("div", {
                                className: V.SJ,
                                children: [
                                    (0, i.jsx)(_._, {
                                        color:
                                            w > 0 ? j.A.unsafe_rawColors.GUILD_BOOSTING_PINK_REFRESH : "currentColor",
                                        className: A()(V.Me, { [V.S3]: w > 0 }),
                                    }),
                                    (0, i.jsx)(N.E, {
                                        className: V.n,
                                        variant: "text-md/semibold",
                                        children: G.intl.format(G.t["pob/cL"], { subscriptions: w }),
                                    }),
                                ],
                            }),
                            p > 0
                                ? (0, i.jsx)(N.E, {
                                      ...
                                      children: G.intl.format(G.t.Jeto2u, { numSubscriptions: p }),
                                  })
                                : null,
                        ],
                    }),
            ...
            (0, i.jsxs)("div", {
                className: V.mY,
                children: [
                    (0, i.jsx)("h1", { className: V.R_, children: G.intl.string(G.t.N4sqzL) }),
                    ...
                    (0, i.jsxs)("div", {
                        ...
                        children: [
                            ...
                            L.Ay.hasFreeBoosts(u) || L.Ay.isPremium(u, P.PremiumTypes.TIER_2)
                                ? (0, i.jsx)(T.$, {
                                      variant: "secondary",
                                      size: "md",
                                      icon: v.o,
...
function J(e) {
    ...
    return (0, i.jsxs)("div", {
        className: $.MY,
        children: [
            (0, i.jsx)("div", { className: A()($.hr, { [$.ti]: n, [$.YO]: !n, [$.JQ]: l, [$.Uz]: s }) }),
            (0, i.jsx)("div", {
                className: A()($.Zj, {
                    [$.jv]: n,
                    [$.ip]: t === k.TVA.TIER_1,
...
function e_(e) {
    let {
        ...
        p = n !== ep.b_.INACTIVE,
        v = (0, ed.A)(t),
        I = (0, s.bG)([ea.Ay], () => ea.Ay.useReducedMotion),
        C = l.useRef(null),
        [S, b] = l.useState(!1),
        [y, R] = l.useState(!1),
        [L, P] = l.useState(!1),
        ...
        D = l.useCallback(() => {
            f(), (0, eh.A)(t, eo.A.GUILD_POWERUPS_MARKETING, h.skuId);
        }, [t, h.skuId, f]),
        U = { tension: 400, friction: 30 },
        M = (0, ei.z)({ scale: V ? 0.85 : 1, y: V ? -32 : 0, config: U }),
        B = (0, ei.z)({ scale: V ? 0.7 : 1, y: V ? -35 : 0, config: U }),
        F = (0, ei.z)({ y: V ? -32 : 0, config: U }),
        W = (0, ei.z)({ opacity: +!!V, transform: V ? "translateY(0)" : "translateY(16px)", config: U }),
        z = l.useCallback((e) => {
            e && b(!0);
        }, []),
        Q = l.useCallback(() => {
                                ...
                                children: [
                                    ...
                                    (0, i.jsx)(N.E, {
                                        ...
                                        children: G.intl.formatToPlainString(
                                            null != c ? eA.default["G/aTXi"] : eA.default.r9pa9K,
                                            { boostCount: o },
                                        ),
                                    }),
                                ],
                          ...
                          children: [
                              ...
                              (0, i.jsx)(N.E, {
                                  ...
                                  children: G.intl.format(Y.default.S562fn, {
                                      helpDeskArticle: ef.A.getArticleURL(k.MVz.GUILD_BOOSTING_FAQ),
                                  }),
                              }),
                          ],
                      }),
            ...
            children: (0, i.jsxs)(eC.xp, {
                ...
                children: [
                    (0, i.jsxs)("div", {
                        className: eb.OA,
                        children: [
                            (0, i.jsx)(I.Ay, { className: eb.$f, guild: n, size: I.Ay.Sizes.SMALL }),
...
function eG(e) {
    let { analyticsLocation: t, guild: n, onClose: p, scrollToPowerupCards: A } = e,
        [E, _] = l.useState(!0),
        j = l.useRef(!1),
        ...
        S = l.useCallback(() => {
            null != I.current &&
                null != v.current &&
                v.current.scrollIntoViewNode({ node: I.current, animate: !0, shouldScrollToStart: !0 });
        }, []),
        b = l.useCallback(
            (e) => {
                e &&
                    !j.current &&
                    (f.default.track(k.HAw.PREMIUM_MARKETING_SURFACE_REACHED_BOTTOM, {
    ...
    l.useEffect(() => {
        f.default.track(k.HAw.OPEN_MODAL, {
            type: k.liQ.PREMIUM_GUILD_USER_MODAL,
            location_stack: N,
            location_section: t.section,
            location_object: t.object,
    ...
    let L = (0, s.bG)([g.A], () => g.A.hasFetchedPowerupCatalog(n.id));
    return (
        l.useEffect(() => {
            if (A && L) {
                let e = setTimeout(() => {
            ...
            children: [
                ...
                (0, i.jsxs)(c.Gt, {
                    ...
                    children: [
                        ...
                        (0, i.jsx)("div", {
                            className: W.uE,
                            children: (0, i.jsx)(eT, { ref: I, guild: e.guild, onClose: C }),
                        }),
                        (0, i.jsx)("div", {
                            className: W.o6,
                            children: (0, i.jsxs)("div", {
                                className: W.y$,
                                children: [
                                    (0, i.jsx)(ev.A, { className: W.Q, guild: n }),
                                    (0, i.jsx)(x.A, {}),
                                    (0, i.jsx)(D.A, {}),
                                ],
                            }),
