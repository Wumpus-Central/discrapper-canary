                    ...
                    (0, i.jsxs)("div", {
                        ...
                        children: [
                            ...
                            (0, i.jsx)(N.E, {
                                className: $.wx,
                                variant: "text-md/medium",
                                children: G.intl.string(X.default.nIj3LZ),
                            }),
                        ],
                    }),
                ],
...
function ee(e) {
    ...
    return (0, i.jsx)("div", {
        className: p()($.iE, n),
        children: Y.t.map((e) => (0, i.jsx)(Z, { guild: t, definition: e }, e.tier)),
    });
}
var et = n(785651),
    en = n(172218),
...
function e_(e) {
    let {
        ...
        M = (0, ei.z)({ scale: D ? 0.85 : 1, y: D ? -32 : 0, config: w }),
        B = (0, ei.z)({ scale: D ? 0.7 : 1, y: D ? -35 : 0, config: w }),
        F = (0, ei.z)({ y: D ? -32 : 0, config: w }),
        W = (0, ei.z)({ opacity: +!!D, transform: D ? "translateY(0)" : "translateY(16px)", config: w }),
        z = l.useCallback((e) => {
            e && b(!0);
        }, []),
        Q = l.useCallback(() => {
                      ...
                      (0, i.jsxs)("div", {
                          ...
                          children: [
                              (0, i.jsx)(E.D, {
                                  ...
                                  children: G.intl.string(X.default.wjI18Q),
                              }),
                              (0, i.jsx)(N.E, {
                                  className: eE.fV,
                                  variant: "text-md/medium",
                                  children: G.intl.format(X.default.S562fn, {
...
function eP(e) {
    ...
    return (0, i.jsxs)(a.D, {
        className: eO.kL,
        onClick: c,
        "aria-label": G.intl.string(X.default["103aY+"]),
        children: [
...
function eG(e) {
    ...
    let R = (0, m.C$)(n.id, "GuildBoostingMarketingRefresh"),
        y = (0, s.bG)([h.A], () => h.A.shouldFetchCatalogForGuild(n.id));
    l.useEffect(() => {
        R && y && (0, u.z9)(n.id);
    }, [n.id, R, y]);
    ...
    return (
        ...
        (0, i.jsxs)(i.Fragment, {
            children: [
                ...
                (0, i.jsx)(eR, { guild: n, isVisible: !E, closeLayer: C }),
            ],
        })
    );
}
