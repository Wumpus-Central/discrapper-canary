...
function te(e, t, n) {
    if (null == e) return;
    let i = e3[e];
    (null == i || t || d.w.set(i, !0), e6.has(e) && (e4[e] = !0), null != n && null != i)
...
function ti(e) {
    ...
    let a = e4[e];
    return !!a || (null != i && "" !== i ? d.w.get(i) : !!e6.has(e) && a);
}
let tr = [
    eI.kqX.QUARANTINED,
...
function tl() {
    return ew.A.enabled || delete e4[eI.kqX.STREAMER_MODE], ts();
}
...
let td = new to(c.h, {
    ...
    DISPATCH_APPLICATION_ERROR: function () {
        return delete e4[eI.kqX.DISPATCH_ERROR], ts();
    },
    DISPATCH_APPLICATION_LAUNCH_SETUP_START: function () {
        return delete e4[eI.kqX.DISPATCH_INSTALL_SCRIPT_PROGRESS], ts();
    },
