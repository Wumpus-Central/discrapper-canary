...
function eC() {
    ...
    for (let { skuId: t, applicationId: n } of ec().values(eS)) {
        ...
        eT.A.isEntitledToSku(q.default.getCurrentUser(), t, i.id, i.id) ||
        !l.available
...
class eD extends s.Ay.Store {
    ...
    initialize() {
        this.waitFor(d.A, eT.A, P.Ay, ed.A, q.default), (eO = o.w.get(eN) ?? eO);
    }
...
function te(e, t, n) {
    if (null == e) return;
    let i = e5[e];
    (null == i || t || o.w.set(i, !0), e7.has(e) && (e6[e] = !0), null != n && null != i)
...
eI.kqX.QUARANTINED,
    ...
    eI.kqX.SCHEDULED_MAINTENANCE;
let tr = {
    [eI.kqX.GIFTING_PROMOTION_REMINDER]: { predicate: () => (0, F.MD)() },
    [eI.kqX.GUILD_RAID_NOTIFICATION]: {
        predicate: () => (0, p.dj)().show && !ti(eI.kqX.GUILD_RAID_NOTIFICATION),
    ...
    [eI.kqX.VOICE_DISABLED]: { predicate: () => null != ek.A.getRemoteDisconnectVoiceChannelId() },
    [eI.kqX.VOICE_CONNECTED_LAST_SESSION]: { predicate: () => null != ek.A.getLastSessionVoiceChannelId() },
    ...
    [eI.kqX.VIDEO_BACKGROUND_UNAVAILABLE]: { predicate: () => ek.A.isConnected() && et.A.videoBackgroundUnavailable },
    [eI.kqX.HARDWARE_MUTE]: {
        predicate: () =>
            ek.A.isConnected() &&
    ...
    [eI.kqX.PENDING_MEMBER]: {
        predicate: (e) => {
            ...
            return (
                (null != t &&
                    null != n &&
                    !ep.A.getGuild(t)?.features.has(eI.GuildFeatures.GUILD_ONBOARDING) &&
                    eM.Ay.getMember(t, n.id)?.isPending) ??
                !1
            );
        },
    },
    [eI.kqX.OUTBOUND_PROMOTION]: { predicate: () => (0, H.So)() },
    [eI.kqX.CORRUPT_INSTALLATION]: {
        predicate: () => eV.isPlatformEmbedded && (!a.A.supported() || eY.A.isCorruptInstallation()),
    },
    [eI.kqX.VIDEO_UNSUPPORTED_BROWSER]: {
        predicate: (e) => {
            let { voiceChannelId: t } = e;
            return (
                null != t && ev.A.hasVideo(t) && !ef.Ay.supports(eZ.O5.VIDEO) && !ti(eI.kqX.VIDEO_UNSUPPORTED_BROWSER)
            );
        },
    },
    [eI.kqX.DETECTED_OFF_PLATFORM_PREMIUM_PERK]: {
        predicate: (e) => {
            let { currentUser: t } = e;
            return v.Ay.canRedeemPremiumPerks(t) && eP.getDetectedOffPlatformPremiumPerks().length > 0;
        },
        metadata: () => eP.getDetectedOffPlatformPremiumPerks()[0],
    },
    [eI.kqX.DETECTED_OFF_PLATFORM_PREMIUM_PERK_UPSELL]: {
        predicate: () =>
            !ti(eI.kqX.DETECTED_OFF_PLATFORM_PREMIUM_PERK_UPSELL) && eP.getDetectedOffPlatformPremiumPerks().length > 0,
        metadata: () => eP.getDetectedOffPlatformPremiumPerks()[0],
    },
    [eI.kqX.STREAMER_MODE]: { predicate: () => eG.A.enabled },
    [eI.kqX.DOWNLOAD_NAG]: { predicate: () => !eV.isPlatformEmbedded && !ti(eI.kqX.DOWNLOAD_NAG) },
    [eI.kqX.QUEST_APP_UPSELL]: { predicate: () => (0, eV.isOculusWeb)() && !ti(eI.kqX.QUEST_APP_UPSELL) },
    [eI.kqX.SCHEDULED_MAINTENANCE]: {
    ...
    [eI.kqX.SURVEY]: { predicate: () => null != ej.Ay.getCurrentSurvey(), metadata: () => ej.Ay.getCurrentSurvey() },
    [eI.kqX.UNVERIFIED_ACCOUNT]: {
        predicate: (e) => {
            let { currentUser: t } = e;
    ...
    [eI.kqX.CONNECT_SPOTIFY]: {
        predicate: () =>
            ...
            P.Ay.isObservedAppRunning(u.A.get(eI.fg2.SPOTIFY).name) &&
        ...
        predicate: (e) => {
            let { premiumSubscription: t, currentUser: n } = e,
                ...
                a =
                    ...
                    i <= 7 &&
                    i >= 0 &&
                    (0, v.YE)(n, eW.PremiumTypes.TIER_2) &&
                    !r &&
                    !n.hasFreePremium() &&
        ...
        predicate: (e) => {
            let { premiumSubscription: t, currentUser: n } = e,
                ...
                u =
                    ...
                    !n.hasFreePremium() &&
                    !t.isPurchasedExternally;
            return !ti(eI.kqX.PREMIUM_MISSING_PAYMENT) && u;
        },
        metadata: (e) => {
            let { premiumSubscription: t } = e,
                n = null != t ? l()(t.currentPeriodEnd).diff(l()().startOf("day"), "days") : 0,
    ...
    [eI.kqX.PREMIUM_GROUP_PRIMARY_REMINDER_NAGBAR]: {
        predicate: (e) => {
            ...
            let i = V.A.hasFetchedMembers(),
                l = V.A.getNumAvailableInvites();
            return (0, w.ux)(t, n) && i && l >= e$.Vu;
        },
        metadata: () => ({ premiumSubscription: eb.A.getPremiumGroupSubscription() }),
    },
    [eI.kqX.BLOCK_USER_FEEDBACK_NAGBAR]: {
        predicate: () => !ti(eI.kqX.BLOCK_USER_FEEDBACK_NAGBAR) && $.Cm(),
        metadata: () => ({ dismissUntil: l()().add(180, "days").toDate(), sampleRate: 0.1 }),
    },
    [eI.kqX.IGNORE_USER_FEEDBACK_NAGBAR]: { predicate: () => $.h6(), metadata: () => ({ sampleRate: 0.1 }) },
    [eI.kqX.SYSTEM_SERVICE_WARNING]: {
        predicate: (e) => {
            let { voiceChannelId: t } = e;
            if (
    ...
    [eI.kqX.E2EE_UPDATE_REQUIRED]: {
        predicate: () => {
            if (ti(eI.kqX.E2EE_UPDATE_REQUIRED) || !ek.A.isConnected()) return !1;
    ...
    [eI.kqX.RIOT_MIGRATION]: {
        predicate: () => {
            ...
            if (ti(eI.kqX.RIOT_MIGRATION) || (0, N.k8)(E.M.RIOT_CONNECTION_DEPRECATION_DISABLE) || (!e && !t))
                return !1;
            let n = u.A.get(eI.fg2.LEAGUE_OF_LEGENDS),
                i = u.A.get(eI.fg2.RIOT_GAMES);
    ...
    [eI.kqX.BATTLENET_MIGRATION]: {
        predicate: () => {
            let e = u.A.get(eI.fg2.BATTLENET);
            return !(
...
function ta() {
    return eG.A.enabled || delete e6[eI.kqX.STREAMER_MODE], ts();
}
class tE extends s.Ay.Store {
    static displayName = "NoticeStore";
    initialize() {
        this.syncWith(
            [C.A, ej.Ay, eh.A, eP, eL.A, K.A, eB.A, y.default, eE.A, ee.A, f.A, W.A, el.A, P.Ay, ei.A, C.A, I.A, L.A],
            ts,
        ),
            this.waitFor(
                C.A,
    ...
    getNotice() {
        return null == eq.A.getAction() ? e8 : null;
    }
    isNoticeDismissed(e) {
        return ti(e);
    }
...
let to = new tE(c.h, {
    ...
    DISPATCH_APPLICATION_ERROR: function () {
        return delete e6[eI.kqX.DISPATCH_ERROR], ts();
    },
    DISPATCH_APPLICATION_LAUNCH_SETUP_START: function () {
        return delete e6[eI.kqX.DISPATCH_INSTALL_SCRIPT_PROGRESS], ts();
    },
