...
class eD extends s.Ay.Store {
    ...
    initialize() {
        this.waitFor(d.A, eT.A, m.Ay, ed.A, v.default), (eO = o.w.get(eN) ?? eO);
    }
...
function te(e, t, n) {
    if (null == e) return;
    let i = e5[e];
    (null == i || t || o.w.set(i, !0), e3.has(e) && (e6[e] = !0), null != n && null != i)
...
function ts() {
    ...
    for (let r of tl)
        if (
            ...
            e4 = { ...e7, type: r, metadata: i };
            break;
        }
    if (null != e4) {
        e4.metadata?.sampleRate != null &&
            null == e9[e4.type] &&
            (e9[e4.type] = Math.random() <= e4.metadata.sampleRate);
        let e = !1 === e9[e4.type];
        (ti(e4.type) || e) && (e4 = null);
    }
}
function ta() {
...
class tE extends s.Ay.Store {
    ...
    initialize() {
        this.syncWith(
            [C.A, ej.Ay, eU.A, em, ek.A, K.A, eB.A, L.default, eE.A, ee.A, f.A, W.A, el.A, m.Ay, ei.A, C.A, I.A, k.A],
            ts,
        ),
            this.waitFor(
                C.A,
    ...
    getNotice() {
        return null == ev.A.getAction() ? e4 : null;
    }
    isNoticeDismissed(e) {
        return ti(e);
    }
...
let to = new tE(c.h, {
    ...
    VOICE_STATE_UPDATES: function (e) {
        let { voiceStates: t } = e;
        return (
            (e4?.type === eI.kqX.INVITED_TO_SPEAK ||
                t.some((e) => {
                    let { userId: t } = e;
    ...
    NOTICE_DISMISS: function (e) {
        return null != e4 && (null == e.id || e.id === e4.id) && (te(e4.type, e.isTemporary, e.untilAtLeast), ts());
    },
