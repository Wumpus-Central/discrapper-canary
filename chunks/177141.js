...
function e4(e, t, n) {
    if (null == e) return;
    let i = e2[e];
    (null == i || t || o.w.set(i, !0), e5.has(e) && (e3[e] = !0), null != n && null != i)
...
function ts() {
    return eL.A.enabled || delete e3[eT.kqX.STREAMER_MODE], tr();
}
...
let tE = new ta(c.h, {
    ...
    DISPATCH_APPLICATION_ERROR: function () {
        return delete e3[eT.kqX.DISPATCH_ERROR], tr();
    },
    DISPATCH_APPLICATION_LAUNCH_SETUP_START: function () {
        return delete e3[eT.kqX.DISPATCH_INSTALL_SCRIPT_PROGRESS], tr();
    },
