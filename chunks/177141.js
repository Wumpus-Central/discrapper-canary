n.d(t, { f7: () => e7, Re: () => e5, Ay: () => tu, pe: () => e1, rV: () => e2 });
var i = n(989349),
    l = n.n(i),
    r = n(877624),
    s = n(17928),
...
function eD() {
    ...
    for (let { skuId: t, applicationId: n } of eu().values(eO)) {
        ...
        if (null == i) {
            T.A.isFetchingApplication(n) || T.A.didFetchingApplicationFail(n) || ed.Ay.fetchApplication(n);
            continue;
        }
        let l = eI.A.get(t);
        if (null == l) {
...
class eP extends s.Ay.Store {
    ...
    initialize() {
        this.waitFor(T.A, eT.A, P.Ay, eI.A, j.default), (eC = E.w.get(eR) ?? eC);
    }
...
let e1 = {
    ...
    e7 = { [eN.kqX.OUTBOUND_PROMOTION]: o.M.THIRD_PARTY_OUTBOUND_PROMO_NAGBAR },
    e6 = {
...
function tn(e, t, n) {
    if (null == e) return;
    let i = e6[e];
    (null == i || t || E.w.set(i, !0), e3.has(e) && (e4[e] = !0), null != n && null != i)
...
function tr(e) {
    ...
    let r = e4[e];
    return !!r || (null != i && "" !== i ? E.w.get(i) : !!e3.has(e) && r);
}
let ts = [
    eN.kqX.QUARANTINED,
...
let ta = {
    ...
    [eN.kqX.HARDWARE_MUTE]: {
        predicate: () =>
            ey.A.isConnected() &&
            eU.Ay.isHardwareMute() &&
            eU.Ay.isHardwareMuteNoticeEnabled() &&
            !J.Ay.disableHardwareMuteSilenceAlert,
        metadata: () => {
            let e = eU.Ay.getInputDeviceId(),
                t = ea.A.getVendor(e),
                n = ea.A.getModel(e);
    ...
    [eN.kqX.PTT_NO_KEYBIND_WARNING]: {
        predicate: () =>
            !!ey.A.isConnected() &&
            eU.Ay.getMode() === eN.TBI.PUSH_TO_TALK &&
            !(eU.Ay.getSettings().modeOptions.shortcut.length > 0) &&
    ...
    [eN.kqX.VIDEO_UNSUPPORTED_BROWSER]: {
        predicate: (e) => {
            ...
            return (
                null != t && eX.A.hasVideo(t) && !eU.Ay.supports(e0.O5.VIDEO) && !tr(eN.kqX.VIDEO_UNSUPPORTED_BROWSER)
            );
        },
    },
    [eN.kqX.DETECTED_OFF_PLATFORM_PREMIUM_PERK]: {
    ...
    [eN.kqX.WINDOWS_MEDIA_PACK_REQUIRED]: {
        predicate: () =>
            ...
            ) && !1 === eU.Ay.isH264MfDecodeAvailable(),
    },
    [eN.kqX.RIOT_MIGRATION]: {
        predicate: () => {
    ...
    [eN.kqX.RIOT_CONNECTION_DEPRECATION_ADMIN]: {
        predicate: (e) => {
            ...
            return null != i && !!l && null != r && !!(0, d.D)(r);
        },
    },
};
function to() {
    ...
    for (let r of ts)
        if (
            ...
            te = { ...e8, type: r, metadata: i };
            break;
        }
    if (null != te) {
        te.metadata?.sampleRate != null &&
            null == e9[te.type] &&
            (e9[te.type] = Math.random() <= te.metadata.sampleRate);
        let e = !1 === e9[te.type];
        (tr(te.type) || e) && (te = null);
    }
}
function tE() {
    return ej.A.enabled || delete e4[eN.kqX.STREAMER_MODE], to();
}
...
let tu = new tc(c.h, {
    ...
    DISPATCH_APPLICATION_ERROR: function () {
        return delete e4[eN.kqX.DISPATCH_ERROR], to();
    },
    DISPATCH_APPLICATION_LAUNCH_SETUP_START: function () {
        return delete e4[eN.kqX.DISPATCH_INSTALL_SCRIPT_PROGRESS], to();
    },
