...
function ts() {
    ...
    if (null != e6) {
        e6.metadata?.sampleRate != null &&
            null == e9[e6.type] &&
            (e9[e6.type] = Math.random() <= e6.metadata.sampleRate);
        let e = !1 === e9[e6.type];
        (ti(e6.type) || e) && (e6 = null);
    }
}
function ta() {
...
class tE extends s.Ay.Store {
    ...
    getNotice() {
        return null == ej.A.getAction() ? e6 : null;
    }
    isNoticeDismissed(e) {
        return ti(e);
    }
...
let to = new tE(c.h, {
    ...
    VOICE_STATE_UPDATES: function (e) {
        let { voiceStates: t } = e;
        return (
            (e6?.type === eI.kqX.INVITED_TO_SPEAK ||
                t.some((e) => {
                    let { userId: t } = e;
    ...
    NOTICE_DISMISS: function (e) {
        return null != e6 && (null == e.id || e.id === e6.id) && (te(e6.type, e.isTemporary, e.untilAtLeast), ts());
    },
