...
function tr() {
    ...
    for (let r of ti)
        if (
            ...
            e9 = { ...e8, type: r, metadata: i };
            break;
        }
    if (null != e9) {
        e9.metadata?.sampleRate != null &&
            null == e5[e9.type] &&
            (e5[e9.type] = Math.random() <= e9.metadata.sampleRate);
        let e = !1 === e5[e9.type];
        (tn(e9.type) || e) && (e9 = null);
    }
}
function ts() {
...
let tc = new ta(d.h, {
    ...
    VOICE_STATE_UPDATES: function (e) {
        let { voiceStates: t } = e;
        return (
            (e9?.type === e_.kqX.INVITED_TO_SPEAK ||
                t.some((e) => {
                    let { userId: t } = e;
    ...
    NOTICE_DISMISS: function (e) {
        return null != e9 && (null == e.id || e.id === e9.id) && (e4(e9.type, e.isTemporary, e.untilAtLeast), tr());
    },
