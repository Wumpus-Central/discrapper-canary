...
function tn(e, t, n) {
    if (null == e) return;
    let i = e4[e];
    (null == i || t || d.w.set(i, !0), e7.has(e) && (e5[e] = !0), null != n && null != i)
...
function ta(e) {
    ...
    let a = e5[e];
    return !!a || (null != i && "" !== i ? d.w.get(i) : !!e7.has(e) && a);
}
let ts = [
    ef.kqX.QUARANTINED,
...
let tl = {
    ...
    [ef.kqX.GUILD_RAID_NOTIFICATION]: {
        predicate: () => (0, R.dj)().show && !ta(ef.kqX.GUILD_RAID_NOTIFICATION),
    ...
    [ef.kqX.RIOT_CONNECTION_DEPRECATION_ADMIN]: {
        predicate: (e) => {
            ...
            let i = null != n ? eL.A.getGuild(n) : null,
                ...
                a = null != i ? eR.A.getSortedRoles(i.id).filter((e) => null === e.tags.guild_connections) : null;
...
function td() {
    return eG.A.enabled || delete e5[ef.kqX.STREAMER_MODE], to();
}
...
let tu = new tc(c.h, {
    ...
    DISPATCH_APPLICATION_ERROR: function () {
        return delete e5[ef.kqX.DISPATCH_ERROR], to();
    },
    DISPATCH_APPLICATION_LAUNCH_SETUP_START: function () {
        return delete e5[ef.kqX.DISPATCH_INSTALL_SCRIPT_PROGRESS], to();
    },
