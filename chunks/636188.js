...
function U(e) {
    let { option: n, source: s, selected: o = !1, onSelectOption: u, isAnimatedImage: j, isVideo: h, hotspotLocation: N, ...f } = e,
        b = (0, d.O)(),
    ...
    return (0, l.jsxs)(r.Clickable, {
        ...f,
        className: i()(E.backgroundOption, { [E.backgroundOptionSelected]: o }),
        onClick: () => u(n),
        onContextMenu: (e) =>
            (0, c.jW)(e, async () => {
...
function D(e) {
    let { onClick: n, tooltipText: t, disabled: s = !1 } = e,
        o = (0, a.e7)([O.Z], () => O.Z.hasHotspot(b.v.ANIMATED_VIDEO_BG_CUSTOM_TOOLTIP_NEW));
    function i() {
    ...
    return (0, l.jsxs)(r.TooltipContainer, {
        ...
        children: [
            (0, l.jsxs)(B, {
                ...
                children: [(0, l.jsx)('div', { className: E.backgroundCustomInlineUpsellBackground }), (0, l.jsx)('div', { className: E.backgroundCustomInlineUpsellBackgroundDarkener })]
            }),
            o &&
                (0, l.jsx)(r.TextBadge, {
                    text: C.intl.string(C.t.y2b7CA),
...
function Z(e) {
    let { onAddBackgroundImage: n, disabled: s } = e,
        ...
        i = s ? C.intl.formatToPlainString(C.t.ykGFeH, { maxCustomBackgrounds: 25 }) : C.intl.string(C.t.Qx0tFR),
        a = [
            {
...
function A(e) {
    let { canUseCustomBackgrounds: n, customBackgroundOptions: t, selectedOption: o, onSelectOption: i, onUpsellClick: a, onAddBackgroundImage: c, smallerOptions: d } = e,
        u = s.useMemo(() => t.sort((e, n) => (null == e.last_used || null == n.last_used ? h.default.compare(n.id, e.id) : new Date(n.last_used).getTime() - new Date(e.last_used).getTime())), [t]),
        p = u.length >= 25,
        ...
        children: (0, l.jsxs)('div', {
            ...
            children: [
                ...
                (0, l.jsx)(B, {
                    ...
                    children: (0, l.jsx)('div', { className: E.backgroundOptionBlurBackground })
                }),
                n
                    ? (0, l.jsx)(Z, {
