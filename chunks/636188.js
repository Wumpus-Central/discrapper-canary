...
function P(e) {
    let { icon: t, onClick: n, text: i, children: s, className: o, selected: c = !1, disabled: d = !1, onMouseLeave: u, onBlur: m } = e;
...
function D(e) {
    var { option: t, source: i, selected: s = !1, onSelectOption: u, isAnimatedImage: b, isVideo: x, hotspotLocation: E } = e,
        j = (function (e, t) {
            if (null == e) return {};
            var n,
                r,
...
function w(e) {
    let { onClick: t, tooltipText: n, disabled: i = !1 } = e,
        s = (0, o.e7)([f.Z], () => f.Z.hasHotspot(O.v.ANIMATED_VIDEO_BG_CUSTOM_TOOLTIP_NEW));
    function a() {
...
function W(e) {
    ...
    return (0, r.jsx)(w, {
        ...
        onClick: function () {
            (0, l.ZDy)(
                async () => {
                    let { default: e } = await Promise.all([n.e('91689'), n.e('55849'), n.e('61707')]).then(n.bind(n, 192277));
                    return (n) =>
                        (0, r.jsx)(
                            e,
                            y(
...
function L(e) {
    let { canUseCustomBackgrounds: t, customBackgroundOptions: n, selectedOption: s, onSelectOption: a, onUpsellClick: o, onAddBackgroundImage: c, smallerOptions: d } = e,
