                        ...
                        return function (t = {}) {
                            ...
                            a.onRuntimeInitialized = function () {
                                ...
                                (a.ptrToAsset = (e) => {
                                    ...
                                    (a.FallbackFileAssetLoader = n.extend("FallbackFileAssetLoader", {
                                        ...
                                        loadContents: function (e, t) {
                                            for (let n of this.lb) if (n.loadContents(e, t)) return !0;
                                            return !1;
                                        },
                                    }));
                                    ...
                                    function e() {
                                        if (!t) {
                                            ...
                                            if (/iPhone|iPad|iPod/i.test(navigator.userAgent)) {
                                                if (((l = e.getContext("webgl", o)), (n = 1), !l))
                                                    return (
                                    ...
                                    (this.Qb = function (n, r, s, c, p) {
                                        if (e()) {
                                            ...
                                            if (t.canvas) {
                                                ...
                                                s.sort((e, t) => t.xb - e.xb),
                                                (h = f.push(c)),
                                                o != h &&
                                                    (t.bufferData(t.ARRAY_BUFFER, 8 * h, t.DYNAMIC_DRAW), (o = h)),
                                                (h = 0),
                                                s))
                                                    t.bufferSubData(t.ARRAY_BUFFER, h, g.Ua), (h += 4 * g.Ua.length);
                                                ...
                                                s)) {
                                                    e.image.Ka != b &&
                                                        ...
                                                        (b = e.image.Ka)),
                                                        e.mc
                                                            ? (t.scissor(e.Za, m - e.$a - e.kb, e.Ac, e.kb), (E = !0))
                                                    ...
                                                    t.uniform4f(
                                                        ...
                                                        t.uniform2f(
                                                            a,
                                                            e.ha[4] * s * e.Ba + s * (e.Za - e.ic * e.Ba) - 1,
                                                            e.ha[5] * o * e.Ca + o * (e.$a - e.jc * e.Ca) + 1,
                                                        ),
                            ...
                            a.onRuntimeInitialized = function () {
                                ...
                                var b = a.RenderImage.extend("CanvasRenderImage", {
                                        ...
                                        __destruct: function () {
                                            this.Ja && (u.Mb(this.Ja), URL.revokeObjectURL(this.Xa)),
                                        ...
                                        decode: function (e) {
                                            ...
                                            t.xa && t.xa(t);
                                            var n = new Image();
                                            (t.Xa = URL.createObjectURL(new Blob([e], { type: "image/png" }))),
                                                (n.onload = function () {
                                                    (t.Fb = n),
                                                        (t.Ja = u.Lb(n)),
                                ...
                                var C = (a.CanvasRenderer = l.extend("Renderer", {
                                    ...
                                    _drawImageMesh: function (t, r, i, o, s, l, c, d, f, _, p) {
                                        ...
                                        if (
                                            ...
                                            (h = u.hc()),
                                                y > h && ((p *= h / y), (y = h)),
                                                O > h && ((r *= h / O), (O = h)),
                                                I || (I = new a.DynamicRectanizer(h)).reset(512, 512),
                                                0 > (h = I.addRect(y, O)) &&
                                    ...
                                    clear: function () {
                                        v.add(this),
                                            this.H.push(
                                                this.C.clearRect.bind(this.C, 0, 0, this.Va.width, this.Va.height),
                                            );
                                    },
                                    flush: function () {},
                                        ...
                                        return (
                                            ...
                                            (o.Z.onaudioprocess = function (n) {
                                                if (
                                                    ...
                                                    for (var s = 0; s < t; s += 1)
                                                        for (
                                                            var l = n.inputBuffer.getChannelData(s), c = o.sa, u = 0;
                                                            u < r;
                                                            u += 1
                                                        )
                                                            c[u * t + s] = l[u];
                                                ...
                                                if (e == window.h.I.ya || e == window.h.I.La)
                                                    for (nT(a, r, i), s = 0; s < n.outputBuffer.numberOfChannels; ++s)
                                                        for (
                                                            l = n.outputBuffer.getChannelData(s), c = o.sa, u = 0;
                                                            u < r;
                                                            u += 1
                                                        )
                                                            l[u] = c[u * t + s];
                            ...
                            var eh = {
                                    ...
                                    read: function (e, t, n, r) {
                                        ...
                                        for (var i = 0, a = 0; a < r; a++) {
                                            ...
                                            if (void 0 === o && 0 === i) throw new eD(6);
                                            if (null == o) break;
                                            i++, (t[n + a] = o);
                                        }
                            ...
                            var eb = {
                                        ...
                                        16384 == (61440 & (n = ek(e, t, n, r)).mode)
                                            ...
                                            : 32768 == (61440 & n.mode)
                                              ...
                                              : 40960 == (61440 & n.mode)
                                                ...
                                                : 8192 == (61440 & n.mode) &&
                                                  ((n.l = eb.O.ab.node), (n.m = eb.O.ab.stream)),
                                ...
                                m: {
                                    ...
                                    ob: (e, t, n, r) => (eb.m.write(e, t, 0, r, n, !1), 0),
                                },
                            };
                            function ey(e, t) {
                                var n = 0;
                            ...
                            var eO,
                                    ...
                                    for (var n = eS, r = "/", i = 0; i < e.length; i++) {
                                        ...
                                        if (
                                            ...
                                            for (a = 0; 40960 == (61440 & n.mode); )
                                                if (
                                                    ((n = eX(r)),
                                                    (n = ex((r = eo(en(r), n)), { Qa: t.Qa + 1 }).node),
                                                    40 < a++)
                                                )
                                                    throw new eD(32);
                                        }
                                ...
                                eL = (e) => {
                                    for (var t; ; ) {
                                        if (e === e.parent)
                                            return (
                                                (e = e.U.nb), t ? ("/" !== e[e.length - 1] ? `${e}/${t}` : e + t) : e
                                            );
                                ...
                                eZ = () => {
                                    for (var e = 0; 4096 >= e; e++) if (!eC[e]) return e;
                                    throw new eD(33);
                                },
                                eF = (e) => {
                                ...
                                eQ = (e, t, n) => {
                                    ...
                                    if (
                                        ...
                                        throw new eD(n);
                                    if (512 & t && !r) {
                                        if (!(n = "string" == typeof (n = i) ? ex(n, { gb: !0 }).node : n).l.P)
                                            throw new eD(63);
                                    ...
                                    eY(i, {
                                        ...
                                        read: (e, n, r, i) => {
                                            for (var a = 0, o = 0; o < i; o++) {
                                                ...
                                                if (void 0 === s && 0 === a) throw new eD(6);
                                                if (null == s) break;
                                                a++, (n[r + o] = s);
                                            }
                            ...
                            function tD(e, t, n = {}) {
                                ...
                                (td[e] = t),
                                    delete tN[e],
                                    tC.hasOwnProperty(e) && ((t = tC[e]), delete tC[e], t.forEach((e) => e()));
                            }
                            function tw(e, t, n = {}) {
                            ...
                            function tV(e, t, n) {
                                a.hasOwnProperty(e) || tO("Replacing nonexistant public symbol"),
                                    void 0 !== a[e].B && void 0 !== n ? (a[e].B[n] = t) : ((a[e] = t), (a[e].ea = n));
                            }
                            var tH = [],
                                tY = (e) => {
                                    var t = tH[e];
                            ...
                            function tq(e, t) {
                                function n(e) {
                                    i[e] || td[e] || (tN[e] ? tN[e].forEach(n) : (r.push(e), (i[e] = !0)));
                                }
                                var r = [],
                                    i = {};
                            ...
                            function tX(e, t, n, r, i) {
                                ...
                                return function () {
                                    ...
                                    for (var a = 0; a < c; ++a)
                                        (u[a] = t[a + 2].toWireType(f, arguments[a])), d.push(u[a]);
                            ...
                            Object.defineProperties(nh.prototype, {
                                ...
                                e6.M.push({ value: void 0 }, { value: null }, { value: !0 }, { value: !1 }),
                                (e6.h = e6.M.length),
                                (a.count_emval_handles = function () {
                                    for (var e = 0, t = e6.h; t < e6.M.length; ++t) void 0 !== e6.M[t] && ++e;
                                    return e;
                                }),
                            ...
                            (ti = nm),
                                ...
                                (tL.prototype.isAliasOf = function (e) {
                                    if (!(this instanceof tL && e instanceof tL)) return !1;
                                    var t = this.g.u.i,
                                        n = this.g.o,
                                        r = e.g.u.i;
                            ...
                            var nE = {
                                    ...
                                    (t = ta(t)),
                                        ...
                                        tR([], [e], function (e) {
                                            ...
                                            return (
                                                ...
                                                tR([], s, function (r) {
                                                    if (
                                                        ((r = tX(i, [r[0], null].concat(r.slice(1)), null, a, o)),
                                                        void 0 === l[t].B
                                                            ? ((r.ea = n - 1), (l[t] = r))
                                                            : (l[t].B[n - 1] = r),
                                                        e.i.oa)
                                    ...
                                    (i = tK(r, i)),
                                        tR([], [e], function (e) {
                                            ...
                                            return (
                                                ...
                                                tR([], o, function (r) {
                                                    return (
                                                        r.splice(1, 0, null), (e.i.$[t - 1] = tX(n, r, null, i, a)), []
                                                    );
                                                }),
                                                []
                                            );
                                    ...
                                    tw(e, {
                                        ...
                                        toWireType: function (e, r) {
                                            ...
                                            var o = a(r),
                                                l = ny(4 + o + t);
                                            return (
                                                (R[l >> 2] = o >> s), i(r, l + 4, o + t), null !== e && e.push(nb, l), l
                                            );
                                        },
                                        argPackAdvance: 8,
                                        readValueFromPointer: tA,
                                    ...
                                    return (
                                        (i = ni((t, i, o, s) => {
                                            for (var l = 0, c = 0; c < e - 1; ++c)
                                                (a[c] = n[c + 1].readValueFromPointer(s + l)),
                                                    (l += n[c + 1].argPackAdvance);
                                            for (c = 0, t = t[i].apply(t, a); c < e - 1; ++c)
                                                n[c + 1].Nb && n[c + 1].Nb(a[c]);
                                ...
                                emscripten_asm_const_int: (e, t, n) => {
                                    ...
                                    for (nl.length = 0, n >>= 2; (r = S[t++]); )
                                        (n += (105 != r) & n), nl.push(105 == r ? N[n] : D[n++ >> 1]), ++n;
                            ...
                            (a._ma_malloc_emscripten = (e, t) =>
                                (a._ma_malloc_emscripten = I.ma_malloc_emscripten)(e, t)),
                                (a._ma_free_emscripten = (e, t) =>
                                    (a._ma_free_emscripten = I.ma_free_emscripten)(e, t));
                                    ...
                                    if (!n && ((n = !0), (a.calledRun = !0), !w)) {
                                        if (
                                            (a.noFSInit ||
                                                ...
                                                (a.stdout = a.stdout),
                                                (a.stderr = a.stderr),
                                                a.stdin ? e0("stdin", a.stdin) : eq("/dev/tty", "/dev/stdin"),
                                                a.stdout ? e0("stdout", null, a.stdout) : eq("/dev/tty", "/dev/stdout"),
                                                a.stderr
                                                    ? e0("stderr", null, a.stderr)
                            ...
                            if (
                                ((a.__embind_initialize_bindings = () =>
                                    (a.__embind_initialize_bindings = I._embind_initialize_bindings)()),
                                ...
                                (a.dynCall_iiiji = (e, t, n, r, i, o) =>
                                    (a.dynCall_iiiji = I.dynCall_iiiji)(e, t, n, r, i, o)),
                                ...
                                (a.dynCall_viijii = (e, t, n, r, i, o, s) =>
                                    (a.dynCall_viijii = I.dynCall_viijii)(e, t, n, r, i, o, s)),
                                (a.dynCall_iiiiij = (e, t, n, r, i, o, s) =>
                                    (a.dynCall_iiiiij = I.dynCall_iiiiij)(e, t, n, r, i, o, s)),
                                (a.dynCall_iiiiijj = (e, t, n, r, i, o, s, l, c) =>
                                    (a.dynCall_iiiiijj = I.dynCall_iiiiijj)(e, t, n, r, i, o, s, l, c)),
                                (a.dynCall_iiiiiijj = (e, t, n, r, i, o, s, l, c, u) =>
                                    (a.dynCall_iiiiiijj = I.dynCall_iiiiiijj)(e, t, n, r, i, o, s, l, c, u)),
                                (Z = function e() {
                                    n || nA(), n || (Z = e);
                                }),
                                a.preInit)
                ...
                (e, t, n) => {
                    ...
                    var r = void 0,
                        ...
                        a = function (e) {
                                ...
                                b = function (e) {
                                    ...
                                    if (s || d) {
                                        var _ = s - r.left,
                                            h = d - r.top;
                                        if (
                                            (_ >= 0 && _ <= r.width && h >= 0 && h <= r.height) ||
                                            ["mouseleave", "mouseout"].includes(e.type)
                                        ) {
                                            var m = l.computeAlignment(
                                                    c,
                                                    u,
                                                    {
                                                        minX: 0,
                            ...
                            return (
                                y.addEventListener("mouseover", b, m),
                                y.addEventListener("mouseenter", b, m),
                                y.addEventListener("mouseout", b, m),
                                y.addEventListener("mouseleave", b, m),
                                y.addEventListener("mousemove", b, m),
                                y.addEventListener("mousedown", b, m),
                                y.addEventListener("mouseup", b, m),
                                t.addEventListener("touchmove", b, { passive: f }),
                                t.addEventListener("touchstart", b, { passive: f }),
                                t.addEventListener("touchend", b),
                                function () {
                                    y.removeEventListener("mouseover", b, m),
                                        y.removeEventListener("mouseenter", b, m),
                                        y.removeEventListener("mouseout", b, m),
                                        y.removeEventListener("mouseleave", b, m),
                                        y.removeEventListener("mousemove", b, m),
                                        y.removeEventListener("mousedown", b, m),
                                        y.removeEventListener("mouseup", b, m),
                    ...
                    S = (function () {
                        ...
                        return (
                            (e.prototype.add = function (e, t, n) {
                                if ((void 0 === n && (n = !0), 0 === (e = K(e)).length))
                                    ...
                                    return g(this, function (a) {
                                        switch (a.label) {
                                            ...
                                            case 2:
                                                ...
                                                return (
                                                    this.assetLoader &&
                                                        (n = new _.CustomFileAssetLoaderWrapper(
                                                            this.runtime,
                                                            this.assetLoader,
                                                        ).assetLoader),
                                                    (r = this),
                                            ...
                                            case 3:
                                                if (((r.file = a.sent()), this.destroyed))
                                                    return (
                        ...
                        function t(e) {
                            ...
                            (this.loaded = !1),
                                ...
                                e.canvas.constructor === HTMLCanvasElement &&
                                    (this._observed = D.add(this.canvas, this.onCanvasResize)),
                                (this.src = e.src),
                                (this.buffer = e.buffer),
                        ...
                        return (
                            ...
                            (t.prototype.initializeAudio = function () {
                                ...
                                N.status == l.UNAVAILABLE &&
                                    ...
                                    N.add(this._audioEventListener),
                                    N.establishAudio());
                            }),
                            ...
                            (t.prototype.initArtboard = function (e, t, n, r, i) {
                                if (this.file) {
                                    ...
                                    if (
                                        ((this.artboard = s),
                                        (s.volume = this._volume * N.systemVolume),
                            ...
                            (t.prototype.cleanup = function () {
                                ...
                                (this.destroyed = !0),
                                    ...
                                    null !== this._observed && D.remove(this._observed),
                                    this.removeRiveListeners(),
                                    this.file && (null == (e = this.riveFile) || e.cleanup(), (this.file = null)),
                                    (this.riveFile = null),
                                    this.deleteRiveRenderer(),
                                    null !== this._audioEventListener &&
                                        (N.remove(this._audioEventListener), (this._audioEventListener = null)),
                            ...
                            (t.prototype.reset = function (e) {
                                var t,
                                    ...
                                    i = K(null == e ? void 0 : e.animations),
                                    a = K(null == e ? void 0 : e.stateMachines),
                            ...
                            return g(this, function (r) {
                                switch (r.label) {
                                    ...
                                    case 1:
                                        return (
                                            (t = r.sent()),
                                            (n = new _.AudioWrapper(t)),
                                            _.finalizationRegistry.register(n, t),
                                            [2, n]
                                        );
                                }
                            });
