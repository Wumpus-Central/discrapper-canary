...
let s = (t) => {
    ...
    return (0, l.ro)(new Date(), new Date(e))
        ? o.intl.formatToPlainString(o.t["+3jw2j"], { time: o.intl.data.formatTime(e, { format: "short" }) })
        : o.intl.formatToPlainString(o.t["/Avy4C"], { time: o.intl.data.formatTime(e, { format: "short" }) });
};
function u(t) {
