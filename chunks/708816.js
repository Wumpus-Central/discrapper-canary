                ...
                : e < 120
                  ...
                  : e < 180
                    ...
                    : e < 240
                      ...
                      : e < 300
                        ? [a, 0, o]
                        : [o, 0, a]).map((e) => Math.round((e + s) * 255));
    return {
        red: l[0],
        green: l[1],
        blue: l[2],
...
class A {
    ...
    getBorderRadius(e) {
        ...
        let c = null != (n = S(null == (t = e.styles[0]) ? void 0 : t.borderTopLeftRadius)) ? n : "0",
            ...
            d = null != (a = S(null == (o = e.styles[0]) ? void 0 : o.borderBottomRightRadius)) ? a : "0",
...
function G(e) {
    ...
    U(() => {
        ...
        o.useEffect(() => {
            ...
            null == r || null == e || ((p.current = r), r ? g.showElement(e, v) : !1 === r && g.hide());
        }, [r, v, g, s]),
        U(() => {
            if (null != r) return;
        ...
        T = o.useCallback(
            (e) => {
                ...
                e.currentTarget === e.target
                    ? ((p.current = !0), g.showElement(null != n ? n : e.currentTarget, v))
                    : (m(!0), t && g.showElement(null != n ? n : e.currentTarget, v)),
                    null == y || y(e);
            },
            [s, t, y, g, v],
        );
