"use strict";
n.d(t, { DZ: () => D, Mm: () => b, Qg: () => N, Y5: () => v, av: () => y, vK: () => C });
var r = n(835245),
    i = n(323889),
    s = n(345353),
    a = n(881615),
...
function S(e, t) {
    ...
    if (
        (d.A.displayTools && "quest_preview" === d.A.lastOpenTabId) ||
...
async function R(e) {
    let {
        ...
        { adUser: l, adMetadataSealed: d } = await O(t);
    return {
        ...(0, g.fF)(t, n, i),
        ...(0, u.A)(),
        cta_name: s,
...
async function v(e) {
    ...
    y({
        ...
        properties: {
            ...
            quest_status: null != d ? (0, g.NI)(d) : null,
