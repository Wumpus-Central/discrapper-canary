"use strict";
n.d(t, { DZ: () => L, Mm: () => D, Qg: () => v, Y5: () => R, av: () => N, kO: () => b, vK: () => O });
var i = n(835245),
    r = n(323889),
    s = n(345353),
    a = n(881615),
...
function S(e, t, n, i) {
    ...
    return {
        ...
        billing_session_id: T(r, (0, p.xn)(t)),
        ad_content_id: e,
        ...s,
...
function b(e) {
    let {
        ...
        u = (0, a.sN)().uuid;
    _.default.track(A.HAw.QUEST_HOME_CAROUSEL_SCROLL, {
        scrolling_type: t,
        client_ad_session_id: u,
        billing_session_id: T(u, (0, p.xn)(o)),
