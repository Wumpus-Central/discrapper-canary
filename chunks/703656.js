...
function E(e, t) {
    return (
        !!("string" == typeof e && p.some((t) => e.startsWith(t))) &&
...
function v(e, t, n) {
    E(e, "replace") ||
        (_.log("Replacing route with ".concat(e)), "string" == typeof e ? r.replace(e, t) : r.replace(e), (i = n));
}
function I() {
    return r;
}
...
function N(e) {
    ...
    else if (e.startsWith(u.Z5c.DISABLE_SERVER_HIGHLIGHT_NOTIFICATIONS))
        return u.Usc.DISABLE_SERVER_HIGHLIGHT_NOTIFICATIONS;
