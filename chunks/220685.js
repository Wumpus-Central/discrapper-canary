...
let E = [14361481, 12200937, 8804082, 6576370, 5335282, 2652110, 2128781, 2196594, 4752414, 13064760, 13058360, 12401000, 12933021, 5659039, 4092591, 5868359, 6586142, 8876063, 8484432, 9979976, 5269106, 3421236],
    ...
    P = (e) => {
        ...
        let { guild: s, canEnable: l } = e,
            ...
            [v, P] = i.useState(s.hasFeature(y.oNc.CREATOR_STORE_PAGE)),
            ...
            M = v !== s.hasFeature(y.oNc.CREATOR_STORE_PAGE) || ((null == c ? void 0 : c.store_page_primary_color) == null && w !== T) || ((null == c ? void 0 : c.store_page_primary_color) != null && w !== (null == c ? void 0 : c.store_page_primary_color)) || D !== (null == c ? void 0 : c.store_page_trailer_url) || (null != k && k !== (null == c ? void 0 : c.store_page_show_subscriber_count)),
            G = async () => {
                o()(null != c, 'Settings must be defined');
                let e = {};
                v !== s.hasFeature(y.oNc.CREATOR_STORE_PAGE) && (e.store_page_enabled = v),
            ...
            U = y.EYA.ROLE_SUBSCRIPTION_STORE_PAGE(L),
                    ...
                    children:
                        ...
                        (0, r.jsx)(p.oXn, {
                            children: (0, r.jsx)(f.Z, {
                                ...
                                onReset: () => {
                                    var e, t;
                                    P(s.hasFeature(y.oNc.CREATOR_STORE_PAGE)), R(null != (e = null == c ? void 0 : c.store_page_primary_color) ? e : T), Z(null == c ? void 0 : c.store_page_trailer_url), W(null != (t = null == c ? void 0 : c.store_page_show_subscriber_count) && t);
                                },
                                onSave: G,
                                disabled: z
                            })
