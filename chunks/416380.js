...
let m = 10 + Math.random() * (10 * _.A.Millis.SECOND),
    ...
    I = !1;
class T extends a.A {
    actions = { POST_CONNECTION_OPEN: S, CONNECTION_RESUMED: S, CONNECTION_CLOSED: N, APP_STATE_UPDATE: y };
    _initialize() {
...
function y(e) {
    I && "active" !== e.state && (clearTimeout(A), (A = null), v(!1));
}
function N() {
    I && (clearTimeout(A), (A = null), v(!1));
}
async function v(e) {
    C(g, !1),
        !f.A.hasLoaded(E.oD.FRECENCY_AND_FAVORITES_SETTINGS) &&
...
function C(e, t) {
    null != A && clearTimeout(A), (A = setTimeout(() => v(t), e));
}
let R = new T();
