...
var a = n(54381),
    ...
    h = n(734435);
function f(t) {
    let { guildId: e, shouldUpsellCreation: f, transitionState: v, onClose: j } = t,
    ...
    return (
        f &&
            O.push({
                ...
                onClick: () => {
                    (0, o.ZDy)(async () => {
                        let { default: t } = await Promise.all([n.e("29497"), n.e("73209")]).then(n.bind(n, 241865));
                        return (n) => {
                            var r, i;
                            return (0, a.jsx)(
                                t,
                                ...
                                (i = i =
                                    {
                                        ...
                                        guildId: e,
                                        prefillChannelName: f ? x.intl.string(x.t["5z1Xat"]) : void 0,
                                    }),
