...
let x = {
    ...
    C = (e) => {
        ...
        let C = (0, l.default)(new Date(a.next_reward_date), new Date()),
            p = a.program_current_state === u.L.PREMIUM_CHURNING,
            _ = p ? x.churning.start : x.active.start,
            g = p ? x.churning.end : x.active.end;
        return (0, n.jsxs)("div", {
            className: r()(h.k, t),
            children: [
                (0, n.jsx)(c.Ay, {
                    ...
                    progress: i - C,
                    maximum: i,
                    override: { default: { gradientStart: _, gradientEnd: g } },
                }),
                p
