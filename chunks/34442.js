...
function I(e) {
    let { widgetType: t, widget: i, onAddGame: c, children: u, ...g } = e,
        ...
        [v, S] = l.useState(""),
        E = l.useRef(""),
        { options: y, matchSorterOptions: w } = (0, h.R)(),
        { applicationIds: b, onAddGame: N } = (0, A.S)(t),
        T = l.useCallback(
            (e) => {
                (0, p.ew)({ widgetType: t, game: { applicationId: e } }),
                    a.O.announce(f.intl.string(f.t.q0U3DE)),
        ...
        R = l.useMemo(() => ({ ...w, threshold: s.Ht.rankings.CONTAINS, keys: ["label"] }), [w]),
