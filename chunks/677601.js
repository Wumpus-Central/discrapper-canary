...
class eK extends i.PureComponent {
    ...
    componentDidMount() {
        ...
        this.currentDocument.addEventListener(eE.NO, this.handleFullScreenChange), eC.default.track(eG.rMx.VIDEO_LAYOUT_TOGGLED, ez({ video_layout: this.inPopout ? 'popout' : t }, (0, A.AB)(e.id)));
    }
    ...
    constructor(...e) {
        super(...e),
                            ...
                            switch (c.type) {
                                case eG.d4z.DM:
                                    return (0, b.jW)(
                                        t,
                                        async () => {
                                            let { default: t } = await Promise.all([n.e('79695'), n.e('55551'), n.e('70205'), n.e('98783'), n.e('53912'), n.e('56826'), n.e('31084')]).then(n.bind(n, 131404));
                                            return (n) =>
                                                (0, r.jsx)(
                                                    t,
                                                    eW(ez({}, n), {
            ...
            eV(this, 'renderRegionSelect', () => {
                ...
                return (
                    this.inPopout || i === eG.AEg.FULL_SCREEN || null == t || n.isManaged() || (e = (0, r.jsx)(x.Z, { call: t })),
                    (0, r.jsx)(k.Z, {
