...
var l = n(54381),
    ...
    m = n(388032);
function j(e) {
    let { userId: t, guildId: n, channelId: j, location: h, onAction: v, appContext: S } = e,
        _ = r.useContext(p.AnalyticsContext),
        M = (0, s.Aq)(),
    ...
    return null != n && null != I && N
        ? (0, l.jsx)(a.sNh, {
              ...
              action: () => {
                  null == v || v(), (0, d.i)(S), M.dispatch(y.CkL.POPOUT_CLOSE);
                  let e = g.Z.getChannel(C),
                      l = {
                          modViewPanel: P.k.INFO,
                          sourceLocation: null != h ? h : _.location,
                      };
