...
let p = 1500,
    ...
    I = (e) => {
        var t;
        let { dispatcher: n, actionHandler: o, getFingerprint: c, getSessionId: f = v, TRACKING_URL: I, drainTimeoutOverride: S, waitFor: T, scheduleWhenIdle: A = g } = e;
        function N(e) {
            var t;
            if (null != i) return i;
        ...
        function P(e) {
            ...
            null == O && C() && (O = t ? setTimeout(R, 0) : A(R, { timeout: m }));
        }
        function R() {
            if (((O = null), !C())) return;
            let e = y.slice();
        ...
        (m = null != S ? S : p),
            (b.handleConnectionOpen = function (e) {
                ...
                return null != t && (r = t), null != n.id && (i = n.id), P({ shouldFlushOnNextTick: !1 }), !1;
            }),
                ...
                return (
                    f().then((e) => {
                        let { sessionId: a } = e,
                            ...
                            l = N(s);
                        null != l && (s.properties.client_uuid = E.generate(l)), y.push(s), y.length > h && (y = y.slice(-h)), r ? P({ shouldFlushOnNextTick: !0 }) : P({ shouldFlushOnNextTick: !1 });
                    }),
                    !1
                );
            });
