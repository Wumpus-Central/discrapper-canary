...
function m(e) {
    ...
    return (0, i.jsxs)("div", {
        className: u.AA,
        children: [
            t && (0, i.jsx)(r.s, { children: c.intl.string(c.t["8DAM+5"]) }),
            (0, i.jsxs)(s.Text, { variant: "text-md/semibold", color: "none", children: [l, "%"] }),
            (0, i.jsx)(s.Text, { variant: "text-xs/semibold", color: "none", children: n }),
        ],
    });
}
function _(e) {
    ...
    return (0, i.jsxs)(i.Fragment, {
        children: [
            (0, i.jsx)(d.Dt, {
                attachmentClassName: a()(u.oh, { [u.Wx]: r }),
                emojiClassName: u.Zg,
                media: t.pollMedia,
                fallback: (0, i.jsx)("div", { className: a()(u.oh, u.nb) }),
            }),
            s && (0, i.jsx)(d.Vx, { size: 40, isVictor: c, isExpired: n, className: u.Dt }),
            r &&
                (0, i.jsxs)(i.Fragment, {
                    children: [
                        (0, i.jsx)(m, {
...
function h(e) {
    ...
    return (0, i.jsx)(d.Fh, {
        ...
        renderAnswerContent: (e) =>
            (0, i.jsx)(_, { answer: e, isExpired: t, myAvatarUrl: n, answersInteraction: l, canShowVoteCounts: r }),
        ...s,
    });
}
