...
function G() {
    ...
    return (
        d().each(b, (t, n) => {
            (null != t && (I.A.hasChannel(t) || t === s || w.has(t) || (0, R.mP)(t))) ||
...
function F(e, t, n) {
    ...
    o === e && ((o = null), (s = !0)),
        b[M(r)] === e &&
            ...
            v.A.getGuildId() === r && (0, E.bG)(C.BVt.CHANNEL(t, b[M(r)])),
            (s = !0)),
...
class B extends h.Ay.Store {
    ...
    initialize() {
        ...
        this.mustEmitChanges((e) => "CONNECTION_OPEN" !== e.type && "VOICE_STATE_UPDATES" !== e.type),
            this.waitFor(A.default, I.A, T.Ay, S.A, y.Ay, N.A, v.A);
    }
    getChannelId(e) {
        let t = !(arguments.length > 1) || void 0 === arguments[1] || arguments[1],
            n = M(e === C.ME ? null : (e ?? v.A.getGuildId() ?? null));
...
let H = new B(p.h, {
    CONNECTION_OPEN: function (e) {
        if (((i = e.sessionId), null != o)) {
            ...
            (null != e && N.A.can(_.kg(C.xBc.VIEW_CHANNEL, C.xBc.CONNECT), e)) || (o = null);
        }
        G() && P();
    },
    ...
    VOICE_CHANNEL_SELECT: function (e) {
        ...
        if (null == t) {
            let e = I.A.getChannel(o),
                t = e?.guild_id;
            null != t && t !== v.A.getGuildId() && b[t] === o && (b[t] = x(t));
        }
        (o = t), P();
    },
    ...
    LOGOUT: function () {
        (b = {}), (s = null), (r = void 0), (L = {}), (a = {}), (o = null), f.w.remove(O);
    },
});
