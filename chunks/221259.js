    ...
    let e = (0, i.Wu)([s.ZP], () =>
        ...
        [n, l] = (0, i.Wu)([s.ZP, a.Z], () => {
            ...
            return null != n && e.includes(n.id)
                ? ["parent", (0, c.p1)((0, c.gs)(s.ZP.resolveUnreadSetting(n), s.ZP.resolvedMessageNotifications(n)))]
                : [
                      "guild",
                      (0, c.p1)(
                          (0, c.gs)(s.ZP.getGuildUnreadSetting(t.guild_id), s.ZP.getMessageNotifications(t.guild_id)),
                      ),
                  ];
