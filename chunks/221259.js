    ...
    let t = (0, i.Wu)([o.ZP], () =>
        ...
        [n, a] = (0, i.Wu)([o.ZP, r.Z], () => {
            ...
            return null != n && t.includes(n.id)
                ? ["parent", (0, d.p1)((0, d.gs)(o.ZP.resolveUnreadSetting(n), o.ZP.resolvedMessageNotifications(n)))]
                : [
                      "guild",
                      (0, d.p1)(
                          (0, d.gs)(o.ZP.getGuildUnreadSetting(e.guild_id), o.ZP.getMessageNotifications(e.guild_id)),
                      ),
                  ];
