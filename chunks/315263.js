...
function k(e) {
    ...
    if (null != I && (I.type === _.g.APP_DIRECTORY_PROFILE || I.type === _.g.APP_DIRECTORY_STOREFRONT || I.type === _.g.APP_DIRECTORY_STOREFRONT_SKU))
        return (t) => {
            var i, o;
    ...
    if (null != I && I.type === _.g.ACTIVITY_BOOKMARK)
        return (e) => {
            var t, n, r;
    ...
    if (null != I && I.type === _.g.GUILD_PRODUCT)
        return (e) => {
            null == e || e.preventDefault();
    ...
    if (null != I && I.type === _.g.QUESTS_EMBED && (0, b.cB)({ location: w.dr.EMBED_MOBILE }))
        return (e) => (
            null == e || e.preventDefault(),
            Promise.resolve()
    ...
    let { host: A, hostname: L, pathname: k, search: j, hash: U } = null !== (t = R.Z.toURLSafe(e)) && void 0 !== t ? t : {},
        G = R.Z.isDiscordHostname(null != L ? L : null) || R.Z.isDiscordLocalhost(null != A ? A : null, null != L ? L : null);
    ...
    if (null != k && G) {
        let { getOAuth2AuthorizeProps: t, openOAuth2ModalWithCreateGuildModal: r } = n(69580),
            i = t(e);
        if (null != i) return (e) => (null == e || e.preventDefault(), null != I && I.type === _.g.APP_OAUTH2_LINK && u.ZP.trackWithMetadata(D.rMx.APP_OAUTH2_LINK_EMBED_URL_CLICKED, { application_id: i.clientId }), r(i), !0);
    }
    let B = (0, E.Ao)(k);
    if (null != k && G && null != B)
        return (e) => {
    ...
    return G && (null == k ? void 0 : k.startsWith('/discovery/quests'))
        ? (e) => (null == e || e.preventDefault(), (0, y.navigateToQuestHome)({ fromContent: i.j.QUEST_BADGE }), !0)
        : G && (null == k ? void 0 : k.startsWith('/discovery/servers'))
          ? (e) => (
                null == e || e.preventDefault(),
                n
                    .e('11866')
          ...
          : o || null == (0, S.v)(e)
            ? void 0
            : (t) => (null == t || t.preventDefault(), O.Z.show(e), !0);
}
