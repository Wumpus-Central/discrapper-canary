...
let P = (t, e) => {
    ...
    R = (0, r.qs)(_.n.CONTENT_AND_SOCIAL_PERMISSIONS_MESSAGE_REQUESTS_SETTING, {
            ...
            if (e === g.Th) {
                ...
                (n = !t),
                    (0, N.V)({
                        ...
                        onConfirm: () => {
                            d.mX.updateSetting(n), P(n, !1);
                        },
                        onCancel: () => {
                            d.mX.updateSetting(n), d.zA.updateSetting(n ? a.Z.getGuildIds() : []), P(n, !0);
                        },
                    });
            } else {
                let n = (0, S.gl)();
