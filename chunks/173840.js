...
function eo(e) {
    if (Array.isArray(e.begin)) {
        ...
        es(e, e.begin, { key: 'beginScope' }), (e.begin = b(e.begin, { joinWith: '' }));
    }
}
function el(e) {
    if (Array.isArray(e.end)) {
        ...
        es(e, e.end, { key: 'endScope' }), (e.end = b(e.end, { joinWith: '' }));
    }
}
function eu(e) {
    ...
    ey = function (e) {
        ...
        function v(e, t, r, a) {
            ...
            function f() {
                ...
                } else e = b(w, x.subLanguage.length ? x.subLanguage : null);
