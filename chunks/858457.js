                ...
                : (function (e) {
                      let { [m]: t = [] } = e,
                          n = Object.entries(
                              ...
                              let [n, r] = e,
                                  i = r[m],
                                  { code: s, message: a } =
                                      null !== (t = null == i ? void 0 : i[0]) && void 0 !== t
                                          ? t
                                          : {
                                                code: p,
                      ...
                      if (t.length > 0) {
                          ...
                          n.push({
                              ...
                              code: null !== (a = null === (i = t[0]) || void 0 === i ? void 0 : i.code) && void 0 !== a ? a : p
                          });
                      }
                      return n;
                  })(n);
...
let h = (0, i.throttle)(g, 1000, { leading: !1 });
function f(e, t) {
    var n, s;
    let [a, l] = r.useState([]),
        [d, u] = r.useState(null),
        [m, p] = r.useState(null !== (s = null == e ? void 0 : null === (n = e.triggerMetadata) || void 0 === n ? void 0 : n.regexPatterns) && void 0 !== s ? s : []),
        f = r.useCallback(
            (t) => {
                !(t.length < 3) &&
    ...
    return {
        ...
        validatePatternsChanged: r.useCallback(
            (n, r) => {
                !(0, i.isEqual)(n, r) &&
                    (h.cancel(),
                    g(c(o({}, e), { triggerMetadata: c(o({}, e.triggerMetadata), { regexPatterns: n }) }), (e) => {
