...
function W(e) {
    let { product: t, isFetching: n } = (0, g.T)(e),
        ...
        o = () => (null == r ? (S.Z.addBreadcrumb({ message: 'Error saving avatar decoration; it is null' }), Promise.reject()) : ((0, d.cV)(r), H()));
    return [r, o];
}
function K(e) {
    var t;
...
function z(e) {
    let { quest: t } = e,
        ...
        o = w.r.build(t.config).defaultRewardRedemptionInstructionsByPlatform[R.y$.CROSS_PLATFORM];
    return (0, r.jsxs)('div', {
        ...
        children: [
            ...
            (0, r.jsx)(u.Text, {
                ...
                color: 'always-white',
                children: b.Z.parse(o, !1, { allowLinks: !0 })
            })
        ]
    });
}
function q(e) {
    let { quest: t, user: n, decoration: i, isSaving: o, onClose: a, onConfirm: s } = e,
