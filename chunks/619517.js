...
class N extends r.Component {
    ...
    static getFormatQuality(e) {
        let { src: t, original: n, animated: i, srcIsAnimated: r, freeze: s = !1 } = e,
            ...
            o = null;
        return (
            E.QB && (s || !N.isAnimated({ src: t, original: n, animated: i, srcIsAnimated: r }))
                ? ((a = "webp"), (N.isSrcPNG({ src: t }) || N.isSrcAVIF({ src: t })) && (o = "lossless"))
                : s && (a = "png"),
            { format: a, quality: o }
        );
    }
    static preloadImage(e) {
        ...
        if (1 === r && 1 === s) return;
        let { format: h, quality: f } = N.getFormatQuality({
                src: t,
                original: o,
                animated: l,
                srcIsAnimated: a,
    ...
    static async trackLoadingCompleted(e) {
        ...
        if ((t && _.A.increment({ name: a.K.IMAGE_LOAD_ERROR }), !v.getConfig({ location: "lazy_image" }).enabled))
            return;
    ...
    constructor(e) {
        super(e),
            (0, d.LE)(this.getSrc(this.getRatio(), N.isAnimated(this.props))) && (this.state.readyState = g.Rv1.READY);
    }
    componentDidMount() {
        let { readyState: e } = this.state;
        if (e === g.Rv1.LOADING)
            if (C.getConfig({ location: "LazyImage_componentDidMount" }).enabled) {
    ...
    getSrc(e) {
        let t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
            ...
            { format: l, quality: u } = N.getFormatQuality({ ...this.props, freeze: t });
        return (0, d.AE)({
            src: n,
            width: i,
            height: r,
    ...
    handleImageLoad = (e, t) => {
        this._unmounted ||
            this.setState({ readyState: e ? g.Rv1.ERROR : g.Rv1.READY }, () => {
                let { format: n, quality: i } = N.getFormatQuality(this.props);
                N.trackLoadingCompleted({
                    error: e,
                    imageData: t,
    ...
    render() {
        let {
            ...
            V = C.getConfig({ location: "LazyImage_render" }).enabled,
            B = {
                alt: e,
                readyState: M,
        ...
        switch (
            ...
            case g.Rv1.READY:
                if (N.isAnimated(this.props)) {
                    ...
                    let e = (o || P || x) && (null == f || f) && N.visibilityObserver.isVisible(this);
                    e
