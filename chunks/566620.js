...
async function et(e) {
    var t, n;
    let { channelId: r, applicationId: o, isStart: s, analyticsLocations: l, locationObject: c, embeddedActivitiesManager: u, componentId: d, commandOrigin: _, sectionName: p, source: h, onExecutedCallback: m, referrerId: g, customId: E, inviterUserId: b, onConfirmActivityLaunchChecksAlertOpen: y } = e,
        I = C.Z.getChannel(r),
    ...
    try {
        ...
        if (
            ...
            if (null == r || !en(o, I)) throw new O.Z(O.Z.Reasons.INVALID_CHANNEL);
            let e = await er({
                applicationId: o,
                nonce: A,
                channelId: r,
...
async function ei(e) {
    let t,
        { applicationId: n, channelId: i, embeddedActivitiesManager: o, isStart: a, guildId: l } = e,
...
function eo(e) {
    ...
    if (null != o) {
        ...
        let e = y.Z.getSelectedParticipantId(o),
            ...
            r = G.ZP.getEmbeddedActivitiesForChannel(o).find((e) => e.applicationId === n);
    ...
    if (!l && !G.ZP.shouldFetchShelf(s)) {
        if (null == (t = G.ZP.getShelfFetchStatus(s)) ? void 0 : t.isFetching) {
            let e,
                t,
                n = new Promise((t) => {
                    (e = el.bind(null, s, t)), a.Z.subscribe('EMBEDDED_ACTIVITY_FETCH_SHELF_SUCCESS', e);
                }),
                r = new Promise((e) => {
                    (t = el.bind(null, s, e)), a.Z.subscribe('EMBEDDED_ACTIVITY_FETCH_SHELF_FAIL', t);
                });
