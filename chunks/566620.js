...
async function er(e) {
    ...
    if (!k) {
        var M;
        if (null == D && !(null != (M = null == R ? void 0 : R.isPrivate()) && M)) return !1;
    }
    let j = (0, S.r)();
    try {
        a.Z.dispatch({
        ...
        if (
            ...
            if (null == P || !ei(n, R)) throw new O.Z(O.Z.Reasons.INVALID_CHANNEL);
            let e = await eo({
                applicationId: n,
                nonce: j,
                channelId: P,
                ...
                clientSupportsContextlessActivityLaunch: k,
