...
function es(e, t) {
    let n = (null == t ? void 0 : t.type) === Q.d4z.GUILD_VOICE,
        ...
        i = null != r && (0, U.yE)(r.flags, Q.udG.EMBEDDED),
        a = (0, Z.l5)(t);
    return (n && i) || a;
}
async function el(e) {
...
function eO() {
    (eb(X.Ez.ACTIVITY_POPOUT_WINDOW), s.Z.dispatch({ type: 'ACTIVITY_POPOUT_WINDOW_OPEN' }));
}
