...
class C extends s.Ay.Store {
    ...
    initialize() {
        this.waitFor(l.A, u.default), v(l.A.settings);
    }
...
let O = new C(a.h, {
    LOGOUT: function () {
        h.clear(), E.clear(), T.clear(), (S = !1), (A = 0), (g = 0);
    },
    ...
    GUILD_SOUNDBOARD_SOUND_PLAY_START: function (e) {
        let { soundId: t, userId: n } = e,
            r = (E.get(t) ?? 0) + 1,
            i = (T.get(n) ?? 0) + 1;
        E.set(t, r), T.set(n, i), n !== u.default.getCurrentUser()?.id && (S = !0);
    },
    GUILD_SOUNDBOARD_SOUND_PLAY_END: function (e) {
        let { soundId: t, userId: n } = e,
            r = (E.get(t) ?? 0) - 1,
            i = (T.get(n) ?? 0) - 1;
        r <= 0 ? E.delete(t) : E.set(t, r), i <= 0 ? T.delete(n) : T.set(n, i);
    },
    ...
    USER_SETTINGS_PROTO_UPDATE: function (e) {
        ...
        n === p.oD.FRECENCY_AND_FAVORITES_SETTINGS
            ...
            : n === p.oD.PRELOADED_USER_SETTINGS && v(r);
    },
