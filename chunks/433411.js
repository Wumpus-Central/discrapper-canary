...
function b(e) {
    let {
        ...
        I = (0, f.Z)("enable_avatar_decoration_uploads"),
        T = (0, m.i3)({
            user: t,
            guildId: null == n ? void 0 : n.id,
        }),
        { pendingAvatarDecoration: A, errors: C } = (0, m.wE)({
            guildId: null == n ? void 0 : n.id,
            isTryItOut: v,
        }),
        N = i.useCallback(
        ...
        P = v || void 0 !== A ? null != A : null != T;
    function R() {
        v ? (0, _.Xz)(null) : (0, m.PO)(null, null == n ? void 0 : n.id);
    }
    let w = y ? l.gtL : s.zx;
    return (0, r.jsxs)(h.Z, {
        className: a,
