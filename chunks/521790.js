    ...
    return (0, i.jsxs)(d.$T, {
        ...
        children: [
            ...
            (0, i.jsx)("img", {
                ...
                alt: f?.name,
                className: a()(O.tV, O.Y5),
            }),
            R.intl.format(C.default.iMCLA5, { connectionName: f?.name, date: p }),
            (0, i.jsx)(d.Z_, {
                onClick: () => {
                ...
                noticeType: s,
                className: O.NS,
                children: R.intl.string(C.default.kxlybP),
            }),
            (0, i.jsx)(d.zr, {
                onClick: () => {
                    n(N.i.USER_DISMISS);
                ...
                className: O.go,
                children: R.intl.string(C.default["8qJAeT"]),
            }),
        ],
    });
}
