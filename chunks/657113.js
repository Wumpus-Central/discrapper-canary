...
function z(t) {
    let {
        ...
        [A, _] = m.useState(!1),
        { startingConsoleQuest: f, startConsoleQuest: O } = (0, c.Wj)({
            questId: e.id,
            beforeRequest: () => {
                l ? T.startAnimation() : _(!0),
    ...
    return l
        ? (0, s.jsx)(w.$n, {
              ...
              disabled: f,
              className: X.x,
              children: (0, s.jsxs)("div", { className: X.t, children: [T?.render(), I.intl.string(I.t.nPThNb)] }),
          })
        : (0, s.jsx)(i.$, {
              variant: "secondary",
              onClick: O,
