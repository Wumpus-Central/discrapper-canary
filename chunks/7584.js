...
let b = String.fromCodePoint(917631),
    ...
    L = /^[\u{E0061}-\u{E007A}]$/u;
function w(e, t) {
    if (!0 !== t && !R(e)) return [{ type: "text", text: e }];
    let n = "",
        i = [],
        r = e.match(f) ?? [];
...
let x = {
    ...
    getByCategory: function (e) {
        ...
        if (null == t) {
            let n = E[e];
            (t = a.Ay.filterUnsupportedEmojis(p.slice(n[0], n[1])).map(C)), v.set(e, t);
        }
        return t;
    },
    contentHasUnicodeOrEmoji: R,
    ...
    forEach: (e) => {
        for (let t of p) t.hasDiversityParent || t.hasMultiDiversityParent || e(C(t));
    },
    numDiversitySprites: A,
    numNonDiversitySprites: I,
