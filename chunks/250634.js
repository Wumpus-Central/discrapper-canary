                        ...
                        : (e) => {
                              if (e.currentTarget.contains(e.target)) {
                                  if (
                                      ...
                                      b ? p.focusPrevious() : p.focusNext();
                                  else if (
                                      ("horizontal" === n && "ArrowLeft" === e.key) ||
                                      ("vertical" === n && "ArrowUp" === e.key)
                                  )
                                      b ? p.focusNext() : p.focusPrevious();
                                  else {
                                      if ("Tab" !== e.key) return;
                                      e.stopPropagation(),
...
function c(e, t, s) {
    let r = {
        ...
        },
        {
            ...
            isDisabled: a,
            buttonProps: d,
        } = (0, i.q)({ ...e, id: void 0, isDisabled: e.isDisabled || t.isDisabled }, r, s);
    return (
        "single" === t.selectionMode &&
            ((d.role = "radio"), (d["aria-checked"] = r.isSelected), delete d["aria-pressed"]),
        { isPressed: l, isSelected: o, isDisabled: a, buttonProps: d }
    );
}
