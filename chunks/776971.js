...
function N(t) {
    let e,
        ...
        O = l.useRef(null),
        j = l.useRef(null),
        B = r === T.w_.DEEP_LINK_PROMPT,
        W = r === T.w_.FAMILY_CENTER,
        Y = (0, w.a9)() && !W && !B,
        { verifyAgreementButtonText: z, verifyGateDescription: K, verifyTitle: H } = (0, w.Gn)(r),
        Q = (0, w.vL)(M),
        q = w.Bc.has(r);
    (0, g.I7)(r);
    let X = null != L ? o()().diff(L, "years") : null;
    function Z() {
        if (r === T.w_.NSFW_SERVER_INVITE_EMBED) return (0, C.IO)(r), Promise.resolve();
        let t = M?.getGuildId();
        return A.A.nsfwReturnToSafety(t), (0, C.IO)(r), Promise.resolve();
    }
    async function J() {
        s()(null != L, "Cannot submit null birthday.");
        try {
            return V(null), v(!0), await (0, y.n7)(L, r), !0;
        } catch (t) {
            return (
                null != t.body && null != t.body.date_of_birth
                    ? (0, C.MP)(r, t.body.date_of_birth)
    ...
    l.useEffect(() => {
        N?.nsfwAllowed !== !0 || Y || B || (0, C.Nk)(r);
    }),
        l.useEffect(() => {
            R.default.track(S.HAw.AGE_GATE_ACTION, { source: r, action: T.AM.AGE_GATE_OPEN });
        }, [r]);
