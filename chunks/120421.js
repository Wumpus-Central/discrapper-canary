...
function u(e, t, n) {
    return {
        pointsByItem: { [o.yN.CLICKER_BUTTON]: 0 },
        pointsSpent: 0,
        itemContributions: {},
        purchasedItems: { [o.yN.CLICKER_BUTTON]: { upgrades: {} } },
...
let N = new b(s.Z, {
    ...
    CLICKER_GAME_PURCHASE_ITEM: function (e) {
        ...
        if (
            ...
            var r;
            (m.endTime = Date.now()),
                a.default.track(l.rMx.CLICKER_GAME_COMPLETED, {
    ...
    CLICKER_GAME_PURCHASE_ITEM_UPGRADE: function (e) {
        ...
        let { id: i } = e,
            s = (0, o.r7)()[i],
            a = null === (t = m.purchasedItems[s.itemId]) || void 0 === t ? void 0 : t.upgrades;
        if (null == a) return;
        let l = null !== (r = a[i]) && void 0 !== r ? r : 0,
            c = h();
        if (
            null != s.predicate &&
            !(null === (n = s.predicate) || void 0 === n
                ? void 0
                : n.call(s, {
            ...
            return;
        let u = s.cost({ numAlreadyPurchased: l });
        f() < u ||
            ((m.pointsSpent += u),
