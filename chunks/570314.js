...
var n = t(627968),
    ...
    R = t(375708);
function v(e) {
    let { user: i, closePopout: t, ...v } = e,
        E = l.useRef(null),
        S = (0, a.bG)([j.A], () => j.A.getUserProfile(i.id)?.application),
        m = (0, a.bG)([_.Ay, C.A], () => C.A.getChannel(_.Ay.getChannelId())),
        y = (0, p.A)(m),
        F = i.id,
        O = l.useCallback(() => {
            null != S &&
    ...
    return h.p5
        ? (0, n.jsx)(u.Y, {
              ...
              renderPopout: (e) => {
                  ...
                  return (0, n.jsx)(c.W, {
                      ...
                      onClose: i,
                      "aria-label": R.intl.string(R.t.dbkxVm),
                      onSelect: void 0,
        ...
        : (0, n.jsx)(D.FD, { action: "PRESS_ADD_APP", text: U, icon: N, onClick: O, variant: "primary", ...v });
}
