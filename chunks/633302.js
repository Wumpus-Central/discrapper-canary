...
class L {
    ...
    get name() {
        return this.hasDiversity && null != _ ? ''.concat(this.uniqueName, '::').concat(v[_]) : this.uniqueName;
    }
    ...
    let n = x[e].map((e) => {
        ...
        for (let n in a) {
            ...
            if (!e.hasMultiDiversity) {
                let n = T[r.emojiObject.diversity[0]];
...
function q(e) {
    let n = !(arguments.length > 1) || void 0 === arguments[1] || arguments[1],
        ...
        i = r;
    return Object.prototype.hasOwnProperty.call(N, e) && (i = N[e]), n ? ':'.concat(i, ':') : i;
}
function Q(e) {
    let n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : '';
...
n.ZP = {
    ...
    forEach: (e) => c().each(y, e),
    all: () => y,
    numDiversitySprites: b,
