...
function en(e) {
    ...
    if (
        ...
        if (
            ...
            ep && (0, o.Kc)(l) && ex.includes(q.i.SUMMARIES))
        ) {
            ...
            if (
                ...
                let a = e_ ? Q.intl.format(n, { count: H }) : Q.intl.format(e, { count: H, timestamp: r });
                if (e_) {
                    let e =
                        c > 0
                            ? (0, i.jsxs)(i.Fragment, {
            ...
            ex.includes(q.i.NEW_MESSAGES) &&
                (t = (0, i.jsx)(K.GN, { content: Q.intl.format(e, { count: H, timestamp: r }), channelId: l.id }));
    }
    if (
        (null == t &&
            (0, o.pk)(l) &&
