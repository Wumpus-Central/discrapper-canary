    ...
    function l() {
        ...
        if (e || t)
            do {
                ...
                if (r)
                    a
                        ? (o.nextSymbol(), n.byweekday || (n.byweekday = []), n.byweekday.push(i.Ci[a].nth(r)))
                        : (n.bymonthday || (n.bymonthday = []), n.bymonthday.push(r), o.accept("day(s)"));
                else if (a) o.nextSymbol(), n.byweekday || (n.byweekday = []), n.byweekday.push(i.Ci[a]);
                else if ("weekday(s)" === o.symbol)
                    o.nextSymbol(), n.byweekday || (n.byweekday = [i.Ci.MO, i.Ci.TU, i.Ci.WE, i.Ci.TH, i.Ci.FR]);
