...
async function R(e) {
    ...
    let C,
        O,
        { applicationId: p, skuId: m, initialPlanId: D, analyticsLocations: P, analyticsLocationObject: g } = e,
        h = I.A.get(m);
    if (null == h) {
    ...
    (h = h ?? I.A.get(m)),
        r()(null != h && h.applicationId === p, "SKU must belong to application"),
        h.type !== N.Puh.SUBSCRIPTION || (0, _.B)([h.id]) || (await (0, o.ur)(h.id));
    let U =
        null == (O = null != (C = (0, c.LU)({ applicationId: p })) ? u.A.getWindow(C) : void 0) || O.closed
            ? a.SYi
            : a.KX8;
    if (h.type !== N.Puh.SUBSCRIPTION)
