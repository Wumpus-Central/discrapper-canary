...
function E(e, t, n) {
    ...
    let s = l.ZP.getUserState(),
        ...
        u = Object.values(null != (a = null == (r = s.result) ? void 0 : r.sections) ? a : {}).concat(
            Object.values(null != (o = null == (i = c.result) ? void 0 : i.sections) ? o : {}),
        );
    if (null != n) {
        let e = u.find((e) => {
            var t;
...
function y(e, t, n) {
    ...
    let f = l.ZP.getUserState(),
        ...
        m =
            null !=
            (d =
                null != (u = null == (i = f.result) || null == (r = i.sections) ? void 0 : r[n])
                    ? u
                    : null == (o = p.result) || null == (a = o.sections)
                      ? void 0
                      : a[n])
                ? d
                : null == (c = _.result) || null == (s = c.sections)
                  ? void 0
                  : s[n];
...
function S(e) {
    let { context: t, filters: n, options: o, allowFetch: c } = e,
        u = "channel" === t.type ? t.channel.guild_id : null,
        d = (0, i.e7)([a.Z], () => a.Z.getGuild(u), [u]),
        {
            descriptors: _,
            commands: h,
            sectionedCommands: E,
            loading: b,
        } = (0, l.JK)(t, d, n, g(m({}, o), { allowFetch: c })),
        [y, O] = r.useState(null),
        v = r.useMemo(() => {
            var e;
...
function T(e, t) {
    ...
    return r.useMemo(() => {
        if (null != t) {
            var e, r, a, o;
            for (let s of Object.values(null != (a = null == (e = n.result) ? void 0 : e.sections) ? a : {}).concat(
                Object.values(null != (o = null == (r = i.result) ? void 0 : r.sections) ? o : {}),
            )) {
                let e = s.commands[t];
                if (null != e)
                    return {
...
function C(e, t, n) {
    ...
    return r.useMemo(() => {
        var e, r, s, l, c, u;
        let f =
                null != (c = null == (r = i.result) || null == (e = r.sections) ? void 0 : e[t])
                    ? c
                    : null == (s = a.result)
                      ? void 0
                      : s.sections[t],
            p = Object.values(null != (u = null == f ? void 0 : f.commands) ? u : {})
                .map((e) =>
                    null == e.rootCommand
                        ? e
                        : (0, d.Z8)({
