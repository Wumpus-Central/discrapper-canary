...
function R() {
    ...
    return !(null != r && o()(r, n)) && N(null != (r = n) ? r : [], null != (t = null == (e = d.Z.settings.guildFolders) ? void 0 : e.guildPositions) ? t : []);
}
function P(e) {
...
function D(e) {
    ...
    if (o !== i.name) {
        let e = T.cloneNode(i);
        (s()(e.id === i.id, '[SORTED GUILDS] Replacement folder node must have same id.'), (e.name = o), T.replaceNode(i, e));
    }
    let a = T.getNode(t);
    if (null == a) return !1;
