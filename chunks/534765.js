            ...
            if (null != t) {
                if (t.isMultiUserDM())
                    return void (0, a.L3)(e, async () => {
                        ...
                        return (n) => (0, i.jsx)(e, { ...n, channel: t, selected: !1, widgetType: r.uss.TEXT_CHAT_V3 });
                    });
                if (t.isDM() && null != d)
                    return void (0, a.L3)(e, async () => {
                ...
                if (t.isModeratorReportChannel())
                    return void (0, a.L3)(e, async () => {
                        ...
                        return (n) => (0, i.jsx)(e, { ...n, channel: t, widgetType: r.uss.TEXT_CHAT_V3 });
                    });
                if ((0, s.ay)(t.type)) {
                    if (null == o) return;
                    (0, a.L3)(e, async () => {
                        let { default: e } = await n.e("21905").then(n.bind(n, 769192));
                        return (n) => (0, i.jsx)(e, { ...n, channel: t, guild: o, widgetType: r.uss.TEXT_CHAT_V3 });
                    });
                    return;
                }
                null != o &&
