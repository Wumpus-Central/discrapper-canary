...
let b = new s.h(
        (e) => [_(e.application_id), ...e.subscription_listings_ids.map(O)],
        (e) => e.id
    ),
    T = new s.h(
        (e) => [_(e.application_id), S(e.subscription_plans[0].id)],
        (e) => e.id
    ),
    h = new s.h(
        (e) => [g(e.applicationId, e.isValid(null, f.Z), e.guildId), I(e.isValid(null, f.Z), e.guildId)],
        (e) => e.id
    ),
    y = {},
    C = {};
