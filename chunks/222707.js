...
let u = (e) => {
        let { fractionalPremiumInfo: t, selectedPlanId: n, planGroup: l, premiumSubscription: a, isGift: s } = e,
            o = null != a && null != n && (0, r.Ge)(a, n, l);
        return t.isFractionalPremiumActive && (null == a || o) && !s && null != n && i.JM.has(n);
    },
    c = (e) => {
        let {
                selectedPlanId: t,
    ...
    d = () =>
        s.intl.formatToPlainString(o.default["h1i+H8"], { premiumGroupProductName: (0, a.DP)(), cooldownMonths: a.wl });
