"use strict";
n.d(t, { lx: () => K, TB: () => X, Wv: () => W, q1: () => z, kY: () => $ }), n(938796);
var i = n(665260),
    r = n(17928),
    s = n(155718),
    a = n(933958),
...
function W(e, t, n) {
    ...
    return !(
        ...
        (!i.ignoreStatus && L.A.getStatus() === j.clD.DND) ||
        A.NO.getSetting() ||
...
function K(e, t) {
    ...
    e.type === j.lAJ.THREAD_STARTER_MESSAGE && (o = y.A.getChannel(o?.parent_id));
    ...
    if (
        ...
        null == l ||
        null == u ||
        (o.type === j.rbe.GROUP_DM && e.type === j.lAJ.RECIPIENT_REMOVE) ||
        (B.areSlayerNotificationsSuppressed() && ((n = o).type === j.rbe.DM || null != n.linkedLobby)) ||
        !W(l, u, o, { ignoreStatus: s, ignoreSameUser: j.MRS.SELF_MENTIONABLE_SYSTEM.has(e.type) }) ||
        _.A.isMessageRequest(t)
    )
        return !1;
    if (!r) {
        let e = b.A.getChannelId(D.A.getGuildId());
        if (e === o.id || N.Ay.getCurrentSidebarChannelId(e) === o.id) return !1;
    }
    if (
    ...
    {
        let t = !C.OU.has(o.type) || R.A.getChannelId() === o.id;
...
function $(e, t) {
    ...
    e.type === j.lAJ.THREAD_STARTER_MESSAGE && (n = y.A.getChannel(n?.parent_id));
...
function X(e, t, n) {
    ...
    switch (e.type) {
        ...
        case j.rbe.PRIVATE_THREAD:
            ...
            t.type === j.lAJ.THREAD_STARTER_MESSAGE && null != d
                ? (o = q(o, d, y.A.getChannel(d.parent_id)))
                : (0, E.A)(t)
                  ? null != v.A.getGuild(e.getGuildId()) && (o = q(o, e, d))
                  : (o = q(o, e, d));
            break;
        case j.rbe.GROUP_DM:
    ...
    if ("message_reference" in t ? (0, c.m)(t) : (0, c.A)(t)) r = Y.intl.string(Y.t["9ddYKt"]);
        ...
        r =
            t.activity.type === j.xL.JOIN
                ? Y.intl.formatToPlainString(Z(e, Y.t.E8CgCh, Y.t.c6KHWJ, Y.t.Fy7rJN), {
                      user: a,
                      game: t.application.name,
                  })
                : t.activity.type === j.xL.JOIN_REQUEST
                  ? Y.intl.formatToPlainString(Z(e, Y.t["/TD0la"], Y.t["/TD0la"], Y.t["/TD0la"]), {
                        user: a,
                        game: t.application.name,
                    })
                  : "";
    else if (null != t.activity && t.activity.type === j.xL.LISTEN) {
        let t = Z(e, Y.t.SaDdmN, Y.t.qsODhp, Y.t.WeiMTW);
        ...
        0 !== _.length && e.type === j.rbe.DM && !n.bot && _.startsWith("> -# *"))
    )
