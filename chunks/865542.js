...
function nN() {
    let e = (0, D.vx)(),
        t = (0, z.y3)(),
        n = (0, t4.Vh)({ location: "TimeControlsRow" });
    function i() {
        (0, t1.openUserSettings)(t7.X.CONTENT_AND_SOCIAL_PANEL);
    }
    return (0, l.jsxs)(c.B, {
        direction: "vertical",
        gap: 0,
            ...
            (0, l.jsxs)(c.B, {
                ...
                children: [
                    ...
                    (0, l.jsx)(tY.$, {
                        ...
                        onClick: function () {
                            (0, t2.default)(), t3.A.openPrivateChannel({ recipientIds: e });
                        },
                        variant: "secondary",
                        size: "sm",
                    }),
...
function np() {
    let e = (0, z.y3)(),
        t = (0, z.tl)(),
        { handleTabChange: n } = k(),
        s = (0, t4.Vh)({ location: "TimeControlsRow" });
    return (
        i.useEffect(() => {
...
function n0() {
    return (0, l.jsxs)("div", {
        className: r()(nQ.aP, e5.a, nQ.dO, nQ.p2),
        children: [
            (0, l.jsxs)("div", {
                className: nQ.Np,
                children: [
...
let lg = {
    ...
    lv = { [C.u9.REQUESTS]: n4, [C.u9.ACTIVITY]: nI, [C.u9.CONTENT_AND_SOCIAL]: tF, [C.u9.DATA_AND_PRIVACY]: tz };
function lA() {
