...
function s(e, t, n) {
    ...
    for (let r = 0; r < t.length; r++) {
        ...
        if (null != s) {
            let { cache: e } = a;
            if ((null != e && null != (i = e.get(s[0])) && ((i = new c(i)).start = s.index), null == i)) {
                if (((i = new c(s, a.type)), null != a.validator && !a.validator(i))) continue;
...
class l {
    ...
    tokenize(e) {
        ...
        for (; n.length > 0; ) {
            ...
            null != e
                ? (null != r && "" !== r && s.push(new c(o(r.match(i), a), this._nonTokenType)),
                  (t = e),
                  s.push(e),
                  (a += t.length + r.length),
        ...
        return null != r && "" !== r && s.push(new c(o(r.match(i), a), this._nonTokenType)), s;
    }
    clearCache() {
...
class c {
    ...
    constructor(e, t) {
        if (
            ...
            var n;
            (this.match = [...e]),
                (this.start = "string" == typeof e ? 0 : null != (n = e.index) ? n : 0),
                (this.type = t);
