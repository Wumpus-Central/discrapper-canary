...
var l = n(627968),
    ...
    en = n(912579),
    el = n(176465);
let { INVITE_OPTIONS_FOREVER: ei, INVITE_OPTIONS_7_DAYS: es, INVITE_OPTIONS_UNLIMITED: ea } = B.Ay;
class er extends i.PureComponent {
    _scroller = null;
    _headerId = o().uniqueId();
    static defaultProps = { analyticsLocation: $.ThZ.GUILD_CREATE_INVITE_SUGGESTION, defaultMaxAge: es.value };
    componentDidMount() {
        let {
                inviteChannel: e,
                code: t,
            ...
            { maxAge: p, maxUses: x, temporary: m, flags: v } = h;
        if (i) {
            let n = e?.id;
            if (null == n) return;
        ...
        if (
            (g &&
                F.default.track($.HAw.INVITE_SUGGESTION_OPENED, {
                    location: l,
            ...
            d?.id != null ||
                F.default.track($.HAw.OPEN_MODAL, { type: "Instant Invite Modal", source: l, location: s });
    }
        ...
        if (
            ((e =
                null != s
                    ...
                    : null != a
                      ? et.intl.formatToPlainString(et.t.ZdK3dW, { applicationName: a.name })
                      : null != i
            ...
            if (null != e) {
                ...
                t = et.intl.format(et.t.MkSwTR, {
                    channelName: n,
                    channelNameHook: (t, n) =>
                        (0, l.jsxs)("span", { children: [(0, l.jsx)(e, { className: en.p }), t] }, n),
                });
            }
        }
        return n.features.has($.GuildFeatures.HUB)
            ? { title: et.intl.string(et.t.WhR38i), subtitle: et.intl.string(et.t.Ed4BMs) }
            : { title: e, subtitle: t };
    }
    renderFriendsBody() {
        ...
        return 0 === e.length
            ? {
                  ...
                  renderRow: () =>
                      (0, l.jsx)("div", {
                          className: en.Iq,
                          children: (0, l.jsx)(p.SGT, { children: et.intl.string(et.t.ojoWgX) }),
                      }),
                  rowHeight: 200,
              }
            : null == n
              ? {
                    ...
                    renderRow: () =>
                        (0, l.jsx)("div", {
                            className: en.Iq,
                            children: (0, l.jsx)(p.SGT, { children: et.intl.string(et.t.hzPwGG) }),
                        }),
                    rowHeight: 200,
                }
              : null != t
    ...
    getBodyContent() {
        ...
        return (
            null != n ? (o = et.intl.string(et.t.CXpS1I)) : null != i && (o = et.intl.string(et.t.ueCrHB)),
            {
                bodyContent: (0, l.jsxs)(l.Fragment, {
                    children: [
                        (0, l.jsx)(p.Text, { className: en.Sv, variant: "text-sm/normal", children: o }),
                        (0, l.jsx)(J.p, { ...this.props, setInviteFlags: this.handleSetInviteFlags, copyValue: s }),
                    ],
                }),
                controls: void 0,
                listProps: void 0,
            ...
            null != i
                ...
                : null != s
                  ...
                  : null != n
                    ...
                    : a?.isGuildStageVoice() && (e = et.intl.string(et.t["2frWa3"])),
                (d = (0, l.jsx)(p.D0$, {
                    label: e,
...
function eo(e) {
    ...
    return (0, l.jsxs)(p.DUT, {
        ...
        children: [
            ...
            (0, l.jsx)(p.abt, { size: "md", color: "currentColor", className: en.ep }),
        ],
    });
}
let ed = i.forwardRef(function (e, t) {
    let {
        ...
        { analyticsLocations: T } = (0, S.Ay)(v.A.INSTANT_INVITE_MODAL),
        M = (0, g.bG)([P.A, G.A, U.Ay, O.A], () => {
            if (null != n) return n;
            let e = P.A.getChannelId(),
                t = null == e || (0, ee.jq)(e) ? void 0 : G.A.getChannel(e);
            return (
                t?.isThread() && (t = G.A.getChannel(t.parent_id)),
                t?.guild_id === s.id && null != t && O.A.can($.xBc.VIEW_CHANNEL, t)
                    ? t
                    : U.Ay.getDefaultChannel(s.id, !0, $.xBc.CREATE_INSTANT_INVITE)
            );
        }, [n, s.id]),
        j = (0, f.Ay)(M),
        D = null;
    ...
    i.useEffect(() => {
        (0, x.t)({ omitUserIds: ec, guild: s, channel: n, applicationId: c, inviteTargetType: D }).catch($.FXj);
    }, [ec, n, s, c, D]);
    let [eA] = (0, y.A)(null != c ? [c] : []),
        ep = null != Q ? Q.code : void 0,
        eI = Q?.maxAge,
        ex = Q?.maxUses,
        em = Q?.temporary,
        ev = s.vanityURLCode,
        eS = null != ev && ev.length > 0,
        ey = !el && !M?.isGuildVocal() && eS,
        eE = Q?.flags ?? 0;
    ...
    let ef = i.useMemo(() => (ed ? (0, B.Gv)(Y, L) : null), [ed, Y, L]),
        ...
        eb = ed && !ey && !eo && !eu,
        { enabled: eM } = C.w.useExperiment({ guildId: s?.id, location: "acc417_3" }, { autoTrackExposure: eb }),
        { canCreateApplicationBypassInvites: ej, isManualApprovalGuild: eR } = (0, q.N)(s),
        eG = (eM && eb) || eR,
        { maxAge: eU, maxUses: eV, temporary: ew, savedMaxAge: eO, flags: eD, roleIds: eP } = e_,
        eL = !eG && ew,
        ...
        ez = i.useCallback(() => {
            ...
            0 === eV && 0 === eU && !eL && ey
                ...
                eU !== ei.value && eO !== ei.value && eC({ savedMaxAge: ei.value });
    ...
    let { enabled: eJ } = b.A.useExperiment({ guildId: s?.id, location: "InstantInvite" });
    return (0, l.jsx)(S.f5, {
        value: T,
        children: (0, l.jsx)(er, {
            ref: t,
