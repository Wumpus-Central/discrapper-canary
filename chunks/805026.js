...
let H = {
        ...
        villain: {
            ...
            baseColor: "#3D0109",
            styleKey: "villain",
            previewSoundURLs: [S.A, y.A, v.A, N.A],
        },
        solara: {
...
(H["robot-synthetic"] = j(H.robot, { name: C.default["Ur/62B"] })),
    (H["chords-2part"] = j(H.tunes, { name: C.default.TYbrfK })),
    (H["chords-choir"] = j(H.tunes, { name: C.default.OnZ6g9 })),
    (H["chords-dev"] = j(H.tunes, { name: C.default["2XH8tr"] })),
    (H["robot-dev"] = j(H.robot, { name: C.default.XhhSOi })),
    (H["ghost-dev"] = j(H.ghost, { name: C.default.KmHwvD })),
    (H["wobble-dev"] = j(H.ghost, { name: C.default["6PDpse"] })),
    (H["fan-dev"] = j(H.robot, { name: C.default["87aX+2"] })),
    (H["autotune-dev"] = j(H.tunes, { name: C.default.EYDrRx }));
