...
let H = {
        ...
        tunes: {
            ...
            baseColor: "#010A3C",
            styleKey: "tunes",
            previewSoundURLs: [y.A],
        },
        ghost: {
            name: N.default["lFIyM/"],
            iconURL: L.A,
            splashGradient:
        ...
        space_bunny: {
            ...
            baseColor: "#160935",
            styleKey: "spacebunny",
            previewSoundURLs: [A.A, I.A, T.A],
        },
        justus: {
            name: N.default.ZVrsKC,
            iconURL: x.A,
            splashGradient:
        ...
        villain: {
            ...
            baseColor: "#3D0109",
            styleKey: "villain",
            previewSoundURLs: [S.A, v.A, C.A, b.A],
        },
        solara: {
            name: N.default.ndNi1j,
            iconURL: F.A,
            splashGradient:
            ...
            baseColor: "#33240A",
            styleKey: "solara",
            previewSoundURLs: [E.A],
        },
        cave: {
            name: N.default.Xypb3z,
            iconURL: O.A,
            splashGradient:
...
(H["robot-synthetic"] = Y(H.robot, { name: N.default["Ur/62B"] })),
    (H["chords-2part"] = Y(H.tunes, { name: N.default.TYbrfK })),
    (H["chords-choir"] = Y(H.tunes, { name: N.default.OnZ6g9 })),
    (H["chords-dev"] = Y(H.tunes, { name: N.default["2XH8tr"] })),
    (H["robot-dev"] = Y(H.robot, { name: N.default.XhhSOi })),
    (H["ghost-dev"] = Y(H.ghost, { name: N.default.KmHwvD })),
    (H["wobble-dev"] = Y(H.ghost, { name: N.default["6PDpse"] })),
    (H["fan-dev"] = Y(H.robot, { name: N.default["87aX+2"] })),
    (H["autotune-dev"] = Y(H.tunes, { name: N.default.EYDrRx }));
