s.d(t, { A0: () => er, NI: () => en, Ay: () => eo, Tb: () => ei }), s(321073);
var a,
    i,
    r,
    n = s(627968),
...
let y = o.forwardRef((e, t) => {
    ...
    return (
        ...
        (0, n.jsx)("div", {
            className: A()(s, C.k),
            children: (0, n.jsx)(T.C, { ref: a, autoplay: !1, stateMachine: "State Machine 1", fit: "contain" }),
        })
    );
});
...
var ee = s(576765),
    ...
    es = s(909340),
    ea = s(455482),
    ei = (((a = {}).CONTAINED = "contained"), (a.OVERLAY = "overlay"), a),
    er = (((i = {}).SMALL = "small"), (i.MEDIUM = "medium"), (i.LARGE = "large"), i),
    en =
...
let eo = function () {
    let e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
        ...
        a = (0, P.X)("useBentoBoxes"),
        i = (0, v.A)({ analyticsLocations: t }),
        r = (0, h.A)({ scrollPosition: G._F.TRY_IT_OUT, analyticsLocations: t }),
        w = (0, o.useCallback)(() => {
            (0, S.openUserSettings)(E.X.PROFILE_PANEL, { analyticsLocations: t }, () =>
                (0, u.L)({ analyticsLocations: t }),
            );
        }, [t]),
        A = (0, o.useCallback)(() => {
            (0, g.A)({ subscriptionTier: V.pe.TIER_2, initialPlanId: V.gD.PREMIUM_GROUP_MONTH, analyticsLocations: t });
        }, [t]),
        T = (0, M.TM)(),
        C = O.A.getArticleURL(j.MVz.REFERRAL_PROGRAM),
        { shouldShowBonusOrbsUX: ei, multiplier: er } = (0, R.lk)(D.rE.NITRO_HOME_MARKETING),
        eo = o.useRef(null),
        ed = (0, f.l)("bento_box"),
        ec = {
            ...
            orbRewards: { thumbnail: ea.A, assetUrl: es.A },
            orbMultiplier: { thumbnail: $, assetUrl: T ? J : q },
            combinedOrbs: { thumbnail: $, assetUrl: T ? J : q },
            threePPromotions: { thumbnail: ed ? (0, n.jsx)(y, { ref: eo }) : Z, assetUrl: ed ? void 0 : Z },
        },
        el = {
            serverProfiles: {
                name: "serverProfiles",
            ...
            referralProgram: {
                ...
                description: X.intl.format(X.t.jRPQUH, { learnMoreLink: C }),
            ...
            displayNameStyles: {
                ...
                title: X.intl.string(K.default.ABtBDQ),
                description: X.intl.string(K.default.MFNXZh),
                descriptionCta: X.intl.string(X.t.jVcuVY),
            ...
            premiumGroup: {
                name: "premiumGroup",
                title: X.intl.formatToPlainString(W.default.VFEDDB, { premiumGroupProductName: (0, B.DP)() }),
                description: X.intl.formatToPlainString(W.default.WudmR3, {
                    totalSeats: B.aw,
                ...
                actions: [
                    {
                        variant: "primary",
                        text: X.intl.formatToPlainString(W.default.LwdrNi, { premiumGroupProductName: (0, B.DP)() }),
                        onClick: A,
                        icon: l.t,
                        iconPosition: "start",
                    },
                    {
                        ...
                        onClick: () => {
                            (0, c.openModalLazy)(async () => {
                                let { default: e } = await Promise.all([s.e("99709"), s.e("3370"), s.e("69595")]).then(
                                    s.bind(s, 526710),
                                );
            ...
            yourSpace: {
                ...
                onClick: () => {
                    {
                        let { openUserSettings: e } = s(766075);
            ...
            threePPromotions: {
                ...
                title: ed ? X.intl.string(X.t.E4U4SS) : X.intl.string(H.default.OlObRa),
                description: ed ? X.intl.string(X.t["B4uSy/"]) : X.intl.string(H.default["8Gl8gP"]),
                descriptionCta: ed ? X.intl.string(X.t.RzWDqY) : X.intl.string(H.default.HINTfJ),
                previewImage: ec.threePPromotions.thumbnail,
                videoUrl: ec.threePPromotions.assetUrl,
                onClick: () =>
                    (0, _.u)({ analyticsLocations: t, partnerIds: [I.KS, I.Cs, I.XY, ...(ed ? ["xbox"] : [])] }),
                badgeText: ed ? void 0 : X.intl.string(X.t.y2b7CA).toLocaleUpperCase(),
                badgeVariant: "expressive",
                mediaRef: ed ? eo : void 0,
            },
            orbRewards: {
                name: "orbRewards",
                title: X.intl.string(F.default["ZFJ/NU"]),
                description: X.intl.string(F.default.wMi514),
                descriptionCta: X.intl.string(X.t.hvVgAZ),
                onClick: () => {
                    window.open(O.A.getArticleURL(j.MVz.ORBS_REWARDS_FAQ), "_blank");
                },
                previewImage: ec.orbRewards.thumbnail,
                previewImageStyle: "overlay",
                backgroundVideoUrl: ec.orbRewards.assetUrl,
                badgeText: ed ? void 0 : X.intl.string(X.t.oW0eUd).toLocaleUpperCase(),
                badgeVariant: "expressive",
            },
            orbMultiplier: {
                name: "orbMultiplier",
                title: X.intl.string(X.t.Csf5Ol),
                description: X.intl.format(X.t["G5k+lZ"], { bonusOrbMultiplier: er }),
                descriptionCta: X.intl.string(X.t.jVcuVY),
                onClick: () => (0, U.navigateToQuestHome)({ fromContent: d.u.NITRO_HOME_PERK_CARD }),
                badgeVariant: "expressive",
            ...
            combinedOrbs: {
                ...
                description: X.intl.format(X.t.djzJx6, { bonusOrbMultiplier: er }),
        ...
        em = (function (e) {
            let t = (0, x.YS)({ location: "bento_box" }).functionalityEnabled,
                { enabled: s } = Y.Ay.useConfig({ location: "bento_box" }),
                a = (0, k.O9)(),
                i = (0, N.DK)(L.W.NITRO, "useBentoBoxes"),
                r = i && e;
            return [
                ...(t || s ? [en.THREE_P_PROMOTIONS] : []),
                ...(r ? [en.COMBINED_ORBS] : []),
                ...(!r && e ? [en.ORB_MULTIPLIER] : []),
                ...(a ? [en.PREMIUM_GROUP] : []),
                ...(!r && i ? [en.ORB_REWARDS] : []),
        ...
        eu = em.slice(+!e, e ? 2 : 3);
    return (
        null != ef && eb.push([ep(ef)]),
        1 === eu.length ? eb.push([ep(eu[0])]) : 2 === eu.length && eb.push([ep(eu[0]), ep(eu[1])]),
        {
            whatsNewBoxes: [...eb],
