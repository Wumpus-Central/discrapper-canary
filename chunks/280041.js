...
var M = n(440005),
    ...
    z = n(864386),
    q = n(817577);
let X = "/assets/035ad0fba4997f3f.svg",
    Z =
...
let eo = function () {
    let e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
        ...
        s = (0, m.A)({ scrollPosition: H._F.TRY_IT_OUT, analyticsLocations: t }),
        O = (0, o.useCallback)(() => {
        ...
        D = (0, N.TM)(),
        L = v.A.getArticleURL(V.MVz.REFERRAL_PROGRAM),
        ...
        eu = {
            ...
            orbMultiplier: { thumbnail: J, assetUrl: D ? Z : Q },
            combinedOrbs: { thumbnail: J, assetUrl: D ? Z : Q },
            threePPromotions: { thumbnail: el ? (0, a.jsx)(w, { ref: eo }) : X, assetUrl: el ? void 0 : X },
        },
        ec = {
            serverProfiles: {
                name: "serverProfiles",
            ...
            threePPromotions: {
                ...
                title: el ? K.intl.string(K.t.E4U4SS) : K.intl.string(j.default.OlObRa),
                description: el ? K.intl.string(K.t["B4uSy/"]) : K.intl.string(j.default["8Gl8gP"]),
                descriptionCta: el ? K.intl.string(K.t.RzWDqY) : K.intl.string(j.default.HINTfJ),
                previewImage: eu.threePPromotions.thumbnail,
                videoUrl: eu.threePPromotions.assetUrl,
                onClick: () =>
                    (0, R.u)({ analyticsLocations: t, partnerIds: [C.KS, C.Cs, C.XY, ...(el ? ["xbox"] : [])] }),
            ...
            orbRewards: {
                ...
                onClick: () => {
                    window.open(v.A.getArticleURL(V.MVz.ORBS_REWARDS_FAQ), "_blank");
                },
