...
let T = l.forwardRef((e, t) => {
    ...
    return (
        ...
        (0, a.jsx)("div", {
            className: j()(i, D.k),
            children: (0, a.jsx)(M.C, { ref: r, autoplay: !1, stateMachine: "State Machine 1", fit: "contain" }),
        })
    );
});
T.displayName = "PremiumRewardsBentoBoxAsset";
var U = i(440005),
    y = i(26508),
    L = i(398523),
    k = i(881373),
...
let ed = function () {
    let e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
        ...
        N = (0, l.useCallback)(() => {
            (0, E.openUserSettings)(x.X.PROFILE_PANEL, { analyticsLocations: t }, () =>
        ...
        M = (0, A.TM)(),
        D = v.A.getArticleURL(H.MVz.REFERRAL_PROGRAM),
        ...
        eu = {
            ...
            orbMultiplier: { thumbnail: et, assetUrl: M ? q : ee },
            combinedOrbs: { thumbnail: et, assetUrl: M ? q : ee },
            threePPromotions: { thumbnail: ec ? (0, a.jsx)(T, { ref: ed }) : Q, assetUrl: ec ? void 0 : Q },
        },
        em = (0, I.Y)({ location: "bento_box" }),
        ep = (0, S.A)(!em),
        ef = {
            serverProfiles: {
                name: "serverProfiles",
            ...
            referralProgram: {
                ...
                description: X.intl.format(X.t.jRPQUH, { learnMoreLink: D }),
            ...
            threePPromotions: {
                ...
                onClick: () =>
                    (0, O.u)({
                        ...
                        partnerIds: [w.KS, w.Cs, w.XY, ...(ec ? ["xbox"] : [])],
                        isLocked: !0,
                    }),
            ...
            orbRewards: {
                ...
                onClick: () => {
                    window.open(v.A.getArticleURL(H.MVz.ORBS_REWARDS_FAQ), "_blank");
                },
    ...
    let eh = (function (e) {
            let t = (0, k.YS)({ location: "bento_box" }).functionalityEnabled,
                ...
                r = (0, B.O9)(),
                n = (0, y.DK)(U.W.NITRO, "useBentoBoxes"),
                s = n && e;
            return [
