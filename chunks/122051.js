...
function x(e) {
    let { guild: t, isExpanded: o, emptyFormFields: c, hasTermsField: s } = e,
        ...
        P = () => {
            (0, a.ZDy)(async () => {
                let { default: e } = await Promise.all([n.e('99916'), n.e('81038'), n.e('98077')]).then(n.bind(n, 645264));
                return (n) =>
                    (0, r.jsx)(
                        e,
                        v(h({}, n), {
...
function N(e) {
    ...
    let { guild: a, isClanContext: p = !1, onFieldsSave: y, onDescriptionSave: m, verificationForm: h } = e,
        ...
        S = null !== (t = (0, b.A)({ guildId: a.id })) && void 0 !== t ? t : 0,
        D = (0, s.e7)([d.Z], () => (null != h ? h : d.Z.get(a.id))),
        R = null !== (n = null == D ? void 0 : D.formFields) && void 0 !== n ? n : [];
    i.useEffect(() => {
