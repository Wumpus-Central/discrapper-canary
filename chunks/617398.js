...
function ed(e) {
    ...
    function s(n, r) {
        ...
        return (
            ...
            (o = o || /\w+/),
            n.keywords && (n.keywords = $(n.keywords, e.case_insensitive)),
    ...
    ey = function (e) {
        ...
        function b(e, t, i, a) {
            ...
            function d() {
                ...
                let t = P.keywordPatternRe.exec(L),
                    n = "";
                for (; t; ) {
                    ...
                    (e = P.keywordPatternRe.lastIndex), (t = P.keywordPatternRe.exec(L));
                }
            ...
            function f() {
                ...
                if ("string" == typeof P.subLanguage) {
                    if (!r[P.subLanguage]) return void x.addText(L);
                    (e = b(P.subLanguage, L, !0, D[P.subLanguage])), (D[P.subLanguage] = e._top);
            ...
            function O(e) {
                ...
                return (
                    r.skip ? (L += t) : (r.excludeBegin && (L += t), p(), r.returnBegin || r.excludeBegin || (L = t)),
                    m(r, e),
            ...
            function v(e) {
                ...
                P.endScope && P.endScope._wrap
                    ? (p(), _(n, P.endScope._wrap))
                    : P.endScope && P.endScope._multi
                      ? (p(), h(P.endScope, e))
                      : a.skip
                        ? (L += n)
                        : (a.returnEnd || a.excludeEnd || (L += n), p(), a.excludeEnd && (L = n));
                do P.scope && x.closeNode(), P.skip || P.subLanguage || (j += P.relevance), (P = P.parent);
                while (P !== i.parent);
            ...
            function T(n, r) {
                ...
                if ("begin" === I.type && "end" === r.type && I.index === r.index && "" === a) {
                    if (((L += t.slice(r.index, r.index + 1)), !s)) {
                        let t = Error(`0 width match regex (${e})`);
                        throw ((t.languageName = e), (t.badRule = I.rule), t);
                    }
                    return 1;
                }
                if (((I = r), "begin" === r.type)) return O(r);
                if ("illegal" !== r.type || i) {
                    if ("end" === r.type) {
                        let e = v(r);
                        if (e !== eE) return e;
            ...
            try {
                if (C.__emitTokens) C.__emitTokens(t, x);
                    ...
                    for (P.matcher.considerAll(); ; ) {
                        k++, U ? (U = !1) : P.matcher.considerAll(), (P.matcher.lastIndex = M);
        ...
        function A(e, t) {
            ...
            let [a, s] = i.sort((e, t) => {
                    ...
                    if (e.language && t.language) {
                        ...
                        else if (w(t.language).supersetOf === e.language) return -1;
                    }
                    return 0;
                }),
                o = a;
        ...
        B))
            "object" == typeof B[n] && t(B[n]);
        return Object.assign(e, B), e;
    },
    eO = ey({});
(eO.newInstance = () => ey({})), (e.exports = eO), (eO.HighlightJS = eO), (eO.default = eO);
