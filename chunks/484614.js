...
class d extends (r = s.PureComponent) {
    ...
    render() {
        ...
        let { text: n } = this.props,
            { mode: r } = this.state,
            s = r === a.kO8.Modes.SUCCESS ? c.intl.string(c.t['t5VZ8/']) : n;
        return (0, i.jsx)(
            a.kO8,
            ((e = (function (e) {
    ...
    constructor(e) {
        super(e), u(this, '_timeout', void 0), (this.state = { mode: a.kO8.Modes.DEFAULT }), (this._timeout = new o.V7()), (this.handleCopy = this.handleCopy.bind(this));
    }
}
