!(function (e, t) {
    ...
    function u(e, t) {
        var n = Math.max(e.top, t.top),
            ...
            s = a - i,
            o = r - n;
        return s >= 0 && o >= 0 && { top: n, bottom: r, left: i, right: a, width: s, height: o };
    }
    function c(e) {
        var t;
        try {
    ...
    (i.prototype.THROTTLE_TIMEOUT = 100),
        ...
        (i.prototype._unmonitorIntersections = function () {
            this._monitoringIntersections &&
                ...
                l(t, "scroll", this._checkForIntersections, !0),
        ...
        (i.prototype._checkForIntersections = function () {
            ...
            this._observationTargets.forEach(function (n) {
                var i = n.element,
                    ...
                    l = n.entry,
                    u = e && o && this._computeTargetAndRootIntersection(i, t),
                    d = (n.entry = new r({
                        time: a(),
                        target: i,
                ...
                l
                    ? e && o
                        ? this._hasCrossedThreshold(l, d) && this._queuedEntries.push(d)
            ...
            if ("none" != e.getComputedStyle(n).display) {
                for (var i = c(n), a = i, s = f(n), o = !1; !o; ) {
                    ...
                    if (
                        (s == this.root || s == t
                            ? ((o = !0), (l = r))
                            : s != t.body && s != t.documentElement && "visible" != d.overflow && (l = c(s)),
                        l && !(a = u(l, a)))
                    )
                        break;
                    s = f(s);
