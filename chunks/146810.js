    ...
    let {
        ...
        H = (0, f.i)((e) => {
            ...
            if (t.isPressed && t.target) {
                for (let n of (t.didFirePressStart && null != t.pointerType && V(P(t.target, e), t.pointerType, !1),
                (t.isPressed = !1),
                (t.isOverTarget = !1),
                ...
                (t.onPointerDown = (t) => {
                    ...
                    (t.onPointerUp = (t) => {
                        (0, _.bE)(t.currentTarget, (0, _.NI)(t.nativeEvent)) &&
                            ...
                            (0 !== t.button || e.isPressed || F(t, e.pointerType || t.pointerType));
                    }),
                    (t.onPointerEnter = (t) => {
                    ...
                    (t.onPointerLeave = (t) => {
                        t.pointerId === e.activePointerId &&
                            ...
                            e.isOverTarget &&
                            null != e.pointerType &&
                            ((e.isOverTarget = !1), V(P(e.target, t), e.pointerType, !1), Y(t));
                    });
                let n = (t) => {
