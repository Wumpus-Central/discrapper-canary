...
let s = (0, r.C)({
    ...
    defaultConfig: { enabled: !1, showBothNitroSkusInCategorySelect: !1, giftRecommendationAlgorithm: 0 },
    commonTriggerPoint: i.$G.DM_GDM_LIST_RENDER,
    treatments: [
        {
            id: 1,
            label: "Gift Collectibles in DM, with existing Nitro flow, showing popular items",
            config: { enabled: !0, showBothNitroSkusInCategorySelect: !1, giftRecommendationAlgorithm: 1 },
        },
        {
            id: 2,
            label: "Gift Collectibles in DM, with existing Nitro flow, showing recent items",
            config: { enabled: !0, showBothNitroSkusInCategorySelect: !1, giftRecommendationAlgorithm: 2 },
        },
        {
            id: 3,
            label: "Gift Collectibles in DM, select Nitro SKU from category, showing popular items",
            config: { enabled: !0, showBothNitroSkusInCategorySelect: !0, giftRecommendationAlgorithm: 1 },
        },
        {
            id: 4,
            label: "Gift Collectibles in DM, select Nitro SKU from category, showing recent items",
            config: { enabled: !0, showBothNitroSkusInCategorySelect: !0, giftRecommendationAlgorithm: 2 },
        },
    ],
});
