...
function H(e) {
    ...
    if (null != T && T.type === f.I.ACTIVITY_BOOKMARK)
        return (e) => {
            ...
            let { code: t, url: n } = T,
                ...
                c = (0, u.A)(),
                { currentChannelId: E, instanceId: f, isCurrentlyInInstance: g, canLaunchInChannel: A } = (0, m.t)(t);
            if (A)
                return (
                    !g &&
                    null != E &&
    ...
    if (null != w && H && null != Y)
        return (e) => {
            ...
            let n = I.Ay.getGuildScheduledEvent(Y.guildEventId);
            return null != n && (0, A.uR)({ eventId: n.id }), !0;
        };
