...
class y extends s.A {
    ...
    getCodecUsageStats(e, t) {
        ...
        if ("sender" === e || "streamer" === e) {
            ...
            return {
                ...
                codec_av1_encode_duration_sec: null != (s = m.get(p.Wn.AV1)) ? s : 0,
                codec_unknown_encode_duration_sec: null != (o = m.get(p.Wn.UNKNOWN)) ? o : 0,
            };
        }
        {
    ...
    getOutboundStats() {
        ...
        return (
            i().forEach(this.outboundStats, (t, n) => {
                var r, i, a, s, o;
                let l,
                    c = null == (o = this.connection) ? void 0 : o.getStreamParameters();
                c.length > 1 &&
                    c.forEach((e) => {
                ...
                e.push(
                    g(h({}, this.getStats(t)), {
                        ...
                        target_bitrate_network:
                            O > 0 ? Math.round(((null != (i = t.targetBytesNetwork) ? i : 0) * 8) / O) : 0,
    ...
    receivedStats(e, t, n) {
        ...
        (this.cameraDuration.value = this.connection.context === o.x.DEFAULT && null != t.camera),
            ...
            (this.cameraSendDuration.value = this.connection.context === o.x.DEFAULT && null != t.camera && u > 0),
            ...
            .forEach((t) => {
                ...
                if (null != r) {
                    ...
                    null == S &&
                        ...
                        (S = new p.ET(this.timestampProducer)),
                        (this.outboundStats[t] = S)),
                        null == S.timeToFirstFrame &&
                            (r.framesEncoded > 0 || (null != (i = r.frameRateInput) ? i : 0) > 0) &&
                            (S.timeToFirstFrame = Math.max(0, e - S.startTime)),
                        null != g && g >= 0 && this.videoEntropy.addSample(g);
                    let I = n.find((e) => e.ssrc === t);
                    var i,
                        a,
                        s,
                        c,
                    ...
                    if (this.connection.context === o.x.STREAM) {
                        var v = this.connection.getRemoteVideoSinkWants(t);
                        (null == v || 0 === v) &&
                            (null == I ? void 0 : I.quality) === h &&
                            (v = this.connection.getRemoteVideoSinkWants("any")),
                            (A = (null != v ? v : 0) > 0);
                    }
                    let T = this.videoStopped.value || !A;
                    if ((T !== S.isVideoStopped && S.setVideoStopped(T, p.iF.SenderStopped), !T)) {
                        S.appendAndIncrementStats(p.tH.parseOutboundStats(r, e)),
                            S.encoderCodec !== p.Wn.UNKNOWN && d.add(S.encoderCodec);
                        let t = null == I ? void 0 : I.maxBitrate;
                        S.appendTargetRates(
                            null == I ? void 0 : I.maxFrameRate,
                            null != (a = r.bitrateTarget)
                                ? a
                                : Math.min(null != (s = l.availableOutgoingBitrate) ? s : 0, null != t ? t : 0),
                            t,
                            l.availableOutgoingBitrate,
                        ),
                            (S.averageEncodeTime = null != (c = r.averageEncodeTime) ? c : 0),
                            (S.framesDroppedRateLimiter = null != (u = r.framesDroppedRateLimiter) ? u : null),
                            (S.framesDroppedEncoderQueue = null != (f = r.framesDroppedEncoderQueue) ? f : null),
                            (S.framesDroppedCongestionWindow =
                                null != (_ = r.framesDroppedCongestionWindow) ? _ : null),
                            (S.framesDroppedEncoder = null != (m = r.framesDroppedEncoder) ? m : null),
                ...
                i().forEach(t.rtp.inbound, (t, n) => {
                    ...
                    if (null != r) {
                        ...
                        this.statCollectionPausedUsers.has(n) ||
                            ...
                            t.decoderCodec !== p.Wn.UNKNOWN && f.add(t.decoderCodec),
                            null == t.timeToFirstFrame && r.framesDecoded > 0 && (t.timeToFirstFrame = e - t.startTime);
                    }
                }),
            0 !== d.size &&
                0 !== f.size &&
                ((0, a._)(d, f) ? this.symmetricCodecUpdates++ : this.asymmetricCodecUpdates++);
    }
