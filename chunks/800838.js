...
var b = d(695149),
    ...
    h = d(946204),
    W = d(452854);
d(40591), d(783159), d(812345), d(774605), d(856844), d(987467), d(508532), d(81799), d(133239), d(650361);
var G = d(107721);
d(953627);
var p = ({ className: l, ...t }) =>
        (0, e.v)("svg", {
    ...
    N = ({ onRetry: l, onContinue: t, attemptsRemaining: d, isBackSide: c }) => {
        let { t: Z } = (0, i.n)(),
            m = (0, e.l)(null);
        return (
            (0, e._)(() => {
            ...
            (0, e.v)(s.t, {
                ...
                children: [
                    (0, e.v)("div", {
                        ...
                        role: "alert",
                        children: [
                            (0, e.v)(p, { className: "IncodeIdExpiredIcon" }),
                            (0, e.v)(n.t, {
                                ref: m,
                                tabIndex: -1,
                                className: "IncodeIdExpiredTitle",
                                children: Z("idv2.capture.notifications.expiredId"),
                            }),
                            (0, e.v)(a.r, { size: 12 }),
                            (0, e.v)("p", {
                                ...
                                children: Z(
                                    c
                                        ? "idv2.digitalIdUpload.wrongDocumentTypeScreen.errorSubtitle"
                                        : "idv2.capture.expiredId.pleaseTryWithADifferentId",
                                ),
                            }),
                            (0, e.v)(a.r, { size: 80 }),
                            void 0 !== d
                                ? (0, e.v)("p", {
                                      ...
                                      children: `${d} ${Z("idv2.capture.processing.attemptsRemainingLabel")}`,
                                  })
                                : null,
                        ],
                    }),
                    (0, e.v)("div", {
                        ...
                        children: l
                            ? (0, e.v)(b.t, {
                                  ...
                                  children: Z("idv2.capture.processing.tryAgain"),
                              })
                            : t
                              ? (0, e.v)(b.t, {
                                    variant: "primary",
                                    ...
                                    children: Z("idv2.capture.processing.continue"),
                                })
                              : null,
                    }),
                ],
    ...
    M = d(389956);
d(722135);
var X = ({ children: l, "aria-labelledby": t, class: d }) =>
        (0, e.v)("div", {
            ...
            children: (0, e.v)("div", {
                ...
                children: (0, e.v)("div", { class: "IncodeOverlayBody", children: l }),
            }),
        }),
    r = ({ progress: l, label: t, className: d, labelledById: i }) =>
        (0, e.v)("div", {
            ...
            children: [
                (0, e.v)("div", {
                    ...
                    "aria-valuemin": 0,
                    "aria-valuemax": 100,
                    "aria-label": i ? void 0 : t,
                    "aria-labelledby": i,
                    children: (0, e.v)("div", { class: "IncodeProgressBarFill", style: { width: `${l}%` } }),
                }),
                t
                    ? (0, e.v)(e.x, {
                          children: [
                              (0, e.v)(a.r, { size: 24 }),
                              (0, e.v)("p", { class: "IncodeProgressBarLabel", children: t }),
                          ],
                      })
                    : null,
            ],
    ...
    V = (l) => {
        if (!l) return T;
        let t = y.exec(l);
        return t ? { yyyy: t[1], mm: t[2], dd: t[3] } : T;
    },
    L = ({ mm: l, dd: t, yyyy: d }) => {
        ...
        return ((l, t, d) => {
            ...
            ? `${d}-${String(e).padStart(2, "0")}-${String(c).padStart(2, "0")}`
            : "";
    },
    I = { mm: { min: 1, max: 12, pad: 2 }, dd: { min: 1, max: 31, pad: 2 }, yyyy: { min: 1, max: 9999, pad: 4 } },
    z = { mm: 1, dd: 3, yyyy: 9 },
    w = (l, t) => String(t).padStart(I[l].pad, "0");
(0, e.a)(
    (
        {
            id: l,
        ...
        let { i18n: g } = (0, i.n)(),
            ...
            U = "string" == typeof S ? S : "string" == typeof R ? R : void 0,
            F = (0, e.l)(null),
            O = (0, e.l)(null),
        ...
        let v = `${l}-label`,
            ...
            P = (0, e.d)(() => {
                ...
                return `Date format: ${D.map((t) => l[t]).join(", ")}.`;
            }, [D]),
            f = [Q, !W && Z ? K : null, !W && s ? H : null].filter(Boolean).join(" "),
            B = (l) => {
                let t = L(l),
                    d = F.current;
                d && (d.value = t);
            ...
            lt = (l) => {
                if (M) return void l.preventDefault();
                let t = F.current;
                if (t) {
                    try {
                        t.click();
            ...
            ld = !!L(k),
            li = !!s,
            le = t ? { "aria-labelledby": v } : c ? { "aria-label": c } : {},
            lc = {
        ...
        return (0, e.v)("div", {
            class: (0, a.n)("IncodeInputComposed IncodeSegmentedDateInput", G),
            children: [
                t &&
                    (0, e.v)("label", {
                        id: v,
                    ...
                    children: [
                        (0, e.v)("div", {
                            ...
                            class: (0, a.n)(
                                ...
                                li && "IncodeSegmentedDateInputField--invalid",
                                M && "IncodeSegmentedDateInputField--disabled",
                            ),
                            "data-has-value": ld ? "true" : void 0,
                            "data-disabled": M ? "true" : void 0,
                            "aria-invalid": li ? "true" : void 0,
                            ...
                            children: D.map((t, d) =>
                                (0, e.v)(
                                    e.x,
                                    {
                                        children: [
                                            ((t) => {
                                                let { maxLen: d, placeholder: i, ariaLabel: c } = lc[t];
                                                return (0, e.v)("input", {
                                                    ref: (l) => {
                                                        J[t].current = l;
                                                    },
                                                    ...
                                                    onInput: (l) => {
                                                        let i = l.target,
                                                            e = i.value.replace(/\D/g, "").slice(0, d),
                                                            c = !1;
                                                        if (
                                                            (1 === e.length &&
                                                                Number(e) > z[t] &&
                                                    ...
                                                    onKeyDown: (l) => {
                                                        ...
                                                        if ("ArrowUp" === l.key || "ArrowDown" === l.key) {
                                                            ...
                                                            ("ArrowLeft" === l.key && 0 === i)
                                                                ? (l.preventDefault(), _(j.prev[t]))
                                                                : "ArrowRight" === l.key && i === d.value.length
                                                                  ? (l.preventDefault(), _(j.next[t]))
                                                                  : ("/" === l.key || "-" === l.key || " " === l.key) &&
                                                                    (d.value.length > 0
                                                                        ? (l.preventDefault(), _(j.next[t]))
                                                                        : l.preventDefault());
                        ...
                        children: [
                            n &&
                                (0, e.v)("div", {
                                    ...
                                    children: (0, e.v)(m.t, { size: 16 }),
                                }),
                            (0, e.v)("p", { id: H, class: "IncodeInputComposedError", children: s }),
                        ],
                    }),
                !W &&
                    Z &&
                    ...
                    (0, e.v)("div", {
                        ...
                        children: [
                            b &&
                                (0, e.v)("div", {
                                    class: "IncodeInputComposedIconWrapper",
                                    children: (0, e.v)(u.t, { size: 16 }),
                                }),
                            (0, e.v)("p", { id: K, class: "IncodeInputComposedHelper", children: Z }),
                        ],
                    }),
            ],
        });
...
var R = (0, e.a)((l, t) => {
    let { class: d, rows: i = 4, ...c } = l;
    return (0, e.v)("textarea", { ...c, ref: t, rows: i, class: (0, a.n)("IncodeTextArea", d) });
});
function S({ children: l }) {
    return (0, e.v)("div", { class: "IncodeVerificationOptionCardList", children: l });
}
function C({ icon: l, title: t, testId: d, onClick: i, tag: c }) {
    return (0, e.v)("button", {
        type: "button",
            ...
            (0, e.v)("span", {
                ...
                children: [
                    (0, e.v)("span", {
                        ...
                        children: [
                            (0, e.v)("span", { class: "IncodeVerificationOptionCardTitle", children: t }),
                            c && (0, e.v)(x, { label: c }),
                        ],
                    }),
                    (0, e.v)("span", {
                        ...
                        children: (0, e.v)(o.s, { size: 24, variant: "m" }),
                    }),
                ],
            }),
        ],
...
function x({ label: l }) {
    return (0, e.v)("div", {
        ...
        children: [(0, e.v)(o.t, {}), (0, e.v)("span", { children: l })],
    });
}
(0, e.a)(
    (
        ...
        let p = `${l}-helper`,
            N = `${l}-error`,
            M = [n ? p : null, c ? N : null].filter(Boolean).join(" ");
        return (0, e.v)("div", {
                        ...
                        children: [
                            s &&
                                (0, e.v)("div", {
                                    ...
                                    children: (0, e.v)(m.t, { size: 17 }),
                                }),
                            (0, e.v)("p", { id: N, class: "IncodeTextAreaComposedError", children: c }),
                        ],
                    }),
                n &&
                    !c &&
                    (0, e.v)("div", {
                        ...
                        children: [
                            Z &&
                                (0, e.v)("div", {
                                    class: "IncodeTextAreaComposedIconWrapper",
                                    children: (0, e.v)(u.t, { size: 17 }),
                                }),
                            (0, e.v)("p", { id: p, class: "IncodeTextAreaComposedHelper", children: n }),
                        ],
                    }),
            ],
        });
...
var g = ({ children: l, className: t }) => (0, e.v)("div", { class: (0, a.n)("IncodeCameraOverlay", t), children: l }),
    D = ({ title: l, subtitle: t, visible: d = !0, className: i, titleId: c }) => {
        let s = (0, e.l)(null);
        return (
            (0, e._)(() => {
                s.current?.focus();
            ...
            (0, e.v)("div", {
                ...
                children: [
                    ...
                    (0, e.v)("p", { class: "IncodeCameraOverlayHeaderSubtitle", children: t }),
                ],
            })
        );
    },
        ...
        return (0, e.v)("div", {
            ...
            children: [
                (0, e.v)("div", {
                    ...
                    children: [
                        (0, e.v)(o.r, { className: "IncodeCaptureFooterEncryptionIcon" }),
                        (0, e.v)("span", { children: m ?? h("v2.capture.label") }),
                    ],
                }),
                d && t
                    ? (0, e.v)("div", {
                          ...
                          children: [
                              ...
                              (0, e.v)("button", {
                                  ...
                                  onClick: t,
                                  "aria-label": c ?? h("manualCapture.ariaLabel"),
                                  "aria-describedby": a,
    ...
    J = ({ className: l }) =>
        (0, e.v)("svg", {
            ...
            "aria-hidden": "true",
            children: [
                (0, e.v)("circle", { cx: "32", cy: "32", r: "32", fill: "#14151A" }),
                (0, e.v)("path", {
    ...
    k = ({ open: l, onClose: t, onTakeManually: d, portalContainer: c }) => {
        let { t: a } = (0, i.n)(),
            s = (0, e.h)((l) => {
                l?.focus();
            }, []);
        return (0, e.v)(h.t.Root, {
            open: l,
            onOpenChange: (l) => {
                l || t();
            },
            ...
            hasBackdrop: !1,
            portalContainer: c ?? void 0,
            manageInitialFocus: !1,
            children: (0, e.v)(h.t.Content, {
                class: "IncodeCommonIssuesContent",
                children: [
                    (0, e.v)(h.t.Icon, { class: "IncodeCommonIssuesQuestionIcon", children: (0, e.v)(J, {}) }),
                    (0, e.v)(h.t.TitleSection, {
                        children: (0, e.v)(n.t, {
    ...
    E = ({ orientation: l, mode: t, state: d, children: i, className: c }) => {
        ...
        return (0, e.v)(s.t, {
            ...
            children: (0, e.v)("div", {
                ...
                children: (0, e.v)("div", {
                    ...
                    children: [
                        n && (0, e.v)("div", { class: "IncodeIdProcessingTopArea", children: n }),
                        (0, e.v)(E, {
                            orientation: t,
                            mode: "id" === d ? "front" : d,
                            state: c,
                            children: [
                                (0, e.v)("img", {
                                    ...
                                    class: (0, a.n)(
                                        ...
                                        m ? "IncodeIdProcessingImageBlurred" : void 0,
                                    ),
                                }),
                                b &&
                                    (0, e.v)("div", {
                        ...
                        (0, e.v)("div", {
                            ...
                            children: [
                                (0, e.v)("div", {
                                    ...
                                    children: [
                                        (0, e.v)(o.r, { className: "IncodeCaptureEncryptionIcon" }),
                                        (0, e.v)("span", { children: u("v2.capture.label") }),
                                    ],
                                }),
                                Z,
                            ],
    ...
    K = ({ imageUrl: l, progress: t, orientation: c, mode: a, blurImage: s }) => {
        let { t: Z } = (0, i.n)(),
            b = (0, e.l)(null),
            m = "vertical" !== c || "passport" === a,
            [o, u] = (0, e.p)(null);
        return (
            (0, e._)(() => {
                b.current?.focus();
            ...
            (0, e._)(() => {
                m
                    ? d
                          .e("2081")
                          .then(d.bind(d, 327320))
                          .then((l) => {
                              u(l.default);
                          })
                    : Promise.resolve()
                          .then(d.bind(d, 419588))
                          .then((l) => l.n)
                          .then((l) => {
                              u(l.default);
                          });
            ...
            (0, e.v)(v, {
                ...
                blurImage: s,
                topContent: (0, e.v)("div", {
                    class: "IncodeAnalyzingContent",
                    children: [
                        (0, e.v)(r, { progress: t, labelledById: "analyzing-title" }),
                        (0, e.v)(n.t, {
                            ref: b,
                            id: "analyzing-title",
                            className: "IncodeAnalyzingTitle",
                            tabIndex: -1,
                            children: Z("idv2.capture.processing.analyzing"),
                        }),
                    ],
                }),
                overlayContent: o
                    ? (0, e.v)(W.i, { animationData: o, loop: !0, autoStop: !0, className: "IncodeAnalyzingLottie" })
                    : null,
            })
        );
    },
        ...
        return (
            ...
            (0, e.v)(v, {
                ...
                topContent: (0, e.v)("div", {
                    ...
                    children: [
                        "success" === l
                            ? (0, e.v)(H, { className: "IncodeIdProcessingResultIcon" })
                            : (0, e.v)(p, { className: "IncodeIdProcessingResultIcon" }),
                        (0, e.v)(a.r, { size: 16 }),
                        s &&
                            (0, e.v)(n.t, {
                                ref: G,
                        ...
                        Z &&
                            (0, e.v)(e.x, {
                                children: [
                                    (0, e.v)(a.r, { size: 12 }),
                                    (0, e.v)("p", { class: "IncodeIdProcessingResultSubtitle", children: Z }),
                                ],
                            }),
                    ],
                }),
                bottomContent: (0, e.v)("div", {
                    ...
                    children: [
                        void 0 !== u &&
                            ...
                            (0, e.v)("p", {
                                ...
                                children: W("v2.idError.attemptsLeft", { count: u }),
                            }),
                        (0, e.v)(b.t, { onClick: o, "data-testid": "retry-button", children: m }),
                    ],
                }),
            })
        );
    },
    P = ({ manager: l, state: t, blurImage: d }) => {
        let { t: c } = (0, i.n)();
        ...
        return (0, e.v)(Q, {
            ...
            mode: a,
            title: c("idv2.capture.processing.successTitle"),
            subtitle: c(
                t.needsBackCapture
    ...
    f = ({ manager: l, state: t, blurImage: d, ...c }) => {
        let { t: a } = (0, i.n)();
        if ("error" === t.status)
            return (0, e.v)("div", {
                class: "IncodeIdError",
                role: "alert",
                children: [
                    (0, e.v)("div", { class: "IncodeIdErrorMessage", children: t.error }),
                    (0, e.v)(b.t, {
                        onClick: () => l.reset(),
    ...
    B = ({ manager: l, attemptsRemaining: t, isBackSide: d }) =>
        (0, e.v)(N, { onRetry: () => l.retryCapture(), attemptsRemaining: t, isBackSide: d }),
    A = ({ manager: l }) => {
        let { t } = (0, i.n)(),
            d = (0, e.l)(null);
        return (
            ...
            (0, e.v)(s.t, {
                ...
                children: [
                    (0, e.v)("div", {
                        ...
                        role: "alert",
                        children: [
                            (0, e.v)(p, { className: "IncodeIdNoAttemptsIcon" }),
                            (0, e.v)(n.t, {
                                ref: d,
                                tabIndex: -1,
...
function q(l) {
    $ ||
        (($ = !0),
        Promise.all([
            d.e("26362").then(d.bind(d, 668961)),
            d.e("22715").then(d.bind(d, 54070)),
            d.e("23316").then(d.bind(d, 646719)),
            d.e("95020").then(d.bind(d, 491079)),
            d.e("38621").then(d.bind(d, 443468)),
        ])
            .then(([t, d, i, e, c]) => {
...
var ll = ({ detectionStatus: l, mode: t, isCapturing: d }) => {
        let { t: c } = (0, i.n)(),
            s = (function (l, t) {
                let { t: d } = (0, i.n)(),
                    [, c] = (0, e.p)(0);
                ...
                if ("wrongSide" === l) {
                    ...
                    return {
                        ...
                        animationData: _.get(l ? "back" : "front") ?? null,
                    };
                }
                return null;
            })(l, t),
            n = (0, e.l)(null),
            Z = (0, e.l)({ message: "", at: 0 }),
            b = (0, e.l)(l),
            m = (0, e.l)(!1),
            o = (0, e.l)(),
            u = (0, e.l)(),
            h = "detecting" === l || "idNotDetected" === l || "manualCapture" === l,
            G = "manualCapture" === l,
            p = "wrongSide" === l,
            N = "farAway" === l,
            M = "glare" === l,
            ...
            y = (0, e.h)(
                () =>
                    "passport" === t
                        ? c("idv2.capture.fillFramePassport")
                        : "back" === t
                          ? c("idv2.capture.fillFrameBack")
                          : c("idv2.capture.fillFrameFront"),
                [t, c],
            );
        return (
            (0, e._)(() => {
            ...
            (0, e._)(() => {
                if (!d) {
                    if (p) {
                        ...
                        r(`${c(`${l}.title`)}. ${c(`${l}.description`)}`);
                        return;
                    }
                    if (N) return void r(`${c("idv2.capture.notifications.notAligned.title")}.`);
                    if (M) return void r(`${c("idv2.capture.notifications.glare.title")}.`);
                    if (X) return void r(`${c("idv2.capture.notifications.blur.title")}.`);
                    h && m.current && r(y());
                }
            }, [r, X, d, N, M, h, p, t, c, y]),
            (0, e._)(
            ...
            (0, e.v)(e.x, {
                children: [
                    (0, e.v)("div", { ref: n, class: "IncodeSrOnly", "aria-live": "assertive", "aria-atomic": "true" }),
                    s
                        ? (0, e.v)("div", {
                              ...
                              children: (0, e.v)("div", {
                                  ...
                                  children: [
                                      ...
                                      (0, e.v)(a.r, { size: 16, direction: "horizontal" }),
                                      s.animationData &&
                                          (0, e.v)("div", {
                                              class: "IncodeIdCaptureNotificationAnimation",
                                              children: (0, e.v)(W.i, { animationData: s.animationData, loop: !0 }),
                                          }),
                                  ],
                              }),
                          })
    ...
    lt = (0, e.c)(() => d.e("33869").then(d.bind(d, 757468))),
    ld = (0, e.c)(() => d.e("3206").then(d.bind(d, 856197))),
    li = (0, e.c)(() => d.e("58377").then(d.bind(d, 388176))),
    le = (0, e.c)(() => d.e("82727").then(d.bind(d, 27898))),
    lc = (0, e.c)(() => d.e("47618").then(d.bind(d, 547910))),
    la = (0, e.c)(() => d.e("22222").then(d.bind(d, 576349))),
                ...
                y =
                    s || "capturing" === d
                        ...
                        : "blur" === d || "glare" === d || "wrongSide" === d || "farAway" === d
                          ...
                          : "idle",
                Y = "passport" === l,
                T = "vertical" !== t || Y ? "horizontal" : "vertical",
                V = n && !M,
                L = (0, e.v)("div", {
                    ...
                    children: (0, e.v)("ol", {
                        ...
                        children: [
                            (0, e.v)("li", {
                                children: h(Y ? "idv2.commonIssues.firstStepPassport" : "idv2.commonIssues.firstStep"),
                            }),
                            (0, e.v)("li", { children: h("idv2.commonIssues.secondStep") }),
                        ],
                    }),
                });
            return (0, e.v)(g, {
                ...
                children: [
                    (0, e.v)("div", {
                        ...
                        children: [
                            (0, e.v)(ll, { detectionStatus: d, mode: l, isCapturing: s }),
                            (0, e.v)(D, {
                                title: r?.title ?? "",
                                subtitle: r?.subtitle,
                                visible: null !== r,
                    ...
                    (0, e.v)(G.n, {
                        ...
                        orientation: T,
                        frameState: y,
                        className: (0, a.n)(Y && "IncodeCaptureFramePassport"),
                        children: [
                            s && c > 0 && (0, e.v)("div", { class: "IncodeCaptureCounter", children: c }),
                            p && (0, e.v)(lZ, { mode: l, orientation: t ?? "horizontal", onAnimationEnd: () => N(!1) }),
                        ],
                    }),
                    (0, e.v)("div", {
                        class: "IncodeSrOnly",
                    ...
                    (0, e.v)(j, {
                        ...
                        helpButtonRef: m,
                        captureButtonRef: o,
                        captureAriaDescribedBy: V ? "manual-capture-tooltip" : void 0,
                        children: V
                            ? (0, e.v)("div", {
                                  class: "IncodeIdManualCaptureTooltipContainer",
                                  onAnimationEnd: (l) => {
                                      "manualCaptureTooltipExit" === l.animationName && X(!0);
                                  },
                                  children: L,
                              })
                            : null,
    ...
    lm = ({ manager: l, state: t }) => {
        ...
        return "success" === t.captureStatus && t.previewImageUrl
            ? (0, e.v)(P, { manager: l, state: t, blurImage: t.ageAssurance })
            : "uploadError" === t.captureStatus && t.previewImageUrl
              ? (0, e.v)(f, { manager: l, state: t, blurImage: t.ageAssurance })
              : (0, e.v)(lo, { manager: l, state: t });
    },
    ...
    lu = ({ manager: l, state: t }) => {
        ...
        (0, e._)(() => {
            m
                ...
                : o
                  ? d
                        .e("55796")
                        .then(d.bind(d, 477279))
                        .then((l) => {
                            b(l.default);
                        })
                  : d
                        .e("27025")
                        .then(d.bind(d, 253160))
                        .then((l) => {
                            b(l.default);
                        });
        }, [m, o]);
        let u = c(m ? "idv2.capture.passport.title" : o ? "idv2.backTutorial.title" : "idv2.tutorial.title"),
        ...
        return (0, e.v)(W.r, {
            ...
            subtitle: h,
            onContinue: p,
            buttonText: c("idv2.tutorial.startScan"),
            disclaimerText: G,
            isLoading: s,
        ...
        digitalIdUpload: {
            ...
            icon: () =>
                (0, e.v)("svg", {
                    ...
                    children: [
                        (0, e.v)("title", { children: "Digital ID Icon" }),
                        (0, e.v)("g", {
                        ...
                        (0, e.v)("defs", {
                            children: [
                                (0, e.v)("linearGradient", {
                                    ...
                                    gradientUnits: "userSpaceOnUse",
                                    children: [
                                        (0, e.v)("stop", { "stop-color": "#B1B1B1" }),
                                        (0, e.v)("stop", { offset: "1", "stop-color": "white" }),
                                    ],
                                }),
                                (0, e.v)("linearGradient", {
                                    ...
                                    gradientUnits: "userSpaceOnUse",
                                    children: [
                                        (0, e.v)("stop", { offset: "0.171875", "stop-color": "#BDBDBD" }),
                                        (0, e.v)("stop", { offset: "0.640625", "stop-color": "#E1E1E1" }),
                                        (0, e.v)("stop", { offset: "1", "stop-color": "#DDDDDD" }),
                                    ],
                                }),
                                (0, e.v)("linearGradient", {
                                    ...
                                    gradientUnits: "userSpaceOnUse",
                                    children: [
                                        (0, e.v)("stop", { offset: "0.0416667", "stop-color": "#B5B5B5" }),
                                        (0, e.v)("stop", { offset: "0.362488", "stop-color": "#E2E2E2" }),
                                        (0, e.v)("stop", { offset: "1", "stop-color": "white" }),
                                    ],
                                }),
                                (0, e.v)("linearGradient", {
                                    ...
                                    gradientUnits: "userSpaceOnUse",
                                    children: [
                                        (0, e.v)("stop", { "stop-color": "#E0E0E0" }),
                                        (0, e.v)("stop", { offset: "1", "stop-color": "white" }),
                                    ],
                                }),
                                (0, e.v)("clipPath", {
                                    id: "clip0_25823_31181",
                                    children: (0, e.v)("rect", { width: "118", height: "86", fill: "white" }),
                                }),
                                (0, e.v)("clipPath", {
        ...
        digitalId: {
            icon: () =>
                (0, e.v)("svg", {
                    ...
                    children: [
                        (0, e.v)("title", { children: "Mobile Driver License icon" }),
                        (0, e.v)("g", {
                        ...
                        (0, e.v)("defs", {
                            children: [
                                ...
                                (0, e.v)("clipPath", {
                                    id: "clip0_26265_2591",
                                    children: (0, e.v)("rect", { width: "60", height: "60", fill: "white" }),
                                }),
                                (0, e.v)("clipPath", {
                                    id: "clip1_26265_2591",
                                    children: (0, e.v)("rect", {
        ...
        manualIdUpload: {
            ...
            icon: () =>
                (0, e.v)("svg", {
                    ...
                    children: [
                        (0, e.v)("title", { children: "Upload document" }),
                        (0, e.v)("rect", {
                            x: "5.51713",
                            y: "15.51",
                            width: "50.4685",
    ...
    lG = ({ manager: l, direction: t }) => {
        let [c, s] = (0, e.p)(null),
            [b, m] = (0, e.p)(!1),
            { t: o } = (0, i.n)();
        (0, e._)(() => {
            d.e("24219")
                .then(d.bind(d, 667062))
                .then((l) => {
                    s(l.default);
                });
        }, []);
            ...
            : c
              ? (0, e.v)("div", {
                    ...
                    children: [
                        ...
                        (0, e.v)(a.r, { size: 32 }),
                        (0, e.v)(W.i, { animationData: c, loop: !1, reverse: "toFront" === t, onComplete: u }),
                    ],
                })
              : null;
    };
