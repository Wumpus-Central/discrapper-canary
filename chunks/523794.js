...
function p(t) {
    ...
    let e,
        ...
        D = d.Z.can(o.yP, p);
    e = f && (null == C ? void 0 : C.premiumTier) === _.Eu4.TIER_3 ? (O <= _.TU7 ? E.intl.string(E.t.tJmOu7) : E.intl.string(E.t['7FHbPD'])) : m ? E.intl.string(E.t['8/uDSE']) : E.intl.string(E.t['7FHbPD']);
    let h = () => {
            (S(),
