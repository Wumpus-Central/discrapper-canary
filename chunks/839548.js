...
class d extends o.Z {
    ...
    setConnectionState(e) {
        this.logger.info("Connection state change: ".concat(this.connectionState, " => ").concat(e)),
            ...
            this.emit(a.S.ConnectionStateChange, this.connectionState);
    }
    updateVideoQuality(e) {
        ...
        null != o &&
            ((s[r].maxBitrate = o.bitrateMax),
            (s[r].minBitrate = o.bitrateMin),
            (s[r].targetBitrate = null != (t = o.bitrateTarget) ? t : 0),
            null != o.encode && ((s[r].maxPixelCount = o.encode.pixelCount), (s[r].maxFrameRate = o.encode.framerate))),
        ...
        for (let e = 0; e < this.videoStreamParameters.length; e++) {
            ...
            null != t &&
                ...
                100 === this.videoStreamParameters[e].quality && ((a = i), (o = t));
        }
    ...
    constructor(e, t) {
        super(),
            c(this, "mediaEngineConnectionId", "WebRTC-".concat(u++)),
            c(this, "context", void 0),
            c(this, "userId", void 0),
            c(this, "streamUserId", void 0),
            c(this, "destroyed", !1),
            c(this, "audioSSRC", 0),
            c(this, "videoSSRC", 0),
            c(this, "selfDeaf", !1),
            c(this, "selfMute", !1),
            c(this, "localMutes", {}),
            c(this, "disabledLocalVideos", {}),
            c(this, "localVolumes", {}),
            c(this, "isActiveOutputSinksEnabled", !1),
            c(this, "activeOutputSinks", new Map()),
            c(this, "videoSupported", !1),
            c(this, "useElectronVideo", !1),
            c(this, "voiceBitrate", l.dX),
            c(this, "remoteSinkWantsMaxFramerate", l.Gs),
            c(this, "videoQualityManager", void 0),
            c(this, "wantsPriority", new Set()),
            c(this, "localSpeakingFlags", {}),
            c(this, "videoReady", !1),
            c(this, "videoStreamParameters", []),
            c(this, "remoteVideoSinkWants", { any: 100 }),
            c(this, "localVideoSinkWants", { any: 100 }),
            c(this, "connectionState", l.$j.CONNECTING),
            c(this, "stats", void 0),
            c(this, "onDesktopEncodingOptionsSet", (e, t, n) => {}),
            c(this, "experimentFlags", new Set()),
            c(this, "framerateReducer", void 0),
            (this.context = e),
            (this.userId = t),
            (this.videoQualityManager = new s.iY(e, this));
        let r = n(988746).Z;
