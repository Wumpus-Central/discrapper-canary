...
class d extends a.Z {
    ...
    setConnectionState(e) {
        this.logger.info("Connection state change: ".concat(this.connectionState, " => ").concat(e)),
            ...
            this.emit(o.S.ConnectionStateChange, this.connectionState);
    }
    updateVideoQuality(e) {
        ...
        null != a &&
            ((s[r].maxBitrate = a.bitrateMax),
            (s[r].minBitrate = a.bitrateMin),
            (s[r].targetBitrate = null != (t = a.bitrateTarget) ? t : 0),
            null != a.encode && ((s[r].maxPixelCount = a.encode.pixelCount), (s[r].maxFrameRate = a.encode.framerate))),
