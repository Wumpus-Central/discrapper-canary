...
function O(e, t, n) {
    ...
    if (t || !_.vF.getSetting() || __OVERLAY__ || r) {
        s.Z.dispatch({
            ...
            null != n ? (0, p.ad)(e, { source: n }) : (0, p.Kh)(e.id);
        return;
    }
    i()(null != e.parent_id, 'all threads must have parents');
    let o = m.Z.getChannelId();
    e.parent_id === o || (0, y.ME)(o) || (0, p.Kh)(e.parent_id),
        (0, f.uL)(b.Z5c.CHANNEL_THREAD_VIEW((0, d.e)(e), (0, y.ME)(o) ? y.oC.GUILD_HOME : e.parent_id, e.id), e.isForumPost() ? { source: v.on.FORUM } : void 0),
        setTimeout(() => {
...
function S(e, t, n) {
    if (
        ...
        (0, u.yw)(b.rMx.THREAD_CREATION_STARTED, {
            location: n,
            channel_id: e.id,
            guild_id: e.guild_id
        }),
        c.UI.dispatch(b.CkL.POPOUT_CLOSE),
        m.Z.getChannelId() !== e.id && (0, p.Kh)(e.id),
...
function I(e, t) {
    (0, f.uL)(b.Z5c.CHANNEL(e, (0, y.ME)(t) ? y.oC.GUILD_HOME : t)),
        s.Z.dispatch({
            type: 'SIDEBAR_CLOSE',
            baseChannelId: t
        });
