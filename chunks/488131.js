...
function v(e, t, n) {
    ...
    e.parent_id === a || (0, O.ME)(a) || (0, _.Kh)(e.parent_id),
        (0, f.uL)(y.Z5c.CHANNEL_THREAD_VIEW((0, d.e)(e), (0, O.ME)(a) ? O.oC.GUILD_HOME : e.parent_id, e.id), e.isForumPost() ? { source: b.on.FORUM } : void 0),
        setTimeout(() => {
