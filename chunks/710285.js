...
class g {
    ...
    corrections = [];
    constructor(e) {
        const [t, n] = _.default.locale.split("-");
...
async function I() {
    let e = new g(((await m.getAvailableDictionaries()) ?? []).map(f).filter(d.Vq));
    return null != document.body && document.body.addEventListener("beforeinput", (t) => A(e, t.target), !0), e;
}
