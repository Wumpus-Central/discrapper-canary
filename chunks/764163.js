...
function C(e) {
    let { guildId: t, emojiData: n, 'aria-labelledby': l, onSelectEmoji: s } = e,
        ...
        d = (0, a.e7)([f.ZP], () => f.ZP.getDefaultChannel(t)),
        x = i.useCallback(
            (e) => {
                let { closePopout: t } = e;
                return (0, r.jsx)(g.Z, {
        ...
        y = '';
    return (
        null != u ? (y = ':'.concat(u.name, ':')) : null != n.name && (y = h.ZP.convertSurrogateToName(n.name)),
        (0, r.jsx)(o.yRy, {
...
function y(e) {
    var t;
    let { guildId: n, initialData: l, benefitTypeInput: s, descriptionPlaceholder: a, canSubmit: c, onSave: m, onDelete: g, transitionState: p, onClose: h } = e,
        f = (0, d.Dt)(),
        x = (0, d.Dt)(),
        b = (0, d.Dt)(),
