...
let d = (e) => {
    ...
    return (0, i.jsxs)("div", {
        className: o.RP,
        children: [
            (0, i.jsx)(l.Heading, { className: o.RS, variant: "heading-lg/extrabold", children: d }),
            null != c
                ? (0, i.jsx)(l.Text, { className: o.sT, variant: "text-sm/normal", color: "text-default", children: c })
                : null,
            (0, i.jsxs)("div", {
                className: o.UD,
                children: [
