...
function _(e, t) {
    ...
    let i = null != (n = t.filter((t) => t.guild_id === e.id)[0]) ? n : {},
        ...
        _ = f.filter((e) => {
            var t, n;
            let r =
                null != (n = null == (t = s.Z.frecencyWithoutFetchingLatest.usageHistory[e.id]) ? void 0 : t.recentUses)
                    ? n
                    : [];
        ...
        h = f.reduce((e, t) => {
            ...
            return (
                e +
                (null != (r = null == (n = s.Z.frecencyWithoutFetchingLatest.usageHistory[t.id]) ? void 0 : n.totalUses)
                    ? r
                    : 0)
            );
        }, 0),
        m = "\n- **Local**:\n    - Guild Visits: "
            ...
            .concat(f.length, "\n    - Recent Channels: ")
            .concat(_.length, "\n");
    return i.messages === u.XR.High || a > 1000
        ? [u.AR.UseGreyDot, p, "SuggestGreyDot" + m]
        : [u.AR.KeepAsIs, p, "KeepAsIs" + m];
}
