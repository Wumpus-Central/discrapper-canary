            ...
            children: [
                ...
                n &&
                    (0, r.jsx)(c.P3F, {
                        ...
                        onClick: (e) => {
                            if ((e.stopPropagation(), (0, b.EW)(s.z.SERVER_SHOP_PHANTOM_PREVIEW), O.default.track(S.rMx.GUILD_SHOP_PREVIEW_CLICK, P(N({}, (0, h.hH)(t)), { action_taken: E.mz.DISMISS_CHANNEL_ROW })), !u || !j)) {
                                var n;
              ...
              onContextMenu: (e) => {
                  null != t &&
                      (0, u.jW)(e, async () => {
                          ...
                          return (n) => (0, r.jsx)(e, P(N({}, n), { guild: t }));
                      });
              }
          });
}
