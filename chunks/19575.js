...
let g = window.DiscordNative,
    ...
    N = new Set(["jpg", "jpeg", "jfif", "png", "webp", "gif", "tiff", "bmp", "avif"]),
    C = null,
    O = null,
    R = null,
    L = {},
        ...
        setObservedGamesCallback(e, t, n, i) {
            try {
                ...
                let a = 0,
                    ...
                    l = e.map((e) => {
                        let t = ++a;
                        return null != e.id && (L[t] = e.id), { ...e, cmdline: e.cmdLine, id: t };
                    }),
                    o = L;
                function r(e) {
                    return n(e.map((e) => j(e, o)));
                }
