...
function L(e) {
    ...
    return null == a
        ...
        : (0, i.jsxs)("li", {
              className: R.NG,
              children: [
                  (0, i.jsx)("div", { className: R.Wz }),
                  (0, i.jsx)("div", {
                      className: R.xW,
                      children: (0, i.jsx)(p.A, { game: o, className: R.AW, "aria-hidden": !0 }),
                  }),
                  (0, i.jsxs)("div", {
                      className: R.Kw,
                      children: [
                          (0, i.jsx)(r.E, {
                              ...
                              className: R.rN,
                              children: j.intl.format(j.t.CKIMrx, {
                                  user: (0, i.jsx)(m.A, {
                                      tag: "span",
                                      onClick: () =>
                                  ...
                                  activityName:
                                      null != c && null != o
                                          ...
                                          : (0, i.jsx)(r.E, {
                                                variant: "text-sm/semibold",
                                                tag: "span",
                                                children: o?.name ?? j.intl.string(j.t.GIWFlF),
                                            }),
                              }),
                          }),
                          (0, i.jsx)(r.E, {
                  ...
                  (0, i.jsxs)("div", {
                      ...
                      children: [
                          (0, i.jsx)(r.E, {
                              variant: "text-sm/normal",
                              className: R.qJ,
                              children: j.intl.format(j.t.TlVwqn, {
                                  user: c,
                                  userHook: (e, s) =>
                                      (0, i.jsx)(
                                          m.A,
                                  ...
                                  labelHook: (e, t) =>
                                      (0, i.jsx)(r.E, { variant: "text-sm/normal", className: R.CS, children: e }, t),
                              }),
                          }),
                          (0, i.jsx)(r.E, {
                              variant: "text-xs/normal",
...
function M(e) {
    ...
    return (0, i.jsxs)("div", {
        ...
        children: [
            ...
            (0, i.jsx)(r.E, { variant: "text-md/medium", className: R.HA, children: l }),
...
function D(e) {
    ...
    c)
        ? (0, i.jsxs)("div", {
              role: "dialog",
              "aria-label": j.intl.string(j.t.N0ED9s),
              className: R.kL,
              onMouseEnter: a,
              onMouseLeave: o,
              children: [
                  "voice_channel" === n ? (0, i.jsx)(M, { channel: t }) : null,
                  (0, i.jsx)(u.Ip, {
                          ...
                          children: [
                              (0, i.jsx)("div", {
                                  ...
                                  children: (0, i.jsx)(r.E, {
                                      ...
                                      color: "text-muted",
                                      children: j.intl.string(j.t.N0ED9s),
                                  }),
                              }),
                              (0, i.jsx)("ol", {
                                  className: R.Gz,
