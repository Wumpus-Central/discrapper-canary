...
function N(e) {
    let { event: t, guildId: n, channelId: s } = e,
        r = (0, l.bG)([g.default], () => g.default.getUser(t.userId)),
        c = (0, o.O)(t.applicationId ?? null),
        d = x.Ay.useName(n, s, r);
    return null == r
        ? null
        : (0, i.jsxs)("li", {
              className: I.NG,
...
function S(e) {
    let { event: t, guildId: n, channelId: s } = e;
    return t.eventType === p.i.ACTIVITY_ENDED
        ? (0, i.jsx)(N, { event: t, guildId: n, channelId: s })
        : t.eventType === p.i.USER_LEFT
          ? (0, i.jsx)(b, { event: t, guildId: n, channelId: s })
          : null;
}
function T(e) {
    let { channel: t } = e,
    ...
    return (0, i.jsxs)("div", {
        className: I.hY,
        children: [
            (0, i.jsx)(a.HKD, { size: "custom", color: r.A.colors.ICON_FEEDBACK_POSITIVE, height: 20, width: 20 }),
            (0, i.jsx)(a.Text, { variant: "text-md/medium", className: I.HA, children: s }),
            null != n && (0, i.jsx)(u.z, { textColor: "text-feedback-positive", entry: { start: n } }),
        ],
    });
}
function v(e) {
    let { channel: t, source: n, onMouseEnter: r, onMouseLeave: o } = e;
    s.useEffect(() => {
        (0, m.q)(t.id);
    }, [t.id]);
                      ...
                      children: (0, i.jsxs)("div", {
                          ...
                          children: [
                              ...
                              (0, i.jsx)("ol", {
                                  className: I.Gz,
                                  children: c.map((e) =>
                                      (0, i.jsx)(S, { event: e, guildId: t.guild_id, channelId: t.id }, e.key),
                                  ),
                              }),
                          ],
                      }),
