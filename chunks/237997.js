...
function V(e) {
    if (('OVERLAY_INITIALIZE' === e.type && F(e) && (P = !0), P)) {
        ...
        switch (e.type) {
            ...
            case 'CHANNEL_DELETE':
            case 'THREAD_DELETE':
                let s = (0, p.kt)(e.channel);
                if (!p.AW.has(s.type)) break;
                u.Z.dispatch({
                    type: e.type,
                    channel: s
                });
            ...
            case 'CHANNEL_UPDATES':
                u.Z.dispatch({
                    type: e.type,
                    channels: e.channels.map((e) => (0, p.kt)(e))
                });
                break;
            case 'CONNECTION_OPEN_SUPPLEMENTAL':
                (e.lazyPrivateChannels = (null !== (n = e.lazyPrivateChannels) && void 0 !== n ? n : []).map((e) => (0, p.kt)(e))), u.Z.dispatch(e);
                break;
            case 'THREAD_LIST_SYNC':
                u.Z.dispatch({
                    ...e,
                    threads: e.threads.map((e) => (0, p.kt)(e))
                });
                break;
            case 'GUILD_CREATE':
                let l = (e) => (0, p.kt)(e),
                ...
                (c.channels = null !== (a = null === (r = c.channels) || void 0 === r ? void 0 : r.map(l)) && void 0 !== a ? a : null),
                    ...
                    null != c.channelUpdates && (c.channelUpdates.writes = null === (o = c.channelUpdates.writes) || void 0 === o ? void 0 : o.map(l)),
                    u.Z.dispatch({
                        type: 'GUILD_CREATE',
                        guild: c
                    });
...
function K() {
    ...
    if ((null != e && (!m.ZP.hasChannels(e) || (null != n && !m.ZP.hasSelectableChannel(e, n))) && ((e = null), (n = null)), null != n && null == _.Z.getChannel(n) && ((e = null), (n = null)), null == e && null == n && (e = E.Z.getGuildId()), null != e && null == n)) {
...
function X(e) {
    let { region: n } = e;
    if (N !== (0, b.QF)() || M.has(n)) return !1;
    M.add(n);
}
function J() {
    if (N !== (0, b.QF)()) return !1;
    M.clear();
}
function $(e) {
    let { pid: n } = e;
    ...
    if (null == e.pid || e.pid === n)
        switch (e.type) {
            case T.BmY.STORAGE_SYNC:
                s.ZP.PersistedStore.initializeAll(e.states);
                break;
            case T.BmY.DISPATCH:
...
class ey extends (i = s.ZP.PersistedStore) {
    initialize(e) {
        if (
            ...
            null != n && (null == (B = U(n)).textChatNotifications && (B.textChatNotifications = C.textChatNotifications), null == B.textWidgetOpacity && (B.textWidgetOpacity = C.textWidgetOpacity));
        }
    }
    getState() {
        return R;
    ...
    getTextChatNotificationMode() {
        return B.notificationPositionMode === T._vf.DISABLED ? T.Ypu.DISABLED : B.textChatNotifications;
    }
