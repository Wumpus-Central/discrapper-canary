...
function W(e) {
    return (null == e.version && 1 === v.Tq) || e.version === v.Tq || (s.Z.dispatch({ type: 'OVERLAY_INCOMPATIBLE_APP' }), (0, c.zP)(), !1);
}
function Y(e) {
    if (('OVERLAY_INITIALIZE' === e.type && W(e) && (j = !0), j)) {
        ...
        switch (e.type) {
            ...
            case 'GUILD_CREATE':
                let l = (e) => (0, f.kt)(e),
                    c = e.guild;
                (c.channels = null !== (i = null === (n = c.channels) || void 0 === n ? void 0 : n.map(l)) && void 0 !== i ? i : null),
                    (c.threads = null === (r = c.threads) || void 0 === r ? void 0 : r.map(l)),
...
I(eT, 'displayName', 'OverlayStore'),
    I(eT, 'persistKey', 'OverlayStoreV2'),
    I(eT, 'migrations', [
        () => {
