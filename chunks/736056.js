...
let R = {
    ...
    [a().v3("guild_age_range_days")]: (e) => {
        let { min: t, max: n } = C(e);
        return (e) => v(Math.floor(N.default.age(e) / y.A.Millis.DAY), t, n);
    },
    [a().v3("guild_member_count_range")]: (e) => {
        let { min: t, max: n } = C(e);
        return (e) => {
            let i = T.A.getMemberCount(e);
            return null != i && v(i, t, n);
        };
    },
...
function J(e) {
    ...
    u ? U.set(_, f) : ((k[X(t, n, i, c)] = { time: Date.now(), hash: Z(n) }), e_(k));
}
function ee(e) {
    let [t, n] = e;
...
function el(e) {
    ...
    o.w.remove(D),
        t || (o.w.remove(L), o.w.remove(w), o.w.remove(M), (j = {}), (Y = {})),
        (V = {}),
