...
function M(e) {
    let { onAnimationComplete: t, onClick: n, position: r, size: a } = e,
        ...
        { createMultipleConfettiAt: h, confettiCanvas: g } = l.useContext(f.h),
        [b, E] = l.useState(null),
        y = (0, s.uR)(g, b),
        C = (function (e, t) {
            ...
            children: [
                ...
                (0, i.jsx)(p.P3F, {
                    ...
                    children: (0, i.jsx)(p.kci, {
                        animationRef: M,
                        className: o()(v.easterEggAnimation, { [v.easterEggAnimationHideLeaf]: O }),
                        nextScene: C,
                        sceneSegments: I,
                        onScenePlay: j,
                        onSceneComplete: P,
...
function U(e) {
    ...
    t =
        null == c || null == a
            ? u > 1
                ? x.intl.format(x.t.yfC9dn, {
                      username: P,
                      usernameHook: A,
                      numSubscriptions: u
                  })
                : x.intl.format(x.t['57St//'], {
                      username: P,
                      usernameHook: A
                  })
            : u > 1
              ? x.intl.format(x.t.PO9uJC, {
                    username: P,
                    usernameHook: A,
                    numSubscriptions: u,
                    guildName: a.name,
    ...
    let Z = l.useCallback(() => {
        ...
        L = l.useCallback(() => {
            ((0, h.AI)({ settingsVisible: !0 }), m.Z.open(C.oAB.POGGERMODE), I(!1));
        }, []),
        k = l.useCallback(
            (e, t) => {
