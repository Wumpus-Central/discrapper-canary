...
var e1 = l(97808),
    ...
    tn = l(19575),
    ti = l(941610);
let ts = tn.Ay.getEnableHardwareAcceleration() ? e1.Js : e9.A;
function tr(e) {
    let { guildId: t } = e,
        l = (0, r.bG)([c.A], () => c.A.getGuild(t)),
        ...
        d = (0, r.bG)([eb.Ay], () => eb.Ay.useReducedMotion),
        {
            ...
            avatarSrc: p,
            eventHandlers: f,
        } = (0, e8.A)({ userId: s?.id, guildId: t, size: e4._3.SIZE_40, animateOnHover: !d });
