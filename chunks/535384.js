...
function v(e, t, n) {
    ...
    for (let i = 0; i < t.length; i++) if (!N(e, t[i], n[i])) return !1;
    return !0;
}
function C(e, t, n) {
    if (t.length !== n.length) return !1;
            ...
            for (let r of e.fields) {
                ...
                switch (r.kind) {
                    ...
                    case "scalar":
                        ...
                        if (!(r.repeat ? v(o, s, a) : N(o, s, a))) return !1;
                        break;
                    case "map":
                        if (
                            !("message" == r.V.kind
                                ? C(r.V.T(), y(s), y(a))
                                : v("enum" == r.V.kind ? i.LN.INT32 : r.V.T, y(s), y(a)))
                        )
                            return !1;
                        break;
                    case "message":
                        let l = r.T();
                        if (!(r.repeat ? C(l, s, a) : l.equals(s, a))) return !1;
                }
            }
            return !0;
        })(this, e, t);
