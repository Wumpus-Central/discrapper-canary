            ...
            O = s.useCallback(() => {
                ...
                switch (N?.popout?.type) {
                    case p.o.LEVEL_REACHED:
                        return (0, i.jsx)(_.HW, { guildId: t, channelRowRef: T, ...N.popout });
                    case p.o.PERKS_AVAILABLE:
                        return (0, i.jsx)(_.UB, { guildId: t, channelRowRef: T, ...N.popout });
                    case p.o.PERKS_PURCHASABLE:
                        return (0, i.jsx)(_.lw, { guildId: t, channelRowRef: T, ...N.popout });
                    case p.o.NEW_PERK_AVAILABLE:
                        return (0, i.jsx)(_.bo, { guildId: t, channelRowRef: T, ...N.popout });
                    case p.o.BOOST_TO_UNLOCK:
                        return (0, i.jsx)(_.Gw, { guildId: t, channelRowRef: T, ...N.popout });
                    case p.o.EXPIRING_PERK:
                        return (0, i.jsx)(_.Mr, { guildId: t, channelRowRef: T, ...N.popout });
                    case p.o.GAME_SERVER_HOSTING_AVAILABLE:
                    case p.o.GAME_SERVER_HOSTING_GUILD_ELIGIBLE:
                        return (0, i.jsx)(_.jz, { guildId: t, channelRowRef: T, ...N.popout });
                    default:
                        return (0, i.jsx)("div", {});
                }
            }, [t, N?.popout, T, R]),
