    ...
    function t(t) {
        ...
        function ex() {
            ...
            if (
                ...
                (n = []),
                (r = eO),
                (o = ez()) !== i && (a = e$()) !== i && (s = ez()) !== i ? (r = o = [o, a, s]) : ((eO = r), (r = l)),
                r !== i)
            )
                for (; r !== i; )
                    n.push(r),
        ...
        function ek() {
            ...
            if ((e = eQ()) === i) {
                if (
                    ((e = eO),
                    (n = []),
                    d.test(t.charAt(eO)) ? ((r = t.charAt(eO)), eO++) : ((r = i), 0 === eN && eR(f)),
                    r !== i)
                )
                    for (; r !== i; )
                        n.push(r), d.test(t.charAt(eO)) ? ((r = t.charAt(eO)), eO++) : ((r = i), 0 === eN && eR(f));
                else n = l;
            ...
            return (
                ...
                n !== i && ez() !== i && (r = ek()) !== i && ez() !== i
                    ? ((o = eO),
                      ...
                      o === i && (o = h),
                      o !== i && (a = ez()) !== i
                          ? (125 === t.charCodeAt(eO) ? ((s = E), eO++) : ((s = i), 0 === eN && eR(b)),
                            s !== i ? ((ev = e), (e = n = y(r, o))) : ((eO = e), (e = l)))
                          : ((eO = e), (e = l)))
                    : ((eO = e), (e = l)),
                e
            );
        ...
        function eG() {
            ...
            return (
                (e = eO),
                t.substr(eO, 6) === O ? ((n = O), (eO += 6)) : ((n = i), 0 === eN && eR(v)),
                n === i &&
                    (t.substr(eO, 4) === I ? ((n = I), (eO += 4)) : ((n = i), 0 === eN && eR(T)),
                    n === i && (t.substr(eO, 4) === S ? ((n = S), (eO += 4)) : ((n = i), 0 === eN && eR(A)))),
                n !== i && ez() !== i
                    ? ((r = eO),
                      44 === t.charCodeAt(eO) ? ((o = m), eO++) : ((o = i), 0 === eN && eR(g)),
                      o !== i && (a = ez()) !== i && (s = e$()) !== i ? (r = o = [o, a, s]) : ((eO = r), (r = l)),
                      r === i && (r = h),
                      r !== i ? ((ev = e), (e = n = N(n, r))) : ((eO = e), (e = l)))
                    : ((eO = e), (e = l)),
                e
            );
        }
        function eB() {
            ...
            return (
                (e = eO),
                t.substr(eO, 6) === C ? ((n = C), (eO += 6)) : ((n = i), 0 === eN && eR(R)),
                n !== i && ez() !== i
                    ? (44 === t.charCodeAt(eO) ? ((r = m), eO++) : ((r = i), 0 === eN && eR(g)),
                      r !== i && ez() !== i && (o = eW()) !== i ? ((ev = e), (e = n = P(o))) : ((eO = e), (e = l)))
                    : ((eO = e), (e = l)),
                e
            );
        }
        function eZ() {
            ...
            return (
                (e = eO),
                t.substr(eO, 13) === w ? ((n = w), (eO += 13)) : ((n = i), 0 === eN && eR(D)),
                n !== i && ez() !== i
                    ? (44 === t.charCodeAt(eO) ? ((r = m), eO++) : ((r = i), 0 === eN && eR(g)),
                      r !== i && ez() !== i && (o = eW()) !== i ? ((ev = e), (e = n = L(o))) : ((eO = e), (e = l)))
                    : ((eO = e), (e = l)),
                e
            );
        }
        ...
        function eH() {
            ...
            return (
                (e = eO),
                (n = ez()) !== i && (r = eV()) !== i && ez() !== i
                    ? (123 === t.charCodeAt(eO) ? ((o = _), eO++) : ((o = i), 0 === eN && eR(p)),
                      o !== i && ez() !== i && (a = eD()) !== i && ez() !== i
                          ? (125 === t.charCodeAt(eO) ? ((s = E), eO++) : ((s = i), 0 === eN && eR(b)),
                            s !== i ? ((ev = e), (e = n = G(r, a))) : ((eO = e), (e = l)))
                          : ((eO = e), (e = l)))
                    : ((eO = e), (e = l)),
                e
            );
        ...
        function eY() {
            ...
            return (
                (e = eO),
                t.substr(eO, 7) === B ? ((n = B), (eO += 7)) : ((n = i), 0 === eN && eR(Z)),
        ...
        function eK() {
            ...
            if (
                (eN++,
                (e = []),
                Y.test(t.charAt(eO)) ? ((n = t.charAt(eO)), eO++) : ((n = i), 0 === eN && eR(W)),
                n !== i)
            )
                for (; n !== i; )
                    e.push(n), Y.test(t.charAt(eO)) ? ((n = t.charAt(eO)), eO++) : ((n = i), 0 === eN && eR(W));
            else e = l;
        ...
        function eQ() {
            ...
            if (((e = eO), 48 === t.charCodeAt(eO) ? ((n = J), eO++) : ((n = i), 0 === eN && eR($)), n === i)) {
                if (
                    ((n = eO),
                    (r = eO),
                    ee.test(t.charAt(eO)) ? ((o = t.charAt(eO)), eO++) : ((o = i), 0 === eN && eR(et)),
                    o !== i)
                ) {
        ...
        function eJ() {
            var e, n, r, o, a, s, c, u;
            return (
                er.test(t.charAt(eO)) ? ((e = t.charAt(eO)), eO++) : ((e = i), 0 === eN && eR(ei)),
                e === i &&
                    ((e = eO),
                    t.substr(eO, 2) === eo ? ((n = eo), (eO += 2)) : ((n = i), 0 === eN && eR(ea)),
                    n !== i && ((ev = e), (n = es())),
                    (e = n) === i &&
                        ((e = eO),
                        t.substr(eO, 2) === el ? ((n = el), (eO += 2)) : ((n = i), 0 === eN && eR(ec)),
                        n !== i && ((ev = e), (n = eu())),
                        (e = n) === i &&
                            ((e = eO),
                            t.substr(eO, 2) === ed ? ((n = ed), (eO += 2)) : ((n = i), 0 === eN && eR(ef)),
                            n !== i && ((ev = e), (n = e_())),
                            (e = n) === i &&
                                ((e = eO),
                                t.substr(eO, 2) === ep ? ((n = ep), (eO += 2)) : ((n = i), 0 === eN && eR(eh)),
                                n !== i && ((ev = e), (n = em())),
                                (e = n) === i &&
                                    ((e = eO),
                                    t.substr(eO, 2) === eg ? ((n = eg), (eO += 2)) : ((n = i), 0 === eN && eR(eE)),
                                    n !== i
                                        ? ((r = eO),
                                          (o = eO),
                                          (a = eX()) !== i && (s = eX()) !== i && (c = eX()) !== i && (u = eX()) !== i
                                              ? (o = a = [a, s, c, u])
                                              : ((eO = o), (o = l)),
                                          o !== i && (o = t.substring(r, eO)),
                                          (r = o) !== i ? ((ev = e), (e = n = eb(r))) : ((eO = e), (e = l)))
                                        : ((eO = e), (e = l))))))),
                e
            );
        }
