...
function k(e) {
    ...
    O
        ? x.canWrite ||
          (x.type === m.Kw.USER
              ? (a = x.id === w ? Z.intl.string(Z.t["1VF/09"]) : Z.intl.string(Z.t.P1GnER))
              : x.type === m.Kw.ROLE && (a = Z.intl.string(Z.t.mcAijY)))
        : (a = null != d ? Z.intl.string(Z.t.tybdam) : Z.intl.string(Z.t.z2hjk5));
