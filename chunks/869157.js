...
function k(e) {
    ...
    O
        ? x.canWrite ||
          (x.type === m.Kw.USER
              ? (a = x.id === S ? w.intl.string(w.t["1VF/09"]) : w.intl.string(w.t.P1GnER))
              : x.type === m.Kw.ROLE && (a = w.intl.string(w.t.mcAijY)))
        : (a = null != d ? w.intl.string(w.t.tybdam) : w.intl.string(w.t.z2hjk5));
