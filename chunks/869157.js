...
function A(e) {
    ...
    O
        ? x.canWrite ||
          (x.type === u.Kw.USER
              ? (a = x.id === k ? T.intl.string(T.t["1VF/09"]) : T.intl.string(T.t.P1GnER))
              : x.type === u.Kw.ROLE && (a = T.intl.string(T.t.mcAijY)))
        : (a = null != c ? T.intl.string(T.t.tybdam) : T.intl.string(T.t.z2hjk5));
