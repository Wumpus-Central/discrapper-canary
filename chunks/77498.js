...
class w extends (a = o.ZP.PersistedStore) {
    initialize(e) {
        ...
        null != e &&
            ...
            null == (t = e.detectableGames) || t.forEach((e) => A(e)));
    }
    getState() {
    ...
    isGameInDatabase(e) {
        return (
            ...
            (void 0 !== e.nativeProcessObserverId && (e.nativeProcessObserverId & m) == 0)
        );
    }
    get fetching() {
        return !0 === r;
        ...
        (e) => {
            ...
            return null == e
                ...
                : {
                      ...
                      detectableGames:
                          null != (n = null == (t = e.detectableGames) ? void 0 : t.map((e) => S(new d.ZP(e))))
                              ? n
                              : [],
                  };
        },
