...
let I = {
    ...
    R = (e) => {
        ...
        let { handleClose: n } = e,
            ...
            { skuId: b, onRedeemVirtualCurrency: x, isRedeeming: C, orbRedemptionError: S, orbProductContext: v } = (0, j.C)(),
            T = (0, _.cR)(),
            N = (0, r.useRef)(T);
        ((0, l.ZP)(() => {
            ...
            (0, r.useEffect)(() => {
                null != S && null !== N.current && (g(O.rMx.PAYMENT_FLOW_FAILED, S), (N.current = null));
            }, [S, g]));
