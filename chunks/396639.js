...
let w = {
    ...
    x = () => {
        let { activitySessionId: e, hasPaymentSources: t, contextMetadata: n } = (0, u.JL)(),
            ...
            { skuId: o, orbProductContext: s, analyticsLocations: l, analyticsSourceLocation: c } = (0, O.C)(),
            f = (0, i.useMemo)(() => {
                var t, n;
                return A(
                    N(
