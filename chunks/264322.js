...
function eo(e, t) {
    ...
    return (
        t.forEach((e) => {
            ...
            let l = (0, R.bq)(k(j({}, o.descriptor.application), { bot: t }), !1, n);
...
function el(e) {
    ...
    eh.hasContextStateApplication({
        ...
        eh.hasUserStateApplication(t) && Z({ type: "user" }, { serverVersion: V }),
