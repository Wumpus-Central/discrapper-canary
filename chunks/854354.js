...
let c = (e) => {
        ...
        if (null != l && t.interval === i.WT.YEAR && !u)
            return o.intl.formatToPlainString(s.default.nsG1jw, { savingsText: (0, a.l9)(n, l / 100) });
        let c = null != r ? r.discount.amount : null;
        return null != r && r.discount.plan_ids.includes(t.id) && null != c
            ? o.intl.formatToPlainString(s.default.MSB4E4, { amountOrPercentOffText: (0, a.l9)(n, parseInt(c) / 100) })
            : null;
    },
    d = function (e) {
