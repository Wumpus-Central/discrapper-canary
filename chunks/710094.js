...
function L(e) {
    ...
    i.useEffect(() => {
        null != J && null != ey.current && ey.current.scrollIntoView({ behavior: 'smooth' });
    }, [J]);
    let eR = i.useCallback(
        ...
        eH = i.useCallback(() => {
            ...
            return eF ? L(E.h8.GIFT_CUSTOMIZATION) : L(E.h8.PLAN_SELECT);
        }, [L, eB, eF, eZ]),
        eW = !1;
    return (
        ed === P.GZ.ONE_TIME
