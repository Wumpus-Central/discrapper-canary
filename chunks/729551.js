        ...
        V = i.useMemo(
            () =>
                (0, r.uniqWith)(
                    n?.filter((e) => {
                        let { type: t, name: n } = e;
                        return t !== v.$pd.CUSTOM_STATUS && t !== v.$pd.HANG_STATUS && n !== M?.name;
                    }) ?? [],
                    (e, t) =>
                          ...
                          __unsupportedReactNodeAsText:
                              ...
                              null != O &&
                                  e.push(
                                      (0, l.jsx)(
                                          C.A,
                                          { stream: O, game: n?.find(d.A), ...t, showChannelName: !0 },
                                          "stream",
                                      ),
                                  ),
                              V.forEach((n, i) => {
