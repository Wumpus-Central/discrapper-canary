...
function Z(e) {
    ...
    if ((r()(null != a && null != c, "Missing startingPlan or newPlan"), f.LE.indexOf(l) < f.LE.indexOf(s)))
        switch (s) {
            case f.gD.PREMIUM_MONTH_TIER_1:
                (t = P.intl.string(P.t.knvOVz)),
                    x.NcF.has(null != i ? i : x.hes.UNKNOWN) && (t = P.intl.format(P.t.o6hBiR, {}));
                break;
            case f.gD.PREMIUM_MONTH_TIER_2:
                (t = P.intl.string(P.t.f8Dquh)),
                    x.NcF.has(null != i ? i : x.hes.UNKNOWN) && (t = P.intl.format(P.t.A4THYt, {}));
                break;
            case f.gD.PREMIUM_YEAR_TIER_1:
                (t = P.intl.string(P.t.YZd5rw)),
...
function v(e) {
    let t,
        ...
        { isDisplayingWowMomentConfirmation: O, customCheckoutFlow: D, isPremiumGroupPurchase: y } = (0, u.P5)(),
        { theme: S } = (0, c.wRf)(),
    ...
    let G = (e) =>
        y
            ...
            : e.skuId === f.pe.TIER_0
              ? x.NcF.has(null != k ? k : x.hes.UNKNOWN)
