...
function y(e) {
    let { onClick: t, selectedOverride: n = !1, popoutProps: m, ref: g } = e,
        ...
        y = (0, x.lI)(),
        R = n || y,
        { notificationCenterVariant: j } = (0, E.X8)({ location: "NotificationsInboxButtonInner" }),
        {
            badge: L,
            badgeDimensions: O,
        ...
        D = j === E.U5.LEGACY ? d.K : c.X,
        M = (0, a.bG)([p.A], () => p.A.getChannelId()),
        U = l.useMemo(() => {
            if (j === E.U5.SIDEBAR) return N.BVt.CHANNEL(N.gNP, M);
        }, [j, M]);
    return (0, i.jsxs)(_.c, {
        ref: g,
        children: [
            (0, i.jsx)(A.A, {
                selected: R && j === E.U5.SIDEBAR,
                hovered: C && j === E.U5.SIDEBAR,
                unread: G > 0,
                className: v.Io,
                disabled: j === E.U5.LEGACY,
            }),
            (0, i.jsx)(b.A, {
