...
function tw(e) {
    ...
    let I = i.useCallback((e, t, n) => {
        ...
        { blockCount: C, ignoreCount: U } = (0, u.cf)([J.A], () => {
            let e = 0,
                t = 0;
            return (
                h.forEach((n) => {
        ...
        : (0, a.jsxs)("div", {
              ...
              children: [
                  ...
                  (0, a.jsx)(tj.Ch, {
                      ...
                      onScroll: G,
                      children:
                          !f.isSearching && f.totalResults > 0
                              ? (0, a.jsx)(tB.A, {
                                    messages: h,
                                    search: f,
                                    renderEmbeds: !0,
    ...
    return (0, a.jsxs)("div", {
        ...
        children: [
            ...
            null != l &&
                (0, a.jsx)(nT, {
                    disabled: !c,
                    text: _ ? P.intl.string(P.t.N86XcP) : P.intl.string(P.t.kTlLrz),
                    onClick: () => {
                        _
