...
function P(e, t) {
    let { results: n, queryMode: a, query: r, maxQueryLength: l } = v.Z.getProps(),
        i = y.Z.getGuildId(),
...
function j() {
    ...
    !(function (e) {
        ...
        a.Z.dispatch(O({ type: 'QUICKSWITCHER_SHOW' }, T(t)));
}
function w() {
    P(S.rMx.QUICKSWITCHER_CLOSED), L();
}
function Z(e) {
    a.Z.dispatch(O({ type: 'QUICKSWITCHER_SEARCH' }, T(e)));
}
function D(e) {
    a.Z.dispatch({
...
function k(e) {
    ...
    switch (g) {
        ...
        case c.h8.USER:
            ...
            break;
        case c.h8.GROUP_DM:
            (0, m.Kh)(b.id, { navigationReplace: !0 }), i.Z.channelListScrollTo(S.ME, b.id);
            break;
