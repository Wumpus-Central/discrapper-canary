...
var r = n(200651),
    ...
    g = n(802138);
let p = function (e) {
    let { title: t, description: n, agreement: o, disagreement: p, onAgree: f, onDisagree: d, imageClassName: b, agreementButtonColor: m = a.zxk.Colors.RED, modalType: O, channelId: y, guildId: j } = e;
    i.useEffect(() => {
        (0, s.YT)(O, y, j);
    }, [O, y, j]);
    let E = i.useCallback(() => {
