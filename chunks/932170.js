"use strict";
n.d(t, { Gx: () => _, Js: () => d, Lh: () => l, Qo: () => c, m6: () => u }), n(321073);
var r = n(61090);
n(423034);
var i = n(614792),
    s = n(287809),
...
function l(e, t, n, s, l) {
    ...
    i.A.attachReadyPayloadProperties(d), a.default.track(o.HAw.READY_PAYLOAD_RECEIVED, d, { logEventProperties: !0 });
}
function u(e) {
    try {
        var t;
    ...
    return (
        n.forEach((e) => {
            ...
            h.push("partial" === e.data_mode ? e.partial_updates.channels : e.channels),
                p.push("partial" === e.data_mode ? e.partial_updates.roles : e.roles),
        ...
        }),
        {
            ...
            experiments_size: JSON.stringify(d ?? []).length + JSON.stringify(c ?? []).length,
            user_guild_settings_size: JSON.stringify(o).length,
            relationships_size: JSON.stringify(_).length,
            remaining_data_size: JSON.stringify(E ?? {}).length,
