"use strict";
n.d(t, { Gx: () => g, Js: () => h, Lh: () => l, Qo: () => m, m6: () => c }), n(321073);
var r = n(61090);
n(423034);
var i = n(614792),
    a = n(287809),
...
function l(e, t, n, a, l) {
    ...
    null != a && r.A.addDetail("payload_size(kb)", Math.round(a.uncompressed_byte_size / 1024)),
        r.A.addDetail("server_time(ms)", c.identify_total_server_duration_ms ?? 0);
    let d = {
        ...a,
        ...c,
        ...p(t),
    ...
    i.A.attachReadyPayloadProperties(d), s.default.track(o.HAw.READY_PAYLOAD_RECEIVED, d, { logEventProperties: !0 });
}
function u(e) {
    let { _trace: t } = e,
        n = {};
...
function d(e) {
    return null == e ? null : _(JSON.parse(e), "");
}
function _(e, t) {
    if (null == e) return "";
    let n = "";
    ...
    return (
        n.forEach((e) => {
            ...
            let { features: t, ...n } = e.properties ?? {},
                { threads: r, guild_scheduled_events: i, ...a } = e;
            h.push("partial" === e.data_mode ? e.partial_updates.channels : e.channels),
                m.push("partial" === e.data_mode ? e.partial_updates.roles : e.roles),
        ...
        }),
        {
            ...
            guild_threads_size: JSON.stringify(E).length,
...
function g(e) {
    (!a.default.getCurrentUser()?.isStaff() && 0.5 > Math.random()) ||
        s.default.track(
