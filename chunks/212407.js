n.d(t, { Kk: () => o, MV: () => d, U1: () => u, bv: () => m, qY: () => p, s4: () => c, w$: () => x });
var i = n(64700),
    r = n(488430),
    s = n(719986),
    l = n(940622),
...
function o(e) {
    let t = (0, l.mb)(a.RN.HERO_LOGO),
        ...
        o = (0, l.mb)(a.RN.HERO_BANNER_RIVE),
        c = (0, l.JE)((e) => e.heroLogoMaxHeight),
        d = (0, l.JE)((e) => e.heroResponsive);
    return i.useMemo(() => {
        let i,
            l = null != n || null != r || null != o || null != t,
            a = null != n && null == r;
        return (
            (i = l
                ? null != t && null != c
                    ? s.M.fromServer({ desktop_max_height: c })
                    : void 0
                : e.logoDisplayConfig),
            {
