e.exports = function (e) {
    let t = "a-zA-Z_\\-!.?+*=<>&'",
        ...
        o = { scope: "regex", begin: /#"/, end: /"/, contains: [e.BACKSLASH_ESCAPE] },
        ...
        d = { begin: "\\[|(#::?" + a + ")?\\{", end: "[\\]\\}]", relevance: 0 },
        m = { className: "symbol", begin: "[:]{1,2}" + a },
        p = { begin: "\\(", end: "\\)" },
        u = { endsWithParent: !0, relevance: 0 },
        g = [l, p, i, o, s, c, m, d, r, _, { begin: a, relevance: 0 }];
    return (
        (p.contains = [
            {
                beginKeywords: n,
                keywords: { $pattern: a, keyword: n },
                end: '(\\[|#|\\d|"|:|\\{|\\)|\\(|$)',
                contains: [{ className: "title", begin: a, relevance: 0, excludeEnd: !0, endsParent: !0 }].concat(g),
            },
            {
                keywords: {
                    $pattern: a,
        ...
        (u.contains = g),
        (d.contains = g),
        { name: "Clojure", aliases: ["clj", "edn"], illegal: /\S/, contains: [l, p, i, o, s, c, m, d, r, _] }
    );
};
