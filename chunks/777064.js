e.exports = function (e) {
    let t = "a-zA-Z_\\-!.?+*=<>&'",
        ...
        a = { scope: "regex", begin: /#"/, end: /"/, contains: [e.BACKSLASH_ESCAPE] },
        ...
        d = { begin: "\\[|(#::?" + n + ")?\\{", end: "[\\]\\}]", relevance: 0 },
        _ = { className: "symbol", begin: "[:]{1,2}" + n },
        h = { begin: "\\(", end: "\\)" },
        f = { endsWithParent: !0, relevance: 0 },
        p = [l, h, s, a, o, u, _, d, r, c, { begin: n, relevance: 0 }];
    return (
        (h.contains = [
            {
                beginKeywords: i,
                keywords: { $pattern: n, keyword: i },
                end: '(\\[|#|\\d|"|:|\\{|\\)|\\(|$)',
                contains: [{ className: "title", begin: n, relevance: 0, excludeEnd: !0, endsParent: !0 }].concat(p),
            },
            {
                keywords: {
                    $pattern: n,
        ...
        (f.contains = p),
        (d.contains = p),
        { name: "Clojure", aliases: ["clj", "edn"], illegal: /\S/, contains: [l, h, s, a, o, u, _, d, r, c] }
    );
};
