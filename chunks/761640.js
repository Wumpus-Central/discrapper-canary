...
function w() {
    ...
    for (let t in v) {
        ...
        if (n.type === l.PE.VIEW_THREAD || n.type === l.PE.VIEW_CHANNEL) {
            ...
            (null != i && h.A.can(A.xB.VIEW_CHANNEL, i)) || (delete v[t], (e = !0));
        }
    }
    return e;
}
...
let x = new P(s.h, {
    ...
    SIDEBAR_VIEW_GUILD: function (e) {
        ...
        R = !1;
        let s = b(i);
        return null != s && ((C[n] = { type: t, baseChannelId: s, guildId: n, details: r }), !0);
    },
    SIDEBAR_CREATE_THREAD: function (e) {
        let { parentChannelId: t, parentMessageId: n, location: i } = e;
        R = !1;
        let r = b(t);
        null != r && (v[r] = { type: l.PE.CREATE_THREAD, parentChannelId: t, parentMessageId: n, location: i });
    },
    ...
    CHANNEL_DELETE: function (e) {
        ...
        for (let e in v) {
            let i = v[e];
            null != i && i.type === l.PE.VIEW_CHANNEL && i.channelId === t.id && (delete v[e], (n = !0));
        }
        return n;
    },
