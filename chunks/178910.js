...
function m(e) {
    ...
    return (0, i.jsxs)("div", {
        ...
        children: [
            ...
            (0, i.jsx)(l.E, { variant: "text-xs/normal", color: "none", children: s }),
        ],
    });
}
function h(e) {
    ...
    switch (t?.type) {
        case d.$pd.STREAMING:
            return { text: c.intl.formatToPlainString(c.t.tyCw2q, { count: n }), Icon: s.o };
        case d.$pd.LISTENING:
            return { text: c.intl.formatToPlainString(c.t["2l8yka"], { count: n }), Icon: a.T };
        default:
