...
let el = () => 80,
    ...
    eo = (e) => {
        ...
        return (0, r.jsxs)(es, {
            ...
            ...o,
            children: [
                (0, r.jsx)("img", { src: ei.A, alt: u, className: er.rQ }),
        ...
        children: [
            (0, r.jsxs)(o.rQ, {
                ...
                children: [
                    ...
                    (0, r.jsx)(o.s_, { "data-migration-pending": !0, className: ep.iT, onClick: f }),
                ],
            }),
            (0, r.jsxs)(o.$m, {
                "data-migration-pending": !0,
...
function eh(e) {
    ...
    return (
        i.useEffect(() => {
            b.default.track(ed.HAw.OPEN_MODAL, { type: ed.JJy.PROFILE_EFFECT_CUSTOMIZATION, location_stack: A });
        }, [A]),
        (0, r.jsx)(p.f5, {
            value: A,
            children: (0, r.jsx)(o.EO, {
                ...
                "data-migration-pending": !0,
                children: f
                    ? (0, r.jsx)(d.y, { className: ep.u1, type: d.y.Type.SPINNING_CIRCLE })
                    : (0, r.jsx)(e_, {
                          user: v,
                          guild: s,
                          categories: _,
