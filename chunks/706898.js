...
class C extends (r = o.Component) {
    ...
    render() {
        let { children: e, className: t, id: n, selectedItem: r, color: i, disabled: o, onContextMenu: s, clickableRef: c, clickableInnerRef: u, look: d, disableItemStyles: _ } = this.props,
