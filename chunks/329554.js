...
l(582128);
var s = l(17928);
if (/^(221552|614256)$/.test(l.j)) var n = l(297264);
if (/^(221552|614256)$/.test(l.j)) var a = l(939249);
if (/^(221552|614256)$/.test(l.j)) var d = l(834730);
var r = l(302959),
    o = l(765379),
    c = l(35903),
    p = l(506326),
...
function j(e) {
    let { resolvedActivity: t, presenceActivity: l, showHeader: s = !0 } = e,
        ...
        c = null != l && !(0, o.A)(l) && null != l.party,
        h = null != t.state && t.state.length > 0 && !c;
    return (0, i.jsxs)("div", {
        className: v.ec,
        children: [
            s
