...
class b extends i.Z {
    ...
    constructor(e) {
        ...
        (this.id = e.id),
            ...
            (this.discriminator = null != (o = e.discriminator) ? o : f.fo$),
            ...
            (this.hasBouncedEmail = null != (w = null != (R = e.has_bounced_email) ? R : e.hasBouncedEmail) && w),
            ...
            (this.primaryGuild = (0, a.l)(null != (M = null != (k = e.primary_guild) ? k : e.primaryGuild) ? M : null)),
