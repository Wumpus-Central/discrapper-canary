...
function eo(e) {
    let {
        ...
        O = n === et.IlC.POPOUT && G.isPlatformEmbedded && H.ZP.supportsFeature(et.eRX.POPOUT_WINDOWS);
        ...
        children: [
            ...
            g
                ? (0, r.jsx)(R.Z, {
                      ...
                      onClosePopout: () => {
                          (0, v.v)(d, v.d.POPOUT, !1), p.Z.wait(() => I.xv(et.KJ3.CHANNEL_CALL_POPOUT));
                      },
                  })
                : null,
            x,
...
function ed(e) {
    ...
    let l,
        ...
        { analyticsLocations: x } = (0, m.ZP)(g.Z.VOICE_CONTROL_TRAY),
        O = (0, C.bp)(),
