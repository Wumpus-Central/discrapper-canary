n.d(t, { ER: () => o, Qi: () => A, Wy: () => u, gN: () => c, jS: () => _ });
var l = n(636537),
    r = n(228366),
    a = n(523599),
    i = n(652215);
...
function E(e, t) {
    let n = (function (e) {
        let { before: t, userId: n, targetId: l, action: r } = e,
            ...
            E = r ?? a.A.actionFilter,
            u = l ?? a.A.targetIdFilter,
            _ = { limit: i.$jw };
        return (
            null != t && (_.before = t),
            null != s && (_.user_id = s),
            null != E && (_.action_type = E),
            null != u && (_.target_id = u),
            _
        );
    })(t);
...
function c(e, t) {
    if (!s() && null != t) return r.h.dispatch({ type: "AUDIT_LOG_FILTER_BY_ACTION", action: e }), u(t, null, null, e);
}
function o(e, t) {
    if (!s() && null != t) return r.h.dispatch({ type: "AUDIT_LOG_FILTER_BY_USER", userId: e }), u(t, e);
}
function A(e, t) {
    if (!s() && null != t) return r.h.dispatch({ type: "AUDIT_LOG_FILTER_BY_TARGET", targetId: e }), u(t, null, e);
}
