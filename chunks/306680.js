...
class ek {
    ...
    static getValue(e) {
        ...
        let n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : ei.W.CHANNEL,
            ...
            a = null == (t = ek._readStates[n]) ? void 0 : t[e];
        return null == a ? i : r(a);
    }
    static clear(e) {
        var t;
...
eo(ek, '_guildReadStateSentinels', {}), eo(ek, '_readStates', {}), eo(ek, '_mentionChannels', new Set());
...
function e9(e) {
    ...
    } else null == f && ((t = Q.Z.getChannelId()), (n = V.ZP.getCurrentSidebarChannelId(t)));
    let h = t === i || n === i;
...
function tI(e) {
    ...
    tA(ef), tA(e_);
    let a = !1;
    return ef !== t && ((a = tN(ef) || a), (a = tN(e_) || a)), (ef === t || ((null == r ? void 0 : r.type) != null && ee.TPd.GUILD_THREADS_ONLY.has(r.type))) && (a = eX(t) || a), ef === t && (a = eX(n) || a), (ef = t), (e_ = n), a;
}
function tS() {
    let e = V.ZP.getCurrentSidebarChannelId(ef),
        t = !1;
    return e_ !== e ? ((t = tN(e_)), (e_ = e)) : (t = eX(e) || t), t;
}
function tT(e) {
    let { channelId: t } = e;
    if (null == t) return;
...
class tJ extends (i = l.ZP.Store) {
    initialize() {
        let e = [Z.Z, J.default, Y.Z, H.Z, F.Z, Q.Z, K.Z, z.Z, p.Z, C.Z, R.Z, V.ZP, b.ZP, E.Z, m.Z, X.ZP, $.Z, T.Z, O.Z, D.Z, I.Z];
