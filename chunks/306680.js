    ...
    rebuildChannelState(e) {
        ...
        if (((this.ackMessageId = null != (t = null != e ? e : this._ackMessageId) ? t : this.guessAckMessageId()), (this.isManualAck = null != e), (this.oldestUnreadMessageId = null), (this.estimated = !1), (this.unreadCount = 0), r && (this.mentionCount = 0), this.hasUnread())) {
            ...
            s.forAll((n) => {
                ...
                G.default.extractTimestamp(n.id) > t ? (this.unreadCount++, r && eP(n, e) && this.mentionCount++, (a = null != a ? a : n.id)) : (o = !0);
            }),
...
function e9(e) {
    ...
    let h = t === i || n === i;
    if ((h && ek(s) && !a) || (null != r && r.isInstanceFocused() && h && r.isInstanceLocked() && r.isPinned(ee.Odu.TEXT))) return s.ack({ messageId: o.id });
...
function tb(e) {
    ...
    if (null == i) return !1;
    let o = eM.get(i, ei.W.NOTIFICATION_CENTER);
    n.forEach((e) => {
...
function tI(e) {
    ...
    tA(ef), tA(e_);
    let o = !1;
    return ef !== t && ((o = tN(ef) || o), (o = tN(e_) || o)), (ef === t || ((null == r ? void 0 : r.type) != null && ee.TPd.GUILD_THREADS_ONLY.has(r.type))) && (o = eX(t) || o), ef === t && (o = eX(n) || o), (ef = t), (e_ = n), o;
}
function tS() {
...
class tJ extends (i = l.ZP.Store) {
    ...
    getGuildChannelUnreadState(e, t, n, r, i) {
        return eM.getValue(e.id, ei.W.CHANNEL, (o) => o.getGuildChannelUnreadState(e, t, n, r, i), {
            mentionCount: 0,
            unread: !1,
            isMentionLowImportance: !1
        });
