...
function ej(e) {
    ...
    if (!m.Z.getChatOpen(e.channelId) && (i === ee.AEg.NO_CHAT || i === ee.AEg.FULL_SCREEN))
...
class eM {
            ...
            !(
                ...
                (!this._isThread &&
                    ...
                    (this._lastMessageTimestamp < eS ||
                        (!X.ZP.isChannelOrParentOptedIn(this._guildId, this.channelId) &&
    ...
    canHaveMentions() {
        return (
            !(
                ...
                (this._isThread && !this._isJoinedThread) ||
                (0, S.h3)(this.channelId, [v.Z, I.Z]) ||
                ((0, A.r1)(this._guildId) && this._lastMessageTimestamp < eS)
            ) && this.canTrackUnreads()
        );
    }
    getGuildChannelUnreadState(e, t, n, r, i) {
        if (
            t &&
            (this._lastMessageTimestamp < eS ||
                (!X.ZP.isChannelRecordOrParentOptedIn(e) &&
                    !this.hasRecentlyVisitedAndRead() &&
                    this.mentionCount <= 0))
        )
            return {
        ...
        return (
            ...
            (!this.isManualAck &&
                (this.type !== ei.W.CHANNEL ||
                    !!this.loadedMessages ||
                    !!(null == (r = B.Z.getChannel(this.channelId)) ? void 0 : r.isForumLikeChannel())))
        );
    }
    _ack(e, t) {
    ...
    e.forEach((e) => {
        if ((0, L.Em)(e.type)) {
            ...
            (t._guildId = e.guild_id),
                ...
                (t.lastPinTimestamp = eA(e.lastPinTimestamp)),
    ...
    e.forEach((e) => {
        if ((0, L.Em)(e.type)) {
            ...
            (n.lastMessageId = e.last_message_id),
                (n.lastPinTimestamp = eA(e.last_pin_timestamp)),
    ...
    null == (t = e.threads) ||
        t.forEach((t) => {
            ...
            (n.lastMessageId = t.lastMessageId),
                (n.lastPinTimestamp = eA(t.lastPinTimestamp)),
                (n._isThread = !0),
                (n._isActiveThread = !0),
    ...
    eC(),
        ...
        a.entries.forEach((e) => {
            ...
            null != a && (0, L.Q5)(a.type) && (null == e.last_message_id || 0 === e.last_message_id)
                ...
                (i.ackPinTimestamp = eA(e.last_pin_timestamp)),
...
function e2(e) {
    for (let t of e) {
        ...
        null != t.last_message_id && (e.lastMessageId = t.last_message_id),
            null != t.last_pin_timestamp && (e.lastPinTimestamp = eA(t.last_pin_timestamp));
    }
}
function e4(e) {
...
function e5(e) {
    ...
    eC(),
        (e_ = null),
        (ef = n),
        (ep = F.ZP.getCurrentSidebarChannelId(ef)),
        eM.clearAll(),
        t.forEach((e) => {
...
function te(e, t, n) {
    ...
    if (X.ZP.mentionOnAllMessages && null != r) {
        if (r.isThread()) {
            ...
            !r.isVocal() &&
            !X.ZP.isChannelMuted(r.guild_id, r.id) &&
            X.ZP.resolvedMessageNotifications(r) === ee.bL.ALL_MESSAGES
        )
            return {
                shouldMention: !0,
                isMentionLowImportance: !0,
...
function th(e) {
    ...
    (null != n.ackMessageId ? G.default.extractTimestamp(n.ackMessageId) : 0) < i &&
        ...
        C.Z.active ? tk(t.id, ei.W.NOTIFICATION_CENTER, void 0, !1) : r ? n.mentionCount-- : n.mentionCount++);
}
function tg(e) {
    let t = J.default.getCurrentUser();
...
function tE(e) {
    ...
    if (((i.lastMessageId = n.id), C.Z.active || 0)) return void tk(r, ei.W.NOTIFICATION_CENTER, n.id, !1);
    i.mentionCount++;
}
function tb(e) {
    var t;
    let { ids: n, optimistic: r } = e;
    if (r || C.Z.active) return !1;
