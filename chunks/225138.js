...
function z(e) {
    ...
    let l,
        ...
        u,
        d,
        { channel: f, message: g, target: m, mediaItem: h, shouldHideMediaOptions: p, onSelect: b, onHeightUpdate: O } = e,
...
function B(e) {
    let { message: t, channel: n, mediaItem: r, textSelection: a, favoriteableType: s, favoriteableId: c, favoriteableName: z, itemHref: B, itemSrc: K, itemSafeSrc: W, itemTextContent: X, canReport: q, onHeightUpdate: V, onSelect: Q, onClose: J, navId: Y, ariaLabel: $, shouldHideMediaOptions: ee = !1 } = e,
        et = (0, d.Z)(a),
        en = (0, m.Z)(a),
        ei = (0, D.Z)(t, n),
        er = (0, y.Z)(t, n),
        ...
        eO = (0, C.eH)(t),
        eE = (0, L.Z)(t, n),
        ey = (0, g.Z)(null != B ? B : K, X, t, { shouldHideMediaOptions: ee }),
        ev = (0, f.Z)(W, t, {
