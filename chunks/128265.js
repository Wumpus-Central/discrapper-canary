...
class m {
    ...
    receiveMessage(e) {
        ...
        if (this.hasMoreAfter) this._after.wasAtEdge && (this._after.wasAtEdge = !1);
            ...
            let n,
                ...
                i = this.last();
            return ((n =
                null != i && 0 > c.default.compare(e.id, i.id) && _.A.getConfig({ location: "receiveMessage" }).enabled
                    ? this.mutate((e) => {
                          let t = e._map[r.id];
                          (e._map[r.id] = r),
                              null != t
                                  ? (e._array[e._array.indexOf(t)] = r)
                                  : d.Y(e._array, r, (e, t) => c.default.compare(e.id, t.id));
                      }, !0)
                    : this.merge([r])),
            t)
    ...
    loadComplete(e) {
        ...
        return h.mutate({
            ...
            error: !1,
            initialScrollSequenceId: E ? h.initialScrollSequenceId + 1 : h.initialScrollSequenceId,
            suppressRowAnimationSequenceId: E ? h.suppressRowAnimationSequenceId + 1 : h.suppressRowAnimationSequenceId,
        });
    }
