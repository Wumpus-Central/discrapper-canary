...
function j(e) {
    let { onClose: t, onSelect: n, channel: j, remoteMode: E, onInteraction: S } = e,
        ...
        w = (0, i.e7)([o.Z], () =>
            (null == N ? void 0 : N.type) === C.fO.ACTIVITY ? o.Z.getApplication(N.applicationId) : void 0,
        ),
        R = (0, h.Z)(P),
        M = (0, _.Z)(P),
    ...
    return (0, r.jsxs)(l.v2r, {
        ...
        children: [
            ...
            (0, r.jsxs)(l.kSQ, {
                children: [
                    Z === x.d4z.GUILD_STAGE_VOICE ? U : null,
                    Z === x.d4z.GUILD_STAGE_VOICE ? B : null,
                    E || Z === x.d4z.GUILD_STAGE_VOICE ? null : L,
                    H,
                    Z !== x.d4z.GUILD_STAGE_VOICE ? R : null,
                    Z === x.d4z.GUILD_STAGE_VOICE || Z === x.d4z.GUILD_VOICE ? M : null,
                ],
            }),
