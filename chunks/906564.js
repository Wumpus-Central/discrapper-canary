...
function f(e) {
    ...
    if ((l.h.dispatch({ type: "REGISTER" }), null != x)) {
        let e;
        (0, _.A)(x, p.JJy.REGISTER),
            u.default.track(p.HAw.AGE_GATE_ACTION, { source: g.w_.REGISTER, action: g.AM.AGE_GATE_SUBMITTED }),
            (e = s()().diff(x, "years")) < 13 ||
                u.default.track(p.HAw.USER_AGE_SUBMITTED, {
    ...
    return h.A.post({
        ...
        (e) => {
            l.h.dispatch({ type: "REGISTER_SUCCESS", token: e.body.token }),
                u.default.track(p.HAw.AGE_GATE_ACTION, { source: g.w_.REGISTER, action: g.AM.AGE_GATE_SUCCESS });
        },
        (e) => {
            ...
            throw (
                ...
                u.default.track(p.HAw.REGISTER_SUBMIT_ERRORED, {
