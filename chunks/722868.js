...
var t = n(627968),
    ...
    g = n(375708);
function f(e) {
    let { user: l, guildId: n, channelId: f, displayProfile: m, onClose: p } = e,
        ...
        : m?.guildId != null
          ...
          : m?.guildId != null
            ...
            : (0, t.jsx)(i.Dr, {
                  ...
                  subtext: g.intl.formatToPlainString(g.t["mn/nW2"], { displayName: a.Ay.getName(n, f, l) }),
                  action: () => {
                      p?.(),
                          (0, d.openUserProfileModal)({ userId: l.id, ...h, guildId: n, sourceAnalyticsLocations: v }),
