...
function b(e) {
    let { username: t, discriminator: n, email: r, emailToken: a, password: s, avatar: c, avatarDescription: _, avatarId: h, avatarDecoration: m, newPassword: g, globalName: b, nameplate: y, primaryGuildId: O } = e;
    return (
        ...
        (0, l.Z)(
            (e) => {
                ...
                null === m && (o.avatar_decoration_id = null), null != m && ((o.avatar_decoration_id = m.id), (o.avatar_decoration_sku_id = m.skuId)), null === y && (o.nameplate_id = null), null != y && ((o.nameplate_id = y.id), (o.nameplate_sku_id = y.skuId)), void 0 !== O && (o.primary_guild_id = O);
                let l = i.K.get(u.JkL),
                    f = (0, d.xJ)();
