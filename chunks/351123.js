...
function U(e) {
    let { guild: t, channel: i, isPrivateGuildChannel: l, roles: c, members: d } = e,
        u = (0, a.e7)([Z.Z], () => Z.Z.can(L.Pl.ADMINISTRATOR, t)),
        h = T.Uu(L.Pl.VIEW_CHANNEL, t),
        g = T.Uu(L.Pl.ADMINISTRATOR, t);
    async function m() {
    ...
    return (
        i.isCategory() ? ((p.title = A.NW.string(A.t.lEPAZ2)), (p.subtitle = A.NW.string(A.t['RQUk6+'])), (p.formLabel = A.NW.string(A.t['8VIxJi']))) : i.type === D.d4z.GUILD_VOICE && (p.subtitle = A.NW.string(A.t.cLjvKi)),
        (0, r.jsxs)('div', {
...
let z = a.ZP.connectStores([C.Z, Z.Z, S.ZP, w.Z], () => {
    ...
    let { canSyncChannel: t, category: l, channel: s, filteredMembers: a, filteredRoles: c, guild: d, isPrivateGuildChannel: h, locked: g, permissionUpdates: m } = e,
        [p, f] = i.useState(!T.Uu(L.Pl.SEND_MESSAGES, s));
