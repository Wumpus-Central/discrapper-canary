...
function F(e, t) {
    let { forceBatchScan: n = !1, jitter: r = !1 } = null != t ? t : {},
        i = (null == t ? void 0 : t.isMessageUpdate) ? e.filter(A.MD).filter(V) : e.filter(V);
    i.forEach((e) => {
        let t = M(e);
        null == x[t] &&
        ...
        r = e
            .map((e) => {
                if (R.OBS.has(e.type) && null != e.messageReference) {
                    ...
                    if (t.state === _.Y.LOADED && null != t.message && (0, y.O)(t.message) && 0 !== (0, A.rb)(t.message)) return t.message;
                }
            })
            .filter(t);
    r.length > 0 && (n = [...n, ...r]);
