...
function W(e, t) {
    var n;
    return null == t ? e : L(Z({}, e), { presence: L(Z({}, e.presence), { activity: null != (n = I.Z.getApplicationActivity(e.user.id, t)) ? n : null }) });
}
function Y(e) {
    let t;
    if (null == e) return !1;
...
function er(e) {
    if (e !== A.He.POST_MESSAGE) throw new P.Z({ errorCode: x.lTL.INVALID_COMMAND }, 'command not available from "'.concat(e, ' transport'));
}
function ei(e) {
