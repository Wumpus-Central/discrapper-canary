...
class S extends a.Component {
    ...
    render() {
        let {
            ...
            { hasAcceptedEULA: T, hasAcceptedWithdrawalWaiver: U } = this.state;
        return (c()(!S || null != g, "subscriptionPlan cannot be null if shouldShowTrialOrDiscountLayout is true"),
        l || (null != e && !a) || v)
            ? (0, i.jsxs)("div", {
                  className: d,
                  children: [
                      ...
                      null != e && (l || !a)
                          ...
                          : null,
                      null == p ? null : (0, i.jsx)("div", { className: n()(f.aO, C), children: p }),
                      v
                          ? (0, i.jsxs)("div", {
                                className: d,
                                children: [
                                    ...
                                    (0, i.jsx)("div", { className: f.aO, children: L.intl.string(L.t.jhu6zm) }),
                                ],
                            })
                          : null,
                      A &&
                      ...
                      (0, i.jsx)(E, { isTrial: S, subscriptionPlan: g, isDiscount: b }),
                  ],
              })
            : null;
    }
...
function E(e) {
    let { isTrial: t, subscriptionPlan: s, isDiscount: a } = e;
...
let b = d.Ay.connectStores([A.A], (e) => {
    let { eulaId: t } = e;
