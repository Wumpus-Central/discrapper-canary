    ...
    try {
        if ((i(!0), r(!1), [Y.O0b.PAST_DUE, Y.O0b.PAUSED, Y.O0b.BILLING_RETRY].includes(t.status))) await (0, _.EO)(t.id, o, a);
            ...
            await (0, _.Mg)(
                ...
                (0, j.UX)(n, t.currency, t.paymentSourceId),
                o,
                a
            );
        }
    ...
    let P =
            ...
            (null == (t = n.renewalMutations)
                ...
                : (0, r.jsx)(p.zxk, {
                      ...
                      text: l ? H.intl.string(H.t['cY+Ooa']) : H.intl.formatToPlainString(H.t['V3+Rpa'], { planPremiumType: j.ZP.getDisplayPremiumType(n.planId) }),
                      disabled: _,
                      onClick: async () => {
                          await X({
                              setHasError: g,
            ...
            l
                ...
                : (0, r.jsxs)(p.xBx, {
                      ...
                      children: [
                          (0, r.jsx)(p.vwX, {
                              tag: p.RB0.H4,
                              children: H.intl.format(H.t.ZpiGy8, { planPremiumType: j.ZP.getDisplayPremiumType(n.planId) })
                          }),
                          (0, r.jsx)(p.olH, { onClick: s })
                      ]
                  }),
            (0, r.jsxs)(p.hzk, {
                className: W.body,
...
function V(e) {
    ...
    if (null == a || null == s) return (0, r.jsx)(p.$jN, { className: W.loading });
    let { intervalType: l, intervalCount: c } = j.ZP.getIntervalForInvoice(a);
    return (0, r.jsxs)('div', {
        ...
        children: [
            ...
            (0, r.jsxs)(N.aO, {
                children: [
                    ...
                    (0, r.jsx)(N.B1, {
                        label: H.intl.formatToPlainString(H.t.r3jVZm, { planName: j.ZP.getDisplayName(s.id) }),
                        value: (0, j.PK)(s),
            ...
            (0, r.jsxs)(p.hzk, {
                ...
                children: [
                    d
                        ...
                        : null,
                    (0, r.jsx)(V, { premiumSubscription: t })
                ]
            }),
            (0, r.jsxs)(p.mzw, {
                ...
                children: [
                    (0, r.jsx)(p.zxk, {
                        variant: 'critical-primary',
                        text: H.intl.format(H.t['V3+Rpa'], { planPremiumType: j.ZP.getDisplayPremiumType(t.planId) }),
                        disabled: c,
                        onClick: async () => {
                            await X({
                                setHasError: m,
...
function Q(e) {
    ...
    let { premiumSubscription: o } = e,
        ...
        { enabled: s, expressive: l } = (0, O.S)({ location: 'Churn Modal' });
    return !a && s
        ? (0, r.jsx)(
              R.I,
              ((n = G({}, e)),
...
let $ = (e) => {
    var t;
    let n,
        { premiumSubscription: o, transitionState: a, onClose: l, analyticsLocations: u, analyticsLocation: _ } = e,
        { initialStep: x } = e,
        y = i.useRef(new s.qA()),
        [b, I] = i.useState(null),
    ...
    let $ = (e) => {
        ...
        ee = (0, P.UV)(),
        { churnUserDiscountOffer: et, isFetchingChurnDiscountOffer: en } = (0, P.WR)(!ee || L !== B.R.WHAT_YOU_LOSE),
        er = (0, S.Z)(),
