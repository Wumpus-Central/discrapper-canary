...
function K(e) {
    var t, a;
    let { onClose: i, transitionState: y, location: h, appContext: S } = e,
        R = (0, o.e7)([x.default], () => x.default.getFocusedPID()),
        F = null != R ? R : (0, I.getPID)(),
        U = (0, o.e7)([Z.default], () => Z.default.getTrackedGameByPid(F), [F]),
        [K, q] = r.useState(null),
        [z, H] = r.useState(""),
        X = (function () {
            let e = (0, j.II)(),
            ...
            switch (!0) {
                case null != l:
                    return {
                        ...
                        trackedGame: l,
                        runningGame: null != l.gameName && null != (s = p.ZP.getGameForName(l.gameName)) ? s : void 0,
                    };
                case null != e:
                    var i, u, d, s, c, m;
        ...
        [V, Y] = r.useState(
            null !=
                (a = null != (t = null == X ? void 0 : X.fullscreenType) ? t : null == U ? void 0 : U.fullscreenType)
                ? a
                : null,
        ),
        [Q, $] = r.useState(X),
        ...
        es = async () => {
            el(!0), await (0, d._v)(500), el(!1);
        },
        ec = async () => {
            var e, t, r, a, u;
            if (null === K && 0 === z.length) {
                ea(!0), es();
                return;
            }
            et(!0);
            let o = null != (r = x.default.getFocusedPID()) ? r : (0, I.getPID)(),
                c = Z.default.getTrackedGameByPid(o),
                g = G.Z.getPopoutInitializationStages(),
                p = (null == c ? void 0 : c.overlayMethod) != null ? P.gl[c.overlayMethod] : null,
            ...
            await _.default.track(T.rMx.OVERLAY_BUG_REPORT, M),
                await (0, d._v)(1000),
                et(!1),
                null == i || i(),
                (0, s.ZDy)(
