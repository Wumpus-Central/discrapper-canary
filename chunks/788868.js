...
let X = Object.freeze({ 3: R.t["t9uG/o"], 1: R.t.FSOz78, 2: R.t.lG6a5x }),
    ...
    eH = "1397609029626232955",
    ej = "1460778896906522665",
    eY = 8,
    eW = 96,
    eK = Object.freeze({
...
let eq = Object.freeze({
    ...
    eJ = 262144e3,
    e0 = 5,
    e1 = { [v.TVA.NONE]: e0, [v.TVA.TIER_1]: 10, [v.TVA.TIER_2]: 15, [v.TVA.TIER_3]: 30 },
    e2 = {
        [v.TVA.NONE]: e1[v.TVA.NONE],
        [v.TVA.TIER_1]: e1[v.TVA.NONE] + e1[v.TVA.TIER_1],
        [v.TVA.TIER_2]: e1[v.TVA.NONE] + e1[v.TVA.TIER_1] + e1[v.TVA.TIER_2],
        [v.TVA.TIER_3]: e1[v.TVA.NONE] + e1[v.TVA.TIER_1] + e1[v.TVA.TIER_2] + e1[v.TVA.TIER_3],
    },
    e3 = { [v.TVA.NONE]: eY, [v.TVA.TIER_1]: 24, [v.TVA.TIER_2]: 36, [v.TVA.TIER_3]: 48 },
    e6 = Object.freeze({
        [v.TVA.NONE]: {
            features: [],
            limits: {
                ...
                soundboardSounds: e3[v.TVA.NONE],
                stickers: e2[v.TVA.NONE],
        ...
        [v.TVA.TIER_1]: {
            ...
            limits: {
                ...
                screenShareQualityResolution: "720p",
                soundboardSounds: e3[v.TVA.TIER_1],
                stickers: e2[v.TVA.TIER_1],
                stageVideoUsers: v._i_,
            },
        },
        [v.TVA.TIER_2]: {
            ...
            limits: {
                ...
                soundboardSounds: e3[v.TVA.TIER_2],
                stickers: e2[v.TVA.TIER_2],
        ...
        [v.TVA.TIER_3]: {
            ...
            limits: {
                ...
                screenShareQualityFramerate: 60,
                screenShareQualityResolution: "1080p",
                soundboardSounds: e3[v.TVA.TIER_3],
                stickers: e2[v.TVA.TIER_3],
...
let tr = Object.freeze({ IS_BLOCKED_IOS: 32, IS_OUTBOUND_REDEEMABLE_BY_TRIAL_USERS: 64, SUPPRESS_NOTIFICATION: 128 }),
    ts = Object.freeze({ 3: { fileSize: 0x3200000 }, 1: { fileSize: 0x3200000 }, 2: { fileSize: eX } });
