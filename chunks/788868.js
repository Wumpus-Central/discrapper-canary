...
let Z = Object.freeze({ 3: R.t["t9uG/o"], 1: R.t.FSOz78, 2: R.t.lG6a5x }),
    ...
    eC = [e_, eh, ef, ep, eE, em, eg, eA, eI, eT, eS, "1271484512081285191", ey],
...
let eq = Object.freeze({
    ...
    eJ = 262144e3,
    e0 = 5,
    e1 = { [N.TVA.NONE]: e0, [N.TVA.TIER_1]: 10, [N.TVA.TIER_2]: 15, [N.TVA.TIER_3]: 30 },
    e2 = {
        [N.TVA.NONE]: e1[N.TVA.NONE],
        [N.TVA.TIER_1]: e1[N.TVA.NONE] + e1[N.TVA.TIER_1],
        [N.TVA.TIER_2]: e1[N.TVA.NONE] + e1[N.TVA.TIER_1] + e1[N.TVA.TIER_2],
        [N.TVA.TIER_3]: e1[N.TVA.NONE] + e1[N.TVA.TIER_1] + e1[N.TVA.TIER_2] + e1[N.TVA.TIER_3],
    },
    e3 = { [N.TVA.NONE]: eY, [N.TVA.TIER_1]: 24, [N.TVA.TIER_2]: 36, [N.TVA.TIER_3]: 48 },
    e6 = Object.freeze({
        [N.TVA.NONE]: {
            features: [],
            limits: {
                ...
                soundboardSounds: e3[N.TVA.NONE],
                stickers: e2[N.TVA.NONE],
        ...
        [N.TVA.TIER_1]: {
            ...
            limits: {
                ...
                screenShareQualityResolution: "720p",
                soundboardSounds: e3[N.TVA.TIER_1],
                stickers: e2[N.TVA.TIER_1],
                stageVideoUsers: N._i_,
            },
        },
        [N.TVA.TIER_2]: {
            ...
            limits: {
                ...
                soundboardSounds: e3[N.TVA.TIER_2],
                stickers: e2[N.TVA.TIER_2],
        ...
        [N.TVA.TIER_3]: {
            ...
            limits: {
                ...
                screenShareQualityFramerate: 60,
                screenShareQualityResolution: "1080p",
                soundboardSounds: e3[N.TVA.TIER_3],
                stickers: e2[N.TVA.TIER_3],
    ...
    e5 = ["590665532894740483", "944037355453415424", "944037391444738048", "590665538238152709"];
var e7 =
        ...
        (d.PRESET = "preset"),
        d),
    e8 = (((_ = {}).FREE = "free"), (_.PREMIUM_STANDARD = "premium-standard"), _);
let e9 = {
...
var te =
    ...
    h);
let tt = Object.freeze({ high_streaming_quality: 2, mid_streaming_quality: 1 });
var tn =
    ...
    ti =
        ...
        p);
let tr = Object.freeze({ IS_BLOCKED_IOS: 32, IS_OUTBOUND_REDEEMABLE_BY_TRIAL_USERS: 64, SUPPRESS_NOTIFICATION: 128 }),
    ts = Object.freeze({ 3: { fileSize: 0x3200000 }, 1: { fileSize: 0x3200000 }, 2: { fileSize: eZ } });
var ta = (((E = {}).BOOST = "boost"), (E.DISMISS = "dismiss"), E);
let to = new Set(["PL", "TR"]),
    tl = [1, 2, 3];
[8, 9, 11, 10].concat(tl);
let tu = 190;
var tc = (((m = {})[(m.FRIEND_ANNIVERSARY = 0)] = "FRIEND_ANNIVERSARY"), m),
    td = (((g = {}).VIEW_ALL = "view_all"), (g.SEND_MESSAGE = "send_message"), g),
    t_ =
...
var tA =
        ...
        T),
    tI = (((S = {})[(S.HOUR = 1)] = "HOUR"), (S[(S.DAY = 2)] = "DAY"), S);
let tT = {
