...
function O(e) {
    let t,
        ...
        b = r.useCallback(() => {
            null != d && T.Ay.isCatalogStaleFor(d) && (0, N.RS)(d);
        }, [d]),
    ...
    let I = _ ? void 0 : E?.complex_icon_animated_url,
        v = I ?? E?.complex_icon_static_url ?? E?.simple_icon_url ?? u,
        D = null != I && v === I;
...
function eI(e) {
    let {
        ...
        j = r.useRef(null),
        C = r.useRef(null),
        { analyticsLocations: y } = (0, I.Ay)(x.A.BADGE),
    ...
    r.useEffect(() => {
        (w || H) && s?.userId != null && !T.Ay.hasCatalogFor(s.userId) && (0, N.RS)(s.userId);
    }, [w, H, s?.userId]);
    let V = s?.userId,
        $ = (0, g.bG)([T.Ay], () => {
        ...
        children: t.map((e, t) => {
            let n = e.id === es.A.ORB_PROFILE_BADGE,
                ...
                v = (0, a.jsx)("img", {
                    alt: " ",
                    "aria-hidden": !0,
                    src: e.iconSrc ?? N ?? (0, z.L7)(e.icon),
                    className: m()(ex.qS, null != N && ex.Do, l),
                }),
                T = null != d && d(e.id),
                D = {
                    onClick: (a) => {
...
function eT(e) {
    ...
    let g = n === eN.d.MODAL_V2 ? [m] : (0, l.chunk)(m, !0 === s && n === eN.d.SIDEBAR ? ev[eN.d.POPOUT] : ev[n]);
