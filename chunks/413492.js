...
function y(e) {
    let t,
        ...
        b = (0, g.bG)([S.Ay], () => S.Ay.useReducedMotion),
        _ = l.useCallback(() => {
            null != d && v.Ay.isCatalogStaleFor(d) && (0, x.RS)(d);
        }, [d]),
    ...
    let T = b ? void 0 : E?.complex_icon_animated_url,
        D = T ?? E?.complex_icon_static_url ?? E?.simple_icon_url ?? u,
        y = null != T && D === T;
    if (A) return (0, a.jsx)(M, { userId: d, title: n, badgeImage: D, children: s });
...
function M(e) {
    ...
    return (0, a.jsx)(C.A, { title: l, body: s, badgeImage: r, badgeName: l, children: t });
}
var O = n(470739),
    P = n(34332),
    U = n(459192);
...
function eA(e) {
    let {
        ...
        j = l.useRef(null),
        S = l.useRef(null),
        { analyticsLocations: C } = (0, R.Ay)(A.A.BADGE),
        { context: D, trackUserProfileAction: M } = (0, eE.NJ)(),
    ...
    l.useEffect(() => {
        (G || w) && s?.userId != null && !v.Ay.hasCatalogFor(s.userId) && (0, x.RS)(s.userId);
    }, [G, w, s?.userId]);
    let L = s?.userId,
        H = (0, g.bG)([v.Ay], () => {
    ...
    return (0, a.jsx)("div", {
        ...
        children: t.map((e, t) => {
                    ...
                    onClick: (a) => {
                        ...
                        if (c) {
                            if (
                                ...
                                f
                                    ? ((0, en.pX)(ep.BVt.NITRO_HOME), (0, p.closeAllModals)())
                                    : (0, J.D)({ analyticsLocations: C, displayProfile: s }),
                                    i?.();
                                return;
                            }
                            if (f) {
                                let t = null != e.link ? (0, h.default)(e.link, { analyticsLocations: C }) : null;
                                if (null == t) return;
                                return i?.(), (0, p.closeAllModals)(), t(a);
                            }
                            return (0, J.D)({ analyticsLocations: C, displayProfile: s }), void i?.();
                        }
                        let r = null != e.link ? (0, h.default)(e.link, { analyticsLocations: C }) : null;
            ...
            if (G)
                return (0, a.jsx)(
                    y,
                    {
                        ...
                        children: (0, a.jsx)(b.Anchor, { ...T, children: N }),
                    },
                    `${e.id}-${t}`,
                );
            if (R) {
                let n = (0, a.jsx)(b.Anchor, { ...T, ref: E, children: N });
                return (0, a.jsx)(
                    "div",
                    {
                        children: (0, a.jsx)(F, {
            ...
            if (n) {
                let n = (0, a.jsx)(b.Anchor, { ...T, ref: j, children: N });
                return (0, a.jsx)(
                    ed,
                    {
                        targetElementRef: j,
            ...
            if (g) {
                let n = (0, a.jsx)(b.Anchor, { ...T, ref: S, children: N });
                return (0, a.jsx)(
                    B,
                    { targetElementRef: S, delay: X.In, forceOpen: v, badgeDescription: e.description, children: n },
                    `${e.id}-${t}`,
                );
            }
            let w = (0, a.jsx)(b.Anchor, { ...T, children: N }),
                L = (function (e) {
