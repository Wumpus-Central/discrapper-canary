...
let K = function (e) {
    ...
    return (0, a.jsxs)("div", { className: Y.R, children: [t, (0, a.jsx)("div", { className: Y.A, children: n }), l] });
};
var q = n(224016),
    Z = n(632707);
let Q = function (e) {
...
function eo(e) {
    ...
    return (0, a.jsxs)(K, {
        ...
        children: [
            ...
            t
                ? (0, a.jsx)(W.E, { variant: "text-xs/normal", className: ei.lV, children: c.intl.string(c.t.MEV0GI) })
                : void 0,
        ],
    });
}
...
function eA(e) {
    let {
        ...
        B = (0, eu.CC)(U?.premiumType, V.PremiumTypes.TIER_2),
    ...
    return (0, a.jsx)("div", {
        ...
        children: t.map((e, t) => {
            let n = e.id === ea.A.ORB_PROFILE_BADGE,
                ...
                T = {
                    onClick: (a) => {
                        ...
                        let r = null != e.link ? (0, h.default)(e.link, { analyticsLocations: S }) : null;
            ...
            if (g) {
                let n = (0, a.jsx)(b.Anchor, { ...T, ref: C, children: N });
                return (0, a.jsx)(
                    k,
