    ...
    return (
        null != i
            ? s === i.planId && s === o.IW[e]
                ...
                : s === i.planId && s === o.mn[e]
                  ? (s = o.IW[e])
                  : (i.planId === o.Xh.PREMIUM_YEAR_TIER_0 || i.planId === o.Xh.PREMIUM_YEAR_TIER_1) &&
                    s === o.Xh.PREMIUM_MONTH_TIER_2 &&
                    (s = o.Xh.PREMIUM_YEAR_TIER_2)
            : s === o.Xh.PREMIUM_YEAR_TIER_1 && (s = o.Xh.PREMIUM_MONTH_TIER_1),
        s
    );
}
