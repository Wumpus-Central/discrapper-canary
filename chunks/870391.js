...
class c extends i.Ay.PersistedStore {
    ...
    initialize(e) {
        this.waitFor(l.A, a.A, s.A, u.default), null != e && ((o = e.groups ?? []), (d = e.isInitialized ?? !1));
    }
    getGroups() {
        return o;
    }
...
let h = new c(r.h, {
    ...
    ADD_USERS_TO_GROUP: function (e) {
        ...
        let r = o[i],
            s = new Set(r.userIds),
            l = n.filter((e) => !s.has(e));
        return 0 !== l.length && ((o[i] = { ...r, userIds: [...r.userIds, ...l] }), !0);
    },
    REMOVE_USERS_FROM_GROUP: function (e) {
        ...
        let r = o[i],
            s = new Set(n),
            l = r.userIds.filter((e) => !s.has(e));
        return l.length !== r.userIds.length && ((o[i] = { ...r, userIds: l }), !0);
    },
});
