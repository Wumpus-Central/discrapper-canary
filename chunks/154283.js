...
function l(e, t, n) {
    void 0 === n && (n = !1),
        0 === u(e)
            ? (n ? Object.keys : $)(e).forEach(function (i) {
...
function u(e) {
    var t = e[W];
    return t ? (t.i > 3 ? t.i - 4 : t.i) : Array.isArray(e) ? 1 : _(e) ? 2 : 3 * !!h(e);
}
function c(e, t) {
...
function R(e, t, n, i, r, s, l) {
    if (a(r)) {
        var u = C(e, r, s && t && 3 !== t.i && !c(t.R, i) ? s.concat(i) : void 0);
...
var x,
    ...
    j = F ? Symbol.for("immer-nothing") : (((U = {})["immer-nothing"] = !0), U),
...
var ef = function (e) {
        ...
        for (var l of i) {
            ...
            if (
                ...
                (r & k.ZWJ) != 0 &&
                    (s & k.ExtPict) != 0 &&
                    !(n ? ek(e.substring(0, a)) : ek(e.substring(0, e.length - a))))
            )
                break;
            if (
                ((r & k.RI) != 0 &&
...
var eN =
    ...
    eM = (e, t) => {
        var n = k.Any;
        return (
            -1 !== e.search(eN) && (n |= k.Extend),
            8205 === t && (n |= k.ZWJ),
            t >= 127462 && t <= 127487 && (n |= k.RI),
            -1 !== e.search(ev) && (n |= k.Prepend),
            -1 !== e.search(eC) && (n |= k.SpacingMark),
            -1 !== e.search(eR) && (n |= k.L),
            -1 !== e.search(eO) && (n |= k.V),
            -1 !== e.search(eb) && (n |= k.T),
            -1 !== e.search(eD) && (n |= k.LV),
            -1 !== e.search(eL) && (n |= k.LVT),
            -1 !== e.search(ew) && (n |= k.ExtPict),
            n
        );
    },
    eP = [
        [k.L, k.L | k.V | k.LV | k.LVT],
        [k.LV | k.V, k.V | k.T],
        [k.LVT | k.T, k.T],
        [k.Any, k.Extend | k.ZWJ],
        [k.Any, k.SpacingMark],
        [k.Prepend, k.Any],
        [k.ZWJ, k.ExtPict],
        [k.RI, k.RI],
    ...
    eF = (e) => r(e) && eZ.isNodeList(e.children) && !eK.isEditor(e),
    eV = {
        isAncestor: (e) => r(e) && eZ.isNodeList(e.children),
        isElement: eF,
...
var eW = new WeakMap(),
            ...
            if ((c || (c = () => !0), s)) {
                ...
                for (var [p, E] of h) {
                    ...
                    if ("highest" !== a || !m) {
                        ...
                        g && (o ? f.push(g) : yield g), (i = [p, E]);
                    }
                }
                "lowest" === a && i && (o ? f.push(i) : yield i), o && (yield* f);
            }
        },
        normalize(e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
            ...
            if (n) {
                ...
                for (var [p, E] of eK.nodes(e, { at: n, reverse: r, voids: s })) {
                    ...
                    if (tl.isText(p)) {
                        ...
                        for (
                            S
                                ? ((h = r ? u.offset : p.text.length - u.offset), (f = u.offset))
                                : ((h = p.text.length), (f = r ? h : 0)),
                                (S || c || "offset" === i) && (yield { path: E, offset: f }, (c = !1));
                            ;
                        ) {
                            if (0 === _) {
                                if ("" === d) break;
                            ...
                            if (((f = r ? f - _ : f + _), (h -= _) < 0)) {
                                _ = -h;
                                break;
                            }
                            (_ = 0), yield { path: E, offset: f };
                        }
                    }
                }
            }
    ...
    e$ = { isSpan: (e) => Array.isArray(e) && 2 === e.length && e.every(e1.isPath) },
    ez = ["children"],
    eq = ["text"],
    eX = new WeakMap(),
    eZ = {
        ...
        *descendants(e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            for (var [n, i] of eZ.nodes(e, t)) 0 !== i.length && (yield [n, i]);
        },
        *elements(e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            for (var [n, i] of eZ.nodes(e, t)) eV.isElement(n) && (yield [n, i]);
        },
        extractProps(e) {
            if (eV.isAncestor(e)) {
                var t = eh(e, ez);
        ...
        first(e, t) {
            for (var n = t.slice(), i = eZ.get(e, n); i; )
        ...
        *nodes(e) {
            for (
                ...
                if (
                    ...
                    e1.isAncestor(o, r) && (u = r[o.length]), (o = o.concat(u)), (l = eZ.get(e, o));
                    continue;
                }
                if (0 === o.length) break;
                if (!i) {
                ...
                if (i && 0 !== o[o.length - 1]) {
                    (o = e1.previous(o)), (l = eZ.get(e, o));
                    continue;
                }
                (o = e1.parent(o)), (l = eZ.get(e, o)), a.add(l);
            }
        },
        parent(e, t) {
            var n = e1.parent(t),
        ...
        string: (e) => (tl.isText(e) ? e.text : e.children.map(eZ.string).join("")),
        *texts(e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            for (var [n, i] of eZ.nodes(e, t)) tl.isText(n) && (yield [n, i]);
        },
    };
function eQ(e, t) {
    var n = Object.keys(e);
...
var e0 = {
        ...
        isOperation(e) {
            ...
            switch (e.type) {
                case "insert_node":
                case "remove_node":
                    return e1.isPath(e.path) && eZ.isNode(e.node);
                case "insert_text":
                case "remove_text":
            ...
            switch (t.type) {
                ...
                case "move_node":
                    ...
                    if (e1.isAncestor(d, i) || e1.equals(d, i)) {
                        var h = _.slice();
                        return (
                            e1.endsBefore(d, _) && d.length < _.length && (h[d.length - 1] -= 1),
                            h.concat(i.slice(d.length))
                        );
                    }
...
var tl = {
    equals(e, t) {
        var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {},
            { loose: i = !1 } = n;
        return ti(i ? eh(e, tr) : e, i ? eh(t, tr) : t);
    },
    ...
    decorations(e, t) {
        ...
        for (var i of t) {
            ...
            for (var d of n) {
                ...
                if ((u !== c && (u === l || c === h)) || u > l || c < h || (c === h && 0 !== h)) {
                    o.push(d);
                    continue;
                }
                var f = d,
                ...
                if (c < l) {
                    var m = c - h;
                    (E = to(to({}, f), {}, { text: f.text.slice(m) })),
                        (f = to(to({}, f), {}, { text: f.text.slice(0, m) }));
                }
                if (u > h) {
                    var g = u - h;
                    (p = to(to({}, f), {}, { text: f.text.slice(0, g) })),
                        (f = to(to({}, f), {}, { text: f.text.slice(g) }));
                }
                Object.assign(f, r), p && o.push(p), o.push(f), E && o.push(E);
            }
            n = o;
        }
        return n;
                                ...
                                switch (n.type) {
                                    ...
                                    case "merge_node":
                                        ...
                                        if ((T.children.splice(S, 1), t))
                                            for (var [y, N] of e9.points(t)) t[N] = e4.transform(y, n);
                                        break;
                                    case "move_node":
                                        var { path: v, newPath: C } = n;
                                        if (e1.isAncestor(v, C))
                                            throw Error(
                                                "Cannot move a path ["
                                        ...
                                        var D = e1.transform(v, n),
                                            L = eZ.get(e, e1.parent(D)),
                                            w = D[D.length - 1];
                                        if ((L.children.splice(w, 0, R), t))
                                            for (var [M, P] of e9.points(t)) t[P] = e4.transform(M, n);
                                        break;
                                    case "remove_node":
                                        var { path: x } = n,
                                            k = x[x.length - 1];
                                        if ((eZ.parent(e, x).children.splice(k, 1), t))
                                            for (var [U, G] of e9.points(t)) {
                                                var F = e4.transform(U, n);
                                                if (null != t && null != F) t[G] = F;
                                                else {
                                                    var V = void 0,
                                                        B = void 0;
                                                    for (var [H, j] of eZ.texts(e))
                                    ...
                                    case "remove_text":
                                        ...
                                        if (((z.text = q + X), t))
                                            for (var [Z, Q] of e9.points(t)) t[Q] = e4.transform(Z, n);
                                        break;
                                    case "set_node":
                                    ...
                                    case "split_node":
                                        ...
                                        var eh = eZ.get(e, ec),
                                            ...
                                            ep = ec[ec.length - 1];
                                        if (tl.isText(eh)) {
                                            var eE = eh.text.slice(0, ed),
                                                em = eh.text.slice(ed);
                                            (eh.text = eE), (eu = tc(tc({}, e_), {}, { text: em }));
                                        } else {
                                            var eg = eh.children.slice(0, ed),
                                                eA = eh.children.slice(ed);
                                            (eh.children = eg), (eu = tc(tc({}, e_), {}, { children: eA }));
                                        }
                                        if ((ef.children.splice(ep + 1, 0, eu), t))
            ...
            ),
            {
                        ...
                        if (
                            ...
                            for (var a of Array.from(eK.nodes(e, { at: n, match: s, mode: i, voids: r }), (t) => {
                                ...
                                if (1 === d) {
                                    ...
                                    var h = e1.next(u);
                                    tT.moveNodes(e, { at: o, to: h, voids: r });
                                } else {
                                    var f = e1.next(o),
                                        p = e1.next(u);
                                    tT.splitNodes(e, { at: f, voids: r }), tT.moveNodes(e, { at: o, to: p, voids: r });
                                }
                            }
                    });
                },
                    ...
                    eK.withoutNormalizing(e, () => {
                        ...
                        if (s) {
                            ...
                            var [_] = eK.nodes(e, { at: s, match: r, voids: o, mode: l }),
                                h = eK.previous(e, { at: s, match: r, voids: o, mode: l });
                            if (_ && h) {
                                var [f, p] = _,
                                    [E, m] = h;
                                if (0 !== p.length && 0 !== m.length) {
                                    var g = e1.next(m),
                                        ...
                                        y = S && eK.pathRef(e, S[1]);
                                    if (tl.isText(f) && tl.isText(E)) {
                                        var N = eh(f, td);
                                        (i = E.text.length), (n = N);
                                    } else if (eV.isElement(f) && eV.isElement(E)) {
                                        var N = eh(f, t_);
                                        (i = E.children.length), (n = N);
                                    } else
                                        throw Error(
                                            "Cannot merge the node at path ["
                                                ...
                                                .concat(tn.stringify(f), " ")
                                                .concat(tn.stringify(E)),
                                        );
                                    I || tT.moveNodes(e, { at: p, to: g, voids: o }),
                                        y && tT.removeNodes(e, { at: y.current, voids: o }),
                        ...
                        if (r) {
                            if (
                                ...
                                var d = eK.rangeRef(e, r, { affinity: "inward" }),
                                    ...
                                    p = eK.isEnd(e, h, h.path);
                                tT.splitNodes(e, { at: h, match: i, mode: f, voids: c, always: !p });
                                var E = eK.isStart(e, _, _.path);
                                tT.splitNodes(e, { at: _, match: i, mode: f, voids: c, always: !E }),
                                    (r = d.unref()),
                ...
                splitNodes(e) {
                    ...
                    eK.withoutNormalizing(e, () => {
                        ...
                        if (o) {
                            var h = eK.pointRef(e, o, { affinity: "backward" });
                            try {
                                var [f] = eK.nodes(e, { at: o, match: a, mode: r, voids: s });
                                if (!f) return;
                                ...
                                for (var [N, v] of eK.levels(e, { at: S, reverse: !0, voids: s })) {
                                    var C = !1;
                                    if (
                                        v.length < T.length ||
                                        0 === v.length ||
                                        (!s && eV.isElement(N) && eK.isVoid(e, N))
                                    )
                                        break;
                                    var R = h.current,
                                        O = eK.isEnd(e, R, v);
                                    if (u || !h || !eK.isEdge(e, R, v)) {
                                        C = !0;
                                        var b = eZ.extractProps(N);
                                        e.apply({ type: "split_node", path: v, position: y, properties: b });
                                    }
                                    y = v[v.length - 1] + (C || O ? 1 : 0);
                                }
                                if (null == t.at) {
                    ...
                    eK.withoutNormalizing(e, () => {
                        ...
                        if (o) {
                            ...
                            for (var [, d] of Array.from(
                                ...
                                if (_) {
                                    var h = Array.from(eK.nodes(e, { at: _, match: a, mode: i, voids: s }));
                                    if (
                                        h.length > 0 &&
                                        "continue" ===
                                            (function () {
                ...
                if (o) {
                    ...
                    if ((e9.isRange(o) && e9.isCollapsed(o) && ((u = !0), (o = o.anchor)), e4.isPoint(o))) {
                        ...
                        if (!a && c) {
                            ...
                            var _ = { unit: r, distance: s },
                                h = i ? eK.before(e, o, _) || eK.start(e, []) : eK.after(e, o, _) || eK.end(e, []);
                            (o = { anchor: o, focus: h }), (l = !0);
                        }
                    }
                    ...
                    if (!e9.isCollapsed(o)) {
                        if (!l) {
                            var [, f] = e9.edges(o),
                                p = eK.end(e, []);
                            e4.equals(f, p) || (o = eK.unhangRange(e, o, { voids: a }));
                        }
                        var [E, m] = e9.edges(o),
                            ...
                            y = a ? null : eK.void(e, { at: m, mode: "highest" });
                        if (S) {
                            var N = eK.before(e, E);
                            N && g && e1.isAncestor(g[1], N.path) && (E = N);
                        }
                        if (y) {
                            var v = eK.after(e, m);
                            v && A && e1.isAncestor(A[1], v.path) && (m = v);
                        }
                        var C = [];
                        for (var R of eK.nodes(e, { at: o, voids: a })) {
                            var [O, b] = R;
                            (!n || 0 !== e1.compare(b, n)) &&
                                ((!a && eV.isElement(O) && eK.isVoid(e, O)) ||
                    ...
                    if (a) {
                        ...
                        if (!(!s && eK.void(e, { at: a }))) {
                            ...
                            var [, d] = eK.above(e, {
                                ...
                                p = !_ || (_ && h),
                                E = !h,
                                [, m] = eZ.first({ children: t }, []),
                                [, g] = eZ.last({ children: t }, []),
                                A = [],
                                I = (t) => {
                                    var [n, i] = t;
                                    return (
                            ...
                            for (var T of eZ.nodes({ children: t }, { pass: I })) I(T) && A.push(T);
                            var S = [],
                                y = [],
                                N = [],
                                v = !0,
                            ...
                            var [O] = eK.nodes(e, {
                                ...
                                D = eK.isStart(e, a, b),
                                L = eK.isEnd(e, a, b),
                                w = eK.pathRef(e, h && !N.length ? e1.next(d) : d),
                                M = eK.pathRef(e, L ? e1.next(b) : b);
                            tT.splitNodes(e, {
                                at: a,
                                match: (t) =>
                                    C ? eV.isElement(t) && eK.isBlock(e, t) : tl.isText(t) || eK.isInline(e, t),
                                mode: C ? "lowest" : "highest",
                                always: C && (!_ || S.length > 0) && (!h || N.length > 0),
                                voids: s,
                            });
                            ...
                            if (
                                ...
                                f && !S.length && y.length && !N.length && tT.delete(e, { at: d, voids: s }),
                                tT.insertNodes(e, y, {
                                    at: w.current,
                                    match: (t) => eV.isElement(t) && eK.isBlock(e, t),
                                    mode: "lowest",
