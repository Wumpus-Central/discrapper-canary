...
var M,
    ...
    Z = {
        get: function (e, t) {
            ...
            var a = i[t];
            return e.I || !u(a) ? a : a === T(e.t, t) ? (P(e), (e.o[t] = O(e.A.h, a, e))) : a;
        },
        has: function (e, t) {
            return t in p(e);
        },
        ...
        function e(e) {
            ...
            (this.O = W),
                ...
                (this.produce = function (e, n, r) {
                    ...
                    if (("function" != typeof n && a(6), void 0 !== r && "function" != typeof r && a(7), u(e))) {
                        var s = E(t),
                            l = O(t, e, void 0),
                            d = !0;
                        try {
...
var ef = () => {
    var e = {
        ...
        onChange: () => {},
        apply: (t) => {
            for (var n of ez.pathRefs(e)) e2.transform(n, t);
            for (var r of ez.pointRefs(e)) e7.transform(r, t);
            for (var i of ez.rangeRefs(e)) te.transform(i, t);
            var a,
                o,
                u = er.get(e) || [],
                s = ei.get(e) || new Set(),
            ...
            if (e1.operationCanTransformPath(t)) for (var d of ((a = []), (o = new Set()), u)) l(e1.transform(d, t));
            else (a = u), (o = s);
        ...
        addMark: (t, n) => {
            ...
            if (r) {
                ...
                if (o || u) tb.setNodes(e, { [t]: n }, { match: a, split: !0, voids: !0 });
                else {
                    var c = ec(ec({}, ez.marks(e) || {}), {}, { [t]: n });
...
var ep = function (e) {
        ...
        for (var s of r) {
            ...
            if (
                ...
                (i & R.ZWJ) != 0 &&
                    (a & R.ExtPict) != 0 &&
                    !(n ? eR(e.substring(0, o)) : eR(e.substring(0, e.length - o))))
            )
                break;
            if (
                ((i & R.RI) != 0 &&
                    (a & R.RI) != 0 &&
                    !(u = null !== u ? !u : !!n || eL(e.substring(0, e.length - o)))) ||
                (i !== R.None &&
                    a !== R.None &&
                    (function (e, t) {
...
var ew =
    ...
    eO = (e, t) => {
        var n = R.Any;
        return (
            -1 !== e.search(ew) && (n |= R.Extend),
            8205 === t && (n |= R.ZWJ),
            t >= 127462 && t <= 127487 && (n |= R.RI),
            -1 !== e.search(eA) && (n |= R.Prepend),
            -1 !== e.search(eB) && (n |= R.SpacingMark),
            -1 !== e.search(eF) && (n |= R.L),
            -1 !== e.search(eV) && (n |= R.V),
            -1 !== e.search(eT) && (n |= R.T),
            -1 !== e.search(ek) && (n |= R.LV),
            -1 !== e.search(ex) && (n |= R.LVT),
            -1 !== e.search(eP) && (n |= R.ExtPict),
            n
        );
    },
    eS = [
    ...
    eI = (e) => i(e) && eY.isNodeList(e.children) && !ez.isEditor(e),
    ej = {
...
var eH = new WeakMap(),
    ez = {
        above(e) {
            ...
            if (i) {
                var o = ez.path(e, i);
                for (var [u, s] of ez.levels(e, { at: o, voids: n, match: a, reverse: "lowest" === r }))
                    if (!ts.isText(u)) {
                        if (e6.isRange(i)) {
                            if (e1.isAncestor(s, i.anchor.path) && e1.isAncestor(s, i.focus.path)) return [u, s];
                        } else if (!e1.equals(o, s)) return [u, s];
                    }
            }
        },
        addMark(e, t, n) {
        ...
        after(e, t) {
            var n,
                ...
                i = ez.point(e, t, { edge: "end" }),
                a = ez.end(e, []),
                { distance: o = 1 } = r,
                u = 0;
            for (var s of ez.positions(e, eU(eU({}, r), {}, { at: { anchor: i, focus: a } }))) {
                if (u > o) break;
                0 !== u && (n = s), u++;
            }
            return n;
        ...
        before(e, t) {
            var n,
                r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {},
                i = ez.start(e, []),
                a = ez.point(e, t, { edge: "start" }),
                { distance: o = 1 } = r,
                u = 0;
            for (var s of ez.positions(e, eU(eU({}, r), {}, { at: { anchor: i, focus: a }, reverse: !0 }))) {
                if (u > o) break;
                0 !== u && (n = s), u++;
            }
            return n;
        ...
        edges: (e, t) => [ez.start(e, t), ez.end(e, t)],
        end: (e, t) => ez.point(e, t, { edge: "end" }),
        first(e, t) {
            var n = ez.path(e, t, { edge: "start" });
            return ez.node(e, n);
        },
        fragment(e, t) {
            var n = ez.range(e, t);
        ...
        hasBlocks: (e, t) => t.children.some((t) => ej.isElement(t) && ez.isBlock(e, t)),
        hasInlines: (e, t) => t.children.some((t) => ts.isText(t) || ez.isInline(e, t)),
        ...
        isEdge: (e, t, n) => ez.isStart(e, t, n) || ez.isEnd(e, t, n),
        isEmpty(e, t) {
            var { children: n } = t,
                [r] = n;
        ...
        *levels(e) {
            ...
            if ((null == a && (a = () => !0), n)) {
                var o = [],
                    u = ez.path(e, n);
                for (var [s, l] of eY.levels(e, u))
                    if (a(s, l) && (o.push([s, l]), !i && ej.isElement(s) && ez.isVoid(e, s))) break;
                r && o.reverse(), yield* o;
            }
        },
        marks(e) {
            ...
            if (t) return t;
            if (e6.isExpanded(n)) {
                var [r] = ez.nodes(e, { match: ts.isText });
                if (!r) return {};
                var [i] = r;
                return eh(i, eG);
            }
            var { anchor: a } = n,
                ...
                [u] = ez.leaf(e, o);
            if (0 === a.offset) {
                var s = ez.previous(e, { at: o, match: ts.isText });
                if (!ez.above(e, { match: (t) => ej.isElement(t) && ez.isVoid(e, t) && e.markableVoid(t) })) {
                    var l = ez.above(e, { match: (t) => ej.isElement(t) && ez.isBlock(e, t) });
                    if (s && l) {
                        var [d, c] = s,
                            [, f] = l;
                        e1.isAncestor(f, c) && (u = d);
                    }
                }
            }
            return eh(u, eW);
        ...
        next(e) {
            ...
            if (a) {
                ...
                if (o) {
                    ...
                    var [d] = ez.nodes(e, { at: s, match: i, mode: n, voids: r });
                    return d;
                }
            }
        },
        ...
        *nodes(e) {
            var t,
                ...
                { match: d } = i;
            if ((d || (d = () => !0), a)) {
                if (eq.isSpan(a)) (t = a[0]), (n = a[1]);
                else {
                    var c = ez.path(e, a, { edge: "start" }),
                        f = ez.path(e, a, { edge: "end" });
                    (t = s ? f : c), (n = s ? c : f);
                }
                var h = eY.nodes(e, {
                        reverse: s,
                        ...
                        pass: (t) => {
                            var [n] = t;
                            return !l && ej.isElement(n) && ez.isVoid(e, n);
                        },
                    }),
                    p = [];
                for (var [m, _] of h) {
                    ...
                    if ("highest" !== o || !v) {
                        if (!d(m, _))
                            if (u && !v && ts.isText(m)) return;
                            else continue;
                        if ("lowest" === o && v) {
                            r = [m, _];
                            continue;
                        }
                        var g = "lowest" === o ? r : [m, _];
                        g && (u ? p.push(g) : yield g), (r = [m, _]);
                    }
                }
        ...
        normalize(e) {
            ...
            if (ez.isNormalizing(e)) {
                if (n) {
                    var o = Array.from(eY.nodes(e), (e) => {
                            var [, t] = e;
                            return t;
                        }),
                        u = new Set(o.map((e) => e.join(",")));
                    er.set(e, o), ei.set(e, u);
                }
                0 !== i(e).length &&
                    ez.withoutNormalizing(e, () => {
                        for (var t of i(e))
                            if (eY.has(e, t)) {
                                var n = ez.node(e, t),
                                    [o, u] = n;
                                ej.isElement(o) && 0 === o.children.length && e.normalizeNode(n, { operation: r });
                            }
        ...
        pathRef(e, t) {
            var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {},
                ...
                i = {
                    ...
                    unref() {
                        var { current: t } = i;
                        return ez.pathRefs(e).delete(i), (i.current = null), t;
                    },
                };
            return ez.pathRefs(e).add(i), i;
        },
        pathRefs(e) {
            var t = eu.get(e);
        ...
        pointRef(e, t) {
            var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {},
                ...
                i = {
                    ...
                    unref() {
                        var { current: t } = i;
                        return ez.pointRefs(e).delete(i), (i.current = null), t;
                    },
                };
            return ez.pointRefs(e).add(i), i;
        },
        pointRefs(e) {
            var t = es.get(e);
        ...
        *positions(e) {
            ...
            if (n) {
                var o = ez.range(e, n),
                    ...
                    h = 0,
                    p = 0;
                for (var [m, _] of ez.nodes(e, { at: n, reverse: i, voids: a })) {
                    if (ej.isElement(m)) {
                        if (!a && e.isVoid(m)) {
                            yield ez.start(e, _);
                            continue;
                        ...
                        if (ez.hasInlines(e, m)) {
                            var v = e1.isAncestor(_, s.path) ? s : ez.end(e, _),
                                g = e1.isAncestor(_, u.path) ? u : ez.start(e, _);
                            (c = ez.string(e, { anchor: g, focus: v }, { voids: a })), (d = !0);
                        }
                    }
                    if (ts.isText(m)) {
                        var y,
        ...
        previous(e) {
            ...
            if (a) {
                ...
                if (o) {
                    ...
                    var [d] = ez.nodes(e, { reverse: !0, at: s, match: i, mode: n, voids: r });
                    return d;
                }
            }
        },
        range: (e, t, n) => (e6.isRange(t) && !n ? t : { anchor: ez.start(e, t), focus: ez.end(e, n || t) }),
        rangeRef(e, t) {
            var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {},
                { affinity: r = "forward" } = n,
                i = {
                    ...
                    unref() {
                        var { current: t } = i;
                        return ez.rangeRefs(e).delete(i), (i.current = null), t;
                    },
                };
            return ez.rangeRefs(e).add(i), i;
        },
        rangeRefs(e) {
            var t = el.get(e);
        ...
        start: (e, t) => ez.point(e, t, { edge: "start" }),
        string(e, t) {
            var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {},
                { voids: r = !1 } = n,
                i = ez.range(e, t),
                [a, o] = e6.edges(i),
                u = "";
            for (var [s, l] of ez.nodes(e, { at: i, match: ts.isText, voids: r })) {
                var d = s.text;
                e1.equals(l, o.path) && (d = d.slice(0, o.offset)),
        ...
        unhangRange(e, t) {
            ...
            var o = ez.above(e, { at: a, match: (t) => ej.isElement(t) && ez.isBlock(e, t), voids: r }),
                u = o ? o[1] : [],
                s = { anchor: ez.start(e, i), focus: a },
                l = !0;
            for (var [d, c] of ez.nodes(e, { at: s, match: ts.isText, reverse: !0, voids: r })) {
                if (l) {
                    l = !1;
                    continue;
                }
                if ("" !== d.text || e1.isBefore(c, u)) {
        ...
        void(e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            return ez.above(e, eU(eU({}, t), {}, { match: (t) => ej.isElement(t) && ez.isVoid(e, t) }));
        },
        withoutNormalizing(e, t) {
            var n = ez.isNormalizing(e);
            ez.setNormalizing(e, !1);
            try {
                t();
            } finally {
                ez.setNormalizing(e, n);
            }
            ez.normalize(e);
        },
    },
        ...
        *elements(e) {
        ...
        fragment(e, t) {
            ...
            return $({ children: e.children }, (e) => {
                ...
                ez.isEditor(e) && (e.selection = null);
            }).children;
        },
        get(e, t) {
        ...
        isNode: (e) => ts.isText(e) || ej.isElement(e) || ez.isEditor(e),
        isNodeList(e) {
        ...
        *nodes(e) {
            for (
                var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                    ...
                    u = [],
                    s = e;
                !(a && (r ? e1.isBefore(u, a) : e1.isAfter(u, a)));
            ) {
                if (
                    (o.has(s) || (yield [s, u]),
                    !o.has(s) && !ts.isText(s) && 0 !== s.children.length && (null == n || !1 === n([s, u])))
                ) {
                    o.add(s);
                    var l = r ? s.children.length - 1 : 0;
                    e1.isAncestor(u, i) && (l = i[u.length]), (u = u.concat(l)), (s = eY.get(e, u));
                    continue;
                }
                if (0 === u.length) break;
                if (!r) {
                ...
                if (r && 0 !== u[u.length - 1]) {
                    (u = e1.previous(u)), (s = eY.get(e, u));
                    continue;
                }
                (u = e1.parent(u)), (s = eY.get(e, u)), o.add(s);
            }
        },
        parent(e, t) {
            var n = e1.parent(t),
        ...
        inverse(e) {
            switch (e.type) {
                ...
                case "set_node":
                    ...
                    return e$(e$({}, e), {}, { properties: o, newProperties: a });
                case "set_selection":
                    var { properties: u, newProperties: s } = e;
                    if (null == u) return e$(e$({}, e), {}, { properties: s, newProperties: null });
                    if (null == s) return e$(e$({}, e), {}, { properties: null, newProperties: u });
                    return e$(e$({}, e), {}, { properties: s, newProperties: u });
                case "split_node":
    ...
    e1 = {
        ...
        transform(e, t) {
            ...
            switch (t.type) {
                ...
                case "remove_node":
                    var { path: o } = t;
                    if (e1.equals(o, r) || e1.isAncestor(o, r)) return null;
                    e1.endsBefore(o, r) && (r[o.length - 1] -= 1);
                    break;
                case "merge_node":
                    var { path: u, position: s } = t;
                    e1.equals(u, r) || e1.endsBefore(u, r)
                        ? (r[u.length - 1] -= 1)
                        : e1.isAncestor(u, r) && ((r[u.length - 1] -= 1), (r[u.length] += s));
                    break;
                case "split_node":
...
var e6 = {
        ...
        includes(e, t) {
            ...
            return (
                e8.isPoint(t)
                    ? ((s = e8.compare(t, o) >= 0), (l = 0 >= e8.compare(t, u)))
                    : ((s = e1.compare(t, o.path) >= 0), (l = 0 >= e1.compare(t, u.path))),
                s && l
            );
        },
        intersection(e, t) {
            var n = eh(e, e4),
                [r, i] = e6.edges(e),
                [a, o] = e6.edges(t),
                u = e8.isBefore(r, a) ? a : r,
                s = e8.isBefore(i, o) ? i : o;
            return e8.isBefore(s, u)
                ? null
                : (function (e) {
                      for (var t = 1; t < arguments.length; t++) {
                          var n = null != arguments[t] ? arguments[t] : {};
            ...
            return $(e, (e) => {
                ...
                if ("inward" === a) {
                    ...
                    "outward" === a
                        ...
                        : ((r = a), (i = a));
                var u = e8.transform(e.anchor, t, { affinity: r }),
    ...
    decorations(e, t) {
        ...
        for (var r of t) {
            ...
            for (var c of n) {
                ...
                if (d < s) {
                    var v = d - h;
                    (_ = tu(tu({}, p), {}, { text: p.text.slice(v) })),
                        (p = tu(tu({}, p), {}, { text: p.text.slice(0, v) }));
                }
                if (l > h) {
                    var g = l - h;
                    (m = tu(tu({}, p), {}, { text: p.text.slice(0, g) })),
                        (p = tu(tu({}, p), {}, { text: p.text.slice(g) }));
                }
...
var tm = (e, t) =>
        ej.isElement(t)
            ? !!ez.isVoid(e, t) || (1 === t.children.length && tm(e, t.children[0]))
            : !ez.isEditor(t) && !0,
    t_ = (e, t) => {
        var [n] = ez.node(e, t);
        return (e) => e === n;
                ...
                {},
                {
                    transform(e, t) {
                        ...
                        try {
                                ...
                                switch (n.type) {
                                    case "insert_node":
                                        ...
                                        if ((a.children.splice(o, 0, i), t))
                                            for (var [u, s] of e6.points(t)) t[s] = e8.transform(u, n);
                                        break;
                                    case "insert_text":
                                    ...
                                    case "remove_node":
                                        var { path: M } = n,
                                            R = M[M.length - 1];
                                        if ((eY.parent(e, M).children.splice(R, 1), t))
                                            for (var [N, L] of e6.points(t)) {
                                                ...
                                                if (null != t && null != I) t[L] = I;
                                                    ...
                                                    j &&
                                                        ...
                                                        (U = e1.equals(G[1], M)
                                                            ? !e1.hasPrevious(G[1])
                                                            : e1.common(j[1], M).length < e1.common(G[1], M).length),
                                                        j && !U
                                        ...
                                        break;
                                    case "remove_text":
                                        var { path: H, offset: z, text: q } = n;
                                        if (0 === q.length) break;
                                        var X = eY.leaf(e, H),
                                            Q = X.text.slice(0, z),
                                            Z = X.text.slice(z + q.length);
                                        if (((X.text = Q + Z), t))
                            ...
                            (e.children = et(e.children)), n ? (e.selection = o(n) ? et(n) : n) : (e.selection = null);
                        }
                    },
                },
            ),
            {
                insertNodes(e, t) {
                    ...
                    ez.withoutNormalizing(e, () => {
                        ...
                        if ((eY.isNode(t) && (t = [t]), 0 !== t.length)) {
                            ...
                            if (
                                (o ||
                                    ((o = e.selection ? e.selection : e.children.length > 0 ? ez.end(e, []) : [0]),
                                    (s = !0)),
                                null == s && (s = !1),
                                e6.isRange(o))
                            )
                                if ((r || (o = ez.unhangRange(e, o, { voids: i })), e6.isCollapsed(o))) o = o.anchor;
                                else {
                                    var [, d] = e6.edges(o),
                                        c = ez.pointRef(e, d);
                                    tb.delete(e, { at: o }), (o = c.unref());
                                }
                            if (e8.isPoint(o)) {
                                null == u &&
                                    (u = ts.isText(l)
                                        ? (e) => ts.isText(e)
                                        : e.isInline(l)
                                          ? (t) => ts.isText(t) || ez.isInline(e, t)
                                          : (t) => ej.isElement(t) && ez.isBlock(e, t));
                                var [f] = ez.nodes(e, { at: o.path, match: u, mode: a, voids: i });
                                if (!f) return;
                                var [, h] = f,
                                    p = ez.pathRef(e, h),
                                    m = ez.isEnd(e, o, h);
                                tb.splitNodes(e, { at: o, match: u, mode: a, voids: i });
                                var _ = p.unref();
                                o = m ? e1.next(_) : _;
                            }
                            var v = e1.parent(o),
                            ...
                            if (!(!i && ez.void(e, { at: v }))) {
                                for (var y of t) {
                                    var D = v.concat(g);
                                    g++, e.apply({ type: "insert_node", path: D, node: y }), (o = e1.next(o));
                                }
                                if (((o = e1.previous(o)), s)) {
                                    var b = ez.end(e, o);
                                    b && tb.select(e, b);
                                }
                            }
                ...
                liftNodes(e) {
                    ...
                    ez.withoutNormalizing(e, () => {
                        var { at: n = e.selection, mode: r = "lowest", voids: i = !1 } = t,
                            { match: a } = t;
                        if (
                            (null == a && (a = e1.isPath(n) ? t_(e, n) : (t) => ej.isElement(t) && ez.isBlock(e, t)), n)
                        )
                            for (var o of Array.from(ez.nodes(e, { at: n, match: a, mode: r, voids: i }), (t) => {
                                var [, n] = t;
                                return ez.pathRef(e, n);
                            })) {
                                var u = o.unref();
                                if (u.length < 2)
                                    throw Error(
                                ...
                                var [s, l] = ez.node(e, e1.parent(u)),
                                    d = u[u.length - 1],
                                    { length: c } = s.children;
                                if (1 === c) {
                                    var f = e1.next(l);
                                    tb.moveNodes(e, { at: u, to: f, voids: i }), tb.removeNodes(e, { at: l, voids: i });
                                } else if (0 === d) tb.moveNodes(e, { at: u, to: l, voids: i });
                                else if (d === c - 1) {
                                    var h = e1.next(l);
                                    tb.moveNodes(e, { at: u, to: h, voids: i });
                                } else {
                                    var p = e1.next(u),
                                        m = e1.next(l);
                                    tb.splitNodes(e, { at: p, voids: i }), tb.moveNodes(e, { at: u, to: m, voids: i });
                                }
                            }
                    });
                },
                        ...
                        if (a) {
                            if (null == i)
                                if (e1.isPath(a)) {
                                    var [l] = ez.parent(e, a);
                                    i = (e) => l.children.includes(e);
                                } else i = (t) => ej.isElement(t) && ez.isBlock(e, t);
                            if ((!o && e6.isRange(a) && (a = ez.unhangRange(e, a, { voids: u })), e6.isRange(a)))
                            ...
                            var [f] = ez.nodes(e, { at: a, match: i, voids: u, mode: s }),
                                h = ez.previous(e, { at: a, match: i, voids: u, mode: s });
                            if (f && h) {
                                var [p, m] = f,
                                    [_, v] = h;
                                if (0 !== m.length && 0 !== v.length) {
                                    var g = e1.next(v),
                                        y = e1.common(m, v),
                                        D = e1.isSibling(m, v),
                                        b = Array.from(ez.levels(e, { at: m }), (e) => {
                                            var [t] = e;
                                            return t;
                                        })
                                            .slice(y.length)
                                    ...
                                    D || tb.moveNodes(e, { at: m, to: g, voids: u }),
                                        E && tb.removeNodes(e, { at: E.current, voids: u }),
                                        (ej.isElement(_) && ez.isEmpty(e, _)) ||
                                        (ts.isText(_) && "" === _.text && 0 !== v[v.length - 1])
                                            ? tb.removeNodes(e, { at: v, voids: u })
                ...
                moveNodes(e, t) {
                    ez.withoutNormalizing(e, () => {
                        var { to: n, at: r = e.selection, mode: i = "lowest", voids: a = !1 } = t,
                            { match: o } = t;
                        if (r) {
                            null == o && (o = e1.isPath(r) ? t_(e, r) : (t) => ej.isElement(t) && ez.isBlock(e, t));
                            var u = ez.pathRef(e, n);
                            for (var s of Array.from(ez.nodes(e, { at: r, match: o, mode: i, voids: a }), (t) => {
                                var [, n] = t;
                                return ez.pathRef(e, n);
                            })) {
                                var l = s.unref(),
                ...
                removeNodes(e) {
                    ...
                    ez.withoutNormalizing(e, () => {
                        ...
                        if (a)
                            for (var u of (null == o &&
                                (o = e1.isPath(a) ? t_(e, a) : (t) => ej.isElement(t) && ez.isBlock(e, t)),
                            !n && e6.isRange(a) && (a = ez.unhangRange(e, a, { voids: r })),
                            Array.from(ez.nodes(e, { at: a, match: o, mode: i, voids: r }), (t) => {
                                var [, n] = t;
                                return ez.pathRef(e, n);
                            }))) {
                                var s = u.unref();
                ...
                setNodes(e, t) {
                    ...
                    ez.withoutNormalizing(e, () => {
                        ...
                        if (i) {
                            if (
                                (null == r &&
                                    (r = e1.isPath(i) ? t_(e, i) : (t) => ej.isElement(t) && ez.isBlock(e, t)),
                                !u && e6.isRange(i) && (i = ez.unhangRange(e, i, { voids: d })),
                                l && e6.isRange(i))
                            ) {
                                if (e6.isCollapsed(i) && ez.leaf(e, i.anchor)[0].text.length > 0) return;
                                var c = ez.rangeRef(e, i, { affinity: "inward" }),
                                    [f, h] = e6.edges(i),
                                    p = "lowest" === s ? "lowest" : "highest",
                                    m = ez.isEnd(e, h, h.path);
                                tb.splitNodes(e, { at: h, match: r, mode: p, voids: d, always: !m });
                                var _ = ez.isStart(e, f, f.path);
                                tb.splitNodes(e, { at: f, match: r, mode: p, voids: d, always: !_ }),
                                    (i = c.unref()),
                                    null == n.at && tb.select(e, i);
                            }
                            for (var [v, g] of (a || (a = (e, t) => e !== t),
                            ez.nodes(e, { at: i, match: r, mode: s, voids: d }))) {
                                var y = {},
                                    D = {};
                                if (0 !== g.length) {
                                    var b = !1;
                                    for (var C in t)
                                        "children" !== C &&
                                            ...
                                            o ? null != t[C] && (D[C] = o(v[C], t[C])) : null != t[C] && (D[C] = t[C]));
                ...
                splitNodes(e) {
                    ...
                    ez.withoutNormalizing(e, () => {
                        ...
                        if (
                            (null == o && (o = (t) => ej.isElement(t) && ez.isBlock(e, t)),
                            e6.isRange(u) &&
                                (u = ((e, t) => {
                        ...
                        if (u) {
                            var h = ez.pointRef(e, u, { affinity: "backward" });
                            try {
                                var [p] = ez.nodes(e, { at: u, match: o, mode: i, voids: a });
                                if (!p) return;
                                var m = ez.void(e, { at: u, mode: "highest" });
                                if (!a && m) {
                                    var [_, v] = m;
                                    if (ej.isElement(_) && e.isInline(_)) {
                                        ...
                                        if (!g) {
                                            var y = e1.next(v);
                                            tb.insertNodes(e, { text: "" }, { at: y, voids: a }), (g = ez.point(e, y));
                                        }
                                        (u = g), (l = !0);
                                    }
                                    (s = u.path.length - v.length + 1), (l = !0);
                                }
                                n = ez.pointRef(e, u);
                                ...
                                for (var [w, A] of ez.levels(e, { at: C, reverse: !0, voids: a })) {
                                    var B = !1;
                                    if (
                                        A.length < b.length ||
                                        0 === A.length ||
                                        (!a && ej.isElement(w) && ez.isVoid(e, w))
                                    )
                                        break;
                                    var F = h.current,
                                        V = ez.isEnd(e, F, A);
                                    if (l || !h || !ez.isEdge(e, F, A)) {
                                        B = !0;
                ...
                unwrapNodes(e) {
                    ...
                    ez.withoutNormalizing(e, () => {
                        var { mode: n = "lowest", split: r = !1, voids: i = !1 } = t,
                            { at: a = e.selection, match: o } = t;
                        if (a) {
                            null == o && (o = e1.isPath(a) ? t_(e, a) : (t) => ej.isElement(t) && ez.isBlock(e, t)),
                                e1.isPath(a) && (a = ez.range(e, a));
                            var u = e6.isRange(a) ? ez.rangeRef(e, a) : null;
                            for (var s of Array.from(ez.nodes(e, { at: a, match: o, mode: n, voids: i }), (t) => {
                                var [, n] = t;
                                return ez.pathRef(e, n);
                            }).reverse())
                                !(function (t) {
                                    var n = t.unref(),
                                        [a] = ez.node(e, n),
                                        o = ez.range(e, n);
                                    r && u && (o = e6.intersection(u.current, o)),
                                        tb.liftNodes(e, {
                                            at: o,
                    ...
                    ez.withoutNormalizing(e, () => {
                        ...
                        if (u) {
                            if (
                                (null == o &&
                                    (o = e1.isPath(u)
                                        ? t_(e, u)
                                        : e.isInline(t)
                                          ? (t) => (ej.isElement(t) && ez.isInline(e, t)) || ts.isText(t)
                                          : (t) => ej.isElement(t) && ez.isBlock(e, t)),
                                i && e6.isRange(u))
                            ) {
                                var [s, l] = e6.edges(u),
                                    d = ez.rangeRef(e, u, { affinity: "inward" });
                                tb.splitNodes(e, { at: l, match: o, voids: a }),
                                    tb.splitNodes(e, { at: s, match: o, voids: a }),
                                    (u = d.unref()),
                                    null == n.at && tb.select(e, u);
                            }
                            for (var [, c] of Array.from(
                                ...
                                var f = e6.isRange(u) ? e6.intersection(u, ez.range(e, c)) : u;
                                if (f) {
                                    var h = Array.from(ez.nodes(e, { at: f, match: o, mode: r, voids: a }));
                                    if (
                                        h.length > 0 &&
                                        "continue" ===
                                            (function () {
                                                ...
                                                var u = e1.equals(i, o) ? e1.parent(i) : e1.common(i, o),
                                                    s = ez.range(e, i, o),
                                                    [l] = ez.node(e, u),
                                                    d = u.length + 1,
                                                    c = e1.next(o.slice(0, d)),
                                                    f = tp(tp({}, t), {}, { children: [] });
        ...
        ),
        {
            ...
            move(e) {
                var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                    ...
                    { edge: o = null } = t;
                if (n) {
                    "start" === o && (o = e6.isBackward(n) ? "focus" : "anchor"),
                        "end" === o && (o = e6.isBackward(n) ? "anchor" : "focus");
                    var { anchor: u, focus: s } = n,
                        l = { distance: r, unit: i },
                        d = {};
                    if (null == o || "anchor" === o) {
                        var c = a ? ez.before(e, u, l) : ez.after(e, u, l);
                        c && (d.anchor = c);
                    }
                    if (null == o || "focus" === o) {
                        var f = a ? ez.before(e, s, l) : ez.after(e, s, l);
                        f && (d.focus = f);
                    }
                    tb.setSelection(e, d);
                }
            ...
            select(e, t) {
                var { selection: n } = e;
                if (((t = ez.range(e, t)), n)) return void tb.setSelection(e, t);
                if (!e6.isRange(t))
                    throw Error(
            ...
            setPoint(e, t) {
                ...
                if (r) {
                    ...
                    var { anchor: a, focus: o } = r,
                        u = "anchor" === i ? a : o;
                    tb.setSelection(e, { ["anchor" === i ? "anchor" : "focus"]: tg(tg({}, u), t) });
                }
            },
            setSelection(e, t) {
                var { selection: n } = e,
    ...
    ),
    {
        delete(e) {
            ...
            ez.withoutNormalizing(e, () => {
                ...
                if (u) {
                    var l = !1;
                    if ((e6.isRange(u) && e6.isCollapsed(u) && ((l = !0), (u = u.anchor)), e8.isPoint(u))) {
                        var d = ez.void(e, { at: u, mode: "highest" });
                        if (!o && d) {
                            var [, c] = d;
                            u = c;
                        } else {
                            var f = { unit: i, distance: a },
                                h = r ? ez.before(e, u, f) || ez.start(e, []) : ez.after(e, u, f) || ez.end(e, []);
                            (u = { anchor: u, focus: h }), (s = !0);
                        }
                    }
                    if (e1.isPath(u)) return void tb.removeNodes(e, { at: u, voids: o });
                    if (!e6.isCollapsed(u)) {
                        if (!s) {
                            var [, p] = e6.edges(u),
                                m = ez.end(e, []);
                            e8.equals(p, m) || (u = ez.unhangRange(e, u, { voids: o }));
                        }
                        var [_, v] = e6.edges(u),
                            g = ez.above(e, { match: (t) => ej.isElement(t) && ez.isBlock(e, t), at: _, voids: o }),
                            y = ez.above(e, { match: (t) => ej.isElement(t) && ez.isBlock(e, t), at: v, voids: o }),
                            D = g && y && !e1.equals(g[1], y[1]),
                            b = e1.equals(_.path, v.path),
                            C = o ? null : ez.void(e, { at: _, mode: "highest" }),
                            E = o ? null : ez.void(e, { at: v, mode: "highest" });
                        if (C) {
                            var w = ez.before(e, _);
                        ...
                        var B = [];
                        for (var F of ez.nodes(e, { at: u, voids: o })) {
                            var [V, T] = F;
                            (!n || 0 !== e1.compare(T, n)) &&
                                ((!o && ej.isElement(V) && ez.isVoid(e, V)) ||
                        ...
                        if (
                            (k
                                ...
                                .map((e) => e.unref())
                                .filter((e) => null !== e)
                                .forEach((t) => tb.removeNodes(e, { at: t, voids: o })),
                            !E)
                        ) {
                            var I = P.current,
                                [j] = ez.leaf(e, I),
                        ...
                        !b && D && P.current && x.current && tb.mergeNodes(e, { at: P.current, hanging: !0, voids: o }),
                            l &&
                                r &&
                                "character" === i &&
                                O.length > 1 &&
        ...
        insertFragment(e, t) {
            ...
            ez.withoutNormalizing(e, () => {
                ...
                if (t.length) {
                    if (o) {
                        if (e6.isRange(o))
                            if ((i || (o = ez.unhangRange(e, o, { voids: a })), e6.isCollapsed(o))) o = o.anchor;
                            else {
                                var [, u] = e6.edges(o);
                                if (!a && ez.void(e, { at: u })) return;
                                var s = ez.pointRef(e, u);
                                tb.delete(e, { at: o }), (o = s.unref());
                            }
                        else e1.isPath(o) && (o = ez.start(e, o));
                        if (!(!a && ez.void(e, { at: o }))) {
                            var l = ez.above(e, {
                                at: o,
                                match: (t) => ej.isElement(t) && ez.isInline(e, t),
                                mode: "highest",
                                voids: a,
                            });
                            if (l) {
                                var [, d] = l;
                                ez.isEnd(e, o, d) ? (o = ez.after(e, d)) : ez.isStart(e, o, d) && (o = ez.before(e, d));
                            }
                            var [, c] = ez.above(e, {
                                    match: (t) => ej.isElement(t) && ez.isBlock(e, t),
                                    at: o,
                                    voids: a,
                                }),
                                f = ez.isStart(e, o, c),
                            ...
                            var [V] = ez.nodes(e, {
                                    at: o,
                                    match: (t) => ts.isText(t) || ez.isInline(e, t),
                                    mode: "highest",
                                    voids: a,
                                }),
                                [, T] = V,
                                k = ez.isStart(e, o, T),
                                x = ez.isEnd(e, o, T),
                                P = ez.pathRef(e, h && !w.length ? e1.next(c) : c),
                                O = ez.pathRef(e, x ? e1.next(T) : T);
                            tb.splitNodes(e, {
                                at: o,
                                match: (t) =>
                                    B ? ej.isElement(t) && ez.isBlock(e, t) : ts.isText(t) || ez.isInline(e, t),
                                mode: B ? "lowest" : "highest",
                                always: B && (!f || C.length > 0) && (!h || w.length > 0),
                                voids: a,
                            });
                            var S = ez.pathRef(e, !k || (k && x) ? e1.next(T) : T);
                            if (
                                (tb.insertNodes(e, C, {
                                    at: S.current,
                                    match: (t) => ts.isText(t) || ez.isInline(e, t),
        ...
        insertText(e, t) {
            ...
            ez.withoutNormalizing(e, () => {
                var { voids: r = !1 } = n,
                    { at: i = e.selection } = n;
                if (i) {
                    if ((e1.isPath(i) && (i = ez.range(e, i)), e6.isRange(i)))
                        if (e6.isCollapsed(i)) i = i.anchor;
                        else {
                            var a = e6.end(i);
                            if (!r && ez.void(e, { at: a })) return;
                            var o = e6.start(i),
                                u = ez.pointRef(e, o),
                                s = ez.pointRef(e, a);
