...
var x,
    ...
    V = "u" > typeof Map,
    B = "u" > typeof Set,
    j = "u" > typeof Proxy && void 0 !== Proxy.revocable && "u" > typeof Reflect,
    H = F ? Symbol.for("immer-nothing") : (((U = {})["immer-nothing"] = !0), U),
            ...
            (this.O = j),
                ...
                (this.produce = function (e, n, i) {
                    ...
                    if (!e || "object" != typeof e) {
                        if ((void 0 === (r = n(e)) && (r = e), r === H && (r = void 0), t.D && E(r, !0), i)) {
                            var d = [],
                                _ = [];
...
var eC =
    ...
    eM = (e, t) => {
        var n = k.Any;
        return (
            -1 !== e.search(eC) && (n |= k.Extend),
            8205 === t && (n |= k.ZWJ),
            t >= 127462 && t <= 127487 && (n |= k.RI),
            -1 !== e.search(eN) && (n |= k.Prepend),
            -1 !== e.search(ev) && (n |= k.SpacingMark),
            -1 !== e.search(eR) && (n |= k.L),
            -1 !== e.search(eO) && (n |= k.V),
            -1 !== e.search(eb) && (n |= k.T),
                                ...
                                switch (n.type) {
                                    ...
                                    case "merge_node":
                                        ...
                                        if ((T.children.splice(S, 1), t))
                                            for (var [y, C] of e9.points(t)) t[C] = e4.transform(y, n);
                                        break;
                                    case "move_node":
                                        var { path: N, newPath: v } = n;
                                        if (e1.isAncestor(N, v))
                                            throw Error(
                                                "Cannot move a path ["
                                    ...
                                    case "remove_node":
                                        var { path: x } = n,
                                            k = x[x.length - 1];
                                        if ((eX.parent(e, x).children.splice(k, 1), t))
                                            for (var [U, G] of e9.points(t)) {
                                                ...
                                                if (null != t && null != F) t[G] = F;
                                                    ...
                                                    var V = void 0,
                                                        B = void 0;
                                                    for (var [j, H] of eX.texts(e))
                                                        if (-1 === e1.compare(H, x)) V = [j, H];
                                                        else {
                                                            B = [j, H];
                                                            break;
                                                        }
                    ...
                    eK.withoutNormalizing(e, () => {
                        ...
                        if (o) {
                            ...
                            try {
                                ...
                                for (var [C, N] of eK.levels(e, { at: S, reverse: !0, voids: s })) {
                                    var v = !1;
                                    if (
                                        N.length < T.length ||
                                        0 === N.length ||
                                        (!s && eV.isElement(C) && eK.isVoid(e, C))
                                    )
                                        break;
                                    var R = h.current,
                                        O = eK.isEnd(e, R, N);
                                    if (u || !h || !eK.isEdge(e, R, N)) {
                                        v = !0;
                                        var b = eX.extractProps(C);
                                        e.apply({ type: "split_node", path: N, position: y, properties: b });
                                    }
                                    y = N[N.length - 1] + (v || O ? 1 : 0);
                                }
                                if (null == t.at) {
            ...
            eK.withoutNormalizing(e, () => {
                ...
                if (o) {
                    ...
                    if (!e9.isCollapsed(o)) {
                        ...
                        if (S) {
                            var C = eK.before(e, E);
                            C && g && e1.isAncestor(g[1], C.path) && (E = C);
                        }
                        if (y) {
                            var N = eK.after(e, m);
                            N && A && e1.isAncestor(A[1], N.path) && (m = N);
                        }
                        var v = [];
                        ...
                        if (
                            ...
                            var F = w.current,
                                ...
                                { path: B } = F,
                                j = T ? E.offset : 0,
                                H = V.text.slice(j, m.offset);
                            H.length > 0 && (e.apply({ type: "remove_text", path: B, offset: j, text: H }), (M = H));
                        }
                    ...
                    if (a) {
                        ...
                        if (!(!s && eK.void(e, { at: a }))) {
                            ...
                            var [O] = eK.nodes(e, {
                                ...
                                D = eK.isStart(e, a, b),
                                L = eK.isEnd(e, a, b),
                                w = eK.pathRef(e, h && !C.length ? e1.next(d) : d),
                            ...
                            tT.splitNodes(e, {
                                ...
                                always: v && (!_ || S.length > 0) && (!h || C.length > 0),
                                voids: s,
                            });
                            ...
                            if (
                                ...
                                f && !S.length && y.length && !C.length && tT.delete(e, { at: d, voids: s }),
                                tT.insertNodes(e, y, {
                                    at: w.current,
                                    match: (t) => eV.isElement(t) && eK.isBlock(e, t),
                                    mode: "lowest",
