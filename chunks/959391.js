...
let h = (e) => {
    let t,
        { billingAddressInfo: n, billingError: h, onBillingAddressChange: E, paymentSourceType: m } = e,
        ...
        (0, r.jsxs)(i.Fragment, {
            children: [
                g
                    ? (0, r.jsx)("div", {
                          className: p.QK,
                          children: (0, r.jsx)(a.w, { type: "critical", children: f.intl.string(f.t.vZ8y7l) }),
                      })
                    : null,
                (0, r.jsx)(o.Ay, {
                ...
                I && null != T && T.length > 0
                    ? (0, r.jsx)(a.w, { type: "info", children: f.intl.string(f.t.Pg2hU0) })
                    : null,
            ],
        })
    );
