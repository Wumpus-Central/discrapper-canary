...
function j(e) {
    let {
        ...
        D = x && null == A,
        {
            ...
            targetElementRef: O,
            trigger: P,
        } = (0, d.D)({ children: t, targetElementRef: j, delay: v.In, onTooltipShow: S }),
    ...
    return (0, a.jsxs)(a.Fragment, { children: [P, (0, a.jsx)(i.A, { id: y, children: B }), G] });
}
let S = j;
