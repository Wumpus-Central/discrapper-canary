        ...
        return I.A.logGroups
            .map((i) => {
                ...
                let c,
                    ...
                    p,
                    E,
                    { index: m, timestamp: g, logs: I, nativeLogs: y, serverTrace: C } = i,
                    N = 0 === m ? (A().find(I, (e) => e.log.indexOf("Logger loaded") >= 0)?.timestamp ?? e) : g,
                    v =
                        ((l =
                            ((r = I),
                            (s = y),
...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "564083", versionHash: "ca7cb477e5f46133bb3f0eba97731ee2d4b4b463" }, void 0, 2)}
