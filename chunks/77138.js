...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "601629", versionHash: "f17cd3e8fcaa37e664d842296093b0ef0b85b099" }, void 0, 2)}
