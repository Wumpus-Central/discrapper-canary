...
`;
    ...
    Metadata:
    ${JSON.stringify({ logsUploaded: new Date().toISOString(), releaseChannel: window.GLOBAL_ENV.RELEASE_CHANNEL, buildNumber: "600185", versionHash: "262a11195fa32f4d9361b1f5d2636b4a49b6257a" }, void 0, 2)}
