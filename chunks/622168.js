...
function e9(e) {
    ...
    return (0, l.jsxs)("div", {
        ...
        children: [
            ...
            (0, l.jsx)(e2.E, { variant: "text-sm/normal", className: e5.Qs, children: e0.intl.string(e0.t.rdzeVP) }),
            (0, l.jsx)(e6.$, {
        ...
        children: (() => {
            switch (s) {
                ...
                case u.M.SERVER_SUBSCRIPTION_TIER_TEMPLATE_UPSELL:
                    return (0, l.jsx)(tt, {
                        renderPopout: (e) => (0, l.jsx)(e4, { guildId: n.id, markAsDismissed: r, targetElementRef: e }),
                        renderGuildHeaderDropdownButton: i,
                    });
                default:
                    return i();
...
function nN(e) {
    ...
    let { channel: n, speakers: i, voiceType: s } = e,
        ...
        c =
            ((t = n.id),
            (0, d.bG)([t2.default, t6.A, t5.Ay], () => {
                let e = t2.default.getId();
                return t6.A.getVoiceChannelId() === t ? t5.Ay.getPermissionsForUser(e, t) : null;
            }, [t])),
                      ...
                      ? (0, l.jsxs)("div", {
                            ...
                            children: [
                                ...
                                (0, l.jsx)(e2.E, {
                                    ...
                                    variant: "text-xs/normal",
                                    className: no.c8,
                                    children: (0, t4.c)(r, o, n?.id, i.length),
                                }),
                            ],
                        })
                      : null,
...
function n5(e) {
    ...
    let i,
        ...
        A =
            ...
            a.useMemo(() => {
                let e = [];
                return s && e.push(u.M.GAME_CLAIM_COACHMARK), e.length > 0 ? e : n6;
            }, [s])),
                ...
                _
                    ...
                    : n3
                          .filter((e) => {
                              ...
                              return !0 === n?.channelNoticePredicate(r, o) && !n4.has(t);
                          })
