e.d(t, { Fu: () => v, AO: () => d, yJ: () => l, sC: () => C, TM: () => L, zR: () => P });
var o = e(1139),
    i = e(861193);
function r(n) {
...
var w = !!("u" > typeof window && window.document && window.document.createElement);
function g(n, t) {
    t(window.confirm(n));
}
var m = "popstate",
...
function P(n) {
    ...
    function _(n) {
        1 === (B += n) && 1 === n
            ? (window.addEventListener(m, S), r && window.addEventListener(y, U))
            : 0 === B && (window.removeEventListener(m, S), r && window.removeEventListener(y, U));
    }
    var q = !1,
        z = {
            length: e.length,
                ...
                E.confirmTransitionTo(r, o, A, function (n) {
                    if (n) {
                        var t = j(r),
                            ...
                            c = r.state;
                        if (i)
                            if ((e.pushState({ key: a, state: c }, null, t), v)) window.location.href = t;
                            else {
                ...
                E.confirmTransitionTo(r, o, A, function (n) {
                    if (n) {
                        var t = j(r),
                            ...
                            c = r.state;
                        if (i)
                            if ((e.replaceState({ key: a, state: c }, null, t), v)) window.location.replace(t);
                            else {
                                var u = M.indexOf(z.location.key);
...
function L(n) {
    ...
    var P = p();
    function L(n) {
        (0, o.A)(_, n), (_.length = t.length), P.notifyListeners(_.location, _.action);
    }
    var E = !1,
        C = null;
    function S() {
        ...
        if (n !== t) T(t);
            ...
            var e,
                o = O(),
                i = _.location;
            if ((!E && i.pathname === o.pathname && i.search === o.search && i.hash === o.hash) || C === d(o)) return;
            (C = null),
                (e = o),
                E
                    ? ((E = !1), L())
    ...
    var j = 0;
    function F(n) {
        1 === (j += n) && 1 === n ? window.addEventListener(A, S) : 0 === j && window.removeEventListener(A, S);
    }
    var B = !1,
        _ = {
            length: t.length,
            ...
            createHref: function (n) {
                var t = document.querySelector("base"),
                    e = "";
                return t && t.getAttribute("href") && (e = b(window.location.href)), e + "#" + m(s + d(n));
            },
            push: function (n, t) {
                var e = "PUSH",
...
function C(n) {
    ...
    var v = E(void 0 === a ? 0 : a, 0, r.length - 1),
        w = r.map(function (n) {
            return "string" == typeof n ? l(n, void 0, h()) : l(n, void 0, n.key || h());
        });
    function g(n) {
