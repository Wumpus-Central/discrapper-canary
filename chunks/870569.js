...
let u = r.forwardRef(function (e, t) {
    let { tooltipText: n, children: r, onContextMenu: i, onClick: u, disabled: d, icon: E, iconForeground: f, innerClassName: p, className: C, redGlow: h, tooltipClassName: _, onMouseEnter: g, onMouseLeave: S, 'aria-label': O, 'aria-checked': T, role: I, tooltipColor: N, tooltipForceOpen: m, tooltipContentClassName: A, plated: b } = e,
        P =
            'function' == typeof E
                ? (0, l.jsx)(E, {
                      width: 20,
    ...
    return (0, l.jsx)(a.ua7, {
        ...
        children: (e) => {
            var n,
                E,
                { onClick: f, onMouseEnter: _, onMouseLeave: O } = e,
                N = (function (e, t) {
                    if (null == e) return {};
                    var n,
                        l,
