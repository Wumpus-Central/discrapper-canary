            ...
            : k &&
              ...
              (U === l.default.getSessionId() &&
                  (function (e) {
                      ...
                      if (null == v || null == R || C.get(t)?.location.id === a.id) return;
                      let O = (0, m.H)(a),
                          b = u.A.getChannel(O),
                          D = b?.getGuildId();
...
let X = new q(s.h, {
        ...
        EMBEDDED_ACTIVITY_CLOSE: function (e) {
            let { applicationId: t } = e,
                n = C.get(t);
            C.delete(t), n?.location.id === i?.id && (i = void 0);
        },
        ...
        EMBEDDED_ACTIVITY_SET_CONFIG: function (e) {
            let { applicationId: t, config: n } = e,
                i = C.get(t);
            null != i && C.set(i.applicationId, { ...i, config: n });
        },
