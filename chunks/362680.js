...
function ei(e) {
    let { app: t, linkType: n, activityCustomId: i, activityReferrerId: l, message: a, onView: o } = e,
        ...
        }, [h, Y, B, t.id, U, O, j, b, _, M, i, I, v, m]),
...
function eJ(e) {
    ...
    let A = () => {
        (0, eI.openModalLazy)(async () => {
            let { default: e } = await Promise.all([n.e("61949"), n.e("68031"), n.e("85384"), n.e("20428")]).then(
                n.bind(n, 719847),
            );
            return (t) =>
        ...
        default:
            switch ((0, a_.On)(c)) {
                case a_.Xd.GROUP_DM:
                    ...
                    break;
                case a_.Xd.FRIEND:
                    C = (0, s.jsx)(aV, { invite: c, message: n, getAcceptInviteContext: i });
                    break;
                default:
                    if ((0, a_.G4)(c)) {
...
function o0(e) {
    let t,
        ...
        { canAddNewReactions: E, canManageMessages: C } = (0, u.cf)(
            [tl.A],
            () => ({
