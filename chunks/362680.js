...
function ei(e) {
    let { app: t, linkType: n, activityCustomId: i, activityReferrerId: l, message: a, onView: o } = e,
        ...
        }, [h, Y, B, t.id, U, O, j, b, _, M, i, C, v, m]),
...
function eJ(e) {
    ...
    let A = () => {
        (0, eC.openModalLazy)(async () => {
            let { default: e } = await Promise.all([n.e("13551"), n.e("68031"), n.e("85384"), n.e("20428")]).then(
                n.bind(n, 719847),
            );
            return (t) =>
    ...
    let { guildId: t } = e,
        ...
        c = r.useCallback(async () => {
            eU.default.track(K.HAw.GUILD_SHOP_EMBED_CLICKED, { ...(0, tU.H$)(t) }),
                await (0, tV.A)(K.BVt.SERVER_SHOP(t));
        }, [t]);
    (0, e4.A)(
...
async function nc(e) {
    ...
    let r = s ? n : void 0;
    (0, tV.A)(K.BVt.CHANNEL(t, n, i), { welcomeModalChannelId: r });
}
var nu = n(387408),
    nm = n(427209),
    nh = n(249847);
    ...
    let { embedUrl: t, message: n, channel: i } = e,
        ...
        k = r.useCallback(async () => {
            null != d &&
                ...
                d.canAccess
                    ? (0, tV.A)(K.BVt.CHANNEL(d.guildId, d.threadId, d.messageId))
                    : I
                      ? (0, tV.A)(K.BVt.CHANNEL(d.guildId, d.parentChannelId))
    ...
    let t,
        ...
        a =
            ...
            (0, ig.YW)(i.layoutType)
                .with(ip.Z.DEFAULT, () => (0, s.jsx)(iV, { ...t }))
...
let ln = (e) => {
    ...
    return (0, s.jsxs)("div", {
        ...
        children: [
            (0, s.jsx)(tf.eu, { src: h, size: tI._3.SIZE_16, className: i8.my, "aria-label": "" }),
...
function lH(e) {
    let { guildId: t, skuId: n, channel: i, applicationId: l, customNavigateToSocialLayerStorefront: a } = e,
        ...
        A = (0, lT.h)(m),
        { analyticsLocations: f } = (0, E.Ay)(x.A.SLAYER_STOREFRONT_PRODUCT_DETAILS_EMBED);
    (0, lL.pE)();
    let I = (0, u.bG)([U.default], () =>
        ...
        { normalPrice: j, discountedPrice: N, discountPercent: y, userPrice: T } = (0, lS.CD)({ sku: d });
    r.useEffect(() => {
    ...
    return (o || h || R) && (null == d || null == A)
        ...
        : null != A && null != d && (0, ly.A)(A) && A.id === d.applicationId
          ? (0, s.jsxs)("div", {
                className: lG.kL,
                children: [
                    (0, s.jsx)(lU.A, {
                        ...
                        children: [
                            (0, s.jsxs)("div", {
                                ...
                                children: [
                                    ...
                                    (0, s.jsx)(lB, { sku: d, normalPrice: j, discountedPrice: N, discountPercent: y }),
                                ],
                            }),
                            (0, s.jsxs)(lj.e, {
                                wrap: !1,
                                ...
                                children: [
                                    ...
                                    C &&
                                        (0, s.jsx)(eg.$, {
                                            ...
                                            text:
                                                null != T
                                                    ? J.intl.format(J.t.Xp5WTn, { price: T })
...
function sb(e) {
    ...
    return (0, s.jsxs)("div", {
        ...
        children: [
            ...
            (0, s.jsx)(sT.A, { message: t, channel: n, compact: !0 }),
            (0, s.jsx)("div", {
                className: le.Au,
...
function sM(e) {
    ...
    return null == i ? null : (0, s.jsx)(sP, { channel: i, compact: n, isSystemMessage: (0, sf.A)(t) });
}
function sP(e) {
    var t;
    let i,
...
let rd = r.memo(function (e) {
    let t,
        ...
        y = (0, re.vG)({ userId: g, channelId: i, application: N }),
        T = null == A,
        S = (function (e) {
        ...
        })({ embeddedActivity: A, joinability: y, currentEmbeddedActivity: f, channel: m }),
        b = r.useId(),
            ...
            children: T
                ...
                : (0, s.jsxs)(s.Fragment, {
                      children: [
                          ...
                          O > 0 && (0, s.jsx)(Z, { activityUsers: v, guildId: l, activityText: V.text }),
                      ],
                  }),
        }),
        actions: W,
...
function rw(e) {
    let {
        ...
        f = (0, u.bG)([ew.A], () => null != E && !ew.A.didFetchingSkuFail(E));
...
var rG = n(257727),
    rB =
        (((l = rB || {})[(l.DIRECTORY_HERO = 1)] = "DIRECTORY_HERO"),
...
let rV = (e) => {
    ...
    rH = (e) => {
        ...
        return (0, s.jsxs)("div", {
            className: o()(rG.nM, n),
            children: [(0, s.jsx)(tE.t, { size: "md", color: "currentColor", className: rG.Kk }), rU(t)],
        });
    },
    rF = (e) => {
        let { sku: t, className: n } = e;
    ...
    let h = r.useCallback(() => {
        ...
        N = r.useCallback(() => {
            (0, af.he)(
                ...
                af.Ay.acceptInviteAndTransitionToInviteChannel({
                    inviteKey: i.code,
...
function aw(e) {
    let {
        ...
        { bot: E, icon: f } = t,
        I = G.Ay.getApplicationIconURL({ id: t.id, icon: f, bot: E }),
        C = (0, ee.F)(t),
        v = (0, $.f)(t),
        _ = n.length,
        j = r.useMemo(
...
function aV(e) {
    let { invite: t, message: n, getAcceptInviteContext: i } = e,
        ...
        h = r.useCallback(() => {
            ...
            af.Ay.acceptInviteAndTransitionToInviteChannel({ inviteKey: t.code, context: e });
        }, [t, n, d, i]);
            ...
            (0, s.jsxs)(n_.A.Body, {
                children: [
                    (0, s.jsxs)("div", {
                        className: nB.iH,
                        children: [
                            (0, s.jsx)(n_.A.Icon, { user: new aB.A(t.inviter), onClick: c ? g : void 0 }),
...
function aH(e) {
    ...
    eI()(null == h || h.isPrivate(), "must be a private channel");
    let { analyticsLocations: g } = (0, E.Ay)(x.A.INVITE_EMBED),
        p = null != h,
        A = r.useCallback(() => {
            let e = "noop";
    ...
    let f = J.intl.string(J.t.XpeFYr),
        I = "active";
    p && ((f = J.intl.string(J.t.cEnaWx)), (I = "secondary"));
    let C = J.intl.string(J.t["3p3/BK"]);
    return (
        c && (C = J.intl.string(J.t.qmtuXE)),
        (0, s.jsxs)(n_.A, {
            children: [
                ...
                (0, s.jsxs)(n_.A.Body, {
                    children: [
                        ...
                        (0, s.jsx)(eg.$, { onClick: A, loading: m, disabled: p, variant: I, text: f, fullWidth: !0 }),
                    ],
                }),
            ],
        })
...
function aK(e) {
    let t,
        ...
        _ = null != f ? (0, aN.OY)(f) : null,
        j = null != d,
        N = null != _,
        y = null != _ && _.isGuildStageVoice(),
        T = (0, c.Lt)(m.flags ?? 0, aF.Q.IS_GUEST_INVITE),
    ...
    if (null == d) {
        ...
        (d = aT.DY(m.guild)).premiumTier = m.guild.premium_tier ?? K.TVA.NONE;
    }
    let G = (function (e) {
    ...
    return (
        ...
        T &&
            (l = (0, s.jsx)(iR.m, {
                ...
                children: (0, s.jsx)(tQ.m, { size: "md", color: "currentColor", className: nB.G }),
            })),
        S
        ...
        : (0, s.jsxs)(aJ.s, {
              ...
              children: [
                  (0, s.jsxs)("div", {
                      ...
                      ref: d,
                      children: [
                          (0, s.jsx)(a0.J$, { profile: I, className: a2.vK }),
                          (0, s.jsx)(a0.CG, { profile: I }),
                          (0, s.jsx)(a$.A, { profile: I }),
                          (0, s.jsx)(aX.P, { profile: I, className: a2.rb }),
                          (0, s.jsx)(a1.A, {
                              guild: null != t.guild ? (0, aT.DY)(t.guild) : null,
                              roles: t.roles,
                              className: a2.Ei,
                          }),
                      ],
...
function a9(e) {
    ...
    let y = null != n.channel ? (0, aN.OY)(n.channel) : null,
        T = rL.Ay.getName(C),
        S = A || (!f && N),
            ...
            (0, s.jsxs)(n_.A.Body, {
                children: [
                    (0, s.jsxs)("div", {
                        className: nB.iH,
                        children: [
                            (0, s.jsx)(n_.A.Icon, { guild: l, onClick: N && f ? j : void 0 }),
                            (0, s.jsx)(n_.A.Info, { title: t, onClick: N && f ? j : void 0, children: R }),
                        ],
                    }),
            ...
            return (0, s.jsxs)(eb.D, {
                ...
                children: [
                    ...
                    (0, s.jsx)(p.E, {
                        ...
                        variant: "text-sm/medium",
                        color: "text-default",
                        children: (0, s.jsx)(of.A, { user: t, nick: l, hideDiscriminator: !0 }),
                    }),
                ],
            });
        },
...
function oj(e) {
    let { users: t, guildId: n, channelId: i, onHoverOrFocus: l } = e,
        a = r.useRef(null),
        { isHoveringOrFocusing: o } = (0, oE.A)(a);
    return (
        r.useEffect(() => {
            l?.(o);
        }, [l, o]),
...
function oT(e) {
    let { className: t, guildId: n, channelId: i, members: l, ref: a, motion: d } = e,
        ...
        [x, E] = (0, ik.z)(() => ({ x: 0, y: 0, scale: 1, config: oy }));
    return (
        r.useEffect(() => {
            E({ x: g, y: p, scale: A });
        }, [g, p, A, E]),
    ...
    let { guildId: t, channelId: n, members: i, count: l } = e,
        {
            ...
            let e = r.useRef(null),
                { isHoveringOrFocusing: t } = (0, oE.A)(e),
                [n, i] = r.useState(!1),
                l = t || n,
                [s, a] = r.useState(!1),
                o = r.useRef(null);
...
function oL(e) {
    let { invite: t, message: n, guild: i, onTransitionToInviteChannel: l, onAcceptInstantInvite: a } = e,
        d = r.useRef(null),
        c = i ?? null;
    null == c && null != t.guild && (c = aT.DY(t.guild));
                ...
                (0, af.he)(
                    {
                        ...
                        stream_key: null != y ? (0, om._z)(y) : void 0,
        ...
        L = r.useCallback(() => {
            I ? (0, i0.iN)(m.id) : a({ autoJoin: !1 }),
                eU.default.track(K.HAw.VOICE_INVITE_EMBED_BREADCRUMB_CLICKED, {
                    ...
                    stream_key: null != y ? (0, om._z)(y) : null,
                    number_of_users_in_channel: g.length,
                    location_stack: j,
                });
                                        ...
                                        children: [
                                            ...
                                            null != f
                                                ? (0, s.jsx)(p.E, {
                                                      variant: "text-sm/normal",
                                                      className: ob.$B,
                                                      children: (0, s.jsx)(lQ.A, { delay: 150, children: f }),
                                                  })
                                                : null,
                                        ],
                                    }),
...
function oR(e) {
    let { code: t, message: n, getAcceptInviteContext: i } = e,
        { invite: l, inviteError: a } = (0, u.cf)(
            [ay.A],
            () => ({ invite: ay.A.getInvite(t), inviteError: ay.A.getInviteError(t) }),
            [t],
        ),
        o = null == l,
        d = (0, nH._U)(t, n.id);
    r.useEffect(() => {
        o && af.Ay.resolveInvite(t, void 0, { inviteInstanceId: d });
    }, [t, o, d]);
    let c = l ?? { state: K.elq.RESOLVING, code: "" },
        ...
        x = () => {
            null != c.channel && af.Ay.transitionToInviteSync(c);
        },
        f = function () {
            let { autoJoin: e } = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                n = null == h && l?.guild != null ? aT.DY(l.guild) : h;
        ...
        default:
            switch ((0, a_.On)(c)) {
                case a_.Xd.GROUP_DM:
                    ...
                    break;
                case a_.Xd.FRIEND:
                    I = (0, s.jsx)(aV, { invite: c, message: n, getAcceptInviteContext: i });
                    break;
                default:
                    if ((0, a_.G4)(c)) {
...
class o$ extends r.Component {
        ...
        return e.codedLinks.map((n) => {
            ...
            switch (i) {
                ...
                case tP.I.SOCIAL_LAYER_STOREFRONT_APP: {
                    let [e, n] = l.split("-");
                    return (0, s.jsx)(lV, { applicationId: n, skuId: e, channel: t }, l);
                }
        ...
        return 0 === e.embeds.length || !t || n
            ...
            : e.embeds.map((t, n) => {
                  ...
                  if (
                      ...
                      let i = sB.A.safeParseWithQuery(t.url);
    ...
    renderActivityInvite(e) {
        ...
        return (0, s.jsx)(oO, { channel: t, message: e, hideParty: !1, hideInviteEmbedBanner: n });
    }
    renderPublishBump(e) {
    ...
    renderThreadRoleMentionWarning(e) {
        if (
            ...
            !(Date.now() - sI.default.extractTimestamp(e.id) >= oZ)
        )
...
function o0(e) {
    let t,
        ...
        d = nn.X6.useSetting(),
        m = nn.hD.useSetting(),
        h = nn.rs.useSetting() && !(0, sf.A)(e.message),
