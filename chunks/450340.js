...
function tm(e) {
    ...
    let l = (0, c.yK)([eZ.Ay], () => Object.values(eZ.Ay.getClips())),
        ...
        E = (0, c.bG)([e7.Ay], () => e7.Ay.getKeybindForAction(tI.hCu.SAVE_CLIP)),
        A = r.useCallback(
            (e) => {
                s?.(e);
            },
        ...
        m = [
            (0, e8.$)(o.clipsLength / e5.A.Millis.SECOND),
...
var nQ = n(146901),
    nJ = n(827827);
let n0 = [
        { duration: 15 * e5.A.Millis.MINUTE, label: () => F.intl.string(F.t["8ot6gv"]) },
        { duration: e5.A.Millis.HOUR, label: () => F.intl.string(F.t.UMWBZr) },
        { duration: 8 * e5.A.Millis.HOUR, label: () => F.intl.string(F.t.EpAXPC) },
        { duration: e5.A.Millis.DAY, label: () => F.intl.string(F.t["755t4q"]) },
        { duration: 3 * e5.A.Millis.DAY, label: () => F.intl.string(F.t["f3/1ch"]) },
...
var n5 = n(371912),
    ...
    io = n(499156),
    id = n(731854);
let ic = 2.5 * e5.A.Millis.SECOND,
    iu = +e5.A.Millis.HOUR;
var i_ = n(459838),
    iE = n(485296);
let iA = 3 * e5.A.Millis.SECOND,
    ih = +e5.A.Millis.DAY;
var iI = n(616356),
    ip = n(734057),
    iT = n(629016),
...
function rA(e) {
    let t,
        ...
        O = (0, c.bG)([ro], () => ro.getIsTutorialActive(rd.v.MUTE_TUTORIAL)),
        R = (0, c.bG)([il.A], () => null != il.A.getChannelId()),
...
var rR = n(489902);
let rL = iO.Ay.getEnableHardwareAcceleration() ? E.Js : E.eu,
    rD = 2.5 * e5.A.Millis.SECOND,
    ry = 2 * e5.A.Millis.MINUTE,
    rv = 2 * e5.A.Millis.MINUTE,
    rb = 5 * e5.A.Millis.SECOND;
function rM(e) {
    let {
            ref: t,
            speaking: n,
              ...
              children: (0, i.jsx)(it.A, {
                  ...
                  children: (e) => {
                      ...
                      return (0, i.jsxs)("div", {
                          ...
                          className: s()(rR.Q9, { [rR.ZQ]: null != E }),
                          children: [
                              (0, i.jsx)(I.D, {
                                  ...u,
                                  onClick: (t) => {
                              ...
                              (0, i.jsx)("div", { className: rR.oM, children: _(N) }),
                          ],
                      });
                  },
              }),
    ...
    renderStatus() {
        ...
        return null != o
            ? (0, i.jsxs)(b.A, {
                  ...
                  children: [
                      (0, i.jsx)(f.A, { children: t8.Ay.humanizeStatus(a) }),
                      (0, i.jsx)(er.A, { activity: o, emojiClassName: rR.Zg, className: rR.WO }),
                  ],
              })
                      ...
                      (0, i.jsx)(p.sk, {
                          children: (e) =>
                              (0, i.jsxs)("div", {
                                  ...
                                  className: s()(rR.kL, { [rR.UG]: null != n, [rR.bc]: !r, [rR.G5]: a }),
    ...
    return (0, i.jsxs)("div", {
        ...
        children: [
            (0, i.jsx)(rA, {
                ...
                onClick: A,
                onContextMenu: h,
                iconForeground: null != m ? rR.t4 : void 0,
                nameplate: m,
                shouldShowSpeakingWhileMutedTooltip: o,
...
function rG() {
    let e = (0, c.bG)([nE.default], () => nE.default.getCurrentUser()),
        ...
        O = (0, c.bG)([is.Ay], () => is.Ay.getSpeakingWhileMuted()),
        R = (0, c.bG)([$.A], () => $.A.isFullscreenInContext()),
        L = (0, c.bG)([im.A], () => im.A.hasLayers()),
        D = (0, T.useModalsStore)(T.hasAnyModalOpenSelector) || L || iC.P.isDisallowPopupsSet() || R,
