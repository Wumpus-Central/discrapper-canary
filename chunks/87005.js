...
function C(e) {
    let { context: t, onlyActivityApps: n, allowCommandFetch: s, includeAuthorizedAppsAndFetch: C } = e,
        { sectionDescriptors: v, loading: b } = o.wi({
            context: t,
            filters: h,
            options: g,
            allowFetch: s
    ...
    return {
        ...
        frecentApps: (function (e) {
            ...
            let g = (0, l.Wu)([u.Z], () => {
                ...
                _ = (0, d.h)(C, g);
            return r.useMemo(() => (s ? _.filter((e) => null != e.application && (0, m.ye)(e.application) && null != (0, c.Xu)(n, e.id)).filter((e) => !b.includes(e.id)) : _.filter((e) => !b.includes(e.id))), [s, _, n, b]);
        })({
