...
function b(e) {
    let { context: t, onlyActivityApps: n, allowCommandFetch: o, includeAuthorizedAppsAndFetch: b } = e,
        { sectionDescriptors: v, loading: y } = s.wi({
            context: t,
            filters: h,
            options: g,
            allowFetch: o
    ...
    return {
        ...
        frecentApps: (function (e) {
            ...
            let g = (0, l.Wu)([d.Z], () => (s ? d.Z.getNewestTokens().filter((e) => e.scopes.includes(i.x.APPLICATIONS_COMMANDS)) : [])),
                ...
                j = (0, u.h)(b, g);
            return r.useMemo(() => (o ? j.filter((e) => null != e.application && (0, p.ye)(e.application) && null != (0, c.Xu)(n, e.id)).filter((e) => !y.includes(e.id)) : j.filter((e) => !y.includes(e.id))), [o, j, n, y]);
        })({
