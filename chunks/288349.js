...
function _(e) {
    let { width: t = 14, height: n = 15, color: r = "white", foreground: a, ...l } = e;
    return (0, i.jsxs)("svg", {
        ...(0, d.A)({ ...l }),
...
function m(e) {
    let { className: t, startsAt: n, endsAt: r, messageStyle: d, upperCase: m, showSparkles: p } = e,
        [g] = (0, o.Bo)(l.M.FRACTIONAL_NITRO_DURATION_LEFT_PILL, {
          ...
          (0, i.jsxs)("div", {
              ...
              children: [
                  ...
                  (0, i.jsx)(c.R, {
                      text: E,
                      colorOptions:
                          g === l.M.FRACTIONAL_NITRO_DURATION_LEFT_PILL
