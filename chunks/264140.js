...
class tc extends l.PureComponent {
    ...
    openUserProfile = () => {
        ...
        o()(e?.isPrivate(), "Missing private channel in Channel.openUserProfile"),
            (0, eG.openUserProfileModal)({
                ...
                guildId: e.guild_id,
                channelId: e.id,
                sourceAnalyticsLocations: [R.A.CHANNEL_HEADER],
            });
    };
    ...
    renderThreadSidebar() {
        ...
        return (
            ...
            (0, i.jsx)(eZ.A, {
                sidebarType:
                    t?.type != null && e7.kvI.GUILD_THREADS_ONLY.has(t.type) ? eZ.X.PostSidebar : eZ.X.ThreadSidebar,
                maxWidth: c,
...
let tu = (0, C.A)(tc),
    th = l.memo(function (e) {
        let { providedChannel: t } = e,
            ...
            v = (0, Y.A)(),
            R = (0, h.bG)([eK.A], () => (v?.channelId ?? eK.A.getVoiceChannelId()) === m?.id),
            G = (0, h.bG)([S.Ay], () => (null != m ? S.Ay.getSelfEmbeddedActivityForChannel(m.id) : null), [m]),
            M = (0, h.bG)([eY.A], () => eY.A.isConnected()),
            D = (0, N.A)(M),
            U = M && !1 === D;
        l.useEffect(() => {
            R &&
        ...
        let P = (0, h.bG)([S.Ay], () => S.Ay.getCurrentEmbeddedActivity()),
            ...
            Z = (0, h.bG)([eP.A], () => eP.A.hasSeen(m?.guild_id, X), [m, X]),
            J = (0, h.bG)(
                [O.A, S.Ay],
                () =>
        ...
        l.useEffect(() => {
            let e = eC && !eI,
                t = eC && eI && m?.id !== eN;
            (e || t) && (0, B.Dr)(A.M.ACTIVITY_GDM_CALL_TOOLTIP, { dismissAction: e9.i.AUTO });
        }, [m?.id, eN, eI, eC]);
