        ...
        children: [
            (0, n.jsxs)('div', {
                ...
                children: [
                    ...
                    C && (0, n.jsx)(u.fFY, { className: Z.rewardTileAssetStatusIcon }),
                    (0, n.jsx)(D.Z, {
                        className: s()(Z.rewardTileAsset, { [Z.rewardTileAssetLoading]: b || C }),
                        quest: r,
...
function z(e) {
    var t;
    let { transitionState: r, onClose: a, quest: s, location: d, questContentPosition: c, impressionRef: g, preview: O } = e,
        k = (0, _.Z)(() => {
            var e;
        ...
        D = P.length > 1,
        [W, z] = o.useState(D ? null : P[0]),
        U = o.useRef(new i.qA()),
        F = o.useRef(null),
        [G, H] = o.useState(null),
        X = (0, l.e7)([C.Z], () => C.Z.useReducedMotion),
    ...
    let ef = o.useMemo(
        ...
        eg = o.useMemo(() => ((null == ef ? void 0 : ef.redemptionLink) == null || '' === ef.redemptionLink ? null : (null == ee ? void 0 : ee.code) == null || '' === ee.code ? ef.redemptionLink : ef.redemptionLink.replace(N.Dp, encodeURIComponent(ee.code))), [ef, ee]),
        eC = (0, R.G)({
            claimCode: er,
            fetchCode: en,
            hasError: es,
