...
function U(e) {
    ...
    er &&
        (em = (0, r.jsx)(p.PhF, {
            ...
            errorMessage: ei ? M.intl.string(M.t.rbZBMT) : void 0,
    ...
    er
        ? (ex = M.intl.string(M.t.SLZMi4))
        : !er && ei
          ? (ex = M.intl.string(M.t.gNJHHh))
          : ev && (ex = M.intl.string(M.t["+zx47e"]));
