                            ...
                            if (!f) {
                                ...
                                if (a.is.und(o.duration))
                                    if (o.decay) {
                                        ...
                                        for (var b = null == c.lastVelocity ? m : c.lastVelocity, y = o.precision || (h == d ? 0.005 : Math.min(1, 0.001 * Math.abs(d - h))), v = o.restVelocity || y / 10, O = o.clamp ? 0 : o.bounce, I = !a.is.und(O), S = h == d ? c.v0 > 0 : h < d, T = !1, A = 1, N = Math.ceil(e / 1), C = 0; C < N && !(!(Math.abs(b) > v) && (f = Math.abs(d - _) <= y)); ++C) {
