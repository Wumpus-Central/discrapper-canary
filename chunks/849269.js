...
var i,
    ...
    S = n(360469),
    y = n(652215),
    N = (((i = {})[(i.START = 0)] = "START"), (i[(i.JOIN = 1)] = "JOIN"), (i[(i.LEAVE = 2)] = "LEAVE"), i);
function v(e) {
    let {
            activityItem: t,
            context: n,
        ...
        v = R({ context: n, applicationId: h.id }),
        b = O({
...
function O(e) {
    let {
        ...
        y = t?.id ?? "",
        N = R({ context: i, applicationId: y, fetchesApplication: g }),
