...
let c = Object.freeze({
    ...
    d = [l.GENERIC_SUBSCRIPTION, l.GENERIC_CONSUMABLE];
Object.freeze({
    [u.gD.PREMIUM_MONTH_TIER_0]: c.PREMIUM_TIER_0_MONTHLY,
    [u.gD.PREMIUM_MONTH_TIER_1]: c.PREMIUM_TIER_1_MONTHLY,
    [u.gD.PREMIUM_MONTH_TIER_2]: c.PREMIUM_TIER_2_MONTHLY,
    [u.gD.PREMIUM_MONTH_GUILD]: c.PREMIUM_GUILD_1_MONTHLY,
    [u.gD.PREMIUM_YEAR_TIER_0]: c.PREMIUM_TIER_0_YEARLY,
    [u.gD.PREMIUM_YEAR_TIER_1]: c.PREMIUM_TIER_1_YEARLY,
    [u.gD.PREMIUM_YEAR_TIER_2]: c.PREMIUM_TIER_2_YEARLY,
}),
    c.PREMIUM_MONTH_TIER_1,
    c.PREMIUM_MONTH_TIER_1,
    u.WT.MONTH,
    u.PremiumTypes.TIER_1,
    ...
    u.PremiumTypes.TIER_2,
    u.gD.PREMIUM_MONTH_TIER_2,
    u.gD.PREMIUM_MONTH_GUILD,
    c.PREMIUM_TIER_2_PREMIUM_GUILD_1_YEARLY,
    c.PREMIUM_TIER_2_PREMIUM_GUILD_1_YEARLY,
    u.WT.YEAR,
    u.PremiumTypes.TIER_2,
    u.gD.PREMIUM_YEAR_TIER_2,
    u.gD.PREMIUM_YEAR_GUILD,
...
class p extends a.Ay.Store {
    ...
    genericProductsLoaded() {
        return null != _ && s().filter(_, (e) => d.includes(e.identifier)).length === d.length;
    }
    getProducts() {
        return _;
    }
