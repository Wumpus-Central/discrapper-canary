...
class g extends r.Ay.Store {
    ...
    getGuildProductsForGuild(e, t) {
        ...
        return null == e ? m : p.values(n ? E(e) : f(e));
    }
    getGuildProductFetchState(e) {
        return d[e] ?? 0;
    }
    isGuildProductsCacheExpired(e) {
        return Date.now() - (_[e] ?? 0) > h;
    }
}
let A = new g(a.h, {
