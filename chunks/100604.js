...
class h {
    getForwardInfo() {
        ...
        let m = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : l.Z,
            ...
            { snapshotIndex: E, parentMessage: y, messageSnapshot: v } = this,
            O = (0, d.Xf)(v.message.timestamp),
            j = m.getChannel(this.parentMessage.channel_id);
        if (null != j && j.guild_id === (null == (e = y.messageReference) ? void 0 : e.guild_id)) {
            ...
            if (!_.can(e.accessPermissions, e)) return { snapshotIndex: E };
        ...
        if (null == C) return { snapshotIndex: E };
