        ...
        if (v) {
            ...
            switch (C) {
                case _.POd.COLLECTIBLES:
                    ((G = M), (U = y ? h.intl.format(h.t.ofqyUl, { paidURL: _.EYA.PAID_TERMS }) : h.intl.format(h.t.G3l0s7, { paidURL: _.EYA.PAID_TERMS })));
                    break;
                case _.POd.GUILD_PRODUCT:
                    ((G = M), (U = h.intl.format(h.t['GEAQ+v'], { paidURL: _.EYA.PAID_TERMS })));
                    break;
                default:
