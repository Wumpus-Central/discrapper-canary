    ...
    E = function (e) {
        ...
        if (v) {
            ...
            if (null != s && (null == T ? void 0 : T.subscriptionPeriodEnd) != null)
                G = h.intl.format(h.t["2VPTay"], { subtotalRate: E });
            else
                switch (t) {
                    case p.rV.MONTH:
                        G =
                        ...
                        break;
                    case p.rV.YEAR:
                        G = h.intl.format(h.t.y9gsX5, {});
                        break;
                    case void 0:
                        G = h.intl.format(h.t.UxGFH4, {});
                        break;
                    default:
            ...
            switch ((y && (B = k), t)) {
                case p.rV.MONTH:
                    ...
                    break;
                case p.rV.YEAR:
                    G = y ? h.intl.string(h.t.vAfbG8) : h.intl.string(h.t.IGzFc5);
                    break;
                case void 0:
                    G = "";
                    break;
