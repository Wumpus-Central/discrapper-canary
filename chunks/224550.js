...
let m = function (e) {
    ...
    if (null != I) {
        ...
        (t = e.intervalType), (n = e.intervalCount), (m = (0, u.og)((0, u.T4)(I.total, I.currency), t, n)), (g = (0, u.og)((0, u.T4)(I.subtotal, I.currency), t, n));
    ...
    if (y) M = p.NW.format(p.t.rr811N, { paidURL: f.EYA.PAID_TERMS });
        ...
        if (null != m && (null == I ? void 0 : I.subscriptionPeriodEnd) != null) M = p.NW.format(p.t['2VPTa2'], { subtotalRate: g });
        else
            switch (t) {
                case _.rV.MONTH:
        ...
        if ((null != C && null != t && null != n && (e = (0, u.og)((0, u.T4)(C.amount, C.currency), t, n)), null == e)) {
