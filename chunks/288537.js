...
function ea(e, t) {
    ...
    do {
        ...
        ((a += 2), n++);
        do;
        while (c[++a] === c[++n] && c[++a] === c[++n] && c[++a] === c[++n] && c[++a] === c[++n] && c[++a] === c[++n] && c[++a] === c[++n] && c[++a] === c[++n] && c[++a] === c[++n] && a < f);
    ...
    for (var n, r; ; ) {
        ...
        if (((n = 0), e.lookahead >= k && ((e.ins_h = ((e.ins_h << e.hash_shift) ^ e.window[e.strstart + k - 1]) & e.hash_mask), (n = e.prev[e.strstart & e.w_mask] = e.head[e.ins_h]), (e.head[e.ins_h] = e.strstart)), 0 !== n && e.strstart - n <= e.w_size - j && (e.match_length = ea(e, n)), e.match_length >= k))
            if (((r = a._tr_tally(e, e.strstart - e.match_start, e.match_length - k)), (e.lookahead -= e.match_length), e.match_length <= e.max_lazy_match && e.lookahead >= k)) {
                e.match_length--;
                do (e.strstart++, (e.ins_h = ((e.ins_h << e.hash_shift) ^ e.window[e.strstart + k - 1]) & e.hash_mask), (n = e.prev[e.strstart & e.w_mask] = e.head[e.ins_h]), (e.head[e.ins_h] = e.strstart));
...
function el(e, t) {
    for (var n, r, i; ; ) {
        ...
        if (((n = 0), e.lookahead >= k && ((e.ins_h = ((e.ins_h << e.hash_shift) ^ e.window[e.strstart + k - 1]) & e.hash_mask), (n = e.prev[e.strstart & e.w_mask] = e.head[e.ins_h]), (e.head[e.ins_h] = e.strstart)), (e.prev_length = e.match_length), (e.prev_match = e.match_start), (e.match_length = k - 1), 0 !== n && e.prev_length < e.max_lazy_match && e.strstart - n <= e.w_size - j && ((e.match_length = ea(e, n)), e.match_length <= 5 && (e.strategy === y || (e.match_length === k && e.strstart - e.match_start > 4096)) && (e.match_length = k - 1)), e.prev_length >= k && e.match_length <= e.prev_length)) {
            ...
            do ++e.strstart <= i && ((e.ins_h = ((e.ins_h << e.hash_shift) ^ e.window[e.strstart + k - 1]) & e.hash_mask), (n = e.prev[e.strstart & e.w_mask] = e.head[e.ins_h]), (e.head[e.ins_h] = e.strstart));
...
function ey(e, t) {
    ...
    for (1 === s && (e.adler = o(e.adler, t, f, 0)), n.wrap = 0, f >= n.w_size && (0 === s && ($(n.head), (n.strstart = 0), (n.block_start = 0), (n.insert = 0)), (d = new i.Buf8(n.w_size)), i.arraySet(d, t, f - n.w_size, n.w_size, 0), (t = d), (f = n.w_size)), l = e.avail_in, c = e.next_in, u = e.input, e.avail_in = f, e.next_in = 0, e.input = t, eo(n); n.lookahead >= k; ) {
        ...
        do ((n.ins_h = ((n.ins_h << n.hash_shift) ^ n.window[r + k - 1]) & n.hash_mask), (n.prev[r & n.w_mask] = n.head[n.ins_h]), (n.head[n.ins_h] = r), r++);
        while (--a);
