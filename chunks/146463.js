...
let N = function (e) {
    var t;
    let { applicationStatus: n, guildJoinRequests: a, guildId: u, onScroll: m, listRef: N, atMaxMemberCapacity: y } = e,
        I = (0, l.e7)([d.Z], () => d.Z.getGuild(u), [u]),
        T = (0, l.e7)([f.Z], () => f.Z.isFetching()),
        w = T ? [a.length + 25] : [a.length],
        O = (0, h.L)({ guildId: u }),
        P = null !== (t = (0, b.A)({ guildId: u })) && void 0 !== t ? t : 0,
