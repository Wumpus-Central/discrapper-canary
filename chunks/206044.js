...
let M = (0, l.animated)(d.CJ0),
    ...
    Z = (e) => {
        var t, n;
        let { isFocused: i, isQuestExpired: u, quest: h, location: f, size: v, expansionSpring: Z, isAnimating: B, isExpanded: L, isInConcurrentQuestExperiment: U, contentPosition: Q, toggleExpanded: W } = e,
