...
function el(e) {
    let { flipped: t = !1, locked: n = !1, user: i, nick: l, displayNameMode: c, displayUserMode: d, size: u = $.ipw.LARGE, onClick: h, onContextMenu: p, context: f, guildId: g, voiceState: y } = e,
        ...
        j = o.useMemo(() => null != E && E.ownerId !== i.id && S.includes(i.id), [E, i.id, S]);
    if (d === $.OYC.ONLY_WHILE_SPEAKING && n && !x) return null;
    let I = i.id === _,
        { mute: P, selfMute: w, suppress: N, deaf: T, selfDeaf: k } = y,
        L = O && v,
        M = w && (!I || !L);
...
class es extends (i = o.PureComponent) {
    ...
    renderStreamerSettings() {
        ...
        let { sanitizedTitle: h, title: p } = (0, x.Z)(a);
