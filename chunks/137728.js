...
let eL = "/assets/34c8999cfe272b23.svg",
    ...
    eg = ee.Ay.getEnableHardwareAcceleration() ? p.Js : p.eu,
    eE = {
...
function eA(e) {
    let { ...s } = e,
        { theme: t } = (0, z.E)(),
        i = (0, j.r)(g.A.colors.INTERACTIVE_TEXT_ACTIVE, t).hex();
    return (0, n.jsx)(E.t, { size: "md", ...s, color: i });
}
function eI(e) {
    let s,
            ...
            a?.premiumType === eC.PremiumTypes.TIER_2
                ? (0, n.jsxs)(W.A, {
                      ...
                      children: [
                          ...
                          (0, n.jsx)(eg, {
                              className: ep.jU,
                              src: t.getAvatarURL(void 0, (0, f.FT)(f._3.SIZE_56), !l),
                              size: f._3.SIZE_56,
                ...
                : (0, n.jsxs)("div", {
                      ...
                      children: [
                          ...
                          (0, n.jsxs)("div", {
                              ...
                              children: [
                                  (0, n.jsx)(B.A, { className: ep.Bj, usernameClass: ep.TE, name: t.toString() }),
                                  (0, n.jsx)(E.t, { size: "md", color: "currentColor", className: ep.kC }),
                              ],
                          }),
                      ],
                  })),
...
function e_(e) {
    let { currentUser: s, onClose: t } = e,
        i = (0, es.$F)(),
        { analyticsLocations: r } = (0, R.Ay)(P.A.PREMIUM_UNCANCEL_MODAL),
        a = (0, es.Xb)(),
        l = (0, et.t)(),
...
let eR = i.createContext({ isPremiumRebrand: !1 }),
    ey = () => i.useContext(eR).isPremiumRebrand;
function eb(e) {
        ...
        u = i.useMemo(() => {
            ...
            switch (t) {
                case eC.PremiumTypes.TIER_0:
                    e.push((0, n.jsx)(ev, { premiumType: t }), (0, n.jsx)(eP, { premiumType: t }));
                    break;
...
let eU = function (e) {
    ...
    i.useEffect(() => {
        (0, k.A)(f.id, f.getAvatarURL(null, 80));
    }, [f]);
    let T = null != h && !p;
    return (i.useEffect(() => {
        T &&
                  ...
                  (0, n.jsx)(m.c, {
                      children: (0, n.jsxs)("div", {
                          ...
                          children: [
                              ...
                              (0, n.jsxs)("div", {
                                  className: E,
                                  children: [g, (0, n.jsx)(L.E, { variant: "text-md/normal", children: r })],
                              }),
                              (0, n.jsx)(eb, { currentUser: f, premiumType: s, onClose: l, isDowngrade: j }),
                          ],
                      }),
                  }),
