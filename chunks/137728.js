...
var i = t(627968),
    ...
    em = t(150252);
let eu = function (e) {
    let { churnUserDiscountOffer: s, onDiscountClaim: t, onContinue: a } = e,
        r = (0, U.Ay)(),
    ...
    return null == s
        ...
        : (0, i.jsxs)("div", {
              className: em.bR,
              children: [
                  (0, i.jsx)("div", { className: em.v0 }),
                  (0, i.jsx)("div", { className: em.X2 }),
                  (0, i.jsx)("div", {
                      className: em.Dg,
                      children: (0, i.jsxs)("div", {
                          className: em.xt,
                          children: [
                              (0, i.jsx)("img", { alt: "", src: l, className: em.lR }),
                              (0, i.jsxs)("div", {
                                  className: em.t2,
                                  children: [
                                      (0, i.jsx)(f.E, {
...
let ef = "/assets/34c8999cfe272b23.svg",
    ...
    e_ = ee.Ay.getEnableHardwareAcceleration() ? p.Js : p.eu,
    eC = {
    ...
    return (0, i.jsxs)("div", {
        ...
        children: [
            (0, i.jsxs)("div", {
                ...
                children: [
                    (0, i.jsx)(f.E, { variant: "text-md/normal", children: s }),
                    (0, i.jsx)(A.Q, { onClick: t, text: ec.intl.string(ec.t.hvVgAZ) }),
                ],
            }),
            (0, i.jsx)("div", { className: l()(ep.aS, { [ep.u0]: r }), children: a() }),
        ],
    });
}
function eT(e) {
    ...
    return (0, i.jsx)(C.t, { size: "md", ...s, color: a });
}
function eg(e) {
    let s,
        { currentUser: t, premiumType: a, onClose: r } = e,
        l = (0, k.Ay)(t.id),
        n = (0, u.bG)([y.A], () => y.A.useReducedMotion),
        o = (0, D.X)("PremiumSubscriptionWhatYouLoseModal"),
        c = a === ex.PremiumTypes.TIER_1;
    return (
        (s =
                ...
                ? (0, i.jsxs)(F.A, {
                      ...
                      children: [
                          ...
                          (0, i.jsxs)("div", {
                              className: ep.b$,
                              children: [
                                  (0, i.jsx)(K.A, { className: ep.Bj, usernameClass: ep.TE, name: t.toString() }),
                                  (0, i.jsx)(eT, { className: ep.kC }),
                              ],
                          }),
                      ],
                  })
                : (0, i.jsxs)("div", {
                      ...
                      children: [
                          ...
                          (0, i.jsxs)("div", {
                              ...
                              children: [
                                  (0, i.jsx)(K.A, { className: ep.Bj, usernameClass: ep.TE, name: t.toString() }),
                                  (0, i.jsx)(C.t, { size: "md", color: "currentColor", className: ep.kC }),
                              ],
                          }),
                      ],
                  })),
...
function ev(e) {
    let { currentUser: s, onClose: t } = e,
        ...
        l = (0, es.Xb)(),
        n = (0, et.t)(),
        o = a?.id ?? ex.Ac.PREMIUM_TENURE_1_MONTH,
        c = (0, ei.A)(o);
    if (!(0, Q.YE)(s, ex.PremiumTypes.TIER_2) || null == l) return null;
    let m = a?.status ?? es.Wo.UPCOMING,
        u = a?.nameUnformatted ?? ex.VD[ex.Ac.PREMIUM_TENURE_1_MONTH].nameUnformatted,
        d = (0, ea.I)(o).standard,
        x = ec.intl.string(u),
        j = m === es.Wo.EARNED,
        p = n?.days ?? 1,
    ...
    return (0, i.jsx)(eI, {
        ...
        renderVisual: () =>
            (0, i.jsx)(h.h, {
                className: ep.nc,
                color: c,
                children: (0, i.jsx)("img", { alt: x, src: d, className: ep.pq }),
            }),
    });
}
function eM(e) {
    let { premiumType: s } = e,
        ...
        a = (0, L.Fj)(null)
            ...
            .slice(0, 3),
        r = (0, u.yK)([w.A], () => w.A.stickerFrecencyWithoutFetchingLatest.frequently.slice(0, 3 - a.length)),
    ...
    return (0, i.jsx)(eI, {
        ...
        renderVisual: () =>
            (null != a && a.length > 0) || (!n && null != r && r.length > 0)
                ? (0, i.jsxs)("div", {
                      className: ep.iB,
                      children: [
                          a
                              ...
                              .map((e, s) =>
                                  null != e
                                      ? (0, i.jsx)("img", { className: ep.d7, alt: "", src: e }, `emoji-${s}`)
                                      : null,
                              ),
                          n
                              ? null
                ...
                : (0, i.jsx)("img", { className: ep.OP, alt: "", src: l }),
    });
}
function eU(e) {
            ...
            c
                ? (0, i.jsx)("div", {
                      ...
                      children: (0, i.jsxs)("div", {
                          className: ep.W5,
                          children: [
                              (0, i.jsx)(S.Ay, { guild: n, size: S.Ay.Sizes.MEDIUM, animate: !r, className: ep.Hc }),
                              (0, i.jsxs)("div", {
                                  className: ep.IA,
                                  children: [
                                      (0, i.jsx)(f.E, {
...
let eP = a.createContext({ isPremiumRebrand: !1 }),
    eL = () => a.useContext(eP).isPremiumRebrand;
function eb(e) {
        ...
        c = a.useMemo(() => {
            ...
            switch (t) {
                case ex.PremiumTypes.TIER_0:
                    e.push((0, i.jsx)(eM, { premiumType: t }), (0, i.jsx)(eR, { premiumType: t }));
                    break;
                case ex.PremiumTypes.TIER_1:
                    n
                        ? e.push(
                              (0, i.jsx)(eg, { currentUser: s, premiumType: t, onClose: r }, "profile-item"),
                              (0, i.jsx)(ey, {}, "screen-share-item"),
                              (0, i.jsx)(eU, { premiumType: t, onClose: r }, "boost-item"),
                          )
                        : e.push(
                              (0, i.jsx)(eg, { currentUser: s, premiumType: t, onClose: r }, "profile-item"),
                              (0, i.jsx)(eM, { premiumType: t }, "emoji-stickers-item"),
                              (0, i.jsx)(ey, {}, "screen-share-item"),
                              (0, i.jsx)(eR, { premiumType: t }, "uploads-item"),
                              (0, i.jsx)(eU, { premiumType: t, onClose: r }, "boost-item"),
                          );
                    break;
                case ex.PremiumTypes.TIER_2:
                    n
                        ...
                        : e.push(
                              (0, i.jsx)(ev, { currentUser: s, onClose: r }, "badge-item"),
                              (0, i.jsx)(eg, { currentUser: s, premiumType: t, onClose: r }, "profile-item"),
                              (0, i.jsx)(eM, { premiumType: t }, "emoji-stickers-item"),
                              (0, i.jsx)(eU, { premiumType: t, onClose: r }, "boost-item"),
                              (0, i.jsx)(ey, {}, "screen-share-item"),
...
let eS = function (e) {
    ...
    p)
        ? (0, i.jsxs)(i.Fragment, {
              children: [
                  (0, i.jsx)(ed.A, { premiumType: s, onClose: n }),
                  (0, i.jsx)(d.c, {
                      children: (0, i.jsx)("div", {
                          className: ep.rf,
                          children: (0, i.jsx)(T.y, { className: ep.u1 }),
                      }),
                  }),
              ],
          })
                  ...
                  (0, i.jsx)(d.c, {
                      children: (0, i.jsxs)("div", {
                          ...
                          children: [
                              ...
                              (0, i.jsxs)("div", {
                                  className: C,
                                  children: [_, (0, i.jsx)(f.E, { variant: "text-md/normal", children: r })],
                              }),
                              (0, i.jsx)(eb, { currentUser: E, premiumType: s, onClose: n, isDowngrade: N }),
                          ],
                      }),
                  }),
                  !h && (0, i.jsx)(x.j, { children: l }),
                  h && (0, i.jsx)(eu, { churnUserDiscountOffer: A, onDiscountClaim: c, onContinue: m }),
              ],
          });
};
