                    ...
                    var r,
                        ...
                        x = {
                            ...
                            "%MapIteratorPrototype%":
                                "undefined" != typeof Map && T && C ? C(new Map()[Symbol.iterator]()) : r,
                            "%Math%": Math,
                            "%Number%": Number,
                            "%Object%": i,
                            ...
                            "%SetIteratorPrototype%":
                                "undefined" != typeof Set && T && C ? C(new Set()[Symbol.iterator]()) : r,
                    ...
                    e.exports = function e(t, r, i, s) {
                        ...
                        if (
                            ...
                            for (
                                ...
                                ea += " " + eo[es].name + "=" + Z(F(eo[es].value), "double", l);
                            return (
                                (ea += ">"),
                ...
                5882: (e, t, n) => {
                    var r = n(6738),
                        ...
                        m = function e(t, n, a, o, s, c, d, f, m, h, g, E, b, y, O, v, S, I) {
                            for (var T, C = t, A = I, N = 0, P = !1; void 0 !== (A = A.get(_)) && !P; ) {
                                var R = A.get(t);
                                if (((N += 1), void 0 !== R)) {
                            ...
                            if ("comma" === a && l(C))
                                v && m && (C = i.maybeMap(C, m)),
                                    (w = [{ value: C.length > 0 ? C.join(",") || null : void 0 }]);
                            else if (l(h)) w = h;
                            else {
                                var x = Object.keys(C);
                                w = g ? x.sort(g) : x;
            ...
            (() => {
                ...
                function O(e, t, n, r) {
                    ...
                    return (
                        ...
                        e.setAttribute("sandbox", b.concat(C).join(" ")),
                        (e.frameBorder = "0"),
                        (e.src = j + "/widget" + M),
                        (e.onload = function () {}),
                        e
