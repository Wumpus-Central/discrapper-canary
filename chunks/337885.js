...
function y(e) {
    let t,
        ...
        [w, D] = i.useState(!1),
        L = i.useMemo(() => S.find((e) => e.name === p.Dg), [S]),
        P = null == L || !M.has(L.id),
        ...
        U = ((t = y.trim().split("\n")[0] ?? ""), (0, g.A)(t.slice(0, v.Ign), !0)),
        z = (0, x.w0)({ parentChannel: n, name: U, appliedTags: M, upload: j.Se }),
            ...
            children: [
                    ...
                    ? (0, l.jsx)(a.D, {
                          ...
                          children: (0, l.jsx)("div", {
                              ...
                              children: S.map((e) =>
                                  (0, l.jsx)(
                                      h.A,
                                      { tag: e, size: h.A.Sizes.SMALL, selected: M.has(e.id), onClick: () => F(e.id) },
                                      e.id,
                                  ),
                              ),
                          }),
                ...
                (0, l.jsx)(a.D, {
                    ...
                    children: (0, l.jsx)(o.m, {
                        text: A.intl.formatToPlainString(A.t["0s2ICk"], { noMicTagName: p.Dg }),
                        shouldShow: null == L,
                        asContainer: !0,
