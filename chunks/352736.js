...
let v = {
    ...
    E = () => [g.t.Jm6e09, g.t.MGRnRU, g.t.EXOEGh, g.t['5uCTFB'], g.t.rl45Qk, g.t.Bh9zpa, g.t.RdEy1N, g.t.qcdp09, g.t.F7w2Rk, g.t.gSyOgI, g.t.uYgqv7, g.t['b/1SBQ'], g.t.LhebZG];
function y(e) {
    let t = E(),
...
let S = {
    stringify: function (e, t) {
        ...
        let I = (function (e) {
            ...
            E = e.channel_id,
            S = m.ZP.getName(null, E, e.author);
        switch (e.type) {
            case h.uaV.RECIPIENT_ADD:
                ...
                return (0, r.Rp)(
                    g.intl.formatToParts(g.t['7/Xl0d'], {
                        username: S,
                        usernameOnClick: h.dG4,
                        otherUsername: m.ZP.getName(null, E, I),
            ...
            case h.uaV.GUILD_INCIDENT_ALERT_MODE_ENABLED:
                var T = e.content;
                let w = _.Z.getChannel(E);
                if (null == w) return null;
                let L = f.Z.getGuild(w.getGuildId());
                return null == L
                    ? null
                    : (0, r.Rp)(
