...
let I = {
            ...
            s = (e) => {
                let t = async () => {
                    ...
                    s = (e) => {
                        ...
                        i === p.BM.MESSAGE ? (0, h.eE)(t) : i === p.BM.USER ? (0, h.JM)(t) : i === p.BM.GUILD && (0, h.FO)(t);
                    };
                t(),
                    (0, l.ZDy)(async () => {
    ...
    S = () => {
        let [e, t] = i.useState(!0),
            [n, o] = i.useState([]),
            p = (0, a.e7)([m.default], () => m.default.isAuthenticated()),
                ...
                : null != n &&
                  ...
                  (0, r.jsxs)(u.ZP, {
                      children: [
                          ...
                          (0, r.jsx)(u.DK, {
                              className: N.marginBottom8,
                              children: b.NW.format(b.t['532l+v'], { supportURL: f.Z.getArticleURL(_.BhN.COPYRIGHT_AND_IP_POLICY) })
                          }),
                          (0, r.jsx)('div', {
