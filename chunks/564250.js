        ...
        for (m = 0; m < _.length; ++m)
            if (m !== p) {
                ...
                -1 === I
                    ...
                    r.call(n, g) ? (n[g] = i.combine(n[g], E)) : (n[g] = E);
            }
        return n;
    },
    f = function (e, t, n, i) {
        for (var r = i ? t : l(t, n), a = e.length - 1; a >= 0; --a) {
            var s,
                o = e[a];
            if ('[]' === o && n.parseArrays) s = [].concat(r);
            else {
                s = n.plainObjects ? Object.create(null) : {};
                var u = '[' === o.charAt(0) && ']' === o.charAt(o.length - 1) ? o.slice(1, -1) : o,
                    c = parseInt(u, 10);
                n.parseArrays || '' !== u ? (!isNaN(c) && o !== u && String(c) === u && c >= 0 && n.parseArrays && c <= n.arrayLimit ? ((s = [])[c] = r) : '__proto__' !== u && (s[u] = r)) : (s = { 0: r });
            }
            r = s;
        }
        return r;
