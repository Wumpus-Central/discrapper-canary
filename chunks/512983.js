...
function h(e) {
    let t;
    var { tag: n = 'h5', children: i, className: l, faded: u, disabled: f, required: p = !1, error: h, errorId: m } = e,
        g = _(e, ['tag', 'children', 'className', 'faded', 'disabled', 'required', 'error', 'errorId']);
    switch (n) {
        case 'legend':
        case 'label':
            t = n;
