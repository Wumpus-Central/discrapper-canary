        ...
        a = n.map((e) =>
            (0, r.jsx)(
                o.j7V,
                {
                    ...
                    value: i[e.location],
                    note: e.description,
                    onChange: (t) => s(S(O({}, i), { [e.location]: t })),
                    children: e.title
                },
                e.location
            )
...
function V(e) {
    ...
    return (
        i.useEffect(() => (window.addEventListener('mousemove', _), () => window.removeEventListener('mousemove', _)), []),
        (0, r.jsxs)(r.Fragment, {
            children: [
                (0, r.jsx)(o.X6q, {
...
let G = (e, t, n) => {
        ...
        switch (e) {
            ...
            case 1:
                return (0, r.jsx)(_.Z, { onBackClick: i(0) });
            default:
                return null;
        }
    },
