...
function S(e) {
    ...
    let { renderHeader: n, referralTrialOfferId: o, handleClose: S } = e,
        { selectedSkuId: T, step: A, selectedPlan: N, purchaseState: C, purchaseType: P, selectedSku: R } = (0, g.JL)(),
        { isGift: w, selectedGiftStyle: D, giftRecipient: L } = (0, m.wD)(),
        x = w && (0, h.pO)(L) && A === E.h8.CONFIRM && null != D && (null == R ? void 0 : R.productLine) !== b.POd.COLLECTIBLES,
        k = null != n && null != A,
        M = [E.h8.SKU_SELECT, E.h8.SELECT_FREE_SKU],
        j = null != A && !M.includes(A) && null != T,
        U = (0, d.N)(o),
