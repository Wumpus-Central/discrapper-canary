...
let L = (0, i.trackMaker)({ addBreadcrumb: f, analyticEventConfigs: g, dispatcher: s.h, TRACK_ACTION_NAME: "TRACK" });
function U(e) {
    return (T = e);
}
function D(e) {
...
let K = (0, i.trackMaker)({ addBreadcrumb: f, analyticEventConfigs: g, dispatcher: s.h, TRACK_ACTION_NAME: "TRACK" });
function k(e) {
...
let Y = {
    ...
    track: function (e, t) {
        let n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {},
            o = String(e);
        if (
            (w && null != t && (Array.isArray(b[e]) ? b[e].push(t) : (b[e] = [t])),
