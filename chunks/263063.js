...
class y extends i.PureComponent {
    ...
    renderTooltip() {
        ...
        return t
            ? (0, r.jsx)(c.m, { text: e.name, position: n, "aria-label": !1, children: this.renderIcon() })
            : this.renderIcon();
    }
    render() {
...
let N = l.Ay.connectStores([E.A], (e) => {
    let { guild: t, animate: n, iconSrc: r, style: i, size: s, iconSize: a, lossless: o } = e;
    return (
        null == r &&
            (r =
                t instanceof f.GO
                    ? t.getIconURL(a ?? T[s], n && E.A.isFocused())
                    : (0, h.Iv)(t, a ?? T[s], n && E.A.isFocused(), o)),
