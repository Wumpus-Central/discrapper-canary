    ...
    dispatchOne(e) {
        ...
        if ((ep.flush(r, i), "READY" === r)) {
            ...
            this.getDispatchHandler(r)?.dispatch(i, r, a),
                ...
                v.default.track(eg.HAw.READY_PAYLOAD_RECEIVED, n, { logEventProperties: !0 });
        } else
            "RESUMED" === r
                ? (this.getDispatchHandler(r)?.dispatch(i, r, a),
...
class eQ extends ez.EventEmitter {
    presenceUpdate(e, t, n, i) {
        this.send(eX.p.PRESENCE_UPDATE, { status: e, since: t, activities: n, afk: i });
    }
    voiceStateUpdate(e) {
        let {
                guildId: t = null,
    ...
    requestGuildMembers(e, t) {
        ...
        this.send(eX.p.REQUEST_GUILD_MEMBERS, { guild_id: e, query: n, limit: i, user_ids: r, presences: s });
    }
    searchRecentMembers(e, t) {
        let { query: n, continuationToken: i } = t;
        this.send(eX.p.SEARCH_RECENT_MEMBERS, { guild_id: e, query: n ?? "", continuation_token: i ?? null });
    }
    updateGuildSubscriptions(e) {
        ...
        eq.default.keys(e).forEach((i) => {
            ...
            n + s > 15360 && (this.send(eX.p.GUILD_SUBSCRIPTIONS_BULK, { subscriptions: t }), (t = {}), (n = 0)),
                (t[i] = r),
                (n += s);
        }),
            n > 0 && this.send(eX.p.GUILD_SUBSCRIPTIONS_BULK, { subscriptions: t });
    }
    callConnect(e) {
    ...
    streamCreate(e, t, n) {
        ...
        this.send(eX.p.STREAM_CREATE, { type: e, guild_id: t, channel_id: n, preferred_region: i });
    }
    streamWatch(e) {
    ...
    requestLastMessages(e, t) {
        this.send(eX.p.REQUEST_LAST_MESSAGES, { guild_id: e, channel_ids: t });
    }
    ...
    triggerGuildChannelResync(e, t) {
        this.send(eX.p.GUILD_CHANNELS_RESYNC, { guild_id: e, obfuscated_channel_ids: t });
    }
    requestChannelInfo(e, t) {
        this.send(eX.p.REQUEST_CHANNEL_INFO, { guild_id: e, fields: t });
    }
    requestChannelMemberCount(e, t) {
        this.send(eX.p.REQUEST_CHANNEL_MEMBER_COUNT, { guild_id: e, channel_id: t });
    }
    remoteCommand(e, t) {
...
class e9 extends eQ {
            ...
            !(function (e) {
                ...
                onMessage:
                    ...
                    (n = (e, t) => {
                        ...
                        if (
                            (i !== eX.p.DISPATCH && U.A.mark(`🌐`, `GatewaySocket.onMessage ${i} ${eX.p[i]}`),
                            Q.default.isLoggingGatewayEvents)
                        ) {
                            let e = [i];
                            i === eX.p.DISPATCH && e.push(s), e.push(a), e1.verboseDangerously("<~", ...e);
                        }
                        let o = Date.now() - n;
                        switch (
                            ("READY" === s
    ...
    _tryDetectInvalidIOSToken(e, t, n) {
        (0, C.isIOS)() &&
            ...
            3 === this.iosGoingAwayEventCount &&
                V.Bo.get({ url: eg.Rsh.ME, headers: { authorization: this.token }, rejectWithError: !1 }).then(
                    (e) => {
                        let { status: t } = e;
                        v.default.track(eg.HAw.IOS_INVALID_TOKEN_WORKAROUND_TRIGGERED, { api_status_code: t });
                    },
                    (e) => {
                        let { status: t } = e;
                        401 === t &&
    ...
    _doResume() {
        (this.connectionState = y.RESUMING),
            ...
            this.send(eX.p.RESUME, { token: this.token, session_id: this.sessionId, seq: this.seq }, !1);
    }
    async _doIdentify() {
        ...
        let _ = {
                token: a,
                capabilities: (0, et.O)({ useChannelObfuscation: (0, eZ.RK)("GatewaySocket") }),
                properties: o,
                presence: l,
    ...
    _sendHeartbeat() {
        ...
        this.send(eX.p.QOS_HEARTBEAT, { seq: this.seq, qos: e }, !1), (this.lastHeartbeatTime = Date.now());
    }
    getLogger() {
        return e1;
    }
    ...
    send = (e, t, n) => {
        Q.default.isLoggingGatewayEvents && e1.verboseDangerously("~>", e, eX.p[e], t);
...
let td = new E.A("ConnectionStore"),
    ...
    tE = new (class extends tn {
        ...
        didCommit(e) {
            ...
            s && A.A.getChannel(n)?.type === eg.rbe.GUILD_STAGE_VOICE
...
let nh = new nE(u.h, {
        ...
        return (
            (0, C.isIOS)()
                ? (g.default.isAuthenticated() &&
                  ...
                  (na = e.state))
                : e.state === eg.g6G.ACTIVE &&
                  ((eJ = !1), g.default.isAuthenticated() && tu.resetBackoff("App state is active")),
            !1
        );
    },
    ...
    RESET_SOCKET: function (e) {
        tu.connectionState !== y.WILL_RECONNECT && tu.resetSocketAndClearCacheOnError(e.args);
    },
