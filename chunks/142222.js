    ...
    (e.default = class {
        ...
        start(t) {
            ...
            if (
                ...
                this.data.start &&
                    this.data.end &&
                    (0, h.toDate)(this.data.start).getTime() > (0, h.toDate)(this.data.end).getTime())
            ) {
        ...
        floating(t) {
            return void 0 === t
                ? this.data.floating
                : ((this.data.floating = !!t), this.data.floating && (this.data.timezone = null), this);
        }
        repeating(t) {
            ...
            if (
                (void 0 !== t.until && (this.data.repeating.until = (0, h.checkDate)(t.until, "repeating.until")),
                t.byDay)
            ) {
            ...
            if (t.byMonth) {
                ...
                this.data.repeating.byMonth = e.map((t) => {
                    if ("number" != typeof t || t < 1 || t > 12)
                        throw Error("`repeating.byMonth` contains invalid value `" + t + "`!");
                    return t;
                });
            }
            if (t.byMonthDay) {
                ...
                this.data.repeating.byMonthDay = e.map((t) => {
                    if ("number" != typeof t || t < 1 || t > 31)
                        throw Error("`repeating.byMonthDay` contains invalid value `" + t + "`!");
                    return t;
                });
            }
            if (t.bySetPos) {
                if (!this.data.repeating.byDay) throw "`repeating.bySetPos` must be used along with `repeating.byDay`!";
                if ("number" != typeof t.bySetPos || t.bySetPos < -1 || t.bySetPos > 4)
                    throw "`repeating.bySetPos` contains invalid value `" + t.bySetPos + "`!";
            ...
            return (
                t.startOfWeek && (this.data.repeating.startOfWeek = (0, h.checkEnum)(m.ICalWeekday, t.startOfWeek)),
                this
            );
        }
        summary(t) {
        ...
        organizer(t) {
            return void 0 === t
                ...
                : (null === t
                      ...
                      : (this.data.organizer = (0, h.checkNameAndMail)("organizer", t)),
                  this);
        }
        createAttendee(t = {}) {
        ...
        status(t) {
            return void 0 === t
                ? this.data.status
                : (null === t ? (this.data.status = null) : (this.data.status = (0, h.checkEnum)(s, t)), this);
        }
        busystatus(t) {
            return void 0 === t
                ? this.data.busystatus
                : (null === t ? (this.data.busystatus = null) : (this.data.busystatus = (0, h.checkEnum)(o, t)), this);
        }
        priority(t) {
        ...
        transparency(t) {
            return void 0 === t
                ...
                : (t ? (this.data.transparency = (0, h.checkEnum)(d, t)) : (this.data.transparency = null), this);
        }
        created(t) {
            return void 0 === t
                ? this.data.created
                : (null === t ? (this.data.created = null) : (this.data.created = (0, h.checkDate)(t, "created")),
                  this);
        }
        lastModified(t) {
            return void 0 === t
        ...
        x(t, e) {
            return void 0 === t
                ...
                : ("string" == typeof t && "string" == typeof e && (0, h.addOrGetCustomAttributes)(this.data, t, e),
                  "object" == typeof t && (0, h.addOrGetCustomAttributes)(this.data, t),
                  this);
        }
        toJSON() {
            var t;
        ...
        toString() {
            ...
            return (
                ...
                this.data.allDay
                    ? ((n +=
                          "DTSTART;VALUE=DATE:" +
                          (0, h.formatDate)(this.calendar.timezone(), this.data.start, !0) +
                          "\r\n"),
                      this.data.end &&
                          (n +=
                              "DTEND;VALUE=DATE:" +
                              (0, h.formatDate)(this.calendar.timezone(), this.data.end, !0) +
                              "\r\n"),
                    ...
                    : ((n += (0, h.formatDateTZ)(this.timezone(), "DTSTART", this.data.start, this.data) + "\r\n"),
                      this.data.end &&
                          (n += (0, h.formatDateTZ)(this.timezone(), "DTEND", this.data.end, this.data) + "\r\n")),
                (0, h.isRRule)(this.data.repeating) || "string" == typeof this.data.repeating
                    ? (n +=
                          this.data.repeating
                              .toString()
                    ...
                    : this.data.repeating &&
                      ...
                      this.data.repeating.count && (n += ";COUNT=" + this.data.repeating.count),
                      this.data.repeating.interval && (n += ";INTERVAL=" + this.data.repeating.interval),
                      this.data.repeating.until &&
                          (n += ";UNTIL=" + (0, h.formatDate)(this.calendar.timezone(), this.data.repeating.until)),
                      this.data.repeating.byDay && (n += ";BYDAY=" + this.data.repeating.byDay.join(",")),
                      this.data.repeating.byMonth && (n += ";BYMONTH=" + this.data.repeating.byMonth.join(",")),
                      this.data.repeating.byMonthDay &&
                          (n += ";BYMONTHDAY=" + this.data.repeating.byMonthDay.join(",")),
                      this.data.repeating.bySetPos && (n += ";BYSETPOS=" + this.data.repeating.bySetPos),
                      this.data.repeating.startOfWeek && (n += ";WKST=" + this.data.repeating.startOfWeek),
                      (n += "\r\n"),
                      this.data.repeating.exclude &&
                          (this.data.allDay
                              ? (n +=
                                    "EXDATE;VALUE=DATE:" +
                                    this.data.repeating.exclude
                                        .map((t) => (0, h.formatDate)(this.calendar.timezone(), t, !0))
                                        .join(",") +
                                    "\r\n")
                              : ((n += "EXDATE"),
                                this.timezone()
                                    ? (n +=
                                          ...
                                          ":" +
                                          this.data.repeating.exclude
                                              .map((t) => (0, h.formatDate)(this.timezone(), t, !1, !0))
                                              .join(",") +
                                          "\r\n")
                                    : (n +=
                                          ":" +
                ...
                this.data.recurrenceId &&
                    (n +=
                        (0, h.formatDateTZ)(this.timezone(), "RECURRENCE-ID", this.data.recurrenceId, this.data) +
                        "\r\n"),
                (n += "SUMMARY:" + (0, h.escape)(this.data.summary) + "\r\n"),
                this.data.transparency && (n += "TRANSP:" + (0, h.escape)(this.data.transparency) + "\r\n"),
                (null == (t = this.data.location) ? void 0 : t.title) &&
                    ((n +=
                        "LOCATION:" +
                        (0, h.escape)(
                    ...
                    this.data.location.radius &&
                        ...
                        (n +=
                            ...
                            (this.data.location.address
                                ? "X-ADDRESS=" + (0, h.escape)(this.data.location.address) + ";"
                                : "") +
                            "X-APPLE-RADIUS=" +
                            ...
                            ":geo:" +
                            (0, h.escape)(null == (e = this.data.location.geo) ? void 0 : e.lat) +
                            "," +
                    ...
                    this.data.location.geo &&
                        (n +=
                            "GEO:" +
                            (0, h.escape)(null == (i = this.data.location.geo) ? void 0 : i.lat) +
                            ";" +
                            (0, h.escape)(null == (r = this.data.location.geo) ? void 0 : r.lon) +
                            "\r\n")),
                this.data.description &&
                    ((n += "DESCRIPTION:" + (0, h.escape)(this.data.description.plain) + "\r\n"),
                    this.data.description.html &&
                        (n += "X-ALT-DESC;FMTTYPE=text/html:" + (0, h.escape)(this.data.description.html) + "\r\n")),
                this.data.organizer &&
                    ((n += 'ORGANIZER;CN="' + (0, h.escape)(this.data.organizer.name) + '"'),
                    this.data.organizer.email &&
                        this.data.organizer.mailto &&
                        (n += ";EMAIL=" + (0, h.escape)(this.data.organizer.email)),
                    this.data.organizer.email &&
                        (n += ":mailto:" + (0, h.escape)(this.data.organizer.mailto || this.data.organizer.email)),
                    (n += "\r\n")),
                ...
                this.data.busystatus &&
                    (n += "X-MICROSOFT-CDO-BUSYSTATUS:" + this.data.busystatus.toUpperCase() + "\r\n"),
                null !== this.data.priority && (n += "PRIORITY:" + this.data.priority + "\r\n"),
                (n += (0, h.generateCustomAttributes)(this.data)),
                this.data.created &&
                    (n += "CREATED:" + (0, h.formatDate)(this.calendar.timezone(), this.data.created) + "\r\n"),
                this.data.lastModified &&
                    (n +=
                        "LAST-MODIFIED:" +
                        (0, h.formatDate)(this.calendar.timezone(), this.data.lastModified) +
                        "\r\n"),
                (n += "END:VEVENT\r\n")
            );
        }
