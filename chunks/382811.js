...
(a[254] = a[254] = 1),
    (t.string2buf = function (e) {
        var t,
            ...
            l = 0;
        for (s = 0; s < o; s++)
            (64512 & (n = e.charCodeAt(s))) == 55296 &&
                s + 1 < o &&
                (64512 & (r = e.charCodeAt(s + 1))) == 56320 &&
                ((n = 65536 + ((n - 55296) << 10) + (r - 56320)), s++),
                (l += n < 128 ? 1 : n < 2048 ? 2 : n < 65536 ? 3 : 4);
        for (a = 0, t = new i.Buf8(l), s = 0; a < l; s++)
            (64512 & (n = e.charCodeAt(s))) == 55296 &&
                s + 1 < o &&
                (64512 & (r = e.charCodeAt(s + 1))) == 56320 &&
                ((n = 65536 + ((n - 55296) << 10) + (r - 56320)), s++),
    ...
    (t.buf2string = function (e, t) {
        ...
        for (i = 0, n = 0; n < o; ) {
            ...
            for (r &= 2 === s ? 31 : 3 === s ? 15 : 7; s > 1 && n < o; ) (r = (r << 6) | (63 & e[n++])), s--;
            if (s > 1) {
                u[i++] = 65533;
                continue;
            }
            r < 65536
                ? (u[i++] = r)
                : ((r -= 65536), (u[i++] = 55296 | ((r >> 10) & 1023)), (u[i++] = 56320 | (1023 & r)));
        }
        return l(u, i);
    }),
