...
function v(e) {
    if ("undefined" == typeof window || d.get((0, o.kR)(e))) return;
    let t = (0, o.kR)(e),
        n = (0, o.r3)(e),
    ...
    (t.HTMLElement.prototype.focus = function () {
        ...
        "undefined" != typeof PointerEvent
            ...
            : (n.addEventListener("mousedown", E, !0),
              n.addEventListener("mousemove", E, !0),
              n.addEventListener("mouseup", E, !0)),
        t.addEventListener(
            "beforeunload",
            () => {
                I(e);
        ...
        d.has(n) &&
            ...
            "undefined" != typeof PointerEvent
                ...
                : (r.removeEventListener("mousedown", E, !0),
                  r.removeEventListener("mousemove", E, !0),
                  r.removeEventListener("mouseup", E, !0)),
            d.delete(n));
};
function T(e) {
    let t,
