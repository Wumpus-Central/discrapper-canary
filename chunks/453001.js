...
class u extends r.Ay.Store {
    ...
    getBasicChannel(e) {
        ...
        return (
            c &&
                l.verbose("getting basic_channel (channel: ".concat(e, ", exists: ").concat(this.channels.has(e), ")")),
            null != (t = this.channels.get(e)) ? t : null
        );
    }
    getGuildBasicChannels(e) {
        ...
        return (
            c &&
                l.verbose(
                    "getting guild_basic_channels (guild: ".concat(e, ", exists: ").concat(this.guilds.has(e), ")"),
                ),
            null != (t = this.guilds.get(e)) ? t : null
        );
    }
    invalidate(e) {
        this.delete(e);
    ...
    delete(e) {
        var t;
        for (let n in (c &&
            l.verbose("deleting basic_channels (guild: ".concat(e, ", exists: ").concat(this.guilds.has(e), ")")),
        null != (t = this.guilds.get(e)) ? t : {}))
