...
function A(e) {
    let { subsection: t } = e;
    if (a.A.getGuildId() === p) return !1;
    (N = t === E.nd0.SERVER_GUIDE ? x.Hy.HOME_SETTINGS : x.Hy.LANDING), (p = a.A.getGuildId());
}
