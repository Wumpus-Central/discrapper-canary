...
`,
    ...
    c = s.forwardRef(function (e, t) {
        let { style: n, autoFocus: i = !1, disabled: a = !1, autoCorrect: l = "off", ...u } = e,
            c = s.useRef(null),
            [_, h] = s.useState(() => d(c.current, u.rows, u.value));
        return (
            s.useLayoutEffect(() => {
                h(d(c.current, u.rows, u.value));
            }, [u.rows, u.value]),
            (0, r.jsx)(o.vN, {
...
function d(e, t, n) {
    ...
    let {
        ...
        { minHeight: S, maxHeight: N } =
            ...
            (i.value = ""),
            (m = i.scrollHeight),
            "border-box" === d ? ((p += c), (m += c)) : "content-box" === d && ((p -= o), (m -= o)),
            { minHeight: p, maxHeight: m });
    i.setAttribute("style", T + ";" + l),
        (i.value = n),
        null != t ? i.setAttribute("rows", `${t}`) : i.removeAttribute("rows");
    let C = Math.ceil(i.scrollHeight + 1);
    return "border-box" === I ? (C += A) : "content-box" === I && (C -= g), (C = Math.max(S, Math.min(C, N)));
}
