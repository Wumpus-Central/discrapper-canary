n.d(t, { iV: () => oQ, OC: () => o1, Ay: () => o0 }), n(938796);
var i,
    l,
    s = n(627968),
    r = n(64700),
...
function ei(e) {
    let { app: t, linkType: n, activityCustomId: i, activityReferrerId: l, message: a, onView: o } = e,
        ...
        { staticBannerSrc: p, videoBannerSrc: A, bannerAspectRatio: C } = (0, Q.f)(t),
...
function e$(e) {
    ...
    let A = () => {
        (0, e_.openModalLazy)(async () => {
            let { default: e } = await Promise.all([n.e("28881"), n.e("68031"), n.e("85384"), n.e("20428")]).then(
                n.bind(n, 719847),
            );
            return (n) =>
...
class to extends u.Ay.Store {
    ...
    initialize() {
        this.waitFor(P.default, w.A, ti.A, U.default), (tr = new Set(tt.w.get(ts)));
    }
    shouldShowBump(e) {
        return ta.has(e);
    }
...
function nh(e) {
    let { message: t, snapshot: n, index: i } = e,
        ...
        a = (0, u.bG)(
            [w.A, U.default, D.A, ti.A, tB.A, t6.A],
            () => l.getForwardInfo(w.A, U.default, D.A, ti.A, tB.A, t6.A).footerInfo,
            [l],
            h.A,
        ),
...
function io(e) {
    let { embedUrl: t, message: n, channel: i } = e,
        ...
        v = (0, nQ.A)(I?.avatarDecoration != null ? I?.avatarDecoration : d?.user?.avatarDecoration),
    ...
    let { message: t, snapshot: n, index: i } = e,
        ...
        o = r.useCallback(() => {
            let e = w.A.getChannel(t.channel_id),
                ...
                s = iQ.Ay.getCurrentSidebarChannelId(t.messageReference?.channel_id),
                r = l === i && s === e?.id;
            null == e ||
                null == n ||
                r ||
                null == i ||
                (i$.A.openModReportAsSidebar({ channelId: e.id, baseChannelId: i, guildId: e.guild_id }),
                (0, iX.iN)(i),
            ...
            r.useEffect(() => {
                ...
                (async () => {
                    if (null == e || e.features.has(K.GuildFeatures.DISCOVERABLE)) {
                        ...
                        c(
                            await ((e = n.id),
                            lQ.Bo.get({ url: K.Rsh.STICKER_GUILD_DATA(e), oldFormErrors: !0, rejectWithError: !0 })
                    ...
                    (null != x || null != d) &&
                        (() => {
                            ...
                            let e = (d?.stickers ?? [])
                                    ...
                                    .filter((e) => e.id !== n.id)
                                    .slice(0, 12),
                                t = null != d ? l$.GO.createFromDiscoverableGuild(d) : l$.GO.createFromGuildRecord(x);
                            return (0, s.jsxs)("div", {
                                className: se.tl,
                                children: [
                                    (0, s.jsx)(p.E, {
    ...
    renderTypeImage() {
        ...
        return null == t
            ...
            : (0, s.jsx)(r1.A, {
                  ...
                  className: r3.mZ,
                  disable: !e,
                  children: (0, s.jsx)(r$.F, { children: this.renderSlideItem(t) }),
              });
    }
    render() {
                ...
                children: [
                    (0, s.jsxs)("div", {
                        ...
                        children: [
                            (0, s.jsx)(r0.H, {
                                className: on.p,
                                color: d.length > 0 ? tM.A.colors.TEXT_FEEDBACK_POSITIVE : tM.A.colors.ICON_SUBTLE,
                                size: "custom",
                                width: 20,
                                height: 20,
                            }),
    ...
    return (0, s.jsxs)("div", {
        ...
        children: [
            ...
            (0, s.jsxs)("div", {
                className: oj.qr,
                children: [
                    (0, s.jsx)(os.G, { size: "custom", color: "currentColor", className: oj.Dq }),
                    (0, s.jsx)(p.E, {
                        variant: "text-sm/medium",
                        color: "currentColor",
                        lineClamp: 1,
    ...
    let { channel: n, message: i, hideParty: l } = e,
        ...
        a =
            null != i.application
                ...
                : null != i.activity && null != i.activity.party_id && (0, oD.pH)(i.activity.party_id)
                  ? ow.HT
                  : void 0,
    ...
    renderCodedLinks(e) {
        return 0 === e.codedLinks.length
            ...
            : e.codedLinks.map((t) => {
                  ...
                  else if (n === tR.I.APP_DIRECTORY_STOREFRONT) return (0, s.jsx)(e$, { appId: i, message: e }, i);
                  else if (n === tR.I.APP_DIRECTORY_STOREFRONT_SKU) {
                      let t = (0, eC.u)(i);
                      return null == t
                          ? null
                          : (0, s.jsx)(eQ, { appId: t.applicationId, skuId: t.skuId, message: e }, i);
