...
function eQ(e) {
    ...
    let A = () => {
        (0, e_.openModalLazy)(async () => {
            let { default: e } = await Promise.all([n.e("30272"), n.e("68031"), n.e("85384"), n.e("20428")]).then(
                n.bind(n, 719847),
            );
            return (n) =>
...
let i8 = (e) => {
    let { reportingUserId: t, guildId: n, compact: i, channel: l, messageId: a, reportedTimestamp: d } = e,
        ...
        g =
            null != c
                ? J.intl.format(i5.default["+zqXZs"], { username: c.username, onUserClick: m })
                : J.intl.string(i5.default.xpRjfS);
    return (0, s.jsxs)("div", {
                                      ...
                                      onClick: () => {
                                          d &&
                                              (function (e) {
                                                  ...
                                                  l6._.dispatchToLastSubscribed(K.jej.OPEN_EXPRESSION_PICKER, {
                      ...
                      (n = (0, s.jsx)(ep.$, {
                          onClick: function () {
                              let { id: e } = l,
                                  ...
                                  n = `<@${e}>`;
                              l6._.dispatchToLastSubscribed(K.jej.INSERT_TEXT, { plainText: t, rawText: n }),
