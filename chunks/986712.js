                              ...
                              a && r === u
                                  ? (0, i.jsx)("div", {
                                        ...
                                        children: (0, i.jsx)(v.E, {
                                            ...
                                            lineClamp: 1,
                                            children: (0, i.jsx)(N.A, { children: o > 99 ? ">99" : `+${o}` }),
                                        }),
                                    })
                                  : (0, i.jsx)(l.m, {
                                        ...
                                        children: (0, i.jsx)("img", {
                                            className: b.my,
                                            src: s.getAvatarURL(n.guild_id, (0, C.FT)(C._3.SIZE_80)),
                                            alt: "",
                                        }),
                                    }),
                      },
...
var K = n(70963),
    ...
    z = n(514566);
function q(e) {
    let { user: t, currentUser: n, voiceChannel: s, className: y, onClose: N } = e,
        { themeType: v } = (0, A.E)(),
        { analyticsLocations: C } = (0, h.Ay)(_.A.USER_PROFILE_VOICE_ACTIVITY_CARD),
        R = (0, m.A)({
            display: "voice",
            activity: { type: "VOICE" },
            voiceChannelId: s.id,
        ...
        P = r.useId(),
        x = () =>
            (0, i.jsx)("div", { className: z.o1, children: (0, i.jsx)(K.Ay, { channel: s, onAction: R, onClose: N }) }),
        k =
            s.isDM() || s.isGroupDM()
        ...
        children: (0, i.jsxs)(I.A, {
            ...
            children: [
                (0, i.jsx)(T.A, {
                    ...
                    contextMenu: (0, i.jsx)($.A, { display: "voice", user: t, onClose: N }),
                }),
                    ...
                    children: (0, i.jsxs)("div", {
                        ...
                        children: [
                            ...
                            (0, i.jsxs)("div", {
                                className: z.zH,
                                children: [
                                    (0, i.jsx)(S.A, { channel: s, guild: D, onAction: R, onClose: N }),
                                    s.isGuildVoice() && (0, i.jsx)(W, { voiceChannel: s, onAction: R, onClose: N }),
                                    v === O.d.MODAL_V2 && x(),
                                ],
                            }),
                            v === O.d.MODAL && x(),
