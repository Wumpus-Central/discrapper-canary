...
function y(e) {
    ...
    if (d) return T.intl.string(S.default["7r4HPu"]);
    if (t === I.VV.ONE_TIME) return a ? T.intl.string(T.t.ouo4FK) : T.intl.string(T.t.ExD0Ng);
    if ((s()(null != n, "Subscription plan must be selected to render PaymentModalReviewButton"), r === A.EZt.BOOST))
...
let N = (e) => {
        let { premiumSubscription: t, isGift: n, planGroup: i, isPrepaid: r } = e,
            { checkoutPaymentSources: s } = (0, _.t)(),
            {
                hasAcceptedTerms: o,
                paymentSourceId: c,
                purchaseType: m,
            ...
            { hasPaymentSources: A } = (0, f.jm)(),
            { application: I } = (0, h.V)(),
            T = (0, a.bG)([l.A], () => l.A.getFetchState()),
            S = (0, p.A)(),
            C =
                (0, d.vg)("PaymentModalReviewButton") &&
                null != c &&
                s.some((e) => e.id === c && null != e.relocationCountry),
            N = y({
                purchaseType: m,
                plan: S,
    ...
    v = (e, t) => {
        let {
            ...
            { buttonLabel: E, hasAcceptedTerms: m, application: g, devShelfFetchState: I, hasPaymentSources: S } = t;
        ...
        if ((0, c.n)(g, A.gfo.EMBEDDED) && I === l.$.LOADING)
            return {
