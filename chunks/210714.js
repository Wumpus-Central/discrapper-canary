...
class l {
    ...
    trackEvent(e) {
        ...
        requestIdleCallback(() => {
            let s, r;
            i.default.track(c.HAw.APP_UI_VIEWED, {
                ...(function () {
                    let e = "--campaign-id=";
                ...
                load_id: this.loadId,
                screen_name: e,
                duration_ms_since_app_opened: t - o(),
                app_hardware_acceleration_enabled: _.Ay.getEnableHardwareAcceleration(),
            });
        });
    }
    trackTTI() {
        ...
        requestIdleCallback(() => {
            ...
            let s = d.A.serializeWebPerfStartupMetrics(e);
            i.default.track(c.HAw.APP_WEB_PERF_STARTUP_METRICS, { load_id: this.loadId, url_root_path: t, ...s });
            try {
                _.Ay.appFirstRenderAfterReadyPayload();
            } catch (e) {}
            (0, n.K)();
        });
    }
