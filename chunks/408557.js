...
function _(e) {
    let t,
        s,
        _,
        { className: f, activeCommand: p, activeOption: h, optionStates: E, channelId: m } = e,
        g = i.useCallback(
            (e) => {
        ...
        A = i.useCallback(() => {
            u.Gf({ channelId: m, command: null, section: null });
        }, [m]);
    ...
    return (0, r.jsxs)("div", {
        ...
        children: [
            ...
            (0, r.jsx)("div", {
                className: d.o1,
                children: (0, r.jsx)(l.x, { onClick: A, "aria-label": c.intl.string(c.t.cpT0Cq) }),
            }),
        ],
    });
}
