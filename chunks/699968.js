...
function eu(e) {
    let { sku: l, orbsGate: t, orbPrice: r, analyticsLocations: a, onCheckout: i, variant: o = "secondary" } = e,
        c = s.useRef(null),
        [m, x] = (0, en.kn)("NEEDS_NITRO" === t ? [ee.M.SLAYER_STOREFRONT_ORBS_PURCHASE_COACHMARK] : []),
        h = m === ee.M.SLAYER_STOREFRONT_ORBS_PURCHASE_COACHMARK,
        {
            isOpen: b,
            onMouseEnter: p,
            onMouseLeave: g,
        ...
        v = s.useMemo(
            () =>
                "NEEDS_NITRO" === t
                    ? {
                          title: F.intl.string(eo.default["1OBZN2"]),
                          body: F.intl.string(eo.default.FDywIe),
                          ctaText: F.intl.string(eo.default["Mt/ukE"]),
                          ctaIcon: et.t,
                          ctaVariant: "expressive",
                          onCtaClick: () => {
                              h && x(ea.i.TAKE_ACTION),
                                  C(),
                                  (0, es.A)({
                    ...
                    : "NOT_ENOUGH_ORBS" === t
                      ? {
                            title: F.intl.string(eo.default.Xo6oAV),
                            body: F.intl.string(eo.default.fkdIdV),
                            ctaText: F.intl.string(eo.default.d525FQ),
                            ctaIcon: u.C,
                            ctaVariant: "primary",
                            onCtaClick: () => {
                                C(), (0, er.navigateToQuestHome)({ fromContent: Z.u.ORBS_BALANCE_MENU });
                            },
                        }
                      : null,
            [t, h, x, C, a, l.applicationId],
        ),
        f = null != v && b,
        _ = s.useCallback(() => {
            h && x(ea.i.USER_DISMISS), C();
        }, [h, x, C]);
...
var ed = t(310784),
    ...
    eg = t(34337),
    ej = t(172079);
let eC = (e) => (0, eg.$o)({ ...e, className: ej.tN, mediaPlayerClassName: ej.yf }),
    ev = (e) => (0, n.jsx)(ep.Ay, { ...e });
function ef(e) {
    let { item: l, isMuted: t, className: r, alt: a = "" } = e,
        ...
        c = (0, i.bG)([ex.Ay], () => ex.Ay.useReducedMotion),
        [u, d] = s.useState(null),
        [m, x] = s.useState(l);
...
function ey(e) {
    ...
    return (0, n.jsxs)("div", {
        className: ek.sj,
        children: [
            (0, n.jsx)(Q.V, { textColor: "text-subtle" }),
            (0, n.jsx)("div", {
                className: a()(ek.hO, c && ek.XE),
                children:
                    c && "CAN_CHECKOUT" === t
                        ? (0, n.jsxs)(n.Fragment, {
                              children: [
                                  (0, n.jsx)(eS, { amount: l.amount }),
                                  (0, n.jsx)(eR, { normalPrice: r, discountedPrice: i, discountPercent: o }),
                              ],
                          })
                        : (0, n.jsxs)(n.Fragment, {
                              children: [
                                  (0, n.jsx)(eR, { normalPrice: r, discountedPrice: i, discountPercent: o }),
                                  c && (0, n.jsx)(eS, { amount: l.amount }),
                              ],
                          }),
            }),
        ],
...
function eO(e) {
    let {
        ...
        g = l.id,
        j = (0, i.bG)([Y.A], () => Y.A.getNormalizedSKUEligibility(g), [g]),
        C = j && "CAN_CHECKOUT" === b,
        ...
        E = (0, N.h)(l.applicationId),
        I = s.useMemo(() => [...u, A.A.SLAYER_STOREFRONT_PRODUCT_DETAILS_MODAL_PURCHASE_BUTTON], [u]),
        k = s.useCallback(() => {
            null != E &&
                ...
                (0, R.B4)({
                    ...
                    applicationId: l.applicationId,
                    onComplete: () => {
                        (0, $.j)(), (0, V.n)({ sku: l, application: E, analyticsLocations: I });
                    },
...
function eP(e) {
    ...
    return (0, n.jsxs)("div", {
        ...
        children: [
            ...
            (0, n.jsx)(eL, { applicationId: r, selectedCarouselItem: l }),
...
function eM(e) {
    ...
    let t,
        ...
        { analyticsLocations: Q } = (0, I.Ay)($ ?? []),
        { guildId: Z } = (0, M.nG)(N),
        ee = (0, i.bG)([O.default], () => O.default.getId());
    s.useEffect(() => {
        null != A && (0, U.iR)(N, A);
    }, [N, A]);
    let el = (0, H.A)({ applicationId: N }),
        et = (0, i.bG)([Y.A], () => Y.A.getSkuAssets()),
        en = (0, i.bG)([L.A], () => L.A.isFetchingForSKU(A)),
        es = (0, h.M)((0, E.Ay)()),
        [er, ea] = s.useState(!0),
        ei = (0, S.A)({ skuId: A }),
        eo = (0, T.JL)({ sku: ei }),
        ec = (0, G.o)({ orbPriceAmount: eo?.amount, location: "product_details_modal" }),
        eu = (0, T.CD)({ sku: ei }),
        [ed, em] = s.useState(0),
        [ex, eh] = s.useMemo(
            () =>
                (function (e, l, t, n) {
                    ...
                    return [r, a];
                })(ei?.tenantMetadata?.socialLayer?.carouselItems ?? [], N, et, { heroWidth: 747 }),
            [ei, N, et],
        ),
        [eb, ep] = s.useState(null),
        [eg, ej] = s.useState(!1);
    s.useEffect(() => {
        if (null == eb) return;
        let e = new ResizeObserver(() => {
            ej(eb.scrollHeight > eb.clientHeight);
        });
        return e.observe(eb), () => e.disconnect();
    }, [eb]);
    let eC = ed < eh.length ? ed : 0,
        ev = ex[eC] ?? null,
        eS = eh.length > 1,
        eR = eh.some((e) => "video" === e.type);
    (0, y.pE)(),
        (0, _.Ay)(() => {
            D.default.track(eN.HAw.OPEN_MODAL, { location_stack: Q, type: eI.Nh, sku_id: A, application_id: N }),
                (0, U.Xw)();
        });
    let eL = s.useCallback(
        ...
        eM = s.useCallback(
            (e) => {
                em(e), eL(eA.Jq.CAROUSEL_ITEM);
            },
            [eL],
        );
    s.useEffect(() => {
        null == A || L.A.isFetchingForSKU(A) || (0, U.Pp)(N, A);
    }, [N, A]);
    let eU = s.useCallback(() => {
            null != ei &&
                (eL(eA.Jq.FORWARD_BUTTON),
                (0, z.d)({
                    sku: ei,
                    guildId: Z,
        ...
        eY = s.useCallback(() => {
            eL(eA.Jq.WISHLIST_BUTTON);
        }, [eL]),
        eH = s.useCallback(() => {
            (0, q.G)({ applicationId: N });
        }, [N]),
        ew = s.useCallback(() => {
            eL(eA.Jq.VISIT_SHOP), (0, b.closeAllModals)(), null != d ? d() : (0, q.default)({ applicationId: N });
        }, [N, eL, d]),
        eB = s.useCallback(() => {
            ea(!er), eL(eA.Jq.MUTE_BUTTON);
        }, [er, eL]),
        eF =
            ((l = ei),
            (o =
            ...
            null != l && null != l.orbsReward && l.orbsReward > 0
                ...
                : null),
        eG = ei?.tenantMetadata?.socialLayer;
    if (null == ei || null == eG) return en ? (0, n.jsx)(p.y, {}) : null;
    let eq = el?.storefront,
        ez = eq?.logoAssetId != null ? (0, P.YE)(eq.applicationId, eq.logoAssetId, 256) : null,
        eV = eq?.lightThemeLogoAssetId != null ? (0, P.YE)(eq.applicationId, eq.lightThemeLogoAssetId, 256) : null,
        e$ = null;
    return (
        (e$ = es ? (ez ?? eV) : (eV ?? ez)),
        (0, n.jsx)(g.EO, {
            ...
            children: (0, n.jsx)(g.$m, {
                ...
                children: (0, n.jsxs)("div", {
                    ...
                    children: [
                        (0, n.jsxs)("div", {
                            className: a()(ek.op, { [ek.uk]: ei.exclusive }),
                            children: [
                                (0, n.jsx)("div", {
                                    className: ek.r$,
                                    children:
                                        null != e$
                                            ? (0, n.jsx)("img", { className: ek.wm, src: e$, alt: eq?.title ?? "" })
                                            : null,
                                }),
                                (0, n.jsxs)("div", {
                                    ref: ep,
                                    ...
                                    children: [
                                        ei.exclusive &&
                                            (0, n.jsx)("div", { className: ek.K3, children: (0, n.jsx)(X.I, {}) }),
                                        eS
                                            ? (0, n.jsxs)(n.Fragment, {
                                                  children: [
                                                      (0, n.jsx)(eT, { sku: ei }),
                                ...
                                (0, n.jsxs)("div", {
                                    className: a()(ek.Td, { [ek.t7]: eg }),
                                    children: [
                                        (0, n.jsx)(ey, { orbPrice: eo, orbsGate: ec, formattedPrice: eu }),
                                        null != eF &&
                                            (0, n.jsx)(e_.O, {
                                                Icon: eF.Icon,
                                        ...
                                        (0, n.jsx)(eO, {
                                            sku: ei,
                                            guildId: Z,
                                            giftRecipient: w?.id !== ee ? w : void 0,
                                            giftingOrigin: w?.id !== ee ? V : void 0,
                                            trackPDPClick: eL,
                                            analyticsLocations: Q,
                                            orbPrice: eo,
                                            orbsGate: ec,
                        ...
                        (0, n.jsxs)("div", {
                            className: ek.il,
                            children: [
                                (0, n.jsx)(ef, { item: eh[eC], isMuted: er, alt: ev?.label ?? ei.name }),
                                !R &&
                                    (0, n.jsxs)(eD, {
                                        onClick: ew,
                                        onMouseDown: eH,
                                        ...
                                        className: ek.gW,
                                        children: [
                                            (0, n.jsx)(j.U, { size: "refresh_sm", color: "currentColor" }),
                                            (0, n.jsx)(c.E, {
                                ...
                                (0, n.jsxs)("div", {
                                    ...
                                    children: [
                                        ...
                                        eR &&
                                            (0, n.jsx)(eD, {
                                                onClick: eB,
                                                ariaLabel: er ? F.intl.string(F.t.YqAjXy) : F.intl.string(F.t.w4m945),
                                                children: er
                                                    ? (0, n.jsx)(C._, { size: "refresh_sm", color: "currentColor" })
