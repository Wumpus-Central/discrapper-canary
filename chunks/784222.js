...
let G = [D.Z5.DISALLOW_EXTERNAL, D.Z5.DISALLOW_CUSTOM],
    B = (e) => {
        let {
            ...
            V = r.useMemo(() => (B ? _.ZP.getCategories() : Z), [Z, B]),
        ...
        let { topEmojis: Q, newlyAddedEmojis: J } = (0, P.Z)(H, l),
            ...
            { canCreateExpressions: et } = (0, m.XJ)(F),
            ...
            { enabled: el, treatment: ec } = C.Z.useExperiment(
            ...
            if (null != Y && null != h) {
                let f = Math.floor(h / (M + 2 * L)),
                    ...
                    g = (o, _) => {
                        ...
                        let G = el && D && !h,
                            B = Math.ceil((D || L ? b.length + 1 : b.length) / f),
                            Z = [];
                        for (let e = 0; e < B; e++) {
                            let t = 0 === e,
                                n = e * f - (G && e > 0 ? 1 : 0),
                                ...
                                i = b.slice(n, r).map((e, n) => {
                                    ...
                                    return {
                                        ...
                                        category: _.type,
                                        subCategory:
                                            _.sectionId === w.En.TOP_GUILD_EMOJI
                                                ? (0, N.IP)(
                                                      Q,
                                                      J,
                    ...
                    for (let e of V)
                        if (e === w.UX.CUSTOM) {
                            ...
                            if ((null != F && n(F.id), (0, D.Gt)(l)))
                                for (let e of $) (null == F || F.id !== e) && n(e);
        ...
        }, [Y, h, M, L, p, n, el, ec, es, i, et, ee, t, l, Q, J, er, V, F, $, q, X, z, K, W, ei, eu, U]);
    };
var Z = (function (e) {
