...
let P = (0, m.Mg)(s.Z.STICKERS_CONSTANTS_STICKER_CATEGORY_LIST_PADDING),
    ...
    j = (0, m.Mg)(s.Z.STICKERS_CONSTANTS_CATEGORY_SEPARATOR_MARGIN_VERTICAL),
    M = [P, P, P, P],
    k = (w + D) * 2 + P,
    U = L + 2 * j,
    G = 7,
            ...
            g = i.useCallback(
                (e, a, s) => {
                    ...
                    let f,
                        ...
                        A = +!!g,
                        N = (null == (d = n[A]) ? void 0 : d.type) === b.Ih.RECENT,
                        P = n.length > 0,
                        D = n.length;
                    if (0 === a && g)
                        return (0, r.jsx)(
                        ...
                        return (0, r.jsx)(
                            "div",
                            {
                                ...
                                children: (0, r.jsx)(l.P3F, {
                                    ...
                                    className: o()(
                                        S.stickerCategory,
                                        S.stickerCategoryGeneric,
                                        S.stickerCategoryGenericLast,
                                        {
        ...
        let { stickersListRef: t, channel: n } = e,
            ...
            f = (0, g.Sd)(n),
            {
                ...
                let n = f.filter((e) => e.type === b.Ih.GUILD).length,
                    r =
                        n +
                        +((null == (e = f[0]) ? void 0 : e.type) === b.Ih.RECENT) +
                        +((null == (t = f[0]) ? void 0 : t.type) === b.Ih.FAVORITE),
                    i = r * (w + D) - D + U;
                return {
