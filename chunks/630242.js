...
function m(e) {
    let { isSettingsOpen: t } = e,
        ...
        [P, R] = (0, l.US)(C ? [o.z.CHAT_WALLPAPERS_PICKER_COACHMARK] : []),
    ...
    if (
        (r.useMemo(() => {
            v &&
                ...
                !D &&
                P !== o.z.CHAT_WALLPAPERS_PICKER_COACHMARK &&
        ...
        return;
    let L = C && P === o.z.CHAT_WALLPAPERS_PICKER_COACHMARK;
    if ((L && null != b && null == n && E !== f.j.COACHMARK && m(b), n === b)) {
        ...
        return (
            E !== e && g(e),
            {
                ...
                markDismissed: L
                    ? (e) => {
                          R(e), O === d.FN.TOOLBAR && N(h.L.INDIRECT_ACTION);
                      }
                    : void 0
            }
        );
