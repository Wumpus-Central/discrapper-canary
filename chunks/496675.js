...
function K(e) {
    let { channel: t } = e;
    return (delete C[t.id], (R += 1), x(t.guild_id), !1);
}
function z(e) {
    let { guildId: t } = e;
    delete N[t];
...
A(Q, 'displayName', 'PermissionStore');
let ee = new Q(l.Z, {
    BACKGROUND_SYNC: j,
    CONNECTION_OPEN: j,
