    ...
    return (
        ...
        (0, t.jsxs)("div", {
            ...
            children: [
                ...
                (0, t.jsx)(Y, { appId: e.id, subscriptions: s, otps: r, guildId: i }),
            ],
        })
    );
}
    ...
    return (0, t.jsxs)("div", {
        ...
        children: [
            ...
            l.length > 0 &&
                (0, t.jsxs)("div", {
                    children: [
                        (0, t.jsx)(v.D, { variant: "heading-lg/semibold", children: $.intl.string($.t.yUGTs8) }),
                        (0, t.jsx)("div", {
                            className: q.dD,
                            children: l.map((n) => (0, t.jsx)(J, { skuId: n.skuId, appId: e }, n.id)),
                        }),
                    ],
                }),
        ],
...
function Z(n) {
    let { appId: e, guildId: r, listing: a, subscriptionType: d, onDetails: u } = n,
        ...
        j = (0, P.Ko)(h, r),
        k = null != I && (0, E.Uo)(I, m),
        A = null != j && v?.subscriptionPlan?.id !== j?.subscriptionPlan.id,
        N = !1 === k && j?.subscriptionPlan.skuId === a.skuId,
        _ = v?.subscriptionPlan.skuId === a.skuId,
        {
            openModal: L,
        ...
        z = l.useMemo(() => {
            if (A && I?.currentPeriodEnd != null) {
                ...
                if (N) return $.intl.formatToPlainString($.t["2w6+NN"], { date: n });
            }
            if (F)
                return (0, t.jsxs)(t.Fragment, {
                    children: [
                        null != p && (0, t.jsx)(f.Ay, { guild: p, size: f.Ay.Sizes.MINI }),
                        $.intl.string($.t.l8ufqL),
                    ],
                });
        }, [I?.currentPeriodEnd, p, A, _, F, N]),
        w =
            null != z
