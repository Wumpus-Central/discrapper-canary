n.d(t, { ZP: () => eo }), n(35282), n(388685), n(539854), n(361932), n(187205);
var r = n(392711),
    i = n.n(r),
    a = n(159635),
    o = n.n(a),
    ...
    J = {
        ...
        mention: {
            ...
            parse(e, t, n) {
                ...
                if (r) {
                    var c;
                    let e = null != (c = P.ZP.getNickname(null == a ? void 0 : a.id, o, s)) ? c : w.ZP.getGlobalName(s);
        ...
        channel: {
            ...
            parse(e) {
                ...
                return { content: null == t ? e[0] : (0, l.F6)(t, C.default, S.Z, !0, !0) };
            },
        },
        emoji: {
        ...
        spoiler: {
            ...
            parse: () => ({ content: "<".concat(x.intl.string(x.t["F+x38P"]).toLowerCase(), ">") }),
        },
        staticRouteLink: {
