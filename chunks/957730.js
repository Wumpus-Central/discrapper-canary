...
function k(e, n, r) {
    ...
    let o = n.substring(0, a + 1),
        s = (0, f.mA)(n.substring(2, a));
    return r
        .sortBy((e) => {
            let { text: n } = e;
            return -n.length;
...
let G = _.Z.RULES,
    ...
    W = {
        ...
        mention: {
            match(e, n, r) {
                ...
                if (
                    ...
                    return null;
                let o = Y.exec(e);
                if (null != o && a[0].length <= o[0].length) return null;
                if ('' === r) {
                    let n = E.v.exec(e);
        ...
        emoticon: {
            match(e, n, r) {
                if (!y.ev.getSetting() || (0 !== r.length && !/\s$/.test(r))) return null;
        ...
        emoji: {
            ...
            parse(e, n, r) {
                let [i, a] = e,
                    { customEmoji: o } = r,
                    s = Object.prototype.hasOwnProperty.call(o, a) ? o[a] : null;
                if (null != s) {
                    var l;
                    return {
                        type: 'customEmoticon',
                        content: '<'
                            ...
                            .concat(null !== (l = s.originalName) && void 0 !== l ? l : s.name, ':')
                            .concat(s.id, '>'),
                        emoji: s
                    };
                }
    ...
    K = {
        ...
        mention: {
            ...
            parse(e, n, r) {
                ...
                let o = x.ZP.getUserTag(a, { identifiable: i && N.Z.enabled ? 'never' : 'always' });
                if (!i) return { content: '@'.concat(o) };
                {
                    let e = x.ZP.getGlobalName(a);
        ...
        channel: {
            ...
            parse(e) {
                let n = b.Z.getChannel(e[1]);
                return { content: null == n ? e[0] : (0, f.F6)(n, R.default, C.Z, !0, !0) };
            }
        },
        emoji: {
            ...
            parse(e, n, r) {
                let [i, a, o] = e,
                    { guild: s } = r,
                    l = p.ZP.getDisambiguatedEmojiContext(s ? s.id : null).getById(o),
                    u = null != l ? l.name : a;
...
function $(e) {
    ...
    let r = null == e ? void 0 : e.getGuildId(),
        ...
        a = A.Z.can(L.Plq.MENTION_EVERYONE, e);
    ...
    let o = u()(
        ...
        l = u()(I.ZP.getTextChannelNameDisambiguations(r)).map((e) => {
            let { id: n, name: r } = e;
            return {
                id: n,
                text: r
        ...
        f = p.ZP.getDisambiguatedEmojiContext(r),
...
n.ZP = {
    ...
    unparse(e, n, r) {
        let i = b.Z.getChannel(n),
            ...
            s = r ? K : u().omit(K, ['spoiler', 'timestamp']),
