...
class a {
    constructor(t, n) {
        if (
            ((this.messages = {}),
            (this.localeImportMap = t),
            (this.supportedLocales = Object.keys(t)),
    ...
    get(e, t) {
        ...
        return (
            console.warn(
                `Requested message ${o} does not have a value in the requested locale ${s} nor the default locale ${l}`,
            ),
