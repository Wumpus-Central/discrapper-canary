...
function C(e, t, n) {
    for (var r in (n && (A((n = o({}, n)), t), (t = o(o({}, n), t))), A(e, t), Object.assign(e, t), I))
        null == e[r] && (e[r] = I[r]);
    var i = e.mass,
        s = e.frequency,
        l = e.damping;
        ...
        return (
                                    ...
                                    if (o.decay) {
                                        ...
                                        for (
                                            var b = null == c.lastVelocity ? h : c.lastVelocity,
                                                ...
                                                A = Math.ceil(e / 1),
                                                N = 0;
                                            N < A && !(!(Math.abs(b) > O) && (f = Math.abs(d - p) <= y));
                                            ++N
                                        ) {
            ...
            (n._merge = function (e, t, n) {
                ...
                var I = a.is.arr(t.to) || a.is.fun(t.to),
                    ...
                    A = T.decay,
                    N = T.velocity;
                t.config && !I && C(T, L(t.config, r), t.config !== o.config ? L(o.config, r) : void 0);
                ...
                if (!G) {
                    ...
                    (O || B) && (G = !(F = a.isEqual(Y(w), D))),
                        (a.isEqual(T.decay, A) && a.isEqual(T.velocity, N)) || (G = !0);
                }
                if ((F && this.is(ec) && (i.changed && !R ? (G = !0) : G || this._stop()), !I)) {
