...
function y(e) {
    ...
    return {
        ...
        nudgeTimestamp: p.A.getNudgeDMTimestamp(e.id),
    };
}
function N() {
    S.clear(),
...
class O extends l.Ay.Store {
    ...
    initialize() {
        this.waitFor(E.A, m.A, _.A, g.Ay, f.A, A.Ay, I.default, p.A), this.syncWith([A.Ay, _.A, p.A], N);
    }
...
let R = new O(c.h, {
    ...
    CHANNEL_CREATE: function (e) {
        let { channel: t } = e;
        if (!(0, h.Gw)(t.type) || t.id === d.E) return !1;
        S.set(t.id, y(t));
    },
