...
var r,
    ...
    b =
        ...
        (c[(c.SUBSCRIPTION = 1)] = "SUBSCRIPTION"),
        (c[(c.FRACTIONAL_NITRO = 2)] = "FRACTIONAL_NITRO"),
        (c[(c.REVERSE_TRIAL = 3)] = "REVERSE_TRIAL"),
        (c[(c.SUBSCRIPTION_GROUP = 4)] = "SUBSCRIPTION_GROUP"),
        c),
    D =
        (((d = {})[(d.NONE_UNSPECIFIED = 0)] = "NONE_UNSPECIFIED"),
        (d[(d.BOOST_ONLY = 1)] = "BOOST_ONLY"),
        (d[(d.TIER_0 = 2)] = "TIER_0"),
        (d[(d.TIER_1 = 3)] = "TIER_1"),
        (d[(d.TIER_2 = 4)] = "TIER_2"),
        d),
    ...
    w =
        ...
        f),
    M =
        (((p = {})[(p.SOURCE_UNSPECIFIED = 0)] = "SOURCE_UNSPECIFIED"),
        (p[(p.SOURCE_NITRO = 1)] = "SOURCE_NITRO"),
        (p[(p.SOURCE_THIRDPARTY_CROISSANT = 2)] = "SOURCE_THIRDPARTY_CROISSANT"),
        p);
class P extends g.G {
    constructor() {
...
class k extends g.G {
    constructor() {
        super("discord_protos.users.v1.User", [
            ...
            { no: 9, name: "avatar_decoration_data", kind: "message", T: () => F },
            ...
            { no: 13, name: "display_name_styles", kind: "message", T: () => j },
        ]);
    }
    create(e) {
        ...
        for (; e.pos < s; ) {
            ...
            switch (t) {
                ...
                case 8:
                    ...
                    break;
                case 9:
                    i.avatarDecorationData = F.internalBinaryRead(e, e.uint32(), n, i.avatarDecorationData);
                    break;
                case 10:
                    i.primaryGuild = $.internalBinaryRead(e, e.uint32(), n, i.primaryGuild);
                    break;
                case 11:
                    i.collectibles = W.internalBinaryRead(e, e.uint32(), n, i.collectibles);
                    break;
                case 12:
                    i.safetyState = T.ew.internalBinaryRead(e, e.uint32(), n, i.safetyState);
                    break;
                case 13:
                    i.displayNameStyles = j.internalBinaryRead(e, e.uint32(), n, i.displayNameStyles);
                    break;
                default:
                    let s = n.readUnknownField;
                    if ("throw" === s)
    ...
    internalBinaryWrite(e, t, n) {
        "0" !== e.id && t.tag(1, h.O0.Varint).uint64(e.id),
            ...
            e.avatarDecorationData &&
                F.internalBinaryWrite(e.avatarDecorationData, t.tag(9, h.O0.LengthDelimited).fork(), n).join(),
            e.primaryGuild && $.internalBinaryWrite(e.primaryGuild, t.tag(10, h.O0.LengthDelimited).fork(), n).join(),
            e.collectibles && W.internalBinaryWrite(e.collectibles, t.tag(11, h.O0.LengthDelimited).fork(), n).join(),
            e.safetyState && T.ew.internalBinaryWrite(e.safetyState, t.tag(12, h.O0.LengthDelimited).fork(), n).join(),
            e.displayNameStyles &&
                j.internalBinaryWrite(e.displayNameStyles, t.tag(13, h.O0.LengthDelimited).fork(), n).join();
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? h.f$.onWrite : r)(this.typeName, e, t), t;
    }
}
...
class z extends g.G {
    constructor() {
        super("discord_protos.users.v1.ScheduleRule", [
            ...
            { no: 3, name: "start_time", kind: "message", T: () => x },
            { no: 4, name: "end_time", kind: "message", T: () => x },
        ...
        for (; e.pos < s; ) {
            ...
            switch (t) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    i.startTime = x.internalBinaryRead(e, e.uint32(), n, i.startTime);
                    break;
                case 4:
                    i.endTime = x.internalBinaryRead(e, e.uint32(), n, i.endTime);
                    break;
                case 5:
    ...
    internalBinaryWrite(e, t, n) {
        if (
            ...
            e.startTime && x.internalBinaryWrite(e.startTime, t.tag(3, h.O0.LengthDelimited).fork(), n).join(),
            e.endTime && x.internalBinaryWrite(e.endTime, t.tag(4, h.O0.LengthDelimited).fork(), n).join(),
            e.days.length)
        ) {
...
class el extends g.G {
    constructor() {
        super("discord_protos.users.v1.UserData", [
            ...
            { no: 2, name: "safety_feature_limits", kind: "map", K: 13, V: { kind: "message", T: () => eE } },
            ...
            { no: 6, name: "cross_platform_restriction", kind: "message", T: () => J },
            ...
            { no: 10, name: "display_name_styles", kind: "message", T: () => j },
            { no: 11, name: "store_country", kind: "message", T: () => ev },
            { no: 12, name: "restricted_schedule", kind: "message", T: () => Q },
            { no: 13, name: "age_assurance_data", kind: "message", T: () => ec },
            { no: 14, name: "perks", kind: "message", T: () => eM },
            { no: 15, name: "badges", kind: "message", T: () => eo },
            { no: 16, name: "country_data", kind: "message", T: () => ex },
        ]);
    }
    create(e) {
        ...
        for (; e.pos < s; ) {
            ...
            switch (t) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    i.crossPlatformRestriction = J.internalBinaryRead(e, e.uint32(), n, i.crossPlatformRestriction);
                    break;
                case 7:
                    i.collectibles = W.internalBinaryRead(e, e.uint32(), n, i.collectibles);
                    break;
                ...
                case 10:
                    ...
                    break;
                case 11:
                    i.storeCountry = ev.internalBinaryRead(e, e.uint32(), n, i.storeCountry);
                    break;
                case 12:
                    i.restrictedSchedule = Q.internalBinaryRead(e, e.uint32(), n, i.restrictedSchedule);
                    break;
                case 13:
                    i.ageAssuranceData = ec.internalBinaryRead(e, e.uint32(), n, i.ageAssuranceData);
                    break;
                case 14:
                ...
                case 15:
                    ...
                    break;
                case 16:
                    i.countryData = ex.internalBinaryRead(e, e.uint32(), n, i.countryData);
                    break;
                default:
                    let s = n.readUnknownField;
                    if ("throw" === s)
    ...
    internalBinaryWrite(e, t, n) {
        ...
        for (let r of Object.keys(e.safetyFeatureLimits))
            t.tag(2, h.O0.LengthDelimited).fork().tag(1, h.O0.Varint).uint32(parseInt(r)),
                t.tag(2, h.O0.LengthDelimited).fork(),
                eE.internalBinaryWrite(e.safetyFeatureLimits[r], t, n),
                t.join().join();
        ...
        e.quest && eT.internalBinaryWrite(e.quest, t.tag(4, h.O0.LengthDelimited).fork(), n).join(),
            ...
            e.crossPlatformRestriction &&
                J.internalBinaryWrite(e.crossPlatformRestriction, t.tag(6, h.O0.LengthDelimited).fork(), n).join(),
            e.collectibles && W.internalBinaryWrite(e.collectibles, t.tag(7, h.O0.LengthDelimited).fork(), n).join(),
            ...
            e.displayNameStyles &&
                j.internalBinaryWrite(e.displayNameStyles, t.tag(10, h.O0.LengthDelimited).fork(), n).join(),
            e.storeCountry && ev.internalBinaryWrite(e.storeCountry, t.tag(11, h.O0.LengthDelimited).fork(), n).join(),
            e.restrictedSchedule &&
                Q.internalBinaryWrite(e.restrictedSchedule, t.tag(12, h.O0.LengthDelimited).fork(), n).join(),
            e.ageAssuranceData &&
                ec.internalBinaryWrite(e.ageAssuranceData, t.tag(13, h.O0.LengthDelimited).fork(), n).join(),
            ...
            e.countryData && ex.internalBinaryWrite(e.countryData, t.tag(16, h.O0.LengthDelimited).fork(), n).join();
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? h.f$.onWrite : r)(this.typeName, e, t), t;
    }
}
    ...
    constructor() {
        super("discord_protos.users.v1.AgeAssuranceData", [
            { no: 1, name: "estimated_date_of_birth", kind: "message", T: () => I.D },
            {
                ...
                name: "method",
                kind: "enum",
                T: () => ["discord_protos.users.v1.AgeAssuranceMethod", v, "AGE_ASSURANCE_METHOD_"],
            },
            { no: 3, name: "method_version", kind: "scalar", T: 5 },
            {
                ...
                name: "vendor",
                kind: "enum",
                T: () => ["discord_protos.users.v1.AgeAssuranceVendor", C, "AGE_ASSURANCE_VENDOR_"],
            },
...
class ed extends g.G {
    constructor() {
        super("discord_protos.users.v1.LinkedUser", [
            ...
            { no: 2, name: "link_type", kind: "enum", T: () => ["discord_protos.users.v1.UserLinkType", O] },
            { no: 3, name: "link_status", kind: "enum", T: () => ["discord_protos.users.v1.UserLinkStatus", R] },
...
class eh extends g.G {
    constructor() {
        super("discord_protos.users.v1.FeatureLimits", [
            { no: 1, name: "map", kind: "map", K: 13, V: { kind: "message", T: () => ep } },
        ]);
    }
    create(e) {
        let t = { map: {} };
    ...
    internalBinaryWrite(e, t, n) {
        for (let r of Object.keys(e.map))
            t.tag(1, h.O0.LengthDelimited).fork().tag(1, h.O0.Varint).uint32(parseInt(r)),
                t.tag(2, h.O0.LengthDelimited).fork(),
                ep.internalBinaryWrite(e.map[r], t, n),
                t.join().join();
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? h.f$.onWrite : r)(this.typeName, e, t), t;
    }
...
class ew extends g.G {
    constructor() {
        super("discord_protos.users.v1.Perks", [
            ...
            { no: 2, name: "config_by_perk", kind: "map", K: 13, V: { kind: "message", T: () => eO } },
        ...
        for (; t.pos < i; ) {
            ...
            switch (e) {
                case 1:
                    ...
                    break;
                case 2:
                    a = eO.internalBinaryRead(t, t.uint32(), n);
                    break;
                default:
                    throw new globalThis.Error(
    ...
    internalBinaryWrite(e, t, n) {
        ...
        for (let r of Object.keys(e.configByPerk))
            t.tag(2, h.O0.LengthDelimited).fork().tag(1, h.O0.Varint).uint32(parseInt(r)),
                t.tag(2, h.O0.LengthDelimited).fork(),
                eO.internalBinaryWrite(e.configByPerk[r], t, n),
                t.join().join();
