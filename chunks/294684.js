    ...
    parseObject: function (t) {
        ...
        if (c)
            for (r = (e = L(t, c)).next; !(n = o(r, e)).done; ) {
                if ((a = o((s = (i = L(S(n.value))).next), i)).done || (u = o(s, i)).done || !o(s, i).done) throw new D('Expected sequence with length 2');
                W(h, {
                    key: k(a.value),
                    value: k(u.value)
                });
...
if (
    (p(
        tm,
        {
            ...
            has: function (t) {
                for (var e = j(this).entries, r = A(arguments.length, 1), n = k(t), i = r < 2 ? void 0 : arguments[1], s = void 0 === i ? i : k(i), a = 0; a < e.length; ) {
                    var o = e[a++];
    ...
    var ty = u(_.has),
        ...
        tw = function (t) {
            if (R(t)) {
                ...
                if (x(r) === H)
                    return (
                        ty((e = t.headers ? new N(t.headers) : new N()), 'content-type') || tb(e, 'content-type', 'application/x-www-form-urlencoded;charset=UTF-8'),
                        P(t, {
                            body: U(0, k(r)),
                            headers: U(0, e)
                        })
