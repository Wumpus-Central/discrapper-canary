...
var c = function (e, t, n) {
        for (var o = 0, i = 0; (o = i), (i = (0, r.fj)()), 38 === o && 12 === i && (t[n] = 1), !(0, r.r)(i); )
            (0, r.lp)();
            ...
            if ((1 !== e.props.length || 58 === t.charCodeAt(0) || p.get(n)) && !o) {
                ...
                for (var i = [], a = (0, r.cE)(d((0, r.un)(t), i)), s = n.props, u = 0, l = 0; u < a.length; u++)
                    for (var c = 0; c < s.length; c++, l++)
                        e.props[l] = i[u] ? a[u].replace(/&\f/g, s[c]) : s[c] + " " + a[u];
            }
        }
    },
    h = function (e) {
                            ...
                            switch ((0, i.vp)(t, n)) {
                                ...
                                case 5187:
                                    return (
                                        a.G$ +
                                        t +
                                        (0, i.gx)(t, /(\w+).+(:[^]+)/, a.G$ + "box-$1$2" + a.MS + "flex-$1$2") +
                                        t
                                    );
                                case 5443:
                                                ...
                                                return (
                                                    (0, i.gx)(
                                                        ...
                                                        "$1" +
                                                            ...
                                                            "$2-$3$1" +
                                                            a.uj +
                                                            (108 == (0, i.uO)(t, n + 3) ? "$3" : "$2-$3"),
                                                    ) + t
                                                );
                                            case 115:
                                                return ~(0, i.Cw)(t, "stretch")
                                                    ? e((0, i.gx)(t, "stretch", "fill-available"), n) + t
                                                    : t;
                                        }
                                    break;
                                case 4949:
                        ...
                        if (e.length)
                            return (0, i.$e)(e.props, function (t) {
                                switch ((0, i.EQ)(t, /(::plac\w+|:read-\w+)/)) {
                                    ...
                                    case ":read-write":
                                        return (0, s.q)(
                                            [(0, r.JG)(e, { props: [(0, i.gx)(t, /:(read-\w+)/, ":" + a.uj + "$1")] })],
                                            o,
                                        );
                                    case "::placeholder":
                                        return (0, s.q)(
