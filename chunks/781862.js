...
let A = [
        ...
        },
        {
            ...
            handler: (e, t) =>
                (0, s.mMO)(async () => {
                    let { default: l } = await Promise.all([n.e("43600"), n.e("42821")]).then(n.bind(n, 234355));
    ...
    g = (e) => {
        let { guild: t, channel: n } = e,
            s = (0, l.bG)([d.A], () => null != n && d.A.getChannelId() === n.id),
            o = (0, c.x)(n);
        return (0, i.jsx)(i.Fragment, {
            children: A.map((e) => {
                let { key: l, getName: d, handler: c, renderIcon: u } = e,
                    h = s && "JOIN_SERVERS" === l,
                    A = `${l}-${t.id}`;
                return (0, i.jsx)(
                    a.G,
