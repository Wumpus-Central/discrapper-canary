        ...
        children: [
            ...
            (0, o.jsxs)(e2.Z, {
                ...
                children: [
                    ...
                    (0, o.jsxs)(e6.A, {
                        className: e4.p_,
                        direction: e6.A.Direction.VERTICAL,
                        align: e6.A.Align.STRETCH,
                        grow: 0,
                        children: [
                            (0, o.jsx)(V.E, {
                                tag: "strong",
...
function t4(e) {
    ...
    return t?.state === R.elq.BANNED
        ? (0, o.jsx)(e8, { text: Q.intl.string(Q.t["5AkWAd"]), buttonCta: Q.intl.string(Q.t["8osdkn"]), onClick: n })
        : (0, o.jsx)(e8, { text: Q.intl.string(Q.t["usP+Mb"]), buttonCta: Q.intl.string(Q.t["8osdkn"]), onClick: n });
}
function t8(e) {
...
let i4 = function () {
    return (0, o.jsx)(G.Ay, {
        children: (0, o.jsxs)("div", {
            className: i6.hQ,
            children: [
                (0, o.jsx)(G.hE, { className: i6.DD, children: Q.intl.string(Q.t.nCB6Ga) }),
                (0, o.jsx)(G.tK, {
                    className: i6.VA,
...
let lU = g.Ay.connectStores([nk.A, n8.A, eX.default, n3.A, eh.A, n6.A], (e) => {
    ...
    return {
        ...
        nativeAppState: n6.A.getState(t),
    };
})(lB);
function lV(e) {
...
function sN(e) {
    let { invite: t, guild: n, liveliness: i, analyticsLocation: l } = e,
        ...
        r = l6.useConfig({ location: l }).variant;
    return (0, o.jsxs)(eO.B, {
        direction: "vertical",
        gap: 8,
        children: [
...
function sz(e) {
    let { invite: t, transitionTo: n, location: i } = e,
        ...
        { enabled: s } = l6.useConfig({ location: "InviteLogin" });
    return null != l &&
        t.liveliness?.msg_activity_bins != null &&
        null == t.guild_scheduled_event &&
        (l6.getConfig({ location: "InviteLogin.hasLiveliness" }), s)
...
function sQ(e) {
    let { invite: t, onLoginStart: n, location: i, transitionTo: l } = e,
        ...
        { enabled: r } = l6.useConfig({ location: "InviteRegister" });
    return null != s &&
        t.liveliness?.msg_activity_bins != null &&
        null == t.guild_scheduled_event &&
        (l6.getConfig({ location: "InviteRegister.hasLiveliness" }), r)
        ? (0, o.jsx)(sb, {
              invite: t,
              guild: s,
...
function sK(e) {
    let { invite: t, inviteKey: n, handleAccept: i, handleDefaultTransition: l } = e,
        ...
        { enabled: a } = l6.useConfig({ location: "InviteAuthenticated" }),
    ...
    null != r &&
        t.liveliness?.msg_activity_bins != null &&
        null == d &&
        (l6.getConfig({ location: "InviteAuthenticated.hasLiveliness" }), a))
...
let s6 = nK(iX),
    ...
    s3 = nK(function (e) {
        let t = {
            ...
            nativeAppState: (0, g.bG)([n6.A], () => n6.A.getState(e.code)),
        ...
        return (0, o.jsxs)(nq.A, {
            ...
            children: [
                ...
                (0, o.jsx)(ei.A, {
                    ...
                    path: R.BVt.LOGIN,
                    render: (e) => (0, o.jsx)(s6, { ...e, redirectTo: t }),
                }),
                (0, o.jsx)(ei.A, {
                ...
                (0, o.jsx)(ei.A, {
                    ...
                    render: (e) => (0, o.jsx)(s7, { login: !0, ...e }),
                }),
                (0, o.jsx)(ei.A, { path: R.BVt.GIFT_CODE(":giftCode"), render: (e) => (0, o.jsx)(s7, { ...e }) }),
                (0, o.jsx)(ei.A, {
