...
function e8(e) {
    ...
    return (0, o.jsx)(G.Ay, { theme: i, children: (0, o.jsx)(e3, { text: t, buttonCta: n, onClick: l }) });
}
var e7 = n(765671),
    e5 = n(9994),
    e9 = n(71393),
...
function t6(e) {
    ...
    return t?.state === R.elq.BANNED
        ? (0, o.jsx)(e3, { text: z.intl.string(z.t["5AkWAd"]), buttonCta: z.intl.string(z.t["8osdkn"]), onClick: n })
        : (0, o.jsx)(e3, { text: z.intl.string(z.t["usP+Mb"]), buttonCta: z.intl.string(z.t["8osdkn"]), onClick: n });
}
function t3(e) {
...
class n0 extends c.PureComponent {
    ...
    componentDidMount() {
        ...
        E.Bo.post({
            ...
            (0, D.d)("disable_email_notifications");
    }
    renderBusy() {
        return (0, o.jsx)(G.Ay, { children: (0, o.jsx)(G.CK, {}) });
    }
...
function iq(e) {
    ...
    let p = (0, g.bG)([eq.default], () => eq.default.isAuthenticated()),
        ...
        j = i?.skuId ?? null,
        v = (0, g.bG)([n8.A], () => (null != j ? n8.A.get(j) : null)),
        {
            checkingHandoff: N,
            redirecting: I,
            login: C,
...
function lN(e) {
    ...
    let eg = c.useCallback(async () => {
            ...
            try {
                ...
                if ((Q(!1), !(t instanceof i8.LG))) return;
                let e = (0, iW.W)(t);
...
class lB extends c.PureComponent {
    ...
    componentDidMount() {
        ...
        e && this.handleAuthenticated(), t || this.resolveGiftCode(), (0, D.d)("gift_code");
    }
...
let lV = g.Ay.connectStores([nk.A, n3.A, eq.default, n8.A, eh.A, n4.A], (e) => {
...
let s2 = nK(iq),
    ...
    s6 = nK(function (e) {
        let { inviteKey: t, location: n, transitionTo: i, login: l } = e,
            ...
            [m, f] = c.useState(!1);
        c.useLayoutEffect(() => {
            (a === R.fAW.OPEN || r?.state === R.elq.APP_OPENED) && f(!0);
        }, [r?.state, a]);
        let p = l ? sF : sM,
            E = c.useCallback((e) => A.Ay.getInviteContext(e, r), [r]),
            _ = c.useCallback(
                (e) => {
                    null != r &&
        ...
        if (
            ...
            c.useEffect(() => {
                r?.state === R.elq.APP_NOT_OPENED && _();
            }, [r?.state, _]),
            (function (e) {
                let {
                        invite: t,
            ...
            return null;
        let N = a === R.fAW.OPEN;
        if (m || N || r.state === R.elq.APP_OPENED)
            return (0, o.jsx)(sK, { invite: r, inviteKey: t, rpcConnected: N, onContinue: _ });
        let { state: I } = r;
        if (I === R.elq.APP_NOT_OPENED) return (0, o.jsx)(sY, { handleDefaultTransition: v });
        if ([R.elq.RESOLVING, R.elq.ACCEPTING, R.elq.APP_OPENING].includes(I)) {
            let e =
                I === R.elq.ACCEPTING ? z.intl.string(z.t["6wsY16"]) : (R.elq.RESOLVING, z.intl.string(z.t["Z+hCVU"]));
            return (0, o.jsx)(sX, { title: e });
        }
        if (I === R.elq.EXPIRED) return (0, o.jsx)(sq, { banned: !1, handleDefaultTransition: v });
        if (I === R.elq.BANNED) return (0, o.jsx)(sq, { banned: !0, handleDefaultTransition: v });
        if (I === R.elq.RESOLVED) {
            if (d && (0, lZ.Lt)(r.flags ?? 0, l$.Q.IS_GUEST_INVITE))
                return (
                    A.Ay.openApp(t),
                    lJ.u.set(sU.B, t),
                    (0, o.jsx)(sK, { invite: r, inviteKey: t, rpcConnected: N, onContinue: () => i(R.BVt.APP) })
                );
            if (!d && lQ.VP)
                return p === sF
        ...
        return I === R.elq.RESOLVED || I === R.elq.ERROR
            ? (0, o.jsx)(sz, { invite: r, inviteKey: t, handleAccept: j, handleDefaultTransition: v })
            : null;
    }),
    s3 = nK(function (e) {
        let t = {
    ...
    rr = nK(function (e) {
        ...
        return (c.useEffect(() => {
            let e = (0, eg.A)(t);
            eL.A.verify(e), (0, D.d)("verify_hub_email");
        }, [t]),
        n)
            ? (0, o.jsx)(eD, {
    ...
    rd = nK(function (e) {
        ...
        return (
            ...
            c.useEffect(() => {
                ...
                r(!0), e((0, eg.A)(t)), (0, D.d)("report_second_look");
            }, [t]),
            l &&
                !u &&
                (0, o.jsxs)(G.Ay, {
