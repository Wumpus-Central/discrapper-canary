...
async function r(e, t) {
    let { rating: n, category: r, reasonCode: o, reasonDescription: d, variant: s, feedback: u, analyticsData: c } = t,
        b = l.Z.getSettings(),
        f = l.Z.getInputDeviceId(),
        O = l.Z.getInputDevices()[f],
        v = l.Z.getOutputDeviceId(),
        m = l.Z.getOutputDevices()[v],
        E = l.Z.getVideoDeviceId(),
        p = l.Z.getVideoDevices()[E],
        g = l.Z.getNoiseCancellation(),
        _ = l.Z.getMediaEngine().getAudioSubsystem(),
