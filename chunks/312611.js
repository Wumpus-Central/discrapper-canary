    ...
    (e.default = class {
        ...
        description(t) {
            return void 0 === t
                ...
                : (t ? (this.data.description = t) : (this.data.description = null), this);
        }
        x(t, e) {
        ...
        toString() {
            ...
            if (
                ...
                "number" == typeof this.data.trigger && this.data.trigger > 0
                    ? (t += "TRIGGER;RELATED=END:" + (0, n.toDurationString)(this.data.trigger) + "\r\n")
                    : "number" == typeof this.data.trigger
                      ? (t += "TRIGGER:" + (0, n.toDurationString)(this.data.trigger) + "\r\n")
                      : (t +=
                            "TRIGGER;VALUE=DATE-TIME:" +
                            (0, n.formatDate)(this.event.timezone(), this.data.trigger) +
                            "\r\n"),
            ...
            return (
                this.data.interval && (t += "DURATION:" + (0, n.toDurationString)(this.data.interval) + "\r\n"),
                "audio" === this.data.type && this.data.attach && this.data.attach.mime
                    ? (t += "ATTACH;FMTTYPE=" + this.data.attach.mime + ":" + this.data.attach.uri + "\r\n")
                ...
                "display" === this.data.type && this.data.description
                    ? (t += "DESCRIPTION:" + (0, n.escape)(this.data.description) + "\r\n")
                    : "display" === this.data.type &&
                      (t += "DESCRIPTION:" + (0, n.escape)(this.event.summary()) + "\r\n"),
                (t += (0, n.generateCustomAttributes)(this.data)),
                (t += "END:VALARM\r\n")
            );
        }
    });
