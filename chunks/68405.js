...
function R(e, t) {
    ...
    let a = {
        ...
        o = (0, m._)(p.Z.getAnalyticsID(), t, I(v({}, a, i), { results: e.length })),
...
function B(e) {
    f.DZ.updateAsync(
        ...
        (t) => {
            ...
            if (((t.gifs[Z(e.url)] = I(v({}, e), { order: r + 1 })), s.wK.toBinary(t).length > b.vY))
                return (
                    g.Z.show({
            ...
            let a = i().size(t.gifs);
            a > 2 && (t.hideTooltip = !0), _.default.track(E.rMx.GIF_FAVORITED, { total_num_favorited: a });
        },
