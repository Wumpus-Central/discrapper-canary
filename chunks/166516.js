    ...
    var t = function (e) {
        ...
        if (_ || I)
            for (var M = 0; M < T.types['' + t.animation].length; M++) {
                ...
                (_ && (U.y < 0.6 ? (U.y = U.y - 0.4) : (U.y = U.y - 2 * U.y + (1 - U.w))), I && (U.x < 0.6 ? (U.x = U.x - 0.4) : (U.x = U.x - 2 * U.x + (1 - U.h))), (T.types['' + t.animation][M] = U));
            }
        return (
                        ...
                        (p = function () {
                            try {
                                if ('number' == typeof e ? e > 0 : '' !== e) {
                                    ...
                                    if (
                                        ('animation' in t && T.types['' + t.animation] && (r.options.animation = '' + t.animation),
