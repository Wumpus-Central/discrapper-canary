        ...
        (E.getIcon = function () {
            ...
            (E.setIcon = function (t) {
                ...
                if ((e.dataUrl && e.dataUrl(r), e.element))
                    e.element.setAttribute("href", r), e.element.setAttribute("src", r);
                else if (e.elementId) {
                ...
                image: function (t) {
                    (f = function () {
                        try {
                            ...
                            s.setAttribute("crossOrigin", "anonymous"),
                                (s.onload = function () {
                                    a.clearRect(0, 0, n, r), a.drawImage(s, 0, 0, n, r), E.setIcon(i);
                                }),
                        ...
                        (navigator.getUserMedia =
                            ...
                            (f = function () {
                                try {
                                    ...
                                    ((e = document.createElement("video")).width = n),
                                        (e.height = r),
                                        navigator.getUserMedia(
                                            {
                                                video: !0,
