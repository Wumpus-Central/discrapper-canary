    ...
    (e.deleteBackward = (n) => {
        ...
        if ((null == r ? void 0 : r[0].type) === "blockQuote") {
            ...
            if (null != t && a.C0.isFirstChild(r[1], t.path) && 0 === t.offset)
                return void i.Q.setNodes(e, { type: "line" }, { at: r[1] });
        }
        t(n);
    }),
        (e.deleteFragment = (t) => {
...
function c(e) {
    ...
    for (let l of a.bN.blocks(e)) {
        ...
        if ((0, o.iF)(e, d)) {
            "blockQuote" === c.type &&
                (i.Q.setNodes(e, { type: "line" }, { at: u }), i.Q.insertText(e, "> ", { at: d }));
            continue;
        }
        ...
        if ((null != _ || null != p || t) && (i.Q.setNodes(e, { type: "blockQuote" }, { at: u }), !t)) {
            var n, r;
            let o =
                    null != (r = null != (n = null == _ ? void 0 : _[0].length) ? n : null == p ? void 0 : p[0].length)
                        ? r
                        : 0,
                s = a.C0.child(u, 0);
            i.Q.delete(e, {
