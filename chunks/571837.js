...
var o = {
    ...
    'creditCard.cvcField.title': 'Codice di sicurezza',
    ...
    'error.message.unknown': 'Si è verificato un errore sconosciuto',
    ...
    'sr.wechatpay.timetopay': 'Hai %#minuti%# %#secondi%# per pagare',
    ...
    firstName: 'Nome',
    'firstName.invalid': 'Immetti il tuo nome',
    infix: 'Prefisso',
    lastName: 'Cognome',
    'lastName.invalid': 'Immetti il tuo cognome',
    ...
    cityTown: 'Città',
    address: 'Indirizzo',
    'address.placeholder': 'Trova il tuo indirizzo',
    'address.errors.incomplete': 'Inserisci un indirizzo per continuare',
    'address.enterManually': "Inserisci l'indirizzo manualmente",
    state: 'Stato',
    'field.title.optional': '(facoltativo)',
    'creditCard.cvcField.title.optional': 'Codice di sicurezza (facoltativo)',
    ...
    'boleto.socialSecurityNumber.invalid': 'Il campo non è valido',
    ...
    'error.va.sf-cc-num.01': 'Immetti un numero di carta valido',
    'error.va.sf-cc-num.02': 'Immetti il numero della carta',
    'error.va.sf-cc-num.03': 'Immetti un marchio di carta supportato',
    'error.va.sf-cc-num.04': 'Immetti il numero completo della carta',
    'error.va.sf-cc-dat.01': 'Immetti una data di scadenza valida',
    'error.va.sf-cc-dat.02': 'Immetti una data di scadenza valida',
    'error.va.sf-cc-dat.03': 'Carta di credito in scadenza',
    'error.va.sf-cc-dat.04': 'Immetti la data di scadenza',
    'error.va.sf-cc-dat.05': 'Immetti la data di scadenza completa',
    'error.va.sf-cc-mth.01': 'Immetti il mese di scadenza',
    'error.va.sf-cc-yr.01': "Immetti l'anno di scadenza",
    'error.va.sf-cc-yr.02': "Immetti l'anno di scadenza completo",
    'error.va.sf-cc-cvc.01': 'Immetti il codice di sicurezza',
    'error.va.sf-cc-cvc.02': 'Immetti il codice di sicurezza completo',
    'error.va.sf-ach-num.01': 'Il campo Numero di conto corrente bancario è vuoto',
    'error.va.sf-ach-num.02': 'La lunghezza del numero di conto corrente bancario non è corretta',
    'error.va.sf-ach-loc.01': 'Il campo Numero di routing bancario è vuoto',
    'error.va.sf-ach-loc.02': 'La lunghezza del numero di routing bancario non è corretta',
    'error.va.sf-kcp-pwd.01': 'Il campo Password è vuoto',
    'error.va.sf-kcp-pwd.02': 'La lunghezza della password non è corretta',
    ...
    'partialPayment.remainingBalance': 'Il saldo rimanente sarà di %{amount}',
    ...
    'creditCard.encryptedCardNumber.aria.iframeTitle': 'Iframe per il numero di carta',
    'creditCard.encryptedCardNumber.aria.label': 'Numero carta',
    'creditCard.encryptedExpiryDate.aria.iframeTitle': 'Iframe per data di scadenza',
    'creditCard.encryptedExpiryDate.aria.label': 'Data di scadenza',
    'creditCard.encryptedExpiryMonth.aria.iframeTitle': 'Iframe per il mese di scadenza',
    'creditCard.encryptedExpiryMonth.aria.label': 'Mese di scadenza',
    'creditCard.encryptedExpiryYear.aria.iframeTitle': "Iframe per l'anno di scadenza",
    'creditCard.encryptedExpiryYear.aria.label': 'Anno di scadenza',
    'creditCard.encryptedSecurityCode.aria.iframeTitle': 'Iframe per il codice di sicurezza',
    'creditCard.encryptedSecurityCode.aria.label': 'Codice di sicurezza',
    'creditCard.encryptedPassword.aria.iframeTitle': 'Iframe per la password',
    'creditCard.encryptedPassword.aria.label': 'Prime 2 cifre della password della carta',
    'giftcard.encryptedCardNumber.aria.iframeTitle': 'Iframe per il numero di carta',
    'giftcard.encryptedCardNumber.aria.label': 'Numero carta',
    'giftcard.encryptedSecurityCode.aria.iframeTitle': 'Iframe per il pin',
    ...
    'ach.encryptedBankAccountNumber.aria.iframeTitle': 'Iframe per il numero di conto bancario',
    'ach.encryptedBankAccountNumber.aria.label': 'Numero di conto',
    'ach.encryptedBankLocationId.aria.iframeTitle': 'Iframe per il numero di routing bancario',
    'ach.encryptedBankLocationId.aria.label': 'Codice ABA',
    ...
    'ctp.logout.notYourCard': 'Non è la tua carta?',
    'ctp.logout.notYourProfile': 'Non è il tuo profilo?',
    ...
    'ctp.errors.ACCT_INACCESSIBLE': 'Questo account non è attualmente disponibile, ad esempio perché è bloccato',
    'ctp.errors.CODE_INVALID': 'Codice di verifica non corretto',
    'ctp.errors.CODE_EXPIRED': 'Questo codice è scaduto',
    'ctp.errors.RETRIES_EXCEEDED': 'È stato superato il limite di tentativi per la generazione del codice OTP',
    'ctp.errors.OTP_SEND_FAILED': 'Impossibile inviare il codice OTP al destinatario',
    'ctp.errors.REQUEST_TIMEOUT': 'Si è verificato un errore. Riprova o inserisci manualmente la carta',
    'ctp.errors.UNKNOWN_ERROR': 'Si è verificato un errore. Riprova o inserisci manualmente la carta',
    'ctp.errors.SERVICE_ERROR': 'Si è verificato un errore. Riprova o inserisci manualmente la carta',
    'ctp.errors.SERVER_ERROR': 'Si è verificato un errore. Riprova o inserisci manualmente la carta',
    'ctp.errors.INVALID_PARAMETER': 'Si è verificato un errore. Riprova o inserisci manualmente la carta',
    'ctp.errors.AUTH_ERROR': 'Si è verificato un errore. Riprova o inserisci manualmente la carta',
