...
function u(e, t, a) {
    null != d[e] && d[e].stop();
    let n = new l.Ep();
    n.start(a, () => r.h.dispatch({ type: "ACTIVITY_LAUNCH_FAIL", applicationId: e, activityType: t })), (d[e] = n);
}
function h(e, t, a) {
    let { applicationId: n, remotePartyId: l } = a;
    if (e === o.eAD.COMPLETE) {
        delete c[n]?.[t], null != d[n] && (d[n].stop(), delete d[n]);
        return;
    }
    let r = c[n] ?? {};
    (r[t] = { state: e, remotePartyId: l }),
        (c[n] = r),
        __OVERLAY__ || e !== o.eAD.FAILED ? e === o.eAD.LOADING && null != l && u(n, t, 15e3) : u(n, t, 12e4);
}
function p(e) {
    ...
    return (
        e.forEach((e) => {
            let { applicationId: a, remotePartyId: n } = e,
                ...
                r = s.A.getApplicationActivity(a);
            (l?.party?.id === n || r?.party?.id === n) &&
