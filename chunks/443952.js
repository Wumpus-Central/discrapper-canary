...
async function U(e, t, n, r) {
    ...
    if (null == l || null == l.secrets || !(0, A.t9)(r, l.party, l.secrets)) throw new x.Z({ errorCode: k.lTL.NO_ELIGIBLE_ACTIVITY }, 'No eligible activity for application. Ensure an activity includes a party and appropriate secret.');
    let a = (0, m.Z)(l, I.Z);
    if (a) {
        let { lock: t } = (0, R.jU)(e);
        return (0, s.h7)(l, a).then(() => {
            throw (t(), new x.Z({ errorCode: k.lTL.NO_ELIGIBLE_ACTIVITY }, 'No eligible activity for application. Ensure user does have have privacy enabled.'));
        });
    }
...
let G = {
    ...
    [k.Etm.OPEN_INVITE_DIALOG]: {
        ...
        handler(e) {
            ...
            if (((0, j.Pr)({}, null == d ? void 0 : d.document), null != c)) {
                if (c.applicationId !== i.id) throw new x.Z({ errorCode: k.lTL.INVALID_COMMAND }, 'Application is not currently mounted.');
                let e = v.Z.getApplicationActivity(i.id);
                if (null != e) (0, s.h7)(e, !1, p);
                else throw new x.Z({ errorCode: k.lTL.NO_ELIGIBLE_ACTIVITY }, 'No eligible activity for application. Ensure an activity was set using setActivity.');
            } else
                (0, a.ZDy)(
                    async () => {
    ...
    [k.Etm.INITIATE_IMAGE_UPLOAD]: (0, l.S)(k.Etm.INITIATE_IMAGE_UPLOAD, {
        ...
        handler(e) {
            ...
            return new Promise((e, t) => {
                ...
                var t;
                throw new x.Z({ errorCode: k.lTL.UNKNOWN_ERROR }, null != (t = null == e ? void 0 : e.message) ? t : 'Failed to upload image');
            });
        }
    }),
    [k.Etm.OPEN_SHARE_MOMENT_DIALOG]: (0, l.S)(k.Etm.OPEN_SHARE_MOMENT_DIALOG, {
        ...
        handler(e) {
            ...
            if (null == i) throw new x.Z({ errorCode: k.lTL.INVALID_COMMAND }, 'No application.');
            if (!(0, S.yE)(null != (t = n.application.flags) ? t : 0, k.udG.EMBEDDED)) throw new x.Z({ errorCode: k.lTL.INVALID_COMMAND }, 'This application cannot access this API');
            let l = (0, w.Z)();
            if (!P.Z.isDiscordCdnUrl(r)) throw new x.Z({ errorCode: k.lTL.INVALID_PAYLOAD }, 'mediaUrl must be a Discord CDN url');
            (0, b.Z)({
                applicationId: i,
                channelId: null == l ? void 0 : l.id,
                mediaUrl: r
    ...
    [k.Etm.SHARE_INTERACTION]: (0, l.S)(k.Etm.SHARE_INTERACTION, {
        ...
        handler(e) {
            ...
            if (!(0, S.yE)(null != (t = r.application.flags) ? t : 0, k.udG.EMBEDDED)) throw new x.Z({ errorCode: k.lTL.INVALID_COMMAND }, 'This application cannot access this API');
            let h = (0, w.Z)();
