    ...
    21552 == n.j
        ? () => {
              ...
              let i = (0, a.bG)([E.A], () => E.A.getGuildId(), []),
                  ...
                  C =
                      (null ==
                      (t = (0, o.B6)(f.pathname, O.BVt.CHANNEL(null == P ? void 0 : P.id, p.VV.GUILD_ONBOARDING)))
                          ? void 0
                          : t.isExact) === !0;
              ...
              switch (D) {
                  case A.B5.SUBMITTED:
                      (m = N.intl.string(N.t["5iLvSx"])),
                          (g = N.intl.string(N.t.mqtdmQ)),
                          (h = () => {
                              (0, s.A)({
                                  title: N.intl.string(N.t.aIz1oV),
                                  subtitle: N.intl.string(N.t["13tjTU"]),
                                  variant: "primary",
                      ...
                      break;
                  case A.B5.REJECTED:
                      (m = N.intl.string(N.t.lk30cY)),
                          (g = N.intl.string(N.t["8RrsHr"])),
                          (h = () => {
                              (0, c.mMO)(async () => {
                      ...
                      break;
                  default:
                      (m = N.intl.string(N.t.G5YKXP)),
                          (g = N.intl.string(N.t["r8/DT+"])),
                          (h = () => {
                              (0, _.Ze)(P.id);
                          });
              }
