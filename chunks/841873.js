...
let h = new ("u" < typeof TextDecoder ? (0, e.require)("util").TextDecoder : TextDecoder)("utf-8", {
    ignoreBOM: !0,
    fatal: !0,
});
function f(e, t) {
    return (e >>>= 0), h.decode(o().subarray(e, e + t));
}
function p(e) {
...
class M {
    ...
    static isBlockedDomain(e) {
        ...
        if (a[3]) throw I(a[2]);
        return 0 !== a[0] && ((t = f(a[0], a[1]).slice()), i.__wbindgen_free(a[0], +a[1], 1)), t;
    }
