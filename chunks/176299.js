...
let eC = (0, c.Un)({
    ...
    eL = (e) => {
        let { match: t } = e,
            ...
            d = (0, h.e7)([ee.ZP], () => (null == l ? null : ee.ZP.getSelfMember(l))),
            c = (0, h.e7)([G.Z], () => {
                if (null == l) return;
                let e = G.Z.getData(l);
        ...
        if (null != l && null != r && (0, e_.AB)(r))
            switch (r) {
                ...
                case e_.oC.GUILD_BOOSTS:
                    return p ? (0, i.jsx)(eb, { guildId: l }) : (0, i.jsx)(o.l_, { to: eg.Z5c.CHANNEL(l) });
                default:
                    (0, er.vE)(r);
            }
        if ((0, j.p3)(s, d))
...
function eF(e) {
    let { hasNotice: t, sidebarTheme: n, hideSidebar: r, hideChannelList: s, isSidebarOpen: o, isOnFullScreenCollectiblesShopRoute: d } = e;
    (0, _.t)(!0);
    let c = 'app view user trigger debugging';
    g.R6.useExperiment({ location: c }, { autoTrackExposure: !1 }), g.R6.trackExposure({ location: c });
...
function ez() {
    ...
    let t = (0, h.e7)([ei.ZP], () => ei.ZP.hasNotice()),
        ...
        v = (0, b.TH)('AppView'),
        S = I ? 'div' : l.Fragment,
        Z = (0, A.useAppSidebarState)((e) => !e.isOpen),
                                            ...
                                            children: (0, i.jsxs)(o.rs, {
                                                children: [
                                                    ...
                                                    (0, i.jsx)(C.Z, {
                                                        ...
                                                        render: ej,
                                                        impressionName: d.ImpressionNames.HUB_EMAIL_SIGNUP,
                                                        impressionProperties: (e) => {
                                                            let { computedMatch: t } = e;
