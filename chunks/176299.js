...
let eZ = (0, u.Un)({
    ...
    eG = (0, u.Un)({
        createPromise: () => Promise.all([n.e("55616"), n.e("97844"), n.e("44799")]).then(n.bind(n, 393357)),
        webpackId: 393357,
    ...
    eV = i.memo(function () {
        ...
        return window.location.pathname.startsWith(eS.Z5c.CHANNEL(eS.STv))
            ...
            : window.location.pathname.startsWith(eS.Z5c.GLOBAL_DISCOVERY) ||
                window.location.pathname.startsWith(eS.Z5c.GUILD_DISCOVERY) ||
                (0, et.OG)()
              ? (0, r.jsx)(R.Z, {})
              : null != e
                ? (0, r.jsx)(
    ...
    eX = function () {
        ...
        return function (t) {
            ...
            return Object.values(eT.AW).includes(n)
                ...
                : (0, r.jsx)(T.Z, eA({ isFullScreen: e }, t));
        };
    },
        ...
        v = i.useCallback(
            (e, t) => {
                ...
                t <= ev.li
                    ...
                    : document.body.classList.remove(ex.draggingMin),
                    t >= ev.zx
                        ? document.body.classList.add(ex.draggingMax)
                        : document.body.classList.remove(ex.draggingMax);
                let i = t - e;
                null == (n = y.current) ||
                    n.style.setProperty("--custom-overdrag", "".concat(1 + Math.min(Math.abs(i / ev.p8), 0.25))),
                    m && (P.useAppSidebarState.setState({ isOpen: !r }), r && e4(ev.p8));
            },
            [m],
        ),
        I = i.useCallback(() => {
...
function e5() {
    ...
    let t = (0, p.e7)([eh.ZP], () => eh.ZP.hasNotice()),
        ...
        a = (function () {
            let [e, t] = i.useState(() =>
                window.location.pathname.startsWith(eS.Z5c.GUILD_MEMBER_VERIFICATION_FOR_HUB("")),
            );
            return (
                i.useEffect(
                    () =>
        ...
        o = (function () {
            ...
            let t = (0, s.TH)();
            return (
                (null == (e = (0, s.LX)(t.pathname, eS.Z5c.GUILD_BOOSTING_MARKETING(ea.Hw.guildId())))
                    ? void 0
                    : e.isExact) === !0
            );
        })(),
                                    ...
                                    children: [
                                        (0, r.jsxs)(s.rs, {
                                            children: [
                                                ...
                                                (0, r.jsx)(I.Z, {
                                                    path: eS.Z5c.GUILD_MEMBER_VERIFICATION_FOR_HUB(
                                                        ea.Hw.guildId(),
                                                        ":inviteCode?",
                                                    ),
                                                    render: eK,
