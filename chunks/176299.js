...
let ew = (0, u.Un)({
    ...
    eV = (e) => {
        let { match: t } = e,
            ...
            u = (0, p.e7)([ef.Z], () => ef.Z.getGuild(l)),
            d = (0, p.e7)([ep.ZP], () => (null == l ? null : ep.ZP.getSelfMember(l))),
            f = (0, p.e7)([F.Z], () => {
                if (null == l) return;
                let e = F.Z.getData(l);
        ...
        if (null != l && null != a && (0, eT.AB)(a))
            switch (a) {
                ...
                case eT.oC.MEMBER_APPLICATIONS:
                    return (0, r.jsx)(s.l_, { to: eN.Z5c.CHANNEL(l, eT.oC.MEMBER_SAFETY) });
    ...
    eF = (e) => (0, r.jsx)(eV, eZ({}, e)),
    ez = () => (0, r.jsx)(L.Z, {}),
    eW = (e) => (0, r.jsx)(eY, eZ({}, e)),
    eY = (e) => {
    ...
    let y = i.useRef(null),
        v = i.useCallback(
            (e, t) => {
                ...
                null == (n = y.current) ||
                    ...
                    m && (j.useAppSidebarState.setState({ isOpen: !r }), r && e5(eI.p8));
            },
            [m],
        ),
        I = i.useCallback(() => {
        ...
        S = i.useCallback((e) => {
            ...
            document.body.classList.remove(eA.dragging),
                ...
                f.K.set(eI.nT, e),
                em.default.track(eN.rMx.CHANNEL_SIDEBAR_RESIZED, { width: e });
        }, []),
        N = (0, O.Z)({
            minDimension: eI.li,
            maxDimension: eI.zx,
...
function e6() {
    ...
    let t = (0, p.e7)([eg.ZP], () => eg.ZP.hasNotice()),
        ...
        m = (null == g || null == (e = g.params) ? void 0 : e.channelId) === eT.oC.GUILD_ONBOARDING,
        b = l || a || o || u || m,
