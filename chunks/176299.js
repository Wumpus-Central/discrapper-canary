    ...
    eU = function () {
        ...
        return function (t) {
            ...
            return Object.values(eb.AW).includes(n)
                ...
                : (0, r.jsx)(N.Z, ey({ isFullScreen: e }, t));
        };
    },
    eG = (e) => (0, r.jsx)(y.Z, ey({}, e)),
    eV = () => (0, r.jsx)(Y.Z, {}),
    eB = () => (0, r.jsx)(H.Z, {}),
    eH = () => (0, r.jsx)(W.Z, {}),
    eF = (e) => {
        ...
        switch (t.params.feature) {
            ...
            case 'connected-games':
                return (0, r.jsx)(s.l_, { to: eg.Z5c.SETTINGS('content-and-social', 'connected-games') });
            default:
...
function eY(e) {
    ...
    i.useLayoutEffect(() => {
        if (E) {
            ...
            Number.isNaN(t) && (t = ep.qO), (t = Math.min(Math.max(t, ep.li), ep.zx)), !E && t <= ep.p8 && (t = ep.qO), eW(t);
            let n = (e) => {
    ...
    let I = i.useRef(null),
        C = i.useCallback(
            (e, t) => {
                ...
                let i = t - e;
                null == (n = I.current) || n.style.setProperty('--custom-overdrag', ''.concat(1 + Math.min(Math.abs(i / ep.p8), 0.25))), E && (T.useAppSidebarState.setState({ isOpen: !r }), r && eW(ep.p8));
            },
            [E]
        ),
        S = i.useCallback(() => {
            ...
            (0, r.jsxs)('div', {
                ...
                children: [
                    ...
                    !o &&
                        (0, r.jsxs)(r.Fragment, {
                            children: [
                                (0, r.jsx)(Z, eI(ey({}, x), { children: (0, r.jsx)(ex, {}) })),
                                O
                                    ? (0, r.jsx)(f.P3F, {
                                          onClick: j,
...
function eK() {
    ...
    let t = (0, p.e7)([er.ZP], () => er.ZP.hasNotice()),
        ...
        E = (0, A.TH)('AppView'),
        y = _ ? 'div' : i.Fragment,
        C = (0, T.useAppSidebarState)((e) => !e.isOpen),
        N = (0, p.e7)([v.Z], () => v.Z.isFullscreenInContext()),
        P = _
            ? {
                  className: eO.page,
                  'data-collapsed': !!E && C
