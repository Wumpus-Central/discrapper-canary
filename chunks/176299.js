...
let ex = (0, u.Un)({
    ...
    eG = i.memo(function () {
        ...
        return window.location.pathname.startsWith(eC.Z5c.CHANNEL(eC.STv))
    ...
    eH = () => (0, r.jsx)(w.Z, {}),
    eB = (e) => (null != e.match.params.channelId ? eV(e) : (0, r.jsx)(Q.Z, {})),
    eF = (e) => {
        let { match: t } = e;
...
function e3(e) {
    ...
    (i.useLayoutEffect(() => {
        if (O) {
            ...
            (Number.isNaN(t) && (t = ey.qO), (t = Math.min(Math.max(t, ey.li), ey.zx)), !O && t <= ey.p8 && (t = ey.qO), e1(t));
            let n = (e) => {
    ...
    let y = i.useRef(null),
        v = i.useCallback(
            (e, t) => {
                ...
                let i = t - e;
                (null == (n = y.current) || n.style.setProperty('--custom-overdrag', ''.concat(1 + Math.min(Math.abs(i / ey.p8), 0.25))), O && (T.useAppSidebarState.setState({ isOpen: !r }), r && e1(ey.p8)));
            },
            [O]
        ),
        C = i.useCallback(() => {
                                    ...
                                    children: [
                                        (0, r.jsxs)(s.rs, {
                                            children: [
                                                ...
                                                f === q.jP.SIDEBAR &&
                                                    (0, r.jsx)(v.Z, {
                                                        path: eC.Z5c.CHANNEL(eC.STv, el.Hw.channelId({ optional: !0 }), ':messageId?'),
                                                        render: eB,
                                                        disableTrack: !0
                                                    }),
                                                (0, r.jsx)(v.Z, {
