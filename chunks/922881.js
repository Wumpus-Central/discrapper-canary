...
function eL(e) {
    let { product: t, user: n, activeBundleSlide: i } = e,
        ...
        A = o?.type === L.R.PROFILE_FRAME ? o : p,
        N = o?.type === L.R.NAMEPLATE ? o : f;
    if (d === L.R.NAMEPLATE && null != N)
        return (0, r.jsx)("div", {
            className: ej.Zj,
            children: (0, r.jsx)(eT, { user: n, nameplate: N, avatarDecoration: R }),
        });
    return (0, r.jsx)("div", {
...
function e0(e) {
    let t,
        n,
        { productRecord: i, selectedProduct: s, selectedBundleSlide: l } = e,
        a = (0, eK.Do)("CollectiblesShopProductDetailsModal") && s.type === L.R.PROFILE_FRAME,
        c = null == (t = (0, eW.A)(j.FYj)) || (0, I.G0)(s) || (0, k.Ab)(s) ? null : t,
        o = i.type === L.R.BUNDLE ? (i.items[l] ?? i.items[0]) : void 0,
        u =
            null != o &&
            !i.hideBadge &&
            null == i.badgeOverride &&
            (0, k.JQ)({ skuId: o.skuId, type: o.type, items: [o] });
    return (
        (n = a
            ? (0, r.jsx)(e$.A, { location: "CollectiblesShopProductDetailsModal" })
            : u
              ? (0, r.jsx)(eX.s, {})
              : (0, r.jsx)(eX.A, { skuId: i.skuId })),
        (0, r.jsxs)("div", { className: eQ.N, children: [n, null != c && (0, r.jsx)(eJ, { promotion: c })] })
    );
}
var e1 = n(462887),
    e2 = n(821609),
...
function tg(e) {
    ...
    return (0, r.jsxs)("div", {
        className: B()(tN.kG, l),
        children: [
            c ? null : (0, r.jsx)(tv, { price: h, className: tN.q9 }),
            (0, r.jsx)(tA.x, {
...
function tH(e) {
    let {
        ...
        T = (0, tr.h)(n),
        { isPurchased: O, isPartiallyOwnedBundle: b } = (0, tr.h)(i),
        ...
        K = (0, tS.V_)(n),
        W = null != K,
        $ = (0, ti.W)("CollectiblesShopProductDetailsModal"),
        X = c === w.G2.ORBS && a ? tf.Hi.ORBS : $ ? tf.Hi.FIAT : void 0,
        { checkoutEligiblePrices: Y, hasSufficientOrbs: q } = (0, tD.F)({
            product: i,
            hasShopDiscount: k,
            hasDiscountOffer: W,
        ...
        J = (0, ts.A)({ location: "CollectiblesShopProductDetailsModal", product: i }),
        Q = s.useMemo(() => Y.some((e) => e.currency === tL.Yr.DISCORD_ORB), [Y]);
    ...
    return (
        ...
        (0, r.jsxs)("div", {
            ...
            children: [
                ...
                A && g > 1 && (0, r.jsx)(ni, { goPrev: O, goNext: b }),
                (0, r.jsxs)("div", {
                    className: nr.VG,
                    children: [
                        (0, r.jsx)(t6.R, {
