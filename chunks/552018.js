...
class g extends a.C {
    ...
    internalBinaryRead(e, t, n, i) {
        ...
        for (; e.pos < a; ) {
            let [t, i] = e.tag();
            if (1 === t)
                if (i === r.TD.LengthDelimited) for (let t = e.int32() + e.pos; e.pos < t; ) o.guildIds.push(e.fixed64().toString());
...
class b extends a.C {
    ...
    internalBinaryRead(e, t, n, i) {
        ...
        for (; e.pos < a; ) {
            let [t, i] = e.tag();
            if (1 === t)
                if (i === r.TD.LengthDelimited) for (let t = e.int32() + e.pos; e.pos < t; ) o.userIds.push(e.fixed64().toString());
