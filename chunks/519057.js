...
let ez = {
    ...
    [eD.kqX.NO_INPUT_DETECTED]: { predicate: () => C.A.hasActiveErrorOfType(p.iy.NO_AUDIO_INPUT_DETECTED) },
    [eD.kqX.NO_INPUT_DEVICES_DETECTED]: { predicate: () => C.A.hasActiveErrorOfType(p.iy.NO_INPUT_DEVICES) },
    [eD.kqX.HARDWARE_MUTE]: {
        predicate: () =>
            eo.A.isConnected() &&
    ...
    [eD.kqX.PREMIUM_MISSING_PAYMENT]: {
        predicate: (e) => {
            let { premiumSubscription: t, currentUser: n } = e,
                ...
                a = null != t && r()(t.currentPeriodEnd).isBefore(r()()),
                l = ep.A.applicationIdsFetched.has(eU.tv),
    ...
    [eD.kqX.RIOT_CONNECTION_DEPRECATION_ADMIN]: {
        predicate: (e) => {
            ...
            let i = null != n ? ei.A.getGuild(n) : null,
                r = (0, ef.$3)({ permission: eD.xBc.ADMINISTRATOR, user: t, context: i }),
...
class e$ extends a.Ay.Store {
    ...
    initialize() {
        this.syncWith(
            [C.A, eE.Ay, el.A, ee.A, eu.A, k.A, eg.A, z.default, $.A, q.A, O.A, F.A, W.A, h.Ay, Y.A, C.A, I.A],
            eQ,
        ),
            this.waitFor(
                C.A,
