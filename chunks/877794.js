...
function h(t) {
    let { text: e = "", target: n } = t,
        ...
        m = a.useRef(g(p({}, t), { spellcheckEnabled: h }));
    m.current = g(p({}, t), { spellcheckEnabled: h });
    let S = a.useRef(!1),
        [j, T] = a.useState(!1),
        [E, x] = a.useState([]),
        C = a.useCallback(() => {
        ...
        O = a.useCallback(() => {
            if ((0, i.k)(n, HTMLInputElement) || (0, i.k)(n, HTMLTextAreaElement)) {
                  ...
                  children: [
                      j
                          ? (0, l.jsx)(s.sNh, {
                                ...
                                label: f.intl.string(f.t.HJmG1N),
                                action: () => {
                                    (0, o.D0)(e), O();
                                },
                            })
                      ...
                      y &&
                          (0, l.jsx)(s.sNh, {
                              ...
                              label: f.intl.string(f.t.xXqIX1),
                              action: () => {
                                  (0, o.lE)(e), O();
                              },
                          }),
                      (0, l.jsx)(s.S89, {
                          id: "spellcheck",
                          label: f.intl.string(f.t.TKkotb),
                          checked: h,
                          action: () => {
                              (0, o.kY)(), O();
                          },
                      ...
                      h
                          ? (0, l.jsx)(s.sNh, {
                                id: "languages",
                                label: f.intl.string(f.t.OlOHDA),
