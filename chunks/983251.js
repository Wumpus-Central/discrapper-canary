...
function t8(e) {
    ...
    return (
        ...
        (0, r.jsxs)("div", {
            className: G()(t6.i1, (0, z.EZ)(l.skuId) ? t6.bF : l.type === S.R.AVATAR_DECORATION ? t6.Jq : t6.eF),
            ...
            children: [
                ...
                N && f > 1 && (0, r.jsx)(t3, { goPrev: _, goNext: C }),
                (0, r.jsxs)("div", {
                    className: t6.VG,
                    children: [
                        (0, r.jsx)(t$.R, {
        ...
        let eo = {
                ...
                pendingAvatarSrc:
                    void 0 !== z.pendingAvatar
                        ? (0, h.sv)((0, v.V7)({ userId: V.id, image: z.pendingAvatar, size: t4 }), null, V, {
                              size: t4,
                          })
                        : void 0,
            },
