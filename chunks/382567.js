...
let er = function (e) {
    ...
    switch (t.badgeType) {
        case es.Xi.NEW:
            return (0, i.jsx)(ei.E, { type: "new", variant: "brand" });
        case es.Xi.STRONGLY_DISCOURAGED_CUSTOM:
...
function ex(e) {
    let t,
        ...
        m = L.A.useField("currentCategoryKey"),
        [h, g] = s.useState(a);
    s.useLayoutEffect(() => {
        a && g(!0);
    }, [a]);
    ...
    return (
        ...
        s.useEffect(() => {
            if (!c) return;
            let e = ee.A.getPanelScrollerNode();
            if (null == e) return;
                ...
                (t.current = new IntersectionObserver(
                    function (t) {
                        if (
                            ...
                            !ee.A.getIsSidebarCategoryAutoSelectEnabled())
                        )
                            return;
                        let i = [];
                        if (
                        ...
                        L.A.getField("currentCategoryKey") !== l && L.A.setState({ currentCategoryKey: l });
                    },
    ...
    let { index: t, activeKey: n, categories: r, visibleContent: l, dismissibleBadges: a, onMount: c } = e,
        {
            ...
            let t = em.Xi.useSetting(),
                ...
                a = s.useRef(t),
                c = s.useRef(e),
                [o, u] = (0, ed.z)(() => ({ y: 0, height: 0, config: { mass: 0.1, friction: 20, tension: 300 } }));
            return (
                s.useLayoutEffect(() => {
                    let s = a.current !== t;
                    function d() {
        ...
        (0, i.jsxs)("div", {
            ...
            children: [
                (0, i.jsx)("div", {
                    ...
                    "aria-hidden": "true",
                    ref: u,
                    children: (0, i.jsx)(ec.animated.div, {
                        className: I()(eh.FF, { [eh.R]: null == n }),
                        style: m,
                        ref: o,
                    }),
                }),
                (0, i.jsx)("div", { className: eh.gu, "aria-hidden": "true", ref: d }),
                r.map((e) => {
                    let t = et(e.key, l, a);
                    return (0, i.jsx)(
                        eg,
...
function eT(e) {
    let {
        ...
        h = L.A.useField("currentPanelKey"),
    ...
    let C = s.useMemo(() => ({ visibleDirectory: x, accessibleDirectory: f }), [x, f]),
        ...
        P = N ? void 0 : (T ?? A),
        w = P?.useTitle() ?? K.intl.string(K.t["3D5yo/"]);
...
function eJ() {
    let e = (0, eY.GV)(),
        ...
        n = "607800",
        s = "70e72b2bfb333d65d00013949872de5479512db8".substring(0, 7),
        r = eV.A?.app.getVersion(),
        l = eV.A?.app.getBuildNumber(),
        c = eV.A?.app.getAppArch(),
        o = eX.A.getCurrentBuildOverride().overrides?.discord_web,
        u = null != o ? (0, eq.A)("1788545173540", !1) : null,
        d = null != u ? ` (built ${u})` : "",
        m = (function () {
...
function e1(e) {
    ...
    return (0, i.jsx)(eB.W, {
        ...
        children: (0, i.jsxs)(eO.rX, {
            children: [
                (0, i.jsx)(eO.Dr, { id: "changelog", label: K.intl.string(K.t.LRmNAl), action: () => (0, eU.j)(!0) }),
                (0, i.jsx)(eO.Dr, {
                    id: "acknowledgements",
                    label: K.intl.string(K.t["0nUKy3"]),
                    action: () => (0, eF.A)(ew.X7G.ACKNOWLEDGEMENTS),
                }),
                (0, i.jsx)(eO.Dr, {
                    id: "support",
...
let e3 = new Set([e_.X.PROFILE_PANEL, e_.X.SUBSCRIPTIONS_PANEL, e_.X.FAMILY_CENTER_PANEL, e_.X.POGGERMODE_PANEL]),
    e4 = new Map([[e_.X.SESSIONS_PANEL, r.ImpressionNames.USER_SETTINGS_SESSIONS]]);
function e6(e) {
    let { target: t, ...n } = e,
