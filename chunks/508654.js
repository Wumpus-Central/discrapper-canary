"use strict";
n.d(t, { Ay: () => g, BP: () => S, Qs: () => A, RO: () => y, WG: () => T, ob: () => N, r2: () => C, vj: () => I });
var i = n(64700),
    r = n(17928),
    s = n(734057),
    a = n(71393),
    ...
    return (0, r.yK)([a.A, u.Ay, o.A, s.A], () => {
        ...
        return null == n
            ...
            : u.Ay.getGuildScheduledEventsByIndex(t ?? u.ej.GUILD_EVENT_UPCOMING(n.id)).filter((e) => {
                  ...
                  return o.A.can(E.xBc.VIEW_CHANNEL, n);
              });
    }, [t, e]);
}
function A(e) {
    return (0, r.bG)([u.Ay, s.A, o.A], () => {
        ...
        if (!o.A.can(E.xBc.VIEW_CHANNEL, t) || null == t?.guild_id) return null;
    ...
    let t = (0, r.yK)(
            ...
            () =>
                u.Ay.getGuildScheduledEventsByIndex(u.ej.GUILD_EVENT_UPCOMING(e)).filter((e) => {
                    ...
                    return o.A.can(E.xBc.VIEW_CHANNEL, t);
                }),
            [e],
        ),
        ...
        p =
            null != _ &&
            !_.features.has(E.GuildFeatures.COMMUNITY) &&
            _.features.has(E.GuildFeatures.INTERNAL_EMPLOYEE_ONLY);
    if (null != t && null != l && p)
    ...
    return (0, r.bG)(
        ...
        () =>
            u.Ay.getGuildScheduledEventsByIndex(u.ej.GUILD_EVENT_ACTIVE(e)).find((e) => {
                if (e.entity_type === f.Ps.NONE || !(0, u.Fd)(e)) return !1;
                if (null == e.channel_id) return !0;
                let t = s.A.getChannel(e.channel_id);
                return o.A.can(E.xBc.VIEW_CHANNEL, t);
            }),
        ...
        () =>
            s.filter((e) => {
                let { startTime: t, endTime: n } = (0, _.YR)(e),
                    { withinStartWindow: i, diffMinutes: r } = (0, h.CC)(t.toISOString(), n?.toISOString());
                return e.status !== f.XG.ACTIVE && i && r < 15;
            }),
        [s],
    );
}
