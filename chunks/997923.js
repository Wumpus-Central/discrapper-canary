...
var i = n(31144),
    ...
    h = n(868282),
    f = n(118116),
    g = ({ stream: e, manager: t, onOpenHelp: n }) => {
        let { t: r } = (0, i.n)(),
            l = (0, a.l)(null),
            d = (0, a.h)(() => {
                let e = l.current;
                ...
                let n = (function (e) {
                    ...
                    return n ? (n.drawImage(e, 0, 0), t.toDataURL("image/jpeg", 0.92).split(",")[1] ?? null) : null;
                })(e);
                if (!n) return;
                let i = new File(
                    [new Blob([Uint8Array.from(atob(n), (e) => e.charCodeAt(0))], { type: "image/jpeg" })],
                    "document.jpg",
                    { type: "image/jpeg" },
                );
                t.setFile(i, `data:image/jpeg;base64,${n}`);
            }, [t]);
        return (0, a.v)(c.u, {
            stream: e,
            videoRef: l,
    ...
    M = ({ progress: e, isFilePdf: t }) => {
        let { t: n } = (0, i.n)(),
            r = n(t ? "documentCapture.review.uploading" : "documentCapture.review.analyzing");
        return (0, a.v)(a.S, { children: [(0, a.v)(o.r, { size: 8 }), (0, a.v)(c.y, { progress: e, label: r })] });
    },
    b = ({ state: e, manager: t }) => {
        let { t: n } = (0, i.n)();
        if ("failure" === e.status)
            ...
            children: (0, a.v)("div", {
                ...
                children: [
                    (0, a.v)("div", {
                        ...
                        children: [
                            c ? (0, a.v)(V, { isFilePdf: r }) : null,
                            u ? (0, a.v)(M, { progress: e.progress, isFilePdf: r }) : null,
                            v ? (0, a.v)(D, {}) : null,
                        ],
                    }),
                    (0, a.v)("div", {
                        ...
                        children: [
                                  ...
                                  ? (0, a.v)("div", {
                                        ...
                                        children: (0, a.v)("img", {
                                            ...
                                            class: (0, o.n)(
                                                ...
                                                v && "IncodeDocumentCaptureSuccessBorder",
                                            ),
                            ...
                            (0, a.v)("div", {
                                ...
                                children: [
                                    ...
                                    (0, a.v)("span", { children: [" ", n("encryptionLabel.encryptedPhotos")] }),
                                ],
                            }),
                            (0, a.v)(o.r, { size: 8 }),
                        ],
                    ...
                    (0, a.v)("div", {
                        ...
                        children: [c ? (0, a.v)(w, { manager: t }) : null, s ? (0, a.v)(y, { manager: t }) : null],
                    }),
                ],
            }),
        });
...
var P = ({ manager: e, title: t, text: n, allowSkipDocumentCapture: l, captureMode: o, error: c, pageNumber: u }) => {
        let { t: p } = (0, i.n)(),
            C = (0, r.r)(),
            m = (0, a.l)(null),
            [v, h] = (0, a.p)(!1),
                    ...
                    children: [
                        ...
                        (0, a.v)("div", {
                            ...
                            children: (0, a.v)("div", {
                                ...
                                "aria-hidden": !0,
                                children: (0, a.v)(L, { class: "IncodeDocumentCaptureTutorialImage" }),
                            }),
                        }),
                        c
                            ? (0, a.v)("p", {
    ...
    k = ({ manager: e, nextPageType: t, captureMode: n }) => {
        let { t: l } = (0, i.n)(),
            c = (0, r.r)(),
            u = (0, a.l)(null),
            [p, C] = (0, a.p)(!1),
            m = "documentCapture.tutorial.multiPageDocument",
            v = l("optional" === t ? `${m}.optionalPage.subtitle` : `${m}.subtitle`),
            h = "camera" === n && c,
            f = (0, a.h)(() => C(!1), []),
            g = () => {
                u.current?.click();
            ...
            H = async (t) => {
                ...
                if (i) {
                    f();
                    let t = await Z(i);
                    e.captureNextPageFromFile(), e.setFile(i, t);
                }
                n.value = "";
            };
        return (0, a.v)(a.S, {
    ...
    R = ({ config: e, onFinish: t, onError: n }) => {
        let [l, o] = (0, r.o)(() => (0, f.D)({ config: e })),
            [d, c] = (0, a.p)(!1),
            { t: u } = (0, i.n)();
        return (
            (0, a._)(() => {
                "finished" === l.status && t?.(), "closed" === l.status && n?.(void 0);
            }, [l.status, t, n]),
            "tutorial" === l.status
                ? (0, a.v)(P, {
                      manager: o,
                ...
                : "nextPage" === l.status
                  ? (0, a.v)(k, { manager: o, nextPageType: l.nextPageType, captureMode: l.captureMode })
                    ...
                    : "initializingCamera" === l.status
                      ...
                      : "capturing" === l.status && "camera" === l.captureMode
                        ? l.stream
                            ? (0, a.v)(a.S, {
                                  children: [
                                      (0, a.v)(g, { stream: l.stream, manager: o, onOpenHelp: () => c(!0) }),
                                      d ? (0, a.v)(I, { onClose: () => c(!1) }) : null,
                                  ],
                              })
                            : (0, a.v)(x, {})
                        : "finalizing" === l.status
                          ? (0, a.v)(x, { title: u("common.processing") })
                          : "preview" === l.status ||
                              "uploading" === l.status ||
                              "success" === l.status ||
                              "failure" === l.status
                            ? (0, a.v)(b, { state: l, manager: o })
                            : null
        );
    },
    F = ({ config: e, onFinish: t, onError: n }) =>
        (0, a.v)(l.t, { children: e ? (0, a.v)(R, { config: e, onFinish: t, onError: n }) : null });
(0, h.t)(F, "incode-document-capture");
