...
function tf() {
    ...
    let n = (0, d.e7)([ez.default], () => ez.default.getCurrentUser()),
        ...
        [et, en] = (0, H.b)(),
        er = q.JH.useExperiment({ location: "Account" }).enabled,
    ...
    let ef = (0, K.Y)({ location: "AccountConnected" }),
        { shouldShowTooltip: eg, dismissTooltip: eb } = tx(tn.h7.AUDIO_INPUT),
                ...
                tl(
                    {
                        ref: x,
                        tooltipText: t,
                        tooltipColor: b ? f.FGA.GREEN : void 0,
                        tooltipForceOpen: b,
