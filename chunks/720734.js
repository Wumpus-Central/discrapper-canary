    ...
    constructor(...e) {
        (super(...e),
            ...
            e7(this, 'handleOpenSettings', function () {
                let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : (0, eQ.Q)('Account').jumpToVoice && ew.Z.isConnected() ? e1.oAB.VOICE : e1.oAB.ACCOUNT,
...
function tl() {
    ...
    return (
        !A && (L && X.settings.push(u.z.PER_GUILD_COLLECTIBLES_CUSTOMIZATION_COACHMARK), M && X.avatar.push(u.z.PREMIUM_SUBSCRIPTION_APRIL_MARKETING_DECO_TOOLTIP), U && X.avatar.push(u.z.EXPIRING_STATUS_COACHMARK), F && X.avatar.push(u.z.DISPLAY_NAME_STYLES_COACHMARK)),
        (0, i.jsx)(N.Gt, {
            value: H,
            children: (0, i.jsx)(ts, {
                currentUser: t,
