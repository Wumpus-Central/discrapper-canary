                      ...
                      (0, i.jsxs)(
                          ...
                          e7(
                              ...
                              ),
                              {
                                  ...
                                  className: l()(e2.avatarWrapper, !g && h && e2.experiment, { [e2.plated]: null != u }),
                                  children: [
                                      (0, i.jsx)(e9, {
                                      ...
                                      (0, i.jsx)('div', {
                                          className: l()(e2.nameTag, { [e2.canCopy]: ez.wS }),
                                          children: d()
                                      })
                                  ]
                              }
...
class tr extends r.PureComponent {
        ...
        return null != d
            ...
            : null != s && s !== e1.Skl.UNKNOWN && r.isPomelo()
              ? (0, i.jsx)(y.Z, {
                    hoverText: l,
                    forceHover: e,
                    children: (0, i.jsx)(I.Z, { text: eX.ZP.humanizeStatus(s) })
                })
              : l;
    }
    ...
    constructor(...e) {
        super(...e),
            ...
            e5(this, 'audioOnInteractionHandler', (0, V.u)('AudioDeviceMenu', A.Z.ACCOUNT)),
...
function tl() {
    ...
    let $ = (0, o.e7)([eb.Z], () => eb.Z.hasHadOtherUserPlaySoundInSession()),
        ...
        el = (0, ep.Ws)({ location: e8.dr.CONFLICT_CHECKS }),
...
function to(e) {
    let { selfMute: t, serverMute: n, suppress: s, awaitingRemote: c, tooltipText: d, tooltipColor: u, tooltipForceOpen: g, iconForeground: b, onMouseEnter: _, onMouseLeave: x, onClick: E, onContextMenu: j, nameplate: C, accountContainerRef: O } = e,
        ...
        v = r.useRef(null),
        T = r.useRef(null),
        N = (0, m.O)(S ? 'unmute' : 'mute'),
        I = (0, p.P)(S ? 'unmute' : 'mute'),
        { activeVoice: y } = (0, eI.o)(),
        R = null != y,
        D = (0, eN.z)(y),
        Z = (0, o.e7)([eL.Z], () => eL.Z.isConnected()),
        { Component: w, events: k, play: M } = R ? I : N,
        B = n || s ? f.v0G : w,
