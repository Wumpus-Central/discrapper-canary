...
let ek = ex.ZP.getEnableHardwareAcceleration() ? _.Xo$ : _.qEK,
    eM = 2 * eS.Z.Millis.MINUTE,
            ...
            : (0, i.jsxs)(i.Fragment, {
                  children: [
                      (0, i.jsx)('div', {
                          ...
                          children: (0, i.jsx)(eP.Z, { children: eb.ZP.getName(e) })
                      }),
                      (0, i.jsx)('div', {
    ...
    constructor(...e) {
        super(...e),
            ...
            ew(this, 'handleToggleSelfMute', () => {
                ...
                (0, M.Z)(e, t, eO.jXE.ACCOUNT_PANEL);
            }),
            ew(this, 'handleToggleSelfDeaf', () => {
                let { serverDeaf: e } = this.props;
                (0, k.Z)(e, eO.jXE.ACCOUNT_PANEL);
            }),
...
function eV() {
    ...
    let Y = (0, o.e7)([et.Z], () => et.Z.hasHadOtherUserPlaySoundInSession()),
        ...
        { analyticsLocations: $ } = (0, L.ZP)(x.Z.ACCOUNT),
        ee = {
            avatar: [],
            settings: []
        };
    return (
        !D && (Q && ee.settings.push(c.z.PROFILE_THEMES_FEATURE_EDUCATION_TOOLTIP_TAKE_2), M && (1 === U ? ee.settings.push(c.z.USER_SAFETY_CONSUMER_EDUCATION_MUTE) : ee.settings.push(c.z.USER_SAFETY_CONSUMER_EDUCATION_BLOCK)), Y && ee.settings.push(c.z.SOUNDBOARD_VOLUME_EDUCATION), G && ee.settings.push(c.z.PER_GUILD_COLLECTIBLES_CUSTOMIZATION_COACHMARK), B && ee.avatar.push(c.z.PREMIUM_SUBSCRIPTION_APRIL_MARKETING_DECO_TOOLTIP)),
        (0, i.jsx)(L.Gt, {
            value: $,
            children: (0, i.jsx)(eB, {
                currentUser: t,
...
function eF(e) {
    let { selfMute: t, serverMute: n, suppress: r, awaitingRemote: a, tooltipText: o, tooltipColor: c, tooltipForceOpen: d, onMouseEnter: u, onMouseLeave: p, onClick: f, onContextMenu: E } = e,
        ...
        j = (0, eo.H)(x.Z.AUDIO_INPUT_BUTTON);
    l.useEffect(() => () => b(), [C, b]);
    let D = l.useCallback(
            (e) => {
                E(e, R);
...
function ez(e) {
    let { selfDeaf: t, serverDeaf: n, awaitingRemote: r, onClick: s, onContextMenu: o } = e,
        ...
        g = n ? _.Vm4 : d,
        { analyticsLocations: f } = (0, L.ZP)(x.Z.AUDIO_OUTPUT_BUTTON);
    l.useEffect(() => () => h(), [c, h]);
    let E = l.useCallback(
        (e) => {
            o(e, f);
