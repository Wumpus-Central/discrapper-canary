...
let tc = e3.ZP.getEnableHardwareAcceleration() ? g.Xo$ : g.qEK,
        ...
        return null != c
            ...
            : null != r && r !== te.Skl.UNKNOWN && l.hasUniqueUsername()
              ? (0, a.jsx)(O.Z, {
                    hoverText: i,
                    forceHover: e,
                    children: (0, a.jsx)(E.Z, { text: e4.ZP.humanizeStatus(r) }),
                })
              : i;
    }
...
function tg(e) {
    let { shouldShowDeviceChangedNotifications: t } = (0, e7.P)({
