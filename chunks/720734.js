...
function eO(e) {
    let { speaking: t, streaming: n, currentUser: r, status: l, handleMouseLeave: s, renderNameTag: o } = e,
        c = (0, M.Q3)('RTC Avatar'),
        d = (0, S.Z)(null == r ? void 0 : r.avatarDecoration),
        u = (0, ep.NZ)({
            avatarDecoration: d,
        ...
        super(...e),
            ...
            ex(this, 'handleCopyTag', () => {
                ...
                (0, eg.JG)(
                    ...
                    em.default.track(eS.rMx.TEXT_COPIED, { type: 'User Tag' });
                let i = {
...
function ej() {
    ...
    let t = (0, s.e7)([eu.default], () => eu.default.getCurrentUser()),
        ...
        { streaming: a, status: c } = (0, s.cj)([ec.Z], () => ({
            streaming: null != ec.Z.findActivity((e) => e.type === eS.IIU.STREAMING),
        ...
        X = (function () {
            let e = (0, w.wE)(o.z.PROFILE_THEMES_FEATURE_EDUCATION_TOOLTIP_TAKE_2),
                ...
                c = r.useMemo(() => {
                    ...
                    return null != l && (l.status === eS.O0b.ACTIVE || e - l.currentPeriodEnd.getTime() < eP);
                }, [l]);
            return (
                r.useEffect(() => {
                    (async () => {
...
function eM(e) {
    let { selfMute: t, serverMute: n, suppress: l, awaitingRemote: a, tooltipText: s, tooltipColor: o, tooltipForceOpen: c, onMouseEnter: d, onMouseLeave: h, onClick: p, onContextMenu: g } = e,
        ...
        S = null != s ? s : (0, L.Z)(t, n, l, a, v === et.BK.GroupedButtonsRedMic),
        { analyticsLocations: b } = (0, T.ZP)(N.Z.AUDIO_INPUT_BUTTON);
    r.useEffect(() => () => E(), [f, E]);
    let A = r.useCallback(
        (e) => {
            g(e, b);
