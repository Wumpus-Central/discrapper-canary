...
let te = eJ.ZP.getEnableHardwareAcceleration() ? f.Xo$ : f.qEK,
    tt = 2 * eK.Z.Millis.MINUTE,
    tn = 3 * eK.Z.Millis.SECOND,
    ti = 30 * eK.Z.Millis.DAY;
function tr(e) {
    let { ref: t, speaking: n, streaming: s, currentUser: a, status: o, handleClick: c, handleMouseLeave: d, renderNameTag: u, nameplate: m, 'data-jump-section': g } = e,
        ...
        h = null != t ? t : p,
        b = (0, X.Q3)('RTC Avatar'),
        { coloredIconsEnabled: _ } = (0, eS.Z)({ location: 'RTC Avatar' }),
                      ...
                      (0, i.jsxs)(
                          ...
                          e9(
                              ...
                              ),
                              {
                                  ...
                                  className: l()(e5.avatarWrapper, !b && _ && e5.experiment, { [e5.plated]: null != m }),
                                  children: [
                                      (0, i.jsx)(te, {
                                      ...
                                      (0, i.jsx)('div', {
                                          className: l()(e5.nameTag, { [e5.canCopy]: eW.wS }),
                                          children: u()
                                      })
                                  ]
                              }
...
class ts extends r.PureComponent {
    ...
    renderStatus() {
        ...
        if (
            ...
            return (0, i.jsx)(y.Z, {
                ...
                children: (0, i.jsx)(I.Z, {
                    ...
                    applicationStream: n,
                    voiceChannel: a ? o : void 0,
                    textClassName: e5.activityStatusText,
                    hideTooltip: !0,
                    disableTextScroll: !0
                })
            });
        ...
        return null != u
            ...
            : null != s && s !== e3.Skl.UNKNOWN && r.isPomelo()
              ? (0, i.jsx)(y.Z, {
                    hoverText: l,
                    forceHover: e,
                      ...
                      (0, i.jsxs)(i.Fragment, {
                          children: [
                              (0, i.jsxs)('div', {
                                  ...
                                  className: l()(e5.container, {
                                      [e5.containerRtcOpened]: null != n,
                                      [e5.containerQuestBarVisible]: !r
                                  }),
    ...
    constructor(...e) {
        super(...e),
            ...
            e4(this, 'avatarWithPopoutRef', r.createRef()),
            e4(this, 'handleToggleSelfMute', () => {
                let { serverMute: e, suppress: t, selfMute: n } = this.props;
                (0, U.Z)(e, t, e3.jXE.ACCOUNT_PANEL), (0, V.v)(A.Z.ACCOUNT, V.d.MIC, n);
            }),
            ...
            e4(this, 'handleOpenSettings', function () {
                let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : e3.oAB.ACCOUNT,
            ...
            e4(this, 'audioOnInteractionHandler', (0, G.u)('AudioDeviceMenu', A.Z.ACCOUNT)),
            ...
            e4(this, 'handleCopyTag', () => {
                ...
                (0, eW.JG)(
                    ...
                    eH.default.track(e3.rMx.TEXT_COPIED, { type: 'User Tag' });
                let i = {
            ...
            e4(this, 'handleSpeakingWhileMutedChanged', () => {
                let { selfMute: e, serverMute: t, suppress: n, speakingWhileMuted: i, occluded: r } = this.props,
                    ...
                    l = void 0 === this.lastSpeakingWhileMutedNotificationTime || Date.now() - this.lastSpeakingWhileMutedNotificationTime > tt;
                i
                    ? s ||
                      !e ||
                      t ||
            ...
            e4(this, 'renderNameTag', () => {
                ...
                return null == e
                    ...
                    : (0, i.jsxs)(i.Fragment, {
                          children: [
                              (0, i.jsx)('div', {
                                  className: e5.panelTitleContainer,
                                  children: (0, i.jsx)(e1.Z, { children: eQ.ZP.getName(e) })
                              }),
                              (0, i.jsx)('div', {
                                  className: e5.panelSubtextContainer,
    ...
    return (0, i.jsxs)('div', {
        ...
        children: [
            (0, i.jsx)(tc, {
                ...
                onClick: p,
                onContextMenu: h,
                iconForeground: null != C ? e5.iconForeground : void 0,
                nameplate: C
            }),
            (0, i.jsx)(td, {
                selfDeaf: t,
...
function ta() {
    var e;
    let t = (0, o.e7)([eG.default], () => eG.default.getCurrentUser()),
        n = (0, o.e7)([eZ.default], () => eZ.default.getId()),
        {
            activities: s,
            streaming: l,
            status: a
        ...
        { mute: h, selfMute: _, suppress: x } = (0, eT.Z)(p),
        { selfDeaf: E, deaf: S } = (0, ev.Z)(p),
        T = (0, o.e7)([Z.C], () => {
            var e;
            return (0, w.fD)() ? (null == (e = Z.C.getCurrentBuildOverride().overrides) ? void 0 : e.discord_web) : null;
        }),
        I = (0, o.e7)([eF.ZP], () => eF.ZP.getPremiumTypeSubscription()),
        N = (0, o.e7)([eL.Z], () => eL.Z.getSpeakingWhileMuted()),
        ...
        F = (null == t || null == (e = t.avatarDecoration) ? void 0 : e.skuId) === e8.rL,
        { voiceActivityStatusEnabled: H } = (0, v.U)({ location: 'Account' }),
        { simplifiedSettingsEnabled: Y } = (0, eS.Z)({ location: 'Account' }),
        K = (0, ei.m)(),
    ...
    let er = (0, o.e7)([e_.Z], () => e_.Z.hasHadOtherUserPlaySoundInSession()),
        es = (function () {
            let e = (0, Q.wE)(c.z.PROFILE_THEMES_FEATURE_EDUCATION_TOOLTIP_TAKE_2),
                ...
                [i, s] = (0, o.Wu)([eF.ZP], () => [eF.ZP.hasFetchedMostRecentPremiumTypeSubscription(), eF.ZP.getMostRecentPremiumTypeSubscription()]),
                { enabled: l } = em.Z.useExperiment({ location: '08bd40_1' }, { autoTrackExposure: !0 }),
                a = r.useMemo(() => {
                    let e = new Date().getTime();
                    return null != s && (s.status === e3.O0b.ACTIVE || e - s.currentPeriodEnd.getTime() < ti);
                }, [s]);
            return (
                r.useEffect(() => {
                    (async () => {
        ...
        ec = (0, ep.Ws)({ location: e6.dr.CONFLICT_CHECKS }),
...
function tc(e) {
    let { selfMute: t, serverMute: n, suppress: s, awaitingRemote: c, tooltipText: d, tooltipColor: u, tooltipForceOpen: p, iconForeground: b, onMouseEnter: _, onMouseLeave: x, onClick: E, onContextMenu: C, nameplate: j, accountContainerRef: O } = e,
        ...
        { activeVoice: y } = (0, ey.o)(),
        R = null != y,
        D = (0, eN.z)(y),
        Z = (0, o.e7)([eB.Z], () => eB.Z.isConnected()),
        { Component: w, events: k, play: L } = R ? N : I,
        M = n || s ? f.v0G : w,
        { mode: U } = (0, eO.ZP)({ location: 'RTC Microphone Button' }),
        { coloredIconsEnabled: V } = (0, eS.Z)({ location: 'RTC Microphone Button' }),
            ...
            children: (0, i.jsxs)('div', {
                ...
                children: [
                    (0, i.jsx)(e$.Z, {
                        ...
                        onContextMenu: z,
                        role: 'switch',
                        className: l()({ [e5.micButtonWithMenu]: H }),
                        redGlow: S && V,
                                                ...
                                                e7(
                                                    {
                                                        ...
                                                        role: 'button',
                                                        className: l()([e5.buttonChevron], { [e5.redGlow]: S && V }),
                                                        redGlow: S && V,
...
function td(e) {
    let { selfDeaf: t, serverDeaf: n, awaitingRemote: s, onClick: a, onContextMenu: o, iconForeground: c, nameplate: d } = e,
        ...
        _ = n ? f.Vm4 : g,
        { coloredIconsEnabled: x } = (0, eS.Z)({ location: 'RTC Microphone Button' }),
