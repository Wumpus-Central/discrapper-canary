l.r(t),
    l.d(t, {
        nitroCollection: () => aF,
        virtualCurrencyCollection: () => aW,
        playgroundConfig: () => aY,
        identityCollection: () => az,
        RevenuePlaygroundCollectionId: () => aG,
        paymentsCollection: () => a$,
    });
var a,
    n = l(700623),
    i = l(318254),
    ...
    stories: [
        {
            ...
            component: function () {
                let [e, t] = u.useState(ek.pe.TIER_2),
                    ...
                    [b, h] = u.useState(""),
                    [x, g] = u.useState({ plan_id: ek.gD.PREMIUM_MONTH_TIER_2, gift: "true" }),
                            ...
                            children: [
                                ...
                                (0, s.jsx)(G.$, {
                                    ...
                                    onClick: () =>
                                        ...
                                        (0, eA.U9)({ discount: null }, ek.pe.TIER_2)),
                                }),
                            ],
                        }),
                    ],
...
let tM = { none: void 0, nitroWheel: r.t },
    tN = {
        ...
        component: function (e) {
            ...
            function f() {
                return (0, tT.P0)((0, tA.o)("CTA clicked!", tI.Ck.SUCCESS));
            }
            let g = tM[d],
                v =
                    "descriptionCta" === a
                ...
                return (0, s.jsxs)("div", {
                    ...
                    children: [
                        (0, s.jsx)(tO.S, {
                            ...
                            onCtaClick: () => (0, tT.P0)((0, tA.o)("CTA Clicked!", tI.Ck.SUCCESS)),
                        }),
                        (0, s.jsx)(tU, {}),
                    ],
                });
    ...
    let g = u.useMemo(
        () =>
            Object.values(b).map((e) => {
                ...
                if (e.type === tJ.he.CARD && "last4" in e) {
                    let t = e.last4 ?? "",
                        l = e.brand ?? "Unknown";
                    a += ` - ****${t} (${l})`;
...
function lE() {
    let [e, t] = u.useState(lv(lf)),
        [l, a] = u.useState(lf),
        [n, i] = u.useState(lv(lg)),
        [r, o] = u.useState(lg),
        [d, c] = u.useState(null),
        [p, m] = u.useState(
            (0, s.jsx)(tB.a8, {
    ...
    return (0, s.jsxs)("div", {
        children: [
            ...
            (0, s.jsx)(y.E, {
                variant: "text-md/normal",
                children: (0, s.jsx)(lh.A, { className: tZ.wD, children: `\`\` ${lv(l)} \`\`` }),
            }),
            (0, s.jsx)(y.E, {
                variant: "text-md/normal",
                className: tZ.cW,
            ...
            (0, s.jsx)(y.E, {
                variant: "text-md/normal",
                children: (0, s.jsx)(lh.A, { className: tZ.wD, children: `\`\` ${lv(r)} \`\`` }),
            }),
            p,
        ],
    });
            ...
            component: function (e) {
                let { isEligibleForTrial: t, onlyStripeCardEnabled: l, paymentRequestWalletsEnabled: a } = e,
                    n = {
                        ...
                        paymentSourceTypeRestrictions: l ? [tJ.he.CARD.valueOf()] : null,
                    };
                return (0, s.jsx)(j.M, {
                    stepConfigs: [],
                    skuIDs: [],
                    ...
                    children: (0, s.jsxs)(tB.wn, {
                        children: [
                            ...
                            (0, s.jsx)(tB.e_, {
                                className: tZ.Bt,
                                children: (0, s.jsx)("div", { className: tZ.VS, children: (0, s.jsx)(tX.A, { ...n }) }),
                            }),
                        ],
                    }),
                });
...
function lG() {
    let { elementsAppearanceOptions: e } = (0, lA.E)();
    return (0, s.jsxs)("div", {
        children: [
            (0, s.jsx)(ec.D, {
                variant: "heading-lg/semibold",
...
let l8 = {
    ...
    l7 = lJ.A.map((e) => ({ id: e.alpha2, value: e.alpha2, label: e.name })),
    l4 = {
        ...
        controls: {
            ...
            countryCode: { label: "Country Code", type: "select", defaultValue: lZ.d.US, options: l7 },
    ...
    at = {
        ...
        stories: [
            ...
            },
            {
                ...
                controls: {
                    storeCountry: { label: "Store Country", type: "select", defaultValue: lZ.d.US, options: l7 },
                },
            },
            {
...
function aA(e) {
    ...
    return (0, s.jsx)("div", {
        ...
        children: (0, s.jsx)(G.$, {
            ...
            onClick: function () {
                (0, aC.openUserProfileModal)({ userId: t, guildId: l, channelId: a, hideRestrictedProfile: !0 });
            },
        }),
    });
}
var aI = l(21280);
let aP = aa.Ay.getEnableHardwareAcceleration() ? z.Js : z.eu,
    a_ = Y._3.SIZE_96,
    aR = {
        "--custom-user-profile-banner-height": "120px",
        "--custom-user-profile-avatar-size": `${((0, Y.Kj))(a_).size}px`,
    };
function ak(e) {
    ...
    return (0, s.jsx)("div", { className: aI.H, children: (0, s.jsx)(aP, { ...i, ...r }) });
}
function aM(e) {
    let { userId: t, guildId: l, channelId: a } = e,
    ...
    return null == n
        ...
        : (0, s.jsxs)(aj, {
              ...
              children: [
                  (0, s.jsx)(ax, { user: n, displayProfile: i, guildId: l, bannerHeight: 120, avatarSize: a_ }),
                  (0, s.jsx)(ak, { user: n, displayProfile: i, guildId: l, channelId: a }),
                  (0, s.jsx)(ar.Ay, {
                      user: n,
                      guildId: r ?? void 0,
                  ...
                  (0, s.jsx)(aA, { userId: t, guildId: l, channelId: a }),
              ],
          });
}
var aN = l(734057),
...
function aU(e) {
    let { children: t } = e;
    return (0, s.jsx)("div", { className: aL.t, children: t });
}
let aB = "default";
var aG =
    (((a = {}).PAYMENTS = "payments"),
    ...
    (a.IDENTITY = "identity"),
    a);
let aH = ["Revenue Storybook", "Revenue Playground"],
    a$ = {
        id: "payments",
        name: "Payments",
        groups: [
            ...
            { title: "Checkout Review Step", stories: [eX, eJ] },
            lS,
        ],
        tags: aH,
        IconComponent: n.d,
    ...
    az = {
        ...
        groups: [
            ...
            { title: "Profile Banner", stories: [J] },
            lK,
            {
                ...
                stories: [
                    {
                        ...
                        component: function () {
                            let e,
                                ...
                                n =
                                    ((l = (0, ee.yK)([aV.Ay], () => aV.Ay.getFlattenedGuildIds())),
                                    u.useMemo(
                                        () =>
                                            l.reduce((e, t) => {
                                ...
                                p = u.useMemo(
                                    () => [
                                        ...
                                        { id: aB, label: "Default (main profile)", value: aB },
                                        ...n,
                                    ],
                                    [n],
                                ),
                                m = (0, ee.bG)(
                                    ...
                                    () =>
                                        null == c
                                            ? void 0
                                            : (aN.A.getDMFromUserId(c) ?? aN.A.getSortedPrivateChannels()[0]?.id),
                                    [c],
                                ),
                                b = o === aB || "dm" === o ? void 0 : o,
                                h = "dm" === o ? m : void 0;
                            return (0, s.jsxs)(ea.B, {
                                direction: "vertical",
                                gap: 16,
                                children: [
                                    (0, s.jsxs)(ea.B, {
                                        ...
                                        gap: 8,
                                        children: [
                                            (0, s.jsx)(aw, { label: "User", options: a, value: c, onChange: r }),
                                            (0, s.jsx)(aw, { label: "Context", options: p, value: o, onChange: d }),
                                        ],
                                    }),
                                    (0, s.jsx)(aU, {
                                        children: null != c && (0, s.jsx)(aM, { userId: c, guildId: b, channelId: h }),
                                    }),
                                ],
                            });
                        },
    ...
    aY = { playgroundBaseUrl: "revenue", collections: [a$, aW, aF, az] };
