...
let O = (e) => {
        let {
            ...
            S = r.useRef(null),
            O = (0, N.gm)() && null != t.loopDelay && t.loopDelay > 0 && h?.src != null;
        function R(e) {
            (0, N.gm)() && e !== m && g(e);
        }
        if (
            ...
            (p = Math.floor((a - t.start) / e)),
                a - t.start - p * e > t.duration &&
                    (n === o.l.ANIMATION_TYPE_INTERMITTENT && !l && null != c && p >= c && u(!0), (E = !1));
        }
        return E
            ? (R("layer"),
              (0, i.jsx)("img", {
    ...
    R = (e) => {
        ...
        return (
            r.useEffect(() => {
                null != E && (R(-D.current), P(!1), L.current || b());
            }, [E, b, L]),
            r.useEffect(() => {
                !0 === c || l || (v(), R(0)),
                    !l && w && L.current && (v(), R(0)),
            ...
            }, [l, w, T, s, v, b, L, h.animationType, c, _]),
            (0, i.jsx)("div", {
                ref: m,
