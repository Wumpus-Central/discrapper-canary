...
let p = 1e3 / 24,
    h = function (e) {
        let {
            ...
            T = l.useCallback(() => {
                (d.current = !1), cancelAnimationFrame(c.current), clearTimeout(A.current);
            }, []),
            h = l.useCallback(
                (r) => {
                    if (!d.current) return;
        ...
        return (
            ...
            (0, I.Ay)(() => ((c.current = requestAnimationFrame(h)), () => T())),
...
let P = (e) => {
    ...
    S = (e) => {
        ...
        return (
            ...
            }, [c, j, y, a, _, M, C, A.animationType, i, f]),
            (0, n.jsx)("div", {
                ref: I,
                className: u()(R.yC, { [R.yo]: c && o }),
                "aria-label": N,
                role: "img",
