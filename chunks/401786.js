...
function j(e) {
    ...
    let { premiumSubscriptionPlan: k, premiumGuildPlan: U } = (0, l.cj)([v.Z], () => {
        ...
        F = null != U ? (0, T.Zx)(o, null != (a = null == (t = x[0]) ? void 0 : t.quantity) ? a : 0, U.id) : null,
        [B] = (0, h.ED)({
            subscriptionId: o.id,
            items: F,
            renewal: !0,
    ...
    let V =
        ...
        z = R.intl.format(R.t["0W23cu"], { endDate: B.subscriptionPeriodStart });
    return (
