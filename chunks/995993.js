...
function j(e) {
    let { guild: t, selected: j } = e,
        ...
        N = (0, l.Wu)([p.Z], () => Array.from(p.Z.getNewChannelIds(t.id)).filter((e) => p.Z.shouldIndicateNewChannel(t.id, e))),
        I = (0, l.e7)([g.ZP], () => g.ZP.hasUnread(t.id, O.W.GUILD_ONBOARDING_QUESTION)),
        P = N.length > b.Cb,
        w = (0, l.e7)([d.Z, g.ZP], () => {
