...
let L = (t) =>
    r
        ...
        : t;
for (var h = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/', O = 'undefined' == typeof Uint8Array ? [] : new Uint8Array(256), P = 0; P < h.length; P++) O[h.charCodeAt(P)] = P;
var g = function (t) {
    var e,
        a = new Uint8Array(t),
        r = a.length,
