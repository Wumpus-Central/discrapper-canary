...
class H extends s.Ay.Store {
    ...
    initialize() {
        this.waitFor(d.A, f.default, p.A, E.A, m.A, o.Ay, g.A, u.A, c.Ay, _.A, A.A, I.Ay, T.A, S.Ay, h.A);
    }
    getGuild(e, t) {
...
let j = new H(a.h, {
    ...
    USER_SETTINGS_PROTO_UPDATE: function (e) {
        let { settings: t } = e;
        if (t.type !== C.oD.PRELOADED_USER_SETTINGS) return !1;
