...
function tH(e, t, n, l, i) {
    ...
    if (l < t) {
        ...
        if (n.type === s) {
            ...
            if (null != l) {
                if (tO(t.channel.type, e.type) || (e.isGuildVocal() && (0, e9.tr)(t.channel.type)))
    ...
    if (n.type === s) {
        ...
        if (null != l) {
            ...
            if (tO(t.channel.type, e.type) || ((0, e9.tr)(e.type) && t.channel.isGuildVocal()))
                return { referenceId: l.channel.id, parentId: t.channel.parent_id };
...
var t3 = n(728321),
    t2 = n(244083);
let t9 = { origin: { x: -36, y: 7 }, targetWidth: 232, targetHeight: 40, offset: { x: 0, y: 0 } };
var t6 = n(121880);
    ...
    switch (t) {
        ...
        case l.voiceChannelsSectionNumber: {
            ...
            return (0, s.jsxs)(r.Fragment, {
                children: [(0, s.jsx)("div", { className: t6.ts }), (0, s.jsx)(t0, { category: e, channel: n })],
            });
        }
        case e4.TF: {
...
function le(e) {
    ...
    return (0, s.jsx)(H.G, {
        ...
        renderIcon: (e) => (0, s.jsx)(n6.h, { width: 20, height: 20, className: ef()([e, n8.sV]) }),
                    ...
                    (0, s.jsx)(ee.D, {
                        ...
                        onClick: (e) => {
                            e.stopPropagation(),
                                ...
                                n7.default.track(F.HAw.GUILD_SHOP_PREVIEW_CLICK, {
                                    ...(0, n3.H$)(t),
...
function l7(e) {
    ...
    if (n.length <= 0) return null;
    {
        if (1 === n.length)
            return (0, s.jsx)("div", {
                className: ef()(l5.kL, t, l && l5.F4),
                children: (0, s.jsx)(l6.A, { game: n[0].application, className: l5.wK }),
            });
        let e = n.length - 1;
        return (0, s.jsxs)("div", {
            className: ef()(l5.kL, t, l && l5.F4),
            children: [
                (0, s.jsx)(l6.A, { game: n[0].application, className: l5.wK }),
                2 === n.length
                    ? (0, s.jsx)(l6.A, { game: n[1].application, className: l5.wK })
                    : (0, s.jsx)(N.E, {
                          className: l5.ju,
    ...
    return null != r && r && S
        ...
        : l && (0, l9.t)(i) && G
          ...
          : null != E
            ...
            : null != a && a && f.length > 0
              ? (0, s.jsx)(l7, { embeddedApps: f, muted: A })
              : null;
}
var l8 = n(582630);
class ie extends nx {
...
function i4(e) {
    ...
    let l = tu.A.getGuild(n.guild_id);
    return (
        null != l && !!l.features.has(F.GuildFeatures.COMMUNITY) && e7.A.getGuildId() === n.guild_id && i9(n.guild_id)
    );
}
function i8(e) {
    let { guildId: t } = e;
...
class se extends u.Ay.Store {
    ...
    initialize() {
        this.waitFor(e8.A, eq.A, tu.A, ll.A, nK.Ay, e7.A, eX.Ay, eQ.A, tY.Ay);
    }
...
let st = new se(eU.h, {
    ...
    THREAD_DELETE: i7,
    THREAD_LIST_SYNC: i6,
    THREAD_MEMBER_UPDATE: i5,
    THREAD_MEMBERS_UPDATE: i5,
    THREAD_UPDATE: i7,
...
function sD(e) {
    ...
    if (
        (r.useEffect(() => {
            u && n7.default.track(F.HAw.VOICE_CHANNEL_TOPIC_VIEWED, { channel_id: t.id, guild_id: t.guild_id });
        }, [u, t.id, t.guild_id]),
        null == t.guild_id)
    )
        return null;
