...
(W['robot-synthetic'] = K(W.robot, { name: A.default['Ur/62N'] })), (W['chords-2part'] = K(W.tunes, { name: A.default.TYbrfH })), (W['chords-choir'] = K(W.tunes, { name: A.default.OnZ6g4 })), (W['chords-dev'] = K(W.tunes, { name: A.default['2XH8tr'] })), (W['robot-dev'] = K(W.robot, { name: A.default.XhhSOj })), (W['ghost-dev'] = K(W.ghost, { name: A.default.KmHwvL })), (W.rachel = W.skye), (W.alex = W.quinn), (W.elliot = W.axel), (W.sebastian = W.sebastien), (W.justin = W.justus), (W.taylor = W.harper), (W.monique = W.solara);
