...
function T(e, t) {
    ...
    return (
        ...
        t && (0, u.zV)(A.HAw.REQUEST_TO_SPEAK_INITIATED, { ...(0, E.l7)(e) }),
        a.Bo.patch({
...
function N(e, t) {
    ...
    return !t && (0, g.Cf)()
        ...
        : (o !== m.zF.REQUESTED_TO_SPEAK_AND_AWAITING_USER_ACK ||
              t ||
              (0, u.zV)(A.HAw.PROMOTED_TO_SPEAKER, { ...(0, E.l7)(e) }),
          a.Bo.patch({
...
function R(e, t, n) {
    ...
    let a = e.permissionOverwrites[i],
        u = { id: i, type: l.r2.ROLE, allow: h.x3, deny: h.x3, ...a };
    n
...
async function v(e, t, n, i) {
    if ("" === t) return;
    d.A.getVoiceChannelId() !== e.id && (0, f.cy)(e);
    let r = await (0, p.yG)(e.id, t, n, i);
    return N(e, !1, !0), r;
}
async function b(e, t, n) {
    if ("" !== t) return await (0, p.RY)(e.id, t, n);
}
async function L(e) {
    await (0, p.RR)(e.id);
}
