...
function O(e) {
    ...
    if (null == i)
        void 0 !== (t = (i = new p.A(C(e))).premiumType) && r && (i.premiumType = b((0, f.I9)(i), i.premiumType));
    else if (n) {
        var s;
        let n,
            a,
...
function w(e) {
    ...
    delete t.premium,
        ...
        i.forEach((e) => {
            e.members.forEach((t) => {
                N(t.user.id, e.id, t.avatar), v(t.user.id, t.user);
            });
        }),
    ...
    for (let e of t)
        n =
            e.members.reduce((t, n) => {
                let i = O(n.user);
                return N(n.user.id, e.guildId, n.avatar) || i || t;
            }, !1) || n;
    return n;
}
function ec(e) {
    let t = !1;
    for (let n of e.members) O(n.user) && (t = !0), N(n.user.id, e.guildId, n.avatar) && (t = !0);
    return t;
}
function ed(e) {
    let t = !1;
...
function ef(e) {
    ...
    t.members.forEach((e) => {
        ...
        n !== m.default.getId() && O({ id: n, username: i, avatar: r, discriminator: s, bot: a }), N(n, t.id, o);
    });
}
function ep(e) {
