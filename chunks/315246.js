...
function T(e) {
    let { user: t, guildId: n, channel: T, entry: S, onSelect: y, disableGameProfileLinks: N } = e,
        v = r.useRef(null),
        C = r.useContext(m.Jd),
        R = (0, p.A)({ userId: t.id, guildId: n, channelId: T?.id, onAction: C }),
        ...
        w = (0, f.A)({
            ...
            applicationId: L && !0 !== N ? S.extra?.application_id : void 0,
