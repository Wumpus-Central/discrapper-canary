...
let tr = [
    ...
    },
    {
        ...
        render: function () {
            return (0, Y.h)(() => R.Z.openCreateGuildModal({ location: 'External link' })), (0, r.jsx)(o.l_, { to: eG.Z.defaultRoute });
        }
    },
    {
    ...
    },
    {
        ...
        render: function () {
            return (0, Y.h)(() => f.Z.open(e0.oAB.INVENTORY)), (0, r.jsx)(o.l_, { to: eG.Z.defaultRoute });
        },
        isSessionRequired: !0
    },
    {
