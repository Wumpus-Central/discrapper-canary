...
let te = (0, g.l)((e) => {
    ...
    tn = (0, g.l)((0, T.e)(P.Z, null, { passProps: !1 })),
    tr = (0, T.e)(Q.default, null, { passProps: !1 }),
    ti = [
...
let ta = [
    ...
    },
    {
        ...
        render: function () {
            return (
                (0, K.h)(() => (0, eM.openUserSettings)(eR.n.GIFT_PANEL, { section: e4.oAB.INVENTORY })),
                (0, r.jsx)(a.l_, { to: eF.Z.defaultRoute })
            );
        },
        isSessionRequired: !0,
