                    ...
                    eB.Z.whenInitialized(() => {
                        switch (l) {
                            ...
                            case 'uninstall': {
                                let e = eB.Z.getActiveLibraryApplication(n);
                                if (null == e) return;
                                (0, c.W)(e.id, e.branchId, eJ.Sbl.URI_SCHEME);
                            }
                        }
                    });
                }),
        ...
        !(function (e) {
            ...
            (function (e, t) {
                ...
                if ((d && g && u.Z.selectGuild(i), d && c)) {
                    ...
                    } else ((a && d) || (!g && !a)) && en.Z.closeSidebar();
                } else
                    !e9.some((t) => {
                        var n;
