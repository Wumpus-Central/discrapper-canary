...
function T(e) {
    let {
        ...
        A = d.length,
        E = 0 === A ? I.intl.string(I.t["vR7M+/"]) : I.intl.formatToPlainString(I.t.PCs0oq, { numRoles: A }),
        S = d.map((e) => {
            var i;
            return (0, l.jsx)(
                v.Z,
...
function A(e) {
    ...
    let { trackUserProfileAction: s } = (0, x.KZ)(),
        ...
        [E] = (0, a.Wu)([f.Z], () => [f.Z.can(y.Plq.MANAGE_ROLES, v), f.Z.getGuildVersion(r)]),
        S = i.useCallback(
            (e) => {
                var t, l;
    ...
    return 0 !== A.length || _
        ? (0, l.jsx)(
              g.Z,
              N(O({ heading: I.intl.string(I.t.LPJmLy) }, o), {
                  children: (0, l.jsx)(T, {
                      user: n,
                      currentUser: t,
                      guild: v,
