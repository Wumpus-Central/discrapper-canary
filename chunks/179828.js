...
function E(e) {
    let { user: t, currentUser: n, guild: c, guildMember: s, roles: d, highestRole: u, canManageRoles: f, onAddRole: p, onRemoveRole: m } = e,
        b = f && null != s,
        j = l.useRef(null),
        ...
        N = d.length,
        T = 0 === N ? x.intl.string(x.t['vR7M+/']) : x.intl.formatToPlainString(x.t.PCs0oq, { numRoles: N }),
        A = d.map((e) => {
            var l;
            return (0, r.jsx)(
                h.Z,
