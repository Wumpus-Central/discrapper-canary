                            ...
                            if (
                                ...
                                if (
                                    ...
                                    (this.mux.WINDOW_HIDDEN && "hb" === e
                                        ...
                                        : ts.indexOf(e) >= 0 && this.eventQueue.flushEvents(),
                                    this.rateLimited)
                                )
                                    return (
                    ...
                    value: function (e) {
                        return e.hlsjs
                            ? this.hlsjs
                                ...
                                : void ((this.hlsjs = e.hlsjs), ev(this.mux, this.id, e.hlsjs, {}, e.Hls || window.Hls))
                            : void this.mux.log.warn("You must pass a valid hlsjs instance in order to track it.");
                    },
                },
                {
                    key: "removeHLSJS",
                    ...
                    value: function (e) {
                        return e.dashjs
                            ? this.dashjs
                                ...
                                : void ((this.dashjs = e.dashjs), eb(this.mux, this.id, e.dashjs))
                            : void this.mux.log.warn("You must pass a valid dashjs instance in order to track it.");
                    },
                },
                {
                    key: "removeDashJS",
