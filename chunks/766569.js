...
function D(e) {
    let { selectedGuild: t, onGuildChange: n } = e,
        ...
        { pendingDisplayNameStyles: B } = (0, A.B0)(D, t?.id);
    return (s.useEffect(() => () => d.h.wait(N.IM), []), M)
        ? (0, i.jsx)(c.A, {})
        : G
          ? (0, i.jsxs)(_.f5, {
                value: l,
                children: [
                    (0, i.jsx)(o.Text, {
                        ...
                        children: R.intl.format(R.t["/PTB2E"], {
                            helpCenterLink: I.A.getArticleURL(j.MVz.GUILD_PROFILES),
                        }),
                    }),
                    null != t
                        ? (0, i.jsxs)(i.Fragment, {
                              children: [
                                  (0, i.jsx)(O.A, { guildId: t.id, onChange: n }),
                                  (0, i.jsx)(m.A, {
