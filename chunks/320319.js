...
let R = {
    ...
    D = i.memo((e) => {
        let { name: t, canReveal: n = !0, dismissibleContentType: s, forceShadow: b, cardType: C, confettiCanvas: O } = e,
            ...
            V = (0, x.IB)(),
            [G, F] = i.useState(!1),
            [H, z] = i.useState(t === E.u.TENURE_REWARD_COLLECTIBLE && V && (null == U ? void 0 : U.nitroTenureStatus) === v.EB.REDEEMABLE);
        i.useEffect(() => {
...
let Z = i.forwardRef((e, t) => {
    var n;
    let { title: i, titleClassName: s = '', subtitle: l = '', description: o = '', descriptionCta: c = '', isPremiumGetCta: d, onCtaClick: m, onMouseEnter: g, className: p, perkComponent: h, cardVariant: f, cardType: x, onClick: N, backgroundImage: _, pillText: E, perkImage: v, imageOverlayText: S } = e,
        T = x === j.R0.CARD_CAROUSEL_FIRST_ROW || x === j.R0.CARD_CAROUSEL_SECOND_ROW || x === j.R0.CARD_CAROUSEL_THIRD_ROW,
