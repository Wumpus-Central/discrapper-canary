    ...
    getStats(e) {
        ...
        let t = Number(this.streamStart),
            ...
            },
            {
                ...
                cryptorInvalidNonceCount: w,
                qualityDecodeErrors: G,
                qualityDecoderReboots: x,
                qualityScoreErrors: k,
                qualityFrameDrops: F,
                qualitySizeMismatches: V,
            } = e.aggregatedProperties,
            B = (b ?? 0) - (e.cryptorFailureBeforeSuccessCount ?? 0);
        return (
            e instanceof eJ.ET
                  ...
                  (u.total_decode_time_ms = L)),
            {
                ...
                cryptor_invalid_nonce_count: w,
                cryptor_failure_after_success_count: B,
                encoder_quality_decode_errors: G,
