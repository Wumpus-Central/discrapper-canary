...
let o = [
        ...
        (e) => ({ ...e, version: 5, id: (0, i.A)(), createdAt: r.default.extractTimestamp(e.id) }),
    ],
    l = null;
async function _(e) {
            ...
            null != l
                ...
                : (l = t
                      .object({
                          ...
                          version: t.number().positive().integer().min(0).max(a.kd).optional(),
    ...
    try {
        return (
            ...
            o.slice(e.version).reduce((e, t) => t(e), e)
        );
    } catch (e) {
        return null;
    }
