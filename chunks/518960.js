...
async function N(e, t, n) {
    ...
    if ((await Promise.resolve(), (0, g.fJ)(T, m))) return void y(t, T);
    if (h.A.getUploadCount(t.id, n) + T.length > A.XgB) {
        (0, a.openUploadError)({
    ...
    if (
        ...
        let e = T.map((e, n) => {
            let i = null != u ? u[n] : {};
            return new o.bK(
                { file: e, platform: l.xz.WEB, isThumbnail: f, origin: E, compressionMetadata: N[n], ...i },
                t.id,
            );
        });
