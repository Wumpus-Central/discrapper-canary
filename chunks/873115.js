...
function g() {
    ...
    (0, l.isDesktop)() && (t = (0, c.EH)(u.HeQ.PAYPAL)),
        t
...
function y() {
    return b(a.Z.getPayPalClient(), { type: "BRAINTREE_TEARDOWN_PAYPAL_CLIENT" });
}
function O() {
    return b(a.Z.getVenmoClient(), { type: "BRAINTREE_TEARDOWN_VENMO_CLIENT" });
}
function v() {
