...
function eI(e) {
    ...
    let {
        ...
        { isConnected: p, isResolved: T } = (function (e) {
            let t = (0, b.bG)([Z.A], () => Z.A.getLinkedUsers()[e]?.link_status),
                [n, i] = s.useState(() =>
...
let eN = {
        ...
        parental_consent_connection: (e) => {
            ...
            let h = s.useMemo(() => {
                ...
                I = (0, J.VT)(),
                f = (0, J.Du)(),
                p = (0, b.bG)([Z.A], () => Z.A.getLinkedUsers()),
                T = (0, b.bG)([Z.A], () => Z.A.getAreLinkedUsersProcessed()),
                m =
                    ((t = h.pending_requests),
                    (n = (0, b.bG)([Z.A], () => Z.A.getLinkedUsers())),
                ...
                R = (0, b.bG)([Z.A], () => Z.A.getLinkCode()),
                O = (0, b.bG)([Z.A], () => Z.A.getLinkCodeExpiresAt()),
                L = R ?? h.link_code,
