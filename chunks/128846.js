...
function eg(e) {
    ...
    let {
        ...
        T = ((t = n.created_at), (0, eh.mV)(Date.parse(t), ep)),
    ...
    return (0, s.jsxs)("div", {
        ...
        children: [
            (0, s.jsx)("div", {
                className: ef.R3,
                children: (0, s.jsx)(er.eu, { src: E, size: ea._3.SIZE_40, "aria-label": f }),
            }),
            (0, s.jsxs)("div", {
                className: ef.zH,
                children: [
            ...
            v
                ...
                : (0, s.jsxs)("div", {
                      ...
                      children: [
                          !i &&
                              (0, s.jsx)(eo.D, {
                                  "aria-label": N.intl.formatToPlainString(em.default.jc1Ip7, {
                                      name: n.parent_username,
                                  }),
                                  className: es()(ef.hP, ef.xG),
                                  onClick: () => !d && u(n.parent_id),
                                  children: l
                                      ? (0, s.jsx)(r.y, { type: r.y.Type.SPINNING_CIRCLE_SIMPLE })
                                      : (0, s.jsx)(ed.r, { className: ef.gE, color: "currentColor" }),
                              }),
                          (0, s.jsx)(eo.D, {
                              "aria-label": N.intl.formatToPlainString(em.default["4GtllP"], {
                                  name: n.parent_username,
                              }),
                              className: es()(ef.hP, ef.rr),
                              onClick: () => !d && h(n.parent_id),
                              children: o
                                  ? (0, s.jsx)(r.y, { type: r.y.Type.SPINNING_CIRCLE_SIMPLE })
                                  : (0, s.jsx)(ec.P, { className: ef.gE, color: "currentColor" }),
                          }),
                      ],
                  }),
        ],
    ...
    let { pendingRequests: t, linkedUsersProcessed: n } = e,
        {
            ...
            onActionError: () => {
                (0, Z.P0)((0, z.o)(N.intl.string(em.default.Wu8BK2), K.Ck.FAILURE));
            },
        });
    return 0 === i.length
        ? null
...
let e_ = {
        ...
        parental_consent_connection: (e) => {
            ...
            let n,
                i,
                { configData: l, onSubmit: r, disabled: d, transitionState: p = ex.ip.ENTERED } = e,
                { getLinkCode: m } = (0, X.A)();
            (0, h.Ay)(() => {
                (0, J._z)();
            });
            let f = a.useMemo(() => {
                ...
                E = v ? Object.values(x).some((e) => null != e) : f.pending_requests.length > 0,
                C = v ? g : f.pending_requests.length,
                j = (0, R.bG)([Y.A], () => Y.A.getLinkCode()),
                I = (0, R.bG)([Y.A], () => Y.A.getLinkCodeExpiresAt()),
                S = j ?? f.link_code,
                y = I ?? Date.parse(f.link_code_expires_at),
            ...
            let G = !O || D,
                H = G
                    ? N.intl.format(_.default["6GaRTu"], { link: eE })
                    : N.intl.format(_.default["Ke+kz5"], { pendingCount: C, link: eE });
            return (0, s.jsxs)(V.d, {
                transitionState: p,
                onClose: ev.tE,
                dismissable: !1,
                ...
                children: [
                    ...
                    (0, s.jsx)(W.rQ, { alignCenter: !0, title: N.intl.string(_.default.dMMSA0), subtitle: H }),
                    (0, s.jsxs)(P.c, {
                        children: [
                            G &&
                                (0, s.jsx)(o.B, {
                                    ...
                                    align: "center",
                                    gap: 16,
                                    children: (0, s.jsx)(ee.r, { linkCode: S, expiresAt: y, onRefresh: m }),
                                }),
                            (0, s.jsx)("div", {
                                hidden: G,
                                children: (0, s.jsx)(eA, { pendingRequests: T, linkedUsersProcessed: v }),
                            }),
                        ],
                    }),
                    (0, s.jsx)(B.H, {
...
function eR(e) {
    ...
    return (0, s.jsxs)(E.Provider, {
        value: d,
        children: [!c && (0, s.jsx)(ey, {}), (0, s.jsx)(eN, { onSubmit: n, disabled: i, transitionState: l })],
    });
}
let ew = function (e) {
    ...
    return (0, s.jsxs)("div", {
        ...
        children: [
            ...
            k
                ...
                : P && null != i
                  ? (0, s.jsx)(eR, { task: i, handleSubmit: O, disabled: C, transitionState: t ?? ex.ip.ENTERED })
                  : (0, s.jsx)("div", {
                        className: eb.nA,
                        children: g
                            ...
                            : (0, s.jsx)("div", {
                                  ...
                                  children: (0, s.jsxs)(o.B, {
                                      ...
                                      children: [
                                          ...
                                          null === x &&
                                              null != i &&
                                              (0, s.jsx)(eR, { task: i, handleSubmit: O, disabled: C }),
                                      ],
                                  }),
                              }),
                    }),
