    ...
    return (0, N.T)(
        X,
        {
            drop(e, t) {
                ...
                if (0 !== c.length) {
                    if ((0, R.ai)(l)) return void (0, j.zN)(c);
                    if (
                        ((c = c.filter((e) => {
                            let { id: t } = e,
                                n = L.A.getChannel(t);
            ...
            canDrop(e, t) {
                ...
                if (null == i) return !1;
                if ((0, R.ai)(P.A.getGuildId())) return !0;
    ...
    switch (t) {
        ...
        case l.voiceChannelsSectionNumber: {
            ...
            return (0, s.jsxs)(r.Fragment, {
                children: [(0, s.jsx)("div", { className: ne.ts }), (0, s.jsx)(t5, { category: e, channel: n })],
            });
        }
        case tE.TF: {
...
let nW = r.memo(function (e) {
    ...
    let [_, I] = (0, eo.x_)(en.M.GAME_SHOP_NEW_DROP_POPOVER, t.id, g?.id ?? ""),
        ...
        children: [
            ...
            (0, s.jsx)(el.m, {
                ...
                children: (0, s.jsx)(ei.D, {
                    ...
                    children: (0, s.jsx)(lg.o, { size: "xs", color: "currentColor", className: ef.gE }),
                }),
            }),
        ],
    });
    ...
    return (0, s.jsxs)("div", {
        ...
        children: [
            (0, s.jsxs)(e0.E, {
                ...
                children: [
                    l ? (0, s.jsx)(lj.n, { size: "md", color: "currentColor", className: lR.LB }) : null,
...
function ip(e) {
    ...
    if (!A && g === nG.e.ALL_MESSAGES && t.isForumLikeChannel() && null != S && S > 0)
        return (0, s.jsx)(e0.E, {
            variant: "text-xs/semibold",
            color: "text-brand",
            children: eg.intl.format(eg.t.GkAbqY, { count: (0, er.Gu)(S) }),
        });
    if (!A && t.isForumLikeChannel() && null != I && I > 0)
        return (0, s.jsx)(e0.E, { variant: "text-xs/semibold", color: "text-muted", children: (0, er.Gu)(I) });
    let G = i?.length ?? 0;
    return null != r && r && _
        ? (0, s.jsx)(ly, { userCount: G, video: x || N, channel: t })
        : l && (0, ih.t)(i) && b
...
class iE extends nI {
    ...
    handleClick = () => {
        ...
        null != s && (0, lK.V)(s) && (0, lF.Ze)(s),
            ...
            t || n || e.isRoleSubscriptionTemplatePreviewChannel() || (0, l7.av)(e),
            __OVERLAY__ || (0, l5.iN)(e.id, i ? { source: l9.A.CHANNEL_LIST_SUGGESTED_SECTION } : void 0);
    };
    handleClickChat = () => {
        let { channel: e, locked: t, isSuggestedSection: n } = this.props;
        __OVERLAY__ || t || (0, l5.iN)(e.id, n ? { source: l9.A.CHANNEL_LIST_SUGGESTED_SECTION } : void 0);
    };
    handleContextMenu = (e) => {
    ...
    return (0, s.jsxs)(ei.D, {
        ...
        children: [
            ...
            (0, s.jsxs)("div", {
                className: iV.Pf,
                children: [
                    (0, s.jsx)(e0.E, { className: iV.UU, variant: "text-sm/normal", color: "none", children: t.name }),
                    ...
                    (0, s.jsx)(lw.Y, {
                        ...
                        children: () =>
                            (0, s.jsxs)(nb.Ay, {
                                ...
                                resolvedUnreadSetting: C,
                                transitionExtras: _ ? { source: l9.A.CHANNEL_LIST_SUGGESTED_SECTION } : void 0,
                                "aria-label": (0, lk.Ay)({
                                    channel: e,
                                    unread: i,
                                    mentionCount: o,
...
function sd(e) {
    let { guildId: t } = e,
        n = D.A.getGuild(t);
    return null != n && !!n.features.has(B.GuildFeatures.COMMUNITY) && so(t);
}
function sc(e) {
    let { id: t } = e,
        n = L.A.getChannel(t);
    ...
    return null != l && !!l.features.has(B.GuildFeatures.COMMUNITY) && so(n.guild_id);
}
function su(e) {
    let { channel: t } = e,
...
function sh(e) {
    ...
    let l = D.A.getGuild(n.guild_id);
    return (
        null != l && !!l.features.has(B.GuildFeatures.COMMUNITY) && P.A.getGuildId() === n.guild_id && so(n.guild_id)
    );
}
function sA(e) {
    let { guildId: t } = e;
...
let sm = new sg(e9.h, {
        ...
        return (
            o()(t)
                ...
                .forEach((e) => {
                    ...
                    null != t && t.features.has(B.GuildFeatures.COMMUNITY) && so(e) && (n = !0);
                }),
            n
        );
    },
    ...
    PASSIVE_UPDATE_V2: function (e) {
        ...
        return !!(e.channels.length > 0 && null != t && t.features.has(B.GuildFeatures.COMMUNITY)) && so(e.guildId);
    },
    RESORT_THREADS: sh,
    THREAD_CREATE: su,
    THREAD_DELETE: su,
...
function sC(e) {
    ...
    return (0, s.jsxs)(ei.D, {
        className: ew()(sf.M0, sf.OF),
        onClick: a,
        children: [
            (0, s.jsx)(tY.H, { size: "custom", className: sf.Gs, width: 14, height: 14, color: "currentColor" }),
            (0, s.jsx)(e0.E, {
                variant: "text-xs/semibold",
                className: sf.pM,
...
function sE(e) {
    ...
    return (0, s.jsx)("div", {
        className: ew()(sf.kL, { [sf.Mn]: "top" === t, [sf.sQ]: "bottom" === t }),
        children: (0, s.jsx)(eQ.animated.div, {
            ...
            children: (function () {
                switch (h) {
                    case i8.HIDDEN:
                        return (0, s.jsx)("div", { className: ew()(sf.M0, sf.Te) });
                    case i8.UNREAD:
                        return (0, s.jsxs)(ei.D, {
                            className: sf.M0,
                            onClick: p,
...
function sL(e) {
    ...
    return (0, s.jsx)(ed.G, {
        ...
        text: eg.intl.string(sM.default.Xmvb23),
        selected: n,
        trailing: (0, s.jsx)(sv.iT, { guildId: t.id }),
        onClick: () => {
        ...
        children: [
            ...
            o
                ? (0, s.jsxs)("div", {
                      ...
                      children: [
                          (0, s.jsx)(el.m, {
                              text: eg.intl.string(sY.default.XJ4UpB),
                              children: (0, s.jsx)(ei.D, {
                                  className: sX.HF,
                                  onClick: h,
                          ...
                          (0, s.jsx)(el.m, {
                              text: eg.intl.string(sY.default.XV4qT6),
                              children: (0, s.jsx)(ei.D, {
                                  className: sX.HF,
                                  onClick: A,
        ...
        children: (0, s.jsxs)(ei.D, {
            ...
            children: [
                ...
                (0, s.jsx)(e0.E, {
                    variant: "text-sm/medium",
                    color: "currentColor",
                    children: eg.intl.string(sY.default.NGcIOF),
                }),
            ],
        }),
    });
...
function s7(e) {
    ...
    return u
        ? (0, s.jsx)(ei.D, {
              ...
              children: (0, s.jsx)(e0.E, {
                  variant: "text-xs/medium",
                  className: ew()(s9.qS, s5.PT),
                  children: (0, s.jsx)(tB.A, { children: s2.A.parseVoiceChannelStatus(o, !0, { channelId: t.id }) }),
              }),
          })
        : n && h && !c && (!A || l)
          ? (0, s.jsxs)(ei.D, {
                ...
                children: (0, s.jsx)(ei.D, {
                    ...
                    onClick: () => {
                        lH.A.updateChatOpen(e.id, !0),
                            (0, l5.iN)(e.id, l ? { source: l9.A.CHANNEL_LIST_SUGGESTED_SECTION } : void 0);
                    },
                    "aria-label": eg.intl.string(eg.t.ZXxLQg),
                    children: (0, s.jsx)(lg.o, { size: "xs", color: "currentColor", className: ef.gE }),
                }),
    ...
    renderRow = (e) => {
        ...
        if (t === tE.PU) {
            ...
            switch (t) {
                ...
                case tH.n.GUILD_VIBEGRATIONS:
                    return (0, s.jsx)(sL, { guild: l, selected: a === eu.VV.VIBEGRATIONS }, tH.n.GUILD_VIBEGRATIONS);
        ...
        switch (x.type) {
            ...
            case B.rbe.GUILD_CATEGORY:
                ...
                return (0, s.jsx)(t7, { channel: x }, `readonly-${x.id}`);
...
function rl(e) {
    let t = (function (e) {
            ...
            return (
                ...
                I && (b ? p.push(tH.n.GAME_SERVERS) : null != j && p.push(tH.n.GAME_SERVERS_EMPTY)),
