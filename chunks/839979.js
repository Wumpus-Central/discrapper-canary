...
let eS = r.memo(function (e) {
    let { guildId: t, selected: l } = e,
        [i, a] = (0, eg.ww)([eo.M.GAME_SERVER_HOSTING_NEW_BADGE], t),
        o = i === eo.M.GAME_SERVER_HOSTING_NEW_BADGE,
        d = r.useCallback(() => {
            a(eC.i.USER_DISMISS), (0, ef.pX)(Y.BVt.CHANNEL(t, ep.VV.GAME_SERVERS));
        }, [t, a]),
        c = r.useCallback(
            (e) => {
                e.stopPropagation(),
        ...
        u = (0, s.jsxs)("div", {
            ...
            children: [
                (0, s.jsx)("div", {
                    className: e_.Xs,
                    children: (0, s.jsx)(ed.m, {
                        text: ex.intl.string(ex.t.fgq1gs),
                        position: "top",
                        children: (0, s.jsx)(ec.D, {
                            onClick: c,
                            "aria-label": ex.intl.string(ex.t.fgq1gs),
                            children: (0, s.jsx)(eu.P, { size: "xs", color: "currentColor", className: e_.gE }),
                        }),
                    }),
                }),
                o &&
    ...
    return (0, s.jsx)(em.G, {
        ...
        text: ex.intl.string(eE.default.vCzwM7),
        selected: l,
        onClick: d,
        trailing: u,
    });
...
let ev = r.memo(function (e) {
    let { guildId: t, selected: n } = e,
        ...
        a = (0, eI.xr)((e) => e.fullScreenLayers.length > 0),
        [o, d] = (0, eg.ww)([eo.M.GAME_SERVER_HOSTING_NEW_BADGE], t),
        c = o === eo.M.GAME_SERVER_HOSTING_NEW_BADGE,
        [h, A] = (0, eg.ww)(l || i || a || !c ? [] : [eo.M.GAME_SERVER_HOSTING_NEW_COACHMARK], t),
        g = r.useCallback(
            (e) => {
                d(e), A(e);
            },
        ...
        m = r.useCallback(() => {
            g(eC.i.USER_DISMISS), (0, ef.pX)(Y.BVt.CHANNEL(t, ep.VV.GAME_SERVERS));
        }, [t, g]),
        f = r.useRef(null),
    ...
    return (0, s.jsxs)(s.Fragment, {
        children: [
            (0, s.jsx)(em.G, {
                ...
                onClick: m,
                trailing: c
                    ? (0, s.jsx)(eh.Lp, { disableColor: !0, text: ex.intl.string(ex.t.y2b7CA), className: eR.q })
                    : null,
            }),
            p && C(),
        ],
...
function eO(e) {
    let { guild: t, selected: n } = e,
        ...
        i = (0, u.bG)([eL.A], () => eL.A.getSubmittedGuildJoinRequestTotal(t.id)),
        a = l ? (i ?? 0) : 0;
    r.useEffect(() => {
        l &&
            ...
            eM.A.fetchGuildJoinRequests({ guildId: t.id, status: eT.B5.SUBMITTED, limit: eU.L });
    }, [l, t]);
    let o = r.useCallback(() => {
            (0, eD.aZ)(t.id);
        }, [t.id]),
        d = (0, ey.q8)(t.id, eo.M.MEMBERS_LAUNCH_UPSELL);
    return (0, s.jsx)("div", {
        ref: d,
        children: (0, s.jsx)(em.G, {
            id: `members-${t.id}`,
            renderIcon: (e) => (0, s.jsx)(ej.n, { size: "md", color: "currentColor", className: e }),
            text: ex.intl.string(ex.t.oclz3Z),
            selected: n,
            onClick: o,
            trailing: a > 0 ? (0, s.jsx)(eh.hV, { count: a }) : null,
        }),
    });
}
var eP = n(632015);
function eV(e) {
    ...
    return (0, s.jsx)(em.G, {
        ...
        renderIcon: (e) => (0, s.jsx)(eP.f, { size: "md", color: "currentColor", className: e }),
        text: ex.intl.string(ex.t["04IVMq"]),
        selected: n,
        onClick: function () {
            (0, ef.pX)(Y.BVt.CHANNEL(t.id, ep.VV.GUILD_SPACE));
        },
    });
}
var ew = n(581007),
...
function e2(e) {
    ...
    switch (t.type) {
        ...
        case eJ.cD.UNREAD:
            return (0, s.jsx)(eh.hV, { count: t.count });
        default:
            return null;
    }
}
        ...
        let { guildId: t, selected: l } = e,
            ...
            d = r.useCallback(() => {
                o(),
                    ...
                    i?.popout?.markAsDismissed(eC.i.INDIRECT_ACTION);
            }, [t, o, i]),
            c = r.useRef(null),
            A = (0, j.useModalsStore)(j.hasAnyModalOpenSelector),
            g = (0, u.bG)([eG.A], () => eG.A.hasLayers()),
            m = (0, eI.xr)((e) => e.fullScreenLayers.length > 0),
            f = A || g || m,
            p = r.useCallback(() => {
            ...
            children: [
                (0, s.jsx)(em.G, {
                    ...
                    text: (0, s.jsx)("span", {
                        ...
                        children: ex.intl.string(e0.default.yv3DJJ),
                    }),
                    selected: l,
                    onClick: d,
                        ...
                        (0, s.jsxs)("div", {
                            ...
                            children: [
                                (0, s.jsx)(N.E, {
                                    ...
                                    children: ex.intl.string(e0.default.NI6Ihe),
                                }),
                                i >= l &&
                                    (0, s.jsx)(N.E, {
                                        className: ta.Qq,
                        ...
                        (0, s.jsxs)("div", {
                            ...
                            children: [
                                (0, s.jsx)(N.E, {
                                    ...
                                    variant: "text-xs/semibold",
                                    children: o
                                        ? ex.intl.formatToPlainString(e0.default["Ehpq+7"], { appliedBoostCount: n })
                                        : ex.intl.formatToPlainString(e0.default["/rbPDs"], {
                                              appliedBoostCount: n,
                                              maxBoostCount: l,
                                          }),
                                }),
...
let t6 = el(
        r.memo(function (e) {
            ...
            let E = r.useCallback(() => {
                ...
                _ = (0, t2.C)(l);
            null == _ && p && !o && (_ = { label: ex.intl.string(ex.t["fUYU+j"]), perform: N });
                            ...
                            children: (0, s.jsxs)("div", {
                                ...
                                children: [
                                    (0, s.jsxs)(ec.D, {
                                        ...
                                        ...b,
                                        onClick: E,
                                        "aria-label": ex.intl.formatToPlainString(ex.t.y5l3J2, { categoryName: C }),
                                        "aria-expanded": !f,
            ...
            children: (0, s.jsxs)("div", {
                ...
                children: [
                    ...
                    null != n
                        ? (0, s.jsx)(ed.m, {
                              asContainer: !0,
                              text: ex.intl.string(ex.t["5qNmsU"]),
                              children: (0, s.jsx)(ec.D, {
                                  className: t9.r,
                                  onClick: n,
    ...
    t4 = r.memo(function (e) {
        ...
        return (0, s.jsx)("div", {
            ...
            children: (0, s.jsx)(tX.$, {
                ...
                onClick: l,
                icon: S.H,
                text: n ? ex.intl.string(ex.t["/eB9Bg"]) : ex.intl.string(ex.t.Q2gPWl),
            }),
        });
    }),
                ...
                ? (0, s.jsx)("li", {
                      ...
                      children: (0, s.jsx)("div", {
                          ...
                          children: (0, s.jsx)(t1.A, {
                              className: t9.UU,
                              children: (0, s.jsx)(tY.A, { children: ex.intl.string(ex.t["V/u9Dy"]) }),
                          }),
                      }),
                  })
                : null
...
let nr = r.memo(function (e) {
    let {
        ...
        d = r.useCallback(() => {
            ...
            null != a && i.includes(a) && (t = (0, eF.xb)(l)), (0, eF.DD)(n.id, i, t);
        }, [n.id, a, l, i]),
        { density: c } = (0, C.wR)(),
        u = "compact" === c ? 8 : 12;
    switch (t) {
        ...
        case tI.bK:
            ...
            return (0, s.jsx)("div", { style: { height: u } });
        case tI.HP:
            return (0, s.jsx)(t8, { name: ex.intl.string(ex.t.mlPMCy) });
        case l.recentsSectionNumber:
            return (0, s.jsx)(t8, { name: ex.intl.string(ex.t.gKcrqM), onDismiss: d });
                  ...
                  children: [
                      (0, s.jsx)("div", {
                          ...
                          children: (0, s.jsx)(na.Ay, {
                              ...
                              guildId: a,
                              renderLeadingIcon: f
                                  ? (e) => (0, s.jsx)(nd.A, { color: "currentColor", className: ez()(e, e_.Gj) })
                                  : void 0,
                          }),
                      }),
                      E,
...
function nI(e, t) {
    return null == t ? e_.fx : e > t ? e_.mU : e_.TR;
}
function nb(e) {
    ...
    return (0, u.bG)(
        ...
        : (0, s.jsx)(ed.m, {
              asContainer: !0,
              text: ex.intl.string(ex.t["3gUsJb"]),
              children: (0, s.jsx)(ec.D, {
                  className: ez()(e_.Xs, i ? e_.Tf : void 0, r ? e_.bw : e_.UI),
                  onClick: function () {
                      np.Ay.open(t.id);
                  },
                  tabIndex: l,
                  "aria-label": ex.intl.string(ex.t["3gUsJb"]),
                  children: (0, s.jsx)(ng.Z, { size: "xs", color: "currentColor", className: e_.gE }),
              }),
          });
}
function nG(e) {
    let {
        ...
        m = (0, u.bG)([], () =>
            t?.type === Y.rbe.GUILD_VOICE ? ex.intl.string(ex.t["EE+P0H"]) : ex.intl.string(ex.t["0jeAXt"]),
        ),
        f = r.useRef(null);
    if (i || !g || t.isModeratorReportChannel() || t.isThread()) return null;
    let p = (0, s.jsx)(nm.R, { size: "xs", className: e_.gE, "aria-hidden": !0, color: "currentColor" });
    return (
        l &&
            (p = (0, s.jsx)(nn.A, {
                childRef: f,
        ...
        (0, s.jsx)(ed.m, {
            ...
            text: m,
            children: (0, s.jsx)(ec.D, {
                className: ez()(e_.Xs, o ? e_.Tf : void 0, d ? e_.bw : e_.UI),
                onClick: function () {
                    if (null != c) {
...
function nR(e) {
    ...
    return (0, s.jsx)(ed.m, {
        asContainer: !0,
        text: ex.intl.string(ex.t["ROh4T+"]),
        children: (0, s.jsx)(ec.D, {
            className: e_.Xs,
            onClick: function () {
                (0, nx.Ol)(t.guild_id, t.id);
            },
            "aria-label": ex.intl.string(ex.t["ROh4T+"]),
            children: (0, s.jsx)(eu.P, { size: "xs", color: "currentColor", className: e_.gE }),
        }),
    });
}
function nv(e) {
    ...
    return (0, s.jsx)(ed.m, {
        asContainer: !0,
        text: ex.intl.string(ex.t["N2c/Un"]),
        children: (0, s.jsx)(ec.D, {
            className: e_.Xs,
            onClick: function () {
                (0, nx.jA)(t.guild_id, t.id, !0, { section: Y.JJy.CHANNEL_LIST });
            },
            "aria-label": ex.intl.string(ex.t["N2c/Un"]),
            children: (0, s.jsx)(nf.A, { size: "xs", color: "currentColor", className: e_.gE }),
        }),
    });
}
...
let nL = el(function (e) {
    ...
    let N = nI(i, c),
        _ = nS(m, o, d),
        S = (0, s.jsx)("div", {
            className: ez()(N, { [e_.r9]: _, [e_.wH]: p }),
            "data-dnd-name": C,
...
let nZ = r.memo(function (e) {
    let { guild: t, selected: l } = e,
        ...
        c = (0, eI.xr)((e) => e.fullScreenLayers.length > 0);
    r.useEffect(() => {
        (0, nU.Kh)(t.id);
    }, [t.id]);
    let A = (0, u.bG)([nD.A], () => nD.A.getAnnouncement(t.id)),
        g = A?.state === "success" ? A.announcement : void 0,
        [m, f] = (0, eg.x_)(eo.M.GAME_SHOP_NEW_BADGE, t.id, g?.id ?? "", void 0, !0),
        ...
        _ = null;
    p ? (_ = ex.intl.string(ex.t.y2b7CA)) : x && (_ = ex.intl.string(nX.default.hriMCc)), null != E && (_ = E.text);
    let [S, I] = (0, eg.x_)(eo.M.GAME_SHOP_NEW_DROP_POPOVER, t.id, g?.id ?? ""),
        b = S === eo.M.GAME_SHOP_NEW_DROP_POPOVER && null != g;
    r.useEffect(() => {
        l && (p && f(eC.i.INDIRECT_ACTION), b && I(eC.i.INDIRECT_ACTION));
    }, [f, I, l, p, b]);
    let G = r.useCallback(() => {
            f(eC.i.TAKE_ACTION), I(eC.i.TAKE_ACTION);
            let e = (0, tK.mq)(t.id),
                n = nD.A.getStorefrontState(e)?.activePage ?? 0;
            (0, ef.pX)(Y.BVt.CHANNELS_GAME_SHOP(t.id, n));
        }, [t.id, f, I]),
        R = r.useCallback(() => {
            ...
            (e) =>
                (0, s.jsx)(em.G, {
                    ...
                    text: (0, s.jsx)(N.E, {
                        ...
                        className: nq.UU,
                        children: ex.intl.string(ex.t.vyaWs7),
                    }),
                    selected: l,
                    onMouseDown: R,
                    onClick: G,
                    ...
                    trailing: (0, s.jsxs)(s.Fragment, {
                        children: [
                            null != _ && (0, s.jsx)(eh.Lp, { text: _, color: h.A.colors.BACKGROUND_BRAND.css }),
                            e,
                        ],
                    }),
                }),
            ...
            switch (g.type) {
                case "guild-application-announcement": {
                    ...
                    return {
                        ...
                        title: ex.intl.string(ex.t["7PvvS9"]),
                        body: ex.intl.formatToPlainString(ex.t["9J4h1a"], { applicationName: g.applicationName }),
                    };
                }
...
function n9(e) {
    let { guild: t, selected: l } = e,
        ...
        A = r.useCallback(() => {
            (0, ef.pX)(Y.BVt.CHANNEL(t.id, i ? ep.VV.CUSTOMIZE_COMMUNITY : ep.VV.CHANNEL_BROWSER));
        }, [t.id, i]),
        g = r.useCallback(
            (e) => {
                (0, e6.L3)(e, async () => {
    ...
    return (
        ...
        (0, s.jsx)(em.G, {
            ...
            text: i ? ex.intl.string(ex.t.h9mGOP) : ex.intl.string(ex.t.et6wav),
            selected: l,
            onClick: A,
            onContextMenu: g,
            trailing: m,
...
function n5(e) {
    ...
    return (0, s.jsx)(em.G, {
        ...
        text: ex.intl.string(ex.t.VbpLyU),
        selected: n,
        onClick: function () {
            (0, ef.pX)(Y.BVt.CHANNEL(t.id, ep.VV.GUILD_HOME));
        },
    });
}
var n6 = n(5373),
...
let lt = r.memo(function (e) {
    let { guild: t } = e,
        n = (0, u.bG)([tU.h], () => tU.h.getNewMemberActions(t.id), [t.id]),
            ...
            (0, s.jsxs)(ec.D, {
                ...
                children: [
                    (0, s.jsxs)("div", {
                        className: n4.A1,
                        children: [
                            (0, s.jsx)(x.D, { variant: "heading-sm/bold", children: ex.intl.string(ex.t.SnrR3x) }),
                            (0, s.jsxs)("div", {
                                className: n4.Ib,
                                children: [
                                    (0, s.jsx)(N.E, {
                                        ...
                                        color: "text-muted",
                                        className: n4.Cv,
                                        children: ex.intl.format(ex.t.eqZ1lW, {
                                            numberHook: le,
                                            total: a.toString(),
...
function ll(e) {
    ...
    return (0, s.jsx)(em.G, {
        ...
        text: ex.intl.string(ex.t.xHEzFh),
        selected: n,
        onClick: function () {
            (0, ef.pX)(Y.BVt.CHANNEL(t.id, ep.VV.GUILD_OFFICIAL_MESSAGES));
        },
    });
}
var li = n(514179);
function ls(e) {
    ...
    return (0, s.jsx)(em.G, {
        ...
        text: ex.intl.string(ex.t["KzCF/6"]),
        selected: l,
        onClick: function () {
            (0, ef.pX)(Y.BVt.CHANNEL(t.id, ep.VV.ROLE_SUBSCRIPTIONS));
        },
...
function lm(e) {
    ...
    return (0, s.jsx)(em.G, {
        ...
        text: ex.intl.string(ex.t.al5EXL),
        selected: n,
        onClick: l,
                    ...
                    (0, s.jsx)(ec.D, {
                        ...
                        onClick: function (e) {
                            e.stopPropagation(),
                                ...
                                (i && a) || (0, ef.bG)(Y.BVt.CHANNEL(t, H.Ay.getDefaultChannel(t)?.id));
                        },
...
function lf(e) {
    let { guild: t, selected: l } = e;
    function i() {
        lr.w.set(lA.bJ, "true"), (0, ef.pX)(Y.BVt.CHANNEL(t.id, ep.VV.GUILD_SHOP));
    }
    return (0, ld.P)(t)
...
function lG(e) {
    ...
    return (0, s.jsxs)(s.Fragment, {
        children: [
            (0, s.jsx)(ed.m, {
                asContainer: !0,
                text: ex.intl.string(ex.t["96ANUN"]),
                children: (0, s.jsx)(ec.D, {
                    className: e_.Xs,
                    onClick: a,
                    tabIndex: n,
                    "aria-label": ex.intl.string(ex.t["96ANUN"]),
                    children: (0, s.jsx)(S.H, { size: "xs", color: "currentColor", className: e_.gE }),
                }),
            }),
            (0, s.jsx)(ed.m, {
                asContainer: !0,
                text: ex.intl.string(ex.t.ZXxLQg),
                children: (0, s.jsx)(ec.D, {
                    className: e_.Xs,
                    onClick: o,
                    tabIndex: n,
                    "aria-label": ex.intl.string(ex.t.ZXxLQg),
                    children: (0, s.jsx)(I.o, { size: "xs", color: "currentColor", className: e_.gE }),
                }),
            }),
        ],
    });
...
let lH = r.memo(function (e) {
        let { thread: t, isSelectedChannel: l, isSelectedVoice: i, isLast: a, withGuildIcon: o } = e,
            ...
            b =
                g > 0
                    ? ex.intl.formatToPlainString(ex.t["ZL7+I6"], { channelName: t.name, mentionCount: g })
                    : A
                      ? ex.intl.formatToPlainString(ex.t.YlVvmc, { channelName: t.name })
                      : ex.intl.formatToPlainString(ex.t["0nZpiF"], { channelName: t.name });
        return (0, s.jsxs)("li", {
            role: _,
            className: ez()(e_.fx, { [e_.wH]: l }),
            children: [
                ...
                (0, s.jsx)(tJ.vN, {
                    ...
                    children: (0, s.jsxs)("div", {
                        className: ez()(e_.Ki, nq.iE, nq.ZS, {
                            [nq.J1]: l,
                            [nq.F4]: !l && f,
                            [nq.V2]: !f && !l && A,
                            [nq.lY]: o,
    ...
    lB = r.memo(function (e) {
        ...
        return (0, s.jsx)("li", {
            ...
            children: (0, s.jsxs)("ul", {
                role: "group",
                "aria-label": ex.intl.formatToPlainString(ex.t.EiyIi6, { channelName: a }),
                children: [
                    (0, s.jsx)("div", {
...
let l5 = function (e) {
    let { type: t, guildId: l, closePopout: i } = e,
        ...
        } = a,
        {
            ...
            {
                let e = ex.intl.string(ex.t["6zY8BI"]),
                    {
                        notClaimed: n,
                        notPhoneVerified: l,
                        notEmailVerified: i,
                ...
                return n
                    ? { header: e, body: ex.intl.string(ex.t.IRxUlG), buttonText: ex.intl.string(ex.t.fiNVin) }
                    : l
                      ? { header: e, body: ex.intl.string(ex.t.vW8iUF), buttonText: ex.intl.string(ex.t["50gfOv"]) }
                      : i
                        ? { header: e, body: ex.intl.string(ex.t.vdSOpz), buttonText: ex.intl.string(ex.t.lm1UKt) }
                        : s
                          ? {
                                header: e,
                                body: ex.intl.formatToPlainString(ex.t.v1ktYb, { min: Y.$8o.MEMBER_AGE }),
                                buttonText: ex.intl.string(ex.t.BddRzS),
                            }
                          : r
                            ? {
                                  header: e,
                                  body: ex.intl.formatToPlainString(ex.t.sncw41, { min: Y.$8o.ACCOUNT_AGE }),
                                  buttonText: ex.intl.string(ex.t.BddRzS),
                              }
                            : a && null != o && null === o.tags.guild_connections
                              ? {
                                    header: e,
                                    body: ex.intl.format(ex.t.MZbCuG, { roleName: `@${o.name}` }),
                                    buttonText: ex.intl.string(ex.t["6Ge2LG"]),
                                }
                          ...
                          (0, s.jsxs)("div", {
                              ...
                              children: [
                                                          ...
                                                          : d
                                                            ? (lZ.A.verifyResend(),
                                                              (0, lX.A)({
                                                                  ...
                                                                  subtitle: ex.intl.format(ex.t.azKEPy, {
                                  ...
                                  o || c || d
                                      ? (0, s.jsx)(lJ.Q, {
                                            onClick: i,
                                            text: ex.intl.string(ex.t.oEAioF),
                                            variant: "secondary",
                                        })
                                      : null,
                              ],
...
function ix(e) {
    ...
    if (c)
        return (0, s.jsx)(eh.Lp, { text: ex.intl.string(ex.t.y2b7CA), color: h.A.colors.BADGE_BACKGROUND_BRAND.css });
    if (!A && g === nM.e.ALL_MESSAGES && t.isForumLikeChannel() && null != I && I > 0)
        return (0, s.jsx)(N.E, {
            variant: "text-xs/semibold",
            color: "text-brand",
            children: ex.intl.format(ex.t.GkAbqY, { count: (0, eh.Gu)(I) }),
        });
    if (!A && t.isForumLikeChannel() && null != b && b > 0)
        return (0, s.jsx)(N.E, { variant: "text-xs/semibold", color: "text-muted", children: (0, eh.Gu)(b) });
    let R = i?.length ?? 0;
    return null != r && r && S
        ? (0, s.jsx)(lT, { userCount: R, video: x || _, channel: t })
        : l && (0, im.t)(i) && G
          ? (0, s.jsx)(eh.Lp, { text: ex.intl.string(ex.t.dI3q4h), color: h.A.unsafe_rawColors.RED_400.css })
          : null != E
...
class i_ extends nj {
    ...
    renderOpenChatButton = () => {
        ...
        if (!t)
            return (0, s.jsx)(ed.m, {
                ...
                text: ex.intl.string(ex.t.ZXxLQg),
                children: (0, s.jsx)(ec.D, {
                    className: ez()(e_.Xs, n ? e_.Tf : null),
                    onClick: () => {
    ...
    renderChannelInfo() {
        ...
        return null == e ? null : (0, s.jsx)("div", { className: e_.yW, children: e });
    }
    getTooltipText = () => {
        let { connected: e } = this.props;
        return this.isFull() && !e ? ex.intl.string(ex.t.rZfiNq) : null;
    };
    renderSubtitle = () => {
    ...
    render() {
        let {
            ...
            E = (0, s.jsxs)("li", {
                className: ez()(this.getModeClass(), { [e_.r9]: this.isDisabled() }),
        ...
        class extends nj {
            ...
            render() {
                let {
                    ...
                    a = (0, s.jsx)("li", {
                        className: ez()(this.getClassName(), { [e_.r9]: this.isDisabled() }),
                        "data-dnd-name": (0, t0.m1)(e, l2.default, ir.A),
                        children: (0, s.jsxs)(ny.Ay, {
                            className: e_.Ki,
                            channel: e,
...
function iM(e) {
    ...
    switch (e.type) {
        ...
        case "go-live":
            return { subtitle: ex.intl.string(ex.t.Pa817q) };
    }
    return null;
}
var iL = n(3322),
        ...
        (0, s.jsxs)("div", {
            ...
            children: [
                (0, s.jsx)(N.E, {
                    ...
                    color: "text-muted",
                    className: ik.DD,
                    children: t.isForumLikeChannel() ? ex.intl.string(ex.t.ioVdO2) : ex.intl.string(ex.t.VNYs2v),
                }),
                (0, s.jsxs)("div", {
                    className: ik.p_,
                    children: [
                            ...
                            children: [
                                ...
                                (0, s.jsx)("div", {
                                    ...
                                    children: (0, s.jsx)(N.E, {
                                        ...
                                        color: "none",
                                        children: ex.intl.string(ex.t["4qdZ93"]),
                                    }),
                                }),
                            ],
                        }),
...
class i6 extends nj {
    ...
    render() {
        let {
            ...
            R = iM(m),
            v = (0, s.jsxs)("li", {
                className: ez()(this.getClassName(), { [e_.r9]: this.isDisabled(), [e_.wH]: n }),
                "data-dnd-name": (0, t0.m1)(e, l2.default, ir.A),
    ...
    return (0, s.jsxs)(ec.D, {
        ...
        children: [
            ...
            (0, s.jsx)(N.E, {
                variant: "text-xs/semibold",
                className: sx.pM,
                children: ex.intl.format(ex.t["fDlr+F"], { count: d.length }),
            }),
            (0, s.jsx)(st.A, {
                guildId: t.id,
                className: sx.J$,
                        ...
                        return (0, s.jsxs)(ec.D, {
                            ...
                            children: [
                                ...
                                (0, s.jsx)(N.E, {
                                    ...
                                    color: "interactive-text-default",
                                    className: sx.pM,
                                    children: ex.intl.string(ex.t.FCRiT3),
                                }),
                            ],
                        });
                    case sl.MENTIONS:
                        return (0, s.jsx)(ec.D, {
                            ...
                            children: (0, s.jsx)(N.E, {
                                ...
                                className: sx.pM,
                                children: ex.intl.format(ex.t.EQcLyp, { count: A }),
                            }),
                        });
...
function sy(e) {
    ...
    let d = (0, tH.Ay)(t.id),
        c = d.length > 0 ? ex.intl.formatToPlainString(ex.t.IBdqSu, { number: d.length }) : ex.intl.string(ex.t.tlopTM);
    return (0, s.jsx)(em.G, {
        ...
        showUnread: i && !a,
        trailing: !a && r > 0 ? (0, s.jsx)(eh.hV, { className: nq.Do, disableColor: !0, count: r }) : null,
    });
}
var sM = n(152367),
    sL = n(972786),
...
function sO(e) {
    let { guild: t, selected: n } = e,
        ...
        i = (0, u.bG)([sU.Ay], () => sU.Ay.getChannelId(), []),
    ...
    return (0, s.jsx)(em.G, {
        ...
        text: ex.intl.string(sD.default.Xmvb23),
        selected: n,
        trailing: (0, s.jsx)(sT.iT, { guildId: t.id }),
        onClick: () => {
            let e = i === ep.VV.VIBEGRATIONS && r === t.id;
            (0, ef.pX)(Y.BVt.CHANNEL(t.id, ep.VV.VIBEGRATIONS, null == l || e ? null : l));
        },
    });
}
var sP = n(845056),
...
function sQ(e) {
    let { channel: t, imageUrl: l, animatedUrl: i, bannerHash: a, canModifyHangout: o } = e,
        d = (0, sW.S)(l),
        c = (0, eH.je)(t),
        u = (0, sX.P9)({ guildId: t.guild_id, channelId: t.id, bannerHash: a }),
        h = r.useCallback(() => {
            (0, sX.J_)({ guildId: t.guild_id, channelId: t.id }), (0, sJ.A)({ channel: t });
        }, [t]),
        A = r.useCallback(() => {
            (0, sX.nK)({ guildId: t.guild_id, channelId: t.id }), (0, sY.e2)(t.id);
        }, [t.guild_id, t.id]),
        g = r.useCallback(
            (e) => {
                c
    ...
    return (0, s.jsxs)("div", {
        ...
        children: [
            (0, s.jsx)("div", {
                ...
                children: (0, s.jsx)(sq.A, { imageUrl: l, animatedUrl: i, className: s$.Sl }),
            }),
            o
                ? (0, s.jsxs)("div", {
                      className: s$.n_,
                      children: [
                          (0, s.jsx)(ed.m, {
                              text: ex.intl.string(sZ.default.XJ4UpB),
                              children: (0, s.jsx)(ec.D, {
                                  className: s$.HF,
                                  onClick: h,
                          ...
                          (0, s.jsx)(ed.m, {
                              text: ex.intl.string(sZ.default.XV4qT6),
                              children: (0, s.jsx)(ec.D, {
                                  className: s$.HF,
                                  onClick: A,
                                  children: (0, s.jsx)(sK.u, { size: "xs", color: "currentColor" }),
                              }),
                          }),
                      ],
                  })
...
function s0(e) {
    let { channel: t } = e,
        n = (0, sX.dX)({ guildId: t.guild_id, channelId: t.id }),
        l = r.useCallback(() => {
            (0, sX.J_)({ guildId: t.guild_id, channelId: t.id }), (0, sJ.A)({ channel: t });
        }, [t]);
    return (0, s.jsx)("div", {
        ...
        children: (0, s.jsxs)(ec.D, {
            ...
            children: [
                ...
                (0, s.jsx)(N.E, {
                    variant: "text-sm/medium",
                    color: "currentColor",
                    children: ex.intl.string(sZ.default.NGcIOF),
                }),
            ],
        }),
    });
...
function s1(e) {
    let { channel: t, isConnected: n } = e,
        { enableHangoutWindow: l } = (0, ew.Dm)({ guildId: t.guild_id, location: "HangoutWindow" }),
        i = (0, eH.W6)(t),
        a = n && i,
        o = t.voiceHangout,
        d = o?.banner_hash,
        c = r.useMemo(() => {
            ...
            let e = (0, eH.Sq)({ guildId: t.guild_id, bannerHash: d });
...
function re(e) {
    let { channel: t, connected: n, hovered: l, subtitle: i, onClick: a } = e,
        o = (0, s5.G)((0, s7.l)(t)),
        { enableHangoutWindow: d } = (0, ew.Dm)({ guildId: t.guild_id, location: "VoiceChannelStatus" }),
        c = d && (0, eH.lr)(t),
        u = null != o && o.length > 0,
        h = (0, s9.Ay)(t, !0),
        A = null != i && i.length > 0;
    ...
    return u
        ? (0, s.jsx)(ec.D, {
              ...
              children: (0, s.jsx)(N.E, {
                  variant: "text-xs/medium",
                  className: ez()(s8.qS, s4.PT),
                  children: (0, s.jsx)(tY.A, { children: s6.A.parseVoiceChannelStatus(o, !0, { channelId: t.id }) }),
              }),
          })
        : n && h && !c && (!A || l)
          ? (0, s.jsxs)(ec.D, {
                ...
                children: [
                    (0, s.jsx)(N.E, {
                        variant: "text-xs/medium",
                        className: s8.qS,
                        children: ex.intl.string(ex.t.Mgpxiw),
                    }),
                    (0, s.jsx)(sF.R, { color: "currentColor", className: s8.rD, size: "xxs" }),
                ],
            })
          : A
...
class rt extends nj {
    ...
    renderHangoutWindow() {
        ...
        return !(null != n && n.length > 0) || l ? null : (0, s.jsx)(s1, { channel: e, isConnected: t });
    }
    renderPopout = () => {
        let { channel: e } = this.props,
            { shouldShowGuildVerificationPopout: t } = this.state;
    ...
    render() {
        let {
            ...
            R = (0, s.jsxs)("li", {
                ref: this.ref,
                className: ez()(this.getModeClass(), { [e_.r9]: this.isDisabled(), [e_.fy]: _ }),
                "data-dnd-name": (0, t0.m1)(e, l2.default, ir.A),
                children: [
                    _ &&
                        (0, s.jsxs)(s.Fragment, {
                            children: [
                                (0, s.jsx)("div", { className: e_.UQ }),
                                (0, s.jsx)("div", { className: e_.l0 }),
                            ],
                        }),
                    (0, s.jsx)("div", {
...
function rl(e) {
    let {
        ...
        { enabled: g } = sk.A.useExperiment({ guildId: t.id, location: "VoiceChannel" }),
        m = (0, ia.Ay)(n),
        f = (0, u.yK)([s3.A, s2.A, il.default], () => {
            if (null == o || 0 === o.length) return [];
            let e = il.default.getId(),
                t = [];
            for (let { user: l } of o)
                for (let i of l.id === e ? s3.A.getActivities() : s2.A.getActivities(l.id, n.guild_id))
                    !(0, sP.N)(i) || (0, sV.A)(i) || null == i.name || t.includes(i.name) || t.push(i.name);
            return t;
        }, [o, n.guild_id]),
        p = (0, t0.Ay)(n),
        C = (0, tH.Qs)(n.id),
        E = (0, u.bG)([sH.A], () => sH.A.getStartTime(n), [n]),
...
class rr extends r.PureComponent {
    ...
    getRowHeight = (e, t) => {
        ...
        if (d.record.isGuildVoice()) {
            ...
            if (null != e && e.length > 0) {
                let t = 32 * e.length;
                if (
                    (d.isCollapsed || c.isCollapsed ? (t = 32) : (0, ek.Ln)(d.record) && (t += 32),
                    (a += t + h.A.space.SPACE_XS.resolve({ density: r })),
                    !d.isCollapsed && !c.isCollapsed)
                ) {
                    let { enableHangoutWindow: e } = (0, ew.kY)({
                        guildId: d.record.guild_id,
                        location: "ChannelList",
                    });
                    e && ((0, eH.lr)(d.record) ? (a += 134) : s === d.id && (a += 44));
                }
            }
    ...
    dismissRecents = () => {
        ...
        null != n && s.includes(n) && (i = (0, eF.xb)(t)), (0, eF.DD)(e.id, s, i);
    };
    renderSection = (e) => {
        let { section: t } = e,
            {
        ...
        if (t === tI.PU) {
            ...
            switch (t) {
                ...
                case tW.n.GUILD_SPACE:
                    return (0, s.jsx)(eV, { guild: l, selected: a === ep.VV.GUILD_SPACE }, tW.n.GUILD_SPACE);
                case tW.n.GUILD_HOME:
                    return (0, s.jsx)(n5, { guild: l, selected: a === ep.VV.GUILD_HOME }, tW.n.GUILD_HOME);
                ...
                case tW.n.GUILD_ROLE_SUBSCRIPTIONS:
                    return (0, s.jsx)(
                        ls,
                        { guild: l, selected: a === ep.VV.ROLE_SUBSCRIPTIONS },
                        tW.n.GUILD_ROLE_SUBSCRIPTIONS,
                    );
                case tW.n.GUILD_SHOP:
                    return (0, s.jsx)(lf, { guild: l, selected: a === ep.VV.GUILD_SHOP }, tW.n.GUILD_SHOP);
                case tW.n.GUILD_GAME_SHOP:
                    return (0, s.jsx)(nZ, { guild: l, selected: a === ep.VV.GAME_SHOP }, tW.n.GUILD_GAME_SHOP);
                case tW.n.GUILD_VIBEGRATIONS:
                    return (0, s.jsx)(sO, { guild: l, selected: a === ep.VV.VIBEGRATIONS }, tW.n.GUILD_VIBEGRATIONS);
                case tW.n.GUILD_NEW_MEMBER_ACTIONS_PROGRESS_BAR:
                    return (0, s.jsx)(lt, { guild: l });
                case tW.n.CHANNELS_AND_ROLES:
                    return (0, s.jsx)(
                        n9,
                        { guild: l, selected: a === ep.VV.CHANNEL_BROWSER || a === ep.VV.CUSTOMIZE_COMMUNITY },
                ...
                case tW.n.GUILD_MOD_DASH_MEMBER_SAFETY:
                    return (0, s.jsx)(
                        eO,
                        { guild: l, selected: a === ep.VV.MEMBER_SAFETY },
                        tW.n.GUILD_MOD_DASH_MEMBER_SAFETY,
                    );
                case tW.n.GUILD_BOOSTS:
                    return (0, s.jsx)(e9, { guildId: l.id, selected: a === ep.VV.GUILD_BOOSTS }, tW.n.GUILD_BOOSTS);
                case tW.n.GAME_SERVERS:
                    return (0, s.jsx)(ev, { guildId: l.id, selected: a === ep.VV.GAME_SERVERS }, tW.n.GAME_SERVERS);
                case tW.n.GAME_SERVERS_EMPTY:
                    return (0, s.jsx)(
                        eS,
                        { guildId: l.id, selected: a === ep.VV.GAME_SERVERS },
                        tW.n.GAME_SERVERS_EMPTY,
                    );
                case tW.n.GUILD_OFFICIAL_MESSAGES:
                    return (0, s.jsx)(
                        ll,
                        { guild: l, selected: a === ep.VV.GUILD_OFFICIAL_MESSAGES },
    ...
    renderTopUnread() {
        ...
        return (0, s.jsx)("div", {
            ...
            children: (0, s.jsx)(sv, {
                ...
                textUnread: ex.intl.string(ex.t.FCRiT3),
                textMention: ex.intl.string(ex.t["8zH0LJ"]),
            ...
            children: (l) =>
                (0, s.jsx)(f.F, {
                    component: (0, s.jsx)(p.A, {
                        children: (0, s.jsx)(f.H, { id: l, children: ex.intl.string(ex.t.OGiMXJ) }),
                    }),
                    children: n
                        ? (0, s.jsxs)(r.Fragment, {
                              children: [
...
function ro(e) {
    ...
    return n
                      ...
                      (0, s.jsxs)(E.B, {
                          ...
                          children: [
                              (0, s.jsx)(x.D, {
                                  ...
                                  children: ex.intl.string(ri.default["1n0TGE"]),
                              }),
                              (0, s.jsx)(N.E, {
                                  variant: "text-sm/medium",
                                  color: "text-muted",
                                  children: ex.intl.string(ri.default.Wwzrs9),
                              }),
                          ],
                      }),
        ...
        : (0, s.jsx)(ra, { ...e, guildChannels: t, guildChannelsVersion: 0, withGuildIcon: !1, density: l });
}
function rd(e) {
    let t = (function (e) {
            var t;
            let n,
                ...
                o = (0, tK.jz)(e),
                d = (0, tO.d)(e.id),
                c = (0, tv.bG)([tU.h], () => tU.h.getNewMemberActions(e.id), [e.id]),
            ...
            let _ = tr(e),
                S = (0, tk.bW)(e.id, "useGuildActionRows"),
                I = (0, ty.C$)(e.id, "useGuildActionRows"),
                b = e.features.has(Y.GuildFeatures.GAME_SERVERS),
                G = (0, tM.N)("useGuildActionRows"),
                [R] = (0, eg.kn)(I && G && !b ? [eo.M.EMPTY_GAME_SERVER_TAB] : [], void 0, !0);
            return (
