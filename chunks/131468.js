...
class s extends i.Z {
    _initialize() {
        __OVERLAY__ ||
            ...
            r.Z.subscribe("GUILD_SOUNDBOARD_SOUND_PLAY_LOCALLY", this._handleSoundboardSoundPlayLocally),
            r.Z.subscribe("VOICE_CHANNEL_SELECT", this._handleVoiceChannelSelect),
            r.Z.subscribe("AUDIO_TOGGLE_SELF_DEAF", this._handleToggleSelfDeafened));
    }
    _terminate() {
        __OVERLAY__ ||
            (r.Z.unsubscribe("VOICE_CHANNEL_EFFECT_SEND", this._handleSoundboardSoundReceived),
            r.Z.unsubscribe("GUILD_SOUNDBOARD_SOUND_PLAY_LOCALLY", this._handleSoundboardSoundPlayLocally),
            r.Z.unsubscribe("VOICE_CHANNEL_SELECT", this._handleVoiceChannelSelect),
            r.Z.unsubscribe("AUDIO_TOGGLE_SELF_DEAF", this._handleToggleSelfDeafened));
    }
    constructor(...e) {
        super(...e),
