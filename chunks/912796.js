...
function ed(e) {
    ...
    function o(n, r) {
        ...
        [H, K, eu, q].forEach((e) => e(n, r)),
            e.compilerExtensions.forEach((e) => e(n, r)),
            (n.__beforeBegin = null),
            [Y, W, z].forEach((e) => e(n, r)),
            (n.isCompiled = !0);
        let s = null;
        return (
            "object" == typeof n.keywords &&
                n.keywords.$pattern &&
                ((n.keywords = Object.assign({}, n.keywords)), (s = n.keywords.$pattern), delete n.keywords.$pattern),
            (s = s || /\w+/),
    ...
    ey = function (e) {
        ...
        function f(e) {
            ...
            if (n) {
                let t = P(n[1]);
                return (
                    t || (er(s.replace("{}", n[1])), er("Falling back to no-highlight mode for this block.", e)),
                    t ? n[1] : "no-highlight"
                );
            }
        ...
        function b(e, t, i, a) {
            ...
            function d() {
                if (!D.keywords) return void L.addText(x);
                let e = 0;
            ...
            function f() {
                ...
                if ("string" == typeof D.subLanguage) {
                    if (!r[D.subLanguage]) return void L.addText(x);
                    (e = b(D.subLanguage, x, !0, w[D.subLanguage])), (w[D.subLanguage] = e._top);
                } else e = v(x, D.subLanguage.length ? D.subLanguage : null);
            ...
            function m(e, t) {
                return (
                    e.scope && "string" == typeof e.scope && L.openNode(C.classNameAliases[e.scope] || e.scope),
                    e.beginScope &&
                        (e.beginScope._wrap
                            ? (p(x, C.classNameAliases[e.beginScope._wrap] || e.beginScope._wrap), (x = ""))
            ...
            function O(e) {
                ...
                return (
                    r.skip ? (x += t) : (r.excludeBegin && (x += t), _(), r.returnBegin || r.excludeBegin || (x = t)),
                    m(r, e),
            ...
            function I(e) {
                ...
                D.endScope && D.endScope._wrap
                    ? (_(), p(n, D.endScope._wrap))
                    : D.endScope && D.endScope._multi
                      ? (_(), h(D.endScope, e))
                      : a.skip
                        ? (x += n)
                        : (a.returnEnd || a.excludeEnd || (x += n), _(), a.excludeEnd && (x = n));
                do D.scope && L.closeNode(), D.skip || D.subLanguage || (M += D.relevance), (D = D.parent);
                while (D !== i.parent);
        ...
        function R(t, n) {
            ...
            i.name || (i.name = t),
                ...
                i.aliases && D(i.aliases, { languageName: t });
        }
        function P(e) {
