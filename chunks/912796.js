...
function es(e) {
    if (Array.isArray(e.begin)) {
        if (e.skip || e.excludeBegin || e.returnBegin)
            throw (en("skip, excludeBegin, returnBegin not compatible with beginScope: {}"), eo);
        if ("object" != typeof e.beginScope || null === e.beginScope) throw (en("beginScope must be object"), eo);
        ea(e, e.begin, { key: "beginScope" }), (e.begin = v(e.begin, { joinWith: "" }));
    }
}
function el(e) {
    if (Array.isArray(e.end)) {
        if (e.skip || e.excludeEnd || e.returnEnd)
            throw (en("skip, excludeEnd, returnEnd not compatible with endScope: {}"), eo);
        if ("object" != typeof e.endScope || null === e.endScope) throw (en("endScope must be object"), eo);
        ea(e, e.end, { key: "endScope" }), (e.end = v(e.end, { joinWith: "" }));
    }
}
function ec(e) {
...
let em = r,
    ...
    ey = function (e) {
        ...
        function b(e, t, i, o) {
            ...
            function m(e, t) {
                return (
                    e.scope && "string" == typeof e.scope && L.openNode(N.classNameAliases[e.scope] || e.scope),
                    e.beginScope &&
                        (e.beginScope._wrap
                            ? (p(x, N.classNameAliases[e.beginScope._wrap] || e.beginScope._wrap), (x = ""))
            ...
            function I(e) {
                ...
                w.endScope && w.endScope._wrap
                    ...
                    : w.endScope && w.endScope._multi
                      ...
                      : o.skip
                        ? (x += n)
                        : (o.returnEnd || o.excludeEnd || (x += n), _(), o.excludeEnd && (x = n));
