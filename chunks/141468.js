"use strict";
n.d(t, { IU: () => v, SP: () => N, ec: () => w, ei: () => L, rh: () => y }), n(938796);
var r = n(989349),
    i = n.n(r),
    s = n(833291),
    a = n(814890),
...
function y(e) {
    ...
    return (
        ...
        new c.Ay({
            ...
            giftCodes: (0, E.pF)(e) ? (0, E.e7)(e?.embeds[0].url) : (0, E.e7)(e.content),
            content: L,
            referralTrialOfferId: t,
            premiumGroupInviteId: n,
            call: O(e.call, s.timestamp),
...
function v(e, t) {
    ...
    return (
        ...
        null != t.attachments && (n = n.set("attachments", C(t))),
        ...
        null != t.embeds && (n = n.set("embeds", R(t))),
...
function D(e) {
    return null == e.message_snapshots
        ...
        : e.message_snapshots.map((e) => {
              ...
              return new c.vF({ message: S(t), moderator_report: n });
          });
}
