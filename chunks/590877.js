...
let s = (0, i.C)({
    ...
    treatments: [
        { id: 1, label: "Hide Browse Channels when all channels are visible", config: { alwaysShowDirectory: !1 } },
    ],
});
function a(e) {
    let { alwaysShowDirectory: t } = s.useExperiment({ location: "useShowBrowseChannelsExperiment" });
    return t || !e;
}
