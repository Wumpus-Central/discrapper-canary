n.d(t, { iV: () => cH, OC: () => cB, Ay: () => cV }), n(938796);
var i,
    l = n(477900),
    s = n(582128),
    a = n(503698),
...
function el(e) {
    let { app: t, linkType: n, activityCustomId: i, activityReferrerId: a, message: r, onView: o } = e,
        ...
        { currentChannelId: v, instanceId: N, isCurrentlyInInstance: b, canLaunchInChannel: k } = (0, V.w)(t.id),
        M = (0, T.A)(),
        ...
        }, [h, z, H, t.id, G, U, N, b, v, M, i, C, _, m]),
...
function es(e) {
    let { app: t } = e,
        ...
        i = (0, d.bG)([M.default], () => M.default.locale, []),
        a = s.useMemo(() => {
            if (!n) return null;
                ...
                children: [
                    ...
                    eJ.p5 &&
                        (0, l.jsx)(eR.K, {
                            ...
                            onClick: () => {
                                (0, eJ.C)(s, () => {
                                    (0, ek.P0)((0, eM.o)(W.intl.string(W.t["L/PwZf"]), eO.Ck.SUCCESS)), o();
                                });
                            },
                            variant: "icon-only",
                        }),
        ...
        ? (0, l.jsxs)("div", {
              ...
              children: [
                  (0, l.jsxs)("div", {
                      className: tu.mp,
                      children: [
                          (0, l.jsx)(e7.k, { size: "xs", color: "currentColor", className: tu.Kk }),
                          (0, l.jsx)(e9.D, {
...
function nP(e) {
    ...
    let v = (0, t5.Q)(t),
        ...
        L = (0, nj.X)(N),
        k = (0, ne.f)({ product: t, analyticsLocations: o }),
        M = (0, ns.G)({
            skuId: j,
            product: N,
        ...
        B = H ? (0, l.jsx)(nO, { product: N, hasShopDiscount: w, analyticsLocations: o }) : null,
        F = L
            ? (0, l.jsx)(no.A, {
                  primary: !0,
                  product: t,
    ...
    return (0, l.jsxs)("div", {
        ...
        children: [
            u && (0, l.jsx)(nk, {}),
            (0, l.jsx)(nM, { disableFetch: !(0, ni.Vx)(N) }),
                ...
                children: [
                    ...
                    (0, l.jsxs)("div", {
                        ...
                        children: [
                            ...
                            (0, l.jsxs)(tz.e, { wrap: !1, fullWidth: !0, children: [V, B, F] }),
                        ],
                    }),
                ],
            }),
    ...
    return null == r
        ...
        : (0, l.jsxs)(eP.D, {
              ...
              children: [
                  ...
                  (0, l.jsx)(n7._, { size: "xxs", color: nw.A.colors.TEXT_MUTED }),
              ],
          });
}
function iv(e) {
        ...
        ? (0, l.jsxs)(tB.s, {
              ...
              children: [
                  (0, l.jsxs)("div", {
                      ...
                      children: [
                          null != a &&
                              (0, l.jsx)("div", { className: iM.Tp, style: { backgroundImage: `url("${a}")` } }),
                          (0, l.jsx)("div", { className: iM.N4 }),
                      ],
                  }),
                  (0, l.jsxs)("div", {
                      className: iM.rf,
                      children: [
                          null != s
                              ? (0, l.jsx)("img", { src: s, alt: "", className: iM.Kk, draggable: !1 })
                              : (0, l.jsx)("div", {
                                    "aria-hidden": !0,
                                    className: iM.EU,
...
function lJ(e) {
    let { embedUrl: t, message: n, channel: i } = e,
        ...
        T = (0, lM.gn)(C?.guildId, c?.authorId ?? void 0, N),
    ...
    let M = (0, w.F_)({ avatarDecoration: _, size: (0, ly.Te)(tE._3.SIZE_40), canAnimate: y }),
...
let sl = (e) => {
    let { reportingUserId: t, guildId: n, compact: i, channel: a, messageId: o, reportedTimestamp: c } = e,
        ...
        u = s.useMemo(() => (i ? (0, l9.A)((0, iu.i$)(l4()(), "LT")) : null), [i]),
        ...
        children: [
            ...
            (0, l.jsxs)(p.E, {
                ...
                children: [
                    ...
                    (0, l.jsx)(l7.A, { timestamp: c, className: st.vE }),
                ],
            }),
        ],
    });
...
function sr(e) {
    let { mergedMessageRecord: t, content: n, channel: i, reportingUserId: a, reportedTimestamp: r } = e,
        o = (0, t_.m2)(t.author, i),
        {
            ...
            let { popouts: n, setPopout: i } = (0, lk.A)(e.id, lF.Fd),
...
function s_(e) {
    let { iconType: t } = e,
        n = {
            default: (0, l.jsx)(e7.k, { size: "xs", color: nw.A.colors.TEXT_LINK.css }),
...
function s0(e) {
    ...
    o || null == r)
        ...
        : (0, l.jsxs)(sL.Uq, {
              className: sZ.Bm,
              children: [
                  (0, l.jsx)(e9.D, { variant: "heading-md/semibold", children: n.name }),
                  (0, l.jsx)(p.E, {
                      variant: "text-sm/normal",
                      children: c
        ...
        s.useEffect(() => {
            ...
            !(async function () {
                if (null == e || e.features.has(K.GuildFeatures.DISCOVERABLE)) {
                    ...
                    u(
                        await ((t = n.id),
                        sB.Bo.get({ url: K.Rsh.STICKER_GUILD_DATA(t), oldFormErrors: !0, rejectWithError: !0 })
...
var s5 = n(751686);
let s6 = (0, sk.xI)(sy.A.STICKERS_CONSTANTS_STICKER_DIMENSION),
    s4 = (e) => {
                        ...
                        (0, l.jsx)(i6.A.Info, {
                            ...
                            children: (0, l.jsxs)("span", {
                                ...
                                children: [
                                    ...
                                    (0, l.jsx)("span", {
                                        className: lm.E3,
                                        children: (0, l.jsx)(aM.A, { guild: t, isBannerVisible: !1 }),
                                    }),
                                ],
                            }),
                        }),
...
function rO(e) {
    ...
    let s = i.icon;
    return (0, l.jsx)(tF.m, { text: i.getLabel(), children: (0, l.jsx)(s, { className: n }) });
}
function rP(e) {
    let { systems: t, className: n, iconClassName: i } = e;
    return (0, l.jsx)("div", {
        className: r()(rk.I, n),
        children: t.map((e) => (0, l.jsx)(rO, { operatingSystem: e, className: r()(rk.A, i) }, e)),
    });
}
var rD = n(198985);
let rU = function (e) {
...
function r8(e) {
    ...
    return (0, l.jsxs)(eP.D, {
        ...
        onClick: t,
        children: [
            (0, l.jsx)(a4._, { size: "md", color: "currentColor", className: r9.dy }),
...
class ot extends s.Component {
    ...
    renderButton(e) {
        ...
        return (0, l.jsx)("div", {
            className: (0, t6.hU)(e) ? r9.UQ : void 0,
            children: (0, l.jsx)(eA.$, {
                variant: "primary",
                size: "sm",
                text: o,
    ...
    renderCustomGiftBox = (e) => {
        ...
        let n = nR.Wx.includes(e.giftStyle),
            i = r()(r9.gB, { [r9.El]: n, [r9.by]: t >= a7.Tm }),
            s = r()({ [r9.gc]: n, [r9.Ei]: n && t >= a7.Tm, [r9.ww]: !n, [r9.wy]: !n && t >= a7.Tm });
        return (0, l.jsxs)("div", {
            className: i,
            children: [
                n && (0, l.jsx)(rd, { className: r9.nr }),
                null != e.giftStyle &&
                    (0, l.jsx)(ri.A, {
    ...
    render() {
        ...
        if (null == e || e.revoked)
            ...
            else return (0, l.jsx)(a7.Wb, { isHorizontal: i >= a7.Tm });
        return (0, t6.hU)(e)
            ? (0, l.jsx)("div", { className: r9.mp, children: this.renderEmbed() })
            : this.renderEmbed();
    }
}
let on = (0, a8.A)((0, a9.A)(ot)),
    oi = function (e) {
...
function oO(e) {
    ...
    let [M, O] = s.useState(!1),
        P = s.useCallback(() => O(!1), []),
        D = s.useRef(null),
        U = (0, d.bG)([lP.Ay], () => ok([lP.Ay], m)),
        G = s.useCallback(() => {
            O(!0), (0, ol.Pq)(L, "show profile", k);
        }, [L, k]),
        w = s.useCallback(() => {
            let e = "noop";
    ...
    return (
        (i = (0, l.jsxs)("span", {
            ...
            children: [
                ...
                (0, l.jsx)("span", {
                    className: lm.E3,
                    children: (0, l.jsx)(aM.A, { guild: u, isBannerVisible: !1, disableBoostClick: !0 }),
                }),
            ],
        })),
        y &&
            ...
            ? ((i = (0, l.jsx)(i6.A.Channel, { channel: N })),
              (t = (0, l.jsxs)("span", {
                  ...
                  children: [
                      ...
                      (0, l.jsx)("span", {
                          className: lm.E3,
                          children: (0, l.jsx)(aM.A, { guild: u, isBannerVisible: !1 }),
                      }),
                  ],
              })))
...
function oF(e) {
    ...
    let j = (0, l.jsxs)(l.Fragment, {
        children: [
            ...
            g && !m
                ...
                : null,
            (0, l.jsxs)("div", {
                className: r()(oB.qr, { [oB.iK]: g }),
                children: [
                    g && m ? (0, l.jsx)("div", { className: oB.D7 }) : null,
                    (0, l.jsx)("div", {
                        className: r()(oB.z8, { [oB.it]: g && m }),
                        children: (0, l.jsx)("div", {
                            className: oB.UD,
                            children: (0, l.jsx)(oz, {
                                invite: t,
    ...
    return g
        ? (0, l.jsx)(tB.s, {
              className: r()(oB.Gg, { [oB.vk]: m }),
              onClick: _,
              style: N,
              "aria-label": W.intl.string(W.t.dcl9MQ),
              children: j,
          })
        : (0, l.jsx)("div", { className: oB.Gg, role: "group", "aria-labelledby": u, children: j });
}
function oz(e) {
    let {
            invite: t,
...
function ct(e) {
    ...
    return (0, l.jsxs)(eP.D, {
        ...
        children: [
            ...
            (0, l.jsx)(n7._, { className: ce.t4, color: "currentColor", size: "custom", width: 12, height: 12 }),
        ],
    });
}
var cn = n(296704),
...
function cA(e) {
                ...
                (0, ol.he)(
                    {
                        ...
                        stream_key: null != T ? (0, o7._z)(T) : void 0,
        ...
        R = s.useCallback(() => {
            I ? (0, l2.iN)(m.id) : o({ autoJoin: !1 }),
                ez.default.track(K.HAw.VOICE_INVITE_EMBED_BREADCRUMB_CLICKED, {
                    ...
                    stream_key: null != T ? (0, o7._z)(T) : null,
                    number_of_users_in_channel: g.length,
                    location_stack: N,
                });
    ...
    let L = (0, d.bG)([aY.Ay], () => aY.Ay.useReducedMotion),
        k = s.useRef(null),
        [M, D] = s.useState({ percentX: 0, percentY: 0, proximity: 0 }),
        U = (0, d.bG)([o8.A], () => {
...
function cx(e) {
    ...
    function x() {
        ...
        let l = null == m && a?.guild != null ? om.DY(a.guild) : m;
        (0, oc.g)({
...
class cH extends s.Component {
    ...
    renderCodedLinks(e) {
        ...
        return e.codedLinks.map((n) => {
            ...
            switch (i) {
                ...
                case tM.I.GAME_SERVER_SHARE:
                    return (0, l.jsx)(i1, { code: s }, s);
                case tM.I.USER_PROFILE:
    ...
    renderEmbed = (e, t, n, i) => {
        ...
        return (0, l.jsx)(
            i2.G.Provider,
            {
                value: (0, cM.b)(m, e.image, e.video, e.thumbnail, e.provider?.name),
    ...
    handleEditAttachment = (e) => {
        let t = e.originalItem;
        (0, h.openModalLazy)(async () => {
            let { ModifyMosaicAttachmentModal: i } = await Promise.all([n.e("384081"), n.e("570698")]).then(
                n.bind(n, 427281),
            );
            return (n) =>
                (0, l.jsx)(i, {
