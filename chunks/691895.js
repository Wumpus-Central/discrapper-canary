            ...
            let { index: c, timestamp: d, logs: f, nativeLogs: p, serverTrace: _ } = r,
                m =
                    0 === c
                        ? null !=
                          (s =
                              null == (a = i().find(f, (e) => e.log.indexOf("Logger loaded") >= 0))
                                  ? void 0
                                  : a.timestamp)
                            ? s
                            : e
...
function u(e, t, n, r) {
    ...
    t.forEach((t) => {
        ...
        if (r.startsWith("Finish ") && !r.includes("RUN_JS_BUNDLE") && i.has(r.replace("Finish ", "Start "))) {
            ...
            let e = o.pop();
            null != e &&
                ((s = t.timestamp - e.timestamp), (l = l || (s > 5 && !d(r))), (e.shouldKeep = e.shouldKeep || l));
        }
        let u = {
            emoji: "\u2615",
    ...
    let s = !1;
    return e.filter(
        (e) => !(s && e.log.includes("\u21AA")) && !(s = (!r && "\uD83C\uDFA8" === e.emoji) || !1 === e.shouldKeep),
    );
}
function d(e) {
