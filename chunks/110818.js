...
class E extends (r = l.PureComponent) {
    ...
    render() {
        ...
        return (0, s.jsx)(p.kci, {
            className: u()(_.sequencedAnimation, e),
            ...
            children: [
                n
                    ? (0, s.jsxs)("div", {
                          className: _.panningAnimation,
                          children: [
                              (0, s.jsx)("div", { className: _.tier2Background }),
                              (0, s.jsx)("div", { className: _.tier2Foreground }),
                          ],
                      })
                    : (0, s.jsxs)(s.Fragment, {
                          children: [
