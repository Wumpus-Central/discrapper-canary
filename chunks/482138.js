...
var r,
    ...
    es = function (e) {
        ...
        for (r = 0, n = []; r < t; r++) {
            ...
            if (
                ((o = 10),
                i.length > 1 && "0" === L(i, 0) && ((o = x(J, i) ? 16 : 8), (i = F(i, 8 === o ? 1 : 2))),
                "" === i)
            )
                a = 0;
            else {
...
eF.prototype = {
            ...
            switch (((o = i[u]), c)) {
                ...
                case eU:
                    if (o === r || "/" === o || ("\\" === o && l.isSpecial()) || (!t && ("?" === o || "#" === o))) {
                        if (
                            (ey(d)
                                ? (l.shortenPath(), "/" === o || ("\\" === o && l.isSpecial()) || U(l.path, ""))
                                : eb(d)
                                  ? "/" === o || ("\\" === o && l.isSpecial()) || U(l.path, "")
                                  : ("file" === l.scheme &&
                                        !l.path.length &&
                                        eg(d) &&
        ...
        return (
            null !== i
                ? ((c += "//"),
                  ...
                  null !== o && (c += ":" + o))
                : "file" === t && (c += "//"),
            (c += e.cannotBeABaseURL ? a[0] : a.length ? "/" + M(a, "/") : ""),
            null !== s && (c += "?" + s),
            null !== l && (c += "#" + l),
            c
        );
    ...
    setSearch: function (e) {
        "" === (e = b(e))
            ? (this.query = null)
            : ("?" === L(e, 0) && (e = F(e, 1)), (this.query = ""), this.parse(e, eB)),
            this.searchParams.update();
    },
