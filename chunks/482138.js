...
var r,
    ...
    es = function (e) {
        ...
        for (r = 0, n = []; r < t; r++) {
            ...
            if (
                ((a = 10),
                i.length > 1 && "0" === x(i, 0) && ((a = L(J, i) ? 16 : 8), (i = V(i, 8 === a ? 1 : 2))),
                "" === i)
            )
                o = 0;
            else {
...
eV.prototype = {
    ...
    parseHost: function (e) {
        var t, n, r;
        if ("[" === x(e, 0)) {
            if ("]" !== x(e, e.length - 1) || !(t = el(V(e, 1, -1)))) return K;
            this.host = t;
    ...
    setSearch: function (e) {
        "" === (e = b(e))
            ? (this.query = null)
            : ("?" === x(e, 0) && (e = V(e, 1)), (this.query = ""), this.parse(e, eB)),
            this.searchParams.update();
    },
...
if (
    ...
    eW && u(eF, "createObjectURL", l(eW, N)), eK && u(eF, "revokeObjectURL", l(eK, N));
}
y(eF, "URL"),
    i(
        {
