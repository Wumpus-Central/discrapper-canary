...
var r,
    ...
    el = function (e) {
        ...
        for (; _(); ) {
            ...
            for (t = n = 0; n < 4 && x(et, _()); ) (t = 16 * t + P(_(), 16)), d++, n++;
            if ('.' === _()) {
            ...
            switch (((a = i[u]), c)) {
                ...
                case ev:
                    if (a && (x(X, a) || '+' === a || '-' === a || '.' === a)) d += Z(a);
                        ...
                        if (t && (l.isSpecial() !== f(em, d) || ('file' === d && (l.includesCredentials() || null !== l.port)) || ('file' === l.scheme && !l.host))) return;
                        if (((l.scheme = d), t)) {
                            l.isSpecial() && em[l.scheme] === l.port && (l.port = null);
                            return;
                        }
                        (d = ''), 'file' === l.scheme ? (c = ex) : l.isSpecial() && n && n.scheme === l.scheme ? (c = eT) : l.isSpecial() ? (c = eC) : '/' === i[u + 1] ? ((c = eS), u++) : ((l.cannotBeABaseURL = !0), U(l.path, ''), (c = eG));
                    } else {
                        if (t) return W;
                        (d = ''), (c = eI), (u = 0);
                        continue;
