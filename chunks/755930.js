                            ...
                            (n = (0, r.jsxs)(r.Fragment, {
                                children: [
                                    ...
                                    (0, r.jsxs)(l.Text, {
                                        ...
                                        className: p.listingNameLabel,
                                        children: [t.name, !t.published && (0, r.jsx)(x, {})]
                                    })
                                ]
                            })),
                        (0, r.jsx)(y, {
                            className: p.listingNameCell,
                            children: n
                        })
                    );
                }
...
function _(e) {
    ...
    for (let n = 1; n < e.length; ++n) {
        ...
        })(g({}, r), { cellClassName: a()(r.cellClassName, p.cellAlignRight) });
    }
    return t;
}
let O = (e) => {
...
function E(e) {
    ...
    let [f, b] = i.useState(c),
        [x, j] = i.useState(d);
    return (0, r.jsx)('div', {
        className: a()(p.tableContainer, t),
        children: (0, r.jsx)(
            o.Z,
            g(
                {
                    className: a()({ [p.tableWithoutSeparators]: !l }, p.table),
                    rowClassName: a()({ [p.rowWithSeparators]: l }, s),
                    headerClassName: a()(p.header, { [p.headerWithoutSeparators]: !l }, n),
                    sortKey: f,
                    sortDirection: x,
                    onSort: (e, t) => {
                        b(e), j(t);
