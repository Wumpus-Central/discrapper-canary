...
async function Y(e) {
    ...
    try {
        ...
        (d.Z.show({
            ...
            body: null != (u = null != (l = null == (s = e.getAnyErrorMessage) ? void 0 : s.call(e)) ? l : e.message) ? u : w.intl.string(w.t.eAn6z8)
        }),
            await H({
                channelId: t,
                messageId: n,
...
let q = {
    handlePollAnswerTapped: function (e) {
        ...
        (0, C.eu)(i, o, (e) => {
            ...
            if (null == e) {
                let e = new Set([r]),
                    { analyticsSelectedAnswerIds: t, selectedTextAnswersCount: s, selectedEmojiAnswersCount: l } = G(null == (n = a.poll) ? void 0 : n.answers, e);
                return (
            ...
            let { analyticsSelectedAnswerIds: u, selectedTextAnswersCount: d, selectedEmojiAnswersCount: f } = G(null == (t = a.poll) ? void 0 : t.answers, c);
            return (
                h.ZP.trackWithMetadata(P.rMx.POLL_VOTE_SELECTED, {
                    channel_id: i,
                    message_id: o,
    ...
    createPoll: async function (e) {
        ...
        try {
            ...
            if ('poll' === (e instanceof p.Hx ? e : new p.Hx(e)).getAnyErrorMessage() && null != e.text) throw M(L({}, e), { body: JSON.parse(e.text) });
            throw e;
        }
    },
