...
async function Y(e) {
    ...
    try {
        ...
        ((0, C.eu)(
            ...
            (0, C.eu)(t, n, () => void 0),
            c.uv.announce(0 === e.length ? P.intl.string(P.t['xcvy+/']) : P.intl.string(P.t.o20GSk)));
    } catch (e) {
        var s, l, u;
        (d.Z.show({
            title: P.intl.string(P.t.iufib2),
            body: null != (u = null != (l = null == (s = e.getAnyErrorMessage) ? void 0 : s.call(e)) ? l : e.message) ? u : P.intl.string(P.t.eAn6z8)
        }),
            await H({
                channelId: t,
                messageId: n,
...
let q = {
    handlePollAnswerTapped: function (e) {
        ...
        let { channelId: i, messageId: a, message: o } = U(j(e, ['answerId'])),
            { tapShouldOpenVotersModal: s } = null != (n = (0, w.Tk)(o)) ? n : {};
        if (!0 === s)
            return void Z({
                channelId: i,
                messageId: a,
        ...
        (0, C.eu)(i, a, (e) => {
            ...
            if (null == e) {
                let e = new Set([r]),
                    { analyticsSelectedAnswerIds: t, selectedTextAnswersCount: s, selectedEmojiAnswersCount: l } = G(null == (n = o.poll) ? void 0 : n.answers, e);
                return (
            ...
            let { analyticsSelectedAnswerIds: u, selectedTextAnswersCount: d, selectedEmojiAnswersCount: f } = G(null == (t = o.poll) ? void 0 : t.answers, c);
            return (
                h.ZP.trackWithMetadata(R.rMx.POLL_VOTE_SELECTED, {
                    channel_id: i,
                    message_id: a,
    ...
    createPoll: async function (e) {
        ...
        try {
            ...
            if ('poll' === (e instanceof p.Hx ? e : new p.Hx(e)).getAnyErrorMessage() && null != e.text) throw k(L({}, e), { body: JSON.parse(e.text) });
            throw e;
        }
    },
