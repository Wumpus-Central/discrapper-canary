...
function eh(e) {
    ...
    (0, z.Ay)(() => {
                ...
                if (f)
                    if (null != g && g.hasAnyPremiumGroup) {
                        ...
                        (0, P.openModalLazy)(
                            ...
                            {
                                onCloseRequest: () => {
                                    X._.dispatch(e_.jej.PREMIUM_GROUP_PURCHASE_FLOW_COMPLETED), (0, P.closeModal)(e);
                                },
                                modalKey: e,
                            },
                        );
        ...
        r.useEffect(() => {
            !k || null == N || null == O || v || G || (0, Q.Ik)(N) || L({ onSubscriptionConfirmation: u });
        }, [L, k, N, O, v, G, u]),
        r.useEffect(() => {
            et &&
                null != ei &&
    ...
    else if (k) t = (0, l.jsx)(Y.fw, { planId: R.id, onClose: eu });
    else {
        let e =
            T.current === R.id
                ? { postSuccessGuild: d }
                : {
                      ...
                      isDowngrade: null != x && (0, $.vT)(x, R.id, a),
                  };
        t = (0, l.jsx)(Y.Ay, {
            planId: R.id,
            onClose: eu,
    ...
    return (0, l.jsxs)(l.Fragment, {
        children: [
            (0, l.jsxs)(J.dZ, { children: [(0, l.jsx)(eA.A, {}), t] }),
            null != ee && ee,
    ...
    return null == P
        ...
        : ((0, eo.T)(P)
              ? ((n = eM.R.AVATAR_DECORATION),
                (t = (0, l.jsx)(eG.i, { item: P, user: s, isHighlighted: S, avatarSize: en._3.SIZE_96 })))
              : (0, ed.F)(P) &&
                ((n = eM.R.NAMEPLATE),
                (t = (0, l.jsx)(eL.A, { nameplate: P, user: s, isHighlighted: S, size: "small" }))),
          (0, l.jsx)(eC.vN, {
              children: (0, l.jsxs)(eb.s, {
                  ...
                  children: [
                                        ...
                                        children: [
                                            ...
                                            a &&
                                                (0, l.jsx)(ek.r, {
                                                    ...
                                                    width: 48,
                                                    height: 48,
                                                    color: ey.A.colors.INTERACTIVE_TEXT_ACTIVE,
                                                    className: eU.j0,
                                                }),
                                        ],
                                    })
                      ...
                      (0, l.jsxs)("div", {
                          className: eU.tZ,
                          children: [
                              (0, l.jsx)(eN.D, { variant: "heading-md/extrabold", children: I.name }),
                              (0, l.jsx)(eO.E, {
...
function eB(e) {
    let {
        ...
        S = (0, p.A)(),
        { isGift: I, claimableRewards: P } = (0, C.Pv)();
    i = i ?? E;
    let {
            variant: A,
            text: _,
        ...
        f = r.useMemo(
            () =>
                null != n && u.includes(n)
                    ? [{ variant: A, text: _, onClick: g, disabled: h }]
                    : [{ variant: "primary", text: eE.intl.string(eE.t.XqMe3N), disabled: !0 }],
            [A, _, g, h, n, u],
        );
    return (0, l.jsx)(ew.H, { leading: a && null != s ? (0, l.jsx)(eF.A, { onClick: s }) : void 0, actions: f });
}
let eW = (e) => {
    let {
            onStepChange: t,
    ...
    var P = a ? eE.intl.string(eE.t.PDTjLN) : eE.intl.string(eE.t.XqMe3N),
        A = k.pn.ADD_PAYMENT_STEPS;
    return (
        I && (A = k.pn.REVIEW),
        (0, S.px)(c, l, r) && m !== k.pn.SELECT_FREE_SKU && (A = k.pn.SELECT_FREE_SKU),
...
function eV(e) {
    ...
    r.useEffect(() => {
        ...
        (null != I && g && E.includes(I)) || null == I || (P(void 0), u(void 0));
    }, [E, g, I, u]);
    let f = (e) => {
            u(e), P(e), _(!0);
        },
        x = E.map((e) =>
            (0, l.jsx)(
                eD,
                { skuId: e, claimed: null != d && !d.includes(e), user: c, onSelect: f, selectedSkuId: I },
                e,
            ),
        ),
        T = (0, l.jsx)(J.UX, {
            children: (0, l.jsx)(eB, {
                onStepChange: t,
                onBackClick: () => t(k.pn.PLAN_SELECT),
        ...
        children: [
            ...
            (0, l.jsx)(ex.c, {
                children: (0, l.jsx)(eT.B, {
                    ...
                    justify: "center",
                    align: "center",
                    children: (0, l.jsx)("div", { className: ez.Dq, children: x }),
                }),
            }),
            T,
        ],
...
function ti(e) {
    let { handleStepChange: t, initialPlanId: n, planGroup: i, subscriptionTier: s, trialId: a, handleClose: u } = e,
        ...
        { isPremium: P, isEligibleForTrial: A, isEligibleForDiscount: _, discountOffer: g } = (0, e$.i)(),
        h = (0, e7.YJ)(g),
        f = (0, p.A)(),
        x = (0, U.bB)(),
        { isGift: T, giftRecipient: j, giftMessage: M, claimableRewards: y } = (0, C.Pv)(),
        N = (0, S.Mq)(f),
        O = (0, eq.bG)([q.A], () => {
            let e = q.A.getMarketingComponentByType(B.C.GIFT_CUSTOMIZATION_BANNER);
            return null != e && "giftCustomizationBanner" === e.properties.properties.oneofKind;
        }),
        v = T && N && null != y && y.length > 0 && O,
        G = (A || _) ?? !1,
        L = r.useMemo(() => (0, e5.Tm)({ skuId: o, isPremium: P, defaultPlanId: I }), [o, P, I]),
    ...
    let et = r.useMemo(
        ...
        [L, f?.id, i, V?.subscriptionPeriodEnd, v, u],
    );
    if ($) return ee ? (0, l.jsx)(eX.E, { className: tr.QW }) : (0, l.jsx)(te.A, {});
    F()(null != x, "Step should be set"), F()(L.length > 0, "Premium plan options should be set");
    let en =
        ee && !T
    ...
    return (0, l.jsxs)(l.Fragment, {
        children: [
            ...
            !(T && (0, Q.Ik)(j)) && (0, l.jsx)(e9.A, { isEligibleForTrial: A }),
            (0, l.jsxs)(J.dZ, {
                children: [
    ...
    return (0, l.jsx)(tp, {
        selectSku: (e) =>
            (function (e) {
                ...
                l(n);
                let d = k.pn.PLAN_SELECT,
                    c = (0, e5.aZ)(t);
                (c !== T.pe.TIER_1 && c !== T.pe.TIER_2) || n !== T.pe.TIER_0 || i || (d = k.pn.WHAT_YOU_LOSE);
                ...
                d !== k.pn.WHAT_YOU_LOSE && m && ((d = k.pn.REVIEW), a((0, eK.xT)(n, t, o))),
        ...
        onSelectPremiumGroup: () =>
            (function (e) {
                ...
                r((0, e5.mH)(T.pe.TIER_2)),
                    ...
                    n(l ? k.pn.REVIEW : k.pn.ADD_PAYMENT_STEPS, { analyticsDataOverride: { sku_id: T.pe.TIER_2 } });
...
function tp(e) {
    ...
    return (0, l.jsxs)(l.Fragment, {
        children: [
            (0, l.jsx)(ef.rQ, { titleTextVariant: "heading-lg/semibold", title: eE.intl.string(eE.t["r+SebU"]) }),
            a
                ? (0, l.jsx)(ex.c, {
            ...
            footer: (0, l.jsxs)(tm.e, {
                ...
                children: [
                    (0, l.jsx)(et.$, {
                        ...
                        onClick: () => {
                            p ? (i((0, eK.xT)(r, s)), t(k.pn.REVIEW)) : t(k.pn.PLAN_SELECT);
                        },
                    }),
...
let tI = [k.pn.PLAN_SELECT, k.pn.ADD_PAYMENT_STEPS, k.pn.REVIEW, k.pn.CONFIRM];
function tP(e) {
    let {
            analyticsLocation: t,
            analyticsObject: u,
    ...
    let { selectedSkuId: Z, purchaseState: X } = (0, m.t4)((e) => ({
        ...
        ee = (function () {
            let { enabled: e } = g.J.useConfig({ location: "useOpenGiftingBadgePostPurchaseModal" }),
                t = (0, i.bG)([A.Ay], () => A.Ay.getBadgeById(I.$.GIFTING)?.tiers),
            ...
            return (
                r.useEffect(() => {
                    e &&
                        s === _.h.PURCHASING &&
                        (a.current = A.Ay.getSingleRequirementProgress(I.$.GIFTING)?.current ?? null);
                }, [e, s]),
                r.useCallback(() => {
        ...
        en = !$ && Z === T.pe.TIER_2 && !f.Ct && !f.KY && null == (0, x.uM)(),
        el = X === _.h.PURCHASING;
    return (0, l.jsx)(D.A, {
        isConfirmationStep: Q === k.pn.CONFIRM && null == q && null == G,
        isEligibleForWowMoment: en,
        shouldPrefetchWowMoment: el,
        children: (0, l.jsx)(N.PaymentModal, {
    ...
    return (0, l.jsx)(O.x, {
        ...
        onReturn: () => {
            let e = Object.values(s),
                l = e.length < 1 && null == t ? k.pn.PLAN_SELECT : k.pn.REVIEW;
            E && (l = k.pn.REVIEW),
                I && e.length < 1 && (l = k.pn.SELECT_FREE_SKU),
                n(l, { trackedFromStep: k.pn.PAYMENT_TYPE });
        },
    });
}
let t_ = function () {
        ...
        return [
            { key: null, renderStep: (e) => (0, l.jsx)(N.I, { ...e }) },
            {
                key: k.pn.SKU_SELECT,
            ...
            { key: k.pn.AWAITING_PURCHASE_TOKEN_AUTH, renderStep: () => (0, l.jsx)(G.A, {}) },
            { key: k.pn.AWAITING_AUTHENTICATION, renderStep: () => (0, l.jsx)(v.A, {}) },
            {
                key: k.pn.REVIEW,
...
function th(e) {
    ...
    let f = (0, j.tA)({ giftRecipient: S, isGift: P ?? !1 }),
        x = r.useMemo(() => t_(f), [f]);
    return (0, l.jsx)(o.f5, {
        value: s,
