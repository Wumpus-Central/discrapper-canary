...
function w(e) {
    ...
    let { transitionState: n, onClose: l } = e,
        ...
        u = i.useMemo(() => j.ZP.canEditDiscriminator(a) && !a.isPomelo(), [a]),
        [d, w] = i.useState(!1),
        [R, z] = i.useState(a.username),
        [S, L] = i.useState(a.discriminator),
        [P, y] = i.useState(''),
        [T, B] = i.useState(!1),
        F = (0, m.e7)([N.Z], () => N.Z.getErrors()),
        M = (0, v.n)(),
        Z = a.isPomelo() && M,
        A = (0, b.a)(R, Z, !1, a.username),
        D = i.useRef(null),
        U = i.useMemo(() => {
            var e, t, n;
