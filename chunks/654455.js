...
function v() {
    ...
    let n =
        null !=
        (t =
            null == (e = c.Z.frecencyWithoutFetchingLatest.applicationCommandFrecency) ? void 0 : e.applicationCommands)
            ? t
            : {};
    g.overwriteHistory(
        o().mapValues(n, (e) => h(_({}, e), { recentUses: e.recentUses.map(Number).filter((e) => e > 0) })),
        m.pendingUsages,
    );
}
