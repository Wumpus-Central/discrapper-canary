n.d(t, { findMatchingAutocompleteType: () => tc, getOptions: () => ta, findCommandOptionAutocompleteType: () => td });
var l = n(284009),
    i = n.n(l),
    r = n(155718),
    s = n(168186),
...
let X = {
    ...
    onSelect(e) {
        ...
        return (
            ...
            l.replaceInlineInput("gameMentionInput", ee(i.name), (0, L.K)(i.id)),
...
var eE = n(289873),
    ...
    ef = n(17928);
let eT = {},
    eD = { integration: "", query: "" };
class eO extends ef.Ay.Store {
...
let e_ = new eO(eS.h, {
        INTEGRATION_QUERY: function (e) {
            ...
            (eT[t] = eT[t] ?? {}), (eT[t][n] = { loading: !0, results: [] });
        },
        INTEGRATION_QUERY_SUCCESS: function (e) {
            let { integration: t, query: n, results: l } = e;
            (eT[t][n] = { loading: !1, results: l.map((e) => ({ type: eA.Z86[t].type, meta: e })) }),
                (eD = { query: n, integration: t });
        },
...
let eB = {
    ...
    queryResults(e, t, n, l, i) {
        let { command: r, query: s } = eq(e, n, l);
        if (null == r) return eY;
        let o = v().findKey(eA.Z86, (e) => e.command === r);
        i && null != o && s.length > 0 && eL.search(o, s);
        let u = e_.getResults(o, s);
        return null == u ? eY : { results: { command: r, integrations: u.results, isLoading: u.loading } };
    },
    renderResults(e) {
        let {
            ...
            { command: d, query: p } = eq(i, r, s);
        if (null == d || 0 === p.length) return null;
        if (n) return (0, m.jsx)(eE.y, { className: ex.u1, type: eE.y.Type.SPINNING_CIRCLE });
        if (null != t) {
            let e = !1,
                n = t.map((t, n) => {
            ...
            return (0, m.jsxs)(
                c.Fragment,
                {
                    children: [
                        ...
                        e ? (0, m.jsx)(ek.A, { className: ex.os, children: n }) : n,
                    ],
                },
                "gifs",
            );
    ...
    onSelect(e) {
        ...
        if (
            ...
            eR.Ay.trackWithMetadata(eA.HAw.SEARCH_RESULT_SELECTED, {
            ...
            e?.inputType === N.y$.BUILT_IN_INTEGRATION &&
                ...
                eR.Ay.trackWithMetadata(eA.HAw.APPLICATION_COMMAND_USED, {
                    command_id: e.id,
...
let ej = {
    ...
    matches(e, t, n, l, i) {
        if (i.commands === a.Ze.DISABLED || i.commands === a.Ze.OLD_BUILT_INS || n.length < 2 || !ev._3.getSetting())
            return !1;
        let r = eH(n);
        return null != r && r.cleanedQuery.length > 0;
    },
    queryResults(e, t, n, l, i) {
        if (!ev._3.getSetting()) return x;
        let s = eH(n);
        if (null == s) return x;
    ...
    renderResults(e) {
        ...
        return _({
            ...
            getQuery: (e) => {
                ...
                let n = eG.Ay.getName(l?.id, i.id, t.user);
                return e.replace(eU, `@${n}`);
            },
            key: "commands",
        });
    },
...
function eQ(e) {
    let { onClick: t, onHover: n, selected: l, index: i, text: r, description: s } = e,
        ...
        u = o ? (0, m.jsx)(eb.Lp, { text: D.intl.string(D.t.y2b7CA), color: eP.A.colors.BACKGROUND_BRAND.css }) : null;
...
let ew = {
        ...
        let {
            ...
            h = n.map((e, n) => {
                ...
                return "gameMentionInput" === e.inlineAutocompleteType
                    ? (0, c.createElement)(eQ, { ...l, key: e.text })
    ...
    onSelect(e) {
        ...
        if (null != h) {
            ...
            return (
                p.addMentionGame({ id: M.id, name: M.name, icon_hash: M.icon ?? M.icon_hash }),
    ...
    tu = {
        ...
        [a.DB.REACTIONS]: {
            ...
            matches: (e, t, n, l, i) =>
                ...
                (C.A.can(eA.xBc.ADD_REACTIONS, e) || e.isPrivate()),
            queryResults(e, t, n, l, i) {
                let { emojis: r } = j.Ay.queryEmojiResults({
                    query: n,
                    channel: e,
                    intention: eF.EmojiIntention.REACTION,
                    maxCount: 50,
                });
        ...
        [a.DB.TIMESTAMPS]: {
            ...
            queryResults(e, t, n) {
                let l = tn()(),
                    i = (function () {
                        let e = ti.default.locale;
                        if ("en-US" === e) return ez;
                        if ("en-GB" === e) return ez.GB;
                        if ("de" === e) return eX;
                        if ("fr" === e) return e0;
                        if ("ja" === e) return e1;
                        ...
                        else if (e.startsWith("pt-")) return e9;
                        else if (e.startsWith("es-")) return te;
                        else return null;
                    })(),
                    [r] = i?.parse(n, l.toDate()) ?? [void 0],
                    s = r?.start != null && r?.end == null && r.text === n,
                    o = s ? tn()(r.start.date()) : tn()(n, ts, !0),
                    u = [],
            ...
            onSelect(e) {
                ...
                let r = (0, tl.tf)(i.timestamp, i.format),
                    s = (0, tl.WA)(i)?.formatted;
                return null == s
                    ? null
    ...
    for (let e of to) {
        ...
        if (null == y.autocompleteInputElementType) {
            if (e === a.DB.GIFS || e === a.DB.CHOICES) {
                ...
                if (
                    (null != r && r.length > 0 && (0, u.K)(eF.EmojiInteractionPoint.AutocompleteTyped),
