...
function I(e) {
    ...
    let {
        ...
        D = o.Z.getChannel(g),
        w = null != (n = P("channel_flags")) ? n : 0,
        L = (null != (l = R.channel_flags) ? l : 0) ^ w,
        x = 0 === (0, r.M1)(L, f.ic.FAVORITED, f.ic.OPT_IN_ENABLED),
        M = null != (d = null == (t = s.Z.getLastMessage(g)) ? void 0 : t.type) ? d : null;
    i.ZP.trackWithMetadata(
        c.rMx.NOTIFICATION_SETTINGS_UPDATED,
        m(p({}, R, a.Z.getStats(h)), {
            location: S,
            guild_id: h,
            channel_id: g,
            update_type: _,
