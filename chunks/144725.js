...
function ej(e) {
    ...
    let i = X,
        [l, a] = eI(H);
    if (((V = ev(l, t)), (X = $ ? i && V.length >= P.Lb : i && em(r, H)), 0 === n.length && i === X)) return !1;
...
let ex = new eP(a.Z, {
    ...
    LOAD_MESSAGES_SUCCESS: function (e) {
        ...
        let s = r
            .filter(
                (e) => S.default.age(e.id) < y.Z.Millis.HOUR && (e.type === Z.uaV.DEFAULT || e.type === Z.uaV.REPLY),
            )
            .slice(0, 3)
            .reverse();
        if (
