...
let J = () => {
    let {
        ...
        r.useEffect(
            () => () => {
                s ? !C() && (_ || A.length > 100) && b() : n && A.length > 100 && b();
            },
            [n, A, s, C, _],
        ),
            r.useEffect(() => {
...
function eV(e) {
    ...
    let s = eA.default.getUser(t.message?.author?.id) ?? new eh.A(t.message?.author),
        l = ec.A.parse(n);
    return (0, i.jsxs)("div", {
        className: ew.PI,
        children: [
        ...
        let t,
            ...
            c = r.useCallback(async () => {
                ...
                if (null != s.deeplink) {
                    ...
                    em.default.track(M.HAw.NOTIFICATION_CENTER_ACTION, {
        ...
        let u = null != s.local_id,
            h = (function (e) {
                let { item: t, renderApplication: n } = e,
                    ...
                    l = eS.Ay.getName(eA.default.getUser(t.other_user?.id)),
                    a = t.applicationId;
                switch (t.type) {
                    case I.Uo.FRIEND_REQUESTS_GROUPED:
                        let i = eS.Ay.getName(eA.default.getUser(t.other_users?.[0]?.id)),
                            r = eS.Ay.getName(eA.default.getUser(t.other_users?.[1]?.id)),
                    ...
                    case I.hW.GUILD_SCHEDULED_EVENT_STARTED:
                        let d = t.guild_scheduled_event_id,
                            ...
                            h = u?.name,
                            A = ef.A.getGuild(u?.guild_id)?.name,
                            m = (0, eN.AZ)(u ?? void 0);
                        return (0, eC.uJ)(A) || (0, eC.uJ)(h) || !m
                            ? (t.body ?? "")
                            : $.intl.format($.t.AyvfXR, { event_name: h, guild_name: A });
                    case I.Uo.INCOMING_FRIEND_REQUESTS:
                        return ep({
                            username: l,
                            applicationId: a,
            ...
            { emoji_id: A, emoji_name: m } = s,
            E = null != A || null != m ? (0, i.jsx)(el.A, { className: ew.Zg, emojiId: A, emojiName: m }) : null;
        return (0, i.jsxs)("div", {
            className: ew.nM,
            children: [
                (0, i.jsxs)(es.s, {
              ...
              children: (0, i.jsx)(_.K, {
                  ...
                  onClick: () => {
                      null != t &&
                          ...
                          em.default.track(M.HAw.NOTIFICATION_CENTER_ACTION, { action_type: I.e1.MARK_ALL_READ }));
                  },
              }),
          })
        : null;
...
function tb(e) {
    let { channel: t, gotoChannel: n } = e,
        s = (0, g.bG)([eA.default], () => (t.isDM() ? eA.default.getUser(t.getRecipientId()) : null)),
...
function tL(e) {
    ...
    return (0, i.jsxs)("div", {
        ...
        children: [
            ...
            (0, i.jsx)(et.E, { color: "text-default", variant: "text-xs/normal", className: tj.PL, children: A }),
        ],
    });
}
function tU(e) {
...
function tw(e) {
    ...
    return (0, i.jsxs)("div", {
        ...
        children: [
            ...
            (0, i.jsx)(tA.D, { className: tG.wx, variant: "heading-xl/semibold", children: n }),
            (0, i.jsxs)(et.E, {
                color: "text-default",
...
function tH(e, t, n) {
    ...
    null != e && null != s && (i = s === M.KE7.ALL_SERVERS ? null : e.getGuildId()),
        e9.A.fetchRecentMentions({ before: n, limit: M.Ue3, guildId: i, roles: l, everyone: a });
}
function tB(e) {
    let { onJump: t } = e,
    ...
    r.useEffect(() => {
        R.Ay.hasLoadedEver
            ? ((null != A && o !== A) || (null != m && d !== m) || (null != E && u !== E)) && tH(n, !0)
            : tH(n, !0);
    }, [A, o, m, d, E, u, n, !0]),
        (0, e4.Ay)(() => {
            s?.some(tn.$r) && (e9.A.clearMentions(), tH(n, !0));
        }),
        r.useEffect(
            () => () => {
                e9.A.truncateMentions(M.Ue3);
            },
            [],
        );
    ...
    return (0, i.jsxs)("div", {
        ...
        children: [
            (0, i.jsx)(tM, {
                ...
                gotoChannel: n,
                children:
                    null != s ? (0, i.jsx)(e5.J, { size: "sm", onClick: () => e9.A.deleteRecentMention(t.id) }) : null,
            }),
            (0, i.jsxs)("div", {
                className: tP.zC,
                children: [
...
function t3(e) {
    ...
    return (0, i.jsx)(E.m, {
        ...
        children: (0, i.jsxs)(tc.D, {
            ...
            className: t1.b,
            onClick: () => {
                em.default.track(M.HAw.NOTIFICATION_CENTER_ACTION, { action_type: I.e1.FRIEND_REQUESTS_BUTTON_CLICK }),
    ...
    return (0, i.jsxs)(eH.W, {
        ...
        children: [
            (0, i.jsx)(eB.sL, {
                ...
                action: function () {
                    e9.A.setGuildFilter({ everyoneFilter: !l });
                },
                checked: l,
            }),
            (0, i.jsx)(eB.sL, {
                ...
                action: function () {
                    e9.A.setGuildFilter({ roleFilter: !a });
                },
                checked: a,
            }),
            null == s || s.isPrivate()
...
function ns(e) {
    let { onClick: t } = e,
        ...
        l = () => {
            t(),
                em.default.track(M.HAw.INBOX_CHANNEL_ACKED, {
...
let n1 = r.memo(function e(t) {
    let n,
        ...
        m = M.sl8.has(l.type) ? l.messageReference : void 0,
        E = (0, g.bG)([nU.A], () => nU.A.getMessageByReference(m)),
        _ = (0, g.bG)([ti.A], () =>
        ...
        b = !v && void 0 === n,
        F = (0, nY.A)({ message: l, channel: s, enabled: b }),
        L = (0, nv.P)(l),
...
class sA extends n8.EventEmitter {
    state;
    scrollerRef;
    undoStack = [];
    constructor(e, t) {
...
function sE(e, t, n, s) {
    ...
    } else if (!(0, n4.Y)(l) && 0 === tT.Ay.getMentionCount(s)) return;
...
function sp(e) {
    let { channel: t, channelRecord: n, gotoChannel: s } = e,
        ...
        d = eA.default.getUser(n2.default.getId())?.hasFlag(M.nhx.SPAMMER) ?? !1,
        u = [];
    if (!t.collapsed) {
        let e = null,
            h = null,
            A = t.messages.slice(0, 25);
        A.forEach((t) => {
...
function sO(e) {
    var t, n, s, l, a, o;
    let { onJump: d, showTutorial: u, setSeenTutorial: h, closePopout: A } = e,
        m = r.useRef(null),
        [E, _] = (function (e) {
            let [t, n] = r.useState(() => new sA(sg(), e)),
                [s, l] = r.useState(!1),
                a = r.useRef(Date.now()),
                [i, o] = r.useState(() => sg());
            r.useEffect(() => {
    ...
    (t = m),
        ...
        r.useEffect(() => {
            ...
            return (
                t4._.subscribe(M.jej.MARK_TOP_INBOX_CHANNEL_READ, e),
                () => {
                    t4._.unsubscribe(M.jej.MARK_TOP_INBOX_CHANNEL_READ, e);
                }
            );
        }, [a, l.channels]),
        (o = _),
        ...
        r.useEffect(() => {
            em.default.track(M.HAw.OPEN_POPOUT, { type: "Inbox" });
        }, []),
        r.useEffect(
            () => (
                j.h.subscribe("CONNECTION_OPEN", A),
                () => {
                    j.h.unsubscribe("CONNECTION_OPEN", A);
                }
            ),
            [A],
        ),
        (0, e4.Ay)(
            () => (
                t4._.subscribe(M.jej.INBOX_MARK_ALL_UNREADS_READ, _.markAllRead),
                () => {
                    t4._.unsubscribe(M.jej.INBOX_MARK_ALL_UNREADS_READ, _.markAllRead);
                }
            ),
        );
    let S = (0, V.A)("unreads", m);
    return 0 === f.length
        ? (0, i.jsx)(tw, {
              Icon: tQ.K,
...
let sb = () => (0, i.jsx)(ns, { onClick: () => t4._.dispatch(M.jej.INBOX_MARK_ALL_UNREADS_READ) });
var sF = n(716030);
function sL(e) {
...
let sV = r.memo(function (e) {
    let { scheduledMessage: t, channel: n, isPendingDeletion: s } = e,
        l = new sB.Ay({
            ...
            author: eA.default.getUser(t.userId),
