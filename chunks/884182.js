...
function T(e) {
    let { itemsForLayout: t, maxWidth: n, isSingleImage: i, footer: o } = e,
        s = t[0];
    return (0, r.jsx)('div', {
...
let R = (e) => ({
    ...
    P = (e) => ({ className: a()(e, h.lazyImg) });
function w(e) {
    let { props: t, maxWidth: n = p.mT, maxHeight: i = p.Jj, useFullWidth: o = !0, isSingleItem: a = !1, footer: s, displayGridItem: l } = e,
        c = t.item.type,
...
let D = function (e) {
    let { items: t, isInAppComponentsV2: n = !1 } = e,
        { groupableVisualMediaItems: i, nonGroupableVisualMediaItems: o, nonVisualMediaItems: s } = v(t),
        l = n ? p.Y9 : p.mT;
    return (0, r.jsxs)(r.Fragment, {
        children: [
            i.length > 0 &&
                (0, r.jsx)('div', {
                    className: a()(h.visualMediaItemContainer, { [h.isInAppComponentsV2]: n }),
                    children: (0, r.jsx)(I, {
                        visualMediaItems: i,
                        maxWidth: l
                    })
