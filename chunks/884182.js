...
let w = (e) => ({
    ...
    R = (e) => ({ className: o()(e, h.lazyImg) });
function P(e) {
    let { props: t, maxWidth: n = p.mT, maxHeight: i = p.Jj, useFullWidth: a = !0, isSingleItem: o = !1, footer: s, displayGridItem: l } = e,
        c = t.item.type,
        u = b(g({}, t, 'IMAGE' === c && w(t.className), 'VIDEO' === c && R(t.className)), {
            displayGridItem: l,
