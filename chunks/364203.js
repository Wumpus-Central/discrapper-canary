        ...
        (0, r.jsxs)('div', {
            ...
            children: [
                (0, r.jsxs)('div', {
                    ...
                    children: [
                        (0, r.jsx)(_.lBU, { text: M.intl.string(M.t.oW0eUV) }),
                        (0, r.jsx)('div', {
...
let ee = function (e) {
    ...
    let H = i.useCallback(() => {
        ...
        { isUpdating: Y, updateChatWallpaper: W } = (0, R.x)({
            channelId: c,
            onUpdateComplete: H
        }),
        q = i.useCallback(
    ...
    let ee = i.useCallback(() => {
            ...
            (S.default.track(x.rMx.CHAT_WALLPAPER_PICKER_APPLY_CLICKED, {
                ...
                W(c, g.wallpaperId, () => {
                    (0, _.showToast)((0, _.createToast)(M.intl.string(M.t.F8FvU1), _.ToastType.FAILURE));
                }));
        }, [c, g, W, b]),
        et = i.useCallback(
            (e) => {
