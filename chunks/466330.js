...
function p(e) {
    let t,
        r = (null == e ? void 0 : e.type) === s.d4z.GUILD_VOICE;
    return (0, l.jW)({ location: 'invite_menu_item' }) ? (r ? b.NW.string(b.t['EE+P0N']) : b.NW.string(b.t['0jeAXl'])) : b.NW.string(b.t.BN75l5);
}
let d = (e, t, i) => {
        let l = p(i);
