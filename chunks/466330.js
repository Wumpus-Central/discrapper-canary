...
function p(n, e) {
    return (0, c.jW)({ location: "invite_menu_item" }).entrypoints
        ? (null != e && [s.t4x.GUILD_HEADER, s.t4x.GUILD_CONTEXT_MENU].includes(e)) || null == n
            ? b.intl.string(b.t.Sd8Ix8)
...
let E = (n, e, l) => {
        ...
        return (0, r.jsx)(i.sNh, {
            ...
            action: () =>
                (0, i.ZDy)(async () => {
                    let { default: i } = await Promise.all([t.e("7654"), t.e("39725")]).then(t.bind(t, 560114));
                    return (t) => {
                        var c, o;
                        return (0, r.jsx)(
                            i,
