...
function f(t, e) {
    return (0, o.jW)({ location: "invite_menu_item" }).entrypoints
        ? (null != e && [s.t4x.GUILD_HEADER, s.t4x.GUILD_CONTEXT_MENU].includes(e)) || null == t
            ? d.intl.string(d.t.Sd8Ix8)
            : t.type === s.d4z.GUILD_VOICE
...
let j = (t, e, r) => {
        ...
        return (0, l.jsx)(i.sNh, {
            ...
            action: () =>
                (0, i.ZDy)(async () => {
                    let { default: i } = await Promise.all([n.e("7654"), n.e("77710")]).then(n.bind(n, 560114));
                    return (n) => {
                        var o, u;
                        return (0, l.jsx)(
                            i,
