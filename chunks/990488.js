...
function E(e) {
    ...
    return ((t = b === x.sFg.NONE ? null : b === x.sFg.VERY_HIGH ? (g ? v.l : j.l) : g ? p.b : f.b), null == d)
        ? null
        : (0, n.jsxs)(n.Fragment, {
              children: [
                  !u && null != t && (0, n.jsx)(t, {}),
...
function C(e) {
    let t,
        ...
        h = !1;
    g === x.sFg.NONE ? ((h = !0), (t = null)) : g === x.sFg.VERY_HIGH ? ((h = null != y && y), (t = O ? v.v : j.v)) : ((h = null != m && m), (t = O ? p.B : f.B));
    let P = i.useRef(h);
    return null == b
        ? null
        : (0, n.jsxs)(n.Fragment, {
