...
let v = (e) => {
        let { bannerAdjustment: t = 0, maxLoops: n, resetOnHover: o = !1, isHovering: s = !1, useOpacityOnHover: l = !0, autoPlay: c = !0, restartMethod: u, urlQueryString: m, profileEffectConfig: E, noBorderRadius: y = !1, introDelay: O = d.lG } = e,
            v = i.useRef(null),
            [I, S] = i.useState([]);
        (0, g.Z)(E);
        ...
        return (
            i.useEffect(() => {
                !0 === c || s || (D(), w(0)), !s && M && x.current && (D(), w(0)), o && s && !x.current && (L(), E.animationType === f.Q.PERSISTENT ? w(u === f.j.FromStart ? 0 : T) : w(0));
            }, [s, M, T, o, D, L, x, E.animationType, c, u]),
            (0, r.jsx)('div', {
                ref: v,
