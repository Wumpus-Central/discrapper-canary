...
let v = (e) => {
        ...
        return (
            i.useEffect(() => {
                (!0 === c || s || (D(), w(0)), !s && M && x.current && (D(), w(0)), a && s && !x.current && (L(), g.animationType === f.Q.PERSISTENT ? w(u === f.j.FromStart ? 0 : S) : w(0)));
            ...
            (0, r.jsx)('div', {
                ...
                children: (0, r.jsx)('div', {
                    ...
                    children: I.map((e, i) => {
                        if (!x.current && g.animationType === f.Q.PERSISTENT && null != g.staticFrameSrc && 0 === i && !0 === c) {
                            var a, o, s, l;
    ...
    T = (e) => {
        let t = (0, s.e7)([u.Z], () => u.Z.isFocused()),
            ...
            E = null != _ ? _ : m;
        return null != d && null != E && (t || e.shopPreview || d.config.animationType !== f.Q.INTERMITTENT)
