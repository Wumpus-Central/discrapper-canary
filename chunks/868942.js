...
function H(e) {
    ...
    return (0, n.jsxs)("div", {
        className: l()(F.vK, r),
        children: [
            (0, n.jsx)("div", { className: F.aK }),
            (0, n.jsxs)("div", {
                className: F.wt,
                children: [
                    (0, n.jsx)("div", { className: F.Sl }),
                    (0, n.jsxs)("div", {
                        className: F.zH,
                        children: [
                            (0, n.jsxs)("div", {
            ...
            (0, n.jsx)("div", { className: F.Uo, children: s }),
        ],
    });
}
function K(e) {
...
function W() {
    return (0, n.jsxs)("div", {
        className: F.Up,
        children: [
            (0, n.jsx)(I.A, { className: F.sq, "aria-label": B.intl.string(B.t.FSOz78) }),
            (0, n.jsx)("div", { className: F.CJ }),
        ],
    });
}
function Z() {
    let { analyticsLocations: e } = (0, E.Ay)(A.A.ACCOUNT_CREDIT_BANNER);
    return (0, n.jsx)(H, {
        wordMark: (0, n.jsx)(W, {}),
...
let q = function (e) {
    let {
        ...
        { analyticsLocations: Z } = (0, E.Ay)(A.A.SUBSCRIPTION_HEADER),
        ...
        ec = j.Ay.getPlanIdFromInvoice(t, s);
    if ((0, N.m1)(ec)) return null;
    let eg = j.Ay.getStatusFromInvoice(t, s),
        em = j.Ay.getPremiumType(ec),
        eh = {
            [F.Vd]: em === V.PremiumTypes.TIER_0,
            [F.aS]: em === V.PremiumTypes.TIER_1,
            [F.hA]: em === V.PremiumTypes.TIER_2,
            [F.aD]: eg === k.Dmq.CANCELED,
            [F.WY]: eg === k.Dmq.PAUSE_PENDING,
            [F.Ft]: eg === k.Dmq.PAUSED && !J,
            [F.GD]: (0, j.PK)(eg),
        },
        eA = null;
    switch (em) {
        case V.PremiumTypes.TIER_0:
            eA = (0, n.jsxs)("div", {
                className: F.Up,
                children: [
                    (0, n.jsx)(I.A, { className: F.sq, "aria-label": B.intl.string(B.t["t9uG/o"]) }),
                    (0, n.jsx)("div", { className: F.sT }),
                ],
            });
            break;
        ...
        case V.PremiumTypes.TIER_2:
            eA = (0, n.jsx)(_, { className: F.V6, "aria-label": B.intl.string(B.t.lpNrPu) });
    }
