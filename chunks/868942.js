...
var i = n(503698),
    ...
    N = n(953727);
function P(e) {
    let { width: t = 106, height: n = 43, color: i = "currentColor", foreground: a, ...l } = e;
    return (0, s.jsx)("svg", {
        ...(0, N.A)(l),
        width: t,
        height: n,
...
let z = new g.A("SubscriptionHeader.tsx"),
    q = { page: O.liQ.USER_SETTINGS, section: O.JJy.SETTINGS_PREMIUM, object: O.ZSU.CARD },
    Y = [O.Dmq.PAUSED, O.Dmq.PAUSE_PENDING, O.Dmq.BILLING_RETRY];
function V(e) {
    let {
        wordMark: t,
        subscriptionInfo: n,
    ...
    return (0, s.jsxs)("div", {
        className: a()(F.vK, l),
        children: [
            (0, s.jsx)("div", { className: F.aK }),
            (0, s.jsxs)("div", {
                className: F.wt,
                children: [
                    (0, s.jsx)("div", { className: F.Sl }),
                    (0, s.jsxs)("div", {
                        className: F.zH,
                        children: [
                            (0, s.jsxs)("div", {
                                ...
                                children: [
                                    ...
                                    r &&
                                        null != c &&
                                        (0, s.jsx)(M.HU, {
                                            text: B.intl.formatToPlainString(B.t.iiLbvu, { percent: c }),
                                            className: F.NM,
            ...
            (0, s.jsx)("div", { className: F.Uo, children: i }),
        ],
    });
}
function Z(e) {
...
function K() {
    return (0, s.jsxs)("div", {
        className: F.Up,
        children: [
            (0, s.jsx)(I.A, { className: F.sq, "aria-label": B.intl.string(B.t.FSOz78) }),
            (0, s.jsx)("div", { className: F.CJ }),
        ],
    });
}
function W() {
    let { analyticsLocations: e } = (0, f.Ay)(x.A.ACCOUNT_CREDIT_BANNER);
    return (0, s.jsx)(V, {
        wordMark: (0, s.jsx)(K, {}),
        subscriptionInfo: (0, s.jsx)("div", { className: F.MS, children: B.intl.string(B.t.R0GJL2) }),
        buttons: (0, s.jsx)(U.A, {
            className: F.au,
            onClick: () => (0, j.A)({ subscriptionTier: G.pe.TIER_1, analyticsLocations: e, analyticsObject: q }),
...
let Q = function (e) {
    let {
        ...
        { analyticsLocations: W } = (0, f.Ay)(x.A.SUBSCRIPTION_HEADER),
        Q = (0, C.A)({ forceFetch: !1 }),
        { fractionalState: $ } = Q,
        ...
        es = (0, D.ds)(),
        ei = () => {
            (t.status === O.Dmq.ACTIVE || t.status === O.Dmq.PAST_DUE || t.status === O.Dmq.PAUSE_PENDING || J) && el();
        },
        ea = () => {
            t.status === O.Dmq.BILLING_RETRY && el(k.g.CONFIRM);
        },
        el = (e) => {
        ...
        er = () => {
            if (null != t && null != t.premiumPlanIdFromItems) {
                ...
                let a = (0, L._w)(e, g?.id, !1),
                    u = a.length > 0 ? a[0] : t.currency,
                    d = !0;
                if ((1 === a.length && g?.id === t.paymentSourceId && (0, L.jJ)(e.id, u, g?.id) && (d = !1), d))
                    (0, j.A)({
                    ...
                    r()(null != l, "Expected renewalInvoicePreview"),
                        r()(null != i, "Expected currentInvoicePreview"),
                                ...
                                return (n) =>
                                    (0, s.jsx)(e, {
                                        ...
                                        onClose: async () => {
                                            a ||
                                                ((a = !0),
                                                S._.dispatch(O.jej.WOW_MOMENT_CONFIRMATION_MODAL_CLOSED),
        ...
        ec = () => {
            Y.includes(t.status) && null != t.pauseEndsAt
                ? t.status === O.Dmq.PAUSED && t.pauseReason !== H.qf.USER_TEMPORARY_BAN
                    ? (0, j.A)({
                          initialPlanId: t.premiumPlanIdFromItems,
                          analyticsLocations: W,
                          analyticsLocation: M,
        ...
        eu = () => {
            t.status === O.Dmq.PAUSED && el(k.g.PAUSE_SELECT);
        },
        eo = () => {
            el(k.g.WHAT_YOU_LOSE);
        },
        ed = b.Ay.getPlanIdFromInvoice(t, i);
    if ((0, A.m1)(ed)) return null;
    let em = b.Ay.getStatusFromInvoice(t, i),
        ep = b.Ay.getPremiumType(ed),
        eh = {
            [F.Vd]: ep === G.PremiumTypes.TIER_0,
            [F.aS]: ep === G.PremiumTypes.TIER_1,
            [F.hA]: ep === G.PremiumTypes.TIER_2,
            [F.aD]: em === O.Dmq.CANCELED,
            [F.WY]: em === O.Dmq.PAUSE_PENDING,
            [F.Ft]: em === O.Dmq.PAUSED && !J,
            [F.GD]: (0, b.PK)(em),
        },
        ex = null;
    switch (ep) {
        case G.PremiumTypes.TIER_0:
            ex = (0, s.jsxs)("div", {
                className: F.Up,
                children: [
                    (0, s.jsx)(I.A, { className: F.sq, "aria-label": B.intl.string(B.t["t9uG/o"]) }),
                    (0, s.jsx)("div", { className: F.sT }),
                ],
            });
            break;
        ...
        case G.PremiumTypes.TIER_2:
            ex = (0, s.jsx)(P, { className: F.V6, "aria-label": B.intl.string(B.t.lpNrPu) });
    }
    let ef = Y.includes(t.status) && !J ? Z : V;
    return (0, s.jsx)(ef, {
        wordMark: ex,
        subscriptionInfo:
            (r()(null != i, "Expected currentInvoicePreview"),
            (0, s.jsx)("div", {
                className: F.MS,
                children: es
                    ? B.intl.format(B.t["/SfHwl"], { weeks: 1 })
                    : (0, b.nB)({
                          planId: ed,
                          subscription: t,
