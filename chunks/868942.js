...
var s = n(503698),
    ...
    b = n(953727);
function j(e) {
    let { width: t = 106, height: n = 43, color: s = "currentColor", foreground: a, ...r } = e;
    return (0, i.jsx)("svg", {
        ...(0, b.A)(r),
        width: t,
        height: n,
...
var I = n(85563),
    ...
    H = n(985018),
    F = n(640692);
let z = new g.A("SubscriptionHeader.tsx"),
    q = { page: B.liQ.USER_SETTINGS, section: B.JJy.SETTINGS_PREMIUM, object: B.ZSU.CARD },
    Y = [B.Dmq.PAUSED, B.Dmq.PAUSE_PENDING, B.Dmq.BILLING_RETRY];
function V(e) {
    let {
        wordMark: t,
        subscriptionInfo: n,
    ...
    return (0, i.jsxs)("div", {
        ...
        children: [
                            ...
                            (0, i.jsxs)("div", {
                                ...
                                children: [
                                    ...
                                    l &&
                                        null != c &&
                                        (0, i.jsx)(M.HU, {
                                            text: H.intl.formatToPlainString(H.t.iiLbvu, { percent: c }),
                                            className: F.NM,
            ...
            (0, i.jsx)("div", { className: F.Uo, children: s }),
        ],
    });
}
function W(e) {
...
function K() {
    return (0, i.jsxs)("div", {
        className: F.Up,
        children: [
            (0, i.jsx)(I.A, { className: F.sq, "aria-label": H.intl.string(H.t.FSOz78) }),
            (0, i.jsx)("div", { className: F.CJ }),
        ],
    });
}
function Z() {
    let { analyticsLocations: e } = (0, x.Ay)(_.A.ACCOUNT_CREDIT_BANNER);
    return (0, i.jsx)(V, {
        wordMark: (0, i.jsx)(K, {}),
        subscriptionInfo: (0, i.jsx)("div", { className: F.MS, children: H.intl.string(H.t.R0GJL2) }),
        buttons: (0, i.jsx)(U.A, {
            className: F.au,
            onClick: () => (0, y.A)({ subscriptionTier: G.pe.TIER_1, analyticsLocations: e, analyticsObject: q }),
            text: H.intl.string(H.t["/ygMUY"]),
        }),
...
let Q = function (e) {
    let {
        ...
        { analyticsLocations: Z } = (0, x.Ay)(_.A.SUBSCRIPTION_HEADER),
        Q = (0, f.A)({ forceFetch: !1 }),
        { fractionalState: $ } = Q,
        J = $ === G.xc.FP_SUB_PAUSED,
        X = (0, R.O)(),
        ee = X?.discount?.amount,
        et = (0, T.k5)(),
        en = (0, T.nf)(),
        ei = (0, D.ds)(),
        es = () => {
            (t.status === B.Dmq.ACTIVE || t.status === B.Dmq.PAST_DUE || t.status === B.Dmq.PAUSE_PENDING || J) && er();
        },
        ea = () => {
            t.status === B.Dmq.BILLING_RETRY && er(k.g.CONFIRM);
        },
        er = (e) => {
        ...
        el = () => {
            if (null != t && null != t.premiumPlanIdFromItems) {
                let e = v.A.get(t.premiumPlanIdFromItems);
                if (null == e) return void z.info(`Plan not fetched for plan id: ${t.premiumPlanIdFromItems}`);
                let a = (0, E._w)(e, g?.id, !1),
                    o = a.length > 0 ? a[0] : t.currency,
                    u = !0;
                if ((1 === a.length && g?.id === t.paymentSourceId && (0, E.jJ)(e.id, o, g?.id) && (u = !1), u))
                    (0, y.A)({
                    ...
                    let e, a;
                    l()(null != r, "Expected renewalInvoicePreview"),
                        l()(null != s, "Expected currentInvoicePreview"),
                        (e = (0, c.uniqueId)("premium-resubscribe-modal")),
                        (a = !1),
                        (0, d.openModalLazy)(
                            async () => {
                                ...
                                return (n) =>
                                    (0, i.jsx)(e, {
                                        ...
                                        onClose: async () => {
                                            a ||
                                                ((a = !0),
                                                P._.dispatch(B.jej.WOW_MOMENT_CONFIRMATION_MODAL_CLOSED),
                                                w.A.isDisplayingWowMomentConfirmation && w.A.isAnimated
                                                    ? setTimeout(() => {
                                                          n.onClose();
                                                      }, C.K)
                                                    : await n.onClose());
        ...
        ec = () => {
            Y.includes(t.status) && null != t.pauseEndsAt
                ? t.status === B.Dmq.PAUSED && t.pauseReason !== O.qf.USER_TEMPORARY_BAN
                    ? (0, y.A)({
                          initialPlanId: t.premiumPlanIdFromItems,
                          analyticsLocations: Z,
                          analyticsLocation: M,
        ...
        eo = () => {
            t.status === B.Dmq.PAUSED && er(k.g.PAUSE_SELECT);
        },
        ed = () => {
            er(k.g.WHAT_YOU_LOSE);
        },
        eu = N.Ay.getPlanIdFromInvoice(t, s);
    if ((0, A.m1)(eu)) return null;
    let em = N.Ay.getStatusFromInvoice(t, s),
        ep = N.Ay.getPremiumType(eu),
        eh = {
            [F.Vd]: ep === G.PremiumTypes.TIER_0,
            [F.aS]: ep === G.PremiumTypes.TIER_1,
            [F.hA]: ep === G.PremiumTypes.TIER_2,
            [F.aD]: em === B.Dmq.CANCELED,
            [F.WY]: em === B.Dmq.PAUSE_PENDING,
            [F.Ft]: em === B.Dmq.PAUSED && !J,
            [F.GD]: (0, N.PK)(em),
        },
        e_ = null;
    switch (ep) {
        case G.PremiumTypes.TIER_0:
            e_ = (0, i.jsxs)("div", {
                className: F.Up,
                children: [
                    (0, i.jsx)(I.A, { className: F.sq, "aria-label": H.intl.string(H.t["t9uG/o"]) }),
                    (0, i.jsx)("div", { className: F.sT }),
                ],
            });
            break;
        ...
        case G.PremiumTypes.TIER_2:
            e_ = (0, i.jsx)(j, { className: F.V6, "aria-label": H.intl.string(H.t.lpNrPu) });
    }
    let ex = Y.includes(t.status) && !J ? W : V;
    return (0, i.jsx)(ex, {
        wordMark: e_,
        subscriptionInfo:
            (l()(null != s, "Expected currentInvoicePreview"),
            (0, i.jsx)("div", {
                className: F.MS,
                children: ei
                    ? H.intl.format(H.t["/SfHwl"], { weeks: 1 })
                    : (0, N.nB)({
                          planId: eu,
                          subscription: t,
        ...
        buttons: (() => {
            ...
            if (t.isPurchasedExternally) {
                ...
                return (0, i.jsx)(u.Anchor, {
                    ...
                    children: (0, i.jsx)(m.$, {
                        ...
                        size: "sm",
                        loading: b,
                        text: H.intl.string(H.t.obRG6Y).toLocaleUpperCase(),
                    }),
                });
            }
            function n() {
            ...
            if (N.Ay.isBaseSubscriptionCanceled(t))
                return (0, i.jsx)("div", {
