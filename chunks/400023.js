    ...
    K = r.memo(
        function (e) {
            ...
            let {
                ...
                [k, K] = r.useState(null != (n = S.Z.isAtBottom(m.id)) && n),
                Y = r.useMemo(
                    () =>
                        v
                            ? (0, D.aJ)({
            ...
            let er = (0, u.mFp)(),
                ...
                eu = r.useMemo(
                    () => (R ? (k ? B.chatTypingGradientAtBottom : B.chatTypingGradientNotAtBottom) : B.chatGradient),
                    [R, k],
                ),
                ed = r.useMemo(
                    () => (R ? (k ? B.typingGradientAtBottom : B.typingGradientNotAtBottom) : B.gradientDefault),
                    [R, k],
                );
