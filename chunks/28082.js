...
let em = (e) => {
    ...
    ex = (e) => {
        let {
            ...
            { quest: o, onGameSheetOpen: u, onGameSheetClose: c, taskDetails: d } = l.useContext(B),
            [h] = (0, g.Qo)(o, d),
...
let ej = (e) => {
    let { overlayRef: t, progressBarRef: n, isHovered: i } = e,
        { quest: c, isExpanded: d } = l.useContext(B),
...
let eb = l.forwardRef(function (e, t) {
    let { className: n, overlayRef: i } = e,
        ...
        { quest: u, taskDetails: c, isExpanded: d, isExpansionAnimationComplete: h } = l.useContext(B),
...
function tl(e) {
    ...
    return (0, s.jsxs)("div", {
        ...
        children: [
            ...
            (0, s.jsxs)("div", {
                className: a()({ [tn.Iu]: d }),
                children: [p(), 0 === c.length ? null : (0, s.jsx)(ts, { children: i })],
            }),
        ],
    });
}
let ti = function (e) {
        ...
        return (0, s.jsx)(tt, {
            ...
            steps: u,
            children: c && !d && !h && (0, s.jsx)(tl, { useReducedMotion: i, quest: t }),
        });
    },
...
function to(e) {
    ...
    return (
        ...
        (0, s.jsx)(r.animated.div, {
            ...
            children: (0, s.jsx)("div", { style: { overflow: "hidden" }, ref: c, children: t }),
        })
    );
}
n(134528), n(947204);
...
function tv(e) {
    let { isInteractable: t, containerRef: n, onAcceptQuest: i } = e,
        { quest: u, onGameSheetOpen: c, onGameSheetClose: d, taskDetails: h } = l.useContext(B),
        { expansionSpring: m } = l.useContext(F),
        A = l.useRef(null),
        x = (0, o.bG)([p.A], () => p.A.isEnrolling(u.id), [u]),
        C = l.useMemo(() => (0, eQ.tW)(u, eQ.fY.QUEST_BAR_HERO), [u]),
        v = (0, el.NA)({ quest: u }),
        T = l.useMemo(() => (0, eQ.tW)(u, eQ.fY.HERO_IMAGE), [u]),
                            ...
                            children: [
                                ...
                                (0, s.jsxs)("div", {
                                    ...
                                    children: [
                                        ...
                                        b && (0, s.jsx)(eq.e, { questId: u.id, orbMultiplierEligibility: y }),
                                    ],
                                }),
                            ],
                        }),
...
function tR(e) {
    let { overlayRef: t, containerRef: n } = e,
        ...
        { expansionSpring: u } = l.useContext(F),
        c = l.useRef(null),
        d = l.useRef(null),
        h = (0, g.I3)(i),
        ...
        children: [
            (0, s.jsx)(r.animated.div, {
                ...
                style: {
                    ...
                    opacity: (0, U.a)(u.to({ range: [0, 1], output: [1, 0] })),
                },
            }),
            (0, s.jsxs)("div", {
                className: tA.Fe,
                ...
                children: [
                    ...
                    (0, s.jsx)(ej, { overlayRef: t, progressBarRef: c, isHovered: !1 }),
                    (0, s.jsx)(eS, {
...
let ty = l.forwardRef(function (e, t) {
    let { children: n, className: i, overlayRef: o } = e,
        { collapsedHeight: u, isExpanded: c, isExpansionAnimationComplete: d, quest: h } = l.useContext(B),
        { expansionSpring: m } = l.useContext(F),
...
function tM() {
    ...
    return (
        ...
        (0, s.jsx)("div", {
            ...
            children: t.map((t) => {
                let { id: n, collapsedLeft: l, expandedLeft: a, collapsedTop: o, expandedTop: u, width: c } = t,
                    d = i.get(n);
                return (0, s.jsx)(
                    r.animated.div,
                    {
                        ...
                        style: {
                            ...
                            width: c,
                            transform: (0, r.to)(
                                [e.to({ range: [0, 1], output: [l, a] }), e.to({ range: [0, 1], output: [o, u] })],
                                (e, t) => `translate(${e}px, ${t}px)`,
                            ),
                        },
                    },
...
function tG(e) {
    let { quest: t } = e,
        ...
        })({ isQuestAccepted: I, isQuestCompleted: M, isQuestBarVisible: U }),
        {
            ...
            let {
                ...
                _ = l.useCallback(() => {
                    window.clearTimeout(c.current), h || p || d.current || s(!1);
                }, [h, p, s]),
                N = l.useCallback(() => {
                    (0, tw.av)({
                        questId: t.id,
    ...
    !(function (e) {
        ...
        l.useEffect(() => {
            ...
            l.useEffect(() => {
                (!u || c) && tP.A.clearTracking(), i && a && !r && !n && s && tP.A.stopTracking(t.id);
            }, [u, c, i, a, r, n, s, t.id]);
    })({
        quest: t,
        hasAssetsError: w,
