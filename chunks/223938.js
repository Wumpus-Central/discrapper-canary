...
function Z(e, t, n) {
    ...
    return {
        media: { url: l, proxyUrl: l, loadingState: g.TD.UNKNOWN, flags: 0 },
...
let X = l.memo(
    l.forwardRef(function (e, t) {
        let n,
            ...
            e_ = eg?.heroFile,
            eE = eg?.publish ?? !0,
            eC = eg?.createThread ?? !0;
        o()(null != b, "chat input type must be set");
        let { analyticsLocations: ex } = (0, C.Ay)(E.A.CHANNEL_TEXT_AREA),
            eS = (0, V.L0)(t),
            eT = l.useRef(null),
            eI = l.useRef(null),
            eN = l.useRef(null),
            ev = l.useRef(null);
        eu?.(eI.current);
        let { activeCommand: ey } = (0, u.cf)([x.A], () => ({
            ...
            eU = (0, M.n)(y);
        (0, V.N_)(b, ej, y.id);
        let { eventEmitter: eG, handleEditorSelectionChanged: eF } = (0, V.ml)(eI, a, r),
            eH = l.useCallback(
                (e) => {
                    let t = (e) => (
                            e.shouldClear && ((0, T.x)(y.id, { title: "", heroFile: null }), eI.current?.blur()), e
                        ),
                        n = [],
                        i =
                            ef.length > 0
                    ...
                    if (null == e_)
                        return ei({
                            ...e,
                            announcementSendOptions: { createThread: eU && eC, threadName: i, publish: eE },
                        }).then(t);
                    n.push({ type: g.I5.MEDIA_GALLERY, items: [Z(`attachment://${e_.name}`, null, !1)], id: "82733" }),
                        e.value.length > 0 && n.push({ type: g.I5.TEXT_DISPLAY, content: e.value, id: "82744" });
                    ...
                    return (
                        r.length > 0 && n.push({ type: g.I5.MEDIA_GALLERY, items: r, id: "82755" }),
                        s.forEach((e, t) => {
                            n.push({
                                type: g.I5.FILE,
                ...
                [ei, ef, e_, y.id, eC, eE, eU],
            ),
            { submit: eB, handleSubmit: eV } = (0, V.Zx)(eH, b, eI, ev, y.id),
            { autocompleteRef: eW, handleMaybeShowAutocomplete: eK, handleHideAutocomplete: ez } = (0, V.v7)(),
            ...
            { editorHeight: eq, handleResize: eJ } = (0, V.ck)(U),
            {
                ...
                () => !!(!eL && eT.current?.onTabOrEnter(!1)) || eW.current?.onTabOrEnter(!1) || !1,
                [eL],
            )),
            {
                handleTab: n,
                handleEnter: l.useCallback(
                    () => !!(!eL && eT.current?.onTabOrEnter(!0)) || eW.current?.onTabOrEnter(!1) || !1,
                    [eL],
                ),
                handleMoveSelection: l.useCallback(
                    (e) => !!(!eL && eT.current?.onMoveSelection(e)) || eW.current?.onMoveSelection(e) || !1,
                    [eL],
                ),
            }),
            { expressionPickerView: eQ, shouldHideExpressionPicker: e0, handleOuterClick: e1 } = (0, V.MD)(b, eI, y.id),
            e2 = (0, V.BX)(a),
            { currentAutocompleteType: e7, handleAutocompleteVisibilityChange: e3 } = (0, V.uW)(b, y.id),
            e5 = (0, V.NO)(eI),
            e6 = (0, V.Vu)(eB, b, eI),
            e9 = (0, V.C)({ editorRef: eI, disabled: ej, textValue: a, channelId: y.id, chatInputType: b, submit: eH });
        (0, G.R)(eG, y.guild_id, y.id);
        let [e8, e4] = l.useState(!1),
            te = R || e8 || a.length > 0 || null != e_ || ef.length > 0,
            ...
            tc = l.useCallback(() => {
                ...
                null != t && p.A.remove(y.id, t, O.C.ChannelMessage), (0, T.x)(y.id, { heroFile: null });
                                                ...
                                                (0, i.jsxs)(c.animated.div, {
                                                    ...
                                                    children: [
                                                        ...
                                                        (0, i.jsx)("input", {
                                                            ...
                                                            value: ef,
                                                            onChange: (e) => (0, T.x)(y.id, { title: e.target.value }),
                                                        }),
                                                    ],
                                                }),
                                                (0, i.jsx)("div", {
...
`
                                                        ...
                                                        disabled: 0 === a.length && 0 === ef.length,
                                                        size: "sm",
...
function ee(e) {
    ...
    return null == a
        ...
        : (0, i.jsxs)("div", {
              ...
              "aria-hidden": !0,
              children: [
                  (0, i.jsx)("img", { src: a, alt: q.intl.string(q.t["2ePvR8"]), className: J.c8 }),
                  r
                      ? (0, i.jsx)(N.Ay, {
                            className: J.jM,
    ...
    let { channel: t, onImageUploaded: n, onFocus: a } = e,
        ...
        r = async (e, i) => {
            let l = await (0, w.bX)(e, i.name, i.type),
                a = { id: (0, d.A)(), file: l, platform: f.xz.WEB, isThumbnail: !1, origin: "file_picker" };
            p.A.addFile({ file: a, channelId: t.id, draftType: O.C.ChannelMessage }), n(l);
        },
        [o, c] = l.useState(!1),
        u = l.useCallback(() => {
            c(!0);
