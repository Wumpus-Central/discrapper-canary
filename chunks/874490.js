...
var c = n(30370),
    ...
    h = n(652215),
    f = n(650583);
let p = { [h.fg2.INSTAGRAM]: ["1036753656588017764"] },
    E = new Map([[h.fg2.INSTAGRAM, new Date(2023, 1, 18).getTime()]]),
    m = 30 * _.A.Millis.DAY;
function g(e) {
    ...
    return (e) =>
        e.type === h.fg2.PLAYSTATION_STAGING
            ? i
...
function I(e) {
    ...
    t && e === h.fg2.TWITTER)
        ? h.fg2.TWITTER_LEGACY
        : e;
}
h.fg2.PLAYSTATION, h.fg2.XBOX, h.fg2.SPOTIFY, h.fg2.STEAM, h.fg2.TWITCH;
