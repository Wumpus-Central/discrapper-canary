...
function d(e) {
    let [t, n] = (0, i.useState)(""),
        ...
        I = (0, i.useCallback)(
            async (e, t, n) => {
                if (null == g) {
                    f(new r.Ay("Order not created yet")), E(!1);
                    return;
                }
                E(!0), f(null);
                try {
                    let e = await (0, s.Ub)({ orderId: g.id, loadId: t });
                    ...
                    let i = await (0, s.pI)(g.id);
                    for (let e of [250, 500, 1e3, 1500, 2500, 4250]) {
                        if (i.length > 0) break;
                        await new Promise((t) => setTimeout(t, e)), (i = await (0, s.pI)(g.id));
                    }
                    if (0 === i.length) throw new s.j2();
                    _(i), E(!1), n?.(i);
                } catch (i) {
                    if (i instanceof s.FY) {
                        A?.(i.order), f(i), E(!1);
                        return;
                    }
                    let n = i instanceof r.Ay ? i : new r.Ay(i);
                    (0, a.gr)(i) ||
                        (0, a.pM)(i instanceof Error ? i : n, {
                            tags: { source: "orb_redeem_orders_api" },
                            extra: { skuId: e, loadId: t, orderId: g.id },
                        }),
                        f(n),
                        E(!1);
                }
    ...
    return (
        (0, i.useEffect)(() => {
            if (null != h) return void n(c.intl.format(c.t["7gHWrd"], { amount: "1 orb", errorMessage: h.message }));
        ...
        { entitlements: d, error: h, isSubmitting: p, responseMessage: t, redeemVirtualCurrency: S }
    );
}
