...
var r = n(200651),
    ...
    f = n(368365);
function m(e) {
    let { onClose: t, onConfirm: m, onCancel: g, channel: b, analyticsType: _, popoutText: C, animation: v } = e;
    i.useEffect(() => {
        u.default.track(
            d.rMx.OPEN_POPOUT,
            (function (e) {
    ...
    return (
        i.useEffect(() => {
            ...
            return (
                null != v &&
                    (async () => {
                        let [{ default: i }, l] = await Promise.all([Promise.resolve().then(n.t.bind(n, 500923, 23)), (0, o.wj)(t) ? v.dark() : v.light()]);
                        r ||
                            null == j.current ||
                            (e = i.loadAnimation({
                                container: j.current,
