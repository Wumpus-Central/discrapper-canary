...
function lj() {
    ...
    return (0, r.jsxs)("div", {
        ...
        children: [
            ...
            (0, r.jsx)("br", {}),
            (0, r.jsxs)("div", { className: lx.pq, children: ["Last winner: ", null != l ? au.M[l] : "None"] }),
            (0, r.jsx)("br", {}),
            (0, r.jsx)("div", {
                className: lx.uI,
...
let rr = [
    ...
    rd = [au.V.ADOPT_CLAN_IDENTITY_NOTICE],
    rc = [
...
function rp() {
    let e = (0, d.bG)([nt.A], () => nt.A.getGuildId()),
        t = (0, d.bG)([ne.A], () => ne.A.getGuild(e)?.name),
        a = (0, d.yK)([ah.A], () => [...ro, ...rd].filter((t) => null != e && (0, rl.zs)(t, e))),
            ...
            children: [
                ...
                (0, r.jsxs)("div", {
                    ...
                    children: [
                        ...
                        (0, r.jsx)(z.B, {
                            gap: 16,
                            children: rr.map((e) => (0, r.jsx)(lk, { className: rm.z6, content: au.M[e] }, au.M[e])),
                        }),
                    ],
                }),
                (0, r.jsx)("div", {
                            ...
                            (0, r.jsx)(
                                m.d,
                                {
                                    ...
                                    onChange: (a) => {
                                        a
                                            ? (0, rl._$)(t, e, !1)
                                            : ((0, am._N)(au.M.GUILD_POWERUP_NOTIFICATION), (0, rl.hk)(t, e));
                                    },
                                },
                                t,
                            ),
                ...
                (0, r.jsxs)("div", {
                    ...
                    children: [
                        ...
                        rc.map((e) => (0, r.jsx)(lk, { className: rm.z6, content: au.M[e] }, au.M[e])),
                    ],
                }),
                (0, r.jsxs)("div", {
                    className: rm.uW,
...
let rM = {
    ...
    "discord_app/images/burst_reactions/BurstReaction_Bubbles_v03.lottiejson": () =>
        a.e("69389").then(a.t.bind(a, 95553, 19)),
...
function ck() {
    let e = o.useCallback(() => {
        ...
        { lastDismissedAtMs: t } = (0, cE.FZ)(au.M.NITRO_TENURE_BADGE_LEVEL_UP),
            ...
            switch ((xO.info(`Result Type: ${e.type}`), e.type)) {
                        ...
                        e.record.isDM() &&
                            ...
                            e.record.recipients.forEach((e) => {
                                ...
                                null != t &&
                                    ...
                                    xO.info(`recipient nickname: ${aC.A.getNickname(t.id)}`));
                            }));
                    break;
                case xR.rD.GROUP_DM:
                    xO.info(`channel type: ${e.record.type}`),
                        xO.info(`channel id: ${e.record.id}`),
                        xO.info(`name: ${(0, aE.m1)(e.record, el.default, aC.A)}`),
                        e.record.isGroupDM() &&
                            (xO.info(`default name: ${(0, aE.ks)(e.record, el.default, aC.A)}`),
                ...
                case xR.rD.USER:
                    xO.info(`user id: ${e.record.id}`),
                        ...
                        xO.info(`nickname: ${aC.A.getNickname(e.record.id)}`),
                    ...
                    xB.setState({ isUploading: !0, errorMessage: null, isSuccess: !1 }),
                        ...
                        e &&
                            ...
                            v.forEach((e) => {
                                let t = xk.A.getScoreWithoutFetchingLatest(e.id);
                                xO.info(`id: ${e.id} - Frecency Score: ${t}`),
                                    xO.info(`default name: ${(0, aE.ks)(e, el.default, aC.A)}`),
                                    xO.info(`name: ${(0, aE.m1)(e, el.default, aC.A)}`);
                            }),
                            xw(),
