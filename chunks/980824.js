...
function J(e) {
    let { children: t, id: n, root: r, preserveTabOrder: s = !0 } = e,
        c = X({
            id: n,
            root: r,
        }),
        ...
        _ = i.useRef(null),
        m = i.useRef(null),
        h = null == u ? void 0 : u.modal,
        g = null == u ? void 0 : u.open,
        E = !!u && !u.modal && u.open && s && !!(r || c);
    return (
        i.useEffect(() => {
            if (c && s && !h)
                return (
...
function ed(e, t) {
    ...
    let { open: n, onOpenChange: r, elements: o, dataRef: l } = e,
        ...
        O = i.useRef(!1),
        { escapeKey: v, outsidePress: S } = eu(h),
        { escapeKey: I, outsidePress: T } = eu(g),
        C = i.useRef(!1),
        P = (0, a.iW)((e) => {
            var t;
    ...
    let d = (e) => {
        ...
        return function (e) {
            ...
            if (
                ...
                (p && eS(p.nodesRef.current, f).length)
            )
                return;
            if (
                ("top" === I && o >= v.bottom - 1) ||
