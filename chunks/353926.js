...
function ec(e) {
    ...
    (s.K.remove(O), t || (s.K.remove(v), s.K.remove(I), s.K.remove(T), (k = {}), (j = {})), (D = {}), (P = y(E({}, P), { rawUserExperiments: [] })), (C = {}), (N = !1));
}
function eu() {
...
function eg(e) {
    ...
    if (
        (null == r
            ? ((k = E({}, k)), delete k[n], (j = E({}, j)), delete j[n])
            : 'user' === o
              ? (k = y(E({}, k), {
                    [n]: {
                        type: o,
        ...
        for (let e of [k, j]) for (let t in e) null == R[t] && delete k[t];
    ep();
}
function eE(e) {
    let { guild: t } = e;
