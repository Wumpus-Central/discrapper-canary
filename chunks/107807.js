...
function Q(e) {
    let { eligibilityStatesGroups: n, onPlatformConnect: t, onPlatformConnected: a } = e,
        ...
        j = o.useMemo(() => d().groupBy(_, (e) => ''.concat(e.connection_type).concat(null != e.application_id ? ':'.concat(e.application_id) : '')), [_]);
    ...
    return (0, c.jsx)(c.Fragment, {
        children: Object.keys(j)
            ...
            .map((e) => {
                ...
                M.SJ.includes(null !== (n = null == S ? void 0 : S.id) && void 0 !== n ? n : '')
                    ? (d = (0, c.jsx)(V.Z, {
                          className: H.botTag,
                          color: A,
                          size: 16
                            ...
                            onClick:
                                !g && O
                                    ? () => {
                                          var e, n;
                                          return (
                                              (n = null !== (e = null == T ? void 0 : T.type) && void 0 !== e ? e : z.Kt),
                                              void ((0, Z.Z)({
                                                  platformType: n,
...
function $(e) {
    ...
    function ed() {
        R.default.track(D.rMx.PASSPORT_CHALLENGE_STARTED, U({ role_id: l.id }, (0, j.hH)(a)));
    }
    function eu(e) {
    ...
    return (
        ...
        o.useEffect(() => {
            R.default.track(D.rMx.PASSPORT_CHALLENGE_VIEWED, U({ role_id: l.id }, (0, j.hH)(a)));
        }, [a, l.id]),
        o.useEffect(() => {
            y && null != eo && eo.roles.includes(l.id) && (g(!1), ea.length > 0 ? s(2) : null == t || t(), R.default.track(D.rMx.PASSPORT_CHALLENGE_FINISHED, U({ role_id: l.id }, (0, j.hH)(a))));
