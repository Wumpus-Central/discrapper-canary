...
let eS = (0, f.Zc)(
    ...
    eA = new Set([g.fx.AUTO, s.l.COZY, s.l.COMPACT]);
(0, f.Zc)(
    "appearance",
    "channelListLayout",
    (e) => (null != e && eA.has(e.value) ? e.value : s.l.COZY),
    (e) => o.Gm.create({ value: e }),
);
let eC = new Set([s.Z.ALL, s.Z.UNREADS, s.Z.NONE]);
(0, f.Zc)(
    "appearance",
    "messagePreviews",
    (e) => (null != e && eC.has(e.value) ? e.value : s.Z.ALL),
    (e) => o.Gm.create({ value: e }),
);
let eN = (0, f.KM)(
        (0, f.Zc)(
