...
function k(e, t, n) {
    let { referencedMessage: o, channel: a, compact: s, isReplyAuthorBlocked: l, repliedAuthor: f, showAvatarPopout: _, onClickAvatar: p, onContextMenu: h, onPopoutRequestClose: m } = e,
    ...
    if (o.message.type === R.uaV.USER_JOIN || o.message.type === R.uaV.ROLE_SUBSCRIPTION_PURCHASE || o.message.type === R.uaV.GUILD_DEADCHAT_REVIVE_PROMPT || o.message.type === R.uaV.GUILD_GAMING_STATS_PROMPT) return (0, r.jsx)(x, { className: w.userJoinSystemMessageIcon });
...
function j(e, t) {
    let { baseMessage: n, channel: i, referencedMessage: o, showUsernamePopout: a, onClickUsername: s, onContextMenu: l, onPopoutRequestClose: c } = e,
        u = (null == o ? void 0 : o.state) === E.Y.LOADED ? o.message : void 0;
    return null == u || u.type === R.uaV.USER_JOIN || u.type === R.uaV.ROLE_SUBSCRIPTION_PURCHASE || u.type === R.uaV.GUILD_APPLICATION_PREMIUM_SUBSCRIPTION || u.type === R.uaV.GUILD_DEADCHAT_REVIVE_PROMPT || u.type === R.uaV.GUILD_GAMING_STATS_PROMPT || u.type === R.uaV.POLL_RESULT
        ? null
        : (0, r.jsx)(A.Z, {
              message: u,
              channel: i,
        ...
        case E.Y.LOADED: {
            ...
            return (0, r.jsxs)(r.Fragment, {
                children: [
                    _,
                    (0, r.jsx)(c.P3F, {
                        className: a()(w.repliedTextPreview, w.clickable, { [w.repliedMessageClickableSpineHovered]: t }),
                        onClick: d,
                        onMouseEnter: n,
                        onMouseLeave: n,
...
function B(e) {
    let t,
        { repliedAuthor: n, baseAuthor: o, baseMessage: s, referencedMessage: u, renderPopout: d, isReplySpineClickable: _, showReplySpine: p } = e,
