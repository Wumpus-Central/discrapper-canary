n.d(t, { Z: () => b }), n(290780), n(49124), n(539854), n(415506), n(388685);
var r = n(512722),
    i = n.n(r),
    a = n(392711),
    o = n.n(a),
...
class b {
    ...
    handleRequest(e, t) {
        new Promise((n) => {
            if (null == t.nonce || "" === t.nonce)
                throw new c.Z({ errorCode: p.lTL.INVALID_PAYLOAD }, "Payload requires a nonce");
            let r = t.cmd,
                i = this.commands[r];
            if (null == i) throw new c.Z({ errorCode: p.lTL.INVALID_COMMAND }, "Invalid command: ".concat(t.cmd));
            if (!(0, d.Z)(e.authorization.scopes, i.scope))
                throw new c.Z({ errorCode: p.lTL.INVALID_PERMISSIONS }, "Not authenticated or invalid scope");
                        ...
                        if (null != e.validation) {
                            ...
                            i()(null != e.validation, "command.validation must not be null"),
                                a.validate(t.args, e.validation(a), { convert: !1 }, (t) => {
                                    if (null != t)
                                        return void r(new c.Z({ errorCode: p.lTL.INVALID_PAYLOAD }, t.message));
                                    n(e);
                                });
                        } else n(e);
                    }),
        ...
        (null != r && "" !== r && E(r)) ||
            this.subscriptions.forEach((r) => {
                ...
                r.evt === e &&
                    ...
                    ("function" == typeof n && (n = n(r)), this.dispatch(r.socket, null, p.Etm.DISPATCH, r.evt, n));
            });
    }
    updateSubscriptions() {
    ...
    storeWait(e, t, n) {
        ...
        let i = o().uniqueId(),
            a = () => this.removeSubscription(e, m, { uniqueId: i });
        return new Promise((r, o) => {
            let s = setTimeout(() => {
                a(), o(Error("timeout"));
            }, n * l.Z.Millis.SECOND);
            this.addSubscription(e, m, { uniqueId: i }, () => {
                let e = t();
