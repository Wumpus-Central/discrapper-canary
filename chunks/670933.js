...
function o(e, t) {
    ...
    if (l.timezone) {
        if (isNaN((o = g(l.timezone)))) return new Date(NaN);
    } else {
        var m = new Date(u + p),
            E = new Date(0);
...
function _(e, t) {
    ...
    var u = new Date(0);
    return O(t, a, o) && v(t, i) ? (u.setUTCFullYear(t, a, Math.max(i, o)), u) : new Date(NaN);
}
function p(e) {
...
function h(e) {
    ...
    var n = m(t[1]),
        i = m(t[2]),
        a = m(t[3]);
    return S(n, i, a) ? n * r.vh + i * r.yJ + 1000 * a : NaN;
}
function m(e) {
...
function g(e) {
    ...
    return T(i, a) ? n * (i * r.vh + a * r.yJ) : NaN;
}
function E(e, t, n) {
    var r = new Date(0);
