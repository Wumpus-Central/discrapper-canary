...
var j = n(857192),
    ...
    B = n(70956),
    Z = n(378799);
j.default.cssDebuggingEnabled && n.e("95666").then(n.bind(n, 754261)), (0, Z.s5)();
...
if (null != D.Z) {
    ...
    ("ptb" === d || "canary" === d || "development" === d) && T.ZP.pauseFrameEvictor(),
        T.ZP.initializeExitHook(),
        T.ZP.initializeWERHandler();
}
