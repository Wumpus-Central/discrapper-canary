...
var n = r(627968),
    ...
    _ = r(466919),
    p = r(375708);
let f = { 1: "what_you_lose", 2: "confirmation" },
    P = (t) => {
        let { onClose: e, currentUser: r, onNext: i, ...o } = t;
    ...
    w = (t) => {
        let { onClose: e, onConfirm: r, isRemovingUser: i, ...o } = t;
        return (0, n.jsx)(a.Modal, {
            size: "md",
    ...
    C = (t) => {
        ...
        (0, o.Ay)(() => {
            ...
            (C.current = t),
                (E.current = t),
                s.default.track(m.HAw.PREMIUM_GROUP_MEMBER_CANCELLATION_STARTED, { subscription_id: e });
        });
        let M = (t, r) => {
                s.default.track(m.HAw.PREMIUM_GROUP_MEMBER_CANCELLATION_STEP, {
                    subscription_id: e,
                    from_step: f[t],
                    to_step: r,
            ...
            T = async () => {
                p(!0),
                    (await (0, u.oO)(e, r.id)).ok &&
                        (s.default.track(m.HAw.PREMIUM_GROUP_MEMBER_CANCELLATION_COMPLETED, { subscription_id: e }),
                        a()),
                    p(!1);
            };
        switch (c) {
            ...
            case 2:
                return (0, n.jsx)(w, { ...l, onConfirm: T, onClose: R, isRemovingUser: _ });
            default:
                return null;
        }
    };
