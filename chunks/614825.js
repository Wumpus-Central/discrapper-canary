...
class k extends i.Component {
    ...
    renderBody(e, t, n) {
        let { trialOffer: r } = this.props;
        if (e && !n && void 0 === r.redeemed_at)
            return R.intl.format(R.t.LwCwT0, { helpdeskArticle: O.Z.getArticleURL(C.BhN.REFERRAL_PROGRAM) });
        if (t) return null;
    ...
    renderExpirationDate(e, t, n) {
        ...
        if (void 0 !== r.redeemed_at && !n && null !== i)
            return R.intl.formatToPlainString(R.t.nP0ivb, { date: (0, b.vc)(l()(i), "LL") });
...
function j(e) {
    let { userTrialOfferId: t, canRenderReferralEmbed: n } = e,
        ...
        s = (0, u.e7)(
            [g.default],
            () => null != i && (0, v.I5)(void 0 !== a && i.user_id === a.id ? a : g.default.getUser(i.user_id)),
        ),
        l = (0, u.e7)([E.Z], () => {
            var e;
