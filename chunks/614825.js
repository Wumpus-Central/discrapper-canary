...
class Z extends i.Component {
    ...
    renderBody(e, t, n) {
        let { trialOffer: r } = this.props;
        if (e && !n && void 0 === r.redeemed_at) return N.intl.format(N.t.LwCwT0, { helpdeskArticle: v.Z.getArticleURL(T.BhN.REFERRAL_PROGRAM) });
        if (t) return null;
    ...
    renderActions(e, t, n) {
        ...
        let { trialOffer: a, currentUser: o, analyticsLocations: s } = this.props,
            ...
            p = o.id !== a.user_id || (0, O.I5)(o) || !o.verified || (0, j.B)(a),
...
function R(e) {
    let { userTrialOfferId: t, canRenderReferralEmbed: n } = e,
        ...
        o = (0, u.e7)([h.default], () => null != i && (0, O.I5)(void 0 !== a && i.user_id === a.id ? a : h.default.getUser(i.user_id))),
        s = (0, u.e7)([b.Z], () => {
            var e;
