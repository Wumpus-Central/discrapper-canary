"use strict";
n.d(t, { AO: () => d, Fu: () => h, TM: () => C, sC: () => O, yJ: () => _, zR: () => I });
var i = n(1139),
    r = n(861193),
    s = n(987701),
    a = n(258635);
...
function C(e) {
    ...
    var C = f();
    function R(e) {
        (0, i.A)(F, e), (F.length = t.length), C.notifyListeners(F.location, F.action);
    }
    var O = !1,
        b = null;
    function D() {
    ...
    var G = !1,
        F = {
            ...
            push: function (e, t) {
                ...
                C.confirmTransitionTo(i, n, s, function (e) {
                    if (e) {
                        var t = d(i),
                            r = g(h + t);
                        if (N() !== r) {
