...
let K = (e) => {
    ...
    F = [h.A.unsafe_rawColors.BLUE_345.css, h.A.colors.INTERACTIVE_TEXT_DEFAULT.css],
    W = (e) => {
...
let z = {
    [V.WTw.INSTALLING]: {
        [P.pJ.NONE]: (e, t, n, i) => H.intl.formatToPlainString(H.t.JfJt9d, { percent: e, progress: t, total: n }),
        [P.pJ.SECONDS]: (e, t, n, i) =>
            H.intl.formatToPlainString(H.t["1z3c6e"], { percent: e, progress: t, total: n, timeRemaining: i }),
        [P.pJ.MINUTES]: (e, t, n, i) =>
    ...
    [V.WTw.UPDATING]: {
        [P.pJ.NONE]: (e, t, n, i) => H.intl.formatToPlainString(H.t.JsqXXL, { percent: e, progress: t, total: n }),
        [P.pJ.SECONDS]: (e, t, n, i) =>
...
function Y(e, t, n, i, s) {
    let l = z[t],
        ...
        { unit: a, time: o } = (0, P.$l)(null != e ? e / 60 : null, r);
    if (null != l && null != a) {
        let e = l[a];
...
function J(e) {
    ...
    switch (n) {
        ...
        case V.OQC.REPAIRING:
            if (t === V.WTw.REPAIRING) return Y(r, t, i, o, a);
...
class Q extends s.PureComponent {
    ...
    renderStackedProgress(e) {
        ...
        return (0, i.jsxs)(R.A, {
            direction: R.A.Direction.VERTICAL,
            children: [
                (0, i.jsx)(m.L, { percents: t, size: m.L.Sizes.SMALL, foregroundColors: F, animate: this.isFocused }),
    ...
    renderPaused() {
        ...
        return this.renderBody({
            message: r,
            foregroundColor: (0, p.q)(t) ? h.A.unsafe_rawColors.PRIMARY_300.css : h.A.unsafe_rawColors.PRIMARY_500.css,
            percent: s,
        });
    }
    ...
    renderProgressPatching() {
        return (0, i.jsx)(k.A, {
            getHistoricalTotalBytes: L.A.getHistoricalTotalBytesWritten,
            updateInterval: 5e3,
    ...
    renderProgressDefault() {
        ...
        return this.renderBody({
            percent: l,
            message: J({ type: s, stage: i, percent: r, progress: n, total: t }),
...
let q = () => (0, i.jsx)(W, { icon: g.u, tooltip: H.intl.string(H.t.YGm6SZ), onClick: () => C.U() }),
    Z = () => (0, i.jsx)(W, { icon: f.E, tooltip: H.intl.string(H.t.TVAd5J), onClick: () => C.v7() }),
    $ = (e) => {
        let { item: t } = e;
        return (0, i.jsx)(W, {
            icon: _.z,
    ...
    et = [
        {
            ...
            render: (e) =>
                (0, i.jsxs)(R.A, {
                    ...
                    children: [
                        (0, i.jsx)(w.A, { game: e.application, className: G.__invalid_gameIcon, size: w.M.SMALL }),
                      ...
                      (0, i.jsxs)("div", {
                          ...
                          children: [
                              (0, i.jsx)(U.A, {
                                  ...
                                  getHistoricalTotalBytes: L.A.getHistoricalTotalBytesDownloaded,
        ...
        return (
            null != o &&
                e.push({
                    ...
                    state: c,
                    application: o,
                    libraryApplication: E.A.getLibraryApplication(r, a),
                    finished: t,
                    index: l,
                }),
            e
...
let es = (0, S.A)(
    d.Ay.connectStores([b.A, L.A, D.A, j.A, M.A], () => ({
        applications: [...ei(D.A.activeItems, !1, b.A, L.A), ...ei(D.A.finishedItems, !0, b.A, L.A)],
        paused: D.A.paused,
