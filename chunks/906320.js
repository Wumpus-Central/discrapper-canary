...
function Y(e) {
    ...
    switch (n) {
        ...
        case w.OQC.REPAIRING:
            if (t === w.WTw.REPAIRING) return F(a, t, i, o, s);
    ...
    renderQueued() {
        ...
        if (null != n) {
            ...
            if (null != i && null != r) {
                ...
                e =
                    l === w.OQC.PAUSING
                        ? M.intl.formatToPlainString(M.t.vjxhWo, { percent: s, progress: a, total: n })
                        : M.intl.formatToPlainString(M.t.voT3Bi, { percent: s, progress: a, total: n });
            }
        }
        return (
