...
class p {
    ...
    constructor(e) {
        u(this, "_members", new s.Z((e, t) => this._enqueue(e, { members: t }))),
            u(this, "_channels", new o.ZP((e, t) => this._enqueue(e, { channels: t }))),
            u(this, "_threadMemberLists", new l.Z((e, t) => this._enqueue(e, { thread_member_lists: t }))),
            ...
            u(this, "_pending", {}),
            u(this, "_flush", new a.sW(0, () => this.flush())),
