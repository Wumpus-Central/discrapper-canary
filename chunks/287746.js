...
function e5(e) {
    ...
    return t ? (0, r.jsx)("section", e4(e3({}, n), { role: "complementary" })) : (0, r.jsx)("main", e3({}, n));
}
let e9 = i.forwardRef((e, t) => (0, r.jsx)(te, e4(e3({}, e), { ref: t })));
...
class te extends i.PureComponent {
    ...
    componentDidUpdate(e, t) {
        ...
        t.textValue.length < eJ.J6R && r.length >= eJ.J6R && ew.default.track(eJ.rMx.MESSAGE_LENGTH_LIMIT_REACHED, {});
    }
    handleEditLastMessage(e) {
        let { channel: t } = this.props;
        f.Z.startEditMessageRecord(t.id, e), x.ZP.trackWithMetadata(eJ.rMx.MESSAGE_EDIT_UP_ARROW);
    }
    ...
    render() {
        let {
            ...
            x =
                e.type === eJ.d4z.GUILD_ANNOUNCEMENT && C
                    ? (0, r.jsx)(B.Z, {
                          ...
                          accessibilityLabel: d,
                          pendingReply: o,
                          type: k.Ie.CREATE_ANNOUNCEMENT_POST,
    ...
    constructor(...e) {
        ...
        super(...e),
            ...
            e8(
                this,
                "state",
                e4(e3({}, (0, U.eK)(eE.Z.getDraft(this.props.channel.id, eE.d.ChannelMessage))), {
                    ...
                    case eJ.yXg.ARROW_UP:
                        ...
                        if ((e.preventDefault(), t))
                            eN.Z.getUploadCount(r.id, eE.d.ChannelMessage) > 0
                                ? eD.S.dispatchToLastSubscribed(eJ.CkL.FOCUS_ATTACHMENT_AREA)
                                : eD.S.dispatchToLastSubscribed(eJ.CkL.FOCUS_MESSAGES, { atEnd: !0 });
                        else {
                            let { channel: e } = this.props,
                                t = eP.Z.getLastChatCommandMessage(e.id),
                                n = eP.Z.getLastEditableMessage(e.id);
                            null != t && null != n
                                ? ek.default.compare(n.id, t.id) > 0
            ...
            e8(this, "handleSendMessage", async (e) => {
                ...
                if (null != l) {
                    if (l.inputType === R.iw.BUILT_IN_INTEGRATION)
                        return (
                            eD.S.dispatch(eJ.CkL.SHAKE_APP, {
                                duration: 200,
                                intensity: 2,
                            }),
                            Promise.resolve({
                    ...
                    if (null == e || e === R.bB.CHAT) {
                        ...
                        e === R.bB.APPLICATION_LAUNCHER ||
                        e === R.bB.IMAGE_RECS_MENU ||
                        e === R.bB.IMAGE_RECS_SUBMENU
                    ) {
                        var y;
                ...
                return (0, eU.v)({
                    ...
                    if (!_)
                        if (C === eJ.zYc.SLOWMODE_COOLDOWN)
                            return (
                                ...
                                eD.S.dispatch(eJ.CkL.EMPHASIZE_SLOWMODE_COOLDOWN),
                                {
                                    shouldClear: !1,
                                    shouldRefocus: !0,
                                }
                    ...
                    if (
                        ...
                        null != s && (O.flags = (0, eL.pj)(null != (y = O.flags) ? y : 0, eJ.iLy.IS_COMPONENTS_V2)),
                        o)
                    )
                        return (
                    ...
                    if (null != n && n.length > 0) {
                        let e = (0, eG.KZ)(n);
                        if ((0, eG.Bf)(e, null == u ? void 0 : u.id))
                            return (
                                (0, eB.G)(d, e),
                                {
                                    shouldClear: !1,
...
class tt extends i.PureComponent {
    static getDerivedStateFromProps(e, t) {
        ...
        return n.id !== r
            ? {
                  textAreaFocused:
                      null != n && n.type !== eJ.d4z.GUILD_ANNOUNCEMENT && !c.tq && eZ.Z.can(eJ.Plq.SEND_MESSAGES, n),
                  currentChannelId: n.id,
              }
            : null;
    }
    componentDidMount() {
        eD.S.subscribe(eJ.CkL.FOCUS_CHANNEL_TEXT_AREA, this.handleRequestFocus);
    }
    ...
    componentWillUnmount() {
        eD.S.unsubscribe(eJ.CkL.FOCUS_CHANNEL_TEXT_AREA, this.handleRequestFocus);
    }
    render() {
        var e;
        let t,
            ...
            { textAreaFocused: w, textAreaHighlighted: R } = this.state,
            M = c === k.Ie.SIDEBAR;
        t =
        ...
        let D = (0, r.jsx)("div", {
            ...
            F = H && null != I && null != P && null != P.guild_id;
        return (0, r.jsx)(
            y.Z,
            {
                page: (0, eR.mE)(this.props.channel),
                ...
                if (t)
                    switch (e.which) {
                        case eJ.yXg.ARROW_LEFT:
                            n === k.Ie.SIDEBAR &&
                                eD.S.dispatch(eJ.CkL.FOCUS_CHANNEL_TEXT_AREA, { channelId: eT.Z.getChannelId() });
                            return;
                        case eJ.yXg.ARROW_RIGHT:
                            n === k.Ie.NORMAL &&
                                eD.S.dispatch(eJ.CkL.FOCUS_CHANNEL_TEXT_AREA, {
            ...
            e8(this, "renderMessageBanner", (e) => {
                ...
                return t.type === eJ.d4z.DM && n
                    ...
                    : t.isModeratorReportChannel() && t.isArchivedThread()
                      ...
                      : null != l && (0, X.J)(l) && null != i && !eZ.Z.can(eJ.Plq.ADMINISTRATOR, i)
                        ? (0, r.jsx)(J.T, {
                              guild: i,
                              disabledUntil: l,
                          })
...
let tn = i.memo(function (e) {
    ...
    let D = i.useRef(null),
        ...
        H = (0, b.iD)(t),
        F = (0, b.d7)(t),
        V = H.length > 0 || t.rateLimitPerUser > 0 || null != G || null != F,
        q = (0, z.Z)("ChannelChat"),
