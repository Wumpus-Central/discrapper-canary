...
class te extends i.PureComponent {
    ...
    constructor(...e) {
        ...
        super(...e),
            ...
            e3(this, 'state', e4(e7({}, (0, G.eK)(eP.Z.getDraft(this.props.channel.id, eP.d.ChannelMessage))), { contentWarningProps: null })),
