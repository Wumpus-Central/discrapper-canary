(n.d(t, { Z: () => tl }), n(388685), n(35282), n(781311), n(997841));
var r = n(255367),
    i = n(73800),
    l = n(120356),
    a = n.n(l),
...
function tt(e) {
    ...
    return t ? (0, r.jsx)('section', e4(e6({}, n), { role: 'complementary' })) : (0, r.jsx)('main', e6({}, n));
}
let tn = i.forwardRef((e, t) => (0, r.jsx)(tr, e4(e6({}, e), { ref: t })));
tn.displayName = 'ChannelTextAreaForm';
class tr extends i.PureComponent {
    ...
    componentDidUpdate(e, t) {
        ...
        t.textValue.length < e1.J6R && r.length >= e1.J6R && ek.default.track(e1.rMx.MESSAGE_LENGTH_LIMIT_REACHED, {});
    }
    handleEditLastMessage(e) {
        let { channel: t } = this.props;
        (f.Z.startEditMessage(t.id, e.id, e.content), j.ZP.trackWithMetadata(e1.rMx.MESSAGE_EDIT_UP_ARROW));
    }
    ...
    render() {
        ...
        return (0, r.jsx)(p.yRy, {
            ...
            renderPopout: (e) => {
                let { closePopout: t } = e;
                return (s()(null != C, 'ChannelTextAreaForm > Popout > renderPopout: contentWarningProps cannot be null'), (0, r.jsx)(y.Z, e6({ onClose: t }, C)));
            },
            children: () =>
                f
                    ? (0, r.jsx)(p.UkV, {
    ...
    constructor(...e) {
        ...
        (super(...e),
            ...
            e8(this, 'state', e4(e6({}, (0, B.eK)(eZ.Z.getDraft(this.props.channel.id, eZ.d.ChannelMessage))), { contentWarningProps: null })),
            ...
            e8(this, 'handleKeyDown', (e) => {
                ...
                switch (e.which) {
                    case e1.yXg.DELETE:
                    case e1.yXg.BACKSPACE:
                        return void this.handleIncrementCombo('', 1);
                    case e1.yXg.ARROW_UP:
                        if (i || l) return;
                        if ((e.preventDefault(), t)) eM.Z.getUploadCount(r.id, eZ.d.ChannelMessage) > 0 ? eB.S.dispatchToLastSubscribed(e1.CkL.FOCUS_ATTACHMENT_AREA) : eB.S.dispatchToLastSubscribed(e1.CkL.FOCUS_MESSAGES, { atEnd: !0 });
                        else {
            ...
            e8(this, 'handleTextareaChange', (e, t, n) => {
                ...
                let l = '' !== t && n !== this.state.richValue,
                    a = l && !te.test(t) && !t.startsWith('/') && (!this.isFirstChange || t !== this.state.textValue);
            ...
            e8(this, 'handleSendMessage', async (e) => {
                ...
                if (null != l) {
                    if (l.inputType === R.iw.BUILT_IN_INTEGRATION)
                        return (
                            eB.S.dispatch(e1.CkL.SHAKE_APP, {
                                duration: 200,
                                intensity: 2
                            }),
                            Promise.resolve({
                    ...
                    if (null == e || e === R.bB.CHAT) {
                        ...
                        var m;
                        let { location: t, sectionName: n } = null != (m = (0, eq._U)(l)) ? m : {},
                ...
                return (0, eH.v)({
                    ...
                    if (!m)
                        if (b === e1.zYc.SLOWMODE_COOLDOWN)
                            return (
                                eB.S.dispatch(e1.CkL.SHAKE_APP, {
                                    duration: 200,
                                    intensity: 2
                                }),
                                eB.S.dispatch(e1.CkL.EMPHASIZE_SLOWMODE_COOLDOWN),
                                {
                                    shouldClear: !1,
                                    shouldRefocus: !0
                                }
                    ...
                    if (((C.location = e2.dy.CHAT_INPUT), o))
                        return (
...
class ti extends i.PureComponent {
    static getDerivedStateFromProps(e, t) {
        ...
        return n.id !== r
            ? {
                  textAreaFocused: null != n && !c.tq && ew.Z.can(e1.Plq.SEND_MESSAGES, n),
                  currentChannelId: n.id
              }
            : null;
    }
    componentDidMount() {
        eB.S.subscribe(e1.CkL.FOCUS_CHANNEL_TEXT_AREA, this.handleRequestFocus);
    }
    ...
    componentWillUnmount() {
        eB.S.unsubscribe(e1.CkL.FOCUS_CHANNEL_TEXT_AREA, this.handleRequestFocus);
    }
    render() {
        var e, t;
        let n,
            ...
            { textAreaFocused: D, textAreaHighlighted: k } = this.state,
            L = d === U.Ie.SIDEBAR;
        n = L && i.type === e1.d4z.GUILD_VOICE ? e3.t.pnnyFR : L && i.type === e1.d4z.GUILD_STAGE_VOICE ? e3.t.YInSkp : u.T.THREADS.has(i.type) ? e3.t['OkzL+f'] : e3.t.UbNmGR;
        let B = (0, r.jsx)('div', {
            ...
            { enabled: z } = eE.Z.getCurrentConfig({
                guildId: null == Z ? void 0 : Z.guild_id,
                location: 'ChannelChat'
            }),
            q = W.qM.getCurrentConfig({ location: 'ChannelChat' }).enabled,
            K = z && null != I && null != Z && null != Z.guild_id;
        return (0, r.jsx)(
            _.Z,
            {
                ...
                children: (0, r.jsx)(el.sW, {
                    children: (0, r.jsx)(ei.BV, {
                        children: (0, r.jsxs)(eU.I3, {
                            ...
                            children: [
                                (0, r.jsx)(eU.d9, {
                                    event: e1.CkL.TEXTAREA_FOCUS,
                                    handler: this.handleInputFocus
                                }),
                                (0, r.jsx)(eU.d9, {
                                    event: e1.CkL.TEXTAREA_BLUR,
                                    handler: this.handleInputBlur
                                }),
                                (0, r.jsx)(eU.d9, {
                                    event: e1.CkL.OPEN_EXPRESSION_PICKER,
                                    handler: this.handleOpenExpressionPicker
                                }),
                                (0, r.jsx)(eU.d9, {
                                    event: e1.CkL.OPEN_APP_LAUNCHER,
                                    handler: this.handleOpenAppLauncher
                                }),
                                (0, r.jsxs)(tt, {
                                    isSidebar: L,
                                    className: a()(e7.chatContent, {
                                        [e7.hasWallpaper]: null == N ? void 0 : N.isViewable,
                                        [X.e3]: q ? (null == N ? void 0 : N.isViewable) : void 0,
                                        [null != (e = (0, p.QeD)(T)) ? e : '']: q ? (null == N ? void 0 : N.isViewable) : void 0
                                    }),
                                                ...
                                                v
                                                    ...
                                                    : null !=
                                                      ...
                                                      : (0, r.jsxs)('form', {
                                                            ...
                                                            onSubmit: e9,
                                                            className: a()(e7.form, { [e7.formWithLoadedChatInput]: !H }),
                                                            children: [
    ...
    constructor(...e) {
        (super(...e),
            ...
            e8(this, '_handleMoveToPane', (e) => {
                ...
                if (t)
                    switch (e.which) {
                        case e1.yXg.ARROW_LEFT:
                            n === U.Ie.SIDEBAR && eB.S.dispatch(e1.CkL.FOCUS_CHANNEL_TEXT_AREA, { channelId: eR.Z.getChannelId() });
                            return;
                        case e1.yXg.ARROW_RIGHT:
                            n === U.Ie.NORMAL && eB.S.dispatch(e1.CkL.FOCUS_CHANNEL_TEXT_AREA, { channelId: eP.ZP.getCurrentSidebarChannelId(r.id) });
                    }
            }),
            ...
            e8(this, 'renderMessageBanner', (e) => {
                ...
                return t.type === e1.d4z.DM && n
                    ? (0, r.jsx)(eg.Z, {})
                    : t.isModeratorReportChannel() && t.isArchivedThread()
                      ? (0, r.jsx)(ey.Z, { channelId: t.id })
                      : null != l && (0, ee.J)(l) && null != i && !ew.Z.can(e1.Plq.ADMINISTRATOR, i)
                        ? (0, r.jsx)(en.T, {
                              guild: i,
                              disabledUntil: l
                          })
...
let tl = i.memo(function (e) {
    let { channel: t, guild: n, chatInputType: l, filterAfterTimestamp: a } = e,
        { placeholder: o, accessibilityLabel: s } = (0, eW.Z)({ channel: t }),
        ...
        m = (0, d.e7)([eN.ZP], () => {
            var e, t, r;
            return null != f && null != (r = null == (e = eN.ZP.getMember(null != (t = null == n ? void 0 : n.id) ? t : e1.lds, null == f ? void 0 : f.id)) ? void 0 : e.isPending) && r;
        }),
        ...
        I = (0, C.ZP)(),
        T = (0, K.Z)(t.id),
        N = (0, q.Z)(null == T ? void 0 : T.wallpaperId),
        {
            isInitialLoading: A,
    ...
    let B = i.useRef(null),
        ...
        G = (0, d.e7)([eI.Z], () => eI.Z.getChannel(H)),
        V = (0, d.e7)([eD.default], () => (t.type !== e1.d4z.DM ? null : eD.default.getUser(t.getRecipientId()))),
        W = (0, d.e7)([eh.ZP, eS.default], () => eh.ZP.getUserCombo(eS.default.getId(), t.id)),
        Y = (0, b.iD)(t),
        X = (0, b.d7)(t),
        Q = Y.length > 0 || t.rateLimitPerUser > 0 || null != W || null != X,
        $ = (0, z.Z)('ChannelChat'),
        { showLinkedLobbyApplicationLoadingIndicator: ee } = (0, ez.Z)(t.linkedLobby);
    return (0, r.jsx)(ti, {
        channel: t,
        ...
        showLinkedLobbyApplicationLoadingIndicator: ee
    });
});
