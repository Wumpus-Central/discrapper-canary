...
function tn(e) {
    var { isSidebar: t } = e,
        n = e9(e, ['isSidebar']);
    return t ? (0, r.jsx)('section', e6(e4({}, n), { role: 'complementary' })) : (0, r.jsx)('main', e4({}, n));
}
let tr = (e) => {
    let { ref: t } = e,
        n = e9(e, ['ref']);
    return (0, r.jsx)(ti, e6(e4({}, n), { refInstance: t }));
};
...
class ti extends i.PureComponent {
    ...
    render() {
        ...
        return (0, r.jsx)(p.yRy, {
            ...
            renderPopout: (e) => {
                let { closePopout: t } = e;
                return s()(null != x, 'ChannelTextAreaForm > Popout > renderPopout: contentWarningProps cannot be null'), (0, r.jsx)(y.Z, e4({ onClose: t }, x));
            },
            children: () =>
                f
                    ? (0, r.jsx)(p.UkV, {
    ...
    constructor(...e) {
        ...
        super(...e),
            (t = this),
            e5(this, 'isFirstChange', !0),
            e5(this, 'editorRef', null),
            e5(this, 'state', e6(e4({}, (0, G.eK)(eT.Z.getDraft(this.props.channel.id, eT.d.ChannelMessage))), { contentWarningProps: null })),
            e5(this, 'draftDidChange', function () {
            ...
            e5(this, 'handleKeyDown', (e) => {
                ...
                switch (e.which) {
                    ...
                    case e2.yXg.ARROW_UP:
                        if (i || l) return;
                        if ((e.preventDefault(), t)) eL.Z.getUploadCount(r.id, eT.d.ChannelMessage) > 0 ? eF.S.dispatchToLastSubscribed(e2.CkL.FOCUS_ATTACHMENT_AREA) : eF.S.dispatchToLastSubscribed(e2.CkL.FOCUS_MESSAGES, { atEnd: !0 });
                        else {
            ...
            e5(this, 'handleIncrementCombo', (e, t) => {
                var n;
            ...
            e5(this, 'handleTextareaChange', (e, t, n) => {
                let {
            ...
            e5(this, 'handleSendMessage', async (e) => {
                ...
                if (null != l) {
                    if (l.inputType === k.iw.BUILT_IN_INTEGRATION)
                        return (
                            eF.S.dispatch(e2.CkL.SHAKE_APP, {
                                duration: 200,
                                intensity: 2
                            }),
                            Promise.resolve({
                ...
                return (0, eV.v)({
                    ...
                    if (!m)
                        if (_ === e2.zYc.SLOWMODE_COOLDOWN)
                            return (
                                ...
                                eF.S.dispatch(e2.CkL.EMPHASIZE_SLOWMODE_COOLDOWN),
                                {
                                    shouldClear: !1,
                                    shouldRefocus: !0
                                }
                    ...
                    null != x && (null != x.content && (t = x.content), null != x.tts && (p = x.tts));
                    let y = ec.ZP.parse(c, t);
                    y.tts = y.tts || p;
            ...
            e5(this, 'renderApplicationCommandIcon', (e, t, n) =>
                (0, r.jsx)(F.Z, {
                    className: n,
                    command: e,
                    section: t,
...
class tl extends i.PureComponent {
    ...
    componentDidMount() {
        eF.S.subscribe(e2.CkL.FOCUS_CHANNEL_TEXT_AREA, this.handleRequestFocus);
    }
    ...
    componentWillUnmount() {
        eF.S.unsubscribe(e2.CkL.FOCUS_CHANNEL_TEXT_AREA, this.handleRequestFocus);
    }
    render() {
        var e, t;
        let n,
            { channel: i, guild: l, keyboardModeEnabled: o, hasModalOpen: s, pendingReply: c, chatInputType: d, placeholder: h, accessibilityLabel: f, showQuarantinedUserBanner: m, filterAfterTimestamp: g, communicationDisabledUntil: b, shakeIntensity: y, poggermodeEnabled: C, isSelectedResourceChannel: v, showAutomodUserProfileChatBlocker: j, showAppLauncherButton: O, showAppDMsUI: E, isInitialLoading: I, isRefreshChatInputEnabled: P, isRefreshEnabled: S, pendingScheduledMessage: Z, recipientUser: N, voiceChannel: T, theme: A, chatWallpaperState: w, wallpaperColorMix: R } = this.props,
            { textAreaFocused: k, textAreaHighlighted: M } = this.state,
            L = d === B.Ie.SIDEBAR;
        n = L && i.type === e2.d4z.GUILD_VOICE ? e3.t.pnnyFR : L && i.type === e2.d4z.GUILD_STAGE_VOICE ? e3.t.YInSkp : u.T.THREADS.has(i.type) ? e3.t['OkzL+f'] : e3.t.UbNmGR;
        let D = (0, r.jsx)('div', {
                className: e7.channelBottomBarArea,
            ...
            F = G && I ? D : U,
            H = a()({
                [e8.barWithAppLauncherButton]: O,
                [e8.barWithAppsDMsUI]: E
            }),
            { enabled: V } = eP.Z.getCurrentConfig({
                    ...
                    children: (0, r.jsx)(el.BV, {
                        children: (0, r.jsxs)(eG.I3, {
                            ...
                            children: [
                                ...
                                (0, r.jsxs)(tn, {
                                    isSidebar: L,
                                    className: a()(e7.chatContent, {
                                        [e7.hasWallpaper]: null == w ? void 0 : w.isViewable,
                                        [X.e3]: z ? (null == w ? void 0 : w.isViewable) : void 0,
                                        [null != (e = (0, p.QeD)(A)) ? e : '']: z ? (null == w ? void 0 : w.isViewable) : void 0
                                    }),
                                    'aria-label': e3.intl.formatToPlainString(n, { channelName: i.name }),
                                    ...
                                    children: [
                                        ...
                                        (0, r.jsxs)(p.y5t, {
                                            component: (0, r.jsx)(p.nn4, { children: (0, r.jsx)(p.H, { children: e3.intl.format(e3.t.eTzKk5, { channelName: i.name }) }) }),
                                            children: [
                                                (0, r.jsx)(ep.Z, {
                                                    channel: i,
                                                    forceCozy: v,
                                                ...
                                                v
                                                    ...
                                                    : null !=
                                                      ...
                                                      : (0, r.jsxs)('form', {
                                                            ...
                                                            onSubmit: te,
                                                            className: a()(e7.form, { [e7.formWithLoadedChatInput]: !G }),
                                                            children: [
                                                                C && (0, r.jsx)(eg.Z, { channelId: i.id }),
                                                                i.isPrivate()
                                                                    ? (0, r.jsx)(e$.Z, {
                                                                          channel: i,
                                                                          children: F
    ...
    constructor(...e) {
        super(...e),
            e5(this, 'channelTextAreaFormRef', i.createRef()),
            e5(this, 'inputFormRef', i.createRef()),
            e5(this, 'state', {
                textAreaFocused: !1,
                textAreaHighlighted: !1,
                currentChannelId: this.props.channel.id
            }),
            e5(this, 'dispatchGroupRef', i.createRef()),
            e5(this, 'appIconAnimateRef', i.createRef()),
            e5(this, 'handleRequestFocus', (e) => {
                e.channelId === this.props.channel.id && this.setState({ textAreaFocused: !0 });
            }),
            e5(this, 'handleInputFocus', (e) => {
                var t;
            ...
            e5(this, 'handleInputKeyDown', (e, t) => {
            ...
            e5(this, '_handleMoveToPane', (e) => {
                let { keyboardModeEnabled: t, chatInputType: n, channel: r } = this.props;
                if (t)
                    switch (e.which) {
                        case e2.yXg.ARROW_LEFT:
                            n === B.Ie.SIDEBAR && eF.S.dispatch(e2.CkL.FOCUS_CHANNEL_TEXT_AREA, { channelId: eM.Z.getChannelId() });
                            return;
                        case e2.yXg.ARROW_RIGHT:
                            n === B.Ie.NORMAL && eF.S.dispatch(e2.CkL.FOCUS_CHANNEL_TEXT_AREA, { channelId: eZ.ZP.getCurrentSidebarChannelId(r.id) });
                    }
            }),
            e5(this, 'handleOpenExpressionPicker', (e) => {
                let { activeView: t } = e;
                (0, J.PG)(t, this.props.chatInputType);
            }),
            e5(this, 'handleOpenAppLauncher', (e) => {
                let { applicationId: t } = e;
                return P.__(Z._b.TEXT, this.props.chatInputType, { applicationId: t });
            }),
            e5(this, 'handleChatInteract', () => {
                var e;
                null == (e = this.dispatchGroupRef.current) || e.bumpDispatchPriority();
            }),
            e5(this, 'handleCommandSentinelTyped', () => {
                var e;
                null == (e = this.appIconAnimateRef.current) || e.animate();
            }),
            e5(this, 'renderMessageBanner', (e) => {
                ...
                return t.type === e2.d4z.DM && n
                    ...
                    : t.isModeratorReportChannel() && t.isArchivedThread()
                      ...
                      : null != l && (0, et.J)(l) && null != i && !ek.Z.can(e2.Plq.ADMINISTRATOR, i)
                        ? (0, r.jsx)(er.T, {
                              guild: i,
                              disabledUntil: l
                          })
            ...
            e5(this, 'renderAppLauncherButton', () => {
...
let ta = i.memo(function (e) {
    ...
    let U = i.useRef(null),
        ...
        H = (0, d.e7)([eM.Z], () => eM.Z.getVoiceChannelId()),
        V = (0, d.e7)([eN.Z], () => eN.Z.getChannel(H)),
        z = (0, d.e7)([eD.default], () => (t.type !== e2.d4z.DM ? null : eD.default.getUser(t.getRecipientId())));
    return (0, r.jsx)(tl, {
        channel: t,
