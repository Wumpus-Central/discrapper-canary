            ...
            eY(this, "handleSendMessage", async (e) => {
                ...
                return (0, eM.v)({
                    ...
                    if (
                        ...
                        null != s && (E.flags = (0, d.pj)(null != (C = E.flags) ? C : 0, ez.iLy.IS_COMPONENTS_V2)),
                        o)
                    )
                        return (
...
class e3 extends r.PureComponent {
    static getDerivedStateFromProps(e, t) {
        ...
        return n.id !== i
            ? {
                  textAreaFocused:
                      null != n && n.type !== ez.d4z.GUILD_ANNOUNCEMENT && !c.tq && ej.Z.can(ez.Plq.SEND_MESSAGES, n),
            ...
            eY(this, "renderMessageBanner", (e) => {
                ...
                return t.type === ez.d4z.DM && n
                    ...
                    : t.isModeratorReportChannel() && t.isArchivedThread()
                      ...
                      : null != l && (0, z.J)(l) && null != r && !ej.Z.can(ez.Plq.ADMINISTRATOR, r)
                        ? (0, i.jsx)(q.T, {
                              guild: r,
                              disabledUntil: l,
                          })
...
let e4 = r.memo(function (e) {
    let { channel: t, guild: n, chatInputType: r, filterAfterTimestamp: l } = e,
        ...
        E = (0, p.e7)([el.ZP, ey.default], () => el.ZP.getUserCombo(ey.default.getId(), t.id)),
        j = (0, y.iD)(t),
        S = (0, y.d7)(t),
