    ...
    v = (e) => {
        let { message: t, channel: n, compact: r } = e,
            l = t.premiumGroupInviteId,
            {
                ...
                [h.A, I.default, T.A],
                () => ({
                    inviteState: null != l ? h.A.getInviteState(l) : S.xI.NOT_FOUND,
                    isFetching: null != l && h.A.isFetching(l),
                    invite: null != l ? h.A.getInvite(l)?.invite : null,
        ...
        let m = (0, R.o1)({ sender: _, channel: n, isSender: A, inviteState: a });
