...
function V(e) {
    ...
    let { analyticsLocations: et, sourceAnalyticsLocations: en } = (0, d.ZP)(c.Z.USER_SETTINGS_TRY_OUT_PREMIUM),
        [er, ei] = i.useState(Math.floor(Math.random() * N.J2.length)),
        es = (e) => {
            if (e) {
                ...
                T.default.track(W.rMx.TRY_IT_OUT_PRESET_SELECTED, { preset: N.J2[er].presetName });
            }
        };
    i.useEffect(() => {
        G &&
