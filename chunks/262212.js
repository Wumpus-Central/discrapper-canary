...
function h(e) {
    let { powerup: t, isActive: n, compact: o } = e,
        ...
        s = x.intl.string(n ? f.default.TZsu1d : f.default.gSxlHR);
        ...
        return (0, r.jsxs)('div', {
            ...
            children: [
                ...
                (0, r.jsx)(l.Text, {
                    ...
                    children: x.intl.formatToPlainString(f.default.WRRYUV, { perkName: null != (s = null == (i = o.sourcePowerup) ? void 0 : i.title) ? s : x.intl.string(x.t.BfF6EB) })
                })
            ]
        });
    }
...
function N(e) {
    ...
    let { onActivate: g, isLoading: I, error: N, onShowDeactivate: Z } = (0, m.ZP)(t, n),
        O = (0, d.Z)(t, n).type !== _.A3.INACTIVE,
    ...
    return (
        ...
        (0, r.jsx)(l.ua7, {
            delay: 100,
            'aria-label': null != w ? w : O ? x.intl.string(f.default.TZsu1d) : void 0,
            text:
                null != w
                    ? w
                    : O
                    ...
                    j(
                        b(
                            j(b({}, e), {
                                ...
                                'aria-label': x.intl.string(O ? f.default.TZsu1d : f.default.gSxlHR),
                                disabled: P,
                                onClick: O ? Z : g,
                                submitting: I
                            }),
...
function Z(e) {
    ...
    return (0, r.jsx)('div', {
        ...
        children: (0, r.jsx)(a.zx, {
            ...
            grow: !0,
            onClick: i,
            children: o.type === _.Us.LEVEL ? x.intl.string(x.t['0Q61kJ']) : x.intl.string(x.t.Xa11Eh)
        })
    });
}
function O(e) {
    let { className: t, guildId: n, powerup: o, onError: i } = e,
        a = (0, d.Z)(n, o).type !== _.A3.INACTIVE,
        l = !a;
    return (0, r.jsxs)('div', {
        className: s()(v.container, t),
        children: [
