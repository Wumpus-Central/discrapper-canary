...
function j(e) {
    let { powerup: n, isActive: t, compact: i } = e,
        ...
        s = _.intl.string(t ? m.default.TZsu1d : m.default.gSxlHR);
...
function h(e) {
    ...
    let { onActivate: b, isLoading: h, error: C, onShowDeactivate: Z } = (0, d.ZP)(n, t),
        N = null != (0, c.Z)(n, t),
        { disabled: E, reason: w } = (0, l.Z)(n, t, N);
    return (
        i.useEffect(() => {
            null == u || u(C);
        }, [C, u]),
        (0, r.jsx)(a.ua7, {
            delay: 100,
            'aria-label': null != w ? w : N ? _.intl.string(m.default.TZsu1d) : void 0,
            text:
                null != w
                    ? w
                    : N
                      ? (0, r.jsxs)('div', {
                            ...
                            children: [
                                (0, r.jsx)(a.Text, {
                                    ...
                                    children: _.intl.string(m.default.TZsu1d)
                                }),
                                (0, r.jsx)(a.Text, {
                                    variant: 'text-xs/medium',
                                    children: _.intl.formatToPlainString(m.default['5HQUzM'], { boostCount: t.cost })
                                })
                            ]
                        })
                      : void 0,
                    ...
                    v(
                        f(
                            v(f({}, e), {
                                ...
                                innerClassName: x.buttonInner,
                                wrapperClassName: s()(x.secondaryButton, { [x.buttonWrapper]: !0 === p.grow }),
                                color: N ? a.Ttl.PRIMARY : a.Ttl.BRAND,
                                'aria-label': _.intl.string(N ? m.default.TZsu1d : m.default.gSxlHR),
                                disabled: E,
                                onClick: N ? Z : b,
                                submitting: h
                            }),
