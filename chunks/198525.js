...
function H(e) {
    let {
        ...
        q = (0, o.bG)([C.A], () => C.A.getChannel(H?.channelId) ?? null),
        Z = (0, k.D)({
            quest: t,
            questContent: N.uF.MEMBERS_LIST,
            sourceQuestContent: N.uF.MEMBERS_LIST,
    ...
    let eu = (0, c.z)({
        ...
        eh = () => {
            (0, O.Y5)({
                ...
                (0, x.navigateToQuestHome)({ fromContent: N.uF.MEMBERS_LIST, questId: t.id });
        },
        ef = () => {
            (0, L.Ll)(H, q) && null != q
                ? ((0, O.Y5)({
