    ...
    let M = async (t) => {
        ...
        T = async () => {
            if (!S) {
                k(!0);
                try {
                    await v(!0), (0, m.P0)((0, h.o)(_.intl.string(_.t["84yeoz"]), f.Ck.SUCCESS));
                } catch (e) {
                    let t = new y.A(e).getAnyErrorMessage();
                    null != t && (0, m.P0)((0, h.o)(t, f.Ck.FAILURE));
                } finally {
                    k(!1);
                }
            }
...
function H(t) {
    ...
    let E = c?.verified,
        _ = E ? G.ko.CONFIRM_START : G.ko.EMAIL_AND_PASSWORD,
        [A, g] = r.useState(_),
        [S, k] = r.useState(null),
        [m, h] = r.useState(null),
        [f, x] = r.useState(""),
    ...
    switch (A) {
        case G.ko.CONFIRM_START:
            return (0, a.jsx)(j, { onNext: () => g(G.ko.CONFIRM_CODE), onClose: n, transitionState: e });
        case G.ko.CONFIRM_CODE:
            return (0, a.jsx)(T, {
                error: m,
                setError: h,
                setEmailToken: k,
                onNext: () => g(G.ko.CHANGE_EMAIL_REASONS),
                transitionState: e,
                onClose: n,
            });
        case G.ko.CHANGE_EMAIL_REASONS:
            return (0, a.jsx)(N, {
                onNext: () => (
                    ...
                    null != p && u.qr.has(p) ? g(G.ko.CHANGE_EMAIL_WARNING) : g(G.ko.EMAIL_AND_PASSWORD)
                ),
                transitionState: e,
                onClose: n,
                reason: p,
        ...
        case G.ko.EMAIL_AND_PASSWORD:
            return (0, a.jsx)(U, {
                emailToken: S,
                onBack: E
                    ? () => g(null != p && u.qr.has(p) ? G.ko.CHANGE_EMAIL_WARNING : G.ko.CHANGE_EMAIL_REASONS)
                    : null,
                onNext: (t) => {
        ...
        case G.ko.COMPLETE:
            return (0, a.jsx)(d, { email: f, onClose: n, transitionState: e });
        default:
            return null;
    }
}
