...
function I() {
    return (0, r.jsx)(d.ZP, {
        contentTypes: [a.z.REPORT_TO_MOD_NEW_TAG],
        children: (e) => {
            let { visibleContent: t } = e;
            return t === a.z.REPORT_TO_MOD_NEW_TAG
                ? (0, r.jsx)(o.IGR, {
                      color: l.Z.BG_BRAND,
...
function T(e) {
    let t = (0, i.e7)([_.Z], () => _.Z.hasReportedMessage(e.channel_id, e.id)),
        n = (0, p.sP)(e);
    return ((0, s.zq)(() => {
        n && (0, u.Q3)(a.z.REPORT_TO_MOD_NEW_TAG, { dismissAction: b.L.AUTO_DISMISS });
    }),
    n)
        ? (0, r.jsx)(o.sNh, {
              id: 'report-to-mod',
              ...
              action: () => {
                  ((0, u.Q3)(a.z.REPORT_TO_MOD_NEW_TAG, { dismissAction: b.L.USER_DISMISS }), (0, f.tV)(e));
              },
              icon: (0, r.jsx)(I, {}),
              disabled: t
          })
