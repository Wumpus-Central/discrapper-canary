n.r(t), n.d(t, { default: () => _ }), n(321073);
var r = n(627968),
    l = n(64700),
    a = n(503698),
    i = n.n(a),
    ...
    k = n(375708),
    I = n(834926);
let D = { tension: 250, friction: 5, clamp: !0 },
    B = { visibility: "hidden" },
    _ = l.forwardRef(function (e, t) {
        let {
            ...
            eQ = F ?? O,
            e$ = eN ?? L.u,
            { focused: eG, focusedChanged: eV } = (0, R.A7)(),
            { visible: eH, visibleChanged: eY, targetRef: eZ } = (0, R.O7)(),
            ...
            tI = (0, l.useRef)(null),
            tD = l.useRef(!0),
            [tB, t_] = l.useState(null),
            tF = l.useRef(null),
            tU = (0, w.z5)(tg, tF, eI, eD),
            tO = l.useCallback(() => tj.current?.currentTime ?? null, []);
        (0, M.A)({ videoRef: tj, canvasRef: tk, enabled: tg && eF && !tP, canvasWidth: 32, canvasHeight: 18 });
        let tK = l.useCallback(
            ...
            { isHlsActive: tQ, hlsRef: t$ } = (0, C.Ay)(tj, {
                src: eQ,
                initialTimeSec: $,
                onError: tK,
                onHlsInstance: ev,
            ...
            { isReady: tG } = (0, S.A)({ videoRef: tj, hlsRef: t$, contentMetadata: eO, isHls: tQ }),
            tV = eK && !tG && !tQ,
        ...
        let t2 = l.useCallback(
            function (e) {
                ...
                if (((td.current = !0), eX(e), W?.(e, t), null != tj.current))
                    switch (e) {
                        case o.Q6.PLAYING:
                            t_(null), tj.current.play();
                            break;
                        case o.Q6.PAUSED:
                            (tu.current = !1), tj.current.pause(), (th.current = !1);
                            break;
                        case o.Q6.ENDED:
                            tN(!1);
                    }
        ...
        l.useEffect(() => {
            ...
            if ((e || t || r) && null != tj.current && ez === o.Q6.PLAYING) {
                ...
                t_(n), t2(o.Q6.PAUSED, n);
            }
        }, [eR, n, eG, eV, eH, eY, ez, t2]),
            (0, P.A)({
                videoRef: tj,
                enabled: eR,
                onPipPause: () => {
                    t_(o.KB.PICTURE_IN_PICTURE), t2(o.Q6.PAUSED, o.KB.PICTURE_IN_PICTURE);
                },
                onHiddenPause: () => {
                    t_(o.KB.FOCUS), t2(o.Q6.PAUSED, o.KB.FOCUS);
                },
            }),
            l.useEffect(() => {
                eV && ec?.(eG, ez);
                ...
                if (null != tj.current)
                    switch (ez) {
                        case o.Q6.ENDED:
                            ...
                            break;
                        case o.Q6.PLAYING:
                            t_(o.KB.USER), t2(o.Q6.PAUSED, o.KB.USER);
                            break;
                        default:
            ...
            no = l.useCallback(() => {
                ...
                if (((e.mode = "hidden"), null != e.cues))
                    for (let t = 0; t < e.cues.length; t++) {
                        let n = e.cues[t];
                        (0, T.C)(n) && ((n.id = `cue-${t}`), (n.onenter = () => ns(n)), (n.onexit = () => nu(n)));
                    }
            }, []);
        l.useEffect(() => {
        ...
        let nc = (e) => {
            ...
            [{ controlBarAnimSpring: nm }, nf] = (0, d.z)(() => ({
            ...
            nh = (0, l.useRef)(null),
            [{ captionHeightSpring: np }, nv] = (0, d.z)(() => ({ from: { captionHeightSpring: 0 }, config: D }));
        l.useEffect(
            () => (
                nv({ captionHeightSpring: tT && null != tH ? (nh.current?.clientHeight ?? 0) : 0, immediate: tP }),
                () => {
                    np.stop();
                }
            ),
            ...
            l.useEffect(
                () => (
                    nf({ controlBarAnimSpring: t5 || ti ? 1 : 0, immediate: tP }),
                    () => {
                        nm.stop();
                    }
                ),
        ...
        return (0, r.jsx)(m.D, {
            ...
            children: (0, r.jsxs)("div", {
                className: i()(I.NS, { [I.DO]: "portrait" === _, [I.r7]: "landscape" === _ }),
                tabIndex: -1,
                onKeyDown: nb,
                style: { "--custom-footer-horizontal-padding": "20px", "--custom-footer-bottom": "4px" },
                children: [
                    eF && !tP && (0, r.jsx)("canvas", { ref: tk, className: I.Xm }),
                    ng && X?.({ replay: nx }),
                    (0, r.jsxs)(E.A, {
                        ref: (e) => {
                            (tj.current = e),
                        ...
                        className: i()({ [I.R]: ng, [I.IR]: !0, [I.FP]: "cover" === eU && !tL }),
                        controls: !1,
                        poster: K,
                        preload: tg ? ex : "none",
                        ...
                        onLoadedMetadata: (e) => {
                            ...
                            let t = er?.() ?? tE,
                                n = el?.() ?? tC;
                            t !== tE && tb(t), n !== tC && tS(n), (tj.current.volume = n ? 0 : t);
                        ...
                        onPlaying: () => {
                            th.current && (es?.(performance.now()), (th.current = !1));
                        },
                        onWaiting: (e) => {
                        ...
                        children: [
                            ...
                            null != eI && (0, r.jsx)("track", { ref: tF, src: eI, kind: "metadata" }),
                    ...
                    ty &&
                        ...
                        (0, r.jsxs)(r.Fragment, {
                            children: [
                                ...
                                (0, r.jsx)(s.animated.div, {
                                    className: i()(I.xr, ep, { [I.MZ]: "portrait" === _ }),
                    ...
                    (0, r.jsx)(
                        ...
                        {
                            className: i()(I.yf, {
                                [I.ZH]: td.current && ez === o.Q6.PLAYING,
                                [I.v7]: td.current && ez === o.Q6.PAUSED,
                            }),
                            style: { "--custom-play-pause-pop-ms": "1000ms" },
                            children:
                                ez === o.Q6.PLAYING
                                    ? (0, r.jsx)(h.u, { className: I.PK })
                                    : (0, r.jsx)(p.E, { className: I.PK }),
                        },
                        ez,
                    ),
                    tT &&
                            ...
                            children: [
                                ...
                                (0, r.jsx)(s.animated.div, {
                                    ...
                                    children: (0, r.jsx)(A.A, {
                                        ...
                                        hideSkipButtons: eA ?? "portrait" === _,
                                        compactTimeDisplay: ew,
                                        size: tJ,
                                        downloadUrl: eE,
                                        downloadContentType: eb,
                                        extraButtons: eC,
