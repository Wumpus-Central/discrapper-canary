...
function I(e, t) {
    let n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2],
        r = f.get(e);
    if (null == r) return !1;
    for (let [e, { flags: i }] of r) if ((!n || e !== E) && (i & t) === t) return !0;
    return !1;
}
function T(e) {
...
class S extends r.Ay.Store {
    ...
    isCurrentUserPrioritySpeaker() {
        let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : _.x.DEFAULT;
        return null != E && this.isPrioritySpeaker(E, e);
    }
...
let y = new S(i.h, {
    ...
    SPEAKING: function (e) {
        ...
        if ((r & _.ME.PRIORITY) === _.ME.PRIORITY) {
            ...
            null != e && a.$3({ permission: c.xBc.PRIORITY_SPEAKER, user: n, context: e })
    ...
    VOICE_STATE_UPDATES: function (e) {
        ...
        return t.reduce((e, t) => {
            ...
            return (
                n === E && i === h && (p = r ?? null),
                a !== p && (s = f.delete(_.x.DEFAULT) || s),
                null == r
                    ? (s = n === E && i === h ? f.delete(_.x.DEFAULT) || s : g(_.x.DEFAULT, n) || s)
                    : n === E && i !== h
                      ? (s = f.delete(_.x.DEFAULT) || s)
                      : n !== E && r !== u.A.getChannelId() && (s = g(_.x.DEFAULT, n) || s),
                s || e
            );
        }, !1);
    },
