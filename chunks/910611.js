    ...
    switch (t.type) {
        ...
        case w.d4z.GROUP_DM:
            ...
            return (0, r.jsxs)(r.Fragment, {
                children: [
                    (0, r.jsx)(c.nn4, { children: L.intl.string(L.t["e5y+go"]) }),
                    (0, r.jsx)(N.j, { channel: t }, "channel-".concat(t.id)),
                ],
            });
            ...
            return null != t.linkedLobby
                ? (0, r.jsxs)(B, {
                      ...
                      children: [
                          Y(
                              g,
                              t.type === w.d4z.GUILD_ANNOUNCEMENT
                                  ? L.intl.string(L.t.l1dkSE)
                                  : L.intl.string(L.t.Pnajj4),
                          ),
                          (0, r.jsx)(R.Z.Title, {
                              level: b,
                              onContextMenu: d,
        ...
        case w.d4z.GUILD_DIRECTORY:
            let S = (null == s ? void 0 : s.features.has(w.oNc.HUB))
                ? L.intl.formatToPlainString(L.t.Dy2aho, { guildName: n })
                : n;
            return (0, r.jsxs)(i.Fragment, {
                children: [
                    null !== g
