...
class et {
    ...
    isUsable(e) {
        ...
        let n = x.ZP.getMember(this.id, this._userId);
        return null != n && (!!(n.roles.some((n) => e.roles.includes(n)) || (0, C.yH)(e)) || !1);
    }
    get rawEmojis() {
        return this._emojis;
    }
...
function ed(e) {
    var n, r;
    let i = ep()[e];
    return null != i && null !== (r = null === (n = es[i]) || void 0 === n ? void 0 : n.getEmoji(e)) && void 0 !== r ? r : void 0;
}
function ef(e) {
    var n, r;
    let i = ep()[e];
    return null != i && null !== (r = null === (n = es[i]) || void 0 === n ? void 0 : n.getUsableEmoji(e)) && void 0 !== r ? r : void 0;
}
function ep() {
    if ((eh(), null == el)) for (let e in ((el = {}), es)) for (let n of es[e].rawEmojis) el[n.id] = e;
    return el;
}
async function eh() {
    if (0 !== ea) return;
    ...
    if (null == e) return;
    ea = 2;
    let n = await (0, b.gs)('EmojiStore.loadSavedEmojis', () => m.Z.timeAsync('\uD83D\uDCBE', 'loadSavedEmojis', () => I.Z.getAsync(e)));
    if (((ea = 3), null != n))
        E.Z.dispatch({
...
function e_(e) {
    let { emojis: n } = e;
    for (let [e, r] of n) !Object.hasOwn(es, e) && L.Z.isMember(e) && eT(e, r);
    eI();
}
function em(e) {
    return new v.ZP({
        ...
        afterCompute: () => {
            e(), (eo = $.slice(0)), !p().some(es, (e) => e.usableEmojis.length > 0) && eo.splice($.indexOf(q.UX.CUSTOM), 1);
        },
...
class eg {
    ...
    getTopEmojiWithoutFetchingLatest(e) {
        if ((this.ensureDisambiguated(), null == this.topEmojis)) {
            ...
            this.topEmojis = o.filter((e) => !s.includes(e.id));
        }
    ...
    nameMatchesChain(e) {
        return p()(this.getDisambiguatedEmoji()).filter((n) => {
            let { names: r, name: i } = n,
                a = null != r && p().some(r, e),
                o = null != i && e(i),
                s = null != i && p().some(T.Z.getTermsForEmoji(i), e);
            return a || o || s;
        });
    }
    _buildDisambiguatedCustomEmoji() {
        ...
        H.ZP.forEach(r);
        let a = (e) => {
            let n = es[null == e ? z.kod : e];
            null != n && (p().each(n.usableEmojis, r), p().each(n.emoticons, i));
        };
...
function eT(e, n) {
    if ((eb(e), eg.clear(e), null == n)) return;
    let r = M.default.getCurrentUser();
    if (null == r) return;
    let i = (0, R.r)(e);
    es[e] = new et(e, r.id, n, i);
}
function eS(e) {
    for (let n of (ey(), e.guilds)) eT(n.id, n.emojis);
    (ea = e.guilds.every((e) => null != e.emojis) ? 1 : 0), eI();
}
function eA(e) {
    for (let n in (ey(), e.emojis)) eT(n, e.emojis[n]);
    (ea = 1), eI();
}
function eC() {
...
function eR(e) {
    1 === ea && null == e.guild.emojis && null != e.guild.emojiUpdates && (ea = 0), eT(e.guild.id, e.guild.emojis), eI();
}
function eO(e) {
    eT(e.guild.id, e.guild.emojis), eI();
}
function eD(e) {
...
function eL(e) {
    ...
    let a = es[r];
    eT(r, null == a ? void 0 : a.usableEmojis), eI();
}
function ew(e) {
...
function eP(e, n) {
    ...
    if ((j.Xb.trackExposure({ location: 'populateInitialFrecencyData' }), p().isEmpty(e) && p().isEmpty(ee.pendingUsages) && D.Z.hasLoaded(Q.yP.FRECENCY_AND_FAVORITES_SETTINGS))) for (let e of ['thumbsup', 'thumbsup', 'eyes', 'eyes', 'laughing', 'laughing', 'watermelon', 'fork_and_knife', 'yum', 'weary', 'tired_face', 'poop', '100']) eE.track(e);
    if ((r || i) && p().isEmpty(n) && p().isEmpty(ee.emojiReactionPendingUsages) && D.Z.hasLoaded(Q.yP.FRECENCY_AND_FAVORITES_SETTINGS)) for (let e of ['100', '100', 'thumbsup', 'thumbsup', 'thumbsdown', 'thumbsdown', 'heart', 'point_up', 'eyes', 'weary', 'laughing', 'white_check_mark', 'x']) ev.track(e);
}
function eM() {
    var e, n, r, i, a, o;
    let s = null === (n = D.Z.settings.textAndImages) || void 0 === n ? void 0 : null === (e = n.diversitySurrogate) || void 0 === e ? void 0 : e.value;
    null != s && H.ZP.setDefaultDiversitySurrogate(s), eg.reset();
    let l = D.Z.frecencyWithoutFetchingLatest,
        u = null !== (a = null === (r = l.emojiFrecency) || void 0 === r ? void 0 : r.emojis) && void 0 !== a ? a : {},
        c = null !== (o = null === (i = l.emojiReactionFrecency) || void 0 === i ? void 0 : i.emojis) && void 0 !== o ? o : {};
    eE.overwriteHistory(
        p().mapValues(u, (e) => ({
            ...e,
...
function ek(e) {
    ...
    if ((T.Z.setEmojiLocale(O.default.locale), n !== Q.yP.FRECENCY_AND_FAVORITES_SETTINGS || !r)) return !1;
    (ee.pendingUsages = []), (ee.emojiReactionPendingUsages = []);
}
function eU() {
...
function eF(e) {
    ...
    {
        let e = es[n];
        eT(n, null == e ? void 0 : e.emojis), eI();
    }
}
function eV(e) {
    let { guildId: n } = e,
...
function ej(e) {
    ...
    ec.set(n, {
        ...
        topEmojisTTL: _()(_()()).add(1, 'days').valueOf()
    });
}
function eH(e) {
    let { text: n } = e;
...
class eY extends (a = g.ZP.PersistedStore) {
    initialize(e) {
        this.waitFor(y.Z, L.Z, x.ZP, w.Z, O.default, N.Z, Y.Z, M.default, S.Z), null != e && (null != e.pendingUsages && (ee.pendingUsages = e.pendingUsages), null != e.emojiReactionPendingUsages && (ee.emojiReactionPendingUsages = e.emojiReactionPendingUsages), null != e.expandedSectionsByGuildIds && (ee.expandedSectionsByGuildIds = new Set(e.expandedSectionsByGuildIds))), this.syncWith([D.Z], eM), this.syncWith([S.Z], eU);
    }
    getState() {
        return ee;
    }
    ...
    getSearchResultsOrder(e, n, r, i) {
        let a = n.toLowerCase(),
            o = G.Z.escape(a),
            { canSplitFrecencyList: s } = V.Z.getCurrentConfig({ location: 'getSearchResultsOrder' }, { autoTrackExposure: !0 }),
            l = (0, j.E2)({
                location: 'getSearchResultsOrder',
                autoTrackExposure: !0
            });
        if ((j.Xb.trackExposure({ location: 'getSearchResultsOrder' }), e.length > 0)) {
            let n = RegExp('^'.concat(o), 'i'),
                r = new RegExp('(^|_|[A-Z])'.concat(o, 's?([A-Z]|_|$)')),
                u = r.test.bind(r),
                c = n.test.bind(n),
                d = function (e) {
                    ...
                    let r = e.toLowerCase(),
                        o = 1 + (r === a ? 4 : 0) + (u(r) || u(e) ? 2 : 0) + (c(e) ? 1 : 0),
                        d = i === K.Hz.REACTION && (s || l) ? ev.getScore(n) : eE.getScore(n);
                    return null != d && (o *= d / 100), o;
                };
            e = p().orderBy(e, [(e) => (null != e.names ? d(e.names[0]) : d(e.name, e.id)), (e) => (null != e.names ? e.names[0] : e.name)], ['desc', 'asc']);
        }
        return r > 0 && (e = e.slice(0, r)), e;
    }
    searchWithoutFetchingLatest(e) {
        let n,
            { channel: r, query: i, count: a = 0, intention: o, includeExternalGuilds: s = !0, matchComparator: l } = e;
        eh();
        ...
        return {
            unlocked: this.getSearchResultsOrder(f.unlocked, i, a, o),
            locked: this.getSearchResultsOrder(f.locked, i, 0, o)
        };
    }
    ...
    hasUsableEmojiInAnyGuild() {
        return eh(), Z.default.keys(es).some((e) => es[e].usableEmojis.length > 0);
    }
    hasFavoriteEmojis(e) {
        let n = eg.get(e);
