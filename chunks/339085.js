...
let z = "original",
    q = [
        F.UX.TOP_GUILD_EMOJI.toString(),
        F.UX.FAVORITES.toString(),
        F.UX.RECENT.toString(),
        F.UX.CUSTOM.toString(),
...
class Q {
    ...
    constructor(e, t, n, r = !1) {
        H(this, "id", void 0),
            H(this, "_userId", void 0),
            H(this, "_dirty", !0),
            H(this, "_emojis", void 0),
            H(this, "_emojiMap", {}),
            H(this, "_emoticons", []),
            H(this, "_usableEmojis", []),
            H(this, "_canSeeServerSubIAP", !1),
            H(this, "_totalUsable", 0),
            (this.id = e),
            (this._userId = t),
            (this._emojis = n),
...
function eu() {
    if ((ed(), null == eo)) for (let e in ((eo = {}), ei)) for (let t of ei[e].rawEmojis) eo[t.id] = e;
    return eo;
}
async function ed() {
    if (0 !== en) return;
...
class ep {
    static get(e) {
        return (
            void 0 === e && (e = null),
            (null == ep._lastInstance || ep._lastInstance.guildId !== e) && (ep._lastInstance = new ep(e)),
            ep._lastInstance
        );
    }
    static reset() {
    ...
    static resetFavorites() {
        null != ep._lastInstance &&
            ((ep._lastInstance.favorites = null), (ep._lastInstance.favoriteNamesAndIds = null));
    }
    static clear(e) {
    ...
    getFrequentlyUsedEmojisWithoutFetchingLatest() {
        ...
        let e = eh.frequently.map((e) => (null != e.id ? this.getById(e.id) : k.ZP.getByName(e.name))).filter(w.lm),
            t = (0, G.Z)(e);
    ...
    getFrequentlyUsedReactionEmojisWithoutFetchingLatest() {
        ...
        let e = em.frequently.map((e) => (null != e.id ? this.getById(e.id) : k.ZP.getByName(e.name))).filter(w.lm),
            t = (0, G.Z)(e);
        ...
        for (let e in (i(this.guildId), this.newlyAddedEmoji))
            null != this.newlyAddedEmoji[e]
                ? (this.newlyAddedEmoji[e] = this.newlyAddedEmoji[e]
                      .sort((e, t) => L.default.compare(t.id, e.id))
                      .slice(0, 3))
...
function eS(e) {
    1 === en && "update" === e.guild.emojis.op && null == e.guild.emojis.items && (en = 0),
        ey(e.guild.id, e.guild.emojis.items),
        eb();
}
function eA(e) {
...
function ew(e, t) {
    let { canSplitFrecencyList: n } = M.Z.getCurrentConfig(
    ...
    if (
        (j.Xb.trackExposure({ location: "populateInitialFrecencyData" }),
    ...
    if (
        ...
        v.Z.hasLoaded(V.yP.FRECENCY_AND_FAVORITES_SETTINGS)
    )
        for (let e of [
            "100",
            "100",
...
function eD() {
    ...
    null != s && k.ZP.setDefaultDiversitySurrogate(s), ep.reset();
    ...
    eh.overwriteHistory(
        o().mapValues(c, (e) => K(Y({}, e), { recentUses: e.recentUses.map(Number).filter((e) => e > 0) })),
        X.pendingUsages,
    ),
        em.overwriteHistory(
            o().mapValues(u, (e) => K(Y({}, e), { recentUses: e.recentUses.map(Number).filter((e) => e > 0) })),
...
function ex() {
    ...
    let { frecencyAlgorithm: e } = j.ZP.getCurrentConfig(
...
class eF extends (r = c.ZP.PersistedStore) {
    initialize(e) {
        this.waitFor(f.Z, T.Z, I.ZP, A.Z, O.default, b.Z, U.Z, C.default, m.Z, S.Z),
            null != e &&
            ...
            this.syncWith([v.Z], eD),
            this.syncWith([m.Z], ex);
    }
    getState() {
        return X;
    }
    ...
    getSearchResultsOrder(e, t, n, r) {
        let i = t.toLowerCase(),
            a = D.Z.escape(i),
            { canSplitFrecencyList: s } = M.Z.getCurrentConfig(
                    ...
                    (e, t) => {
                        ...
                        return (
                            r !== B.Z5.PREMIUM_LOCKED || l
                                ? null != r || (l && t.type !== x.B.UNICODE) || e.unlocked.push(t)
                                : e.locked.push(t),
                            e
                        );
                    },
