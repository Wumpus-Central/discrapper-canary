...
var r = (function (t) {
    ...
    function d(t, e) {
        var a,
            ...
            _ = Array(n),
            i = 0;
        for (r = 0; r < o; r++) (i = +((a = t[r] + e[r] + i) >= 10000000)), (_[r] = a - 10000000 * i);
        for (; r < n; ) (i = +(10000000 === (a = t[r] + i))), (_[r++] = a - 10000000 * i);
    ...
    function M(t, e, a) {
        ...
        for (var I = 0 !== a(+!!n, +!!o) ? r(-1) : r(0), R = u.length - 1; R >= 0; R -= 1) I = I.multiply(G).add(r(u[R]));
        return I;
    }
    ...
    function x(t) {
        ...
        if (2 === r.length) {
            var o = r[1];
            if (('+' === o[0] && (o = o.slice(1)), (o *= 1) !== R(o) || !s(o))) throw Error('Invalid integer: ' + o + ' is not a valid exponent.');
            var E = r[0],
                l = E.indexOf('.');
