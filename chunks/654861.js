...
var r = (function (e) {
    ...
    function v(e, t, n) {
        var r;
        return (j(e, t) >= 0 ? (r = O(e, t)) : ((r = O(t, e)), (n = !n)), "number" == typeof (r = _(r)))
            ? (n && (r = -r), new u(r))
            : new c(r, n);
    }
    function S(e, n, r) {
    ...
    function I(e, n) {
        ...
        for (a = 0; a < s; ++a) {
            o = e[a];
            for (var d = 0; d < l; ++d)
                (i = Math.floor((r = o * n[d] + c[a + d]) / u)), (c[a + d] = r - i * u), (c[a + d + 1] += i);
        }
        return m(c), c;
    }
    function T(e, n) {
    ...
    function D(e, n) {
        ...
        for (E.length <= u && E.push(0), b.push(0), m = b[d - 1], i = u - d; i >= 0; i--) {
            for (
                r = f - 1,
                    E[i + d] !== m && (r = Math.floor((E[i + d] * f + E[i + d - 1]) / m)),
                    a = 0,
                    o = 0,
                    l = b.length,
                    s = 0;
                ...
                (a += r * b[s]),
                    ...
                    (o += E[i + s] - (a - c * f)),
                    (a = c),
                    o < 0 ? ((E[i + s] = o + f), (o = -1)) : ((E[i + s] = o), (o = 0));
            for (; 0 !== o; ) {
                for (r -= 1, a = 0, s = 0; s < l; s++)
                    (a += E[i + s] - f + b[s]) < 0 ? ((E[i + s] = a + f), (a = 0)) : ((E[i + s] = a), (a = 1));
                o += a;
            }
            p[i] = r;
        }
    ...
    function L(e, n) {
        ...
        if (a.isSmall) {
            ...
            if (m < t) {
                r = _((i = x(o, m))[0]);
                var h = i[1];
                return (e.sign && (h = -h), "number" == typeof r)
                    ? (e.sign !== a.sign && (r = -r), [new u(r), new u(h)])
                    : [new c(r, e.sign !== a.sign), new u(h)];
            }
            f = p(m);
        }
        var E = j(o, f);
    ...
    (c.prototype = Object.create(l.prototype)),
        ...
        (u.prototype._multiplyBySmall = function (e) {
            return f(e.value * this.value)
                ...
                : P(Math.abs(e.value), p(Math.abs(this.value)), this.sign !== e.sign);
        }),
        (c.prototype._multiplyBySmall = function (e) {
            return 0 === e.value
                ...
                : 1 === e.value
                  ...
                  : -1 === e.value
                    ? this.negate()
                    : P(Math.abs(e.value), this.value, this.sign !== e.sign);
        }),
        ...
        (d.prototype.pow = function (e) {
            ...
            for (var s = this, c = l[1]; (r & a) === a && ((c = c.times(s)), --r), r !== i; )
                (r /= o), (s = s.square());
            return c;
        }),
        ...
        (c.prototype.modInv = function (e) {
            for (var t, n, i, a = r.zero, o = r.one, s = ea(e), l = this.abs(); !l.isZero(); )
                (t = s.divide(l)),
                    (n = a),
                    (i = s),
                    (a = o),
        ...
        (c.prototype.prev = function () {
            var e = this.value;
            return this.sign ? new c(y(e, 1), !0) : S(e, 1, this.sign);
        }),
    ...
    function F(e, t, n) {
        ...
        for (
            ...
            (l = (u = L(o, Z))[1].toJSNumber()),
                i && (l = Z - 1 - l),
                (c = (d = L(s, Z))[1].toJSNumber()),
                a && (c = Z - 1 - c),
                (o = u[0]),
                (s = d[0]),
                f.push(n(l, c));
        for (var p = 0 !== n(+!!i, +!!a) ? r(-1) : r(0), _ = f.length - 1; _ >= 0; _ -= 1)
            p = p.multiply(Z).add(r(f[_]));
        return p;
    }
    ...
    function er(e) {
        ...
        if (2 === i.length) {
            var a = i[1];
            if (("+" === a[0] && (a = a.slice(1)), (a *= 1) !== g(a) || !f(a)))
                throw Error("Invalid integer: " + a + " is not a valid exponent.");
            var o = i[0],
                l = o.indexOf(".");
            if ((l >= 0 && ((a -= o.length - l - 1), (o = o.slice(0, l) + o.slice(l + 1))), a < 0))
        ...
        for (var p = [], _ = e.length, h = n, E = _ - h; _ > 0; )
            p.push(+e.slice(E, _)), (E -= h) < 0 && (E = 0), (_ -= h);
    ...
    (c.prototype.toArray = function (e) {
        ...
        (c.prototype.toString = function (t, n) {
            ...
            for (var r, i = this.value, a = i.length, o = String(i[--a]), s = "0000000"; --a >= 0; )
                o += s.slice((r = String(i[a])).length) + r;
            return (this.sign ? "-" : "") + o;
        }),
