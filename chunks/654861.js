...
var r = (function (e) {
        ...
        if (a.isSmall) {
            ...
            if (h < t) {
                ...
                return (e.sign && (m = -m), "number" == typeof r)
                    ? (e.sign !== a.sign && (r = -r), [new u(r), new u(m)])
                    : [new c(r, e.sign !== a.sign), new u(m)];
            }
            f = _(h);
        }
        var E = M(o, f);
    ...
    function F(e, t, n) {
        ...
        for (
            ...
            (l = (u = L(o, B))[1].toJSNumber()),
                i && (l = B - 1 - l),
                (c = (d = L(s, B))[1].toJSNumber()),
                a && (c = B - 1 - c),
                (o = u[0]),
                (s = d[0]),
                f.push(n(l, c));
        for (var _ = 0 !== n(+!!i, +!!a) ? r(-1) : r(0), p = f.length - 1; p >= 0; p -= 1)
