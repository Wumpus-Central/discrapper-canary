let r, i, o, a;
n.d(t, { Z: () => V }), n(86693), n(536091), n(230036), n(47120), n(653041), n(978209);
var s,
    l = n(392711),
    c = n.n(l),
    u = n(442837),
...
class Z extends (s = u.ZP.PersistedStore) {
    ...
    topSummaries() {
        return Object.values(P)
            .flat()
            .filter((e) => e.people.length > 1 && S.default.extractTimestamp(e.endId) > new Date().getTime() - 5 * O.Z.Millis.HOUR)
    ...
    defaultChannelIds(e) {
        ...
        return (
            t && (o = o.concat(k)),
            n && (o = o.concat(x.map((e) => e.channel_id))),
            r &&
                (o = o.filter((e) => {
...
let V = new Z(d.Z, {
    ...
    RECEIVE_CHANNEL_SUMMARY(e) {
        ...
        let s = R(A({}, null !== (n = w[i]) && void 0 !== n ? n : { fetching: !1 }), {
            summaryId: void 0,
    ...
    REQUEST_CHANNEL_SUMMARY(e) {
        ...
        w[n] = R(A({}, null !== (t = w[n]) && void 0 !== t ? t : { fetching: !1 }), {
            summaryId: r,
    ...
    RECEIVE_CHANNEL_SUMMARIES(e) {
        let { summaries: t, channelId: n, error: r, receivedAt: i } = e,
            o = t.filter((e) => Object.keys(e).length > 0).map((e) => (0, I.b)(e, n));
    ...
    DELETE_SUMMARY(e) {
        ...
        let n = e.summary.channelId,
            r = (null !== (t = P[n]) && void 0 !== t ? t : []).indexOf(e.summary);
        -1 !== r && P[n].splice(r, 1);
    }
});
