...
var r = t(481060),
    ...
    S = t(405666);
function N(e) {
    let { user: n, currentUser: t, guildId: N, channelId: A, messageId: C, roleId: w, sessionId: _, initialSection: R, initialSubsection: M, transitionState: U, openedAt: L, onClose: D, sourceAnalyticsLocations: B = [] } = e,
        k = N === E.ME ? void 0 : N,
        G = (0, u.ZP)(n.id, k),
