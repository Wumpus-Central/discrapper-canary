...
var r = t(442837),
    ...
    A = t(405666);
function C(e) {
    let { user: n, currentUser: t, guildId: C, channelId: _, messageId: w, roleId: M, sessionId: R, initialSection: U, initialSubsection: L, transitionState: D, openedAt: B, onClose: G, sourceAnalyticsLocations: k = [] } = e,
        V = C === T.ME ? void 0 : C,
        Y = (0, f.ZP)(n.id, V),
