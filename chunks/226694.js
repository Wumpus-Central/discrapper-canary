    ...
    return (0, i.jsxs)(d.D, {
        ...
        children: [
            ...
            (0, i.jsx)(c.E, {
                ...
                color: "text-strong",
                className: j.Kk,
                children: R.intl.string(R.t.H9jxS1),
            }),
        ],
    });
});
function G(e) {
    let { entry: t } = e,
        ...
        { canEdit: c } = (0, v.A)(t);
    return (0, i.jsx)("div", {
        className: a()(j.fc, { [j.QX]: s }),
        children: (0, i.jsxs)(f.Ay, {
            children: [
                c
                    ? (0, i.jsx)(o.m, {
                          text: R.intl.string(R.t.XnuOvN),
                          children: (0, i.jsx)(f.$n, {
                              ...
                              "aria-label": R.intl.string(R.t.XnuOvN),
                              children: (0, i.jsx)(h.R, { size: "xs", color: "currentColor", className: j.IQ }),
                          }),
                      })
                    : null,
                (0, i.jsx)(T.A, {
                    ...
                    children: (e) => {
                        ...
                        return (0, i.jsx)(o.m, {
                            ...
                            children: (0, i.jsx)(f.$n, {
                                ...
                                children: (0, i.jsx)(A.j, { size: "md", color: "currentColor", className: j.IQ }),
                            }),
                        });
                    },
                }),
...
let D = l.memo(function (e) {
    let { entry: t } = e,
        ...
        A = R.intl.string(R.t.VJlc0S);
    return (
        o && (A = R.intl.string(R.t.cqWE2Z)),
        (0, i.jsxs)("div", {
            className: j.Nr,
            onContextMenu: (e) => {
                (0, m.L3)(e, async () => {
            ...
            children: [
                (0, i.jsxs)("div", {
                    ...
                    children: [
                        (0, i.jsx)("div", {
                            className: j.Yi,
                            children: null != u && (0, i.jsx)("img", { src: u, alt: "", className: j.j0 }),
                        }),
                        (0, i.jsx)("div", {
                            className: j.$f,
                ...
                (0, i.jsxs)("div", {
                    ...
                    children: [
                        (0, i.jsxs)("div", {
                            className: j.DD,
                            children: [
                                (0, i.jsx)(x.A, { className: j.n2, guild: t }),
                                (0, i.jsx)(c.E, {
                                    className: j.J5,
                            ...
                            children: [
                                ...
                                null != t.approximateMemberCount &&
                                    (0, i.jsxs)("div", {
                                        className: j.Kl,
                                        children: [
                                            (0, i.jsx)("div", { className: j.Li }),
                                            (0, i.jsx)(c.E, {
                                                variant: "text-xs/normal",
                                                color: "text-default",
                                                children: R.intl.format(R.t.zRl6XR, {
