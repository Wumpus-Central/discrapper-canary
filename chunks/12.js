l.r(t), l.d(t, { SocialLayerStorefrontInnerWrapper: () => e$, default: () => eV });
var n = l(627968),
    s = l(64700),
    a = l(503698),
    i = l.n(a),
...
function X() {
    ...
    return e
        ? (0, n.jsx)(G.SS, { cardAlignment: G.SS.CardAlignment.END, ctaText: Z.intl.string(Z.t.VC4Mq0), ctaOnClick: t })
        : null;
}
function z(e) {
    let { storefront: t, selectedPageIndex: l } = e,
        ...
        { getSocialLayerStorefrontLink: m } = (0, N.H)(),
        f = s.useCallback(() => {
            r?.id != null &&
        ...
        h = s.useCallback(() => {
            P.default.track(U.HAw.SLAYER_STOREFRONT_PAGE_ELEMENT_CLICKED, {
                ...
                window.open(V.A.getArticleURL(U.MVz.SOCIAL_LAYER_STOREFRONT));
        }, [c, u]),
        j = s.useCallback(() => {
            null != m && (0, p.pX)(m(0));
        }, [m]);
    ...
    let I = null != t.logoAssetId ? (0, $.YE)(t.applicationId, t.logoAssetId, 128) : null,
        k = null != t.lightThemeLogoAssetId ? (0, $.YE)(t.applicationId, t.lightThemeLogoAssetId, 128) : null,
        A = null;
    return (
        (A = a ? (I ?? k) : (k ?? I)),
        (0, n.jsxs)(O.A, {
            ...
            children: [
                (0, n.jsxs)(y.D, {
                    ...
                    className: J.gn,
                    children: [
                        null != A && (0, n.jsx)("img", { className: J.wm, src: A, alt: t.title }),
...
function ep(e) {
    ...
    return (0, n.jsx)(ei.N, {
        theme: eg.NJ.DARK,
        children: (e) => o({ className: i()(e, ex.cI, r, t), noticeColor: ec.Hv.BRAND }),
    });
}
function ef(e) {
    ...
    return null != r
        ? r.days > 0
            ? (0, n.jsxs)(ep, { ...i, children: [c(), (0, n.jsx)(eh, { days: r.days })] })
            : (0, n.jsxs)(ep, { ...i, children: [c(), (0, n.jsx)(ej, { timeLeft: r })] })
        : null != a && null == r
          ? null
          : (0, n.jsx)(ep, { ...i, children: c() });
}
function eh(e) {
    let { days: t } = e;
    return (0, n.jsxs)("div", {
...
function ej(e) {
    ...
    function o() {
        return (0, n.jsx)(d.E, { className: ex.At, variant: "text-lg/bold", children: ":" });
    }
    return (0, n.jsxs)("div", {
        className: ex.kz,
...
function ek(e) {
    let { applicationId: t, backgroundImageAssetId: l } = e,
        s = null != l ? (0, $.YE)(t, l, 1024, S.pV) : null;
    return (0, n.jsx)("div", {
        className: eI._,
...
function ev(e) {
    ...
    return null == t || 0 === t.length
        ? null
        : (0, n.jsx)("div", {
              className: i()(eA.kL, eA.$2, { [eA.Wc]: l === el.s.MEDIUM }),
              children: t.map((e, t) =>
...
function eO(e) {
    let { applicationId: t, analyticsLocations: l } = e,
        a = (0, ey.W)(),
        i = (0, o.bG)([eE.A], () => eE.A.getApplication(t)),
        r = s.useCallback(() => {
    ...
    return a
        ? (0, n.jsx)(ef, {
              sticky: !0,
              color: "nitro-pink",
              text: Z.intl.format(eT.default.iFXcjn, {
                  applicationName: i?.name,
                  endDate: new Intl.DateTimeFormat(Z.intl.currentLocale, { month: "short", day: "numeric" }).format(
                      eC.V,
                  ),
              }),
              endDatetime: eC.V,
              ...
              children: (0, n.jsxs)("div", {
                  ...
                  children: [
                      (0, n.jsx)(d.E, {
                          variant: "text-sm/normal",
                          color: "currentColor",
                          children: Z.intl.format(eT.default.iFXcjn, {
                              applicationName: i?.name,
                              endDate: new Intl.DateTimeFormat(Z.intl.currentLocale, {
                                  month: "short",
                                  day: "numeric",
                              }).format(eC.V),
                          }),
...
function eG(e) {
    let t,
        ...
        p = (0, ee.A)({ applicationId: a, location: "SocialLayerStorefrontPage" }),
...
function eP(e) {
    ...
    return (
                ...
                return (
                    (0, L.R)({
                        ...
                        onClose: () => {
                            ...
                            (0, S.rG)(e, n, t.applicationId, l) && null != c && (0, p.bG)(c(a));
                        },
                    }),
                    () => {
                        (0, L.j)();
        ...
        (0, n.jsxs)("div", {
            className: eF.kL,
            children: [o?.(a, t), (0, n.jsx)(eG, { applicationId: t.applicationId, page: t.pages[a] })],
        })
    );
}
function eV(e) {
    ...
    return (
        s.useEffect(() => {
            null == l || null == r || (null == k.A.getGuild(l) && (0, v.Z2)(l, {}, { shouldNavigate: !1 }));
        }, [l, r]),
        (0, n.jsx)(e$, {
            applicationId: d,
            guildId: l,
...
function e$(e) {
    let {
        ...
        { analyticsLocations: S } = (0, x.Ay)(g.A.SOCIAL_LAYER_STOREFRONT),
        L = (0, E.A)({ applicationId: t }),
        C = (0, o.bG)([A.A], () => A.A.get(a), [a]);
    (0, h.pE)(), (0, f.x)({ applicationId: L?.storefront?.applicationId });
    let y = (0, m.A)((0, r.A)()),
        R = (0, o.bG)([I.Ay, j.default], () => I.Ay.isMember(l, j.default.getId())),
        T = s.useMemo(
            () =>
                null == p || isNaN(p) || (null != L && null != L.storefront && p >= L.storefront.pages.length) ? 0 : p,
            [p, L],
        ),
