...
class K extends i.PureComponent {
    ...
    render() {
        let { isFollowable: e, isLurking: t, notClaimed: n, notPhoneVerified: i, notEmailVerified: a, newMember: o, memberDeadline: s, newAccount: u, accountDeadline: d, theme: f, children: _, canSendMessages: p, channelFollowingUsersSeen: h, showLurkerModeUpsellPopout: m, showMemberVerificationModal: g, useReducedMotion: b, isStaff: y, guildJoinRequest: O, showLinkedLobbyApplicationLoadingIndicator: v, requiredLinkedLobbyApplication: I } = this.props,
...
function z(e) {
    var t, n;
    let { channel: i, children: a } = e,
        o = i.getGuildId(),
        l = (0, s.e7)([P.Z], () => P.Z.getGuild(o)),
        c = (0, s.e7)([D.Z], () => D.Z.getCheck(o)),
        u = i.type === U.d4z.GUILD_ANNOUNCEMENT && null != l && l.features.has(U.oNc.NEWS),
        d = (0, s.e7)([w.Z], () => (u ? w.Z.getFollowerStatsForChannel(i.id) : null)),
        f = (0, s.e7)([I.Z], () => I.Z.isLurking(o)),
        ...
        g = !!(0, b.Dc)(l),
        O = m && g,
        T = (0, s.e7)([v.Z], () => v.Z.shouldShowPopout(o)),
        S = (0, s.e7)([L.Z], () => L.Z.can(U.Plq.SEND_MESSAGES, i)),
        A = (0, s.e7)([y.Z], () => y.Z.getRequest(o)),
        { showLinkedLobbyApplicationLoadingIndicator: N, requiredLinkedLobbyApplication: M } = (0, j.Z)(i.linkedLobby),
        G = W(H({}, c), {
            guild: l,
            isLurking: f,
            isFollowable: u,
