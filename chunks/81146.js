        ...
        for (let e of s)
            switch (e.type) {
                case d.R.AVATAR_DECORATION:
                    n.push(ex.intl.formatToPlainString(ex.t.Ntv9Jt, { itemName: e.name }));
                    break;
                case d.R.PROFILE_EFFECT:
                    n.push(ex.intl.formatToPlainString(ex.t["3Y8q7a"], { itemName: e.name }));
                    break;
                case d.R.NAMEPLATE:
                    n.push(ex.intl.formatToPlainString(ex.t["2keXky"], { itemName: e.name })), (i = !0);
            }
        if (i) {
        ...
        ? (0, n.jsx)(h.m, {
              ...
              children: (0, n.jsxs)("div", {
                  ...
                  children: [
                      (0, n.jsx)("span", {
                          className: ek.P0,
                          children: (0, n.jsx)(eT.m, { size: "md", color: "currentColor", className: ek.G }),
                      }),
                      (0, n.jsx)(N.E, { variant: "text-md/semibold", children: ex.intl.string(ex.t.BEjTij) }),
                  ],
              }),
          })
        : (0, n.jsx)(N.E, { variant: "text-md/semibold", className: t, children: ex.intl.string(ex.t["6cfuDj"]) });
};
var eS = s(691540),
    eP = s(857250),
    ey = s(97483),
...
function eM(e) {
    let { skuId: t, tab: s, onTrackClick: r } = e,
        l = i.useCallback(() => {
            ...
            (0, eD.C)(e, () => (0, eS.P0)((0, eP.o)(ex.intl.string(ex.t["L/PwZf"]), ey.Ck.SUCCESS)));
        }, [t, s, r]);
    return (0, n.jsx)(g.K, {
...
function eG(e) {
    ...
    return null === r
        ? null
        : (0, n.jsx)(N.E, { variant: "text-xxs/normal", className: l()([eF.kL, s ? eF.ap : eF.aK]), children: r });
}
var eV = s(203312),
    ew = s(878112),
    eW = s(140735),
...
let e$ = (e) => {
    ...
    return (0, n.jsxs)(N.E, {
        ...
        className: l()(ez.v, i),
        children: [
            (0, n.jsx)(eW.A, { children: ex.intl.format(ex.t["2CEGln"], { price: a }) }),
...
function eZ(e) {
    ...
    if (x)
        return (0, n.jsx)("div", {
            className: l()(eq.kG, a),
            children: (0, n.jsx)(eK.x, { priceAmount: h.amount, priceCurrency: h.currency }),
        });
    let { showDiscountPrice: p, originalPrice: A, finalPrice: g } = m;
    return (0, n.jsxs)("div", {
        className: l()(eq.kG, a),
        children: [
            o ? null : (0, n.jsx)(e$, { price: A, className: eq.q9 }),
            (0, n.jsx)(eK.x, {
    ...
    return (0, n.jsxs)("div", {
        ...
        children: [
            (0, n.jsx)(h.m, {
                ...
                children: (0, n.jsx)(eJ.t, { size: "md", color: "currentColor", className: e5.o }),
            }),
            (0, n.jsx)(N.E, {
                variant: "text-xs/medium",
                children: ex.intl.format(ex.t.Sv8iic, {
                    price: r,
                    subscribeNowHook: (e) => (0, n.jsx)(e1, { text: e, onTrackClick: s }),
                }),
            }),
        ],
    });
                ...
                children: e.map((e, t) =>
                    (0, n.jsxs)(
                        "div",
                        {
                            className: te.UJ,
                            children: [
                                (0, n.jsx)(e2.U, { color: e9.A.colors.WHITE }),
                                (0, n.jsx)(N.E, {
...
let tl = (e) => {
    let { user: t } = e,
        ...
        { pendingAvatar: i, ...r } = (0, tn.cf)([Z.A], () => Z.A.getPendingChanges()),
        l = (0, K.V7)({ userId: t.id, image: i });
    return (0, n.jsx)("div", {
        className: tr.k,
        children: (0, n.jsx)($.A, {
            ...r,
...
function th(e) {
    ...
    return (0, n.jsxs)("div", {
        ...
        children: [
            (0, n.jsx)("div", {
                className: tm.zR,
                children: (0, n.jsx)(N.E, { variant: "text-xs/normal", className: l ? tm.r9 : void 0, children: r }),
            }),
            (0, n.jsx)(eK.x, { priceAmount: t.amount, priceCurrency: t.currency, className: l ? tm.r9 : void 0 }),
        ],
    });
}
function tx(e) {
    ...
    return 0 === t.length
        ...
        : t[0].currency === tu.Yr.DISCORD_ORB
          ? (0, n.jsx)(th, { orbPrice: t[0], isProductDisabled: o, hasSufficientOrbs: a })
          : (0, n.jsxs)("div", {
                className: tm.eg,
                children: [
                    (0, n.jsxs)("div", {
                        ...
                        children: [
                            ...
                            s || u ? null : (0, n.jsx)(e7, { product: l, onTrackClick: c }),
                        ],
                    }),
                    t.length > 1 &&
...
let tf = (e) => {
        ...
        switch (t.type) {
            case d.R.AVATAR_DECORATION:
                return (0, n.jsx)("div", {
                    ...
                    children: (0, n.jsx)(tA.i, { user: i, item: t, isHighlighted: !0 }),
                });
            case d.R.PROFILE_EFFECT:
                return (0, n.jsx)("div", {
            ...
            case d.R.PROFILE_FRAME:
                return (0, n.jsx)("div", { className: tI.ob, children: (0, n.jsx)(eI.A, { frame: t }) });
            case d.R.NAMEPLATE:
                return (0, n.jsx)("div", {
                    className: tI.Dz,
                    ...
                    return (0, n.jsx)(
                        R.q,
                        {
                            ...
                            children: (0, n.jsxs)("div", {
                                className: tI.Kg,
                                children: [
                                    (0, n.jsx)(tf, { item: e, product: t, user: s }),
                                    (0, n.jsxs)(N.E, {
    ...
    tO = (e) => {
        ...
        return (0, eo.aw)(t)
            ? (0, n.jsx)(tC, { product: t, user: s, activeSlide: i })
            : (0, eB.pQ)(t.skuId)
              ? (0, n.jsx)(td.B, { animationState: "on_hover", product: t })
              : t.items.length > 0
                ? (0, n.jsx)(tf, { item: t.items[0], product: t, user: s })
                : null;
    },
    tT = (e) => {
        let { skuId: t } = e;
    ...
    tk = (e) => {
        let {
            ...
            { cardId: S, sessionId: P, tilePosition: L } = (0, el.uM)() ?? {},
        ...
        let K = (0, eh.Do)("CollectiblesShopProductDetailsModal") && $.type === d.R.PROFILE_FRAME,
            Z = en.Ay.canUseShopDiscounts(s) || K,
            J = (0, ej.h)(t),
            ...
            eJ = i.useMemo(() => ez.some((e) => e.currency === tu.Yr.DISCORD_ORB), [ez]);
        ...
        let eQ = function (e) {
            ...
            return t ? (0, n.jsx)(B.f5, { value: [...b, D.A.PROFILE_FRAMES_EA_MARKETING], children: s }) : s;
        };
        return (0, n.jsxs)("div", {
            className: tI.qA,
            children: [
                (0, n.jsx)("div", { className: tI.gn, children: (0, n.jsx)(eV.A, { category: r }) }),
                (0, n.jsx)(tO, { product: V ?? $, user: s, activeSlide: j }),
                (0, n.jsxs)("div", {
                    children: [
                        (0, n.jsxs)("div", {
                            className: tI.h_,
                            children: [
                                K
                                    ...
                                    : (0, n.jsx)(eG, { product: $, isDarkText: !ev, isOrbExclusive: e$ }),
                                (0, n.jsx)(I.D, { variant: "heading-xl/extrabold", className: tI.v7, children: eS }),
                                (0, n.jsx)(N.E, { variant: "text-sm/normal", children: eL }),
                                (0, n.jsx)(tT, { skuId: $.skuId }),
                                J.isPurchased || J.isPartiallyOwnedBundle
                                    ? (0, n.jsx)(eb, { className: tI.On, isPartiallyPurchased: et })
                                    : e_
                                      ? (0, n.jsx)(N.E, {
                                        ...
                                        : e$
                                          ...
                                          : (0, n.jsxs)("div", {
                                                ...
                                                children: [
                                                    ...
                                                    Z || eM ? null : (0, n.jsx)(e7, { product: $, onTrackClick: T }),
                                                ],
                                            }),
                            ],
                        }),
                        ...
                        null !== ec && (0, n.jsx)(N.E, { variant: "text-xs/normal", className: tI.H$, children: ec }),
                        (0, n.jsx)(C.B, {
                            direction: "vertical",
                            gap: 8,
                            children:
                                        ...
                                        ? ee
                                            ? eP
                                                ? (0, n.jsxs)(_.e, {
                                                      ...
                                                      fullWidth: !0,
                                                      children: [
                                                          (0, n.jsx)(e8, { product: $, onSuccess: u, onTrackClick: T }),
                                                          (0, n.jsx)(ew.A, {
                                                              primary: !0,
                                                              product: $,
                                                              onSuccess: u,
    ...
    tS = (e) => {
        ...
        return (0, n.jsx)("div", {
            ...
            children: (0, n.jsxs)(f.M, {
                children: [
                    (0, n.jsx)(tb, { user: r.mallow, innerClassName: tI.ab }),
                    (0, n.jsxs)(N.E, {
                        variant: "text-sm/semibold",
                        className: tI.OS,
                        children: [ex.intl.string(ex.t["yzW/fZ"]), " - 3"],
                    }),
                    (0, n.jsx)(tb, { user: r.phibi, innerClassName: tI.e9 }),
                    (0, n.jsx)("div", {
                        className: tI.mV,
                        children: (0, n.jsx)(ev.A, {
                            className: tI.M4,
                    ...
                    (0, n.jsx)(tb, { user: r.locke, innerClassName: tI.e9 }),
                    (0, n.jsxs)(N.E, {
                        variant: "text-sm/semibold",
                        className: tI.OS,
                        children: [ex.intl.string(ex.t["NG43/6"]), " - 12"],
                    }),
                    (0, n.jsx)(tb, { user: r.boom, innerClassName: tI.bD }),
                    (0, n.jsx)(tb, { user: r.cherry, innerClassName: tI.bD }),
                ],
            }),
        });
    },
    tP = (e) => {
        let { product: t, user: s, activeBundleSlide: i, isTransitioning: r } = e,
            a = (0, m.bG)([L.A], () => L.A.useReducedMotion),
            ...
            v = (e) => (0, n.jsx)(tS, { user: s, nameplate: e, avatarDecoration: A });
        if (t.type === d.R.BUNDLE) {
            if (!(0, eC.Wb)(t))
                return (0, n.jsx)("div", {
                    className: tI.RA,
                    children: (0, n.jsx)("div", { className: tI.bo, children: E() }),
                });
            {
                let e = i ?? 0,
                    s = t.items[e],
                ...
                return s.type === d.R.NAMEPLATE
                    ? (0, n.jsx)("div", { className: l()(tI.Zj, r && o ? tI.p2 : ""), children: v(s) })
                    : (0, n.jsx)("div", { className: l()(tI.Ak, r && o ? tI.p2 : ""), children: E() });
            }
        }
        return null != j
            ? (0, n.jsx)("div", { className: tI.Zj, children: v(j) })
            : (0, n.jsx)("div", { className: p?.type === d.R.AVATAR_DECORATION ? tI.RA : tI.Ak, children: E() });
    },
    ty = (e) => {
        let { user: t } = e,
            s = ((e) => {
        ...
        return (0, n.jsx)("div", {
            ...
            children: (0, n.jsx)(f.M, {
                children: (0, n.jsxs)(b.Z, {
                    ...
                    "aria-hidden": !0,
                    children: [
                        (0, n.jsx)(V.A, { className: tI.G5, author: (0, G.p_)(s), message: s }, s.id),
                        (0, n.jsxs)("div", {
                            className: tI.lG,
                            children: [
                                (0, n.jsx)(S.U, { size: "md", color: "currentColor", className: tI.hq }),
                                (0, n.jsx)(P.n, { size: "md", color: "currentColor", className: tI.hq }),
                            ],
                        }),
                    ],
                }),
    ...
    tL = (e) => {
        ...
        let { analyticsLocations: P } = (0, B.Ay)([...R, D.A.COLLECTIBLES_SHOP_DETAILS_MODAL]);
        (0, eH.Yr)(S.skuId);
        let y = (0, tN.U1)(a);
        i.useEffect(() => {
            null != f && (0, J.A)(f.id, f.getAvatarURL(void 0, 80));
        }, [f]);
        let L = i.useMemo(() => (0, eo.V6)(r.type, r.skuId), [r.type, r.skuId]);
        i.useEffect(() => {
                                      ...
                                      children: [
                                          (0, eB.pQ)(r.skuId)
                                              ? r.skuId === eB.Dp.ORB_PROFILE_BADGE
                                                  ...
                                                  : (0, eB.EZ)(r.skuId)
                                                    ? (0, n.jsx)(tt, {})
                                                    : (0, n.jsx)(td.B, { product: r, className: tI.Ms })
                                              : (0, n.jsx)(tP, {
                                                    user: f,
                                                    product: b ?? S,
                                                    activeBundleSlide: q,
                                          ...
                                          (0, n.jsxs)("div", {
                                              ...
                                              children: [
                                                  ...
                                                  (0, n.jsx)(eM, { skuId: S.skuId, tab: v, onTrackClick: V }),
                                                  (0, n.jsx)(g.K, {
                                      ...
                                      children: [
                                          ...
                                          (0, n.jsxs)("div", {
                                              ...
                                              children: [
                                                  ...
                                                  z?.expiresAt != null && (0, n.jsx)(eU.e, { endDate: z.expiresAt }),
                                              ],
                                          }),
                                      ],
                                  }),
