...
function d(e) {
    let t = "...",
        n = (0, a.bG)([i.A], () => i.A.isLoadedForSKU(c.pe.TIER_2));
...
function u(e, t) {
    ...
    if ("" === n) return null;
    let a = e?.linkText != null && "" !== e.linkText ? e.linkText : o.intl.string(o.t["sBp+u0"]);
    return { url: r.A.getArticleURL(n), linkText: a };
}
