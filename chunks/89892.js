...
class v {
    ...
    loadComplete(e) {
        ...
        return C.mutate({
            ...
            jumpTargetId: null !== (m = null == b ? void 0 : b.messageId) && void 0 !== m ? m : null,
            ...
            hasMoreBefore: null == b && I ? C.hasMoreBefore : T,
            hasMoreAfter: null == b && y ? C.hasMoreAfter : S,
            cached: A,
