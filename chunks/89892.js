...
function g(e, t) {
    ...
    return (
        ...
        e.embeds.length < (null != (r = null == (n = t.embeds) ? void 0 : n.length) ? r : 0) ||
        e.content !== t.content
    );
}
function E(e, t) {
    ...
    cache(e) {
        ...
        if ((0 === this.length && (this._wasAtEdge = t), this._messages.length + e.length > f.FD8)) {
            if (((this._wasAtEdge = !1), e.length > f.FD8)) {
                this._isCacheBefore
                    ? (this._messages = e.slice(e.length - f.FD8))
                    : (this._messages = e.slice(0, f.FD8)),
                    (this._map = {}),
...
class y {
    ...
    mutate(e) {
        ...
        return (
            ...
            (n._map = t ? p({}, this._map) : this._map),
    ...
    findOldest(e) {
        var t, n;
        return null != (n = null != (t = i().find(this._before._messages, e)) ? t : i().find(this._array, e))
            ? n
            : i().find(this._after._messages, e);
    }
    findNewest(e) {
        var t, n;
        return null != (n = null != (t = i().findLast(this._after._messages, e)) ? t : i().findLast(this._array, e))
            ? n
    ...
    getManyAfter(e, t, n) {
        ...
        if (-1 === i) return null;
        let o = [];
        for (let e = i + 1; e < this.length && (-1 === t || o.length < t); e++)
            (null == n || n(this._array[e])) && o.push(this._array[e]);
        return o;
    }
    getManyBefore(e, t, n) {
        let r = this.get(e);
        ...
        if (-1 === i) return null;
        let o = [];
        for (let e = i - 1; e >= 0 && (-1 === t || o.length < t); e--)
            (null == n || n(this._array[e])) && o.unshift(this._array[e]);
        return o;
    }
    has(e) {
        let t = !(arguments.length > 1) || void 0 === arguments[1] || arguments[1];
    ...
    jumpToMessage(e) {
        ...
        return this.mutate((o) => {
            (o.jumped = !0),
                (o.jumpedToPresent = !1),
                (o.jumpType = null != i ? i : a.SR.ANIMATED),
                (o.jumpTargetId = e),
                (o.jumpTargetOffset = null != e && null != n ? n : 0),
                (o.jumpSequenceId = o.jumpSequenceId + 1),
                (o.jumpFlash = t),
                (o.jumpReturnTargetId = r),
                (o.ready = !0),
                (o.loadingMore = !1);
        }, !1);
    }
    ...
    receiveMessage(e) {
        ...
        if (this.hasMoreAfter) this._after.wasAtEdge && (this._after.wasAtEdge = !1);
            ...
            let t = o.Z.getCurrentConfig({ location: "2ecb25_1" }, { autoTrackExposure: !1 }).enabled
                    ? (0, c.e5)(e)
                    : E(this, e),
                n = this.merge([t]);
    ...
    loadComplete(e) {
        ...
        let y = [...e.newMessages],
            ...
            C = i()(y)
                .reverse()
                .map(
                    o.Z.getCurrentConfig({ location: "2ecb25_2" }, { autoTrackExposure: !1 }).enabled
                        ? (e) => (0, c.e5)(e)
                        : (e) => E(this, e),
                )
                .value(),
    ...
    addCachedMessages(e, t) {
        ...
        this._array
            ...
            .forEach((e) => d.$(n, e, (e, t) => u.default.compare(e.id, t.id)));
        let r = !t && this.cached;
