                ...
                y.A.canManageUser(b.xBc.KICK_MEMBERS, r, n)
                    ? (async () => {
                          ...
                          await c.A.kickUser(n.id, r, x(e, "reason") ?? ""),
                              d.A.sendBotMessage(
                                  i.id,
                                  M.intl.formatToPlainString(M.t["9wzHDV"], { user: v.Ay.getUserTag(t) }),
                              );
                      })().catch(() => {
                ...
                y.A.canManageUser(b.xBc.BAN_MEMBERS, r, n)
                    ? (async () => {
                          ...
                          let t = x(e, "delete_messages") ?? 0,
                              s = x(e, "reason") ?? "",
                              a = C.default.getUser(r);
                          await c.A.banUser(n.id, r, t, s),
                              d.A.sendBotMessage(
                                  i.id,
                                  M.intl.formatToPlainString(M.t.YflWdM, { user: null != a ? v.Ay.getUserTag(a) : r }),
                              );
                      })().catch(() => {
                ...
                (0, p.b)(n.id, r)
                    ? (async () => {
                          ...
                          await c.A.setCommunicationDisabledUntil({
                              ...
                              d.A.sendBotMessage(
                                  i.id,
                                  M.intl.formatToPlainString(M.t.BbRV6o, { user: v.Ay.getUserTag(o), duration: t }),
                              );
                      })().catch(() => {
