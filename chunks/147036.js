...
function b(e, t, n) {
    let r = e.getGuildId(),
        ...
        l = E.Ay.countVoiceStatesForChannel(e.id),
        u = E.Ay.getVoiceStatesForChannel(e),
        d = _.A.can(m.xBc.MOVE_MEMBERS, e) && _.A.can(m.xBc.CONNECT, e),
        c = !1;
    c =
        e.type === S
            ? null != r && (t.hasVideo(e.id) || (0, a.t)(u)) && o > 0 && l >= o
            : null != r && t.hasVideo(e.id) && s > 0 && l >= s + +!!d;
...
function P(e) {
    let t,
        n = d.A.getChannel(f.A.getLastSelectedChannelId());
    if (null != n && n.getGuildId() === e && n.type === m.rbe.GUILD_TEXT) t = n.id;
    else {
        let n = c.Ay.getDefaultChannel(e);
        t = null != n ? n.id : null;
    }
        ...
        (l = t.id),
            ...
            (i =
                null == s || null == l || null == u
                    ? U(s, l, d)
                    : `${location.protocol}//${location.host}${m.BVt.CHANNEL_THREAD_VIEW(s, l, u, d)}`);
    } else i = r ?? U(s, e.id, n);
    return i;
}
function x(e) {
