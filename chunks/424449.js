r.d(t, { idOcrStateMachine: () => E, W: () => p, Ti: () => F });
var a = r(41851),
    i = r(269882),
    n = r(528239),
    o = r(646613),
    ...
    y = () => ({
        ...
        minAge: (e, t) => {
            if (e.trim() && "minAge" === t.type)
                return D.getAgeInYears(e, (0, i.S)()) < t.years ? "modifiableOCR.ageRange" : void 0;
        },
        cpf: (e, t) => {
...
function S({ actor: e, trackElementClicked: t }) {
    return {
        load() {
            e.send({ type: "LOAD" });
        },
...
function F(e) {
    var t;
    return (
        (t = (0, o.s)(E, { input: { config: e.config } }).start()),
        (0, o.l)({ actor: t, mapState: N, createApi: S, instrumentation: (0, i.s)(i.n.idOcr) })
    );
}
