            ...
            async function i(i) {
                ...
                f.Z.sendMessage(
                    ...
                    null != j
                        ? v.ZP.parse(
                              l,
                              H.intl.formatToPlainString(H.t.jQULqK, { applicationName: "**".concat(j.name, "**") }),
                          )
                        : {
                              content: "",
                              tts: !1,
            ...
            try {
                await Promise.all(a),
                    null != j &&
                        (0, m.showToast)(
                            (0, m.createToast)(
                                H.intl.formatToPlainString(H.t.jQULqK, { applicationName: j.name }),
                                m.ToastType.SUCCESS,
                            ),
                        );
            } catch (e) {
              ...
              (n = n =
                  {
                      children: ee.map((e, t) =>
                          (0, i.jsxs)(
                              ...
                              {
                                  children: [
                                      0 === t ? null : (0, i.jsx)("div", { className: V.rowDivider }),
                                      (0, i.jsx)(B, {
                                          row: e,
                                          onClick: () =>
                                              (() => {
...
function B(e) {
    ...
    return (0, i.jsxs)(m.P3F, {
        onClick: n,
        className: l()(V.rowContainer, { [V.disabled]: r }),
        children: [
            (0, i.jsxs)("div", {
                className: V.rowLeft,
                children: [
                    ...
                    (0, i.jsxs)("div", {
                        ...
                        children: [
                            (0, i.jsx)(m.Text, {
                                variant: "text-md/semibold",
                                className: l()(V.rowName, { [V.disabled]: r }),
                                children: o,
                            }),
                            (0, i.jsx)(m.Text, {
                                variant: "text-xs/medium",
                                className: l()(V.rowSubName, { [V.disabled]: r }),
                                children: c,
                            }),
                        ],
                    }),
