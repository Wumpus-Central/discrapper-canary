...
let q = (0, d.KU)(z, (e, t, n) => {
        ...
        let { hoverProps: m, isHovered: g } = (0, A.M)({
...
let J = (0, d.yq)(
    ...
    (e, t, n) => {
        let c,
            ...
            { isFocusVisible: w, focusProps: D } = (0, E.o)({
                within: !0,
            }),
...
function ea() {
    let e = (0, L.useContext)(U),
        ...
        r = (0, L.useRef)(null),
        { dropIndicatorProps: i } = t.useDropIndicator(
            {
                target: {
                    type: "root",
                },
