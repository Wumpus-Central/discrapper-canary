...
function tg(e) {
    let { quest: t, questContent: s, sourceQuestContent: n, isHovering: l, isInFeaturedSection: i } = e,
        a = (0, e0.Pd)(t),
        { ctaOnHover: u } = G.aD.useConfig({ location: tx.rE.QUEST_HOME_DESKTOP }),
        c = (0, E.bG)([X.A], () => a === e0.UA.UNENROLLED && null != X.A.questEnrollmentBlockedUntil, [a]),
        d = a === e0.UA.EXPIRED || (a === e0.UA.CLAIMED && (0, tm.GL)(t)),
    ...
    return (0, r.jsx)(ed.D, {
        ...
        children: (0, r.jsxs)("div", {
            ...
            children: [
                ...
                (0, r.jsx)(eH.E, { variant: "text-sm/normal", color: "currentColor", className: tS.Q, children: a }),
            ],
        }),
    });
}
    ...
    return (0, r.jsxs)("div", {
        ...
        children: [
            (0, r.jsx)("div", {
                className: tR.tE,
                children: f
                    ? (0, r.jsx)("div", { className: tR.fm, children: v })
                    : (0, r.jsx)(tI.A, {
                          size: 74,
                          percentComplete: m,
                          useAltStyle: !0,
                          children: (0, r.jsx)("div", { className: tR.n5, children: v }),
                      }),
            }),
            (0, r.jsxs)("div", {
                className: tR.FS,
...
function tD(e) {
    let {
        ...
        p = i.useMemo(() => ({ onMenuOpen: C, onMenuClose: N }), [C, N]),
        T = (0, e0.Pd)(s),
        A = (0, e$.go)(),
        O = (0, eY.E0)(s.config),
        I = i.useContext(e1.X),
        { visibilityElementRef: b, almostVisibleInViewport: R } = (0, tH.I)(
    ...
    return (0, r.jsx)("div", {
        ...
        children: (0, r.jsxs)("article", {
            ...
            children: [
                        ...
                        videoAsset:
                            null != x
                                ? {
                                      ...
                                      className: o()(tU.Tv, tU.gJ, { [tU.C7]: j }),
                                  }
                                : void 0,
                ...
                (0, r.jsx)("div", { className: o()(tU.sL, { [tU.Mq]: T === e0.UA.EXPIRED }) }),
                (0, r.jsx)("div", { className: o()(tU.f5, tU.Cm) }),
                (0, r.jsx)("div", { className: o()(tU.f5, tU.sr) }),
                (0, r.jsxs)("div", {
                    className: tU.wx,
                    children: [
                        (0, r.jsx)(tr, { quest: s, isHovering: j }),
                        (0, r.jsxs)("div", {
                            className: o()(tU.$s, { [tU.rk]: j }),
                            children: [
                                l &&
                                    O &&
                                    (0, r.jsx)(ed.D, {
...
function tF(e) {
    let { quest: t } = e,
        { useNewTile: s } = G.aD.useConfig({ location: tx.rE.QUEST_HOME_DESKTOP });
    return (0, r.jsx)("div", {
        className: eI.x3,
        children: (0, r.jsxs)("div", {
            className: eI.B0,
    ...
    return (0, r.jsx)("div", {
        ...
        children: (0, r.jsxs)("div", {
            ...
            children: [
                ...
                (0, r.jsx)("div", { className: tG.$Q, children: ea.intl.string(ea.t.q3hbne) }),
                (0, r.jsx)("div", {
                    className: tG.k0,
...
function tK(e) {
    ...
    return (0, r.jsxs)(r.Fragment, {
        children: [
            ...
            l("home_card") && (0, r.jsxs)(r.Fragment, { children: [(0, r.jsx)(tF, { quest: n }), (0, r.jsx)(eA, {})] }),
            l("share_embed") &&
            ...
            l("members_list") &&
                (0, r.jsxs)(r.Fragment, { children: [(0, r.jsx)(tV, { quest: n }), (0, r.jsx)(eA, {})] }),
            l("activity_panel") &&
...
function t3(e) {
    ...
    return (0, r.jsx)(eH.E, { className: t7.g, color: "text-subtle", id: s, variant: "text-sm/semibold", children: t });
}
let t6 = function (e) {
...
let st = function (e) {
    ...
    return (0, r.jsx)(t6, {
        ...
        children: (e, t) =>
            (0, r.jsx)(g.$, {
                ...e,
                "aria-label": ea.intl.formatToPlainString(ea.t.lPlIMo, { selected: (0, t1.Js)(n) }),
                buttonRef: t,
                size: "sm",
                text: (0, t1.Js)(n),
                icon: se.g,
...
function su() {
    ...
    return {
        showToast: i.useCallback((t) => {
            e.current !== t &&
                ((0, sr.P0)((0, si.o)(ea.intl.string(ea.t["5ABf1w"]), sa.Ck.FAILURE)),
                so.default.track(ef.HAw.QUEST_HOME_MOBILE_DEEP_LINK_MISSING_QUEST, { quest_id: t }),
                (e.current = t));
        }, []),
    };
}
...
let sf = i.forwardRef(function (e, t) {
    let {
        ...
        [x, f] = i.useState(null),
        [g, v] = i.useState(0),
        { useNewTile: j } = G.aD.useConfig({ location: tx.rE.QUEST_HOME_DESKTOP }),
        [{ highlightAnimationProgress: S }, _] = (0, sn.z)(() => ({
    ...
    sC = i.forwardRef(function (e, t) {
        let s,
            ...
            m = i.useMemo(() => {
                ...
                return (
                    (e = c.get(sS)),
                    ((0, B.uJ)(e) ? null : (Object.values(tx.kL).find((t) => t === e) ?? null)) ?? tx.kL.SUGGESTED
                );
            }, [c]),
            E = i.useMemo(
                () =>
                    ...
                    (0, r.jsxs)("div", {
                        ...
                        children: [
                            ...
                            (0, r.jsxs)("div", {
                                className: sv.Nf,
                                children: [
                                    (0, r.jsx)(st, { onChange: h, optionClassName: sv.Uq, selectedSortMethod: m }),
...
let sD = (0, i.memo)(function (e) {
    let { quest: t } = e,
        ...
        C = _?.type === sp.l.FRACTIONAL_PREMIUM,
        N = _?.type === sp.l.COLLECTIBLE,
        p = _?.type === sp.l.VIRTUAL_CURRENCY,
    ...
    function U() {
        n(!0), so.default.track(ef.HAw.QUEST_HOVER, { quest_id: t.id, ...H });
    }
    function D() {
        n(!1);
    }
    function q(e) {
        c(!0), so.default.track(ef.HAw.QUEST_ASSET_LOADING_FAILURE, { source: e, asset_id: e, quest_id: t.id });
    }
    return null == _ || u
        ? null
        : (0, r.jsx)(sA.vN, {
...
function sF(e) {
    ...
    return (0, r.jsxs)(sq.pp, {
        ...
        children: [
            ...
            (0, r.jsx)(sq.SG, { note: ea.intl.format(ea.t.Pv8u2u, { onClick: t }) }),
        ],
    });
}
var sP = s(975424);
function sk(e) {
    ...
    return l && 0 === n.length
        ? (0, r.jsx)(el.y, { className: sP.u })
        : 0 === n.length
          ? (0, r.jsx)(sF, { onClick: () => t(K.NC.ALL) })
          : (0, r.jsx)("div", {
                className: o()(sP.U, s),
                children: [...n]
...
let s1 = i.memo(function (e) {
        ...
        return (0, r.jsxs)("div", {
            ...
            children: [
                ...
                (0, r.jsx)("div", {
                    className: o()({ [s$.sF]: f && S, [s$.RC]: v && S, [s$.Ni]: D && !f, [s$.GA]: D && !v }),
...
function s7(e) {
    let { children: t, sectionIdentifier: s, questId: n, featuredSection: l } = e,
        ...
        d = a === n && o === s,
        m = null != a && (a !== n || o !== s),
        { useNewTile: E } = G.aD.useConfig({ location: tx.rE.QUEST_HOME_DESKTOP }),
...
function s9(e) {
    ...
    return (0, r.jsxs)("div", {
        ...
        ...s,
        children: [
            (0, r.jsx)("div", { className: o()(s5.m, s8.Gf), "aria-hidden": !0 }),
            (0, r.jsx)("div", {
                className: s8.Jm,
                "aria-hidden": !0,
                children: Array.from({ length: 6 }).map((e, t) =>
                    (0, r.jsx)("div", { className: o()(s5.m, s8.Vr) }, t),
                ),
            }),
        ],
    });
...
function nn(e) {
    let { questContent: t, questIds: s, rowIndex: n, sectionIdentifier: l } = e,
        ...
        { useNewTile: o } = G.aD.useConfig({ location: tx.rE.QUEST_HOME_DESKTOP }),
        { variant: u } = G.Mk.useConfig({ location: tx.rE.QUEST_HOME_DESKTOP }),
        c = (0, ne.C)(),
        d = a === l,
        m = i.useCallback(
            (e) => {
...
var nh = s(32304);
let nx = {
        [sG.FEATURED]: ew.uF.QUEST_HOME_FEATURED_SECTION,
        [sG.IN_PROGRESS]: ew.uF.QUEST_HOME_IN_PROGRESS_SECTION,
        [sG.ENDING_SOON]: ew.uF.QUEST_HOME_ENDING_SOON_SECTION,
        [sG.ORB]: ew.uF.QUEST_HOME_ORB_SECTION,
        [sG.DISCOVERED]: ew.uF.QUEST_HOME_DISCOVERED_SECTION,
        [sG.EXPIRED]: ew.uF.QUEST_HOME_EXPIRED_SECTION,
        [sG.PREVIEW]: ew.uF.QUEST_HOME_PREVIEW_SECTION,
        [sG.SPECIAL_QUESTS]: ew.uF.QUEST_HOME_SPECIAL_QUESTS_SECTION,
    },
    ...
    ng = i.forwardRef(function (e, t) {
        let { deepLinkedQuestId: s, isLoadingQuestHomeHero: n, className: l, withQuestHomeHero: a = !0 } = e,
            { useNewTile: u, useLargeFeaturedTiles: c } = G.aD.useConfig({ location: tx.rE.QUEST_HOME_DESKTOP }),
            {
                sections: d,
                                          ...
                                          let o = (function (e) {
                                              ...
                                              return (0, tA.kd)(t) && !c
                                                  ...
                                                  : (n.has(t.id) && u.push(sG.DISCOVERED),
                                                    ...
                                                    ? [...u, sG.IN_PROGRESS]
                                                    : null != s && (0, eY.I0)(s, t.id) && nm(sG.FEATURED, l)
                                                      ? [...u, sG.FEATURED]
        ...
        return (0, r.jsx)(s2.Provider, {
            ...
            children: (0, r.jsx)("div", {
                ...
                ref: x,
                children: m
                    ? (0, r.jsx)(s9, { role: "status", "aria-label": ea.intl.string(ea.t.ZTNur7) })
                    : d.length > 0
                      ? d.map((e, t) => {
...
let n_ = (0, nv.v)((e, t) => ({
    ...
    logger: null,
    registerAssetLoad: () => {
        let s = t().logger ?? (0, nS.L)({ location: tx.rE.QUEST_HOME_DESKTOP });
...
let nQ = i.forwardRef(function (e, t) {
    let { adContentId: s, topContent: n, title: l, subtitle: a, buttons: u, background: c, className: d } = e,
        ...
        f = i.useCallback(() => nM(s, ef.HAw.QUEST_HOVER), [s]),
        g = i.useCallback(() => nM(s, ef.HAw.QUEST_HOVER_OFF), [s]);
    return (0, r.jsx)(tu.N, {
...
function nW(e) {
    ...
    i.useEffect(() => {
        let e = l.current;
        (0, nH.vq)(e, HTMLVideoElement) && (a ? ((e.currentTime = 0), e.play().catch(ej.tE)) : e.pause());
    }, [a]);
    let { hoverSpring: c } = (0, sn.z)({ hoverSpring: +!!a, config: ss.config.gentle }),
        d = i.useCallback(() => {
            (0, nO._Q)(
...
function nG(e) {
    let { heroId: t, quest: s, onQuestCtaClick: n, contentPosition: l } = e,
        ...
        v = i.useMemo(() => (0, tO.mq)(s.config, f), [s.config, f]),
        S = i.useMemo(
            () =>
                (function (e, t) {
                        ...
                        (0, r.jsxs)(j.B, {
                            ...
                            children: [
                                (0, r.jsxs)(j.B, {
                                    ...
                                    fullWidth: !1,
                                    children: [
                                        (0, r.jsx)(nq.y, { size: "xs", color: eu.A.colors.ICON_MUTED.css }),
                                        (0, r.jsx)(eH.E, {
                                            variant: "text-sm/normal",
                                            color: "text-muted",
                                ...
                                (0, r.jsxs)(j.B, {
                                    ...
                                    fullWidth: !1,
                                    children: [
                                        (0, eY.pv)(s.config) === ny.Z.VIDEO
                                            ? (0, r.jsx)(nF.S, { size: "xs", color: eu.A.colors.ICON_MUTED.css })
...
function nK(e) {
    let { hero: t, shelfQuests: s, isBannerLoading: n, onQuestCtaClick: l } = e,
        i = (0, ne.C)();
    return n
        ? (0, r.jsx)(nz, { numShelfCards: s.length + 1 })
        : (0, r.jsx)(s1, {
              className: nV.vo,
              overflowAmount: 25,
              maskWidth: sK(i),
                      ...
                      (0, r.jsx)(eX.R, {
                          ...
                          children: (e, s) =>
                              (0, r.jsx)("div", {
                                  ...
                                  children: (0, r.jsx)(nW, { hero: t, contentPosition: 0, impressionRef: s }),
                              }),
                      }),
                      s.map((e, s) =>
                          (0, r.jsx)(
    ...
    return (0, r.jsx)(s1, {
        ...
        children: (0, r.jsx)(j.B, {
            ...
            children: Array.from({ length: l - 1 }).map((e, t) =>
                (0, r.jsx)("div", { className: o()(s5.m, nV.W_) }, t),
            ),
        }),
    });
}
...
function nX(e) {
    ...
    return null == s
              ...
              children: [
                  ...
                  (0, r.jsx)("div", {
                      ...
                      children: (0, r.jsx)(z._M, {
                          ...
                          children: (e) => (0, r.jsx)("img", { ref: e, className: n$.LY, src: t, alt: "" }),
                      }),
                  }),
                  (0, r.jsx)("div", {
                      className: o()(n$.LO, n$.jx, n$.hw),
                      children: (0, r.jsx)("img", { className: n$.LY, src: t, alt: "" }),
                  }),
                  (0, r.jsx)("div", {
                      className: o()(n$.LO, n$.jx, n$.Co),
                      children: (0, r.jsx)("img", { className: n$.LY, src: t, alt: "" }),
                  }),
              ],
          })
        : (0, r.jsxs)("div", {
              ...
              children: [
                  (0, r.jsx)(nY, {}),
                  (0, r.jsx)("div", { className: n$.LO, children: (0, r.jsx)(nJ, { heroImage: t, heroVideo: s }) }),
              ],
          });
}
function nZ(e) {
        ...
        children: [
            (0, r.jsx)(eX.R, {
                ...
                children: (e, l) =>
                    (0, r.jsxs)(r.Fragment, {
                        children: [
                            (0, r.jsx)(nZ, { hero: t, hasFetchedQuests: a, hasNoAccessibleQuests: 0 === h.length }),
                            (0, r.jsx)(nQ, {
                                ref: (t) => {
                                    e.current = n ? null : t;
                                },
                                ...
                                background: (0, r.jsx)(nX, { heroImage: t.heroImage, heroVideo: t.heroVideo }),
                            }),
                        ],
                    }),
            }),
            c && (0, r.jsx)(nK, { hero: t, isBannerLoading: n, shelfQuests: u, onQuestCtaClick: s }),
        ],
    });
}
function n1() {
    return (0, r.jsx)("div", { className: o()(nR.iE, nR.FG, nR.B3), children: (0, r.jsx)(el.y, {}) });
}
var n2 = s(740879),
    n4 = s(604880),
    n7 = s(318808);
function n3(e) {
    ...
    return (0, r.jsxs)("div", {
        className: n2.MY,
        children: [
            (0, r.jsx)("img", { className: n2.Bg, src: n7.Ay, alt: "" }),
            (0, r.jsx)("div", { className: n2.r$, children: (0, r.jsx)("img", { src: n4, alt: "" }) }),
            (0, r.jsxs)("div", {
                className: n2.Nr,
                children: [
                    (0, r.jsx)(eN.D, {
...
let n5 = function (e) {
    let { matchingQuestIds: t } = e,
        s = (0, ne.C)(),
        { useNewTile: n } = G.aD.useConfig({ location: tx.rE.QUEST_HOME_DESKTOP }),
        { variant: l } = G.Mk.useConfig({ location: tx.rE.QUEST_HOME_DESKTOP }),
        a = i.useRef(null),
        ...
        children: [
            ...
            0 === t.length
                ? (0, r.jsxs)(j.B, {
                      ...
                      className: n8.y7,
                      children: [
                          (0, r.jsx)(n6, { alt: ea.intl.string(ea.t["Xe+fJM"]) }),
                          (0, r.jsxs)(j.B, {
                              direction: "vertical",
                              align: "center",
                              children: [
    ...
    return (0, r.jsxs)(e1.X.Provider, {
        ...
        children: [
            ...
            (0, r.jsxs)(D.A, {
                ...
                children: [
                    l && t,
                    (0, r.jsxs)(H.A, { className: lo.Jo, innerClassName: lo.FG, children: [!l && t, s] }),
                ],
            }),
        ],
    });
...
function lh(e) {
    let { className: t, onAssetLoad: s } = e,
        { enabled: n } = V.useConfig({ location: tx.rE.QUEST_HOME_DESKTOP }),
        l = !n,
        a = i.useCallback(() => {
    ...
    return (0, r.jsx)(nQ, {
        ...
        background: (0, r.jsx)(lE, { onAssetLoad: s, isVirtualCurrencyEnabled: l }),
    });
}
function lx(e) {
    ...
    return (0, r.jsxs)("div", {
        ...
        children: [
            ...
            !l &&
                (null == n || a
                    ? (0, r.jsx)(lh, { className: o()({ [lo.lX]: u }), onAssetLoad: t })
                    : (0, r.jsx)(n0, { hero: n, isBannerLoading: u, onQuestCtaClick: s })),
        ],
    });
}
let lf = function (e) {
    let { topLevelRoute: t } = e,
        ...
        x = (0, E.bG)([A.A], () => A.A.getState("quests")),
        {
            ...
            let { withClaimedQuestsTab: t = !0 } = e,
                ...
                n = (0, u.zy)(),
                l = (0, K.p5)(),
                { enabled: r } = G.Mk.useConfig({ location: tx.rE.QUEST_HOME_DESKTOP }),
                { useNewLayoutWithSearch: a } = G.aD.useConfig({ location: tx.rE.QUEST_HOME_DESKTOP }),
                o = r || a;
            i.useEffect(() => {
                lr.A.getState().initializeFromUrl(n.search, l);
            }, [n.search, l]);
            let c = i.useCallback((e) => {
                lr.A.getState().setTab(e);
            }, []);
            return {
                tabs: i.useMemo(
                    () =>
        ...
        })({ withClaimedQuestsTab: !0 }),
        {
            ...
            let [e, t] = i.useState(""),
                [s, n] = i.useState(null),
                l = (0, E.yK)([X.A], () =>
                    (0, K.mn)(Array.from(X.A.quests.values()), { sortMethod: tx.kL.SUGGESTED }).map((e) => e.config),
                ),
                r = e.trim().toLowerCase(),
                a = "" !== r,
                o = i.useMemo(() => le()(nt.gr, 1e3), []),
                u = i.useCallback(() => {
                    o.cancel();
                    let e = (0, ln.tv)();
                    null != e &&
    ...
    let k = i.useRef(null),
        { enabled: w } = G.Mk.useConfig({ location: tx.rE.QUEST_HOME_DESKTOP }),
        { useNewLayoutWithSearch: V } = G.aD.useConfig({ location: tx.rE.QUEST_HOME_DESKTOP }),
        Y = w || V,
        J = i.useRef(null),
        Z = i.useCallback((e) => {
              ...
              children: (0, r.jsx)(lu.Provider, {
                  ...
                  children: (0, r.jsx)("div", {
                      ...
                      children: (0, r.jsxs)(lc, {
                          ...
                          children: [
                              er && null != M && (0, r.jsx)(n5, { matchingQuestIds: M }),
                              f === K.NC.CLAIMED
                                  ? (0, r.jsx)(sk, { onSelectTab: el, className: er ? lo.R : void 0 })
                                  : f === K.NC.PREVIEW_TOOL
                                    ? (0, r.jsx)(tY, { className: er ? lo.R : void 0 })
                                    : Y
                                      ? (0, r.jsx)(ng, {
                                            className: er ? lo.R : void 0,
                                            ref: J,
