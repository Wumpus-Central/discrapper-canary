        ...
        for (let [s, o] of Object.entries(e)) {
            ...
            if (!l) {
                if (!n.ignoreUnknownFields)
                    throw Error(
                        `Found unknown field while reading ${this.info.typeName} from JSON format. JSON key: ${s}`,
                    );
                continue;
            }
            let u = l.localName;
            ...
            if ("map" == l.kind) {
                ...
                for (let [e, r] of Object.entries(o)) {
                    ...
                    let s = e;
                    l.K == a.LN.BOOL && (s = "true" == s || ("false" != s && s)),
                        (t[(s = this.scalar(s, l.K, a.rO.STRING, l.name).toString())] = i);
                }
            } else if (l.repeat) {
                if (null === o) continue;
