...
class l {
    ...
    setFont(e) {
        ...
        (this.font.style = null != (t = e.style) ? t : this.font.style),
            ...
            (this.font.truncate = null != (o = e.truncate) ? o : this.font.truncate);
    }
    setFilter(e) {
        ...
        (this.filter.blur = null != (t = e.blur) ? t : this.filter.blur),
            ...
            (this.filter.hueRotation = null != (o = e.hueRotation) ? o : this.filter.hueRotation),
            (this.filter.invert = null != (a = e.invert) ? a : this.filter.invert),
            (this.filter.opacity = null != (s = e.opacity) ? s : this.filter.opacity),
