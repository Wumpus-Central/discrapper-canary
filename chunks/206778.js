                      ...
                      children: [
                          ...
                          (0, i.jsxs)("div", {
                              ...
                              children: [
                                  ...
                                  (0, i.jsx)(ev, { guildId: t, user: c, joinRequest: l }),
                                  (0, i.jsx)(eS, { guildId: t, userId: s.id, selectedJoinRequestId: l.joinRequestId }),
                              ],
                          }),
                      ],
                  }),
...
let eU = n.memo(function (e) {
    ...
    ew = n.memo(function (e) {
        ...
        return null == x
            ...
            : (0, i.jsxs)("tr", {
                  onClick: s,
                  className: a()(eP.yF, eP.iA, { [eP.wH]: j?.joinRequestId === t.joinRequestId, [eP.qb]: E }),
                  children: [
                                          ...
                                          (0, ep.L3)(
                                              ...
                                              async () => {
                                                  let { default: e } = await Promise.all([
                                                      l.e("4524"),
                                                      l.e("32660"),
                                                  ]).then(l.bind(l, 772063));
                                                  return (t) => (0, i.jsx)(e, { ...t, guild: g, user: x });
                                              },
...
function eO(e) {
    let { guildId: t, currentTab: l } = e,
        ...
        { guildJoinRequests: u } = v({ guildId: t, applicationStatus: l, sortOrder: a }),
...
function e2(e) {
    ...
    let { guildId: l, currentTab: s, onTabSelect: r } = e,
        ...
        E = z({ guildId: l }),
        g = n.useMemo(() => !!A || (s !== M.ALL_MEMBERS && null != E && null != E.user), [s, A, E]),
        f = n.useMemo(() => x.slice(0, m + 1), [m, x]),
        S = n.useMemo(() => x.slice(m + 1), [m, x]),
        v = (0, eQ.A)((e) => {
    ...
    return (
        ...
        (0, i.jsxs)(i.Fragment, {
            children: [
                (0, i.jsx)(b.A.Divider, { className: e0.yF }),
                (0, i.jsxs)("div", {
                    className: e0.oB,
                    ref: o,
                    children: [
                        (0, i.jsxs)("div", {
                            ...
                            children: [
                                ...
                                (0, i.jsx)("div", {
                                    ref: h,
                                    children: (0, i.jsx)(e5, { tabs: S, onTabSelect: r, selectedTab: s }),
                                }),
                            ],
                        }),
                        (0, i.jsxs)(eJ.V, {
                            ...
                            children: [
                                ...
                                0 !== S.length ? (0, i.jsx)(e5, { tabs: S, onTabSelect: r, selectedTab: s }) : null,
                            ],
                        }),
                    ],
                }),
    ...
    return (
        ...
        (0, i.jsxs)(b.A, {
            ...
            children: [
                ...
                n && (0, i.jsx)(e2, { guildId: t.id, currentTab: l, onTabSelect: s }),
            ],
        })
    );
}
function tx(e) {
    ...
    let { fetchNextPage: y } = (0, g.K)({ guildId: t, guildJoinRequests: f }),
        ...
        P = n.useCallback(
            async (e) => {
                s === e || (r(e), h.A.setSelectedGuildJoinRequest(t, null), "ALL_MEMBERS" !== e && (await y(E, e)));
            },
            [s, t, y, E],
        );
    n.useEffect(() => {
