...
function U(e) {
    let { app: t, linkType: n, activityCustomId: a, activityReferrerId: l, message: o, onView: g } = e,
        ...
        k = (0, s.bG)([E.default], () => l ?? E.default.getId(), [l]),
        ...
        }, [T, X, K, t.id, Q, z, H, V, F, q, a, k, U, b]),
...
function G(e) {
    let { app: t } = e,
        ...
        d = r.useMemo(() => {
            ...
            return 0 === i ? null : w.intl.format(w.t["6IW6Wi"], { guildCount: e.format(i) });
        ...
        _ = r.useMemo(() => {
            if (u.length > 0)
                return (0, i.jsx)(L.$, {
                    activityUsers: u,
                    guildId: d,
                    activityText: w.intl.formatToPlainString(w.t["IJa+46"], { count: u.length }),
                });
            if (c.some((e) => (0, g.CZ)(e) === l.m.GLOBAL))
                return (0, i.jsxs)(i.Fragment, {
                    children: [(0, i.jsx)(o.Y3C, { size: "xxs", color: "currentColor" }), w.intl.string(w.t.TsWCdW)],
                });
            let e = a > 0 ? w.intl.format(w.t.z8EAJW, { count: a }) : w.intl.string(w.t.RjceQU);
            return (0, i.jsxs)(i.Fragment, {
