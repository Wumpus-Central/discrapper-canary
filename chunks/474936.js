...
let A = Object.freeze({
    ...
    j = 7,
    U = 30,
    G = '775514091874680832',
    B = '845031178288889946',
    V = 432000000,
    F = 14,
    ...
    er = [Z, H, Y, W, K, z, q, Q, X, J, $, ee, et, en],
    ei = [J, $, et],
    ea = [J, et],
...
let ex = {
    '1024422698568122368': C,
    '511651876987469824': C,
    '511651885459963904': C,
