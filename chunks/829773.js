...
function b(e) {
    ...
    let H = (0, C.A)(t),
        ...
        ee = J === R.TBI.VOICE_ACTIVITY ? R.TBI.PUSH_TO_TALK : R.TBI.VOICE_ACTIVITY,
        et = (0, s.bG)([T.Ay, g.Ay], () => {
            let e = T.Ay.getModeOptions().shortcut?.length > 0,
                t = null != g.Ay.getKeybindForAction(R.hCu.PUSH_TO_TALK, !1, !0),
                n = null != g.Ay.getKeybindForAction(R.hCu.PUSH_TO_TALK_PRIORITY, !1, !0);
            return e || t || n;
        }),
                            ...
                            (0, i.jsx)(d.aK, {
                                ...
                                control: (e, t) =>
                                    (0, i.jsx)(N, {
                                        ...
                                        location: { section: R.JJy.CONTEXT_MENU },
                        ...
                        M &&
                            (0, i.jsx)(
                                d.sL,
                                {
                                    ...
                                    action: () => c.A.toggleSelfDeaf({ context: Z, location: "AudioDeviceMenu" }),
                                    checked: q,
                                },
                                "self-deafen",
                            ),
