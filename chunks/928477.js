    ...
    return r.useCallback(
        async (e, r, _) => {
            ...
            v !== O &&
                ...
                null == u || u(v),
                (h || e.length > 0 || (null != r && r.length > 0) || (null != _ && _.length > 0)) && G(v, e, r, _, f)),
...
function U(e) {
    let { parentChannel: t, name: n, appliedTags: o, analyticsLocations: a, onThreadCreated: l, upload: u } = e;
    return r.useCallback(
        async (e, r, d) => {
            let p,
                h = 0,
