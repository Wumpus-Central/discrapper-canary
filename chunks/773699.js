...
let T = (e) => {
    let n,
        ...
        V = "" !== U,
        {
            ...
            context: R,
            filters: { text: V ? U : void 0, commandTypes: [t] },
            options: { limit: f.YC, includeFrecency: w && !V, scoreMethod: V ? c.M.COMMAND_OR_APPLICATION : void 0 },
            allowFetch: !0,
        }),
    ...
    if (L)
        ...
        if (0 === k.length)
            n = (0, i.jsxs)(i.Fragment, {
                children: [
                    V && (0, i.jsxs)(i.Fragment, { children: [Y, (0, i.jsx)(d.bXX, {})] }),
                    (0, i.jsx)(
                        d.Drp,
            ...
            if (V)
                n = (0, i.jsxs)(i.Fragment, {
                    children: [Y, (0, i.jsx)(d.bXX, {}), k.map((e) => X(e, { showAppIcon: !0 }))],
                });
            else {
                let e = P.find((e) => {
                        let { section: n } = e;
        ...
        else n = k.map((e) => X(e, { showAppIcon: !0 }));
        null != O &&
            O.length > 0 &&
