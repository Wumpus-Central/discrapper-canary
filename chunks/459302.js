        ...
        (function () {
            ...
            switch (a.symbol) {
                ...
                case "weekday(s)":
                    ...
                    break;
                case "week(s)":
                    (n.freq = i.p3.WEEKLY), a.nextSymbol() && (o(), d());
                    break;
                case "hour(s)":
                    (n.freq = i.p3.HOURLY), a.nextSymbol() && (o(), d());
                    break;
                case "minute(s)":
                    (n.freq = i.p3.MINUTELY), a.nextSymbol() && (o(), d());
                    break;
                case "month(s)":
                    (n.freq = i.p3.MONTHLY), a.nextSymbol() && (o(), d());
                    break;
                case "year(s)":
                    (n.freq = i.p3.YEARLY), a.nextSymbol() && (o(), d());
                    break;
                case "monday":
                case "tuesday":
                case "wednesday":
                    ...
                    (function () {
                        ...
                        if (e)
                            for (n.bymonthday = [e], a.nextSymbol(); a.accept("comma"); ) {
                                if (!(e = c())) throw Error("Unexpected symbol " + a.symbol + "; expected monthday");
        ...
        if (e || t)
            do {
                ...
                if (r)
                    ...
                    if (!d) throw Error("Unexpected symbol " + a.symbol + ", expected week number");
