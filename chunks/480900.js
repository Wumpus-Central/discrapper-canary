...
let M = function (e) {
    let { guildId: t, transitionState: s, onClose: c } = e,
        M = (0, l.bG)([C.A], () => C.A.getSortedRoles(t)),
    ...
    if (
        (r.useEffect(() => {
            0 !== k.length &&
                N.default.track(O.HAw.PASSPORT_ENTRY_VIEWED, {
                    role_ids: k.map((e) => {
                        let { role_id: t } = e;
                        return t;
                    }),
    ...
    return (0, i.jsx)(o.Modal, {
        ...
        onClose: c,
        subtitle: b.intl.format(b.t["Y+TsEV"], { helpdeskArticleUrl: v.A.getArticleURL(O.MVz.CONNECTION_DETAILS) }),
        actions: [],
