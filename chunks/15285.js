"use strict";
let r;
n.d(t, { Ay: () => eV, Es: () => eN, Xr: () => eC, Zh: () => eA, hw: () => ev, xU: () => eL }), n(321073), n(667532);
var i = n(735438),
    s = n.n(i),
    a = n(989349),
    o = n.n(a),
    ...
    x = n(862775),
    G = n(652215);
let V = new E.A("RunningGameStore"),
    F = "RunningGameStore",
...
function ey() {
    if (X.length > 0) {
        let e = Z;
        (Z = X[0]), null != e && Z.pid === e.pid ? (Z.start = e.start) : (Z.start = Date.now());
    } else Z = null;
    let e = [];
    for (let t of X) t.pid in ed || ((ed[t.pid] = t), e.push(t));
    let t = [];
    for (let e of Object.values(ed)) X.some((t) => t.pid === e.pid) || (t.push(e), delete ed[e.pid]);
    V.info("Running Games Changed", { runningGames: X, added: e, removed: t, previousGames: ed }),
        d.h.dispatch({ type: "RUNNING_GAMES_CHANGE", games: X, added: e, removed: t });
}
function eN(e) {
...
function ev(e) {
    let t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
        [n, r] = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : [N.A, O.A];
    if (e.isLauncher)
        return {
...
function ew() {
    ...
    return (
        (z = s()
            .values(O.A.libraryApplications)
            .reduce((t, n) => {
                let r = N.A.getDetectableGame(n.id);
                if (null == r) return t;
                for (let i of v.A.getLaunchOptions(n.id, n.branchId)) {
...
function eP(e) {
    null != e &&
        ...
        eD(),
        D.A.setRecentGames(eU().map((e) => eL(e, eG, N.A, O.A))));
}
function eU() {
...
function ek() {
    B && M.Ay.setProcessObserverCollectExecutableFingerprint((0, x.Q)("running-game-store")),
        h.A.hasLoadedExperiments && H.length > 0 && (eP(H), (H = []));
}
B &&
    (es = function () {
        if (!N.A.hasAttemptedFetch || !U.A.hasAttemptedFetch) return !1;
        let e = [],
            t = new Set();
        r = {};
        let n = N.A.games,
        ...
        Y.forEach((e) => {
            ...
            [
                ...[...n, ...i].filter((e) => !(e.executables ?? []).some((e) => ep.has(e.name.toLowerCase()))),
                ...Y,
            ].forEach((n) => {
            ...
            M.Ay.setObservedGamesCallback(
                ...
                (e) => {
                    let n = [],
                        ...
                        s = [];
                    e = e.filter((e) =>
                        null != e.id && null != U.A.getById(e.id)
                            ? (s.push(e), !1)
                    ...
                    a !== eo && ((eo = a), d.h.dispatch({ type: "RUNNING_STREAMER_TOOLS_CHANGE", count: eo })),
                        (X = null != Q ? [Q, ...e] : e),
                        (J = s),
                        (et = n),
                        (r = i),
                        ey(),
                        (ee = J.length > 0 ? J[0] : null);
                    let o = [];
                    for (let e of J) e.pid in ec || ((ec[e.pid] = e), o.push(e));
                    let l = [];
                    for (let e of Object.values(ec)) J.some((t) => t.pid === e.pid) || (l.push(e), delete ec[e.pid]);
                    V.info("Running Non-Games Changed", {
                        ...
                        d.h.dispatch({ type: "RUNNING_NON_GAMES_CHANGE", nonGames: J, added: o, removed: l });
                },
            ...
            M.Ay.setGameDetectionCallback((e, t) => {
                if (e.length === t.length)
                    for (let [n, r] of e.entries()) {
                        ...
                        C.default.track(G.HAw.GAME_DETECTION_COMPARISON, {
                            ...
                            game_detection_enabled_v1: eC(r),
                            ...
                            game_detection_enabled_v2: eC(e),
...
class ex extends l.Ay.Store {
    ...
    initialize() {
        ...
        this.waitFor(N.A, U.A, v.A, h.A, p.A, O.A, R.default),
            (H = e.gamesSeen.filter((e) => !(0, y.n1)(e))),
            this.syncWith([p.A], ek),
            this.syncWith([O.A, N.A, v.A], s().throttle(ew, 1e3)),
            t && eD();
    }
    getVisibleGame() {
        return null == Z || eb(Z) ? Z : null;
    }
    ...
    canCollectExecutableFingerprintsForRunningGames() {
        return B && (0, x.M)("running-game-store");
    }
    getCandidateGames() {
    ...
    get canShowAdminWarning() {
        return j && !this.isSystemServiceInitialized("input-service");
    }
...
let eG = new ex(d.h, {
        ...
        RUNNING_GAME_TOGGLE_DETECTION: function (e) {
            ...
            (ei.enableDetection[eN(t)] = !n),
                eD(),
                C.default.track(G.HAw.USER_SETTINGS_GAME_DETECTION_TOGGLE, { enabled: !n });
        },
        ...
        GAME_DETECTION_DEBUGGING_START: function (e) {
            (eE = e.level), (eh = e.intervalSeconds);
        },
        GAME_DETECTION_DEBUGGING_STOP: function () {
            (eE = null), (eh = null), e_.clear();
        },
        GAME_DETECTION_DEBUGGING_TICK: function (e) {
            ...
            t.length > 0 &&
                C.default.track(G.HAw.GAME_DETECTION_DEBUGGING_KEYWORD_MATCH, {
                    keywords: W,
                    paths: t,
                    debugging_level: eE,
                    interval_seconds: eh,
