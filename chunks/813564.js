...
function N(e, t, n, i, r) {
    ...
    T.default.track(S.HAw.PREMIUM_FEATURE_USAGE, {
        feature_name: y.Ae.SOUNDBOARD_PLAY,
        feature_tier: c ? y.tz.PREMIUM_STANDARD : y.tz.FREE,
        guild_id: a,
...
async function $(e) {
    ...
    if (null != s) {
        ...
        (a = n.id),
            (0, U.qP)(a, s, E.Zm.JOINED_VOICE_CHANNEL),
            (function (e, t, n) {
                ...
                h.Bo.post({
                    ...
                    N([f.A.CHANNEL_CALL], n, t, E.ib.ENTRY);
            })(a, s, __OVERLAY__);
    }
}
function z(e) {
...
function q(e, t) {
    (0, u.TG)(
        e,
        (n) => {
            (n.joinSound = void 0), Z({ guildId: e, changeType: E.Vr.REMOVED, soundType: E.ib.ENTRY, location: t });
        },
    ...
    (0, u.TG)(
        ...
        (i) => {
            ...
            (i.joinSound = { soundId: t.soundId, guildId: r ? "0" : t.guildId }),
                Z({ guildId: e, changeType: a, soundSource: s, soundType: E.ib.ENTRY, location: n });
        },
        u.Sb.INFREQUENT_USER_ACTION,
    );
}
